...
public class UpdateUserPoolClientResponseUserPoolClient {
  ...
  public UpdateUserPoolClientResponseUserPoolClient() {
  }

  public UpdateUserPoolClientResponseUserPoolClient userPoolId(String userPoolId) {
  ...
  public UpdateUserPoolClientResponseUserPoolClient clientName(String clientName) {
  ...
  public UpdateUserPoolClientResponseUserPoolClient clientId(String clientId) {
  ...
  public UpdateUserPoolClientResponseUserPoolClient clientSecret(String clientSecret) {
  ...
  public UpdateUserPoolClientResponseUserPoolClient lastModifiedDate(OffsetDateTime lastModifiedDate) {
  ...
  public UpdateUserPoolClientResponseUserPoolClient creationDate(OffsetDateTime creationDate) {
  ...
  public UpdateUserPoolClientResponseUserPoolClient refreshTokenValidity(Integer refreshTokenValidity) {
  ...
  public UpdateUserPoolClientResponseUserPoolClient accessTokenValidity(Integer accessTokenValidity) {
  ...
  public UpdateUserPoolClientResponseUserPoolClient idTokenValidity(Integer idTokenValidity) {
  ...
  public UpdateUserPoolClientResponseUserPoolClient tokenValidityUnits(UserPoolClientTypeTokenValidityUnits tokenValidityUnits) {
  ...
  public UpdateUserPoolClientResponseUserPoolClient readAttributes(List readAttributes) {
  ...
  public UpdateUserPoolClientResponseUserPoolClient writeAttributes(List writeAttributes) {
  ...
  public UpdateUserPoolClientResponseUserPoolClient explicitAuthFlows(List explicitAuthFlows) {
  ...
  public UpdateUserPoolClientResponseUserPoolClient supportedIdentityProviders(List supportedIdentityProviders) {
  ...
  public UpdateUserPoolClientResponseUserPoolClient callbackURLs(List callbackURLs) {
  ...
  public UpdateUserPoolClientResponseUserPoolClient logoutURLs(List logoutURLs) {
  ...
  public UpdateUserPoolClientResponseUserPoolClient defaultRedirectURI(String defaultRedirectURI) {
  ...
  public UpdateUserPoolClientResponseUserPoolClient allowedOAuthFlows(List allowedOAuthFlows) {
  ...
  public UpdateUserPoolClientResponseUserPoolClient allowedOAuthScopes(List allowedOAuthScopes) {
  ...
  public UpdateUserPoolClientResponseUserPoolClient allowedOAuthFlowsUserPoolClient(Boolean allowedOAuthFlowsUserPoolClient) {
  ...
  public UpdateUserPoolClientResponseUserPoolClient analyticsConfiguration(UserPoolClientTypeAnalyticsConfiguration analyticsConfiguration) {
  ...
  public UpdateUserPoolClientResponseUserPoolClient preventUserExistenceErrors(PreventUserExistenceErrorTypes preventUserExistenceErrors) {
  ...
  public UpdateUserPoolClientResponseUserPoolClient enableTokenRevocation(Boolean enableTokenRevocation) {
  ...
  public UpdateUserPoolClientResponseUserPoolClient enablePropagateAdditionalUserContextData(Boolean enablePropagateAdditionalUserContextData) {
  ...
  public UpdateUserPoolClientResponseUserPoolClient authSessionValidity(Integer authSessionValidity) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateUserPoolClientResponseUserPoolClient updateUserPoolClientResponseUserPoolClient = (UpdateUserPoolClientResponseUserPoolClient) o;
    return Objects.equals(this.userPoolId, updateUserPoolClientResponseUserPoolClient.userPoolId) &&
        Objects.equals(this.clientName, updateUserPoolClientResponseUserPoolClient.clientName) &&
        Objects.equals(this.clientId, updateUserPoolClientResponseUserPoolClient.clientId) &&
        Objects.equals(this.clientSecret, updateUserPoolClientResponseUserPoolClient.clientSecret) &&
        Objects.equals(this.lastModifiedDate, updateUserPoolClientResponseUserPoolClient.lastModifiedDate) &&
        Objects.equals(this.creationDate, updateUserPoolClientResponseUserPoolClient.creationDate) &&
        Objects.equals(this.refreshTokenValidity, updateUserPoolClientResponseUserPoolClient.refreshTokenValidity) &&
        Objects.equals(this.accessTokenValidity, updateUserPoolClientResponseUserPoolClient.accessTokenValidity) &&
        Objects.equals(this.idTokenValidity, updateUserPoolClientResponseUserPoolClient.idTokenValidity) &&
        Objects.equals(this.tokenValidityUnits, updateUserPoolClientResponseUserPoolClient.tokenValidityUnits) &&
        Objects.equals(this.readAttributes, updateUserPoolClientResponseUserPoolClient.readAttributes) &&
        Objects.equals(this.writeAttributes, updateUserPoolClientResponseUserPoolClient.writeAttributes) &&
        Objects.equals(this.explicitAuthFlows, updateUserPoolClientResponseUserPoolClient.explicitAuthFlows) &&
        Objects.equals(this.supportedIdentityProviders, updateUserPoolClientResponseUserPoolClient.supportedIdentityProviders) &&
        Objects.equals(this.callbackURLs, updateUserPoolClientResponseUserPoolClient.callbackURLs) &&
        Objects.equals(this.logoutURLs, updateUserPoolClientResponseUserPoolClient.logoutURLs) &&
        Objects.equals(this.defaultRedirectURI, updateUserPoolClientResponseUserPoolClient.defaultRedirectURI) &&
        Objects.equals(this.allowedOAuthFlows, updateUserPoolClientResponseUserPoolClient.allowedOAuthFlows) &&
        Objects.equals(this.allowedOAuthScopes, updateUserPoolClientResponseUserPoolClient.allowedOAuthScopes) &&
        Objects.equals(this.allowedOAuthFlowsUserPoolClient, updateUserPoolClientResponseUserPoolClient.allowedOAuthFlowsUserPoolClient) &&
        Objects.equals(this.analyticsConfiguration, updateUserPoolClientResponseUserPoolClient.analyticsConfiguration) &&
        Objects.equals(this.preventUserExistenceErrors, updateUserPoolClientResponseUserPoolClient.preventUserExistenceErrors) &&
        Objects.equals(this.enableTokenRevocation, updateUserPoolClientResponseUserPoolClient.enableTokenRevocation) &&
        Objects.equals(this.enablePropagateAdditionalUserContextData, updateUserPoolClientResponseUserPoolClient.enablePropagateAdditionalUserContextData) &&
        Objects.equals(this.authSessionValidity, updateUserPoolClientResponseUserPoolClient.authSessionValidity);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateUserPoolClientResponseUserPoolClient {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateUserPoolClientResponseUserPoolClient
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateUserPoolClientResponseUserPoolClient.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateUserPoolClientResponseUserPoolClient is not found in the empty JSON string", UpdateUserPoolClientResponseUserPoolClient.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateUserPoolClientResponseUserPoolClient.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateUserPoolClientResponseUserPoolClient` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateUserPoolClientResponseUserPoolClient.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateUserPoolClientResponseUserPoolClient' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateUserPoolClientResponseUserPoolClient> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateUserPoolClientResponseUserPoolClient.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateUserPoolClientResponseUserPoolClient>() {
           @Override
           public void write(JsonWriter out, UpdateUserPoolClientResponseUserPoolClient value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateUserPoolClientResponseUserPoolClient read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateUserPoolClientResponseUserPoolClient given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateUserPoolClientResponseUserPoolClient
   * @throws IOException if the JSON string is invalid with respect to UpdateUserPoolClientResponseUserPoolClient
   */
  public static UpdateUserPoolClientResponseUserPoolClient fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateUserPoolClientResponseUserPoolClient.class);
  }

  /**
   * Convert an instance of UpdateUserPoolClientResponseUserPoolClient to an JSON string
   *
   * @return JSON string
   */
