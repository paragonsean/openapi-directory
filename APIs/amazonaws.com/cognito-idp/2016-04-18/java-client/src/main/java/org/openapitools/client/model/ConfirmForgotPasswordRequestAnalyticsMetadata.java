...
public class ConfirmForgotPasswordRequestAnalyticsMetadata {
  ...
  public ConfirmForgotPasswordRequestAnalyticsMetadata() {
  }

  public ConfirmForgotPasswordRequestAnalyticsMetadata analyticsEndpointId(String analyticsEndpointId) {
  ...
  public boolean equals(Object o) {
    ...
    ConfirmForgotPasswordRequestAnalyticsMetadata confirmForgotPasswordRequestAnalyticsMetadata = (ConfirmForgotPasswordRequestAnalyticsMetadata) o;
    return Objects.equals(this.analyticsEndpointId, confirmForgotPasswordRequestAnalyticsMetadata.analyticsEndpointId);
  }
  ...
  public String toString() {
    ...
    sb.append("class ConfirmForgotPasswordRequestAnalyticsMetadata {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConfirmForgotPasswordRequestAnalyticsMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConfirmForgotPasswordRequestAnalyticsMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConfirmForgotPasswordRequestAnalyticsMetadata is not found in the empty JSON string", ConfirmForgotPasswordRequestAnalyticsMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConfirmForgotPasswordRequestAnalyticsMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConfirmForgotPasswordRequestAnalyticsMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConfirmForgotPasswordRequestAnalyticsMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConfirmForgotPasswordRequestAnalyticsMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConfirmForgotPasswordRequestAnalyticsMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConfirmForgotPasswordRequestAnalyticsMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<ConfirmForgotPasswordRequestAnalyticsMetadata>() {
           @Override
           public void write(JsonWriter out, ConfirmForgotPasswordRequestAnalyticsMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ConfirmForgotPasswordRequestAnalyticsMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ConfirmForgotPasswordRequestAnalyticsMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ConfirmForgotPasswordRequestAnalyticsMetadata
   * @throws IOException if the JSON string is invalid with respect to ConfirmForgotPasswordRequestAnalyticsMetadata
   */
  public static ConfirmForgotPasswordRequestAnalyticsMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConfirmForgotPasswordRequestAnalyticsMetadata.class);
  }

  /**
   * Convert an instance of ConfirmForgotPasswordRequestAnalyticsMetadata to an JSON string
   *
   * @return JSON string
   */
