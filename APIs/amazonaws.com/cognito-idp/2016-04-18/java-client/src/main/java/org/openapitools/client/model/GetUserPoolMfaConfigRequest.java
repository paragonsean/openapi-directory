...
public class GetUserPoolMfaConfigRequest {
  ...
  public GetUserPoolMfaConfigRequest userPoolId(String userPoolId) {
  ...
  public boolean equals(Object o) {
    ...
    GetUserPoolMfaConfigRequest getUserPoolMfaConfigRequest = (GetUserPoolMfaConfigRequest) o;
    return Objects.equals(this.userPoolId, getUserPoolMfaConfigRequest.userPoolId);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetUserPoolMfaConfigRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetUserPoolMfaConfigRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetUserPoolMfaConfigRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetUserPoolMfaConfigRequest is not found in the empty JSON string", GetUserPoolMfaConfigRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetUserPoolMfaConfigRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetUserPoolMfaConfigRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetUserPoolMfaConfigRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetUserPoolMfaConfigRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetUserPoolMfaConfigRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetUserPoolMfaConfigRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetUserPoolMfaConfigRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GetUserPoolMfaConfigRequest>() {
           @Override
           public void write(JsonWriter out, GetUserPoolMfaConfigRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetUserPoolMfaConfigRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetUserPoolMfaConfigRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetUserPoolMfaConfigRequest
   * @throws IOException if the JSON string is invalid with respect to GetUserPoolMfaConfigRequest
   */
  public static GetUserPoolMfaConfigRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetUserPoolMfaConfigRequest.class);
  }

  /**
   * Convert an instance of GetUserPoolMfaConfigRequest to an JSON string
   *
   * @return JSON string
   */
