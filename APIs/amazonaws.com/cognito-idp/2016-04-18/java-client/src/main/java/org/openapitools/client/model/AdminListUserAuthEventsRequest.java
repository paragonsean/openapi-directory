...
public class AdminListUserAuthEventsRequest {
  ...
  public AdminListUserAuthEventsRequest userPoolId(String userPoolId) {
  ...
  public AdminListUserAuthEventsRequest username(String username) {
  ...
  public AdminListUserAuthEventsRequest maxResults(Integer maxResults) {
  ...
  public AdminListUserAuthEventsRequest nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    AdminListUserAuthEventsRequest adminListUserAuthEventsRequest = (AdminListUserAuthEventsRequest) o;
    return Objects.equals(this.userPoolId, adminListUserAuthEventsRequest.userPoolId) &&
        Objects.equals(this.username, adminListUserAuthEventsRequest.username) &&
        Objects.equals(this.maxResults, adminListUserAuthEventsRequest.maxResults) &&
        Objects.equals(this.nextToken, adminListUserAuthEventsRequest.nextToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(userPoolId, username, maxResults, nextToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AdminListUserAuthEventsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AdminListUserAuthEventsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdminListUserAuthEventsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AdminListUserAuthEventsRequest is not found in the empty JSON string", AdminListUserAuthEventsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AdminListUserAuthEventsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AdminListUserAuthEventsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AdminListUserAuthEventsRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AdminListUserAuthEventsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AdminListUserAuthEventsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AdminListUserAuthEventsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AdminListUserAuthEventsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AdminListUserAuthEventsRequest>() {
           @Override
           public void write(JsonWriter out, AdminListUserAuthEventsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AdminListUserAuthEventsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AdminListUserAuthEventsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AdminListUserAuthEventsRequest
   * @throws IOException if the JSON string is invalid with respect to AdminListUserAuthEventsRequest
   */
  public static AdminListUserAuthEventsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AdminListUserAuthEventsRequest.class);
  }

  /**
   * Convert an instance of AdminListUserAuthEventsRequest to an JSON string
   *
   * @return JSON string
   */
