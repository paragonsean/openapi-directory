...
public class NotifyEmailType {
  ...
  public NotifyEmailType subject(String subject) {
  ...
  public NotifyEmailType htmlBody(String htmlBody) {
  ...
  public NotifyEmailType textBody(String textBody) {
  ...
  public boolean equals(Object o) {
    ...
    NotifyEmailType notifyEmailType = (NotifyEmailType) o;
    return Objects.equals(this.subject, notifyEmailType.subject) &&
        Objects.equals(this.htmlBody, notifyEmailType.htmlBody) &&
        Objects.equals(this.textBody, notifyEmailType.textBody);
  }
  ...
  public String toString() {
    ...
    sb.append("class NotifyEmailType {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NotifyEmailType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NotifyEmailType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NotifyEmailType is not found in the empty JSON string", NotifyEmailType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NotifyEmailType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NotifyEmailType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NotifyEmailType.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NotifyEmailType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NotifyEmailType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NotifyEmailType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NotifyEmailType.class));

       return (TypeAdapter<T>) new TypeAdapter<NotifyEmailType>() {
           @Override
           public void write(JsonWriter out, NotifyEmailType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NotifyEmailType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NotifyEmailType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NotifyEmailType
   * @throws IOException if the JSON string is invalid with respect to NotifyEmailType
   */
  public static NotifyEmailType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NotifyEmailType.class);
  }

  /**
   * Convert an instance of NotifyEmailType to an JSON string
   *
   * @return JSON string
   */
