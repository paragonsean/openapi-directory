...
public class GetCSVHeaderResponse {
  ...
  public static final String SERIALIZED_NAME_CS_V_HEADER = "CSVHeader";
  @SerializedName(SERIALIZED_NAME_CS_V_HEADER)
  private List csVHeader;

  public GetCSVHeaderResponse() {
  }

  public GetCSVHeaderResponse userPoolId(String userPoolId) {
  ...
  public GetCSVHeaderResponse csVHeader(List csVHeader) {
  ...
  public void setCsVHeader(List csVHeader) {
    this.csVHeader = csVHeader;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetCSVHeaderResponse getCSVHeaderResponse = (GetCSVHeaderResponse) o;
    return Objects.equals(this.userPoolId, getCSVHeaderResponse.userPoolId) &&
        Objects.equals(this.csVHeader, getCSVHeaderResponse.csVHeader);
  }

  @Override
  public int hashCode() {
    return Objects.hash(userPoolId, csVHeader);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetCSVHeaderResponse {\n");
    sb.append("    userPoolId: ").append(toIndentedString(userPoolId)).append("\n");
    sb.append("    csVHeader: ").append(toIndentedString(csVHeader)).append("\n");
    sb.append("}");
    return sb.toString();
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetCSVHeaderResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetCSVHeaderResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetCSVHeaderResponse is not found in the empty JSON string", GetCSVHeaderResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetCSVHeaderResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetCSVHeaderResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // validate the optional field `CSVHeader`
      if (jsonObj.get("CSVHeader") != null && !jsonObj.get("CSVHeader").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("CSVHeader"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetCSVHeaderResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetCSVHeaderResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetCSVHeaderResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetCSVHeaderResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GetCSVHeaderResponse>() {
           @Override
           public void write(JsonWriter out, GetCSVHeaderResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetCSVHeaderResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetCSVHeaderResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetCSVHeaderResponse
   * @throws IOException if the JSON string is invalid with respect to GetCSVHeaderResponse
   */
  public static GetCSVHeaderResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetCSVHeaderResponse.class);
  }

  /**
   * Convert an instance of GetCSVHeaderResponse to an JSON string
   *
   * @return JSON string
   */
