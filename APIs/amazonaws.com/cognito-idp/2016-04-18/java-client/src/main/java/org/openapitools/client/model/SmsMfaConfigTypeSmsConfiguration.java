...
public class SmsMfaConfigTypeSmsConfiguration {
  ...
  public SmsMfaConfigTypeSmsConfiguration() {
  }

  public SmsMfaConfigTypeSmsConfiguration snsCallerArn(String snsCallerArn) {
  ...
  public SmsMfaConfigTypeSmsConfiguration externalId(String externalId) {
  ...
  public SmsMfaConfigTypeSmsConfiguration snsRegion(String snsRegion) {
  ...
  public boolean equals(Object o) {
    ...
    SmsMfaConfigTypeSmsConfiguration smsMfaConfigTypeSmsConfiguration = (SmsMfaConfigTypeSmsConfiguration) o;
    return Objects.equals(this.snsCallerArn, smsMfaConfigTypeSmsConfiguration.snsCallerArn) &&
        Objects.equals(this.externalId, smsMfaConfigTypeSmsConfiguration.externalId) &&
        Objects.equals(this.snsRegion, smsMfaConfigTypeSmsConfiguration.snsRegion);
  }
  ...
  public String toString() {
    ...
    sb.append("class SmsMfaConfigTypeSmsConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SmsMfaConfigTypeSmsConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SmsMfaConfigTypeSmsConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SmsMfaConfigTypeSmsConfiguration is not found in the empty JSON string", SmsMfaConfigTypeSmsConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SmsMfaConfigTypeSmsConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SmsMfaConfigTypeSmsConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SmsMfaConfigTypeSmsConfiguration.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SmsMfaConfigTypeSmsConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SmsMfaConfigTypeSmsConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SmsMfaConfigTypeSmsConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SmsMfaConfigTypeSmsConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<SmsMfaConfigTypeSmsConfiguration>() {
           @Override
           public void write(JsonWriter out, SmsMfaConfigTypeSmsConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SmsMfaConfigTypeSmsConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SmsMfaConfigTypeSmsConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SmsMfaConfigTypeSmsConfiguration
   * @throws IOException if the JSON string is invalid with respect to SmsMfaConfigTypeSmsConfiguration
   */
  public static SmsMfaConfigTypeSmsConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SmsMfaConfigTypeSmsConfiguration.class);
  }

  /**
   * Convert an instance of SmsMfaConfigTypeSmsConfiguration to an JSON string
   *
   * @return JSON string
   */
