...
public class AccountTakeoverActionType {
  ...
  public AccountTakeoverActionType notify(Boolean notify) {
    this.notify = notify;
    return this;
  }
  ...
  public AccountTakeoverActionType eventAction(AccountTakeoverEventActionType eventAction) {
  ...
  public boolean equals(Object o) {
    ...
    AccountTakeoverActionType accountTakeoverActionType = (AccountTakeoverActionType) o;
    return Objects.equals(this.notify, accountTakeoverActionType.notify) &&
        Objects.equals(this.eventAction, accountTakeoverActionType.eventAction);
  }
  ...
  public String toString() {
    ...
    sb.append("class AccountTakeoverActionType {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AccountTakeoverActionType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AccountTakeoverActionType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccountTakeoverActionType is not found in the empty JSON string", AccountTakeoverActionType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AccountTakeoverActionType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AccountTakeoverActionType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AccountTakeoverActionType.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccountTakeoverActionType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccountTakeoverActionType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccountTakeoverActionType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccountTakeoverActionType.class));

       return (TypeAdapter<T>) new TypeAdapter<AccountTakeoverActionType>() {
           @Override
           public void write(JsonWriter out, AccountTakeoverActionType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AccountTakeoverActionType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AccountTakeoverActionType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AccountTakeoverActionType
   * @throws IOException if the JSON string is invalid with respect to AccountTakeoverActionType
   */
  public static AccountTakeoverActionType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccountTakeoverActionType.class);
  }

  /**
   * Convert an instance of AccountTakeoverActionType to an JSON string
   *
   * @return JSON string
   */
