...
public class GetUICustomizationRequest {
  ...
  public GetUICustomizationRequest() {
  }

  public GetUICustomizationRequest userPoolId(String userPoolId) {
  ...
  public GetUICustomizationRequest clientId(String clientId) {
  ...
  public boolean equals(Object o) {
    ...
    GetUICustomizationRequest getUICustomizationRequest = (GetUICustomizationRequest) o;
    return Objects.equals(this.userPoolId, getUICustomizationRequest.userPoolId) &&
        Objects.equals(this.clientId, getUICustomizationRequest.clientId);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetUICustomizationRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetUICustomizationRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetUICustomizationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetUICustomizationRequest is not found in the empty JSON string", GetUICustomizationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetUICustomizationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetUICustomizationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetUICustomizationRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetUICustomizationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetUICustomizationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetUICustomizationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetUICustomizationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GetUICustomizationRequest>() {
           @Override
           public void write(JsonWriter out, GetUICustomizationRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetUICustomizationRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetUICustomizationRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetUICustomizationRequest
   * @throws IOException if the JSON string is invalid with respect to GetUICustomizationRequest
   */
  public static GetUICustomizationRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetUICustomizationRequest.class);
  }

  /**
   * Convert an instance of GetUICustomizationRequest to an JSON string
   *
   * @return JSON string
   */
