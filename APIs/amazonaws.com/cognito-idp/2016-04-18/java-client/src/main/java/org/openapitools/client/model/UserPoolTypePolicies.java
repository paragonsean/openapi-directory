...
public class UserPoolTypePolicies {
  ...
  public UserPoolTypePolicies() {
  }

  public UserPoolTypePolicies passwordPolicy(UserPoolPolicyTypePasswordPolicy passwordPolicy) {
  ...
  public boolean equals(Object o) {
    ...
    UserPoolTypePolicies userPoolTypePolicies = (UserPoolTypePolicies) o;
    return Objects.equals(this.passwordPolicy, userPoolTypePolicies.passwordPolicy);
  }
  ...
  public String toString() {
    ...
    sb.append("class UserPoolTypePolicies {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UserPoolTypePolicies
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserPoolTypePolicies.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserPoolTypePolicies is not found in the empty JSON string", UserPoolTypePolicies.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserPoolTypePolicies.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserPoolTypePolicies` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserPoolTypePolicies.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserPoolTypePolicies' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserPoolTypePolicies> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserPoolTypePolicies.class));

       return (TypeAdapter<T>) new TypeAdapter<UserPoolTypePolicies>() {
           @Override
           public void write(JsonWriter out, UserPoolTypePolicies value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserPoolTypePolicies read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UserPoolTypePolicies given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UserPoolTypePolicies
   * @throws IOException if the JSON string is invalid with respect to UserPoolTypePolicies
   */
  public static UserPoolTypePolicies fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserPoolTypePolicies.class);
  }

  /**
   * Convert an instance of UserPoolTypePolicies to an JSON string
   *
   * @return JSON string
   */
