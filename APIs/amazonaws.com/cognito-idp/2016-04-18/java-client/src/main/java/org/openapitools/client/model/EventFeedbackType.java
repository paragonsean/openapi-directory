...
public class EventFeedbackType {
  ...
  public EventFeedbackType feedbackValue(FeedbackValueType feedbackValue) {
  ...
  public EventFeedbackType provider(String provider) {
  ...
  public EventFeedbackType feedbackDate(OffsetDateTime feedbackDate) {
  ...
  public boolean equals(Object o) {
    ...
    EventFeedbackType eventFeedbackType = (EventFeedbackType) o;
    return Objects.equals(this.feedbackValue, eventFeedbackType.feedbackValue) &&
        Objects.equals(this.provider, eventFeedbackType.provider) &&
        Objects.equals(this.feedbackDate, eventFeedbackType.feedbackDate);
  }
  ...
  public String toString() {
    ...
    sb.append("class EventFeedbackType {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EventFeedbackType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EventFeedbackType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EventFeedbackType is not found in the empty JSON string", EventFeedbackType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EventFeedbackType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EventFeedbackType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EventFeedbackType.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EventFeedbackType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EventFeedbackType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EventFeedbackType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EventFeedbackType.class));

       return (TypeAdapter<T>) new TypeAdapter<EventFeedbackType>() {
           @Override
           public void write(JsonWriter out, EventFeedbackType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EventFeedbackType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EventFeedbackType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EventFeedbackType
   * @throws IOException if the JSON string is invalid with respect to EventFeedbackType
   */
  public static EventFeedbackType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EventFeedbackType.class);
  }

  /**
   * Convert an instance of EventFeedbackType to an JSON string
   *
   * @return JSON string
   */
