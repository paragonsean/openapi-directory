...
public class AdminRemoveUserFromGroupRequest {
  ...
  public AdminRemoveUserFromGroupRequest userPoolId(String userPoolId) {
  ...
  public AdminRemoveUserFromGroupRequest username(String username) {
  ...
  public AdminRemoveUserFromGroupRequest groupName(String groupName) {
  ...
  public boolean equals(Object o) {
    ...
    AdminRemoveUserFromGroupRequest adminRemoveUserFromGroupRequest = (AdminRemoveUserFromGroupRequest) o;
    return Objects.equals(this.userPoolId, adminRemoveUserFromGroupRequest.userPoolId) &&
        Objects.equals(this.username, adminRemoveUserFromGroupRequest.username) &&
        Objects.equals(this.groupName, adminRemoveUserFromGroupRequest.groupName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(userPoolId, username, groupName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AdminRemoveUserFromGroupRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AdminRemoveUserFromGroupRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdminRemoveUserFromGroupRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AdminRemoveUserFromGroupRequest is not found in the empty JSON string", AdminRemoveUserFromGroupRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AdminRemoveUserFromGroupRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AdminRemoveUserFromGroupRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AdminRemoveUserFromGroupRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AdminRemoveUserFromGroupRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AdminRemoveUserFromGroupRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AdminRemoveUserFromGroupRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AdminRemoveUserFromGroupRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AdminRemoveUserFromGroupRequest>() {
           @Override
           public void write(JsonWriter out, AdminRemoveUserFromGroupRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AdminRemoveUserFromGroupRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AdminRemoveUserFromGroupRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AdminRemoveUserFromGroupRequest
   * @throws IOException if the JSON string is invalid with respect to AdminRemoveUserFromGroupRequest
   */
  public static AdminRemoveUserFromGroupRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AdminRemoveUserFromGroupRequest.class);
  }

  /**
   * Convert an instance of AdminRemoveUserFromGroupRequest to an JSON string
   *
   * @return JSON string
   */
