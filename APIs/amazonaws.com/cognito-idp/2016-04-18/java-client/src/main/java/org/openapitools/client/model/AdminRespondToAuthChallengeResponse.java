...
public class AdminRespondToAuthChallengeResponse {
  ...
  private AdminRespondToAuthChallengeResponseAuthenticationResult authenticationResult;

  public AdminRespondToAuthChallengeResponse() {
  }

  public AdminRespondToAuthChallengeResponse challengeName(ChallengeNameType challengeName) {
  ...
  public AdminRespondToAuthChallengeResponse session(String session) {
  ...
  public AdminRespondToAuthChallengeResponse challengeParameters(Map challengeParameters) {
  ...
  public AdminRespondToAuthChallengeResponse authenticationResult(AdminRespondToAuthChallengeResponseAuthenticationResult authenticationResult) {
   ...
   */
  @javax.annotation.Nullable
  public AdminRespondToAuthChallengeResponseAuthenticationResult getAuthenticationResult() {
    return authenticationResult;
  }

  public void setAuthenticationResult(AdminRespondToAuthChallengeResponseAuthenticationResult authenticationResult) {
    this.authenticationResult = authenticationResult;
  }
  ...
  public boolean equals(Object o) {
    ...
    AdminRespondToAuthChallengeResponse adminRespondToAuthChallengeResponse = (AdminRespondToAuthChallengeResponse) o;
    return Objects.equals(this.challengeName, adminRespondToAuthChallengeResponse.challengeName) &&
        Objects.equals(this.session, adminRespondToAuthChallengeResponse.session) &&
        Objects.equals(this.challengeParameters, adminRespondToAuthChallengeResponse.challengeParameters) &&
        Objects.equals(this.authenticationResult, adminRespondToAuthChallengeResponse.authenticationResult);
  }
  ...
  public String toString() {
    ...
    sb.append("class AdminRespondToAuthChallengeResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AdminRespondToAuthChallengeResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdminRespondToAuthChallengeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AdminRespondToAuthChallengeResponse is not found in the empty JSON string", AdminRespondToAuthChallengeResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AdminRespondToAuthChallengeResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AdminRespondToAuthChallengeResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("AuthenticationResult") != null && !jsonObj.get("AuthenticationResult").isJsonNull()) {
        AdminRespondToAuthChallengeResponseAuthenticationResult.validateJsonElement(jsonObj.get("AuthenticationResult"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AdminRespondToAuthChallengeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AdminRespondToAuthChallengeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AdminRespondToAuthChallengeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AdminRespondToAuthChallengeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<AdminRespondToAuthChallengeResponse>() {
           @Override
           public void write(JsonWriter out, AdminRespondToAuthChallengeResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AdminRespondToAuthChallengeResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AdminRespondToAuthChallengeResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AdminRespondToAuthChallengeResponse
   * @throws IOException if the JSON string is invalid with respect to AdminRespondToAuthChallengeResponse
   */
  public static AdminRespondToAuthChallengeResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AdminRespondToAuthChallengeResponse.class);
  }

  /**
   * Convert an instance of AdminRespondToAuthChallengeResponse to an JSON string
   *
   * @return JSON string
   */
