...
public class SchemaAttributeTypeStringAttributeConstraints {
  ...
  public SchemaAttributeTypeStringAttributeConstraints() {
  }

  public SchemaAttributeTypeStringAttributeConstraints minLength(String minLength) {
  ...
  public SchemaAttributeTypeStringAttributeConstraints maxLength(String maxLength) {
  ...
  public boolean equals(Object o) {
    ...
    SchemaAttributeTypeStringAttributeConstraints schemaAttributeTypeStringAttributeConstraints = (SchemaAttributeTypeStringAttributeConstraints) o;
    return Objects.equals(this.minLength, schemaAttributeTypeStringAttributeConstraints.minLength) &&
        Objects.equals(this.maxLength, schemaAttributeTypeStringAttributeConstraints.maxLength);
  }
  ...
  public String toString() {
    ...
    sb.append("class SchemaAttributeTypeStringAttributeConstraints {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SchemaAttributeTypeStringAttributeConstraints
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SchemaAttributeTypeStringAttributeConstraints.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SchemaAttributeTypeStringAttributeConstraints is not found in the empty JSON string", SchemaAttributeTypeStringAttributeConstraints.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SchemaAttributeTypeStringAttributeConstraints.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SchemaAttributeTypeStringAttributeConstraints` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SchemaAttributeTypeStringAttributeConstraints.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SchemaAttributeTypeStringAttributeConstraints' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SchemaAttributeTypeStringAttributeConstraints> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SchemaAttributeTypeStringAttributeConstraints.class));

       return (TypeAdapter<T>) new TypeAdapter<SchemaAttributeTypeStringAttributeConstraints>() {
           @Override
           public void write(JsonWriter out, SchemaAttributeTypeStringAttributeConstraints value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SchemaAttributeTypeStringAttributeConstraints read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SchemaAttributeTypeStringAttributeConstraints given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SchemaAttributeTypeStringAttributeConstraints
   * @throws IOException if the JSON string is invalid with respect to SchemaAttributeTypeStringAttributeConstraints
   */
  public static SchemaAttributeTypeStringAttributeConstraints fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SchemaAttributeTypeStringAttributeConstraints.class);
  }

  /**
   * Convert an instance of SchemaAttributeTypeStringAttributeConstraints to an JSON string
   *
   * @return JSON string
   */
