...
import org.openapitools.client.model.InitiateAuthResponseAuthenticationResult;
...
public class InitiateAuthResponse {
  ...
  private InitiateAuthResponseAuthenticationResult authenticationResult;

  public InitiateAuthResponse() {
  }

  public InitiateAuthResponse challengeName(ChallengeNameType challengeName) {
  ...
  public InitiateAuthResponse session(String session) {
  ...
  public InitiateAuthResponse challengeParameters(Map challengeParameters) {
  ...
  public InitiateAuthResponse authenticationResult(InitiateAuthResponseAuthenticationResult authenticationResult) {
   ...
   */
  @javax.annotation.Nullable
  public InitiateAuthResponseAuthenticationResult getAuthenticationResult() {
    return authenticationResult;
  }

  public void setAuthenticationResult(InitiateAuthResponseAuthenticationResult authenticationResult) {
    this.authenticationResult = authenticationResult;
  }
  ...
  public boolean equals(Object o) {
    ...
    InitiateAuthResponse initiateAuthResponse = (InitiateAuthResponse) o;
    return Objects.equals(this.challengeName, initiateAuthResponse.challengeName) &&
        Objects.equals(this.session, initiateAuthResponse.session) &&
        Objects.equals(this.challengeParameters, initiateAuthResponse.challengeParameters) &&
        Objects.equals(this.authenticationResult, initiateAuthResponse.authenticationResult);
  }
  ...
  public String toString() {
    ...
    sb.append("class InitiateAuthResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to InitiateAuthResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InitiateAuthResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InitiateAuthResponse is not found in the empty JSON string", InitiateAuthResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InitiateAuthResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InitiateAuthResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("AuthenticationResult") != null && !jsonObj.get("AuthenticationResult").isJsonNull()) {
        InitiateAuthResponseAuthenticationResult.validateJsonElement(jsonObj.get("AuthenticationResult"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InitiateAuthResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InitiateAuthResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InitiateAuthResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InitiateAuthResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<InitiateAuthResponse>() {
           @Override
           public void write(JsonWriter out, InitiateAuthResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InitiateAuthResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InitiateAuthResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InitiateAuthResponse
   * @throws IOException if the JSON string is invalid with respect to InitiateAuthResponse
   */
  public static InitiateAuthResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InitiateAuthResponse.class);
  }

  /**
   * Convert an instance of InitiateAuthResponse to an JSON string
   *
   * @return JSON string
   */
