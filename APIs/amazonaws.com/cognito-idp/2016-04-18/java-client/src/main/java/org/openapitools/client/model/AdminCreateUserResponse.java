...
public class AdminCreateUserResponse {
  ...
  private AdminCreateUserResponseUser user;

  public AdminCreateUserResponse() {
  }

  public AdminCreateUserResponse user(AdminCreateUserResponseUser user) {
    this.user = user;
    return this;
  }
  ...
  public AdminCreateUserResponseUser getUser() {
    return user;
  }

  public void setUser(AdminCreateUserResponseUser user) {
    this.user = user;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.user, adminCreateUserResponse.user);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AdminCreateUserResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdminCreateUserResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AdminCreateUserResponse is not found in the empty JSON string", AdminCreateUserResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AdminCreateUserResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AdminCreateUserResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `User`
      if (jsonObj.get("User") != null && !jsonObj.get("User").isJsonNull()) {
        AdminCreateUserResponseUser.validateJsonElement(jsonObj.get("User"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AdminCreateUserResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AdminCreateUserResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AdminCreateUserResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AdminCreateUserResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<AdminCreateUserResponse>() {
           @Override
           public void write(JsonWriter out, AdminCreateUserResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AdminCreateUserResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AdminCreateUserResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AdminCreateUserResponse
   * @throws IOException if the JSON string is invalid with respect to AdminCreateUserResponse
   */
  public static AdminCreateUserResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AdminCreateUserResponse.class);
  }

  /**
   * Convert an instance of AdminCreateUserResponse to an JSON string
   *
   * @return JSON string
   */
