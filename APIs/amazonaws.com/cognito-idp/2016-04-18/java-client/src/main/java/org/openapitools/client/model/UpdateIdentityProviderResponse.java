...
import org.openapitools.client.model.DescribeIdentityProviderResponseIdentityProvider;
...
public class UpdateIdentityProviderResponse {
  ...
  private DescribeIdentityProviderResponseIdentityProvider identityProvider;

  public UpdateIdentityProviderResponse() {
  }

  public UpdateIdentityProviderResponse identityProvider(DescribeIdentityProviderResponseIdentityProvider identityProvider) {
  ...
  public DescribeIdentityProviderResponseIdentityProvider getIdentityProvider() {
    return identityProvider;
  }

  public void setIdentityProvider(DescribeIdentityProviderResponseIdentityProvider identityProvider) {
    this.identityProvider = identityProvider;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateIdentityProviderResponse updateIdentityProviderResponse = (UpdateIdentityProviderResponse) o;
    return Objects.equals(this.identityProvider, updateIdentityProviderResponse.identityProvider);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateIdentityProviderResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateIdentityProviderResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateIdentityProviderResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateIdentityProviderResponse is not found in the empty JSON string", UpdateIdentityProviderResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateIdentityProviderResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateIdentityProviderResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateIdentityProviderResponse.openapiRequiredFields) {
      ...
      DescribeIdentityProviderResponseIdentityProvider.validateJsonElement(jsonObj.get("IdentityProvider"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateIdentityProviderResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateIdentityProviderResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateIdentityProviderResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateIdentityProviderResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateIdentityProviderResponse>() {
           @Override
           public void write(JsonWriter out, UpdateIdentityProviderResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateIdentityProviderResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateIdentityProviderResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateIdentityProviderResponse
   * @throws IOException if the JSON string is invalid with respect to UpdateIdentityProviderResponse
   */
  public static UpdateIdentityProviderResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateIdentityProviderResponse.class);
  }

  /**
   * Convert an instance of UpdateIdentityProviderResponse to an JSON string
   *
   * @return JSON string
   */
