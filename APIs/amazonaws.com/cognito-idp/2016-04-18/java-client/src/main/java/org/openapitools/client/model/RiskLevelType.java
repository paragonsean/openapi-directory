...
/**
 * Gets or Sets RiskLevelType
 */
@JsonAdapter(RiskLevelType.Adapter.class)
public enum RiskLevelType {
  ...
  public static RiskLevelType fromValue(String value) {
    for (RiskLevelType b : RiskLevelType.values()) {
  ...
  public static class Adapter extends TypeAdapter<RiskLevelType> {
    @Override
    public void write(final JsonWriter jsonWriter, final RiskLevelType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public RiskLevelType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return RiskLevelType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    RiskLevelType.fromValue(value);
  }
}
