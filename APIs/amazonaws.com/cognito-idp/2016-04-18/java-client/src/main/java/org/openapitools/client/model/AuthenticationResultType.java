...
public class AuthenticationResultType {
  ...
  public AuthenticationResultType accessToken(String accessToken) {
  ...
  public AuthenticationResultType expiresIn(Integer expiresIn) {
  ...
  public AuthenticationResultType tokenType(String tokenType) {
  ...
  public AuthenticationResultType idToken(String idToken) {
  ...
  public AuthenticationResultType newDeviceMetadata(AuthenticationResultTypeNewDeviceMetadata newDeviceMetadata) {
  ...
  public boolean equals(Object o) {
    ...
    AuthenticationResultType authenticationResultType = (AuthenticationResultType) o;
    return Objects.equals(this.accessToken, authenticationResultType.accessToken) &&
        Objects.equals(this.expiresIn, authenticationResultType.expiresIn) &&
        Objects.equals(this.tokenType, authenticationResultType.tokenType) &&
        Objects.equals(this.refreshToken, authenticationResultType.refreshToken) &&
        Objects.equals(this.idToken, authenticationResultType.idToken) &&
        Objects.equals(this.newDeviceMetadata, authenticationResultType.newDeviceMetadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class AuthenticationResultType {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AuthenticationResultType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AuthenticationResultType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AuthenticationResultType is not found in the empty JSON string", AuthenticationResultType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AuthenticationResultType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AuthenticationResultType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AuthenticationResultType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AuthenticationResultType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AuthenticationResultType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AuthenticationResultType.class));

       return (TypeAdapter<T>) new TypeAdapter<AuthenticationResultType>() {
           @Override
           public void write(JsonWriter out, AuthenticationResultType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AuthenticationResultType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AuthenticationResultType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AuthenticationResultType
   * @throws IOException if the JSON string is invalid with respect to AuthenticationResultType
   */
  public static AuthenticationResultType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AuthenticationResultType.class);
  }

  /**
   * Convert an instance of AuthenticationResultType to an JSON string
   *
   * @return JSON string
   */
