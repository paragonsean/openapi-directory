...
public class VerifyUserAttributeRequest {
  ...
  public VerifyUserAttributeRequest accessToken(String accessToken) {
  ...
  public VerifyUserAttributeRequest attributeName(String attributeName) {
  ...
  public VerifyUserAttributeRequest code(String code) {
    this.code = code;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    VerifyUserAttributeRequest verifyUserAttributeRequest = (VerifyUserAttributeRequest) o;
    return Objects.equals(this.accessToken, verifyUserAttributeRequest.accessToken) &&
        Objects.equals(this.attributeName, verifyUserAttributeRequest.attributeName) &&
        Objects.equals(this.code, verifyUserAttributeRequest.code);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accessToken, attributeName, code);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class VerifyUserAttributeRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to VerifyUserAttributeRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VerifyUserAttributeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VerifyUserAttributeRequest is not found in the empty JSON string", VerifyUserAttributeRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VerifyUserAttributeRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VerifyUserAttributeRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VerifyUserAttributeRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VerifyUserAttributeRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VerifyUserAttributeRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VerifyUserAttributeRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VerifyUserAttributeRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<VerifyUserAttributeRequest>() {
           @Override
           public void write(JsonWriter out, VerifyUserAttributeRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public VerifyUserAttributeRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of VerifyUserAttributeRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of VerifyUserAttributeRequest
   * @throws IOException if the JSON string is invalid with respect to VerifyUserAttributeRequest
   */
  public static VerifyUserAttributeRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VerifyUserAttributeRequest.class);
  }

  /**
   * Convert an instance of VerifyUserAttributeRequest to an JSON string
   *
   * @return JSON string
   */
