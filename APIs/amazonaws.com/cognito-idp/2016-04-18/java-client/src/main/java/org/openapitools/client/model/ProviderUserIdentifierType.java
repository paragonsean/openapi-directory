...
public class ProviderUserIdentifierType {
  ...
  public ProviderUserIdentifierType providerName(String providerName) {
  ...
  public ProviderUserIdentifierType providerAttributeName(String providerAttributeName) {
  ...
  public ProviderUserIdentifierType providerAttributeValue(String providerAttributeValue) {
  ...
  public boolean equals(Object o) {
    ...
    ProviderUserIdentifierType providerUserIdentifierType = (ProviderUserIdentifierType) o;
    return Objects.equals(this.providerName, providerUserIdentifierType.providerName) &&
        Objects.equals(this.providerAttributeName, providerUserIdentifierType.providerAttributeName) &&
        Objects.equals(this.providerAttributeValue, providerUserIdentifierType.providerAttributeValue);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProviderUserIdentifierType {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProviderUserIdentifierType
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProviderUserIdentifierType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProviderUserIdentifierType is not found in the empty JSON string", ProviderUserIdentifierType.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProviderUserIdentifierType.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProviderUserIdentifierType` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProviderUserIdentifierType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProviderUserIdentifierType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProviderUserIdentifierType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProviderUserIdentifierType.class));

       return (TypeAdapter<T>) new TypeAdapter<ProviderUserIdentifierType>() {
           @Override
           public void write(JsonWriter out, ProviderUserIdentifierType value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProviderUserIdentifierType read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProviderUserIdentifierType given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProviderUserIdentifierType
   * @throws IOException if the JSON string is invalid with respect to ProviderUserIdentifierType
   */
  public static ProviderUserIdentifierType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProviderUserIdentifierType.class);
  }

  /**
   * Convert an instance of ProviderUserIdentifierType to an JSON string
   *
   * @return JSON string
   */
