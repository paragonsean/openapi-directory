...
public class DescribeResourceServerResponseResourceServer {
  ...
  public DescribeResourceServerResponseResourceServer() {
  }

  public DescribeResourceServerResponseResourceServer userPoolId(String userPoolId) {
  ...
  public DescribeResourceServerResponseResourceServer identifier(String identifier) {
  ...
  public DescribeResourceServerResponseResourceServer name(String name) {
    this.name = name;
    return this;
  }
  ...
  public DescribeResourceServerResponseResourceServer scopes(List scopes) {
    this.scopes = scopes;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DescribeResourceServerResponseResourceServer describeResourceServerResponseResourceServer = (DescribeResourceServerResponseResourceServer) o;
    return Objects.equals(this.userPoolId, describeResourceServerResponseResourceServer.userPoolId) &&
        Objects.equals(this.identifier, describeResourceServerResponseResourceServer.identifier) &&
        Objects.equals(this.name, describeResourceServerResponseResourceServer.name) &&
        Objects.equals(this.scopes, describeResourceServerResponseResourceServer.scopes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeResourceServerResponseResourceServer {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeResourceServerResponseResourceServer
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeResourceServerResponseResourceServer.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeResourceServerResponseResourceServer is not found in the empty JSON string", DescribeResourceServerResponseResourceServer.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeResourceServerResponseResourceServer.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeResourceServerResponseResourceServer` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeResourceServerResponseResourceServer.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeResourceServerResponseResourceServer' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeResourceServerResponseResourceServer> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeResourceServerResponseResourceServer.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeResourceServerResponseResourceServer>() {
           @Override
           public void write(JsonWriter out, DescribeResourceServerResponseResourceServer value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeResourceServerResponseResourceServer read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeResourceServerResponseResourceServer given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeResourceServerResponseResourceServer
   * @throws IOException if the JSON string is invalid with respect to DescribeResourceServerResponseResourceServer
   */
  public static DescribeResourceServerResponseResourceServer fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeResourceServerResponseResourceServer.class);
  }

  /**
   * Convert an instance of DescribeResourceServerResponseResourceServer to an JSON string
   *
   * @return JSON string
   */
