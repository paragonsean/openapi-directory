...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.GetDeviceResponse();
  });
  ...
  describe('GetDeviceResponse', function() {
    it('should create an instance of GetDeviceResponse', function() {
      ...
      //var instance = new AmazonCognitoIdentityProvider.GetDeviceResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.GetDeviceResponse);
    });
