...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.CreateGroupResponseGroup();
  });
  ...
  describe('CreateGroupResponseGroup', function() {
    it('should create an instance of CreateGroupResponseGroup', function() {
      ...
      //var instance = new AmazonCognitoIdentityProvider.CreateGroupResponseGroup();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.CreateGroupResponseGroup);
    });
