...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.CreateUserPoolRequestUserAttributeUpdateSettings();
  });
  ...
  describe('CreateUserPoolRequestUserAttributeUpdateSettings', function() {
    it('should create an instance of CreateUserPoolRequestUserAttributeUpdateSettings', function() {
      // uncomment below and update the code to test CreateUserPoolRequestUserAttributeUpdateSettings
      //var instance = new AmazonCognitoIdentityProvider.CreateUserPoolRequestUserAttributeUpdateSettings();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.CreateUserPoolRequestUserAttributeUpdateSettings);
    });

    it('should have the property attributesRequireVerificationBeforeUpdate (base name: "AttributesRequireVerificationBeforeUpdate")', function() {
      // uncomment below and update the code to test the property attributesRequireVerificationBeforeUpdate
      //var instance = new AmazonCognitoIdentityProvider.CreateUserPoolRequestUserAttributeUpdateSettings();
