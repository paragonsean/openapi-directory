...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.CreateUserPoolClientResponse();
  });
  ...
  describe('CreateUserPoolClientResponse', function() {
    it('should create an instance of CreateUserPoolClientResponse', function() {
      // uncomment below and update the code to test CreateUserPoolClientResponse
      //var instance = new AmazonCognitoIdentityProvider.CreateUserPoolClientResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.CreateUserPoolClientResponse);
    });
