...
(function(root, factory) {
  ...
  describe('EventFilterType', function() {
    it('should create an instance of EventFilterType', function() {
      // uncomment below and update the code to test EventFilterType
      //var instance = new AmazonCognitoIdentityProvider.EventFilterType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.EventFilterType);
    });
