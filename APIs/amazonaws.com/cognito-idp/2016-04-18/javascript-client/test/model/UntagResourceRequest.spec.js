...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.UntagResourceRequest();
  });
  ...
  describe('UntagResourceRequest', function() {
    it('should create an instance of UntagResourceRequest', function() {
      ...
      //var instance = new AmazonCognitoIdentityProvider.UntagResourceRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.UntagResourceRequest);
    });
