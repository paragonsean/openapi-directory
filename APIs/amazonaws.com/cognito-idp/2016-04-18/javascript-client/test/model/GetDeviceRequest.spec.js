...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.GetDeviceRequest();
  });
  ...
  describe('GetDeviceRequest', function() {
    it('should create an instance of GetDeviceRequest', function() {
      // uncomment below and update the code to test GetDeviceRequest
      //var instance = new AmazonCognitoIdentityProvider.GetDeviceRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.GetDeviceRequest);
    });
