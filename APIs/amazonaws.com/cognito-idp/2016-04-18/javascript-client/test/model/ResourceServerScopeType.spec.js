...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.ResourceServerScopeType();
  });
  ...
  describe('ResourceServerScopeType', function() {
    it('should create an instance of ResourceServerScopeType', function() {
      // uncomment below and update the code to test ResourceServerScopeType
      //var instance = new AmazonCognitoIdentityProvider.ResourceServerScopeType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.ResourceServerScopeType);
    });
    ...
    it('should have the property scopeDescription (base name: "ScopeDescription")', function() {
      // uncomment below and update the code to test the property scopeDescription
      //var instance = new AmazonCognitoIdentityProvider.ResourceServerScopeType();
      //expect(instance).to.be();
    });
