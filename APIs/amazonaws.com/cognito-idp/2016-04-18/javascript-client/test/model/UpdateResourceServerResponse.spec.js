...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.UpdateResourceServerResponse();
  });
  ...
  describe('UpdateResourceServerResponse', function() {
    it('should create an instance of UpdateResourceServerResponse', function() {
      // uncomment below and update the code to test UpdateResourceServerResponse
      //var instance = new AmazonCognitoIdentityProvider.UpdateResourceServerResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.UpdateResourceServerResponse);
    });
