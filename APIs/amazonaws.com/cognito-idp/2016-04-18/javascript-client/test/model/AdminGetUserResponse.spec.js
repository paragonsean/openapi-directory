...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AdminGetUserResponse();
  });
  ...
  describe('AdminGetUserResponse', function() {
    it('should create an instance of AdminGetUserResponse', function() {
      // uncomment below and update the code to test AdminGetUserResponse
      //var instance = new AmazonCognitoIdentityProvider.AdminGetUserResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AdminGetUserResponse);
    });
    ...
    it('should have the property userCreateDate (base name: "UserCreateDate")', function() {
      // uncomment below and update the code to test the property userCreateDate
      //var instance = new AmazonCognitoIdentityProvider.AdminGetUserResponse();
      //expect(instance).to.be();
    });

    it('should have the property userLastModifiedDate (base name: "UserLastModifiedDate")', function() {
      // uncomment below and update the code to test the property userLastModifiedDate
      //var instance = new AmazonCognitoIdentityProvider.AdminGetUserResponse();
      //expect(instance).to.be();
    });
    ...
    it('should have the property preferredMfaSetting (base name: "PreferredMfaSetting")', function() {
      // uncomment below and update the code to test the property preferredMfaSetting
      //var instance = new AmazonCognitoIdentityProvider.AdminGetUserResponse();
      //expect(instance).to.be();
    });

    it('should have the property userMFASettingList (base name: "UserMFASettingList")', function() {
      // uncomment below and update the code to test the property userMFASettingList
      //var instance = new AmazonCognitoIdentityProvider.AdminGetUserResponse();
      //expect(instance).to.be();
    });
