...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.DescribeResourceServerRequest();
  });
  ...
  describe('DescribeResourceServerRequest', function() {
    it('should create an instance of DescribeResourceServerRequest', function() {
      // uncomment below and update the code to test DescribeResourceServerRequest
      //var instance = new AmazonCognitoIdentityProvider.DescribeResourceServerRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.DescribeResourceServerRequest);
    });
