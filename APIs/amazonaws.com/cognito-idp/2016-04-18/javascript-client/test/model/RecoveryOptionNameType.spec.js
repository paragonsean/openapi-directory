...
(function(root, factory) {
  ...
  describe('RecoveryOptionNameType', function() {
    it('should create an instance of RecoveryOptionNameType', function() {
      // uncomment below and update the code to test RecoveryOptionNameType
      //var instance = new AmazonCognitoIdentityProvider.RecoveryOptionNameType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.RecoveryOptionNameType);
    });
