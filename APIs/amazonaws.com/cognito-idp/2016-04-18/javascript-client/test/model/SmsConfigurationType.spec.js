...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.SmsConfigurationType();
  });
  ...
  describe('SmsConfigurationType', function() {
    it('should create an instance of SmsConfigurationType', function() {
      // uncomment below and update the code to test SmsConfigurationType
      //var instance = new AmazonCognitoIdentityProvider.SmsConfigurationType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.SmsConfigurationType);
    });

    it('should have the property snsCallerArn (base name: "SnsCallerArn")', function() {
      // uncomment below and update the code to test the property snsCallerArn
      //var instance = new AmazonCognitoIdentityProvider.SmsConfigurationType();
    ...
    it('should have the property snsRegion (base name: "SnsRegion")', function() {
      // uncomment below and update the code to test the property snsRegion
      //var instance = new AmazonCognitoIdentityProvider.SmsConfigurationType();
      //expect(instance).to.be();
    });
