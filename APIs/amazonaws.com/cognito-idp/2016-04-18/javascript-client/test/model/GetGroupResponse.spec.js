...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.GetGroupResponse();
  });
  ...
  describe('GetGroupResponse', function() {
    it('should create an instance of GetGroupResponse', function() {
      // uncomment below and update the code to test GetGroupResponse
      //var instance = new AmazonCognitoIdentityProvider.GetGroupResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.GetGroupResponse);
    });
