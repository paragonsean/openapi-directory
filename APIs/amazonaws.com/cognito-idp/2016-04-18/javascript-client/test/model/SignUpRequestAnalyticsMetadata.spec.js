...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.SignUpRequestAnalyticsMetadata();
  });
  ...
  describe('SignUpRequestAnalyticsMetadata', function() {
    it('should create an instance of SignUpRequestAnalyticsMetadata', function() {
      // uncomment below and update the code to test SignUpRequestAnalyticsMetadata
      //var instance = new AmazonCognitoIdentityProvider.SignUpRequestAnalyticsMetadata();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.SignUpRequestAnalyticsMetadata);
    });
