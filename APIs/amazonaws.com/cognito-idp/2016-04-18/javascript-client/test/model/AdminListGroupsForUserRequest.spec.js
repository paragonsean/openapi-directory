...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AdminListGroupsForUserRequest();
  });
  ...
  describe('AdminListGroupsForUserRequest', function() {
    it('should create an instance of AdminListGroupsForUserRequest', function() {
      // uncomment below and update the code to test AdminListGroupsForUserRequest
      //var instance = new AmazonCognitoIdentityProvider.AdminListGroupsForUserRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AdminListGroupsForUserRequest);
    });
