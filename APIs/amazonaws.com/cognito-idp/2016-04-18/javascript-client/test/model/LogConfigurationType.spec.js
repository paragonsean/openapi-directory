...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.LogConfigurationType();
  });
  ...
  describe('LogConfigurationType', function() {
    it('should create an instance of LogConfigurationType', function() {
      // uncomment below and update the code to test LogConfigurationType
      //var instance = new AmazonCognitoIdentityProvider.LogConfigurationType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.LogConfigurationType);
    });
