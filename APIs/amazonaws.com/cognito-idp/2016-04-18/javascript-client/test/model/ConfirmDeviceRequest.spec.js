...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.ConfirmDeviceRequest();
  });
  ...
  describe('ConfirmDeviceRequest', function() {
    it('should create an instance of ConfirmDeviceRequest', function() {
      // uncomment below and update the code to test ConfirmDeviceRequest
      //var instance = new AmazonCognitoIdentityProvider.ConfirmDeviceRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.ConfirmDeviceRequest);
    });
    ...
    it('should have the property deviceSecretVerifierConfig (base name: "DeviceSecretVerifierConfig")', function() {
      // uncomment below and update the code to test the property deviceSecretVerifierConfig
      //var instance = new AmazonCognitoIdentityProvider.ConfirmDeviceRequest();
      //expect(instance).to.be();
    });
