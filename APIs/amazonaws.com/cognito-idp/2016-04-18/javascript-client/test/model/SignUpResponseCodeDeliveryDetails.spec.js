...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.SignUpResponseCodeDeliveryDetails();
  });
  ...
  describe('SignUpResponseCodeDeliveryDetails', function() {
    it('should create an instance of SignUpResponseCodeDeliveryDetails', function() {
      // uncomment below and update the code to test SignUpResponseCodeDeliveryDetails
      //var instance = new AmazonCognitoIdentityProvider.SignUpResponseCodeDeliveryDetails();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.SignUpResponseCodeDeliveryDetails);
    });
