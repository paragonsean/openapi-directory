...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.CustomSMSLambdaVersionConfigType();
  });
  ...
  describe('CustomSMSLambdaVersionConfigType', function() {
    it('should create an instance of CustomSMSLambdaVersionConfigType', function() {
      // uncomment below and update the code to test CustomSMSLambdaVersionConfigType
      //var instance = new AmazonCognitoIdentityProvider.CustomSMSLambdaVersionConfigType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.CustomSMSLambdaVersionConfigType);
    });
