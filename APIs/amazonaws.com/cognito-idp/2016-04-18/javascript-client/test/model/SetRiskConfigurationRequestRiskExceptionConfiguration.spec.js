...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.SetRiskConfigurationRequestRiskExceptionConfiguration();
  });
  ...
  describe('SetRiskConfigurationRequestRiskExceptionConfiguration', function() {
    it('should create an instance of SetRiskConfigurationRequestRiskExceptionConfiguration', function() {
      // uncomment below and update the code to test SetRiskConfigurationRequestRiskExceptionConfiguration
      //var instance = new AmazonCognitoIdentityProvider.SetRiskConfigurationRequestRiskExceptionConfiguration();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.SetRiskConfigurationRequestRiskExceptionConfiguration);
    });

    it('should have the property blockedIPRangeList (base name: "BlockedIPRangeList")', function() {
      // uncomment below and update the code to test the property blockedIPRangeList
      //var instance = new AmazonCognitoIdentityProvider.SetRiskConfigurationRequestRiskExceptionConfiguration();
      //expect(instance).to.be();
    });

    it('should have the property skippedIPRangeList (base name: "SkippedIPRangeList")', function() {
      // uncomment below and update the code to test the property skippedIPRangeList
      //var instance = new AmazonCognitoIdentityProvider.SetRiskConfigurationRequestRiskExceptionConfiguration();
      //expect(instance).to.be();
    });
