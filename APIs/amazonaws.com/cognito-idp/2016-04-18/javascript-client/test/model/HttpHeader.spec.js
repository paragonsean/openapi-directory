...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.HttpHeader();
  });
  ...
  describe('HttpHeader', function() {
    it('should create an instance of HttpHeader', function() {
      // uncomment below and update the code to test HttpHeader
      //var instance = new AmazonCognitoIdentityProvider.HttpHeader();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.HttpHeader);
    });
