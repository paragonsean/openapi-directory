...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AccountTakeoverActionsTypeMediumAction();
  });
  ...
  describe('AccountTakeoverActionsTypeMediumAction', function() {
    it('should create an instance of AccountTakeoverActionsTypeMediumAction', function() {
      // uncomment below and update the code to test AccountTakeoverActionsTypeMediumAction
      //var instance = new AmazonCognitoIdentityProvider.AccountTakeoverActionsTypeMediumAction();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AccountTakeoverActionsTypeMediumAction);
    });
