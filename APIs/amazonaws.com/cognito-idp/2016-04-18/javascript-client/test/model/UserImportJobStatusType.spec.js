...
(function(root, factory) {
  ...
  describe('UserImportJobStatusType', function() {
    it('should create an instance of UserImportJobStatusType', function() {
      // uncomment below and update the code to test UserImportJobStatusType
      //var instance = new AmazonCognitoIdentityProvider.UserImportJobStatusType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.UserImportJobStatusType);
    });
