...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.CodeDeliveryDetailsType();
  });
  ...
  describe('CodeDeliveryDetailsType', function() {
    it('should create an instance of CodeDeliveryDetailsType', function() {
      // uncomment below and update the code to test CodeDeliveryDetailsType
      //var instance = new AmazonCognitoIdentityProvider.CodeDeliveryDetailsType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.CodeDeliveryDetailsType);
    });
