...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AdminDisableProviderForUserRequestUser();
  });
  ...
  describe('AdminDisableProviderForUserRequestUser', function() {
    it('should create an instance of AdminDisableProviderForUserRequestUser', function() {
      // uncomment below and update the code to test AdminDisableProviderForUserRequestUser
      //var instance = new AmazonCognitoIdentityProvider.AdminDisableProviderForUserRequestUser();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AdminDisableProviderForUserRequestUser);
    });
