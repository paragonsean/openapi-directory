...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.TokenValidityUnitsType();
  });
  ...
  describe('TokenValidityUnitsType', function() {
    it('should create an instance of TokenValidityUnitsType', function() {
      // uncomment below and update the code to test TokenValidityUnitsType
      //var instance = new AmazonCognitoIdentityProvider.TokenValidityUnitsType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.TokenValidityUnitsType);
    });
