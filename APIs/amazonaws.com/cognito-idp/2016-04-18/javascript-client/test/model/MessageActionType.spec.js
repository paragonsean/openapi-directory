...
(function(root, factory) {
  ...
  describe('MessageActionType', function() {
    it('should create an instance of MessageActionType', function() {
      // uncomment below and update the code to test MessageActionType
      //var instance = new AmazonCognitoIdentityProvider.MessageActionType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.MessageActionType);
    });
