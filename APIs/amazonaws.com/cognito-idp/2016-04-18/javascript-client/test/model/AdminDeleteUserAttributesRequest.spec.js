...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AdminDeleteUserAttributesRequest();
  });
  ...
  describe('AdminDeleteUserAttributesRequest', function() {
    it('should create an instance of AdminDeleteUserAttributesRequest', function() {
      // uncomment below and update the code to test AdminDeleteUserAttributesRequest
      //var instance = new AmazonCognitoIdentityProvider.AdminDeleteUserAttributesRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AdminDeleteUserAttributesRequest);
    });
    ...
    it('should have the property userAttributeNames (base name: "UserAttributeNames")', function() {
      // uncomment below and update the code to test the property userAttributeNames
      //var instance = new AmazonCognitoIdentityProvider.AdminDeleteUserAttributesRequest();
      //expect(instance).to.be();
    });
