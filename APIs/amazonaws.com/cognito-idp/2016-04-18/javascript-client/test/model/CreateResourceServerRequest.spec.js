...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.CreateResourceServerRequest();
  });
  ...
  describe('CreateResourceServerRequest', function() {
    it('should create an instance of CreateResourceServerRequest', function() {
      // uncomment below and update the code to test CreateResourceServerRequest
      //var instance = new AmazonCognitoIdentityProvider.CreateResourceServerRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.CreateResourceServerRequest);
    });
