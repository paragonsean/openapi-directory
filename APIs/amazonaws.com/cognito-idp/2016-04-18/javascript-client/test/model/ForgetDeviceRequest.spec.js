...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.ForgetDeviceRequest();
  });
  ...
  describe('ForgetDeviceRequest', function() {
    it('should create an instance of ForgetDeviceRequest', function() {
      // uncomment below and update the code to test ForgetDeviceRequest
      //var instance = new AmazonCognitoIdentityProvider.ForgetDeviceRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.ForgetDeviceRequest);
    });
