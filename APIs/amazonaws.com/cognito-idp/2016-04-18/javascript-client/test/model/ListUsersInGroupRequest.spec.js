...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.ListUsersInGroupRequest();
  });
  ...
  describe('ListUsersInGroupRequest', function() {
    it('should create an instance of ListUsersInGroupRequest', function() {
      // uncomment below and update the code to test ListUsersInGroupRequest
      //var instance = new AmazonCognitoIdentityProvider.ListUsersInGroupRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.ListUsersInGroupRequest);
    });
