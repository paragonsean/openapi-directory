...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AdminListUserAuthEventsRequest();
  });
  ...
  describe('AdminListUserAuthEventsRequest', function() {
    it('should create an instance of AdminListUserAuthEventsRequest', function() {
      // uncomment below and update the code to test AdminListUserAuthEventsRequest
      //var instance = new AmazonCognitoIdentityProvider.AdminListUserAuthEventsRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AdminListUserAuthEventsRequest);
    });
