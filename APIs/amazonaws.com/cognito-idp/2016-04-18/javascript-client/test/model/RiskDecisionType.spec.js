...
(function(root, factory) {
  ...
  describe('RiskDecisionType', function() {
    it('should create an instance of RiskDecisionType', function() {
      // uncomment below and update the code to test RiskDecisionType
      //var instance = new AmazonCognitoIdentityProvider.RiskDecisionType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.RiskDecisionType);
    });
