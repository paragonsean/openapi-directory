...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AdminListDevicesResponse();
  });
  ...
  describe('AdminListDevicesResponse', function() {
    it('should create an instance of AdminListDevicesResponse', function() {
      // uncomment below and update the code to test AdminListDevicesResponse
      //var instance = new AmazonCognitoIdentityProvider.AdminListDevicesResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AdminListDevicesResponse);
    });
