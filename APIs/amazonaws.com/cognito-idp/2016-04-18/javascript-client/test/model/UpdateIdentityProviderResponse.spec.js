...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.UpdateIdentityProviderResponse();
  });
  ...
  describe('UpdateIdentityProviderResponse', function() {
    it('should create an instance of UpdateIdentityProviderResponse', function() {
      // uncomment below and update the code to test UpdateIdentityProviderResponse
      //var instance = new AmazonCognitoIdentityProvider.UpdateIdentityProviderResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.UpdateIdentityProviderResponse);
    });
