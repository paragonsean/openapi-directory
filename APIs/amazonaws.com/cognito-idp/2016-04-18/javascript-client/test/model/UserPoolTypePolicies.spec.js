...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.UserPoolTypePolicies();
  });
  ...
  describe('UserPoolTypePolicies', function() {
    it('should create an instance of UserPoolTypePolicies', function() {
      // uncomment below and update the code to test UserPoolTypePolicies
      //var instance = new AmazonCognitoIdentityProvider.UserPoolTypePolicies();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.UserPoolTypePolicies);
    });
