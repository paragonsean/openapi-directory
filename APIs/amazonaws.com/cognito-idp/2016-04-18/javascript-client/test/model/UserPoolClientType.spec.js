...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.UserPoolClientType();
  });
  ...
  describe('UserPoolClientType', function() {
    it('should create an instance of UserPoolClientType', function() {
      // uncomment below and update the code to test UserPoolClientType
      //var instance = new AmazonCognitoIdentityProvider.UserPoolClientType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.UserPoolClientType);
    });
