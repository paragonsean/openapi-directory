...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.DescribeResourceServerResponse();
  });
  ...
  describe('DescribeResourceServerResponse', function() {
    it('should create an instance of DescribeResourceServerResponse', function() {
      // uncomment below and update the code to test DescribeResourceServerResponse
      //var instance = new AmazonCognitoIdentityProvider.DescribeResourceServerResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.DescribeResourceServerResponse);
    });
