...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.SetUserMFAPreferenceRequest();
  });
  ...
  describe('SetUserMFAPreferenceRequest', function() {
    it('should create an instance of SetUserMFAPreferenceRequest', function() {
      // uncomment below and update the code to test SetUserMFAPreferenceRequest
      //var instance = new AmazonCognitoIdentityProvider.SetUserMFAPreferenceRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.SetUserMFAPreferenceRequest);
    });
