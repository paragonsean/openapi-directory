...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.LambdaConfigTypeCustomEmailSender();
  });
  ...
  describe('LambdaConfigTypeCustomEmailSender', function() {
    it('should create an instance of LambdaConfigTypeCustomEmailSender', function() {
      // uncomment below and update the code to test LambdaConfigTypeCustomEmailSender
      //var instance = new AmazonCognitoIdentityProvider.LambdaConfigTypeCustomEmailSender();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.LambdaConfigTypeCustomEmailSender);
    });

    it('should have the property lambdaVersion (base name: "LambdaVersion")', function() {
      // uncomment below and update the code to test the property lambdaVersion
      //var instance = new AmazonCognitoIdentityProvider.LambdaConfigTypeCustomEmailSender();
