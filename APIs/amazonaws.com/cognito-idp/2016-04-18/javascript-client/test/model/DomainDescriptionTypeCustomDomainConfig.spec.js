...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.DomainDescriptionTypeCustomDomainConfig();
  });
  ...
  describe('DomainDescriptionTypeCustomDomainConfig', function() {
    it('should create an instance of DomainDescriptionTypeCustomDomainConfig', function() {
      // uncomment below and update the code to test DomainDescriptionTypeCustomDomainConfig
      //var instance = new AmazonCognitoIdentityProvider.DomainDescriptionTypeCustomDomainConfig();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.DomainDescriptionTypeCustomDomainConfig);
    });
