...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.UpdateGroupRequest();
  });
  ...
  describe('UpdateGroupRequest', function() {
    it('should create an instance of UpdateGroupRequest', function() {
      ...
      //var instance = new AmazonCognitoIdentityProvider.UpdateGroupRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.UpdateGroupRequest);
    });
