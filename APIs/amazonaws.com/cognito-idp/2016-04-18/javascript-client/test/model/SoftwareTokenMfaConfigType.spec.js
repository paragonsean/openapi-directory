...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.SoftwareTokenMfaConfigType();
  });
  ...
  describe('SoftwareTokenMfaConfigType', function() {
    it('should create an instance of SoftwareTokenMfaConfigType', function() {
      // uncomment below and update the code to test SoftwareTokenMfaConfigType
      //var instance = new AmazonCognitoIdentityProvider.SoftwareTokenMfaConfigType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.SoftwareTokenMfaConfigType);
    });
