...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.SoftwareTokenMfaSettingsType();
  });
  ...
  describe('SoftwareTokenMfaSettingsType', function() {
    it('should create an instance of SoftwareTokenMfaSettingsType', function() {
      // uncomment below and update the code to test SoftwareTokenMfaSettingsType
      //var instance = new AmazonCognitoIdentityProvider.SoftwareTokenMfaSettingsType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.SoftwareTokenMfaSettingsType);
    });
