...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AdminCreateUserConfigType();
  });
  ...
  describe('AdminCreateUserConfigType', function() {
    it('should create an instance of AdminCreateUserConfigType', function() {
      // uncomment below and update the code to test AdminCreateUserConfigType
      //var instance = new AmazonCognitoIdentityProvider.AdminCreateUserConfigType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AdminCreateUserConfigType);
    });
