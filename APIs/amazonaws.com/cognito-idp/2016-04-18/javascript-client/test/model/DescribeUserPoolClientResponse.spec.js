...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.DescribeUserPoolClientResponse();
  });
  ...
  describe('DescribeUserPoolClientResponse', function() {
    it('should create an instance of DescribeUserPoolClientResponse', function() {
      // uncomment below and update the code to test DescribeUserPoolClientResponse
      //var instance = new AmazonCognitoIdentityProvider.DescribeUserPoolClientResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.DescribeUserPoolClientResponse);
    });
