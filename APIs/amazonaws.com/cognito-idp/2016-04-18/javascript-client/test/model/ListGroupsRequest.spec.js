...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.ListGroupsRequest();
  });
  ...
  describe('ListGroupsRequest', function() {
    it('should create an instance of ListGroupsRequest', function() {
      // uncomment below and update the code to test ListGroupsRequest
      //var instance = new AmazonCognitoIdentityProvider.ListGroupsRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.ListGroupsRequest);
    });
