...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.ProviderUserIdentifierType();
  });
  ...
  describe('ProviderUserIdentifierType', function() {
    it('should create an instance of ProviderUserIdentifierType', function() {
      // uncomment below and update the code to test ProviderUserIdentifierType
      //var instance = new AmazonCognitoIdentityProvider.ProviderUserIdentifierType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.ProviderUserIdentifierType);
    });
