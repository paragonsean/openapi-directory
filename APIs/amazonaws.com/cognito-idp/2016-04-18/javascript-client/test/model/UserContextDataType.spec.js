...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.UserContextDataType();
  });
  ...
  describe('UserContextDataType', function() {
    it('should create an instance of UserContextDataType', function() {
      // uncomment below and update the code to test UserContextDataType
      //var instance = new AmazonCognitoIdentityProvider.UserContextDataType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.UserContextDataType);
    });
