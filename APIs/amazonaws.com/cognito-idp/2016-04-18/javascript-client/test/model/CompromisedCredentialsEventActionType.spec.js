...
(function(root, factory) {
  ...
  describe('CompromisedCredentialsEventActionType', function() {
    it('should create an instance of CompromisedCredentialsEventActionType', function() {
      // uncomment below and update the code to test CompromisedCredentialsEventActionType
      //var instance = new AmazonCognitoIdentityProvider.CompromisedCredentialsEventActionType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.CompromisedCredentialsEventActionType);
    });
