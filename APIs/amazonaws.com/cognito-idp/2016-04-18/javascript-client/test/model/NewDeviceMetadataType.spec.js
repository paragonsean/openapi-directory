...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.NewDeviceMetadataType();
  });
  ...
  describe('NewDeviceMetadataType', function() {
    it('should create an instance of NewDeviceMetadataType', function() {
      // uncomment below and update the code to test NewDeviceMetadataType
      //var instance = new AmazonCognitoIdentityProvider.NewDeviceMetadataType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.NewDeviceMetadataType);
    });
    ...
    it('should have the property deviceGroupKey (base name: "DeviceGroupKey")', function() {
      // uncomment below and update the code to test the property deviceGroupKey
      //var instance = new AmazonCognitoIdentityProvider.NewDeviceMetadataType();
      //expect(instance).to.be();
    });
