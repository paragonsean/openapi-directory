...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.SmsMfaConfigType();
  });
  ...
  describe('SmsMfaConfigType', function() {
    it('should create an instance of SmsMfaConfigType', function() {
      // uncomment below and update the code to test SmsMfaConfigType
      //var instance = new AmazonCognitoIdentityProvider.SmsMfaConfigType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.SmsMfaConfigType);
    });
