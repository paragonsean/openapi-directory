...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.RiskConfigurationTypeAccountTakeoverRiskConfiguration();
  });
  ...
  describe('RiskConfigurationTypeAccountTakeoverRiskConfiguration', function() {
    it('should create an instance of RiskConfigurationTypeAccountTakeoverRiskConfiguration', function() {
      // uncomment below and update the code to test RiskConfigurationTypeAccountTakeoverRiskConfiguration
      //var instance = new AmazonCognitoIdentityProvider.RiskConfigurationTypeAccountTakeoverRiskConfiguration();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.RiskConfigurationTypeAccountTakeoverRiskConfiguration);
    });
