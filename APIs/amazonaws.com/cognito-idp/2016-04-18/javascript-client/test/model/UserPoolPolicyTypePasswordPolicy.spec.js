...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.UserPoolPolicyTypePasswordPolicy();
  });
  ...
  describe('UserPoolPolicyTypePasswordPolicy', function() {
    it('should create an instance of UserPoolPolicyTypePasswordPolicy', function() {
      // uncomment below and update the code to test UserPoolPolicyTypePasswordPolicy
      //var instance = new AmazonCognitoIdentityProvider.UserPoolPolicyTypePasswordPolicy();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.UserPoolPolicyTypePasswordPolicy);
    });
    ...
    it('should have the property requireUppercase (base name: "RequireUppercase")', function() {
      // uncomment below and update the code to test the property requireUppercase
      //var instance = new AmazonCognitoIdentityProvider.UserPoolPolicyTypePasswordPolicy();
      //expect(instance).to.be();
    });

    it('should have the property requireLowercase (base name: "RequireLowercase")', function() {
      // uncomment below and update the code to test the property requireLowercase
      //var instance = new AmazonCognitoIdentityProvider.UserPoolPolicyTypePasswordPolicy();
      //expect(instance).to.be();
    });

    it('should have the property requireNumbers (base name: "RequireNumbers")', function() {
      // uncomment below and update the code to test the property requireNumbers
      //var instance = new AmazonCognitoIdentityProvider.UserPoolPolicyTypePasswordPolicy();
      //expect(instance).to.be();
    });

    it('should have the property requireSymbols (base name: "RequireSymbols")', function() {
      // uncomment below and update the code to test the property requireSymbols
      //var instance = new AmazonCognitoIdentityProvider.UserPoolPolicyTypePasswordPolicy();
      //expect(instance).to.be();
    });

    it('should have the property temporaryPasswordValidityDays (base name: "TemporaryPasswordValidityDays")', function() {
      // uncomment below and update the code to test the property temporaryPasswordValidityDays
      //var instance = new AmazonCognitoIdentityProvider.UserPoolPolicyTypePasswordPolicy();
      //expect(instance).to.be();
    });
