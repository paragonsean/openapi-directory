...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.GetUICustomizationResponse();
  });
  ...
  describe('GetUICustomizationResponse', function() {
    it('should create an instance of GetUICustomizationResponse', function() {
      // uncomment below and update the code to test GetUICustomizationResponse
      //var instance = new AmazonCognitoIdentityProvider.GetUICustomizationResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.GetUICustomizationResponse);
    });

    it('should have the property uICustomization (base name: "UICustomization")', function() {
      // uncomment below and update the code to test the property uICustomization
      //var instance = new AmazonCognitoIdentityProvider.GetUICustomizationResponse();
