...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.GetLogDeliveryConfigurationResponseLogDeliveryConfiguration();
  });
  ...
  describe('GetLogDeliveryConfigurationResponseLogDeliveryConfiguration', function() {
    it('should create an instance of GetLogDeliveryConfigurationResponseLogDeliveryConfiguration', function() {
      // uncomment below and update the code to test GetLogDeliveryConfigurationResponseLogDeliveryConfiguration
      //var instance = new AmazonCognitoIdentityProvider.GetLogDeliveryConfigurationResponseLogDeliveryConfiguration();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.GetLogDeliveryConfigurationResponseLogDeliveryConfiguration);
    });
