...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.InitiateAuthResponseAuthenticationResult();
  });
  ...
  describe('InitiateAuthResponseAuthenticationResult', function() {
    it('should create an instance of InitiateAuthResponseAuthenticationResult', function() {
      // uncomment below and update the code to test InitiateAuthResponseAuthenticationResult
      //var instance = new AmazonCognitoIdentityProvider.InitiateAuthResponseAuthenticationResult();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.InitiateAuthResponseAuthenticationResult);
    });
