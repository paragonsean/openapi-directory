...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AdminDeleteUserRequest();
  });
  ...
  describe('AdminDeleteUserRequest', function() {
    it('should create an instance of AdminDeleteUserRequest', function() {
      // uncomment below and update the code to test AdminDeleteUserRequest
      //var instance = new AmazonCognitoIdentityProvider.AdminDeleteUserRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AdminDeleteUserRequest);
    });
