...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.ResourceServerType();
  });
  ...
  describe('ResourceServerType', function() {
    it('should create an instance of ResourceServerType', function() {
      // uncomment below and update the code to test ResourceServerType
      //var instance = new AmazonCognitoIdentityProvider.ResourceServerType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.ResourceServerType);
    });
