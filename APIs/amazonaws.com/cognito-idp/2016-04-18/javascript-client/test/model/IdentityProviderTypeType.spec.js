...
(function(root, factory) {
  ...
  describe('IdentityProviderTypeType', function() {
    it('should create an instance of IdentityProviderTypeType', function() {
      // uncomment below and update the code to test IdentityProviderTypeType
      //var instance = new AmazonCognitoIdentityProvider.IdentityProviderTypeType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.IdentityProviderTypeType);
    });
