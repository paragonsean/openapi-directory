...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.DescribeUserImportJobResponse();
  });
  ...
  describe('DescribeUserImportJobResponse', function() {
    it('should create an instance of DescribeUserImportJobResponse', function() {
      // uncomment below and update the code to test DescribeUserImportJobResponse
      //var instance = new AmazonCognitoIdentityProvider.DescribeUserImportJobResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.DescribeUserImportJobResponse);
    });
