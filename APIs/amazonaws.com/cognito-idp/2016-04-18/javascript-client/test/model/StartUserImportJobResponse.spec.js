...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.StartUserImportJobResponse();
  });
  ...
  describe('StartUserImportJobResponse', function() {
    it('should create an instance of StartUserImportJobResponse', function() {
      // uncomment below and update the code to test StartUserImportJobResponse
      //var instance = new AmazonCognitoIdentityProvider.StartUserImportJobResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.StartUserImportJobResponse);
    });

    it('should have the property userImportJob (base name: "UserImportJob")', function() {
      // uncomment below and update the code to test the property userImportJob
      //var instance = new AmazonCognitoIdentityProvider.StartUserImportJobResponse();
