...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AddCustomAttributesRequest();
  });
  ...
  describe('AddCustomAttributesRequest', function() {
    it('should create an instance of AddCustomAttributesRequest', function() {
      // uncomment below and update the code to test AddCustomAttributesRequest
      //var instance = new AmazonCognitoIdentityProvider.AddCustomAttributesRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AddCustomAttributesRequest);
    });
