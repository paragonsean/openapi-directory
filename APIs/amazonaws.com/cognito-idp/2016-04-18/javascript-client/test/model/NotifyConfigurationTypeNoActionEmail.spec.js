...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.NotifyConfigurationTypeNoActionEmail();
  });
  ...
  describe('NotifyConfigurationTypeNoActionEmail', function() {
    it('should create an instance of NotifyConfigurationTypeNoActionEmail', function() {
      // uncomment below and update the code to test NotifyConfigurationTypeNoActionEmail
      //var instance = new AmazonCognitoIdentityProvider.NotifyConfigurationTypeNoActionEmail();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.NotifyConfigurationTypeNoActionEmail);
    });
