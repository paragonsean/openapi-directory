...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.DescribeResourceServerResponseResourceServer();
  });
  ...
  describe('DescribeResourceServerResponseResourceServer', function() {
    it('should create an instance of DescribeResourceServerResponseResourceServer', function() {
      // uncomment below and update the code to test DescribeResourceServerResponseResourceServer
      //var instance = new AmazonCognitoIdentityProvider.DescribeResourceServerResponseResourceServer();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.DescribeResourceServerResponseResourceServer);
    });
