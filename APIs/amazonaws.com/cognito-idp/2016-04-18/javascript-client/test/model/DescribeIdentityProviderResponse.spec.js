...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.DescribeIdentityProviderResponse();
  });
  ...
  describe('DescribeIdentityProviderResponse', function() {
    it('should create an instance of DescribeIdentityProviderResponse', function() {
      // uncomment below and update the code to test DescribeIdentityProviderResponse
      //var instance = new AmazonCognitoIdentityProvider.DescribeIdentityProviderResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.DescribeIdentityProviderResponse);
    });
