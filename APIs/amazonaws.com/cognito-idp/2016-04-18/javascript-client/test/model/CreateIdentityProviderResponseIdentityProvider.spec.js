...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.CreateIdentityProviderResponseIdentityProvider();
  });
  ...
  describe('CreateIdentityProviderResponseIdentityProvider', function() {
    it('should create an instance of CreateIdentityProviderResponseIdentityProvider', function() {
      // uncomment below and update the code to test CreateIdentityProviderResponseIdentityProvider
      //var instance = new AmazonCognitoIdentityProvider.CreateIdentityProviderResponseIdentityProvider();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.CreateIdentityProviderResponseIdentityProvider);
    });
    ...
    it('should have the property providerDetails (base name: "ProviderDetails")', function() {
    ...
    it('should have the property idpIdentifiers (base name: "IdpIdentifiers")', function() {
      // uncomment below and update the code to test the property idpIdentifiers
      //var instance = new AmazonCognitoIdentityProvider.CreateIdentityProviderResponseIdentityProvider();
      //expect(instance).to.be();
    });
