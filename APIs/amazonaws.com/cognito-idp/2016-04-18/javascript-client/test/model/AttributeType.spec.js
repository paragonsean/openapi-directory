...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AttributeType();
  });
  ...
  describe('AttributeType', function() {
    it('should create an instance of AttributeType', function() {
      ...
      //var instance = new AmazonCognitoIdentityProvider.AttributeType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AttributeType);
    });
