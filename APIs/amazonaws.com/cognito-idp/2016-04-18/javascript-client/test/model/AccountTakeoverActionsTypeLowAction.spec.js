...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AccountTakeoverActionsTypeLowAction();
  });
  ...
  describe('AccountTakeoverActionsTypeLowAction', function() {
    it('should create an instance of AccountTakeoverActionsTypeLowAction', function() {
      // uncomment below and update the code to test AccountTakeoverActionsTypeLowAction
      //var instance = new AmazonCognitoIdentityProvider.AccountTakeoverActionsTypeLowAction();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AccountTakeoverActionsTypeLowAction);
    });
