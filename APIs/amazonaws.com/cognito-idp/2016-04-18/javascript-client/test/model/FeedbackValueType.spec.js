...
(function(root, factory) {
  ...
  describe('FeedbackValueType', function() {
    it('should create an instance of FeedbackValueType', function() {
      // uncomment below and update the code to test FeedbackValueType
      //var instance = new AmazonCognitoIdentityProvider.FeedbackValueType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.FeedbackValueType);
    });
