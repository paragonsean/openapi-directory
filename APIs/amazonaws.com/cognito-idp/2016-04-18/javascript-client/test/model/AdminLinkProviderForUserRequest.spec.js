...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AdminLinkProviderForUserRequest();
  });
  ...
  describe('AdminLinkProviderForUserRequest', function() {
    it('should create an instance of AdminLinkProviderForUserRequest', function() {
      // uncomment below and update the code to test AdminLinkProviderForUserRequest
      //var instance = new AmazonCognitoIdentityProvider.AdminLinkProviderForUserRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AdminLinkProviderForUserRequest);
    });
    ...
    it('should have the property destinationUser (base name: "DestinationUser")', function() {
