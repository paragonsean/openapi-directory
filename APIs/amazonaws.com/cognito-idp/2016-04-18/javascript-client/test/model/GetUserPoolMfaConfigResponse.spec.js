...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.GetUserPoolMfaConfigResponse();
  });
  ...
  describe('GetUserPoolMfaConfigResponse', function() {
    it('should create an instance of GetUserPoolMfaConfigResponse', function() {
      // uncomment below and update the code to test GetUserPoolMfaConfigResponse
      //var instance = new AmazonCognitoIdentityProvider.GetUserPoolMfaConfigResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.GetUserPoolMfaConfigResponse);
    });
