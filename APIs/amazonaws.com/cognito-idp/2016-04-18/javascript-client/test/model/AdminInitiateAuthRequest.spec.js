...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AdminInitiateAuthRequest();
  });
  ...
  describe('AdminInitiateAuthRequest', function() {
    it('should create an instance of AdminInitiateAuthRequest', function() {
      // uncomment below and update the code to test AdminInitiateAuthRequest
      //var instance = new AmazonCognitoIdentityProvider.AdminInitiateAuthRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AdminInitiateAuthRequest);
    });
