...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.SetLogDeliveryConfigurationResponseLogDeliveryConfiguration();
  });
  ...
  describe('SetLogDeliveryConfigurationResponseLogDeliveryConfiguration', function() {
    it('should create an instance of SetLogDeliveryConfigurationResponseLogDeliveryConfiguration', function() {
      // uncomment below and update the code to test SetLogDeliveryConfigurationResponseLogDeliveryConfiguration
      //var instance = new AmazonCognitoIdentityProvider.SetLogDeliveryConfigurationResponseLogDeliveryConfiguration();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.SetLogDeliveryConfigurationResponseLogDeliveryConfiguration);
    });
    ...
    it('should have the property logConfigurations (base name: "LogConfigurations")', function() {
      // uncomment below and update the code to test the property logConfigurations
      //var instance = new AmazonCognitoIdentityProvider.SetLogDeliveryConfigurationResponseLogDeliveryConfiguration();
      //expect(instance).to.be();
    });
