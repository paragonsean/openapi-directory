...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.ForgotPasswordResponseCodeDeliveryDetails();
  });
  ...
  describe('ForgotPasswordResponseCodeDeliveryDetails', function() {
    it('should create an instance of ForgotPasswordResponseCodeDeliveryDetails', function() {
      // uncomment below and update the code to test ForgotPasswordResponseCodeDeliveryDetails
      //var instance = new AmazonCognitoIdentityProvider.ForgotPasswordResponseCodeDeliveryDetails();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.ForgotPasswordResponseCodeDeliveryDetails);
    });
