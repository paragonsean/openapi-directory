...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.ListUserImportJobsRequest();
  });
  ...
  describe('ListUserImportJobsRequest', function() {
    it('should create an instance of ListUserImportJobsRequest', function() {
      // uncomment below and update the code to test ListUserImportJobsRequest
      //var instance = new AmazonCognitoIdentityProvider.ListUserImportJobsRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.ListUserImportJobsRequest);
    });
