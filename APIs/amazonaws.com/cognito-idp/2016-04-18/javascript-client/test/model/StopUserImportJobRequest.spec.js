...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.StopUserImportJobRequest();
  });
  ...
  describe('StopUserImportJobRequest', function() {
    it('should create an instance of StopUserImportJobRequest', function() {
      // uncomment below and update the code to test StopUserImportJobRequest
      //var instance = new AmazonCognitoIdentityProvider.StopUserImportJobRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.StopUserImportJobRequest);
    });
