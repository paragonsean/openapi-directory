...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.UpdateUserAttributesResponse();
  });
  ...
  describe('UpdateUserAttributesResponse', function() {
    it('should create an instance of UpdateUserAttributesResponse', function() {
      // uncomment below and update the code to test UpdateUserAttributesResponse
      //var instance = new AmazonCognitoIdentityProvider.UpdateUserAttributesResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.UpdateUserAttributesResponse);
    });

    it('should have the property codeDeliveryDetailsList (base name: "CodeDeliveryDetailsList")', function() {
      // uncomment below and update the code to test the property codeDeliveryDetailsList
      //var instance = new AmazonCognitoIdentityProvider.UpdateUserAttributesResponse();
