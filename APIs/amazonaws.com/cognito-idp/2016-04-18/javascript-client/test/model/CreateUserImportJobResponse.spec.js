...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.CreateUserImportJobResponse();
  });
  ...
  describe('CreateUserImportJobResponse', function() {
    it('should create an instance of CreateUserImportJobResponse', function() {
      // uncomment below and update the code to test CreateUserImportJobResponse
      //var instance = new AmazonCognitoIdentityProvider.CreateUserImportJobResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.CreateUserImportJobResponse);
    });
