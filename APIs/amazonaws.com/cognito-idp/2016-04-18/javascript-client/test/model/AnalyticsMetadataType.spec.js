...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AnalyticsMetadataType();
  });
  ...
  describe('AnalyticsMetadataType', function() {
    it('should create an instance of AnalyticsMetadataType', function() {
      // uncomment below and update the code to test AnalyticsMetadataType
      //var instance = new AmazonCognitoIdentityProvider.AnalyticsMetadataType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AnalyticsMetadataType);
    });
