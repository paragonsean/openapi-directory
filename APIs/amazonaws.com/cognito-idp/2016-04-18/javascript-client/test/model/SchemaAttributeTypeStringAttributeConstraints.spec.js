...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.SchemaAttributeTypeStringAttributeConstraints();
  });
  ...
  describe('SchemaAttributeTypeStringAttributeConstraints', function() {
    it('should create an instance of SchemaAttributeTypeStringAttributeConstraints', function() {
      // uncomment below and update the code to test SchemaAttributeTypeStringAttributeConstraints
      //var instance = new AmazonCognitoIdentityProvider.SchemaAttributeTypeStringAttributeConstraints();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.SchemaAttributeTypeStringAttributeConstraints);
    });
