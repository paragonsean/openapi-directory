...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.UserPoolPolicyType();
  });
  ...
  describe('UserPoolPolicyType', function() {
    it('should create an instance of UserPoolPolicyType', function() {
      // uncomment below and update the code to test UserPoolPolicyType
      //var instance = new AmazonCognitoIdentityProvider.UserPoolPolicyType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.UserPoolPolicyType);
    });
