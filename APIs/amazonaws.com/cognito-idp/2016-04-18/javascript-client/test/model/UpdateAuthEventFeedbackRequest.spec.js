...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.UpdateAuthEventFeedbackRequest();
  });
  ...
  describe('UpdateAuthEventFeedbackRequest', function() {
    it('should create an instance of UpdateAuthEventFeedbackRequest', function() {
      // uncomment below and update the code to test UpdateAuthEventFeedbackRequest
      //var instance = new AmazonCognitoIdentityProvider.UpdateAuthEventFeedbackRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.UpdateAuthEventFeedbackRequest);
    });
