...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AccountTakeoverActionType();
  });
  ...
  describe('AccountTakeoverActionType', function() {
    it('should create an instance of AccountTakeoverActionType', function() {
      // uncomment below and update the code to test AccountTakeoverActionType
      //var instance = new AmazonCognitoIdentityProvider.AccountTakeoverActionType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AccountTakeoverActionType);
    });
