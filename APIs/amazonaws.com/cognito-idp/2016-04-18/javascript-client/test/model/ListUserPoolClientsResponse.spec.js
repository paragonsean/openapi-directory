...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.ListUserPoolClientsResponse();
  });
  ...
  describe('ListUserPoolClientsResponse', function() {
    it('should create an instance of ListUserPoolClientsResponse', function() {
      // uncomment below and update the code to test ListUserPoolClientsResponse
      //var instance = new AmazonCognitoIdentityProvider.ListUserPoolClientsResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.ListUserPoolClientsResponse);
    });

    it('should have the property userPoolClients (base name: "UserPoolClients")', function() {
      // uncomment below and update the code to test the property userPoolClients
      //var instance = new AmazonCognitoIdentityProvider.ListUserPoolClientsResponse();
