...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.DescribeUserPoolDomainResponseDomainDescription();
  });
  ...
  describe('DescribeUserPoolDomainResponseDomainDescription', function() {
    it('should create an instance of DescribeUserPoolDomainResponseDomainDescription', function() {
      // uncomment below and update the code to test DescribeUserPoolDomainResponseDomainDescription
      //var instance = new AmazonCognitoIdentityProvider.DescribeUserPoolDomainResponseDomainDescription();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.DescribeUserPoolDomainResponseDomainDescription);
    });
