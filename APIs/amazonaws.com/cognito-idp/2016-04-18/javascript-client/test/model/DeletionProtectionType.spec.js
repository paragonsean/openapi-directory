...
(function(root, factory) {
  ...
  describe('DeletionProtectionType', function() {
    it('should create an instance of DeletionProtectionType', function() {
      // uncomment below and update the code to test DeletionProtectionType
      //var instance = new AmazonCognitoIdentityProvider.DeletionProtectionType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.DeletionProtectionType);
    });
