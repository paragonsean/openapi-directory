...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.ChangePasswordRequest();
  });
  ...
  describe('ChangePasswordRequest', function() {
    it('should create an instance of ChangePasswordRequest', function() {
      ...
      //var instance = new AmazonCognitoIdentityProvider.ChangePasswordRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.ChangePasswordRequest);
    });

    it('should have the property previousPassword (base name: "PreviousPassword")', function() {
      // uncomment below and update the code to test the property previousPassword
      //var instance = new AmazonCognitoIdentityProvider.ChangePasswordRequest();
      //expect(instance).to.be();
    });

    it('should have the property proposedPassword (base name: "ProposedPassword")', function() {
      // uncomment below and update the code to test the property proposedPassword
      //var instance = new AmazonCognitoIdentityProvider.ChangePasswordRequest();
      //expect(instance).to.be();
    });
