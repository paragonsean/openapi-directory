...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.RiskConfigurationType();
  });
  ...
  describe('RiskConfigurationType', function() {
    it('should create an instance of RiskConfigurationType', function() {
      // uncomment below and update the code to test RiskConfigurationType
      //var instance = new AmazonCognitoIdentityProvider.RiskConfigurationType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.RiskConfigurationType);
    });
    ...
    it('should have the property compromisedCredentialsRiskConfiguration (base name: "CompromisedCredentialsRiskConfiguration")', function() {
      // uncomment below and update the code to test the property compromisedCredentialsRiskConfiguration
      //var instance = new AmazonCognitoIdentityProvider.RiskConfigurationType();
      //expect(instance).to.be();
    });

    it('should have the property accountTakeoverRiskConfiguration (base name: "AccountTakeoverRiskConfiguration")', function() {
      // uncomment below and update the code to test the property accountTakeoverRiskConfiguration
      //var instance = new AmazonCognitoIdentityProvider.RiskConfigurationType();
      //expect(instance).to.be();
    });

    it('should have the property riskExceptionConfiguration (base name: "RiskExceptionConfiguration")', function() {
      // uncomment below and update the code to test the property riskExceptionConfiguration
      //var instance = new AmazonCognitoIdentityProvider.RiskConfigurationType();
      //expect(instance).to.be();
    });
