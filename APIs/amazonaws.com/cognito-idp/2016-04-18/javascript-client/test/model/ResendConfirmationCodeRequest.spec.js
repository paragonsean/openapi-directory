...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.ResendConfirmationCodeRequest();
  });
  ...
  describe('ResendConfirmationCodeRequest', function() {
    it('should create an instance of ResendConfirmationCodeRequest', function() {
      // uncomment below and update the code to test ResendConfirmationCodeRequest
      //var instance = new AmazonCognitoIdentityProvider.ResendConfirmationCodeRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.ResendConfirmationCodeRequest);
    });
    ...
    it('should have the property secretHash (base name: "SecretHash")', function() {
      // uncomment below and update the code to test the property secretHash
      //var instance = new AmazonCognitoIdentityProvider.ResendConfirmationCodeRequest();
      //expect(instance).to.be();
    });
