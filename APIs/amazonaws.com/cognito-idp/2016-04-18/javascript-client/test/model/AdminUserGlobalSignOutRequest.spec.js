...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AdminUserGlobalSignOutRequest();
  });
  ...
  describe('AdminUserGlobalSignOutRequest', function() {
    it('should create an instance of AdminUserGlobalSignOutRequest', function() {
      // uncomment below and update the code to test AdminUserGlobalSignOutRequest
      //var instance = new AmazonCognitoIdentityProvider.AdminUserGlobalSignOutRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AdminUserGlobalSignOutRequest);
    });
