...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.ResendConfirmationCodeResponse();
  });
  ...
  describe('ResendConfirmationCodeResponse', function() {
    it('should create an instance of ResendConfirmationCodeResponse', function() {
      // uncomment below and update the code to test ResendConfirmationCodeResponse
      //var instance = new AmazonCognitoIdentityProvider.ResendConfirmationCodeResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.ResendConfirmationCodeResponse);
    });
