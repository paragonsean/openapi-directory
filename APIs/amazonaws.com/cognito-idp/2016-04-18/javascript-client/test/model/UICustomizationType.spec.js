...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.UICustomizationType();
  });
  ...
  describe('UICustomizationType', function() {
    it('should create an instance of UICustomizationType', function() {
      // uncomment below and update the code to test UICustomizationType
      //var instance = new AmazonCognitoIdentityProvider.UICustomizationType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.UICustomizationType);
    });
    ...
    it('should have the property cSSVersion (base name: "CSSVersion")', function() {
      // uncomment below and update the code to test the property cSSVersion
      //var instance = new AmazonCognitoIdentityProvider.UICustomizationType();
      //expect(instance).to.be();
    });
