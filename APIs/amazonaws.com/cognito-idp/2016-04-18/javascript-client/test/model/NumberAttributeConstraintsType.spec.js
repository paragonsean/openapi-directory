...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.NumberAttributeConstraintsType();
  });
  ...
  describe('NumberAttributeConstraintsType', function() {
    it('should create an instance of NumberAttributeConstraintsType', function() {
      // uncomment below and update the code to test NumberAttributeConstraintsType
      //var instance = new AmazonCognitoIdentityProvider.NumberAttributeConstraintsType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.NumberAttributeConstraintsType);
    });
