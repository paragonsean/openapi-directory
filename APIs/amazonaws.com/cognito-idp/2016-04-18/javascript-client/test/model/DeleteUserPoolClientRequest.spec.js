...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.DeleteUserPoolClientRequest();
  });
  ...
  describe('DeleteUserPoolClientRequest', function() {
    it('should create an instance of DeleteUserPoolClientRequest', function() {
      // uncomment below and update the code to test DeleteUserPoolClientRequest
      //var instance = new AmazonCognitoIdentityProvider.DeleteUserPoolClientRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.DeleteUserPoolClientRequest);
    });
