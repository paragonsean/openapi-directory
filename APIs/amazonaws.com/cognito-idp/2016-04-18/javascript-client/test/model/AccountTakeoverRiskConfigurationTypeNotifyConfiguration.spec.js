...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AccountTakeoverRiskConfigurationTypeNotifyConfiguration();
  });
  ...
  describe('AccountTakeoverRiskConfigurationTypeNotifyConfiguration', function() {
    it('should create an instance of AccountTakeoverRiskConfigurationTypeNotifyConfiguration', function() {
      // uncomment below and update the code to test AccountTakeoverRiskConfigurationTypeNotifyConfiguration
      //var instance = new AmazonCognitoIdentityProvider.AccountTakeoverRiskConfigurationTypeNotifyConfiguration();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AccountTakeoverRiskConfigurationTypeNotifyConfiguration);
    });
    ...
    it('should have the property blockEmail (base name: "BlockEmail")', function() {
      // uncomment below and update the code to test the property blockEmail
      //var instance = new AmazonCognitoIdentityProvider.AccountTakeoverRiskConfigurationTypeNotifyConfiguration();
      //expect(instance).to.be();
    });

    it('should have the property noActionEmail (base name: "NoActionEmail")', function() {
      // uncomment below and update the code to test the property noActionEmail
      //var instance = new AmazonCognitoIdentityProvider.AccountTakeoverRiskConfigurationTypeNotifyConfiguration();
      //expect(instance).to.be();
    });

    it('should have the property mfaEmail (base name: "MfaEmail")', function() {
      // uncomment below and update the code to test the property mfaEmail
      //var instance = new AmazonCognitoIdentityProvider.AccountTakeoverRiskConfigurationTypeNotifyConfiguration();
      //expect(instance).to.be();
    });
