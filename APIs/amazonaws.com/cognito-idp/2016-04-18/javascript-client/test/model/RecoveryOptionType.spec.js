...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.RecoveryOptionType();
  });
  ...
  describe('RecoveryOptionType', function() {
    it('should create an instance of RecoveryOptionType', function() {
      // uncomment below and update the code to test RecoveryOptionType
      //var instance = new AmazonCognitoIdentityProvider.RecoveryOptionType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.RecoveryOptionType);
    });
