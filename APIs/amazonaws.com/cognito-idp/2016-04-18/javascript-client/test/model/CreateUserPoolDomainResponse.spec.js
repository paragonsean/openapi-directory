...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.CreateUserPoolDomainResponse();
  });
  ...
  describe('CreateUserPoolDomainResponse', function() {
    it('should create an instance of CreateUserPoolDomainResponse', function() {
      // uncomment below and update the code to test CreateUserPoolDomainResponse
      //var instance = new AmazonCognitoIdentityProvider.CreateUserPoolDomainResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.CreateUserPoolDomainResponse);
    });
