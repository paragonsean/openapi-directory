...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.EmailConfigurationType();
  });
  ...
  describe('EmailConfigurationType', function() {
    it('should create an instance of EmailConfigurationType', function() {
      // uncomment below and update the code to test EmailConfigurationType
      //var instance = new AmazonCognitoIdentityProvider.EmailConfigurationType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.EmailConfigurationType);
    });
