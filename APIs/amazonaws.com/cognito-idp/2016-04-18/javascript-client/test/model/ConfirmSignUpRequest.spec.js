...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.ConfirmSignUpRequest();
  });
  ...
  describe('ConfirmSignUpRequest', function() {
    it('should create an instance of ConfirmSignUpRequest', function() {
      // uncomment below and update the code to test ConfirmSignUpRequest
      //var instance = new AmazonCognitoIdentityProvider.ConfirmSignUpRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.ConfirmSignUpRequest);
    });
