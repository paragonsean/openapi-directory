...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.ListUserPoolsResponse();
  });
  ...
  describe('ListUserPoolsResponse', function() {
    it('should create an instance of ListUserPoolsResponse', function() {
      // uncomment below and update the code to test ListUserPoolsResponse
      //var instance = new AmazonCognitoIdentityProvider.ListUserPoolsResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.ListUserPoolsResponse);
    });

    it('should have the property userPools (base name: "UserPools")', function() {
      // uncomment below and update the code to test the property userPools
      //var instance = new AmazonCognitoIdentityProvider.ListUserPoolsResponse();
