...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.UpdateUserPoolRequestPolicies();
  });
  ...
  describe('UpdateUserPoolRequestPolicies', function() {
    it('should create an instance of UpdateUserPoolRequestPolicies', function() {
      // uncomment below and update the code to test UpdateUserPoolRequestPolicies
      //var instance = new AmazonCognitoIdentityProvider.UpdateUserPoolRequestPolicies();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.UpdateUserPoolRequestPolicies);
    });
