...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.ResendConfirmationCodeResponseCodeDeliveryDetails();
  });
  ...
  describe('ResendConfirmationCodeResponseCodeDeliveryDetails', function() {
    it('should create an instance of ResendConfirmationCodeResponseCodeDeliveryDetails', function() {
      // uncomment below and update the code to test ResendConfirmationCodeResponseCodeDeliveryDetails
      //var instance = new AmazonCognitoIdentityProvider.ResendConfirmationCodeResponseCodeDeliveryDetails();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.ResendConfirmationCodeResponseCodeDeliveryDetails);
    });
