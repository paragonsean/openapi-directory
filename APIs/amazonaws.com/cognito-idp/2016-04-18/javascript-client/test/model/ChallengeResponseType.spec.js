...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.ChallengeResponseType();
  });
  ...
  describe('ChallengeResponseType', function() {
    it('should create an instance of ChallengeResponseType', function() {
      // uncomment below and update the code to test ChallengeResponseType
      //var instance = new AmazonCognitoIdentityProvider.ChallengeResponseType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.ChallengeResponseType);
    });
