...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.CreateUserPoolRequestAccountRecoverySetting();
  });
  ...
  describe('CreateUserPoolRequestAccountRecoverySetting', function() {
    it('should create an instance of CreateUserPoolRequestAccountRecoverySetting', function() {
      // uncomment below and update the code to test CreateUserPoolRequestAccountRecoverySetting
      //var instance = new AmazonCognitoIdentityProvider.CreateUserPoolRequestAccountRecoverySetting();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.CreateUserPoolRequestAccountRecoverySetting);
    });

    it('should have the property recoveryMechanisms (base name: "RecoveryMechanisms")', function() {
      // uncomment below and update the code to test the property recoveryMechanisms
      //var instance = new AmazonCognitoIdentityProvider.CreateUserPoolRequestAccountRecoverySetting();
