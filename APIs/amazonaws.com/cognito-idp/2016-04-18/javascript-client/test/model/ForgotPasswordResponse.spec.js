...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.ForgotPasswordResponse();
  });
  ...
  describe('ForgotPasswordResponse', function() {
    it('should create an instance of ForgotPasswordResponse', function() {
      ...
      //var instance = new AmazonCognitoIdentityProvider.ForgotPasswordResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.ForgotPasswordResponse);
    });
