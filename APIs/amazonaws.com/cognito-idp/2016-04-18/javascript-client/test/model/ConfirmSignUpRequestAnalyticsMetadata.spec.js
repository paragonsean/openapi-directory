...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.ConfirmSignUpRequestAnalyticsMetadata();
  });
  ...
  describe('ConfirmSignUpRequestAnalyticsMetadata', function() {
    it('should create an instance of ConfirmSignUpRequestAnalyticsMetadata', function() {
      // uncomment below and update the code to test ConfirmSignUpRequestAnalyticsMetadata
      //var instance = new AmazonCognitoIdentityProvider.ConfirmSignUpRequestAnalyticsMetadata();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.ConfirmSignUpRequestAnalyticsMetadata);
    });
