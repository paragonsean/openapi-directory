...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.VerifyUserAttributeRequest();
  });
  ...
  describe('VerifyUserAttributeRequest', function() {
    it('should create an instance of VerifyUserAttributeRequest', function() {
      // uncomment below and update the code to test VerifyUserAttributeRequest
      //var instance = new AmazonCognitoIdentityProvider.VerifyUserAttributeRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.VerifyUserAttributeRequest);
    });
