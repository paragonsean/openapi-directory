...
(function(root, factory) {
  ...
  describe('OAuthFlowType', function() {
    it('should create an instance of OAuthFlowType', function() {
      // uncomment below and update the code to test OAuthFlowType
      //var instance = new AmazonCognitoIdentityProvider.OAuthFlowType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.OAuthFlowType);
    });
