...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.CustomDomainConfigType();
  });
  ...
  describe('CustomDomainConfigType', function() {
    it('should create an instance of CustomDomainConfigType', function() {
      // uncomment below and update the code to test CustomDomainConfigType
      //var instance = new AmazonCognitoIdentityProvider.CustomDomainConfigType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.CustomDomainConfigType);
    });
