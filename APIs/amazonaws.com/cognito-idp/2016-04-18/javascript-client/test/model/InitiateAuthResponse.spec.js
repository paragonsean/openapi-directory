...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.InitiateAuthResponse();
  });
  ...
  describe('InitiateAuthResponse', function() {
    it('should create an instance of InitiateAuthResponse', function() {
      // uncomment below and update the code to test InitiateAuthResponse
      //var instance = new AmazonCognitoIdentityProvider.InitiateAuthResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.InitiateAuthResponse);
    });
