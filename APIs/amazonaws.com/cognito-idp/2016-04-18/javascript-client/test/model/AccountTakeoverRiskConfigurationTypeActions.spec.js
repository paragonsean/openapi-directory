...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AccountTakeoverRiskConfigurationTypeActions();
  });
  ...
  describe('AccountTakeoverRiskConfigurationTypeActions', function() {
    it('should create an instance of AccountTakeoverRiskConfigurationTypeActions', function() {
      // uncomment below and update the code to test AccountTakeoverRiskConfigurationTypeActions
      //var instance = new AmazonCognitoIdentityProvider.AccountTakeoverRiskConfigurationTypeActions();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AccountTakeoverRiskConfigurationTypeActions);
    });

    it('should have the property lowAction (base name: "LowAction")', function() {
      // uncomment below and update the code to test the property lowAction
      //var instance = new AmazonCognitoIdentityProvider.AccountTakeoverRiskConfigurationTypeActions();
      //expect(instance).to.be();
    });

    it('should have the property mediumAction (base name: "MediumAction")', function() {
      // uncomment below and update the code to test the property mediumAction
      //var instance = new AmazonCognitoIdentityProvider.AccountTakeoverRiskConfigurationTypeActions();
      //expect(instance).to.be();
    });

    it('should have the property highAction (base name: "HighAction")', function() {
      // uncomment below and update the code to test the property highAction
      //var instance = new AmazonCognitoIdentityProvider.AccountTakeoverRiskConfigurationTypeActions();
      //expect(instance).to.be();
    });
