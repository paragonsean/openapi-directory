...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.CreateUserPoolClientRequestAnalyticsConfiguration();
  });
  ...
  describe('CreateUserPoolClientRequestAnalyticsConfiguration', function() {
    it('should create an instance of CreateUserPoolClientRequestAnalyticsConfiguration', function() {
      // uncomment below and update the code to test CreateUserPoolClientRequestAnalyticsConfiguration
      //var instance = new AmazonCognitoIdentityProvider.CreateUserPoolClientRequestAnalyticsConfiguration();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.CreateUserPoolClientRequestAnalyticsConfiguration);
    });
