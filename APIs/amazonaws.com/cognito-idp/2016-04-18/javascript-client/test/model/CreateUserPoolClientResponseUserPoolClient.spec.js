...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.CreateUserPoolClientResponseUserPoolClient();
  });
  ...
  describe('CreateUserPoolClientResponseUserPoolClient', function() {
    it('should create an instance of CreateUserPoolClientResponseUserPoolClient', function() {
      // uncomment below and update the code to test CreateUserPoolClientResponseUserPoolClient
      //var instance = new AmazonCognitoIdentityProvider.CreateUserPoolClientResponseUserPoolClient();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.CreateUserPoolClientResponseUserPoolClient);
    });
