...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.LambdaConfigType();
  });
  ...
  describe('LambdaConfigType', function() {
    it('should create an instance of LambdaConfigType', function() {
      // uncomment below and update the code to test LambdaConfigType
      //var instance = new AmazonCognitoIdentityProvider.LambdaConfigType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.LambdaConfigType);
    });
