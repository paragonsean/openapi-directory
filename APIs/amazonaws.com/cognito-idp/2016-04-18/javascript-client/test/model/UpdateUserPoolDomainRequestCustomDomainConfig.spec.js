...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.UpdateUserPoolDomainRequestCustomDomainConfig();
  });
  ...
  describe('UpdateUserPoolDomainRequestCustomDomainConfig', function() {
    it('should create an instance of UpdateUserPoolDomainRequestCustomDomainConfig', function() {
      // uncomment below and update the code to test UpdateUserPoolDomainRequestCustomDomainConfig
      //var instance = new AmazonCognitoIdentityProvider.UpdateUserPoolDomainRequestCustomDomainConfig();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.UpdateUserPoolDomainRequestCustomDomainConfig);
    });
