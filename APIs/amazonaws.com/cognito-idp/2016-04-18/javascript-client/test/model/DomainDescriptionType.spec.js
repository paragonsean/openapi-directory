...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.DomainDescriptionType();
  });
  ...
  describe('DomainDescriptionType', function() {
    it('should create an instance of DomainDescriptionType', function() {
      // uncomment below and update the code to test DomainDescriptionType
      //var instance = new AmazonCognitoIdentityProvider.DomainDescriptionType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.DomainDescriptionType);
    });
    ...
    it('should have the property cloudFrontDistribution (base name: "CloudFrontDistribution")', function() {
      // uncomment below and update the code to test the property cloudFrontDistribution
      //var instance = new AmazonCognitoIdentityProvider.DomainDescriptionType();
      //expect(instance).to.be();
    });
    ...
    it('should have the property customDomainConfig (base name: "CustomDomainConfig")', function() {
      // uncomment below and update the code to test the property customDomainConfig
      //var instance = new AmazonCognitoIdentityProvider.DomainDescriptionType();
      //expect(instance).to.be();
    });
