...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.SetRiskConfigurationResponse();
  });
  ...
  describe('SetRiskConfigurationResponse', function() {
    it('should create an instance of SetRiskConfigurationResponse', function() {
      // uncomment below and update the code to test SetRiskConfigurationResponse
      //var instance = new AmazonCognitoIdentityProvider.SetRiskConfigurationResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.SetRiskConfigurationResponse);
    });

    it('should have the property riskConfiguration (base name: "RiskConfiguration")', function() {
      // uncomment below and update the code to test the property riskConfiguration
      //var instance = new AmazonCognitoIdentityProvider.SetRiskConfigurationResponse();
