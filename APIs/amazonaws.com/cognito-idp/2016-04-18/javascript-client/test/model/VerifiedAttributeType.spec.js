...
(function(root, factory) {
  ...
  describe('VerifiedAttributeType', function() {
    it('should create an instance of VerifiedAttributeType', function() {
      // uncomment below and update the code to test VerifiedAttributeType
      //var instance = new AmazonCognitoIdentityProvider.VerifiedAttributeType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.VerifiedAttributeType);
    });
