...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AdminInitiateAuthResponse();
  });
  ...
  describe('AdminInitiateAuthResponse', function() {
    it('should create an instance of AdminInitiateAuthResponse', function() {
      // uncomment below and update the code to test AdminInitiateAuthResponse
      //var instance = new AmazonCognitoIdentityProvider.AdminInitiateAuthResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AdminInitiateAuthResponse);
    });
