...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.CreateGroupRequest();
  });
  ...
  describe('CreateGroupRequest', function() {
    it('should create an instance of CreateGroupRequest', function() {
      ...
      //var instance = new AmazonCognitoIdentityProvider.CreateGroupRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.CreateGroupRequest);
    });
