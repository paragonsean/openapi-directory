...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.UpdateResourceServerRequest();
  });
  ...
  describe('UpdateResourceServerRequest', function() {
    it('should create an instance of UpdateResourceServerRequest', function() {
      // uncomment below and update the code to test UpdateResourceServerRequest
      //var instance = new AmazonCognitoIdentityProvider.UpdateResourceServerRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.UpdateResourceServerRequest);
    });
