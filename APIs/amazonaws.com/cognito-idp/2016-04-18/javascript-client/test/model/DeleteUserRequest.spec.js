...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.DeleteUserRequest();
  });
  ...
  describe('DeleteUserRequest', function() {
    it('should create an instance of DeleteUserRequest', function() {
      ...
      //var instance = new AmazonCognitoIdentityProvider.DeleteUserRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.DeleteUserRequest);
    });
