...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.SetUserPoolMfaConfigResponse();
  });
  ...
  describe('SetUserPoolMfaConfigResponse', function() {
    it('should create an instance of SetUserPoolMfaConfigResponse', function() {
      // uncomment below and update the code to test SetUserPoolMfaConfigResponse
      //var instance = new AmazonCognitoIdentityProvider.SetUserPoolMfaConfigResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.SetUserPoolMfaConfigResponse);
    });
