...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.SetRiskConfigurationRequestCompromisedCredentialsRiskConfiguration();
  });
  ...
  describe('SetRiskConfigurationRequestCompromisedCredentialsRiskConfiguration', function() {
    it('should create an instance of SetRiskConfigurationRequestCompromisedCredentialsRiskConfiguration', function() {
      // uncomment below and update the code to test SetRiskConfigurationRequestCompromisedCredentialsRiskConfiguration
      //var instance = new AmazonCognitoIdentityProvider.SetRiskConfigurationRequestCompromisedCredentialsRiskConfiguration();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.SetRiskConfigurationRequestCompromisedCredentialsRiskConfiguration);
    });
