...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.StringAttributeConstraintsType();
  });
  ...
  describe('StringAttributeConstraintsType', function() {
    it('should create an instance of StringAttributeConstraintsType', function() {
      // uncomment below and update the code to test StringAttributeConstraintsType
      //var instance = new AmazonCognitoIdentityProvider.StringAttributeConstraintsType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.StringAttributeConstraintsType);
    });
