...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AdminGetUserRequest();
  });
  ...
  describe('AdminGetUserRequest', function() {
    it('should create an instance of AdminGetUserRequest', function() {
      // uncomment below and update the code to test AdminGetUserRequest
      //var instance = new AmazonCognitoIdentityProvider.AdminGetUserRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AdminGetUserRequest);
    });
