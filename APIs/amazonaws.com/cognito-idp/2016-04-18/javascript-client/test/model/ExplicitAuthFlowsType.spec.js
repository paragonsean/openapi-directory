...
(function(root, factory) {
  ...
  describe('ExplicitAuthFlowsType', function() {
    it('should create an instance of ExplicitAuthFlowsType', function() {
      // uncomment below and update the code to test ExplicitAuthFlowsType
      //var instance = new AmazonCognitoIdentityProvider.ExplicitAuthFlowsType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.ExplicitAuthFlowsType);
    });
