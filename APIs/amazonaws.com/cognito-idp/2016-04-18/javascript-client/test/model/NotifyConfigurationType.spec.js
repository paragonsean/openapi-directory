...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.NotifyConfigurationType();
  });
  ...
  describe('NotifyConfigurationType', function() {
    it('should create an instance of NotifyConfigurationType', function() {
      // uncomment below and update the code to test NotifyConfigurationType
      //var instance = new AmazonCognitoIdentityProvider.NotifyConfigurationType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.NotifyConfigurationType);
    });
