...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.EventContextDataType();
  });
  ...
  describe('EventContextDataType', function() {
    it('should create an instance of EventContextDataType', function() {
      // uncomment below and update the code to test EventContextDataType
      //var instance = new AmazonCognitoIdentityProvider.EventContextDataType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.EventContextDataType);
    });
