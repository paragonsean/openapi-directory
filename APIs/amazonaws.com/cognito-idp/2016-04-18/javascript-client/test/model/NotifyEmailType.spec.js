...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.NotifyEmailType();
  });
  ...
  describe('NotifyEmailType', function() {
    it('should create an instance of NotifyEmailType', function() {
      // uncomment below and update the code to test NotifyEmailType
      //var instance = new AmazonCognitoIdentityProvider.NotifyEmailType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.NotifyEmailType);
    });
