...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.DeleteUserPoolRequest();
  });
  ...
  describe('DeleteUserPoolRequest', function() {
    it('should create an instance of DeleteUserPoolRequest', function() {
      // uncomment below and update the code to test DeleteUserPoolRequest
      //var instance = new AmazonCognitoIdentityProvider.DeleteUserPoolRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.DeleteUserPoolRequest);
    });
