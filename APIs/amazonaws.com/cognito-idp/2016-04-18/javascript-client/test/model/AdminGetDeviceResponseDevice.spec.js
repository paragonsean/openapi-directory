...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AdminGetDeviceResponseDevice();
  });
  ...
  describe('AdminGetDeviceResponseDevice', function() {
    it('should create an instance of AdminGetDeviceResponseDevice', function() {
      // uncomment below and update the code to test AdminGetDeviceResponseDevice
      //var instance = new AmazonCognitoIdentityProvider.AdminGetDeviceResponseDevice();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AdminGetDeviceResponseDevice);
    });
    ...
    it('should have the property deviceCreateDate (base name: "DeviceCreateDate")', function() {
      // uncomment below and update the code to test the property deviceCreateDate
      //var instance = new AmazonCognitoIdentityProvider.AdminGetDeviceResponseDevice();
      //expect(instance).to.be();
    });
    ...
    it('should have the property deviceLastAuthenticatedDate (base name: "DeviceLastAuthenticatedDate")', function() {
      // uncomment below and update the code to test the property deviceLastAuthenticatedDate
      //var instance = new AmazonCognitoIdentityProvider.AdminGetDeviceResponseDevice();
      //expect(instance).to.be();
    });
