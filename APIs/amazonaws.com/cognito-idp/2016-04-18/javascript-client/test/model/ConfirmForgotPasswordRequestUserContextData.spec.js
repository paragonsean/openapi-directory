...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.ConfirmForgotPasswordRequestUserContextData();
  });
  ...
  describe('ConfirmForgotPasswordRequestUserContextData', function() {
    it('should create an instance of ConfirmForgotPasswordRequestUserContextData', function() {
      // uncomment below and update the code to test ConfirmForgotPasswordRequestUserContextData
      //var instance = new AmazonCognitoIdentityProvider.ConfirmForgotPasswordRequestUserContextData();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.ConfirmForgotPasswordRequestUserContextData);
    });
