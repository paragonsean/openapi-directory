...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.DescribeRiskConfigurationRequest();
  });
  ...
  describe('DescribeRiskConfigurationRequest', function() {
    it('should create an instance of DescribeRiskConfigurationRequest', function() {
      // uncomment below and update the code to test DescribeRiskConfigurationRequest
      //var instance = new AmazonCognitoIdentityProvider.DescribeRiskConfigurationRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.DescribeRiskConfigurationRequest);
    });
