...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.GetCSVHeaderRequest();
  });
  ...
  describe('GetCSVHeaderRequest', function() {
    it('should create an instance of GetCSVHeaderRequest', function() {
      // uncomment below and update the code to test GetCSVHeaderRequest
      //var instance = new AmazonCognitoIdentityProvider.GetCSVHeaderRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.GetCSVHeaderRequest);
    });
