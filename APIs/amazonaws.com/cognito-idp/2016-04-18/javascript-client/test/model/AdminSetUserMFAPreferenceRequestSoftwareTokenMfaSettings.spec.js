...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AdminSetUserMFAPreferenceRequestSoftwareTokenMfaSettings();
  });
  ...
  describe('AdminSetUserMFAPreferenceRequestSoftwareTokenMfaSettings', function() {
    it('should create an instance of AdminSetUserMFAPreferenceRequestSoftwareTokenMfaSettings', function() {
      // uncomment below and update the code to test AdminSetUserMFAPreferenceRequestSoftwareTokenMfaSettings
      //var instance = new AmazonCognitoIdentityProvider.AdminSetUserMFAPreferenceRequestSoftwareTokenMfaSettings();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AdminSetUserMFAPreferenceRequestSoftwareTokenMfaSettings);
    });
