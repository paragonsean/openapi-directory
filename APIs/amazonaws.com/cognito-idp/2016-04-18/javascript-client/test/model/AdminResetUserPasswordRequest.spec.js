...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AdminResetUserPasswordRequest();
  });
  ...
  describe('AdminResetUserPasswordRequest', function() {
    it('should create an instance of AdminResetUserPasswordRequest', function() {
      // uncomment below and update the code to test AdminResetUserPasswordRequest
      //var instance = new AmazonCognitoIdentityProvider.AdminResetUserPasswordRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AdminResetUserPasswordRequest);
    });
