...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.SchemaAttributeTypeNumberAttributeConstraints();
  });
  ...
  describe('SchemaAttributeTypeNumberAttributeConstraints', function() {
    it('should create an instance of SchemaAttributeTypeNumberAttributeConstraints', function() {
      // uncomment below and update the code to test SchemaAttributeTypeNumberAttributeConstraints
      //var instance = new AmazonCognitoIdentityProvider.SchemaAttributeTypeNumberAttributeConstraints();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.SchemaAttributeTypeNumberAttributeConstraints);
    });
