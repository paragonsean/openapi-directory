...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.CreateUserPoolRequestUsernameConfiguration();
  });
  ...
  describe('CreateUserPoolRequestUsernameConfiguration', function() {
    it('should create an instance of CreateUserPoolRequestUsernameConfiguration', function() {
      // uncomment below and update the code to test CreateUserPoolRequestUsernameConfiguration
      //var instance = new AmazonCognitoIdentityProvider.CreateUserPoolRequestUsernameConfiguration();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.CreateUserPoolRequestUsernameConfiguration);
    });
