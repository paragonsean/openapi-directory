...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.SignUpResponse();
  });
  ...
  describe('SignUpResponse', function() {
    it('should create an instance of SignUpResponse', function() {
      ...
      //var instance = new AmazonCognitoIdentityProvider.SignUpResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.SignUpResponse);
    });

    it('should have the property userConfirmed (base name: "UserConfirmed")', function() {
      // uncomment below and update the code to test the property userConfirmed
      //var instance = new AmazonCognitoIdentityProvider.SignUpResponse();
    ...
    it('should have the property userSub (base name: "UserSub")', function() {
      // uncomment below and update the code to test the property userSub
      //var instance = new AmazonCognitoIdentityProvider.SignUpResponse();
      //expect(instance).to.be();
    });
