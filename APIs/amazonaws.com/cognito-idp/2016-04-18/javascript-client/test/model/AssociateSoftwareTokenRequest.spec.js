...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AssociateSoftwareTokenRequest();
  });
  ...
  describe('AssociateSoftwareTokenRequest', function() {
    it('should create an instance of AssociateSoftwareTokenRequest', function() {
      // uncomment below and update the code to test AssociateSoftwareTokenRequest
      //var instance = new AmazonCognitoIdentityProvider.AssociateSoftwareTokenRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AssociateSoftwareTokenRequest);
    });
