...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.UpdateGroupResponse();
  });
  ...
  describe('UpdateGroupResponse', function() {
    it('should create an instance of UpdateGroupResponse', function() {
      // uncomment below and update the code to test UpdateGroupResponse
      //var instance = new AmazonCognitoIdentityProvider.UpdateGroupResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.UpdateGroupResponse);
    });
