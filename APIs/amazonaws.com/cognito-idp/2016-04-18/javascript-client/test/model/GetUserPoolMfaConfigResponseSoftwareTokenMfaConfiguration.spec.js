...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.GetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration();
  });
  ...
  describe('GetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration', function() {
    it('should create an instance of GetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration', function() {
      // uncomment below and update the code to test GetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration
      //var instance = new AmazonCognitoIdentityProvider.GetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.GetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration);
    });
