...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.GetSigningCertificateRequest();
  });
  ...
  describe('GetSigningCertificateRequest', function() {
    it('should create an instance of GetSigningCertificateRequest', function() {
      // uncomment below and update the code to test GetSigningCertificateRequest
      //var instance = new AmazonCognitoIdentityProvider.GetSigningCertificateRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.GetSigningCertificateRequest);
    });
