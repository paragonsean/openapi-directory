...
(function(root, factory) {
  ...
  describe('CustomSMSSenderLambdaVersionType', function() {
    it('should create an instance of CustomSMSSenderLambdaVersionType', function() {
      // uncomment below and update the code to test CustomSMSSenderLambdaVersionType
      //var instance = new AmazonCognitoIdentityProvider.CustomSMSSenderLambdaVersionType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.CustomSMSSenderLambdaVersionType);
    });
