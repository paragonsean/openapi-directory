...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.GetUserResponse();
  });
  ...
  describe('GetUserResponse', function() {
    it('should create an instance of GetUserResponse', function() {
      ...
      //var instance = new AmazonCognitoIdentityProvider.GetUserResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.GetUserResponse);
    });
