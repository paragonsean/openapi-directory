...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.GetLogDeliveryConfigurationRequest();
  });
  ...
  describe('GetLogDeliveryConfigurationRequest', function() {
    it('should create an instance of GetLogDeliveryConfigurationRequest', function() {
      // uncomment below and update the code to test GetLogDeliveryConfigurationRequest
      //var instance = new AmazonCognitoIdentityProvider.GetLogDeliveryConfigurationRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.GetLogDeliveryConfigurationRequest);
    });
