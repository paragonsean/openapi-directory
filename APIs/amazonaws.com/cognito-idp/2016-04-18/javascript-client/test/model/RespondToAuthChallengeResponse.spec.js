...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.RespondToAuthChallengeResponse();
  });
  ...
  describe('RespondToAuthChallengeResponse', function() {
    it('should create an instance of RespondToAuthChallengeResponse', function() {
      // uncomment below and update the code to test RespondToAuthChallengeResponse
      //var instance = new AmazonCognitoIdentityProvider.RespondToAuthChallengeResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.RespondToAuthChallengeResponse);
    });
    ...
    it('should have the property challengeParameters (base name: "ChallengeParameters")', function() {
      // uncomment below and update the code to test the property challengeParameters
      //var instance = new AmazonCognitoIdentityProvider.RespondToAuthChallengeResponse();
      //expect(instance).to.be();
    });
