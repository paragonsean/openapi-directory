...
(function(root, factory) {
  ...
  describe('PreventUserExistenceErrorTypes', function() {
    it('should create an instance of PreventUserExistenceErrorTypes', function() {
      // uncomment below and update the code to test PreventUserExistenceErrorTypes
      //var instance = new AmazonCognitoIdentityProvider.PreventUserExistenceErrorTypes();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.PreventUserExistenceErrorTypes);
    });
