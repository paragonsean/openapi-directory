...
(function(root, factory) {
  ...
  describe('DomainStatusType', function() {
    it('should create an instance of DomainStatusType', function() {
      // uncomment below and update the code to test DomainStatusType
      //var instance = new AmazonCognitoIdentityProvider.DomainStatusType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.DomainStatusType);
    });
