...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.UserPoolAddOnsType();
  });
  ...
  describe('UserPoolAddOnsType', function() {
    it('should create an instance of UserPoolAddOnsType', function() {
      // uncomment below and update the code to test UserPoolAddOnsType
      //var instance = new AmazonCognitoIdentityProvider.UserPoolAddOnsType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.UserPoolAddOnsType);
    });

    it('should have the property advancedSecurityMode (base name: "AdvancedSecurityMode")', function() {
      // uncomment below and update the code to test the property advancedSecurityMode
      //var instance = new AmazonCognitoIdentityProvider.UserPoolAddOnsType();
