...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AuthEventTypeEventFeedback();
  });
  ...
  describe('AuthEventTypeEventFeedback', function() {
    it('should create an instance of AuthEventTypeEventFeedback', function() {
      // uncomment below and update the code to test AuthEventTypeEventFeedback
      //var instance = new AmazonCognitoIdentityProvider.AuthEventTypeEventFeedback();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AuthEventTypeEventFeedback);
    });
