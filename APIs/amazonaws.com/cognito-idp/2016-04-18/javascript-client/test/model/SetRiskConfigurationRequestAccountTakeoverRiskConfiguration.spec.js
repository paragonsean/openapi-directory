...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.SetRiskConfigurationRequestAccountTakeoverRiskConfiguration();
  });
  ...
  describe('SetRiskConfigurationRequestAccountTakeoverRiskConfiguration', function() {
    it('should create an instance of SetRiskConfigurationRequestAccountTakeoverRiskConfiguration', function() {
      // uncomment below and update the code to test SetRiskConfigurationRequestAccountTakeoverRiskConfiguration
      //var instance = new AmazonCognitoIdentityProvider.SetRiskConfigurationRequestAccountTakeoverRiskConfiguration();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.SetRiskConfigurationRequestAccountTakeoverRiskConfiguration);
    });

    it('should have the property notifyConfiguration (base name: "NotifyConfiguration")', function() {
      // uncomment below and update the code to test the property notifyConfiguration
      //var instance = new AmazonCognitoIdentityProvider.SetRiskConfigurationRequestAccountTakeoverRiskConfiguration();
