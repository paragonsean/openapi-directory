...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.InitiateAuthRequest();
  });
  ...
  describe('InitiateAuthRequest', function() {
    it('should create an instance of InitiateAuthRequest', function() {
      // uncomment below and update the code to test InitiateAuthRequest
      //var instance = new AmazonCognitoIdentityProvider.InitiateAuthRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.InitiateAuthRequest);
    });

    it('should have the property authFlow (base name: "AuthFlow")', function() {
      // uncomment below and update the code to test the property authFlow
      //var instance = new AmazonCognitoIdentityProvider.InitiateAuthRequest();
      //expect(instance).to.be();
    });

    it('should have the property authParameters (base name: "AuthParameters")', function() {
      // uncomment below and update the code to test the property authParameters
      //var instance = new AmazonCognitoIdentityProvider.InitiateAuthRequest();
      //expect(instance).to.be();
    });
