...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.DeleteUserPoolDomainRequest();
  });
  ...
  describe('DeleteUserPoolDomainRequest', function() {
    it('should create an instance of DeleteUserPoolDomainRequest', function() {
      // uncomment below and update the code to test DeleteUserPoolDomainRequest
      //var instance = new AmazonCognitoIdentityProvider.DeleteUserPoolDomainRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.DeleteUserPoolDomainRequest);
    });
