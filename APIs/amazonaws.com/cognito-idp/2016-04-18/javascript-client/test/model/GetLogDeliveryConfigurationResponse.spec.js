...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.GetLogDeliveryConfigurationResponse();
  });
  ...
  describe('GetLogDeliveryConfigurationResponse', function() {
    it('should create an instance of GetLogDeliveryConfigurationResponse', function() {
      // uncomment below and update the code to test GetLogDeliveryConfigurationResponse
      //var instance = new AmazonCognitoIdentityProvider.GetLogDeliveryConfigurationResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.GetLogDeliveryConfigurationResponse);
    });
