...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AdminRespondToAuthChallengeRequest();
  });
  ...
  describe('AdminRespondToAuthChallengeRequest', function() {
    it('should create an instance of AdminRespondToAuthChallengeRequest', function() {
      // uncomment below and update the code to test AdminRespondToAuthChallengeRequest
      //var instance = new AmazonCognitoIdentityProvider.AdminRespondToAuthChallengeRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AdminRespondToAuthChallengeRequest);
    });
    ...
    it('should have the property challengeResponses (base name: "ChallengeResponses")', function() {
      // uncomment below and update the code to test the property challengeResponses
      //var instance = new AmazonCognitoIdentityProvider.AdminRespondToAuthChallengeRequest();
      //expect(instance).to.be();
    });
    ...
    it('should have the property analyticsMetadata (base name: "AnalyticsMetadata")', function() {
      // uncomment below and update the code to test the property analyticsMetadata
      //var instance = new AmazonCognitoIdentityProvider.AdminRespondToAuthChallengeRequest();
      //expect(instance).to.be();
    });

    it('should have the property contextData (base name: "ContextData")', function() {
      // uncomment below and update the code to test the property contextData
      //var instance = new AmazonCognitoIdentityProvider.AdminRespondToAuthChallengeRequest();
      //expect(instance).to.be();
    });
