...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.DescribeUserImportJobRequest();
  });
  ...
  describe('DescribeUserImportJobRequest', function() {
    it('should create an instance of DescribeUserImportJobRequest', function() {
      // uncomment below and update the code to test DescribeUserImportJobRequest
      //var instance = new AmazonCognitoIdentityProvider.DescribeUserImportJobRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.DescribeUserImportJobRequest);
    });
