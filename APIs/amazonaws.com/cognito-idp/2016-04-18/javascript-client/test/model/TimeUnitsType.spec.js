...
(function(root, factory) {
  ...
  describe('TimeUnitsType', function() {
    it('should create an instance of TimeUnitsType', function() {
      // uncomment below and update the code to test TimeUnitsType
      //var instance = new AmazonCognitoIdentityProvider.TimeUnitsType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.TimeUnitsType);
    });
