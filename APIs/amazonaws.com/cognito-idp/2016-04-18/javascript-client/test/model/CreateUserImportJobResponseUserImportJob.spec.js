...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.CreateUserImportJobResponseUserImportJob();
  });
  ...
  describe('CreateUserImportJobResponseUserImportJob', function() {
    it('should create an instance of CreateUserImportJobResponseUserImportJob', function() {
      // uncomment below and update the code to test CreateUserImportJobResponseUserImportJob
      //var instance = new AmazonCognitoIdentityProvider.CreateUserImportJobResponseUserImportJob();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.CreateUserImportJobResponseUserImportJob);
    });
