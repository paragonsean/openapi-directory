...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AdminSetUserSettingsRequest();
  });
  ...
  describe('AdminSetUserSettingsRequest', function() {
    it('should create an instance of AdminSetUserSettingsRequest', function() {
      // uncomment below and update the code to test AdminSetUserSettingsRequest
      //var instance = new AmazonCognitoIdentityProvider.AdminSetUserSettingsRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AdminSetUserSettingsRequest);
    });
