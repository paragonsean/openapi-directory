...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.CustomEmailLambdaVersionConfigType();
  });
  ...
  describe('CustomEmailLambdaVersionConfigType', function() {
    it('should create an instance of CustomEmailLambdaVersionConfigType', function() {
      // uncomment below and update the code to test CustomEmailLambdaVersionConfigType
      //var instance = new AmazonCognitoIdentityProvider.CustomEmailLambdaVersionConfigType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.CustomEmailLambdaVersionConfigType);
    });
