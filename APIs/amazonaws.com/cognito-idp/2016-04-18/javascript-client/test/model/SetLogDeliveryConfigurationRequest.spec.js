...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.SetLogDeliveryConfigurationRequest();
  });
  ...
  describe('SetLogDeliveryConfigurationRequest', function() {
    it('should create an instance of SetLogDeliveryConfigurationRequest', function() {
      // uncomment below and update the code to test SetLogDeliveryConfigurationRequest
      //var instance = new AmazonCognitoIdentityProvider.SetLogDeliveryConfigurationRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.SetLogDeliveryConfigurationRequest);
    });
