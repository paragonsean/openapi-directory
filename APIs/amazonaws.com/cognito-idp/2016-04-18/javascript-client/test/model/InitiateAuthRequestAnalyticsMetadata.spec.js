...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.InitiateAuthRequestAnalyticsMetadata();
  });
  ...
  describe('InitiateAuthRequestAnalyticsMetadata', function() {
    it('should create an instance of InitiateAuthRequestAnalyticsMetadata', function() {
      // uncomment below and update the code to test InitiateAuthRequestAnalyticsMetadata
      //var instance = new AmazonCognitoIdentityProvider.InitiateAuthRequestAnalyticsMetadata();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.InitiateAuthRequestAnalyticsMetadata);
    });
