...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.ConfirmDeviceRequestDeviceSecretVerifierConfig();
  });
  ...
  describe('ConfirmDeviceRequestDeviceSecretVerifierConfig', function() {
    it('should create an instance of ConfirmDeviceRequestDeviceSecretVerifierConfig', function() {
      // uncomment below and update the code to test ConfirmDeviceRequestDeviceSecretVerifierConfig
      //var instance = new AmazonCognitoIdentityProvider.ConfirmDeviceRequestDeviceSecretVerifierConfig();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.ConfirmDeviceRequestDeviceSecretVerifierConfig);
    });
