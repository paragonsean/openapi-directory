...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.CloudWatchLogsConfigurationType();
  });
  ...
  describe('CloudWatchLogsConfigurationType', function() {
    it('should create an instance of CloudWatchLogsConfigurationType', function() {
      // uncomment below and update the code to test CloudWatchLogsConfigurationType
      //var instance = new AmazonCognitoIdentityProvider.CloudWatchLogsConfigurationType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.CloudWatchLogsConfigurationType);
    });
