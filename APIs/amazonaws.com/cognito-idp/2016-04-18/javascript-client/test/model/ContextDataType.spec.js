...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.ContextDataType();
  });
  ...
  describe('ContextDataType', function() {
    it('should create an instance of ContextDataType', function() {
      // uncomment below and update the code to test ContextDataType
      //var instance = new AmazonCognitoIdentityProvider.ContextDataType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.ContextDataType);
    });
    ...
    it('should have the property serverPath (base name: "ServerPath")', function() {
      // uncomment below and update the code to test the property serverPath
      //var instance = new AmazonCognitoIdentityProvider.ContextDataType();
      //expect(instance).to.be();
    });
