...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.GetGroupRequest();
  });
  ...
  describe('GetGroupRequest', function() {
    it('should create an instance of GetGroupRequest', function() {
      ...
      //var instance = new AmazonCognitoIdentityProvider.GetGroupRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.GetGroupRequest);
    });
