...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.RevokeTokenRequest();
  });
  ...
  describe('RevokeTokenRequest', function() {
    it('should create an instance of RevokeTokenRequest', function() {
      ...
      //var instance = new AmazonCognitoIdentityProvider.RevokeTokenRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.RevokeTokenRequest);
    });
