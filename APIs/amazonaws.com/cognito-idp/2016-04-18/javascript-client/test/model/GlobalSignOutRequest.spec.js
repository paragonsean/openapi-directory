...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.GlobalSignOutRequest();
  });
  ...
  describe('GlobalSignOutRequest', function() {
    it('should create an instance of GlobalSignOutRequest', function() {
      // uncomment below and update the code to test GlobalSignOutRequest
      //var instance = new AmazonCognitoIdentityProvider.GlobalSignOutRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.GlobalSignOutRequest);
    });
