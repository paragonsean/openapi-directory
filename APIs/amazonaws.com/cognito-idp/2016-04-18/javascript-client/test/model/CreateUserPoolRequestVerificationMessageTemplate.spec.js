...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.CreateUserPoolRequestVerificationMessageTemplate();
  });
  ...
  describe('CreateUserPoolRequestVerificationMessageTemplate', function() {
    it('should create an instance of CreateUserPoolRequestVerificationMessageTemplate', function() {
      // uncomment below and update the code to test CreateUserPoolRequestVerificationMessageTemplate
      //var instance = new AmazonCognitoIdentityProvider.CreateUserPoolRequestVerificationMessageTemplate();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.CreateUserPoolRequestVerificationMessageTemplate);
    });
