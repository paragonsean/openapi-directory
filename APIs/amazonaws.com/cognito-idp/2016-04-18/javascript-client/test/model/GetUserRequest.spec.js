...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.GetUserRequest();
  });
  ...
  describe('GetUserRequest', function() {
    it('should create an instance of GetUserRequest', function() {
      ...
      //var instance = new AmazonCognitoIdentityProvider.GetUserRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.GetUserRequest);
    });
