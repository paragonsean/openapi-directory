...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.DeleteResourceServerRequest();
  });
  ...
  describe('DeleteResourceServerRequest', function() {
    it('should create an instance of DeleteResourceServerRequest', function() {
      // uncomment below and update the code to test DeleteResourceServerRequest
      //var instance = new AmazonCognitoIdentityProvider.DeleteResourceServerRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.DeleteResourceServerRequest);
    });
