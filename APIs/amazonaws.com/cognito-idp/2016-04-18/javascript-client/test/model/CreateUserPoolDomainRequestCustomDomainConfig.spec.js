...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.CreateUserPoolDomainRequestCustomDomainConfig();
  });
  ...
  describe('CreateUserPoolDomainRequestCustomDomainConfig', function() {
    it('should create an instance of CreateUserPoolDomainRequestCustomDomainConfig', function() {
      // uncomment below and update the code to test CreateUserPoolDomainRequestCustomDomainConfig
      //var instance = new AmazonCognitoIdentityProvider.CreateUserPoolDomainRequestCustomDomainConfig();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.CreateUserPoolDomainRequestCustomDomainConfig);
    });
