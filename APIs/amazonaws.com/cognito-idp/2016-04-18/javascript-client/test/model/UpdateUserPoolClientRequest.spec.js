...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.UpdateUserPoolClientRequest();
  });
  ...
  describe('UpdateUserPoolClientRequest', function() {
    it('should create an instance of UpdateUserPoolClientRequest', function() {
      // uncomment below and update the code to test UpdateUserPoolClientRequest
      //var instance = new AmazonCognitoIdentityProvider.UpdateUserPoolClientRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.UpdateUserPoolClientRequest);
    });
