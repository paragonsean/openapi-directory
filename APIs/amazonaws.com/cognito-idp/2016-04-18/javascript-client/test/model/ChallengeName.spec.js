...
(function(root, factory) {
  ...
  describe('ChallengeName', function() {
    it('should create an instance of ChallengeName', function() {
      // uncomment below and update the code to test ChallengeName
      //var instance = new AmazonCognitoIdentityProvider.ChallengeName();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.ChallengeName);
    });
