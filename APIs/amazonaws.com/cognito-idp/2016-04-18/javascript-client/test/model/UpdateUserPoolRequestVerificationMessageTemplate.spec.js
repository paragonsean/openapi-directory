...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.UpdateUserPoolRequestVerificationMessageTemplate();
  });
  ...
  describe('UpdateUserPoolRequestVerificationMessageTemplate', function() {
    it('should create an instance of UpdateUserPoolRequestVerificationMessageTemplate', function() {
      // uncomment below and update the code to test UpdateUserPoolRequestVerificationMessageTemplate
      //var instance = new AmazonCognitoIdentityProvider.UpdateUserPoolRequestVerificationMessageTemplate();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.UpdateUserPoolRequestVerificationMessageTemplate);
    });
