...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AdminRespondToAuthChallengeRequestAnalyticsMetadata();
  });
  ...
  describe('AdminRespondToAuthChallengeRequestAnalyticsMetadata', function() {
    it('should create an instance of AdminRespondToAuthChallengeRequestAnalyticsMetadata', function() {
      // uncomment below and update the code to test AdminRespondToAuthChallengeRequestAnalyticsMetadata
      //var instance = new AmazonCognitoIdentityProvider.AdminRespondToAuthChallengeRequestAnalyticsMetadata();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AdminRespondToAuthChallengeRequestAnalyticsMetadata);
    });

    it('should have the property analyticsEndpointId (base name: "AnalyticsEndpointId")', function() {
      // uncomment below and update the code to test the property analyticsEndpointId
      //var instance = new AmazonCognitoIdentityProvider.AdminRespondToAuthChallengeRequestAnalyticsMetadata();
