...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.GetUICustomizationRequest();
  });
  ...
  describe('GetUICustomizationRequest', function() {
    it('should create an instance of GetUICustomizationRequest', function() {
      // uncomment below and update the code to test GetUICustomizationRequest
      //var instance = new AmazonCognitoIdentityProvider.GetUICustomizationRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.GetUICustomizationRequest);
    });
