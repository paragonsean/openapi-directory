...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AdminListUserAuthEventsResponse();
  });
  ...
  describe('AdminListUserAuthEventsResponse', function() {
    it('should create an instance of AdminListUserAuthEventsResponse', function() {
      // uncomment below and update the code to test AdminListUserAuthEventsResponse
      //var instance = new AmazonCognitoIdentityProvider.AdminListUserAuthEventsResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AdminListUserAuthEventsResponse);
    });

    it('should have the property authEvents (base name: "AuthEvents")', function() {
      // uncomment below and update the code to test the property authEvents
      //var instance = new AmazonCognitoIdentityProvider.AdminListUserAuthEventsResponse();
