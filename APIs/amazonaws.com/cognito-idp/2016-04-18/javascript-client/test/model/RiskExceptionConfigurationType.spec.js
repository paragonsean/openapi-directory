...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.RiskExceptionConfigurationType();
  });
  ...
  describe('RiskExceptionConfigurationType', function() {
    it('should create an instance of RiskExceptionConfigurationType', function() {
      // uncomment below and update the code to test RiskExceptionConfigurationType
      //var instance = new AmazonCognitoIdentityProvider.RiskExceptionConfigurationType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.RiskExceptionConfigurationType);
    });
