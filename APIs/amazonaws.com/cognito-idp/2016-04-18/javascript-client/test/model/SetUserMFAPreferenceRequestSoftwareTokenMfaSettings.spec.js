...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.SetUserMFAPreferenceRequestSoftwareTokenMfaSettings();
  });
  ...
  describe('SetUserMFAPreferenceRequestSoftwareTokenMfaSettings', function() {
    it('should create an instance of SetUserMFAPreferenceRequestSoftwareTokenMfaSettings', function() {
      // uncomment below and update the code to test SetUserMFAPreferenceRequestSoftwareTokenMfaSettings
      //var instance = new AmazonCognitoIdentityProvider.SetUserMFAPreferenceRequestSoftwareTokenMfaSettings();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.SetUserMFAPreferenceRequestSoftwareTokenMfaSettings);
    });
