...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AdminInitiateAuthResponseAuthenticationResult();
  });
  ...
  describe('AdminInitiateAuthResponseAuthenticationResult', function() {
    it('should create an instance of AdminInitiateAuthResponseAuthenticationResult', function() {
      // uncomment below and update the code to test AdminInitiateAuthResponseAuthenticationResult
      //var instance = new AmazonCognitoIdentityProvider.AdminInitiateAuthResponseAuthenticationResult();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AdminInitiateAuthResponseAuthenticationResult);
    });
