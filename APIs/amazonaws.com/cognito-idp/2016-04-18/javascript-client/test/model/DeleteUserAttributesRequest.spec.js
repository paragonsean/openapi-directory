...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.DeleteUserAttributesRequest();
  });
  ...
  describe('DeleteUserAttributesRequest', function() {
    it('should create an instance of DeleteUserAttributesRequest', function() {
      // uncomment below and update the code to test DeleteUserAttributesRequest
      //var instance = new AmazonCognitoIdentityProvider.DeleteUserAttributesRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.DeleteUserAttributesRequest);
    });
