...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.RespondToAuthChallengeRequestAnalyticsMetadata();
  });
  ...
  describe('RespondToAuthChallengeRequestAnalyticsMetadata', function() {
    it('should create an instance of RespondToAuthChallengeRequestAnalyticsMetadata', function() {
      // uncomment below and update the code to test RespondToAuthChallengeRequestAnalyticsMetadata
      //var instance = new AmazonCognitoIdentityProvider.RespondToAuthChallengeRequestAnalyticsMetadata();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.RespondToAuthChallengeRequestAnalyticsMetadata);
    });
