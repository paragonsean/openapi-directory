...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.ListGroupsResponse();
  });
  ...
  describe('ListGroupsResponse', function() {
    it('should create an instance of ListGroupsResponse', function() {
      ...
      //var instance = new AmazonCognitoIdentityProvider.ListGroupsResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.ListGroupsResponse);
    });
