...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.UpdateUserPoolRequestEmailConfiguration();
  });
  ...
  describe('UpdateUserPoolRequestEmailConfiguration', function() {
    it('should create an instance of UpdateUserPoolRequestEmailConfiguration', function() {
      // uncomment below and update the code to test UpdateUserPoolRequestEmailConfiguration
      //var instance = new AmazonCognitoIdentityProvider.UpdateUserPoolRequestEmailConfiguration();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.UpdateUserPoolRequestEmailConfiguration);
    });
