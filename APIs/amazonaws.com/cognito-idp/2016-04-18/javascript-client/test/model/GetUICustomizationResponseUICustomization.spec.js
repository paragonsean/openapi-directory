...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.GetUICustomizationResponseUICustomization();
  });
  ...
  describe('GetUICustomizationResponseUICustomization', function() {
    it('should create an instance of GetUICustomizationResponseUICustomization', function() {
      // uncomment below and update the code to test GetUICustomizationResponseUICustomization
      //var instance = new AmazonCognitoIdentityProvider.GetUICustomizationResponseUICustomization();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.GetUICustomizationResponseUICustomization);
    });
