...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.MessageTemplateType();
  });
  ...
  describe('MessageTemplateType', function() {
    it('should create an instance of MessageTemplateType', function() {
      // uncomment below and update the code to test MessageTemplateType
      //var instance = new AmazonCognitoIdentityProvider.MessageTemplateType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.MessageTemplateType);
    });
