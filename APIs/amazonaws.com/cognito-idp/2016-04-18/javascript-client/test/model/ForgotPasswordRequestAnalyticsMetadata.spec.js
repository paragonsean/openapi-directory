...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.ForgotPasswordRequestAnalyticsMetadata();
  });
  ...
  describe('ForgotPasswordRequestAnalyticsMetadata', function() {
    it('should create an instance of ForgotPasswordRequestAnalyticsMetadata', function() {
      // uncomment below and update the code to test ForgotPasswordRequestAnalyticsMetadata
      //var instance = new AmazonCognitoIdentityProvider.ForgotPasswordRequestAnalyticsMetadata();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.ForgotPasswordRequestAnalyticsMetadata);
    });
