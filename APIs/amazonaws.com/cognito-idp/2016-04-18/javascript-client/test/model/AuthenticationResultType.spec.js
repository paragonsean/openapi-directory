...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AuthenticationResultType();
  });
  ...
  describe('AuthenticationResultType', function() {
    it('should create an instance of AuthenticationResultType', function() {
      // uncomment below and update the code to test AuthenticationResultType
      //var instance = new AmazonCognitoIdentityProvider.AuthenticationResultType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AuthenticationResultType);
    });
