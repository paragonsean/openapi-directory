...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.ListUserPoolClientsRequest();
  });
  ...
  describe('ListUserPoolClientsRequest', function() {
    it('should create an instance of ListUserPoolClientsRequest', function() {
      // uncomment below and update the code to test ListUserPoolClientsRequest
      //var instance = new AmazonCognitoIdentityProvider.ListUserPoolClientsRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.ListUserPoolClientsRequest);
    });
