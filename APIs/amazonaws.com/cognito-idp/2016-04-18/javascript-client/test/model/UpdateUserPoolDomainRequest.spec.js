...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.UpdateUserPoolDomainRequest();
  });
  ...
  describe('UpdateUserPoolDomainRequest', function() {
    it('should create an instance of UpdateUserPoolDomainRequest', function() {
      // uncomment below and update the code to test UpdateUserPoolDomainRequest
      //var instance = new AmazonCognitoIdentityProvider.UpdateUserPoolDomainRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.UpdateUserPoolDomainRequest);
    });
