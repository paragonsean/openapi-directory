...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.DescribeIdentityProviderRequest();
  });
  ...
  describe('DescribeIdentityProviderRequest', function() {
    it('should create an instance of DescribeIdentityProviderRequest', function() {
      // uncomment below and update the code to test DescribeIdentityProviderRequest
      //var instance = new AmazonCognitoIdentityProvider.DescribeIdentityProviderRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.DescribeIdentityProviderRequest);
    });
