...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AccountTakeoverActionsType();
  });
  ...
  describe('AccountTakeoverActionsType', function() {
    it('should create an instance of AccountTakeoverActionsType', function() {
      // uncomment below and update the code to test AccountTakeoverActionsType
      //var instance = new AmazonCognitoIdentityProvider.AccountTakeoverActionsType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AccountTakeoverActionsType);
    });
