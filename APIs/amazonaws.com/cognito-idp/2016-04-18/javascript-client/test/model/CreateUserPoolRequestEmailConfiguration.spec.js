...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.CreateUserPoolRequestEmailConfiguration();
  });
  ...
  describe('CreateUserPoolRequestEmailConfiguration', function() {
    it('should create an instance of CreateUserPoolRequestEmailConfiguration', function() {
      // uncomment below and update the code to test CreateUserPoolRequestEmailConfiguration
      //var instance = new AmazonCognitoIdentityProvider.CreateUserPoolRequestEmailConfiguration();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.CreateUserPoolRequestEmailConfiguration);
    });
    ...
    it('should have the property emailSendingAccount (base name: "EmailSendingAccount")', function() {
      // uncomment below and update the code to test the property emailSendingAccount
      //var instance = new AmazonCognitoIdentityProvider.CreateUserPoolRequestEmailConfiguration();
      //expect(instance).to.be();
    });
