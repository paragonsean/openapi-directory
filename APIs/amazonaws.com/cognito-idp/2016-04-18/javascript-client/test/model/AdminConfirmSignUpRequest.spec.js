...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AdminConfirmSignUpRequest();
  });
  ...
  describe('AdminConfirmSignUpRequest', function() {
    it('should create an instance of AdminConfirmSignUpRequest', function() {
      // uncomment below and update the code to test AdminConfirmSignUpRequest
      //var instance = new AmazonCognitoIdentityProvider.AdminConfirmSignUpRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AdminConfirmSignUpRequest);
    });
