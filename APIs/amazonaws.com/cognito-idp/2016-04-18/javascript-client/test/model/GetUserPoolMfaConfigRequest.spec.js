...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.GetUserPoolMfaConfigRequest();
  });
  ...
  describe('GetUserPoolMfaConfigRequest', function() {
    it('should create an instance of GetUserPoolMfaConfigRequest', function() {
      // uncomment below and update the code to test GetUserPoolMfaConfigRequest
      //var instance = new AmazonCognitoIdentityProvider.GetUserPoolMfaConfigRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.GetUserPoolMfaConfigRequest);
    });
