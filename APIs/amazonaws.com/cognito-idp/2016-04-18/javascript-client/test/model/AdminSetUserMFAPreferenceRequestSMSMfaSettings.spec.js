...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AdminSetUserMFAPreferenceRequestSMSMfaSettings();
  });
  ...
  describe('AdminSetUserMFAPreferenceRequestSMSMfaSettings', function() {
    it('should create an instance of AdminSetUserMFAPreferenceRequestSMSMfaSettings', function() {
      // uncomment below and update the code to test AdminSetUserMFAPreferenceRequestSMSMfaSettings
      //var instance = new AmazonCognitoIdentityProvider.AdminSetUserMFAPreferenceRequestSMSMfaSettings();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AdminSetUserMFAPreferenceRequestSMSMfaSettings);
    });
