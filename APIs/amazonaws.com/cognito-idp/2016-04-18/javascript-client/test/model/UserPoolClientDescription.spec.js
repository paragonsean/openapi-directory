...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.UserPoolClientDescription();
  });
  ...
  describe('UserPoolClientDescription', function() {
    it('should create an instance of UserPoolClientDescription', function() {
      // uncomment below and update the code to test UserPoolClientDescription
      //var instance = new AmazonCognitoIdentityProvider.UserPoolClientDescription();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.UserPoolClientDescription);
    });
