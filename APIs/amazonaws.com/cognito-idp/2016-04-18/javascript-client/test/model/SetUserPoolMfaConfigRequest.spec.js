...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.SetUserPoolMfaConfigRequest();
  });
  ...
  describe('SetUserPoolMfaConfigRequest', function() {
    it('should create an instance of SetUserPoolMfaConfigRequest', function() {
      // uncomment below and update the code to test SetUserPoolMfaConfigRequest
      //var instance = new AmazonCognitoIdentityProvider.SetUserPoolMfaConfigRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.SetUserPoolMfaConfigRequest);
    });
    ...
    it('should have the property smsMfaConfiguration (base name: "SmsMfaConfiguration")', function() {
      // uncomment below and update the code to test the property smsMfaConfiguration
      //var instance = new AmazonCognitoIdentityProvider.SetUserPoolMfaConfigRequest();
      //expect(instance).to.be();
    });

    it('should have the property softwareTokenMfaConfiguration (base name: "SoftwareTokenMfaConfiguration")', function() {
      // uncomment below and update the code to test the property softwareTokenMfaConfiguration
      //var instance = new AmazonCognitoIdentityProvider.SetUserPoolMfaConfigRequest();
      //expect(instance).to.be();
    });

    it('should have the property mfaConfiguration (base name: "MfaConfiguration")', function() {
      // uncomment below and update the code to test the property mfaConfiguration
      //var instance = new AmazonCognitoIdentityProvider.SetUserPoolMfaConfigRequest();
      //expect(instance).to.be();
    });
