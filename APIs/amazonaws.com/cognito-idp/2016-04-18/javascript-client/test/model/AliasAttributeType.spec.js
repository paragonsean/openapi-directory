...
(function(root, factory) {
  ...
  describe('AliasAttributeType', function() {
    it('should create an instance of AliasAttributeType', function() {
      // uncomment below and update the code to test AliasAttributeType
      //var instance = new AmazonCognitoIdentityProvider.AliasAttributeType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AliasAttributeType);
    });
