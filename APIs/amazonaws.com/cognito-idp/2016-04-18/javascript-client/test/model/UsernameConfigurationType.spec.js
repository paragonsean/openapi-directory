...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.UsernameConfigurationType();
  });
  ...
  describe('UsernameConfigurationType', function() {
    it('should create an instance of UsernameConfigurationType', function() {
      // uncomment below and update the code to test UsernameConfigurationType
      //var instance = new AmazonCognitoIdentityProvider.UsernameConfigurationType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.UsernameConfigurationType);
    });
