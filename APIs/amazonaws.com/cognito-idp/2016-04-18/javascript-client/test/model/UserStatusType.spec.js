...
(function(root, factory) {
  ...
  describe('UserStatusType', function() {
    it('should create an instance of UserStatusType', function() {
      // uncomment below and update the code to test UserStatusType
      //var instance = new AmazonCognitoIdentityProvider.UserStatusType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.UserStatusType);
    });
