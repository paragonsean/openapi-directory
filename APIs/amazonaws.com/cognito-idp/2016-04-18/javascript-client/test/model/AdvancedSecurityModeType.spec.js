...
(function(root, factory) {
  ...
  describe('AdvancedSecurityModeType', function() {
    it('should create an instance of AdvancedSecurityModeType', function() {
      // uncomment below and update the code to test AdvancedSecurityModeType
      //var instance = new AmazonCognitoIdentityProvider.AdvancedSecurityModeType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AdvancedSecurityModeType);
    });
