...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.SetRiskConfigurationRequest();
  });
  ...
  describe('SetRiskConfigurationRequest', function() {
    it('should create an instance of SetRiskConfigurationRequest', function() {
      // uncomment below and update the code to test SetRiskConfigurationRequest
      //var instance = new AmazonCognitoIdentityProvider.SetRiskConfigurationRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.SetRiskConfigurationRequest);
    });
