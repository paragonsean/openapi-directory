...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AdminRespondToAuthChallengeResponse();
  });
  ...
  describe('AdminRespondToAuthChallengeResponse', function() {
    it('should create an instance of AdminRespondToAuthChallengeResponse', function() {
      // uncomment below and update the code to test AdminRespondToAuthChallengeResponse
      //var instance = new AmazonCognitoIdentityProvider.AdminRespondToAuthChallengeResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AdminRespondToAuthChallengeResponse);
    });
