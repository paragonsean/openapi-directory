...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.ListUserImportJobsResponse();
  });
  ...
  describe('ListUserImportJobsResponse', function() {
    it('should create an instance of ListUserImportJobsResponse', function() {
      // uncomment below and update the code to test ListUserImportJobsResponse
      //var instance = new AmazonCognitoIdentityProvider.ListUserImportJobsResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.ListUserImportJobsResponse);
    });

    it('should have the property userImportJobs (base name: "UserImportJobs")', function() {
      // uncomment below and update the code to test the property userImportJobs
      //var instance = new AmazonCognitoIdentityProvider.ListUserImportJobsResponse();
