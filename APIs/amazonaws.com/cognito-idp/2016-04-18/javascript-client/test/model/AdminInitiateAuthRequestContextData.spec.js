...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AdminInitiateAuthRequestContextData();
  });
  ...
  describe('AdminInitiateAuthRequestContextData', function() {
    it('should create an instance of AdminInitiateAuthRequestContextData', function() {
      // uncomment below and update the code to test AdminInitiateAuthRequestContextData
      //var instance = new AmazonCognitoIdentityProvider.AdminInitiateAuthRequestContextData();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AdminInitiateAuthRequestContextData);
    });
