...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.CreateUserPoolRequestLambdaConfig();
  });
  ...
  describe('CreateUserPoolRequestLambdaConfig', function() {
    it('should create an instance of CreateUserPoolRequestLambdaConfig', function() {
      // uncomment below and update the code to test CreateUserPoolRequestLambdaConfig
      //var instance = new AmazonCognitoIdentityProvider.CreateUserPoolRequestLambdaConfig();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.CreateUserPoolRequestLambdaConfig);
    });
