...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.UpdateDeviceStatusRequest();
  });
  ...
  describe('UpdateDeviceStatusRequest', function() {
    it('should create an instance of UpdateDeviceStatusRequest', function() {
      // uncomment below and update the code to test UpdateDeviceStatusRequest
      //var instance = new AmazonCognitoIdentityProvider.UpdateDeviceStatusRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.UpdateDeviceStatusRequest);
    });
