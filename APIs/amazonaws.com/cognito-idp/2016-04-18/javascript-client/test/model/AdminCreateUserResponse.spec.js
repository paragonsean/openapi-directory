...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AdminCreateUserResponse();
  });
  ...
  describe('AdminCreateUserResponse', function() {
    it('should create an instance of AdminCreateUserResponse', function() {
      // uncomment below and update the code to test AdminCreateUserResponse
      //var instance = new AmazonCognitoIdentityProvider.AdminCreateUserResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AdminCreateUserResponse);
    });
