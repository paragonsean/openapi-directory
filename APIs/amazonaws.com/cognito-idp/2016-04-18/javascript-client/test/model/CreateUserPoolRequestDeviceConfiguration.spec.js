...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.CreateUserPoolRequestDeviceConfiguration();
  });
  ...
  describe('CreateUserPoolRequestDeviceConfiguration', function() {
    it('should create an instance of CreateUserPoolRequestDeviceConfiguration', function() {
      // uncomment below and update the code to test CreateUserPoolRequestDeviceConfiguration
      //var instance = new AmazonCognitoIdentityProvider.CreateUserPoolRequestDeviceConfiguration();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.CreateUserPoolRequestDeviceConfiguration);
    });

    it('should have the property challengeRequiredOnNewDevice (base name: "ChallengeRequiredOnNewDevice")', function() {
      // uncomment below and update the code to test the property challengeRequiredOnNewDevice
      //var instance = new AmazonCognitoIdentityProvider.CreateUserPoolRequestDeviceConfiguration();
      //expect(instance).to.be();
    });

    it('should have the property deviceOnlyRememberedOnUserPrompt (base name: "DeviceOnlyRememberedOnUserPrompt")', function() {
      // uncomment below and update the code to test the property deviceOnlyRememberedOnUserPrompt
      //var instance = new AmazonCognitoIdentityProvider.CreateUserPoolRequestDeviceConfiguration();
      //expect(instance).to.be();
    });
