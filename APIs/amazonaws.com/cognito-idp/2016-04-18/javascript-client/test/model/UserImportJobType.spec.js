...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.UserImportJobType();
  });
  ...
  describe('UserImportJobType', function() {
    it('should create an instance of UserImportJobType', function() {
      // uncomment below and update the code to test UserImportJobType
      //var instance = new AmazonCognitoIdentityProvider.UserImportJobType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.UserImportJobType);
    });
    ...
    it('should have the property importedUsers (base name: "ImportedUsers")', function() {
      // uncomment below and update the code to test the property importedUsers
      //var instance = new AmazonCognitoIdentityProvider.UserImportJobType();
      //expect(instance).to.be();
    });

    it('should have the property skippedUsers (base name: "SkippedUsers")', function() {
      // uncomment below and update the code to test the property skippedUsers
      //var instance = new AmazonCognitoIdentityProvider.UserImportJobType();
      //expect(instance).to.be();
    });
    ...
    it('should have the property completionMessage (base name: "CompletionMessage")', function() {
