...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AuthEventTypeEventContextData();
  });
  ...
  describe('AuthEventTypeEventContextData', function() {
    it('should create an instance of AuthEventTypeEventContextData', function() {
      // uncomment below and update the code to test AuthEventTypeEventContextData
      //var instance = new AmazonCognitoIdentityProvider.AuthEventTypeEventContextData();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AuthEventTypeEventContextData);
    });
