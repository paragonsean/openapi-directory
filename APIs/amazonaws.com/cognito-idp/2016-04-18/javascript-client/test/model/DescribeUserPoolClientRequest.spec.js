...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.DescribeUserPoolClientRequest();
  });
  ...
  describe('DescribeUserPoolClientRequest', function() {
    it('should create an instance of DescribeUserPoolClientRequest', function() {
      // uncomment below and update the code to test DescribeUserPoolClientRequest
      //var instance = new AmazonCognitoIdentityProvider.DescribeUserPoolClientRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.DescribeUserPoolClientRequest);
    });
