...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.DescribeUserPoolResponse();
  });
  ...
  describe('DescribeUserPoolResponse', function() {
    it('should create an instance of DescribeUserPoolResponse', function() {
      // uncomment below and update the code to test DescribeUserPoolResponse
      //var instance = new AmazonCognitoIdentityProvider.DescribeUserPoolResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.DescribeUserPoolResponse);
    });
