...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.VerifySoftwareTokenRequest();
  });
  ...
  describe('VerifySoftwareTokenRequest', function() {
    it('should create an instance of VerifySoftwareTokenRequest', function() {
      // uncomment below and update the code to test VerifySoftwareTokenRequest
      //var instance = new AmazonCognitoIdentityProvider.VerifySoftwareTokenRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.VerifySoftwareTokenRequest);
    });
    ...
    it('should have the property friendlyDeviceName (base name: "FriendlyDeviceName")', function() {
      // uncomment below and update the code to test the property friendlyDeviceName
      //var instance = new AmazonCognitoIdentityProvider.VerifySoftwareTokenRequest();
      //expect(instance).to.be();
    });
