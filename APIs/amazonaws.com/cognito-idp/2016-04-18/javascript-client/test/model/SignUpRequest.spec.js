...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.SignUpRequest();
  });
  ...
  describe('SignUpRequest', function() {
    it('should create an instance of SignUpRequest', function() {
      ...
      //var instance = new AmazonCognitoIdentityProvider.SignUpRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.SignUpRequest);
    });
