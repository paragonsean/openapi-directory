...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.NotifyConfigurationTypeBlockEmail();
  });
  ...
  describe('NotifyConfigurationTypeBlockEmail', function() {
    it('should create an instance of NotifyConfigurationTypeBlockEmail', function() {
      // uncomment below and update the code to test NotifyConfigurationTypeBlockEmail
      //var instance = new AmazonCognitoIdentityProvider.NotifyConfigurationTypeBlockEmail();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.NotifyConfigurationTypeBlockEmail);
    });
