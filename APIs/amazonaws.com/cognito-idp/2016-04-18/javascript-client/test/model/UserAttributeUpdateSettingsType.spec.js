...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.UserAttributeUpdateSettingsType();
  });
  ...
  describe('UserAttributeUpdateSettingsType', function() {
    it('should create an instance of UserAttributeUpdateSettingsType', function() {
      // uncomment below and update the code to test UserAttributeUpdateSettingsType
      //var instance = new AmazonCognitoIdentityProvider.UserAttributeUpdateSettingsType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.UserAttributeUpdateSettingsType);
    });
