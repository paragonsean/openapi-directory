...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.CreateUserPoolRequestSmsConfiguration();
  });
  ...
  describe('CreateUserPoolRequestSmsConfiguration', function() {
    it('should create an instance of CreateUserPoolRequestSmsConfiguration', function() {
      // uncomment below and update the code to test CreateUserPoolRequestSmsConfiguration
      //var instance = new AmazonCognitoIdentityProvider.CreateUserPoolRequestSmsConfiguration();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.CreateUserPoolRequestSmsConfiguration);
    });
