...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.UserPoolClientTypeTokenValidityUnits();
  });
  ...
  describe('UserPoolClientTypeTokenValidityUnits', function() {
    it('should create an instance of UserPoolClientTypeTokenValidityUnits', function() {
      // uncomment below and update the code to test UserPoolClientTypeTokenValidityUnits
      //var instance = new AmazonCognitoIdentityProvider.UserPoolClientTypeTokenValidityUnits();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.UserPoolClientTypeTokenValidityUnits);
    });
