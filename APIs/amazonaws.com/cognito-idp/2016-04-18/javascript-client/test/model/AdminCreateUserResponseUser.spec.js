...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AdminCreateUserResponseUser();
  });
  ...
  describe('AdminCreateUserResponseUser', function() {
    it('should create an instance of AdminCreateUserResponseUser', function() {
      // uncomment below and update the code to test AdminCreateUserResponseUser
      //var instance = new AmazonCognitoIdentityProvider.AdminCreateUserResponseUser();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AdminCreateUserResponseUser);
    });
