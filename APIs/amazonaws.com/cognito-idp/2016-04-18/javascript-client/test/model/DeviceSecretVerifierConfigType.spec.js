...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.DeviceSecretVerifierConfigType();
  });
  ...
  describe('DeviceSecretVerifierConfigType', function() {
    it('should create an instance of DeviceSecretVerifierConfigType', function() {
      // uncomment below and update the code to test DeviceSecretVerifierConfigType
      //var instance = new AmazonCognitoIdentityProvider.DeviceSecretVerifierConfigType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.DeviceSecretVerifierConfigType);
    });

    it('should have the property passwordVerifier (base name: "PasswordVerifier")', function() {
      // uncomment below and update the code to test the property passwordVerifier
      //var instance = new AmazonCognitoIdentityProvider.DeviceSecretVerifierConfigType();
