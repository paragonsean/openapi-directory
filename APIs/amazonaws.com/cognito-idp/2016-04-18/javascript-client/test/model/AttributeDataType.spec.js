...
(function(root, factory) {
  ...
  describe('AttributeDataType', function() {
    it('should create an instance of AttributeDataType', function() {
      // uncomment below and update the code to test AttributeDataType
      //var instance = new AmazonCognitoIdentityProvider.AttributeDataType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AttributeDataType);
    });
