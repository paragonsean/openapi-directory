...
(function(root, factory) {
  ...
  describe('DefaultEmailOptionType', function() {
    it('should create an instance of DefaultEmailOptionType', function() {
      // uncomment below and update the code to test DefaultEmailOptionType
      //var instance = new AmazonCognitoIdentityProvider.DefaultEmailOptionType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.DefaultEmailOptionType);
    });
