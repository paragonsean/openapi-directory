...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.UpdateIdentityProviderRequest();
  });
  ...
  describe('UpdateIdentityProviderRequest', function() {
    it('should create an instance of UpdateIdentityProviderRequest', function() {
      // uncomment below and update the code to test UpdateIdentityProviderRequest
      //var instance = new AmazonCognitoIdentityProvider.UpdateIdentityProviderRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.UpdateIdentityProviderRequest);
    });
