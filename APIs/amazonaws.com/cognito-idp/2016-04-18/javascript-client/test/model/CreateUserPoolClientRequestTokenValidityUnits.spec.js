...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.CreateUserPoolClientRequestTokenValidityUnits();
  });
  ...
  describe('CreateUserPoolClientRequestTokenValidityUnits', function() {
    it('should create an instance of CreateUserPoolClientRequestTokenValidityUnits', function() {
      // uncomment below and update the code to test CreateUserPoolClientRequestTokenValidityUnits
      //var instance = new AmazonCognitoIdentityProvider.CreateUserPoolClientRequestTokenValidityUnits();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.CreateUserPoolClientRequestTokenValidityUnits);
    });
