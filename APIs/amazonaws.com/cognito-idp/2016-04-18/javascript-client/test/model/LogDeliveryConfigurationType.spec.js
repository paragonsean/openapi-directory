...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.LogDeliveryConfigurationType();
  });
  ...
  describe('LogDeliveryConfigurationType', function() {
    it('should create an instance of LogDeliveryConfigurationType', function() {
      // uncomment below and update the code to test LogDeliveryConfigurationType
      //var instance = new AmazonCognitoIdentityProvider.LogDeliveryConfigurationType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.LogDeliveryConfigurationType);
    });
