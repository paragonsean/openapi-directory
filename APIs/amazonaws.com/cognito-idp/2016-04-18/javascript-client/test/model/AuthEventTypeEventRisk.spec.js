...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AuthEventTypeEventRisk();
  });
  ...
  describe('AuthEventTypeEventRisk', function() {
    it('should create an instance of AuthEventTypeEventRisk', function() {
      // uncomment below and update the code to test AuthEventTypeEventRisk
      //var instance = new AmazonCognitoIdentityProvider.AuthEventTypeEventRisk();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AuthEventTypeEventRisk);
    });

    it('should have the property riskDecision (base name: "RiskDecision")', function() {
      // uncomment below and update the code to test the property riskDecision
      //var instance = new AmazonCognitoIdentityProvider.AuthEventTypeEventRisk();
    ...
    it('should have the property compromisedCredentialsDetected (base name: "CompromisedCredentialsDetected")', function() {
      // uncomment below and update the code to test the property compromisedCredentialsDetected
      //var instance = new AmazonCognitoIdentityProvider.AuthEventTypeEventRisk();
      //expect(instance).to.be();
    });
