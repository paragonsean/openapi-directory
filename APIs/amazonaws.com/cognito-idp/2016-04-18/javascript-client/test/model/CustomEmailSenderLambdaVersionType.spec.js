...
(function(root, factory) {
  ...
  describe('CustomEmailSenderLambdaVersionType', function() {
    it('should create an instance of CustomEmailSenderLambdaVersionType', function() {
      // uncomment below and update the code to test CustomEmailSenderLambdaVersionType
      //var instance = new AmazonCognitoIdentityProvider.CustomEmailSenderLambdaVersionType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.CustomEmailSenderLambdaVersionType);
    });
