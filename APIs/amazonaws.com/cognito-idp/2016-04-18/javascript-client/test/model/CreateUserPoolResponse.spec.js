...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.CreateUserPoolResponse();
  });
  ...
  describe('CreateUserPoolResponse', function() {
    it('should create an instance of CreateUserPoolResponse', function() {
      // uncomment below and update the code to test CreateUserPoolResponse
      //var instance = new AmazonCognitoIdentityProvider.CreateUserPoolResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.CreateUserPoolResponse);
    });
