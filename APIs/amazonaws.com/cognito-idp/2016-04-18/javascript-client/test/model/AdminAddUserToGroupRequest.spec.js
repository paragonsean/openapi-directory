...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AdminAddUserToGroupRequest();
  });
  ...
  describe('AdminAddUserToGroupRequest', function() {
    it('should create an instance of AdminAddUserToGroupRequest', function() {
      // uncomment below and update the code to test AdminAddUserToGroupRequest
      //var instance = new AmazonCognitoIdentityProvider.AdminAddUserToGroupRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AdminAddUserToGroupRequest);
    });
