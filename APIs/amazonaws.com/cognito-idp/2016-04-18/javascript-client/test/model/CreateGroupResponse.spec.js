...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.CreateGroupResponse();
  });
  ...
  describe('CreateGroupResponse', function() {
    it('should create an instance of CreateGroupResponse', function() {
      ...
      //var instance = new AmazonCognitoIdentityProvider.CreateGroupResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.CreateGroupResponse);
    });
