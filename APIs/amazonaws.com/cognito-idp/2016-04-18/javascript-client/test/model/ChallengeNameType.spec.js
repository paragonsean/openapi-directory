...
(function(root, factory) {
  ...
  describe('ChallengeNameType', function() {
    it('should create an instance of ChallengeNameType', function() {
      // uncomment below and update the code to test ChallengeNameType
      //var instance = new AmazonCognitoIdentityProvider.ChallengeNameType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.ChallengeNameType);
    });
