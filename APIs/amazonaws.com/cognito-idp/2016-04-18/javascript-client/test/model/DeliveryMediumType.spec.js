...
(function(root, factory) {
  ...
  describe('DeliveryMediumType', function() {
    it('should create an instance of DeliveryMediumType', function() {
      // uncomment below and update the code to test DeliveryMediumType
      //var instance = new AmazonCognitoIdentityProvider.DeliveryMediumType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.DeliveryMediumType);
    });
