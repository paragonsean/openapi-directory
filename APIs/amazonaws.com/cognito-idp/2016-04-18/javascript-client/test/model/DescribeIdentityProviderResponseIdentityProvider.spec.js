...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.DescribeIdentityProviderResponseIdentityProvider();
  });
  ...
  describe('DescribeIdentityProviderResponseIdentityProvider', function() {
    it('should create an instance of DescribeIdentityProviderResponseIdentityProvider', function() {
      // uncomment below and update the code to test DescribeIdentityProviderResponseIdentityProvider
      //var instance = new AmazonCognitoIdentityProvider.DescribeIdentityProviderResponseIdentityProvider();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.DescribeIdentityProviderResponseIdentityProvider);
    });
