...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.GroupType();
  });
  ...
  describe('GroupType', function() {
    it('should create an instance of GroupType', function() {
      ...
      //var instance = new AmazonCognitoIdentityProvider.GroupType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.GroupType);
    });
