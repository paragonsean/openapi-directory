...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AdminUpdateDeviceStatusRequest();
  });
  ...
  describe('AdminUpdateDeviceStatusRequest', function() {
    it('should create an instance of AdminUpdateDeviceStatusRequest', function() {
      // uncomment below and update the code to test AdminUpdateDeviceStatusRequest
      //var instance = new AmazonCognitoIdentityProvider.AdminUpdateDeviceStatusRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AdminUpdateDeviceStatusRequest);
    });
    ...
    it('should have the property deviceKey (base name: "DeviceKey")', function() {
      // uncomment below and update the code to test the property deviceKey
      //var instance = new AmazonCognitoIdentityProvider.AdminUpdateDeviceStatusRequest();
      //expect(instance).to.be();
    });

    it('should have the property deviceRememberedStatus (base name: "DeviceRememberedStatus")', function() {
      // uncomment below and update the code to test the property deviceRememberedStatus
      //var instance = new AmazonCognitoIdentityProvider.AdminUpdateDeviceStatusRequest();
      //expect(instance).to.be();
    });
