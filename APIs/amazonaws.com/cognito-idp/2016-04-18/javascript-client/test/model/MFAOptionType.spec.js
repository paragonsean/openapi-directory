...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.MFAOptionType();
  });
  ...
  describe('MFAOptionType', function() {
    it('should create an instance of MFAOptionType', function() {
      // uncomment below and update the code to test MFAOptionType
      //var instance = new AmazonCognitoIdentityProvider.MFAOptionType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.MFAOptionType);
    });

    it('should have the property deliveryMedium (base name: "DeliveryMedium")', function() {
      // uncomment below and update the code to test the property deliveryMedium
      //var instance = new AmazonCognitoIdentityProvider.MFAOptionType();
