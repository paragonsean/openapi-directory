...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AccountTakeoverRiskConfigurationType();
  });
  ...
  describe('AccountTakeoverRiskConfigurationType', function() {
    it('should create an instance of AccountTakeoverRiskConfigurationType', function() {
      // uncomment below and update the code to test AccountTakeoverRiskConfigurationType
      //var instance = new AmazonCognitoIdentityProvider.AccountTakeoverRiskConfigurationType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AccountTakeoverRiskConfigurationType);
    });
