...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.CreateIdentityProviderRequest();
  });
  ...
  describe('CreateIdentityProviderRequest', function() {
    it('should create an instance of CreateIdentityProviderRequest', function() {
      // uncomment below and update the code to test CreateIdentityProviderRequest
      //var instance = new AmazonCognitoIdentityProvider.CreateIdentityProviderRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.CreateIdentityProviderRequest);
    });
