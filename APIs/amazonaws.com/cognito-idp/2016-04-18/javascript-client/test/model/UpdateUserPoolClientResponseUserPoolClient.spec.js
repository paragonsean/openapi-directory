...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.UpdateUserPoolClientResponseUserPoolClient();
  });
  ...
  describe('UpdateUserPoolClientResponseUserPoolClient', function() {
    it('should create an instance of UpdateUserPoolClientResponseUserPoolClient', function() {
      // uncomment below and update the code to test UpdateUserPoolClientResponseUserPoolClient
      //var instance = new AmazonCognitoIdentityProvider.UpdateUserPoolClientResponseUserPoolClient();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.UpdateUserPoolClientResponseUserPoolClient);
    });
