...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.GetSigningCertificateResponse();
  });
  ...
  describe('GetSigningCertificateResponse', function() {
    it('should create an instance of GetSigningCertificateResponse', function() {
      // uncomment below and update the code to test GetSigningCertificateResponse
      //var instance = new AmazonCognitoIdentityProvider.GetSigningCertificateResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.GetSigningCertificateResponse);
    });
