...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.UserType();
  });
  ...
  describe('UserType', function() {
    it('should create an instance of UserType', function() {
      ...
      //var instance = new AmazonCognitoIdentityProvider.UserType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.UserType);
    });
