...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AdminCreateUserConfigTypeInviteMessageTemplate();
  });
  ...
  describe('AdminCreateUserConfigTypeInviteMessageTemplate', function() {
    it('should create an instance of AdminCreateUserConfigTypeInviteMessageTemplate', function() {
      // uncomment below and update the code to test AdminCreateUserConfigTypeInviteMessageTemplate
      //var instance = new AmazonCognitoIdentityProvider.AdminCreateUserConfigTypeInviteMessageTemplate();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AdminCreateUserConfigTypeInviteMessageTemplate);
    });
