...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AssociateSoftwareTokenResponse();
  });
  ...
  describe('AssociateSoftwareTokenResponse', function() {
    it('should create an instance of AssociateSoftwareTokenResponse', function() {
      // uncomment below and update the code to test AssociateSoftwareTokenResponse
      //var instance = new AmazonCognitoIdentityProvider.AssociateSoftwareTokenResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AssociateSoftwareTokenResponse);
    });

    it('should have the property secretCode (base name: "SecretCode")', function() {
      // uncomment below and update the code to test the property secretCode
      //var instance = new AmazonCognitoIdentityProvider.AssociateSoftwareTokenResponse();
