...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AccountRecoverySettingType();
  });
  ...
  describe('AccountRecoverySettingType', function() {
    it('should create an instance of AccountRecoverySettingType', function() {
      // uncomment below and update the code to test AccountRecoverySettingType
      //var instance = new AmazonCognitoIdentityProvider.AccountRecoverySettingType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AccountRecoverySettingType);
    });
