...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AdminSetUserPasswordRequest();
  });
  ...
  describe('AdminSetUserPasswordRequest', function() {
    it('should create an instance of AdminSetUserPasswordRequest', function() {
      // uncomment below and update the code to test AdminSetUserPasswordRequest
      //var instance = new AmazonCognitoIdentityProvider.AdminSetUserPasswordRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AdminSetUserPasswordRequest);
    });
