...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AdminRespondToAuthChallengeResponseAuthenticationResult();
  });
  ...
  describe('AdminRespondToAuthChallengeResponseAuthenticationResult', function() {
    it('should create an instance of AdminRespondToAuthChallengeResponseAuthenticationResult', function() {
      // uncomment below and update the code to test AdminRespondToAuthChallengeResponseAuthenticationResult
      //var instance = new AmazonCognitoIdentityProvider.AdminRespondToAuthChallengeResponseAuthenticationResult();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AdminRespondToAuthChallengeResponseAuthenticationResult);
    });
