...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.StopUserImportJobResponse();
  });
  ...
  describe('StopUserImportJobResponse', function() {
    it('should create an instance of StopUserImportJobResponse', function() {
      // uncomment below and update the code to test StopUserImportJobResponse
      //var instance = new AmazonCognitoIdentityProvider.StopUserImportJobResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.StopUserImportJobResponse);
    });
