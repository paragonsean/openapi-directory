...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.UpdateUserPoolClientRequestAnalyticsConfiguration();
  });
  ...
  describe('UpdateUserPoolClientRequestAnalyticsConfiguration', function() {
    it('should create an instance of UpdateUserPoolClientRequestAnalyticsConfiguration', function() {
      // uncomment below and update the code to test UpdateUserPoolClientRequestAnalyticsConfiguration
      //var instance = new AmazonCognitoIdentityProvider.UpdateUserPoolClientRequestAnalyticsConfiguration();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.UpdateUserPoolClientRequestAnalyticsConfiguration);
    });
