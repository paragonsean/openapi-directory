...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AccountTakeoverActionsTypeHighAction();
  });
  ...
  describe('AccountTakeoverActionsTypeHighAction', function() {
    it('should create an instance of AccountTakeoverActionsTypeHighAction', function() {
      // uncomment below and update the code to test AccountTakeoverActionsTypeHighAction
      //var instance = new AmazonCognitoIdentityProvider.AccountTakeoverActionsTypeHighAction();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AccountTakeoverActionsTypeHighAction);
    });
