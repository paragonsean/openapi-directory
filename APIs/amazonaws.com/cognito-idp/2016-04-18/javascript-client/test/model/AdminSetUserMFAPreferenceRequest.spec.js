...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AdminSetUserMFAPreferenceRequest();
  });
  ...
  describe('AdminSetUserMFAPreferenceRequest', function() {
    it('should create an instance of AdminSetUserMFAPreferenceRequest', function() {
      // uncomment below and update the code to test AdminSetUserMFAPreferenceRequest
      //var instance = new AmazonCognitoIdentityProvider.AdminSetUserMFAPreferenceRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AdminSetUserMFAPreferenceRequest);
    });

    it('should have the property sMSMfaSettings (base name: "SMSMfaSettings")', function() {
      // uncomment below and update the code to test the property sMSMfaSettings
      //var instance = new AmazonCognitoIdentityProvider.AdminSetUserMFAPreferenceRequest();
      //expect(instance).to.be();
    });

    it('should have the property softwareTokenMfaSettings (base name: "SoftwareTokenMfaSettings")', function() {
      // uncomment below and update the code to test the property softwareTokenMfaSettings
      //var instance = new AmazonCognitoIdentityProvider.AdminSetUserMFAPreferenceRequest();
      //expect(instance).to.be();
    });
