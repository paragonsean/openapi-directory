...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.SetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration();
  });
  ...
  describe('SetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration', function() {
    it('should create an instance of SetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration', function() {
      // uncomment below and update the code to test SetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration
      //var instance = new AmazonCognitoIdentityProvider.SetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.SetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration);
    });
