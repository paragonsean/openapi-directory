...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.CreateIdentityProviderResponse();
  });
  ...
  describe('CreateIdentityProviderResponse', function() {
    it('should create an instance of CreateIdentityProviderResponse', function() {
      // uncomment below and update the code to test CreateIdentityProviderResponse
      //var instance = new AmazonCognitoIdentityProvider.CreateIdentityProviderResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.CreateIdentityProviderResponse);
    });
