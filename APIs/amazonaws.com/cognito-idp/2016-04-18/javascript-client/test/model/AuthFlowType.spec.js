...
(function(root, factory) {
  ...
  describe('AuthFlowType', function() {
    it('should create an instance of AuthFlowType', function() {
      // uncomment below and update the code to test AuthFlowType
      //var instance = new AmazonCognitoIdentityProvider.AuthFlowType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AuthFlowType);
    });
