...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AuthenticationResultTypeNewDeviceMetadata();
  });
  ...
  describe('AuthenticationResultTypeNewDeviceMetadata', function() {
    it('should create an instance of AuthenticationResultTypeNewDeviceMetadata', function() {
      // uncomment below and update the code to test AuthenticationResultTypeNewDeviceMetadata
      //var instance = new AmazonCognitoIdentityProvider.AuthenticationResultTypeNewDeviceMetadata();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AuthenticationResultTypeNewDeviceMetadata);
    });
