...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.CreateUserPoolDomainRequest();
  });
  ...
  describe('CreateUserPoolDomainRequest', function() {
    it('should create an instance of CreateUserPoolDomainRequest', function() {
      // uncomment below and update the code to test CreateUserPoolDomainRequest
      //var instance = new AmazonCognitoIdentityProvider.CreateUserPoolDomainRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.CreateUserPoolDomainRequest);
    });
