...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.IdentityProviderType();
  });
  ...
  describe('IdentityProviderType', function() {
    it('should create an instance of IdentityProviderType', function() {
      // uncomment below and update the code to test IdentityProviderType
      //var instance = new AmazonCognitoIdentityProvider.IdentityProviderType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.IdentityProviderType);
    });
