...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.VerificationMessageTemplateType();
  });
  ...
  describe('VerificationMessageTemplateType', function() {
    it('should create an instance of VerificationMessageTemplateType', function() {
      // uncomment below and update the code to test VerificationMessageTemplateType
      //var instance = new AmazonCognitoIdentityProvider.VerificationMessageTemplateType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.VerificationMessageTemplateType);
    });
    ...
    it('should have the property emailMessageByLink (base name: "EmailMessageByLink")', function() {
      // uncomment below and update the code to test the property emailMessageByLink
      //var instance = new AmazonCognitoIdentityProvider.VerificationMessageTemplateType();
      //expect(instance).to.be();
    });

    it('should have the property emailSubjectByLink (base name: "EmailSubjectByLink")', function() {
      // uncomment below and update the code to test the property emailSubjectByLink
      //var instance = new AmazonCognitoIdentityProvider.VerificationMessageTemplateType();
      //expect(instance).to.be();
    });

    it('should have the property defaultEmailOption (base name: "DefaultEmailOption")', function() {
      // uncomment below and update the code to test the property defaultEmailOption
      //var instance = new AmazonCognitoIdentityProvider.VerificationMessageTemplateType();
      //expect(instance).to.be();
    });
