...
(function(root, factory) {
  ...
  describe('UserPoolMfaType', function() {
    it('should create an instance of UserPoolMfaType', function() {
      // uncomment below and update the code to test UserPoolMfaType
      //var instance = new AmazonCognitoIdentityProvider.UserPoolMfaType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.UserPoolMfaType);
    });
