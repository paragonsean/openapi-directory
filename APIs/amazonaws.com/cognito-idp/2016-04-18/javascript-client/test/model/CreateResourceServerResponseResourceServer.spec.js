...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.CreateResourceServerResponseResourceServer();
  });
  ...
  describe('CreateResourceServerResponseResourceServer', function() {
    it('should create an instance of CreateResourceServerResponseResourceServer', function() {
      // uncomment below and update the code to test CreateResourceServerResponseResourceServer
      //var instance = new AmazonCognitoIdentityProvider.CreateResourceServerResponseResourceServer();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.CreateResourceServerResponseResourceServer);
    });
