...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.DescribeRiskConfigurationResponse();
  });
  ...
  describe('DescribeRiskConfigurationResponse', function() {
    it('should create an instance of DescribeRiskConfigurationResponse', function() {
      // uncomment below and update the code to test DescribeRiskConfigurationResponse
      //var instance = new AmazonCognitoIdentityProvider.DescribeRiskConfigurationResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.DescribeRiskConfigurationResponse);
    });
