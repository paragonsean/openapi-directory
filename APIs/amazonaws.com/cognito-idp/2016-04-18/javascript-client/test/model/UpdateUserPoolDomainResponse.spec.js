...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.UpdateUserPoolDomainResponse();
  });
  ...
  describe('UpdateUserPoolDomainResponse', function() {
    it('should create an instance of UpdateUserPoolDomainResponse', function() {
      // uncomment below and update the code to test UpdateUserPoolDomainResponse
      //var instance = new AmazonCognitoIdentityProvider.UpdateUserPoolDomainResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.UpdateUserPoolDomainResponse);
    });
