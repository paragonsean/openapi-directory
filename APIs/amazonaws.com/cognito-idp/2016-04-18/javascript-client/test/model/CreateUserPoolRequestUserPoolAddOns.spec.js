...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.CreateUserPoolRequestUserPoolAddOns();
  });
  ...
  describe('CreateUserPoolRequestUserPoolAddOns', function() {
    it('should create an instance of CreateUserPoolRequestUserPoolAddOns', function() {
      // uncomment below and update the code to test CreateUserPoolRequestUserPoolAddOns
      //var instance = new AmazonCognitoIdentityProvider.CreateUserPoolRequestUserPoolAddOns();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.CreateUserPoolRequestUserPoolAddOns);
    });
