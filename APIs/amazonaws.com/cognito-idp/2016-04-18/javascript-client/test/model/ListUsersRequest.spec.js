...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.ListUsersRequest();
  });
  ...
  describe('ListUsersRequest', function() {
    it('should create an instance of ListUsersRequest', function() {
      // uncomment below and update the code to test ListUsersRequest
      //var instance = new AmazonCognitoIdentityProvider.ListUsersRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.ListUsersRequest);
    });
