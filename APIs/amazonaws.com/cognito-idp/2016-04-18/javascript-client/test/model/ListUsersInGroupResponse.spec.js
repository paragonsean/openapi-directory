...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.ListUsersInGroupResponse();
  });
  ...
  describe('ListUsersInGroupResponse', function() {
    it('should create an instance of ListUsersInGroupResponse', function() {
      // uncomment below and update the code to test ListUsersInGroupResponse
      //var instance = new AmazonCognitoIdentityProvider.ListUsersInGroupResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.ListUsersInGroupResponse);
    });
