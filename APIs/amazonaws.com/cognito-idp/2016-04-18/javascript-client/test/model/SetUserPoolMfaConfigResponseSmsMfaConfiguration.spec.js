...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.SetUserPoolMfaConfigResponseSmsMfaConfiguration();
  });
  ...
  describe('SetUserPoolMfaConfigResponseSmsMfaConfiguration', function() {
    it('should create an instance of SetUserPoolMfaConfigResponseSmsMfaConfiguration', function() {
      // uncomment below and update the code to test SetUserPoolMfaConfigResponseSmsMfaConfiguration
      //var instance = new AmazonCognitoIdentityProvider.SetUserPoolMfaConfigResponseSmsMfaConfiguration();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.SetUserPoolMfaConfigResponseSmsMfaConfiguration);
    });

    it('should have the property smsAuthenticationMessage (base name: "SmsAuthenticationMessage")', function() {
      // uncomment below and update the code to test the property smsAuthenticationMessage
      //var instance = new AmazonCognitoIdentityProvider.SetUserPoolMfaConfigResponseSmsMfaConfiguration();
      //expect(instance).to.be();
    });

    it('should have the property smsConfiguration (base name: "SmsConfiguration")', function() {
      // uncomment below and update the code to test the property smsConfiguration
      //var instance = new AmazonCognitoIdentityProvider.SetUserPoolMfaConfigResponseSmsMfaConfiguration();
      //expect(instance).to.be();
    });
