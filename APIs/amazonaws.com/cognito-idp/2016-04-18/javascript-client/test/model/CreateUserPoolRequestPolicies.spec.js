...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.CreateUserPoolRequestPolicies();
  });
  ...
  describe('CreateUserPoolRequestPolicies', function() {
    it('should create an instance of CreateUserPoolRequestPolicies', function() {
      // uncomment below and update the code to test CreateUserPoolRequestPolicies
      //var instance = new AmazonCognitoIdentityProvider.CreateUserPoolRequestPolicies();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.CreateUserPoolRequestPolicies);
    });
