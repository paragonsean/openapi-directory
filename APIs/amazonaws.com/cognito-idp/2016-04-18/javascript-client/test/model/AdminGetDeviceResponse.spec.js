...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AdminGetDeviceResponse();
  });
  ...
  describe('AdminGetDeviceResponse', function() {
    it('should create an instance of AdminGetDeviceResponse', function() {
      // uncomment below and update the code to test AdminGetDeviceResponse
      //var instance = new AmazonCognitoIdentityProvider.AdminGetDeviceResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AdminGetDeviceResponse);
    });
