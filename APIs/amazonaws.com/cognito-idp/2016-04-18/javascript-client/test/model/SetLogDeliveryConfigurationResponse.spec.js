...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.SetLogDeliveryConfigurationResponse();
  });
  ...
  describe('SetLogDeliveryConfigurationResponse', function() {
    it('should create an instance of SetLogDeliveryConfigurationResponse', function() {
      // uncomment below and update the code to test SetLogDeliveryConfigurationResponse
      //var instance = new AmazonCognitoIdentityProvider.SetLogDeliveryConfigurationResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.SetLogDeliveryConfigurationResponse);
    });

    it('should have the property logDeliveryConfiguration (base name: "LogDeliveryConfiguration")', function() {
      // uncomment below and update the code to test the property logDeliveryConfiguration
      //var instance = new AmazonCognitoIdentityProvider.SetLogDeliveryConfigurationResponse();
