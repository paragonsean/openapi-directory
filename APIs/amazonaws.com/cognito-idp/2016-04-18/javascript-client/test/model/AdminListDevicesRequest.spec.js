...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AdminListDevicesRequest();
  });
  ...
  describe('AdminListDevicesRequest', function() {
    it('should create an instance of AdminListDevicesRequest', function() {
      // uncomment below and update the code to test AdminListDevicesRequest
      //var instance = new AmazonCognitoIdentityProvider.AdminListDevicesRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AdminListDevicesRequest);
    });
