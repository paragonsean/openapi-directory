...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AdminGetDeviceRequest();
  });
  ...
  describe('AdminGetDeviceRequest', function() {
    it('should create an instance of AdminGetDeviceRequest', function() {
      // uncomment below and update the code to test AdminGetDeviceRequest
      //var instance = new AmazonCognitoIdentityProvider.AdminGetDeviceRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AdminGetDeviceRequest);
    });
