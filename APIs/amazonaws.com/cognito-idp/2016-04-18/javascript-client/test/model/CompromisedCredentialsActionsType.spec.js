...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.CompromisedCredentialsActionsType();
  });
  ...
  describe('CompromisedCredentialsActionsType', function() {
    it('should create an instance of CompromisedCredentialsActionsType', function() {
      // uncomment below and update the code to test CompromisedCredentialsActionsType
      //var instance = new AmazonCognitoIdentityProvider.CompromisedCredentialsActionsType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.CompromisedCredentialsActionsType);
    });
