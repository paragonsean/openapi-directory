...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AdminForgetDeviceRequest();
  });
  ...
  describe('AdminForgetDeviceRequest', function() {
    it('should create an instance of AdminForgetDeviceRequest', function() {
      // uncomment below and update the code to test AdminForgetDeviceRequest
      //var instance = new AmazonCognitoIdentityProvider.AdminForgetDeviceRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AdminForgetDeviceRequest);
    });
