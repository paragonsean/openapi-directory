...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.DeviceType();
  });
  ...
  describe('DeviceType', function() {
    it('should create an instance of DeviceType', function() {
      ...
      //var instance = new AmazonCognitoIdentityProvider.DeviceType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.DeviceType);
    });
