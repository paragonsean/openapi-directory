...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.RespondToAuthChallengeRequest();
  });
  ...
  describe('RespondToAuthChallengeRequest', function() {
    it('should create an instance of RespondToAuthChallengeRequest', function() {
      // uncomment below and update the code to test RespondToAuthChallengeRequest
      //var instance = new AmazonCognitoIdentityProvider.RespondToAuthChallengeRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.RespondToAuthChallengeRequest);
    });
    ...
    it('should have the property userContextData (base name: "UserContextData")', function() {
      // uncomment below and update the code to test the property userContextData
      //var instance = new AmazonCognitoIdentityProvider.RespondToAuthChallengeRequest();
      //expect(instance).to.be();
    });
