...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AdminUpdateAuthEventFeedbackRequest();
  });
  ...
  describe('AdminUpdateAuthEventFeedbackRequest', function() {
    it('should create an instance of AdminUpdateAuthEventFeedbackRequest', function() {
      // uncomment below and update the code to test AdminUpdateAuthEventFeedbackRequest
      //var instance = new AmazonCognitoIdentityProvider.AdminUpdateAuthEventFeedbackRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AdminUpdateAuthEventFeedbackRequest);
    });
    ...
    it('should have the property feedbackValue (base name: "FeedbackValue")', function() {
      // uncomment below and update the code to test the property feedbackValue
      //var instance = new AmazonCognitoIdentityProvider.AdminUpdateAuthEventFeedbackRequest();
      //expect(instance).to.be();
    });
