...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.ListIdentityProvidersResponse();
  });
  ...
  describe('ListIdentityProvidersResponse', function() {
    it('should create an instance of ListIdentityProvidersResponse', function() {
      // uncomment below and update the code to test ListIdentityProvidersResponse
      //var instance = new AmazonCognitoIdentityProvider.ListIdentityProvidersResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.ListIdentityProvidersResponse);
    });
