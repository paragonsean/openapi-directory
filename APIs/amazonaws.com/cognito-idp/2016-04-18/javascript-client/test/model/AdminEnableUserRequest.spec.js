...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AdminEnableUserRequest();
  });
  ...
  describe('AdminEnableUserRequest', function() {
    it('should create an instance of AdminEnableUserRequest', function() {
      // uncomment below and update the code to test AdminEnableUserRequest
      //var instance = new AmazonCognitoIdentityProvider.AdminEnableUserRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AdminEnableUserRequest);
    });
