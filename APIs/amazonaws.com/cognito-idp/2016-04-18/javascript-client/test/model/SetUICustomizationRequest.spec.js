...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.SetUICustomizationRequest();
  });
  ...
  describe('SetUICustomizationRequest', function() {
    it('should create an instance of SetUICustomizationRequest', function() {
      // uncomment below and update the code to test SetUICustomizationRequest
      //var instance = new AmazonCognitoIdentityProvider.SetUICustomizationRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.SetUICustomizationRequest);
    });
