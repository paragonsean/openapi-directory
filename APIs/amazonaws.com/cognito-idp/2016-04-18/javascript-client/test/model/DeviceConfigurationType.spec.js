...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.DeviceConfigurationType();
  });
  ...
  describe('DeviceConfigurationType', function() {
    it('should create an instance of DeviceConfigurationType', function() {
      // uncomment below and update the code to test DeviceConfigurationType
      //var instance = new AmazonCognitoIdentityProvider.DeviceConfigurationType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.DeviceConfigurationType);
    });
