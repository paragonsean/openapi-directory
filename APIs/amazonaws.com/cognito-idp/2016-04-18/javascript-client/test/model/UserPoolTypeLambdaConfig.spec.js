...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.UserPoolTypeLambdaConfig();
  });
  ...
  describe('UserPoolTypeLambdaConfig', function() {
    it('should create an instance of UserPoolTypeLambdaConfig', function() {
      // uncomment below and update the code to test UserPoolTypeLambdaConfig
      //var instance = new AmazonCognitoIdentityProvider.UserPoolTypeLambdaConfig();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.UserPoolTypeLambdaConfig);
    });
