...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.RiskConfigurationTypeCompromisedCredentialsRiskConfiguration();
  });
  ...
  describe('RiskConfigurationTypeCompromisedCredentialsRiskConfiguration', function() {
    it('should create an instance of RiskConfigurationTypeCompromisedCredentialsRiskConfiguration', function() {
      // uncomment below and update the code to test RiskConfigurationTypeCompromisedCredentialsRiskConfiguration
      //var instance = new AmazonCognitoIdentityProvider.RiskConfigurationTypeCompromisedCredentialsRiskConfiguration();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.RiskConfigurationTypeCompromisedCredentialsRiskConfiguration);
    });
