...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.SchemaAttributeType();
  });
  ...
  describe('SchemaAttributeType', function() {
    it('should create an instance of SchemaAttributeType', function() {
      // uncomment below and update the code to test SchemaAttributeType
      //var instance = new AmazonCognitoIdentityProvider.SchemaAttributeType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.SchemaAttributeType);
    });
    ...
    it('should have the property attributeDataType (base name: "AttributeDataType")', function() {
      // uncomment below and update the code to test the property attributeDataType
      //var instance = new AmazonCognitoIdentityProvider.SchemaAttributeType();
      //expect(instance).to.be();
    });

    it('should have the property developerOnlyAttribute (base name: "DeveloperOnlyAttribute")', function() {
      // uncomment below and update the code to test the property developerOnlyAttribute
      //var instance = new AmazonCognitoIdentityProvider.SchemaAttributeType();
      //expect(instance).to.be();
    });
    ...
    it('should have the property numberAttributeConstraints (base name: "NumberAttributeConstraints")', function() {
      // uncomment below and update the code to test the property numberAttributeConstraints
      //var instance = new AmazonCognitoIdentityProvider.SchemaAttributeType();
      //expect(instance).to.be();
    });

    it('should have the property stringAttributeConstraints (base name: "StringAttributeConstraints")', function() {
      // uncomment below and update the code to test the property stringAttributeConstraints
      //var instance = new AmazonCognitoIdentityProvider.SchemaAttributeType();
      //expect(instance).to.be();
    });
