...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.ResendConfirmationCodeRequestAnalyticsMetadata();
  });
  ...
  describe('ResendConfirmationCodeRequestAnalyticsMetadata', function() {
    it('should create an instance of ResendConfirmationCodeRequestAnalyticsMetadata', function() {
      // uncomment below and update the code to test ResendConfirmationCodeRequestAnalyticsMetadata
      //var instance = new AmazonCognitoIdentityProvider.ResendConfirmationCodeRequestAnalyticsMetadata();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.ResendConfirmationCodeRequestAnalyticsMetadata);
    });
