...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.UserPoolClientTypeAnalyticsConfiguration();
  });
  ...
  describe('UserPoolClientTypeAnalyticsConfiguration', function() {
    it('should create an instance of UserPoolClientTypeAnalyticsConfiguration', function() {
      // uncomment below and update the code to test UserPoolClientTypeAnalyticsConfiguration
      //var instance = new AmazonCognitoIdentityProvider.UserPoolClientTypeAnalyticsConfiguration();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.UserPoolClientTypeAnalyticsConfiguration);
    });
