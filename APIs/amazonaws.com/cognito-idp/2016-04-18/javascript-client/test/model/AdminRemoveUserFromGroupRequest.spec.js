...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AdminRemoveUserFromGroupRequest();
  });
  ...
  describe('AdminRemoveUserFromGroupRequest', function() {
    it('should create an instance of AdminRemoveUserFromGroupRequest', function() {
      // uncomment below and update the code to test AdminRemoveUserFromGroupRequest
      //var instance = new AmazonCognitoIdentityProvider.AdminRemoveUserFromGroupRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AdminRemoveUserFromGroupRequest);
    });
