...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.SetUserMFAPreferenceRequestSMSMfaSettings();
  });
  ...
  describe('SetUserMFAPreferenceRequestSMSMfaSettings', function() {
    it('should create an instance of SetUserMFAPreferenceRequestSMSMfaSettings', function() {
      // uncomment below and update the code to test SetUserMFAPreferenceRequestSMSMfaSettings
      //var instance = new AmazonCognitoIdentityProvider.SetUserMFAPreferenceRequestSMSMfaSettings();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.SetUserMFAPreferenceRequestSMSMfaSettings);
    });
