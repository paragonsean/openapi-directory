...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.ListIdentityProvidersRequest();
  });
  ...
  describe('ListIdentityProvidersRequest', function() {
    it('should create an instance of ListIdentityProvidersRequest', function() {
      ...
      //var instance = new AmazonCognitoIdentityProvider.ListIdentityProvidersRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.ListIdentityProvidersRequest);
    });
