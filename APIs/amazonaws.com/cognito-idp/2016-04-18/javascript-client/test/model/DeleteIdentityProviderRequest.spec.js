...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.DeleteIdentityProviderRequest();
  });
  ...
  describe('DeleteIdentityProviderRequest', function() {
    it('should create an instance of DeleteIdentityProviderRequest', function() {
      // uncomment below and update the code to test DeleteIdentityProviderRequest
      //var instance = new AmazonCognitoIdentityProvider.DeleteIdentityProviderRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.DeleteIdentityProviderRequest);
    });
