...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AdminDisableUserRequest();
  });
  ...
  describe('AdminDisableUserRequest', function() {
    it('should create an instance of AdminDisableUserRequest', function() {
      // uncomment below and update the code to test AdminDisableUserRequest
      //var instance = new AmazonCognitoIdentityProvider.AdminDisableUserRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AdminDisableUserRequest);
    });
