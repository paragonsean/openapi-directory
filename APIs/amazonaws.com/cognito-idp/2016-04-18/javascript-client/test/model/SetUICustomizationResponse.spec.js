...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.SetUICustomizationResponse();
  });
  ...
  describe('SetUICustomizationResponse', function() {
    it('should create an instance of SetUICustomizationResponse', function() {
      // uncomment below and update the code to test SetUICustomizationResponse
      //var instance = new AmazonCognitoIdentityProvider.SetUICustomizationResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.SetUICustomizationResponse);
    });
