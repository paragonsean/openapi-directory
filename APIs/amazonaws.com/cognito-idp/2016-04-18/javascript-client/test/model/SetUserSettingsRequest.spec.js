...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.SetUserSettingsRequest();
  });
  ...
  describe('SetUserSettingsRequest', function() {
    it('should create an instance of SetUserSettingsRequest', function() {
      // uncomment below and update the code to test SetUserSettingsRequest
      //var instance = new AmazonCognitoIdentityProvider.SetUserSettingsRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.SetUserSettingsRequest);
    });
    ...
    it('should have the property mFAOptions (base name: "MFAOptions")', function() {
      // uncomment below and update the code to test the property mFAOptions
      //var instance = new AmazonCognitoIdentityProvider.SetUserSettingsRequest();
      //expect(instance).to.be();
    });
