...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AuthEventType();
  });
  ...
  describe('AuthEventType', function() {
    it('should create an instance of AuthEventType', function() {
      // uncomment below and update the code to test AuthEventType
      //var instance = new AmazonCognitoIdentityProvider.AuthEventType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AuthEventType);
    });
    ...
    it('should have the property eventResponse (base name: "EventResponse")', function() {
      // uncomment below and update the code to test the property eventResponse
      //var instance = new AmazonCognitoIdentityProvider.AuthEventType();
      //expect(instance).to.be();
    });

    it('should have the property eventRisk (base name: "EventRisk")', function() {
      // uncomment below and update the code to test the property eventRisk
      //var instance = new AmazonCognitoIdentityProvider.AuthEventType();
      //expect(instance).to.be();
    });
    ...
    it('should have the property eventContextData (base name: "EventContextData")', function() {
      // uncomment below and update the code to test the property eventContextData
      //var instance = new AmazonCognitoIdentityProvider.AuthEventType();
      //expect(instance).to.be();
    });

    it('should have the property eventFeedback (base name: "EventFeedback")', function() {
      // uncomment below and update the code to test the property eventFeedback
      //var instance = new AmazonCognitoIdentityProvider.AuthEventType();
      //expect(instance).to.be();
    });
