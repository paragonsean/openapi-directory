...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.ListDevicesResponse();
  });
  ...
  describe('ListDevicesResponse', function() {
    it('should create an instance of ListDevicesResponse', function() {
      ...
      //var instance = new AmazonCognitoIdentityProvider.ListDevicesResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.ListDevicesResponse);
    });
