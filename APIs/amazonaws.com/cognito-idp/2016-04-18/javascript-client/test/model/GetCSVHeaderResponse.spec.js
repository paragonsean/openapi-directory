...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.GetCSVHeaderResponse();
  });
  ...
  describe('GetCSVHeaderResponse', function() {
    it('should create an instance of GetCSVHeaderResponse', function() {
      // uncomment below and update the code to test GetCSVHeaderResponse
      //var instance = new AmazonCognitoIdentityProvider.GetCSVHeaderResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.GetCSVHeaderResponse);
    });
    ...
    it('should have the property cSVHeader (base name: "CSVHeader")', function() {
      // uncomment below and update the code to test the property cSVHeader
      //var instance = new AmazonCognitoIdentityProvider.GetCSVHeaderResponse();
      //expect(instance).to.be();
    });
