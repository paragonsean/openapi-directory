...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.VerifySoftwareTokenResponse();
  });
  ...
  describe('VerifySoftwareTokenResponse', function() {
    it('should create an instance of VerifySoftwareTokenResponse', function() {
      // uncomment below and update the code to test VerifySoftwareTokenResponse
      //var instance = new AmazonCognitoIdentityProvider.VerifySoftwareTokenResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.VerifySoftwareTokenResponse);
    });
