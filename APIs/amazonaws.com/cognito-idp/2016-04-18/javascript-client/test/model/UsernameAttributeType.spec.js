...
(function(root, factory) {
  ...
  describe('UsernameAttributeType', function() {
    it('should create an instance of UsernameAttributeType', function() {
      // uncomment below and update the code to test UsernameAttributeType
      //var instance = new AmazonCognitoIdentityProvider.UsernameAttributeType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.UsernameAttributeType);
    });
