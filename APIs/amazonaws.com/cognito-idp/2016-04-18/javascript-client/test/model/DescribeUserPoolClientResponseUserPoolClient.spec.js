...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.DescribeUserPoolClientResponseUserPoolClient();
  });
  ...
  describe('DescribeUserPoolClientResponseUserPoolClient', function() {
    it('should create an instance of DescribeUserPoolClientResponseUserPoolClient', function() {
      // uncomment below and update the code to test DescribeUserPoolClientResponseUserPoolClient
      //var instance = new AmazonCognitoIdentityProvider.DescribeUserPoolClientResponseUserPoolClient();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.DescribeUserPoolClientResponseUserPoolClient);
    });
    ...
    it('should have the property idTokenValidity (base name: "IdTokenValidity")', function() {
      // uncomment below and update the code to test the property idTokenValidity
      //var instance = new AmazonCognitoIdentityProvider.DescribeUserPoolClientResponseUserPoolClient();
      //expect(instance).to.be();
    });

    it('should have the property tokenValidityUnits (base name: "TokenValidityUnits")', function() {
      // uncomment below and update the code to test the property tokenValidityUnits
      //var instance = new AmazonCognitoIdentityProvider.DescribeUserPoolClientResponseUserPoolClient();
      //expect(instance).to.be();
    });

    it('should have the property readAttributes (base name: "ReadAttributes")', function() {
      // uncomment below and update the code to test the property readAttributes
      //var instance = new AmazonCognitoIdentityProvider.DescribeUserPoolClientResponseUserPoolClient();
      //expect(instance).to.be();
    });

    it('should have the property writeAttributes (base name: "WriteAttributes")', function() {
      // uncomment below and update the code to test the property writeAttributes
      //var instance = new AmazonCognitoIdentityProvider.DescribeUserPoolClientResponseUserPoolClient();
      //expect(instance).to.be();
    });

    it('should have the property explicitAuthFlows (base name: "ExplicitAuthFlows")', function() {
      // uncomment below and update the code to test the property explicitAuthFlows
      //var instance = new AmazonCognitoIdentityProvider.DescribeUserPoolClientResponseUserPoolClient();
      //expect(instance).to.be();
    });

    it('should have the property supportedIdentityProviders (base name: "SupportedIdentityProviders")', function() {
      // uncomment below and update the code to test the property supportedIdentityProviders
      //var instance = new AmazonCognitoIdentityProvider.DescribeUserPoolClientResponseUserPoolClient();
      //expect(instance).to.be();
    });
    ...
    it('should have the property defaultRedirectURI (base name: "DefaultRedirectURI")', function() {
      // uncomment below and update the code to test the property defaultRedirectURI
      //var instance = new AmazonCognitoIdentityProvider.DescribeUserPoolClientResponseUserPoolClient();
      //expect(instance).to.be();
    });

    it('should have the property allowedOAuthFlows (base name: "AllowedOAuthFlows")', function() {
      // uncomment below and update the code to test the property allowedOAuthFlows
      //var instance = new AmazonCognitoIdentityProvider.DescribeUserPoolClientResponseUserPoolClient();
      //expect(instance).to.be();
    });

    it('should have the property allowedOAuthScopes (base name: "AllowedOAuthScopes")', function() {
      // uncomment below and update the code to test the property allowedOAuthScopes
      //var instance = new AmazonCognitoIdentityProvider.DescribeUserPoolClientResponseUserPoolClient();
      //expect(instance).to.be();
    });

    it('should have the property allowedOAuthFlowsUserPoolClient (base name: "AllowedOAuthFlowsUserPoolClient")', function() {
      // uncomment below and update the code to test the property allowedOAuthFlowsUserPoolClient
      //var instance = new AmazonCognitoIdentityProvider.DescribeUserPoolClientResponseUserPoolClient();
      //expect(instance).to.be();
    });

    it('should have the property analyticsConfiguration (base name: "AnalyticsConfiguration")', function() {
      // uncomment below and update the code to test the property analyticsConfiguration
      //var instance = new AmazonCognitoIdentityProvider.DescribeUserPoolClientResponseUserPoolClient();
      //expect(instance).to.be();
    });

    it('should have the property preventUserExistenceErrors (base name: "PreventUserExistenceErrors")', function() {
      // uncomment below and update the code to test the property preventUserExistenceErrors
      //var instance = new AmazonCognitoIdentityProvider.DescribeUserPoolClientResponseUserPoolClient();
      //expect(instance).to.be();
    });

    it('should have the property enableTokenRevocation (base name: "EnableTokenRevocation")', function() {
      // uncomment below and update the code to test the property enableTokenRevocation
      //var instance = new AmazonCognitoIdentityProvider.DescribeUserPoolClientResponseUserPoolClient();
      //expect(instance).to.be();
    });

    it('should have the property enablePropagateAdditionalUserContextData (base name: "EnablePropagateAdditionalUserContextData")', function() {
      // uncomment below and update the code to test the property enablePropagateAdditionalUserContextData
      //var instance = new AmazonCognitoIdentityProvider.DescribeUserPoolClientResponseUserPoolClient();
      //expect(instance).to.be();
    });

    it('should have the property authSessionValidity (base name: "AuthSessionValidity")', function() {
      // uncomment below and update the code to test the property authSessionValidity
      //var instance = new AmazonCognitoIdentityProvider.DescribeUserPoolClientResponseUserPoolClient();
      //expect(instance).to.be();
    });
