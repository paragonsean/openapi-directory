...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.NotifyConfigurationTypeMfaEmail();
  });
  ...
  describe('NotifyConfigurationTypeMfaEmail', function() {
    it('should create an instance of NotifyConfigurationTypeMfaEmail', function() {
      // uncomment below and update the code to test NotifyConfigurationTypeMfaEmail
      //var instance = new AmazonCognitoIdentityProvider.NotifyConfigurationTypeMfaEmail();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.NotifyConfigurationTypeMfaEmail);
    });
