...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.ListResourceServersRequest();
  });
  ...
  describe('ListResourceServersRequest', function() {
    it('should create an instance of ListResourceServersRequest', function() {
      // uncomment below and update the code to test ListResourceServersRequest
      //var instance = new AmazonCognitoIdentityProvider.ListResourceServersRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.ListResourceServersRequest);
    });
