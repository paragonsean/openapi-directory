...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.ListDevicesRequest();
  });
  ...
  describe('ListDevicesRequest', function() {
    it('should create an instance of ListDevicesRequest', function() {
      // uncomment below and update the code to test ListDevicesRequest
      //var instance = new AmazonCognitoIdentityProvider.ListDevicesRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.ListDevicesRequest);
    });
