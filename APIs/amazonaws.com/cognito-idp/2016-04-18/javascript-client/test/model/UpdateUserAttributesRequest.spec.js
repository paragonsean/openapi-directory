...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.UpdateUserAttributesRequest();
  });
  ...
  describe('UpdateUserAttributesRequest', function() {
    it('should create an instance of UpdateUserAttributesRequest', function() {
      // uncomment below and update the code to test UpdateUserAttributesRequest
      //var instance = new AmazonCognitoIdentityProvider.UpdateUserAttributesRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.UpdateUserAttributesRequest);
    });
