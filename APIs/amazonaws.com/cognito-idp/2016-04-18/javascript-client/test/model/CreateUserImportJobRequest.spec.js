...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.CreateUserImportJobRequest();
  });
  ...
  describe('CreateUserImportJobRequest', function() {
    it('should create an instance of CreateUserImportJobRequest', function() {
      // uncomment below and update the code to test CreateUserImportJobRequest
      //var instance = new AmazonCognitoIdentityProvider.CreateUserImportJobRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.CreateUserImportJobRequest);
    });
