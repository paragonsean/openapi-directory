...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AdminLinkProviderForUserRequestDestinationUser();
  });
  ...
  describe('AdminLinkProviderForUserRequestDestinationUser', function() {
    it('should create an instance of AdminLinkProviderForUserRequestDestinationUser', function() {
      // uncomment below and update the code to test AdminLinkProviderForUserRequestDestinationUser
      //var instance = new AmazonCognitoIdentityProvider.AdminLinkProviderForUserRequestDestinationUser();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AdminLinkProviderForUserRequestDestinationUser);
    });
