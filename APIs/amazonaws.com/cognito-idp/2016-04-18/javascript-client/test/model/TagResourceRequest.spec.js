...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.TagResourceRequest();
  });
  ...
  describe('TagResourceRequest', function() {
    it('should create an instance of TagResourceRequest', function() {
      ...
      //var instance = new AmazonCognitoIdentityProvider.TagResourceRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.TagResourceRequest);
    });
