...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.UpdateUserPoolClientRequestTokenValidityUnits();
  });
  ...
  describe('UpdateUserPoolClientRequestTokenValidityUnits', function() {
    it('should create an instance of UpdateUserPoolClientRequestTokenValidityUnits', function() {
      // uncomment below and update the code to test UpdateUserPoolClientRequestTokenValidityUnits
      //var instance = new AmazonCognitoIdentityProvider.UpdateUserPoolClientRequestTokenValidityUnits();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.UpdateUserPoolClientRequestTokenValidityUnits);
    });
