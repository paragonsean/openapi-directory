...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.LambdaConfigTypeCustomSMSSender();
  });
  ...
  describe('LambdaConfigTypeCustomSMSSender', function() {
    it('should create an instance of LambdaConfigTypeCustomSMSSender', function() {
      // uncomment below and update the code to test LambdaConfigTypeCustomSMSSender
      //var instance = new AmazonCognitoIdentityProvider.LambdaConfigTypeCustomSMSSender();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.LambdaConfigTypeCustomSMSSender);
    });
