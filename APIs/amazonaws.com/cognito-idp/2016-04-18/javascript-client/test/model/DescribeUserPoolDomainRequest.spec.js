...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.DescribeUserPoolDomainRequest();
  });
  ...
  describe('DescribeUserPoolDomainRequest', function() {
    it('should create an instance of DescribeUserPoolDomainRequest', function() {
      // uncomment below and update the code to test DescribeUserPoolDomainRequest
      //var instance = new AmazonCognitoIdentityProvider.DescribeUserPoolDomainRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.DescribeUserPoolDomainRequest);
    });
