...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AdminInitiateAuthRequestAnalyticsMetadata();
  });
  ...
  describe('AdminInitiateAuthRequestAnalyticsMetadata', function() {
    it('should create an instance of AdminInitiateAuthRequestAnalyticsMetadata', function() {
      // uncomment below and update the code to test AdminInitiateAuthRequestAnalyticsMetadata
      //var instance = new AmazonCognitoIdentityProvider.AdminInitiateAuthRequestAnalyticsMetadata();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AdminInitiateAuthRequestAnalyticsMetadata);
    });
