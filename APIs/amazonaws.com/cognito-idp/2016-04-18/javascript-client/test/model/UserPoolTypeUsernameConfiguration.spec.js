...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.UserPoolTypeUsernameConfiguration();
  });
  ...
  describe('UserPoolTypeUsernameConfiguration', function() {
    it('should create an instance of UserPoolTypeUsernameConfiguration', function() {
      // uncomment below and update the code to test UserPoolTypeUsernameConfiguration
      //var instance = new AmazonCognitoIdentityProvider.UserPoolTypeUsernameConfiguration();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.UserPoolTypeUsernameConfiguration);
    });
