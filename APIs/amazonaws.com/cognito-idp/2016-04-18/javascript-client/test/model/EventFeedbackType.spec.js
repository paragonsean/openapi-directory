...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.EventFeedbackType();
  });
  ...
  describe('EventFeedbackType', function() {
    it('should create an instance of EventFeedbackType', function() {
      // uncomment below and update the code to test EventFeedbackType
      //var instance = new AmazonCognitoIdentityProvider.EventFeedbackType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.EventFeedbackType);
    });
    ...
    it('should have the property feedbackDate (base name: "FeedbackDate")', function() {
