...
(function(root, factory) {
  ...
  describe('EventResponseType', function() {
    it('should create an instance of EventResponseType', function() {
      // uncomment below and update the code to test EventResponseType
      //var instance = new AmazonCognitoIdentityProvider.EventResponseType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.EventResponseType);
    });
