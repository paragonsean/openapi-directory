...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.GetUserAttributeVerificationCodeRequest();
  });
  ...
  describe('GetUserAttributeVerificationCodeRequest', function() {
    it('should create an instance of GetUserAttributeVerificationCodeRequest', function() {
      // uncomment below and update the code to test GetUserAttributeVerificationCodeRequest
      //var instance = new AmazonCognitoIdentityProvider.GetUserAttributeVerificationCodeRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.GetUserAttributeVerificationCodeRequest);
    });
