...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.DeleteGroupRequest();
  });
  ...
  describe('DeleteGroupRequest', function() {
    it('should create an instance of DeleteGroupRequest', function() {
      ...
      //var instance = new AmazonCognitoIdentityProvider.DeleteGroupRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.DeleteGroupRequest);
    });
