...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.CompromisedCredentialsRiskConfigurationType();
  });
  ...
  describe('CompromisedCredentialsRiskConfigurationType', function() {
    it('should create an instance of CompromisedCredentialsRiskConfigurationType', function() {
      // uncomment below and update the code to test CompromisedCredentialsRiskConfigurationType
      //var instance = new AmazonCognitoIdentityProvider.CompromisedCredentialsRiskConfigurationType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.CompromisedCredentialsRiskConfigurationType);
    });
