...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.SmsMfaConfigTypeSmsConfiguration();
  });
  ...
  describe('SmsMfaConfigTypeSmsConfiguration', function() {
    it('should create an instance of SmsMfaConfigTypeSmsConfiguration', function() {
      // uncomment below and update the code to test SmsMfaConfigTypeSmsConfiguration
      //var instance = new AmazonCognitoIdentityProvider.SmsMfaConfigTypeSmsConfiguration();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.SmsMfaConfigTypeSmsConfiguration);
    });
