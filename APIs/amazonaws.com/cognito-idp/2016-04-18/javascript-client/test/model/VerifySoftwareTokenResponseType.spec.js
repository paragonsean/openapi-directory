...
(function(root, factory) {
  ...
  describe('VerifySoftwareTokenResponseType', function() {
    it('should create an instance of VerifySoftwareTokenResponseType', function() {
      // uncomment below and update the code to test VerifySoftwareTokenResponseType
      //var instance = new AmazonCognitoIdentityProvider.VerifySoftwareTokenResponseType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.VerifySoftwareTokenResponseType);
    });
