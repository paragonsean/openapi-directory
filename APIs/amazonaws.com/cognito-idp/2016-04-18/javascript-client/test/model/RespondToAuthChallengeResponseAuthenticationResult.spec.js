...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.RespondToAuthChallengeResponseAuthenticationResult();
  });
  ...
  describe('RespondToAuthChallengeResponseAuthenticationResult', function() {
    it('should create an instance of RespondToAuthChallengeResponseAuthenticationResult', function() {
      // uncomment below and update the code to test RespondToAuthChallengeResponseAuthenticationResult
      //var instance = new AmazonCognitoIdentityProvider.RespondToAuthChallengeResponseAuthenticationResult();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.RespondToAuthChallengeResponseAuthenticationResult);
    });
    ...
    it('should have the property newDeviceMetadata (base name: "NewDeviceMetadata")', function() {
      // uncomment below and update the code to test the property newDeviceMetadata
      //var instance = new AmazonCognitoIdentityProvider.RespondToAuthChallengeResponseAuthenticationResult();
      //expect(instance).to.be();
    });
