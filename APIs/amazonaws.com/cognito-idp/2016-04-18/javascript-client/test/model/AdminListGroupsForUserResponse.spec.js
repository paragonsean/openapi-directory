...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AdminListGroupsForUserResponse();
  });
  ...
  describe('AdminListGroupsForUserResponse', function() {
    it('should create an instance of AdminListGroupsForUserResponse', function() {
      // uncomment below and update the code to test AdminListGroupsForUserResponse
      //var instance = new AmazonCognitoIdentityProvider.AdminListGroupsForUserResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AdminListGroupsForUserResponse);
    });
