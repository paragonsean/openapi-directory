...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.CreateResourceServerResponse();
  });
  ...
  describe('CreateResourceServerResponse', function() {
    it('should create an instance of CreateResourceServerResponse', function() {
      // uncomment below and update the code to test CreateResourceServerResponse
      //var instance = new AmazonCognitoIdentityProvider.CreateResourceServerResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.CreateResourceServerResponse);
    });

    it('should have the property resourceServer (base name: "ResourceServer")', function() {
      // uncomment below and update the code to test the property resourceServer
      //var instance = new AmazonCognitoIdentityProvider.CreateResourceServerResponse();
