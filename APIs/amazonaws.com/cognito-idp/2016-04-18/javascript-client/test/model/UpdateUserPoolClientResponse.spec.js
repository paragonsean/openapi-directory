...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.UpdateUserPoolClientResponse();
  });
  ...
  describe('UpdateUserPoolClientResponse', function() {
    it('should create an instance of UpdateUserPoolClientResponse', function() {
      // uncomment below and update the code to test UpdateUserPoolClientResponse
      //var instance = new AmazonCognitoIdentityProvider.UpdateUserPoolClientResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.UpdateUserPoolClientResponse);
    });

    it('should have the property userPoolClient (base name: "UserPoolClient")', function() {
      // uncomment below and update the code to test the property userPoolClient
      //var instance = new AmazonCognitoIdentityProvider.UpdateUserPoolClientResponse();
