...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AdminLinkProviderForUserRequestSourceUser();
  });
  ...
  describe('AdminLinkProviderForUserRequestSourceUser', function() {
    it('should create an instance of AdminLinkProviderForUserRequestSourceUser', function() {
      // uncomment below and update the code to test AdminLinkProviderForUserRequestSourceUser
      //var instance = new AmazonCognitoIdentityProvider.AdminLinkProviderForUserRequestSourceUser();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AdminLinkProviderForUserRequestSourceUser);
    });
    ...
    it('should have the property providerAttributeName (base name: "ProviderAttributeName")', function() {
      // uncomment below and update the code to test the property providerAttributeName
      //var instance = new AmazonCognitoIdentityProvider.AdminLinkProviderForUserRequestSourceUser();
      //expect(instance).to.be();
    });

    it('should have the property providerAttributeValue (base name: "ProviderAttributeValue")', function() {
      // uncomment below and update the code to test the property providerAttributeValue
      //var instance = new AmazonCognitoIdentityProvider.AdminLinkProviderForUserRequestSourceUser();
      //expect(instance).to.be();
    });
