...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.DescribeRiskConfigurationResponseRiskConfiguration();
  });
  ...
  describe('DescribeRiskConfigurationResponseRiskConfiguration', function() {
    it('should create an instance of DescribeRiskConfigurationResponseRiskConfiguration', function() {
      // uncomment below and update the code to test DescribeRiskConfigurationResponseRiskConfiguration
      //var instance = new AmazonCognitoIdentityProvider.DescribeRiskConfigurationResponseRiskConfiguration();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.DescribeRiskConfigurationResponseRiskConfiguration);
    });
