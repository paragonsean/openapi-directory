...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AnalyticsConfigurationType();
  });
  ...
  describe('AnalyticsConfigurationType', function() {
    it('should create an instance of AnalyticsConfigurationType', function() {
      // uncomment below and update the code to test AnalyticsConfigurationType
      //var instance = new AmazonCognitoIdentityProvider.AnalyticsConfigurationType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AnalyticsConfigurationType);
    });
    ...
    it('should have the property userDataShared (base name: "UserDataShared")', function() {
      // uncomment below and update the code to test the property userDataShared
      //var instance = new AmazonCognitoIdentityProvider.AnalyticsConfigurationType();
      //expect(instance).to.be();
    });
