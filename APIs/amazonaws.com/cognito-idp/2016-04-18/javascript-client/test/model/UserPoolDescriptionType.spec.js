...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.UserPoolDescriptionType();
  });
  ...
  describe('UserPoolDescriptionType', function() {
    it('should create an instance of UserPoolDescriptionType', function() {
      // uncomment below and update the code to test UserPoolDescriptionType
      //var instance = new AmazonCognitoIdentityProvider.UserPoolDescriptionType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.UserPoolDescriptionType);
    });
