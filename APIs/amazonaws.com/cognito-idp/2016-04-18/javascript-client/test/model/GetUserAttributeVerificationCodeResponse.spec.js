...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.GetUserAttributeVerificationCodeResponse();
  });
  ...
  describe('GetUserAttributeVerificationCodeResponse', function() {
    it('should create an instance of GetUserAttributeVerificationCodeResponse', function() {
      // uncomment below and update the code to test GetUserAttributeVerificationCodeResponse
      //var instance = new AmazonCognitoIdentityProvider.GetUserAttributeVerificationCodeResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.GetUserAttributeVerificationCodeResponse);
    });

    it('should have the property codeDeliveryDetails (base name: "CodeDeliveryDetails")', function() {
      // uncomment below and update the code to test the property codeDeliveryDetails
      //var instance = new AmazonCognitoIdentityProvider.GetUserAttributeVerificationCodeResponse();
