...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AdminDisableProviderForUserRequest();
  });
  ...
  describe('AdminDisableProviderForUserRequest', function() {
    it('should create an instance of AdminDisableProviderForUserRequest', function() {
      // uncomment below and update the code to test AdminDisableProviderForUserRequest
      //var instance = new AmazonCognitoIdentityProvider.AdminDisableProviderForUserRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AdminDisableProviderForUserRequest);
    });
