...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.ConfirmForgotPasswordRequestAnalyticsMetadata();
  });
  ...
  describe('ConfirmForgotPasswordRequestAnalyticsMetadata', function() {
    it('should create an instance of ConfirmForgotPasswordRequestAnalyticsMetadata', function() {
      // uncomment below and update the code to test ConfirmForgotPasswordRequestAnalyticsMetadata
      //var instance = new AmazonCognitoIdentityProvider.ConfirmForgotPasswordRequestAnalyticsMetadata();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.ConfirmForgotPasswordRequestAnalyticsMetadata);
    });
