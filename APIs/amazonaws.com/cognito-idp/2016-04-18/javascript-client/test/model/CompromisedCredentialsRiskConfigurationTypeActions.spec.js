...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.CompromisedCredentialsRiskConfigurationTypeActions();
  });
  ...
  describe('CompromisedCredentialsRiskConfigurationTypeActions', function() {
    it('should create an instance of CompromisedCredentialsRiskConfigurationTypeActions', function() {
      // uncomment below and update the code to test CompromisedCredentialsRiskConfigurationTypeActions
      //var instance = new AmazonCognitoIdentityProvider.CompromisedCredentialsRiskConfigurationTypeActions();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.CompromisedCredentialsRiskConfigurationTypeActions);
    });
