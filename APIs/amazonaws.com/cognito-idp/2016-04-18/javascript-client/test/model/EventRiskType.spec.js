...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.EventRiskType();
  });
  ...
  describe('EventRiskType', function() {
    it('should create an instance of EventRiskType', function() {
      // uncomment below and update the code to test EventRiskType
      //var instance = new AmazonCognitoIdentityProvider.EventRiskType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.EventRiskType);
    });
