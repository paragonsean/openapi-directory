...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.GetUserAttributeVerificationCodeResponseCodeDeliveryDetails();
  });
  ...
  describe('GetUserAttributeVerificationCodeResponseCodeDeliveryDetails', function() {
    it('should create an instance of GetUserAttributeVerificationCodeResponseCodeDeliveryDetails', function() {
      // uncomment below and update the code to test GetUserAttributeVerificationCodeResponseCodeDeliveryDetails
      //var instance = new AmazonCognitoIdentityProvider.GetUserAttributeVerificationCodeResponseCodeDeliveryDetails();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.GetUserAttributeVerificationCodeResponseCodeDeliveryDetails);
    });
