...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.DescribeUserPoolRequest();
  });
  ...
  describe('DescribeUserPoolRequest', function() {
    it('should create an instance of DescribeUserPoolRequest', function() {
      // uncomment below and update the code to test DescribeUserPoolRequest
      //var instance = new AmazonCognitoIdentityProvider.DescribeUserPoolRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.DescribeUserPoolRequest);
    });
