...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.SMSMfaSettingsType();
  });
  ...
  describe('SMSMfaSettingsType', function() {
    it('should create an instance of SMSMfaSettingsType', function() {
      // uncomment below and update the code to test SMSMfaSettingsType
      //var instance = new AmazonCognitoIdentityProvider.SMSMfaSettingsType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.SMSMfaSettingsType);
    });
