...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.ListResourceServersResponse();
  });
  ...
  describe('ListResourceServersResponse', function() {
    it('should create an instance of ListResourceServersResponse', function() {
      // uncomment below and update the code to test ListResourceServersResponse
      //var instance = new AmazonCognitoIdentityProvider.ListResourceServersResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.ListResourceServersResponse);
    });

    it('should have the property resourceServers (base name: "ResourceServers")', function() {
      // uncomment below and update the code to test the property resourceServers
      //var instance = new AmazonCognitoIdentityProvider.ListResourceServersResponse();
