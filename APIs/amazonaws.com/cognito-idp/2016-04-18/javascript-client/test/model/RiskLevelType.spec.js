...
(function(root, factory) {
  ...
  describe('RiskLevelType', function() {
    it('should create an instance of RiskLevelType', function() {
      // uncomment below and update the code to test RiskLevelType
      //var instance = new AmazonCognitoIdentityProvider.RiskLevelType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.RiskLevelType);
    });
