...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.ListUsersResponse();
  });
  ...
  describe('ListUsersResponse', function() {
    it('should create an instance of ListUsersResponse', function() {
      ...
      //var instance = new AmazonCognitoIdentityProvider.ListUsersResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.ListUsersResponse);
    });
