...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.UserPoolDescriptionTypeLambdaConfig();
  });
  ...
  describe('UserPoolDescriptionTypeLambdaConfig', function() {
    it('should create an instance of UserPoolDescriptionTypeLambdaConfig', function() {
      // uncomment below and update the code to test UserPoolDescriptionTypeLambdaConfig
      //var instance = new AmazonCognitoIdentityProvider.UserPoolDescriptionTypeLambdaConfig();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.UserPoolDescriptionTypeLambdaConfig);
    });

    it('should have the property preSignUp (base name: "PreSignUp")', function() {
      // uncomment below and update the code to test the property preSignUp
      //var instance = new AmazonCognitoIdentityProvider.UserPoolDescriptionTypeLambdaConfig();
    ...
    it('should have the property postConfirmation (base name: "PostConfirmation")', function() {
      // uncomment below and update the code to test the property postConfirmation
      //var instance = new AmazonCognitoIdentityProvider.UserPoolDescriptionTypeLambdaConfig();
      //expect(instance).to.be();
    });

    it('should have the property preAuthentication (base name: "PreAuthentication")', function() {
      // uncomment below and update the code to test the property preAuthentication
      //var instance = new AmazonCognitoIdentityProvider.UserPoolDescriptionTypeLambdaConfig();
      //expect(instance).to.be();
    });

    it('should have the property postAuthentication (base name: "PostAuthentication")', function() {
      // uncomment below and update the code to test the property postAuthentication
      //var instance = new AmazonCognitoIdentityProvider.UserPoolDescriptionTypeLambdaConfig();
      //expect(instance).to.be();
    });

    it('should have the property defineAuthChallenge (base name: "DefineAuthChallenge")', function() {
      // uncomment below and update the code to test the property defineAuthChallenge
      //var instance = new AmazonCognitoIdentityProvider.UserPoolDescriptionTypeLambdaConfig();
      //expect(instance).to.be();
    });

    it('should have the property createAuthChallenge (base name: "CreateAuthChallenge")', function() {
      // uncomment below and update the code to test the property createAuthChallenge
      //var instance = new AmazonCognitoIdentityProvider.UserPoolDescriptionTypeLambdaConfig();
      //expect(instance).to.be();
    });

    it('should have the property verifyAuthChallengeResponse (base name: "VerifyAuthChallengeResponse")', function() {
      // uncomment below and update the code to test the property verifyAuthChallengeResponse
      //var instance = new AmazonCognitoIdentityProvider.UserPoolDescriptionTypeLambdaConfig();
      //expect(instance).to.be();
    });

    it('should have the property preTokenGeneration (base name: "PreTokenGeneration")', function() {
      // uncomment below and update the code to test the property preTokenGeneration
      //var instance = new AmazonCognitoIdentityProvider.UserPoolDescriptionTypeLambdaConfig();
      //expect(instance).to.be();
    });

    it('should have the property userMigration (base name: "UserMigration")', function() {
      // uncomment below and update the code to test the property userMigration
      //var instance = new AmazonCognitoIdentityProvider.UserPoolDescriptionTypeLambdaConfig();
      //expect(instance).to.be();
    });

    it('should have the property customSMSSender (base name: "CustomSMSSender")', function() {
      // uncomment below and update the code to test the property customSMSSender
      //var instance = new AmazonCognitoIdentityProvider.UserPoolDescriptionTypeLambdaConfig();
      //expect(instance).to.be();
    });

    it('should have the property customEmailSender (base name: "CustomEmailSender")', function() {
      // uncomment below and update the code to test the property customEmailSender
      //var instance = new AmazonCognitoIdentityProvider.UserPoolDescriptionTypeLambdaConfig();
      //expect(instance).to.be();
    });
