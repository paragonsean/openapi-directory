...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.PasswordPolicyType();
  });
  ...
  describe('PasswordPolicyType', function() {
    it('should create an instance of PasswordPolicyType', function() {
      // uncomment below and update the code to test PasswordPolicyType
      //var instance = new AmazonCognitoIdentityProvider.PasswordPolicyType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.PasswordPolicyType);
    });
