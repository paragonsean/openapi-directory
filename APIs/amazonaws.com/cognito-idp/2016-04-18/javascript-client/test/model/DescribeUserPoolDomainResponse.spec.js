...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.DescribeUserPoolDomainResponse();
  });
  ...
  describe('DescribeUserPoolDomainResponse', function() {
    it('should create an instance of DescribeUserPoolDomainResponse', function() {
      // uncomment below and update the code to test DescribeUserPoolDomainResponse
      //var instance = new AmazonCognitoIdentityProvider.DescribeUserPoolDomainResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.DescribeUserPoolDomainResponse);
    });

    it('should have the property domainDescription (base name: "DomainDescription")', function() {
      // uncomment below and update the code to test the property domainDescription
      //var instance = new AmazonCognitoIdentityProvider.DescribeUserPoolDomainResponse();
