...
(function(root, factory) {
  ...
  describe('AccountTakeoverEventActionType', function() {
    it('should create an instance of AccountTakeoverEventActionType', function() {
      // uncomment below and update the code to test AccountTakeoverEventActionType
      //var instance = new AmazonCognitoIdentityProvider.AccountTakeoverEventActionType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AccountTakeoverEventActionType);
    });
