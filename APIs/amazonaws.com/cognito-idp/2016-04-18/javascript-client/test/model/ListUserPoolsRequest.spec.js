...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.ListUserPoolsRequest();
  });
  ...
  describe('ListUserPoolsRequest', function() {
    it('should create an instance of ListUserPoolsRequest', function() {
      // uncomment below and update the code to test ListUserPoolsRequest
      //var instance = new AmazonCognitoIdentityProvider.ListUserPoolsRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.ListUserPoolsRequest);
    });
