...
(function(root, factory) {
  ...
  describe('EmailSendingAccountType', function() {
    it('should create an instance of EmailSendingAccountType', function() {
      // uncomment below and update the code to test EmailSendingAccountType
      //var instance = new AmazonCognitoIdentityProvider.EmailSendingAccountType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.EmailSendingAccountType);
    });
