...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.GetIdentityProviderByIdentifierRequest();
  });
  ...
  describe('GetIdentityProviderByIdentifierRequest', function() {
    it('should create an instance of GetIdentityProviderByIdentifierRequest', function() {
      // uncomment below and update the code to test GetIdentityProviderByIdentifierRequest
      //var instance = new AmazonCognitoIdentityProvider.GetIdentityProviderByIdentifierRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.GetIdentityProviderByIdentifierRequest);
    });
    ...
    it('should have the property idpIdentifier (base name: "IdpIdentifier")', function() {
      // uncomment below and update the code to test the property idpIdentifier
      //var instance = new AmazonCognitoIdentityProvider.GetIdentityProviderByIdentifierRequest();
      //expect(instance).to.be();
    });
