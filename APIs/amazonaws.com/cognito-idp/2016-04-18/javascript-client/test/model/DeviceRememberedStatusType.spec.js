...
(function(root, factory) {
  ...
  describe('DeviceRememberedStatusType', function() {
    it('should create an instance of DeviceRememberedStatusType', function() {
      // uncomment below and update the code to test DeviceRememberedStatusType
      //var instance = new AmazonCognitoIdentityProvider.DeviceRememberedStatusType();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.DeviceRememberedStatusType);
    });
