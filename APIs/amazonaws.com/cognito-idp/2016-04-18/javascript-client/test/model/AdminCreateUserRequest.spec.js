...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.AdminCreateUserRequest();
  });
  ...
  describe('AdminCreateUserRequest', function() {
    it('should create an instance of AdminCreateUserRequest', function() {
      // uncomment below and update the code to test AdminCreateUserRequest
      //var instance = new AmazonCognitoIdentityProvider.AdminCreateUserRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.AdminCreateUserRequest);
    });
    ...
    it('should have the property forceAliasCreation (base name: "ForceAliasCreation")', function() {
      // uncomment below and update the code to test the property forceAliasCreation
      //var instance = new AmazonCognitoIdentityProvider.AdminCreateUserRequest();
      //expect(instance).to.be();
    });
    ...
    it('should have the property desiredDeliveryMediums (base name: "DesiredDeliveryMediums")', function() {
      // uncomment below and update the code to test the property desiredDeliveryMediums
      //var instance = new AmazonCognitoIdentityProvider.AdminCreateUserRequest();
      //expect(instance).to.be();
    });
