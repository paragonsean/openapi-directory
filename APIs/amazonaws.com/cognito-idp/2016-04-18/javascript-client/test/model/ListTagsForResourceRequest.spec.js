...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.ListTagsForResourceRequest();
  });
  ...
  describe('ListTagsForResourceRequest', function() {
    it('should create an instance of ListTagsForResourceRequest', function() {
      ...
      //var instance = new AmazonCognitoIdentityProvider.ListTagsForResourceRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.ListTagsForResourceRequest);
    });
