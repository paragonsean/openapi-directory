...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.GetIdentityProviderByIdentifierResponse();
  });
  ...
  describe('GetIdentityProviderByIdentifierResponse', function() {
    it('should create an instance of GetIdentityProviderByIdentifierResponse', function() {
      // uncomment below and update the code to test GetIdentityProviderByIdentifierResponse
      //var instance = new AmazonCognitoIdentityProvider.GetIdentityProviderByIdentifierResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.GetIdentityProviderByIdentifierResponse);
    });
