...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.CreateUserPoolRequestAdminCreateUserConfig();
  });
  ...
  describe('CreateUserPoolRequestAdminCreateUserConfig', function() {
    it('should create an instance of CreateUserPoolRequestAdminCreateUserConfig', function() {
      // uncomment below and update the code to test CreateUserPoolRequestAdminCreateUserConfig
      //var instance = new AmazonCognitoIdentityProvider.CreateUserPoolRequestAdminCreateUserConfig();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.CreateUserPoolRequestAdminCreateUserConfig);
    });

    it('should have the property allowAdminCreateUserOnly (base name: "AllowAdminCreateUserOnly")', function() {
      // uncomment below and update the code to test the property allowAdminCreateUserOnly
      //var instance = new AmazonCognitoIdentityProvider.CreateUserPoolRequestAdminCreateUserConfig();
      //expect(instance).to.be();
    });

    it('should have the property unusedAccountValidityDays (base name: "UnusedAccountValidityDays")', function() {
      // uncomment below and update the code to test the property unusedAccountValidityDays
      //var instance = new AmazonCognitoIdentityProvider.CreateUserPoolRequestAdminCreateUserConfig();
      //expect(instance).to.be();
    });

    it('should have the property inviteMessageTemplate (base name: "InviteMessageTemplate")', function() {
      // uncomment below and update the code to test the property inviteMessageTemplate
      //var instance = new AmazonCognitoIdentityProvider.CreateUserPoolRequestAdminCreateUserConfig();
      //expect(instance).to.be();
    });
