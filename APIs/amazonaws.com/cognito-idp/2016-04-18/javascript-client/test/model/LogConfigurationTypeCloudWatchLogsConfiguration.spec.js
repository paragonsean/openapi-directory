...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.LogConfigurationTypeCloudWatchLogsConfiguration();
  });
  ...
  describe('LogConfigurationTypeCloudWatchLogsConfiguration', function() {
    it('should create an instance of LogConfigurationTypeCloudWatchLogsConfiguration', function() {
      // uncomment below and update the code to test LogConfigurationTypeCloudWatchLogsConfiguration
      //var instance = new AmazonCognitoIdentityProvider.LogConfigurationTypeCloudWatchLogsConfiguration();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.LogConfigurationTypeCloudWatchLogsConfiguration);
    });
