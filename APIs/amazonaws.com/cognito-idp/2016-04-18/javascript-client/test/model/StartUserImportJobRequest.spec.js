...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.StartUserImportJobRequest();
  });
  ...
  describe('StartUserImportJobRequest', function() {
    it('should create an instance of StartUserImportJobRequest', function() {
      // uncomment below and update the code to test StartUserImportJobRequest
      //var instance = new AmazonCognitoIdentityProvider.StartUserImportJobRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.StartUserImportJobRequest);
    });
