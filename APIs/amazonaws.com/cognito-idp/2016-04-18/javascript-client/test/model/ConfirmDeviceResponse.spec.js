...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.ConfirmDeviceResponse();
  });
  ...
  describe('ConfirmDeviceResponse', function() {
    it('should create an instance of ConfirmDeviceResponse', function() {
      // uncomment below and update the code to test ConfirmDeviceResponse
      //var instance = new AmazonCognitoIdentityProvider.ConfirmDeviceResponse();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.ConfirmDeviceResponse);
    });

    it('should have the property userConfirmationNecessary (base name: "UserConfirmationNecessary")', function() {
      // uncomment below and update the code to test the property userConfirmationNecessary
      //var instance = new AmazonCognitoIdentityProvider.ConfirmDeviceResponse();
