...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.ProviderDescription();
  });
  ...
  describe('ProviderDescription', function() {
    it('should create an instance of ProviderDescription', function() {
      // uncomment below and update the code to test ProviderDescription
      //var instance = new AmazonCognitoIdentityProvider.ProviderDescription();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.ProviderDescription);
    });
