...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCognitoIdentityProvider.ConfirmForgotPasswordRequest();
  });
  ...
  describe('ConfirmForgotPasswordRequest', function() {
    it('should create an instance of ConfirmForgotPasswordRequest', function() {
      // uncomment below and update the code to test ConfirmForgotPasswordRequest
      //var instance = new AmazonCognitoIdentityProvider.ConfirmForgotPasswordRequest();
      //expect(instance).to.be.a(AmazonCognitoIdentityProvider.ConfirmForgotPasswordRequest);
    });
