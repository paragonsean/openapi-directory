...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://cognito-idp.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://cognito-idp.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2016-04-18/Javascript'
        };
