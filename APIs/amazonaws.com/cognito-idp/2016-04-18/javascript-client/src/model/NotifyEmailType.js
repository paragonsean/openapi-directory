...
/**
 * The NotifyEmailType model module.
 * @module model/NotifyEmailType
 * @version 2016-04-18
 */
class NotifyEmailType {
    /**
     * Constructs a new <code>NotifyEmailType</code>.
     * The notify email type.
     * @alias module:model/NotifyEmailType
     * @param subject {String} 
     */
    constructor(subject) { 
        
        NotifyEmailType.initialize(this, subject);
    }
    ...
    /**
     * Constructs a <code>NotifyEmailType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NotifyEmailType} obj Optional instance to populate.
     * @return {module:model/NotifyEmailType} The populated <code>NotifyEmailType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NotifyEmailType();
    ...
    /**
     * Validates the JSON data with respect to <code>NotifyEmailType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NotifyEmailType</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of NotifyEmailType.RequiredProperties) {
        ...
        if (data['TextBody']) { // data not null
          String.validateJSON(data['TextBody']);
        }
...
NotifyEmailType.RequiredProperties = ["Subject"];

/**
 * @member {String} Subject
 */
NotifyEmailType.prototype['Subject'] = undefined;

/**
 * @member {String} HtmlBody
 */
NotifyEmailType.prototype['HtmlBody'] = undefined;

/**
 * @member {String} TextBody
 */
NotifyEmailType.prototype['TextBody'] = undefined;
...
export default NotifyEmailType;
