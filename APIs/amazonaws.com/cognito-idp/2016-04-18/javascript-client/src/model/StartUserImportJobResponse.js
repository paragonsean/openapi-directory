...
/**
 * The StartUserImportJobResponse model module.
 * @module model/StartUserImportJobResponse
 * @version 2016-04-18
 */
class StartUserImportJobResponse {
    /**
     * Constructs a new <code>StartUserImportJobResponse</code>.
     * Represents the response from the server to the request to start the user import job.
     * @alias module:model/StartUserImportJobResponse
     */
    constructor() { 
        
        StartUserImportJobResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StartUserImportJobResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartUserImportJobResponse} obj Optional instance to populate.
     * @return {module:model/StartUserImportJobResponse} The populated <code>StartUserImportJobResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartUserImportJobResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>StartUserImportJobResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartUserImportJobResponse</code>.
     */
 ...
 */
StartUserImportJobResponse.prototype['UserImportJob'] = undefined;
...
export default StartUserImportJobResponse;
