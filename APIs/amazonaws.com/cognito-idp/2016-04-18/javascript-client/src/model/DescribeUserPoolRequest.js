...
/**
 * The DescribeUserPoolRequest model module.
 * @module model/DescribeUserPoolRequest
 * @version 2016-04-18
 */
class DescribeUserPoolRequest {
    /**
     * Constructs a new <code>DescribeUserPoolRequest</code>.
     * Represents the request to describe the user pool.
     * @alias module:model/DescribeUserPoolRequest
     * @param userPoolId {String} 
     */
    constructor(userPoolId) { 
        
        DescribeUserPoolRequest.initialize(this, userPoolId);
    }
    ...
    /**
     * Constructs a <code>DescribeUserPoolRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeUserPoolRequest} obj Optional instance to populate.
     * @return {module:model/DescribeUserPoolRequest} The populated <code>DescribeUserPoolRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeUserPoolRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeUserPoolRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeUserPoolRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeUserPoolRequest.RequiredProperties) {
...
DescribeUserPoolRequest.RequiredProperties = ["UserPoolId"];

/**
 * @member {String} UserPoolId
 */
DescribeUserPoolRequest.prototype['UserPoolId'] = undefined;
...
export default DescribeUserPoolRequest;
