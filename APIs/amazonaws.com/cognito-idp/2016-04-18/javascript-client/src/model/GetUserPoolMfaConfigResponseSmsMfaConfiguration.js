...
/**
 * The GetUserPoolMfaConfigResponseSmsMfaConfiguration model module.
 * @module model/GetUserPoolMfaConfigResponseSmsMfaConfiguration
 * @version 2016-04-18
 */
class GetUserPoolMfaConfigResponseSmsMfaConfiguration {
    /**
     * Constructs a new <code>GetUserPoolMfaConfigResponseSmsMfaConfiguration</code>.
     * @alias module:model/GetUserPoolMfaConfigResponseSmsMfaConfiguration
     * @implements module:model/SmsMfaConfigType
     */
    constructor() { 
        SmsMfaConfigType.initialize(this);
        GetUserPoolMfaConfigResponseSmsMfaConfiguration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetUserPoolMfaConfigResponseSmsMfaConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetUserPoolMfaConfigResponseSmsMfaConfiguration} obj Optional instance to populate.
     * @return {module:model/GetUserPoolMfaConfigResponseSmsMfaConfiguration} The populated <code>GetUserPoolMfaConfigResponseSmsMfaConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetUserPoolMfaConfigResponseSmsMfaConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>GetUserPoolMfaConfigResponseSmsMfaConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetUserPoolMfaConfigResponseSmsMfaConfiguration</code>.
     */
 ...
 */
GetUserPoolMfaConfigResponseSmsMfaConfiguration.prototype['SmsAuthenticationMessage'] = undefined;

/**
 * @member {module:model/SmsMfaConfigTypeSmsConfiguration} SmsConfiguration
 */
GetUserPoolMfaConfigResponseSmsMfaConfiguration.prototype['SmsConfiguration'] = undefined;
...
export default GetUserPoolMfaConfigResponseSmsMfaConfiguration;
