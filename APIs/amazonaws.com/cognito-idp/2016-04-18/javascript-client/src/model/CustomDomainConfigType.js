...
/**
 * The CustomDomainConfigType model module.
 * @module model/CustomDomainConfigType
 * @version 2016-04-18
 */
class CustomDomainConfigType {
    /**
     * Constructs a new <code>CustomDomainConfigType</code>.
     * The configuration for a custom domain that hosts the sign-up and sign-in webpages for your application.
     * @alias module:model/CustomDomainConfigType
    ...
    /**
     * Constructs a <code>CustomDomainConfigType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CustomDomainConfigType} obj Optional instance to populate.
     * @return {module:model/CustomDomainConfigType} The populated <code>CustomDomainConfigType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CustomDomainConfigType();
    ...
    /**
     * Validates the JSON data with respect to <code>CustomDomainConfigType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CustomDomainConfigType</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CustomDomainConfigType.RequiredProperties) {
...
CustomDomainConfigType.RequiredProperties = ["CertificateArn"];
...
export default CustomDomainConfigType;
