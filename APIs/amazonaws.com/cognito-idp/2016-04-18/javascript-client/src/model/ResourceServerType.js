...
/**
 * The ResourceServerType model module.
 * @module model/ResourceServerType
 * @version 2016-04-18
 */
class ResourceServerType {
    /**
     * Constructs a new <code>ResourceServerType</code>.
     * A container for information about a resource server for a user pool.
     * @alias module:model/ResourceServerType
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>ResourceServerType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ResourceServerType} obj Optional instance to populate.
     * @return {module:model/ResourceServerType} The populated <code>ResourceServerType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ResourceServerType();
    ...
    /**
     * Validates the JSON data with respect to <code>ResourceServerType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ResourceServerType</code>.
     */
...
export default ResourceServerType;
