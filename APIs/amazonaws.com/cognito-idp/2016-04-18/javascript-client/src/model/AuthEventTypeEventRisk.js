...
import RiskDecisionType from './RiskDecisionType';
import RiskLevelType from './RiskLevelType';

/**
 * The AuthEventTypeEventRisk model module.
 * @module model/AuthEventTypeEventRisk
 * @version 2016-04-18
 */
class AuthEventTypeEventRisk {
    /**
     * Constructs a new <code>AuthEventTypeEventRisk</code>.
     * @alias module:model/AuthEventTypeEventRisk
     * @implements module:model/EventRiskType
     */
    constructor() { 
        EventRiskType.initialize(this);
        AuthEventTypeEventRisk.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AuthEventTypeEventRisk</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AuthEventTypeEventRisk} obj Optional instance to populate.
     * @return {module:model/AuthEventTypeEventRisk} The populated <code>AuthEventTypeEventRisk</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AuthEventTypeEventRisk();
            EventRiskType.constructFromObject(data, obj);

            if (data.hasOwnProperty('RiskDecision')) {
                obj['RiskDecision'] = ApiClient.convertToType(data['RiskDecision'], RiskDecisionType);
            }
            if (data.hasOwnProperty('RiskLevel')) {
                obj['RiskLevel'] = ApiClient.convertToType(data['RiskLevel'], RiskLevelType);
            }
            if (data.hasOwnProperty('CompromisedCredentialsDetected')) {
                obj['CompromisedCredentialsDetected'] = ApiClient.convertToType(data['CompromisedCredentialsDetected'], 'Boolean');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AuthEventTypeEventRisk</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AuthEventTypeEventRisk</code>.
     */
    static validateJSON(data) {
        // validate the optional field `RiskDecision`
        if (data['RiskDecision']) { // data not null
          RiskDecisionType.validateJSON(data['RiskDecision']);
        }
        // validate the optional field `RiskLevel`
        if (data['RiskLevel']) { // data not null
          RiskLevelType.validateJSON(data['RiskLevel']);
        }
        // validate the optional field `CompromisedCredentialsDetected`
        if (data['CompromisedCredentialsDetected']) { // data not null
          Boolean.validateJSON(data['CompromisedCredentialsDetected']);
        }
...
/**
 * @member {module:model/RiskDecisionType} RiskDecision
 */
AuthEventTypeEventRisk.prototype['RiskDecision'] = undefined;

/**
 * @member {module:model/RiskLevelType} RiskLevel
 */
AuthEventTypeEventRisk.prototype['RiskLevel'] = undefined;

/**
 * @member {Boolean} CompromisedCredentialsDetected
 */
AuthEventTypeEventRisk.prototype['CompromisedCredentialsDetected'] = undefined;


// Implement EventRiskType interface:
/**
 * @member {module:model/RiskDecisionType} RiskDecision
 */
EventRiskType.prototype['RiskDecision'] = undefined;
/**
 * @member {module:model/RiskLevelType} RiskLevel
 */
EventRiskType.prototype['RiskLevel'] = undefined;
/**
 * @member {Boolean} CompromisedCredentialsDetected
 */
EventRiskType.prototype['CompromisedCredentialsDetected'] = undefined;




export default AuthEventTypeEventRisk;
