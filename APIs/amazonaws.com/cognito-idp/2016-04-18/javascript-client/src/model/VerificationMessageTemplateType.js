...
/**
 * The VerificationMessageTemplateType model module.
 * @module model/VerificationMessageTemplateType
 * @version 2016-04-18
 */
class VerificationMessageTemplateType {
    /**
     * Constructs a new <code>VerificationMessageTemplateType</code>.
     * The template for verification messages.
     * @alias module:model/VerificationMessageTemplateType
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>VerificationMessageTemplateType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VerificationMessageTemplateType} obj Optional instance to populate.
     * @return {module:model/VerificationMessageTemplateType} The populated <code>VerificationMessageTemplateType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VerificationMessageTemplateType();
    ...
    /**
     * Validates the JSON data with respect to <code>VerificationMessageTemplateType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VerificationMessageTemplateType</code>.
     */
...
export default VerificationMessageTemplateType;
