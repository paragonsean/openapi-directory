...
/**
 * The UserImportJobType model module.
 * @module model/UserImportJobType
 * @version 2016-04-18
 */
class UserImportJobType {
    /**
     * Constructs a new <code>UserImportJobType</code>.
     * The user import job type.
     * @alias module:model/UserImportJobType
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>UserImportJobType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UserImportJobType} obj Optional instance to populate.
     * @return {module:model/UserImportJobType} The populated <code>UserImportJobType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UserImportJobType();
    ...
    /**
     * Validates the JSON data with respect to <code>UserImportJobType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UserImportJobType</code>.
     */
...
export default UserImportJobType;
