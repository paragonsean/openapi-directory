...
/**
 * The ListUsersInGroupResponse model module.
 * @module model/ListUsersInGroupResponse
 * @version 2016-04-18
 */
class ListUsersInGroupResponse {
    /**
     * Constructs a new <code>ListUsersInGroupResponse</code>.
     * @alias module:model/ListUsersInGroupResponse
     */
    constructor() { 
        
        ListUsersInGroupResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListUsersInGroupResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListUsersInGroupResponse} obj Optional instance to populate.
     * @return {module:model/ListUsersInGroupResponse} The populated <code>ListUsersInGroupResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListUsersInGroupResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>ListUsersInGroupResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListUsersInGroupResponse</code>.
     */
 ...
 * @member {Array} Users
 */
ListUsersInGroupResponse.prototype['Users'] = undefined;

/**
 * @member {String} NextToken
 */
ListUsersInGroupResponse.prototype['NextToken'] = undefined;
...
export default ListUsersInGroupResponse;
