...
/**
 * The CreateUserPoolDomainRequestCustomDomainConfig model module.
 * @module model/CreateUserPoolDomainRequestCustomDomainConfig
 * @version 2016-04-18
 */
class CreateUserPoolDomainRequestCustomDomainConfig {
    /**
     * Constructs a new <code>CreateUserPoolDomainRequestCustomDomainConfig</code>.
     * @alias module:model/CreateUserPoolDomainRequestCustomDomainConfig
     * @implements module:model/CustomDomainConfigType
     * @param certificateArn {String} 
     */
    constructor(certificateArn) { 
        CustomDomainConfigType.initialize(this, certificateArn);
        CreateUserPoolDomainRequestCustomDomainConfig.initialize(this, certificateArn);
    }
    ...
    /**
     * Constructs a <code>CreateUserPoolDomainRequestCustomDomainConfig</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateUserPoolDomainRequestCustomDomainConfig} obj Optional instance to populate.
     * @return {module:model/CreateUserPoolDomainRequestCustomDomainConfig} The populated <code>CreateUserPoolDomainRequestCustomDomainConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateUserPoolDomainRequestCustomDomainConfig();
            CustomDomainConfigType.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>CreateUserPoolDomainRequestCustomDomainConfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateUserPoolDomainRequestCustomDomainConfig</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateUserPoolDomainRequestCustomDomainConfig.RequiredProperties) {
...
CreateUserPoolDomainRequestCustomDomainConfig.RequiredProperties = ["CertificateArn"];

/**
 * @member {String} CertificateArn
 */
CreateUserPoolDomainRequestCustomDomainConfig.prototype['CertificateArn'] = undefined;


// Implement CustomDomainConfigType interface:
/**
 * @member {String} CertificateArn
 */
CustomDomainConfigType.prototype['CertificateArn'] = undefined;




export default CreateUserPoolDomainRequestCustomDomainConfig;
