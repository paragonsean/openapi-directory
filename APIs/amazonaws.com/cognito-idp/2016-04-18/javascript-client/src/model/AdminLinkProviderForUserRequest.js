...
import AdminLinkProviderForUserRequestDestinationUser from './AdminLinkProviderForUserRequestDestinationUser';
import AdminLinkProviderForUserRequestSourceUser from './AdminLinkProviderForUserRequestSourceUser';

/**
 * The AdminLinkProviderForUserRequest model module.
 * @module model/AdminLinkProviderForUserRequest
 * @version 2016-04-18
 */
class AdminLinkProviderForUserRequest {
    /**
     * Constructs a new <code>AdminLinkProviderForUserRequest</code>.
     * @alias module:model/AdminLinkProviderForUserRequest
     * @param userPoolId {String} 
     * @param destinationUser {module:model/AdminLinkProviderForUserRequestDestinationUser} 
     * @param sourceUser {module:model/AdminLinkProviderForUserRequestSourceUser} 
     */
    constructor(userPoolId, destinationUser, sourceUser) { 
        
        AdminLinkProviderForUserRequest.initialize(this, userPoolId, destinationUser, sourceUser);
    }
     ...
     */
    static initialize(obj, userPoolId, destinationUser, sourceUser) { 
        obj['UserPoolId'] = userPoolId;
        obj['DestinationUser'] = destinationUser;
        obj['SourceUser'] = sourceUser;
    }

    /**
     * Constructs a <code>AdminLinkProviderForUserRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdminLinkProviderForUserRequest} obj Optional instance to populate.
     * @return {module:model/AdminLinkProviderForUserRequest} The populated <code>AdminLinkProviderForUserRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdminLinkProviderForUserRequest();

            if (data.hasOwnProperty('UserPoolId')) {
                obj['UserPoolId'] = ApiClient.convertToType(data['UserPoolId'], 'String');
            }
            if (data.hasOwnProperty('DestinationUser')) {
                obj['DestinationUser'] = AdminLinkProviderForUserRequestDestinationUser.constructFromObject(data['DestinationUser']);
            }
            if (data.hasOwnProperty('SourceUser')) {
                obj['SourceUser'] = AdminLinkProviderForUserRequestSourceUser.constructFromObject(data['SourceUser']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AdminLinkProviderForUserRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdminLinkProviderForUserRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AdminLinkProviderForUserRequest.RequiredProperties) {
        ...
        // validate the optional field `DestinationUser`
        if (data['DestinationUser']) { // data not null
          AdminLinkProviderForUserRequestDestinationUser.validateJSON(data['DestinationUser']);
        }
        // validate the optional field `SourceUser`
        if (data['SourceUser']) { // data not null
          AdminLinkProviderForUserRequestSourceUser.validateJSON(data['SourceUser']);
        }
...
AdminLinkProviderForUserRequest.RequiredProperties = ["UserPoolId", "DestinationUser", "SourceUser"];

/**
 * @member {String} UserPoolId
 */
AdminLinkProviderForUserRequest.prototype['UserPoolId'] = undefined;

/**
 * @member {module:model/AdminLinkProviderForUserRequestDestinationUser} DestinationUser
 */
AdminLinkProviderForUserRequest.prototype['DestinationUser'] = undefined;

/**
 * @member {module:model/AdminLinkProviderForUserRequestSourceUser} SourceUser
 */
AdminLinkProviderForUserRequest.prototype['SourceUser'] = undefined;
...
export default AdminLinkProviderForUserRequest;
