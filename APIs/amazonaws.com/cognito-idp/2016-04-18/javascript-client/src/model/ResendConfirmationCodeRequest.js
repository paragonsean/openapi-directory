...
import ResendConfirmationCodeRequestAnalyticsMetadata from './ResendConfirmationCodeRequestAnalyticsMetadata';

/**
 * The ResendConfirmationCodeRequest model module.
 * @module model/ResendConfirmationCodeRequest
 * @version 2016-04-18
 */
class ResendConfirmationCodeRequest {
    /**
     * Constructs a new <code>ResendConfirmationCodeRequest</code>.
     * Represents the request to resend the confirmation code.
     * @alias module:model/ResendConfirmationCodeRequest
     * @param clientId {String} 
     * @param username {String} 
     */
    constructor(clientId, username) { 
        
        ResendConfirmationCodeRequest.initialize(this, clientId, username);
    }
     ...
     */
    static initialize(obj, clientId, username) { 
        obj['ClientId'] = clientId;
        obj['Username'] = username;
    }

    /**
     * Constructs a <code>ResendConfirmationCodeRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ResendConfirmationCodeRequest} obj Optional instance to populate.
     * @return {module:model/ResendConfirmationCodeRequest} The populated <code>ResendConfirmationCodeRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ResendConfirmationCodeRequest();
            ...
            if (data.hasOwnProperty('AnalyticsMetadata')) {
                obj['AnalyticsMetadata'] = ResendConfirmationCodeRequestAnalyticsMetadata.constructFromObject(data['AnalyticsMetadata']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ResendConfirmationCodeRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ResendConfirmationCodeRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ResendConfirmationCodeRequest.RequiredProperties) {
        ...
        if (data['AnalyticsMetadata']) { // data not null
          ResendConfirmationCodeRequestAnalyticsMetadata.validateJSON(data['AnalyticsMetadata']);
        }
...
ResendConfirmationCodeRequest.RequiredProperties = ["ClientId", "Username"];

/**
 * @member {String} ClientId
 */
ResendConfirmationCodeRequest.prototype['ClientId'] = undefined;

/**
 * @member {String} SecretHash
 */
ResendConfirmationCodeRequest.prototype['SecretHash'] = undefined;

/**
 * @member {module:model/ConfirmForgotPasswordRequestUserContextData} UserContextData
 */
ResendConfirmationCodeRequest.prototype['UserContextData'] = undefined;

/**
 * @member {String} Username
 */
ResendConfirmationCodeRequest.prototype['Username'] = undefined;

/**
 * @member {module:model/ResendConfirmationCodeRequestAnalyticsMetadata} AnalyticsMetadata
 */
ResendConfirmationCodeRequest.prototype['AnalyticsMetadata'] = undefined;

/**
 * @member {Object} ClientMetadata
 */
ResendConfirmationCodeRequest.prototype['ClientMetadata'] = undefined;
...
export default ResendConfirmationCodeRequest;
