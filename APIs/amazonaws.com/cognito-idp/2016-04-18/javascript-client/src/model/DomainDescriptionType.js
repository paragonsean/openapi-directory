...
/**
 * The DomainDescriptionType model module.
 * @module model/DomainDescriptionType
 * @version 2016-04-18
 */
class DomainDescriptionType {
    /**
     * Constructs a new <code>DomainDescriptionType</code>.
     * A container for information about a domain.
     * @alias module:model/DomainDescriptionType
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>DomainDescriptionType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DomainDescriptionType} obj Optional instance to populate.
     * @return {module:model/DomainDescriptionType} The populated <code>DomainDescriptionType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DomainDescriptionType();
    ...
    /**
     * Validates the JSON data with respect to <code>DomainDescriptionType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DomainDescriptionType</code>.
     */
...
export default DomainDescriptionType;
