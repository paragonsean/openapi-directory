...
/**
 * The RiskExceptionConfigurationType model module.
 * @module model/RiskExceptionConfigurationType
 * @version 2016-04-18
 */
class RiskExceptionConfigurationType {
    /**
     * Constructs a new <code>RiskExceptionConfigurationType</code>.
     * The type of the configuration to override the risk decision.
     * @alias module:model/RiskExceptionConfigurationType
     */
    constructor() { 
        
        RiskExceptionConfigurationType.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RiskExceptionConfigurationType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RiskExceptionConfigurationType} obj Optional instance to populate.
     * @return {module:model/RiskExceptionConfigurationType} The populated <code>RiskExceptionConfigurationType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RiskExceptionConfigurationType();

            if (data.hasOwnProperty('BlockedIPRangeList')) {
                obj['BlockedIPRangeList'] = ApiClient.convertToType(data['BlockedIPRangeList'], Array);
            }
            if (data.hasOwnProperty('SkippedIPRangeList')) {
                obj['SkippedIPRangeList'] = ApiClient.convertToType(data['SkippedIPRangeList'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>RiskExceptionConfigurationType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RiskExceptionConfigurationType</code>.
     */
    static validateJSON(data) {
        // validate the optional field `BlockedIPRangeList`
        if (data['BlockedIPRangeList']) { // data not null
          Array.validateJSON(data['BlockedIPRangeList']);
        }
        // validate the optional field `SkippedIPRangeList`
        if (data['SkippedIPRangeList']) { // data not null
          Array.validateJSON(data['SkippedIPRangeList']);
        }
...
/**
 * @member {Array} BlockedIPRangeList
 */
RiskExceptionConfigurationType.prototype['BlockedIPRangeList'] = undefined;

/**
 * @member {Array} SkippedIPRangeList
 */
RiskExceptionConfigurationType.prototype['SkippedIPRangeList'] = undefined;
...
export default RiskExceptionConfigurationType;
