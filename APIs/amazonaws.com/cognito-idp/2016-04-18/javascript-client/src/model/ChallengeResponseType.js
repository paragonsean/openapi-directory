...
/**
 * The ChallengeResponseType model module.
 * @module model/ChallengeResponseType
 * @version 2016-04-18
 */
class ChallengeResponseType {
    /**
     * Constructs a new <code>ChallengeResponseType</code>.
     * The challenge response type.
     * @alias module:model/ChallengeResponseType
     */
    constructor() { 
        
        ChallengeResponseType.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ChallengeResponseType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ChallengeResponseType} obj Optional instance to populate.
     * @return {module:model/ChallengeResponseType} The populated <code>ChallengeResponseType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ChallengeResponseType();

            if (data.hasOwnProperty('ChallengeName')) {
                obj['ChallengeName'] = ApiClient.convertToType(data['ChallengeName'], ChallengeName);
            }
            if (data.hasOwnProperty('ChallengeResponse')) {
                obj['ChallengeResponse'] = ApiClient.convertToType(data['ChallengeResponse'], ChallengeResponse);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ChallengeResponseType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ChallengeResponseType</code>.
     */
    static validateJSON(data) {
        // validate the optional field `ChallengeName`
        if (data['ChallengeName']) { // data not null
          ChallengeName.validateJSON(data['ChallengeName']);
        }
        // validate the optional field `ChallengeResponse`
        if (data['ChallengeResponse']) { // data not null
          ChallengeResponse.validateJSON(data['ChallengeResponse']);
        }
...
/**
 * @member {module:model/ChallengeName} ChallengeName
 */
ChallengeResponseType.prototype['ChallengeName'] = undefined;

/**
 * @member {module:model/ChallengeResponse} ChallengeResponse
 */
ChallengeResponseType.prototype['ChallengeResponse'] = undefined;
...
export default ChallengeResponseType;
