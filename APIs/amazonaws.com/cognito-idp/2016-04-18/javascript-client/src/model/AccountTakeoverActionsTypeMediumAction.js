...
/**
 * The AccountTakeoverActionsTypeMediumAction model module.
 * @module model/AccountTakeoverActionsTypeMediumAction
 * @version 2016-04-18
 */
class AccountTakeoverActionsTypeMediumAction {
    /**
     * Constructs a new <code>AccountTakeoverActionsTypeMediumAction</code>.
     * @alias module:model/AccountTakeoverActionsTypeMediumAction
    ...
    constructor(notify, eventAction) { 
        ...
        AccountTakeoverActionsTypeMediumAction.initialize(this, notify, eventAction);
    }
    ...
    /**
     * Constructs a <code>AccountTakeoverActionsTypeMediumAction</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AccountTakeoverActionsTypeMediumAction} obj Optional instance to populate.
     * @return {module:model/AccountTakeoverActionsTypeMediumAction} The populated <code>AccountTakeoverActionsTypeMediumAction</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AccountTakeoverActionsTypeMediumAction();
    ...
    /**
     * Validates the JSON data with respect to <code>AccountTakeoverActionsTypeMediumAction</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AccountTakeoverActionsTypeMediumAction</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AccountTakeoverActionsTypeMediumAction.RequiredProperties) {
...
AccountTakeoverActionsTypeMediumAction.RequiredProperties = ["Notify", "EventAction"];

/**
 * @member {Boolean} Notify
 */
AccountTakeoverActionsTypeMediumAction.prototype['Notify'] = undefined;

/**
 * @member {module:model/AccountTakeoverEventActionType} EventAction
 */
AccountTakeoverActionsTypeMediumAction.prototype['EventAction'] = undefined;
...
export default AccountTakeoverActionsTypeMediumAction;
