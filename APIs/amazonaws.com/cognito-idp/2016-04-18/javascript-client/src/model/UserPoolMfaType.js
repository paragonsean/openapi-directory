...
* @readonly
*/
export default class UserPoolMfaType {
    ...
    /**
    * Returns a <code>UserPoolMfaType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/UserPoolMfaType} The enum <code>UserPoolMfaType</code> value.
    */
