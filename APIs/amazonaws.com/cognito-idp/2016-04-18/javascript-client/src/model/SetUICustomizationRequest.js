...
/**
 * The SetUICustomizationRequest model module.
 * @module model/SetUICustomizationRequest
 * @version 2016-04-18
 */
class SetUICustomizationRequest {
    /**
     * Constructs a new <code>SetUICustomizationRequest</code>.
     * @alias module:model/SetUICustomizationRequest
     * @param userPoolId {String} 
     */
    constructor(userPoolId) { 
        
        SetUICustomizationRequest.initialize(this, userPoolId);
    }
    ...
    /**
     * Constructs a <code>SetUICustomizationRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SetUICustomizationRequest} obj Optional instance to populate.
     * @return {module:model/SetUICustomizationRequest} The populated <code>SetUICustomizationRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SetUICustomizationRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>SetUICustomizationRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SetUICustomizationRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SetUICustomizationRequest.RequiredProperties) {
        ...
        if (data['ImageFile']) { // data not null
          String.validateJSON(data['ImageFile']);
        }
...
SetUICustomizationRequest.RequiredProperties = ["UserPoolId"];

/**
 * @member {String} UserPoolId
 */
SetUICustomizationRequest.prototype['UserPoolId'] = undefined;

/**
 * @member {String} ClientId
 */
SetUICustomizationRequest.prototype['ClientId'] = undefined;

/**
 * @member {String} CSS
 */
SetUICustomizationRequest.prototype['CSS'] = undefined;

/**
 * @member {String} ImageFile
 */
SetUICustomizationRequest.prototype['ImageFile'] = undefined;
...
export default SetUICustomizationRequest;
