...
/**
 * The AdminInitiateAuthRequestAnalyticsMetadata model module.
 * @module model/AdminInitiateAuthRequestAnalyticsMetadata
 * @version 2016-04-18
 */
class AdminInitiateAuthRequestAnalyticsMetadata {
    /**
     * Constructs a new <code>AdminInitiateAuthRequestAnalyticsMetadata</code>.
     * @alias module:model/AdminInitiateAuthRequestAnalyticsMetadata
     * @implements module:model/AnalyticsMetadataType
     */
    constructor() { 
        AnalyticsMetadataType.initialize(this);
        AdminInitiateAuthRequestAnalyticsMetadata.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AdminInitiateAuthRequestAnalyticsMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdminInitiateAuthRequestAnalyticsMetadata} obj Optional instance to populate.
     * @return {module:model/AdminInitiateAuthRequestAnalyticsMetadata} The populated <code>AdminInitiateAuthRequestAnalyticsMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdminInitiateAuthRequestAnalyticsMetadata();
    ...
    /**
     * Validates the JSON data with respect to <code>AdminInitiateAuthRequestAnalyticsMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdminInitiateAuthRequestAnalyticsMetadata</code>.
     */
 ...
 */
AdminInitiateAuthRequestAnalyticsMetadata.prototype['AnalyticsEndpointId'] = undefined;
...
export default AdminInitiateAuthRequestAnalyticsMetadata;
