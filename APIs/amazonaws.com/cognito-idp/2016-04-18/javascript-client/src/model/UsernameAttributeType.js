...
* @readonly
*/
export default class UsernameAttributeType {
    ...
    /**
    * Returns a <code>UsernameAttributeType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/UsernameAttributeType} The enum <code>UsernameAttributeType</code> value.
    */
