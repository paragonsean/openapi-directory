...
/**
 * The AdminConfirmSignUpRequest model module.
 * @module model/AdminConfirmSignUpRequest
 * @version 2016-04-18
 */
class AdminConfirmSignUpRequest {
    /**
     * Constructs a new <code>AdminConfirmSignUpRequest</code>.
     * Confirm a user&#39;s registration as a user pool administrator.
     * @alias module:model/AdminConfirmSignUpRequest
     * @param userPoolId {String} 
     * @param username {String} 
     */
    constructor(userPoolId, username) { 
        
        AdminConfirmSignUpRequest.initialize(this, userPoolId, username);
    }
    ...
    /**
     * Constructs a <code>AdminConfirmSignUpRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdminConfirmSignUpRequest} obj Optional instance to populate.
     * @return {module:model/AdminConfirmSignUpRequest} The populated <code>AdminConfirmSignUpRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdminConfirmSignUpRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>AdminConfirmSignUpRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdminConfirmSignUpRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AdminConfirmSignUpRequest.RequiredProperties) {
...
AdminConfirmSignUpRequest.RequiredProperties = ["UserPoolId", "Username"];

/**
 * @member {String} UserPoolId
 */
AdminConfirmSignUpRequest.prototype['UserPoolId'] = undefined;

/**
 * @member {String} Username
 */
AdminConfirmSignUpRequest.prototype['Username'] = undefined;

/**
 * @member {Object} ClientMetadata
 */
AdminConfirmSignUpRequest.prototype['ClientMetadata'] = undefined;
...
export default AdminConfirmSignUpRequest;
