...
/**
 * The DescribeUserPoolDomainRequest model module.
 * @module model/DescribeUserPoolDomainRequest
 * @version 2016-04-18
 */
class DescribeUserPoolDomainRequest {
    /**
     * Constructs a new <code>DescribeUserPoolDomainRequest</code>.
     * @alias module:model/DescribeUserPoolDomainRequest
     * @param domain {String} 
     */
    constructor(domain) { 
        
        DescribeUserPoolDomainRequest.initialize(this, domain);
    }
    ...
    /**
     * Constructs a <code>DescribeUserPoolDomainRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeUserPoolDomainRequest} obj Optional instance to populate.
     * @return {module:model/DescribeUserPoolDomainRequest} The populated <code>DescribeUserPoolDomainRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeUserPoolDomainRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeUserPoolDomainRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeUserPoolDomainRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeUserPoolDomainRequest.RequiredProperties) {
...
DescribeUserPoolDomainRequest.RequiredProperties = ["Domain"];

/**
 * @member {String} Domain
 */
DescribeUserPoolDomainRequest.prototype['Domain'] = undefined;
...
export default DescribeUserPoolDomainRequest;
