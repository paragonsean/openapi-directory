...
import GetUserPoolMfaConfigResponseSmsMfaConfiguration from './GetUserPoolMfaConfigResponseSmsMfaConfiguration';
import GetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration from './GetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration';
import UserPoolMfaType from './UserPoolMfaType';

/**
 * The GetUserPoolMfaConfigResponse model module.
 * @module model/GetUserPoolMfaConfigResponse
 * @version 2016-04-18
 */
class GetUserPoolMfaConfigResponse {
    /**
     * Constructs a new <code>GetUserPoolMfaConfigResponse</code>.
     * @alias module:model/GetUserPoolMfaConfigResponse
     */
    constructor() { 
        
        GetUserPoolMfaConfigResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetUserPoolMfaConfigResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetUserPoolMfaConfigResponse} obj Optional instance to populate.
     * @return {module:model/GetUserPoolMfaConfigResponse} The populated <code>GetUserPoolMfaConfigResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetUserPoolMfaConfigResponse();

            if (data.hasOwnProperty('SmsMfaConfiguration')) {
                obj['SmsMfaConfiguration'] = GetUserPoolMfaConfigResponseSmsMfaConfiguration.constructFromObject(data['SmsMfaConfiguration']);
            }
            if (data.hasOwnProperty('SoftwareTokenMfaConfiguration')) {
                obj['SoftwareTokenMfaConfiguration'] = GetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration.constructFromObject(data['SoftwareTokenMfaConfiguration']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GetUserPoolMfaConfigResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetUserPoolMfaConfigResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `SmsMfaConfiguration`
        if (data['SmsMfaConfiguration']) { // data not null
          GetUserPoolMfaConfigResponseSmsMfaConfiguration.validateJSON(data['SmsMfaConfiguration']);
        }
        // validate the optional field `SoftwareTokenMfaConfiguration`
        if (data['SoftwareTokenMfaConfiguration']) { // data not null
          GetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration.validateJSON(data['SoftwareTokenMfaConfiguration']);
        }
...
/**
 * @member {module:model/GetUserPoolMfaConfigResponseSmsMfaConfiguration} SmsMfaConfiguration
 */
GetUserPoolMfaConfigResponse.prototype['SmsMfaConfiguration'] = undefined;

/**
 * @member {module:model/GetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration} SoftwareTokenMfaConfiguration
 */
GetUserPoolMfaConfigResponse.prototype['SoftwareTokenMfaConfiguration'] = undefined;

/**
 * @member {module:model/UserPoolMfaType} MfaConfiguration
 */
GetUserPoolMfaConfigResponse.prototype['MfaConfiguration'] = undefined;
...
export default GetUserPoolMfaConfigResponse;
