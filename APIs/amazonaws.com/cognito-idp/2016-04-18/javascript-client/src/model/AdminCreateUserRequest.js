...
/**
 * The AdminCreateUserRequest model module.
 * @module model/AdminCreateUserRequest
 * @version 2016-04-18
 */
class AdminCreateUserRequest {
    /**
     * Constructs a new <code>AdminCreateUserRequest</code>.
     * Represents the request to create a user in the specified user pool.
     * @alias module:model/AdminCreateUserRequest
     * @param userPoolId {String} 
     * @param username {String} 
     */
    constructor(userPoolId, username) { 
        
        AdminCreateUserRequest.initialize(this, userPoolId, username);
    }
     ...
     */
    static initialize(obj, userPoolId, username) { 
        obj['UserPoolId'] = userPoolId;
        obj['Username'] = username;
    }

    /**
     * Constructs a <code>AdminCreateUserRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdminCreateUserRequest} obj Optional instance to populate.
     * @return {module:model/AdminCreateUserRequest} The populated <code>AdminCreateUserRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdminCreateUserRequest();
            ...
            if (data.hasOwnProperty('ValidationData')) {
                obj['ValidationData'] = ApiClient.convertToType(data['ValidationData'], Array);
            }
            if (data.hasOwnProperty('TemporaryPassword')) {
                obj['TemporaryPassword'] = ApiClient.convertToType(data['TemporaryPassword'], 'String');
            }
            if (data.hasOwnProperty('ForceAliasCreation')) {
                obj['ForceAliasCreation'] = ApiClient.convertToType(data['ForceAliasCreation'], 'Boolean');
            }
            if (data.hasOwnProperty('MessageAction')) {
                obj['MessageAction'] = ApiClient.convertToType(data['MessageAction'], MessageActionType);
            }
            if (data.hasOwnProperty('DesiredDeliveryMediums')) {
                obj['DesiredDeliveryMediums'] = ApiClient.convertToType(data['DesiredDeliveryMediums'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>AdminCreateUserRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdminCreateUserRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AdminCreateUserRequest.RequiredProperties) {
        ...
        // validate the optional field `ValidationData`
        if (data['ValidationData']) { // data not null
          Array.validateJSON(data['ValidationData']);
        }
        ...
        // validate the optional field `ForceAliasCreation`
        if (data['ForceAliasCreation']) { // data not null
          Boolean.validateJSON(data['ForceAliasCreation']);
        }
        // validate the optional field `MessageAction`
        if (data['MessageAction']) { // data not null
          MessageActionType.validateJSON(data['MessageAction']);
        }
        // validate the optional field `DesiredDeliveryMediums`
        if (data['DesiredDeliveryMediums']) { // data not null
          Array.validateJSON(data['DesiredDeliveryMediums']);
        }
...
AdminCreateUserRequest.RequiredProperties = ["UserPoolId", "Username"];

/**
 * @member {String} UserPoolId
 */
AdminCreateUserRequest.prototype['UserPoolId'] = undefined;

/**
 * @member {String} Username
 */
AdminCreateUserRequest.prototype['Username'] = undefined;

/**
 * @member {Array} UserAttributes
 */
AdminCreateUserRequest.prototype['UserAttributes'] = undefined;

/**
 * @member {Array} ValidationData
 */
AdminCreateUserRequest.prototype['ValidationData'] = undefined;

/**
 * @member {String} TemporaryPassword
 */
AdminCreateUserRequest.prototype['TemporaryPassword'] = undefined;

/**
 * @member {Boolean} ForceAliasCreation
 */
AdminCreateUserRequest.prototype['ForceAliasCreation'] = undefined;

/**
 * @member {module:model/MessageActionType} MessageAction
 */
AdminCreateUserRequest.prototype['MessageAction'] = undefined;

/**
 * @member {Array} DesiredDeliveryMediums
 */
AdminCreateUserRequest.prototype['DesiredDeliveryMediums'] = undefined;

/**
 * @member {Object} ClientMetadata
 */
AdminCreateUserRequest.prototype['ClientMetadata'] = undefined;
...
export default AdminCreateUserRequest;
