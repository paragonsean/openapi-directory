...
class ListIdentityProvidersRequest {
    ...
    constructor(userPoolId) { 
        ...
        ListIdentityProvidersRequest.initialize(this, userPoolId);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of ListIdentityProvidersRequest.RequiredProperties) {
...
ListIdentityProvidersRequest.RequiredProperties = ["UserPoolId"];

/**
 * @member {String} UserPoolId
 */
ListIdentityProvidersRequest.prototype['UserPoolId'] = undefined;
