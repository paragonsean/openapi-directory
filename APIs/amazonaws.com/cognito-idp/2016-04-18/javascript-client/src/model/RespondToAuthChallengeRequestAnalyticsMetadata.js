...
/**
 * The RespondToAuthChallengeRequestAnalyticsMetadata model module.
 * @module model/RespondToAuthChallengeRequestAnalyticsMetadata
 * @version 2016-04-18
 */
class RespondToAuthChallengeRequestAnalyticsMetadata {
    /**
     * Constructs a new <code>RespondToAuthChallengeRequestAnalyticsMetadata</code>.
     * @alias module:model/RespondToAuthChallengeRequestAnalyticsMetadata
     * @implements module:model/AnalyticsMetadataType
     */
    constructor() { 
        AnalyticsMetadataType.initialize(this);
        RespondToAuthChallengeRequestAnalyticsMetadata.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RespondToAuthChallengeRequestAnalyticsMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RespondToAuthChallengeRequestAnalyticsMetadata} obj Optional instance to populate.
     * @return {module:model/RespondToAuthChallengeRequestAnalyticsMetadata} The populated <code>RespondToAuthChallengeRequestAnalyticsMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RespondToAuthChallengeRequestAnalyticsMetadata();
            AnalyticsMetadataType.constructFromObject(data, obj);

            if (data.hasOwnProperty('AnalyticsEndpointId')) {
                obj['AnalyticsEndpointId'] = ApiClient.convertToType(data['AnalyticsEndpointId'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>RespondToAuthChallengeRequestAnalyticsMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RespondToAuthChallengeRequestAnalyticsMetadata</code>.
     */
    static validateJSON(data) {
        // validate the optional field `AnalyticsEndpointId`
        if (data['AnalyticsEndpointId']) { // data not null
          String.validateJSON(data['AnalyticsEndpointId']);
        }
...
/**
 * @member {String} AnalyticsEndpointId
 */
RespondToAuthChallengeRequestAnalyticsMetadata.prototype['AnalyticsEndpointId'] = undefined;


// Implement AnalyticsMetadataType interface:
/**
 * @member {String} AnalyticsEndpointId
 */
AnalyticsMetadataType.prototype['AnalyticsEndpointId'] = undefined;




export default RespondToAuthChallengeRequestAnalyticsMetadata;
