...
import LogDeliveryConfigurationType from './LogDeliveryConfigurationType';

/**
 * The SetLogDeliveryConfigurationResponseLogDeliveryConfiguration model module.
 * @module model/SetLogDeliveryConfigurationResponseLogDeliveryConfiguration
 * @version 2016-04-18
 */
class SetLogDeliveryConfigurationResponseLogDeliveryConfiguration {
    /**
     * Constructs a new <code>SetLogDeliveryConfigurationResponseLogDeliveryConfiguration</code>.
     * @alias module:model/SetLogDeliveryConfigurationResponseLogDeliveryConfiguration
     * @implements module:model/LogDeliveryConfigurationType
     * @param userPoolId {String} 
     * @param logConfigurations {Array} 
     */
    constructor(userPoolId, logConfigurations) { 
        LogDeliveryConfigurationType.initialize(this, userPoolId, logConfigurations);
        SetLogDeliveryConfigurationResponseLogDeliveryConfiguration.initialize(this, userPoolId, logConfigurations);
    }
    ...
    /**
     * Constructs a <code>SetLogDeliveryConfigurationResponseLogDeliveryConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SetLogDeliveryConfigurationResponseLogDeliveryConfiguration} obj Optional instance to populate.
     * @return {module:model/SetLogDeliveryConfigurationResponseLogDeliveryConfiguration} The populated <code>SetLogDeliveryConfigurationResponseLogDeliveryConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SetLogDeliveryConfigurationResponseLogDeliveryConfiguration();
            LogDeliveryConfigurationType.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>SetLogDeliveryConfigurationResponseLogDeliveryConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SetLogDeliveryConfigurationResponseLogDeliveryConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SetLogDeliveryConfigurationResponseLogDeliveryConfiguration.RequiredProperties) {
...
SetLogDeliveryConfigurationResponseLogDeliveryConfiguration.RequiredProperties = ["UserPoolId", "LogConfigurations"];

/**
 * @member {String} UserPoolId
 */
SetLogDeliveryConfigurationResponseLogDeliveryConfiguration.prototype['UserPoolId'] = undefined;

/**
 * @member {Array} LogConfigurations
 */
SetLogDeliveryConfigurationResponseLogDeliveryConfiguration.prototype['LogConfigurations'] = undefined;


// Implement LogDeliveryConfigurationType interface:
/**
 * @member {String} UserPoolId
 */
LogDeliveryConfigurationType.prototype['UserPoolId'] = undefined;
/**
 * @member {Array} LogConfigurations
 */
LogDeliveryConfigurationType.prototype['LogConfigurations'] = undefined;




export default SetLogDeliveryConfigurationResponseLogDeliveryConfiguration;
