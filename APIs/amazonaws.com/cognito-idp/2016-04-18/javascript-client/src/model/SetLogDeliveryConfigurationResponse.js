...
import SetLogDeliveryConfigurationResponseLogDeliveryConfiguration from './SetLogDeliveryConfigurationResponseLogDeliveryConfiguration';

/**
 * The SetLogDeliveryConfigurationResponse model module.
 * @module model/SetLogDeliveryConfigurationResponse
 * @version 2016-04-18
 */
class SetLogDeliveryConfigurationResponse {
    /**
     * Constructs a new <code>SetLogDeliveryConfigurationResponse</code>.
     * @alias module:model/SetLogDeliveryConfigurationResponse
     */
    constructor() { 
        
        SetLogDeliveryConfigurationResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SetLogDeliveryConfigurationResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SetLogDeliveryConfigurationResponse} obj Optional instance to populate.
     * @return {module:model/SetLogDeliveryConfigurationResponse} The populated <code>SetLogDeliveryConfigurationResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SetLogDeliveryConfigurationResponse();

            if (data.hasOwnProperty('LogDeliveryConfiguration')) {
                obj['LogDeliveryConfiguration'] = SetLogDeliveryConfigurationResponseLogDeliveryConfiguration.constructFromObject(data['LogDeliveryConfiguration']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>SetLogDeliveryConfigurationResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SetLogDeliveryConfigurationResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `LogDeliveryConfiguration`
        if (data['LogDeliveryConfiguration']) { // data not null
          SetLogDeliveryConfigurationResponseLogDeliveryConfiguration.validateJSON(data['LogDeliveryConfiguration']);
        }
...
/**
 * @member {module:model/SetLogDeliveryConfigurationResponseLogDeliveryConfiguration} LogDeliveryConfiguration
 */
SetLogDeliveryConfigurationResponse.prototype['LogDeliveryConfiguration'] = undefined;
...
export default SetLogDeliveryConfigurationResponse;
