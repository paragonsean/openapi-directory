...
import AdminCreateUserResponseUser from './AdminCreateUserResponseUser';

/**
 * The AdminCreateUserResponse model module.
 * @module model/AdminCreateUserResponse
 * @version 2016-04-18
 */
class AdminCreateUserResponse {
    /**
     * Constructs a new <code>AdminCreateUserResponse</code>.
     * Represents the response from the server to the request to create the user.
     * @alias module:model/AdminCreateUserResponse
     */
    constructor() { 
        
        AdminCreateUserResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AdminCreateUserResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdminCreateUserResponse} obj Optional instance to populate.
     * @return {module:model/AdminCreateUserResponse} The populated <code>AdminCreateUserResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdminCreateUserResponse();

            if (data.hasOwnProperty('User')) {
                obj['User'] = AdminCreateUserResponseUser.constructFromObject(data['User']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AdminCreateUserResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdminCreateUserResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `User`
        if (data['User']) { // data not null
          AdminCreateUserResponseUser.validateJSON(data['User']);
        }
...
/**
 * @member {module:model/AdminCreateUserResponseUser} User
 */
AdminCreateUserResponse.prototype['User'] = undefined;
