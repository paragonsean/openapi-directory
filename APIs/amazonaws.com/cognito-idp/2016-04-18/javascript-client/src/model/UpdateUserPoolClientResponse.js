...
import UpdateUserPoolClientResponseUserPoolClient from './UpdateUserPoolClientResponseUserPoolClient';

/**
 * The UpdateUserPoolClientResponse model module.
 * @module model/UpdateUserPoolClientResponse
 * @version 2016-04-18
 */
class UpdateUserPoolClientResponse {
    /**
     * Constructs a new <code>UpdateUserPoolClientResponse</code>.
     * Represents the response from the server to the request to update the user pool client.
     * @alias module:model/UpdateUserPoolClientResponse
     */
    constructor() { 
        
        UpdateUserPoolClientResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateUserPoolClientResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateUserPoolClientResponse} obj Optional instance to populate.
     * @return {module:model/UpdateUserPoolClientResponse} The populated <code>UpdateUserPoolClientResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateUserPoolClientResponse();

            if (data.hasOwnProperty('UserPoolClient')) {
                obj['UserPoolClient'] = UpdateUserPoolClientResponseUserPoolClient.constructFromObject(data['UserPoolClient']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateUserPoolClientResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateUserPoolClientResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `UserPoolClient`
        if (data['UserPoolClient']) { // data not null
          UpdateUserPoolClientResponseUserPoolClient.validateJSON(data['UserPoolClient']);
        }
...
/**
 * @member {module:model/UpdateUserPoolClientResponseUserPoolClient} UserPoolClient
 */
UpdateUserPoolClientResponse.prototype['UserPoolClient'] = undefined;
...
export default UpdateUserPoolClientResponse;
