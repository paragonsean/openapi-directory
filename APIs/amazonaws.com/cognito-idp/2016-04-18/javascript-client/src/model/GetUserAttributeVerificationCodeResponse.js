...
import GetUserAttributeVerificationCodeResponseCodeDeliveryDetails from './GetUserAttributeVerificationCodeResponseCodeDeliveryDetails';

/**
 * The GetUserAttributeVerificationCodeResponse model module.
 * @module model/GetUserAttributeVerificationCodeResponse
 * @version 2016-04-18
 */
class GetUserAttributeVerificationCodeResponse {
    /**
     * Constructs a new <code>GetUserAttributeVerificationCodeResponse</code>.
     * The verification code response returned by the server response to get the user attribute verification code.
     * @alias module:model/GetUserAttributeVerificationCodeResponse
     */
    constructor() { 
        
        GetUserAttributeVerificationCodeResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetUserAttributeVerificationCodeResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetUserAttributeVerificationCodeResponse} obj Optional instance to populate.
     * @return {module:model/GetUserAttributeVerificationCodeResponse} The populated <code>GetUserAttributeVerificationCodeResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetUserAttributeVerificationCodeResponse();

            if (data.hasOwnProperty('CodeDeliveryDetails')) {
                obj['CodeDeliveryDetails'] = GetUserAttributeVerificationCodeResponseCodeDeliveryDetails.constructFromObject(data['CodeDeliveryDetails']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetUserAttributeVerificationCodeResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetUserAttributeVerificationCodeResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `CodeDeliveryDetails`
        if (data['CodeDeliveryDetails']) { // data not null
          GetUserAttributeVerificationCodeResponseCodeDeliveryDetails.validateJSON(data['CodeDeliveryDetails']);
        }
...
/**
 * @member {module:model/GetUserAttributeVerificationCodeResponseCodeDeliveryDetails} CodeDeliveryDetails
 */
GetUserAttributeVerificationCodeResponse.prototype['CodeDeliveryDetails'] = undefined;
...
export default GetUserAttributeVerificationCodeResponse;
