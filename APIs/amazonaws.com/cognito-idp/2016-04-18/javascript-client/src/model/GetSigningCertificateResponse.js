...
/**
 * The GetSigningCertificateResponse model module.
 * @module model/GetSigningCertificateResponse
 * @version 2016-04-18
 */
class GetSigningCertificateResponse {
    /**
     * Constructs a new <code>GetSigningCertificateResponse</code>.
     * Response from Amazon Cognito for a signing certificate request.
     * @alias module:model/GetSigningCertificateResponse
     */
    constructor() { 
        
        GetSigningCertificateResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetSigningCertificateResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetSigningCertificateResponse} obj Optional instance to populate.
     * @return {module:model/GetSigningCertificateResponse} The populated <code>GetSigningCertificateResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetSigningCertificateResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>GetSigningCertificateResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetSigningCertificateResponse</code>.
     */
 ...
 */
GetSigningCertificateResponse.prototype['Certificate'] = undefined;
...
export default GetSigningCertificateResponse;
