...
/**
 * The UpdateUserPoolDomainRequestCustomDomainConfig model module.
 * @module model/UpdateUserPoolDomainRequestCustomDomainConfig
 * @version 2016-04-18
 */
class UpdateUserPoolDomainRequestCustomDomainConfig {
    /**
     * Constructs a new <code>UpdateUserPoolDomainRequestCustomDomainConfig</code>.
     * @alias module:model/UpdateUserPoolDomainRequestCustomDomainConfig
    ...
    constructor(certificateArn) { 
        ...
        UpdateUserPoolDomainRequestCustomDomainConfig.initialize(this, certificateArn);
    }
    ...
    /**
     * Constructs a <code>UpdateUserPoolDomainRequestCustomDomainConfig</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateUserPoolDomainRequestCustomDomainConfig} obj Optional instance to populate.
     * @return {module:model/UpdateUserPoolDomainRequestCustomDomainConfig} The populated <code>UpdateUserPoolDomainRequestCustomDomainConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateUserPoolDomainRequestCustomDomainConfig();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateUserPoolDomainRequestCustomDomainConfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateUserPoolDomainRequestCustomDomainConfig</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateUserPoolDomainRequestCustomDomainConfig.RequiredProperties) {
...
UpdateUserPoolDomainRequestCustomDomainConfig.RequiredProperties = ["CertificateArn"];

/**
 * @member {String} CertificateArn
 */
UpdateUserPoolDomainRequestCustomDomainConfig.prototype['CertificateArn'] = undefined;
...
export default UpdateUserPoolDomainRequestCustomDomainConfig;
