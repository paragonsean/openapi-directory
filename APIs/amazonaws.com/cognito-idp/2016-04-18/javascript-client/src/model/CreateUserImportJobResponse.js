...
/**
 * The CreateUserImportJobResponse model module.
 * @module model/CreateUserImportJobResponse
 * @version 2016-04-18
 */
class CreateUserImportJobResponse {
    /**
     * Constructs a new <code>CreateUserImportJobResponse</code>.
     * Represents the response from the server to the request to create the user import job.
     * @alias module:model/CreateUserImportJobResponse
     */
    constructor() { 
        
        CreateUserImportJobResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateUserImportJobResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateUserImportJobResponse} obj Optional instance to populate.
     * @return {module:model/CreateUserImportJobResponse} The populated <code>CreateUserImportJobResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateUserImportJobResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateUserImportJobResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateUserImportJobResponse</code>.
     */
 ...
 */
CreateUserImportJobResponse.prototype['UserImportJob'] = undefined;
...
export default CreateUserImportJobResponse;
