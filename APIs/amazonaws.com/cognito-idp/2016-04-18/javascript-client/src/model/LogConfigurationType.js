...
import LogConfigurationTypeCloudWatchLogsConfiguration from './LogConfigurationTypeCloudWatchLogsConfiguration';
import LogLevel from './LogLevel';

/**
 * The LogConfigurationType model module.
 * @module model/LogConfigurationType
 * @version 2016-04-18
 */
class LogConfigurationType {
    /**
     * Constructs a new <code>LogConfigurationType</code>.
     * The logging parameters of a user pool.
     * @alias module:model/LogConfigurationType
     * @param logLevel {module:model/LogLevel} 
     * @param eventSource {module:model/EventSourceName} 
     */
    constructor(logLevel, eventSource) { 
        
        LogConfigurationType.initialize(this, logLevel, eventSource);
    }
     ...
     */
    static initialize(obj, logLevel, eventSource) { 
        obj['LogLevel'] = logLevel;
        obj['EventSource'] = eventSource;
    }

    /**
     * Constructs a <code>LogConfigurationType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LogConfigurationType} obj Optional instance to populate.
     * @return {module:model/LogConfigurationType} The populated <code>LogConfigurationType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LogConfigurationType();
            ...
            if (data.hasOwnProperty('EventSource')) {
                obj['EventSource'] = ApiClient.convertToType(data['EventSource'], EventSourceName);
            }
            if (data.hasOwnProperty('CloudWatchLogsConfiguration')) {
                obj['CloudWatchLogsConfiguration'] = LogConfigurationTypeCloudWatchLogsConfiguration.constructFromObject(data['CloudWatchLogsConfiguration']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>LogConfigurationType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LogConfigurationType</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of LogConfigurationType.RequiredProperties) {
        ...
        if (data['EventSource']) { // data not null
          EventSourceName.validateJSON(data['EventSource']);
        }
        // validate the optional field `CloudWatchLogsConfiguration`
        if (data['CloudWatchLogsConfiguration']) { // data not null
          LogConfigurationTypeCloudWatchLogsConfiguration.validateJSON(data['CloudWatchLogsConfiguration']);
        }
...
LogConfigurationType.RequiredProperties = ["LogLevel", "EventSource"];

/**
 * @member {module:model/LogLevel} LogLevel
 */
LogConfigurationType.prototype['LogLevel'] = undefined;

/**
 * @member {module:model/EventSourceName} EventSource
 */
LogConfigurationType.prototype['EventSource'] = undefined;

/**
 * @member {module:model/LogConfigurationTypeCloudWatchLogsConfiguration} CloudWatchLogsConfiguration
 */
LogConfigurationType.prototype['CloudWatchLogsConfiguration'] = undefined;
...
export default LogConfigurationType;
