...
/**
 * The DeleteResourceServerRequest model module.
 * @module model/DeleteResourceServerRequest
 * @version 2016-04-18
 */
class DeleteResourceServerRequest {
    /**
     * Constructs a new <code>DeleteResourceServerRequest</code>.
     * @alias module:model/DeleteResourceServerRequest
     * @param userPoolId {String} 
     * @param identifier {String} 
     */
    constructor(userPoolId, identifier) { 
        
        DeleteResourceServerRequest.initialize(this, userPoolId, identifier);
    }
     ...
     */
    static initialize(obj, userPoolId, identifier) { 
        obj['UserPoolId'] = userPoolId;
        obj['Identifier'] = identifier;
    }

    /**
     * Constructs a <code>DeleteResourceServerRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteResourceServerRequest} obj Optional instance to populate.
     * @return {module:model/DeleteResourceServerRequest} The populated <code>DeleteResourceServerRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteResourceServerRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteResourceServerRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteResourceServerRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteResourceServerRequest.RequiredProperties) {
...
DeleteResourceServerRequest.RequiredProperties = ["UserPoolId", "Identifier"];

/**
 * @member {String} UserPoolId
 */
DeleteResourceServerRequest.prototype['UserPoolId'] = undefined;

/**
 * @member {String} Identifier
 */
DeleteResourceServerRequest.prototype['Identifier'] = undefined;
...
export default DeleteResourceServerRequest;
