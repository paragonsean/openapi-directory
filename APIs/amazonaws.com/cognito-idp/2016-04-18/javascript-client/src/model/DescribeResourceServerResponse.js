...
import DescribeResourceServerResponseResourceServer from './DescribeResourceServerResponseResourceServer';

/**
 * The DescribeResourceServerResponse model module.
 * @module model/DescribeResourceServerResponse
 * @version 2016-04-18
 */
class DescribeResourceServerResponse {
    /**
     * Constructs a new <code>DescribeResourceServerResponse</code>.
     * @alias module:model/DescribeResourceServerResponse
     * @param resourceServer {module:model/DescribeResourceServerResponseResourceServer} 
     */
    constructor(resourceServer) { 
        
        DescribeResourceServerResponse.initialize(this, resourceServer);
    }
     ...
     */
    static initialize(obj, resourceServer) { 
        obj['ResourceServer'] = resourceServer;
    }

    /**
     * Constructs a <code>DescribeResourceServerResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeResourceServerResponse} obj Optional instance to populate.
     * @return {module:model/DescribeResourceServerResponse} The populated <code>DescribeResourceServerResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeResourceServerResponse();

            if (data.hasOwnProperty('ResourceServer')) {
                obj['ResourceServer'] = DescribeResourceServerResponseResourceServer.constructFromObject(data['ResourceServer']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeResourceServerResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeResourceServerResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeResourceServerResponse.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `ResourceServer`
        if (data['ResourceServer']) { // data not null
          DescribeResourceServerResponseResourceServer.validateJSON(data['ResourceServer']);
        }
...
DescribeResourceServerResponse.RequiredProperties = ["ResourceServer"];

/**
 * @member {module:model/DescribeResourceServerResponseResourceServer} ResourceServer
 */
DescribeResourceServerResponse.prototype['ResourceServer'] = undefined;
...
export default DescribeResourceServerResponse;
