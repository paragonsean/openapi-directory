...
/**
 * The StopUserImportJobRequest model module.
 * @module model/StopUserImportJobRequest
 * @version 2016-04-18
 */
class StopUserImportJobRequest {
    /**
     * Constructs a new <code>StopUserImportJobRequest</code>.
     * Represents the request to stop the user import job.
     * @alias module:model/StopUserImportJobRequest
     * @param userPoolId {String} 
     * @param jobId {String} 
     */
    constructor(userPoolId, jobId) { 
        
        StopUserImportJobRequest.initialize(this, userPoolId, jobId);
    }
    ...
    /**
     * Constructs a <code>StopUserImportJobRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StopUserImportJobRequest} obj Optional instance to populate.
     * @return {module:model/StopUserImportJobRequest} The populated <code>StopUserImportJobRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StopUserImportJobRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>StopUserImportJobRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StopUserImportJobRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StopUserImportJobRequest.RequiredProperties) {
...
StopUserImportJobRequest.RequiredProperties = ["UserPoolId", "JobId"];

/**
 * @member {String} UserPoolId
 */
StopUserImportJobRequest.prototype['UserPoolId'] = undefined;

/**
 * @member {String} JobId
 */
StopUserImportJobRequest.prototype['JobId'] = undefined;
...
export default StopUserImportJobRequest;
