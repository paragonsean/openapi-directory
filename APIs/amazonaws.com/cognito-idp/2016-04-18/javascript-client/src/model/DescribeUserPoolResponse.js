...
import DescribeUserPoolResponseUserPool from './DescribeUserPoolResponseUserPool';

/**
 * The DescribeUserPoolResponse model module.
 * @module model/DescribeUserPoolResponse
 * @version 2016-04-18
 */
class DescribeUserPoolResponse {
    /**
     * Constructs a new <code>DescribeUserPoolResponse</code>.
     * Represents the response to describe the user pool.
     * @alias module:model/DescribeUserPoolResponse
     */
    constructor() { 
        
        DescribeUserPoolResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeUserPoolResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeUserPoolResponse} obj Optional instance to populate.
     * @return {module:model/DescribeUserPoolResponse} The populated <code>DescribeUserPoolResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeUserPoolResponse();

            if (data.hasOwnProperty('UserPool')) {
                obj['UserPool'] = DescribeUserPoolResponseUserPool.constructFromObject(data['UserPool']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeUserPoolResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeUserPoolResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `UserPool`
        if (data['UserPool']) { // data not null
          DescribeUserPoolResponseUserPool.validateJSON(data['UserPool']);
        }
...
/**
 * @member {module:model/DescribeUserPoolResponseUserPool} UserPool
 */
DescribeUserPoolResponse.prototype['UserPool'] = undefined;
...
export default DescribeUserPoolResponse;
