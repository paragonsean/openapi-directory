...
import DefaultEmailOptionType from './DefaultEmailOptionType';
import VerificationMessageTemplateType from './VerificationMessageTemplateType';

/**
 * The CreateUserPoolRequestVerificationMessageTemplate model module.
 * @module model/CreateUserPoolRequestVerificationMessageTemplate
 * @version 2016-04-18
 */
class CreateUserPoolRequestVerificationMessageTemplate {
    /**
     * Constructs a new <code>CreateUserPoolRequestVerificationMessageTemplate</code>.
     * @alias module:model/CreateUserPoolRequestVerificationMessageTemplate
     * @implements module:model/VerificationMessageTemplateType
     */
    constructor() { 
        VerificationMessageTemplateType.initialize(this);
        CreateUserPoolRequestVerificationMessageTemplate.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateUserPoolRequestVerificationMessageTemplate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateUserPoolRequestVerificationMessageTemplate} obj Optional instance to populate.
     * @return {module:model/CreateUserPoolRequestVerificationMessageTemplate} The populated <code>CreateUserPoolRequestVerificationMessageTemplate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateUserPoolRequestVerificationMessageTemplate();
            VerificationMessageTemplateType.constructFromObject(data, obj);
            ...
            if (data.hasOwnProperty('EmailMessageByLink')) {
                obj['EmailMessageByLink'] = ApiClient.convertToType(data['EmailMessageByLink'], 'String');
            }
            if (data.hasOwnProperty('EmailSubjectByLink')) {
                obj['EmailSubjectByLink'] = ApiClient.convertToType(data['EmailSubjectByLink'], 'String');
            }
            if (data.hasOwnProperty('DefaultEmailOption')) {
                obj['DefaultEmailOption'] = ApiClient.convertToType(data['DefaultEmailOption'], DefaultEmailOptionType);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateUserPoolRequestVerificationMessageTemplate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateUserPoolRequestVerificationMessageTemplate</code>.
     */
    static validateJSON(data) {
        ...
        if (data['EmailMessageByLink']) { // data not null
          String.validateJSON(data['EmailMessageByLink']);
        }
        // validate the optional field `EmailSubjectByLink`
        if (data['EmailSubjectByLink']) { // data not null
          String.validateJSON(data['EmailSubjectByLink']);
        }
        // validate the optional field `DefaultEmailOption`
        if (data['DefaultEmailOption']) { // data not null
          DefaultEmailOptionType.validateJSON(data['DefaultEmailOption']);
        }
 ...
 */
CreateUserPoolRequestVerificationMessageTemplate.prototype['SmsMessage'] = undefined;

/**
 * @member {String} EmailMessage
 */
CreateUserPoolRequestVerificationMessageTemplate.prototype['EmailMessage'] = undefined;

/**
 * @member {String} EmailSubject
 */
CreateUserPoolRequestVerificationMessageTemplate.prototype['EmailSubject'] = undefined;

/**
 * @member {String} EmailMessageByLink
 */
CreateUserPoolRequestVerificationMessageTemplate.prototype['EmailMessageByLink'] = undefined;

/**
 * @member {String} EmailSubjectByLink
 */
CreateUserPoolRequestVerificationMessageTemplate.prototype['EmailSubjectByLink'] = undefined;

/**
 * @member {module:model/DefaultEmailOptionType} DefaultEmailOption
 */
CreateUserPoolRequestVerificationMessageTemplate.prototype['DefaultEmailOption'] = undefined;


// Implement VerificationMessageTemplateType interface:
/**
 * @member {String} SmsMessage
 */
VerificationMessageTemplateType.prototype['SmsMessage'] = undefined;
/**
 * @member {String} EmailMessage
 */
VerificationMessageTemplateType.prototype['EmailMessage'] = undefined;
/**
 * @member {String} EmailSubject
 */
VerificationMessageTemplateType.prototype['EmailSubject'] = undefined;
/**
 * @member {String} EmailMessageByLink
 */
VerificationMessageTemplateType.prototype['EmailMessageByLink'] = undefined;
/**
 * @member {String} EmailSubjectByLink
 */
VerificationMessageTemplateType.prototype['EmailSubjectByLink'] = undefined;
/**
 * @member {module:model/DefaultEmailOptionType} DefaultEmailOption
 */
VerificationMessageTemplateType.prototype['DefaultEmailOption'] = undefined;




export default CreateUserPoolRequestVerificationMessageTemplate;
