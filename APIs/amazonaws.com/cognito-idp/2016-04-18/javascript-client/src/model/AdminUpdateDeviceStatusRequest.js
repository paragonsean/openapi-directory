...
import DeviceRememberedStatusType from './DeviceRememberedStatusType';

/**
 * The AdminUpdateDeviceStatusRequest model module.
 * @module model/AdminUpdateDeviceStatusRequest
 * @version 2016-04-18
 */
class AdminUpdateDeviceStatusRequest {
    /**
     * Constructs a new <code>AdminUpdateDeviceStatusRequest</code>.
     * The request to update the device status, as an administrator.
     * @alias module:model/AdminUpdateDeviceStatusRequest
    ...
    constructor(userPoolId, username, deviceKey) { 
        ...
        AdminUpdateDeviceStatusRequest.initialize(this, userPoolId, username, deviceKey);
    }
    ...
    /**
     * Constructs a <code>AdminUpdateDeviceStatusRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdminUpdateDeviceStatusRequest} obj Optional instance to populate.
     * @return {module:model/AdminUpdateDeviceStatusRequest} The populated <code>AdminUpdateDeviceStatusRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdminUpdateDeviceStatusRequest();
            ...
            if (data.hasOwnProperty('DeviceRememberedStatus')) {
                obj['DeviceRememberedStatus'] = ApiClient.convertToType(data['DeviceRememberedStatus'], DeviceRememberedStatusType);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AdminUpdateDeviceStatusRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdminUpdateDeviceStatusRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AdminUpdateDeviceStatusRequest.RequiredProperties) {
        ...
        if (data['DeviceRememberedStatus']) { // data not null
          DeviceRememberedStatusType.validateJSON(data['DeviceRememberedStatus']);
        }
...
AdminUpdateDeviceStatusRequest.RequiredProperties = ["UserPoolId", "Username", "DeviceKey"];

/**
 * @member {String} UserPoolId
 */
AdminUpdateDeviceStatusRequest.prototype['UserPoolId'] = undefined;

/**
 * @member {String} Username
 */
AdminUpdateDeviceStatusRequest.prototype['Username'] = undefined;

/**
 * @member {String} DeviceKey
 */
AdminUpdateDeviceStatusRequest.prototype['DeviceKey'] = undefined;

/**
 * @member {module:model/DeviceRememberedStatusType} DeviceRememberedStatus
 */
AdminUpdateDeviceStatusRequest.prototype['DeviceRememberedStatus'] = undefined;
...
export default AdminUpdateDeviceStatusRequest;
