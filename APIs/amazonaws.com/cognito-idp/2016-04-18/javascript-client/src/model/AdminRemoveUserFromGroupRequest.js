...
/**
 * The AdminRemoveUserFromGroupRequest model module.
 * @module model/AdminRemoveUserFromGroupRequest
 * @version 2016-04-18
 */
class AdminRemoveUserFromGroupRequest {
    /**
     * Constructs a new <code>AdminRemoveUserFromGroupRequest</code>.
     * @alias module:model/AdminRemoveUserFromGroupRequest
    ...
    constructor(userPoolId, username, groupName) { 
        ...
        AdminRemoveUserFromGroupRequest.initialize(this, userPoolId, username, groupName);
    }
    ...
    /**
     * Constructs a <code>AdminRemoveUserFromGroupRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdminRemoveUserFromGroupRequest} obj Optional instance to populate.
     * @return {module:model/AdminRemoveUserFromGroupRequest} The populated <code>AdminRemoveUserFromGroupRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdminRemoveUserFromGroupRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>AdminRemoveUserFromGroupRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdminRemoveUserFromGroupRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AdminRemoveUserFromGroupRequest.RequiredProperties) {
...
AdminRemoveUserFromGroupRequest.RequiredProperties = ["UserPoolId", "Username", "GroupName"];

/**
 * @member {String} UserPoolId
 */
AdminRemoveUserFromGroupRequest.prototype['UserPoolId'] = undefined;

/**
 * @member {String} Username
 */
AdminRemoveUserFromGroupRequest.prototype['Username'] = undefined;

/**
 * @member {String} GroupName
 */
AdminRemoveUserFromGroupRequest.prototype['GroupName'] = undefined;
...
export default AdminRemoveUserFromGroupRequest;
