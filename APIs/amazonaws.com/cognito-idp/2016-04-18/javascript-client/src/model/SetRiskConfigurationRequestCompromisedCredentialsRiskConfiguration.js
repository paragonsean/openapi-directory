...
import CompromisedCredentialsRiskConfigurationTypeActions from './CompromisedCredentialsRiskConfigurationTypeActions';

/**
 * The SetRiskConfigurationRequestCompromisedCredentialsRiskConfiguration model module.
 * @module model/SetRiskConfigurationRequestCompromisedCredentialsRiskConfiguration
 * @version 2016-04-18
 */
class SetRiskConfigurationRequestCompromisedCredentialsRiskConfiguration {
    /**
     * Constructs a new <code>SetRiskConfigurationRequestCompromisedCredentialsRiskConfiguration</code>.
     * @alias module:model/SetRiskConfigurationRequestCompromisedCredentialsRiskConfiguration
     * @implements module:model/CompromisedCredentialsRiskConfigurationType
     * @param actions {module:model/CompromisedCredentialsRiskConfigurationTypeActions} 
     */
    constructor(actions) { 
        CompromisedCredentialsRiskConfigurationType.initialize(this, actions);
        SetRiskConfigurationRequestCompromisedCredentialsRiskConfiguration.initialize(this, actions);
    }
    ...
    /**
     * Constructs a <code>SetRiskConfigurationRequestCompromisedCredentialsRiskConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SetRiskConfigurationRequestCompromisedCredentialsRiskConfiguration} obj Optional instance to populate.
     * @return {module:model/SetRiskConfigurationRequestCompromisedCredentialsRiskConfiguration} The populated <code>SetRiskConfigurationRequestCompromisedCredentialsRiskConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SetRiskConfigurationRequestCompromisedCredentialsRiskConfiguration();
            CompromisedCredentialsRiskConfigurationType.constructFromObject(data, obj);

            if (data.hasOwnProperty('EventFilter')) {
                obj['EventFilter'] = ApiClient.convertToType(data['EventFilter'], Array);
            }
            if (data.hasOwnProperty('Actions')) {
                obj['Actions'] = CompromisedCredentialsRiskConfigurationTypeActions.constructFromObject(data['Actions']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>SetRiskConfigurationRequestCompromisedCredentialsRiskConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SetRiskConfigurationRequestCompromisedCredentialsRiskConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SetRiskConfigurationRequestCompromisedCredentialsRiskConfiguration.RequiredProperties) {
        ...
        if (data['EventFilter']) { // data not null
          Array.validateJSON(data['EventFilter']);
        }
        // validate the optional field `Actions`
        if (data['Actions']) { // data not null
          CompromisedCredentialsRiskConfigurationTypeActions.validateJSON(data['Actions']);
        }
...
SetRiskConfigurationRequestCompromisedCredentialsRiskConfiguration.RequiredProperties = ["Actions"];

/**
 * @member {Array} EventFilter
 */
SetRiskConfigurationRequestCompromisedCredentialsRiskConfiguration.prototype['EventFilter'] = undefined;

/**
 * @member {module:model/CompromisedCredentialsRiskConfigurationTypeActions} Actions
 */
SetRiskConfigurationRequestCompromisedCredentialsRiskConfiguration.prototype['Actions'] = undefined;


// Implement CompromisedCredentialsRiskConfigurationType interface:
/**
 * @member {Array} EventFilter
 */
CompromisedCredentialsRiskConfigurationType.prototype['EventFilter'] = undefined;
/**
 * @member {module:model/CompromisedCredentialsRiskConfigurationTypeActions} Actions
 */
CompromisedCredentialsRiskConfigurationType.prototype['Actions'] = undefined;




export default SetRiskConfigurationRequestCompromisedCredentialsRiskConfiguration;
