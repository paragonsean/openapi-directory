...
import CompromisedCredentialsEventActionType from './CompromisedCredentialsEventActionType';

/**
 * The CompromisedCredentialsActionsType model module.
 * @module model/CompromisedCredentialsActionsType
 * @version 2016-04-18
 */
class CompromisedCredentialsActionsType {
    /**
     * Constructs a new <code>CompromisedCredentialsActionsType</code>.
     * The compromised credentials actions type.
     * @alias module:model/CompromisedCredentialsActionsType
     * @param eventAction {module:model/CompromisedCredentialsEventActionType} 
     */
    constructor(eventAction) { 
        
        CompromisedCredentialsActionsType.initialize(this, eventAction);
    }
     ...
     */
    static initialize(obj, eventAction) { 
        obj['EventAction'] = eventAction;
    }

    /**
     * Constructs a <code>CompromisedCredentialsActionsType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CompromisedCredentialsActionsType} obj Optional instance to populate.
     * @return {module:model/CompromisedCredentialsActionsType} The populated <code>CompromisedCredentialsActionsType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CompromisedCredentialsActionsType();

            if (data.hasOwnProperty('EventAction')) {
                obj['EventAction'] = ApiClient.convertToType(data['EventAction'], CompromisedCredentialsEventActionType);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CompromisedCredentialsActionsType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CompromisedCredentialsActionsType</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CompromisedCredentialsActionsType.RequiredProperties) {
        ...
        if (data['EventAction']) { // data not null
          CompromisedCredentialsEventActionType.validateJSON(data['EventAction']);
        }
...
CompromisedCredentialsActionsType.RequiredProperties = ["EventAction"];

/**
 * @member {module:model/CompromisedCredentialsEventActionType} EventAction
 */
CompromisedCredentialsActionsType.prototype['EventAction'] = undefined;
...
export default CompromisedCredentialsActionsType;
