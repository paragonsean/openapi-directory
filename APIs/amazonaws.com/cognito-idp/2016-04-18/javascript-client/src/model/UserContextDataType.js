...
/**
 * The UserContextDataType model module.
 * @module model/UserContextDataType
 * @version 2016-04-18
 */
class UserContextDataType {
    /**
     * Constructs a new <code>UserContextDataType</code>.
     * Contextual data, such as the user&#39;s device fingerprint, IP address, or location, used for evaluating the risk of an unexpected event by Amazon Cognito advanced security.
     * @alias module:model/UserContextDataType
     */
    constructor() { 
        
        UserContextDataType.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UserContextDataType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UserContextDataType} obj Optional instance to populate.
     * @return {module:model/UserContextDataType} The populated <code>UserContextDataType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UserContextDataType();
    ...
    /**
     * Validates the JSON data with respect to <code>UserContextDataType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UserContextDataType</code>.
     */
 ...
 */
UserContextDataType.prototype['IpAddress'] = undefined;

/**
 * @member {String} EncodedData
 */
UserContextDataType.prototype['EncodedData'] = undefined;
...
export default UserContextDataType;
