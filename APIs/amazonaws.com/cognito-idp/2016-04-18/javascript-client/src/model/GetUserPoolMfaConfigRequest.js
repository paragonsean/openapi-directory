...
/**
 * The GetUserPoolMfaConfigRequest model module.
 * @module model/GetUserPoolMfaConfigRequest
 * @version 2016-04-18
 */
class GetUserPoolMfaConfigRequest {
    /**
     * Constructs a new <code>GetUserPoolMfaConfigRequest</code>.
     * @alias module:model/GetUserPoolMfaConfigRequest
     * @param userPoolId {String} 
     */
    constructor(userPoolId) { 
        
        GetUserPoolMfaConfigRequest.initialize(this, userPoolId);
    }
    ...
    /**
     * Constructs a <code>GetUserPoolMfaConfigRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetUserPoolMfaConfigRequest} obj Optional instance to populate.
     * @return {module:model/GetUserPoolMfaConfigRequest} The populated <code>GetUserPoolMfaConfigRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetUserPoolMfaConfigRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GetUserPoolMfaConfigRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetUserPoolMfaConfigRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetUserPoolMfaConfigRequest.RequiredProperties) {
...
GetUserPoolMfaConfigRequest.RequiredProperties = ["UserPoolId"];

/**
 * @member {String} UserPoolId
 */
GetUserPoolMfaConfigRequest.prototype['UserPoolId'] = undefined;
...
export default GetUserPoolMfaConfigRequest;
