...
/**
 * The UpdateAuthEventFeedbackRequest model module.
 * @module model/UpdateAuthEventFeedbackRequest
 * @version 2016-04-18
 */
class UpdateAuthEventFeedbackRequest {
    /**
     * Constructs a new <code>UpdateAuthEventFeedbackRequest</code>.
     * @alias module:model/UpdateAuthEventFeedbackRequest
     ...
     */
    constructor(userPoolId, username, eventId, feedbackToken, feedbackValue) { 
        
        UpdateAuthEventFeedbackRequest.initialize(this, userPoolId, username, eventId, feedbackToken, feedbackValue);
    }
     ...
     */
    static initialize(obj, userPoolId, username, eventId, feedbackToken, feedbackValue) { 
        obj['UserPoolId'] = userPoolId;
        obj['Username'] = username;
        obj['EventId'] = eventId;
        obj['FeedbackToken'] = feedbackToken;
        obj['FeedbackValue'] = feedbackValue;
    }

    /**
     * Constructs a <code>UpdateAuthEventFeedbackRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateAuthEventFeedbackRequest} obj Optional instance to populate.
     * @return {module:model/UpdateAuthEventFeedbackRequest} The populated <code>UpdateAuthEventFeedbackRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateAuthEventFeedbackRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateAuthEventFeedbackRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateAuthEventFeedbackRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateAuthEventFeedbackRequest.RequiredProperties) {
...
UpdateAuthEventFeedbackRequest.RequiredProperties = ["UserPoolId", "Username", "EventId", "FeedbackToken", "FeedbackValue"];

/**
 * @member {String} UserPoolId
 */
UpdateAuthEventFeedbackRequest.prototype['UserPoolId'] = undefined;

/**
 * @member {String} Username
 */
UpdateAuthEventFeedbackRequest.prototype['Username'] = undefined;

/**
 * @member {String} EventId
 */
UpdateAuthEventFeedbackRequest.prototype['EventId'] = undefined;

/**
 * @member {String} FeedbackToken
 */
UpdateAuthEventFeedbackRequest.prototype['FeedbackToken'] = undefined;

/**
 * @member {module:model/FeedbackValueType} FeedbackValue
 */
UpdateAuthEventFeedbackRequest.prototype['FeedbackValue'] = undefined;
...
export default UpdateAuthEventFeedbackRequest;
