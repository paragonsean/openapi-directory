...
/**
 * The AdminCreateUserConfigType model module.
 * @module model/AdminCreateUserConfigType
 * @version 2016-04-18
 */
class AdminCreateUserConfigType {
    /**
     * Constructs a new <code>AdminCreateUserConfigType</code>.
     * The configuration for creating a new user profile.
     * @alias module:model/AdminCreateUserConfigType
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>AdminCreateUserConfigType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdminCreateUserConfigType} obj Optional instance to populate.
     * @return {module:model/AdminCreateUserConfigType} The populated <code>AdminCreateUserConfigType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdminCreateUserConfigType();
    ...
    /**
     * Validates the JSON data with respect to <code>AdminCreateUserConfigType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdminCreateUserConfigType</code>.
     */
...
export default AdminCreateUserConfigType;
