...
/**
 * The AccountTakeoverActionsTypeHighAction model module.
 * @module model/AccountTakeoverActionsTypeHighAction
 * @version 2016-04-18
 */
class AccountTakeoverActionsTypeHighAction {
    /**
     * Constructs a new <code>AccountTakeoverActionsTypeHighAction</code>.
     * @alias module:model/AccountTakeoverActionsTypeHighAction
    ...
    constructor(notify, eventAction) { 
        ...
        AccountTakeoverActionsTypeHighAction.initialize(this, notify, eventAction);
    }
    ...
    /**
     * Constructs a <code>AccountTakeoverActionsTypeHighAction</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AccountTakeoverActionsTypeHighAction} obj Optional instance to populate.
     * @return {module:model/AccountTakeoverActionsTypeHighAction} The populated <code>AccountTakeoverActionsTypeHighAction</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AccountTakeoverActionsTypeHighAction();
    ...
    /**
     * Validates the JSON data with respect to <code>AccountTakeoverActionsTypeHighAction</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AccountTakeoverActionsTypeHighAction</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AccountTakeoverActionsTypeHighAction.RequiredProperties) {
...
AccountTakeoverActionsTypeHighAction.RequiredProperties = ["Notify", "EventAction"];

/**
 * @member {Boolean} Notify
 */
AccountTakeoverActionsTypeHighAction.prototype['Notify'] = undefined;

/**
 * @member {module:model/AccountTakeoverEventActionType} EventAction
 */
AccountTakeoverActionsTypeHighAction.prototype['EventAction'] = undefined;
...
export default AccountTakeoverActionsTypeHighAction;
