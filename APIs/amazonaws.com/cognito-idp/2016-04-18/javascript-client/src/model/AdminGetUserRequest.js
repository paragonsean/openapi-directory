...
/**
 * The AdminGetUserRequest model module.
 * @module model/AdminGetUserRequest
 * @version 2016-04-18
 */
class AdminGetUserRequest {
    /**
     * Constructs a new <code>AdminGetUserRequest</code>.
     * Represents the request to get the specified user as an administrator.
     * @alias module:model/AdminGetUserRequest
     * @param userPoolId {String} 
     * @param username {String} 
     */
    constructor(userPoolId, username) { 
        
        AdminGetUserRequest.initialize(this, userPoolId, username);
    }
    ...
    /**
     * Constructs a <code>AdminGetUserRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdminGetUserRequest} obj Optional instance to populate.
     * @return {module:model/AdminGetUserRequest} The populated <code>AdminGetUserRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdminGetUserRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>AdminGetUserRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdminGetUserRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AdminGetUserRequest.RequiredProperties) {
...
AdminGetUserRequest.RequiredProperties = ["UserPoolId", "Username"];

/**
 * @member {String} UserPoolId
 */
AdminGetUserRequest.prototype['UserPoolId'] = undefined;

/**
 * @member {String} Username
 */
AdminGetUserRequest.prototype['Username'] = undefined;
...
export default AdminGetUserRequest;
