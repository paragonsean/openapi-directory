...
/**
 * The UserPoolClientTypeAnalyticsConfiguration model module.
 * @module model/UserPoolClientTypeAnalyticsConfiguration
 * @version 2016-04-18
 */
class UserPoolClientTypeAnalyticsConfiguration {
    /**
     * Constructs a new <code>UserPoolClientTypeAnalyticsConfiguration</code>.
     * @alias module:model/UserPoolClientTypeAnalyticsConfiguration
     * @implements module:model/AnalyticsConfigurationType
     */
    constructor() { 
        AnalyticsConfigurationType.initialize(this);
        UserPoolClientTypeAnalyticsConfiguration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UserPoolClientTypeAnalyticsConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UserPoolClientTypeAnalyticsConfiguration} obj Optional instance to populate.
     * @return {module:model/UserPoolClientTypeAnalyticsConfiguration} The populated <code>UserPoolClientTypeAnalyticsConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UserPoolClientTypeAnalyticsConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>UserPoolClientTypeAnalyticsConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UserPoolClientTypeAnalyticsConfiguration</code>.
     */
 ...
 */
UserPoolClientTypeAnalyticsConfiguration.prototype['ApplicationId'] = undefined;

/**
 * @member {String} ApplicationArn
 */
UserPoolClientTypeAnalyticsConfiguration.prototype['ApplicationArn'] = undefined;

/**
 * @member {String} RoleArn
 */
UserPoolClientTypeAnalyticsConfiguration.prototype['RoleArn'] = undefined;

/**
 * @member {String} ExternalId
 */
UserPoolClientTypeAnalyticsConfiguration.prototype['ExternalId'] = undefined;

/**
 * @member {Boolean} UserDataShared
 */
UserPoolClientTypeAnalyticsConfiguration.prototype['UserDataShared'] = undefined;
...
export default UserPoolClientTypeAnalyticsConfiguration;
