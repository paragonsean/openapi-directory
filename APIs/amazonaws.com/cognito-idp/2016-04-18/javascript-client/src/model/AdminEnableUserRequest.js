...
/**
 * The AdminEnableUserRequest model module.
 * @module model/AdminEnableUserRequest
 * @version 2016-04-18
 */
class AdminEnableUserRequest {
    /**
     * Constructs a new <code>AdminEnableUserRequest</code>.
     * Represents the request that enables the user as an administrator.
     * @alias module:model/AdminEnableUserRequest
     * @param userPoolId {String} 
     * @param username {String} 
     */
    constructor(userPoolId, username) { 
        
        AdminEnableUserRequest.initialize(this, userPoolId, username);
    }
    ...
    /**
     * Constructs a <code>AdminEnableUserRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdminEnableUserRequest} obj Optional instance to populate.
     * @return {module:model/AdminEnableUserRequest} The populated <code>AdminEnableUserRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdminEnableUserRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>AdminEnableUserRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdminEnableUserRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AdminEnableUserRequest.RequiredProperties) {
...
AdminEnableUserRequest.RequiredProperties = ["UserPoolId", "Username"];

/**
 * @member {String} UserPoolId
 */
AdminEnableUserRequest.prototype['UserPoolId'] = undefined;

/**
 * @member {String} Username
 */
AdminEnableUserRequest.prototype['Username'] = undefined;
...
export default AdminEnableUserRequest;
