...
/**
 * The GetUICustomizationRequest model module.
 * @module model/GetUICustomizationRequest
 * @version 2016-04-18
 */
class GetUICustomizationRequest {
    /**
     * Constructs a new <code>GetUICustomizationRequest</code>.
     * @alias module:model/GetUICustomizationRequest
     * @param userPoolId {String} 
     */
    constructor(userPoolId) { 
        
        GetUICustomizationRequest.initialize(this, userPoolId);
    }
    ...
    /**
     * Constructs a <code>GetUICustomizationRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetUICustomizationRequest} obj Optional instance to populate.
     * @return {module:model/GetUICustomizationRequest} The populated <code>GetUICustomizationRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetUICustomizationRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GetUICustomizationRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetUICustomizationRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetUICustomizationRequest.RequiredProperties) {
...
GetUICustomizationRequest.RequiredProperties = ["UserPoolId"];

/**
 * @member {String} UserPoolId
 */
GetUICustomizationRequest.prototype['UserPoolId'] = undefined;

/**
 * @member {String} ClientId
 */
GetUICustomizationRequest.prototype['ClientId'] = undefined;
...
export default GetUICustomizationRequest;
