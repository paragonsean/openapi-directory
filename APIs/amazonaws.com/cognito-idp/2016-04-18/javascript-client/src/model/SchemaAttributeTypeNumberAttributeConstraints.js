...
/**
 * The SchemaAttributeTypeNumberAttributeConstraints model module.
 * @module model/SchemaAttributeTypeNumberAttributeConstraints
 * @version 2016-04-18
 */
class SchemaAttributeTypeNumberAttributeConstraints {
    /**
     * Constructs a new <code>SchemaAttributeTypeNumberAttributeConstraints</code>.
     * @alias module:model/SchemaAttributeTypeNumberAttributeConstraints
     * @implements module:model/NumberAttributeConstraintsType
     */
    constructor() { 
        NumberAttributeConstraintsType.initialize(this);
        SchemaAttributeTypeNumberAttributeConstraints.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SchemaAttributeTypeNumberAttributeConstraints</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SchemaAttributeTypeNumberAttributeConstraints} obj Optional instance to populate.
     * @return {module:model/SchemaAttributeTypeNumberAttributeConstraints} The populated <code>SchemaAttributeTypeNumberAttributeConstraints</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SchemaAttributeTypeNumberAttributeConstraints();
            NumberAttributeConstraintsType.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>SchemaAttributeTypeNumberAttributeConstraints</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SchemaAttributeTypeNumberAttributeConstraints</code>.
     */
 ...
 */
SchemaAttributeTypeNumberAttributeConstraints.prototype['MinValue'] = undefined;

/**
 * @member {String} MaxValue
 */
SchemaAttributeTypeNumberAttributeConstraints.prototype['MaxValue'] = undefined;


// Implement NumberAttributeConstraintsType interface:
/**
 * @member {String} MinValue
 */
NumberAttributeConstraintsType.prototype['MinValue'] = undefined;
/**
 * @member {String} MaxValue
 */
NumberAttributeConstraintsType.prototype['MaxValue'] = undefined;




export default SchemaAttributeTypeNumberAttributeConstraints;
