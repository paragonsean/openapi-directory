...
/**
 * The UpdateUserAttributesRequest model module.
 * @module model/UpdateUserAttributesRequest
 * @version 2016-04-18
 */
class UpdateUserAttributesRequest {
    /**
     * Constructs a new <code>UpdateUserAttributesRequest</code>.
     * Represents the request to update user attributes.
     * @alias module:model/UpdateUserAttributesRequest
     * @param userAttributes {Array} 
     * @param accessToken {String} 
     */
    constructor(userAttributes, accessToken) { 
        
        UpdateUserAttributesRequest.initialize(this, userAttributes, accessToken);
    }
     ...
     */
    static initialize(obj, userAttributes, accessToken) { 
        obj['UserAttributes'] = userAttributes;
        obj['AccessToken'] = accessToken;
    }

    /**
     * Constructs a <code>UpdateUserAttributesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateUserAttributesRequest} obj Optional instance to populate.
     * @return {module:model/UpdateUserAttributesRequest} The populated <code>UpdateUserAttributesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateUserAttributesRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateUserAttributesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateUserAttributesRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateUserAttributesRequest.RequiredProperties) {
...
UpdateUserAttributesRequest.RequiredProperties = ["UserAttributes", "AccessToken"];

/**
 * @member {Array} UserAttributes
 */
UpdateUserAttributesRequest.prototype['UserAttributes'] = undefined;

/**
 * @member {String} AccessToken
 */
UpdateUserAttributesRequest.prototype['AccessToken'] = undefined;

/**
 * @member {Object} ClientMetadata
 */
UpdateUserAttributesRequest.prototype['ClientMetadata'] = undefined;
...
export default UpdateUserAttributesRequest;
