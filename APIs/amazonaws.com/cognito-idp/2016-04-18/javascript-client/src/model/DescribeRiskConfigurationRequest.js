...
/**
 * The DescribeRiskConfigurationRequest model module.
 * @module model/DescribeRiskConfigurationRequest
 * @version 2016-04-18
 */
class DescribeRiskConfigurationRequest {
    /**
     * Constructs a new <code>DescribeRiskConfigurationRequest</code>.
     * @alias module:model/DescribeRiskConfigurationRequest
     * @param userPoolId {String} 
     */
    constructor(userPoolId) { 
        
        DescribeRiskConfigurationRequest.initialize(this, userPoolId);
    }
    ...
    /**
     * Constructs a <code>DescribeRiskConfigurationRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeRiskConfigurationRequest} obj Optional instance to populate.
     * @return {module:model/DescribeRiskConfigurationRequest} The populated <code>DescribeRiskConfigurationRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeRiskConfigurationRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeRiskConfigurationRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeRiskConfigurationRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeRiskConfigurationRequest.RequiredProperties) {
...
DescribeRiskConfigurationRequest.RequiredProperties = ["UserPoolId"];

/**
 * @member {String} UserPoolId
 */
DescribeRiskConfigurationRequest.prototype['UserPoolId'] = undefined;

/**
 * @member {String} ClientId
 */
DescribeRiskConfigurationRequest.prototype['ClientId'] = undefined;
...
export default DescribeRiskConfigurationRequest;
