...
/**
 * The NotifyConfigurationTypeNoActionEmail model module.
 * @module model/NotifyConfigurationTypeNoActionEmail
 * @version 2016-04-18
 */
class NotifyConfigurationTypeNoActionEmail {
    /**
     * Constructs a new <code>NotifyConfigurationTypeNoActionEmail</code>.
     * @alias module:model/NotifyConfigurationTypeNoActionEmail
     * @implements module:model/NotifyEmailType
     * @param subject {String} 
     */
    constructor(subject) { 
        NotifyEmailType.initialize(this, subject);
        NotifyConfigurationTypeNoActionEmail.initialize(this, subject);
    }
    ...
    /**
     * Constructs a <code>NotifyConfigurationTypeNoActionEmail</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NotifyConfigurationTypeNoActionEmail} obj Optional instance to populate.
     * @return {module:model/NotifyConfigurationTypeNoActionEmail} The populated <code>NotifyConfigurationTypeNoActionEmail</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NotifyConfigurationTypeNoActionEmail();
    ...
    /**
     * Validates the JSON data with respect to <code>NotifyConfigurationTypeNoActionEmail</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NotifyConfigurationTypeNoActionEmail</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of NotifyConfigurationTypeNoActionEmail.RequiredProperties) {
...
NotifyConfigurationTypeNoActionEmail.RequiredProperties = ["Subject"];

/**
 * @member {String} Subject
 */
NotifyConfigurationTypeNoActionEmail.prototype['Subject'] = undefined;

/**
 * @member {String} HtmlBody
 */
NotifyConfigurationTypeNoActionEmail.prototype['HtmlBody'] = undefined;

/**
 * @member {String} TextBody
 */
NotifyConfigurationTypeNoActionEmail.prototype['TextBody'] = undefined;
...
export default NotifyConfigurationTypeNoActionEmail;
