...
/**
 * The AdminInitiateAuthResponseAuthenticationResult model module.
 * @module model/AdminInitiateAuthResponseAuthenticationResult
 * @version 2016-04-18
 */
class AdminInitiateAuthResponseAuthenticationResult {
    /**
     * Constructs a new <code>AdminInitiateAuthResponseAuthenticationResult</code>.
     * @alias module:model/AdminInitiateAuthResponseAuthenticationResult
     * @implements module:model/AuthenticationResultType
     */
    constructor() { 
        AuthenticationResultType.initialize(this);
        AdminInitiateAuthResponseAuthenticationResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AdminInitiateAuthResponseAuthenticationResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdminInitiateAuthResponseAuthenticationResult} obj Optional instance to populate.
     * @return {module:model/AdminInitiateAuthResponseAuthenticationResult} The populated <code>AdminInitiateAuthResponseAuthenticationResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdminInitiateAuthResponseAuthenticationResult();
    ...
    /**
     * Validates the JSON data with respect to <code>AdminInitiateAuthResponseAuthenticationResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdminInitiateAuthResponseAuthenticationResult</code>.
     */
 ...
 */
AdminInitiateAuthResponseAuthenticationResult.prototype['AccessToken'] = undefined;

/**
 * @member {Number} ExpiresIn
 */
AdminInitiateAuthResponseAuthenticationResult.prototype['ExpiresIn'] = undefined;

/**
 * @member {String} TokenType
 */
AdminInitiateAuthResponseAuthenticationResult.prototype['TokenType'] = undefined;

/**
 * @member {String} RefreshToken
 */
AdminInitiateAuthResponseAuthenticationResult.prototype['RefreshToken'] = undefined;

/**
 * @member {String} IdToken
 */
AdminInitiateAuthResponseAuthenticationResult.prototype['IdToken'] = undefined;

/**
 * @member {module:model/AuthenticationResultTypeNewDeviceMetadata} NewDeviceMetadata
 */
AdminInitiateAuthResponseAuthenticationResult.prototype['NewDeviceMetadata'] = undefined;
...
export default AdminInitiateAuthResponseAuthenticationResult;
