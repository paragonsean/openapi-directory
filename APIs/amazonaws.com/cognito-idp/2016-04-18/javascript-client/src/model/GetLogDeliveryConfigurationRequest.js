...
/**
 * The GetLogDeliveryConfigurationRequest model module.
 * @module model/GetLogDeliveryConfigurationRequest
 * @version 2016-04-18
 */
class GetLogDeliveryConfigurationRequest {
    /**
     * Constructs a new <code>GetLogDeliveryConfigurationRequest</code>.
     * @alias module:model/GetLogDeliveryConfigurationRequest
     * @param userPoolId {String} 
     */
    constructor(userPoolId) { 
        
        GetLogDeliveryConfigurationRequest.initialize(this, userPoolId);
    }
    ...
    /**
     * Constructs a <code>GetLogDeliveryConfigurationRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetLogDeliveryConfigurationRequest} obj Optional instance to populate.
     * @return {module:model/GetLogDeliveryConfigurationRequest} The populated <code>GetLogDeliveryConfigurationRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetLogDeliveryConfigurationRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GetLogDeliveryConfigurationRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetLogDeliveryConfigurationRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetLogDeliveryConfigurationRequest.RequiredProperties) {
...
GetLogDeliveryConfigurationRequest.RequiredProperties = ["UserPoolId"];

/**
 * @member {String} UserPoolId
 */
GetLogDeliveryConfigurationRequest.prototype['UserPoolId'] = undefined;
...
export default GetLogDeliveryConfigurationRequest;
