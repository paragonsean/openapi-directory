...
/**
 * The AdminSetUserMFAPreferenceRequestSoftwareTokenMfaSettings model module.
 * @module model/AdminSetUserMFAPreferenceRequestSoftwareTokenMfaSettings
 * @version 2016-04-18
 */
class AdminSetUserMFAPreferenceRequestSoftwareTokenMfaSettings {
    /**
     * Constructs a new <code>AdminSetUserMFAPreferenceRequestSoftwareTokenMfaSettings</code>.
     * @alias module:model/AdminSetUserMFAPreferenceRequestSoftwareTokenMfaSettings
     * @implements module:model/SoftwareTokenMfaSettingsType
     */
    constructor() { 
        SoftwareTokenMfaSettingsType.initialize(this);
        AdminSetUserMFAPreferenceRequestSoftwareTokenMfaSettings.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AdminSetUserMFAPreferenceRequestSoftwareTokenMfaSettings</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdminSetUserMFAPreferenceRequestSoftwareTokenMfaSettings} obj Optional instance to populate.
     * @return {module:model/AdminSetUserMFAPreferenceRequestSoftwareTokenMfaSettings} The populated <code>AdminSetUserMFAPreferenceRequestSoftwareTokenMfaSettings</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdminSetUserMFAPreferenceRequestSoftwareTokenMfaSettings();
    ...
    /**
     * Validates the JSON data with respect to <code>AdminSetUserMFAPreferenceRequestSoftwareTokenMfaSettings</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdminSetUserMFAPreferenceRequestSoftwareTokenMfaSettings</code>.
     */
 ...
 */
AdminSetUserMFAPreferenceRequestSoftwareTokenMfaSettings.prototype['Enabled'] = undefined;

/**
 * @member {Boolean} PreferredMfa
 */
AdminSetUserMFAPreferenceRequestSoftwareTokenMfaSettings.prototype['PreferredMfa'] = undefined;
...
export default AdminSetUserMFAPreferenceRequestSoftwareTokenMfaSettings;
