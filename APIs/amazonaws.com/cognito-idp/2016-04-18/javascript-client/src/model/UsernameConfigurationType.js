...
/**
 * The UsernameConfigurationType model module.
 * @module model/UsernameConfigurationType
 * @version 2016-04-18
 */
class UsernameConfigurationType {
    /**
     * Constructs a new <code>UsernameConfigurationType</code>.
     * The username configuration type. 
     * @alias module:model/UsernameConfigurationType
    ...
    /**
     * Constructs a <code>UsernameConfigurationType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UsernameConfigurationType} obj Optional instance to populate.
     * @return {module:model/UsernameConfigurationType} The populated <code>UsernameConfigurationType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UsernameConfigurationType();
    ...
    /**
     * Validates the JSON data with respect to <code>UsernameConfigurationType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UsernameConfigurationType</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UsernameConfigurationType.RequiredProperties) {
...
UsernameConfigurationType.RequiredProperties = ["CaseSensitive"];
...
export default UsernameConfigurationType;
