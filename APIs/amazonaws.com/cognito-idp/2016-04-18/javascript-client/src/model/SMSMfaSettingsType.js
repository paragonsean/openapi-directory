...
/**
 * The SMSMfaSettingsType model module.
 * @module model/SMSMfaSettingsType
 * @version 2016-04-18
 */
class SMSMfaSettingsType {
    /**
     * Constructs a new <code>SMSMfaSettingsType</code>.
     ...
     * @alias module:model/SMSMfaSettingsType
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>SMSMfaSettingsType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SMSMfaSettingsType} obj Optional instance to populate.
     * @return {module:model/SMSMfaSettingsType} The populated <code>SMSMfaSettingsType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SMSMfaSettingsType();
    ...
    /**
     * Validates the JSON data with respect to <code>SMSMfaSettingsType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SMSMfaSettingsType</code>.
     */
...
export default SMSMfaSettingsType;
