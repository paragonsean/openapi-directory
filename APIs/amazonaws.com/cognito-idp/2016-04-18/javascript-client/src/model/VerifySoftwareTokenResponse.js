...
import VerifySoftwareTokenResponseType from './VerifySoftwareTokenResponseType';

/**
 * The VerifySoftwareTokenResponse model module.
 * @module model/VerifySoftwareTokenResponse
 * @version 2016-04-18
 */
class VerifySoftwareTokenResponse {
    /**
     * Constructs a new <code>VerifySoftwareTokenResponse</code>.
     * @alias module:model/VerifySoftwareTokenResponse
     */
    constructor() { 
        
        VerifySoftwareTokenResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>VerifySoftwareTokenResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VerifySoftwareTokenResponse} obj Optional instance to populate.
     * @return {module:model/VerifySoftwareTokenResponse} The populated <code>VerifySoftwareTokenResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VerifySoftwareTokenResponse();

            if (data.hasOwnProperty('Status')) {
                obj['Status'] = ApiClient.convertToType(data['Status'], VerifySoftwareTokenResponseType);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>VerifySoftwareTokenResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VerifySoftwareTokenResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Status`
        if (data['Status']) { // data not null
          VerifySoftwareTokenResponseType.validateJSON(data['Status']);
        }
...
/**
 * @member {module:model/VerifySoftwareTokenResponseType} Status
 */
VerifySoftwareTokenResponse.prototype['Status'] = undefined;

/**
 * @member {String} Session
 */
VerifySoftwareTokenResponse.prototype['Session'] = undefined;
...
export default VerifySoftwareTokenResponse;
