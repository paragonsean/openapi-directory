...
/**
 * The AdminGetDeviceRequest model module.
 * @module model/AdminGetDeviceRequest
 * @version 2016-04-18
 */
class AdminGetDeviceRequest {
    /**
     * Constructs a new <code>AdminGetDeviceRequest</code>.
     * Represents the request to get the device, as an administrator.
     * @alias module:model/AdminGetDeviceRequest
     * @param deviceKey {String} 
     * @param userPoolId {String} 
     * @param username {String} 
     */
    constructor(deviceKey, userPoolId, username) { 
        
        AdminGetDeviceRequest.initialize(this, deviceKey, userPoolId, username);
    }
     ...
     */
    static initialize(obj, deviceKey, userPoolId, username) { 
    ...
    /**
     * Constructs a <code>AdminGetDeviceRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdminGetDeviceRequest} obj Optional instance to populate.
     * @return {module:model/AdminGetDeviceRequest} The populated <code>AdminGetDeviceRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdminGetDeviceRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>AdminGetDeviceRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdminGetDeviceRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AdminGetDeviceRequest.RequiredProperties) {
...
AdminGetDeviceRequest.RequiredProperties = ["DeviceKey", "UserPoolId", "Username"];

/**
 * @member {String} DeviceKey
 */
AdminGetDeviceRequest.prototype['DeviceKey'] = undefined;

/**
 * @member {String} UserPoolId
 */
AdminGetDeviceRequest.prototype['UserPoolId'] = undefined;

/**
 * @member {String} Username
 */
AdminGetDeviceRequest.prototype['Username'] = undefined;
...
export default AdminGetDeviceRequest;
