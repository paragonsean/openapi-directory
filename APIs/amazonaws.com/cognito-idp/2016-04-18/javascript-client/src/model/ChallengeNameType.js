...
* @readonly
*/
export default class ChallengeNameType {
    ...
    /**
    * Returns a <code>ChallengeNameType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ChallengeNameType} The enum <code>ChallengeNameType</code> value.
    */
