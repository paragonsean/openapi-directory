...
/**
 * The ResendConfirmationCodeResponseCodeDeliveryDetails model module.
 * @module model/ResendConfirmationCodeResponseCodeDeliveryDetails
 * @version 2016-04-18
 */
class ResendConfirmationCodeResponseCodeDeliveryDetails {
    /**
     * Constructs a new <code>ResendConfirmationCodeResponseCodeDeliveryDetails</code>.
     * @alias module:model/ResendConfirmationCodeResponseCodeDeliveryDetails
     * @implements module:model/CodeDeliveryDetailsType
     */
    constructor() { 
        CodeDeliveryDetailsType.initialize(this);
        ResendConfirmationCodeResponseCodeDeliveryDetails.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ResendConfirmationCodeResponseCodeDeliveryDetails</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ResendConfirmationCodeResponseCodeDeliveryDetails} obj Optional instance to populate.
     * @return {module:model/ResendConfirmationCodeResponseCodeDeliveryDetails} The populated <code>ResendConfirmationCodeResponseCodeDeliveryDetails</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ResendConfirmationCodeResponseCodeDeliveryDetails();
    ...
    /**
     * Validates the JSON data with respect to <code>ResendConfirmationCodeResponseCodeDeliveryDetails</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ResendConfirmationCodeResponseCodeDeliveryDetails</code>.
     */
 ...
 */
ResendConfirmationCodeResponseCodeDeliveryDetails.prototype['Destination'] = undefined;

/**
 * @member {module:model/DeliveryMediumType} DeliveryMedium
 */
ResendConfirmationCodeResponseCodeDeliveryDetails.prototype['DeliveryMedium'] = undefined;

/**
 * @member {String} AttributeName
 */
ResendConfirmationCodeResponseCodeDeliveryDetails.prototype['AttributeName'] = undefined;
...
export default ResendConfirmationCodeResponseCodeDeliveryDetails;
