...
/**
 * The ListResourceServersResponse model module.
 * @module model/ListResourceServersResponse
 * @version 2016-04-18
 */
class ListResourceServersResponse {
    /**
     * Constructs a new <code>ListResourceServersResponse</code>.
     * @alias module:model/ListResourceServersResponse
     * @param resourceServers {Array} 
     */
    constructor(resourceServers) { 
        
        ListResourceServersResponse.initialize(this, resourceServers);
    }
     ...
     */
    static initialize(obj, resourceServers) { 
        obj['ResourceServers'] = resourceServers;
    }

    /**
     * Constructs a <code>ListResourceServersResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListResourceServersResponse} obj Optional instance to populate.
     * @return {module:model/ListResourceServersResponse} The populated <code>ListResourceServersResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListResourceServersResponse();

            if (data.hasOwnProperty('ResourceServers')) {
                obj['ResourceServers'] = ApiClient.convertToType(data['ResourceServers'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListResourceServersResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListResourceServersResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListResourceServersResponse.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `ResourceServers`
        if (data['ResourceServers']) { // data not null
          Array.validateJSON(data['ResourceServers']);
        }
...
ListResourceServersResponse.RequiredProperties = ["ResourceServers"];

/**
 * @member {Array} ResourceServers
 */
ListResourceServersResponse.prototype['ResourceServers'] = undefined;

/**
 * @member {String} NextToken
 */
ListResourceServersResponse.prototype['NextToken'] = undefined;
...
export default ListResourceServersResponse;
