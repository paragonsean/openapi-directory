...
/**
 * The GlobalSignOutRequest model module.
 * @module model/GlobalSignOutRequest
 * @version 2016-04-18
 */
class GlobalSignOutRequest {
    /**
     * Constructs a new <code>GlobalSignOutRequest</code>.
     * Represents the request to sign out all devices.
     * @alias module:model/GlobalSignOutRequest
     * @param accessToken {String} 
     */
    constructor(accessToken) { 
        
        GlobalSignOutRequest.initialize(this, accessToken);
    }
    ...
    /**
     * Constructs a <code>GlobalSignOutRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GlobalSignOutRequest} obj Optional instance to populate.
     * @return {module:model/GlobalSignOutRequest} The populated <code>GlobalSignOutRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GlobalSignOutRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GlobalSignOutRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GlobalSignOutRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GlobalSignOutRequest.RequiredProperties) {
...
GlobalSignOutRequest.RequiredProperties = ["AccessToken"];

/**
 * @member {String} AccessToken
 */
GlobalSignOutRequest.prototype['AccessToken'] = undefined;
...
export default GlobalSignOutRequest;
