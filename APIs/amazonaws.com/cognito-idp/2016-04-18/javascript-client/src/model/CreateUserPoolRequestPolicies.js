...
import UserPoolPolicyTypePasswordPolicy from './UserPoolPolicyTypePasswordPolicy';

/**
 * The CreateUserPoolRequestPolicies model module.
 * @module model/CreateUserPoolRequestPolicies
 * @version 2016-04-18
 */
class CreateUserPoolRequestPolicies {
    /**
     * Constructs a new <code>CreateUserPoolRequestPolicies</code>.
     * @alias module:model/CreateUserPoolRequestPolicies
     * @implements module:model/UserPoolPolicyType
     */
    constructor() { 
        UserPoolPolicyType.initialize(this);
        CreateUserPoolRequestPolicies.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateUserPoolRequestPolicies</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateUserPoolRequestPolicies} obj Optional instance to populate.
     * @return {module:model/CreateUserPoolRequestPolicies} The populated <code>CreateUserPoolRequestPolicies</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateUserPoolRequestPolicies();
            UserPoolPolicyType.constructFromObject(data, obj);

            if (data.hasOwnProperty('PasswordPolicy')) {
                obj['PasswordPolicy'] = UserPoolPolicyTypePasswordPolicy.constructFromObject(data['PasswordPolicy']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateUserPoolRequestPolicies</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateUserPoolRequestPolicies</code>.
     */
    static validateJSON(data) {
        // validate the optional field `PasswordPolicy`
        if (data['PasswordPolicy']) { // data not null
          UserPoolPolicyTypePasswordPolicy.validateJSON(data['PasswordPolicy']);
        }
...
/**
 * @member {module:model/UserPoolPolicyTypePasswordPolicy} PasswordPolicy
 */
CreateUserPoolRequestPolicies.prototype['PasswordPolicy'] = undefined;


// Implement UserPoolPolicyType interface:
/**
 * @member {module:model/UserPoolPolicyTypePasswordPolicy} PasswordPolicy
 */
UserPoolPolicyType.prototype['PasswordPolicy'] = undefined;




export default CreateUserPoolRequestPolicies;
