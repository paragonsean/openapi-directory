...
import UserPoolDescriptionTypeLambdaConfig from './UserPoolDescriptionTypeLambdaConfig';

/**
 * The UserPoolDescriptionType model module.
 * @module model/UserPoolDescriptionType
 * @version 2016-04-18
 */
class UserPoolDescriptionType {
    /**
     * Constructs a new <code>UserPoolDescriptionType</code>.
     * A user pool description.
     * @alias module:model/UserPoolDescriptionType
     */
    constructor() { 
        
        UserPoolDescriptionType.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UserPoolDescriptionType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UserPoolDescriptionType} obj Optional instance to populate.
     * @return {module:model/UserPoolDescriptionType} The populated <code>UserPoolDescriptionType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UserPoolDescriptionType();
            ...
            if (data.hasOwnProperty('LambdaConfig')) {
                obj['LambdaConfig'] = UserPoolDescriptionTypeLambdaConfig.constructFromObject(data['LambdaConfig']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>UserPoolDescriptionType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UserPoolDescriptionType</code>.
     */
    static validateJSON(data) {
        ...
        if (data['LambdaConfig']) { // data not null
          UserPoolDescriptionTypeLambdaConfig.validateJSON(data['LambdaConfig']);
        }
 ...
 * @member {String} Id
 */
UserPoolDescriptionType.prototype['Id'] = undefined;

/**
 * @member {String} Name
 */
UserPoolDescriptionType.prototype['Name'] = undefined;

/**
 * @member {module:model/UserPoolDescriptionTypeLambdaConfig} LambdaConfig
 */
UserPoolDescriptionType.prototype['LambdaConfig'] = undefined;

/**
 * @member {module:model/StatusType} Status
 */
UserPoolDescriptionType.prototype['Status'] = undefined;

/**
 * @member {Date} LastModifiedDate
 */
UserPoolDescriptionType.prototype['LastModifiedDate'] = undefined;

/**
 * @member {Date} CreationDate
 */
UserPoolDescriptionType.prototype['CreationDate'] = undefined;
...
export default UserPoolDescriptionType;
