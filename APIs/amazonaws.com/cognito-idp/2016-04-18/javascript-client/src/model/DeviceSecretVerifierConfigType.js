...
/**
 * The DeviceSecretVerifierConfigType model module.
 * @module model/DeviceSecretVerifierConfigType
 * @version 2016-04-18
 */
class DeviceSecretVerifierConfigType {
    /**
     * Constructs a new <code>DeviceSecretVerifierConfigType</code>.
     * The device verifier against which it is authenticated.
     * @alias module:model/DeviceSecretVerifierConfigType
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>DeviceSecretVerifierConfigType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeviceSecretVerifierConfigType} obj Optional instance to populate.
     * @return {module:model/DeviceSecretVerifierConfigType} The populated <code>DeviceSecretVerifierConfigType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeviceSecretVerifierConfigType();
    ...
    /**
     * Validates the JSON data with respect to <code>DeviceSecretVerifierConfigType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeviceSecretVerifierConfigType</code>.
     */
...
export default DeviceSecretVerifierConfigType;
