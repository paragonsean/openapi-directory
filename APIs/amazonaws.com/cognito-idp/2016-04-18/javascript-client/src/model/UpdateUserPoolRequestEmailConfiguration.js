...
/**
 * The UpdateUserPoolRequestEmailConfiguration model module.
 * @module model/UpdateUserPoolRequestEmailConfiguration
 * @version 2016-04-18
 */
class UpdateUserPoolRequestEmailConfiguration {
    /**
     * Constructs a new <code>UpdateUserPoolRequestEmailConfiguration</code>.
     * @alias module:model/UpdateUserPoolRequestEmailConfiguration
     * @implements module:model/EmailConfigurationType
     */
    constructor() { 
        EmailConfigurationType.initialize(this);
        UpdateUserPoolRequestEmailConfiguration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateUserPoolRequestEmailConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateUserPoolRequestEmailConfiguration} obj Optional instance to populate.
     * @return {module:model/UpdateUserPoolRequestEmailConfiguration} The populated <code>UpdateUserPoolRequestEmailConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateUserPoolRequestEmailConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateUserPoolRequestEmailConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateUserPoolRequestEmailConfiguration</code>.
     */
 ...
 */
UpdateUserPoolRequestEmailConfiguration.prototype['SourceArn'] = undefined;

/**
 * @member {String} ReplyToEmailAddress
 */
UpdateUserPoolRequestEmailConfiguration.prototype['ReplyToEmailAddress'] = undefined;

/**
 * @member {module:model/EmailSendingAccountType} EmailSendingAccount
 */
UpdateUserPoolRequestEmailConfiguration.prototype['EmailSendingAccount'] = undefined;

/**
 * @member {String} From
 */
UpdateUserPoolRequestEmailConfiguration.prototype['From'] = undefined;

/**
 * @member {String} ConfigurationSet
 */
UpdateUserPoolRequestEmailConfiguration.prototype['ConfigurationSet'] = undefined;
...
export default UpdateUserPoolRequestEmailConfiguration;
