...
import CreateUserPoolClientResponseUserPoolClient from './CreateUserPoolClientResponseUserPoolClient';

/**
 * The CreateUserPoolClientResponse model module.
 * @module model/CreateUserPoolClientResponse
 * @version 2016-04-18
 */
class CreateUserPoolClientResponse {
    /**
     * Constructs a new <code>CreateUserPoolClientResponse</code>.
     * Represents the response from the server to create a user pool client.
     * @alias module:model/CreateUserPoolClientResponse
     */
    constructor() { 
        
        CreateUserPoolClientResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateUserPoolClientResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateUserPoolClientResponse} obj Optional instance to populate.
     * @return {module:model/CreateUserPoolClientResponse} The populated <code>CreateUserPoolClientResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateUserPoolClientResponse();

            if (data.hasOwnProperty('UserPoolClient')) {
                obj['UserPoolClient'] = CreateUserPoolClientResponseUserPoolClient.constructFromObject(data['UserPoolClient']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateUserPoolClientResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateUserPoolClientResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `UserPoolClient`
        if (data['UserPoolClient']) { // data not null
          CreateUserPoolClientResponseUserPoolClient.validateJSON(data['UserPoolClient']);
        }
...
/**
 * @member {module:model/CreateUserPoolClientResponseUserPoolClient} UserPoolClient
 */
CreateUserPoolClientResponse.prototype['UserPoolClient'] = undefined;
...
export default CreateUserPoolClientResponse;
