...
* @readonly
*/
export default class CustomEmailSenderLambdaVersionType {
    ...
    /**
    * Returns a <code>CustomEmailSenderLambdaVersionType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/CustomEmailSenderLambdaVersionType} The enum <code>CustomEmailSenderLambdaVersionType</code> value.
    */
