...
/**
 * The CustomEmailLambdaVersionConfigType model module.
 * @module model/CustomEmailLambdaVersionConfigType
 * @version 2016-04-18
 */
class CustomEmailLambdaVersionConfigType {
    /**
     * Constructs a new <code>CustomEmailLambdaVersionConfigType</code>.
     * A custom email sender Lambda configuration type.
     * @alias module:model/CustomEmailLambdaVersionConfigType
    ...
    /**
     * Constructs a <code>CustomEmailLambdaVersionConfigType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CustomEmailLambdaVersionConfigType} obj Optional instance to populate.
     * @return {module:model/CustomEmailLambdaVersionConfigType} The populated <code>CustomEmailLambdaVersionConfigType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CustomEmailLambdaVersionConfigType();
    ...
    /**
     * Validates the JSON data with respect to <code>CustomEmailLambdaVersionConfigType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CustomEmailLambdaVersionConfigType</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CustomEmailLambdaVersionConfigType.RequiredProperties) {
...
CustomEmailLambdaVersionConfigType.RequiredProperties = ["LambdaVersion", "LambdaArn"];
...
export default CustomEmailLambdaVersionConfigType;
