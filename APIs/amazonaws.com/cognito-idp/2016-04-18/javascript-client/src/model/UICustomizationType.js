...
/**
 * The UICustomizationType model module.
 * @module model/UICustomizationType
 * @version 2016-04-18
 */
class UICustomizationType {
    /**
     * Constructs a new <code>UICustomizationType</code>.
     * A container for the UI customization information for a user pool&#39;s built-in app UI.
     * @alias module:model/UICustomizationType
     */
    constructor() { 
        
        UICustomizationType.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UICustomizationType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UICustomizationType} obj Optional instance to populate.
     * @return {module:model/UICustomizationType} The populated <code>UICustomizationType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UICustomizationType();
            ...
            if (data.hasOwnProperty('CSSVersion')) {
                obj['CSSVersion'] = ApiClient.convertToType(data['CSSVersion'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>UICustomizationType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UICustomizationType</code>.
     */
    static validateJSON(data) {
        ...
        if (data['CSS']) { // data not null
          String.validateJSON(data['CSS']);
        }
        // validate the optional field `CSSVersion`
        if (data['CSSVersion']) { // data not null
          String.validateJSON(data['CSSVersion']);
        }
 ...
 */
UICustomizationType.prototype['UserPoolId'] = undefined;

/**
 * @member {String} ClientId
 */
UICustomizationType.prototype['ClientId'] = undefined;

/**
 * @member {String} ImageUrl
 */
UICustomizationType.prototype['ImageUrl'] = undefined;

/**
 * @member {String} CSS
 */
UICustomizationType.prototype['CSS'] = undefined;

/**
 * @member {String} CSSVersion
 */
UICustomizationType.prototype['CSSVersion'] = undefined;

/**
 * @member {Date} LastModifiedDate
 */
UICustomizationType.prototype['LastModifiedDate'] = undefined;

/**
 * @member {Date} CreationDate
 */
UICustomizationType.prototype['CreationDate'] = undefined;
...
export default UICustomizationType;
