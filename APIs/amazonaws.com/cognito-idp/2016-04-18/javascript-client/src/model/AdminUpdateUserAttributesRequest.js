...
/**
 * The AdminUpdateUserAttributesRequest model module.
 * @module model/AdminUpdateUserAttributesRequest
 * @version 2016-04-18
 */
class AdminUpdateUserAttributesRequest {
    /**
     * Constructs a new <code>AdminUpdateUserAttributesRequest</code>.
     * Represents the request to update the user&#39;s attributes as an administrator.
     * @alias module:model/AdminUpdateUserAttributesRequest
     * @param userPoolId {String} 
     * @param username {String} 
     * @param userAttributes {Array} 
     */
    constructor(userPoolId, username, userAttributes) { 
        
        AdminUpdateUserAttributesRequest.initialize(this, userPoolId, username, userAttributes);
    }
     ...
     */
    static initialize(obj, userPoolId, username, userAttributes) { 
    ...
    /**
     * Constructs a <code>AdminUpdateUserAttributesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdminUpdateUserAttributesRequest} obj Optional instance to populate.
     * @return {module:model/AdminUpdateUserAttributesRequest} The populated <code>AdminUpdateUserAttributesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdminUpdateUserAttributesRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>AdminUpdateUserAttributesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdminUpdateUserAttributesRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AdminUpdateUserAttributesRequest.RequiredProperties) {
...
AdminUpdateUserAttributesRequest.RequiredProperties = ["UserPoolId", "Username", "UserAttributes"];

/**
 * @member {String} UserPoolId
 */
AdminUpdateUserAttributesRequest.prototype['UserPoolId'] = undefined;

/**
 * @member {String} Username
 */
AdminUpdateUserAttributesRequest.prototype['Username'] = undefined;

/**
 * @member {Array} UserAttributes
 */
AdminUpdateUserAttributesRequest.prototype['UserAttributes'] = undefined;

/**
 * @member {Object} ClientMetadata
 */
AdminUpdateUserAttributesRequest.prototype['ClientMetadata'] = undefined;
...
export default AdminUpdateUserAttributesRequest;
