...
/**
 * The DomainDescriptionTypeCustomDomainConfig model module.
 * @module model/DomainDescriptionTypeCustomDomainConfig
 * @version 2016-04-18
 */
class DomainDescriptionTypeCustomDomainConfig {
    /**
     * Constructs a new <code>DomainDescriptionTypeCustomDomainConfig</code>.
     * @alias module:model/DomainDescriptionTypeCustomDomainConfig
    ...
    constructor(certificateArn) { 
        ...
        DomainDescriptionTypeCustomDomainConfig.initialize(this, certificateArn);
    }
    ...
    /**
     * Constructs a <code>DomainDescriptionTypeCustomDomainConfig</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DomainDescriptionTypeCustomDomainConfig} obj Optional instance to populate.
     * @return {module:model/DomainDescriptionTypeCustomDomainConfig} The populated <code>DomainDescriptionTypeCustomDomainConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DomainDescriptionTypeCustomDomainConfig();
    ...
    /**
     * Validates the JSON data with respect to <code>DomainDescriptionTypeCustomDomainConfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DomainDescriptionTypeCustomDomainConfig</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DomainDescriptionTypeCustomDomainConfig.RequiredProperties) {
...
DomainDescriptionTypeCustomDomainConfig.RequiredProperties = ["CertificateArn"];

/**
 * @member {String} CertificateArn
 */
DomainDescriptionTypeCustomDomainConfig.prototype['CertificateArn'] = undefined;
...
export default DomainDescriptionTypeCustomDomainConfig;
