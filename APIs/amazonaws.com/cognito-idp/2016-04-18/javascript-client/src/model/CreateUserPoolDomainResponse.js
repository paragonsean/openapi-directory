...
/**
 * The CreateUserPoolDomainResponse model module.
 * @module model/CreateUserPoolDomainResponse
 * @version 2016-04-18
 */
class CreateUserPoolDomainResponse {
    /**
     * Constructs a new <code>CreateUserPoolDomainResponse</code>.
     * @alias module:model/CreateUserPoolDomainResponse
     */
    constructor() { 
        
        CreateUserPoolDomainResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateUserPoolDomainResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateUserPoolDomainResponse} obj Optional instance to populate.
     * @return {module:model/CreateUserPoolDomainResponse} The populated <code>CreateUserPoolDomainResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateUserPoolDomainResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateUserPoolDomainResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateUserPoolDomainResponse</code>.
     */
 ...
 */
CreateUserPoolDomainResponse.prototype['CloudFrontDomain'] = undefined;
...
export default CreateUserPoolDomainResponse;
