...
import CreateUserPoolResponseUserPool from './CreateUserPoolResponseUserPool';

/**
 * The CreateUserPoolResponse model module.
 * @module model/CreateUserPoolResponse
 * @version 2016-04-18
 */
class CreateUserPoolResponse {
    /**
     * Constructs a new <code>CreateUserPoolResponse</code>.
     * Represents the response from the server for the request to create a user pool.
     * @alias module:model/CreateUserPoolResponse
     */
    constructor() { 
        
        CreateUserPoolResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateUserPoolResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateUserPoolResponse} obj Optional instance to populate.
     * @return {module:model/CreateUserPoolResponse} The populated <code>CreateUserPoolResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateUserPoolResponse();

            if (data.hasOwnProperty('UserPool')) {
                obj['UserPool'] = CreateUserPoolResponseUserPool.constructFromObject(data['UserPool']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateUserPoolResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateUserPoolResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `UserPool`
        if (data['UserPool']) { // data not null
          CreateUserPoolResponseUserPool.validateJSON(data['UserPool']);
        }
...
/**
 * @member {module:model/CreateUserPoolResponseUserPool} UserPool
 */
CreateUserPoolResponse.prototype['UserPool'] = undefined;
...
export default CreateUserPoolResponse;
