...
/**
 * The AdminSetUserMFAPreferenceRequestSMSMfaSettings model module.
 * @module model/AdminSetUserMFAPreferenceRequestSMSMfaSettings
 * @version 2016-04-18
 */
class AdminSetUserMFAPreferenceRequestSMSMfaSettings {
    /**
     * Constructs a new <code>AdminSetUserMFAPreferenceRequestSMSMfaSettings</code>.
     * @alias module:model/AdminSetUserMFAPreferenceRequestSMSMfaSettings
     * @implements module:model/SMSMfaSettingsType
     */
    constructor() { 
        SMSMfaSettingsType.initialize(this);
        AdminSetUserMFAPreferenceRequestSMSMfaSettings.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AdminSetUserMFAPreferenceRequestSMSMfaSettings</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdminSetUserMFAPreferenceRequestSMSMfaSettings} obj Optional instance to populate.
     * @return {module:model/AdminSetUserMFAPreferenceRequestSMSMfaSettings} The populated <code>AdminSetUserMFAPreferenceRequestSMSMfaSettings</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdminSetUserMFAPreferenceRequestSMSMfaSettings();
            SMSMfaSettingsType.constructFromObject(data, obj);

            if (data.hasOwnProperty('Enabled')) {
                obj['Enabled'] = ApiClient.convertToType(data['Enabled'], 'Boolean');
            }
            if (data.hasOwnProperty('PreferredMfa')) {
                obj['PreferredMfa'] = ApiClient.convertToType(data['PreferredMfa'], 'Boolean');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AdminSetUserMFAPreferenceRequestSMSMfaSettings</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdminSetUserMFAPreferenceRequestSMSMfaSettings</code>.
     */
    static validateJSON(data) {
        ...
        if (data['PreferredMfa']) { // data not null
          Boolean.validateJSON(data['PreferredMfa']);
        }
 ...
 */
AdminSetUserMFAPreferenceRequestSMSMfaSettings.prototype['Enabled'] = undefined;

/**
 * @member {Boolean} PreferredMfa
 */
AdminSetUserMFAPreferenceRequestSMSMfaSettings.prototype['PreferredMfa'] = undefined;


// Implement SMSMfaSettingsType interface:
/**
 * @member {Boolean} Enabled
 */
SMSMfaSettingsType.prototype['Enabled'] = undefined;
/**
 * @member {Boolean} PreferredMfa
 */
SMSMfaSettingsType.prototype['PreferredMfa'] = undefined;




export default AdminSetUserMFAPreferenceRequestSMSMfaSettings;
