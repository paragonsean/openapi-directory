...
/**
 * The GetIdentityProviderByIdentifierRequest model module.
 * @module model/GetIdentityProviderByIdentifierRequest
 * @version 2016-04-18
 */
class GetIdentityProviderByIdentifierRequest {
    /**
     * Constructs a new <code>GetIdentityProviderByIdentifierRequest</code>.
     * @alias module:model/GetIdentityProviderByIdentifierRequest
     * @param userPoolId {String} 
     * @param idpIdentifier {String} 
     */
    constructor(userPoolId, idpIdentifier) { 
        
        GetIdentityProviderByIdentifierRequest.initialize(this, userPoolId, idpIdentifier);
    }
     ...
     */
    static initialize(obj, userPoolId, idpIdentifier) { 
        obj['UserPoolId'] = userPoolId;
        obj['IdpIdentifier'] = idpIdentifier;
    }

    /**
     * Constructs a <code>GetIdentityProviderByIdentifierRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetIdentityProviderByIdentifierRequest} obj Optional instance to populate.
     * @return {module:model/GetIdentityProviderByIdentifierRequest} The populated <code>GetIdentityProviderByIdentifierRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetIdentityProviderByIdentifierRequest();
            ...
            if (data.hasOwnProperty('IdpIdentifier')) {
                obj['IdpIdentifier'] = ApiClient.convertToType(data['IdpIdentifier'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetIdentityProviderByIdentifierRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetIdentityProviderByIdentifierRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetIdentityProviderByIdentifierRequest.RequiredProperties) {
        ...
        // validate the optional field `IdpIdentifier`
        if (data['IdpIdentifier']) { // data not null
          String.validateJSON(data['IdpIdentifier']);
        }
...
GetIdentityProviderByIdentifierRequest.RequiredProperties = ["UserPoolId", "IdpIdentifier"];

/**
 * @member {String} UserPoolId
 */
GetIdentityProviderByIdentifierRequest.prototype['UserPoolId'] = undefined;

/**
 * @member {String} IdpIdentifier
 */
GetIdentityProviderByIdentifierRequest.prototype['IdpIdentifier'] = undefined;
...
export default GetIdentityProviderByIdentifierRequest;
