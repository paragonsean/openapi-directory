...
/**
 * The AccountTakeoverActionsTypeLowAction model module.
 * @module model/AccountTakeoverActionsTypeLowAction
 * @version 2016-04-18
 */
class AccountTakeoverActionsTypeLowAction {
    /**
     * Constructs a new <code>AccountTakeoverActionsTypeLowAction</code>.
     * @alias module:model/AccountTakeoverActionsTypeLowAction
     * @implements module:model/AccountTakeoverActionType
    ...
    constructor(notify, eventAction) { 
        ...
        AccountTakeoverActionsTypeLowAction.initialize(this, notify, eventAction);
    }
    ...
    /**
     * Constructs a <code>AccountTakeoverActionsTypeLowAction</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AccountTakeoverActionsTypeLowAction} obj Optional instance to populate.
     * @return {module:model/AccountTakeoverActionsTypeLowAction} The populated <code>AccountTakeoverActionsTypeLowAction</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AccountTakeoverActionsTypeLowAction();
            AccountTakeoverActionType.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>AccountTakeoverActionsTypeLowAction</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AccountTakeoverActionsTypeLowAction</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AccountTakeoverActionsTypeLowAction.RequiredProperties) {
...
AccountTakeoverActionsTypeLowAction.RequiredProperties = ["Notify", "EventAction"];

/**
 * @member {Boolean} Notify
 */
AccountTakeoverActionsTypeLowAction.prototype['Notify'] = undefined;

/**
 * @member {module:model/AccountTakeoverEventActionType} EventAction
 */
AccountTakeoverActionsTypeLowAction.prototype['EventAction'] = undefined;


// Implement AccountTakeoverActionType interface:
/**
 * @member {Boolean} Notify
 */
...
export default AccountTakeoverActionsTypeLowAction;
