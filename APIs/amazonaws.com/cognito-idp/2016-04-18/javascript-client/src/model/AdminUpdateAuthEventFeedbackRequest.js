...
import FeedbackValueType from './FeedbackValueType';

/**
 * The AdminUpdateAuthEventFeedbackRequest model module.
 * @module model/AdminUpdateAuthEventFeedbackRequest
 * @version 2016-04-18
 */
class AdminUpdateAuthEventFeedbackRequest {
    /**
     * Constructs a new <code>AdminUpdateAuthEventFeedbackRequest</code>.
     * @alias module:model/AdminUpdateAuthEventFeedbackRequest
     * @param userPoolId {String} 
     * @param username {String} 
     * @param eventId {String} 
     * @param feedbackValue {module:model/FeedbackValueType} 
     */
    constructor(userPoolId, username, eventId, feedbackValue) { 
        
        AdminUpdateAuthEventFeedbackRequest.initialize(this, userPoolId, username, eventId, feedbackValue);
    }
     ...
     */
    static initialize(obj, userPoolId, username, eventId, feedbackValue) { 
        obj['UserPoolId'] = userPoolId;
        obj['Username'] = username;
        obj['EventId'] = eventId;
        obj['FeedbackValue'] = feedbackValue;
    }

    /**
     * Constructs a <code>AdminUpdateAuthEventFeedbackRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdminUpdateAuthEventFeedbackRequest} obj Optional instance to populate.
     * @return {module:model/AdminUpdateAuthEventFeedbackRequest} The populated <code>AdminUpdateAuthEventFeedbackRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdminUpdateAuthEventFeedbackRequest();
            ...
            if (data.hasOwnProperty('FeedbackValue')) {
                obj['FeedbackValue'] = ApiClient.convertToType(data['FeedbackValue'], FeedbackValueType);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AdminUpdateAuthEventFeedbackRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdminUpdateAuthEventFeedbackRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AdminUpdateAuthEventFeedbackRequest.RequiredProperties) {
        ...
        // validate the optional field `FeedbackValue`
        if (data['FeedbackValue']) { // data not null
          FeedbackValueType.validateJSON(data['FeedbackValue']);
        }
...
AdminUpdateAuthEventFeedbackRequest.RequiredProperties = ["UserPoolId", "Username", "EventId", "FeedbackValue"];

/**
 * @member {String} UserPoolId
 */
AdminUpdateAuthEventFeedbackRequest.prototype['UserPoolId'] = undefined;

/**
 * @member {String} Username
 */
AdminUpdateAuthEventFeedbackRequest.prototype['Username'] = undefined;

/**
 * @member {String} EventId
 */
AdminUpdateAuthEventFeedbackRequest.prototype['EventId'] = undefined;

/**
 * @member {module:model/FeedbackValueType} FeedbackValue
 */
AdminUpdateAuthEventFeedbackRequest.prototype['FeedbackValue'] = undefined;
...
export default AdminUpdateAuthEventFeedbackRequest;
