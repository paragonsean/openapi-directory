...
/**
 * The RiskConfigurationTypeAccountTakeoverRiskConfiguration model module.
 * @module model/RiskConfigurationTypeAccountTakeoverRiskConfiguration
 * @version 2016-04-18
 */
class RiskConfigurationTypeAccountTakeoverRiskConfiguration {
    /**
     * Constructs a new <code>RiskConfigurationTypeAccountTakeoverRiskConfiguration</code>.
     * @alias module:model/RiskConfigurationTypeAccountTakeoverRiskConfiguration
    ...
    constructor(actions) { 
        ...
        RiskConfigurationTypeAccountTakeoverRiskConfiguration.initialize(this, actions);
    }
    ...
    /**
     * Constructs a <code>RiskConfigurationTypeAccountTakeoverRiskConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RiskConfigurationTypeAccountTakeoverRiskConfiguration} obj Optional instance to populate.
     * @return {module:model/RiskConfigurationTypeAccountTakeoverRiskConfiguration} The populated <code>RiskConfigurationTypeAccountTakeoverRiskConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RiskConfigurationTypeAccountTakeoverRiskConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>RiskConfigurationTypeAccountTakeoverRiskConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RiskConfigurationTypeAccountTakeoverRiskConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RiskConfigurationTypeAccountTakeoverRiskConfiguration.RequiredProperties) {
...
RiskConfigurationTypeAccountTakeoverRiskConfiguration.RequiredProperties = ["Actions"];

/**
 * @member {module:model/AccountTakeoverRiskConfigurationTypeNotifyConfiguration} NotifyConfiguration
 */
RiskConfigurationTypeAccountTakeoverRiskConfiguration.prototype['NotifyConfiguration'] = undefined;

/**
 * @member {module:model/AccountTakeoverRiskConfigurationTypeActions} Actions
 */
RiskConfigurationTypeAccountTakeoverRiskConfiguration.prototype['Actions'] = undefined;
...
export default RiskConfigurationTypeAccountTakeoverRiskConfiguration;
