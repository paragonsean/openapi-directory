...
import ConfirmSignUpRequestAnalyticsMetadata from './ConfirmSignUpRequestAnalyticsMetadata';

/**
 * The ConfirmSignUpRequest model module.
 * @module model/ConfirmSignUpRequest
 * @version 2016-04-18
 */
class ConfirmSignUpRequest {
    /**
     * Constructs a new <code>ConfirmSignUpRequest</code>.
     * Represents the request to confirm registration of a user.
     * @alias module:model/ConfirmSignUpRequest
     * @param clientId {String} 
     * @param username {String} 
     * @param confirmationCode {String} 
     */
    constructor(clientId, username, confirmationCode) { 
        
        ConfirmSignUpRequest.initialize(this, clientId, username, confirmationCode);
    }
     ...
     */
    static initialize(obj, clientId, username, confirmationCode) { 
    ...
    /**
     * Constructs a <code>ConfirmSignUpRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ConfirmSignUpRequest} obj Optional instance to populate.
     * @return {module:model/ConfirmSignUpRequest} The populated <code>ConfirmSignUpRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ConfirmSignUpRequest();
            ...
            if (data.hasOwnProperty('AnalyticsMetadata')) {
                obj['AnalyticsMetadata'] = ConfirmSignUpRequestAnalyticsMetadata.constructFromObject(data['AnalyticsMetadata']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ConfirmSignUpRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConfirmSignUpRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ConfirmSignUpRequest.RequiredProperties) {
        ...
        if (data['AnalyticsMetadata']) { // data not null
          ConfirmSignUpRequestAnalyticsMetadata.validateJSON(data['AnalyticsMetadata']);
        }
...
ConfirmSignUpRequest.RequiredProperties = ["ClientId", "Username", "ConfirmationCode"];

/**
 * @member {String} ClientId
 */
ConfirmSignUpRequest.prototype['ClientId'] = undefined;

/**
 * @member {String} SecretHash
 */
ConfirmSignUpRequest.prototype['SecretHash'] = undefined;

/**
 * @member {String} Username
 */
ConfirmSignUpRequest.prototype['Username'] = undefined;

/**
 * @member {String} ConfirmationCode
 */
ConfirmSignUpRequest.prototype['ConfirmationCode'] = undefined;

/**
 * @member {Boolean} ForceAliasCreation
 */
ConfirmSignUpRequest.prototype['ForceAliasCreation'] = undefined;

/**
 * @member {module:model/ConfirmSignUpRequestAnalyticsMetadata} AnalyticsMetadata
 */
ConfirmSignUpRequest.prototype['AnalyticsMetadata'] = undefined;

/**
 * @member {module:model/ConfirmForgotPasswordRequestUserContextData} UserContextData
 */
ConfirmSignUpRequest.prototype['UserContextData'] = undefined;

/**
 * @member {Object} ClientMetadata
 */
ConfirmSignUpRequest.prototype['ClientMetadata'] = undefined;
