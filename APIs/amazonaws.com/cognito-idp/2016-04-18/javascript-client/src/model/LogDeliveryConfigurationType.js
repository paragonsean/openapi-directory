...
/**
 * The LogDeliveryConfigurationType model module.
 * @module model/LogDeliveryConfigurationType
 * @version 2016-04-18
 */
class LogDeliveryConfigurationType {
    /**
     * Constructs a new <code>LogDeliveryConfigurationType</code>.
     * The logging parameters of a user pool.
     * @alias module:model/LogDeliveryConfigurationType
    ...
    /**
     * Constructs a <code>LogDeliveryConfigurationType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LogDeliveryConfigurationType} obj Optional instance to populate.
     * @return {module:model/LogDeliveryConfigurationType} The populated <code>LogDeliveryConfigurationType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LogDeliveryConfigurationType();
    ...
    /**
     * Validates the JSON data with respect to <code>LogDeliveryConfigurationType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LogDeliveryConfigurationType</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of LogDeliveryConfigurationType.RequiredProperties) {
...
LogDeliveryConfigurationType.RequiredProperties = ["UserPoolId", "LogConfigurations"];
...
export default LogDeliveryConfigurationType;
