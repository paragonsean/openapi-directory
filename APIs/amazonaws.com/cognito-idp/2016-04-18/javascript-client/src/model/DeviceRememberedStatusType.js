...
* @readonly
*/
export default class DeviceRememberedStatusType {
    ...
    /**
    * Returns a <code>DeviceRememberedStatusType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/DeviceRememberedStatusType} The enum <code>DeviceRememberedStatusType</code> value.
    */
