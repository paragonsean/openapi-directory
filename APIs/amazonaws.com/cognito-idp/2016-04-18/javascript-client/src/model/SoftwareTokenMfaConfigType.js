...
/**
 * The SoftwareTokenMfaConfigType model module.
 * @module model/SoftwareTokenMfaConfigType
 * @version 2016-04-18
 */
class SoftwareTokenMfaConfigType {
    /**
     * Constructs a new <code>SoftwareTokenMfaConfigType</code>.
     * The type used for enabling software token MFA at the user pool level.
     * @alias module:model/SoftwareTokenMfaConfigType
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>SoftwareTokenMfaConfigType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SoftwareTokenMfaConfigType} obj Optional instance to populate.
     * @return {module:model/SoftwareTokenMfaConfigType} The populated <code>SoftwareTokenMfaConfigType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SoftwareTokenMfaConfigType();
    ...
    /**
     * Validates the JSON data with respect to <code>SoftwareTokenMfaConfigType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SoftwareTokenMfaConfigType</code>.
     */
...
export default SoftwareTokenMfaConfigType;
