...
/**
 * The AdminForgetDeviceRequest model module.
 * @module model/AdminForgetDeviceRequest
 * @version 2016-04-18
 */
class AdminForgetDeviceRequest {
    /**
     * Constructs a new <code>AdminForgetDeviceRequest</code>.
     * Sends the forgot device request, as an administrator.
     * @alias module:model/AdminForgetDeviceRequest
     * @param userPoolId {String} 
     * @param username {String} 
     * @param deviceKey {String} 
     */
    constructor(userPoolId, username, deviceKey) { 
        
        AdminForgetDeviceRequest.initialize(this, userPoolId, username, deviceKey);
    }
     ...
     */
    static initialize(obj, userPoolId, username, deviceKey) { 
    ...
    /**
     * Constructs a <code>AdminForgetDeviceRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdminForgetDeviceRequest} obj Optional instance to populate.
     * @return {module:model/AdminForgetDeviceRequest} The populated <code>AdminForgetDeviceRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdminForgetDeviceRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>AdminForgetDeviceRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdminForgetDeviceRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AdminForgetDeviceRequest.RequiredProperties) {
...
AdminForgetDeviceRequest.RequiredProperties = ["UserPoolId", "Username", "DeviceKey"];

/**
 * @member {String} UserPoolId
 */
AdminForgetDeviceRequest.prototype['UserPoolId'] = undefined;

/**
 * @member {String} Username
 */
AdminForgetDeviceRequest.prototype['Username'] = undefined;

/**
 * @member {String} DeviceKey
 */
AdminForgetDeviceRequest.prototype['DeviceKey'] = undefined;
...
export default AdminForgetDeviceRequest;
