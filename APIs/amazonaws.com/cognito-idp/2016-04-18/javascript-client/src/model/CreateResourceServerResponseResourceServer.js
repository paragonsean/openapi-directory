...
/**
 * The CreateResourceServerResponseResourceServer model module.
 * @module model/CreateResourceServerResponseResourceServer
 * @version 2016-04-18
 */
class CreateResourceServerResponseResourceServer {
    /**
     * Constructs a new <code>CreateResourceServerResponseResourceServer</code>.
     * @alias module:model/CreateResourceServerResponseResourceServer
     * @implements module:model/ResourceServerType
     */
    constructor() { 
        ResourceServerType.initialize(this);
        CreateResourceServerResponseResourceServer.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateResourceServerResponseResourceServer</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateResourceServerResponseResourceServer} obj Optional instance to populate.
     * @return {module:model/CreateResourceServerResponseResourceServer} The populated <code>CreateResourceServerResponseResourceServer</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateResourceServerResponseResourceServer();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateResourceServerResponseResourceServer</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateResourceServerResponseResourceServer</code>.
     */
 ...
 */
CreateResourceServerResponseResourceServer.prototype['UserPoolId'] = undefined;

/**
 * @member {String} Identifier
 */
CreateResourceServerResponseResourceServer.prototype['Identifier'] = undefined;

/**
 * @member {String} Name
 */
CreateResourceServerResponseResourceServer.prototype['Name'] = undefined;

/**
 * @member {Array} Scopes
 */
CreateResourceServerResponseResourceServer.prototype['Scopes'] = undefined;
...
export default CreateResourceServerResponseResourceServer;
