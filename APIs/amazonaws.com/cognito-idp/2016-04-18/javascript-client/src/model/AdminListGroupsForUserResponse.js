...
/**
 * The AdminListGroupsForUserResponse model module.
 * @module model/AdminListGroupsForUserResponse
 * @version 2016-04-18
 */
class AdminListGroupsForUserResponse {
    /**
     * Constructs a new <code>AdminListGroupsForUserResponse</code>.
     * @alias module:model/AdminListGroupsForUserResponse
     */
    constructor() { 
        
        AdminListGroupsForUserResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AdminListGroupsForUserResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdminListGroupsForUserResponse} obj Optional instance to populate.
     * @return {module:model/AdminListGroupsForUserResponse} The populated <code>AdminListGroupsForUserResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdminListGroupsForUserResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>AdminListGroupsForUserResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdminListGroupsForUserResponse</code>.
     */
 ...
 * @member {Array} Groups
 */
AdminListGroupsForUserResponse.prototype['Groups'] = undefined;

/**
 * @member {String} NextToken
 */
AdminListGroupsForUserResponse.prototype['NextToken'] = undefined;
...
export default AdminListGroupsForUserResponse;
