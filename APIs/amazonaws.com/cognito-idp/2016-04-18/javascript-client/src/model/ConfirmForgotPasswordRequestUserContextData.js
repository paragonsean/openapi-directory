...
/**
 * The ConfirmForgotPasswordRequestUserContextData model module.
 * @module model/ConfirmForgotPasswordRequestUserContextData
 * @version 2016-04-18
 */
class ConfirmForgotPasswordRequestUserContextData {
    /**
     * Constructs a new <code>ConfirmForgotPasswordRequestUserContextData</code>.
     * @alias module:model/ConfirmForgotPasswordRequestUserContextData
     * @implements module:model/UserContextDataType
     */
    constructor() { 
        UserContextDataType.initialize(this);
        ConfirmForgotPasswordRequestUserContextData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ConfirmForgotPasswordRequestUserContextData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ConfirmForgotPasswordRequestUserContextData} obj Optional instance to populate.
     * @return {module:model/ConfirmForgotPasswordRequestUserContextData} The populated <code>ConfirmForgotPasswordRequestUserContextData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ConfirmForgotPasswordRequestUserContextData();
            UserContextDataType.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>ConfirmForgotPasswordRequestUserContextData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConfirmForgotPasswordRequestUserContextData</code>.
     */
 ...
 */
ConfirmForgotPasswordRequestUserContextData.prototype['IpAddress'] = undefined;

/**
 * @member {String} EncodedData
 */
ConfirmForgotPasswordRequestUserContextData.prototype['EncodedData'] = undefined;


// Implement UserContextDataType interface:
/**
 * @member {String} IpAddress
 */
...
export default ConfirmForgotPasswordRequestUserContextData;
