...
/**
 * The AdminDeleteUserRequest model module.
 * @module model/AdminDeleteUserRequest
 * @version 2016-04-18
 */
class AdminDeleteUserRequest {
    /**
     * Constructs a new <code>AdminDeleteUserRequest</code>.
     * Represents the request to delete a user as an administrator.
     * @alias module:model/AdminDeleteUserRequest
     * @param userPoolId {String} 
     * @param username {String} 
     */
    constructor(userPoolId, username) { 
        
        AdminDeleteUserRequest.initialize(this, userPoolId, username);
    }
    ...
    /**
     * Constructs a <code>AdminDeleteUserRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdminDeleteUserRequest} obj Optional instance to populate.
     * @return {module:model/AdminDeleteUserRequest} The populated <code>AdminDeleteUserRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdminDeleteUserRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>AdminDeleteUserRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdminDeleteUserRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AdminDeleteUserRequest.RequiredProperties) {
...
AdminDeleteUserRequest.RequiredProperties = ["UserPoolId", "Username"];

/**
 * @member {String} UserPoolId
 */
AdminDeleteUserRequest.prototype['UserPoolId'] = undefined;

/**
 * @member {String} Username
 */
AdminDeleteUserRequest.prototype['Username'] = undefined;
...
export default AdminDeleteUserRequest;
