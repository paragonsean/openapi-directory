...
/**
 * The AuthEventTypeEventFeedback model module.
 * @module model/AuthEventTypeEventFeedback
 * @version 2016-04-18
 */
class AuthEventTypeEventFeedback {
    /**
     * Constructs a new <code>AuthEventTypeEventFeedback</code>.
     * @alias module:model/AuthEventTypeEventFeedback
     * @implements module:model/EventFeedbackType
    ...
    constructor(feedbackValue, provider) { 
        ...
        AuthEventTypeEventFeedback.initialize(this, feedbackValue, provider);
    }
    ...
    /**
     * Constructs a <code>AuthEventTypeEventFeedback</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AuthEventTypeEventFeedback} obj Optional instance to populate.
     * @return {module:model/AuthEventTypeEventFeedback} The populated <code>AuthEventTypeEventFeedback</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AuthEventTypeEventFeedback();
            EventFeedbackType.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>AuthEventTypeEventFeedback</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AuthEventTypeEventFeedback</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AuthEventTypeEventFeedback.RequiredProperties) {
...
AuthEventTypeEventFeedback.RequiredProperties = ["FeedbackValue", "Provider"];

/**
 * @member {module:model/FeedbackValueType} FeedbackValue
 */
AuthEventTypeEventFeedback.prototype['FeedbackValue'] = undefined;

/**
 * @member {String} Provider
 */
AuthEventTypeEventFeedback.prototype['Provider'] = undefined;

/**
 * @member {Date} FeedbackDate
 */
AuthEventTypeEventFeedback.prototype['FeedbackDate'] = undefined;


// Implement EventFeedbackType interface:
/**
 * @member {module:model/FeedbackValueType} FeedbackValue
 */
...
export default AuthEventTypeEventFeedback;
