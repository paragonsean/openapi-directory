...
* @readonly
*/
export default class OAuthFlowType {
    ...
    /**
    * Returns a <code>OAuthFlowType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/OAuthFlowType} The enum <code>OAuthFlowType</code> value.
    */
