...
* @readonly
*/
export default class AuthFlowType {
        ...
        /**
         * value: "ADMIN_USER_PASSWORD_AUTH"
         * @const
         */
    ...
    /**
    * Returns a <code>AuthFlowType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/AuthFlowType} The enum <code>AuthFlowType</code> value.
    */
