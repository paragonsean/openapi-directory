...
class AttributeType {
    ...
    constructor(name) { 
        ...
        AttributeType.initialize(this, name);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AttributeType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AttributeType</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AttributeType.RequiredProperties) {
...
AttributeType.RequiredProperties = ["Name"];
 ...
 * @member {String} Value
 */
AttributeType.prototype['Value'] = undefined;
