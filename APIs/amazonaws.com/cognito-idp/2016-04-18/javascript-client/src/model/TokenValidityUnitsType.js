...
/**
 * The TokenValidityUnitsType model module.
 * @module model/TokenValidityUnitsType
 * @version 2016-04-18
 */
class TokenValidityUnitsType {
    /**
     * Constructs a new <code>TokenValidityUnitsType</code>.
     ...
     * @alias module:model/TokenValidityUnitsType
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>TokenValidityUnitsType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TokenValidityUnitsType} obj Optional instance to populate.
     * @return {module:model/TokenValidityUnitsType} The populated <code>TokenValidityUnitsType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TokenValidityUnitsType();
    ...
    /**
     * Validates the JSON data with respect to <code>TokenValidityUnitsType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TokenValidityUnitsType</code>.
     */
...
export default TokenValidityUnitsType;
