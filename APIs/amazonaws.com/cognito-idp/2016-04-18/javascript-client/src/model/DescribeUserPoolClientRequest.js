...
/**
 * The DescribeUserPoolClientRequest model module.
 * @module model/DescribeUserPoolClientRequest
 * @version 2016-04-18
 */
class DescribeUserPoolClientRequest {
    /**
     * Constructs a new <code>DescribeUserPoolClientRequest</code>.
     * Represents the request to describe a user pool client.
     * @alias module:model/DescribeUserPoolClientRequest
     * @param userPoolId {String} 
     * @param clientId {String} 
     */
    constructor(userPoolId, clientId) { 
        
        DescribeUserPoolClientRequest.initialize(this, userPoolId, clientId);
    }
    ...
    /**
     * Constructs a <code>DescribeUserPoolClientRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeUserPoolClientRequest} obj Optional instance to populate.
     * @return {module:model/DescribeUserPoolClientRequest} The populated <code>DescribeUserPoolClientRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeUserPoolClientRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeUserPoolClientRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeUserPoolClientRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeUserPoolClientRequest.RequiredProperties) {
...
DescribeUserPoolClientRequest.RequiredProperties = ["UserPoolId", "ClientId"];

/**
 * @member {String} UserPoolId
 */
DescribeUserPoolClientRequest.prototype['UserPoolId'] = undefined;

/**
 * @member {String} ClientId
 */
DescribeUserPoolClientRequest.prototype['ClientId'] = undefined;
...
export default DescribeUserPoolClientRequest;
