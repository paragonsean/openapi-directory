...
import DescribeRiskConfigurationResponseRiskConfiguration from './DescribeRiskConfigurationResponseRiskConfiguration';

/**
 * The DescribeRiskConfigurationResponse model module.
 * @module model/DescribeRiskConfigurationResponse
 * @version 2016-04-18
 */
class DescribeRiskConfigurationResponse {
    /**
     * Constructs a new <code>DescribeRiskConfigurationResponse</code>.
     * @alias module:model/DescribeRiskConfigurationResponse
     * @param riskConfiguration {module:model/DescribeRiskConfigurationResponseRiskConfiguration} 
     */
    constructor(riskConfiguration) { 
        
        DescribeRiskConfigurationResponse.initialize(this, riskConfiguration);
    }
     ...
     */
    static initialize(obj, riskConfiguration) { 
        obj['RiskConfiguration'] = riskConfiguration;
    }

    /**
     * Constructs a <code>DescribeRiskConfigurationResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeRiskConfigurationResponse} obj Optional instance to populate.
     * @return {module:model/DescribeRiskConfigurationResponse} The populated <code>DescribeRiskConfigurationResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeRiskConfigurationResponse();

            if (data.hasOwnProperty('RiskConfiguration')) {
                obj['RiskConfiguration'] = DescribeRiskConfigurationResponseRiskConfiguration.constructFromObject(data['RiskConfiguration']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeRiskConfigurationResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeRiskConfigurationResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeRiskConfigurationResponse.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `RiskConfiguration`
        if (data['RiskConfiguration']) { // data not null
          DescribeRiskConfigurationResponseRiskConfiguration.validateJSON(data['RiskConfiguration']);
        }
...
DescribeRiskConfigurationResponse.RequiredProperties = ["RiskConfiguration"];

/**
 * @member {module:model/DescribeRiskConfigurationResponseRiskConfiguration} RiskConfiguration
 */
DescribeRiskConfigurationResponse.prototype['RiskConfiguration'] = undefined;
...
export default DescribeRiskConfigurationResponse;
