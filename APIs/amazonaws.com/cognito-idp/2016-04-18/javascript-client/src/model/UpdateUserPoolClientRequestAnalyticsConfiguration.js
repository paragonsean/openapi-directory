...
/**
 * The UpdateUserPoolClientRequestAnalyticsConfiguration model module.
 * @module model/UpdateUserPoolClientRequestAnalyticsConfiguration
 * @version 2016-04-18
 */
class UpdateUserPoolClientRequestAnalyticsConfiguration {
    /**
     * Constructs a new <code>UpdateUserPoolClientRequestAnalyticsConfiguration</code>.
     * @alias module:model/UpdateUserPoolClientRequestAnalyticsConfiguration
     * @implements module:model/AnalyticsConfigurationType
     */
    constructor() { 
        AnalyticsConfigurationType.initialize(this);
        UpdateUserPoolClientRequestAnalyticsConfiguration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateUserPoolClientRequestAnalyticsConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateUserPoolClientRequestAnalyticsConfiguration} obj Optional instance to populate.
     * @return {module:model/UpdateUserPoolClientRequestAnalyticsConfiguration} The populated <code>UpdateUserPoolClientRequestAnalyticsConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateUserPoolClientRequestAnalyticsConfiguration();
            AnalyticsConfigurationType.constructFromObject(data, obj);
            ...
            if (data.hasOwnProperty('UserDataShared')) {
                obj['UserDataShared'] = ApiClient.convertToType(data['UserDataShared'], 'Boolean');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateUserPoolClientRequestAnalyticsConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateUserPoolClientRequestAnalyticsConfiguration</code>.
     */
    static validateJSON(data) {
        ...
        // validate the optional field `UserDataShared`
        if (data['UserDataShared']) { // data not null
          Boolean.validateJSON(data['UserDataShared']);
        }
 ...
 */
UpdateUserPoolClientRequestAnalyticsConfiguration.prototype['ApplicationId'] = undefined;

/**
 * @member {String} ApplicationArn
 */
UpdateUserPoolClientRequestAnalyticsConfiguration.prototype['ApplicationArn'] = undefined;

/**
 * @member {String} RoleArn
 */
UpdateUserPoolClientRequestAnalyticsConfiguration.prototype['RoleArn'] = undefined;

/**
 * @member {String} ExternalId
 */
UpdateUserPoolClientRequestAnalyticsConfiguration.prototype['ExternalId'] = undefined;

/**
 * @member {Boolean} UserDataShared
 */
UpdateUserPoolClientRequestAnalyticsConfiguration.prototype['UserDataShared'] = undefined;


// Implement AnalyticsConfigurationType interface:
/**
 * @member {String} ApplicationId
 */
AnalyticsConfigurationType.prototype['ApplicationId'] = undefined;
/**
 * @member {String} ApplicationArn
 */
AnalyticsConfigurationType.prototype['ApplicationArn'] = undefined;
/**
 * @member {String} RoleArn
 */
AnalyticsConfigurationType.prototype['RoleArn'] = undefined;
/**
 * @member {String} ExternalId
 */
AnalyticsConfigurationType.prototype['ExternalId'] = undefined;
/**
 * @member {Boolean} UserDataShared
 */
AnalyticsConfigurationType.prototype['UserDataShared'] = undefined;




export default UpdateUserPoolClientRequestAnalyticsConfiguration;
