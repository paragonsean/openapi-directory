...
/**
 * The AdminListUserAuthEventsRequest model module.
 * @module model/AdminListUserAuthEventsRequest
 * @version 2016-04-18
 */
class AdminListUserAuthEventsRequest {
    /**
     * Constructs a new <code>AdminListUserAuthEventsRequest</code>.
     * @alias module:model/AdminListUserAuthEventsRequest
     * @param userPoolId {String} 
     * @param username {String} 
     */
    constructor(userPoolId, username) { 
        
        AdminListUserAuthEventsRequest.initialize(this, userPoolId, username);
    }
    ...
    /**
     * Constructs a <code>AdminListUserAuthEventsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdminListUserAuthEventsRequest} obj Optional instance to populate.
     * @return {module:model/AdminListUserAuthEventsRequest} The populated <code>AdminListUserAuthEventsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdminListUserAuthEventsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>AdminListUserAuthEventsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdminListUserAuthEventsRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AdminListUserAuthEventsRequest.RequiredProperties) {
...
AdminListUserAuthEventsRequest.RequiredProperties = ["UserPoolId", "Username"];

/**
 * @member {String} UserPoolId
 */
AdminListUserAuthEventsRequest.prototype['UserPoolId'] = undefined;

/**
 * @member {String} Username
 */
AdminListUserAuthEventsRequest.prototype['Username'] = undefined;

/**
 * @member {Number} MaxResults
 */
AdminListUserAuthEventsRequest.prototype['MaxResults'] = undefined;

/**
 * @member {String} NextToken
 */
AdminListUserAuthEventsRequest.prototype['NextToken'] = undefined;
...
export default AdminListUserAuthEventsRequest;
