...
import AdminInitiateAuthResponseAuthenticationResult from './AdminInitiateAuthResponseAuthenticationResult';
import ChallengeNameType from './ChallengeNameType';

/**
 * The AdminInitiateAuthResponse model module.
 * @module model/AdminInitiateAuthResponse
 * @version 2016-04-18
 */
class AdminInitiateAuthResponse {
    /**
     * Constructs a new <code>AdminInitiateAuthResponse</code>.
     * Initiates the authentication response, as an administrator.
     * @alias module:model/AdminInitiateAuthResponse
     */
    constructor() { 
        
        AdminInitiateAuthResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AdminInitiateAuthResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdminInitiateAuthResponse} obj Optional instance to populate.
     * @return {module:model/AdminInitiateAuthResponse} The populated <code>AdminInitiateAuthResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdminInitiateAuthResponse();
            ...
            if (data.hasOwnProperty('AuthenticationResult')) {
                obj['AuthenticationResult'] = AdminInitiateAuthResponseAuthenticationResult.constructFromObject(data['AuthenticationResult']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AdminInitiateAuthResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdminInitiateAuthResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['AuthenticationResult']) { // data not null
          AdminInitiateAuthResponseAuthenticationResult.validateJSON(data['AuthenticationResult']);
        }
 ...
 */
AdminInitiateAuthResponse.prototype['ChallengeName'] = undefined;

/**
 * @member {String} Session
 */
AdminInitiateAuthResponse.prototype['Session'] = undefined;

/**
 * @member {Object} ChallengeParameters
 */
AdminInitiateAuthResponse.prototype['ChallengeParameters'] = undefined;

/**
 * @member {module:model/AdminInitiateAuthResponseAuthenticationResult} AuthenticationResult
 */
AdminInitiateAuthResponse.prototype['AuthenticationResult'] = undefined;
...
export default AdminInitiateAuthResponse;
