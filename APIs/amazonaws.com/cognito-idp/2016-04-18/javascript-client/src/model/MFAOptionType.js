...
/**
 * The MFAOptionType model module.
 * @module model/MFAOptionType
 * @version 2016-04-18
 */
class MFAOptionType {
    /**
     * Constructs a new <code>MFAOptionType</code>.
     ...
     * @alias module:model/MFAOptionType
     */
    constructor() { 
        
        MFAOptionType.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MFAOptionType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MFAOptionType} obj Optional instance to populate.
     * @return {module:model/MFAOptionType} The populated <code>MFAOptionType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MFAOptionType();
    ...
    /**
     * Validates the JSON data with respect to <code>MFAOptionType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MFAOptionType</code>.
     */
 ...
 */
MFAOptionType.prototype['DeliveryMedium'] = undefined;

/**
 * @member {String} AttributeName
 */
MFAOptionType.prototype['AttributeName'] = undefined;
