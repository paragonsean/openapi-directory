...
* @readonly
*/
export default class DeletionProtectionType {
    ...
    /**
    * Returns a <code>DeletionProtectionType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/DeletionProtectionType} The enum <code>DeletionProtectionType</code> value.
    */
