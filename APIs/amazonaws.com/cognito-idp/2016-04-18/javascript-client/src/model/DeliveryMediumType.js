...
* @readonly
*/
export default class DeliveryMediumType {
    ...
    /**
    * Returns a <code>DeliveryMediumType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/DeliveryMediumType} The enum <code>DeliveryMediumType</code> value.
    */
