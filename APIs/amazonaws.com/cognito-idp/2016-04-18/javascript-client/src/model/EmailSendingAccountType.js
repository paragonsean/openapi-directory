...
* @readonly
*/
export default class EmailSendingAccountType {
    ...
    /**
    * Returns a <code>EmailSendingAccountType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/EmailSendingAccountType} The enum <code>EmailSendingAccountType</code> value.
    */
