...
/**
 * The StopUserImportJobResponse model module.
 * @module model/StopUserImportJobResponse
 * @version 2016-04-18
 */
class StopUserImportJobResponse {
    /**
     * Constructs a new <code>StopUserImportJobResponse</code>.
     * Represents the response from the server to the request to stop the user import job.
     * @alias module:model/StopUserImportJobResponse
     */
    constructor() { 
        
        StopUserImportJobResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StopUserImportJobResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StopUserImportJobResponse} obj Optional instance to populate.
     * @return {module:model/StopUserImportJobResponse} The populated <code>StopUserImportJobResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StopUserImportJobResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>StopUserImportJobResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StopUserImportJobResponse</code>.
     */
 ...
 */
StopUserImportJobResponse.prototype['UserImportJob'] = undefined;
...
export default StopUserImportJobResponse;
