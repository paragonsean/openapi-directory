...
/**
 * The UserPoolAddOnsType model module.
 * @module model/UserPoolAddOnsType
 * @version 2016-04-18
 */
class UserPoolAddOnsType {
    /**
     * Constructs a new <code>UserPoolAddOnsType</code>.
     ...
     * @alias module:model/UserPoolAddOnsType
    ...
    /**
     * Constructs a <code>UserPoolAddOnsType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UserPoolAddOnsType} obj Optional instance to populate.
     * @return {module:model/UserPoolAddOnsType} The populated <code>UserPoolAddOnsType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UserPoolAddOnsType();
    ...
    /**
     * Validates the JSON data with respect to <code>UserPoolAddOnsType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UserPoolAddOnsType</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UserPoolAddOnsType.RequiredProperties) {
...
UserPoolAddOnsType.RequiredProperties = ["AdvancedSecurityMode"];
...
export default UserPoolAddOnsType;
