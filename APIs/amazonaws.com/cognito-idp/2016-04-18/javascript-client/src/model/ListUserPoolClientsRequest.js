...
/**
 * The ListUserPoolClientsRequest model module.
 * @module model/ListUserPoolClientsRequest
 * @version 2016-04-18
 */
class ListUserPoolClientsRequest {
    /**
     * Constructs a new <code>ListUserPoolClientsRequest</code>.
     * Represents the request to list the user pool clients.
     * @alias module:model/ListUserPoolClientsRequest
     * @param userPoolId {String} 
     */
    constructor(userPoolId) { 
        
        ListUserPoolClientsRequest.initialize(this, userPoolId);
    }
    ...
    /**
     * Constructs a <code>ListUserPoolClientsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListUserPoolClientsRequest} obj Optional instance to populate.
     * @return {module:model/ListUserPoolClientsRequest} The populated <code>ListUserPoolClientsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListUserPoolClientsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListUserPoolClientsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListUserPoolClientsRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListUserPoolClientsRequest.RequiredProperties) {
...
ListUserPoolClientsRequest.RequiredProperties = ["UserPoolId"];

/**
 * @member {String} UserPoolId
 */
ListUserPoolClientsRequest.prototype['UserPoolId'] = undefined;

/**
 * @member {Number} MaxResults
 */
ListUserPoolClientsRequest.prototype['MaxResults'] = undefined;

/**
 * @member {String} NextToken
 */
ListUserPoolClientsRequest.prototype['NextToken'] = undefined;
...
export default ListUserPoolClientsRequest;
