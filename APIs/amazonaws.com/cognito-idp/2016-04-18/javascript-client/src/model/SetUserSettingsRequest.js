...
/**
 * The SetUserSettingsRequest model module.
 * @module model/SetUserSettingsRequest
 * @version 2016-04-18
 */
class SetUserSettingsRequest {
    /**
     * Constructs a new <code>SetUserSettingsRequest</code>.
     * Represents the request to set user settings.
     * @alias module:model/SetUserSettingsRequest
     * @param accessToken {String} 
     * @param mFAOptions {Array} 
     */
    constructor(accessToken, mFAOptions) { 
        
        SetUserSettingsRequest.initialize(this, accessToken, mFAOptions);
    }
     ...
     */
    static initialize(obj, accessToken, mFAOptions) { 
        obj['AccessToken'] = accessToken;
        obj['MFAOptions'] = mFAOptions;
    }

    /**
     * Constructs a <code>SetUserSettingsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SetUserSettingsRequest} obj Optional instance to populate.
     * @return {module:model/SetUserSettingsRequest} The populated <code>SetUserSettingsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SetUserSettingsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>SetUserSettingsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SetUserSettingsRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SetUserSettingsRequest.RequiredProperties) {
...
SetUserSettingsRequest.RequiredProperties = ["AccessToken", "MFAOptions"];

/**
 * @member {String} AccessToken
 */
SetUserSettingsRequest.prototype['AccessToken'] = undefined;

/**
 * @member {Array} MFAOptions
 */
SetUserSettingsRequest.prototype['MFAOptions'] = undefined;
...
export default SetUserSettingsRequest;
