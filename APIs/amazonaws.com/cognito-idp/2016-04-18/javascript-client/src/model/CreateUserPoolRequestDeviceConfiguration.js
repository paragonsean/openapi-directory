...
/**
 * The CreateUserPoolRequestDeviceConfiguration model module.
 * @module model/CreateUserPoolRequestDeviceConfiguration
 * @version 2016-04-18
 */
class CreateUserPoolRequestDeviceConfiguration {
    /**
     * Constructs a new <code>CreateUserPoolRequestDeviceConfiguration</code>.
     * @alias module:model/CreateUserPoolRequestDeviceConfiguration
     * @implements module:model/DeviceConfigurationType
     */
    constructor() { 
        DeviceConfigurationType.initialize(this);
        CreateUserPoolRequestDeviceConfiguration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateUserPoolRequestDeviceConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateUserPoolRequestDeviceConfiguration} obj Optional instance to populate.
     * @return {module:model/CreateUserPoolRequestDeviceConfiguration} The populated <code>CreateUserPoolRequestDeviceConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateUserPoolRequestDeviceConfiguration();
            DeviceConfigurationType.constructFromObject(data, obj);

            if (data.hasOwnProperty('ChallengeRequiredOnNewDevice')) {
                obj['ChallengeRequiredOnNewDevice'] = ApiClient.convertToType(data['ChallengeRequiredOnNewDevice'], 'Boolean');
            }
            if (data.hasOwnProperty('DeviceOnlyRememberedOnUserPrompt')) {
                obj['DeviceOnlyRememberedOnUserPrompt'] = ApiClient.convertToType(data['DeviceOnlyRememberedOnUserPrompt'], 'Boolean');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateUserPoolRequestDeviceConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateUserPoolRequestDeviceConfiguration</code>.
     */
    static validateJSON(data) {
        // validate the optional field `ChallengeRequiredOnNewDevice`
        if (data['ChallengeRequiredOnNewDevice']) { // data not null
          Boolean.validateJSON(data['ChallengeRequiredOnNewDevice']);
        }
        // validate the optional field `DeviceOnlyRememberedOnUserPrompt`
        if (data['DeviceOnlyRememberedOnUserPrompt']) { // data not null
          Boolean.validateJSON(data['DeviceOnlyRememberedOnUserPrompt']);
        }
...
/**
 * @member {Boolean} ChallengeRequiredOnNewDevice
 */
CreateUserPoolRequestDeviceConfiguration.prototype['ChallengeRequiredOnNewDevice'] = undefined;

/**
 * @member {Boolean} DeviceOnlyRememberedOnUserPrompt
 */
CreateUserPoolRequestDeviceConfiguration.prototype['DeviceOnlyRememberedOnUserPrompt'] = undefined;


// Implement DeviceConfigurationType interface:
/**
 * @member {Boolean} ChallengeRequiredOnNewDevice
 */
DeviceConfigurationType.prototype['ChallengeRequiredOnNewDevice'] = undefined;
/**
 * @member {Boolean} DeviceOnlyRememberedOnUserPrompt
 */
DeviceConfigurationType.prototype['DeviceOnlyRememberedOnUserPrompt'] = undefined;




export default CreateUserPoolRequestDeviceConfiguration;
