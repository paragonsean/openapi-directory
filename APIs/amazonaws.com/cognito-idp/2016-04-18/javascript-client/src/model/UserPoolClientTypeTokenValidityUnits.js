...
/**
 * The UserPoolClientTypeTokenValidityUnits model module.
 * @module model/UserPoolClientTypeTokenValidityUnits
 * @version 2016-04-18
 */
class UserPoolClientTypeTokenValidityUnits {
    /**
     * Constructs a new <code>UserPoolClientTypeTokenValidityUnits</code>.
     * @alias module:model/UserPoolClientTypeTokenValidityUnits
     * @implements module:model/TokenValidityUnitsType
     */
    constructor() { 
        TokenValidityUnitsType.initialize(this);
        UserPoolClientTypeTokenValidityUnits.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UserPoolClientTypeTokenValidityUnits</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UserPoolClientTypeTokenValidityUnits} obj Optional instance to populate.
     * @return {module:model/UserPoolClientTypeTokenValidityUnits} The populated <code>UserPoolClientTypeTokenValidityUnits</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UserPoolClientTypeTokenValidityUnits();
    ...
    /**
     * Validates the JSON data with respect to <code>UserPoolClientTypeTokenValidityUnits</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UserPoolClientTypeTokenValidityUnits</code>.
     */
 ...
 */
UserPoolClientTypeTokenValidityUnits.prototype['AccessToken'] = undefined;

/**
 * @member {module:model/TimeUnitsType} IdToken
 */
UserPoolClientTypeTokenValidityUnits.prototype['IdToken'] = undefined;

/**
 * @member {module:model/TimeUnitsType} RefreshToken
 */
UserPoolClientTypeTokenValidityUnits.prototype['RefreshToken'] = undefined;
...
export default UserPoolClientTypeTokenValidityUnits;
