...
import AdminDisableProviderForUserRequestUser from './AdminDisableProviderForUserRequestUser';

/**
 * The AdminDisableProviderForUserRequest model module.
 * @module model/AdminDisableProviderForUserRequest
 * @version 2016-04-18
 */
class AdminDisableProviderForUserRequest {
    /**
     * Constructs a new <code>AdminDisableProviderForUserRequest</code>.
     * @alias module:model/AdminDisableProviderForUserRequest
     * @param userPoolId {String} 
     * @param user {module:model/AdminDisableProviderForUserRequestUser} 
     */
    constructor(userPoolId, user) { 
        
        AdminDisableProviderForUserRequest.initialize(this, userPoolId, user);
    }
     ...
     */
    static initialize(obj, userPoolId, user) { 
        obj['UserPoolId'] = userPoolId;
        obj['User'] = user;
    }

    /**
     * Constructs a <code>AdminDisableProviderForUserRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdminDisableProviderForUserRequest} obj Optional instance to populate.
     * @return {module:model/AdminDisableProviderForUserRequest} The populated <code>AdminDisableProviderForUserRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdminDisableProviderForUserRequest();

            if (data.hasOwnProperty('UserPoolId')) {
                obj['UserPoolId'] = ApiClient.convertToType(data['UserPoolId'], 'String');
            }
            if (data.hasOwnProperty('User')) {
                obj['User'] = AdminDisableProviderForUserRequestUser.constructFromObject(data['User']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AdminDisableProviderForUserRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdminDisableProviderForUserRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AdminDisableProviderForUserRequest.RequiredProperties) {
        ...
        if (data['User']) { // data not null
          AdminDisableProviderForUserRequestUser.validateJSON(data['User']);
        }
...
AdminDisableProviderForUserRequest.RequiredProperties = ["UserPoolId", "User"];

/**
 * @member {String} UserPoolId
 */
AdminDisableProviderForUserRequest.prototype['UserPoolId'] = undefined;

/**
 * @member {module:model/AdminDisableProviderForUserRequestUser} User
 */
AdminDisableProviderForUserRequest.prototype['User'] = undefined;
...
export default AdminDisableProviderForUserRequest;
