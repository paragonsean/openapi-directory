...
import AdminRespondToAuthChallengeRequestAnalyticsMetadata from './AdminRespondToAuthChallengeRequestAnalyticsMetadata';
import ChallengeNameType from './ChallengeNameType';

/**
 * The AdminRespondToAuthChallengeRequest model module.
 * @module model/AdminRespondToAuthChallengeRequest
 * @version 2016-04-18
 */
class AdminRespondToAuthChallengeRequest {
    /**
     * Constructs a new <code>AdminRespondToAuthChallengeRequest</code>.
     * The request to respond to the authentication challenge, as an administrator.
     * @alias module:model/AdminRespondToAuthChallengeRequest
     * @param userPoolId {String} 
     * @param clientId {String} 
     * @param challengeName {module:model/ChallengeNameType} 
     */
    constructor(userPoolId, clientId, challengeName) { 
        
        AdminRespondToAuthChallengeRequest.initialize(this, userPoolId, clientId, challengeName);
    }
     ...
     */
    static initialize(obj, userPoolId, clientId, challengeName) { 
    ...
    /**
     * Constructs a <code>AdminRespondToAuthChallengeRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdminRespondToAuthChallengeRequest} obj Optional instance to populate.
     * @return {module:model/AdminRespondToAuthChallengeRequest} The populated <code>AdminRespondToAuthChallengeRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdminRespondToAuthChallengeRequest();
            ...
            if (data.hasOwnProperty('AnalyticsMetadata')) {
                obj['AnalyticsMetadata'] = AdminRespondToAuthChallengeRequestAnalyticsMetadata.constructFromObject(data['AnalyticsMetadata']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>AdminRespondToAuthChallengeRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdminRespondToAuthChallengeRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AdminRespondToAuthChallengeRequest.RequiredProperties) {
        ...
        if (data['AnalyticsMetadata']) { // data not null
          AdminRespondToAuthChallengeRequestAnalyticsMetadata.validateJSON(data['AnalyticsMetadata']);
        }
...
AdminRespondToAuthChallengeRequest.RequiredProperties = ["UserPoolId", "ClientId", "ChallengeName"];

/**
 * @member {String} UserPoolId
 */
AdminRespondToAuthChallengeRequest.prototype['UserPoolId'] = undefined;

/**
 * @member {String} ClientId
 */
AdminRespondToAuthChallengeRequest.prototype['ClientId'] = undefined;

/**
 * @member {module:model/ChallengeNameType} ChallengeName
 */
AdminRespondToAuthChallengeRequest.prototype['ChallengeName'] = undefined;

/**
 * @member {Object} ChallengeResponses
 */
AdminRespondToAuthChallengeRequest.prototype['ChallengeResponses'] = undefined;

/**
 * @member {String} Session
 */
AdminRespondToAuthChallengeRequest.prototype['Session'] = undefined;

/**
 * @member {module:model/AdminRespondToAuthChallengeRequestAnalyticsMetadata} AnalyticsMetadata
 */
AdminRespondToAuthChallengeRequest.prototype['AnalyticsMetadata'] = undefined;

/**
 * @member {module:model/AdminInitiateAuthRequestContextData} ContextData
 */
AdminRespondToAuthChallengeRequest.prototype['ContextData'] = undefined;

/**
 * @member {Object} ClientMetadata
 */
AdminRespondToAuthChallengeRequest.prototype['ClientMetadata'] = undefined;
...
export default AdminRespondToAuthChallengeRequest;
