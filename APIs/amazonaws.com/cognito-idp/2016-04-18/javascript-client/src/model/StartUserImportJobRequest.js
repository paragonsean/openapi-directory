...
/**
 * The StartUserImportJobRequest model module.
 * @module model/StartUserImportJobRequest
 * @version 2016-04-18
 */
class StartUserImportJobRequest {
    /**
     * Constructs a new <code>StartUserImportJobRequest</code>.
     * Represents the request to start the user import job.
     * @alias module:model/StartUserImportJobRequest
     * @param userPoolId {String} 
     * @param jobId {String} 
     */
    constructor(userPoolId, jobId) { 
        
        StartUserImportJobRequest.initialize(this, userPoolId, jobId);
    }
     ...
     */
    static initialize(obj, userPoolId, jobId) { 
        obj['UserPoolId'] = userPoolId;
        obj['JobId'] = jobId;
    }

    /**
     * Constructs a <code>StartUserImportJobRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StartUserImportJobRequest} obj Optional instance to populate.
     * @return {module:model/StartUserImportJobRequest} The populated <code>StartUserImportJobRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StartUserImportJobRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>StartUserImportJobRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StartUserImportJobRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StartUserImportJobRequest.RequiredProperties) {
...
StartUserImportJobRequest.RequiredProperties = ["UserPoolId", "JobId"];

/**
 * @member {String} UserPoolId
 */
StartUserImportJobRequest.prototype['UserPoolId'] = undefined;

/**
 * @member {String} JobId
 */
StartUserImportJobRequest.prototype['JobId'] = undefined;
...
export default StartUserImportJobRequest;
