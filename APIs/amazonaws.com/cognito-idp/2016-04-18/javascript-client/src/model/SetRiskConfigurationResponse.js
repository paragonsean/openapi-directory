...
/**
 * The SetRiskConfigurationResponse model module.
 * @module model/SetRiskConfigurationResponse
 * @version 2016-04-18
 */
class SetRiskConfigurationResponse {
    /**
     * Constructs a new <code>SetRiskConfigurationResponse</code>.
     * @alias module:model/SetRiskConfigurationResponse
     * @param riskConfiguration {module:model/DescribeRiskConfigurationResponseRiskConfiguration} 
     */
    constructor(riskConfiguration) { 
        
        SetRiskConfigurationResponse.initialize(this, riskConfiguration);
    }
    ...
    /**
     * Constructs a <code>SetRiskConfigurationResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SetRiskConfigurationResponse} obj Optional instance to populate.
     * @return {module:model/SetRiskConfigurationResponse} The populated <code>SetRiskConfigurationResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SetRiskConfigurationResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>SetRiskConfigurationResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SetRiskConfigurationResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SetRiskConfigurationResponse.RequiredProperties) {
...
SetRiskConfigurationResponse.RequiredProperties = ["RiskConfiguration"];

/**
 * @member {module:model/DescribeRiskConfigurationResponseRiskConfiguration} RiskConfiguration
 */
SetRiskConfigurationResponse.prototype['RiskConfiguration'] = undefined;
...
export default SetRiskConfigurationResponse;
