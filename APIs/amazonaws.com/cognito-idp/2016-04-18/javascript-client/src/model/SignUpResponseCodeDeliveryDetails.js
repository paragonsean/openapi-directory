...
/**
 * The SignUpResponseCodeDeliveryDetails model module.
 * @module model/SignUpResponseCodeDeliveryDetails
 * @version 2016-04-18
 */
class SignUpResponseCodeDeliveryDetails {
    /**
     * Constructs a new <code>SignUpResponseCodeDeliveryDetails</code>.
     * @alias module:model/SignUpResponseCodeDeliveryDetails
     * @implements module:model/CodeDeliveryDetailsType
     */
    constructor() { 
        CodeDeliveryDetailsType.initialize(this);
        SignUpResponseCodeDeliveryDetails.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SignUpResponseCodeDeliveryDetails</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SignUpResponseCodeDeliveryDetails} obj Optional instance to populate.
     * @return {module:model/SignUpResponseCodeDeliveryDetails} The populated <code>SignUpResponseCodeDeliveryDetails</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SignUpResponseCodeDeliveryDetails();
    ...
    /**
     * Validates the JSON data with respect to <code>SignUpResponseCodeDeliveryDetails</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SignUpResponseCodeDeliveryDetails</code>.
     */
 ...
 */
SignUpResponseCodeDeliveryDetails.prototype['Destination'] = undefined;

/**
 * @member {module:model/DeliveryMediumType} DeliveryMedium
 */
SignUpResponseCodeDeliveryDetails.prototype['DeliveryMedium'] = undefined;

/**
 * @member {String} AttributeName
 */
SignUpResponseCodeDeliveryDetails.prototype['AttributeName'] = undefined;
...
export default SignUpResponseCodeDeliveryDetails;
