...
* @readonly
*/
export default class CustomSMSSenderLambdaVersionType {
    ...
    /**
    * Returns a <code>CustomSMSSenderLambdaVersionType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/CustomSMSSenderLambdaVersionType} The enum <code>CustomSMSSenderLambdaVersionType</code> value.
    */
