...
/**
 * The CreateIdentityProviderResponseIdentityProvider model module.
 * @module model/CreateIdentityProviderResponseIdentityProvider
 * @version 2016-04-18
 */
class CreateIdentityProviderResponseIdentityProvider {
    /**
     * Constructs a new <code>CreateIdentityProviderResponseIdentityProvider</code>.
     * @alias module:model/CreateIdentityProviderResponseIdentityProvider
     * @implements module:model/IdentityProviderType
     */
    constructor() { 
        IdentityProviderType.initialize(this);
        CreateIdentityProviderResponseIdentityProvider.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateIdentityProviderResponseIdentityProvider</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateIdentityProviderResponseIdentityProvider} obj Optional instance to populate.
     * @return {module:model/CreateIdentityProviderResponseIdentityProvider} The populated <code>CreateIdentityProviderResponseIdentityProvider</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateIdentityProviderResponseIdentityProvider();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateIdentityProviderResponseIdentityProvider</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateIdentityProviderResponseIdentityProvider</code>.
     */
 ...
 */
CreateIdentityProviderResponseIdentityProvider.prototype['UserPoolId'] = undefined;

/**
 * @member {String} ProviderName
 */
CreateIdentityProviderResponseIdentityProvider.prototype['ProviderName'] = undefined;

/**
 * @member {module:model/IdentityProviderTypeType} ProviderType
 */
CreateIdentityProviderResponseIdentityProvider.prototype['ProviderType'] = undefined;

/**
 * @member {Object} ProviderDetails
 */
CreateIdentityProviderResponseIdentityProvider.prototype['ProviderDetails'] = undefined;

/**
 * @member {Object} AttributeMapping
 */
CreateIdentityProviderResponseIdentityProvider.prototype['AttributeMapping'] = undefined;

/**
 * @member {Array} IdpIdentifiers
 */
CreateIdentityProviderResponseIdentityProvider.prototype['IdpIdentifiers'] = undefined;

/**
 * @member {Date} LastModifiedDate
 */
CreateIdentityProviderResponseIdentityProvider.prototype['LastModifiedDate'] = undefined;

/**
 * @member {Date} CreationDate
 */
CreateIdentityProviderResponseIdentityProvider.prototype['CreationDate'] = undefined;
...
export default CreateIdentityProviderResponseIdentityProvider;
