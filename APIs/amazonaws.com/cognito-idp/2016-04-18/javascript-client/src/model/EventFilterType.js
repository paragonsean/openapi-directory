...
* @readonly
*/
export default class EventFilterType {
    ...
    /**
    * Returns a <code>EventFilterType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/EventFilterType} The enum <code>EventFilterType</code> value.
    */
