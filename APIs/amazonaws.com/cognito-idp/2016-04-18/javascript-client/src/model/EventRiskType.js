...
/**
 * The EventRiskType model module.
 * @module model/EventRiskType
 * @version 2016-04-18
 */
class EventRiskType {
    /**
     * Constructs a new <code>EventRiskType</code>.
     * The event risk type.
     * @alias module:model/EventRiskType
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>EventRiskType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EventRiskType} obj Optional instance to populate.
     * @return {module:model/EventRiskType} The populated <code>EventRiskType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EventRiskType();
    ...
    /**
     * Validates the JSON data with respect to <code>EventRiskType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EventRiskType</code>.
     */
