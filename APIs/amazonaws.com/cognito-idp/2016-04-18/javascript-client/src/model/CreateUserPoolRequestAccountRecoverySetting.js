...
/**
 * The CreateUserPoolRequestAccountRecoverySetting model module.
 * @module model/CreateUserPoolRequestAccountRecoverySetting
 * @version 2016-04-18
 */
class CreateUserPoolRequestAccountRecoverySetting {
    /**
     * Constructs a new <code>CreateUserPoolRequestAccountRecoverySetting</code>.
     * @alias module:model/CreateUserPoolRequestAccountRecoverySetting
     * @implements module:model/AccountRecoverySettingType
     */
    constructor() { 
        AccountRecoverySettingType.initialize(this);
        CreateUserPoolRequestAccountRecoverySetting.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateUserPoolRequestAccountRecoverySetting</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateUserPoolRequestAccountRecoverySetting} obj Optional instance to populate.
     * @return {module:model/CreateUserPoolRequestAccountRecoverySetting} The populated <code>CreateUserPoolRequestAccountRecoverySetting</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateUserPoolRequestAccountRecoverySetting();
            AccountRecoverySettingType.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>CreateUserPoolRequestAccountRecoverySetting</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateUserPoolRequestAccountRecoverySetting</code>.
     */
 ...
 */
CreateUserPoolRequestAccountRecoverySetting.prototype['RecoveryMechanisms'] = undefined;


// Implement AccountRecoverySettingType interface:
/**
 * @member {Array} RecoveryMechanisms
 */
...
export default CreateUserPoolRequestAccountRecoverySetting;
