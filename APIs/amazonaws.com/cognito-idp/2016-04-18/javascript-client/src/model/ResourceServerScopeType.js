...
/**
 * The ResourceServerScopeType model module.
 * @module model/ResourceServerScopeType
 * @version 2016-04-18
 */
class ResourceServerScopeType {
    /**
     * Constructs a new <code>ResourceServerScopeType</code>.
     * A resource server scope.
     * @alias module:model/ResourceServerScopeType
     * @param scopeName {String} 
     * @param scopeDescription {String} 
     */
    constructor(scopeName, scopeDescription) { 
        
        ResourceServerScopeType.initialize(this, scopeName, scopeDescription);
    }
     ...
     */
    static initialize(obj, scopeName, scopeDescription) { 
        obj['ScopeName'] = scopeName;
        obj['ScopeDescription'] = scopeDescription;
    }

    /**
     * Constructs a <code>ResourceServerScopeType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ResourceServerScopeType} obj Optional instance to populate.
     * @return {module:model/ResourceServerScopeType} The populated <code>ResourceServerScopeType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ResourceServerScopeType();

            if (data.hasOwnProperty('ScopeName')) {
                obj['ScopeName'] = ApiClient.convertToType(data['ScopeName'], 'String');
            }
            if (data.hasOwnProperty('ScopeDescription')) {
                obj['ScopeDescription'] = ApiClient.convertToType(data['ScopeDescription'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ResourceServerScopeType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ResourceServerScopeType</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ResourceServerScopeType.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `ScopeName`
        if (data['ScopeName']) { // data not null
          String.validateJSON(data['ScopeName']);
        }
        // validate the optional field `ScopeDescription`
        if (data['ScopeDescription']) { // data not null
          String.validateJSON(data['ScopeDescription']);
        }
...
ResourceServerScopeType.RequiredProperties = ["ScopeName", "ScopeDescription"];

/**
 * @member {String} ScopeName
 */
ResourceServerScopeType.prototype['ScopeName'] = undefined;

/**
 * @member {String} ScopeDescription
 */
ResourceServerScopeType.prototype['ScopeDescription'] = undefined;
...
export default ResourceServerScopeType;
