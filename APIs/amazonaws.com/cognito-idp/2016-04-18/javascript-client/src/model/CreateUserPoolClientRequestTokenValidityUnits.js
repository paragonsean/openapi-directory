...
/**
 * The CreateUserPoolClientRequestTokenValidityUnits model module.
 * @module model/CreateUserPoolClientRequestTokenValidityUnits
 * @version 2016-04-18
 */
class CreateUserPoolClientRequestTokenValidityUnits {
    /**
     * Constructs a new <code>CreateUserPoolClientRequestTokenValidityUnits</code>.
     * @alias module:model/CreateUserPoolClientRequestTokenValidityUnits
     * @implements module:model/TokenValidityUnitsType
     */
    constructor() { 
        TokenValidityUnitsType.initialize(this);
        CreateUserPoolClientRequestTokenValidityUnits.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateUserPoolClientRequestTokenValidityUnits</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateUserPoolClientRequestTokenValidityUnits} obj Optional instance to populate.
     * @return {module:model/CreateUserPoolClientRequestTokenValidityUnits} The populated <code>CreateUserPoolClientRequestTokenValidityUnits</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateUserPoolClientRequestTokenValidityUnits();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateUserPoolClientRequestTokenValidityUnits</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateUserPoolClientRequestTokenValidityUnits</code>.
     */
 ...
 */
CreateUserPoolClientRequestTokenValidityUnits.prototype['AccessToken'] = undefined;

/**
 * @member {module:model/TimeUnitsType} IdToken
 */
CreateUserPoolClientRequestTokenValidityUnits.prototype['IdToken'] = undefined;

/**
 * @member {module:model/TimeUnitsType} RefreshToken
 */
CreateUserPoolClientRequestTokenValidityUnits.prototype['RefreshToken'] = undefined;
...
export default CreateUserPoolClientRequestTokenValidityUnits;
