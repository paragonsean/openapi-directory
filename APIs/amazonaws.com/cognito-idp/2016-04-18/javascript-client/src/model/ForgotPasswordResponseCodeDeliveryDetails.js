...
/**
 * The ForgotPasswordResponseCodeDeliveryDetails model module.
 * @module model/ForgotPasswordResponseCodeDeliveryDetails
 * @version 2016-04-18
 */
class ForgotPasswordResponseCodeDeliveryDetails {
    /**
     * Constructs a new <code>ForgotPasswordResponseCodeDeliveryDetails</code>.
     * @alias module:model/ForgotPasswordResponseCodeDeliveryDetails
     * @implements module:model/CodeDeliveryDetailsType
     */
    constructor() { 
        CodeDeliveryDetailsType.initialize(this);
        ForgotPasswordResponseCodeDeliveryDetails.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ForgotPasswordResponseCodeDeliveryDetails</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ForgotPasswordResponseCodeDeliveryDetails} obj Optional instance to populate.
     * @return {module:model/ForgotPasswordResponseCodeDeliveryDetails} The populated <code>ForgotPasswordResponseCodeDeliveryDetails</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ForgotPasswordResponseCodeDeliveryDetails();
    ...
    /**
     * Validates the JSON data with respect to <code>ForgotPasswordResponseCodeDeliveryDetails</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ForgotPasswordResponseCodeDeliveryDetails</code>.
     */
 ...
 */
ForgotPasswordResponseCodeDeliveryDetails.prototype['Destination'] = undefined;

/**
 * @member {module:model/DeliveryMediumType} DeliveryMedium
 */
ForgotPasswordResponseCodeDeliveryDetails.prototype['DeliveryMedium'] = undefined;

/**
 * @member {String} AttributeName
 */
ForgotPasswordResponseCodeDeliveryDetails.prototype['AttributeName'] = undefined;
...
export default ForgotPasswordResponseCodeDeliveryDetails;
