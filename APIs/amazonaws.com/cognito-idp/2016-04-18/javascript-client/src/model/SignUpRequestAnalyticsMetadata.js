...
/**
 * The SignUpRequestAnalyticsMetadata model module.
 * @module model/SignUpRequestAnalyticsMetadata
 * @version 2016-04-18
 */
class SignUpRequestAnalyticsMetadata {
    /**
     * Constructs a new <code>SignUpRequestAnalyticsMetadata</code>.
     * @alias module:model/SignUpRequestAnalyticsMetadata
     * @implements module:model/AnalyticsMetadataType
     */
    constructor() { 
        AnalyticsMetadataType.initialize(this);
        SignUpRequestAnalyticsMetadata.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SignUpRequestAnalyticsMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SignUpRequestAnalyticsMetadata} obj Optional instance to populate.
     * @return {module:model/SignUpRequestAnalyticsMetadata} The populated <code>SignUpRequestAnalyticsMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SignUpRequestAnalyticsMetadata();
    ...
    /**
     * Validates the JSON data with respect to <code>SignUpRequestAnalyticsMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SignUpRequestAnalyticsMetadata</code>.
     */
 ...
 */
SignUpRequestAnalyticsMetadata.prototype['AnalyticsEndpointId'] = undefined;
...
export default SignUpRequestAnalyticsMetadata;
