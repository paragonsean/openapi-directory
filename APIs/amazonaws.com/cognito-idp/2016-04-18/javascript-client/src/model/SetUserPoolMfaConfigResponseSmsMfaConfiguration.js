...
import SmsMfaConfigTypeSmsConfiguration from './SmsMfaConfigTypeSmsConfiguration';

/**
 * The SetUserPoolMfaConfigResponseSmsMfaConfiguration model module.
 * @module model/SetUserPoolMfaConfigResponseSmsMfaConfiguration
 * @version 2016-04-18
 */
class SetUserPoolMfaConfigResponseSmsMfaConfiguration {
    /**
     * Constructs a new <code>SetUserPoolMfaConfigResponseSmsMfaConfiguration</code>.
     * @alias module:model/SetUserPoolMfaConfigResponseSmsMfaConfiguration
     * @implements module:model/SmsMfaConfigType
     */
    constructor() { 
        SmsMfaConfigType.initialize(this);
        SetUserPoolMfaConfigResponseSmsMfaConfiguration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SetUserPoolMfaConfigResponseSmsMfaConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SetUserPoolMfaConfigResponseSmsMfaConfiguration} obj Optional instance to populate.
     * @return {module:model/SetUserPoolMfaConfigResponseSmsMfaConfiguration} The populated <code>SetUserPoolMfaConfigResponseSmsMfaConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SetUserPoolMfaConfigResponseSmsMfaConfiguration();
            SmsMfaConfigType.constructFromObject(data, obj);
            ...
            if (data.hasOwnProperty('SmsConfiguration')) {
                obj['SmsConfiguration'] = SmsMfaConfigTypeSmsConfiguration.constructFromObject(data['SmsConfiguration']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>SetUserPoolMfaConfigResponseSmsMfaConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SetUserPoolMfaConfigResponseSmsMfaConfiguration</code>.
     */
    static validateJSON(data) {
        ...
        if (data['SmsConfiguration']) { // data not null
          SmsMfaConfigTypeSmsConfiguration.validateJSON(data['SmsConfiguration']);
        }
 ...
 */
SetUserPoolMfaConfigResponseSmsMfaConfiguration.prototype['SmsAuthenticationMessage'] = undefined;

/**
 * @member {module:model/SmsMfaConfigTypeSmsConfiguration} SmsConfiguration
 */
SetUserPoolMfaConfigResponseSmsMfaConfiguration.prototype['SmsConfiguration'] = undefined;


// Implement SmsMfaConfigType interface:
/**
 * @member {String} SmsAuthenticationMessage
 */
SmsMfaConfigType.prototype['SmsAuthenticationMessage'] = undefined;
/**
 * @member {module:model/SmsMfaConfigTypeSmsConfiguration} SmsConfiguration
 */
SmsMfaConfigType.prototype['SmsConfiguration'] = undefined;




export default SetUserPoolMfaConfigResponseSmsMfaConfiguration;
