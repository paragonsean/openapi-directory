...
/**
 * The CreateUserPoolRequestUserAttributeUpdateSettings model module.
 * @module model/CreateUserPoolRequestUserAttributeUpdateSettings
 * @version 2016-04-18
 */
class CreateUserPoolRequestUserAttributeUpdateSettings {
    /**
     * Constructs a new <code>CreateUserPoolRequestUserAttributeUpdateSettings</code>.
     * @alias module:model/CreateUserPoolRequestUserAttributeUpdateSettings
     * @implements module:model/UserAttributeUpdateSettingsType
     */
    constructor() { 
        UserAttributeUpdateSettingsType.initialize(this);
        CreateUserPoolRequestUserAttributeUpdateSettings.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateUserPoolRequestUserAttributeUpdateSettings</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateUserPoolRequestUserAttributeUpdateSettings} obj Optional instance to populate.
     * @return {module:model/CreateUserPoolRequestUserAttributeUpdateSettings} The populated <code>CreateUserPoolRequestUserAttributeUpdateSettings</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateUserPoolRequestUserAttributeUpdateSettings();
            UserAttributeUpdateSettingsType.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>CreateUserPoolRequestUserAttributeUpdateSettings</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateUserPoolRequestUserAttributeUpdateSettings</code>.
     */
 ...
 */
CreateUserPoolRequestUserAttributeUpdateSettings.prototype['AttributesRequireVerificationBeforeUpdate'] = undefined;


// Implement UserAttributeUpdateSettingsType interface:
/**
 * @member {Array} AttributesRequireVerificationBeforeUpdate
 */
...
export default CreateUserPoolRequestUserAttributeUpdateSettings;
