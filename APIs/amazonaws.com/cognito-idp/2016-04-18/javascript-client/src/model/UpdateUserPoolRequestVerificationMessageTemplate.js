...
/**
 * The UpdateUserPoolRequestVerificationMessageTemplate model module.
 * @module model/UpdateUserPoolRequestVerificationMessageTemplate
 * @version 2016-04-18
 */
class UpdateUserPoolRequestVerificationMessageTemplate {
    /**
     * Constructs a new <code>UpdateUserPoolRequestVerificationMessageTemplate</code>.
     * @alias module:model/UpdateUserPoolRequestVerificationMessageTemplate
     * @implements module:model/VerificationMessageTemplateType
     */
    constructor() { 
        VerificationMessageTemplateType.initialize(this);
        UpdateUserPoolRequestVerificationMessageTemplate.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateUserPoolRequestVerificationMessageTemplate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateUserPoolRequestVerificationMessageTemplate} obj Optional instance to populate.
     * @return {module:model/UpdateUserPoolRequestVerificationMessageTemplate} The populated <code>UpdateUserPoolRequestVerificationMessageTemplate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateUserPoolRequestVerificationMessageTemplate();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateUserPoolRequestVerificationMessageTemplate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateUserPoolRequestVerificationMessageTemplate</code>.
     */
 ...
 */
UpdateUserPoolRequestVerificationMessageTemplate.prototype['SmsMessage'] = undefined;

/**
 * @member {String} EmailMessage
 */
UpdateUserPoolRequestVerificationMessageTemplate.prototype['EmailMessage'] = undefined;

/**
 * @member {String} EmailSubject
 */
UpdateUserPoolRequestVerificationMessageTemplate.prototype['EmailSubject'] = undefined;

/**
 * @member {String} EmailMessageByLink
 */
UpdateUserPoolRequestVerificationMessageTemplate.prototype['EmailMessageByLink'] = undefined;

/**
 * @member {String} EmailSubjectByLink
 */
UpdateUserPoolRequestVerificationMessageTemplate.prototype['EmailSubjectByLink'] = undefined;

/**
 * @member {module:model/DefaultEmailOptionType} DefaultEmailOption
 */
UpdateUserPoolRequestVerificationMessageTemplate.prototype['DefaultEmailOption'] = undefined;
...
export default UpdateUserPoolRequestVerificationMessageTemplate;
