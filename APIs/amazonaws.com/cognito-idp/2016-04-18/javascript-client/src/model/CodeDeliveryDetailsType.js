...
/**
 * The CodeDeliveryDetailsType model module.
 * @module model/CodeDeliveryDetailsType
 * @version 2016-04-18
 */
class CodeDeliveryDetailsType {
    /**
     * Constructs a new <code>CodeDeliveryDetailsType</code>.
     * The delivery details for an email or SMS message that Amazon Cognito sent for authentication or verification.
     * @alias module:model/CodeDeliveryDetailsType
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>CodeDeliveryDetailsType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CodeDeliveryDetailsType} obj Optional instance to populate.
     * @return {module:model/CodeDeliveryDetailsType} The populated <code>CodeDeliveryDetailsType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CodeDeliveryDetailsType();
    ...
    /**
     * Validates the JSON data with respect to <code>CodeDeliveryDetailsType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CodeDeliveryDetailsType</code>.
     */
...
export default CodeDeliveryDetailsType;
