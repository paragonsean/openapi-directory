...
/**
 * The SmsMfaConfigType model module.
 * @module model/SmsMfaConfigType
 * @version 2016-04-18
 */
class SmsMfaConfigType {
    /**
     * Constructs a new <code>SmsMfaConfigType</code>.
     * The SMS text message multi-factor authentication (MFA) configuration type.
     * @alias module:model/SmsMfaConfigType
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>SmsMfaConfigType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SmsMfaConfigType} obj Optional instance to populate.
     * @return {module:model/SmsMfaConfigType} The populated <code>SmsMfaConfigType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SmsMfaConfigType();
    ...
    /**
     * Validates the JSON data with respect to <code>SmsMfaConfigType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SmsMfaConfigType</code>.
     */
...
export default SmsMfaConfigType;
