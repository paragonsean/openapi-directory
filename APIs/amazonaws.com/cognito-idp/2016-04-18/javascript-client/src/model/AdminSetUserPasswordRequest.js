...
/**
 * The AdminSetUserPasswordRequest model module.
 * @module model/AdminSetUserPasswordRequest
 * @version 2016-04-18
 */
class AdminSetUserPasswordRequest {
    /**
     * Constructs a new <code>AdminSetUserPasswordRequest</code>.
     * @alias module:model/AdminSetUserPasswordRequest
     * @param userPoolId {String} 
     * @param username {String} 
     * @param password {String} 
     */
    constructor(userPoolId, username, password) { 
        
        AdminSetUserPasswordRequest.initialize(this, userPoolId, username, password);
    }
     ...
     */
    static initialize(obj, userPoolId, username, password) { 
    ...
    /**
     * Constructs a <code>AdminSetUserPasswordRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdminSetUserPasswordRequest} obj Optional instance to populate.
     * @return {module:model/AdminSetUserPasswordRequest} The populated <code>AdminSetUserPasswordRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdminSetUserPasswordRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>AdminSetUserPasswordRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdminSetUserPasswordRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AdminSetUserPasswordRequest.RequiredProperties) {
        ...
        if (data['Permanent']) { // data not null
          Boolean.validateJSON(data['Permanent']);
        }
...
AdminSetUserPasswordRequest.RequiredProperties = ["UserPoolId", "Username", "Password"];

/**
 * @member {String} UserPoolId
 */
AdminSetUserPasswordRequest.prototype['UserPoolId'] = undefined;

/**
 * @member {String} Username
 */
AdminSetUserPasswordRequest.prototype['Username'] = undefined;

/**
 * @member {String} Password
 */
AdminSetUserPasswordRequest.prototype['Password'] = undefined;

/**
 * @member {Boolean} Permanent
 */
AdminSetUserPasswordRequest.prototype['Permanent'] = undefined;
...
export default AdminSetUserPasswordRequest;
