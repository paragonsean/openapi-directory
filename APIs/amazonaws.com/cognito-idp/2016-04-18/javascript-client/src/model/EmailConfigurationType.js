...
/**
 * The EmailConfigurationType model module.
 * @module model/EmailConfigurationType
 * @version 2016-04-18
 */
class EmailConfigurationType {
    /**
     * Constructs a new <code>EmailConfigurationType</code>.
     ...
     * @alias module:model/EmailConfigurationType
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>EmailConfigurationType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EmailConfigurationType} obj Optional instance to populate.
     * @return {module:model/EmailConfigurationType} The populated <code>EmailConfigurationType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EmailConfigurationType();
    ...
    /**
     * Validates the JSON data with respect to <code>EmailConfigurationType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EmailConfigurationType</code>.
     */
...
export default EmailConfigurationType;
