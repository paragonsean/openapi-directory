...
* @readonly
*/
export default class MessageActionType {
    ...
    /**
    * Returns a <code>MessageActionType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/MessageActionType} The enum <code>MessageActionType</code> value.
    */
