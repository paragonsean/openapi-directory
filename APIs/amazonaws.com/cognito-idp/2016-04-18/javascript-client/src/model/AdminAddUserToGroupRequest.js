...
/**
 * The AdminAddUserToGroupRequest model module.
 * @module model/AdminAddUserToGroupRequest
 * @version 2016-04-18
 */
class AdminAddUserToGroupRequest {
    /**
     * Constructs a new <code>AdminAddUserToGroupRequest</code>.
     * @alias module:model/AdminAddUserToGroupRequest
     * @param userPoolId {String} 
     * @param username {String} 
     * @param groupName {String} 
     */
    constructor(userPoolId, username, groupName) { 
        
        AdminAddUserToGroupRequest.initialize(this, userPoolId, username, groupName);
    }
     ...
     */
    static initialize(obj, userPoolId, username, groupName) { 
    ...
    /**
     * Constructs a <code>AdminAddUserToGroupRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdminAddUserToGroupRequest} obj Optional instance to populate.
     * @return {module:model/AdminAddUserToGroupRequest} The populated <code>AdminAddUserToGroupRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdminAddUserToGroupRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>AdminAddUserToGroupRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdminAddUserToGroupRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AdminAddUserToGroupRequest.RequiredProperties) {
...
AdminAddUserToGroupRequest.RequiredProperties = ["UserPoolId", "Username", "GroupName"];

/**
 * @member {String} UserPoolId
 */
AdminAddUserToGroupRequest.prototype['UserPoolId'] = undefined;

/**
 * @member {String} Username
 */
AdminAddUserToGroupRequest.prototype['Username'] = undefined;

/**
 * @member {String} GroupName
 */
AdminAddUserToGroupRequest.prototype['GroupName'] = undefined;
...
export default AdminAddUserToGroupRequest;
