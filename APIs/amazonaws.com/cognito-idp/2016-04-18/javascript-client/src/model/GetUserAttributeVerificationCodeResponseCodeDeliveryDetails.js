...
import DeliveryMediumType from './DeliveryMediumType';

/**
 * The GetUserAttributeVerificationCodeResponseCodeDeliveryDetails model module.
 * @module model/GetUserAttributeVerificationCodeResponseCodeDeliveryDetails
 * @version 2016-04-18
 */
class GetUserAttributeVerificationCodeResponseCodeDeliveryDetails {
    /**
     * Constructs a new <code>GetUserAttributeVerificationCodeResponseCodeDeliveryDetails</code>.
     * @alias module:model/GetUserAttributeVerificationCodeResponseCodeDeliveryDetails
     * @implements module:model/CodeDeliveryDetailsType
     */
    constructor() { 
        CodeDeliveryDetailsType.initialize(this);
        GetUserAttributeVerificationCodeResponseCodeDeliveryDetails.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetUserAttributeVerificationCodeResponseCodeDeliveryDetails</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetUserAttributeVerificationCodeResponseCodeDeliveryDetails} obj Optional instance to populate.
     * @return {module:model/GetUserAttributeVerificationCodeResponseCodeDeliveryDetails} The populated <code>GetUserAttributeVerificationCodeResponseCodeDeliveryDetails</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetUserAttributeVerificationCodeResponseCodeDeliveryDetails();
            CodeDeliveryDetailsType.constructFromObject(data, obj);

            if (data.hasOwnProperty('Destination')) {
                obj['Destination'] = ApiClient.convertToType(data['Destination'], 'String');
            }
            if (data.hasOwnProperty('DeliveryMedium')) {
                obj['DeliveryMedium'] = ApiClient.convertToType(data['DeliveryMedium'], DeliveryMediumType);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GetUserAttributeVerificationCodeResponseCodeDeliveryDetails</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetUserAttributeVerificationCodeResponseCodeDeliveryDetails</code>.
     */
    static validateJSON(data) {
        ...
        if (data['DeliveryMedium']) { // data not null
          DeliveryMediumType.validateJSON(data['DeliveryMedium']);
        }
 ...
 */
GetUserAttributeVerificationCodeResponseCodeDeliveryDetails.prototype['Destination'] = undefined;

/**
 * @member {module:model/DeliveryMediumType} DeliveryMedium
 */
GetUserAttributeVerificationCodeResponseCodeDeliveryDetails.prototype['DeliveryMedium'] = undefined;

/**
 * @member {String} AttributeName
 */
GetUserAttributeVerificationCodeResponseCodeDeliveryDetails.prototype['AttributeName'] = undefined;


// Implement CodeDeliveryDetailsType interface:
/**
 * @member {String} Destination
 */
CodeDeliveryDetailsType.prototype['Destination'] = undefined;
/**
 * @member {module:model/DeliveryMediumType} DeliveryMedium
 */
CodeDeliveryDetailsType.prototype['DeliveryMedium'] = undefined;
/**
 * @member {String} AttributeName
 */
CodeDeliveryDetailsType.prototype['AttributeName'] = undefined;




export default GetUserAttributeVerificationCodeResponseCodeDeliveryDetails;
