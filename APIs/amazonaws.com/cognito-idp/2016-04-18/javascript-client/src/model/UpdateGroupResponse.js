...
import CreateGroupResponseGroup from './CreateGroupResponseGroup';

/**
 * The UpdateGroupResponse model module.
 * @module model/UpdateGroupResponse
 * @version 2016-04-18
 */
class UpdateGroupResponse {
    /**
     * Constructs a new <code>UpdateGroupResponse</code>.
     * @alias module:model/UpdateGroupResponse
     */
    constructor() { 
        
        UpdateGroupResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateGroupResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateGroupResponse} obj Optional instance to populate.
     * @return {module:model/UpdateGroupResponse} The populated <code>UpdateGroupResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateGroupResponse();

            if (data.hasOwnProperty('Group')) {
                obj['Group'] = CreateGroupResponseGroup.constructFromObject(data['Group']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateGroupResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateGroupResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Group`
        if (data['Group']) { // data not null
          CreateGroupResponseGroup.validateJSON(data['Group']);
        }
...
/**
 * @member {module:model/CreateGroupResponseGroup} Group
 */
UpdateGroupResponse.prototype['Group'] = undefined;
