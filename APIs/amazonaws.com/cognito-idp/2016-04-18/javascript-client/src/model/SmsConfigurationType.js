...
/**
 * The SmsConfigurationType model module.
 * @module model/SmsConfigurationType
 * @version 2016-04-18
 */
class SmsConfigurationType {
    /**
     * Constructs a new <code>SmsConfigurationType</code>.
     ...
     * @alias module:model/SmsConfigurationType
    ...
    /**
     * Constructs a <code>SmsConfigurationType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SmsConfigurationType} obj Optional instance to populate.
     * @return {module:model/SmsConfigurationType} The populated <code>SmsConfigurationType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SmsConfigurationType();
    ...
    /**
     * Validates the JSON data with respect to <code>SmsConfigurationType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SmsConfigurationType</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SmsConfigurationType.RequiredProperties) {
...
SmsConfigurationType.RequiredProperties = ["SnsCallerArn"];
...
export default SmsConfigurationType;
