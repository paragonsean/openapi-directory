...
/**
 * The ForgotPasswordRequestAnalyticsMetadata model module.
 * @module model/ForgotPasswordRequestAnalyticsMetadata
 * @version 2016-04-18
 */
class ForgotPasswordRequestAnalyticsMetadata {
    /**
     * Constructs a new <code>ForgotPasswordRequestAnalyticsMetadata</code>.
     * @alias module:model/ForgotPasswordRequestAnalyticsMetadata
     * @implements module:model/AnalyticsMetadataType
     */
    constructor() { 
        AnalyticsMetadataType.initialize(this);
        ForgotPasswordRequestAnalyticsMetadata.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ForgotPasswordRequestAnalyticsMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ForgotPasswordRequestAnalyticsMetadata} obj Optional instance to populate.
     * @return {module:model/ForgotPasswordRequestAnalyticsMetadata} The populated <code>ForgotPasswordRequestAnalyticsMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ForgotPasswordRequestAnalyticsMetadata();
    ...
    /**
     * Validates the JSON data with respect to <code>ForgotPasswordRequestAnalyticsMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ForgotPasswordRequestAnalyticsMetadata</code>.
     */
 ...
 */
ForgotPasswordRequestAnalyticsMetadata.prototype['AnalyticsEndpointId'] = undefined;
...
export default ForgotPasswordRequestAnalyticsMetadata;
