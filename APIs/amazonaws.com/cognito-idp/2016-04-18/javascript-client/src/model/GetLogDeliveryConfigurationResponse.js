...
import GetLogDeliveryConfigurationResponseLogDeliveryConfiguration from './GetLogDeliveryConfigurationResponseLogDeliveryConfiguration';

/**
 * The GetLogDeliveryConfigurationResponse model module.
 * @module model/GetLogDeliveryConfigurationResponse
 * @version 2016-04-18
 */
class GetLogDeliveryConfigurationResponse {
    /**
     * Constructs a new <code>GetLogDeliveryConfigurationResponse</code>.
     * @alias module:model/GetLogDeliveryConfigurationResponse
     */
    constructor() { 
        
        GetLogDeliveryConfigurationResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetLogDeliveryConfigurationResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetLogDeliveryConfigurationResponse} obj Optional instance to populate.
     * @return {module:model/GetLogDeliveryConfigurationResponse} The populated <code>GetLogDeliveryConfigurationResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetLogDeliveryConfigurationResponse();

            if (data.hasOwnProperty('LogDeliveryConfiguration')) {
                obj['LogDeliveryConfiguration'] = GetLogDeliveryConfigurationResponseLogDeliveryConfiguration.constructFromObject(data['LogDeliveryConfiguration']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetLogDeliveryConfigurationResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetLogDeliveryConfigurationResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `LogDeliveryConfiguration`
        if (data['LogDeliveryConfiguration']) { // data not null
          GetLogDeliveryConfigurationResponseLogDeliveryConfiguration.validateJSON(data['LogDeliveryConfiguration']);
        }
...
/**
 * @member {module:model/GetLogDeliveryConfigurationResponseLogDeliveryConfiguration} LogDeliveryConfiguration
 */
GetLogDeliveryConfigurationResponse.prototype['LogDeliveryConfiguration'] = undefined;
...
export default GetLogDeliveryConfigurationResponse;
