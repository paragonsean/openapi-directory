...
/**
 * The AuthenticationResultType model module.
 * @module model/AuthenticationResultType
 * @version 2016-04-18
 */
class AuthenticationResultType {
    /**
     * Constructs a new <code>AuthenticationResultType</code>.
     * The authentication result.
     * @alias module:model/AuthenticationResultType
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>AuthenticationResultType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AuthenticationResultType} obj Optional instance to populate.
     * @return {module:model/AuthenticationResultType} The populated <code>AuthenticationResultType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AuthenticationResultType();
    ...
    /**
     * Validates the JSON data with respect to <code>AuthenticationResultType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AuthenticationResultType</code>.
     */
...
export default AuthenticationResultType;
