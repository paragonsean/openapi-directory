...
/**
 * The ListUserImportJobsResponse model module.
 * @module model/ListUserImportJobsResponse
 * @version 2016-04-18
 */
class ListUserImportJobsResponse {
    /**
     * Constructs a new <code>ListUserImportJobsResponse</code>.
     * Represents the response from the server to the request to list the user import jobs.
     * @alias module:model/ListUserImportJobsResponse
     */
    constructor() { 
        
        ListUserImportJobsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListUserImportJobsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListUserImportJobsResponse} obj Optional instance to populate.
     * @return {module:model/ListUserImportJobsResponse} The populated <code>ListUserImportJobsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListUserImportJobsResponse();

            if (data.hasOwnProperty('UserImportJobs')) {
                obj['UserImportJobs'] = ApiClient.convertToType(data['UserImportJobs'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListUserImportJobsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListUserImportJobsResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `UserImportJobs`
        if (data['UserImportJobs']) { // data not null
          Array.validateJSON(data['UserImportJobs']);
        }
...
/**
 * @member {Array} UserImportJobs
 */
ListUserImportJobsResponse.prototype['UserImportJobs'] = undefined;

/**
 * @member {String} PaginationToken
 */
ListUserImportJobsResponse.prototype['PaginationToken'] = undefined;
...
export default ListUserImportJobsResponse;
