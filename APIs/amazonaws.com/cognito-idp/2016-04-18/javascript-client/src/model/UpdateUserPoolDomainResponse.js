...
/**
 * The UpdateUserPoolDomainResponse model module.
 * @module model/UpdateUserPoolDomainResponse
 * @version 2016-04-18
 */
class UpdateUserPoolDomainResponse {
    /**
     * Constructs a new <code>UpdateUserPoolDomainResponse</code>.
     * The UpdateUserPoolDomain response output.
     * @alias module:model/UpdateUserPoolDomainResponse
     */
    constructor() { 
        
        UpdateUserPoolDomainResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateUserPoolDomainResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateUserPoolDomainResponse} obj Optional instance to populate.
     * @return {module:model/UpdateUserPoolDomainResponse} The populated <code>UpdateUserPoolDomainResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateUserPoolDomainResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateUserPoolDomainResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateUserPoolDomainResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `CloudFrontDomain`
        if (data['CloudFrontDomain']) { // data not null
          String.validateJSON(data['CloudFrontDomain']);
        }
 ...
 */
UpdateUserPoolDomainResponse.prototype['CloudFrontDomain'] = undefined;
...
export default UpdateUserPoolDomainResponse;
