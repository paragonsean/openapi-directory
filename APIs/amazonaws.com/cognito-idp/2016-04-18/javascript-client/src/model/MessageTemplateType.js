...
/**
 * The MessageTemplateType model module.
 * @module model/MessageTemplateType
 * @version 2016-04-18
 */
class MessageTemplateType {
    /**
     * Constructs a new <code>MessageTemplateType</code>.
     * The message template structure.
     * @alias module:model/MessageTemplateType
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>MessageTemplateType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MessageTemplateType} obj Optional instance to populate.
     * @return {module:model/MessageTemplateType} The populated <code>MessageTemplateType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MessageTemplateType();
    ...
    /**
     * Validates the JSON data with respect to <code>MessageTemplateType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MessageTemplateType</code>.
     */
