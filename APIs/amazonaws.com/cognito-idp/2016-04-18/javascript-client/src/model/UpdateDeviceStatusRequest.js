...
/**
 * The UpdateDeviceStatusRequest model module.
 * @module model/UpdateDeviceStatusRequest
 * @version 2016-04-18
 */
class UpdateDeviceStatusRequest {
    /**
     * Constructs a new <code>UpdateDeviceStatusRequest</code>.
     * Represents the request to update the device status.
     * @alias module:model/UpdateDeviceStatusRequest
     * @param accessToken {String} 
     * @param deviceKey {String} 
     */
    constructor(accessToken, deviceKey) { 
        
        UpdateDeviceStatusRequest.initialize(this, accessToken, deviceKey);
    }
    ...
    /**
     * Constructs a <code>UpdateDeviceStatusRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateDeviceStatusRequest} obj Optional instance to populate.
     * @return {module:model/UpdateDeviceStatusRequest} The populated <code>UpdateDeviceStatusRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateDeviceStatusRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateDeviceStatusRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateDeviceStatusRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateDeviceStatusRequest.RequiredProperties) {
...
UpdateDeviceStatusRequest.RequiredProperties = ["AccessToken", "DeviceKey"];

/**
 * @member {String} AccessToken
 */
UpdateDeviceStatusRequest.prototype['AccessToken'] = undefined;

/**
 * @member {String} DeviceKey
 */
UpdateDeviceStatusRequest.prototype['DeviceKey'] = undefined;

/**
 * @member {module:model/DeviceRememberedStatusType} DeviceRememberedStatus
 */
UpdateDeviceStatusRequest.prototype['DeviceRememberedStatus'] = undefined;
...
export default UpdateDeviceStatusRequest;
