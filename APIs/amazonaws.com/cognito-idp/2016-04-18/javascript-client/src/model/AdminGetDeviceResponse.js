...
import AdminGetDeviceResponseDevice from './AdminGetDeviceResponseDevice';

/**
 * The AdminGetDeviceResponse model module.
 * @module model/AdminGetDeviceResponse
 * @version 2016-04-18
 */
class AdminGetDeviceResponse {
    /**
     * Constructs a new <code>AdminGetDeviceResponse</code>.
     * Gets the device response, as an administrator.
     * @alias module:model/AdminGetDeviceResponse
     * @param device {module:model/AdminGetDeviceResponseDevice} 
     */
    constructor(device) { 
        
        AdminGetDeviceResponse.initialize(this, device);
    }
    ...
    /**
     * Constructs a <code>AdminGetDeviceResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdminGetDeviceResponse} obj Optional instance to populate.
     * @return {module:model/AdminGetDeviceResponse} The populated <code>AdminGetDeviceResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdminGetDeviceResponse();

            if (data.hasOwnProperty('Device')) {
                obj['Device'] = AdminGetDeviceResponseDevice.constructFromObject(data['Device']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AdminGetDeviceResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdminGetDeviceResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AdminGetDeviceResponse.RequiredProperties) {
        ...
        if (data['Device']) { // data not null
          AdminGetDeviceResponseDevice.validateJSON(data['Device']);
        }
...
AdminGetDeviceResponse.RequiredProperties = ["Device"];

/**
 * @member {module:model/AdminGetDeviceResponseDevice} Device
 */
AdminGetDeviceResponse.prototype['Device'] = undefined;
...
export default AdminGetDeviceResponse;
