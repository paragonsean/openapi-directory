...
/**
 * The AddCustomAttributesRequest model module.
 * @module model/AddCustomAttributesRequest
 * @version 2016-04-18
 */
class AddCustomAttributesRequest {
    /**
     * Constructs a new <code>AddCustomAttributesRequest</code>.
     * Represents the request to add custom attributes.
     * @alias module:model/AddCustomAttributesRequest
     * @param userPoolId {String} 
     * @param customAttributes {Array} 
     */
    constructor(userPoolId, customAttributes) { 
        
        AddCustomAttributesRequest.initialize(this, userPoolId, customAttributes);
    }
     ...
     */
    static initialize(obj, userPoolId, customAttributes) { 
        obj['UserPoolId'] = userPoolId;
        obj['CustomAttributes'] = customAttributes;
    }

    /**
     * Constructs a <code>AddCustomAttributesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddCustomAttributesRequest} obj Optional instance to populate.
     * @return {module:model/AddCustomAttributesRequest} The populated <code>AddCustomAttributesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddCustomAttributesRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>AddCustomAttributesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddCustomAttributesRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AddCustomAttributesRequest.RequiredProperties) {
...
AddCustomAttributesRequest.RequiredProperties = ["UserPoolId", "CustomAttributes"];

/**
 * @member {String} UserPoolId
 */
AddCustomAttributesRequest.prototype['UserPoolId'] = undefined;

/**
 * @member {Array} CustomAttributes
 */
AddCustomAttributesRequest.prototype['CustomAttributes'] = undefined;
...
export default AddCustomAttributesRequest;
