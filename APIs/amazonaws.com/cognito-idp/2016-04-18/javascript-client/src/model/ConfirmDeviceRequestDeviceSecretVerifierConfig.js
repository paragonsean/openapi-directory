...
/**
 * The ConfirmDeviceRequestDeviceSecretVerifierConfig model module.
 * @module model/ConfirmDeviceRequestDeviceSecretVerifierConfig
 * @version 2016-04-18
 */
class ConfirmDeviceRequestDeviceSecretVerifierConfig {
    /**
     * Constructs a new <code>ConfirmDeviceRequestDeviceSecretVerifierConfig</code>.
     * @alias module:model/ConfirmDeviceRequestDeviceSecretVerifierConfig
     * @implements module:model/DeviceSecretVerifierConfigType
     */
    constructor() { 
        DeviceSecretVerifierConfigType.initialize(this);
        ConfirmDeviceRequestDeviceSecretVerifierConfig.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ConfirmDeviceRequestDeviceSecretVerifierConfig</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ConfirmDeviceRequestDeviceSecretVerifierConfig} obj Optional instance to populate.
     * @return {module:model/ConfirmDeviceRequestDeviceSecretVerifierConfig} The populated <code>ConfirmDeviceRequestDeviceSecretVerifierConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ConfirmDeviceRequestDeviceSecretVerifierConfig();
            DeviceSecretVerifierConfigType.constructFromObject(data, obj);

            if (data.hasOwnProperty('PasswordVerifier')) {
                obj['PasswordVerifier'] = ApiClient.convertToType(data['PasswordVerifier'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ConfirmDeviceRequestDeviceSecretVerifierConfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConfirmDeviceRequestDeviceSecretVerifierConfig</code>.
     */
    static validateJSON(data) {
        // validate the optional field `PasswordVerifier`
        if (data['PasswordVerifier']) { // data not null
          String.validateJSON(data['PasswordVerifier']);
        }
...
/**
 * @member {String} PasswordVerifier
 */
ConfirmDeviceRequestDeviceSecretVerifierConfig.prototype['PasswordVerifier'] = undefined;

/**
 * @member {String} Salt
 */
ConfirmDeviceRequestDeviceSecretVerifierConfig.prototype['Salt'] = undefined;


// Implement DeviceSecretVerifierConfigType interface:
/**
 * @member {String} PasswordVerifier
 */
DeviceSecretVerifierConfigType.prototype['PasswordVerifier'] = undefined;
/**
 * @member {String} Salt
 */
DeviceSecretVerifierConfigType.prototype['Salt'] = undefined;




export default ConfirmDeviceRequestDeviceSecretVerifierConfig;
