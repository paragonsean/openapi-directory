...
/**
 * The ListUserPoolsResponse model module.
 * @module model/ListUserPoolsResponse
 * @version 2016-04-18
 */
class ListUserPoolsResponse {
    /**
     * Constructs a new <code>ListUserPoolsResponse</code>.
     * Represents the response to list user pools.
     * @alias module:model/ListUserPoolsResponse
     */
    constructor() { 
        
        ListUserPoolsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListUserPoolsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListUserPoolsResponse} obj Optional instance to populate.
     * @return {module:model/ListUserPoolsResponse} The populated <code>ListUserPoolsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListUserPoolsResponse();

            if (data.hasOwnProperty('UserPools')) {
                obj['UserPools'] = ApiClient.convertToType(data['UserPools'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListUserPoolsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListUserPoolsResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `UserPools`
        if (data['UserPools']) { // data not null
          Array.validateJSON(data['UserPools']);
        }
...
/**
 * @member {Array} UserPools
 */
ListUserPoolsResponse.prototype['UserPools'] = undefined;

/**
 * @member {String} NextToken
 */
ListUserPoolsResponse.prototype['NextToken'] = undefined;
...
export default ListUserPoolsResponse;
