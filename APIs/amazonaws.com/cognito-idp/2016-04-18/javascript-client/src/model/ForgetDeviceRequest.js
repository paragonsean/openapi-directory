...
/**
 * The ForgetDeviceRequest model module.
 * @module model/ForgetDeviceRequest
 * @version 2016-04-18
 */
class ForgetDeviceRequest {
    /**
     * Constructs a new <code>ForgetDeviceRequest</code>.
     * Represents the request to forget the device.
     * @alias module:model/ForgetDeviceRequest
     * @param deviceKey {String} 
     */
    constructor(deviceKey) { 
        
        ForgetDeviceRequest.initialize(this, deviceKey);
    }
    ...
    /**
     * Constructs a <code>ForgetDeviceRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ForgetDeviceRequest} obj Optional instance to populate.
     * @return {module:model/ForgetDeviceRequest} The populated <code>ForgetDeviceRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ForgetDeviceRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ForgetDeviceRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ForgetDeviceRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ForgetDeviceRequest.RequiredProperties) {
...
ForgetDeviceRequest.RequiredProperties = ["DeviceKey"];

/**
 * @member {String} AccessToken
 */
ForgetDeviceRequest.prototype['AccessToken'] = undefined;

/**
 * @member {String} DeviceKey
 */
ForgetDeviceRequest.prototype['DeviceKey'] = undefined;
...
export default ForgetDeviceRequest;
