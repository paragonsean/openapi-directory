...
/**
 * The AccountRecoverySettingType model module.
 * @module model/AccountRecoverySettingType
 * @version 2016-04-18
 */
class AccountRecoverySettingType {
    /**
     * Constructs a new <code>AccountRecoverySettingType</code>.
     * The data type for &lt;code&gt;AccountRecoverySetting&lt;/code&gt;.
     * @alias module:model/AccountRecoverySettingType
     */
    constructor() { 
        
        AccountRecoverySettingType.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AccountRecoverySettingType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AccountRecoverySettingType} obj Optional instance to populate.
     * @return {module:model/AccountRecoverySettingType} The populated <code>AccountRecoverySettingType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AccountRecoverySettingType();

            if (data.hasOwnProperty('RecoveryMechanisms')) {
                obj['RecoveryMechanisms'] = ApiClient.convertToType(data['RecoveryMechanisms'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AccountRecoverySettingType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AccountRecoverySettingType</code>.
     */
    static validateJSON(data) {
        // validate the optional field `RecoveryMechanisms`
        if (data['RecoveryMechanisms']) { // data not null
          Array.validateJSON(data['RecoveryMechanisms']);
        }
...
/**
 * @member {Array} RecoveryMechanisms
 */
AccountRecoverySettingType.prototype['RecoveryMechanisms'] = undefined;
...
export default AccountRecoverySettingType;
