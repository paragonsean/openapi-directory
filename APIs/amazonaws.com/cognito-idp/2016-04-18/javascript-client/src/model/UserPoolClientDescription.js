...
/**
 * The UserPoolClientDescription model module.
 * @module model/UserPoolClientDescription
 * @version 2016-04-18
 */
class UserPoolClientDescription {
    /**
     * Constructs a new <code>UserPoolClientDescription</code>.
     * The description of the user pool client.
     * @alias module:model/UserPoolClientDescription
     */
    constructor() { 
        
        UserPoolClientDescription.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UserPoolClientDescription</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UserPoolClientDescription} obj Optional instance to populate.
     * @return {module:model/UserPoolClientDescription} The populated <code>UserPoolClientDescription</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UserPoolClientDescription();
    ...
    /**
     * Validates the JSON data with respect to <code>UserPoolClientDescription</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UserPoolClientDescription</code>.
     */
 ...
 */
UserPoolClientDescription.prototype['ClientId'] = undefined;

/**
 * @member {String} UserPoolId
 */
UserPoolClientDescription.prototype['UserPoolId'] = undefined;

/**
 * @member {String} ClientName
 */
UserPoolClientDescription.prototype['ClientName'] = undefined;
...
export default UserPoolClientDescription;
