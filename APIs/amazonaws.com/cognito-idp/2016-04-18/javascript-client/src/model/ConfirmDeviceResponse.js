...
/**
 * The ConfirmDeviceResponse model module.
 * @module model/ConfirmDeviceResponse
 * @version 2016-04-18
 */
class ConfirmDeviceResponse {
    /**
     * Constructs a new <code>ConfirmDeviceResponse</code>.
     * Confirms the device response.
     * @alias module:model/ConfirmDeviceResponse
     */
    constructor() { 
        
        ConfirmDeviceResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ConfirmDeviceResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ConfirmDeviceResponse} obj Optional instance to populate.
     * @return {module:model/ConfirmDeviceResponse} The populated <code>ConfirmDeviceResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ConfirmDeviceResponse();

            if (data.hasOwnProperty('UserConfirmationNecessary')) {
                obj['UserConfirmationNecessary'] = ApiClient.convertToType(data['UserConfirmationNecessary'], 'Boolean');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ConfirmDeviceResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConfirmDeviceResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `UserConfirmationNecessary`
        if (data['UserConfirmationNecessary']) { // data not null
          Boolean.validateJSON(data['UserConfirmationNecessary']);
        }
...
/**
 * @member {Boolean} UserConfirmationNecessary
 */
ConfirmDeviceResponse.prototype['UserConfirmationNecessary'] = undefined;
...
export default ConfirmDeviceResponse;
