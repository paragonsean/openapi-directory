...
/**
 * The GetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration model module.
 * @module model/GetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration
 * @version 2016-04-18
 */
class GetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration {
    /**
     * Constructs a new <code>GetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration</code>.
     * @alias module:model/GetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration
     * @implements module:model/SoftwareTokenMfaConfigType
     */
    constructor() { 
        SoftwareTokenMfaConfigType.initialize(this);
        GetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration} obj Optional instance to populate.
     * @return {module:model/GetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration} The populated <code>GetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>GetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration</code>.
     */
 ...
 */
GetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration.prototype['Enabled'] = undefined;
...
export default GetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration;
