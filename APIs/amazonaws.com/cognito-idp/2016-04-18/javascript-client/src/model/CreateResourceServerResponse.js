...
import CreateResourceServerResponseResourceServer from './CreateResourceServerResponseResourceServer';

/**
 * The CreateResourceServerResponse model module.
 * @module model/CreateResourceServerResponse
 * @version 2016-04-18
 */
class CreateResourceServerResponse {
    /**
     * Constructs a new <code>CreateResourceServerResponse</code>.
     * @alias module:model/CreateResourceServerResponse
     * @param resourceServer {module:model/CreateResourceServerResponseResourceServer} 
     */
    constructor(resourceServer) { 
        
        CreateResourceServerResponse.initialize(this, resourceServer);
    }
    ...
    /**
     * Constructs a <code>CreateResourceServerResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateResourceServerResponse} obj Optional instance to populate.
     * @return {module:model/CreateResourceServerResponse} The populated <code>CreateResourceServerResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateResourceServerResponse();

            if (data.hasOwnProperty('ResourceServer')) {
                obj['ResourceServer'] = CreateResourceServerResponseResourceServer.constructFromObject(data['ResourceServer']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateResourceServerResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateResourceServerResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateResourceServerResponse.RequiredProperties) {
        ...
        if (data['ResourceServer']) { // data not null
          CreateResourceServerResponseResourceServer.validateJSON(data['ResourceServer']);
        }
...
CreateResourceServerResponse.RequiredProperties = ["ResourceServer"];

/**
 * @member {module:model/CreateResourceServerResponseResourceServer} ResourceServer
 */
CreateResourceServerResponse.prototype['ResourceServer'] = undefined;
...
export default CreateResourceServerResponse;
