...
/**
 * The DeleteUserPoolRequest model module.
 * @module model/DeleteUserPoolRequest
 * @version 2016-04-18
 */
class DeleteUserPoolRequest {
    /**
     * Constructs a new <code>DeleteUserPoolRequest</code>.
     * Represents the request to delete a user pool.
     * @alias module:model/DeleteUserPoolRequest
     * @param userPoolId {String} 
     */
    constructor(userPoolId) { 
        
        DeleteUserPoolRequest.initialize(this, userPoolId);
    }
    ...
    /**
     * Constructs a <code>DeleteUserPoolRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteUserPoolRequest} obj Optional instance to populate.
     * @return {module:model/DeleteUserPoolRequest} The populated <code>DeleteUserPoolRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteUserPoolRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteUserPoolRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteUserPoolRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteUserPoolRequest.RequiredProperties) {
...
DeleteUserPoolRequest.RequiredProperties = ["UserPoolId"];

/**
 * @member {String} UserPoolId
 */
DeleteUserPoolRequest.prototype['UserPoolId'] = undefined;
...
export default DeleteUserPoolRequest;
