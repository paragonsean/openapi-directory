...
/**
 * The AdminRespondToAuthChallengeRequestAnalyticsMetadata model module.
 * @module model/AdminRespondToAuthChallengeRequestAnalyticsMetadata
 * @version 2016-04-18
 */
class AdminRespondToAuthChallengeRequestAnalyticsMetadata {
    /**
     * Constructs a new <code>AdminRespondToAuthChallengeRequestAnalyticsMetadata</code>.
     * @alias module:model/AdminRespondToAuthChallengeRequestAnalyticsMetadata
     * @implements module:model/AnalyticsMetadataType
     */
    constructor() { 
        AnalyticsMetadataType.initialize(this);
        AdminRespondToAuthChallengeRequestAnalyticsMetadata.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AdminRespondToAuthChallengeRequestAnalyticsMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdminRespondToAuthChallengeRequestAnalyticsMetadata} obj Optional instance to populate.
     * @return {module:model/AdminRespondToAuthChallengeRequestAnalyticsMetadata} The populated <code>AdminRespondToAuthChallengeRequestAnalyticsMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdminRespondToAuthChallengeRequestAnalyticsMetadata();
    ...
    /**
     * Validates the JSON data with respect to <code>AdminRespondToAuthChallengeRequestAnalyticsMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdminRespondToAuthChallengeRequestAnalyticsMetadata</code>.
     */
 ...
 */
AdminRespondToAuthChallengeRequestAnalyticsMetadata.prototype['AnalyticsEndpointId'] = undefined;
...
export default AdminRespondToAuthChallengeRequestAnalyticsMetadata;
