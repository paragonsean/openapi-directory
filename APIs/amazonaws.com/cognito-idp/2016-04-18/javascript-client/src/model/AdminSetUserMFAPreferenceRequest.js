...
import AdminSetUserMFAPreferenceRequestSMSMfaSettings from './AdminSetUserMFAPreferenceRequestSMSMfaSettings';
import AdminSetUserMFAPreferenceRequestSoftwareTokenMfaSettings from './AdminSetUserMFAPreferenceRequestSoftwareTokenMfaSettings';

/**
 * The AdminSetUserMFAPreferenceRequest model module.
 * @module model/AdminSetUserMFAPreferenceRequest
 * @version 2016-04-18
 */
class AdminSetUserMFAPreferenceRequest {
    /**
     * Constructs a new <code>AdminSetUserMFAPreferenceRequest</code>.
     * @alias module:model/AdminSetUserMFAPreferenceRequest
     * @param username {String} 
     * @param userPoolId {String} 
     */
    constructor(username, userPoolId) { 
        
        AdminSetUserMFAPreferenceRequest.initialize(this, username, userPoolId);
    }
    ...
    /**
     * Constructs a <code>AdminSetUserMFAPreferenceRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdminSetUserMFAPreferenceRequest} obj Optional instance to populate.
     * @return {module:model/AdminSetUserMFAPreferenceRequest} The populated <code>AdminSetUserMFAPreferenceRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdminSetUserMFAPreferenceRequest();

            if (data.hasOwnProperty('SMSMfaSettings')) {
                obj['SMSMfaSettings'] = AdminSetUserMFAPreferenceRequestSMSMfaSettings.constructFromObject(data['SMSMfaSettings']);
            }
            if (data.hasOwnProperty('SoftwareTokenMfaSettings')) {
                obj['SoftwareTokenMfaSettings'] = AdminSetUserMFAPreferenceRequestSoftwareTokenMfaSettings.constructFromObject(data['SoftwareTokenMfaSettings']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>AdminSetUserMFAPreferenceRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdminSetUserMFAPreferenceRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AdminSetUserMFAPreferenceRequest.RequiredProperties) {
        ...
        if (data['SMSMfaSettings']) { // data not null
          AdminSetUserMFAPreferenceRequestSMSMfaSettings.validateJSON(data['SMSMfaSettings']);
        }
        // validate the optional field `SoftwareTokenMfaSettings`
        if (data['SoftwareTokenMfaSettings']) { // data not null
          AdminSetUserMFAPreferenceRequestSoftwareTokenMfaSettings.validateJSON(data['SoftwareTokenMfaSettings']);
        }
...
AdminSetUserMFAPreferenceRequest.RequiredProperties = ["Username", "UserPoolId"];

/**
 * @member {module:model/AdminSetUserMFAPreferenceRequestSMSMfaSettings} SMSMfaSettings
 */
AdminSetUserMFAPreferenceRequest.prototype['SMSMfaSettings'] = undefined;

/**
 * @member {module:model/AdminSetUserMFAPreferenceRequestSoftwareTokenMfaSettings} SoftwareTokenMfaSettings
 */
AdminSetUserMFAPreferenceRequest.prototype['SoftwareTokenMfaSettings'] = undefined;

/**
 * @member {String} Username
 */
AdminSetUserMFAPreferenceRequest.prototype['Username'] = undefined;

/**
 * @member {String} UserPoolId
 */
AdminSetUserMFAPreferenceRequest.prototype['UserPoolId'] = undefined;
...
export default AdminSetUserMFAPreferenceRequest;
