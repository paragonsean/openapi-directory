...
/**
 * The GetSigningCertificateRequest model module.
 * @module model/GetSigningCertificateRequest
 * @version 2016-04-18
 */
class GetSigningCertificateRequest {
    /**
     * Constructs a new <code>GetSigningCertificateRequest</code>.
     * Request to get a signing certificate from Amazon Cognito.
     * @alias module:model/GetSigningCertificateRequest
     * @param userPoolId {String} 
     */
    constructor(userPoolId) { 
        
        GetSigningCertificateRequest.initialize(this, userPoolId);
    }
    ...
    /**
     * Constructs a <code>GetSigningCertificateRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetSigningCertificateRequest} obj Optional instance to populate.
     * @return {module:model/GetSigningCertificateRequest} The populated <code>GetSigningCertificateRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetSigningCertificateRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GetSigningCertificateRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetSigningCertificateRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetSigningCertificateRequest.RequiredProperties) {
...
GetSigningCertificateRequest.RequiredProperties = ["UserPoolId"];

/**
 * @member {String} UserPoolId
 */
GetSigningCertificateRequest.prototype['UserPoolId'] = undefined;
...
export default GetSigningCertificateRequest;
