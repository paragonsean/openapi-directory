...
* @readonly
*/
export default class RiskLevelType {
    ...
    /**
    * Returns a <code>RiskLevelType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/RiskLevelType} The enum <code>RiskLevelType</code> value.
    */
