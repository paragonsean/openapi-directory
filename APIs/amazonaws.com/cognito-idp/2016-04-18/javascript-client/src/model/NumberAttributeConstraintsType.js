...
/**
 * The NumberAttributeConstraintsType model module.
 * @module model/NumberAttributeConstraintsType
 * @version 2016-04-18
 */
class NumberAttributeConstraintsType {
    /**
     * Constructs a new <code>NumberAttributeConstraintsType</code>.
     * The minimum and maximum values of an attribute that is of the number data type.
     * @alias module:model/NumberAttributeConstraintsType
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>NumberAttributeConstraintsType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NumberAttributeConstraintsType} obj Optional instance to populate.
     * @return {module:model/NumberAttributeConstraintsType} The populated <code>NumberAttributeConstraintsType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NumberAttributeConstraintsType();
    ...
    /**
     * Validates the JSON data with respect to <code>NumberAttributeConstraintsType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NumberAttributeConstraintsType</code>.
     */
...
export default NumberAttributeConstraintsType;
