...
/**
 * The LambdaConfigTypeCustomSMSSender model module.
 * @module model/LambdaConfigTypeCustomSMSSender
 * @version 2016-04-18
 */
class LambdaConfigTypeCustomSMSSender {
    /**
     * Constructs a new <code>LambdaConfigTypeCustomSMSSender</code>.
     * @alias module:model/LambdaConfigTypeCustomSMSSender
     * @implements module:model/CustomSMSLambdaVersionConfigType
    ...
    constructor(lambdaVersion, lambdaArn) { 
        ...
        LambdaConfigTypeCustomSMSSender.initialize(this, lambdaVersion, lambdaArn);
    }
    ...
    /**
     * Constructs a <code>LambdaConfigTypeCustomSMSSender</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LambdaConfigTypeCustomSMSSender} obj Optional instance to populate.
     * @return {module:model/LambdaConfigTypeCustomSMSSender} The populated <code>LambdaConfigTypeCustomSMSSender</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LambdaConfigTypeCustomSMSSender();
            CustomSMSLambdaVersionConfigType.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>LambdaConfigTypeCustomSMSSender</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LambdaConfigTypeCustomSMSSender</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of LambdaConfigTypeCustomSMSSender.RequiredProperties) {
...
LambdaConfigTypeCustomSMSSender.RequiredProperties = ["LambdaVersion", "LambdaArn"];

/**
 * @member {module:model/CustomSMSSenderLambdaVersionType} LambdaVersion
 */
LambdaConfigTypeCustomSMSSender.prototype['LambdaVersion'] = undefined;

/**
 * @member {String} LambdaArn
 */
LambdaConfigTypeCustomSMSSender.prototype['LambdaArn'] = undefined;


// Implement CustomSMSLambdaVersionConfigType interface:
/**
 * @member {module:model/CustomSMSSenderLambdaVersionType} LambdaVersion
 */
...
export default LambdaConfigTypeCustomSMSSender;
