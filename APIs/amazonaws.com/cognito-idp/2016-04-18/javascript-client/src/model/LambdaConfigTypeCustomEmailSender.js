...
import CustomEmailSenderLambdaVersionType from './CustomEmailSenderLambdaVersionType';

/**
 * The LambdaConfigTypeCustomEmailSender model module.
 * @module model/LambdaConfigTypeCustomEmailSender
 * @version 2016-04-18
 */
class LambdaConfigTypeCustomEmailSender {
    /**
     * Constructs a new <code>LambdaConfigTypeCustomEmailSender</code>.
     * @alias module:model/LambdaConfigTypeCustomEmailSender
     * @implements module:model/CustomEmailLambdaVersionConfigType
     * @param lambdaVersion {module:model/CustomEmailSenderLambdaVersionType} 
     * @param lambdaArn {String} 
     */
    constructor(lambdaVersion, lambdaArn) { 
        CustomEmailLambdaVersionConfigType.initialize(this, lambdaVersion, lambdaArn);
        LambdaConfigTypeCustomEmailSender.initialize(this, lambdaVersion, lambdaArn);
    }
    ...
    /**
     * Constructs a <code>LambdaConfigTypeCustomEmailSender</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LambdaConfigTypeCustomEmailSender} obj Optional instance to populate.
     * @return {module:model/LambdaConfigTypeCustomEmailSender} The populated <code>LambdaConfigTypeCustomEmailSender</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LambdaConfigTypeCustomEmailSender();
            CustomEmailLambdaVersionConfigType.constructFromObject(data, obj);

            if (data.hasOwnProperty('LambdaVersion')) {
                obj['LambdaVersion'] = ApiClient.convertToType(data['LambdaVersion'], CustomEmailSenderLambdaVersionType);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>LambdaConfigTypeCustomEmailSender</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LambdaConfigTypeCustomEmailSender</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of LambdaConfigTypeCustomEmailSender.RequiredProperties) {
        ...
        if (data['LambdaVersion']) { // data not null
          CustomEmailSenderLambdaVersionType.validateJSON(data['LambdaVersion']);
        }
...
LambdaConfigTypeCustomEmailSender.RequiredProperties = ["LambdaVersion", "LambdaArn"];

/**
 * @member {module:model/CustomEmailSenderLambdaVersionType} LambdaVersion
 */
LambdaConfigTypeCustomEmailSender.prototype['LambdaVersion'] = undefined;

/**
 * @member {String} LambdaArn
 */
LambdaConfigTypeCustomEmailSender.prototype['LambdaArn'] = undefined;


// Implement CustomEmailLambdaVersionConfigType interface:
/**
 * @member {module:model/CustomEmailSenderLambdaVersionType} LambdaVersion
 */
CustomEmailLambdaVersionConfigType.prototype['LambdaVersion'] = undefined;
/**
 * @member {String} LambdaArn
 */
CustomEmailLambdaVersionConfigType.prototype['LambdaArn'] = undefined;




export default LambdaConfigTypeCustomEmailSender;
