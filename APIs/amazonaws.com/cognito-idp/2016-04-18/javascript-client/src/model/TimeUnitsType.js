...
* @readonly
*/
export default class TimeUnitsType {
    ...
    /**
    * Returns a <code>TimeUnitsType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/TimeUnitsType} The enum <code>TimeUnitsType</code> value.
    */
