...
/**
 * The GroupType model module.
 * @module model/GroupType
 * @version 2016-04-18
 */
class GroupType {
    /**
     * Constructs a new <code>GroupType</code>.
     * The group type.
     * @alias module:model/GroupType
     */
    constructor() { 
        
        GroupType.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GroupType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GroupType} obj Optional instance to populate.
     * @return {module:model/GroupType} The populated <code>GroupType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GroupType();
    ...
    /**
     * Validates the JSON data with respect to <code>GroupType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GroupType</code>.
     */
    static validateJSON(data) {
        ...
        if (data['Precedence']) { // data not null
          Number.validateJSON(data['Precedence']);
        }
 ...
 */
GroupType.prototype['GroupName'] = undefined;

/**
 * @member {String} UserPoolId
 */
GroupType.prototype['UserPoolId'] = undefined;

/**
 * @member {String} Description
 */
GroupType.prototype['Description'] = undefined;

/**
 * @member {String} RoleArn
 */
GroupType.prototype['RoleArn'] = undefined;

/**
 * @member {Number} Precedence
 */
GroupType.prototype['Precedence'] = undefined;

/**
 * @member {Date} LastModifiedDate
 */
GroupType.prototype['LastModifiedDate'] = undefined;

/**
 * @member {Date} CreationDate
 */
GroupType.prototype['CreationDate'] = undefined;
