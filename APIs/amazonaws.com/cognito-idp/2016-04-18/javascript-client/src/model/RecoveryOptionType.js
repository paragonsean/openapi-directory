...
import RecoveryOptionNameType from './RecoveryOptionNameType';

/**
 * The RecoveryOptionType model module.
 * @module model/RecoveryOptionType
 * @version 2016-04-18
 */
class RecoveryOptionType {
    /**
     * Constructs a new <code>RecoveryOptionType</code>.
     * A map containing a priority as a key, and recovery method name as a value.
     * @alias module:model/RecoveryOptionType
     * @param priority {Number} 
     * @param name {module:model/RecoveryOptionNameType} 
     */
    constructor(priority, name) { 
        
        RecoveryOptionType.initialize(this, priority, name);
    }
     ...
     */
    static initialize(obj, priority, name) { 
        obj['Priority'] = priority;
        obj['Name'] = name;
    }

    /**
     * Constructs a <code>RecoveryOptionType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RecoveryOptionType} obj Optional instance to populate.
     * @return {module:model/RecoveryOptionType} The populated <code>RecoveryOptionType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RecoveryOptionType();

            if (data.hasOwnProperty('Priority')) {
                obj['Priority'] = ApiClient.convertToType(data['Priority'], 'Number');
            }
            if (data.hasOwnProperty('Name')) {
                obj['Name'] = ApiClient.convertToType(data['Name'], RecoveryOptionNameType);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>RecoveryOptionType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RecoveryOptionType</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RecoveryOptionType.RequiredProperties) {
        ...
        if (data['Name']) { // data not null
          RecoveryOptionNameType.validateJSON(data['Name']);
        }
...
RecoveryOptionType.RequiredProperties = ["Priority", "Name"];

/**
 * @member {Number} Priority
 */
RecoveryOptionType.prototype['Priority'] = undefined;

/**
 * @member {module:model/RecoveryOptionNameType} Name
 */
RecoveryOptionType.prototype['Name'] = undefined;
...
export default RecoveryOptionType;
