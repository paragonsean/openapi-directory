...
import CreateUserPoolDomainRequestCustomDomainConfig from './CreateUserPoolDomainRequestCustomDomainConfig';

/**
 * The CreateUserPoolDomainRequest model module.
 * @module model/CreateUserPoolDomainRequest
 * @version 2016-04-18
 */
class CreateUserPoolDomainRequest {
    /**
     * Constructs a new <code>CreateUserPoolDomainRequest</code>.
     * @alias module:model/CreateUserPoolDomainRequest
     * @param domain {String} 
     * @param userPoolId {String} 
     */
    constructor(domain, userPoolId) { 
        
        CreateUserPoolDomainRequest.initialize(this, domain, userPoolId);
    }
    ...
    /**
     * Constructs a <code>CreateUserPoolDomainRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateUserPoolDomainRequest} obj Optional instance to populate.
     * @return {module:model/CreateUserPoolDomainRequest} The populated <code>CreateUserPoolDomainRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateUserPoolDomainRequest();
            ...
            if (data.hasOwnProperty('CustomDomainConfig')) {
                obj['CustomDomainConfig'] = CreateUserPoolDomainRequestCustomDomainConfig.constructFromObject(data['CustomDomainConfig']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateUserPoolDomainRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateUserPoolDomainRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateUserPoolDomainRequest.RequiredProperties) {
        ...
        if (data['CustomDomainConfig']) { // data not null
          CreateUserPoolDomainRequestCustomDomainConfig.validateJSON(data['CustomDomainConfig']);
        }
...
CreateUserPoolDomainRequest.RequiredProperties = ["Domain", "UserPoolId"];

/**
 * @member {String} Domain
 */
CreateUserPoolDomainRequest.prototype['Domain'] = undefined;

/**
 * @member {String} UserPoolId
 */
CreateUserPoolDomainRequest.prototype['UserPoolId'] = undefined;

/**
 * @member {module:model/CreateUserPoolDomainRequestCustomDomainConfig} CustomDomainConfig
 */
CreateUserPoolDomainRequest.prototype['CustomDomainConfig'] = undefined;
...
export default CreateUserPoolDomainRequest;
