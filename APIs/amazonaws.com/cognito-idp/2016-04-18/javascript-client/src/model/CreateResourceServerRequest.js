...
/**
 * The CreateResourceServerRequest model module.
 * @module model/CreateResourceServerRequest
 * @version 2016-04-18
 */
class CreateResourceServerRequest {
    /**
     * Constructs a new <code>CreateResourceServerRequest</code>.
     * @alias module:model/CreateResourceServerRequest
    ...
    constructor(userPoolId, identifier, name) { 
        ...
        CreateResourceServerRequest.initialize(this, userPoolId, identifier, name);
    }
    ...
    /**
     * Constructs a <code>CreateResourceServerRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateResourceServerRequest} obj Optional instance to populate.
     * @return {module:model/CreateResourceServerRequest} The populated <code>CreateResourceServerRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateResourceServerRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateResourceServerRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateResourceServerRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateResourceServerRequest.RequiredProperties) {
...
CreateResourceServerRequest.RequiredProperties = ["UserPoolId", "Identifier", "Name"];

/**
 * @member {String} UserPoolId
 */
CreateResourceServerRequest.prototype['UserPoolId'] = undefined;

/**
 * @member {String} Identifier
 */
CreateResourceServerRequest.prototype['Identifier'] = undefined;

/**
 * @member {String} Name
 */
CreateResourceServerRequest.prototype['Name'] = undefined;

/**
 * @member {Array} Scopes
 */
CreateResourceServerRequest.prototype['Scopes'] = undefined;
...
export default CreateResourceServerRequest;
