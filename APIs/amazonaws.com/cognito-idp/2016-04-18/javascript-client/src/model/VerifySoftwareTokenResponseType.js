...
* @readonly
*/
export default class VerifySoftwareTokenResponseType {
    ...
    /**
    * Returns a <code>VerifySoftwareTokenResponseType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/VerifySoftwareTokenResponseType} The enum <code>VerifySoftwareTokenResponseType</code> value.
    */
