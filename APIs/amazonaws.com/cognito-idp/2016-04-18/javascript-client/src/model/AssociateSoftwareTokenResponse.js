...
/**
 * The AssociateSoftwareTokenResponse model module.
 * @module model/AssociateSoftwareTokenResponse
 * @version 2016-04-18
 */
class AssociateSoftwareTokenResponse {
    /**
     * Constructs a new <code>AssociateSoftwareTokenResponse</code>.
     * @alias module:model/AssociateSoftwareTokenResponse
     */
    constructor() { 
        
        AssociateSoftwareTokenResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AssociateSoftwareTokenResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AssociateSoftwareTokenResponse} obj Optional instance to populate.
     * @return {module:model/AssociateSoftwareTokenResponse} The populated <code>AssociateSoftwareTokenResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AssociateSoftwareTokenResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>AssociateSoftwareTokenResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AssociateSoftwareTokenResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `SecretCode`
        if (data['SecretCode']) { // data not null
          String.validateJSON(data['SecretCode']);
        }
 ...
 */
AssociateSoftwareTokenResponse.prototype['SecretCode'] = undefined;

/**
 * @member {String} Session
 */
AssociateSoftwareTokenResponse.prototype['Session'] = undefined;
...
export default AssociateSoftwareTokenResponse;
