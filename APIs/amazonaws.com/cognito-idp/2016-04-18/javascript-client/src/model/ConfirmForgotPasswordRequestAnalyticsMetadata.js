...
/**
 * The ConfirmForgotPasswordRequestAnalyticsMetadata model module.
 * @module model/ConfirmForgotPasswordRequestAnalyticsMetadata
 * @version 2016-04-18
 */
class ConfirmForgotPasswordRequestAnalyticsMetadata {
    /**
     * Constructs a new <code>ConfirmForgotPasswordRequestAnalyticsMetadata</code>.
     * @alias module:model/ConfirmForgotPasswordRequestAnalyticsMetadata
     * @implements module:model/AnalyticsMetadataType
     */
    constructor() { 
        AnalyticsMetadataType.initialize(this);
        ConfirmForgotPasswordRequestAnalyticsMetadata.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ConfirmForgotPasswordRequestAnalyticsMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ConfirmForgotPasswordRequestAnalyticsMetadata} obj Optional instance to populate.
     * @return {module:model/ConfirmForgotPasswordRequestAnalyticsMetadata} The populated <code>ConfirmForgotPasswordRequestAnalyticsMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ConfirmForgotPasswordRequestAnalyticsMetadata();
    ...
    /**
     * Validates the JSON data with respect to <code>ConfirmForgotPasswordRequestAnalyticsMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConfirmForgotPasswordRequestAnalyticsMetadata</code>.
     */
 ...
 */
ConfirmForgotPasswordRequestAnalyticsMetadata.prototype['AnalyticsEndpointId'] = undefined;
...
export default ConfirmForgotPasswordRequestAnalyticsMetadata;
