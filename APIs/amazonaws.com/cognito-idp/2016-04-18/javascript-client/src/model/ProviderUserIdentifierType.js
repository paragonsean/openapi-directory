...
/**
 * The ProviderUserIdentifierType model module.
 * @module model/ProviderUserIdentifierType
 * @version 2016-04-18
 */
class ProviderUserIdentifierType {
    /**
     * Constructs a new <code>ProviderUserIdentifierType</code>.
     * A container for information about an IdP for a user pool.
     * @alias module:model/ProviderUserIdentifierType
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>ProviderUserIdentifierType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ProviderUserIdentifierType} obj Optional instance to populate.
     * @return {module:model/ProviderUserIdentifierType} The populated <code>ProviderUserIdentifierType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProviderUserIdentifierType();
    ...
    /**
     * Validates the JSON data with respect to <code>ProviderUserIdentifierType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProviderUserIdentifierType</code>.
     */
...
export default ProviderUserIdentifierType;
