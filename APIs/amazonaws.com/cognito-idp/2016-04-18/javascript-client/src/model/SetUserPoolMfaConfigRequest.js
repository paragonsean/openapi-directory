...
import SetUserPoolMfaConfigResponseSmsMfaConfiguration from './SetUserPoolMfaConfigResponseSmsMfaConfiguration';
import SetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration from './SetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration';
import UserPoolMfaType from './UserPoolMfaType';

/**
 * The SetUserPoolMfaConfigRequest model module.
 * @module model/SetUserPoolMfaConfigRequest
 * @version 2016-04-18
 */
class SetUserPoolMfaConfigRequest {
    /**
     * Constructs a new <code>SetUserPoolMfaConfigRequest</code>.
     * @alias module:model/SetUserPoolMfaConfigRequest
     * @param userPoolId {String} 
     */
    constructor(userPoolId) { 
        
        SetUserPoolMfaConfigRequest.initialize(this, userPoolId);
    }
    ...
    /**
     * Constructs a <code>SetUserPoolMfaConfigRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SetUserPoolMfaConfigRequest} obj Optional instance to populate.
     * @return {module:model/SetUserPoolMfaConfigRequest} The populated <code>SetUserPoolMfaConfigRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SetUserPoolMfaConfigRequest();

            if (data.hasOwnProperty('UserPoolId')) {
                obj['UserPoolId'] = ApiClient.convertToType(data['UserPoolId'], 'String');
            }
            if (data.hasOwnProperty('SmsMfaConfiguration')) {
                obj['SmsMfaConfiguration'] = SetUserPoolMfaConfigResponseSmsMfaConfiguration.constructFromObject(data['SmsMfaConfiguration']);
            }
            if (data.hasOwnProperty('SoftwareTokenMfaConfiguration')) {
                obj['SoftwareTokenMfaConfiguration'] = SetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration.constructFromObject(data['SoftwareTokenMfaConfiguration']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>SetUserPoolMfaConfigRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SetUserPoolMfaConfigRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SetUserPoolMfaConfigRequest.RequiredProperties) {
        ...
        if (data['SmsMfaConfiguration']) { // data not null
          SetUserPoolMfaConfigResponseSmsMfaConfiguration.validateJSON(data['SmsMfaConfiguration']);
        }
        // validate the optional field `SoftwareTokenMfaConfiguration`
        if (data['SoftwareTokenMfaConfiguration']) { // data not null
          SetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration.validateJSON(data['SoftwareTokenMfaConfiguration']);
        }
...
SetUserPoolMfaConfigRequest.RequiredProperties = ["UserPoolId"];

/**
 * @member {String} UserPoolId
 */
SetUserPoolMfaConfigRequest.prototype['UserPoolId'] = undefined;

/**
 * @member {module:model/SetUserPoolMfaConfigResponseSmsMfaConfiguration} SmsMfaConfiguration
 */
SetUserPoolMfaConfigRequest.prototype['SmsMfaConfiguration'] = undefined;

/**
 * @member {module:model/SetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration} SoftwareTokenMfaConfiguration
 */
SetUserPoolMfaConfigRequest.prototype['SoftwareTokenMfaConfiguration'] = undefined;

/**
 * @member {module:model/UserPoolMfaType} MfaConfiguration
 */
SetUserPoolMfaConfigRequest.prototype['MfaConfiguration'] = undefined;
...
export default SetUserPoolMfaConfigRequest;
