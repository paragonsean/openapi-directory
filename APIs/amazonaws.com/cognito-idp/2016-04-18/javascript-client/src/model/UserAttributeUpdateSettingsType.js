...
/**
 * The UserAttributeUpdateSettingsType model module.
 * @module model/UserAttributeUpdateSettingsType
 * @version 2016-04-18
 */
class UserAttributeUpdateSettingsType {
    /**
     * Constructs a new <code>UserAttributeUpdateSettingsType</code>.
     ...
     * @alias module:model/UserAttributeUpdateSettingsType
     */
    constructor() { 
        
        UserAttributeUpdateSettingsType.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UserAttributeUpdateSettingsType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UserAttributeUpdateSettingsType} obj Optional instance to populate.
     * @return {module:model/UserAttributeUpdateSettingsType} The populated <code>UserAttributeUpdateSettingsType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UserAttributeUpdateSettingsType();

            if (data.hasOwnProperty('AttributesRequireVerificationBeforeUpdate')) {
                obj['AttributesRequireVerificationBeforeUpdate'] = ApiClient.convertToType(data['AttributesRequireVerificationBeforeUpdate'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UserAttributeUpdateSettingsType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UserAttributeUpdateSettingsType</code>.
     */
    static validateJSON(data) {
        // validate the optional field `AttributesRequireVerificationBeforeUpdate`
        if (data['AttributesRequireVerificationBeforeUpdate']) { // data not null
          Array.validateJSON(data['AttributesRequireVerificationBeforeUpdate']);
        }
...
/**
 * @member {Array} AttributesRequireVerificationBeforeUpdate
 */
UserAttributeUpdateSettingsType.prototype['AttributesRequireVerificationBeforeUpdate'] = undefined;
...
export default UserAttributeUpdateSettingsType;
