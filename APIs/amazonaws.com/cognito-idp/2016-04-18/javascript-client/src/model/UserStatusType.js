...
* @readonly
*/
export default class UserStatusType {
    ...
    /**
    * Returns a <code>UserStatusType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/UserStatusType} The enum <code>UserStatusType</code> value.
    */
