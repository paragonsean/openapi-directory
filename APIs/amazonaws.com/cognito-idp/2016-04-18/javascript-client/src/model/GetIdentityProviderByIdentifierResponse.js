...
/**
 * The GetIdentityProviderByIdentifierResponse model module.
 * @module model/GetIdentityProviderByIdentifierResponse
 * @version 2016-04-18
 */
class GetIdentityProviderByIdentifierResponse {
    /**
     * Constructs a new <code>GetIdentityProviderByIdentifierResponse</code>.
     * @alias module:model/GetIdentityProviderByIdentifierResponse
     * @param identityProvider {module:model/DescribeIdentityProviderResponseIdentityProvider} 
     */
    constructor(identityProvider) { 
        
        GetIdentityProviderByIdentifierResponse.initialize(this, identityProvider);
    }
    ...
    /**
     * Constructs a <code>GetIdentityProviderByIdentifierResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetIdentityProviderByIdentifierResponse} obj Optional instance to populate.
     * @return {module:model/GetIdentityProviderByIdentifierResponse} The populated <code>GetIdentityProviderByIdentifierResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetIdentityProviderByIdentifierResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>GetIdentityProviderByIdentifierResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetIdentityProviderByIdentifierResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetIdentityProviderByIdentifierResponse.RequiredProperties) {
...
GetIdentityProviderByIdentifierResponse.RequiredProperties = ["IdentityProvider"];

/**
 * @member {module:model/DescribeIdentityProviderResponseIdentityProvider} IdentityProvider
 */
GetIdentityProviderByIdentifierResponse.prototype['IdentityProvider'] = undefined;
...
export default GetIdentityProviderByIdentifierResponse;
