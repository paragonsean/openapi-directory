...
/**
 * The ListUserPoolClientsResponse model module.
 * @module model/ListUserPoolClientsResponse
 * @version 2016-04-18
 */
class ListUserPoolClientsResponse {
    /**
     * Constructs a new <code>ListUserPoolClientsResponse</code>.
     * Represents the response from the server that lists user pool clients.
     * @alias module:model/ListUserPoolClientsResponse
     */
    constructor() { 
        
        ListUserPoolClientsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListUserPoolClientsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListUserPoolClientsResponse} obj Optional instance to populate.
     * @return {module:model/ListUserPoolClientsResponse} The populated <code>ListUserPoolClientsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListUserPoolClientsResponse();

            if (data.hasOwnProperty('UserPoolClients')) {
                obj['UserPoolClients'] = ApiClient.convertToType(data['UserPoolClients'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ListUserPoolClientsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListUserPoolClientsResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `UserPoolClients`
        if (data['UserPoolClients']) { // data not null
          Array.validateJSON(data['UserPoolClients']);
        }
...
/**
 * @member {Array} UserPoolClients
 */
ListUserPoolClientsResponse.prototype['UserPoolClients'] = undefined;

/**
 * @member {String} NextToken
 */
ListUserPoolClientsResponse.prototype['NextToken'] = undefined;
...
export default ListUserPoolClientsResponse;
