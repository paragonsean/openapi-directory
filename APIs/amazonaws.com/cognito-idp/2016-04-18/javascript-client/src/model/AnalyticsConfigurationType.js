...
/**
 * The AnalyticsConfigurationType model module.
 * @module model/AnalyticsConfigurationType
 * @version 2016-04-18
 */
class AnalyticsConfigurationType {
    /**
     * Constructs a new <code>AnalyticsConfigurationType</code>.
     ...
     * @alias module:model/AnalyticsConfigurationType
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>AnalyticsConfigurationType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AnalyticsConfigurationType} obj Optional instance to populate.
     * @return {module:model/AnalyticsConfigurationType} The populated <code>AnalyticsConfigurationType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AnalyticsConfigurationType();
    ...
    /**
     * Validates the JSON data with respect to <code>AnalyticsConfigurationType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AnalyticsConfigurationType</code>.
     */
...
export default AnalyticsConfigurationType;
