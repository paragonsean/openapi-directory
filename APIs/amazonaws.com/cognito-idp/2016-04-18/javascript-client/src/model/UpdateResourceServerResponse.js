...
/**
 * The UpdateResourceServerResponse model module.
 * @module model/UpdateResourceServerResponse
 * @version 2016-04-18
 */
class UpdateResourceServerResponse {
    /**
     * Constructs a new <code>UpdateResourceServerResponse</code>.
     * @alias module:model/UpdateResourceServerResponse
     * @param resourceServer {module:model/DescribeResourceServerResponseResourceServer} 
     */
    constructor(resourceServer) { 
        
        UpdateResourceServerResponse.initialize(this, resourceServer);
    }
    ...
    /**
     * Constructs a <code>UpdateResourceServerResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateResourceServerResponse} obj Optional instance to populate.
     * @return {module:model/UpdateResourceServerResponse} The populated <code>UpdateResourceServerResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateResourceServerResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateResourceServerResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateResourceServerResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateResourceServerResponse.RequiredProperties) {
...
UpdateResourceServerResponse.RequiredProperties = ["ResourceServer"];

/**
 * @member {module:model/DescribeResourceServerResponseResourceServer} ResourceServer
 */
UpdateResourceServerResponse.prototype['ResourceServer'] = undefined;
...
export default UpdateResourceServerResponse;
