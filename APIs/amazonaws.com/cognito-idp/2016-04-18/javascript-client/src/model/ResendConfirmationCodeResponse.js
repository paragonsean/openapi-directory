...
import ResendConfirmationCodeResponseCodeDeliveryDetails from './ResendConfirmationCodeResponseCodeDeliveryDetails';

/**
 * The ResendConfirmationCodeResponse model module.
 * @module model/ResendConfirmationCodeResponse
 * @version 2016-04-18
 */
class ResendConfirmationCodeResponse {
    /**
     * Constructs a new <code>ResendConfirmationCodeResponse</code>.
     * The response from the server when Amazon Cognito makes the request to resend a confirmation code.
     * @alias module:model/ResendConfirmationCodeResponse
     */
    constructor() { 
        
        ResendConfirmationCodeResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ResendConfirmationCodeResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ResendConfirmationCodeResponse} obj Optional instance to populate.
     * @return {module:model/ResendConfirmationCodeResponse} The populated <code>ResendConfirmationCodeResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ResendConfirmationCodeResponse();

            if (data.hasOwnProperty('CodeDeliveryDetails')) {
                obj['CodeDeliveryDetails'] = ResendConfirmationCodeResponseCodeDeliveryDetails.constructFromObject(data['CodeDeliveryDetails']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ResendConfirmationCodeResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ResendConfirmationCodeResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `CodeDeliveryDetails`
        if (data['CodeDeliveryDetails']) { // data not null
          ResendConfirmationCodeResponseCodeDeliveryDetails.validateJSON(data['CodeDeliveryDetails']);
        }
...
/**
 * @member {module:model/ResendConfirmationCodeResponseCodeDeliveryDetails} CodeDeliveryDetails
 */
ResendConfirmationCodeResponse.prototype['CodeDeliveryDetails'] = undefined;
...
export default ResendConfirmationCodeResponse;
