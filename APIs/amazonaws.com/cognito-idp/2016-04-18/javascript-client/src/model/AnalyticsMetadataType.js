...
/**
 * The AnalyticsMetadataType model module.
 * @module model/AnalyticsMetadataType
 * @version 2016-04-18
 */
class AnalyticsMetadataType {
    /**
     * Constructs a new <code>AnalyticsMetadataType</code>.
     ...
     * @alias module:model/AnalyticsMetadataType
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>AnalyticsMetadataType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AnalyticsMetadataType} obj Optional instance to populate.
     * @return {module:model/AnalyticsMetadataType} The populated <code>AnalyticsMetadataType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AnalyticsMetadataType();
    ...
    /**
     * Validates the JSON data with respect to <code>AnalyticsMetadataType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AnalyticsMetadataType</code>.
     */
...
export default AnalyticsMetadataType;
