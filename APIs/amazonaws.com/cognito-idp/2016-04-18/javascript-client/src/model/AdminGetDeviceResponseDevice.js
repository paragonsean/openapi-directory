...
/**
 * The AdminGetDeviceResponseDevice model module.
 * @module model/AdminGetDeviceResponseDevice
 * @version 2016-04-18
 */
class AdminGetDeviceResponseDevice {
    /**
     * Constructs a new <code>AdminGetDeviceResponseDevice</code>.
     * @alias module:model/AdminGetDeviceResponseDevice
     * @implements module:model/DeviceType
     */
    constructor() { 
        DeviceType.initialize(this);
        AdminGetDeviceResponseDevice.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AdminGetDeviceResponseDevice</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdminGetDeviceResponseDevice} obj Optional instance to populate.
     * @return {module:model/AdminGetDeviceResponseDevice} The populated <code>AdminGetDeviceResponseDevice</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdminGetDeviceResponseDevice();
            DeviceType.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>AdminGetDeviceResponseDevice</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdminGetDeviceResponseDevice</code>.
     */
 ...
 */
AdminGetDeviceResponseDevice.prototype['DeviceKey'] = undefined;

/**
 * @member {Array} DeviceAttributes
 */
AdminGetDeviceResponseDevice.prototype['DeviceAttributes'] = undefined;

/**
 * @member {Date} DeviceCreateDate
 */
AdminGetDeviceResponseDevice.prototype['DeviceCreateDate'] = undefined;

/**
 * @member {Date} DeviceLastModifiedDate
 */
AdminGetDeviceResponseDevice.prototype['DeviceLastModifiedDate'] = undefined;

/**
 * @member {Date} DeviceLastAuthenticatedDate
 */
AdminGetDeviceResponseDevice.prototype['DeviceLastAuthenticatedDate'] = undefined;


// Implement DeviceType interface:
/**
 * @member {String} DeviceKey
 */
...
export default AdminGetDeviceResponseDevice;
