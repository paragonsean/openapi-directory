...
import DescribeUserPoolDomainResponseDomainDescription from './DescribeUserPoolDomainResponseDomainDescription';

/**
 * The DescribeUserPoolDomainResponse model module.
 * @module model/DescribeUserPoolDomainResponse
 * @version 2016-04-18
 */
class DescribeUserPoolDomainResponse {
    /**
     * Constructs a new <code>DescribeUserPoolDomainResponse</code>.
     * @alias module:model/DescribeUserPoolDomainResponse
     */
    constructor() { 
        
        DescribeUserPoolDomainResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeUserPoolDomainResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeUserPoolDomainResponse} obj Optional instance to populate.
     * @return {module:model/DescribeUserPoolDomainResponse} The populated <code>DescribeUserPoolDomainResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeUserPoolDomainResponse();

            if (data.hasOwnProperty('DomainDescription')) {
                obj['DomainDescription'] = DescribeUserPoolDomainResponseDomainDescription.constructFromObject(data['DomainDescription']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeUserPoolDomainResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeUserPoolDomainResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `DomainDescription`
        if (data['DomainDescription']) { // data not null
          DescribeUserPoolDomainResponseDomainDescription.validateJSON(data['DomainDescription']);
        }
...
/**
 * @member {module:model/DescribeUserPoolDomainResponseDomainDescription} DomainDescription
 */
DescribeUserPoolDomainResponse.prototype['DomainDescription'] = undefined;
...
export default DescribeUserPoolDomainResponse;
