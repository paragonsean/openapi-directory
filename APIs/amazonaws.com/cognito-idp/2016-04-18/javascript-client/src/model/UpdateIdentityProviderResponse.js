...
/**
 * The UpdateIdentityProviderResponse model module.
 * @module model/UpdateIdentityProviderResponse
 * @version 2016-04-18
 */
class UpdateIdentityProviderResponse {
    /**
     * Constructs a new <code>UpdateIdentityProviderResponse</code>.
     * @alias module:model/UpdateIdentityProviderResponse
     * @param identityProvider {module:model/DescribeIdentityProviderResponseIdentityProvider} 
     */
    constructor(identityProvider) { 
        
        UpdateIdentityProviderResponse.initialize(this, identityProvider);
    }
    ...
    /**
     * Constructs a <code>UpdateIdentityProviderResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateIdentityProviderResponse} obj Optional instance to populate.
     * @return {module:model/UpdateIdentityProviderResponse} The populated <code>UpdateIdentityProviderResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateIdentityProviderResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateIdentityProviderResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateIdentityProviderResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateIdentityProviderResponse.RequiredProperties) {
...
UpdateIdentityProviderResponse.RequiredProperties = ["IdentityProvider"];

/**
 * @member {module:model/DescribeIdentityProviderResponseIdentityProvider} IdentityProvider
 */
UpdateIdentityProviderResponse.prototype['IdentityProvider'] = undefined;
...
export default UpdateIdentityProviderResponse;
