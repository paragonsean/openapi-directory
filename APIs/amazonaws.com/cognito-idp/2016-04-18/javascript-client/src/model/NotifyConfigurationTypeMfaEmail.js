...
/**
 * The NotifyConfigurationTypeMfaEmail model module.
 * @module model/NotifyConfigurationTypeMfaEmail
 * @version 2016-04-18
 */
class NotifyConfigurationTypeMfaEmail {
    /**
     * Constructs a new <code>NotifyConfigurationTypeMfaEmail</code>.
     * @alias module:model/NotifyConfigurationTypeMfaEmail
     * @implements module:model/NotifyEmailType
     * @param subject {String} 
     */
    constructor(subject) { 
        NotifyEmailType.initialize(this, subject);
        NotifyConfigurationTypeMfaEmail.initialize(this, subject);
    }
    ...
    /**
     * Constructs a <code>NotifyConfigurationTypeMfaEmail</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NotifyConfigurationTypeMfaEmail} obj Optional instance to populate.
     * @return {module:model/NotifyConfigurationTypeMfaEmail} The populated <code>NotifyConfigurationTypeMfaEmail</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NotifyConfigurationTypeMfaEmail();
    ...
    /**
     * Validates the JSON data with respect to <code>NotifyConfigurationTypeMfaEmail</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NotifyConfigurationTypeMfaEmail</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of NotifyConfigurationTypeMfaEmail.RequiredProperties) {
...
NotifyConfigurationTypeMfaEmail.RequiredProperties = ["Subject"];

/**
 * @member {String} Subject
 */
NotifyConfigurationTypeMfaEmail.prototype['Subject'] = undefined;

/**
 * @member {String} HtmlBody
 */
NotifyConfigurationTypeMfaEmail.prototype['HtmlBody'] = undefined;

/**
 * @member {String} TextBody
 */
NotifyConfigurationTypeMfaEmail.prototype['TextBody'] = undefined;
...
export default NotifyConfigurationTypeMfaEmail;
