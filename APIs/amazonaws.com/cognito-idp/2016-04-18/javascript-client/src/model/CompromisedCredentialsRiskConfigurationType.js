...
/**
 * The CompromisedCredentialsRiskConfigurationType model module.
 * @module model/CompromisedCredentialsRiskConfigurationType
 * @version 2016-04-18
 */
class CompromisedCredentialsRiskConfigurationType {
    /**
     * Constructs a new <code>CompromisedCredentialsRiskConfigurationType</code>.
     * The compromised credentials risk configuration type.
     * @alias module:model/CompromisedCredentialsRiskConfigurationType
    ...
    /**
     * Constructs a <code>CompromisedCredentialsRiskConfigurationType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CompromisedCredentialsRiskConfigurationType} obj Optional instance to populate.
     * @return {module:model/CompromisedCredentialsRiskConfigurationType} The populated <code>CompromisedCredentialsRiskConfigurationType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CompromisedCredentialsRiskConfigurationType();
    ...
    /**
     * Validates the JSON data with respect to <code>CompromisedCredentialsRiskConfigurationType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CompromisedCredentialsRiskConfigurationType</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CompromisedCredentialsRiskConfigurationType.RequiredProperties) {
...
CompromisedCredentialsRiskConfigurationType.RequiredProperties = ["Actions"];
...
export default CompromisedCredentialsRiskConfigurationType;
