...
/**
 * The UpdateUserPoolRequestPolicies model module.
 * @module model/UpdateUserPoolRequestPolicies
 * @version 2016-04-18
 */
class UpdateUserPoolRequestPolicies {
    /**
     * Constructs a new <code>UpdateUserPoolRequestPolicies</code>.
     * @alias module:model/UpdateUserPoolRequestPolicies
     * @implements module:model/UserPoolPolicyType
     */
    constructor() { 
        UserPoolPolicyType.initialize(this);
        UpdateUserPoolRequestPolicies.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateUserPoolRequestPolicies</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateUserPoolRequestPolicies} obj Optional instance to populate.
     * @return {module:model/UpdateUserPoolRequestPolicies} The populated <code>UpdateUserPoolRequestPolicies</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateUserPoolRequestPolicies();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateUserPoolRequestPolicies</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateUserPoolRequestPolicies</code>.
     */
 ...
 */
UpdateUserPoolRequestPolicies.prototype['PasswordPolicy'] = undefined;
...
export default UpdateUserPoolRequestPolicies;
