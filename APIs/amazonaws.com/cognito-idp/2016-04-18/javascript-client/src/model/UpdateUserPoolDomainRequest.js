...
import UpdateUserPoolDomainRequestCustomDomainConfig from './UpdateUserPoolDomainRequestCustomDomainConfig';

/**
 * The UpdateUserPoolDomainRequest model module.
 * @module model/UpdateUserPoolDomainRequest
 * @version 2016-04-18
 */
class UpdateUserPoolDomainRequest {
    /**
     * Constructs a new <code>UpdateUserPoolDomainRequest</code>.
     * The UpdateUserPoolDomain request input.
     * @alias module:model/UpdateUserPoolDomainRequest
     * @param domain {String} 
     * @param userPoolId {String} 
     * @param customDomainConfig {module:model/UpdateUserPoolDomainRequestCustomDomainConfig} 
     */
    constructor(domain, userPoolId, customDomainConfig) { 
        
        UpdateUserPoolDomainRequest.initialize(this, domain, userPoolId, customDomainConfig);
    }
     ...
     */
    static initialize(obj, domain, userPoolId, customDomainConfig) { 
        obj['Domain'] = domain;
        obj['UserPoolId'] = userPoolId;
        obj['CustomDomainConfig'] = customDomainConfig;
    }

    /**
     * Constructs a <code>UpdateUserPoolDomainRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateUserPoolDomainRequest} obj Optional instance to populate.
     * @return {module:model/UpdateUserPoolDomainRequest} The populated <code>UpdateUserPoolDomainRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateUserPoolDomainRequest();
            ...
            if (data.hasOwnProperty('CustomDomainConfig')) {
                obj['CustomDomainConfig'] = UpdateUserPoolDomainRequestCustomDomainConfig.constructFromObject(data['CustomDomainConfig']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateUserPoolDomainRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateUserPoolDomainRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateUserPoolDomainRequest.RequiredProperties) {
        ...
        if (data['CustomDomainConfig']) { // data not null
          UpdateUserPoolDomainRequestCustomDomainConfig.validateJSON(data['CustomDomainConfig']);
        }
...
UpdateUserPoolDomainRequest.RequiredProperties = ["Domain", "UserPoolId", "CustomDomainConfig"];

/**
 * @member {String} Domain
 */
UpdateUserPoolDomainRequest.prototype['Domain'] = undefined;

/**
 * @member {String} UserPoolId
 */
UpdateUserPoolDomainRequest.prototype['UserPoolId'] = undefined;

/**
 * @member {module:model/UpdateUserPoolDomainRequestCustomDomainConfig} CustomDomainConfig
 */
UpdateUserPoolDomainRequest.prototype['CustomDomainConfig'] = undefined;
...
export default UpdateUserPoolDomainRequest;
