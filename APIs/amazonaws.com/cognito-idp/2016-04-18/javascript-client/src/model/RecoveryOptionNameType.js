...
* @readonly
*/
export default class RecoveryOptionNameType {
    ...
    /**
    * Returns a <code>RecoveryOptionNameType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/RecoveryOptionNameType} The enum <code>RecoveryOptionNameType</code> value.
    */
