...
import InitiateAuthRequestAnalyticsMetadata from './InitiateAuthRequestAnalyticsMetadata';

/**
 * The InitiateAuthRequest model module.
 * @module model/InitiateAuthRequest
 * @version 2016-04-18
 */
class InitiateAuthRequest {
    /**
     * Constructs a new <code>InitiateAuthRequest</code>.
     * Initiates the authentication request.
     * @alias module:model/InitiateAuthRequest
     * @param authFlow {module:model/AuthFlowType} 
     * @param clientId {String} 
     */
    constructor(authFlow, clientId) { 
        
        InitiateAuthRequest.initialize(this, authFlow, clientId);
    }
     ...
     */
    static initialize(obj, authFlow, clientId) { 
        obj['AuthFlow'] = authFlow;
        obj['ClientId'] = clientId;
    }

    /**
     * Constructs a <code>InitiateAuthRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InitiateAuthRequest} obj Optional instance to populate.
     * @return {module:model/InitiateAuthRequest} The populated <code>InitiateAuthRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InitiateAuthRequest();
            ...
            if (data.hasOwnProperty('AnalyticsMetadata')) {
                obj['AnalyticsMetadata'] = InitiateAuthRequestAnalyticsMetadata.constructFromObject(data['AnalyticsMetadata']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>InitiateAuthRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InitiateAuthRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of InitiateAuthRequest.RequiredProperties) {
        ...
        if (data['AnalyticsMetadata']) { // data not null
          InitiateAuthRequestAnalyticsMetadata.validateJSON(data['AnalyticsMetadata']);
        }
...
InitiateAuthRequest.RequiredProperties = ["AuthFlow", "ClientId"];

/**
 * @member {module:model/AuthFlowType} AuthFlow
 */
InitiateAuthRequest.prototype['AuthFlow'] = undefined;

/**
 * @member {Object} AuthParameters
 */
InitiateAuthRequest.prototype['AuthParameters'] = undefined;

/**
 * @member {Object} ClientMetadata
 */
InitiateAuthRequest.prototype['ClientMetadata'] = undefined;

/**
 * @member {String} ClientId
 */
InitiateAuthRequest.prototype['ClientId'] = undefined;

/**
 * @member {module:model/InitiateAuthRequestAnalyticsMetadata} AnalyticsMetadata
 */
InitiateAuthRequest.prototype['AnalyticsMetadata'] = undefined;

/**
 * @member {module:model/ConfirmForgotPasswordRequestUserContextData} UserContextData
 */
InitiateAuthRequest.prototype['UserContextData'] = undefined;
