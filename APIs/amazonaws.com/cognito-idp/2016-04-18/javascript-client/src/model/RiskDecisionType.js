...
* @readonly
*/
export default class RiskDecisionType {
    ...
    /**
    * Returns a <code>RiskDecisionType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/RiskDecisionType} The enum <code>RiskDecisionType</code> value.
    */
