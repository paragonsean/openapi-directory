...
/**
 * The AdminListDevicesResponse model module.
 * @module model/AdminListDevicesResponse
 * @version 2016-04-18
 */
class AdminListDevicesResponse {
    /**
     * Constructs a new <code>AdminListDevicesResponse</code>.
     * Lists the device&#39;s response, as an administrator.
     * @alias module:model/AdminListDevicesResponse
     */
    constructor() { 
        
        AdminListDevicesResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AdminListDevicesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdminListDevicesResponse} obj Optional instance to populate.
     * @return {module:model/AdminListDevicesResponse} The populated <code>AdminListDevicesResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdminListDevicesResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>AdminListDevicesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdminListDevicesResponse</code>.
     */
 ...
 */
AdminListDevicesResponse.prototype['Devices'] = undefined;

/**
 * @member {String} PaginationToken
 */
AdminListDevicesResponse.prototype['PaginationToken'] = undefined;
...
export default AdminListDevicesResponse;
