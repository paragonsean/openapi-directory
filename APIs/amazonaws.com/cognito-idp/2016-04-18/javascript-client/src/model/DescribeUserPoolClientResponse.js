...
import DescribeUserPoolClientResponseUserPoolClient from './DescribeUserPoolClientResponseUserPoolClient';

/**
 * The DescribeUserPoolClientResponse model module.
 * @module model/DescribeUserPoolClientResponse
 * @version 2016-04-18
 */
class DescribeUserPoolClientResponse {
    /**
     * Constructs a new <code>DescribeUserPoolClientResponse</code>.
     * Represents the response from the server from a request to describe the user pool client.
     * @alias module:model/DescribeUserPoolClientResponse
     */
    constructor() { 
        
        DescribeUserPoolClientResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeUserPoolClientResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeUserPoolClientResponse} obj Optional instance to populate.
     * @return {module:model/DescribeUserPoolClientResponse} The populated <code>DescribeUserPoolClientResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeUserPoolClientResponse();

            if (data.hasOwnProperty('UserPoolClient')) {
                obj['UserPoolClient'] = DescribeUserPoolClientResponseUserPoolClient.constructFromObject(data['UserPoolClient']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeUserPoolClientResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeUserPoolClientResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `UserPoolClient`
        if (data['UserPoolClient']) { // data not null
          DescribeUserPoolClientResponseUserPoolClient.validateJSON(data['UserPoolClient']);
        }
...
/**
 * @member {module:model/DescribeUserPoolClientResponseUserPoolClient} UserPoolClient
 */
DescribeUserPoolClientResponse.prototype['UserPoolClient'] = undefined;
...
export default DescribeUserPoolClientResponse;
