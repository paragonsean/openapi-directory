...
/**
 * The EventContextDataType model module.
 * @module model/EventContextDataType
 * @version 2016-04-18
 */
class EventContextDataType {
    /**
     * Constructs a new <code>EventContextDataType</code>.
     * Specifies the user context data captured at the time of an event request.
     * @alias module:model/EventContextDataType
     */
    constructor() { 
        
        EventContextDataType.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EventContextDataType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EventContextDataType} obj Optional instance to populate.
     * @return {module:model/EventContextDataType} The populated <code>EventContextDataType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EventContextDataType();
    ...
    /**
     * Validates the JSON data with respect to <code>EventContextDataType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EventContextDataType</code>.
     */
 ...
 */
EventContextDataType.prototype['IpAddress'] = undefined;

/**
 * @member {String} DeviceName
 */
EventContextDataType.prototype['DeviceName'] = undefined;

/**
 * @member {String} Timezone
 */
EventContextDataType.prototype['Timezone'] = undefined;

/**
 * @member {String} City
 */
EventContextDataType.prototype['City'] = undefined;

/**
 * @member {String} Country
 */
EventContextDataType.prototype['Country'] = undefined;
...
export default EventContextDataType;
