...
/**
 * The AdminSetUserSettingsRequest model module.
 * @module model/AdminSetUserSettingsRequest
 * @version 2016-04-18
 */
class AdminSetUserSettingsRequest {
    /**
     * Constructs a new <code>AdminSetUserSettingsRequest</code>.
     * You can use this parameter to set an MFA configuration that uses the SMS delivery medium.
     * @alias module:model/AdminSetUserSettingsRequest
     * @param userPoolId {String} 
     * @param username {String} 
     * @param mFAOptions {Array} 
     */
    constructor(userPoolId, username, mFAOptions) { 
        
        AdminSetUserSettingsRequest.initialize(this, userPoolId, username, mFAOptions);
    }
     ...
     */
    static initialize(obj, userPoolId, username, mFAOptions) { 
        obj['UserPoolId'] = userPoolId;
        obj['Username'] = username;
        obj['MFAOptions'] = mFAOptions;
    }

    /**
     * Constructs a <code>AdminSetUserSettingsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdminSetUserSettingsRequest} obj Optional instance to populate.
     * @return {module:model/AdminSetUserSettingsRequest} The populated <code>AdminSetUserSettingsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdminSetUserSettingsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>AdminSetUserSettingsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdminSetUserSettingsRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AdminSetUserSettingsRequest.RequiredProperties) {
...
AdminSetUserSettingsRequest.RequiredProperties = ["UserPoolId", "Username", "MFAOptions"];

/**
 * @member {String} UserPoolId
 */
AdminSetUserSettingsRequest.prototype['UserPoolId'] = undefined;

/**
 * @member {String} Username
 */
AdminSetUserSettingsRequest.prototype['Username'] = undefined;

/**
 * @member {Array} MFAOptions
 */
AdminSetUserSettingsRequest.prototype['MFAOptions'] = undefined;
...
export default AdminSetUserSettingsRequest;
