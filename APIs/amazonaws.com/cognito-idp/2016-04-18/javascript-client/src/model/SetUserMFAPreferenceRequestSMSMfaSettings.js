...
/**
 * The SetUserMFAPreferenceRequestSMSMfaSettings model module.
 * @module model/SetUserMFAPreferenceRequestSMSMfaSettings
 * @version 2016-04-18
 */
class SetUserMFAPreferenceRequestSMSMfaSettings {
    /**
     * Constructs a new <code>SetUserMFAPreferenceRequestSMSMfaSettings</code>.
     * @alias module:model/SetUserMFAPreferenceRequestSMSMfaSettings
     * @implements module:model/SMSMfaSettingsType
     */
    constructor() { 
        SMSMfaSettingsType.initialize(this);
        SetUserMFAPreferenceRequestSMSMfaSettings.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SetUserMFAPreferenceRequestSMSMfaSettings</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SetUserMFAPreferenceRequestSMSMfaSettings} obj Optional instance to populate.
     * @return {module:model/SetUserMFAPreferenceRequestSMSMfaSettings} The populated <code>SetUserMFAPreferenceRequestSMSMfaSettings</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SetUserMFAPreferenceRequestSMSMfaSettings();
    ...
    /**
     * Validates the JSON data with respect to <code>SetUserMFAPreferenceRequestSMSMfaSettings</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SetUserMFAPreferenceRequestSMSMfaSettings</code>.
     */
 ...
 */
SetUserMFAPreferenceRequestSMSMfaSettings.prototype['Enabled'] = undefined;

/**
 * @member {Boolean} PreferredMfa
 */
SetUserMFAPreferenceRequestSMSMfaSettings.prototype['PreferredMfa'] = undefined;
...
export default SetUserMFAPreferenceRequestSMSMfaSettings;
