...
/**
 * The RiskConfigurationTypeCompromisedCredentialsRiskConfiguration model module.
 * @module model/RiskConfigurationTypeCompromisedCredentialsRiskConfiguration
 * @version 2016-04-18
 */
class RiskConfigurationTypeCompromisedCredentialsRiskConfiguration {
    /**
     * Constructs a new <code>RiskConfigurationTypeCompromisedCredentialsRiskConfiguration</code>.
     * @alias module:model/RiskConfigurationTypeCompromisedCredentialsRiskConfiguration
    ...
    constructor(actions) { 
        ...
        RiskConfigurationTypeCompromisedCredentialsRiskConfiguration.initialize(this, actions);
    }
    ...
    /**
     * Constructs a <code>RiskConfigurationTypeCompromisedCredentialsRiskConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RiskConfigurationTypeCompromisedCredentialsRiskConfiguration} obj Optional instance to populate.
     * @return {module:model/RiskConfigurationTypeCompromisedCredentialsRiskConfiguration} The populated <code>RiskConfigurationTypeCompromisedCredentialsRiskConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RiskConfigurationTypeCompromisedCredentialsRiskConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>RiskConfigurationTypeCompromisedCredentialsRiskConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RiskConfigurationTypeCompromisedCredentialsRiskConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RiskConfigurationTypeCompromisedCredentialsRiskConfiguration.RequiredProperties) {
...
RiskConfigurationTypeCompromisedCredentialsRiskConfiguration.RequiredProperties = ["Actions"];

/**
 * @member {Array} EventFilter
 */
RiskConfigurationTypeCompromisedCredentialsRiskConfiguration.prototype['EventFilter'] = undefined;

/**
 * @member {module:model/CompromisedCredentialsRiskConfigurationTypeActions} Actions
 */
RiskConfigurationTypeCompromisedCredentialsRiskConfiguration.prototype['Actions'] = undefined;
...
export default RiskConfigurationTypeCompromisedCredentialsRiskConfiguration;
