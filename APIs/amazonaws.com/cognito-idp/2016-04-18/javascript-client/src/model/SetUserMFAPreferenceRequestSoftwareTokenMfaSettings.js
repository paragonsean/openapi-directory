...
/**
 * The SetUserMFAPreferenceRequestSoftwareTokenMfaSettings model module.
 * @module model/SetUserMFAPreferenceRequestSoftwareTokenMfaSettings
 * @version 2016-04-18
 */
class SetUserMFAPreferenceRequestSoftwareTokenMfaSettings {
    /**
     * Constructs a new <code>SetUserMFAPreferenceRequestSoftwareTokenMfaSettings</code>.
     * @alias module:model/SetUserMFAPreferenceRequestSoftwareTokenMfaSettings
     * @implements module:model/SoftwareTokenMfaSettingsType
     */
    constructor() { 
        SoftwareTokenMfaSettingsType.initialize(this);
        SetUserMFAPreferenceRequestSoftwareTokenMfaSettings.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SetUserMFAPreferenceRequestSoftwareTokenMfaSettings</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SetUserMFAPreferenceRequestSoftwareTokenMfaSettings} obj Optional instance to populate.
     * @return {module:model/SetUserMFAPreferenceRequestSoftwareTokenMfaSettings} The populated <code>SetUserMFAPreferenceRequestSoftwareTokenMfaSettings</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SetUserMFAPreferenceRequestSoftwareTokenMfaSettings();
            SoftwareTokenMfaSettingsType.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>SetUserMFAPreferenceRequestSoftwareTokenMfaSettings</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SetUserMFAPreferenceRequestSoftwareTokenMfaSettings</code>.
     */
 ...
 */
SetUserMFAPreferenceRequestSoftwareTokenMfaSettings.prototype['Enabled'] = undefined;

/**
 * @member {Boolean} PreferredMfa
 */
SetUserMFAPreferenceRequestSoftwareTokenMfaSettings.prototype['PreferredMfa'] = undefined;


// Implement SoftwareTokenMfaSettingsType interface:
/**
 * @member {Boolean} Enabled
 */
...
export default SetUserMFAPreferenceRequestSoftwareTokenMfaSettings;
