...
import SetUserMFAPreferenceRequestSMSMfaSettings from './SetUserMFAPreferenceRequestSMSMfaSettings';
import SetUserMFAPreferenceRequestSoftwareTokenMfaSettings from './SetUserMFAPreferenceRequestSoftwareTokenMfaSettings';

/**
 * The SetUserMFAPreferenceRequest model module.
 * @module model/SetUserMFAPreferenceRequest
 * @version 2016-04-18
 */
class SetUserMFAPreferenceRequest {
    /**
     * Constructs a new <code>SetUserMFAPreferenceRequest</code>.
     * @alias module:model/SetUserMFAPreferenceRequest
     * @param accessToken {String} 
     */
    constructor(accessToken) { 
        
        SetUserMFAPreferenceRequest.initialize(this, accessToken);
    }
    ...
    /**
     * Constructs a <code>SetUserMFAPreferenceRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SetUserMFAPreferenceRequest} obj Optional instance to populate.
     * @return {module:model/SetUserMFAPreferenceRequest} The populated <code>SetUserMFAPreferenceRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SetUserMFAPreferenceRequest();

            if (data.hasOwnProperty('SMSMfaSettings')) {
                obj['SMSMfaSettings'] = SetUserMFAPreferenceRequestSMSMfaSettings.constructFromObject(data['SMSMfaSettings']);
            }
            if (data.hasOwnProperty('SoftwareTokenMfaSettings')) {
                obj['SoftwareTokenMfaSettings'] = SetUserMFAPreferenceRequestSoftwareTokenMfaSettings.constructFromObject(data['SoftwareTokenMfaSettings']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>SetUserMFAPreferenceRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SetUserMFAPreferenceRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SetUserMFAPreferenceRequest.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `SMSMfaSettings`
        if (data['SMSMfaSettings']) { // data not null
          SetUserMFAPreferenceRequestSMSMfaSettings.validateJSON(data['SMSMfaSettings']);
        }
        // validate the optional field `SoftwareTokenMfaSettings`
        if (data['SoftwareTokenMfaSettings']) { // data not null
          SetUserMFAPreferenceRequestSoftwareTokenMfaSettings.validateJSON(data['SoftwareTokenMfaSettings']);
        }
...
SetUserMFAPreferenceRequest.RequiredProperties = ["AccessToken"];

/**
 * @member {module:model/SetUserMFAPreferenceRequestSMSMfaSettings} SMSMfaSettings
 */
SetUserMFAPreferenceRequest.prototype['SMSMfaSettings'] = undefined;

/**
 * @member {module:model/SetUserMFAPreferenceRequestSoftwareTokenMfaSettings} SoftwareTokenMfaSettings
 */
SetUserMFAPreferenceRequest.prototype['SoftwareTokenMfaSettings'] = undefined;

/**
 * @member {String} AccessToken
 */
SetUserMFAPreferenceRequest.prototype['AccessToken'] = undefined;
...
export default SetUserMFAPreferenceRequest;
