...
/**
 * The GetDeviceRequest model module.
 * @module model/GetDeviceRequest
 * @version 2016-04-18
 */
class GetDeviceRequest {
    /**
     * Constructs a new <code>GetDeviceRequest</code>.
     * Represents the request to get the device.
     * @alias module:model/GetDeviceRequest
     * @param deviceKey {String} 
     */
    constructor(deviceKey) { 
        
        GetDeviceRequest.initialize(this, deviceKey);
    }
     ...
     */
    static initialize(obj, deviceKey) { 
        obj['DeviceKey'] = deviceKey;
    }

    /**
     * Constructs a <code>GetDeviceRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetDeviceRequest} obj Optional instance to populate.
     * @return {module:model/GetDeviceRequest} The populated <code>GetDeviceRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetDeviceRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GetDeviceRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetDeviceRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetDeviceRequest.RequiredProperties) {
...
GetDeviceRequest.RequiredProperties = ["DeviceKey"];

/**
 * @member {String} DeviceKey
 */
GetDeviceRequest.prototype['DeviceKey'] = undefined;

/**
 * @member {String} AccessToken
 */
GetDeviceRequest.prototype['AccessToken'] = undefined;
