...
/**
 * The RiskConfigurationType model module.
 * @module model/RiskConfigurationType
 * @version 2016-04-18
 */
class RiskConfigurationType {
    /**
     * Constructs a new <code>RiskConfigurationType</code>.
     * The risk configuration type.
     * @alias module:model/RiskConfigurationType
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>RiskConfigurationType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RiskConfigurationType} obj Optional instance to populate.
     * @return {module:model/RiskConfigurationType} The populated <code>RiskConfigurationType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RiskConfigurationType();
    ...
    /**
     * Validates the JSON data with respect to <code>RiskConfigurationType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RiskConfigurationType</code>.
     */
...
export default RiskConfigurationType;
