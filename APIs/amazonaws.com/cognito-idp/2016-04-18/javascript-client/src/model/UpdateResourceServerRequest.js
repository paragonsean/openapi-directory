...
/**
 * The UpdateResourceServerRequest model module.
 * @module model/UpdateResourceServerRequest
 * @version 2016-04-18
 */
class UpdateResourceServerRequest {
    /**
     * Constructs a new <code>UpdateResourceServerRequest</code>.
     * @alias module:model/UpdateResourceServerRequest
     * @param userPoolId {String} 
     * @param identifier {String} 
     * @param name {String} 
     */
    constructor(userPoolId, identifier, name) { 
        
        UpdateResourceServerRequest.initialize(this, userPoolId, identifier, name);
    }
     ...
     */
    static initialize(obj, userPoolId, identifier, name) { 
    ...
    /**
     * Constructs a <code>UpdateResourceServerRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateResourceServerRequest} obj Optional instance to populate.
     * @return {module:model/UpdateResourceServerRequest} The populated <code>UpdateResourceServerRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateResourceServerRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateResourceServerRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateResourceServerRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateResourceServerRequest.RequiredProperties) {
...
UpdateResourceServerRequest.RequiredProperties = ["UserPoolId", "Identifier", "Name"];

/**
 * @member {String} UserPoolId
 */
UpdateResourceServerRequest.prototype['UserPoolId'] = undefined;

/**
 * @member {String} Identifier
 */
UpdateResourceServerRequest.prototype['Identifier'] = undefined;

/**
 * @member {String} Name
 */
UpdateResourceServerRequest.prototype['Name'] = undefined;

/**
 * @member {Array} Scopes
 */
UpdateResourceServerRequest.prototype['Scopes'] = undefined;
...
export default UpdateResourceServerRequest;
