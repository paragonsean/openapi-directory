...
/**
 * The AdminListDevicesRequest model module.
 * @module model/AdminListDevicesRequest
 * @version 2016-04-18
 */
class AdminListDevicesRequest {
    /**
     * Constructs a new <code>AdminListDevicesRequest</code>.
     * Represents the request to list devices, as an administrator.
     * @alias module:model/AdminListDevicesRequest
     * @param userPoolId {String} 
     * @param username {String} 
     */
    constructor(userPoolId, username) { 
        
        AdminListDevicesRequest.initialize(this, userPoolId, username);
    }
    ...
    /**
     * Constructs a <code>AdminListDevicesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdminListDevicesRequest} obj Optional instance to populate.
     * @return {module:model/AdminListDevicesRequest} The populated <code>AdminListDevicesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdminListDevicesRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>AdminListDevicesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdminListDevicesRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AdminListDevicesRequest.RequiredProperties) {
...
AdminListDevicesRequest.RequiredProperties = ["UserPoolId", "Username"];

/**
 * @member {String} UserPoolId
 */
AdminListDevicesRequest.prototype['UserPoolId'] = undefined;

/**
 * @member {String} Username
 */
AdminListDevicesRequest.prototype['Username'] = undefined;

/**
 * @member {Number} Limit
 */
AdminListDevicesRequest.prototype['Limit'] = undefined;

/**
 * @member {String} PaginationToken
 */
AdminListDevicesRequest.prototype['PaginationToken'] = undefined;
...
export default AdminListDevicesRequest;
