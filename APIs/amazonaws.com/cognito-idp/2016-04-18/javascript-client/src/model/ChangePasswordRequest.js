...
class ChangePasswordRequest {
     ...
     * @param proposedPassword {String} 
     * @param accessToken {String} 
     */
    constructor(previousPassword, proposedPassword, accessToken) { 
        
        ChangePasswordRequest.initialize(this, previousPassword, proposedPassword, accessToken);
    }
     ...
     */
    static initialize(obj, previousPassword, proposedPassword, accessToken) { 
        obj['PreviousPassword'] = previousPassword;
        obj['ProposedPassword'] = proposedPassword;
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('PreviousPassword')) {
                obj['PreviousPassword'] = ApiClient.convertToType(data['PreviousPassword'], 'String');
            }
            if (data.hasOwnProperty('ProposedPassword')) {
                obj['ProposedPassword'] = ApiClient.convertToType(data['ProposedPassword'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        // validate the optional field `PreviousPassword`
        if (data['PreviousPassword']) { // data not null
          String.validateJSON(data['PreviousPassword']);
        }
        // validate the optional field `ProposedPassword`
        if (data['ProposedPassword']) { // data not null
          String.validateJSON(data['ProposedPassword']);
        }
...
ChangePasswordRequest.RequiredProperties = ["PreviousPassword", "ProposedPassword", "AccessToken"];

/**
 * @member {String} PreviousPassword
 */
ChangePasswordRequest.prototype['PreviousPassword'] = undefined;

/**
 * @member {String} ProposedPassword
 */
ChangePasswordRequest.prototype['ProposedPassword'] = undefined;

/**
 * @member {String} AccessToken
 */
ChangePasswordRequest.prototype['AccessToken'] = undefined;
