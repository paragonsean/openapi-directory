...
import CreateUserImportJobResponseUserImportJob from './CreateUserImportJobResponseUserImportJob';

/**
 * The DescribeUserImportJobResponse model module.
 * @module model/DescribeUserImportJobResponse
 * @version 2016-04-18
 */
class DescribeUserImportJobResponse {
    /**
     * Constructs a new <code>DescribeUserImportJobResponse</code>.
     * Represents the response from the server to the request to describe the user import job.
     * @alias module:model/DescribeUserImportJobResponse
     */
    constructor() { 
        
        DescribeUserImportJobResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeUserImportJobResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeUserImportJobResponse} obj Optional instance to populate.
     * @return {module:model/DescribeUserImportJobResponse} The populated <code>DescribeUserImportJobResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeUserImportJobResponse();

            if (data.hasOwnProperty('UserImportJob')) {
                obj['UserImportJob'] = CreateUserImportJobResponseUserImportJob.constructFromObject(data['UserImportJob']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeUserImportJobResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeUserImportJobResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `UserImportJob`
        if (data['UserImportJob']) { // data not null
          CreateUserImportJobResponseUserImportJob.validateJSON(data['UserImportJob']);
        }
...
/**
 * @member {module:model/CreateUserImportJobResponseUserImportJob} UserImportJob
 */
DescribeUserImportJobResponse.prototype['UserImportJob'] = undefined;
...
export default DescribeUserImportJobResponse;
