...
* @readonly
*/
export default class ChallengeName {
    ...
    /**
    * Returns a <code>ChallengeName</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ChallengeName} The enum <code>ChallengeName</code> value.
    */
