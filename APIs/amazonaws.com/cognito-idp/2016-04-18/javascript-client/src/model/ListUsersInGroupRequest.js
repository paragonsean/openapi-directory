...
/**
 * The ListUsersInGroupRequest model module.
 * @module model/ListUsersInGroupRequest
 * @version 2016-04-18
 */
class ListUsersInGroupRequest {
    /**
     * Constructs a new <code>ListUsersInGroupRequest</code>.
     * @alias module:model/ListUsersInGroupRequest
     * @param userPoolId {String} 
     * @param groupName {String} 
     */
    constructor(userPoolId, groupName) { 
        
        ListUsersInGroupRequest.initialize(this, userPoolId, groupName);
    }
     ...
     */
    static initialize(obj, userPoolId, groupName) { 
        obj['UserPoolId'] = userPoolId;
        obj['GroupName'] = groupName;
    }

    /**
     * Constructs a <code>ListUsersInGroupRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListUsersInGroupRequest} obj Optional instance to populate.
     * @return {module:model/ListUsersInGroupRequest} The populated <code>ListUsersInGroupRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListUsersInGroupRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListUsersInGroupRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListUsersInGroupRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListUsersInGroupRequest.RequiredProperties) {
...
ListUsersInGroupRequest.RequiredProperties = ["UserPoolId", "GroupName"];

/**
 * @member {String} UserPoolId
 */
ListUsersInGroupRequest.prototype['UserPoolId'] = undefined;

/**
 * @member {String} GroupName
 */
ListUsersInGroupRequest.prototype['GroupName'] = undefined;

/**
 * @member {Number} Limit
 */
ListUsersInGroupRequest.prototype['Limit'] = undefined;

/**
 * @member {String} NextToken
 */
ListUsersInGroupRequest.prototype['NextToken'] = undefined;
...
export default ListUsersInGroupRequest;
