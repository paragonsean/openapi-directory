...
* @readonly
*/
export default class CompromisedCredentialsEventActionType {
    ...
    /**
    * Returns a <code>CompromisedCredentialsEventActionType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/CompromisedCredentialsEventActionType} The enum <code>CompromisedCredentialsEventActionType</code> value.
    */
