...
* @readonly
*/
export default class PreventUserExistenceErrorTypes {
    ...
    /**
    * Returns a <code>PreventUserExistenceErrorTypes</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/PreventUserExistenceErrorTypes} The enum <code>PreventUserExistenceErrorTypes</code> value.
    */
