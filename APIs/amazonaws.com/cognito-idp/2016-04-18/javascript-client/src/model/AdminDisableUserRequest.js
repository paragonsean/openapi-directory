...
/**
 * The AdminDisableUserRequest model module.
 * @module model/AdminDisableUserRequest
 * @version 2016-04-18
 */
class AdminDisableUserRequest {
    /**
     * Constructs a new <code>AdminDisableUserRequest</code>.
     * Represents the request to disable the user as an administrator.
     * @alias module:model/AdminDisableUserRequest
     * @param userPoolId {String} 
     * @param username {String} 
     */
    constructor(userPoolId, username) { 
        
        AdminDisableUserRequest.initialize(this, userPoolId, username);
    }
    ...
    /**
     * Constructs a <code>AdminDisableUserRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdminDisableUserRequest} obj Optional instance to populate.
     * @return {module:model/AdminDisableUserRequest} The populated <code>AdminDisableUserRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdminDisableUserRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>AdminDisableUserRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdminDisableUserRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AdminDisableUserRequest.RequiredProperties) {
...
AdminDisableUserRequest.RequiredProperties = ["UserPoolId", "Username"];

/**
 * @member {String} UserPoolId
 */
AdminDisableUserRequest.prototype['UserPoolId'] = undefined;

/**
 * @member {String} Username
 */
AdminDisableUserRequest.prototype['Username'] = undefined;
...
export default AdminDisableUserRequest;
