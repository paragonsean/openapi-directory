...
/**
 * The InitiateAuthRequestAnalyticsMetadata model module.
 * @module model/InitiateAuthRequestAnalyticsMetadata
 * @version 2016-04-18
 */
class InitiateAuthRequestAnalyticsMetadata {
    /**
     * Constructs a new <code>InitiateAuthRequestAnalyticsMetadata</code>.
     * @alias module:model/InitiateAuthRequestAnalyticsMetadata
     * @implements module:model/AnalyticsMetadataType
     */
    constructor() { 
        AnalyticsMetadataType.initialize(this);
        InitiateAuthRequestAnalyticsMetadata.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InitiateAuthRequestAnalyticsMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InitiateAuthRequestAnalyticsMetadata} obj Optional instance to populate.
     * @return {module:model/InitiateAuthRequestAnalyticsMetadata} The populated <code>InitiateAuthRequestAnalyticsMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InitiateAuthRequestAnalyticsMetadata();
    ...
    /**
     * Validates the JSON data with respect to <code>InitiateAuthRequestAnalyticsMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InitiateAuthRequestAnalyticsMetadata</code>.
     */
 ...
 */
InitiateAuthRequestAnalyticsMetadata.prototype['AnalyticsEndpointId'] = undefined;
...
export default InitiateAuthRequestAnalyticsMetadata;
