...
/**
 * The CloudWatchLogsConfigurationType model module.
 * @module model/CloudWatchLogsConfigurationType
 * @version 2016-04-18
 */
class CloudWatchLogsConfigurationType {
    /**
     * Constructs a new <code>CloudWatchLogsConfigurationType</code>.
     * The CloudWatch logging destination of a user pool detailed activity logging configuration.
     * @alias module:model/CloudWatchLogsConfigurationType
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>CloudWatchLogsConfigurationType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CloudWatchLogsConfigurationType} obj Optional instance to populate.
     * @return {module:model/CloudWatchLogsConfigurationType} The populated <code>CloudWatchLogsConfigurationType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CloudWatchLogsConfigurationType();
    ...
    /**
     * Validates the JSON data with respect to <code>CloudWatchLogsConfigurationType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CloudWatchLogsConfigurationType</code>.
     */
...
export default CloudWatchLogsConfigurationType;
