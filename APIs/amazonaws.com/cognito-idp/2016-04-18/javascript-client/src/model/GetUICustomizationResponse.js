...
import GetUICustomizationResponseUICustomization from './GetUICustomizationResponseUICustomization';

/**
 * The GetUICustomizationResponse model module.
 * @module model/GetUICustomizationResponse
 * @version 2016-04-18
 */
class GetUICustomizationResponse {
    /**
     * Constructs a new <code>GetUICustomizationResponse</code>.
     * @alias module:model/GetUICustomizationResponse
     * @param uICustomization {module:model/GetUICustomizationResponseUICustomization} 
     */
    constructor(uICustomization) { 
        
        GetUICustomizationResponse.initialize(this, uICustomization);
    }
     ...
     */
    static initialize(obj, uICustomization) { 
        obj['UICustomization'] = uICustomization;
    }

    /**
     * Constructs a <code>GetUICustomizationResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetUICustomizationResponse} obj Optional instance to populate.
     * @return {module:model/GetUICustomizationResponse} The populated <code>GetUICustomizationResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetUICustomizationResponse();

            if (data.hasOwnProperty('UICustomization')) {
                obj['UICustomization'] = GetUICustomizationResponseUICustomization.constructFromObject(data['UICustomization']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetUICustomizationResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetUICustomizationResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetUICustomizationResponse.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `UICustomization`
        if (data['UICustomization']) { // data not null
          GetUICustomizationResponseUICustomization.validateJSON(data['UICustomization']);
        }
...
GetUICustomizationResponse.RequiredProperties = ["UICustomization"];

/**
 * @member {module:model/GetUICustomizationResponseUICustomization} UICustomization
 */
GetUICustomizationResponse.prototype['UICustomization'] = undefined;
...
export default GetUICustomizationResponse;
