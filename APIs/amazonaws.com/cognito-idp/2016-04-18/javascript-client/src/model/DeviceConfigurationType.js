...
/**
 * The DeviceConfigurationType model module.
 * @module model/DeviceConfigurationType
 * @version 2016-04-18
 */
class DeviceConfigurationType {
    /**
     * Constructs a new <code>DeviceConfigurationType</code>.
     ...
     * @alias module:model/DeviceConfigurationType
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>DeviceConfigurationType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeviceConfigurationType} obj Optional instance to populate.
     * @return {module:model/DeviceConfigurationType} The populated <code>DeviceConfigurationType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeviceConfigurationType();
    ...
    /**
     * Validates the JSON data with respect to <code>DeviceConfigurationType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeviceConfigurationType</code>.
     */
...
export default DeviceConfigurationType;
