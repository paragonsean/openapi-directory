...
/**
 * The SetRiskConfigurationRequestRiskExceptionConfiguration model module.
 * @module model/SetRiskConfigurationRequestRiskExceptionConfiguration
 * @version 2016-04-18
 */
class SetRiskConfigurationRequestRiskExceptionConfiguration {
    /**
     * Constructs a new <code>SetRiskConfigurationRequestRiskExceptionConfiguration</code>.
     * @alias module:model/SetRiskConfigurationRequestRiskExceptionConfiguration
     * @implements module:model/RiskExceptionConfigurationType
     */
    constructor() { 
        RiskExceptionConfigurationType.initialize(this);
        SetRiskConfigurationRequestRiskExceptionConfiguration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SetRiskConfigurationRequestRiskExceptionConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SetRiskConfigurationRequestRiskExceptionConfiguration} obj Optional instance to populate.
     * @return {module:model/SetRiskConfigurationRequestRiskExceptionConfiguration} The populated <code>SetRiskConfigurationRequestRiskExceptionConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SetRiskConfigurationRequestRiskExceptionConfiguration();
            RiskExceptionConfigurationType.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>SetRiskConfigurationRequestRiskExceptionConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SetRiskConfigurationRequestRiskExceptionConfiguration</code>.
     */
 ...
 */
SetRiskConfigurationRequestRiskExceptionConfiguration.prototype['BlockedIPRangeList'] = undefined;

/**
 * @member {Array} SkippedIPRangeList
 */
SetRiskConfigurationRequestRiskExceptionConfiguration.prototype['SkippedIPRangeList'] = undefined;


// Implement RiskExceptionConfigurationType interface:
/**
 * @member {Array} BlockedIPRangeList
 */
...
export default SetRiskConfigurationRequestRiskExceptionConfiguration;
