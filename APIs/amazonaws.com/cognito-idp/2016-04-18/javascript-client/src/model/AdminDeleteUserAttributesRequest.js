...
/**
 * The AdminDeleteUserAttributesRequest model module.
 * @module model/AdminDeleteUserAttributesRequest
 * @version 2016-04-18
 */
class AdminDeleteUserAttributesRequest {
    /**
     * Constructs a new <code>AdminDeleteUserAttributesRequest</code>.
     * Represents the request to delete user attributes as an administrator.
     * @alias module:model/AdminDeleteUserAttributesRequest
     * @param userPoolId {String} 
     * @param username {String} 
     * @param userAttributeNames {Array} 
     */
    constructor(userPoolId, username, userAttributeNames) { 
        
        AdminDeleteUserAttributesRequest.initialize(this, userPoolId, username, userAttributeNames);
    }
     ...
     */
    static initialize(obj, userPoolId, username, userAttributeNames) { 
        obj['UserPoolId'] = userPoolId;
        obj['Username'] = username;
        obj['UserAttributeNames'] = userAttributeNames;
    }

    /**
     * Constructs a <code>AdminDeleteUserAttributesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdminDeleteUserAttributesRequest} obj Optional instance to populate.
     * @return {module:model/AdminDeleteUserAttributesRequest} The populated <code>AdminDeleteUserAttributesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdminDeleteUserAttributesRequest();
            ...
            if (data.hasOwnProperty('UserAttributeNames')) {
                obj['UserAttributeNames'] = ApiClient.convertToType(data['UserAttributeNames'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AdminDeleteUserAttributesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdminDeleteUserAttributesRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AdminDeleteUserAttributesRequest.RequiredProperties) {
        ...
        // validate the optional field `UserAttributeNames`
        if (data['UserAttributeNames']) { // data not null
          Array.validateJSON(data['UserAttributeNames']);
        }
...
AdminDeleteUserAttributesRequest.RequiredProperties = ["UserPoolId", "Username", "UserAttributeNames"];

/**
 * @member {String} UserPoolId
 */
AdminDeleteUserAttributesRequest.prototype['UserPoolId'] = undefined;

/**
 * @member {String} Username
 */
AdminDeleteUserAttributesRequest.prototype['Username'] = undefined;

/**
 * @member {Array} UserAttributeNames
 */
AdminDeleteUserAttributesRequest.prototype['UserAttributeNames'] = undefined;
...
export default AdminDeleteUserAttributesRequest;
