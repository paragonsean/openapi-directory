...
import ConfirmDeviceRequestDeviceSecretVerifierConfig from './ConfirmDeviceRequestDeviceSecretVerifierConfig';

/**
 * The ConfirmDeviceRequest model module.
 * @module model/ConfirmDeviceRequest
 * @version 2016-04-18
 */
class ConfirmDeviceRequest {
    /**
     * Constructs a new <code>ConfirmDeviceRequest</code>.
     * Confirms the device request.
     * @alias module:model/ConfirmDeviceRequest
     * @param accessToken {String} 
     * @param deviceKey {String} 
     */
    constructor(accessToken, deviceKey) { 
        
        ConfirmDeviceRequest.initialize(this, accessToken, deviceKey);
    }
     ...
     */
    static initialize(obj, accessToken, deviceKey) { 
        obj['AccessToken'] = accessToken;
        obj['DeviceKey'] = deviceKey;
    }

    /**
     * Constructs a <code>ConfirmDeviceRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ConfirmDeviceRequest} obj Optional instance to populate.
     * @return {module:model/ConfirmDeviceRequest} The populated <code>ConfirmDeviceRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ConfirmDeviceRequest();
            ...
            if (data.hasOwnProperty('DeviceSecretVerifierConfig')) {
                obj['DeviceSecretVerifierConfig'] = ConfirmDeviceRequestDeviceSecretVerifierConfig.constructFromObject(data['DeviceSecretVerifierConfig']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ConfirmDeviceRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConfirmDeviceRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ConfirmDeviceRequest.RequiredProperties) {
        ...
        if (data['DeviceSecretVerifierConfig']) { // data not null
          ConfirmDeviceRequestDeviceSecretVerifierConfig.validateJSON(data['DeviceSecretVerifierConfig']);
        }
...
ConfirmDeviceRequest.RequiredProperties = ["AccessToken", "DeviceKey"];

/**
 * @member {String} AccessToken
 */
ConfirmDeviceRequest.prototype['AccessToken'] = undefined;

/**
 * @member {String} DeviceKey
 */
ConfirmDeviceRequest.prototype['DeviceKey'] = undefined;

/**
 * @member {module:model/ConfirmDeviceRequestDeviceSecretVerifierConfig} DeviceSecretVerifierConfig
 */
ConfirmDeviceRequest.prototype['DeviceSecretVerifierConfig'] = undefined;

/**
 * @member {String} DeviceName
 */
ConfirmDeviceRequest.prototype['DeviceName'] = undefined;
...
export default ConfirmDeviceRequest;
