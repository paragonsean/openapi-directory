...
* @readonly
*/
export default class AccountTakeoverEventActionType {
    ...
    /**
    * Returns a <code>AccountTakeoverEventActionType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/AccountTakeoverEventActionType} The enum <code>AccountTakeoverEventActionType</code> value.
    */
