...
/**
 * The EventFeedbackType model module.
 * @module model/EventFeedbackType
 * @version 2016-04-18
 */
class EventFeedbackType {
    /**
     * Constructs a new <code>EventFeedbackType</code>.
     * Specifies the event feedback type.
     * @alias module:model/EventFeedbackType
     * @param feedbackValue {module:model/FeedbackValueType} 
     * @param provider {String} 
     */
    constructor(feedbackValue, provider) { 
        
        EventFeedbackType.initialize(this, feedbackValue, provider);
    }
     ...
     */
    static initialize(obj, feedbackValue, provider) { 
        obj['FeedbackValue'] = feedbackValue;
        obj['Provider'] = provider;
    }

    /**
     * Constructs a <code>EventFeedbackType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EventFeedbackType} obj Optional instance to populate.
     * @return {module:model/EventFeedbackType} The populated <code>EventFeedbackType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EventFeedbackType();
            ...
            if (data.hasOwnProperty('FeedbackDate')) {
                obj['FeedbackDate'] = ApiClient.convertToType(data['FeedbackDate'], 'Date');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>EventFeedbackType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EventFeedbackType</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EventFeedbackType.RequiredProperties) {
        ...
        if (data['FeedbackDate']) { // data not null
          Date.validateJSON(data['FeedbackDate']);
        }
...
EventFeedbackType.RequiredProperties = ["FeedbackValue", "Provider"];

/**
 * @member {module:model/FeedbackValueType} FeedbackValue
 */
EventFeedbackType.prototype['FeedbackValue'] = undefined;

/**
 * @member {String} Provider
 */
EventFeedbackType.prototype['Provider'] = undefined;

/**
 * @member {Date} FeedbackDate
 */
EventFeedbackType.prototype['FeedbackDate'] = undefined;
...
export default EventFeedbackType;
