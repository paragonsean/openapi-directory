...
/**
 * The AuthenticationResultTypeNewDeviceMetadata model module.
 * @module model/AuthenticationResultTypeNewDeviceMetadata
 * @version 2016-04-18
 */
class AuthenticationResultTypeNewDeviceMetadata {
    /**
     * Constructs a new <code>AuthenticationResultTypeNewDeviceMetadata</code>.
     * @alias module:model/AuthenticationResultTypeNewDeviceMetadata
     * @implements module:model/NewDeviceMetadataType
     */
    constructor() { 
        NewDeviceMetadataType.initialize(this);
        AuthenticationResultTypeNewDeviceMetadata.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AuthenticationResultTypeNewDeviceMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AuthenticationResultTypeNewDeviceMetadata} obj Optional instance to populate.
     * @return {module:model/AuthenticationResultTypeNewDeviceMetadata} The populated <code>AuthenticationResultTypeNewDeviceMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AuthenticationResultTypeNewDeviceMetadata();
            NewDeviceMetadataType.constructFromObject(data, obj);

            if (data.hasOwnProperty('DeviceKey')) {
                obj['DeviceKey'] = ApiClient.convertToType(data['DeviceKey'], 'String');
            }
            if (data.hasOwnProperty('DeviceGroupKey')) {
                obj['DeviceGroupKey'] = ApiClient.convertToType(data['DeviceGroupKey'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AuthenticationResultTypeNewDeviceMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AuthenticationResultTypeNewDeviceMetadata</code>.
     */
    static validateJSON(data) {
        ...
        if (data['DeviceGroupKey']) { // data not null
          String.validateJSON(data['DeviceGroupKey']);
        }
 ...
 */
AuthenticationResultTypeNewDeviceMetadata.prototype['DeviceKey'] = undefined;

/**
 * @member {String} DeviceGroupKey
 */
AuthenticationResultTypeNewDeviceMetadata.prototype['DeviceGroupKey'] = undefined;


// Implement NewDeviceMetadataType interface:
/**
 * @member {String} DeviceKey
 */
NewDeviceMetadataType.prototype['DeviceKey'] = undefined;
/**
 * @member {String} DeviceGroupKey
 */
NewDeviceMetadataType.prototype['DeviceGroupKey'] = undefined;




export default AuthenticationResultTypeNewDeviceMetadata;
