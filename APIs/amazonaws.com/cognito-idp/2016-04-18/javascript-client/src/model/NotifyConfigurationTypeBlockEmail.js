...
/**
 * The NotifyConfigurationTypeBlockEmail model module.
 * @module model/NotifyConfigurationTypeBlockEmail
 * @version 2016-04-18
 */
class NotifyConfigurationTypeBlockEmail {
    /**
     * Constructs a new <code>NotifyConfigurationTypeBlockEmail</code>.
     * @alias module:model/NotifyConfigurationTypeBlockEmail
     * @implements module:model/NotifyEmailType
     * @param subject {String} 
     */
    constructor(subject) { 
        NotifyEmailType.initialize(this, subject);
        NotifyConfigurationTypeBlockEmail.initialize(this, subject);
    }
    ...
    /**
     * Constructs a <code>NotifyConfigurationTypeBlockEmail</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NotifyConfigurationTypeBlockEmail} obj Optional instance to populate.
     * @return {module:model/NotifyConfigurationTypeBlockEmail} The populated <code>NotifyConfigurationTypeBlockEmail</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NotifyConfigurationTypeBlockEmail();
            NotifyEmailType.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>NotifyConfigurationTypeBlockEmail</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NotifyConfigurationTypeBlockEmail</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of NotifyConfigurationTypeBlockEmail.RequiredProperties) {
...
NotifyConfigurationTypeBlockEmail.RequiredProperties = ["Subject"];

/**
 * @member {String} Subject
 */
NotifyConfigurationTypeBlockEmail.prototype['Subject'] = undefined;

/**
 * @member {String} HtmlBody
 */
NotifyConfigurationTypeBlockEmail.prototype['HtmlBody'] = undefined;

/**
 * @member {String} TextBody
 */
NotifyConfigurationTypeBlockEmail.prototype['TextBody'] = undefined;


// Implement NotifyEmailType interface:
/**
 * @member {String} Subject
 */
...
export default NotifyConfigurationTypeBlockEmail;
