...
/**
 * The DeleteUserAttributesRequest model module.
 * @module model/DeleteUserAttributesRequest
 * @version 2016-04-18
 */
class DeleteUserAttributesRequest {
    /**
     * Constructs a new <code>DeleteUserAttributesRequest</code>.
     * Represents the request to delete user attributes.
     * @alias module:model/DeleteUserAttributesRequest
     * @param userAttributeNames {Array} 
     * @param accessToken {String} 
     */
    constructor(userAttributeNames, accessToken) { 
        
        DeleteUserAttributesRequest.initialize(this, userAttributeNames, accessToken);
    }
     ...
     */
    static initialize(obj, userAttributeNames, accessToken) { 
        obj['UserAttributeNames'] = userAttributeNames;
        obj['AccessToken'] = accessToken;
    }

    /**
     * Constructs a <code>DeleteUserAttributesRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteUserAttributesRequest} obj Optional instance to populate.
     * @return {module:model/DeleteUserAttributesRequest} The populated <code>DeleteUserAttributesRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteUserAttributesRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteUserAttributesRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteUserAttributesRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteUserAttributesRequest.RequiredProperties) {
...
DeleteUserAttributesRequest.RequiredProperties = ["UserAttributeNames", "AccessToken"];

/**
 * @member {Array} UserAttributeNames
 */
DeleteUserAttributesRequest.prototype['UserAttributeNames'] = undefined;

/**
 * @member {String} AccessToken
 */
DeleteUserAttributesRequest.prototype['AccessToken'] = undefined;
...
export default DeleteUserAttributesRequest;
