...
* @readonly
*/
export default class EventSourceName {
    ...
    /**
    * Returns a <code>EventSourceName</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/EventSourceName} The enum <code>EventSourceName</code> value.
    */
