...
* @readonly
*/
export default class UserImportJobStatusType {
    ...
    /**
    * Returns a <code>UserImportJobStatusType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/UserImportJobStatusType} The enum <code>UserImportJobStatusType</code> value.
    */
