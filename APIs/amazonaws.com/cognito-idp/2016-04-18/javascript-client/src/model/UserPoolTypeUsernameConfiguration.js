...
/**
 * The UserPoolTypeUsernameConfiguration model module.
 * @module model/UserPoolTypeUsernameConfiguration
 * @version 2016-04-18
 */
class UserPoolTypeUsernameConfiguration {
    /**
     * Constructs a new <code>UserPoolTypeUsernameConfiguration</code>.
     * @alias module:model/UserPoolTypeUsernameConfiguration
     * @implements module:model/UsernameConfigurationType
     * @param caseSensitive {Boolean} 
     */
    constructor(caseSensitive) { 
        UsernameConfigurationType.initialize(this, caseSensitive);
        UserPoolTypeUsernameConfiguration.initialize(this, caseSensitive);
    }
     ...
     */
    static initialize(obj, caseSensitive) { 
        obj['CaseSensitive'] = caseSensitive;
    }

    /**
     * Constructs a <code>UserPoolTypeUsernameConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UserPoolTypeUsernameConfiguration} obj Optional instance to populate.
     * @return {module:model/UserPoolTypeUsernameConfiguration} The populated <code>UserPoolTypeUsernameConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UserPoolTypeUsernameConfiguration();
            UsernameConfigurationType.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>UserPoolTypeUsernameConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UserPoolTypeUsernameConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UserPoolTypeUsernameConfiguration.RequiredProperties) {
...
UserPoolTypeUsernameConfiguration.RequiredProperties = ["CaseSensitive"];

/**
 * @member {Boolean} CaseSensitive
 */
UserPoolTypeUsernameConfiguration.prototype['CaseSensitive'] = undefined;


// Implement UsernameConfigurationType interface:
/**
 * @member {Boolean} CaseSensitive
 */
UsernameConfigurationType.prototype['CaseSensitive'] = undefined;




export default UserPoolTypeUsernameConfiguration;
