...
import RespondToAuthChallengeResponseAuthenticationResult from './RespondToAuthChallengeResponseAuthenticationResult';

/**
 * The RespondToAuthChallengeResponse model module.
 * @module model/RespondToAuthChallengeResponse
 * @version 2016-04-18
 */
class RespondToAuthChallengeResponse {
    /**
     * Constructs a new <code>RespondToAuthChallengeResponse</code>.
     * The response to respond to the authentication challenge.
     * @alias module:model/RespondToAuthChallengeResponse
     */
    constructor() { 
        
        RespondToAuthChallengeResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RespondToAuthChallengeResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RespondToAuthChallengeResponse} obj Optional instance to populate.
     * @return {module:model/RespondToAuthChallengeResponse} The populated <code>RespondToAuthChallengeResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RespondToAuthChallengeResponse();
            ...
            if (data.hasOwnProperty('ChallengeParameters')) {
                obj['ChallengeParameters'] = ApiClient.convertToType(data['ChallengeParameters'], Object);
            }
            if (data.hasOwnProperty('AuthenticationResult')) {
                obj['AuthenticationResult'] = RespondToAuthChallengeResponseAuthenticationResult.constructFromObject(data['AuthenticationResult']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>RespondToAuthChallengeResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RespondToAuthChallengeResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['ChallengeParameters']) { // data not null
          Object.validateJSON(data['ChallengeParameters']);
        }
        // validate the optional field `AuthenticationResult`
        if (data['AuthenticationResult']) { // data not null
          RespondToAuthChallengeResponseAuthenticationResult.validateJSON(data['AuthenticationResult']);
        }
 ...
 */
RespondToAuthChallengeResponse.prototype['ChallengeName'] = undefined;

/**
 * @member {String} Session
 */
RespondToAuthChallengeResponse.prototype['Session'] = undefined;

/**
 * @member {Object} ChallengeParameters
 */
RespondToAuthChallengeResponse.prototype['ChallengeParameters'] = undefined;

/**
 * @member {module:model/RespondToAuthChallengeResponseAuthenticationResult} AuthenticationResult
 */
RespondToAuthChallengeResponse.prototype['AuthenticationResult'] = undefined;
...
export default RespondToAuthChallengeResponse;
