...
import CloudWatchLogsConfigurationType from './CloudWatchLogsConfigurationType';

/**
 * The LogConfigurationTypeCloudWatchLogsConfiguration model module.
 * @module model/LogConfigurationTypeCloudWatchLogsConfiguration
 * @version 2016-04-18
 */
class LogConfigurationTypeCloudWatchLogsConfiguration {
    /**
     * Constructs a new <code>LogConfigurationTypeCloudWatchLogsConfiguration</code>.
     * @alias module:model/LogConfigurationTypeCloudWatchLogsConfiguration
     * @implements module:model/CloudWatchLogsConfigurationType
     */
    constructor() { 
        CloudWatchLogsConfigurationType.initialize(this);
        LogConfigurationTypeCloudWatchLogsConfiguration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LogConfigurationTypeCloudWatchLogsConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LogConfigurationTypeCloudWatchLogsConfiguration} obj Optional instance to populate.
     * @return {module:model/LogConfigurationTypeCloudWatchLogsConfiguration} The populated <code>LogConfigurationTypeCloudWatchLogsConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LogConfigurationTypeCloudWatchLogsConfiguration();
            CloudWatchLogsConfigurationType.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>LogConfigurationTypeCloudWatchLogsConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LogConfigurationTypeCloudWatchLogsConfiguration</code>.
     */
 ...
 */
LogConfigurationTypeCloudWatchLogsConfiguration.prototype['LogGroupArn'] = undefined;


// Implement CloudWatchLogsConfigurationType interface:
/**
 * @member {String} LogGroupArn
 */
CloudWatchLogsConfigurationType.prototype['LogGroupArn'] = undefined;




export default LogConfigurationTypeCloudWatchLogsConfiguration;
