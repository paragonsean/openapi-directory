...
/**
 * The SchemaAttributeTypeStringAttributeConstraints model module.
 * @module model/SchemaAttributeTypeStringAttributeConstraints
 * @version 2016-04-18
 */
class SchemaAttributeTypeStringAttributeConstraints {
    /**
     * Constructs a new <code>SchemaAttributeTypeStringAttributeConstraints</code>.
     * @alias module:model/SchemaAttributeTypeStringAttributeConstraints
     * @implements module:model/StringAttributeConstraintsType
     */
    constructor() { 
        StringAttributeConstraintsType.initialize(this);
        SchemaAttributeTypeStringAttributeConstraints.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SchemaAttributeTypeStringAttributeConstraints</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SchemaAttributeTypeStringAttributeConstraints} obj Optional instance to populate.
     * @return {module:model/SchemaAttributeTypeStringAttributeConstraints} The populated <code>SchemaAttributeTypeStringAttributeConstraints</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SchemaAttributeTypeStringAttributeConstraints();
            StringAttributeConstraintsType.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>SchemaAttributeTypeStringAttributeConstraints</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SchemaAttributeTypeStringAttributeConstraints</code>.
     */
 ...
 */
SchemaAttributeTypeStringAttributeConstraints.prototype['MinLength'] = undefined;

/**
 * @member {String} MaxLength
 */
SchemaAttributeTypeStringAttributeConstraints.prototype['MaxLength'] = undefined;


// Implement StringAttributeConstraintsType interface:
/**
 * @member {String} MinLength
 */
StringAttributeConstraintsType.prototype['MinLength'] = undefined;
/**
 * @member {String} MaxLength
 */
StringAttributeConstraintsType.prototype['MaxLength'] = undefined;




export default SchemaAttributeTypeStringAttributeConstraints;
