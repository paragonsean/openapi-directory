...
/**
 * The DeleteUserPoolClientRequest model module.
 * @module model/DeleteUserPoolClientRequest
 * @version 2016-04-18
 */
class DeleteUserPoolClientRequest {
    /**
     * Constructs a new <code>DeleteUserPoolClientRequest</code>.
     * Represents the request to delete a user pool client.
     * @alias module:model/DeleteUserPoolClientRequest
     * @param userPoolId {String} 
     * @param clientId {String} 
     */
    constructor(userPoolId, clientId) { 
        
        DeleteUserPoolClientRequest.initialize(this, userPoolId, clientId);
    }
    ...
    /**
     * Constructs a <code>DeleteUserPoolClientRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteUserPoolClientRequest} obj Optional instance to populate.
     * @return {module:model/DeleteUserPoolClientRequest} The populated <code>DeleteUserPoolClientRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteUserPoolClientRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteUserPoolClientRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteUserPoolClientRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteUserPoolClientRequest.RequiredProperties) {
...
DeleteUserPoolClientRequest.RequiredProperties = ["UserPoolId", "ClientId"];

/**
 * @member {String} UserPoolId
 */
DeleteUserPoolClientRequest.prototype['UserPoolId'] = undefined;

/**
 * @member {String} ClientId
 */
DeleteUserPoolClientRequest.prototype['ClientId'] = undefined;
...
export default DeleteUserPoolClientRequest;
