...
* @readonly
*/
export default class AliasAttributeType {
    ...
    /**
    * Returns a <code>AliasAttributeType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/AliasAttributeType} The enum <code>AliasAttributeType</code> value.
    */
