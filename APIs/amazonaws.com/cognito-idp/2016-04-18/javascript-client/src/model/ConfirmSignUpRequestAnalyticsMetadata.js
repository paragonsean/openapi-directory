...
/**
 * The ConfirmSignUpRequestAnalyticsMetadata model module.
 * @module model/ConfirmSignUpRequestAnalyticsMetadata
 * @version 2016-04-18
 */
class ConfirmSignUpRequestAnalyticsMetadata {
    /**
     * Constructs a new <code>ConfirmSignUpRequestAnalyticsMetadata</code>.
     * @alias module:model/ConfirmSignUpRequestAnalyticsMetadata
     * @implements module:model/AnalyticsMetadataType
     */
    constructor() { 
        AnalyticsMetadataType.initialize(this);
        ConfirmSignUpRequestAnalyticsMetadata.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ConfirmSignUpRequestAnalyticsMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ConfirmSignUpRequestAnalyticsMetadata} obj Optional instance to populate.
     * @return {module:model/ConfirmSignUpRequestAnalyticsMetadata} The populated <code>ConfirmSignUpRequestAnalyticsMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ConfirmSignUpRequestAnalyticsMetadata();
    ...
    /**
     * Validates the JSON data with respect to <code>ConfirmSignUpRequestAnalyticsMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConfirmSignUpRequestAnalyticsMetadata</code>.
     */
 ...
 */
ConfirmSignUpRequestAnalyticsMetadata.prototype['AnalyticsEndpointId'] = undefined;
...
export default ConfirmSignUpRequestAnalyticsMetadata;
