...
/**
 * The CreateUserPoolRequestSmsConfiguration model module.
 * @module model/CreateUserPoolRequestSmsConfiguration
 * @version 2016-04-18
 */
class CreateUserPoolRequestSmsConfiguration {
    /**
     * Constructs a new <code>CreateUserPoolRequestSmsConfiguration</code>.
     * @alias module:model/CreateUserPoolRequestSmsConfiguration
    ...
    constructor(snsCallerArn) { 
        ...
        CreateUserPoolRequestSmsConfiguration.initialize(this, snsCallerArn);
    }
    ...
    /**
     * Constructs a <code>CreateUserPoolRequestSmsConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateUserPoolRequestSmsConfiguration} obj Optional instance to populate.
     * @return {module:model/CreateUserPoolRequestSmsConfiguration} The populated <code>CreateUserPoolRequestSmsConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateUserPoolRequestSmsConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateUserPoolRequestSmsConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateUserPoolRequestSmsConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateUserPoolRequestSmsConfiguration.RequiredProperties) {
...
CreateUserPoolRequestSmsConfiguration.RequiredProperties = ["SnsCallerArn"];

/**
 * @member {String} SnsCallerArn
 */
CreateUserPoolRequestSmsConfiguration.prototype['SnsCallerArn'] = undefined;

/**
 * @member {String} ExternalId
 */
CreateUserPoolRequestSmsConfiguration.prototype['ExternalId'] = undefined;

/**
 * @member {String} SnsRegion
 */
CreateUserPoolRequestSmsConfiguration.prototype['SnsRegion'] = undefined;
...
export default CreateUserPoolRequestSmsConfiguration;
