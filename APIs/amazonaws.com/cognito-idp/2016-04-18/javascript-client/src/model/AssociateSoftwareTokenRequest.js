...
/**
 * The AssociateSoftwareTokenRequest model module.
 * @module model/AssociateSoftwareTokenRequest
 * @version 2016-04-18
 */
class AssociateSoftwareTokenRequest {
    /**
     * Constructs a new <code>AssociateSoftwareTokenRequest</code>.
     * @alias module:model/AssociateSoftwareTokenRequest
     */
    constructor() { 
        
        AssociateSoftwareTokenRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AssociateSoftwareTokenRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AssociateSoftwareTokenRequest} obj Optional instance to populate.
     * @return {module:model/AssociateSoftwareTokenRequest} The populated <code>AssociateSoftwareTokenRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AssociateSoftwareTokenRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>AssociateSoftwareTokenRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AssociateSoftwareTokenRequest</code>.
     */
 ...
 */
AssociateSoftwareTokenRequest.prototype['AccessToken'] = undefined;

/**
 * @member {String} Session
 */
AssociateSoftwareTokenRequest.prototype['Session'] = undefined;
...
export default AssociateSoftwareTokenRequest;
