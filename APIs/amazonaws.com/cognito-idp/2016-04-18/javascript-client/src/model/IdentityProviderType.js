...
/**
 * The IdentityProviderType model module.
 * @module model/IdentityProviderType
 * @version 2016-04-18
 */
class IdentityProviderType {
    /**
     * Constructs a new <code>IdentityProviderType</code>.
     * A container for information about an IdP.
     * @alias module:model/IdentityProviderType
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>IdentityProviderType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IdentityProviderType} obj Optional instance to populate.
     * @return {module:model/IdentityProviderType} The populated <code>IdentityProviderType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IdentityProviderType();
    ...
    /**
     * Validates the JSON data with respect to <code>IdentityProviderType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IdentityProviderType</code>.
     */
...
export default IdentityProviderType;
