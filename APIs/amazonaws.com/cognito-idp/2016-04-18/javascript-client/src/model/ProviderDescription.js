...
/**
 * The ProviderDescription model module.
 * @module model/ProviderDescription
 * @version 2016-04-18
 */
class ProviderDescription {
    /**
     * Constructs a new <code>ProviderDescription</code>.
     * A container for IdP details.
     * @alias module:model/ProviderDescription
     */
    constructor() { 
        
        ProviderDescription.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ProviderDescription</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ProviderDescription} obj Optional instance to populate.
     * @return {module:model/ProviderDescription} The populated <code>ProviderDescription</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProviderDescription();
    ...
    /**
     * Validates the JSON data with respect to <code>ProviderDescription</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProviderDescription</code>.
     */
 ...
 */
ProviderDescription.prototype['ProviderName'] = undefined;

/**
 * @member {module:model/IdentityProviderTypeType} ProviderType
 */
ProviderDescription.prototype['ProviderType'] = undefined;

/**
 * @member {Date} LastModifiedDate
 */
ProviderDescription.prototype['LastModifiedDate'] = undefined;

/**
 * @member {Date} CreationDate
 */
ProviderDescription.prototype['CreationDate'] = undefined;
