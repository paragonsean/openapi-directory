...
/**
 * The AuthEventTypeEventContextData model module.
 * @module model/AuthEventTypeEventContextData
 * @version 2016-04-18
 */
class AuthEventTypeEventContextData {
    /**
     * Constructs a new <code>AuthEventTypeEventContextData</code>.
     * @alias module:model/AuthEventTypeEventContextData
     * @implements module:model/EventContextDataType
     */
    constructor() { 
        EventContextDataType.initialize(this);
        AuthEventTypeEventContextData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AuthEventTypeEventContextData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AuthEventTypeEventContextData} obj Optional instance to populate.
     * @return {module:model/AuthEventTypeEventContextData} The populated <code>AuthEventTypeEventContextData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AuthEventTypeEventContextData();
            EventContextDataType.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>AuthEventTypeEventContextData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AuthEventTypeEventContextData</code>.
     */
 ...
 */
AuthEventTypeEventContextData.prototype['IpAddress'] = undefined;

/**
 * @member {String} DeviceName
 */
AuthEventTypeEventContextData.prototype['DeviceName'] = undefined;

/**
 * @member {String} Timezone
 */
AuthEventTypeEventContextData.prototype['Timezone'] = undefined;

/**
 * @member {String} City
 */
AuthEventTypeEventContextData.prototype['City'] = undefined;

/**
 * @member {String} Country
 */
AuthEventTypeEventContextData.prototype['Country'] = undefined;


// Implement EventContextDataType interface:
/**
 * @member {String} IpAddress
 */
...
export default AuthEventTypeEventContextData;
