...
/**
 * The ResendConfirmationCodeRequestAnalyticsMetadata model module.
 * @module model/ResendConfirmationCodeRequestAnalyticsMetadata
 * @version 2016-04-18
 */
class ResendConfirmationCodeRequestAnalyticsMetadata {
    /**
     * Constructs a new <code>ResendConfirmationCodeRequestAnalyticsMetadata</code>.
     * @alias module:model/ResendConfirmationCodeRequestAnalyticsMetadata
     * @implements module:model/AnalyticsMetadataType
     */
    constructor() { 
        AnalyticsMetadataType.initialize(this);
        ResendConfirmationCodeRequestAnalyticsMetadata.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ResendConfirmationCodeRequestAnalyticsMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ResendConfirmationCodeRequestAnalyticsMetadata} obj Optional instance to populate.
     * @return {module:model/ResendConfirmationCodeRequestAnalyticsMetadata} The populated <code>ResendConfirmationCodeRequestAnalyticsMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ResendConfirmationCodeRequestAnalyticsMetadata();
    ...
    /**
     * Validates the JSON data with respect to <code>ResendConfirmationCodeRequestAnalyticsMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ResendConfirmationCodeRequestAnalyticsMetadata</code>.
     */
 ...
 */
ResendConfirmationCodeRequestAnalyticsMetadata.prototype['AnalyticsEndpointId'] = undefined;
...
export default ResendConfirmationCodeRequestAnalyticsMetadata;
