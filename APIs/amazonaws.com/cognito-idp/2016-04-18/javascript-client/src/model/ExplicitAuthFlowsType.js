...
* @readonly
*/
export default class ExplicitAuthFlowsType {
        ...
        /**
         * value: "ALLOW_ADMIN_USER_PASSWORD_AUTH"
         * @const
         */
        ...
        /**
         * value: "ALLOW_USER_PASSWORD_AUTH"
         * @const
         */
        ...
        /**
         * value: "ALLOW_REFRESH_TOKEN_AUTH"
         * @const
         */
    ...
    /**
    * Returns a <code>ExplicitAuthFlowsType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ExplicitAuthFlowsType} The enum <code>ExplicitAuthFlowsType</code> value.
    */
