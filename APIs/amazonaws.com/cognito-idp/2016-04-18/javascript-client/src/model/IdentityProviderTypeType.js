...
* @readonly
*/
export default class IdentityProviderTypeType {
    ...
    /**
    * Returns a <code>IdentityProviderTypeType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/IdentityProviderTypeType} The enum <code>IdentityProviderTypeType</code> value.
    */
