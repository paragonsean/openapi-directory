...
/**
 * The ListUserPoolsRequest model module.
 * @module model/ListUserPoolsRequest
 * @version 2016-04-18
 */
class ListUserPoolsRequest {
    /**
     * Constructs a new <code>ListUserPoolsRequest</code>.
     * Represents the request to list user pools.
     * @alias module:model/ListUserPoolsRequest
     * @param maxResults {Number} 
     */
    constructor(maxResults) { 
        
        ListUserPoolsRequest.initialize(this, maxResults);
    }
    ...
    /**
     * Constructs a <code>ListUserPoolsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListUserPoolsRequest} obj Optional instance to populate.
     * @return {module:model/ListUserPoolsRequest} The populated <code>ListUserPoolsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListUserPoolsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListUserPoolsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListUserPoolsRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListUserPoolsRequest.RequiredProperties) {
...
ListUserPoolsRequest.RequiredProperties = ["MaxResults"];

/**
 * @member {String} NextToken
 */
ListUserPoolsRequest.prototype['NextToken'] = undefined;

/**
 * @member {Number} MaxResults
 */
ListUserPoolsRequest.prototype['MaxResults'] = undefined;
...
export default ListUserPoolsRequest;
