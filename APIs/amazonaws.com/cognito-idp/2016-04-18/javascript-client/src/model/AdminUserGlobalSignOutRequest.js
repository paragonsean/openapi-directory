...
/**
 * The AdminUserGlobalSignOutRequest model module.
 * @module model/AdminUserGlobalSignOutRequest
 * @version 2016-04-18
 */
class AdminUserGlobalSignOutRequest {
    /**
     * Constructs a new <code>AdminUserGlobalSignOutRequest</code>.
     * The request to sign out of all devices, as an administrator.
     * @alias module:model/AdminUserGlobalSignOutRequest
     * @param userPoolId {String} 
     * @param username {String} 
     */
    constructor(userPoolId, username) { 
        
        AdminUserGlobalSignOutRequest.initialize(this, userPoolId, username);
    }
    ...
    /**
     * Constructs a <code>AdminUserGlobalSignOutRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdminUserGlobalSignOutRequest} obj Optional instance to populate.
     * @return {module:model/AdminUserGlobalSignOutRequest} The populated <code>AdminUserGlobalSignOutRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdminUserGlobalSignOutRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>AdminUserGlobalSignOutRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdminUserGlobalSignOutRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AdminUserGlobalSignOutRequest.RequiredProperties) {
...
AdminUserGlobalSignOutRequest.RequiredProperties = ["UserPoolId", "Username"];

/**
 * @member {String} UserPoolId
 */
AdminUserGlobalSignOutRequest.prototype['UserPoolId'] = undefined;

/**
 * @member {String} Username
 */
AdminUserGlobalSignOutRequest.prototype['Username'] = undefined;
...
export default AdminUserGlobalSignOutRequest;
