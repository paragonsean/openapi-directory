...
/**
 * The SetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration model module.
 * @module model/SetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration
 * @version 2016-04-18
 */
class SetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration {
    /**
     * Constructs a new <code>SetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration</code>.
     * @alias module:model/SetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration
     * @implements module:model/SoftwareTokenMfaConfigType
     */
    constructor() { 
        SoftwareTokenMfaConfigType.initialize(this);
        SetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration} obj Optional instance to populate.
     * @return {module:model/SetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration} The populated <code>SetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration();
            SoftwareTokenMfaConfigType.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>SetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration</code>.
     */
 ...
 */
SetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration.prototype['Enabled'] = undefined;


// Implement SoftwareTokenMfaConfigType interface:
/**
 * @member {Boolean} Enabled
 */
SoftwareTokenMfaConfigType.prototype['Enabled'] = undefined;




export default SetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration;
