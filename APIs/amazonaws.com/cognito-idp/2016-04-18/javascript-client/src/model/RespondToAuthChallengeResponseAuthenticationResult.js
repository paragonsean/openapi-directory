...
/**
 * The RespondToAuthChallengeResponseAuthenticationResult model module.
 * @module model/RespondToAuthChallengeResponseAuthenticationResult
 * @version 2016-04-18
 */
class RespondToAuthChallengeResponseAuthenticationResult {
    /**
     * Constructs a new <code>RespondToAuthChallengeResponseAuthenticationResult</code>.
     * @alias module:model/RespondToAuthChallengeResponseAuthenticationResult
     * @implements module:model/AuthenticationResultType
     */
    constructor() { 
        AuthenticationResultType.initialize(this);
        RespondToAuthChallengeResponseAuthenticationResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RespondToAuthChallengeResponseAuthenticationResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RespondToAuthChallengeResponseAuthenticationResult} obj Optional instance to populate.
     * @return {module:model/RespondToAuthChallengeResponseAuthenticationResult} The populated <code>RespondToAuthChallengeResponseAuthenticationResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RespondToAuthChallengeResponseAuthenticationResult();
    ...
    /**
     * Validates the JSON data with respect to <code>RespondToAuthChallengeResponseAuthenticationResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RespondToAuthChallengeResponseAuthenticationResult</code>.
     */
 ...
 */
RespondToAuthChallengeResponseAuthenticationResult.prototype['AccessToken'] = undefined;

/**
 * @member {Number} ExpiresIn
 */
RespondToAuthChallengeResponseAuthenticationResult.prototype['ExpiresIn'] = undefined;

/**
 * @member {String} TokenType
 */
RespondToAuthChallengeResponseAuthenticationResult.prototype['TokenType'] = undefined;

/**
 * @member {String} RefreshToken
 */
RespondToAuthChallengeResponseAuthenticationResult.prototype['RefreshToken'] = undefined;

/**
 * @member {String} IdToken
 */
RespondToAuthChallengeResponseAuthenticationResult.prototype['IdToken'] = undefined;

/**
 * @member {module:model/AuthenticationResultTypeNewDeviceMetadata} NewDeviceMetadata
 */
RespondToAuthChallengeResponseAuthenticationResult.prototype['NewDeviceMetadata'] = undefined;
...
export default RespondToAuthChallengeResponseAuthenticationResult;
