...
/**
 * The ListResourceServersRequest model module.
 * @module model/ListResourceServersRequest
 * @version 2016-04-18
 */
class ListResourceServersRequest {
    /**
     * Constructs a new <code>ListResourceServersRequest</code>.
     * @alias module:model/ListResourceServersRequest
     * @param userPoolId {String} 
     */
    constructor(userPoolId) { 
        
        ListResourceServersRequest.initialize(this, userPoolId);
    }
    ...
    /**
     * Constructs a <code>ListResourceServersRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListResourceServersRequest} obj Optional instance to populate.
     * @return {module:model/ListResourceServersRequest} The populated <code>ListResourceServersRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListResourceServersRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListResourceServersRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListResourceServersRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListResourceServersRequest.RequiredProperties) {
...
ListResourceServersRequest.RequiredProperties = ["UserPoolId"];

/**
 * @member {String} UserPoolId
 */
ListResourceServersRequest.prototype['UserPoolId'] = undefined;

/**
 * @member {Number} MaxResults
 */
ListResourceServersRequest.prototype['MaxResults'] = undefined;

/**
 * @member {String} NextToken
 */
ListResourceServersRequest.prototype['NextToken'] = undefined;
...
export default ListResourceServersRequest;
