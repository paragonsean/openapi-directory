...
/**
 * The SoftwareTokenMfaSettingsType model module.
 * @module model/SoftwareTokenMfaSettingsType
 * @version 2016-04-18
 */
class SoftwareTokenMfaSettingsType {
    /**
     * Constructs a new <code>SoftwareTokenMfaSettingsType</code>.
     * The type used for enabling software token MFA at the user level. If an MFA type is activated for a user, the user will be prompted for MFA during all sign-in attempts, unless device tracking is turned on and the device has been trusted. If you want MFA to be applied selectively based on the assessed risk level of sign-in attempts, deactivate MFA for users and turn on Adaptive Authentication for the user pool.
     * @alias module:model/SoftwareTokenMfaSettingsType
     */
    constructor() { 
        
        SoftwareTokenMfaSettingsType.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SoftwareTokenMfaSettingsType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SoftwareTokenMfaSettingsType} obj Optional instance to populate.
     * @return {module:model/SoftwareTokenMfaSettingsType} The populated <code>SoftwareTokenMfaSettingsType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SoftwareTokenMfaSettingsType();
    ...
    /**
     * Validates the JSON data with respect to <code>SoftwareTokenMfaSettingsType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SoftwareTokenMfaSettingsType</code>.
     */
 ...
 */
SoftwareTokenMfaSettingsType.prototype['Enabled'] = undefined;

/**
 * @member {Boolean} PreferredMfa
 */
SoftwareTokenMfaSettingsType.prototype['PreferredMfa'] = undefined;
...
export default SoftwareTokenMfaSettingsType;
