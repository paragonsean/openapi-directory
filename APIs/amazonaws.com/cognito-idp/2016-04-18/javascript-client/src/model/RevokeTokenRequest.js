...
class RevokeTokenRequest {
    ...
    constructor(token, clientId) { 
        ...
        RevokeTokenRequest.initialize(this, token, clientId);
    }
     ...
     */
    static initialize(obj, token, clientId) { 
        obj['Token'] = token;
...
RevokeTokenRequest.RequiredProperties = ["Token", "ClientId"];

/**
 * @member {String} Token
 */
RevokeTokenRequest.prototype['Token'] = undefined;

/**
 * @member {String} ClientId
 */
RevokeTokenRequest.prototype['ClientId'] = undefined;

/**
 * @member {String} ClientSecret
 */
RevokeTokenRequest.prototype['ClientSecret'] = undefined;
