...
/**
 * The UpdateIdentityProviderRequest model module.
 * @module model/UpdateIdentityProviderRequest
 * @version 2016-04-18
 */
class UpdateIdentityProviderRequest {
    /**
     * Constructs a new <code>UpdateIdentityProviderRequest</code>.
     * @alias module:model/UpdateIdentityProviderRequest
     * @param userPoolId {String} 
     * @param providerName {String} 
     */
    constructor(userPoolId, providerName) { 
        
        UpdateIdentityProviderRequest.initialize(this, userPoolId, providerName);
    }
    ...
    /**
     * Constructs a <code>UpdateIdentityProviderRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateIdentityProviderRequest} obj Optional instance to populate.
     * @return {module:model/UpdateIdentityProviderRequest} The populated <code>UpdateIdentityProviderRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateIdentityProviderRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateIdentityProviderRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateIdentityProviderRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateIdentityProviderRequest.RequiredProperties) {
...
UpdateIdentityProviderRequest.RequiredProperties = ["UserPoolId", "ProviderName"];

/**
 * @member {String} UserPoolId
 */
UpdateIdentityProviderRequest.prototype['UserPoolId'] = undefined;

/**
 * @member {String} ProviderName
 */
UpdateIdentityProviderRequest.prototype['ProviderName'] = undefined;

/**
 * @member {Object} ProviderDetails
 */
UpdateIdentityProviderRequest.prototype['ProviderDetails'] = undefined;

/**
 * @member {Object} AttributeMapping
 */
UpdateIdentityProviderRequest.prototype['AttributeMapping'] = undefined;

/**
 * @member {Array} IdpIdentifiers
 */
UpdateIdentityProviderRequest.prototype['IdpIdentifiers'] = undefined;
...
export default UpdateIdentityProviderRequest;
