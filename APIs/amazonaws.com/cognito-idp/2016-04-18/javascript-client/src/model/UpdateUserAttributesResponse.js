...
/**
 * The UpdateUserAttributesResponse model module.
 * @module model/UpdateUserAttributesResponse
 * @version 2016-04-18
 */
class UpdateUserAttributesResponse {
    /**
     * Constructs a new <code>UpdateUserAttributesResponse</code>.
     * Represents the response from the server for the request to update user attributes.
     * @alias module:model/UpdateUserAttributesResponse
     */
    constructor() { 
        
        UpdateUserAttributesResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateUserAttributesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateUserAttributesResponse} obj Optional instance to populate.
     * @return {module:model/UpdateUserAttributesResponse} The populated <code>UpdateUserAttributesResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateUserAttributesResponse();

            if (data.hasOwnProperty('CodeDeliveryDetailsList')) {
                obj['CodeDeliveryDetailsList'] = ApiClient.convertToType(data['CodeDeliveryDetailsList'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateUserAttributesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateUserAttributesResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `CodeDeliveryDetailsList`
        if (data['CodeDeliveryDetailsList']) { // data not null
          Array.validateJSON(data['CodeDeliveryDetailsList']);
        }
...
/**
 * @member {Array} CodeDeliveryDetailsList
 */
UpdateUserAttributesResponse.prototype['CodeDeliveryDetailsList'] = undefined;
...
export default UpdateUserAttributesResponse;
