...
/**
 * The AdminResetUserPasswordRequest model module.
 * @module model/AdminResetUserPasswordRequest
 * @version 2016-04-18
 */
class AdminResetUserPasswordRequest {
    /**
     * Constructs a new <code>AdminResetUserPasswordRequest</code>.
     * Represents the request to reset a user&#39;s password as an administrator.
     * @alias module:model/AdminResetUserPasswordRequest
     * @param userPoolId {String} 
     * @param username {String} 
     */
    constructor(userPoolId, username) { 
        
        AdminResetUserPasswordRequest.initialize(this, userPoolId, username);
    }
    ...
    /**
     * Constructs a <code>AdminResetUserPasswordRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdminResetUserPasswordRequest} obj Optional instance to populate.
     * @return {module:model/AdminResetUserPasswordRequest} The populated <code>AdminResetUserPasswordRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdminResetUserPasswordRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>AdminResetUserPasswordRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdminResetUserPasswordRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AdminResetUserPasswordRequest.RequiredProperties) {
...
AdminResetUserPasswordRequest.RequiredProperties = ["UserPoolId", "Username"];

/**
 * @member {String} UserPoolId
 */
AdminResetUserPasswordRequest.prototype['UserPoolId'] = undefined;

/**
 * @member {String} Username
 */
AdminResetUserPasswordRequest.prototype['Username'] = undefined;

/**
 * @member {Object} ClientMetadata
 */
AdminResetUserPasswordRequest.prototype['ClientMetadata'] = undefined;
...
export default AdminResetUserPasswordRequest;
