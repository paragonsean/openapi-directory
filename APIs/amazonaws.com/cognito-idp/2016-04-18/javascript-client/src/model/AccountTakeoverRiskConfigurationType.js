...
/**
 * The AccountTakeoverRiskConfigurationType model module.
 * @module model/AccountTakeoverRiskConfigurationType
 * @version 2016-04-18
 */
class AccountTakeoverRiskConfigurationType {
    /**
     * Constructs a new <code>AccountTakeoverRiskConfigurationType</code>.
     * Configuration for mitigation actions and notification for different levels of risk detected for a potential account takeover.
     * @alias module:model/AccountTakeoverRiskConfigurationType
    ...
    /**
     * Constructs a <code>AccountTakeoverRiskConfigurationType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AccountTakeoverRiskConfigurationType} obj Optional instance to populate.
     * @return {module:model/AccountTakeoverRiskConfigurationType} The populated <code>AccountTakeoverRiskConfigurationType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AccountTakeoverRiskConfigurationType();
    ...
    /**
     * Validates the JSON data with respect to <code>AccountTakeoverRiskConfigurationType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AccountTakeoverRiskConfigurationType</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AccountTakeoverRiskConfigurationType.RequiredProperties) {
...
AccountTakeoverRiskConfigurationType.RequiredProperties = ["Actions"];
...
export default AccountTakeoverRiskConfigurationType;
