...
/**
 * The CreateIdentityProviderRequest model module.
 * @module model/CreateIdentityProviderRequest
 * @version 2016-04-18
 */
class CreateIdentityProviderRequest {
    /**
     * Constructs a new <code>CreateIdentityProviderRequest</code>.
     * @alias module:model/CreateIdentityProviderRequest
     * @param userPoolId {String} 
     * @param providerName {String} 
     * @param providerType {module:model/IdentityProviderTypeType} 
     * @param providerDetails {Object} 
     */
    constructor(userPoolId, providerName, providerType, providerDetails) { 
        
        CreateIdentityProviderRequest.initialize(this, userPoolId, providerName, providerType, providerDetails);
    }
     ...
     */
    static initialize(obj, userPoolId, providerName, providerType, providerDetails) { 
    ...
    /**
     * Constructs a <code>CreateIdentityProviderRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateIdentityProviderRequest} obj Optional instance to populate.
     * @return {module:model/CreateIdentityProviderRequest} The populated <code>CreateIdentityProviderRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateIdentityProviderRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateIdentityProviderRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateIdentityProviderRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateIdentityProviderRequest.RequiredProperties) {
...
CreateIdentityProviderRequest.RequiredProperties = ["UserPoolId", "ProviderName", "ProviderType", "ProviderDetails"];

/**
 * @member {String} UserPoolId
 */
CreateIdentityProviderRequest.prototype['UserPoolId'] = undefined;

/**
 * @member {String} ProviderName
 */
CreateIdentityProviderRequest.prototype['ProviderName'] = undefined;

/**
 * @member {module:model/IdentityProviderTypeType} ProviderType
 */
CreateIdentityProviderRequest.prototype['ProviderType'] = undefined;

/**
 * @member {Object} ProviderDetails
 */
CreateIdentityProviderRequest.prototype['ProviderDetails'] = undefined;

/**
 * @member {Object} AttributeMapping
 */
CreateIdentityProviderRequest.prototype['AttributeMapping'] = undefined;

/**
 * @member {Array} IdpIdentifiers
 */
CreateIdentityProviderRequest.prototype['IdpIdentifiers'] = undefined;
...
export default CreateIdentityProviderRequest;
