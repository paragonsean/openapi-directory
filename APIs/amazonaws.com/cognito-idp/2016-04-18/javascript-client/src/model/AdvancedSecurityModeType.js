...
* @readonly
*/
export default class AdvancedSecurityModeType {
    ...
    /**
    * Returns a <code>AdvancedSecurityModeType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/AdvancedSecurityModeType} The enum <code>AdvancedSecurityModeType</code> value.
    */
