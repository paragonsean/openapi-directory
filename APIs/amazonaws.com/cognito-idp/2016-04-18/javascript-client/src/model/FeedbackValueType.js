...
* @readonly
*/
export default class FeedbackValueType {
    ...
    /**
    * Returns a <code>FeedbackValueType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FeedbackValueType} The enum <code>FeedbackValueType</code> value.
    */
