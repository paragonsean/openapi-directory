...
/**
 * The UpdateUserPoolClientRequestTokenValidityUnits model module.
 * @module model/UpdateUserPoolClientRequestTokenValidityUnits
 * @version 2016-04-18
 */
class UpdateUserPoolClientRequestTokenValidityUnits {
    /**
     * Constructs a new <code>UpdateUserPoolClientRequestTokenValidityUnits</code>.
     * @alias module:model/UpdateUserPoolClientRequestTokenValidityUnits
     * @implements module:model/TokenValidityUnitsType
     */
    constructor() { 
        TokenValidityUnitsType.initialize(this);
        UpdateUserPoolClientRequestTokenValidityUnits.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateUserPoolClientRequestTokenValidityUnits</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateUserPoolClientRequestTokenValidityUnits} obj Optional instance to populate.
     * @return {module:model/UpdateUserPoolClientRequestTokenValidityUnits} The populated <code>UpdateUserPoolClientRequestTokenValidityUnits</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateUserPoolClientRequestTokenValidityUnits();
            TokenValidityUnitsType.constructFromObject(data, obj);

            if (data.hasOwnProperty('AccessToken')) {
                obj['AccessToken'] = ApiClient.convertToType(data['AccessToken'], TimeUnitsType);
            }
            if (data.hasOwnProperty('IdToken')) {
                obj['IdToken'] = ApiClient.convertToType(data['IdToken'], TimeUnitsType);
            }
            if (data.hasOwnProperty('RefreshToken')) {
                obj['RefreshToken'] = ApiClient.convertToType(data['RefreshToken'], TimeUnitsType);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateUserPoolClientRequestTokenValidityUnits</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateUserPoolClientRequestTokenValidityUnits</code>.
     */
    static validateJSON(data) {
        // validate the optional field `AccessToken`
        if (data['AccessToken']) { // data not null
          TimeUnitsType.validateJSON(data['AccessToken']);
        }
        // validate the optional field `IdToken`
        if (data['IdToken']) { // data not null
          TimeUnitsType.validateJSON(data['IdToken']);
        }
        // validate the optional field `RefreshToken`
        if (data['RefreshToken']) { // data not null
          TimeUnitsType.validateJSON(data['RefreshToken']);
        }
...
/**
 * @member {module:model/TimeUnitsType} AccessToken
 */
UpdateUserPoolClientRequestTokenValidityUnits.prototype['AccessToken'] = undefined;

/**
 * @member {module:model/TimeUnitsType} IdToken
 */
UpdateUserPoolClientRequestTokenValidityUnits.prototype['IdToken'] = undefined;

/**
 * @member {module:model/TimeUnitsType} RefreshToken
 */
UpdateUserPoolClientRequestTokenValidityUnits.prototype['RefreshToken'] = undefined;


// Implement TokenValidityUnitsType interface:
/**
 * @member {module:model/TimeUnitsType} AccessToken
 */
TokenValidityUnitsType.prototype['AccessToken'] = undefined;
/**
 * @member {module:model/TimeUnitsType} IdToken
 */
TokenValidityUnitsType.prototype['IdToken'] = undefined;
/**
 * @member {module:model/TimeUnitsType} RefreshToken
 */
TokenValidityUnitsType.prototype['RefreshToken'] = undefined;




export default UpdateUserPoolClientRequestTokenValidityUnits;
