...
* @readonly
*/
export default class DomainStatusType {
    ...
    /**
    * Returns a <code>DomainStatusType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/DomainStatusType} The enum <code>DomainStatusType</code> value.
    */
