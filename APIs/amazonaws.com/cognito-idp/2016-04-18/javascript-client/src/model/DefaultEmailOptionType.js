...
* @readonly
*/
export default class DefaultEmailOptionType {
    
        /**
         * value: "CONFIRM_WITH_LINK"
         * @const
         */
    ...
    /**
    * Returns a <code>DefaultEmailOptionType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/DefaultEmailOptionType} The enum <code>DefaultEmailOptionType</code> value.
    */
