...
/**
 * The DescribeIdentityProviderRequest model module.
 * @module model/DescribeIdentityProviderRequest
 * @version 2016-04-18
 */
class DescribeIdentityProviderRequest {
    /**
     * Constructs a new <code>DescribeIdentityProviderRequest</code>.
     * @alias module:model/DescribeIdentityProviderRequest
     * @param userPoolId {String} 
     * @param providerName {String} 
     */
    constructor(userPoolId, providerName) { 
        
        DescribeIdentityProviderRequest.initialize(this, userPoolId, providerName);
    }
     ...
     */
    static initialize(obj, userPoolId, providerName) { 
        obj['UserPoolId'] = userPoolId;
        obj['ProviderName'] = providerName;
    }

    /**
     * Constructs a <code>DescribeIdentityProviderRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeIdentityProviderRequest} obj Optional instance to populate.
     * @return {module:model/DescribeIdentityProviderRequest} The populated <code>DescribeIdentityProviderRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeIdentityProviderRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeIdentityProviderRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeIdentityProviderRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeIdentityProviderRequest.RequiredProperties) {
...
DescribeIdentityProviderRequest.RequiredProperties = ["UserPoolId", "ProviderName"];

/**
 * @member {String} UserPoolId
 */
DescribeIdentityProviderRequest.prototype['UserPoolId'] = undefined;

/**
 * @member {String} ProviderName
 */
DescribeIdentityProviderRequest.prototype['ProviderName'] = undefined;
...
export default DescribeIdentityProviderRequest;
