...
/**
 * The GetCSVHeaderRequest model module.
 * @module model/GetCSVHeaderRequest
 * @version 2016-04-18
 */
class GetCSVHeaderRequest {
    /**
     * Constructs a new <code>GetCSVHeaderRequest</code>.
     * Represents the request to get the header information of the CSV file for the user import job.
     * @alias module:model/GetCSVHeaderRequest
     * @param userPoolId {String} 
     */
    constructor(userPoolId) { 
        
        GetCSVHeaderRequest.initialize(this, userPoolId);
    }
    ...
    /**
     * Constructs a <code>GetCSVHeaderRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetCSVHeaderRequest} obj Optional instance to populate.
     * @return {module:model/GetCSVHeaderRequest} The populated <code>GetCSVHeaderRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetCSVHeaderRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GetCSVHeaderRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetCSVHeaderRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetCSVHeaderRequest.RequiredProperties) {
...
GetCSVHeaderRequest.RequiredProperties = ["UserPoolId"];

/**
 * @member {String} UserPoolId
 */
GetCSVHeaderRequest.prototype['UserPoolId'] = undefined;
...
export default GetCSVHeaderRequest;
