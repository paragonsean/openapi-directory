...
/**
 * The UserPoolPolicyType model module.
 * @module model/UserPoolPolicyType
 * @version 2016-04-18
 */
class UserPoolPolicyType {
    /**
     * Constructs a new <code>UserPoolPolicyType</code>.
     * The policy associated with a user pool.
     * @alias module:model/UserPoolPolicyType
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>UserPoolPolicyType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UserPoolPolicyType} obj Optional instance to populate.
     * @return {module:model/UserPoolPolicyType} The populated <code>UserPoolPolicyType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UserPoolPolicyType();
    ...
    /**
     * Validates the JSON data with respect to <code>UserPoolPolicyType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UserPoolPolicyType</code>.
     */
...
export default UserPoolPolicyType;
