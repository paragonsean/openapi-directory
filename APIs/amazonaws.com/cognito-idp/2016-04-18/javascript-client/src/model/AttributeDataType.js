...
* @readonly
*/
export default class AttributeDataType {
    ...
    /**
    * Returns a <code>AttributeDataType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/AttributeDataType} The enum <code>AttributeDataType</code> value.
    */
