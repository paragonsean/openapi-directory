...
import CreateIdentityProviderResponseIdentityProvider from './CreateIdentityProviderResponseIdentityProvider';

/**
 * The CreateIdentityProviderResponse model module.
 * @module model/CreateIdentityProviderResponse
 * @version 2016-04-18
 */
class CreateIdentityProviderResponse {
    /**
     * Constructs a new <code>CreateIdentityProviderResponse</code>.
     * @alias module:model/CreateIdentityProviderResponse
     * @param identityProvider {module:model/CreateIdentityProviderResponseIdentityProvider} 
     */
    constructor(identityProvider) { 
        
        CreateIdentityProviderResponse.initialize(this, identityProvider);
    }
    ...
    /**
     * Constructs a <code>CreateIdentityProviderResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateIdentityProviderResponse} obj Optional instance to populate.
     * @return {module:model/CreateIdentityProviderResponse} The populated <code>CreateIdentityProviderResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateIdentityProviderResponse();

            if (data.hasOwnProperty('IdentityProvider')) {
                obj['IdentityProvider'] = CreateIdentityProviderResponseIdentityProvider.constructFromObject(data['IdentityProvider']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateIdentityProviderResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateIdentityProviderResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateIdentityProviderResponse.RequiredProperties) {
        ...
        if (data['IdentityProvider']) { // data not null
          CreateIdentityProviderResponseIdentityProvider.validateJSON(data['IdentityProvider']);
        }
...
CreateIdentityProviderResponse.RequiredProperties = ["IdentityProvider"];

/**
 * @member {module:model/CreateIdentityProviderResponseIdentityProvider} IdentityProvider
 */
CreateIdentityProviderResponse.prototype['IdentityProvider'] = undefined;
...
export default CreateIdentityProviderResponse;
