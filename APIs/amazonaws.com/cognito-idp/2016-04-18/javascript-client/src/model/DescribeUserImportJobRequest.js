...
/**
 * The DescribeUserImportJobRequest model module.
 * @module model/DescribeUserImportJobRequest
 * @version 2016-04-18
 */
class DescribeUserImportJobRequest {
    /**
     * Constructs a new <code>DescribeUserImportJobRequest</code>.
     * Represents the request to describe the user import job.
     * @alias module:model/DescribeUserImportJobRequest
     * @param userPoolId {String} 
     * @param jobId {String} 
     */
    constructor(userPoolId, jobId) { 
        
        DescribeUserImportJobRequest.initialize(this, userPoolId, jobId);
    }
    ...
    /**
     * Constructs a <code>DescribeUserImportJobRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeUserImportJobRequest} obj Optional instance to populate.
     * @return {module:model/DescribeUserImportJobRequest} The populated <code>DescribeUserImportJobRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeUserImportJobRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeUserImportJobRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeUserImportJobRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeUserImportJobRequest.RequiredProperties) {
...
DescribeUserImportJobRequest.RequiredProperties = ["UserPoolId", "JobId"];

/**
 * @member {String} UserPoolId
 */
DescribeUserImportJobRequest.prototype['UserPoolId'] = undefined;

/**
 * @member {String} JobId
 */
DescribeUserImportJobRequest.prototype['JobId'] = undefined;
...
export default DescribeUserImportJobRequest;
