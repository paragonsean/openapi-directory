...
* @readonly
*/
export default class VerifiedAttributeType {
    ...
    /**
    * Returns a <code>VerifiedAttributeType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/VerifiedAttributeType} The enum <code>VerifiedAttributeType</code> value.
    */
