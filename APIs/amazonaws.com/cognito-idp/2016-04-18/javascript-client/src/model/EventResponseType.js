...
* @readonly
*/
export default class EventResponseType {
    ...
    /**
    * Returns a <code>EventResponseType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/EventResponseType} The enum <code>EventResponseType</code> value.
    */
