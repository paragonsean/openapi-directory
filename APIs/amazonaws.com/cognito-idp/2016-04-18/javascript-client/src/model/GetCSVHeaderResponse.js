...
/**
 * The GetCSVHeaderResponse model module.
 * @module model/GetCSVHeaderResponse
 * @version 2016-04-18
 */
class GetCSVHeaderResponse {
    /**
     * Constructs a new <code>GetCSVHeaderResponse</code>.
     ...
     * @alias module:model/GetCSVHeaderResponse
     */
    constructor() { 
        
        GetCSVHeaderResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetCSVHeaderResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetCSVHeaderResponse} obj Optional instance to populate.
     * @return {module:model/GetCSVHeaderResponse} The populated <code>GetCSVHeaderResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetCSVHeaderResponse();

            if (data.hasOwnProperty('UserPoolId')) {
                obj['UserPoolId'] = ApiClient.convertToType(data['UserPoolId'], 'String');
            }
            if (data.hasOwnProperty('CSVHeader')) {
                obj['CSVHeader'] = ApiClient.convertToType(data['CSVHeader'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetCSVHeaderResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetCSVHeaderResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['CSVHeader']) { // data not null
          Array.validateJSON(data['CSVHeader']);
        }
 ...
 */
GetCSVHeaderResponse.prototype['UserPoolId'] = undefined;

/**
 * @member {Array} CSVHeader
 */
GetCSVHeaderResponse.prototype['CSVHeader'] = undefined;
...
export default GetCSVHeaderResponse;
