...
import AdvancedSecurityModeType from './AdvancedSecurityModeType';
import UserPoolAddOnsType from './UserPoolAddOnsType';

/**
 * The CreateUserPoolRequestUserPoolAddOns model module.
 * @module model/CreateUserPoolRequestUserPoolAddOns
 * @version 2016-04-18
 */
class CreateUserPoolRequestUserPoolAddOns {
    /**
     * Constructs a new <code>CreateUserPoolRequestUserPoolAddOns</code>.
     * @alias module:model/CreateUserPoolRequestUserPoolAddOns
     * @implements module:model/UserPoolAddOnsType
     * @param advancedSecurityMode {module:model/AdvancedSecurityModeType} 
     */
    constructor(advancedSecurityMode) { 
        UserPoolAddOnsType.initialize(this, advancedSecurityMode);
        CreateUserPoolRequestUserPoolAddOns.initialize(this, advancedSecurityMode);
    }
     ...
     */
    static initialize(obj, advancedSecurityMode) { 
        obj['AdvancedSecurityMode'] = advancedSecurityMode;
    }

    /**
     * Constructs a <code>CreateUserPoolRequestUserPoolAddOns</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateUserPoolRequestUserPoolAddOns} obj Optional instance to populate.
     * @return {module:model/CreateUserPoolRequestUserPoolAddOns} The populated <code>CreateUserPoolRequestUserPoolAddOns</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateUserPoolRequestUserPoolAddOns();
            UserPoolAddOnsType.constructFromObject(data, obj);

            if (data.hasOwnProperty('AdvancedSecurityMode')) {
                obj['AdvancedSecurityMode'] = ApiClient.convertToType(data['AdvancedSecurityMode'], AdvancedSecurityModeType);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateUserPoolRequestUserPoolAddOns</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateUserPoolRequestUserPoolAddOns</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateUserPoolRequestUserPoolAddOns.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `AdvancedSecurityMode`
        if (data['AdvancedSecurityMode']) { // data not null
          AdvancedSecurityModeType.validateJSON(data['AdvancedSecurityMode']);
        }
...
CreateUserPoolRequestUserPoolAddOns.RequiredProperties = ["AdvancedSecurityMode"];

/**
 * @member {module:model/AdvancedSecurityModeType} AdvancedSecurityMode
 */
CreateUserPoolRequestUserPoolAddOns.prototype['AdvancedSecurityMode'] = undefined;


// Implement UserPoolAddOnsType interface:
/**
 * @member {module:model/AdvancedSecurityModeType} AdvancedSecurityMode
 */
UserPoolAddOnsType.prototype['AdvancedSecurityMode'] = undefined;




export default CreateUserPoolRequestUserPoolAddOns;
