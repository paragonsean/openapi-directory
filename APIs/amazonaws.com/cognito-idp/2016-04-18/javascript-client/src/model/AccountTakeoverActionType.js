...
import AccountTakeoverEventActionType from './AccountTakeoverEventActionType';

/**
 * The AccountTakeoverActionType model module.
 * @module model/AccountTakeoverActionType
 * @version 2016-04-18
 */
class AccountTakeoverActionType {
    /**
     * Constructs a new <code>AccountTakeoverActionType</code>.
     * Account takeover action type.
     * @alias module:model/AccountTakeoverActionType
     * @param notify {Boolean} 
     * @param eventAction {module:model/AccountTakeoverEventActionType} 
     */
    constructor(notify, eventAction) { 
        
        AccountTakeoverActionType.initialize(this, notify, eventAction);
    }
     ...
     */
    static initialize(obj, notify, eventAction) { 
        obj['Notify'] = notify;
        obj['EventAction'] = eventAction;
    }

    /**
     * Constructs a <code>AccountTakeoverActionType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AccountTakeoverActionType} obj Optional instance to populate.
     * @return {module:model/AccountTakeoverActionType} The populated <code>AccountTakeoverActionType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AccountTakeoverActionType();

            if (data.hasOwnProperty('Notify')) {
                obj['Notify'] = ApiClient.convertToType(data['Notify'], 'Boolean');
            }
            if (data.hasOwnProperty('EventAction')) {
                obj['EventAction'] = ApiClient.convertToType(data['EventAction'], AccountTakeoverEventActionType);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AccountTakeoverActionType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AccountTakeoverActionType</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AccountTakeoverActionType.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `Notify`
        if (data['Notify']) { // data not null
          Boolean.validateJSON(data['Notify']);
        }
        // validate the optional field `EventAction`
        if (data['EventAction']) { // data not null
          AccountTakeoverEventActionType.validateJSON(data['EventAction']);
        }
...
AccountTakeoverActionType.RequiredProperties = ["Notify", "EventAction"];

/**
 * @member {Boolean} Notify
 */
AccountTakeoverActionType.prototype['Notify'] = undefined;

/**
 * @member {module:model/AccountTakeoverEventActionType} EventAction
 */
AccountTakeoverActionType.prototype['EventAction'] = undefined;
...
export default AccountTakeoverActionType;
