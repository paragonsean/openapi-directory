...
import InitiateAuthResponseAuthenticationResult from './InitiateAuthResponseAuthenticationResult';

/**
 * The InitiateAuthResponse model module.
 * @module model/InitiateAuthResponse
 * @version 2016-04-18
 */
class InitiateAuthResponse {
    /**
     * Constructs a new <code>InitiateAuthResponse</code>.
     * Initiates the authentication response.
     * @alias module:model/InitiateAuthResponse
     */
    constructor() { 
        
        InitiateAuthResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InitiateAuthResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InitiateAuthResponse} obj Optional instance to populate.
     * @return {module:model/InitiateAuthResponse} The populated <code>InitiateAuthResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InitiateAuthResponse();
            ...
            if (data.hasOwnProperty('AuthenticationResult')) {
                obj['AuthenticationResult'] = InitiateAuthResponseAuthenticationResult.constructFromObject(data['AuthenticationResult']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>InitiateAuthResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InitiateAuthResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['AuthenticationResult']) { // data not null
          InitiateAuthResponseAuthenticationResult.validateJSON(data['AuthenticationResult']);
        }
 ...
 */
InitiateAuthResponse.prototype['ChallengeName'] = undefined;

/**
 * @member {String} Session
 */
InitiateAuthResponse.prototype['Session'] = undefined;

/**
 * @member {Object} ChallengeParameters
 */
InitiateAuthResponse.prototype['ChallengeParameters'] = undefined;

/**
 * @member {module:model/InitiateAuthResponseAuthenticationResult} AuthenticationResult
 */
InitiateAuthResponse.prototype['AuthenticationResult'] = undefined;
