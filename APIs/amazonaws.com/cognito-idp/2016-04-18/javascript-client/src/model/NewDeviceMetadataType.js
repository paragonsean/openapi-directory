...
/**
 * The NewDeviceMetadataType model module.
 * @module model/NewDeviceMetadataType
 * @version 2016-04-18
 */
class NewDeviceMetadataType {
    /**
     * Constructs a new <code>NewDeviceMetadataType</code>.
     * The new device metadata type.
     * @alias module:model/NewDeviceMetadataType
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>NewDeviceMetadataType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NewDeviceMetadataType} obj Optional instance to populate.
     * @return {module:model/NewDeviceMetadataType} The populated <code>NewDeviceMetadataType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NewDeviceMetadataType();
    ...
    /**
     * Validates the JSON data with respect to <code>NewDeviceMetadataType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NewDeviceMetadataType</code>.
     */
...
export default NewDeviceMetadataType;
