...
/**
 * The AdminListUserAuthEventsResponse model module.
 * @module model/AdminListUserAuthEventsResponse
 * @version 2016-04-18
 */
class AdminListUserAuthEventsResponse {
    /**
     * Constructs a new <code>AdminListUserAuthEventsResponse</code>.
     * @alias module:model/AdminListUserAuthEventsResponse
     */
    constructor() { 
        
        AdminListUserAuthEventsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AdminListUserAuthEventsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdminListUserAuthEventsResponse} obj Optional instance to populate.
     * @return {module:model/AdminListUserAuthEventsResponse} The populated <code>AdminListUserAuthEventsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdminListUserAuthEventsResponse();

            if (data.hasOwnProperty('AuthEvents')) {
                obj['AuthEvents'] = ApiClient.convertToType(data['AuthEvents'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>AdminListUserAuthEventsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdminListUserAuthEventsResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `AuthEvents`
        if (data['AuthEvents']) { // data not null
          Array.validateJSON(data['AuthEvents']);
        }
...
/**
 * @member {Array} AuthEvents
 */
AdminListUserAuthEventsResponse.prototype['AuthEvents'] = undefined;

/**
 * @member {String} NextToken
 */
AdminListUserAuthEventsResponse.prototype['NextToken'] = undefined;
...
export default AdminListUserAuthEventsResponse;
