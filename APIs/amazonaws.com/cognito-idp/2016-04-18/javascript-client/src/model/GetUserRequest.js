...
class GetUserRequest {
     ...
     * @alias module:model/GetUserRequest
     * @param accessToken {String} 
     */
    constructor(accessToken) { 
        
        GetUserRequest.initialize(this, accessToken);
    }
     ...
     * @param {module:model/GetUserRequest} obj Optional instance to populate.
     * @return {module:model/GetUserRequest} The populated <code>GetUserRequest</code> instance.
     */
    ...
    static validateJSON(data) {
        ...
        for (const property of GetUserRequest.RequiredProperties) {
...
GetUserRequest.RequiredProperties = ["AccessToken"];

/**
 * @member {String} AccessToken
 */
GetUserRequest.prototype['AccessToken'] = undefined;
