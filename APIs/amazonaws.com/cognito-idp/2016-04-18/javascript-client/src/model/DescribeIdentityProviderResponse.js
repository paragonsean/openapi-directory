...
import DescribeIdentityProviderResponseIdentityProvider from './DescribeIdentityProviderResponseIdentityProvider';

/**
 * The DescribeIdentityProviderResponse model module.
 * @module model/DescribeIdentityProviderResponse
 * @version 2016-04-18
 */
class DescribeIdentityProviderResponse {
    /**
     * Constructs a new <code>DescribeIdentityProviderResponse</code>.
     * @alias module:model/DescribeIdentityProviderResponse
     * @param identityProvider {module:model/DescribeIdentityProviderResponseIdentityProvider} 
     */
    constructor(identityProvider) { 
        
        DescribeIdentityProviderResponse.initialize(this, identityProvider);
    }
     ...
     */
    static initialize(obj, identityProvider) { 
        obj['IdentityProvider'] = identityProvider;
    }

    /**
     * Constructs a <code>DescribeIdentityProviderResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeIdentityProviderResponse} obj Optional instance to populate.
     * @return {module:model/DescribeIdentityProviderResponse} The populated <code>DescribeIdentityProviderResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeIdentityProviderResponse();

            if (data.hasOwnProperty('IdentityProvider')) {
                obj['IdentityProvider'] = DescribeIdentityProviderResponseIdentityProvider.constructFromObject(data['IdentityProvider']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeIdentityProviderResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeIdentityProviderResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeIdentityProviderResponse.RequiredProperties) {
        ...
        if (data['IdentityProvider']) { // data not null
          DescribeIdentityProviderResponseIdentityProvider.validateJSON(data['IdentityProvider']);
        }
...
DescribeIdentityProviderResponse.RequiredProperties = ["IdentityProvider"];

/**
 * @member {module:model/DescribeIdentityProviderResponseIdentityProvider} IdentityProvider
 */
DescribeIdentityProviderResponse.prototype['IdentityProvider'] = undefined;
...
export default DescribeIdentityProviderResponse;
