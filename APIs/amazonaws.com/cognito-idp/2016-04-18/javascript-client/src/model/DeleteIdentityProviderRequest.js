...
/**
 * The DeleteIdentityProviderRequest model module.
 * @module model/DeleteIdentityProviderRequest
 * @version 2016-04-18
 */
class DeleteIdentityProviderRequest {
    /**
     * Constructs a new <code>DeleteIdentityProviderRequest</code>.
     * @alias module:model/DeleteIdentityProviderRequest
     * @param userPoolId {String} 
     * @param providerName {String} 
     */
    constructor(userPoolId, providerName) { 
        
        DeleteIdentityProviderRequest.initialize(this, userPoolId, providerName);
    }
    ...
    /**
     * Constructs a <code>DeleteIdentityProviderRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteIdentityProviderRequest} obj Optional instance to populate.
     * @return {module:model/DeleteIdentityProviderRequest} The populated <code>DeleteIdentityProviderRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteIdentityProviderRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteIdentityProviderRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteIdentityProviderRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteIdentityProviderRequest.RequiredProperties) {
...
DeleteIdentityProviderRequest.RequiredProperties = ["UserPoolId", "ProviderName"];

/**
 * @member {String} UserPoolId
 */
DeleteIdentityProviderRequest.prototype['UserPoolId'] = undefined;

/**
 * @member {String} ProviderName
 */
DeleteIdentityProviderRequest.prototype['ProviderName'] = undefined;
...
export default DeleteIdentityProviderRequest;
