...
/**
 * The AdminCreateUserConfigTypeInviteMessageTemplate model module.
 * @module model/AdminCreateUserConfigTypeInviteMessageTemplate
 * @version 2016-04-18
 */
class AdminCreateUserConfigTypeInviteMessageTemplate {
    /**
     * Constructs a new <code>AdminCreateUserConfigTypeInviteMessageTemplate</code>.
     * @alias module:model/AdminCreateUserConfigTypeInviteMessageTemplate
     * @implements module:model/MessageTemplateType
     */
    constructor() { 
        MessageTemplateType.initialize(this);
        AdminCreateUserConfigTypeInviteMessageTemplate.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AdminCreateUserConfigTypeInviteMessageTemplate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdminCreateUserConfigTypeInviteMessageTemplate} obj Optional instance to populate.
     * @return {module:model/AdminCreateUserConfigTypeInviteMessageTemplate} The populated <code>AdminCreateUserConfigTypeInviteMessageTemplate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdminCreateUserConfigTypeInviteMessageTemplate();
            MessageTemplateType.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>AdminCreateUserConfigTypeInviteMessageTemplate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdminCreateUserConfigTypeInviteMessageTemplate</code>.
     */
 ...
 */
AdminCreateUserConfigTypeInviteMessageTemplate.prototype['SMSMessage'] = undefined;

/**
 * @member {String} EmailMessage
 */
AdminCreateUserConfigTypeInviteMessageTemplate.prototype['EmailMessage'] = undefined;

/**
 * @member {String} EmailSubject
 */
AdminCreateUserConfigTypeInviteMessageTemplate.prototype['EmailSubject'] = undefined;


// Implement MessageTemplateType interface:
/**
 * @member {String} SMSMessage
 */
MessageTemplateType.prototype['SMSMessage'] = undefined;
/**
 * @member {String} EmailMessage
 */
MessageTemplateType.prototype['EmailMessage'] = undefined;
/**
 * @member {String} EmailSubject
 */
MessageTemplateType.prototype['EmailSubject'] = undefined;




export default AdminCreateUserConfigTypeInviteMessageTemplate;
