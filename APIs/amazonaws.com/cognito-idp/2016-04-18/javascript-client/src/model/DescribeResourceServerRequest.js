...
/**
 * The DescribeResourceServerRequest model module.
 * @module model/DescribeResourceServerRequest
 * @version 2016-04-18
 */
class DescribeResourceServerRequest {
    /**
     * Constructs a new <code>DescribeResourceServerRequest</code>.
     * @alias module:model/DescribeResourceServerRequest
     * @param userPoolId {String} 
     * @param identifier {String} 
     */
    constructor(userPoolId, identifier) { 
        
        DescribeResourceServerRequest.initialize(this, userPoolId, identifier);
    }
    ...
    /**
     * Constructs a <code>DescribeResourceServerRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeResourceServerRequest} obj Optional instance to populate.
     * @return {module:model/DescribeResourceServerRequest} The populated <code>DescribeResourceServerRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeResourceServerRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeResourceServerRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeResourceServerRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeResourceServerRequest.RequiredProperties) {
...
DescribeResourceServerRequest.RequiredProperties = ["UserPoolId", "Identifier"];

/**
 * @member {String} UserPoolId
 */
DescribeResourceServerRequest.prototype['UserPoolId'] = undefined;

/**
 * @member {String} Identifier
 */
DescribeResourceServerRequest.prototype['Identifier'] = undefined;
...
export default DescribeResourceServerRequest;
