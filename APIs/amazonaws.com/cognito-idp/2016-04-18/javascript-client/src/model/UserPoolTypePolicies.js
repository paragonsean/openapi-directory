...
/**
 * The UserPoolTypePolicies model module.
 * @module model/UserPoolTypePolicies
 * @version 2016-04-18
 */
class UserPoolTypePolicies {
    /**
     * Constructs a new <code>UserPoolTypePolicies</code>.
     * @alias module:model/UserPoolTypePolicies
     * @implements module:model/UserPoolPolicyType
     */
    constructor() { 
        UserPoolPolicyType.initialize(this);
        UserPoolTypePolicies.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UserPoolTypePolicies</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UserPoolTypePolicies} obj Optional instance to populate.
     * @return {module:model/UserPoolTypePolicies} The populated <code>UserPoolTypePolicies</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UserPoolTypePolicies();
    ...
    /**
     * Validates the JSON data with respect to <code>UserPoolTypePolicies</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UserPoolTypePolicies</code>.
     */
 ...
 */
UserPoolTypePolicies.prototype['PasswordPolicy'] = undefined;
...
export default UserPoolTypePolicies;
