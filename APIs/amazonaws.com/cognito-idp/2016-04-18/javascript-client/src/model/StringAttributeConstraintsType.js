...
/**
 * The StringAttributeConstraintsType model module.
 * @module model/StringAttributeConstraintsType
 * @version 2016-04-18
 */
class StringAttributeConstraintsType {
    /**
     * Constructs a new <code>StringAttributeConstraintsType</code>.
     * The constraints associated with a string attribute.
     * @alias module:model/StringAttributeConstraintsType
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>StringAttributeConstraintsType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StringAttributeConstraintsType} obj Optional instance to populate.
     * @return {module:model/StringAttributeConstraintsType} The populated <code>StringAttributeConstraintsType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StringAttributeConstraintsType();
    ...
    /**
     * Validates the JSON data with respect to <code>StringAttributeConstraintsType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StringAttributeConstraintsType</code>.
     */
...
export default StringAttributeConstraintsType;
