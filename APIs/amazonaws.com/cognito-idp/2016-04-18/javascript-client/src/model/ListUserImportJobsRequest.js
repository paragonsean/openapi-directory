...
/**
 * The ListUserImportJobsRequest model module.
 * @module model/ListUserImportJobsRequest
 * @version 2016-04-18
 */
class ListUserImportJobsRequest {
    /**
     * Constructs a new <code>ListUserImportJobsRequest</code>.
     * Represents the request to list the user import jobs.
     * @alias module:model/ListUserImportJobsRequest
     * @param userPoolId {String} 
     * @param maxResults {Number} 
     */
    constructor(userPoolId, maxResults) { 
        
        ListUserImportJobsRequest.initialize(this, userPoolId, maxResults);
    }
     ...
     */
    static initialize(obj, userPoolId, maxResults) { 
        obj['UserPoolId'] = userPoolId;
        obj['MaxResults'] = maxResults;
    }

    /**
     * Constructs a <code>ListUserImportJobsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListUserImportJobsRequest} obj Optional instance to populate.
     * @return {module:model/ListUserImportJobsRequest} The populated <code>ListUserImportJobsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListUserImportJobsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListUserImportJobsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListUserImportJobsRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListUserImportJobsRequest.RequiredProperties) {
...
ListUserImportJobsRequest.RequiredProperties = ["UserPoolId", "MaxResults"];

/**
 * @member {String} UserPoolId
 */
ListUserImportJobsRequest.prototype['UserPoolId'] = undefined;

/**
 * @member {Number} MaxResults
 */
ListUserImportJobsRequest.prototype['MaxResults'] = undefined;

/**
 * @member {String} PaginationToken
 */
ListUserImportJobsRequest.prototype['PaginationToken'] = undefined;
...
export default ListUserImportJobsRequest;
