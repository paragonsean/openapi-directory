...
/**
 * The AdminDisableProviderForUserRequestUser model module.
 * @module model/AdminDisableProviderForUserRequestUser
 * @version 2016-04-18
 */
class AdminDisableProviderForUserRequestUser {
    /**
     * Constructs a new <code>AdminDisableProviderForUserRequestUser</code>.
     * @alias module:model/AdminDisableProviderForUserRequestUser
     * @implements module:model/ProviderUserIdentifierType
     */
    constructor() { 
        ProviderUserIdentifierType.initialize(this);
        AdminDisableProviderForUserRequestUser.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AdminDisableProviderForUserRequestUser</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdminDisableProviderForUserRequestUser} obj Optional instance to populate.
     * @return {module:model/AdminDisableProviderForUserRequestUser} The populated <code>AdminDisableProviderForUserRequestUser</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdminDisableProviderForUserRequestUser();
    ...
    /**
     * Validates the JSON data with respect to <code>AdminDisableProviderForUserRequestUser</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdminDisableProviderForUserRequestUser</code>.
     */
 ...
 */
AdminDisableProviderForUserRequestUser.prototype['ProviderName'] = undefined;

/**
 * @member {String} ProviderAttributeName
 */
AdminDisableProviderForUserRequestUser.prototype['ProviderAttributeName'] = undefined;

/**
 * @member {String} ProviderAttributeValue
 */
AdminDisableProviderForUserRequestUser.prototype['ProviderAttributeValue'] = undefined;
...
export default AdminDisableProviderForUserRequestUser;
