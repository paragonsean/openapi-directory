...
/**
 * The CreateUserPoolClientRequestAnalyticsConfiguration model module.
 * @module model/CreateUserPoolClientRequestAnalyticsConfiguration
 * @version 2016-04-18
 */
class CreateUserPoolClientRequestAnalyticsConfiguration {
    /**
     * Constructs a new <code>CreateUserPoolClientRequestAnalyticsConfiguration</code>.
     * @alias module:model/CreateUserPoolClientRequestAnalyticsConfiguration
     * @implements module:model/AnalyticsConfigurationType
     */
    constructor() { 
        AnalyticsConfigurationType.initialize(this);
        CreateUserPoolClientRequestAnalyticsConfiguration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateUserPoolClientRequestAnalyticsConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateUserPoolClientRequestAnalyticsConfiguration} obj Optional instance to populate.
     * @return {module:model/CreateUserPoolClientRequestAnalyticsConfiguration} The populated <code>CreateUserPoolClientRequestAnalyticsConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateUserPoolClientRequestAnalyticsConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateUserPoolClientRequestAnalyticsConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateUserPoolClientRequestAnalyticsConfiguration</code>.
     */
 ...
 */
CreateUserPoolClientRequestAnalyticsConfiguration.prototype['ApplicationId'] = undefined;

/**
 * @member {String} ApplicationArn
 */
CreateUserPoolClientRequestAnalyticsConfiguration.prototype['ApplicationArn'] = undefined;

/**
 * @member {String} RoleArn
 */
CreateUserPoolClientRequestAnalyticsConfiguration.prototype['RoleArn'] = undefined;

/**
 * @member {String} ExternalId
 */
CreateUserPoolClientRequestAnalyticsConfiguration.prototype['ExternalId'] = undefined;

/**
 * @member {Boolean} UserDataShared
 */
CreateUserPoolClientRequestAnalyticsConfiguration.prototype['UserDataShared'] = undefined;
...
export default CreateUserPoolClientRequestAnalyticsConfiguration;
