...
/**
 * The GetUserAttributeVerificationCodeRequest model module.
 * @module model/GetUserAttributeVerificationCodeRequest
 * @version 2016-04-18
 */
class GetUserAttributeVerificationCodeRequest {
    /**
     * Constructs a new <code>GetUserAttributeVerificationCodeRequest</code>.
     * Represents the request to get user attribute verification.
     * @alias module:model/GetUserAttributeVerificationCodeRequest
     * @param accessToken {String} 
     * @param attributeName {String} 
     */
    constructor(accessToken, attributeName) { 
        
        GetUserAttributeVerificationCodeRequest.initialize(this, accessToken, attributeName);
    }
     ...
     */
    static initialize(obj, accessToken, attributeName) { 
        obj['AccessToken'] = accessToken;
        obj['AttributeName'] = attributeName;
    }

    /**
     * Constructs a <code>GetUserAttributeVerificationCodeRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetUserAttributeVerificationCodeRequest} obj Optional instance to populate.
     * @return {module:model/GetUserAttributeVerificationCodeRequest} The populated <code>GetUserAttributeVerificationCodeRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetUserAttributeVerificationCodeRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GetUserAttributeVerificationCodeRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetUserAttributeVerificationCodeRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetUserAttributeVerificationCodeRequest.RequiredProperties) {
...
GetUserAttributeVerificationCodeRequest.RequiredProperties = ["AccessToken", "AttributeName"];

/**
 * @member {String} AccessToken
 */
GetUserAttributeVerificationCodeRequest.prototype['AccessToken'] = undefined;

/**
 * @member {String} AttributeName
 */
GetUserAttributeVerificationCodeRequest.prototype['AttributeName'] = undefined;

/**
 * @member {Object} ClientMetadata
 */
GetUserAttributeVerificationCodeRequest.prototype['ClientMetadata'] = undefined;
...
export default GetUserAttributeVerificationCodeRequest;
