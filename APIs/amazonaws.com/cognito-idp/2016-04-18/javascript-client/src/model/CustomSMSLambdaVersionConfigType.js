...
import CustomSMSSenderLambdaVersionType from './CustomSMSSenderLambdaVersionType';

/**
 * The CustomSMSLambdaVersionConfigType model module.
 * @module model/CustomSMSLambdaVersionConfigType
 * @version 2016-04-18
 */
class CustomSMSLambdaVersionConfigType {
    /**
     * Constructs a new <code>CustomSMSLambdaVersionConfigType</code>.
     * A custom SMS sender Lambda configuration type.
     * @alias module:model/CustomSMSLambdaVersionConfigType
     * @param lambdaVersion {module:model/CustomSMSSenderLambdaVersionType} 
     * @param lambdaArn {String} 
     */
    constructor(lambdaVersion, lambdaArn) { 
        
        CustomSMSLambdaVersionConfigType.initialize(this, lambdaVersion, lambdaArn);
    }
     ...
     */
    static initialize(obj, lambdaVersion, lambdaArn) { 
        obj['LambdaVersion'] = lambdaVersion;
        obj['LambdaArn'] = lambdaArn;
    }

    /**
     * Constructs a <code>CustomSMSLambdaVersionConfigType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CustomSMSLambdaVersionConfigType} obj Optional instance to populate.
     * @return {module:model/CustomSMSLambdaVersionConfigType} The populated <code>CustomSMSLambdaVersionConfigType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CustomSMSLambdaVersionConfigType();

            if (data.hasOwnProperty('LambdaVersion')) {
                obj['LambdaVersion'] = ApiClient.convertToType(data['LambdaVersion'], CustomSMSSenderLambdaVersionType);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CustomSMSLambdaVersionConfigType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CustomSMSLambdaVersionConfigType</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CustomSMSLambdaVersionConfigType.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `LambdaVersion`
        if (data['LambdaVersion']) { // data not null
          CustomSMSSenderLambdaVersionType.validateJSON(data['LambdaVersion']);
        }
...
CustomSMSLambdaVersionConfigType.RequiredProperties = ["LambdaVersion", "LambdaArn"];

/**
 * @member {module:model/CustomSMSSenderLambdaVersionType} LambdaVersion
 */
CustomSMSLambdaVersionConfigType.prototype['LambdaVersion'] = undefined;

/**
 * @member {String} LambdaArn
 */
CustomSMSLambdaVersionConfigType.prototype['LambdaArn'] = undefined;
...
export default CustomSMSLambdaVersionConfigType;
