...
/**
 * The SetUICustomizationResponse model module.
 * @module model/SetUICustomizationResponse
 * @version 2016-04-18
 */
class SetUICustomizationResponse {
    /**
     * Constructs a new <code>SetUICustomizationResponse</code>.
     * @alias module:model/SetUICustomizationResponse
     * @param uICustomization {module:model/GetUICustomizationResponseUICustomization} 
     */
    constructor(uICustomization) { 
        
        SetUICustomizationResponse.initialize(this, uICustomization);
    }
    ...
    /**
     * Constructs a <code>SetUICustomizationResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SetUICustomizationResponse} obj Optional instance to populate.
     * @return {module:model/SetUICustomizationResponse} The populated <code>SetUICustomizationResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SetUICustomizationResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>SetUICustomizationResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SetUICustomizationResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SetUICustomizationResponse.RequiredProperties) {
...
SetUICustomizationResponse.RequiredProperties = ["UICustomization"];

/**
 * @member {module:model/GetUICustomizationResponseUICustomization} UICustomization
 */
SetUICustomizationResponse.prototype['UICustomization'] = undefined;
...
export default SetUICustomizationResponse;
