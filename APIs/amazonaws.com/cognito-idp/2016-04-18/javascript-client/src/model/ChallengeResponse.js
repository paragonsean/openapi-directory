...
export default class ChallengeResponse {
    ...
    /**
    * Returns a <code>ChallengeResponse</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ChallengeResponse} The enum <code>ChallengeResponse</code> value.
    */
