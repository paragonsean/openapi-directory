...
/**
 * The GetLogDeliveryConfigurationResponseLogDeliveryConfiguration model module.
 * @module model/GetLogDeliveryConfigurationResponseLogDeliveryConfiguration
 * @version 2016-04-18
 */
class GetLogDeliveryConfigurationResponseLogDeliveryConfiguration {
    /**
     * Constructs a new <code>GetLogDeliveryConfigurationResponseLogDeliveryConfiguration</code>.
     * @alias module:model/GetLogDeliveryConfigurationResponseLogDeliveryConfiguration
    ...
    constructor(userPoolId, logConfigurations) { 
        ...
        GetLogDeliveryConfigurationResponseLogDeliveryConfiguration.initialize(this, userPoolId, logConfigurations);
    }
    ...
    /**
     * Constructs a <code>GetLogDeliveryConfigurationResponseLogDeliveryConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetLogDeliveryConfigurationResponseLogDeliveryConfiguration} obj Optional instance to populate.
     * @return {module:model/GetLogDeliveryConfigurationResponseLogDeliveryConfiguration} The populated <code>GetLogDeliveryConfigurationResponseLogDeliveryConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetLogDeliveryConfigurationResponseLogDeliveryConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>GetLogDeliveryConfigurationResponseLogDeliveryConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetLogDeliveryConfigurationResponseLogDeliveryConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetLogDeliveryConfigurationResponseLogDeliveryConfiguration.RequiredProperties) {
...
GetLogDeliveryConfigurationResponseLogDeliveryConfiguration.RequiredProperties = ["UserPoolId", "LogConfigurations"];

/**
 * @member {String} UserPoolId
 */
GetLogDeliveryConfigurationResponseLogDeliveryConfiguration.prototype['UserPoolId'] = undefined;

/**
 * @member {Array} LogConfigurations
 */
GetLogDeliveryConfigurationResponseLogDeliveryConfiguration.prototype['LogConfigurations'] = undefined;
...
export default GetLogDeliveryConfigurationResponseLogDeliveryConfiguration;
