...
/**
 * The VerifyUserAttributeRequest model module.
 * @module model/VerifyUserAttributeRequest
 * @version 2016-04-18
 */
class VerifyUserAttributeRequest {
    /**
     * Constructs a new <code>VerifyUserAttributeRequest</code>.
     * Represents the request to verify user attributes.
     * @alias module:model/VerifyUserAttributeRequest
     * @param accessToken {String} 
     * @param attributeName {String} 
     * @param code {String} 
     */
    constructor(accessToken, attributeName, code) { 
        
        VerifyUserAttributeRequest.initialize(this, accessToken, attributeName, code);
    }
     ...
     */
    static initialize(obj, accessToken, attributeName, code) { 
    ...
    /**
     * Constructs a <code>VerifyUserAttributeRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VerifyUserAttributeRequest} obj Optional instance to populate.
     * @return {module:model/VerifyUserAttributeRequest} The populated <code>VerifyUserAttributeRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VerifyUserAttributeRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>VerifyUserAttributeRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VerifyUserAttributeRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of VerifyUserAttributeRequest.RequiredProperties) {
...
VerifyUserAttributeRequest.RequiredProperties = ["AccessToken", "AttributeName", "Code"];

/**
 * @member {String} AccessToken
 */
VerifyUserAttributeRequest.prototype['AccessToken'] = undefined;

/**
 * @member {String} AttributeName
 */
VerifyUserAttributeRequest.prototype['AttributeName'] = undefined;

/**
 * @member {String} Code
 */
VerifyUserAttributeRequest.prototype['Code'] = undefined;
...
export default VerifyUserAttributeRequest;
