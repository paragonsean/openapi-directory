...
/**
 * The CreateUserPoolRequestUsernameConfiguration model module.
 * @module model/CreateUserPoolRequestUsernameConfiguration
 * @version 2016-04-18
 */
class CreateUserPoolRequestUsernameConfiguration {
    /**
     * Constructs a new <code>CreateUserPoolRequestUsernameConfiguration</code>.
     * @alias module:model/CreateUserPoolRequestUsernameConfiguration
    ...
    constructor(caseSensitive) { 
        ...
        CreateUserPoolRequestUsernameConfiguration.initialize(this, caseSensitive);
    }
    ...
    /**
     * Constructs a <code>CreateUserPoolRequestUsernameConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateUserPoolRequestUsernameConfiguration} obj Optional instance to populate.
     * @return {module:model/CreateUserPoolRequestUsernameConfiguration} The populated <code>CreateUserPoolRequestUsernameConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateUserPoolRequestUsernameConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateUserPoolRequestUsernameConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateUserPoolRequestUsernameConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateUserPoolRequestUsernameConfiguration.RequiredProperties) {
...
CreateUserPoolRequestUsernameConfiguration.RequiredProperties = ["CaseSensitive"];

/**
 * @member {Boolean} CaseSensitive
 */
CreateUserPoolRequestUsernameConfiguration.prototype['CaseSensitive'] = undefined;
...
export default CreateUserPoolRequestUsernameConfiguration;
