...
/**
 * The PasswordPolicyType model module.
 * @module model/PasswordPolicyType
 * @version 2016-04-18
 */
class PasswordPolicyType {
    /**
     * Constructs a new <code>PasswordPolicyType</code>.
     * The password policy type.
     * @alias module:model/PasswordPolicyType
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>PasswordPolicyType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PasswordPolicyType} obj Optional instance to populate.
     * @return {module:model/PasswordPolicyType} The populated <code>PasswordPolicyType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PasswordPolicyType();
    ...
    /**
     * Validates the JSON data with respect to <code>PasswordPolicyType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PasswordPolicyType</code>.
     */
...
export default PasswordPolicyType;
