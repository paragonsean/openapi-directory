...
import AdminRespondToAuthChallengeResponseAuthenticationResult from './AdminRespondToAuthChallengeResponseAuthenticationResult';
import ChallengeNameType from './ChallengeNameType';

/**
 * The AdminRespondToAuthChallengeResponse model module.
 * @module model/AdminRespondToAuthChallengeResponse
 * @version 2016-04-18
 */
class AdminRespondToAuthChallengeResponse {
    /**
     * Constructs a new <code>AdminRespondToAuthChallengeResponse</code>.
     * Responds to the authentication challenge, as an administrator.
     * @alias module:model/AdminRespondToAuthChallengeResponse
     */
    constructor() { 
        
        AdminRespondToAuthChallengeResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AdminRespondToAuthChallengeResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdminRespondToAuthChallengeResponse} obj Optional instance to populate.
     * @return {module:model/AdminRespondToAuthChallengeResponse} The populated <code>AdminRespondToAuthChallengeResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdminRespondToAuthChallengeResponse();
            ...
            if (data.hasOwnProperty('AuthenticationResult')) {
                obj['AuthenticationResult'] = AdminRespondToAuthChallengeResponseAuthenticationResult.constructFromObject(data['AuthenticationResult']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AdminRespondToAuthChallengeResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdminRespondToAuthChallengeResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['AuthenticationResult']) { // data not null
          AdminRespondToAuthChallengeResponseAuthenticationResult.validateJSON(data['AuthenticationResult']);
        }
 ...
 */
AdminRespondToAuthChallengeResponse.prototype['ChallengeName'] = undefined;

/**
 * @member {String} Session
 */
AdminRespondToAuthChallengeResponse.prototype['Session'] = undefined;

/**
 * @member {Object} ChallengeParameters
 */
AdminRespondToAuthChallengeResponse.prototype['ChallengeParameters'] = undefined;

/**
 * @member {module:model/AdminRespondToAuthChallengeResponseAuthenticationResult} AuthenticationResult
 */
AdminRespondToAuthChallengeResponse.prototype['AuthenticationResult'] = undefined;
...
export default AdminRespondToAuthChallengeResponse;
