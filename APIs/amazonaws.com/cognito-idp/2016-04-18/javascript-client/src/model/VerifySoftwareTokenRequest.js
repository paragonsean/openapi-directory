...
/**
 * The VerifySoftwareTokenRequest model module.
 * @module model/VerifySoftwareTokenRequest
 * @version 2016-04-18
 */
class VerifySoftwareTokenRequest {
    /**
     * Constructs a new <code>VerifySoftwareTokenRequest</code>.
     * @alias module:model/VerifySoftwareTokenRequest
     * @param userCode {String} 
     */
    constructor(userCode) { 
        
        VerifySoftwareTokenRequest.initialize(this, userCode);
    }
     ...
     */
    static initialize(obj, userCode) { 
        obj['UserCode'] = userCode;
    }

    /**
     * Constructs a <code>VerifySoftwareTokenRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VerifySoftwareTokenRequest} obj Optional instance to populate.
     * @return {module:model/VerifySoftwareTokenRequest} The populated <code>VerifySoftwareTokenRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VerifySoftwareTokenRequest();
            ...
            if (data.hasOwnProperty('FriendlyDeviceName')) {
                obj['FriendlyDeviceName'] = ApiClient.convertToType(data['FriendlyDeviceName'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>VerifySoftwareTokenRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VerifySoftwareTokenRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of VerifySoftwareTokenRequest.RequiredProperties) {
        ...
        if (data['FriendlyDeviceName']) { // data not null
          String.validateJSON(data['FriendlyDeviceName']);
        }
...
VerifySoftwareTokenRequest.RequiredProperties = ["UserCode"];

/**
 * @member {String} AccessToken
 */
VerifySoftwareTokenRequest.prototype['AccessToken'] = undefined;

/**
 * @member {String} Session
 */
VerifySoftwareTokenRequest.prototype['Session'] = undefined;

/**
 * @member {String} UserCode
 */
VerifySoftwareTokenRequest.prototype['UserCode'] = undefined;

/**
 * @member {String} FriendlyDeviceName
 */
VerifySoftwareTokenRequest.prototype['FriendlyDeviceName'] = undefined;
...
export default VerifySoftwareTokenRequest;
