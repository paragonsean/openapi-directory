...
/**
 * The AdminLinkProviderForUserRequestSourceUser model module.
 * @module model/AdminLinkProviderForUserRequestSourceUser
 * @version 2016-04-18
 */
class AdminLinkProviderForUserRequestSourceUser {
    /**
     * Constructs a new <code>AdminLinkProviderForUserRequestSourceUser</code>.
     * @alias module:model/AdminLinkProviderForUserRequestSourceUser
     * @implements module:model/ProviderUserIdentifierType
     */
    constructor() { 
        ProviderUserIdentifierType.initialize(this);
        AdminLinkProviderForUserRequestSourceUser.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AdminLinkProviderForUserRequestSourceUser</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdminLinkProviderForUserRequestSourceUser} obj Optional instance to populate.
     * @return {module:model/AdminLinkProviderForUserRequestSourceUser} The populated <code>AdminLinkProviderForUserRequestSourceUser</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdminLinkProviderForUserRequestSourceUser();
    ...
    /**
     * Validates the JSON data with respect to <code>AdminLinkProviderForUserRequestSourceUser</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdminLinkProviderForUserRequestSourceUser</code>.
     */
 ...
 */
AdminLinkProviderForUserRequestSourceUser.prototype['ProviderName'] = undefined;

/**
 * @member {String} ProviderAttributeName
 */
AdminLinkProviderForUserRequestSourceUser.prototype['ProviderAttributeName'] = undefined;

/**
 * @member {String} ProviderAttributeValue
 */
AdminLinkProviderForUserRequestSourceUser.prototype['ProviderAttributeValue'] = undefined;
...
export default AdminLinkProviderForUserRequestSourceUser;
