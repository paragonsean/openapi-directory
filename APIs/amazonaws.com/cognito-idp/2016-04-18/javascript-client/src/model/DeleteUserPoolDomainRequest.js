...
/**
 * The DeleteUserPoolDomainRequest model module.
 * @module model/DeleteUserPoolDomainRequest
 * @version 2016-04-18
 */
class DeleteUserPoolDomainRequest {
    /**
     * Constructs a new <code>DeleteUserPoolDomainRequest</code>.
     * @alias module:model/DeleteUserPoolDomainRequest
     * @param domain {String} 
     * @param userPoolId {String} 
     */
    constructor(domain, userPoolId) { 
        
        DeleteUserPoolDomainRequest.initialize(this, domain, userPoolId);
    }
     ...
     */
    static initialize(obj, domain, userPoolId) { 
        obj['Domain'] = domain;
        obj['UserPoolId'] = userPoolId;
    }

    /**
     * Constructs a <code>DeleteUserPoolDomainRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteUserPoolDomainRequest} obj Optional instance to populate.
     * @return {module:model/DeleteUserPoolDomainRequest} The populated <code>DeleteUserPoolDomainRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteUserPoolDomainRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteUserPoolDomainRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteUserPoolDomainRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteUserPoolDomainRequest.RequiredProperties) {
...
DeleteUserPoolDomainRequest.RequiredProperties = ["Domain", "UserPoolId"];

/**
 * @member {String} Domain
 */
DeleteUserPoolDomainRequest.prototype['Domain'] = undefined;

/**
 * @member {String} UserPoolId
 */
DeleteUserPoolDomainRequest.prototype['UserPoolId'] = undefined;
...
export default DeleteUserPoolDomainRequest;
