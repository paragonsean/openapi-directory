...
/**
 * The AdminCreateUserResponseUser model module.
 * @module model/AdminCreateUserResponseUser
 * @version 2016-04-18
 */
class AdminCreateUserResponseUser {
    /**
     * Constructs a new <code>AdminCreateUserResponseUser</code>.
     * @alias module:model/AdminCreateUserResponseUser
     * @implements module:model/UserType
     */
    constructor() { 
        UserType.initialize(this);
        AdminCreateUserResponseUser.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AdminCreateUserResponseUser</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdminCreateUserResponseUser} obj Optional instance to populate.
     * @return {module:model/AdminCreateUserResponseUser} The populated <code>AdminCreateUserResponseUser</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdminCreateUserResponseUser();
    ...
    /**
     * Validates the JSON data with respect to <code>AdminCreateUserResponseUser</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdminCreateUserResponseUser</code>.
     */
 ...
 */
AdminCreateUserResponseUser.prototype['Username'] = undefined;

/**
 * @member {Array} Attributes
 */
AdminCreateUserResponseUser.prototype['Attributes'] = undefined;

/**
 * @member {Date} UserCreateDate
 */
AdminCreateUserResponseUser.prototype['UserCreateDate'] = undefined;

/**
 * @member {Date} UserLastModifiedDate
 */
AdminCreateUserResponseUser.prototype['UserLastModifiedDate'] = undefined;

/**
 * @member {Boolean} Enabled
 */
AdminCreateUserResponseUser.prototype['Enabled'] = undefined;

/**
 * @member {module:model/UserStatusType} UserStatus
 */
AdminCreateUserResponseUser.prototype['UserStatus'] = undefined;

/**
 * @member {Array} MFAOptions
 */
AdminCreateUserResponseUser.prototype['MFAOptions'] = undefined;
 ...
 * @member {String} Username
 */
UserType.prototype['Username'] = undefined;
/**
 * @member {Array} Attributes
 */
UserType.prototype['Attributes'] = undefined;
/**
 * @member {Date} UserCreateDate
 */
UserType.prototype['UserCreateDate'] = undefined;
/**
 * @member {Date} UserLastModifiedDate
 */
UserType.prototype['UserLastModifiedDate'] = undefined;
/**
 * @member {Boolean} Enabled
 */
UserType.prototype['Enabled'] = undefined;
/**
 * @member {module:model/UserStatusType} UserStatus
 */
UserType.prototype['UserStatus'] = undefined;
/**
 * @member {Array} MFAOptions
 */
UserType.prototype['MFAOptions'] = undefined;




export default AdminCreateUserResponseUser;
