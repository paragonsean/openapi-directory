...
import SignUpResponseCodeDeliveryDetails from './SignUpResponseCodeDeliveryDetails';
...
class SignUpResponse {
     ...
     * @param userSub {String} 
     */
    constructor(userConfirmed, userSub) { 
        
        SignUpResponse.initialize(this, userConfirmed, userSub);
    }
     ...
     */
    static initialize(obj, userConfirmed, userSub) { 
        obj['UserConfirmed'] = userConfirmed;
        obj['UserSub'] = userSub;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('UserConfirmed')) {
                obj['UserConfirmed'] = ApiClient.convertToType(data['UserConfirmed'], 'Boolean');
            }
            if (data.hasOwnProperty('CodeDeliveryDetails')) {
                obj['CodeDeliveryDetails'] = SignUpResponseCodeDeliveryDetails.constructFromObject(data['CodeDeliveryDetails']);
            }
            if (data.hasOwnProperty('UserSub')) {
                obj['UserSub'] = ApiClient.convertToType(data['UserSub'], 'String');
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        // validate the optional field `UserConfirmed`
        if (data['UserConfirmed']) { // data not null
          Boolean.validateJSON(data['UserConfirmed']);
        }
        // validate the optional field `CodeDeliveryDetails`
        if (data['CodeDeliveryDetails']) { // data not null
          SignUpResponseCodeDeliveryDetails.validateJSON(data['CodeDeliveryDetails']);
        }
        // validate the optional field `UserSub`
        if (data['UserSub']) { // data not null
          String.validateJSON(data['UserSub']);
        }
...
SignUpResponse.RequiredProperties = ["UserConfirmed", "UserSub"];

/**
 * @member {Boolean} UserConfirmed
 */
SignUpResponse.prototype['UserConfirmed'] = undefined;

/**
 * @member {module:model/SignUpResponseCodeDeliveryDetails} CodeDeliveryDetails
 */
SignUpResponse.prototype['CodeDeliveryDetails'] = undefined;

/**
 * @member {String} UserSub
 */
SignUpResponse.prototype['UserSub'] = undefined;
