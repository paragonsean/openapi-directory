...
import AuthenticationResultTypeNewDeviceMetadata from './AuthenticationResultTypeNewDeviceMetadata';

/**
 * The AdminRespondToAuthChallengeResponseAuthenticationResult model module.
 * @module model/AdminRespondToAuthChallengeResponseAuthenticationResult
 * @version 2016-04-18
 */
class AdminRespondToAuthChallengeResponseAuthenticationResult {
    /**
     * Constructs a new <code>AdminRespondToAuthChallengeResponseAuthenticationResult</code>.
     * @alias module:model/AdminRespondToAuthChallengeResponseAuthenticationResult
     * @implements module:model/AuthenticationResultType
     */
    constructor() { 
        AuthenticationResultType.initialize(this);
        AdminRespondToAuthChallengeResponseAuthenticationResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AdminRespondToAuthChallengeResponseAuthenticationResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdminRespondToAuthChallengeResponseAuthenticationResult} obj Optional instance to populate.
     * @return {module:model/AdminRespondToAuthChallengeResponseAuthenticationResult} The populated <code>AdminRespondToAuthChallengeResponseAuthenticationResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdminRespondToAuthChallengeResponseAuthenticationResult();
            AuthenticationResultType.constructFromObject(data, obj);
            ...
            if (data.hasOwnProperty('NewDeviceMetadata')) {
                obj['NewDeviceMetadata'] = AuthenticationResultTypeNewDeviceMetadata.constructFromObject(data['NewDeviceMetadata']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AdminRespondToAuthChallengeResponseAuthenticationResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdminRespondToAuthChallengeResponseAuthenticationResult</code>.
     */
    static validateJSON(data) {
        ...
        if (data['NewDeviceMetadata']) { // data not null
          AuthenticationResultTypeNewDeviceMetadata.validateJSON(data['NewDeviceMetadata']);
        }
 ...
 */
AdminRespondToAuthChallengeResponseAuthenticationResult.prototype['AccessToken'] = undefined;

/**
 * @member {Number} ExpiresIn
 */
AdminRespondToAuthChallengeResponseAuthenticationResult.prototype['ExpiresIn'] = undefined;

/**
 * @member {String} TokenType
 */
AdminRespondToAuthChallengeResponseAuthenticationResult.prototype['TokenType'] = undefined;

/**
 * @member {String} RefreshToken
 */
AdminRespondToAuthChallengeResponseAuthenticationResult.prototype['RefreshToken'] = undefined;

/**
 * @member {String} IdToken
 */
AdminRespondToAuthChallengeResponseAuthenticationResult.prototype['IdToken'] = undefined;

/**
 * @member {module:model/AuthenticationResultTypeNewDeviceMetadata} NewDeviceMetadata
 */
AdminRespondToAuthChallengeResponseAuthenticationResult.prototype['NewDeviceMetadata'] = undefined;


// Implement AuthenticationResultType interface:
/**
 * @member {String} AccessToken
 */
AuthenticationResultType.prototype['AccessToken'] = undefined;
/**
 * @member {Number} ExpiresIn
 */
AuthenticationResultType.prototype['ExpiresIn'] = undefined;
/**
 * @member {String} TokenType
 */
AuthenticationResultType.prototype['TokenType'] = undefined;
/**
 * @member {String} RefreshToken
 */
AuthenticationResultType.prototype['RefreshToken'] = undefined;
/**
 * @member {String} IdToken
 */
AuthenticationResultType.prototype['IdToken'] = undefined;
/**
 * @member {module:model/AuthenticationResultTypeNewDeviceMetadata} NewDeviceMetadata
 */
AuthenticationResultType.prototype['NewDeviceMetadata'] = undefined;




export default AdminRespondToAuthChallengeResponseAuthenticationResult;
