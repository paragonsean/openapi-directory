...
/**
 * The CompromisedCredentialsRiskConfigurationTypeActions model module.
 * @module model/CompromisedCredentialsRiskConfigurationTypeActions
 * @version 2016-04-18
 */
class CompromisedCredentialsRiskConfigurationTypeActions {
    /**
     * Constructs a new <code>CompromisedCredentialsRiskConfigurationTypeActions</code>.
     * @alias module:model/CompromisedCredentialsRiskConfigurationTypeActions
     * @implements module:model/CompromisedCredentialsActionsType
    ...
    constructor(eventAction) { 
        ...
        CompromisedCredentialsRiskConfigurationTypeActions.initialize(this, eventAction);
    }
    ...
    /**
     * Constructs a <code>CompromisedCredentialsRiskConfigurationTypeActions</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CompromisedCredentialsRiskConfigurationTypeActions} obj Optional instance to populate.
     * @return {module:model/CompromisedCredentialsRiskConfigurationTypeActions} The populated <code>CompromisedCredentialsRiskConfigurationTypeActions</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CompromisedCredentialsRiskConfigurationTypeActions();
            CompromisedCredentialsActionsType.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>CompromisedCredentialsRiskConfigurationTypeActions</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CompromisedCredentialsRiskConfigurationTypeActions</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CompromisedCredentialsRiskConfigurationTypeActions.RequiredProperties) {
...
CompromisedCredentialsRiskConfigurationTypeActions.RequiredProperties = ["EventAction"];

/**
 * @member {module:model/CompromisedCredentialsEventActionType} EventAction
 */
CompromisedCredentialsRiskConfigurationTypeActions.prototype['EventAction'] = undefined;


// Implement CompromisedCredentialsActionsType interface:
/**
 * @member {module:model/CompromisedCredentialsEventActionType} EventAction
 */
...
export default CompromisedCredentialsRiskConfigurationTypeActions;
