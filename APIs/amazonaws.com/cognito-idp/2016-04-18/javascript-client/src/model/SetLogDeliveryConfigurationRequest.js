...
/**
 * The SetLogDeliveryConfigurationRequest model module.
 * @module model/SetLogDeliveryConfigurationRequest
 * @version 2016-04-18
 */
class SetLogDeliveryConfigurationRequest {
    /**
     * Constructs a new <code>SetLogDeliveryConfigurationRequest</code>.
     * @alias module:model/SetLogDeliveryConfigurationRequest
     * @param userPoolId {String} 
     * @param logConfigurations {Array} 
     */
    constructor(userPoolId, logConfigurations) { 
        
        SetLogDeliveryConfigurationRequest.initialize(this, userPoolId, logConfigurations);
    }
     ...
     */
    static initialize(obj, userPoolId, logConfigurations) { 
        obj['UserPoolId'] = userPoolId;
        obj['LogConfigurations'] = logConfigurations;
    }

    /**
     * Constructs a <code>SetLogDeliveryConfigurationRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SetLogDeliveryConfigurationRequest} obj Optional instance to populate.
     * @return {module:model/SetLogDeliveryConfigurationRequest} The populated <code>SetLogDeliveryConfigurationRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SetLogDeliveryConfigurationRequest();

            if (data.hasOwnProperty('UserPoolId')) {
                obj['UserPoolId'] = ApiClient.convertToType(data['UserPoolId'], 'String');
            }
            if (data.hasOwnProperty('LogConfigurations')) {
                obj['LogConfigurations'] = ApiClient.convertToType(data['LogConfigurations'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>SetLogDeliveryConfigurationRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SetLogDeliveryConfigurationRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SetLogDeliveryConfigurationRequest.RequiredProperties) {
        ...
        // validate the optional field `LogConfigurations`
        if (data['LogConfigurations']) { // data not null
          Array.validateJSON(data['LogConfigurations']);
        }
...
SetLogDeliveryConfigurationRequest.RequiredProperties = ["UserPoolId", "LogConfigurations"];

/**
 * @member {String} UserPoolId
 */
SetLogDeliveryConfigurationRequest.prototype['UserPoolId'] = undefined;

/**
 * @member {Array} LogConfigurations
 */
SetLogDeliveryConfigurationRequest.prototype['LogConfigurations'] = undefined;
...
export default SetLogDeliveryConfigurationRequest;
