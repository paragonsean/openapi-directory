...
import ForgotPasswordResponseCodeDeliveryDetails from './ForgotPasswordResponseCodeDeliveryDetails';
...
class ForgotPasswordResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('CodeDeliveryDetails')) {
                obj['CodeDeliveryDetails'] = ForgotPasswordResponseCodeDeliveryDetails.constructFromObject(data['CodeDeliveryDetails']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['CodeDeliveryDetails']) { // data not null
          ForgotPasswordResponseCodeDeliveryDetails.validateJSON(data['CodeDeliveryDetails']);
        }
...
/**
 * @member {module:model/ForgotPasswordResponseCodeDeliveryDetails} CodeDeliveryDetails
 */
ForgotPasswordResponse.prototype['CodeDeliveryDetails'] = undefined;
