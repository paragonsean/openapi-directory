...
/**
 * The SetUserPoolMfaConfigResponse model module.
 * @module model/SetUserPoolMfaConfigResponse
 * @version 2016-04-18
 */
class SetUserPoolMfaConfigResponse {
    /**
     * Constructs a new <code>SetUserPoolMfaConfigResponse</code>.
     * @alias module:model/SetUserPoolMfaConfigResponse
     */
    constructor() { 
        
        SetUserPoolMfaConfigResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SetUserPoolMfaConfigResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SetUserPoolMfaConfigResponse} obj Optional instance to populate.
     * @return {module:model/SetUserPoolMfaConfigResponse} The populated <code>SetUserPoolMfaConfigResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SetUserPoolMfaConfigResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>SetUserPoolMfaConfigResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SetUserPoolMfaConfigResponse</code>.
     */
 ...
 */
SetUserPoolMfaConfigResponse.prototype['SmsMfaConfiguration'] = undefined;

/**
 * @member {module:model/SetUserPoolMfaConfigResponseSoftwareTokenMfaConfiguration} SoftwareTokenMfaConfiguration
 */
SetUserPoolMfaConfigResponse.prototype['SoftwareTokenMfaConfiguration'] = undefined;

/**
 * @member {module:model/UserPoolMfaType} MfaConfiguration
 */
SetUserPoolMfaConfigResponse.prototype['MfaConfiguration'] = undefined;
...
export default SetUserPoolMfaConfigResponse;
