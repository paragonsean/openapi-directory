...
/**
 * The GetUICustomizationResponseUICustomization model module.
 * @module model/GetUICustomizationResponseUICustomization
 * @version 2016-04-18
 */
class GetUICustomizationResponseUICustomization {
    /**
     * Constructs a new <code>GetUICustomizationResponseUICustomization</code>.
     * @alias module:model/GetUICustomizationResponseUICustomization
     * @implements module:model/UICustomizationType
     */
    constructor() { 
        UICustomizationType.initialize(this);
        GetUICustomizationResponseUICustomization.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetUICustomizationResponseUICustomization</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetUICustomizationResponseUICustomization} obj Optional instance to populate.
     * @return {module:model/GetUICustomizationResponseUICustomization} The populated <code>GetUICustomizationResponseUICustomization</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetUICustomizationResponseUICustomization();
            UICustomizationType.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>GetUICustomizationResponseUICustomization</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetUICustomizationResponseUICustomization</code>.
     */
 ...
 */
GetUICustomizationResponseUICustomization.prototype['UserPoolId'] = undefined;

/**
 * @member {String} ClientId
 */
GetUICustomizationResponseUICustomization.prototype['ClientId'] = undefined;

/**
 * @member {String} ImageUrl
 */
GetUICustomizationResponseUICustomization.prototype['ImageUrl'] = undefined;

/**
 * @member {String} CSS
 */
GetUICustomizationResponseUICustomization.prototype['CSS'] = undefined;

/**
 * @member {String} CSSVersion
 */
GetUICustomizationResponseUICustomization.prototype['CSSVersion'] = undefined;

/**
 * @member {Date} LastModifiedDate
 */
GetUICustomizationResponseUICustomization.prototype['LastModifiedDate'] = undefined;

/**
 * @member {Date} CreationDate
 */
GetUICustomizationResponseUICustomization.prototype['CreationDate'] = undefined;


// Implement UICustomizationType interface:
/**
 * @member {String} UserPoolId
 */
...
export default GetUICustomizationResponseUICustomization;
