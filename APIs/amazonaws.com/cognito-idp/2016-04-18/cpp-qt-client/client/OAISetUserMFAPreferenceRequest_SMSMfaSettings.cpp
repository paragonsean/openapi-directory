...
OAISetUserMFAPreferenceRequest_SMSMfaSettings::OAISetUserMFAPreferenceRequest_SMSMfaSettings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISetUserMFAPreferenceRequest_SMSMfaSettings::OAISetUserMFAPreferenceRequest_SMSMfaSettings() {
    this->initializeModel();
}

OAISetUserMFAPreferenceRequest_SMSMfaSettings::~OAISetUserMFAPreferenceRequest_SMSMfaSettings() {}

void OAISetUserMFAPreferenceRequest_SMSMfaSettings::initializeModel() {
...
void OAISetUserMFAPreferenceRequest_SMSMfaSettings::fromJson(QString jsonString) {
...
void OAISetUserMFAPreferenceRequest_SMSMfaSettings::fromJsonObject(QJsonObject json) {
...
QString OAISetUserMFAPreferenceRequest_SMSMfaSettings::asJson() const {
...
QJsonObject OAISetUserMFAPreferenceRequest_SMSMfaSettings::asJsonObject() const {
    QJsonObject obj;
    if (m_enabled_isSet) {
...
bool OAISetUserMFAPreferenceRequest_SMSMfaSettings::getEnabled() const {
    return m_enabled;
}
void OAISetUserMFAPreferenceRequest_SMSMfaSettings::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAISetUserMFAPreferenceRequest_SMSMfaSettings::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAISetUserMFAPreferenceRequest_SMSMfaSettings::is_enabled_Valid() const{
    return m_enabled_isValid;
}

bool OAISetUserMFAPreferenceRequest_SMSMfaSettings::getPreferredMfa() const {
    return m_preferred_mfa;
}
void OAISetUserMFAPreferenceRequest_SMSMfaSettings::setPreferredMfa(const bool &preferred_mfa) {
    m_preferred_mfa = preferred_mfa;
    m_preferred_mfa_isSet = true;
}

bool OAISetUserMFAPreferenceRequest_SMSMfaSettings::is_preferred_mfa_Set() const{
    return m_preferred_mfa_isSet;
}

bool OAISetUserMFAPreferenceRequest_SMSMfaSettings::is_preferred_mfa_Valid() const{
    return m_preferred_mfa_isValid;
}

bool OAISetUserMFAPreferenceRequest_SMSMfaSettings::isSet() const {
...
bool OAISetUserMFAPreferenceRequest_SMSMfaSettings::isValid() const {
