...
#include "OAIFeedbackValueType.h"
...
OAIFeedbackValueType::OAIFeedbackValueType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFeedbackValueType::OAIFeedbackValueType() {
    this->initializeModel();
}

OAIFeedbackValueType::~OAIFeedbackValueType() {}

void OAIFeedbackValueType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIFeedbackValueType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIFeedbackValueType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("Valid", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFeedbackValueType::VALID;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Invalid", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFeedbackValueType::INVALID;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIFeedbackValueType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIFeedbackValueType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIFeedbackValueType::VALID:
            val = "Valid";
            break;
        case eOAIFeedbackValueType::INVALID:
            val = "Invalid";
            break;
        default:
            break;
...
QJsonValue OAIFeedbackValueType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIFeedbackValueType::eOAIFeedbackValueType OAIFeedbackValueType::getValue() const {
    return m_value;
}

void OAIFeedbackValueType::setValue(const OAIFeedbackValueType::eOAIFeedbackValueType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIFeedbackValueType::isSet() const {
    
    return m_value_isSet;
}

bool OAIFeedbackValueType::isValid() const {
