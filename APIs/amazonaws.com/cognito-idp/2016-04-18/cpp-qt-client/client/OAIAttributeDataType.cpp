...
OAIAttributeDataType::OAIAttributeDataType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAttributeDataType::OAIAttributeDataType() {
    this->initializeModel();
}

OAIAttributeDataType::~OAIAttributeDataType() {}

void OAIAttributeDataType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIAttributeDataType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIAttributeDataType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("String", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAttributeDataType::STRING;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Number", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAttributeDataType::NUMBER;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("DateTime", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAttributeDataType::DATETIME;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Boolean", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAttributeDataType::BOOLEAN;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIAttributeDataType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIAttributeDataType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIAttributeDataType::STRING:
            val = "String";
            break;
        case eOAIAttributeDataType::NUMBER:
            val = "Number";
            break;
        case eOAIAttributeDataType::DATETIME:
            val = "DateTime";
            break;
        case eOAIAttributeDataType::BOOLEAN:
            val = "Boolean";
            break;
        default:
            break;
...
QJsonValue OAIAttributeDataType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIAttributeDataType::eOAIAttributeDataType OAIAttributeDataType::getValue() const {
    return m_value;
}

void OAIAttributeDataType::setValue(const OAIAttributeDataType::eOAIAttributeDataType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIAttributeDataType::isSet() const {
    
    return m_value_isSet;
}

bool OAIAttributeDataType::isValid() const {
