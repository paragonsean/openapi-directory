...
OAIUserPoolType_UsernameConfiguration::OAIUserPoolType_UsernameConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUserPoolType_UsernameConfiguration::OAIUserPoolType_UsernameConfiguration() {
    this->initializeModel();
}

OAIUserPoolType_UsernameConfiguration::~OAIUserPoolType_UsernameConfiguration() {}

void OAIUserPoolType_UsernameConfiguration::initializeModel() {

    m_case_sensitive_isSet = false;
    m_case_sensitive_isValid = false;
}

void OAIUserPoolType_UsernameConfiguration::fromJson(QString jsonString) {
...
void OAIUserPoolType_UsernameConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIUserPoolType_UsernameConfiguration::asJson() const {
...
QJsonObject OAIUserPoolType_UsernameConfiguration::asJsonObject() const {
    QJsonObject obj;
...
bool OAIUserPoolType_UsernameConfiguration::getCaseSensitive() const {
    return m_case_sensitive;
}
void OAIUserPoolType_UsernameConfiguration::setCaseSensitive(const bool &case_sensitive) {
    m_case_sensitive = case_sensitive;
    m_case_sensitive_isSet = true;
}

bool OAIUserPoolType_UsernameConfiguration::is_case_sensitive_Set() const{
    return m_case_sensitive_isSet;
}

bool OAIUserPoolType_UsernameConfiguration::is_case_sensitive_Valid() const{
    return m_case_sensitive_isValid;
}

bool OAIUserPoolType_UsernameConfiguration::isSet() const {
...
bool OAIUserPoolType_UsernameConfiguration::isValid() const {
