...
OAIRiskConfigurationType_AccountTakeoverRiskConfiguration::OAIRiskConfigurationType_AccountTakeoverRiskConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRiskConfigurationType_AccountTakeoverRiskConfiguration::OAIRiskConfigurationType_AccountTakeoverRiskConfiguration() {
    this->initializeModel();
}

OAIRiskConfigurationType_AccountTakeoverRiskConfiguration::~OAIRiskConfigurationType_AccountTakeoverRiskConfiguration() {}

void OAIRiskConfigurationType_AccountTakeoverRiskConfiguration::initializeModel() {
...
void OAIRiskConfigurationType_AccountTakeoverRiskConfiguration::fromJson(QString jsonString) {
...
void OAIRiskConfigurationType_AccountTakeoverRiskConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIRiskConfigurationType_AccountTakeoverRiskConfiguration::asJson() const {
...
QJsonObject OAIRiskConfigurationType_AccountTakeoverRiskConfiguration::asJsonObject() const {
    QJsonObject obj;
...
OAIAccountTakeoverRiskConfigurationType_NotifyConfiguration OAIRiskConfigurationType_AccountTakeoverRiskConfiguration::getNotifyConfiguration() const {
    return m_notify_configuration;
}
void OAIRiskConfigurationType_AccountTakeoverRiskConfiguration::setNotifyConfiguration(const OAIAccountTakeoverRiskConfigurationType_NotifyConfiguration &notify_configuration) {
    m_notify_configuration = notify_configuration;
    m_notify_configuration_isSet = true;
}

bool OAIRiskConfigurationType_AccountTakeoverRiskConfiguration::is_notify_configuration_Set() const{
    return m_notify_configuration_isSet;
}

bool OAIRiskConfigurationType_AccountTakeoverRiskConfiguration::is_notify_configuration_Valid() const{
    return m_notify_configuration_isValid;
}

OAIAccountTakeoverRiskConfigurationType_Actions OAIRiskConfigurationType_AccountTakeoverRiskConfiguration::getActions() const {
    return m_actions;
}
void OAIRiskConfigurationType_AccountTakeoverRiskConfiguration::setActions(const OAIAccountTakeoverRiskConfigurationType_Actions &actions) {
    m_actions = actions;
    m_actions_isSet = true;
}

bool OAIRiskConfigurationType_AccountTakeoverRiskConfiguration::is_actions_Set() const{
    return m_actions_isSet;
}

bool OAIRiskConfigurationType_AccountTakeoverRiskConfiguration::is_actions_Valid() const{
    return m_actions_isValid;
}

bool OAIRiskConfigurationType_AccountTakeoverRiskConfiguration::isSet() const {
...
bool OAIRiskConfigurationType_AccountTakeoverRiskConfiguration::isValid() const {
