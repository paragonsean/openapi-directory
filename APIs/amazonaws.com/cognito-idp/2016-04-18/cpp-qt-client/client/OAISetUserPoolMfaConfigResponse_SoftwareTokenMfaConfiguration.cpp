...
OAISetUserPoolMfaConfigResponse_SoftwareTokenMfaConfiguration::OAISetUserPoolMfaConfigResponse_SoftwareTokenMfaConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISetUserPoolMfaConfigResponse_SoftwareTokenMfaConfiguration::OAISetUserPoolMfaConfigResponse_SoftwareTokenMfaConfiguration() {
    this->initializeModel();
}

OAISetUserPoolMfaConfigResponse_SoftwareTokenMfaConfiguration::~OAISetUserPoolMfaConfigResponse_SoftwareTokenMfaConfiguration() {}

void OAISetUserPoolMfaConfigResponse_SoftwareTokenMfaConfiguration::initializeModel() {

    m_enabled_isSet = false;
    m_enabled_isValid = false;
}

void OAISetUserPoolMfaConfigResponse_SoftwareTokenMfaConfiguration::fromJson(QString jsonString) {
...
void OAISetUserPoolMfaConfigResponse_SoftwareTokenMfaConfiguration::fromJsonObject(QJsonObject json) {

    m_enabled_isValid = ::OpenAPI::fromJsonValue(m_enabled, json[QString("Enabled")]);
    m_enabled_isSet = !json[QString("Enabled")].isNull() && m_enabled_isValid;
}

QString OAISetUserPoolMfaConfigResponse_SoftwareTokenMfaConfiguration::asJson() const {
...
QJsonObject OAISetUserPoolMfaConfigResponse_SoftwareTokenMfaConfiguration::asJsonObject() const {
    QJsonObject obj;
    if (m_enabled_isSet) {
...
bool OAISetUserPoolMfaConfigResponse_SoftwareTokenMfaConfiguration::getEnabled() const {
    return m_enabled;
}
void OAISetUserPoolMfaConfigResponse_SoftwareTokenMfaConfiguration::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAISetUserPoolMfaConfigResponse_SoftwareTokenMfaConfiguration::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAISetUserPoolMfaConfigResponse_SoftwareTokenMfaConfiguration::is_enabled_Valid() const{
    return m_enabled_isValid;
}

bool OAISetUserPoolMfaConfigResponse_SoftwareTokenMfaConfiguration::isSet() const {
...
bool OAISetUserPoolMfaConfigResponse_SoftwareTokenMfaConfiguration::isValid() const {
