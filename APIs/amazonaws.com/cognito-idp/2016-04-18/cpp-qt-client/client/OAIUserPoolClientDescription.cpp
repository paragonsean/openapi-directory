...
#include "OAIUserPoolClientDescription.h"
...
OAIUserPoolClientDescription::OAIUserPoolClientDescription(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUserPoolClientDescription::OAIUserPoolClientDescription() {
    this->initializeModel();
}

OAIUserPoolClientDescription::~OAIUserPoolClientDescription() {}

void OAIUserPoolClientDescription::initializeModel() {
...
void OAIUserPoolClientDescription::fromJson(QString jsonString) {
...
void OAIUserPoolClientDescription::fromJsonObject(QJsonObject json) {
...
QString OAIUserPoolClientDescription::asJson() const {
...
QJsonObject OAIUserPoolClientDescription::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUserPoolClientDescription::getClientId() const {
    return m_client_id;
}
void OAIUserPoolClientDescription::setClientId(const QString &client_id) {
    m_client_id = client_id;
    m_client_id_isSet = true;
}

bool OAIUserPoolClientDescription::is_client_id_Set() const{
    return m_client_id_isSet;
}

bool OAIUserPoolClientDescription::is_client_id_Valid() const{
    return m_client_id_isValid;
}

QString OAIUserPoolClientDescription::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIUserPoolClientDescription::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIUserPoolClientDescription::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIUserPoolClientDescription::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

QString OAIUserPoolClientDescription::getClientName() const {
    return m_client_name;
}
void OAIUserPoolClientDescription::setClientName(const QString &client_name) {
    m_client_name = client_name;
    m_client_name_isSet = true;
}

bool OAIUserPoolClientDescription::is_client_name_Set() const{
    return m_client_name_isSet;
}

bool OAIUserPoolClientDescription::is_client_name_Valid() const{
    return m_client_name_isValid;
}

bool OAIUserPoolClientDescription::isSet() const {
...
bool OAIUserPoolClientDescription::isValid() const {
