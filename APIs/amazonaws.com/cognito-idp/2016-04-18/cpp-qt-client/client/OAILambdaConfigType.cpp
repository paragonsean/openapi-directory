...
OAILambdaConfigType::OAILambdaConfigType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILambdaConfigType::OAILambdaConfigType() {
    this->initializeModel();
}

OAILambdaConfigType::~OAILambdaConfigType() {}

void OAILambdaConfigType::initializeModel() {
...
void OAILambdaConfigType::fromJson(QString jsonString) {
...
void OAILambdaConfigType::fromJsonObject(QJsonObject json) {
...
QString OAILambdaConfigType::asJson() const {
...
QJsonObject OAILambdaConfigType::asJsonObject() const {
    QJsonObject obj;
...
QString OAILambdaConfigType::getPreSignUp() const {
    return m_pre_sign_up;
}
void OAILambdaConfigType::setPreSignUp(const QString &pre_sign_up) {
    m_pre_sign_up = pre_sign_up;
    m_pre_sign_up_isSet = true;
}

bool OAILambdaConfigType::is_pre_sign_up_Set() const{
    return m_pre_sign_up_isSet;
}

bool OAILambdaConfigType::is_pre_sign_up_Valid() const{
    return m_pre_sign_up_isValid;
}

QString OAILambdaConfigType::getCustomMessage() const {
    return m_custom_message;
}
void OAILambdaConfigType::setCustomMessage(const QString &custom_message) {
    m_custom_message = custom_message;
    m_custom_message_isSet = true;
}

bool OAILambdaConfigType::is_custom_message_Set() const{
    return m_custom_message_isSet;
}

bool OAILambdaConfigType::is_custom_message_Valid() const{
    return m_custom_message_isValid;
}

QString OAILambdaConfigType::getPostConfirmation() const {
    return m_post_confirmation;
}
void OAILambdaConfigType::setPostConfirmation(const QString &post_confirmation) {
    m_post_confirmation = post_confirmation;
    m_post_confirmation_isSet = true;
}

bool OAILambdaConfigType::is_post_confirmation_Set() const{
    return m_post_confirmation_isSet;
}

bool OAILambdaConfigType::is_post_confirmation_Valid() const{
    return m_post_confirmation_isValid;
}

QString OAILambdaConfigType::getPreAuthentication() const {
    return m_pre_authentication;
}
void OAILambdaConfigType::setPreAuthentication(const QString &pre_authentication) {
    m_pre_authentication = pre_authentication;
    m_pre_authentication_isSet = true;
}

bool OAILambdaConfigType::is_pre_authentication_Set() const{
    return m_pre_authentication_isSet;
}

bool OAILambdaConfigType::is_pre_authentication_Valid() const{
    return m_pre_authentication_isValid;
}

QString OAILambdaConfigType::getPostAuthentication() const {
    return m_post_authentication;
}
void OAILambdaConfigType::setPostAuthentication(const QString &post_authentication) {
    m_post_authentication = post_authentication;
    m_post_authentication_isSet = true;
}

bool OAILambdaConfigType::is_post_authentication_Set() const{
    return m_post_authentication_isSet;
}

bool OAILambdaConfigType::is_post_authentication_Valid() const{
    return m_post_authentication_isValid;
}

QString OAILambdaConfigType::getDefineAuthChallenge() const {
    return m_define_auth_challenge;
}
void OAILambdaConfigType::setDefineAuthChallenge(const QString &define_auth_challenge) {
    m_define_auth_challenge = define_auth_challenge;
    m_define_auth_challenge_isSet = true;
}

bool OAILambdaConfigType::is_define_auth_challenge_Set() const{
    return m_define_auth_challenge_isSet;
}

bool OAILambdaConfigType::is_define_auth_challenge_Valid() const{
    return m_define_auth_challenge_isValid;
}

QString OAILambdaConfigType::getCreateAuthChallenge() const {
    return m_create_auth_challenge;
}
void OAILambdaConfigType::setCreateAuthChallenge(const QString &create_auth_challenge) {
    m_create_auth_challenge = create_auth_challenge;
    m_create_auth_challenge_isSet = true;
}

bool OAILambdaConfigType::is_create_auth_challenge_Set() const{
    return m_create_auth_challenge_isSet;
}

bool OAILambdaConfigType::is_create_auth_challenge_Valid() const{
    return m_create_auth_challenge_isValid;
}

QString OAILambdaConfigType::getVerifyAuthChallengeResponse() const {
    return m_verify_auth_challenge_response;
}
void OAILambdaConfigType::setVerifyAuthChallengeResponse(const QString &verify_auth_challenge_response) {
    m_verify_auth_challenge_response = verify_auth_challenge_response;
    m_verify_auth_challenge_response_isSet = true;
}

bool OAILambdaConfigType::is_verify_auth_challenge_response_Set() const{
    return m_verify_auth_challenge_response_isSet;
}

bool OAILambdaConfigType::is_verify_auth_challenge_response_Valid() const{
    return m_verify_auth_challenge_response_isValid;
}

QString OAILambdaConfigType::getPreTokenGeneration() const {
    return m_pre_token_generation;
}
void OAILambdaConfigType::setPreTokenGeneration(const QString &pre_token_generation) {
    m_pre_token_generation = pre_token_generation;
    m_pre_token_generation_isSet = true;
}

bool OAILambdaConfigType::is_pre_token_generation_Set() const{
    return m_pre_token_generation_isSet;
}

bool OAILambdaConfigType::is_pre_token_generation_Valid() const{
    return m_pre_token_generation_isValid;
}

QString OAILambdaConfigType::getUserMigration() const {
    return m_user_migration;
}
void OAILambdaConfigType::setUserMigration(const QString &user_migration) {
    m_user_migration = user_migration;
    m_user_migration_isSet = true;
}

bool OAILambdaConfigType::is_user_migration_Set() const{
    return m_user_migration_isSet;
}

bool OAILambdaConfigType::is_user_migration_Valid() const{
    return m_user_migration_isValid;
}

OAILambdaConfigType_CustomSMSSender OAILambdaConfigType::getCustomSmsSender() const {
    return m_custom_sms_sender;
}
void OAILambdaConfigType::setCustomSmsSender(const OAILambdaConfigType_CustomSMSSender &custom_sms_sender) {
    m_custom_sms_sender = custom_sms_sender;
    m_custom_sms_sender_isSet = true;
}

bool OAILambdaConfigType::is_custom_sms_sender_Set() const{
    return m_custom_sms_sender_isSet;
}

bool OAILambdaConfigType::is_custom_sms_sender_Valid() const{
    return m_custom_sms_sender_isValid;
}

OAILambdaConfigType_CustomEmailSender OAILambdaConfigType::getCustomEmailSender() const {
    return m_custom_email_sender;
}
void OAILambdaConfigType::setCustomEmailSender(const OAILambdaConfigType_CustomEmailSender &custom_email_sender) {
    m_custom_email_sender = custom_email_sender;
    m_custom_email_sender_isSet = true;
}

bool OAILambdaConfigType::is_custom_email_sender_Set() const{
    return m_custom_email_sender_isSet;
}

bool OAILambdaConfigType::is_custom_email_sender_Valid() const{
    return m_custom_email_sender_isValid;
}

QString OAILambdaConfigType::getKmsKeyId() const {
    return m_kms_key_id;
}
void OAILambdaConfigType::setKmsKeyId(const QString &kms_key_id) {
    m_kms_key_id = kms_key_id;
    m_kms_key_id_isSet = true;
}

bool OAILambdaConfigType::is_kms_key_id_Set() const{
    return m_kms_key_id_isSet;
}

bool OAILambdaConfigType::is_kms_key_id_Valid() const{
    return m_kms_key_id_isValid;
}

bool OAILambdaConfigType::isSet() const {
...
bool OAILambdaConfigType::isValid() const {
