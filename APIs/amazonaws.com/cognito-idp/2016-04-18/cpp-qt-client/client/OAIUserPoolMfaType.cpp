...
OAIUserPoolMfaType::OAIUserPoolMfaType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUserPoolMfaType::OAIUserPoolMfaType() {
    this->initializeModel();
}

OAIUserPoolMfaType::~OAIUserPoolMfaType() {}

void OAIUserPoolMfaType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIUserPoolMfaType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIUserPoolMfaType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("OFF", Qt::CaseInsensitive) == 0) {
        m_value = eOAIUserPoolMfaType::OFF;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ON", Qt::CaseInsensitive) == 0) {
        m_value = eOAIUserPoolMfaType::ON;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("OPTIONAL", Qt::CaseInsensitive) == 0) {
        m_value = eOAIUserPoolMfaType::OPTIONAL;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIUserPoolMfaType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIUserPoolMfaType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIUserPoolMfaType::OFF:
            val = "OFF";
            break;
        case eOAIUserPoolMfaType::ON:
            val = "ON";
            break;
        case eOAIUserPoolMfaType::OPTIONAL:
            val = "OPTIONAL";
            break;
        default:
            break;
...
QJsonValue OAIUserPoolMfaType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIUserPoolMfaType::eOAIUserPoolMfaType OAIUserPoolMfaType::getValue() const {
    return m_value;
}

void OAIUserPoolMfaType::setValue(const OAIUserPoolMfaType::eOAIUserPoolMfaType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIUserPoolMfaType::isSet() const {
    
    return m_value_isSet;
}

bool OAIUserPoolMfaType::isValid() const {
