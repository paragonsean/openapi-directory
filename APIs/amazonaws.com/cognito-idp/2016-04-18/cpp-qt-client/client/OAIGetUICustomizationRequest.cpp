...
OAIGetUICustomizationRequest::OAIGetUICustomizationRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetUICustomizationRequest::OAIGetUICustomizationRequest() {
    this->initializeModel();
}

OAIGetUICustomizationRequest::~OAIGetUICustomizationRequest() {}

void OAIGetUICustomizationRequest::initializeModel() {
...
void OAIGetUICustomizationRequest::fromJson(QString jsonString) {
...
void OAIGetUICustomizationRequest::fromJsonObject(QJsonObject json) {
...
QString OAIGetUICustomizationRequest::asJson() const {
...
QJsonObject OAIGetUICustomizationRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetUICustomizationRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIGetUICustomizationRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIGetUICustomizationRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIGetUICustomizationRequest::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

QString OAIGetUICustomizationRequest::getClientId() const {
    return m_client_id;
}
void OAIGetUICustomizationRequest::setClientId(const QString &client_id) {
    m_client_id = client_id;
    m_client_id_isSet = true;
}

bool OAIGetUICustomizationRequest::is_client_id_Set() const{
    return m_client_id_isSet;
}

bool OAIGetUICustomizationRequest::is_client_id_Valid() const{
    return m_client_id_isValid;
}

bool OAIGetUICustomizationRequest::isSet() const {
...
bool OAIGetUICustomizationRequest::isValid() const {
