...
/*
 * OAIAdminListUserAuthEventsRequest.h
 *
 * 
 */

#ifndef OAIAdminListUserAuthEventsRequest_H
#define OAIAdminListUserAuthEventsRequest_H
...
class OAIAdminListUserAuthEventsRequest : public OAIObject {
public:
    OAIAdminListUserAuthEventsRequest();
    OAIAdminListUserAuthEventsRequest(QString json);
    ~OAIAdminListUserAuthEventsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdminListUserAuthEventsRequest)

#endif // OAIAdminListUserAuthEventsRequest_H
