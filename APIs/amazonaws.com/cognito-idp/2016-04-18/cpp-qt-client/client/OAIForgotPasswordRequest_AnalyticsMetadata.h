...
/*
 * OAIForgotPasswordRequest_AnalyticsMetadata.h
 *
 * 
 */

#ifndef OAIForgotPasswordRequest_AnalyticsMetadata_H
#define OAIForgotPasswordRequest_AnalyticsMetadata_H
...
class OAIForgotPasswordRequest_AnalyticsMetadata : public OAIObject {
public:
    OAIForgotPasswordRequest_AnalyticsMetadata();
    OAIForgotPasswordRequest_AnalyticsMetadata(QString json);
    ~OAIForgotPasswordRequest_AnalyticsMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIForgotPasswordRequest_AnalyticsMetadata)

#endif // OAIForgotPasswordRequest_AnalyticsMetadata_H
