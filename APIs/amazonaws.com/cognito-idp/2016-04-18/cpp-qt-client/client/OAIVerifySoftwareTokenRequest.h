...
/*
 * OAIVerifySoftwareTokenRequest.h
 *
 * 
 */

#ifndef OAIVerifySoftwareTokenRequest_H
#define OAIVerifySoftwareTokenRequest_H
...
class OAIVerifySoftwareTokenRequest : public OAIObject {
public:
    OAIVerifySoftwareTokenRequest();
    OAIVerifySoftwareTokenRequest(QString json);
    ~OAIVerifySoftwareTokenRequest() override;
    ...
    QString getFriendlyDeviceName() const;
    void setFriendlyDeviceName(const QString &friendly_device_name);
    bool is_friendly_device_name_Set() const;
    bool is_friendly_device_name_Valid() const;
...
private:
    ...
    QString m_friendly_device_name;
    bool m_friendly_device_name_isSet;
    bool m_friendly_device_name_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIVerifySoftwareTokenRequest)

#endif // OAIVerifySoftwareTokenRequest_H
