...
/*
 * OAIUserContextDataType.h
 *
 * Contextual data, such as the user&#39;s device fingerprint, IP address, or location, used for evaluating the risk of an unexpected event by Amazon Cognito advanced security.
 */

#ifndef OAIUserContextDataType_H
#define OAIUserContextDataType_H
...
class OAIUserContextDataType : public OAIObject {
public:
    OAIUserContextDataType();
    OAIUserContextDataType(QString json);
    ~OAIUserContextDataType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserContextDataType)

#endif // OAIUserContextDataType_H
