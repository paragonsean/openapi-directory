...
OAIIdentityProviderTypeType::OAIIdentityProviderTypeType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIdentityProviderTypeType::OAIIdentityProviderTypeType() {
    this->initializeModel();
}

OAIIdentityProviderTypeType::~OAIIdentityProviderTypeType() {}

void OAIIdentityProviderTypeType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIIdentityProviderTypeType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIIdentityProviderTypeType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("SAML", Qt::CaseInsensitive) == 0) {
        m_value = eOAIIdentityProviderTypeType::SAML;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Facebook", Qt::CaseInsensitive) == 0) {
        m_value = eOAIIdentityProviderTypeType::FACEBOOK;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Google", Qt::CaseInsensitive) == 0) {
        m_value = eOAIIdentityProviderTypeType::GOOGLE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("LoginWithAmazon", Qt::CaseInsensitive) == 0) {
        m_value = eOAIIdentityProviderTypeType::LOGINWITHAMAZON;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("SignInWithApple", Qt::CaseInsensitive) == 0) {
        m_value = eOAIIdentityProviderTypeType::SIGNINWITHAPPLE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("OIDC", Qt::CaseInsensitive) == 0) {
        m_value = eOAIIdentityProviderTypeType::OIDC;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIIdentityProviderTypeType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIIdentityProviderTypeType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIIdentityProviderTypeType::SAML:
            val = "SAML";
            break;
        case eOAIIdentityProviderTypeType::FACEBOOK:
            val = "Facebook";
            break;
        case eOAIIdentityProviderTypeType::GOOGLE:
            val = "Google";
            break;
        case eOAIIdentityProviderTypeType::LOGINWITHAMAZON:
            val = "LoginWithAmazon";
            break;
        case eOAIIdentityProviderTypeType::SIGNINWITHAPPLE:
            val = "SignInWithApple";
            break;
        case eOAIIdentityProviderTypeType::OIDC:
            val = "OIDC";
            break;
        default:
            break;
...
QJsonValue OAIIdentityProviderTypeType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIIdentityProviderTypeType::eOAIIdentityProviderTypeType OAIIdentityProviderTypeType::getValue() const {
    return m_value;
}

void OAIIdentityProviderTypeType::setValue(const OAIIdentityProviderTypeType::eOAIIdentityProviderTypeType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIIdentityProviderTypeType::isSet() const {
    
    return m_value_isSet;
}

bool OAIIdentityProviderTypeType::isValid() const {
