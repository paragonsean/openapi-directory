...
#ifndef OAIGetUserRequest_H
#define OAIGetUserRequest_H
...
class OAIGetUserRequest : public OAIObject {
public:
    OAIGetUserRequest();
    OAIGetUserRequest(QString json);
    ~OAIGetUserRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetUserRequest)

#endif // OAIGetUserRequest_H
