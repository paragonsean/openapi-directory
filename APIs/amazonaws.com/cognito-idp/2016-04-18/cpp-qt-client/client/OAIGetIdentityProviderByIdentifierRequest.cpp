...
OAIGetIdentityProviderByIdentifierRequest::OAIGetIdentityProviderByIdentifierRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetIdentityProviderByIdentifierRequest::OAIGetIdentityProviderByIdentifierRequest() {
    this->initializeModel();
}

OAIGetIdentityProviderByIdentifierRequest::~OAIGetIdentityProviderByIdentifierRequest() {}

void OAIGetIdentityProviderByIdentifierRequest::initializeModel() {

    m_user_pool_id_isSet = false;
    m_user_pool_id_isValid = false;

    m_idp_identifier_isSet = false;
    m_idp_identifier_isValid = false;
}

void OAIGetIdentityProviderByIdentifierRequest::fromJson(QString jsonString) {
...
void OAIGetIdentityProviderByIdentifierRequest::fromJsonObject(QJsonObject json) {
    ...
    m_idp_identifier_isValid = ::OpenAPI::fromJsonValue(m_idp_identifier, json[QString("IdpIdentifier")]);
    m_idp_identifier_isSet = !json[QString("IdpIdentifier")].isNull() && m_idp_identifier_isValid;
}

QString OAIGetIdentityProviderByIdentifierRequest::asJson() const {
...
QJsonObject OAIGetIdentityProviderByIdentifierRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_user_pool_id_isSet) {
        obj.insert(QString("UserPoolId"), ::OpenAPI::toJsonValue(m_user_pool_id));
    }
    if (m_idp_identifier_isSet) {
        obj.insert(QString("IdpIdentifier"), ::OpenAPI::toJsonValue(m_idp_identifier));
    }
    return obj;
}

QString OAIGetIdentityProviderByIdentifierRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIGetIdentityProviderByIdentifierRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIGetIdentityProviderByIdentifierRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIGetIdentityProviderByIdentifierRequest::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

QString OAIGetIdentityProviderByIdentifierRequest::getIdpIdentifier() const {
    return m_idp_identifier;
}
void OAIGetIdentityProviderByIdentifierRequest::setIdpIdentifier(const QString &idp_identifier) {
    m_idp_identifier = idp_identifier;
    m_idp_identifier_isSet = true;
}

bool OAIGetIdentityProviderByIdentifierRequest::is_idp_identifier_Set() const{
    return m_idp_identifier_isSet;
}

bool OAIGetIdentityProviderByIdentifierRequest::is_idp_identifier_Valid() const{
    return m_idp_identifier_isValid;
}

bool OAIGetIdentityProviderByIdentifierRequest::isSet() const {
...
bool OAIGetIdentityProviderByIdentifierRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_user_pool_id_isValid && m_idp_identifier_isValid && true;
}
