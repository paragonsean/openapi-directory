...
/*
 * OAIRespondToAuthChallengeResponse_AuthenticationResult.h
 *
 * 
 */

#ifndef OAIRespondToAuthChallengeResponse_AuthenticationResult_H
#define OAIRespondToAuthChallengeResponse_AuthenticationResult_H
...
class OAIRespondToAuthChallengeResponse_AuthenticationResult : public OAIObject {
public:
    OAIRespondToAuthChallengeResponse_AuthenticationResult();
    OAIRespondToAuthChallengeResponse_AuthenticationResult(QString json);
    ~OAIRespondToAuthChallengeResponse_AuthenticationResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRespondToAuthChallengeResponse_AuthenticationResult)

#endif // OAIRespondToAuthChallengeResponse_AuthenticationResult_H
