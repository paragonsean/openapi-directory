...
/*
 * OAIListUserImportJobsResponse.h
 *
 * Represents the response from the server to the request to list the user import jobs.
 */

#ifndef OAIListUserImportJobsResponse_H
#define OAIListUserImportJobsResponse_H
...
class OAIListUserImportJobsResponse : public OAIObject {
public:
    OAIListUserImportJobsResponse();
    OAIListUserImportJobsResponse(QString json);
    ~OAIListUserImportJobsResponse() override;
    ...
    QList getUserImportJobs() const;
    void setUserImportJobs(const QList &user_import_jobs);
    bool is_user_import_jobs_Set() const;
    bool is_user_import_jobs_Valid() const;
...
private:
    ...
    QList m_user_import_jobs;
    bool m_user_import_jobs_isSet;
    bool m_user_import_jobs_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListUserImportJobsResponse)

#endif // OAIListUserImportJobsResponse_H
