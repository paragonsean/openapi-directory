...
/*
 * OAICreateUserPoolRequest_UserAttributeUpdateSettings.h
 *
 * 
 */

#ifndef OAICreateUserPoolRequest_UserAttributeUpdateSettings_H
#define OAICreateUserPoolRequest_UserAttributeUpdateSettings_H
...
class OAICreateUserPoolRequest_UserAttributeUpdateSettings : public OAIObject {
public:
    OAICreateUserPoolRequest_UserAttributeUpdateSettings();
    OAICreateUserPoolRequest_UserAttributeUpdateSettings(QString json);
    ~OAICreateUserPoolRequest_UserAttributeUpdateSettings() override;
    ...
    QList getAttributesRequireVerificationBeforeUpdate() const;
    void setAttributesRequireVerificationBeforeUpdate(const QList &attributes_require_verification_before_update);
    bool is_attributes_require_verification_before_update_Set() const;
    bool is_attributes_require_verification_before_update_Valid() const;
...
private:
    ...
    QList m_attributes_require_verification_before_update;
    bool m_attributes_require_verification_before_update_isSet;
    bool m_attributes_require_verification_before_update_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICreateUserPoolRequest_UserAttributeUpdateSettings)

#endif // OAICreateUserPoolRequest_UserAttributeUpdateSettings_H
