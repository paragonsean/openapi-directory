...
/*
 * OAIUserPoolClientDescription.h
 *
 * The description of the user pool client.
 */

#ifndef OAIUserPoolClientDescription_H
#define OAIUserPoolClientDescription_H
...
class OAIUserPoolClientDescription : public OAIObject {
public:
    OAIUserPoolClientDescription();
    OAIUserPoolClientDescription(QString json);
    ~OAIUserPoolClientDescription() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserPoolClientDescription)

#endif // OAIUserPoolClientDescription_H
