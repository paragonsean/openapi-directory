...
OAIStartUserImportJobRequest::OAIStartUserImportJobRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartUserImportJobRequest::OAIStartUserImportJobRequest() {
    this->initializeModel();
}

OAIStartUserImportJobRequest::~OAIStartUserImportJobRequest() {}

void OAIStartUserImportJobRequest::initializeModel() {
...
void OAIStartUserImportJobRequest::fromJson(QString jsonString) {
...
void OAIStartUserImportJobRequest::fromJsonObject(QJsonObject json) {
...
QString OAIStartUserImportJobRequest::asJson() const {
...
QJsonObject OAIStartUserImportJobRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIStartUserImportJobRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIStartUserImportJobRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIStartUserImportJobRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIStartUserImportJobRequest::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

QString OAIStartUserImportJobRequest::getJobId() const {
    return m_job_id;
}
void OAIStartUserImportJobRequest::setJobId(const QString &job_id) {
    m_job_id = job_id;
    m_job_id_isSet = true;
}

bool OAIStartUserImportJobRequest::is_job_id_Set() const{
    return m_job_id_isSet;
}

bool OAIStartUserImportJobRequest::is_job_id_Valid() const{
    return m_job_id_isValid;
}

bool OAIStartUserImportJobRequest::isSet() const {
...
bool OAIStartUserImportJobRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_user_pool_id_isValid && m_job_id_isValid && true;
}
