...
/*
 * OAIUserPoolPolicyType.h
 *
 * The policy associated with a user pool.
 */

#ifndef OAIUserPoolPolicyType_H
#define OAIUserPoolPolicyType_H
...
class OAIUserPoolPolicyType : public OAIObject {
public:
    OAIUserPoolPolicyType();
    OAIUserPoolPolicyType(QString json);
    ~OAIUserPoolPolicyType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserPoolPolicyType)

#endif // OAIUserPoolPolicyType_H
