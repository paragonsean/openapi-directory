...
/*
 * OAIAccountTakeoverActionsType_HighAction.h
 *
 * 
 */

#ifndef OAIAccountTakeoverActionsType_HighAction_H
#define OAIAccountTakeoverActionsType_HighAction_H
...
class OAIAccountTakeoverActionsType_HighAction : public OAIObject {
public:
    OAIAccountTakeoverActionsType_HighAction();
    OAIAccountTakeoverActionsType_HighAction(QString json);
    ~OAIAccountTakeoverActionsType_HighAction() override;
    ...
    OAIAccountTakeoverEventActionType getEventAction() const;
    void setEventAction(const OAIAccountTakeoverEventActionType &event_action);
...
private:
    ...
    OAIAccountTakeoverEventActionType m_event_action;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccountTakeoverActionsType_HighAction)

#endif // OAIAccountTakeoverActionsType_HighAction_H
