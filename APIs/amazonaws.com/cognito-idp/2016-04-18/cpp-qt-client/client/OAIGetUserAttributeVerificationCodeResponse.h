...
/*
 * OAIGetUserAttributeVerificationCodeResponse.h
 *
 * The verification code response returned by the server response to get the user attribute verification code.
 */

#ifndef OAIGetUserAttributeVerificationCodeResponse_H
#define OAIGetUserAttributeVerificationCodeResponse_H
...
namespace OpenAPI {
class OAIGetUserAttributeVerificationCodeResponse_CodeDeliveryDetails;

class OAIGetUserAttributeVerificationCodeResponse : public OAIObject {
public:
    OAIGetUserAttributeVerificationCodeResponse();
    OAIGetUserAttributeVerificationCodeResponse(QString json);
    ~OAIGetUserAttributeVerificationCodeResponse() override;
    ...
    OAIGetUserAttributeVerificationCodeResponse_CodeDeliveryDetails getCodeDeliveryDetails() const;
    void setCodeDeliveryDetails(const OAIGetUserAttributeVerificationCodeResponse_CodeDeliveryDetails &code_delivery_details);
    bool is_code_delivery_details_Set() const;
    bool is_code_delivery_details_Valid() const;
...
private:
    ...
    OAIGetUserAttributeVerificationCodeResponse_CodeDeliveryDetails m_code_delivery_details;
    bool m_code_delivery_details_isSet;
    bool m_code_delivery_details_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGetUserAttributeVerificationCodeResponse)

#endif // OAIGetUserAttributeVerificationCodeResponse_H
