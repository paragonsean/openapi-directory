...
#include "OAINumberAttributeConstraintsType.h"
...
OAINumberAttributeConstraintsType::OAINumberAttributeConstraintsType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINumberAttributeConstraintsType::OAINumberAttributeConstraintsType() {
    this->initializeModel();
}

OAINumberAttributeConstraintsType::~OAINumberAttributeConstraintsType() {}

void OAINumberAttributeConstraintsType::initializeModel() {
...
void OAINumberAttributeConstraintsType::fromJson(QString jsonString) {
...
void OAINumberAttributeConstraintsType::fromJsonObject(QJsonObject json) {
...
QString OAINumberAttributeConstraintsType::asJson() const {
...
QJsonObject OAINumberAttributeConstraintsType::asJsonObject() const {
    QJsonObject obj;
...
QString OAINumberAttributeConstraintsType::getMinValue() const {
    return m_min_value;
}
void OAINumberAttributeConstraintsType::setMinValue(const QString &min_value) {
    m_min_value = min_value;
    m_min_value_isSet = true;
}

bool OAINumberAttributeConstraintsType::is_min_value_Set() const{
    return m_min_value_isSet;
}

bool OAINumberAttributeConstraintsType::is_min_value_Valid() const{
    return m_min_value_isValid;
}

QString OAINumberAttributeConstraintsType::getMaxValue() const {
    return m_max_value;
}
void OAINumberAttributeConstraintsType::setMaxValue(const QString &max_value) {
    m_max_value = max_value;
    m_max_value_isSet = true;
}

bool OAINumberAttributeConstraintsType::is_max_value_Set() const{
    return m_max_value_isSet;
}

bool OAINumberAttributeConstraintsType::is_max_value_Valid() const{
    return m_max_value_isValid;
}

bool OAINumberAttributeConstraintsType::isSet() const {
...
bool OAINumberAttributeConstraintsType::isValid() const {
