...
OAIEmailSendingAccountType::OAIEmailSendingAccountType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEmailSendingAccountType::OAIEmailSendingAccountType() {
    this->initializeModel();
}

OAIEmailSendingAccountType::~OAIEmailSendingAccountType() {}

void OAIEmailSendingAccountType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIEmailSendingAccountType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIEmailSendingAccountType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("COGNITO_DEFAULT", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEmailSendingAccountType::COGNITO_DEFAULT;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("DEVELOPER", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEmailSendingAccountType::DEVELOPER;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIEmailSendingAccountType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIEmailSendingAccountType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIEmailSendingAccountType::COGNITO_DEFAULT:
            val = "COGNITO_DEFAULT";
            break;
        case eOAIEmailSendingAccountType::DEVELOPER:
            val = "DEVELOPER";
            break;
        default:
            break;
...
QJsonValue OAIEmailSendingAccountType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIEmailSendingAccountType::eOAIEmailSendingAccountType OAIEmailSendingAccountType::getValue() const {
    return m_value;
}

void OAIEmailSendingAccountType::setValue(const OAIEmailSendingAccountType::eOAIEmailSendingAccountType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIEmailSendingAccountType::isSet() const {
    
    return m_value_isSet;
}

bool OAIEmailSendingAccountType::isValid() const {
