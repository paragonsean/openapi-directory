...
/*
 * OAIAliasAttributeType.h
 *
 * 
 */

#ifndef OAIAliasAttributeType_H
#define OAIAliasAttributeType_H
...
class OAIAliasAttributeType : public OAIEnum {
public:
    OAIAliasAttributeType();
    OAIAliasAttributeType(QString json);
    ~OAIAliasAttributeType() override;
    ...
    enum class eOAIAliasAttributeType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        PHONE_NUMBER, 
        EMAIL, 
        PREFERRED_USERNAME
    };
    OAIAliasAttributeType::eOAIAliasAttributeType getValue() const;
    void setValue(const OAIAliasAttributeType::eOAIAliasAttributeType& value);
...
private:
    ...
    eOAIAliasAttributeType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAliasAttributeType)

#endif // OAIAliasAttributeType_H
