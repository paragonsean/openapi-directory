...
/*
 * OAIChallengeResponseType.h
 *
 * The challenge response type.
 */

#ifndef OAIChallengeResponseType_H
#define OAIChallengeResponseType_H
...
class OAIChallengeResponseType : public OAIObject {
public:
    OAIChallengeResponseType();
    OAIChallengeResponseType(QString json);
    ~OAIChallengeResponseType() override;
    ...
    OAIChallengeName getChallengeName() const;
    void setChallengeName(const OAIChallengeName &challenge_name);
    bool is_challenge_name_Set() const;
    bool is_challenge_name_Valid() const;

    OAIChallengeResponse getChallengeResponse() const;
    void setChallengeResponse(const OAIChallengeResponse &challenge_response);
...
private:
    ...
    OAIChallengeName m_challenge_name;
    bool m_challenge_name_isSet;
    bool m_challenge_name_isValid;

    OAIChallengeResponse m_challenge_response;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChallengeResponseType)

#endif // OAIChallengeResponseType_H
