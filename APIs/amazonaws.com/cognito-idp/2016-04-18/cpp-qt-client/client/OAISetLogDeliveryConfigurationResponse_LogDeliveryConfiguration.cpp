...
OAISetLogDeliveryConfigurationResponse_LogDeliveryConfiguration::OAISetLogDeliveryConfigurationResponse_LogDeliveryConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISetLogDeliveryConfigurationResponse_LogDeliveryConfiguration::OAISetLogDeliveryConfigurationResponse_LogDeliveryConfiguration() {
    this->initializeModel();
}

OAISetLogDeliveryConfigurationResponse_LogDeliveryConfiguration::~OAISetLogDeliveryConfigurationResponse_LogDeliveryConfiguration() {}

void OAISetLogDeliveryConfigurationResponse_LogDeliveryConfiguration::initializeModel() {
...
void OAISetLogDeliveryConfigurationResponse_LogDeliveryConfiguration::fromJson(QString jsonString) {
...
void OAISetLogDeliveryConfigurationResponse_LogDeliveryConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAISetLogDeliveryConfigurationResponse_LogDeliveryConfiguration::asJson() const {
...
QJsonObject OAISetLogDeliveryConfigurationResponse_LogDeliveryConfiguration::asJsonObject() const {
    QJsonObject obj;
...
QString OAISetLogDeliveryConfigurationResponse_LogDeliveryConfiguration::getUserPoolId() const {
    return m_user_pool_id;
}
void OAISetLogDeliveryConfigurationResponse_LogDeliveryConfiguration::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAISetLogDeliveryConfigurationResponse_LogDeliveryConfiguration::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAISetLogDeliveryConfigurationResponse_LogDeliveryConfiguration::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

QList OAISetLogDeliveryConfigurationResponse_LogDeliveryConfiguration::getLogConfigurations() const {
    return m_log_configurations;
}
void OAISetLogDeliveryConfigurationResponse_LogDeliveryConfiguration::setLogConfigurations(const QList &log_configurations) {
    m_log_configurations = log_configurations;
    m_log_configurations_isSet = true;
}

bool OAISetLogDeliveryConfigurationResponse_LogDeliveryConfiguration::is_log_configurations_Set() const{
    return m_log_configurations_isSet;
}

bool OAISetLogDeliveryConfigurationResponse_LogDeliveryConfiguration::is_log_configurations_Valid() const{
    return m_log_configurations_isValid;
}

bool OAISetLogDeliveryConfigurationResponse_LogDeliveryConfiguration::isSet() const {
...
bool OAISetLogDeliveryConfigurationResponse_LogDeliveryConfiguration::isValid() const {
