...
OAIForgotPasswordResponse::OAIForgotPasswordResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIForgotPasswordResponse::OAIForgotPasswordResponse() {
    this->initializeModel();
}

OAIForgotPasswordResponse::~OAIForgotPasswordResponse() {}

void OAIForgotPasswordResponse::initializeModel() {

    m_code_delivery_details_isSet = false;
    m_code_delivery_details_isValid = false;
}

void OAIForgotPasswordResponse::fromJson(QString jsonString) {
...
void OAIForgotPasswordResponse::fromJsonObject(QJsonObject json) {
...
QString OAIForgotPasswordResponse::asJson() const {
...
QJsonObject OAIForgotPasswordResponse::asJsonObject() const {
    QJsonObject obj;
...
OAIForgotPasswordResponse_CodeDeliveryDetails OAIForgotPasswordResponse::getCodeDeliveryDetails() const {
    return m_code_delivery_details;
}
void OAIForgotPasswordResponse::setCodeDeliveryDetails(const OAIForgotPasswordResponse_CodeDeliveryDetails &code_delivery_details) {
    m_code_delivery_details = code_delivery_details;
    m_code_delivery_details_isSet = true;
}

bool OAIForgotPasswordResponse::is_code_delivery_details_Set() const{
    return m_code_delivery_details_isSet;
}

bool OAIForgotPasswordResponse::is_code_delivery_details_Valid() const{
    return m_code_delivery_details_isValid;
}

bool OAIForgotPasswordResponse::isSet() const {
...
bool OAIForgotPasswordResponse::isValid() const {
