...
#include "OAILogConfigurationType_CloudWatchLogsConfiguration.h"
...
OAILogConfigurationType_CloudWatchLogsConfiguration::OAILogConfigurationType_CloudWatchLogsConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILogConfigurationType_CloudWatchLogsConfiguration::OAILogConfigurationType_CloudWatchLogsConfiguration() {
    this->initializeModel();
}

OAILogConfigurationType_CloudWatchLogsConfiguration::~OAILogConfigurationType_CloudWatchLogsConfiguration() {}

void OAILogConfigurationType_CloudWatchLogsConfiguration::initializeModel() {

    m_log_group_arn_isSet = false;
    m_log_group_arn_isValid = false;
}

void OAILogConfigurationType_CloudWatchLogsConfiguration::fromJson(QString jsonString) {
...
void OAILogConfigurationType_CloudWatchLogsConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAILogConfigurationType_CloudWatchLogsConfiguration::asJson() const {
...
QJsonObject OAILogConfigurationType_CloudWatchLogsConfiguration::asJsonObject() const {
    QJsonObject obj;
...
QString OAILogConfigurationType_CloudWatchLogsConfiguration::getLogGroupArn() const {
    return m_log_group_arn;
}
void OAILogConfigurationType_CloudWatchLogsConfiguration::setLogGroupArn(const QString &log_group_arn) {
    m_log_group_arn = log_group_arn;
    m_log_group_arn_isSet = true;
}

bool OAILogConfigurationType_CloudWatchLogsConfiguration::is_log_group_arn_Set() const{
    return m_log_group_arn_isSet;
}

bool OAILogConfigurationType_CloudWatchLogsConfiguration::is_log_group_arn_Valid() const{
    return m_log_group_arn_isValid;
}

bool OAILogConfigurationType_CloudWatchLogsConfiguration::isSet() const {
...
bool OAILogConfigurationType_CloudWatchLogsConfiguration::isValid() const {
