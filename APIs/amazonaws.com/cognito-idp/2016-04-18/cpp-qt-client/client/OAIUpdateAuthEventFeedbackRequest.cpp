...
OAIUpdateAuthEventFeedbackRequest::OAIUpdateAuthEventFeedbackRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateAuthEventFeedbackRequest::OAIUpdateAuthEventFeedbackRequest() {
    this->initializeModel();
}

OAIUpdateAuthEventFeedbackRequest::~OAIUpdateAuthEventFeedbackRequest() {}

void OAIUpdateAuthEventFeedbackRequest::initializeModel() {
...
void OAIUpdateAuthEventFeedbackRequest::fromJson(QString jsonString) {
...
void OAIUpdateAuthEventFeedbackRequest::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateAuthEventFeedbackRequest::asJson() const {
...
QJsonObject OAIUpdateAuthEventFeedbackRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateAuthEventFeedbackRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIUpdateAuthEventFeedbackRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIUpdateAuthEventFeedbackRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIUpdateAuthEventFeedbackRequest::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

QString OAIUpdateAuthEventFeedbackRequest::getUsername() const {
    return m_username;
}
void OAIUpdateAuthEventFeedbackRequest::setUsername(const QString &username) {
    m_username = username;
    m_username_isSet = true;
}

bool OAIUpdateAuthEventFeedbackRequest::is_username_Set() const{
    return m_username_isSet;
}

bool OAIUpdateAuthEventFeedbackRequest::is_username_Valid() const{
    return m_username_isValid;
}

QString OAIUpdateAuthEventFeedbackRequest::getEventId() const {
    return m_event_id;
}
void OAIUpdateAuthEventFeedbackRequest::setEventId(const QString &event_id) {
    m_event_id = event_id;
    m_event_id_isSet = true;
}

bool OAIUpdateAuthEventFeedbackRequest::is_event_id_Set() const{
    return m_event_id_isSet;
}

bool OAIUpdateAuthEventFeedbackRequest::is_event_id_Valid() const{
    return m_event_id_isValid;
}

QString OAIUpdateAuthEventFeedbackRequest::getFeedbackToken() const {
    return m_feedback_token;
}
void OAIUpdateAuthEventFeedbackRequest::setFeedbackToken(const QString &feedback_token) {
    m_feedback_token = feedback_token;
    m_feedback_token_isSet = true;
}

bool OAIUpdateAuthEventFeedbackRequest::is_feedback_token_Set() const{
    return m_feedback_token_isSet;
}

bool OAIUpdateAuthEventFeedbackRequest::is_feedback_token_Valid() const{
    return m_feedback_token_isValid;
}

OAIFeedbackValueType OAIUpdateAuthEventFeedbackRequest::getFeedbackValue() const {
    return m_feedback_value;
}
void OAIUpdateAuthEventFeedbackRequest::setFeedbackValue(const OAIFeedbackValueType &feedback_value) {
    m_feedback_value = feedback_value;
    m_feedback_value_isSet = true;
}

bool OAIUpdateAuthEventFeedbackRequest::is_feedback_value_Set() const{
    return m_feedback_value_isSet;
}

bool OAIUpdateAuthEventFeedbackRequest::is_feedback_value_Valid() const{
    return m_feedback_value_isValid;
}

bool OAIUpdateAuthEventFeedbackRequest::isSet() const {
...
bool OAIUpdateAuthEventFeedbackRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_user_pool_id_isValid && m_username_isValid && m_event_id_isValid && m_feedback_token_isValid && m_feedback_value_isValid && true;
}
