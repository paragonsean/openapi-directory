...
/*
 * OAISetUICustomizationRequest.h
 *
 * 
 */

#ifndef OAISetUICustomizationRequest_H
#define OAISetUICustomizationRequest_H
...
class OAISetUICustomizationRequest : public OAIObject {
public:
    OAISetUICustomizationRequest();
    OAISetUICustomizationRequest(QString json);
    ~OAISetUICustomizationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISetUICustomizationRequest)

#endif // OAISetUICustomizationRequest_H
