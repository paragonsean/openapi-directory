...
OAIGetLogDeliveryConfigurationRequest::OAIGetLogDeliveryConfigurationRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetLogDeliveryConfigurationRequest::OAIGetLogDeliveryConfigurationRequest() {
    this->initializeModel();
}

OAIGetLogDeliveryConfigurationRequest::~OAIGetLogDeliveryConfigurationRequest() {}

void OAIGetLogDeliveryConfigurationRequest::initializeModel() {

    m_user_pool_id_isSet = false;
    m_user_pool_id_isValid = false;
}

void OAIGetLogDeliveryConfigurationRequest::fromJson(QString jsonString) {
...
void OAIGetLogDeliveryConfigurationRequest::fromJsonObject(QJsonObject json) {
...
QString OAIGetLogDeliveryConfigurationRequest::asJson() const {
...
QJsonObject OAIGetLogDeliveryConfigurationRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetLogDeliveryConfigurationRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIGetLogDeliveryConfigurationRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIGetLogDeliveryConfigurationRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIGetLogDeliveryConfigurationRequest::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

bool OAIGetLogDeliveryConfigurationRequest::isSet() const {
...
bool OAIGetLogDeliveryConfigurationRequest::isValid() const {
