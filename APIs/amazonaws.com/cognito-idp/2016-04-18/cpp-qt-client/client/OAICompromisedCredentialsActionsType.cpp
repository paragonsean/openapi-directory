...
#include "OAICompromisedCredentialsActionsType.h"
...
OAICompromisedCredentialsActionsType::OAICompromisedCredentialsActionsType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICompromisedCredentialsActionsType::OAICompromisedCredentialsActionsType() {
    this->initializeModel();
}

OAICompromisedCredentialsActionsType::~OAICompromisedCredentialsActionsType() {}

void OAICompromisedCredentialsActionsType::initializeModel() {

    m_event_action_isSet = false;
    m_event_action_isValid = false;
}

void OAICompromisedCredentialsActionsType::fromJson(QString jsonString) {
...
void OAICompromisedCredentialsActionsType::fromJsonObject(QJsonObject json) {
...
QString OAICompromisedCredentialsActionsType::asJson() const {
...
QJsonObject OAICompromisedCredentialsActionsType::asJsonObject() const {
    QJsonObject obj;
...
OAICompromisedCredentialsEventActionType OAICompromisedCredentialsActionsType::getEventAction() const {
    return m_event_action;
}
void OAICompromisedCredentialsActionsType::setEventAction(const OAICompromisedCredentialsEventActionType &event_action) {
    m_event_action = event_action;
    m_event_action_isSet = true;
}

bool OAICompromisedCredentialsActionsType::is_event_action_Set() const{
    return m_event_action_isSet;
}

bool OAICompromisedCredentialsActionsType::is_event_action_Valid() const{
    return m_event_action_isValid;
}

bool OAICompromisedCredentialsActionsType::isSet() const {
...
bool OAICompromisedCredentialsActionsType::isValid() const {
