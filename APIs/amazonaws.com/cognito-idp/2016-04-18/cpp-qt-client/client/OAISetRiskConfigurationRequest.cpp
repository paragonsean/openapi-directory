...
OAISetRiskConfigurationRequest::OAISetRiskConfigurationRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISetRiskConfigurationRequest::OAISetRiskConfigurationRequest() {
    this->initializeModel();
}

OAISetRiskConfigurationRequest::~OAISetRiskConfigurationRequest() {}

void OAISetRiskConfigurationRequest::initializeModel() {
...
void OAISetRiskConfigurationRequest::fromJson(QString jsonString) {
...
void OAISetRiskConfigurationRequest::fromJsonObject(QJsonObject json) {
...
QString OAISetRiskConfigurationRequest::asJson() const {
...
QJsonObject OAISetRiskConfigurationRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAISetRiskConfigurationRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAISetRiskConfigurationRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAISetRiskConfigurationRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAISetRiskConfigurationRequest::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

QString OAISetRiskConfigurationRequest::getClientId() const {
    return m_client_id;
}
void OAISetRiskConfigurationRequest::setClientId(const QString &client_id) {
    m_client_id = client_id;
    m_client_id_isSet = true;
}

bool OAISetRiskConfigurationRequest::is_client_id_Set() const{
    return m_client_id_isSet;
}

bool OAISetRiskConfigurationRequest::is_client_id_Valid() const{
    return m_client_id_isValid;
}

OAISetRiskConfigurationRequest_CompromisedCredentialsRiskConfiguration OAISetRiskConfigurationRequest::getCompromisedCredentialsRiskConfiguration() const {
    return m_compromised_credentials_risk_configuration;
}
void OAISetRiskConfigurationRequest::setCompromisedCredentialsRiskConfiguration(const OAISetRiskConfigurationRequest_CompromisedCredentialsRiskConfiguration &compromised_credentials_risk_configuration) {
...
bool OAISetRiskConfigurationRequest::is_compromised_credentials_risk_configuration_Set() const{
    return m_compromised_credentials_risk_configuration_isSet;
}

bool OAISetRiskConfigurationRequest::is_compromised_credentials_risk_configuration_Valid() const{
    return m_compromised_credentials_risk_configuration_isValid;
}

OAISetRiskConfigurationRequest_AccountTakeoverRiskConfiguration OAISetRiskConfigurationRequest::getAccountTakeoverRiskConfiguration() const {
    return m_account_takeover_risk_configuration;
}
void OAISetRiskConfigurationRequest::setAccountTakeoverRiskConfiguration(const OAISetRiskConfigurationRequest_AccountTakeoverRiskConfiguration &account_takeover_risk_configuration) {
...
bool OAISetRiskConfigurationRequest::is_account_takeover_risk_configuration_Set() const{
    return m_account_takeover_risk_configuration_isSet;
}

bool OAISetRiskConfigurationRequest::is_account_takeover_risk_configuration_Valid() const{
    return m_account_takeover_risk_configuration_isValid;
}

OAISetRiskConfigurationRequest_RiskExceptionConfiguration OAISetRiskConfigurationRequest::getRiskExceptionConfiguration() const {
    return m_risk_exception_configuration;
}
void OAISetRiskConfigurationRequest::setRiskExceptionConfiguration(const OAISetRiskConfigurationRequest_RiskExceptionConfiguration &risk_exception_configuration) {
    m_risk_exception_configuration = risk_exception_configuration;
    m_risk_exception_configuration_isSet = true;
}

bool OAISetRiskConfigurationRequest::is_risk_exception_configuration_Set() const{
    return m_risk_exception_configuration_isSet;
}

bool OAISetRiskConfigurationRequest::is_risk_exception_configuration_Valid() const{
    return m_risk_exception_configuration_isValid;
}

bool OAISetRiskConfigurationRequest::isSet() const {
...
bool OAISetRiskConfigurationRequest::isValid() const {
