...
/*
 * OAIAdminInitiateAuthRequest.h
 *
 * Initiates the authorization request, as an administrator.
 */

#ifndef OAIAdminInitiateAuthRequest_H
#define OAIAdminInitiateAuthRequest_H
...
namespace OpenAPI {
class OAIAdminInitiateAuthRequest_AnalyticsMetadata;
class OAIAdminInitiateAuthRequest_ContextData;

class OAIAdminInitiateAuthRequest : public OAIObject {
public:
    OAIAdminInitiateAuthRequest();
    OAIAdminInitiateAuthRequest(QString json);
    ~OAIAdminInitiateAuthRequest() override;
    ...
    OAIAdminInitiateAuthRequest_AnalyticsMetadata getAnalyticsMetadata() const;
    void setAnalyticsMetadata(const OAIAdminInitiateAuthRequest_AnalyticsMetadata &analytics_metadata);
    bool is_analytics_metadata_Set() const;
    bool is_analytics_metadata_Valid() const;

    OAIAdminInitiateAuthRequest_ContextData getContextData() const;
    void setContextData(const OAIAdminInitiateAuthRequest_ContextData &context_data);
    bool is_context_data_Set() const;
    bool is_context_data_Valid() const;
...
private:
    ...
    OAIAdminInitiateAuthRequest_AnalyticsMetadata m_analytics_metadata;
    bool m_analytics_metadata_isSet;
    bool m_analytics_metadata_isValid;

    OAIAdminInitiateAuthRequest_ContextData m_context_data;
    bool m_context_data_isSet;
    bool m_context_data_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIAdminInitiateAuthRequest)

#endif // OAIAdminInitiateAuthRequest_H
