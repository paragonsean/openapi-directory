...
OAIRiskConfigurationType_CompromisedCredentialsRiskConfiguration::OAIRiskConfigurationType_CompromisedCredentialsRiskConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRiskConfigurationType_CompromisedCredentialsRiskConfiguration::OAIRiskConfigurationType_CompromisedCredentialsRiskConfiguration() {
    this->initializeModel();
}

OAIRiskConfigurationType_CompromisedCredentialsRiskConfiguration::~OAIRiskConfigurationType_CompromisedCredentialsRiskConfiguration() {}

void OAIRiskConfigurationType_CompromisedCredentialsRiskConfiguration::initializeModel() {
...
void OAIRiskConfigurationType_CompromisedCredentialsRiskConfiguration::fromJson(QString jsonString) {
...
void OAIRiskConfigurationType_CompromisedCredentialsRiskConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIRiskConfigurationType_CompromisedCredentialsRiskConfiguration::asJson() const {
...
QJsonObject OAIRiskConfigurationType_CompromisedCredentialsRiskConfiguration::asJsonObject() const {
    QJsonObject obj;
...
QList OAIRiskConfigurationType_CompromisedCredentialsRiskConfiguration::getEventFilter() const {
    return m_event_filter;
}
void OAIRiskConfigurationType_CompromisedCredentialsRiskConfiguration::setEventFilter(const QList &event_filter) {
    m_event_filter = event_filter;
    m_event_filter_isSet = true;
}

bool OAIRiskConfigurationType_CompromisedCredentialsRiskConfiguration::is_event_filter_Set() const{
    return m_event_filter_isSet;
}

bool OAIRiskConfigurationType_CompromisedCredentialsRiskConfiguration::is_event_filter_Valid() const{
    return m_event_filter_isValid;
}

OAICompromisedCredentialsRiskConfigurationType_Actions OAIRiskConfigurationType_CompromisedCredentialsRiskConfiguration::getActions() const {
    return m_actions;
}
void OAIRiskConfigurationType_CompromisedCredentialsRiskConfiguration::setActions(const OAICompromisedCredentialsRiskConfigurationType_Actions &actions) {
    m_actions = actions;
    m_actions_isSet = true;
}

bool OAIRiskConfigurationType_CompromisedCredentialsRiskConfiguration::is_actions_Set() const{
    return m_actions_isSet;
}

bool OAIRiskConfigurationType_CompromisedCredentialsRiskConfiguration::is_actions_Valid() const{
    return m_actions_isValid;
}

bool OAIRiskConfigurationType_CompromisedCredentialsRiskConfiguration::isSet() const {
...
bool OAIRiskConfigurationType_CompromisedCredentialsRiskConfiguration::isValid() const {
