...
/*
 * OAISetUserPoolMfaConfigRequest.h
 *
 * 
 */

#ifndef OAISetUserPoolMfaConfigRequest_H
#define OAISetUserPoolMfaConfigRequest_H
...
class OAISetUserPoolMfaConfigRequest : public OAIObject {
public:
    OAISetUserPoolMfaConfigRequest();
    OAISetUserPoolMfaConfigRequest(QString json);
    ~OAISetUserPoolMfaConfigRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISetUserPoolMfaConfigRequest)

#endif // OAISetUserPoolMfaConfigRequest_H
