...
#include "OAIAdminDisableProviderForUserRequest_User.h"
...
OAIAdminDisableProviderForUserRequest_User::OAIAdminDisableProviderForUserRequest_User(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdminDisableProviderForUserRequest_User::OAIAdminDisableProviderForUserRequest_User() {
    this->initializeModel();
}

OAIAdminDisableProviderForUserRequest_User::~OAIAdminDisableProviderForUserRequest_User() {}

void OAIAdminDisableProviderForUserRequest_User::initializeModel() {
...
void OAIAdminDisableProviderForUserRequest_User::fromJson(QString jsonString) {
...
void OAIAdminDisableProviderForUserRequest_User::fromJsonObject(QJsonObject json) {
...
QString OAIAdminDisableProviderForUserRequest_User::asJson() const {
...
QJsonObject OAIAdminDisableProviderForUserRequest_User::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAdminDisableProviderForUserRequest_User::getProviderName() const {
    return m_provider_name;
}
void OAIAdminDisableProviderForUserRequest_User::setProviderName(const QString &provider_name) {
    m_provider_name = provider_name;
    m_provider_name_isSet = true;
}

bool OAIAdminDisableProviderForUserRequest_User::is_provider_name_Set() const{
    return m_provider_name_isSet;
}

bool OAIAdminDisableProviderForUserRequest_User::is_provider_name_Valid() const{
    return m_provider_name_isValid;
}

QString OAIAdminDisableProviderForUserRequest_User::getProviderAttributeName() const {
    return m_provider_attribute_name;
}
void OAIAdminDisableProviderForUserRequest_User::setProviderAttributeName(const QString &provider_attribute_name) {
    m_provider_attribute_name = provider_attribute_name;
    m_provider_attribute_name_isSet = true;
}

bool OAIAdminDisableProviderForUserRequest_User::is_provider_attribute_name_Set() const{
    return m_provider_attribute_name_isSet;
}

bool OAIAdminDisableProviderForUserRequest_User::is_provider_attribute_name_Valid() const{
    return m_provider_attribute_name_isValid;
}

QString OAIAdminDisableProviderForUserRequest_User::getProviderAttributeValue() const {
    return m_provider_attribute_value;
}
void OAIAdminDisableProviderForUserRequest_User::setProviderAttributeValue(const QString &provider_attribute_value) {
    m_provider_attribute_value = provider_attribute_value;
    m_provider_attribute_value_isSet = true;
}

bool OAIAdminDisableProviderForUserRequest_User::is_provider_attribute_value_Set() const{
    return m_provider_attribute_value_isSet;
}

bool OAIAdminDisableProviderForUserRequest_User::is_provider_attribute_value_Valid() const{
    return m_provider_attribute_value_isValid;
}

bool OAIAdminDisableProviderForUserRequest_User::isSet() const {
...
bool OAIAdminDisableProviderForUserRequest_User::isValid() const {
