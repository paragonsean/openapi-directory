...
OAISetUserPoolMfaConfigResponse::OAISetUserPoolMfaConfigResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISetUserPoolMfaConfigResponse::OAISetUserPoolMfaConfigResponse() {
    this->initializeModel();
}

OAISetUserPoolMfaConfigResponse::~OAISetUserPoolMfaConfigResponse() {}

void OAISetUserPoolMfaConfigResponse::initializeModel() {
...
void OAISetUserPoolMfaConfigResponse::fromJson(QString jsonString) {
...
void OAISetUserPoolMfaConfigResponse::fromJsonObject(QJsonObject json) {
...
QString OAISetUserPoolMfaConfigResponse::asJson() const {
...
QJsonObject OAISetUserPoolMfaConfigResponse::asJsonObject() const {
    QJsonObject obj;
...
OAISetUserPoolMfaConfigResponse_SmsMfaConfiguration OAISetUserPoolMfaConfigResponse::getSmsMfaConfiguration() const {
    return m_sms_mfa_configuration;
}
void OAISetUserPoolMfaConfigResponse::setSmsMfaConfiguration(const OAISetUserPoolMfaConfigResponse_SmsMfaConfiguration &sms_mfa_configuration) {
    m_sms_mfa_configuration = sms_mfa_configuration;
    m_sms_mfa_configuration_isSet = true;
}

bool OAISetUserPoolMfaConfigResponse::is_sms_mfa_configuration_Set() const{
    return m_sms_mfa_configuration_isSet;
}

bool OAISetUserPoolMfaConfigResponse::is_sms_mfa_configuration_Valid() const{
    return m_sms_mfa_configuration_isValid;
}

OAISetUserPoolMfaConfigResponse_SoftwareTokenMfaConfiguration OAISetUserPoolMfaConfigResponse::getSoftwareTokenMfaConfiguration() const {
    return m_software_token_mfa_configuration;
}
void OAISetUserPoolMfaConfigResponse::setSoftwareTokenMfaConfiguration(const OAISetUserPoolMfaConfigResponse_SoftwareTokenMfaConfiguration &software_token_mfa_configuration) {
    m_software_token_mfa_configuration = software_token_mfa_configuration;
    m_software_token_mfa_configuration_isSet = true;
}

bool OAISetUserPoolMfaConfigResponse::is_software_token_mfa_configuration_Set() const{
    return m_software_token_mfa_configuration_isSet;
}

bool OAISetUserPoolMfaConfigResponse::is_software_token_mfa_configuration_Valid() const{
    return m_software_token_mfa_configuration_isValid;
}

OAIUserPoolMfaType OAISetUserPoolMfaConfigResponse::getMfaConfiguration() const {
    return m_mfa_configuration;
}
void OAISetUserPoolMfaConfigResponse::setMfaConfiguration(const OAIUserPoolMfaType &mfa_configuration) {
    m_mfa_configuration = mfa_configuration;
    m_mfa_configuration_isSet = true;
}

bool OAISetUserPoolMfaConfigResponse::is_mfa_configuration_Set() const{
    return m_mfa_configuration_isSet;
}

bool OAISetUserPoolMfaConfigResponse::is_mfa_configuration_Valid() const{
    return m_mfa_configuration_isValid;
}

bool OAISetUserPoolMfaConfigResponse::isSet() const {
...
bool OAISetUserPoolMfaConfigResponse::isValid() const {
