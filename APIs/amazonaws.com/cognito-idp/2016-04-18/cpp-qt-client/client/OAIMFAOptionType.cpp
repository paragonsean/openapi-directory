...
OAIMFAOptionType::OAIMFAOptionType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMFAOptionType::OAIMFAOptionType() {
    this->initializeModel();
}

OAIMFAOptionType::~OAIMFAOptionType() {}

void OAIMFAOptionType::initializeModel() {
...
void OAIMFAOptionType::fromJson(QString jsonString) {
...
void OAIMFAOptionType::fromJsonObject(QJsonObject json) {
...
QString OAIMFAOptionType::asJson() const {
...
QJsonObject OAIMFAOptionType::asJsonObject() const {
    QJsonObject obj;
...
OAIDeliveryMediumType OAIMFAOptionType::getDeliveryMedium() const {
    return m_delivery_medium;
}
void OAIMFAOptionType::setDeliveryMedium(const OAIDeliveryMediumType &delivery_medium) {
    m_delivery_medium = delivery_medium;
    m_delivery_medium_isSet = true;
}

bool OAIMFAOptionType::is_delivery_medium_Set() const{
    return m_delivery_medium_isSet;
}

bool OAIMFAOptionType::is_delivery_medium_Valid() const{
    return m_delivery_medium_isValid;
}

QString OAIMFAOptionType::getAttributeName() const {
    return m_attribute_name;
}
void OAIMFAOptionType::setAttributeName(const QString &attribute_name) {
    m_attribute_name = attribute_name;
    m_attribute_name_isSet = true;
}

bool OAIMFAOptionType::is_attribute_name_Set() const{
    return m_attribute_name_isSet;
}

bool OAIMFAOptionType::is_attribute_name_Valid() const{
    return m_attribute_name_isValid;
}

bool OAIMFAOptionType::isSet() const {
...
bool OAIMFAOptionType::isValid() const {
