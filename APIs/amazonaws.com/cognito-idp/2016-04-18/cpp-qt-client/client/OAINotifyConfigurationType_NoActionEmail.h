...
/*
 * OAINotifyConfigurationType_NoActionEmail.h
 *
 * 
 */

#ifndef OAINotifyConfigurationType_NoActionEmail_H
#define OAINotifyConfigurationType_NoActionEmail_H
...
class OAINotifyConfigurationType_NoActionEmail : public OAIObject {
public:
    OAINotifyConfigurationType_NoActionEmail();
    OAINotifyConfigurationType_NoActionEmail(QString json);
    ~OAINotifyConfigurationType_NoActionEmail() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINotifyConfigurationType_NoActionEmail)

#endif // OAINotifyConfigurationType_NoActionEmail_H
