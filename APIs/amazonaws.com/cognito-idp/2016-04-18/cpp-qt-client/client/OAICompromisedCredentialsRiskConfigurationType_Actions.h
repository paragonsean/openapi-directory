...
/*
 * OAICompromisedCredentialsRiskConfigurationType_Actions.h
 *
 * 
 */

#ifndef OAICompromisedCredentialsRiskConfigurationType_Actions_H
#define OAICompromisedCredentialsRiskConfigurationType_Actions_H
...
class OAICompromisedCredentialsRiskConfigurationType_Actions : public OAIObject {
public:
    OAICompromisedCredentialsRiskConfigurationType_Actions();
    OAICompromisedCredentialsRiskConfigurationType_Actions(QString json);
    ~OAICompromisedCredentialsRiskConfigurationType_Actions() override;
    ...
    OAICompromisedCredentialsEventActionType getEventAction() const;
    void setEventAction(const OAICompromisedCredentialsEventActionType &event_action);
...
private:
    ...
    OAICompromisedCredentialsEventActionType m_event_action;
...
Q_DECLARE_METATYPE(OpenAPI::OAICompromisedCredentialsRiskConfigurationType_Actions)

#endif // OAICompromisedCredentialsRiskConfigurationType_Actions_H
