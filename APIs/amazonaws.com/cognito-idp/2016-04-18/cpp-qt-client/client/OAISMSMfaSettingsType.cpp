...
#include "OAISMSMfaSettingsType.h"
...
OAISMSMfaSettingsType::OAISMSMfaSettingsType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISMSMfaSettingsType::OAISMSMfaSettingsType() {
    this->initializeModel();
}

OAISMSMfaSettingsType::~OAISMSMfaSettingsType() {}

void OAISMSMfaSettingsType::initializeModel() {
...
void OAISMSMfaSettingsType::fromJson(QString jsonString) {
...
void OAISMSMfaSettingsType::fromJsonObject(QJsonObject json) {
...
QString OAISMSMfaSettingsType::asJson() const {
...
QJsonObject OAISMSMfaSettingsType::asJsonObject() const {
    QJsonObject obj;
    if (m_enabled_isSet) {
...
bool OAISMSMfaSettingsType::getEnabled() const {
    return m_enabled;
}
void OAISMSMfaSettingsType::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAISMSMfaSettingsType::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAISMSMfaSettingsType::is_enabled_Valid() const{
    return m_enabled_isValid;
}

bool OAISMSMfaSettingsType::getPreferredMfa() const {
    return m_preferred_mfa;
}
void OAISMSMfaSettingsType::setPreferredMfa(const bool &preferred_mfa) {
    m_preferred_mfa = preferred_mfa;
    m_preferred_mfa_isSet = true;
}

bool OAISMSMfaSettingsType::is_preferred_mfa_Set() const{
    return m_preferred_mfa_isSet;
}

bool OAISMSMfaSettingsType::is_preferred_mfa_Valid() const{
    return m_preferred_mfa_isValid;
}

bool OAISMSMfaSettingsType::isSet() const {
...
bool OAISMSMfaSettingsType::isValid() const {
