...
/*
 * OAISoftwareTokenMfaSettingsType.h
 *
 * The type used for enabling software token MFA at the user level. If an MFA type is activated for a user, the user will be prompted for MFA during all sign-in attempts, unless device tracking is turned on and the device has been trusted. If you want MFA to be applied selectively based on the assessed risk level of sign-in attempts, deactivate MFA for users and turn on Adaptive Authentication for the user pool.
 */

#ifndef OAISoftwareTokenMfaSettingsType_H
#define OAISoftwareTokenMfaSettingsType_H
...
class OAISoftwareTokenMfaSettingsType : public OAIObject {
public:
    OAISoftwareTokenMfaSettingsType();
    OAISoftwareTokenMfaSettingsType(QString json);
    ~OAISoftwareTokenMfaSettingsType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISoftwareTokenMfaSettingsType)

#endif // OAISoftwareTokenMfaSettingsType_H
