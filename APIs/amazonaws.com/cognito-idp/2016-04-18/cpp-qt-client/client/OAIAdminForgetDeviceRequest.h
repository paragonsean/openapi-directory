...
/*
 * OAIAdminForgetDeviceRequest.h
 *
 * Sends the forgot device request, as an administrator.
 */

#ifndef OAIAdminForgetDeviceRequest_H
#define OAIAdminForgetDeviceRequest_H
...
class OAIAdminForgetDeviceRequest : public OAIObject {
public:
    OAIAdminForgetDeviceRequest();
    OAIAdminForgetDeviceRequest(QString json);
    ~OAIAdminForgetDeviceRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdminForgetDeviceRequest)

#endif // OAIAdminForgetDeviceRequest_H
