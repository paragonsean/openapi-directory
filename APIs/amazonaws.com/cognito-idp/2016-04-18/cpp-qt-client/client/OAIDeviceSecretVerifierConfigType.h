...
/*
 * OAIDeviceSecretVerifierConfigType.h
 *
 * The device verifier against which it is authenticated.
 */

#ifndef OAIDeviceSecretVerifierConfigType_H
#define OAIDeviceSecretVerifierConfigType_H
...
class OAIDeviceSecretVerifierConfigType : public OAIObject {
public:
    OAIDeviceSecretVerifierConfigType();
    OAIDeviceSecretVerifierConfigType(QString json);
    ~OAIDeviceSecretVerifierConfigType() override;
    ...
    QString getPasswordVerifier() const;
    void setPasswordVerifier(const QString &password_verifier);
    bool is_password_verifier_Set() const;
    bool is_password_verifier_Valid() const;
...
private:
    ...
    QString m_password_verifier;
    bool m_password_verifier_isSet;
    bool m_password_verifier_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeviceSecretVerifierConfigType)

#endif // OAIDeviceSecretVerifierConfigType_H
