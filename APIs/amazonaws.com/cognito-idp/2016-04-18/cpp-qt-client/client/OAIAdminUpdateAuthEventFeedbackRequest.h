...
/*
 * OAIAdminUpdateAuthEventFeedbackRequest.h
 *
 * 
 */

#ifndef OAIAdminUpdateAuthEventFeedbackRequest_H
#define OAIAdminUpdateAuthEventFeedbackRequest_H
...
class OAIAdminUpdateAuthEventFeedbackRequest : public OAIObject {
public:
    OAIAdminUpdateAuthEventFeedbackRequest();
    OAIAdminUpdateAuthEventFeedbackRequest(QString json);
    ~OAIAdminUpdateAuthEventFeedbackRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdminUpdateAuthEventFeedbackRequest)

#endif // OAIAdminUpdateAuthEventFeedbackRequest_H
