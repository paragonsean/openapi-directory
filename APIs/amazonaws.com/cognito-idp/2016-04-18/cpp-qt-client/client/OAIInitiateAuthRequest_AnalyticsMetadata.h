...
/*
 * OAIInitiateAuthRequest_AnalyticsMetadata.h
 *
 * 
 */

#ifndef OAIInitiateAuthRequest_AnalyticsMetadata_H
#define OAIInitiateAuthRequest_AnalyticsMetadata_H
...
class OAIInitiateAuthRequest_AnalyticsMetadata : public OAIObject {
public:
    OAIInitiateAuthRequest_AnalyticsMetadata();
    OAIInitiateAuthRequest_AnalyticsMetadata(QString json);
    ~OAIInitiateAuthRequest_AnalyticsMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInitiateAuthRequest_AnalyticsMetadata)

#endif // OAIInitiateAuthRequest_AnalyticsMetadata_H
