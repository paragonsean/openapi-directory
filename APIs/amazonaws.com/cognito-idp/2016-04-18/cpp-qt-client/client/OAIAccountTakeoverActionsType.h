...
/*
 * OAIAccountTakeoverActionsType.h
 *
 * Account takeover actions type.
 */

#ifndef OAIAccountTakeoverActionsType_H
#define OAIAccountTakeoverActionsType_H

#include <QJsonObject>

#include "OAIAccountTakeoverActionsType_HighAction.h"
#include "OAIAccountTakeoverActionsType_LowAction.h"
#include "OAIAccountTakeoverActionsType_MediumAction.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIAccountTakeoverActionsType_LowAction;
class OAIAccountTakeoverActionsType_MediumAction;
class OAIAccountTakeoverActionsType_HighAction;

class OAIAccountTakeoverActionsType : public OAIObject {
public:
    OAIAccountTakeoverActionsType();
    OAIAccountTakeoverActionsType(QString json);
    ~OAIAccountTakeoverActionsType() override;
    ...
    OAIAccountTakeoverActionsType_LowAction getLowAction() const;
    void setLowAction(const OAIAccountTakeoverActionsType_LowAction &low_action);
    bool is_low_action_Set() const;
    bool is_low_action_Valid() const;

    OAIAccountTakeoverActionsType_MediumAction getMediumAction() const;
    void setMediumAction(const OAIAccountTakeoverActionsType_MediumAction &medium_action);
    bool is_medium_action_Set() const;
    bool is_medium_action_Valid() const;

    OAIAccountTakeoverActionsType_HighAction getHighAction() const;
    void setHighAction(const OAIAccountTakeoverActionsType_HighAction &high_action);
    bool is_high_action_Set() const;
    bool is_high_action_Valid() const;
...
private:
    ...
    OAIAccountTakeoverActionsType_LowAction m_low_action;
    bool m_low_action_isSet;
    bool m_low_action_isValid;

    OAIAccountTakeoverActionsType_MediumAction m_medium_action;
    bool m_medium_action_isSet;
    bool m_medium_action_isValid;

    OAIAccountTakeoverActionsType_HighAction m_high_action;
    bool m_high_action_isSet;
    bool m_high_action_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIAccountTakeoverActionsType)

#endif // OAIAccountTakeoverActionsType_H
