...
OAIDescribeUserPoolRequest::OAIDescribeUserPoolRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeUserPoolRequest::OAIDescribeUserPoolRequest() {
    this->initializeModel();
}

OAIDescribeUserPoolRequest::~OAIDescribeUserPoolRequest() {}

void OAIDescribeUserPoolRequest::initializeModel() {

    m_user_pool_id_isSet = false;
    m_user_pool_id_isValid = false;
}

void OAIDescribeUserPoolRequest::fromJson(QString jsonString) {
...
void OAIDescribeUserPoolRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeUserPoolRequest::asJson() const {
...
QJsonObject OAIDescribeUserPoolRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeUserPoolRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIDescribeUserPoolRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIDescribeUserPoolRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIDescribeUserPoolRequest::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

bool OAIDescribeUserPoolRequest::isSet() const {
...
bool OAIDescribeUserPoolRequest::isValid() const {
