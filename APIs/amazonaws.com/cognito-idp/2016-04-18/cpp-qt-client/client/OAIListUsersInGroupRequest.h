...
/*
 * OAIListUsersInGroupRequest.h
 *
 * 
 */

#ifndef OAIListUsersInGroupRequest_H
#define OAIListUsersInGroupRequest_H
...
class OAIListUsersInGroupRequest : public OAIObject {
public:
    OAIListUsersInGroupRequest();
    OAIListUsersInGroupRequest(QString json);
    ~OAIListUsersInGroupRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListUsersInGroupRequest)

#endif // OAIListUsersInGroupRequest_H
