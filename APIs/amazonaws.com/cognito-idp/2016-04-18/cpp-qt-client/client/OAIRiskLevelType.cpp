...
OAIRiskLevelType::OAIRiskLevelType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRiskLevelType::OAIRiskLevelType() {
    this->initializeModel();
}

OAIRiskLevelType::~OAIRiskLevelType() {}

void OAIRiskLevelType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIRiskLevelType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIRiskLevelType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("Low", Qt::CaseInsensitive) == 0) {
        m_value = eOAIRiskLevelType::LOW;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Medium", Qt::CaseInsensitive) == 0) {
        m_value = eOAIRiskLevelType::MEDIUM;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("High", Qt::CaseInsensitive) == 0) {
        m_value = eOAIRiskLevelType::HIGH;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIRiskLevelType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIRiskLevelType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIRiskLevelType::LOW:
            val = "Low";
            break;
        case eOAIRiskLevelType::MEDIUM:
            val = "Medium";
            break;
        case eOAIRiskLevelType::HIGH:
            val = "High";
            break;
        default:
            break;
...
QJsonValue OAIRiskLevelType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIRiskLevelType::eOAIRiskLevelType OAIRiskLevelType::getValue() const {
    return m_value;
}

void OAIRiskLevelType::setValue(const OAIRiskLevelType::eOAIRiskLevelType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIRiskLevelType::isSet() const {
    
    return m_value_isSet;
}

bool OAIRiskLevelType::isValid() const {
