...
void OAIGroupType::fromJsonObject(QJsonObject json) {
...
QJsonObject OAIGroupType::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGroupType::getGroupName() const {
    return m_group_name;
}
void OAIGroupType::setGroupName(const QString &group_name) {
    m_group_name = group_name;
    m_group_name_isSet = true;
}

bool OAIGroupType::is_group_name_Set() const{
    return m_group_name_isSet;
}

bool OAIGroupType::is_group_name_Valid() const{
    return m_group_name_isValid;
}

QString OAIGroupType::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIGroupType::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIGroupType::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIGroupType::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

QString OAIGroupType::getDescription() const {
    return m_description;
}
void OAIGroupType::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIGroupType::is_description_Set() const{
    return m_description_isSet;
}

bool OAIGroupType::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIGroupType::getRoleArn() const {
    return m_role_arn;
}
void OAIGroupType::setRoleArn(const QString &role_arn) {
    m_role_arn = role_arn;
    m_role_arn_isSet = true;
}

bool OAIGroupType::is_role_arn_Set() const{
    return m_role_arn_isSet;
}

bool OAIGroupType::is_role_arn_Valid() const{
    return m_role_arn_isValid;
}

qint32 OAIGroupType::getPrecedence() const {
    return m_precedence;
}
void OAIGroupType::setPrecedence(const qint32 &precedence) {
    m_precedence = precedence;
    m_precedence_isSet = true;
}

bool OAIGroupType::is_precedence_Set() const{
    return m_precedence_isSet;
}

bool OAIGroupType::is_precedence_Valid() const{
    return m_precedence_isValid;
}

QDateTime OAIGroupType::getLastModifiedDate() const {
    return m_last_modified_date;
}
void OAIGroupType::setLastModifiedDate(const QDateTime &last_modified_date) {
    m_last_modified_date = last_modified_date;
    m_last_modified_date_isSet = true;
}

bool OAIGroupType::is_last_modified_date_Set() const{
    return m_last_modified_date_isSet;
}

bool OAIGroupType::is_last_modified_date_Valid() const{
    return m_last_modified_date_isValid;
}

QDateTime OAIGroupType::getCreationDate() const {
    return m_creation_date;
}
void OAIGroupType::setCreationDate(const QDateTime &creation_date) {
    m_creation_date = creation_date;
    m_creation_date_isSet = true;
}

bool OAIGroupType::is_creation_date_Set() const{
    return m_creation_date_isSet;
}

bool OAIGroupType::is_creation_date_Valid() const{
