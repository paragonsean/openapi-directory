...
OAICreateUserPoolRequest_AccountRecoverySetting::OAICreateUserPoolRequest_AccountRecoverySetting(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateUserPoolRequest_AccountRecoverySetting::OAICreateUserPoolRequest_AccountRecoverySetting() {
    this->initializeModel();
}

OAICreateUserPoolRequest_AccountRecoverySetting::~OAICreateUserPoolRequest_AccountRecoverySetting() {}

void OAICreateUserPoolRequest_AccountRecoverySetting::initializeModel() {

    m_recovery_mechanisms_isSet = false;
    m_recovery_mechanisms_isValid = false;
}

void OAICreateUserPoolRequest_AccountRecoverySetting::fromJson(QString jsonString) {
...
void OAICreateUserPoolRequest_AccountRecoverySetting::fromJsonObject(QJsonObject json) {
...
QString OAICreateUserPoolRequest_AccountRecoverySetting::asJson() const {
...
QJsonObject OAICreateUserPoolRequest_AccountRecoverySetting::asJsonObject() const {
    QJsonObject obj;
...
QList OAICreateUserPoolRequest_AccountRecoverySetting::getRecoveryMechanisms() const {
    return m_recovery_mechanisms;
}
void OAICreateUserPoolRequest_AccountRecoverySetting::setRecoveryMechanisms(const QList &recovery_mechanisms) {
    m_recovery_mechanisms = recovery_mechanisms;
    m_recovery_mechanisms_isSet = true;
}

bool OAICreateUserPoolRequest_AccountRecoverySetting::is_recovery_mechanisms_Set() const{
    return m_recovery_mechanisms_isSet;
}

bool OAICreateUserPoolRequest_AccountRecoverySetting::is_recovery_mechanisms_Valid() const{
    return m_recovery_mechanisms_isValid;
}

bool OAICreateUserPoolRequest_AccountRecoverySetting::isSet() const {
...
bool OAICreateUserPoolRequest_AccountRecoverySetting::isValid() const {
