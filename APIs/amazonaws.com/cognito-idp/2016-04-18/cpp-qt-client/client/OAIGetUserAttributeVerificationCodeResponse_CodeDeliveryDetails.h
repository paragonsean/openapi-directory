...
/*
 * OAIGetUserAttributeVerificationCodeResponse_CodeDeliveryDetails.h
 *
 * 
 */

#ifndef OAIGetUserAttributeVerificationCodeResponse_CodeDeliveryDetails_H
#define OAIGetUserAttributeVerificationCodeResponse_CodeDeliveryDetails_H

#include <QJsonObject>

#include "OAIDeliveryMediumType.h"
#include <QString>
...
class OAIGetUserAttributeVerificationCodeResponse_CodeDeliveryDetails : public OAIObject {
public:
    OAIGetUserAttributeVerificationCodeResponse_CodeDeliveryDetails();
    OAIGetUserAttributeVerificationCodeResponse_CodeDeliveryDetails(QString json);
    ~OAIGetUserAttributeVerificationCodeResponse_CodeDeliveryDetails() override;
    ...
    OAIDeliveryMediumType getDeliveryMedium() const;
    void setDeliveryMedium(const OAIDeliveryMediumType &delivery_medium);
    bool is_delivery_medium_Set() const;
    bool is_delivery_medium_Valid() const;
...
private:
    ...
    OAIDeliveryMediumType m_delivery_medium;
    bool m_delivery_medium_isSet;
    bool m_delivery_medium_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetUserAttributeVerificationCodeResponse_CodeDeliveryDetails)

#endif // OAIGetUserAttributeVerificationCodeResponse_CodeDeliveryDetails_H
