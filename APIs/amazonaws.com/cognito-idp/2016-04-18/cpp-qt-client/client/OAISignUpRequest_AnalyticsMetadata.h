...
/*
 * OAISignUpRequest_AnalyticsMetadata.h
 *
 * 
 */

#ifndef OAISignUpRequest_AnalyticsMetadata_H
#define OAISignUpRequest_AnalyticsMetadata_H
...
class OAISignUpRequest_AnalyticsMetadata : public OAIObject {
public:
    OAISignUpRequest_AnalyticsMetadata();
    OAISignUpRequest_AnalyticsMetadata(QString json);
    ~OAISignUpRequest_AnalyticsMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISignUpRequest_AnalyticsMetadata)

#endif // OAISignUpRequest_AnalyticsMetadata_H
