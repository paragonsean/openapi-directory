...
#include "OAIAdminSetUserMFAPreferenceRequest_SoftwareTokenMfaSettings.h"
...
OAIAdminSetUserMFAPreferenceRequest_SoftwareTokenMfaSettings::OAIAdminSetUserMFAPreferenceRequest_SoftwareTokenMfaSettings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdminSetUserMFAPreferenceRequest_SoftwareTokenMfaSettings::OAIAdminSetUserMFAPreferenceRequest_SoftwareTokenMfaSettings() {
    this->initializeModel();
}

OAIAdminSetUserMFAPreferenceRequest_SoftwareTokenMfaSettings::~OAIAdminSetUserMFAPreferenceRequest_SoftwareTokenMfaSettings() {}

void OAIAdminSetUserMFAPreferenceRequest_SoftwareTokenMfaSettings::initializeModel() {
...
void OAIAdminSetUserMFAPreferenceRequest_SoftwareTokenMfaSettings::fromJson(QString jsonString) {
...
void OAIAdminSetUserMFAPreferenceRequest_SoftwareTokenMfaSettings::fromJsonObject(QJsonObject json) {
...
QString OAIAdminSetUserMFAPreferenceRequest_SoftwareTokenMfaSettings::asJson() const {
...
QJsonObject OAIAdminSetUserMFAPreferenceRequest_SoftwareTokenMfaSettings::asJsonObject() const {
    QJsonObject obj;
    if (m_enabled_isSet) {
...
bool OAIAdminSetUserMFAPreferenceRequest_SoftwareTokenMfaSettings::getEnabled() const {
    return m_enabled;
}
void OAIAdminSetUserMFAPreferenceRequest_SoftwareTokenMfaSettings::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAIAdminSetUserMFAPreferenceRequest_SoftwareTokenMfaSettings::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAIAdminSetUserMFAPreferenceRequest_SoftwareTokenMfaSettings::is_enabled_Valid() const{
    return m_enabled_isValid;
}

bool OAIAdminSetUserMFAPreferenceRequest_SoftwareTokenMfaSettings::getPreferredMfa() const {
    return m_preferred_mfa;
}
void OAIAdminSetUserMFAPreferenceRequest_SoftwareTokenMfaSettings::setPreferredMfa(const bool &preferred_mfa) {
    m_preferred_mfa = preferred_mfa;
    m_preferred_mfa_isSet = true;
}

bool OAIAdminSetUserMFAPreferenceRequest_SoftwareTokenMfaSettings::is_preferred_mfa_Set() const{
    return m_preferred_mfa_isSet;
}

bool OAIAdminSetUserMFAPreferenceRequest_SoftwareTokenMfaSettings::is_preferred_mfa_Valid() const{
    return m_preferred_mfa_isValid;
}

bool OAIAdminSetUserMFAPreferenceRequest_SoftwareTokenMfaSettings::isSet() const {
...
bool OAIAdminSetUserMFAPreferenceRequest_SoftwareTokenMfaSettings::isValid() const {
