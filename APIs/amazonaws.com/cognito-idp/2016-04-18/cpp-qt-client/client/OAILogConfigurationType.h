...
/*
 * OAILogConfigurationType.h
 *
 * The logging parameters of a user pool.
 */

#ifndef OAILogConfigurationType_H
#define OAILogConfigurationType_H
...
namespace OpenAPI {
class OAILogConfigurationType_CloudWatchLogsConfiguration;

class OAILogConfigurationType : public OAIObject {
public:
    OAILogConfigurationType();
    OAILogConfigurationType(QString json);
    ~OAILogConfigurationType() override;
    ...
    OAIEventSourceName getEventSource() const;
    void setEventSource(const OAIEventSourceName &event_source);
    bool is_event_source_Set() const;
    bool is_event_source_Valid() const;

    OAILogConfigurationType_CloudWatchLogsConfiguration getCloudWatchLogsConfiguration() const;
    void setCloudWatchLogsConfiguration(const OAILogConfigurationType_CloudWatchLogsConfiguration &cloud_watch_logs_configuration);
...
private:
    ...
    OAIEventSourceName m_event_source;
    bool m_event_source_isSet;
    bool m_event_source_isValid;

    OAILogConfigurationType_CloudWatchLogsConfiguration m_cloud_watch_logs_configuration;
...
Q_DECLARE_METATYPE(OpenAPI::OAILogConfigurationType)

#endif // OAILogConfigurationType_H
