...
public:
    ...
    QString getPreviousPassword() const;
    void setPreviousPassword(const QString &previous_password);
    bool is_previous_password_Set() const;
    bool is_previous_password_Valid() const;

    QString getProposedPassword() const;
    void setProposedPassword(const QString &proposed_password);
    bool is_proposed_password_Set() const;
    bool is_proposed_password_Valid() const;
...
private:
    ...
    QString m_previous_password;
    bool m_previous_password_isSet;
    bool m_previous_password_isValid;

    QString m_proposed_password;
    bool m_proposed_password_isSet;
    bool m_proposed_password_isValid;
