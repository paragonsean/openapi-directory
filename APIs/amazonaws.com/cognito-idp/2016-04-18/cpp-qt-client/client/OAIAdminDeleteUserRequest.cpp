...
OAIAdminDeleteUserRequest::OAIAdminDeleteUserRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdminDeleteUserRequest::OAIAdminDeleteUserRequest() {
    this->initializeModel();
}

OAIAdminDeleteUserRequest::~OAIAdminDeleteUserRequest() {}

void OAIAdminDeleteUserRequest::initializeModel() {
...
void OAIAdminDeleteUserRequest::fromJson(QString jsonString) {
...
void OAIAdminDeleteUserRequest::fromJsonObject(QJsonObject json) {
...
QString OAIAdminDeleteUserRequest::asJson() const {
...
QJsonObject OAIAdminDeleteUserRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAdminDeleteUserRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIAdminDeleteUserRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIAdminDeleteUserRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIAdminDeleteUserRequest::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

QString OAIAdminDeleteUserRequest::getUsername() const {
    return m_username;
}
void OAIAdminDeleteUserRequest::setUsername(const QString &username) {
    m_username = username;
    m_username_isSet = true;
}

bool OAIAdminDeleteUserRequest::is_username_Set() const{
    return m_username_isSet;
}

bool OAIAdminDeleteUserRequest::is_username_Valid() const{
    return m_username_isValid;
}

bool OAIAdminDeleteUserRequest::isSet() const {
...
bool OAIAdminDeleteUserRequest::isValid() const {
