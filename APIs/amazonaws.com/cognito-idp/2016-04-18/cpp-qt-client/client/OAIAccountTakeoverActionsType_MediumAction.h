...
/*
 * OAIAccountTakeoverActionsType_MediumAction.h
 *
 * 
 */

#ifndef OAIAccountTakeoverActionsType_MediumAction_H
#define OAIAccountTakeoverActionsType_MediumAction_H
...
class OAIAccountTakeoverActionsType_MediumAction : public OAIObject {
public:
    OAIAccountTakeoverActionsType_MediumAction();
    OAIAccountTakeoverActionsType_MediumAction(QString json);
    ~OAIAccountTakeoverActionsType_MediumAction() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccountTakeoverActionsType_MediumAction)

#endif // OAIAccountTakeoverActionsType_MediumAction_H
