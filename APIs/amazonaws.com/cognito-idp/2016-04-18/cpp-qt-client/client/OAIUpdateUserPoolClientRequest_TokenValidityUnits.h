...
/*
 * OAIUpdateUserPoolClientRequest_TokenValidityUnits.h
 *
 * 
 */

#ifndef OAIUpdateUserPoolClientRequest_TokenValidityUnits_H
#define OAIUpdateUserPoolClientRequest_TokenValidityUnits_H
...
class OAIUpdateUserPoolClientRequest_TokenValidityUnits : public OAIObject {
public:
    OAIUpdateUserPoolClientRequest_TokenValidityUnits();
    OAIUpdateUserPoolClientRequest_TokenValidityUnits(QString json);
    ~OAIUpdateUserPoolClientRequest_TokenValidityUnits() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateUserPoolClientRequest_TokenValidityUnits)

#endif // OAIUpdateUserPoolClientRequest_TokenValidityUnits_H
