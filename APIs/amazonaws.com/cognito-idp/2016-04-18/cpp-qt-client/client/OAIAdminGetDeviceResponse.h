...
/*
 * OAIAdminGetDeviceResponse.h
 *
 * Gets the device response, as an administrator.
 */

#ifndef OAIAdminGetDeviceResponse_H
#define OAIAdminGetDeviceResponse_H
...
namespace OpenAPI {
class OAIAdminGetDeviceResponse_Device;

class OAIAdminGetDeviceResponse : public OAIObject {
public:
    OAIAdminGetDeviceResponse();
    OAIAdminGetDeviceResponse(QString json);
    ~OAIAdminGetDeviceResponse() override;
    ...
    OAIAdminGetDeviceResponse_Device getDevice() const;
    void setDevice(const OAIAdminGetDeviceResponse_Device &device);
...
private:
    ...
    OAIAdminGetDeviceResponse_Device m_device;
    bool m_device_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdminGetDeviceResponse)

#endif // OAIAdminGetDeviceResponse_H
