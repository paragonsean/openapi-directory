...
QString OAIDeleteUserRequest::getAccessToken() const {
    return m_access_token;
}
void OAIDeleteUserRequest::setAccessToken(const QString &access_token) {
    m_access_token = access_token;
    m_access_token_isSet = true;
}

bool OAIDeleteUserRequest::is_access_token_Set() const{
    return m_access_token_isSet;
}

bool OAIDeleteUserRequest::is_access_token_Valid() const{
