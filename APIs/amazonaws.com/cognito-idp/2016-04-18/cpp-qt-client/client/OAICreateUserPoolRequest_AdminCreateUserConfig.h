...
/*
 * OAICreateUserPoolRequest_AdminCreateUserConfig.h
 *
 * 
 */

#ifndef OAICreateUserPoolRequest_AdminCreateUserConfig_H
#define OAICreateUserPoolRequest_AdminCreateUserConfig_H
...
namespace OpenAPI {
class OAIAdminCreateUserConfigType_InviteMessageTemplate;

class OAICreateUserPoolRequest_AdminCreateUserConfig : public OAIObject {
public:
    OAICreateUserPoolRequest_AdminCreateUserConfig();
    OAICreateUserPoolRequest_AdminCreateUserConfig(QString json);
    ~OAICreateUserPoolRequest_AdminCreateUserConfig() override;
    ...
    bool getAllowAdminCreateUserOnly() const;
    void setAllowAdminCreateUserOnly(const bool &allow_admin_create_user_only);
    bool is_allow_admin_create_user_only_Set() const;
    bool is_allow_admin_create_user_only_Valid() const;

    qint32 getUnusedAccountValidityDays() const;
    void setUnusedAccountValidityDays(const qint32 &unused_account_validity_days);
    bool is_unused_account_validity_days_Set() const;
    bool is_unused_account_validity_days_Valid() const;

    OAIAdminCreateUserConfigType_InviteMessageTemplate getInviteMessageTemplate() const;
    void setInviteMessageTemplate(const OAIAdminCreateUserConfigType_InviteMessageTemplate &invite_message_template);
    bool is_invite_message_template_Set() const;
    bool is_invite_message_template_Valid() const;
...
private:
    ...
    bool m_allow_admin_create_user_only;
    bool m_allow_admin_create_user_only_isSet;
    bool m_allow_admin_create_user_only_isValid;

    qint32 m_unused_account_validity_days;
    bool m_unused_account_validity_days_isSet;
    bool m_unused_account_validity_days_isValid;

    OAIAdminCreateUserConfigType_InviteMessageTemplate m_invite_message_template;
    bool m_invite_message_template_isSet;
    bool m_invite_message_template_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICreateUserPoolRequest_AdminCreateUserConfig)

#endif // OAICreateUserPoolRequest_AdminCreateUserConfig_H
