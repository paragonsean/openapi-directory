...
#include "OAICompromisedCredentialsRiskConfigurationType.h"
...
OAICompromisedCredentialsRiskConfigurationType::OAICompromisedCredentialsRiskConfigurationType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICompromisedCredentialsRiskConfigurationType::OAICompromisedCredentialsRiskConfigurationType() {
    this->initializeModel();
}

OAICompromisedCredentialsRiskConfigurationType::~OAICompromisedCredentialsRiskConfigurationType() {}

void OAICompromisedCredentialsRiskConfigurationType::initializeModel() {
...
void OAICompromisedCredentialsRiskConfigurationType::fromJson(QString jsonString) {
...
void OAICompromisedCredentialsRiskConfigurationType::fromJsonObject(QJsonObject json) {
...
QString OAICompromisedCredentialsRiskConfigurationType::asJson() const {
...
QJsonObject OAICompromisedCredentialsRiskConfigurationType::asJsonObject() const {
    QJsonObject obj;
...
QList OAICompromisedCredentialsRiskConfigurationType::getEventFilter() const {
    return m_event_filter;
}
void OAICompromisedCredentialsRiskConfigurationType::setEventFilter(const QList &event_filter) {
    m_event_filter = event_filter;
    m_event_filter_isSet = true;
}

bool OAICompromisedCredentialsRiskConfigurationType::is_event_filter_Set() const{
    return m_event_filter_isSet;
}

bool OAICompromisedCredentialsRiskConfigurationType::is_event_filter_Valid() const{
    return m_event_filter_isValid;
}

OAICompromisedCredentialsRiskConfigurationType_Actions OAICompromisedCredentialsRiskConfigurationType::getActions() const {
    return m_actions;
}
void OAICompromisedCredentialsRiskConfigurationType::setActions(const OAICompromisedCredentialsRiskConfigurationType_Actions &actions) {
    m_actions = actions;
    m_actions_isSet = true;
}

bool OAICompromisedCredentialsRiskConfigurationType::is_actions_Set() const{
    return m_actions_isSet;
}

bool OAICompromisedCredentialsRiskConfigurationType::is_actions_Valid() const{
    return m_actions_isValid;
}

bool OAICompromisedCredentialsRiskConfigurationType::isSet() const {
...
bool OAICompromisedCredentialsRiskConfigurationType::isValid() const {
