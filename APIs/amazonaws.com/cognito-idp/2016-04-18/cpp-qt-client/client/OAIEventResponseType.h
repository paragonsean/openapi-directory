...
/*
 * OAIEventResponseType.h
 *
 * 
 */

#ifndef OAIEventResponseType_H
#define OAIEventResponseType_H
...
class OAIEventResponseType : public OAIEnum {
public:
    OAIEventResponseType();
    OAIEventResponseType(QString json);
    ~OAIEventResponseType() override;
    ...
    enum class eOAIEventResponseType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        PASS, 
        FAIL, 
        INPROGRESS
    };
    OAIEventResponseType::eOAIEventResponseType getValue() const;
    void setValue(const OAIEventResponseType::eOAIEventResponseType& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIEventResponseType)

#endif // OAIEventResponseType_H
