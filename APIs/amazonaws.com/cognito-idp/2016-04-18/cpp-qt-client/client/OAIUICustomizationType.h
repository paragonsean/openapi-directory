...
/*
 * OAIUICustomizationType.h
 *
 * A container for the UI customization information for a user pool&#39;s built-in app UI.
 */

#ifndef OAIUICustomizationType_H
#define OAIUICustomizationType_H
...
class OAIUICustomizationType : public OAIObject {
public:
    OAIUICustomizationType();
    OAIUICustomizationType(QString json);
    ~OAIUICustomizationType() override;
    ...
    QString getCssVersion() const;
    void setCssVersion(const QString &css_version);
    bool is_css_version_Set() const;
    bool is_css_version_Valid() const;
...
private:
    ...
    QString m_css_version;
    bool m_css_version_isSet;
    bool m_css_version_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUICustomizationType)

#endif // OAIUICustomizationType_H
