...
OAIAdminListGroupsForUserResponse::OAIAdminListGroupsForUserResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdminListGroupsForUserResponse::OAIAdminListGroupsForUserResponse() {
    this->initializeModel();
}

OAIAdminListGroupsForUserResponse::~OAIAdminListGroupsForUserResponse() {}

void OAIAdminListGroupsForUserResponse::initializeModel() {
...
void OAIAdminListGroupsForUserResponse::fromJson(QString jsonString) {
...
void OAIAdminListGroupsForUserResponse::fromJsonObject(QJsonObject json) {
...
QString OAIAdminListGroupsForUserResponse::asJson() const {
...
QJsonObject OAIAdminListGroupsForUserResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_groups.isSet()) {
...
QList OAIAdminListGroupsForUserResponse::getGroups() const {
    return m_groups;
}
void OAIAdminListGroupsForUserResponse::setGroups(const QList &groups) {
    m_groups = groups;
    m_groups_isSet = true;
}

bool OAIAdminListGroupsForUserResponse::is_groups_Set() const{
    return m_groups_isSet;
}

bool OAIAdminListGroupsForUserResponse::is_groups_Valid() const{
    return m_groups_isValid;
}

QString OAIAdminListGroupsForUserResponse::getNextToken() const {
    return m_next_token;
}
void OAIAdminListGroupsForUserResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIAdminListGroupsForUserResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIAdminListGroupsForUserResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIAdminListGroupsForUserResponse::isSet() const {
...
bool OAIAdminListGroupsForUserResponse::isValid() const {
