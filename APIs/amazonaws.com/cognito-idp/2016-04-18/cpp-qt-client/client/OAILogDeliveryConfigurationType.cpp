...
#include "OAILogDeliveryConfigurationType.h"
...
OAILogDeliveryConfigurationType::OAILogDeliveryConfigurationType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILogDeliveryConfigurationType::OAILogDeliveryConfigurationType() {
    this->initializeModel();
}

OAILogDeliveryConfigurationType::~OAILogDeliveryConfigurationType() {}

void OAILogDeliveryConfigurationType::initializeModel() {
...
void OAILogDeliveryConfigurationType::fromJson(QString jsonString) {
...
void OAILogDeliveryConfigurationType::fromJsonObject(QJsonObject json) {
...
QString OAILogDeliveryConfigurationType::asJson() const {
...
QJsonObject OAILogDeliveryConfigurationType::asJsonObject() const {
    QJsonObject obj;
...
QString OAILogDeliveryConfigurationType::getUserPoolId() const {
    return m_user_pool_id;
}
void OAILogDeliveryConfigurationType::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAILogDeliveryConfigurationType::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAILogDeliveryConfigurationType::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

QList OAILogDeliveryConfigurationType::getLogConfigurations() const {
    return m_log_configurations;
}
void OAILogDeliveryConfigurationType::setLogConfigurations(const QList &log_configurations) {
    m_log_configurations = log_configurations;
    m_log_configurations_isSet = true;
}

bool OAILogDeliveryConfigurationType::is_log_configurations_Set() const{
    return m_log_configurations_isSet;
}

bool OAILogDeliveryConfigurationType::is_log_configurations_Valid() const{
    return m_log_configurations_isValid;
}

bool OAILogDeliveryConfigurationType::isSet() const {
...
bool OAILogDeliveryConfigurationType::isValid() const {
