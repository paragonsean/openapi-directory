...
/*
 * OAIRecoveryOptionType.h
 *
 * A map containing a priority as a key, and recovery method name as a value.
 */

#ifndef OAIRecoveryOptionType_H
#define OAIRecoveryOptionType_H
...
class OAIRecoveryOptionType : public OAIObject {
public:
    OAIRecoveryOptionType();
    OAIRecoveryOptionType(QString json);
    ~OAIRecoveryOptionType() override;
    ...
    OAIRecoveryOptionNameType getName() const;
    void setName(const OAIRecoveryOptionNameType &name);
...
private:
    ...
    OAIRecoveryOptionNameType m_name;
    bool m_name_isSet;
    bool m_name_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAIRecoveryOptionType)

#endif // OAIRecoveryOptionType_H
