...
OAIGetUserAttributeVerificationCodeRequest::OAIGetUserAttributeVerificationCodeRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetUserAttributeVerificationCodeRequest::OAIGetUserAttributeVerificationCodeRequest() {
    this->initializeModel();
}

OAIGetUserAttributeVerificationCodeRequest::~OAIGetUserAttributeVerificationCodeRequest() {}

void OAIGetUserAttributeVerificationCodeRequest::initializeModel() {
...
void OAIGetUserAttributeVerificationCodeRequest::fromJson(QString jsonString) {
...
void OAIGetUserAttributeVerificationCodeRequest::fromJsonObject(QJsonObject json) {
...
QString OAIGetUserAttributeVerificationCodeRequest::asJson() const {
...
QJsonObject OAIGetUserAttributeVerificationCodeRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetUserAttributeVerificationCodeRequest::getAccessToken() const {
    return m_access_token;
}
void OAIGetUserAttributeVerificationCodeRequest::setAccessToken(const QString &access_token) {
    m_access_token = access_token;
    m_access_token_isSet = true;
}

bool OAIGetUserAttributeVerificationCodeRequest::is_access_token_Set() const{
    return m_access_token_isSet;
}

bool OAIGetUserAttributeVerificationCodeRequest::is_access_token_Valid() const{
    return m_access_token_isValid;
}

QString OAIGetUserAttributeVerificationCodeRequest::getAttributeName() const {
    return m_attribute_name;
}
void OAIGetUserAttributeVerificationCodeRequest::setAttributeName(const QString &attribute_name) {
    m_attribute_name = attribute_name;
    m_attribute_name_isSet = true;
}

bool OAIGetUserAttributeVerificationCodeRequest::is_attribute_name_Set() const{
    return m_attribute_name_isSet;
}

bool OAIGetUserAttributeVerificationCodeRequest::is_attribute_name_Valid() const{
    return m_attribute_name_isValid;
}

QMap OAIGetUserAttributeVerificationCodeRequest::getClientMetadata() const {
    return m_client_metadata;
}
void OAIGetUserAttributeVerificationCodeRequest::setClientMetadata(const QMap &client_metadata) {
    m_client_metadata = client_metadata;
    m_client_metadata_isSet = true;
}

bool OAIGetUserAttributeVerificationCodeRequest::is_client_metadata_Set() const{
    return m_client_metadata_isSet;
}

bool OAIGetUserAttributeVerificationCodeRequest::is_client_metadata_Valid() const{
    return m_client_metadata_isValid;
}

bool OAIGetUserAttributeVerificationCodeRequest::isSet() const {
...
bool OAIGetUserAttributeVerificationCodeRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_access_token_isValid && m_attribute_name_isValid && true;
}
