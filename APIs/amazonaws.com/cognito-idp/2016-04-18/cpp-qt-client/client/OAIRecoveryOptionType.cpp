...
#include "OAIRecoveryOptionType.h"
...
OAIRecoveryOptionType::OAIRecoveryOptionType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRecoveryOptionType::OAIRecoveryOptionType() {
    this->initializeModel();
}

OAIRecoveryOptionType::~OAIRecoveryOptionType() {}

void OAIRecoveryOptionType::initializeModel() {
...
void OAIRecoveryOptionType::fromJson(QString jsonString) {
...
void OAIRecoveryOptionType::fromJsonObject(QJsonObject json) {
...
QString OAIRecoveryOptionType::asJson() const {
...
QJsonObject OAIRecoveryOptionType::asJsonObject() const {
    QJsonObject obj;
    if (m_priority_isSet) {
...
qint32 OAIRecoveryOptionType::getPriority() const {
    return m_priority;
}
void OAIRecoveryOptionType::setPriority(const qint32 &priority) {
    m_priority = priority;
    m_priority_isSet = true;
}

bool OAIRecoveryOptionType::is_priority_Set() const{
    return m_priority_isSet;
}

bool OAIRecoveryOptionType::is_priority_Valid() const{
    return m_priority_isValid;
}

OAIRecoveryOptionNameType OAIRecoveryOptionType::getName() const {
    return m_name;
}
void OAIRecoveryOptionType::setName(const OAIRecoveryOptionNameType &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIRecoveryOptionType::is_name_Set() const{
    return m_name_isSet;
}

bool OAIRecoveryOptionType::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIRecoveryOptionType::isSet() const {
...
bool OAIRecoveryOptionType::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_priority_isValid && m_name_isValid && true;
}
