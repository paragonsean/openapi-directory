...
OAICreateIdentityProviderResponse::OAICreateIdentityProviderResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateIdentityProviderResponse::OAICreateIdentityProviderResponse() {
    this->initializeModel();
}

OAICreateIdentityProviderResponse::~OAICreateIdentityProviderResponse() {}

void OAICreateIdentityProviderResponse::initializeModel() {

    m_identity_provider_isSet = false;
    m_identity_provider_isValid = false;
}

void OAICreateIdentityProviderResponse::fromJson(QString jsonString) {
...
void OAICreateIdentityProviderResponse::fromJsonObject(QJsonObject json) {
...
QString OAICreateIdentityProviderResponse::asJson() const {
...
QJsonObject OAICreateIdentityProviderResponse::asJsonObject() const {
    QJsonObject obj;
...
OAICreateIdentityProviderResponse_IdentityProvider OAICreateIdentityProviderResponse::getIdentityProvider() const {
    return m_identity_provider;
}
void OAICreateIdentityProviderResponse::setIdentityProvider(const OAICreateIdentityProviderResponse_IdentityProvider &identity_provider) {
    m_identity_provider = identity_provider;
    m_identity_provider_isSet = true;
}

bool OAICreateIdentityProviderResponse::is_identity_provider_Set() const{
    return m_identity_provider_isSet;
}

bool OAICreateIdentityProviderResponse::is_identity_provider_Valid() const{
    return m_identity_provider_isValid;
}

bool OAICreateIdentityProviderResponse::isSet() const {
...
bool OAICreateIdentityProviderResponse::isValid() const {
