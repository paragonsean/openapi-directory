...
OAIAccountTakeoverActionsType_HighAction::OAIAccountTakeoverActionsType_HighAction(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAccountTakeoverActionsType_HighAction::OAIAccountTakeoverActionsType_HighAction() {
    this->initializeModel();
}

OAIAccountTakeoverActionsType_HighAction::~OAIAccountTakeoverActionsType_HighAction() {}

void OAIAccountTakeoverActionsType_HighAction::initializeModel() {
...
void OAIAccountTakeoverActionsType_HighAction::fromJson(QString jsonString) {
...
void OAIAccountTakeoverActionsType_HighAction::fromJsonObject(QJsonObject json) {
...
QString OAIAccountTakeoverActionsType_HighAction::asJson() const {
...
QJsonObject OAIAccountTakeoverActionsType_HighAction::asJsonObject() const {
    QJsonObject obj;
    if (m_notify_isSet) {
...
bool OAIAccountTakeoverActionsType_HighAction::getNotify() const {
    return m_notify;
}
void OAIAccountTakeoverActionsType_HighAction::setNotify(const bool &notify) {
    m_notify = notify;
    m_notify_isSet = true;
}

bool OAIAccountTakeoverActionsType_HighAction::is_notify_Set() const{
    return m_notify_isSet;
}

bool OAIAccountTakeoverActionsType_HighAction::is_notify_Valid() const{
    return m_notify_isValid;
}

OAIAccountTakeoverEventActionType OAIAccountTakeoverActionsType_HighAction::getEventAction() const {
    return m_event_action;
}
void OAIAccountTakeoverActionsType_HighAction::setEventAction(const OAIAccountTakeoverEventActionType &event_action) {
    m_event_action = event_action;
    m_event_action_isSet = true;
}

bool OAIAccountTakeoverActionsType_HighAction::is_event_action_Set() const{
    return m_event_action_isSet;
}

bool OAIAccountTakeoverActionsType_HighAction::is_event_action_Valid() const{
    return m_event_action_isValid;
}

bool OAIAccountTakeoverActionsType_HighAction::isSet() const {
...
bool OAIAccountTakeoverActionsType_HighAction::isValid() const {
