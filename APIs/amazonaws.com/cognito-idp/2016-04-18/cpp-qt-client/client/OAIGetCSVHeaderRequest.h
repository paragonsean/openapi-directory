...
class OAIGetCSVHeaderRequest : public OAIObject {
public:
    OAIGetCSVHeaderRequest();
    OAIGetCSVHeaderRequest(QString json);
    ~OAIGetCSVHeaderRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetCSVHeaderRequest)

#endif // OAIGetCSVHeaderRequest_H
