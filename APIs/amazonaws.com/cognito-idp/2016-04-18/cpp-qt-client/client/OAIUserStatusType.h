...
#ifndef OAIUserStatusType_H
#define OAIUserStatusType_H
...
class OAIUserStatusType : public OAIEnum {
public:
    OAIUserStatusType();
    OAIUserStatusType(QString json);
    ~OAIUserStatusType() override;
    ...
    OAIUserStatusType::eOAIUserStatusType getValue() const;
    void setValue(const OAIUserStatusType::eOAIUserStatusType& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserStatusType)

#endif // OAIUserStatusType_H
