...
/*
 * OAICreateUserPoolRequest_EmailConfiguration.h
 *
 * 
 */

#ifndef OAICreateUserPoolRequest_EmailConfiguration_H
#define OAICreateUserPoolRequest_EmailConfiguration_H
...
class OAICreateUserPoolRequest_EmailConfiguration : public OAIObject {
public:
    OAICreateUserPoolRequest_EmailConfiguration();
    OAICreateUserPoolRequest_EmailConfiguration(QString json);
    ~OAICreateUserPoolRequest_EmailConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateUserPoolRequest_EmailConfiguration)

#endif // OAICreateUserPoolRequest_EmailConfiguration_H
