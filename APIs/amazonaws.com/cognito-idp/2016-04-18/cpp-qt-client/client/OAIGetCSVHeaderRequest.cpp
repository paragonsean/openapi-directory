...
OAIGetCSVHeaderRequest::OAIGetCSVHeaderRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetCSVHeaderRequest::OAIGetCSVHeaderRequest() {
    this->initializeModel();
}

OAIGetCSVHeaderRequest::~OAIGetCSVHeaderRequest() {}

void OAIGetCSVHeaderRequest::initializeModel() {

    m_user_pool_id_isSet = false;
    m_user_pool_id_isValid = false;
}

void OAIGetCSVHeaderRequest::fromJson(QString jsonString) {
...
void OAIGetCSVHeaderRequest::fromJsonObject(QJsonObject json) {
...
QString OAIGetCSVHeaderRequest::asJson() const {
...
QJsonObject OAIGetCSVHeaderRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetCSVHeaderRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIGetCSVHeaderRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIGetCSVHeaderRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIGetCSVHeaderRequest::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

bool OAIGetCSVHeaderRequest::isSet() const {
...
bool OAIGetCSVHeaderRequest::isValid() const {
