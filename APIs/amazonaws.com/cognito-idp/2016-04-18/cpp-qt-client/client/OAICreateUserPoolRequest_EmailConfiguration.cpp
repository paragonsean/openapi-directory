...
OAICreateUserPoolRequest_EmailConfiguration::OAICreateUserPoolRequest_EmailConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateUserPoolRequest_EmailConfiguration::OAICreateUserPoolRequest_EmailConfiguration() {
    this->initializeModel();
}

OAICreateUserPoolRequest_EmailConfiguration::~OAICreateUserPoolRequest_EmailConfiguration() {}

void OAICreateUserPoolRequest_EmailConfiguration::initializeModel() {
...
void OAICreateUserPoolRequest_EmailConfiguration::fromJson(QString jsonString) {
...
void OAICreateUserPoolRequest_EmailConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAICreateUserPoolRequest_EmailConfiguration::asJson() const {
...
QJsonObject OAICreateUserPoolRequest_EmailConfiguration::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateUserPoolRequest_EmailConfiguration::getSourceArn() const {
    return m_source_arn;
}
void OAICreateUserPoolRequest_EmailConfiguration::setSourceArn(const QString &source_arn) {
    m_source_arn = source_arn;
    m_source_arn_isSet = true;
}

bool OAICreateUserPoolRequest_EmailConfiguration::is_source_arn_Set() const{
    return m_source_arn_isSet;
}

bool OAICreateUserPoolRequest_EmailConfiguration::is_source_arn_Valid() const{
    return m_source_arn_isValid;
}

QString OAICreateUserPoolRequest_EmailConfiguration::getReplyToEmailAddress() const {
    return m_reply_to_email_address;
}
void OAICreateUserPoolRequest_EmailConfiguration::setReplyToEmailAddress(const QString &reply_to_email_address) {
    m_reply_to_email_address = reply_to_email_address;
    m_reply_to_email_address_isSet = true;
}

bool OAICreateUserPoolRequest_EmailConfiguration::is_reply_to_email_address_Set() const{
    return m_reply_to_email_address_isSet;
}

bool OAICreateUserPoolRequest_EmailConfiguration::is_reply_to_email_address_Valid() const{
    return m_reply_to_email_address_isValid;
}

OAIEmailSendingAccountType OAICreateUserPoolRequest_EmailConfiguration::getEmailSendingAccount() const {
    return m_email_sending_account;
}
void OAICreateUserPoolRequest_EmailConfiguration::setEmailSendingAccount(const OAIEmailSendingAccountType &email_sending_account) {
    m_email_sending_account = email_sending_account;
    m_email_sending_account_isSet = true;
}

bool OAICreateUserPoolRequest_EmailConfiguration::is_email_sending_account_Set() const{
    return m_email_sending_account_isSet;
}

bool OAICreateUserPoolRequest_EmailConfiguration::is_email_sending_account_Valid() const{
    return m_email_sending_account_isValid;
}

QString OAICreateUserPoolRequest_EmailConfiguration::getFrom() const {
    return m_from;
}
void OAICreateUserPoolRequest_EmailConfiguration::setFrom(const QString &from) {
    m_from = from;
    m_from_isSet = true;
}

bool OAICreateUserPoolRequest_EmailConfiguration::is_from_Set() const{
    return m_from_isSet;
}

bool OAICreateUserPoolRequest_EmailConfiguration::is_from_Valid() const{
    return m_from_isValid;
}

QString OAICreateUserPoolRequest_EmailConfiguration::getConfigurationSet() const {
    return m_configuration_set;
}
void OAICreateUserPoolRequest_EmailConfiguration::setConfigurationSet(const QString &configuration_set) {
    m_configuration_set = configuration_set;
    m_configuration_set_isSet = true;
}

bool OAICreateUserPoolRequest_EmailConfiguration::is_configuration_set_Set() const{
    return m_configuration_set_isSet;
}

bool OAICreateUserPoolRequest_EmailConfiguration::is_configuration_set_Valid() const{
    return m_configuration_set_isValid;
}

bool OAICreateUserPoolRequest_EmailConfiguration::isSet() const {
...
bool OAICreateUserPoolRequest_EmailConfiguration::isValid() const {
