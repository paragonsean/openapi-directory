...
/*
 * OAIDeleteUserAttributesRequest.h
 *
 * Represents the request to delete user attributes.
 */

#ifndef OAIDeleteUserAttributesRequest_H
#define OAIDeleteUserAttributesRequest_H
...
class OAIDeleteUserAttributesRequest : public OAIObject {
public:
    OAIDeleteUserAttributesRequest();
    OAIDeleteUserAttributesRequest(QString json);
    ~OAIDeleteUserAttributesRequest() override;
    ...
    QList getUserAttributeNames() const;
    void setUserAttributeNames(const QList &user_attribute_names);
    bool is_user_attribute_names_Set() const;
    bool is_user_attribute_names_Valid() const;
...
private:
    ...
    QList m_user_attribute_names;
    bool m_user_attribute_names_isSet;
    bool m_user_attribute_names_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteUserAttributesRequest)

#endif // OAIDeleteUserAttributesRequest_H
