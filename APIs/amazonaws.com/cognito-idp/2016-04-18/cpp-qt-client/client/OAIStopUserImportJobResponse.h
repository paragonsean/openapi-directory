...
/*
 * OAIStopUserImportJobResponse.h
 *
 * Represents the response from the server to the request to stop the user import job.
 */

#ifndef OAIStopUserImportJobResponse_H
#define OAIStopUserImportJobResponse_H
...
class OAIStopUserImportJobResponse : public OAIObject {
public:
    OAIStopUserImportJobResponse();
    OAIStopUserImportJobResponse(QString json);
    ~OAIStopUserImportJobResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStopUserImportJobResponse)

#endif // OAIStopUserImportJobResponse_H
