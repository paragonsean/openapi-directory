...
/*
 * OAIEventSourceName.h
 *
 * 
 */

#ifndef OAIEventSourceName_H
#define OAIEventSourceName_H
...
class OAIEventSourceName : public OAIEnum {
public:
    OAIEventSourceName();
    OAIEventSourceName(QString json);
    ~OAIEventSourceName() override;
    ...
    enum class eOAIEventSourceName {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        USERNOTIFICATION
    };
    OAIEventSourceName::eOAIEventSourceName getValue() const;
    void setValue(const OAIEventSourceName::eOAIEventSourceName& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIEventSourceName)

#endif // OAIEventSourceName_H
