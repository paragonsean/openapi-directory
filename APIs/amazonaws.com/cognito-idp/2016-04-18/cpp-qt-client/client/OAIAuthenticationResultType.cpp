...
#include "OAIAuthenticationResultType.h"
...
OAIAuthenticationResultType::OAIAuthenticationResultType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAuthenticationResultType::OAIAuthenticationResultType() {
    this->initializeModel();
}

OAIAuthenticationResultType::~OAIAuthenticationResultType() {}

void OAIAuthenticationResultType::initializeModel() {
...
void OAIAuthenticationResultType::fromJson(QString jsonString) {
...
void OAIAuthenticationResultType::fromJsonObject(QJsonObject json) {
...
QString OAIAuthenticationResultType::asJson() const {
...
QJsonObject OAIAuthenticationResultType::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAuthenticationResultType::getAccessToken() const {
    return m_access_token;
}
void OAIAuthenticationResultType::setAccessToken(const QString &access_token) {
    m_access_token = access_token;
    m_access_token_isSet = true;
}

bool OAIAuthenticationResultType::is_access_token_Set() const{
    return m_access_token_isSet;
}

bool OAIAuthenticationResultType::is_access_token_Valid() const{
    return m_access_token_isValid;
}

qint32 OAIAuthenticationResultType::getExpiresIn() const {
    return m_expires_in;
}
void OAIAuthenticationResultType::setExpiresIn(const qint32 &expires_in) {
    m_expires_in = expires_in;
    m_expires_in_isSet = true;
}

bool OAIAuthenticationResultType::is_expires_in_Set() const{
    return m_expires_in_isSet;
}

bool OAIAuthenticationResultType::is_expires_in_Valid() const{
    return m_expires_in_isValid;
}

QString OAIAuthenticationResultType::getTokenType() const {
    return m_token_type;
}
void OAIAuthenticationResultType::setTokenType(const QString &token_type) {
    m_token_type = token_type;
    m_token_type_isSet = true;
}

bool OAIAuthenticationResultType::is_token_type_Set() const{
    return m_token_type_isSet;
}

bool OAIAuthenticationResultType::is_token_type_Valid() const{
    return m_token_type_isValid;
}

QString OAIAuthenticationResultType::getRefreshToken() const {
    return m_refresh_token;
}
void OAIAuthenticationResultType::setRefreshToken(const QString &refresh_token) {
    m_refresh_token = refresh_token;
    m_refresh_token_isSet = true;
}

bool OAIAuthenticationResultType::is_refresh_token_Set() const{
    return m_refresh_token_isSet;
}

bool OAIAuthenticationResultType::is_refresh_token_Valid() const{
    return m_refresh_token_isValid;
}

QString OAIAuthenticationResultType::getIdToken() const {
    return m_id_token;
}
void OAIAuthenticationResultType::setIdToken(const QString &id_token) {
    m_id_token = id_token;
    m_id_token_isSet = true;
}

bool OAIAuthenticationResultType::is_id_token_Set() const{
    return m_id_token_isSet;
}

bool OAIAuthenticationResultType::is_id_token_Valid() const{
    return m_id_token_isValid;
}

OAIAuthenticationResultType_NewDeviceMetadata OAIAuthenticationResultType::getNewDeviceMetadata() const {
    return m_new_device_metadata;
}
void OAIAuthenticationResultType::setNewDeviceMetadata(const OAIAuthenticationResultType_NewDeviceMetadata &new_device_metadata) {
    m_new_device_metadata = new_device_metadata;
    m_new_device_metadata_isSet = true;
}

bool OAIAuthenticationResultType::is_new_device_metadata_Set() const{
    return m_new_device_metadata_isSet;
}

bool OAIAuthenticationResultType::is_new_device_metadata_Valid() const{
    return m_new_device_metadata_isValid;
}

bool OAIAuthenticationResultType::isSet() const {
...
bool OAIAuthenticationResultType::isValid() const {
