...
/*
 * OAIListUserImportJobsRequest.h
 *
 * Represents the request to list the user import jobs.
 */

#ifndef OAIListUserImportJobsRequest_H
#define OAIListUserImportJobsRequest_H
...
class OAIListUserImportJobsRequest : public OAIObject {
public:
    OAIListUserImportJobsRequest();
    OAIListUserImportJobsRequest(QString json);
    ~OAIListUserImportJobsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListUserImportJobsRequest)

#endif // OAIListUserImportJobsRequest_H
