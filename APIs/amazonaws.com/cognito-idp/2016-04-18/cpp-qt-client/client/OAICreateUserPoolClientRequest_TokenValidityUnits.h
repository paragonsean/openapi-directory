...
/*
 * OAICreateUserPoolClientRequest_TokenValidityUnits.h
 *
 * 
 */

#ifndef OAICreateUserPoolClientRequest_TokenValidityUnits_H
#define OAICreateUserPoolClientRequest_TokenValidityUnits_H

#include <QJsonObject>

#include "OAITimeUnitsType.h"
...
class OAICreateUserPoolClientRequest_TokenValidityUnits : public OAIObject {
public:
    OAICreateUserPoolClientRequest_TokenValidityUnits();
    OAICreateUserPoolClientRequest_TokenValidityUnits(QString json);
    ~OAICreateUserPoolClientRequest_TokenValidityUnits() override;
    ...
    OAITimeUnitsType getAccessToken() const;
    void setAccessToken(const OAITimeUnitsType &access_token);
    bool is_access_token_Set() const;
    bool is_access_token_Valid() const;

    OAITimeUnitsType getIdToken() const;
    void setIdToken(const OAITimeUnitsType &id_token);
    bool is_id_token_Set() const;
    bool is_id_token_Valid() const;

    OAITimeUnitsType getRefreshToken() const;
    void setRefreshToken(const OAITimeUnitsType &refresh_token);
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateUserPoolClientRequest_TokenValidityUnits)

#endif // OAICreateUserPoolClientRequest_TokenValidityUnits_H
