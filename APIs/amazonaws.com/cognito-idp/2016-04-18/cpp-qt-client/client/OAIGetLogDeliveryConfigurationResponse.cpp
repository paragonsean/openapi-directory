...
OAIGetLogDeliveryConfigurationResponse::OAIGetLogDeliveryConfigurationResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetLogDeliveryConfigurationResponse::OAIGetLogDeliveryConfigurationResponse() {
    this->initializeModel();
}

OAIGetLogDeliveryConfigurationResponse::~OAIGetLogDeliveryConfigurationResponse() {}

void OAIGetLogDeliveryConfigurationResponse::initializeModel() {

    m_log_delivery_configuration_isSet = false;
    m_log_delivery_configuration_isValid = false;
}

void OAIGetLogDeliveryConfigurationResponse::fromJson(QString jsonString) {
...
void OAIGetLogDeliveryConfigurationResponse::fromJsonObject(QJsonObject json) {

    m_log_delivery_configuration_isValid = ::OpenAPI::fromJsonValue(m_log_delivery_configuration, json[QString("LogDeliveryConfiguration")]);
    m_log_delivery_configuration_isSet = !json[QString("LogDeliveryConfiguration")].isNull() && m_log_delivery_configuration_isValid;
}

QString OAIGetLogDeliveryConfigurationResponse::asJson() const {
...
QJsonObject OAIGetLogDeliveryConfigurationResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_log_delivery_configuration.isSet()) {
        obj.insert(QString("LogDeliveryConfiguration"), ::OpenAPI::toJsonValue(m_log_delivery_configuration));
    }
    return obj;
}

OAIGetLogDeliveryConfigurationResponse_LogDeliveryConfiguration OAIGetLogDeliveryConfigurationResponse::getLogDeliveryConfiguration() const {
    return m_log_delivery_configuration;
}
void OAIGetLogDeliveryConfigurationResponse::setLogDeliveryConfiguration(const OAIGetLogDeliveryConfigurationResponse_LogDeliveryConfiguration &log_delivery_configuration) {
    m_log_delivery_configuration = log_delivery_configuration;
    m_log_delivery_configuration_isSet = true;
}

bool OAIGetLogDeliveryConfigurationResponse::is_log_delivery_configuration_Set() const{
    return m_log_delivery_configuration_isSet;
}

bool OAIGetLogDeliveryConfigurationResponse::is_log_delivery_configuration_Valid() const{
    return m_log_delivery_configuration_isValid;
}

bool OAIGetLogDeliveryConfigurationResponse::isSet() const {
...
bool OAIGetLogDeliveryConfigurationResponse::isValid() const {
