...
QString OAIHttpHeader::getHeaderName() const {
    return m_header_name;
}
void OAIHttpHeader::setHeaderName(const QString &header_name) {
    m_header_name = header_name;
    m_header_name_isSet = true;
}

bool OAIHttpHeader::is_header_name_Set() const{
    return m_header_name_isSet;
}

bool OAIHttpHeader::is_header_name_Valid() const{
    return m_header_name_isValid;
}

QString OAIHttpHeader::getHeaderValue() const {
    return m_header_value;
}
void OAIHttpHeader::setHeaderValue(const QString &header_value) {
    m_header_value = header_value;
    m_header_value_isSet = true;
}

bool OAIHttpHeader::is_header_value_Set() const{
    return m_header_value_isSet;
}

bool OAIHttpHeader::is_header_value_Valid() const{
