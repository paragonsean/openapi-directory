...
/*
 * OAIAdminDeleteUserAttributesRequest.h
 *
 * Represents the request to delete user attributes as an administrator.
 */

#ifndef OAIAdminDeleteUserAttributesRequest_H
#define OAIAdminDeleteUserAttributesRequest_H
...
class OAIAdminDeleteUserAttributesRequest : public OAIObject {
public:
    OAIAdminDeleteUserAttributesRequest();
    OAIAdminDeleteUserAttributesRequest(QString json);
    ~OAIAdminDeleteUserAttributesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdminDeleteUserAttributesRequest)

#endif // OAIAdminDeleteUserAttributesRequest_H
