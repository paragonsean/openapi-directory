...
/*
 * OAIStringAttributeConstraintsType.h
 *
 * The constraints associated with a string attribute.
 */

#ifndef OAIStringAttributeConstraintsType_H
#define OAIStringAttributeConstraintsType_H
...
class OAIStringAttributeConstraintsType : public OAIObject {
public:
    OAIStringAttributeConstraintsType();
    OAIStringAttributeConstraintsType(QString json);
    ~OAIStringAttributeConstraintsType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStringAttributeConstraintsType)

#endif // OAIStringAttributeConstraintsType_H
