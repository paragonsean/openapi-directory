...
/*
 * OAILambdaConfigType_CustomEmailSender.h
 *
 * 
 */

#ifndef OAILambdaConfigType_CustomEmailSender_H
#define OAILambdaConfigType_CustomEmailSender_H
...
class OAILambdaConfigType_CustomEmailSender : public OAIObject {
public:
    OAILambdaConfigType_CustomEmailSender();
    OAILambdaConfigType_CustomEmailSender(QString json);
    ~OAILambdaConfigType_CustomEmailSender() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILambdaConfigType_CustomEmailSender)

#endif // OAILambdaConfigType_CustomEmailSender_H
