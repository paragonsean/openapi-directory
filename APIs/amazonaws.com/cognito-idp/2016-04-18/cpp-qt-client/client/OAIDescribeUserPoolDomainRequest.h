...
/*
 * OAIDescribeUserPoolDomainRequest.h
 *
 * 
 */

#ifndef OAIDescribeUserPoolDomainRequest_H
#define OAIDescribeUserPoolDomainRequest_H
...
class OAIDescribeUserPoolDomainRequest : public OAIObject {
public:
    OAIDescribeUserPoolDomainRequest();
    OAIDescribeUserPoolDomainRequest(QString json);
    ~OAIDescribeUserPoolDomainRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeUserPoolDomainRequest)

#endif // OAIDescribeUserPoolDomainRequest_H
