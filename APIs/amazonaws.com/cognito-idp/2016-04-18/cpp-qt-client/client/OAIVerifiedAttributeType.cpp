...
#include "OAIVerifiedAttributeType.h"
...
OAIVerifiedAttributeType::OAIVerifiedAttributeType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIVerifiedAttributeType::OAIVerifiedAttributeType() {
    this->initializeModel();
}

OAIVerifiedAttributeType::~OAIVerifiedAttributeType() {}

void OAIVerifiedAttributeType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIVerifiedAttributeType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIVerifiedAttributeType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("phone_number", Qt::CaseInsensitive) == 0) {
        m_value = eOAIVerifiedAttributeType::PHONE_NUMBER;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("email", Qt::CaseInsensitive) == 0) {
        m_value = eOAIVerifiedAttributeType::EMAIL;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIVerifiedAttributeType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIVerifiedAttributeType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIVerifiedAttributeType::PHONE_NUMBER:
            val = "phone_number";
            break;
        case eOAIVerifiedAttributeType::EMAIL:
            val = "email";
            break;
        default:
            break;
...
QJsonValue OAIVerifiedAttributeType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIVerifiedAttributeType::eOAIVerifiedAttributeType OAIVerifiedAttributeType::getValue() const {
    return m_value;
}

void OAIVerifiedAttributeType::setValue(const OAIVerifiedAttributeType::eOAIVerifiedAttributeType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIVerifiedAttributeType::isSet() const {
    
    return m_value_isSet;
}

bool OAIVerifiedAttributeType::isValid() const {
