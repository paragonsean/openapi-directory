...
/*
 * OAISetLogDeliveryConfigurationRequest.h
 *
 * 
 */

#ifndef OAISetLogDeliveryConfigurationRequest_H
#define OAISetLogDeliveryConfigurationRequest_H
...
class OAISetLogDeliveryConfigurationRequest : public OAIObject {
public:
    OAISetLogDeliveryConfigurationRequest();
    OAISetLogDeliveryConfigurationRequest(QString json);
    ~OAISetLogDeliveryConfigurationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISetLogDeliveryConfigurationRequest)

#endif // OAISetLogDeliveryConfigurationRequest_H
