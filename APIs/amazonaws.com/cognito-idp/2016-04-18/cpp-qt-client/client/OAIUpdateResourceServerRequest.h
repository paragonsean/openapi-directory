...
/*
 * OAIUpdateResourceServerRequest.h
 *
 * 
 */

#ifndef OAIUpdateResourceServerRequest_H
#define OAIUpdateResourceServerRequest_H
...
class OAIUpdateResourceServerRequest : public OAIObject {
public:
    OAIUpdateResourceServerRequest();
    OAIUpdateResourceServerRequest(QString json);
    ~OAIUpdateResourceServerRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateResourceServerRequest)

#endif // OAIUpdateResourceServerRequest_H
