...
#include "OAIUserContextDataType.h"
...
OAIUserContextDataType::OAIUserContextDataType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUserContextDataType::OAIUserContextDataType() {
    this->initializeModel();
}

OAIUserContextDataType::~OAIUserContextDataType() {}

void OAIUserContextDataType::initializeModel() {
...
void OAIUserContextDataType::fromJson(QString jsonString) {
...
void OAIUserContextDataType::fromJsonObject(QJsonObject json) {
...
QString OAIUserContextDataType::asJson() const {
...
QJsonObject OAIUserContextDataType::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUserContextDataType::getIpAddress() const {
    return m_ip_address;
}
void OAIUserContextDataType::setIpAddress(const QString &ip_address) {
    m_ip_address = ip_address;
    m_ip_address_isSet = true;
}

bool OAIUserContextDataType::is_ip_address_Set() const{
    return m_ip_address_isSet;
}

bool OAIUserContextDataType::is_ip_address_Valid() const{
    return m_ip_address_isValid;
}

QString OAIUserContextDataType::getEncodedData() const {
    return m_encoded_data;
}
void OAIUserContextDataType::setEncodedData(const QString &encoded_data) {
    m_encoded_data = encoded_data;
    m_encoded_data_isSet = true;
}

bool OAIUserContextDataType::is_encoded_data_Set() const{
    return m_encoded_data_isSet;
}

bool OAIUserContextDataType::is_encoded_data_Valid() const{
    return m_encoded_data_isValid;
}

bool OAIUserContextDataType::isSet() const {
...
bool OAIUserContextDataType::isValid() const {
