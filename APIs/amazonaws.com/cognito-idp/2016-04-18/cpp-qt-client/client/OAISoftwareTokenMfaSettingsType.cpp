...
#include "OAISoftwareTokenMfaSettingsType.h"
...
OAISoftwareTokenMfaSettingsType::OAISoftwareTokenMfaSettingsType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISoftwareTokenMfaSettingsType::OAISoftwareTokenMfaSettingsType() {
    this->initializeModel();
}

OAISoftwareTokenMfaSettingsType::~OAISoftwareTokenMfaSettingsType() {}

void OAISoftwareTokenMfaSettingsType::initializeModel() {
...
void OAISoftwareTokenMfaSettingsType::fromJson(QString jsonString) {
...
void OAISoftwareTokenMfaSettingsType::fromJsonObject(QJsonObject json) {
...
QString OAISoftwareTokenMfaSettingsType::asJson() const {
...
QJsonObject OAISoftwareTokenMfaSettingsType::asJsonObject() const {
    QJsonObject obj;
    if (m_enabled_isSet) {
...
bool OAISoftwareTokenMfaSettingsType::getEnabled() const {
    return m_enabled;
}
void OAISoftwareTokenMfaSettingsType::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAISoftwareTokenMfaSettingsType::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAISoftwareTokenMfaSettingsType::is_enabled_Valid() const{
    return m_enabled_isValid;
}

bool OAISoftwareTokenMfaSettingsType::getPreferredMfa() const {
    return m_preferred_mfa;
}
void OAISoftwareTokenMfaSettingsType::setPreferredMfa(const bool &preferred_mfa) {
    m_preferred_mfa = preferred_mfa;
    m_preferred_mfa_isSet = true;
}

bool OAISoftwareTokenMfaSettingsType::is_preferred_mfa_Set() const{
    return m_preferred_mfa_isSet;
}

bool OAISoftwareTokenMfaSettingsType::is_preferred_mfa_Valid() const{
    return m_preferred_mfa_isValid;
}

bool OAISoftwareTokenMfaSettingsType::isSet() const {
...
bool OAISoftwareTokenMfaSettingsType::isValid() const {
