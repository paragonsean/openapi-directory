...
OAIConfirmDeviceResponse::OAIConfirmDeviceResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIConfirmDeviceResponse::OAIConfirmDeviceResponse() {
    this->initializeModel();
}

OAIConfirmDeviceResponse::~OAIConfirmDeviceResponse() {}

void OAIConfirmDeviceResponse::initializeModel() {

    m_user_confirmation_necessary_isSet = false;
    m_user_confirmation_necessary_isValid = false;
}

void OAIConfirmDeviceResponse::fromJson(QString jsonString) {
...
void OAIConfirmDeviceResponse::fromJsonObject(QJsonObject json) {

    m_user_confirmation_necessary_isValid = ::OpenAPI::fromJsonValue(m_user_confirmation_necessary, json[QString("UserConfirmationNecessary")]);
    m_user_confirmation_necessary_isSet = !json[QString("UserConfirmationNecessary")].isNull() && m_user_confirmation_necessary_isValid;
}

QString OAIConfirmDeviceResponse::asJson() const {
...
QJsonObject OAIConfirmDeviceResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_user_confirmation_necessary_isSet) {
        obj.insert(QString("UserConfirmationNecessary"), ::OpenAPI::toJsonValue(m_user_confirmation_necessary));
    }
    return obj;
}

bool OAIConfirmDeviceResponse::getUserConfirmationNecessary() const {
    return m_user_confirmation_necessary;
}
void OAIConfirmDeviceResponse::setUserConfirmationNecessary(const bool &user_confirmation_necessary) {
    m_user_confirmation_necessary = user_confirmation_necessary;
    m_user_confirmation_necessary_isSet = true;
}

bool OAIConfirmDeviceResponse::is_user_confirmation_necessary_Set() const{
    return m_user_confirmation_necessary_isSet;
}

bool OAIConfirmDeviceResponse::is_user_confirmation_necessary_Valid() const{
    return m_user_confirmation_necessary_isValid;
}

bool OAIConfirmDeviceResponse::isSet() const {
...
bool OAIConfirmDeviceResponse::isValid() const {
