...
OAIAccountTakeoverActionsType_LowAction::OAIAccountTakeoverActionsType_LowAction(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAccountTakeoverActionsType_LowAction::OAIAccountTakeoverActionsType_LowAction() {
    this->initializeModel();
}

OAIAccountTakeoverActionsType_LowAction::~OAIAccountTakeoverActionsType_LowAction() {}

void OAIAccountTakeoverActionsType_LowAction::initializeModel() {
...
void OAIAccountTakeoverActionsType_LowAction::fromJson(QString jsonString) {
...
void OAIAccountTakeoverActionsType_LowAction::fromJsonObject(QJsonObject json) {
...
QString OAIAccountTakeoverActionsType_LowAction::asJson() const {
...
QJsonObject OAIAccountTakeoverActionsType_LowAction::asJsonObject() const {
    QJsonObject obj;
    if (m_notify_isSet) {
        obj.insert(QString("Notify"), ::OpenAPI::toJsonValue(m_notify));
    }
    if (m_event_action.isSet()) {
        obj.insert(QString("EventAction"), ::OpenAPI::toJsonValue(m_event_action));
    }
    return obj;
}

bool OAIAccountTakeoverActionsType_LowAction::getNotify() const {
    return m_notify;
}
void OAIAccountTakeoverActionsType_LowAction::setNotify(const bool &notify) {
    m_notify = notify;
    m_notify_isSet = true;
}

bool OAIAccountTakeoverActionsType_LowAction::is_notify_Set() const{
    return m_notify_isSet;
}

bool OAIAccountTakeoverActionsType_LowAction::is_notify_Valid() const{
    return m_notify_isValid;
}

OAIAccountTakeoverEventActionType OAIAccountTakeoverActionsType_LowAction::getEventAction() const {
    return m_event_action;
}
void OAIAccountTakeoverActionsType_LowAction::setEventAction(const OAIAccountTakeoverEventActionType &event_action) {
    m_event_action = event_action;
    m_event_action_isSet = true;
}

bool OAIAccountTakeoverActionsType_LowAction::is_event_action_Set() const{
    return m_event_action_isSet;
}

bool OAIAccountTakeoverActionsType_LowAction::is_event_action_Valid() const{
    return m_event_action_isValid;
}

bool OAIAccountTakeoverActionsType_LowAction::isSet() const {
...
bool OAIAccountTakeoverActionsType_LowAction::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_notify_isValid && m_event_action_isValid && true;
}
