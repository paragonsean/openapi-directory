...
/*
 * OAICreateUserPoolRequest_SmsConfiguration.h
 *
 * 
 */

#ifndef OAICreateUserPoolRequest_SmsConfiguration_H
#define OAICreateUserPoolRequest_SmsConfiguration_H
...
class OAICreateUserPoolRequest_SmsConfiguration : public OAIObject {
public:
    OAICreateUserPoolRequest_SmsConfiguration();
    OAICreateUserPoolRequest_SmsConfiguration(QString json);
    ~OAICreateUserPoolRequest_SmsConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateUserPoolRequest_SmsConfiguration)

#endif // OAICreateUserPoolRequest_SmsConfiguration_H
