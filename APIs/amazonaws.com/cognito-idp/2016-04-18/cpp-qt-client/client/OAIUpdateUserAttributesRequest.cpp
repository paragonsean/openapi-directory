...
OAIUpdateUserAttributesRequest::OAIUpdateUserAttributesRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateUserAttributesRequest::OAIUpdateUserAttributesRequest() {
    this->initializeModel();
}

OAIUpdateUserAttributesRequest::~OAIUpdateUserAttributesRequest() {}

void OAIUpdateUserAttributesRequest::initializeModel() {
...
void OAIUpdateUserAttributesRequest::fromJson(QString jsonString) {
...
void OAIUpdateUserAttributesRequest::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateUserAttributesRequest::asJson() const {
...
QJsonObject OAIUpdateUserAttributesRequest::asJsonObject() const {
    QJsonObject obj;
...
QList OAIUpdateUserAttributesRequest::getUserAttributes() const {
    return m_user_attributes;
}
void OAIUpdateUserAttributesRequest::setUserAttributes(const QList &user_attributes) {
    m_user_attributes = user_attributes;
    m_user_attributes_isSet = true;
}

bool OAIUpdateUserAttributesRequest::is_user_attributes_Set() const{
    return m_user_attributes_isSet;
}

bool OAIUpdateUserAttributesRequest::is_user_attributes_Valid() const{
    return m_user_attributes_isValid;
}

QString OAIUpdateUserAttributesRequest::getAccessToken() const {
    return m_access_token;
}
void OAIUpdateUserAttributesRequest::setAccessToken(const QString &access_token) {
    m_access_token = access_token;
    m_access_token_isSet = true;
}

bool OAIUpdateUserAttributesRequest::is_access_token_Set() const{
    return m_access_token_isSet;
}

bool OAIUpdateUserAttributesRequest::is_access_token_Valid() const{
    return m_access_token_isValid;
}

QMap OAIUpdateUserAttributesRequest::getClientMetadata() const {
    return m_client_metadata;
}
void OAIUpdateUserAttributesRequest::setClientMetadata(const QMap &client_metadata) {
    m_client_metadata = client_metadata;
    m_client_metadata_isSet = true;
}

bool OAIUpdateUserAttributesRequest::is_client_metadata_Set() const{
    return m_client_metadata_isSet;
}

bool OAIUpdateUserAttributesRequest::is_client_metadata_Valid() const{
    return m_client_metadata_isValid;
}

bool OAIUpdateUserAttributesRequest::isSet() const {
...
bool OAIUpdateUserAttributesRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_user_attributes_isValid && m_access_token_isValid && true;
}
