...
QString OAIGetDeviceRequest::getDeviceKey() const {
    return m_device_key;
}
void OAIGetDeviceRequest::setDeviceKey(const QString &device_key) {
    m_device_key = device_key;
    m_device_key_isSet = true;
}

bool OAIGetDeviceRequest::is_device_key_Set() const{
    return m_device_key_isSet;
}

bool OAIGetDeviceRequest::is_device_key_Valid() const{
    return m_device_key_isValid;
}

QString OAIGetDeviceRequest::getAccessToken() const {
    return m_access_token;
}
void OAIGetDeviceRequest::setAccessToken(const QString &access_token) {
    m_access_token = access_token;
    m_access_token_isSet = true;
}

bool OAIGetDeviceRequest::is_access_token_Set() const{
    return m_access_token_isSet;
}

bool OAIGetDeviceRequest::is_access_token_Valid() const{
