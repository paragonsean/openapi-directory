...
OAIAdminInitiateAuthResponse::OAIAdminInitiateAuthResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdminInitiateAuthResponse::OAIAdminInitiateAuthResponse() {
    this->initializeModel();
}

OAIAdminInitiateAuthResponse::~OAIAdminInitiateAuthResponse() {}

void OAIAdminInitiateAuthResponse::initializeModel() {
...
void OAIAdminInitiateAuthResponse::fromJson(QString jsonString) {
...
void OAIAdminInitiateAuthResponse::fromJsonObject(QJsonObject json) {
...
QString OAIAdminInitiateAuthResponse::asJson() const {
...
QJsonObject OAIAdminInitiateAuthResponse::asJsonObject() const {
    QJsonObject obj;
...
OAIChallengeNameType OAIAdminInitiateAuthResponse::getChallengeName() const {
    return m_challenge_name;
}
void OAIAdminInitiateAuthResponse::setChallengeName(const OAIChallengeNameType &challenge_name) {
    m_challenge_name = challenge_name;
    m_challenge_name_isSet = true;
}

bool OAIAdminInitiateAuthResponse::is_challenge_name_Set() const{
    return m_challenge_name_isSet;
}

bool OAIAdminInitiateAuthResponse::is_challenge_name_Valid() const{
    return m_challenge_name_isValid;
}

QString OAIAdminInitiateAuthResponse::getSession() const {
    return m_session;
}
void OAIAdminInitiateAuthResponse::setSession(const QString &session) {
    m_session = session;
    m_session_isSet = true;
}

bool OAIAdminInitiateAuthResponse::is_session_Set() const{
    return m_session_isSet;
}

bool OAIAdminInitiateAuthResponse::is_session_Valid() const{
    return m_session_isValid;
}

QMap OAIAdminInitiateAuthResponse::getChallengeParameters() const {
    return m_challenge_parameters;
}
void OAIAdminInitiateAuthResponse::setChallengeParameters(const QMap &challenge_parameters) {
    m_challenge_parameters = challenge_parameters;
    m_challenge_parameters_isSet = true;
}

bool OAIAdminInitiateAuthResponse::is_challenge_parameters_Set() const{
    return m_challenge_parameters_isSet;
}

bool OAIAdminInitiateAuthResponse::is_challenge_parameters_Valid() const{
    return m_challenge_parameters_isValid;
}

OAIAdminInitiateAuthResponse_AuthenticationResult OAIAdminInitiateAuthResponse::getAuthenticationResult() const {
    return m_authentication_result;
}
void OAIAdminInitiateAuthResponse::setAuthenticationResult(const OAIAdminInitiateAuthResponse_AuthenticationResult &authentication_result) {
    m_authentication_result = authentication_result;
    m_authentication_result_isSet = true;
}

bool OAIAdminInitiateAuthResponse::is_authentication_result_Set() const{
    return m_authentication_result_isSet;
}

bool OAIAdminInitiateAuthResponse::is_authentication_result_Valid() const{
    return m_authentication_result_isValid;
}

bool OAIAdminInitiateAuthResponse::isSet() const {
...
bool OAIAdminInitiateAuthResponse::isValid() const {
