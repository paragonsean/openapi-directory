...
OAIGetLogDeliveryConfigurationResponse_LogDeliveryConfiguration::OAIGetLogDeliveryConfigurationResponse_LogDeliveryConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetLogDeliveryConfigurationResponse_LogDeliveryConfiguration::OAIGetLogDeliveryConfigurationResponse_LogDeliveryConfiguration() {
    this->initializeModel();
}

OAIGetLogDeliveryConfigurationResponse_LogDeliveryConfiguration::~OAIGetLogDeliveryConfigurationResponse_LogDeliveryConfiguration() {}

void OAIGetLogDeliveryConfigurationResponse_LogDeliveryConfiguration::initializeModel() {
...
void OAIGetLogDeliveryConfigurationResponse_LogDeliveryConfiguration::fromJson(QString jsonString) {
...
void OAIGetLogDeliveryConfigurationResponse_LogDeliveryConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIGetLogDeliveryConfigurationResponse_LogDeliveryConfiguration::asJson() const {
...
QJsonObject OAIGetLogDeliveryConfigurationResponse_LogDeliveryConfiguration::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetLogDeliveryConfigurationResponse_LogDeliveryConfiguration::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIGetLogDeliveryConfigurationResponse_LogDeliveryConfiguration::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIGetLogDeliveryConfigurationResponse_LogDeliveryConfiguration::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIGetLogDeliveryConfigurationResponse_LogDeliveryConfiguration::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

QList OAIGetLogDeliveryConfigurationResponse_LogDeliveryConfiguration::getLogConfigurations() const {
    return m_log_configurations;
}
void OAIGetLogDeliveryConfigurationResponse_LogDeliveryConfiguration::setLogConfigurations(const QList &log_configurations) {
    m_log_configurations = log_configurations;
    m_log_configurations_isSet = true;
}

bool OAIGetLogDeliveryConfigurationResponse_LogDeliveryConfiguration::is_log_configurations_Set() const{
    return m_log_configurations_isSet;
}

bool OAIGetLogDeliveryConfigurationResponse_LogDeliveryConfiguration::is_log_configurations_Valid() const{
    return m_log_configurations_isValid;
}

bool OAIGetLogDeliveryConfigurationResponse_LogDeliveryConfiguration::isSet() const {
...
bool OAIGetLogDeliveryConfigurationResponse_LogDeliveryConfiguration::isValid() const {
