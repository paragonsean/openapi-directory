...
#include "OAICustomSMSSenderLambdaVersionType.h"
...
OAICustomSMSSenderLambdaVersionType::OAICustomSMSSenderLambdaVersionType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICustomSMSSenderLambdaVersionType::OAICustomSMSSenderLambdaVersionType() {
    this->initializeModel();
}

OAICustomSMSSenderLambdaVersionType::~OAICustomSMSSenderLambdaVersionType() {}

void OAICustomSMSSenderLambdaVersionType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAICustomSMSSenderLambdaVersionType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAICustomSMSSenderLambdaVersionType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("V1_0", Qt::CaseInsensitive) == 0) {
        m_value = eOAICustomSMSSenderLambdaVersionType::V1_0;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAICustomSMSSenderLambdaVersionType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAICustomSMSSenderLambdaVersionType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAICustomSMSSenderLambdaVersionType::V1_0:
            val = "V1_0";
            break;
        default:
            break;
...
QJsonValue OAICustomSMSSenderLambdaVersionType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAICustomSMSSenderLambdaVersionType::eOAICustomSMSSenderLambdaVersionType OAICustomSMSSenderLambdaVersionType::getValue() const {
    return m_value;
}

void OAICustomSMSSenderLambdaVersionType::setValue(const OAICustomSMSSenderLambdaVersionType::eOAICustomSMSSenderLambdaVersionType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAICustomSMSSenderLambdaVersionType::isSet() const {
    
    return m_value_isSet;
}

bool OAICustomSMSSenderLambdaVersionType::isValid() const {
