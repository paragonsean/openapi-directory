...
OAIAdminForgetDeviceRequest::OAIAdminForgetDeviceRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdminForgetDeviceRequest::OAIAdminForgetDeviceRequest() {
    this->initializeModel();
}

OAIAdminForgetDeviceRequest::~OAIAdminForgetDeviceRequest() {}

void OAIAdminForgetDeviceRequest::initializeModel() {
...
void OAIAdminForgetDeviceRequest::fromJson(QString jsonString) {
...
void OAIAdminForgetDeviceRequest::fromJsonObject(QJsonObject json) {
...
QString OAIAdminForgetDeviceRequest::asJson() const {
...
QJsonObject OAIAdminForgetDeviceRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAdminForgetDeviceRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIAdminForgetDeviceRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIAdminForgetDeviceRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIAdminForgetDeviceRequest::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

QString OAIAdminForgetDeviceRequest::getUsername() const {
    return m_username;
}
void OAIAdminForgetDeviceRequest::setUsername(const QString &username) {
    m_username = username;
    m_username_isSet = true;
}

bool OAIAdminForgetDeviceRequest::is_username_Set() const{
    return m_username_isSet;
}

bool OAIAdminForgetDeviceRequest::is_username_Valid() const{
    return m_username_isValid;
}

QString OAIAdminForgetDeviceRequest::getDeviceKey() const {
    return m_device_key;
}
void OAIAdminForgetDeviceRequest::setDeviceKey(const QString &device_key) {
    m_device_key = device_key;
    m_device_key_isSet = true;
}

bool OAIAdminForgetDeviceRequest::is_device_key_Set() const{
    return m_device_key_isSet;
}

bool OAIAdminForgetDeviceRequest::is_device_key_Valid() const{
    return m_device_key_isValid;
}

bool OAIAdminForgetDeviceRequest::isSet() const {
...
bool OAIAdminForgetDeviceRequest::isValid() const {
