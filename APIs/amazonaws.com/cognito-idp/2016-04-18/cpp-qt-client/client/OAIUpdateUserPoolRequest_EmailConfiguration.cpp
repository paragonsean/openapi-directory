...
OAIUpdateUserPoolRequest_EmailConfiguration::OAIUpdateUserPoolRequest_EmailConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateUserPoolRequest_EmailConfiguration::OAIUpdateUserPoolRequest_EmailConfiguration() {
    this->initializeModel();
}

OAIUpdateUserPoolRequest_EmailConfiguration::~OAIUpdateUserPoolRequest_EmailConfiguration() {}

void OAIUpdateUserPoolRequest_EmailConfiguration::initializeModel() {
...
void OAIUpdateUserPoolRequest_EmailConfiguration::fromJson(QString jsonString) {
...
void OAIUpdateUserPoolRequest_EmailConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateUserPoolRequest_EmailConfiguration::asJson() const {
...
QJsonObject OAIUpdateUserPoolRequest_EmailConfiguration::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateUserPoolRequest_EmailConfiguration::getSourceArn() const {
    return m_source_arn;
}
void OAIUpdateUserPoolRequest_EmailConfiguration::setSourceArn(const QString &source_arn) {
    m_source_arn = source_arn;
    m_source_arn_isSet = true;
}

bool OAIUpdateUserPoolRequest_EmailConfiguration::is_source_arn_Set() const{
    return m_source_arn_isSet;
}

bool OAIUpdateUserPoolRequest_EmailConfiguration::is_source_arn_Valid() const{
    return m_source_arn_isValid;
}

QString OAIUpdateUserPoolRequest_EmailConfiguration::getReplyToEmailAddress() const {
    return m_reply_to_email_address;
}
void OAIUpdateUserPoolRequest_EmailConfiguration::setReplyToEmailAddress(const QString &reply_to_email_address) {
    m_reply_to_email_address = reply_to_email_address;
    m_reply_to_email_address_isSet = true;
}

bool OAIUpdateUserPoolRequest_EmailConfiguration::is_reply_to_email_address_Set() const{
    return m_reply_to_email_address_isSet;
}

bool OAIUpdateUserPoolRequest_EmailConfiguration::is_reply_to_email_address_Valid() const{
    return m_reply_to_email_address_isValid;
}

OAIEmailSendingAccountType OAIUpdateUserPoolRequest_EmailConfiguration::getEmailSendingAccount() const {
    return m_email_sending_account;
}
void OAIUpdateUserPoolRequest_EmailConfiguration::setEmailSendingAccount(const OAIEmailSendingAccountType &email_sending_account) {
    m_email_sending_account = email_sending_account;
    m_email_sending_account_isSet = true;
}

bool OAIUpdateUserPoolRequest_EmailConfiguration::is_email_sending_account_Set() const{
    return m_email_sending_account_isSet;
}

bool OAIUpdateUserPoolRequest_EmailConfiguration::is_email_sending_account_Valid() const{
    return m_email_sending_account_isValid;
}

QString OAIUpdateUserPoolRequest_EmailConfiguration::getFrom() const {
    return m_from;
}
void OAIUpdateUserPoolRequest_EmailConfiguration::setFrom(const QString &from) {
    m_from = from;
    m_from_isSet = true;
}

bool OAIUpdateUserPoolRequest_EmailConfiguration::is_from_Set() const{
    return m_from_isSet;
}

bool OAIUpdateUserPoolRequest_EmailConfiguration::is_from_Valid() const{
    return m_from_isValid;
}

QString OAIUpdateUserPoolRequest_EmailConfiguration::getConfigurationSet() const {
    return m_configuration_set;
}
void OAIUpdateUserPoolRequest_EmailConfiguration::setConfigurationSet(const QString &configuration_set) {
    m_configuration_set = configuration_set;
    m_configuration_set_isSet = true;
}

bool OAIUpdateUserPoolRequest_EmailConfiguration::is_configuration_set_Set() const{
    return m_configuration_set_isSet;
}

bool OAIUpdateUserPoolRequest_EmailConfiguration::is_configuration_set_Valid() const{
    return m_configuration_set_isValid;
}

bool OAIUpdateUserPoolRequest_EmailConfiguration::isSet() const {
...
bool OAIUpdateUserPoolRequest_EmailConfiguration::isValid() const {
