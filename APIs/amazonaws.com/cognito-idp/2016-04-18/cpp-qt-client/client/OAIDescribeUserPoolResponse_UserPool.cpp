...
#include "OAIDescribeUserPoolResponse_UserPool.h"
...
OAIDescribeUserPoolResponse_UserPool::OAIDescribeUserPoolResponse_UserPool(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeUserPoolResponse_UserPool::OAIDescribeUserPoolResponse_UserPool() {
    this->initializeModel();
}

OAIDescribeUserPoolResponse_UserPool::~OAIDescribeUserPoolResponse_UserPool() {}

void OAIDescribeUserPoolResponse_UserPool::initializeModel() {
...
void OAIDescribeUserPoolResponse_UserPool::fromJson(QString jsonString) {
...
void OAIDescribeUserPoolResponse_UserPool::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeUserPoolResponse_UserPool::asJson() const {
...
QJsonObject OAIDescribeUserPoolResponse_UserPool::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
QString OAIDescribeUserPoolResponse_UserPool::getId() const {
    return m_id;
}
void OAIDescribeUserPoolResponse_UserPool::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIDescribeUserPoolResponse_UserPool::is_id_Set() const{
    return m_id_isSet;
}

bool OAIDescribeUserPoolResponse_UserPool::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIDescribeUserPoolResponse_UserPool::getName() const {
    return m_name;
}
void OAIDescribeUserPoolResponse_UserPool::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIDescribeUserPoolResponse_UserPool::is_name_Set() const{
    return m_name_isSet;
}

bool OAIDescribeUserPoolResponse_UserPool::is_name_Valid() const{
    return m_name_isValid;
}

OAIUserPoolType_Policies OAIDescribeUserPoolResponse_UserPool::getPolicies() const {
    return m_policies;
}
void OAIDescribeUserPoolResponse_UserPool::setPolicies(const OAIUserPoolType_Policies &policies) {
    m_policies = policies;
    m_policies_isSet = true;
}

bool OAIDescribeUserPoolResponse_UserPool::is_policies_Set() const{
    return m_policies_isSet;
}

bool OAIDescribeUserPoolResponse_UserPool::is_policies_Valid() const{
    return m_policies_isValid;
}

OAIDeletionProtectionType OAIDescribeUserPoolResponse_UserPool::getDeletionProtection() const {
    return m_deletion_protection;
}
void OAIDescribeUserPoolResponse_UserPool::setDeletionProtection(const OAIDeletionProtectionType &deletion_protection) {
    m_deletion_protection = deletion_protection;
    m_deletion_protection_isSet = true;
}

bool OAIDescribeUserPoolResponse_UserPool::is_deletion_protection_Set() const{
    return m_deletion_protection_isSet;
}

bool OAIDescribeUserPoolResponse_UserPool::is_deletion_protection_Valid() const{
    return m_deletion_protection_isValid;
}

OAIUserPoolType_LambdaConfig OAIDescribeUserPoolResponse_UserPool::getLambdaConfig() const {
    return m_lambda_config;
}
void OAIDescribeUserPoolResponse_UserPool::setLambdaConfig(const OAIUserPoolType_LambdaConfig &lambda_config) {
    m_lambda_config = lambda_config;
    m_lambda_config_isSet = true;
}

bool OAIDescribeUserPoolResponse_UserPool::is_lambda_config_Set() const{
    return m_lambda_config_isSet;
}

bool OAIDescribeUserPoolResponse_UserPool::is_lambda_config_Valid() const{
    return m_lambda_config_isValid;
}

OAIStatusType OAIDescribeUserPoolResponse_UserPool::getStatus() const {
    return m_status;
}
void OAIDescribeUserPoolResponse_UserPool::setStatus(const OAIStatusType &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIDescribeUserPoolResponse_UserPool::is_status_Set() const{
    return m_status_isSet;
}

bool OAIDescribeUserPoolResponse_UserPool::is_status_Valid() const{
    return m_status_isValid;
}

QDateTime OAIDescribeUserPoolResponse_UserPool::getLastModifiedDate() const {
    return m_last_modified_date;
}
void OAIDescribeUserPoolResponse_UserPool::setLastModifiedDate(const QDateTime &last_modified_date) {
    m_last_modified_date = last_modified_date;
    m_last_modified_date_isSet = true;
}

bool OAIDescribeUserPoolResponse_UserPool::is_last_modified_date_Set() const{
    return m_last_modified_date_isSet;
}

bool OAIDescribeUserPoolResponse_UserPool::is_last_modified_date_Valid() const{
    return m_last_modified_date_isValid;
}

QDateTime OAIDescribeUserPoolResponse_UserPool::getCreationDate() const {
    return m_creation_date;
}
void OAIDescribeUserPoolResponse_UserPool::setCreationDate(const QDateTime &creation_date) {
    m_creation_date = creation_date;
    m_creation_date_isSet = true;
}

bool OAIDescribeUserPoolResponse_UserPool::is_creation_date_Set() const{
    return m_creation_date_isSet;
}

bool OAIDescribeUserPoolResponse_UserPool::is_creation_date_Valid() const{
    return m_creation_date_isValid;
}

QList OAIDescribeUserPoolResponse_UserPool::getSchemaAttributes() const {
    return m_schema_attributes;
}
void OAIDescribeUserPoolResponse_UserPool::setSchemaAttributes(const QList &schema_attributes) {
    m_schema_attributes = schema_attributes;
    m_schema_attributes_isSet = true;
}

bool OAIDescribeUserPoolResponse_UserPool::is_schema_attributes_Set() const{
    return m_schema_attributes_isSet;
}

bool OAIDescribeUserPoolResponse_UserPool::is_schema_attributes_Valid() const{
    return m_schema_attributes_isValid;
}

QList OAIDescribeUserPoolResponse_UserPool::getAutoVerifiedAttributes() const {
    return m_auto_verified_attributes;
}
void OAIDescribeUserPoolResponse_UserPool::setAutoVerifiedAttributes(const QList &auto_verified_attributes) {
    m_auto_verified_attributes = auto_verified_attributes;
    m_auto_verified_attributes_isSet = true;
}

bool OAIDescribeUserPoolResponse_UserPool::is_auto_verified_attributes_Set() const{
    return m_auto_verified_attributes_isSet;
}

bool OAIDescribeUserPoolResponse_UserPool::is_auto_verified_attributes_Valid() const{
    return m_auto_verified_attributes_isValid;
}

QList OAIDescribeUserPoolResponse_UserPool::getAliasAttributes() const {
    return m_alias_attributes;
}
void OAIDescribeUserPoolResponse_UserPool::setAliasAttributes(const QList &alias_attributes) {
    m_alias_attributes = alias_attributes;
    m_alias_attributes_isSet = true;
}

bool OAIDescribeUserPoolResponse_UserPool::is_alias_attributes_Set() const{
    return m_alias_attributes_isSet;
}

bool OAIDescribeUserPoolResponse_UserPool::is_alias_attributes_Valid() const{
    return m_alias_attributes_isValid;
}

QList OAIDescribeUserPoolResponse_UserPool::getUsernameAttributes() const {
    return m_username_attributes;
}
void OAIDescribeUserPoolResponse_UserPool::setUsernameAttributes(const QList &username_attributes) {
    m_username_attributes = username_attributes;
    m_username_attributes_isSet = true;
}

bool OAIDescribeUserPoolResponse_UserPool::is_username_attributes_Set() const{
    return m_username_attributes_isSet;
}

bool OAIDescribeUserPoolResponse_UserPool::is_username_attributes_Valid() const{
    return m_username_attributes_isValid;
}

QString OAIDescribeUserPoolResponse_UserPool::getSmsVerificationMessage() const {
    return m_sms_verification_message;
}
void OAIDescribeUserPoolResponse_UserPool::setSmsVerificationMessage(const QString &sms_verification_message) {
    m_sms_verification_message = sms_verification_message;
    m_sms_verification_message_isSet = true;
}

bool OAIDescribeUserPoolResponse_UserPool::is_sms_verification_message_Set() const{
    return m_sms_verification_message_isSet;
}

bool OAIDescribeUserPoolResponse_UserPool::is_sms_verification_message_Valid() const{
    return m_sms_verification_message_isValid;
}

QString OAIDescribeUserPoolResponse_UserPool::getEmailVerificationMessage() const {
    return m_email_verification_message;
}
void OAIDescribeUserPoolResponse_UserPool::setEmailVerificationMessage(const QString &email_verification_message) {
    m_email_verification_message = email_verification_message;
    m_email_verification_message_isSet = true;
}

bool OAIDescribeUserPoolResponse_UserPool::is_email_verification_message_Set() const{
    return m_email_verification_message_isSet;
}

bool OAIDescribeUserPoolResponse_UserPool::is_email_verification_message_Valid() const{
    return m_email_verification_message_isValid;
}

QString OAIDescribeUserPoolResponse_UserPool::getEmailVerificationSubject() const {
    return m_email_verification_subject;
}
void OAIDescribeUserPoolResponse_UserPool::setEmailVerificationSubject(const QString &email_verification_subject) {
    m_email_verification_subject = email_verification_subject;
    m_email_verification_subject_isSet = true;
}

bool OAIDescribeUserPoolResponse_UserPool::is_email_verification_subject_Set() const{
    return m_email_verification_subject_isSet;
}

bool OAIDescribeUserPoolResponse_UserPool::is_email_verification_subject_Valid() const{
    return m_email_verification_subject_isValid;
}

OAIUpdateUserPoolRequest_VerificationMessageTemplate OAIDescribeUserPoolResponse_UserPool::getVerificationMessageTemplate() const {
    return m_verification_message_template;
}
void OAIDescribeUserPoolResponse_UserPool::setVerificationMessageTemplate(const OAIUpdateUserPoolRequest_VerificationMessageTemplate &verification_message_template) {
    m_verification_message_template = verification_message_template;
    m_verification_message_template_isSet = true;
}

bool OAIDescribeUserPoolResponse_UserPool::is_verification_message_template_Set() const{
    return m_verification_message_template_isSet;
}

bool OAIDescribeUserPoolResponse_UserPool::is_verification_message_template_Valid() const{
    return m_verification_message_template_isValid;
}

QString OAIDescribeUserPoolResponse_UserPool::getSmsAuthenticationMessage() const {
    return m_sms_authentication_message;
}
void OAIDescribeUserPoolResponse_UserPool::setSmsAuthenticationMessage(const QString &sms_authentication_message) {
    m_sms_authentication_message = sms_authentication_message;
    m_sms_authentication_message_isSet = true;
}

bool OAIDescribeUserPoolResponse_UserPool::is_sms_authentication_message_Set() const{
    return m_sms_authentication_message_isSet;
}

bool OAIDescribeUserPoolResponse_UserPool::is_sms_authentication_message_Valid() const{
    return m_sms_authentication_message_isValid;
}

OAICreateUserPoolRequest_UserAttributeUpdateSettings OAIDescribeUserPoolResponse_UserPool::getUserAttributeUpdateSettings() const {
    return m_user_attribute_update_settings;
}
void OAIDescribeUserPoolResponse_UserPool::setUserAttributeUpdateSettings(const OAICreateUserPoolRequest_UserAttributeUpdateSettings &user_attribute_update_settings) {
    m_user_attribute_update_settings = user_attribute_update_settings;
    m_user_attribute_update_settings_isSet = true;
}

bool OAIDescribeUserPoolResponse_UserPool::is_user_attribute_update_settings_Set() const{
    return m_user_attribute_update_settings_isSet;
}

bool OAIDescribeUserPoolResponse_UserPool::is_user_attribute_update_settings_Valid() const{
    return m_user_attribute_update_settings_isValid;
}

OAIUserPoolMfaType OAIDescribeUserPoolResponse_UserPool::getMfaConfiguration() const {
    return m_mfa_configuration;
}
void OAIDescribeUserPoolResponse_UserPool::setMfaConfiguration(const OAIUserPoolMfaType &mfa_configuration) {
    m_mfa_configuration = mfa_configuration;
    m_mfa_configuration_isSet = true;
}

bool OAIDescribeUserPoolResponse_UserPool::is_mfa_configuration_Set() const{
    return m_mfa_configuration_isSet;
}

bool OAIDescribeUserPoolResponse_UserPool::is_mfa_configuration_Valid() const{
    return m_mfa_configuration_isValid;
}

OAICreateUserPoolRequest_DeviceConfiguration OAIDescribeUserPoolResponse_UserPool::getDeviceConfiguration() const {
    return m_device_configuration;
}
void OAIDescribeUserPoolResponse_UserPool::setDeviceConfiguration(const OAICreateUserPoolRequest_DeviceConfiguration &device_configuration) {
    m_device_configuration = device_configuration;
    m_device_configuration_isSet = true;
}

bool OAIDescribeUserPoolResponse_UserPool::is_device_configuration_Set() const{
    return m_device_configuration_isSet;
}

bool OAIDescribeUserPoolResponse_UserPool::is_device_configuration_Valid() const{
    return m_device_configuration_isValid;
}

qint32 OAIDescribeUserPoolResponse_UserPool::getEstimatedNumberOfUsers() const {
    return m_estimated_number_of_users;
}
void OAIDescribeUserPoolResponse_UserPool::setEstimatedNumberOfUsers(const qint32 &estimated_number_of_users) {
    m_estimated_number_of_users = estimated_number_of_users;
    m_estimated_number_of_users_isSet = true;
}

bool OAIDescribeUserPoolResponse_UserPool::is_estimated_number_of_users_Set() const{
    return m_estimated_number_of_users_isSet;
}

bool OAIDescribeUserPoolResponse_UserPool::is_estimated_number_of_users_Valid() const{
    return m_estimated_number_of_users_isValid;
}

OAICreateUserPoolRequest_EmailConfiguration OAIDescribeUserPoolResponse_UserPool::getEmailConfiguration() const {
    return m_email_configuration;
}
void OAIDescribeUserPoolResponse_UserPool::setEmailConfiguration(const OAICreateUserPoolRequest_EmailConfiguration &email_configuration) {
    m_email_configuration = email_configuration;
    m_email_configuration_isSet = true;
}

bool OAIDescribeUserPoolResponse_UserPool::is_email_configuration_Set() const{
    return m_email_configuration_isSet;
}

bool OAIDescribeUserPoolResponse_UserPool::is_email_configuration_Valid() const{
    return m_email_configuration_isValid;
}

OAICreateUserPoolRequest_SmsConfiguration OAIDescribeUserPoolResponse_UserPool::getSmsConfiguration() const {
    return m_sms_configuration;
}
void OAIDescribeUserPoolResponse_UserPool::setSmsConfiguration(const OAICreateUserPoolRequest_SmsConfiguration &sms_configuration) {
    m_sms_configuration = sms_configuration;
    m_sms_configuration_isSet = true;
}

bool OAIDescribeUserPoolResponse_UserPool::is_sms_configuration_Set() const{
    return m_sms_configuration_isSet;
}

bool OAIDescribeUserPoolResponse_UserPool::is_sms_configuration_Valid() const{
    return m_sms_configuration_isValid;
}

QMap OAIDescribeUserPoolResponse_UserPool::getUserPoolTags() const {
    return m_user_pool_tags;
}
void OAIDescribeUserPoolResponse_UserPool::setUserPoolTags(const QMap &user_pool_tags) {
    m_user_pool_tags = user_pool_tags;
    m_user_pool_tags_isSet = true;
}

bool OAIDescribeUserPoolResponse_UserPool::is_user_pool_tags_Set() const{
    return m_user_pool_tags_isSet;
}

bool OAIDescribeUserPoolResponse_UserPool::is_user_pool_tags_Valid() const{
    return m_user_pool_tags_isValid;
}

QString OAIDescribeUserPoolResponse_UserPool::getSmsConfigurationFailure() const {
    return m_sms_configuration_failure;
}
void OAIDescribeUserPoolResponse_UserPool::setSmsConfigurationFailure(const QString &sms_configuration_failure) {
    m_sms_configuration_failure = sms_configuration_failure;
    m_sms_configuration_failure_isSet = true;
}

bool OAIDescribeUserPoolResponse_UserPool::is_sms_configuration_failure_Set() const{
    return m_sms_configuration_failure_isSet;
}

bool OAIDescribeUserPoolResponse_UserPool::is_sms_configuration_failure_Valid() const{
    return m_sms_configuration_failure_isValid;
}

QString OAIDescribeUserPoolResponse_UserPool::getEmailConfigurationFailure() const {
    return m_email_configuration_failure;
}
void OAIDescribeUserPoolResponse_UserPool::setEmailConfigurationFailure(const QString &email_configuration_failure) {
    m_email_configuration_failure = email_configuration_failure;
    m_email_configuration_failure_isSet = true;
}

bool OAIDescribeUserPoolResponse_UserPool::is_email_configuration_failure_Set() const{
    return m_email_configuration_failure_isSet;
}

bool OAIDescribeUserPoolResponse_UserPool::is_email_configuration_failure_Valid() const{
    return m_email_configuration_failure_isValid;
}

QString OAIDescribeUserPoolResponse_UserPool::getDomain() const {
    return m_domain;
}
void OAIDescribeUserPoolResponse_UserPool::setDomain(const QString &domain) {
    m_domain = domain;
    m_domain_isSet = true;
}

bool OAIDescribeUserPoolResponse_UserPool::is_domain_Set() const{
    return m_domain_isSet;
}

bool OAIDescribeUserPoolResponse_UserPool::is_domain_Valid() const{
    return m_domain_isValid;
}

QString OAIDescribeUserPoolResponse_UserPool::getCustomDomain() const {
    return m_custom_domain;
}
void OAIDescribeUserPoolResponse_UserPool::setCustomDomain(const QString &custom_domain) {
    m_custom_domain = custom_domain;
    m_custom_domain_isSet = true;
}

bool OAIDescribeUserPoolResponse_UserPool::is_custom_domain_Set() const{
    return m_custom_domain_isSet;
}

bool OAIDescribeUserPoolResponse_UserPool::is_custom_domain_Valid() const{
    return m_custom_domain_isValid;
}

OAICreateUserPoolRequest_AdminCreateUserConfig OAIDescribeUserPoolResponse_UserPool::getAdminCreateUserConfig() const {
    return m_admin_create_user_config;
}
void OAIDescribeUserPoolResponse_UserPool::setAdminCreateUserConfig(const OAICreateUserPoolRequest_AdminCreateUserConfig &admin_create_user_config) {
    m_admin_create_user_config = admin_create_user_config;
    m_admin_create_user_config_isSet = true;
}

bool OAIDescribeUserPoolResponse_UserPool::is_admin_create_user_config_Set() const{
    return m_admin_create_user_config_isSet;
}

bool OAIDescribeUserPoolResponse_UserPool::is_admin_create_user_config_Valid() const{
    return m_admin_create_user_config_isValid;
}

OAICreateUserPoolRequest_UserPoolAddOns OAIDescribeUserPoolResponse_UserPool::getUserPoolAddOns() const {
    return m_user_pool_add_ons;
}
void OAIDescribeUserPoolResponse_UserPool::setUserPoolAddOns(const OAICreateUserPoolRequest_UserPoolAddOns &user_pool_add_ons) {
    m_user_pool_add_ons = user_pool_add_ons;
    m_user_pool_add_ons_isSet = true;
}

bool OAIDescribeUserPoolResponse_UserPool::is_user_pool_add_ons_Set() const{
    return m_user_pool_add_ons_isSet;
}

bool OAIDescribeUserPoolResponse_UserPool::is_user_pool_add_ons_Valid() const{
    return m_user_pool_add_ons_isValid;
}

OAIUserPoolType_UsernameConfiguration OAIDescribeUserPoolResponse_UserPool::getUsernameConfiguration() const {
    return m_username_configuration;
}
void OAIDescribeUserPoolResponse_UserPool::setUsernameConfiguration(const OAIUserPoolType_UsernameConfiguration &username_configuration) {
    m_username_configuration = username_configuration;
    m_username_configuration_isSet = true;
}

bool OAIDescribeUserPoolResponse_UserPool::is_username_configuration_Set() const{
    return m_username_configuration_isSet;
}

bool OAIDescribeUserPoolResponse_UserPool::is_username_configuration_Valid() const{
    return m_username_configuration_isValid;
}

QString OAIDescribeUserPoolResponse_UserPool::getArn() const {
    return m_arn;
}
void OAIDescribeUserPoolResponse_UserPool::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIDescribeUserPoolResponse_UserPool::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIDescribeUserPoolResponse_UserPool::is_arn_Valid() const{
    return m_arn_isValid;
}

OAICreateUserPoolRequest_AccountRecoverySetting OAIDescribeUserPoolResponse_UserPool::getAccountRecoverySetting() const {
    return m_account_recovery_setting;
}
void OAIDescribeUserPoolResponse_UserPool::setAccountRecoverySetting(const OAICreateUserPoolRequest_AccountRecoverySetting &account_recovery_setting) {
    m_account_recovery_setting = account_recovery_setting;
    m_account_recovery_setting_isSet = true;
}

bool OAIDescribeUserPoolResponse_UserPool::is_account_recovery_setting_Set() const{
    return m_account_recovery_setting_isSet;
}

bool OAIDescribeUserPoolResponse_UserPool::is_account_recovery_setting_Valid() const{
    return m_account_recovery_setting_isValid;
}

bool OAIDescribeUserPoolResponse_UserPool::isSet() const {
...
bool OAIDescribeUserPoolResponse_UserPool::isValid() const {
