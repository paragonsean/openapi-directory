...
/*
 * OAISetUserSettingsRequest.h
 *
 * Represents the request to set user settings.
 */

#ifndef OAISetUserSettingsRequest_H
#define OAISetUserSettingsRequest_H
...
class OAISetUserSettingsRequest : public OAIObject {
public:
    OAISetUserSettingsRequest();
    OAISetUserSettingsRequest(QString json);
    ~OAISetUserSettingsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISetUserSettingsRequest)

#endif // OAISetUserSettingsRequest_H
