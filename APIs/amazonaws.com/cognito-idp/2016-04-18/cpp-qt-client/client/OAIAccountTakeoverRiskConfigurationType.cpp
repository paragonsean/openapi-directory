...
#include "OAIAccountTakeoverRiskConfigurationType.h"
...
OAIAccountTakeoverRiskConfigurationType::OAIAccountTakeoverRiskConfigurationType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAccountTakeoverRiskConfigurationType::OAIAccountTakeoverRiskConfigurationType() {
    this->initializeModel();
}

OAIAccountTakeoverRiskConfigurationType::~OAIAccountTakeoverRiskConfigurationType() {}

void OAIAccountTakeoverRiskConfigurationType::initializeModel() {
...
void OAIAccountTakeoverRiskConfigurationType::fromJson(QString jsonString) {
...
void OAIAccountTakeoverRiskConfigurationType::fromJsonObject(QJsonObject json) {
...
QString OAIAccountTakeoverRiskConfigurationType::asJson() const {
...
QJsonObject OAIAccountTakeoverRiskConfigurationType::asJsonObject() const {
    QJsonObject obj;
...
OAIAccountTakeoverRiskConfigurationType_NotifyConfiguration OAIAccountTakeoverRiskConfigurationType::getNotifyConfiguration() const {
    return m_notify_configuration;
}
void OAIAccountTakeoverRiskConfigurationType::setNotifyConfiguration(const OAIAccountTakeoverRiskConfigurationType_NotifyConfiguration &notify_configuration) {
    m_notify_configuration = notify_configuration;
    m_notify_configuration_isSet = true;
}

bool OAIAccountTakeoverRiskConfigurationType::is_notify_configuration_Set() const{
    return m_notify_configuration_isSet;
}

bool OAIAccountTakeoverRiskConfigurationType::is_notify_configuration_Valid() const{
    return m_notify_configuration_isValid;
}

OAIAccountTakeoverRiskConfigurationType_Actions OAIAccountTakeoverRiskConfigurationType::getActions() const {
    return m_actions;
}
void OAIAccountTakeoverRiskConfigurationType::setActions(const OAIAccountTakeoverRiskConfigurationType_Actions &actions) {
    m_actions = actions;
    m_actions_isSet = true;
}

bool OAIAccountTakeoverRiskConfigurationType::is_actions_Set() const{
    return m_actions_isSet;
}

bool OAIAccountTakeoverRiskConfigurationType::is_actions_Valid() const{
    return m_actions_isValid;
}

bool OAIAccountTakeoverRiskConfigurationType::isSet() const {
...
bool OAIAccountTakeoverRiskConfigurationType::isValid() const {
