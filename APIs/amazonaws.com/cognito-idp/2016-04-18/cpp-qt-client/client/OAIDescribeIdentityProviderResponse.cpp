...
OAIDescribeIdentityProviderResponse::OAIDescribeIdentityProviderResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeIdentityProviderResponse::OAIDescribeIdentityProviderResponse() {
    this->initializeModel();
}

OAIDescribeIdentityProviderResponse::~OAIDescribeIdentityProviderResponse() {}

void OAIDescribeIdentityProviderResponse::initializeModel() {

    m_identity_provider_isSet = false;
    m_identity_provider_isValid = false;
}

void OAIDescribeIdentityProviderResponse::fromJson(QString jsonString) {
...
void OAIDescribeIdentityProviderResponse::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeIdentityProviderResponse::asJson() const {
...
QJsonObject OAIDescribeIdentityProviderResponse::asJsonObject() const {
    QJsonObject obj;
...
OAIDescribeIdentityProviderResponse_IdentityProvider OAIDescribeIdentityProviderResponse::getIdentityProvider() const {
    return m_identity_provider;
}
void OAIDescribeIdentityProviderResponse::setIdentityProvider(const OAIDescribeIdentityProviderResponse_IdentityProvider &identity_provider) {
    m_identity_provider = identity_provider;
    m_identity_provider_isSet = true;
}

bool OAIDescribeIdentityProviderResponse::is_identity_provider_Set() const{
    return m_identity_provider_isSet;
}

bool OAIDescribeIdentityProviderResponse::is_identity_provider_Valid() const{
    return m_identity_provider_isValid;
}

bool OAIDescribeIdentityProviderResponse::isSet() const {
...
bool OAIDescribeIdentityProviderResponse::isValid() const {
