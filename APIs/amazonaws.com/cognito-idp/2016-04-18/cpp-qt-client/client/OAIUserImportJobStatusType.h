...
/*
 * OAIUserImportJobStatusType.h
 *
 * 
 */

#ifndef OAIUserImportJobStatusType_H
#define OAIUserImportJobStatusType_H
...
class OAIUserImportJobStatusType : public OAIEnum {
public:
    OAIUserImportJobStatusType();
    OAIUserImportJobStatusType(QString json);
    ~OAIUserImportJobStatusType() override;
    ...
    enum class eOAIUserImportJobStatusType {
    ...
    OAIUserImportJobStatusType::eOAIUserImportJobStatusType getValue() const;
    void setValue(const OAIUserImportJobStatusType::eOAIUserImportJobStatusType& value);
...
private:
    ...
    eOAIUserImportJobStatusType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserImportJobStatusType)

#endif // OAIUserImportJobStatusType_H
