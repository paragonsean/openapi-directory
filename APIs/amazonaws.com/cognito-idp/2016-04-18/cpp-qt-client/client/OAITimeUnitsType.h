...
#ifndef OAITimeUnitsType_H
#define OAITimeUnitsType_H
...
class OAITimeUnitsType : public OAIEnum {
public:
    OAITimeUnitsType();
    OAITimeUnitsType(QString json);
    ~OAITimeUnitsType() override;
    ...
    OAITimeUnitsType::eOAITimeUnitsType getValue() const;
    void setValue(const OAITimeUnitsType::eOAITimeUnitsType& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAITimeUnitsType)

#endif // OAITimeUnitsType_H
