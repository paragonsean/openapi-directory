...
/*
 * OAISoftwareTokenMfaConfigType.h
 *
 * The type used for enabling software token MFA at the user pool level.
 */

#ifndef OAISoftwareTokenMfaConfigType_H
#define OAISoftwareTokenMfaConfigType_H
...
class OAISoftwareTokenMfaConfigType : public OAIObject {
public:
    OAISoftwareTokenMfaConfigType();
    OAISoftwareTokenMfaConfigType(QString json);
    ~OAISoftwareTokenMfaConfigType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISoftwareTokenMfaConfigType)

#endif // OAISoftwareTokenMfaConfigType_H
