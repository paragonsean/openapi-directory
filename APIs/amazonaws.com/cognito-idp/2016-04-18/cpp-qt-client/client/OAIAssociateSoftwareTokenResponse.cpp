...
OAIAssociateSoftwareTokenResponse::OAIAssociateSoftwareTokenResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAssociateSoftwareTokenResponse::OAIAssociateSoftwareTokenResponse() {
    this->initializeModel();
}

OAIAssociateSoftwareTokenResponse::~OAIAssociateSoftwareTokenResponse() {}

void OAIAssociateSoftwareTokenResponse::initializeModel() {
...
void OAIAssociateSoftwareTokenResponse::fromJson(QString jsonString) {
...
void OAIAssociateSoftwareTokenResponse::fromJsonObject(QJsonObject json) {
...
QString OAIAssociateSoftwareTokenResponse::asJson() const {
...
QJsonObject OAIAssociateSoftwareTokenResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAssociateSoftwareTokenResponse::getSecretCode() const {
    return m_secret_code;
}
void OAIAssociateSoftwareTokenResponse::setSecretCode(const QString &secret_code) {
    m_secret_code = secret_code;
    m_secret_code_isSet = true;
}

bool OAIAssociateSoftwareTokenResponse::is_secret_code_Set() const{
    return m_secret_code_isSet;
}

bool OAIAssociateSoftwareTokenResponse::is_secret_code_Valid() const{
    return m_secret_code_isValid;
}

QString OAIAssociateSoftwareTokenResponse::getSession() const {
    return m_session;
}
void OAIAssociateSoftwareTokenResponse::setSession(const QString &session) {
    m_session = session;
    m_session_isSet = true;
}

bool OAIAssociateSoftwareTokenResponse::is_session_Set() const{
    return m_session_isSet;
}

bool OAIAssociateSoftwareTokenResponse::is_session_Valid() const{
    return m_session_isValid;
}

bool OAIAssociateSoftwareTokenResponse::isSet() const {
...
bool OAIAssociateSoftwareTokenResponse::isValid() const {
