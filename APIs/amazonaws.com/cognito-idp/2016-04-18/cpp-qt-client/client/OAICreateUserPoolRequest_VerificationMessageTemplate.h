...
/*
 * OAICreateUserPoolRequest_VerificationMessageTemplate.h
 *
 * 
 */

#ifndef OAICreateUserPoolRequest_VerificationMessageTemplate_H
#define OAICreateUserPoolRequest_VerificationMessageTemplate_H

#include <QJsonObject>

#include "OAIDefaultEmailOptionType.h"
#include <QString>
...
class OAICreateUserPoolRequest_VerificationMessageTemplate : public OAIObject {
public:
    OAICreateUserPoolRequest_VerificationMessageTemplate();
    OAICreateUserPoolRequest_VerificationMessageTemplate(QString json);
    ~OAICreateUserPoolRequest_VerificationMessageTemplate() override;
    ...
    QString getEmailMessageByLink() const;
    void setEmailMessageByLink(const QString &email_message_by_link);
    bool is_email_message_by_link_Set() const;
    bool is_email_message_by_link_Valid() const;

    QString getEmailSubjectByLink() const;
    void setEmailSubjectByLink(const QString &email_subject_by_link);
    bool is_email_subject_by_link_Set() const;
    bool is_email_subject_by_link_Valid() const;

    OAIDefaultEmailOptionType getDefaultEmailOption() const;
    void setDefaultEmailOption(const OAIDefaultEmailOptionType &default_email_option);
    bool is_default_email_option_Set() const;
    bool is_default_email_option_Valid() const;
...
private:
    ...
    QString m_email_message_by_link;
    bool m_email_message_by_link_isSet;
    bool m_email_message_by_link_isValid;

    QString m_email_subject_by_link;
    bool m_email_subject_by_link_isSet;
    bool m_email_subject_by_link_isValid;

    OAIDefaultEmailOptionType m_default_email_option;
    bool m_default_email_option_isSet;
    bool m_default_email_option_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICreateUserPoolRequest_VerificationMessageTemplate)

#endif // OAICreateUserPoolRequest_VerificationMessageTemplate_H
