...
/*
 * OAIUpdateUserPoolRequest_Policies.h
 *
 * 
 */

#ifndef OAIUpdateUserPoolRequest_Policies_H
#define OAIUpdateUserPoolRequest_Policies_H
...
class OAIUpdateUserPoolRequest_Policies : public OAIObject {
public:
    OAIUpdateUserPoolRequest_Policies();
    OAIUpdateUserPoolRequest_Policies(QString json);
    ~OAIUpdateUserPoolRequest_Policies() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateUserPoolRequest_Policies)

#endif // OAIUpdateUserPoolRequest_Policies_H
