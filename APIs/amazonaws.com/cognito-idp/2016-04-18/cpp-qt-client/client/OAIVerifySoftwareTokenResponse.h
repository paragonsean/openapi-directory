...
/*
 * OAIVerifySoftwareTokenResponse.h
 *
 * 
 */

#ifndef OAIVerifySoftwareTokenResponse_H
#define OAIVerifySoftwareTokenResponse_H

#include <QJsonObject>

#include "OAIVerifySoftwareTokenResponseType.h"
#include <QString>
...
class OAIVerifySoftwareTokenResponse : public OAIObject {
public:
    OAIVerifySoftwareTokenResponse();
    OAIVerifySoftwareTokenResponse(QString json);
    ~OAIVerifySoftwareTokenResponse() override;
    ...
    OAIVerifySoftwareTokenResponseType getStatus() const;
    void setStatus(const OAIVerifySoftwareTokenResponseType &status);
...
private:
    ...
    OAIVerifySoftwareTokenResponseType m_status;
    bool m_status_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVerifySoftwareTokenResponse)

#endif // OAIVerifySoftwareTokenResponse_H
