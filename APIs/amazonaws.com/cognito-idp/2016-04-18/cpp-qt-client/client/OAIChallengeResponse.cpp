...
#include "OAIChallengeResponse.h"
...
OAIChallengeResponse::OAIChallengeResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIChallengeResponse::OAIChallengeResponse() {
    this->initializeModel();
}

OAIChallengeResponse::~OAIChallengeResponse() {}

void OAIChallengeResponse::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIChallengeResponse::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIChallengeResponse::fromJson(QString jsonString) {
    
    if ( jsonString.compare("Success", Qt::CaseInsensitive) == 0) {
        m_value = eOAIChallengeResponse::SUCCESS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Failure", Qt::CaseInsensitive) == 0) {
        m_value = eOAIChallengeResponse::FAILURE;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIChallengeResponse::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIChallengeResponse::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIChallengeResponse::SUCCESS:
            val = "Success";
            break;
        case eOAIChallengeResponse::FAILURE:
            val = "Failure";
            break;
        default:
            break;
...
QJsonValue OAIChallengeResponse::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIChallengeResponse::eOAIChallengeResponse OAIChallengeResponse::getValue() const {
    return m_value;
}

void OAIChallengeResponse::setValue(const OAIChallengeResponse::eOAIChallengeResponse& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIChallengeResponse::isSet() const {
    
    return m_value_isSet;
}

bool OAIChallengeResponse::isValid() const {
