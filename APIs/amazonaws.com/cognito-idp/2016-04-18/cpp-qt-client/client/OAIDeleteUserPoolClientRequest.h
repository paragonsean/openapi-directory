...
/*
 * OAIDeleteUserPoolClientRequest.h
 *
 * Represents the request to delete a user pool client.
 */

#ifndef OAIDeleteUserPoolClientRequest_H
#define OAIDeleteUserPoolClientRequest_H
...
class OAIDeleteUserPoolClientRequest : public OAIObject {
public:
    OAIDeleteUserPoolClientRequest();
    OAIDeleteUserPoolClientRequest(QString json);
    ~OAIDeleteUserPoolClientRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteUserPoolClientRequest)

#endif // OAIDeleteUserPoolClientRequest_H
