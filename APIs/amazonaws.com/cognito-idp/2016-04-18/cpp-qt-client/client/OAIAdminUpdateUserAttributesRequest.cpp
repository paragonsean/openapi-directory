...
OAIAdminUpdateUserAttributesRequest::OAIAdminUpdateUserAttributesRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdminUpdateUserAttributesRequest::OAIAdminUpdateUserAttributesRequest() {
    this->initializeModel();
}

OAIAdminUpdateUserAttributesRequest::~OAIAdminUpdateUserAttributesRequest() {}

void OAIAdminUpdateUserAttributesRequest::initializeModel() {
...
void OAIAdminUpdateUserAttributesRequest::fromJson(QString jsonString) {
...
void OAIAdminUpdateUserAttributesRequest::fromJsonObject(QJsonObject json) {
...
QString OAIAdminUpdateUserAttributesRequest::asJson() const {
...
QJsonObject OAIAdminUpdateUserAttributesRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAdminUpdateUserAttributesRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIAdminUpdateUserAttributesRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIAdminUpdateUserAttributesRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIAdminUpdateUserAttributesRequest::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

QString OAIAdminUpdateUserAttributesRequest::getUsername() const {
    return m_username;
}
void OAIAdminUpdateUserAttributesRequest::setUsername(const QString &username) {
    m_username = username;
    m_username_isSet = true;
}

bool OAIAdminUpdateUserAttributesRequest::is_username_Set() const{
    return m_username_isSet;
}

bool OAIAdminUpdateUserAttributesRequest::is_username_Valid() const{
    return m_username_isValid;
}

QList OAIAdminUpdateUserAttributesRequest::getUserAttributes() const {
    return m_user_attributes;
}
void OAIAdminUpdateUserAttributesRequest::setUserAttributes(const QList &user_attributes) {
    m_user_attributes = user_attributes;
    m_user_attributes_isSet = true;
}

bool OAIAdminUpdateUserAttributesRequest::is_user_attributes_Set() const{
    return m_user_attributes_isSet;
}

bool OAIAdminUpdateUserAttributesRequest::is_user_attributes_Valid() const{
    return m_user_attributes_isValid;
}

QMap OAIAdminUpdateUserAttributesRequest::getClientMetadata() const {
    return m_client_metadata;
}
void OAIAdminUpdateUserAttributesRequest::setClientMetadata(const QMap &client_metadata) {
    m_client_metadata = client_metadata;
    m_client_metadata_isSet = true;
}

bool OAIAdminUpdateUserAttributesRequest::is_client_metadata_Set() const{
    return m_client_metadata_isSet;
}

bool OAIAdminUpdateUserAttributesRequest::is_client_metadata_Valid() const{
    return m_client_metadata_isValid;
}

bool OAIAdminUpdateUserAttributesRequest::isSet() const {
...
bool OAIAdminUpdateUserAttributesRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_user_pool_id_isValid && m_username_isValid && m_user_attributes_isValid && true;
}
