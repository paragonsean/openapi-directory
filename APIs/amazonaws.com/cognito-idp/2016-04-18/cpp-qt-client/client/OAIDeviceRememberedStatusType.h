...
/*
 * OAIDeviceRememberedStatusType.h
 *
 * 
 */

#ifndef OAIDeviceRememberedStatusType_H
#define OAIDeviceRememberedStatusType_H
...
class OAIDeviceRememberedStatusType : public OAIEnum {
public:
    OAIDeviceRememberedStatusType();
    OAIDeviceRememberedStatusType(QString json);
    ~OAIDeviceRememberedStatusType() override;
    ...
    enum class eOAIDeviceRememberedStatusType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        REMEMBERED, 
        NOT_REMEMBERED
    };
    OAIDeviceRememberedStatusType::eOAIDeviceRememberedStatusType getValue() const;
    void setValue(const OAIDeviceRememberedStatusType::eOAIDeviceRememberedStatusType& value);
...
private:
    ...
    eOAIDeviceRememberedStatusType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeviceRememberedStatusType)

#endif // OAIDeviceRememberedStatusType_H
