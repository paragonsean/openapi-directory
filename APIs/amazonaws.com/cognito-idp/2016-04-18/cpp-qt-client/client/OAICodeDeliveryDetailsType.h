...
/*
 * OAICodeDeliveryDetailsType.h
 *
 * The delivery details for an email or SMS message that Amazon Cognito sent for authentication or verification.
 */

#ifndef OAICodeDeliveryDetailsType_H
#define OAICodeDeliveryDetailsType_H
...
class OAICodeDeliveryDetailsType : public OAIObject {
public:
    OAICodeDeliveryDetailsType();
    OAICodeDeliveryDetailsType(QString json);
    ~OAICodeDeliveryDetailsType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICodeDeliveryDetailsType)

#endif // OAICodeDeliveryDetailsType_H
