...
/*
 * OAIAdminGetUserRequest.h
 *
 * Represents the request to get the specified user as an administrator.
 */

#ifndef OAIAdminGetUserRequest_H
#define OAIAdminGetUserRequest_H
...
class OAIAdminGetUserRequest : public OAIObject {
public:
    OAIAdminGetUserRequest();
    OAIAdminGetUserRequest(QString json);
    ~OAIAdminGetUserRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdminGetUserRequest)

#endif // OAIAdminGetUserRequest_H
