...
OAIDescribeResourceServerResponse::OAIDescribeResourceServerResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeResourceServerResponse::OAIDescribeResourceServerResponse() {
    this->initializeModel();
}

OAIDescribeResourceServerResponse::~OAIDescribeResourceServerResponse() {}

void OAIDescribeResourceServerResponse::initializeModel() {

    m_resource_server_isSet = false;
    m_resource_server_isValid = false;
}

void OAIDescribeResourceServerResponse::fromJson(QString jsonString) {
...
void OAIDescribeResourceServerResponse::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeResourceServerResponse::asJson() const {
...
QJsonObject OAIDescribeResourceServerResponse::asJsonObject() const {
    QJsonObject obj;
...
OAIDescribeResourceServerResponse_ResourceServer OAIDescribeResourceServerResponse::getResourceServer() const {
    return m_resource_server;
}
void OAIDescribeResourceServerResponse::setResourceServer(const OAIDescribeResourceServerResponse_ResourceServer &resource_server) {
    m_resource_server = resource_server;
    m_resource_server_isSet = true;
}

bool OAIDescribeResourceServerResponse::is_resource_server_Set() const{
    return m_resource_server_isSet;
}

bool OAIDescribeResourceServerResponse::is_resource_server_Valid() const{
    return m_resource_server_isValid;
}

bool OAIDescribeResourceServerResponse::isSet() const {
...
bool OAIDescribeResourceServerResponse::isValid() const {
