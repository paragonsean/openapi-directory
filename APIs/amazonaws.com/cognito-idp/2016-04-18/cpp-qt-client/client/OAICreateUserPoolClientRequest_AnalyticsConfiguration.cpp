...
OAICreateUserPoolClientRequest_AnalyticsConfiguration::OAICreateUserPoolClientRequest_AnalyticsConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateUserPoolClientRequest_AnalyticsConfiguration::OAICreateUserPoolClientRequest_AnalyticsConfiguration() {
    this->initializeModel();
}

OAICreateUserPoolClientRequest_AnalyticsConfiguration::~OAICreateUserPoolClientRequest_AnalyticsConfiguration() {}

void OAICreateUserPoolClientRequest_AnalyticsConfiguration::initializeModel() {
...
void OAICreateUserPoolClientRequest_AnalyticsConfiguration::fromJson(QString jsonString) {
...
void OAICreateUserPoolClientRequest_AnalyticsConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAICreateUserPoolClientRequest_AnalyticsConfiguration::asJson() const {
...
QJsonObject OAICreateUserPoolClientRequest_AnalyticsConfiguration::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateUserPoolClientRequest_AnalyticsConfiguration::getApplicationId() const {
    return m_application_id;
}
void OAICreateUserPoolClientRequest_AnalyticsConfiguration::setApplicationId(const QString &application_id) {
    m_application_id = application_id;
    m_application_id_isSet = true;
}

bool OAICreateUserPoolClientRequest_AnalyticsConfiguration::is_application_id_Set() const{
    return m_application_id_isSet;
}

bool OAICreateUserPoolClientRequest_AnalyticsConfiguration::is_application_id_Valid() const{
    return m_application_id_isValid;
}

QString OAICreateUserPoolClientRequest_AnalyticsConfiguration::getApplicationArn() const {
    return m_application_arn;
}
void OAICreateUserPoolClientRequest_AnalyticsConfiguration::setApplicationArn(const QString &application_arn) {
    m_application_arn = application_arn;
    m_application_arn_isSet = true;
}

bool OAICreateUserPoolClientRequest_AnalyticsConfiguration::is_application_arn_Set() const{
    return m_application_arn_isSet;
}

bool OAICreateUserPoolClientRequest_AnalyticsConfiguration::is_application_arn_Valid() const{
    return m_application_arn_isValid;
}

QString OAICreateUserPoolClientRequest_AnalyticsConfiguration::getRoleArn() const {
    return m_role_arn;
}
void OAICreateUserPoolClientRequest_AnalyticsConfiguration::setRoleArn(const QString &role_arn) {
    m_role_arn = role_arn;
    m_role_arn_isSet = true;
}

bool OAICreateUserPoolClientRequest_AnalyticsConfiguration::is_role_arn_Set() const{
    return m_role_arn_isSet;
}

bool OAICreateUserPoolClientRequest_AnalyticsConfiguration::is_role_arn_Valid() const{
    return m_role_arn_isValid;
}

QString OAICreateUserPoolClientRequest_AnalyticsConfiguration::getExternalId() const {
    return m_external_id;
}
void OAICreateUserPoolClientRequest_AnalyticsConfiguration::setExternalId(const QString &external_id) {
    m_external_id = external_id;
    m_external_id_isSet = true;
}

bool OAICreateUserPoolClientRequest_AnalyticsConfiguration::is_external_id_Set() const{
    return m_external_id_isSet;
}

bool OAICreateUserPoolClientRequest_AnalyticsConfiguration::is_external_id_Valid() const{
    return m_external_id_isValid;
}

bool OAICreateUserPoolClientRequest_AnalyticsConfiguration::getUserDataShared() const {
    return m_user_data_shared;
}
void OAICreateUserPoolClientRequest_AnalyticsConfiguration::setUserDataShared(const bool &user_data_shared) {
    m_user_data_shared = user_data_shared;
    m_user_data_shared_isSet = true;
}

bool OAICreateUserPoolClientRequest_AnalyticsConfiguration::is_user_data_shared_Set() const{
    return m_user_data_shared_isSet;
}

bool OAICreateUserPoolClientRequest_AnalyticsConfiguration::is_user_data_shared_Valid() const{
    return m_user_data_shared_isValid;
}

bool OAICreateUserPoolClientRequest_AnalyticsConfiguration::isSet() const {
...
bool OAICreateUserPoolClientRequest_AnalyticsConfiguration::isValid() const {
