...
/*
 * OAIUpdateUserPoolDomainRequest_CustomDomainConfig.h
 *
 * 
 */

#ifndef OAIUpdateUserPoolDomainRequest_CustomDomainConfig_H
#define OAIUpdateUserPoolDomainRequest_CustomDomainConfig_H
...
class OAIUpdateUserPoolDomainRequest_CustomDomainConfig : public OAIObject {
public:
    OAIUpdateUserPoolDomainRequest_CustomDomainConfig();
    OAIUpdateUserPoolDomainRequest_CustomDomainConfig(QString json);
    ~OAIUpdateUserPoolDomainRequest_CustomDomainConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateUserPoolDomainRequest_CustomDomainConfig)

#endif // OAIUpdateUserPoolDomainRequest_CustomDomainConfig_H
