...
OAILambdaConfigType_CustomEmailSender::OAILambdaConfigType_CustomEmailSender(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILambdaConfigType_CustomEmailSender::OAILambdaConfigType_CustomEmailSender() {
    this->initializeModel();
}

OAILambdaConfigType_CustomEmailSender::~OAILambdaConfigType_CustomEmailSender() {}

void OAILambdaConfigType_CustomEmailSender::initializeModel() {

    m_lambda_version_isSet = false;
    m_lambda_version_isValid = false;

    m_lambda_arn_isSet = false;
    m_lambda_arn_isValid = false;
}

void OAILambdaConfigType_CustomEmailSender::fromJson(QString jsonString) {
...
void OAILambdaConfigType_CustomEmailSender::fromJsonObject(QJsonObject json) {

    m_lambda_version_isValid = ::OpenAPI::fromJsonValue(m_lambda_version, json[QString("LambdaVersion")]);
    m_lambda_version_isSet = !json[QString("LambdaVersion")].isNull() && m_lambda_version_isValid;
...
QString OAILambdaConfigType_CustomEmailSender::asJson() const {
...
QJsonObject OAILambdaConfigType_CustomEmailSender::asJsonObject() const {
    QJsonObject obj;
    if (m_lambda_version.isSet()) {
        obj.insert(QString("LambdaVersion"), ::OpenAPI::toJsonValue(m_lambda_version));
    }
...
OAICustomEmailSenderLambdaVersionType OAILambdaConfigType_CustomEmailSender::getLambdaVersion() const {
    return m_lambda_version;
}
void OAILambdaConfigType_CustomEmailSender::setLambdaVersion(const OAICustomEmailSenderLambdaVersionType &lambda_version) {
    m_lambda_version = lambda_version;
    m_lambda_version_isSet = true;
}

bool OAILambdaConfigType_CustomEmailSender::is_lambda_version_Set() const{
    return m_lambda_version_isSet;
}

bool OAILambdaConfigType_CustomEmailSender::is_lambda_version_Valid() const{
    return m_lambda_version_isValid;
}

QString OAILambdaConfigType_CustomEmailSender::getLambdaArn() const {
    return m_lambda_arn;
}
void OAILambdaConfigType_CustomEmailSender::setLambdaArn(const QString &lambda_arn) {
    m_lambda_arn = lambda_arn;
    m_lambda_arn_isSet = true;
}

bool OAILambdaConfigType_CustomEmailSender::is_lambda_arn_Set() const{
    return m_lambda_arn_isSet;
}

bool OAILambdaConfigType_CustomEmailSender::is_lambda_arn_Valid() const{
    return m_lambda_arn_isValid;
}

bool OAILambdaConfigType_CustomEmailSender::isSet() const {
...
bool OAILambdaConfigType_CustomEmailSender::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_lambda_version_isValid && m_lambda_arn_isValid && true;
}
