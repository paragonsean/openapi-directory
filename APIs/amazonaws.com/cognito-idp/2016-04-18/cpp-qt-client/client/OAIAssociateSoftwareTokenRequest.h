...
/*
 * OAIAssociateSoftwareTokenRequest.h
 *
 * 
 */

#ifndef OAIAssociateSoftwareTokenRequest_H
#define OAIAssociateSoftwareTokenRequest_H
...
class OAIAssociateSoftwareTokenRequest : public OAIObject {
public:
    OAIAssociateSoftwareTokenRequest();
    OAIAssociateSoftwareTokenRequest(QString json);
    ~OAIAssociateSoftwareTokenRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssociateSoftwareTokenRequest)

#endif // OAIAssociateSoftwareTokenRequest_H
