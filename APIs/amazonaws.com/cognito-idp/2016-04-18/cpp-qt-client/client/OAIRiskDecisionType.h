...
/*
 * OAIRiskDecisionType.h
 *
 * 
 */

#ifndef OAIRiskDecisionType_H
#define OAIRiskDecisionType_H
...
class OAIRiskDecisionType : public OAIEnum {
public:
    OAIRiskDecisionType();
    OAIRiskDecisionType(QString json);
    ~OAIRiskDecisionType() override;
    ...
    enum class eOAIRiskDecisionType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        NORISK, 
        ACCOUNTTAKEOVER, 
        BLOCK
    };
    OAIRiskDecisionType::eOAIRiskDecisionType getValue() const;
    void setValue(const OAIRiskDecisionType::eOAIRiskDecisionType& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIRiskDecisionType)

#endif // OAIRiskDecisionType_H
