...
void OAIUserType::fromJsonObject(QJsonObject json) {
...
QJsonObject OAIUserType::asJsonObject() const {
    QJsonObject obj;
    if (m_username_isSet) {
...
QString OAIUserType::getUsername() const {
    return m_username;
}
void OAIUserType::setUsername(const QString &username) {
    m_username = username;
    m_username_isSet = true;
}

bool OAIUserType::is_username_Set() const{
    return m_username_isSet;
}

bool OAIUserType::is_username_Valid() const{
    return m_username_isValid;
}

QList OAIUserType::getAttributes() const {
    return m_attributes;
}
void OAIUserType::setAttributes(const QList &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAIUserType::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAIUserType::is_attributes_Valid() const{
    return m_attributes_isValid;
}

QDateTime OAIUserType::getUserCreateDate() const {
    return m_user_create_date;
}
void OAIUserType::setUserCreateDate(const QDateTime &user_create_date) {
    m_user_create_date = user_create_date;
    m_user_create_date_isSet = true;
}

bool OAIUserType::is_user_create_date_Set() const{
    return m_user_create_date_isSet;
}

bool OAIUserType::is_user_create_date_Valid() const{
    return m_user_create_date_isValid;
}

QDateTime OAIUserType::getUserLastModifiedDate() const {
    return m_user_last_modified_date;
}
void OAIUserType::setUserLastModifiedDate(const QDateTime &user_last_modified_date) {
    m_user_last_modified_date = user_last_modified_date;
    m_user_last_modified_date_isSet = true;
}

bool OAIUserType::is_user_last_modified_date_Set() const{
    return m_user_last_modified_date_isSet;
}

bool OAIUserType::is_user_last_modified_date_Valid() const{
    return m_user_last_modified_date_isValid;
}

bool OAIUserType::getEnabled() const {
    return m_enabled;
}
void OAIUserType::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAIUserType::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAIUserType::is_enabled_Valid() const{
    return m_enabled_isValid;
}

OAIUserStatusType OAIUserType::getUserStatus() const {
    return m_user_status;
}
void OAIUserType::setUserStatus(const OAIUserStatusType &user_status) {
    m_user_status = user_status;
    m_user_status_isSet = true;
}

bool OAIUserType::is_user_status_Set() const{
    return m_user_status_isSet;
}

bool OAIUserType::is_user_status_Valid() const{
    return m_user_status_isValid;
}

QList OAIUserType::getMfaOptions() const {
    return m_mfa_options;
}
void OAIUserType::setMfaOptions(const QList &mfa_options) {
    m_mfa_options = mfa_options;
    m_mfa_options_isSet = true;
}

bool OAIUserType::is_mfa_options_Set() const{
    return m_mfa_options_isSet;
}

bool OAIUserType::is_mfa_options_Valid() const{
