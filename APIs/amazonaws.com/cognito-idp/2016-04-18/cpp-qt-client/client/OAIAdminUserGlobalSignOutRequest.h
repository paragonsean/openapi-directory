...
/*
 * OAIAdminUserGlobalSignOutRequest.h
 *
 * The request to sign out of all devices, as an administrator.
 */

#ifndef OAIAdminUserGlobalSignOutRequest_H
#define OAIAdminUserGlobalSignOutRequest_H
...
class OAIAdminUserGlobalSignOutRequest : public OAIObject {
public:
    OAIAdminUserGlobalSignOutRequest();
    OAIAdminUserGlobalSignOutRequest(QString json);
    ~OAIAdminUserGlobalSignOutRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdminUserGlobalSignOutRequest)

#endif // OAIAdminUserGlobalSignOutRequest_H
