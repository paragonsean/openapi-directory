...
#include "OAISignUpResponse_CodeDeliveryDetails.h"
#include <QString>
...
namespace OpenAPI {
class OAISignUpResponse_CodeDeliveryDetails;
...
public:
    ...
    void setUserConfirmed(const bool &user_confirmed);
    bool is_user_confirmed_Set() const;
    bool is_user_confirmed_Valid() const;

    OAISignUpResponse_CodeDeliveryDetails getCodeDeliveryDetails() const;
    void setCodeDeliveryDetails(const OAISignUpResponse_CodeDeliveryDetails &code_delivery_details);
    bool is_code_delivery_details_Set() const;
    bool is_code_delivery_details_Valid() const;

    QString getUserSub() const;
    void setUserSub(const QString &user_sub);
    bool is_user_sub_Set() const;
    bool is_user_sub_Valid() const;
...
private:
    ...
    bool m_user_confirmed;
    bool m_user_confirmed_isSet;
    bool m_user_confirmed_isValid;

    OAISignUpResponse_CodeDeliveryDetails m_code_delivery_details;
    bool m_code_delivery_details_isSet;
    bool m_code_delivery_details_isValid;

    QString m_user_sub;
    bool m_user_sub_isSet;
    bool m_user_sub_isValid;
};
