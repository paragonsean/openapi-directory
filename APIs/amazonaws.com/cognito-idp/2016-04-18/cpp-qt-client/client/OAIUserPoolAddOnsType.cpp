...
#include "OAIUserPoolAddOnsType.h"
...
OAIUserPoolAddOnsType::OAIUserPoolAddOnsType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUserPoolAddOnsType::OAIUserPoolAddOnsType() {
    this->initializeModel();
}

OAIUserPoolAddOnsType::~OAIUserPoolAddOnsType() {}

void OAIUserPoolAddOnsType::initializeModel() {

    m_advanced_security_mode_isSet = false;
    m_advanced_security_mode_isValid = false;
}

void OAIUserPoolAddOnsType::fromJson(QString jsonString) {
...
void OAIUserPoolAddOnsType::fromJsonObject(QJsonObject json) {

    m_advanced_security_mode_isValid = ::OpenAPI::fromJsonValue(m_advanced_security_mode, json[QString("AdvancedSecurityMode")]);
    m_advanced_security_mode_isSet = !json[QString("AdvancedSecurityMode")].isNull() && m_advanced_security_mode_isValid;
}

QString OAIUserPoolAddOnsType::asJson() const {
...
QJsonObject OAIUserPoolAddOnsType::asJsonObject() const {
    QJsonObject obj;
    if (m_advanced_security_mode.isSet()) {
        obj.insert(QString("AdvancedSecurityMode"), ::OpenAPI::toJsonValue(m_advanced_security_mode));
    }
    return obj;
}

OAIAdvancedSecurityModeType OAIUserPoolAddOnsType::getAdvancedSecurityMode() const {
    return m_advanced_security_mode;
}
void OAIUserPoolAddOnsType::setAdvancedSecurityMode(const OAIAdvancedSecurityModeType &advanced_security_mode) {
    m_advanced_security_mode = advanced_security_mode;
    m_advanced_security_mode_isSet = true;
}

bool OAIUserPoolAddOnsType::is_advanced_security_mode_Set() const{
    return m_advanced_security_mode_isSet;
}

bool OAIUserPoolAddOnsType::is_advanced_security_mode_Valid() const{
    return m_advanced_security_mode_isValid;
}

bool OAIUserPoolAddOnsType::isSet() const {
...
bool OAIUserPoolAddOnsType::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_advanced_security_mode_isValid && true;
}
