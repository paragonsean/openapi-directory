...
QList OAIListGroupsResponse::getGroups() const {
    return m_groups;
}
void OAIListGroupsResponse::setGroups(const QList &groups) {
    m_groups = groups;
    m_groups_isSet = true;
}
...
QString OAIListGroupsResponse::getNextToken() const {
    return m_next_token;
}
void OAIListGroupsResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListGroupsResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListGroupsResponse::is_next_token_Valid() const{
