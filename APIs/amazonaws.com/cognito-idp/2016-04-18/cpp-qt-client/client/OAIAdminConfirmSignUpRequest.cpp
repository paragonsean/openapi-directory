...
OAIAdminConfirmSignUpRequest::OAIAdminConfirmSignUpRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdminConfirmSignUpRequest::OAIAdminConfirmSignUpRequest() {
    this->initializeModel();
}

OAIAdminConfirmSignUpRequest::~OAIAdminConfirmSignUpRequest() {}

void OAIAdminConfirmSignUpRequest::initializeModel() {
...
void OAIAdminConfirmSignUpRequest::fromJson(QString jsonString) {
...
void OAIAdminConfirmSignUpRequest::fromJsonObject(QJsonObject json) {
...
QString OAIAdminConfirmSignUpRequest::asJson() const {
...
QJsonObject OAIAdminConfirmSignUpRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAdminConfirmSignUpRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIAdminConfirmSignUpRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIAdminConfirmSignUpRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIAdminConfirmSignUpRequest::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

QString OAIAdminConfirmSignUpRequest::getUsername() const {
    return m_username;
}
void OAIAdminConfirmSignUpRequest::setUsername(const QString &username) {
    m_username = username;
    m_username_isSet = true;
}

bool OAIAdminConfirmSignUpRequest::is_username_Set() const{
    return m_username_isSet;
}

bool OAIAdminConfirmSignUpRequest::is_username_Valid() const{
    return m_username_isValid;
}

QMap OAIAdminConfirmSignUpRequest::getClientMetadata() const {
    return m_client_metadata;
}
void OAIAdminConfirmSignUpRequest::setClientMetadata(const QMap &client_metadata) {
    m_client_metadata = client_metadata;
    m_client_metadata_isSet = true;
}

bool OAIAdminConfirmSignUpRequest::is_client_metadata_Set() const{
    return m_client_metadata_isSet;
}

bool OAIAdminConfirmSignUpRequest::is_client_metadata_Valid() const{
    return m_client_metadata_isValid;
}

bool OAIAdminConfirmSignUpRequest::isSet() const {
...
bool OAIAdminConfirmSignUpRequest::isValid() const {
