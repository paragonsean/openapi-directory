...
/*
 * OAIAdminLinkProviderForUserRequest_SourceUser.h
 *
 * 
 */

#ifndef OAIAdminLinkProviderForUserRequest_SourceUser_H
#define OAIAdminLinkProviderForUserRequest_SourceUser_H
...
class OAIAdminLinkProviderForUserRequest_SourceUser : public OAIObject {
public:
    OAIAdminLinkProviderForUserRequest_SourceUser();
    OAIAdminLinkProviderForUserRequest_SourceUser(QString json);
    ~OAIAdminLinkProviderForUserRequest_SourceUser() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdminLinkProviderForUserRequest_SourceUser)

#endif // OAIAdminLinkProviderForUserRequest_SourceUser_H
