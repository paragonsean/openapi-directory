...
OAIAccountTakeoverActionsType_MediumAction::OAIAccountTakeoverActionsType_MediumAction(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAccountTakeoverActionsType_MediumAction::OAIAccountTakeoverActionsType_MediumAction() {
    this->initializeModel();
}

OAIAccountTakeoverActionsType_MediumAction::~OAIAccountTakeoverActionsType_MediumAction() {}

void OAIAccountTakeoverActionsType_MediumAction::initializeModel() {
...
void OAIAccountTakeoverActionsType_MediumAction::fromJson(QString jsonString) {
...
void OAIAccountTakeoverActionsType_MediumAction::fromJsonObject(QJsonObject json) {
...
QString OAIAccountTakeoverActionsType_MediumAction::asJson() const {
...
QJsonObject OAIAccountTakeoverActionsType_MediumAction::asJsonObject() const {
    QJsonObject obj;
    if (m_notify_isSet) {
...
bool OAIAccountTakeoverActionsType_MediumAction::getNotify() const {
    return m_notify;
}
void OAIAccountTakeoverActionsType_MediumAction::setNotify(const bool &notify) {
    m_notify = notify;
    m_notify_isSet = true;
}

bool OAIAccountTakeoverActionsType_MediumAction::is_notify_Set() const{
    return m_notify_isSet;
}

bool OAIAccountTakeoverActionsType_MediumAction::is_notify_Valid() const{
    return m_notify_isValid;
}

OAIAccountTakeoverEventActionType OAIAccountTakeoverActionsType_MediumAction::getEventAction() const {
    return m_event_action;
}
void OAIAccountTakeoverActionsType_MediumAction::setEventAction(const OAIAccountTakeoverEventActionType &event_action) {
    m_event_action = event_action;
    m_event_action_isSet = true;
}

bool OAIAccountTakeoverActionsType_MediumAction::is_event_action_Set() const{
    return m_event_action_isSet;
}

bool OAIAccountTakeoverActionsType_MediumAction::is_event_action_Valid() const{
    return m_event_action_isValid;
}

bool OAIAccountTakeoverActionsType_MediumAction::isSet() const {
...
bool OAIAccountTakeoverActionsType_MediumAction::isValid() const {
