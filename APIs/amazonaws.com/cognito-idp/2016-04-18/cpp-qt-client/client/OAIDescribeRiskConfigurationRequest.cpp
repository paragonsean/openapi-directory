...
OAIDescribeRiskConfigurationRequest::OAIDescribeRiskConfigurationRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeRiskConfigurationRequest::OAIDescribeRiskConfigurationRequest() {
    this->initializeModel();
}

OAIDescribeRiskConfigurationRequest::~OAIDescribeRiskConfigurationRequest() {}

void OAIDescribeRiskConfigurationRequest::initializeModel() {
...
void OAIDescribeRiskConfigurationRequest::fromJson(QString jsonString) {
...
void OAIDescribeRiskConfigurationRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeRiskConfigurationRequest::asJson() const {
...
QJsonObject OAIDescribeRiskConfigurationRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeRiskConfigurationRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIDescribeRiskConfigurationRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIDescribeRiskConfigurationRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIDescribeRiskConfigurationRequest::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

QString OAIDescribeRiskConfigurationRequest::getClientId() const {
    return m_client_id;
}
void OAIDescribeRiskConfigurationRequest::setClientId(const QString &client_id) {
    m_client_id = client_id;
    m_client_id_isSet = true;
}

bool OAIDescribeRiskConfigurationRequest::is_client_id_Set() const{
    return m_client_id_isSet;
}

bool OAIDescribeRiskConfigurationRequest::is_client_id_Valid() const{
    return m_client_id_isValid;
}

bool OAIDescribeRiskConfigurationRequest::isSet() const {
...
bool OAIDescribeRiskConfigurationRequest::isValid() const {
