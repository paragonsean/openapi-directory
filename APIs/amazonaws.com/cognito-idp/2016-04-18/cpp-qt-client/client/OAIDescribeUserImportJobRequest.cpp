...
OAIDescribeUserImportJobRequest::OAIDescribeUserImportJobRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeUserImportJobRequest::OAIDescribeUserImportJobRequest() {
    this->initializeModel();
}

OAIDescribeUserImportJobRequest::~OAIDescribeUserImportJobRequest() {}

void OAIDescribeUserImportJobRequest::initializeModel() {
...
void OAIDescribeUserImportJobRequest::fromJson(QString jsonString) {
...
void OAIDescribeUserImportJobRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeUserImportJobRequest::asJson() const {
...
QJsonObject OAIDescribeUserImportJobRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeUserImportJobRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIDescribeUserImportJobRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIDescribeUserImportJobRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIDescribeUserImportJobRequest::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

QString OAIDescribeUserImportJobRequest::getJobId() const {
    return m_job_id;
}
void OAIDescribeUserImportJobRequest::setJobId(const QString &job_id) {
    m_job_id = job_id;
    m_job_id_isSet = true;
}

bool OAIDescribeUserImportJobRequest::is_job_id_Set() const{
    return m_job_id_isSet;
}

bool OAIDescribeUserImportJobRequest::is_job_id_Valid() const{
    return m_job_id_isValid;
}

bool OAIDescribeUserImportJobRequest::isSet() const {
...
bool OAIDescribeUserImportJobRequest::isValid() const {
