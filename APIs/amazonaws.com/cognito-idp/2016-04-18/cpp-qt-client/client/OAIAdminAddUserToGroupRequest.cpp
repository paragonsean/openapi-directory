...
OAIAdminAddUserToGroupRequest::OAIAdminAddUserToGroupRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdminAddUserToGroupRequest::OAIAdminAddUserToGroupRequest() {
    this->initializeModel();
}

OAIAdminAddUserToGroupRequest::~OAIAdminAddUserToGroupRequest() {}

void OAIAdminAddUserToGroupRequest::initializeModel() {
...
void OAIAdminAddUserToGroupRequest::fromJson(QString jsonString) {
...
void OAIAdminAddUserToGroupRequest::fromJsonObject(QJsonObject json) {
...
QString OAIAdminAddUserToGroupRequest::asJson() const {
...
QJsonObject OAIAdminAddUserToGroupRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAdminAddUserToGroupRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIAdminAddUserToGroupRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIAdminAddUserToGroupRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIAdminAddUserToGroupRequest::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

QString OAIAdminAddUserToGroupRequest::getUsername() const {
    return m_username;
}
void OAIAdminAddUserToGroupRequest::setUsername(const QString &username) {
    m_username = username;
    m_username_isSet = true;
}

bool OAIAdminAddUserToGroupRequest::is_username_Set() const{
    return m_username_isSet;
}

bool OAIAdminAddUserToGroupRequest::is_username_Valid() const{
    return m_username_isValid;
}

QString OAIAdminAddUserToGroupRequest::getGroupName() const {
    return m_group_name;
}
void OAIAdminAddUserToGroupRequest::setGroupName(const QString &group_name) {
    m_group_name = group_name;
    m_group_name_isSet = true;
}

bool OAIAdminAddUserToGroupRequest::is_group_name_Set() const{
    return m_group_name_isSet;
}

bool OAIAdminAddUserToGroupRequest::is_group_name_Valid() const{
    return m_group_name_isValid;
}

bool OAIAdminAddUserToGroupRequest::isSet() const {
...
bool OAIAdminAddUserToGroupRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_user_pool_id_isValid && m_username_isValid && m_group_name_isValid && true;
}
