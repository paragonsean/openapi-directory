...
/*
 * OAIAccountTakeoverRiskConfigurationType_NotifyConfiguration.h
 *
 * 
 */

#ifndef OAIAccountTakeoverRiskConfigurationType_NotifyConfiguration_H
#define OAIAccountTakeoverRiskConfigurationType_NotifyConfiguration_H

#include <QJsonObject>

#include "OAINotifyConfigurationType_BlockEmail.h"
#include "OAINotifyConfigurationType_MfaEmail.h"
#include "OAINotifyConfigurationType_NoActionEmail.h"
#include <QString>
...
namespace OpenAPI {
class OAINotifyConfigurationType_BlockEmail;
class OAINotifyConfigurationType_NoActionEmail;
class OAINotifyConfigurationType_MfaEmail;

class OAIAccountTakeoverRiskConfigurationType_NotifyConfiguration : public OAIObject {
public:
    OAIAccountTakeoverRiskConfigurationType_NotifyConfiguration();
    OAIAccountTakeoverRiskConfigurationType_NotifyConfiguration(QString json);
    ~OAIAccountTakeoverRiskConfigurationType_NotifyConfiguration() override;
    ...
    OAINotifyConfigurationType_BlockEmail getBlockEmail() const;
    void setBlockEmail(const OAINotifyConfigurationType_BlockEmail &block_email);
    bool is_block_email_Set() const;
    bool is_block_email_Valid() const;

    OAINotifyConfigurationType_NoActionEmail getNoActionEmail() const;
    void setNoActionEmail(const OAINotifyConfigurationType_NoActionEmail &no_action_email);
    bool is_no_action_email_Set() const;
    bool is_no_action_email_Valid() const;

    OAINotifyConfigurationType_MfaEmail getMfaEmail() const;
    void setMfaEmail(const OAINotifyConfigurationType_MfaEmail &mfa_email);
    bool is_mfa_email_Set() const;
    bool is_mfa_email_Valid() const;
...
private:
    ...
    OAINotifyConfigurationType_BlockEmail m_block_email;
    bool m_block_email_isSet;
    bool m_block_email_isValid;

    OAINotifyConfigurationType_NoActionEmail m_no_action_email;
    bool m_no_action_email_isSet;
    bool m_no_action_email_isValid;

    OAINotifyConfigurationType_MfaEmail m_mfa_email;
    bool m_mfa_email_isSet;
    bool m_mfa_email_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIAccountTakeoverRiskConfigurationType_NotifyConfiguration)

#endif // OAIAccountTakeoverRiskConfigurationType_NotifyConfiguration_H
