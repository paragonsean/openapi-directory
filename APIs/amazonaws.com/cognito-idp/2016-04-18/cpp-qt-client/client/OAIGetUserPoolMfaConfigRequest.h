...
/*
 * OAIGetUserPoolMfaConfigRequest.h
 *
 * 
 */

#ifndef OAIGetUserPoolMfaConfigRequest_H
#define OAIGetUserPoolMfaConfigRequest_H
...
class OAIGetUserPoolMfaConfigRequest : public OAIObject {
public:
    OAIGetUserPoolMfaConfigRequest();
    OAIGetUserPoolMfaConfigRequest(QString json);
    ~OAIGetUserPoolMfaConfigRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetUserPoolMfaConfigRequest)

#endif // OAIGetUserPoolMfaConfigRequest_H
