...
/*
 * OAICustomDomainConfigType.h
 *
 * The configuration for a custom domain that hosts the sign-up and sign-in webpages for your application.
 */

#ifndef OAICustomDomainConfigType_H
#define OAICustomDomainConfigType_H
...
class OAICustomDomainConfigType : public OAIObject {
public:
    OAICustomDomainConfigType();
    OAICustomDomainConfigType(QString json);
    ~OAICustomDomainConfigType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomDomainConfigType)

#endif // OAICustomDomainConfigType_H
