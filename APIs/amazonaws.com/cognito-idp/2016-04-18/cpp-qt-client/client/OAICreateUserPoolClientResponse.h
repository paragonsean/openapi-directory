...
/*
 * OAICreateUserPoolClientResponse.h
 *
 * Represents the response from the server to create a user pool client.
 */

#ifndef OAICreateUserPoolClientResponse_H
#define OAICreateUserPoolClientResponse_H
...
namespace OpenAPI {
class OAICreateUserPoolClientResponse_UserPoolClient;

class OAICreateUserPoolClientResponse : public OAIObject {
public:
    OAICreateUserPoolClientResponse();
    OAICreateUserPoolClientResponse(QString json);
    ~OAICreateUserPoolClientResponse() override;
    ...
    OAICreateUserPoolClientResponse_UserPoolClient getUserPoolClient() const;
    void setUserPoolClient(const OAICreateUserPoolClientResponse_UserPoolClient &user_pool_client);
...
private:
    ...
    OAICreateUserPoolClientResponse_UserPoolClient m_user_pool_client;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateUserPoolClientResponse)

#endif // OAICreateUserPoolClientResponse_H
