...
OAIDescribeUserPoolClientRequest::OAIDescribeUserPoolClientRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeUserPoolClientRequest::OAIDescribeUserPoolClientRequest() {
    this->initializeModel();
}

OAIDescribeUserPoolClientRequest::~OAIDescribeUserPoolClientRequest() {}

void OAIDescribeUserPoolClientRequest::initializeModel() {
...
void OAIDescribeUserPoolClientRequest::fromJson(QString jsonString) {
...
void OAIDescribeUserPoolClientRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeUserPoolClientRequest::asJson() const {
...
QJsonObject OAIDescribeUserPoolClientRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeUserPoolClientRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIDescribeUserPoolClientRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIDescribeUserPoolClientRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIDescribeUserPoolClientRequest::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

QString OAIDescribeUserPoolClientRequest::getClientId() const {
    return m_client_id;
}
void OAIDescribeUserPoolClientRequest::setClientId(const QString &client_id) {
    m_client_id = client_id;
    m_client_id_isSet = true;
}

bool OAIDescribeUserPoolClientRequest::is_client_id_Set() const{
    return m_client_id_isSet;
}

bool OAIDescribeUserPoolClientRequest::is_client_id_Valid() const{
    return m_client_id_isValid;
}

bool OAIDescribeUserPoolClientRequest::isSet() const {
...
bool OAIDescribeUserPoolClientRequest::isValid() const {
