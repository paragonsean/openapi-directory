...
OAIAdminSetUserSettingsRequest::OAIAdminSetUserSettingsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdminSetUserSettingsRequest::OAIAdminSetUserSettingsRequest() {
    this->initializeModel();
}

OAIAdminSetUserSettingsRequest::~OAIAdminSetUserSettingsRequest() {}

void OAIAdminSetUserSettingsRequest::initializeModel() {
...
void OAIAdminSetUserSettingsRequest::fromJson(QString jsonString) {
...
void OAIAdminSetUserSettingsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIAdminSetUserSettingsRequest::asJson() const {
...
QJsonObject OAIAdminSetUserSettingsRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAdminSetUserSettingsRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIAdminSetUserSettingsRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIAdminSetUserSettingsRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIAdminSetUserSettingsRequest::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

QString OAIAdminSetUserSettingsRequest::getUsername() const {
    return m_username;
}
void OAIAdminSetUserSettingsRequest::setUsername(const QString &username) {
    m_username = username;
    m_username_isSet = true;
}

bool OAIAdminSetUserSettingsRequest::is_username_Set() const{
    return m_username_isSet;
}

bool OAIAdminSetUserSettingsRequest::is_username_Valid() const{
    return m_username_isValid;
}

QList OAIAdminSetUserSettingsRequest::getMfaOptions() const {
    return m_mfa_options;
}
void OAIAdminSetUserSettingsRequest::setMfaOptions(const QList &mfa_options) {
    m_mfa_options = mfa_options;
    m_mfa_options_isSet = true;
}

bool OAIAdminSetUserSettingsRequest::is_mfa_options_Set() const{
    return m_mfa_options_isSet;
}

bool OAIAdminSetUserSettingsRequest::is_mfa_options_Valid() const{
    return m_mfa_options_isValid;
}

bool OAIAdminSetUserSettingsRequest::isSet() const {
...
bool OAIAdminSetUserSettingsRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_user_pool_id_isValid && m_username_isValid && m_mfa_options_isValid && true;
}
