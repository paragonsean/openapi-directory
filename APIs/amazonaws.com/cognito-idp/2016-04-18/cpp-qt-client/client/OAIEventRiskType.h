...
#ifndef OAIEventRiskType_H
#define OAIEventRiskType_H

#include <QJsonObject>

#include "OAIRiskDecisionType.h"
#include "OAIRiskLevelType.h"
...
class OAIEventRiskType : public OAIObject {
public:
    OAIEventRiskType();
    OAIEventRiskType(QString json);
    ~OAIEventRiskType() override;
    ...
    OAIRiskDecisionType getRiskDecision() const;
    void setRiskDecision(const OAIRiskDecisionType &risk_decision);
    bool is_risk_decision_Set() const;
    bool is_risk_decision_Valid() const;

    OAIRiskLevelType getRiskLevel() const;
    void setRiskLevel(const OAIRiskLevelType &risk_level);
    bool is_risk_level_Set() const;
    bool is_risk_level_Valid() const;

    bool getCompromisedCredentialsDetected() const;
    void setCompromisedCredentialsDetected(const bool &compromised_credentials_detected);
    bool is_compromised_credentials_detected_Set() const;
    bool is_compromised_credentials_detected_Valid() const;
...
private:
    ...
    OAIRiskDecisionType m_risk_decision;
    bool m_risk_decision_isSet;
    bool m_risk_decision_isValid;

    OAIRiskLevelType m_risk_level;
    bool m_risk_level_isSet;
    bool m_risk_level_isValid;

    bool m_compromised_credentials_detected;
    bool m_compromised_credentials_detected_isSet;
    bool m_compromised_credentials_detected_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIEventRiskType)

#endif // OAIEventRiskType_H
