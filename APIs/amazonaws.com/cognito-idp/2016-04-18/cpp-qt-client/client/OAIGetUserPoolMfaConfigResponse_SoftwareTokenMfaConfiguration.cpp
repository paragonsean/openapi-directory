...
#include "OAIGetUserPoolMfaConfigResponse_SoftwareTokenMfaConfiguration.h"
...
OAIGetUserPoolMfaConfigResponse_SoftwareTokenMfaConfiguration::OAIGetUserPoolMfaConfigResponse_SoftwareTokenMfaConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetUserPoolMfaConfigResponse_SoftwareTokenMfaConfiguration::OAIGetUserPoolMfaConfigResponse_SoftwareTokenMfaConfiguration() {
    this->initializeModel();
}

OAIGetUserPoolMfaConfigResponse_SoftwareTokenMfaConfiguration::~OAIGetUserPoolMfaConfigResponse_SoftwareTokenMfaConfiguration() {}

void OAIGetUserPoolMfaConfigResponse_SoftwareTokenMfaConfiguration::initializeModel() {

    m_enabled_isSet = false;
    m_enabled_isValid = false;
}

void OAIGetUserPoolMfaConfigResponse_SoftwareTokenMfaConfiguration::fromJson(QString jsonString) {
...
void OAIGetUserPoolMfaConfigResponse_SoftwareTokenMfaConfiguration::fromJsonObject(QJsonObject json) {

    m_enabled_isValid = ::OpenAPI::fromJsonValue(m_enabled, json[QString("Enabled")]);
    m_enabled_isSet = !json[QString("Enabled")].isNull() && m_enabled_isValid;
}

QString OAIGetUserPoolMfaConfigResponse_SoftwareTokenMfaConfiguration::asJson() const {
...
QJsonObject OAIGetUserPoolMfaConfigResponse_SoftwareTokenMfaConfiguration::asJsonObject() const {
    QJsonObject obj;
    if (m_enabled_isSet) {
...
bool OAIGetUserPoolMfaConfigResponse_SoftwareTokenMfaConfiguration::getEnabled() const {
    return m_enabled;
}
void OAIGetUserPoolMfaConfigResponse_SoftwareTokenMfaConfiguration::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAIGetUserPoolMfaConfigResponse_SoftwareTokenMfaConfiguration::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAIGetUserPoolMfaConfigResponse_SoftwareTokenMfaConfiguration::is_enabled_Valid() const{
    return m_enabled_isValid;
}

bool OAIGetUserPoolMfaConfigResponse_SoftwareTokenMfaConfiguration::isSet() const {
...
bool OAIGetUserPoolMfaConfigResponse_SoftwareTokenMfaConfiguration::isValid() const {
