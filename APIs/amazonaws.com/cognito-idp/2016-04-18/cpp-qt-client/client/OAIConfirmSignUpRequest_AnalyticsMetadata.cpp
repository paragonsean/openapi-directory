...
#include "OAIConfirmSignUpRequest_AnalyticsMetadata.h"
...
OAIConfirmSignUpRequest_AnalyticsMetadata::OAIConfirmSignUpRequest_AnalyticsMetadata(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIConfirmSignUpRequest_AnalyticsMetadata::OAIConfirmSignUpRequest_AnalyticsMetadata() {
    this->initializeModel();
}

OAIConfirmSignUpRequest_AnalyticsMetadata::~OAIConfirmSignUpRequest_AnalyticsMetadata() {}

void OAIConfirmSignUpRequest_AnalyticsMetadata::initializeModel() {

    m_analytics_endpoint_id_isSet = false;
    m_analytics_endpoint_id_isValid = false;
}

void OAIConfirmSignUpRequest_AnalyticsMetadata::fromJson(QString jsonString) {
...
void OAIConfirmSignUpRequest_AnalyticsMetadata::fromJsonObject(QJsonObject json) {
...
QString OAIConfirmSignUpRequest_AnalyticsMetadata::asJson() const {
...
QJsonObject OAIConfirmSignUpRequest_AnalyticsMetadata::asJsonObject() const {
    QJsonObject obj;
...
QString OAIConfirmSignUpRequest_AnalyticsMetadata::getAnalyticsEndpointId() const {
    return m_analytics_endpoint_id;
}
void OAIConfirmSignUpRequest_AnalyticsMetadata::setAnalyticsEndpointId(const QString &analytics_endpoint_id) {
    m_analytics_endpoint_id = analytics_endpoint_id;
    m_analytics_endpoint_id_isSet = true;
}

bool OAIConfirmSignUpRequest_AnalyticsMetadata::is_analytics_endpoint_id_Set() const{
    return m_analytics_endpoint_id_isSet;
}

bool OAIConfirmSignUpRequest_AnalyticsMetadata::is_analytics_endpoint_id_Valid() const{
    return m_analytics_endpoint_id_isValid;
}

bool OAIConfirmSignUpRequest_AnalyticsMetadata::isSet() const {
...
bool OAIConfirmSignUpRequest_AnalyticsMetadata::isValid() const {
