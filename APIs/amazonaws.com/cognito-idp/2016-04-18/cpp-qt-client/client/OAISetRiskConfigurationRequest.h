...
/*
 * OAISetRiskConfigurationRequest.h
 *
 * 
 */

#ifndef OAISetRiskConfigurationRequest_H
#define OAISetRiskConfigurationRequest_H
...
namespace OpenAPI {
class OAISetRiskConfigurationRequest_CompromisedCredentialsRiskConfiguration;
class OAISetRiskConfigurationRequest_AccountTakeoverRiskConfiguration;
class OAISetRiskConfigurationRequest_RiskExceptionConfiguration;

class OAISetRiskConfigurationRequest : public OAIObject {
public:
    OAISetRiskConfigurationRequest();
    OAISetRiskConfigurationRequest(QString json);
    ~OAISetRiskConfigurationRequest() override;
    ...
    OAISetRiskConfigurationRequest_CompromisedCredentialsRiskConfiguration getCompromisedCredentialsRiskConfiguration() const;
    void setCompromisedCredentialsRiskConfiguration(const OAISetRiskConfigurationRequest_CompromisedCredentialsRiskConfiguration &compromised_credentials_risk_configuration);
    ...
    OAISetRiskConfigurationRequest_AccountTakeoverRiskConfiguration getAccountTakeoverRiskConfiguration() const;
    void setAccountTakeoverRiskConfiguration(const OAISetRiskConfigurationRequest_AccountTakeoverRiskConfiguration &account_takeover_risk_configuration);
...
private:
    ...
    OAISetRiskConfigurationRequest_CompromisedCredentialsRiskConfiguration m_compromised_credentials_risk_configuration;
    bool m_compromised_credentials_risk_configuration_isSet;
    bool m_compromised_credentials_risk_configuration_isValid;

    OAISetRiskConfigurationRequest_AccountTakeoverRiskConfiguration m_account_takeover_risk_configuration;
...
Q_DECLARE_METATYPE(OpenAPI::OAISetRiskConfigurationRequest)

#endif // OAISetRiskConfigurationRequest_H
