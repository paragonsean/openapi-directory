...
#include "OAIAdminLinkProviderForUserRequest_SourceUser.h"
...
OAIAdminLinkProviderForUserRequest_SourceUser::OAIAdminLinkProviderForUserRequest_SourceUser(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdminLinkProviderForUserRequest_SourceUser::OAIAdminLinkProviderForUserRequest_SourceUser() {
    this->initializeModel();
}

OAIAdminLinkProviderForUserRequest_SourceUser::~OAIAdminLinkProviderForUserRequest_SourceUser() {}

void OAIAdminLinkProviderForUserRequest_SourceUser::initializeModel() {
...
void OAIAdminLinkProviderForUserRequest_SourceUser::fromJson(QString jsonString) {
...
void OAIAdminLinkProviderForUserRequest_SourceUser::fromJsonObject(QJsonObject json) {
...
QString OAIAdminLinkProviderForUserRequest_SourceUser::asJson() const {
...
QJsonObject OAIAdminLinkProviderForUserRequest_SourceUser::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAdminLinkProviderForUserRequest_SourceUser::getProviderName() const {
    return m_provider_name;
}
void OAIAdminLinkProviderForUserRequest_SourceUser::setProviderName(const QString &provider_name) {
    m_provider_name = provider_name;
    m_provider_name_isSet = true;
}

bool OAIAdminLinkProviderForUserRequest_SourceUser::is_provider_name_Set() const{
    return m_provider_name_isSet;
}

bool OAIAdminLinkProviderForUserRequest_SourceUser::is_provider_name_Valid() const{
    return m_provider_name_isValid;
}

QString OAIAdminLinkProviderForUserRequest_SourceUser::getProviderAttributeName() const {
    return m_provider_attribute_name;
}
void OAIAdminLinkProviderForUserRequest_SourceUser::setProviderAttributeName(const QString &provider_attribute_name) {
    m_provider_attribute_name = provider_attribute_name;
    m_provider_attribute_name_isSet = true;
}

bool OAIAdminLinkProviderForUserRequest_SourceUser::is_provider_attribute_name_Set() const{
    return m_provider_attribute_name_isSet;
}

bool OAIAdminLinkProviderForUserRequest_SourceUser::is_provider_attribute_name_Valid() const{
    return m_provider_attribute_name_isValid;
}

QString OAIAdminLinkProviderForUserRequest_SourceUser::getProviderAttributeValue() const {
    return m_provider_attribute_value;
}
void OAIAdminLinkProviderForUserRequest_SourceUser::setProviderAttributeValue(const QString &provider_attribute_value) {
    m_provider_attribute_value = provider_attribute_value;
    m_provider_attribute_value_isSet = true;
}

bool OAIAdminLinkProviderForUserRequest_SourceUser::is_provider_attribute_value_Set() const{
    return m_provider_attribute_value_isSet;
}

bool OAIAdminLinkProviderForUserRequest_SourceUser::is_provider_attribute_value_Valid() const{
    return m_provider_attribute_value_isValid;
}

bool OAIAdminLinkProviderForUserRequest_SourceUser::isSet() const {
...
bool OAIAdminLinkProviderForUserRequest_SourceUser::isValid() const {
