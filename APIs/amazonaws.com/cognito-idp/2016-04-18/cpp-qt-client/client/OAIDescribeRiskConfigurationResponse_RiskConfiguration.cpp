...
OAIDescribeRiskConfigurationResponse_RiskConfiguration::OAIDescribeRiskConfigurationResponse_RiskConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeRiskConfigurationResponse_RiskConfiguration::OAIDescribeRiskConfigurationResponse_RiskConfiguration() {
    this->initializeModel();
}

OAIDescribeRiskConfigurationResponse_RiskConfiguration::~OAIDescribeRiskConfigurationResponse_RiskConfiguration() {}

void OAIDescribeRiskConfigurationResponse_RiskConfiguration::initializeModel() {
...
void OAIDescribeRiskConfigurationResponse_RiskConfiguration::fromJson(QString jsonString) {
...
void OAIDescribeRiskConfigurationResponse_RiskConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeRiskConfigurationResponse_RiskConfiguration::asJson() const {
...
QJsonObject OAIDescribeRiskConfigurationResponse_RiskConfiguration::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeRiskConfigurationResponse_RiskConfiguration::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIDescribeRiskConfigurationResponse_RiskConfiguration::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIDescribeRiskConfigurationResponse_RiskConfiguration::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIDescribeRiskConfigurationResponse_RiskConfiguration::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

QString OAIDescribeRiskConfigurationResponse_RiskConfiguration::getClientId() const {
    return m_client_id;
}
void OAIDescribeRiskConfigurationResponse_RiskConfiguration::setClientId(const QString &client_id) {
    m_client_id = client_id;
    m_client_id_isSet = true;
}

bool OAIDescribeRiskConfigurationResponse_RiskConfiguration::is_client_id_Set() const{
    return m_client_id_isSet;
}

bool OAIDescribeRiskConfigurationResponse_RiskConfiguration::is_client_id_Valid() const{
    return m_client_id_isValid;
}

OAIRiskConfigurationType_CompromisedCredentialsRiskConfiguration OAIDescribeRiskConfigurationResponse_RiskConfiguration::getCompromisedCredentialsRiskConfiguration() const {
    return m_compromised_credentials_risk_configuration;
}
void OAIDescribeRiskConfigurationResponse_RiskConfiguration::setCompromisedCredentialsRiskConfiguration(const OAIRiskConfigurationType_CompromisedCredentialsRiskConfiguration &compromised_credentials_risk_configuration) {
...
bool OAIDescribeRiskConfigurationResponse_RiskConfiguration::is_compromised_credentials_risk_configuration_Set() const{
    return m_compromised_credentials_risk_configuration_isSet;
}

bool OAIDescribeRiskConfigurationResponse_RiskConfiguration::is_compromised_credentials_risk_configuration_Valid() const{
    return m_compromised_credentials_risk_configuration_isValid;
}

OAIRiskConfigurationType_AccountTakeoverRiskConfiguration OAIDescribeRiskConfigurationResponse_RiskConfiguration::getAccountTakeoverRiskConfiguration() const {
    return m_account_takeover_risk_configuration;
}
void OAIDescribeRiskConfigurationResponse_RiskConfiguration::setAccountTakeoverRiskConfiguration(const OAIRiskConfigurationType_AccountTakeoverRiskConfiguration &account_takeover_risk_configuration) {
...
bool OAIDescribeRiskConfigurationResponse_RiskConfiguration::is_account_takeover_risk_configuration_Set() const{
    return m_account_takeover_risk_configuration_isSet;
}

bool OAIDescribeRiskConfigurationResponse_RiskConfiguration::is_account_takeover_risk_configuration_Valid() const{
    return m_account_takeover_risk_configuration_isValid;
}

OAISetRiskConfigurationRequest_RiskExceptionConfiguration OAIDescribeRiskConfigurationResponse_RiskConfiguration::getRiskExceptionConfiguration() const {
    return m_risk_exception_configuration;
}
void OAIDescribeRiskConfigurationResponse_RiskConfiguration::setRiskExceptionConfiguration(const OAISetRiskConfigurationRequest_RiskExceptionConfiguration &risk_exception_configuration) {
    m_risk_exception_configuration = risk_exception_configuration;
    m_risk_exception_configuration_isSet = true;
}

bool OAIDescribeRiskConfigurationResponse_RiskConfiguration::is_risk_exception_configuration_Set() const{
    return m_risk_exception_configuration_isSet;
}

bool OAIDescribeRiskConfigurationResponse_RiskConfiguration::is_risk_exception_configuration_Valid() const{
    return m_risk_exception_configuration_isValid;
}

QDateTime OAIDescribeRiskConfigurationResponse_RiskConfiguration::getLastModifiedDate() const {
    return m_last_modified_date;
}
void OAIDescribeRiskConfigurationResponse_RiskConfiguration::setLastModifiedDate(const QDateTime &last_modified_date) {
    m_last_modified_date = last_modified_date;
    m_last_modified_date_isSet = true;
}

bool OAIDescribeRiskConfigurationResponse_RiskConfiguration::is_last_modified_date_Set() const{
    return m_last_modified_date_isSet;
}

bool OAIDescribeRiskConfigurationResponse_RiskConfiguration::is_last_modified_date_Valid() const{
    return m_last_modified_date_isValid;
}

bool OAIDescribeRiskConfigurationResponse_RiskConfiguration::isSet() const {
...
bool OAIDescribeRiskConfigurationResponse_RiskConfiguration::isValid() const {
