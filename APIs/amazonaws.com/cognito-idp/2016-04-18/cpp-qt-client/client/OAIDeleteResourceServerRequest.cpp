...
OAIDeleteResourceServerRequest::OAIDeleteResourceServerRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteResourceServerRequest::OAIDeleteResourceServerRequest() {
    this->initializeModel();
}

OAIDeleteResourceServerRequest::~OAIDeleteResourceServerRequest() {}

void OAIDeleteResourceServerRequest::initializeModel() {
...
void OAIDeleteResourceServerRequest::fromJson(QString jsonString) {
...
void OAIDeleteResourceServerRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteResourceServerRequest::asJson() const {
...
QJsonObject OAIDeleteResourceServerRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteResourceServerRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIDeleteResourceServerRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIDeleteResourceServerRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIDeleteResourceServerRequest::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

QString OAIDeleteResourceServerRequest::getIdentifier() const {
    return m_identifier;
}
void OAIDeleteResourceServerRequest::setIdentifier(const QString &identifier) {
    m_identifier = identifier;
    m_identifier_isSet = true;
}

bool OAIDeleteResourceServerRequest::is_identifier_Set() const{
    return m_identifier_isSet;
}

bool OAIDeleteResourceServerRequest::is_identifier_Valid() const{
    return m_identifier_isValid;
}

bool OAIDeleteResourceServerRequest::isSet() const {
...
bool OAIDeleteResourceServerRequest::isValid() const {
