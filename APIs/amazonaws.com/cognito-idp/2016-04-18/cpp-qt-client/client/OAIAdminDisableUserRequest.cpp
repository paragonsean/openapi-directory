...
OAIAdminDisableUserRequest::OAIAdminDisableUserRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdminDisableUserRequest::OAIAdminDisableUserRequest() {
    this->initializeModel();
}

OAIAdminDisableUserRequest::~OAIAdminDisableUserRequest() {}

void OAIAdminDisableUserRequest::initializeModel() {
...
void OAIAdminDisableUserRequest::fromJson(QString jsonString) {
...
void OAIAdminDisableUserRequest::fromJsonObject(QJsonObject json) {
...
QString OAIAdminDisableUserRequest::asJson() const {
...
QJsonObject OAIAdminDisableUserRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAdminDisableUserRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIAdminDisableUserRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIAdminDisableUserRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIAdminDisableUserRequest::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

QString OAIAdminDisableUserRequest::getUsername() const {
    return m_username;
}
void OAIAdminDisableUserRequest::setUsername(const QString &username) {
    m_username = username;
    m_username_isSet = true;
}

bool OAIAdminDisableUserRequest::is_username_Set() const{
    return m_username_isSet;
}

bool OAIAdminDisableUserRequest::is_username_Valid() const{
    return m_username_isValid;
}

bool OAIAdminDisableUserRequest::isSet() const {
...
bool OAIAdminDisableUserRequest::isValid() const {
