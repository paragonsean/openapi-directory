...
QString OAIGetUserResponse::getUsername() const {
    return m_username;
}
void OAIGetUserResponse::setUsername(const QString &username) {
    m_username = username;
    m_username_isSet = true;
}

bool OAIGetUserResponse::is_username_Set() const{
    return m_username_isSet;
}

bool OAIGetUserResponse::is_username_Valid() const{
    return m_username_isValid;
}

QList OAIGetUserResponse::getUserAttributes() const {
    return m_user_attributes;
}
void OAIGetUserResponse::setUserAttributes(const QList &user_attributes) {
    m_user_attributes = user_attributes;
    m_user_attributes_isSet = true;
}

bool OAIGetUserResponse::is_user_attributes_Set() const{
    return m_user_attributes_isSet;
}

bool OAIGetUserResponse::is_user_attributes_Valid() const{
    return m_user_attributes_isValid;
}

QList OAIGetUserResponse::getMfaOptions() const {
    return m_mfa_options;
}
void OAIGetUserResponse::setMfaOptions(const QList &mfa_options) {
    m_mfa_options = mfa_options;
    m_mfa_options_isSet = true;
}

bool OAIGetUserResponse::is_mfa_options_Set() const{
    return m_mfa_options_isSet;
}

bool OAIGetUserResponse::is_mfa_options_Valid() const{
    return m_mfa_options_isValid;
}

QString OAIGetUserResponse::getPreferredMfaSetting() const {
    return m_preferred_mfa_setting;
}
void OAIGetUserResponse::setPreferredMfaSetting(const QString &preferred_mfa_setting) {
    m_preferred_mfa_setting = preferred_mfa_setting;
    m_preferred_mfa_setting_isSet = true;
}

bool OAIGetUserResponse::is_preferred_mfa_setting_Set() const{
    return m_preferred_mfa_setting_isSet;
}

bool OAIGetUserResponse::is_preferred_mfa_setting_Valid() const{
    return m_preferred_mfa_setting_isValid;
}

QList OAIGetUserResponse::getUserMfaSettingList() const {
    return m_user_mfa_setting_list;
}
void OAIGetUserResponse::setUserMfaSettingList(const QList &user_mfa_setting_list) {
    m_user_mfa_setting_list = user_mfa_setting_list;
    m_user_mfa_setting_list_isSet = true;
}

bool OAIGetUserResponse::is_user_mfa_setting_list_Set() const{
    return m_user_mfa_setting_list_isSet;
}

bool OAIGetUserResponse::is_user_mfa_setting_list_Valid() const{
...
bool OAIGetUserResponse::isValid() const {
    ...
    return m_username_isValid && m_user_attributes_isValid && true;
}
