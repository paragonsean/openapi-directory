...
#include "OAIAccountTakeoverActionType.h"
...
OAIAccountTakeoverActionType::OAIAccountTakeoverActionType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAccountTakeoverActionType::OAIAccountTakeoverActionType() {
    this->initializeModel();
}

OAIAccountTakeoverActionType::~OAIAccountTakeoverActionType() {}

void OAIAccountTakeoverActionType::initializeModel() {
...
void OAIAccountTakeoverActionType::fromJson(QString jsonString) {
...
void OAIAccountTakeoverActionType::fromJsonObject(QJsonObject json) {
...
QString OAIAccountTakeoverActionType::asJson() const {
...
QJsonObject OAIAccountTakeoverActionType::asJsonObject() const {
    QJsonObject obj;
    if (m_notify_isSet) {
...
bool OAIAccountTakeoverActionType::getNotify() const {
    return m_notify;
}
void OAIAccountTakeoverActionType::setNotify(const bool &notify) {
    m_notify = notify;
    m_notify_isSet = true;
}

bool OAIAccountTakeoverActionType::is_notify_Set() const{
    return m_notify_isSet;
}

bool OAIAccountTakeoverActionType::is_notify_Valid() const{
    return m_notify_isValid;
}

OAIAccountTakeoverEventActionType OAIAccountTakeoverActionType::getEventAction() const {
    return m_event_action;
}
void OAIAccountTakeoverActionType::setEventAction(const OAIAccountTakeoverEventActionType &event_action) {
    m_event_action = event_action;
    m_event_action_isSet = true;
}

bool OAIAccountTakeoverActionType::is_event_action_Set() const{
    return m_event_action_isSet;
}

bool OAIAccountTakeoverActionType::is_event_action_Valid() const{
    return m_event_action_isValid;
}

bool OAIAccountTakeoverActionType::isSet() const {
...
bool OAIAccountTakeoverActionType::isValid() const {
