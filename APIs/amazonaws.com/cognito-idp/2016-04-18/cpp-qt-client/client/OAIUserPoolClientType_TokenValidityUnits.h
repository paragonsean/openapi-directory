...
/*
 * OAIUserPoolClientType_TokenValidityUnits.h
 *
 * 
 */

#ifndef OAIUserPoolClientType_TokenValidityUnits_H
#define OAIUserPoolClientType_TokenValidityUnits_H
...
class OAIUserPoolClientType_TokenValidityUnits : public OAIObject {
public:
    OAIUserPoolClientType_TokenValidityUnits();
    OAIUserPoolClientType_TokenValidityUnits(QString json);
    ~OAIUserPoolClientType_TokenValidityUnits() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserPoolClientType_TokenValidityUnits)

#endif // OAIUserPoolClientType_TokenValidityUnits_H
