...
OAICreateUserImportJobResponse::OAICreateUserImportJobResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateUserImportJobResponse::OAICreateUserImportJobResponse() {
    this->initializeModel();
}

OAICreateUserImportJobResponse::~OAICreateUserImportJobResponse() {}

void OAICreateUserImportJobResponse::initializeModel() {

    m_user_import_job_isSet = false;
    m_user_import_job_isValid = false;
}

void OAICreateUserImportJobResponse::fromJson(QString jsonString) {
...
void OAICreateUserImportJobResponse::fromJsonObject(QJsonObject json) {

    m_user_import_job_isValid = ::OpenAPI::fromJsonValue(m_user_import_job, json[QString("UserImportJob")]);
    m_user_import_job_isSet = !json[QString("UserImportJob")].isNull() && m_user_import_job_isValid;
}

QString OAICreateUserImportJobResponse::asJson() const {
...
QJsonObject OAICreateUserImportJobResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_user_import_job.isSet()) {
        obj.insert(QString("UserImportJob"), ::OpenAPI::toJsonValue(m_user_import_job));
    }
    return obj;
}

OAICreateUserImportJobResponse_UserImportJob OAICreateUserImportJobResponse::getUserImportJob() const {
    return m_user_import_job;
}
void OAICreateUserImportJobResponse::setUserImportJob(const OAICreateUserImportJobResponse_UserImportJob &user_import_job) {
    m_user_import_job = user_import_job;
    m_user_import_job_isSet = true;
}

bool OAICreateUserImportJobResponse::is_user_import_job_Set() const{
    return m_user_import_job_isSet;
}

bool OAICreateUserImportJobResponse::is_user_import_job_Valid() const{
    return m_user_import_job_isValid;
}

bool OAICreateUserImportJobResponse::isSet() const {
...
bool OAICreateUserImportJobResponse::isValid() const {
