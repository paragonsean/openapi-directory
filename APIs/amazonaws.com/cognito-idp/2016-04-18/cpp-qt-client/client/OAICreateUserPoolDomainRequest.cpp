...
OAICreateUserPoolDomainRequest::OAICreateUserPoolDomainRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateUserPoolDomainRequest::OAICreateUserPoolDomainRequest() {
    this->initializeModel();
}

OAICreateUserPoolDomainRequest::~OAICreateUserPoolDomainRequest() {}

void OAICreateUserPoolDomainRequest::initializeModel() {
...
void OAICreateUserPoolDomainRequest::fromJson(QString jsonString) {
...
void OAICreateUserPoolDomainRequest::fromJsonObject(QJsonObject json) {
...
QString OAICreateUserPoolDomainRequest::asJson() const {
...
QJsonObject OAICreateUserPoolDomainRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_domain_isSet) {
...
QString OAICreateUserPoolDomainRequest::getDomain() const {
    return m_domain;
}
void OAICreateUserPoolDomainRequest::setDomain(const QString &domain) {
    m_domain = domain;
    m_domain_isSet = true;
}

bool OAICreateUserPoolDomainRequest::is_domain_Set() const{
    return m_domain_isSet;
}

bool OAICreateUserPoolDomainRequest::is_domain_Valid() const{
    return m_domain_isValid;
}

QString OAICreateUserPoolDomainRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAICreateUserPoolDomainRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAICreateUserPoolDomainRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAICreateUserPoolDomainRequest::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

OAICreateUserPoolDomainRequest_CustomDomainConfig OAICreateUserPoolDomainRequest::getCustomDomainConfig() const {
    return m_custom_domain_config;
}
void OAICreateUserPoolDomainRequest::setCustomDomainConfig(const OAICreateUserPoolDomainRequest_CustomDomainConfig &custom_domain_config) {
    m_custom_domain_config = custom_domain_config;
    m_custom_domain_config_isSet = true;
}

bool OAICreateUserPoolDomainRequest::is_custom_domain_config_Set() const{
    return m_custom_domain_config_isSet;
}

bool OAICreateUserPoolDomainRequest::is_custom_domain_config_Valid() const{
    return m_custom_domain_config_isValid;
}

bool OAICreateUserPoolDomainRequest::isSet() const {
...
bool OAICreateUserPoolDomainRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_domain_isValid && m_user_pool_id_isValid && true;
}
