...
/*
 * OAIUpdateGroupResponse.h
 *
 * 
 */

#ifndef OAIUpdateGroupResponse_H
#define OAIUpdateGroupResponse_H
...
class OAIUpdateGroupResponse : public OAIObject {
public:
    OAIUpdateGroupResponse();
    OAIUpdateGroupResponse(QString json);
    ~OAIUpdateGroupResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateGroupResponse)

#endif // OAIUpdateGroupResponse_H
