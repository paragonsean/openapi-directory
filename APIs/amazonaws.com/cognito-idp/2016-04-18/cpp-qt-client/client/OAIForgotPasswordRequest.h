...
class OAIForgotPasswordRequest_AnalyticsMetadata;
...
public:
    ...
    OAIForgotPasswordRequest_AnalyticsMetadata getAnalyticsMetadata() const;
    void setAnalyticsMetadata(const OAIForgotPasswordRequest_AnalyticsMetadata &analytics_metadata);
...
private:
    ...
    OAIForgotPasswordRequest_AnalyticsMetadata m_analytics_metadata;
