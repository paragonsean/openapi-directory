...
#include "OAICloudWatchLogsConfigurationType.h"
...
OAICloudWatchLogsConfigurationType::OAICloudWatchLogsConfigurationType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICloudWatchLogsConfigurationType::OAICloudWatchLogsConfigurationType() {
    this->initializeModel();
}

OAICloudWatchLogsConfigurationType::~OAICloudWatchLogsConfigurationType() {}

void OAICloudWatchLogsConfigurationType::initializeModel() {

    m_log_group_arn_isSet = false;
    m_log_group_arn_isValid = false;
}

void OAICloudWatchLogsConfigurationType::fromJson(QString jsonString) {
...
void OAICloudWatchLogsConfigurationType::fromJsonObject(QJsonObject json) {
...
QString OAICloudWatchLogsConfigurationType::asJson() const {
...
QJsonObject OAICloudWatchLogsConfigurationType::asJsonObject() const {
    QJsonObject obj;
...
QString OAICloudWatchLogsConfigurationType::getLogGroupArn() const {
    return m_log_group_arn;
}
void OAICloudWatchLogsConfigurationType::setLogGroupArn(const QString &log_group_arn) {
    m_log_group_arn = log_group_arn;
    m_log_group_arn_isSet = true;
}

bool OAICloudWatchLogsConfigurationType::is_log_group_arn_Set() const{
    return m_log_group_arn_isSet;
}

bool OAICloudWatchLogsConfigurationType::is_log_group_arn_Valid() const{
    return m_log_group_arn_isValid;
}

bool OAICloudWatchLogsConfigurationType::isSet() const {
...
bool OAICloudWatchLogsConfigurationType::isValid() const {
