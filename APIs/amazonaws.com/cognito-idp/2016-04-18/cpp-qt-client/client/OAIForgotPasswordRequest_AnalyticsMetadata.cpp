...
#include "OAIForgotPasswordRequest_AnalyticsMetadata.h"
...
OAIForgotPasswordRequest_AnalyticsMetadata::OAIForgotPasswordRequest_AnalyticsMetadata(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIForgotPasswordRequest_AnalyticsMetadata::OAIForgotPasswordRequest_AnalyticsMetadata() {
    this->initializeModel();
}

OAIForgotPasswordRequest_AnalyticsMetadata::~OAIForgotPasswordRequest_AnalyticsMetadata() {}

void OAIForgotPasswordRequest_AnalyticsMetadata::initializeModel() {

    m_analytics_endpoint_id_isSet = false;
    m_analytics_endpoint_id_isValid = false;
}

void OAIForgotPasswordRequest_AnalyticsMetadata::fromJson(QString jsonString) {
...
void OAIForgotPasswordRequest_AnalyticsMetadata::fromJsonObject(QJsonObject json) {
...
QString OAIForgotPasswordRequest_AnalyticsMetadata::asJson() const {
...
QJsonObject OAIForgotPasswordRequest_AnalyticsMetadata::asJsonObject() const {
    QJsonObject obj;
...
QString OAIForgotPasswordRequest_AnalyticsMetadata::getAnalyticsEndpointId() const {
    return m_analytics_endpoint_id;
}
void OAIForgotPasswordRequest_AnalyticsMetadata::setAnalyticsEndpointId(const QString &analytics_endpoint_id) {
    m_analytics_endpoint_id = analytics_endpoint_id;
    m_analytics_endpoint_id_isSet = true;
}

bool OAIForgotPasswordRequest_AnalyticsMetadata::is_analytics_endpoint_id_Set() const{
    return m_analytics_endpoint_id_isSet;
}

bool OAIForgotPasswordRequest_AnalyticsMetadata::is_analytics_endpoint_id_Valid() const{
    return m_analytics_endpoint_id_isValid;
}

bool OAIForgotPasswordRequest_AnalyticsMetadata::isSet() const {
...
bool OAIForgotPasswordRequest_AnalyticsMetadata::isValid() const {
