...
OAICreateResourceServerRequest::OAICreateResourceServerRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateResourceServerRequest::OAICreateResourceServerRequest() {
    this->initializeModel();
}

OAICreateResourceServerRequest::~OAICreateResourceServerRequest() {}

void OAICreateResourceServerRequest::initializeModel() {
...
void OAICreateResourceServerRequest::fromJson(QString jsonString) {
...
void OAICreateResourceServerRequest::fromJsonObject(QJsonObject json) {
...
QString OAICreateResourceServerRequest::asJson() const {
...
QJsonObject OAICreateResourceServerRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateResourceServerRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAICreateResourceServerRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAICreateResourceServerRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAICreateResourceServerRequest::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

QString OAICreateResourceServerRequest::getIdentifier() const {
    return m_identifier;
}
void OAICreateResourceServerRequest::setIdentifier(const QString &identifier) {
    m_identifier = identifier;
    m_identifier_isSet = true;
}

bool OAICreateResourceServerRequest::is_identifier_Set() const{
    return m_identifier_isSet;
}

bool OAICreateResourceServerRequest::is_identifier_Valid() const{
    return m_identifier_isValid;
}

QString OAICreateResourceServerRequest::getName() const {
    return m_name;
}
void OAICreateResourceServerRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICreateResourceServerRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAICreateResourceServerRequest::is_name_Valid() const{
    return m_name_isValid;
}

QList OAICreateResourceServerRequest::getScopes() const {
    return m_scopes;
}
void OAICreateResourceServerRequest::setScopes(const QList &scopes) {
    m_scopes = scopes;
    m_scopes_isSet = true;
}

bool OAICreateResourceServerRequest::is_scopes_Set() const{
    return m_scopes_isSet;
}

bool OAICreateResourceServerRequest::is_scopes_Valid() const{
    return m_scopes_isValid;
}

bool OAICreateResourceServerRequest::isSet() const {
...
bool OAICreateResourceServerRequest::isValid() const {
