...
#ifndef OAISMSMfaSettingsType_H
#define OAISMSMfaSettingsType_H
...
class OAISMSMfaSettingsType : public OAIObject {
public:
    OAISMSMfaSettingsType();
    OAISMSMfaSettingsType(QString json);
    ~OAISMSMfaSettingsType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISMSMfaSettingsType)

#endif // OAISMSMfaSettingsType_H
