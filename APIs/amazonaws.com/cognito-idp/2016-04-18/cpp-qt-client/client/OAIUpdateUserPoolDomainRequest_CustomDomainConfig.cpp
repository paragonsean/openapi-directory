...
OAIUpdateUserPoolDomainRequest_CustomDomainConfig::OAIUpdateUserPoolDomainRequest_CustomDomainConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateUserPoolDomainRequest_CustomDomainConfig::OAIUpdateUserPoolDomainRequest_CustomDomainConfig() {
    this->initializeModel();
}

OAIUpdateUserPoolDomainRequest_CustomDomainConfig::~OAIUpdateUserPoolDomainRequest_CustomDomainConfig() {}

void OAIUpdateUserPoolDomainRequest_CustomDomainConfig::initializeModel() {

    m_certificate_arn_isSet = false;
    m_certificate_arn_isValid = false;
}

void OAIUpdateUserPoolDomainRequest_CustomDomainConfig::fromJson(QString jsonString) {
...
void OAIUpdateUserPoolDomainRequest_CustomDomainConfig::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateUserPoolDomainRequest_CustomDomainConfig::asJson() const {
...
QJsonObject OAIUpdateUserPoolDomainRequest_CustomDomainConfig::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateUserPoolDomainRequest_CustomDomainConfig::getCertificateArn() const {
    return m_certificate_arn;
}
void OAIUpdateUserPoolDomainRequest_CustomDomainConfig::setCertificateArn(const QString &certificate_arn) {
    m_certificate_arn = certificate_arn;
    m_certificate_arn_isSet = true;
}

bool OAIUpdateUserPoolDomainRequest_CustomDomainConfig::is_certificate_arn_Set() const{
    return m_certificate_arn_isSet;
}

bool OAIUpdateUserPoolDomainRequest_CustomDomainConfig::is_certificate_arn_Valid() const{
    return m_certificate_arn_isValid;
}

bool OAIUpdateUserPoolDomainRequest_CustomDomainConfig::isSet() const {
...
bool OAIUpdateUserPoolDomainRequest_CustomDomainConfig::isValid() const {
