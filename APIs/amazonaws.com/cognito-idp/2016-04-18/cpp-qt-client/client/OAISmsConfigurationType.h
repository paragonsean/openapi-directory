...
#ifndef OAISmsConfigurationType_H
#define OAISmsConfigurationType_H
...
class OAISmsConfigurationType : public OAIObject {
public:
    OAISmsConfigurationType();
    OAISmsConfigurationType(QString json);
    ~OAISmsConfigurationType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISmsConfigurationType)

#endif // OAISmsConfigurationType_H
