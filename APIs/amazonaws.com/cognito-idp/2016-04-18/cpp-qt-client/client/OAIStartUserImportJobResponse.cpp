...
OAIStartUserImportJobResponse::OAIStartUserImportJobResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartUserImportJobResponse::OAIStartUserImportJobResponse() {
    this->initializeModel();
}

OAIStartUserImportJobResponse::~OAIStartUserImportJobResponse() {}

void OAIStartUserImportJobResponse::initializeModel() {

    m_user_import_job_isSet = false;
    m_user_import_job_isValid = false;
}

void OAIStartUserImportJobResponse::fromJson(QString jsonString) {
...
void OAIStartUserImportJobResponse::fromJsonObject(QJsonObject json) {
...
QString OAIStartUserImportJobResponse::asJson() const {
...
QJsonObject OAIStartUserImportJobResponse::asJsonObject() const {
    QJsonObject obj;
...
OAICreateUserImportJobResponse_UserImportJob OAIStartUserImportJobResponse::getUserImportJob() const {
    return m_user_import_job;
}
void OAIStartUserImportJobResponse::setUserImportJob(const OAICreateUserImportJobResponse_UserImportJob &user_import_job) {
    m_user_import_job = user_import_job;
    m_user_import_job_isSet = true;
}

bool OAIStartUserImportJobResponse::is_user_import_job_Set() const{
    return m_user_import_job_isSet;
}

bool OAIStartUserImportJobResponse::is_user_import_job_Valid() const{
    return m_user_import_job_isValid;
}

bool OAIStartUserImportJobResponse::isSet() const {
...
bool OAIStartUserImportJobResponse::isValid() const {
