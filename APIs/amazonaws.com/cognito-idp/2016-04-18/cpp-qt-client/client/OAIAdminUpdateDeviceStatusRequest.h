...
/*
 * OAIAdminUpdateDeviceStatusRequest.h
 *
 * The request to update the device status, as an administrator.
 */

#ifndef OAIAdminUpdateDeviceStatusRequest_H
#define OAIAdminUpdateDeviceStatusRequest_H
...
class OAIAdminUpdateDeviceStatusRequest : public OAIObject {
public:
    OAIAdminUpdateDeviceStatusRequest();
    OAIAdminUpdateDeviceStatusRequest(QString json);
    ~OAIAdminUpdateDeviceStatusRequest() override;
    ...
    OAIDeviceRememberedStatusType getDeviceRememberedStatus() const;
    void setDeviceRememberedStatus(const OAIDeviceRememberedStatusType &device_remembered_status);
    bool is_device_remembered_status_Set() const;
    bool is_device_remembered_status_Valid() const;
...
private:
    ...
    OAIDeviceRememberedStatusType m_device_remembered_status;
    bool m_device_remembered_status_isSet;
    bool m_device_remembered_status_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIAdminUpdateDeviceStatusRequest)

#endif // OAIAdminUpdateDeviceStatusRequest_H
