...
/*
 * OAIListUserPoolsRequest.h
 *
 * Represents the request to list user pools.
 */

#ifndef OAIListUserPoolsRequest_H
#define OAIListUserPoolsRequest_H
...
class OAIListUserPoolsRequest : public OAIObject {
public:
    OAIListUserPoolsRequest();
    OAIListUserPoolsRequest(QString json);
    ~OAIListUserPoolsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListUserPoolsRequest)

#endif // OAIListUserPoolsRequest_H
