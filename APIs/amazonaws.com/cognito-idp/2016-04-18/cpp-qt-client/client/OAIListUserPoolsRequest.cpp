...
OAIListUserPoolsRequest::OAIListUserPoolsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListUserPoolsRequest::OAIListUserPoolsRequest() {
    this->initializeModel();
}

OAIListUserPoolsRequest::~OAIListUserPoolsRequest() {}

void OAIListUserPoolsRequest::initializeModel() {
...
void OAIListUserPoolsRequest::fromJson(QString jsonString) {
...
void OAIListUserPoolsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListUserPoolsRequest::asJson() const {
...
QJsonObject OAIListUserPoolsRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListUserPoolsRequest::getNextToken() const {
    return m_next_token;
}
void OAIListUserPoolsRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListUserPoolsRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListUserPoolsRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIListUserPoolsRequest::getMaxResults() const {
    return m_max_results;
}
void OAIListUserPoolsRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListUserPoolsRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListUserPoolsRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

bool OAIListUserPoolsRequest::isSet() const {
...
bool OAIListUserPoolsRequest::isValid() const {
