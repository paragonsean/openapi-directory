...
/*
 * OAISetUserPoolMfaConfigResponse_SmsMfaConfiguration.h
 *
 * 
 */

#ifndef OAISetUserPoolMfaConfigResponse_SmsMfaConfiguration_H
#define OAISetUserPoolMfaConfigResponse_SmsMfaConfiguration_H
...
namespace OpenAPI {
class OAISmsMfaConfigType_SmsConfiguration;

class OAISetUserPoolMfaConfigResponse_SmsMfaConfiguration : public OAIObject {
public:
    OAISetUserPoolMfaConfigResponse_SmsMfaConfiguration();
    OAISetUserPoolMfaConfigResponse_SmsMfaConfiguration(QString json);
    ~OAISetUserPoolMfaConfigResponse_SmsMfaConfiguration() override;
    ...
    OAISmsMfaConfigType_SmsConfiguration getSmsConfiguration() const;
    void setSmsConfiguration(const OAISmsMfaConfigType_SmsConfiguration &sms_configuration);
...
private:
    ...
    OAISmsMfaConfigType_SmsConfiguration m_sms_configuration;
...
Q_DECLARE_METATYPE(OpenAPI::OAISetUserPoolMfaConfigResponse_SmsMfaConfiguration)

#endif // OAISetUserPoolMfaConfigResponse_SmsMfaConfiguration_H
