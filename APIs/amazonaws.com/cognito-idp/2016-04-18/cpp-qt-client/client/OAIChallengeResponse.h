...
/*
 * OAIChallengeResponse.h
 *
 * 
 */

#ifndef OAIChallengeResponse_H
#define OAIChallengeResponse_H
...
class OAIChallengeResponse : public OAIEnum {
public:
    OAIChallengeResponse();
    OAIChallengeResponse(QString json);
    ~OAIChallengeResponse() override;
    ...
    enum class eOAIChallengeResponse {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        SUCCESS, 
        FAILURE
    };
    OAIChallengeResponse::eOAIChallengeResponse getValue() const;
    void setValue(const OAIChallengeResponse::eOAIChallengeResponse& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIChallengeResponse)

#endif // OAIChallengeResponse_H
