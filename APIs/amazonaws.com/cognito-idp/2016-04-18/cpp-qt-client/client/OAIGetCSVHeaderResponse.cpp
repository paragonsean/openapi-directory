...
OAIGetCSVHeaderResponse::OAIGetCSVHeaderResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetCSVHeaderResponse::OAIGetCSVHeaderResponse() {
    this->initializeModel();
}

OAIGetCSVHeaderResponse::~OAIGetCSVHeaderResponse() {}

void OAIGetCSVHeaderResponse::initializeModel() {

    m_user_pool_id_isSet = false;
    m_user_pool_id_isValid = false;

    m_csv_header_isSet = false;
    m_csv_header_isValid = false;
}

void OAIGetCSVHeaderResponse::fromJson(QString jsonString) {
...
void OAIGetCSVHeaderResponse::fromJsonObject(QJsonObject json) {
    ...
    m_csv_header_isValid = ::OpenAPI::fromJsonValue(m_csv_header, json[QString("CSVHeader")]);
    m_csv_header_isSet = !json[QString("CSVHeader")].isNull() && m_csv_header_isValid;
}

QString OAIGetCSVHeaderResponse::asJson() const {
...
QJsonObject OAIGetCSVHeaderResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_user_pool_id_isSet) {
        obj.insert(QString("UserPoolId"), ::OpenAPI::toJsonValue(m_user_pool_id));
    }
    if (m_csv_header.isSet()) {
        obj.insert(QString("CSVHeader"), ::OpenAPI::toJsonValue(m_csv_header));
    }
    return obj;
}

QString OAIGetCSVHeaderResponse::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIGetCSVHeaderResponse::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIGetCSVHeaderResponse::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIGetCSVHeaderResponse::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

QList OAIGetCSVHeaderResponse::getCsvHeader() const {
    return m_csv_header;
}
void OAIGetCSVHeaderResponse::setCsvHeader(const QList &csv_header) {
    m_csv_header = csv_header;
    m_csv_header_isSet = true;
}

bool OAIGetCSVHeaderResponse::is_csv_header_Set() const{
    return m_csv_header_isSet;
}

bool OAIGetCSVHeaderResponse::is_csv_header_Valid() const{
    return m_csv_header_isValid;
}

bool OAIGetCSVHeaderResponse::isSet() const {
...
bool OAIGetCSVHeaderResponse::isValid() const {
