...
OAINotifyEmailType::OAINotifyEmailType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINotifyEmailType::OAINotifyEmailType() {
    this->initializeModel();
}

OAINotifyEmailType::~OAINotifyEmailType() {}

void OAINotifyEmailType::initializeModel() {
...
void OAINotifyEmailType::fromJson(QString jsonString) {
...
void OAINotifyEmailType::fromJsonObject(QJsonObject json) {
...
QString OAINotifyEmailType::asJson() const {
...
QJsonObject OAINotifyEmailType::asJsonObject() const {
    QJsonObject obj;
    if (m_subject_isSet) {
...
QString OAINotifyEmailType::getSubject() const {
    return m_subject;
}
void OAINotifyEmailType::setSubject(const QString &subject) {
    m_subject = subject;
    m_subject_isSet = true;
}

bool OAINotifyEmailType::is_subject_Set() const{
    return m_subject_isSet;
}

bool OAINotifyEmailType::is_subject_Valid() const{
    return m_subject_isValid;
}

QString OAINotifyEmailType::getHtmlBody() const {
    return m_html_body;
}
void OAINotifyEmailType::setHtmlBody(const QString &html_body) {
    m_html_body = html_body;
    m_html_body_isSet = true;
}

bool OAINotifyEmailType::is_html_body_Set() const{
    return m_html_body_isSet;
}

bool OAINotifyEmailType::is_html_body_Valid() const{
    return m_html_body_isValid;
}

QString OAINotifyEmailType::getTextBody() const {
    return m_text_body;
}
void OAINotifyEmailType::setTextBody(const QString &text_body) {
    m_text_body = text_body;
    m_text_body_isSet = true;
}

bool OAINotifyEmailType::is_text_body_Set() const{
    return m_text_body_isSet;
}

bool OAINotifyEmailType::is_text_body_Valid() const{
    return m_text_body_isValid;
}

bool OAINotifyEmailType::isSet() const {
...
bool OAINotifyEmailType::isValid() const {
