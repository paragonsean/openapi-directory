...
/*
 * OAIAdminCreateUserResponse.h
 *
 * Represents the response from the server to the request to create the user.
 */

#ifndef OAIAdminCreateUserResponse_H
#define OAIAdminCreateUserResponse_H
...
namespace OpenAPI {
class OAIAdminCreateUserResponse_User;

class OAIAdminCreateUserResponse : public OAIObject {
public:
    OAIAdminCreateUserResponse();
    OAIAdminCreateUserResponse(QString json);
    ~OAIAdminCreateUserResponse() override;
    ...
    OAIAdminCreateUserResponse_User getUser() const;
    void setUser(const OAIAdminCreateUserResponse_User &user);
...
private:
    ...
    OAIAdminCreateUserResponse_User m_user;
    bool m_user_isSet;
    bool m_user_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdminCreateUserResponse)

#endif // OAIAdminCreateUserResponse_H
