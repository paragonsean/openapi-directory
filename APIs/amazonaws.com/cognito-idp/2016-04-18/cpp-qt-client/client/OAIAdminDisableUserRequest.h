...
/*
 * OAIAdminDisableUserRequest.h
 *
 * Represents the request to disable the user as an administrator.
 */

#ifndef OAIAdminDisableUserRequest_H
#define OAIAdminDisableUserRequest_H
...
class OAIAdminDisableUserRequest : public OAIObject {
public:
    OAIAdminDisableUserRequest();
    OAIAdminDisableUserRequest(QString json);
    ~OAIAdminDisableUserRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdminDisableUserRequest)

#endif // OAIAdminDisableUserRequest_H
