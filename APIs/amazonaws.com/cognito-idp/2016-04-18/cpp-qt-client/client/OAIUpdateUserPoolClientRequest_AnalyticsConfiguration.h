...
/*
 * OAIUpdateUserPoolClientRequest_AnalyticsConfiguration.h
 *
 * 
 */

#ifndef OAIUpdateUserPoolClientRequest_AnalyticsConfiguration_H
#define OAIUpdateUserPoolClientRequest_AnalyticsConfiguration_H
...
class OAIUpdateUserPoolClientRequest_AnalyticsConfiguration : public OAIObject {
public:
    OAIUpdateUserPoolClientRequest_AnalyticsConfiguration();
    OAIUpdateUserPoolClientRequest_AnalyticsConfiguration(QString json);
    ~OAIUpdateUserPoolClientRequest_AnalyticsConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateUserPoolClientRequest_AnalyticsConfiguration)

#endif // OAIUpdateUserPoolClientRequest_AnalyticsConfiguration_H
