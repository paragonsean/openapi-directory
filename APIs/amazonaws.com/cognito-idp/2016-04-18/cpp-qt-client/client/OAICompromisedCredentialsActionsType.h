...
/*
 * OAICompromisedCredentialsActionsType.h
 *
 * The compromised credentials actions type.
 */

#ifndef OAICompromisedCredentialsActionsType_H
#define OAICompromisedCredentialsActionsType_H
...
class OAICompromisedCredentialsActionsType : public OAIObject {
public:
    OAICompromisedCredentialsActionsType();
    OAICompromisedCredentialsActionsType(QString json);
    ~OAICompromisedCredentialsActionsType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICompromisedCredentialsActionsType)

#endif // OAICompromisedCredentialsActionsType_H
