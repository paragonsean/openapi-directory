...
OAIForgetDeviceRequest::OAIForgetDeviceRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIForgetDeviceRequest::OAIForgetDeviceRequest() {
    this->initializeModel();
}

OAIForgetDeviceRequest::~OAIForgetDeviceRequest() {}

void OAIForgetDeviceRequest::initializeModel() {
...
void OAIForgetDeviceRequest::fromJson(QString jsonString) {
...
void OAIForgetDeviceRequest::fromJsonObject(QJsonObject json) {
...
QString OAIForgetDeviceRequest::asJson() const {
...
QJsonObject OAIForgetDeviceRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIForgetDeviceRequest::getAccessToken() const {
    return m_access_token;
}
void OAIForgetDeviceRequest::setAccessToken(const QString &access_token) {
    m_access_token = access_token;
    m_access_token_isSet = true;
}

bool OAIForgetDeviceRequest::is_access_token_Set() const{
    return m_access_token_isSet;
}

bool OAIForgetDeviceRequest::is_access_token_Valid() const{
    return m_access_token_isValid;
}

QString OAIForgetDeviceRequest::getDeviceKey() const {
    return m_device_key;
}
void OAIForgetDeviceRequest::setDeviceKey(const QString &device_key) {
    m_device_key = device_key;
    m_device_key_isSet = true;
}

bool OAIForgetDeviceRequest::is_device_key_Set() const{
    return m_device_key_isSet;
}

bool OAIForgetDeviceRequest::is_device_key_Valid() const{
    return m_device_key_isValid;
}

bool OAIForgetDeviceRequest::isSet() const {
...
bool OAIForgetDeviceRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_device_key_isValid && true;
}
