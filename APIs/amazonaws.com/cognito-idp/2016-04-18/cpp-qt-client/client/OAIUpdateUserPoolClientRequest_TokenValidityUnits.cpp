...
#include "OAIUpdateUserPoolClientRequest_TokenValidityUnits.h"
...
OAIUpdateUserPoolClientRequest_TokenValidityUnits::OAIUpdateUserPoolClientRequest_TokenValidityUnits(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateUserPoolClientRequest_TokenValidityUnits::OAIUpdateUserPoolClientRequest_TokenValidityUnits() {
    this->initializeModel();
}

OAIUpdateUserPoolClientRequest_TokenValidityUnits::~OAIUpdateUserPoolClientRequest_TokenValidityUnits() {}

void OAIUpdateUserPoolClientRequest_TokenValidityUnits::initializeModel() {
...
void OAIUpdateUserPoolClientRequest_TokenValidityUnits::fromJson(QString jsonString) {
...
void OAIUpdateUserPoolClientRequest_TokenValidityUnits::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateUserPoolClientRequest_TokenValidityUnits::asJson() const {
...
QJsonObject OAIUpdateUserPoolClientRequest_TokenValidityUnits::asJsonObject() const {
    QJsonObject obj;
...
OAITimeUnitsType OAIUpdateUserPoolClientRequest_TokenValidityUnits::getAccessToken() const {
    return m_access_token;
}
void OAIUpdateUserPoolClientRequest_TokenValidityUnits::setAccessToken(const OAITimeUnitsType &access_token) {
    m_access_token = access_token;
    m_access_token_isSet = true;
}

bool OAIUpdateUserPoolClientRequest_TokenValidityUnits::is_access_token_Set() const{
    return m_access_token_isSet;
}

bool OAIUpdateUserPoolClientRequest_TokenValidityUnits::is_access_token_Valid() const{
    return m_access_token_isValid;
}

OAITimeUnitsType OAIUpdateUserPoolClientRequest_TokenValidityUnits::getIdToken() const {
    return m_id_token;
}
void OAIUpdateUserPoolClientRequest_TokenValidityUnits::setIdToken(const OAITimeUnitsType &id_token) {
    m_id_token = id_token;
    m_id_token_isSet = true;
}

bool OAIUpdateUserPoolClientRequest_TokenValidityUnits::is_id_token_Set() const{
    return m_id_token_isSet;
}

bool OAIUpdateUserPoolClientRequest_TokenValidityUnits::is_id_token_Valid() const{
    return m_id_token_isValid;
}

OAITimeUnitsType OAIUpdateUserPoolClientRequest_TokenValidityUnits::getRefreshToken() const {
    return m_refresh_token;
}
void OAIUpdateUserPoolClientRequest_TokenValidityUnits::setRefreshToken(const OAITimeUnitsType &refresh_token) {
    m_refresh_token = refresh_token;
    m_refresh_token_isSet = true;
}

bool OAIUpdateUserPoolClientRequest_TokenValidityUnits::is_refresh_token_Set() const{
    return m_refresh_token_isSet;
}

bool OAIUpdateUserPoolClientRequest_TokenValidityUnits::is_refresh_token_Valid() const{
    return m_refresh_token_isValid;
}

bool OAIUpdateUserPoolClientRequest_TokenValidityUnits::isSet() const {
...
bool OAIUpdateUserPoolClientRequest_TokenValidityUnits::isValid() const {
