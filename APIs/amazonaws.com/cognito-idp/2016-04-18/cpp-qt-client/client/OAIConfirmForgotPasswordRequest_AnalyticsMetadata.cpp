...
OAIConfirmForgotPasswordRequest_AnalyticsMetadata::OAIConfirmForgotPasswordRequest_AnalyticsMetadata(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIConfirmForgotPasswordRequest_AnalyticsMetadata::OAIConfirmForgotPasswordRequest_AnalyticsMetadata() {
    this->initializeModel();
}

OAIConfirmForgotPasswordRequest_AnalyticsMetadata::~OAIConfirmForgotPasswordRequest_AnalyticsMetadata() {}

void OAIConfirmForgotPasswordRequest_AnalyticsMetadata::initializeModel() {

    m_analytics_endpoint_id_isSet = false;
    m_analytics_endpoint_id_isValid = false;
}

void OAIConfirmForgotPasswordRequest_AnalyticsMetadata::fromJson(QString jsonString) {
...
void OAIConfirmForgotPasswordRequest_AnalyticsMetadata::fromJsonObject(QJsonObject json) {
...
QString OAIConfirmForgotPasswordRequest_AnalyticsMetadata::asJson() const {
...
QJsonObject OAIConfirmForgotPasswordRequest_AnalyticsMetadata::asJsonObject() const {
    QJsonObject obj;
...
QString OAIConfirmForgotPasswordRequest_AnalyticsMetadata::getAnalyticsEndpointId() const {
    return m_analytics_endpoint_id;
}
void OAIConfirmForgotPasswordRequest_AnalyticsMetadata::setAnalyticsEndpointId(const QString &analytics_endpoint_id) {
    m_analytics_endpoint_id = analytics_endpoint_id;
    m_analytics_endpoint_id_isSet = true;
}

bool OAIConfirmForgotPasswordRequest_AnalyticsMetadata::is_analytics_endpoint_id_Set() const{
    return m_analytics_endpoint_id_isSet;
}

bool OAIConfirmForgotPasswordRequest_AnalyticsMetadata::is_analytics_endpoint_id_Valid() const{
    return m_analytics_endpoint_id_isValid;
}

bool OAIConfirmForgotPasswordRequest_AnalyticsMetadata::isSet() const {
...
bool OAIConfirmForgotPasswordRequest_AnalyticsMetadata::isValid() const {
