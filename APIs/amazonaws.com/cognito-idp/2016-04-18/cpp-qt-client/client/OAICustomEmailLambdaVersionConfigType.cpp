...
#include "OAICustomEmailLambdaVersionConfigType.h"
...
OAICustomEmailLambdaVersionConfigType::OAICustomEmailLambdaVersionConfigType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICustomEmailLambdaVersionConfigType::OAICustomEmailLambdaVersionConfigType() {
    this->initializeModel();
}

OAICustomEmailLambdaVersionConfigType::~OAICustomEmailLambdaVersionConfigType() {}

void OAICustomEmailLambdaVersionConfigType::initializeModel() {
...
void OAICustomEmailLambdaVersionConfigType::fromJson(QString jsonString) {
...
void OAICustomEmailLambdaVersionConfigType::fromJsonObject(QJsonObject json) {
...
QString OAICustomEmailLambdaVersionConfigType::asJson() const {
...
QJsonObject OAICustomEmailLambdaVersionConfigType::asJsonObject() const {
    QJsonObject obj;
...
OAICustomEmailSenderLambdaVersionType OAICustomEmailLambdaVersionConfigType::getLambdaVersion() const {
    return m_lambda_version;
}
void OAICustomEmailLambdaVersionConfigType::setLambdaVersion(const OAICustomEmailSenderLambdaVersionType &lambda_version) {
    m_lambda_version = lambda_version;
    m_lambda_version_isSet = true;
}

bool OAICustomEmailLambdaVersionConfigType::is_lambda_version_Set() const{
    return m_lambda_version_isSet;
}

bool OAICustomEmailLambdaVersionConfigType::is_lambda_version_Valid() const{
    return m_lambda_version_isValid;
}

QString OAICustomEmailLambdaVersionConfigType::getLambdaArn() const {
    return m_lambda_arn;
}
void OAICustomEmailLambdaVersionConfigType::setLambdaArn(const QString &lambda_arn) {
    m_lambda_arn = lambda_arn;
    m_lambda_arn_isSet = true;
}

bool OAICustomEmailLambdaVersionConfigType::is_lambda_arn_Set() const{
    return m_lambda_arn_isSet;
}

bool OAICustomEmailLambdaVersionConfigType::is_lambda_arn_Valid() const{
    return m_lambda_arn_isValid;
}

bool OAICustomEmailLambdaVersionConfigType::isSet() const {
...
bool OAICustomEmailLambdaVersionConfigType::isValid() const {
