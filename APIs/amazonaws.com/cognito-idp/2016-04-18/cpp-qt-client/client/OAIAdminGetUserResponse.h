...
/*
 * OAIAdminGetUserResponse.h
 *
 * Represents the response from the server from the request to get the specified user as an administrator.
 */

#ifndef OAIAdminGetUserResponse_H
#define OAIAdminGetUserResponse_H
...
class OAIAdminGetUserResponse : public OAIObject {
public:
    OAIAdminGetUserResponse();
    OAIAdminGetUserResponse(QString json);
    ~OAIAdminGetUserResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdminGetUserResponse)

#endif // OAIAdminGetUserResponse_H
