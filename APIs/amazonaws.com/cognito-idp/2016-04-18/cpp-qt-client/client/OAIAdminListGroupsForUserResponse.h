...
/*
 * OAIAdminListGroupsForUserResponse.h
 *
 * 
 */

#ifndef OAIAdminListGroupsForUserResponse_H
#define OAIAdminListGroupsForUserResponse_H
...
class OAIAdminListGroupsForUserResponse : public OAIObject {
public:
    OAIAdminListGroupsForUserResponse();
    OAIAdminListGroupsForUserResponse(QString json);
    ~OAIAdminListGroupsForUserResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdminListGroupsForUserResponse)

#endif // OAIAdminListGroupsForUserResponse_H
