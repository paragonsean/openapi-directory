...
OAICreateUserPoolRequest_UserPoolAddOns::OAICreateUserPoolRequest_UserPoolAddOns(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateUserPoolRequest_UserPoolAddOns::OAICreateUserPoolRequest_UserPoolAddOns() {
    this->initializeModel();
}

OAICreateUserPoolRequest_UserPoolAddOns::~OAICreateUserPoolRequest_UserPoolAddOns() {}

void OAICreateUserPoolRequest_UserPoolAddOns::initializeModel() {

    m_advanced_security_mode_isSet = false;
    m_advanced_security_mode_isValid = false;
}

void OAICreateUserPoolRequest_UserPoolAddOns::fromJson(QString jsonString) {
...
void OAICreateUserPoolRequest_UserPoolAddOns::fromJsonObject(QJsonObject json) {
...
QString OAICreateUserPoolRequest_UserPoolAddOns::asJson() const {
...
QJsonObject OAICreateUserPoolRequest_UserPoolAddOns::asJsonObject() const {
    QJsonObject obj;
...
OAIAdvancedSecurityModeType OAICreateUserPoolRequest_UserPoolAddOns::getAdvancedSecurityMode() const {
    return m_advanced_security_mode;
}
void OAICreateUserPoolRequest_UserPoolAddOns::setAdvancedSecurityMode(const OAIAdvancedSecurityModeType &advanced_security_mode) {
    m_advanced_security_mode = advanced_security_mode;
    m_advanced_security_mode_isSet = true;
}

bool OAICreateUserPoolRequest_UserPoolAddOns::is_advanced_security_mode_Set() const{
    return m_advanced_security_mode_isSet;
}

bool OAICreateUserPoolRequest_UserPoolAddOns::is_advanced_security_mode_Valid() const{
    return m_advanced_security_mode_isValid;
}

bool OAICreateUserPoolRequest_UserPoolAddOns::isSet() const {
...
bool OAICreateUserPoolRequest_UserPoolAddOns::isValid() const {
