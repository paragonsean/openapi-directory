...
OAIDescribeIdentityProviderRequest::OAIDescribeIdentityProviderRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeIdentityProviderRequest::OAIDescribeIdentityProviderRequest() {
    this->initializeModel();
}

OAIDescribeIdentityProviderRequest::~OAIDescribeIdentityProviderRequest() {}

void OAIDescribeIdentityProviderRequest::initializeModel() {
...
void OAIDescribeIdentityProviderRequest::fromJson(QString jsonString) {
...
void OAIDescribeIdentityProviderRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeIdentityProviderRequest::asJson() const {
...
QJsonObject OAIDescribeIdentityProviderRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeIdentityProviderRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIDescribeIdentityProviderRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIDescribeIdentityProviderRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIDescribeIdentityProviderRequest::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

QString OAIDescribeIdentityProviderRequest::getProviderName() const {
    return m_provider_name;
}
void OAIDescribeIdentityProviderRequest::setProviderName(const QString &provider_name) {
    m_provider_name = provider_name;
    m_provider_name_isSet = true;
}

bool OAIDescribeIdentityProviderRequest::is_provider_name_Set() const{
    return m_provider_name_isSet;
}

bool OAIDescribeIdentityProviderRequest::is_provider_name_Valid() const{
    return m_provider_name_isValid;
}

bool OAIDescribeIdentityProviderRequest::isSet() const {
...
bool OAIDescribeIdentityProviderRequest::isValid() const {
