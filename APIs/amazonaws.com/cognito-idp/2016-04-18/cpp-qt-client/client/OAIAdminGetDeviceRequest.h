...
/*
 * OAIAdminGetDeviceRequest.h
 *
 * Represents the request to get the device, as an administrator.
 */

#ifndef OAIAdminGetDeviceRequest_H
#define OAIAdminGetDeviceRequest_H
...
class OAIAdminGetDeviceRequest : public OAIObject {
public:
    OAIAdminGetDeviceRequest();
    OAIAdminGetDeviceRequest(QString json);
    ~OAIAdminGetDeviceRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdminGetDeviceRequest)

#endif // OAIAdminGetDeviceRequest_H
