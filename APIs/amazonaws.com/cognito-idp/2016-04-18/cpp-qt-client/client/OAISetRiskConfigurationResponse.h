...
/*
 * OAISetRiskConfigurationResponse.h
 *
 * 
 */

#ifndef OAISetRiskConfigurationResponse_H
#define OAISetRiskConfigurationResponse_H

#include <QJsonObject>

#include "OAIDescribeRiskConfigurationResponse_RiskConfiguration.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIDescribeRiskConfigurationResponse_RiskConfiguration;

class OAISetRiskConfigurationResponse : public OAIObject {
public:
    OAISetRiskConfigurationResponse();
    OAISetRiskConfigurationResponse(QString json);
    ~OAISetRiskConfigurationResponse() override;
    ...
    OAIDescribeRiskConfigurationResponse_RiskConfiguration getRiskConfiguration() const;
    void setRiskConfiguration(const OAIDescribeRiskConfigurationResponse_RiskConfiguration &risk_configuration);
    bool is_risk_configuration_Set() const;
    bool is_risk_configuration_Valid() const;
...
private:
    ...
    OAIDescribeRiskConfigurationResponse_RiskConfiguration m_risk_configuration;
    bool m_risk_configuration_isSet;
    bool m_risk_configuration_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAISetRiskConfigurationResponse)

#endif // OAISetRiskConfigurationResponse_H
