...
/*
 * OAIDefaultEmailOptionType.h
 *
 * 
 */

#ifndef OAIDefaultEmailOptionType_H
#define OAIDefaultEmailOptionType_H
...
class OAIDefaultEmailOptionType : public OAIEnum {
public:
    OAIDefaultEmailOptionType();
    OAIDefaultEmailOptionType(QString json);
    ~OAIDefaultEmailOptionType() override;
    ...
    enum class eOAIDefaultEmailOptionType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        LINK, 
        CODE
    };
    OAIDefaultEmailOptionType::eOAIDefaultEmailOptionType getValue() const;
    void setValue(const OAIDefaultEmailOptionType::eOAIDefaultEmailOptionType& value);
...
private:
    ...
    eOAIDefaultEmailOptionType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDefaultEmailOptionType)

#endif // OAIDefaultEmailOptionType_H
