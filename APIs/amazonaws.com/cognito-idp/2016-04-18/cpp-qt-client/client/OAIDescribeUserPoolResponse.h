...
/*
 * OAIDescribeUserPoolResponse.h
 *
 * Represents the response to describe the user pool.
 */

#ifndef OAIDescribeUserPoolResponse_H
#define OAIDescribeUserPoolResponse_H
...
namespace OpenAPI {
class OAIDescribeUserPoolResponse_UserPool;

class OAIDescribeUserPoolResponse : public OAIObject {
public:
    OAIDescribeUserPoolResponse();
    OAIDescribeUserPoolResponse(QString json);
    ~OAIDescribeUserPoolResponse() override;
    ...
    OAIDescribeUserPoolResponse_UserPool getUserPool() const;
    void setUserPool(const OAIDescribeUserPoolResponse_UserPool &user_pool);
...
private:
    ...
    OAIDescribeUserPoolResponse_UserPool m_user_pool;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeUserPoolResponse)

#endif // OAIDescribeUserPoolResponse_H
