...
/*
 * OAIResourceServerType.h
 *
 * A container for information about a resource server for a user pool.
 */

#ifndef OAIResourceServerType_H
#define OAIResourceServerType_H
...
class OAIResourceServerType : public OAIObject {
public:
    OAIResourceServerType();
    OAIResourceServerType(QString json);
    ~OAIResourceServerType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResourceServerType)

#endif // OAIResourceServerType_H
