...
/*
 * OAICreateUserPoolClientRequest.h
 *
 * Represents the request to create a user pool client.
 */

#ifndef OAICreateUserPoolClientRequest_H
#define OAICreateUserPoolClientRequest_H

#include <QJsonObject>

#include "OAICreateUserPoolClientRequest_AnalyticsConfiguration.h"
#include "OAICreateUserPoolClientRequest_TokenValidityUnits.h"
...
namespace OpenAPI {
class OAICreateUserPoolClientRequest_TokenValidityUnits;
class OAICreateUserPoolClientRequest_AnalyticsConfiguration;

class OAICreateUserPoolClientRequest : public OAIObject {
public:
    OAICreateUserPoolClientRequest();
    OAICreateUserPoolClientRequest(QString json);
    ~OAICreateUserPoolClientRequest() override;
    ...
    OAICreateUserPoolClientRequest_TokenValidityUnits getTokenValidityUnits() const;
    void setTokenValidityUnits(const OAICreateUserPoolClientRequest_TokenValidityUnits &token_validity_units);
    ...
    OAICreateUserPoolClientRequest_AnalyticsConfiguration getAnalyticsConfiguration() const;
    void setAnalyticsConfiguration(const OAICreateUserPoolClientRequest_AnalyticsConfiguration &analytics_configuration);
...
private:
    ...
    OAICreateUserPoolClientRequest_TokenValidityUnits m_token_validity_units;
    ...
    OAICreateUserPoolClientRequest_AnalyticsConfiguration m_analytics_configuration;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateUserPoolClientRequest)

#endif // OAICreateUserPoolClientRequest_H
