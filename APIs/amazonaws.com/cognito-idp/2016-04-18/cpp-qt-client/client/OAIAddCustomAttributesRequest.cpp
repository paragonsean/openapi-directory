...
OAIAddCustomAttributesRequest::OAIAddCustomAttributesRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAddCustomAttributesRequest::OAIAddCustomAttributesRequest() {
    this->initializeModel();
}

OAIAddCustomAttributesRequest::~OAIAddCustomAttributesRequest() {}

void OAIAddCustomAttributesRequest::initializeModel() {
...
void OAIAddCustomAttributesRequest::fromJson(QString jsonString) {
...
void OAIAddCustomAttributesRequest::fromJsonObject(QJsonObject json) {
...
QString OAIAddCustomAttributesRequest::asJson() const {
...
QJsonObject OAIAddCustomAttributesRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAddCustomAttributesRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIAddCustomAttributesRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIAddCustomAttributesRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIAddCustomAttributesRequest::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

QList OAIAddCustomAttributesRequest::getCustomAttributes() const {
    return m_custom_attributes;
}
void OAIAddCustomAttributesRequest::setCustomAttributes(const QList &custom_attributes) {
    m_custom_attributes = custom_attributes;
    m_custom_attributes_isSet = true;
}

bool OAIAddCustomAttributesRequest::is_custom_attributes_Set() const{
    return m_custom_attributes_isSet;
}

bool OAIAddCustomAttributesRequest::is_custom_attributes_Valid() const{
    return m_custom_attributes_isValid;
}

bool OAIAddCustomAttributesRequest::isSet() const {
...
bool OAIAddCustomAttributesRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_user_pool_id_isValid && m_custom_attributes_isValid && true;
}
