...
OAIDescribeResourceServerRequest::OAIDescribeResourceServerRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeResourceServerRequest::OAIDescribeResourceServerRequest() {
    this->initializeModel();
}

OAIDescribeResourceServerRequest::~OAIDescribeResourceServerRequest() {}

void OAIDescribeResourceServerRequest::initializeModel() {
...
void OAIDescribeResourceServerRequest::fromJson(QString jsonString) {
...
void OAIDescribeResourceServerRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeResourceServerRequest::asJson() const {
...
QJsonObject OAIDescribeResourceServerRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeResourceServerRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIDescribeResourceServerRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIDescribeResourceServerRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIDescribeResourceServerRequest::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

QString OAIDescribeResourceServerRequest::getIdentifier() const {
    return m_identifier;
}
void OAIDescribeResourceServerRequest::setIdentifier(const QString &identifier) {
    m_identifier = identifier;
    m_identifier_isSet = true;
}

bool OAIDescribeResourceServerRequest::is_identifier_Set() const{
    return m_identifier_isSet;
}

bool OAIDescribeResourceServerRequest::is_identifier_Valid() const{
    return m_identifier_isValid;
}

bool OAIDescribeResourceServerRequest::isSet() const {
...
bool OAIDescribeResourceServerRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_user_pool_id_isValid && m_identifier_isValid && true;
}
