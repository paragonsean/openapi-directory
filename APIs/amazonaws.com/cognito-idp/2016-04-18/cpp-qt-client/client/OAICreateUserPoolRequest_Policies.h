...
/*
 * OAICreateUserPoolRequest_Policies.h
 *
 * 
 */

#ifndef OAICreateUserPoolRequest_Policies_H
#define OAICreateUserPoolRequest_Policies_H
...
namespace OpenAPI {
class OAIUserPoolPolicyType_PasswordPolicy;

class OAICreateUserPoolRequest_Policies : public OAIObject {
public:
    OAICreateUserPoolRequest_Policies();
    OAICreateUserPoolRequest_Policies(QString json);
    ~OAICreateUserPoolRequest_Policies() override;
    ...
    OAIUserPoolPolicyType_PasswordPolicy getPasswordPolicy() const;
    void setPasswordPolicy(const OAIUserPoolPolicyType_PasswordPolicy &password_policy);
...
private:
    ...
    OAIUserPoolPolicyType_PasswordPolicy m_password_policy;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateUserPoolRequest_Policies)

#endif // OAICreateUserPoolRequest_Policies_H
