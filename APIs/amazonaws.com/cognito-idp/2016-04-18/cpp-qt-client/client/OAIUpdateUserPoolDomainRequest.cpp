...
OAIUpdateUserPoolDomainRequest::OAIUpdateUserPoolDomainRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateUserPoolDomainRequest::OAIUpdateUserPoolDomainRequest() {
    this->initializeModel();
}

OAIUpdateUserPoolDomainRequest::~OAIUpdateUserPoolDomainRequest() {}

void OAIUpdateUserPoolDomainRequest::initializeModel() {
...
void OAIUpdateUserPoolDomainRequest::fromJson(QString jsonString) {
...
void OAIUpdateUserPoolDomainRequest::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateUserPoolDomainRequest::asJson() const {
...
QJsonObject OAIUpdateUserPoolDomainRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_domain_isSet) {
...
QString OAIUpdateUserPoolDomainRequest::getDomain() const {
    return m_domain;
}
void OAIUpdateUserPoolDomainRequest::setDomain(const QString &domain) {
    m_domain = domain;
    m_domain_isSet = true;
}

bool OAIUpdateUserPoolDomainRequest::is_domain_Set() const{
    return m_domain_isSet;
}

bool OAIUpdateUserPoolDomainRequest::is_domain_Valid() const{
    return m_domain_isValid;
}

QString OAIUpdateUserPoolDomainRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIUpdateUserPoolDomainRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIUpdateUserPoolDomainRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIUpdateUserPoolDomainRequest::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

OAIUpdateUserPoolDomainRequest_CustomDomainConfig OAIUpdateUserPoolDomainRequest::getCustomDomainConfig() const {
    return m_custom_domain_config;
}
void OAIUpdateUserPoolDomainRequest::setCustomDomainConfig(const OAIUpdateUserPoolDomainRequest_CustomDomainConfig &custom_domain_config) {
    m_custom_domain_config = custom_domain_config;
    m_custom_domain_config_isSet = true;
}

bool OAIUpdateUserPoolDomainRequest::is_custom_domain_config_Set() const{
    return m_custom_domain_config_isSet;
}

bool OAIUpdateUserPoolDomainRequest::is_custom_domain_config_Valid() const{
    return m_custom_domain_config_isValid;
}

bool OAIUpdateUserPoolDomainRequest::isSet() const {
...
bool OAIUpdateUserPoolDomainRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_domain_isValid && m_user_pool_id_isValid && m_custom_domain_config_isValid && true;
}
