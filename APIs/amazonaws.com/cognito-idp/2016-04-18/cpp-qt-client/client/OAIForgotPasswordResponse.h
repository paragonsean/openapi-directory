...
/*
 * OAIForgotPasswordResponse.h
 *
 * The response from Amazon Cognito to a request to reset a password.
 */

#ifndef OAIForgotPasswordResponse_H
#define OAIForgotPasswordResponse_H
...
namespace OpenAPI {
class OAIForgotPasswordResponse_CodeDeliveryDetails;

class OAIForgotPasswordResponse : public OAIObject {
public:
    OAIForgotPasswordResponse();
    OAIForgotPasswordResponse(QString json);
    ~OAIForgotPasswordResponse() override;
    ...
    OAIForgotPasswordResponse_CodeDeliveryDetails getCodeDeliveryDetails() const;
    void setCodeDeliveryDetails(const OAIForgotPasswordResponse_CodeDeliveryDetails &code_delivery_details);
...
private:
    ...
    OAIForgotPasswordResponse_CodeDeliveryDetails m_code_delivery_details;
...
Q_DECLARE_METATYPE(OpenAPI::OAIForgotPasswordResponse)

#endif // OAIForgotPasswordResponse_H
