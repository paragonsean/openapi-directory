...
/*
 * OAIRiskExceptionConfigurationType.h
 *
 * The type of the configuration to override the risk decision.
 */

#ifndef OAIRiskExceptionConfigurationType_H
#define OAIRiskExceptionConfigurationType_H
...
class OAIRiskExceptionConfigurationType : public OAIObject {
public:
    OAIRiskExceptionConfigurationType();
    OAIRiskExceptionConfigurationType(QString json);
    ~OAIRiskExceptionConfigurationType() override;
    ...
    QList getBlockedIpRangeList() const;
    void setBlockedIpRangeList(const QList &blocked_ip_range_list);
    bool is_blocked_ip_range_list_Set() const;
    bool is_blocked_ip_range_list_Valid() const;

    QList getSkippedIpRangeList() const;
    void setSkippedIpRangeList(const QList &skipped_ip_range_list);
    bool is_skipped_ip_range_list_Set() const;
    bool is_skipped_ip_range_list_Valid() const;
...
private:
    ...
    QList m_blocked_ip_range_list;
    bool m_blocked_ip_range_list_isSet;
    bool m_blocked_ip_range_list_isValid;

    QList m_skipped_ip_range_list;
    bool m_skipped_ip_range_list_isSet;
    bool m_skipped_ip_range_list_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIRiskExceptionConfigurationType)

#endif // OAIRiskExceptionConfigurationType_H
