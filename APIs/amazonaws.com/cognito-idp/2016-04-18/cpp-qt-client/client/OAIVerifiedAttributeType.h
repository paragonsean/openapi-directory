...
/*
 * OAIVerifiedAttributeType.h
 *
 * 
 */

#ifndef OAIVerifiedAttributeType_H
#define OAIVerifiedAttributeType_H
...
class OAIVerifiedAttributeType : public OAIEnum {
public:
    OAIVerifiedAttributeType();
    OAIVerifiedAttributeType(QString json);
    ~OAIVerifiedAttributeType() override;
    ...
    enum class eOAIVerifiedAttributeType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        PHONE_NUMBER, 
        EMAIL
    };
    OAIVerifiedAttributeType::eOAIVerifiedAttributeType getValue() const;
    void setValue(const OAIVerifiedAttributeType::eOAIVerifiedAttributeType& value);
...
private:
    ...
    eOAIVerifiedAttributeType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVerifiedAttributeType)

#endif // OAIVerifiedAttributeType_H
