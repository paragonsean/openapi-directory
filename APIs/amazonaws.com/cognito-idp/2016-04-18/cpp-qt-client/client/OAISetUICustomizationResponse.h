...
/*
 * OAISetUICustomizationResponse.h
 *
 * 
 */

#ifndef OAISetUICustomizationResponse_H
#define OAISetUICustomizationResponse_H

#include <QJsonObject>

#include "OAIGetUICustomizationResponse_UICustomization.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIGetUICustomizationResponse_UICustomization;

class OAISetUICustomizationResponse : public OAIObject {
public:
    OAISetUICustomizationResponse();
    OAISetUICustomizationResponse(QString json);
    ~OAISetUICustomizationResponse() override;
    ...
    OAIGetUICustomizationResponse_UICustomization getUiCustomization() const;
    void setUiCustomization(const OAIGetUICustomizationResponse_UICustomization &ui_customization);
    bool is_ui_customization_Set() const;
    bool is_ui_customization_Valid() const;
...
private:
    ...
    OAIGetUICustomizationResponse_UICustomization m_ui_customization;
    bool m_ui_customization_isSet;
    bool m_ui_customization_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAISetUICustomizationResponse)

#endif // OAISetUICustomizationResponse_H
