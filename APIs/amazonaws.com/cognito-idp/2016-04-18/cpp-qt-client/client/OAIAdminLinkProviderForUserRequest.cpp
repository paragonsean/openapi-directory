...
OAIAdminLinkProviderForUserRequest::OAIAdminLinkProviderForUserRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdminLinkProviderForUserRequest::OAIAdminLinkProviderForUserRequest() {
    this->initializeModel();
}

OAIAdminLinkProviderForUserRequest::~OAIAdminLinkProviderForUserRequest() {}

void OAIAdminLinkProviderForUserRequest::initializeModel() {
...
void OAIAdminLinkProviderForUserRequest::fromJson(QString jsonString) {
...
void OAIAdminLinkProviderForUserRequest::fromJsonObject(QJsonObject json) {
    ...
    m_destination_user_isValid = ::OpenAPI::fromJsonValue(m_destination_user, json[QString("DestinationUser")]);
    m_destination_user_isSet = !json[QString("DestinationUser")].isNull() && m_destination_user_isValid;

    m_source_user_isValid = ::OpenAPI::fromJsonValue(m_source_user, json[QString("SourceUser")]);
    m_source_user_isSet = !json[QString("SourceUser")].isNull() && m_source_user_isValid;
}

QString OAIAdminLinkProviderForUserRequest::asJson() const {
...
QJsonObject OAIAdminLinkProviderForUserRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_user_pool_id_isSet) {
        obj.insert(QString("UserPoolId"), ::OpenAPI::toJsonValue(m_user_pool_id));
    }
    if (m_destination_user.isSet()) {
        obj.insert(QString("DestinationUser"), ::OpenAPI::toJsonValue(m_destination_user));
    }
    if (m_source_user.isSet()) {
        obj.insert(QString("SourceUser"), ::OpenAPI::toJsonValue(m_source_user));
    }
    return obj;
}

QString OAIAdminLinkProviderForUserRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIAdminLinkProviderForUserRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIAdminLinkProviderForUserRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIAdminLinkProviderForUserRequest::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

OAIAdminLinkProviderForUserRequest_DestinationUser OAIAdminLinkProviderForUserRequest::getDestinationUser() const {
    return m_destination_user;
}
void OAIAdminLinkProviderForUserRequest::setDestinationUser(const OAIAdminLinkProviderForUserRequest_DestinationUser &destination_user) {
    m_destination_user = destination_user;
    m_destination_user_isSet = true;
}

bool OAIAdminLinkProviderForUserRequest::is_destination_user_Set() const{
    return m_destination_user_isSet;
}

bool OAIAdminLinkProviderForUserRequest::is_destination_user_Valid() const{
    return m_destination_user_isValid;
}

OAIAdminLinkProviderForUserRequest_SourceUser OAIAdminLinkProviderForUserRequest::getSourceUser() const {
    return m_source_user;
}
void OAIAdminLinkProviderForUserRequest::setSourceUser(const OAIAdminLinkProviderForUserRequest_SourceUser &source_user) {
    m_source_user = source_user;
    m_source_user_isSet = true;
}

bool OAIAdminLinkProviderForUserRequest::is_source_user_Set() const{
    return m_source_user_isSet;
}

bool OAIAdminLinkProviderForUserRequest::is_source_user_Valid() const{
    return m_source_user_isValid;
}

bool OAIAdminLinkProviderForUserRequest::isSet() const {
...
bool OAIAdminLinkProviderForUserRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_user_pool_id_isValid && m_destination_user_isValid && m_source_user_isValid && true;
}
