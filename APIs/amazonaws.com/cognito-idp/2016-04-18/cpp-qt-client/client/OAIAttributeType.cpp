...
void OAIAttributeType::fromJsonObject(QJsonObject json) {
...
QJsonObject OAIAttributeType::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIAttributeType::getName() const {
    return m_name;
}
void OAIAttributeType::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIAttributeType::is_name_Set() const{
    return m_name_isSet;
}

bool OAIAttributeType::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIAttributeType::getValue() const {
    return m_value;
}
void OAIAttributeType::setValue(const QString &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIAttributeType::is_value_Set() const{
    return m_value_isSet;
}

bool OAIAttributeType::is_value_Valid() const{
