...
#include "OAIAttributeDataType.h"
#include "OAISchemaAttributeType_NumberAttributeConstraints.h"
...
namespace OpenAPI {
class OAISchemaAttributeType_NumberAttributeConstraints;
class OAISchemaAttributeType_StringAttributeConstraints;

class OAISchemaAttributeType : public OAIObject {
public:
    ...
    OAIAttributeDataType getAttributeDataType() const;
    void setAttributeDataType(const OAIAttributeDataType &attribute_data_type);
    bool is_attribute_data_type_Set() const;
    bool is_attribute_data_type_Valid() const;

    bool getDeveloperOnlyAttribute() const;
    void setDeveloperOnlyAttribute(const bool &developer_only_attribute);
    bool is_developer_only_attribute_Set() const;
    bool is_developer_only_attribute_Valid() const;

    bool getRMutable() const;
    void setRMutable(const bool &r_mutable);
    ...
    OAISchemaAttributeType_NumberAttributeConstraints getNumberAttributeConstraints() const;
    void setNumberAttributeConstraints(const OAISchemaAttributeType_NumberAttributeConstraints &number_attribute_constraints);
    bool is_number_attribute_constraints_Set() const;
    bool is_number_attribute_constraints_Valid() const;

    OAISchemaAttributeType_StringAttributeConstraints getStringAttributeConstraints() const;
    void setStringAttributeConstraints(const OAISchemaAttributeType_StringAttributeConstraints &string_attribute_constraints);
    bool is_string_attribute_constraints_Set() const;
    bool is_string_attribute_constraints_Valid() const;
...
private:
    ...
    OAIAttributeDataType m_attribute_data_type;
    bool m_attribute_data_type_isSet;
    bool m_attribute_data_type_isValid;

    bool m_developer_only_attribute;
    bool m_developer_only_attribute_isSet;
    bool m_developer_only_attribute_isValid;
    ...
    OAISchemaAttributeType_NumberAttributeConstraints m_number_attribute_constraints;
    bool m_number_attribute_constraints_isSet;
    bool m_number_attribute_constraints_isValid;

    OAISchemaAttributeType_StringAttributeConstraints m_string_attribute_constraints;
    bool m_string_attribute_constraints_isSet;
    bool m_string_attribute_constraints_isValid;
};
