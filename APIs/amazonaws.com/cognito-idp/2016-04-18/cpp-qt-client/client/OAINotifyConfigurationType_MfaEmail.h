...
/*
 * OAINotifyConfigurationType_MfaEmail.h
 *
 * 
 */

#ifndef OAINotifyConfigurationType_MfaEmail_H
#define OAINotifyConfigurationType_MfaEmail_H
...
class OAINotifyConfigurationType_MfaEmail : public OAIObject {
public:
    OAINotifyConfigurationType_MfaEmail();
    OAINotifyConfigurationType_MfaEmail(QString json);
    ~OAINotifyConfigurationType_MfaEmail() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINotifyConfigurationType_MfaEmail)

#endif // OAINotifyConfigurationType_MfaEmail_H
