...
OAIResendConfirmationCodeResponse::OAIResendConfirmationCodeResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIResendConfirmationCodeResponse::OAIResendConfirmationCodeResponse() {
    this->initializeModel();
}

OAIResendConfirmationCodeResponse::~OAIResendConfirmationCodeResponse() {}

void OAIResendConfirmationCodeResponse::initializeModel() {

    m_code_delivery_details_isSet = false;
    m_code_delivery_details_isValid = false;
}

void OAIResendConfirmationCodeResponse::fromJson(QString jsonString) {
...
void OAIResendConfirmationCodeResponse::fromJsonObject(QJsonObject json) {
...
QString OAIResendConfirmationCodeResponse::asJson() const {
...
QJsonObject OAIResendConfirmationCodeResponse::asJsonObject() const {
    QJsonObject obj;
...
OAIResendConfirmationCodeResponse_CodeDeliveryDetails OAIResendConfirmationCodeResponse::getCodeDeliveryDetails() const {
    return m_code_delivery_details;
}
void OAIResendConfirmationCodeResponse::setCodeDeliveryDetails(const OAIResendConfirmationCodeResponse_CodeDeliveryDetails &code_delivery_details) {
    m_code_delivery_details = code_delivery_details;
    m_code_delivery_details_isSet = true;
}

bool OAIResendConfirmationCodeResponse::is_code_delivery_details_Set() const{
    return m_code_delivery_details_isSet;
}

bool OAIResendConfirmationCodeResponse::is_code_delivery_details_Valid() const{
    return m_code_delivery_details_isValid;
}

bool OAIResendConfirmationCodeResponse::isSet() const {
...
bool OAIResendConfirmationCodeResponse::isValid() const {
