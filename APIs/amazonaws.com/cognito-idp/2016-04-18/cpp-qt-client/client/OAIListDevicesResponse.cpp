...
QString OAIListDevicesResponse::getPaginationToken() const {
    return m_pagination_token;
}
void OAIListDevicesResponse::setPaginationToken(const QString &pagination_token) {
    m_pagination_token = pagination_token;
    m_pagination_token_isSet = true;
}

bool OAIListDevicesResponse::is_pagination_token_Set() const{
    return m_pagination_token_isSet;
}

bool OAIListDevicesResponse::is_pagination_token_Valid() const{
