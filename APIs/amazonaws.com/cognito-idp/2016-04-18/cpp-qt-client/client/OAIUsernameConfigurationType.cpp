...
#include "OAIUsernameConfigurationType.h"
...
OAIUsernameConfigurationType::OAIUsernameConfigurationType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUsernameConfigurationType::OAIUsernameConfigurationType() {
    this->initializeModel();
}

OAIUsernameConfigurationType::~OAIUsernameConfigurationType() {}

void OAIUsernameConfigurationType::initializeModel() {

    m_case_sensitive_isSet = false;
    m_case_sensitive_isValid = false;
}

void OAIUsernameConfigurationType::fromJson(QString jsonString) {
...
void OAIUsernameConfigurationType::fromJsonObject(QJsonObject json) {
...
QString OAIUsernameConfigurationType::asJson() const {
...
QJsonObject OAIUsernameConfigurationType::asJsonObject() const {
    QJsonObject obj;
...
bool OAIUsernameConfigurationType::getCaseSensitive() const {
    return m_case_sensitive;
}
void OAIUsernameConfigurationType::setCaseSensitive(const bool &case_sensitive) {
    m_case_sensitive = case_sensitive;
    m_case_sensitive_isSet = true;
}

bool OAIUsernameConfigurationType::is_case_sensitive_Set() const{
    return m_case_sensitive_isSet;
}

bool OAIUsernameConfigurationType::is_case_sensitive_Valid() const{
    return m_case_sensitive_isValid;
}

bool OAIUsernameConfigurationType::isSet() const {
...
bool OAIUsernameConfigurationType::isValid() const {
