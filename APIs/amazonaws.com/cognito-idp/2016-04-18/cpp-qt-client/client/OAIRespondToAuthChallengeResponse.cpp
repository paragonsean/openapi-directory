...
OAIRespondToAuthChallengeResponse::OAIRespondToAuthChallengeResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRespondToAuthChallengeResponse::OAIRespondToAuthChallengeResponse() {
    this->initializeModel();
}

OAIRespondToAuthChallengeResponse::~OAIRespondToAuthChallengeResponse() {}

void OAIRespondToAuthChallengeResponse::initializeModel() {
    ...
    m_challenge_parameters_isSet = false;
    m_challenge_parameters_isValid = false;

    m_authentication_result_isSet = false;
    m_authentication_result_isValid = false;
}

void OAIRespondToAuthChallengeResponse::fromJson(QString jsonString) {
...
void OAIRespondToAuthChallengeResponse::fromJsonObject(QJsonObject json) {
    ...
    m_challenge_parameters_isValid = ::OpenAPI::fromJsonValue(m_challenge_parameters, json[QString("ChallengeParameters")]);
    m_challenge_parameters_isSet = !json[QString("ChallengeParameters")].isNull() && m_challenge_parameters_isValid;
...
QString OAIRespondToAuthChallengeResponse::asJson() const {
...
QJsonObject OAIRespondToAuthChallengeResponse::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_challenge_parameters.isSet()) {
        obj.insert(QString("ChallengeParameters"), ::OpenAPI::toJsonValue(m_challenge_parameters));
    }
...
OAIChallengeNameType OAIRespondToAuthChallengeResponse::getChallengeName() const {
    return m_challenge_name;
}
void OAIRespondToAuthChallengeResponse::setChallengeName(const OAIChallengeNameType &challenge_name) {
    m_challenge_name = challenge_name;
    m_challenge_name_isSet = true;
}

bool OAIRespondToAuthChallengeResponse::is_challenge_name_Set() const{
    return m_challenge_name_isSet;
}

bool OAIRespondToAuthChallengeResponse::is_challenge_name_Valid() const{
    return m_challenge_name_isValid;
}

QString OAIRespondToAuthChallengeResponse::getSession() const {
    return m_session;
}
void OAIRespondToAuthChallengeResponse::setSession(const QString &session) {
    m_session = session;
    m_session_isSet = true;
}

bool OAIRespondToAuthChallengeResponse::is_session_Set() const{
    return m_session_isSet;
}

bool OAIRespondToAuthChallengeResponse::is_session_Valid() const{
    return m_session_isValid;
}

QMap OAIRespondToAuthChallengeResponse::getChallengeParameters() const {
    return m_challenge_parameters;
}
void OAIRespondToAuthChallengeResponse::setChallengeParameters(const QMap &challenge_parameters) {
    m_challenge_parameters = challenge_parameters;
    m_challenge_parameters_isSet = true;
}

bool OAIRespondToAuthChallengeResponse::is_challenge_parameters_Set() const{
    return m_challenge_parameters_isSet;
}

bool OAIRespondToAuthChallengeResponse::is_challenge_parameters_Valid() const{
    return m_challenge_parameters_isValid;
}

OAIRespondToAuthChallengeResponse_AuthenticationResult OAIRespondToAuthChallengeResponse::getAuthenticationResult() const {
    return m_authentication_result;
}
void OAIRespondToAuthChallengeResponse::setAuthenticationResult(const OAIRespondToAuthChallengeResponse_AuthenticationResult &authentication_result) {
    m_authentication_result = authentication_result;
    m_authentication_result_isSet = true;
}

bool OAIRespondToAuthChallengeResponse::is_authentication_result_Set() const{
    return m_authentication_result_isSet;
}

bool OAIRespondToAuthChallengeResponse::is_authentication_result_Valid() const{
    return m_authentication_result_isValid;
}

bool OAIRespondToAuthChallengeResponse::isSet() const {
...
bool OAIRespondToAuthChallengeResponse::isValid() const {
