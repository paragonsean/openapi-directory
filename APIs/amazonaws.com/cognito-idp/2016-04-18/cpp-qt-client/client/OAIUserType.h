...
class OAIUserType : public OAIObject {
public:
    OAIUserType();
    ...
    QDateTime getUserCreateDate() const;
    void setUserCreateDate(const QDateTime &user_create_date);
    bool is_user_create_date_Set() const;
    bool is_user_create_date_Valid() const;

    QDateTime getUserLastModifiedDate() const;
    void setUserLastModifiedDate(const QDateTime &user_last_modified_date);
    bool is_user_last_modified_date_Set() const;
    bool is_user_last_modified_date_Valid() const;
    ...
    OAIUserStatusType getUserStatus() const;
    void setUserStatus(const OAIUserStatusType &user_status);
    bool is_user_status_Set() const;
    bool is_user_status_Valid() const;

    QList getMfaOptions() const;
    void setMfaOptions(const QList &mfa_options);
    bool is_mfa_options_Set() const;
    bool is_mfa_options_Valid() const;
...
private:
    ...
    QDateTime m_user_create_date;
    bool m_user_create_date_isSet;
    bool m_user_create_date_isValid;

    QDateTime m_user_last_modified_date;
    bool m_user_last_modified_date_isSet;
    bool m_user_last_modified_date_isValid;

    bool m_enabled;
    bool m_enabled_isSet;
    bool m_enabled_isValid;

    OAIUserStatusType m_user_status;
    bool m_user_status_isSet;
    bool m_user_status_isValid;

    QList m_mfa_options;
    bool m_mfa_options_isSet;
    bool m_mfa_options_isValid;
};
