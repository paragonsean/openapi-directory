...
/*
 * OAICreateUserPoolResponse.h
 *
 * Represents the response from the server for the request to create a user pool.
 */

#ifndef OAICreateUserPoolResponse_H
#define OAICreateUserPoolResponse_H
...
namespace OpenAPI {
class OAICreateUserPoolResponse_UserPool;

class OAICreateUserPoolResponse : public OAIObject {
public:
    OAICreateUserPoolResponse();
    OAICreateUserPoolResponse(QString json);
    ~OAICreateUserPoolResponse() override;
    ...
    OAICreateUserPoolResponse_UserPool getUserPool() const;
    void setUserPool(const OAICreateUserPoolResponse_UserPool &user_pool);
...
private:
    ...
    OAICreateUserPoolResponse_UserPool m_user_pool;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateUserPoolResponse)

#endif // OAICreateUserPoolResponse_H
