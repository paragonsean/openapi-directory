...
/*
 * OAIStartUserImportJobResponse.h
 *
 * Represents the response from the server to the request to start the user import job.
 */

#ifndef OAIStartUserImportJobResponse_H
#define OAIStartUserImportJobResponse_H
...
class OAIStartUserImportJobResponse : public OAIObject {
public:
    OAIStartUserImportJobResponse();
    OAIStartUserImportJobResponse(QString json);
    ~OAIStartUserImportJobResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartUserImportJobResponse)

#endif // OAIStartUserImportJobResponse_H
