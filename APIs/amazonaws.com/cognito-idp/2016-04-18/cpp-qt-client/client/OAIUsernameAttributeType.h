...
/*
 * OAIUsernameAttributeType.h
 *
 * 
 */

#ifndef OAIUsernameAttributeType_H
#define OAIUsernameAttributeType_H
...
class OAIUsernameAttributeType : public OAIEnum {
public:
    OAIUsernameAttributeType();
    OAIUsernameAttributeType(QString json);
    ~OAIUsernameAttributeType() override;
    ...
    enum class eOAIUsernameAttributeType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        PHONE_NUMBER, 
        EMAIL
    };
    OAIUsernameAttributeType::eOAIUsernameAttributeType getValue() const;
    void setValue(const OAIUsernameAttributeType::eOAIUsernameAttributeType& value);
...
private:
    ...
    eOAIUsernameAttributeType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUsernameAttributeType)

#endif // OAIUsernameAttributeType_H
