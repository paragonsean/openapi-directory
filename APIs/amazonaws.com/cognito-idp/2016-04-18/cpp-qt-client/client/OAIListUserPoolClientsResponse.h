...
/*
 * OAIListUserPoolClientsResponse.h
 *
 * Represents the response from the server that lists user pool clients.
 */

#ifndef OAIListUserPoolClientsResponse_H
#define OAIListUserPoolClientsResponse_H
...
class OAIListUserPoolClientsResponse : public OAIObject {
public:
    OAIListUserPoolClientsResponse();
    OAIListUserPoolClientsResponse(QString json);
    ~OAIListUserPoolClientsResponse() override;
    ...
    QList getUserPoolClients() const;
    void setUserPoolClients(const QList &user_pool_clients);
    bool is_user_pool_clients_Set() const;
    bool is_user_pool_clients_Valid() const;
...
private:
    ...
    QList m_user_pool_clients;
    bool m_user_pool_clients_isSet;
    bool m_user_pool_clients_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListUserPoolClientsResponse)

#endif // OAIListUserPoolClientsResponse_H
