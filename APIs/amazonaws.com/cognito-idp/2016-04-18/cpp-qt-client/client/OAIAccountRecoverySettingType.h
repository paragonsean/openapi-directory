...
/*
 * OAIAccountRecoverySettingType.h
 *
 * The data type for &lt;code&gt;AccountRecoverySetting&lt;/code&gt;.
 */

#ifndef OAIAccountRecoverySettingType_H
#define OAIAccountRecoverySettingType_H
...
class OAIAccountRecoverySettingType : public OAIObject {
public:
    OAIAccountRecoverySettingType();
    OAIAccountRecoverySettingType(QString json);
    ~OAIAccountRecoverySettingType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccountRecoverySettingType)

#endif // OAIAccountRecoverySettingType_H
