...
/*
 * OAICreateIdentityProviderResponse.h
 *
 * 
 */

#ifndef OAICreateIdentityProviderResponse_H
#define OAICreateIdentityProviderResponse_H
...
namespace OpenAPI {
class OAICreateIdentityProviderResponse_IdentityProvider;

class OAICreateIdentityProviderResponse : public OAIObject {
public:
    OAICreateIdentityProviderResponse();
    OAICreateIdentityProviderResponse(QString json);
    ~OAICreateIdentityProviderResponse() override;
    ...
    OAICreateIdentityProviderResponse_IdentityProvider getIdentityProvider() const;
    void setIdentityProvider(const OAICreateIdentityProviderResponse_IdentityProvider &identity_provider);
...
private:
    ...
    OAICreateIdentityProviderResponse_IdentityProvider m_identity_provider;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateIdentityProviderResponse)

#endif // OAICreateIdentityProviderResponse_H
