...
#include "OAISoftwareTokenMfaConfigType.h"
...
OAISoftwareTokenMfaConfigType::OAISoftwareTokenMfaConfigType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISoftwareTokenMfaConfigType::OAISoftwareTokenMfaConfigType() {
    this->initializeModel();
}

OAISoftwareTokenMfaConfigType::~OAISoftwareTokenMfaConfigType() {}

void OAISoftwareTokenMfaConfigType::initializeModel() {

    m_enabled_isSet = false;
    m_enabled_isValid = false;
}

void OAISoftwareTokenMfaConfigType::fromJson(QString jsonString) {
...
void OAISoftwareTokenMfaConfigType::fromJsonObject(QJsonObject json) {

    m_enabled_isValid = ::OpenAPI::fromJsonValue(m_enabled, json[QString("Enabled")]);
    m_enabled_isSet = !json[QString("Enabled")].isNull() && m_enabled_isValid;
}

QString OAISoftwareTokenMfaConfigType::asJson() const {
...
QJsonObject OAISoftwareTokenMfaConfigType::asJsonObject() const {
    QJsonObject obj;
    if (m_enabled_isSet) {
...
bool OAISoftwareTokenMfaConfigType::getEnabled() const {
    return m_enabled;
}
void OAISoftwareTokenMfaConfigType::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAISoftwareTokenMfaConfigType::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAISoftwareTokenMfaConfigType::is_enabled_Valid() const{
    return m_enabled_isValid;
}

bool OAISoftwareTokenMfaConfigType::isSet() const {
...
bool OAISoftwareTokenMfaConfigType::isValid() const {
