...
/*
 * OAICreateUserPoolClientRequest_AnalyticsConfiguration.h
 *
 * 
 */

#ifndef OAICreateUserPoolClientRequest_AnalyticsConfiguration_H
#define OAICreateUserPoolClientRequest_AnalyticsConfiguration_H
...
class OAICreateUserPoolClientRequest_AnalyticsConfiguration : public OAIObject {
public:
    OAICreateUserPoolClientRequest_AnalyticsConfiguration();
    OAICreateUserPoolClientRequest_AnalyticsConfiguration(QString json);
    ~OAICreateUserPoolClientRequest_AnalyticsConfiguration() override;
    ...
    bool getUserDataShared() const;
    void setUserDataShared(const bool &user_data_shared);
    bool is_user_data_shared_Set() const;
    bool is_user_data_shared_Valid() const;
...
private:
    ...
    bool m_user_data_shared_isSet;
    bool m_user_data_shared_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICreateUserPoolClientRequest_AnalyticsConfiguration)

#endif // OAICreateUserPoolClientRequest_AnalyticsConfiguration_H
