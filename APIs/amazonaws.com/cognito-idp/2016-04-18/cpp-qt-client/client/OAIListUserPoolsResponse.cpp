...
OAIListUserPoolsResponse::OAIListUserPoolsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListUserPoolsResponse::OAIListUserPoolsResponse() {
    this->initializeModel();
}

OAIListUserPoolsResponse::~OAIListUserPoolsResponse() {}

void OAIListUserPoolsResponse::initializeModel() {

    m_user_pools_isSet = false;
    m_user_pools_isValid = false;

    m_next_token_isSet = false;
    m_next_token_isValid = false;
}

void OAIListUserPoolsResponse::fromJson(QString jsonString) {
...
void OAIListUserPoolsResponse::fromJsonObject(QJsonObject json) {

    m_user_pools_isValid = ::OpenAPI::fromJsonValue(m_user_pools, json[QString("UserPools")]);
    m_user_pools_isSet = !json[QString("UserPools")].isNull() && m_user_pools_isValid;

    m_next_token_isValid = ::OpenAPI::fromJsonValue(m_next_token, json[QString("NextToken")]);
    m_next_token_isSet = !json[QString("NextToken")].isNull() && m_next_token_isValid;
}

QString OAIListUserPoolsResponse::asJson() const {
...
QJsonObject OAIListUserPoolsResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_user_pools.isSet()) {
        obj.insert(QString("UserPools"), ::OpenAPI::toJsonValue(m_user_pools));
    }
...
QList OAIListUserPoolsResponse::getUserPools() const {
    return m_user_pools;
}
void OAIListUserPoolsResponse::setUserPools(const QList &user_pools) {
    m_user_pools = user_pools;
    m_user_pools_isSet = true;
}

bool OAIListUserPoolsResponse::is_user_pools_Set() const{
    return m_user_pools_isSet;
}

bool OAIListUserPoolsResponse::is_user_pools_Valid() const{
    return m_user_pools_isValid;
}

QString OAIListUserPoolsResponse::getNextToken() const {
    return m_next_token;
}
void OAIListUserPoolsResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListUserPoolsResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListUserPoolsResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListUserPoolsResponse::isSet() const {
...
bool OAIListUserPoolsResponse::isValid() const {
