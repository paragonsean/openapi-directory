...
OAIDescribeIdentityProviderResponse_IdentityProvider::OAIDescribeIdentityProviderResponse_IdentityProvider(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeIdentityProviderResponse_IdentityProvider::OAIDescribeIdentityProviderResponse_IdentityProvider() {
    this->initializeModel();
}

OAIDescribeIdentityProviderResponse_IdentityProvider::~OAIDescribeIdentityProviderResponse_IdentityProvider() {}

void OAIDescribeIdentityProviderResponse_IdentityProvider::initializeModel() {
...
void OAIDescribeIdentityProviderResponse_IdentityProvider::fromJson(QString jsonString) {
...
void OAIDescribeIdentityProviderResponse_IdentityProvider::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeIdentityProviderResponse_IdentityProvider::asJson() const {
...
QJsonObject OAIDescribeIdentityProviderResponse_IdentityProvider::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeIdentityProviderResponse_IdentityProvider::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIDescribeIdentityProviderResponse_IdentityProvider::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIDescribeIdentityProviderResponse_IdentityProvider::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIDescribeIdentityProviderResponse_IdentityProvider::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

QString OAIDescribeIdentityProviderResponse_IdentityProvider::getProviderName() const {
    return m_provider_name;
}
void OAIDescribeIdentityProviderResponse_IdentityProvider::setProviderName(const QString &provider_name) {
    m_provider_name = provider_name;
    m_provider_name_isSet = true;
}

bool OAIDescribeIdentityProviderResponse_IdentityProvider::is_provider_name_Set() const{
    return m_provider_name_isSet;
}

bool OAIDescribeIdentityProviderResponse_IdentityProvider::is_provider_name_Valid() const{
    return m_provider_name_isValid;
}

OAIIdentityProviderTypeType OAIDescribeIdentityProviderResponse_IdentityProvider::getProviderType() const {
    return m_provider_type;
}
void OAIDescribeIdentityProviderResponse_IdentityProvider::setProviderType(const OAIIdentityProviderTypeType &provider_type) {
    m_provider_type = provider_type;
    m_provider_type_isSet = true;
}

bool OAIDescribeIdentityProviderResponse_IdentityProvider::is_provider_type_Set() const{
    return m_provider_type_isSet;
}

bool OAIDescribeIdentityProviderResponse_IdentityProvider::is_provider_type_Valid() const{
    return m_provider_type_isValid;
}

QMap OAIDescribeIdentityProviderResponse_IdentityProvider::getProviderDetails() const {
    return m_provider_details;
}
void OAIDescribeIdentityProviderResponse_IdentityProvider::setProviderDetails(const QMap &provider_details) {
    m_provider_details = provider_details;
    m_provider_details_isSet = true;
}

bool OAIDescribeIdentityProviderResponse_IdentityProvider::is_provider_details_Set() const{
    return m_provider_details_isSet;
}

bool OAIDescribeIdentityProviderResponse_IdentityProvider::is_provider_details_Valid() const{
    return m_provider_details_isValid;
}

QMap OAIDescribeIdentityProviderResponse_IdentityProvider::getAttributeMapping() const {
    return m_attribute_mapping;
}
void OAIDescribeIdentityProviderResponse_IdentityProvider::setAttributeMapping(const QMap &attribute_mapping) {
    m_attribute_mapping = attribute_mapping;
    m_attribute_mapping_isSet = true;
}

bool OAIDescribeIdentityProviderResponse_IdentityProvider::is_attribute_mapping_Set() const{
    return m_attribute_mapping_isSet;
}

bool OAIDescribeIdentityProviderResponse_IdentityProvider::is_attribute_mapping_Valid() const{
    return m_attribute_mapping_isValid;
}

QList OAIDescribeIdentityProviderResponse_IdentityProvider::getIdpIdentifiers() const {
    return m_idp_identifiers;
}
void OAIDescribeIdentityProviderResponse_IdentityProvider::setIdpIdentifiers(const QList &idp_identifiers) {
    m_idp_identifiers = idp_identifiers;
    m_idp_identifiers_isSet = true;
}

bool OAIDescribeIdentityProviderResponse_IdentityProvider::is_idp_identifiers_Set() const{
    return m_idp_identifiers_isSet;
}

bool OAIDescribeIdentityProviderResponse_IdentityProvider::is_idp_identifiers_Valid() const{
    return m_idp_identifiers_isValid;
}

QDateTime OAIDescribeIdentityProviderResponse_IdentityProvider::getLastModifiedDate() const {
    return m_last_modified_date;
}
void OAIDescribeIdentityProviderResponse_IdentityProvider::setLastModifiedDate(const QDateTime &last_modified_date) {
    m_last_modified_date = last_modified_date;
    m_last_modified_date_isSet = true;
}

bool OAIDescribeIdentityProviderResponse_IdentityProvider::is_last_modified_date_Set() const{
    return m_last_modified_date_isSet;
}

bool OAIDescribeIdentityProviderResponse_IdentityProvider::is_last_modified_date_Valid() const{
    return m_last_modified_date_isValid;
}

QDateTime OAIDescribeIdentityProviderResponse_IdentityProvider::getCreationDate() const {
    return m_creation_date;
}
void OAIDescribeIdentityProviderResponse_IdentityProvider::setCreationDate(const QDateTime &creation_date) {
    m_creation_date = creation_date;
    m_creation_date_isSet = true;
}

bool OAIDescribeIdentityProviderResponse_IdentityProvider::is_creation_date_Set() const{
    return m_creation_date_isSet;
}

bool OAIDescribeIdentityProviderResponse_IdentityProvider::is_creation_date_Valid() const{
    return m_creation_date_isValid;
}

bool OAIDescribeIdentityProviderResponse_IdentityProvider::isSet() const {
...
bool OAIDescribeIdentityProviderResponse_IdentityProvider::isValid() const {
