...
/*
 * OAIFeedbackValueType.h
 *
 * 
 */

#ifndef OAIFeedbackValueType_H
#define OAIFeedbackValueType_H
...
class OAIFeedbackValueType : public OAIEnum {
public:
    OAIFeedbackValueType();
    OAIFeedbackValueType(QString json);
    ~OAIFeedbackValueType() override;
    ...
    enum class eOAIFeedbackValueType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        VALID, 
        INVALID
    };
    OAIFeedbackValueType::eOAIFeedbackValueType getValue() const;
    void setValue(const OAIFeedbackValueType::eOAIFeedbackValueType& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIFeedbackValueType)

#endif // OAIFeedbackValueType_H
