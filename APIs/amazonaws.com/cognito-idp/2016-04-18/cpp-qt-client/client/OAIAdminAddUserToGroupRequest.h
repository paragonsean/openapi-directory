...
/*
 * OAIAdminAddUserToGroupRequest.h
 *
 * 
 */

#ifndef OAIAdminAddUserToGroupRequest_H
#define OAIAdminAddUserToGroupRequest_H
...
class OAIAdminAddUserToGroupRequest : public OAIObject {
public:
    OAIAdminAddUserToGroupRequest();
    OAIAdminAddUserToGroupRequest(QString json);
    ~OAIAdminAddUserToGroupRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdminAddUserToGroupRequest)

#endif // OAIAdminAddUserToGroupRequest_H
