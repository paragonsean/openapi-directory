...
OAIDeliveryMediumType::OAIDeliveryMediumType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeliveryMediumType::OAIDeliveryMediumType() {
    this->initializeModel();
}

OAIDeliveryMediumType::~OAIDeliveryMediumType() {}

void OAIDeliveryMediumType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIDeliveryMediumType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIDeliveryMediumType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("SMS", Qt::CaseInsensitive) == 0) {
        m_value = eOAIDeliveryMediumType::SMS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("EMAIL", Qt::CaseInsensitive) == 0) {
        m_value = eOAIDeliveryMediumType::EMAIL;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIDeliveryMediumType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIDeliveryMediumType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIDeliveryMediumType::SMS:
            val = "SMS";
            break;
        case eOAIDeliveryMediumType::EMAIL:
            val = "EMAIL";
            break;
        default:
            break;
...
QJsonValue OAIDeliveryMediumType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIDeliveryMediumType::eOAIDeliveryMediumType OAIDeliveryMediumType::getValue() const {
    return m_value;
}

void OAIDeliveryMediumType::setValue(const OAIDeliveryMediumType::eOAIDeliveryMediumType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIDeliveryMediumType::isSet() const {
    
    return m_value_isSet;
}

bool OAIDeliveryMediumType::isValid() const {
