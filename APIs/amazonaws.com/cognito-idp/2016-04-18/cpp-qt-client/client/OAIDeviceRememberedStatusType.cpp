...
#include "OAIDeviceRememberedStatusType.h"
...
OAIDeviceRememberedStatusType::OAIDeviceRememberedStatusType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeviceRememberedStatusType::OAIDeviceRememberedStatusType() {
    this->initializeModel();
}

OAIDeviceRememberedStatusType::~OAIDeviceRememberedStatusType() {}

void OAIDeviceRememberedStatusType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIDeviceRememberedStatusType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIDeviceRememberedStatusType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("remembered", Qt::CaseInsensitive) == 0) {
        m_value = eOAIDeviceRememberedStatusType::REMEMBERED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("not_remembered", Qt::CaseInsensitive) == 0) {
        m_value = eOAIDeviceRememberedStatusType::NOT_REMEMBERED;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIDeviceRememberedStatusType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIDeviceRememberedStatusType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIDeviceRememberedStatusType::REMEMBERED:
            val = "remembered";
            break;
        case eOAIDeviceRememberedStatusType::NOT_REMEMBERED:
            val = "not_remembered";
            break;
        default:
            break;
...
QJsonValue OAIDeviceRememberedStatusType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIDeviceRememberedStatusType::eOAIDeviceRememberedStatusType OAIDeviceRememberedStatusType::getValue() const {
    return m_value;
}

void OAIDeviceRememberedStatusType::setValue(const OAIDeviceRememberedStatusType::eOAIDeviceRememberedStatusType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIDeviceRememberedStatusType::isSet() const {
    
    return m_value_isSet;
}

bool OAIDeviceRememberedStatusType::isValid() const {
