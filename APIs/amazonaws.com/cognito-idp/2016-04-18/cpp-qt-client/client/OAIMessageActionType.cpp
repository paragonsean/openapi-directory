...
#include "OAIMessageActionType.h"
...
OAIMessageActionType::OAIMessageActionType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMessageActionType::OAIMessageActionType() {
    this->initializeModel();
}

OAIMessageActionType::~OAIMessageActionType() {}

void OAIMessageActionType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIMessageActionType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIMessageActionType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("RESEND", Qt::CaseInsensitive) == 0) {
        m_value = eOAIMessageActionType::RESEND;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("SUPPRESS", Qt::CaseInsensitive) == 0) {
        m_value = eOAIMessageActionType::SUPPRESS;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIMessageActionType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIMessageActionType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIMessageActionType::RESEND:
            val = "RESEND";
            break;
        case eOAIMessageActionType::SUPPRESS:
            val = "SUPPRESS";
            break;
        default:
            break;
...
QJsonValue OAIMessageActionType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIMessageActionType::eOAIMessageActionType OAIMessageActionType::getValue() const {
    return m_value;
}

void OAIMessageActionType::setValue(const OAIMessageActionType::eOAIMessageActionType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIMessageActionType::isSet() const {
    
    return m_value_isSet;
}

bool OAIMessageActionType::isValid() const {
