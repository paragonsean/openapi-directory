...
/*
 * OAIDescribeResourceServerRequest.h
 *
 * 
 */

#ifndef OAIDescribeResourceServerRequest_H
#define OAIDescribeResourceServerRequest_H
...
class OAIDescribeResourceServerRequest : public OAIObject {
public:
    OAIDescribeResourceServerRequest();
    OAIDescribeResourceServerRequest(QString json);
    ~OAIDescribeResourceServerRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeResourceServerRequest)

#endif // OAIDescribeResourceServerRequest_H
