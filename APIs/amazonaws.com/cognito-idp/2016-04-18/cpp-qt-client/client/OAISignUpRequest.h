...
#ifndef OAISignUpRequest_H
#define OAISignUpRequest_H
...
namespace OpenAPI {
class OAISignUpRequest_AnalyticsMetadata;
class OAIConfirmForgotPasswordRequest_UserContextData;

class OAISignUpRequest : public OAIObject {
public:
    OAISignUpRequest();
    OAISignUpRequest(QString json);
    ~OAISignUpRequest() override;
    ...
    QList getValidationData() const;
    void setValidationData(const QList &validation_data);
    bool is_validation_data_Set() const;
    bool is_validation_data_Valid() const;

    OAISignUpRequest_AnalyticsMetadata getAnalyticsMetadata() const;
    void setAnalyticsMetadata(const OAISignUpRequest_AnalyticsMetadata &analytics_metadata);
...
private:
    ...
    QList m_validation_data;
    bool m_validation_data_isSet;
    bool m_validation_data_isValid;

    OAISignUpRequest_AnalyticsMetadata m_analytics_metadata;
...
Q_DECLARE_METATYPE(OpenAPI::OAISignUpRequest)

#endif // OAISignUpRequest_H
