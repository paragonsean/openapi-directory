...
/*
 * OAIAdminUpdateUserAttributesRequest.h
 *
 * Represents the request to update the user&#39;s attributes as an administrator.
 */

#ifndef OAIAdminUpdateUserAttributesRequest_H
#define OAIAdminUpdateUserAttributesRequest_H
...
class OAIAdminUpdateUserAttributesRequest : public OAIObject {
public:
    OAIAdminUpdateUserAttributesRequest();
    OAIAdminUpdateUserAttributesRequest(QString json);
    ~OAIAdminUpdateUserAttributesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdminUpdateUserAttributesRequest)

#endif // OAIAdminUpdateUserAttributesRequest_H
