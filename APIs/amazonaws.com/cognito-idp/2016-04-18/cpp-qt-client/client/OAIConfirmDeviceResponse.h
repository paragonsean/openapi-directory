...
/*
 * OAIConfirmDeviceResponse.h
 *
 * Confirms the device response.
 */

#ifndef OAIConfirmDeviceResponse_H
#define OAIConfirmDeviceResponse_H
...
class OAIConfirmDeviceResponse : public OAIObject {
public:
    OAIConfirmDeviceResponse();
    OAIConfirmDeviceResponse(QString json);
    ~OAIConfirmDeviceResponse() override;
    ...
    bool getUserConfirmationNecessary() const;
    void setUserConfirmationNecessary(const bool &user_confirmation_necessary);
    bool is_user_confirmation_necessary_Set() const;
    bool is_user_confirmation_necessary_Valid() const;
...
private:
    ...
    bool m_user_confirmation_necessary;
    bool m_user_confirmation_necessary_isSet;
    bool m_user_confirmation_necessary_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIConfirmDeviceResponse)

#endif // OAIConfirmDeviceResponse_H
