...
/*
 * OAIUpdateIdentityProviderResponse.h
 *
 * 
 */

#ifndef OAIUpdateIdentityProviderResponse_H
#define OAIUpdateIdentityProviderResponse_H
...
class OAIUpdateIdentityProviderResponse : public OAIObject {
public:
    OAIUpdateIdentityProviderResponse();
    OAIUpdateIdentityProviderResponse(QString json);
    ~OAIUpdateIdentityProviderResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateIdentityProviderResponse)

#endif // OAIUpdateIdentityProviderResponse_H
