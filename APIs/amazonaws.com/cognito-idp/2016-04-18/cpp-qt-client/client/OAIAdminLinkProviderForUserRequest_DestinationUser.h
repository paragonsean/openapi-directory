...
/*
 * OAIAdminLinkProviderForUserRequest_DestinationUser.h
 *
 * 
 */

#ifndef OAIAdminLinkProviderForUserRequest_DestinationUser_H
#define OAIAdminLinkProviderForUserRequest_DestinationUser_H
...
class OAIAdminLinkProviderForUserRequest_DestinationUser : public OAIObject {
public:
    OAIAdminLinkProviderForUserRequest_DestinationUser();
    OAIAdminLinkProviderForUserRequest_DestinationUser(QString json);
    ~OAIAdminLinkProviderForUserRequest_DestinationUser() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdminLinkProviderForUserRequest_DestinationUser)

#endif // OAIAdminLinkProviderForUserRequest_DestinationUser_H
