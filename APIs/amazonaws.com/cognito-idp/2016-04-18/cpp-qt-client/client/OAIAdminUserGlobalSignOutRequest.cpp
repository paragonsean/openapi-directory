...
OAIAdminUserGlobalSignOutRequest::OAIAdminUserGlobalSignOutRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdminUserGlobalSignOutRequest::OAIAdminUserGlobalSignOutRequest() {
    this->initializeModel();
}

OAIAdminUserGlobalSignOutRequest::~OAIAdminUserGlobalSignOutRequest() {}

void OAIAdminUserGlobalSignOutRequest::initializeModel() {
...
void OAIAdminUserGlobalSignOutRequest::fromJson(QString jsonString) {
...
void OAIAdminUserGlobalSignOutRequest::fromJsonObject(QJsonObject json) {
...
QString OAIAdminUserGlobalSignOutRequest::asJson() const {
...
QJsonObject OAIAdminUserGlobalSignOutRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAdminUserGlobalSignOutRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIAdminUserGlobalSignOutRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIAdminUserGlobalSignOutRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIAdminUserGlobalSignOutRequest::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

QString OAIAdminUserGlobalSignOutRequest::getUsername() const {
    return m_username;
}
void OAIAdminUserGlobalSignOutRequest::setUsername(const QString &username) {
    m_username = username;
    m_username_isSet = true;
}

bool OAIAdminUserGlobalSignOutRequest::is_username_Set() const{
    return m_username_isSet;
}

bool OAIAdminUserGlobalSignOutRequest::is_username_Valid() const{
    return m_username_isValid;
}

bool OAIAdminUserGlobalSignOutRequest::isSet() const {
...
bool OAIAdminUserGlobalSignOutRequest::isValid() const {
