...
OAIListUserPoolClientsResponse::OAIListUserPoolClientsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListUserPoolClientsResponse::OAIListUserPoolClientsResponse() {
    this->initializeModel();
}

OAIListUserPoolClientsResponse::~OAIListUserPoolClientsResponse() {}

void OAIListUserPoolClientsResponse::initializeModel() {

    m_user_pool_clients_isSet = false;
    m_user_pool_clients_isValid = false;

    m_next_token_isSet = false;
    m_next_token_isValid = false;
}

void OAIListUserPoolClientsResponse::fromJson(QString jsonString) {
...
void OAIListUserPoolClientsResponse::fromJsonObject(QJsonObject json) {

    m_user_pool_clients_isValid = ::OpenAPI::fromJsonValue(m_user_pool_clients, json[QString("UserPoolClients")]);
    m_user_pool_clients_isSet = !json[QString("UserPoolClients")].isNull() && m_user_pool_clients_isValid;

    m_next_token_isValid = ::OpenAPI::fromJsonValue(m_next_token, json[QString("NextToken")]);
    m_next_token_isSet = !json[QString("NextToken")].isNull() && m_next_token_isValid;
}

QString OAIListUserPoolClientsResponse::asJson() const {
...
QJsonObject OAIListUserPoolClientsResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_user_pool_clients.isSet()) {
        obj.insert(QString("UserPoolClients"), ::OpenAPI::toJsonValue(m_user_pool_clients));
    }
...
QList OAIListUserPoolClientsResponse::getUserPoolClients() const {
    return m_user_pool_clients;
}
void OAIListUserPoolClientsResponse::setUserPoolClients(const QList &user_pool_clients) {
    m_user_pool_clients = user_pool_clients;
    m_user_pool_clients_isSet = true;
}

bool OAIListUserPoolClientsResponse::is_user_pool_clients_Set() const{
    return m_user_pool_clients_isSet;
}

bool OAIListUserPoolClientsResponse::is_user_pool_clients_Valid() const{
    return m_user_pool_clients_isValid;
}

QString OAIListUserPoolClientsResponse::getNextToken() const {
    return m_next_token;
}
void OAIListUserPoolClientsResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListUserPoolClientsResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListUserPoolClientsResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListUserPoolClientsResponse::isSet() const {
...
bool OAIListUserPoolClientsResponse::isValid() const {
