...
OAIAdminResetUserPasswordRequest::OAIAdminResetUserPasswordRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdminResetUserPasswordRequest::OAIAdminResetUserPasswordRequest() {
    this->initializeModel();
}

OAIAdminResetUserPasswordRequest::~OAIAdminResetUserPasswordRequest() {}

void OAIAdminResetUserPasswordRequest::initializeModel() {
...
void OAIAdminResetUserPasswordRequest::fromJson(QString jsonString) {
...
void OAIAdminResetUserPasswordRequest::fromJsonObject(QJsonObject json) {
...
QString OAIAdminResetUserPasswordRequest::asJson() const {
...
QJsonObject OAIAdminResetUserPasswordRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAdminResetUserPasswordRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIAdminResetUserPasswordRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIAdminResetUserPasswordRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIAdminResetUserPasswordRequest::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

QString OAIAdminResetUserPasswordRequest::getUsername() const {
    return m_username;
}
void OAIAdminResetUserPasswordRequest::setUsername(const QString &username) {
    m_username = username;
    m_username_isSet = true;
}

bool OAIAdminResetUserPasswordRequest::is_username_Set() const{
    return m_username_isSet;
}

bool OAIAdminResetUserPasswordRequest::is_username_Valid() const{
    return m_username_isValid;
}

QMap OAIAdminResetUserPasswordRequest::getClientMetadata() const {
    return m_client_metadata;
}
void OAIAdminResetUserPasswordRequest::setClientMetadata(const QMap &client_metadata) {
    m_client_metadata = client_metadata;
    m_client_metadata_isSet = true;
}

bool OAIAdminResetUserPasswordRequest::is_client_metadata_Set() const{
    return m_client_metadata_isSet;
}

bool OAIAdminResetUserPasswordRequest::is_client_metadata_Valid() const{
    return m_client_metadata_isValid;
}

bool OAIAdminResetUserPasswordRequest::isSet() const {
...
bool OAIAdminResetUserPasswordRequest::isValid() const {
