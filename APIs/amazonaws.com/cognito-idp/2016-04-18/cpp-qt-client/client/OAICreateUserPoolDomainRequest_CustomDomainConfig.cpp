...
#include "OAICreateUserPoolDomainRequest_CustomDomainConfig.h"
...
OAICreateUserPoolDomainRequest_CustomDomainConfig::OAICreateUserPoolDomainRequest_CustomDomainConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateUserPoolDomainRequest_CustomDomainConfig::OAICreateUserPoolDomainRequest_CustomDomainConfig() {
    this->initializeModel();
}

OAICreateUserPoolDomainRequest_CustomDomainConfig::~OAICreateUserPoolDomainRequest_CustomDomainConfig() {}

void OAICreateUserPoolDomainRequest_CustomDomainConfig::initializeModel() {

    m_certificate_arn_isSet = false;
    m_certificate_arn_isValid = false;
}

void OAICreateUserPoolDomainRequest_CustomDomainConfig::fromJson(QString jsonString) {
...
void OAICreateUserPoolDomainRequest_CustomDomainConfig::fromJsonObject(QJsonObject json) {
...
QString OAICreateUserPoolDomainRequest_CustomDomainConfig::asJson() const {
...
QJsonObject OAICreateUserPoolDomainRequest_CustomDomainConfig::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateUserPoolDomainRequest_CustomDomainConfig::getCertificateArn() const {
    return m_certificate_arn;
}
void OAICreateUserPoolDomainRequest_CustomDomainConfig::setCertificateArn(const QString &certificate_arn) {
    m_certificate_arn = certificate_arn;
    m_certificate_arn_isSet = true;
}

bool OAICreateUserPoolDomainRequest_CustomDomainConfig::is_certificate_arn_Set() const{
    return m_certificate_arn_isSet;
}

bool OAICreateUserPoolDomainRequest_CustomDomainConfig::is_certificate_arn_Valid() const{
    return m_certificate_arn_isValid;
}

bool OAICreateUserPoolDomainRequest_CustomDomainConfig::isSet() const {
...
bool OAICreateUserPoolDomainRequest_CustomDomainConfig::isValid() const {
