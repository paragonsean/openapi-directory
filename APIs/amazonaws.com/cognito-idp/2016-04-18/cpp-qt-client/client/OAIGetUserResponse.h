...
public:
    ...
    QString getPreferredMfaSetting() const;
    void setPreferredMfaSetting(const QString &preferred_mfa_setting);
    bool is_preferred_mfa_setting_Set() const;
    bool is_preferred_mfa_setting_Valid() const;

    QList getUserMfaSettingList() const;
    void setUserMfaSettingList(const QList &user_mfa_setting_list);
    bool is_user_mfa_setting_list_Set() const;
    bool is_user_mfa_setting_list_Valid() const;
...
private:
    ...
    QString m_preferred_mfa_setting;
    bool m_preferred_mfa_setting_isSet;
    bool m_preferred_mfa_setting_isValid;

    QList m_user_mfa_setting_list;
    bool m_user_mfa_setting_list_isSet;
    bool m_user_mfa_setting_list_isValid;
};
