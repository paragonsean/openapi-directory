...
OAIUpdateIdentityProviderRequest::OAIUpdateIdentityProviderRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateIdentityProviderRequest::OAIUpdateIdentityProviderRequest() {
    this->initializeModel();
}

OAIUpdateIdentityProviderRequest::~OAIUpdateIdentityProviderRequest() {}

void OAIUpdateIdentityProviderRequest::initializeModel() {
...
void OAIUpdateIdentityProviderRequest::fromJson(QString jsonString) {
...
void OAIUpdateIdentityProviderRequest::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateIdentityProviderRequest::asJson() const {
...
QJsonObject OAIUpdateIdentityProviderRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateIdentityProviderRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIUpdateIdentityProviderRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIUpdateIdentityProviderRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIUpdateIdentityProviderRequest::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

QString OAIUpdateIdentityProviderRequest::getProviderName() const {
    return m_provider_name;
}
void OAIUpdateIdentityProviderRequest::setProviderName(const QString &provider_name) {
    m_provider_name = provider_name;
    m_provider_name_isSet = true;
}

bool OAIUpdateIdentityProviderRequest::is_provider_name_Set() const{
    return m_provider_name_isSet;
}

bool OAIUpdateIdentityProviderRequest::is_provider_name_Valid() const{
    return m_provider_name_isValid;
}

QMap OAIUpdateIdentityProviderRequest::getProviderDetails() const {
    return m_provider_details;
}
void OAIUpdateIdentityProviderRequest::setProviderDetails(const QMap &provider_details) {
    m_provider_details = provider_details;
    m_provider_details_isSet = true;
}

bool OAIUpdateIdentityProviderRequest::is_provider_details_Set() const{
    return m_provider_details_isSet;
}

bool OAIUpdateIdentityProviderRequest::is_provider_details_Valid() const{
    return m_provider_details_isValid;
}

QMap OAIUpdateIdentityProviderRequest::getAttributeMapping() const {
    return m_attribute_mapping;
}
void OAIUpdateIdentityProviderRequest::setAttributeMapping(const QMap &attribute_mapping) {
    m_attribute_mapping = attribute_mapping;
    m_attribute_mapping_isSet = true;
}

bool OAIUpdateIdentityProviderRequest::is_attribute_mapping_Set() const{
    return m_attribute_mapping_isSet;
}

bool OAIUpdateIdentityProviderRequest::is_attribute_mapping_Valid() const{
    return m_attribute_mapping_isValid;
}

QList OAIUpdateIdentityProviderRequest::getIdpIdentifiers() const {
    return m_idp_identifiers;
}
void OAIUpdateIdentityProviderRequest::setIdpIdentifiers(const QList &idp_identifiers) {
    m_idp_identifiers = idp_identifiers;
    m_idp_identifiers_isSet = true;
}

bool OAIUpdateIdentityProviderRequest::is_idp_identifiers_Set() const{
    return m_idp_identifiers_isSet;
}

bool OAIUpdateIdentityProviderRequest::is_idp_identifiers_Valid() const{
    return m_idp_identifiers_isValid;
}

bool OAIUpdateIdentityProviderRequest::isSet() const {
...
bool OAIUpdateIdentityProviderRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_user_pool_id_isValid && m_provider_name_isValid && true;
}
