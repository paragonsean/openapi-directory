...
/*
 * OAIInitiateAuthRequest.h
 *
 * Initiates the authentication request.
 */

#ifndef OAIInitiateAuthRequest_H
#define OAIInitiateAuthRequest_H

#include <QJsonObject>

#include "OAIAuthFlowType.h"
#include "OAIConfirmForgotPasswordRequest_UserContextData.h"
#include "OAIInitiateAuthRequest_AnalyticsMetadata.h"
#include <QMap>
#include <QString>
...
namespace OpenAPI {
class OAIInitiateAuthRequest_AnalyticsMetadata;
class OAIConfirmForgotPasswordRequest_UserContextData;

class OAIInitiateAuthRequest : public OAIObject {
public:
    OAIInitiateAuthRequest();
    OAIInitiateAuthRequest(QString json);
    ~OAIInitiateAuthRequest() override;
    ...
    OAIAuthFlowType getAuthFlow() const;
    void setAuthFlow(const OAIAuthFlowType &auth_flow);
    bool is_auth_flow_Set() const;
    bool is_auth_flow_Valid() const;

    QMap getAuthParameters() const;
    void setAuthParameters(const QMap &auth_parameters);
    ...
    OAIInitiateAuthRequest_AnalyticsMetadata getAnalyticsMetadata() const;
    void setAnalyticsMetadata(const OAIInitiateAuthRequest_AnalyticsMetadata &analytics_metadata);
...
private:
    ...
    OAIAuthFlowType m_auth_flow;
    bool m_auth_flow_isSet;
    bool m_auth_flow_isValid;

    QMap m_auth_parameters;
    ...
    OAIInitiateAuthRequest_AnalyticsMetadata m_analytics_metadata;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInitiateAuthRequest)

#endif // OAIInitiateAuthRequest_H
