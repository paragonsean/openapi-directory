...
/*
 * OAIListUserPoolsResponse.h
 *
 * Represents the response to list user pools.
 */

#ifndef OAIListUserPoolsResponse_H
#define OAIListUserPoolsResponse_H
...
class OAIListUserPoolsResponse : public OAIObject {
public:
    OAIListUserPoolsResponse();
    OAIListUserPoolsResponse(QString json);
    ~OAIListUserPoolsResponse() override;
    ...
    QList getUserPools() const;
    void setUserPools(const QList &user_pools);
    bool is_user_pools_Set() const;
    bool is_user_pools_Valid() const;
...
private:
    ...
    QList m_user_pools;
    bool m_user_pools_isSet;
    bool m_user_pools_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListUserPoolsResponse)

#endif // OAIListUserPoolsResponse_H
