...
#include "OAIAliasAttributeType.h"
...
OAIAliasAttributeType::OAIAliasAttributeType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAliasAttributeType::OAIAliasAttributeType() {
    this->initializeModel();
}

OAIAliasAttributeType::~OAIAliasAttributeType() {}

void OAIAliasAttributeType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIAliasAttributeType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIAliasAttributeType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("phone_number", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAliasAttributeType::PHONE_NUMBER;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("email", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAliasAttributeType::EMAIL;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("preferred_username", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAliasAttributeType::PREFERRED_USERNAME;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIAliasAttributeType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIAliasAttributeType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIAliasAttributeType::PHONE_NUMBER:
            val = "phone_number";
            break;
        case eOAIAliasAttributeType::EMAIL:
            val = "email";
            break;
        case eOAIAliasAttributeType::PREFERRED_USERNAME:
...
QJsonValue OAIAliasAttributeType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIAliasAttributeType::eOAIAliasAttributeType OAIAliasAttributeType::getValue() const {
    return m_value;
}

void OAIAliasAttributeType::setValue(const OAIAliasAttributeType::eOAIAliasAttributeType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIAliasAttributeType::isSet() const {
    
    return m_value_isSet;
}

bool OAIAliasAttributeType::isValid() const {
