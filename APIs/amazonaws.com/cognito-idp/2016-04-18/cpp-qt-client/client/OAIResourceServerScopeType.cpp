...
#include "OAIResourceServerScopeType.h"
...
OAIResourceServerScopeType::OAIResourceServerScopeType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIResourceServerScopeType::OAIResourceServerScopeType() {
    this->initializeModel();
}

OAIResourceServerScopeType::~OAIResourceServerScopeType() {}

void OAIResourceServerScopeType::initializeModel() {

    m_scope_name_isSet = false;
    m_scope_name_isValid = false;

    m_scope_description_isSet = false;
    m_scope_description_isValid = false;
}

void OAIResourceServerScopeType::fromJson(QString jsonString) {
...
void OAIResourceServerScopeType::fromJsonObject(QJsonObject json) {
    ...
    m_scope_description_isValid = ::OpenAPI::fromJsonValue(m_scope_description, json[QString("ScopeDescription")]);
    m_scope_description_isSet = !json[QString("ScopeDescription")].isNull() && m_scope_description_isValid;
}

QString OAIResourceServerScopeType::asJson() const {
...
QJsonObject OAIResourceServerScopeType::asJsonObject() const {
    QJsonObject obj;
    if (m_scope_name_isSet) {
        obj.insert(QString("ScopeName"), ::OpenAPI::toJsonValue(m_scope_name));
    }
    if (m_scope_description_isSet) {
        obj.insert(QString("ScopeDescription"), ::OpenAPI::toJsonValue(m_scope_description));
    }
    return obj;
}

QString OAIResourceServerScopeType::getScopeName() const {
    return m_scope_name;
}
void OAIResourceServerScopeType::setScopeName(const QString &scope_name) {
    m_scope_name = scope_name;
    m_scope_name_isSet = true;
}

bool OAIResourceServerScopeType::is_scope_name_Set() const{
    return m_scope_name_isSet;
}

bool OAIResourceServerScopeType::is_scope_name_Valid() const{
    return m_scope_name_isValid;
}

QString OAIResourceServerScopeType::getScopeDescription() const {
    return m_scope_description;
}
void OAIResourceServerScopeType::setScopeDescription(const QString &scope_description) {
    m_scope_description = scope_description;
    m_scope_description_isSet = true;
}

bool OAIResourceServerScopeType::is_scope_description_Set() const{
    return m_scope_description_isSet;
}

bool OAIResourceServerScopeType::is_scope_description_Valid() const{
    return m_scope_description_isValid;
}

bool OAIResourceServerScopeType::isSet() const {
...
bool OAIResourceServerScopeType::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_scope_name_isValid && m_scope_description_isValid && true;
}
