...
/*
 * OAICreateUserPoolRequest_DeviceConfiguration.h
 *
 * 
 */

#ifndef OAICreateUserPoolRequest_DeviceConfiguration_H
#define OAICreateUserPoolRequest_DeviceConfiguration_H
...
class OAICreateUserPoolRequest_DeviceConfiguration : public OAIObject {
public:
    OAICreateUserPoolRequest_DeviceConfiguration();
    OAICreateUserPoolRequest_DeviceConfiguration(QString json);
    ~OAICreateUserPoolRequest_DeviceConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateUserPoolRequest_DeviceConfiguration)

#endif // OAICreateUserPoolRequest_DeviceConfiguration_H
