...
OAIDeletionProtectionType::OAIDeletionProtectionType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeletionProtectionType::OAIDeletionProtectionType() {
    this->initializeModel();
}

OAIDeletionProtectionType::~OAIDeletionProtectionType() {}

void OAIDeletionProtectionType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIDeletionProtectionType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIDeletionProtectionType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("ACTIVE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIDeletionProtectionType::ACTIVE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("INACTIVE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIDeletionProtectionType::INACTIVE;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIDeletionProtectionType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIDeletionProtectionType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIDeletionProtectionType::ACTIVE:
            val = "ACTIVE";
            break;
        case eOAIDeletionProtectionType::INACTIVE:
            val = "INACTIVE";
            break;
        default:
            break;
...
QJsonValue OAIDeletionProtectionType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIDeletionProtectionType::eOAIDeletionProtectionType OAIDeletionProtectionType::getValue() const {
    return m_value;
}

void OAIDeletionProtectionType::setValue(const OAIDeletionProtectionType::eOAIDeletionProtectionType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIDeletionProtectionType::isSet() const {
    
    return m_value_isSet;
}

bool OAIDeletionProtectionType::isValid() const {
