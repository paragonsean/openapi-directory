...
#include "OAIAuthenticationResultType_NewDeviceMetadata.h"
...
OAIAuthenticationResultType_NewDeviceMetadata::OAIAuthenticationResultType_NewDeviceMetadata(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAuthenticationResultType_NewDeviceMetadata::OAIAuthenticationResultType_NewDeviceMetadata() {
    this->initializeModel();
}

OAIAuthenticationResultType_NewDeviceMetadata::~OAIAuthenticationResultType_NewDeviceMetadata() {}

void OAIAuthenticationResultType_NewDeviceMetadata::initializeModel() {

    m_device_key_isSet = false;
    m_device_key_isValid = false;

    m_device_group_key_isSet = false;
    m_device_group_key_isValid = false;
}

void OAIAuthenticationResultType_NewDeviceMetadata::fromJson(QString jsonString) {
...
void OAIAuthenticationResultType_NewDeviceMetadata::fromJsonObject(QJsonObject json) {
    ...
    m_device_group_key_isValid = ::OpenAPI::fromJsonValue(m_device_group_key, json[QString("DeviceGroupKey")]);
    m_device_group_key_isSet = !json[QString("DeviceGroupKey")].isNull() && m_device_group_key_isValid;
}

QString OAIAuthenticationResultType_NewDeviceMetadata::asJson() const {
...
QJsonObject OAIAuthenticationResultType_NewDeviceMetadata::asJsonObject() const {
    QJsonObject obj;
    if (m_device_key_isSet) {
        obj.insert(QString("DeviceKey"), ::OpenAPI::toJsonValue(m_device_key));
    }
    if (m_device_group_key_isSet) {
        obj.insert(QString("DeviceGroupKey"), ::OpenAPI::toJsonValue(m_device_group_key));
    }
    return obj;
}

QString OAIAuthenticationResultType_NewDeviceMetadata::getDeviceKey() const {
    return m_device_key;
}
void OAIAuthenticationResultType_NewDeviceMetadata::setDeviceKey(const QString &device_key) {
    m_device_key = device_key;
    m_device_key_isSet = true;
}

bool OAIAuthenticationResultType_NewDeviceMetadata::is_device_key_Set() const{
    return m_device_key_isSet;
}

bool OAIAuthenticationResultType_NewDeviceMetadata::is_device_key_Valid() const{
    return m_device_key_isValid;
}

QString OAIAuthenticationResultType_NewDeviceMetadata::getDeviceGroupKey() const {
    return m_device_group_key;
}
void OAIAuthenticationResultType_NewDeviceMetadata::setDeviceGroupKey(const QString &device_group_key) {
    m_device_group_key = device_group_key;
    m_device_group_key_isSet = true;
}

bool OAIAuthenticationResultType_NewDeviceMetadata::is_device_group_key_Set() const{
    return m_device_group_key_isSet;
}

bool OAIAuthenticationResultType_NewDeviceMetadata::is_device_group_key_Valid() const{
    return m_device_group_key_isValid;
}

bool OAIAuthenticationResultType_NewDeviceMetadata::isSet() const {
...
bool OAIAuthenticationResultType_NewDeviceMetadata::isValid() const {
