...
OAIAdminListDevicesResponse::OAIAdminListDevicesResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdminListDevicesResponse::OAIAdminListDevicesResponse() {
    this->initializeModel();
}

OAIAdminListDevicesResponse::~OAIAdminListDevicesResponse() {}

void OAIAdminListDevicesResponse::initializeModel() {
...
void OAIAdminListDevicesResponse::fromJson(QString jsonString) {
...
void OAIAdminListDevicesResponse::fromJsonObject(QJsonObject json) {
...
QString OAIAdminListDevicesResponse::asJson() const {
...
QJsonObject OAIAdminListDevicesResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_devices.isSet()) {
...
QList OAIAdminListDevicesResponse::getDevices() const {
    return m_devices;
}
void OAIAdminListDevicesResponse::setDevices(const QList &devices) {
    m_devices = devices;
    m_devices_isSet = true;
}

bool OAIAdminListDevicesResponse::is_devices_Set() const{
    return m_devices_isSet;
}

bool OAIAdminListDevicesResponse::is_devices_Valid() const{
    return m_devices_isValid;
}

QString OAIAdminListDevicesResponse::getPaginationToken() const {
    return m_pagination_token;
}
void OAIAdminListDevicesResponse::setPaginationToken(const QString &pagination_token) {
    m_pagination_token = pagination_token;
    m_pagination_token_isSet = true;
}

bool OAIAdminListDevicesResponse::is_pagination_token_Set() const{
    return m_pagination_token_isSet;
}

bool OAIAdminListDevicesResponse::is_pagination_token_Valid() const{
    return m_pagination_token_isValid;
}

bool OAIAdminListDevicesResponse::isSet() const {
...
bool OAIAdminListDevicesResponse::isValid() const {
