...
/*
 * OAIUpdateDeviceStatusRequest.h
 *
 * Represents the request to update the device status.
 */

#ifndef OAIUpdateDeviceStatusRequest_H
#define OAIUpdateDeviceStatusRequest_H
...
class OAIUpdateDeviceStatusRequest : public OAIObject {
public:
    OAIUpdateDeviceStatusRequest();
    OAIUpdateDeviceStatusRequest(QString json);
    ~OAIUpdateDeviceStatusRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateDeviceStatusRequest)

#endif // OAIUpdateDeviceStatusRequest_H
