...
/*
 * OAIResendConfirmationCodeRequest_AnalyticsMetadata.h
 *
 * 
 */

#ifndef OAIResendConfirmationCodeRequest_AnalyticsMetadata_H
#define OAIResendConfirmationCodeRequest_AnalyticsMetadata_H
...
class OAIResendConfirmationCodeRequest_AnalyticsMetadata : public OAIObject {
public:
    OAIResendConfirmationCodeRequest_AnalyticsMetadata();
    OAIResendConfirmationCodeRequest_AnalyticsMetadata(QString json);
    ~OAIResendConfirmationCodeRequest_AnalyticsMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResendConfirmationCodeRequest_AnalyticsMetadata)

#endif // OAIResendConfirmationCodeRequest_AnalyticsMetadata_H
