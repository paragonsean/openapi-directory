...
/*
 * OAIUpdateUserPoolClientResponse.h
 *
 * Represents the response from the server to the request to update the user pool client.
 */

#ifndef OAIUpdateUserPoolClientResponse_H
#define OAIUpdateUserPoolClientResponse_H
...
namespace OpenAPI {
class OAIUpdateUserPoolClientResponse_UserPoolClient;

class OAIUpdateUserPoolClientResponse : public OAIObject {
public:
    OAIUpdateUserPoolClientResponse();
    OAIUpdateUserPoolClientResponse(QString json);
    ~OAIUpdateUserPoolClientResponse() override;
    ...
    OAIUpdateUserPoolClientResponse_UserPoolClient getUserPoolClient() const;
    void setUserPoolClient(const OAIUpdateUserPoolClientResponse_UserPoolClient &user_pool_client);
...
private:
    ...
    OAIUpdateUserPoolClientResponse_UserPoolClient m_user_pool_client;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateUserPoolClientResponse)

#endif // OAIUpdateUserPoolClientResponse_H
