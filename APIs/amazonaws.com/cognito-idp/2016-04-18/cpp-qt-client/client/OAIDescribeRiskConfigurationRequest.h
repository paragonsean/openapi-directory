...
/*
 * OAIDescribeRiskConfigurationRequest.h
 *
 * 
 */

#ifndef OAIDescribeRiskConfigurationRequest_H
#define OAIDescribeRiskConfigurationRequest_H
...
class OAIDescribeRiskConfigurationRequest : public OAIObject {
public:
    OAIDescribeRiskConfigurationRequest();
    OAIDescribeRiskConfigurationRequest(QString json);
    ~OAIDescribeRiskConfigurationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeRiskConfigurationRequest)

#endif // OAIDescribeRiskConfigurationRequest_H
