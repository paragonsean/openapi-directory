...
/*
 * OAIRiskConfigurationType_CompromisedCredentialsRiskConfiguration.h
 *
 * 
 */

#ifndef OAIRiskConfigurationType_CompromisedCredentialsRiskConfiguration_H
#define OAIRiskConfigurationType_CompromisedCredentialsRiskConfiguration_H
...
namespace OpenAPI {
class OAICompromisedCredentialsRiskConfigurationType_Actions;

class OAIRiskConfigurationType_CompromisedCredentialsRiskConfiguration : public OAIObject {
public:
    OAIRiskConfigurationType_CompromisedCredentialsRiskConfiguration();
    OAIRiskConfigurationType_CompromisedCredentialsRiskConfiguration(QString json);
    ~OAIRiskConfigurationType_CompromisedCredentialsRiskConfiguration() override;
    ...
    QList getEventFilter() const;
    void setEventFilter(const QList &event_filter);
    bool is_event_filter_Set() const;
    bool is_event_filter_Valid() const;

    OAICompromisedCredentialsRiskConfigurationType_Actions getActions() const;
    void setActions(const OAICompromisedCredentialsRiskConfigurationType_Actions &actions);
...
private:
    ...
    QList m_event_filter;
    bool m_event_filter_isSet;
    bool m_event_filter_isValid;

    OAICompromisedCredentialsRiskConfigurationType_Actions m_actions;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRiskConfigurationType_CompromisedCredentialsRiskConfiguration)

#endif // OAIRiskConfigurationType_CompromisedCredentialsRiskConfiguration_H
