...
#include "OAIUserPoolType_Policies.h"
...
OAIUserPoolType_Policies::OAIUserPoolType_Policies(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUserPoolType_Policies::OAIUserPoolType_Policies() {
    this->initializeModel();
}

OAIUserPoolType_Policies::~OAIUserPoolType_Policies() {}

void OAIUserPoolType_Policies::initializeModel() {

    m_password_policy_isSet = false;
    m_password_policy_isValid = false;
}

void OAIUserPoolType_Policies::fromJson(QString jsonString) {
...
void OAIUserPoolType_Policies::fromJsonObject(QJsonObject json) {
...
QString OAIUserPoolType_Policies::asJson() const {
...
QJsonObject OAIUserPoolType_Policies::asJsonObject() const {
    QJsonObject obj;
...
OAIUserPoolPolicyType_PasswordPolicy OAIUserPoolType_Policies::getPasswordPolicy() const {
    return m_password_policy;
}
void OAIUserPoolType_Policies::setPasswordPolicy(const OAIUserPoolPolicyType_PasswordPolicy &password_policy) {
    m_password_policy = password_policy;
    m_password_policy_isSet = true;
}

bool OAIUserPoolType_Policies::is_password_policy_Set() const{
    return m_password_policy_isSet;
}

bool OAIUserPoolType_Policies::is_password_policy_Valid() const{
    return m_password_policy_isValid;
}

bool OAIUserPoolType_Policies::isSet() const {
...
bool OAIUserPoolType_Policies::isValid() const {
