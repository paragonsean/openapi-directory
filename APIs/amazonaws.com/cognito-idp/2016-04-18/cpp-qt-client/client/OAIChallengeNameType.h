...
/*
 * OAIChallengeNameType.h
 *
 * 
 */

#ifndef OAIChallengeNameType_H
#define OAIChallengeNameType_H
...
class OAIChallengeNameType : public OAIEnum {
public:
    OAIChallengeNameType();
    OAIChallengeNameType(QString json);
    ~OAIChallengeNameType() override;
    ...
    enum class eOAIChallengeNameType {
    ...
    OAIChallengeNameType::eOAIChallengeNameType getValue() const;
    void setValue(const OAIChallengeNameType::eOAIChallengeNameType& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIChallengeNameType)

#endif // OAIChallengeNameType_H
