...
/*
 * OAIAdminListDevicesRequest.h
 *
 * Represents the request to list devices, as an administrator.
 */

#ifndef OAIAdminListDevicesRequest_H
#define OAIAdminListDevicesRequest_H
...
class OAIAdminListDevicesRequest : public OAIObject {
public:
    OAIAdminListDevicesRequest();
    OAIAdminListDevicesRequest(QString json);
    ~OAIAdminListDevicesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdminListDevicesRequest)

#endif // OAIAdminListDevicesRequest_H
