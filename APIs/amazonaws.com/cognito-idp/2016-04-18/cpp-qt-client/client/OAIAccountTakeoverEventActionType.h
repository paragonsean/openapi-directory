...
/*
 * OAIAccountTakeoverEventActionType.h
 *
 * 
 */

#ifndef OAIAccountTakeoverEventActionType_H
#define OAIAccountTakeoverEventActionType_H
...
class OAIAccountTakeoverEventActionType : public OAIEnum {
public:
    OAIAccountTakeoverEventActionType();
    OAIAccountTakeoverEventActionType(QString json);
    ~OAIAccountTakeoverEventActionType() override;
    ...
    enum class eOAIAccountTakeoverEventActionType {
    ...
    OAIAccountTakeoverEventActionType::eOAIAccountTakeoverEventActionType getValue() const;
    void setValue(const OAIAccountTakeoverEventActionType::eOAIAccountTakeoverEventActionType& value);
...
private:
    ...
    eOAIAccountTakeoverEventActionType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccountTakeoverEventActionType)

#endif // OAIAccountTakeoverEventActionType_H
