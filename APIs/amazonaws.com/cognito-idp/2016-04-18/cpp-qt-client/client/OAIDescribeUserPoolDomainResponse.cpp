...
OAIDescribeUserPoolDomainResponse::OAIDescribeUserPoolDomainResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeUserPoolDomainResponse::OAIDescribeUserPoolDomainResponse() {
    this->initializeModel();
}

OAIDescribeUserPoolDomainResponse::~OAIDescribeUserPoolDomainResponse() {}

void OAIDescribeUserPoolDomainResponse::initializeModel() {

    m_domain_description_isSet = false;
    m_domain_description_isValid = false;
}

void OAIDescribeUserPoolDomainResponse::fromJson(QString jsonString) {
...
void OAIDescribeUserPoolDomainResponse::fromJsonObject(QJsonObject json) {

    m_domain_description_isValid = ::OpenAPI::fromJsonValue(m_domain_description, json[QString("DomainDescription")]);
    m_domain_description_isSet = !json[QString("DomainDescription")].isNull() && m_domain_description_isValid;
}

QString OAIDescribeUserPoolDomainResponse::asJson() const {
...
QJsonObject OAIDescribeUserPoolDomainResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_domain_description.isSet()) {
        obj.insert(QString("DomainDescription"), ::OpenAPI::toJsonValue(m_domain_description));
    }
    return obj;
}

OAIDescribeUserPoolDomainResponse_DomainDescription OAIDescribeUserPoolDomainResponse::getDomainDescription() const {
    return m_domain_description;
}
void OAIDescribeUserPoolDomainResponse::setDomainDescription(const OAIDescribeUserPoolDomainResponse_DomainDescription &domain_description) {
    m_domain_description = domain_description;
    m_domain_description_isSet = true;
}

bool OAIDescribeUserPoolDomainResponse::is_domain_description_Set() const{
    return m_domain_description_isSet;
}

bool OAIDescribeUserPoolDomainResponse::is_domain_description_Valid() const{
    return m_domain_description_isValid;
}

bool OAIDescribeUserPoolDomainResponse::isSet() const {
...
bool OAIDescribeUserPoolDomainResponse::isValid() const {
