...
/*
 * OAIUpdateAuthEventFeedbackRequest.h
 *
 * 
 */

#ifndef OAIUpdateAuthEventFeedbackRequest_H
#define OAIUpdateAuthEventFeedbackRequest_H
...
class OAIUpdateAuthEventFeedbackRequest : public OAIObject {
public:
    OAIUpdateAuthEventFeedbackRequest();
    OAIUpdateAuthEventFeedbackRequest(QString json);
    ~OAIUpdateAuthEventFeedbackRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateAuthEventFeedbackRequest)

#endif // OAIUpdateAuthEventFeedbackRequest_H
