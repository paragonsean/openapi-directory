...
#ifndef OAIOAuthFlowType_H
#define OAIOAuthFlowType_H
...
class OAIOAuthFlowType : public OAIEnum {
public:
    OAIOAuthFlowType();
    OAIOAuthFlowType(QString json);
    ~OAIOAuthFlowType() override;
    ...
    enum class eOAIOAuthFlowType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        CODE, 
        IMPLICIT, 
        CLIENT_CREDENTIALS
    };
    OAIOAuthFlowType::eOAIOAuthFlowType getValue() const;
    void setValue(const OAIOAuthFlowType::eOAIOAuthFlowType& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIOAuthFlowType)

#endif // OAIOAuthFlowType_H
