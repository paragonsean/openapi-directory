...
OAIAdminEnableUserRequest::OAIAdminEnableUserRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdminEnableUserRequest::OAIAdminEnableUserRequest() {
    this->initializeModel();
}

OAIAdminEnableUserRequest::~OAIAdminEnableUserRequest() {}

void OAIAdminEnableUserRequest::initializeModel() {
...
void OAIAdminEnableUserRequest::fromJson(QString jsonString) {
...
void OAIAdminEnableUserRequest::fromJsonObject(QJsonObject json) {
...
QString OAIAdminEnableUserRequest::asJson() const {
...
QJsonObject OAIAdminEnableUserRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAdminEnableUserRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIAdminEnableUserRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIAdminEnableUserRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIAdminEnableUserRequest::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

QString OAIAdminEnableUserRequest::getUsername() const {
    return m_username;
}
void OAIAdminEnableUserRequest::setUsername(const QString &username) {
    m_username = username;
    m_username_isSet = true;
}

bool OAIAdminEnableUserRequest::is_username_Set() const{
    return m_username_isSet;
}

bool OAIAdminEnableUserRequest::is_username_Valid() const{
    return m_username_isValid;
}

bool OAIAdminEnableUserRequest::isSet() const {
...
bool OAIAdminEnableUserRequest::isValid() const {
