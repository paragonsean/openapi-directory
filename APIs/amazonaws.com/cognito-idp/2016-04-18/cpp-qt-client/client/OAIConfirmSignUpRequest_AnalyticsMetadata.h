...
/*
 * OAIConfirmSignUpRequest_AnalyticsMetadata.h
 *
 * 
 */

#ifndef OAIConfirmSignUpRequest_AnalyticsMetadata_H
#define OAIConfirmSignUpRequest_AnalyticsMetadata_H
...
class OAIConfirmSignUpRequest_AnalyticsMetadata : public OAIObject {
public:
    OAIConfirmSignUpRequest_AnalyticsMetadata();
    OAIConfirmSignUpRequest_AnalyticsMetadata(QString json);
    ~OAIConfirmSignUpRequest_AnalyticsMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConfirmSignUpRequest_AnalyticsMetadata)

#endif // OAIConfirmSignUpRequest_AnalyticsMetadata_H
