...
#include "OAIMessageTemplateType.h"
...
OAIMessageTemplateType::OAIMessageTemplateType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMessageTemplateType::OAIMessageTemplateType() {
    this->initializeModel();
}

OAIMessageTemplateType::~OAIMessageTemplateType() {}

void OAIMessageTemplateType::initializeModel() {
...
void OAIMessageTemplateType::fromJson(QString jsonString) {
...
void OAIMessageTemplateType::fromJsonObject(QJsonObject json) {
...
QString OAIMessageTemplateType::asJson() const {
...
QJsonObject OAIMessageTemplateType::asJsonObject() const {
    QJsonObject obj;
...
QString OAIMessageTemplateType::getSmsMessage() const {
    return m_sms_message;
}
void OAIMessageTemplateType::setSmsMessage(const QString &sms_message) {
    m_sms_message = sms_message;
    m_sms_message_isSet = true;
}

bool OAIMessageTemplateType::is_sms_message_Set() const{
    return m_sms_message_isSet;
}

bool OAIMessageTemplateType::is_sms_message_Valid() const{
    return m_sms_message_isValid;
}

QString OAIMessageTemplateType::getEmailMessage() const {
    return m_email_message;
}
void OAIMessageTemplateType::setEmailMessage(const QString &email_message) {
    m_email_message = email_message;
    m_email_message_isSet = true;
}

bool OAIMessageTemplateType::is_email_message_Set() const{
    return m_email_message_isSet;
}

bool OAIMessageTemplateType::is_email_message_Valid() const{
    return m_email_message_isValid;
}

QString OAIMessageTemplateType::getEmailSubject() const {
    return m_email_subject;
}
void OAIMessageTemplateType::setEmailSubject(const QString &email_subject) {
    m_email_subject = email_subject;
    m_email_subject_isSet = true;
}

bool OAIMessageTemplateType::is_email_subject_Set() const{
    return m_email_subject_isSet;
}

bool OAIMessageTemplateType::is_email_subject_Valid() const{
    return m_email_subject_isValid;
}

bool OAIMessageTemplateType::isSet() const {
...
bool OAIMessageTemplateType::isValid() const {
