...
OAIAdminCreateUserResponse::OAIAdminCreateUserResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdminCreateUserResponse::OAIAdminCreateUserResponse() {
    this->initializeModel();
}

OAIAdminCreateUserResponse::~OAIAdminCreateUserResponse() {}

void OAIAdminCreateUserResponse::initializeModel() {

    m_user_isSet = false;
    m_user_isValid = false;
}

void OAIAdminCreateUserResponse::fromJson(QString jsonString) {
...
void OAIAdminCreateUserResponse::fromJsonObject(QJsonObject json) {

    m_user_isValid = ::OpenAPI::fromJsonValue(m_user, json[QString("User")]);
    m_user_isSet = !json[QString("User")].isNull() && m_user_isValid;
}

QString OAIAdminCreateUserResponse::asJson() const {
...
QJsonObject OAIAdminCreateUserResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_user.isSet()) {
...
OAIAdminCreateUserResponse_User OAIAdminCreateUserResponse::getUser() const {
    return m_user;
}
void OAIAdminCreateUserResponse::setUser(const OAIAdminCreateUserResponse_User &user) {
    m_user = user;
    m_user_isSet = true;
}

bool OAIAdminCreateUserResponse::is_user_Set() const{
    return m_user_isSet;
}

bool OAIAdminCreateUserResponse::is_user_Valid() const{
    return m_user_isValid;
}

bool OAIAdminCreateUserResponse::isSet() const {
...
bool OAIAdminCreateUserResponse::isValid() const {
