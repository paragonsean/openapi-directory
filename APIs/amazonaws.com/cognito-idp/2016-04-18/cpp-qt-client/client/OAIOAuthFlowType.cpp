...
OAIOAuthFlowType::OAIOAuthFlowType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOAuthFlowType::OAIOAuthFlowType() {
    this->initializeModel();
}

OAIOAuthFlowType::~OAIOAuthFlowType() {}

void OAIOAuthFlowType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIOAuthFlowType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIOAuthFlowType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("code", Qt::CaseInsensitive) == 0) {
        m_value = eOAIOAuthFlowType::CODE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("implicit", Qt::CaseInsensitive) == 0) {
        m_value = eOAIOAuthFlowType::IMPLICIT;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("client_credentials", Qt::CaseInsensitive) == 0) {
        m_value = eOAIOAuthFlowType::CLIENT_CREDENTIALS;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIOAuthFlowType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIOAuthFlowType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIOAuthFlowType::CODE:
            val = "code";
            break;
        case eOAIOAuthFlowType::IMPLICIT:
            val = "implicit";
            break;
        case eOAIOAuthFlowType::CLIENT_CREDENTIALS:
...
QJsonValue OAIOAuthFlowType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIOAuthFlowType::eOAIOAuthFlowType OAIOAuthFlowType::getValue() const {
    return m_value;
}

void OAIOAuthFlowType::setValue(const OAIOAuthFlowType::eOAIOAuthFlowType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIOAuthFlowType::isSet() const {
    
    return m_value_isSet;
}

bool OAIOAuthFlowType::isValid() const {
