...
/*
 * OAISetUserPoolMfaConfigResponse.h
 *
 * 
 */

#ifndef OAISetUserPoolMfaConfigResponse_H
#define OAISetUserPoolMfaConfigResponse_H

#include <QJsonObject>

#include "OAISetUserPoolMfaConfigResponse_SmsMfaConfiguration.h"
#include "OAISetUserPoolMfaConfigResponse_SoftwareTokenMfaConfiguration.h"
...
namespace OpenAPI {
class OAISetUserPoolMfaConfigResponse_SmsMfaConfiguration;
class OAISetUserPoolMfaConfigResponse_SoftwareTokenMfaConfiguration;

class OAISetUserPoolMfaConfigResponse : public OAIObject {
public:
    OAISetUserPoolMfaConfigResponse();
    OAISetUserPoolMfaConfigResponse(QString json);
    ~OAISetUserPoolMfaConfigResponse() override;
    ...
    OAISetUserPoolMfaConfigResponse_SmsMfaConfiguration getSmsMfaConfiguration() const;
    void setSmsMfaConfiguration(const OAISetUserPoolMfaConfigResponse_SmsMfaConfiguration &sms_mfa_configuration);
    bool is_sms_mfa_configuration_Set() const;
    bool is_sms_mfa_configuration_Valid() const;

    OAISetUserPoolMfaConfigResponse_SoftwareTokenMfaConfiguration getSoftwareTokenMfaConfiguration() const;
    void setSoftwareTokenMfaConfiguration(const OAISetUserPoolMfaConfigResponse_SoftwareTokenMfaConfiguration &software_token_mfa_configuration);
    bool is_software_token_mfa_configuration_Set() const;
    bool is_software_token_mfa_configuration_Valid() const;
...
private:
    ...
    OAISetUserPoolMfaConfigResponse_SmsMfaConfiguration m_sms_mfa_configuration;
    bool m_sms_mfa_configuration_isSet;
    bool m_sms_mfa_configuration_isValid;

    OAISetUserPoolMfaConfigResponse_SoftwareTokenMfaConfiguration m_software_token_mfa_configuration;
    bool m_software_token_mfa_configuration_isSet;
    bool m_software_token_mfa_configuration_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAISetUserPoolMfaConfigResponse)

#endif // OAISetUserPoolMfaConfigResponse_H
