...
QString OAIListUsersResponse::getPaginationToken() const {
    return m_pagination_token;
}
void OAIListUsersResponse::setPaginationToken(const QString &pagination_token) {
    m_pagination_token = pagination_token;
    m_pagination_token_isSet = true;
}

bool OAIListUsersResponse::is_pagination_token_Set() const{
    return m_pagination_token_isSet;
}

bool OAIListUsersResponse::is_pagination_token_Valid() const{
