...
void OAIChangePasswordRequest::initializeModel() {
    ...
    m_previous_password_isSet = false;
    m_previous_password_isValid = false;

    m_proposed_password_isSet = false;
    m_proposed_password_isValid = false;
...
void OAIChangePasswordRequest::fromJsonObject(QJsonObject json) {
    ...
    m_previous_password_isValid = ::OpenAPI::fromJsonValue(m_previous_password, json[QString("PreviousPassword")]);
    m_previous_password_isSet = !json[QString("PreviousPassword")].isNull() && m_previous_password_isValid;

    m_proposed_password_isValid = ::OpenAPI::fromJsonValue(m_proposed_password, json[QString("ProposedPassword")]);
    m_proposed_password_isSet = !json[QString("ProposedPassword")].isNull() && m_proposed_password_isValid;
...
QJsonObject OAIChangePasswordRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_previous_password_isSet) {
        obj.insert(QString("PreviousPassword"), ::OpenAPI::toJsonValue(m_previous_password));
    }
    if (m_proposed_password_isSet) {
        obj.insert(QString("ProposedPassword"), ::OpenAPI::toJsonValue(m_proposed_password));
    }
...
QString OAIChangePasswordRequest::getPreviousPassword() const {
    return m_previous_password;
}
void OAIChangePasswordRequest::setPreviousPassword(const QString &previous_password) {
    m_previous_password = previous_password;
    m_previous_password_isSet = true;
}

bool OAIChangePasswordRequest::is_previous_password_Set() const{
    return m_previous_password_isSet;
}

bool OAIChangePasswordRequest::is_previous_password_Valid() const{
    return m_previous_password_isValid;
}

QString OAIChangePasswordRequest::getProposedPassword() const {
    return m_proposed_password;
}
void OAIChangePasswordRequest::setProposedPassword(const QString &proposed_password) {
    m_proposed_password = proposed_password;
    m_proposed_password_isSet = true;
}

bool OAIChangePasswordRequest::is_proposed_password_Set() const{
    return m_proposed_password_isSet;
}

bool OAIChangePasswordRequest::is_proposed_password_Valid() const{
    return m_proposed_password_isValid;
}

QString OAIChangePasswordRequest::getAccessToken() const {
    return m_access_token;
}
void OAIChangePasswordRequest::setAccessToken(const QString &access_token) {
    m_access_token = access_token;
    m_access_token_isSet = true;
}

bool OAIChangePasswordRequest::is_access_token_Set() const{
    return m_access_token_isSet;
}

bool OAIChangePasswordRequest::is_access_token_Valid() const{
...
bool OAIChangePasswordRequest::isValid() const {
    ...
    return m_previous_password_isValid && m_proposed_password_isValid && m_access_token_isValid && true;
}
