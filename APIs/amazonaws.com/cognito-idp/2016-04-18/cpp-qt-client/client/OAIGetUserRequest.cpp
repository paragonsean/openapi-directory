...
OAIGetUserRequest::OAIGetUserRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetUserRequest::OAIGetUserRequest() {
    this->initializeModel();
}

OAIGetUserRequest::~OAIGetUserRequest() {}

void OAIGetUserRequest::initializeModel() {

    m_access_token_isSet = false;
    m_access_token_isValid = false;
}

void OAIGetUserRequest::fromJson(QString jsonString) {
...
void OAIGetUserRequest::fromJsonObject(QJsonObject json) {
...
QString OAIGetUserRequest::asJson() const {
...
QJsonObject OAIGetUserRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetUserRequest::getAccessToken() const {
    return m_access_token;
}
void OAIGetUserRequest::setAccessToken(const QString &access_token) {
    m_access_token = access_token;
    m_access_token_isSet = true;
}

bool OAIGetUserRequest::is_access_token_Set() const{
    return m_access_token_isSet;
}

bool OAIGetUserRequest::is_access_token_Valid() const{
    return m_access_token_isValid;
}

bool OAIGetUserRequest::isSet() const {
...
bool OAIGetUserRequest::isValid() const {
