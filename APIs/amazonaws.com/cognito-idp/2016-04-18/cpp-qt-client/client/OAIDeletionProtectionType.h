...
/*
 * OAIDeletionProtectionType.h
 *
 * 
 */

#ifndef OAIDeletionProtectionType_H
#define OAIDeletionProtectionType_H
...
class OAIDeletionProtectionType : public OAIEnum {
public:
    OAIDeletionProtectionType();
    OAIDeletionProtectionType(QString json);
    ~OAIDeletionProtectionType() override;
    ...
    enum class eOAIDeletionProtectionType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        ACTIVE, 
        INACTIVE
    };
    OAIDeletionProtectionType::eOAIDeletionProtectionType getValue() const;
    void setValue(const OAIDeletionProtectionType::eOAIDeletionProtectionType& value);
...
private:
    ...
    eOAIDeletionProtectionType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeletionProtectionType)

#endif // OAIDeletionProtectionType_H
