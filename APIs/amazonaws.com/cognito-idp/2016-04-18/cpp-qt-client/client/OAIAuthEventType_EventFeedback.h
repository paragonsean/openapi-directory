...
/*
 * OAIAuthEventType_EventFeedback.h
 *
 * 
 */

#ifndef OAIAuthEventType_EventFeedback_H
#define OAIAuthEventType_EventFeedback_H
...
class OAIAuthEventType_EventFeedback : public OAIObject {
public:
    OAIAuthEventType_EventFeedback();
    OAIAuthEventType_EventFeedback(QString json);
    ~OAIAuthEventType_EventFeedback() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAuthEventType_EventFeedback)

#endif // OAIAuthEventType_EventFeedback_H
