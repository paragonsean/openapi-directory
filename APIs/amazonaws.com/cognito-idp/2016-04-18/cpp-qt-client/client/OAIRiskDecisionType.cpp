...
OAIRiskDecisionType::OAIRiskDecisionType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRiskDecisionType::OAIRiskDecisionType() {
    this->initializeModel();
}

OAIRiskDecisionType::~OAIRiskDecisionType() {}

void OAIRiskDecisionType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIRiskDecisionType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIRiskDecisionType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("NoRisk", Qt::CaseInsensitive) == 0) {
        m_value = eOAIRiskDecisionType::NORISK;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("AccountTakeover", Qt::CaseInsensitive) == 0) {
        m_value = eOAIRiskDecisionType::ACCOUNTTAKEOVER;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Block", Qt::CaseInsensitive) == 0) {
        m_value = eOAIRiskDecisionType::BLOCK;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIRiskDecisionType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIRiskDecisionType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIRiskDecisionType::NORISK:
            val = "NoRisk";
            break;
        case eOAIRiskDecisionType::ACCOUNTTAKEOVER:
            val = "AccountTakeover";
            break;
        case eOAIRiskDecisionType::BLOCK:
            val = "Block";
            break;
        default:
            break;
...
QJsonValue OAIRiskDecisionType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIRiskDecisionType::eOAIRiskDecisionType OAIRiskDecisionType::getValue() const {
    return m_value;
}

void OAIRiskDecisionType::setValue(const OAIRiskDecisionType::eOAIRiskDecisionType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIRiskDecisionType::isSet() const {
    
    return m_value_isSet;
}

bool OAIRiskDecisionType::isValid() const {
