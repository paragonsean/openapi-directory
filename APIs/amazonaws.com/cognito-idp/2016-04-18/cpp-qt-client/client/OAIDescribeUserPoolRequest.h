...
/*
 * OAIDescribeUserPoolRequest.h
 *
 * Represents the request to describe the user pool.
 */

#ifndef OAIDescribeUserPoolRequest_H
#define OAIDescribeUserPoolRequest_H
...
class OAIDescribeUserPoolRequest : public OAIObject {
public:
    OAIDescribeUserPoolRequest();
    OAIDescribeUserPoolRequest(QString json);
    ~OAIDescribeUserPoolRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeUserPoolRequest)

#endif // OAIDescribeUserPoolRequest_H
