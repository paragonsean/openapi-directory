...
OAISetUserSettingsRequest::OAISetUserSettingsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISetUserSettingsRequest::OAISetUserSettingsRequest() {
    this->initializeModel();
}

OAISetUserSettingsRequest::~OAISetUserSettingsRequest() {}

void OAISetUserSettingsRequest::initializeModel() {
...
void OAISetUserSettingsRequest::fromJson(QString jsonString) {
...
void OAISetUserSettingsRequest::fromJsonObject(QJsonObject json) {
...
QString OAISetUserSettingsRequest::asJson() const {
...
QJsonObject OAISetUserSettingsRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAISetUserSettingsRequest::getAccessToken() const {
    return m_access_token;
}
void OAISetUserSettingsRequest::setAccessToken(const QString &access_token) {
    m_access_token = access_token;
    m_access_token_isSet = true;
}

bool OAISetUserSettingsRequest::is_access_token_Set() const{
    return m_access_token_isSet;
}

bool OAISetUserSettingsRequest::is_access_token_Valid() const{
    return m_access_token_isValid;
}

QList OAISetUserSettingsRequest::getMfaOptions() const {
    return m_mfa_options;
}
void OAISetUserSettingsRequest::setMfaOptions(const QList &mfa_options) {
    m_mfa_options = mfa_options;
    m_mfa_options_isSet = true;
}

bool OAISetUserSettingsRequest::is_mfa_options_Set() const{
    return m_mfa_options_isSet;
}

bool OAISetUserSettingsRequest::is_mfa_options_Valid() const{
    return m_mfa_options_isValid;
}

bool OAISetUserSettingsRequest::isSet() const {
...
bool OAISetUserSettingsRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_access_token_isValid && m_mfa_options_isValid && true;
}
