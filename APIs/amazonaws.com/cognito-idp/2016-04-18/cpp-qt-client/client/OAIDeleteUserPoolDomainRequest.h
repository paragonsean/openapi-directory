...
/*
 * OAIDeleteUserPoolDomainRequest.h
 *
 * 
 */

#ifndef OAIDeleteUserPoolDomainRequest_H
#define OAIDeleteUserPoolDomainRequest_H
...
class OAIDeleteUserPoolDomainRequest : public OAIObject {
public:
    OAIDeleteUserPoolDomainRequest();
    OAIDeleteUserPoolDomainRequest(QString json);
    ~OAIDeleteUserPoolDomainRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteUserPoolDomainRequest)

#endif // OAIDeleteUserPoolDomainRequest_H
