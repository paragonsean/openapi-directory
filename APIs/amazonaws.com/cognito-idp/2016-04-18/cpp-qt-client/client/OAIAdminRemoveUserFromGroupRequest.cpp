...
OAIAdminRemoveUserFromGroupRequest::OAIAdminRemoveUserFromGroupRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdminRemoveUserFromGroupRequest::OAIAdminRemoveUserFromGroupRequest() {
    this->initializeModel();
}

OAIAdminRemoveUserFromGroupRequest::~OAIAdminRemoveUserFromGroupRequest() {}

void OAIAdminRemoveUserFromGroupRequest::initializeModel() {
...
void OAIAdminRemoveUserFromGroupRequest::fromJson(QString jsonString) {
...
void OAIAdminRemoveUserFromGroupRequest::fromJsonObject(QJsonObject json) {
...
QString OAIAdminRemoveUserFromGroupRequest::asJson() const {
...
QJsonObject OAIAdminRemoveUserFromGroupRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAdminRemoveUserFromGroupRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIAdminRemoveUserFromGroupRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIAdminRemoveUserFromGroupRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIAdminRemoveUserFromGroupRequest::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

QString OAIAdminRemoveUserFromGroupRequest::getUsername() const {
    return m_username;
}
void OAIAdminRemoveUserFromGroupRequest::setUsername(const QString &username) {
    m_username = username;
    m_username_isSet = true;
}

bool OAIAdminRemoveUserFromGroupRequest::is_username_Set() const{
    return m_username_isSet;
}

bool OAIAdminRemoveUserFromGroupRequest::is_username_Valid() const{
    return m_username_isValid;
}

QString OAIAdminRemoveUserFromGroupRequest::getGroupName() const {
    return m_group_name;
}
void OAIAdminRemoveUserFromGroupRequest::setGroupName(const QString &group_name) {
    m_group_name = group_name;
    m_group_name_isSet = true;
}

bool OAIAdminRemoveUserFromGroupRequest::is_group_name_Set() const{
    return m_group_name_isSet;
}

bool OAIAdminRemoveUserFromGroupRequest::is_group_name_Valid() const{
    return m_group_name_isValid;
}

bool OAIAdminRemoveUserFromGroupRequest::isSet() const {
...
bool OAIAdminRemoveUserFromGroupRequest::isValid() const {
