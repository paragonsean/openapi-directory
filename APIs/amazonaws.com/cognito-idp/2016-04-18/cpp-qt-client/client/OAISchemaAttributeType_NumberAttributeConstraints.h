...
/*
 * OAISchemaAttributeType_NumberAttributeConstraints.h
 *
 * 
 */

#ifndef OAISchemaAttributeType_NumberAttributeConstraints_H
#define OAISchemaAttributeType_NumberAttributeConstraints_H
...
class OAISchemaAttributeType_NumberAttributeConstraints : public OAIObject {
public:
    OAISchemaAttributeType_NumberAttributeConstraints();
    OAISchemaAttributeType_NumberAttributeConstraints(QString json);
    ~OAISchemaAttributeType_NumberAttributeConstraints() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISchemaAttributeType_NumberAttributeConstraints)

#endif // OAISchemaAttributeType_NumberAttributeConstraints_H
