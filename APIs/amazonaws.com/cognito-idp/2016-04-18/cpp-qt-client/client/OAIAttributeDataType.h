...
/*
 * OAIAttributeDataType.h
 *
 * 
 */

#ifndef OAIAttributeDataType_H
#define OAIAttributeDataType_H
...
class OAIAttributeDataType : public OAIEnum {
public:
    OAIAttributeDataType();
    OAIAttributeDataType(QString json);
    ~OAIAttributeDataType() override;
    ...
    enum class eOAIAttributeDataType {
    ...
    OAIAttributeDataType::eOAIAttributeDataType getValue() const;
    void setValue(const OAIAttributeDataType::eOAIAttributeDataType& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIAttributeDataType)

#endif // OAIAttributeDataType_H
