...
/*
 * OAIForgetDeviceRequest.h
 *
 * Represents the request to forget the device.
 */

#ifndef OAIForgetDeviceRequest_H
#define OAIForgetDeviceRequest_H
...
class OAIForgetDeviceRequest : public OAIObject {
public:
    OAIForgetDeviceRequest();
    OAIForgetDeviceRequest(QString json);
    ~OAIForgetDeviceRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIForgetDeviceRequest)

#endif // OAIForgetDeviceRequest_H
