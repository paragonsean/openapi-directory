...
OAIAdminGetDeviceRequest::OAIAdminGetDeviceRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdminGetDeviceRequest::OAIAdminGetDeviceRequest() {
    this->initializeModel();
}

OAIAdminGetDeviceRequest::~OAIAdminGetDeviceRequest() {}

void OAIAdminGetDeviceRequest::initializeModel() {
...
void OAIAdminGetDeviceRequest::fromJson(QString jsonString) {
...
void OAIAdminGetDeviceRequest::fromJsonObject(QJsonObject json) {
...
QString OAIAdminGetDeviceRequest::asJson() const {
...
QJsonObject OAIAdminGetDeviceRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAdminGetDeviceRequest::getDeviceKey() const {
    return m_device_key;
}
void OAIAdminGetDeviceRequest::setDeviceKey(const QString &device_key) {
    m_device_key = device_key;
    m_device_key_isSet = true;
}

bool OAIAdminGetDeviceRequest::is_device_key_Set() const{
    return m_device_key_isSet;
}

bool OAIAdminGetDeviceRequest::is_device_key_Valid() const{
    return m_device_key_isValid;
}

QString OAIAdminGetDeviceRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIAdminGetDeviceRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIAdminGetDeviceRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIAdminGetDeviceRequest::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

QString OAIAdminGetDeviceRequest::getUsername() const {
    return m_username;
}
void OAIAdminGetDeviceRequest::setUsername(const QString &username) {
    m_username = username;
    m_username_isSet = true;
}

bool OAIAdminGetDeviceRequest::is_username_Set() const{
    return m_username_isSet;
}

bool OAIAdminGetDeviceRequest::is_username_Valid() const{
    return m_username_isValid;
}

bool OAIAdminGetDeviceRequest::isSet() const {
...
bool OAIAdminGetDeviceRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_device_key_isValid && m_user_pool_id_isValid && m_username_isValid && true;
}
