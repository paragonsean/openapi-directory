...
OAISetLogDeliveryConfigurationRequest::OAISetLogDeliveryConfigurationRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISetLogDeliveryConfigurationRequest::OAISetLogDeliveryConfigurationRequest() {
    this->initializeModel();
}

OAISetLogDeliveryConfigurationRequest::~OAISetLogDeliveryConfigurationRequest() {}

void OAISetLogDeliveryConfigurationRequest::initializeModel() {

    m_user_pool_id_isSet = false;
    m_user_pool_id_isValid = false;

    m_log_configurations_isSet = false;
    m_log_configurations_isValid = false;
}

void OAISetLogDeliveryConfigurationRequest::fromJson(QString jsonString) {
...
void OAISetLogDeliveryConfigurationRequest::fromJsonObject(QJsonObject json) {
    ...
    m_log_configurations_isValid = ::OpenAPI::fromJsonValue(m_log_configurations, json[QString("LogConfigurations")]);
    m_log_configurations_isSet = !json[QString("LogConfigurations")].isNull() && m_log_configurations_isValid;
}

QString OAISetLogDeliveryConfigurationRequest::asJson() const {
...
QJsonObject OAISetLogDeliveryConfigurationRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_user_pool_id_isSet) {
        obj.insert(QString("UserPoolId"), ::OpenAPI::toJsonValue(m_user_pool_id));
    }
    if (m_log_configurations.isSet()) {
        obj.insert(QString("LogConfigurations"), ::OpenAPI::toJsonValue(m_log_configurations));
    }
    return obj;
}

QString OAISetLogDeliveryConfigurationRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAISetLogDeliveryConfigurationRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAISetLogDeliveryConfigurationRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAISetLogDeliveryConfigurationRequest::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

QList OAISetLogDeliveryConfigurationRequest::getLogConfigurations() const {
    return m_log_configurations;
}
void OAISetLogDeliveryConfigurationRequest::setLogConfigurations(const QList &log_configurations) {
    m_log_configurations = log_configurations;
    m_log_configurations_isSet = true;
}

bool OAISetLogDeliveryConfigurationRequest::is_log_configurations_Set() const{
    return m_log_configurations_isSet;
}

bool OAISetLogDeliveryConfigurationRequest::is_log_configurations_Valid() const{
    return m_log_configurations_isValid;
}

bool OAISetLogDeliveryConfigurationRequest::isSet() const {
...
bool OAISetLogDeliveryConfigurationRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_user_pool_id_isValid && m_log_configurations_isValid && true;
}
