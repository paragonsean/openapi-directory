...
OAIUpdateUserPoolRequest_LambdaConfig::OAIUpdateUserPoolRequest_LambdaConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateUserPoolRequest_LambdaConfig::OAIUpdateUserPoolRequest_LambdaConfig() {
    this->initializeModel();
}

OAIUpdateUserPoolRequest_LambdaConfig::~OAIUpdateUserPoolRequest_LambdaConfig() {}

void OAIUpdateUserPoolRequest_LambdaConfig::initializeModel() {
...
void OAIUpdateUserPoolRequest_LambdaConfig::fromJson(QString jsonString) {
...
void OAIUpdateUserPoolRequest_LambdaConfig::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateUserPoolRequest_LambdaConfig::asJson() const {
...
QJsonObject OAIUpdateUserPoolRequest_LambdaConfig::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateUserPoolRequest_LambdaConfig::getPreSignUp() const {
    return m_pre_sign_up;
}
void OAIUpdateUserPoolRequest_LambdaConfig::setPreSignUp(const QString &pre_sign_up) {
    m_pre_sign_up = pre_sign_up;
    m_pre_sign_up_isSet = true;
}

bool OAIUpdateUserPoolRequest_LambdaConfig::is_pre_sign_up_Set() const{
    return m_pre_sign_up_isSet;
}

bool OAIUpdateUserPoolRequest_LambdaConfig::is_pre_sign_up_Valid() const{
    return m_pre_sign_up_isValid;
}

QString OAIUpdateUserPoolRequest_LambdaConfig::getCustomMessage() const {
    return m_custom_message;
}
void OAIUpdateUserPoolRequest_LambdaConfig::setCustomMessage(const QString &custom_message) {
    m_custom_message = custom_message;
    m_custom_message_isSet = true;
}

bool OAIUpdateUserPoolRequest_LambdaConfig::is_custom_message_Set() const{
    return m_custom_message_isSet;
}

bool OAIUpdateUserPoolRequest_LambdaConfig::is_custom_message_Valid() const{
    return m_custom_message_isValid;
}

QString OAIUpdateUserPoolRequest_LambdaConfig::getPostConfirmation() const {
    return m_post_confirmation;
}
void OAIUpdateUserPoolRequest_LambdaConfig::setPostConfirmation(const QString &post_confirmation) {
    m_post_confirmation = post_confirmation;
    m_post_confirmation_isSet = true;
}

bool OAIUpdateUserPoolRequest_LambdaConfig::is_post_confirmation_Set() const{
    return m_post_confirmation_isSet;
}

bool OAIUpdateUserPoolRequest_LambdaConfig::is_post_confirmation_Valid() const{
    return m_post_confirmation_isValid;
}

QString OAIUpdateUserPoolRequest_LambdaConfig::getPreAuthentication() const {
    return m_pre_authentication;
}
void OAIUpdateUserPoolRequest_LambdaConfig::setPreAuthentication(const QString &pre_authentication) {
    m_pre_authentication = pre_authentication;
    m_pre_authentication_isSet = true;
}

bool OAIUpdateUserPoolRequest_LambdaConfig::is_pre_authentication_Set() const{
    return m_pre_authentication_isSet;
}

bool OAIUpdateUserPoolRequest_LambdaConfig::is_pre_authentication_Valid() const{
    return m_pre_authentication_isValid;
}

QString OAIUpdateUserPoolRequest_LambdaConfig::getPostAuthentication() const {
    return m_post_authentication;
}
void OAIUpdateUserPoolRequest_LambdaConfig::setPostAuthentication(const QString &post_authentication) {
    m_post_authentication = post_authentication;
    m_post_authentication_isSet = true;
}

bool OAIUpdateUserPoolRequest_LambdaConfig::is_post_authentication_Set() const{
    return m_post_authentication_isSet;
}

bool OAIUpdateUserPoolRequest_LambdaConfig::is_post_authentication_Valid() const{
    return m_post_authentication_isValid;
}

QString OAIUpdateUserPoolRequest_LambdaConfig::getDefineAuthChallenge() const {
    return m_define_auth_challenge;
}
void OAIUpdateUserPoolRequest_LambdaConfig::setDefineAuthChallenge(const QString &define_auth_challenge) {
    m_define_auth_challenge = define_auth_challenge;
    m_define_auth_challenge_isSet = true;
}

bool OAIUpdateUserPoolRequest_LambdaConfig::is_define_auth_challenge_Set() const{
    return m_define_auth_challenge_isSet;
}

bool OAIUpdateUserPoolRequest_LambdaConfig::is_define_auth_challenge_Valid() const{
    return m_define_auth_challenge_isValid;
}

QString OAIUpdateUserPoolRequest_LambdaConfig::getCreateAuthChallenge() const {
    return m_create_auth_challenge;
}
void OAIUpdateUserPoolRequest_LambdaConfig::setCreateAuthChallenge(const QString &create_auth_challenge) {
    m_create_auth_challenge = create_auth_challenge;
    m_create_auth_challenge_isSet = true;
}

bool OAIUpdateUserPoolRequest_LambdaConfig::is_create_auth_challenge_Set() const{
    return m_create_auth_challenge_isSet;
}

bool OAIUpdateUserPoolRequest_LambdaConfig::is_create_auth_challenge_Valid() const{
    return m_create_auth_challenge_isValid;
}

QString OAIUpdateUserPoolRequest_LambdaConfig::getVerifyAuthChallengeResponse() const {
    return m_verify_auth_challenge_response;
}
void OAIUpdateUserPoolRequest_LambdaConfig::setVerifyAuthChallengeResponse(const QString &verify_auth_challenge_response) {
    m_verify_auth_challenge_response = verify_auth_challenge_response;
    m_verify_auth_challenge_response_isSet = true;
}

bool OAIUpdateUserPoolRequest_LambdaConfig::is_verify_auth_challenge_response_Set() const{
    return m_verify_auth_challenge_response_isSet;
}

bool OAIUpdateUserPoolRequest_LambdaConfig::is_verify_auth_challenge_response_Valid() const{
    return m_verify_auth_challenge_response_isValid;
}

QString OAIUpdateUserPoolRequest_LambdaConfig::getPreTokenGeneration() const {
    return m_pre_token_generation;
}
void OAIUpdateUserPoolRequest_LambdaConfig::setPreTokenGeneration(const QString &pre_token_generation) {
    m_pre_token_generation = pre_token_generation;
    m_pre_token_generation_isSet = true;
}

bool OAIUpdateUserPoolRequest_LambdaConfig::is_pre_token_generation_Set() const{
    return m_pre_token_generation_isSet;
}

bool OAIUpdateUserPoolRequest_LambdaConfig::is_pre_token_generation_Valid() const{
    return m_pre_token_generation_isValid;
}

QString OAIUpdateUserPoolRequest_LambdaConfig::getUserMigration() const {
    return m_user_migration;
}
void OAIUpdateUserPoolRequest_LambdaConfig::setUserMigration(const QString &user_migration) {
    m_user_migration = user_migration;
    m_user_migration_isSet = true;
}

bool OAIUpdateUserPoolRequest_LambdaConfig::is_user_migration_Set() const{
    return m_user_migration_isSet;
}

bool OAIUpdateUserPoolRequest_LambdaConfig::is_user_migration_Valid() const{
    return m_user_migration_isValid;
}

OAILambdaConfigType_CustomSMSSender OAIUpdateUserPoolRequest_LambdaConfig::getCustomSmsSender() const {
    return m_custom_sms_sender;
}
void OAIUpdateUserPoolRequest_LambdaConfig::setCustomSmsSender(const OAILambdaConfigType_CustomSMSSender &custom_sms_sender) {
    m_custom_sms_sender = custom_sms_sender;
    m_custom_sms_sender_isSet = true;
}

bool OAIUpdateUserPoolRequest_LambdaConfig::is_custom_sms_sender_Set() const{
    return m_custom_sms_sender_isSet;
}

bool OAIUpdateUserPoolRequest_LambdaConfig::is_custom_sms_sender_Valid() const{
    return m_custom_sms_sender_isValid;
}

OAILambdaConfigType_CustomEmailSender OAIUpdateUserPoolRequest_LambdaConfig::getCustomEmailSender() const {
    return m_custom_email_sender;
}
void OAIUpdateUserPoolRequest_LambdaConfig::setCustomEmailSender(const OAILambdaConfigType_CustomEmailSender &custom_email_sender) {
    m_custom_email_sender = custom_email_sender;
    m_custom_email_sender_isSet = true;
}

bool OAIUpdateUserPoolRequest_LambdaConfig::is_custom_email_sender_Set() const{
    return m_custom_email_sender_isSet;
}

bool OAIUpdateUserPoolRequest_LambdaConfig::is_custom_email_sender_Valid() const{
    return m_custom_email_sender_isValid;
}

QString OAIUpdateUserPoolRequest_LambdaConfig::getKmsKeyId() const {
    return m_kms_key_id;
}
void OAIUpdateUserPoolRequest_LambdaConfig::setKmsKeyId(const QString &kms_key_id) {
    m_kms_key_id = kms_key_id;
    m_kms_key_id_isSet = true;
}

bool OAIUpdateUserPoolRequest_LambdaConfig::is_kms_key_id_Set() const{
    return m_kms_key_id_isSet;
}

bool OAIUpdateUserPoolRequest_LambdaConfig::is_kms_key_id_Valid() const{
    return m_kms_key_id_isValid;
}

bool OAIUpdateUserPoolRequest_LambdaConfig::isSet() const {
...
bool OAIUpdateUserPoolRequest_LambdaConfig::isValid() const {
