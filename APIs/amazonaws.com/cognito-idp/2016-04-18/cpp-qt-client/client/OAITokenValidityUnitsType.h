...
#ifndef OAITokenValidityUnitsType_H
#define OAITokenValidityUnitsType_H
...
class OAITokenValidityUnitsType : public OAIObject {
public:
    OAITokenValidityUnitsType();
    OAITokenValidityUnitsType(QString json);
    ~OAITokenValidityUnitsType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITokenValidityUnitsType)

#endif // OAITokenValidityUnitsType_H
