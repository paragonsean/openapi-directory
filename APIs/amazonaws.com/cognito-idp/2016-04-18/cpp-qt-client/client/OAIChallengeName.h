...
#ifndef OAIChallengeName_H
#define OAIChallengeName_H
...
class OAIChallengeName : public OAIEnum {
public:
    OAIChallengeName();
    OAIChallengeName(QString json);
    ~OAIChallengeName() override;
    ...
    enum class eOAIChallengeName {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        PASSWORD, 
        MFA
    };
    OAIChallengeName::eOAIChallengeName getValue() const;
    void setValue(const OAIChallengeName::eOAIChallengeName& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIChallengeName)

#endif // OAIChallengeName_H
