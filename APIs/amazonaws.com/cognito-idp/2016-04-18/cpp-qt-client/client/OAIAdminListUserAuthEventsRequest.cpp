...
OAIAdminListUserAuthEventsRequest::OAIAdminListUserAuthEventsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdminListUserAuthEventsRequest::OAIAdminListUserAuthEventsRequest() {
    this->initializeModel();
}

OAIAdminListUserAuthEventsRequest::~OAIAdminListUserAuthEventsRequest() {}

void OAIAdminListUserAuthEventsRequest::initializeModel() {
...
void OAIAdminListUserAuthEventsRequest::fromJson(QString jsonString) {
...
void OAIAdminListUserAuthEventsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIAdminListUserAuthEventsRequest::asJson() const {
...
QJsonObject OAIAdminListUserAuthEventsRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAdminListUserAuthEventsRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIAdminListUserAuthEventsRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIAdminListUserAuthEventsRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIAdminListUserAuthEventsRequest::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

QString OAIAdminListUserAuthEventsRequest::getUsername() const {
    return m_username;
}
void OAIAdminListUserAuthEventsRequest::setUsername(const QString &username) {
    m_username = username;
    m_username_isSet = true;
}

bool OAIAdminListUserAuthEventsRequest::is_username_Set() const{
    return m_username_isSet;
}

bool OAIAdminListUserAuthEventsRequest::is_username_Valid() const{
    return m_username_isValid;
}

qint32 OAIAdminListUserAuthEventsRequest::getMaxResults() const {
    return m_max_results;
}
void OAIAdminListUserAuthEventsRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIAdminListUserAuthEventsRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIAdminListUserAuthEventsRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIAdminListUserAuthEventsRequest::getNextToken() const {
    return m_next_token;
}
void OAIAdminListUserAuthEventsRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIAdminListUserAuthEventsRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIAdminListUserAuthEventsRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIAdminListUserAuthEventsRequest::isSet() const {
...
bool OAIAdminListUserAuthEventsRequest::isValid() const {
