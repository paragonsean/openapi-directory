...
/*
 * OAIAdminEnableUserRequest.h
 *
 * Represents the request that enables the user as an administrator.
 */

#ifndef OAIAdminEnableUserRequest_H
#define OAIAdminEnableUserRequest_H
...
class OAIAdminEnableUserRequest : public OAIObject {
public:
    OAIAdminEnableUserRequest();
    OAIAdminEnableUserRequest(QString json);
    ~OAIAdminEnableUserRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdminEnableUserRequest)

#endif // OAIAdminEnableUserRequest_H
