...
OAIListResourceServersRequest::OAIListResourceServersRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListResourceServersRequest::OAIListResourceServersRequest() {
    this->initializeModel();
}

OAIListResourceServersRequest::~OAIListResourceServersRequest() {}

void OAIListResourceServersRequest::initializeModel() {
...
void OAIListResourceServersRequest::fromJson(QString jsonString) {
...
void OAIListResourceServersRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListResourceServersRequest::asJson() const {
...
QJsonObject OAIListResourceServersRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListResourceServersRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIListResourceServersRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIListResourceServersRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIListResourceServersRequest::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

qint32 OAIListResourceServersRequest::getMaxResults() const {
    return m_max_results;
}
void OAIListResourceServersRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListResourceServersRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListResourceServersRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIListResourceServersRequest::getNextToken() const {
    return m_next_token;
}
void OAIListResourceServersRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListResourceServersRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListResourceServersRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListResourceServersRequest::isSet() const {
...
bool OAIListResourceServersRequest::isValid() const {
