...
OAIGetUICustomizationResponse::OAIGetUICustomizationResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetUICustomizationResponse::OAIGetUICustomizationResponse() {
    this->initializeModel();
}

OAIGetUICustomizationResponse::~OAIGetUICustomizationResponse() {}

void OAIGetUICustomizationResponse::initializeModel() {

    m_ui_customization_isSet = false;
    m_ui_customization_isValid = false;
}

void OAIGetUICustomizationResponse::fromJson(QString jsonString) {
...
void OAIGetUICustomizationResponse::fromJsonObject(QJsonObject json) {
...
QString OAIGetUICustomizationResponse::asJson() const {
...
QJsonObject OAIGetUICustomizationResponse::asJsonObject() const {
    QJsonObject obj;
...
OAIGetUICustomizationResponse_UICustomization OAIGetUICustomizationResponse::getUiCustomization() const {
    return m_ui_customization;
}
void OAIGetUICustomizationResponse::setUiCustomization(const OAIGetUICustomizationResponse_UICustomization &ui_customization) {
    m_ui_customization = ui_customization;
    m_ui_customization_isSet = true;
}

bool OAIGetUICustomizationResponse::is_ui_customization_Set() const{
    return m_ui_customization_isSet;
}

bool OAIGetUICustomizationResponse::is_ui_customization_Valid() const{
    return m_ui_customization_isValid;
}

bool OAIGetUICustomizationResponse::isSet() const {
...
bool OAIGetUICustomizationResponse::isValid() const {
