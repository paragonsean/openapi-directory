...
/*
 * OAIEventFeedbackType.h
 *
 * Specifies the event feedback type.
 */

#ifndef OAIEventFeedbackType_H
#define OAIEventFeedbackType_H
...
class OAIEventFeedbackType : public OAIObject {
public:
    OAIEventFeedbackType();
    OAIEventFeedbackType(QString json);
    ~OAIEventFeedbackType() override;
    ...
    OAIFeedbackValueType getFeedbackValue() const;
    void setFeedbackValue(const OAIFeedbackValueType &feedback_value);
    bool is_feedback_value_Set() const;
    bool is_feedback_value_Valid() const;
    ...
    QDateTime getFeedbackDate() const;
    void setFeedbackDate(const QDateTime &feedback_date);
...
private:
    ...
    OAIFeedbackValueType m_feedback_value;
    bool m_feedback_value_isSet;
    bool m_feedback_value_isValid;

    QString m_provider;
    bool m_provider_isSet;
    bool m_provider_isValid;

    QDateTime m_feedback_date;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEventFeedbackType)

#endif // OAIEventFeedbackType_H
