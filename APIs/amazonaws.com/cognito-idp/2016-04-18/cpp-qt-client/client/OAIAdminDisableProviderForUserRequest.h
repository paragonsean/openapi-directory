...
/*
 * OAIAdminDisableProviderForUserRequest.h
 *
 * 
 */

#ifndef OAIAdminDisableProviderForUserRequest_H
#define OAIAdminDisableProviderForUserRequest_H
...
namespace OpenAPI {
class OAIAdminDisableProviderForUserRequest_User;

class OAIAdminDisableProviderForUserRequest : public OAIObject {
public:
    OAIAdminDisableProviderForUserRequest();
    OAIAdminDisableProviderForUserRequest(QString json);
    ~OAIAdminDisableProviderForUserRequest() override;
    ...
    OAIAdminDisableProviderForUserRequest_User getUser() const;
    void setUser(const OAIAdminDisableProviderForUserRequest_User &user);
...
private:
    ...
    OAIAdminDisableProviderForUserRequest_User m_user;
    bool m_user_isSet;
    bool m_user_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdminDisableProviderForUserRequest)

#endif // OAIAdminDisableProviderForUserRequest_H
