...
/*
 * OAIUpdateUserPoolClientResponse_UserPoolClient.h
 *
 * 
 */

#ifndef OAIUpdateUserPoolClientResponse_UserPoolClient_H
#define OAIUpdateUserPoolClientResponse_UserPoolClient_H
...
class OAIUpdateUserPoolClientResponse_UserPoolClient : public OAIObject {
public:
    OAIUpdateUserPoolClientResponse_UserPoolClient();
    OAIUpdateUserPoolClientResponse_UserPoolClient(QString json);
    ~OAIUpdateUserPoolClientResponse_UserPoolClient() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateUserPoolClientResponse_UserPoolClient)

#endif // OAIUpdateUserPoolClientResponse_UserPoolClient_H
