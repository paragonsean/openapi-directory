...
/*
 * OAICreateUserPoolDomainRequest.h
 *
 * 
 */

#ifndef OAICreateUserPoolDomainRequest_H
#define OAICreateUserPoolDomainRequest_H
...
namespace OpenAPI {
class OAICreateUserPoolDomainRequest_CustomDomainConfig;

class OAICreateUserPoolDomainRequest : public OAIObject {
public:
    OAICreateUserPoolDomainRequest();
    OAICreateUserPoolDomainRequest(QString json);
    ~OAICreateUserPoolDomainRequest() override;
    ...
    OAICreateUserPoolDomainRequest_CustomDomainConfig getCustomDomainConfig() const;
    void setCustomDomainConfig(const OAICreateUserPoolDomainRequest_CustomDomainConfig &custom_domain_config);
...
private:
    ...
    OAICreateUserPoolDomainRequest_CustomDomainConfig m_custom_domain_config;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateUserPoolDomainRequest)

#endif // OAICreateUserPoolDomainRequest_H
