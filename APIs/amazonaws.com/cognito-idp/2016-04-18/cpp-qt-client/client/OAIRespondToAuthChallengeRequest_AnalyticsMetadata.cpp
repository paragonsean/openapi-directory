...
OAIRespondToAuthChallengeRequest_AnalyticsMetadata::OAIRespondToAuthChallengeRequest_AnalyticsMetadata(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRespondToAuthChallengeRequest_AnalyticsMetadata::OAIRespondToAuthChallengeRequest_AnalyticsMetadata() {
    this->initializeModel();
}

OAIRespondToAuthChallengeRequest_AnalyticsMetadata::~OAIRespondToAuthChallengeRequest_AnalyticsMetadata() {}

void OAIRespondToAuthChallengeRequest_AnalyticsMetadata::initializeModel() {

    m_analytics_endpoint_id_isSet = false;
    m_analytics_endpoint_id_isValid = false;
}

void OAIRespondToAuthChallengeRequest_AnalyticsMetadata::fromJson(QString jsonString) {
...
void OAIRespondToAuthChallengeRequest_AnalyticsMetadata::fromJsonObject(QJsonObject json) {
...
QString OAIRespondToAuthChallengeRequest_AnalyticsMetadata::asJson() const {
...
QJsonObject OAIRespondToAuthChallengeRequest_AnalyticsMetadata::asJsonObject() const {
    QJsonObject obj;
...
QString OAIRespondToAuthChallengeRequest_AnalyticsMetadata::getAnalyticsEndpointId() const {
    return m_analytics_endpoint_id;
}
void OAIRespondToAuthChallengeRequest_AnalyticsMetadata::setAnalyticsEndpointId(const QString &analytics_endpoint_id) {
    m_analytics_endpoint_id = analytics_endpoint_id;
    m_analytics_endpoint_id_isSet = true;
}

bool OAIRespondToAuthChallengeRequest_AnalyticsMetadata::is_analytics_endpoint_id_Set() const{
    return m_analytics_endpoint_id_isSet;
}

bool OAIRespondToAuthChallengeRequest_AnalyticsMetadata::is_analytics_endpoint_id_Valid() const{
    return m_analytics_endpoint_id_isValid;
}

bool OAIRespondToAuthChallengeRequest_AnalyticsMetadata::isSet() const {
...
bool OAIRespondToAuthChallengeRequest_AnalyticsMetadata::isValid() const {
