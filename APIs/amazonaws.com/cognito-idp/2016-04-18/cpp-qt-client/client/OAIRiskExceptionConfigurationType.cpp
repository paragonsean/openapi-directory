...
#include "OAIRiskExceptionConfigurationType.h"
...
OAIRiskExceptionConfigurationType::OAIRiskExceptionConfigurationType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRiskExceptionConfigurationType::OAIRiskExceptionConfigurationType() {
    this->initializeModel();
}

OAIRiskExceptionConfigurationType::~OAIRiskExceptionConfigurationType() {}

void OAIRiskExceptionConfigurationType::initializeModel() {
...
void OAIRiskExceptionConfigurationType::fromJson(QString jsonString) {
...
void OAIRiskExceptionConfigurationType::fromJsonObject(QJsonObject json) {
...
QString OAIRiskExceptionConfigurationType::asJson() const {
...
QJsonObject OAIRiskExceptionConfigurationType::asJsonObject() const {
    QJsonObject obj;
...
QList OAIRiskExceptionConfigurationType::getBlockedIpRangeList() const {
    return m_blocked_ip_range_list;
}
void OAIRiskExceptionConfigurationType::setBlockedIpRangeList(const QList &blocked_ip_range_list) {
    m_blocked_ip_range_list = blocked_ip_range_list;
    m_blocked_ip_range_list_isSet = true;
}

bool OAIRiskExceptionConfigurationType::is_blocked_ip_range_list_Set() const{
    return m_blocked_ip_range_list_isSet;
}

bool OAIRiskExceptionConfigurationType::is_blocked_ip_range_list_Valid() const{
    return m_blocked_ip_range_list_isValid;
}

QList OAIRiskExceptionConfigurationType::getSkippedIpRangeList() const {
    return m_skipped_ip_range_list;
}
void OAIRiskExceptionConfigurationType::setSkippedIpRangeList(const QList &skipped_ip_range_list) {
    m_skipped_ip_range_list = skipped_ip_range_list;
    m_skipped_ip_range_list_isSet = true;
}

bool OAIRiskExceptionConfigurationType::is_skipped_ip_range_list_Set() const{
    return m_skipped_ip_range_list_isSet;
}

bool OAIRiskExceptionConfigurationType::is_skipped_ip_range_list_Valid() const{
    return m_skipped_ip_range_list_isValid;
}

bool OAIRiskExceptionConfigurationType::isSet() const {
...
bool OAIRiskExceptionConfigurationType::isValid() const {
