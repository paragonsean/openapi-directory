...
/*
 * OAIAdminInitiateAuthRequest_AnalyticsMetadata.h
 *
 * 
 */

#ifndef OAIAdminInitiateAuthRequest_AnalyticsMetadata_H
#define OAIAdminInitiateAuthRequest_AnalyticsMetadata_H
...
class OAIAdminInitiateAuthRequest_AnalyticsMetadata : public OAIObject {
public:
    OAIAdminInitiateAuthRequest_AnalyticsMetadata();
    OAIAdminInitiateAuthRequest_AnalyticsMetadata(QString json);
    ~OAIAdminInitiateAuthRequest_AnalyticsMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdminInitiateAuthRequest_AnalyticsMetadata)

#endif // OAIAdminInitiateAuthRequest_AnalyticsMetadata_H
