...
OAIChallengeName::OAIChallengeName(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIChallengeName::OAIChallengeName() {
    this->initializeModel();
}

OAIChallengeName::~OAIChallengeName() {}

void OAIChallengeName::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIChallengeName::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIChallengeName::fromJson(QString jsonString) {
    
    if ( jsonString.compare("Password", Qt::CaseInsensitive) == 0) {
        m_value = eOAIChallengeName::PASSWORD;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Mfa", Qt::CaseInsensitive) == 0) {
        m_value = eOAIChallengeName::MFA;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIChallengeName::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIChallengeName::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIChallengeName::PASSWORD:
            val = "Password";
            break;
        case eOAIChallengeName::MFA:
            val = "Mfa";
            break;
        default:
            break;
...
QJsonValue OAIChallengeName::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIChallengeName::eOAIChallengeName OAIChallengeName::getValue() const {
    return m_value;
}

void OAIChallengeName::setValue(const OAIChallengeName::eOAIChallengeName& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIChallengeName::isSet() const {
    
    return m_value_isSet;
}

bool OAIChallengeName::isValid() const {
