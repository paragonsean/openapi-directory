...
/*
 * OAIDeleteIdentityProviderRequest.h
 *
 * 
 */

#ifndef OAIDeleteIdentityProviderRequest_H
#define OAIDeleteIdentityProviderRequest_H
...
class OAIDeleteIdentityProviderRequest : public OAIObject {
public:
    OAIDeleteIdentityProviderRequest();
    OAIDeleteIdentityProviderRequest(QString json);
    ~OAIDeleteIdentityProviderRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteIdentityProviderRequest)

#endif // OAIDeleteIdentityProviderRequest_H
