...
OAISetUICustomizationResponse::OAISetUICustomizationResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISetUICustomizationResponse::OAISetUICustomizationResponse() {
    this->initializeModel();
}

OAISetUICustomizationResponse::~OAISetUICustomizationResponse() {}

void OAISetUICustomizationResponse::initializeModel() {

    m_ui_customization_isSet = false;
    m_ui_customization_isValid = false;
}

void OAISetUICustomizationResponse::fromJson(QString jsonString) {
...
void OAISetUICustomizationResponse::fromJsonObject(QJsonObject json) {

    m_ui_customization_isValid = ::OpenAPI::fromJsonValue(m_ui_customization, json[QString("UICustomization")]);
    m_ui_customization_isSet = !json[QString("UICustomization")].isNull() && m_ui_customization_isValid;
}

QString OAISetUICustomizationResponse::asJson() const {
...
QJsonObject OAISetUICustomizationResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_ui_customization.isSet()) {
        obj.insert(QString("UICustomization"), ::OpenAPI::toJsonValue(m_ui_customization));
    }
    return obj;
}

OAIGetUICustomizationResponse_UICustomization OAISetUICustomizationResponse::getUiCustomization() const {
    return m_ui_customization;
}
void OAISetUICustomizationResponse::setUiCustomization(const OAIGetUICustomizationResponse_UICustomization &ui_customization) {
    m_ui_customization = ui_customization;
    m_ui_customization_isSet = true;
}

bool OAISetUICustomizationResponse::is_ui_customization_Set() const{
    return m_ui_customization_isSet;
}

bool OAISetUICustomizationResponse::is_ui_customization_Valid() const{
    return m_ui_customization_isValid;
}

bool OAISetUICustomizationResponse::isSet() const {
...
bool OAISetUICustomizationResponse::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_ui_customization_isValid && true;
}
