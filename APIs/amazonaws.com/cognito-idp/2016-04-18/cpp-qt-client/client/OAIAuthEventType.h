...
#ifndef OAIAuthEventType_H
#define OAIAuthEventType_H
...
#include "OAIEventResponseType.h"
...
namespace OpenAPI {
class OAIAuthEventType_EventRisk;
class OAIAuthEventType_EventContextData;
class OAIAuthEventType_EventFeedback;

class OAIAuthEventType : public OAIObject {
public:
    OAIAuthEventType();
    OAIAuthEventType(QString json);
    ~OAIAuthEventType() override;
    ...
    OAIEventResponseType getEventResponse() const;
    void setEventResponse(const OAIEventResponseType &event_response);
    bool is_event_response_Set() const;
    bool is_event_response_Valid() const;

    OAIAuthEventType_EventRisk getEventRisk() const;
    void setEventRisk(const OAIAuthEventType_EventRisk &event_risk);
    bool is_event_risk_Set() const;
    bool is_event_risk_Valid() const;

    QList getChallengeResponses() const;
    void setChallengeResponses(const QList &challenge_responses);
    bool is_challenge_responses_Set() const;
    bool is_challenge_responses_Valid() const;

    OAIAuthEventType_EventContextData getEventContextData() const;
    void setEventContextData(const OAIAuthEventType_EventContextData &event_context_data);
    bool is_event_context_data_Set() const;
    bool is_event_context_data_Valid() const;

    OAIAuthEventType_EventFeedback getEventFeedback() const;
    void setEventFeedback(const OAIAuthEventType_EventFeedback &event_feedback);
    bool is_event_feedback_Set() const;
    bool is_event_feedback_Valid() const;
...
private:
    ...
    OAIEventResponseType m_event_response;
    bool m_event_response_isSet;
    bool m_event_response_isValid;

    OAIAuthEventType_EventRisk m_event_risk;
    bool m_event_risk_isSet;
    bool m_event_risk_isValid;

    QList m_challenge_responses;
    bool m_challenge_responses_isSet;
    bool m_challenge_responses_isValid;

    OAIAuthEventType_EventContextData m_event_context_data;
    bool m_event_context_data_isSet;
    bool m_event_context_data_isValid;

    OAIAuthEventType_EventFeedback m_event_feedback;
    bool m_event_feedback_isSet;
    bool m_event_feedback_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIAuthEventType)

#endif // OAIAuthEventType_H
