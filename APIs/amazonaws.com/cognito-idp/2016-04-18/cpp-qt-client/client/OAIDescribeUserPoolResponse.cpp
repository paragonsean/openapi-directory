...
OAIDescribeUserPoolResponse::OAIDescribeUserPoolResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeUserPoolResponse::OAIDescribeUserPoolResponse() {
    this->initializeModel();
}

OAIDescribeUserPoolResponse::~OAIDescribeUserPoolResponse() {}

void OAIDescribeUserPoolResponse::initializeModel() {

    m_user_pool_isSet = false;
    m_user_pool_isValid = false;
}

void OAIDescribeUserPoolResponse::fromJson(QString jsonString) {
...
void OAIDescribeUserPoolResponse::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeUserPoolResponse::asJson() const {
...
QJsonObject OAIDescribeUserPoolResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_user_pool.isSet()) {
        obj.insert(QString("UserPool"), ::OpenAPI::toJsonValue(m_user_pool));
    }
    return obj;
}

OAIDescribeUserPoolResponse_UserPool OAIDescribeUserPoolResponse::getUserPool() const {
    return m_user_pool;
}
void OAIDescribeUserPoolResponse::setUserPool(const OAIDescribeUserPoolResponse_UserPool &user_pool) {
    m_user_pool = user_pool;
    m_user_pool_isSet = true;
}

bool OAIDescribeUserPoolResponse::is_user_pool_Set() const{
    return m_user_pool_isSet;
}

bool OAIDescribeUserPoolResponse::is_user_pool_Valid() const{
    return m_user_pool_isValid;
}

bool OAIDescribeUserPoolResponse::isSet() const {
...
bool OAIDescribeUserPoolResponse::isValid() const {
