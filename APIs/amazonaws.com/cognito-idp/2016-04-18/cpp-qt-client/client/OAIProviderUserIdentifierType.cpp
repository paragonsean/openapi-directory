...
#include "OAIProviderUserIdentifierType.h"
...
OAIProviderUserIdentifierType::OAIProviderUserIdentifierType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIProviderUserIdentifierType::OAIProviderUserIdentifierType() {
    this->initializeModel();
}

OAIProviderUserIdentifierType::~OAIProviderUserIdentifierType() {}

void OAIProviderUserIdentifierType::initializeModel() {
...
void OAIProviderUserIdentifierType::fromJson(QString jsonString) {
...
void OAIProviderUserIdentifierType::fromJsonObject(QJsonObject json) {
...
QString OAIProviderUserIdentifierType::asJson() const {
...
QJsonObject OAIProviderUserIdentifierType::asJsonObject() const {
    QJsonObject obj;
...
QString OAIProviderUserIdentifierType::getProviderName() const {
    return m_provider_name;
}
void OAIProviderUserIdentifierType::setProviderName(const QString &provider_name) {
    m_provider_name = provider_name;
    m_provider_name_isSet = true;
}

bool OAIProviderUserIdentifierType::is_provider_name_Set() const{
    return m_provider_name_isSet;
}

bool OAIProviderUserIdentifierType::is_provider_name_Valid() const{
    return m_provider_name_isValid;
}

QString OAIProviderUserIdentifierType::getProviderAttributeName() const {
    return m_provider_attribute_name;
}
void OAIProviderUserIdentifierType::setProviderAttributeName(const QString &provider_attribute_name) {
    m_provider_attribute_name = provider_attribute_name;
    m_provider_attribute_name_isSet = true;
}

bool OAIProviderUserIdentifierType::is_provider_attribute_name_Set() const{
    return m_provider_attribute_name_isSet;
}

bool OAIProviderUserIdentifierType::is_provider_attribute_name_Valid() const{
    return m_provider_attribute_name_isValid;
}

QString OAIProviderUserIdentifierType::getProviderAttributeValue() const {
    return m_provider_attribute_value;
}
void OAIProviderUserIdentifierType::setProviderAttributeValue(const QString &provider_attribute_value) {
    m_provider_attribute_value = provider_attribute_value;
    m_provider_attribute_value_isSet = true;
}

bool OAIProviderUserIdentifierType::is_provider_attribute_value_Set() const{
    return m_provider_attribute_value_isSet;
}

bool OAIProviderUserIdentifierType::is_provider_attribute_value_Valid() const{
    return m_provider_attribute_value_isValid;
}

bool OAIProviderUserIdentifierType::isSet() const {
...
bool OAIProviderUserIdentifierType::isValid() const {
