...
OAIUpdateResourceServerResponse::OAIUpdateResourceServerResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateResourceServerResponse::OAIUpdateResourceServerResponse() {
    this->initializeModel();
}

OAIUpdateResourceServerResponse::~OAIUpdateResourceServerResponse() {}

void OAIUpdateResourceServerResponse::initializeModel() {

    m_resource_server_isSet = false;
    m_resource_server_isValid = false;
}

void OAIUpdateResourceServerResponse::fromJson(QString jsonString) {
...
void OAIUpdateResourceServerResponse::fromJsonObject(QJsonObject json) {

    m_resource_server_isValid = ::OpenAPI::fromJsonValue(m_resource_server, json[QString("ResourceServer")]);
    m_resource_server_isSet = !json[QString("ResourceServer")].isNull() && m_resource_server_isValid;
}

QString OAIUpdateResourceServerResponse::asJson() const {
...
QJsonObject OAIUpdateResourceServerResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_resource_server.isSet()) {
        obj.insert(QString("ResourceServer"), ::OpenAPI::toJsonValue(m_resource_server));
    }
    return obj;
}

OAIDescribeResourceServerResponse_ResourceServer OAIUpdateResourceServerResponse::getResourceServer() const {
    return m_resource_server;
}
void OAIUpdateResourceServerResponse::setResourceServer(const OAIDescribeResourceServerResponse_ResourceServer &resource_server) {
    m_resource_server = resource_server;
    m_resource_server_isSet = true;
}

bool OAIUpdateResourceServerResponse::is_resource_server_Set() const{
    return m_resource_server_isSet;
}

bool OAIUpdateResourceServerResponse::is_resource_server_Valid() const{
    return m_resource_server_isValid;
}

bool OAIUpdateResourceServerResponse::isSet() const {
...
bool OAIUpdateResourceServerResponse::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_resource_server_isValid && true;
}
