...
/*
 * OAICreateResourceServerRequest.h
 *
 * 
 */

#ifndef OAICreateResourceServerRequest_H
#define OAICreateResourceServerRequest_H
...
class OAICreateResourceServerRequest : public OAIObject {
public:
    OAICreateResourceServerRequest();
    OAICreateResourceServerRequest(QString json);
    ~OAICreateResourceServerRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateResourceServerRequest)

#endif // OAICreateResourceServerRequest_H
