...
/*
 * OAIAdminSetUserSettingsRequest.h
 *
 * You can use this parameter to set an MFA configuration that uses the SMS delivery medium.
 */

#ifndef OAIAdminSetUserSettingsRequest_H
#define OAIAdminSetUserSettingsRequest_H
...
class OAIAdminSetUserSettingsRequest : public OAIObject {
public:
    OAIAdminSetUserSettingsRequest();
    OAIAdminSetUserSettingsRequest(QString json);
    ~OAIAdminSetUserSettingsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdminSetUserSettingsRequest)

#endif // OAIAdminSetUserSettingsRequest_H
