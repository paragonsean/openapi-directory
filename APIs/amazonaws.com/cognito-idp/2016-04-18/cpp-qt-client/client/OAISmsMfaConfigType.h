...
/*
 * OAISmsMfaConfigType.h
 *
 * The SMS text message multi-factor authentication (MFA) configuration type.
 */

#ifndef OAISmsMfaConfigType_H
#define OAISmsMfaConfigType_H
...
class OAISmsMfaConfigType : public OAIObject {
public:
    OAISmsMfaConfigType();
    OAISmsMfaConfigType(QString json);
    ~OAISmsMfaConfigType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISmsMfaConfigType)

#endif // OAISmsMfaConfigType_H
