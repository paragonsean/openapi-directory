...
/*
 * OAINotifyConfigurationType_BlockEmail.h
 *
 * 
 */

#ifndef OAINotifyConfigurationType_BlockEmail_H
#define OAINotifyConfigurationType_BlockEmail_H
...
class OAINotifyConfigurationType_BlockEmail : public OAIObject {
public:
    OAINotifyConfigurationType_BlockEmail();
    OAINotifyConfigurationType_BlockEmail(QString json);
    ~OAINotifyConfigurationType_BlockEmail() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINotifyConfigurationType_BlockEmail)

#endif // OAINotifyConfigurationType_BlockEmail_H
