...
/*
 * OAIResourceServerScopeType.h
 *
 * A resource server scope.
 */

#ifndef OAIResourceServerScopeType_H
#define OAIResourceServerScopeType_H
...
class OAIResourceServerScopeType : public OAIObject {
public:
    OAIResourceServerScopeType();
    OAIResourceServerScopeType(QString json);
    ~OAIResourceServerScopeType() override;
    ...
    QString getScopeDescription() const;
    void setScopeDescription(const QString &scope_description);
    bool is_scope_description_Set() const;
    bool is_scope_description_Valid() const;
...
private:
    ...
    QString m_scope_description;
    bool m_scope_description_isSet;
    bool m_scope_description_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIResourceServerScopeType)

#endif // OAIResourceServerScopeType_H
