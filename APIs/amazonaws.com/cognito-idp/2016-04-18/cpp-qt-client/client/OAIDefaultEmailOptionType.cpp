...
OAIDefaultEmailOptionType::OAIDefaultEmailOptionType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDefaultEmailOptionType::OAIDefaultEmailOptionType() {
    this->initializeModel();
}

OAIDefaultEmailOptionType::~OAIDefaultEmailOptionType() {}

void OAIDefaultEmailOptionType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIDefaultEmailOptionType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIDefaultEmailOptionType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("CONFIRM_WITH_LINK", Qt::CaseInsensitive) == 0) {
        m_value = eOAIDefaultEmailOptionType::LINK;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("CONFIRM_WITH_CODE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIDefaultEmailOptionType::CODE;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIDefaultEmailOptionType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIDefaultEmailOptionType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIDefaultEmailOptionType::LINK:
            val = "CONFIRM_WITH_LINK";
            break;
        case eOAIDefaultEmailOptionType::CODE:
            val = "CONFIRM_WITH_CODE";
            break;
        default:
            break;
    }
...
QJsonValue OAIDefaultEmailOptionType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIDefaultEmailOptionType::eOAIDefaultEmailOptionType OAIDefaultEmailOptionType::getValue() const {
    return m_value;
}

void OAIDefaultEmailOptionType::setValue(const OAIDefaultEmailOptionType::eOAIDefaultEmailOptionType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIDefaultEmailOptionType::isSet() const {
    
    return m_value_isSet;
}

bool OAIDefaultEmailOptionType::isValid() const {
