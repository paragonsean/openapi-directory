...
OAISetUserPoolMfaConfigRequest::OAISetUserPoolMfaConfigRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISetUserPoolMfaConfigRequest::OAISetUserPoolMfaConfigRequest() {
    this->initializeModel();
}

OAISetUserPoolMfaConfigRequest::~OAISetUserPoolMfaConfigRequest() {}

void OAISetUserPoolMfaConfigRequest::initializeModel() {
...
void OAISetUserPoolMfaConfigRequest::fromJson(QString jsonString) {
...
void OAISetUserPoolMfaConfigRequest::fromJsonObject(QJsonObject json) {
...
QString OAISetUserPoolMfaConfigRequest::asJson() const {
...
QJsonObject OAISetUserPoolMfaConfigRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAISetUserPoolMfaConfigRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAISetUserPoolMfaConfigRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAISetUserPoolMfaConfigRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAISetUserPoolMfaConfigRequest::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

OAISetUserPoolMfaConfigResponse_SmsMfaConfiguration OAISetUserPoolMfaConfigRequest::getSmsMfaConfiguration() const {
    return m_sms_mfa_configuration;
}
void OAISetUserPoolMfaConfigRequest::setSmsMfaConfiguration(const OAISetUserPoolMfaConfigResponse_SmsMfaConfiguration &sms_mfa_configuration) {
    m_sms_mfa_configuration = sms_mfa_configuration;
    m_sms_mfa_configuration_isSet = true;
}

bool OAISetUserPoolMfaConfigRequest::is_sms_mfa_configuration_Set() const{
    return m_sms_mfa_configuration_isSet;
}

bool OAISetUserPoolMfaConfigRequest::is_sms_mfa_configuration_Valid() const{
    return m_sms_mfa_configuration_isValid;
}

OAISetUserPoolMfaConfigResponse_SoftwareTokenMfaConfiguration OAISetUserPoolMfaConfigRequest::getSoftwareTokenMfaConfiguration() const {
    return m_software_token_mfa_configuration;
}
void OAISetUserPoolMfaConfigRequest::setSoftwareTokenMfaConfiguration(const OAISetUserPoolMfaConfigResponse_SoftwareTokenMfaConfiguration &software_token_mfa_configuration) {
    m_software_token_mfa_configuration = software_token_mfa_configuration;
    m_software_token_mfa_configuration_isSet = true;
}

bool OAISetUserPoolMfaConfigRequest::is_software_token_mfa_configuration_Set() const{
    return m_software_token_mfa_configuration_isSet;
}

bool OAISetUserPoolMfaConfigRequest::is_software_token_mfa_configuration_Valid() const{
    return m_software_token_mfa_configuration_isValid;
}

OAIUserPoolMfaType OAISetUserPoolMfaConfigRequest::getMfaConfiguration() const {
    return m_mfa_configuration;
}
void OAISetUserPoolMfaConfigRequest::setMfaConfiguration(const OAIUserPoolMfaType &mfa_configuration) {
    m_mfa_configuration = mfa_configuration;
    m_mfa_configuration_isSet = true;
}

bool OAISetUserPoolMfaConfigRequest::is_mfa_configuration_Set() const{
    return m_mfa_configuration_isSet;
}

bool OAISetUserPoolMfaConfigRequest::is_mfa_configuration_Valid() const{
    return m_mfa_configuration_isValid;
}

bool OAISetUserPoolMfaConfigRequest::isSet() const {
...
bool OAISetUserPoolMfaConfigRequest::isValid() const {
