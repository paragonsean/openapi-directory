...
/*
 * OAIConfirmSignUpRequest.h
 *
 * Represents the request to confirm registration of a user.
 */

#ifndef OAIConfirmSignUpRequest_H
#define OAIConfirmSignUpRequest_H
...
namespace OpenAPI {
class OAIConfirmSignUpRequest_AnalyticsMetadata;
class OAIConfirmForgotPasswordRequest_UserContextData;

class OAIConfirmSignUpRequest : public OAIObject {
public:
    OAIConfirmSignUpRequest();
    OAIConfirmSignUpRequest(QString json);
    ~OAIConfirmSignUpRequest() override;
    ...
    OAIConfirmSignUpRequest_AnalyticsMetadata getAnalyticsMetadata() const;
    void setAnalyticsMetadata(const OAIConfirmSignUpRequest_AnalyticsMetadata &analytics_metadata);
...
private:
    ...
    OAIConfirmSignUpRequest_AnalyticsMetadata m_analytics_metadata;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConfirmSignUpRequest)

#endif // OAIConfirmSignUpRequest_H
