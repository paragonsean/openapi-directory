...
/*
 * OAIUserPoolType_UsernameConfiguration.h
 *
 * 
 */

#ifndef OAIUserPoolType_UsernameConfiguration_H
#define OAIUserPoolType_UsernameConfiguration_H
...
class OAIUserPoolType_UsernameConfiguration : public OAIObject {
public:
    OAIUserPoolType_UsernameConfiguration();
    OAIUserPoolType_UsernameConfiguration(QString json);
    ~OAIUserPoolType_UsernameConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserPoolType_UsernameConfiguration)

#endif // OAIUserPoolType_UsernameConfiguration_H
