...
OAIStopUserImportJobRequest::OAIStopUserImportJobRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStopUserImportJobRequest::OAIStopUserImportJobRequest() {
    this->initializeModel();
}

OAIStopUserImportJobRequest::~OAIStopUserImportJobRequest() {}

void OAIStopUserImportJobRequest::initializeModel() {
...
void OAIStopUserImportJobRequest::fromJson(QString jsonString) {
...
void OAIStopUserImportJobRequest::fromJsonObject(QJsonObject json) {
...
QString OAIStopUserImportJobRequest::asJson() const {
...
QJsonObject OAIStopUserImportJobRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIStopUserImportJobRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIStopUserImportJobRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIStopUserImportJobRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIStopUserImportJobRequest::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

QString OAIStopUserImportJobRequest::getJobId() const {
    return m_job_id;
}
void OAIStopUserImportJobRequest::setJobId(const QString &job_id) {
    m_job_id = job_id;
    m_job_id_isSet = true;
}

bool OAIStopUserImportJobRequest::is_job_id_Set() const{
    return m_job_id_isSet;
}

bool OAIStopUserImportJobRequest::is_job_id_Valid() const{
    return m_job_id_isValid;
}

bool OAIStopUserImportJobRequest::isSet() const {
...
bool OAIStopUserImportJobRequest::isValid() const {
