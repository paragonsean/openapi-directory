...
OAIGetSigningCertificateResponse::OAIGetSigningCertificateResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetSigningCertificateResponse::OAIGetSigningCertificateResponse() {
    this->initializeModel();
}

OAIGetSigningCertificateResponse::~OAIGetSigningCertificateResponse() {}

void OAIGetSigningCertificateResponse::initializeModel() {

    m_certificate_isSet = false;
    m_certificate_isValid = false;
}

void OAIGetSigningCertificateResponse::fromJson(QString jsonString) {
...
void OAIGetSigningCertificateResponse::fromJsonObject(QJsonObject json) {
...
QString OAIGetSigningCertificateResponse::asJson() const {
...
QJsonObject OAIGetSigningCertificateResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetSigningCertificateResponse::getCertificate() const {
    return m_certificate;
}
void OAIGetSigningCertificateResponse::setCertificate(const QString &certificate) {
    m_certificate = certificate;
    m_certificate_isSet = true;
}

bool OAIGetSigningCertificateResponse::is_certificate_Set() const{
    return m_certificate_isSet;
}

bool OAIGetSigningCertificateResponse::is_certificate_Valid() const{
    return m_certificate_isValid;
}

bool OAIGetSigningCertificateResponse::isSet() const {
...
bool OAIGetSigningCertificateResponse::isValid() const {
