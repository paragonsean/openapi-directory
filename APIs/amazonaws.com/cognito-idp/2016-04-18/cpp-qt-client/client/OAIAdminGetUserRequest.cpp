...
OAIAdminGetUserRequest::OAIAdminGetUserRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdminGetUserRequest::OAIAdminGetUserRequest() {
    this->initializeModel();
}

OAIAdminGetUserRequest::~OAIAdminGetUserRequest() {}

void OAIAdminGetUserRequest::initializeModel() {
...
void OAIAdminGetUserRequest::fromJson(QString jsonString) {
...
void OAIAdminGetUserRequest::fromJsonObject(QJsonObject json) {
...
QString OAIAdminGetUserRequest::asJson() const {
...
QJsonObject OAIAdminGetUserRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAdminGetUserRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIAdminGetUserRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIAdminGetUserRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIAdminGetUserRequest::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

QString OAIAdminGetUserRequest::getUsername() const {
    return m_username;
}
void OAIAdminGetUserRequest::setUsername(const QString &username) {
    m_username = username;
    m_username_isSet = true;
}

bool OAIAdminGetUserRequest::is_username_Set() const{
    return m_username_isSet;
}

bool OAIAdminGetUserRequest::is_username_Valid() const{
    return m_username_isValid;
}

bool OAIAdminGetUserRequest::isSet() const {
...
bool OAIAdminGetUserRequest::isValid() const {
