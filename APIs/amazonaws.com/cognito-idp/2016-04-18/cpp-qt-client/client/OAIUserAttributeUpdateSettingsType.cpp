...
#include "OAIUserAttributeUpdateSettingsType.h"
...
OAIUserAttributeUpdateSettingsType::OAIUserAttributeUpdateSettingsType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUserAttributeUpdateSettingsType::OAIUserAttributeUpdateSettingsType() {
    this->initializeModel();
}

OAIUserAttributeUpdateSettingsType::~OAIUserAttributeUpdateSettingsType() {}

void OAIUserAttributeUpdateSettingsType::initializeModel() {

    m_attributes_require_verification_before_update_isSet = false;
    m_attributes_require_verification_before_update_isValid = false;
}

void OAIUserAttributeUpdateSettingsType::fromJson(QString jsonString) {
...
void OAIUserAttributeUpdateSettingsType::fromJsonObject(QJsonObject json) {
...
QString OAIUserAttributeUpdateSettingsType::asJson() const {
...
QJsonObject OAIUserAttributeUpdateSettingsType::asJsonObject() const {
    QJsonObject obj;
...
QList OAIUserAttributeUpdateSettingsType::getAttributesRequireVerificationBeforeUpdate() const {
    return m_attributes_require_verification_before_update;
}
void OAIUserAttributeUpdateSettingsType::setAttributesRequireVerificationBeforeUpdate(const QList &attributes_require_verification_before_update) {
...
bool OAIUserAttributeUpdateSettingsType::is_attributes_require_verification_before_update_Set() const{
    return m_attributes_require_verification_before_update_isSet;
}

bool OAIUserAttributeUpdateSettingsType::is_attributes_require_verification_before_update_Valid() const{
    return m_attributes_require_verification_before_update_isValid;
}

bool OAIUserAttributeUpdateSettingsType::isSet() const {
...
bool OAIUserAttributeUpdateSettingsType::isValid() const {
