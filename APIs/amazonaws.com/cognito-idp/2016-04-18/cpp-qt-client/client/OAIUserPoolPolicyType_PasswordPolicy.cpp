...
#include "OAIUserPoolPolicyType_PasswordPolicy.h"
...
OAIUserPoolPolicyType_PasswordPolicy::OAIUserPoolPolicyType_PasswordPolicy(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUserPoolPolicyType_PasswordPolicy::OAIUserPoolPolicyType_PasswordPolicy() {
    this->initializeModel();
}

OAIUserPoolPolicyType_PasswordPolicy::~OAIUserPoolPolicyType_PasswordPolicy() {}

void OAIUserPoolPolicyType_PasswordPolicy::initializeModel() {
...
void OAIUserPoolPolicyType_PasswordPolicy::fromJson(QString jsonString) {
...
void OAIUserPoolPolicyType_PasswordPolicy::fromJsonObject(QJsonObject json) {
...
QString OAIUserPoolPolicyType_PasswordPolicy::asJson() const {
...
QJsonObject OAIUserPoolPolicyType_PasswordPolicy::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIUserPoolPolicyType_PasswordPolicy::getMinimumLength() const {
    return m_minimum_length;
}
void OAIUserPoolPolicyType_PasswordPolicy::setMinimumLength(const qint32 &minimum_length) {
    m_minimum_length = minimum_length;
    m_minimum_length_isSet = true;
}

bool OAIUserPoolPolicyType_PasswordPolicy::is_minimum_length_Set() const{
    return m_minimum_length_isSet;
}

bool OAIUserPoolPolicyType_PasswordPolicy::is_minimum_length_Valid() const{
    return m_minimum_length_isValid;
}

bool OAIUserPoolPolicyType_PasswordPolicy::getRequireUppercase() const {
    return m_require_uppercase;
}
void OAIUserPoolPolicyType_PasswordPolicy::setRequireUppercase(const bool &require_uppercase) {
    m_require_uppercase = require_uppercase;
    m_require_uppercase_isSet = true;
}

bool OAIUserPoolPolicyType_PasswordPolicy::is_require_uppercase_Set() const{
    return m_require_uppercase_isSet;
}

bool OAIUserPoolPolicyType_PasswordPolicy::is_require_uppercase_Valid() const{
    return m_require_uppercase_isValid;
}

bool OAIUserPoolPolicyType_PasswordPolicy::getRequireLowercase() const {
    return m_require_lowercase;
}
void OAIUserPoolPolicyType_PasswordPolicy::setRequireLowercase(const bool &require_lowercase) {
    m_require_lowercase = require_lowercase;
    m_require_lowercase_isSet = true;
}

bool OAIUserPoolPolicyType_PasswordPolicy::is_require_lowercase_Set() const{
    return m_require_lowercase_isSet;
}

bool OAIUserPoolPolicyType_PasswordPolicy::is_require_lowercase_Valid() const{
    return m_require_lowercase_isValid;
}

bool OAIUserPoolPolicyType_PasswordPolicy::getRequireNumbers() const {
    return m_require_numbers;
}
void OAIUserPoolPolicyType_PasswordPolicy::setRequireNumbers(const bool &require_numbers) {
    m_require_numbers = require_numbers;
    m_require_numbers_isSet = true;
}

bool OAIUserPoolPolicyType_PasswordPolicy::is_require_numbers_Set() const{
    return m_require_numbers_isSet;
}

bool OAIUserPoolPolicyType_PasswordPolicy::is_require_numbers_Valid() const{
    return m_require_numbers_isValid;
}

bool OAIUserPoolPolicyType_PasswordPolicy::getRequireSymbols() const {
    return m_require_symbols;
}
void OAIUserPoolPolicyType_PasswordPolicy::setRequireSymbols(const bool &require_symbols) {
    m_require_symbols = require_symbols;
    m_require_symbols_isSet = true;
}

bool OAIUserPoolPolicyType_PasswordPolicy::is_require_symbols_Set() const{
    return m_require_symbols_isSet;
}

bool OAIUserPoolPolicyType_PasswordPolicy::is_require_symbols_Valid() const{
    return m_require_symbols_isValid;
}

qint32 OAIUserPoolPolicyType_PasswordPolicy::getTemporaryPasswordValidityDays() const {
    return m_temporary_password_validity_days;
}
void OAIUserPoolPolicyType_PasswordPolicy::setTemporaryPasswordValidityDays(const qint32 &temporary_password_validity_days) {
    m_temporary_password_validity_days = temporary_password_validity_days;
    m_temporary_password_validity_days_isSet = true;
}

bool OAIUserPoolPolicyType_PasswordPolicy::is_temporary_password_validity_days_Set() const{
    return m_temporary_password_validity_days_isSet;
}

bool OAIUserPoolPolicyType_PasswordPolicy::is_temporary_password_validity_days_Valid() const{
    return m_temporary_password_validity_days_isValid;
}

bool OAIUserPoolPolicyType_PasswordPolicy::isSet() const {
...
bool OAIUserPoolPolicyType_PasswordPolicy::isValid() const {
