...
/*
 * OAIDescribeUserImportJobResponse.h
 *
 * Represents the response from the server to the request to describe the user import job.
 */

#ifndef OAIDescribeUserImportJobResponse_H
#define OAIDescribeUserImportJobResponse_H
...
namespace OpenAPI {
class OAICreateUserImportJobResponse_UserImportJob;

class OAIDescribeUserImportJobResponse : public OAIObject {
public:
    OAIDescribeUserImportJobResponse();
    OAIDescribeUserImportJobResponse(QString json);
    ~OAIDescribeUserImportJobResponse() override;
    ...
    OAICreateUserImportJobResponse_UserImportJob getUserImportJob() const;
    void setUserImportJob(const OAICreateUserImportJobResponse_UserImportJob &user_import_job);
    bool is_user_import_job_Set() const;
    bool is_user_import_job_Valid() const;
...
private:
    ...
    OAICreateUserImportJobResponse_UserImportJob m_user_import_job;
    bool m_user_import_job_isSet;
    bool m_user_import_job_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDescribeUserImportJobResponse)

#endif // OAIDescribeUserImportJobResponse_H
