...
/*
 * OAIListDevicesRequest.h
 *
 * Represents the request to list the devices.
 */

#ifndef OAIListDevicesRequest_H
#define OAIListDevicesRequest_H
...
class OAIListDevicesRequest : public OAIObject {
public:
    OAIListDevicesRequest();
    OAIListDevicesRequest(QString json);
    ~OAIListDevicesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListDevicesRequest)

#endif // OAIListDevicesRequest_H
