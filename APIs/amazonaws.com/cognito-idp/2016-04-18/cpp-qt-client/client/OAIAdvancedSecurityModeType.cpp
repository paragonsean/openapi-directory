...
#include "OAIAdvancedSecurityModeType.h"
...
OAIAdvancedSecurityModeType::OAIAdvancedSecurityModeType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdvancedSecurityModeType::OAIAdvancedSecurityModeType() {
    this->initializeModel();
}

OAIAdvancedSecurityModeType::~OAIAdvancedSecurityModeType() {}

void OAIAdvancedSecurityModeType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIAdvancedSecurityModeType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIAdvancedSecurityModeType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("OFF", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAdvancedSecurityModeType::OFF;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("AUDIT", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAdvancedSecurityModeType::AUDIT;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ENFORCED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAdvancedSecurityModeType::ENFORCED;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIAdvancedSecurityModeType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIAdvancedSecurityModeType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIAdvancedSecurityModeType::OFF:
            val = "OFF";
            break;
        case eOAIAdvancedSecurityModeType::AUDIT:
            val = "AUDIT";
            break;
        case eOAIAdvancedSecurityModeType::ENFORCED:
            val = "ENFORCED";
            break;
        default:
            break;
...
QJsonValue OAIAdvancedSecurityModeType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIAdvancedSecurityModeType::eOAIAdvancedSecurityModeType OAIAdvancedSecurityModeType::getValue() const {
    return m_value;
}

void OAIAdvancedSecurityModeType::setValue(const OAIAdvancedSecurityModeType::eOAIAdvancedSecurityModeType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIAdvancedSecurityModeType::isSet() const {
    
    return m_value_isSet;
}

bool OAIAdvancedSecurityModeType::isValid() const {
