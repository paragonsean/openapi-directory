...
#include "OAICreateUserPoolRequest_UsernameConfiguration.h"
...
OAICreateUserPoolRequest_UsernameConfiguration::OAICreateUserPoolRequest_UsernameConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateUserPoolRequest_UsernameConfiguration::OAICreateUserPoolRequest_UsernameConfiguration() {
    this->initializeModel();
}

OAICreateUserPoolRequest_UsernameConfiguration::~OAICreateUserPoolRequest_UsernameConfiguration() {}

void OAICreateUserPoolRequest_UsernameConfiguration::initializeModel() {

    m_case_sensitive_isSet = false;
    m_case_sensitive_isValid = false;
}

void OAICreateUserPoolRequest_UsernameConfiguration::fromJson(QString jsonString) {
...
void OAICreateUserPoolRequest_UsernameConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAICreateUserPoolRequest_UsernameConfiguration::asJson() const {
...
QJsonObject OAICreateUserPoolRequest_UsernameConfiguration::asJsonObject() const {
    QJsonObject obj;
...
bool OAICreateUserPoolRequest_UsernameConfiguration::getCaseSensitive() const {
    return m_case_sensitive;
}
void OAICreateUserPoolRequest_UsernameConfiguration::setCaseSensitive(const bool &case_sensitive) {
    m_case_sensitive = case_sensitive;
    m_case_sensitive_isSet = true;
}

bool OAICreateUserPoolRequest_UsernameConfiguration::is_case_sensitive_Set() const{
    return m_case_sensitive_isSet;
}

bool OAICreateUserPoolRequest_UsernameConfiguration::is_case_sensitive_Valid() const{
    return m_case_sensitive_isValid;
}

bool OAICreateUserPoolRequest_UsernameConfiguration::isSet() const {
...
bool OAICreateUserPoolRequest_UsernameConfiguration::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_case_sensitive_isValid && true;
}
