...
OAIVerifySoftwareTokenResponseType::OAIVerifySoftwareTokenResponseType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIVerifySoftwareTokenResponseType::OAIVerifySoftwareTokenResponseType() {
    this->initializeModel();
}

OAIVerifySoftwareTokenResponseType::~OAIVerifySoftwareTokenResponseType() {}

void OAIVerifySoftwareTokenResponseType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIVerifySoftwareTokenResponseType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIVerifySoftwareTokenResponseType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("SUCCESS", Qt::CaseInsensitive) == 0) {
        m_value = eOAIVerifySoftwareTokenResponseType::SUCCESS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ERROR", Qt::CaseInsensitive) == 0) {
        m_value = eOAIVerifySoftwareTokenResponseType::ERROR;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIVerifySoftwareTokenResponseType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIVerifySoftwareTokenResponseType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIVerifySoftwareTokenResponseType::SUCCESS:
            val = "SUCCESS";
            break;
        case eOAIVerifySoftwareTokenResponseType::ERROR:
            val = "ERROR";
            break;
        default:
            break;
...
QJsonValue OAIVerifySoftwareTokenResponseType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIVerifySoftwareTokenResponseType::eOAIVerifySoftwareTokenResponseType OAIVerifySoftwareTokenResponseType::getValue() const {
    return m_value;
}

void OAIVerifySoftwareTokenResponseType::setValue(const OAIVerifySoftwareTokenResponseType::eOAIVerifySoftwareTokenResponseType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIVerifySoftwareTokenResponseType::isSet() const {
    
    return m_value_isSet;
}

bool OAIVerifySoftwareTokenResponseType::isValid() const {
