...
/*
 * OAIConfirmDeviceRequest.h
 *
 * Confirms the device request.
 */

#ifndef OAIConfirmDeviceRequest_H
#define OAIConfirmDeviceRequest_H

#include <QJsonObject>

#include "OAIConfirmDeviceRequest_DeviceSecretVerifierConfig.h"
#include <QString>
...
namespace OpenAPI {
class OAIConfirmDeviceRequest_DeviceSecretVerifierConfig;

class OAIConfirmDeviceRequest : public OAIObject {
public:
    OAIConfirmDeviceRequest();
    OAIConfirmDeviceRequest(QString json);
    ~OAIConfirmDeviceRequest() override;
    ...
    OAIConfirmDeviceRequest_DeviceSecretVerifierConfig getDeviceSecretVerifierConfig() const;
    void setDeviceSecretVerifierConfig(const OAIConfirmDeviceRequest_DeviceSecretVerifierConfig &device_secret_verifier_config);
    bool is_device_secret_verifier_config_Set() const;
    bool is_device_secret_verifier_config_Valid() const;
...
private:
    ...
    OAIConfirmDeviceRequest_DeviceSecretVerifierConfig m_device_secret_verifier_config;
    bool m_device_secret_verifier_config_isSet;
    bool m_device_secret_verifier_config_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConfirmDeviceRequest)

#endif // OAIConfirmDeviceRequest_H
