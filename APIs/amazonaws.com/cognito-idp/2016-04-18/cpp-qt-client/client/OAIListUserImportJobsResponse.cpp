...
OAIListUserImportJobsResponse::OAIListUserImportJobsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListUserImportJobsResponse::OAIListUserImportJobsResponse() {
    this->initializeModel();
}

OAIListUserImportJobsResponse::~OAIListUserImportJobsResponse() {}

void OAIListUserImportJobsResponse::initializeModel() {

    m_user_import_jobs_isSet = false;
    m_user_import_jobs_isValid = false;

    m_pagination_token_isSet = false;
    m_pagination_token_isValid = false;
}

void OAIListUserImportJobsResponse::fromJson(QString jsonString) {
...
void OAIListUserImportJobsResponse::fromJsonObject(QJsonObject json) {

    m_user_import_jobs_isValid = ::OpenAPI::fromJsonValue(m_user_import_jobs, json[QString("UserImportJobs")]);
    m_user_import_jobs_isSet = !json[QString("UserImportJobs")].isNull() && m_user_import_jobs_isValid;
...
QString OAIListUserImportJobsResponse::asJson() const {
...
QJsonObject OAIListUserImportJobsResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_user_import_jobs.isSet()) {
        obj.insert(QString("UserImportJobs"), ::OpenAPI::toJsonValue(m_user_import_jobs));
    }
...
QList OAIListUserImportJobsResponse::getUserImportJobs() const {
    return m_user_import_jobs;
}
void OAIListUserImportJobsResponse::setUserImportJobs(const QList &user_import_jobs) {
    m_user_import_jobs = user_import_jobs;
    m_user_import_jobs_isSet = true;
}

bool OAIListUserImportJobsResponse::is_user_import_jobs_Set() const{
    return m_user_import_jobs_isSet;
}

bool OAIListUserImportJobsResponse::is_user_import_jobs_Valid() const{
    return m_user_import_jobs_isValid;
}

QString OAIListUserImportJobsResponse::getPaginationToken() const {
    return m_pagination_token;
}
void OAIListUserImportJobsResponse::setPaginationToken(const QString &pagination_token) {
    m_pagination_token = pagination_token;
    m_pagination_token_isSet = true;
}

bool OAIListUserImportJobsResponse::is_pagination_token_Set() const{
    return m_pagination_token_isSet;
}

bool OAIListUserImportJobsResponse::is_pagination_token_Valid() const{
    return m_pagination_token_isValid;
}

bool OAIListUserImportJobsResponse::isSet() const {
...
bool OAIListUserImportJobsResponse::isValid() const {
