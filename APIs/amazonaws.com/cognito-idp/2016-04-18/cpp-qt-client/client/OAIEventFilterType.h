...
/*
 * OAIEventFilterType.h
 *
 * 
 */

#ifndef OAIEventFilterType_H
#define OAIEventFilterType_H
...
class OAIEventFilterType : public OAIEnum {
public:
    OAIEventFilterType();
    OAIEventFilterType(QString json);
    ~OAIEventFilterType() override;
    ...
    enum class eOAIEventFilterType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        SIGN_IN, 
        PASSWORD_CHANGE, 
        SIGN_UP
    };
    OAIEventFilterType::eOAIEventFilterType getValue() const;
    void setValue(const OAIEventFilterType::eOAIEventFilterType& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIEventFilterType)

#endif // OAIEventFilterType_H
