...
/*
 * OAIUserImportJobType.h
 *
 * The user import job type.
 */

#ifndef OAIUserImportJobType_H
#define OAIUserImportJobType_H
...
class OAIUserImportJobType : public OAIObject {
public:
    OAIUserImportJobType();
    OAIUserImportJobType(QString json);
    ~OAIUserImportJobType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserImportJobType)

#endif // OAIUserImportJobType_H
