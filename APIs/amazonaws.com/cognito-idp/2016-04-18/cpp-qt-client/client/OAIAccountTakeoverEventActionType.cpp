...
#include "OAIAccountTakeoverEventActionType.h"
...
OAIAccountTakeoverEventActionType::OAIAccountTakeoverEventActionType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAccountTakeoverEventActionType::OAIAccountTakeoverEventActionType() {
    this->initializeModel();
}

OAIAccountTakeoverEventActionType::~OAIAccountTakeoverEventActionType() {}

void OAIAccountTakeoverEventActionType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIAccountTakeoverEventActionType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIAccountTakeoverEventActionType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("BLOCK", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAccountTakeoverEventActionType::BLOCK;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("MFA_IF_CONFIGURED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAccountTakeoverEventActionType::MFA_IF_CONFIGURED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("MFA_REQUIRED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAccountTakeoverEventActionType::MFA_REQUIRED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("NO_ACTION", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAccountTakeoverEventActionType::NO_ACTION;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIAccountTakeoverEventActionType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIAccountTakeoverEventActionType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIAccountTakeoverEventActionType::BLOCK:
            val = "BLOCK";
            break;
        case eOAIAccountTakeoverEventActionType::MFA_IF_CONFIGURED:
            val = "MFA_IF_CONFIGURED";
            break;
        case eOAIAccountTakeoverEventActionType::MFA_REQUIRED:
            val = "MFA_REQUIRED";
            break;
        case eOAIAccountTakeoverEventActionType::NO_ACTION:
            val = "NO_ACTION";
            break;
        default:
            break;
...
QJsonValue OAIAccountTakeoverEventActionType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIAccountTakeoverEventActionType::eOAIAccountTakeoverEventActionType OAIAccountTakeoverEventActionType::getValue() const {
    return m_value;
}

void OAIAccountTakeoverEventActionType::setValue(const OAIAccountTakeoverEventActionType::eOAIAccountTakeoverEventActionType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIAccountTakeoverEventActionType::isSet() const {
    
    return m_value_isSet;
}

bool OAIAccountTakeoverEventActionType::isValid() const {
