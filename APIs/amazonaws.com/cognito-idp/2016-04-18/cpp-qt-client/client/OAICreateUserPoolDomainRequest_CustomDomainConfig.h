...
/*
 * OAICreateUserPoolDomainRequest_CustomDomainConfig.h
 *
 * 
 */

#ifndef OAICreateUserPoolDomainRequest_CustomDomainConfig_H
#define OAICreateUserPoolDomainRequest_CustomDomainConfig_H
...
class OAICreateUserPoolDomainRequest_CustomDomainConfig : public OAIObject {
public:
    OAICreateUserPoolDomainRequest_CustomDomainConfig();
    OAICreateUserPoolDomainRequest_CustomDomainConfig(QString json);
    ~OAICreateUserPoolDomainRequest_CustomDomainConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateUserPoolDomainRequest_CustomDomainConfig)

#endif // OAICreateUserPoolDomainRequest_CustomDomainConfig_H
