...
/*
 * OAIGetSigningCertificateResponse.h
 *
 * Response from Amazon Cognito for a signing certificate request.
 */

#ifndef OAIGetSigningCertificateResponse_H
#define OAIGetSigningCertificateResponse_H
...
class OAIGetSigningCertificateResponse : public OAIObject {
public:
    OAIGetSigningCertificateResponse();
    OAIGetSigningCertificateResponse(QString json);
    ~OAIGetSigningCertificateResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetSigningCertificateResponse)

#endif // OAIGetSigningCertificateResponse_H
