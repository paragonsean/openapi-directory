...
/*
 * OAIAdminRemoveUserFromGroupRequest.h
 *
 * 
 */

#ifndef OAIAdminRemoveUserFromGroupRequest_H
#define OAIAdminRemoveUserFromGroupRequest_H
...
class OAIAdminRemoveUserFromGroupRequest : public OAIObject {
public:
    OAIAdminRemoveUserFromGroupRequest();
    OAIAdminRemoveUserFromGroupRequest(QString json);
    ~OAIAdminRemoveUserFromGroupRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdminRemoveUserFromGroupRequest)

#endif // OAIAdminRemoveUserFromGroupRequest_H
