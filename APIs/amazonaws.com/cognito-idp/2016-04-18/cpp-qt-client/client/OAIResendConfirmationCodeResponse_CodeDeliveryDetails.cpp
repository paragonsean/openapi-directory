...
#include "OAIResendConfirmationCodeResponse_CodeDeliveryDetails.h"
...
OAIResendConfirmationCodeResponse_CodeDeliveryDetails::OAIResendConfirmationCodeResponse_CodeDeliveryDetails(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIResendConfirmationCodeResponse_CodeDeliveryDetails::OAIResendConfirmationCodeResponse_CodeDeliveryDetails() {
    this->initializeModel();
}

OAIResendConfirmationCodeResponse_CodeDeliveryDetails::~OAIResendConfirmationCodeResponse_CodeDeliveryDetails() {}

void OAIResendConfirmationCodeResponse_CodeDeliveryDetails::initializeModel() {
...
void OAIResendConfirmationCodeResponse_CodeDeliveryDetails::fromJson(QString jsonString) {
...
void OAIResendConfirmationCodeResponse_CodeDeliveryDetails::fromJsonObject(QJsonObject json) {
...
QString OAIResendConfirmationCodeResponse_CodeDeliveryDetails::asJson() const {
...
QJsonObject OAIResendConfirmationCodeResponse_CodeDeliveryDetails::asJsonObject() const {
    QJsonObject obj;
...
QString OAIResendConfirmationCodeResponse_CodeDeliveryDetails::getDestination() const {
    return m_destination;
}
void OAIResendConfirmationCodeResponse_CodeDeliveryDetails::setDestination(const QString &destination) {
    m_destination = destination;
    m_destination_isSet = true;
}

bool OAIResendConfirmationCodeResponse_CodeDeliveryDetails::is_destination_Set() const{
    return m_destination_isSet;
}

bool OAIResendConfirmationCodeResponse_CodeDeliveryDetails::is_destination_Valid() const{
    return m_destination_isValid;
}

OAIDeliveryMediumType OAIResendConfirmationCodeResponse_CodeDeliveryDetails::getDeliveryMedium() const {
    return m_delivery_medium;
}
void OAIResendConfirmationCodeResponse_CodeDeliveryDetails::setDeliveryMedium(const OAIDeliveryMediumType &delivery_medium) {
    m_delivery_medium = delivery_medium;
    m_delivery_medium_isSet = true;
}

bool OAIResendConfirmationCodeResponse_CodeDeliveryDetails::is_delivery_medium_Set() const{
    return m_delivery_medium_isSet;
}

bool OAIResendConfirmationCodeResponse_CodeDeliveryDetails::is_delivery_medium_Valid() const{
    return m_delivery_medium_isValid;
}

QString OAIResendConfirmationCodeResponse_CodeDeliveryDetails::getAttributeName() const {
    return m_attribute_name;
}
void OAIResendConfirmationCodeResponse_CodeDeliveryDetails::setAttributeName(const QString &attribute_name) {
    m_attribute_name = attribute_name;
    m_attribute_name_isSet = true;
}

bool OAIResendConfirmationCodeResponse_CodeDeliveryDetails::is_attribute_name_Set() const{
    return m_attribute_name_isSet;
}

bool OAIResendConfirmationCodeResponse_CodeDeliveryDetails::is_attribute_name_Valid() const{
    return m_attribute_name_isValid;
}

bool OAIResendConfirmationCodeResponse_CodeDeliveryDetails::isSet() const {
...
bool OAIResendConfirmationCodeResponse_CodeDeliveryDetails::isValid() const {
