...
/*
 * OAIRecoveryOptionNameType.h
 *
 * 
 */

#ifndef OAIRecoveryOptionNameType_H
#define OAIRecoveryOptionNameType_H
...
class OAIRecoveryOptionNameType : public OAIEnum {
public:
    OAIRecoveryOptionNameType();
    OAIRecoveryOptionNameType(QString json);
    ~OAIRecoveryOptionNameType() override;
    ...
    enum class eOAIRecoveryOptionNameType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        VERIFIED_EMAIL, 
        VERIFIED_PHONE_NUMBER, 
        ADMIN_ONLY
    };
    OAIRecoveryOptionNameType::eOAIRecoveryOptionNameType getValue() const;
    void setValue(const OAIRecoveryOptionNameType::eOAIRecoveryOptionNameType& value);
...
private:
    ...
    eOAIRecoveryOptionNameType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRecoveryOptionNameType)

#endif // OAIRecoveryOptionNameType_H
