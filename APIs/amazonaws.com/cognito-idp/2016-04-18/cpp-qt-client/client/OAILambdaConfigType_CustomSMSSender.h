...
/*
 * OAILambdaConfigType_CustomSMSSender.h
 *
 * 
 */

#ifndef OAILambdaConfigType_CustomSMSSender_H
#define OAILambdaConfigType_CustomSMSSender_H
...
class OAILambdaConfigType_CustomSMSSender : public OAIObject {
public:
    OAILambdaConfigType_CustomSMSSender();
    OAILambdaConfigType_CustomSMSSender(QString json);
    ~OAILambdaConfigType_CustomSMSSender() override;
    ...
    OAICustomSMSSenderLambdaVersionType getLambdaVersion() const;
    void setLambdaVersion(const OAICustomSMSSenderLambdaVersionType &lambda_version);
...
private:
    ...
    OAICustomSMSSenderLambdaVersionType m_lambda_version;
...
Q_DECLARE_METATYPE(OpenAPI::OAILambdaConfigType_CustomSMSSender)

#endif // OAILambdaConfigType_CustomSMSSender_H
