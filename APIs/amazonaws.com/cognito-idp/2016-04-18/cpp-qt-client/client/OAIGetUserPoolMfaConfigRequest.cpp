...
OAIGetUserPoolMfaConfigRequest::OAIGetUserPoolMfaConfigRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetUserPoolMfaConfigRequest::OAIGetUserPoolMfaConfigRequest() {
    this->initializeModel();
}

OAIGetUserPoolMfaConfigRequest::~OAIGetUserPoolMfaConfigRequest() {}

void OAIGetUserPoolMfaConfigRequest::initializeModel() {

    m_user_pool_id_isSet = false;
    m_user_pool_id_isValid = false;
}

void OAIGetUserPoolMfaConfigRequest::fromJson(QString jsonString) {
...
void OAIGetUserPoolMfaConfigRequest::fromJsonObject(QJsonObject json) {
...
QString OAIGetUserPoolMfaConfigRequest::asJson() const {
...
QJsonObject OAIGetUserPoolMfaConfigRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetUserPoolMfaConfigRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIGetUserPoolMfaConfigRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIGetUserPoolMfaConfigRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIGetUserPoolMfaConfigRequest::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

bool OAIGetUserPoolMfaConfigRequest::isSet() const {
...
bool OAIGetUserPoolMfaConfigRequest::isValid() const {
