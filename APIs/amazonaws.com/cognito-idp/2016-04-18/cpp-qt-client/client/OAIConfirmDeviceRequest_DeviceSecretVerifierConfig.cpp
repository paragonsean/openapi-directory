...
OAIConfirmDeviceRequest_DeviceSecretVerifierConfig::OAIConfirmDeviceRequest_DeviceSecretVerifierConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIConfirmDeviceRequest_DeviceSecretVerifierConfig::OAIConfirmDeviceRequest_DeviceSecretVerifierConfig() {
    this->initializeModel();
}

OAIConfirmDeviceRequest_DeviceSecretVerifierConfig::~OAIConfirmDeviceRequest_DeviceSecretVerifierConfig() {}

void OAIConfirmDeviceRequest_DeviceSecretVerifierConfig::initializeModel() {
...
void OAIConfirmDeviceRequest_DeviceSecretVerifierConfig::fromJson(QString jsonString) {
...
void OAIConfirmDeviceRequest_DeviceSecretVerifierConfig::fromJsonObject(QJsonObject json) {
...
QString OAIConfirmDeviceRequest_DeviceSecretVerifierConfig::asJson() const {
...
QJsonObject OAIConfirmDeviceRequest_DeviceSecretVerifierConfig::asJsonObject() const {
    QJsonObject obj;
...
QString OAIConfirmDeviceRequest_DeviceSecretVerifierConfig::getPasswordVerifier() const {
    return m_password_verifier;
}
void OAIConfirmDeviceRequest_DeviceSecretVerifierConfig::setPasswordVerifier(const QString &password_verifier) {
    m_password_verifier = password_verifier;
    m_password_verifier_isSet = true;
}

bool OAIConfirmDeviceRequest_DeviceSecretVerifierConfig::is_password_verifier_Set() const{
    return m_password_verifier_isSet;
}

bool OAIConfirmDeviceRequest_DeviceSecretVerifierConfig::is_password_verifier_Valid() const{
    return m_password_verifier_isValid;
}

QString OAIConfirmDeviceRequest_DeviceSecretVerifierConfig::getSalt() const {
    return m_salt;
}
void OAIConfirmDeviceRequest_DeviceSecretVerifierConfig::setSalt(const QString &salt) {
    m_salt = salt;
    m_salt_isSet = true;
}

bool OAIConfirmDeviceRequest_DeviceSecretVerifierConfig::is_salt_Set() const{
    return m_salt_isSet;
}

bool OAIConfirmDeviceRequest_DeviceSecretVerifierConfig::is_salt_Valid() const{
    return m_salt_isValid;
}

bool OAIConfirmDeviceRequest_DeviceSecretVerifierConfig::isSet() const {
...
bool OAIConfirmDeviceRequest_DeviceSecretVerifierConfig::isValid() const {
