...
OAIAdminListGroupsForUserRequest::OAIAdminListGroupsForUserRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdminListGroupsForUserRequest::OAIAdminListGroupsForUserRequest() {
    this->initializeModel();
}

OAIAdminListGroupsForUserRequest::~OAIAdminListGroupsForUserRequest() {}

void OAIAdminListGroupsForUserRequest::initializeModel() {
...
void OAIAdminListGroupsForUserRequest::fromJson(QString jsonString) {
...
void OAIAdminListGroupsForUserRequest::fromJsonObject(QJsonObject json) {
...
QString OAIAdminListGroupsForUserRequest::asJson() const {
...
QJsonObject OAIAdminListGroupsForUserRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_username_isSet) {
...
QString OAIAdminListGroupsForUserRequest::getUsername() const {
    return m_username;
}
void OAIAdminListGroupsForUserRequest::setUsername(const QString &username) {
    m_username = username;
    m_username_isSet = true;
}

bool OAIAdminListGroupsForUserRequest::is_username_Set() const{
    return m_username_isSet;
}

bool OAIAdminListGroupsForUserRequest::is_username_Valid() const{
    return m_username_isValid;
}

QString OAIAdminListGroupsForUserRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIAdminListGroupsForUserRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIAdminListGroupsForUserRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIAdminListGroupsForUserRequest::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

qint32 OAIAdminListGroupsForUserRequest::getLimit() const {
    return m_limit;
}
void OAIAdminListGroupsForUserRequest::setLimit(const qint32 &limit) {
    m_limit = limit;
    m_limit_isSet = true;
}

bool OAIAdminListGroupsForUserRequest::is_limit_Set() const{
    return m_limit_isSet;
}

bool OAIAdminListGroupsForUserRequest::is_limit_Valid() const{
    return m_limit_isValid;
}

QString OAIAdminListGroupsForUserRequest::getNextToken() const {
    return m_next_token;
}
void OAIAdminListGroupsForUserRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIAdminListGroupsForUserRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIAdminListGroupsForUserRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIAdminListGroupsForUserRequest::isSet() const {
...
bool OAIAdminListGroupsForUserRequest::isValid() const {
