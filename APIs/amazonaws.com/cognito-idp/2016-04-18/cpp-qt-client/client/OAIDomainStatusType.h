...
/*
 * OAIDomainStatusType.h
 *
 * 
 */

#ifndef OAIDomainStatusType_H
#define OAIDomainStatusType_H
...
class OAIDomainStatusType : public OAIEnum {
public:
    OAIDomainStatusType();
    OAIDomainStatusType(QString json);
    ~OAIDomainStatusType() override;
    ...
    enum class eOAIDomainStatusType {
    ...
    OAIDomainStatusType::eOAIDomainStatusType getValue() const;
    void setValue(const OAIDomainStatusType::eOAIDomainStatusType& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIDomainStatusType)

#endif // OAIDomainStatusType_H
