...
OAIStopUserImportJobResponse::OAIStopUserImportJobResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStopUserImportJobResponse::OAIStopUserImportJobResponse() {
    this->initializeModel();
}

OAIStopUserImportJobResponse::~OAIStopUserImportJobResponse() {}

void OAIStopUserImportJobResponse::initializeModel() {

    m_user_import_job_isSet = false;
    m_user_import_job_isValid = false;
}

void OAIStopUserImportJobResponse::fromJson(QString jsonString) {
...
void OAIStopUserImportJobResponse::fromJsonObject(QJsonObject json) {
...
QString OAIStopUserImportJobResponse::asJson() const {
...
QJsonObject OAIStopUserImportJobResponse::asJsonObject() const {
    QJsonObject obj;
...
OAICreateUserImportJobResponse_UserImportJob OAIStopUserImportJobResponse::getUserImportJob() const {
    return m_user_import_job;
}
void OAIStopUserImportJobResponse::setUserImportJob(const OAICreateUserImportJobResponse_UserImportJob &user_import_job) {
    m_user_import_job = user_import_job;
    m_user_import_job_isSet = true;
}

bool OAIStopUserImportJobResponse::is_user_import_job_Set() const{
    return m_user_import_job_isSet;
}

bool OAIStopUserImportJobResponse::is_user_import_job_Valid() const{
    return m_user_import_job_isValid;
}

bool OAIStopUserImportJobResponse::isSet() const {
...
bool OAIStopUserImportJobResponse::isValid() const {
