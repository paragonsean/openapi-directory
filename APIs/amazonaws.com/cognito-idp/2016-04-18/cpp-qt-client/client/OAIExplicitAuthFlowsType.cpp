...
#include "OAIExplicitAuthFlowsType.h"
...
OAIExplicitAuthFlowsType::OAIExplicitAuthFlowsType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIExplicitAuthFlowsType::OAIExplicitAuthFlowsType() {
    this->initializeModel();
}

OAIExplicitAuthFlowsType::~OAIExplicitAuthFlowsType() {}

void OAIExplicitAuthFlowsType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIExplicitAuthFlowsType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIExplicitAuthFlowsType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("ADMIN_NO_SRP_AUTH", Qt::CaseInsensitive) == 0) {
        m_value = eOAIExplicitAuthFlowsType::ADMIN_NO_SRP_AUTH;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("CUSTOM_AUTH_FLOW_ONLY", Qt::CaseInsensitive) == 0) {
        m_value = eOAIExplicitAuthFlowsType::CUSTOM_AUTH_FLOW_ONLY;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("USER_PASSWORD_AUTH", Qt::CaseInsensitive) == 0) {
        m_value = eOAIExplicitAuthFlowsType::USER_PASSWORD_AUTH;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ALLOW_ADMIN_USER_PASSWORD_AUTH", Qt::CaseInsensitive) == 0) {
        m_value = eOAIExplicitAuthFlowsType::ALLOW_ADMIN_USER_PASSWORD_AUTH;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ALLOW_CUSTOM_AUTH", Qt::CaseInsensitive) == 0) {
        m_value = eOAIExplicitAuthFlowsType::ALLOW_CUSTOM_AUTH;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ALLOW_USER_PASSWORD_AUTH", Qt::CaseInsensitive) == 0) {
        m_value = eOAIExplicitAuthFlowsType::ALLOW_USER_PASSWORD_AUTH;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ALLOW_USER_SRP_AUTH", Qt::CaseInsensitive) == 0) {
        m_value = eOAIExplicitAuthFlowsType::ALLOW_USER_SRP_AUTH;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ALLOW_REFRESH_TOKEN_AUTH", Qt::CaseInsensitive) == 0) {
        m_value = eOAIExplicitAuthFlowsType::ALLOW_REFRESH_TOKEN_AUTH;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIExplicitAuthFlowsType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIExplicitAuthFlowsType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIExplicitAuthFlowsType::ADMIN_NO_SRP_AUTH:
            val = "ADMIN_NO_SRP_AUTH";
            break;
        case eOAIExplicitAuthFlowsType::CUSTOM_AUTH_FLOW_ONLY:
            val = "CUSTOM_AUTH_FLOW_ONLY";
            break;
        case eOAIExplicitAuthFlowsType::USER_PASSWORD_AUTH:
            val = "USER_PASSWORD_AUTH";
            break;
        case eOAIExplicitAuthFlowsType::ALLOW_ADMIN_USER_PASSWORD_AUTH:
            val = "ALLOW_ADMIN_USER_PASSWORD_AUTH";
            break;
        case eOAIExplicitAuthFlowsType::ALLOW_CUSTOM_AUTH:
            val = "ALLOW_CUSTOM_AUTH";
            break;
        case eOAIExplicitAuthFlowsType::ALLOW_USER_PASSWORD_AUTH:
            val = "ALLOW_USER_PASSWORD_AUTH";
            break;
        case eOAIExplicitAuthFlowsType::ALLOW_USER_SRP_AUTH:
            val = "ALLOW_USER_SRP_AUTH";
            break;
        case eOAIExplicitAuthFlowsType::ALLOW_REFRESH_TOKEN_AUTH:
            val = "ALLOW_REFRESH_TOKEN_AUTH";
            break;
        default:
            break;
    }
...
QJsonValue OAIExplicitAuthFlowsType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIExplicitAuthFlowsType::eOAIExplicitAuthFlowsType OAIExplicitAuthFlowsType::getValue() const {
    return m_value;
}

void OAIExplicitAuthFlowsType::setValue(const OAIExplicitAuthFlowsType::eOAIExplicitAuthFlowsType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIExplicitAuthFlowsType::isSet() const {
    
    return m_value_isSet;
}

bool OAIExplicitAuthFlowsType::isValid() const {
