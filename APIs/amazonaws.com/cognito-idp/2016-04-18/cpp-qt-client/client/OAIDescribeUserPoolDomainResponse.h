...
/*
 * OAIDescribeUserPoolDomainResponse.h
 *
 * 
 */

#ifndef OAIDescribeUserPoolDomainResponse_H
#define OAIDescribeUserPoolDomainResponse_H
...
namespace OpenAPI {
class OAIDescribeUserPoolDomainResponse_DomainDescription;

class OAIDescribeUserPoolDomainResponse : public OAIObject {
public:
    OAIDescribeUserPoolDomainResponse();
    OAIDescribeUserPoolDomainResponse(QString json);
    ~OAIDescribeUserPoolDomainResponse() override;
    ...
    OAIDescribeUserPoolDomainResponse_DomainDescription getDomainDescription() const;
    void setDomainDescription(const OAIDescribeUserPoolDomainResponse_DomainDescription &domain_description);
    bool is_domain_description_Set() const;
    bool is_domain_description_Valid() const;
...
private:
    ...
    OAIDescribeUserPoolDomainResponse_DomainDescription m_domain_description;
    bool m_domain_description_isSet;
    bool m_domain_description_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDescribeUserPoolDomainResponse)

#endif // OAIDescribeUserPoolDomainResponse_H
