...
/*
 * OAIConfirmForgotPasswordRequest_UserContextData.h
 *
 * 
 */

#ifndef OAIConfirmForgotPasswordRequest_UserContextData_H
#define OAIConfirmForgotPasswordRequest_UserContextData_H
...
class OAIConfirmForgotPasswordRequest_UserContextData : public OAIObject {
public:
    OAIConfirmForgotPasswordRequest_UserContextData();
    OAIConfirmForgotPasswordRequest_UserContextData(QString json);
    ~OAIConfirmForgotPasswordRequest_UserContextData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConfirmForgotPasswordRequest_UserContextData)

#endif // OAIConfirmForgotPasswordRequest_UserContextData_H
