...
/*
 * OAIRiskConfigurationType_AccountTakeoverRiskConfiguration.h
 *
 * 
 */

#ifndef OAIRiskConfigurationType_AccountTakeoverRiskConfiguration_H
#define OAIRiskConfigurationType_AccountTakeoverRiskConfiguration_H

#include <QJsonObject>

#include "OAIAccountTakeoverRiskConfigurationType_Actions.h"
#include "OAIAccountTakeoverRiskConfigurationType_NotifyConfiguration.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIAccountTakeoverRiskConfigurationType_NotifyConfiguration;
class OAIAccountTakeoverRiskConfigurationType_Actions;

class OAIRiskConfigurationType_AccountTakeoverRiskConfiguration : public OAIObject {
public:
    OAIRiskConfigurationType_AccountTakeoverRiskConfiguration();
    OAIRiskConfigurationType_AccountTakeoverRiskConfiguration(QString json);
    ~OAIRiskConfigurationType_AccountTakeoverRiskConfiguration() override;
    ...
    OAIAccountTakeoverRiskConfigurationType_NotifyConfiguration getNotifyConfiguration() const;
    void setNotifyConfiguration(const OAIAccountTakeoverRiskConfigurationType_NotifyConfiguration &notify_configuration);
    bool is_notify_configuration_Set() const;
    bool is_notify_configuration_Valid() const;

    OAIAccountTakeoverRiskConfigurationType_Actions getActions() const;
    void setActions(const OAIAccountTakeoverRiskConfigurationType_Actions &actions);
...
private:
    ...
    OAIAccountTakeoverRiskConfigurationType_NotifyConfiguration m_notify_configuration;
    bool m_notify_configuration_isSet;
    bool m_notify_configuration_isValid;

    OAIAccountTakeoverRiskConfigurationType_Actions m_actions;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRiskConfigurationType_AccountTakeoverRiskConfiguration)

#endif // OAIRiskConfigurationType_AccountTakeoverRiskConfiguration_H
