...
/*
 * OAIAccountTakeoverRiskConfigurationType_Actions.h
 *
 * 
 */

#ifndef OAIAccountTakeoverRiskConfigurationType_Actions_H
#define OAIAccountTakeoverRiskConfigurationType_Actions_H
...
class OAIAccountTakeoverRiskConfigurationType_Actions : public OAIObject {
public:
    OAIAccountTakeoverRiskConfigurationType_Actions();
    OAIAccountTakeoverRiskConfigurationType_Actions(QString json);
    ~OAIAccountTakeoverRiskConfigurationType_Actions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccountTakeoverRiskConfigurationType_Actions)

#endif // OAIAccountTakeoverRiskConfigurationType_Actions_H
