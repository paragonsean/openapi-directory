...
#ifndef OAIRiskLevelType_H
#define OAIRiskLevelType_H
...
class OAIRiskLevelType : public OAIEnum {
public:
    OAIRiskLevelType();
    OAIRiskLevelType(QString json);
    ~OAIRiskLevelType() override;
    ...
    enum class eOAIRiskLevelType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        LOW, 
        MEDIUM, 
        HIGH
    };
    OAIRiskLevelType::eOAIRiskLevelType getValue() const;
    void setValue(const OAIRiskLevelType::eOAIRiskLevelType& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIRiskLevelType)

#endif // OAIRiskLevelType_H
