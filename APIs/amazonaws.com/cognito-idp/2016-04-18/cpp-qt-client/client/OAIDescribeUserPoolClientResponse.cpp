...
OAIDescribeUserPoolClientResponse::OAIDescribeUserPoolClientResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeUserPoolClientResponse::OAIDescribeUserPoolClientResponse() {
    this->initializeModel();
}

OAIDescribeUserPoolClientResponse::~OAIDescribeUserPoolClientResponse() {}

void OAIDescribeUserPoolClientResponse::initializeModel() {

    m_user_pool_client_isSet = false;
    m_user_pool_client_isValid = false;
}

void OAIDescribeUserPoolClientResponse::fromJson(QString jsonString) {
...
void OAIDescribeUserPoolClientResponse::fromJsonObject(QJsonObject json) {

    m_user_pool_client_isValid = ::OpenAPI::fromJsonValue(m_user_pool_client, json[QString("UserPoolClient")]);
    m_user_pool_client_isSet = !json[QString("UserPoolClient")].isNull() && m_user_pool_client_isValid;
}

QString OAIDescribeUserPoolClientResponse::asJson() const {
...
QJsonObject OAIDescribeUserPoolClientResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_user_pool_client.isSet()) {
        obj.insert(QString("UserPoolClient"), ::OpenAPI::toJsonValue(m_user_pool_client));
    }
    return obj;
}

OAIDescribeUserPoolClientResponse_UserPoolClient OAIDescribeUserPoolClientResponse::getUserPoolClient() const {
    return m_user_pool_client;
}
void OAIDescribeUserPoolClientResponse::setUserPoolClient(const OAIDescribeUserPoolClientResponse_UserPoolClient &user_pool_client) {
    m_user_pool_client = user_pool_client;
    m_user_pool_client_isSet = true;
}

bool OAIDescribeUserPoolClientResponse::is_user_pool_client_Set() const{
    return m_user_pool_client_isSet;
}

bool OAIDescribeUserPoolClientResponse::is_user_pool_client_Valid() const{
    return m_user_pool_client_isValid;
}

bool OAIDescribeUserPoolClientResponse::isSet() const {
...
bool OAIDescribeUserPoolClientResponse::isValid() const {
