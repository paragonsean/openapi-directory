...
OAIVerifySoftwareTokenResponse::OAIVerifySoftwareTokenResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIVerifySoftwareTokenResponse::OAIVerifySoftwareTokenResponse() {
    this->initializeModel();
}

OAIVerifySoftwareTokenResponse::~OAIVerifySoftwareTokenResponse() {}

void OAIVerifySoftwareTokenResponse::initializeModel() {
...
void OAIVerifySoftwareTokenResponse::fromJson(QString jsonString) {
...
void OAIVerifySoftwareTokenResponse::fromJsonObject(QJsonObject json) {
...
QString OAIVerifySoftwareTokenResponse::asJson() const {
...
QJsonObject OAIVerifySoftwareTokenResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_status.isSet()) {
...
OAIVerifySoftwareTokenResponseType OAIVerifySoftwareTokenResponse::getStatus() const {
    return m_status;
}
void OAIVerifySoftwareTokenResponse::setStatus(const OAIVerifySoftwareTokenResponseType &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIVerifySoftwareTokenResponse::is_status_Set() const{
    return m_status_isSet;
}

bool OAIVerifySoftwareTokenResponse::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIVerifySoftwareTokenResponse::getSession() const {
    return m_session;
}
void OAIVerifySoftwareTokenResponse::setSession(const QString &session) {
    m_session = session;
    m_session_isSet = true;
}

bool OAIVerifySoftwareTokenResponse::is_session_Set() const{
    return m_session_isSet;
}

bool OAIVerifySoftwareTokenResponse::is_session_Valid() const{
    return m_session_isValid;
}

bool OAIVerifySoftwareTokenResponse::isSet() const {
...
bool OAIVerifySoftwareTokenResponse::isValid() const {
