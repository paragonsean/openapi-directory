...
/*
 * OAIGetIdentityProviderByIdentifierRequest.h
 *
 * 
 */

#ifndef OAIGetIdentityProviderByIdentifierRequest_H
#define OAIGetIdentityProviderByIdentifierRequest_H
...
class OAIGetIdentityProviderByIdentifierRequest : public OAIObject {
public:
    OAIGetIdentityProviderByIdentifierRequest();
    OAIGetIdentityProviderByIdentifierRequest(QString json);
    ~OAIGetIdentityProviderByIdentifierRequest() override;
    ...
    QString getIdpIdentifier() const;
    void setIdpIdentifier(const QString &idp_identifier);
    bool is_idp_identifier_Set() const;
    bool is_idp_identifier_Valid() const;
...
private:
    ...
    QString m_idp_identifier;
    bool m_idp_identifier_isSet;
    bool m_idp_identifier_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGetIdentityProviderByIdentifierRequest)

#endif // OAIGetIdentityProviderByIdentifierRequest_H
