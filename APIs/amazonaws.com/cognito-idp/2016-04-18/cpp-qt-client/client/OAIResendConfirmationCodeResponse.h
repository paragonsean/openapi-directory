...
/*
 * OAIResendConfirmationCodeResponse.h
 *
 * The response from the server when Amazon Cognito makes the request to resend a confirmation code.
 */

#ifndef OAIResendConfirmationCodeResponse_H
#define OAIResendConfirmationCodeResponse_H
...
namespace OpenAPI {
class OAIResendConfirmationCodeResponse_CodeDeliveryDetails;

class OAIResendConfirmationCodeResponse : public OAIObject {
public:
    OAIResendConfirmationCodeResponse();
    OAIResendConfirmationCodeResponse(QString json);
    ~OAIResendConfirmationCodeResponse() override;
    ...
    OAIResendConfirmationCodeResponse_CodeDeliveryDetails getCodeDeliveryDetails() const;
    void setCodeDeliveryDetails(const OAIResendConfirmationCodeResponse_CodeDeliveryDetails &code_delivery_details);
...
private:
    ...
    OAIResendConfirmationCodeResponse_CodeDeliveryDetails m_code_delivery_details;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResendConfirmationCodeResponse)

#endif // OAIResendConfirmationCodeResponse_H
