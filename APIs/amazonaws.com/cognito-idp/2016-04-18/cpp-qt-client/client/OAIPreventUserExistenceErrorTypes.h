...
/*
 * OAIPreventUserExistenceErrorTypes.h
 *
 * 
 */

#ifndef OAIPreventUserExistenceErrorTypes_H
#define OAIPreventUserExistenceErrorTypes_H
...
class OAIPreventUserExistenceErrorTypes : public OAIEnum {
public:
    OAIPreventUserExistenceErrorTypes();
    OAIPreventUserExistenceErrorTypes(QString json);
    ~OAIPreventUserExistenceErrorTypes() override;
    ...
    enum class eOAIPreventUserExistenceErrorTypes {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        LEGACY, 
        ENABLED
    };
    OAIPreventUserExistenceErrorTypes::eOAIPreventUserExistenceErrorTypes getValue() const;
    void setValue(const OAIPreventUserExistenceErrorTypes::eOAIPreventUserExistenceErrorTypes& value);
...
private:
    ...
    eOAIPreventUserExistenceErrorTypes m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPreventUserExistenceErrorTypes)

#endif // OAIPreventUserExistenceErrorTypes_H
