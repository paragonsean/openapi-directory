...
/*
 * OAIVerifyUserAttributeRequest.h
 *
 * Represents the request to verify user attributes.
 */

#ifndef OAIVerifyUserAttributeRequest_H
#define OAIVerifyUserAttributeRequest_H
...
class OAIVerifyUserAttributeRequest : public OAIObject {
public:
    OAIVerifyUserAttributeRequest();
    OAIVerifyUserAttributeRequest(QString json);
    ~OAIVerifyUserAttributeRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVerifyUserAttributeRequest)

#endif // OAIVerifyUserAttributeRequest_H
