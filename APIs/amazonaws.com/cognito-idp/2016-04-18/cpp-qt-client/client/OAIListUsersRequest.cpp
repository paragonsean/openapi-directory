...
OAIListUsersRequest::OAIListUsersRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListUsersRequest::OAIListUsersRequest() {
    this->initializeModel();
}

OAIListUsersRequest::~OAIListUsersRequest() {}

void OAIListUsersRequest::initializeModel() {
...
void OAIListUsersRequest::fromJson(QString jsonString) {
...
void OAIListUsersRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListUsersRequest::asJson() const {
...
QJsonObject OAIListUsersRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListUsersRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIListUsersRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIListUsersRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIListUsersRequest::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

QList OAIListUsersRequest::getAttributesToGet() const {
    return m_attributes_to_get;
}
void OAIListUsersRequest::setAttributesToGet(const QList &attributes_to_get) {
    m_attributes_to_get = attributes_to_get;
    m_attributes_to_get_isSet = true;
}

bool OAIListUsersRequest::is_attributes_to_get_Set() const{
    return m_attributes_to_get_isSet;
}

bool OAIListUsersRequest::is_attributes_to_get_Valid() const{
    return m_attributes_to_get_isValid;
}

qint32 OAIListUsersRequest::getLimit() const {
    return m_limit;
}
void OAIListUsersRequest::setLimit(const qint32 &limit) {
    m_limit = limit;
    m_limit_isSet = true;
}

bool OAIListUsersRequest::is_limit_Set() const{
    return m_limit_isSet;
}

bool OAIListUsersRequest::is_limit_Valid() const{
    return m_limit_isValid;
}

QString OAIListUsersRequest::getPaginationToken() const {
    return m_pagination_token;
}
void OAIListUsersRequest::setPaginationToken(const QString &pagination_token) {
    m_pagination_token = pagination_token;
    m_pagination_token_isSet = true;
}

bool OAIListUsersRequest::is_pagination_token_Set() const{
    return m_pagination_token_isSet;
}

bool OAIListUsersRequest::is_pagination_token_Valid() const{
    return m_pagination_token_isValid;
}

QString OAIListUsersRequest::getFilter() const {
    return m_filter;
}
void OAIListUsersRequest::setFilter(const QString &filter) {
    m_filter = filter;
    m_filter_isSet = true;
}

bool OAIListUsersRequest::is_filter_Set() const{
    return m_filter_isSet;
}

bool OAIListUsersRequest::is_filter_Valid() const{
    return m_filter_isValid;
}

bool OAIListUsersRequest::isSet() const {
...
bool OAIListUsersRequest::isValid() const {
