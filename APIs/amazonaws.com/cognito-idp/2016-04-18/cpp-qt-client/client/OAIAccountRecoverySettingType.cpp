...
#include "OAIAccountRecoverySettingType.h"
...
OAIAccountRecoverySettingType::OAIAccountRecoverySettingType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAccountRecoverySettingType::OAIAccountRecoverySettingType() {
    this->initializeModel();
}

OAIAccountRecoverySettingType::~OAIAccountRecoverySettingType() {}

void OAIAccountRecoverySettingType::initializeModel() {

    m_recovery_mechanisms_isSet = false;
    m_recovery_mechanisms_isValid = false;
}

void OAIAccountRecoverySettingType::fromJson(QString jsonString) {
...
void OAIAccountRecoverySettingType::fromJsonObject(QJsonObject json) {

    m_recovery_mechanisms_isValid = ::OpenAPI::fromJsonValue(m_recovery_mechanisms, json[QString("RecoveryMechanisms")]);
    m_recovery_mechanisms_isSet = !json[QString("RecoveryMechanisms")].isNull() && m_recovery_mechanisms_isValid;
}

QString OAIAccountRecoverySettingType::asJson() const {
...
QJsonObject OAIAccountRecoverySettingType::asJsonObject() const {
    QJsonObject obj;
    if (m_recovery_mechanisms.isSet()) {
        obj.insert(QString("RecoveryMechanisms"), ::OpenAPI::toJsonValue(m_recovery_mechanisms));
    }
    return obj;
}

QList OAIAccountRecoverySettingType::getRecoveryMechanisms() const {
    return m_recovery_mechanisms;
}
void OAIAccountRecoverySettingType::setRecoveryMechanisms(const QList &recovery_mechanisms) {
    m_recovery_mechanisms = recovery_mechanisms;
    m_recovery_mechanisms_isSet = true;
}

bool OAIAccountRecoverySettingType::is_recovery_mechanisms_Set() const{
    return m_recovery_mechanisms_isSet;
}

bool OAIAccountRecoverySettingType::is_recovery_mechanisms_Valid() const{
    return m_recovery_mechanisms_isValid;
}

bool OAIAccountRecoverySettingType::isSet() const {
...
bool OAIAccountRecoverySettingType::isValid() const {
