...
/*
 * OAIConfirmForgotPasswordRequest_AnalyticsMetadata.h
 *
 * 
 */

#ifndef OAIConfirmForgotPasswordRequest_AnalyticsMetadata_H
#define OAIConfirmForgotPasswordRequest_AnalyticsMetadata_H
...
class OAIConfirmForgotPasswordRequest_AnalyticsMetadata : public OAIObject {
public:
    OAIConfirmForgotPasswordRequest_AnalyticsMetadata();
    OAIConfirmForgotPasswordRequest_AnalyticsMetadata(QString json);
    ~OAIConfirmForgotPasswordRequest_AnalyticsMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConfirmForgotPasswordRequest_AnalyticsMetadata)

#endif // OAIConfirmForgotPasswordRequest_AnalyticsMetadata_H
