...
#include "OAICompromisedCredentialsRiskConfigurationType_Actions.h"
...
OAICompromisedCredentialsRiskConfigurationType_Actions::OAICompromisedCredentialsRiskConfigurationType_Actions(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICompromisedCredentialsRiskConfigurationType_Actions::OAICompromisedCredentialsRiskConfigurationType_Actions() {
    this->initializeModel();
}

OAICompromisedCredentialsRiskConfigurationType_Actions::~OAICompromisedCredentialsRiskConfigurationType_Actions() {}

void OAICompromisedCredentialsRiskConfigurationType_Actions::initializeModel() {

    m_event_action_isSet = false;
    m_event_action_isValid = false;
}

void OAICompromisedCredentialsRiskConfigurationType_Actions::fromJson(QString jsonString) {
...
void OAICompromisedCredentialsRiskConfigurationType_Actions::fromJsonObject(QJsonObject json) {
...
QString OAICompromisedCredentialsRiskConfigurationType_Actions::asJson() const {
...
QJsonObject OAICompromisedCredentialsRiskConfigurationType_Actions::asJsonObject() const {
    QJsonObject obj;
...
OAICompromisedCredentialsEventActionType OAICompromisedCredentialsRiskConfigurationType_Actions::getEventAction() const {
    return m_event_action;
}
void OAICompromisedCredentialsRiskConfigurationType_Actions::setEventAction(const OAICompromisedCredentialsEventActionType &event_action) {
    m_event_action = event_action;
    m_event_action_isSet = true;
}

bool OAICompromisedCredentialsRiskConfigurationType_Actions::is_event_action_Set() const{
    return m_event_action_isSet;
}

bool OAICompromisedCredentialsRiskConfigurationType_Actions::is_event_action_Valid() const{
    return m_event_action_isValid;
}

bool OAICompromisedCredentialsRiskConfigurationType_Actions::isSet() const {
...
bool OAICompromisedCredentialsRiskConfigurationType_Actions::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_event_action_isValid && true;
}
