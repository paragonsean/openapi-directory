...
/*
 * OAIDescribeIdentityProviderResponse.h
 *
 * 
 */

#ifndef OAIDescribeIdentityProviderResponse_H
#define OAIDescribeIdentityProviderResponse_H
...
class OAIDescribeIdentityProviderResponse : public OAIObject {
public:
    OAIDescribeIdentityProviderResponse();
    OAIDescribeIdentityProviderResponse(QString json);
    ~OAIDescribeIdentityProviderResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeIdentityProviderResponse)

#endif // OAIDescribeIdentityProviderResponse_H
