...
/*
 * OAICreateUserPoolDomainResponse.h
 *
 * 
 */

#ifndef OAICreateUserPoolDomainResponse_H
#define OAICreateUserPoolDomainResponse_H
...
class OAICreateUserPoolDomainResponse : public OAIObject {
public:
    OAICreateUserPoolDomainResponse();
    OAICreateUserPoolDomainResponse(QString json);
    ~OAICreateUserPoolDomainResponse() override;
    ...
    void setCloudFrontDomain(const QString &cloud_front_domain);
    bool is_cloud_front_domain_Set() const;
    bool is_cloud_front_domain_Valid() const;
...
private:
    ...
    QString m_cloud_front_domain;
    bool m_cloud_front_domain_isSet;
    bool m_cloud_front_domain_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICreateUserPoolDomainResponse)

#endif // OAICreateUserPoolDomainResponse_H
