...
/*
 * OAIUserPoolClientType_AnalyticsConfiguration.h
 *
 * 
 */

#ifndef OAIUserPoolClientType_AnalyticsConfiguration_H
#define OAIUserPoolClientType_AnalyticsConfiguration_H
...
class OAIUserPoolClientType_AnalyticsConfiguration : public OAIObject {
public:
    OAIUserPoolClientType_AnalyticsConfiguration();
    OAIUserPoolClientType_AnalyticsConfiguration(QString json);
    ~OAIUserPoolClientType_AnalyticsConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserPoolClientType_AnalyticsConfiguration)

#endif // OAIUserPoolClientType_AnalyticsConfiguration_H
