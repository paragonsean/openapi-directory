...
/*
 * OAIDescribeUserPoolClientRequest.h
 *
 * Represents the request to describe a user pool client.
 */

#ifndef OAIDescribeUserPoolClientRequest_H
#define OAIDescribeUserPoolClientRequest_H
...
class OAIDescribeUserPoolClientRequest : public OAIObject {
public:
    OAIDescribeUserPoolClientRequest();
    OAIDescribeUserPoolClientRequest(QString json);
    ~OAIDescribeUserPoolClientRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeUserPoolClientRequest)

#endif // OAIDescribeUserPoolClientRequest_H
