...
OAIDeleteUserPoolRequest::OAIDeleteUserPoolRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteUserPoolRequest::OAIDeleteUserPoolRequest() {
    this->initializeModel();
}

OAIDeleteUserPoolRequest::~OAIDeleteUserPoolRequest() {}

void OAIDeleteUserPoolRequest::initializeModel() {

    m_user_pool_id_isSet = false;
    m_user_pool_id_isValid = false;
}

void OAIDeleteUserPoolRequest::fromJson(QString jsonString) {
...
void OAIDeleteUserPoolRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteUserPoolRequest::asJson() const {
...
QJsonObject OAIDeleteUserPoolRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteUserPoolRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIDeleteUserPoolRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIDeleteUserPoolRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIDeleteUserPoolRequest::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

bool OAIDeleteUserPoolRequest::isSet() const {
...
bool OAIDeleteUserPoolRequest::isValid() const {
