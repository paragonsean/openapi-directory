...
/*
 * OAIDescribeRiskConfigurationResponse.h
 *
 * 
 */

#ifndef OAIDescribeRiskConfigurationResponse_H
#define OAIDescribeRiskConfigurationResponse_H
...
class OAIDescribeRiskConfigurationResponse : public OAIObject {
public:
    OAIDescribeRiskConfigurationResponse();
    OAIDescribeRiskConfigurationResponse(QString json);
    ~OAIDescribeRiskConfigurationResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeRiskConfigurationResponse)

#endif // OAIDescribeRiskConfigurationResponse_H
