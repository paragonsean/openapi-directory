...
#include "OAIUsernameAttributeType.h"
...
OAIUsernameAttributeType::OAIUsernameAttributeType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUsernameAttributeType::OAIUsernameAttributeType() {
    this->initializeModel();
}

OAIUsernameAttributeType::~OAIUsernameAttributeType() {}

void OAIUsernameAttributeType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIUsernameAttributeType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIUsernameAttributeType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("phone_number", Qt::CaseInsensitive) == 0) {
        m_value = eOAIUsernameAttributeType::PHONE_NUMBER;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("email", Qt::CaseInsensitive) == 0) {
        m_value = eOAIUsernameAttributeType::EMAIL;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIUsernameAttributeType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIUsernameAttributeType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIUsernameAttributeType::PHONE_NUMBER:
            val = "phone_number";
            break;
        case eOAIUsernameAttributeType::EMAIL:
            val = "email";
            break;
        default:
            break;
...
QJsonValue OAIUsernameAttributeType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIUsernameAttributeType::eOAIUsernameAttributeType OAIUsernameAttributeType::getValue() const {
    return m_value;
}

void OAIUsernameAttributeType::setValue(const OAIUsernameAttributeType::eOAIUsernameAttributeType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIUsernameAttributeType::isSet() const {
    
    return m_value_isSet;
}

bool OAIUsernameAttributeType::isValid() const {
