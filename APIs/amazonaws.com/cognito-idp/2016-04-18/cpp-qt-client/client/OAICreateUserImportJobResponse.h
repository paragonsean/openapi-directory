...
/*
 * OAICreateUserImportJobResponse.h
 *
 * Represents the response from the server to the request to create the user import job.
 */

#ifndef OAICreateUserImportJobResponse_H
#define OAICreateUserImportJobResponse_H
...
class OAICreateUserImportJobResponse : public OAIObject {
public:
    OAICreateUserImportJobResponse();
    OAICreateUserImportJobResponse(QString json);
    ~OAICreateUserImportJobResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateUserImportJobResponse)

#endif // OAICreateUserImportJobResponse_H
