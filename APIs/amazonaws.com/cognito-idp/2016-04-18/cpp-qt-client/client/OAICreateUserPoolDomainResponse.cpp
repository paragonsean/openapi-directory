...
OAICreateUserPoolDomainResponse::OAICreateUserPoolDomainResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateUserPoolDomainResponse::OAICreateUserPoolDomainResponse() {
    this->initializeModel();
}

OAICreateUserPoolDomainResponse::~OAICreateUserPoolDomainResponse() {}

void OAICreateUserPoolDomainResponse::initializeModel() {

    m_cloud_front_domain_isSet = false;
    m_cloud_front_domain_isValid = false;
}

void OAICreateUserPoolDomainResponse::fromJson(QString jsonString) {
...
void OAICreateUserPoolDomainResponse::fromJsonObject(QJsonObject json) {

    m_cloud_front_domain_isValid = ::OpenAPI::fromJsonValue(m_cloud_front_domain, json[QString("CloudFrontDomain")]);
    m_cloud_front_domain_isSet = !json[QString("CloudFrontDomain")].isNull() && m_cloud_front_domain_isValid;
}

QString OAICreateUserPoolDomainResponse::asJson() const {
...
QJsonObject OAICreateUserPoolDomainResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_cloud_front_domain_isSet) {
        obj.insert(QString("CloudFrontDomain"), ::OpenAPI::toJsonValue(m_cloud_front_domain));
    }
    return obj;
}

QString OAICreateUserPoolDomainResponse::getCloudFrontDomain() const {
    return m_cloud_front_domain;
}
void OAICreateUserPoolDomainResponse::setCloudFrontDomain(const QString &cloud_front_domain) {
    m_cloud_front_domain = cloud_front_domain;
    m_cloud_front_domain_isSet = true;
}

bool OAICreateUserPoolDomainResponse::is_cloud_front_domain_Set() const{
    return m_cloud_front_domain_isSet;
}

bool OAICreateUserPoolDomainResponse::is_cloud_front_domain_Valid() const{
    return m_cloud_front_domain_isValid;
}

bool OAICreateUserPoolDomainResponse::isSet() const {
...
bool OAICreateUserPoolDomainResponse::isValid() const {
