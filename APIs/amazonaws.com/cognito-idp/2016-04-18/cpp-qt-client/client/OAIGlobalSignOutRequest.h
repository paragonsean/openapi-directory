...
/*
 * OAIGlobalSignOutRequest.h
 *
 * Represents the request to sign out all devices.
 */

#ifndef OAIGlobalSignOutRequest_H
#define OAIGlobalSignOutRequest_H
...
class OAIGlobalSignOutRequest : public OAIObject {
public:
    OAIGlobalSignOutRequest();
    OAIGlobalSignOutRequest(QString json);
    ~OAIGlobalSignOutRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGlobalSignOutRequest)

#endif // OAIGlobalSignOutRequest_H
