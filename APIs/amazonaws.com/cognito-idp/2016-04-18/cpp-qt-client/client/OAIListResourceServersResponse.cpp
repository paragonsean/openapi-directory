...
OAIListResourceServersResponse::OAIListResourceServersResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListResourceServersResponse::OAIListResourceServersResponse() {
    this->initializeModel();
}

OAIListResourceServersResponse::~OAIListResourceServersResponse() {}

void OAIListResourceServersResponse::initializeModel() {

    m_resource_servers_isSet = false;
    m_resource_servers_isValid = false;

    m_next_token_isSet = false;
    m_next_token_isValid = false;
}

void OAIListResourceServersResponse::fromJson(QString jsonString) {
...
void OAIListResourceServersResponse::fromJsonObject(QJsonObject json) {

    m_resource_servers_isValid = ::OpenAPI::fromJsonValue(m_resource_servers, json[QString("ResourceServers")]);
    m_resource_servers_isSet = !json[QString("ResourceServers")].isNull() && m_resource_servers_isValid;

    m_next_token_isValid = ::OpenAPI::fromJsonValue(m_next_token, json[QString("NextToken")]);
    m_next_token_isSet = !json[QString("NextToken")].isNull() && m_next_token_isValid;
}

QString OAIListResourceServersResponse::asJson() const {
...
QJsonObject OAIListResourceServersResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_resource_servers.isSet()) {
        obj.insert(QString("ResourceServers"), ::OpenAPI::toJsonValue(m_resource_servers));
    }
...
QList OAIListResourceServersResponse::getResourceServers() const {
    return m_resource_servers;
}
void OAIListResourceServersResponse::setResourceServers(const QList &resource_servers) {
    m_resource_servers = resource_servers;
    m_resource_servers_isSet = true;
}

bool OAIListResourceServersResponse::is_resource_servers_Set() const{
    return m_resource_servers_isSet;
}

bool OAIListResourceServersResponse::is_resource_servers_Valid() const{
    return m_resource_servers_isValid;
}

QString OAIListResourceServersResponse::getNextToken() const {
    return m_next_token;
}
void OAIListResourceServersResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListResourceServersResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListResourceServersResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListResourceServersResponse::isSet() const {
...
bool OAIListResourceServersResponse::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_resource_servers_isValid && true;
}
