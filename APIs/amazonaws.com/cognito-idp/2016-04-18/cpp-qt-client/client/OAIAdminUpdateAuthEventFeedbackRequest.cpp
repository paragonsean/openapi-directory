...
OAIAdminUpdateAuthEventFeedbackRequest::OAIAdminUpdateAuthEventFeedbackRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdminUpdateAuthEventFeedbackRequest::OAIAdminUpdateAuthEventFeedbackRequest() {
    this->initializeModel();
}

OAIAdminUpdateAuthEventFeedbackRequest::~OAIAdminUpdateAuthEventFeedbackRequest() {}

void OAIAdminUpdateAuthEventFeedbackRequest::initializeModel() {
...
void OAIAdminUpdateAuthEventFeedbackRequest::fromJson(QString jsonString) {
...
void OAIAdminUpdateAuthEventFeedbackRequest::fromJsonObject(QJsonObject json) {
...
QString OAIAdminUpdateAuthEventFeedbackRequest::asJson() const {
...
QJsonObject OAIAdminUpdateAuthEventFeedbackRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAdminUpdateAuthEventFeedbackRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIAdminUpdateAuthEventFeedbackRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIAdminUpdateAuthEventFeedbackRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIAdminUpdateAuthEventFeedbackRequest::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

QString OAIAdminUpdateAuthEventFeedbackRequest::getUsername() const {
    return m_username;
}
void OAIAdminUpdateAuthEventFeedbackRequest::setUsername(const QString &username) {
    m_username = username;
    m_username_isSet = true;
}

bool OAIAdminUpdateAuthEventFeedbackRequest::is_username_Set() const{
    return m_username_isSet;
}

bool OAIAdminUpdateAuthEventFeedbackRequest::is_username_Valid() const{
    return m_username_isValid;
}

QString OAIAdminUpdateAuthEventFeedbackRequest::getEventId() const {
    return m_event_id;
}
void OAIAdminUpdateAuthEventFeedbackRequest::setEventId(const QString &event_id) {
    m_event_id = event_id;
    m_event_id_isSet = true;
}

bool OAIAdminUpdateAuthEventFeedbackRequest::is_event_id_Set() const{
    return m_event_id_isSet;
}

bool OAIAdminUpdateAuthEventFeedbackRequest::is_event_id_Valid() const{
    return m_event_id_isValid;
}

OAIFeedbackValueType OAIAdminUpdateAuthEventFeedbackRequest::getFeedbackValue() const {
    return m_feedback_value;
}
void OAIAdminUpdateAuthEventFeedbackRequest::setFeedbackValue(const OAIFeedbackValueType &feedback_value) {
    m_feedback_value = feedback_value;
    m_feedback_value_isSet = true;
}

bool OAIAdminUpdateAuthEventFeedbackRequest::is_feedback_value_Set() const{
    return m_feedback_value_isSet;
}

bool OAIAdminUpdateAuthEventFeedbackRequest::is_feedback_value_Valid() const{
    return m_feedback_value_isValid;
}

bool OAIAdminUpdateAuthEventFeedbackRequest::isSet() const {
...
bool OAIAdminUpdateAuthEventFeedbackRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_user_pool_id_isValid && m_username_isValid && m_event_id_isValid && m_feedback_value_isValid && true;
}
