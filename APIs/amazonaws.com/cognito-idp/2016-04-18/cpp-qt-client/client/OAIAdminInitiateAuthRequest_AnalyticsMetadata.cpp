...
#include "OAIAdminInitiateAuthRequest_AnalyticsMetadata.h"
...
OAIAdminInitiateAuthRequest_AnalyticsMetadata::OAIAdminInitiateAuthRequest_AnalyticsMetadata(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdminInitiateAuthRequest_AnalyticsMetadata::OAIAdminInitiateAuthRequest_AnalyticsMetadata() {
    this->initializeModel();
}

OAIAdminInitiateAuthRequest_AnalyticsMetadata::~OAIAdminInitiateAuthRequest_AnalyticsMetadata() {}

void OAIAdminInitiateAuthRequest_AnalyticsMetadata::initializeModel() {

    m_analytics_endpoint_id_isSet = false;
    m_analytics_endpoint_id_isValid = false;
}

void OAIAdminInitiateAuthRequest_AnalyticsMetadata::fromJson(QString jsonString) {
...
void OAIAdminInitiateAuthRequest_AnalyticsMetadata::fromJsonObject(QJsonObject json) {
...
QString OAIAdminInitiateAuthRequest_AnalyticsMetadata::asJson() const {
...
QJsonObject OAIAdminInitiateAuthRequest_AnalyticsMetadata::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAdminInitiateAuthRequest_AnalyticsMetadata::getAnalyticsEndpointId() const {
    return m_analytics_endpoint_id;
}
void OAIAdminInitiateAuthRequest_AnalyticsMetadata::setAnalyticsEndpointId(const QString &analytics_endpoint_id) {
    m_analytics_endpoint_id = analytics_endpoint_id;
    m_analytics_endpoint_id_isSet = true;
}

bool OAIAdminInitiateAuthRequest_AnalyticsMetadata::is_analytics_endpoint_id_Set() const{
    return m_analytics_endpoint_id_isSet;
}

bool OAIAdminInitiateAuthRequest_AnalyticsMetadata::is_analytics_endpoint_id_Valid() const{
    return m_analytics_endpoint_id_isValid;
}

bool OAIAdminInitiateAuthRequest_AnalyticsMetadata::isSet() const {
...
bool OAIAdminInitiateAuthRequest_AnalyticsMetadata::isValid() const {
