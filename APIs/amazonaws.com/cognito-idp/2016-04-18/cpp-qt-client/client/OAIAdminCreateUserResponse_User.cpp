...
#include "OAIAdminCreateUserResponse_User.h"
...
OAIAdminCreateUserResponse_User::OAIAdminCreateUserResponse_User(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdminCreateUserResponse_User::OAIAdminCreateUserResponse_User() {
    this->initializeModel();
}

OAIAdminCreateUserResponse_User::~OAIAdminCreateUserResponse_User() {}

void OAIAdminCreateUserResponse_User::initializeModel() {
...
void OAIAdminCreateUserResponse_User::fromJson(QString jsonString) {
...
void OAIAdminCreateUserResponse_User::fromJsonObject(QJsonObject json) {
...
QString OAIAdminCreateUserResponse_User::asJson() const {
...
QJsonObject OAIAdminCreateUserResponse_User::asJsonObject() const {
    QJsonObject obj;
    if (m_username_isSet) {
...
QString OAIAdminCreateUserResponse_User::getUsername() const {
    return m_username;
}
void OAIAdminCreateUserResponse_User::setUsername(const QString &username) {
    m_username = username;
    m_username_isSet = true;
}

bool OAIAdminCreateUserResponse_User::is_username_Set() const{
    return m_username_isSet;
}

bool OAIAdminCreateUserResponse_User::is_username_Valid() const{
    return m_username_isValid;
}

QList OAIAdminCreateUserResponse_User::getAttributes() const {
    return m_attributes;
}
void OAIAdminCreateUserResponse_User::setAttributes(const QList &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAIAdminCreateUserResponse_User::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAIAdminCreateUserResponse_User::is_attributes_Valid() const{
    return m_attributes_isValid;
}

QDateTime OAIAdminCreateUserResponse_User::getUserCreateDate() const {
    return m_user_create_date;
}
void OAIAdminCreateUserResponse_User::setUserCreateDate(const QDateTime &user_create_date) {
    m_user_create_date = user_create_date;
    m_user_create_date_isSet = true;
}

bool OAIAdminCreateUserResponse_User::is_user_create_date_Set() const{
    return m_user_create_date_isSet;
}

bool OAIAdminCreateUserResponse_User::is_user_create_date_Valid() const{
    return m_user_create_date_isValid;
}

QDateTime OAIAdminCreateUserResponse_User::getUserLastModifiedDate() const {
    return m_user_last_modified_date;
}
void OAIAdminCreateUserResponse_User::setUserLastModifiedDate(const QDateTime &user_last_modified_date) {
    m_user_last_modified_date = user_last_modified_date;
    m_user_last_modified_date_isSet = true;
}

bool OAIAdminCreateUserResponse_User::is_user_last_modified_date_Set() const{
    return m_user_last_modified_date_isSet;
}

bool OAIAdminCreateUserResponse_User::is_user_last_modified_date_Valid() const{
    return m_user_last_modified_date_isValid;
}

bool OAIAdminCreateUserResponse_User::getEnabled() const {
    return m_enabled;
}
void OAIAdminCreateUserResponse_User::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAIAdminCreateUserResponse_User::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAIAdminCreateUserResponse_User::is_enabled_Valid() const{
    return m_enabled_isValid;
}

OAIUserStatusType OAIAdminCreateUserResponse_User::getUserStatus() const {
    return m_user_status;
}
void OAIAdminCreateUserResponse_User::setUserStatus(const OAIUserStatusType &user_status) {
    m_user_status = user_status;
    m_user_status_isSet = true;
}

bool OAIAdminCreateUserResponse_User::is_user_status_Set() const{
    return m_user_status_isSet;
}

bool OAIAdminCreateUserResponse_User::is_user_status_Valid() const{
    return m_user_status_isValid;
}

QList OAIAdminCreateUserResponse_User::getMfaOptions() const {
    return m_mfa_options;
}
void OAIAdminCreateUserResponse_User::setMfaOptions(const QList &mfa_options) {
    m_mfa_options = mfa_options;
    m_mfa_options_isSet = true;
}

bool OAIAdminCreateUserResponse_User::is_mfa_options_Set() const{
    return m_mfa_options_isSet;
}

bool OAIAdminCreateUserResponse_User::is_mfa_options_Valid() const{
    return m_mfa_options_isValid;
}

bool OAIAdminCreateUserResponse_User::isSet() const {
...
bool OAIAdminCreateUserResponse_User::isValid() const {
