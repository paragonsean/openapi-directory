...
/*
 * OAIGetUserPoolMfaConfigResponse.h
 *
 * 
 */

#ifndef OAIGetUserPoolMfaConfigResponse_H
#define OAIGetUserPoolMfaConfigResponse_H
...
namespace OpenAPI {
class OAIGetUserPoolMfaConfigResponse_SmsMfaConfiguration;
class OAIGetUserPoolMfaConfigResponse_SoftwareTokenMfaConfiguration;

class OAIGetUserPoolMfaConfigResponse : public OAIObject {
public:
    OAIGetUserPoolMfaConfigResponse();
    OAIGetUserPoolMfaConfigResponse(QString json);
    ~OAIGetUserPoolMfaConfigResponse() override;
    ...
    OAIGetUserPoolMfaConfigResponse_SmsMfaConfiguration getSmsMfaConfiguration() const;
    void setSmsMfaConfiguration(const OAIGetUserPoolMfaConfigResponse_SmsMfaConfiguration &sms_mfa_configuration);
    bool is_sms_mfa_configuration_Set() const;
    bool is_sms_mfa_configuration_Valid() const;

    OAIGetUserPoolMfaConfigResponse_SoftwareTokenMfaConfiguration getSoftwareTokenMfaConfiguration() const;
    void setSoftwareTokenMfaConfiguration(const OAIGetUserPoolMfaConfigResponse_SoftwareTokenMfaConfiguration &software_token_mfa_configuration);
...
private:
    ...
    OAIGetUserPoolMfaConfigResponse_SmsMfaConfiguration m_sms_mfa_configuration;
    bool m_sms_mfa_configuration_isSet;
    bool m_sms_mfa_configuration_isValid;

    OAIGetUserPoolMfaConfigResponse_SoftwareTokenMfaConfiguration m_software_token_mfa_configuration;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetUserPoolMfaConfigResponse)

#endif // OAIGetUserPoolMfaConfigResponse_H
