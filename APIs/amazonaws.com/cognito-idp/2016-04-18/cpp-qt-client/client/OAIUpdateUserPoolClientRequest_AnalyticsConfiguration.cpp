...
OAIUpdateUserPoolClientRequest_AnalyticsConfiguration::OAIUpdateUserPoolClientRequest_AnalyticsConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateUserPoolClientRequest_AnalyticsConfiguration::OAIUpdateUserPoolClientRequest_AnalyticsConfiguration() {
    this->initializeModel();
}

OAIUpdateUserPoolClientRequest_AnalyticsConfiguration::~OAIUpdateUserPoolClientRequest_AnalyticsConfiguration() {}

void OAIUpdateUserPoolClientRequest_AnalyticsConfiguration::initializeModel() {
...
void OAIUpdateUserPoolClientRequest_AnalyticsConfiguration::fromJson(QString jsonString) {
...
void OAIUpdateUserPoolClientRequest_AnalyticsConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateUserPoolClientRequest_AnalyticsConfiguration::asJson() const {
...
QJsonObject OAIUpdateUserPoolClientRequest_AnalyticsConfiguration::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateUserPoolClientRequest_AnalyticsConfiguration::getApplicationId() const {
    return m_application_id;
}
void OAIUpdateUserPoolClientRequest_AnalyticsConfiguration::setApplicationId(const QString &application_id) {
    m_application_id = application_id;
    m_application_id_isSet = true;
}

bool OAIUpdateUserPoolClientRequest_AnalyticsConfiguration::is_application_id_Set() const{
    return m_application_id_isSet;
}

bool OAIUpdateUserPoolClientRequest_AnalyticsConfiguration::is_application_id_Valid() const{
    return m_application_id_isValid;
}

QString OAIUpdateUserPoolClientRequest_AnalyticsConfiguration::getApplicationArn() const {
    return m_application_arn;
}
void OAIUpdateUserPoolClientRequest_AnalyticsConfiguration::setApplicationArn(const QString &application_arn) {
    m_application_arn = application_arn;
    m_application_arn_isSet = true;
}

bool OAIUpdateUserPoolClientRequest_AnalyticsConfiguration::is_application_arn_Set() const{
    return m_application_arn_isSet;
}

bool OAIUpdateUserPoolClientRequest_AnalyticsConfiguration::is_application_arn_Valid() const{
    return m_application_arn_isValid;
}

QString OAIUpdateUserPoolClientRequest_AnalyticsConfiguration::getRoleArn() const {
    return m_role_arn;
}
void OAIUpdateUserPoolClientRequest_AnalyticsConfiguration::setRoleArn(const QString &role_arn) {
    m_role_arn = role_arn;
    m_role_arn_isSet = true;
}

bool OAIUpdateUserPoolClientRequest_AnalyticsConfiguration::is_role_arn_Set() const{
    return m_role_arn_isSet;
}

bool OAIUpdateUserPoolClientRequest_AnalyticsConfiguration::is_role_arn_Valid() const{
    return m_role_arn_isValid;
}

QString OAIUpdateUserPoolClientRequest_AnalyticsConfiguration::getExternalId() const {
    return m_external_id;
}
void OAIUpdateUserPoolClientRequest_AnalyticsConfiguration::setExternalId(const QString &external_id) {
    m_external_id = external_id;
    m_external_id_isSet = true;
}

bool OAIUpdateUserPoolClientRequest_AnalyticsConfiguration::is_external_id_Set() const{
    return m_external_id_isSet;
}

bool OAIUpdateUserPoolClientRequest_AnalyticsConfiguration::is_external_id_Valid() const{
    return m_external_id_isValid;
}

bool OAIUpdateUserPoolClientRequest_AnalyticsConfiguration::getUserDataShared() const {
    return m_user_data_shared;
}
void OAIUpdateUserPoolClientRequest_AnalyticsConfiguration::setUserDataShared(const bool &user_data_shared) {
    m_user_data_shared = user_data_shared;
    m_user_data_shared_isSet = true;
}

bool OAIUpdateUserPoolClientRequest_AnalyticsConfiguration::is_user_data_shared_Set() const{
    return m_user_data_shared_isSet;
}

bool OAIUpdateUserPoolClientRequest_AnalyticsConfiguration::is_user_data_shared_Valid() const{
    return m_user_data_shared_isValid;
}

bool OAIUpdateUserPoolClientRequest_AnalyticsConfiguration::isSet() const {
...
bool OAIUpdateUserPoolClientRequest_AnalyticsConfiguration::isValid() const {
