...
/*
 * OAIStopUserImportJobRequest.h
 *
 * Represents the request to stop the user import job.
 */

#ifndef OAIStopUserImportJobRequest_H
#define OAIStopUserImportJobRequest_H
...
class OAIStopUserImportJobRequest : public OAIObject {
public:
    OAIStopUserImportJobRequest();
    OAIStopUserImportJobRequest(QString json);
    ~OAIStopUserImportJobRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStopUserImportJobRequest)

#endif // OAIStopUserImportJobRequest_H
