...
#include "OAISetRiskConfigurationRequest_AccountTakeoverRiskConfiguration.h"
...
OAISetRiskConfigurationRequest_AccountTakeoverRiskConfiguration::OAISetRiskConfigurationRequest_AccountTakeoverRiskConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISetRiskConfigurationRequest_AccountTakeoverRiskConfiguration::OAISetRiskConfigurationRequest_AccountTakeoverRiskConfiguration() {
    this->initializeModel();
}

OAISetRiskConfigurationRequest_AccountTakeoverRiskConfiguration::~OAISetRiskConfigurationRequest_AccountTakeoverRiskConfiguration() {}

void OAISetRiskConfigurationRequest_AccountTakeoverRiskConfiguration::initializeModel() {

    m_notify_configuration_isSet = false;
    m_notify_configuration_isValid = false;

    m_actions_isSet = false;
    m_actions_isValid = false;
}

void OAISetRiskConfigurationRequest_AccountTakeoverRiskConfiguration::fromJson(QString jsonString) {
...
void OAISetRiskConfigurationRequest_AccountTakeoverRiskConfiguration::fromJsonObject(QJsonObject json) {

    m_notify_configuration_isValid = ::OpenAPI::fromJsonValue(m_notify_configuration, json[QString("NotifyConfiguration")]);
    m_notify_configuration_isSet = !json[QString("NotifyConfiguration")].isNull() && m_notify_configuration_isValid;

    m_actions_isValid = ::OpenAPI::fromJsonValue(m_actions, json[QString("Actions")]);
    m_actions_isSet = !json[QString("Actions")].isNull() && m_actions_isValid;
}

QString OAISetRiskConfigurationRequest_AccountTakeoverRiskConfiguration::asJson() const {
...
QJsonObject OAISetRiskConfigurationRequest_AccountTakeoverRiskConfiguration::asJsonObject() const {
    QJsonObject obj;
    if (m_notify_configuration.isSet()) {
        obj.insert(QString("NotifyConfiguration"), ::OpenAPI::toJsonValue(m_notify_configuration));
    }
    if (m_actions.isSet()) {
...
OAIAccountTakeoverRiskConfigurationType_NotifyConfiguration OAISetRiskConfigurationRequest_AccountTakeoverRiskConfiguration::getNotifyConfiguration() const {
    return m_notify_configuration;
}
void OAISetRiskConfigurationRequest_AccountTakeoverRiskConfiguration::setNotifyConfiguration(const OAIAccountTakeoverRiskConfigurationType_NotifyConfiguration &notify_configuration) {
    m_notify_configuration = notify_configuration;
    m_notify_configuration_isSet = true;
}

bool OAISetRiskConfigurationRequest_AccountTakeoverRiskConfiguration::is_notify_configuration_Set() const{
    return m_notify_configuration_isSet;
}

bool OAISetRiskConfigurationRequest_AccountTakeoverRiskConfiguration::is_notify_configuration_Valid() const{
    return m_notify_configuration_isValid;
}

OAIAccountTakeoverRiskConfigurationType_Actions OAISetRiskConfigurationRequest_AccountTakeoverRiskConfiguration::getActions() const {
    return m_actions;
}
void OAISetRiskConfigurationRequest_AccountTakeoverRiskConfiguration::setActions(const OAIAccountTakeoverRiskConfigurationType_Actions &actions) {
    m_actions = actions;
    m_actions_isSet = true;
}

bool OAISetRiskConfigurationRequest_AccountTakeoverRiskConfiguration::is_actions_Set() const{
    return m_actions_isSet;
}

bool OAISetRiskConfigurationRequest_AccountTakeoverRiskConfiguration::is_actions_Valid() const{
    return m_actions_isValid;
}

bool OAISetRiskConfigurationRequest_AccountTakeoverRiskConfiguration::isSet() const {
...
bool OAISetRiskConfigurationRequest_AccountTakeoverRiskConfiguration::isValid() const {
