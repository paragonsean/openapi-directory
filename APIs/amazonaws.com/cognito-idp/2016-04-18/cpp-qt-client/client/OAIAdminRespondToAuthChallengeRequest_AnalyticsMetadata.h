...
/*
 * OAIAdminRespondToAuthChallengeRequest_AnalyticsMetadata.h
 *
 * 
 */

#ifndef OAIAdminRespondToAuthChallengeRequest_AnalyticsMetadata_H
#define OAIAdminRespondToAuthChallengeRequest_AnalyticsMetadata_H
...
class OAIAdminRespondToAuthChallengeRequest_AnalyticsMetadata : public OAIObject {
public:
    OAIAdminRespondToAuthChallengeRequest_AnalyticsMetadata();
    OAIAdminRespondToAuthChallengeRequest_AnalyticsMetadata(QString json);
    ~OAIAdminRespondToAuthChallengeRequest_AnalyticsMetadata() override;
    ...
    QString getAnalyticsEndpointId() const;
    void setAnalyticsEndpointId(const QString &analytics_endpoint_id);
    bool is_analytics_endpoint_id_Set() const;
    bool is_analytics_endpoint_id_Valid() const;
...
private:
    ...
    QString m_analytics_endpoint_id;
    bool m_analytics_endpoint_id_isSet;
    bool m_analytics_endpoint_id_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIAdminRespondToAuthChallengeRequest_AnalyticsMetadata)

#endif // OAIAdminRespondToAuthChallengeRequest_AnalyticsMetadata_H
