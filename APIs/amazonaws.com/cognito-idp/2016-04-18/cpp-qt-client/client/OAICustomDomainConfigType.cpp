...
#include "OAICustomDomainConfigType.h"
...
OAICustomDomainConfigType::OAICustomDomainConfigType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICustomDomainConfigType::OAICustomDomainConfigType() {
    this->initializeModel();
}

OAICustomDomainConfigType::~OAICustomDomainConfigType() {}

void OAICustomDomainConfigType::initializeModel() {

    m_certificate_arn_isSet = false;
    m_certificate_arn_isValid = false;
}

void OAICustomDomainConfigType::fromJson(QString jsonString) {
...
void OAICustomDomainConfigType::fromJsonObject(QJsonObject json) {
...
QString OAICustomDomainConfigType::asJson() const {
...
QJsonObject OAICustomDomainConfigType::asJsonObject() const {
    QJsonObject obj;
...
QString OAICustomDomainConfigType::getCertificateArn() const {
    return m_certificate_arn;
}
void OAICustomDomainConfigType::setCertificateArn(const QString &certificate_arn) {
    m_certificate_arn = certificate_arn;
    m_certificate_arn_isSet = true;
}

bool OAICustomDomainConfigType::is_certificate_arn_Set() const{
    return m_certificate_arn_isSet;
}

bool OAICustomDomainConfigType::is_certificate_arn_Valid() const{
    return m_certificate_arn_isValid;
}

bool OAICustomDomainConfigType::isSet() const {
...
bool OAICustomDomainConfigType::isValid() const {
