...
/*
 * OAIStartUserImportJobRequest.h
 *
 * Represents the request to start the user import job.
 */

#ifndef OAIStartUserImportJobRequest_H
#define OAIStartUserImportJobRequest_H
...
class OAIStartUserImportJobRequest : public OAIObject {
public:
    OAIStartUserImportJobRequest();
    OAIStartUserImportJobRequest(QString json);
    ~OAIStartUserImportJobRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartUserImportJobRequest)

#endif // OAIStartUserImportJobRequest_H
