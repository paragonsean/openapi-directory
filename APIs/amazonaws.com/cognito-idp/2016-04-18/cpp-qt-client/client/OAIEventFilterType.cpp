...
OAIEventFilterType::OAIEventFilterType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEventFilterType::OAIEventFilterType() {
    this->initializeModel();
}

OAIEventFilterType::~OAIEventFilterType() {}

void OAIEventFilterType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIEventFilterType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIEventFilterType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("SIGN_IN", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEventFilterType::SIGN_IN;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("PASSWORD_CHANGE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEventFilterType::PASSWORD_CHANGE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("SIGN_UP", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEventFilterType::SIGN_UP;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIEventFilterType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIEventFilterType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIEventFilterType::SIGN_IN:
            val = "SIGN_IN";
            break;
        case eOAIEventFilterType::PASSWORD_CHANGE:
            val = "PASSWORD_CHANGE";
            break;
        case eOAIEventFilterType::SIGN_UP:
            val = "SIGN_UP";
            break;
        default:
            break;
...
QJsonValue OAIEventFilterType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIEventFilterType::eOAIEventFilterType OAIEventFilterType::getValue() const {
    return m_value;
}

void OAIEventFilterType::setValue(const OAIEventFilterType::eOAIEventFilterType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIEventFilterType::isSet() const {
    
    return m_value_isSet;
}

bool OAIEventFilterType::isValid() const {
