...
OAINotifyConfigurationType_NoActionEmail::OAINotifyConfigurationType_NoActionEmail(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINotifyConfigurationType_NoActionEmail::OAINotifyConfigurationType_NoActionEmail() {
    this->initializeModel();
}

OAINotifyConfigurationType_NoActionEmail::~OAINotifyConfigurationType_NoActionEmail() {}

void OAINotifyConfigurationType_NoActionEmail::initializeModel() {
...
void OAINotifyConfigurationType_NoActionEmail::fromJson(QString jsonString) {
...
void OAINotifyConfigurationType_NoActionEmail::fromJsonObject(QJsonObject json) {
...
QString OAINotifyConfigurationType_NoActionEmail::asJson() const {
...
QJsonObject OAINotifyConfigurationType_NoActionEmail::asJsonObject() const {
    QJsonObject obj;
    if (m_subject_isSet) {
...
QString OAINotifyConfigurationType_NoActionEmail::getSubject() const {
    return m_subject;
}
void OAINotifyConfigurationType_NoActionEmail::setSubject(const QString &subject) {
    m_subject = subject;
    m_subject_isSet = true;
}

bool OAINotifyConfigurationType_NoActionEmail::is_subject_Set() const{
    return m_subject_isSet;
}

bool OAINotifyConfigurationType_NoActionEmail::is_subject_Valid() const{
    return m_subject_isValid;
}

QString OAINotifyConfigurationType_NoActionEmail::getHtmlBody() const {
    return m_html_body;
}
void OAINotifyConfigurationType_NoActionEmail::setHtmlBody(const QString &html_body) {
    m_html_body = html_body;
    m_html_body_isSet = true;
}

bool OAINotifyConfigurationType_NoActionEmail::is_html_body_Set() const{
    return m_html_body_isSet;
}

bool OAINotifyConfigurationType_NoActionEmail::is_html_body_Valid() const{
    return m_html_body_isValid;
}

QString OAINotifyConfigurationType_NoActionEmail::getTextBody() const {
    return m_text_body;
}
void OAINotifyConfigurationType_NoActionEmail::setTextBody(const QString &text_body) {
    m_text_body = text_body;
    m_text_body_isSet = true;
}

bool OAINotifyConfigurationType_NoActionEmail::is_text_body_Set() const{
    return m_text_body_isSet;
}

bool OAINotifyConfigurationType_NoActionEmail::is_text_body_Valid() const{
    return m_text_body_isValid;
}

bool OAINotifyConfigurationType_NoActionEmail::isSet() const {
...
bool OAINotifyConfigurationType_NoActionEmail::isValid() const {
