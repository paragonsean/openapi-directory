...
OAISignUpRequest::OAISignUpRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISignUpRequest::OAISignUpRequest() {
    this->initializeModel();
}

OAISignUpRequest::~OAISignUpRequest() {}

void OAISignUpRequest::initializeModel() {
...
void OAISignUpRequest::fromJson(QString jsonString) {
...
void OAISignUpRequest::fromJsonObject(QJsonObject json) {
...
QString OAISignUpRequest::asJson() const {
...
QJsonObject OAISignUpRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAISignUpRequest::getClientId() const {
    return m_client_id;
}
void OAISignUpRequest::setClientId(const QString &client_id) {
    m_client_id = client_id;
    m_client_id_isSet = true;
}

bool OAISignUpRequest::is_client_id_Set() const{
    return m_client_id_isSet;
}

bool OAISignUpRequest::is_client_id_Valid() const{
    return m_client_id_isValid;
}

QString OAISignUpRequest::getSecretHash() const {
    return m_secret_hash;
}
void OAISignUpRequest::setSecretHash(const QString &secret_hash) {
    m_secret_hash = secret_hash;
    m_secret_hash_isSet = true;
}

bool OAISignUpRequest::is_secret_hash_Set() const{
    return m_secret_hash_isSet;
}

bool OAISignUpRequest::is_secret_hash_Valid() const{
    return m_secret_hash_isValid;
}

QString OAISignUpRequest::getUsername() const {
    return m_username;
}
void OAISignUpRequest::setUsername(const QString &username) {
    m_username = username;
    m_username_isSet = true;
}

bool OAISignUpRequest::is_username_Set() const{
    return m_username_isSet;
}

bool OAISignUpRequest::is_username_Valid() const{
    return m_username_isValid;
}

QString OAISignUpRequest::getPassword() const {
    return m_password;
}
void OAISignUpRequest::setPassword(const QString &password) {
    m_password = password;
    m_password_isSet = true;
}

bool OAISignUpRequest::is_password_Set() const{
    return m_password_isSet;
}

bool OAISignUpRequest::is_password_Valid() const{
    return m_password_isValid;
}

QList OAISignUpRequest::getUserAttributes() const {
    return m_user_attributes;
}
void OAISignUpRequest::setUserAttributes(const QList &user_attributes) {
    m_user_attributes = user_attributes;
    m_user_attributes_isSet = true;
}

bool OAISignUpRequest::is_user_attributes_Set() const{
    return m_user_attributes_isSet;
}

bool OAISignUpRequest::is_user_attributes_Valid() const{
    return m_user_attributes_isValid;
}

QList OAISignUpRequest::getValidationData() const {
    return m_validation_data;
}
void OAISignUpRequest::setValidationData(const QList &validation_data) {
    m_validation_data = validation_data;
    m_validation_data_isSet = true;
}

bool OAISignUpRequest::is_validation_data_Set() const{
    return m_validation_data_isSet;
}

bool OAISignUpRequest::is_validation_data_Valid() const{
    return m_validation_data_isValid;
}

OAISignUpRequest_AnalyticsMetadata OAISignUpRequest::getAnalyticsMetadata() const {
    return m_analytics_metadata;
}
void OAISignUpRequest::setAnalyticsMetadata(const OAISignUpRequest_AnalyticsMetadata &analytics_metadata) {
    m_analytics_metadata = analytics_metadata;
    m_analytics_metadata_isSet = true;
}

bool OAISignUpRequest::is_analytics_metadata_Set() const{
    return m_analytics_metadata_isSet;
}

bool OAISignUpRequest::is_analytics_metadata_Valid() const{
    return m_analytics_metadata_isValid;
}

OAIConfirmForgotPasswordRequest_UserContextData OAISignUpRequest::getUserContextData() const {
    return m_user_context_data;
}
void OAISignUpRequest::setUserContextData(const OAIConfirmForgotPasswordRequest_UserContextData &user_context_data) {
    m_user_context_data = user_context_data;
    m_user_context_data_isSet = true;
}

bool OAISignUpRequest::is_user_context_data_Set() const{
    return m_user_context_data_isSet;
}

bool OAISignUpRequest::is_user_context_data_Valid() const{
    return m_user_context_data_isValid;
}

QMap OAISignUpRequest::getClientMetadata() const {
    return m_client_metadata;
}
void OAISignUpRequest::setClientMetadata(const QMap &client_metadata) {
    m_client_metadata = client_metadata;
    m_client_metadata_isSet = true;
}

bool OAISignUpRequest::is_client_metadata_Set() const{
    return m_client_metadata_isSet;
}

bool OAISignUpRequest::is_client_metadata_Valid() const{
    return m_client_metadata_isValid;
}

bool OAISignUpRequest::isSet() const {
...
bool OAISignUpRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_client_id_isValid && m_username_isValid && m_password_isValid && true;
}
