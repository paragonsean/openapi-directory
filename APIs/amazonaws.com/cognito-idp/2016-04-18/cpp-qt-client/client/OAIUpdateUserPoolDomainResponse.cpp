...
OAIUpdateUserPoolDomainResponse::OAIUpdateUserPoolDomainResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateUserPoolDomainResponse::OAIUpdateUserPoolDomainResponse() {
    this->initializeModel();
}

OAIUpdateUserPoolDomainResponse::~OAIUpdateUserPoolDomainResponse() {}

void OAIUpdateUserPoolDomainResponse::initializeModel() {

    m_cloud_front_domain_isSet = false;
    m_cloud_front_domain_isValid = false;
}

void OAIUpdateUserPoolDomainResponse::fromJson(QString jsonString) {
...
void OAIUpdateUserPoolDomainResponse::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateUserPoolDomainResponse::asJson() const {
...
QJsonObject OAIUpdateUserPoolDomainResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateUserPoolDomainResponse::getCloudFrontDomain() const {
    return m_cloud_front_domain;
}
void OAIUpdateUserPoolDomainResponse::setCloudFrontDomain(const QString &cloud_front_domain) {
    m_cloud_front_domain = cloud_front_domain;
    m_cloud_front_domain_isSet = true;
}

bool OAIUpdateUserPoolDomainResponse::is_cloud_front_domain_Set() const{
    return m_cloud_front_domain_isSet;
}

bool OAIUpdateUserPoolDomainResponse::is_cloud_front_domain_Valid() const{
    return m_cloud_front_domain_isValid;
}

bool OAIUpdateUserPoolDomainResponse::isSet() const {
...
bool OAIUpdateUserPoolDomainResponse::isValid() const {
