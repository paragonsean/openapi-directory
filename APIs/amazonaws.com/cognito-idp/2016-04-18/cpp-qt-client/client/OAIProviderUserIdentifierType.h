...
/*
 * OAIProviderUserIdentifierType.h
 *
 * A container for information about an IdP for a user pool.
 */

#ifndef OAIProviderUserIdentifierType_H
#define OAIProviderUserIdentifierType_H
...
class OAIProviderUserIdentifierType : public OAIObject {
public:
    OAIProviderUserIdentifierType();
    OAIProviderUserIdentifierType(QString json);
    ~OAIProviderUserIdentifierType() override;
    ...
    QString getProviderAttributeName() const;
    void setProviderAttributeName(const QString &provider_attribute_name);
    bool is_provider_attribute_name_Set() const;
    bool is_provider_attribute_name_Valid() const;

    QString getProviderAttributeValue() const;
    void setProviderAttributeValue(const QString &provider_attribute_value);
    bool is_provider_attribute_value_Set() const;
    bool is_provider_attribute_value_Valid() const;
...
private:
    ...
    QString m_provider_attribute_name;
    bool m_provider_attribute_name_isSet;
    bool m_provider_attribute_name_isValid;

    QString m_provider_attribute_value;
    bool m_provider_attribute_value_isSet;
    bool m_provider_attribute_value_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIProviderUserIdentifierType)

#endif // OAIProviderUserIdentifierType_H
