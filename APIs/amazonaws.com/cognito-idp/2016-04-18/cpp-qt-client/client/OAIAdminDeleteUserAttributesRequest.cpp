...
OAIAdminDeleteUserAttributesRequest::OAIAdminDeleteUserAttributesRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdminDeleteUserAttributesRequest::OAIAdminDeleteUserAttributesRequest() {
    this->initializeModel();
}

OAIAdminDeleteUserAttributesRequest::~OAIAdminDeleteUserAttributesRequest() {}

void OAIAdminDeleteUserAttributesRequest::initializeModel() {
...
void OAIAdminDeleteUserAttributesRequest::fromJson(QString jsonString) {
...
void OAIAdminDeleteUserAttributesRequest::fromJsonObject(QJsonObject json) {
...
QString OAIAdminDeleteUserAttributesRequest::asJson() const {
...
QJsonObject OAIAdminDeleteUserAttributesRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAdminDeleteUserAttributesRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIAdminDeleteUserAttributesRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIAdminDeleteUserAttributesRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIAdminDeleteUserAttributesRequest::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

QString OAIAdminDeleteUserAttributesRequest::getUsername() const {
    return m_username;
}
void OAIAdminDeleteUserAttributesRequest::setUsername(const QString &username) {
    m_username = username;
    m_username_isSet = true;
}

bool OAIAdminDeleteUserAttributesRequest::is_username_Set() const{
    return m_username_isSet;
}

bool OAIAdminDeleteUserAttributesRequest::is_username_Valid() const{
    return m_username_isValid;
}

QList OAIAdminDeleteUserAttributesRequest::getUserAttributeNames() const {
    return m_user_attribute_names;
}
void OAIAdminDeleteUserAttributesRequest::setUserAttributeNames(const QList &user_attribute_names) {
    m_user_attribute_names = user_attribute_names;
    m_user_attribute_names_isSet = true;
}

bool OAIAdminDeleteUserAttributesRequest::is_user_attribute_names_Set() const{
    return m_user_attribute_names_isSet;
}

bool OAIAdminDeleteUserAttributesRequest::is_user_attribute_names_Valid() const{
    return m_user_attribute_names_isValid;
}

bool OAIAdminDeleteUserAttributesRequest::isSet() const {
...
bool OAIAdminDeleteUserAttributesRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_user_pool_id_isValid && m_username_isValid && m_user_attribute_names_isValid && true;
}
