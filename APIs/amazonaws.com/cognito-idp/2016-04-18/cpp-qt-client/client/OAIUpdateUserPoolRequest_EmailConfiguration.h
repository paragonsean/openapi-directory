...
/*
 * OAIUpdateUserPoolRequest_EmailConfiguration.h
 *
 * 
 */

#ifndef OAIUpdateUserPoolRequest_EmailConfiguration_H
#define OAIUpdateUserPoolRequest_EmailConfiguration_H
...
class OAIUpdateUserPoolRequest_EmailConfiguration : public OAIObject {
public:
    OAIUpdateUserPoolRequest_EmailConfiguration();
    OAIUpdateUserPoolRequest_EmailConfiguration(QString json);
    ~OAIUpdateUserPoolRequest_EmailConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateUserPoolRequest_EmailConfiguration)

#endif // OAIUpdateUserPoolRequest_EmailConfiguration_H
