...
/*
 * OAIUpdateUserPoolDomainRequest.h
 *
 * The UpdateUserPoolDomain request input.
 */

#ifndef OAIUpdateUserPoolDomainRequest_H
#define OAIUpdateUserPoolDomainRequest_H

#include <QJsonObject>

#include "OAIUpdateUserPoolDomainRequest_CustomDomainConfig.h"
#include <QString>
...
namespace OpenAPI {
class OAIUpdateUserPoolDomainRequest_CustomDomainConfig;

class OAIUpdateUserPoolDomainRequest : public OAIObject {
public:
    OAIUpdateUserPoolDomainRequest();
    OAIUpdateUserPoolDomainRequest(QString json);
    ~OAIUpdateUserPoolDomainRequest() override;
    ...
    OAIUpdateUserPoolDomainRequest_CustomDomainConfig getCustomDomainConfig() const;
    void setCustomDomainConfig(const OAIUpdateUserPoolDomainRequest_CustomDomainConfig &custom_domain_config);
    bool is_custom_domain_config_Set() const;
    bool is_custom_domain_config_Valid() const;
...
private:
    ...
    OAIUpdateUserPoolDomainRequest_CustomDomainConfig m_custom_domain_config;
    bool m_custom_domain_config_isSet;
    bool m_custom_domain_config_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIUpdateUserPoolDomainRequest)

#endif // OAIUpdateUserPoolDomainRequest_H
