...
OAIDescribeRiskConfigurationResponse::OAIDescribeRiskConfigurationResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeRiskConfigurationResponse::OAIDescribeRiskConfigurationResponse() {
    this->initializeModel();
}

OAIDescribeRiskConfigurationResponse::~OAIDescribeRiskConfigurationResponse() {}

void OAIDescribeRiskConfigurationResponse::initializeModel() {

    m_risk_configuration_isSet = false;
    m_risk_configuration_isValid = false;
}

void OAIDescribeRiskConfigurationResponse::fromJson(QString jsonString) {
...
void OAIDescribeRiskConfigurationResponse::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeRiskConfigurationResponse::asJson() const {
...
QJsonObject OAIDescribeRiskConfigurationResponse::asJsonObject() const {
    QJsonObject obj;
...
OAIDescribeRiskConfigurationResponse_RiskConfiguration OAIDescribeRiskConfigurationResponse::getRiskConfiguration() const {
    return m_risk_configuration;
}
void OAIDescribeRiskConfigurationResponse::setRiskConfiguration(const OAIDescribeRiskConfigurationResponse_RiskConfiguration &risk_configuration) {
    m_risk_configuration = risk_configuration;
    m_risk_configuration_isSet = true;
}

bool OAIDescribeRiskConfigurationResponse::is_risk_configuration_Set() const{
    return m_risk_configuration_isSet;
}

bool OAIDescribeRiskConfigurationResponse::is_risk_configuration_Valid() const{
    return m_risk_configuration_isValid;
}

bool OAIDescribeRiskConfigurationResponse::isSet() const {
...
bool OAIDescribeRiskConfigurationResponse::isValid() const {
