...
OAIUpdateIdentityProviderResponse::OAIUpdateIdentityProviderResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateIdentityProviderResponse::OAIUpdateIdentityProviderResponse() {
    this->initializeModel();
}

OAIUpdateIdentityProviderResponse::~OAIUpdateIdentityProviderResponse() {}

void OAIUpdateIdentityProviderResponse::initializeModel() {

    m_identity_provider_isSet = false;
    m_identity_provider_isValid = false;
}

void OAIUpdateIdentityProviderResponse::fromJson(QString jsonString) {
...
void OAIUpdateIdentityProviderResponse::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateIdentityProviderResponse::asJson() const {
...
QJsonObject OAIUpdateIdentityProviderResponse::asJsonObject() const {
    QJsonObject obj;
...
OAIDescribeIdentityProviderResponse_IdentityProvider OAIUpdateIdentityProviderResponse::getIdentityProvider() const {
    return m_identity_provider;
}
void OAIUpdateIdentityProviderResponse::setIdentityProvider(const OAIDescribeIdentityProviderResponse_IdentityProvider &identity_provider) {
    m_identity_provider = identity_provider;
    m_identity_provider_isSet = true;
}

bool OAIUpdateIdentityProviderResponse::is_identity_provider_Set() const{
    return m_identity_provider_isSet;
}

bool OAIUpdateIdentityProviderResponse::is_identity_provider_Valid() const{
    return m_identity_provider_isValid;
}

bool OAIUpdateIdentityProviderResponse::isSet() const {
...
bool OAIUpdateIdentityProviderResponse::isValid() const {
