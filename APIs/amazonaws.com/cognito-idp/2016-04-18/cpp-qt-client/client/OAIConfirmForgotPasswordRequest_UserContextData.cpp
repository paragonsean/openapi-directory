...
OAIConfirmForgotPasswordRequest_UserContextData::OAIConfirmForgotPasswordRequest_UserContextData(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIConfirmForgotPasswordRequest_UserContextData::OAIConfirmForgotPasswordRequest_UserContextData() {
    this->initializeModel();
}

OAIConfirmForgotPasswordRequest_UserContextData::~OAIConfirmForgotPasswordRequest_UserContextData() {}

void OAIConfirmForgotPasswordRequest_UserContextData::initializeModel() {
...
void OAIConfirmForgotPasswordRequest_UserContextData::fromJson(QString jsonString) {
...
void OAIConfirmForgotPasswordRequest_UserContextData::fromJsonObject(QJsonObject json) {
...
QString OAIConfirmForgotPasswordRequest_UserContextData::asJson() const {
...
QJsonObject OAIConfirmForgotPasswordRequest_UserContextData::asJsonObject() const {
    QJsonObject obj;
...
QString OAIConfirmForgotPasswordRequest_UserContextData::getIpAddress() const {
    return m_ip_address;
}
void OAIConfirmForgotPasswordRequest_UserContextData::setIpAddress(const QString &ip_address) {
    m_ip_address = ip_address;
    m_ip_address_isSet = true;
}

bool OAIConfirmForgotPasswordRequest_UserContextData::is_ip_address_Set() const{
    return m_ip_address_isSet;
}

bool OAIConfirmForgotPasswordRequest_UserContextData::is_ip_address_Valid() const{
    return m_ip_address_isValid;
}

QString OAIConfirmForgotPasswordRequest_UserContextData::getEncodedData() const {
    return m_encoded_data;
}
void OAIConfirmForgotPasswordRequest_UserContextData::setEncodedData(const QString &encoded_data) {
    m_encoded_data = encoded_data;
    m_encoded_data_isSet = true;
}

bool OAIConfirmForgotPasswordRequest_UserContextData::is_encoded_data_Set() const{
    return m_encoded_data_isSet;
}

bool OAIConfirmForgotPasswordRequest_UserContextData::is_encoded_data_Valid() const{
    return m_encoded_data_isValid;
}

bool OAIConfirmForgotPasswordRequest_UserContextData::isSet() const {
...
bool OAIConfirmForgotPasswordRequest_UserContextData::isValid() const {
