...
#include "OAITokenValidityUnitsType.h"
...
OAITokenValidityUnitsType::OAITokenValidityUnitsType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITokenValidityUnitsType::OAITokenValidityUnitsType() {
    this->initializeModel();
}

OAITokenValidityUnitsType::~OAITokenValidityUnitsType() {}

void OAITokenValidityUnitsType::initializeModel() {
...
void OAITokenValidityUnitsType::fromJson(QString jsonString) {
...
void OAITokenValidityUnitsType::fromJsonObject(QJsonObject json) {
...
QString OAITokenValidityUnitsType::asJson() const {
...
QJsonObject OAITokenValidityUnitsType::asJsonObject() const {
    QJsonObject obj;
...
OAITimeUnitsType OAITokenValidityUnitsType::getAccessToken() const {
    return m_access_token;
}
void OAITokenValidityUnitsType::setAccessToken(const OAITimeUnitsType &access_token) {
    m_access_token = access_token;
    m_access_token_isSet = true;
}

bool OAITokenValidityUnitsType::is_access_token_Set() const{
    return m_access_token_isSet;
}

bool OAITokenValidityUnitsType::is_access_token_Valid() const{
    return m_access_token_isValid;
}

OAITimeUnitsType OAITokenValidityUnitsType::getIdToken() const {
    return m_id_token;
}
void OAITokenValidityUnitsType::setIdToken(const OAITimeUnitsType &id_token) {
    m_id_token = id_token;
    m_id_token_isSet = true;
}

bool OAITokenValidityUnitsType::is_id_token_Set() const{
    return m_id_token_isSet;
}

bool OAITokenValidityUnitsType::is_id_token_Valid() const{
    return m_id_token_isValid;
}

OAITimeUnitsType OAITokenValidityUnitsType::getRefreshToken() const {
    return m_refresh_token;
}
void OAITokenValidityUnitsType::setRefreshToken(const OAITimeUnitsType &refresh_token) {
    m_refresh_token = refresh_token;
    m_refresh_token_isSet = true;
}

bool OAITokenValidityUnitsType::is_refresh_token_Set() const{
    return m_refresh_token_isSet;
}

bool OAITokenValidityUnitsType::is_refresh_token_Valid() const{
    return m_refresh_token_isValid;
}

bool OAITokenValidityUnitsType::isSet() const {
...
bool OAITokenValidityUnitsType::isValid() const {
