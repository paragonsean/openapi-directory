...
OAICustomEmailSenderLambdaVersionType::OAICustomEmailSenderLambdaVersionType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICustomEmailSenderLambdaVersionType::OAICustomEmailSenderLambdaVersionType() {
    this->initializeModel();
}

OAICustomEmailSenderLambdaVersionType::~OAICustomEmailSenderLambdaVersionType() {}

void OAICustomEmailSenderLambdaVersionType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAICustomEmailSenderLambdaVersionType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAICustomEmailSenderLambdaVersionType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("V1_0", Qt::CaseInsensitive) == 0) {
        m_value = eOAICustomEmailSenderLambdaVersionType::V1_0;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAICustomEmailSenderLambdaVersionType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAICustomEmailSenderLambdaVersionType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAICustomEmailSenderLambdaVersionType::V1_0:
            val = "V1_0";
            break;
        default:
            break;
...
QJsonValue OAICustomEmailSenderLambdaVersionType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAICustomEmailSenderLambdaVersionType::eOAICustomEmailSenderLambdaVersionType OAICustomEmailSenderLambdaVersionType::getValue() const {
    return m_value;
}

void OAICustomEmailSenderLambdaVersionType::setValue(const OAICustomEmailSenderLambdaVersionType::eOAICustomEmailSenderLambdaVersionType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAICustomEmailSenderLambdaVersionType::isSet() const {
    
    return m_value_isSet;
}

bool OAICustomEmailSenderLambdaVersionType::isValid() const {
