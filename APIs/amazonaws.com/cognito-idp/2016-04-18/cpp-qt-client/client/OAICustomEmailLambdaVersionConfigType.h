...
/*
 * OAICustomEmailLambdaVersionConfigType.h
 *
 * A custom email sender Lambda configuration type.
 */

#ifndef OAICustomEmailLambdaVersionConfigType_H
#define OAICustomEmailLambdaVersionConfigType_H

#include <QJsonObject>

#include "OAICustomEmailSenderLambdaVersionType.h"
#include <QString>
...
class OAICustomEmailLambdaVersionConfigType : public OAIObject {
public:
    OAICustomEmailLambdaVersionConfigType();
    OAICustomEmailLambdaVersionConfigType(QString json);
    ~OAICustomEmailLambdaVersionConfigType() override;
    ...
    OAICustomEmailSenderLambdaVersionType getLambdaVersion() const;
    void setLambdaVersion(const OAICustomEmailSenderLambdaVersionType &lambda_version);
    bool is_lambda_version_Set() const;
    bool is_lambda_version_Valid() const;
...
private:
    ...
    OAICustomEmailSenderLambdaVersionType m_lambda_version;
    bool m_lambda_version_isSet;
    bool m_lambda_version_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomEmailLambdaVersionConfigType)

#endif // OAICustomEmailLambdaVersionConfigType_H
