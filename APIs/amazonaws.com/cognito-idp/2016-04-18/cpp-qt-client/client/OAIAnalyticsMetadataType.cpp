...
#include "OAIAnalyticsMetadataType.h"
...
OAIAnalyticsMetadataType::OAIAnalyticsMetadataType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAnalyticsMetadataType::OAIAnalyticsMetadataType() {
    this->initializeModel();
}

OAIAnalyticsMetadataType::~OAIAnalyticsMetadataType() {}

void OAIAnalyticsMetadataType::initializeModel() {

    m_analytics_endpoint_id_isSet = false;
    m_analytics_endpoint_id_isValid = false;
}

void OAIAnalyticsMetadataType::fromJson(QString jsonString) {
...
void OAIAnalyticsMetadataType::fromJsonObject(QJsonObject json) {
...
QString OAIAnalyticsMetadataType::asJson() const {
...
QJsonObject OAIAnalyticsMetadataType::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAnalyticsMetadataType::getAnalyticsEndpointId() const {
    return m_analytics_endpoint_id;
}
void OAIAnalyticsMetadataType::setAnalyticsEndpointId(const QString &analytics_endpoint_id) {
    m_analytics_endpoint_id = analytics_endpoint_id;
    m_analytics_endpoint_id_isSet = true;
}

bool OAIAnalyticsMetadataType::is_analytics_endpoint_id_Set() const{
    return m_analytics_endpoint_id_isSet;
}

bool OAIAnalyticsMetadataType::is_analytics_endpoint_id_Valid() const{
    return m_analytics_endpoint_id_isValid;
}

bool OAIAnalyticsMetadataType::isSet() const {
...
bool OAIAnalyticsMetadataType::isValid() const {
