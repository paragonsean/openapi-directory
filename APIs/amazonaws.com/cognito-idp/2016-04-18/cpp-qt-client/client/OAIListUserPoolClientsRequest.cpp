...
OAIListUserPoolClientsRequest::OAIListUserPoolClientsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListUserPoolClientsRequest::OAIListUserPoolClientsRequest() {
    this->initializeModel();
}

OAIListUserPoolClientsRequest::~OAIListUserPoolClientsRequest() {}

void OAIListUserPoolClientsRequest::initializeModel() {
...
void OAIListUserPoolClientsRequest::fromJson(QString jsonString) {
...
void OAIListUserPoolClientsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListUserPoolClientsRequest::asJson() const {
...
QJsonObject OAIListUserPoolClientsRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListUserPoolClientsRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIListUserPoolClientsRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIListUserPoolClientsRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIListUserPoolClientsRequest::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

qint32 OAIListUserPoolClientsRequest::getMaxResults() const {
    return m_max_results;
}
void OAIListUserPoolClientsRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListUserPoolClientsRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListUserPoolClientsRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIListUserPoolClientsRequest::getNextToken() const {
    return m_next_token;
}
void OAIListUserPoolClientsRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListUserPoolClientsRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListUserPoolClientsRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListUserPoolClientsRequest::isSet() const {
...
bool OAIListUserPoolClientsRequest::isValid() const {
