...
/*
 * OAIMessageActionType.h
 *
 * 
 */

#ifndef OAIMessageActionType_H
#define OAIMessageActionType_H
...
class OAIMessageActionType : public OAIEnum {
public:
    OAIMessageActionType();
    OAIMessageActionType(QString json);
    ~OAIMessageActionType() override;
    ...
    enum class eOAIMessageActionType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        RESEND, 
        SUPPRESS
    };
    OAIMessageActionType::eOAIMessageActionType getValue() const;
    void setValue(const OAIMessageActionType::eOAIMessageActionType& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIMessageActionType)

#endif // OAIMessageActionType_H
