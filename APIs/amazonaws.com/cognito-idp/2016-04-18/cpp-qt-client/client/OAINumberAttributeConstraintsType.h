...
/*
 * OAINumberAttributeConstraintsType.h
 *
 * The minimum and maximum values of an attribute that is of the number data type.
 */

#ifndef OAINumberAttributeConstraintsType_H
#define OAINumberAttributeConstraintsType_H
...
class OAINumberAttributeConstraintsType : public OAIObject {
public:
    OAINumberAttributeConstraintsType();
    OAINumberAttributeConstraintsType(QString json);
    ~OAINumberAttributeConstraintsType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINumberAttributeConstraintsType)

#endif // OAINumberAttributeConstraintsType_H
