...
#include "OAINotifyConfigurationType.h"
...
OAINotifyConfigurationType::OAINotifyConfigurationType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINotifyConfigurationType::OAINotifyConfigurationType() {
    this->initializeModel();
}

OAINotifyConfigurationType::~OAINotifyConfigurationType() {}

void OAINotifyConfigurationType::initializeModel() {
...
void OAINotifyConfigurationType::fromJson(QString jsonString) {
...
void OAINotifyConfigurationType::fromJsonObject(QJsonObject json) {
...
QString OAINotifyConfigurationType::asJson() const {
...
QJsonObject OAINotifyConfigurationType::asJsonObject() const {
    QJsonObject obj;
    if (m_from_isSet) {
...
QString OAINotifyConfigurationType::getFrom() const {
    return m_from;
}
void OAINotifyConfigurationType::setFrom(const QString &from) {
    m_from = from;
    m_from_isSet = true;
}

bool OAINotifyConfigurationType::is_from_Set() const{
    return m_from_isSet;
}

bool OAINotifyConfigurationType::is_from_Valid() const{
    return m_from_isValid;
}

QString OAINotifyConfigurationType::getReplyTo() const {
    return m_reply_to;
}
void OAINotifyConfigurationType::setReplyTo(const QString &reply_to) {
    m_reply_to = reply_to;
    m_reply_to_isSet = true;
}

bool OAINotifyConfigurationType::is_reply_to_Set() const{
    return m_reply_to_isSet;
}

bool OAINotifyConfigurationType::is_reply_to_Valid() const{
    return m_reply_to_isValid;
}

QString OAINotifyConfigurationType::getSourceArn() const {
    return m_source_arn;
}
void OAINotifyConfigurationType::setSourceArn(const QString &source_arn) {
    m_source_arn = source_arn;
    m_source_arn_isSet = true;
}

bool OAINotifyConfigurationType::is_source_arn_Set() const{
    return m_source_arn_isSet;
}

bool OAINotifyConfigurationType::is_source_arn_Valid() const{
    return m_source_arn_isValid;
}

OAINotifyConfigurationType_BlockEmail OAINotifyConfigurationType::getBlockEmail() const {
    return m_block_email;
}
void OAINotifyConfigurationType::setBlockEmail(const OAINotifyConfigurationType_BlockEmail &block_email) {
    m_block_email = block_email;
    m_block_email_isSet = true;
}

bool OAINotifyConfigurationType::is_block_email_Set() const{
    return m_block_email_isSet;
}

bool OAINotifyConfigurationType::is_block_email_Valid() const{
    return m_block_email_isValid;
}

OAINotifyConfigurationType_NoActionEmail OAINotifyConfigurationType::getNoActionEmail() const {
    return m_no_action_email;
}
void OAINotifyConfigurationType::setNoActionEmail(const OAINotifyConfigurationType_NoActionEmail &no_action_email) {
    m_no_action_email = no_action_email;
    m_no_action_email_isSet = true;
}

bool OAINotifyConfigurationType::is_no_action_email_Set() const{
    return m_no_action_email_isSet;
}

bool OAINotifyConfigurationType::is_no_action_email_Valid() const{
    return m_no_action_email_isValid;
}

OAINotifyConfigurationType_MfaEmail OAINotifyConfigurationType::getMfaEmail() const {
    return m_mfa_email;
}
void OAINotifyConfigurationType::setMfaEmail(const OAINotifyConfigurationType_MfaEmail &mfa_email) {
    m_mfa_email = mfa_email;
    m_mfa_email_isSet = true;
}

bool OAINotifyConfigurationType::is_mfa_email_Set() const{
    return m_mfa_email_isSet;
}

bool OAINotifyConfigurationType::is_mfa_email_Valid() const{
    return m_mfa_email_isValid;
}

bool OAINotifyConfigurationType::isSet() const {
...
bool OAINotifyConfigurationType::isValid() const {
