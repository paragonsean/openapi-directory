...
/*
 * OAIEventContextDataType.h
 *
 * Specifies the user context data captured at the time of an event request.
 */

#ifndef OAIEventContextDataType_H
#define OAIEventContextDataType_H
...
class OAIEventContextDataType : public OAIObject {
public:
    OAIEventContextDataType();
    OAIEventContextDataType(QString json);
    ~OAIEventContextDataType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEventContextDataType)

#endif // OAIEventContextDataType_H
