...
/*
 * OAISetLogDeliveryConfigurationResponse_LogDeliveryConfiguration.h
 *
 * 
 */

#ifndef OAISetLogDeliveryConfigurationResponse_LogDeliveryConfiguration_H
#define OAISetLogDeliveryConfigurationResponse_LogDeliveryConfiguration_H
...
class OAISetLogDeliveryConfigurationResponse_LogDeliveryConfiguration : public OAIObject {
public:
    OAISetLogDeliveryConfigurationResponse_LogDeliveryConfiguration();
    OAISetLogDeliveryConfigurationResponse_LogDeliveryConfiguration(QString json);
    ~OAISetLogDeliveryConfigurationResponse_LogDeliveryConfiguration() override;
    ...
    QList getLogConfigurations() const;
    void setLogConfigurations(const QList &log_configurations);
    bool is_log_configurations_Set() const;
    bool is_log_configurations_Valid() const;
...
private:
    ...
    QList m_log_configurations;
    bool m_log_configurations_isSet;
    bool m_log_configurations_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAISetLogDeliveryConfigurationResponse_LogDeliveryConfiguration)

#endif // OAISetLogDeliveryConfigurationResponse_LogDeliveryConfiguration_H
