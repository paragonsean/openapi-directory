...
OAIUpdateDeviceStatusRequest::OAIUpdateDeviceStatusRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateDeviceStatusRequest::OAIUpdateDeviceStatusRequest() {
    this->initializeModel();
}

OAIUpdateDeviceStatusRequest::~OAIUpdateDeviceStatusRequest() {}

void OAIUpdateDeviceStatusRequest::initializeModel() {
...
void OAIUpdateDeviceStatusRequest::fromJson(QString jsonString) {
...
void OAIUpdateDeviceStatusRequest::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateDeviceStatusRequest::asJson() const {
...
QJsonObject OAIUpdateDeviceStatusRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateDeviceStatusRequest::getAccessToken() const {
    return m_access_token;
}
void OAIUpdateDeviceStatusRequest::setAccessToken(const QString &access_token) {
    m_access_token = access_token;
    m_access_token_isSet = true;
}

bool OAIUpdateDeviceStatusRequest::is_access_token_Set() const{
    return m_access_token_isSet;
}

bool OAIUpdateDeviceStatusRequest::is_access_token_Valid() const{
    return m_access_token_isValid;
}

QString OAIUpdateDeviceStatusRequest::getDeviceKey() const {
    return m_device_key;
}
void OAIUpdateDeviceStatusRequest::setDeviceKey(const QString &device_key) {
    m_device_key = device_key;
    m_device_key_isSet = true;
}

bool OAIUpdateDeviceStatusRequest::is_device_key_Set() const{
    return m_device_key_isSet;
}

bool OAIUpdateDeviceStatusRequest::is_device_key_Valid() const{
    return m_device_key_isValid;
}

OAIDeviceRememberedStatusType OAIUpdateDeviceStatusRequest::getDeviceRememberedStatus() const {
    return m_device_remembered_status;
}
void OAIUpdateDeviceStatusRequest::setDeviceRememberedStatus(const OAIDeviceRememberedStatusType &device_remembered_status) {
    m_device_remembered_status = device_remembered_status;
    m_device_remembered_status_isSet = true;
}

bool OAIUpdateDeviceStatusRequest::is_device_remembered_status_Set() const{
    return m_device_remembered_status_isSet;
}

bool OAIUpdateDeviceStatusRequest::is_device_remembered_status_Valid() const{
    return m_device_remembered_status_isValid;
}

bool OAIUpdateDeviceStatusRequest::isSet() const {
...
bool OAIUpdateDeviceStatusRequest::isValid() const {
