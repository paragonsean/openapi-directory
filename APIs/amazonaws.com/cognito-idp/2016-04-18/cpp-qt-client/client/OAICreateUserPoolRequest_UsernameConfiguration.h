...
/*
 * OAICreateUserPoolRequest_UsernameConfiguration.h
 *
 * 
 */

#ifndef OAICreateUserPoolRequest_UsernameConfiguration_H
#define OAICreateUserPoolRequest_UsernameConfiguration_H
...
class OAICreateUserPoolRequest_UsernameConfiguration : public OAIObject {
public:
    OAICreateUserPoolRequest_UsernameConfiguration();
    OAICreateUserPoolRequest_UsernameConfiguration(QString json);
    ~OAICreateUserPoolRequest_UsernameConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateUserPoolRequest_UsernameConfiguration)

#endif // OAICreateUserPoolRequest_UsernameConfiguration_H
