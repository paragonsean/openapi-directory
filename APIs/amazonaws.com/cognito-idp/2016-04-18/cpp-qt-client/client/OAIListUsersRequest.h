...
/*
 * OAIListUsersRequest.h
 *
 * Represents the request to list users.
 */

#ifndef OAIListUsersRequest_H
#define OAIListUsersRequest_H
...
class OAIListUsersRequest : public OAIObject {
public:
    OAIListUsersRequest();
    OAIListUsersRequest(QString json);
    ~OAIListUsersRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListUsersRequest)

#endif // OAIListUsersRequest_H
