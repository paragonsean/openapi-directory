...
OAIUserImportJobStatusType::OAIUserImportJobStatusType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUserImportJobStatusType::OAIUserImportJobStatusType() {
    this->initializeModel();
}

OAIUserImportJobStatusType::~OAIUserImportJobStatusType() {}

void OAIUserImportJobStatusType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIUserImportJobStatusType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIUserImportJobStatusType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("Created", Qt::CaseInsensitive) == 0) {
        m_value = eOAIUserImportJobStatusType::CREATED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Pending", Qt::CaseInsensitive) == 0) {
        m_value = eOAIUserImportJobStatusType::PENDING;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("InProgress", Qt::CaseInsensitive) == 0) {
        m_value = eOAIUserImportJobStatusType::INPROGRESS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Stopping", Qt::CaseInsensitive) == 0) {
        m_value = eOAIUserImportJobStatusType::STOPPING;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Expired", Qt::CaseInsensitive) == 0) {
        m_value = eOAIUserImportJobStatusType::EXPIRED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Stopped", Qt::CaseInsensitive) == 0) {
        m_value = eOAIUserImportJobStatusType::STOPPED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Failed", Qt::CaseInsensitive) == 0) {
        m_value = eOAIUserImportJobStatusType::FAILED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Succeeded", Qt::CaseInsensitive) == 0) {
        m_value = eOAIUserImportJobStatusType::SUCCEEDED;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIUserImportJobStatusType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIUserImportJobStatusType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIUserImportJobStatusType::CREATED:
            val = "Created";
            break;
        case eOAIUserImportJobStatusType::PENDING:
            val = "Pending";
            break;
        case eOAIUserImportJobStatusType::INPROGRESS:
            val = "InProgress";
            break;
        case eOAIUserImportJobStatusType::STOPPING:
            val = "Stopping";
            break;
        case eOAIUserImportJobStatusType::EXPIRED:
            val = "Expired";
            break;
        case eOAIUserImportJobStatusType::STOPPED:
            val = "Stopped";
            break;
        case eOAIUserImportJobStatusType::FAILED:
            val = "Failed";
            break;
        case eOAIUserImportJobStatusType::SUCCEEDED:
            val = "Succeeded";
            break;
        default:
            break;
...
QJsonValue OAIUserImportJobStatusType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIUserImportJobStatusType::eOAIUserImportJobStatusType OAIUserImportJobStatusType::getValue() const {
    return m_value;
}

void OAIUserImportJobStatusType::setValue(const OAIUserImportJobStatusType::eOAIUserImportJobStatusType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIUserImportJobStatusType::isSet() const {
    
    return m_value_isSet;
}

bool OAIUserImportJobStatusType::isValid() const {
