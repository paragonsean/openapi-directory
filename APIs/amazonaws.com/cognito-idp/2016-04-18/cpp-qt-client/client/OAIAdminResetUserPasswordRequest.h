...
/*
 * OAIAdminResetUserPasswordRequest.h
 *
 * Represents the request to reset a user&#39;s password as an administrator.
 */

#ifndef OAIAdminResetUserPasswordRequest_H
#define OAIAdminResetUserPasswordRequest_H
...
class OAIAdminResetUserPasswordRequest : public OAIObject {
public:
    OAIAdminResetUserPasswordRequest();
    OAIAdminResetUserPasswordRequest(QString json);
    ~OAIAdminResetUserPasswordRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdminResetUserPasswordRequest)

#endif // OAIAdminResetUserPasswordRequest_H
