...
#include "OAIChallengeResponseType.h"
...
OAIChallengeResponseType::OAIChallengeResponseType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIChallengeResponseType::OAIChallengeResponseType() {
    this->initializeModel();
}

OAIChallengeResponseType::~OAIChallengeResponseType() {}

void OAIChallengeResponseType::initializeModel() {
...
void OAIChallengeResponseType::fromJson(QString jsonString) {
...
void OAIChallengeResponseType::fromJsonObject(QJsonObject json) {
...
QString OAIChallengeResponseType::asJson() const {
...
QJsonObject OAIChallengeResponseType::asJsonObject() const {
    QJsonObject obj;
    if (m_challenge_name.isSet()) {
        obj.insert(QString("ChallengeName"), ::OpenAPI::toJsonValue(m_challenge_name));
    }
    if (m_challenge_response.isSet()) {
        obj.insert(QString("ChallengeResponse"), ::OpenAPI::toJsonValue(m_challenge_response));
    }
    return obj;
}

OAIChallengeName OAIChallengeResponseType::getChallengeName() const {
    return m_challenge_name;
}
void OAIChallengeResponseType::setChallengeName(const OAIChallengeName &challenge_name) {
    m_challenge_name = challenge_name;
    m_challenge_name_isSet = true;
}

bool OAIChallengeResponseType::is_challenge_name_Set() const{
    return m_challenge_name_isSet;
}

bool OAIChallengeResponseType::is_challenge_name_Valid() const{
    return m_challenge_name_isValid;
}

OAIChallengeResponse OAIChallengeResponseType::getChallengeResponse() const {
    return m_challenge_response;
}
void OAIChallengeResponseType::setChallengeResponse(const OAIChallengeResponse &challenge_response) {
    m_challenge_response = challenge_response;
    m_challenge_response_isSet = true;
}

bool OAIChallengeResponseType::is_challenge_response_Set() const{
    return m_challenge_response_isSet;
}

bool OAIChallengeResponseType::is_challenge_response_Valid() const{
    return m_challenge_response_isValid;
}

bool OAIChallengeResponseType::isSet() const {
...
bool OAIChallengeResponseType::isValid() const {
