...
/*
 * OAIGetIdentityProviderByIdentifierResponse.h
 *
 * 
 */

#ifndef OAIGetIdentityProviderByIdentifierResponse_H
#define OAIGetIdentityProviderByIdentifierResponse_H

#include <QJsonObject>

#include "OAIDescribeIdentityProviderResponse_IdentityProvider.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIDescribeIdentityProviderResponse_IdentityProvider;

class OAIGetIdentityProviderByIdentifierResponse : public OAIObject {
public:
    OAIGetIdentityProviderByIdentifierResponse();
    OAIGetIdentityProviderByIdentifierResponse(QString json);
    ~OAIGetIdentityProviderByIdentifierResponse() override;
    ...
    OAIDescribeIdentityProviderResponse_IdentityProvider getIdentityProvider() const;
    void setIdentityProvider(const OAIDescribeIdentityProviderResponse_IdentityProvider &identity_provider);
...
private:
    ...
    OAIDescribeIdentityProviderResponse_IdentityProvider m_identity_provider;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetIdentityProviderByIdentifierResponse)

#endif // OAIGetIdentityProviderByIdentifierResponse_H
