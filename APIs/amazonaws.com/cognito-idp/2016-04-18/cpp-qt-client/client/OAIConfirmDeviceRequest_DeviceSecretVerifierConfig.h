...
/*
 * OAIConfirmDeviceRequest_DeviceSecretVerifierConfig.h
 *
 * 
 */

#ifndef OAIConfirmDeviceRequest_DeviceSecretVerifierConfig_H
#define OAIConfirmDeviceRequest_DeviceSecretVerifierConfig_H
...
class OAIConfirmDeviceRequest_DeviceSecretVerifierConfig : public OAIObject {
public:
    OAIConfirmDeviceRequest_DeviceSecretVerifierConfig();
    OAIConfirmDeviceRequest_DeviceSecretVerifierConfig(QString json);
    ~OAIConfirmDeviceRequest_DeviceSecretVerifierConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConfirmDeviceRequest_DeviceSecretVerifierConfig)

#endif // OAIConfirmDeviceRequest_DeviceSecretVerifierConfig_H
