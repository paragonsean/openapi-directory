...
/*
 * OAIAdminSetUserMFAPreferenceRequest_SMSMfaSettings.h
 *
 * 
 */

#ifndef OAIAdminSetUserMFAPreferenceRequest_SMSMfaSettings_H
#define OAIAdminSetUserMFAPreferenceRequest_SMSMfaSettings_H
...
class OAIAdminSetUserMFAPreferenceRequest_SMSMfaSettings : public OAIObject {
public:
    OAIAdminSetUserMFAPreferenceRequest_SMSMfaSettings();
    OAIAdminSetUserMFAPreferenceRequest_SMSMfaSettings(QString json);
    ~OAIAdminSetUserMFAPreferenceRequest_SMSMfaSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdminSetUserMFAPreferenceRequest_SMSMfaSettings)

#endif // OAIAdminSetUserMFAPreferenceRequest_SMSMfaSettings_H
