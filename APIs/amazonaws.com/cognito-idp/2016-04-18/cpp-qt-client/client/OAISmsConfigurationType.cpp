...
#include "OAISmsConfigurationType.h"
...
OAISmsConfigurationType::OAISmsConfigurationType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISmsConfigurationType::OAISmsConfigurationType() {
    this->initializeModel();
}

OAISmsConfigurationType::~OAISmsConfigurationType() {}

void OAISmsConfigurationType::initializeModel() {
...
void OAISmsConfigurationType::fromJson(QString jsonString) {
...
void OAISmsConfigurationType::fromJsonObject(QJsonObject json) {
...
QString OAISmsConfigurationType::asJson() const {
...
QJsonObject OAISmsConfigurationType::asJsonObject() const {
    QJsonObject obj;
...
QString OAISmsConfigurationType::getSnsCallerArn() const {
    return m_sns_caller_arn;
}
void OAISmsConfigurationType::setSnsCallerArn(const QString &sns_caller_arn) {
    m_sns_caller_arn = sns_caller_arn;
    m_sns_caller_arn_isSet = true;
}

bool OAISmsConfigurationType::is_sns_caller_arn_Set() const{
    return m_sns_caller_arn_isSet;
}

bool OAISmsConfigurationType::is_sns_caller_arn_Valid() const{
    return m_sns_caller_arn_isValid;
}

QString OAISmsConfigurationType::getExternalId() const {
    return m_external_id;
}
void OAISmsConfigurationType::setExternalId(const QString &external_id) {
    m_external_id = external_id;
    m_external_id_isSet = true;
}

bool OAISmsConfigurationType::is_external_id_Set() const{
    return m_external_id_isSet;
}

bool OAISmsConfigurationType::is_external_id_Valid() const{
    return m_external_id_isValid;
}

QString OAISmsConfigurationType::getSnsRegion() const {
    return m_sns_region;
}
void OAISmsConfigurationType::setSnsRegion(const QString &sns_region) {
    m_sns_region = sns_region;
    m_sns_region_isSet = true;
}

bool OAISmsConfigurationType::is_sns_region_Set() const{
    return m_sns_region_isSet;
}

bool OAISmsConfigurationType::is_sns_region_Valid() const{
    return m_sns_region_isValid;
}

bool OAISmsConfigurationType::isSet() const {
...
bool OAISmsConfigurationType::isValid() const {
