...
#include "OAIDescribeResourceServerResponse_ResourceServer.h"
...
OAIDescribeResourceServerResponse_ResourceServer::OAIDescribeResourceServerResponse_ResourceServer(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeResourceServerResponse_ResourceServer::OAIDescribeResourceServerResponse_ResourceServer() {
    this->initializeModel();
}

OAIDescribeResourceServerResponse_ResourceServer::~OAIDescribeResourceServerResponse_ResourceServer() {}

void OAIDescribeResourceServerResponse_ResourceServer::initializeModel() {
...
void OAIDescribeResourceServerResponse_ResourceServer::fromJson(QString jsonString) {
...
void OAIDescribeResourceServerResponse_ResourceServer::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeResourceServerResponse_ResourceServer::asJson() const {
...
QJsonObject OAIDescribeResourceServerResponse_ResourceServer::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeResourceServerResponse_ResourceServer::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIDescribeResourceServerResponse_ResourceServer::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIDescribeResourceServerResponse_ResourceServer::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIDescribeResourceServerResponse_ResourceServer::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

QString OAIDescribeResourceServerResponse_ResourceServer::getIdentifier() const {
    return m_identifier;
}
void OAIDescribeResourceServerResponse_ResourceServer::setIdentifier(const QString &identifier) {
    m_identifier = identifier;
    m_identifier_isSet = true;
}

bool OAIDescribeResourceServerResponse_ResourceServer::is_identifier_Set() const{
    return m_identifier_isSet;
}

bool OAIDescribeResourceServerResponse_ResourceServer::is_identifier_Valid() const{
    return m_identifier_isValid;
}

QString OAIDescribeResourceServerResponse_ResourceServer::getName() const {
    return m_name;
}
void OAIDescribeResourceServerResponse_ResourceServer::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIDescribeResourceServerResponse_ResourceServer::is_name_Set() const{
    return m_name_isSet;
}

bool OAIDescribeResourceServerResponse_ResourceServer::is_name_Valid() const{
    return m_name_isValid;
}

QList OAIDescribeResourceServerResponse_ResourceServer::getScopes() const {
    return m_scopes;
}
void OAIDescribeResourceServerResponse_ResourceServer::setScopes(const QList &scopes) {
    m_scopes = scopes;
    m_scopes_isSet = true;
}

bool OAIDescribeResourceServerResponse_ResourceServer::is_scopes_Set() const{
    return m_scopes_isSet;
}

bool OAIDescribeResourceServerResponse_ResourceServer::is_scopes_Valid() const{
    return m_scopes_isValid;
}

bool OAIDescribeResourceServerResponse_ResourceServer::isSet() const {
...
bool OAIDescribeResourceServerResponse_ResourceServer::isValid() const {
