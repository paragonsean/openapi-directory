...
/*
 * OAIAdminSetUserPasswordRequest.h
 *
 * 
 */

#ifndef OAIAdminSetUserPasswordRequest_H
#define OAIAdminSetUserPasswordRequest_H
...
class OAIAdminSetUserPasswordRequest : public OAIObject {
public:
    OAIAdminSetUserPasswordRequest();
    OAIAdminSetUserPasswordRequest(QString json);
    ~OAIAdminSetUserPasswordRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdminSetUserPasswordRequest)

#endif // OAIAdminSetUserPasswordRequest_H
