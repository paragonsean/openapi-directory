...
OAIListUsersInGroupResponse::OAIListUsersInGroupResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListUsersInGroupResponse::OAIListUsersInGroupResponse() {
    this->initializeModel();
}

OAIListUsersInGroupResponse::~OAIListUsersInGroupResponse() {}

void OAIListUsersInGroupResponse::initializeModel() {
...
void OAIListUsersInGroupResponse::fromJson(QString jsonString) {
...
void OAIListUsersInGroupResponse::fromJsonObject(QJsonObject json) {
...
QString OAIListUsersInGroupResponse::asJson() const {
...
QJsonObject OAIListUsersInGroupResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_users.isSet()) {
...
QList OAIListUsersInGroupResponse::getUsers() const {
    return m_users;
}
void OAIListUsersInGroupResponse::setUsers(const QList &users) {
    m_users = users;
    m_users_isSet = true;
}

bool OAIListUsersInGroupResponse::is_users_Set() const{
    return m_users_isSet;
}

bool OAIListUsersInGroupResponse::is_users_Valid() const{
    return m_users_isValid;
}

QString OAIListUsersInGroupResponse::getNextToken() const {
    return m_next_token;
}
void OAIListUsersInGroupResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListUsersInGroupResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListUsersInGroupResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListUsersInGroupResponse::isSet() const {
...
bool OAIListUsersInGroupResponse::isValid() const {
