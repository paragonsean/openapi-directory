...
OAICreateUserPoolResponse::OAICreateUserPoolResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateUserPoolResponse::OAICreateUserPoolResponse() {
    this->initializeModel();
}

OAICreateUserPoolResponse::~OAICreateUserPoolResponse() {}

void OAICreateUserPoolResponse::initializeModel() {

    m_user_pool_isSet = false;
    m_user_pool_isValid = false;
}

void OAICreateUserPoolResponse::fromJson(QString jsonString) {
...
void OAICreateUserPoolResponse::fromJsonObject(QJsonObject json) {
...
QString OAICreateUserPoolResponse::asJson() const {
...
QJsonObject OAICreateUserPoolResponse::asJsonObject() const {
    QJsonObject obj;
...
OAICreateUserPoolResponse_UserPool OAICreateUserPoolResponse::getUserPool() const {
    return m_user_pool;
}
void OAICreateUserPoolResponse::setUserPool(const OAICreateUserPoolResponse_UserPool &user_pool) {
    m_user_pool = user_pool;
    m_user_pool_isSet = true;
}

bool OAICreateUserPoolResponse::is_user_pool_Set() const{
    return m_user_pool_isSet;
}

bool OAICreateUserPoolResponse::is_user_pool_Valid() const{
    return m_user_pool_isValid;
}

bool OAICreateUserPoolResponse::isSet() const {
...
bool OAICreateUserPoolResponse::isValid() const {
