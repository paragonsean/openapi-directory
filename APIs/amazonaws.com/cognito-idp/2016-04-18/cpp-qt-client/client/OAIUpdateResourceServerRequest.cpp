...
OAIUpdateResourceServerRequest::OAIUpdateResourceServerRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateResourceServerRequest::OAIUpdateResourceServerRequest() {
    this->initializeModel();
}

OAIUpdateResourceServerRequest::~OAIUpdateResourceServerRequest() {}

void OAIUpdateResourceServerRequest::initializeModel() {
...
void OAIUpdateResourceServerRequest::fromJson(QString jsonString) {
...
void OAIUpdateResourceServerRequest::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateResourceServerRequest::asJson() const {
...
QJsonObject OAIUpdateResourceServerRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateResourceServerRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIUpdateResourceServerRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIUpdateResourceServerRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIUpdateResourceServerRequest::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

QString OAIUpdateResourceServerRequest::getIdentifier() const {
    return m_identifier;
}
void OAIUpdateResourceServerRequest::setIdentifier(const QString &identifier) {
    m_identifier = identifier;
    m_identifier_isSet = true;
}

bool OAIUpdateResourceServerRequest::is_identifier_Set() const{
    return m_identifier_isSet;
}

bool OAIUpdateResourceServerRequest::is_identifier_Valid() const{
    return m_identifier_isValid;
}

QString OAIUpdateResourceServerRequest::getName() const {
    return m_name;
}
void OAIUpdateResourceServerRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIUpdateResourceServerRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAIUpdateResourceServerRequest::is_name_Valid() const{
    return m_name_isValid;
}

QList OAIUpdateResourceServerRequest::getScopes() const {
    return m_scopes;
}
void OAIUpdateResourceServerRequest::setScopes(const QList &scopes) {
    m_scopes = scopes;
    m_scopes_isSet = true;
}

bool OAIUpdateResourceServerRequest::is_scopes_Set() const{
    return m_scopes_isSet;
}

bool OAIUpdateResourceServerRequest::is_scopes_Valid() const{
    return m_scopes_isValid;
}

bool OAIUpdateResourceServerRequest::isSet() const {
...
bool OAIUpdateResourceServerRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_user_pool_id_isValid && m_identifier_isValid && m_name_isValid && true;
}
