...
/*
 * OAIListResourceServersResponse.h
 *
 * 
 */

#ifndef OAIListResourceServersResponse_H
#define OAIListResourceServersResponse_H
...
class OAIListResourceServersResponse : public OAIObject {
public:
    OAIListResourceServersResponse();
    OAIListResourceServersResponse(QString json);
    ~OAIListResourceServersResponse() override;
    ...
    QList getResourceServers() const;
    void setResourceServers(const QList &resource_servers);
    bool is_resource_servers_Set() const;
    bool is_resource_servers_Valid() const;
...
private:
    ...
    QList m_resource_servers;
    bool m_resource_servers_isSet;
    bool m_resource_servers_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListResourceServersResponse)

#endif // OAIListResourceServersResponse_H
