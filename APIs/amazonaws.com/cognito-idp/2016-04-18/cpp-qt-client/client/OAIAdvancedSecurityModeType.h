...
/*
 * OAIAdvancedSecurityModeType.h
 *
 * 
 */

#ifndef OAIAdvancedSecurityModeType_H
#define OAIAdvancedSecurityModeType_H
...
class OAIAdvancedSecurityModeType : public OAIEnum {
public:
    OAIAdvancedSecurityModeType();
    OAIAdvancedSecurityModeType(QString json);
    ~OAIAdvancedSecurityModeType() override;
    ...
    enum class eOAIAdvancedSecurityModeType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        OFF, 
        AUDIT, 
        ENFORCED
    };
    OAIAdvancedSecurityModeType::eOAIAdvancedSecurityModeType getValue() const;
    void setValue(const OAIAdvancedSecurityModeType::eOAIAdvancedSecurityModeType& value);
...
private:
    ...
    eOAIAdvancedSecurityModeType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdvancedSecurityModeType)

#endif // OAIAdvancedSecurityModeType_H
