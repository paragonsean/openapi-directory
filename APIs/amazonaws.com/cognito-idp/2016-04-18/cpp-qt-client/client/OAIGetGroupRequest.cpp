...
QString OAIGetGroupRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIGetGroupRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIGetGroupRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIGetGroupRequest::is_user_pool_id_Valid() const{
