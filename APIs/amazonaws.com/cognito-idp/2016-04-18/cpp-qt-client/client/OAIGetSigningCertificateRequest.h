...
/*
 * OAIGetSigningCertificateRequest.h
 *
 * Request to get a signing certificate from Amazon Cognito.
 */

#ifndef OAIGetSigningCertificateRequest_H
#define OAIGetSigningCertificateRequest_H
...
class OAIGetSigningCertificateRequest : public OAIObject {
public:
    OAIGetSigningCertificateRequest();
    OAIGetSigningCertificateRequest(QString json);
    ~OAIGetSigningCertificateRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetSigningCertificateRequest)

#endif // OAIGetSigningCertificateRequest_H
