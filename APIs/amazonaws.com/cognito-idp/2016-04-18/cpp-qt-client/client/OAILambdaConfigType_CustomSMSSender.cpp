...
OAILambdaConfigType_CustomSMSSender::OAILambdaConfigType_CustomSMSSender(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILambdaConfigType_CustomSMSSender::OAILambdaConfigType_CustomSMSSender() {
    this->initializeModel();
}

OAILambdaConfigType_CustomSMSSender::~OAILambdaConfigType_CustomSMSSender() {}

void OAILambdaConfigType_CustomSMSSender::initializeModel() {
...
void OAILambdaConfigType_CustomSMSSender::fromJson(QString jsonString) {
...
void OAILambdaConfigType_CustomSMSSender::fromJsonObject(QJsonObject json) {
...
QString OAILambdaConfigType_CustomSMSSender::asJson() const {
...
QJsonObject OAILambdaConfigType_CustomSMSSender::asJsonObject() const {
    QJsonObject obj;
...
OAICustomSMSSenderLambdaVersionType OAILambdaConfigType_CustomSMSSender::getLambdaVersion() const {
    return m_lambda_version;
}
void OAILambdaConfigType_CustomSMSSender::setLambdaVersion(const OAICustomSMSSenderLambdaVersionType &lambda_version) {
    m_lambda_version = lambda_version;
    m_lambda_version_isSet = true;
}

bool OAILambdaConfigType_CustomSMSSender::is_lambda_version_Set() const{
    return m_lambda_version_isSet;
}

bool OAILambdaConfigType_CustomSMSSender::is_lambda_version_Valid() const{
    return m_lambda_version_isValid;
}

QString OAILambdaConfigType_CustomSMSSender::getLambdaArn() const {
    return m_lambda_arn;
}
void OAILambdaConfigType_CustomSMSSender::setLambdaArn(const QString &lambda_arn) {
    m_lambda_arn = lambda_arn;
    m_lambda_arn_isSet = true;
}

bool OAILambdaConfigType_CustomSMSSender::is_lambda_arn_Set() const{
    return m_lambda_arn_isSet;
}

bool OAILambdaConfigType_CustomSMSSender::is_lambda_arn_Valid() const{
    return m_lambda_arn_isValid;
}

bool OAILambdaConfigType_CustomSMSSender::isSet() const {
...
bool OAILambdaConfigType_CustomSMSSender::isValid() const {
