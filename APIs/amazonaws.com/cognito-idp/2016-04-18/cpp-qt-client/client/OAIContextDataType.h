...
/*
 * OAIContextDataType.h
 *
 * Contextual user data type used for evaluating the risk of an unexpected event by Amazon Cognito advanced security.
 */

#ifndef OAIContextDataType_H
#define OAIContextDataType_H
...
class OAIContextDataType : public OAIObject {
public:
    OAIContextDataType();
    OAIContextDataType(QString json);
    ~OAIContextDataType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIContextDataType)

#endif // OAIContextDataType_H
