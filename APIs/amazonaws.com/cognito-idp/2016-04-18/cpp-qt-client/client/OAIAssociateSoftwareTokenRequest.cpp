...
OAIAssociateSoftwareTokenRequest::OAIAssociateSoftwareTokenRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAssociateSoftwareTokenRequest::OAIAssociateSoftwareTokenRequest() {
    this->initializeModel();
}

OAIAssociateSoftwareTokenRequest::~OAIAssociateSoftwareTokenRequest() {}

void OAIAssociateSoftwareTokenRequest::initializeModel() {
...
void OAIAssociateSoftwareTokenRequest::fromJson(QString jsonString) {
...
void OAIAssociateSoftwareTokenRequest::fromJsonObject(QJsonObject json) {
...
QString OAIAssociateSoftwareTokenRequest::asJson() const {
...
QJsonObject OAIAssociateSoftwareTokenRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAssociateSoftwareTokenRequest::getAccessToken() const {
    return m_access_token;
}
void OAIAssociateSoftwareTokenRequest::setAccessToken(const QString &access_token) {
    m_access_token = access_token;
    m_access_token_isSet = true;
}

bool OAIAssociateSoftwareTokenRequest::is_access_token_Set() const{
    return m_access_token_isSet;
}

bool OAIAssociateSoftwareTokenRequest::is_access_token_Valid() const{
    return m_access_token_isValid;
}

QString OAIAssociateSoftwareTokenRequest::getSession() const {
    return m_session;
}
void OAIAssociateSoftwareTokenRequest::setSession(const QString &session) {
    m_session = session;
    m_session_isSet = true;
}

bool OAIAssociateSoftwareTokenRequest::is_session_Set() const{
    return m_session_isSet;
}

bool OAIAssociateSoftwareTokenRequest::is_session_Valid() const{
    return m_session_isValid;
}

bool OAIAssociateSoftwareTokenRequest::isSet() const {
...
bool OAIAssociateSoftwareTokenRequest::isValid() const {
