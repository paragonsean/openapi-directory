...
void OAIEventType::fromJson(QString jsonString) {
    ...
    if ( jsonString.compare("SignIn", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEventType::SIGNIN;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("SignUp", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEventType::SIGNUP;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ForgotPassword", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEventType::FORGOTPASSWORD;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("PasswordChange", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEventType::PASSWORDCHANGE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ResendCode", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEventType::RESENDCODE;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAIEventType::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIEventType::SIGNIN:
            val = "SignIn";
            break;
        case eOAIEventType::SIGNUP:
            val = "SignUp";
            break;
        case eOAIEventType::FORGOTPASSWORD:
            val = "ForgotPassword";
            break;
        case eOAIEventType::PASSWORDCHANGE:
            val = "PasswordChange";
            break;
        case eOAIEventType::RESENDCODE:
            val = "ResendCode";
            break;
        default:
            break;
