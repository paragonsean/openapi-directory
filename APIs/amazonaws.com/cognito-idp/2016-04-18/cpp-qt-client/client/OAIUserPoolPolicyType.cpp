...
#include "OAIUserPoolPolicyType.h"
...
OAIUserPoolPolicyType::OAIUserPoolPolicyType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUserPoolPolicyType::OAIUserPoolPolicyType() {
    this->initializeModel();
}

OAIUserPoolPolicyType::~OAIUserPoolPolicyType() {}

void OAIUserPoolPolicyType::initializeModel() {

    m_password_policy_isSet = false;
    m_password_policy_isValid = false;
}

void OAIUserPoolPolicyType::fromJson(QString jsonString) {
...
void OAIUserPoolPolicyType::fromJsonObject(QJsonObject json) {
...
QString OAIUserPoolPolicyType::asJson() const {
...
QJsonObject OAIUserPoolPolicyType::asJsonObject() const {
    QJsonObject obj;
...
OAIUserPoolPolicyType_PasswordPolicy OAIUserPoolPolicyType::getPasswordPolicy() const {
    return m_password_policy;
}
void OAIUserPoolPolicyType::setPasswordPolicy(const OAIUserPoolPolicyType_PasswordPolicy &password_policy) {
    m_password_policy = password_policy;
    m_password_policy_isSet = true;
}

bool OAIUserPoolPolicyType::is_password_policy_Set() const{
    return m_password_policy_isSet;
}

bool OAIUserPoolPolicyType::is_password_policy_Valid() const{
    return m_password_policy_isValid;
}

bool OAIUserPoolPolicyType::isSet() const {
...
bool OAIUserPoolPolicyType::isValid() const {
