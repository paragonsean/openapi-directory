...
QString OAICreateGroupRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAICreateGroupRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAICreateGroupRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAICreateGroupRequest::is_user_pool_id_Valid() const{
...
QString OAICreateGroupRequest::getRoleArn() const {
    return m_role_arn;
}
void OAICreateGroupRequest::setRoleArn(const QString &role_arn) {
    m_role_arn = role_arn;
    m_role_arn_isSet = true;
}

bool OAICreateGroupRequest::is_role_arn_Set() const{
    return m_role_arn_isSet;
}

bool OAICreateGroupRequest::is_role_arn_Valid() const{
    return m_role_arn_isValid;
}

qint32 OAICreateGroupRequest::getPrecedence() const {
    return m_precedence;
}
void OAICreateGroupRequest::setPrecedence(const qint32 &precedence) {
    m_precedence = precedence;
    m_precedence_isSet = true;
}

bool OAICreateGroupRequest::is_precedence_Set() const{
    return m_precedence_isSet;
}

bool OAICreateGroupRequest::is_precedence_Valid() const{
