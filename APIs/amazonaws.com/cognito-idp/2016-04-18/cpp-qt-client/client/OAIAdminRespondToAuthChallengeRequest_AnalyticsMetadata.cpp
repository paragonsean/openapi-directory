...
#include "OAIAdminRespondToAuthChallengeRequest_AnalyticsMetadata.h"
...
OAIAdminRespondToAuthChallengeRequest_AnalyticsMetadata::OAIAdminRespondToAuthChallengeRequest_AnalyticsMetadata(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdminRespondToAuthChallengeRequest_AnalyticsMetadata::OAIAdminRespondToAuthChallengeRequest_AnalyticsMetadata() {
    this->initializeModel();
}

OAIAdminRespondToAuthChallengeRequest_AnalyticsMetadata::~OAIAdminRespondToAuthChallengeRequest_AnalyticsMetadata() {}

void OAIAdminRespondToAuthChallengeRequest_AnalyticsMetadata::initializeModel() {

    m_analytics_endpoint_id_isSet = false;
    m_analytics_endpoint_id_isValid = false;
}

void OAIAdminRespondToAuthChallengeRequest_AnalyticsMetadata::fromJson(QString jsonString) {
...
void OAIAdminRespondToAuthChallengeRequest_AnalyticsMetadata::fromJsonObject(QJsonObject json) {
...
QString OAIAdminRespondToAuthChallengeRequest_AnalyticsMetadata::asJson() const {
...
QJsonObject OAIAdminRespondToAuthChallengeRequest_AnalyticsMetadata::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAdminRespondToAuthChallengeRequest_AnalyticsMetadata::getAnalyticsEndpointId() const {
    return m_analytics_endpoint_id;
}
void OAIAdminRespondToAuthChallengeRequest_AnalyticsMetadata::setAnalyticsEndpointId(const QString &analytics_endpoint_id) {
    m_analytics_endpoint_id = analytics_endpoint_id;
    m_analytics_endpoint_id_isSet = true;
}

bool OAIAdminRespondToAuthChallengeRequest_AnalyticsMetadata::is_analytics_endpoint_id_Set() const{
    return m_analytics_endpoint_id_isSet;
}

bool OAIAdminRespondToAuthChallengeRequest_AnalyticsMetadata::is_analytics_endpoint_id_Valid() const{
    return m_analytics_endpoint_id_isValid;
}

bool OAIAdminRespondToAuthChallengeRequest_AnalyticsMetadata::isSet() const {
...
bool OAIAdminRespondToAuthChallengeRequest_AnalyticsMetadata::isValid() const {
