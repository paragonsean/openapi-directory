...
OAIRespondToAuthChallengeResponse_AuthenticationResult::OAIRespondToAuthChallengeResponse_AuthenticationResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRespondToAuthChallengeResponse_AuthenticationResult::OAIRespondToAuthChallengeResponse_AuthenticationResult() {
    this->initializeModel();
}

OAIRespondToAuthChallengeResponse_AuthenticationResult::~OAIRespondToAuthChallengeResponse_AuthenticationResult() {}

void OAIRespondToAuthChallengeResponse_AuthenticationResult::initializeModel() {
...
void OAIRespondToAuthChallengeResponse_AuthenticationResult::fromJson(QString jsonString) {
...
void OAIRespondToAuthChallengeResponse_AuthenticationResult::fromJsonObject(QJsonObject json) {
...
QString OAIRespondToAuthChallengeResponse_AuthenticationResult::asJson() const {
...
QJsonObject OAIRespondToAuthChallengeResponse_AuthenticationResult::asJsonObject() const {
    QJsonObject obj;
...
QString OAIRespondToAuthChallengeResponse_AuthenticationResult::getAccessToken() const {
    return m_access_token;
}
void OAIRespondToAuthChallengeResponse_AuthenticationResult::setAccessToken(const QString &access_token) {
    m_access_token = access_token;
    m_access_token_isSet = true;
}

bool OAIRespondToAuthChallengeResponse_AuthenticationResult::is_access_token_Set() const{
    return m_access_token_isSet;
}

bool OAIRespondToAuthChallengeResponse_AuthenticationResult::is_access_token_Valid() const{
    return m_access_token_isValid;
}

qint32 OAIRespondToAuthChallengeResponse_AuthenticationResult::getExpiresIn() const {
    return m_expires_in;
}
void OAIRespondToAuthChallengeResponse_AuthenticationResult::setExpiresIn(const qint32 &expires_in) {
    m_expires_in = expires_in;
    m_expires_in_isSet = true;
}

bool OAIRespondToAuthChallengeResponse_AuthenticationResult::is_expires_in_Set() const{
    return m_expires_in_isSet;
}

bool OAIRespondToAuthChallengeResponse_AuthenticationResult::is_expires_in_Valid() const{
    return m_expires_in_isValid;
}

QString OAIRespondToAuthChallengeResponse_AuthenticationResult::getTokenType() const {
    return m_token_type;
}
void OAIRespondToAuthChallengeResponse_AuthenticationResult::setTokenType(const QString &token_type) {
    m_token_type = token_type;
    m_token_type_isSet = true;
}

bool OAIRespondToAuthChallengeResponse_AuthenticationResult::is_token_type_Set() const{
    return m_token_type_isSet;
}

bool OAIRespondToAuthChallengeResponse_AuthenticationResult::is_token_type_Valid() const{
    return m_token_type_isValid;
}

QString OAIRespondToAuthChallengeResponse_AuthenticationResult::getRefreshToken() const {
    return m_refresh_token;
}
void OAIRespondToAuthChallengeResponse_AuthenticationResult::setRefreshToken(const QString &refresh_token) {
    m_refresh_token = refresh_token;
    m_refresh_token_isSet = true;
}

bool OAIRespondToAuthChallengeResponse_AuthenticationResult::is_refresh_token_Set() const{
    return m_refresh_token_isSet;
}

bool OAIRespondToAuthChallengeResponse_AuthenticationResult::is_refresh_token_Valid() const{
    return m_refresh_token_isValid;
}

QString OAIRespondToAuthChallengeResponse_AuthenticationResult::getIdToken() const {
    return m_id_token;
}
void OAIRespondToAuthChallengeResponse_AuthenticationResult::setIdToken(const QString &id_token) {
    m_id_token = id_token;
    m_id_token_isSet = true;
}

bool OAIRespondToAuthChallengeResponse_AuthenticationResult::is_id_token_Set() const{
    return m_id_token_isSet;
}

bool OAIRespondToAuthChallengeResponse_AuthenticationResult::is_id_token_Valid() const{
    return m_id_token_isValid;
}

OAIAuthenticationResultType_NewDeviceMetadata OAIRespondToAuthChallengeResponse_AuthenticationResult::getNewDeviceMetadata() const {
    return m_new_device_metadata;
}
void OAIRespondToAuthChallengeResponse_AuthenticationResult::setNewDeviceMetadata(const OAIAuthenticationResultType_NewDeviceMetadata &new_device_metadata) {
    m_new_device_metadata = new_device_metadata;
    m_new_device_metadata_isSet = true;
}

bool OAIRespondToAuthChallengeResponse_AuthenticationResult::is_new_device_metadata_Set() const{
    return m_new_device_metadata_isSet;
}

bool OAIRespondToAuthChallengeResponse_AuthenticationResult::is_new_device_metadata_Valid() const{
    return m_new_device_metadata_isValid;
}

bool OAIRespondToAuthChallengeResponse_AuthenticationResult::isSet() const {
...
bool OAIRespondToAuthChallengeResponse_AuthenticationResult::isValid() const {
