...
/*
 * OAIAdminCreateUserRequest.h
 *
 * Represents the request to create a user in the specified user pool.
 */

#ifndef OAIAdminCreateUserRequest_H
#define OAIAdminCreateUserRequest_H
...
class OAIAdminCreateUserRequest : public OAIObject {
public:
    OAIAdminCreateUserRequest();
    OAIAdminCreateUserRequest(QString json);
    ~OAIAdminCreateUserRequest() override;
    ...
    QString getTemporaryPassword() const;
    void setTemporaryPassword(const QString &temporary_password);
    bool is_temporary_password_Set() const;
    bool is_temporary_password_Valid() const;

    bool getForceAliasCreation() const;
    void setForceAliasCreation(const bool &force_alias_creation);
    bool is_force_alias_creation_Set() const;
    bool is_force_alias_creation_Valid() const;

    OAIMessageActionType getMessageAction() const;
    void setMessageAction(const OAIMessageActionType &message_action);
    bool is_message_action_Set() const;
    bool is_message_action_Valid() const;

    QList getDesiredDeliveryMediums() const;
    void setDesiredDeliveryMediums(const QList &desired_delivery_mediums);
    bool is_desired_delivery_mediums_Set() const;
    bool is_desired_delivery_mediums_Valid() const;
...
private:
    ...
    QString m_temporary_password;
    bool m_temporary_password_isSet;
    bool m_temporary_password_isValid;

    bool m_force_alias_creation;
    bool m_force_alias_creation_isSet;
    bool m_force_alias_creation_isValid;

    OAIMessageActionType m_message_action;
    bool m_message_action_isSet;
    bool m_message_action_isValid;

    QList m_desired_delivery_mediums;
    bool m_desired_delivery_mediums_isSet;
    bool m_desired_delivery_mediums_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdminCreateUserRequest)

#endif // OAIAdminCreateUserRequest_H
