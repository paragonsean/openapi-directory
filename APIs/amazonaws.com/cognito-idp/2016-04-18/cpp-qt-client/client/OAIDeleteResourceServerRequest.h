...
/*
 * OAIDeleteResourceServerRequest.h
 *
 * 
 */

#ifndef OAIDeleteResourceServerRequest_H
#define OAIDeleteResourceServerRequest_H
...
class OAIDeleteResourceServerRequest : public OAIObject {
public:
    OAIDeleteResourceServerRequest();
    OAIDeleteResourceServerRequest(QString json);
    ~OAIDeleteResourceServerRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteResourceServerRequest)

#endif // OAIDeleteResourceServerRequest_H
