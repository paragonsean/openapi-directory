...
/*
 * OAISmsMfaConfigType_SmsConfiguration.h
 *
 * 
 */

#ifndef OAISmsMfaConfigType_SmsConfiguration_H
#define OAISmsMfaConfigType_SmsConfiguration_H
...
class OAISmsMfaConfigType_SmsConfiguration : public OAIObject {
public:
    OAISmsMfaConfigType_SmsConfiguration();
    OAISmsMfaConfigType_SmsConfiguration(QString json);
    ~OAISmsMfaConfigType_SmsConfiguration() override;
    ...
    QString getSnsCallerArn() const;
    void setSnsCallerArn(const QString &sns_caller_arn);
    bool is_sns_caller_arn_Set() const;
    bool is_sns_caller_arn_Valid() const;
    ...
    QString getSnsRegion() const;
    void setSnsRegion(const QString &sns_region);
    bool is_sns_region_Set() const;
    bool is_sns_region_Valid() const;
...
private:
    ...
    QString m_sns_caller_arn;
    bool m_sns_caller_arn_isSet;
    bool m_sns_caller_arn_isValid;

    QString m_external_id;
    bool m_external_id_isSet;
    bool m_external_id_isValid;

    QString m_sns_region;
    bool m_sns_region_isSet;
    bool m_sns_region_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAISmsMfaConfigType_SmsConfiguration)

#endif // OAISmsMfaConfigType_SmsConfiguration_H
