...
/*
 * OAIGetUICustomizationRequest.h
 *
 * 
 */

#ifndef OAIGetUICustomizationRequest_H
#define OAIGetUICustomizationRequest_H
...
class OAIGetUICustomizationRequest : public OAIObject {
public:
    OAIGetUICustomizationRequest();
    OAIGetUICustomizationRequest(QString json);
    ~OAIGetUICustomizationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetUICustomizationRequest)

#endif // OAIGetUICustomizationRequest_H
