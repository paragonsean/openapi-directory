...
OAISetRiskConfigurationResponse::OAISetRiskConfigurationResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISetRiskConfigurationResponse::OAISetRiskConfigurationResponse() {
    this->initializeModel();
}

OAISetRiskConfigurationResponse::~OAISetRiskConfigurationResponse() {}

void OAISetRiskConfigurationResponse::initializeModel() {

    m_risk_configuration_isSet = false;
    m_risk_configuration_isValid = false;
}

void OAISetRiskConfigurationResponse::fromJson(QString jsonString) {
...
void OAISetRiskConfigurationResponse::fromJsonObject(QJsonObject json) {

    m_risk_configuration_isValid = ::OpenAPI::fromJsonValue(m_risk_configuration, json[QString("RiskConfiguration")]);
    m_risk_configuration_isSet = !json[QString("RiskConfiguration")].isNull() && m_risk_configuration_isValid;
}

QString OAISetRiskConfigurationResponse::asJson() const {
...
QJsonObject OAISetRiskConfigurationResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_risk_configuration.isSet()) {
        obj.insert(QString("RiskConfiguration"), ::OpenAPI::toJsonValue(m_risk_configuration));
    }
    return obj;
}

OAIDescribeRiskConfigurationResponse_RiskConfiguration OAISetRiskConfigurationResponse::getRiskConfiguration() const {
    return m_risk_configuration;
}
void OAISetRiskConfigurationResponse::setRiskConfiguration(const OAIDescribeRiskConfigurationResponse_RiskConfiguration &risk_configuration) {
    m_risk_configuration = risk_configuration;
    m_risk_configuration_isSet = true;
}

bool OAISetRiskConfigurationResponse::is_risk_configuration_Set() const{
    return m_risk_configuration_isSet;
}

bool OAISetRiskConfigurationResponse::is_risk_configuration_Valid() const{
    return m_risk_configuration_isValid;
}

bool OAISetRiskConfigurationResponse::isSet() const {
...
bool OAISetRiskConfigurationResponse::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_risk_configuration_isValid && true;
}
