...
#ifndef OAIAuthFlowType_H
#define OAIAuthFlowType_H
...
class OAIAuthFlowType : public OAIEnum {
public:
    OAIAuthFlowType();
    OAIAuthFlowType(QString json);
    ~OAIAuthFlowType() override;
    ...
    OAIAuthFlowType::eOAIAuthFlowType getValue() const;
    void setValue(const OAIAuthFlowType::eOAIAuthFlowType& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIAuthFlowType)

#endif // OAIAuthFlowType_H
