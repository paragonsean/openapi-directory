...
#include "OAIDeviceSecretVerifierConfigType.h"
...
OAIDeviceSecretVerifierConfigType::OAIDeviceSecretVerifierConfigType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeviceSecretVerifierConfigType::OAIDeviceSecretVerifierConfigType() {
    this->initializeModel();
}

OAIDeviceSecretVerifierConfigType::~OAIDeviceSecretVerifierConfigType() {}

void OAIDeviceSecretVerifierConfigType::initializeModel() {

    m_password_verifier_isSet = false;
    m_password_verifier_isValid = false;

    m_salt_isSet = false;
    m_salt_isValid = false;
}

void OAIDeviceSecretVerifierConfigType::fromJson(QString jsonString) {
...
void OAIDeviceSecretVerifierConfigType::fromJsonObject(QJsonObject json) {

    m_password_verifier_isValid = ::OpenAPI::fromJsonValue(m_password_verifier, json[QString("PasswordVerifier")]);
    m_password_verifier_isSet = !json[QString("PasswordVerifier")].isNull() && m_password_verifier_isValid;

    m_salt_isValid = ::OpenAPI::fromJsonValue(m_salt, json[QString("Salt")]);
    m_salt_isSet = !json[QString("Salt")].isNull() && m_salt_isValid;
}

QString OAIDeviceSecretVerifierConfigType::asJson() const {
...
QJsonObject OAIDeviceSecretVerifierConfigType::asJsonObject() const {
    QJsonObject obj;
    if (m_password_verifier_isSet) {
        obj.insert(QString("PasswordVerifier"), ::OpenAPI::toJsonValue(m_password_verifier));
    }
    if (m_salt_isSet) {
...
QString OAIDeviceSecretVerifierConfigType::getPasswordVerifier() const {
    return m_password_verifier;
}
void OAIDeviceSecretVerifierConfigType::setPasswordVerifier(const QString &password_verifier) {
    m_password_verifier = password_verifier;
    m_password_verifier_isSet = true;
}

bool OAIDeviceSecretVerifierConfigType::is_password_verifier_Set() const{
    return m_password_verifier_isSet;
}

bool OAIDeviceSecretVerifierConfigType::is_password_verifier_Valid() const{
    return m_password_verifier_isValid;
}

QString OAIDeviceSecretVerifierConfigType::getSalt() const {
    return m_salt;
}
void OAIDeviceSecretVerifierConfigType::setSalt(const QString &salt) {
    m_salt = salt;
    m_salt_isSet = true;
}

bool OAIDeviceSecretVerifierConfigType::is_salt_Set() const{
    return m_salt_isSet;
}

bool OAIDeviceSecretVerifierConfigType::is_salt_Valid() const{
    return m_salt_isValid;
}

bool OAIDeviceSecretVerifierConfigType::isSet() const {
...
bool OAIDeviceSecretVerifierConfigType::isValid() const {
