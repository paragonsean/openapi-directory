...
/*
 * OAIAdminListUserAuthEventsResponse.h
 *
 * 
 */

#ifndef OAIAdminListUserAuthEventsResponse_H
#define OAIAdminListUserAuthEventsResponse_H
...
class OAIAdminListUserAuthEventsResponse : public OAIObject {
public:
    OAIAdminListUserAuthEventsResponse();
    OAIAdminListUserAuthEventsResponse(QString json);
    ~OAIAdminListUserAuthEventsResponse() override;
    ...
    QList getAuthEvents() const;
    void setAuthEvents(const QList &auth_events);
    bool is_auth_events_Set() const;
    bool is_auth_events_Valid() const;
...
private:
    ...
    QList m_auth_events;
    bool m_auth_events_isSet;
    bool m_auth_events_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdminListUserAuthEventsResponse)

#endif // OAIAdminListUserAuthEventsResponse_H
