...
OAIInitiateAuthResponse::OAIInitiateAuthResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIInitiateAuthResponse::OAIInitiateAuthResponse() {
    this->initializeModel();
}

OAIInitiateAuthResponse::~OAIInitiateAuthResponse() {}

void OAIInitiateAuthResponse::initializeModel() {
...
void OAIInitiateAuthResponse::fromJson(QString jsonString) {
...
void OAIInitiateAuthResponse::fromJsonObject(QJsonObject json) {
...
QString OAIInitiateAuthResponse::asJson() const {
...
QJsonObject OAIInitiateAuthResponse::asJsonObject() const {
    QJsonObject obj;
...
OAIChallengeNameType OAIInitiateAuthResponse::getChallengeName() const {
    return m_challenge_name;
}
void OAIInitiateAuthResponse::setChallengeName(const OAIChallengeNameType &challenge_name) {
    m_challenge_name = challenge_name;
    m_challenge_name_isSet = true;
}

bool OAIInitiateAuthResponse::is_challenge_name_Set() const{
    return m_challenge_name_isSet;
}

bool OAIInitiateAuthResponse::is_challenge_name_Valid() const{
    return m_challenge_name_isValid;
}

QString OAIInitiateAuthResponse::getSession() const {
    return m_session;
}
void OAIInitiateAuthResponse::setSession(const QString &session) {
    m_session = session;
    m_session_isSet = true;
}

bool OAIInitiateAuthResponse::is_session_Set() const{
    return m_session_isSet;
}

bool OAIInitiateAuthResponse::is_session_Valid() const{
    return m_session_isValid;
}

QMap OAIInitiateAuthResponse::getChallengeParameters() const {
    return m_challenge_parameters;
}
void OAIInitiateAuthResponse::setChallengeParameters(const QMap &challenge_parameters) {
    m_challenge_parameters = challenge_parameters;
    m_challenge_parameters_isSet = true;
}

bool OAIInitiateAuthResponse::is_challenge_parameters_Set() const{
    return m_challenge_parameters_isSet;
}

bool OAIInitiateAuthResponse::is_challenge_parameters_Valid() const{
    return m_challenge_parameters_isValid;
}

OAIInitiateAuthResponse_AuthenticationResult OAIInitiateAuthResponse::getAuthenticationResult() const {
    return m_authentication_result;
}
void OAIInitiateAuthResponse::setAuthenticationResult(const OAIInitiateAuthResponse_AuthenticationResult &authentication_result) {
    m_authentication_result = authentication_result;
    m_authentication_result_isSet = true;
}

bool OAIInitiateAuthResponse::is_authentication_result_Set() const{
    return m_authentication_result_isSet;
}

bool OAIInitiateAuthResponse::is_authentication_result_Valid() const{
    return m_authentication_result_isValid;
}

bool OAIInitiateAuthResponse::isSet() const {
...
bool OAIInitiateAuthResponse::isValid() const {
