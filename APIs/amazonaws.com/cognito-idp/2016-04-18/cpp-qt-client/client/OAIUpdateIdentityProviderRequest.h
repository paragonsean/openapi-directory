...
/*
 * OAIUpdateIdentityProviderRequest.h
 *
 * 
 */

#ifndef OAIUpdateIdentityProviderRequest_H
#define OAIUpdateIdentityProviderRequest_H
...
class OAIUpdateIdentityProviderRequest : public OAIObject {
public:
    OAIUpdateIdentityProviderRequest();
    OAIUpdateIdentityProviderRequest(QString json);
    ~OAIUpdateIdentityProviderRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateIdentityProviderRequest)

#endif // OAIUpdateIdentityProviderRequest_H
