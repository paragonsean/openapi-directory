...
#include "OAIAccountTakeoverActionsType.h"
...
OAIAccountTakeoverActionsType::OAIAccountTakeoverActionsType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAccountTakeoverActionsType::OAIAccountTakeoverActionsType() {
    this->initializeModel();
}

OAIAccountTakeoverActionsType::~OAIAccountTakeoverActionsType() {}

void OAIAccountTakeoverActionsType::initializeModel() {
...
void OAIAccountTakeoverActionsType::fromJson(QString jsonString) {
...
void OAIAccountTakeoverActionsType::fromJsonObject(QJsonObject json) {
...
QString OAIAccountTakeoverActionsType::asJson() const {
...
QJsonObject OAIAccountTakeoverActionsType::asJsonObject() const {
    QJsonObject obj;
...
OAIAccountTakeoverActionsType_LowAction OAIAccountTakeoverActionsType::getLowAction() const {
    return m_low_action;
}
void OAIAccountTakeoverActionsType::setLowAction(const OAIAccountTakeoverActionsType_LowAction &low_action) {
    m_low_action = low_action;
    m_low_action_isSet = true;
}

bool OAIAccountTakeoverActionsType::is_low_action_Set() const{
    return m_low_action_isSet;
}

bool OAIAccountTakeoverActionsType::is_low_action_Valid() const{
    return m_low_action_isValid;
}

OAIAccountTakeoverActionsType_MediumAction OAIAccountTakeoverActionsType::getMediumAction() const {
    return m_medium_action;
}
void OAIAccountTakeoverActionsType::setMediumAction(const OAIAccountTakeoverActionsType_MediumAction &medium_action) {
    m_medium_action = medium_action;
    m_medium_action_isSet = true;
}

bool OAIAccountTakeoverActionsType::is_medium_action_Set() const{
    return m_medium_action_isSet;
}

bool OAIAccountTakeoverActionsType::is_medium_action_Valid() const{
    return m_medium_action_isValid;
}

OAIAccountTakeoverActionsType_HighAction OAIAccountTakeoverActionsType::getHighAction() const {
    return m_high_action;
}
void OAIAccountTakeoverActionsType::setHighAction(const OAIAccountTakeoverActionsType_HighAction &high_action) {
    m_high_action = high_action;
    m_high_action_isSet = true;
}

bool OAIAccountTakeoverActionsType::is_high_action_Set() const{
    return m_high_action_isSet;
}

bool OAIAccountTakeoverActionsType::is_high_action_Valid() const{
    return m_high_action_isValid;
}

bool OAIAccountTakeoverActionsType::isSet() const {
...
bool OAIAccountTakeoverActionsType::isValid() const {
