...
OAIPreventUserExistenceErrorTypes::OAIPreventUserExistenceErrorTypes(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPreventUserExistenceErrorTypes::OAIPreventUserExistenceErrorTypes() {
    this->initializeModel();
}

OAIPreventUserExistenceErrorTypes::~OAIPreventUserExistenceErrorTypes() {}

void OAIPreventUserExistenceErrorTypes::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIPreventUserExistenceErrorTypes::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIPreventUserExistenceErrorTypes::fromJson(QString jsonString) {
    
    if ( jsonString.compare("LEGACY", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPreventUserExistenceErrorTypes::LEGACY;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ENABLED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPreventUserExistenceErrorTypes::ENABLED;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIPreventUserExistenceErrorTypes::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIPreventUserExistenceErrorTypes::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIPreventUserExistenceErrorTypes::LEGACY:
            val = "LEGACY";
            break;
        case eOAIPreventUserExistenceErrorTypes::ENABLED:
            val = "ENABLED";
            break;
        default:
            break;
...
QJsonValue OAIPreventUserExistenceErrorTypes::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIPreventUserExistenceErrorTypes::eOAIPreventUserExistenceErrorTypes OAIPreventUserExistenceErrorTypes::getValue() const {
    return m_value;
}

void OAIPreventUserExistenceErrorTypes::setValue(const OAIPreventUserExistenceErrorTypes::eOAIPreventUserExistenceErrorTypes& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIPreventUserExistenceErrorTypes::isSet() const {
    
    return m_value_isSet;
}

bool OAIPreventUserExistenceErrorTypes::isValid() const {
