...
#include "OAICustomSMSLambdaVersionConfigType.h"
...
OAICustomSMSLambdaVersionConfigType::OAICustomSMSLambdaVersionConfigType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICustomSMSLambdaVersionConfigType::OAICustomSMSLambdaVersionConfigType() {
    this->initializeModel();
}

OAICustomSMSLambdaVersionConfigType::~OAICustomSMSLambdaVersionConfigType() {}

void OAICustomSMSLambdaVersionConfigType::initializeModel() {
...
void OAICustomSMSLambdaVersionConfigType::fromJson(QString jsonString) {
...
void OAICustomSMSLambdaVersionConfigType::fromJsonObject(QJsonObject json) {
...
QString OAICustomSMSLambdaVersionConfigType::asJson() const {
...
QJsonObject OAICustomSMSLambdaVersionConfigType::asJsonObject() const {
    QJsonObject obj;
...
OAICustomSMSSenderLambdaVersionType OAICustomSMSLambdaVersionConfigType::getLambdaVersion() const {
    return m_lambda_version;
}
void OAICustomSMSLambdaVersionConfigType::setLambdaVersion(const OAICustomSMSSenderLambdaVersionType &lambda_version) {
    m_lambda_version = lambda_version;
    m_lambda_version_isSet = true;
}

bool OAICustomSMSLambdaVersionConfigType::is_lambda_version_Set() const{
    return m_lambda_version_isSet;
}

bool OAICustomSMSLambdaVersionConfigType::is_lambda_version_Valid() const{
    return m_lambda_version_isValid;
}

QString OAICustomSMSLambdaVersionConfigType::getLambdaArn() const {
    return m_lambda_arn;
}
void OAICustomSMSLambdaVersionConfigType::setLambdaArn(const QString &lambda_arn) {
    m_lambda_arn = lambda_arn;
    m_lambda_arn_isSet = true;
}

bool OAICustomSMSLambdaVersionConfigType::is_lambda_arn_Set() const{
    return m_lambda_arn_isSet;
}

bool OAICustomSMSLambdaVersionConfigType::is_lambda_arn_Valid() const{
    return m_lambda_arn_isValid;
}

bool OAICustomSMSLambdaVersionConfigType::isSet() const {
...
bool OAICustomSMSLambdaVersionConfigType::isValid() const {
