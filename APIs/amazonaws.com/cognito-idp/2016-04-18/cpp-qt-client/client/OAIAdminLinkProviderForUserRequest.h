...
/*
 * OAIAdminLinkProviderForUserRequest.h
 *
 * 
 */

#ifndef OAIAdminLinkProviderForUserRequest_H
#define OAIAdminLinkProviderForUserRequest_H
...
namespace OpenAPI {
class OAIAdminLinkProviderForUserRequest_DestinationUser;
class OAIAdminLinkProviderForUserRequest_SourceUser;

class OAIAdminLinkProviderForUserRequest : public OAIObject {
public:
    OAIAdminLinkProviderForUserRequest();
    OAIAdminLinkProviderForUserRequest(QString json);
    ~OAIAdminLinkProviderForUserRequest() override;
    ...
    OAIAdminLinkProviderForUserRequest_DestinationUser getDestinationUser() const;
    void setDestinationUser(const OAIAdminLinkProviderForUserRequest_DestinationUser &destination_user);
    bool is_destination_user_Set() const;
    bool is_destination_user_Valid() const;

    OAIAdminLinkProviderForUserRequest_SourceUser getSourceUser() const;
    void setSourceUser(const OAIAdminLinkProviderForUserRequest_SourceUser &source_user);
...
private:
    ...
    OAIAdminLinkProviderForUserRequest_DestinationUser m_destination_user;
    bool m_destination_user_isSet;
    bool m_destination_user_isValid;

    OAIAdminLinkProviderForUserRequest_SourceUser m_source_user;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdminLinkProviderForUserRequest)

#endif // OAIAdminLinkProviderForUserRequest_H
