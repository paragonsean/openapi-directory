...
OAICreateUserPoolRequest_Policies::OAICreateUserPoolRequest_Policies(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateUserPoolRequest_Policies::OAICreateUserPoolRequest_Policies() {
    this->initializeModel();
}

OAICreateUserPoolRequest_Policies::~OAICreateUserPoolRequest_Policies() {}

void OAICreateUserPoolRequest_Policies::initializeModel() {

    m_password_policy_isSet = false;
    m_password_policy_isValid = false;
}

void OAICreateUserPoolRequest_Policies::fromJson(QString jsonString) {
...
void OAICreateUserPoolRequest_Policies::fromJsonObject(QJsonObject json) {
...
QString OAICreateUserPoolRequest_Policies::asJson() const {
...
QJsonObject OAICreateUserPoolRequest_Policies::asJsonObject() const {
    QJsonObject obj;
...
OAIUserPoolPolicyType_PasswordPolicy OAICreateUserPoolRequest_Policies::getPasswordPolicy() const {
    return m_password_policy;
}
void OAICreateUserPoolRequest_Policies::setPasswordPolicy(const OAIUserPoolPolicyType_PasswordPolicy &password_policy) {
    m_password_policy = password_policy;
    m_password_policy_isSet = true;
}

bool OAICreateUserPoolRequest_Policies::is_password_policy_Set() const{
    return m_password_policy_isSet;
}

bool OAICreateUserPoolRequest_Policies::is_password_policy_Valid() const{
    return m_password_policy_isValid;
}

bool OAICreateUserPoolRequest_Policies::isSet() const {
...
bool OAICreateUserPoolRequest_Policies::isValid() const {
