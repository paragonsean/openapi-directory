...
/*
 * OAISignUpResponse_CodeDeliveryDetails.h
 *
 * 
 */

#ifndef OAISignUpResponse_CodeDeliveryDetails_H
#define OAISignUpResponse_CodeDeliveryDetails_H
...
class OAISignUpResponse_CodeDeliveryDetails : public OAIObject {
public:
    OAISignUpResponse_CodeDeliveryDetails();
    OAISignUpResponse_CodeDeliveryDetails(QString json);
    ~OAISignUpResponse_CodeDeliveryDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISignUpResponse_CodeDeliveryDetails)

#endif // OAISignUpResponse_CodeDeliveryDetails_H
