...
/*
 * OAIExplicitAuthFlowsType.h
 *
 * 
 */

#ifndef OAIExplicitAuthFlowsType_H
#define OAIExplicitAuthFlowsType_H
...
class OAIExplicitAuthFlowsType : public OAIEnum {
public:
    OAIExplicitAuthFlowsType();
    OAIExplicitAuthFlowsType(QString json);
    ~OAIExplicitAuthFlowsType() override;
    ...
    enum class eOAIExplicitAuthFlowsType {
    ...
    OAIExplicitAuthFlowsType::eOAIExplicitAuthFlowsType getValue() const;
    void setValue(const OAIExplicitAuthFlowsType::eOAIExplicitAuthFlowsType& value);
...
private:
    ...
    eOAIExplicitAuthFlowsType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExplicitAuthFlowsType)

#endif // OAIExplicitAuthFlowsType_H
