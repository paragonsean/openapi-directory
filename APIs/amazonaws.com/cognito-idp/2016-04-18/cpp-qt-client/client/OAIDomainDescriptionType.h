...
/*
 * OAIDomainDescriptionType.h
 *
 * A container for information about a domain.
 */

#ifndef OAIDomainDescriptionType_H
#define OAIDomainDescriptionType_H

#include <QJsonObject>

#include "OAIDomainDescriptionType_CustomDomainConfig.h"
#include "OAIDomainStatusType.h"
#include <QString>
...
namespace OpenAPI {
class OAIDomainDescriptionType_CustomDomainConfig;

class OAIDomainDescriptionType : public OAIObject {
public:
    OAIDomainDescriptionType();
    OAIDomainDescriptionType(QString json);
    ~OAIDomainDescriptionType() override;
    ...
    QString getCloudFrontDistribution() const;
    void setCloudFrontDistribution(const QString &cloud_front_distribution);
    bool is_cloud_front_distribution_Set() const;
    bool is_cloud_front_distribution_Valid() const;
    ...
    OAIDomainStatusType getStatus() const;
    void setStatus(const OAIDomainStatusType &status);
    bool is_status_Set() const;
    bool is_status_Valid() const;

    OAIDomainDescriptionType_CustomDomainConfig getCustomDomainConfig() const;
    void setCustomDomainConfig(const OAIDomainDescriptionType_CustomDomainConfig &custom_domain_config);
...
private:
    ...
    QString m_cloud_front_distribution;
    bool m_cloud_front_distribution_isSet;
    bool m_cloud_front_distribution_isValid;

    QString m_version;
    bool m_version_isSet;
    bool m_version_isValid;

    OAIDomainStatusType m_status;
    bool m_status_isSet;
    bool m_status_isValid;

    OAIDomainDescriptionType_CustomDomainConfig m_custom_domain_config;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDomainDescriptionType)

#endif // OAIDomainDescriptionType_H
