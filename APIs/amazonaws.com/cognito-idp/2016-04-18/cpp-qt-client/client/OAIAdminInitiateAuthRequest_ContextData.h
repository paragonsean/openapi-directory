...
/*
 * OAIAdminInitiateAuthRequest_ContextData.h
 *
 * 
 */

#ifndef OAIAdminInitiateAuthRequest_ContextData_H
#define OAIAdminInitiateAuthRequest_ContextData_H
...
class OAIAdminInitiateAuthRequest_ContextData : public OAIObject {
public:
    OAIAdminInitiateAuthRequest_ContextData();
    OAIAdminInitiateAuthRequest_ContextData(QString json);
    ~OAIAdminInitiateAuthRequest_ContextData() override;
    ...
    void setServerPath(const QString &server_path);
    bool is_server_path_Set() const;
    bool is_server_path_Valid() const;

    QList getHttpHeaders() const;
    void setHttpHeaders(const QList &http_headers);
    bool is_http_headers_Set() const;
    bool is_http_headers_Valid() const;

    QString getEncodedData() const;
    void setEncodedData(const QString &encoded_data);
...
private:
    ...
    bool m_server_path_isSet;
    bool m_server_path_isValid;

    QList m_http_headers;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdminInitiateAuthRequest_ContextData)

#endif // OAIAdminInitiateAuthRequest_ContextData_H
