...
OAIDomainDescriptionType_CustomDomainConfig::OAIDomainDescriptionType_CustomDomainConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDomainDescriptionType_CustomDomainConfig::OAIDomainDescriptionType_CustomDomainConfig() {
    this->initializeModel();
}

OAIDomainDescriptionType_CustomDomainConfig::~OAIDomainDescriptionType_CustomDomainConfig() {}

void OAIDomainDescriptionType_CustomDomainConfig::initializeModel() {

    m_certificate_arn_isSet = false;
    m_certificate_arn_isValid = false;
}

void OAIDomainDescriptionType_CustomDomainConfig::fromJson(QString jsonString) {
...
void OAIDomainDescriptionType_CustomDomainConfig::fromJsonObject(QJsonObject json) {
...
QString OAIDomainDescriptionType_CustomDomainConfig::asJson() const {
...
QJsonObject OAIDomainDescriptionType_CustomDomainConfig::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDomainDescriptionType_CustomDomainConfig::getCertificateArn() const {
    return m_certificate_arn;
}
void OAIDomainDescriptionType_CustomDomainConfig::setCertificateArn(const QString &certificate_arn) {
    m_certificate_arn = certificate_arn;
    m_certificate_arn_isSet = true;
}

bool OAIDomainDescriptionType_CustomDomainConfig::is_certificate_arn_Set() const{
    return m_certificate_arn_isSet;
}

bool OAIDomainDescriptionType_CustomDomainConfig::is_certificate_arn_Valid() const{
    return m_certificate_arn_isValid;
}

bool OAIDomainDescriptionType_CustomDomainConfig::isSet() const {
...
bool OAIDomainDescriptionType_CustomDomainConfig::isValid() const {
