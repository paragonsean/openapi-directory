...
/*
 * OAIAdminRespondToAuthChallengeResponse_AuthenticationResult.h
 *
 * 
 */

#ifndef OAIAdminRespondToAuthChallengeResponse_AuthenticationResult_H
#define OAIAdminRespondToAuthChallengeResponse_AuthenticationResult_H
...
namespace OpenAPI {
class OAIAuthenticationResultType_NewDeviceMetadata;

class OAIAdminRespondToAuthChallengeResponse_AuthenticationResult : public OAIObject {
public:
    OAIAdminRespondToAuthChallengeResponse_AuthenticationResult();
    OAIAdminRespondToAuthChallengeResponse_AuthenticationResult(QString json);
    ~OAIAdminRespondToAuthChallengeResponse_AuthenticationResult() override;
    ...
    OAIAuthenticationResultType_NewDeviceMetadata getNewDeviceMetadata() const;
    void setNewDeviceMetadata(const OAIAuthenticationResultType_NewDeviceMetadata &new_device_metadata);
    bool is_new_device_metadata_Set() const;
    bool is_new_device_metadata_Valid() const;
...
private:
    ...
    OAIAuthenticationResultType_NewDeviceMetadata m_new_device_metadata;
    bool m_new_device_metadata_isSet;
    bool m_new_device_metadata_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIAdminRespondToAuthChallengeResponse_AuthenticationResult)

#endif // OAIAdminRespondToAuthChallengeResponse_AuthenticationResult_H
