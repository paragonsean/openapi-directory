...
OAICreateUserPoolRequest_UserAttributeUpdateSettings::OAICreateUserPoolRequest_UserAttributeUpdateSettings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateUserPoolRequest_UserAttributeUpdateSettings::OAICreateUserPoolRequest_UserAttributeUpdateSettings() {
    this->initializeModel();
}

OAICreateUserPoolRequest_UserAttributeUpdateSettings::~OAICreateUserPoolRequest_UserAttributeUpdateSettings() {}

void OAICreateUserPoolRequest_UserAttributeUpdateSettings::initializeModel() {

    m_attributes_require_verification_before_update_isSet = false;
    m_attributes_require_verification_before_update_isValid = false;
}

void OAICreateUserPoolRequest_UserAttributeUpdateSettings::fromJson(QString jsonString) {
...
void OAICreateUserPoolRequest_UserAttributeUpdateSettings::fromJsonObject(QJsonObject json) {

    m_attributes_require_verification_before_update_isValid = ::OpenAPI::fromJsonValue(m_attributes_require_verification_before_update, json[QString("AttributesRequireVerificationBeforeUpdate")]);
    m_attributes_require_verification_before_update_isSet = !json[QString("AttributesRequireVerificationBeforeUpdate")].isNull() && m_attributes_require_verification_before_update_isValid;
}

QString OAICreateUserPoolRequest_UserAttributeUpdateSettings::asJson() const {
...
QJsonObject OAICreateUserPoolRequest_UserAttributeUpdateSettings::asJsonObject() const {
    QJsonObject obj;
    if (m_attributes_require_verification_before_update.isSet()) {
        obj.insert(QString("AttributesRequireVerificationBeforeUpdate"), ::OpenAPI::toJsonValue(m_attributes_require_verification_before_update));
    }
    return obj;
}

QList OAICreateUserPoolRequest_UserAttributeUpdateSettings::getAttributesRequireVerificationBeforeUpdate() const {
    return m_attributes_require_verification_before_update;
}
void OAICreateUserPoolRequest_UserAttributeUpdateSettings::setAttributesRequireVerificationBeforeUpdate(const QList &attributes_require_verification_before_update) {
    m_attributes_require_verification_before_update = attributes_require_verification_before_update;
    m_attributes_require_verification_before_update_isSet = true;
}

bool OAICreateUserPoolRequest_UserAttributeUpdateSettings::is_attributes_require_verification_before_update_Set() const{
    return m_attributes_require_verification_before_update_isSet;
}

bool OAICreateUserPoolRequest_UserAttributeUpdateSettings::is_attributes_require_verification_before_update_Valid() const{
    return m_attributes_require_verification_before_update_isValid;
}

bool OAICreateUserPoolRequest_UserAttributeUpdateSettings::isSet() const {
...
bool OAICreateUserPoolRequest_UserAttributeUpdateSettings::isValid() const {
