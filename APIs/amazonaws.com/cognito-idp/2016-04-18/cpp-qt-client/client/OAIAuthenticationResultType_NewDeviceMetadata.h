...
/*
 * OAIAuthenticationResultType_NewDeviceMetadata.h
 *
 * 
 */

#ifndef OAIAuthenticationResultType_NewDeviceMetadata_H
#define OAIAuthenticationResultType_NewDeviceMetadata_H
...
class OAIAuthenticationResultType_NewDeviceMetadata : public OAIObject {
public:
    OAIAuthenticationResultType_NewDeviceMetadata();
    OAIAuthenticationResultType_NewDeviceMetadata(QString json);
    ~OAIAuthenticationResultType_NewDeviceMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAuthenticationResultType_NewDeviceMetadata)

#endif // OAIAuthenticationResultType_NewDeviceMetadata_H
