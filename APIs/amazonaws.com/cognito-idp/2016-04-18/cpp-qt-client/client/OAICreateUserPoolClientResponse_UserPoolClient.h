...
/*
 * OAICreateUserPoolClientResponse_UserPoolClient.h
 *
 * 
 */

#ifndef OAICreateUserPoolClientResponse_UserPoolClient_H
#define OAICreateUserPoolClientResponse_UserPoolClient_H
...
class OAICreateUserPoolClientResponse_UserPoolClient : public OAIObject {
public:
    OAICreateUserPoolClientResponse_UserPoolClient();
    OAICreateUserPoolClientResponse_UserPoolClient(QString json);
    ~OAICreateUserPoolClientResponse_UserPoolClient() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateUserPoolClientResponse_UserPoolClient)

#endif // OAICreateUserPoolClientResponse_UserPoolClient_H
