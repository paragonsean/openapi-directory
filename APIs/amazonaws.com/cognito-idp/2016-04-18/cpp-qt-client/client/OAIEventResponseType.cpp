...
OAIEventResponseType::OAIEventResponseType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEventResponseType::OAIEventResponseType() {
    this->initializeModel();
}

OAIEventResponseType::~OAIEventResponseType() {}

void OAIEventResponseType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIEventResponseType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIEventResponseType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("Pass", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEventResponseType::PASS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("Fail", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEventResponseType::FAIL;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("InProgress", Qt::CaseInsensitive) == 0) {
        m_value = eOAIEventResponseType::INPROGRESS;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIEventResponseType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIEventResponseType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIEventResponseType::PASS:
            val = "Pass";
            break;
        case eOAIEventResponseType::FAIL:
            val = "Fail";
            break;
        case eOAIEventResponseType::INPROGRESS:
            val = "InProgress";
            break;
        default:
            break;
...
QJsonValue OAIEventResponseType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIEventResponseType::eOAIEventResponseType OAIEventResponseType::getValue() const {
    return m_value;
}

void OAIEventResponseType::setValue(const OAIEventResponseType::eOAIEventResponseType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIEventResponseType::isSet() const {
    
    return m_value_isSet;
}

bool OAIEventResponseType::isValid() const {
