...
/*
 * OAIUserPoolPolicyType_PasswordPolicy.h
 *
 * 
 */

#ifndef OAIUserPoolPolicyType_PasswordPolicy_H
#define OAIUserPoolPolicyType_PasswordPolicy_H
...
class OAIUserPoolPolicyType_PasswordPolicy : public OAIObject {
public:
    OAIUserPoolPolicyType_PasswordPolicy();
    OAIUserPoolPolicyType_PasswordPolicy(QString json);
    ~OAIUserPoolPolicyType_PasswordPolicy() override;
    ...
    qint32 getMinimumLength() const;
    void setMinimumLength(const qint32 &minimum_length);
    bool is_minimum_length_Set() const;
    bool is_minimum_length_Valid() const;

    bool getRequireUppercase() const;
    void setRequireUppercase(const bool &require_uppercase);
    bool is_require_uppercase_Set() const;
    bool is_require_uppercase_Valid() const;

    bool getRequireLowercase() const;
    void setRequireLowercase(const bool &require_lowercase);
    bool is_require_lowercase_Set() const;
    bool is_require_lowercase_Valid() const;

    bool getRequireNumbers() const;
    void setRequireNumbers(const bool &require_numbers);
    bool is_require_numbers_Set() const;
    bool is_require_numbers_Valid() const;

    bool getRequireSymbols() const;
    void setRequireSymbols(const bool &require_symbols);
    bool is_require_symbols_Set() const;
    bool is_require_symbols_Valid() const;

    qint32 getTemporaryPasswordValidityDays() const;
    void setTemporaryPasswordValidityDays(const qint32 &temporary_password_validity_days);
    bool is_temporary_password_validity_days_Set() const;
    bool is_temporary_password_validity_days_Valid() const;
...
private:
    ...
    qint32 m_minimum_length;
    bool m_minimum_length_isSet;
    bool m_minimum_length_isValid;

    bool m_require_uppercase;
    bool m_require_uppercase_isSet;
    bool m_require_uppercase_isValid;

    bool m_require_lowercase;
    bool m_require_lowercase_isSet;
    bool m_require_lowercase_isValid;

    bool m_require_numbers;
    bool m_require_numbers_isSet;
    bool m_require_numbers_isValid;

    bool m_require_symbols;
    bool m_require_symbols_isSet;
    bool m_require_symbols_isValid;

    qint32 m_temporary_password_validity_days;
    bool m_temporary_password_validity_days_isSet;
    bool m_temporary_password_validity_days_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIUserPoolPolicyType_PasswordPolicy)

#endif // OAIUserPoolPolicyType_PasswordPolicy_H
