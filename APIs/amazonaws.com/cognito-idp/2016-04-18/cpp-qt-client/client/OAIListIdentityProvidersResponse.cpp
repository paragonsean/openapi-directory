...
QList OAIListIdentityProvidersResponse::getProviders() const {
    return m_providers;
}
void OAIListIdentityProvidersResponse::setProviders(const QList &providers) {
    m_providers = providers;
    m_providers_isSet = true;
}

bool OAIListIdentityProvidersResponse::is_providers_Set() const{
    return m_providers_isSet;
}

bool OAIListIdentityProvidersResponse::is_providers_Valid() const{
