...
/*
 * OAIGetGroupResponse.h
 *
 * 
 */

#ifndef OAIGetGroupResponse_H
#define OAIGetGroupResponse_H
...
class OAIGetGroupResponse : public OAIObject {
public:
    OAIGetGroupResponse();
    OAIGetGroupResponse(QString json);
    ~OAIGetGroupResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetGroupResponse)

#endif // OAIGetGroupResponse_H
