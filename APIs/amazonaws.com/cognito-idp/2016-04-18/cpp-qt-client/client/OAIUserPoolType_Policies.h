...
/*
 * OAIUserPoolType_Policies.h
 *
 * 
 */

#ifndef OAIUserPoolType_Policies_H
#define OAIUserPoolType_Policies_H
...
class OAIUserPoolType_Policies : public OAIObject {
public:
    OAIUserPoolType_Policies();
    OAIUserPoolType_Policies(QString json);
    ~OAIUserPoolType_Policies() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserPoolType_Policies)

#endif // OAIUserPoolType_Policies_H
