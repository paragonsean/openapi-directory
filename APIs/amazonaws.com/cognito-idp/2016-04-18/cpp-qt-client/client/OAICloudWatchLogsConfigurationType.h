...
/*
 * OAICloudWatchLogsConfigurationType.h
 *
 * The CloudWatch logging destination of a user pool detailed activity logging configuration.
 */

#ifndef OAICloudWatchLogsConfigurationType_H
#define OAICloudWatchLogsConfigurationType_H
...
class OAICloudWatchLogsConfigurationType : public OAIObject {
public:
    OAICloudWatchLogsConfigurationType();
    OAICloudWatchLogsConfigurationType(QString json);
    ~OAICloudWatchLogsConfigurationType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICloudWatchLogsConfigurationType)

#endif // OAICloudWatchLogsConfigurationType_H
