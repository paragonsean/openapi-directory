...
OAISetUserMFAPreferenceRequest::OAISetUserMFAPreferenceRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISetUserMFAPreferenceRequest::OAISetUserMFAPreferenceRequest() {
    this->initializeModel();
}

OAISetUserMFAPreferenceRequest::~OAISetUserMFAPreferenceRequest() {}

void OAISetUserMFAPreferenceRequest::initializeModel() {
...
void OAISetUserMFAPreferenceRequest::fromJson(QString jsonString) {
...
void OAISetUserMFAPreferenceRequest::fromJsonObject(QJsonObject json) {
...
QString OAISetUserMFAPreferenceRequest::asJson() const {
...
QJsonObject OAISetUserMFAPreferenceRequest::asJsonObject() const {
    QJsonObject obj;
...
OAISetUserMFAPreferenceRequest_SMSMfaSettings OAISetUserMFAPreferenceRequest::getSmsMfaSettings() const {
    return m_sms_mfa_settings;
}
void OAISetUserMFAPreferenceRequest::setSmsMfaSettings(const OAISetUserMFAPreferenceRequest_SMSMfaSettings &sms_mfa_settings) {
    m_sms_mfa_settings = sms_mfa_settings;
    m_sms_mfa_settings_isSet = true;
}

bool OAISetUserMFAPreferenceRequest::is_sms_mfa_settings_Set() const{
    return m_sms_mfa_settings_isSet;
}

bool OAISetUserMFAPreferenceRequest::is_sms_mfa_settings_Valid() const{
    return m_sms_mfa_settings_isValid;
}

OAISetUserMFAPreferenceRequest_SoftwareTokenMfaSettings OAISetUserMFAPreferenceRequest::getSoftwareTokenMfaSettings() const {
    return m_software_token_mfa_settings;
}
void OAISetUserMFAPreferenceRequest::setSoftwareTokenMfaSettings(const OAISetUserMFAPreferenceRequest_SoftwareTokenMfaSettings &software_token_mfa_settings) {
    m_software_token_mfa_settings = software_token_mfa_settings;
    m_software_token_mfa_settings_isSet = true;
}

bool OAISetUserMFAPreferenceRequest::is_software_token_mfa_settings_Set() const{
    return m_software_token_mfa_settings_isSet;
}

bool OAISetUserMFAPreferenceRequest::is_software_token_mfa_settings_Valid() const{
    return m_software_token_mfa_settings_isValid;
}

QString OAISetUserMFAPreferenceRequest::getAccessToken() const {
    return m_access_token;
}
void OAISetUserMFAPreferenceRequest::setAccessToken(const QString &access_token) {
    m_access_token = access_token;
    m_access_token_isSet = true;
}

bool OAISetUserMFAPreferenceRequest::is_access_token_Set() const{
    return m_access_token_isSet;
}

bool OAISetUserMFAPreferenceRequest::is_access_token_Valid() const{
    return m_access_token_isValid;
}

bool OAISetUserMFAPreferenceRequest::isSet() const {
...
bool OAISetUserMFAPreferenceRequest::isValid() const {
