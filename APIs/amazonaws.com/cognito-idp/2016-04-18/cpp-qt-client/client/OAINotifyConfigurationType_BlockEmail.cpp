...
OAINotifyConfigurationType_BlockEmail::OAINotifyConfigurationType_BlockEmail(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINotifyConfigurationType_BlockEmail::OAINotifyConfigurationType_BlockEmail() {
    this->initializeModel();
}

OAINotifyConfigurationType_BlockEmail::~OAINotifyConfigurationType_BlockEmail() {}

void OAINotifyConfigurationType_BlockEmail::initializeModel() {
...
void OAINotifyConfigurationType_BlockEmail::fromJson(QString jsonString) {
...
void OAINotifyConfigurationType_BlockEmail::fromJsonObject(QJsonObject json) {
...
QString OAINotifyConfigurationType_BlockEmail::asJson() const {
...
QJsonObject OAINotifyConfigurationType_BlockEmail::asJsonObject() const {
    QJsonObject obj;
    if (m_subject_isSet) {
...
QString OAINotifyConfigurationType_BlockEmail::getSubject() const {
    return m_subject;
}
void OAINotifyConfigurationType_BlockEmail::setSubject(const QString &subject) {
    m_subject = subject;
    m_subject_isSet = true;
}

bool OAINotifyConfigurationType_BlockEmail::is_subject_Set() const{
    return m_subject_isSet;
}

bool OAINotifyConfigurationType_BlockEmail::is_subject_Valid() const{
    return m_subject_isValid;
}

QString OAINotifyConfigurationType_BlockEmail::getHtmlBody() const {
    return m_html_body;
}
void OAINotifyConfigurationType_BlockEmail::setHtmlBody(const QString &html_body) {
    m_html_body = html_body;
    m_html_body_isSet = true;
}

bool OAINotifyConfigurationType_BlockEmail::is_html_body_Set() const{
    return m_html_body_isSet;
}

bool OAINotifyConfigurationType_BlockEmail::is_html_body_Valid() const{
    return m_html_body_isValid;
}

QString OAINotifyConfigurationType_BlockEmail::getTextBody() const {
    return m_text_body;
}
void OAINotifyConfigurationType_BlockEmail::setTextBody(const QString &text_body) {
    m_text_body = text_body;
    m_text_body_isSet = true;
}

bool OAINotifyConfigurationType_BlockEmail::is_text_body_Set() const{
    return m_text_body_isSet;
}

bool OAINotifyConfigurationType_BlockEmail::is_text_body_Valid() const{
    return m_text_body_isValid;
}

bool OAINotifyConfigurationType_BlockEmail::isSet() const {
...
bool OAINotifyConfigurationType_BlockEmail::isValid() const {
