...
#include "OAICompromisedCredentialsEventActionType.h"
...
OAICompromisedCredentialsEventActionType::OAICompromisedCredentialsEventActionType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICompromisedCredentialsEventActionType::OAICompromisedCredentialsEventActionType() {
    this->initializeModel();
}

OAICompromisedCredentialsEventActionType::~OAICompromisedCredentialsEventActionType() {}

void OAICompromisedCredentialsEventActionType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAICompromisedCredentialsEventActionType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAICompromisedCredentialsEventActionType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("BLOCK", Qt::CaseInsensitive) == 0) {
        m_value = eOAICompromisedCredentialsEventActionType::BLOCK;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("NO_ACTION", Qt::CaseInsensitive) == 0) {
        m_value = eOAICompromisedCredentialsEventActionType::NO_ACTION;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAICompromisedCredentialsEventActionType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAICompromisedCredentialsEventActionType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAICompromisedCredentialsEventActionType::BLOCK:
            val = "BLOCK";
            break;
        case eOAICompromisedCredentialsEventActionType::NO_ACTION:
            val = "NO_ACTION";
            break;
        default:
            break;
...
QJsonValue OAICompromisedCredentialsEventActionType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAICompromisedCredentialsEventActionType::eOAICompromisedCredentialsEventActionType OAICompromisedCredentialsEventActionType::getValue() const {
    return m_value;
}

void OAICompromisedCredentialsEventActionType::setValue(const OAICompromisedCredentialsEventActionType::eOAICompromisedCredentialsEventActionType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAICompromisedCredentialsEventActionType::isSet() const {
    
    return m_value_isSet;
}

bool OAICompromisedCredentialsEventActionType::isValid() const {
