...
OAIGetSigningCertificateRequest::OAIGetSigningCertificateRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetSigningCertificateRequest::OAIGetSigningCertificateRequest() {
    this->initializeModel();
}

OAIGetSigningCertificateRequest::~OAIGetSigningCertificateRequest() {}

void OAIGetSigningCertificateRequest::initializeModel() {

    m_user_pool_id_isSet = false;
    m_user_pool_id_isValid = false;
}

void OAIGetSigningCertificateRequest::fromJson(QString jsonString) {
...
void OAIGetSigningCertificateRequest::fromJsonObject(QJsonObject json) {
...
QString OAIGetSigningCertificateRequest::asJson() const {
...
QJsonObject OAIGetSigningCertificateRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetSigningCertificateRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIGetSigningCertificateRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIGetSigningCertificateRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIGetSigningCertificateRequest::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

bool OAIGetSigningCertificateRequest::isSet() const {
...
bool OAIGetSigningCertificateRequest::isValid() const {
