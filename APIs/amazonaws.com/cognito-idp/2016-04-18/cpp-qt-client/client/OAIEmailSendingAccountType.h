...
/*
 * OAIEmailSendingAccountType.h
 *
 * 
 */

#ifndef OAIEmailSendingAccountType_H
#define OAIEmailSendingAccountType_H
...
class OAIEmailSendingAccountType : public OAIEnum {
public:
    OAIEmailSendingAccountType();
    OAIEmailSendingAccountType(QString json);
    ~OAIEmailSendingAccountType() override;
    ...
    enum class eOAIEmailSendingAccountType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        COGNITO_DEFAULT, 
        DEVELOPER
    };
    OAIEmailSendingAccountType::eOAIEmailSendingAccountType getValue() const;
    void setValue(const OAIEmailSendingAccountType::eOAIEmailSendingAccountType& value);
...
private:
    ...
    eOAIEmailSendingAccountType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEmailSendingAccountType)

#endif // OAIEmailSendingAccountType_H
