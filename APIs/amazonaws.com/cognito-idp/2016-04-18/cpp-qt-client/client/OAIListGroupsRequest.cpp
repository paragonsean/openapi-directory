...
QString OAIListGroupsRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIListGroupsRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIListGroupsRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIListGroupsRequest::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

qint32 OAIListGroupsRequest::getLimit() const {
    return m_limit;
}
void OAIListGroupsRequest::setLimit(const qint32 &limit) {
    m_limit = limit;
    m_limit_isSet = true;
}

bool OAIListGroupsRequest::is_limit_Set() const{
    return m_limit_isSet;
}

bool OAIListGroupsRequest::is_limit_Valid() const{
