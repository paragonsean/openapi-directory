...
OAIUserStatusType::OAIUserStatusType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUserStatusType::OAIUserStatusType() {
    this->initializeModel();
}

OAIUserStatusType::~OAIUserStatusType() {}

void OAIUserStatusType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIUserStatusType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIUserStatusType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("UNCONFIRMED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIUserStatusType::UNCONFIRMED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("CONFIRMED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIUserStatusType::CONFIRMED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ARCHIVED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIUserStatusType::ARCHIVED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("COMPROMISED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIUserStatusType::COMPROMISED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("UNKNOWN", Qt::CaseInsensitive) == 0) {
        m_value = eOAIUserStatusType::UNKNOWN;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("RESET_REQUIRED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIUserStatusType::RESET_REQUIRED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("FORCE_CHANGE_PASSWORD", Qt::CaseInsensitive) == 0) {
        m_value = eOAIUserStatusType::FORCE_CHANGE_PASSWORD;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIUserStatusType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIUserStatusType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIUserStatusType::UNCONFIRMED:
            val = "UNCONFIRMED";
            break;
        case eOAIUserStatusType::CONFIRMED:
            val = "CONFIRMED";
            break;
        case eOAIUserStatusType::ARCHIVED:
            val = "ARCHIVED";
            break;
        case eOAIUserStatusType::COMPROMISED:
            val = "COMPROMISED";
            break;
        case eOAIUserStatusType::UNKNOWN:
            val = "UNKNOWN";
            break;
        case eOAIUserStatusType::RESET_REQUIRED:
            val = "RESET_REQUIRED";
            break;
        case eOAIUserStatusType::FORCE_CHANGE_PASSWORD:
            val = "FORCE_CHANGE_PASSWORD";
            break;
        default:
            break;
    }
...
QJsonValue OAIUserStatusType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIUserStatusType::eOAIUserStatusType OAIUserStatusType::getValue() const {
    return m_value;
}

void OAIUserStatusType::setValue(const OAIUserStatusType::eOAIUserStatusType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIUserStatusType::isSet() const {
    
    return m_value_isSet;
}

bool OAIUserStatusType::isValid() const {
