...
/*
 * OAIAccountTakeoverActionsType_LowAction.h
 *
 * 
 */

#ifndef OAIAccountTakeoverActionsType_LowAction_H
#define OAIAccountTakeoverActionsType_LowAction_H
...
class OAIAccountTakeoverActionsType_LowAction : public OAIObject {
public:
    OAIAccountTakeoverActionsType_LowAction();
    OAIAccountTakeoverActionsType_LowAction(QString json);
    ~OAIAccountTakeoverActionsType_LowAction() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccountTakeoverActionsType_LowAction)

#endif // OAIAccountTakeoverActionsType_LowAction_H
