...
/*
 * OAIListUserPoolClientsRequest.h
 *
 * Represents the request to list the user pool clients.
 */

#ifndef OAIListUserPoolClientsRequest_H
#define OAIListUserPoolClientsRequest_H
...
class OAIListUserPoolClientsRequest : public OAIObject {
public:
    OAIListUserPoolClientsRequest();
    OAIListUserPoolClientsRequest(QString json);
    ~OAIListUserPoolClientsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListUserPoolClientsRequest)

#endif // OAIListUserPoolClientsRequest_H
