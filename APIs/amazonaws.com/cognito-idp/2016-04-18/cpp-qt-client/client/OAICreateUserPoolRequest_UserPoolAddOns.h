...
/*
 * OAICreateUserPoolRequest_UserPoolAddOns.h
 *
 * 
 */

#ifndef OAICreateUserPoolRequest_UserPoolAddOns_H
#define OAICreateUserPoolRequest_UserPoolAddOns_H
...
class OAICreateUserPoolRequest_UserPoolAddOns : public OAIObject {
public:
    OAICreateUserPoolRequest_UserPoolAddOns();
    OAICreateUserPoolRequest_UserPoolAddOns(QString json);
    ~OAICreateUserPoolRequest_UserPoolAddOns() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateUserPoolRequest_UserPoolAddOns)

#endif // OAICreateUserPoolRequest_UserPoolAddOns_H
