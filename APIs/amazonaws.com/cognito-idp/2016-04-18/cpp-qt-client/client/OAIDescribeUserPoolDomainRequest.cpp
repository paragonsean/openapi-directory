...
OAIDescribeUserPoolDomainRequest::OAIDescribeUserPoolDomainRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeUserPoolDomainRequest::OAIDescribeUserPoolDomainRequest() {
    this->initializeModel();
}

OAIDescribeUserPoolDomainRequest::~OAIDescribeUserPoolDomainRequest() {}

void OAIDescribeUserPoolDomainRequest::initializeModel() {

    m_domain_isSet = false;
    m_domain_isValid = false;
}

void OAIDescribeUserPoolDomainRequest::fromJson(QString jsonString) {
...
void OAIDescribeUserPoolDomainRequest::fromJsonObject(QJsonObject json) {

    m_domain_isValid = ::OpenAPI::fromJsonValue(m_domain, json[QString("Domain")]);
    m_domain_isSet = !json[QString("Domain")].isNull() && m_domain_isValid;
}

QString OAIDescribeUserPoolDomainRequest::asJson() const {
...
QJsonObject OAIDescribeUserPoolDomainRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_domain_isSet) {
...
QString OAIDescribeUserPoolDomainRequest::getDomain() const {
    return m_domain;
}
void OAIDescribeUserPoolDomainRequest::setDomain(const QString &domain) {
    m_domain = domain;
    m_domain_isSet = true;
}

bool OAIDescribeUserPoolDomainRequest::is_domain_Set() const{
    return m_domain_isSet;
}

bool OAIDescribeUserPoolDomainRequest::is_domain_Valid() const{
    return m_domain_isValid;
}

bool OAIDescribeUserPoolDomainRequest::isSet() const {
...
bool OAIDescribeUserPoolDomainRequest::isValid() const {
