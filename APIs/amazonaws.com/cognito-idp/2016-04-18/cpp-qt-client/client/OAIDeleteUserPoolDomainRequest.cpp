...
OAIDeleteUserPoolDomainRequest::OAIDeleteUserPoolDomainRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteUserPoolDomainRequest::OAIDeleteUserPoolDomainRequest() {
    this->initializeModel();
}

OAIDeleteUserPoolDomainRequest::~OAIDeleteUserPoolDomainRequest() {}

void OAIDeleteUserPoolDomainRequest::initializeModel() {
...
void OAIDeleteUserPoolDomainRequest::fromJson(QString jsonString) {
...
void OAIDeleteUserPoolDomainRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteUserPoolDomainRequest::asJson() const {
...
QJsonObject OAIDeleteUserPoolDomainRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_domain_isSet) {
...
QString OAIDeleteUserPoolDomainRequest::getDomain() const {
    return m_domain;
}
void OAIDeleteUserPoolDomainRequest::setDomain(const QString &domain) {
    m_domain = domain;
    m_domain_isSet = true;
}

bool OAIDeleteUserPoolDomainRequest::is_domain_Set() const{
    return m_domain_isSet;
}

bool OAIDeleteUserPoolDomainRequest::is_domain_Valid() const{
    return m_domain_isValid;
}

QString OAIDeleteUserPoolDomainRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIDeleteUserPoolDomainRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIDeleteUserPoolDomainRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIDeleteUserPoolDomainRequest::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

bool OAIDeleteUserPoolDomainRequest::isSet() const {
...
bool OAIDeleteUserPoolDomainRequest::isValid() const {
