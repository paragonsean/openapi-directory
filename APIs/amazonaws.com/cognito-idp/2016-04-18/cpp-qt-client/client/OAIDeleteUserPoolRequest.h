...
/*
 * OAIDeleteUserPoolRequest.h
 *
 * Represents the request to delete a user pool.
 */

#ifndef OAIDeleteUserPoolRequest_H
#define OAIDeleteUserPoolRequest_H
...
class OAIDeleteUserPoolRequest : public OAIObject {
public:
    OAIDeleteUserPoolRequest();
    OAIDeleteUserPoolRequest(QString json);
    ~OAIDeleteUserPoolRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteUserPoolRequest)

#endif // OAIDeleteUserPoolRequest_H
