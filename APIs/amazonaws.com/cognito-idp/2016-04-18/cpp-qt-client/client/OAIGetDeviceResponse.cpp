...
OAIAdminGetDeviceResponse_Device OAIGetDeviceResponse::getDevice() const {
    return m_device;
}
void OAIGetDeviceResponse::setDevice(const OAIAdminGetDeviceResponse_Device &device) {
    m_device = device;
    m_device_isSet = true;
}

bool OAIGetDeviceResponse::is_device_Set() const{
    return m_device_isSet;
}

bool OAIGetDeviceResponse::is_device_Valid() const{
