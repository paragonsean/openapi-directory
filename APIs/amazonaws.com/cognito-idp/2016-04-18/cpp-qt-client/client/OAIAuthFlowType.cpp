...
OAIAuthFlowType::OAIAuthFlowType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAuthFlowType::OAIAuthFlowType() {
    this->initializeModel();
}

OAIAuthFlowType::~OAIAuthFlowType() {}

void OAIAuthFlowType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIAuthFlowType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIAuthFlowType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("USER_SRP_AUTH", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAuthFlowType::USER_SRP_AUTH;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("REFRESH_TOKEN_AUTH", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAuthFlowType::REFRESH_TOKEN_AUTH;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("REFRESH_TOKEN", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAuthFlowType::REFRESH_TOKEN;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("CUSTOM_AUTH", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAuthFlowType::CUSTOM_AUTH;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ADMIN_NO_SRP_AUTH", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAuthFlowType::ADMIN_NO_SRP_AUTH;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("USER_PASSWORD_AUTH", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAuthFlowType::USER_PASSWORD_AUTH;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ADMIN_USER_PASSWORD_AUTH", Qt::CaseInsensitive) == 0) {
        m_value = eOAIAuthFlowType::ADMIN_USER_PASSWORD_AUTH;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIAuthFlowType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIAuthFlowType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIAuthFlowType::USER_SRP_AUTH:
            val = "USER_SRP_AUTH";
            break;
        case eOAIAuthFlowType::REFRESH_TOKEN_AUTH:
            val = "REFRESH_TOKEN_AUTH";
            break;
        case eOAIAuthFlowType::REFRESH_TOKEN:
            val = "REFRESH_TOKEN";
            break;
        case eOAIAuthFlowType::CUSTOM_AUTH:
            val = "CUSTOM_AUTH";
            break;
        case eOAIAuthFlowType::ADMIN_NO_SRP_AUTH:
            val = "ADMIN_NO_SRP_AUTH";
            break;
        case eOAIAuthFlowType::USER_PASSWORD_AUTH:
            val = "USER_PASSWORD_AUTH";
            break;
        case eOAIAuthFlowType::ADMIN_USER_PASSWORD_AUTH:
            val = "ADMIN_USER_PASSWORD_AUTH";
            break;
        default:
            break;
    }
...
QJsonValue OAIAuthFlowType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIAuthFlowType::eOAIAuthFlowType OAIAuthFlowType::getValue() const {
    return m_value;
}

void OAIAuthFlowType::setValue(const OAIAuthFlowType::eOAIAuthFlowType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIAuthFlowType::isSet() const {
    
    return m_value_isSet;
}

bool OAIAuthFlowType::isValid() const {
