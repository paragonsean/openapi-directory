...
OAICreateResourceServerResponse::OAICreateResourceServerResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateResourceServerResponse::OAICreateResourceServerResponse() {
    this->initializeModel();
}

OAICreateResourceServerResponse::~OAICreateResourceServerResponse() {}

void OAICreateResourceServerResponse::initializeModel() {

    m_resource_server_isSet = false;
    m_resource_server_isValid = false;
}

void OAICreateResourceServerResponse::fromJson(QString jsonString) {
...
void OAICreateResourceServerResponse::fromJsonObject(QJsonObject json) {
...
QString OAICreateResourceServerResponse::asJson() const {
...
QJsonObject OAICreateResourceServerResponse::asJsonObject() const {
    QJsonObject obj;
...
OAICreateResourceServerResponse_ResourceServer OAICreateResourceServerResponse::getResourceServer() const {
    return m_resource_server;
}
void OAICreateResourceServerResponse::setResourceServer(const OAICreateResourceServerResponse_ResourceServer &resource_server) {
    m_resource_server = resource_server;
    m_resource_server_isSet = true;
}

bool OAICreateResourceServerResponse::is_resource_server_Set() const{
    return m_resource_server_isSet;
}

bool OAICreateResourceServerResponse::is_resource_server_Valid() const{
    return m_resource_server_isValid;
}

bool OAICreateResourceServerResponse::isSet() const {
...
bool OAICreateResourceServerResponse::isValid() const {
