...
OAISetLogDeliveryConfigurationResponse::OAISetLogDeliveryConfigurationResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISetLogDeliveryConfigurationResponse::OAISetLogDeliveryConfigurationResponse() {
    this->initializeModel();
}

OAISetLogDeliveryConfigurationResponse::~OAISetLogDeliveryConfigurationResponse() {}

void OAISetLogDeliveryConfigurationResponse::initializeModel() {

    m_log_delivery_configuration_isSet = false;
    m_log_delivery_configuration_isValid = false;
}

void OAISetLogDeliveryConfigurationResponse::fromJson(QString jsonString) {
...
void OAISetLogDeliveryConfigurationResponse::fromJsonObject(QJsonObject json) {
...
QString OAISetLogDeliveryConfigurationResponse::asJson() const {
...
QJsonObject OAISetLogDeliveryConfigurationResponse::asJsonObject() const {
    QJsonObject obj;
...
OAISetLogDeliveryConfigurationResponse_LogDeliveryConfiguration OAISetLogDeliveryConfigurationResponse::getLogDeliveryConfiguration() const {
    return m_log_delivery_configuration;
}
void OAISetLogDeliveryConfigurationResponse::setLogDeliveryConfiguration(const OAISetLogDeliveryConfigurationResponse_LogDeliveryConfiguration &log_delivery_configuration) {
    m_log_delivery_configuration = log_delivery_configuration;
    m_log_delivery_configuration_isSet = true;
}

bool OAISetLogDeliveryConfigurationResponse::is_log_delivery_configuration_Set() const{
    return m_log_delivery_configuration_isSet;
}

bool OAISetLogDeliveryConfigurationResponse::is_log_delivery_configuration_Valid() const{
    return m_log_delivery_configuration_isValid;
}

bool OAISetLogDeliveryConfigurationResponse::isSet() const {
...
bool OAISetLogDeliveryConfigurationResponse::isValid() const {
