...
OAIGlobalSignOutRequest::OAIGlobalSignOutRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGlobalSignOutRequest::OAIGlobalSignOutRequest() {
    this->initializeModel();
}

OAIGlobalSignOutRequest::~OAIGlobalSignOutRequest() {}

void OAIGlobalSignOutRequest::initializeModel() {

    m_access_token_isSet = false;
    m_access_token_isValid = false;
}

void OAIGlobalSignOutRequest::fromJson(QString jsonString) {
...
void OAIGlobalSignOutRequest::fromJsonObject(QJsonObject json) {
...
QString OAIGlobalSignOutRequest::asJson() const {
...
QJsonObject OAIGlobalSignOutRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGlobalSignOutRequest::getAccessToken() const {
    return m_access_token;
}
void OAIGlobalSignOutRequest::setAccessToken(const QString &access_token) {
    m_access_token = access_token;
    m_access_token_isSet = true;
}

bool OAIGlobalSignOutRequest::is_access_token_Set() const{
    return m_access_token_isSet;
}

bool OAIGlobalSignOutRequest::is_access_token_Valid() const{
    return m_access_token_isValid;
}

bool OAIGlobalSignOutRequest::isSet() const {
...
bool OAIGlobalSignOutRequest::isValid() const {
