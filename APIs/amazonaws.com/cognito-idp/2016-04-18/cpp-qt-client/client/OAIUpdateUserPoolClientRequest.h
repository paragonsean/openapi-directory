...
/*
 * OAIUpdateUserPoolClientRequest.h
 *
 * Represents the request to update the user pool client.
 */

#ifndef OAIUpdateUserPoolClientRequest_H
#define OAIUpdateUserPoolClientRequest_H

#include <QJsonObject>

#include "OAIPreventUserExistenceErrorTypes.h"
#include "OAIUpdateUserPoolClientRequest_AnalyticsConfiguration.h"
...
namespace OpenAPI {
class OAIUpdateUserPoolClientRequest_TokenValidityUnits;
class OAIUpdateUserPoolClientRequest_AnalyticsConfiguration;

class OAIUpdateUserPoolClientRequest : public OAIObject {
public:
    OAIUpdateUserPoolClientRequest();
    OAIUpdateUserPoolClientRequest(QString json);
    ~OAIUpdateUserPoolClientRequest() override;
    ...
    OAIUpdateUserPoolClientRequest_TokenValidityUnits getTokenValidityUnits() const;
    void setTokenValidityUnits(const OAIUpdateUserPoolClientRequest_TokenValidityUnits &token_validity_units);
    ...
    OAIUpdateUserPoolClientRequest_AnalyticsConfiguration getAnalyticsConfiguration() const;
    void setAnalyticsConfiguration(const OAIUpdateUserPoolClientRequest_AnalyticsConfiguration &analytics_configuration);
...
private:
    ...
    OAIUpdateUserPoolClientRequest_TokenValidityUnits m_token_validity_units;
    ...
    OAIUpdateUserPoolClientRequest_AnalyticsConfiguration m_analytics_configuration;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateUserPoolClientRequest)

#endif // OAIUpdateUserPoolClientRequest_H
