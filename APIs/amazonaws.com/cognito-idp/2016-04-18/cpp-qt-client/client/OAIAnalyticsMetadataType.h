...
#ifndef OAIAnalyticsMetadataType_H
#define OAIAnalyticsMetadataType_H
...
class OAIAnalyticsMetadataType : public OAIObject {
public:
    OAIAnalyticsMetadataType();
    OAIAnalyticsMetadataType(QString json);
    ~OAIAnalyticsMetadataType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAnalyticsMetadataType)

#endif // OAIAnalyticsMetadataType_H
