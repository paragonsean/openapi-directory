...
#include "OAIEventFeedbackType.h"
...
OAIEventFeedbackType::OAIEventFeedbackType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEventFeedbackType::OAIEventFeedbackType() {
    this->initializeModel();
}

OAIEventFeedbackType::~OAIEventFeedbackType() {}

void OAIEventFeedbackType::initializeModel() {
...
void OAIEventFeedbackType::fromJson(QString jsonString) {
...
void OAIEventFeedbackType::fromJsonObject(QJsonObject json) {
...
QString OAIEventFeedbackType::asJson() const {
...
QJsonObject OAIEventFeedbackType::asJsonObject() const {
    QJsonObject obj;
...
OAIFeedbackValueType OAIEventFeedbackType::getFeedbackValue() const {
    return m_feedback_value;
}
void OAIEventFeedbackType::setFeedbackValue(const OAIFeedbackValueType &feedback_value) {
    m_feedback_value = feedback_value;
    m_feedback_value_isSet = true;
}

bool OAIEventFeedbackType::is_feedback_value_Set() const{
    return m_feedback_value_isSet;
}

bool OAIEventFeedbackType::is_feedback_value_Valid() const{
    return m_feedback_value_isValid;
}

QString OAIEventFeedbackType::getProvider() const {
    return m_provider;
}
void OAIEventFeedbackType::setProvider(const QString &provider) {
    m_provider = provider;
    m_provider_isSet = true;
}

bool OAIEventFeedbackType::is_provider_Set() const{
    return m_provider_isSet;
}

bool OAIEventFeedbackType::is_provider_Valid() const{
    return m_provider_isValid;
}

QDateTime OAIEventFeedbackType::getFeedbackDate() const {
    return m_feedback_date;
}
void OAIEventFeedbackType::setFeedbackDate(const QDateTime &feedback_date) {
    m_feedback_date = feedback_date;
    m_feedback_date_isSet = true;
}

bool OAIEventFeedbackType::is_feedback_date_Set() const{
    return m_feedback_date_isSet;
}

bool OAIEventFeedbackType::is_feedback_date_Valid() const{
    return m_feedback_date_isValid;
}

bool OAIEventFeedbackType::isSet() const {
...
bool OAIEventFeedbackType::isValid() const {
