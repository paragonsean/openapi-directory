...
#include "OAISchemaAttributeType_StringAttributeConstraints.h"
...
OAISchemaAttributeType_StringAttributeConstraints::OAISchemaAttributeType_StringAttributeConstraints(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISchemaAttributeType_StringAttributeConstraints::OAISchemaAttributeType_StringAttributeConstraints() {
    this->initializeModel();
}

OAISchemaAttributeType_StringAttributeConstraints::~OAISchemaAttributeType_StringAttributeConstraints() {}

void OAISchemaAttributeType_StringAttributeConstraints::initializeModel() {
...
void OAISchemaAttributeType_StringAttributeConstraints::fromJson(QString jsonString) {
...
void OAISchemaAttributeType_StringAttributeConstraints::fromJsonObject(QJsonObject json) {
...
QString OAISchemaAttributeType_StringAttributeConstraints::asJson() const {
...
QJsonObject OAISchemaAttributeType_StringAttributeConstraints::asJsonObject() const {
    QJsonObject obj;
...
QString OAISchemaAttributeType_StringAttributeConstraints::getMinLength() const {
    return m_min_length;
}
void OAISchemaAttributeType_StringAttributeConstraints::setMinLength(const QString &min_length) {
    m_min_length = min_length;
    m_min_length_isSet = true;
}

bool OAISchemaAttributeType_StringAttributeConstraints::is_min_length_Set() const{
    return m_min_length_isSet;
}

bool OAISchemaAttributeType_StringAttributeConstraints::is_min_length_Valid() const{
    return m_min_length_isValid;
}

QString OAISchemaAttributeType_StringAttributeConstraints::getMaxLength() const {
    return m_max_length;
}
void OAISchemaAttributeType_StringAttributeConstraints::setMaxLength(const QString &max_length) {
    m_max_length = max_length;
    m_max_length_isSet = true;
}

bool OAISchemaAttributeType_StringAttributeConstraints::is_max_length_Set() const{
    return m_max_length_isSet;
}

bool OAISchemaAttributeType_StringAttributeConstraints::is_max_length_Valid() const{
    return m_max_length_isValid;
}

bool OAISchemaAttributeType_StringAttributeConstraints::isSet() const {
...
bool OAISchemaAttributeType_StringAttributeConstraints::isValid() const {
