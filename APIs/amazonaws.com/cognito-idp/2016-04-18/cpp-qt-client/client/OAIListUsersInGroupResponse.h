...
/*
 * OAIListUsersInGroupResponse.h
 *
 * 
 */

#ifndef OAIListUsersInGroupResponse_H
#define OAIListUsersInGroupResponse_H
...
class OAIListUsersInGroupResponse : public OAIObject {
public:
    OAIListUsersInGroupResponse();
    OAIListUsersInGroupResponse(QString json);
    ~OAIListUsersInGroupResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListUsersInGroupResponse)

#endif // OAIListUsersInGroupResponse_H
