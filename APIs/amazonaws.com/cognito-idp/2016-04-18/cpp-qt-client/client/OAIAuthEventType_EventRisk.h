...
/*
 * OAIAuthEventType_EventRisk.h
 *
 * 
 */

#ifndef OAIAuthEventType_EventRisk_H
#define OAIAuthEventType_EventRisk_H
...
class OAIAuthEventType_EventRisk : public OAIObject {
public:
    OAIAuthEventType_EventRisk();
    OAIAuthEventType_EventRisk(QString json);
    ~OAIAuthEventType_EventRisk() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAuthEventType_EventRisk)

#endif // OAIAuthEventType_EventRisk_H
