...
/*
 * OAIUserPoolMfaType.h
 *
 * 
 */

#ifndef OAIUserPoolMfaType_H
#define OAIUserPoolMfaType_H
...
class OAIUserPoolMfaType : public OAIEnum {
public:
    OAIUserPoolMfaType();
    OAIUserPoolMfaType(QString json);
    ~OAIUserPoolMfaType() override;
    ...
    enum class eOAIUserPoolMfaType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        OFF, 
        ON, 
        OPTIONAL
    };
    OAIUserPoolMfaType::eOAIUserPoolMfaType getValue() const;
    void setValue(const OAIUserPoolMfaType::eOAIUserPoolMfaType& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserPoolMfaType)

#endif // OAIUserPoolMfaType_H
