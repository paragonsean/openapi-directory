...
#include "OAINewDeviceMetadataType.h"
...
OAINewDeviceMetadataType::OAINewDeviceMetadataType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINewDeviceMetadataType::OAINewDeviceMetadataType() {
    this->initializeModel();
}

OAINewDeviceMetadataType::~OAINewDeviceMetadataType() {}

void OAINewDeviceMetadataType::initializeModel() {
...
void OAINewDeviceMetadataType::fromJson(QString jsonString) {
...
void OAINewDeviceMetadataType::fromJsonObject(QJsonObject json) {
...
QString OAINewDeviceMetadataType::asJson() const {
...
QJsonObject OAINewDeviceMetadataType::asJsonObject() const {
    QJsonObject obj;
...
QString OAINewDeviceMetadataType::getDeviceKey() const {
    return m_device_key;
}
void OAINewDeviceMetadataType::setDeviceKey(const QString &device_key) {
    m_device_key = device_key;
    m_device_key_isSet = true;
}

bool OAINewDeviceMetadataType::is_device_key_Set() const{
    return m_device_key_isSet;
}

bool OAINewDeviceMetadataType::is_device_key_Valid() const{
    return m_device_key_isValid;
}

QString OAINewDeviceMetadataType::getDeviceGroupKey() const {
    return m_device_group_key;
}
void OAINewDeviceMetadataType::setDeviceGroupKey(const QString &device_group_key) {
    m_device_group_key = device_group_key;
    m_device_group_key_isSet = true;
}

bool OAINewDeviceMetadataType::is_device_group_key_Set() const{
    return m_device_group_key_isSet;
}

bool OAINewDeviceMetadataType::is_device_group_key_Valid() const{
    return m_device_group_key_isValid;
}

bool OAINewDeviceMetadataType::isSet() const {
...
bool OAINewDeviceMetadataType::isValid() const {
