...
OAIAdminRespondToAuthChallengeResponse_AuthenticationResult::OAIAdminRespondToAuthChallengeResponse_AuthenticationResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdminRespondToAuthChallengeResponse_AuthenticationResult::OAIAdminRespondToAuthChallengeResponse_AuthenticationResult() {
    this->initializeModel();
}

OAIAdminRespondToAuthChallengeResponse_AuthenticationResult::~OAIAdminRespondToAuthChallengeResponse_AuthenticationResult() {}

void OAIAdminRespondToAuthChallengeResponse_AuthenticationResult::initializeModel() {
...
void OAIAdminRespondToAuthChallengeResponse_AuthenticationResult::fromJson(QString jsonString) {
...
void OAIAdminRespondToAuthChallengeResponse_AuthenticationResult::fromJsonObject(QJsonObject json) {
...
QString OAIAdminRespondToAuthChallengeResponse_AuthenticationResult::asJson() const {
...
QJsonObject OAIAdminRespondToAuthChallengeResponse_AuthenticationResult::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAdminRespondToAuthChallengeResponse_AuthenticationResult::getAccessToken() const {
    return m_access_token;
}
void OAIAdminRespondToAuthChallengeResponse_AuthenticationResult::setAccessToken(const QString &access_token) {
    m_access_token = access_token;
    m_access_token_isSet = true;
}

bool OAIAdminRespondToAuthChallengeResponse_AuthenticationResult::is_access_token_Set() const{
    return m_access_token_isSet;
}

bool OAIAdminRespondToAuthChallengeResponse_AuthenticationResult::is_access_token_Valid() const{
    return m_access_token_isValid;
}

qint32 OAIAdminRespondToAuthChallengeResponse_AuthenticationResult::getExpiresIn() const {
    return m_expires_in;
}
void OAIAdminRespondToAuthChallengeResponse_AuthenticationResult::setExpiresIn(const qint32 &expires_in) {
    m_expires_in = expires_in;
    m_expires_in_isSet = true;
}

bool OAIAdminRespondToAuthChallengeResponse_AuthenticationResult::is_expires_in_Set() const{
    return m_expires_in_isSet;
}

bool OAIAdminRespondToAuthChallengeResponse_AuthenticationResult::is_expires_in_Valid() const{
    return m_expires_in_isValid;
}

QString OAIAdminRespondToAuthChallengeResponse_AuthenticationResult::getTokenType() const {
    return m_token_type;
}
void OAIAdminRespondToAuthChallengeResponse_AuthenticationResult::setTokenType(const QString &token_type) {
    m_token_type = token_type;
    m_token_type_isSet = true;
}

bool OAIAdminRespondToAuthChallengeResponse_AuthenticationResult::is_token_type_Set() const{
    return m_token_type_isSet;
}

bool OAIAdminRespondToAuthChallengeResponse_AuthenticationResult::is_token_type_Valid() const{
    return m_token_type_isValid;
}

QString OAIAdminRespondToAuthChallengeResponse_AuthenticationResult::getRefreshToken() const {
    return m_refresh_token;
}
void OAIAdminRespondToAuthChallengeResponse_AuthenticationResult::setRefreshToken(const QString &refresh_token) {
    m_refresh_token = refresh_token;
    m_refresh_token_isSet = true;
}

bool OAIAdminRespondToAuthChallengeResponse_AuthenticationResult::is_refresh_token_Set() const{
    return m_refresh_token_isSet;
}

bool OAIAdminRespondToAuthChallengeResponse_AuthenticationResult::is_refresh_token_Valid() const{
    return m_refresh_token_isValid;
}

QString OAIAdminRespondToAuthChallengeResponse_AuthenticationResult::getIdToken() const {
    return m_id_token;
}
void OAIAdminRespondToAuthChallengeResponse_AuthenticationResult::setIdToken(const QString &id_token) {
    m_id_token = id_token;
    m_id_token_isSet = true;
}

bool OAIAdminRespondToAuthChallengeResponse_AuthenticationResult::is_id_token_Set() const{
    return m_id_token_isSet;
}

bool OAIAdminRespondToAuthChallengeResponse_AuthenticationResult::is_id_token_Valid() const{
    return m_id_token_isValid;
}

OAIAuthenticationResultType_NewDeviceMetadata OAIAdminRespondToAuthChallengeResponse_AuthenticationResult::getNewDeviceMetadata() const {
    return m_new_device_metadata;
}
void OAIAdminRespondToAuthChallengeResponse_AuthenticationResult::setNewDeviceMetadata(const OAIAuthenticationResultType_NewDeviceMetadata &new_device_metadata) {
    m_new_device_metadata = new_device_metadata;
    m_new_device_metadata_isSet = true;
}

bool OAIAdminRespondToAuthChallengeResponse_AuthenticationResult::is_new_device_metadata_Set() const{
    return m_new_device_metadata_isSet;
}

bool OAIAdminRespondToAuthChallengeResponse_AuthenticationResult::is_new_device_metadata_Valid() const{
    return m_new_device_metadata_isValid;
}

bool OAIAdminRespondToAuthChallengeResponse_AuthenticationResult::isSet() const {
...
bool OAIAdminRespondToAuthChallengeResponse_AuthenticationResult::isValid() const {
