...
/*
 * OAIDescribeResourceServerResponse.h
 *
 * 
 */

#ifndef OAIDescribeResourceServerResponse_H
#define OAIDescribeResourceServerResponse_H
...
namespace OpenAPI {
class OAIDescribeResourceServerResponse_ResourceServer;

class OAIDescribeResourceServerResponse : public OAIObject {
public:
    OAIDescribeResourceServerResponse();
    OAIDescribeResourceServerResponse(QString json);
    ~OAIDescribeResourceServerResponse() override;
    ...
    OAIDescribeResourceServerResponse_ResourceServer getResourceServer() const;
    void setResourceServer(const OAIDescribeResourceServerResponse_ResourceServer &resource_server);
    bool is_resource_server_Set() const;
    bool is_resource_server_Valid() const;
...
private:
    ...
    OAIDescribeResourceServerResponse_ResourceServer m_resource_server;
    bool m_resource_server_isSet;
    bool m_resource_server_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDescribeResourceServerResponse)

#endif // OAIDescribeResourceServerResponse_H
