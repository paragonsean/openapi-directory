...
/*
 * OAICreateResourceServerResponse.h
 *
 * 
 */

#ifndef OAICreateResourceServerResponse_H
#define OAICreateResourceServerResponse_H
...
namespace OpenAPI {
class OAICreateResourceServerResponse_ResourceServer;

class OAICreateResourceServerResponse : public OAIObject {
public:
    OAICreateResourceServerResponse();
    OAICreateResourceServerResponse(QString json);
    ~OAICreateResourceServerResponse() override;
    ...
    OAICreateResourceServerResponse_ResourceServer getResourceServer() const;
    void setResourceServer(const OAICreateResourceServerResponse_ResourceServer &resource_server);
...
private:
    ...
    OAICreateResourceServerResponse_ResourceServer m_resource_server;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateResourceServerResponse)

#endif // OAICreateResourceServerResponse_H
