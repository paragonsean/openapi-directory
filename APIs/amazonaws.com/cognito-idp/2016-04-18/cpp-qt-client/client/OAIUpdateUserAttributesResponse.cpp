...
OAIUpdateUserAttributesResponse::OAIUpdateUserAttributesResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateUserAttributesResponse::OAIUpdateUserAttributesResponse() {
    this->initializeModel();
}

OAIUpdateUserAttributesResponse::~OAIUpdateUserAttributesResponse() {}

void OAIUpdateUserAttributesResponse::initializeModel() {

    m_code_delivery_details_list_isSet = false;
    m_code_delivery_details_list_isValid = false;
}

void OAIUpdateUserAttributesResponse::fromJson(QString jsonString) {
...
void OAIUpdateUserAttributesResponse::fromJsonObject(QJsonObject json) {

    m_code_delivery_details_list_isValid = ::OpenAPI::fromJsonValue(m_code_delivery_details_list, json[QString("CodeDeliveryDetailsList")]);
    m_code_delivery_details_list_isSet = !json[QString("CodeDeliveryDetailsList")].isNull() && m_code_delivery_details_list_isValid;
}

QString OAIUpdateUserAttributesResponse::asJson() const {
...
QJsonObject OAIUpdateUserAttributesResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_code_delivery_details_list.isSet()) {
        obj.insert(QString("CodeDeliveryDetailsList"), ::OpenAPI::toJsonValue(m_code_delivery_details_list));
    }
    return obj;
}

QList OAIUpdateUserAttributesResponse::getCodeDeliveryDetailsList() const {
    return m_code_delivery_details_list;
}
void OAIUpdateUserAttributesResponse::setCodeDeliveryDetailsList(const QList &code_delivery_details_list) {
    m_code_delivery_details_list = code_delivery_details_list;
    m_code_delivery_details_list_isSet = true;
}

bool OAIUpdateUserAttributesResponse::is_code_delivery_details_list_Set() const{
    return m_code_delivery_details_list_isSet;
}

bool OAIUpdateUserAttributesResponse::is_code_delivery_details_list_Valid() const{
    return m_code_delivery_details_list_isValid;
}

bool OAIUpdateUserAttributesResponse::isSet() const {
...
bool OAIUpdateUserAttributesResponse::isValid() const {
