...
OAISignUpResponse_CodeDeliveryDetails::OAISignUpResponse_CodeDeliveryDetails(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISignUpResponse_CodeDeliveryDetails::OAISignUpResponse_CodeDeliveryDetails() {
    this->initializeModel();
}

OAISignUpResponse_CodeDeliveryDetails::~OAISignUpResponse_CodeDeliveryDetails() {}

void OAISignUpResponse_CodeDeliveryDetails::initializeModel() {
...
void OAISignUpResponse_CodeDeliveryDetails::fromJson(QString jsonString) {
...
void OAISignUpResponse_CodeDeliveryDetails::fromJsonObject(QJsonObject json) {
...
QString OAISignUpResponse_CodeDeliveryDetails::asJson() const {
...
QJsonObject OAISignUpResponse_CodeDeliveryDetails::asJsonObject() const {
    QJsonObject obj;
...
QString OAISignUpResponse_CodeDeliveryDetails::getDestination() const {
    return m_destination;
}
void OAISignUpResponse_CodeDeliveryDetails::setDestination(const QString &destination) {
    m_destination = destination;
    m_destination_isSet = true;
}

bool OAISignUpResponse_CodeDeliveryDetails::is_destination_Set() const{
    return m_destination_isSet;
}

bool OAISignUpResponse_CodeDeliveryDetails::is_destination_Valid() const{
    return m_destination_isValid;
}

OAIDeliveryMediumType OAISignUpResponse_CodeDeliveryDetails::getDeliveryMedium() const {
    return m_delivery_medium;
}
void OAISignUpResponse_CodeDeliveryDetails::setDeliveryMedium(const OAIDeliveryMediumType &delivery_medium) {
    m_delivery_medium = delivery_medium;
    m_delivery_medium_isSet = true;
}

bool OAISignUpResponse_CodeDeliveryDetails::is_delivery_medium_Set() const{
    return m_delivery_medium_isSet;
}

bool OAISignUpResponse_CodeDeliveryDetails::is_delivery_medium_Valid() const{
    return m_delivery_medium_isValid;
}

QString OAISignUpResponse_CodeDeliveryDetails::getAttributeName() const {
    return m_attribute_name;
}
void OAISignUpResponse_CodeDeliveryDetails::setAttributeName(const QString &attribute_name) {
    m_attribute_name = attribute_name;
    m_attribute_name_isSet = true;
}

bool OAISignUpResponse_CodeDeliveryDetails::is_attribute_name_Set() const{
    return m_attribute_name_isSet;
}

bool OAISignUpResponse_CodeDeliveryDetails::is_attribute_name_Valid() const{
    return m_attribute_name_isValid;
}

bool OAISignUpResponse_CodeDeliveryDetails::isSet() const {
...
bool OAISignUpResponse_CodeDeliveryDetails::isValid() const {
