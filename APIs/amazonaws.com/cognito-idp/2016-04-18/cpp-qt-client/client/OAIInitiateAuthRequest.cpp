...
OAIInitiateAuthRequest::OAIInitiateAuthRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIInitiateAuthRequest::OAIInitiateAuthRequest() {
    this->initializeModel();
}

OAIInitiateAuthRequest::~OAIInitiateAuthRequest() {}

void OAIInitiateAuthRequest::initializeModel() {
...
void OAIInitiateAuthRequest::fromJson(QString jsonString) {
...
void OAIInitiateAuthRequest::fromJsonObject(QJsonObject json) {
...
QString OAIInitiateAuthRequest::asJson() const {
...
QJsonObject OAIInitiateAuthRequest::asJsonObject() const {
    QJsonObject obj;
...
OAIAuthFlowType OAIInitiateAuthRequest::getAuthFlow() const {
    return m_auth_flow;
}
void OAIInitiateAuthRequest::setAuthFlow(const OAIAuthFlowType &auth_flow) {
    m_auth_flow = auth_flow;
    m_auth_flow_isSet = true;
}

bool OAIInitiateAuthRequest::is_auth_flow_Set() const{
    return m_auth_flow_isSet;
}

bool OAIInitiateAuthRequest::is_auth_flow_Valid() const{
    return m_auth_flow_isValid;
}

QMap OAIInitiateAuthRequest::getAuthParameters() const {
    return m_auth_parameters;
}
void OAIInitiateAuthRequest::setAuthParameters(const QMap &auth_parameters) {
    m_auth_parameters = auth_parameters;
    m_auth_parameters_isSet = true;
}

bool OAIInitiateAuthRequest::is_auth_parameters_Set() const{
    return m_auth_parameters_isSet;
}

bool OAIInitiateAuthRequest::is_auth_parameters_Valid() const{
    return m_auth_parameters_isValid;
}

QMap OAIInitiateAuthRequest::getClientMetadata() const {
    return m_client_metadata;
}
void OAIInitiateAuthRequest::setClientMetadata(const QMap &client_metadata) {
    m_client_metadata = client_metadata;
    m_client_metadata_isSet = true;
}

bool OAIInitiateAuthRequest::is_client_metadata_Set() const{
    return m_client_metadata_isSet;
}

bool OAIInitiateAuthRequest::is_client_metadata_Valid() const{
    return m_client_metadata_isValid;
}

QString OAIInitiateAuthRequest::getClientId() const {
    return m_client_id;
}
void OAIInitiateAuthRequest::setClientId(const QString &client_id) {
    m_client_id = client_id;
    m_client_id_isSet = true;
}

bool OAIInitiateAuthRequest::is_client_id_Set() const{
    return m_client_id_isSet;
}

bool OAIInitiateAuthRequest::is_client_id_Valid() const{
    return m_client_id_isValid;
}

OAIInitiateAuthRequest_AnalyticsMetadata OAIInitiateAuthRequest::getAnalyticsMetadata() const {
    return m_analytics_metadata;
}
void OAIInitiateAuthRequest::setAnalyticsMetadata(const OAIInitiateAuthRequest_AnalyticsMetadata &analytics_metadata) {
    m_analytics_metadata = analytics_metadata;
    m_analytics_metadata_isSet = true;
}

bool OAIInitiateAuthRequest::is_analytics_metadata_Set() const{
    return m_analytics_metadata_isSet;
}

bool OAIInitiateAuthRequest::is_analytics_metadata_Valid() const{
    return m_analytics_metadata_isValid;
}

OAIConfirmForgotPasswordRequest_UserContextData OAIInitiateAuthRequest::getUserContextData() const {
    return m_user_context_data;
}
void OAIInitiateAuthRequest::setUserContextData(const OAIConfirmForgotPasswordRequest_UserContextData &user_context_data) {
    m_user_context_data = user_context_data;
    m_user_context_data_isSet = true;
}

bool OAIInitiateAuthRequest::is_user_context_data_Set() const{
    return m_user_context_data_isSet;
}

bool OAIInitiateAuthRequest::is_user_context_data_Valid() const{
    return m_user_context_data_isValid;
}

bool OAIInitiateAuthRequest::isSet() const {
...
bool OAIInitiateAuthRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_auth_flow_isValid && m_client_id_isValid && true;
}
