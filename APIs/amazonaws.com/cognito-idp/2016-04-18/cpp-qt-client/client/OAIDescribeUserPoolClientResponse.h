...
/*
 * OAIDescribeUserPoolClientResponse.h
 *
 * Represents the response from the server from a request to describe the user pool client.
 */

#ifndef OAIDescribeUserPoolClientResponse_H
#define OAIDescribeUserPoolClientResponse_H

#include <QJsonObject>

#include "OAIDescribeUserPoolClientResponse_UserPoolClient.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIDescribeUserPoolClientResponse_UserPoolClient;

class OAIDescribeUserPoolClientResponse : public OAIObject {
public:
    OAIDescribeUserPoolClientResponse();
    OAIDescribeUserPoolClientResponse(QString json);
    ~OAIDescribeUserPoolClientResponse() override;
    ...
    OAIDescribeUserPoolClientResponse_UserPoolClient getUserPoolClient() const;
    void setUserPoolClient(const OAIDescribeUserPoolClientResponse_UserPoolClient &user_pool_client);
    bool is_user_pool_client_Set() const;
    bool is_user_pool_client_Valid() const;
...
private:
    ...
    OAIDescribeUserPoolClientResponse_UserPoolClient m_user_pool_client;
    bool m_user_pool_client_isSet;
    bool m_user_pool_client_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDescribeUserPoolClientResponse)

#endif // OAIDescribeUserPoolClientResponse_H
