...
/*
 * OAIRespondToAuthChallengeRequest_AnalyticsMetadata.h
 *
 * 
 */

#ifndef OAIRespondToAuthChallengeRequest_AnalyticsMetadata_H
#define OAIRespondToAuthChallengeRequest_AnalyticsMetadata_H
...
class OAIRespondToAuthChallengeRequest_AnalyticsMetadata : public OAIObject {
public:
    OAIRespondToAuthChallengeRequest_AnalyticsMetadata();
    OAIRespondToAuthChallengeRequest_AnalyticsMetadata(QString json);
    ~OAIRespondToAuthChallengeRequest_AnalyticsMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRespondToAuthChallengeRequest_AnalyticsMetadata)

#endif // OAIRespondToAuthChallengeRequest_AnalyticsMetadata_H
