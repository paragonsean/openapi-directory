...
/*
 * OAICustomSMSLambdaVersionConfigType.h
 *
 * A custom SMS sender Lambda configuration type.
 */

#ifndef OAICustomSMSLambdaVersionConfigType_H
#define OAICustomSMSLambdaVersionConfigType_H
...
class OAICustomSMSLambdaVersionConfigType : public OAIObject {
public:
    OAICustomSMSLambdaVersionConfigType();
    OAICustomSMSLambdaVersionConfigType(QString json);
    ~OAICustomSMSLambdaVersionConfigType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomSMSLambdaVersionConfigType)

#endif // OAICustomSMSLambdaVersionConfigType_H
