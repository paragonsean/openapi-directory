...
/*
 * OAIIdentityProviderTypeType.h
 *
 * 
 */

#ifndef OAIIdentityProviderTypeType_H
#define OAIIdentityProviderTypeType_H
...
class OAIIdentityProviderTypeType : public OAIEnum {
public:
    OAIIdentityProviderTypeType();
    OAIIdentityProviderTypeType(QString json);
    ~OAIIdentityProviderTypeType() override;
    ...
    enum class eOAIIdentityProviderTypeType {
    ...
    OAIIdentityProviderTypeType::eOAIIdentityProviderTypeType getValue() const;
    void setValue(const OAIIdentityProviderTypeType::eOAIIdentityProviderTypeType& value);
...
private:
    ...
    eOAIIdentityProviderTypeType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIdentityProviderTypeType)

#endif // OAIIdentityProviderTypeType_H
