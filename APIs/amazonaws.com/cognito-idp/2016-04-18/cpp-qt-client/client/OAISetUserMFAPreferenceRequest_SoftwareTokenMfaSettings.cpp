...
OAISetUserMFAPreferenceRequest_SoftwareTokenMfaSettings::OAISetUserMFAPreferenceRequest_SoftwareTokenMfaSettings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISetUserMFAPreferenceRequest_SoftwareTokenMfaSettings::OAISetUserMFAPreferenceRequest_SoftwareTokenMfaSettings() {
    this->initializeModel();
}

OAISetUserMFAPreferenceRequest_SoftwareTokenMfaSettings::~OAISetUserMFAPreferenceRequest_SoftwareTokenMfaSettings() {}

void OAISetUserMFAPreferenceRequest_SoftwareTokenMfaSettings::initializeModel() {
...
void OAISetUserMFAPreferenceRequest_SoftwareTokenMfaSettings::fromJson(QString jsonString) {
...
void OAISetUserMFAPreferenceRequest_SoftwareTokenMfaSettings::fromJsonObject(QJsonObject json) {
...
QString OAISetUserMFAPreferenceRequest_SoftwareTokenMfaSettings::asJson() const {
...
QJsonObject OAISetUserMFAPreferenceRequest_SoftwareTokenMfaSettings::asJsonObject() const {
    QJsonObject obj;
    if (m_enabled_isSet) {
...
bool OAISetUserMFAPreferenceRequest_SoftwareTokenMfaSettings::getEnabled() const {
    return m_enabled;
}
void OAISetUserMFAPreferenceRequest_SoftwareTokenMfaSettings::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAISetUserMFAPreferenceRequest_SoftwareTokenMfaSettings::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAISetUserMFAPreferenceRequest_SoftwareTokenMfaSettings::is_enabled_Valid() const{
    return m_enabled_isValid;
}

bool OAISetUserMFAPreferenceRequest_SoftwareTokenMfaSettings::getPreferredMfa() const {
    return m_preferred_mfa;
}
void OAISetUserMFAPreferenceRequest_SoftwareTokenMfaSettings::setPreferredMfa(const bool &preferred_mfa) {
    m_preferred_mfa = preferred_mfa;
    m_preferred_mfa_isSet = true;
}

bool OAISetUserMFAPreferenceRequest_SoftwareTokenMfaSettings::is_preferred_mfa_Set() const{
    return m_preferred_mfa_isSet;
}

bool OAISetUserMFAPreferenceRequest_SoftwareTokenMfaSettings::is_preferred_mfa_Valid() const{
    return m_preferred_mfa_isValid;
}

bool OAISetUserMFAPreferenceRequest_SoftwareTokenMfaSettings::isSet() const {
...
bool OAISetUserMFAPreferenceRequest_SoftwareTokenMfaSettings::isValid() const {
