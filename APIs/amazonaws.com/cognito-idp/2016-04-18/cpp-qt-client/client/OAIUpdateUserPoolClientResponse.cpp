...
OAIUpdateUserPoolClientResponse::OAIUpdateUserPoolClientResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateUserPoolClientResponse::OAIUpdateUserPoolClientResponse() {
    this->initializeModel();
}

OAIUpdateUserPoolClientResponse::~OAIUpdateUserPoolClientResponse() {}

void OAIUpdateUserPoolClientResponse::initializeModel() {

    m_user_pool_client_isSet = false;
    m_user_pool_client_isValid = false;
}

void OAIUpdateUserPoolClientResponse::fromJson(QString jsonString) {
...
void OAIUpdateUserPoolClientResponse::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateUserPoolClientResponse::asJson() const {
...
QJsonObject OAIUpdateUserPoolClientResponse::asJsonObject() const {
    QJsonObject obj;
...
OAIUpdateUserPoolClientResponse_UserPoolClient OAIUpdateUserPoolClientResponse::getUserPoolClient() const {
    return m_user_pool_client;
}
void OAIUpdateUserPoolClientResponse::setUserPoolClient(const OAIUpdateUserPoolClientResponse_UserPoolClient &user_pool_client) {
    m_user_pool_client = user_pool_client;
    m_user_pool_client_isSet = true;
}

bool OAIUpdateUserPoolClientResponse::is_user_pool_client_Set() const{
    return m_user_pool_client_isSet;
}

bool OAIUpdateUserPoolClientResponse::is_user_pool_client_Valid() const{
    return m_user_pool_client_isValid;
}

bool OAIUpdateUserPoolClientResponse::isSet() const {
...
bool OAIUpdateUserPoolClientResponse::isValid() const {
