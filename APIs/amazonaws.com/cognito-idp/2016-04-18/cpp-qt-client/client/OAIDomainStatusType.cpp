...
OAIDomainStatusType::OAIDomainStatusType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDomainStatusType::OAIDomainStatusType() {
    this->initializeModel();
}

OAIDomainStatusType::~OAIDomainStatusType() {}

void OAIDomainStatusType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIDomainStatusType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIDomainStatusType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("CREATING", Qt::CaseInsensitive) == 0) {
        m_value = eOAIDomainStatusType::CREATING;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("DELETING", Qt::CaseInsensitive) == 0) {
        m_value = eOAIDomainStatusType::DELETING;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("UPDATING", Qt::CaseInsensitive) == 0) {
        m_value = eOAIDomainStatusType::UPDATING;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ACTIVE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIDomainStatusType::ACTIVE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("FAILED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIDomainStatusType::FAILED;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIDomainStatusType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIDomainStatusType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIDomainStatusType::CREATING:
            val = "CREATING";
            break;
        case eOAIDomainStatusType::DELETING:
            val = "DELETING";
            break;
        case eOAIDomainStatusType::UPDATING:
            val = "UPDATING";
            break;
        case eOAIDomainStatusType::ACTIVE:
            val = "ACTIVE";
            break;
        case eOAIDomainStatusType::FAILED:
            val = "FAILED";
            break;
        default:
            break;
...
QJsonValue OAIDomainStatusType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIDomainStatusType::eOAIDomainStatusType OAIDomainStatusType::getValue() const {
    return m_value;
}

void OAIDomainStatusType::setValue(const OAIDomainStatusType::eOAIDomainStatusType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIDomainStatusType::isSet() const {
    
    return m_value_isSet;
}

bool OAIDomainStatusType::isValid() const {
