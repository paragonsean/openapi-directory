...
/*
 * OAISetUserMFAPreferenceRequest_SoftwareTokenMfaSettings.h
 *
 * 
 */

#ifndef OAISetUserMFAPreferenceRequest_SoftwareTokenMfaSettings_H
#define OAISetUserMFAPreferenceRequest_SoftwareTokenMfaSettings_H
...
class OAISetUserMFAPreferenceRequest_SoftwareTokenMfaSettings : public OAIObject {
public:
    OAISetUserMFAPreferenceRequest_SoftwareTokenMfaSettings();
    OAISetUserMFAPreferenceRequest_SoftwareTokenMfaSettings(QString json);
    ~OAISetUserMFAPreferenceRequest_SoftwareTokenMfaSettings() override;
    ...
    bool getPreferredMfa() const;
    void setPreferredMfa(const bool &preferred_mfa);
...
Q_DECLARE_METATYPE(OpenAPI::OAISetUserMFAPreferenceRequest_SoftwareTokenMfaSettings)

#endif // OAISetUserMFAPreferenceRequest_SoftwareTokenMfaSettings_H
