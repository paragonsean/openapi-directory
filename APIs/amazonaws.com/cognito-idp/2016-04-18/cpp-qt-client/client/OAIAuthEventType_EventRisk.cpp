...
#include "OAIAuthEventType_EventRisk.h"
...
OAIAuthEventType_EventRisk::OAIAuthEventType_EventRisk(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAuthEventType_EventRisk::OAIAuthEventType_EventRisk() {
    this->initializeModel();
}

OAIAuthEventType_EventRisk::~OAIAuthEventType_EventRisk() {}

void OAIAuthEventType_EventRisk::initializeModel() {
...
void OAIAuthEventType_EventRisk::fromJson(QString jsonString) {
...
void OAIAuthEventType_EventRisk::fromJsonObject(QJsonObject json) {
...
QString OAIAuthEventType_EventRisk::asJson() const {
...
QJsonObject OAIAuthEventType_EventRisk::asJsonObject() const {
    QJsonObject obj;
...
OAIRiskDecisionType OAIAuthEventType_EventRisk::getRiskDecision() const {
    return m_risk_decision;
}
void OAIAuthEventType_EventRisk::setRiskDecision(const OAIRiskDecisionType &risk_decision) {
    m_risk_decision = risk_decision;
    m_risk_decision_isSet = true;
}

bool OAIAuthEventType_EventRisk::is_risk_decision_Set() const{
    return m_risk_decision_isSet;
}

bool OAIAuthEventType_EventRisk::is_risk_decision_Valid() const{
    return m_risk_decision_isValid;
}

OAIRiskLevelType OAIAuthEventType_EventRisk::getRiskLevel() const {
    return m_risk_level;
}
void OAIAuthEventType_EventRisk::setRiskLevel(const OAIRiskLevelType &risk_level) {
    m_risk_level = risk_level;
    m_risk_level_isSet = true;
}

bool OAIAuthEventType_EventRisk::is_risk_level_Set() const{
    return m_risk_level_isSet;
}

bool OAIAuthEventType_EventRisk::is_risk_level_Valid() const{
    return m_risk_level_isValid;
}

bool OAIAuthEventType_EventRisk::getCompromisedCredentialsDetected() const {
    return m_compromised_credentials_detected;
}
void OAIAuthEventType_EventRisk::setCompromisedCredentialsDetected(const bool &compromised_credentials_detected) {
    m_compromised_credentials_detected = compromised_credentials_detected;
    m_compromised_credentials_detected_isSet = true;
}

bool OAIAuthEventType_EventRisk::is_compromised_credentials_detected_Set() const{
    return m_compromised_credentials_detected_isSet;
}

bool OAIAuthEventType_EventRisk::is_compromised_credentials_detected_Valid() const{
    return m_compromised_credentials_detected_isValid;
}

bool OAIAuthEventType_EventRisk::isSet() const {
...
bool OAIAuthEventType_EventRisk::isValid() const {
