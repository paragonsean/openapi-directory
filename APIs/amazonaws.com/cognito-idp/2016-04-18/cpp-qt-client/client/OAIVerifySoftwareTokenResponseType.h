...
/*
 * OAIVerifySoftwareTokenResponseType.h
 *
 * 
 */

#ifndef OAIVerifySoftwareTokenResponseType_H
#define OAIVerifySoftwareTokenResponseType_H
...
class OAIVerifySoftwareTokenResponseType : public OAIEnum {
public:
    OAIVerifySoftwareTokenResponseType();
    OAIVerifySoftwareTokenResponseType(QString json);
    ~OAIVerifySoftwareTokenResponseType() override;
    ...
    enum class eOAIVerifySoftwareTokenResponseType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        SUCCESS, 
        ERROR
    };
    OAIVerifySoftwareTokenResponseType::eOAIVerifySoftwareTokenResponseType getValue() const;
    void setValue(const OAIVerifySoftwareTokenResponseType::eOAIVerifySoftwareTokenResponseType& value);
...
private:
    ...
    eOAIVerifySoftwareTokenResponseType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVerifySoftwareTokenResponseType)

#endif // OAIVerifySoftwareTokenResponseType_H
