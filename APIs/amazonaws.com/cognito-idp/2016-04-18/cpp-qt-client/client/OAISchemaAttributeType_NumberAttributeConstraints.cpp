...
OAISchemaAttributeType_NumberAttributeConstraints::OAISchemaAttributeType_NumberAttributeConstraints(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISchemaAttributeType_NumberAttributeConstraints::OAISchemaAttributeType_NumberAttributeConstraints() {
    this->initializeModel();
}

OAISchemaAttributeType_NumberAttributeConstraints::~OAISchemaAttributeType_NumberAttributeConstraints() {}

void OAISchemaAttributeType_NumberAttributeConstraints::initializeModel() {
...
void OAISchemaAttributeType_NumberAttributeConstraints::fromJson(QString jsonString) {
...
void OAISchemaAttributeType_NumberAttributeConstraints::fromJsonObject(QJsonObject json) {
...
QString OAISchemaAttributeType_NumberAttributeConstraints::asJson() const {
...
QJsonObject OAISchemaAttributeType_NumberAttributeConstraints::asJsonObject() const {
    QJsonObject obj;
...
QString OAISchemaAttributeType_NumberAttributeConstraints::getMinValue() const {
    return m_min_value;
}
void OAISchemaAttributeType_NumberAttributeConstraints::setMinValue(const QString &min_value) {
    m_min_value = min_value;
    m_min_value_isSet = true;
}

bool OAISchemaAttributeType_NumberAttributeConstraints::is_min_value_Set() const{
    return m_min_value_isSet;
}

bool OAISchemaAttributeType_NumberAttributeConstraints::is_min_value_Valid() const{
    return m_min_value_isValid;
}

QString OAISchemaAttributeType_NumberAttributeConstraints::getMaxValue() const {
    return m_max_value;
}
void OAISchemaAttributeType_NumberAttributeConstraints::setMaxValue(const QString &max_value) {
    m_max_value = max_value;
    m_max_value_isSet = true;
}

bool OAISchemaAttributeType_NumberAttributeConstraints::is_max_value_Set() const{
    return m_max_value_isSet;
}

bool OAISchemaAttributeType_NumberAttributeConstraints::is_max_value_Valid() const{
    return m_max_value_isValid;
}

bool OAISchemaAttributeType_NumberAttributeConstraints::isSet() const {
...
bool OAISchemaAttributeType_NumberAttributeConstraints::isValid() const {
