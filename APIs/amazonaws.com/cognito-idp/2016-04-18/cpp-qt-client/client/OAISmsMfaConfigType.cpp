...
OAISmsMfaConfigType::OAISmsMfaConfigType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISmsMfaConfigType::OAISmsMfaConfigType() {
    this->initializeModel();
}

OAISmsMfaConfigType::~OAISmsMfaConfigType() {}

void OAISmsMfaConfigType::initializeModel() {
...
void OAISmsMfaConfigType::fromJson(QString jsonString) {
...
void OAISmsMfaConfigType::fromJsonObject(QJsonObject json) {
...
QString OAISmsMfaConfigType::asJson() const {
...
QJsonObject OAISmsMfaConfigType::asJsonObject() const {
    QJsonObject obj;
...
QString OAISmsMfaConfigType::getSmsAuthenticationMessage() const {
    return m_sms_authentication_message;
}
void OAISmsMfaConfigType::setSmsAuthenticationMessage(const QString &sms_authentication_message) {
    m_sms_authentication_message = sms_authentication_message;
    m_sms_authentication_message_isSet = true;
}

bool OAISmsMfaConfigType::is_sms_authentication_message_Set() const{
    return m_sms_authentication_message_isSet;
}

bool OAISmsMfaConfigType::is_sms_authentication_message_Valid() const{
    return m_sms_authentication_message_isValid;
}

OAISmsMfaConfigType_SmsConfiguration OAISmsMfaConfigType::getSmsConfiguration() const {
    return m_sms_configuration;
}
void OAISmsMfaConfigType::setSmsConfiguration(const OAISmsMfaConfigType_SmsConfiguration &sms_configuration) {
    m_sms_configuration = sms_configuration;
    m_sms_configuration_isSet = true;
}

bool OAISmsMfaConfigType::is_sms_configuration_Set() const{
    return m_sms_configuration_isSet;
}

bool OAISmsMfaConfigType::is_sms_configuration_Valid() const{
    return m_sms_configuration_isValid;
}

bool OAISmsMfaConfigType::isSet() const {
...
bool OAISmsMfaConfigType::isValid() const {
