...
OAIUpdateUserPoolRequest_Policies::OAIUpdateUserPoolRequest_Policies(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateUserPoolRequest_Policies::OAIUpdateUserPoolRequest_Policies() {
    this->initializeModel();
}

OAIUpdateUserPoolRequest_Policies::~OAIUpdateUserPoolRequest_Policies() {}

void OAIUpdateUserPoolRequest_Policies::initializeModel() {

    m_password_policy_isSet = false;
    m_password_policy_isValid = false;
}

void OAIUpdateUserPoolRequest_Policies::fromJson(QString jsonString) {
...
void OAIUpdateUserPoolRequest_Policies::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateUserPoolRequest_Policies::asJson() const {
...
QJsonObject OAIUpdateUserPoolRequest_Policies::asJsonObject() const {
    QJsonObject obj;
...
OAIUserPoolPolicyType_PasswordPolicy OAIUpdateUserPoolRequest_Policies::getPasswordPolicy() const {
    return m_password_policy;
}
void OAIUpdateUserPoolRequest_Policies::setPasswordPolicy(const OAIUserPoolPolicyType_PasswordPolicy &password_policy) {
    m_password_policy = password_policy;
    m_password_policy_isSet = true;
}

bool OAIUpdateUserPoolRequest_Policies::is_password_policy_Set() const{
    return m_password_policy_isSet;
}

bool OAIUpdateUserPoolRequest_Policies::is_password_policy_Valid() const{
    return m_password_policy_isValid;
}

bool OAIUpdateUserPoolRequest_Policies::isSet() const {
...
bool OAIUpdateUserPoolRequest_Policies::isValid() const {
