...
/*
 * OAIAddCustomAttributesRequest.h
 *
 * Represents the request to add custom attributes.
 */

#ifndef OAIAddCustomAttributesRequest_H
#define OAIAddCustomAttributesRequest_H
...
class OAIAddCustomAttributesRequest : public OAIObject {
public:
    OAIAddCustomAttributesRequest();
    OAIAddCustomAttributesRequest(QString json);
    ~OAIAddCustomAttributesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddCustomAttributesRequest)

#endif // OAIAddCustomAttributesRequest_H
