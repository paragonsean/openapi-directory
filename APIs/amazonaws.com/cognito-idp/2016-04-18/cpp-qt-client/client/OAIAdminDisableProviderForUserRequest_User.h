...
/*
 * OAIAdminDisableProviderForUserRequest_User.h
 *
 * 
 */

#ifndef OAIAdminDisableProviderForUserRequest_User_H
#define OAIAdminDisableProviderForUserRequest_User_H
...
class OAIAdminDisableProviderForUserRequest_User : public OAIObject {
public:
    OAIAdminDisableProviderForUserRequest_User();
    OAIAdminDisableProviderForUserRequest_User(QString json);
    ~OAIAdminDisableProviderForUserRequest_User() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdminDisableProviderForUserRequest_User)

#endif // OAIAdminDisableProviderForUserRequest_User_H
