...
OAIListUsersInGroupRequest::OAIListUsersInGroupRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListUsersInGroupRequest::OAIListUsersInGroupRequest() {
    this->initializeModel();
}

OAIListUsersInGroupRequest::~OAIListUsersInGroupRequest() {}

void OAIListUsersInGroupRequest::initializeModel() {
...
void OAIListUsersInGroupRequest::fromJson(QString jsonString) {
...
void OAIListUsersInGroupRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListUsersInGroupRequest::asJson() const {
...
QJsonObject OAIListUsersInGroupRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListUsersInGroupRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIListUsersInGroupRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIListUsersInGroupRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIListUsersInGroupRequest::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

QString OAIListUsersInGroupRequest::getGroupName() const {
    return m_group_name;
}
void OAIListUsersInGroupRequest::setGroupName(const QString &group_name) {
    m_group_name = group_name;
    m_group_name_isSet = true;
}

bool OAIListUsersInGroupRequest::is_group_name_Set() const{
    return m_group_name_isSet;
}

bool OAIListUsersInGroupRequest::is_group_name_Valid() const{
    return m_group_name_isValid;
}

qint32 OAIListUsersInGroupRequest::getLimit() const {
    return m_limit;
}
void OAIListUsersInGroupRequest::setLimit(const qint32 &limit) {
    m_limit = limit;
    m_limit_isSet = true;
}

bool OAIListUsersInGroupRequest::is_limit_Set() const{
    return m_limit_isSet;
}

bool OAIListUsersInGroupRequest::is_limit_Valid() const{
    return m_limit_isValid;
}

QString OAIListUsersInGroupRequest::getNextToken() const {
    return m_next_token;
}
void OAIListUsersInGroupRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListUsersInGroupRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListUsersInGroupRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListUsersInGroupRequest::isSet() const {
...
bool OAIListUsersInGroupRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_user_pool_id_isValid && m_group_name_isValid && true;
}
