...
/*
 * OAICreateUserPoolRequest_AccountRecoverySetting.h
 *
 * 
 */

#ifndef OAICreateUserPoolRequest_AccountRecoverySetting_H
#define OAICreateUserPoolRequest_AccountRecoverySetting_H
...
class OAICreateUserPoolRequest_AccountRecoverySetting : public OAIObject {
public:
    OAICreateUserPoolRequest_AccountRecoverySetting();
    OAICreateUserPoolRequest_AccountRecoverySetting(QString json);
    ~OAICreateUserPoolRequest_AccountRecoverySetting() override;
    ...
    QList getRecoveryMechanisms() const;
    void setRecoveryMechanisms(const QList &recovery_mechanisms);
    bool is_recovery_mechanisms_Set() const;
    bool is_recovery_mechanisms_Valid() const;
...
private:
    ...
    QList m_recovery_mechanisms;
    bool m_recovery_mechanisms_isSet;
    bool m_recovery_mechanisms_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICreateUserPoolRequest_AccountRecoverySetting)

#endif // OAICreateUserPoolRequest_AccountRecoverySetting_H
