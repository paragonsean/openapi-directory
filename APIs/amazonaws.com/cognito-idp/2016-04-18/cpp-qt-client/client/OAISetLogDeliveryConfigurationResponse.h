...
/*
 * OAISetLogDeliveryConfigurationResponse.h
 *
 * 
 */

#ifndef OAISetLogDeliveryConfigurationResponse_H
#define OAISetLogDeliveryConfigurationResponse_H

#include <QJsonObject>

#include "OAISetLogDeliveryConfigurationResponse_LogDeliveryConfiguration.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAISetLogDeliveryConfigurationResponse_LogDeliveryConfiguration;

class OAISetLogDeliveryConfigurationResponse : public OAIObject {
public:
    OAISetLogDeliveryConfigurationResponse();
    OAISetLogDeliveryConfigurationResponse(QString json);
    ~OAISetLogDeliveryConfigurationResponse() override;
    ...
    OAISetLogDeliveryConfigurationResponse_LogDeliveryConfiguration getLogDeliveryConfiguration() const;
    void setLogDeliveryConfiguration(const OAISetLogDeliveryConfigurationResponse_LogDeliveryConfiguration &log_delivery_configuration);
    bool is_log_delivery_configuration_Set() const;
    bool is_log_delivery_configuration_Valid() const;
...
private:
    ...
    OAISetLogDeliveryConfigurationResponse_LogDeliveryConfiguration m_log_delivery_configuration;
    bool m_log_delivery_configuration_isSet;
    bool m_log_delivery_configuration_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAISetLogDeliveryConfigurationResponse)

#endif // OAISetLogDeliveryConfigurationResponse_H
