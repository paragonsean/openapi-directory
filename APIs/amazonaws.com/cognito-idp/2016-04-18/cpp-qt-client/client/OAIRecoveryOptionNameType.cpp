...
#include "OAIRecoveryOptionNameType.h"
...
OAIRecoveryOptionNameType::OAIRecoveryOptionNameType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRecoveryOptionNameType::OAIRecoveryOptionNameType() {
    this->initializeModel();
}

OAIRecoveryOptionNameType::~OAIRecoveryOptionNameType() {}

void OAIRecoveryOptionNameType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIRecoveryOptionNameType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIRecoveryOptionNameType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("verified_email", Qt::CaseInsensitive) == 0) {
        m_value = eOAIRecoveryOptionNameType::VERIFIED_EMAIL;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("verified_phone_number", Qt::CaseInsensitive) == 0) {
        m_value = eOAIRecoveryOptionNameType::VERIFIED_PHONE_NUMBER;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("admin_only", Qt::CaseInsensitive) == 0) {
        m_value = eOAIRecoveryOptionNameType::ADMIN_ONLY;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIRecoveryOptionNameType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIRecoveryOptionNameType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIRecoveryOptionNameType::VERIFIED_EMAIL:
            val = "verified_email";
            break;
        case eOAIRecoveryOptionNameType::VERIFIED_PHONE_NUMBER:
            val = "verified_phone_number";
            break;
        case eOAIRecoveryOptionNameType::ADMIN_ONLY:
            val = "admin_only";
            break;
        default:
            break;
...
QJsonValue OAIRecoveryOptionNameType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIRecoveryOptionNameType::eOAIRecoveryOptionNameType OAIRecoveryOptionNameType::getValue() const {
    return m_value;
}

void OAIRecoveryOptionNameType::setValue(const OAIRecoveryOptionNameType::eOAIRecoveryOptionNameType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIRecoveryOptionNameType::isSet() const {
    
    return m_value_isSet;
}

bool OAIRecoveryOptionNameType::isValid() const {
