...
/*
 * OAIGetLogDeliveryConfigurationRequest.h
 *
 * 
 */

#ifndef OAIGetLogDeliveryConfigurationRequest_H
#define OAIGetLogDeliveryConfigurationRequest_H
...
class OAIGetLogDeliveryConfigurationRequest : public OAIObject {
public:
    OAIGetLogDeliveryConfigurationRequest();
    OAIGetLogDeliveryConfigurationRequest(QString json);
    ~OAIGetLogDeliveryConfigurationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetLogDeliveryConfigurationRequest)

#endif // OAIGetLogDeliveryConfigurationRequest_H
