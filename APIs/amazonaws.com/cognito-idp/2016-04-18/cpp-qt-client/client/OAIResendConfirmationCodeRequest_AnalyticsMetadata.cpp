...
#include "OAIResendConfirmationCodeRequest_AnalyticsMetadata.h"
...
OAIResendConfirmationCodeRequest_AnalyticsMetadata::OAIResendConfirmationCodeRequest_AnalyticsMetadata(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIResendConfirmationCodeRequest_AnalyticsMetadata::OAIResendConfirmationCodeRequest_AnalyticsMetadata() {
    this->initializeModel();
}

OAIResendConfirmationCodeRequest_AnalyticsMetadata::~OAIResendConfirmationCodeRequest_AnalyticsMetadata() {}

void OAIResendConfirmationCodeRequest_AnalyticsMetadata::initializeModel() {

    m_analytics_endpoint_id_isSet = false;
    m_analytics_endpoint_id_isValid = false;
}

void OAIResendConfirmationCodeRequest_AnalyticsMetadata::fromJson(QString jsonString) {
...
void OAIResendConfirmationCodeRequest_AnalyticsMetadata::fromJsonObject(QJsonObject json) {
...
QString OAIResendConfirmationCodeRequest_AnalyticsMetadata::asJson() const {
...
QJsonObject OAIResendConfirmationCodeRequest_AnalyticsMetadata::asJsonObject() const {
    QJsonObject obj;
...
QString OAIResendConfirmationCodeRequest_AnalyticsMetadata::getAnalyticsEndpointId() const {
    return m_analytics_endpoint_id;
}
void OAIResendConfirmationCodeRequest_AnalyticsMetadata::setAnalyticsEndpointId(const QString &analytics_endpoint_id) {
    m_analytics_endpoint_id = analytics_endpoint_id;
    m_analytics_endpoint_id_isSet = true;
}

bool OAIResendConfirmationCodeRequest_AnalyticsMetadata::is_analytics_endpoint_id_Set() const{
    return m_analytics_endpoint_id_isSet;
}

bool OAIResendConfirmationCodeRequest_AnalyticsMetadata::is_analytics_endpoint_id_Valid() const{
    return m_analytics_endpoint_id_isValid;
}

bool OAIResendConfirmationCodeRequest_AnalyticsMetadata::isSet() const {
...
bool OAIResendConfirmationCodeRequest_AnalyticsMetadata::isValid() const {
