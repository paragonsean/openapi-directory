...
/*
 * OAIDeliveryMediumType.h
 *
 * 
 */

#ifndef OAIDeliveryMediumType_H
#define OAIDeliveryMediumType_H
...
class OAIDeliveryMediumType : public OAIEnum {
public:
    OAIDeliveryMediumType();
    OAIDeliveryMediumType(QString json);
    ~OAIDeliveryMediumType() override;
    ...
    enum class eOAIDeliveryMediumType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        SMS, 
        EMAIL
    };
    OAIDeliveryMediumType::eOAIDeliveryMediumType getValue() const;
    void setValue(const OAIDeliveryMediumType::eOAIDeliveryMediumType& value);
...
private:
    ...
    eOAIDeliveryMediumType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeliveryMediumType)

#endif // OAIDeliveryMediumType_H
