...
/*
 * OAINewDeviceMetadataType.h
 *
 * The new device metadata type.
 */

#ifndef OAINewDeviceMetadataType_H
#define OAINewDeviceMetadataType_H
...
class OAINewDeviceMetadataType : public OAIObject {
public:
    OAINewDeviceMetadataType();
    OAINewDeviceMetadataType(QString json);
    ~OAINewDeviceMetadataType() override;
    ...
    QString getDeviceGroupKey() const;
    void setDeviceGroupKey(const QString &device_group_key);
    bool is_device_group_key_Set() const;
    bool is_device_group_key_Valid() const;
...
private:
    ...
    QString m_device_group_key;
    bool m_device_group_key_isSet;
    bool m_device_group_key_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAINewDeviceMetadataType)

#endif // OAINewDeviceMetadataType_H
