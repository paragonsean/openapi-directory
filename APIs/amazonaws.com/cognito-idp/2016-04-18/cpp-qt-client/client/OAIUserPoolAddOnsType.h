...
#ifndef OAIUserPoolAddOnsType_H
#define OAIUserPoolAddOnsType_H
...
class OAIUserPoolAddOnsType : public OAIObject {
public:
    OAIUserPoolAddOnsType();
    OAIUserPoolAddOnsType(QString json);
    ~OAIUserPoolAddOnsType() override;
    ...
    OAIAdvancedSecurityModeType getAdvancedSecurityMode() const;
    void setAdvancedSecurityMode(const OAIAdvancedSecurityModeType &advanced_security_mode);
    bool is_advanced_security_mode_Set() const;
    bool is_advanced_security_mode_Valid() const;
...
private:
    ...
    OAIAdvancedSecurityModeType m_advanced_security_mode;
    bool m_advanced_security_mode_isSet;
    bool m_advanced_security_mode_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIUserPoolAddOnsType)

#endif // OAIUserPoolAddOnsType_H
