...
/*
 * OAIDescribeUserImportJobRequest.h
 *
 * Represents the request to describe the user import job.
 */

#ifndef OAIDescribeUserImportJobRequest_H
#define OAIDescribeUserImportJobRequest_H
...
class OAIDescribeUserImportJobRequest : public OAIObject {
public:
    OAIDescribeUserImportJobRequest();
    OAIDescribeUserImportJobRequest(QString json);
    ~OAIDescribeUserImportJobRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeUserImportJobRequest)

#endif // OAIDescribeUserImportJobRequest_H
