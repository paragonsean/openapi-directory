...
/*
 * OAIUpdateUserAttributesResponse.h
 *
 * Represents the response from the server for the request to update user attributes.
 */

#ifndef OAIUpdateUserAttributesResponse_H
#define OAIUpdateUserAttributesResponse_H
...
class OAIUpdateUserAttributesResponse : public OAIObject {
public:
    OAIUpdateUserAttributesResponse();
    OAIUpdateUserAttributesResponse(QString json);
    ~OAIUpdateUserAttributesResponse() override;
    ...
    QList getCodeDeliveryDetailsList() const;
    void setCodeDeliveryDetailsList(const QList &code_delivery_details_list);
    bool is_code_delivery_details_list_Set() const;
    bool is_code_delivery_details_list_Valid() const;
...
private:
    ...
    QList m_code_delivery_details_list;
    bool m_code_delivery_details_list_isSet;
    bool m_code_delivery_details_list_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIUpdateUserAttributesResponse)

#endif // OAIUpdateUserAttributesResponse_H
