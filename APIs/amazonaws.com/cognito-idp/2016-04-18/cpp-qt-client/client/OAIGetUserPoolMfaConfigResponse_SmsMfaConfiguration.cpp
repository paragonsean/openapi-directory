...
#include "OAIGetUserPoolMfaConfigResponse_SmsMfaConfiguration.h"
...
OAIGetUserPoolMfaConfigResponse_SmsMfaConfiguration::OAIGetUserPoolMfaConfigResponse_SmsMfaConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetUserPoolMfaConfigResponse_SmsMfaConfiguration::OAIGetUserPoolMfaConfigResponse_SmsMfaConfiguration() {
    this->initializeModel();
}

OAIGetUserPoolMfaConfigResponse_SmsMfaConfiguration::~OAIGetUserPoolMfaConfigResponse_SmsMfaConfiguration() {}

void OAIGetUserPoolMfaConfigResponse_SmsMfaConfiguration::initializeModel() {
...
void OAIGetUserPoolMfaConfigResponse_SmsMfaConfiguration::fromJson(QString jsonString) {
...
void OAIGetUserPoolMfaConfigResponse_SmsMfaConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIGetUserPoolMfaConfigResponse_SmsMfaConfiguration::asJson() const {
...
QJsonObject OAIGetUserPoolMfaConfigResponse_SmsMfaConfiguration::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetUserPoolMfaConfigResponse_SmsMfaConfiguration::getSmsAuthenticationMessage() const {
    return m_sms_authentication_message;
}
void OAIGetUserPoolMfaConfigResponse_SmsMfaConfiguration::setSmsAuthenticationMessage(const QString &sms_authentication_message) {
    m_sms_authentication_message = sms_authentication_message;
    m_sms_authentication_message_isSet = true;
}

bool OAIGetUserPoolMfaConfigResponse_SmsMfaConfiguration::is_sms_authentication_message_Set() const{
    return m_sms_authentication_message_isSet;
}

bool OAIGetUserPoolMfaConfigResponse_SmsMfaConfiguration::is_sms_authentication_message_Valid() const{
    return m_sms_authentication_message_isValid;
}

OAISmsMfaConfigType_SmsConfiguration OAIGetUserPoolMfaConfigResponse_SmsMfaConfiguration::getSmsConfiguration() const {
    return m_sms_configuration;
}
void OAIGetUserPoolMfaConfigResponse_SmsMfaConfiguration::setSmsConfiguration(const OAISmsMfaConfigType_SmsConfiguration &sms_configuration) {
    m_sms_configuration = sms_configuration;
    m_sms_configuration_isSet = true;
}

bool OAIGetUserPoolMfaConfigResponse_SmsMfaConfiguration::is_sms_configuration_Set() const{
    return m_sms_configuration_isSet;
}

bool OAIGetUserPoolMfaConfigResponse_SmsMfaConfiguration::is_sms_configuration_Valid() const{
    return m_sms_configuration_isValid;
}

bool OAIGetUserPoolMfaConfigResponse_SmsMfaConfiguration::isSet() const {
...
bool OAIGetUserPoolMfaConfigResponse_SmsMfaConfiguration::isValid() const {
