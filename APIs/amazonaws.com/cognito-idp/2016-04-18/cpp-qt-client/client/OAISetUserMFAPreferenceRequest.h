...
/*
 * OAISetUserMFAPreferenceRequest.h
 *
 * 
 */

#ifndef OAISetUserMFAPreferenceRequest_H
#define OAISetUserMFAPreferenceRequest_H

#include <QJsonObject>

#include "OAISetUserMFAPreferenceRequest_SMSMfaSettings.h"
#include "OAISetUserMFAPreferenceRequest_SoftwareTokenMfaSettings.h"
#include <QString>
...
namespace OpenAPI {
class OAISetUserMFAPreferenceRequest_SMSMfaSettings;
class OAISetUserMFAPreferenceRequest_SoftwareTokenMfaSettings;

class OAISetUserMFAPreferenceRequest : public OAIObject {
public:
    OAISetUserMFAPreferenceRequest();
    OAISetUserMFAPreferenceRequest(QString json);
    ~OAISetUserMFAPreferenceRequest() override;
    ...
    OAISetUserMFAPreferenceRequest_SMSMfaSettings getSmsMfaSettings() const;
    void setSmsMfaSettings(const OAISetUserMFAPreferenceRequest_SMSMfaSettings &sms_mfa_settings);
    bool is_sms_mfa_settings_Set() const;
    bool is_sms_mfa_settings_Valid() const;

    OAISetUserMFAPreferenceRequest_SoftwareTokenMfaSettings getSoftwareTokenMfaSettings() const;
    void setSoftwareTokenMfaSettings(const OAISetUserMFAPreferenceRequest_SoftwareTokenMfaSettings &software_token_mfa_settings);
    bool is_software_token_mfa_settings_Set() const;
    bool is_software_token_mfa_settings_Valid() const;
...
private:
    ...
    OAISetUserMFAPreferenceRequest_SMSMfaSettings m_sms_mfa_settings;
    bool m_sms_mfa_settings_isSet;
    bool m_sms_mfa_settings_isValid;

    OAISetUserMFAPreferenceRequest_SoftwareTokenMfaSettings m_software_token_mfa_settings;
    bool m_software_token_mfa_settings_isSet;
    bool m_software_token_mfa_settings_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAISetUserMFAPreferenceRequest)

#endif // OAISetUserMFAPreferenceRequest_H
