...
OAIDeleteUserPoolClientRequest::OAIDeleteUserPoolClientRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteUserPoolClientRequest::OAIDeleteUserPoolClientRequest() {
    this->initializeModel();
}

OAIDeleteUserPoolClientRequest::~OAIDeleteUserPoolClientRequest() {}

void OAIDeleteUserPoolClientRequest::initializeModel() {
...
void OAIDeleteUserPoolClientRequest::fromJson(QString jsonString) {
...
void OAIDeleteUserPoolClientRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteUserPoolClientRequest::asJson() const {
...
QJsonObject OAIDeleteUserPoolClientRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteUserPoolClientRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIDeleteUserPoolClientRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIDeleteUserPoolClientRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIDeleteUserPoolClientRequest::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

QString OAIDeleteUserPoolClientRequest::getClientId() const {
    return m_client_id;
}
void OAIDeleteUserPoolClientRequest::setClientId(const QString &client_id) {
    m_client_id = client_id;
    m_client_id_isSet = true;
}

bool OAIDeleteUserPoolClientRequest::is_client_id_Set() const{
    return m_client_id_isSet;
}

bool OAIDeleteUserPoolClientRequest::is_client_id_Valid() const{
    return m_client_id_isValid;
}

bool OAIDeleteUserPoolClientRequest::isSet() const {
...
bool OAIDeleteUserPoolClientRequest::isValid() const {
