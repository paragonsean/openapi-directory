...
OAICreateIdentityProviderRequest::OAICreateIdentityProviderRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateIdentityProviderRequest::OAICreateIdentityProviderRequest() {
    this->initializeModel();
}

OAICreateIdentityProviderRequest::~OAICreateIdentityProviderRequest() {}

void OAICreateIdentityProviderRequest::initializeModel() {
...
void OAICreateIdentityProviderRequest::fromJson(QString jsonString) {
...
void OAICreateIdentityProviderRequest::fromJsonObject(QJsonObject json) {
...
QString OAICreateIdentityProviderRequest::asJson() const {
...
QJsonObject OAICreateIdentityProviderRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateIdentityProviderRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAICreateIdentityProviderRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAICreateIdentityProviderRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAICreateIdentityProviderRequest::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

QString OAICreateIdentityProviderRequest::getProviderName() const {
    return m_provider_name;
}
void OAICreateIdentityProviderRequest::setProviderName(const QString &provider_name) {
    m_provider_name = provider_name;
    m_provider_name_isSet = true;
}

bool OAICreateIdentityProviderRequest::is_provider_name_Set() const{
    return m_provider_name_isSet;
}

bool OAICreateIdentityProviderRequest::is_provider_name_Valid() const{
    return m_provider_name_isValid;
}

OAIIdentityProviderTypeType OAICreateIdentityProviderRequest::getProviderType() const {
    return m_provider_type;
}
void OAICreateIdentityProviderRequest::setProviderType(const OAIIdentityProviderTypeType &provider_type) {
    m_provider_type = provider_type;
    m_provider_type_isSet = true;
}

bool OAICreateIdentityProviderRequest::is_provider_type_Set() const{
    return m_provider_type_isSet;
}

bool OAICreateIdentityProviderRequest::is_provider_type_Valid() const{
    return m_provider_type_isValid;
}

QMap OAICreateIdentityProviderRequest::getProviderDetails() const {
    return m_provider_details;
}
void OAICreateIdentityProviderRequest::setProviderDetails(const QMap &provider_details) {
    m_provider_details = provider_details;
    m_provider_details_isSet = true;
}

bool OAICreateIdentityProviderRequest::is_provider_details_Set() const{
    return m_provider_details_isSet;
}

bool OAICreateIdentityProviderRequest::is_provider_details_Valid() const{
    return m_provider_details_isValid;
}

QMap OAICreateIdentityProviderRequest::getAttributeMapping() const {
    return m_attribute_mapping;
}
void OAICreateIdentityProviderRequest::setAttributeMapping(const QMap &attribute_mapping) {
    m_attribute_mapping = attribute_mapping;
    m_attribute_mapping_isSet = true;
}

bool OAICreateIdentityProviderRequest::is_attribute_mapping_Set() const{
    return m_attribute_mapping_isSet;
}

bool OAICreateIdentityProviderRequest::is_attribute_mapping_Valid() const{
    return m_attribute_mapping_isValid;
}

QList OAICreateIdentityProviderRequest::getIdpIdentifiers() const {
    return m_idp_identifiers;
}
void OAICreateIdentityProviderRequest::setIdpIdentifiers(const QList &idp_identifiers) {
    m_idp_identifiers = idp_identifiers;
    m_idp_identifiers_isSet = true;
}

bool OAICreateIdentityProviderRequest::is_idp_identifiers_Set() const{
    return m_idp_identifiers_isSet;
}

bool OAICreateIdentityProviderRequest::is_idp_identifiers_Valid() const{
    return m_idp_identifiers_isValid;
}

bool OAICreateIdentityProviderRequest::isSet() const {
...
bool OAICreateIdentityProviderRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_user_pool_id_isValid && m_provider_name_isValid && m_provider_type_isValid && m_provider_details_isValid && true;
}
