...
/*
 * OAICreateResourceServerResponse_ResourceServer.h
 *
 * 
 */

#ifndef OAICreateResourceServerResponse_ResourceServer_H
#define OAICreateResourceServerResponse_ResourceServer_H
...
class OAICreateResourceServerResponse_ResourceServer : public OAIObject {
public:
    OAICreateResourceServerResponse_ResourceServer();
    OAICreateResourceServerResponse_ResourceServer(QString json);
    ~OAICreateResourceServerResponse_ResourceServer() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateResourceServerResponse_ResourceServer)

#endif // OAICreateResourceServerResponse_ResourceServer_H
