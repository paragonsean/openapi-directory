...
/*
 * OAIAdminSetUserMFAPreferenceRequest.h
 *
 * 
 */

#ifndef OAIAdminSetUserMFAPreferenceRequest_H
#define OAIAdminSetUserMFAPreferenceRequest_H
...
namespace OpenAPI {
class OAIAdminSetUserMFAPreferenceRequest_SMSMfaSettings;
class OAIAdminSetUserMFAPreferenceRequest_SoftwareTokenMfaSettings;

class OAIAdminSetUserMFAPreferenceRequest : public OAIObject {
public:
    OAIAdminSetUserMFAPreferenceRequest();
    OAIAdminSetUserMFAPreferenceRequest(QString json);
    ~OAIAdminSetUserMFAPreferenceRequest() override;
    ...
    OAIAdminSetUserMFAPreferenceRequest_SMSMfaSettings getSmsMfaSettings() const;
    void setSmsMfaSettings(const OAIAdminSetUserMFAPreferenceRequest_SMSMfaSettings &sms_mfa_settings);
    bool is_sms_mfa_settings_Set() const;
    bool is_sms_mfa_settings_Valid() const;

    OAIAdminSetUserMFAPreferenceRequest_SoftwareTokenMfaSettings getSoftwareTokenMfaSettings() const;
    void setSoftwareTokenMfaSettings(const OAIAdminSetUserMFAPreferenceRequest_SoftwareTokenMfaSettings &software_token_mfa_settings);
...
private:
    ...
    OAIAdminSetUserMFAPreferenceRequest_SMSMfaSettings m_sms_mfa_settings;
    bool m_sms_mfa_settings_isSet;
    bool m_sms_mfa_settings_isValid;

    OAIAdminSetUserMFAPreferenceRequest_SoftwareTokenMfaSettings m_software_token_mfa_settings;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdminSetUserMFAPreferenceRequest)

#endif // OAIAdminSetUserMFAPreferenceRequest_H
