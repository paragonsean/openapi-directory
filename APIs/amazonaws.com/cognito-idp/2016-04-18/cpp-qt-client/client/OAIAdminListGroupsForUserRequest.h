...
/*
 * OAIAdminListGroupsForUserRequest.h
 *
 * 
 */

#ifndef OAIAdminListGroupsForUserRequest_H
#define OAIAdminListGroupsForUserRequest_H
...
class OAIAdminListGroupsForUserRequest : public OAIObject {
public:
    OAIAdminListGroupsForUserRequest();
    OAIAdminListGroupsForUserRequest(QString json);
    ~OAIAdminListGroupsForUserRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdminListGroupsForUserRequest)

#endif // OAIAdminListGroupsForUserRequest_H
