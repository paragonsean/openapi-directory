...
OAIGetUserAttributeVerificationCodeResponse::OAIGetUserAttributeVerificationCodeResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetUserAttributeVerificationCodeResponse::OAIGetUserAttributeVerificationCodeResponse() {
    this->initializeModel();
}

OAIGetUserAttributeVerificationCodeResponse::~OAIGetUserAttributeVerificationCodeResponse() {}

void OAIGetUserAttributeVerificationCodeResponse::initializeModel() {

    m_code_delivery_details_isSet = false;
    m_code_delivery_details_isValid = false;
}

void OAIGetUserAttributeVerificationCodeResponse::fromJson(QString jsonString) {
...
void OAIGetUserAttributeVerificationCodeResponse::fromJsonObject(QJsonObject json) {
...
QString OAIGetUserAttributeVerificationCodeResponse::asJson() const {
...
QJsonObject OAIGetUserAttributeVerificationCodeResponse::asJsonObject() const {
    QJsonObject obj;
...
OAIGetUserAttributeVerificationCodeResponse_CodeDeliveryDetails OAIGetUserAttributeVerificationCodeResponse::getCodeDeliveryDetails() const {
    return m_code_delivery_details;
}
void OAIGetUserAttributeVerificationCodeResponse::setCodeDeliveryDetails(const OAIGetUserAttributeVerificationCodeResponse_CodeDeliveryDetails &code_delivery_details) {
    m_code_delivery_details = code_delivery_details;
    m_code_delivery_details_isSet = true;
}

bool OAIGetUserAttributeVerificationCodeResponse::is_code_delivery_details_Set() const{
    return m_code_delivery_details_isSet;
}

bool OAIGetUserAttributeVerificationCodeResponse::is_code_delivery_details_Valid() const{
    return m_code_delivery_details_isValid;
}

bool OAIGetUserAttributeVerificationCodeResponse::isSet() const {
...
bool OAIGetUserAttributeVerificationCodeResponse::isValid() const {
