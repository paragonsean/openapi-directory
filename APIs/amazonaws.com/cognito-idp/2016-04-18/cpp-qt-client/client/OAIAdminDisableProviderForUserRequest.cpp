...
OAIAdminDisableProviderForUserRequest::OAIAdminDisableProviderForUserRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdminDisableProviderForUserRequest::OAIAdminDisableProviderForUserRequest() {
    this->initializeModel();
}

OAIAdminDisableProviderForUserRequest::~OAIAdminDisableProviderForUserRequest() {}

void OAIAdminDisableProviderForUserRequest::initializeModel() {
...
void OAIAdminDisableProviderForUserRequest::fromJson(QString jsonString) {
...
void OAIAdminDisableProviderForUserRequest::fromJsonObject(QJsonObject json) {
...
QString OAIAdminDisableProviderForUserRequest::asJson() const {
...
QJsonObject OAIAdminDisableProviderForUserRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAdminDisableProviderForUserRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIAdminDisableProviderForUserRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIAdminDisableProviderForUserRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIAdminDisableProviderForUserRequest::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

OAIAdminDisableProviderForUserRequest_User OAIAdminDisableProviderForUserRequest::getUser() const {
    return m_user;
}
void OAIAdminDisableProviderForUserRequest::setUser(const OAIAdminDisableProviderForUserRequest_User &user) {
    m_user = user;
    m_user_isSet = true;
}

bool OAIAdminDisableProviderForUserRequest::is_user_Set() const{
    return m_user_isSet;
}

bool OAIAdminDisableProviderForUserRequest::is_user_Valid() const{
    return m_user_isValid;
}

bool OAIAdminDisableProviderForUserRequest::isSet() const {
...
bool OAIAdminDisableProviderForUserRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_user_pool_id_isValid && m_user_isValid && true;
}
