...
/*
 * OAIAuthEventType_EventContextData.h
 *
 * 
 */

#ifndef OAIAuthEventType_EventContextData_H
#define OAIAuthEventType_EventContextData_H
...
class OAIAuthEventType_EventContextData : public OAIObject {
public:
    OAIAuthEventType_EventContextData();
    OAIAuthEventType_EventContextData(QString json);
    ~OAIAuthEventType_EventContextData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAuthEventType_EventContextData)

#endif // OAIAuthEventType_EventContextData_H
