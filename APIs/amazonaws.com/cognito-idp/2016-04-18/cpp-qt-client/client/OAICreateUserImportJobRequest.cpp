...
OAICreateUserImportJobRequest::OAICreateUserImportJobRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateUserImportJobRequest::OAICreateUserImportJobRequest() {
    this->initializeModel();
}

OAICreateUserImportJobRequest::~OAICreateUserImportJobRequest() {}

void OAICreateUserImportJobRequest::initializeModel() {
...
void OAICreateUserImportJobRequest::fromJson(QString jsonString) {
...
void OAICreateUserImportJobRequest::fromJsonObject(QJsonObject json) {
...
QString OAICreateUserImportJobRequest::asJson() const {
...
QJsonObject OAICreateUserImportJobRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_job_name_isSet) {
...
QString OAICreateUserImportJobRequest::getJobName() const {
    return m_job_name;
}
void OAICreateUserImportJobRequest::setJobName(const QString &job_name) {
    m_job_name = job_name;
    m_job_name_isSet = true;
}

bool OAICreateUserImportJobRequest::is_job_name_Set() const{
    return m_job_name_isSet;
}

bool OAICreateUserImportJobRequest::is_job_name_Valid() const{
    return m_job_name_isValid;
}

QString OAICreateUserImportJobRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAICreateUserImportJobRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAICreateUserImportJobRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAICreateUserImportJobRequest::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

QString OAICreateUserImportJobRequest::getCloudWatchLogsRoleArn() const {
    return m_cloud_watch_logs_role_arn;
}
void OAICreateUserImportJobRequest::setCloudWatchLogsRoleArn(const QString &cloud_watch_logs_role_arn) {
    m_cloud_watch_logs_role_arn = cloud_watch_logs_role_arn;
    m_cloud_watch_logs_role_arn_isSet = true;
}

bool OAICreateUserImportJobRequest::is_cloud_watch_logs_role_arn_Set() const{
    return m_cloud_watch_logs_role_arn_isSet;
}

bool OAICreateUserImportJobRequest::is_cloud_watch_logs_role_arn_Valid() const{
    return m_cloud_watch_logs_role_arn_isValid;
}

bool OAICreateUserImportJobRequest::isSet() const {
...
bool OAICreateUserImportJobRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_job_name_isValid && m_user_pool_id_isValid && m_cloud_watch_logs_role_arn_isValid && true;
}
