...
#ifndef OAIMFAOptionType_H
#define OAIMFAOptionType_H
...
class OAIMFAOptionType : public OAIObject {
public:
    OAIMFAOptionType();
    OAIMFAOptionType(QString json);
    ~OAIMFAOptionType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMFAOptionType)

#endif // OAIMFAOptionType_H
