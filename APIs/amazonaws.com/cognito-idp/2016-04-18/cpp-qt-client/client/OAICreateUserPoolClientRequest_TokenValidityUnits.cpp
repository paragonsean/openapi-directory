...
OAICreateUserPoolClientRequest_TokenValidityUnits::OAICreateUserPoolClientRequest_TokenValidityUnits(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateUserPoolClientRequest_TokenValidityUnits::OAICreateUserPoolClientRequest_TokenValidityUnits() {
    this->initializeModel();
}

OAICreateUserPoolClientRequest_TokenValidityUnits::~OAICreateUserPoolClientRequest_TokenValidityUnits() {}

void OAICreateUserPoolClientRequest_TokenValidityUnits::initializeModel() {
...
void OAICreateUserPoolClientRequest_TokenValidityUnits::fromJson(QString jsonString) {
...
void OAICreateUserPoolClientRequest_TokenValidityUnits::fromJsonObject(QJsonObject json) {
...
QString OAICreateUserPoolClientRequest_TokenValidityUnits::asJson() const {
...
QJsonObject OAICreateUserPoolClientRequest_TokenValidityUnits::asJsonObject() const {
    QJsonObject obj;
...
OAITimeUnitsType OAICreateUserPoolClientRequest_TokenValidityUnits::getAccessToken() const {
    return m_access_token;
}
void OAICreateUserPoolClientRequest_TokenValidityUnits::setAccessToken(const OAITimeUnitsType &access_token) {
    m_access_token = access_token;
    m_access_token_isSet = true;
}

bool OAICreateUserPoolClientRequest_TokenValidityUnits::is_access_token_Set() const{
    return m_access_token_isSet;
}

bool OAICreateUserPoolClientRequest_TokenValidityUnits::is_access_token_Valid() const{
    return m_access_token_isValid;
}

OAITimeUnitsType OAICreateUserPoolClientRequest_TokenValidityUnits::getIdToken() const {
    return m_id_token;
}
void OAICreateUserPoolClientRequest_TokenValidityUnits::setIdToken(const OAITimeUnitsType &id_token) {
    m_id_token = id_token;
    m_id_token_isSet = true;
}

bool OAICreateUserPoolClientRequest_TokenValidityUnits::is_id_token_Set() const{
    return m_id_token_isSet;
}

bool OAICreateUserPoolClientRequest_TokenValidityUnits::is_id_token_Valid() const{
    return m_id_token_isValid;
}

OAITimeUnitsType OAICreateUserPoolClientRequest_TokenValidityUnits::getRefreshToken() const {
    return m_refresh_token;
}
void OAICreateUserPoolClientRequest_TokenValidityUnits::setRefreshToken(const OAITimeUnitsType &refresh_token) {
    m_refresh_token = refresh_token;
    m_refresh_token_isSet = true;
}

bool OAICreateUserPoolClientRequest_TokenValidityUnits::is_refresh_token_Set() const{
    return m_refresh_token_isSet;
}

bool OAICreateUserPoolClientRequest_TokenValidityUnits::is_refresh_token_Valid() const{
    return m_refresh_token_isValid;
}

bool OAICreateUserPoolClientRequest_TokenValidityUnits::isSet() const {
...
bool OAICreateUserPoolClientRequest_TokenValidityUnits::isValid() const {
