...
OAIAdminGetDeviceResponse::OAIAdminGetDeviceResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdminGetDeviceResponse::OAIAdminGetDeviceResponse() {
    this->initializeModel();
}

OAIAdminGetDeviceResponse::~OAIAdminGetDeviceResponse() {}

void OAIAdminGetDeviceResponse::initializeModel() {

    m_device_isSet = false;
    m_device_isValid = false;
}

void OAIAdminGetDeviceResponse::fromJson(QString jsonString) {
...
void OAIAdminGetDeviceResponse::fromJsonObject(QJsonObject json) {
...
QString OAIAdminGetDeviceResponse::asJson() const {
...
QJsonObject OAIAdminGetDeviceResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_device.isSet()) {
...
OAIAdminGetDeviceResponse_Device OAIAdminGetDeviceResponse::getDevice() const {
    return m_device;
}
void OAIAdminGetDeviceResponse::setDevice(const OAIAdminGetDeviceResponse_Device &device) {
    m_device = device;
    m_device_isSet = true;
}

bool OAIAdminGetDeviceResponse::is_device_Set() const{
    return m_device_isSet;
}

bool OAIAdminGetDeviceResponse::is_device_Valid() const{
    return m_device_isValid;
}

bool OAIAdminGetDeviceResponse::isSet() const {
...
bool OAIAdminGetDeviceResponse::isValid() const {
