...
OAIListUserImportJobsRequest::OAIListUserImportJobsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListUserImportJobsRequest::OAIListUserImportJobsRequest() {
    this->initializeModel();
}

OAIListUserImportJobsRequest::~OAIListUserImportJobsRequest() {}

void OAIListUserImportJobsRequest::initializeModel() {
...
void OAIListUserImportJobsRequest::fromJson(QString jsonString) {
...
void OAIListUserImportJobsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListUserImportJobsRequest::asJson() const {
...
QJsonObject OAIListUserImportJobsRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListUserImportJobsRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIListUserImportJobsRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIListUserImportJobsRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIListUserImportJobsRequest::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

qint32 OAIListUserImportJobsRequest::getMaxResults() const {
    return m_max_results;
}
void OAIListUserImportJobsRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListUserImportJobsRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListUserImportJobsRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIListUserImportJobsRequest::getPaginationToken() const {
    return m_pagination_token;
}
void OAIListUserImportJobsRequest::setPaginationToken(const QString &pagination_token) {
    m_pagination_token = pagination_token;
    m_pagination_token_isSet = true;
}

bool OAIListUserImportJobsRequest::is_pagination_token_Set() const{
    return m_pagination_token_isSet;
}

bool OAIListUserImportJobsRequest::is_pagination_token_Valid() const{
    return m_pagination_token_isValid;
}

bool OAIListUserImportJobsRequest::isSet() const {
...
bool OAIListUserImportJobsRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_user_pool_id_isValid && m_max_results_isValid && true;
}
