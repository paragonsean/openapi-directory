...
/*
 * OAIDescribeIdentityProviderRequest.h
 *
 * 
 */

#ifndef OAIDescribeIdentityProviderRequest_H
#define OAIDescribeIdentityProviderRequest_H
...
class OAIDescribeIdentityProviderRequest : public OAIObject {
public:
    OAIDescribeIdentityProviderRequest();
    OAIDescribeIdentityProviderRequest(QString json);
    ~OAIDescribeIdentityProviderRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeIdentityProviderRequest)

#endif // OAIDescribeIdentityProviderRequest_H
