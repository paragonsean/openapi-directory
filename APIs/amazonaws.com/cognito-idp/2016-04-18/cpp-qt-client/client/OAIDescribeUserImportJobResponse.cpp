...
OAIDescribeUserImportJobResponse::OAIDescribeUserImportJobResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeUserImportJobResponse::OAIDescribeUserImportJobResponse() {
    this->initializeModel();
}

OAIDescribeUserImportJobResponse::~OAIDescribeUserImportJobResponse() {}

void OAIDescribeUserImportJobResponse::initializeModel() {

    m_user_import_job_isSet = false;
    m_user_import_job_isValid = false;
}

void OAIDescribeUserImportJobResponse::fromJson(QString jsonString) {
...
void OAIDescribeUserImportJobResponse::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeUserImportJobResponse::asJson() const {
...
QJsonObject OAIDescribeUserImportJobResponse::asJsonObject() const {
    QJsonObject obj;
...
OAICreateUserImportJobResponse_UserImportJob OAIDescribeUserImportJobResponse::getUserImportJob() const {
    return m_user_import_job;
}
void OAIDescribeUserImportJobResponse::setUserImportJob(const OAICreateUserImportJobResponse_UserImportJob &user_import_job) {
    m_user_import_job = user_import_job;
    m_user_import_job_isSet = true;
}

bool OAIDescribeUserImportJobResponse::is_user_import_job_Set() const{
    return m_user_import_job_isSet;
}

bool OAIDescribeUserImportJobResponse::is_user_import_job_Valid() const{
    return m_user_import_job_isValid;
}

bool OAIDescribeUserImportJobResponse::isSet() const {
...
bool OAIDescribeUserImportJobResponse::isValid() const {
