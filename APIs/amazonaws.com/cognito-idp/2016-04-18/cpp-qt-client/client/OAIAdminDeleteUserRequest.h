...
/*
 * OAIAdminDeleteUserRequest.h
 *
 * Represents the request to delete a user as an administrator.
 */

#ifndef OAIAdminDeleteUserRequest_H
#define OAIAdminDeleteUserRequest_H
...
class OAIAdminDeleteUserRequest : public OAIObject {
public:
    OAIAdminDeleteUserRequest();
    OAIAdminDeleteUserRequest(QString json);
    ~OAIAdminDeleteUserRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdminDeleteUserRequest)

#endif // OAIAdminDeleteUserRequest_H
