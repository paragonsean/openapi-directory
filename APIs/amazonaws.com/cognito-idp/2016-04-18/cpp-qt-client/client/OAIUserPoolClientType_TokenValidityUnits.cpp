...
OAIUserPoolClientType_TokenValidityUnits::OAIUserPoolClientType_TokenValidityUnits(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUserPoolClientType_TokenValidityUnits::OAIUserPoolClientType_TokenValidityUnits() {
    this->initializeModel();
}

OAIUserPoolClientType_TokenValidityUnits::~OAIUserPoolClientType_TokenValidityUnits() {}

void OAIUserPoolClientType_TokenValidityUnits::initializeModel() {
...
void OAIUserPoolClientType_TokenValidityUnits::fromJson(QString jsonString) {
...
void OAIUserPoolClientType_TokenValidityUnits::fromJsonObject(QJsonObject json) {
...
QString OAIUserPoolClientType_TokenValidityUnits::asJson() const {
...
QJsonObject OAIUserPoolClientType_TokenValidityUnits::asJsonObject() const {
    QJsonObject obj;
...
OAITimeUnitsType OAIUserPoolClientType_TokenValidityUnits::getAccessToken() const {
    return m_access_token;
}
void OAIUserPoolClientType_TokenValidityUnits::setAccessToken(const OAITimeUnitsType &access_token) {
    m_access_token = access_token;
    m_access_token_isSet = true;
}

bool OAIUserPoolClientType_TokenValidityUnits::is_access_token_Set() const{
    return m_access_token_isSet;
}

bool OAIUserPoolClientType_TokenValidityUnits::is_access_token_Valid() const{
    return m_access_token_isValid;
}

OAITimeUnitsType OAIUserPoolClientType_TokenValidityUnits::getIdToken() const {
    return m_id_token;
}
void OAIUserPoolClientType_TokenValidityUnits::setIdToken(const OAITimeUnitsType &id_token) {
    m_id_token = id_token;
    m_id_token_isSet = true;
}

bool OAIUserPoolClientType_TokenValidityUnits::is_id_token_Set() const{
    return m_id_token_isSet;
}

bool OAIUserPoolClientType_TokenValidityUnits::is_id_token_Valid() const{
    return m_id_token_isValid;
}

OAITimeUnitsType OAIUserPoolClientType_TokenValidityUnits::getRefreshToken() const {
    return m_refresh_token;
}
void OAIUserPoolClientType_TokenValidityUnits::setRefreshToken(const OAITimeUnitsType &refresh_token) {
    m_refresh_token = refresh_token;
    m_refresh_token_isSet = true;
}

bool OAIUserPoolClientType_TokenValidityUnits::is_refresh_token_Set() const{
    return m_refresh_token_isSet;
}

bool OAIUserPoolClientType_TokenValidityUnits::is_refresh_token_Valid() const{
    return m_refresh_token_isValid;
}

bool OAIUserPoolClientType_TokenValidityUnits::isSet() const {
...
bool OAIUserPoolClientType_TokenValidityUnits::isValid() const {
