...
/*
 * OAIAdminListDevicesResponse.h
 *
 * Lists the device&#39;s response, as an administrator.
 */

#ifndef OAIAdminListDevicesResponse_H
#define OAIAdminListDevicesResponse_H
...
class OAIAdminListDevicesResponse : public OAIObject {
public:
    OAIAdminListDevicesResponse();
    OAIAdminListDevicesResponse(QString json);
    ~OAIAdminListDevicesResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdminListDevicesResponse)

#endif // OAIAdminListDevicesResponse_H
