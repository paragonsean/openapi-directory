...
#include "OAICreateResourceServerResponse_ResourceServer.h"
...
OAICreateResourceServerResponse_ResourceServer::OAICreateResourceServerResponse_ResourceServer(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateResourceServerResponse_ResourceServer::OAICreateResourceServerResponse_ResourceServer() {
    this->initializeModel();
}

OAICreateResourceServerResponse_ResourceServer::~OAICreateResourceServerResponse_ResourceServer() {}

void OAICreateResourceServerResponse_ResourceServer::initializeModel() {
...
void OAICreateResourceServerResponse_ResourceServer::fromJson(QString jsonString) {
...
void OAICreateResourceServerResponse_ResourceServer::fromJsonObject(QJsonObject json) {
...
QString OAICreateResourceServerResponse_ResourceServer::asJson() const {
...
QJsonObject OAICreateResourceServerResponse_ResourceServer::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateResourceServerResponse_ResourceServer::getUserPoolId() const {
    return m_user_pool_id;
}
void OAICreateResourceServerResponse_ResourceServer::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAICreateResourceServerResponse_ResourceServer::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAICreateResourceServerResponse_ResourceServer::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

QString OAICreateResourceServerResponse_ResourceServer::getIdentifier() const {
    return m_identifier;
}
void OAICreateResourceServerResponse_ResourceServer::setIdentifier(const QString &identifier) {
    m_identifier = identifier;
    m_identifier_isSet = true;
}

bool OAICreateResourceServerResponse_ResourceServer::is_identifier_Set() const{
    return m_identifier_isSet;
}

bool OAICreateResourceServerResponse_ResourceServer::is_identifier_Valid() const{
    return m_identifier_isValid;
}

QString OAICreateResourceServerResponse_ResourceServer::getName() const {
    return m_name;
}
void OAICreateResourceServerResponse_ResourceServer::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICreateResourceServerResponse_ResourceServer::is_name_Set() const{
    return m_name_isSet;
}

bool OAICreateResourceServerResponse_ResourceServer::is_name_Valid() const{
    return m_name_isValid;
}

QList OAICreateResourceServerResponse_ResourceServer::getScopes() const {
    return m_scopes;
}
void OAICreateResourceServerResponse_ResourceServer::setScopes(const QList &scopes) {
    m_scopes = scopes;
    m_scopes_isSet = true;
}

bool OAICreateResourceServerResponse_ResourceServer::is_scopes_Set() const{
    return m_scopes_isSet;
}

bool OAICreateResourceServerResponse_ResourceServer::is_scopes_Valid() const{
    return m_scopes_isValid;
}

bool OAICreateResourceServerResponse_ResourceServer::isSet() const {
...
bool OAICreateResourceServerResponse_ResourceServer::isValid() const {
