...
OAIAdminListUserAuthEventsResponse::OAIAdminListUserAuthEventsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdminListUserAuthEventsResponse::OAIAdminListUserAuthEventsResponse() {
    this->initializeModel();
}

OAIAdminListUserAuthEventsResponse::~OAIAdminListUserAuthEventsResponse() {}

void OAIAdminListUserAuthEventsResponse::initializeModel() {

    m_auth_events_isSet = false;
    m_auth_events_isValid = false;

    m_next_token_isSet = false;
    m_next_token_isValid = false;
}

void OAIAdminListUserAuthEventsResponse::fromJson(QString jsonString) {
...
void OAIAdminListUserAuthEventsResponse::fromJsonObject(QJsonObject json) {

    m_auth_events_isValid = ::OpenAPI::fromJsonValue(m_auth_events, json[QString("AuthEvents")]);
    m_auth_events_isSet = !json[QString("AuthEvents")].isNull() && m_auth_events_isValid;

    m_next_token_isValid = ::OpenAPI::fromJsonValue(m_next_token, json[QString("NextToken")]);
    m_next_token_isSet = !json[QString("NextToken")].isNull() && m_next_token_isValid;
}

QString OAIAdminListUserAuthEventsResponse::asJson() const {
...
QJsonObject OAIAdminListUserAuthEventsResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_auth_events.isSet()) {
        obj.insert(QString("AuthEvents"), ::OpenAPI::toJsonValue(m_auth_events));
    }
...
QList OAIAdminListUserAuthEventsResponse::getAuthEvents() const {
    return m_auth_events;
}
void OAIAdminListUserAuthEventsResponse::setAuthEvents(const QList &auth_events) {
    m_auth_events = auth_events;
    m_auth_events_isSet = true;
}

bool OAIAdminListUserAuthEventsResponse::is_auth_events_Set() const{
    return m_auth_events_isSet;
}

bool OAIAdminListUserAuthEventsResponse::is_auth_events_Valid() const{
    return m_auth_events_isValid;
}

QString OAIAdminListUserAuthEventsResponse::getNextToken() const {
    return m_next_token;
}
void OAIAdminListUserAuthEventsResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIAdminListUserAuthEventsResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIAdminListUserAuthEventsResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIAdminListUserAuthEventsResponse::isSet() const {
...
bool OAIAdminListUserAuthEventsResponse::isValid() const {
