...
#ifndef OAIGetCSVHeaderResponse_H
#define OAIGetCSVHeaderResponse_H
...
class OAIGetCSVHeaderResponse : public OAIObject {
public:
    OAIGetCSVHeaderResponse();
    OAIGetCSVHeaderResponse(QString json);
    ~OAIGetCSVHeaderResponse() override;
    ...
    QList getCsvHeader() const;
    void setCsvHeader(const QList &csv_header);
    bool is_csv_header_Set() const;
    bool is_csv_header_Valid() const;
...
private:
    ...
    QList m_csv_header;
    bool m_csv_header_isSet;
    bool m_csv_header_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGetCSVHeaderResponse)

#endif // OAIGetCSVHeaderResponse_H
