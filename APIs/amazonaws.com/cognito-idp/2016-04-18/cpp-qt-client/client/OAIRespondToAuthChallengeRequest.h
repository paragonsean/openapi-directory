...
/*
 * OAIRespondToAuthChallengeRequest.h
 *
 * The request to respond to an authentication challenge.
 */

#ifndef OAIRespondToAuthChallengeRequest_H
#define OAIRespondToAuthChallengeRequest_H

#include <QJsonObject>

#include "OAIChallengeNameType.h"
#include "OAIConfirmForgotPasswordRequest_UserContextData.h"
#include "OAIRespondToAuthChallengeRequest_AnalyticsMetadata.h"
#include <QMap>
#include <QString>
...
namespace OpenAPI {
class OAIRespondToAuthChallengeRequest_AnalyticsMetadata;
class OAIConfirmForgotPasswordRequest_UserContextData;

class OAIRespondToAuthChallengeRequest : public OAIObject {
public:
    OAIRespondToAuthChallengeRequest();
    OAIRespondToAuthChallengeRequest(QString json);
    ~OAIRespondToAuthChallengeRequest() override;
    ...
    QMap getChallengeResponses() const;
    void setChallengeResponses(const QMap &challenge_responses);
    bool is_challenge_responses_Set() const;
    bool is_challenge_responses_Valid() const;

    OAIRespondToAuthChallengeRequest_AnalyticsMetadata getAnalyticsMetadata() const;
    void setAnalyticsMetadata(const OAIRespondToAuthChallengeRequest_AnalyticsMetadata &analytics_metadata);
...
private:
    ...
    QMap m_challenge_responses;
    bool m_challenge_responses_isSet;
    bool m_challenge_responses_isValid;

    OAIRespondToAuthChallengeRequest_AnalyticsMetadata m_analytics_metadata;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRespondToAuthChallengeRequest)

#endif // OAIRespondToAuthChallengeRequest_H
