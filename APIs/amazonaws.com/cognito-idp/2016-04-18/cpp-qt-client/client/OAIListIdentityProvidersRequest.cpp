...
QString OAIListIdentityProvidersRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIListIdentityProvidersRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIListIdentityProvidersRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIListIdentityProvidersRequest::is_user_pool_id_Valid() const{
