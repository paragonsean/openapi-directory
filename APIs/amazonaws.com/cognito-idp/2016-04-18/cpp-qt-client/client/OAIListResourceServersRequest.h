...
/*
 * OAIListResourceServersRequest.h
 *
 * 
 */

#ifndef OAIListResourceServersRequest_H
#define OAIListResourceServersRequest_H
...
class OAIListResourceServersRequest : public OAIObject {
public:
    OAIListResourceServersRequest();
    OAIListResourceServersRequest(QString json);
    ~OAIListResourceServersRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListResourceServersRequest)

#endif // OAIListResourceServersRequest_H
