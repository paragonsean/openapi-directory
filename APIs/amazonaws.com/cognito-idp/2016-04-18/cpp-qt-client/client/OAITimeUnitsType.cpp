...
OAITimeUnitsType::OAITimeUnitsType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITimeUnitsType::OAITimeUnitsType() {
    this->initializeModel();
}

OAITimeUnitsType::~OAITimeUnitsType() {}

void OAITimeUnitsType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAITimeUnitsType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAITimeUnitsType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("seconds", Qt::CaseInsensitive) == 0) {
        m_value = eOAITimeUnitsType::SECONDS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("minutes", Qt::CaseInsensitive) == 0) {
        m_value = eOAITimeUnitsType::MINUTES;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("hours", Qt::CaseInsensitive) == 0) {
        m_value = eOAITimeUnitsType::HOURS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("days", Qt::CaseInsensitive) == 0) {
        m_value = eOAITimeUnitsType::DAYS;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAITimeUnitsType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAITimeUnitsType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAITimeUnitsType::SECONDS:
            val = "seconds";
            break;
        case eOAITimeUnitsType::MINUTES:
            val = "minutes";
            break;
        case eOAITimeUnitsType::HOURS:
            val = "hours";
            break;
        case eOAITimeUnitsType::DAYS:
            val = "days";
            break;
        default:
            break;
...
QJsonValue OAITimeUnitsType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAITimeUnitsType::eOAITimeUnitsType OAITimeUnitsType::getValue() const {
    return m_value;
}

void OAITimeUnitsType::setValue(const OAITimeUnitsType::eOAITimeUnitsType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAITimeUnitsType::isSet() const {
    
    return m_value_isSet;
}

bool OAITimeUnitsType::isValid() const {
