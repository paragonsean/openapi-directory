...
void OAIIdentityProviderType::fromJsonObject(QJsonObject json) {
...
QJsonObject OAIIdentityProviderType::asJsonObject() const {
    QJsonObject obj;
...
QString OAIIdentityProviderType::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIIdentityProviderType::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIIdentityProviderType::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIIdentityProviderType::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

QString OAIIdentityProviderType::getProviderName() const {
    return m_provider_name;
}
void OAIIdentityProviderType::setProviderName(const QString &provider_name) {
    m_provider_name = provider_name;
    m_provider_name_isSet = true;
}

bool OAIIdentityProviderType::is_provider_name_Set() const{
    return m_provider_name_isSet;
}

bool OAIIdentityProviderType::is_provider_name_Valid() const{
    return m_provider_name_isValid;
}

OAIIdentityProviderTypeType OAIIdentityProviderType::getProviderType() const {
    return m_provider_type;
}
void OAIIdentityProviderType::setProviderType(const OAIIdentityProviderTypeType &provider_type) {
    m_provider_type = provider_type;
    m_provider_type_isSet = true;
}

bool OAIIdentityProviderType::is_provider_type_Set() const{
    return m_provider_type_isSet;
}

bool OAIIdentityProviderType::is_provider_type_Valid() const{
    return m_provider_type_isValid;
}

QMap OAIIdentityProviderType::getProviderDetails() const {
    return m_provider_details;
}
void OAIIdentityProviderType::setProviderDetails(const QMap &provider_details) {
    m_provider_details = provider_details;
    m_provider_details_isSet = true;
}

bool OAIIdentityProviderType::is_provider_details_Set() const{
    return m_provider_details_isSet;
}

bool OAIIdentityProviderType::is_provider_details_Valid() const{
    return m_provider_details_isValid;
}

QMap OAIIdentityProviderType::getAttributeMapping() const {
    return m_attribute_mapping;
}
void OAIIdentityProviderType::setAttributeMapping(const QMap &attribute_mapping) {
    m_attribute_mapping = attribute_mapping;
    m_attribute_mapping_isSet = true;
}

bool OAIIdentityProviderType::is_attribute_mapping_Set() const{
    return m_attribute_mapping_isSet;
}

bool OAIIdentityProviderType::is_attribute_mapping_Valid() const{
    return m_attribute_mapping_isValid;
}

QList OAIIdentityProviderType::getIdpIdentifiers() const {
    return m_idp_identifiers;
}
void OAIIdentityProviderType::setIdpIdentifiers(const QList &idp_identifiers) {
    m_idp_identifiers = idp_identifiers;
    m_idp_identifiers_isSet = true;
}

bool OAIIdentityProviderType::is_idp_identifiers_Set() const{
    return m_idp_identifiers_isSet;
}

bool OAIIdentityProviderType::is_idp_identifiers_Valid() const{
    return m_idp_identifiers_isValid;
}

QDateTime OAIIdentityProviderType::getLastModifiedDate() const {
    return m_last_modified_date;
}
void OAIIdentityProviderType::setLastModifiedDate(const QDateTime &last_modified_date) {
    m_last_modified_date = last_modified_date;
    m_last_modified_date_isSet = true;
}

bool OAIIdentityProviderType::is_last_modified_date_Set() const{
    return m_last_modified_date_isSet;
}

bool OAIIdentityProviderType::is_last_modified_date_Valid() const{
    return m_last_modified_date_isValid;
}

QDateTime OAIIdentityProviderType::getCreationDate() const {
    return m_creation_date;
}
void OAIIdentityProviderType::setCreationDate(const QDateTime &creation_date) {
    m_creation_date = creation_date;
    m_creation_date_isSet = true;
}

bool OAIIdentityProviderType::is_creation_date_Set() const{
    return m_creation_date_isSet;
}

bool OAIIdentityProviderType::is_creation_date_Valid() const{
