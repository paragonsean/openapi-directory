...
QString OAIDeleteGroupRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIDeleteGroupRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIDeleteGroupRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIDeleteGroupRequest::is_user_pool_id_Valid() const{
