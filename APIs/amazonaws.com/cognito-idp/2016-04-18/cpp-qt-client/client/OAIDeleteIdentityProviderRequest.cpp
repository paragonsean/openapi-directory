...
OAIDeleteIdentityProviderRequest::OAIDeleteIdentityProviderRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteIdentityProviderRequest::OAIDeleteIdentityProviderRequest() {
    this->initializeModel();
}

OAIDeleteIdentityProviderRequest::~OAIDeleteIdentityProviderRequest() {}

void OAIDeleteIdentityProviderRequest::initializeModel() {
...
void OAIDeleteIdentityProviderRequest::fromJson(QString jsonString) {
...
void OAIDeleteIdentityProviderRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteIdentityProviderRequest::asJson() const {
...
QJsonObject OAIDeleteIdentityProviderRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteIdentityProviderRequest::getUserPoolId() const {
    return m_user_pool_id;
}
void OAIDeleteIdentityProviderRequest::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAIDeleteIdentityProviderRequest::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAIDeleteIdentityProviderRequest::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

QString OAIDeleteIdentityProviderRequest::getProviderName() const {
    return m_provider_name;
}
void OAIDeleteIdentityProviderRequest::setProviderName(const QString &provider_name) {
    m_provider_name = provider_name;
    m_provider_name_isSet = true;
}

bool OAIDeleteIdentityProviderRequest::is_provider_name_Set() const{
    return m_provider_name_isSet;
}

bool OAIDeleteIdentityProviderRequest::is_provider_name_Valid() const{
    return m_provider_name_isValid;
}

bool OAIDeleteIdentityProviderRequest::isSet() const {
...
bool OAIDeleteIdentityProviderRequest::isValid() const {
