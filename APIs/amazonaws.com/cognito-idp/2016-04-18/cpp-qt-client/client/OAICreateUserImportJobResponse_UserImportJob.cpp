...
#include "OAICreateUserImportJobResponse_UserImportJob.h"
...
OAICreateUserImportJobResponse_UserImportJob::OAICreateUserImportJobResponse_UserImportJob(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateUserImportJobResponse_UserImportJob::OAICreateUserImportJobResponse_UserImportJob() {
    this->initializeModel();
}

OAICreateUserImportJobResponse_UserImportJob::~OAICreateUserImportJobResponse_UserImportJob() {}

void OAICreateUserImportJobResponse_UserImportJob::initializeModel() {
...
void OAICreateUserImportJobResponse_UserImportJob::fromJson(QString jsonString) {
...
void OAICreateUserImportJobResponse_UserImportJob::fromJsonObject(QJsonObject json) {
...
QString OAICreateUserImportJobResponse_UserImportJob::asJson() const {
...
QJsonObject OAICreateUserImportJobResponse_UserImportJob::asJsonObject() const {
    QJsonObject obj;
    if (m_job_name_isSet) {
...
QString OAICreateUserImportJobResponse_UserImportJob::getJobName() const {
    return m_job_name;
}
void OAICreateUserImportJobResponse_UserImportJob::setJobName(const QString &job_name) {
    m_job_name = job_name;
    m_job_name_isSet = true;
}

bool OAICreateUserImportJobResponse_UserImportJob::is_job_name_Set() const{
    return m_job_name_isSet;
}

bool OAICreateUserImportJobResponse_UserImportJob::is_job_name_Valid() const{
    return m_job_name_isValid;
}

QString OAICreateUserImportJobResponse_UserImportJob::getJobId() const {
    return m_job_id;
}
void OAICreateUserImportJobResponse_UserImportJob::setJobId(const QString &job_id) {
    m_job_id = job_id;
    m_job_id_isSet = true;
}

bool OAICreateUserImportJobResponse_UserImportJob::is_job_id_Set() const{
    return m_job_id_isSet;
}

bool OAICreateUserImportJobResponse_UserImportJob::is_job_id_Valid() const{
    return m_job_id_isValid;
}

QString OAICreateUserImportJobResponse_UserImportJob::getUserPoolId() const {
    return m_user_pool_id;
}
void OAICreateUserImportJobResponse_UserImportJob::setUserPoolId(const QString &user_pool_id) {
    m_user_pool_id = user_pool_id;
    m_user_pool_id_isSet = true;
}

bool OAICreateUserImportJobResponse_UserImportJob::is_user_pool_id_Set() const{
    return m_user_pool_id_isSet;
}

bool OAICreateUserImportJobResponse_UserImportJob::is_user_pool_id_Valid() const{
    return m_user_pool_id_isValid;
}

QString OAICreateUserImportJobResponse_UserImportJob::getPreSignedUrl() const {
    return m_pre_signed_url;
}
void OAICreateUserImportJobResponse_UserImportJob::setPreSignedUrl(const QString &pre_signed_url) {
    m_pre_signed_url = pre_signed_url;
    m_pre_signed_url_isSet = true;
}

bool OAICreateUserImportJobResponse_UserImportJob::is_pre_signed_url_Set() const{
    return m_pre_signed_url_isSet;
}

bool OAICreateUserImportJobResponse_UserImportJob::is_pre_signed_url_Valid() const{
    return m_pre_signed_url_isValid;
}

QDateTime OAICreateUserImportJobResponse_UserImportJob::getCreationDate() const {
    return m_creation_date;
}
void OAICreateUserImportJobResponse_UserImportJob::setCreationDate(const QDateTime &creation_date) {
    m_creation_date = creation_date;
    m_creation_date_isSet = true;
}

bool OAICreateUserImportJobResponse_UserImportJob::is_creation_date_Set() const{
    return m_creation_date_isSet;
}

bool OAICreateUserImportJobResponse_UserImportJob::is_creation_date_Valid() const{
    return m_creation_date_isValid;
}

QDateTime OAICreateUserImportJobResponse_UserImportJob::getStartDate() const {
    return m_start_date;
}
void OAICreateUserImportJobResponse_UserImportJob::setStartDate(const QDateTime &start_date) {
    m_start_date = start_date;
    m_start_date_isSet = true;
}

bool OAICreateUserImportJobResponse_UserImportJob::is_start_date_Set() const{
    return m_start_date_isSet;
}

bool OAICreateUserImportJobResponse_UserImportJob::is_start_date_Valid() const{
    return m_start_date_isValid;
}

QDateTime OAICreateUserImportJobResponse_UserImportJob::getCompletionDate() const {
    return m_completion_date;
}
void OAICreateUserImportJobResponse_UserImportJob::setCompletionDate(const QDateTime &completion_date) {
    m_completion_date = completion_date;
    m_completion_date_isSet = true;
}

bool OAICreateUserImportJobResponse_UserImportJob::is_completion_date_Set() const{
    return m_completion_date_isSet;
}

bool OAICreateUserImportJobResponse_UserImportJob::is_completion_date_Valid() const{
    return m_completion_date_isValid;
}

OAIUserImportJobStatusType OAICreateUserImportJobResponse_UserImportJob::getStatus() const {
    return m_status;
}
void OAICreateUserImportJobResponse_UserImportJob::setStatus(const OAIUserImportJobStatusType &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAICreateUserImportJobResponse_UserImportJob::is_status_Set() const{
    return m_status_isSet;
}

bool OAICreateUserImportJobResponse_UserImportJob::is_status_Valid() const{
    return m_status_isValid;
}

QString OAICreateUserImportJobResponse_UserImportJob::getCloudWatchLogsRoleArn() const {
    return m_cloud_watch_logs_role_arn;
}
void OAICreateUserImportJobResponse_UserImportJob::setCloudWatchLogsRoleArn(const QString &cloud_watch_logs_role_arn) {
    m_cloud_watch_logs_role_arn = cloud_watch_logs_role_arn;
    m_cloud_watch_logs_role_arn_isSet = true;
}

bool OAICreateUserImportJobResponse_UserImportJob::is_cloud_watch_logs_role_arn_Set() const{
    return m_cloud_watch_logs_role_arn_isSet;
}

bool OAICreateUserImportJobResponse_UserImportJob::is_cloud_watch_logs_role_arn_Valid() const{
    return m_cloud_watch_logs_role_arn_isValid;
}

qint32 OAICreateUserImportJobResponse_UserImportJob::getImportedUsers() const {
    return m_imported_users;
}
void OAICreateUserImportJobResponse_UserImportJob::setImportedUsers(const qint32 &imported_users) {
    m_imported_users = imported_users;
    m_imported_users_isSet = true;
}

bool OAICreateUserImportJobResponse_UserImportJob::is_imported_users_Set() const{
    return m_imported_users_isSet;
}

bool OAICreateUserImportJobResponse_UserImportJob::is_imported_users_Valid() const{
    return m_imported_users_isValid;
}

qint32 OAICreateUserImportJobResponse_UserImportJob::getSkippedUsers() const {
    return m_skipped_users;
}
void OAICreateUserImportJobResponse_UserImportJob::setSkippedUsers(const qint32 &skipped_users) {
    m_skipped_users = skipped_users;
    m_skipped_users_isSet = true;
}

bool OAICreateUserImportJobResponse_UserImportJob::is_skipped_users_Set() const{
    return m_skipped_users_isSet;
}

bool OAICreateUserImportJobResponse_UserImportJob::is_skipped_users_Valid() const{
    return m_skipped_users_isValid;
}

qint32 OAICreateUserImportJobResponse_UserImportJob::getFailedUsers() const {
    return m_failed_users;
}
void OAICreateUserImportJobResponse_UserImportJob::setFailedUsers(const qint32 &failed_users) {
    m_failed_users = failed_users;
    m_failed_users_isSet = true;
}

bool OAICreateUserImportJobResponse_UserImportJob::is_failed_users_Set() const{
    return m_failed_users_isSet;
}

bool OAICreateUserImportJobResponse_UserImportJob::is_failed_users_Valid() const{
    return m_failed_users_isValid;
}

QString OAICreateUserImportJobResponse_UserImportJob::getCompletionMessage() const {
    return m_completion_message;
}
void OAICreateUserImportJobResponse_UserImportJob::setCompletionMessage(const QString &completion_message) {
    m_completion_message = completion_message;
    m_completion_message_isSet = true;
}

bool OAICreateUserImportJobResponse_UserImportJob::is_completion_message_Set() const{
    return m_completion_message_isSet;
}

bool OAICreateUserImportJobResponse_UserImportJob::is_completion_message_Valid() const{
    return m_completion_message_isValid;
}

bool OAICreateUserImportJobResponse_UserImportJob::isSet() const {
...
bool OAICreateUserImportJobResponse_UserImportJob::isValid() const {
