...
OAICreateUserPoolClientResponse::OAICreateUserPoolClientResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateUserPoolClientResponse::OAICreateUserPoolClientResponse() {
    this->initializeModel();
}

OAICreateUserPoolClientResponse::~OAICreateUserPoolClientResponse() {}

void OAICreateUserPoolClientResponse::initializeModel() {

    m_user_pool_client_isSet = false;
    m_user_pool_client_isValid = false;
}

void OAICreateUserPoolClientResponse::fromJson(QString jsonString) {
...
void OAICreateUserPoolClientResponse::fromJsonObject(QJsonObject json) {
...
QString OAICreateUserPoolClientResponse::asJson() const {
...
QJsonObject OAICreateUserPoolClientResponse::asJsonObject() const {
    QJsonObject obj;
...
OAICreateUserPoolClientResponse_UserPoolClient OAICreateUserPoolClientResponse::getUserPoolClient() const {
    return m_user_pool_client;
}
void OAICreateUserPoolClientResponse::setUserPoolClient(const OAICreateUserPoolClientResponse_UserPoolClient &user_pool_client) {
    m_user_pool_client = user_pool_client;
    m_user_pool_client_isSet = true;
}

bool OAICreateUserPoolClientResponse::is_user_pool_client_Set() const{
    return m_user_pool_client_isSet;
}

bool OAICreateUserPoolClientResponse::is_user_pool_client_Valid() const{
    return m_user_pool_client_isValid;
}

bool OAICreateUserPoolClientResponse::isSet() const {
...
bool OAICreateUserPoolClientResponse::isValid() const {
