...
/*
 * OAIUserPoolDescriptionType.h
 *
 * A user pool description.
 */

#ifndef OAIUserPoolDescriptionType_H
#define OAIUserPoolDescriptionType_H
...
namespace OpenAPI {
class OAIUserPoolDescriptionType_LambdaConfig;

class OAIUserPoolDescriptionType : public OAIObject {
public:
    OAIUserPoolDescriptionType();
    OAIUserPoolDescriptionType(QString json);
    ~OAIUserPoolDescriptionType() override;
    ...
    OAIUserPoolDescriptionType_LambdaConfig getLambdaConfig() const;
    void setLambdaConfig(const OAIUserPoolDescriptionType_LambdaConfig &lambda_config);
...
private:
    ...
    OAIUserPoolDescriptionType_LambdaConfig m_lambda_config;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserPoolDescriptionType)

#endif // OAIUserPoolDescriptionType_H
