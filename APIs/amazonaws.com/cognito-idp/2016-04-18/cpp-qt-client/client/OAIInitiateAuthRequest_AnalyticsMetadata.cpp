...
OAIInitiateAuthRequest_AnalyticsMetadata::OAIInitiateAuthRequest_AnalyticsMetadata(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIInitiateAuthRequest_AnalyticsMetadata::OAIInitiateAuthRequest_AnalyticsMetadata() {
    this->initializeModel();
}

OAIInitiateAuthRequest_AnalyticsMetadata::~OAIInitiateAuthRequest_AnalyticsMetadata() {}

void OAIInitiateAuthRequest_AnalyticsMetadata::initializeModel() {

    m_analytics_endpoint_id_isSet = false;
    m_analytics_endpoint_id_isValid = false;
}

void OAIInitiateAuthRequest_AnalyticsMetadata::fromJson(QString jsonString) {
...
void OAIInitiateAuthRequest_AnalyticsMetadata::fromJsonObject(QJsonObject json) {
...
QString OAIInitiateAuthRequest_AnalyticsMetadata::asJson() const {
...
QJsonObject OAIInitiateAuthRequest_AnalyticsMetadata::asJsonObject() const {
    QJsonObject obj;
...
QString OAIInitiateAuthRequest_AnalyticsMetadata::getAnalyticsEndpointId() const {
    return m_analytics_endpoint_id;
}
void OAIInitiateAuthRequest_AnalyticsMetadata::setAnalyticsEndpointId(const QString &analytics_endpoint_id) {
    m_analytics_endpoint_id = analytics_endpoint_id;
    m_analytics_endpoint_id_isSet = true;
}

bool OAIInitiateAuthRequest_AnalyticsMetadata::is_analytics_endpoint_id_Set() const{
    return m_analytics_endpoint_id_isSet;
}

bool OAIInitiateAuthRequest_AnalyticsMetadata::is_analytics_endpoint_id_Valid() const{
    return m_analytics_endpoint_id_isValid;
}

bool OAIInitiateAuthRequest_AnalyticsMetadata::isSet() const {
...
bool OAIInitiateAuthRequest_AnalyticsMetadata::isValid() const {
