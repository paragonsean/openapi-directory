...
public class DescribeAppAssessmentResponseAssessment {
  ...
  public DescribeAppAssessmentResponseAssessment() {
  }

  public DescribeAppAssessmentResponseAssessment appArn(String appArn) {
    this.appArn = appArn;
    return this;
  }
  ...
  public DescribeAppAssessmentResponseAssessment appVersion(String appVersion) {
  ...
  public DescribeAppAssessmentResponseAssessment assessmentArn(String assessmentArn) {
  ...
  public DescribeAppAssessmentResponseAssessment assessmentName(String assessmentName) {
  ...
  public DescribeAppAssessmentResponseAssessment assessmentStatus(AssessmentStatus assessmentStatus) {
  ...
  public DescribeAppAssessmentResponseAssessment compliance(Map compliance) {
  ...
  public DescribeAppAssessmentResponseAssessment complianceStatus(ComplianceStatus complianceStatus) {
  ...
  public DescribeAppAssessmentResponseAssessment cost(AppAssessmentCost cost) {
    this.cost = cost;
    return this;
  }
  ...
  public DescribeAppAssessmentResponseAssessment driftStatus(DriftStatus driftStatus) {
  ...
  public DescribeAppAssessmentResponseAssessment endTime(OffsetDateTime endTime) {
  ...
  public DescribeAppAssessmentResponseAssessment invoker(AssessmentInvoker invoker) {
  ...
  public DescribeAppAssessmentResponseAssessment message(String message) {
  ...
  public DescribeAppAssessmentResponseAssessment policy(AppAssessmentPolicy policy) {
    this.policy = policy;
    return this;
  }
  ...
  public DescribeAppAssessmentResponseAssessment resiliencyScore(AppAssessmentResiliencyScore resiliencyScore) {
  ...
  public DescribeAppAssessmentResponseAssessment resourceErrorsDetails(AppAssessmentResourceErrorsDetails resourceErrorsDetails) {
  ...
  public DescribeAppAssessmentResponseAssessment startTime(OffsetDateTime startTime) {
  ...
  public DescribeAppAssessmentResponseAssessment tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public DescribeAppAssessmentResponseAssessment versionName(String versionName) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeAppAssessmentResponseAssessment describeAppAssessmentResponseAssessment = (DescribeAppAssessmentResponseAssessment) o;
    return Objects.equals(this.appArn, describeAppAssessmentResponseAssessment.appArn) &&
        Objects.equals(this.appVersion, describeAppAssessmentResponseAssessment.appVersion) &&
        Objects.equals(this.assessmentArn, describeAppAssessmentResponseAssessment.assessmentArn) &&
        Objects.equals(this.assessmentName, describeAppAssessmentResponseAssessment.assessmentName) &&
        Objects.equals(this.assessmentStatus, describeAppAssessmentResponseAssessment.assessmentStatus) &&
        Objects.equals(this.compliance, describeAppAssessmentResponseAssessment.compliance) &&
        Objects.equals(this.complianceStatus, describeAppAssessmentResponseAssessment.complianceStatus) &&
        Objects.equals(this.cost, describeAppAssessmentResponseAssessment.cost) &&
        Objects.equals(this.driftStatus, describeAppAssessmentResponseAssessment.driftStatus) &&
        Objects.equals(this.endTime, describeAppAssessmentResponseAssessment.endTime) &&
        Objects.equals(this.invoker, describeAppAssessmentResponseAssessment.invoker) &&
        Objects.equals(this.message, describeAppAssessmentResponseAssessment.message) &&
        Objects.equals(this.policy, describeAppAssessmentResponseAssessment.policy) &&
        Objects.equals(this.resiliencyScore, describeAppAssessmentResponseAssessment.resiliencyScore) &&
        Objects.equals(this.resourceErrorsDetails, describeAppAssessmentResponseAssessment.resourceErrorsDetails) &&
        Objects.equals(this.startTime, describeAppAssessmentResponseAssessment.startTime) &&
        Objects.equals(this.tags, describeAppAssessmentResponseAssessment.tags) &&
        Objects.equals(this.versionName, describeAppAssessmentResponseAssessment.versionName);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeAppAssessmentResponseAssessment {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeAppAssessmentResponseAssessment
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeAppAssessmentResponseAssessment.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeAppAssessmentResponseAssessment is not found in the empty JSON string", DescribeAppAssessmentResponseAssessment.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeAppAssessmentResponseAssessment.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeAppAssessmentResponseAssessment` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeAppAssessmentResponseAssessment.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeAppAssessmentResponseAssessment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeAppAssessmentResponseAssessment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeAppAssessmentResponseAssessment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeAppAssessmentResponseAssessment.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeAppAssessmentResponseAssessment>() {
           @Override
           public void write(JsonWriter out, DescribeAppAssessmentResponseAssessment value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeAppAssessmentResponseAssessment read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeAppAssessmentResponseAssessment given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeAppAssessmentResponseAssessment
   * @throws IOException if the JSON string is invalid with respect to DescribeAppAssessmentResponseAssessment
   */
  public static DescribeAppAssessmentResponseAssessment fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeAppAssessmentResponseAssessment.class);
  }

  /**
   * Convert an instance of DescribeAppAssessmentResponseAssessment to an JSON string
   *
   * @return JSON string
   */
