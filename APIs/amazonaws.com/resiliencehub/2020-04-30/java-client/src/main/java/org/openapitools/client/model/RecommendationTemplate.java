...
public class RecommendationTemplate {
  ...
  public RecommendationTemplate appArn(String appArn) {
    this.appArn = appArn;
    return this;
  }
  ...
  public RecommendationTemplate assessmentArn(String assessmentArn) {
  ...
  public RecommendationTemplate endTime(OffsetDateTime endTime) {
  ...
  public RecommendationTemplate format(TemplateFormat format) {
    this.format = format;
    return this;
  }
  ...
  public RecommendationTemplate message(String message) {
  ...
  public RecommendationTemplate name(String name) {
    this.name = name;
    return this;
  }
  ...
  public RecommendationTemplate needsReplacements(Boolean needsReplacements) {
  ...
  public RecommendationTemplate recommendationIds(List recommendationIds) {
  ...
  public RecommendationTemplate recommendationTemplateArn(String recommendationTemplateArn) {
  ...
  public RecommendationTemplate recommendationTypes(List recommendationTypes) {
  ...
  public RecommendationTemplate startTime(OffsetDateTime startTime) {
  ...
  public RecommendationTemplate status(RecommendationTemplateStatus status) {
    this.status = status;
    return this;
  }
  ...
  public RecommendationTemplate tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public RecommendationTemplate templatesLocation(RecommendationTemplateTemplatesLocation templatesLocation) {
  ...
  public boolean equals(Object o) {
    ...
    RecommendationTemplate recommendationTemplate = (RecommendationTemplate) o;
    return Objects.equals(this.appArn, recommendationTemplate.appArn) &&
        Objects.equals(this.assessmentArn, recommendationTemplate.assessmentArn) &&
        Objects.equals(this.endTime, recommendationTemplate.endTime) &&
        Objects.equals(this.format, recommendationTemplate.format) &&
        Objects.equals(this.message, recommendationTemplate.message) &&
        Objects.equals(this.name, recommendationTemplate.name) &&
        Objects.equals(this.needsReplacements, recommendationTemplate.needsReplacements) &&
        Objects.equals(this.recommendationIds, recommendationTemplate.recommendationIds) &&
        Objects.equals(this.recommendationTemplateArn, recommendationTemplate.recommendationTemplateArn) &&
        Objects.equals(this.recommendationTypes, recommendationTemplate.recommendationTypes) &&
        Objects.equals(this.startTime, recommendationTemplate.startTime) &&
        Objects.equals(this.status, recommendationTemplate.status) &&
        Objects.equals(this.tags, recommendationTemplate.tags) &&
        Objects.equals(this.templatesLocation, recommendationTemplate.templatesLocation);
  }
  ...
  public String toString() {
    ...
    sb.append("class RecommendationTemplate {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RecommendationTemplate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RecommendationTemplate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RecommendationTemplate is not found in the empty JSON string", RecommendationTemplate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RecommendationTemplate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RecommendationTemplate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RecommendationTemplate.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RecommendationTemplate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RecommendationTemplate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RecommendationTemplate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RecommendationTemplate.class));

       return (TypeAdapter<T>) new TypeAdapter<RecommendationTemplate>() {
           @Override
           public void write(JsonWriter out, RecommendationTemplate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RecommendationTemplate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RecommendationTemplate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RecommendationTemplate
   * @throws IOException if the JSON string is invalid with respect to RecommendationTemplate
   */
  public static RecommendationTemplate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RecommendationTemplate.class);
  }

  /**
   * Convert an instance of RecommendationTemplate to an JSON string
   *
   * @return JSON string
   */
