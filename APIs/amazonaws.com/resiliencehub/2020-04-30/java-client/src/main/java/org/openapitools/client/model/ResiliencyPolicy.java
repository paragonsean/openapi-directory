...
public class ResiliencyPolicy {
  ...
  public ResiliencyPolicy creationTime(OffsetDateTime creationTime) {
  ...
  public ResiliencyPolicy dataLocationConstraint(DataLocationConstraint dataLocationConstraint) {
  ...
  public ResiliencyPolicy estimatedCostTier(EstimatedCostTier estimatedCostTier) {
  ...
  public ResiliencyPolicy policy(Map policy) {
    this.policy = policy;
    return this;
  }
  ...
  public ResiliencyPolicy policyArn(String policyArn) {
  ...
  public ResiliencyPolicy policyDescription(String policyDescription) {
  ...
  public ResiliencyPolicy policyName(String policyName) {
  ...
  public ResiliencyPolicy tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public ResiliencyPolicy tier(ResiliencyPolicyTier tier) {
    this.tier = tier;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ResiliencyPolicy resiliencyPolicy = (ResiliencyPolicy) o;
    return Objects.equals(this.creationTime, resiliencyPolicy.creationTime) &&
        Objects.equals(this.dataLocationConstraint, resiliencyPolicy.dataLocationConstraint) &&
        Objects.equals(this.estimatedCostTier, resiliencyPolicy.estimatedCostTier) &&
        Objects.equals(this.policy, resiliencyPolicy.policy) &&
        Objects.equals(this.policyArn, resiliencyPolicy.policyArn) &&
        Objects.equals(this.policyDescription, resiliencyPolicy.policyDescription) &&
        Objects.equals(this.policyName, resiliencyPolicy.policyName) &&
        Objects.equals(this.tags, resiliencyPolicy.tags) &&
        Objects.equals(this.tier, resiliencyPolicy.tier);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResiliencyPolicy {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ResiliencyPolicy
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResiliencyPolicy.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResiliencyPolicy is not found in the empty JSON string", ResiliencyPolicy.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ResiliencyPolicy.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResiliencyPolicy` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResiliencyPolicy.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResiliencyPolicy' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResiliencyPolicy> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResiliencyPolicy.class));

       return (TypeAdapter<T>) new TypeAdapter<ResiliencyPolicy>() {
           @Override
           public void write(JsonWriter out, ResiliencyPolicy value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResiliencyPolicy read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ResiliencyPolicy given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ResiliencyPolicy
   * @throws IOException if the JSON string is invalid with respect to ResiliencyPolicy
   */
  public static ResiliencyPolicy fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResiliencyPolicy.class);
  }

  /**
   * Convert an instance of ResiliencyPolicy to an JSON string
   *
   * @return JSON string
   */
