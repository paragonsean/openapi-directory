...
public class AppAssessment {
  ...
  public AppAssessment() {
  }

  public AppAssessment appArn(String appArn) {
    this.appArn = appArn;
    return this;
  }
  ...
  public AppAssessment appVersion(String appVersion) {
  ...
  public AppAssessment assessmentArn(String assessmentArn) {
  ...
  public AppAssessment assessmentName(String assessmentName) {
  ...
  public AppAssessment assessmentStatus(AssessmentStatus assessmentStatus) {
  ...
  public AppAssessment compliance(Map compliance) {
  ...
  public AppAssessment complianceStatus(ComplianceStatus complianceStatus) {
  ...
  public AppAssessment cost(AppAssessmentCost cost) {
    this.cost = cost;
    return this;
  }
  ...
  public AppAssessment driftStatus(DriftStatus driftStatus) {
  ...
  public AppAssessment endTime(OffsetDateTime endTime) {
  ...
  public AppAssessment invoker(AssessmentInvoker invoker) {
  ...
  public AppAssessment message(String message) {
  ...
  public AppAssessment policy(AppAssessmentPolicy policy) {
    this.policy = policy;
    return this;
  }
  ...
  public AppAssessment resiliencyScore(AppAssessmentResiliencyScore resiliencyScore) {
  ...
  public AppAssessment resourceErrorsDetails(AppAssessmentResourceErrorsDetails resourceErrorsDetails) {
  ...
  public AppAssessment startTime(OffsetDateTime startTime) {
  ...
  public AppAssessment tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public AppAssessment versionName(String versionName) {
  ...
  public boolean equals(Object o) {
    ...
    AppAssessment appAssessment = (AppAssessment) o;
    return Objects.equals(this.appArn, appAssessment.appArn) &&
        Objects.equals(this.appVersion, appAssessment.appVersion) &&
        Objects.equals(this.assessmentArn, appAssessment.assessmentArn) &&
        Objects.equals(this.assessmentName, appAssessment.assessmentName) &&
        Objects.equals(this.assessmentStatus, appAssessment.assessmentStatus) &&
        Objects.equals(this.compliance, appAssessment.compliance) &&
        Objects.equals(this.complianceStatus, appAssessment.complianceStatus) &&
        Objects.equals(this.cost, appAssessment.cost) &&
        Objects.equals(this.driftStatus, appAssessment.driftStatus) &&
        Objects.equals(this.endTime, appAssessment.endTime) &&
        Objects.equals(this.invoker, appAssessment.invoker) &&
        Objects.equals(this.message, appAssessment.message) &&
        Objects.equals(this.policy, appAssessment.policy) &&
        Objects.equals(this.resiliencyScore, appAssessment.resiliencyScore) &&
        Objects.equals(this.resourceErrorsDetails, appAssessment.resourceErrorsDetails) &&
        Objects.equals(this.startTime, appAssessment.startTime) &&
        Objects.equals(this.tags, appAssessment.tags) &&
        Objects.equals(this.versionName, appAssessment.versionName);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AppAssessment
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AppAssessment.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppAssessment is not found in the empty JSON string", AppAssessment.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AppAssessment.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AppAssessment` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AppAssessment.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppAssessment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppAssessment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppAssessment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppAssessment.class));

       return (TypeAdapter<T>) new TypeAdapter<AppAssessment>() {
           @Override
           public void write(JsonWriter out, AppAssessment value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AppAssessment read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AppAssessment given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AppAssessment
   * @throws IOException if the JSON string is invalid with respect to AppAssessment
   */
  public static AppAssessment fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppAssessment.class);
  }

  /**
   * Convert an instance of AppAssessment to an JSON string
   *
   * @return JSON string
   */
