...
public class CreateAppResponseApp {
  ...
  public CreateAppResponseApp() {
  }

  public CreateAppResponseApp appArn(String appArn) {
    this.appArn = appArn;
    return this;
  }
  ...
  public CreateAppResponseApp assessmentSchedule(AppAssessmentScheduleType assessmentSchedule) {
  ...
  public CreateAppResponseApp complianceStatus(AppComplianceStatusType complianceStatus) {
  ...
  public CreateAppResponseApp creationTime(OffsetDateTime creationTime) {
  ...
  public CreateAppResponseApp description(String description) {
  ...
  public CreateAppResponseApp driftStatus(AppDriftStatusType driftStatus) {
  ...
  public CreateAppResponseApp eventSubscriptions(List eventSubscriptions) {
  ...
  public CreateAppResponseApp lastAppComplianceEvaluationTime(OffsetDateTime lastAppComplianceEvaluationTime) {
  ...
  public CreateAppResponseApp lastDriftEvaluationTime(OffsetDateTime lastDriftEvaluationTime) {
  ...
  public CreateAppResponseApp lastResiliencyScoreEvaluationTime(OffsetDateTime lastResiliencyScoreEvaluationTime) {
  ...
  public CreateAppResponseApp name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateAppResponseApp permissionModel(AppPermissionModel permissionModel) {
  ...
  public CreateAppResponseApp policyArn(String policyArn) {
  ...
  public CreateAppResponseApp resiliencyScore(Double resiliencyScore) {
  ...
  public CreateAppResponseApp status(AppStatusType status) {
    this.status = status;
    return this;
  }
  ...
  public CreateAppResponseApp tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateAppResponseApp createAppResponseApp = (CreateAppResponseApp) o;
    return Objects.equals(this.appArn, createAppResponseApp.appArn) &&
        Objects.equals(this.assessmentSchedule, createAppResponseApp.assessmentSchedule) &&
        Objects.equals(this.complianceStatus, createAppResponseApp.complianceStatus) &&
        Objects.equals(this.creationTime, createAppResponseApp.creationTime) &&
        Objects.equals(this.description, createAppResponseApp.description) &&
        Objects.equals(this.driftStatus, createAppResponseApp.driftStatus) &&
        Objects.equals(this.eventSubscriptions, createAppResponseApp.eventSubscriptions) &&
        Objects.equals(this.lastAppComplianceEvaluationTime, createAppResponseApp.lastAppComplianceEvaluationTime) &&
        Objects.equals(this.lastDriftEvaluationTime, createAppResponseApp.lastDriftEvaluationTime) &&
        Objects.equals(this.lastResiliencyScoreEvaluationTime, createAppResponseApp.lastResiliencyScoreEvaluationTime) &&
        Objects.equals(this.name, createAppResponseApp.name) &&
        Objects.equals(this.permissionModel, createAppResponseApp.permissionModel) &&
        Objects.equals(this.policyArn, createAppResponseApp.policyArn) &&
        Objects.equals(this.resiliencyScore, createAppResponseApp.resiliencyScore) &&
        Objects.equals(this.status, createAppResponseApp.status) &&
        Objects.equals(this.tags, createAppResponseApp.tags);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateAppResponseApp {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateAppResponseApp
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateAppResponseApp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateAppResponseApp is not found in the empty JSON string", CreateAppResponseApp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateAppResponseApp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateAppResponseApp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateAppResponseApp.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateAppResponseApp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateAppResponseApp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateAppResponseApp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateAppResponseApp.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateAppResponseApp>() {
           @Override
           public void write(JsonWriter out, CreateAppResponseApp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateAppResponseApp read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateAppResponseApp given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateAppResponseApp
   * @throws IOException if the JSON string is invalid with respect to CreateAppResponseApp
   */
  public static CreateAppResponseApp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateAppResponseApp.class);
  }

  /**
   * Convert an instance of CreateAppResponseApp to an JSON string
   *
   * @return JSON string
   */
