...
|**appComponents** | **List&lt;String&gt;** | List of Application Components that this resource belongs to. If an Application Component is not part of the Resilience Hub application, it will be added. |  |
