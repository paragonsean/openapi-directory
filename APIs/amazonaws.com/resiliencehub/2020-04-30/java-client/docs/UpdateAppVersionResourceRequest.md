...
|------------ | ------------- | ------------- | -------------|
|**additionalInfo** | **Map&lt;String, List&lt;String&gt;&gt;** | Currently, there is no supported additional information for resources. |  [optional] |
...
|**appComponents** | **List&lt;String&gt;** | List of Application Components that this resource belongs to. If an Application Component is not part of the Resilience Hub application, it will be added. |  [optional] |
