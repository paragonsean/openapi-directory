...
/*
 * OAIUpdateAppRequest_permissionModel.h
 *
 * 
 */

#ifndef OAIUpdateAppRequest_permissionModel_H
#define OAIUpdateAppRequest_permissionModel_H
...
class OAIUpdateAppRequest_permissionModel : public OAIObject {
public:
    OAIUpdateAppRequest_permissionModel();
    OAIUpdateAppRequest_permissionModel(QString json);
    ~OAIUpdateAppRequest_permissionModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateAppRequest_permissionModel)

#endif // OAIUpdateAppRequest_permissionModel_H
