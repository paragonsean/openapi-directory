...
OAIAppAssessment_policy::OAIAppAssessment_policy(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAppAssessment_policy::OAIAppAssessment_policy() {
    this->initializeModel();
}

OAIAppAssessment_policy::~OAIAppAssessment_policy() {}

void OAIAppAssessment_policy::initializeModel() {
...
void OAIAppAssessment_policy::fromJson(QString jsonString) {
...
void OAIAppAssessment_policy::fromJsonObject(QJsonObject json) {
...
QString OAIAppAssessment_policy::asJson() const {
...
QJsonObject OAIAppAssessment_policy::asJsonObject() const {
    QJsonObject obj;
...
QDateTime OAIAppAssessment_policy::getCreationTime() const {
    return m_creation_time;
}
void OAIAppAssessment_policy::setCreationTime(const QDateTime &creation_time) {
    m_creation_time = creation_time;
    m_creation_time_isSet = true;
}

bool OAIAppAssessment_policy::is_creation_time_Set() const{
    return m_creation_time_isSet;
}

bool OAIAppAssessment_policy::is_creation_time_Valid() const{
    return m_creation_time_isValid;
}

OAIDataLocationConstraint OAIAppAssessment_policy::getDataLocationConstraint() const {
    return m_data_location_constraint;
}
void OAIAppAssessment_policy::setDataLocationConstraint(const OAIDataLocationConstraint &data_location_constraint) {
    m_data_location_constraint = data_location_constraint;
    m_data_location_constraint_isSet = true;
}

bool OAIAppAssessment_policy::is_data_location_constraint_Set() const{
    return m_data_location_constraint_isSet;
}

bool OAIAppAssessment_policy::is_data_location_constraint_Valid() const{
    return m_data_location_constraint_isValid;
}

OAIEstimatedCostTier OAIAppAssessment_policy::getEstimatedCostTier() const {
    return m_estimated_cost_tier;
}
void OAIAppAssessment_policy::setEstimatedCostTier(const OAIEstimatedCostTier &estimated_cost_tier) {
    m_estimated_cost_tier = estimated_cost_tier;
    m_estimated_cost_tier_isSet = true;
}

bool OAIAppAssessment_policy::is_estimated_cost_tier_Set() const{
    return m_estimated_cost_tier_isSet;
}

bool OAIAppAssessment_policy::is_estimated_cost_tier_Valid() const{
    return m_estimated_cost_tier_isValid;
}

QMap OAIAppAssessment_policy::getPolicy() const {
    return m_policy;
}
void OAIAppAssessment_policy::setPolicy(const QMap &policy) {
    m_policy = policy;
    m_policy_isSet = true;
}

bool OAIAppAssessment_policy::is_policy_Set() const{
    return m_policy_isSet;
}

bool OAIAppAssessment_policy::is_policy_Valid() const{
    return m_policy_isValid;
}

QString OAIAppAssessment_policy::getPolicyArn() const {
    return m_policy_arn;
}
void OAIAppAssessment_policy::setPolicyArn(const QString &policy_arn) {
    m_policy_arn = policy_arn;
    m_policy_arn_isSet = true;
}

bool OAIAppAssessment_policy::is_policy_arn_Set() const{
    return m_policy_arn_isSet;
}

bool OAIAppAssessment_policy::is_policy_arn_Valid() const{
    return m_policy_arn_isValid;
}

QString OAIAppAssessment_policy::getPolicyDescription() const {
    return m_policy_description;
}
void OAIAppAssessment_policy::setPolicyDescription(const QString &policy_description) {
    m_policy_description = policy_description;
    m_policy_description_isSet = true;
}

bool OAIAppAssessment_policy::is_policy_description_Set() const{
    return m_policy_description_isSet;
}

bool OAIAppAssessment_policy::is_policy_description_Valid() const{
    return m_policy_description_isValid;
}

QString OAIAppAssessment_policy::getPolicyName() const {
    return m_policy_name;
}
void OAIAppAssessment_policy::setPolicyName(const QString &policy_name) {
    m_policy_name = policy_name;
    m_policy_name_isSet = true;
}

bool OAIAppAssessment_policy::is_policy_name_Set() const{
    return m_policy_name_isSet;
}

bool OAIAppAssessment_policy::is_policy_name_Valid() const{
    return m_policy_name_isValid;
}

QMap OAIAppAssessment_policy::getTags() const {
    return m_tags;
}
void OAIAppAssessment_policy::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIAppAssessment_policy::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIAppAssessment_policy::is_tags_Valid() const{
    return m_tags_isValid;
}

OAIResiliencyPolicyTier OAIAppAssessment_policy::getTier() const {
    return m_tier;
}
void OAIAppAssessment_policy::setTier(const OAIResiliencyPolicyTier &tier) {
    m_tier = tier;
    m_tier_isSet = true;
}

bool OAIAppAssessment_policy::is_tier_Set() const{
    return m_tier_isSet;
}

bool OAIAppAssessment_policy::is_tier_Valid() const{
    return m_tier_isValid;
}

bool OAIAppAssessment_policy::isSet() const {
...
bool OAIAppAssessment_policy::isValid() const {
