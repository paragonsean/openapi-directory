...
/*
 * OAILogicalResourceId.h
 *
 * Defines a logical resource identifier.
 */

#ifndef OAILogicalResourceId_H
#define OAILogicalResourceId_H
...
class OAILogicalResourceId : public OAIObject {
public:
    OAILogicalResourceId();
    OAILogicalResourceId(QString json);
    ~OAILogicalResourceId() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILogicalResourceId)

#endif // OAILogicalResourceId_H
