...
/*
 * OAIListAppInputSources_request.h
 *
 * 
 */

#ifndef OAIListAppInputSources_request_H
#define OAIListAppInputSources_request_H
...
class OAIListAppInputSources_request : public OAIObject {
public:
    OAIListAppInputSources_request();
    OAIListAppInputSources_request(QString json);
    ~OAIListAppInputSources_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListAppInputSources_request)

#endif // OAIListAppInputSources_request_H
