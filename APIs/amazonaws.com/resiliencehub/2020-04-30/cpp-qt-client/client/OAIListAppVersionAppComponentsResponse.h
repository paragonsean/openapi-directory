...
/*
 * OAIListAppVersionAppComponentsResponse.h
 *
 * 
 */

#ifndef OAIListAppVersionAppComponentsResponse_H
#define OAIListAppVersionAppComponentsResponse_H
...
class OAIListAppVersionAppComponentsResponse : public OAIObject {
public:
    OAIListAppVersionAppComponentsResponse();
    OAIListAppVersionAppComponentsResponse(QString json);
    ~OAIListAppVersionAppComponentsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListAppVersionAppComponentsResponse)

#endif // OAIListAppVersionAppComponentsResponse_H
