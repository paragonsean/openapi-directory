...
/*
 * OAICreateAppVersionResource_request.h
 *
 * 
 */

#ifndef OAICreateAppVersionResource_request_H
#define OAICreateAppVersionResource_request_H
...
class OAICreateAppVersionResource_request : public OAIObject {
public:
    OAICreateAppVersionResource_request();
    OAICreateAppVersionResource_request(QString json);
    ~OAICreateAppVersionResource_request() override;
    ...
    QList<QString> getAppComponents() const;
    void setAppComponents(const QList<QString> &app_components);
...
private:
    ...
    QList<QString> m_app_components;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateAppVersionResource_request)

#endif // OAICreateAppVersionResource_request_H
