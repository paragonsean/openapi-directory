...
/*
 * OAIUpdateAppVersionResponse.h
 *
 * 
 */

#ifndef OAIUpdateAppVersionResponse_H
#define OAIUpdateAppVersionResponse_H
...
class OAIUpdateAppVersionResponse : public OAIObject {
public:
    OAIUpdateAppVersionResponse();
    OAIUpdateAppVersionResponse(QString json);
    ~OAIUpdateAppVersionResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateAppVersionResponse)

#endif // OAIUpdateAppVersionResponse_H
