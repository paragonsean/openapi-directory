...
/*
 * OAIApp_permissionModel.h
 *
 * 
 */

#ifndef OAIApp_permissionModel_H
#define OAIApp_permissionModel_H
...
class OAIApp_permissionModel : public OAIObject {
public:
    OAIApp_permissionModel();
    OAIApp_permissionModel(QString json);
    ~OAIApp_permissionModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApp_permissionModel)

#endif // OAIApp_permissionModel_H
