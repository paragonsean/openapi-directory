...
/*
 * OAIUnsupportedResource_logicalResourceId.h
 *
 * 
 */

#ifndef OAIUnsupportedResource_logicalResourceId_H
#define OAIUnsupportedResource_logicalResourceId_H
...
class OAIUnsupportedResource_logicalResourceId : public OAIObject {
public:
    OAIUnsupportedResource_logicalResourceId();
    OAIUnsupportedResource_logicalResourceId(QString json);
    ~OAIUnsupportedResource_logicalResourceId() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUnsupportedResource_logicalResourceId)

#endif // OAIUnsupportedResource_logicalResourceId_H
