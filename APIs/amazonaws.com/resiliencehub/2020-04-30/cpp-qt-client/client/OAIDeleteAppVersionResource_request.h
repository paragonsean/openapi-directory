...
/*
 * OAIDeleteAppVersionResource_request.h
 *
 * 
 */

#ifndef OAIDeleteAppVersionResource_request_H
#define OAIDeleteAppVersionResource_request_H
...
class OAIDeleteAppVersionResource_request : public OAIObject {
public:
    OAIDeleteAppVersionResource_request();
    OAIDeleteAppVersionResource_request(QString json);
    ~OAIDeleteAppVersionResource_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteAppVersionResource_request)

#endif // OAIDeleteAppVersionResource_request_H
