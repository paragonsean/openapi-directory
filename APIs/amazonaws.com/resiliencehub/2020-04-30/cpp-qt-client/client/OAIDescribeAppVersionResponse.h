...
/*
 * OAIDescribeAppVersionResponse.h
 *
 * 
 */

#ifndef OAIDescribeAppVersionResponse_H
#define OAIDescribeAppVersionResponse_H
...
class OAIDescribeAppVersionResponse : public OAIObject {
public:
    OAIDescribeAppVersionResponse();
    OAIDescribeAppVersionResponse(QString json);
    ~OAIDescribeAppVersionResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeAppVersionResponse)

#endif // OAIDescribeAppVersionResponse_H
