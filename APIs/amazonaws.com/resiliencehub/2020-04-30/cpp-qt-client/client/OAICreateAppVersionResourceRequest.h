...
/*
 * OAICreateAppVersionResourceRequest.h
 *
 * 
 */

#ifndef OAICreateAppVersionResourceRequest_H
#define OAICreateAppVersionResourceRequest_H
...
class OAICreateAppVersionResourceRequest : public OAIObject {
public:
    OAICreateAppVersionResourceRequest();
    OAICreateAppVersionResourceRequest(QString json);
    ~OAICreateAppVersionResourceRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateAppVersionResourceRequest)

#endif // OAICreateAppVersionResourceRequest_H
