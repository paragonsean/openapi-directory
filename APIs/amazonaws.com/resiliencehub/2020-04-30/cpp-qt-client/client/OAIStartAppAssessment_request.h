...
/*
 * OAIStartAppAssessment_request.h
 *
 * 
 */

#ifndef OAIStartAppAssessment_request_H
#define OAIStartAppAssessment_request_H
...
class OAIStartAppAssessment_request : public OAIObject {
public:
    OAIStartAppAssessment_request();
    OAIStartAppAssessment_request(QString json);
    ~OAIStartAppAssessment_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartAppAssessment_request)

#endif // OAIStartAppAssessment_request_H
