...
/*
 * OAICreateAppVersionAppComponentRequest.h
 *
 * 
 */

#ifndef OAICreateAppVersionAppComponentRequest_H
#define OAICreateAppVersionAppComponentRequest_H
...
class OAICreateAppVersionAppComponentRequest : public OAIObject {
public:
    OAICreateAppVersionAppComponentRequest();
    OAICreateAppVersionAppComponentRequest(QString json);
    ~OAICreateAppVersionAppComponentRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateAppVersionAppComponentRequest)

#endif // OAICreateAppVersionAppComponentRequest_H
