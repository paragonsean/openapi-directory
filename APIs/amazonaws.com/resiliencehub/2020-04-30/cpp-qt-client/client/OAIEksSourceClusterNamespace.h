...
/*
 * OAIEksSourceClusterNamespace.h
 *
 * The input source of the namespace that is located on your Amazon Elastic Kubernetes Service cluster.
 */

#ifndef OAIEksSourceClusterNamespace_H
#define OAIEksSourceClusterNamespace_H
...
class OAIEksSourceClusterNamespace : public OAIObject {
public:
    OAIEksSourceClusterNamespace();
    OAIEksSourceClusterNamespace(QString json);
    ~OAIEksSourceClusterNamespace() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEksSourceClusterNamespace)

#endif // OAIEksSourceClusterNamespace_H
