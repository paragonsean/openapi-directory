...
/*
 * OAIListAppInputSourcesRequest.h
 *
 * 
 */

#ifndef OAIListAppInputSourcesRequest_H
#define OAIListAppInputSourcesRequest_H
...
class OAIListAppInputSourcesRequest : public OAIObject {
public:
    OAIListAppInputSourcesRequest();
    OAIListAppInputSourcesRequest(QString json);
    ~OAIListAppInputSourcesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListAppInputSourcesRequest)

#endif // OAIListAppInputSourcesRequest_H
