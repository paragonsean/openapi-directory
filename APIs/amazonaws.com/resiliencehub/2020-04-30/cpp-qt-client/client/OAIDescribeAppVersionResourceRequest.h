...
/*
 * OAIDescribeAppVersionResourceRequest.h
 *
 * 
 */

#ifndef OAIDescribeAppVersionResourceRequest_H
#define OAIDescribeAppVersionResourceRequest_H
...
class OAIDescribeAppVersionResourceRequest : public OAIObject {
public:
    OAIDescribeAppVersionResourceRequest();
    OAIDescribeAppVersionResourceRequest(QString json);
    ~OAIDescribeAppVersionResourceRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeAppVersionResourceRequest)

#endif // OAIDescribeAppVersionResourceRequest_H
