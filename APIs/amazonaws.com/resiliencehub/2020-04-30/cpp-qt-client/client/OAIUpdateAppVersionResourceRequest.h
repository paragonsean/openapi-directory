...
/*
 * OAIUpdateAppVersionResourceRequest.h
 *
 * 
 */

#ifndef OAIUpdateAppVersionResourceRequest_H
#define OAIUpdateAppVersionResourceRequest_H
...
class OAIUpdateAppVersionResourceRequest : public OAIObject {
public:
    OAIUpdateAppVersionResourceRequest();
    OAIUpdateAppVersionResourceRequest(QString json);
    ~OAIUpdateAppVersionResourceRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateAppVersionResourceRequest)

#endif // OAIUpdateAppVersionResourceRequest_H
