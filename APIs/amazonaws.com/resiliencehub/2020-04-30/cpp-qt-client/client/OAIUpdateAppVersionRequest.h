...
/*
 * OAIUpdateAppVersionRequest.h
 *
 * 
 */

#ifndef OAIUpdateAppVersionRequest_H
#define OAIUpdateAppVersionRequest_H
...
class OAIUpdateAppVersionRequest : public OAIObject {
public:
    OAIUpdateAppVersionRequest();
    OAIUpdateAppVersionRequest(QString json);
    ~OAIUpdateAppVersionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateAppVersionRequest)

#endif // OAIUpdateAppVersionRequest_H
