...
OAIResiliencyPolicy::OAIResiliencyPolicy(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIResiliencyPolicy::OAIResiliencyPolicy() {
    this->initializeModel();
}

OAIResiliencyPolicy::~OAIResiliencyPolicy() {}

void OAIResiliencyPolicy::initializeModel() {
...
void OAIResiliencyPolicy::fromJson(QString jsonString) {
...
void OAIResiliencyPolicy::fromJsonObject(QJsonObject json) {
...
QString OAIResiliencyPolicy::asJson() const {
...
QJsonObject OAIResiliencyPolicy::asJsonObject() const {
    QJsonObject obj;
...
QDateTime OAIResiliencyPolicy::getCreationTime() const {
    return m_creation_time;
}
void OAIResiliencyPolicy::setCreationTime(const QDateTime &creation_time) {
    m_creation_time = creation_time;
    m_creation_time_isSet = true;
}

bool OAIResiliencyPolicy::is_creation_time_Set() const{
    return m_creation_time_isSet;
}

bool OAIResiliencyPolicy::is_creation_time_Valid() const{
    return m_creation_time_isValid;
}

OAIDataLocationConstraint OAIResiliencyPolicy::getDataLocationConstraint() const {
    return m_data_location_constraint;
}
void OAIResiliencyPolicy::setDataLocationConstraint(const OAIDataLocationConstraint &data_location_constraint) {
    m_data_location_constraint = data_location_constraint;
    m_data_location_constraint_isSet = true;
}

bool OAIResiliencyPolicy::is_data_location_constraint_Set() const{
    return m_data_location_constraint_isSet;
}

bool OAIResiliencyPolicy::is_data_location_constraint_Valid() const{
    return m_data_location_constraint_isValid;
}

OAIEstimatedCostTier OAIResiliencyPolicy::getEstimatedCostTier() const {
    return m_estimated_cost_tier;
}
void OAIResiliencyPolicy::setEstimatedCostTier(const OAIEstimatedCostTier &estimated_cost_tier) {
    m_estimated_cost_tier = estimated_cost_tier;
    m_estimated_cost_tier_isSet = true;
}

bool OAIResiliencyPolicy::is_estimated_cost_tier_Set() const{
    return m_estimated_cost_tier_isSet;
}

bool OAIResiliencyPolicy::is_estimated_cost_tier_Valid() const{
    return m_estimated_cost_tier_isValid;
}

QMap OAIResiliencyPolicy::getPolicy() const {
    return m_policy;
}
void OAIResiliencyPolicy::setPolicy(const QMap &policy) {
    m_policy = policy;
    m_policy_isSet = true;
}

bool OAIResiliencyPolicy::is_policy_Set() const{
    return m_policy_isSet;
}

bool OAIResiliencyPolicy::is_policy_Valid() const{
    return m_policy_isValid;
}

QString OAIResiliencyPolicy::getPolicyArn() const {
    return m_policy_arn;
}
void OAIResiliencyPolicy::setPolicyArn(const QString &policy_arn) {
    m_policy_arn = policy_arn;
    m_policy_arn_isSet = true;
}

bool OAIResiliencyPolicy::is_policy_arn_Set() const{
    return m_policy_arn_isSet;
}

bool OAIResiliencyPolicy::is_policy_arn_Valid() const{
    return m_policy_arn_isValid;
}

QString OAIResiliencyPolicy::getPolicyDescription() const {
    return m_policy_description;
}
void OAIResiliencyPolicy::setPolicyDescription(const QString &policy_description) {
    m_policy_description = policy_description;
    m_policy_description_isSet = true;
}

bool OAIResiliencyPolicy::is_policy_description_Set() const{
    return m_policy_description_isSet;
}

bool OAIResiliencyPolicy::is_policy_description_Valid() const{
    return m_policy_description_isValid;
}

QString OAIResiliencyPolicy::getPolicyName() const {
    return m_policy_name;
}
void OAIResiliencyPolicy::setPolicyName(const QString &policy_name) {
    m_policy_name = policy_name;
    m_policy_name_isSet = true;
}

bool OAIResiliencyPolicy::is_policy_name_Set() const{
    return m_policy_name_isSet;
}

bool OAIResiliencyPolicy::is_policy_name_Valid() const{
    return m_policy_name_isValid;
}

QMap OAIResiliencyPolicy::getTags() const {
    return m_tags;
}
void OAIResiliencyPolicy::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIResiliencyPolicy::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIResiliencyPolicy::is_tags_Valid() const{
    return m_tags_isValid;
}

OAIResiliencyPolicyTier OAIResiliencyPolicy::getTier() const {
    return m_tier;
}
void OAIResiliencyPolicy::setTier(const OAIResiliencyPolicyTier &tier) {
    m_tier = tier;
    m_tier_isSet = true;
}

bool OAIResiliencyPolicy::is_tier_Set() const{
    return m_tier_isSet;
}

bool OAIResiliencyPolicy::is_tier_Valid() const{
    return m_tier_isValid;
}

bool OAIResiliencyPolicy::isSet() const {
...
bool OAIResiliencyPolicy::isValid() const {
