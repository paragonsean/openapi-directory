...
/*
 * OAICreateApp_request_permissionModel.h
 *
 * Defines the roles and credentials that Resilience Hub would use while creating the application, importing its resources, and running an assessment.
 */

#ifndef OAICreateApp_request_permissionModel_H
#define OAICreateApp_request_permissionModel_H
...
class OAICreateApp_request_permissionModel : public OAIObject {
public:
    OAICreateApp_request_permissionModel();
    OAICreateApp_request_permissionModel(QString json);
    ~OAICreateApp_request_permissionModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateApp_request_permissionModel)

#endif // OAICreateApp_request_permissionModel_H
