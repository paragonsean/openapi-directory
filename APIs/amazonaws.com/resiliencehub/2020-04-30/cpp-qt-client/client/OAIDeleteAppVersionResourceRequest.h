...
/*
 * OAIDeleteAppVersionResourceRequest.h
 *
 * 
 */

#ifndef OAIDeleteAppVersionResourceRequest_H
#define OAIDeleteAppVersionResourceRequest_H
...
class OAIDeleteAppVersionResourceRequest : public OAIObject {
public:
    OAIDeleteAppVersionResourceRequest();
    OAIDeleteAppVersionResourceRequest(QString json);
    ~OAIDeleteAppVersionResourceRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteAppVersionResourceRequest)

#endif // OAIDeleteAppVersionResourceRequest_H
