...
/*
 * OAICreateAppVersionResource_request_logicalResourceId.h
 *
 * Defines a logical resource identifier.
 */

#ifndef OAICreateAppVersionResource_request_logicalResourceId_H
#define OAICreateAppVersionResource_request_logicalResourceId_H
...
class OAICreateAppVersionResource_request_logicalResourceId : public OAIObject {
public:
    OAICreateAppVersionResource_request_logicalResourceId();
    OAICreateAppVersionResource_request_logicalResourceId(QString json);
    ~OAICreateAppVersionResource_request_logicalResourceId() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateAppVersionResource_request_logicalResourceId)

#endif // OAICreateAppVersionResource_request_logicalResourceId_H
