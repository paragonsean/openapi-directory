...
/*
 * OAIListAppVersionResources_request.h
 *
 * 
 */

#ifndef OAIListAppVersionResources_request_H
#define OAIListAppVersionResources_request_H
...
class OAIListAppVersionResources_request : public OAIObject {
public:
    OAIListAppVersionResources_request();
    OAIListAppVersionResources_request(QString json);
    ~OAIListAppVersionResources_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListAppVersionResources_request)

#endif // OAIListAppVersionResources_request_H
