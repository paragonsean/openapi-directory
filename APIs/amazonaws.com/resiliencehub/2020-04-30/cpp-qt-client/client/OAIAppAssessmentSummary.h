...
/*
 * OAIAppAssessmentSummary.h
 *
 * Defines an application assessment summary.
 */

#ifndef OAIAppAssessmentSummary_H
#define OAIAppAssessmentSummary_H
...
namespace OpenAPI {
class OAIAppAssessmentSummary_cost;

class OAIAppAssessmentSummary : public OAIObject {
public:
    OAIAppAssessmentSummary();
    OAIAppAssessmentSummary(QString json);
    ~OAIAppAssessmentSummary() override;
    ...
    OAIAppAssessmentSummary_cost getCost() const;
    void setCost(const OAIAppAssessmentSummary_cost &cost);
...
private:
    ...
    OAIAppAssessmentSummary_cost m_cost;
    bool m_cost_isSet;
    bool m_cost_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAppAssessmentSummary)

#endif // OAIAppAssessmentSummary_H
