...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResilienceHub.AppInputSource();
  });
  ...
  describe('AppInputSource', function() {
    it('should create an instance of AppInputSource', function() {
      // uncomment below and update the code to test AppInputSource
      //var instance = new AwsResilienceHub.AppInputSource();
      //expect(instance).to.be.a(AwsResilienceHub.AppInputSource);
    });
