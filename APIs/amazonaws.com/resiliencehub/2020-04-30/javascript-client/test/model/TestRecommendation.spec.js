...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResilienceHub.TestRecommendation();
  });
  ...
  describe('TestRecommendation', function() {
    it('should create an instance of TestRecommendation', function() {
      // uncomment below and update the code to test TestRecommendation
      //var instance = new AwsResilienceHub.TestRecommendation();
      //expect(instance).to.be.a(AwsResilienceHub.TestRecommendation);
    });
    ...
    it('should have the property dependsOnAlarms (base name: "dependsOnAlarms")', function() {
      // uncomment below and update the code to test the property dependsOnAlarms
      //var instance = new AwsResilienceHub.TestRecommendation();
      //expect(instance).to.be();
    });
