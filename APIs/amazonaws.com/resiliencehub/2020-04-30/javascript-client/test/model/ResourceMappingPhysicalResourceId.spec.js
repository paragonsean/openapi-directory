...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResilienceHub.ResourceMappingPhysicalResourceId();
  });
  ...
  describe('ResourceMappingPhysicalResourceId', function() {
    it('should create an instance of ResourceMappingPhysicalResourceId', function() {
      // uncomment below and update the code to test ResourceMappingPhysicalResourceId
      //var instance = new AwsResilienceHub.ResourceMappingPhysicalResourceId();
      //expect(instance).to.be.a(AwsResilienceHub.ResourceMappingPhysicalResourceId);
    });
