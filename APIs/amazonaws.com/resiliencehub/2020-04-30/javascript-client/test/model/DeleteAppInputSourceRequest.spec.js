...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResilienceHub.DeleteAppInputSourceRequest();
  });
  ...
  describe('DeleteAppInputSourceRequest', function() {
    it('should create an instance of DeleteAppInputSourceRequest', function() {
      // uncomment below and update the code to test DeleteAppInputSourceRequest
      //var instance = new AwsResilienceHub.DeleteAppInputSourceRequest();
      //expect(instance).to.be.a(AwsResilienceHub.DeleteAppInputSourceRequest);
    });
