...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResilienceHub.SopRecommendation();
  });
  ...
  describe('SopRecommendation', function() {
    it('should create an instance of SopRecommendation', function() {
      // uncomment below and update the code to test SopRecommendation
      //var instance = new AwsResilienceHub.SopRecommendation();
      //expect(instance).to.be.a(AwsResilienceHub.SopRecommendation);
    });
