...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResilienceHub.AppVersionSummary();
  });
  ...
  describe('AppVersionSummary', function() {
    it('should create an instance of AppVersionSummary', function() {
      // uncomment below and update the code to test AppVersionSummary
      //var instance = new AwsResilienceHub.AppVersionSummary();
      //expect(instance).to.be.a(AwsResilienceHub.AppVersionSummary);
    });
