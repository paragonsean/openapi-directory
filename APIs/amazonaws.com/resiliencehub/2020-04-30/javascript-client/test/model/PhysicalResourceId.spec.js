...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResilienceHub.PhysicalResourceId();
  });
  ...
  describe('PhysicalResourceId', function() {
    it('should create an instance of PhysicalResourceId', function() {
      // uncomment below and update the code to test PhysicalResourceId
      //var instance = new AwsResilienceHub.PhysicalResourceId();
      //expect(instance).to.be.a(AwsResilienceHub.PhysicalResourceId);
    });
