...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsResilienceHub.EventSubscription();
  });
  ...
  describe('EventSubscription', function() {
    it('should create an instance of EventSubscription', function() {
      ...
      //var instance = new AwsResilienceHub.EventSubscription();
      //expect(instance).to.be.a(AwsResilienceHub.EventSubscription);
    });
