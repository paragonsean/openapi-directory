...
class DeleteAppVersionResourceRequest(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, app_arn: str=None, aws_account_id: str=None, aws_region: str=None, client_token: str=None, logical_resource_id: CreateAppVersionResourceRequestLogicalResourceId=None, physical_resource_id: str=None, resource_name: str=None):
        """DeleteAppVersionResourceRequest - a model defined in OpenAPI

        :param app_arn: The app_arn of this DeleteAppVersionResourceRequest.
        :param aws_account_id: The aws_account_id of this DeleteAppVersionResourceRequest.
        :param aws_region: The aws_region of this DeleteAppVersionResourceRequest.
        :param client_token: The client_token of this DeleteAppVersionResourceRequest.
        :param logical_resource_id: The logical_resource_id of this DeleteAppVersionResourceRequest.
        :param physical_resource_id: The physical_resource_id of this DeleteAppVersionResourceRequest.
        :param resource_name: The resource_name of this DeleteAppVersionResourceRequest.
        """
        self.openapi_types = {
            'app_arn': str,
            'aws_account_id': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DeleteAppVersionResourceRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DeleteAppVersionResource_request of this DeleteAppVersionResourceRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def app_arn(self):
        """Gets the app_arn of this DeleteAppVersionResourceRequest.

        Amazon Resource Name (ARN) of the Resilience Hub application. The format for this ARN is: arn:<code>partition</code>:resiliencehub:<code>region</code>:<code>account</code>:app/<code>app-id</code>. For more information about ARNs, see <a href=\"https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html\"> Amazon Resource Names (ARNs)</a> in the <i>AWS General Reference</i> guide.

        :return: The app_arn of this DeleteAppVersionResourceRequest.
        :rtype: str
        """
    ...
    def app_arn(self, app_arn):
        """Sets the app_arn of this DeleteAppVersionResourceRequest.
    ...
    def aws_account_id(self):
        """Gets the aws_account_id of this DeleteAppVersionResourceRequest.

        Amazon Web Services account that owns the physical resource.

        :return: The aws_account_id of this DeleteAppVersionResourceRequest.
        :rtype: str
        """
    ...
    def aws_account_id(self, aws_account_id):
        """Sets the aws_account_id of this DeleteAppVersionResourceRequest.
    ...
    @property
    def aws_region(self):
        """Gets the aws_region of this DeleteAppVersionResourceRequest.

        Amazon Web Services region that owns the physical resource.

        :return: The aws_region of this DeleteAppVersionResourceRequest.
        :rtype: str
        """
    ...
    def aws_region(self, aws_region):
        """Sets the aws_region of this DeleteAppVersionResourceRequest.
    ...
    def client_token(self):
        """Gets the client_token of this DeleteAppVersionResourceRequest.

        Used for an idempotency token. A client token is a unique, case-sensitive string of up to 64 ASCII characters. You should not reuse the same client token for other API requests.

        :return: The client_token of this DeleteAppVersionResourceRequest.
        :rtype: str
        """
    ...
    def client_token(self, client_token):
        """Sets the client_token of this DeleteAppVersionResourceRequest.
    ...
    def logical_resource_id(self):
        """Gets the logical_resource_id of this DeleteAppVersionResourceRequest.


        :return: The logical_resource_id of this DeleteAppVersionResourceRequest.
    ...
    def logical_resource_id(self, logical_resource_id):
        """Sets the logical_resource_id of this DeleteAppVersionResourceRequest.
    ...
    def physical_resource_id(self):
        """Gets the physical_resource_id of this DeleteAppVersionResourceRequest.

        Physical identifier of the resource.

        :return: The physical_resource_id of this DeleteAppVersionResourceRequest.
        :rtype: str
        """
    ...
    def physical_resource_id(self, physical_resource_id):
        """Sets the physical_resource_id of this DeleteAppVersionResourceRequest.
    ...
    def resource_name(self):
        """Gets the resource_name of this DeleteAppVersionResourceRequest.

        Name of the resource.

        :return: The resource_name of this DeleteAppVersionResourceRequest.
        :rtype: str
        """
    ...
    def resource_name(self, resource_name):
        """Sets the resource_name of this DeleteAppVersionResourceRequest.
