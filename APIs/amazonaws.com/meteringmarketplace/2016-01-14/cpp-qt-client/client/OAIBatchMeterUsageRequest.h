...
#ifndef OAIBatchMeterUsageRequest_H
#define OAIBatchMeterUsageRequest_H
...
class OAIBatchMeterUsageRequest : public OAIObject {
public:
    OAIBatchMeterUsageRequest();
    OAIBatchMeterUsageRequest(QString json);
    ~OAIBatchMeterUsageRequest() override;
    ...
    QList getUsageRecords() const;
    void setUsageRecords(const QList &usage_records);
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchMeterUsageRequest)

#endif // OAIBatchMeterUsageRequest_H
