...
/*
 * OAIUsageRecordResult_UsageRecord.h
 *
 * 
 */

#ifndef OAIUsageRecordResult_UsageRecord_H
#define OAIUsageRecordResult_UsageRecord_H
...
class OAIUsageRecordResult_UsageRecord : public OAIObject {
public:
    OAIUsageRecordResult_UsageRecord();
    OAIUsageRecordResult_UsageRecord(QString json);
    ~OAIUsageRecordResult_UsageRecord() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUsageRecordResult_UsageRecord)

#endif // OAIUsageRecordResult_UsageRecord_H
