...
OAIResolveCustomerRequest::OAIResolveCustomerRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIResolveCustomerRequest::OAIResolveCustomerRequest() {
    this->initializeModel();
}

OAIResolveCustomerRequest::~OAIResolveCustomerRequest() {}

void OAIResolveCustomerRequest::initializeModel() {

    m_registration_token_isSet = false;
    m_registration_token_isValid = false;
}

void OAIResolveCustomerRequest::fromJson(QString jsonString) {
...
void OAIResolveCustomerRequest::fromJsonObject(QJsonObject json) {
...
QString OAIResolveCustomerRequest::asJson() const {
...
QJsonObject OAIResolveCustomerRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIResolveCustomerRequest::getRegistrationToken() const {
    return m_registration_token;
}
void OAIResolveCustomerRequest::setRegistrationToken(const QString &registration_token) {
    m_registration_token = registration_token;
    m_registration_token_isSet = true;
}

bool OAIResolveCustomerRequest::is_registration_token_Set() const{
    return m_registration_token_isSet;
}

bool OAIResolveCustomerRequest::is_registration_token_Valid() const{
    return m_registration_token_isValid;
}

bool OAIResolveCustomerRequest::isSet() const {
...
bool OAIResolveCustomerRequest::isValid() const {
