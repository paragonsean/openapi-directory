...
#include "OAIUsageRecordResultStatus.h"
...
OAIUsageRecordResultStatus::OAIUsageRecordResultStatus(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUsageRecordResultStatus::OAIUsageRecordResultStatus() {
    this->initializeModel();
}

OAIUsageRecordResultStatus::~OAIUsageRecordResultStatus() {}

void OAIUsageRecordResultStatus::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIUsageRecordResultStatus::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIUsageRecordResultStatus::fromJson(QString jsonString) {
    
    if ( jsonString.compare("Success", Qt::CaseInsensitive) == 0) {
        m_value = eOAIUsageRecordResultStatus::SUCCESS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("CustomerNotSubscribed", Qt::CaseInsensitive) == 0) {
        m_value = eOAIUsageRecordResultStatus::CUSTOMERNOTSUBSCRIBED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("DuplicateRecord", Qt::CaseInsensitive) == 0) {
        m_value = eOAIUsageRecordResultStatus::DUPLICATERECORD;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIUsageRecordResultStatus::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIUsageRecordResultStatus::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIUsageRecordResultStatus::SUCCESS:
            val = "Success";
            break;
        case eOAIUsageRecordResultStatus::CUSTOMERNOTSUBSCRIBED:
            val = "CustomerNotSubscribed";
            break;
        case eOAIUsageRecordResultStatus::DUPLICATERECORD:
            val = "DuplicateRecord";
            break;
        default:
            break;
...
QJsonValue OAIUsageRecordResultStatus::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIUsageRecordResultStatus::eOAIUsageRecordResultStatus OAIUsageRecordResultStatus::getValue() const {
    return m_value;
}

void OAIUsageRecordResultStatus::setValue(const OAIUsageRecordResultStatus::eOAIUsageRecordResultStatus& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIUsageRecordResultStatus::isSet() const {
    
    return m_value_isSet;
}

bool OAIUsageRecordResultStatus::isValid() const {
