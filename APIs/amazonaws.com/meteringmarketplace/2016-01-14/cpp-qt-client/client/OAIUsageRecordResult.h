...
#ifndef OAIUsageRecordResult_H
#define OAIUsageRecordResult_H
...
namespace OpenAPI {
class OAIUsageRecordResult_UsageRecord;

class OAIUsageRecordResult : public OAIObject {
public:
    OAIUsageRecordResult();
    OAIUsageRecordResult(QString json);
    ~OAIUsageRecordResult() override;
    ...
    OAIUsageRecordResult_UsageRecord getUsageRecord() const;
    void setUsageRecord(const OAIUsageRecordResult_UsageRecord &usage_record);
    bool is_usage_record_Set() const;
    bool is_usage_record_Valid() const;
    ...
    OAIUsageRecordResultStatus getStatus() const;
    void setStatus(const OAIUsageRecordResultStatus &status);
...
private:
    ...
    OAIUsageRecordResult_UsageRecord m_usage_record;
    bool m_usage_record_isSet;
    bool m_usage_record_isValid;

    QString m_metering_record_id;
    bool m_metering_record_id_isSet;
    bool m_metering_record_id_isValid;

    OAIUsageRecordResultStatus m_status;
    bool m_status_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUsageRecordResult)

#endif // OAIUsageRecordResult_H
