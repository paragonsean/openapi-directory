...
/*
 * OAIRegisterUsageRequest.h
 *
 * 
 */

#ifndef OAIRegisterUsageRequest_H
#define OAIRegisterUsageRequest_H
...
class OAIRegisterUsageRequest : public OAIObject {
public:
    OAIRegisterUsageRequest();
    OAIRegisterUsageRequest(QString json);
    ~OAIRegisterUsageRequest() override;
    ...
    qint32 getPublicKeyVersion() const;
    void setPublicKeyVersion(const qint32 &public_key_version);
    bool is_public_key_version_Set() const;
    bool is_public_key_version_Valid() const;
...
private:
    ...
    qint32 m_public_key_version;
    bool m_public_key_version_isSet;
    bool m_public_key_version_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRegisterUsageRequest)

#endif // OAIRegisterUsageRequest_H
