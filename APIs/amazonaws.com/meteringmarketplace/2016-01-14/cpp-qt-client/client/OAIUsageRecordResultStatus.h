...
/*
 * OAIUsageRecordResultStatus.h
 *
 * 
 */

#ifndef OAIUsageRecordResultStatus_H
#define OAIUsageRecordResultStatus_H
...
class OAIUsageRecordResultStatus : public OAIEnum {
public:
    OAIUsageRecordResultStatus();
    OAIUsageRecordResultStatus(QString json);
    ~OAIUsageRecordResultStatus() override;
    ...
    enum class eOAIUsageRecordResultStatus {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        SUCCESS, 
        CUSTOMERNOTSUBSCRIBED, 
        DUPLICATERECORD
    };
    OAIUsageRecordResultStatus::eOAIUsageRecordResultStatus getValue() const;
    void setValue(const OAIUsageRecordResultStatus::eOAIUsageRecordResultStatus& value);
...
private:
    ...
    eOAIUsageRecordResultStatus m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUsageRecordResultStatus)

#endif // OAIUsageRecordResultStatus_H
