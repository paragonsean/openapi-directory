...
#ifndef OAIUsageAllocation_H
#define OAIUsageAllocation_H
...
class OAIUsageAllocation : public OAIObject {
public:
    OAIUsageAllocation();
    OAIUsageAllocation(QString json);
    ~OAIUsageAllocation() override;
    ...
    qint32 getAllocatedUsageQuantity() const;
    void setAllocatedUsageQuantity(const qint32 &allocated_usage_quantity);
    bool is_allocated_usage_quantity_Set() const;
    bool is_allocated_usage_quantity_Valid() const;
...
private:
    ...
    qint32 m_allocated_usage_quantity;
    bool m_allocated_usage_quantity_isSet;
    bool m_allocated_usage_quantity_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUsageAllocation)

#endif // OAIUsageAllocation_H
