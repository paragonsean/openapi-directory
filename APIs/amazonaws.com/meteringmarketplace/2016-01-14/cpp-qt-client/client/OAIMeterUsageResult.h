...
/*
 * OAIMeterUsageResult.h
 *
 * 
 */

#ifndef OAIMeterUsageResult_H
#define OAIMeterUsageResult_H
...
class OAIMeterUsageResult : public OAIObject {
public:
    OAIMeterUsageResult();
    OAIMeterUsageResult(QString json);
    ~OAIMeterUsageResult() override;
    ...
    QString getMeteringRecordId() const;
    void setMeteringRecordId(const QString &metering_record_id);
    bool is_metering_record_id_Set() const;
    bool is_metering_record_id_Valid() const;
...
private:
    ...
    QString m_metering_record_id;
    bool m_metering_record_id_isSet;
    bool m_metering_record_id_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIMeterUsageResult)

#endif // OAIMeterUsageResult_H
