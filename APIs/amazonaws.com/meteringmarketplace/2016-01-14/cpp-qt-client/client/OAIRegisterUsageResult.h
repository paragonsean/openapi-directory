...
/*
 * OAIRegisterUsageResult.h
 *
 * 
 */

#ifndef OAIRegisterUsageResult_H
#define OAIRegisterUsageResult_H
...
class OAIRegisterUsageResult : public OAIObject {
public:
    OAIRegisterUsageResult();
    OAIRegisterUsageResult(QString json);
    ~OAIRegisterUsageResult() override;
    ...
    QDateTime getPublicKeyRotationTimestamp() const;
    void setPublicKeyRotationTimestamp(const QDateTime &public_key_rotation_timestamp);
    bool is_public_key_rotation_timestamp_Set() const;
    bool is_public_key_rotation_timestamp_Valid() const;
...
private:
    ...
    QDateTime m_public_key_rotation_timestamp;
    bool m_public_key_rotation_timestamp_isSet;
    bool m_public_key_rotation_timestamp_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRegisterUsageResult)

#endif // OAIRegisterUsageResult_H
