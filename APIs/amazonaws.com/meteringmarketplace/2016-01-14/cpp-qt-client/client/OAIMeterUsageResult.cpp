...
OAIMeterUsageResult::OAIMeterUsageResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMeterUsageResult::OAIMeterUsageResult() {
    this->initializeModel();
}

OAIMeterUsageResult::~OAIMeterUsageResult() {}

void OAIMeterUsageResult::initializeModel() {

    m_metering_record_id_isSet = false;
    m_metering_record_id_isValid = false;
}

void OAIMeterUsageResult::fromJson(QString jsonString) {
...
void OAIMeterUsageResult::fromJsonObject(QJsonObject json) {
...
QString OAIMeterUsageResult::asJson() const {
...
QJsonObject OAIMeterUsageResult::asJsonObject() const {
    QJsonObject obj;
...
QString OAIMeterUsageResult::getMeteringRecordId() const {
    return m_metering_record_id;
}
void OAIMeterUsageResult::setMeteringRecordId(const QString &metering_record_id) {
    m_metering_record_id = metering_record_id;
    m_metering_record_id_isSet = true;
}

bool OAIMeterUsageResult::is_metering_record_id_Set() const{
    return m_metering_record_id_isSet;
}

bool OAIMeterUsageResult::is_metering_record_id_Valid() const{
    return m_metering_record_id_isValid;
}

bool OAIMeterUsageResult::isSet() const {
...
bool OAIMeterUsageResult::isValid() const {
