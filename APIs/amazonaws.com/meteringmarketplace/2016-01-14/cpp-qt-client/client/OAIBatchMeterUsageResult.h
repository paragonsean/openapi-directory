...
#ifndef OAIBatchMeterUsageResult_H
#define OAIBatchMeterUsageResult_H
...
class OAIBatchMeterUsageResult : public OAIObject {
public:
    OAIBatchMeterUsageResult();
    OAIBatchMeterUsageResult(QString json);
    ~OAIBatchMeterUsageResult() override;
    ...
    QList getUnprocessedRecords() const;
    void setUnprocessedRecords(const QList &unprocessed_records);
    bool is_unprocessed_records_Set() const;
    bool is_unprocessed_records_Valid() const;
...
private:
    ...
    QList m_unprocessed_records;
    bool m_unprocessed_records_isSet;
    bool m_unprocessed_records_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIBatchMeterUsageResult)

#endif // OAIBatchMeterUsageResult_H
