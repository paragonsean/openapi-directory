...
#ifndef OAIResolveCustomerResult_H
#define OAIResolveCustomerResult_H
...
class OAIResolveCustomerResult : public OAIObject {
public:
    OAIResolveCustomerResult();
    OAIResolveCustomerResult(QString json);
    ~OAIResolveCustomerResult() override;
    ...
    QString getCustomerAwsAccountId() const;
    void setCustomerAwsAccountId(const QString &customer_aws_account_id);
    bool is_customer_aws_account_id_Set() const;
    bool is_customer_aws_account_id_Valid() const;
...
private:
    ...
    QString m_customer_aws_account_id;
    bool m_customer_aws_account_id_isSet;
    bool m_customer_aws_account_id_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIResolveCustomerResult)

#endif // OAIResolveCustomerResult_H
