...
async def test_batch_meter_usage(client):
    """Test case for batch_meter_usage

    
    """
    body = {"ProductCode":"","UsageRecords":""}
    headers = { 
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSMPMeteringService.BatchMeterUsage',
        headers=headers,
        json=body,
        )
...
async def test_meter_usage(client):
    """Test case for meter_usage

    
    """
    body = {"ProductCode":"","DryRun":"","UsageQuantity":"","UsageAllocations":"","Timestamp":"","UsageDimension":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSMPMeteringService.MeterUsage',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_register_usage(client):
    ...
    """
    body = {"Nonce":"","ProductCode":"","PublicKeyVersion":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSMPMeteringService.RegisterUsage',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_resolve_customer(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSMPMeteringService.ResolveCustomer',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
