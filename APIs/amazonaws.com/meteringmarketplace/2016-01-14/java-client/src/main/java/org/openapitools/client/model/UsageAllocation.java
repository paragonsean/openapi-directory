...
public class UsageAllocation {
  ...
  public UsageAllocation() {
  }

  public UsageAllocation allocatedUsageQuantity(Integer allocatedUsageQuantity) {
    this.allocatedUsageQuantity = allocatedUsageQuantity;
    return this;
  }

  /**
   * Get allocatedUsageQuantity
  ...
  public UsageAllocation tags(List tags) {
    this.tags = tags;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    UsageAllocation usageAllocation = (UsageAllocation) o;
    return Objects.equals(this.allocatedUsageQuantity, usageAllocation.allocatedUsageQuantity) &&
        Objects.equals(this.tags, usageAllocation.tags);
  }

  @Override
  public int hashCode() {
    return Objects.hash(allocatedUsageQuantity, tags);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UsageAllocation {\n");
    sb.append("    allocatedUsageQuantity: ").append(toIndentedString(allocatedUsageQuantity)).append("\n");
  ...
  static {
    ...
    openapiFields.add("AllocatedUsageQuantity");
    openapiFields.add("Tags");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("AllocatedUsageQuantity");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UsageAllocation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UsageAllocation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UsageAllocation is not found in the empty JSON string", UsageAllocation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UsageAllocation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UsageAllocation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UsageAllocation.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `AllocatedUsageQuantity`
      Integer.validateJsonElement(jsonObj.get("AllocatedUsageQuantity"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UsageAllocation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UsageAllocation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UsageAllocation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UsageAllocation.class));

       return (TypeAdapter<T>) new TypeAdapter<UsageAllocation>() {
           @Override
           public void write(JsonWriter out, UsageAllocation value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UsageAllocation read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UsageAllocation given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UsageAllocation
   * @throws IOException if the JSON string is invalid with respect to UsageAllocation
   */
  public static UsageAllocation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UsageAllocation.class);
  }

  /**
   * Convert an instance of UsageAllocation to an JSON string
   *
   * @return JSON string
   */
