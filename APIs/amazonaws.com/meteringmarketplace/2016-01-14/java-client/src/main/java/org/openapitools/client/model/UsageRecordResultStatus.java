...
/**
 * Gets or Sets UsageRecordResultStatus
 */
@JsonAdapter(UsageRecordResultStatus.Adapter.class)
public enum UsageRecordResultStatus {
  ...
  UsageRecordResultStatus(String value) {
    this.value = value;
  }
  ...
  public static UsageRecordResultStatus fromValue(String value) {
    for (UsageRecordResultStatus b : UsageRecordResultStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<UsageRecordResultStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final UsageRecordResultStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public UsageRecordResultStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return UsageRecordResultStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    UsageRecordResultStatus.fromValue(value);
  }
}
