...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMarketplaceMetering.UsageRecordResultUsageRecord();
  });
  ...
  describe('UsageRecordResultUsageRecord', function() {
    it('should create an instance of UsageRecordResultUsageRecord', function() {
      // uncomment below and update the code to test UsageRecordResultUsageRecord
      //var instance = new AwsMarketplaceMetering.UsageRecordResultUsageRecord();
      //expect(instance).to.be.a(AwsMarketplaceMetering.UsageRecordResultUsageRecord);
    });
