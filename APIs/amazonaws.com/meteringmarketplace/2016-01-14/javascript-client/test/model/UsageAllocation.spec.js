...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMarketplaceMetering.UsageAllocation();
  });
  ...
  describe('UsageAllocation', function() {
    it('should create an instance of UsageAllocation', function() {
      // uncomment below and update the code to test UsageAllocation
      //var instance = new AwsMarketplaceMetering.UsageAllocation();
      //expect(instance).to.be.a(AwsMarketplaceMetering.UsageAllocation);
    });

    it('should have the property allocatedUsageQuantity (base name: "AllocatedUsageQuantity")', function() {
      // uncomment below and update the code to test the property allocatedUsageQuantity
      //var instance = new AwsMarketplaceMetering.UsageAllocation();
