...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMarketplaceMetering.RegisterUsageResult();
  });
  ...
  describe('RegisterUsageResult', function() {
    it('should create an instance of RegisterUsageResult', function() {
      // uncomment below and update the code to test RegisterUsageResult
      //var instance = new AwsMarketplaceMetering.RegisterUsageResult();
      //expect(instance).to.be.a(AwsMarketplaceMetering.RegisterUsageResult);
    });

    it('should have the property publicKeyRotationTimestamp (base name: "PublicKeyRotationTimestamp")', function() {
      // uncomment below and update the code to test the property publicKeyRotationTimestamp
      //var instance = new AwsMarketplaceMetering.RegisterUsageResult();
