...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMarketplaceMetering.MeterUsageRequest();
  });
  ...
  describe('MeterUsageRequest', function() {
    it('should create an instance of MeterUsageRequest', function() {
      // uncomment below and update the code to test MeterUsageRequest
      //var instance = new AwsMarketplaceMetering.MeterUsageRequest();
      //expect(instance).to.be.a(AwsMarketplaceMetering.MeterUsageRequest);
    });
    ...
    it('should have the property usageDimension (base name: "UsageDimension")', function() {
      // uncomment below and update the code to test the property usageDimension
      //var instance = new AwsMarketplaceMetering.MeterUsageRequest();
      //expect(instance).to.be();
    });
