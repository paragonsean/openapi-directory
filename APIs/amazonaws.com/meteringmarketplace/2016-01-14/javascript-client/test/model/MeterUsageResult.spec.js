...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMarketplaceMetering.MeterUsageResult();
  });
  ...
  describe('MeterUsageResult', function() {
    it('should create an instance of MeterUsageResult', function() {
      // uncomment below and update the code to test MeterUsageResult
      //var instance = new AwsMarketplaceMetering.MeterUsageResult();
      //expect(instance).to.be.a(AwsMarketplaceMetering.MeterUsageResult);
    });

    it('should have the property meteringRecordId (base name: "MeteringRecordId")', function() {
      // uncomment below and update the code to test the property meteringRecordId
      //var instance = new AwsMarketplaceMetering.MeterUsageResult();
