...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMarketplaceMetering.ResolveCustomerResult();
  });
  ...
  describe('ResolveCustomerResult', function() {
    it('should create an instance of ResolveCustomerResult', function() {
      // uncomment below and update the code to test ResolveCustomerResult
      //var instance = new AwsMarketplaceMetering.ResolveCustomerResult();
      //expect(instance).to.be.a(AwsMarketplaceMetering.ResolveCustomerResult);
    });
    ...
    it('should have the property customerAWSAccountId (base name: "CustomerAWSAccountId")', function() {
      // uncomment below and update the code to test the property customerAWSAccountId
      //var instance = new AwsMarketplaceMetering.ResolveCustomerResult();
      //expect(instance).to.be();
    });
