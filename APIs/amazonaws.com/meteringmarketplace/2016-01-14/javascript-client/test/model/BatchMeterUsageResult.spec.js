...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMarketplaceMetering.BatchMeterUsageResult();
  });
  ...
  describe('BatchMeterUsageResult', function() {
    it('should create an instance of BatchMeterUsageResult', function() {
      // uncomment below and update the code to test BatchMeterUsageResult
      //var instance = new AwsMarketplaceMetering.BatchMeterUsageResult();
      //expect(instance).to.be.a(AwsMarketplaceMetering.BatchMeterUsageResult);
    });
    ...
    it('should have the property unprocessedRecords (base name: "UnprocessedRecords")', function() {
      // uncomment below and update the code to test the property unprocessedRecords
      //var instance = new AwsMarketplaceMetering.BatchMeterUsageResult();
      //expect(instance).to.be();
    });
