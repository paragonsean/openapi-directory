...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMarketplaceMetering.ResolveCustomerRequest();
  });
  ...
  describe('ResolveCustomerRequest', function() {
    it('should create an instance of ResolveCustomerRequest', function() {
      // uncomment below and update the code to test ResolveCustomerRequest
      //var instance = new AwsMarketplaceMetering.ResolveCustomerRequest();
      //expect(instance).to.be.a(AwsMarketplaceMetering.ResolveCustomerRequest);
    });
