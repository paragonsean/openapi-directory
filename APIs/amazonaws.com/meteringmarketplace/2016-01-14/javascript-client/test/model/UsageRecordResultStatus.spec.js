...
(function(root, factory) {
  ...
  describe('UsageRecordResultStatus', function() {
    it('should create an instance of UsageRecordResultStatus', function() {
      // uncomment below and update the code to test UsageRecordResultStatus
      //var instance = new AwsMarketplaceMetering.UsageRecordResultStatus();
      //expect(instance).to.be.a(AwsMarketplaceMetering.UsageRecordResultStatus);
    });
