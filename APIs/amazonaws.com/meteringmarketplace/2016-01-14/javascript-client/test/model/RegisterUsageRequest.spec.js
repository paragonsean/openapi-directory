...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMarketplaceMetering.RegisterUsageRequest();
  });
  ...
  describe('RegisterUsageRequest', function() {
    it('should create an instance of RegisterUsageRequest', function() {
      // uncomment below and update the code to test RegisterUsageRequest
      //var instance = new AwsMarketplaceMetering.RegisterUsageRequest();
      //expect(instance).to.be.a(AwsMarketplaceMetering.RegisterUsageRequest);
    });
    ...
    it('should have the property publicKeyVersion (base name: "PublicKeyVersion")', function() {
      // uncomment below and update the code to test the property publicKeyVersion
      //var instance = new AwsMarketplaceMetering.RegisterUsageRequest();
      //expect(instance).to.be();
    });
