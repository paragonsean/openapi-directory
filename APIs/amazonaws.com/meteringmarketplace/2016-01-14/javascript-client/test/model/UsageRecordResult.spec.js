...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMarketplaceMetering.UsageRecordResult();
  });
  ...
  describe('UsageRecordResult', function() {
    it('should create an instance of UsageRecordResult', function() {
      // uncomment below and update the code to test UsageRecordResult
      //var instance = new AwsMarketplaceMetering.UsageRecordResult();
      //expect(instance).to.be.a(AwsMarketplaceMetering.UsageRecordResult);
    });

    it('should have the property usageRecord (base name: "UsageRecord")', function() {
      // uncomment below and update the code to test the property usageRecord
      //var instance = new AwsMarketplaceMetering.UsageRecordResult();
