...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMarketplaceMetering.BatchMeterUsageRequest();
  });
  ...
  describe('BatchMeterUsageRequest', function() {
    it('should create an instance of BatchMeterUsageRequest', function() {
      // uncomment below and update the code to test BatchMeterUsageRequest
      //var instance = new AwsMarketplaceMetering.BatchMeterUsageRequest();
      //expect(instance).to.be.a(AwsMarketplaceMetering.BatchMeterUsageRequest);
    });

    it('should have the property usageRecords (base name: "UsageRecords")', function() {
