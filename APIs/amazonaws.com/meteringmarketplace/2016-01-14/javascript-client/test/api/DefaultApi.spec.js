...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsMarketplaceMetering.DefaultApi();
  });
  ...
  describe('DefaultApi', function() {
    describe('batchMeterUsage', function() {
      it('should call batchMeterUsage successfully', function(done) {
        //uncomment below and update the code to test batchMeterUsage
        //instance.batchMeterUsage(function(error) {
    ...
    describe('meterUsage', function() {
      it('should call meterUsage successfully', function(done) {
        //uncomment below and update the code to test meterUsage
        //instance.meterUsage(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('registerUsage', function() {
      it('should call registerUsage successfully', function(done) {
        //uncomment below and update the code to test registerUsage
        //instance.registerUsage(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('resolveCustomer', function() {
      it('should call resolveCustomer successfully', function(done) {
        //uncomment below and update the code to test resolveCustomer
        //instance.resolveCustomer(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
