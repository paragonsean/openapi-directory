# AwsMarketplaceMetering.DefaultApi
...
> BatchMeterUsageResult batchMeterUsage(xAmzTarget, batchMeterUsageRequest, opts)
...
```javascript
import AwsMarketplaceMetering from 'aws_marketplace_metering';
let defaultClient = AwsMarketplaceMetering.ApiClient.instance;
...
let apiInstance = new AwsMarketplaceMetering.DefaultApi();
let xAmzTarget = "xAmzTarget_example"; // String | 
let batchMeterUsageRequest = new AwsMarketplaceMetering.BatchMeterUsageRequest(); // BatchMeterUsageRequest | 
let opts = {
...
apiInstance.batchMeterUsage(xAmzTarget, batchMeterUsageRequest, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> MeterUsageResult meterUsage(xAmzTarget, meterUsageRequest, opts)
...
let apiInstance = new AwsMarketplaceMetering.DefaultApi();
let xAmzTarget = "xAmzTarget_example"; // String | 
let meterUsageRequest = new AwsMarketplaceMetering.MeterUsageRequest(); // MeterUsageRequest | 
let opts = {
  'xAmzContentSha256': "xAmzContentSha256_example", // String | 
  'xAmzDate': "xAmzDate_example", // String | 
  'xAmzAlgorithm': "xAmzAlgorithm_example", // String | 
...
apiInstance.meterUsage(xAmzTarget, meterUsageRequest, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> RegisterUsageResult registerUsage(xAmzTarget, registerUsageRequest, opts)
...
let apiInstance = new AwsMarketplaceMetering.DefaultApi();
let xAmzTarget = "xAmzTarget_example"; // String | 
let registerUsageRequest = new AwsMarketplaceMetering.RegisterUsageRequest(); // RegisterUsageRequest | 
let opts = {
  'xAmzContentSha256': "xAmzContentSha256_example", // String | 
  'xAmzDate': "xAmzDate_example", // String | 
  'xAmzAlgorithm': "xAmzAlgorithm_example", // String | 
...
apiInstance.registerUsage(xAmzTarget, registerUsageRequest, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ResolveCustomerResult resolveCustomer(xAmzTarget, resolveCustomerRequest, opts)
...
let apiInstance = new AwsMarketplaceMetering.DefaultApi();
let xAmzTarget = "xAmzTarget_example"; // String | 
let resolveCustomerRequest = new AwsMarketplaceMetering.ResolveCustomerRequest(); // ResolveCustomerRequest | 
let opts = {
  'xAmzContentSha256': "xAmzContentSha256_example", // String | 
  'xAmzDate': "xAmzDate_example", // String | 
  'xAmzAlgorithm': "xAmzAlgorithm_example", // String | 
...
apiInstance.resolveCustomer(xAmzTarget, resolveCustomerRequest, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
