...
/**
 * The BatchMeterUsageResult model module.
 * @module model/BatchMeterUsageResult
 * @version 2016-01-14
 */
class BatchMeterUsageResult {
    /**
     * Constructs a new <code>BatchMeterUsageResult</code>.
     ...
     * @alias module:model/BatchMeterUsageResult
     */
    constructor() { 
        
        BatchMeterUsageResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BatchMeterUsageResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BatchMeterUsageResult} obj Optional instance to populate.
     * @return {module:model/BatchMeterUsageResult} The populated <code>BatchMeterUsageResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BatchMeterUsageResult();

            if (data.hasOwnProperty('Results')) {
                obj['Results'] = ApiClient.convertToType(data['Results'], Array);
            }
            if (data.hasOwnProperty('UnprocessedRecords')) {
                obj['UnprocessedRecords'] = ApiClient.convertToType(data['UnprocessedRecords'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>BatchMeterUsageResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BatchMeterUsageResult</code>.
     */
    static validateJSON(data) {
        ...
        if (data['UnprocessedRecords']) { // data not null
          Array.validateJSON(data['UnprocessedRecords']);
        }
 ...
 */
BatchMeterUsageResult.prototype['Results'] = undefined;

/**
 * @member {Array} UnprocessedRecords
 */
BatchMeterUsageResult.prototype['UnprocessedRecords'] = undefined;
...
export default BatchMeterUsageResult;
