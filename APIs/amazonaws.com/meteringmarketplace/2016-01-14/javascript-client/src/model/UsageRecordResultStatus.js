...
* @readonly
*/
export default class UsageRecordResultStatus {
    ...
    /**
    * Returns a <code>UsageRecordResultStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/UsageRecordResultStatus} The enum <code>UsageRecordResultStatus</code> value.
    */
