...
/**
 * The UsageAllocation model module.
 * @module model/UsageAllocation
 * @version 2016-01-14
 */
class UsageAllocation {
    /**
     * Constructs a new <code>UsageAllocation</code>.
     ...
     * @alias module:model/UsageAllocation
     * @param allocatedUsageQuantity {Number} 
     */
    constructor(allocatedUsageQuantity) { 
        
        UsageAllocation.initialize(this, allocatedUsageQuantity);
    }
     ...
     */
    static initialize(obj, allocatedUsageQuantity) { 
        obj['AllocatedUsageQuantity'] = allocatedUsageQuantity;
    }

    /**
     * Constructs a <code>UsageAllocation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UsageAllocation} obj Optional instance to populate.
     * @return {module:model/UsageAllocation} The populated <code>UsageAllocation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UsageAllocation();

            if (data.hasOwnProperty('AllocatedUsageQuantity')) {
                obj['AllocatedUsageQuantity'] = ApiClient.convertToType(data['AllocatedUsageQuantity'], 'Number');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>UsageAllocation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UsageAllocation</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UsageAllocation.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `AllocatedUsageQuantity`
        if (data['AllocatedUsageQuantity']) { // data not null
          Number.validateJSON(data['AllocatedUsageQuantity']);
        }
...
UsageAllocation.RequiredProperties = ["AllocatedUsageQuantity"];

/**
 * @member {Number} AllocatedUsageQuantity
 */
UsageAllocation.prototype['AllocatedUsageQuantity'] = undefined;

/**
 * @member {Array} Tags
 */
UsageAllocation.prototype['Tags'] = undefined;
...
export default UsageAllocation;
