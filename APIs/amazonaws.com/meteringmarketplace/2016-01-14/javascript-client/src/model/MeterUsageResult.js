...
/**
 * The MeterUsageResult model module.
 * @module model/MeterUsageResult
 * @version 2016-01-14
 */
class MeterUsageResult {
    /**
     * Constructs a new <code>MeterUsageResult</code>.
     * @alias module:model/MeterUsageResult
     */
    constructor() { 
        
        MeterUsageResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MeterUsageResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MeterUsageResult} obj Optional instance to populate.
     * @return {module:model/MeterUsageResult} The populated <code>MeterUsageResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MeterUsageResult();
    ...
    /**
     * Validates the JSON data with respect to <code>MeterUsageResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MeterUsageResult</code>.
     */
 ...
 */
MeterUsageResult.prototype['MeteringRecordId'] = undefined;
...
export default MeterUsageResult;
