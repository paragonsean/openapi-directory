...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://metering.marketplace.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://metering.marketplace.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2016-01-14/Javascript'
        };
