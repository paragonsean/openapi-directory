...
/*
 * OAIExportAssetsToS3RequestDetails_Encryption.h
 *
 * 
 */

#ifndef OAIExportAssetsToS3RequestDetails_Encryption_H
#define OAIExportAssetsToS3RequestDetails_Encryption_H
...
class OAIExportAssetsToS3RequestDetails_Encryption : public OAIObject {
public:
    OAIExportAssetsToS3RequestDetails_Encryption();
    OAIExportAssetsToS3RequestDetails_Encryption(QString json);
    ~OAIExportAssetsToS3RequestDetails_Encryption() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExportAssetsToS3RequestDetails_Encryption)

#endif // OAIExportAssetsToS3RequestDetails_Encryption_H
