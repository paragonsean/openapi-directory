...
OAILFResourceDetails_Table::OAILFResourceDetails_Table(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILFResourceDetails_Table::OAILFResourceDetails_Table() {
    this->initializeModel();
}

OAILFResourceDetails_Table::~OAILFResourceDetails_Table() {}

void OAILFResourceDetails_Table::initializeModel() {

    m_expression_isSet = false;
    m_expression_isValid = false;
}

void OAILFResourceDetails_Table::fromJson(QString jsonString) {
...
void OAILFResourceDetails_Table::fromJsonObject(QJsonObject json) {
...
QString OAILFResourceDetails_Table::asJson() const {
...
QJsonObject OAILFResourceDetails_Table::asJsonObject() const {
    QJsonObject obj;
...
QList OAILFResourceDetails_Table::getExpression() const {
    return m_expression;
}
void OAILFResourceDetails_Table::setExpression(const QList &expression) {
    m_expression = expression;
    m_expression_isSet = true;
}

bool OAILFResourceDetails_Table::is_expression_Set() const{
    return m_expression_isSet;
}

bool OAILFResourceDetails_Table::is_expression_Valid() const{
    return m_expression_isValid;
}

bool OAILFResourceDetails_Table::isSet() const {
...
bool OAILFResourceDetails_Table::isValid() const {
