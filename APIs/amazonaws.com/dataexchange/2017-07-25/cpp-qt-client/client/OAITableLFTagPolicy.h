...
/*
 * OAITableLFTagPolicy.h
 *
 * The LF-tag policy for a table resource.
 */

#ifndef OAITableLFTagPolicy_H
#define OAITableLFTagPolicy_H
...
class OAITableLFTagPolicy : public OAIObject {
public:
    OAITableLFTagPolicy();
    OAITableLFTagPolicy(QString json);
    ~OAITableLFTagPolicy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITableLFTagPolicy)

#endif // OAITableLFTagPolicy_H
