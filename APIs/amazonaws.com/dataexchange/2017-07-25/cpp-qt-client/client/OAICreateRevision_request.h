...
/*
 * OAICreateRevision_request.h
 *
 * 
 */

#ifndef OAICreateRevision_request_H
#define OAICreateRevision_request_H
...
class OAICreateRevision_request : public OAIObject {
public:
    OAICreateRevision_request();
    OAICreateRevision_request(QString json);
    ~OAICreateRevision_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateRevision_request)

#endif // OAICreateRevision_request_H
