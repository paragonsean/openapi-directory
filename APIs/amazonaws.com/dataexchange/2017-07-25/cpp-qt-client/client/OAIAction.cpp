...
OAICreateEventAction_request_Action_ExportRevisionToS3 OAIAction::getExportRevisionToS3() const {
    return m_export_revision_to_s3;
}
void OAIAction::setExportRevisionToS3(const OAICreateEventAction_request_Action_ExportRevisionToS3 &export_revision_to_s3) {
    m_export_revision_to_s3 = export_revision_to_s3;
    m_export_revision_to_s3_isSet = true;
}

bool OAIAction::is_export_revision_to_s3_Set() const{
    return m_export_revision_to_s3_isSet;
}

bool OAIAction::is_export_revision_to_s3_Valid() const{
