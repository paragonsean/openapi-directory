...
/*
 * OAIApiGatewayApiAsset.h
 *
 * The API Gateway API that is the asset.
 */

#ifndef OAIApiGatewayApiAsset_H
#define OAIApiGatewayApiAsset_H
...
class OAIApiGatewayApiAsset : public OAIObject {
public:
    OAIApiGatewayApiAsset();
    OAIApiGatewayApiAsset(QString json);
    ~OAIApiGatewayApiAsset() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApiGatewayApiAsset)

#endif // OAIApiGatewayApiAsset_H
