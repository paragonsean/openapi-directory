...
/*
 * OAIResponseDetails_ExportAssetToSignedUrl.h
 *
 * 
 */

#ifndef OAIResponseDetails_ExportAssetToSignedUrl_H
#define OAIResponseDetails_ExportAssetToSignedUrl_H
...
class OAIResponseDetails_ExportAssetToSignedUrl : public OAIObject {
public:
    OAIResponseDetails_ExportAssetToSignedUrl();
    OAIResponseDetails_ExportAssetToSignedUrl(QString json);
    ~OAIResponseDetails_ExportAssetToSignedUrl() override;
    ...
    QString getSignedUrl() const;
    void setSignedUrl(const QString &signed_url);
    bool is_signed_url_Set() const;
    bool is_signed_url_Valid() const;

    QDateTime getSignedUrlExpiresAt() const;
    void setSignedUrlExpiresAt(const QDateTime &signed_url_expires_at);
    bool is_signed_url_expires_at_Set() const;
    bool is_signed_url_expires_at_Valid() const;
...
private:
    ...
    QString m_signed_url;
    bool m_signed_url_isSet;
    bool m_signed_url_isValid;

    QDateTime m_signed_url_expires_at;
    bool m_signed_url_expires_at_isSet;
    bool m_signed_url_expires_at_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIResponseDetails_ExportAssetToSignedUrl)

#endif // OAIResponseDetails_ExportAssetToSignedUrl_H
