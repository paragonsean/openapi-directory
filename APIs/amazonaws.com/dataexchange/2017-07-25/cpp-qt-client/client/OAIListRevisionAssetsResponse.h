...
/*
 * OAIListRevisionAssetsResponse.h
 *
 * 
 */

#ifndef OAIListRevisionAssetsResponse_H
#define OAIListRevisionAssetsResponse_H
...
class OAIListRevisionAssetsResponse : public OAIObject {
public:
    OAIListRevisionAssetsResponse();
    OAIListRevisionAssetsResponse(QString json);
    ~OAIListRevisionAssetsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListRevisionAssetsResponse)

#endif // OAIListRevisionAssetsResponse_H
