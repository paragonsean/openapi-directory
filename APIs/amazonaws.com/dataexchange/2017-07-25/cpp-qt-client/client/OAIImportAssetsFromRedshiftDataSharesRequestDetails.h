...
/*
 * OAIImportAssetsFromRedshiftDataSharesRequestDetails.h
 *
 * Details from an import from Amazon Redshift datashare request.
 */

#ifndef OAIImportAssetsFromRedshiftDataSharesRequestDetails_H
#define OAIImportAssetsFromRedshiftDataSharesRequestDetails_H
...
class OAIImportAssetsFromRedshiftDataSharesRequestDetails : public OAIObject {
public:
    OAIImportAssetsFromRedshiftDataSharesRequestDetails();
    OAIImportAssetsFromRedshiftDataSharesRequestDetails(QString json);
    ~OAIImportAssetsFromRedshiftDataSharesRequestDetails() override;
    ...
    QList getAssetSources() const;
    void setAssetSources(const QList &asset_sources);
    bool is_asset_sources_Set() const;
    bool is_asset_sources_Valid() const;
...
private:
    ...
    QList m_asset_sources;
    bool m_asset_sources_isSet;
    bool m_asset_sources_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImportAssetsFromRedshiftDataSharesRequestDetails)

#endif // OAIImportAssetsFromRedshiftDataSharesRequestDetails_H
