...
/*
 * OAIServerSideEncryptionTypes.h
 *
 * 
 */

#ifndef OAIServerSideEncryptionTypes_H
#define OAIServerSideEncryptionTypes_H
...
class OAIServerSideEncryptionTypes : public OAIEnum {
public:
    OAIServerSideEncryptionTypes();
    OAIServerSideEncryptionTypes(QString json);
    ~OAIServerSideEncryptionTypes() override;
    ...
    enum class eOAIServerSideEncryptionTypes {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        AWS_KMS, 
        AES256
    };
    OAIServerSideEncryptionTypes::eOAIServerSideEncryptionTypes getValue() const;
    void setValue(const OAIServerSideEncryptionTypes::eOAIServerSideEncryptionTypes& value);
...
private:
    ...
    eOAIServerSideEncryptionTypes m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIServerSideEncryptionTypes)

#endif // OAIServerSideEncryptionTypes_H
