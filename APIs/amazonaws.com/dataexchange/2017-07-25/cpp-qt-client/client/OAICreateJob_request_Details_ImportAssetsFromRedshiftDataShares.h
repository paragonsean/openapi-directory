...
/*
 * OAICreateJob_request_Details_ImportAssetsFromRedshiftDataShares.h
 *
 * 
 */

#ifndef OAICreateJob_request_Details_ImportAssetsFromRedshiftDataShares_H
#define OAICreateJob_request_Details_ImportAssetsFromRedshiftDataShares_H
...
class OAICreateJob_request_Details_ImportAssetsFromRedshiftDataShares : public OAIObject {
public:
    OAICreateJob_request_Details_ImportAssetsFromRedshiftDataShares();
    OAICreateJob_request_Details_ImportAssetsFromRedshiftDataShares(QString json);
    ~OAICreateJob_request_Details_ImportAssetsFromRedshiftDataShares() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateJob_request_Details_ImportAssetsFromRedshiftDataShares)

#endif // OAICreateJob_request_Details_ImportAssetsFromRedshiftDataShares_H
