...
namespace OpenAPI {
class OAICreateJobRequest_Details;
...
public:
    ...
    OAICreateJobRequest_Details getDetails() const;
    void setDetails(const OAICreateJobRequest_Details &details);
...
private:
    ...
    OAICreateJobRequest_Details m_details;
