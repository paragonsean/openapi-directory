...
OAICreateJob_request_Details_ExportAssetToSignedUrl::OAICreateJob_request_Details_ExportAssetToSignedUrl(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateJob_request_Details_ExportAssetToSignedUrl::OAICreateJob_request_Details_ExportAssetToSignedUrl() {
    this->initializeModel();
}

OAICreateJob_request_Details_ExportAssetToSignedUrl::~OAICreateJob_request_Details_ExportAssetToSignedUrl() {}

void OAICreateJob_request_Details_ExportAssetToSignedUrl::initializeModel() {
...
void OAICreateJob_request_Details_ExportAssetToSignedUrl::fromJson(QString jsonString) {
...
void OAICreateJob_request_Details_ExportAssetToSignedUrl::fromJsonObject(QJsonObject json) {
...
QString OAICreateJob_request_Details_ExportAssetToSignedUrl::asJson() const {
...
QJsonObject OAICreateJob_request_Details_ExportAssetToSignedUrl::asJsonObject() const {
    QJsonObject obj;
    if (m_asset_id_isSet) {
...
QString OAICreateJob_request_Details_ExportAssetToSignedUrl::getAssetId() const {
    return m_asset_id;
}
void OAICreateJob_request_Details_ExportAssetToSignedUrl::setAssetId(const QString &asset_id) {
    m_asset_id = asset_id;
    m_asset_id_isSet = true;
}

bool OAICreateJob_request_Details_ExportAssetToSignedUrl::is_asset_id_Set() const{
    return m_asset_id_isSet;
}

bool OAICreateJob_request_Details_ExportAssetToSignedUrl::is_asset_id_Valid() const{
    return m_asset_id_isValid;
}

QString OAICreateJob_request_Details_ExportAssetToSignedUrl::getDataSetId() const {
    return m_data_set_id;
}
void OAICreateJob_request_Details_ExportAssetToSignedUrl::setDataSetId(const QString &data_set_id) {
    m_data_set_id = data_set_id;
    m_data_set_id_isSet = true;
}

bool OAICreateJob_request_Details_ExportAssetToSignedUrl::is_data_set_id_Set() const{
    return m_data_set_id_isSet;
}

bool OAICreateJob_request_Details_ExportAssetToSignedUrl::is_data_set_id_Valid() const{
    return m_data_set_id_isValid;
}

QString OAICreateJob_request_Details_ExportAssetToSignedUrl::getRevisionId() const {
    return m_revision_id;
}
void OAICreateJob_request_Details_ExportAssetToSignedUrl::setRevisionId(const QString &revision_id) {
    m_revision_id = revision_id;
    m_revision_id_isSet = true;
}

bool OAICreateJob_request_Details_ExportAssetToSignedUrl::is_revision_id_Set() const{
    return m_revision_id_isSet;
}

bool OAICreateJob_request_Details_ExportAssetToSignedUrl::is_revision_id_Valid() const{
    return m_revision_id_isValid;
}

bool OAICreateJob_request_Details_ExportAssetToSignedUrl::isSet() const {
...
bool OAICreateJob_request_Details_ExportAssetToSignedUrl::isValid() const {
