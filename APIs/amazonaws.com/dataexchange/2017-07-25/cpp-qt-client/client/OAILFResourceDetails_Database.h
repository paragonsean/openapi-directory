...
/*
 * OAILFResourceDetails_Database.h
 *
 * 
 */

#ifndef OAILFResourceDetails_Database_H
#define OAILFResourceDetails_Database_H
...
class OAILFResourceDetails_Database : public OAIObject {
public:
    OAILFResourceDetails_Database();
    OAILFResourceDetails_Database(QString json);
    ~OAILFResourceDetails_Database() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILFResourceDetails_Database)

#endif // OAILFResourceDetails_Database_H
