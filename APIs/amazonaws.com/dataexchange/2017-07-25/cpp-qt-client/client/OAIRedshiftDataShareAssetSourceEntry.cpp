...
#include "OAIRedshiftDataShareAssetSourceEntry.h"
...
OAIRedshiftDataShareAssetSourceEntry::OAIRedshiftDataShareAssetSourceEntry(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRedshiftDataShareAssetSourceEntry::OAIRedshiftDataShareAssetSourceEntry() {
    this->initializeModel();
}

OAIRedshiftDataShareAssetSourceEntry::~OAIRedshiftDataShareAssetSourceEntry() {}

void OAIRedshiftDataShareAssetSourceEntry::initializeModel() {

    m_data_share_arn_isSet = false;
    m_data_share_arn_isValid = false;
}

void OAIRedshiftDataShareAssetSourceEntry::fromJson(QString jsonString) {
...
void OAIRedshiftDataShareAssetSourceEntry::fromJsonObject(QJsonObject json) {
...
QString OAIRedshiftDataShareAssetSourceEntry::asJson() const {
...
QJsonObject OAIRedshiftDataShareAssetSourceEntry::asJsonObject() const {
    QJsonObject obj;
...
QString OAIRedshiftDataShareAssetSourceEntry::getDataShareArn() const {
    return m_data_share_arn;
}
void OAIRedshiftDataShareAssetSourceEntry::setDataShareArn(const QString &data_share_arn) {
    m_data_share_arn = data_share_arn;
    m_data_share_arn_isSet = true;
}

bool OAIRedshiftDataShareAssetSourceEntry::is_data_share_arn_Set() const{
    return m_data_share_arn_isSet;
}

bool OAIRedshiftDataShareAssetSourceEntry::is_data_share_arn_Valid() const{
    return m_data_share_arn_isValid;
}

bool OAIRedshiftDataShareAssetSourceEntry::isSet() const {
...
bool OAIRedshiftDataShareAssetSourceEntry::isValid() const {
