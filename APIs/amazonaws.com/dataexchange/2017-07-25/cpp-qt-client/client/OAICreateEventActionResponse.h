...
/*
 * OAICreateEventActionResponse.h
 *
 * 
 */

#ifndef OAICreateEventActionResponse_H
#define OAICreateEventActionResponse_H
...
class OAICreateEventActionResponse : public OAIObject {
public:
    OAICreateEventActionResponse();
    OAICreateEventActionResponse(QString json);
    ~OAICreateEventActionResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateEventActionResponse)

#endif // OAICreateEventActionResponse_H
