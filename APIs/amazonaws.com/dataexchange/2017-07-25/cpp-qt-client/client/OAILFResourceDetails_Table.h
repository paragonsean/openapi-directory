...
/*
 * OAILFResourceDetails_Table.h
 *
 * 
 */

#ifndef OAILFResourceDetails_Table_H
#define OAILFResourceDetails_Table_H
...
class OAILFResourceDetails_Table : public OAIObject {
public:
    OAILFResourceDetails_Table();
    OAILFResourceDetails_Table(QString json);
    ~OAILFResourceDetails_Table() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILFResourceDetails_Table)

#endif // OAILFResourceDetails_Table_H
