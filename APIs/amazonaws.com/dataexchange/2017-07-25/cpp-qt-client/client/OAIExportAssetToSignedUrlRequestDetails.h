...
/*
 * OAIExportAssetToSignedUrlRequestDetails.h
 *
 * Details of the operation to be performed by the job.
 */

#ifndef OAIExportAssetToSignedUrlRequestDetails_H
#define OAIExportAssetToSignedUrlRequestDetails_H
...
class OAIExportAssetToSignedUrlRequestDetails : public OAIObject {
public:
    OAIExportAssetToSignedUrlRequestDetails();
    OAIExportAssetToSignedUrlRequestDetails(QString json);
    ~OAIExportAssetToSignedUrlRequestDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExportAssetToSignedUrlRequestDetails)

#endif // OAIExportAssetToSignedUrlRequestDetails_H
