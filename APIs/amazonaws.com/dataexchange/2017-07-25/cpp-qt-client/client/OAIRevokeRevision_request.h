...
/*
 * OAIRevokeRevision_request.h
 *
 * 
 */

#ifndef OAIRevokeRevision_request_H
#define OAIRevokeRevision_request_H
...
class OAIRevokeRevision_request : public OAIObject {
public:
    OAIRevokeRevision_request();
    OAIRevokeRevision_request(QString json);
    ~OAIRevokeRevision_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRevokeRevision_request)

#endif // OAIRevokeRevision_request_H
