...
/*
 * OAIImportAssetFromSignedUrlJobErrorDetails.h
 *
 * Details about the job error.
 */

#ifndef OAIImportAssetFromSignedUrlJobErrorDetails_H
#define OAIImportAssetFromSignedUrlJobErrorDetails_H
...
class OAIImportAssetFromSignedUrlJobErrorDetails : public OAIObject {
public:
    OAIImportAssetFromSignedUrlJobErrorDetails();
    OAIImportAssetFromSignedUrlJobErrorDetails(QString json);
    ~OAIImportAssetFromSignedUrlJobErrorDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImportAssetFromSignedUrlJobErrorDetails)

#endif // OAIImportAssetFromSignedUrlJobErrorDetails_H
