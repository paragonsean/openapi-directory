...
/*
 * OAIAutoExportRevisionDestinationEntry.h
 *
 * A revision destination is the Amazon S3 bucket folder destination to where the export will be sent.
 */

#ifndef OAIAutoExportRevisionDestinationEntry_H
#define OAIAutoExportRevisionDestinationEntry_H
...
class OAIAutoExportRevisionDestinationEntry : public OAIObject {
public:
    OAIAutoExportRevisionDestinationEntry();
    OAIAutoExportRevisionDestinationEntry(QString json);
    ~OAIAutoExportRevisionDestinationEntry() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAutoExportRevisionDestinationEntry)

#endif // OAIAutoExportRevisionDestinationEntry_H
