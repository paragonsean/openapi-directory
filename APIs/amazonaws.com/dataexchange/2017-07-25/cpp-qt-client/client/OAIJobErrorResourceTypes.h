...
/*
 * OAIJobErrorResourceTypes.h
 *
 * 
 */

#ifndef OAIJobErrorResourceTypes_H
#define OAIJobErrorResourceTypes_H
...
class OAIJobErrorResourceTypes : public OAIEnum {
public:
    OAIJobErrorResourceTypes();
    OAIJobErrorResourceTypes(QString json);
    ~OAIJobErrorResourceTypes() override;
    ...
    enum class eOAIJobErrorResourceTypes {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        REVISION, 
        ASSET, 
        DATA_SET
    };
    OAIJobErrorResourceTypes::eOAIJobErrorResourceTypes getValue() const;
    void setValue(const OAIJobErrorResourceTypes::eOAIJobErrorResourceTypes& value);
...
private:
    ...
    eOAIJobErrorResourceTypes m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIJobErrorResourceTypes)

#endif // OAIJobErrorResourceTypes_H
