...
#ifndef OAILFResourceType_H
#define OAILFResourceType_H
...
class OAILFResourceType : public OAIEnum {
public:
    OAILFResourceType();
    OAILFResourceType(QString json);
    ~OAILFResourceType() override;
    ...
    enum class eOAILFResourceType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        TABLE, 
        DATABASE
    };
    OAILFResourceType::eOAILFResourceType getValue() const;
    void setValue(const OAILFResourceType::eOAILFResourceType& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAILFResourceType)

#endif // OAILFResourceType_H
