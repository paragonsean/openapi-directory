...
/*
 * OAIExportAssetsToS3RequestDetails.h
 *
 * Details of the operation to be performed by the job.
 */

#ifndef OAIExportAssetsToS3RequestDetails_H
#define OAIExportAssetsToS3RequestDetails_H
...
class OAIExportAssetsToS3RequestDetails : public OAIObject {
public:
    OAIExportAssetsToS3RequestDetails();
    OAIExportAssetsToS3RequestDetails(QString json);
    ~OAIExportAssetsToS3RequestDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExportAssetsToS3RequestDetails)

#endif // OAIExportAssetsToS3RequestDetails_H
