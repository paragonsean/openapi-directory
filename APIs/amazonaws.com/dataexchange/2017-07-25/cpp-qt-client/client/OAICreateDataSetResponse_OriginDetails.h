...
/*
 * OAICreateDataSetResponse_OriginDetails.h
 *
 * 
 */

#ifndef OAICreateDataSetResponse_OriginDetails_H
#define OAICreateDataSetResponse_OriginDetails_H
...
class OAICreateDataSetResponse_OriginDetails : public OAIObject {
public:
    OAICreateDataSetResponse_OriginDetails();
    OAICreateDataSetResponse_OriginDetails(QString json);
    ~OAICreateDataSetResponse_OriginDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateDataSetResponse_OriginDetails)

#endif // OAICreateDataSetResponse_OriginDetails_H
