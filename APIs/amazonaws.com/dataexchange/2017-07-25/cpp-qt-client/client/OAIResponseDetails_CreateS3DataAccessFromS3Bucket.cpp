...
OAIResponseDetails_CreateS3DataAccessFromS3Bucket::OAIResponseDetails_CreateS3DataAccessFromS3Bucket(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIResponseDetails_CreateS3DataAccessFromS3Bucket::OAIResponseDetails_CreateS3DataAccessFromS3Bucket() {
    this->initializeModel();
}

OAIResponseDetails_CreateS3DataAccessFromS3Bucket::~OAIResponseDetails_CreateS3DataAccessFromS3Bucket() {}

void OAIResponseDetails_CreateS3DataAccessFromS3Bucket::initializeModel() {
...
void OAIResponseDetails_CreateS3DataAccessFromS3Bucket::fromJson(QString jsonString) {
...
void OAIResponseDetails_CreateS3DataAccessFromS3Bucket::fromJsonObject(QJsonObject json) {
...
QString OAIResponseDetails_CreateS3DataAccessFromS3Bucket::asJson() const {
...
QJsonObject OAIResponseDetails_CreateS3DataAccessFromS3Bucket::asJsonObject() const {
    QJsonObject obj;
...
OAICreateS3DataAccessFromS3BucketResponseDetails_AssetSource OAIResponseDetails_CreateS3DataAccessFromS3Bucket::getAssetSource() const {
    return m_asset_source;
}
void OAIResponseDetails_CreateS3DataAccessFromS3Bucket::setAssetSource(const OAICreateS3DataAccessFromS3BucketResponseDetails_AssetSource &asset_source) {
    m_asset_source = asset_source;
    m_asset_source_isSet = true;
}

bool OAIResponseDetails_CreateS3DataAccessFromS3Bucket::is_asset_source_Set() const{
    return m_asset_source_isSet;
}

bool OAIResponseDetails_CreateS3DataAccessFromS3Bucket::is_asset_source_Valid() const{
    return m_asset_source_isValid;
}

QString OAIResponseDetails_CreateS3DataAccessFromS3Bucket::getDataSetId() const {
    return m_data_set_id;
}
void OAIResponseDetails_CreateS3DataAccessFromS3Bucket::setDataSetId(const QString &data_set_id) {
    m_data_set_id = data_set_id;
    m_data_set_id_isSet = true;
}

bool OAIResponseDetails_CreateS3DataAccessFromS3Bucket::is_data_set_id_Set() const{
    return m_data_set_id_isSet;
}

bool OAIResponseDetails_CreateS3DataAccessFromS3Bucket::is_data_set_id_Valid() const{
    return m_data_set_id_isValid;
}

QString OAIResponseDetails_CreateS3DataAccessFromS3Bucket::getRevisionId() const {
    return m_revision_id;
}
void OAIResponseDetails_CreateS3DataAccessFromS3Bucket::setRevisionId(const QString &revision_id) {
    m_revision_id = revision_id;
    m_revision_id_isSet = true;
}

bool OAIResponseDetails_CreateS3DataAccessFromS3Bucket::is_revision_id_Set() const{
    return m_revision_id_isSet;
}

bool OAIResponseDetails_CreateS3DataAccessFromS3Bucket::is_revision_id_Valid() const{
    return m_revision_id_isValid;
}

bool OAIResponseDetails_CreateS3DataAccessFromS3Bucket::isSet() const {
...
bool OAIResponseDetails_CreateS3DataAccessFromS3Bucket::isValid() const {
