...
OAIOriginDetails::OAIOriginDetails(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOriginDetails::OAIOriginDetails() {
    this->initializeModel();
}

OAIOriginDetails::~OAIOriginDetails() {}

void OAIOriginDetails::initializeModel() {

    m_product_id_isSet = false;
    m_product_id_isValid = false;
}

void OAIOriginDetails::fromJson(QString jsonString) {
...
void OAIOriginDetails::fromJsonObject(QJsonObject json) {

    m_product_id_isValid = ::OpenAPI::fromJsonValue(m_product_id, json[QString("ProductId")]);
    m_product_id_isSet = !json[QString("ProductId")].isNull() && m_product_id_isValid;
}

QString OAIOriginDetails::asJson() const {
...
QJsonObject OAIOriginDetails::asJsonObject() const {
    QJsonObject obj;
...
QString OAIOriginDetails::getProductId() const {
    return m_product_id;
}
void OAIOriginDetails::setProductId(const QString &product_id) {
    m_product_id = product_id;
    m_product_id_isSet = true;
}

bool OAIOriginDetails::is_product_id_Set() const{
    return m_product_id_isSet;
}

bool OAIOriginDetails::is_product_id_Valid() const{
    return m_product_id_isValid;
}

bool OAIOriginDetails::isSet() const {
...
bool OAIOriginDetails::isValid() const {
