...
/*
 * OAICreateJob_request_Details_ImportAssetFromSignedUrl.h
 *
 * 
 */

#ifndef OAICreateJob_request_Details_ImportAssetFromSignedUrl_H
#define OAICreateJob_request_Details_ImportAssetFromSignedUrl_H
...
class OAICreateJob_request_Details_ImportAssetFromSignedUrl : public OAIObject {
public:
    OAICreateJob_request_Details_ImportAssetFromSignedUrl();
    OAICreateJob_request_Details_ImportAssetFromSignedUrl(QString json);
    ~OAICreateJob_request_Details_ImportAssetFromSignedUrl() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateJob_request_Details_ImportAssetFromSignedUrl)

#endif // OAICreateJob_request_Details_ImportAssetFromSignedUrl_H
