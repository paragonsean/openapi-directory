...
/*
 * OAIRevokeRevisionRequest.h
 *
 * 
 */

#ifndef OAIRevokeRevisionRequest_H
#define OAIRevokeRevisionRequest_H
...
class OAIRevokeRevisionRequest : public OAIObject {
public:
    OAIRevokeRevisionRequest();
    OAIRevokeRevisionRequest(QString json);
    ~OAIRevokeRevisionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRevokeRevisionRequest)

#endif // OAIRevokeRevisionRequest_H
