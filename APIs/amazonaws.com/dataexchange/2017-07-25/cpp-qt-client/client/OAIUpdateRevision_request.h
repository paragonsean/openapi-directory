...
/*
 * OAIUpdateRevision_request.h
 *
 * 
 */

#ifndef OAIUpdateRevision_request_H
#define OAIUpdateRevision_request_H
...
class OAIUpdateRevision_request : public OAIObject {
public:
    OAIUpdateRevision_request();
    OAIUpdateRevision_request(QString json);
    ~OAIUpdateRevision_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateRevision_request)

#endif // OAIUpdateRevision_request_H
