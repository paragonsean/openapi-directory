...
/*
 * OAICreateJob_request_Details_ExportAssetToSignedUrl.h
 *
 * 
 */

#ifndef OAICreateJob_request_Details_ExportAssetToSignedUrl_H
#define OAICreateJob_request_Details_ExportAssetToSignedUrl_H
...
class OAICreateJob_request_Details_ExportAssetToSignedUrl : public OAIObject {
public:
    OAICreateJob_request_Details_ExportAssetToSignedUrl();
    OAICreateJob_request_Details_ExportAssetToSignedUrl(QString json);
    ~OAICreateJob_request_Details_ExportAssetToSignedUrl() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateJob_request_Details_ExportAssetToSignedUrl)

#endif // OAICreateJob_request_Details_ExportAssetToSignedUrl_H
