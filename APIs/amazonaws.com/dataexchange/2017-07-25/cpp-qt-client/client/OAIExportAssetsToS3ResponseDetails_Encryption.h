...
/*
 * OAIExportAssetsToS3ResponseDetails_Encryption.h
 *
 * 
 */

#ifndef OAIExportAssetsToS3ResponseDetails_Encryption_H
#define OAIExportAssetsToS3ResponseDetails_Encryption_H
...
class OAIExportAssetsToS3ResponseDetails_Encryption : public OAIObject {
public:
    OAIExportAssetsToS3ResponseDetails_Encryption();
    OAIExportAssetsToS3ResponseDetails_Encryption(QString json);
    ~OAIExportAssetsToS3ResponseDetails_Encryption() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExportAssetsToS3ResponseDetails_Encryption)

#endif // OAIExportAssetsToS3ResponseDetails_Encryption_H
