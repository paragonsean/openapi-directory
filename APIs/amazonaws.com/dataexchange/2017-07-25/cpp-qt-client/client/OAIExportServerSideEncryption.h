...
/*
 * OAIExportServerSideEncryption.h
 *
 * Encryption configuration of the export job. Includes the encryption type in addition to the AWS KMS key. The KMS key is only necessary if you chose the KMS encryption type.
 */

#ifndef OAIExportServerSideEncryption_H
#define OAIExportServerSideEncryption_H
...
class OAIExportServerSideEncryption : public OAIObject {
public:
    OAIExportServerSideEncryption();
    OAIExportServerSideEncryption(QString json);
    ~OAIExportServerSideEncryption() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExportServerSideEncryption)

#endif // OAIExportServerSideEncryption_H
