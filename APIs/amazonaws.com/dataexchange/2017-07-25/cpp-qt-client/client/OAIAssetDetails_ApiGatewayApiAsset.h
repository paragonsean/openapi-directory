...
/*
 * OAIAssetDetails_ApiGatewayApiAsset.h
 *
 * 
 */

#ifndef OAIAssetDetails_ApiGatewayApiAsset_H
#define OAIAssetDetails_ApiGatewayApiAsset_H
...
class OAIAssetDetails_ApiGatewayApiAsset : public OAIObject {
public:
    OAIAssetDetails_ApiGatewayApiAsset();
    OAIAssetDetails_ApiGatewayApiAsset(QString json);
    ~OAIAssetDetails_ApiGatewayApiAsset() override;
    ...
    QString getApiSpecificationDownloadUrl() const;
    void setApiSpecificationDownloadUrl(const QString &api_specification_download_url);
    bool is_api_specification_download_url_Set() const;
    bool is_api_specification_download_url_Valid() const;

    QDateTime getApiSpecificationDownloadUrlExpiresAt() const;
    void setApiSpecificationDownloadUrlExpiresAt(const QDateTime &api_specification_download_url_expires_at);
    bool is_api_specification_download_url_expires_at_Set() const;
    bool is_api_specification_download_url_expires_at_Valid() const;
...
private:
    ...
    QString m_api_specification_download_url;
    bool m_api_specification_download_url_isSet;
    bool m_api_specification_download_url_isValid;

    QDateTime m_api_specification_download_url_expires_at;
    bool m_api_specification_download_url_expires_at_isSet;
    bool m_api_specification_download_url_expires_at_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssetDetails_ApiGatewayApiAsset)

#endif // OAIAssetDetails_ApiGatewayApiAsset_H
