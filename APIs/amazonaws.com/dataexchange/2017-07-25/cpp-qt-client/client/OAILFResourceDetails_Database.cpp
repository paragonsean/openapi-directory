...
OAILFResourceDetails_Database::OAILFResourceDetails_Database(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILFResourceDetails_Database::OAILFResourceDetails_Database() {
    this->initializeModel();
}

OAILFResourceDetails_Database::~OAILFResourceDetails_Database() {}

void OAILFResourceDetails_Database::initializeModel() {

    m_expression_isSet = false;
    m_expression_isValid = false;
}

void OAILFResourceDetails_Database::fromJson(QString jsonString) {
...
void OAILFResourceDetails_Database::fromJsonObject(QJsonObject json) {
...
QString OAILFResourceDetails_Database::asJson() const {
...
QJsonObject OAILFResourceDetails_Database::asJsonObject() const {
    QJsonObject obj;
...
QList OAILFResourceDetails_Database::getExpression() const {
    return m_expression;
}
void OAILFResourceDetails_Database::setExpression(const QList &expression) {
    m_expression = expression;
    m_expression_isSet = true;
}

bool OAILFResourceDetails_Database::is_expression_Set() const{
    return m_expression_isSet;
}

bool OAILFResourceDetails_Database::is_expression_Valid() const{
    return m_expression_isValid;
}

bool OAILFResourceDetails_Database::isSet() const {
...
bool OAILFResourceDetails_Database::isValid() const {
