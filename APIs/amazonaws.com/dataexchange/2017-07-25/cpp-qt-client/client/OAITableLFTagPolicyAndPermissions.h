...
/*
 * OAITableLFTagPolicyAndPermissions.h
 *
 * The LF-tag policy and permissions that apply to table resources.
 */

#ifndef OAITableLFTagPolicyAndPermissions_H
#define OAITableLFTagPolicyAndPermissions_H
...
class OAITableLFTagPolicyAndPermissions : public OAIObject {
public:
    OAITableLFTagPolicyAndPermissions();
    OAITableLFTagPolicyAndPermissions(QString json);
    ~OAITableLFTagPolicyAndPermissions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITableLFTagPolicyAndPermissions)

#endif // OAITableLFTagPolicyAndPermissions_H
