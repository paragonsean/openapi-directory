...
#ifndef OAIOriginDetails_H
#define OAIOriginDetails_H
...
class OAIOriginDetails : public OAIObject {
public:
    OAIOriginDetails();
    OAIOriginDetails(QString json);
    ~OAIOriginDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOriginDetails)

#endif // OAIOriginDetails_H
