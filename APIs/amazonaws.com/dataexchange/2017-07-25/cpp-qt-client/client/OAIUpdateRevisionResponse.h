...
/*
 * OAIUpdateRevisionResponse.h
 *
 * 
 */

#ifndef OAIUpdateRevisionResponse_H
#define OAIUpdateRevisionResponse_H
...
class OAIUpdateRevisionResponse : public OAIObject {
public:
    OAIUpdateRevisionResponse();
    OAIUpdateRevisionResponse(QString json);
    ~OAIUpdateRevisionResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateRevisionResponse)

#endif // OAIUpdateRevisionResponse_H
