...
/*
 * OAIRevisionDestinationEntry.h
 *
 * The destination where the assets in the revision will be exported.
 */

#ifndef OAIRevisionDestinationEntry_H
#define OAIRevisionDestinationEntry_H
...
class OAIRevisionDestinationEntry : public OAIObject {
public:
    OAIRevisionDestinationEntry();
    OAIRevisionDestinationEntry(QString json);
    ~OAIRevisionDestinationEntry() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRevisionDestinationEntry)

#endif // OAIRevisionDestinationEntry_H
