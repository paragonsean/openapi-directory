...
OAIAssetDetails_S3SnapshotAsset::OAIAssetDetails_S3SnapshotAsset(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAssetDetails_S3SnapshotAsset::OAIAssetDetails_S3SnapshotAsset() {
    this->initializeModel();
}

OAIAssetDetails_S3SnapshotAsset::~OAIAssetDetails_S3SnapshotAsset() {}

void OAIAssetDetails_S3SnapshotAsset::initializeModel() {

    m_size_isSet = false;
    m_size_isValid = false;
}

void OAIAssetDetails_S3SnapshotAsset::fromJson(QString jsonString) {
...
void OAIAssetDetails_S3SnapshotAsset::fromJsonObject(QJsonObject json) {

    m_size_isValid = ::OpenAPI::fromJsonValue(m_size, json[QString("Size")]);
    m_size_isSet = !json[QString("Size")].isNull() && m_size_isValid;
}

QString OAIAssetDetails_S3SnapshotAsset::asJson() const {
...
QJsonObject OAIAssetDetails_S3SnapshotAsset::asJsonObject() const {
    QJsonObject obj;
    if (m_size_isSet) {
...
double OAIAssetDetails_S3SnapshotAsset::getSize() const {
    return m_size;
}
void OAIAssetDetails_S3SnapshotAsset::setSize(const double &size) {
    m_size = size;
    m_size_isSet = true;
}

bool OAIAssetDetails_S3SnapshotAsset::is_size_Set() const{
    return m_size_isSet;
}

bool OAIAssetDetails_S3SnapshotAsset::is_size_Valid() const{
    return m_size_isValid;
}

bool OAIAssetDetails_S3SnapshotAsset::isSet() const {
...
bool OAIAssetDetails_S3SnapshotAsset::isValid() const {
