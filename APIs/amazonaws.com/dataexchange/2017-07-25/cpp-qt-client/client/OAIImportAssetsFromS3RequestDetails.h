...
/*
 * OAIImportAssetsFromS3RequestDetails.h
 *
 * Details of the operation to be performed by the job.
 */

#ifndef OAIImportAssetsFromS3RequestDetails_H
#define OAIImportAssetsFromS3RequestDetails_H
...
class OAIImportAssetsFromS3RequestDetails : public OAIObject {
public:
    OAIImportAssetsFromS3RequestDetails();
    OAIImportAssetsFromS3RequestDetails(QString json);
    ~OAIImportAssetsFromS3RequestDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImportAssetsFromS3RequestDetails)

#endif // OAIImportAssetsFromS3RequestDetails_H
