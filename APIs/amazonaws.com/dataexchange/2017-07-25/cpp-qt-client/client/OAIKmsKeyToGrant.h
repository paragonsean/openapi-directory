...
#ifndef OAIKmsKeyToGrant_H
#define OAIKmsKeyToGrant_H
...
class OAIKmsKeyToGrant : public OAIObject {
public:
    OAIKmsKeyToGrant();
    OAIKmsKeyToGrant(QString json);
    ~OAIKmsKeyToGrant() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIKmsKeyToGrant)

#endif // OAIKmsKeyToGrant_H
