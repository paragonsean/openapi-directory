...
/*
 * OAIDatabaseLFTagPolicy.h
 *
 * The LF-tag policy for database resources.
 */

#ifndef OAIDatabaseLFTagPolicy_H
#define OAIDatabaseLFTagPolicy_H
...
class OAIDatabaseLFTagPolicy : public OAIObject {
public:
    OAIDatabaseLFTagPolicy();
    OAIDatabaseLFTagPolicy(QString json);
    ~OAIDatabaseLFTagPolicy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDatabaseLFTagPolicy)

#endif // OAIDatabaseLFTagPolicy_H
