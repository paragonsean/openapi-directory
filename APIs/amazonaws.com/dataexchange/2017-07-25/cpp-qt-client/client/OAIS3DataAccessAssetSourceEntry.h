...
/*
 * OAIS3DataAccessAssetSourceEntry.h
 *
 * Source details for an Amazon S3 data access asset.
 */

#ifndef OAIS3DataAccessAssetSourceEntry_H
#define OAIS3DataAccessAssetSourceEntry_H
...
class OAIS3DataAccessAssetSourceEntry : public OAIObject {
public:
    OAIS3DataAccessAssetSourceEntry();
    OAIS3DataAccessAssetSourceEntry(QString json);
    ~OAIS3DataAccessAssetSourceEntry() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIS3DataAccessAssetSourceEntry)

#endif // OAIS3DataAccessAssetSourceEntry_H
