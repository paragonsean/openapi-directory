...
/*
 * OAIResponseDetails_ImportAssetFromApiGatewayApi.h
 *
 * 
 */

#ifndef OAIResponseDetails_ImportAssetFromApiGatewayApi_H
#define OAIResponseDetails_ImportAssetFromApiGatewayApi_H
...
class OAIResponseDetails_ImportAssetFromApiGatewayApi : public OAIObject {
public:
    OAIResponseDetails_ImportAssetFromApiGatewayApi();
    OAIResponseDetails_ImportAssetFromApiGatewayApi(QString json);
    ~OAIResponseDetails_ImportAssetFromApiGatewayApi() override;
    ...
    QString getApiSpecificationUploadUrl() const;
    void setApiSpecificationUploadUrl(const QString &api_specification_upload_url);
    bool is_api_specification_upload_url_Set() const;
    bool is_api_specification_upload_url_Valid() const;

    QDateTime getApiSpecificationUploadUrlExpiresAt() const;
    void setApiSpecificationUploadUrlExpiresAt(const QDateTime &api_specification_upload_url_expires_at);
    bool is_api_specification_upload_url_expires_at_Set() const;
    bool is_api_specification_upload_url_expires_at_Valid() const;
...
private:
    ...
    QString m_api_specification_upload_url;
    bool m_api_specification_upload_url_isSet;
    bool m_api_specification_upload_url_isValid;

    QDateTime m_api_specification_upload_url_expires_at;
    bool m_api_specification_upload_url_expires_at_isSet;
    bool m_api_specification_upload_url_expires_at_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResponseDetails_ImportAssetFromApiGatewayApi)

#endif // OAIResponseDetails_ImportAssetFromApiGatewayApi_H
