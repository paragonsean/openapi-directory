...
/*
 * OAIUpdateEventActionRequest.h
 *
 * 
 */

#ifndef OAIUpdateEventActionRequest_H
#define OAIUpdateEventActionRequest_H
...
class OAIUpdateEventActionRequest : public OAIObject {
public:
    OAIUpdateEventActionRequest();
    OAIUpdateEventActionRequest(QString json);
    ~OAIUpdateEventActionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateEventActionRequest)

#endif // OAIUpdateEventActionRequest_H
