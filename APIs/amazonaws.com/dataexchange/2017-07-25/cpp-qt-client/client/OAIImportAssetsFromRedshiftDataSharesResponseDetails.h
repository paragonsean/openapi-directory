...
/*
 * OAIImportAssetsFromRedshiftDataSharesResponseDetails.h
 *
 * Details from an import from Amazon Redshift datashare response.
 */

#ifndef OAIImportAssetsFromRedshiftDataSharesResponseDetails_H
#define OAIImportAssetsFromRedshiftDataSharesResponseDetails_H
...
class OAIImportAssetsFromRedshiftDataSharesResponseDetails : public OAIObject {
public:
    OAIImportAssetsFromRedshiftDataSharesResponseDetails();
    OAIImportAssetsFromRedshiftDataSharesResponseDetails(QString json);
    ~OAIImportAssetsFromRedshiftDataSharesResponseDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImportAssetsFromRedshiftDataSharesResponseDetails)

#endif // OAIImportAssetsFromRedshiftDataSharesResponseDetails_H
