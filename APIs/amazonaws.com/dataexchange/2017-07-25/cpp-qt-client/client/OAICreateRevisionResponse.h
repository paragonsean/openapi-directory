...
/*
 * OAICreateRevisionResponse.h
 *
 * 
 */

#ifndef OAICreateRevisionResponse_H
#define OAICreateRevisionResponse_H
...
class OAICreateRevisionResponse : public OAIObject {
public:
    OAICreateRevisionResponse();
    OAICreateRevisionResponse(QString json);
    ~OAICreateRevisionResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateRevisionResponse)

#endif // OAICreateRevisionResponse_H
