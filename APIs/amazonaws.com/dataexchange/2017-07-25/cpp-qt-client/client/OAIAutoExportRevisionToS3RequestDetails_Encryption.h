...
/*
 * OAIAutoExportRevisionToS3RequestDetails_Encryption.h
 *
 * 
 */

#ifndef OAIAutoExportRevisionToS3RequestDetails_Encryption_H
#define OAIAutoExportRevisionToS3RequestDetails_Encryption_H
...
class OAIAutoExportRevisionToS3RequestDetails_Encryption : public OAIObject {
public:
    OAIAutoExportRevisionToS3RequestDetails_Encryption();
    OAIAutoExportRevisionToS3RequestDetails_Encryption(QString json);
    ~OAIAutoExportRevisionToS3RequestDetails_Encryption() override;
    ...
    OAIServerSideEncryptionTypes getType() const;
    void setType(const OAIServerSideEncryptionTypes &type);
...
private:
    ...
    OAIServerSideEncryptionTypes m_type;
    bool m_type_isSet;
    bool m_type_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAIAutoExportRevisionToS3RequestDetails_Encryption)

#endif // OAIAutoExportRevisionToS3RequestDetails_Encryption_H
