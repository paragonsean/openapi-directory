...
/*
 * OAICreateS3DataAccessFromS3BucketResponseDetails.h
 *
 * Details about the response of the operation to create an S3 data access from an S3 bucket.
 */

#ifndef OAICreateS3DataAccessFromS3BucketResponseDetails_H
#define OAICreateS3DataAccessFromS3BucketResponseDetails_H
...
class OAICreateS3DataAccessFromS3BucketResponseDetails : public OAIObject {
public:
    OAICreateS3DataAccessFromS3BucketResponseDetails();
    OAICreateS3DataAccessFromS3BucketResponseDetails(QString json);
    ~OAICreateS3DataAccessFromS3BucketResponseDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateS3DataAccessFromS3BucketResponseDetails)

#endif // OAICreateS3DataAccessFromS3BucketResponseDetails_H
