...
QString OAIUpdateDataSetRequest::getDescription() const {
    return m_description;
}
void OAIUpdateDataSetRequest::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIUpdateDataSetRequest::is_description_Set() const{
    return m_description_isSet;
}

bool OAIUpdateDataSetRequest::is_description_Valid() const{
