...
/*
 * OAISendApiAssetRequest.h
 *
 * 
 */

#ifndef OAISendApiAssetRequest_H
#define OAISendApiAssetRequest_H
...
class OAISendApiAssetRequest : public OAIObject {
public:
    OAISendApiAssetRequest();
    OAISendApiAssetRequest(QString json);
    ~OAISendApiAssetRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISendApiAssetRequest)

#endif // OAISendApiAssetRequest_H
