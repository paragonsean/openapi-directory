...
/*
 * OAIImportAssetsFromLakeFormationTagPolicyRequestDetails.h
 *
 * Details about the assets imported from an AWS Lake Formation tag policy request.
 */

#ifndef OAIImportAssetsFromLakeFormationTagPolicyRequestDetails_H
#define OAIImportAssetsFromLakeFormationTagPolicyRequestDetails_H
...
class OAIImportAssetsFromLakeFormationTagPolicyRequestDetails : public OAIObject {
public:
    OAIImportAssetsFromLakeFormationTagPolicyRequestDetails();
    OAIImportAssetsFromLakeFormationTagPolicyRequestDetails(QString json);
    ~OAIImportAssetsFromLakeFormationTagPolicyRequestDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImportAssetsFromLakeFormationTagPolicyRequestDetails)

#endif // OAIImportAssetsFromLakeFormationTagPolicyRequestDetails_H
