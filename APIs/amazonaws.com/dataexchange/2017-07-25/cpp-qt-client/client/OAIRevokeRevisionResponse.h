...
/*
 * OAIRevokeRevisionResponse.h
 *
 * 
 */

#ifndef OAIRevokeRevisionResponse_H
#define OAIRevokeRevisionResponse_H
...
class OAIRevokeRevisionResponse : public OAIObject {
public:
    OAIRevokeRevisionResponse();
    OAIRevokeRevisionResponse(QString json);
    ~OAIRevokeRevisionResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRevokeRevisionResponse)

#endif // OAIRevokeRevisionResponse_H
