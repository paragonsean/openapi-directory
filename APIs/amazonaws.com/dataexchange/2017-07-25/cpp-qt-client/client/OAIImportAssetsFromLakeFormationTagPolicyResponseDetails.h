...
/*
 * OAIImportAssetsFromLakeFormationTagPolicyResponseDetails.h
 *
 * Details from an import AWS Lake Formation tag policy job response.
 */

#ifndef OAIImportAssetsFromLakeFormationTagPolicyResponseDetails_H
#define OAIImportAssetsFromLakeFormationTagPolicyResponseDetails_H
...
class OAIImportAssetsFromLakeFormationTagPolicyResponseDetails : public OAIObject {
public:
    OAIImportAssetsFromLakeFormationTagPolicyResponseDetails();
    OAIImportAssetsFromLakeFormationTagPolicyResponseDetails(QString json);
    ~OAIImportAssetsFromLakeFormationTagPolicyResponseDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImportAssetsFromLakeFormationTagPolicyResponseDetails)

#endif // OAIImportAssetsFromLakeFormationTagPolicyResponseDetails_H
