...
#ifndef OAIAssetDetails_H
#define OAIAssetDetails_H
...
class OAIAssetDetails : public OAIObject {
public:
    OAIAssetDetails();
    OAIAssetDetails(QString json);
    ~OAIAssetDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssetDetails)

#endif // OAIAssetDetails_H
