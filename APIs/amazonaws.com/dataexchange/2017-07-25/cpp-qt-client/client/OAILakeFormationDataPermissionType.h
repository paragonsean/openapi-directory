...
/*
 * OAILakeFormationDataPermissionType.h
 *
 * 
 */

#ifndef OAILakeFormationDataPermissionType_H
#define OAILakeFormationDataPermissionType_H
...
class OAILakeFormationDataPermissionType : public OAIEnum {
public:
    OAILakeFormationDataPermissionType();
    OAILakeFormationDataPermissionType(QString json);
    ~OAILakeFormationDataPermissionType() override;
    ...
    enum class eOAILakeFormationDataPermissionType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        LFTAGPOLICY
    };
    OAILakeFormationDataPermissionType::eOAILakeFormationDataPermissionType getValue() const;
    void setValue(const OAILakeFormationDataPermissionType::eOAILakeFormationDataPermissionType& value);
...
private:
    ...
    eOAILakeFormationDataPermissionType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAILakeFormationDataPermissionType)

#endif // OAILakeFormationDataPermissionType_H
