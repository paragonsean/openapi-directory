...
OAIS3SnapshotAsset::OAIS3SnapshotAsset(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIS3SnapshotAsset::OAIS3SnapshotAsset() {
    this->initializeModel();
}

OAIS3SnapshotAsset::~OAIS3SnapshotAsset() {}

void OAIS3SnapshotAsset::initializeModel() {

    m_size_isSet = false;
    m_size_isValid = false;
}

void OAIS3SnapshotAsset::fromJson(QString jsonString) {
...
void OAIS3SnapshotAsset::fromJsonObject(QJsonObject json) {

    m_size_isValid = ::OpenAPI::fromJsonValue(m_size, json[QString("Size")]);
    m_size_isSet = !json[QString("Size")].isNull() && m_size_isValid;
}

QString OAIS3SnapshotAsset::asJson() const {
...
QJsonObject OAIS3SnapshotAsset::asJsonObject() const {
    QJsonObject obj;
    if (m_size_isSet) {
...
double OAIS3SnapshotAsset::getSize() const {
    return m_size;
}
void OAIS3SnapshotAsset::setSize(const double &size) {
    m_size = size;
    m_size_isSet = true;
}

bool OAIS3SnapshotAsset::is_size_Set() const{
    return m_size_isSet;
}

bool OAIS3SnapshotAsset::is_size_Valid() const{
    return m_size_isValid;
}

bool OAIS3SnapshotAsset::isSet() const {
...
bool OAIS3SnapshotAsset::isValid() const {
