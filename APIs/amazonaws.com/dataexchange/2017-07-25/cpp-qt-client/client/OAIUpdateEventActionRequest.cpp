...
#include "OAIUpdateEventActionRequest.h"
...
OAIUpdateEventActionRequest::OAIUpdateEventActionRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateEventActionRequest::OAIUpdateEventActionRequest() {
    this->initializeModel();
}

OAIUpdateEventActionRequest::~OAIUpdateEventActionRequest() {}

void OAIUpdateEventActionRequest::initializeModel() {

    m_action_isSet = false;
    m_action_isValid = false;
}

void OAIUpdateEventActionRequest::fromJson(QString jsonString) {
...
void OAIUpdateEventActionRequest::fromJsonObject(QJsonObject json) {

    m_action_isValid = ::OpenAPI::fromJsonValue(m_action, json[QString("Action")]);
    m_action_isSet = !json[QString("Action")].isNull() && m_action_isValid;
}

QString OAIUpdateEventActionRequest::asJson() const {
...
QJsonObject OAIUpdateEventActionRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_action.isSet()) {
...
OAICreateEventActionResponse_Action OAIUpdateEventActionRequest::getAction() const {
    return m_action;
}
void OAIUpdateEventActionRequest::setAction(const OAICreateEventActionResponse_Action &action) {
    m_action = action;
    m_action_isSet = true;
}

bool OAIUpdateEventActionRequest::is_action_Set() const{
    return m_action_isSet;
}

bool OAIUpdateEventActionRequest::is_action_Valid() const{
    return m_action_isValid;
}

bool OAIUpdateEventActionRequest::isSet() const {
...
bool OAIUpdateEventActionRequest::isValid() const {
