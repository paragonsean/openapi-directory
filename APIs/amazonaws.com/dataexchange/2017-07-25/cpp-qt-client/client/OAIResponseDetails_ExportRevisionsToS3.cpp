...
OAIResponseDetails_ExportRevisionsToS3::OAIResponseDetails_ExportRevisionsToS3(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIResponseDetails_ExportRevisionsToS3::OAIResponseDetails_ExportRevisionsToS3() {
    this->initializeModel();
}

OAIResponseDetails_ExportRevisionsToS3::~OAIResponseDetails_ExportRevisionsToS3() {}

void OAIResponseDetails_ExportRevisionsToS3::initializeModel() {
...
void OAIResponseDetails_ExportRevisionsToS3::fromJson(QString jsonString) {
...
void OAIResponseDetails_ExportRevisionsToS3::fromJsonObject(QJsonObject json) {
...
QString OAIResponseDetails_ExportRevisionsToS3::asJson() const {
...
QJsonObject OAIResponseDetails_ExportRevisionsToS3::asJsonObject() const {
    QJsonObject obj;
...
QString OAIResponseDetails_ExportRevisionsToS3::getDataSetId() const {
    return m_data_set_id;
}
void OAIResponseDetails_ExportRevisionsToS3::setDataSetId(const QString &data_set_id) {
    m_data_set_id = data_set_id;
    m_data_set_id_isSet = true;
}

bool OAIResponseDetails_ExportRevisionsToS3::is_data_set_id_Set() const{
    return m_data_set_id_isSet;
}

bool OAIResponseDetails_ExportRevisionsToS3::is_data_set_id_Valid() const{
    return m_data_set_id_isValid;
}

OAIExportAssetsToS3ResponseDetails_Encryption OAIResponseDetails_ExportRevisionsToS3::getEncryption() const {
    return m_encryption;
}
void OAIResponseDetails_ExportRevisionsToS3::setEncryption(const OAIExportAssetsToS3ResponseDetails_Encryption &encryption) {
    m_encryption = encryption;
    m_encryption_isSet = true;
}

bool OAIResponseDetails_ExportRevisionsToS3::is_encryption_Set() const{
    return m_encryption_isSet;
}

bool OAIResponseDetails_ExportRevisionsToS3::is_encryption_Valid() const{
    return m_encryption_isValid;
}

QList OAIResponseDetails_ExportRevisionsToS3::getRevisionDestinations() const {
    return m_revision_destinations;
}
void OAIResponseDetails_ExportRevisionsToS3::setRevisionDestinations(const QList &revision_destinations) {
    m_revision_destinations = revision_destinations;
    m_revision_destinations_isSet = true;
}

bool OAIResponseDetails_ExportRevisionsToS3::is_revision_destinations_Set() const{
    return m_revision_destinations_isSet;
}

bool OAIResponseDetails_ExportRevisionsToS3::is_revision_destinations_Valid() const{
    return m_revision_destinations_isValid;
}

QString OAIResponseDetails_ExportRevisionsToS3::getEventActionArn() const {
    return m_event_action_arn;
}
void OAIResponseDetails_ExportRevisionsToS3::setEventActionArn(const QString &event_action_arn) {
    m_event_action_arn = event_action_arn;
    m_event_action_arn_isSet = true;
}

bool OAIResponseDetails_ExportRevisionsToS3::is_event_action_arn_Set() const{
    return m_event_action_arn_isSet;
}

bool OAIResponseDetails_ExportRevisionsToS3::is_event_action_arn_Valid() const{
    return m_event_action_arn_isValid;
}

bool OAIResponseDetails_ExportRevisionsToS3::isSet() const {
...
bool OAIResponseDetails_ExportRevisionsToS3::isValid() const {
