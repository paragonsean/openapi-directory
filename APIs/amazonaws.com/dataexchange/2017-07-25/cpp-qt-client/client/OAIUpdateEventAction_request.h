...
/*
 * OAIUpdateEventAction_request.h
 *
 * 
 */

#ifndef OAIUpdateEventAction_request_H
#define OAIUpdateEventAction_request_H
...
class OAIUpdateEventAction_request : public OAIObject {
public:
    OAIUpdateEventAction_request();
    OAIUpdateEventAction_request(QString json);
    ~OAIUpdateEventAction_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateEventAction_request)

#endif // OAIUpdateEventAction_request_H
