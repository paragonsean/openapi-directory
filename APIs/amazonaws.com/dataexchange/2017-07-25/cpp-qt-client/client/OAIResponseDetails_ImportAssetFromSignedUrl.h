...
/*
 * OAIResponseDetails_ImportAssetFromSignedUrl.h
 *
 * 
 */

#ifndef OAIResponseDetails_ImportAssetFromSignedUrl_H
#define OAIResponseDetails_ImportAssetFromSignedUrl_H
...
class OAIResponseDetails_ImportAssetFromSignedUrl : public OAIObject {
public:
    OAIResponseDetails_ImportAssetFromSignedUrl();
    OAIResponseDetails_ImportAssetFromSignedUrl(QString json);
    ~OAIResponseDetails_ImportAssetFromSignedUrl() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResponseDetails_ImportAssetFromSignedUrl)

#endif // OAIResponseDetails_ImportAssetFromSignedUrl_H
