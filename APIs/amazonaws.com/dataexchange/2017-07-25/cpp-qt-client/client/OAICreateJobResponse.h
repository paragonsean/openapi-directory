...
#include "OAICreateJobResponse_Details.h"
#include "OAIState.h"
#include "OAIType.h"
#include <QDateTime>
#include <QList>
...
namespace OpenAPI {
class OAICreateJobResponse_Details;
...
public:
    ...
    OAICreateJobResponse_Details getDetails() const;
    void setDetails(const OAICreateJobResponse_Details &details);
...
private:
    ...
    OAICreateJobResponse_Details m_details;
