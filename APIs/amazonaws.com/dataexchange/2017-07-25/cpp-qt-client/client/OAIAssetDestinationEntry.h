...
/*
 * OAIAssetDestinationEntry.h
 *
 * The destination for the asset.
 */

#ifndef OAIAssetDestinationEntry_H
#define OAIAssetDestinationEntry_H
...
class OAIAssetDestinationEntry : public OAIObject {
public:
    OAIAssetDestinationEntry();
    OAIAssetDestinationEntry(QString json);
    ~OAIAssetDestinationEntry() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssetDestinationEntry)

#endif // OAIAssetDestinationEntry_H
