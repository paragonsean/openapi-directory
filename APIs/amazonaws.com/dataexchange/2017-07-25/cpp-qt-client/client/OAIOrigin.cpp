...
QString OAIOrigin::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIOrigin::OWNED:
            val = "OWNED";
            break;
        case eOAIOrigin::ENTITLED:
            val = "ENTITLED";
            break;
        default:
            break;
...
QJsonValue OAIOrigin::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIOrigin::eOAIOrigin OAIOrigin::getValue() const {
    return m_value;
}

void OAIOrigin::setValue(const OAIOrigin::eOAIOrigin& value){
    m_value = value;
    m_value_isSet = true;
}
