...
namespace OpenAPI {
class OAICreateJob_request_Details;
...
public:
    ...
    OAICreateJob_request_Details getDetails() const;
    void setDetails(const OAICreateJob_request_Details &details);
...
private:
    ...
    OAICreateJob_request_Details m_details;
