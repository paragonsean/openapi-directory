...
/*
 * OAILakeFormationDataPermissionAsset.h
 *
 * The AWS Lake Formation data permission asset.
 */

#ifndef OAILakeFormationDataPermissionAsset_H
#define OAILakeFormationDataPermissionAsset_H
...
class OAILakeFormationDataPermissionAsset : public OAIObject {
public:
    OAILakeFormationDataPermissionAsset();
    OAILakeFormationDataPermissionAsset(QString json);
    ~OAILakeFormationDataPermissionAsset() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILakeFormationDataPermissionAsset)

#endif // OAILakeFormationDataPermissionAsset_H
