...
/*
 * OAIImportAssetFromApiGatewayApiRequestDetails.h
 *
 * The request details.
 */

#ifndef OAIImportAssetFromApiGatewayApiRequestDetails_H
#define OAIImportAssetFromApiGatewayApiRequestDetails_H
...
class OAIImportAssetFromApiGatewayApiRequestDetails : public OAIObject {
public:
    OAIImportAssetFromApiGatewayApiRequestDetails();
    OAIImportAssetFromApiGatewayApiRequestDetails(QString json);
    ~OAIImportAssetFromApiGatewayApiRequestDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImportAssetFromApiGatewayApiRequestDetails)

#endif // OAIImportAssetFromApiGatewayApiRequestDetails_H
