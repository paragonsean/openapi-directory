...
/*
 * OAIAssetSourceEntry.h
 *
 * The source of the assets.
 */

#ifndef OAIAssetSourceEntry_H
#define OAIAssetSourceEntry_H
...
class OAIAssetSourceEntry : public OAIObject {
public:
    OAIAssetSourceEntry();
    OAIAssetSourceEntry(QString json);
    ~OAIAssetSourceEntry() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssetSourceEntry)

#endif // OAIAssetSourceEntry_H
