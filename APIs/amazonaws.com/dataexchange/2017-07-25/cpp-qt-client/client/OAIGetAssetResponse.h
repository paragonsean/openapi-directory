...
/*
 * OAIGetAssetResponse.h
 *
 * 
 */

#ifndef OAIGetAssetResponse_H
#define OAIGetAssetResponse_H
...
class OAIGetAssetResponse : public OAIObject {
public:
    OAIGetAssetResponse();
    OAIGetAssetResponse(QString json);
    ~OAIGetAssetResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetAssetResponse)

#endif // OAIGetAssetResponse_H
