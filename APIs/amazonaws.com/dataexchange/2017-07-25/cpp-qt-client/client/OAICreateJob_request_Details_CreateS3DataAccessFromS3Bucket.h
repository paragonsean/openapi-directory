...
/*
 * OAICreateJob_request_Details_CreateS3DataAccessFromS3Bucket.h
 *
 * 
 */

#ifndef OAICreateJob_request_Details_CreateS3DataAccessFromS3Bucket_H
#define OAICreateJob_request_Details_CreateS3DataAccessFromS3Bucket_H
...
class OAICreateJob_request_Details_CreateS3DataAccessFromS3Bucket : public OAIObject {
public:
    OAICreateJob_request_Details_CreateS3DataAccessFromS3Bucket();
    OAICreateJob_request_Details_CreateS3DataAccessFromS3Bucket(QString json);
    ~OAICreateJob_request_Details_CreateS3DataAccessFromS3Bucket() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateJob_request_Details_CreateS3DataAccessFromS3Bucket)

#endif // OAICreateJob_request_Details_CreateS3DataAccessFromS3Bucket_H
