...
/*
 * OAIGetRevisionResponse.h
 *
 * 
 */

#ifndef OAIGetRevisionResponse_H
#define OAIGetRevisionResponse_H
...
class OAIGetRevisionResponse : public OAIObject {
public:
    OAIGetRevisionResponse();
    OAIGetRevisionResponse(QString json);
    ~OAIGetRevisionResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetRevisionResponse)

#endif // OAIGetRevisionResponse_H
