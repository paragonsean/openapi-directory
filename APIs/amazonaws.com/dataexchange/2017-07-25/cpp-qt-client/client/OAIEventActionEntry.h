...
#ifndef OAIEventActionEntry_H
#define OAIEventActionEntry_H
...
class OAIEventActionEntry : public OAIObject {
public:
    OAIEventActionEntry();
    OAIEventActionEntry(QString json);
    ~OAIEventActionEntry() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEventActionEntry)

#endif // OAIEventActionEntry_H
