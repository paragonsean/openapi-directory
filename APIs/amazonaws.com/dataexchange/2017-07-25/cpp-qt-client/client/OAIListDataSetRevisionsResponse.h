...
/*
 * OAIListDataSetRevisionsResponse.h
 *
 * 
 */

#ifndef OAIListDataSetRevisionsResponse_H
#define OAIListDataSetRevisionsResponse_H
...
class OAIListDataSetRevisionsResponse : public OAIObject {
public:
    OAIListDataSetRevisionsResponse();
    OAIListDataSetRevisionsResponse(QString json);
    ~OAIListDataSetRevisionsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListDataSetRevisionsResponse)

#endif // OAIListDataSetRevisionsResponse_H
