...
/*
 * OAIAutoExportRevisionToS3RequestDetails_RevisionDestination.h
 *
 * 
 */

#ifndef OAIAutoExportRevisionToS3RequestDetails_RevisionDestination_H
#define OAIAutoExportRevisionToS3RequestDetails_RevisionDestination_H
...
class OAIAutoExportRevisionToS3RequestDetails_RevisionDestination : public OAIObject {
public:
    OAIAutoExportRevisionToS3RequestDetails_RevisionDestination();
    OAIAutoExportRevisionToS3RequestDetails_RevisionDestination(QString json);
    ~OAIAutoExportRevisionToS3RequestDetails_RevisionDestination() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAutoExportRevisionToS3RequestDetails_RevisionDestination)

#endif // OAIAutoExportRevisionToS3RequestDetails_RevisionDestination_H
