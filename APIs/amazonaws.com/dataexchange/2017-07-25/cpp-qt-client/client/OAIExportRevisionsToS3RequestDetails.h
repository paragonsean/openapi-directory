...
/*
 * OAIExportRevisionsToS3RequestDetails.h
 *
 * Details of the operation to be performed by the job.
 */

#ifndef OAIExportRevisionsToS3RequestDetails_H
#define OAIExportRevisionsToS3RequestDetails_H
...
class OAIExportRevisionsToS3RequestDetails : public OAIObject {
public:
    OAIExportRevisionsToS3RequestDetails();
    OAIExportRevisionsToS3RequestDetails(QString json);
    ~OAIExportRevisionsToS3RequestDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExportRevisionsToS3RequestDetails)

#endif // OAIExportRevisionsToS3RequestDetails_H
