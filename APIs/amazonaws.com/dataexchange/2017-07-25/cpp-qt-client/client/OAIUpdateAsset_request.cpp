...
QString OAIUpdateAsset_request::getName() const {
    return m_name;
}
void OAIUpdateAsset_request::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIUpdateAsset_request::is_name_Set() const{
    return m_name_isSet;
}

bool OAIUpdateAsset_request::is_name_Valid() const{
