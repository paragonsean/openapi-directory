...
/*
 * OAICreateRevisionRequest.h
 *
 * 
 */

#ifndef OAICreateRevisionRequest_H
#define OAICreateRevisionRequest_H
...
class OAICreateRevisionRequest : public OAIObject {
public:
    OAICreateRevisionRequest();
    OAICreateRevisionRequest(QString json);
    ~OAICreateRevisionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateRevisionRequest)

#endif // OAICreateRevisionRequest_H
