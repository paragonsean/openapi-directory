...
/*
 * OAILFTagPolicyDetails_ResourceDetails.h
 *
 * 
 */

#ifndef OAILFTagPolicyDetails_ResourceDetails_H
#define OAILFTagPolicyDetails_ResourceDetails_H
...
class OAILFTagPolicyDetails_ResourceDetails : public OAIObject {
public:
    OAILFTagPolicyDetails_ResourceDetails();
    OAILFTagPolicyDetails_ResourceDetails(QString json);
    ~OAILFTagPolicyDetails_ResourceDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILFTagPolicyDetails_ResourceDetails)

#endif // OAILFTagPolicyDetails_ResourceDetails_H
