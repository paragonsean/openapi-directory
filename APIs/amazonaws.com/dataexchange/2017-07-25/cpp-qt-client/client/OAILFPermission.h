...
#ifndef OAILFPermission_H
#define OAILFPermission_H
...
class OAILFPermission : public OAIEnum {
public:
    OAILFPermission();
    OAILFPermission(QString json);
    ~OAILFPermission() override;
    ...
    enum class eOAILFPermission {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        DESCRIBE, 
        SELECT
    };
    OAILFPermission::eOAILFPermission getValue() const;
    void setValue(const OAILFPermission::eOAILFPermission& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAILFPermission)

#endif // OAILFPermission_H
