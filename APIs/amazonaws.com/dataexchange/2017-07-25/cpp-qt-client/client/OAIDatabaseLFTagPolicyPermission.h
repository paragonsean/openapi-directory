...
/*
 * OAIDatabaseLFTagPolicyPermission.h
 *
 * 
 */

#ifndef OAIDatabaseLFTagPolicyPermission_H
#define OAIDatabaseLFTagPolicyPermission_H
...
class OAIDatabaseLFTagPolicyPermission : public OAIEnum {
public:
    OAIDatabaseLFTagPolicyPermission();
    OAIDatabaseLFTagPolicyPermission(QString json);
    ~OAIDatabaseLFTagPolicyPermission() override;
    ...
    enum class eOAIDatabaseLFTagPolicyPermission {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        DESCRIBE
    };
    OAIDatabaseLFTagPolicyPermission::eOAIDatabaseLFTagPolicyPermission getValue() const;
    void setValue(const OAIDatabaseLFTagPolicyPermission::eOAIDatabaseLFTagPolicyPermission& value);
...
private:
    ...
    eOAIDatabaseLFTagPolicyPermission m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDatabaseLFTagPolicyPermission)

#endif // OAIDatabaseLFTagPolicyPermission_H
