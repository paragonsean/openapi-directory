...
/*
 * OAIRedshiftDataShareAsset.h
 *
 * The Amazon Redshift datashare asset.
 */

#ifndef OAIRedshiftDataShareAsset_H
#define OAIRedshiftDataShareAsset_H
...
class OAIRedshiftDataShareAsset : public OAIObject {
public:
    OAIRedshiftDataShareAsset();
    OAIRedshiftDataShareAsset(QString json);
    ~OAIRedshiftDataShareAsset() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRedshiftDataShareAsset)

#endif // OAIRedshiftDataShareAsset_H
