...
/*
 * OAIS3SnapshotAsset.h
 *
 * The Amazon S3 object that is the asset.
 */

#ifndef OAIS3SnapshotAsset_H
#define OAIS3SnapshotAsset_H
...
class OAIS3SnapshotAsset : public OAIObject {
public:
    OAIS3SnapshotAsset();
    OAIS3SnapshotAsset(QString json);
    ~OAIS3SnapshotAsset() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIS3SnapshotAsset)

#endif // OAIS3SnapshotAsset_H
