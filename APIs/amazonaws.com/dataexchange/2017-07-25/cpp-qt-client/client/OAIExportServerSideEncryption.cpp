...
#include "OAIExportServerSideEncryption.h"
...
OAIExportServerSideEncryption::OAIExportServerSideEncryption(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIExportServerSideEncryption::OAIExportServerSideEncryption() {
    this->initializeModel();
}

OAIExportServerSideEncryption::~OAIExportServerSideEncryption() {}

void OAIExportServerSideEncryption::initializeModel() {
...
void OAIExportServerSideEncryption::fromJson(QString jsonString) {
...
void OAIExportServerSideEncryption::fromJsonObject(QJsonObject json) {
...
QString OAIExportServerSideEncryption::asJson() const {
...
QJsonObject OAIExportServerSideEncryption::asJsonObject() const {
    QJsonObject obj;
...
QString OAIExportServerSideEncryption::getKmsKeyArn() const {
    return m_kms_key_arn;
}
void OAIExportServerSideEncryption::setKmsKeyArn(const QString &kms_key_arn) {
    m_kms_key_arn = kms_key_arn;
    m_kms_key_arn_isSet = true;
}

bool OAIExportServerSideEncryption::is_kms_key_arn_Set() const{
    return m_kms_key_arn_isSet;
}

bool OAIExportServerSideEncryption::is_kms_key_arn_Valid() const{
    return m_kms_key_arn_isValid;
}

OAIServerSideEncryptionTypes OAIExportServerSideEncryption::getType() const {
    return m_type;
}
void OAIExportServerSideEncryption::setType(const OAIServerSideEncryptionTypes &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIExportServerSideEncryption::is_type_Set() const{
    return m_type_isSet;
}

bool OAIExportServerSideEncryption::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIExportServerSideEncryption::isSet() const {
...
bool OAIExportServerSideEncryption::isValid() const {
