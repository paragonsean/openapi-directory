...
/*
 * OAITableTagPolicyLFPermission.h
 *
 * 
 */

#ifndef OAITableTagPolicyLFPermission_H
#define OAITableTagPolicyLFPermission_H
...
class OAITableTagPolicyLFPermission : public OAIEnum {
public:
    OAITableTagPolicyLFPermission();
    OAITableTagPolicyLFPermission(QString json);
    ~OAITableTagPolicyLFPermission() override;
    ...
    enum class eOAITableTagPolicyLFPermission {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        DESCRIBE, 
        SELECT
    };
    OAITableTagPolicyLFPermission::eOAITableTagPolicyLFPermission getValue() const;
    void setValue(const OAITableTagPolicyLFPermission::eOAITableTagPolicyLFPermission& value);
...
private:
    ...
    eOAITableTagPolicyLFPermission m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAITableTagPolicyLFPermission)

#endif // OAITableTagPolicyLFPermission_H
