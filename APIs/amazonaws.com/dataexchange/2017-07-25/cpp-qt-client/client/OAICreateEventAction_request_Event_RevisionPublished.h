...
/*
 * OAICreateEventAction_request_Event_RevisionPublished.h
 *
 * 
 */

#ifndef OAICreateEventAction_request_Event_RevisionPublished_H
#define OAICreateEventAction_request_Event_RevisionPublished_H
...
class OAICreateEventAction_request_Event_RevisionPublished : public OAIObject {
public:
    OAICreateEventAction_request_Event_RevisionPublished();
    OAICreateEventAction_request_Event_RevisionPublished(QString json);
    ~OAICreateEventAction_request_Event_RevisionPublished() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateEventAction_request_Event_RevisionPublished)

#endif // OAICreateEventAction_request_Event_RevisionPublished_H
