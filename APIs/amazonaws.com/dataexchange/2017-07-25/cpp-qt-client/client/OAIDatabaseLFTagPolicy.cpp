...
#include "OAIDatabaseLFTagPolicy.h"
...
OAIDatabaseLFTagPolicy::OAIDatabaseLFTagPolicy(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDatabaseLFTagPolicy::OAIDatabaseLFTagPolicy() {
    this->initializeModel();
}

OAIDatabaseLFTagPolicy::~OAIDatabaseLFTagPolicy() {}

void OAIDatabaseLFTagPolicy::initializeModel() {

    m_expression_isSet = false;
    m_expression_isValid = false;
}

void OAIDatabaseLFTagPolicy::fromJson(QString jsonString) {
...
void OAIDatabaseLFTagPolicy::fromJsonObject(QJsonObject json) {
...
QString OAIDatabaseLFTagPolicy::asJson() const {
...
QJsonObject OAIDatabaseLFTagPolicy::asJsonObject() const {
    QJsonObject obj;
...
QList OAIDatabaseLFTagPolicy::getExpression() const {
    return m_expression;
}
void OAIDatabaseLFTagPolicy::setExpression(const QList &expression) {
    m_expression = expression;
    m_expression_isSet = true;
}

bool OAIDatabaseLFTagPolicy::is_expression_Set() const{
    return m_expression_isSet;
}

bool OAIDatabaseLFTagPolicy::is_expression_Valid() const{
    return m_expression_isValid;
}

bool OAIDatabaseLFTagPolicy::isSet() const {
...
bool OAIDatabaseLFTagPolicy::isValid() const {
