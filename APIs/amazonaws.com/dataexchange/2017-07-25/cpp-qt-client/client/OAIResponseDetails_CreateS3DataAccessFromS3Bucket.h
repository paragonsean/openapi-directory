...
/*
 * OAIResponseDetails_CreateS3DataAccessFromS3Bucket.h
 *
 * 
 */

#ifndef OAIResponseDetails_CreateS3DataAccessFromS3Bucket_H
#define OAIResponseDetails_CreateS3DataAccessFromS3Bucket_H
...
namespace OpenAPI {
class OAICreateS3DataAccessFromS3BucketResponseDetails_AssetSource;

class OAIResponseDetails_CreateS3DataAccessFromS3Bucket : public OAIObject {
public:
    OAIResponseDetails_CreateS3DataAccessFromS3Bucket();
    OAIResponseDetails_CreateS3DataAccessFromS3Bucket(QString json);
    ~OAIResponseDetails_CreateS3DataAccessFromS3Bucket() override;
    ...
    OAICreateS3DataAccessFromS3BucketResponseDetails_AssetSource getAssetSource() const;
    void setAssetSource(const OAICreateS3DataAccessFromS3BucketResponseDetails_AssetSource &asset_source);
...
private:
    ...
    OAICreateS3DataAccessFromS3BucketResponseDetails_AssetSource m_asset_source;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResponseDetails_CreateS3DataAccessFromS3Bucket)

#endif // OAIResponseDetails_CreateS3DataAccessFromS3Bucket_H
