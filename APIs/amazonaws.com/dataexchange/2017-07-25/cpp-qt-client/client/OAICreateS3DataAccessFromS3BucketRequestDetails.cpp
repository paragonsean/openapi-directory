...
#include "OAICreateS3DataAccessFromS3BucketRequestDetails.h"
...
OAICreateS3DataAccessFromS3BucketRequestDetails::OAICreateS3DataAccessFromS3BucketRequestDetails(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateS3DataAccessFromS3BucketRequestDetails::OAICreateS3DataAccessFromS3BucketRequestDetails() {
    this->initializeModel();
}

OAICreateS3DataAccessFromS3BucketRequestDetails::~OAICreateS3DataAccessFromS3BucketRequestDetails() {}

void OAICreateS3DataAccessFromS3BucketRequestDetails::initializeModel() {
...
void OAICreateS3DataAccessFromS3BucketRequestDetails::fromJson(QString jsonString) {
...
void OAICreateS3DataAccessFromS3BucketRequestDetails::fromJsonObject(QJsonObject json) {
...
QString OAICreateS3DataAccessFromS3BucketRequestDetails::asJson() const {
...
QJsonObject OAICreateS3DataAccessFromS3BucketRequestDetails::asJsonObject() const {
    QJsonObject obj;
...
OAICreateS3DataAccessFromS3BucketRequestDetails_AssetSource OAICreateS3DataAccessFromS3BucketRequestDetails::getAssetSource() const {
    return m_asset_source;
}
void OAICreateS3DataAccessFromS3BucketRequestDetails::setAssetSource(const OAICreateS3DataAccessFromS3BucketRequestDetails_AssetSource &asset_source) {
    m_asset_source = asset_source;
    m_asset_source_isSet = true;
}

bool OAICreateS3DataAccessFromS3BucketRequestDetails::is_asset_source_Set() const{
    return m_asset_source_isSet;
}

bool OAICreateS3DataAccessFromS3BucketRequestDetails::is_asset_source_Valid() const{
    return m_asset_source_isValid;
}

QString OAICreateS3DataAccessFromS3BucketRequestDetails::getDataSetId() const {
    return m_data_set_id;
}
void OAICreateS3DataAccessFromS3BucketRequestDetails::setDataSetId(const QString &data_set_id) {
    m_data_set_id = data_set_id;
    m_data_set_id_isSet = true;
}

bool OAICreateS3DataAccessFromS3BucketRequestDetails::is_data_set_id_Set() const{
    return m_data_set_id_isSet;
}

bool OAICreateS3DataAccessFromS3BucketRequestDetails::is_data_set_id_Valid() const{
    return m_data_set_id_isValid;
}

QString OAICreateS3DataAccessFromS3BucketRequestDetails::getRevisionId() const {
    return m_revision_id;
}
void OAICreateS3DataAccessFromS3BucketRequestDetails::setRevisionId(const QString &revision_id) {
    m_revision_id = revision_id;
    m_revision_id_isSet = true;
}

bool OAICreateS3DataAccessFromS3BucketRequestDetails::is_revision_id_Set() const{
    return m_revision_id_isSet;
}

bool OAICreateS3DataAccessFromS3BucketRequestDetails::is_revision_id_Valid() const{
    return m_revision_id_isValid;
}

bool OAICreateS3DataAccessFromS3BucketRequestDetails::isSet() const {
...
bool OAICreateS3DataAccessFromS3BucketRequestDetails::isValid() const {
