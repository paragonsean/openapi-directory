...
/*
 * OAIExportAssetsToS3ResponseDetails.h
 *
 * Details about the export to Amazon S3 response.
 */

#ifndef OAIExportAssetsToS3ResponseDetails_H
#define OAIExportAssetsToS3ResponseDetails_H
...
class OAIExportAssetsToS3ResponseDetails : public OAIObject {
public:
    OAIExportAssetsToS3ResponseDetails();
    OAIExportAssetsToS3ResponseDetails(QString json);
    ~OAIExportAssetsToS3ResponseDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExportAssetsToS3ResponseDetails)

#endif // OAIExportAssetsToS3ResponseDetails_H
