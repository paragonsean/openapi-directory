...
/*
 * OAIListEventActionsResponse.h
 *
 * 
 */

#ifndef OAIListEventActionsResponse_H
#define OAIListEventActionsResponse_H
...
class OAIListEventActionsResponse : public OAIObject {
public:
    OAIListEventActionsResponse();
    OAIListEventActionsResponse(QString json);
    ~OAIListEventActionsResponse() override;
    ...
    QList getEventActions() const;
    void setEventActions(const QList &event_actions);
    bool is_event_actions_Set() const;
    bool is_event_actions_Valid() const;
...
private:
    ...
    QList m_event_actions;
    bool m_event_actions_isSet;
    bool m_event_actions_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListEventActionsResponse)

#endif // OAIListEventActionsResponse_H
