...
class CreateEventActionRequestEvent(Model):
    ...
    def __init__(self, revision_published: CreateEventActionRequestEventRevisionPublished=None):
        """CreateEventActionRequestEvent - a model defined in OpenAPI

        :param revision_published: The revision_published of this CreateEventActionRequestEvent.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CreateEventActionRequestEvent':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The CreateEventAction_request_Event of this CreateEventActionRequestEvent.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def revision_published(self):
        """Gets the revision_published of this CreateEventActionRequestEvent.


        :return: The revision_published of this CreateEventActionRequestEvent.
    ...
    def revision_published(self, revision_published):
        """Sets the revision_published of this CreateEventActionRequestEvent.
