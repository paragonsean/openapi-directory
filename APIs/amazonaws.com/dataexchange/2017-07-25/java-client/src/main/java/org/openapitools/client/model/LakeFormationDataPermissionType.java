...
/**
 * Gets or Sets LakeFormationDataPermissionType
 */
@JsonAdapter(LakeFormationDataPermissionType.Adapter.class)
public enum LakeFormationDataPermissionType {
  ...
  LakeFormationDataPermissionType(String value) {
    this.value = value;
  }
  ...
  public static LakeFormationDataPermissionType fromValue(String value) {
    for (LakeFormationDataPermissionType b : LakeFormationDataPermissionType.values()) {
  ...
  public static class Adapter extends TypeAdapter<LakeFormationDataPermissionType> {
    @Override
    public void write(final JsonWriter jsonWriter, final LakeFormationDataPermissionType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public LakeFormationDataPermissionType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return LakeFormationDataPermissionType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    LakeFormationDataPermissionType.fromValue(value);
  }
}
