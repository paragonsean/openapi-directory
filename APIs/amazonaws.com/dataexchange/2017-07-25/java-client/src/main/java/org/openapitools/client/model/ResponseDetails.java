...
public class ResponseDetails {
  ...
  public ResponseDetails exportAssetToSignedUrl(ResponseDetailsExportAssetToSignedUrl exportAssetToSignedUrl) {
  ...
  public ResponseDetails exportAssetsToS3(ResponseDetailsExportAssetsToS3 exportAssetsToS3) {
  ...
  public ResponseDetails exportRevisionsToS3(ResponseDetailsExportRevisionsToS3 exportRevisionsToS3) {
  ...
  public ResponseDetails importAssetFromSignedUrl(ResponseDetailsImportAssetFromSignedUrl importAssetFromSignedUrl) {
  ...
  public ResponseDetails importAssetsFromS3(ResponseDetailsImportAssetsFromS3 importAssetsFromS3) {
  ...
  public ResponseDetails importAssetsFromRedshiftDataShares(ResponseDetailsImportAssetsFromRedshiftDataShares importAssetsFromRedshiftDataShares) {
  ...
  public ResponseDetails importAssetFromApiGatewayApi(ResponseDetailsImportAssetFromApiGatewayApi importAssetFromApiGatewayApi) {
  ...
  public ResponseDetails createS3DataAccessFromS3Bucket(ResponseDetailsCreateS3DataAccessFromS3Bucket createS3DataAccessFromS3Bucket) {
  ...
  public ResponseDetails importAssetsFromLakeFormationTagPolicy(ResponseDetailsImportAssetsFromLakeFormationTagPolicy importAssetsFromLakeFormationTagPolicy) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.exportAssetToSignedUrl, responseDetails.exportAssetToSignedUrl) &&
        Objects.equals(this.exportAssetsToS3, responseDetails.exportAssetsToS3) &&
        Objects.equals(this.exportRevisionsToS3, responseDetails.exportRevisionsToS3) &&
        Objects.equals(this.importAssetFromSignedUrl, responseDetails.importAssetFromSignedUrl) &&
        Objects.equals(this.importAssetsFromS3, responseDetails.importAssetsFromS3) &&
        Objects.equals(this.importAssetsFromRedshiftDataShares, responseDetails.importAssetsFromRedshiftDataShares) &&
        Objects.equals(this.importAssetFromApiGatewayApi, responseDetails.importAssetFromApiGatewayApi) &&
        Objects.equals(this.createS3DataAccessFromS3Bucket, responseDetails.createS3DataAccessFromS3Bucket) &&
        Objects.equals(this.importAssetsFromLakeFormationTagPolicy, responseDetails.importAssetsFromLakeFormationTagPolicy);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ResponseDetails
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResponseDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResponseDetails is not found in the empty JSON string", ResponseDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ResponseDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResponseDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResponseDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResponseDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResponseDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResponseDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<ResponseDetails>() {
           @Override
           public void write(JsonWriter out, ResponseDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResponseDetails read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ResponseDetails given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ResponseDetails
   * @throws IOException if the JSON string is invalid with respect to ResponseDetails
   */
  public static ResponseDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResponseDetails.class);
  }

  /**
   * Convert an instance of ResponseDetails to an JSON string
   *
   * @return JSON string
   */
