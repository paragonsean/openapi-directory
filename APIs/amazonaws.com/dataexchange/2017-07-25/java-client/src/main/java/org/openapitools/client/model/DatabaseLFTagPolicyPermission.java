...
/**
 * Gets or Sets DatabaseLFTagPolicyPermission
 */
@JsonAdapter(DatabaseLFTagPolicyPermission.Adapter.class)
public enum DatabaseLFTagPolicyPermission {
  ...
  DatabaseLFTagPolicyPermission(String value) {
    this.value = value;
  }
  ...
  public static DatabaseLFTagPolicyPermission fromValue(String value) {
    for (DatabaseLFTagPolicyPermission b : DatabaseLFTagPolicyPermission.values()) {
  ...
  public static class Adapter extends TypeAdapter<DatabaseLFTagPolicyPermission> {
    @Override
    public void write(final JsonWriter jsonWriter, final DatabaseLFTagPolicyPermission enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public DatabaseLFTagPolicyPermission read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return DatabaseLFTagPolicyPermission.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    DatabaseLFTagPolicyPermission.fromValue(value);
  }
}
