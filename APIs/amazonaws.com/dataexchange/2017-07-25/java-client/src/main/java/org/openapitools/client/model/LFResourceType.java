...
/**
 * Gets or Sets LFResourceType
 */
@JsonAdapter(LFResourceType.Adapter.class)
public enum LFResourceType {
  ...
  public static LFResourceType fromValue(String value) {
    for (LFResourceType b : LFResourceType.values()) {
  ...
  public static class Adapter extends TypeAdapter<LFResourceType> {
    @Override
    public void write(final JsonWriter jsonWriter, final LFResourceType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public LFResourceType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return LFResourceType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    LFResourceType.fromValue(value);
  }
}
