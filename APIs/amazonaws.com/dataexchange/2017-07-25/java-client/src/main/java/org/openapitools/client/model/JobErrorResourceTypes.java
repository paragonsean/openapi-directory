...
/**
 * Gets or Sets JobErrorResourceTypes
 */
@JsonAdapter(JobErrorResourceTypes.Adapter.class)
public enum JobErrorResourceTypes {
  ...
  JobErrorResourceTypes(String value) {
    this.value = value;
  }
  ...
  public static JobErrorResourceTypes fromValue(String value) {
    for (JobErrorResourceTypes b : JobErrorResourceTypes.values()) {
  ...
  public static class Adapter extends TypeAdapter<JobErrorResourceTypes> {
    @Override
    public void write(final JsonWriter jsonWriter, final JobErrorResourceTypes enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public JobErrorResourceTypes read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return JobErrorResourceTypes.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    JobErrorResourceTypes.fromValue(value);
  }
}
