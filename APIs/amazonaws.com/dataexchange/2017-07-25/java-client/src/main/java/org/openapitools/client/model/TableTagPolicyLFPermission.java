...
/**
 * Gets or Sets TableTagPolicyLFPermission
 */
@JsonAdapter(TableTagPolicyLFPermission.Adapter.class)
public enum TableTagPolicyLFPermission {
  ...
  TableTagPolicyLFPermission(String value) {
    this.value = value;
  }
  ...
  public static TableTagPolicyLFPermission fromValue(String value) {
    for (TableTagPolicyLFPermission b : TableTagPolicyLFPermission.values()) {
  ...
  public static class Adapter extends TypeAdapter<TableTagPolicyLFPermission> {
    @Override
    public void write(final JsonWriter jsonWriter, final TableTagPolicyLFPermission enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public TableTagPolicyLFPermission read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return TableTagPolicyLFPermission.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    TableTagPolicyLFPermission.fromValue(value);
  }
}
