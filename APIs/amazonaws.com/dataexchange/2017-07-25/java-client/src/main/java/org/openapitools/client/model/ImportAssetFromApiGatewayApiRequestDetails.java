...
public class ImportAssetFromApiGatewayApiRequestDetails {
  ...
  public ImportAssetFromApiGatewayApiRequestDetails apiDescription(String apiDescription) {
  ...
  public ImportAssetFromApiGatewayApiRequestDetails apiId(String apiId) {
    this.apiId = apiId;
    return this;
  }
  ...
  public ImportAssetFromApiGatewayApiRequestDetails apiKey(String apiKey) {
    this.apiKey = apiKey;
    return this;
  }
  ...
  public ImportAssetFromApiGatewayApiRequestDetails apiName(String apiName) {
  ...
  public ImportAssetFromApiGatewayApiRequestDetails apiSpecificationMd5Hash(String apiSpecificationMd5Hash) {
  ...
  public ImportAssetFromApiGatewayApiRequestDetails dataSetId(String dataSetId) {
  ...
  public ImportAssetFromApiGatewayApiRequestDetails protocolType(ProtocolType protocolType) {
  ...
  public ImportAssetFromApiGatewayApiRequestDetails revisionId(String revisionId) {
  ...
  public ImportAssetFromApiGatewayApiRequestDetails stage(String stage) {
    this.stage = stage;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ImportAssetFromApiGatewayApiRequestDetails importAssetFromApiGatewayApiRequestDetails = (ImportAssetFromApiGatewayApiRequestDetails) o;
    return Objects.equals(this.apiDescription, importAssetFromApiGatewayApiRequestDetails.apiDescription) &&
        Objects.equals(this.apiId, importAssetFromApiGatewayApiRequestDetails.apiId) &&
        Objects.equals(this.apiKey, importAssetFromApiGatewayApiRequestDetails.apiKey) &&
        Objects.equals(this.apiName, importAssetFromApiGatewayApiRequestDetails.apiName) &&
        Objects.equals(this.apiSpecificationMd5Hash, importAssetFromApiGatewayApiRequestDetails.apiSpecificationMd5Hash) &&
        Objects.equals(this.dataSetId, importAssetFromApiGatewayApiRequestDetails.dataSetId) &&
        Objects.equals(this.protocolType, importAssetFromApiGatewayApiRequestDetails.protocolType) &&
        Objects.equals(this.revisionId, importAssetFromApiGatewayApiRequestDetails.revisionId) &&
        Objects.equals(this.stage, importAssetFromApiGatewayApiRequestDetails.stage);
  }
  ...
  public String toString() {
    ...
    sb.append("class ImportAssetFromApiGatewayApiRequestDetails {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ImportAssetFromApiGatewayApiRequestDetails
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ImportAssetFromApiGatewayApiRequestDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImportAssetFromApiGatewayApiRequestDetails is not found in the empty JSON string", ImportAssetFromApiGatewayApiRequestDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ImportAssetFromApiGatewayApiRequestDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ImportAssetFromApiGatewayApiRequestDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ImportAssetFromApiGatewayApiRequestDetails.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImportAssetFromApiGatewayApiRequestDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImportAssetFromApiGatewayApiRequestDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImportAssetFromApiGatewayApiRequestDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImportAssetFromApiGatewayApiRequestDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<ImportAssetFromApiGatewayApiRequestDetails>() {
           @Override
           public void write(JsonWriter out, ImportAssetFromApiGatewayApiRequestDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ImportAssetFromApiGatewayApiRequestDetails read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ImportAssetFromApiGatewayApiRequestDetails given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ImportAssetFromApiGatewayApiRequestDetails
   * @throws IOException if the JSON string is invalid with respect to ImportAssetFromApiGatewayApiRequestDetails
   */
  public static ImportAssetFromApiGatewayApiRequestDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImportAssetFromApiGatewayApiRequestDetails.class);
  }

  /**
   * Convert an instance of ImportAssetFromApiGatewayApiRequestDetails to an JSON string
   *
   * @return JSON string
   */
