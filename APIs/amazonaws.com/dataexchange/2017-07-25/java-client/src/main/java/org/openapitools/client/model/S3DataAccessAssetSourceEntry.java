...
public class S3DataAccessAssetSourceEntry {
  ...
  public S3DataAccessAssetSourceEntry() {
  }

  public S3DataAccessAssetSourceEntry bucket(String bucket) {
    this.bucket = bucket;
    return this;
  }
  ...
  public S3DataAccessAssetSourceEntry keyPrefixes(List keyPrefixes) {
  ...
  public S3DataAccessAssetSourceEntry keys(List keys) {
    this.keys = keys;
    return this;
  }
  ...
  public S3DataAccessAssetSourceEntry kmsKeysToGrant(List kmsKeysToGrant) {
  ...
  public boolean equals(Object o) {
    ...
    S3DataAccessAssetSourceEntry s3DataAccessAssetSourceEntry = (S3DataAccessAssetSourceEntry) o;
    return Objects.equals(this.bucket, s3DataAccessAssetSourceEntry.bucket) &&
        Objects.equals(this.keyPrefixes, s3DataAccessAssetSourceEntry.keyPrefixes) &&
        Objects.equals(this.keys, s3DataAccessAssetSourceEntry.keys) &&
        Objects.equals(this.kmsKeysToGrant, s3DataAccessAssetSourceEntry.kmsKeysToGrant);
  }
  ...
  public String toString() {
    ...
    sb.append("class S3DataAccessAssetSourceEntry {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to S3DataAccessAssetSourceEntry
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!S3DataAccessAssetSourceEntry.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in S3DataAccessAssetSourceEntry is not found in the empty JSON string", S3DataAccessAssetSourceEntry.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!S3DataAccessAssetSourceEntry.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `S3DataAccessAssetSourceEntry` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : S3DataAccessAssetSourceEntry.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!S3DataAccessAssetSourceEntry.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'S3DataAccessAssetSourceEntry' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<S3DataAccessAssetSourceEntry> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(S3DataAccessAssetSourceEntry.class));

       return (TypeAdapter<T>) new TypeAdapter<S3DataAccessAssetSourceEntry>() {
           @Override
           public void write(JsonWriter out, S3DataAccessAssetSourceEntry value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public S3DataAccessAssetSourceEntry read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of S3DataAccessAssetSourceEntry given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of S3DataAccessAssetSourceEntry
   * @throws IOException if the JSON string is invalid with respect to S3DataAccessAssetSourceEntry
   */
  public static S3DataAccessAssetSourceEntry fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, S3DataAccessAssetSourceEntry.class);
  }

  /**
   * Convert an instance of S3DataAccessAssetSourceEntry to an JSON string
   *
   * @return JSON string
   */
