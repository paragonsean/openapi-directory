...
/**
 * Gets or Sets ServerSideEncryptionTypes
 */
@JsonAdapter(ServerSideEncryptionTypes.Adapter.class)
public enum ServerSideEncryptionTypes {
  ...
  ServerSideEncryptionTypes(String value) {
    this.value = value;
  }
  ...
  public static ServerSideEncryptionTypes fromValue(String value) {
    for (ServerSideEncryptionTypes b : ServerSideEncryptionTypes.values()) {
  ...
  public static class Adapter extends TypeAdapter<ServerSideEncryptionTypes> {
    @Override
    public void write(final JsonWriter jsonWriter, final ServerSideEncryptionTypes enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ServerSideEncryptionTypes read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ServerSideEncryptionTypes.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ServerSideEncryptionTypes.fromValue(value);
  }
}
