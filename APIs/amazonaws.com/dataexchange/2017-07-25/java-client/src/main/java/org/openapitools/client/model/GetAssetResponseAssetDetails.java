...
public class GetAssetResponseAssetDetails {
  ...
  public GetAssetResponseAssetDetails() {
  }

  public GetAssetResponseAssetDetails s3SnapshotAsset(AssetDetailsS3SnapshotAsset s3SnapshotAsset) {
  ...
  public GetAssetResponseAssetDetails redshiftDataShareAsset(AssetDetailsRedshiftDataShareAsset redshiftDataShareAsset) {
  ...
  public GetAssetResponseAssetDetails apiGatewayApiAsset(AssetDetailsApiGatewayApiAsset apiGatewayApiAsset) {
  ...
  public GetAssetResponseAssetDetails s3DataAccessAsset(AssetDetailsS3DataAccessAsset s3DataAccessAsset) {
  ...
  public GetAssetResponseAssetDetails lakeFormationDataPermissionAsset(AssetDetailsLakeFormationDataPermissionAsset lakeFormationDataPermissionAsset) {
  ...
  public boolean equals(Object o) {
    ...
    GetAssetResponseAssetDetails getAssetResponseAssetDetails = (GetAssetResponseAssetDetails) o;
    return Objects.equals(this.s3SnapshotAsset, getAssetResponseAssetDetails.s3SnapshotAsset) &&
        Objects.equals(this.redshiftDataShareAsset, getAssetResponseAssetDetails.redshiftDataShareAsset) &&
        Objects.equals(this.apiGatewayApiAsset, getAssetResponseAssetDetails.apiGatewayApiAsset) &&
        Objects.equals(this.s3DataAccessAsset, getAssetResponseAssetDetails.s3DataAccessAsset) &&
        Objects.equals(this.lakeFormationDataPermissionAsset, getAssetResponseAssetDetails.lakeFormationDataPermissionAsset);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetAssetResponseAssetDetails {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetAssetResponseAssetDetails
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetAssetResponseAssetDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetAssetResponseAssetDetails is not found in the empty JSON string", GetAssetResponseAssetDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetAssetResponseAssetDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetAssetResponseAssetDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetAssetResponseAssetDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetAssetResponseAssetDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetAssetResponseAssetDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetAssetResponseAssetDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<GetAssetResponseAssetDetails>() {
           @Override
           public void write(JsonWriter out, GetAssetResponseAssetDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetAssetResponseAssetDetails read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetAssetResponseAssetDetails given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetAssetResponseAssetDetails
   * @throws IOException if the JSON string is invalid with respect to GetAssetResponseAssetDetails
   */
  public static GetAssetResponseAssetDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetAssetResponseAssetDetails.class);
  }

  /**
   * Convert an instance of GetAssetResponseAssetDetails to an JSON string
   *
   * @return JSON string
   */
