...
public class ImportAssetFromApiGatewayApiResponseDetails {
  ...
  public ImportAssetFromApiGatewayApiResponseDetails apiDescription(String apiDescription) {
  ...
  public ImportAssetFromApiGatewayApiResponseDetails apiId(String apiId) {
    this.apiId = apiId;
    return this;
  }
  ...
  public ImportAssetFromApiGatewayApiResponseDetails apiKey(String apiKey) {
    this.apiKey = apiKey;
    return this;
  }
  ...
  public ImportAssetFromApiGatewayApiResponseDetails apiName(String apiName) {
  ...
  public ImportAssetFromApiGatewayApiResponseDetails apiSpecificationMd5Hash(String apiSpecificationMd5Hash) {
  ...
  public ImportAssetFromApiGatewayApiResponseDetails apiSpecificationUploadUrl(String apiSpecificationUploadUrl) {
  ...
  public ImportAssetFromApiGatewayApiResponseDetails apiSpecificationUploadUrlExpiresAt(OffsetDateTime apiSpecificationUploadUrlExpiresAt) {
  ...
  public ImportAssetFromApiGatewayApiResponseDetails dataSetId(String dataSetId) {
  ...
  public ImportAssetFromApiGatewayApiResponseDetails protocolType(ProtocolType protocolType) {
  ...
  public ImportAssetFromApiGatewayApiResponseDetails revisionId(String revisionId) {
  ...
  public ImportAssetFromApiGatewayApiResponseDetails stage(String stage) {
    this.stage = stage;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ImportAssetFromApiGatewayApiResponseDetails importAssetFromApiGatewayApiResponseDetails = (ImportAssetFromApiGatewayApiResponseDetails) o;
    return Objects.equals(this.apiDescription, importAssetFromApiGatewayApiResponseDetails.apiDescription) &&
        Objects.equals(this.apiId, importAssetFromApiGatewayApiResponseDetails.apiId) &&
        Objects.equals(this.apiKey, importAssetFromApiGatewayApiResponseDetails.apiKey) &&
        Objects.equals(this.apiName, importAssetFromApiGatewayApiResponseDetails.apiName) &&
        Objects.equals(this.apiSpecificationMd5Hash, importAssetFromApiGatewayApiResponseDetails.apiSpecificationMd5Hash) &&
        Objects.equals(this.apiSpecificationUploadUrl, importAssetFromApiGatewayApiResponseDetails.apiSpecificationUploadUrl) &&
        Objects.equals(this.apiSpecificationUploadUrlExpiresAt, importAssetFromApiGatewayApiResponseDetails.apiSpecificationUploadUrlExpiresAt) &&
        Objects.equals(this.dataSetId, importAssetFromApiGatewayApiResponseDetails.dataSetId) &&
        Objects.equals(this.protocolType, importAssetFromApiGatewayApiResponseDetails.protocolType) &&
        Objects.equals(this.revisionId, importAssetFromApiGatewayApiResponseDetails.revisionId) &&
        Objects.equals(this.stage, importAssetFromApiGatewayApiResponseDetails.stage);
  }
  ...
  public String toString() {
    ...
    sb.append("class ImportAssetFromApiGatewayApiResponseDetails {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ImportAssetFromApiGatewayApiResponseDetails
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ImportAssetFromApiGatewayApiResponseDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImportAssetFromApiGatewayApiResponseDetails is not found in the empty JSON string", ImportAssetFromApiGatewayApiResponseDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ImportAssetFromApiGatewayApiResponseDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ImportAssetFromApiGatewayApiResponseDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ImportAssetFromApiGatewayApiResponseDetails.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImportAssetFromApiGatewayApiResponseDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImportAssetFromApiGatewayApiResponseDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImportAssetFromApiGatewayApiResponseDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImportAssetFromApiGatewayApiResponseDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<ImportAssetFromApiGatewayApiResponseDetails>() {
           @Override
           public void write(JsonWriter out, ImportAssetFromApiGatewayApiResponseDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ImportAssetFromApiGatewayApiResponseDetails read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ImportAssetFromApiGatewayApiResponseDetails given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ImportAssetFromApiGatewayApiResponseDetails
   * @throws IOException if the JSON string is invalid with respect to ImportAssetFromApiGatewayApiResponseDetails
   */
  public static ImportAssetFromApiGatewayApiResponseDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImportAssetFromApiGatewayApiResponseDetails.class);
  }

  /**
   * Convert an instance of ImportAssetFromApiGatewayApiResponseDetails to an JSON string
   *
   * @return JSON string
   */
