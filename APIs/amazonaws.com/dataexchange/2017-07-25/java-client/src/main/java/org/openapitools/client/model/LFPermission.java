...
/**
 * Gets or Sets LFPermission
 */
@JsonAdapter(LFPermission.Adapter.class)
public enum LFPermission {
  ...
  public static LFPermission fromValue(String value) {
    for (LFPermission b : LFPermission.values()) {
  ...
  public static class Adapter extends TypeAdapter<LFPermission> {
    @Override
    public void write(final JsonWriter jsonWriter, final LFPermission enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public LFPermission read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return LFPermission.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    LFPermission.fromValue(value);
  }
}
