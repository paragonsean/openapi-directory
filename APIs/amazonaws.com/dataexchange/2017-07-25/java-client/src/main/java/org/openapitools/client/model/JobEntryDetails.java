...
public class JobEntryDetails {
  ...
  public JobEntryDetails exportAssetToSignedUrl(ResponseDetailsExportAssetToSignedUrl exportAssetToSignedUrl) {
  ...
  public JobEntryDetails exportAssetsToS3(ResponseDetailsExportAssetsToS3 exportAssetsToS3) {
  ...
  public JobEntryDetails exportRevisionsToS3(ResponseDetailsExportRevisionsToS3 exportRevisionsToS3) {
  ...
  public JobEntryDetails importAssetFromSignedUrl(ResponseDetailsImportAssetFromSignedUrl importAssetFromSignedUrl) {
  ...
  public JobEntryDetails importAssetsFromS3(ResponseDetailsImportAssetsFromS3 importAssetsFromS3) {
  ...
  public JobEntryDetails importAssetsFromRedshiftDataShares(ResponseDetailsImportAssetsFromRedshiftDataShares importAssetsFromRedshiftDataShares) {
  ...
  public JobEntryDetails importAssetFromApiGatewayApi(ResponseDetailsImportAssetFromApiGatewayApi importAssetFromApiGatewayApi) {
  ...
  public JobEntryDetails createS3DataAccessFromS3Bucket(ResponseDetailsCreateS3DataAccessFromS3Bucket createS3DataAccessFromS3Bucket) {
  ...
  public JobEntryDetails importAssetsFromLakeFormationTagPolicy(ResponseDetailsImportAssetsFromLakeFormationTagPolicy importAssetsFromLakeFormationTagPolicy) {
  ...
  public boolean equals(Object o) {
    ...
    JobEntryDetails jobEntryDetails = (JobEntryDetails) o;
    return Objects.equals(this.exportAssetToSignedUrl, jobEntryDetails.exportAssetToSignedUrl) &&
        Objects.equals(this.exportAssetsToS3, jobEntryDetails.exportAssetsToS3) &&
        Objects.equals(this.exportRevisionsToS3, jobEntryDetails.exportRevisionsToS3) &&
        Objects.equals(this.importAssetFromSignedUrl, jobEntryDetails.importAssetFromSignedUrl) &&
        Objects.equals(this.importAssetsFromS3, jobEntryDetails.importAssetsFromS3) &&
        Objects.equals(this.importAssetsFromRedshiftDataShares, jobEntryDetails.importAssetsFromRedshiftDataShares) &&
        Objects.equals(this.importAssetFromApiGatewayApi, jobEntryDetails.importAssetFromApiGatewayApi) &&
        Objects.equals(this.createS3DataAccessFromS3Bucket, jobEntryDetails.createS3DataAccessFromS3Bucket) &&
        Objects.equals(this.importAssetsFromLakeFormationTagPolicy, jobEntryDetails.importAssetsFromLakeFormationTagPolicy);
  }
  ...
  public String toString() {
    ...
    sb.append("class JobEntryDetails {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to JobEntryDetails
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!JobEntryDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in JobEntryDetails is not found in the empty JSON string", JobEntryDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!JobEntryDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `JobEntryDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!JobEntryDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'JobEntryDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<JobEntryDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(JobEntryDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<JobEntryDetails>() {
           @Override
           public void write(JsonWriter out, JobEntryDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public JobEntryDetails read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of JobEntryDetails given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of JobEntryDetails
   * @throws IOException if the JSON string is invalid with respect to JobEntryDetails
   */
  public static JobEntryDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, JobEntryDetails.class);
  }

  /**
   * Convert an instance of JobEntryDetails to an JSON string
   *
   * @return JSON string
   */
