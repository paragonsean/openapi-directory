...
public class ApiClient {
    ...
    private String basePath = "http://dataexchange.us-east-1.amazonaws.com";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "http://dataexchange.{region}.amazonaws.com",
    ...
    new ServerConfiguration(
      "https://dataexchange.{region}.amazonaws.com",
      "The AWS Data Exchange multi-region endpoint",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    new ServerConfiguration(
      "http://dataexchange.{region}.amazonaws.com.cn",
    ...
    new ServerConfiguration(
      "https://dataexchange.{region}.amazonaws.com.cn",
      "The AWS Data Exchange endpoint for China (Beijing) and China (Ningxia)",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://dataexchange.us-east-1.amazonaws.com
