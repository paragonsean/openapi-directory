...
public class CreateJobRequestDetails {
  ...
  public CreateJobRequestDetails() {
  }

  public CreateJobRequestDetails exportAssetToSignedUrl(CreateJobRequestDetailsExportAssetToSignedUrl exportAssetToSignedUrl) {
  ...
  public CreateJobRequestDetails exportAssetsToS3(CreateJobRequestDetailsExportAssetsToS3 exportAssetsToS3) {
  ...
  public CreateJobRequestDetails exportRevisionsToS3(CreateJobRequestDetailsExportRevisionsToS3 exportRevisionsToS3) {
  ...
  public CreateJobRequestDetails importAssetFromSignedUrl(CreateJobRequestDetailsImportAssetFromSignedUrl importAssetFromSignedUrl) {
  ...
  public CreateJobRequestDetails importAssetsFromS3(CreateJobRequestDetailsImportAssetsFromS3 importAssetsFromS3) {
  ...
  public CreateJobRequestDetails importAssetsFromRedshiftDataShares(CreateJobRequestDetailsImportAssetsFromRedshiftDataShares importAssetsFromRedshiftDataShares) {
  ...
  public CreateJobRequestDetails importAssetFromApiGatewayApi(CreateJobRequestDetailsImportAssetFromApiGatewayApi importAssetFromApiGatewayApi) {
  ...
  public CreateJobRequestDetails createS3DataAccessFromS3Bucket(CreateJobRequestDetailsCreateS3DataAccessFromS3Bucket createS3DataAccessFromS3Bucket) {
  ...
  public CreateJobRequestDetails importAssetsFromLakeFormationTagPolicy(CreateJobRequestDetailsImportAssetsFromLakeFormationTagPolicy importAssetsFromLakeFormationTagPolicy) {
  ...
  public boolean equals(Object o) {
    ...
    CreateJobRequestDetails createJobRequestDetails = (CreateJobRequestDetails) o;
    return Objects.equals(this.exportAssetToSignedUrl, createJobRequestDetails.exportAssetToSignedUrl) &&
        Objects.equals(this.exportAssetsToS3, createJobRequestDetails.exportAssetsToS3) &&
        Objects.equals(this.exportRevisionsToS3, createJobRequestDetails.exportRevisionsToS3) &&
        Objects.equals(this.importAssetFromSignedUrl, createJobRequestDetails.importAssetFromSignedUrl) &&
        Objects.equals(this.importAssetsFromS3, createJobRequestDetails.importAssetsFromS3) &&
        Objects.equals(this.importAssetsFromRedshiftDataShares, createJobRequestDetails.importAssetsFromRedshiftDataShares) &&
        Objects.equals(this.importAssetFromApiGatewayApi, createJobRequestDetails.importAssetFromApiGatewayApi) &&
        Objects.equals(this.createS3DataAccessFromS3Bucket, createJobRequestDetails.createS3DataAccessFromS3Bucket) &&
        Objects.equals(this.importAssetsFromLakeFormationTagPolicy, createJobRequestDetails.importAssetsFromLakeFormationTagPolicy);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateJobRequestDetails {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateJobRequestDetails
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateJobRequestDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateJobRequestDetails is not found in the empty JSON string", CreateJobRequestDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateJobRequestDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateJobRequestDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateJobRequestDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateJobRequestDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateJobRequestDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateJobRequestDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateJobRequestDetails>() {
           @Override
           public void write(JsonWriter out, CreateJobRequestDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateJobRequestDetails read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateJobRequestDetails given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateJobRequestDetails
   * @throws IOException if the JSON string is invalid with respect to CreateJobRequestDetails
   */
  public static CreateJobRequestDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateJobRequestDetails.class);
  }

  /**
   * Convert an instance of CreateJobRequestDetails to an JSON string
   *
   * @return JSON string
   */
