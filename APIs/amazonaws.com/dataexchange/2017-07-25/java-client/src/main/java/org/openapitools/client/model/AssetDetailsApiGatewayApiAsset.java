...
public class AssetDetailsApiGatewayApiAsset {
  ...
  public AssetDetailsApiGatewayApiAsset() {
  }

  public AssetDetailsApiGatewayApiAsset apiDescription(String apiDescription) {
  ...
  public AssetDetailsApiGatewayApiAsset apiEndpoint(String apiEndpoint) {
  ...
  public AssetDetailsApiGatewayApiAsset apiId(String apiId) {
    this.apiId = apiId;
    return this;
  }
  ...
  public AssetDetailsApiGatewayApiAsset apiKey(String apiKey) {
    this.apiKey = apiKey;
    return this;
  }
  ...
  public AssetDetailsApiGatewayApiAsset apiName(String apiName) {
  ...
  public AssetDetailsApiGatewayApiAsset apiSpecificationDownloadUrl(String apiSpecificationDownloadUrl) {
  ...
  public AssetDetailsApiGatewayApiAsset apiSpecificationDownloadUrlExpiresAt(OffsetDateTime apiSpecificationDownloadUrlExpiresAt) {
  ...
  public AssetDetailsApiGatewayApiAsset protocolType(ProtocolType protocolType) {
  ...
  public AssetDetailsApiGatewayApiAsset stage(String stage) {
    this.stage = stage;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AssetDetailsApiGatewayApiAsset assetDetailsApiGatewayApiAsset = (AssetDetailsApiGatewayApiAsset) o;
    return Objects.equals(this.apiDescription, assetDetailsApiGatewayApiAsset.apiDescription) &&
        Objects.equals(this.apiEndpoint, assetDetailsApiGatewayApiAsset.apiEndpoint) &&
        Objects.equals(this.apiId, assetDetailsApiGatewayApiAsset.apiId) &&
        Objects.equals(this.apiKey, assetDetailsApiGatewayApiAsset.apiKey) &&
        Objects.equals(this.apiName, assetDetailsApiGatewayApiAsset.apiName) &&
        Objects.equals(this.apiSpecificationDownloadUrl, assetDetailsApiGatewayApiAsset.apiSpecificationDownloadUrl) &&
        Objects.equals(this.apiSpecificationDownloadUrlExpiresAt, assetDetailsApiGatewayApiAsset.apiSpecificationDownloadUrlExpiresAt) &&
        Objects.equals(this.protocolType, assetDetailsApiGatewayApiAsset.protocolType) &&
        Objects.equals(this.stage, assetDetailsApiGatewayApiAsset.stage);
  }
  ...
  public String toString() {
    ...
    sb.append("class AssetDetailsApiGatewayApiAsset {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AssetDetailsApiGatewayApiAsset
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AssetDetailsApiGatewayApiAsset.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AssetDetailsApiGatewayApiAsset is not found in the empty JSON string", AssetDetailsApiGatewayApiAsset.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AssetDetailsApiGatewayApiAsset.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AssetDetailsApiGatewayApiAsset` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AssetDetailsApiGatewayApiAsset.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AssetDetailsApiGatewayApiAsset' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AssetDetailsApiGatewayApiAsset> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AssetDetailsApiGatewayApiAsset.class));

       return (TypeAdapter<T>) new TypeAdapter<AssetDetailsApiGatewayApiAsset>() {
           @Override
           public void write(JsonWriter out, AssetDetailsApiGatewayApiAsset value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AssetDetailsApiGatewayApiAsset read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AssetDetailsApiGatewayApiAsset given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AssetDetailsApiGatewayApiAsset
   * @throws IOException if the JSON string is invalid with respect to AssetDetailsApiGatewayApiAsset
   */
  public static AssetDetailsApiGatewayApiAsset fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AssetDetailsApiGatewayApiAsset.class);
  }

  /**
   * Convert an instance of AssetDetailsApiGatewayApiAsset to an JSON string
   *
   * @return JSON string
   */
