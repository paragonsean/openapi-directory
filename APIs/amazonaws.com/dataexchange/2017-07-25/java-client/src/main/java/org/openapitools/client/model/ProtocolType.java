 ...
 */
@JsonAdapter(ProtocolType.Adapter.class)
public enum ProtocolType {
  ...
  public static class Adapter extends TypeAdapter<ProtocolType> {
    @Override
    public void write(final JsonWriter jsonWriter, final ProtocolType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ProtocolType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ProtocolType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ProtocolType.fromValue(value);
  }
}
