...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.ExportAssetToSignedUrlResponseDetails();
  });
  ...
  describe('ExportAssetToSignedUrlResponseDetails', function() {
    it('should create an instance of ExportAssetToSignedUrlResponseDetails', function() {
      // uncomment below and update the code to test ExportAssetToSignedUrlResponseDetails
      //var instance = new AwsDataExchange.ExportAssetToSignedUrlResponseDetails();
      //expect(instance).to.be.a(AwsDataExchange.ExportAssetToSignedUrlResponseDetails);
    });
