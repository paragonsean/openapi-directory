...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.CreateEventActionRequestActionExportRevisionToS3();
  });
  ...
  describe('CreateEventActionRequestActionExportRevisionToS3', function() {
    it('should create an instance of CreateEventActionRequestActionExportRevisionToS3', function() {
      // uncomment below and update the code to test CreateEventActionRequestActionExportRevisionToS3
      //var instance = new AwsDataExchange.CreateEventActionRequestActionExportRevisionToS3();
      //expect(instance).to.be.a(AwsDataExchange.CreateEventActionRequestActionExportRevisionToS3);
    });
    ...
    it('should have the property revisionDestination (base name: "RevisionDestination")', function() {
      // uncomment below and update the code to test the property revisionDestination
      //var instance = new AwsDataExchange.CreateEventActionRequestActionExportRevisionToS3();
      //expect(instance).to.be();
    });
