...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.CreateEventActionRequestEventRevisionPublished();
  });
  ...
  describe('CreateEventActionRequestEventRevisionPublished', function() {
    it('should create an instance of CreateEventActionRequestEventRevisionPublished', function() {
      // uncomment below and update the code to test CreateEventActionRequestEventRevisionPublished
      //var instance = new AwsDataExchange.CreateEventActionRequestEventRevisionPublished();
      //expect(instance).to.be.a(AwsDataExchange.CreateEventActionRequestEventRevisionPublished);
    });
