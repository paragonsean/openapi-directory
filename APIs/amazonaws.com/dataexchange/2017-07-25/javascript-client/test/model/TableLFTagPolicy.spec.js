...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.TableLFTagPolicy();
  });
  ...
  describe('TableLFTagPolicy', function() {
    it('should create an instance of TableLFTagPolicy', function() {
      // uncomment below and update the code to test TableLFTagPolicy
      //var instance = new AwsDataExchange.TableLFTagPolicy();
      //expect(instance).to.be.a(AwsDataExchange.TableLFTagPolicy);
    });
