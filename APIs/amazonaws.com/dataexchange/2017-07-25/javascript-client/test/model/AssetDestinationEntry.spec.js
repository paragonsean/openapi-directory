...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.AssetDestinationEntry();
  });
  ...
  describe('AssetDestinationEntry', function() {
    it('should create an instance of AssetDestinationEntry', function() {
      // uncomment below and update the code to test AssetDestinationEntry
      //var instance = new AwsDataExchange.AssetDestinationEntry();
      //expect(instance).to.be.a(AwsDataExchange.AssetDestinationEntry);
    });
