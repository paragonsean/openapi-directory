...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.CreateDataSetRequest();
  });
  ...
  describe('CreateDataSetRequest', function() {
    it('should create an instance of CreateDataSetRequest', function() {
      ...
      //var instance = new AwsDataExchange.CreateDataSetRequest();
      //expect(instance).to.be.a(AwsDataExchange.CreateDataSetRequest);
    });
