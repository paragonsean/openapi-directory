...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.LakeFormationDataPermissionDetails();
  });
  ...
  describe('LakeFormationDataPermissionDetails', function() {
    it('should create an instance of LakeFormationDataPermissionDetails', function() {
      // uncomment below and update the code to test LakeFormationDataPermissionDetails
      //var instance = new AwsDataExchange.LakeFormationDataPermissionDetails();
      //expect(instance).to.be.a(AwsDataExchange.LakeFormationDataPermissionDetails);
    });
