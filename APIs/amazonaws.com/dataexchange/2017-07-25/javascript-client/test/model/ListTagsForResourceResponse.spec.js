...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.ListTagsForResourceResponse();
  });
  ...
  describe('ListTagsForResourceResponse', function() {
    it('should create an instance of ListTagsForResourceResponse', function() {
      ...
      //var instance = new AwsDataExchange.ListTagsForResourceResponse();
      //expect(instance).to.be.a(AwsDataExchange.ListTagsForResourceResponse);
    });
