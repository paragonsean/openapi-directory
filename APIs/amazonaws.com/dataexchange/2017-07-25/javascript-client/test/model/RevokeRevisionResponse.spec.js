...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.RevokeRevisionResponse();
  });
  ...
  describe('RevokeRevisionResponse', function() {
    it('should create an instance of RevokeRevisionResponse', function() {
      // uncomment below and update the code to test RevokeRevisionResponse
      //var instance = new AwsDataExchange.RevokeRevisionResponse();
      //expect(instance).to.be.a(AwsDataExchange.RevokeRevisionResponse);
    });
