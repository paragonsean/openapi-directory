...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.DetailsImportAssetFromSignedUrlJobErrorDetails();
  });
  ...
  describe('DetailsImportAssetFromSignedUrlJobErrorDetails', function() {
    it('should create an instance of DetailsImportAssetFromSignedUrlJobErrorDetails', function() {
      // uncomment below and update the code to test DetailsImportAssetFromSignedUrlJobErrorDetails
      //var instance = new AwsDataExchange.DetailsImportAssetFromSignedUrlJobErrorDetails();
      //expect(instance).to.be.a(AwsDataExchange.DetailsImportAssetFromSignedUrlJobErrorDetails);
    });
