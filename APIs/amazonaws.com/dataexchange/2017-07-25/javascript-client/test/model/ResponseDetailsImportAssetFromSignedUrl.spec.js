...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.ResponseDetailsImportAssetFromSignedUrl();
  });
  ...
  describe('ResponseDetailsImportAssetFromSignedUrl', function() {
    it('should create an instance of ResponseDetailsImportAssetFromSignedUrl', function() {
      // uncomment below and update the code to test ResponseDetailsImportAssetFromSignedUrl
      //var instance = new AwsDataExchange.ResponseDetailsImportAssetFromSignedUrl();
      //expect(instance).to.be.a(AwsDataExchange.ResponseDetailsImportAssetFromSignedUrl);
    });
