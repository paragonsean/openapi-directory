...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.ExportServerSideEncryption();
  });
  ...
  describe('ExportServerSideEncryption', function() {
    it('should create an instance of ExportServerSideEncryption', function() {
      // uncomment below and update the code to test ExportServerSideEncryption
      //var instance = new AwsDataExchange.ExportServerSideEncryption();
      //expect(instance).to.be.a(AwsDataExchange.ExportServerSideEncryption);
    });
