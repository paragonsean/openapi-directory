...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.DatabaseLFTagPolicyAndPermissions();
  });
  ...
  describe('DatabaseLFTagPolicyAndPermissions', function() {
    it('should create an instance of DatabaseLFTagPolicyAndPermissions', function() {
      // uncomment below and update the code to test DatabaseLFTagPolicyAndPermissions
      //var instance = new AwsDataExchange.DatabaseLFTagPolicyAndPermissions();
      //expect(instance).to.be.a(AwsDataExchange.DatabaseLFTagPolicyAndPermissions);
    });
