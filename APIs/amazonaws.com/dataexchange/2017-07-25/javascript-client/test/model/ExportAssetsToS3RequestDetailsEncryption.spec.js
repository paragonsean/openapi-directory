...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.ExportAssetsToS3RequestDetailsEncryption();
  });
  ...
  describe('ExportAssetsToS3RequestDetailsEncryption', function() {
    it('should create an instance of ExportAssetsToS3RequestDetailsEncryption', function() {
      // uncomment below and update the code to test ExportAssetsToS3RequestDetailsEncryption
      //var instance = new AwsDataExchange.ExportAssetsToS3RequestDetailsEncryption();
      //expect(instance).to.be.a(AwsDataExchange.ExportAssetsToS3RequestDetailsEncryption);
    });
