...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.ResponseDetailsImportAssetFromApiGatewayApi();
  });
  ...
  describe('ResponseDetailsImportAssetFromApiGatewayApi', function() {
    it('should create an instance of ResponseDetailsImportAssetFromApiGatewayApi', function() {
      // uncomment below and update the code to test ResponseDetailsImportAssetFromApiGatewayApi
      //var instance = new AwsDataExchange.ResponseDetailsImportAssetFromApiGatewayApi();
      //expect(instance).to.be.a(AwsDataExchange.ResponseDetailsImportAssetFromApiGatewayApi);
    });
    ...
    it('should have the property apiSpecificationUploadUrl (base name: "ApiSpecificationUploadUrl")', function() {
      // uncomment below and update the code to test the property apiSpecificationUploadUrl
      //var instance = new AwsDataExchange.ResponseDetailsImportAssetFromApiGatewayApi();
      //expect(instance).to.be();
    });

    it('should have the property apiSpecificationUploadUrlExpiresAt (base name: "ApiSpecificationUploadUrlExpiresAt")', function() {
      // uncomment below and update the code to test the property apiSpecificationUploadUrlExpiresAt
      //var instance = new AwsDataExchange.ResponseDetailsImportAssetFromApiGatewayApi();
      //expect(instance).to.be();
    });
