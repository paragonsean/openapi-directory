...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.ResponseDetailsImportAssetsFromS3();
  });
  ...
  describe('ResponseDetailsImportAssetsFromS3', function() {
    it('should create an instance of ResponseDetailsImportAssetsFromS3', function() {
      // uncomment below and update the code to test ResponseDetailsImportAssetsFromS3
      //var instance = new AwsDataExchange.ResponseDetailsImportAssetsFromS3();
      //expect(instance).to.be.a(AwsDataExchange.ResponseDetailsImportAssetsFromS3);
    });
