...
(function(root, factory) {
  ...
  describe('JobErrorResourceTypes', function() {
    it('should create an instance of JobErrorResourceTypes', function() {
      // uncomment below and update the code to test JobErrorResourceTypes
      //var instance = new AwsDataExchange.JobErrorResourceTypes();
      //expect(instance).to.be.a(AwsDataExchange.JobErrorResourceTypes);
    });
