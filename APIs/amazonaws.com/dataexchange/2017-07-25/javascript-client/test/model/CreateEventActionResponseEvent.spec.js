...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.CreateEventActionResponseEvent();
  });
  ...
  describe('CreateEventActionResponseEvent', function() {
    it('should create an instance of CreateEventActionResponseEvent', function() {
      // uncomment below and update the code to test CreateEventActionResponseEvent
      //var instance = new AwsDataExchange.CreateEventActionResponseEvent();
      //expect(instance).to.be.a(AwsDataExchange.CreateEventActionResponseEvent);
    });

    it('should have the property revisionPublished (base name: "RevisionPublished")', function() {
      // uncomment below and update the code to test the property revisionPublished
      //var instance = new AwsDataExchange.CreateEventActionResponseEvent();
