...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.UpdateDataSetRequest();
  });
  ...
  describe('UpdateDataSetRequest', function() {
    it('should create an instance of UpdateDataSetRequest', function() {
      ...
      //var instance = new AwsDataExchange.UpdateDataSetRequest();
      //expect(instance).to.be.a(AwsDataExchange.UpdateDataSetRequest);
    });
