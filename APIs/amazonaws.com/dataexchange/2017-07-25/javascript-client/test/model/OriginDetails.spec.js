...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.OriginDetails();
  });
  ...
  describe('OriginDetails', function() {
    it('should create an instance of OriginDetails', function() {
      // uncomment below and update the code to test OriginDetails
      //var instance = new AwsDataExchange.OriginDetails();
      //expect(instance).to.be.a(AwsDataExchange.OriginDetails);
    });
