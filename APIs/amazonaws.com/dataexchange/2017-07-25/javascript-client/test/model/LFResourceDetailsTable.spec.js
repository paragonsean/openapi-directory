...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.LFResourceDetailsTable();
  });
  ...
  describe('LFResourceDetailsTable', function() {
    it('should create an instance of LFResourceDetailsTable', function() {
      // uncomment below and update the code to test LFResourceDetailsTable
      //var instance = new AwsDataExchange.LFResourceDetailsTable();
      //expect(instance).to.be.a(AwsDataExchange.LFResourceDetailsTable);
    });
