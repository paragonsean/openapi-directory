...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.ResponseDetailsExportRevisionsToS3();
  });
  ...
  describe('ResponseDetailsExportRevisionsToS3', function() {
    it('should create an instance of ResponseDetailsExportRevisionsToS3', function() {
      // uncomment below and update the code to test ResponseDetailsExportRevisionsToS3
      //var instance = new AwsDataExchange.ResponseDetailsExportRevisionsToS3();
      //expect(instance).to.be.a(AwsDataExchange.ResponseDetailsExportRevisionsToS3);
    });
