...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.CreateJobRequestDetailsImportAssetFromSignedUrl();
  });
  ...
  describe('CreateJobRequestDetailsImportAssetFromSignedUrl', function() {
    it('should create an instance of CreateJobRequestDetailsImportAssetFromSignedUrl', function() {
      // uncomment below and update the code to test CreateJobRequestDetailsImportAssetFromSignedUrl
      //var instance = new AwsDataExchange.CreateJobRequestDetailsImportAssetFromSignedUrl();
      //expect(instance).to.be.a(AwsDataExchange.CreateJobRequestDetailsImportAssetFromSignedUrl);
    });
