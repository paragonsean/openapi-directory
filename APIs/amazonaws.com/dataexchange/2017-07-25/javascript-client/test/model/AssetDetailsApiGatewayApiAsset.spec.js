...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.AssetDetailsApiGatewayApiAsset();
  });
  ...
  describe('AssetDetailsApiGatewayApiAsset', function() {
    it('should create an instance of AssetDetailsApiGatewayApiAsset', function() {
      // uncomment below and update the code to test AssetDetailsApiGatewayApiAsset
      //var instance = new AwsDataExchange.AssetDetailsApiGatewayApiAsset();
      //expect(instance).to.be.a(AwsDataExchange.AssetDetailsApiGatewayApiAsset);
    });
    ...
    it('should have the property apiSpecificationDownloadUrl (base name: "ApiSpecificationDownloadUrl")', function() {
      // uncomment below and update the code to test the property apiSpecificationDownloadUrl
      //var instance = new AwsDataExchange.AssetDetailsApiGatewayApiAsset();
      //expect(instance).to.be();
    });

    it('should have the property apiSpecificationDownloadUrlExpiresAt (base name: "ApiSpecificationDownloadUrlExpiresAt")', function() {
      // uncomment below and update the code to test the property apiSpecificationDownloadUrlExpiresAt
      //var instance = new AwsDataExchange.AssetDetailsApiGatewayApiAsset();
      //expect(instance).to.be();
    });
