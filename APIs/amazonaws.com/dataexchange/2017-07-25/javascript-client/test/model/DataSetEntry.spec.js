...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.DataSetEntry();
  });
  ...
  describe('DataSetEntry', function() {
    it('should create an instance of DataSetEntry', function() {
      // uncomment below and update the code to test DataSetEntry
      //var instance = new AwsDataExchange.DataSetEntry();
      //expect(instance).to.be.a(AwsDataExchange.DataSetEntry);
    });
