...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.CreateRevisionResponse();
  });
  ...
  describe('CreateRevisionResponse', function() {
    it('should create an instance of CreateRevisionResponse', function() {
      // uncomment below and update the code to test CreateRevisionResponse
      //var instance = new AwsDataExchange.CreateRevisionResponse();
      //expect(instance).to.be.a(AwsDataExchange.CreateRevisionResponse);
    });
