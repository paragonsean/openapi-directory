...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.ExportRevisionsToS3ResponseDetails();
  });
  ...
  describe('ExportRevisionsToS3ResponseDetails', function() {
    it('should create an instance of ExportRevisionsToS3ResponseDetails', function() {
      // uncomment below and update the code to test ExportRevisionsToS3ResponseDetails
      //var instance = new AwsDataExchange.ExportRevisionsToS3ResponseDetails();
      //expect(instance).to.be.a(AwsDataExchange.ExportRevisionsToS3ResponseDetails);
    });
    ...
    it('should have the property revisionDestinations (base name: "RevisionDestinations")', function() {
      // uncomment below and update the code to test the property revisionDestinations
      //var instance = new AwsDataExchange.ExportRevisionsToS3ResponseDetails();
      //expect(instance).to.be();
    });

    it('should have the property eventActionArn (base name: "EventActionArn")', function() {
      // uncomment below and update the code to test the property eventActionArn
      //var instance = new AwsDataExchange.ExportRevisionsToS3ResponseDetails();
      //expect(instance).to.be();
    });
