...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.CreateJobRequestDetailsImportAssetFromApiGatewayApi();
  });
  ...
  describe('CreateJobRequestDetailsImportAssetFromApiGatewayApi', function() {
    it('should create an instance of CreateJobRequestDetailsImportAssetFromApiGatewayApi', function() {
      // uncomment below and update the code to test CreateJobRequestDetailsImportAssetFromApiGatewayApi
      //var instance = new AwsDataExchange.CreateJobRequestDetailsImportAssetFromApiGatewayApi();
      //expect(instance).to.be.a(AwsDataExchange.CreateJobRequestDetailsImportAssetFromApiGatewayApi);
    });

    it('should have the property apiDescription (base name: "ApiDescription")', function() {
      // uncomment below and update the code to test the property apiDescription
      //var instance = new AwsDataExchange.CreateJobRequestDetailsImportAssetFromApiGatewayApi();
    ...
    it('should have the property apiSpecificationMd5Hash (base name: "ApiSpecificationMd5Hash")', function() {
      // uncomment below and update the code to test the property apiSpecificationMd5Hash
      //var instance = new AwsDataExchange.CreateJobRequestDetailsImportAssetFromApiGatewayApi();
      //expect(instance).to.be();
    });
