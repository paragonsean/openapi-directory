...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.LakeFormationDataPermissionAsset();
  });
  ...
  describe('LakeFormationDataPermissionAsset', function() {
    it('should create an instance of LakeFormationDataPermissionAsset', function() {
      // uncomment below and update the code to test LakeFormationDataPermissionAsset
      //var instance = new AwsDataExchange.LakeFormationDataPermissionAsset();
      //expect(instance).to.be.a(AwsDataExchange.LakeFormationDataPermissionAsset);
    });

    it('should have the property lakeFormationDataPermissionDetails (base name: "LakeFormationDataPermissionDetails")', function() {
      // uncomment below and update the code to test the property lakeFormationDataPermissionDetails
      //var instance = new AwsDataExchange.LakeFormationDataPermissionAsset();
      //expect(instance).to.be();
    });

    it('should have the property lakeFormationDataPermissionType (base name: "LakeFormationDataPermissionType")', function() {
      // uncomment below and update the code to test the property lakeFormationDataPermissionType
      //var instance = new AwsDataExchange.LakeFormationDataPermissionAsset();
      //expect(instance).to.be();
    });
