...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.ImportAssetsFromS3ResponseDetails();
  });
  ...
  describe('ImportAssetsFromS3ResponseDetails', function() {
    it('should create an instance of ImportAssetsFromS3ResponseDetails', function() {
      // uncomment below and update the code to test ImportAssetsFromS3ResponseDetails
      //var instance = new AwsDataExchange.ImportAssetsFromS3ResponseDetails();
      //expect(instance).to.be.a(AwsDataExchange.ImportAssetsFromS3ResponseDetails);
    });
