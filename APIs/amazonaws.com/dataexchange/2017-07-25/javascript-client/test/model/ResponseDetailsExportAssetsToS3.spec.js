...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.ResponseDetailsExportAssetsToS3();
  });
  ...
  describe('ResponseDetailsExportAssetsToS3', function() {
    it('should create an instance of ResponseDetailsExportAssetsToS3', function() {
      // uncomment below and update the code to test ResponseDetailsExportAssetsToS3
      //var instance = new AwsDataExchange.ResponseDetailsExportAssetsToS3();
      //expect(instance).to.be.a(AwsDataExchange.ResponseDetailsExportAssetsToS3);
    });

    it('should have the property assetDestinations (base name: "AssetDestinations")', function() {
      // uncomment below and update the code to test the property assetDestinations
      //var instance = new AwsDataExchange.ResponseDetailsExportAssetsToS3();
