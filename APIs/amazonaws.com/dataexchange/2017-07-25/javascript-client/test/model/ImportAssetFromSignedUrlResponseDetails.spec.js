...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.ImportAssetFromSignedUrlResponseDetails();
  });
  ...
  describe('ImportAssetFromSignedUrlResponseDetails', function() {
    it('should create an instance of ImportAssetFromSignedUrlResponseDetails', function() {
      // uncomment below and update the code to test ImportAssetFromSignedUrlResponseDetails
      //var instance = new AwsDataExchange.ImportAssetFromSignedUrlResponseDetails();
      //expect(instance).to.be.a(AwsDataExchange.ImportAssetFromSignedUrlResponseDetails);
    });
