...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.UpdateRevisionRequest();
  });
  ...
  describe('UpdateRevisionRequest', function() {
    it('should create an instance of UpdateRevisionRequest', function() {
      // uncomment below and update the code to test UpdateRevisionRequest
      //var instance = new AwsDataExchange.UpdateRevisionRequest();
      //expect(instance).to.be.a(AwsDataExchange.UpdateRevisionRequest);
    });
