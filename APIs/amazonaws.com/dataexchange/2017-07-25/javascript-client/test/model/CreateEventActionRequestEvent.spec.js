...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.CreateEventActionRequestEvent();
  });
  ...
  describe('CreateEventActionRequestEvent', function() {
    it('should create an instance of CreateEventActionRequestEvent', function() {
      // uncomment below and update the code to test CreateEventActionRequestEvent
      //var instance = new AwsDataExchange.CreateEventActionRequestEvent();
      //expect(instance).to.be.a(AwsDataExchange.CreateEventActionRequestEvent);
    });
