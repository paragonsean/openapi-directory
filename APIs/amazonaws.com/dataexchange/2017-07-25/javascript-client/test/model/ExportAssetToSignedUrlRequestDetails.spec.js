...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.ExportAssetToSignedUrlRequestDetails();
  });
  ...
  describe('ExportAssetToSignedUrlRequestDetails', function() {
    it('should create an instance of ExportAssetToSignedUrlRequestDetails', function() {
      // uncomment below and update the code to test ExportAssetToSignedUrlRequestDetails
      //var instance = new AwsDataExchange.ExportAssetToSignedUrlRequestDetails();
      //expect(instance).to.be.a(AwsDataExchange.ExportAssetToSignedUrlRequestDetails);
    });
