...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.RevisionDestinationEntry();
  });
  ...
  describe('RevisionDestinationEntry', function() {
    it('should create an instance of RevisionDestinationEntry', function() {
      // uncomment below and update the code to test RevisionDestinationEntry
      //var instance = new AwsDataExchange.RevisionDestinationEntry();
      //expect(instance).to.be.a(AwsDataExchange.RevisionDestinationEntry);
    });
