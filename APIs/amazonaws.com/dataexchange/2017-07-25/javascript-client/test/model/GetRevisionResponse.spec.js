...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.GetRevisionResponse();
  });
  ...
  describe('GetRevisionResponse', function() {
    it('should create an instance of GetRevisionResponse', function() {
      // uncomment below and update the code to test GetRevisionResponse
      //var instance = new AwsDataExchange.GetRevisionResponse();
      //expect(instance).to.be.a(AwsDataExchange.GetRevisionResponse);
    });
