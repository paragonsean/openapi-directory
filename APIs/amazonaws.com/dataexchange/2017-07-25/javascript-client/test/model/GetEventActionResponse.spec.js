...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.GetEventActionResponse();
  });
  ...
  describe('GetEventActionResponse', function() {
    it('should create an instance of GetEventActionResponse', function() {
      // uncomment below and update the code to test GetEventActionResponse
      //var instance = new AwsDataExchange.GetEventActionResponse();
      //expect(instance).to.be.a(AwsDataExchange.GetEventActionResponse);
    });
