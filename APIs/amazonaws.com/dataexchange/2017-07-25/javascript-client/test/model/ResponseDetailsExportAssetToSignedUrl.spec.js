...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.ResponseDetailsExportAssetToSignedUrl();
  });
  ...
  describe('ResponseDetailsExportAssetToSignedUrl', function() {
    it('should create an instance of ResponseDetailsExportAssetToSignedUrl', function() {
      // uncomment below and update the code to test ResponseDetailsExportAssetToSignedUrl
      //var instance = new AwsDataExchange.ResponseDetailsExportAssetToSignedUrl();
      //expect(instance).to.be.a(AwsDataExchange.ResponseDetailsExportAssetToSignedUrl);
    });
    ...
    it('should have the property signedUrlExpiresAt (base name: "SignedUrlExpiresAt")', function() {
      // uncomment below and update the code to test the property signedUrlExpiresAt
      //var instance = new AwsDataExchange.ResponseDetailsExportAssetToSignedUrl();
      //expect(instance).to.be();
    });
