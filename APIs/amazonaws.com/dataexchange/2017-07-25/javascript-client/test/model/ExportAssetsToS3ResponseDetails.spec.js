...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.ExportAssetsToS3ResponseDetails();
  });
  ...
  describe('ExportAssetsToS3ResponseDetails', function() {
    it('should create an instance of ExportAssetsToS3ResponseDetails', function() {
      // uncomment below and update the code to test ExportAssetsToS3ResponseDetails
      //var instance = new AwsDataExchange.ExportAssetsToS3ResponseDetails();
      //expect(instance).to.be.a(AwsDataExchange.ExportAssetsToS3ResponseDetails);
    });
