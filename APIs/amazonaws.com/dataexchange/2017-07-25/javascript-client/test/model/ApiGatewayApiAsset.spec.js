...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.ApiGatewayApiAsset();
  });
  ...
  describe('ApiGatewayApiAsset', function() {
    it('should create an instance of ApiGatewayApiAsset', function() {
      // uncomment below and update the code to test ApiGatewayApiAsset
      //var instance = new AwsDataExchange.ApiGatewayApiAsset();
      //expect(instance).to.be.a(AwsDataExchange.ApiGatewayApiAsset);
    });
