...
(function(root, factory) {
  ...
  describe('TableTagPolicyLFPermission', function() {
    it('should create an instance of TableTagPolicyLFPermission', function() {
      // uncomment below and update the code to test TableTagPolicyLFPermission
      //var instance = new AwsDataExchange.TableTagPolicyLFPermission();
      //expect(instance).to.be.a(AwsDataExchange.TableTagPolicyLFPermission);
    });
