...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.AssetDetailsS3DataAccessAsset();
  });
  ...
  describe('AssetDetailsS3DataAccessAsset', function() {
    it('should create an instance of AssetDetailsS3DataAccessAsset', function() {
      // uncomment below and update the code to test AssetDetailsS3DataAccessAsset
      //var instance = new AwsDataExchange.AssetDetailsS3DataAccessAsset();
      //expect(instance).to.be.a(AwsDataExchange.AssetDetailsS3DataAccessAsset);
    });
    ...
    it('should have the property s3AccessPointAlias (base name: "S3AccessPointAlias")', function() {
      // uncomment below and update the code to test the property s3AccessPointAlias
      //var instance = new AwsDataExchange.AssetDetailsS3DataAccessAsset();
      //expect(instance).to.be();
    });

    it('should have the property s3AccessPointArn (base name: "S3AccessPointArn")', function() {
      // uncomment below and update the code to test the property s3AccessPointArn
      //var instance = new AwsDataExchange.AssetDetailsS3DataAccessAsset();
      //expect(instance).to.be();
    });
