...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.CreateEventActionRequest();
  });
  ...
  describe('CreateEventActionRequest', function() {
    it('should create an instance of CreateEventActionRequest', function() {
      // uncomment below and update the code to test CreateEventActionRequest
      //var instance = new AwsDataExchange.CreateEventActionRequest();
      //expect(instance).to.be.a(AwsDataExchange.CreateEventActionRequest);
    });
