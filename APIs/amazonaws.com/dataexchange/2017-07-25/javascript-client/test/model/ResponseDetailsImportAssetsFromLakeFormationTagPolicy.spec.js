...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.ResponseDetailsImportAssetsFromLakeFormationTagPolicy();
  });
  ...
  describe('ResponseDetailsImportAssetsFromLakeFormationTagPolicy', function() {
    it('should create an instance of ResponseDetailsImportAssetsFromLakeFormationTagPolicy', function() {
      // uncomment below and update the code to test ResponseDetailsImportAssetsFromLakeFormationTagPolicy
      //var instance = new AwsDataExchange.ResponseDetailsImportAssetsFromLakeFormationTagPolicy();
      //expect(instance).to.be.a(AwsDataExchange.ResponseDetailsImportAssetsFromLakeFormationTagPolicy);
    });
