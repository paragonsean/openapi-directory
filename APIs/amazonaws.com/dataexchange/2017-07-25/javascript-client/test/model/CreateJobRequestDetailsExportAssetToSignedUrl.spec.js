...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.CreateJobRequestDetailsExportAssetToSignedUrl();
  });
  ...
  describe('CreateJobRequestDetailsExportAssetToSignedUrl', function() {
    it('should create an instance of CreateJobRequestDetailsExportAssetToSignedUrl', function() {
      // uncomment below and update the code to test CreateJobRequestDetailsExportAssetToSignedUrl
      //var instance = new AwsDataExchange.CreateJobRequestDetailsExportAssetToSignedUrl();
      //expect(instance).to.be.a(AwsDataExchange.CreateJobRequestDetailsExportAssetToSignedUrl);
    });
