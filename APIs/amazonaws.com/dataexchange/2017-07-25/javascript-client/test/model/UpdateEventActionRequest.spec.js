...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.UpdateEventActionRequest();
  });
  ...
  describe('UpdateEventActionRequest', function() {
    it('should create an instance of UpdateEventActionRequest', function() {
      // uncomment below and update the code to test UpdateEventActionRequest
      //var instance = new AwsDataExchange.UpdateEventActionRequest();
      //expect(instance).to.be.a(AwsDataExchange.UpdateEventActionRequest);
    });
