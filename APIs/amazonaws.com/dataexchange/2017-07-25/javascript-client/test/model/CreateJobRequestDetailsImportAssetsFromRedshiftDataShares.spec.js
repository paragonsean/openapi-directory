...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.CreateJobRequestDetailsImportAssetsFromRedshiftDataShares();
  });
  ...
  describe('CreateJobRequestDetailsImportAssetsFromRedshiftDataShares', function() {
    it('should create an instance of CreateJobRequestDetailsImportAssetsFromRedshiftDataShares', function() {
      // uncomment below and update the code to test CreateJobRequestDetailsImportAssetsFromRedshiftDataShares
      //var instance = new AwsDataExchange.CreateJobRequestDetailsImportAssetsFromRedshiftDataShares();
      //expect(instance).to.be.a(AwsDataExchange.CreateJobRequestDetailsImportAssetsFromRedshiftDataShares);
    });

    it('should have the property assetSources (base name: "AssetSources")', function() {
      // uncomment below and update the code to test the property assetSources
      //var instance = new AwsDataExchange.CreateJobRequestDetailsImportAssetsFromRedshiftDataShares();
