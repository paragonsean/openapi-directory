...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.ListRevisionAssetsResponse();
  });
  ...
  describe('ListRevisionAssetsResponse', function() {
    it('should create an instance of ListRevisionAssetsResponse', function() {
      // uncomment below and update the code to test ListRevisionAssetsResponse
      //var instance = new AwsDataExchange.ListRevisionAssetsResponse();
      //expect(instance).to.be.a(AwsDataExchange.ListRevisionAssetsResponse);
    });
