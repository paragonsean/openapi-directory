...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.UpdateAssetRequest();
  });
  ...
  describe('UpdateAssetRequest', function() {
    it('should create an instance of UpdateAssetRequest', function() {
      ...
      //var instance = new AwsDataExchange.UpdateAssetRequest();
      //expect(instance).to.be.a(AwsDataExchange.UpdateAssetRequest);
    });
