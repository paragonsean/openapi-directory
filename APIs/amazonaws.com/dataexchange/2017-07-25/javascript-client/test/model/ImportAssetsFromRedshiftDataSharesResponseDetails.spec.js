...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.ImportAssetsFromRedshiftDataSharesResponseDetails();
  });
  ...
  describe('ImportAssetsFromRedshiftDataSharesResponseDetails', function() {
    it('should create an instance of ImportAssetsFromRedshiftDataSharesResponseDetails', function() {
      // uncomment below and update the code to test ImportAssetsFromRedshiftDataSharesResponseDetails
      //var instance = new AwsDataExchange.ImportAssetsFromRedshiftDataSharesResponseDetails();
      //expect(instance).to.be.a(AwsDataExchange.ImportAssetsFromRedshiftDataSharesResponseDetails);
    });
