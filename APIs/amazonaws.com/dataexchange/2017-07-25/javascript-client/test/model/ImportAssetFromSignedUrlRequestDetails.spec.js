...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.ImportAssetFromSignedUrlRequestDetails();
  });
  ...
  describe('ImportAssetFromSignedUrlRequestDetails', function() {
    it('should create an instance of ImportAssetFromSignedUrlRequestDetails', function() {
      // uncomment below and update the code to test ImportAssetFromSignedUrlRequestDetails
      //var instance = new AwsDataExchange.ImportAssetFromSignedUrlRequestDetails();
      //expect(instance).to.be.a(AwsDataExchange.ImportAssetFromSignedUrlRequestDetails);
    });
