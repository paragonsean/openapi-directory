...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.LFTagPolicyDetails();
  });
  ...
  describe('LFTagPolicyDetails', function() {
    it('should create an instance of LFTagPolicyDetails', function() {
      // uncomment below and update the code to test LFTagPolicyDetails
      //var instance = new AwsDataExchange.LFTagPolicyDetails();
      //expect(instance).to.be.a(AwsDataExchange.LFTagPolicyDetails);
    });
