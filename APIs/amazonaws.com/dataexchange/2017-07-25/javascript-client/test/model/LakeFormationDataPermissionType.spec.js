...
(function(root, factory) {
  ...
  describe('LakeFormationDataPermissionType', function() {
    it('should create an instance of LakeFormationDataPermissionType', function() {
      // uncomment below and update the code to test LakeFormationDataPermissionType
      //var instance = new AwsDataExchange.LakeFormationDataPermissionType();
      //expect(instance).to.be.a(AwsDataExchange.LakeFormationDataPermissionType);
    });
