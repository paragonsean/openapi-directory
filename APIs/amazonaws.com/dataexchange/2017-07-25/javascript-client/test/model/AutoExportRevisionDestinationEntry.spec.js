...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.AutoExportRevisionDestinationEntry();
  });
  ...
  describe('AutoExportRevisionDestinationEntry', function() {
    it('should create an instance of AutoExportRevisionDestinationEntry', function() {
      // uncomment below and update the code to test AutoExportRevisionDestinationEntry
      //var instance = new AwsDataExchange.AutoExportRevisionDestinationEntry();
      //expect(instance).to.be.a(AwsDataExchange.AutoExportRevisionDestinationEntry);
    });
