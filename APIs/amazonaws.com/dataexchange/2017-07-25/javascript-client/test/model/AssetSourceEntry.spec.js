...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.AssetSourceEntry();
  });
  ...
  describe('AssetSourceEntry', function() {
    it('should create an instance of AssetSourceEntry', function() {
      // uncomment below and update the code to test AssetSourceEntry
      //var instance = new AwsDataExchange.AssetSourceEntry();
      //expect(instance).to.be.a(AwsDataExchange.AssetSourceEntry);
    });
