...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.ResponseDetailsImportAssetsFromRedshiftDataShares();
  });
  ...
  describe('ResponseDetailsImportAssetsFromRedshiftDataShares', function() {
    it('should create an instance of ResponseDetailsImportAssetsFromRedshiftDataShares', function() {
      // uncomment below and update the code to test ResponseDetailsImportAssetsFromRedshiftDataShares
      //var instance = new AwsDataExchange.ResponseDetailsImportAssetsFromRedshiftDataShares();
      //expect(instance).to.be.a(AwsDataExchange.ResponseDetailsImportAssetsFromRedshiftDataShares);
    });
