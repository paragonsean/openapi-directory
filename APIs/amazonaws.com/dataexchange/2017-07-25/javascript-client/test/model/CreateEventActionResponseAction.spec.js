...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.CreateEventActionResponseAction();
  });
  ...
  describe('CreateEventActionResponseAction', function() {
    it('should create an instance of CreateEventActionResponseAction', function() {
      // uncomment below and update the code to test CreateEventActionResponseAction
      //var instance = new AwsDataExchange.CreateEventActionResponseAction();
      //expect(instance).to.be.a(AwsDataExchange.CreateEventActionResponseAction);
    });
