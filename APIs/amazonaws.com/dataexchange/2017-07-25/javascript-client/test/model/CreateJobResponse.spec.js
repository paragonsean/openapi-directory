...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.CreateJobResponse();
  });
  ...
  describe('CreateJobResponse', function() {
    it('should create an instance of CreateJobResponse', function() {
      ...
      //var instance = new AwsDataExchange.CreateJobResponse();
      //expect(instance).to.be.a(AwsDataExchange.CreateJobResponse);
    });
