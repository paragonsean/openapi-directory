...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.AutoExportRevisionToS3RequestDetails();
  });
  ...
  describe('AutoExportRevisionToS3RequestDetails', function() {
    it('should create an instance of AutoExportRevisionToS3RequestDetails', function() {
      // uncomment below and update the code to test AutoExportRevisionToS3RequestDetails
      //var instance = new AwsDataExchange.AutoExportRevisionToS3RequestDetails();
      //expect(instance).to.be.a(AwsDataExchange.AutoExportRevisionToS3RequestDetails);
    });
