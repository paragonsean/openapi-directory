...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.CreateDataSetResponseOriginDetails();
  });
  ...
  describe('CreateDataSetResponseOriginDetails', function() {
    it('should create an instance of CreateDataSetResponseOriginDetails', function() {
      // uncomment below and update the code to test CreateDataSetResponseOriginDetails
      //var instance = new AwsDataExchange.CreateDataSetResponseOriginDetails();
      //expect(instance).to.be.a(AwsDataExchange.CreateDataSetResponseOriginDetails);
    });
