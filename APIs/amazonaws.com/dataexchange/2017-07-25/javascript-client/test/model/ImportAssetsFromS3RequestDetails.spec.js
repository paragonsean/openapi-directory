...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.ImportAssetsFromS3RequestDetails();
  });
  ...
  describe('ImportAssetsFromS3RequestDetails', function() {
    it('should create an instance of ImportAssetsFromS3RequestDetails', function() {
      // uncomment below and update the code to test ImportAssetsFromS3RequestDetails
      //var instance = new AwsDataExchange.ImportAssetsFromS3RequestDetails();
      //expect(instance).to.be.a(AwsDataExchange.ImportAssetsFromS3RequestDetails);
    });
