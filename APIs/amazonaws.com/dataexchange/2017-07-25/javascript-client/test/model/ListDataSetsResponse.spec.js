...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.ListDataSetsResponse();
  });
  ...
  describe('ListDataSetsResponse', function() {
    it('should create an instance of ListDataSetsResponse', function() {
      ...
      //var instance = new AwsDataExchange.ListDataSetsResponse();
      //expect(instance).to.be.a(AwsDataExchange.ListDataSetsResponse);
    });
