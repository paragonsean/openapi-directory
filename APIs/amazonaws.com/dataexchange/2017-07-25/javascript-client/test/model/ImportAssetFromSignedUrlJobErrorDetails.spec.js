...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.ImportAssetFromSignedUrlJobErrorDetails();
  });
  ...
  describe('ImportAssetFromSignedUrlJobErrorDetails', function() {
    it('should create an instance of ImportAssetFromSignedUrlJobErrorDetails', function() {
      // uncomment below and update the code to test ImportAssetFromSignedUrlJobErrorDetails
      //var instance = new AwsDataExchange.ImportAssetFromSignedUrlJobErrorDetails();
      //expect(instance).to.be.a(AwsDataExchange.ImportAssetFromSignedUrlJobErrorDetails);
    });
