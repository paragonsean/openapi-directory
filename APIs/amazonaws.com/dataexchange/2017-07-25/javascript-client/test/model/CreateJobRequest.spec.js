...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.CreateJobRequest();
  });
  ...
  describe('CreateJobRequest', function() {
    it('should create an instance of CreateJobRequest', function() {
      ...
      //var instance = new AwsDataExchange.CreateJobRequest();
      //expect(instance).to.be.a(AwsDataExchange.CreateJobRequest);
    });
