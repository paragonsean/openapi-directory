...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.S3SnapshotAsset();
  });
  ...
  describe('S3SnapshotAsset', function() {
    it('should create an instance of S3SnapshotAsset', function() {
      // uncomment below and update the code to test S3SnapshotAsset
      //var instance = new AwsDataExchange.S3SnapshotAsset();
      //expect(instance).to.be.a(AwsDataExchange.S3SnapshotAsset);
    });
