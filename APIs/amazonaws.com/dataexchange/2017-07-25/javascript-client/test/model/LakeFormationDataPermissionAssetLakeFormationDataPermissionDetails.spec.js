...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.LakeFormationDataPermissionAssetLakeFormationDataPermissionDetails();
  });
  ...
  describe('LakeFormationDataPermissionAssetLakeFormationDataPermissionDetails', function() {
    it('should create an instance of LakeFormationDataPermissionAssetLakeFormationDataPermissionDetails', function() {
      // uncomment below and update the code to test LakeFormationDataPermissionAssetLakeFormationDataPermissionDetails
      //var instance = new AwsDataExchange.LakeFormationDataPermissionAssetLakeFormationDataPermissionDetails();
      //expect(instance).to.be.a(AwsDataExchange.LakeFormationDataPermissionAssetLakeFormationDataPermissionDetails);
    });
