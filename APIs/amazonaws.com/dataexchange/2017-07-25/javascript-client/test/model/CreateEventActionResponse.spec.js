...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.CreateEventActionResponse();
  });
  ...
  describe('CreateEventActionResponse', function() {
    it('should create an instance of CreateEventActionResponse', function() {
      // uncomment below and update the code to test CreateEventActionResponse
      //var instance = new AwsDataExchange.CreateEventActionResponse();
      //expect(instance).to.be.a(AwsDataExchange.CreateEventActionResponse);
    });
