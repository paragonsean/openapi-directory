...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.ImportAssetsFromLakeFormationTagPolicyRequestDetailsDatabase();
  });
  ...
  describe('ImportAssetsFromLakeFormationTagPolicyRequestDetailsDatabase', function() {
    it('should create an instance of ImportAssetsFromLakeFormationTagPolicyRequestDetailsDatabase', function() {
      // uncomment below and update the code to test ImportAssetsFromLakeFormationTagPolicyRequestDetailsDatabase
      //var instance = new AwsDataExchange.ImportAssetsFromLakeFormationTagPolicyRequestDetailsDatabase();
      //expect(instance).to.be.a(AwsDataExchange.ImportAssetsFromLakeFormationTagPolicyRequestDetailsDatabase);
    });
