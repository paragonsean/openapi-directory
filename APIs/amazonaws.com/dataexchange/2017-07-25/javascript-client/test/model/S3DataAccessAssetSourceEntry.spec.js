...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.S3DataAccessAssetSourceEntry();
  });
  ...
  describe('S3DataAccessAssetSourceEntry', function() {
    it('should create an instance of S3DataAccessAssetSourceEntry', function() {
      // uncomment below and update the code to test S3DataAccessAssetSourceEntry
      //var instance = new AwsDataExchange.S3DataAccessAssetSourceEntry();
      //expect(instance).to.be.a(AwsDataExchange.S3DataAccessAssetSourceEntry);
    });
    ...
    it('should have the property keyPrefixes (base name: "KeyPrefixes")', function() {
      // uncomment below and update the code to test the property keyPrefixes
      //var instance = new AwsDataExchange.S3DataAccessAssetSourceEntry();
      //expect(instance).to.be();
    });
    ...
    it('should have the property kmsKeysToGrant (base name: "KmsKeysToGrant")', function() {
      // uncomment below and update the code to test the property kmsKeysToGrant
      //var instance = new AwsDataExchange.S3DataAccessAssetSourceEntry();
      //expect(instance).to.be();
    });
