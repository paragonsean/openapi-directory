...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.ImportAssetsFromLakeFormationTagPolicyRequestDetails();
  });
  ...
  describe('ImportAssetsFromLakeFormationTagPolicyRequestDetails', function() {
    it('should create an instance of ImportAssetsFromLakeFormationTagPolicyRequestDetails', function() {
      // uncomment below and update the code to test ImportAssetsFromLakeFormationTagPolicyRequestDetails
      //var instance = new AwsDataExchange.ImportAssetsFromLakeFormationTagPolicyRequestDetails();
      //expect(instance).to.be.a(AwsDataExchange.ImportAssetsFromLakeFormationTagPolicyRequestDetails);
    });
