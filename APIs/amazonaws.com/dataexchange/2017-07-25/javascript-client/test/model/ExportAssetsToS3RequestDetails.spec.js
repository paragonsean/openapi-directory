...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.ExportAssetsToS3RequestDetails();
  });
  ...
  describe('ExportAssetsToS3RequestDetails', function() {
    it('should create an instance of ExportAssetsToS3RequestDetails', function() {
      // uncomment below and update the code to test ExportAssetsToS3RequestDetails
      //var instance = new AwsDataExchange.ExportAssetsToS3RequestDetails();
      //expect(instance).to.be.a(AwsDataExchange.ExportAssetsToS3RequestDetails);
    });
