...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.CreateS3DataAccessFromS3BucketResponseDetailsAssetSource();
  });
  ...
  describe('CreateS3DataAccessFromS3BucketResponseDetailsAssetSource', function() {
    it('should create an instance of CreateS3DataAccessFromS3BucketResponseDetailsAssetSource', function() {
      // uncomment below and update the code to test CreateS3DataAccessFromS3BucketResponseDetailsAssetSource
      //var instance = new AwsDataExchange.CreateS3DataAccessFromS3BucketResponseDetailsAssetSource();
      //expect(instance).to.be.a(AwsDataExchange.CreateS3DataAccessFromS3BucketResponseDetailsAssetSource);
    });
