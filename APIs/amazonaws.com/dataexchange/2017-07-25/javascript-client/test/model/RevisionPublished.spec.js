...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.RevisionPublished();
  });
  ...
  describe('RevisionPublished', function() {
    it('should create an instance of RevisionPublished', function() {
      // uncomment below and update the code to test RevisionPublished
      //var instance = new AwsDataExchange.RevisionPublished();
      //expect(instance).to.be.a(AwsDataExchange.RevisionPublished);
    });
