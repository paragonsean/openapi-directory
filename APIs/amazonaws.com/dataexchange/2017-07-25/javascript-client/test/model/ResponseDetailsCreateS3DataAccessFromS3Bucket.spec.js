...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.ResponseDetailsCreateS3DataAccessFromS3Bucket();
  });
  ...
  describe('ResponseDetailsCreateS3DataAccessFromS3Bucket', function() {
    it('should create an instance of ResponseDetailsCreateS3DataAccessFromS3Bucket', function() {
      // uncomment below and update the code to test ResponseDetailsCreateS3DataAccessFromS3Bucket
      //var instance = new AwsDataExchange.ResponseDetailsCreateS3DataAccessFromS3Bucket();
      //expect(instance).to.be.a(AwsDataExchange.ResponseDetailsCreateS3DataAccessFromS3Bucket);
    });
