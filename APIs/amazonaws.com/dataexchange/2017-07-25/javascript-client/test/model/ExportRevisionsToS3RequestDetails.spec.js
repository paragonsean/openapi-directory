...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.ExportRevisionsToS3RequestDetails();
  });
  ...
  describe('ExportRevisionsToS3RequestDetails', function() {
    it('should create an instance of ExportRevisionsToS3RequestDetails', function() {
      // uncomment below and update the code to test ExportRevisionsToS3RequestDetails
      //var instance = new AwsDataExchange.ExportRevisionsToS3RequestDetails();
      //expect(instance).to.be.a(AwsDataExchange.ExportRevisionsToS3RequestDetails);
    });
