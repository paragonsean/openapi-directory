...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.TagResourceRequest();
  });
  ...
  describe('TagResourceRequest', function() {
    it('should create an instance of TagResourceRequest', function() {
      ...
      //var instance = new AwsDataExchange.TagResourceRequest();
      //expect(instance).to.be.a(AwsDataExchange.TagResourceRequest);
    });
