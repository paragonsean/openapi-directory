...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.ListEventActionsResponse();
  });
  ...
  describe('ListEventActionsResponse', function() {
    it('should create an instance of ListEventActionsResponse', function() {
      // uncomment below and update the code to test ListEventActionsResponse
      //var instance = new AwsDataExchange.ListEventActionsResponse();
      //expect(instance).to.be.a(AwsDataExchange.ListEventActionsResponse);
    });
