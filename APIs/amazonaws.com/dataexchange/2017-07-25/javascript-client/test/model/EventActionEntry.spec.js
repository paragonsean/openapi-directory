...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.EventActionEntry();
  });
  ...
  describe('EventActionEntry', function() {
    it('should create an instance of EventActionEntry', function() {
      // uncomment below and update the code to test EventActionEntry
      //var instance = new AwsDataExchange.EventActionEntry();
      //expect(instance).to.be.a(AwsDataExchange.EventActionEntry);
    });
