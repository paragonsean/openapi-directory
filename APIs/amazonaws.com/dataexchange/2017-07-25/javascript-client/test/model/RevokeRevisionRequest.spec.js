...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.RevokeRevisionRequest();
  });
  ...
  describe('RevokeRevisionRequest', function() {
    it('should create an instance of RevokeRevisionRequest', function() {
      // uncomment below and update the code to test RevokeRevisionRequest
      //var instance = new AwsDataExchange.RevokeRevisionRequest();
      //expect(instance).to.be.a(AwsDataExchange.RevokeRevisionRequest);
    });
