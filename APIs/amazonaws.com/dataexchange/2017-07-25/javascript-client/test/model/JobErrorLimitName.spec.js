...
(function(root, factory) {
  ...
  describe('JobErrorLimitName', function() {
    it('should create an instance of JobErrorLimitName', function() {
      // uncomment below and update the code to test JobErrorLimitName
      //var instance = new AwsDataExchange.JobErrorLimitName();
      //expect(instance).to.be.a(AwsDataExchange.JobErrorLimitName);
    });
