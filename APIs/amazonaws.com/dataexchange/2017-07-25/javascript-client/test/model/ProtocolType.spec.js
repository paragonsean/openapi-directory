...
(function(root, factory) {
  ...
  describe('ProtocolType', function() {
    it('should create an instance of ProtocolType', function() {
      // uncomment below and update the code to test ProtocolType
      //var instance = new AwsDataExchange.ProtocolType();
      //expect(instance).to.be.a(AwsDataExchange.ProtocolType);
    });
