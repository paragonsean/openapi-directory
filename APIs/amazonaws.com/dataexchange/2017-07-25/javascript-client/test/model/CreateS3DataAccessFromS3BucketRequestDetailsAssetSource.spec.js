...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.CreateS3DataAccessFromS3BucketRequestDetailsAssetSource();
  });
  ...
  describe('CreateS3DataAccessFromS3BucketRequestDetailsAssetSource', function() {
    it('should create an instance of CreateS3DataAccessFromS3BucketRequestDetailsAssetSource', function() {
      // uncomment below and update the code to test CreateS3DataAccessFromS3BucketRequestDetailsAssetSource
      //var instance = new AwsDataExchange.CreateS3DataAccessFromS3BucketRequestDetailsAssetSource();
      //expect(instance).to.be.a(AwsDataExchange.CreateS3DataAccessFromS3BucketRequestDetailsAssetSource);
    });
