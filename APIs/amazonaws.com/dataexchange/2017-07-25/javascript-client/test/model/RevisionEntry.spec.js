...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.RevisionEntry();
  });
  ...
  describe('RevisionEntry', function() {
    it('should create an instance of RevisionEntry', function() {
      // uncomment below and update the code to test RevisionEntry
      //var instance = new AwsDataExchange.RevisionEntry();
      //expect(instance).to.be.a(AwsDataExchange.RevisionEntry);
    });
