...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.AutoExportRevisionToS3RequestDetailsRevisionDestination();
  });
  ...
  describe('AutoExportRevisionToS3RequestDetailsRevisionDestination', function() {
    it('should create an instance of AutoExportRevisionToS3RequestDetailsRevisionDestination', function() {
      // uncomment below and update the code to test AutoExportRevisionToS3RequestDetailsRevisionDestination
      //var instance = new AwsDataExchange.AutoExportRevisionToS3RequestDetailsRevisionDestination();
      //expect(instance).to.be.a(AwsDataExchange.AutoExportRevisionToS3RequestDetailsRevisionDestination);
    });
    ...
    it('should have the property keyPattern (base name: "KeyPattern")', function() {
      // uncomment below and update the code to test the property keyPattern
      //var instance = new AwsDataExchange.AutoExportRevisionToS3RequestDetailsRevisionDestination();
      //expect(instance).to.be();
    });
