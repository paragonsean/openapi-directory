...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.LFTagPolicyDetailsResourceDetails();
  });
  ...
  describe('LFTagPolicyDetailsResourceDetails', function() {
    it('should create an instance of LFTagPolicyDetailsResourceDetails', function() {
      // uncomment below and update the code to test LFTagPolicyDetailsResourceDetails
      //var instance = new AwsDataExchange.LFTagPolicyDetailsResourceDetails();
      //expect(instance).to.be.a(AwsDataExchange.LFTagPolicyDetailsResourceDetails);
    });
