...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.ImportAssetsFromLakeFormationTagPolicyRequestDetailsTable();
  });
  ...
  describe('ImportAssetsFromLakeFormationTagPolicyRequestDetailsTable', function() {
    it('should create an instance of ImportAssetsFromLakeFormationTagPolicyRequestDetailsTable', function() {
      // uncomment below and update the code to test ImportAssetsFromLakeFormationTagPolicyRequestDetailsTable
      //var instance = new AwsDataExchange.ImportAssetsFromLakeFormationTagPolicyRequestDetailsTable();
      //expect(instance).to.be.a(AwsDataExchange.ImportAssetsFromLakeFormationTagPolicyRequestDetailsTable);
    });
