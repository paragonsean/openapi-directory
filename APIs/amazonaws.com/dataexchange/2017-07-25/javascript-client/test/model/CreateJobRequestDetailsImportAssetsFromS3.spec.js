...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.CreateJobRequestDetailsImportAssetsFromS3();
  });
  ...
  describe('CreateJobRequestDetailsImportAssetsFromS3', function() {
    it('should create an instance of CreateJobRequestDetailsImportAssetsFromS3', function() {
      // uncomment below and update the code to test CreateJobRequestDetailsImportAssetsFromS3
      //var instance = new AwsDataExchange.CreateJobRequestDetailsImportAssetsFromS3();
      //expect(instance).to.be.a(AwsDataExchange.CreateJobRequestDetailsImportAssetsFromS3);
    });
