...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.ExportAssetsToS3ResponseDetailsEncryption();
  });
  ...
  describe('ExportAssetsToS3ResponseDetailsEncryption', function() {
    it('should create an instance of ExportAssetsToS3ResponseDetailsEncryption', function() {
      // uncomment below and update the code to test ExportAssetsToS3ResponseDetailsEncryption
      //var instance = new AwsDataExchange.ExportAssetsToS3ResponseDetailsEncryption();
      //expect(instance).to.be.a(AwsDataExchange.ExportAssetsToS3ResponseDetailsEncryption);
    });
