...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.ListDataSetRevisionsResponse();
  });
  ...
  describe('ListDataSetRevisionsResponse', function() {
    it('should create an instance of ListDataSetRevisionsResponse', function() {
      // uncomment below and update the code to test ListDataSetRevisionsResponse
      //var instance = new AwsDataExchange.ListDataSetRevisionsResponse();
      //expect(instance).to.be.a(AwsDataExchange.ListDataSetRevisionsResponse);
    });
