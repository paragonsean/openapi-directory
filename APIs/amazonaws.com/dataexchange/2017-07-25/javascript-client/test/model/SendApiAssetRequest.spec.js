...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.SendApiAssetRequest();
  });
  ...
  describe('SendApiAssetRequest', function() {
    it('should create an instance of SendApiAssetRequest', function() {
      // uncomment below and update the code to test SendApiAssetRequest
      //var instance = new AwsDataExchange.SendApiAssetRequest();
      //expect(instance).to.be.a(AwsDataExchange.SendApiAssetRequest);
    });
    ...
    it('should have the property xAmznDataexchangeHeader (base name: "x-amzn-dataexchange-header-")', function() {
      // uncomment below and update the code to test the property xAmznDataexchangeHeader
      //var instance = new AwsDataExchange.SendApiAssetRequest();
      //expect(instance).to.be();
    });
