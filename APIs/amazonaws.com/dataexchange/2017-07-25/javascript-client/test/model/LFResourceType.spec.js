...
(function(root, factory) {
  ...
  describe('LFResourceType', function() {
    it('should create an instance of LFResourceType', function() {
      // uncomment below and update the code to test LFResourceType
      //var instance = new AwsDataExchange.LFResourceType();
      //expect(instance).to.be.a(AwsDataExchange.LFResourceType);
    });
