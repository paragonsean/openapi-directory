...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.UpdateEventActionResponse();
  });
  ...
  describe('UpdateEventActionResponse', function() {
    it('should create an instance of UpdateEventActionResponse', function() {
      // uncomment below and update the code to test UpdateEventActionResponse
      //var instance = new AwsDataExchange.UpdateEventActionResponse();
      //expect(instance).to.be.a(AwsDataExchange.UpdateEventActionResponse);
    });
