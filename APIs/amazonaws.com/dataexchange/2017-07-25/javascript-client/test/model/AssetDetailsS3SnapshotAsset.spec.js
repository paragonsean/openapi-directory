...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.AssetDetailsS3SnapshotAsset();
  });
  ...
  describe('AssetDetailsS3SnapshotAsset', function() {
    it('should create an instance of AssetDetailsS3SnapshotAsset', function() {
      // uncomment below and update the code to test AssetDetailsS3SnapshotAsset
      //var instance = new AwsDataExchange.AssetDetailsS3SnapshotAsset();
      //expect(instance).to.be.a(AwsDataExchange.AssetDetailsS3SnapshotAsset);
    });
