...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.UpdateRevisionResponse();
  });
  ...
  describe('UpdateRevisionResponse', function() {
    it('should create an instance of UpdateRevisionResponse', function() {
      // uncomment below and update the code to test UpdateRevisionResponse
      //var instance = new AwsDataExchange.UpdateRevisionResponse();
      //expect(instance).to.be.a(AwsDataExchange.UpdateRevisionResponse);
    });
    ...
    it('should have the property revocationComment (base name: "RevocationComment")', function() {
      // uncomment below and update the code to test the property revocationComment
      //var instance = new AwsDataExchange.UpdateRevisionResponse();
      //expect(instance).to.be();
    });
