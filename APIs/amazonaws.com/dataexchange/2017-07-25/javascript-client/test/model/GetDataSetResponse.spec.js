...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.GetDataSetResponse();
  });
  ...
  describe('GetDataSetResponse', function() {
    it('should create an instance of GetDataSetResponse', function() {
      ...
      //var instance = new AwsDataExchange.GetDataSetResponse();
      //expect(instance).to.be.a(AwsDataExchange.GetDataSetResponse);
    });
