...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.LFResourceDetailsDatabase();
  });
  ...
  describe('LFResourceDetailsDatabase', function() {
    it('should create an instance of LFResourceDetailsDatabase', function() {
      // uncomment below and update the code to test LFResourceDetailsDatabase
      //var instance = new AwsDataExchange.LFResourceDetailsDatabase();
      //expect(instance).to.be.a(AwsDataExchange.LFResourceDetailsDatabase);
    });
