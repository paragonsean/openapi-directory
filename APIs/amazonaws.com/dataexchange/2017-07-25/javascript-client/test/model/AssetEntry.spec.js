...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.AssetEntry();
  });
  ...
  describe('AssetEntry', function() {
    it('should create an instance of AssetEntry', function() {
      // uncomment below and update the code to test AssetEntry
      //var instance = new AwsDataExchange.AssetEntry();
      //expect(instance).to.be.a(AwsDataExchange.AssetEntry);
    });
