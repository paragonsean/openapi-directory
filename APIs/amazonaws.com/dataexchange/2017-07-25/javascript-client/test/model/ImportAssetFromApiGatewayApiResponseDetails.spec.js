...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.ImportAssetFromApiGatewayApiResponseDetails();
  });
  ...
  describe('ImportAssetFromApiGatewayApiResponseDetails', function() {
    it('should create an instance of ImportAssetFromApiGatewayApiResponseDetails', function() {
      // uncomment below and update the code to test ImportAssetFromApiGatewayApiResponseDetails
      //var instance = new AwsDataExchange.ImportAssetFromApiGatewayApiResponseDetails();
      //expect(instance).to.be.a(AwsDataExchange.ImportAssetFromApiGatewayApiResponseDetails);
    });
