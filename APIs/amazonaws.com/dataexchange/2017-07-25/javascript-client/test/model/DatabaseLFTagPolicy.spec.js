...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.DatabaseLFTagPolicy();
  });
  ...
  describe('DatabaseLFTagPolicy', function() {
    it('should create an instance of DatabaseLFTagPolicy', function() {
      // uncomment below and update the code to test DatabaseLFTagPolicy
      //var instance = new AwsDataExchange.DatabaseLFTagPolicy();
      //expect(instance).to.be.a(AwsDataExchange.DatabaseLFTagPolicy);
    });
