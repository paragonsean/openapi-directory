...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.RedshiftDataShareAssetSourceEntry();
  });
  ...
  describe('RedshiftDataShareAssetSourceEntry', function() {
    it('should create an instance of RedshiftDataShareAssetSourceEntry', function() {
      // uncomment below and update the code to test RedshiftDataShareAssetSourceEntry
      //var instance = new AwsDataExchange.RedshiftDataShareAssetSourceEntry();
      //expect(instance).to.be.a(AwsDataExchange.RedshiftDataShareAssetSourceEntry);
    });
