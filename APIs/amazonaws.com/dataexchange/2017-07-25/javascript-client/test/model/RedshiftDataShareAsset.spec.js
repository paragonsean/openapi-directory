...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.RedshiftDataShareAsset();
  });
  ...
  describe('RedshiftDataShareAsset', function() {
    it('should create an instance of RedshiftDataShareAsset', function() {
      // uncomment below and update the code to test RedshiftDataShareAsset
      //var instance = new AwsDataExchange.RedshiftDataShareAsset();
      //expect(instance).to.be.a(AwsDataExchange.RedshiftDataShareAsset);
    });
