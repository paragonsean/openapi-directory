...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.GetAssetResponse();
  });
  ...
  describe('GetAssetResponse', function() {
    it('should create an instance of GetAssetResponse', function() {
      // uncomment below and update the code to test GetAssetResponse
      //var instance = new AwsDataExchange.GetAssetResponse();
      //expect(instance).to.be.a(AwsDataExchange.GetAssetResponse);
    });
