...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.ListJobsResponse();
  });
  ...
  describe('ListJobsResponse', function() {
    it('should create an instance of ListJobsResponse', function() {
      ...
      //var instance = new AwsDataExchange.ListJobsResponse();
      //expect(instance).to.be.a(AwsDataExchange.ListJobsResponse);
    });
