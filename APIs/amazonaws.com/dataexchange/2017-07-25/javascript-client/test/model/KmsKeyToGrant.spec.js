...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.KmsKeyToGrant();
  });
  ...
  describe('KmsKeyToGrant', function() {
    it('should create an instance of KmsKeyToGrant', function() {
      // uncomment below and update the code to test KmsKeyToGrant
      //var instance = new AwsDataExchange.KmsKeyToGrant();
      //expect(instance).to.be.a(AwsDataExchange.KmsKeyToGrant);
    });
