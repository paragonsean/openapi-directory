...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.ImportAssetsFromRedshiftDataSharesRequestDetails();
  });
  ...
  describe('ImportAssetsFromRedshiftDataSharesRequestDetails', function() {
    it('should create an instance of ImportAssetsFromRedshiftDataSharesRequestDetails', function() {
      // uncomment below and update the code to test ImportAssetsFromRedshiftDataSharesRequestDetails
      //var instance = new AwsDataExchange.ImportAssetsFromRedshiftDataSharesRequestDetails();
      //expect(instance).to.be.a(AwsDataExchange.ImportAssetsFromRedshiftDataSharesRequestDetails);
    });
