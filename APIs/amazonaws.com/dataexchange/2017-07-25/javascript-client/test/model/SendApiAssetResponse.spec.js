...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.SendApiAssetResponse();
  });
  ...
  describe('SendApiAssetResponse', function() {
    it('should create an instance of SendApiAssetResponse', function() {
      // uncomment below and update the code to test SendApiAssetResponse
      //var instance = new AwsDataExchange.SendApiAssetResponse();
      //expect(instance).to.be.a(AwsDataExchange.SendApiAssetResponse);
    });
