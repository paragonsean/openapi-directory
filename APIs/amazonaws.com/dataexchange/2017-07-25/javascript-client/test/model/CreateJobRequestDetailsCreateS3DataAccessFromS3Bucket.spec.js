...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.CreateJobRequestDetailsCreateS3DataAccessFromS3Bucket();
  });
  ...
  describe('CreateJobRequestDetailsCreateS3DataAccessFromS3Bucket', function() {
    it('should create an instance of CreateJobRequestDetailsCreateS3DataAccessFromS3Bucket', function() {
      // uncomment below and update the code to test CreateJobRequestDetailsCreateS3DataAccessFromS3Bucket
      //var instance = new AwsDataExchange.CreateJobRequestDetailsCreateS3DataAccessFromS3Bucket();
      //expect(instance).to.be.a(AwsDataExchange.CreateJobRequestDetailsCreateS3DataAccessFromS3Bucket);
    });
