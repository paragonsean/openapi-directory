...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.CreateRevisionRequest();
  });
  ...
  describe('CreateRevisionRequest', function() {
    it('should create an instance of CreateRevisionRequest', function() {
      // uncomment below and update the code to test CreateRevisionRequest
      //var instance = new AwsDataExchange.CreateRevisionRequest();
      //expect(instance).to.be.a(AwsDataExchange.CreateRevisionRequest);
    });
