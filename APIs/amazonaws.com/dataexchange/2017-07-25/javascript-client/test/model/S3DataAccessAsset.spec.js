...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.S3DataAccessAsset();
  });
  ...
  describe('S3DataAccessAsset', function() {
    it('should create an instance of S3DataAccessAsset', function() {
      // uncomment below and update the code to test S3DataAccessAsset
      //var instance = new AwsDataExchange.S3DataAccessAsset();
      //expect(instance).to.be.a(AwsDataExchange.S3DataAccessAsset);
    });
