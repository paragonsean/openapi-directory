...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.AssetDetailsLakeFormationDataPermissionAsset();
  });
  ...
  describe('AssetDetailsLakeFormationDataPermissionAsset', function() {
    it('should create an instance of AssetDetailsLakeFormationDataPermissionAsset', function() {
      // uncomment below and update the code to test AssetDetailsLakeFormationDataPermissionAsset
      //var instance = new AwsDataExchange.AssetDetailsLakeFormationDataPermissionAsset();
      //expect(instance).to.be.a(AwsDataExchange.AssetDetailsLakeFormationDataPermissionAsset);
    });
