...
(function(root, factory) {
  ...
  describe('LFPermission', function() {
    it('should create an instance of LFPermission', function() {
      // uncomment below and update the code to test LFPermission
      //var instance = new AwsDataExchange.LFPermission();
      //expect(instance).to.be.a(AwsDataExchange.LFPermission);
    });
