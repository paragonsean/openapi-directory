...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.CreateJobRequestDetailsExportAssetsToS3();
  });
  ...
  describe('CreateJobRequestDetailsExportAssetsToS3', function() {
    it('should create an instance of CreateJobRequestDetailsExportAssetsToS3', function() {
      // uncomment below and update the code to test CreateJobRequestDetailsExportAssetsToS3
      //var instance = new AwsDataExchange.CreateJobRequestDetailsExportAssetsToS3();
      //expect(instance).to.be.a(AwsDataExchange.CreateJobRequestDetailsExportAssetsToS3);
    });
