...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.CreateJobRequestDetailsExportRevisionsToS3();
  });
  ...
  describe('CreateJobRequestDetailsExportRevisionsToS3', function() {
    it('should create an instance of CreateJobRequestDetailsExportRevisionsToS3', function() {
      // uncomment below and update the code to test CreateJobRequestDetailsExportRevisionsToS3
      //var instance = new AwsDataExchange.CreateJobRequestDetailsExportRevisionsToS3();
      //expect(instance).to.be.a(AwsDataExchange.CreateJobRequestDetailsExportRevisionsToS3);
    });
