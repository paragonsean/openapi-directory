...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.CreateS3DataAccessFromS3BucketRequestDetails();
  });
  ...
  describe('CreateS3DataAccessFromS3BucketRequestDetails', function() {
    it('should create an instance of CreateS3DataAccessFromS3BucketRequestDetails', function() {
      // uncomment below and update the code to test CreateS3DataAccessFromS3BucketRequestDetails
      //var instance = new AwsDataExchange.CreateS3DataAccessFromS3BucketRequestDetails();
      //expect(instance).to.be.a(AwsDataExchange.CreateS3DataAccessFromS3BucketRequestDetails);
    });
