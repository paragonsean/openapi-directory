...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.CreateEventActionRequestAction();
  });
  ...
  describe('CreateEventActionRequestAction', function() {
    it('should create an instance of CreateEventActionRequestAction', function() {
      // uncomment below and update the code to test CreateEventActionRequestAction
      //var instance = new AwsDataExchange.CreateEventActionRequestAction();
      //expect(instance).to.be.a(AwsDataExchange.CreateEventActionRequestAction);
    });

    it('should have the property exportRevisionToS3 (base name: "ExportRevisionToS3")', function() {
      // uncomment below and update the code to test the property exportRevisionToS3
      //var instance = new AwsDataExchange.CreateEventActionRequestAction();
