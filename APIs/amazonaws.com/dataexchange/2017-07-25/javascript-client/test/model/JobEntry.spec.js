...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.JobEntry();
  });
  ...
  describe('JobEntry', function() {
    it('should create an instance of JobEntry', function() {
      // uncomment below and update the code to test JobEntry
      //var instance = new AwsDataExchange.JobEntry();
      //expect(instance).to.be.a(AwsDataExchange.JobEntry);
    });
