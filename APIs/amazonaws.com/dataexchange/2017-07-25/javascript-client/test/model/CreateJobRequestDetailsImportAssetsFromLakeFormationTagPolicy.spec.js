...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.CreateJobRequestDetailsImportAssetsFromLakeFormationTagPolicy();
  });
  ...
  describe('CreateJobRequestDetailsImportAssetsFromLakeFormationTagPolicy', function() {
    it('should create an instance of CreateJobRequestDetailsImportAssetsFromLakeFormationTagPolicy', function() {
      // uncomment below and update the code to test CreateJobRequestDetailsImportAssetsFromLakeFormationTagPolicy
      //var instance = new AwsDataExchange.CreateJobRequestDetailsImportAssetsFromLakeFormationTagPolicy();
      //expect(instance).to.be.a(AwsDataExchange.CreateJobRequestDetailsImportAssetsFromLakeFormationTagPolicy);
    });
