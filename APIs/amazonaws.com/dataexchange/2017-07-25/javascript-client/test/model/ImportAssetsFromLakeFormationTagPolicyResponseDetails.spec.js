...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.ImportAssetsFromLakeFormationTagPolicyResponseDetails();
  });
  ...
  describe('ImportAssetsFromLakeFormationTagPolicyResponseDetails', function() {
    it('should create an instance of ImportAssetsFromLakeFormationTagPolicyResponseDetails', function() {
      // uncomment below and update the code to test ImportAssetsFromLakeFormationTagPolicyResponseDetails
      //var instance = new AwsDataExchange.ImportAssetsFromLakeFormationTagPolicyResponseDetails();
      //expect(instance).to.be.a(AwsDataExchange.ImportAssetsFromLakeFormationTagPolicyResponseDetails);
    });
