...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.AutoExportRevisionToS3RequestDetailsEncryption();
  });
  ...
  describe('AutoExportRevisionToS3RequestDetailsEncryption', function() {
    it('should create an instance of AutoExportRevisionToS3RequestDetailsEncryption', function() {
      // uncomment below and update the code to test AutoExportRevisionToS3RequestDetailsEncryption
      //var instance = new AwsDataExchange.AutoExportRevisionToS3RequestDetailsEncryption();
      //expect(instance).to.be.a(AwsDataExchange.AutoExportRevisionToS3RequestDetailsEncryption);
    });
