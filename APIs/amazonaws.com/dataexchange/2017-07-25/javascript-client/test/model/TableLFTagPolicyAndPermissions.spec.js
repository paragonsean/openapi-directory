...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.TableLFTagPolicyAndPermissions();
  });
  ...
  describe('TableLFTagPolicyAndPermissions', function() {
    it('should create an instance of TableLFTagPolicyAndPermissions', function() {
      // uncomment below and update the code to test TableLFTagPolicyAndPermissions
      //var instance = new AwsDataExchange.TableLFTagPolicyAndPermissions();
      //expect(instance).to.be.a(AwsDataExchange.TableLFTagPolicyAndPermissions);
    });
