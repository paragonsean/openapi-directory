...
(function(root, factory) {
  ...
  describe('DatabaseLFTagPolicyPermission', function() {
    it('should create an instance of DatabaseLFTagPolicyPermission', function() {
      // uncomment below and update the code to test DatabaseLFTagPolicyPermission
      //var instance = new AwsDataExchange.DatabaseLFTagPolicyPermission();
      //expect(instance).to.be.a(AwsDataExchange.DatabaseLFTagPolicyPermission);
    });
