...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.LakeFormationDataPermissionDetailsLFTagPolicy();
  });
  ...
  describe('LakeFormationDataPermissionDetailsLFTagPolicy', function() {
    it('should create an instance of LakeFormationDataPermissionDetailsLFTagPolicy', function() {
      // uncomment below and update the code to test LakeFormationDataPermissionDetailsLFTagPolicy
      //var instance = new AwsDataExchange.LakeFormationDataPermissionDetailsLFTagPolicy();
      //expect(instance).to.be.a(AwsDataExchange.LakeFormationDataPermissionDetailsLFTagPolicy);
    });
