...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.AssetDetailsRedshiftDataShareAsset();
  });
  ...
  describe('AssetDetailsRedshiftDataShareAsset', function() {
    it('should create an instance of AssetDetailsRedshiftDataShareAsset', function() {
      // uncomment below and update the code to test AssetDetailsRedshiftDataShareAsset
      //var instance = new AwsDataExchange.AssetDetailsRedshiftDataShareAsset();
      //expect(instance).to.be.a(AwsDataExchange.AssetDetailsRedshiftDataShareAsset);
    });
