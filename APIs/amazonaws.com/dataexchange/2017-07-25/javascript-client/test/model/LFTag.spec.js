...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.LFTag();
  });
  ...
  describe('LFTag', function() {
    it('should create an instance of LFTag', function() {
      // uncomment below and update the code to test LFTag
      //var instance = new AwsDataExchange.LFTag();
      //expect(instance).to.be.a(AwsDataExchange.LFTag);
    });
