...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.Details();
  });
  ...
  describe('Details', function() {
    it('should create an instance of Details', function() {
      ...
      //var instance = new AwsDataExchange.Details();
      //expect(instance).to.be.a(AwsDataExchange.Details);
    });

    it('should have the property importAssetFromSignedUrlJobErrorDetails (base name: "ImportAssetFromSignedUrlJobErrorDetails")', function() {
      // uncomment below and update the code to test the property importAssetFromSignedUrlJobErrorDetails
      //var instance = new AwsDataExchange.Details();
      //expect(instance).to.be();
    });

    it('should have the property importAssetsFromS3JobErrorDetails (base name: "ImportAssetsFromS3JobErrorDetails")', function() {
      // uncomment below and update the code to test the property importAssetsFromS3JobErrorDetails
      //var instance = new AwsDataExchange.Details();
      //expect(instance).to.be();
    });
