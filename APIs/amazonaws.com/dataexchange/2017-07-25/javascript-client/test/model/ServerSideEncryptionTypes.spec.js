...
(function(root, factory) {
  ...
  describe('ServerSideEncryptionTypes', function() {
    it('should create an instance of ServerSideEncryptionTypes', function() {
      // uncomment below and update the code to test ServerSideEncryptionTypes
      //var instance = new AwsDataExchange.ServerSideEncryptionTypes();
      //expect(instance).to.be.a(AwsDataExchange.ServerSideEncryptionTypes);
    });
