...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.CreateS3DataAccessFromS3BucketResponseDetails();
  });
  ...
  describe('CreateS3DataAccessFromS3BucketResponseDetails', function() {
    it('should create an instance of CreateS3DataAccessFromS3BucketResponseDetails', function() {
      // uncomment below and update the code to test CreateS3DataAccessFromS3BucketResponseDetails
      //var instance = new AwsDataExchange.CreateS3DataAccessFromS3BucketResponseDetails();
      //expect(instance).to.be.a(AwsDataExchange.CreateS3DataAccessFromS3BucketResponseDetails);
    });
