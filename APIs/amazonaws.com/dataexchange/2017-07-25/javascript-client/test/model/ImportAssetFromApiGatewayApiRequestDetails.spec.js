...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsDataExchange.ImportAssetFromApiGatewayApiRequestDetails();
  });
  ...
  describe('ImportAssetFromApiGatewayApiRequestDetails', function() {
    it('should create an instance of ImportAssetFromApiGatewayApiRequestDetails', function() {
      // uncomment below and update the code to test ImportAssetFromApiGatewayApiRequestDetails
      //var instance = new AwsDataExchange.ImportAssetFromApiGatewayApiRequestDetails();
      //expect(instance).to.be.a(AwsDataExchange.ImportAssetFromApiGatewayApiRequestDetails);
    });
