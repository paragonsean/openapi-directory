...
/**
 * The S3SnapshotAsset model module.
 * @module model/S3SnapshotAsset
 * @version 2017-07-25
 */
class S3SnapshotAsset {
    /**
     * Constructs a new <code>S3SnapshotAsset</code>.
     * The Amazon S3 object that is the asset.
     * @alias module:model/S3SnapshotAsset
     * @param size {Number} 
     */
    constructor(size) { 
        
        S3SnapshotAsset.initialize(this, size);
    }
    ...
    /**
     * Constructs a <code>S3SnapshotAsset</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/S3SnapshotAsset} obj Optional instance to populate.
     * @return {module:model/S3SnapshotAsset} The populated <code>S3SnapshotAsset</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new S3SnapshotAsset();
    ...
    /**
     * Validates the JSON data with respect to <code>S3SnapshotAsset</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>S3SnapshotAsset</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of S3SnapshotAsset.RequiredProperties) {
...
S3SnapshotAsset.RequiredProperties = ["Size"];

/**
 * @member {Number} Size
 */
S3SnapshotAsset.prototype['Size'] = undefined;
...
export default S3SnapshotAsset;
