...
/**
 * The DatabaseLFTagPolicy model module.
 * @module model/DatabaseLFTagPolicy
 * @version 2017-07-25
 */
class DatabaseLFTagPolicy {
    /**
     * Constructs a new <code>DatabaseLFTagPolicy</code>.
     * The LF-tag policy for database resources.
     * @alias module:model/DatabaseLFTagPolicy
    ...
    /**
     * Constructs a <code>DatabaseLFTagPolicy</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DatabaseLFTagPolicy} obj Optional instance to populate.
     * @return {module:model/DatabaseLFTagPolicy} The populated <code>DatabaseLFTagPolicy</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DatabaseLFTagPolicy();
    ...
    /**
     * Validates the JSON data with respect to <code>DatabaseLFTagPolicy</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DatabaseLFTagPolicy</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DatabaseLFTagPolicy.RequiredProperties) {
...
DatabaseLFTagPolicy.RequiredProperties = ["Expression"];
...
export default DatabaseLFTagPolicy;
