...
* @readonly
*/
export default class LFPermission {
    ...
    /**
    * Returns a <code>LFPermission</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/LFPermission} The enum <code>LFPermission</code> value.
    */
