...
* @readonly
*/
export default class LFResourceType {
    ...
    /**
    * Returns a <code>LFResourceType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/LFResourceType} The enum <code>LFResourceType</code> value.
    */
