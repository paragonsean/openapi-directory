...
* @readonly
*/
export default class ServerSideEncryptionTypes {
    ...
    /**
    * Returns a <code>ServerSideEncryptionTypes</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ServerSideEncryptionTypes} The enum <code>ServerSideEncryptionTypes</code> value.
    */
