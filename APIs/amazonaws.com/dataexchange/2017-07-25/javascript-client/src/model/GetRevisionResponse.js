...
/**
 * The GetRevisionResponse model module.
 * @module model/GetRevisionResponse
 * @version 2017-07-25
 */
class GetRevisionResponse {
    /**
     * Constructs a new <code>GetRevisionResponse</code>.
     * @alias module:model/GetRevisionResponse
     */
    constructor() { 
        
        GetRevisionResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetRevisionResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetRevisionResponse} obj Optional instance to populate.
     * @return {module:model/GetRevisionResponse} The populated <code>GetRevisionResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetRevisionResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>GetRevisionResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetRevisionResponse</code>.
     */
 ...
 * @member {String} Arn
 */
GetRevisionResponse.prototype['Arn'] = undefined;

/**
 * @member {String} Comment
 */
GetRevisionResponse.prototype['Comment'] = undefined;

/**
 * @member {Date} CreatedAt
 */
GetRevisionResponse.prototype['CreatedAt'] = undefined;

/**
 * @member {String} DataSetId
 */
GetRevisionResponse.prototype['DataSetId'] = undefined;

/**
 * @member {Boolean} Finalized
 */
GetRevisionResponse.prototype['Finalized'] = undefined;

/**
 * @member {String} Id
 */
GetRevisionResponse.prototype['Id'] = undefined;

/**
 * @member {String} SourceId
 */
GetRevisionResponse.prototype['SourceId'] = undefined;

/**
 * @member {Object} Tags
 */
GetRevisionResponse.prototype['Tags'] = undefined;

/**
 * @member {Date} UpdatedAt
 */
GetRevisionResponse.prototype['UpdatedAt'] = undefined;

/**
 * @member {String} RevocationComment
 */
GetRevisionResponse.prototype['RevocationComment'] = undefined;

/**
 * @member {Boolean} Revoked
 */
GetRevisionResponse.prototype['Revoked'] = undefined;

/**
 * @member {Date} RevokedAt
 */
GetRevisionResponse.prototype['RevokedAt'] = undefined;
...
export default GetRevisionResponse;
