...
/**
 * The OriginDetails model module.
 * @module model/OriginDetails
 * @version 2017-07-25
 */
class OriginDetails {
    /**
     * Constructs a new <code>OriginDetails</code>.
     * Details about the origin of the data set.
     * @alias module:model/OriginDetails
    ...
    /**
     * Constructs a <code>OriginDetails</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OriginDetails} obj Optional instance to populate.
     * @return {module:model/OriginDetails} The populated <code>OriginDetails</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OriginDetails();
    ...
    /**
     * Validates the JSON data with respect to <code>OriginDetails</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OriginDetails</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of OriginDetails.RequiredProperties) {
...
OriginDetails.RequiredProperties = ["ProductId"];
