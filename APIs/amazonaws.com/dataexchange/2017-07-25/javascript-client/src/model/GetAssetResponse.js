...
/**
 * The GetAssetResponse model module.
 * @module model/GetAssetResponse
 * @version 2017-07-25
 */
class GetAssetResponse {
    /**
     * Constructs a new <code>GetAssetResponse</code>.
     * @alias module:model/GetAssetResponse
     */
    constructor() { 
        
        GetAssetResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetAssetResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetAssetResponse} obj Optional instance to populate.
     * @return {module:model/GetAssetResponse} The populated <code>GetAssetResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetAssetResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>GetAssetResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetAssetResponse</code>.
     */
 ...
 * @member {String} Arn
 */
GetAssetResponse.prototype['Arn'] = undefined;

/**
 * @member {module:model/GetAssetResponseAssetDetails} AssetDetails
 */
GetAssetResponse.prototype['AssetDetails'] = undefined;

/**
 * @member {module:model/AssetType} AssetType
 */
GetAssetResponse.prototype['AssetType'] = undefined;

/**
 * @member {Date} CreatedAt
 */
GetAssetResponse.prototype['CreatedAt'] = undefined;

/**
 * @member {String} DataSetId
 */
GetAssetResponse.prototype['DataSetId'] = undefined;

/**
 * @member {String} Id
 */
GetAssetResponse.prototype['Id'] = undefined;

/**
 * @member {String} Name
 */
GetAssetResponse.prototype['Name'] = undefined;

/**
 * @member {String} RevisionId
 */
GetAssetResponse.prototype['RevisionId'] = undefined;

/**
 * @member {String} SourceId
 */
GetAssetResponse.prototype['SourceId'] = undefined;

/**
 * @member {Date} UpdatedAt
 */
GetAssetResponse.prototype['UpdatedAt'] = undefined;
...
export default GetAssetResponse;
