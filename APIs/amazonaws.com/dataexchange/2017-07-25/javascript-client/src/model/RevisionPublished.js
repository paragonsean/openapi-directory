...
/**
 * The RevisionPublished model module.
 * @module model/RevisionPublished
 * @version 2017-07-25
 */
class RevisionPublished {
    /**
     * Constructs a new <code>RevisionPublished</code>.
     * Information about the published revision.
     * @alias module:model/RevisionPublished
    ...
    /**
     * Constructs a <code>RevisionPublished</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RevisionPublished} obj Optional instance to populate.
     * @return {module:model/RevisionPublished} The populated <code>RevisionPublished</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RevisionPublished();
    ...
    /**
     * Validates the JSON data with respect to <code>RevisionPublished</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RevisionPublished</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RevisionPublished.RequiredProperties) {
...
RevisionPublished.RequiredProperties = ["DataSetId"];
...
export default RevisionPublished;
