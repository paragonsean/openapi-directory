...
* @readonly
*/
export default class DatabaseLFTagPolicyPermission {
    ...
    /**
    * Returns a <code>DatabaseLFTagPolicyPermission</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/DatabaseLFTagPolicyPermission} The enum <code>DatabaseLFTagPolicyPermission</code> value.
    */
