...
* @readonly
*/
export default class JobErrorResourceTypes {
    ...
    /**
    * Returns a <code>JobErrorResourceTypes</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/JobErrorResourceTypes} The enum <code>JobErrorResourceTypes</code> value.
    */
