...
* @readonly
*/
export default class TableTagPolicyLFPermission {
    ...
    /**
    * Returns a <code>TableTagPolicyLFPermission</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/TableTagPolicyLFPermission} The enum <code>TableTagPolicyLFPermission</code> value.
    */
