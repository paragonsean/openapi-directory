...
* @readonly
*/
export default class LakeFormationDataPermissionType {
    ...
    /**
    * Returns a <code>LakeFormationDataPermissionType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/LakeFormationDataPermissionType} The enum <code>LakeFormationDataPermissionType</code> value.
    */
