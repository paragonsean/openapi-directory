...
/**
 * The CreateRevisionRequest model module.
 * @module model/CreateRevisionRequest
 * @version 2017-07-25
 */
class CreateRevisionRequest {
    /**
     * Constructs a new <code>CreateRevisionRequest</code>.
     * @alias module:model/CreateRevisionRequest
     */
    constructor() { 
        
        CreateRevisionRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateRevisionRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateRevisionRequest} obj Optional instance to populate.
     * @return {module:model/CreateRevisionRequest} The populated <code>CreateRevisionRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateRevisionRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateRevisionRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateRevisionRequest</code>.
     */
 ...
 */
CreateRevisionRequest.prototype['Comment'] = undefined;

/**
 * A revision tag is an optional label that you can assign to a revision when you create it. Each tag consists of a key and an optional value, both of which you define. When you use tagging, you can also use tag-based access control in IAM policies to control access to these data sets and revisions.
 * @member {Object.<String, String>} Tags
 */
CreateRevisionRequest.prototype['Tags'] = undefined;
...
export default CreateRevisionRequest;
