...
/**
 * The AssetDestinationEntry model module.
 * @module model/AssetDestinationEntry
 * @version 2017-07-25
 */
class AssetDestinationEntry {
    /**
     * Constructs a new <code>AssetDestinationEntry</code>.
     * The destination for the asset.
     * @alias module:model/AssetDestinationEntry
     * @param assetId {String} 
     * @param bucket {String} 
     */
    constructor(assetId, bucket) { 
        
        AssetDestinationEntry.initialize(this, assetId, bucket);
    }
     ...
     */
    static initialize(obj, assetId, bucket) { 
        obj['AssetId'] = assetId;
        obj['Bucket'] = bucket;
    }

    /**
     * Constructs a <code>AssetDestinationEntry</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AssetDestinationEntry} obj Optional instance to populate.
     * @return {module:model/AssetDestinationEntry} The populated <code>AssetDestinationEntry</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AssetDestinationEntry();
    ...
    /**
     * Validates the JSON data with respect to <code>AssetDestinationEntry</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AssetDestinationEntry</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AssetDestinationEntry.RequiredProperties) {
...
AssetDestinationEntry.RequiredProperties = ["AssetId", "Bucket"];

/**
 * @member {String} AssetId
 */
AssetDestinationEntry.prototype['AssetId'] = undefined;

/**
 * @member {String} Bucket
 */
AssetDestinationEntry.prototype['Bucket'] = undefined;

/**
 * @member {String} Key
 */
AssetDestinationEntry.prototype['Key'] = undefined;
...
export default AssetDestinationEntry;
