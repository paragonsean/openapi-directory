...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://dataexchange.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://dataexchange.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2017-07-25/Javascript'
        };
