...
/**
 * The DateOptions model module.
 * @module model/DateOptions
 * @version 2013-01-01
 */
class DateOptions {
    /**
     * Constructs a new <code>DateOptions</code>.
     ...
     * @alias module:model/DateOptions
     */
    constructor() { 
        
        DateOptions.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DateOptions</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DateOptions} obj Optional instance to populate.
     * @return {module:model/DateOptions} The populated <code>DateOptions</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DateOptions();
    ...
    /**
     * Validates the JSON data with respect to <code>DateOptions</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DateOptions</code>.
     */
 ...
 */
DateOptions.prototype['DefaultValue'] = undefined;
 ...
 */
DateOptions.prototype['SourceField'] = undefined;

/**
 * @member {Boolean} FacetEnabled
 */
DateOptions.prototype['FacetEnabled'] = undefined;

/**
 * @member {Boolean} SearchEnabled
 */
DateOptions.prototype['SearchEnabled'] = undefined;

/**
 * @member {Boolean} ReturnEnabled
 */
DateOptions.prototype['ReturnEnabled'] = undefined;

/**
 * @member {Boolean} SortEnabled
 */
DateOptions.prototype['SortEnabled'] = undefined;
