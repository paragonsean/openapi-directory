...
/**
 * The DefineIndexFieldRequestIndexField model module.
 * @module model/DefineIndexFieldRequestIndexField
 * @version 2013-01-01
 */
class DefineIndexFieldRequestIndexField {
    /**
     * Constructs a new <code>DefineIndexFieldRequestIndexField</code>.
     * @alias module:model/DefineIndexFieldRequestIndexField
     * @implements module:model/IndexField
    ...
    constructor(indexFieldName, indexFieldType) { 
        ...
        DefineIndexFieldRequestIndexField.initialize(this, indexFieldName, indexFieldType);
    }
    ...
    /**
     * Constructs a <code>DefineIndexFieldRequestIndexField</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DefineIndexFieldRequestIndexField} obj Optional instance to populate.
     * @return {module:model/DefineIndexFieldRequestIndexField} The populated <code>DefineIndexFieldRequestIndexField</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DefineIndexFieldRequestIndexField();
            IndexField.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>DefineIndexFieldRequestIndexField</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DefineIndexFieldRequestIndexField</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DefineIndexFieldRequestIndexField.RequiredProperties) {
...
DefineIndexFieldRequestIndexField.RequiredProperties = ["IndexFieldName", "IndexFieldType"];

/**
 * @member {String} IndexFieldName
 */
DefineIndexFieldRequestIndexField.prototype['IndexFieldName'] = undefined;

/**
 * @member {module:model/IndexFieldType} IndexFieldType
 */
DefineIndexFieldRequestIndexField.prototype['IndexFieldType'] = undefined;

/**
 * @member {module:model/IntOptions} IntOptions
 */
DefineIndexFieldRequestIndexField.prototype['IntOptions'] = undefined;

/**
 * @member {module:model/DoubleOptions} DoubleOptions
 */
DefineIndexFieldRequestIndexField.prototype['DoubleOptions'] = undefined;

/**
 * @member {module:model/LiteralOptions} LiteralOptions
 */
DefineIndexFieldRequestIndexField.prototype['LiteralOptions'] = undefined;

/**
 * @member {module:model/TextOptions} TextOptions
 */
DefineIndexFieldRequestIndexField.prototype['TextOptions'] = undefined;

/**
 * @member {module:model/DateOptions} DateOptions
 */
DefineIndexFieldRequestIndexField.prototype['DateOptions'] = undefined;

/**
 * @member {module:model/LatLonOptions} LatLonOptions
 */
DefineIndexFieldRequestIndexField.prototype['LatLonOptions'] = undefined;

/**
 * @member {module:model/IntArrayOptions} IntArrayOptions
 */
DefineIndexFieldRequestIndexField.prototype['IntArrayOptions'] = undefined;

/**
 * @member {module:model/DoubleArrayOptions} DoubleArrayOptions
 */
DefineIndexFieldRequestIndexField.prototype['DoubleArrayOptions'] = undefined;

/**
 * @member {module:model/LiteralArrayOptions} LiteralArrayOptions
 */
DefineIndexFieldRequestIndexField.prototype['LiteralArrayOptions'] = undefined;

/**
 * @member {module:model/TextArrayOptions} TextArrayOptions
 */
DefineIndexFieldRequestIndexField.prototype['TextArrayOptions'] = undefined;

/**
 * @member {module:model/DateArrayOptions} DateArrayOptions
 */
DefineIndexFieldRequestIndexField.prototype['DateArrayOptions'] = undefined;


// Implement IndexField interface:
/**
 * @member {String} IndexFieldName
 */
...
export default DefineIndexFieldRequestIndexField;
