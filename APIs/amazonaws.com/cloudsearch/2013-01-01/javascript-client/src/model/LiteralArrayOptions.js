...
/**
 * The LiteralArrayOptions model module.
 * @module model/LiteralArrayOptions
 * @version 2013-01-01
 */
class LiteralArrayOptions {
    /**
     * Constructs a new <code>LiteralArrayOptions</code>.
     ...
     * @alias module:model/LiteralArrayOptions
     */
    constructor() { 
        
        LiteralArrayOptions.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LiteralArrayOptions</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LiteralArrayOptions} obj Optional instance to populate.
     * @return {module:model/LiteralArrayOptions} The populated <code>LiteralArrayOptions</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LiteralArrayOptions();
    ...
    /**
     * Validates the JSON data with respect to <code>LiteralArrayOptions</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LiteralArrayOptions</code>.
     */
 ...
 */
LiteralArrayOptions.prototype['DefaultValue'] = undefined;

/**
 * @member {String} SourceFields
 */
LiteralArrayOptions.prototype['SourceFields'] = undefined;

/**
 * @member {Boolean} FacetEnabled
 */
LiteralArrayOptions.prototype['FacetEnabled'] = undefined;

/**
 * @member {Boolean} SearchEnabled
 */
LiteralArrayOptions.prototype['SearchEnabled'] = undefined;

/**
 * @member {Boolean} ReturnEnabled
 */
LiteralArrayOptions.prototype['ReturnEnabled'] = undefined;
...
export default LiteralArrayOptions;
