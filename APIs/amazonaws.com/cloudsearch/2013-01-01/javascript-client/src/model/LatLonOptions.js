...
/**
 * The LatLonOptions model module.
 * @module model/LatLonOptions
 * @version 2013-01-01
 */
class LatLonOptions {
    /**
     * Constructs a new <code>LatLonOptions</code>.
     ...
     * @alias module:model/LatLonOptions
     */
    constructor() { 
        
        LatLonOptions.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LatLonOptions</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LatLonOptions} obj Optional instance to populate.
     * @return {module:model/LatLonOptions} The populated <code>LatLonOptions</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LatLonOptions();
    ...
    /**
     * Validates the JSON data with respect to <code>LatLonOptions</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LatLonOptions</code>.
     */
 ...
 */
LatLonOptions.prototype['DefaultValue'] = undefined;
 ...
 */
LatLonOptions.prototype['SourceField'] = undefined;

/**
 * @member {Boolean} FacetEnabled
 */
LatLonOptions.prototype['FacetEnabled'] = undefined;

/**
 * @member {Boolean} SearchEnabled
 */
LatLonOptions.prototype['SearchEnabled'] = undefined;

/**
 * @member {Boolean} ReturnEnabled
 */
LatLonOptions.prototype['ReturnEnabled'] = undefined;

/**
 * @member {Boolean} SortEnabled
 */
LatLonOptions.prototype['SortEnabled'] = undefined;
