...
/**
 * The IntArrayOptions model module.
 * @module model/IntArrayOptions
 * @version 2013-01-01
 */
class IntArrayOptions {
    /**
     * Constructs a new <code>IntArrayOptions</code>.
     ...
     * @alias module:model/IntArrayOptions
     */
    constructor() { 
        
        IntArrayOptions.initialize(this);
    }
    ...
    /**
     * Constructs a <code>IntArrayOptions</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IntArrayOptions} obj Optional instance to populate.
     * @return {module:model/IntArrayOptions} The populated <code>IntArrayOptions</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IntArrayOptions();
    ...
    /**
     * Validates the JSON data with respect to <code>IntArrayOptions</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IntArrayOptions</code>.
     */
 ...
 */
IntArrayOptions.prototype['DefaultValue'] = undefined;

/**
 * @member {String} SourceFields
 */
IntArrayOptions.prototype['SourceFields'] = undefined;

/**
 * @member {Boolean} FacetEnabled
 */
IntArrayOptions.prototype['FacetEnabled'] = undefined;

/**
 * @member {Boolean} SearchEnabled
 */
IntArrayOptions.prototype['SearchEnabled'] = undefined;

/**
 * @member {Boolean} ReturnEnabled
 */
IntArrayOptions.prototype['ReturnEnabled'] = undefined;
...
export default IntArrayOptions;
