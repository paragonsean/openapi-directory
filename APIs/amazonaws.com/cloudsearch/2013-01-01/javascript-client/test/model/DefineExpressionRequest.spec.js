...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudSearch.DefineExpressionRequest();
  });
  ...
  describe('DefineExpressionRequest', function() {
    it('should create an instance of DefineExpressionRequest', function() {
      // uncomment below and update the code to test DefineExpressionRequest
      //var instance = new AmazonCloudSearch.DefineExpressionRequest();
      //expect(instance).to.be.a(AmazonCloudSearch.DefineExpressionRequest);
    });
