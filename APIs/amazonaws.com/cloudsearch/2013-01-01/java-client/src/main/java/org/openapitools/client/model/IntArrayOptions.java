...
public class IntArrayOptions {
  ...
  public IntArrayOptions defaultValue(Integer defaultValue) {
  ...
  public IntArrayOptions sourceFields(String sourceFields) {
  ...
  public IntArrayOptions facetEnabled(Boolean facetEnabled) {
  ...
  public IntArrayOptions searchEnabled(Boolean searchEnabled) {
  ...
  public IntArrayOptions returnEnabled(Boolean returnEnabled) {
  ...
  public boolean equals(Object o) {
    ...
    IntArrayOptions intArrayOptions = (IntArrayOptions) o;
    return Objects.equals(this.defaultValue, intArrayOptions.defaultValue) &&
        Objects.equals(this.sourceFields, intArrayOptions.sourceFields) &&
        Objects.equals(this.facetEnabled, intArrayOptions.facetEnabled) &&
        Objects.equals(this.searchEnabled, intArrayOptions.searchEnabled) &&
        Objects.equals(this.returnEnabled, intArrayOptions.returnEnabled);
  }
  ...
  public String toString() {
    ...
    sb.append("class IntArrayOptions {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IntArrayOptions
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IntArrayOptions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IntArrayOptions is not found in the empty JSON string", IntArrayOptions.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IntArrayOptions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IntArrayOptions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IntArrayOptions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IntArrayOptions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IntArrayOptions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IntArrayOptions.class));

       return (TypeAdapter<T>) new TypeAdapter<IntArrayOptions>() {
           @Override
           public void write(JsonWriter out, IntArrayOptions value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IntArrayOptions read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IntArrayOptions given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IntArrayOptions
   * @throws IOException if the JSON string is invalid with respect to IntArrayOptions
   */
  public static IntArrayOptions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IntArrayOptions.class);
  }

  /**
   * Convert an instance of IntArrayOptions to an JSON string
   *
   * @return JSON string
   */
