...
public class LiteralArrayOptions {
  ...
  public LiteralArrayOptions defaultValue(String defaultValue) {
  ...
  public LiteralArrayOptions sourceFields(String sourceFields) {
  ...
  public LiteralArrayOptions facetEnabled(Boolean facetEnabled) {
  ...
  public LiteralArrayOptions searchEnabled(Boolean searchEnabled) {
  ...
  public LiteralArrayOptions returnEnabled(Boolean returnEnabled) {
  ...
  public boolean equals(Object o) {
    ...
    LiteralArrayOptions literalArrayOptions = (LiteralArrayOptions) o;
    return Objects.equals(this.defaultValue, literalArrayOptions.defaultValue) &&
        Objects.equals(this.sourceFields, literalArrayOptions.sourceFields) &&
        Objects.equals(this.facetEnabled, literalArrayOptions.facetEnabled) &&
        Objects.equals(this.searchEnabled, literalArrayOptions.searchEnabled) &&
        Objects.equals(this.returnEnabled, literalArrayOptions.returnEnabled);
  }
  ...
  public String toString() {
    ...
    sb.append("class LiteralArrayOptions {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LiteralArrayOptions
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LiteralArrayOptions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LiteralArrayOptions is not found in the empty JSON string", LiteralArrayOptions.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LiteralArrayOptions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LiteralArrayOptions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LiteralArrayOptions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LiteralArrayOptions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LiteralArrayOptions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LiteralArrayOptions.class));

       return (TypeAdapter<T>) new TypeAdapter<LiteralArrayOptions>() {
           @Override
           public void write(JsonWriter out, LiteralArrayOptions value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LiteralArrayOptions read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LiteralArrayOptions given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LiteralArrayOptions
   * @throws IOException if the JSON string is invalid with respect to LiteralArrayOptions
   */
  public static LiteralArrayOptions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LiteralArrayOptions.class);
  }

  /**
   * Convert an instance of LiteralArrayOptions to an JSON string
   *
   * @return JSON string
   */
