...
public class AnalysisScheme {
  ...
  public AnalysisScheme analysisSchemeName(String analysisSchemeName) {
  ...
  public AnalysisScheme analysisSchemeLanguage(AnalysisSchemeLanguage analysisSchemeLanguage) {
  ...
  public AnalysisScheme analysisOptions(AnalysisOptions analysisOptions) {
  ...
  public boolean equals(Object o) {
    ...
    AnalysisScheme analysisScheme = (AnalysisScheme) o;
    return Objects.equals(this.analysisSchemeName, analysisScheme.analysisSchemeName) &&
        Objects.equals(this.analysisSchemeLanguage, analysisScheme.analysisSchemeLanguage) &&
        Objects.equals(this.analysisOptions, analysisScheme.analysisOptions);
  }
  ...
  public String toString() {
    ...
    sb.append("class AnalysisScheme {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AnalysisScheme
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AnalysisScheme.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AnalysisScheme is not found in the empty JSON string", AnalysisScheme.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AnalysisScheme.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AnalysisScheme` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AnalysisScheme.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AnalysisScheme.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AnalysisScheme' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AnalysisScheme> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AnalysisScheme.class));

       return (TypeAdapter<T>) new TypeAdapter<AnalysisScheme>() {
           @Override
           public void write(JsonWriter out, AnalysisScheme value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AnalysisScheme read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AnalysisScheme given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AnalysisScheme
   * @throws IOException if the JSON string is invalid with respect to AnalysisScheme
   */
  public static AnalysisScheme fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AnalysisScheme.class);
  }

  /**
   * Convert an instance of AnalysisScheme to an JSON string
   *
   * @return JSON string
   */
