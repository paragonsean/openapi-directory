...
public class LatLonOptions {
  ...
  public LatLonOptions defaultValue(String defaultValue) {
  ...
  public LatLonOptions sourceField(String sourceField) {
  ...
  public LatLonOptions facetEnabled(Boolean facetEnabled) {
  ...
  public LatLonOptions searchEnabled(Boolean searchEnabled) {
  ...
  public LatLonOptions returnEnabled(Boolean returnEnabled) {
  ...
  public LatLonOptions sortEnabled(Boolean sortEnabled) {
  ...
  public boolean equals(Object o) {
    ...
    LatLonOptions latLonOptions = (LatLonOptions) o;
    return Objects.equals(this.defaultValue, latLonOptions.defaultValue) &&
        Objects.equals(this.sourceField, latLonOptions.sourceField) &&
        Objects.equals(this.facetEnabled, latLonOptions.facetEnabled) &&
        Objects.equals(this.searchEnabled, latLonOptions.searchEnabled) &&
        Objects.equals(this.returnEnabled, latLonOptions.returnEnabled) &&
        Objects.equals(this.sortEnabled, latLonOptions.sortEnabled);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to LatLonOptions
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LatLonOptions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LatLonOptions is not found in the empty JSON string", LatLonOptions.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LatLonOptions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LatLonOptions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LatLonOptions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LatLonOptions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LatLonOptions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LatLonOptions.class));

       return (TypeAdapter<T>) new TypeAdapter<LatLonOptions>() {
           @Override
           public void write(JsonWriter out, LatLonOptions value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LatLonOptions read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LatLonOptions given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LatLonOptions
   * @throws IOException if the JSON string is invalid with respect to LatLonOptions
   */
  public static LatLonOptions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LatLonOptions.class);
  }

  /**
   * Convert an instance of LatLonOptions to an JSON string
   *
   * @return JSON string
   */
