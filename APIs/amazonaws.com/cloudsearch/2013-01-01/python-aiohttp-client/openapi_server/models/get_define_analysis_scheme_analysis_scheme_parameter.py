...
class GETDefineAnalysisSchemeAnalysisSchemeParameter(Model):
    ...
    def __init__(self, analysis_scheme_name: str=None, analysis_scheme_language: AnalysisSchemeLanguage=None, analysis_options: AnalysisOptions=None):
        """GETDefineAnalysisSchemeAnalysisSchemeParameter - a model defined in OpenAPI

        :param analysis_scheme_name: The analysis_scheme_name of this GETDefineAnalysisSchemeAnalysisSchemeParameter.
        :param analysis_scheme_language: The analysis_scheme_language of this GETDefineAnalysisSchemeAnalysisSchemeParameter.
        :param analysis_options: The analysis_options of this GETDefineAnalysisSchemeAnalysisSchemeParameter.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'GETDefineAnalysisSchemeAnalysisSchemeParameter':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The GET_DefineAnalysisScheme_AnalysisScheme_parameter of this GETDefineAnalysisSchemeAnalysisSchemeParameter.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def analysis_scheme_name(self):
        """Gets the analysis_scheme_name of this GETDefineAnalysisSchemeAnalysisSchemeParameter.

        Names must begin with a letter and can contain the following characters: a-z (lowercase), 0-9, and _ (underscore).

        :return: The analysis_scheme_name of this GETDefineAnalysisSchemeAnalysisSchemeParameter.
        :rtype: str
        """
    ...
    def analysis_scheme_name(self, analysis_scheme_name):
        """Sets the analysis_scheme_name of this GETDefineAnalysisSchemeAnalysisSchemeParameter.
    ...
    def analysis_scheme_language(self):
        """Gets the analysis_scheme_language of this GETDefineAnalysisSchemeAnalysisSchemeParameter.


        :return: The analysis_scheme_language of this GETDefineAnalysisSchemeAnalysisSchemeParameter.
    ...
    def analysis_scheme_language(self, analysis_scheme_language):
        """Sets the analysis_scheme_language of this GETDefineAnalysisSchemeAnalysisSchemeParameter.
    ...
    def analysis_options(self):
        """Gets the analysis_options of this GETDefineAnalysisSchemeAnalysisSchemeParameter.


        :return: The analysis_options of this GETDefineAnalysisSchemeAnalysisSchemeParameter.
    ...
    def analysis_options(self, analysis_options):
        """Sets the analysis_options of this GETDefineAnalysisSchemeAnalysisSchemeParameter.
