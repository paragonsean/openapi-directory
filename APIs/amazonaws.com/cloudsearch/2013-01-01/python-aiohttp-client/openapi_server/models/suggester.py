...
class Suggester(Model):
    ...
    def __init__(self, suggester_name: str=None, document_suggester_options: DocumentSuggesterOptions=None):
        """Suggester - a model defined in OpenAPI

        :param suggester_name: The suggester_name of this Suggester.
        :param document_suggester_options: The document_suggester_options of this Suggester.
        """
        self.openapi_types = {
            'suggester_name': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'Suggester':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The Suggester of this Suggester.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def suggester_name(self):
        """Gets the suggester_name of this Suggester.

        Names must begin with a letter and can contain the following characters: a-z (lowercase), 0-9, and _ (underscore).

        :return: The suggester_name of this Suggester.
        :rtype: str
        """
    ...
    def suggester_name(self, suggester_name):
        """Sets the suggester_name of this Suggester.
    ...
    def document_suggester_options(self):
        """Gets the document_suggester_options of this Suggester.


        :return: The document_suggester_options of this Suggester.
    ...
    def document_suggester_options(self, document_suggester_options):
        """Sets the document_suggester_options of this Suggester.
