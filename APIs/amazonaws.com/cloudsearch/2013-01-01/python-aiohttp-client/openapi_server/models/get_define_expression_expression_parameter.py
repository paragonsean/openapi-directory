...
class GETDefineExpressionExpressionParameter(Model):
    ...
    def __init__(self, expression_name: str=None, expression_value: str=None):
        """GETDefineExpressionExpressionParameter - a model defined in OpenAPI

        :param expression_name: The expression_name of this GETDefineExpressionExpressionParameter.
        :param expression_value: The expression_value of this GETDefineExpressionExpressionParameter.
        """
        self.openapi_types = {
            'expression_name': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'GETDefineExpressionExpressionParameter':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The GET_DefineExpression_Expression_parameter of this GETDefineExpressionExpressionParameter.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def expression_name(self):
        """Gets the expression_name of this GETDefineExpressionExpressionParameter.

        Names must begin with a letter and can contain the following characters: a-z (lowercase), 0-9, and _ (underscore).

        :return: The expression_name of this GETDefineExpressionExpressionParameter.
        :rtype: str
        """
    ...
    def expression_name(self, expression_name):
        """Sets the expression_name of this GETDefineExpressionExpressionParameter.
    ...
    def expression_value(self):
        """Gets the expression_value of this GETDefineExpressionExpressionParameter.
        ...
        :return: The expression_value of this GETDefineExpressionExpressionParameter.
        :rtype: str
        """
    ...
    def expression_value(self, expression_value):
        """Sets the expression_value of this GETDefineExpressionExpressionParameter.
