...
class ExpressionStatusOptions(Model):
    ...
    def __init__(self, expression_name: str=None, expression_value: str=None):
        """ExpressionStatusOptions - a model defined in OpenAPI

        :param expression_name: The expression_name of this ExpressionStatusOptions.
        :param expression_value: The expression_value of this ExpressionStatusOptions.
        """
        self.openapi_types = {
            'expression_name': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ExpressionStatusOptions':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ExpressionStatus_Options of this ExpressionStatusOptions.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def expression_name(self):
        """Gets the expression_name of this ExpressionStatusOptions.

        Names must begin with a letter and can contain the following characters: a-z (lowercase), 0-9, and _ (underscore).

        :return: The expression_name of this ExpressionStatusOptions.
        :rtype: str
        """
    ...
    def expression_name(self, expression_name):
        """Sets the expression_name of this ExpressionStatusOptions.
    ...
    def expression_value(self):
        """Gets the expression_value of this ExpressionStatusOptions.
        ...
        :return: The expression_value of this ExpressionStatusOptions.
        :rtype: str
        """
    ...
    def expression_value(self, expression_value):
        """Sets the expression_value of this ExpressionStatusOptions.
