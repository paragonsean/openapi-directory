...
class IndexDocumentsRequest(Model):
    ...
    def __init__(self, domain_name: str=None):
        """IndexDocumentsRequest - a model defined in OpenAPI

        :param domain_name: The domain_name of this IndexDocumentsRequest.
        """
        self.openapi_types = {
            'domain_name': str
        }
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'IndexDocumentsRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The IndexDocumentsRequest of this IndexDocumentsRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def domain_name(self):
        """Gets the domain_name of this IndexDocumentsRequest.

        A string that represents the name of a domain. Domain names are unique across the domains owned by an account within an AWS region. Domain names start with a letter or number and can contain the following characters: a-z (lowercase), 0-9, and - (hyphen).

        :return: The domain_name of this IndexDocumentsRequest.
        :rtype: str
        """
    ...
    def domain_name(self, domain_name):
        """Sets the domain_name of this IndexDocumentsRequest.
