...
class DeleteSuggesterRequest(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, domain_name: str=None, suggester_name: str=None):
        """DeleteSuggesterRequest - a model defined in OpenAPI

        :param domain_name: The domain_name of this DeleteSuggesterRequest.
        :param suggester_name: The suggester_name of this DeleteSuggesterRequest.
        """
        self.openapi_types = {
            'domain_name': str,
            'suggester_name': str
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DeleteSuggesterRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DeleteSuggesterRequest of this DeleteSuggesterRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def domain_name(self):
        """Gets the domain_name of this DeleteSuggesterRequest.

        A string that represents the name of a domain. Domain names are unique across the domains owned by an account within an AWS region. Domain names start with a letter or number and can contain the following characters: a-z (lowercase), 0-9, and - (hyphen).

        :return: The domain_name of this DeleteSuggesterRequest.
        :rtype: str
        """
    ...
    def domain_name(self, domain_name):
        """Sets the domain_name of this DeleteSuggesterRequest.
    ...
    def suggester_name(self):
        """Gets the suggester_name of this DeleteSuggesterRequest.


        :return: The suggester_name of this DeleteSuggesterRequest.
        :rtype: str
        """
    ...
    def suggester_name(self, suggester_name):
        """Sets the suggester_name of this DeleteSuggesterRequest.
