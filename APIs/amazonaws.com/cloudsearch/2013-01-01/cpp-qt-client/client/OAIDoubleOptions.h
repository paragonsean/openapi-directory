...
#ifndef OAIDoubleOptions_H
#define OAIDoubleOptions_H
...
class OAIDoubleOptions : public OAIObject {
public:
    OAIDoubleOptions();
    OAIDoubleOptions(QString json);
    ~OAIDoubleOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDoubleOptions)

#endif // OAIDoubleOptions_H
