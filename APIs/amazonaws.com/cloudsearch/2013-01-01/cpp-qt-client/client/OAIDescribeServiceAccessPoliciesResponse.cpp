...
OAIDescribeServiceAccessPoliciesResponse_AccessPolicies OAIDescribeServiceAccessPoliciesResponse::getAccessPolicies() const {
    return m_access_policies;
}
void OAIDescribeServiceAccessPoliciesResponse::setAccessPolicies(const OAIDescribeServiceAccessPoliciesResponse_AccessPolicies &access_policies) {
