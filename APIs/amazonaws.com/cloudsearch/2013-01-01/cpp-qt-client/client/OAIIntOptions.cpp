...
OAIIntOptions::OAIIntOptions(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIntOptions::OAIIntOptions() {
    this->initializeModel();
}

OAIIntOptions::~OAIIntOptions() {}

void OAIIntOptions::initializeModel() {
...
void OAIIntOptions::fromJson(QString jsonString) {
...
void OAIIntOptions::fromJsonObject(QJsonObject json) {
...
QString OAIIntOptions::asJson() const {
...
QJsonObject OAIIntOptions::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIIntOptions::getDefaultValue() const {
    return m_default_value;
}
void OAIIntOptions::setDefaultValue(const qint32 &default_value) {
    m_default_value = default_value;
    m_default_value_isSet = true;
}

bool OAIIntOptions::is_default_value_Set() const{
    return m_default_value_isSet;
}

bool OAIIntOptions::is_default_value_Valid() const{
    return m_default_value_isValid;
}

QString OAIIntOptions::getSourceField() const {
    return m_source_field;
}
void OAIIntOptions::setSourceField(const QString &source_field) {
    m_source_field = source_field;
    m_source_field_isSet = true;
}

bool OAIIntOptions::is_source_field_Set() const{
    return m_source_field_isSet;
}

bool OAIIntOptions::is_source_field_Valid() const{
    return m_source_field_isValid;
}

bool OAIIntOptions::getFacetEnabled() const {
    return m_facet_enabled;
}
void OAIIntOptions::setFacetEnabled(const bool &facet_enabled) {
    m_facet_enabled = facet_enabled;
    m_facet_enabled_isSet = true;
}

bool OAIIntOptions::is_facet_enabled_Set() const{
    return m_facet_enabled_isSet;
}

bool OAIIntOptions::is_facet_enabled_Valid() const{
    return m_facet_enabled_isValid;
}

bool OAIIntOptions::getSearchEnabled() const {
    return m_search_enabled;
}
void OAIIntOptions::setSearchEnabled(const bool &search_enabled) {
    m_search_enabled = search_enabled;
    m_search_enabled_isSet = true;
}

bool OAIIntOptions::is_search_enabled_Set() const{
    return m_search_enabled_isSet;
}

bool OAIIntOptions::is_search_enabled_Valid() const{
    return m_search_enabled_isValid;
}

bool OAIIntOptions::getReturnEnabled() const {
    return m_return_enabled;
}
void OAIIntOptions::setReturnEnabled(const bool &return_enabled) {
    m_return_enabled = return_enabled;
    m_return_enabled_isSet = true;
}

bool OAIIntOptions::is_return_enabled_Set() const{
    return m_return_enabled_isSet;
}

bool OAIIntOptions::is_return_enabled_Valid() const{
    return m_return_enabled_isValid;
}

bool OAIIntOptions::getSortEnabled() const {
    return m_sort_enabled;
}
void OAIIntOptions::setSortEnabled(const bool &sort_enabled) {
    m_sort_enabled = sort_enabled;
    m_sort_enabled_isSet = true;
}

bool OAIIntOptions::is_sort_enabled_Set() const{
    return m_sort_enabled_isSet;
}

bool OAIIntOptions::is_sort_enabled_Valid() const{
    return m_sort_enabled_isValid;
}

bool OAIIntOptions::isSet() const {
...
bool OAIIntOptions::isValid() const {
