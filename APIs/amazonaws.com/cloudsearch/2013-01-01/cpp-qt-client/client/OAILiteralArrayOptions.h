...
#ifndef OAILiteralArrayOptions_H
#define OAILiteralArrayOptions_H
...
class OAILiteralArrayOptions : public OAIObject {
public:
    OAILiteralArrayOptions();
    OAILiteralArrayOptions(QString json);
    ~OAILiteralArrayOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILiteralArrayOptions)

#endif // OAILiteralArrayOptions_H
