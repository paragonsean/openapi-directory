...
#ifndef OAIDoubleArrayOptions_H
#define OAIDoubleArrayOptions_H
...
class OAIDoubleArrayOptions : public OAIObject {
public:
    OAIDoubleArrayOptions();
    OAIDoubleArrayOptions(QString json);
    ~OAIDoubleArrayOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDoubleArrayOptions)

#endif // OAIDoubleArrayOptions_H
