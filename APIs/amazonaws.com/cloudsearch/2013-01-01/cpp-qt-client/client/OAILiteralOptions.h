...
#ifndef OAILiteralOptions_H
#define OAILiteralOptions_H
...
class OAILiteralOptions : public OAIObject {
public:
    OAILiteralOptions();
    OAILiteralOptions(QString json);
    ~OAILiteralOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILiteralOptions)

#endif // OAILiteralOptions_H
