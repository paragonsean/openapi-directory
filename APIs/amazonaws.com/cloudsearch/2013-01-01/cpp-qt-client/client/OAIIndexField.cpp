...
OAIIntOptions OAIIndexField::getIntOptions() const {
    return m_int_options;
}
void OAIIndexField::setIntOptions(const OAIIntOptions &int_options) {
    m_int_options = int_options;
    m_int_options_isSet = true;
}

bool OAIIndexField::is_int_options_Set() const{
    return m_int_options_isSet;
}

bool OAIIndexField::is_int_options_Valid() const{
    return m_int_options_isValid;
}

OAIDoubleOptions OAIIndexField::getDoubleOptions() const {
    return m_double_options;
}
void OAIIndexField::setDoubleOptions(const OAIDoubleOptions &double_options) {
    m_double_options = double_options;
    m_double_options_isSet = true;
}

bool OAIIndexField::is_double_options_Set() const{
    return m_double_options_isSet;
}

bool OAIIndexField::is_double_options_Valid() const{
    return m_double_options_isValid;
}

OAILiteralOptions OAIIndexField::getLiteralOptions() const {
    return m_literal_options;
}
void OAIIndexField::setLiteralOptions(const OAILiteralOptions &literal_options) {
...
OAITextOptions OAIIndexField::getTextOptions() const {
    return m_text_options;
}
void OAIIndexField::setTextOptions(const OAITextOptions &text_options) {
...
OAIDateOptions OAIIndexField::getDateOptions() const {
    return m_date_options;
}
void OAIIndexField::setDateOptions(const OAIDateOptions &date_options) {
    m_date_options = date_options;
    m_date_options_isSet = true;
}

bool OAIIndexField::is_date_options_Set() const{
    return m_date_options_isSet;
}

bool OAIIndexField::is_date_options_Valid() const{
    return m_date_options_isValid;
}

OAILatLonOptions OAIIndexField::getLatLonOptions() const {
    return m_lat_lon_options;
}
void OAIIndexField::setLatLonOptions(const OAILatLonOptions &lat_lon_options) {
    m_lat_lon_options = lat_lon_options;
    m_lat_lon_options_isSet = true;
}

bool OAIIndexField::is_lat_lon_options_Set() const{
    return m_lat_lon_options_isSet;
}

bool OAIIndexField::is_lat_lon_options_Valid() const{
    return m_lat_lon_options_isValid;
}

OAIIntArrayOptions OAIIndexField::getIntArrayOptions() const {
    return m_int_array_options;
}
void OAIIndexField::setIntArrayOptions(const OAIIntArrayOptions &int_array_options) {
    m_int_array_options = int_array_options;
    m_int_array_options_isSet = true;
}

bool OAIIndexField::is_int_array_options_Set() const{
    return m_int_array_options_isSet;
}

bool OAIIndexField::is_int_array_options_Valid() const{
    return m_int_array_options_isValid;
}

OAIDoubleArrayOptions OAIIndexField::getDoubleArrayOptions() const {
    return m_double_array_options;
}
void OAIIndexField::setDoubleArrayOptions(const OAIDoubleArrayOptions &double_array_options) {
    m_double_array_options = double_array_options;
    m_double_array_options_isSet = true;
}

bool OAIIndexField::is_double_array_options_Set() const{
    return m_double_array_options_isSet;
}

bool OAIIndexField::is_double_array_options_Valid() const{
    return m_double_array_options_isValid;
}

OAILiteralArrayOptions OAIIndexField::getLiteralArrayOptions() const {
    return m_literal_array_options;
}
void OAIIndexField::setLiteralArrayOptions(const OAILiteralArrayOptions &literal_array_options) {
    m_literal_array_options = literal_array_options;
    m_literal_array_options_isSet = true;
}

bool OAIIndexField::is_literal_array_options_Set() const{
    return m_literal_array_options_isSet;
}

bool OAIIndexField::is_literal_array_options_Valid() const{
    return m_literal_array_options_isValid;
}

OAITextArrayOptions OAIIndexField::getTextArrayOptions() const {
    return m_text_array_options;
}
void OAIIndexField::setTextArrayOptions(const OAITextArrayOptions &text_array_options) {
    m_text_array_options = text_array_options;
    m_text_array_options_isSet = true;
}

bool OAIIndexField::is_text_array_options_Set() const{
    return m_text_array_options_isSet;
}

bool OAIIndexField::is_text_array_options_Valid() const{
    return m_text_array_options_isValid;
}

OAIDateArrayOptions OAIIndexField::getDateArrayOptions() const {
    return m_date_array_options;
}
void OAIIndexField::setDateArrayOptions(const OAIDateArrayOptions &date_array_options) {
    m_date_array_options = date_array_options;
    m_date_array_options_isSet = true;
}

bool OAIIndexField::is_date_array_options_Set() const{
    return m_date_array_options_isSet;
}

bool OAIIndexField::is_date_array_options_Valid() const{
