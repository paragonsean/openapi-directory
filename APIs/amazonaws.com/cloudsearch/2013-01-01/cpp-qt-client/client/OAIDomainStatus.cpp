...
OAILimits OAIDomainStatus::getLimits() const {
    return m_limits;
}
void OAIDomainStatus::setLimits(const OAILimits &limits) {
    m_limits = limits;
    m_limits_isSet = true;
}

bool OAIDomainStatus::is_limits_Set() const{
    return m_limits_isSet;
}

bool OAIDomainStatus::is_limits_Valid() const{
