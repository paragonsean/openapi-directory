...
OAIDateOptions::OAIDateOptions(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDateOptions::OAIDateOptions() {
    this->initializeModel();
}

OAIDateOptions::~OAIDateOptions() {}

void OAIDateOptions::initializeModel() {
...
void OAIDateOptions::fromJson(QString jsonString) {
...
void OAIDateOptions::fromJsonObject(QJsonObject json) {
...
QString OAIDateOptions::asJson() const {
...
QJsonObject OAIDateOptions::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDateOptions::getDefaultValue() const {
    return m_default_value;
}
void OAIDateOptions::setDefaultValue(const QString &default_value) {
    m_default_value = default_value;
    m_default_value_isSet = true;
}

bool OAIDateOptions::is_default_value_Set() const{
    return m_default_value_isSet;
}

bool OAIDateOptions::is_default_value_Valid() const{
    return m_default_value_isValid;
}

QString OAIDateOptions::getSourceField() const {
    return m_source_field;
}
void OAIDateOptions::setSourceField(const QString &source_field) {
    m_source_field = source_field;
    m_source_field_isSet = true;
}

bool OAIDateOptions::is_source_field_Set() const{
    return m_source_field_isSet;
}

bool OAIDateOptions::is_source_field_Valid() const{
    return m_source_field_isValid;
}

bool OAIDateOptions::getFacetEnabled() const {
    return m_facet_enabled;
}
void OAIDateOptions::setFacetEnabled(const bool &facet_enabled) {
    m_facet_enabled = facet_enabled;
    m_facet_enabled_isSet = true;
}

bool OAIDateOptions::is_facet_enabled_Set() const{
    return m_facet_enabled_isSet;
}

bool OAIDateOptions::is_facet_enabled_Valid() const{
    return m_facet_enabled_isValid;
}

bool OAIDateOptions::getSearchEnabled() const {
    return m_search_enabled;
}
void OAIDateOptions::setSearchEnabled(const bool &search_enabled) {
    m_search_enabled = search_enabled;
    m_search_enabled_isSet = true;
}

bool OAIDateOptions::is_search_enabled_Set() const{
    return m_search_enabled_isSet;
}

bool OAIDateOptions::is_search_enabled_Valid() const{
    return m_search_enabled_isValid;
}

bool OAIDateOptions::getReturnEnabled() const {
    return m_return_enabled;
}
void OAIDateOptions::setReturnEnabled(const bool &return_enabled) {
    m_return_enabled = return_enabled;
    m_return_enabled_isSet = true;
}

bool OAIDateOptions::is_return_enabled_Set() const{
    return m_return_enabled_isSet;
}

bool OAIDateOptions::is_return_enabled_Valid() const{
    return m_return_enabled_isValid;
}

bool OAIDateOptions::getSortEnabled() const {
    return m_sort_enabled;
}
void OAIDateOptions::setSortEnabled(const bool &sort_enabled) {
    m_sort_enabled = sort_enabled;
    m_sort_enabled_isSet = true;
}

bool OAIDateOptions::is_sort_enabled_Set() const{
    return m_sort_enabled_isSet;
}

bool OAIDateOptions::is_sort_enabled_Valid() const{
    return m_sort_enabled_isValid;
}

bool OAIDateOptions::isSet() const {
...
bool OAIDateOptions::isValid() const {
