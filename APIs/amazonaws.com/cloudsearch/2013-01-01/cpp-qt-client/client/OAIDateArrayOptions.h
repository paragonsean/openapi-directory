...
#ifndef OAIDateArrayOptions_H
#define OAIDateArrayOptions_H
...
class OAIDateArrayOptions : public OAIObject {
public:
    OAIDateArrayOptions();
    OAIDateArrayOptions(QString json);
    ~OAIDateArrayOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDateArrayOptions)

#endif // OAIDateArrayOptions_H
