...
OAIDoubleArrayOptions::OAIDoubleArrayOptions(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDoubleArrayOptions::OAIDoubleArrayOptions() {
    this->initializeModel();
}

OAIDoubleArrayOptions::~OAIDoubleArrayOptions() {}

void OAIDoubleArrayOptions::initializeModel() {
...
void OAIDoubleArrayOptions::fromJson(QString jsonString) {
...
void OAIDoubleArrayOptions::fromJsonObject(QJsonObject json) {
...
QString OAIDoubleArrayOptions::asJson() const {
...
QJsonObject OAIDoubleArrayOptions::asJsonObject() const {
    QJsonObject obj;
...
double OAIDoubleArrayOptions::getDefaultValue() const {
    return m_default_value;
}
void OAIDoubleArrayOptions::setDefaultValue(const double &default_value) {
    m_default_value = default_value;
    m_default_value_isSet = true;
}

bool OAIDoubleArrayOptions::is_default_value_Set() const{
    return m_default_value_isSet;
}

bool OAIDoubleArrayOptions::is_default_value_Valid() const{
    return m_default_value_isValid;
}

QString OAIDoubleArrayOptions::getSourceFields() const {
    return m_source_fields;
}
void OAIDoubleArrayOptions::setSourceFields(const QString &source_fields) {
    m_source_fields = source_fields;
    m_source_fields_isSet = true;
}

bool OAIDoubleArrayOptions::is_source_fields_Set() const{
    return m_source_fields_isSet;
}

bool OAIDoubleArrayOptions::is_source_fields_Valid() const{
    return m_source_fields_isValid;
}

bool OAIDoubleArrayOptions::getFacetEnabled() const {
    return m_facet_enabled;
}
void OAIDoubleArrayOptions::setFacetEnabled(const bool &facet_enabled) {
    m_facet_enabled = facet_enabled;
    m_facet_enabled_isSet = true;
}

bool OAIDoubleArrayOptions::is_facet_enabled_Set() const{
    return m_facet_enabled_isSet;
}

bool OAIDoubleArrayOptions::is_facet_enabled_Valid() const{
    return m_facet_enabled_isValid;
}

bool OAIDoubleArrayOptions::getSearchEnabled() const {
    return m_search_enabled;
}
void OAIDoubleArrayOptions::setSearchEnabled(const bool &search_enabled) {
    m_search_enabled = search_enabled;
    m_search_enabled_isSet = true;
}

bool OAIDoubleArrayOptions::is_search_enabled_Set() const{
    return m_search_enabled_isSet;
}

bool OAIDoubleArrayOptions::is_search_enabled_Valid() const{
    return m_search_enabled_isValid;
}

bool OAIDoubleArrayOptions::getReturnEnabled() const {
    return m_return_enabled;
}
void OAIDoubleArrayOptions::setReturnEnabled(const bool &return_enabled) {
    m_return_enabled = return_enabled;
    m_return_enabled_isSet = true;
}

bool OAIDoubleArrayOptions::is_return_enabled_Set() const{
    return m_return_enabled_isSet;
}

bool OAIDoubleArrayOptions::is_return_enabled_Valid() const{
    return m_return_enabled_isValid;
}

bool OAIDoubleArrayOptions::isSet() const {
...
bool OAIDoubleArrayOptions::isValid() const {
