...
/*
 * OAIScalingParameters.h
 *
 * The desired instance type and desired number of replicas of each index partition.
 */

#ifndef OAIScalingParameters_H
#define OAIScalingParameters_H
...
class OAIScalingParameters : public OAIObject {
public:
    OAIScalingParameters();
    OAIScalingParameters(QString json);
    ~OAIScalingParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIScalingParameters)

#endif // OAIScalingParameters_H
