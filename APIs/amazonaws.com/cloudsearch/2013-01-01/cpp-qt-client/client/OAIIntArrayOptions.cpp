...
OAIIntArrayOptions::OAIIntArrayOptions(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIntArrayOptions::OAIIntArrayOptions() {
    this->initializeModel();
}

OAIIntArrayOptions::~OAIIntArrayOptions() {}

void OAIIntArrayOptions::initializeModel() {
...
void OAIIntArrayOptions::fromJson(QString jsonString) {
...
void OAIIntArrayOptions::fromJsonObject(QJsonObject json) {
...
QString OAIIntArrayOptions::asJson() const {
...
QJsonObject OAIIntArrayOptions::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIIntArrayOptions::getDefaultValue() const {
    return m_default_value;
}
void OAIIntArrayOptions::setDefaultValue(const qint32 &default_value) {
    m_default_value = default_value;
    m_default_value_isSet = true;
}

bool OAIIntArrayOptions::is_default_value_Set() const{
    return m_default_value_isSet;
}

bool OAIIntArrayOptions::is_default_value_Valid() const{
    return m_default_value_isValid;
}

QString OAIIntArrayOptions::getSourceFields() const {
    return m_source_fields;
}
void OAIIntArrayOptions::setSourceFields(const QString &source_fields) {
    m_source_fields = source_fields;
    m_source_fields_isSet = true;
}

bool OAIIntArrayOptions::is_source_fields_Set() const{
    return m_source_fields_isSet;
}

bool OAIIntArrayOptions::is_source_fields_Valid() const{
    return m_source_fields_isValid;
}

bool OAIIntArrayOptions::getFacetEnabled() const {
    return m_facet_enabled;
}
void OAIIntArrayOptions::setFacetEnabled(const bool &facet_enabled) {
    m_facet_enabled = facet_enabled;
    m_facet_enabled_isSet = true;
}

bool OAIIntArrayOptions::is_facet_enabled_Set() const{
    return m_facet_enabled_isSet;
}

bool OAIIntArrayOptions::is_facet_enabled_Valid() const{
    return m_facet_enabled_isValid;
}

bool OAIIntArrayOptions::getSearchEnabled() const {
    return m_search_enabled;
}
void OAIIntArrayOptions::setSearchEnabled(const bool &search_enabled) {
    m_search_enabled = search_enabled;
    m_search_enabled_isSet = true;
}

bool OAIIntArrayOptions::is_search_enabled_Set() const{
    return m_search_enabled_isSet;
}

bool OAIIntArrayOptions::is_search_enabled_Valid() const{
    return m_search_enabled_isValid;
}

bool OAIIntArrayOptions::getReturnEnabled() const {
    return m_return_enabled;
}
void OAIIntArrayOptions::setReturnEnabled(const bool &return_enabled) {
    m_return_enabled = return_enabled;
    m_return_enabled_isSet = true;
}

bool OAIIntArrayOptions::is_return_enabled_Set() const{
    return m_return_enabled_isSet;
}

bool OAIIntArrayOptions::is_return_enabled_Valid() const{
    return m_return_enabled_isValid;
}

bool OAIIntArrayOptions::isSet() const {
...
bool OAIIntArrayOptions::isValid() const {
