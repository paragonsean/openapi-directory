...
#ifndef OAIDefineExpressionRequest_H
#define OAIDefineExpressionRequest_H
...
class OAIDefineExpressionRequest : public OAIObject {
public:
    OAIDefineExpressionRequest();
    OAIDefineExpressionRequest(QString json);
    ~OAIDefineExpressionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDefineExpressionRequest)

#endif // OAIDefineExpressionRequest_H
