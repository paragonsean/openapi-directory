...
QString OAILiteralOptions::getSourceField() const {
    return m_source_field;
}
void OAILiteralOptions::setSourceField(const QString &source_field) {
    m_source_field = source_field;
    m_source_field_isSet = true;
}

bool OAILiteralOptions::is_source_field_Set() const{
    return m_source_field_isSet;
}

bool OAILiteralOptions::is_source_field_Valid() const{
...
bool OAILiteralOptions::getReturnEnabled() const {
    return m_return_enabled;
}
void OAILiteralOptions::setReturnEnabled(const bool &return_enabled) {
    m_return_enabled = return_enabled;
    m_return_enabled_isSet = true;
}

bool OAILiteralOptions::is_return_enabled_Set() const{
    return m_return_enabled_isSet;
}

bool OAILiteralOptions::is_return_enabled_Valid() const{
    return m_return_enabled_isValid;
}

bool OAILiteralOptions::getSortEnabled() const {
    return m_sort_enabled;
}
void OAILiteralOptions::setSortEnabled(const bool &sort_enabled) {
    m_sort_enabled = sort_enabled;
    m_sort_enabled_isSet = true;
}

bool OAILiteralOptions::is_sort_enabled_Set() const{
    return m_sort_enabled_isSet;
}

bool OAILiteralOptions::is_sort_enabled_Valid() const{
