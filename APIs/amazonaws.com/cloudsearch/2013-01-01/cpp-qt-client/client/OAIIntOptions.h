...
#ifndef OAIIntOptions_H
#define OAIIntOptions_H
...
class OAIIntOptions : public OAIObject {
public:
    OAIIntOptions();
    OAIIntOptions(QString json);
    ~OAIIntOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIntOptions)

#endif // OAIIntOptions_H
