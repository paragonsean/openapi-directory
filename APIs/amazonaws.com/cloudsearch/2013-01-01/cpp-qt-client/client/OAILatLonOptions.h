...
#ifndef OAILatLonOptions_H
#define OAILatLonOptions_H
...
class OAILatLonOptions : public OAIObject {
public:
    OAILatLonOptions();
    OAILatLonOptions(QString json);
    ~OAILatLonOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILatLonOptions)

#endif // OAILatLonOptions_H
