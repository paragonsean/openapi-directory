...
#include "OAIDefineIndexFieldRequest_IndexField.h"
...
OAIDefineIndexFieldRequest_IndexField::OAIDefineIndexFieldRequest_IndexField(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDefineIndexFieldRequest_IndexField::OAIDefineIndexFieldRequest_IndexField() {
    this->initializeModel();
}

OAIDefineIndexFieldRequest_IndexField::~OAIDefineIndexFieldRequest_IndexField() {}

void OAIDefineIndexFieldRequest_IndexField::initializeModel() {
...
void OAIDefineIndexFieldRequest_IndexField::fromJson(QString jsonString) {
...
void OAIDefineIndexFieldRequest_IndexField::fromJsonObject(QJsonObject json) {
...
QString OAIDefineIndexFieldRequest_IndexField::asJson() const {
...
QJsonObject OAIDefineIndexFieldRequest_IndexField::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDefineIndexFieldRequest_IndexField::getIndexFieldName() const {
    return m_index_field_name;
}
void OAIDefineIndexFieldRequest_IndexField::setIndexFieldName(const QString &index_field_name) {
    m_index_field_name = index_field_name;
    m_index_field_name_isSet = true;
}

bool OAIDefineIndexFieldRequest_IndexField::is_index_field_name_Set() const{
    return m_index_field_name_isSet;
}

bool OAIDefineIndexFieldRequest_IndexField::is_index_field_name_Valid() const{
    return m_index_field_name_isValid;
}

OAIIndexFieldType OAIDefineIndexFieldRequest_IndexField::getIndexFieldType() const {
    return m_index_field_type;
}
void OAIDefineIndexFieldRequest_IndexField::setIndexFieldType(const OAIIndexFieldType &index_field_type) {
    m_index_field_type = index_field_type;
    m_index_field_type_isSet = true;
}

bool OAIDefineIndexFieldRequest_IndexField::is_index_field_type_Set() const{
    return m_index_field_type_isSet;
}

bool OAIDefineIndexFieldRequest_IndexField::is_index_field_type_Valid() const{
    return m_index_field_type_isValid;
}

OAIIntOptions OAIDefineIndexFieldRequest_IndexField::getIntOptions() const {
    return m_int_options;
}
void OAIDefineIndexFieldRequest_IndexField::setIntOptions(const OAIIntOptions &int_options) {
    m_int_options = int_options;
    m_int_options_isSet = true;
}

bool OAIDefineIndexFieldRequest_IndexField::is_int_options_Set() const{
    return m_int_options_isSet;
}

bool OAIDefineIndexFieldRequest_IndexField::is_int_options_Valid() const{
    return m_int_options_isValid;
}

OAIDoubleOptions OAIDefineIndexFieldRequest_IndexField::getDoubleOptions() const {
    return m_double_options;
}
void OAIDefineIndexFieldRequest_IndexField::setDoubleOptions(const OAIDoubleOptions &double_options) {
    m_double_options = double_options;
    m_double_options_isSet = true;
}

bool OAIDefineIndexFieldRequest_IndexField::is_double_options_Set() const{
    return m_double_options_isSet;
}

bool OAIDefineIndexFieldRequest_IndexField::is_double_options_Valid() const{
    return m_double_options_isValid;
}

OAILiteralOptions OAIDefineIndexFieldRequest_IndexField::getLiteralOptions() const {
    return m_literal_options;
}
void OAIDefineIndexFieldRequest_IndexField::setLiteralOptions(const OAILiteralOptions &literal_options) {
    m_literal_options = literal_options;
    m_literal_options_isSet = true;
}

bool OAIDefineIndexFieldRequest_IndexField::is_literal_options_Set() const{
    return m_literal_options_isSet;
}

bool OAIDefineIndexFieldRequest_IndexField::is_literal_options_Valid() const{
    return m_literal_options_isValid;
}

OAITextOptions OAIDefineIndexFieldRequest_IndexField::getTextOptions() const {
    return m_text_options;
}
void OAIDefineIndexFieldRequest_IndexField::setTextOptions(const OAITextOptions &text_options) {
    m_text_options = text_options;
    m_text_options_isSet = true;
}

bool OAIDefineIndexFieldRequest_IndexField::is_text_options_Set() const{
    return m_text_options_isSet;
}

bool OAIDefineIndexFieldRequest_IndexField::is_text_options_Valid() const{
    return m_text_options_isValid;
}

OAIDateOptions OAIDefineIndexFieldRequest_IndexField::getDateOptions() const {
    return m_date_options;
}
void OAIDefineIndexFieldRequest_IndexField::setDateOptions(const OAIDateOptions &date_options) {
    m_date_options = date_options;
    m_date_options_isSet = true;
}

bool OAIDefineIndexFieldRequest_IndexField::is_date_options_Set() const{
    return m_date_options_isSet;
}

bool OAIDefineIndexFieldRequest_IndexField::is_date_options_Valid() const{
    return m_date_options_isValid;
}

OAILatLonOptions OAIDefineIndexFieldRequest_IndexField::getLatLonOptions() const {
    return m_lat_lon_options;
}
void OAIDefineIndexFieldRequest_IndexField::setLatLonOptions(const OAILatLonOptions &lat_lon_options) {
    m_lat_lon_options = lat_lon_options;
    m_lat_lon_options_isSet = true;
}

bool OAIDefineIndexFieldRequest_IndexField::is_lat_lon_options_Set() const{
    return m_lat_lon_options_isSet;
}

bool OAIDefineIndexFieldRequest_IndexField::is_lat_lon_options_Valid() const{
    return m_lat_lon_options_isValid;
}

OAIIntArrayOptions OAIDefineIndexFieldRequest_IndexField::getIntArrayOptions() const {
    return m_int_array_options;
}
void OAIDefineIndexFieldRequest_IndexField::setIntArrayOptions(const OAIIntArrayOptions &int_array_options) {
    m_int_array_options = int_array_options;
    m_int_array_options_isSet = true;
}

bool OAIDefineIndexFieldRequest_IndexField::is_int_array_options_Set() const{
    return m_int_array_options_isSet;
}

bool OAIDefineIndexFieldRequest_IndexField::is_int_array_options_Valid() const{
    return m_int_array_options_isValid;
}

OAIDoubleArrayOptions OAIDefineIndexFieldRequest_IndexField::getDoubleArrayOptions() const {
    return m_double_array_options;
}
void OAIDefineIndexFieldRequest_IndexField::setDoubleArrayOptions(const OAIDoubleArrayOptions &double_array_options) {
    m_double_array_options = double_array_options;
    m_double_array_options_isSet = true;
}

bool OAIDefineIndexFieldRequest_IndexField::is_double_array_options_Set() const{
    return m_double_array_options_isSet;
}

bool OAIDefineIndexFieldRequest_IndexField::is_double_array_options_Valid() const{
    return m_double_array_options_isValid;
}

OAILiteralArrayOptions OAIDefineIndexFieldRequest_IndexField::getLiteralArrayOptions() const {
    return m_literal_array_options;
}
void OAIDefineIndexFieldRequest_IndexField::setLiteralArrayOptions(const OAILiteralArrayOptions &literal_array_options) {
    m_literal_array_options = literal_array_options;
    m_literal_array_options_isSet = true;
}

bool OAIDefineIndexFieldRequest_IndexField::is_literal_array_options_Set() const{
    return m_literal_array_options_isSet;
}

bool OAIDefineIndexFieldRequest_IndexField::is_literal_array_options_Valid() const{
    return m_literal_array_options_isValid;
}

OAITextArrayOptions OAIDefineIndexFieldRequest_IndexField::getTextArrayOptions() const {
    return m_text_array_options;
}
void OAIDefineIndexFieldRequest_IndexField::setTextArrayOptions(const OAITextArrayOptions &text_array_options) {
    m_text_array_options = text_array_options;
    m_text_array_options_isSet = true;
}

bool OAIDefineIndexFieldRequest_IndexField::is_text_array_options_Set() const{
    return m_text_array_options_isSet;
}

bool OAIDefineIndexFieldRequest_IndexField::is_text_array_options_Valid() const{
    return m_text_array_options_isValid;
}

OAIDateArrayOptions OAIDefineIndexFieldRequest_IndexField::getDateArrayOptions() const {
    return m_date_array_options;
}
void OAIDefineIndexFieldRequest_IndexField::setDateArrayOptions(const OAIDateArrayOptions &date_array_options) {
    m_date_array_options = date_array_options;
    m_date_array_options_isSet = true;
}

bool OAIDefineIndexFieldRequest_IndexField::is_date_array_options_Set() const{
    return m_date_array_options_isSet;
}

bool OAIDefineIndexFieldRequest_IndexField::is_date_array_options_Valid() const{
    return m_date_array_options_isValid;
}

bool OAIDefineIndexFieldRequest_IndexField::isSet() const {
...
bool OAIDefineIndexFieldRequest_IndexField::isValid() const {
