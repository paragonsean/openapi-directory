...
OAIDateArrayOptions::OAIDateArrayOptions(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDateArrayOptions::OAIDateArrayOptions() {
    this->initializeModel();
}

OAIDateArrayOptions::~OAIDateArrayOptions() {}

void OAIDateArrayOptions::initializeModel() {
...
void OAIDateArrayOptions::fromJson(QString jsonString) {
...
void OAIDateArrayOptions::fromJsonObject(QJsonObject json) {
...
QString OAIDateArrayOptions::asJson() const {
...
QJsonObject OAIDateArrayOptions::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDateArrayOptions::getDefaultValue() const {
    return m_default_value;
}
void OAIDateArrayOptions::setDefaultValue(const QString &default_value) {
    m_default_value = default_value;
    m_default_value_isSet = true;
}

bool OAIDateArrayOptions::is_default_value_Set() const{
    return m_default_value_isSet;
}

bool OAIDateArrayOptions::is_default_value_Valid() const{
    return m_default_value_isValid;
}

QString OAIDateArrayOptions::getSourceFields() const {
    return m_source_fields;
}
void OAIDateArrayOptions::setSourceFields(const QString &source_fields) {
    m_source_fields = source_fields;
    m_source_fields_isSet = true;
}

bool OAIDateArrayOptions::is_source_fields_Set() const{
    return m_source_fields_isSet;
}

bool OAIDateArrayOptions::is_source_fields_Valid() const{
    return m_source_fields_isValid;
}

bool OAIDateArrayOptions::getFacetEnabled() const {
    return m_facet_enabled;
}
void OAIDateArrayOptions::setFacetEnabled(const bool &facet_enabled) {
    m_facet_enabled = facet_enabled;
    m_facet_enabled_isSet = true;
}

bool OAIDateArrayOptions::is_facet_enabled_Set() const{
    return m_facet_enabled_isSet;
}

bool OAIDateArrayOptions::is_facet_enabled_Valid() const{
    return m_facet_enabled_isValid;
}

bool OAIDateArrayOptions::getSearchEnabled() const {
    return m_search_enabled;
}
void OAIDateArrayOptions::setSearchEnabled(const bool &search_enabled) {
    m_search_enabled = search_enabled;
    m_search_enabled_isSet = true;
}

bool OAIDateArrayOptions::is_search_enabled_Set() const{
    return m_search_enabled_isSet;
}

bool OAIDateArrayOptions::is_search_enabled_Valid() const{
    return m_search_enabled_isValid;
}

bool OAIDateArrayOptions::getReturnEnabled() const {
    return m_return_enabled;
}
void OAIDateArrayOptions::setReturnEnabled(const bool &return_enabled) {
    m_return_enabled = return_enabled;
    m_return_enabled_isSet = true;
}

bool OAIDateArrayOptions::is_return_enabled_Set() const{
    return m_return_enabled_isSet;
}

bool OAIDateArrayOptions::is_return_enabled_Valid() const{
    return m_return_enabled_isValid;
}

bool OAIDateArrayOptions::isSet() const {
...
bool OAIDateArrayOptions::isValid() const {
