...
#ifndef OAIBuildSuggestersRequest_H
#define OAIBuildSuggestersRequest_H
...
class OAIBuildSuggestersRequest : public OAIObject {
public:
    OAIBuildSuggestersRequest();
    OAIBuildSuggestersRequest(QString json);
    ~OAIBuildSuggestersRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBuildSuggestersRequest)

#endif // OAIBuildSuggestersRequest_H
