...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::gETBuildSuggestersSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::gETBuildSuggestersSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      QString domain_name = create(); // QString | 
      ...
      apiInstance.gETBuildSuggesters(domain_nameactionversionx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
