...
#ifndef OAISourceDataMap_H
#define OAISourceDataMap_H
...
class OAISourceDataMap : public OAIObject {
public:
    OAISourceDataMap();
    OAISourceDataMap(QString json);
    ~OAISourceDataMap() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISourceDataMap)

#endif // OAISourceDataMap_H
