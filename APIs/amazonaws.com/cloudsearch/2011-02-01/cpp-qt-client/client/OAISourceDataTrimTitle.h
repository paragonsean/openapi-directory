...
class OAISourceDataTrimTitle : public OAIObject {
public:
    OAISourceDataTrimTitle();
    OAISourceDataTrimTitle(QString json);
    ~OAISourceDataTrimTitle() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISourceDataTrimTitle)

#endif // OAISourceDataTrimTitle_H
