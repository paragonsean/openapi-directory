...
OAIAccessPoliciesStatus OAIUpdateServiceAccessPoliciesResponse::getAccessPolicies() const {
    return m_access_policies;
}
void OAIUpdateServiceAccessPoliciesResponse::setAccessPolicies(const OAIAccessPoliciesStatus &access_policies) {
