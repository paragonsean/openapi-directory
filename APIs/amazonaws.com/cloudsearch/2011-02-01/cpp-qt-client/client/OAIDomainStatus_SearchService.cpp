...
QString OAIDomainStatus_SearchService::getArn() const {
    return m_arn;
}
void OAIDomainStatus_SearchService::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIDomainStatus_SearchService::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIDomainStatus_SearchService::is_arn_Valid() const{
