...
/*
 * OAIUpdateAvailabilityOptionsRequest.h
 *
...
#ifndef OAIUpdateAvailabilityOptionsRequest_H
#define OAIUpdateAvailabilityOptionsRequest_H
...
class OAIUpdateAvailabilityOptionsRequest : public OAIObject {
public:
    OAIUpdateAvailabilityOptionsRequest();
    OAIUpdateAvailabilityOptionsRequest(QString json);
    ~OAIUpdateAvailabilityOptionsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateAvailabilityOptionsRequest)

#endif // OAIUpdateAvailabilityOptionsRequest_H
