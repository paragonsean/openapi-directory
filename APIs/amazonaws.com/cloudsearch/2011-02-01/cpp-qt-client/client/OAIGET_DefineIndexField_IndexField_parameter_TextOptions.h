...
/*
 * OAIGET_DefineIndexField_IndexField_parameter_TextOptions.h
 *
 * 
 */

#ifndef OAIGET_DefineIndexField_IndexField_parameter_TextOptions_H
#define OAIGET_DefineIndexField_IndexField_parameter_TextOptions_H
...
class OAIGET_DefineIndexField_IndexField_parameter_TextOptions : public OAIObject {
public:
    OAIGET_DefineIndexField_IndexField_parameter_TextOptions();
    OAIGET_DefineIndexField_IndexField_parameter_TextOptions(QString json);
    ~OAIGET_DefineIndexField_IndexField_parameter_TextOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGET_DefineIndexField_IndexField_parameter_TextOptions)

#endif // OAIGET_DefineIndexField_IndexField_parameter_TextOptions_H
