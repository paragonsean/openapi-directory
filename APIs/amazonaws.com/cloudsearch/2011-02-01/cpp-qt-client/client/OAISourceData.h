...
#ifndef OAISourceData_H
#define OAISourceData_H
...
class OAISourceData : public OAIObject {
public:
    OAISourceData();
    OAISourceData(QString json);
    ~OAISourceData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISourceData)

#endif // OAISourceData_H
