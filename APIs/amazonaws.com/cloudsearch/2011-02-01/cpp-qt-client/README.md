...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::gETCreateDomainSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::gETCreateDomainSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
      ...
      apiInstance.gETCreateDomain(domain_nameactionversionx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
