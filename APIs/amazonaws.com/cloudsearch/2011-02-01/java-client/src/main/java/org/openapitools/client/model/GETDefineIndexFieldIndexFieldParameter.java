...
public class GETDefineIndexFieldIndexFieldParameter {
  ...
  public GETDefineIndexFieldIndexFieldParameter() {
  }

  public GETDefineIndexFieldIndexFieldParameter indexFieldName(String indexFieldName) {
  ...
  public GETDefineIndexFieldIndexFieldParameter indexFieldType(IndexFieldType indexFieldType) {
  ...
  public GETDefineIndexFieldIndexFieldParameter uintOptions(GETDefineIndexFieldIndexFieldParameterUIntOptions uintOptions) {
  ...
  public GETDefineIndexFieldIndexFieldParameter literalOptions(GETDefineIndexFieldIndexFieldParameterLiteralOptions literalOptions) {
  ...
  public GETDefineIndexFieldIndexFieldParameter textOptions(GETDefineIndexFieldIndexFieldParameterTextOptions textOptions) {
  ...
  public GETDefineIndexFieldIndexFieldParameter sourceAttributes(List sourceAttributes) {
  ...
  public boolean equals(Object o) {
    ...
    GETDefineIndexFieldIndexFieldParameter geTDefineIndexFieldIndexFieldParameter = (GETDefineIndexFieldIndexFieldParameter) o;
    return Objects.equals(this.indexFieldName, geTDefineIndexFieldIndexFieldParameter.indexFieldName) &&
        Objects.equals(this.indexFieldType, geTDefineIndexFieldIndexFieldParameter.indexFieldType) &&
        Objects.equals(this.uintOptions, geTDefineIndexFieldIndexFieldParameter.uintOptions) &&
        Objects.equals(this.literalOptions, geTDefineIndexFieldIndexFieldParameter.literalOptions) &&
        Objects.equals(this.textOptions, geTDefineIndexFieldIndexFieldParameter.textOptions) &&
        Objects.equals(this.sourceAttributes, geTDefineIndexFieldIndexFieldParameter.sourceAttributes);
  }
  ...
  public String toString() {
    ...
    sb.append("class GETDefineIndexFieldIndexFieldParameter {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GETDefineIndexFieldIndexFieldParameter
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GETDefineIndexFieldIndexFieldParameter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GETDefineIndexFieldIndexFieldParameter is not found in the empty JSON string", GETDefineIndexFieldIndexFieldParameter.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GETDefineIndexFieldIndexFieldParameter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GETDefineIndexFieldIndexFieldParameter` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GETDefineIndexFieldIndexFieldParameter.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GETDefineIndexFieldIndexFieldParameter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GETDefineIndexFieldIndexFieldParameter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GETDefineIndexFieldIndexFieldParameter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GETDefineIndexFieldIndexFieldParameter.class));

       return (TypeAdapter<T>) new TypeAdapter<GETDefineIndexFieldIndexFieldParameter>() {
           @Override
           public void write(JsonWriter out, GETDefineIndexFieldIndexFieldParameter value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GETDefineIndexFieldIndexFieldParameter read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GETDefineIndexFieldIndexFieldParameter given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GETDefineIndexFieldIndexFieldParameter
   * @throws IOException if the JSON string is invalid with respect to GETDefineIndexFieldIndexFieldParameter
   */
  public static GETDefineIndexFieldIndexFieldParameter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GETDefineIndexFieldIndexFieldParameter.class);
  }

  /**
   * Convert an instance of GETDefineIndexFieldIndexFieldParameter to an JSON string
   *
   * @return JSON string
   */
