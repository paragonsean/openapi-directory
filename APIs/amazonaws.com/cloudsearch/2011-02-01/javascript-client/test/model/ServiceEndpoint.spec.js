...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudSearch.ServiceEndpoint();
  });
  ...
  describe('ServiceEndpoint', function() {
    it('should create an instance of ServiceEndpoint', function() {
      ...
      //var instance = new AmazonCloudSearch.ServiceEndpoint();
      //expect(instance).to.be.a(AmazonCloudSearch.ServiceEndpoint);
    });
