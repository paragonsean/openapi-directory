...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudSearch.SourceDataTrimTitle();
  });
  ...
  describe('SourceDataTrimTitle', function() {
    it('should create an instance of SourceDataTrimTitle', function() {
      // uncomment below and update the code to test SourceDataTrimTitle
      //var instance = new AmazonCloudSearch.SourceDataTrimTitle();
      //expect(instance).to.be.a(AmazonCloudSearch.SourceDataTrimTitle);
    });
