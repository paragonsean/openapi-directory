...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudSearch.UpdateStopwordOptionsRequest();
  });
  ...
  describe('UpdateStopwordOptionsRequest', function() {
    it('should create an instance of UpdateStopwordOptionsRequest', function() {
      // uncomment below and update the code to test UpdateStopwordOptionsRequest
      //var instance = new AmazonCloudSearch.UpdateStopwordOptionsRequest();
      //expect(instance).to.be.a(AmazonCloudSearch.UpdateStopwordOptionsRequest);
    });
