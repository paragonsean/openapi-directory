...
(function(root, factory) {
  ...
  describe('DomainStatus', function() {
    ...
    it('should have the property numSearchableDocs (base name: "NumSearchableDocs")', function() {
      // uncomment below and update the code to test the property numSearchableDocs
      //var instance = new AmazonCloudSearch.DomainStatus();
      //expect(instance).to.be();
    });
