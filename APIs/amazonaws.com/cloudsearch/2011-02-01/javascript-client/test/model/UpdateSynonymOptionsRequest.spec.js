...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudSearch.UpdateSynonymOptionsRequest();
  });
  ...
  describe('UpdateSynonymOptionsRequest', function() {
    it('should create an instance of UpdateSynonymOptionsRequest', function() {
      // uncomment below and update the code to test UpdateSynonymOptionsRequest
      //var instance = new AmazonCloudSearch.UpdateSynonymOptionsRequest();
      //expect(instance).to.be.a(AmazonCloudSearch.UpdateSynonymOptionsRequest);
    });
