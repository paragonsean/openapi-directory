...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudSearch.GETDefineIndexFieldIndexFieldParameterTextOptions();
  });
  ...
  describe('GETDefineIndexFieldIndexFieldParameterTextOptions', function() {
    it('should create an instance of GETDefineIndexFieldIndexFieldParameterTextOptions', function() {
      // uncomment below and update the code to test GETDefineIndexFieldIndexFieldParameterTextOptions
      //var instance = new AmazonCloudSearch.GETDefineIndexFieldIndexFieldParameterTextOptions();
      //expect(instance).to.be.a(AmazonCloudSearch.GETDefineIndexFieldIndexFieldParameterTextOptions);
    });
