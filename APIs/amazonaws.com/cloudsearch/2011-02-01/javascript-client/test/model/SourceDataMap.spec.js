...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudSearch.SourceDataMap();
  });
  ...
  describe('SourceDataMap', function() {
    it('should create an instance of SourceDataMap', function() {
      // uncomment below and update the code to test SourceDataMap
      //var instance = new AmazonCloudSearch.SourceDataMap();
      //expect(instance).to.be.a(AmazonCloudSearch.SourceDataMap);
    });
