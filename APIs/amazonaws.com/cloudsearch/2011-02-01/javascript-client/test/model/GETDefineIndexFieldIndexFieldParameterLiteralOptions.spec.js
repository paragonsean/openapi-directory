...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudSearch.GETDefineIndexFieldIndexFieldParameterLiteralOptions();
  });
  ...
  describe('GETDefineIndexFieldIndexFieldParameterLiteralOptions', function() {
    it('should create an instance of GETDefineIndexFieldIndexFieldParameterLiteralOptions', function() {
      // uncomment below and update the code to test GETDefineIndexFieldIndexFieldParameterLiteralOptions
      //var instance = new AmazonCloudSearch.GETDefineIndexFieldIndexFieldParameterLiteralOptions();
      //expect(instance).to.be.a(AmazonCloudSearch.GETDefineIndexFieldIndexFieldParameterLiteralOptions);
    });
