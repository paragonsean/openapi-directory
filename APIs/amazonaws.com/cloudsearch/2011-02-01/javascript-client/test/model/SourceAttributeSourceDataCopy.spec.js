...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudSearch.SourceAttributeSourceDataCopy();
  });
  ...
  describe('SourceAttributeSourceDataCopy', function() {
    it('should create an instance of SourceAttributeSourceDataCopy', function() {
      // uncomment below and update the code to test SourceAttributeSourceDataCopy
      //var instance = new AmazonCloudSearch.SourceAttributeSourceDataCopy();
      //expect(instance).to.be.a(AmazonCloudSearch.SourceAttributeSourceDataCopy);
    });
