...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudSearch.DescribeIndexFieldsRequest();
  });
  ...
  describe('DescribeIndexFieldsRequest', function() {
    it('should create an instance of DescribeIndexFieldsRequest', function() {
      // uncomment below and update the code to test DescribeIndexFieldsRequest
      //var instance = new AmazonCloudSearch.DescribeIndexFieldsRequest();
      //expect(instance).to.be.a(AmazonCloudSearch.DescribeIndexFieldsRequest);
    });
