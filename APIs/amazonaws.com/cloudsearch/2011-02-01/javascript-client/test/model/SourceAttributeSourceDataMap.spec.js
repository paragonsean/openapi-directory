...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudSearch.SourceAttributeSourceDataMap();
  });
  ...
  describe('SourceAttributeSourceDataMap', function() {
    it('should create an instance of SourceAttributeSourceDataMap', function() {
      // uncomment below and update the code to test SourceAttributeSourceDataMap
      //var instance = new AmazonCloudSearch.SourceAttributeSourceDataMap();
      //expect(instance).to.be.a(AmazonCloudSearch.SourceAttributeSourceDataMap);
    });
