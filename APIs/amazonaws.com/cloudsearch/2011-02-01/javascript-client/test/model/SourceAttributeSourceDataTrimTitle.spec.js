...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudSearch.SourceAttributeSourceDataTrimTitle();
  });
  ...
  describe('SourceAttributeSourceDataTrimTitle', function() {
    it('should create an instance of SourceAttributeSourceDataTrimTitle', function() {
      // uncomment below and update the code to test SourceAttributeSourceDataTrimTitle
      //var instance = new AmazonCloudSearch.SourceAttributeSourceDataTrimTitle();
      //expect(instance).to.be.a(AmazonCloudSearch.SourceAttributeSourceDataTrimTitle);
    });
