...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonCloudSearch.DeleteIndexFieldRequest();
  });
  ...
  describe('DeleteIndexFieldRequest', function() {
    it('should create an instance of DeleteIndexFieldRequest', function() {
      // uncomment below and update the code to test DeleteIndexFieldRequest
      //var instance = new AmazonCloudSearch.DeleteIndexFieldRequest();
      //expect(instance).to.be.a(AmazonCloudSearch.DeleteIndexFieldRequest);
    });
