...
class DomainStatus(Model):
    ...
    def __init__(self, domain_id: str=None, domain_name: str=None, created: bool=None, deleted: bool=None, num_searchable_docs: int=None, doc_service: DomainStatusDocService=None, search_service: DomainStatusSearchService=None, requires_index_documents: bool=None, processing: bool=None, search_instance_type: str=None, search_partition_count: int=None, search_instance_count: int=None):
        ...
        :param num_searchable_docs: The num_searchable_docs of this DomainStatus.
        ...
        self.attribute_map = {
            ...
            'created': 'Created',
            'deleted': 'Deleted',
            'num_searchable_docs': 'NumSearchableDocs',
        ...
        self._num_searchable_docs = num_searchable_docs
    ...
    def num_searchable_docs(self):
        """Gets the num_searchable_docs of this DomainStatus.


        :return: The num_searchable_docs of this DomainStatus.
        :rtype: int
        """
        return self._num_searchable_docs

    @num_searchable_docs.setter
    def num_searchable_docs(self, num_searchable_docs):
        """Sets the num_searchable_docs of this DomainStatus.


        :param num_searchable_docs: The num_searchable_docs of this DomainStatus.
        :type num_searchable_docs: int
        """
