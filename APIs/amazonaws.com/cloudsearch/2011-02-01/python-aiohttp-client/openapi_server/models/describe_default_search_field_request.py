...
class DescribeDefaultSearchFieldRequest(Model):
    ...
    def __init__(self, domain_name: str=None):
        """DescribeDefaultSearchFieldRequest - a model defined in OpenAPI

        :param domain_name: The domain_name of this DescribeDefaultSearchFieldRequest.
        """
        self.openapi_types = {
            'domain_name': str
        }
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DescribeDefaultSearchFieldRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DescribeDefaultSearchFieldRequest of this DescribeDefaultSearchFieldRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def domain_name(self):
        """Gets the domain_name of this DescribeDefaultSearchFieldRequest.
        ...
        :return: The domain_name of this DescribeDefaultSearchFieldRequest.
        :rtype: str
        """
    ...
    def domain_name(self, domain_name):
        """Sets the domain_name of this DescribeDefaultSearchFieldRequest.
