...
class DescribeStopwordOptionsRequest(Model):
    ...
    def __init__(self, domain_name: str=None):
        """DescribeStopwordOptionsRequest - a model defined in OpenAPI

        :param domain_name: The domain_name of this DescribeStopwordOptionsRequest.
        """
        self.openapi_types = {
            'domain_name': str
        }
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DescribeStopwordOptionsRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DescribeStopwordOptionsRequest of this DescribeStopwordOptionsRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def domain_name(self):
        """Gets the domain_name of this DescribeStopwordOptionsRequest.
        ...
        :return: The domain_name of this DescribeStopwordOptionsRequest.
        :rtype: str
        """
    ...
    def domain_name(self, domain_name):
        """Sets the domain_name of this DescribeStopwordOptionsRequest.
