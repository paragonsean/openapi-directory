...
class DescribeSynonymOptionsRequest(Model):
    ...
    def __init__(self, domain_name: str=None):
        """DescribeSynonymOptionsRequest - a model defined in OpenAPI

        :param domain_name: The domain_name of this DescribeSynonymOptionsRequest.
        """
        self.openapi_types = {
            'domain_name': str
        }
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DescribeSynonymOptionsRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DescribeSynonymOptionsRequest of this DescribeSynonymOptionsRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def domain_name(self):
        """Gets the domain_name of this DescribeSynonymOptionsRequest.
        ...
        :return: The domain_name of this DescribeSynonymOptionsRequest.
        :rtype: str
        """
    ...
    def domain_name(self, domain_name):
        """Sets the domain_name of this DescribeSynonymOptionsRequest.
