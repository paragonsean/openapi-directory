...
class DescribeStemmingOptionsRequest(Model):
    ...
    def __init__(self, domain_name: str=None):
        """DescribeStemmingOptionsRequest - a model defined in OpenAPI

        :param domain_name: The domain_name of this DescribeStemmingOptionsRequest.
        """
        self.openapi_types = {
            'domain_name': str
        }
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DescribeStemmingOptionsRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DescribeStemmingOptionsRequest of this DescribeStemmingOptionsRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def domain_name(self):
        """Gets the domain_name of this DescribeStemmingOptionsRequest.
        ...
        :return: The domain_name of this DescribeStemmingOptionsRequest.
        :rtype: str
        """
    ...
    def domain_name(self, domain_name):
        """Sets the domain_name of this DescribeStemmingOptionsRequest.
