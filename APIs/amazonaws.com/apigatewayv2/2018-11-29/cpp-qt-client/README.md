...
OAICreateApi_request Example::create(){
    OAICreateApi_request obj;
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::createApiSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::createApiSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAICreateApi_request oai_create_api_request = create(); // OAICreateApi_request | 
      ...
      apiInstance.createApi(oai_create_api_requestx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
