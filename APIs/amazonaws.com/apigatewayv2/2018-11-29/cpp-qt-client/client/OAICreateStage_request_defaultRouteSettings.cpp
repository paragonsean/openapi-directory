...
OAICreateStage_request_defaultRouteSettings::OAICreateStage_request_defaultRouteSettings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateStage_request_defaultRouteSettings::OAICreateStage_request_defaultRouteSettings() {
    this->initializeModel();
}

OAICreateStage_request_defaultRouteSettings::~OAICreateStage_request_defaultRouteSettings() {}

void OAICreateStage_request_defaultRouteSettings::initializeModel() {
...
void OAICreateStage_request_defaultRouteSettings::fromJson(QString jsonString) {
...
void OAICreateStage_request_defaultRouteSettings::fromJsonObject(QJsonObject json) {
...
QString OAICreateStage_request_defaultRouteSettings::asJson() const {
...
QJsonObject OAICreateStage_request_defaultRouteSettings::asJsonObject() const {
    QJsonObject obj;
...
bool OAICreateStage_request_defaultRouteSettings::getDataTraceEnabled() const {
    return m_data_trace_enabled;
}
void OAICreateStage_request_defaultRouteSettings::setDataTraceEnabled(const bool &data_trace_enabled) {
    m_data_trace_enabled = data_trace_enabled;
    m_data_trace_enabled_isSet = true;
}

bool OAICreateStage_request_defaultRouteSettings::is_data_trace_enabled_Set() const{
    return m_data_trace_enabled_isSet;
}

bool OAICreateStage_request_defaultRouteSettings::is_data_trace_enabled_Valid() const{
    return m_data_trace_enabled_isValid;
}

bool OAICreateStage_request_defaultRouteSettings::getDetailedMetricsEnabled() const {
    return m_detailed_metrics_enabled;
}
void OAICreateStage_request_defaultRouteSettings::setDetailedMetricsEnabled(const bool &detailed_metrics_enabled) {
    m_detailed_metrics_enabled = detailed_metrics_enabled;
    m_detailed_metrics_enabled_isSet = true;
}

bool OAICreateStage_request_defaultRouteSettings::is_detailed_metrics_enabled_Set() const{
    return m_detailed_metrics_enabled_isSet;
}

bool OAICreateStage_request_defaultRouteSettings::is_detailed_metrics_enabled_Valid() const{
    return m_detailed_metrics_enabled_isValid;
}

OAILoggingLevel OAICreateStage_request_defaultRouteSettings::getLoggingLevel() const {
    return m_logging_level;
}
void OAICreateStage_request_defaultRouteSettings::setLoggingLevel(const OAILoggingLevel &logging_level) {
    m_logging_level = logging_level;
    m_logging_level_isSet = true;
}

bool OAICreateStage_request_defaultRouteSettings::is_logging_level_Set() const{
    return m_logging_level_isSet;
}

bool OAICreateStage_request_defaultRouteSettings::is_logging_level_Valid() const{
    return m_logging_level_isValid;
}

qint32 OAICreateStage_request_defaultRouteSettings::getThrottlingBurstLimit() const {
    return m_throttling_burst_limit;
}
void OAICreateStage_request_defaultRouteSettings::setThrottlingBurstLimit(const qint32 &throttling_burst_limit) {
    m_throttling_burst_limit = throttling_burst_limit;
    m_throttling_burst_limit_isSet = true;
}

bool OAICreateStage_request_defaultRouteSettings::is_throttling_burst_limit_Set() const{
    return m_throttling_burst_limit_isSet;
}

bool OAICreateStage_request_defaultRouteSettings::is_throttling_burst_limit_Valid() const{
    return m_throttling_burst_limit_isValid;
}

double OAICreateStage_request_defaultRouteSettings::getThrottlingRateLimit() const {
    return m_throttling_rate_limit;
}
void OAICreateStage_request_defaultRouteSettings::setThrottlingRateLimit(const double &throttling_rate_limit) {
    m_throttling_rate_limit = throttling_rate_limit;
    m_throttling_rate_limit_isSet = true;
}

bool OAICreateStage_request_defaultRouteSettings::is_throttling_rate_limit_Set() const{
    return m_throttling_rate_limit_isSet;
}

bool OAICreateStage_request_defaultRouteSettings::is_throttling_rate_limit_Valid() const{
    return m_throttling_rate_limit_isValid;
}

bool OAICreateStage_request_defaultRouteSettings::isSet() const {
...
bool OAICreateStage_request_defaultRouteSettings::isValid() const {
