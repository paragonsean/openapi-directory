...
OAICreateIntegrationResponseResponse::OAICreateIntegrationResponseResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateIntegrationResponseResponse::OAICreateIntegrationResponseResponse() {
    this->initializeModel();
}

OAICreateIntegrationResponseResponse::~OAICreateIntegrationResponseResponse() {}

void OAICreateIntegrationResponseResponse::initializeModel() {
...
void OAICreateIntegrationResponseResponse::fromJson(QString jsonString) {
...
void OAICreateIntegrationResponseResponse::fromJsonObject(QJsonObject json) {
...
QString OAICreateIntegrationResponseResponse::asJson() const {
...
QJsonObject OAICreateIntegrationResponseResponse::asJsonObject() const {
    QJsonObject obj;
...
OAIContentHandlingStrategy OAICreateIntegrationResponseResponse::getContentHandlingStrategy() const {
    return m_content_handling_strategy;
}
void OAICreateIntegrationResponseResponse::setContentHandlingStrategy(const OAIContentHandlingStrategy &content_handling_strategy) {
    m_content_handling_strategy = content_handling_strategy;
    m_content_handling_strategy_isSet = true;
}

bool OAICreateIntegrationResponseResponse::is_content_handling_strategy_Set() const{
    return m_content_handling_strategy_isSet;
}

bool OAICreateIntegrationResponseResponse::is_content_handling_strategy_Valid() const{
    return m_content_handling_strategy_isValid;
}

QString OAICreateIntegrationResponseResponse::getIntegrationResponseId() const {
    return m_integration_response_id;
}
void OAICreateIntegrationResponseResponse::setIntegrationResponseId(const QString &integration_response_id) {
    m_integration_response_id = integration_response_id;
    m_integration_response_id_isSet = true;
}

bool OAICreateIntegrationResponseResponse::is_integration_response_id_Set() const{
    return m_integration_response_id_isSet;
}

bool OAICreateIntegrationResponseResponse::is_integration_response_id_Valid() const{
    return m_integration_response_id_isValid;
}

QString OAICreateIntegrationResponseResponse::getIntegrationResponseKey() const {
    return m_integration_response_key;
}
void OAICreateIntegrationResponseResponse::setIntegrationResponseKey(const QString &integration_response_key) {
    m_integration_response_key = integration_response_key;
    m_integration_response_key_isSet = true;
}

bool OAICreateIntegrationResponseResponse::is_integration_response_key_Set() const{
    return m_integration_response_key_isSet;
}

bool OAICreateIntegrationResponseResponse::is_integration_response_key_Valid() const{
    return m_integration_response_key_isValid;
}

QMap OAICreateIntegrationResponseResponse::getResponseParameters() const {
    return m_response_parameters;
}
void OAICreateIntegrationResponseResponse::setResponseParameters(const QMap &response_parameters) {
    m_response_parameters = response_parameters;
    m_response_parameters_isSet = true;
}

bool OAICreateIntegrationResponseResponse::is_response_parameters_Set() const{
    return m_response_parameters_isSet;
}

bool OAICreateIntegrationResponseResponse::is_response_parameters_Valid() const{
    return m_response_parameters_isValid;
}

QMap OAICreateIntegrationResponseResponse::getResponseTemplates() const {
    return m_response_templates;
}
void OAICreateIntegrationResponseResponse::setResponseTemplates(const QMap &response_templates) {
    m_response_templates = response_templates;
    m_response_templates_isSet = true;
}

bool OAICreateIntegrationResponseResponse::is_response_templates_Set() const{
    return m_response_templates_isSet;
}

bool OAICreateIntegrationResponseResponse::is_response_templates_Valid() const{
    return m_response_templates_isValid;
}

QString OAICreateIntegrationResponseResponse::getTemplateSelectionExpression() const {
    return m_template_selection_expression;
}
void OAICreateIntegrationResponseResponse::setTemplateSelectionExpression(const QString &template_selection_expression) {
    m_template_selection_expression = template_selection_expression;
    m_template_selection_expression_isSet = true;
}

bool OAICreateIntegrationResponseResponse::is_template_selection_expression_Set() const{
    return m_template_selection_expression_isSet;
}

bool OAICreateIntegrationResponseResponse::is_template_selection_expression_Valid() const{
    return m_template_selection_expression_isValid;
}

bool OAICreateIntegrationResponseResponse::isSet() const {
...
bool OAICreateIntegrationResponseResponse::isValid() const {
