...
/*
 * OAIUpdateAuthorizerRequest.h
 *
 * Updates an Authorizer.
 */

#ifndef OAIUpdateAuthorizerRequest_H
#define OAIUpdateAuthorizerRequest_H
...
class OAIUpdateAuthorizerRequest : public OAIObject {
public:
    OAIUpdateAuthorizerRequest();
    OAIUpdateAuthorizerRequest(QString json);
    ~OAIUpdateAuthorizerRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateAuthorizerRequest)

#endif // OAIUpdateAuthorizerRequest_H
