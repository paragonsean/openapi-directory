...
/*
 * OAIReimportApiResponse.h
 *
 * 
 */

#ifndef OAIReimportApiResponse_H
#define OAIReimportApiResponse_H
...
class OAIReimportApiResponse : public OAIObject {
public:
    OAIReimportApiResponse();
    OAIReimportApiResponse(QString json);
    ~OAIReimportApiResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReimportApiResponse)

#endif // OAIReimportApiResponse_H
