...
/*
 * OAIImportApiResponse.h
 *
 * 
 */

#ifndef OAIImportApiResponse_H
#define OAIImportApiResponse_H
...
class OAIImportApiResponse : public OAIObject {
public:
    OAIImportApiResponse();
    OAIImportApiResponse(QString json);
    ~OAIImportApiResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImportApiResponse)

#endif // OAIImportApiResponse_H
