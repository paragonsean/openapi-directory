...
OAIContentHandlingStrategy OAIIntegrationResponse::getContentHandlingStrategy() const {
    return m_content_handling_strategy;
}
void OAIIntegrationResponse::setContentHandlingStrategy(const OAIContentHandlingStrategy &content_handling_strategy) {
    m_content_handling_strategy = content_handling_strategy;
    m_content_handling_strategy_isSet = true;
}

bool OAIIntegrationResponse::is_content_handling_strategy_Set() const{
    return m_content_handling_strategy_isSet;
}

bool OAIIntegrationResponse::is_content_handling_strategy_Valid() const{
    return m_content_handling_strategy_isValid;
}

QString OAIIntegrationResponse::getIntegrationResponseId() const {
    return m_integration_response_id;
}
void OAIIntegrationResponse::setIntegrationResponseId(const QString &integration_response_id) {
    m_integration_response_id = integration_response_id;
    m_integration_response_id_isSet = true;
}

bool OAIIntegrationResponse::is_integration_response_id_Set() const{
    return m_integration_response_id_isSet;
}

bool OAIIntegrationResponse::is_integration_response_id_Valid() const{
    return m_integration_response_id_isValid;
}

QString OAIIntegrationResponse::getIntegrationResponseKey() const {
    return m_integration_response_key;
}
void OAIIntegrationResponse::setIntegrationResponseKey(const QString &integration_response_key) {
    m_integration_response_key = integration_response_key;
    m_integration_response_key_isSet = true;
}

bool OAIIntegrationResponse::is_integration_response_key_Set() const{
    return m_integration_response_key_isSet;
}

bool OAIIntegrationResponse::is_integration_response_key_Valid() const{
...
QString OAIIntegrationResponse::getTemplateSelectionExpression() const {
    return m_template_selection_expression;
}
void OAIIntegrationResponse::setTemplateSelectionExpression(const QString &template_selection_expression) {
    m_template_selection_expression = template_selection_expression;
    m_template_selection_expression_isSet = true;
}

bool OAIIntegrationResponse::is_template_selection_expression_Set() const{
    return m_template_selection_expression_isSet;
}

bool OAIIntegrationResponse::is_template_selection_expression_Valid() const{
