...
bool OAIGetDeploymentResponse::getAutoDeployed() const {
    return m_auto_deployed;
}
void OAIGetDeploymentResponse::setAutoDeployed(const bool &auto_deployed) {
    m_auto_deployed = auto_deployed;
    m_auto_deployed_isSet = true;
}

bool OAIGetDeploymentResponse::is_auto_deployed_Set() const{
    return m_auto_deployed_isSet;
}

bool OAIGetDeploymentResponse::is_auto_deployed_Valid() const{
    return m_auto_deployed_isValid;
}

QDateTime OAIGetDeploymentResponse::getCreatedDate() const {
    return m_created_date;
}
void OAIGetDeploymentResponse::setCreatedDate(const QDateTime &created_date) {
    m_created_date = created_date;
    m_created_date_isSet = true;
}

bool OAIGetDeploymentResponse::is_created_date_Set() const{
    return m_created_date_isSet;
}

bool OAIGetDeploymentResponse::is_created_date_Valid() const{
...
QString OAIGetDeploymentResponse::getDeploymentStatusMessage() const {
    return m_deployment_status_message;
}
void OAIGetDeploymentResponse::setDeploymentStatusMessage(const QString &deployment_status_message) {
    m_deployment_status_message = deployment_status_message;
    m_deployment_status_message_isSet = true;
}

bool OAIGetDeploymentResponse::is_deployment_status_message_Set() const{
    return m_deployment_status_message_isSet;
}

bool OAIGetDeploymentResponse::is_deployment_status_message_Valid() const{
    return m_deployment_status_message_isValid;
}

QString OAIGetDeploymentResponse::getDescription() const {
    return m_description;
}
void OAIGetDeploymentResponse::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIGetDeploymentResponse::is_description_Set() const{
    return m_description_isSet;
}

bool OAIGetDeploymentResponse::is_description_Valid() const{
