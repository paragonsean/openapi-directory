...
/*
 * OAICreateRouteResult.h
 *
 * 
 */

#ifndef OAICreateRouteResult_H
#define OAICreateRouteResult_H
...
class OAICreateRouteResult : public OAIObject {
public:
    OAICreateRouteResult();
    OAICreateRouteResult(QString json);
    ~OAICreateRouteResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateRouteResult)

#endif // OAICreateRouteResult_H
