...
#include "OAIUpdateAuthorizerRequest.h"
...
OAIUpdateAuthorizerRequest::OAIUpdateAuthorizerRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateAuthorizerRequest::OAIUpdateAuthorizerRequest() {
    this->initializeModel();
}

OAIUpdateAuthorizerRequest::~OAIUpdateAuthorizerRequest() {}

void OAIUpdateAuthorizerRequest::initializeModel() {
...
void OAIUpdateAuthorizerRequest::fromJson(QString jsonString) {
...
void OAIUpdateAuthorizerRequest::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateAuthorizerRequest::asJson() const {
...
QJsonObject OAIUpdateAuthorizerRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateAuthorizerRequest::getAuthorizerCredentialsArn() const {
    return m_authorizer_credentials_arn;
}
void OAIUpdateAuthorizerRequest::setAuthorizerCredentialsArn(const QString &authorizer_credentials_arn) {
    m_authorizer_credentials_arn = authorizer_credentials_arn;
    m_authorizer_credentials_arn_isSet = true;
}

bool OAIUpdateAuthorizerRequest::is_authorizer_credentials_arn_Set() const{
    return m_authorizer_credentials_arn_isSet;
}

bool OAIUpdateAuthorizerRequest::is_authorizer_credentials_arn_Valid() const{
    return m_authorizer_credentials_arn_isValid;
}

QString OAIUpdateAuthorizerRequest::getAuthorizerPayloadFormatVersion() const {
    return m_authorizer_payload_format_version;
}
void OAIUpdateAuthorizerRequest::setAuthorizerPayloadFormatVersion(const QString &authorizer_payload_format_version) {
    m_authorizer_payload_format_version = authorizer_payload_format_version;
    m_authorizer_payload_format_version_isSet = true;
}

bool OAIUpdateAuthorizerRequest::is_authorizer_payload_format_version_Set() const{
    return m_authorizer_payload_format_version_isSet;
}

bool OAIUpdateAuthorizerRequest::is_authorizer_payload_format_version_Valid() const{
    return m_authorizer_payload_format_version_isValid;
}

qint32 OAIUpdateAuthorizerRequest::getAuthorizerResultTtlInSeconds() const {
    return m_authorizer_result_ttl_in_seconds;
}
void OAIUpdateAuthorizerRequest::setAuthorizerResultTtlInSeconds(const qint32 &authorizer_result_ttl_in_seconds) {
    m_authorizer_result_ttl_in_seconds = authorizer_result_ttl_in_seconds;
    m_authorizer_result_ttl_in_seconds_isSet = true;
}

bool OAIUpdateAuthorizerRequest::is_authorizer_result_ttl_in_seconds_Set() const{
    return m_authorizer_result_ttl_in_seconds_isSet;
}

bool OAIUpdateAuthorizerRequest::is_authorizer_result_ttl_in_seconds_Valid() const{
    return m_authorizer_result_ttl_in_seconds_isValid;
}

OAIAuthorizerType OAIUpdateAuthorizerRequest::getAuthorizerType() const {
    return m_authorizer_type;
}
void OAIUpdateAuthorizerRequest::setAuthorizerType(const OAIAuthorizerType &authorizer_type) {
    m_authorizer_type = authorizer_type;
    m_authorizer_type_isSet = true;
}

bool OAIUpdateAuthorizerRequest::is_authorizer_type_Set() const{
    return m_authorizer_type_isSet;
}

bool OAIUpdateAuthorizerRequest::is_authorizer_type_Valid() const{
    return m_authorizer_type_isValid;
}

QString OAIUpdateAuthorizerRequest::getAuthorizerUri() const {
    return m_authorizer_uri;
}
void OAIUpdateAuthorizerRequest::setAuthorizerUri(const QString &authorizer_uri) {
    m_authorizer_uri = authorizer_uri;
    m_authorizer_uri_isSet = true;
}

bool OAIUpdateAuthorizerRequest::is_authorizer_uri_Set() const{
    return m_authorizer_uri_isSet;
}

bool OAIUpdateAuthorizerRequest::is_authorizer_uri_Valid() const{
    return m_authorizer_uri_isValid;
}

bool OAIUpdateAuthorizerRequest::getEnableSimpleResponses() const {
    return m_enable_simple_responses;
}
void OAIUpdateAuthorizerRequest::setEnableSimpleResponses(const bool &enable_simple_responses) {
    m_enable_simple_responses = enable_simple_responses;
    m_enable_simple_responses_isSet = true;
}

bool OAIUpdateAuthorizerRequest::is_enable_simple_responses_Set() const{
    return m_enable_simple_responses_isSet;
}

bool OAIUpdateAuthorizerRequest::is_enable_simple_responses_Valid() const{
    return m_enable_simple_responses_isValid;
}

QList OAIUpdateAuthorizerRequest::getIdentitySource() const {
    return m_identity_source;
}
void OAIUpdateAuthorizerRequest::setIdentitySource(const QList &identity_source) {
    m_identity_source = identity_source;
    m_identity_source_isSet = true;
}

bool OAIUpdateAuthorizerRequest::is_identity_source_Set() const{
    return m_identity_source_isSet;
}

bool OAIUpdateAuthorizerRequest::is_identity_source_Valid() const{
    return m_identity_source_isValid;
}

QString OAIUpdateAuthorizerRequest::getIdentityValidationExpression() const {
    return m_identity_validation_expression;
}
void OAIUpdateAuthorizerRequest::setIdentityValidationExpression(const QString &identity_validation_expression) {
    m_identity_validation_expression = identity_validation_expression;
    m_identity_validation_expression_isSet = true;
}

bool OAIUpdateAuthorizerRequest::is_identity_validation_expression_Set() const{
    return m_identity_validation_expression_isSet;
}

bool OAIUpdateAuthorizerRequest::is_identity_validation_expression_Valid() const{
    return m_identity_validation_expression_isValid;
}

OAICreateAuthorizerResponse_JwtConfiguration OAIUpdateAuthorizerRequest::getJwtConfiguration() const {
    return m_jwt_configuration;
}
void OAIUpdateAuthorizerRequest::setJwtConfiguration(const OAICreateAuthorizerResponse_JwtConfiguration &jwt_configuration) {
    m_jwt_configuration = jwt_configuration;
    m_jwt_configuration_isSet = true;
}

bool OAIUpdateAuthorizerRequest::is_jwt_configuration_Set() const{
    return m_jwt_configuration_isSet;
}

bool OAIUpdateAuthorizerRequest::is_jwt_configuration_Valid() const{
    return m_jwt_configuration_isValid;
}

QString OAIUpdateAuthorizerRequest::getName() const {
    return m_name;
}
void OAIUpdateAuthorizerRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIUpdateAuthorizerRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAIUpdateAuthorizerRequest::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIUpdateAuthorizerRequest::isSet() const {
...
bool OAIUpdateAuthorizerRequest::isValid() const {
