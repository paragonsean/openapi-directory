...
/*
 * OAIUpdateAuthorizerResponse.h
 *
 * 
 */

#ifndef OAIUpdateAuthorizerResponse_H
#define OAIUpdateAuthorizerResponse_H
...
class OAIUpdateAuthorizerResponse : public OAIObject {
public:
    OAIUpdateAuthorizerResponse();
    OAIUpdateAuthorizerResponse(QString json);
    ~OAIUpdateAuthorizerResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateAuthorizerResponse)

#endif // OAIUpdateAuthorizerResponse_H
