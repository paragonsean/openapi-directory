...
/*
 * OAICreateIntegrationResult.h
 *
 * 
 */

#ifndef OAICreateIntegrationResult_H
#define OAICreateIntegrationResult_H
...
namespace OpenAPI {
class OAICreateIntegrationResult_TlsConfig;

class OAICreateIntegrationResult : public OAIObject {
public:
    OAICreateIntegrationResult();
    OAICreateIntegrationResult(QString json);
    ~OAICreateIntegrationResult() override;
    ...
    QString getIntegrationResponseSelectionExpression() const;
    void setIntegrationResponseSelectionExpression(const QString &integration_response_selection_expression);
    bool is_integration_response_selection_expression_Set() const;
    bool is_integration_response_selection_expression_Valid() const;
    ...
    OAICreateIntegrationResult_TlsConfig getTlsConfig() const;
    void setTlsConfig(const OAICreateIntegrationResult_TlsConfig &tls_config);
...
private:
    ...
    QString m_integration_response_selection_expression;
    bool m_integration_response_selection_expression_isSet;
    bool m_integration_response_selection_expression_isValid;
    ...
    OAICreateIntegrationResult_TlsConfig m_tls_config;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateIntegrationResult)

#endif // OAICreateIntegrationResult_H
