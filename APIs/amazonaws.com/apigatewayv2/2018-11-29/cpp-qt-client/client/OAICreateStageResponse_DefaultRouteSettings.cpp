...
OAICreateStageResponse_DefaultRouteSettings::OAICreateStageResponse_DefaultRouteSettings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateStageResponse_DefaultRouteSettings::OAICreateStageResponse_DefaultRouteSettings() {
    this->initializeModel();
}

OAICreateStageResponse_DefaultRouteSettings::~OAICreateStageResponse_DefaultRouteSettings() {}

void OAICreateStageResponse_DefaultRouteSettings::initializeModel() {
...
void OAICreateStageResponse_DefaultRouteSettings::fromJson(QString jsonString) {
...
void OAICreateStageResponse_DefaultRouteSettings::fromJsonObject(QJsonObject json) {
...
QString OAICreateStageResponse_DefaultRouteSettings::asJson() const {
...
QJsonObject OAICreateStageResponse_DefaultRouteSettings::asJsonObject() const {
    QJsonObject obj;
...
bool OAICreateStageResponse_DefaultRouteSettings::getDataTraceEnabled() const {
    return m_data_trace_enabled;
}
void OAICreateStageResponse_DefaultRouteSettings::setDataTraceEnabled(const bool &data_trace_enabled) {
    m_data_trace_enabled = data_trace_enabled;
    m_data_trace_enabled_isSet = true;
}

bool OAICreateStageResponse_DefaultRouteSettings::is_data_trace_enabled_Set() const{
    return m_data_trace_enabled_isSet;
}

bool OAICreateStageResponse_DefaultRouteSettings::is_data_trace_enabled_Valid() const{
    return m_data_trace_enabled_isValid;
}

bool OAICreateStageResponse_DefaultRouteSettings::getDetailedMetricsEnabled() const {
    return m_detailed_metrics_enabled;
}
void OAICreateStageResponse_DefaultRouteSettings::setDetailedMetricsEnabled(const bool &detailed_metrics_enabled) {
    m_detailed_metrics_enabled = detailed_metrics_enabled;
    m_detailed_metrics_enabled_isSet = true;
}

bool OAICreateStageResponse_DefaultRouteSettings::is_detailed_metrics_enabled_Set() const{
    return m_detailed_metrics_enabled_isSet;
}

bool OAICreateStageResponse_DefaultRouteSettings::is_detailed_metrics_enabled_Valid() const{
    return m_detailed_metrics_enabled_isValid;
}

OAILoggingLevel OAICreateStageResponse_DefaultRouteSettings::getLoggingLevel() const {
    return m_logging_level;
}
void OAICreateStageResponse_DefaultRouteSettings::setLoggingLevel(const OAILoggingLevel &logging_level) {
    m_logging_level = logging_level;
    m_logging_level_isSet = true;
}

bool OAICreateStageResponse_DefaultRouteSettings::is_logging_level_Set() const{
    return m_logging_level_isSet;
}

bool OAICreateStageResponse_DefaultRouteSettings::is_logging_level_Valid() const{
    return m_logging_level_isValid;
}

qint32 OAICreateStageResponse_DefaultRouteSettings::getThrottlingBurstLimit() const {
    return m_throttling_burst_limit;
}
void OAICreateStageResponse_DefaultRouteSettings::setThrottlingBurstLimit(const qint32 &throttling_burst_limit) {
    m_throttling_burst_limit = throttling_burst_limit;
    m_throttling_burst_limit_isSet = true;
}

bool OAICreateStageResponse_DefaultRouteSettings::is_throttling_burst_limit_Set() const{
    return m_throttling_burst_limit_isSet;
}

bool OAICreateStageResponse_DefaultRouteSettings::is_throttling_burst_limit_Valid() const{
    return m_throttling_burst_limit_isValid;
}

double OAICreateStageResponse_DefaultRouteSettings::getThrottlingRateLimit() const {
    return m_throttling_rate_limit;
}
void OAICreateStageResponse_DefaultRouteSettings::setThrottlingRateLimit(const double &throttling_rate_limit) {
    m_throttling_rate_limit = throttling_rate_limit;
    m_throttling_rate_limit_isSet = true;
}

bool OAICreateStageResponse_DefaultRouteSettings::is_throttling_rate_limit_Set() const{
    return m_throttling_rate_limit_isSet;
}

bool OAICreateStageResponse_DefaultRouteSettings::is_throttling_rate_limit_Valid() const{
    return m_throttling_rate_limit_isValid;
}

bool OAICreateStageResponse_DefaultRouteSettings::isSet() const {
...
bool OAICreateStageResponse_DefaultRouteSettings::isValid() const {
