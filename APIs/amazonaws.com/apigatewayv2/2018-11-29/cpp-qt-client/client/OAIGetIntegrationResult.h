...
/*
 * OAIGetIntegrationResult.h
 *
 * 
 */

#ifndef OAIGetIntegrationResult_H
#define OAIGetIntegrationResult_H
...
class OAIGetIntegrationResult : public OAIObject {
public:
    OAIGetIntegrationResult();
    OAIGetIntegrationResult(QString json);
    ~OAIGetIntegrationResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetIntegrationResult)

#endif // OAIGetIntegrationResult_H
