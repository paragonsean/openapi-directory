...
/*
 * OAIUpdateApiRequest.h
 *
 * Updates an Api.
 */

#ifndef OAIUpdateApiRequest_H
#define OAIUpdateApiRequest_H
...
class OAIUpdateApiRequest : public OAIObject {
public:
    OAIUpdateApiRequest();
    OAIUpdateApiRequest(QString json);
    ~OAIUpdateApiRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateApiRequest)

#endif // OAIUpdateApiRequest_H
