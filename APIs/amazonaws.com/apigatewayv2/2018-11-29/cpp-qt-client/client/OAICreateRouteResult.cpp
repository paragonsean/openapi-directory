...
OAICreateRouteResult::OAICreateRouteResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateRouteResult::OAICreateRouteResult() {
    this->initializeModel();
}

OAICreateRouteResult::~OAICreateRouteResult() {}

void OAICreateRouteResult::initializeModel() {
...
void OAICreateRouteResult::fromJson(QString jsonString) {
...
void OAICreateRouteResult::fromJsonObject(QJsonObject json) {
...
QString OAICreateRouteResult::asJson() const {
...
QJsonObject OAICreateRouteResult::asJsonObject() const {
    QJsonObject obj;
...
bool OAICreateRouteResult::getApiGatewayManaged() const {
    return m_api_gateway_managed;
}
void OAICreateRouteResult::setApiGatewayManaged(const bool &api_gateway_managed) {
    m_api_gateway_managed = api_gateway_managed;
    m_api_gateway_managed_isSet = true;
}

bool OAICreateRouteResult::is_api_gateway_managed_Set() const{
    return m_api_gateway_managed_isSet;
}

bool OAICreateRouteResult::is_api_gateway_managed_Valid() const{
    return m_api_gateway_managed_isValid;
}

bool OAICreateRouteResult::getApiKeyRequired() const {
    return m_api_key_required;
}
void OAICreateRouteResult::setApiKeyRequired(const bool &api_key_required) {
    m_api_key_required = api_key_required;
    m_api_key_required_isSet = true;
}

bool OAICreateRouteResult::is_api_key_required_Set() const{
    return m_api_key_required_isSet;
}

bool OAICreateRouteResult::is_api_key_required_Valid() const{
    return m_api_key_required_isValid;
}

QList OAICreateRouteResult::getAuthorizationScopes() const {
    return m_authorization_scopes;
}
void OAICreateRouteResult::setAuthorizationScopes(const QList &authorization_scopes) {
    m_authorization_scopes = authorization_scopes;
    m_authorization_scopes_isSet = true;
}

bool OAICreateRouteResult::is_authorization_scopes_Set() const{
    return m_authorization_scopes_isSet;
}

bool OAICreateRouteResult::is_authorization_scopes_Valid() const{
    return m_authorization_scopes_isValid;
}

OAIAuthorizationType OAICreateRouteResult::getAuthorizationType() const {
    return m_authorization_type;
}
void OAICreateRouteResult::setAuthorizationType(const OAIAuthorizationType &authorization_type) {
    m_authorization_type = authorization_type;
    m_authorization_type_isSet = true;
}

bool OAICreateRouteResult::is_authorization_type_Set() const{
    return m_authorization_type_isSet;
}

bool OAICreateRouteResult::is_authorization_type_Valid() const{
    return m_authorization_type_isValid;
}

QString OAICreateRouteResult::getAuthorizerId() const {
    return m_authorizer_id;
}
void OAICreateRouteResult::setAuthorizerId(const QString &authorizer_id) {
    m_authorizer_id = authorizer_id;
    m_authorizer_id_isSet = true;
}

bool OAICreateRouteResult::is_authorizer_id_Set() const{
    return m_authorizer_id_isSet;
}

bool OAICreateRouteResult::is_authorizer_id_Valid() const{
    return m_authorizer_id_isValid;
}

QString OAICreateRouteResult::getModelSelectionExpression() const {
    return m_model_selection_expression;
}
void OAICreateRouteResult::setModelSelectionExpression(const QString &model_selection_expression) {
    m_model_selection_expression = model_selection_expression;
    m_model_selection_expression_isSet = true;
}

bool OAICreateRouteResult::is_model_selection_expression_Set() const{
    return m_model_selection_expression_isSet;
}

bool OAICreateRouteResult::is_model_selection_expression_Valid() const{
    return m_model_selection_expression_isValid;
}

QString OAICreateRouteResult::getOperationName() const {
    return m_operation_name;
}
void OAICreateRouteResult::setOperationName(const QString &operation_name) {
    m_operation_name = operation_name;
    m_operation_name_isSet = true;
}

bool OAICreateRouteResult::is_operation_name_Set() const{
    return m_operation_name_isSet;
}

bool OAICreateRouteResult::is_operation_name_Valid() const{
    return m_operation_name_isValid;
}

QMap OAICreateRouteResult::getRequestModels() const {
    return m_request_models;
}
void OAICreateRouteResult::setRequestModels(const QMap &request_models) {
    m_request_models = request_models;
    m_request_models_isSet = true;
}

bool OAICreateRouteResult::is_request_models_Set() const{
    return m_request_models_isSet;
}

bool OAICreateRouteResult::is_request_models_Valid() const{
    return m_request_models_isValid;
}

QMap OAICreateRouteResult::getRequestParameters() const {
    return m_request_parameters;
}
void OAICreateRouteResult::setRequestParameters(const QMap &request_parameters) {
    m_request_parameters = request_parameters;
    m_request_parameters_isSet = true;
}

bool OAICreateRouteResult::is_request_parameters_Set() const{
    return m_request_parameters_isSet;
}

bool OAICreateRouteResult::is_request_parameters_Valid() const{
    return m_request_parameters_isValid;
}

QString OAICreateRouteResult::getRouteId() const {
    return m_route_id;
}
void OAICreateRouteResult::setRouteId(const QString &route_id) {
    m_route_id = route_id;
    m_route_id_isSet = true;
}

bool OAICreateRouteResult::is_route_id_Set() const{
    return m_route_id_isSet;
}

bool OAICreateRouteResult::is_route_id_Valid() const{
    return m_route_id_isValid;
}

QString OAICreateRouteResult::getRouteKey() const {
    return m_route_key;
}
void OAICreateRouteResult::setRouteKey(const QString &route_key) {
    m_route_key = route_key;
    m_route_key_isSet = true;
}

bool OAICreateRouteResult::is_route_key_Set() const{
    return m_route_key_isSet;
}

bool OAICreateRouteResult::is_route_key_Valid() const{
    return m_route_key_isValid;
}

QString OAICreateRouteResult::getRouteResponseSelectionExpression() const {
    return m_route_response_selection_expression;
}
void OAICreateRouteResult::setRouteResponseSelectionExpression(const QString &route_response_selection_expression) {
...
bool OAICreateRouteResult::is_route_response_selection_expression_Set() const{
    return m_route_response_selection_expression_isSet;
}

bool OAICreateRouteResult::is_route_response_selection_expression_Valid() const{
    return m_route_response_selection_expression_isValid;
}

QString OAICreateRouteResult::getTarget() const {
    return m_target;
}
void OAICreateRouteResult::setTarget(const QString &target) {
    m_target = target;
    m_target_isSet = true;
}

bool OAICreateRouteResult::is_target_Set() const{
    return m_target_isSet;
}

bool OAICreateRouteResult::is_target_Valid() const{
    return m_target_isValid;
}

bool OAICreateRouteResult::isSet() const {
...
bool OAICreateRouteResult::isValid() const {
