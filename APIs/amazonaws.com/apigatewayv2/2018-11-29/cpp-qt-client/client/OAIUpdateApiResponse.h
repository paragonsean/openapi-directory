...
/*
 * OAIUpdateApiResponse.h
 *
 * 
 */

#ifndef OAIUpdateApiResponse_H
#define OAIUpdateApiResponse_H
...
class OAIUpdateApiResponse : public OAIObject {
public:
    OAIUpdateApiResponse();
    OAIUpdateApiResponse(QString json);
    ~OAIUpdateApiResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateApiResponse)

#endif // OAIUpdateApiResponse_H
