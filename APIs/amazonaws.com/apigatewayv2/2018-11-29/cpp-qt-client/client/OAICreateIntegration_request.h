...
/*
 * OAICreateIntegration_request.h
 *
 * 
 */

#ifndef OAICreateIntegration_request_H
#define OAICreateIntegration_request_H
...
class OAICreateIntegration_request : public OAIObject {
public:
    OAICreateIntegration_request();
    OAICreateIntegration_request(QString json);
    ~OAICreateIntegration_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateIntegration_request)

#endif // OAICreateIntegration_request_H
