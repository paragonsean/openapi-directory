...
QString OAICreateAuthorizerRequest::getAuthorizerCredentialsArn() const {
    return m_authorizer_credentials_arn;
}
void OAICreateAuthorizerRequest::setAuthorizerCredentialsArn(const QString &authorizer_credentials_arn) {
    m_authorizer_credentials_arn = authorizer_credentials_arn;
    m_authorizer_credentials_arn_isSet = true;
}

bool OAICreateAuthorizerRequest::is_authorizer_credentials_arn_Set() const{
    return m_authorizer_credentials_arn_isSet;
}

bool OAICreateAuthorizerRequest::is_authorizer_credentials_arn_Valid() const{
    return m_authorizer_credentials_arn_isValid;
}

QString OAICreateAuthorizerRequest::getAuthorizerPayloadFormatVersion() const {
    return m_authorizer_payload_format_version;
}
void OAICreateAuthorizerRequest::setAuthorizerPayloadFormatVersion(const QString &authorizer_payload_format_version) {
    m_authorizer_payload_format_version = authorizer_payload_format_version;
    m_authorizer_payload_format_version_isSet = true;
}

bool OAICreateAuthorizerRequest::is_authorizer_payload_format_version_Set() const{
    return m_authorizer_payload_format_version_isSet;
}

bool OAICreateAuthorizerRequest::is_authorizer_payload_format_version_Valid() const{
...
OAIAuthorizerType OAICreateAuthorizerRequest::getAuthorizerType() const {
    return m_authorizer_type;
}
void OAICreateAuthorizerRequest::setAuthorizerType(const OAIAuthorizerType &authorizer_type) {
    m_authorizer_type = authorizer_type;
    m_authorizer_type_isSet = true;
}

bool OAICreateAuthorizerRequest::is_authorizer_type_Set() const{
    return m_authorizer_type_isSet;
}

bool OAICreateAuthorizerRequest::is_authorizer_type_Valid() const{
...
bool OAICreateAuthorizerRequest::getEnableSimpleResponses() const {
    return m_enable_simple_responses;
}
void OAICreateAuthorizerRequest::setEnableSimpleResponses(const bool &enable_simple_responses) {
    m_enable_simple_responses = enable_simple_responses;
    m_enable_simple_responses_isSet = true;
}

bool OAICreateAuthorizerRequest::is_enable_simple_responses_Set() const{
    return m_enable_simple_responses_isSet;
}

bool OAICreateAuthorizerRequest::is_enable_simple_responses_Valid() const{
    return m_enable_simple_responses_isValid;
}

QList OAICreateAuthorizerRequest::getIdentitySource() const {
    return m_identity_source;
}
void OAICreateAuthorizerRequest::setIdentitySource(const QList &identity_source) {
...
OAICreateAuthorizerResponse_JwtConfiguration OAICreateAuthorizerRequest::getJwtConfiguration() const {
    return m_jwt_configuration;
}
void OAICreateAuthorizerRequest::setJwtConfiguration(const OAICreateAuthorizerResponse_JwtConfiguration &jwt_configuration) {
    m_jwt_configuration = jwt_configuration;
    m_jwt_configuration_isSet = true;
}

bool OAICreateAuthorizerRequest::is_jwt_configuration_Set() const{
    return m_jwt_configuration_isSet;
}

bool OAICreateAuthorizerRequest::is_jwt_configuration_Valid() const{
