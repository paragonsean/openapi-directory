...
/*
 * OAIUpdateAuthorizer_request.h
 *
 * 
 */

#ifndef OAIUpdateAuthorizer_request_H
#define OAIUpdateAuthorizer_request_H
...
namespace OpenAPI {
class OAICreateAuthorizer_request_jwtConfiguration;

class OAIUpdateAuthorizer_request : public OAIObject {
public:
    OAIUpdateAuthorizer_request();
    OAIUpdateAuthorizer_request(QString json);
    ~OAIUpdateAuthorizer_request() override;
    ...
    QString getAuthorizerType() const;
    void setAuthorizerType(const QString &authorizer_type);
    ...
    bool isEnableSimpleResponses() const;
    ...
    QList<QString> getIdentitySource() const;
    void setIdentitySource(const QList<QString> &identity_source);
    ...
    OAICreateAuthorizer_request_jwtConfiguration getJwtConfiguration() const;
    void setJwtConfiguration(const OAICreateAuthorizer_request_jwtConfiguration &jwt_configuration);
...
private:
    ...
    QList<QString> m_identity_source;
    ...
    OAICreateAuthorizer_request_jwtConfiguration m_jwt_configuration;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateAuthorizer_request)

#endif // OAIUpdateAuthorizer_request_H
