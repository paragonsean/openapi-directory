...
/*
 * OAICreateApiResponse.h
 *
 * 
 */

#ifndef OAICreateApiResponse_H
#define OAICreateApiResponse_H
...
class OAICreateApiResponse : public OAIObject {
public:
    OAICreateApiResponse();
    OAICreateApiResponse(QString json);
    ~OAICreateApiResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateApiResponse)

#endif // OAICreateApiResponse_H
