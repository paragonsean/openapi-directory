...
OAICreateStageResponse_AccessLogSettings OAIGetStageResponse::getAccessLogSettings() const {
    return m_access_log_settings;
}
void OAIGetStageResponse::setAccessLogSettings(const OAICreateStageResponse_AccessLogSettings &access_log_settings) {
    m_access_log_settings = access_log_settings;
    m_access_log_settings_isSet = true;
}

bool OAIGetStageResponse::is_access_log_settings_Set() const{
    return m_access_log_settings_isSet;
}

bool OAIGetStageResponse::is_access_log_settings_Valid() const{
    return m_access_log_settings_isValid;
}

bool OAIGetStageResponse::getApiGatewayManaged() const {
    return m_api_gateway_managed;
}
void OAIGetStageResponse::setApiGatewayManaged(const bool &api_gateway_managed) {
    m_api_gateway_managed = api_gateway_managed;
    m_api_gateway_managed_isSet = true;
}

bool OAIGetStageResponse::is_api_gateway_managed_Set() const{
    return m_api_gateway_managed_isSet;
}

bool OAIGetStageResponse::is_api_gateway_managed_Valid() const{
    return m_api_gateway_managed_isValid;
}

bool OAIGetStageResponse::getAutoDeploy() const {
    return m_auto_deploy;
}
void OAIGetStageResponse::setAutoDeploy(const bool &auto_deploy) {
    m_auto_deploy = auto_deploy;
    m_auto_deploy_isSet = true;
}

bool OAIGetStageResponse::is_auto_deploy_Set() const{
    return m_auto_deploy_isSet;
}

bool OAIGetStageResponse::is_auto_deploy_Valid() const{
    return m_auto_deploy_isValid;
}

QString OAIGetStageResponse::getClientCertificateId() const {
    return m_client_certificate_id;
}
void OAIGetStageResponse::setClientCertificateId(const QString &client_certificate_id) {
    m_client_certificate_id = client_certificate_id;
    m_client_certificate_id_isSet = true;
}

bool OAIGetStageResponse::is_client_certificate_id_Set() const{
    return m_client_certificate_id_isSet;
}

bool OAIGetStageResponse::is_client_certificate_id_Valid() const{
    return m_client_certificate_id_isValid;
}

QDateTime OAIGetStageResponse::getCreatedDate() const {
    return m_created_date;
}
void OAIGetStageResponse::setCreatedDate(const QDateTime &created_date) {
    m_created_date = created_date;
    m_created_date_isSet = true;
}

bool OAIGetStageResponse::is_created_date_Set() const{
    return m_created_date_isSet;
}

bool OAIGetStageResponse::is_created_date_Valid() const{
    return m_created_date_isValid;
}

OAICreateStageResponse_DefaultRouteSettings OAIGetStageResponse::getDefaultRouteSettings() const {
    return m_default_route_settings;
}
void OAIGetStageResponse::setDefaultRouteSettings(const OAICreateStageResponse_DefaultRouteSettings &default_route_settings) {
    m_default_route_settings = default_route_settings;
    m_default_route_settings_isSet = true;
}

bool OAIGetStageResponse::is_default_route_settings_Set() const{
    return m_default_route_settings_isSet;
}

bool OAIGetStageResponse::is_default_route_settings_Valid() const{
    return m_default_route_settings_isValid;
}

QString OAIGetStageResponse::getDeploymentId() const {
    return m_deployment_id;
}
void OAIGetStageResponse::setDeploymentId(const QString &deployment_id) {
    m_deployment_id = deployment_id;
    m_deployment_id_isSet = true;
}

bool OAIGetStageResponse::is_deployment_id_Set() const{
    return m_deployment_id_isSet;
}

bool OAIGetStageResponse::is_deployment_id_Valid() const{
    return m_deployment_id_isValid;
}

QString OAIGetStageResponse::getDescription() const {
    return m_description;
}
void OAIGetStageResponse::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIGetStageResponse::is_description_Set() const{
    return m_description_isSet;
}

bool OAIGetStageResponse::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIGetStageResponse::getLastDeploymentStatusMessage() const {
    return m_last_deployment_status_message;
}
void OAIGetStageResponse::setLastDeploymentStatusMessage(const QString &last_deployment_status_message) {
    m_last_deployment_status_message = last_deployment_status_message;
    m_last_deployment_status_message_isSet = true;
}

bool OAIGetStageResponse::is_last_deployment_status_message_Set() const{
    return m_last_deployment_status_message_isSet;
}

bool OAIGetStageResponse::is_last_deployment_status_message_Valid() const{
    return m_last_deployment_status_message_isValid;
}

QDateTime OAIGetStageResponse::getLastUpdatedDate() const {
    return m_last_updated_date;
}
void OAIGetStageResponse::setLastUpdatedDate(const QDateTime &last_updated_date) {
    m_last_updated_date = last_updated_date;
    m_last_updated_date_isSet = true;
}

bool OAIGetStageResponse::is_last_updated_date_Set() const{
    return m_last_updated_date_isSet;
}

bool OAIGetStageResponse::is_last_updated_date_Valid() const{
    return m_last_updated_date_isValid;
}

QMap OAIGetStageResponse::getRouteSettings() const {
    return m_route_settings;
}
void OAIGetStageResponse::setRouteSettings(const QMap &route_settings) {
    m_route_settings = route_settings;
    m_route_settings_isSet = true;
}

bool OAIGetStageResponse::is_route_settings_Set() const{
    return m_route_settings_isSet;
}

bool OAIGetStageResponse::is_route_settings_Valid() const{
    return m_route_settings_isValid;
}

QString OAIGetStageResponse::getStageName() const {
    return m_stage_name;
}
void OAIGetStageResponse::setStageName(const QString &stage_name) {
    m_stage_name = stage_name;
    m_stage_name_isSet = true;
}

bool OAIGetStageResponse::is_stage_name_Set() const{
    return m_stage_name_isSet;
}

bool OAIGetStageResponse::is_stage_name_Valid() const{
    return m_stage_name_isValid;
}

QMap OAIGetStageResponse::getStageVariables() const {
    return m_stage_variables;
}
void OAIGetStageResponse::setStageVariables(const QMap &stage_variables) {
    m_stage_variables = stage_variables;
    m_stage_variables_isSet = true;
}

bool OAIGetStageResponse::is_stage_variables_Set() const{
    return m_stage_variables_isSet;
}

bool OAIGetStageResponse::is_stage_variables_Valid() const{
    return m_stage_variables_isValid;
}

QMap OAIGetStageResponse::getTags() const {
    return m_tags;
}
void OAIGetStageResponse::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIGetStageResponse::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIGetStageResponse::is_tags_Valid() const{
