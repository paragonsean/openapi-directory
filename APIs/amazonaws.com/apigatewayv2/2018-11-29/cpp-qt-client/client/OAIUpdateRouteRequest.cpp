...
bool OAIUpdateRouteRequest::getApiKeyRequired() const {
    return m_api_key_required;
}
void OAIUpdateRouteRequest::setApiKeyRequired(const bool &api_key_required) {
    m_api_key_required = api_key_required;
    m_api_key_required_isSet = true;
}

bool OAIUpdateRouteRequest::is_api_key_required_Set() const{
    return m_api_key_required_isSet;
}

bool OAIUpdateRouteRequest::is_api_key_required_Valid() const{
    return m_api_key_required_isValid;
}

QList OAIUpdateRouteRequest::getAuthorizationScopes() const {
    return m_authorization_scopes;
}
void OAIUpdateRouteRequest::setAuthorizationScopes(const QList &authorization_scopes) {
    m_authorization_scopes = authorization_scopes;
    m_authorization_scopes_isSet = true;
}

bool OAIUpdateRouteRequest::is_authorization_scopes_Set() const{
    return m_authorization_scopes_isSet;
}

bool OAIUpdateRouteRequest::is_authorization_scopes_Valid() const{
    return m_authorization_scopes_isValid;
}

OAIAuthorizationType OAIUpdateRouteRequest::getAuthorizationType() const {
    return m_authorization_type;
}
void OAIUpdateRouteRequest::setAuthorizationType(const OAIAuthorizationType &authorization_type) {
    m_authorization_type = authorization_type;
    m_authorization_type_isSet = true;
}

bool OAIUpdateRouteRequest::is_authorization_type_Set() const{
    return m_authorization_type_isSet;
}

bool OAIUpdateRouteRequest::is_authorization_type_Valid() const{
    return m_authorization_type_isValid;
}

QString OAIUpdateRouteRequest::getAuthorizerId() const {
    return m_authorizer_id;
}
void OAIUpdateRouteRequest::setAuthorizerId(const QString &authorizer_id) {
    m_authorizer_id = authorizer_id;
    m_authorizer_id_isSet = true;
}

bool OAIUpdateRouteRequest::is_authorizer_id_Set() const{
    return m_authorizer_id_isSet;
}

bool OAIUpdateRouteRequest::is_authorizer_id_Valid() const{
    return m_authorizer_id_isValid;
}

QString OAIUpdateRouteRequest::getModelSelectionExpression() const {
    return m_model_selection_expression;
}
void OAIUpdateRouteRequest::setModelSelectionExpression(const QString &model_selection_expression) {
    m_model_selection_expression = model_selection_expression;
    m_model_selection_expression_isSet = true;
}

bool OAIUpdateRouteRequest::is_model_selection_expression_Set() const{
    return m_model_selection_expression_isSet;
}

bool OAIUpdateRouteRequest::is_model_selection_expression_Valid() const{
    return m_model_selection_expression_isValid;
}

QString OAIUpdateRouteRequest::getOperationName() const {
    return m_operation_name;
}
void OAIUpdateRouteRequest::setOperationName(const QString &operation_name) {
    m_operation_name = operation_name;
    m_operation_name_isSet = true;
}

bool OAIUpdateRouteRequest::is_operation_name_Set() const{
    return m_operation_name_isSet;
}

bool OAIUpdateRouteRequest::is_operation_name_Valid() const{
    return m_operation_name_isValid;
}

QMap OAIUpdateRouteRequest::getRequestModels() const {
    return m_request_models;
}
void OAIUpdateRouteRequest::setRequestModels(const QMap &request_models) {
    m_request_models = request_models;
    m_request_models_isSet = true;
}

bool OAIUpdateRouteRequest::is_request_models_Set() const{
    return m_request_models_isSet;
}

bool OAIUpdateRouteRequest::is_request_models_Valid() const{
    return m_request_models_isValid;
}

QMap OAIUpdateRouteRequest::getRequestParameters() const {
    return m_request_parameters;
}
void OAIUpdateRouteRequest::setRequestParameters(const QMap &request_parameters) {
    m_request_parameters = request_parameters;
    m_request_parameters_isSet = true;
}

bool OAIUpdateRouteRequest::is_request_parameters_Set() const{
    return m_request_parameters_isSet;
}

bool OAIUpdateRouteRequest::is_request_parameters_Valid() const{
    return m_request_parameters_isValid;
}

QString OAIUpdateRouteRequest::getRouteKey() const {
    return m_route_key;
}
void OAIUpdateRouteRequest::setRouteKey(const QString &route_key) {
    m_route_key = route_key;
    m_route_key_isSet = true;
}

bool OAIUpdateRouteRequest::is_route_key_Set() const{
    return m_route_key_isSet;
}

bool OAIUpdateRouteRequest::is_route_key_Valid() const{
    return m_route_key_isValid;
}

QString OAIUpdateRouteRequest::getRouteResponseSelectionExpression() const {
    return m_route_response_selection_expression;
}
void OAIUpdateRouteRequest::setRouteResponseSelectionExpression(const QString &route_response_selection_expression) {
...
bool OAIUpdateRouteRequest::is_route_response_selection_expression_Set() const{
    return m_route_response_selection_expression_isSet;
}

bool OAIUpdateRouteRequest::is_route_response_selection_expression_Valid() const{
    return m_route_response_selection_expression_isValid;
}

QString OAIUpdateRouteRequest::getTarget() const {
    return m_target;
}
void OAIUpdateRouteRequest::setTarget(const QString &target) {
    m_target = target;
    m_target_isSet = true;
}

bool OAIUpdateRouteRequest::is_target_Set() const{
    return m_target_isSet;
}

bool OAIUpdateRouteRequest::is_target_Valid() const{
