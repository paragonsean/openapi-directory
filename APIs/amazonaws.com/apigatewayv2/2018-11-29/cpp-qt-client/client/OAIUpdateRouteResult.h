...
/*
 * OAIUpdateRouteResult.h
 *
 * 
 */

#ifndef OAIUpdateRouteResult_H
#define OAIUpdateRouteResult_H
...
class OAIUpdateRouteResult : public OAIObject {
public:
    OAIUpdateRouteResult();
    OAIUpdateRouteResult(QString json);
    ~OAIUpdateRouteResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateRouteResult)

#endif // OAIUpdateRouteResult_H
