...
/*
 * OAIUpdateRouteRequest.h
 *
 * Updates a Route.
 */

#ifndef OAIUpdateRouteRequest_H
#define OAIUpdateRouteRequest_H
...
class OAIUpdateRouteRequest : public OAIObject {
public:
    OAIUpdateRouteRequest();
    OAIUpdateRouteRequest(QString json);
    ~OAIUpdateRouteRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateRouteRequest)

#endif // OAIUpdateRouteRequest_H
