...
bool OAIRoute::getApiGatewayManaged() const {
    return m_api_gateway_managed;
}
void OAIRoute::setApiGatewayManaged(const bool &api_gateway_managed) {
    m_api_gateway_managed = api_gateway_managed;
    m_api_gateway_managed_isSet = true;
}

bool OAIRoute::is_api_gateway_managed_Set() const{
    return m_api_gateway_managed_isSet;
}

bool OAIRoute::is_api_gateway_managed_Valid() const{
    return m_api_gateway_managed_isValid;
}

bool OAIRoute::getApiKeyRequired() const {
    return m_api_key_required;
}
void OAIRoute::setApiKeyRequired(const bool &api_key_required) {
    m_api_key_required = api_key_required;
    m_api_key_required_isSet = true;
}

bool OAIRoute::is_api_key_required_Set() const{
    return m_api_key_required_isSet;
}

bool OAIRoute::is_api_key_required_Valid() const{
    return m_api_key_required_isValid;
}

QList OAIRoute::getAuthorizationScopes() const {
    return m_authorization_scopes;
}
void OAIRoute::setAuthorizationScopes(const QList &authorization_scopes) {
    m_authorization_scopes = authorization_scopes;
    m_authorization_scopes_isSet = true;
}

bool OAIRoute::is_authorization_scopes_Set() const{
    return m_authorization_scopes_isSet;
}

bool OAIRoute::is_authorization_scopes_Valid() const{
    return m_authorization_scopes_isValid;
}

OAIAuthorizationType OAIRoute::getAuthorizationType() const {
    return m_authorization_type;
}
void OAIRoute::setAuthorizationType(const OAIAuthorizationType &authorization_type) {
    m_authorization_type = authorization_type;
    m_authorization_type_isSet = true;
}

bool OAIRoute::is_authorization_type_Set() const{
    return m_authorization_type_isSet;
}

bool OAIRoute::is_authorization_type_Valid() const{
    return m_authorization_type_isValid;
}

QString OAIRoute::getAuthorizerId() const {
    return m_authorizer_id;
}
void OAIRoute::setAuthorizerId(const QString &authorizer_id) {
    m_authorizer_id = authorizer_id;
    m_authorizer_id_isSet = true;
}

bool OAIRoute::is_authorizer_id_Set() const{
    return m_authorizer_id_isSet;
}

bool OAIRoute::is_authorizer_id_Valid() const{
    return m_authorizer_id_isValid;
}

QString OAIRoute::getModelSelectionExpression() const {
    return m_model_selection_expression;
}
void OAIRoute::setModelSelectionExpression(const QString &model_selection_expression) {
    m_model_selection_expression = model_selection_expression;
    m_model_selection_expression_isSet = true;
}

bool OAIRoute::is_model_selection_expression_Set() const{
    return m_model_selection_expression_isSet;
}

bool OAIRoute::is_model_selection_expression_Valid() const{
    return m_model_selection_expression_isValid;
}

QString OAIRoute::getOperationName() const {
    return m_operation_name;
}
void OAIRoute::setOperationName(const QString &operation_name) {
    m_operation_name = operation_name;
    m_operation_name_isSet = true;
}

bool OAIRoute::is_operation_name_Set() const{
    return m_operation_name_isSet;
}

bool OAIRoute::is_operation_name_Valid() const{
    return m_operation_name_isValid;
}

QMap OAIRoute::getRequestModels() const {
    return m_request_models;
}
void OAIRoute::setRequestModels(const QMap &request_models) {
    m_request_models = request_models;
    m_request_models_isSet = true;
}

bool OAIRoute::is_request_models_Set() const{
    return m_request_models_isSet;
}

bool OAIRoute::is_request_models_Valid() const{
    return m_request_models_isValid;
}

QMap OAIRoute::getRequestParameters() const {
    return m_request_parameters;
}
void OAIRoute::setRequestParameters(const QMap &request_parameters) {
    m_request_parameters = request_parameters;
    m_request_parameters_isSet = true;
}

bool OAIRoute::is_request_parameters_Set() const{
    return m_request_parameters_isSet;
}

bool OAIRoute::is_request_parameters_Valid() const{
    return m_request_parameters_isValid;
}

QString OAIRoute::getRouteId() const {
    return m_route_id;
}
void OAIRoute::setRouteId(const QString &route_id) {
    m_route_id = route_id;
    m_route_id_isSet = true;
}

bool OAIRoute::is_route_id_Set() const{
    return m_route_id_isSet;
}

bool OAIRoute::is_route_id_Valid() const{
...
QString OAIRoute::getRouteResponseSelectionExpression() const {
    return m_route_response_selection_expression;
}
void OAIRoute::setRouteResponseSelectionExpression(const QString &route_response_selection_expression) {
...
bool OAIRoute::is_route_response_selection_expression_Set() const{
    return m_route_response_selection_expression_isSet;
}

bool OAIRoute::is_route_response_selection_expression_Valid() const{
    return m_route_response_selection_expression_isValid;
}

QString OAIRoute::getTarget() const {
    return m_target;
}
void OAIRoute::setTarget(const QString &target) {
    m_target = target;
    m_target_isSet = true;
}

bool OAIRoute::is_target_Set() const{
    return m_target_isSet;
}

bool OAIRoute::is_target_Valid() const{
