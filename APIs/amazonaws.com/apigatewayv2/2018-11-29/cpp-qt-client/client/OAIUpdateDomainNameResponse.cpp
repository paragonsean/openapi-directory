...
OAIUpdateDomainNameResponse::OAIUpdateDomainNameResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateDomainNameResponse::OAIUpdateDomainNameResponse() {
    this->initializeModel();
}

OAIUpdateDomainNameResponse::~OAIUpdateDomainNameResponse() {}

void OAIUpdateDomainNameResponse::initializeModel() {
...
void OAIUpdateDomainNameResponse::fromJson(QString jsonString) {
...
void OAIUpdateDomainNameResponse::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateDomainNameResponse::asJson() const {
...
QJsonObject OAIUpdateDomainNameResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateDomainNameResponse::getApiMappingSelectionExpression() const {
    return m_api_mapping_selection_expression;
}
void OAIUpdateDomainNameResponse::setApiMappingSelectionExpression(const QString &api_mapping_selection_expression) {
    m_api_mapping_selection_expression = api_mapping_selection_expression;
    m_api_mapping_selection_expression_isSet = true;
}

bool OAIUpdateDomainNameResponse::is_api_mapping_selection_expression_Set() const{
    return m_api_mapping_selection_expression_isSet;
}

bool OAIUpdateDomainNameResponse::is_api_mapping_selection_expression_Valid() const{
    return m_api_mapping_selection_expression_isValid;
}

QString OAIUpdateDomainNameResponse::getDomainName() const {
    return m_domain_name;
}
void OAIUpdateDomainNameResponse::setDomainName(const QString &domain_name) {
    m_domain_name = domain_name;
    m_domain_name_isSet = true;
}

bool OAIUpdateDomainNameResponse::is_domain_name_Set() const{
    return m_domain_name_isSet;
}

bool OAIUpdateDomainNameResponse::is_domain_name_Valid() const{
    return m_domain_name_isValid;
}

QList OAIUpdateDomainNameResponse::getDomainNameConfigurations() const {
    return m_domain_name_configurations;
}
void OAIUpdateDomainNameResponse::setDomainNameConfigurations(const QList &domain_name_configurations) {
    m_domain_name_configurations = domain_name_configurations;
    m_domain_name_configurations_isSet = true;
}

bool OAIUpdateDomainNameResponse::is_domain_name_configurations_Set() const{
    return m_domain_name_configurations_isSet;
}

bool OAIUpdateDomainNameResponse::is_domain_name_configurations_Valid() const{
    return m_domain_name_configurations_isValid;
}

OAICreateDomainNameResponse_MutualTlsAuthentication OAIUpdateDomainNameResponse::getMutualTlsAuthentication() const {
    return m_mutual_tls_authentication;
}
void OAIUpdateDomainNameResponse::setMutualTlsAuthentication(const OAICreateDomainNameResponse_MutualTlsAuthentication &mutual_tls_authentication) {
    m_mutual_tls_authentication = mutual_tls_authentication;
    m_mutual_tls_authentication_isSet = true;
}

bool OAIUpdateDomainNameResponse::is_mutual_tls_authentication_Set() const{
    return m_mutual_tls_authentication_isSet;
}

bool OAIUpdateDomainNameResponse::is_mutual_tls_authentication_Valid() const{
    return m_mutual_tls_authentication_isValid;
}

QMap OAIUpdateDomainNameResponse::getTags() const {
    return m_tags;
}
void OAIUpdateDomainNameResponse::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIUpdateDomainNameResponse::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIUpdateDomainNameResponse::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAIUpdateDomainNameResponse::isSet() const {
...
bool OAIUpdateDomainNameResponse::isValid() const {
