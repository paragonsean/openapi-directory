...
/*
 * OAICreateApiRequest_CorsConfiguration.h
 *
 * 
 */

#ifndef OAICreateApiRequest_CorsConfiguration_H
#define OAICreateApiRequest_CorsConfiguration_H
...
class OAICreateApiRequest_CorsConfiguration : public OAIObject {
public:
    OAICreateApiRequest_CorsConfiguration();
    OAICreateApiRequest_CorsConfiguration(QString json);
    ~OAICreateApiRequest_CorsConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateApiRequest_CorsConfiguration)

#endif // OAICreateApiRequest_CorsConfiguration_H
