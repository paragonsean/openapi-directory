...
#ifndef OAIRouteSettings_H
#define OAIRouteSettings_H
...
class OAIRouteSettings : public OAIObject {
public:
    OAIRouteSettings();
    OAIRouteSettings(QString json);
    ~OAIRouteSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRouteSettings)

#endif // OAIRouteSettings_H
