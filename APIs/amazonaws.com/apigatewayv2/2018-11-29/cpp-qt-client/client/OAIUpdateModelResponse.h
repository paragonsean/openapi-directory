...
/*
 * OAIUpdateModelResponse.h
 *
 * 
 */

#ifndef OAIUpdateModelResponse_H
#define OAIUpdateModelResponse_H
...
class OAIUpdateModelResponse : public OAIObject {
public:
    OAIUpdateModelResponse();
    OAIUpdateModelResponse(QString json);
    ~OAIUpdateModelResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateModelResponse)

#endif // OAIUpdateModelResponse_H
