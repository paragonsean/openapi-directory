...
QList OAICreateDomainNameRequest::getDomainNameConfigurations() const {
    return m_domain_name_configurations;
}
void OAICreateDomainNameRequest::setDomainNameConfigurations(const QList &domain_name_configurations) {
    m_domain_name_configurations = domain_name_configurations;
    m_domain_name_configurations_isSet = true;
}

bool OAICreateDomainNameRequest::is_domain_name_configurations_Set() const{
    return m_domain_name_configurations_isSet;
}

bool OAICreateDomainNameRequest::is_domain_name_configurations_Valid() const{
    return m_domain_name_configurations_isValid;
}

OAICreateDomainNameRequest_MutualTlsAuthentication OAICreateDomainNameRequest::getMutualTlsAuthentication() const {
    return m_mutual_tls_authentication;
}
void OAICreateDomainNameRequest::setMutualTlsAuthentication(const OAICreateDomainNameRequest_MutualTlsAuthentication &mutual_tls_authentication) {
