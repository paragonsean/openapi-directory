...
/*
 * OAICreateDomainNameResponse_MutualTlsAuthentication.h
 *
 * 
 */

#ifndef OAICreateDomainNameResponse_MutualTlsAuthentication_H
#define OAICreateDomainNameResponse_MutualTlsAuthentication_H
...
class OAICreateDomainNameResponse_MutualTlsAuthentication : public OAIObject {
public:
    OAICreateDomainNameResponse_MutualTlsAuthentication();
    OAICreateDomainNameResponse_MutualTlsAuthentication(QString json);
    ~OAICreateDomainNameResponse_MutualTlsAuthentication() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateDomainNameResponse_MutualTlsAuthentication)

#endif // OAICreateDomainNameResponse_MutualTlsAuthentication_H
