...
/*
 * OAIUpdateApi_request.h
 *
 * 
 */

#ifndef OAIUpdateApi_request_H
#define OAIUpdateApi_request_H
...
class OAIUpdateApi_request : public OAIObject {
public:
    OAIUpdateApi_request();
    OAIUpdateApi_request(QString json);
    ~OAIUpdateApi_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateApi_request)

#endif // OAIUpdateApi_request_H
