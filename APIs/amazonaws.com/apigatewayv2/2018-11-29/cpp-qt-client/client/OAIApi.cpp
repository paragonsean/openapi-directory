...
QString OAIApi::getApiEndpoint() const {
    return m_api_endpoint;
}
void OAIApi::setApiEndpoint(const QString &api_endpoint) {
    m_api_endpoint = api_endpoint;
    m_api_endpoint_isSet = true;
}

bool OAIApi::is_api_endpoint_Set() const{
    return m_api_endpoint_isSet;
}

bool OAIApi::is_api_endpoint_Valid() const{
    return m_api_endpoint_isValid;
}

bool OAIApi::getApiGatewayManaged() const {
    return m_api_gateway_managed;
}
void OAIApi::setApiGatewayManaged(const bool &api_gateway_managed) {
    m_api_gateway_managed = api_gateway_managed;
    m_api_gateway_managed_isSet = true;
}

bool OAIApi::is_api_gateway_managed_Set() const{
    return m_api_gateway_managed_isSet;
}

bool OAIApi::is_api_gateway_managed_Valid() const{
    return m_api_gateway_managed_isValid;
}

QString OAIApi::getApiId() const {
    return m_api_id;
}
void OAIApi::setApiId(const QString &api_id) {
    m_api_id = api_id;
    m_api_id_isSet = true;
}

bool OAIApi::is_api_id_Set() const{
    return m_api_id_isSet;
}

bool OAIApi::is_api_id_Valid() const{
    return m_api_id_isValid;
}

QString OAIApi::getApiKeySelectionExpression() const {
    return m_api_key_selection_expression;
}
void OAIApi::setApiKeySelectionExpression(const QString &api_key_selection_expression) {
    m_api_key_selection_expression = api_key_selection_expression;
    m_api_key_selection_expression_isSet = true;
}

bool OAIApi::is_api_key_selection_expression_Set() const{
    return m_api_key_selection_expression_isSet;
}

bool OAIApi::is_api_key_selection_expression_Valid() const{
    return m_api_key_selection_expression_isValid;
}

OAICreateApiResponse_CorsConfiguration OAIApi::getCorsConfiguration() const {
    return m_cors_configuration;
}
void OAIApi::setCorsConfiguration(const OAICreateApiResponse_CorsConfiguration &cors_configuration) {
    m_cors_configuration = cors_configuration;
    m_cors_configuration_isSet = true;
}

bool OAIApi::is_cors_configuration_Set() const{
    return m_cors_configuration_isSet;
}

bool OAIApi::is_cors_configuration_Valid() const{
    return m_cors_configuration_isValid;
}

QDateTime OAIApi::getCreatedDate() const {
    return m_created_date;
}
void OAIApi::setCreatedDate(const QDateTime &created_date) {
    m_created_date = created_date;
    m_created_date_isSet = true;
}

bool OAIApi::is_created_date_Set() const{
    return m_created_date_isSet;
}

bool OAIApi::is_created_date_Valid() const{
...
bool OAIApi::getDisableSchemaValidation() const {
    return m_disable_schema_validation;
}
void OAIApi::setDisableSchemaValidation(const bool &disable_schema_validation) {
    m_disable_schema_validation = disable_schema_validation;
    m_disable_schema_validation_isSet = true;
}

bool OAIApi::is_disable_schema_validation_Set() const{
    return m_disable_schema_validation_isSet;
}

bool OAIApi::is_disable_schema_validation_Valid() const{
    return m_disable_schema_validation_isValid;
}

bool OAIApi::getDisableExecuteApiEndpoint() const {
    return m_disable_execute_api_endpoint;
}
void OAIApi::setDisableExecuteApiEndpoint(const bool &disable_execute_api_endpoint) {
    m_disable_execute_api_endpoint = disable_execute_api_endpoint;
    m_disable_execute_api_endpoint_isSet = true;
}

bool OAIApi::is_disable_execute_api_endpoint_Set() const{
    return m_disable_execute_api_endpoint_isSet;
}

bool OAIApi::is_disable_execute_api_endpoint_Valid() const{
    return m_disable_execute_api_endpoint_isValid;
}

QList OAIApi::getImportInfo() const {
    return m_import_info;
}
void OAIApi::setImportInfo(const QList &import_info) {
    m_import_info = import_info;
    m_import_info_isSet = true;
}

bool OAIApi::is_import_info_Set() const{
    return m_import_info_isSet;
}

bool OAIApi::is_import_info_Valid() const{
...
OAIProtocolType OAIApi::getProtocolType() const {
    return m_protocol_type;
}
void OAIApi::setProtocolType(const OAIProtocolType &protocol_type) {
    m_protocol_type = protocol_type;
    m_protocol_type_isSet = true;
}

bool OAIApi::is_protocol_type_Set() const{
    return m_protocol_type_isSet;
}

bool OAIApi::is_protocol_type_Valid() const{
    return m_protocol_type_isValid;
}

QString OAIApi::getRouteSelectionExpression() const {
    return m_route_selection_expression;
}
void OAIApi::setRouteSelectionExpression(const QString &route_selection_expression) {
    m_route_selection_expression = route_selection_expression;
    m_route_selection_expression_isSet = true;
}

bool OAIApi::is_route_selection_expression_Set() const{
    return m_route_selection_expression_isSet;
}

bool OAIApi::is_route_selection_expression_Valid() const{
    return m_route_selection_expression_isValid;
}

QMap OAIApi::getTags() const {
    return m_tags;
}
void OAIApi::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIApi::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIApi::is_tags_Valid() const{
...
QList OAIApi::getWarnings() const {
    return m_warnings;
}
void OAIApi::setWarnings(const QList &warnings) {
    m_warnings = warnings;
    m_warnings_isSet = true;
}

bool OAIApi::is_warnings_Set() const{
    return m_warnings_isSet;
}

bool OAIApi::is_warnings_Valid() const{
...
bool OAIApi::isValid() const {
    ...
    return m_name_isValid && m_protocol_type_isValid && m_route_selection_expression_isValid && true;
}
