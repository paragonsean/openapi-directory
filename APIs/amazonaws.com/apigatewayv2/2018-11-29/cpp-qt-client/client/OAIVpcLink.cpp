...
QDateTime OAIVpcLink::getCreatedDate() const {
    return m_created_date;
}
void OAIVpcLink::setCreatedDate(const QDateTime &created_date) {
    m_created_date = created_date;
    m_created_date_isSet = true;
}

bool OAIVpcLink::is_created_date_Set() const{
    return m_created_date_isSet;
}

bool OAIVpcLink::is_created_date_Valid() const{
...
QList OAIVpcLink::getSecurityGroupIds() const {
    return m_security_group_ids;
}
void OAIVpcLink::setSecurityGroupIds(const QList &security_group_ids) {
    m_security_group_ids = security_group_ids;
    m_security_group_ids_isSet = true;
}

bool OAIVpcLink::is_security_group_ids_Set() const{
    return m_security_group_ids_isSet;
}

bool OAIVpcLink::is_security_group_ids_Valid() const{
    return m_security_group_ids_isValid;
}

QList OAIVpcLink::getSubnetIds() const {
    return m_subnet_ids;
}
void OAIVpcLink::setSubnetIds(const QList &subnet_ids) {
    m_subnet_ids = subnet_ids;
    m_subnet_ids_isSet = true;
}

bool OAIVpcLink::is_subnet_ids_Set() const{
    return m_subnet_ids_isSet;
}

bool OAIVpcLink::is_subnet_ids_Valid() const{
...
QString OAIVpcLink::getVpcLinkId() const {
    return m_vpc_link_id;
}
void OAIVpcLink::setVpcLinkId(const QString &vpc_link_id) {
    m_vpc_link_id = vpc_link_id;
    m_vpc_link_id_isSet = true;
}

bool OAIVpcLink::is_vpc_link_id_Set() const{
    return m_vpc_link_id_isSet;
}

bool OAIVpcLink::is_vpc_link_id_Valid() const{
    return m_vpc_link_id_isValid;
}

OAIVpcLinkStatus OAIVpcLink::getVpcLinkStatus() const {
    return m_vpc_link_status;
}
void OAIVpcLink::setVpcLinkStatus(const OAIVpcLinkStatus &vpc_link_status) {
    m_vpc_link_status = vpc_link_status;
    m_vpc_link_status_isSet = true;
}

bool OAIVpcLink::is_vpc_link_status_Set() const{
    return m_vpc_link_status_isSet;
}

bool OAIVpcLink::is_vpc_link_status_Valid() const{
    return m_vpc_link_status_isValid;
}

QString OAIVpcLink::getVpcLinkStatusMessage() const {
    return m_vpc_link_status_message;
}
void OAIVpcLink::setVpcLinkStatusMessage(const QString &vpc_link_status_message) {
    m_vpc_link_status_message = vpc_link_status_message;
    m_vpc_link_status_message_isSet = true;
}

bool OAIVpcLink::is_vpc_link_status_message_Set() const{
    return m_vpc_link_status_message_isSet;
}

bool OAIVpcLink::is_vpc_link_status_message_Valid() const{
    return m_vpc_link_status_message_isValid;
}

OAIVpcLinkVersion OAIVpcLink::getVpcLinkVersion() const {
    return m_vpc_link_version;
}
void OAIVpcLink::setVpcLinkVersion(const OAIVpcLinkVersion &vpc_link_version) {
    m_vpc_link_version = vpc_link_version;
    m_vpc_link_version_isSet = true;
}

bool OAIVpcLink::is_vpc_link_version_Set() const{
    return m_vpc_link_version_isSet;
}

bool OAIVpcLink::is_vpc_link_version_Valid() const{
...
bool OAIVpcLink::isValid() const {
    ...
    return m_name_isValid && m_security_group_ids_isValid && m_subnet_ids_isValid && m_vpc_link_id_isValid && true;
}
