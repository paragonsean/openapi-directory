...
/*
 * OAICreateIntegrationResponseRequest.h
 *
 * Creates a new IntegrationResponse resource to represent an integration response.
 */

#ifndef OAICreateIntegrationResponseRequest_H
#define OAICreateIntegrationResponseRequest_H
...
class OAICreateIntegrationResponseRequest : public OAIObject {
public:
    OAICreateIntegrationResponseRequest();
    OAICreateIntegrationResponseRequest(QString json);
    ~OAICreateIntegrationResponseRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateIntegrationResponseRequest)

#endif // OAICreateIntegrationResponseRequest_H
