...
/*
 * OAICreateApiResponse_CorsConfiguration.h
 *
 * 
 */

#ifndef OAICreateApiResponse_CorsConfiguration_H
#define OAICreateApiResponse_CorsConfiguration_H
...
class OAICreateApiResponse_CorsConfiguration : public OAIObject {
public:
    OAICreateApiResponse_CorsConfiguration();
    OAICreateApiResponse_CorsConfiguration(QString json);
    ~OAICreateApiResponse_CorsConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateApiResponse_CorsConfiguration)

#endif // OAICreateApiResponse_CorsConfiguration_H
