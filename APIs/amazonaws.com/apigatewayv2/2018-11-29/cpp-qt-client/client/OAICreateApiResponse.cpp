...
OAICreateApiResponse::OAICreateApiResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateApiResponse::OAICreateApiResponse() {
    this->initializeModel();
}

OAICreateApiResponse::~OAICreateApiResponse() {}

void OAICreateApiResponse::initializeModel() {
...
void OAICreateApiResponse::fromJson(QString jsonString) {
...
void OAICreateApiResponse::fromJsonObject(QJsonObject json) {
...
QString OAICreateApiResponse::asJson() const {
...
QJsonObject OAICreateApiResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateApiResponse::getApiEndpoint() const {
    return m_api_endpoint;
}
void OAICreateApiResponse::setApiEndpoint(const QString &api_endpoint) {
    m_api_endpoint = api_endpoint;
    m_api_endpoint_isSet = true;
}

bool OAICreateApiResponse::is_api_endpoint_Set() const{
    return m_api_endpoint_isSet;
}

bool OAICreateApiResponse::is_api_endpoint_Valid() const{
    return m_api_endpoint_isValid;
}

bool OAICreateApiResponse::getApiGatewayManaged() const {
    return m_api_gateway_managed;
}
void OAICreateApiResponse::setApiGatewayManaged(const bool &api_gateway_managed) {
    m_api_gateway_managed = api_gateway_managed;
    m_api_gateway_managed_isSet = true;
}

bool OAICreateApiResponse::is_api_gateway_managed_Set() const{
    return m_api_gateway_managed_isSet;
}

bool OAICreateApiResponse::is_api_gateway_managed_Valid() const{
    return m_api_gateway_managed_isValid;
}

QString OAICreateApiResponse::getApiId() const {
    return m_api_id;
}
void OAICreateApiResponse::setApiId(const QString &api_id) {
    m_api_id = api_id;
    m_api_id_isSet = true;
}

bool OAICreateApiResponse::is_api_id_Set() const{
    return m_api_id_isSet;
}

bool OAICreateApiResponse::is_api_id_Valid() const{
    return m_api_id_isValid;
}

QString OAICreateApiResponse::getApiKeySelectionExpression() const {
    return m_api_key_selection_expression;
}
void OAICreateApiResponse::setApiKeySelectionExpression(const QString &api_key_selection_expression) {
    m_api_key_selection_expression = api_key_selection_expression;
    m_api_key_selection_expression_isSet = true;
}

bool OAICreateApiResponse::is_api_key_selection_expression_Set() const{
    return m_api_key_selection_expression_isSet;
}

bool OAICreateApiResponse::is_api_key_selection_expression_Valid() const{
    return m_api_key_selection_expression_isValid;
}

OAICreateApiResponse_CorsConfiguration OAICreateApiResponse::getCorsConfiguration() const {
    return m_cors_configuration;
}
void OAICreateApiResponse::setCorsConfiguration(const OAICreateApiResponse_CorsConfiguration &cors_configuration) {
    m_cors_configuration = cors_configuration;
    m_cors_configuration_isSet = true;
}

bool OAICreateApiResponse::is_cors_configuration_Set() const{
    return m_cors_configuration_isSet;
}

bool OAICreateApiResponse::is_cors_configuration_Valid() const{
    return m_cors_configuration_isValid;
}

QDateTime OAICreateApiResponse::getCreatedDate() const {
    return m_created_date;
}
void OAICreateApiResponse::setCreatedDate(const QDateTime &created_date) {
    m_created_date = created_date;
    m_created_date_isSet = true;
}

bool OAICreateApiResponse::is_created_date_Set() const{
    return m_created_date_isSet;
}

bool OAICreateApiResponse::is_created_date_Valid() const{
    return m_created_date_isValid;
}

QString OAICreateApiResponse::getDescription() const {
    return m_description;
}
void OAICreateApiResponse::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAICreateApiResponse::is_description_Set() const{
    return m_description_isSet;
}

bool OAICreateApiResponse::is_description_Valid() const{
    return m_description_isValid;
}

bool OAICreateApiResponse::getDisableSchemaValidation() const {
    return m_disable_schema_validation;
}
void OAICreateApiResponse::setDisableSchemaValidation(const bool &disable_schema_validation) {
    m_disable_schema_validation = disable_schema_validation;
    m_disable_schema_validation_isSet = true;
}

bool OAICreateApiResponse::is_disable_schema_validation_Set() const{
    return m_disable_schema_validation_isSet;
}

bool OAICreateApiResponse::is_disable_schema_validation_Valid() const{
    return m_disable_schema_validation_isValid;
}

bool OAICreateApiResponse::getDisableExecuteApiEndpoint() const {
    return m_disable_execute_api_endpoint;
}
void OAICreateApiResponse::setDisableExecuteApiEndpoint(const bool &disable_execute_api_endpoint) {
    m_disable_execute_api_endpoint = disable_execute_api_endpoint;
    m_disable_execute_api_endpoint_isSet = true;
}

bool OAICreateApiResponse::is_disable_execute_api_endpoint_Set() const{
    return m_disable_execute_api_endpoint_isSet;
}

bool OAICreateApiResponse::is_disable_execute_api_endpoint_Valid() const{
    return m_disable_execute_api_endpoint_isValid;
}

QList OAICreateApiResponse::getImportInfo() const {
    return m_import_info;
}
void OAICreateApiResponse::setImportInfo(const QList &import_info) {
    m_import_info = import_info;
    m_import_info_isSet = true;
}

bool OAICreateApiResponse::is_import_info_Set() const{
    return m_import_info_isSet;
}

bool OAICreateApiResponse::is_import_info_Valid() const{
    return m_import_info_isValid;
}

QString OAICreateApiResponse::getName() const {
    return m_name;
}
void OAICreateApiResponse::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICreateApiResponse::is_name_Set() const{
    return m_name_isSet;
}

bool OAICreateApiResponse::is_name_Valid() const{
    return m_name_isValid;
}

OAIProtocolType OAICreateApiResponse::getProtocolType() const {
    return m_protocol_type;
}
void OAICreateApiResponse::setProtocolType(const OAIProtocolType &protocol_type) {
    m_protocol_type = protocol_type;
    m_protocol_type_isSet = true;
}

bool OAICreateApiResponse::is_protocol_type_Set() const{
    return m_protocol_type_isSet;
}

bool OAICreateApiResponse::is_protocol_type_Valid() const{
    return m_protocol_type_isValid;
}

QString OAICreateApiResponse::getRouteSelectionExpression() const {
    return m_route_selection_expression;
}
void OAICreateApiResponse::setRouteSelectionExpression(const QString &route_selection_expression) {
    m_route_selection_expression = route_selection_expression;
    m_route_selection_expression_isSet = true;
}

bool OAICreateApiResponse::is_route_selection_expression_Set() const{
    return m_route_selection_expression_isSet;
}

bool OAICreateApiResponse::is_route_selection_expression_Valid() const{
    return m_route_selection_expression_isValid;
}

QMap OAICreateApiResponse::getTags() const {
    return m_tags;
}
void OAICreateApiResponse::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAICreateApiResponse::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAICreateApiResponse::is_tags_Valid() const{
    return m_tags_isValid;
}

QString OAICreateApiResponse::getVersion() const {
    return m_version;
}
void OAICreateApiResponse::setVersion(const QString &version) {
    m_version = version;
    m_version_isSet = true;
}

bool OAICreateApiResponse::is_version_Set() const{
    return m_version_isSet;
}

bool OAICreateApiResponse::is_version_Valid() const{
    return m_version_isValid;
}

QList OAICreateApiResponse::getWarnings() const {
    return m_warnings;
}
void OAICreateApiResponse::setWarnings(const QList &warnings) {
    m_warnings = warnings;
    m_warnings_isSet = true;
}

bool OAICreateApiResponse::is_warnings_Set() const{
    return m_warnings_isSet;
}

bool OAICreateApiResponse::is_warnings_Valid() const{
    return m_warnings_isValid;
}

bool OAICreateApiResponse::isSet() const {
...
bool OAICreateApiResponse::isValid() const {
