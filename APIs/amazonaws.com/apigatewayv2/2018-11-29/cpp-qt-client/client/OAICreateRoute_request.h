...
public:
    ...
    QMap<QString, OAIParameterConstraints> getRequestParameters() const;
    void setRequestParameters(const QMap<QString, OAIParameterConstraints> &request_parameters);
...
private:
    ...
    QMap<QString, OAIParameterConstraints> m_request_parameters;
