...
/*
 * OAICreateStageResponse_DefaultRouteSettings.h
 *
 * 
 */

#ifndef OAICreateStageResponse_DefaultRouteSettings_H
#define OAICreateStageResponse_DefaultRouteSettings_H
...
class OAICreateStageResponse_DefaultRouteSettings : public OAIObject {
public:
    OAICreateStageResponse_DefaultRouteSettings();
    OAICreateStageResponse_DefaultRouteSettings(QString json);
    ~OAICreateStageResponse_DefaultRouteSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateStageResponse_DefaultRouteSettings)

#endif // OAICreateStageResponse_DefaultRouteSettings_H
