...
OAIGetVpcLinkResponse::OAIGetVpcLinkResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetVpcLinkResponse::OAIGetVpcLinkResponse() {
    this->initializeModel();
}

OAIGetVpcLinkResponse::~OAIGetVpcLinkResponse() {}

void OAIGetVpcLinkResponse::initializeModel() {
...
void OAIGetVpcLinkResponse::fromJson(QString jsonString) {
...
void OAIGetVpcLinkResponse::fromJsonObject(QJsonObject json) {
...
QString OAIGetVpcLinkResponse::asJson() const {
...
QJsonObject OAIGetVpcLinkResponse::asJsonObject() const {
    QJsonObject obj;
...
QDateTime OAIGetVpcLinkResponse::getCreatedDate() const {
    return m_created_date;
}
void OAIGetVpcLinkResponse::setCreatedDate(const QDateTime &created_date) {
    m_created_date = created_date;
    m_created_date_isSet = true;
}

bool OAIGetVpcLinkResponse::is_created_date_Set() const{
    return m_created_date_isSet;
}

bool OAIGetVpcLinkResponse::is_created_date_Valid() const{
    return m_created_date_isValid;
}

QString OAIGetVpcLinkResponse::getName() const {
    return m_name;
}
void OAIGetVpcLinkResponse::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIGetVpcLinkResponse::is_name_Set() const{
    return m_name_isSet;
}

bool OAIGetVpcLinkResponse::is_name_Valid() const{
    return m_name_isValid;
}

QList OAIGetVpcLinkResponse::getSecurityGroupIds() const {
    return m_security_group_ids;
}
void OAIGetVpcLinkResponse::setSecurityGroupIds(const QList &security_group_ids) {
    m_security_group_ids = security_group_ids;
    m_security_group_ids_isSet = true;
}

bool OAIGetVpcLinkResponse::is_security_group_ids_Set() const{
    return m_security_group_ids_isSet;
}

bool OAIGetVpcLinkResponse::is_security_group_ids_Valid() const{
    return m_security_group_ids_isValid;
}

QList OAIGetVpcLinkResponse::getSubnetIds() const {
    return m_subnet_ids;
}
void OAIGetVpcLinkResponse::setSubnetIds(const QList &subnet_ids) {
    m_subnet_ids = subnet_ids;
    m_subnet_ids_isSet = true;
}

bool OAIGetVpcLinkResponse::is_subnet_ids_Set() const{
    return m_subnet_ids_isSet;
}

bool OAIGetVpcLinkResponse::is_subnet_ids_Valid() const{
    return m_subnet_ids_isValid;
}

QMap OAIGetVpcLinkResponse::getTags() const {
    return m_tags;
}
void OAIGetVpcLinkResponse::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIGetVpcLinkResponse::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIGetVpcLinkResponse::is_tags_Valid() const{
    return m_tags_isValid;
}

QString OAIGetVpcLinkResponse::getVpcLinkId() const {
    return m_vpc_link_id;
}
void OAIGetVpcLinkResponse::setVpcLinkId(const QString &vpc_link_id) {
    m_vpc_link_id = vpc_link_id;
    m_vpc_link_id_isSet = true;
}

bool OAIGetVpcLinkResponse::is_vpc_link_id_Set() const{
    return m_vpc_link_id_isSet;
}

bool OAIGetVpcLinkResponse::is_vpc_link_id_Valid() const{
    return m_vpc_link_id_isValid;
}

OAIVpcLinkStatus OAIGetVpcLinkResponse::getVpcLinkStatus() const {
    return m_vpc_link_status;
}
void OAIGetVpcLinkResponse::setVpcLinkStatus(const OAIVpcLinkStatus &vpc_link_status) {
    m_vpc_link_status = vpc_link_status;
    m_vpc_link_status_isSet = true;
}

bool OAIGetVpcLinkResponse::is_vpc_link_status_Set() const{
    return m_vpc_link_status_isSet;
}

bool OAIGetVpcLinkResponse::is_vpc_link_status_Valid() const{
    return m_vpc_link_status_isValid;
}

QString OAIGetVpcLinkResponse::getVpcLinkStatusMessage() const {
    return m_vpc_link_status_message;
}
void OAIGetVpcLinkResponse::setVpcLinkStatusMessage(const QString &vpc_link_status_message) {
    m_vpc_link_status_message = vpc_link_status_message;
    m_vpc_link_status_message_isSet = true;
}

bool OAIGetVpcLinkResponse::is_vpc_link_status_message_Set() const{
    return m_vpc_link_status_message_isSet;
}

bool OAIGetVpcLinkResponse::is_vpc_link_status_message_Valid() const{
    return m_vpc_link_status_message_isValid;
}

OAIVpcLinkVersion OAIGetVpcLinkResponse::getVpcLinkVersion() const {
    return m_vpc_link_version;
}
void OAIGetVpcLinkResponse::setVpcLinkVersion(const OAIVpcLinkVersion &vpc_link_version) {
    m_vpc_link_version = vpc_link_version;
    m_vpc_link_version_isSet = true;
}

bool OAIGetVpcLinkResponse::is_vpc_link_version_Set() const{
    return m_vpc_link_version_isSet;
}

bool OAIGetVpcLinkResponse::is_vpc_link_version_Valid() const{
    return m_vpc_link_version_isValid;
}

bool OAIGetVpcLinkResponse::isSet() const {
...
bool OAIGetVpcLinkResponse::isValid() const {
