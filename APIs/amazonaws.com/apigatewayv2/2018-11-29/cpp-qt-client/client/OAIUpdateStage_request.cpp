...
OAICreateStage_request_accessLogSettings OAIUpdateStage_request::getAccessLogSettings() const {
    return m_access_log_settings;
}
void OAIUpdateStage_request::setAccessLogSettings(const OAICreateStage_request_accessLogSettings &access_log_settings) {
    m_access_log_settings = access_log_settings;
    m_access_log_settings_isSet = true;
}

bool OAIUpdateStage_request::is_access_log_settings_Set() const{
    return m_access_log_settings_isSet;
}

bool OAIUpdateStage_request::is_access_log_settings_Valid() const{
    return m_access_log_settings_isValid;
}

bool OAIUpdateStage_request::isAutoDeploy() const {
    return m_auto_deploy;
}
void OAIUpdateStage_request::setAutoDeploy(const bool &auto_deploy) {
    m_auto_deploy = auto_deploy;
    m_auto_deploy_isSet = true;
}

bool OAIUpdateStage_request::is_auto_deploy_Set() const{
    return m_auto_deploy_isSet;
}

bool OAIUpdateStage_request::is_auto_deploy_Valid() const{
    return m_auto_deploy_isValid;
}

QString OAIUpdateStage_request::getClientCertificateId() const {
    return m_client_certificate_id;
}
void OAIUpdateStage_request::setClientCertificateId(const QString &client_certificate_id) {
    m_client_certificate_id = client_certificate_id;
    m_client_certificate_id_isSet = true;
}

bool OAIUpdateStage_request::is_client_certificate_id_Set() const{
    return m_client_certificate_id_isSet;
}

bool OAIUpdateStage_request::is_client_certificate_id_Valid() const{
    return m_client_certificate_id_isValid;
}

OAICreateStage_request_defaultRouteSettings OAIUpdateStage_request::getDefaultRouteSettings() const {
    return m_default_route_settings;
}
void OAIUpdateStage_request::setDefaultRouteSettings(const OAICreateStage_request_defaultRouteSettings &default_route_settings) {
    m_default_route_settings = default_route_settings;
    m_default_route_settings_isSet = true;
}

bool OAIUpdateStage_request::is_default_route_settings_Set() const{
    return m_default_route_settings_isSet;
}

bool OAIUpdateStage_request::is_default_route_settings_Valid() const{
    return m_default_route_settings_isValid;
}

QString OAIUpdateStage_request::getDeploymentId() const {
    return m_deployment_id;
}
void OAIUpdateStage_request::setDeploymentId(const QString &deployment_id) {
    m_deployment_id = deployment_id;
    m_deployment_id_isSet = true;
}

bool OAIUpdateStage_request::is_deployment_id_Set() const{
    return m_deployment_id_isSet;
}

bool OAIUpdateStage_request::is_deployment_id_Valid() const{
...
QMap<QString, OAIRouteSettings> OAIUpdateStage_request::getRouteSettings() const {
    return m_route_settings;
}
void OAIUpdateStage_request::setRouteSettings(const QMap<QString, OAIRouteSettings> &route_settings) {
    m_route_settings = route_settings;
    m_route_settings_isSet = true;
}

bool OAIUpdateStage_request::is_route_settings_Set() const{
    return m_route_settings_isSet;
}

bool OAIUpdateStage_request::is_route_settings_Valid() const{
    return m_route_settings_isValid;
}

QMap<QString, QString> OAIUpdateStage_request::getStageVariables() const {
    return m_stage_variables;
}
void OAIUpdateStage_request::setStageVariables(const QMap<QString, QString> &stage_variables) {
    m_stage_variables = stage_variables;
    m_stage_variables_isSet = true;
}

bool OAIUpdateStage_request::is_stage_variables_Set() const{
    return m_stage_variables_isSet;
}

bool OAIUpdateStage_request::is_stage_variables_Valid() const{
