...
/*
 * OAIGetAuthorizerResponse.h
 *
 * 
 */

#ifndef OAIGetAuthorizerResponse_H
#define OAIGetAuthorizerResponse_H
...
class OAIGetAuthorizerResponse : public OAIObject {
public:
    OAIGetAuthorizerResponse();
    OAIGetAuthorizerResponse(QString json);
    ~OAIGetAuthorizerResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetAuthorizerResponse)

#endif // OAIGetAuthorizerResponse_H
