...
#ifndef OAIGetRouteResult_H
#define OAIGetRouteResult_H
...
class OAIGetRouteResult : public OAIObject {
public:
    OAIGetRouteResult();
    OAIGetRouteResult(QString json);
    ~OAIGetRouteResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetRouteResult)

#endif // OAIGetRouteResult_H
