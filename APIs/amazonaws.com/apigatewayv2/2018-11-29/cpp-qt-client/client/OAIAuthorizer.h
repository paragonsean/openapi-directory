...
#ifndef OAIAuthorizer_H
#define OAIAuthorizer_H
...
class OAIAuthorizer : public OAIObject {
public:
    OAIAuthorizer();
    OAIAuthorizer(QString json);
    ~OAIAuthorizer() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAuthorizer)

#endif // OAIAuthorizer_H
