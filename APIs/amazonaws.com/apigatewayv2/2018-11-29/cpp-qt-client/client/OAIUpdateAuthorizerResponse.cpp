...
OAIUpdateAuthorizerResponse::OAIUpdateAuthorizerResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateAuthorizerResponse::OAIUpdateAuthorizerResponse() {
    this->initializeModel();
}

OAIUpdateAuthorizerResponse::~OAIUpdateAuthorizerResponse() {}

void OAIUpdateAuthorizerResponse::initializeModel() {
...
void OAIUpdateAuthorizerResponse::fromJson(QString jsonString) {
...
void OAIUpdateAuthorizerResponse::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateAuthorizerResponse::asJson() const {
...
QJsonObject OAIUpdateAuthorizerResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateAuthorizerResponse::getAuthorizerCredentialsArn() const {
    return m_authorizer_credentials_arn;
}
void OAIUpdateAuthorizerResponse::setAuthorizerCredentialsArn(const QString &authorizer_credentials_arn) {
    m_authorizer_credentials_arn = authorizer_credentials_arn;
    m_authorizer_credentials_arn_isSet = true;
}

bool OAIUpdateAuthorizerResponse::is_authorizer_credentials_arn_Set() const{
    return m_authorizer_credentials_arn_isSet;
}

bool OAIUpdateAuthorizerResponse::is_authorizer_credentials_arn_Valid() const{
    return m_authorizer_credentials_arn_isValid;
}

QString OAIUpdateAuthorizerResponse::getAuthorizerId() const {
    return m_authorizer_id;
}
void OAIUpdateAuthorizerResponse::setAuthorizerId(const QString &authorizer_id) {
    m_authorizer_id = authorizer_id;
    m_authorizer_id_isSet = true;
}

bool OAIUpdateAuthorizerResponse::is_authorizer_id_Set() const{
    return m_authorizer_id_isSet;
}

bool OAIUpdateAuthorizerResponse::is_authorizer_id_Valid() const{
    return m_authorizer_id_isValid;
}

QString OAIUpdateAuthorizerResponse::getAuthorizerPayloadFormatVersion() const {
    return m_authorizer_payload_format_version;
}
void OAIUpdateAuthorizerResponse::setAuthorizerPayloadFormatVersion(const QString &authorizer_payload_format_version) {
    m_authorizer_payload_format_version = authorizer_payload_format_version;
    m_authorizer_payload_format_version_isSet = true;
}

bool OAIUpdateAuthorizerResponse::is_authorizer_payload_format_version_Set() const{
    return m_authorizer_payload_format_version_isSet;
}

bool OAIUpdateAuthorizerResponse::is_authorizer_payload_format_version_Valid() const{
    return m_authorizer_payload_format_version_isValid;
}

qint32 OAIUpdateAuthorizerResponse::getAuthorizerResultTtlInSeconds() const {
    return m_authorizer_result_ttl_in_seconds;
}
void OAIUpdateAuthorizerResponse::setAuthorizerResultTtlInSeconds(const qint32 &authorizer_result_ttl_in_seconds) {
    m_authorizer_result_ttl_in_seconds = authorizer_result_ttl_in_seconds;
    m_authorizer_result_ttl_in_seconds_isSet = true;
}

bool OAIUpdateAuthorizerResponse::is_authorizer_result_ttl_in_seconds_Set() const{
    return m_authorizer_result_ttl_in_seconds_isSet;
}

bool OAIUpdateAuthorizerResponse::is_authorizer_result_ttl_in_seconds_Valid() const{
    return m_authorizer_result_ttl_in_seconds_isValid;
}

OAIAuthorizerType OAIUpdateAuthorizerResponse::getAuthorizerType() const {
    return m_authorizer_type;
}
void OAIUpdateAuthorizerResponse::setAuthorizerType(const OAIAuthorizerType &authorizer_type) {
    m_authorizer_type = authorizer_type;
    m_authorizer_type_isSet = true;
}

bool OAIUpdateAuthorizerResponse::is_authorizer_type_Set() const{
    return m_authorizer_type_isSet;
}

bool OAIUpdateAuthorizerResponse::is_authorizer_type_Valid() const{
    return m_authorizer_type_isValid;
}

QString OAIUpdateAuthorizerResponse::getAuthorizerUri() const {
    return m_authorizer_uri;
}
void OAIUpdateAuthorizerResponse::setAuthorizerUri(const QString &authorizer_uri) {
    m_authorizer_uri = authorizer_uri;
    m_authorizer_uri_isSet = true;
}

bool OAIUpdateAuthorizerResponse::is_authorizer_uri_Set() const{
    return m_authorizer_uri_isSet;
}

bool OAIUpdateAuthorizerResponse::is_authorizer_uri_Valid() const{
    return m_authorizer_uri_isValid;
}

bool OAIUpdateAuthorizerResponse::getEnableSimpleResponses() const {
    return m_enable_simple_responses;
}
void OAIUpdateAuthorizerResponse::setEnableSimpleResponses(const bool &enable_simple_responses) {
    m_enable_simple_responses = enable_simple_responses;
    m_enable_simple_responses_isSet = true;
}

bool OAIUpdateAuthorizerResponse::is_enable_simple_responses_Set() const{
    return m_enable_simple_responses_isSet;
}

bool OAIUpdateAuthorizerResponse::is_enable_simple_responses_Valid() const{
    return m_enable_simple_responses_isValid;
}

QList OAIUpdateAuthorizerResponse::getIdentitySource() const {
    return m_identity_source;
}
void OAIUpdateAuthorizerResponse::setIdentitySource(const QList &identity_source) {
    m_identity_source = identity_source;
    m_identity_source_isSet = true;
}

bool OAIUpdateAuthorizerResponse::is_identity_source_Set() const{
    return m_identity_source_isSet;
}

bool OAIUpdateAuthorizerResponse::is_identity_source_Valid() const{
    return m_identity_source_isValid;
}

QString OAIUpdateAuthorizerResponse::getIdentityValidationExpression() const {
    return m_identity_validation_expression;
}
void OAIUpdateAuthorizerResponse::setIdentityValidationExpression(const QString &identity_validation_expression) {
    m_identity_validation_expression = identity_validation_expression;
    m_identity_validation_expression_isSet = true;
}

bool OAIUpdateAuthorizerResponse::is_identity_validation_expression_Set() const{
    return m_identity_validation_expression_isSet;
}

bool OAIUpdateAuthorizerResponse::is_identity_validation_expression_Valid() const{
    return m_identity_validation_expression_isValid;
}

OAICreateAuthorizerResponse_JwtConfiguration OAIUpdateAuthorizerResponse::getJwtConfiguration() const {
    return m_jwt_configuration;
}
void OAIUpdateAuthorizerResponse::setJwtConfiguration(const OAICreateAuthorizerResponse_JwtConfiguration &jwt_configuration) {
    m_jwt_configuration = jwt_configuration;
    m_jwt_configuration_isSet = true;
}

bool OAIUpdateAuthorizerResponse::is_jwt_configuration_Set() const{
    return m_jwt_configuration_isSet;
}

bool OAIUpdateAuthorizerResponse::is_jwt_configuration_Valid() const{
    return m_jwt_configuration_isValid;
}

QString OAIUpdateAuthorizerResponse::getName() const {
    return m_name;
}
void OAIUpdateAuthorizerResponse::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIUpdateAuthorizerResponse::is_name_Set() const{
    return m_name_isSet;
}

bool OAIUpdateAuthorizerResponse::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIUpdateAuthorizerResponse::isSet() const {
...
bool OAIUpdateAuthorizerResponse::isValid() const {
