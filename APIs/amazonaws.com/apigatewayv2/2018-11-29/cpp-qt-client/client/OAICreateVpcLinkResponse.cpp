...
OAICreateVpcLinkResponse::OAICreateVpcLinkResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateVpcLinkResponse::OAICreateVpcLinkResponse() {
    this->initializeModel();
}

OAICreateVpcLinkResponse::~OAICreateVpcLinkResponse() {}

void OAICreateVpcLinkResponse::initializeModel() {
...
void OAICreateVpcLinkResponse::fromJson(QString jsonString) {
...
void OAICreateVpcLinkResponse::fromJsonObject(QJsonObject json) {
...
QString OAICreateVpcLinkResponse::asJson() const {
...
QJsonObject OAICreateVpcLinkResponse::asJsonObject() const {
    QJsonObject obj;
...
QDateTime OAICreateVpcLinkResponse::getCreatedDate() const {
    return m_created_date;
}
void OAICreateVpcLinkResponse::setCreatedDate(const QDateTime &created_date) {
    m_created_date = created_date;
    m_created_date_isSet = true;
}

bool OAICreateVpcLinkResponse::is_created_date_Set() const{
    return m_created_date_isSet;
}

bool OAICreateVpcLinkResponse::is_created_date_Valid() const{
    return m_created_date_isValid;
}

QString OAICreateVpcLinkResponse::getName() const {
    return m_name;
}
void OAICreateVpcLinkResponse::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICreateVpcLinkResponse::is_name_Set() const{
    return m_name_isSet;
}

bool OAICreateVpcLinkResponse::is_name_Valid() const{
    return m_name_isValid;
}

QList OAICreateVpcLinkResponse::getSecurityGroupIds() const {
    return m_security_group_ids;
}
void OAICreateVpcLinkResponse::setSecurityGroupIds(const QList &security_group_ids) {
    m_security_group_ids = security_group_ids;
    m_security_group_ids_isSet = true;
}

bool OAICreateVpcLinkResponse::is_security_group_ids_Set() const{
    return m_security_group_ids_isSet;
}

bool OAICreateVpcLinkResponse::is_security_group_ids_Valid() const{
    return m_security_group_ids_isValid;
}

QList OAICreateVpcLinkResponse::getSubnetIds() const {
    return m_subnet_ids;
}
void OAICreateVpcLinkResponse::setSubnetIds(const QList &subnet_ids) {
    m_subnet_ids = subnet_ids;
    m_subnet_ids_isSet = true;
}

bool OAICreateVpcLinkResponse::is_subnet_ids_Set() const{
    return m_subnet_ids_isSet;
}

bool OAICreateVpcLinkResponse::is_subnet_ids_Valid() const{
    return m_subnet_ids_isValid;
}

QMap OAICreateVpcLinkResponse::getTags() const {
    return m_tags;
}
void OAICreateVpcLinkResponse::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAICreateVpcLinkResponse::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAICreateVpcLinkResponse::is_tags_Valid() const{
    return m_tags_isValid;
}

QString OAICreateVpcLinkResponse::getVpcLinkId() const {
    return m_vpc_link_id;
}
void OAICreateVpcLinkResponse::setVpcLinkId(const QString &vpc_link_id) {
    m_vpc_link_id = vpc_link_id;
    m_vpc_link_id_isSet = true;
}

bool OAICreateVpcLinkResponse::is_vpc_link_id_Set() const{
    return m_vpc_link_id_isSet;
}

bool OAICreateVpcLinkResponse::is_vpc_link_id_Valid() const{
    return m_vpc_link_id_isValid;
}

OAIVpcLinkStatus OAICreateVpcLinkResponse::getVpcLinkStatus() const {
    return m_vpc_link_status;
}
void OAICreateVpcLinkResponse::setVpcLinkStatus(const OAIVpcLinkStatus &vpc_link_status) {
    m_vpc_link_status = vpc_link_status;
    m_vpc_link_status_isSet = true;
}

bool OAICreateVpcLinkResponse::is_vpc_link_status_Set() const{
    return m_vpc_link_status_isSet;
}

bool OAICreateVpcLinkResponse::is_vpc_link_status_Valid() const{
    return m_vpc_link_status_isValid;
}

QString OAICreateVpcLinkResponse::getVpcLinkStatusMessage() const {
    return m_vpc_link_status_message;
}
void OAICreateVpcLinkResponse::setVpcLinkStatusMessage(const QString &vpc_link_status_message) {
    m_vpc_link_status_message = vpc_link_status_message;
    m_vpc_link_status_message_isSet = true;
}

bool OAICreateVpcLinkResponse::is_vpc_link_status_message_Set() const{
    return m_vpc_link_status_message_isSet;
}

bool OAICreateVpcLinkResponse::is_vpc_link_status_message_Valid() const{
    return m_vpc_link_status_message_isValid;
}

OAIVpcLinkVersion OAICreateVpcLinkResponse::getVpcLinkVersion() const {
    return m_vpc_link_version;
}
void OAICreateVpcLinkResponse::setVpcLinkVersion(const OAIVpcLinkVersion &vpc_link_version) {
    m_vpc_link_version = vpc_link_version;
    m_vpc_link_version_isSet = true;
}

bool OAICreateVpcLinkResponse::is_vpc_link_version_Set() const{
    return m_vpc_link_version_isSet;
}

bool OAICreateVpcLinkResponse::is_vpc_link_version_Valid() const{
    return m_vpc_link_version_isValid;
}

bool OAICreateVpcLinkResponse::isSet() const {
...
bool OAICreateVpcLinkResponse::isValid() const {
