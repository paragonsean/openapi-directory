...
QString OAIAuthorizer::getAuthorizerCredentialsArn() const {
    return m_authorizer_credentials_arn;
}
void OAIAuthorizer::setAuthorizerCredentialsArn(const QString &authorizer_credentials_arn) {
    m_authorizer_credentials_arn = authorizer_credentials_arn;
    m_authorizer_credentials_arn_isSet = true;
}

bool OAIAuthorizer::is_authorizer_credentials_arn_Set() const{
    return m_authorizer_credentials_arn_isSet;
}

bool OAIAuthorizer::is_authorizer_credentials_arn_Valid() const{
    return m_authorizer_credentials_arn_isValid;
}

QString OAIAuthorizer::getAuthorizerId() const {
    return m_authorizer_id;
}
void OAIAuthorizer::setAuthorizerId(const QString &authorizer_id) {
    m_authorizer_id = authorizer_id;
    m_authorizer_id_isSet = true;
}

bool OAIAuthorizer::is_authorizer_id_Set() const{
    return m_authorizer_id_isSet;
}

bool OAIAuthorizer::is_authorizer_id_Valid() const{
    return m_authorizer_id_isValid;
}

QString OAIAuthorizer::getAuthorizerPayloadFormatVersion() const {
    return m_authorizer_payload_format_version;
}
void OAIAuthorizer::setAuthorizerPayloadFormatVersion(const QString &authorizer_payload_format_version) {
    m_authorizer_payload_format_version = authorizer_payload_format_version;
    m_authorizer_payload_format_version_isSet = true;
}

bool OAIAuthorizer::is_authorizer_payload_format_version_Set() const{
    return m_authorizer_payload_format_version_isSet;
}

bool OAIAuthorizer::is_authorizer_payload_format_version_Valid() const{
...
OAIAuthorizerType OAIAuthorizer::getAuthorizerType() const {
    return m_authorizer_type;
}
void OAIAuthorizer::setAuthorizerType(const OAIAuthorizerType &authorizer_type) {
    m_authorizer_type = authorizer_type;
    m_authorizer_type_isSet = true;
}

bool OAIAuthorizer::is_authorizer_type_Set() const{
    return m_authorizer_type_isSet;
}

bool OAIAuthorizer::is_authorizer_type_Valid() const{
...
bool OAIAuthorizer::getEnableSimpleResponses() const {
    return m_enable_simple_responses;
}
void OAIAuthorizer::setEnableSimpleResponses(const bool &enable_simple_responses) {
    m_enable_simple_responses = enable_simple_responses;
    m_enable_simple_responses_isSet = true;
}

bool OAIAuthorizer::is_enable_simple_responses_Set() const{
    return m_enable_simple_responses_isSet;
}

bool OAIAuthorizer::is_enable_simple_responses_Valid() const{
    return m_enable_simple_responses_isValid;
}

QList OAIAuthorizer::getIdentitySource() const {
    return m_identity_source;
}
void OAIAuthorizer::setIdentitySource(const QList &identity_source) {
...
OAICreateAuthorizerResponse_JwtConfiguration OAIAuthorizer::getJwtConfiguration() const {
    return m_jwt_configuration;
}
void OAIAuthorizer::setJwtConfiguration(const OAICreateAuthorizerResponse_JwtConfiguration &jwt_configuration) {
    m_jwt_configuration = jwt_configuration;
    m_jwt_configuration_isSet = true;
}

bool OAIAuthorizer::is_jwt_configuration_Set() const{
    return m_jwt_configuration_isSet;
}

bool OAIAuthorizer::is_jwt_configuration_Valid() const{
