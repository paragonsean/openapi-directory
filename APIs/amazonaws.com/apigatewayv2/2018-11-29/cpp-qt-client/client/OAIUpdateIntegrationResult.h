...
/*
 * OAIUpdateIntegrationResult.h
 *
 * 
 */

#ifndef OAIUpdateIntegrationResult_H
#define OAIUpdateIntegrationResult_H
...
class OAIUpdateIntegrationResult : public OAIObject {
public:
    OAIUpdateIntegrationResult();
    OAIUpdateIntegrationResult(QString json);
    ~OAIUpdateIntegrationResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateIntegrationResult)

#endif // OAIUpdateIntegrationResult_H
