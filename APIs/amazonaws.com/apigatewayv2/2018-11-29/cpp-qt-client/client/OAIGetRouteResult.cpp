...
OAIGetRouteResult::OAIGetRouteResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetRouteResult::OAIGetRouteResult() {
    this->initializeModel();
}

OAIGetRouteResult::~OAIGetRouteResult() {}

void OAIGetRouteResult::initializeModel() {
...
void OAIGetRouteResult::fromJson(QString jsonString) {
...
void OAIGetRouteResult::fromJsonObject(QJsonObject json) {
...
QString OAIGetRouteResult::asJson() const {
...
QJsonObject OAIGetRouteResult::asJsonObject() const {
    QJsonObject obj;
...
bool OAIGetRouteResult::getApiGatewayManaged() const {
    return m_api_gateway_managed;
}
void OAIGetRouteResult::setApiGatewayManaged(const bool &api_gateway_managed) {
    m_api_gateway_managed = api_gateway_managed;
    m_api_gateway_managed_isSet = true;
}

bool OAIGetRouteResult::is_api_gateway_managed_Set() const{
    return m_api_gateway_managed_isSet;
}

bool OAIGetRouteResult::is_api_gateway_managed_Valid() const{
    return m_api_gateway_managed_isValid;
}

bool OAIGetRouteResult::getApiKeyRequired() const {
    return m_api_key_required;
}
void OAIGetRouteResult::setApiKeyRequired(const bool &api_key_required) {
    m_api_key_required = api_key_required;
    m_api_key_required_isSet = true;
}

bool OAIGetRouteResult::is_api_key_required_Set() const{
    return m_api_key_required_isSet;
}

bool OAIGetRouteResult::is_api_key_required_Valid() const{
    return m_api_key_required_isValid;
}

QList OAIGetRouteResult::getAuthorizationScopes() const {
    return m_authorization_scopes;
}
void OAIGetRouteResult::setAuthorizationScopes(const QList &authorization_scopes) {
    m_authorization_scopes = authorization_scopes;
    m_authorization_scopes_isSet = true;
}

bool OAIGetRouteResult::is_authorization_scopes_Set() const{
    return m_authorization_scopes_isSet;
}

bool OAIGetRouteResult::is_authorization_scopes_Valid() const{
    return m_authorization_scopes_isValid;
}

OAIAuthorizationType OAIGetRouteResult::getAuthorizationType() const {
    return m_authorization_type;
}
void OAIGetRouteResult::setAuthorizationType(const OAIAuthorizationType &authorization_type) {
    m_authorization_type = authorization_type;
    m_authorization_type_isSet = true;
}

bool OAIGetRouteResult::is_authorization_type_Set() const{
    return m_authorization_type_isSet;
}

bool OAIGetRouteResult::is_authorization_type_Valid() const{
    return m_authorization_type_isValid;
}

QString OAIGetRouteResult::getAuthorizerId() const {
    return m_authorizer_id;
}
void OAIGetRouteResult::setAuthorizerId(const QString &authorizer_id) {
    m_authorizer_id = authorizer_id;
    m_authorizer_id_isSet = true;
}

bool OAIGetRouteResult::is_authorizer_id_Set() const{
    return m_authorizer_id_isSet;
}

bool OAIGetRouteResult::is_authorizer_id_Valid() const{
    return m_authorizer_id_isValid;
}

QString OAIGetRouteResult::getModelSelectionExpression() const {
    return m_model_selection_expression;
}
void OAIGetRouteResult::setModelSelectionExpression(const QString &model_selection_expression) {
    m_model_selection_expression = model_selection_expression;
    m_model_selection_expression_isSet = true;
}

bool OAIGetRouteResult::is_model_selection_expression_Set() const{
    return m_model_selection_expression_isSet;
}

bool OAIGetRouteResult::is_model_selection_expression_Valid() const{
    return m_model_selection_expression_isValid;
}

QString OAIGetRouteResult::getOperationName() const {
    return m_operation_name;
}
void OAIGetRouteResult::setOperationName(const QString &operation_name) {
    m_operation_name = operation_name;
    m_operation_name_isSet = true;
}

bool OAIGetRouteResult::is_operation_name_Set() const{
    return m_operation_name_isSet;
}

bool OAIGetRouteResult::is_operation_name_Valid() const{
    return m_operation_name_isValid;
}

QMap OAIGetRouteResult::getRequestModels() const {
    return m_request_models;
}
void OAIGetRouteResult::setRequestModels(const QMap &request_models) {
    m_request_models = request_models;
    m_request_models_isSet = true;
}

bool OAIGetRouteResult::is_request_models_Set() const{
    return m_request_models_isSet;
}

bool OAIGetRouteResult::is_request_models_Valid() const{
    return m_request_models_isValid;
}

QMap OAIGetRouteResult::getRequestParameters() const {
    return m_request_parameters;
}
void OAIGetRouteResult::setRequestParameters(const QMap &request_parameters) {
    m_request_parameters = request_parameters;
    m_request_parameters_isSet = true;
}

bool OAIGetRouteResult::is_request_parameters_Set() const{
    return m_request_parameters_isSet;
}

bool OAIGetRouteResult::is_request_parameters_Valid() const{
    return m_request_parameters_isValid;
}

QString OAIGetRouteResult::getRouteId() const {
    return m_route_id;
}
void OAIGetRouteResult::setRouteId(const QString &route_id) {
    m_route_id = route_id;
    m_route_id_isSet = true;
}

bool OAIGetRouteResult::is_route_id_Set() const{
    return m_route_id_isSet;
}

bool OAIGetRouteResult::is_route_id_Valid() const{
    return m_route_id_isValid;
}

QString OAIGetRouteResult::getRouteKey() const {
    return m_route_key;
}
void OAIGetRouteResult::setRouteKey(const QString &route_key) {
    m_route_key = route_key;
    m_route_key_isSet = true;
}

bool OAIGetRouteResult::is_route_key_Set() const{
    return m_route_key_isSet;
}

bool OAIGetRouteResult::is_route_key_Valid() const{
    return m_route_key_isValid;
}

QString OAIGetRouteResult::getRouteResponseSelectionExpression() const {
    return m_route_response_selection_expression;
}
void OAIGetRouteResult::setRouteResponseSelectionExpression(const QString &route_response_selection_expression) {
...
bool OAIGetRouteResult::is_route_response_selection_expression_Set() const{
    return m_route_response_selection_expression_isSet;
}

bool OAIGetRouteResult::is_route_response_selection_expression_Valid() const{
    return m_route_response_selection_expression_isValid;
}

QString OAIGetRouteResult::getTarget() const {
    return m_target;
}
void OAIGetRouteResult::setTarget(const QString &target) {
    m_target = target;
    m_target_isSet = true;
}

bool OAIGetRouteResult::is_target_Set() const{
    return m_target_isSet;
}

bool OAIGetRouteResult::is_target_Valid() const{
    return m_target_isValid;
}

bool OAIGetRouteResult::isSet() const {
...
bool OAIGetRouteResult::isValid() const {
