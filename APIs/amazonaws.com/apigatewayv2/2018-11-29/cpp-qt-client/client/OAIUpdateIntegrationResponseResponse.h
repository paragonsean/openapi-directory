...
/*
 * OAIUpdateIntegrationResponseResponse.h
 *
 * 
 */

#ifndef OAIUpdateIntegrationResponseResponse_H
#define OAIUpdateIntegrationResponseResponse_H
...
class OAIUpdateIntegrationResponseResponse : public OAIObject {
public:
    OAIUpdateIntegrationResponseResponse();
    OAIUpdateIntegrationResponseResponse(QString json);
    ~OAIUpdateIntegrationResponseResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateIntegrationResponseResponse)

#endif // OAIUpdateIntegrationResponseResponse_H
