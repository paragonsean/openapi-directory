...
OAICreateApi_request::OAICreateApi_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateApi_request::OAICreateApi_request() {
    this->initializeModel();
}

OAICreateApi_request::~OAICreateApi_request() {}

void OAICreateApi_request::initializeModel() {
...
void OAICreateApi_request::fromJson(QString jsonString) {
...
void OAICreateApi_request::fromJsonObject(QJsonObject json) {
...
QString OAICreateApi_request::asJson() const {
...
QJsonObject OAICreateApi_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateApi_request::getApiKeySelectionExpression() const {
    return m_api_key_selection_expression;
}
void OAICreateApi_request::setApiKeySelectionExpression(const QString &api_key_selection_expression) {
    m_api_key_selection_expression = api_key_selection_expression;
    m_api_key_selection_expression_isSet = true;
}

bool OAICreateApi_request::is_api_key_selection_expression_Set() const{
    return m_api_key_selection_expression_isSet;
}

bool OAICreateApi_request::is_api_key_selection_expression_Valid() const{
    return m_api_key_selection_expression_isValid;
}

OAICreateApi_request_corsConfiguration OAICreateApi_request::getCorsConfiguration() const {
    return m_cors_configuration;
}
void OAICreateApi_request::setCorsConfiguration(const OAICreateApi_request_corsConfiguration &cors_configuration) {
    m_cors_configuration = cors_configuration;
    m_cors_configuration_isSet = true;
}

bool OAICreateApi_request::is_cors_configuration_Set() const{
    return m_cors_configuration_isSet;
}

bool OAICreateApi_request::is_cors_configuration_Valid() const{
    return m_cors_configuration_isValid;
}

QString OAICreateApi_request::getCredentialsArn() const {
    return m_credentials_arn;
}
void OAICreateApi_request::setCredentialsArn(const QString &credentials_arn) {
    m_credentials_arn = credentials_arn;
    m_credentials_arn_isSet = true;
}

bool OAICreateApi_request::is_credentials_arn_Set() const{
    return m_credentials_arn_isSet;
}

bool OAICreateApi_request::is_credentials_arn_Valid() const{
    return m_credentials_arn_isValid;
}

QString OAICreateApi_request::getDescription() const {
    return m_description;
}
void OAICreateApi_request::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAICreateApi_request::is_description_Set() const{
    return m_description_isSet;
}

bool OAICreateApi_request::is_description_Valid() const{
    return m_description_isValid;
}

bool OAICreateApi_request::isDisableSchemaValidation() const {
    return m_disable_schema_validation;
}
void OAICreateApi_request::setDisableSchemaValidation(const bool &disable_schema_validation) {
    m_disable_schema_validation = disable_schema_validation;
    m_disable_schema_validation_isSet = true;
}

bool OAICreateApi_request::is_disable_schema_validation_Set() const{
    return m_disable_schema_validation_isSet;
}

bool OAICreateApi_request::is_disable_schema_validation_Valid() const{
    return m_disable_schema_validation_isValid;
}

bool OAICreateApi_request::isDisableExecuteApiEndpoint() const {
    return m_disable_execute_api_endpoint;
}
void OAICreateApi_request::setDisableExecuteApiEndpoint(const bool &disable_execute_api_endpoint) {
    m_disable_execute_api_endpoint = disable_execute_api_endpoint;
    m_disable_execute_api_endpoint_isSet = true;
}

bool OAICreateApi_request::is_disable_execute_api_endpoint_Set() const{
    return m_disable_execute_api_endpoint_isSet;
}

bool OAICreateApi_request::is_disable_execute_api_endpoint_Valid() const{
    return m_disable_execute_api_endpoint_isValid;
}

QString OAICreateApi_request::getName() const {
    return m_name;
}
void OAICreateApi_request::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICreateApi_request::is_name_Set() const{
    return m_name_isSet;
}

bool OAICreateApi_request::is_name_Valid() const{
    return m_name_isValid;
}

QString OAICreateApi_request::getProtocolType() const {
    return m_protocol_type;
}
void OAICreateApi_request::setProtocolType(const QString &protocol_type) {
    m_protocol_type = protocol_type;
    m_protocol_type_isSet = true;
}

bool OAICreateApi_request::is_protocol_type_Set() const{
    return m_protocol_type_isSet;
}

bool OAICreateApi_request::is_protocol_type_Valid() const{
    return m_protocol_type_isValid;
}

QString OAICreateApi_request::getRouteKey() const {
    return m_route_key;
}
void OAICreateApi_request::setRouteKey(const QString &route_key) {
    m_route_key = route_key;
    m_route_key_isSet = true;
}

bool OAICreateApi_request::is_route_key_Set() const{
    return m_route_key_isSet;
}

bool OAICreateApi_request::is_route_key_Valid() const{
    return m_route_key_isValid;
}

QString OAICreateApi_request::getRouteSelectionExpression() const {
    return m_route_selection_expression;
}
void OAICreateApi_request::setRouteSelectionExpression(const QString &route_selection_expression) {
    m_route_selection_expression = route_selection_expression;
    m_route_selection_expression_isSet = true;
}

bool OAICreateApi_request::is_route_selection_expression_Set() const{
    return m_route_selection_expression_isSet;
}

bool OAICreateApi_request::is_route_selection_expression_Valid() const{
    return m_route_selection_expression_isValid;
}

QMap<QString, QString> OAICreateApi_request::getTags() const {
    return m_tags;
}
void OAICreateApi_request::setTags(const QMap<QString, QString> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAICreateApi_request::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAICreateApi_request::is_tags_Valid() const{
    return m_tags_isValid;
}

QString OAICreateApi_request::getTarget() const {
    return m_target;
}
void OAICreateApi_request::setTarget(const QString &target) {
    m_target = target;
    m_target_isSet = true;
}

bool OAICreateApi_request::is_target_Set() const{
    return m_target_isSet;
}

bool OAICreateApi_request::is_target_Valid() const{
    return m_target_isValid;
}

QString OAICreateApi_request::getVersion() const {
    return m_version;
}
void OAICreateApi_request::setVersion(const QString &version) {
    m_version = version;
    m_version_isSet = true;
}

bool OAICreateApi_request::is_version_Set() const{
    return m_version_isSet;
}

bool OAICreateApi_request::is_version_Valid() const{
    return m_version_isValid;
}

bool OAICreateApi_request::isSet() const {
...
bool OAICreateApi_request::isValid() const {
