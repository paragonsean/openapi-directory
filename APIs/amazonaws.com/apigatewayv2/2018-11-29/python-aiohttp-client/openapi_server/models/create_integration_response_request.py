...
class CreateIntegrationResponseRequest(Model):
    ...
    def __init__(self, content_handling_strategy: str=None, integration_response_key: str=None, response_parameters: Dict[str, str]=None, response_templates: Dict[str, str]=None, template_selection_expression: str=None):
        """CreateIntegrationResponseRequest - a model defined in OpenAPI

        :param content_handling_strategy: The content_handling_strategy of this CreateIntegrationResponseRequest.
        :param integration_response_key: The integration_response_key of this CreateIntegrationResponseRequest.
        :param response_parameters: The response_parameters of this CreateIntegrationResponseRequest.
        :param response_templates: The response_templates of this CreateIntegrationResponseRequest.
        :param template_selection_expression: The template_selection_expression of this CreateIntegrationResponseRequest.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CreateIntegrationResponseRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The CreateIntegrationResponse_request of this CreateIntegrationResponseRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def content_handling_strategy(self):
        """Gets the content_handling_strategy of this CreateIntegrationResponseRequest.

        Specifies how to handle response payload content type conversions. Supported only for WebSocket APIs.

        :return: The content_handling_strategy of this CreateIntegrationResponseRequest.
        :rtype: str
        """
    ...
    def content_handling_strategy(self, content_handling_strategy):
        """Sets the content_handling_strategy of this CreateIntegrationResponseRequest.
    ...
    def integration_response_key(self):
        """Gets the integration_response_key of this CreateIntegrationResponseRequest.
        ...
        :return: The integration_response_key of this CreateIntegrationResponseRequest.
        :rtype: str
        """
    ...
    def integration_response_key(self, integration_response_key):
        """Sets the integration_response_key of this CreateIntegrationResponseRequest.
    ...
    def response_parameters(self):
        """Gets the response_parameters of this CreateIntegrationResponseRequest.
        ...
        :return: The response_parameters of this CreateIntegrationResponseRequest.
        :rtype: Dict[str, str]
        """
    ...
    def response_parameters(self, response_parameters):
        """Sets the response_parameters of this CreateIntegrationResponseRequest.
    ...
    def response_templates(self):
        """Gets the response_templates of this CreateIntegrationResponseRequest.
        ...
        :return: The response_templates of this CreateIntegrationResponseRequest.
        :rtype: Dict[str, str]
        """
    ...
    def response_templates(self, response_templates):
        """Sets the response_templates of this CreateIntegrationResponseRequest.
    ...
    def template_selection_expression(self):
        """Gets the template_selection_expression of this CreateIntegrationResponseRequest.
        ...
        :return: The template_selection_expression of this CreateIntegrationResponseRequest.
        :rtype: str
        """
    ...
    def template_selection_expression(self, template_selection_expression):
        """Sets the template_selection_expression of this CreateIntegrationResponseRequest.
