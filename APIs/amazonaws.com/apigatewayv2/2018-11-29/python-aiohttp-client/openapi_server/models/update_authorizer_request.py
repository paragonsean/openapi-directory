...
class UpdateAuthorizerRequest(Model):
    ...
    def __init__(self, authorizer_credentials_arn: str=None, authorizer_payload_format_version: str=None, authorizer_result_ttl_in_seconds: int=None, authorizer_type: str=None, authorizer_uri: str=None, enable_simple_responses: bool=None, identity_source: List[str]=None, identity_validation_expression: str=None, jwt_configuration: CreateAuthorizerRequestJwtConfiguration=None, name: str=None):
        ...
        :param authorizer_credentials_arn: The authorizer_credentials_arn of this UpdateAuthorizerRequest.
        :param authorizer_payload_format_version: The authorizer_payload_format_version of this UpdateAuthorizerRequest.
        :param authorizer_result_ttl_in_seconds: The authorizer_result_ttl_in_seconds of this UpdateAuthorizerRequest.
        :param authorizer_type: The authorizer_type of this UpdateAuthorizerRequest.
        :param authorizer_uri: The authorizer_uri of this UpdateAuthorizerRequest.
        :param enable_simple_responses: The enable_simple_responses of this UpdateAuthorizerRequest.
        :param identity_source: The identity_source of this UpdateAuthorizerRequest.
        :param identity_validation_expression: The identity_validation_expression of this UpdateAuthorizerRequest.
        :param jwt_configuration: The jwt_configuration of this UpdateAuthorizerRequest.
        :param name: The name of this UpdateAuthorizerRequest.
        """
        self.openapi_types = {
    ...
    def from_dict(cls, dikt: dict) -> 'UpdateAuthorizerRequest':
        ...
        :param dikt: A dict.
        :return: The UpdateAuthorizer_request of this UpdateAuthorizerRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def authorizer_credentials_arn(self):
        """Gets the authorizer_credentials_arn of this UpdateAuthorizerRequest.

        Represents an Amazon Resource Name (ARN).

        :return: The authorizer_credentials_arn of this UpdateAuthorizerRequest.
        :rtype: str
        """
    ...
    def authorizer_credentials_arn(self, authorizer_credentials_arn):
        """Sets the authorizer_credentials_arn of this UpdateAuthorizerRequest.
    ...
    def authorizer_payload_format_version(self):
        """Gets the authorizer_payload_format_version of this UpdateAuthorizerRequest.

        A string with a length between [1-64].

        :return: The authorizer_payload_format_version of this UpdateAuthorizerRequest.
        :rtype: str
        """
    ...
    def authorizer_payload_format_version(self, authorizer_payload_format_version):
        """Sets the authorizer_payload_format_version of this UpdateAuthorizerRequest.
    ...
    def authorizer_result_ttl_in_seconds(self):
        """Gets the authorizer_result_ttl_in_seconds of this UpdateAuthorizerRequest.

        An integer with a value between [0-3600].

        :return: The authorizer_result_ttl_in_seconds of this UpdateAuthorizerRequest.
        :rtype: int
        """
    ...
    def authorizer_result_ttl_in_seconds(self, authorizer_result_ttl_in_seconds):
        """Sets the authorizer_result_ttl_in_seconds of this UpdateAuthorizerRequest.
    ...
    def authorizer_type(self):
        """Gets the authorizer_type of this UpdateAuthorizerRequest.

        The authorizer type. Specify REQUEST for a Lambda function using incoming request parameters. Specify JWT to use JSON Web Tokens (supported only for HTTP APIs).

        :return: The authorizer_type of this UpdateAuthorizerRequest.
        :rtype: str
        """
    ...
    def authorizer_type(self, authorizer_type):
        """Sets the authorizer_type of this UpdateAuthorizerRequest.
    ...
    def authorizer_uri(self):
        """Gets the authorizer_uri of this UpdateAuthorizerRequest.

        A string representation of a URI with a length between [1-2048].

        :return: The authorizer_uri of this UpdateAuthorizerRequest.
        :rtype: str
        """
    ...
    def authorizer_uri(self, authorizer_uri):
        """Sets the authorizer_uri of this UpdateAuthorizerRequest.
    ...
    def enable_simple_responses(self):
        """Gets the enable_simple_responses of this UpdateAuthorizerRequest.
        ...
        :return: The enable_simple_responses of this UpdateAuthorizerRequest.
        :rtype: bool
        """
    ...
    def enable_simple_responses(self, enable_simple_responses):
        """Sets the enable_simple_responses of this UpdateAuthorizerRequest.
    ...
    def identity_source(self):
        """Gets the identity_source of this UpdateAuthorizerRequest.
        ...
        :return: The identity_source of this UpdateAuthorizerRequest.
        :rtype: List[str]
        """
    ...
    def identity_source(self, identity_source):
        """Sets the identity_source of this UpdateAuthorizerRequest.
    ...
    def identity_validation_expression(self):
        """Gets the identity_validation_expression of this UpdateAuthorizerRequest.

        A string with a length between [0-1024].

        :return: The identity_validation_expression of this UpdateAuthorizerRequest.
        :rtype: str
        """
    ...
    def identity_validation_expression(self, identity_validation_expression):
        """Sets the identity_validation_expression of this UpdateAuthorizerRequest.
    ...
    def jwt_configuration(self):
        """Gets the jwt_configuration of this UpdateAuthorizerRequest.


        :return: The jwt_configuration of this UpdateAuthorizerRequest.
    ...
    def jwt_configuration(self, jwt_configuration):
        """Sets the jwt_configuration of this UpdateAuthorizerRequest.
    ...
    @property
    def name(self):
        """Gets the name of this UpdateAuthorizerRequest.

        A string with a length between [1-128].

        :return: The name of this UpdateAuthorizerRequest.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this UpdateAuthorizerRequest.
