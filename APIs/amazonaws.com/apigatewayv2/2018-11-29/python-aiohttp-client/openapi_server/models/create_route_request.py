...
class CreateRouteRequest(Model):
    ...
    def __init__(self, api_key_required: bool=None, authorization_scopes: List[str]=None, authorization_type: str=None, authorizer_id: str=None, model_selection_expression: str=None, operation_name: str=None, request_models: Dict[str, str]=None, request_parameters: Dict[str, ParameterConstraints]=None, route_key: str=None, route_response_selection_expression: str=None, target: str=None):
        ...
        :param api_key_required: The api_key_required of this CreateRouteRequest.
        :param authorization_scopes: The authorization_scopes of this CreateRouteRequest.
        :param authorization_type: The authorization_type of this CreateRouteRequest.
        :param authorizer_id: The authorizer_id of this CreateRouteRequest.
        :param model_selection_expression: The model_selection_expression of this CreateRouteRequest.
        :param operation_name: The operation_name of this CreateRouteRequest.
        :param request_models: The request_models of this CreateRouteRequest.
        :param request_parameters: The request_parameters of this CreateRouteRequest.
        :param route_key: The route_key of this CreateRouteRequest.
        :param route_response_selection_expression: The route_response_selection_expression of this CreateRouteRequest.
        :param target: The target of this CreateRouteRequest.
        """
        self.openapi_types = {
    ...
    def api_key_required(self):
        """Gets the api_key_required of this CreateRouteRequest.

        Specifies whether an API key is required for the route. Supported only for WebSocket APIs.

        :return: The api_key_required of this CreateRouteRequest.
        :rtype: bool
        """
    ...
    def api_key_required(self, api_key_required):
        """Sets the api_key_required of this CreateRouteRequest.
    ...
    def authorization_scopes(self):
        """Gets the authorization_scopes of this CreateRouteRequest.

        A list of authorization scopes configured on a route. The scopes are used with a JWT authorizer to authorize the method invocation. The authorization works by matching the route scopes against the scopes parsed from the access token in the incoming request. The method invocation is authorized if any route scope matches a claimed scope in the access token. Otherwise, the invocation is not authorized. When the route scope is configured, the client must provide an access token instead of an identity token for authorization purposes.

        :return: The authorization_scopes of this CreateRouteRequest.
        :rtype: List[str]
        """
    ...
    def authorization_scopes(self, authorization_scopes):
        """Sets the authorization_scopes of this CreateRouteRequest.
    ...
    def authorization_type(self):
        """Gets the authorization_type of this CreateRouteRequest.

        The authorization type. For WebSocket APIs, valid values are NONE for open access, AWS_IAM for using AWS IAM permissions, and CUSTOM for using a Lambda authorizer. For HTTP APIs, valid values are NONE for open access, JWT for using JSON Web Tokens, AWS_IAM for using AWS IAM permissions, and CUSTOM for using a Lambda authorizer.

        :return: The authorization_type of this CreateRouteRequest.
        :rtype: str
        """
    ...
    def authorization_type(self, authorization_type):
        """Sets the authorization_type of this CreateRouteRequest.
    ...
    def authorizer_id(self):
        """Gets the authorizer_id of this CreateRouteRequest.

        The identifier.

        :return: The authorizer_id of this CreateRouteRequest.
        :rtype: str
        """
    ...
    def authorizer_id(self, authorizer_id):
        """Sets the authorizer_id of this CreateRouteRequest.
    ...
    def model_selection_expression(self):
        """Gets the model_selection_expression of this CreateRouteRequest.
        ...
        :return: The model_selection_expression of this CreateRouteRequest.
        :rtype: str
        """
    ...
    def model_selection_expression(self, model_selection_expression):
        """Sets the model_selection_expression of this CreateRouteRequest.
    ...
    def operation_name(self):
        """Gets the operation_name of this CreateRouteRequest.

        A string with a length between [1-64].

        :return: The operation_name of this CreateRouteRequest.
        :rtype: str
        """
    ...
    def operation_name(self, operation_name):
        """Sets the operation_name of this CreateRouteRequest.
    ...
    def request_models(self):
        """Gets the request_models of this CreateRouteRequest.

        The route models.

        :return: The request_models of this CreateRouteRequest.
        :rtype: Dict[str, str]
        """
    ...
    def request_models(self, request_models):
        """Sets the request_models of this CreateRouteRequest.
    ...
    def request_parameters(self):
        """Gets the request_parameters of this CreateRouteRequest.

        The route parameters.

        :return: The request_parameters of this CreateRouteRequest.
    ...
    def request_parameters(self, request_parameters):
        """Sets the request_parameters of this CreateRouteRequest.
    ...
    @property
    def route_key(self):
        """Gets the route_key of this CreateRouteRequest.
        ...
        :return: The route_key of this CreateRouteRequest.
        :rtype: str
        """
    ...
    def route_key(self, route_key):
        """Sets the route_key of this CreateRouteRequest.
    ...
    def route_response_selection_expression(self):
        """Gets the route_response_selection_expression of this CreateRouteRequest.

        An expression used to extract information at runtime. See <a href=\"https://docs.aws.amazon.com/apigateway/latest/developerguide/apigateway-websocket-api-selection-expressions.html#apigateway-websocket-api-apikey-selection-expressions\">Selection Expressions</a> for more information.

        :return: The route_response_selection_expression of this CreateRouteRequest.
        :rtype: str
        """
    ...
    def route_response_selection_expression(self, route_response_selection_expression):
        """Sets the route_response_selection_expression of this CreateRouteRequest.
    ...
    @property
    def target(self):
        """Gets the target of this CreateRouteRequest.

        A string with a length between [1-128].

        :return: The target of this CreateRouteRequest.
        :rtype: str
        """
        return self._target
    ...
    def target(self, target):
        """Sets the target of this CreateRouteRequest.
