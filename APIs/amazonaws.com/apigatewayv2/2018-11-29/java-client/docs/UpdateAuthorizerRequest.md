...
|**authorizerResultTtlInSeconds** | **Integer** | An integer with a value between [0-3600]. |  [optional] |
|**authorizerType** | [**AuthorizerTypeEnum**](#AuthorizerTypeEnum) | The authorizer type. Specify REQUEST for a Lambda function using incoming request parameters. Specify JWT to use JSON Web Tokens (supported only for HTTP APIs). |  [optional] |
