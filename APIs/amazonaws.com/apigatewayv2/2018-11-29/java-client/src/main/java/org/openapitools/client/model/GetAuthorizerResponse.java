...
public class GetAuthorizerResponse {
  ...
  public GetAuthorizerResponse authorizerCredentialsArn(String authorizerCredentialsArn) {
  ...
  public GetAuthorizerResponse authorizerId(String authorizerId) {
  ...
  public GetAuthorizerResponse authorizerPayloadFormatVersion(String authorizerPayloadFormatVersion) {
  ...
  public GetAuthorizerResponse authorizerResultTtlInSeconds(Integer authorizerResultTtlInSeconds) {
  ...
  public GetAuthorizerResponse authorizerType(AuthorizerType authorizerType) {
  ...
  public GetAuthorizerResponse authorizerUri(String authorizerUri) {
  ...
  public GetAuthorizerResponse enableSimpleResponses(Boolean enableSimpleResponses) {
  ...
  public GetAuthorizerResponse identitySource(List identitySource) {
  ...
  public GetAuthorizerResponse identityValidationExpression(String identityValidationExpression) {
  ...
  public GetAuthorizerResponse jwtConfiguration(CreateAuthorizerResponseJwtConfiguration jwtConfiguration) {
  ...
  public GetAuthorizerResponse name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetAuthorizerResponse getAuthorizerResponse = (GetAuthorizerResponse) o;
    return Objects.equals(this.authorizerCredentialsArn, getAuthorizerResponse.authorizerCredentialsArn) &&
        Objects.equals(this.authorizerId, getAuthorizerResponse.authorizerId) &&
        Objects.equals(this.authorizerPayloadFormatVersion, getAuthorizerResponse.authorizerPayloadFormatVersion) &&
        Objects.equals(this.authorizerResultTtlInSeconds, getAuthorizerResponse.authorizerResultTtlInSeconds) &&
        Objects.equals(this.authorizerType, getAuthorizerResponse.authorizerType) &&
        Objects.equals(this.authorizerUri, getAuthorizerResponse.authorizerUri) &&
        Objects.equals(this.enableSimpleResponses, getAuthorizerResponse.enableSimpleResponses) &&
        Objects.equals(this.identitySource, getAuthorizerResponse.identitySource) &&
        Objects.equals(this.identityValidationExpression, getAuthorizerResponse.identityValidationExpression) &&
        Objects.equals(this.jwtConfiguration, getAuthorizerResponse.jwtConfiguration) &&
        Objects.equals(this.name, getAuthorizerResponse.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetAuthorizerResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetAuthorizerResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetAuthorizerResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetAuthorizerResponse is not found in the empty JSON string", GetAuthorizerResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetAuthorizerResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetAuthorizerResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetAuthorizerResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetAuthorizerResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetAuthorizerResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetAuthorizerResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GetAuthorizerResponse>() {
           @Override
           public void write(JsonWriter out, GetAuthorizerResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetAuthorizerResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetAuthorizerResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetAuthorizerResponse
   * @throws IOException if the JSON string is invalid with respect to GetAuthorizerResponse
   */
  public static GetAuthorizerResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetAuthorizerResponse.class);
  }

  /**
   * Convert an instance of GetAuthorizerResponse to an JSON string
   *
   * @return JSON string
   */
