...
public class ImportApiResponse {
  ...
  public ImportApiResponse apiEndpoint(String apiEndpoint) {
  ...
  public ImportApiResponse apiGatewayManaged(Boolean apiGatewayManaged) {
  ...
  public ImportApiResponse apiId(String apiId) {
    this.apiId = apiId;
    return this;
  }
  ...
  public ImportApiResponse apiKeySelectionExpression(String apiKeySelectionExpression) {
  ...
  public ImportApiResponse corsConfiguration(CreateApiResponseCorsConfiguration corsConfiguration) {
  ...
  public ImportApiResponse createdDate(OffsetDateTime createdDate) {
  ...
  public ImportApiResponse description(String description) {
  ...
  public ImportApiResponse disableSchemaValidation(Boolean disableSchemaValidation) {
  ...
  public ImportApiResponse disableExecuteApiEndpoint(Boolean disableExecuteApiEndpoint) {
  ...
  public ImportApiResponse importInfo(List importInfo) {
  ...
  public ImportApiResponse name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ImportApiResponse protocolType(ProtocolType protocolType) {
  ...
  public ImportApiResponse routeSelectionExpression(String routeSelectionExpression) {
  ...
  public ImportApiResponse tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public ImportApiResponse version(String version) {
  ...
  public ImportApiResponse warnings(List warnings) {
  ...
  public boolean equals(Object o) {
    ...
    ImportApiResponse importApiResponse = (ImportApiResponse) o;
    return Objects.equals(this.apiEndpoint, importApiResponse.apiEndpoint) &&
        Objects.equals(this.apiGatewayManaged, importApiResponse.apiGatewayManaged) &&
        Objects.equals(this.apiId, importApiResponse.apiId) &&
        Objects.equals(this.apiKeySelectionExpression, importApiResponse.apiKeySelectionExpression) &&
        Objects.equals(this.corsConfiguration, importApiResponse.corsConfiguration) &&
        Objects.equals(this.createdDate, importApiResponse.createdDate) &&
        Objects.equals(this.description, importApiResponse.description) &&
        Objects.equals(this.disableSchemaValidation, importApiResponse.disableSchemaValidation) &&
        Objects.equals(this.disableExecuteApiEndpoint, importApiResponse.disableExecuteApiEndpoint) &&
        Objects.equals(this.importInfo, importApiResponse.importInfo) &&
        Objects.equals(this.name, importApiResponse.name) &&
        Objects.equals(this.protocolType, importApiResponse.protocolType) &&
        Objects.equals(this.routeSelectionExpression, importApiResponse.routeSelectionExpression) &&
        Objects.equals(this.tags, importApiResponse.tags) &&
        Objects.equals(this.version, importApiResponse.version) &&
        Objects.equals(this.warnings, importApiResponse.warnings);
  }
  ...
  public String toString() {
    ...
    sb.append("class ImportApiResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ImportApiResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ImportApiResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImportApiResponse is not found in the empty JSON string", ImportApiResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ImportApiResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ImportApiResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImportApiResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImportApiResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImportApiResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImportApiResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ImportApiResponse>() {
           @Override
           public void write(JsonWriter out, ImportApiResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ImportApiResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ImportApiResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ImportApiResponse
   * @throws IOException if the JSON string is invalid with respect to ImportApiResponse
   */
  public static ImportApiResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImportApiResponse.class);
  }

  /**
   * Convert an instance of ImportApiResponse to an JSON string
   *
   * @return JSON string
   */
