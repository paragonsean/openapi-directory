...
public class CreateVpcLinkResponse {
  ...
  public CreateVpcLinkResponse createdDate(OffsetDateTime createdDate) {
  ...
  public CreateVpcLinkResponse name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateVpcLinkResponse securityGroupIds(List securityGroupIds) {
  ...
  public CreateVpcLinkResponse subnetIds(List subnetIds) {
  ...
  public CreateVpcLinkResponse tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public CreateVpcLinkResponse vpcLinkStatus(VpcLinkStatus vpcLinkStatus) {
  ...
  public CreateVpcLinkResponse vpcLinkStatusMessage(String vpcLinkStatusMessage) {
  ...
  public CreateVpcLinkResponse vpcLinkVersion(VpcLinkVersion vpcLinkVersion) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.createdDate, createVpcLinkResponse.createdDate) &&
        Objects.equals(this.name, createVpcLinkResponse.name) &&
        Objects.equals(this.securityGroupIds, createVpcLinkResponse.securityGroupIds) &&
        Objects.equals(this.subnetIds, createVpcLinkResponse.subnetIds) &&
        Objects.equals(this.tags, createVpcLinkResponse.tags) &&
        Objects.equals(this.vpcLinkId, createVpcLinkResponse.vpcLinkId) &&
        Objects.equals(this.vpcLinkStatus, createVpcLinkResponse.vpcLinkStatus) &&
        Objects.equals(this.vpcLinkStatusMessage, createVpcLinkResponse.vpcLinkStatusMessage) &&
        Objects.equals(this.vpcLinkVersion, createVpcLinkResponse.vpcLinkVersion);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateVpcLinkResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateVpcLinkResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateVpcLinkResponse is not found in the empty JSON string", CreateVpcLinkResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateVpcLinkResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateVpcLinkResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateVpcLinkResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateVpcLinkResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateVpcLinkResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateVpcLinkResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateVpcLinkResponse>() {
           @Override
           public void write(JsonWriter out, CreateVpcLinkResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateVpcLinkResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateVpcLinkResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateVpcLinkResponse
   * @throws IOException if the JSON string is invalid with respect to CreateVpcLinkResponse
   */
  public static CreateVpcLinkResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateVpcLinkResponse.class);
  }

  /**
   * Convert an instance of CreateVpcLinkResponse to an JSON string
   *
   * @return JSON string
   */
