...
public class RouteResponse {
  ...
  public RouteResponse modelSelectionExpression(String modelSelectionExpression) {
  ...
  public RouteResponse responseModels(Map responseModels) {
  ...
  public RouteResponse responseParameters(Map responseParameters) {
  ...
  public RouteResponse routeResponseId(String routeResponseId) {
  ...
  public RouteResponse routeResponseKey(String routeResponseKey) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.modelSelectionExpression, routeResponse.modelSelectionExpression) &&
        Objects.equals(this.responseModels, routeResponse.responseModels) &&
        Objects.equals(this.responseParameters, routeResponse.responseParameters) &&
        Objects.equals(this.routeResponseId, routeResponse.routeResponseId) &&
        Objects.equals(this.routeResponseKey, routeResponse.routeResponseKey);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to RouteResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RouteResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RouteResponse is not found in the empty JSON string", RouteResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RouteResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RouteResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RouteResponse.openapiRequiredFields) {
      ...
      // validate the required field `RouteResponseKey`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RouteResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RouteResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RouteResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RouteResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<RouteResponse>() {
           @Override
           ...
           @Override
           public RouteResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RouteResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RouteResponse
   * @throws IOException if the JSON string is invalid with respect to RouteResponse
   */
  public static RouteResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RouteResponse.class);
  }

  /**
   * Convert an instance of RouteResponse to an JSON string
   *
   * @return JSON string
   */
