...
public class GetIntegrationResult {
  ...
  public GetIntegrationResult apiGatewayManaged(Boolean apiGatewayManaged) {
  ...
  public GetIntegrationResult connectionId(String connectionId) {
  ...
  public GetIntegrationResult connectionType(ConnectionType connectionType) {
  ...
  public GetIntegrationResult contentHandlingStrategy(ContentHandlingStrategy contentHandlingStrategy) {
  ...
  public GetIntegrationResult credentialsArn(String credentialsArn) {
  ...
  public GetIntegrationResult description(String description) {
  ...
  public GetIntegrationResult integrationId(String integrationId) {
  ...
  public GetIntegrationResult integrationMethod(String integrationMethod) {
  ...
  public GetIntegrationResult integrationResponseSelectionExpression(String integrationResponseSelectionExpression) {
  ...
  public GetIntegrationResult integrationSubtype(String integrationSubtype) {
  ...
  public GetIntegrationResult integrationType(IntegrationType integrationType) {
  ...
  public GetIntegrationResult integrationUri(String integrationUri) {
  ...
  public GetIntegrationResult passthroughBehavior(PassthroughBehavior passthroughBehavior) {
  ...
  public GetIntegrationResult payloadFormatVersion(String payloadFormatVersion) {
  ...
  public GetIntegrationResult requestParameters(Map requestParameters) {
  ...
  public GetIntegrationResult requestTemplates(Map requestTemplates) {
  ...
  public GetIntegrationResult responseParameters(Map responseParameters) {
  ...
  public GetIntegrationResult templateSelectionExpression(String templateSelectionExpression) {
  ...
  public GetIntegrationResult timeoutInMillis(Integer timeoutInMillis) {
  ...
  public GetIntegrationResult tlsConfig(CreateIntegrationResultTlsConfig tlsConfig) {
  ...
  public boolean equals(Object o) {
    ...
    GetIntegrationResult getIntegrationResult = (GetIntegrationResult) o;
    return Objects.equals(this.apiGatewayManaged, getIntegrationResult.apiGatewayManaged) &&
        Objects.equals(this.connectionId, getIntegrationResult.connectionId) &&
        Objects.equals(this.connectionType, getIntegrationResult.connectionType) &&
        Objects.equals(this.contentHandlingStrategy, getIntegrationResult.contentHandlingStrategy) &&
        Objects.equals(this.credentialsArn, getIntegrationResult.credentialsArn) &&
        Objects.equals(this.description, getIntegrationResult.description) &&
        Objects.equals(this.integrationId, getIntegrationResult.integrationId) &&
        Objects.equals(this.integrationMethod, getIntegrationResult.integrationMethod) &&
        Objects.equals(this.integrationResponseSelectionExpression, getIntegrationResult.integrationResponseSelectionExpression) &&
        Objects.equals(this.integrationSubtype, getIntegrationResult.integrationSubtype) &&
        Objects.equals(this.integrationType, getIntegrationResult.integrationType) &&
        Objects.equals(this.integrationUri, getIntegrationResult.integrationUri) &&
        Objects.equals(this.passthroughBehavior, getIntegrationResult.passthroughBehavior) &&
        Objects.equals(this.payloadFormatVersion, getIntegrationResult.payloadFormatVersion) &&
        Objects.equals(this.requestParameters, getIntegrationResult.requestParameters) &&
        Objects.equals(this.requestTemplates, getIntegrationResult.requestTemplates) &&
        Objects.equals(this.responseParameters, getIntegrationResult.responseParameters) &&
        Objects.equals(this.templateSelectionExpression, getIntegrationResult.templateSelectionExpression) &&
        Objects.equals(this.timeoutInMillis, getIntegrationResult.timeoutInMillis) &&
        Objects.equals(this.tlsConfig, getIntegrationResult.tlsConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetIntegrationResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetIntegrationResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetIntegrationResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetIntegrationResult is not found in the empty JSON string", GetIntegrationResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetIntegrationResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetIntegrationResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetIntegrationResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetIntegrationResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetIntegrationResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetIntegrationResult.class));

       return (TypeAdapter<T>) new TypeAdapter<GetIntegrationResult>() {
           @Override
           public void write(JsonWriter out, GetIntegrationResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetIntegrationResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetIntegrationResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetIntegrationResult
   * @throws IOException if the JSON string is invalid with respect to GetIntegrationResult
   */
  public static GetIntegrationResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetIntegrationResult.class);
  }

  /**
   * Convert an instance of GetIntegrationResult to an JSON string
   *
   * @return JSON string
   */
