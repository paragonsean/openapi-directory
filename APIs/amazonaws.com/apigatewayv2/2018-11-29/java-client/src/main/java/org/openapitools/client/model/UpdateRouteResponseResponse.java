...
public class UpdateRouteResponseResponse {
  ...
  public UpdateRouteResponseResponse() {
  }

  public UpdateRouteResponseResponse modelSelectionExpression(String modelSelectionExpression) {
  ...
  public UpdateRouteResponseResponse responseModels(Map responseModels) {
  ...
  public UpdateRouteResponseResponse responseParameters(Map responseParameters) {
  ...
  public UpdateRouteResponseResponse routeResponseId(String routeResponseId) {
  ...
  public UpdateRouteResponseResponse routeResponseKey(String routeResponseKey) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateRouteResponseResponse updateRouteResponseResponse = (UpdateRouteResponseResponse) o;
    return Objects.equals(this.modelSelectionExpression, updateRouteResponseResponse.modelSelectionExpression) &&
        Objects.equals(this.responseModels, updateRouteResponseResponse.responseModels) &&
        Objects.equals(this.responseParameters, updateRouteResponseResponse.responseParameters) &&
        Objects.equals(this.routeResponseId, updateRouteResponseResponse.routeResponseId) &&
        Objects.equals(this.routeResponseKey, updateRouteResponseResponse.routeResponseKey);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateRouteResponseResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateRouteResponseResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateRouteResponseResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateRouteResponseResponse is not found in the empty JSON string", UpdateRouteResponseResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateRouteResponseResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateRouteResponseResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateRouteResponseResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateRouteResponseResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateRouteResponseResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateRouteResponseResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateRouteResponseResponse>() {
           @Override
           public void write(JsonWriter out, UpdateRouteResponseResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateRouteResponseResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateRouteResponseResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateRouteResponseResponse
   * @throws IOException if the JSON string is invalid with respect to UpdateRouteResponseResponse
   */
  public static UpdateRouteResponseResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateRouteResponseResponse.class);
  }

  /**
   * Convert an instance of UpdateRouteResponseResponse to an JSON string
   *
   * @return JSON string
   */
