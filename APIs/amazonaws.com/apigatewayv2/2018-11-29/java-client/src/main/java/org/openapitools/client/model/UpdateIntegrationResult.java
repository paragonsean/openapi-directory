...
public class UpdateIntegrationResult {
  ...
  public UpdateIntegrationResult() {
  }

  public UpdateIntegrationResult apiGatewayManaged(Boolean apiGatewayManaged) {
  ...
  public UpdateIntegrationResult connectionId(String connectionId) {
  ...
  public UpdateIntegrationResult connectionType(ConnectionType connectionType) {
  ...
  public UpdateIntegrationResult contentHandlingStrategy(ContentHandlingStrategy contentHandlingStrategy) {
  ...
  public UpdateIntegrationResult credentialsArn(String credentialsArn) {
  ...
  public UpdateIntegrationResult description(String description) {
  ...
  public UpdateIntegrationResult integrationId(String integrationId) {
  ...
  public UpdateIntegrationResult integrationMethod(String integrationMethod) {
  ...
  public UpdateIntegrationResult integrationResponseSelectionExpression(String integrationResponseSelectionExpression) {
  ...
  public UpdateIntegrationResult integrationSubtype(String integrationSubtype) {
  ...
  public UpdateIntegrationResult integrationType(IntegrationType integrationType) {
  ...
  public UpdateIntegrationResult integrationUri(String integrationUri) {
  ...
  public UpdateIntegrationResult passthroughBehavior(PassthroughBehavior passthroughBehavior) {
  ...
  public UpdateIntegrationResult payloadFormatVersion(String payloadFormatVersion) {
  ...
  public UpdateIntegrationResult requestParameters(Map requestParameters) {
  ...
  public UpdateIntegrationResult requestTemplates(Map requestTemplates) {
  ...
  public UpdateIntegrationResult responseParameters(Map responseParameters) {
  ...
  public UpdateIntegrationResult templateSelectionExpression(String templateSelectionExpression) {
  ...
  public UpdateIntegrationResult timeoutInMillis(Integer timeoutInMillis) {
  ...
  public UpdateIntegrationResult tlsConfig(CreateIntegrationResultTlsConfig tlsConfig) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateIntegrationResult updateIntegrationResult = (UpdateIntegrationResult) o;
    return Objects.equals(this.apiGatewayManaged, updateIntegrationResult.apiGatewayManaged) &&
        Objects.equals(this.connectionId, updateIntegrationResult.connectionId) &&
        Objects.equals(this.connectionType, updateIntegrationResult.connectionType) &&
        Objects.equals(this.contentHandlingStrategy, updateIntegrationResult.contentHandlingStrategy) &&
        Objects.equals(this.credentialsArn, updateIntegrationResult.credentialsArn) &&
        Objects.equals(this.description, updateIntegrationResult.description) &&
        Objects.equals(this.integrationId, updateIntegrationResult.integrationId) &&
        Objects.equals(this.integrationMethod, updateIntegrationResult.integrationMethod) &&
        Objects.equals(this.integrationResponseSelectionExpression, updateIntegrationResult.integrationResponseSelectionExpression) &&
        Objects.equals(this.integrationSubtype, updateIntegrationResult.integrationSubtype) &&
        Objects.equals(this.integrationType, updateIntegrationResult.integrationType) &&
        Objects.equals(this.integrationUri, updateIntegrationResult.integrationUri) &&
        Objects.equals(this.passthroughBehavior, updateIntegrationResult.passthroughBehavior) &&
        Objects.equals(this.payloadFormatVersion, updateIntegrationResult.payloadFormatVersion) &&
        Objects.equals(this.requestParameters, updateIntegrationResult.requestParameters) &&
        Objects.equals(this.requestTemplates, updateIntegrationResult.requestTemplates) &&
        Objects.equals(this.responseParameters, updateIntegrationResult.responseParameters) &&
        Objects.equals(this.templateSelectionExpression, updateIntegrationResult.templateSelectionExpression) &&
        Objects.equals(this.timeoutInMillis, updateIntegrationResult.timeoutInMillis) &&
        Objects.equals(this.tlsConfig, updateIntegrationResult.tlsConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateIntegrationResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateIntegrationResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateIntegrationResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateIntegrationResult is not found in the empty JSON string", UpdateIntegrationResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateIntegrationResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateIntegrationResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateIntegrationResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateIntegrationResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateIntegrationResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateIntegrationResult.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateIntegrationResult>() {
           @Override
           public void write(JsonWriter out, UpdateIntegrationResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateIntegrationResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateIntegrationResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateIntegrationResult
   * @throws IOException if the JSON string is invalid with respect to UpdateIntegrationResult
   */
  public static UpdateIntegrationResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateIntegrationResult.class);
  }

  /**
   * Convert an instance of UpdateIntegrationResult to an JSON string
   *
   * @return JSON string
   */
