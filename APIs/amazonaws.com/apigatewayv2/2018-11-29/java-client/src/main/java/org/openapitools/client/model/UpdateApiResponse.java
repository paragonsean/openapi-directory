...
public class UpdateApiResponse {
  ...
  public UpdateApiResponse apiEndpoint(String apiEndpoint) {
  ...
  public UpdateApiResponse apiGatewayManaged(Boolean apiGatewayManaged) {
  ...
  public UpdateApiResponse apiId(String apiId) {
    this.apiId = apiId;
    return this;
  }
  ...
  public UpdateApiResponse apiKeySelectionExpression(String apiKeySelectionExpression) {
  ...
  public UpdateApiResponse corsConfiguration(CreateApiResponseCorsConfiguration corsConfiguration) {
  ...
  public UpdateApiResponse createdDate(OffsetDateTime createdDate) {
  ...
  public UpdateApiResponse description(String description) {
  ...
  public UpdateApiResponse disableSchemaValidation(Boolean disableSchemaValidation) {
  ...
  public UpdateApiResponse disableExecuteApiEndpoint(Boolean disableExecuteApiEndpoint) {
  ...
  public UpdateApiResponse importInfo(List importInfo) {
  ...
  public UpdateApiResponse name(String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateApiResponse protocolType(ProtocolType protocolType) {
  ...
  public UpdateApiResponse routeSelectionExpression(String routeSelectionExpression) {
  ...
  public UpdateApiResponse tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public UpdateApiResponse version(String version) {
  ...
  public UpdateApiResponse warnings(List warnings) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateApiResponse updateApiResponse = (UpdateApiResponse) o;
    return Objects.equals(this.apiEndpoint, updateApiResponse.apiEndpoint) &&
        Objects.equals(this.apiGatewayManaged, updateApiResponse.apiGatewayManaged) &&
        Objects.equals(this.apiId, updateApiResponse.apiId) &&
        Objects.equals(this.apiKeySelectionExpression, updateApiResponse.apiKeySelectionExpression) &&
        Objects.equals(this.corsConfiguration, updateApiResponse.corsConfiguration) &&
        Objects.equals(this.createdDate, updateApiResponse.createdDate) &&
        Objects.equals(this.description, updateApiResponse.description) &&
        Objects.equals(this.disableSchemaValidation, updateApiResponse.disableSchemaValidation) &&
        Objects.equals(this.disableExecuteApiEndpoint, updateApiResponse.disableExecuteApiEndpoint) &&
        Objects.equals(this.importInfo, updateApiResponse.importInfo) &&
        Objects.equals(this.name, updateApiResponse.name) &&
        Objects.equals(this.protocolType, updateApiResponse.protocolType) &&
        Objects.equals(this.routeSelectionExpression, updateApiResponse.routeSelectionExpression) &&
        Objects.equals(this.tags, updateApiResponse.tags) &&
        Objects.equals(this.version, updateApiResponse.version) &&
        Objects.equals(this.warnings, updateApiResponse.warnings);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateApiResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateApiResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateApiResponse is not found in the empty JSON string", UpdateApiResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateApiResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateApiResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateApiResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateApiResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateApiResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateApiResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateApiResponse>() {
           @Override
           public void write(JsonWriter out, UpdateApiResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateApiResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateApiResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateApiResponse
   * @throws IOException if the JSON string is invalid with respect to UpdateApiResponse
   */
  public static UpdateApiResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateApiResponse.class);
  }

  /**
   * Convert an instance of UpdateApiResponse to an JSON string
   *
   * @return JSON string
   */
