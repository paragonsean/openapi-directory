...
public class UpdateRouteResult {
  ...
  public UpdateRouteResult apiGatewayManaged(Boolean apiGatewayManaged) {
  ...
  public UpdateRouteResult apiKeyRequired(Boolean apiKeyRequired) {
  ...
  public UpdateRouteResult authorizationScopes(List authorizationScopes) {
  ...
  public UpdateRouteResult authorizationType(AuthorizationType authorizationType) {
  ...
  public UpdateRouteResult authorizerId(String authorizerId) {
  ...
  public UpdateRouteResult modelSelectionExpression(String modelSelectionExpression) {
  ...
  public UpdateRouteResult operationName(String operationName) {
  ...
  public UpdateRouteResult requestModels(Map requestModels) {
  ...
  public UpdateRouteResult requestParameters(Map requestParameters) {
  ...
  public UpdateRouteResult routeId(String routeId) {
  ...
  public UpdateRouteResult routeKey(String routeKey) {
  ...
  public UpdateRouteResult routeResponseSelectionExpression(String routeResponseSelectionExpression) {
  ...
  public UpdateRouteResult target(String target) {
    this.target = target;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateRouteResult updateRouteResult = (UpdateRouteResult) o;
    return Objects.equals(this.apiGatewayManaged, updateRouteResult.apiGatewayManaged) &&
        Objects.equals(this.apiKeyRequired, updateRouteResult.apiKeyRequired) &&
        Objects.equals(this.authorizationScopes, updateRouteResult.authorizationScopes) &&
        Objects.equals(this.authorizationType, updateRouteResult.authorizationType) &&
        Objects.equals(this.authorizerId, updateRouteResult.authorizerId) &&
        Objects.equals(this.modelSelectionExpression, updateRouteResult.modelSelectionExpression) &&
        Objects.equals(this.operationName, updateRouteResult.operationName) &&
        Objects.equals(this.requestModels, updateRouteResult.requestModels) &&
        Objects.equals(this.requestParameters, updateRouteResult.requestParameters) &&
        Objects.equals(this.routeId, updateRouteResult.routeId) &&
        Objects.equals(this.routeKey, updateRouteResult.routeKey) &&
        Objects.equals(this.routeResponseSelectionExpression, updateRouteResult.routeResponseSelectionExpression) &&
        Objects.equals(this.target, updateRouteResult.target);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateRouteResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateRouteResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateRouteResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateRouteResult is not found in the empty JSON string", UpdateRouteResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateRouteResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateRouteResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateRouteResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateRouteResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateRouteResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateRouteResult.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateRouteResult>() {
           @Override
           public void write(JsonWriter out, UpdateRouteResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateRouteResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateRouteResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateRouteResult
   * @throws IOException if the JSON string is invalid with respect to UpdateRouteResult
   */
  public static UpdateRouteResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateRouteResult.class);
  }

  /**
   * Convert an instance of UpdateRouteResult to an JSON string
   *
   * @return JSON string
   */
