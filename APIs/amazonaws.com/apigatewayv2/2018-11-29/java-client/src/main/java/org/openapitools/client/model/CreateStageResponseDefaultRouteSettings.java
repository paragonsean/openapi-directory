...
public class CreateStageResponseDefaultRouteSettings {
  ...
  public CreateStageResponseDefaultRouteSettings dataTraceEnabled(Boolean dataTraceEnabled) {
  ...
  public CreateStageResponseDefaultRouteSettings detailedMetricsEnabled(Boolean detailedMetricsEnabled) {
  ...
  public CreateStageResponseDefaultRouteSettings loggingLevel(LoggingLevel loggingLevel) {
  ...
  public CreateStageResponseDefaultRouteSettings throttlingBurstLimit(Integer throttlingBurstLimit) {
  ...
  public CreateStageResponseDefaultRouteSettings throttlingRateLimit(Double throttlingRateLimit) {
  ...
  public boolean equals(Object o) {
    ...
    CreateStageResponseDefaultRouteSettings createStageResponseDefaultRouteSettings = (CreateStageResponseDefaultRouteSettings) o;
    return Objects.equals(this.dataTraceEnabled, createStageResponseDefaultRouteSettings.dataTraceEnabled) &&
        Objects.equals(this.detailedMetricsEnabled, createStageResponseDefaultRouteSettings.detailedMetricsEnabled) &&
        Objects.equals(this.loggingLevel, createStageResponseDefaultRouteSettings.loggingLevel) &&
        Objects.equals(this.throttlingBurstLimit, createStageResponseDefaultRouteSettings.throttlingBurstLimit) &&
        Objects.equals(this.throttlingRateLimit, createStageResponseDefaultRouteSettings.throttlingRateLimit);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateStageResponseDefaultRouteSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateStageResponseDefaultRouteSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateStageResponseDefaultRouteSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateStageResponseDefaultRouteSettings is not found in the empty JSON string", CreateStageResponseDefaultRouteSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateStageResponseDefaultRouteSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateStageResponseDefaultRouteSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateStageResponseDefaultRouteSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateStageResponseDefaultRouteSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateStageResponseDefaultRouteSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateStageResponseDefaultRouteSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateStageResponseDefaultRouteSettings>() {
           @Override
           public void write(JsonWriter out, CreateStageResponseDefaultRouteSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateStageResponseDefaultRouteSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateStageResponseDefaultRouteSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateStageResponseDefaultRouteSettings
   * @throws IOException if the JSON string is invalid with respect to CreateStageResponseDefaultRouteSettings
   */
  public static CreateStageResponseDefaultRouteSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateStageResponseDefaultRouteSettings.class);
  }

  /**
   * Convert an instance of CreateStageResponseDefaultRouteSettings to an JSON string
   *
   * @return JSON string
   */
