...
public class GetRouteResult {
  ...
  public GetRouteResult apiGatewayManaged(Boolean apiGatewayManaged) {
  ...
  public GetRouteResult apiKeyRequired(Boolean apiKeyRequired) {
  ...
  public GetRouteResult authorizationScopes(List authorizationScopes) {
  ...
  public GetRouteResult authorizationType(AuthorizationType authorizationType) {
  ...
  public GetRouteResult authorizerId(String authorizerId) {
  ...
  public GetRouteResult modelSelectionExpression(String modelSelectionExpression) {
  ...
  public GetRouteResult operationName(String operationName) {
  ...
  public GetRouteResult requestModels(Map requestModels) {
  ...
  public GetRouteResult requestParameters(Map requestParameters) {
  ...
  public GetRouteResult routeId(String routeId) {
  ...
  public GetRouteResult routeKey(String routeKey) {
  ...
  public GetRouteResult routeResponseSelectionExpression(String routeResponseSelectionExpression) {
  ...
  public GetRouteResult target(String target) {
    this.target = target;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetRouteResult getRouteResult = (GetRouteResult) o;
    return Objects.equals(this.apiGatewayManaged, getRouteResult.apiGatewayManaged) &&
        Objects.equals(this.apiKeyRequired, getRouteResult.apiKeyRequired) &&
        Objects.equals(this.authorizationScopes, getRouteResult.authorizationScopes) &&
        Objects.equals(this.authorizationType, getRouteResult.authorizationType) &&
        Objects.equals(this.authorizerId, getRouteResult.authorizerId) &&
        Objects.equals(this.modelSelectionExpression, getRouteResult.modelSelectionExpression) &&
        Objects.equals(this.operationName, getRouteResult.operationName) &&
        Objects.equals(this.requestModels, getRouteResult.requestModels) &&
        Objects.equals(this.requestParameters, getRouteResult.requestParameters) &&
        Objects.equals(this.routeId, getRouteResult.routeId) &&
        Objects.equals(this.routeKey, getRouteResult.routeKey) &&
        Objects.equals(this.routeResponseSelectionExpression, getRouteResult.routeResponseSelectionExpression) &&
        Objects.equals(this.target, getRouteResult.target);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetRouteResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetRouteResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetRouteResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetRouteResult is not found in the empty JSON string", GetRouteResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetRouteResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetRouteResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetRouteResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetRouteResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetRouteResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetRouteResult.class));

       return (TypeAdapter<T>) new TypeAdapter<GetRouteResult>() {
           @Override
           public void write(JsonWriter out, GetRouteResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetRouteResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetRouteResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetRouteResult
   * @throws IOException if the JSON string is invalid with respect to GetRouteResult
   */
  public static GetRouteResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetRouteResult.class);
  }

  /**
   * Convert an instance of GetRouteResult to an JSON string
   *
   * @return JSON string
   */
