...
public class UpdateStageResponse {
  ...
  public UpdateStageResponse accessLogSettings(CreateStageResponseAccessLogSettings accessLogSettings) {
  ...
  public UpdateStageResponse apiGatewayManaged(Boolean apiGatewayManaged) {
  ...
  public UpdateStageResponse autoDeploy(Boolean autoDeploy) {
  ...
  public UpdateStageResponse clientCertificateId(String clientCertificateId) {
  ...
  public UpdateStageResponse createdDate(OffsetDateTime createdDate) {
  ...
  public UpdateStageResponse defaultRouteSettings(CreateStageResponseDefaultRouteSettings defaultRouteSettings) {
  ...
  public UpdateStageResponse deploymentId(String deploymentId) {
  ...
  public UpdateStageResponse description(String description) {
  ...
  public UpdateStageResponse lastDeploymentStatusMessage(String lastDeploymentStatusMessage) {
  ...
  public UpdateStageResponse lastUpdatedDate(OffsetDateTime lastUpdatedDate) {
  ...
  public UpdateStageResponse routeSettings(Map routeSettings) {
  ...
  public UpdateStageResponse stageName(String stageName) {
  ...
  public UpdateStageResponse stageVariables(Map stageVariables) {
  ...
  public UpdateStageResponse tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateStageResponse updateStageResponse = (UpdateStageResponse) o;
    return Objects.equals(this.accessLogSettings, updateStageResponse.accessLogSettings) &&
        Objects.equals(this.apiGatewayManaged, updateStageResponse.apiGatewayManaged) &&
        Objects.equals(this.autoDeploy, updateStageResponse.autoDeploy) &&
        Objects.equals(this.clientCertificateId, updateStageResponse.clientCertificateId) &&
        Objects.equals(this.createdDate, updateStageResponse.createdDate) &&
        Objects.equals(this.defaultRouteSettings, updateStageResponse.defaultRouteSettings) &&
        Objects.equals(this.deploymentId, updateStageResponse.deploymentId) &&
        Objects.equals(this.description, updateStageResponse.description) &&
        Objects.equals(this.lastDeploymentStatusMessage, updateStageResponse.lastDeploymentStatusMessage) &&
        Objects.equals(this.lastUpdatedDate, updateStageResponse.lastUpdatedDate) &&
        Objects.equals(this.routeSettings, updateStageResponse.routeSettings) &&
        Objects.equals(this.stageName, updateStageResponse.stageName) &&
        Objects.equals(this.stageVariables, updateStageResponse.stageVariables) &&
        Objects.equals(this.tags, updateStageResponse.tags);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateStageResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateStageResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateStageResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateStageResponse is not found in the empty JSON string", UpdateStageResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateStageResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateStageResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateStageResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateStageResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateStageResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateStageResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateStageResponse>() {
           @Override
           public void write(JsonWriter out, UpdateStageResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateStageResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateStageResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateStageResponse
   * @throws IOException if the JSON string is invalid with respect to UpdateStageResponse
   */
  public static UpdateStageResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateStageResponse.class);
  }

  /**
   * Convert an instance of UpdateStageResponse to an JSON string
   *
   * @return JSON string
   */
