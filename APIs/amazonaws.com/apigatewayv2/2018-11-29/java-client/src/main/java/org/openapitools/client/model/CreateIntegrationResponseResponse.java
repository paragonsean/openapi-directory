...
public class CreateIntegrationResponseResponse {
  ...
  public CreateIntegrationResponseResponse contentHandlingStrategy(ContentHandlingStrategy contentHandlingStrategy) {
  ...
  public CreateIntegrationResponseResponse integrationResponseId(String integrationResponseId) {
  ...
  public CreateIntegrationResponseResponse integrationResponseKey(String integrationResponseKey) {
  ...
  public CreateIntegrationResponseResponse responseParameters(Map responseParameters) {
  ...
  public CreateIntegrationResponseResponse responseTemplates(Map responseTemplates) {
  ...
  public CreateIntegrationResponseResponse templateSelectionExpression(String templateSelectionExpression) {
  ...
  public boolean equals(Object o) {
    ...
    CreateIntegrationResponseResponse createIntegrationResponseResponse = (CreateIntegrationResponseResponse) o;
    return Objects.equals(this.contentHandlingStrategy, createIntegrationResponseResponse.contentHandlingStrategy) &&
        Objects.equals(this.integrationResponseId, createIntegrationResponseResponse.integrationResponseId) &&
        Objects.equals(this.integrationResponseKey, createIntegrationResponseResponse.integrationResponseKey) &&
        Objects.equals(this.responseParameters, createIntegrationResponseResponse.responseParameters) &&
        Objects.equals(this.responseTemplates, createIntegrationResponseResponse.responseTemplates) &&
        Objects.equals(this.templateSelectionExpression, createIntegrationResponseResponse.templateSelectionExpression);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateIntegrationResponseResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateIntegrationResponseResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateIntegrationResponseResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateIntegrationResponseResponse is not found in the empty JSON string", CreateIntegrationResponseResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateIntegrationResponseResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateIntegrationResponseResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateIntegrationResponseResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateIntegrationResponseResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateIntegrationResponseResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateIntegrationResponseResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateIntegrationResponseResponse>() {
           @Override
           public void write(JsonWriter out, CreateIntegrationResponseResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateIntegrationResponseResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateIntegrationResponseResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateIntegrationResponseResponse
   * @throws IOException if the JSON string is invalid with respect to CreateIntegrationResponseResponse
   */
  public static CreateIntegrationResponseResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateIntegrationResponseResponse.class);
  }

  /**
   * Convert an instance of CreateIntegrationResponseResponse to an JSON string
   *
   * @return JSON string
   */
