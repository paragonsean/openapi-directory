...
public class UpdateDeploymentResponse {
  ...
  public UpdateDeploymentResponse autoDeployed(Boolean autoDeployed) {
  ...
  public UpdateDeploymentResponse createdDate(OffsetDateTime createdDate) {
  ...
  public UpdateDeploymentResponse deploymentStatus(DeploymentStatus deploymentStatus) {
  ...
  public UpdateDeploymentResponse deploymentStatusMessage(String deploymentStatusMessage) {
  ...
  public UpdateDeploymentResponse description(String description) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.autoDeployed, updateDeploymentResponse.autoDeployed) &&
        Objects.equals(this.createdDate, updateDeploymentResponse.createdDate) &&
        Objects.equals(this.deploymentId, updateDeploymentResponse.deploymentId) &&
        Objects.equals(this.deploymentStatus, updateDeploymentResponse.deploymentStatus) &&
        Objects.equals(this.deploymentStatusMessage, updateDeploymentResponse.deploymentStatusMessage) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateDeploymentResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateDeploymentResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateDeploymentResponse is not found in the empty JSON string", UpdateDeploymentResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateDeploymentResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateDeploymentResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateDeploymentResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateDeploymentResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateDeploymentResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateDeploymentResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateDeploymentResponse>() {
           @Override
           public void write(JsonWriter out, UpdateDeploymentResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateDeploymentResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateDeploymentResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateDeploymentResponse
   * @throws IOException if the JSON string is invalid with respect to UpdateDeploymentResponse
   */
  public static UpdateDeploymentResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateDeploymentResponse.class);
  }

  /**
   * Convert an instance of UpdateDeploymentResponse to an JSON string
   *
   * @return JSON string
   */
