...
public class CreateIntegrationResponseRequest {
  ...
  public CreateIntegrationResponseRequest() {
  }

  public CreateIntegrationResponseRequest contentHandlingStrategy(ContentHandlingStrategyEnum contentHandlingStrategy) {
  ...
  public CreateIntegrationResponseRequest integrationResponseKey(String integrationResponseKey) {
  ...
  public CreateIntegrationResponseRequest responseParameters(Map<String, String> responseParameters) {
    this.responseParameters = responseParameters;
    return this;
  }

  public CreateIntegrationResponseRequest putResponseParametersItem(String key, String responseParametersItem) {
  ...
  public CreateIntegrationResponseRequest responseTemplates(Map<String, String> responseTemplates) {
    this.responseTemplates = responseTemplates;
    return this;
  }

  public CreateIntegrationResponseRequest putResponseTemplatesItem(String key, String responseTemplatesItem) {
  ...
  public CreateIntegrationResponseRequest templateSelectionExpression(String templateSelectionExpression) {
  ...
  public boolean equals(Object o) {
    ...
    CreateIntegrationResponseRequest createIntegrationResponseRequest = (CreateIntegrationResponseRequest) o;
    return Objects.equals(this.contentHandlingStrategy, createIntegrationResponseRequest.contentHandlingStrategy) &&
        Objects.equals(this.integrationResponseKey, createIntegrationResponseRequest.integrationResponseKey) &&
        Objects.equals(this.responseParameters, createIntegrationResponseRequest.responseParameters) &&
        Objects.equals(this.responseTemplates, createIntegrationResponseRequest.responseTemplates) &&
        Objects.equals(this.templateSelectionExpression, createIntegrationResponseRequest.templateSelectionExpression);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateIntegrationResponseRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateIntegrationResponseRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateIntegrationResponseRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateIntegrationResponseRequest is not found in the empty JSON string", CreateIntegrationResponseRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateIntegrationResponseRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateIntegrationResponseRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateIntegrationResponseRequest.openapiRequiredFields) {
      ...
      if (!jsonObj.get("integrationResponseKey").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateIntegrationResponseRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateIntegrationResponseRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateIntegrationResponseRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateIntegrationResponseRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateIntegrationResponseRequest>() {
           @Override
           public void write(JsonWriter out, CreateIntegrationResponseRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateIntegrationResponseRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateIntegrationResponseRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateIntegrationResponseRequest
   * @throws IOException if the JSON string is invalid with respect to CreateIntegrationResponseRequest
   */
  public static CreateIntegrationResponseRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateIntegrationResponseRequest.class);
  }

  /**
   * Convert an instance of CreateIntegrationResponseRequest to an JSON string
   *
   * @return JSON string
   */
