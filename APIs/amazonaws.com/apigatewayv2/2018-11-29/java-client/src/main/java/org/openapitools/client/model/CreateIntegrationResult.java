...
public class CreateIntegrationResult {
  ...
  public CreateIntegrationResult apiGatewayManaged(Boolean apiGatewayManaged) {
  ...
  public CreateIntegrationResult connectionId(String connectionId) {
  ...
  public CreateIntegrationResult connectionType(ConnectionType connectionType) {
  ...
  public CreateIntegrationResult contentHandlingStrategy(ContentHandlingStrategy contentHandlingStrategy) {
  ...
  public CreateIntegrationResult credentialsArn(String credentialsArn) {
  ...
  public CreateIntegrationResult description(String description) {
  ...
  public CreateIntegrationResult integrationId(String integrationId) {
  ...
  public CreateIntegrationResult integrationMethod(String integrationMethod) {
  ...
  public CreateIntegrationResult integrationResponseSelectionExpression(String integrationResponseSelectionExpression) {
  ...
  public CreateIntegrationResult integrationSubtype(String integrationSubtype) {
  ...
  public CreateIntegrationResult integrationType(IntegrationType integrationType) {
  ...
  public CreateIntegrationResult integrationUri(String integrationUri) {
  ...
  public CreateIntegrationResult passthroughBehavior(PassthroughBehavior passthroughBehavior) {
  ...
  public CreateIntegrationResult payloadFormatVersion(String payloadFormatVersion) {
  ...
  public CreateIntegrationResult requestParameters(Map requestParameters) {
  ...
  public CreateIntegrationResult requestTemplates(Map requestTemplates) {
  ...
  public CreateIntegrationResult responseParameters(Map responseParameters) {
  ...
  public CreateIntegrationResult templateSelectionExpression(String templateSelectionExpression) {
  ...
  public CreateIntegrationResult timeoutInMillis(Integer timeoutInMillis) {
  ...
  public CreateIntegrationResult tlsConfig(CreateIntegrationResultTlsConfig tlsConfig) {
  ...
  public boolean equals(Object o) {
    ...
    CreateIntegrationResult createIntegrationResult = (CreateIntegrationResult) o;
    return Objects.equals(this.apiGatewayManaged, createIntegrationResult.apiGatewayManaged) &&
        Objects.equals(this.connectionId, createIntegrationResult.connectionId) &&
        Objects.equals(this.connectionType, createIntegrationResult.connectionType) &&
        Objects.equals(this.contentHandlingStrategy, createIntegrationResult.contentHandlingStrategy) &&
        Objects.equals(this.credentialsArn, createIntegrationResult.credentialsArn) &&
        Objects.equals(this.description, createIntegrationResult.description) &&
        Objects.equals(this.integrationId, createIntegrationResult.integrationId) &&
        Objects.equals(this.integrationMethod, createIntegrationResult.integrationMethod) &&
        Objects.equals(this.integrationResponseSelectionExpression, createIntegrationResult.integrationResponseSelectionExpression) &&
        Objects.equals(this.integrationSubtype, createIntegrationResult.integrationSubtype) &&
        Objects.equals(this.integrationType, createIntegrationResult.integrationType) &&
        Objects.equals(this.integrationUri, createIntegrationResult.integrationUri) &&
        Objects.equals(this.passthroughBehavior, createIntegrationResult.passthroughBehavior) &&
        Objects.equals(this.payloadFormatVersion, createIntegrationResult.payloadFormatVersion) &&
        Objects.equals(this.requestParameters, createIntegrationResult.requestParameters) &&
        Objects.equals(this.requestTemplates, createIntegrationResult.requestTemplates) &&
        Objects.equals(this.responseParameters, createIntegrationResult.responseParameters) &&
        Objects.equals(this.templateSelectionExpression, createIntegrationResult.templateSelectionExpression) &&
        Objects.equals(this.timeoutInMillis, createIntegrationResult.timeoutInMillis) &&
        Objects.equals(this.tlsConfig, createIntegrationResult.tlsConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateIntegrationResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateIntegrationResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateIntegrationResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateIntegrationResult is not found in the empty JSON string", CreateIntegrationResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateIntegrationResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateIntegrationResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateIntegrationResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateIntegrationResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateIntegrationResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateIntegrationResult.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateIntegrationResult>() {
           @Override
           public void write(JsonWriter out, CreateIntegrationResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateIntegrationResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateIntegrationResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateIntegrationResult
   * @throws IOException if the JSON string is invalid with respect to CreateIntegrationResult
   */
  public static CreateIntegrationResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateIntegrationResult.class);
  }

  /**
   * Convert an instance of CreateIntegrationResult to an JSON string
   *
   * @return JSON string
   */
