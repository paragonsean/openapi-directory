...
public class UpdateAuthorizerResponse {
  ...
  public UpdateAuthorizerResponse authorizerCredentialsArn(String authorizerCredentialsArn) {
  ...
  public UpdateAuthorizerResponse authorizerId(String authorizerId) {
  ...
  public UpdateAuthorizerResponse authorizerPayloadFormatVersion(String authorizerPayloadFormatVersion) {
  ...
  public UpdateAuthorizerResponse authorizerResultTtlInSeconds(Integer authorizerResultTtlInSeconds) {
  ...
  public UpdateAuthorizerResponse authorizerType(AuthorizerType authorizerType) {
  ...
  public UpdateAuthorizerResponse authorizerUri(String authorizerUri) {
  ...
  public UpdateAuthorizerResponse enableSimpleResponses(Boolean enableSimpleResponses) {
  ...
  public UpdateAuthorizerResponse identitySource(List identitySource) {
  ...
  public UpdateAuthorizerResponse identityValidationExpression(String identityValidationExpression) {
  ...
  public UpdateAuthorizerResponse jwtConfiguration(CreateAuthorizerResponseJwtConfiguration jwtConfiguration) {
  ...
  public UpdateAuthorizerResponse name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateAuthorizerResponse updateAuthorizerResponse = (UpdateAuthorizerResponse) o;
    return Objects.equals(this.authorizerCredentialsArn, updateAuthorizerResponse.authorizerCredentialsArn) &&
        Objects.equals(this.authorizerId, updateAuthorizerResponse.authorizerId) &&
        Objects.equals(this.authorizerPayloadFormatVersion, updateAuthorizerResponse.authorizerPayloadFormatVersion) &&
        Objects.equals(this.authorizerResultTtlInSeconds, updateAuthorizerResponse.authorizerResultTtlInSeconds) &&
        Objects.equals(this.authorizerType, updateAuthorizerResponse.authorizerType) &&
        Objects.equals(this.authorizerUri, updateAuthorizerResponse.authorizerUri) &&
        Objects.equals(this.enableSimpleResponses, updateAuthorizerResponse.enableSimpleResponses) &&
        Objects.equals(this.identitySource, updateAuthorizerResponse.identitySource) &&
        Objects.equals(this.identityValidationExpression, updateAuthorizerResponse.identityValidationExpression) &&
        Objects.equals(this.jwtConfiguration, updateAuthorizerResponse.jwtConfiguration) &&
        Objects.equals(this.name, updateAuthorizerResponse.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateAuthorizerResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateAuthorizerResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateAuthorizerResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateAuthorizerResponse is not found in the empty JSON string", UpdateAuthorizerResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateAuthorizerResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateAuthorizerResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateAuthorizerResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateAuthorizerResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateAuthorizerResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateAuthorizerResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateAuthorizerResponse>() {
           @Override
           public void write(JsonWriter out, UpdateAuthorizerResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateAuthorizerResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateAuthorizerResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateAuthorizerResponse
   * @throws IOException if the JSON string is invalid with respect to UpdateAuthorizerResponse
   */
  public static UpdateAuthorizerResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateAuthorizerResponse.class);
  }

  /**
   * Convert an instance of UpdateAuthorizerResponse to an JSON string
   *
   * @return JSON string
   */
