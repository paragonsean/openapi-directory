...
public class GetApiResponse {
  ...
  public GetApiResponse apiEndpoint(String apiEndpoint) {
  ...
  public GetApiResponse apiGatewayManaged(Boolean apiGatewayManaged) {
  ...
  public GetApiResponse apiId(String apiId) {
    this.apiId = apiId;
    return this;
  }
  ...
  public GetApiResponse apiKeySelectionExpression(String apiKeySelectionExpression) {
  ...
  public GetApiResponse corsConfiguration(CreateApiResponseCorsConfiguration corsConfiguration) {
  ...
  public GetApiResponse createdDate(OffsetDateTime createdDate) {
  ...
  public GetApiResponse description(String description) {
  ...
  public GetApiResponse disableSchemaValidation(Boolean disableSchemaValidation) {
  ...
  public GetApiResponse disableExecuteApiEndpoint(Boolean disableExecuteApiEndpoint) {
  ...
  public GetApiResponse importInfo(List importInfo) {
  ...
  public GetApiResponse name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GetApiResponse protocolType(ProtocolType protocolType) {
  ...
  public GetApiResponse routeSelectionExpression(String routeSelectionExpression) {
  ...
  public GetApiResponse tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public GetApiResponse version(String version) {
  ...
  public GetApiResponse warnings(List warnings) {
  ...
  public boolean equals(Object o) {
    ...
    GetApiResponse getApiResponse = (GetApiResponse) o;
    return Objects.equals(this.apiEndpoint, getApiResponse.apiEndpoint) &&
        Objects.equals(this.apiGatewayManaged, getApiResponse.apiGatewayManaged) &&
        Objects.equals(this.apiId, getApiResponse.apiId) &&
        Objects.equals(this.apiKeySelectionExpression, getApiResponse.apiKeySelectionExpression) &&
        Objects.equals(this.corsConfiguration, getApiResponse.corsConfiguration) &&
        Objects.equals(this.createdDate, getApiResponse.createdDate) &&
        Objects.equals(this.description, getApiResponse.description) &&
        Objects.equals(this.disableSchemaValidation, getApiResponse.disableSchemaValidation) &&
        Objects.equals(this.disableExecuteApiEndpoint, getApiResponse.disableExecuteApiEndpoint) &&
        Objects.equals(this.importInfo, getApiResponse.importInfo) &&
        Objects.equals(this.name, getApiResponse.name) &&
        Objects.equals(this.protocolType, getApiResponse.protocolType) &&
        Objects.equals(this.routeSelectionExpression, getApiResponse.routeSelectionExpression) &&
        Objects.equals(this.tags, getApiResponse.tags) &&
        Objects.equals(this.version, getApiResponse.version) &&
        Objects.equals(this.warnings, getApiResponse.warnings);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetApiResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetApiResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetApiResponse is not found in the empty JSON string", GetApiResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetApiResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetApiResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetApiResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetApiResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetApiResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetApiResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GetApiResponse>() {
           @Override
           public void write(JsonWriter out, GetApiResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetApiResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetApiResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetApiResponse
   * @throws IOException if the JSON string is invalid with respect to GetApiResponse
   */
  public static GetApiResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetApiResponse.class);
  }

  /**
   * Convert an instance of GetApiResponse to an JSON string
   *
   * @return JSON string
   */
