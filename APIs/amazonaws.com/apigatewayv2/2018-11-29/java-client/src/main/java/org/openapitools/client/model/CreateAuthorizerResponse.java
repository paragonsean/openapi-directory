...
public class CreateAuthorizerResponse {
  ...
  public CreateAuthorizerResponse authorizerCredentialsArn(String authorizerCredentialsArn) {
  ...
  public CreateAuthorizerResponse authorizerId(String authorizerId) {
  ...
  public CreateAuthorizerResponse authorizerPayloadFormatVersion(String authorizerPayloadFormatVersion) {
  ...
  public CreateAuthorizerResponse authorizerResultTtlInSeconds(Integer authorizerResultTtlInSeconds) {
  ...
  public CreateAuthorizerResponse authorizerType(AuthorizerType authorizerType) {
  ...
  public CreateAuthorizerResponse authorizerUri(String authorizerUri) {
  ...
  public CreateAuthorizerResponse enableSimpleResponses(Boolean enableSimpleResponses) {
  ...
  public CreateAuthorizerResponse identitySource(List identitySource) {
  ...
  public CreateAuthorizerResponse identityValidationExpression(String identityValidationExpression) {
  ...
  public CreateAuthorizerResponse jwtConfiguration(CreateAuthorizerResponseJwtConfiguration jwtConfiguration) {
  ...
  public CreateAuthorizerResponse name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateAuthorizerResponse createAuthorizerResponse = (CreateAuthorizerResponse) o;
    return Objects.equals(this.authorizerCredentialsArn, createAuthorizerResponse.authorizerCredentialsArn) &&
        Objects.equals(this.authorizerId, createAuthorizerResponse.authorizerId) &&
        Objects.equals(this.authorizerPayloadFormatVersion, createAuthorizerResponse.authorizerPayloadFormatVersion) &&
        Objects.equals(this.authorizerResultTtlInSeconds, createAuthorizerResponse.authorizerResultTtlInSeconds) &&
        Objects.equals(this.authorizerType, createAuthorizerResponse.authorizerType) &&
        Objects.equals(this.authorizerUri, createAuthorizerResponse.authorizerUri) &&
        Objects.equals(this.enableSimpleResponses, createAuthorizerResponse.enableSimpleResponses) &&
        Objects.equals(this.identitySource, createAuthorizerResponse.identitySource) &&
        Objects.equals(this.identityValidationExpression, createAuthorizerResponse.identityValidationExpression) &&
        Objects.equals(this.jwtConfiguration, createAuthorizerResponse.jwtConfiguration) &&
        Objects.equals(this.name, createAuthorizerResponse.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateAuthorizerResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateAuthorizerResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateAuthorizerResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateAuthorizerResponse is not found in the empty JSON string", CreateAuthorizerResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateAuthorizerResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateAuthorizerResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateAuthorizerResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateAuthorizerResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateAuthorizerResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateAuthorizerResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateAuthorizerResponse>() {
           @Override
           public void write(JsonWriter out, CreateAuthorizerResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateAuthorizerResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateAuthorizerResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateAuthorizerResponse
   * @throws IOException if the JSON string is invalid with respect to CreateAuthorizerResponse
   */
  public static CreateAuthorizerResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateAuthorizerResponse.class);
  }

  /**
   * Convert an instance of CreateAuthorizerResponse to an JSON string
   *
   * @return JSON string
   */
