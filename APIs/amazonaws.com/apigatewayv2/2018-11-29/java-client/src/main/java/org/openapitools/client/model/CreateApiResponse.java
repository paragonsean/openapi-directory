...
public class CreateApiResponse {
  ...
  public CreateApiResponse apiEndpoint(String apiEndpoint) {
  ...
  public CreateApiResponse apiGatewayManaged(Boolean apiGatewayManaged) {
  ...
  public CreateApiResponse apiId(String apiId) {
    this.apiId = apiId;
    return this;
  }
  ...
  public CreateApiResponse apiKeySelectionExpression(String apiKeySelectionExpression) {
  ...
  public CreateApiResponse corsConfiguration(CreateApiResponseCorsConfiguration corsConfiguration) {
  ...
  public CreateApiResponse createdDate(OffsetDateTime createdDate) {
  ...
  public CreateApiResponse description(String description) {
  ...
  public CreateApiResponse disableSchemaValidation(Boolean disableSchemaValidation) {
  ...
  public CreateApiResponse disableExecuteApiEndpoint(Boolean disableExecuteApiEndpoint) {
  ...
  public CreateApiResponse importInfo(List importInfo) {
  ...
  public CreateApiResponse name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateApiResponse protocolType(ProtocolType protocolType) {
  ...
  public CreateApiResponse routeSelectionExpression(String routeSelectionExpression) {
  ...
  public CreateApiResponse tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public CreateApiResponse version(String version) {
  ...
  public CreateApiResponse warnings(List warnings) {
  ...
  public boolean equals(Object o) {
    ...
    CreateApiResponse createApiResponse = (CreateApiResponse) o;
    return Objects.equals(this.apiEndpoint, createApiResponse.apiEndpoint) &&
        Objects.equals(this.apiGatewayManaged, createApiResponse.apiGatewayManaged) &&
        Objects.equals(this.apiId, createApiResponse.apiId) &&
        Objects.equals(this.apiKeySelectionExpression, createApiResponse.apiKeySelectionExpression) &&
        Objects.equals(this.corsConfiguration, createApiResponse.corsConfiguration) &&
        Objects.equals(this.createdDate, createApiResponse.createdDate) &&
        Objects.equals(this.description, createApiResponse.description) &&
        Objects.equals(this.disableSchemaValidation, createApiResponse.disableSchemaValidation) &&
        Objects.equals(this.disableExecuteApiEndpoint, createApiResponse.disableExecuteApiEndpoint) &&
        Objects.equals(this.importInfo, createApiResponse.importInfo) &&
        Objects.equals(this.name, createApiResponse.name) &&
        Objects.equals(this.protocolType, createApiResponse.protocolType) &&
        Objects.equals(this.routeSelectionExpression, createApiResponse.routeSelectionExpression) &&
        Objects.equals(this.tags, createApiResponse.tags) &&
        Objects.equals(this.version, createApiResponse.version) &&
        Objects.equals(this.warnings, createApiResponse.warnings);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateApiResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateApiResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateApiResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateApiResponse is not found in the empty JSON string", CreateApiResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateApiResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateApiResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateApiResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateApiResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateApiResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateApiResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateApiResponse>() {
           @Override
           public void write(JsonWriter out, CreateApiResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateApiResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateApiResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateApiResponse
   * @throws IOException if the JSON string is invalid with respect to CreateApiResponse
   */
  public static CreateApiResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateApiResponse.class);
  }

  /**
   * Convert an instance of CreateApiResponse to an JSON string
   *
   * @return JSON string
   */
