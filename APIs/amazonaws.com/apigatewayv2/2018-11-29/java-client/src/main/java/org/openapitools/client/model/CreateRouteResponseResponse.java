...
public class CreateRouteResponseResponse {
  ...
  public CreateRouteResponseResponse modelSelectionExpression(String modelSelectionExpression) {
  ...
  public CreateRouteResponseResponse responseModels(Map responseModels) {
  ...
  public CreateRouteResponseResponse responseParameters(Map responseParameters) {
  ...
  public CreateRouteResponseResponse routeResponseId(String routeResponseId) {
  ...
  public CreateRouteResponseResponse routeResponseKey(String routeResponseKey) {
  ...
  public boolean equals(Object o) {
    ...
    CreateRouteResponseResponse createRouteResponseResponse = (CreateRouteResponseResponse) o;
    return Objects.equals(this.modelSelectionExpression, createRouteResponseResponse.modelSelectionExpression) &&
        Objects.equals(this.responseModels, createRouteResponseResponse.responseModels) &&
        Objects.equals(this.responseParameters, createRouteResponseResponse.responseParameters) &&
        Objects.equals(this.routeResponseId, createRouteResponseResponse.routeResponseId) &&
        Objects.equals(this.routeResponseKey, createRouteResponseResponse.routeResponseKey);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateRouteResponseResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateRouteResponseResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateRouteResponseResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateRouteResponseResponse is not found in the empty JSON string", CreateRouteResponseResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateRouteResponseResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateRouteResponseResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateRouteResponseResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateRouteResponseResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateRouteResponseResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateRouteResponseResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateRouteResponseResponse>() {
           @Override
           public void write(JsonWriter out, CreateRouteResponseResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateRouteResponseResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateRouteResponseResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateRouteResponseResponse
   * @throws IOException if the JSON string is invalid with respect to CreateRouteResponseResponse
   */
  public static CreateRouteResponseResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateRouteResponseResponse.class);
  }

  /**
   * Convert an instance of CreateRouteResponseResponse to an JSON string
   *
   * @return JSON string
   */
