...
public class UpdateVpcLinkResponse {
  ...
  public UpdateVpcLinkResponse createdDate(OffsetDateTime createdDate) {
  ...
  public UpdateVpcLinkResponse name(String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateVpcLinkResponse securityGroupIds(List securityGroupIds) {
  ...
  public UpdateVpcLinkResponse subnetIds(List subnetIds) {
  ...
  public UpdateVpcLinkResponse tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public UpdateVpcLinkResponse vpcLinkId(String vpcLinkId) {
  ...
  public UpdateVpcLinkResponse vpcLinkStatus(VpcLinkStatus vpcLinkStatus) {
  ...
  public UpdateVpcLinkResponse vpcLinkStatusMessage(String vpcLinkStatusMessage) {
  ...
  public UpdateVpcLinkResponse vpcLinkVersion(VpcLinkVersion vpcLinkVersion) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateVpcLinkResponse updateVpcLinkResponse = (UpdateVpcLinkResponse) o;
    return Objects.equals(this.createdDate, updateVpcLinkResponse.createdDate) &&
        Objects.equals(this.name, updateVpcLinkResponse.name) &&
        Objects.equals(this.securityGroupIds, updateVpcLinkResponse.securityGroupIds) &&
        Objects.equals(this.subnetIds, updateVpcLinkResponse.subnetIds) &&
        Objects.equals(this.tags, updateVpcLinkResponse.tags) &&
        Objects.equals(this.vpcLinkId, updateVpcLinkResponse.vpcLinkId) &&
        Objects.equals(this.vpcLinkStatus, updateVpcLinkResponse.vpcLinkStatus) &&
        Objects.equals(this.vpcLinkStatusMessage, updateVpcLinkResponse.vpcLinkStatusMessage) &&
        Objects.equals(this.vpcLinkVersion, updateVpcLinkResponse.vpcLinkVersion);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateVpcLinkResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateVpcLinkResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateVpcLinkResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateVpcLinkResponse is not found in the empty JSON string", UpdateVpcLinkResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateVpcLinkResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateVpcLinkResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateVpcLinkResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateVpcLinkResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateVpcLinkResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateVpcLinkResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateVpcLinkResponse>() {
           @Override
           public void write(JsonWriter out, UpdateVpcLinkResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateVpcLinkResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateVpcLinkResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateVpcLinkResponse
   * @throws IOException if the JSON string is invalid with respect to UpdateVpcLinkResponse
   */
  public static UpdateVpcLinkResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateVpcLinkResponse.class);
  }

  /**
   * Convert an instance of UpdateVpcLinkResponse to an JSON string
   *
   * @return JSON string
   */
