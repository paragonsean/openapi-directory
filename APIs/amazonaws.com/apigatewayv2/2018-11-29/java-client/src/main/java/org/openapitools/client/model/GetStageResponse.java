...
public class GetStageResponse {
  ...
  public GetStageResponse accessLogSettings(CreateStageResponseAccessLogSettings accessLogSettings) {
  ...
  public GetStageResponse apiGatewayManaged(Boolean apiGatewayManaged) {
  ...
  public GetStageResponse autoDeploy(Boolean autoDeploy) {
  ...
  public GetStageResponse clientCertificateId(String clientCertificateId) {
  ...
  public GetStageResponse createdDate(OffsetDateTime createdDate) {
  ...
  public GetStageResponse defaultRouteSettings(CreateStageResponseDefaultRouteSettings defaultRouteSettings) {
  ...
  public GetStageResponse deploymentId(String deploymentId) {
  ...
  public GetStageResponse description(String description) {
  ...
  public GetStageResponse lastDeploymentStatusMessage(String lastDeploymentStatusMessage) {
  ...
  public GetStageResponse lastUpdatedDate(OffsetDateTime lastUpdatedDate) {
  ...
  public GetStageResponse routeSettings(Map routeSettings) {
  ...
  public GetStageResponse stageName(String stageName) {
  ...
  public GetStageResponse stageVariables(Map stageVariables) {
  ...
  public GetStageResponse tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetStageResponse getStageResponse = (GetStageResponse) o;
    return Objects.equals(this.accessLogSettings, getStageResponse.accessLogSettings) &&
        Objects.equals(this.apiGatewayManaged, getStageResponse.apiGatewayManaged) &&
        Objects.equals(this.autoDeploy, getStageResponse.autoDeploy) &&
        Objects.equals(this.clientCertificateId, getStageResponse.clientCertificateId) &&
        Objects.equals(this.createdDate, getStageResponse.createdDate) &&
        Objects.equals(this.defaultRouteSettings, getStageResponse.defaultRouteSettings) &&
        Objects.equals(this.deploymentId, getStageResponse.deploymentId) &&
        Objects.equals(this.description, getStageResponse.description) &&
        Objects.equals(this.lastDeploymentStatusMessage, getStageResponse.lastDeploymentStatusMessage) &&
        Objects.equals(this.lastUpdatedDate, getStageResponse.lastUpdatedDate) &&
        Objects.equals(this.routeSettings, getStageResponse.routeSettings) &&
        Objects.equals(this.stageName, getStageResponse.stageName) &&
        Objects.equals(this.stageVariables, getStageResponse.stageVariables) &&
        Objects.equals(this.tags, getStageResponse.tags);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetStageResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetStageResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetStageResponse is not found in the empty JSON string", GetStageResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetStageResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetStageResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetStageResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetStageResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetStageResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetStageResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GetStageResponse>() {
           @Override
           public void write(JsonWriter out, GetStageResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetStageResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetStageResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetStageResponse
   * @throws IOException if the JSON string is invalid with respect to GetStageResponse
   */
  public static GetStageResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetStageResponse.class);
  }

  /**
   * Convert an instance of GetStageResponse to an JSON string
   *
   * @return JSON string
   */
