...
/**
 * The CreateAuthorizerResponse model module.
 * @module model/CreateAuthorizerResponse
 * @version 2018-11-29
 */
class CreateAuthorizerResponse {
    /**
     * Constructs a new <code>CreateAuthorizerResponse</code>.
     * @alias module:model/CreateAuthorizerResponse
     */
    constructor() { 
        
        CreateAuthorizerResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateAuthorizerResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateAuthorizerResponse} obj Optional instance to populate.
     * @return {module:model/CreateAuthorizerResponse} The populated <code>CreateAuthorizerResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateAuthorizerResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateAuthorizerResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateAuthorizerResponse</code>.
     */
 ...
 */
CreateAuthorizerResponse.prototype['AuthorizerCredentialsArn'] = undefined;

/**
 * @member {String} AuthorizerId
 */
CreateAuthorizerResponse.prototype['AuthorizerId'] = undefined;

/**
 * @member {String} AuthorizerPayloadFormatVersion
 */
CreateAuthorizerResponse.prototype['AuthorizerPayloadFormatVersion'] = undefined;

/**
 * @member {Number} AuthorizerResultTtlInSeconds
 */
CreateAuthorizerResponse.prototype['AuthorizerResultTtlInSeconds'] = undefined;

/**
 * @member {module:model/AuthorizerType} AuthorizerType
 */
CreateAuthorizerResponse.prototype['AuthorizerType'] = undefined;

/**
 * @member {String} AuthorizerUri
 */
CreateAuthorizerResponse.prototype['AuthorizerUri'] = undefined;

/**
 * @member {Boolean} EnableSimpleResponses
 */
CreateAuthorizerResponse.prototype['EnableSimpleResponses'] = undefined;

/**
 * @member {Array} IdentitySource
 */
CreateAuthorizerResponse.prototype['IdentitySource'] = undefined;

/**
 * @member {String} IdentityValidationExpression
 */
CreateAuthorizerResponse.prototype['IdentityValidationExpression'] = undefined;

/**
 * @member {module:model/CreateAuthorizerResponseJwtConfiguration} JwtConfiguration
 */
CreateAuthorizerResponse.prototype['JwtConfiguration'] = undefined;

/**
 * @member {String} Name
 */
CreateAuthorizerResponse.prototype['Name'] = undefined;
...
export default CreateAuthorizerResponse;
