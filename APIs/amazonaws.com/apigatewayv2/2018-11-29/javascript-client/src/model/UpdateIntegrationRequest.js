 ...
 */
UpdateIntegrationRequest.prototype['connectionId'] = undefined;

/**
 * Represents a connection type.
 * @member {module:model/UpdateIntegrationRequest.ConnectionTypeEnum} connectionType
 */
UpdateIntegrationRequest.prototype['connectionType'] = undefined;

/**
 * Specifies how to handle response payload content type conversions. Supported only for WebSocket APIs.
 * @member {module:model/UpdateIntegrationRequest.ContentHandlingStrategyEnum} contentHandlingStrategy
 */
UpdateIntegrationRequest.prototype['contentHandlingStrategy'] = undefined;

/**
 * Represents an Amazon Resource Name (ARN).
 * @member {String} credentialsArn
 */
UpdateIntegrationRequest.prototype['credentialsArn'] = undefined;

/**
 * A string with a length between [0-1024].
 * @member {String} description
 */
UpdateIntegrationRequest.prototype['description'] = undefined;

/**
 * A string with a length between [1-64].
 * @member {String} integrationMethod
 */
UpdateIntegrationRequest.prototype['integrationMethod'] = undefined;

/**
 * A string with a length between [1-128].
 * @member {String} integrationSubtype
 */
UpdateIntegrationRequest.prototype['integrationSubtype'] = undefined;

/**
 * Represents an API method integration type.
 * @member {module:model/UpdateIntegrationRequest.IntegrationTypeEnum} integrationType
 */
UpdateIntegrationRequest.prototype['integrationType'] = undefined;

/**
 * A string representation of a URI with a length between [1-2048].
 * @member {String} integrationUri
 */
UpdateIntegrationRequest.prototype['integrationUri'] = undefined;

/**
 * Represents passthrough behavior for an integration response. Supported only for WebSocket APIs.
 * @member {module:model/UpdateIntegrationRequest.PassthroughBehaviorEnum} passthroughBehavior
 */
UpdateIntegrationRequest.prototype['passthroughBehavior'] = undefined;

/**
 * A string with a length between [1-64].
 * @member {String} payloadFormatVersion
 */
UpdateIntegrationRequest.prototype['payloadFormatVersion'] = undefined;
 ...
 */
UpdateIntegrationRequest.prototype['requestParameters'] = undefined;
 ...
 */
UpdateIntegrationRequest.prototype['requestTemplates'] = undefined;
 ...
 */
UpdateIntegrationRequest.prototype['responseParameters'] = undefined;
 ...
 */
UpdateIntegrationRequest.prototype['templateSelectionExpression'] = undefined;

/**
 * An integer with a value between [50-30000].
 * @member {Number} timeoutInMillis
 */
UpdateIntegrationRequest.prototype['timeoutInMillis'] = undefined;

/**
 * @member {module:model/CreateIntegrationRequestTlsConfig} tlsConfig
 */
UpdateIntegrationRequest.prototype['tlsConfig'] = undefined;
 ...
 * @readonly
 */
UpdateIntegrationRequest['ConnectionTypeEnum'] = {
 ...
 * @readonly
 */
UpdateIntegrationRequest['ContentHandlingStrategyEnum'] = {
 ...
 * @readonly
 */
UpdateIntegrationRequest['IntegrationTypeEnum'] = {
 ...
 * @readonly
 */
UpdateIntegrationRequest['PassthroughBehaviorEnum'] = {
