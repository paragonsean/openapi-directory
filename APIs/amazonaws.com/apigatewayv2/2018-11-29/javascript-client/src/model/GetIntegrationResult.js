...
/**
 * The GetIntegrationResult model module.
 * @module model/GetIntegrationResult
 * @version 2018-11-29
 */
class GetIntegrationResult {
    /**
     * Constructs a new <code>GetIntegrationResult</code>.
     * @alias module:model/GetIntegrationResult
     */
    constructor() { 
        
        GetIntegrationResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetIntegrationResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetIntegrationResult} obj Optional instance to populate.
     * @return {module:model/GetIntegrationResult} The populated <code>GetIntegrationResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetIntegrationResult();
    ...
    /**
     * Validates the JSON data with respect to <code>GetIntegrationResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetIntegrationResult</code>.
     */
 ...
 */
GetIntegrationResult.prototype['ApiGatewayManaged'] = undefined;

/**
 * @member {String} ConnectionId
 */
GetIntegrationResult.prototype['ConnectionId'] = undefined;

/**
 * @member {module:model/ConnectionType} ConnectionType
 */
GetIntegrationResult.prototype['ConnectionType'] = undefined;

/**
 * @member {module:model/ContentHandlingStrategy} ContentHandlingStrategy
 */
GetIntegrationResult.prototype['ContentHandlingStrategy'] = undefined;

/**
 * @member {String} CredentialsArn
 */
GetIntegrationResult.prototype['CredentialsArn'] = undefined;

/**
 * @member {String} Description
 */
GetIntegrationResult.prototype['Description'] = undefined;

/**
 * @member {String} IntegrationId
 */
GetIntegrationResult.prototype['IntegrationId'] = undefined;

/**
 * @member {String} IntegrationMethod
 */
GetIntegrationResult.prototype['IntegrationMethod'] = undefined;

/**
 * @member {String} IntegrationResponseSelectionExpression
 */
GetIntegrationResult.prototype['IntegrationResponseSelectionExpression'] = undefined;

/**
 * @member {String} IntegrationSubtype
 */
GetIntegrationResult.prototype['IntegrationSubtype'] = undefined;

/**
 * @member {module:model/IntegrationType} IntegrationType
 */
GetIntegrationResult.prototype['IntegrationType'] = undefined;

/**
 * @member {String} IntegrationUri
 */
GetIntegrationResult.prototype['IntegrationUri'] = undefined;

/**
 * @member {module:model/PassthroughBehavior} PassthroughBehavior
 */
GetIntegrationResult.prototype['PassthroughBehavior'] = undefined;

/**
 * @member {String} PayloadFormatVersion
 */
GetIntegrationResult.prototype['PayloadFormatVersion'] = undefined;

/**
 * @member {Object} RequestParameters
 */
GetIntegrationResult.prototype['RequestParameters'] = undefined;

/**
 * @member {Object} RequestTemplates
 */
GetIntegrationResult.prototype['RequestTemplates'] = undefined;

/**
 * @member {Object} ResponseParameters
 */
GetIntegrationResult.prototype['ResponseParameters'] = undefined;

/**
 * @member {String} TemplateSelectionExpression
 */
GetIntegrationResult.prototype['TemplateSelectionExpression'] = undefined;

/**
 * @member {Number} TimeoutInMillis
 */
GetIntegrationResult.prototype['TimeoutInMillis'] = undefined;

/**
 * @member {module:model/CreateIntegrationResultTlsConfig} TlsConfig
 */
GetIntegrationResult.prototype['TlsConfig'] = undefined;
...
export default GetIntegrationResult;
