...
/**
 * The CreateIntegrationResult model module.
 * @module model/CreateIntegrationResult
 * @version 2018-11-29
 */
class CreateIntegrationResult {
    /**
     * Constructs a new <code>CreateIntegrationResult</code>.
     * @alias module:model/CreateIntegrationResult
     */
    constructor() { 
        
        CreateIntegrationResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateIntegrationResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateIntegrationResult} obj Optional instance to populate.
     * @return {module:model/CreateIntegrationResult} The populated <code>CreateIntegrationResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateIntegrationResult();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateIntegrationResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateIntegrationResult</code>.
     */
 ...
 */
CreateIntegrationResult.prototype['ApiGatewayManaged'] = undefined;

/**
 * @member {String} ConnectionId
 */
CreateIntegrationResult.prototype['ConnectionId'] = undefined;

/**
 * @member {module:model/ConnectionType} ConnectionType
 */
CreateIntegrationResult.prototype['ConnectionType'] = undefined;

/**
 * @member {module:model/ContentHandlingStrategy} ContentHandlingStrategy
 */
CreateIntegrationResult.prototype['ContentHandlingStrategy'] = undefined;

/**
 * @member {String} CredentialsArn
 */
CreateIntegrationResult.prototype['CredentialsArn'] = undefined;

/**
 * @member {String} Description
 */
CreateIntegrationResult.prototype['Description'] = undefined;

/**
 * @member {String} IntegrationId
 */
CreateIntegrationResult.prototype['IntegrationId'] = undefined;

/**
 * @member {String} IntegrationMethod
 */
CreateIntegrationResult.prototype['IntegrationMethod'] = undefined;

/**
 * @member {String} IntegrationResponseSelectionExpression
 */
CreateIntegrationResult.prototype['IntegrationResponseSelectionExpression'] = undefined;

/**
 * @member {String} IntegrationSubtype
 */
CreateIntegrationResult.prototype['IntegrationSubtype'] = undefined;

/**
 * @member {module:model/IntegrationType} IntegrationType
 */
CreateIntegrationResult.prototype['IntegrationType'] = undefined;

/**
 * @member {String} IntegrationUri
 */
CreateIntegrationResult.prototype['IntegrationUri'] = undefined;

/**
 * @member {module:model/PassthroughBehavior} PassthroughBehavior
 */
CreateIntegrationResult.prototype['PassthroughBehavior'] = undefined;

/**
 * @member {String} PayloadFormatVersion
 */
CreateIntegrationResult.prototype['PayloadFormatVersion'] = undefined;

/**
 * @member {Object} RequestParameters
 */
CreateIntegrationResult.prototype['RequestParameters'] = undefined;

/**
 * @member {Object} RequestTemplates
 */
CreateIntegrationResult.prototype['RequestTemplates'] = undefined;

/**
 * @member {Object} ResponseParameters
 */
CreateIntegrationResult.prototype['ResponseParameters'] = undefined;

/**
 * @member {String} TemplateSelectionExpression
 */
CreateIntegrationResult.prototype['TemplateSelectionExpression'] = undefined;

/**
 * @member {Number} TimeoutInMillis
 */
CreateIntegrationResult.prototype['TimeoutInMillis'] = undefined;

/**
 * @member {module:model/CreateIntegrationResultTlsConfig} TlsConfig
 */
CreateIntegrationResult.prototype['TlsConfig'] = undefined;
...
export default CreateIntegrationResult;
