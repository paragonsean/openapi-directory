...
/**
 * The UpdateIntegrationResult model module.
 * @module model/UpdateIntegrationResult
 * @version 2018-11-29
 */
class UpdateIntegrationResult {
    /**
     * Constructs a new <code>UpdateIntegrationResult</code>.
     * @alias module:model/UpdateIntegrationResult
     */
    constructor() { 
        
        UpdateIntegrationResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateIntegrationResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateIntegrationResult} obj Optional instance to populate.
     * @return {module:model/UpdateIntegrationResult} The populated <code>UpdateIntegrationResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateIntegrationResult();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateIntegrationResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateIntegrationResult</code>.
     */
 ...
 */
UpdateIntegrationResult.prototype['ApiGatewayManaged'] = undefined;

/**
 * @member {String} ConnectionId
 */
UpdateIntegrationResult.prototype['ConnectionId'] = undefined;

/**
 * @member {module:model/ConnectionType} ConnectionType
 */
UpdateIntegrationResult.prototype['ConnectionType'] = undefined;

/**
 * @member {module:model/ContentHandlingStrategy} ContentHandlingStrategy
 */
UpdateIntegrationResult.prototype['ContentHandlingStrategy'] = undefined;

/**
 * @member {String} CredentialsArn
 */
UpdateIntegrationResult.prototype['CredentialsArn'] = undefined;

/**
 * @member {String} Description
 */
UpdateIntegrationResult.prototype['Description'] = undefined;

/**
 * @member {String} IntegrationId
 */
UpdateIntegrationResult.prototype['IntegrationId'] = undefined;

/**
 * @member {String} IntegrationMethod
 */
UpdateIntegrationResult.prototype['IntegrationMethod'] = undefined;

/**
 * @member {String} IntegrationResponseSelectionExpression
 */
UpdateIntegrationResult.prototype['IntegrationResponseSelectionExpression'] = undefined;

/**
 * @member {String} IntegrationSubtype
 */
UpdateIntegrationResult.prototype['IntegrationSubtype'] = undefined;

/**
 * @member {module:model/IntegrationType} IntegrationType
 */
UpdateIntegrationResult.prototype['IntegrationType'] = undefined;

/**
 * @member {String} IntegrationUri
 */
UpdateIntegrationResult.prototype['IntegrationUri'] = undefined;

/**
 * @member {module:model/PassthroughBehavior} PassthroughBehavior
 */
UpdateIntegrationResult.prototype['PassthroughBehavior'] = undefined;

/**
 * @member {String} PayloadFormatVersion
 */
UpdateIntegrationResult.prototype['PayloadFormatVersion'] = undefined;

/**
 * @member {Object} RequestParameters
 */
UpdateIntegrationResult.prototype['RequestParameters'] = undefined;

/**
 * @member {Object} RequestTemplates
 */
UpdateIntegrationResult.prototype['RequestTemplates'] = undefined;

/**
 * @member {Object} ResponseParameters
 */
UpdateIntegrationResult.prototype['ResponseParameters'] = undefined;

/**
 * @member {String} TemplateSelectionExpression
 */
UpdateIntegrationResult.prototype['TemplateSelectionExpression'] = undefined;

/**
 * @member {Number} TimeoutInMillis
 */
UpdateIntegrationResult.prototype['TimeoutInMillis'] = undefined;

/**
 * @member {module:model/CreateIntegrationResultTlsConfig} TlsConfig
 */
UpdateIntegrationResult.prototype['TlsConfig'] = undefined;
...
export default UpdateIntegrationResult;
