...
/**
 * The UpdateIntegrationResponseRequest model module.
 * @module model/UpdateIntegrationResponseRequest
 * @version 2018-11-29
 */
class UpdateIntegrationResponseRequest {
    /**
     * Constructs a new <code>UpdateIntegrationResponseRequest</code>.
     * @alias module:model/UpdateIntegrationResponseRequest
     */
    constructor() { 
        
        UpdateIntegrationResponseRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateIntegrationResponseRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateIntegrationResponseRequest} obj Optional instance to populate.
     * @return {module:model/UpdateIntegrationResponseRequest} The populated <code>UpdateIntegrationResponseRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateIntegrationResponseRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateIntegrationResponseRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateIntegrationResponseRequest</code>.
     */
 ...
 * @member {module:model/UpdateIntegrationResponseRequest.ContentHandlingStrategyEnum} contentHandlingStrategy
 */
UpdateIntegrationResponseRequest.prototype['contentHandlingStrategy'] = undefined;
 ...
 */
UpdateIntegrationResponseRequest.prototype['integrationResponseKey'] = undefined;
 ...
 */
UpdateIntegrationResponseRequest.prototype['responseParameters'] = undefined;
 ...
 */
UpdateIntegrationResponseRequest.prototype['responseTemplates'] = undefined;
 ...
 */
UpdateIntegrationResponseRequest.prototype['templateSelectionExpression'] = undefined;
 ...
 * @readonly
 */
UpdateIntegrationResponseRequest['ContentHandlingStrategyEnum'] = {
...
export default UpdateIntegrationResponseRequest;
