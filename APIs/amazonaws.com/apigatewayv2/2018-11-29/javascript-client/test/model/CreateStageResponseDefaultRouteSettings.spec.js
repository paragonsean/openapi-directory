...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonApiGatewayV2.CreateStageResponseDefaultRouteSettings();
  });
  ...
  describe('CreateStageResponseDefaultRouteSettings', function() {
    it('should create an instance of CreateStageResponseDefaultRouteSettings', function() {
      // uncomment below and update the code to test CreateStageResponseDefaultRouteSettings
      //var instance = new AmazonApiGatewayV2.CreateStageResponseDefaultRouteSettings();
      //expect(instance).to.be.a(AmazonApiGatewayV2.CreateStageResponseDefaultRouteSettings);
    });
    ...
    it('should have the property detailedMetricsEnabled (base name: "DetailedMetricsEnabled")', function() {
      // uncomment below and update the code to test the property detailedMetricsEnabled
      //var instance = new AmazonApiGatewayV2.CreateStageResponseDefaultRouteSettings();
      //expect(instance).to.be();
    });
