...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonApiGatewayV2.JWTConfiguration();
  });
  ...
  describe('JWTConfiguration', function() {
    it('should create an instance of JWTConfiguration', function() {
      // uncomment below and update the code to test JWTConfiguration
      //var instance = new AmazonApiGatewayV2.JWTConfiguration();
      //expect(instance).to.be.a(AmazonApiGatewayV2.JWTConfiguration);
    });
