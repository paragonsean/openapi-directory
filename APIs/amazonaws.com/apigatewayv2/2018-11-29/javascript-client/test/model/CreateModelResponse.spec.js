...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonApiGatewayV2.CreateModelResponse();
  });
  ...
  describe('CreateModelResponse', function() {
    it('should create an instance of CreateModelResponse', function() {
      ...
      //var instance = new AmazonApiGatewayV2.CreateModelResponse();
      //expect(instance).to.be.a(AmazonApiGatewayV2.CreateModelResponse);
    });
