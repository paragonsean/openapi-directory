...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonApiGatewayV2.UpdateIntegrationResult();
  });
  ...
  describe('UpdateIntegrationResult', function() {
    it('should create an instance of UpdateIntegrationResult', function() {
      // uncomment below and update the code to test UpdateIntegrationResult
      //var instance = new AmazonApiGatewayV2.UpdateIntegrationResult();
      //expect(instance).to.be.a(AmazonApiGatewayV2.UpdateIntegrationResult);
    });
