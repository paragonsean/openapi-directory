...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonApiGatewayV2.UpdateRouteResult();
  });
  ...
  describe('UpdateRouteResult', function() {
    it('should create an instance of UpdateRouteResult', function() {
      // uncomment below and update the code to test UpdateRouteResult
      //var instance = new AmazonApiGatewayV2.UpdateRouteResult();
      //expect(instance).to.be.a(AmazonApiGatewayV2.UpdateRouteResult);
    });
