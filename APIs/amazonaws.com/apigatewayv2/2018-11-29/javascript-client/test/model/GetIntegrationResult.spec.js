...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonApiGatewayV2.GetIntegrationResult();
  });
  ...
  describe('GetIntegrationResult', function() {
    it('should create an instance of GetIntegrationResult', function() {
      // uncomment below and update the code to test GetIntegrationResult
      //var instance = new AmazonApiGatewayV2.GetIntegrationResult();
      //expect(instance).to.be.a(AmazonApiGatewayV2.GetIntegrationResult);
    });
