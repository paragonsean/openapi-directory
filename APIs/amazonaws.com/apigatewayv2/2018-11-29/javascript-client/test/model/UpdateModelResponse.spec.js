...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonApiGatewayV2.UpdateModelResponse();
  });
  ...
  describe('UpdateModelResponse', function() {
    it('should create an instance of UpdateModelResponse', function() {
      // uncomment below and update the code to test UpdateModelResponse
      //var instance = new AmazonApiGatewayV2.UpdateModelResponse();
      //expect(instance).to.be.a(AmazonApiGatewayV2.UpdateModelResponse);
    });
