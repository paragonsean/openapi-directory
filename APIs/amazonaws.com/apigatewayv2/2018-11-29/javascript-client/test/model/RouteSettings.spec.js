...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonApiGatewayV2.RouteSettings();
  });
  ...
  describe('RouteSettings', function() {
    it('should create an instance of RouteSettings', function() {
      // uncomment below and update the code to test RouteSettings
      //var instance = new AmazonApiGatewayV2.RouteSettings();
      //expect(instance).to.be.a(AmazonApiGatewayV2.RouteSettings);
    });
