...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonApiGatewayV2.CreateModelRequest();
  });
  ...
  describe('CreateModelRequest', function() {
    it('should create an instance of CreateModelRequest', function() {
      ...
      //var instance = new AmazonApiGatewayV2.CreateModelRequest();
      //expect(instance).to.be.a(AmazonApiGatewayV2.CreateModelRequest);
    });
