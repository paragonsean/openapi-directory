...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonApiGatewayV2.CreateRouteResult();
  });
  ...
  describe('CreateRouteResult', function() {
    it('should create an instance of CreateRouteResult', function() {
      // uncomment below and update the code to test CreateRouteResult
      //var instance = new AmazonApiGatewayV2.CreateRouteResult();
      //expect(instance).to.be.a(AmazonApiGatewayV2.CreateRouteResult);
    });
