...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonApiGatewayV2.UpdateIntegrationRequest();
  });
  ...
  describe('UpdateIntegrationRequest', function() {
    it('should create an instance of UpdateIntegrationRequest', function() {
      // uncomment below and update the code to test UpdateIntegrationRequest
      //var instance = new AmazonApiGatewayV2.UpdateIntegrationRequest();
      //expect(instance).to.be.a(AmazonApiGatewayV2.UpdateIntegrationRequest);
    });
