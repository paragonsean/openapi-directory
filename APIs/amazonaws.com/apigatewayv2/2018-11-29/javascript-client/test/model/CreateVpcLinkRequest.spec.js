...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonApiGatewayV2.CreateVpcLinkRequest();
  });
  ...
  describe('CreateVpcLinkRequest', function() {
    it('should create an instance of CreateVpcLinkRequest', function() {
      // uncomment below and update the code to test CreateVpcLinkRequest
      //var instance = new AmazonApiGatewayV2.CreateVpcLinkRequest();
      //expect(instance).to.be.a(AmazonApiGatewayV2.CreateVpcLinkRequest);
    });
