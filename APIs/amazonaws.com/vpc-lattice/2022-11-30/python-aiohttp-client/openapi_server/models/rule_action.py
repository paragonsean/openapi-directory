...
class RuleAction(Model):
    ...
    def __init__(self, fixed_response: CreateRuleRequestActionFixedResponse=None, forward: CreateRuleRequestActionForward=None):
        ...
        :param fixed_response: The fixed_response of this RuleAction.
        :param forward: The forward of this RuleAction.
        """
        self.openapi_types = {
    ...
    def fixed_response(self):
        """Gets the fixed_response of this RuleAction.


        :return: The fixed_response of this RuleAction.
    ...
    def fixed_response(self, fixed_response):
        """Sets the fixed_response of this RuleAction.
    ...
    @property
    def forward(self):
        """Gets the forward of this RuleAction.


        :return: The forward of this RuleAction.
    ...
    def forward(self, forward):
        """Sets the forward of this RuleAction.
