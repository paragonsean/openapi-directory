...
class RuleUpdateAction(Model):
    ...
    def __init__(self, fixed_response: CreateRuleRequestActionFixedResponse=None, forward: CreateRuleRequestActionForward=None):
        """RuleUpdateAction - a model defined in OpenAPI

        :param fixed_response: The fixed_response of this RuleUpdateAction.
        :param forward: The forward of this RuleUpdateAction.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'RuleUpdateAction':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The RuleUpdate_action of this RuleUpdateAction.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def fixed_response(self):
        """Gets the fixed_response of this RuleUpdateAction.


        :return: The fixed_response of this RuleUpdateAction.
    ...
    def fixed_response(self, fixed_response):
        """Sets the fixed_response of this RuleUpdateAction.
    ...
    @property
    def forward(self):
        """Gets the forward of this RuleUpdateAction.


        :return: The forward of this RuleUpdateAction.
    ...
    def forward(self, forward):
        """Sets the forward of this RuleUpdateAction.
