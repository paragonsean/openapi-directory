...
class CreateRuleResponseAction(Model):
    ...
    def __init__(self, fixed_response: CreateRuleRequestActionFixedResponse=None, forward: CreateRuleRequestActionForward=None):
        """CreateRuleResponseAction - a model defined in OpenAPI

        :param fixed_response: The fixed_response of this CreateRuleResponseAction.
        :param forward: The forward of this CreateRuleResponseAction.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CreateRuleResponseAction':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The CreateRuleResponse_action of this CreateRuleResponseAction.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def fixed_response(self):
        """Gets the fixed_response of this CreateRuleResponseAction.


        :return: The fixed_response of this CreateRuleResponseAction.
    ...
    def fixed_response(self, fixed_response):
        """Sets the fixed_response of this CreateRuleResponseAction.
    ...
    @property
    def forward(self):
        """Gets the forward of this CreateRuleResponseAction.


        :return: The forward of this CreateRuleResponseAction.
    ...
    def forward(self, forward):
        """Sets the forward of this CreateRuleResponseAction.
