...
async def test_batch_update_rule(client):
    """Test case for batch_update_rule
    ...
    response = await client.request(
        method='PATCH',
        path='/services/{service_identifier}/listeners/{listener_identifier}/rules'.format(listener_identifier='listener_identifier_example', service_identifier='service_identifier_example'),
        headers=headers,
        json=body,
        )
...
async def test_create_access_log_subscription(client):
    """Test case for create_access_log_subscription

    
    """
    body = {"resourceIdentifier":"","destinationArn":"","clientToken":"","tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_create_listener(client):
    """Test case for create_listener

    
    """
    body = {"protocol":"","defaultAction":{"forward":{"targetGroups":""},"fixedResponse":{"statusCode":""}},"port":"","clientToken":"","name":"","tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/services/{service_identifier}/listeners'.format(service_identifier='service_identifier_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_rule(client):
    ...
    """
    body = {"clientToken":"","match":{"httpMatch":{"headerMatches":"","method":"","pathMatch":{"caseSensitive":"","match":{"prefix":"","exact":""}}}},"name":"","action":{"forward":{"targetGroups":""},"fixedResponse":{"statusCode":""}},"priority":"","tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_create_service(client):
    ...
    """
    body = {"customDomainName":"","certificateArn":"","clientToken":"","name":"","authType":"","tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_create_service_network(client):
    """Test case for create_service_network

    
    """
    body = {"clientToken":"","name":"","authType":"","tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_create_service_network_service_association(client):
    """Test case for create_service_network_service_association

    
    """
    body = {"clientToken":"","serviceNetworkIdentifier":"","serviceIdentifier":"","tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_create_service_network_vpc_association(client):
    """Test case for create_service_network_vpc_association

    
    """
    body = {"clientToken":"","securityGroupIds":"","serviceNetworkIdentifier":"","vpcIdentifier":"","tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_create_target_group(client):
    """Test case for create_target_group

    
    """
    body = {"clientToken":"","name":"","type":"","config":{"protocol":"","port":"","healthCheck":{"path":"","protocol":"","port":"","healthCheckIntervalSeconds":"","healthCheckTimeoutSeconds":"","healthyThresholdCount":"","protocolVersion":"","matcher":{"httpCode":""},"enabled":"","unhealthyThresholdCount":""},"protocolVersion":"","vpcIdentifier":"","ipAddressType":""},"tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_delete_access_log_subscription(client):
    """Test case for delete_access_log_subscription
    ...
    response = await client.request(
        method='DELETE',
        path='/accesslogsubscriptions/{access_log_subscription_identifier}'.format(access_log_subscription_identifier='access_log_subscription_identifier_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_auth_policy(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/authpolicy/{resource_identifier}'.format(resource_identifier='resource_identifier_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_listener(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/services/{service_identifier}/listeners/{listener_identifier}'.format(listener_identifier='listener_identifier_example', service_identifier='service_identifier_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_resource_policy(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/resourcepolicy/{resource_arn}'.format(resource_arn='resource_arn_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_rule(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/services/{service_identifier}/listeners/{listener_identifier}/rules/{rule_identifier}'.format(listener_identifier='listener_identifier_example', rule_identifier='rule_identifier_example', service_identifier='service_identifier_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_service(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/services/{service_identifier}'.format(service_identifier='service_identifier_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_service_network(client):
    """Test case for delete_service_network
    ...
    response = await client.request(
        method='DELETE',
        path='/servicenetworks/{service_network_identifier}'.format(service_network_identifier='service_network_identifier_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_service_network_service_association(client):
    """Test case for delete_service_network_service_association
    ...
    response = await client.request(
        method='DELETE',
        path='/servicenetworkserviceassociations/{service_network_service_association_identifier}'.format(service_network_service_association_identifier='service_network_service_association_identifier_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_service_network_vpc_association(client):
    """Test case for delete_service_network_vpc_association
    ...
    response = await client.request(
        method='DELETE',
        path='/servicenetworkvpcassociations/{service_network_vpc_association_identifier}'.format(service_network_vpc_association_identifier='service_network_vpc_association_identifier_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_target_group(client):
    """Test case for delete_target_group
    ...
    response = await client.request(
        method='DELETE',
        path='/targetgroups/{target_group_identifier}'.format(target_group_identifier='target_group_identifier_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_deregister_targets(client):
    """Test case for deregister_targets
    ...
    response = await client.request(
        method='POST',
        path='/targetgroups/{target_group_identifier}/deregistertargets'.format(target_group_identifier='target_group_identifier_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_access_log_subscription(client):
    """Test case for get_access_log_subscription
...
async def test_get_auth_policy(client):
...
async def test_get_listener(client):
...
async def test_get_service_network(client):
    """Test case for get_service_network
...
async def test_get_service_network_service_association(client):
    """Test case for get_service_network_service_association
...
async def test_get_service_network_vpc_association(client):
    """Test case for get_service_network_vpc_association
...
async def test_get_target_group(client):
    """Test case for get_target_group
...
async def test_list_access_log_subscriptions(client):
    """Test case for list_access_log_subscriptions

    
    """
    params = [('maxResults', 56),
                    ('nextToken', 'next_token_example'),
                    ('resourceIdentifier', 'resource_identifier_example')]
    headers = { 
        'Accept': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
        'x_amz_date': 'x_amz_date_example',
...
async def test_list_listeners(client):
    """Test case for list_listeners
...
async def test_list_service_network_service_associations(client):
    """Test case for list_service_network_service_associations

    
    """
    params = [('maxResults', 56),
                    ('nextToken', 'next_token_example'),
                    ('serviceIdentifier', 'service_identifier_example'),
                    ('serviceNetworkIdentifier', 'service_network_identifier_example')]
    headers = { 
        'Accept': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
        'x_amz_date': 'x_amz_date_example',
...
async def test_list_service_network_vpc_associations(client):
    """Test case for list_service_network_vpc_associations
    ...
    params = [('maxResults', 56),
                    ('nextToken', 'next_token_example'),
                    ('serviceNetworkIdentifier', 'service_network_identifier_example'),
                    ('vpcIdentifier', 'vpc_identifier_example')]
    headers = { 
        'Accept': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
        'x_amz_date': 'x_amz_date_example',
...
async def test_list_service_networks(client):
    """Test case for list_service_networks
...
async def test_list_target_groups(client):
    """Test case for list_target_groups

    
    """
    params = [('maxResults', 56),
                    ('nextToken', 'next_token_example'),
                    ('targetGroupType', 'target_group_type_example'),
                    ('vpcIdentifier', 'vpc_identifier_example')]
    headers = { 
        'Accept': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_list_targets(client):
    ...
    response = await client.request(
        method='POST',
        path='/targetgroups/{target_group_identifier}/listtargets'.format(target_group_identifier='target_group_identifier_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_put_auth_policy(client):
    """Test case for put_auth_policy
...
async def test_register_targets(client):
    """Test case for register_targets
    ...
    response = await client.request(
        method='POST',
        path='/targetgroups/{target_group_identifier}/registertargets'.format(target_group_identifier='target_group_identifier_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_access_log_subscription(client):
    """Test case for update_access_log_subscription
...
async def test_update_listener(client):
    """Test case for update_listener

    
    """
    body = {"defaultAction":{"forward":{"targetGroups":""},"fixedResponse":{"statusCode":""}}}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_update_rule(client):
    ...
    """
    body = {"match":{"httpMatch":{"headerMatches":"","method":"","pathMatch":{"caseSensitive":"","match":{"prefix":"","exact":""}}}},"action":{"forward":{"targetGroups":""},"fixedResponse":{"statusCode":""}},"priority":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_update_service_network(client):
    """Test case for update_service_network
...
async def test_update_service_network_vpc_association(client):
    """Test case for update_service_network_vpc_association
...
async def test_update_target_group(client):
    """Test case for update_target_group

    
    """
    body = {"healthCheck":{"path":"","protocol":"","port":"","healthCheckIntervalSeconds":"","healthCheckTimeoutSeconds":"","healthyThresholdCount":"","protocolVersion":"","matcher":{"httpCode":""},"enabled":"","unhealthyThresholdCount":""}}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
