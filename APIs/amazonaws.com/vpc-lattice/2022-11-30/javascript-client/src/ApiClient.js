...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://vpc-lattice.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://vpc-lattice.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2022-11-30/Javascript'
        };
