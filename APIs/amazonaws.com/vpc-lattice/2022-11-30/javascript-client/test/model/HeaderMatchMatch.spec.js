...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVpcLattice.HeaderMatchMatch();
  });
  ...
  describe('HeaderMatchMatch', function() {
    it('should create an instance of HeaderMatchMatch', function() {
      // uncomment below and update the code to test HeaderMatchMatch
      //var instance = new AmazonVpcLattice.HeaderMatchMatch();
      //expect(instance).to.be.a(AmazonVpcLattice.HeaderMatchMatch);
    });
