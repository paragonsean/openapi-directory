...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVpcLattice.HeaderMatch();
  });
  ...
  describe('HeaderMatch', function() {
    it('should create an instance of HeaderMatch', function() {
      // uncomment below and update the code to test HeaderMatch
      //var instance = new AmazonVpcLattice.HeaderMatch();
      //expect(instance).to.be.a(AmazonVpcLattice.HeaderMatch);
    });
