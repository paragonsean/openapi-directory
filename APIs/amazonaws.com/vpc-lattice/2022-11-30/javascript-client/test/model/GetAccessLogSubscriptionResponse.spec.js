...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVpcLattice.GetAccessLogSubscriptionResponse();
  });
  ...
  describe('GetAccessLogSubscriptionResponse', function() {
    it('should create an instance of GetAccessLogSubscriptionResponse', function() {
      // uncomment below and update the code to test GetAccessLogSubscriptionResponse
      //var instance = new AmazonVpcLattice.GetAccessLogSubscriptionResponse();
      //expect(instance).to.be.a(AmazonVpcLattice.GetAccessLogSubscriptionResponse);
    });
