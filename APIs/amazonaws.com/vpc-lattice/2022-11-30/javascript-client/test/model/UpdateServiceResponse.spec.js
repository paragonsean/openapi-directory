...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVpcLattice.UpdateServiceResponse();
  });
  ...
  describe('UpdateServiceResponse', function() {
    it('should create an instance of UpdateServiceResponse', function() {
      // uncomment below and update the code to test UpdateServiceResponse
      //var instance = new AmazonVpcLattice.UpdateServiceResponse();
      //expect(instance).to.be.a(AmazonVpcLattice.UpdateServiceResponse);
    });
