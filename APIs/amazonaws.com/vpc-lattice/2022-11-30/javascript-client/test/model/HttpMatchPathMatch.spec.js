...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVpcLattice.HttpMatchPathMatch();
  });
  ...
  describe('HttpMatchPathMatch', function() {
    it('should create an instance of HttpMatchPathMatch', function() {
      // uncomment below and update the code to test HttpMatchPathMatch
      //var instance = new AmazonVpcLattice.HttpMatchPathMatch();
      //expect(instance).to.be.a(AmazonVpcLattice.HttpMatchPathMatch);
    });
