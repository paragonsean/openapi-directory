...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVpcLattice.RuleUpdateSuccess();
  });
  ...
  describe('RuleUpdateSuccess', function() {
    it('should create an instance of RuleUpdateSuccess', function() {
      // uncomment below and update the code to test RuleUpdateSuccess
      //var instance = new AmazonVpcLattice.RuleUpdateSuccess();
      //expect(instance).to.be.a(AmazonVpcLattice.RuleUpdateSuccess);
    });
