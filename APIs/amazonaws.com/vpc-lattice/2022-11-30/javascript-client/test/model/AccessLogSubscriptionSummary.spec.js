...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVpcLattice.AccessLogSubscriptionSummary();
  });
  ...
  describe('AccessLogSubscriptionSummary', function() {
    it('should create an instance of AccessLogSubscriptionSummary', function() {
      // uncomment below and update the code to test AccessLogSubscriptionSummary
      //var instance = new AmazonVpcLattice.AccessLogSubscriptionSummary();
      //expect(instance).to.be.a(AmazonVpcLattice.AccessLogSubscriptionSummary);
    });
