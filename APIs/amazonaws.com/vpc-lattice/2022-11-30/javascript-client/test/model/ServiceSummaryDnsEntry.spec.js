...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVpcLattice.ServiceSummaryDnsEntry();
  });
  ...
  describe('ServiceSummaryDnsEntry', function() {
    it('should create an instance of ServiceSummaryDnsEntry', function() {
      // uncomment below and update the code to test ServiceSummaryDnsEntry
      //var instance = new AmazonVpcLattice.ServiceSummaryDnsEntry();
      //expect(instance).to.be.a(AmazonVpcLattice.ServiceSummaryDnsEntry);
    });
