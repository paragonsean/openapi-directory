...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVpcLattice.PathMatchType();
  });
  ...
  describe('PathMatchType', function() {
    it('should create an instance of PathMatchType', function() {
      // uncomment below and update the code to test PathMatchType
      //var instance = new AmazonVpcLattice.PathMatchType();
      //expect(instance).to.be.a(AmazonVpcLattice.PathMatchType);
    });
