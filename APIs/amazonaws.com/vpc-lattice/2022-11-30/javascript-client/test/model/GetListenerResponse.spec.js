...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVpcLattice.GetListenerResponse();
  });
  ...
  describe('GetListenerResponse', function() {
    it('should create an instance of GetListenerResponse', function() {
      // uncomment below and update the code to test GetListenerResponse
      //var instance = new AmazonVpcLattice.GetListenerResponse();
      //expect(instance).to.be.a(AmazonVpcLattice.GetListenerResponse);
    });
