...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVpcLattice.GetServiceResponse();
  });
  ...
  describe('GetServiceResponse', function() {
    it('should create an instance of GetServiceResponse', function() {
      // uncomment below and update the code to test GetServiceResponse
      //var instance = new AmazonVpcLattice.GetServiceResponse();
      //expect(instance).to.be.a(AmazonVpcLattice.GetServiceResponse);
    });
