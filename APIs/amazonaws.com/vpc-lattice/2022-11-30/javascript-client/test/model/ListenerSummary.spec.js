...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVpcLattice.ListenerSummary();
  });
  ...
  describe('ListenerSummary', function() {
    it('should create an instance of ListenerSummary', function() {
      // uncomment below and update the code to test ListenerSummary
      //var instance = new AmazonVpcLattice.ListenerSummary();
      //expect(instance).to.be.a(AmazonVpcLattice.ListenerSummary);
    });
