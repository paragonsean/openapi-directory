...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVpcLattice.UpdateServiceRequest();
  });
  ...
  describe('UpdateServiceRequest', function() {
    it('should create an instance of UpdateServiceRequest', function() {
      ...
      //var instance = new AmazonVpcLattice.UpdateServiceRequest();
      //expect(instance).to.be.a(AmazonVpcLattice.UpdateServiceRequest);
    });
