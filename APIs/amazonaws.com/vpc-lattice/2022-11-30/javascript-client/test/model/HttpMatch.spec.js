...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVpcLattice.HttpMatch();
  });
  ...
  describe('HttpMatch', function() {
    it('should create an instance of HttpMatch', function() {
      // uncomment below and update the code to test HttpMatch
      //var instance = new AmazonVpcLattice.HttpMatch();
      //expect(instance).to.be.a(AmazonVpcLattice.HttpMatch);
    });
