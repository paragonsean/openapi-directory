...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVpcLattice.UpdateTargetGroupRequestHealthCheck();
  });
  ...
  describe('UpdateTargetGroupRequestHealthCheck', function() {
    it('should create an instance of UpdateTargetGroupRequestHealthCheck', function() {
      // uncomment below and update the code to test UpdateTargetGroupRequestHealthCheck
      //var instance = new AmazonVpcLattice.UpdateTargetGroupRequestHealthCheck();
      //expect(instance).to.be.a(AmazonVpcLattice.UpdateTargetGroupRequestHealthCheck);
    });
