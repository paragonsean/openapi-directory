...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVpcLattice.CreateServiceRequest();
  });
  ...
  describe('CreateServiceRequest', function() {
    it('should create an instance of CreateServiceRequest', function() {
      ...
      //var instance = new AmazonVpcLattice.CreateServiceRequest();
      //expect(instance).to.be.a(AmazonVpcLattice.CreateServiceRequest);
    });
