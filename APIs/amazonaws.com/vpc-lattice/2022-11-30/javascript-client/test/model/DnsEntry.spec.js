...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVpcLattice.DnsEntry();
  });
  ...
  describe('DnsEntry', function() {
    it('should create an instance of DnsEntry', function() {
      // uncomment below and update the code to test DnsEntry
      //var instance = new AmazonVpcLattice.DnsEntry();
      //expect(instance).to.be.a(AmazonVpcLattice.DnsEntry);
    });
