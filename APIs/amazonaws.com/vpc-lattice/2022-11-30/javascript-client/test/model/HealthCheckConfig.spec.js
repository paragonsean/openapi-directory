...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVpcLattice.HealthCheckConfig();
  });
  ...
  describe('HealthCheckConfig', function() {
    it('should create an instance of HealthCheckConfig', function() {
      ...
      //var instance = new AmazonVpcLattice.HealthCheckConfig();
      //expect(instance).to.be.a(AmazonVpcLattice.HealthCheckConfig);
    });
