...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVpcLattice.CreateRuleRequest();
  });
  ...
  describe('CreateRuleRequest', function() {
    it('should create an instance of CreateRuleRequest', function() {
      ...
      //var instance = new AmazonVpcLattice.CreateRuleRequest();
      //expect(instance).to.be.a(AmazonVpcLattice.CreateRuleRequest);
    });
