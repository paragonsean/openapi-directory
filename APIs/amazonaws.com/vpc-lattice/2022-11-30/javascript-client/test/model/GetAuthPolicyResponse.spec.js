...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVpcLattice.GetAuthPolicyResponse();
  });
  ...
  describe('GetAuthPolicyResponse', function() {
    it('should create an instance of GetAuthPolicyResponse', function() {
      // uncomment below and update the code to test GetAuthPolicyResponse
      //var instance = new AmazonVpcLattice.GetAuthPolicyResponse();
      //expect(instance).to.be.a(AmazonVpcLattice.GetAuthPolicyResponse);
    });
