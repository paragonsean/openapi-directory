...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVpcLattice.UpdateRuleResponse();
  });
  ...
  describe('UpdateRuleResponse', function() {
    it('should create an instance of UpdateRuleResponse', function() {
      ...
      //var instance = new AmazonVpcLattice.UpdateRuleResponse();
      //expect(instance).to.be.a(AmazonVpcLattice.UpdateRuleResponse);
    });
