...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVpcLattice.GetRuleResponse();
  });
  ...
  describe('GetRuleResponse', function() {
    it('should create an instance of GetRuleResponse', function() {
      ...
      //var instance = new AmazonVpcLattice.GetRuleResponse();
      //expect(instance).to.be.a(AmazonVpcLattice.GetRuleResponse);
    });
