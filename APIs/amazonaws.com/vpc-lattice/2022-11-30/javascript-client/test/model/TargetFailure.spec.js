...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVpcLattice.TargetFailure();
  });
  ...
  describe('TargetFailure', function() {
    it('should create an instance of TargetFailure', function() {
      // uncomment below and update the code to test TargetFailure
      //var instance = new AmazonVpcLattice.TargetFailure();
      //expect(instance).to.be.a(AmazonVpcLattice.TargetFailure);
    });
