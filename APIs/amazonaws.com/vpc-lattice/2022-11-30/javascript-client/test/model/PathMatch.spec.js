...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVpcLattice.PathMatch();
  });
  ...
  describe('PathMatch', function() {
    it('should create an instance of PathMatch', function() {
      // uncomment below and update the code to test PathMatch
      //var instance = new AmazonVpcLattice.PathMatch();
      //expect(instance).to.be.a(AmazonVpcLattice.PathMatch);
    });
