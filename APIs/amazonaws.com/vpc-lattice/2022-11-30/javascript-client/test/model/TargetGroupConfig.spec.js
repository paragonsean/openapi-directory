...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVpcLattice.TargetGroupConfig();
  });
  ...
  describe('TargetGroupConfig', function() {
    it('should create an instance of TargetGroupConfig', function() {
      // uncomment below and update the code to test TargetGroupConfig
      //var instance = new AmazonVpcLattice.TargetGroupConfig();
      //expect(instance).to.be.a(AmazonVpcLattice.TargetGroupConfig);
    });
