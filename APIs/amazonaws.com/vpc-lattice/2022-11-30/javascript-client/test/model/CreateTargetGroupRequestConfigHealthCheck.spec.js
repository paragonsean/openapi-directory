...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVpcLattice.CreateTargetGroupRequestConfigHealthCheck();
  });
  ...
  describe('CreateTargetGroupRequestConfigHealthCheck', function() {
    it('should create an instance of CreateTargetGroupRequestConfigHealthCheck', function() {
      // uncomment below and update the code to test CreateTargetGroupRequestConfigHealthCheck
      //var instance = new AmazonVpcLattice.CreateTargetGroupRequestConfigHealthCheck();
      //expect(instance).to.be.a(AmazonVpcLattice.CreateTargetGroupRequestConfigHealthCheck);
    });
