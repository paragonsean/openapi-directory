...
|**port** | **Integer** | The listener port. You can specify a value from &lt;code&gt;1&lt;/code&gt; to &lt;code&gt;65535&lt;/code&gt;. For HTTP, the default is &lt;code&gt;80&lt;/code&gt;. For HTTPS, the default is &lt;code&gt;443&lt;/code&gt;. |  [optional] |
|**protocol** | [**ProtocolEnum**](#ProtocolEnum) | The listener protocol HTTP or HTTPS. |  |
|**tags** | **Map&lt;String, String&gt;** | The tags for the listener. |  [optional] |
