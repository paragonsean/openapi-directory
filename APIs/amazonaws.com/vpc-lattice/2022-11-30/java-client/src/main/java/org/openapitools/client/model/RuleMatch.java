...
public class RuleMatch {
  ...
  public RuleMatch httpMatch(CreateRuleRequestMatchHttpMatch httpMatch) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.httpMatch, ruleMatch.httpMatch);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RuleMatch.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RuleMatch` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
