...
public class CreateTargetGroupRequestConfigHealthCheck {
  ...
  public CreateTargetGroupRequestConfigHealthCheck() {
  }

  public CreateTargetGroupRequestConfigHealthCheck enabled(Boolean enabled) {
  ...
  public CreateTargetGroupRequestConfigHealthCheck healthCheckIntervalSeconds(Integer healthCheckIntervalSeconds) {
  ...
  public CreateTargetGroupRequestConfigHealthCheck healthCheckTimeoutSeconds(Integer healthCheckTimeoutSeconds) {
  ...
  public CreateTargetGroupRequestConfigHealthCheck healthyThresholdCount(Integer healthyThresholdCount) {
  ...
  public CreateTargetGroupRequestConfigHealthCheck matcher(UpdateTargetGroupRequestHealthCheckMatcher matcher) {
  ...
  public CreateTargetGroupRequestConfigHealthCheck path(String path) {
    this.path = path;
    return this;
  }
  ...
  public CreateTargetGroupRequestConfigHealthCheck port(Integer port) {
    this.port = port;
    return this;
  }
  ...
  public CreateTargetGroupRequestConfigHealthCheck protocol(TargetGroupProtocol protocol) {
  ...
  public CreateTargetGroupRequestConfigHealthCheck protocolVersion(HealthCheckProtocolVersion protocolVersion) {
  ...
  public CreateTargetGroupRequestConfigHealthCheck unhealthyThresholdCount(Integer unhealthyThresholdCount) {
  ...
  public boolean equals(Object o) {
    ...
    CreateTargetGroupRequestConfigHealthCheck createTargetGroupRequestConfigHealthCheck = (CreateTargetGroupRequestConfigHealthCheck) o;
    return Objects.equals(this.enabled, createTargetGroupRequestConfigHealthCheck.enabled) &&
        Objects.equals(this.healthCheckIntervalSeconds, createTargetGroupRequestConfigHealthCheck.healthCheckIntervalSeconds) &&
        Objects.equals(this.healthCheckTimeoutSeconds, createTargetGroupRequestConfigHealthCheck.healthCheckTimeoutSeconds) &&
        Objects.equals(this.healthyThresholdCount, createTargetGroupRequestConfigHealthCheck.healthyThresholdCount) &&
        Objects.equals(this.matcher, createTargetGroupRequestConfigHealthCheck.matcher) &&
        Objects.equals(this.path, createTargetGroupRequestConfigHealthCheck.path) &&
        Objects.equals(this.port, createTargetGroupRequestConfigHealthCheck.port) &&
        Objects.equals(this.protocol, createTargetGroupRequestConfigHealthCheck.protocol) &&
        Objects.equals(this.protocolVersion, createTargetGroupRequestConfigHealthCheck.protocolVersion) &&
        Objects.equals(this.unhealthyThresholdCount, createTargetGroupRequestConfigHealthCheck.unhealthyThresholdCount);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateTargetGroupRequestConfigHealthCheck {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateTargetGroupRequestConfigHealthCheck
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateTargetGroupRequestConfigHealthCheck.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateTargetGroupRequestConfigHealthCheck is not found in the empty JSON string", CreateTargetGroupRequestConfigHealthCheck.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateTargetGroupRequestConfigHealthCheck.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateTargetGroupRequestConfigHealthCheck` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateTargetGroupRequestConfigHealthCheck.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateTargetGroupRequestConfigHealthCheck' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateTargetGroupRequestConfigHealthCheck> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateTargetGroupRequestConfigHealthCheck.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateTargetGroupRequestConfigHealthCheck>() {
           @Override
           public void write(JsonWriter out, CreateTargetGroupRequestConfigHealthCheck value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateTargetGroupRequestConfigHealthCheck read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateTargetGroupRequestConfigHealthCheck given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateTargetGroupRequestConfigHealthCheck
   * @throws IOException if the JSON string is invalid with respect to CreateTargetGroupRequestConfigHealthCheck
   */
  public static CreateTargetGroupRequestConfigHealthCheck fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateTargetGroupRequestConfigHealthCheck.class);
  }

  /**
   * Convert an instance of CreateTargetGroupRequestConfigHealthCheck to an JSON string
   *
   * @return JSON string
   */
