...
public class CreateTargetGroupRequestConfig {
  ...
  public CreateTargetGroupRequestConfig() {
  }

  public CreateTargetGroupRequestConfig healthCheck(CreateTargetGroupRequestConfigHealthCheck healthCheck) {
  ...
  public CreateTargetGroupRequestConfig ipAddressType(IpAddressType ipAddressType) {
  ...
  public CreateTargetGroupRequestConfig port(Integer port) {
    this.port = port;
    return this;
  }
  ...
  public CreateTargetGroupRequestConfig protocol(TargetGroupProtocol protocol) {
  ...
  public CreateTargetGroupRequestConfig protocolVersion(TargetGroupProtocolVersion protocolVersion) {
  ...
  public CreateTargetGroupRequestConfig vpcIdentifier(String vpcIdentifier) {
  ...
  public boolean equals(Object o) {
    ...
    CreateTargetGroupRequestConfig createTargetGroupRequestConfig = (CreateTargetGroupRequestConfig) o;
    return Objects.equals(this.healthCheck, createTargetGroupRequestConfig.healthCheck) &&
        Objects.equals(this.ipAddressType, createTargetGroupRequestConfig.ipAddressType) &&
        Objects.equals(this.port, createTargetGroupRequestConfig.port) &&
        Objects.equals(this.protocol, createTargetGroupRequestConfig.protocol) &&
        Objects.equals(this.protocolVersion, createTargetGroupRequestConfig.protocolVersion) &&
        Objects.equals(this.vpcIdentifier, createTargetGroupRequestConfig.vpcIdentifier);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateTargetGroupRequestConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateTargetGroupRequestConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateTargetGroupRequestConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateTargetGroupRequestConfig is not found in the empty JSON string", CreateTargetGroupRequestConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateTargetGroupRequestConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateTargetGroupRequestConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateTargetGroupRequestConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateTargetGroupRequestConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateTargetGroupRequestConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateTargetGroupRequestConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateTargetGroupRequestConfig>() {
           @Override
           public void write(JsonWriter out, CreateTargetGroupRequestConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateTargetGroupRequestConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateTargetGroupRequestConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateTargetGroupRequestConfig
   * @throws IOException if the JSON string is invalid with respect to CreateTargetGroupRequestConfig
   */
  public static CreateTargetGroupRequestConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateTargetGroupRequestConfig.class);
  }

  /**
   * Convert an instance of CreateTargetGroupRequestConfig to an JSON string
   *
   * @return JSON string
   */
