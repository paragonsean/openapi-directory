...
public class GetTargetGroupResponseConfig {
  ...
  public GetTargetGroupResponseConfig() {
  }

  public GetTargetGroupResponseConfig healthCheck(CreateTargetGroupRequestConfigHealthCheck healthCheck) {
  ...
  public GetTargetGroupResponseConfig ipAddressType(IpAddressType ipAddressType) {
  ...
  public GetTargetGroupResponseConfig port(Integer port) {
    this.port = port;
    return this;
  }
  ...
  public GetTargetGroupResponseConfig protocol(TargetGroupProtocol protocol) {
  ...
  public GetTargetGroupResponseConfig protocolVersion(TargetGroupProtocolVersion protocolVersion) {
  ...
  public GetTargetGroupResponseConfig vpcIdentifier(String vpcIdentifier) {
  ...
  public boolean equals(Object o) {
    ...
    GetTargetGroupResponseConfig getTargetGroupResponseConfig = (GetTargetGroupResponseConfig) o;
    return Objects.equals(this.healthCheck, getTargetGroupResponseConfig.healthCheck) &&
        Objects.equals(this.ipAddressType, getTargetGroupResponseConfig.ipAddressType) &&
        Objects.equals(this.port, getTargetGroupResponseConfig.port) &&
        Objects.equals(this.protocol, getTargetGroupResponseConfig.protocol) &&
        Objects.equals(this.protocolVersion, getTargetGroupResponseConfig.protocolVersion) &&
        Objects.equals(this.vpcIdentifier, getTargetGroupResponseConfig.vpcIdentifier);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetTargetGroupResponseConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetTargetGroupResponseConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetTargetGroupResponseConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetTargetGroupResponseConfig is not found in the empty JSON string", GetTargetGroupResponseConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetTargetGroupResponseConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetTargetGroupResponseConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetTargetGroupResponseConfig.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetTargetGroupResponseConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetTargetGroupResponseConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetTargetGroupResponseConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetTargetGroupResponseConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<GetTargetGroupResponseConfig>() {
           @Override
           public void write(JsonWriter out, GetTargetGroupResponseConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetTargetGroupResponseConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetTargetGroupResponseConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetTargetGroupResponseConfig
   * @throws IOException if the JSON string is invalid with respect to GetTargetGroupResponseConfig
   */
  public static GetTargetGroupResponseConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetTargetGroupResponseConfig.class);
  }

  /**
   * Convert an instance of GetTargetGroupResponseConfig to an JSON string
   *
   * @return JSON string
   */
