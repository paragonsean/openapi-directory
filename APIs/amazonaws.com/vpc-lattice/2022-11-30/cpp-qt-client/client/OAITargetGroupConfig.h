...
class OAITargetGroupConfig : public OAIObject {
public:
    OAITargetGroupConfig();
    OAITargetGroupConfig(QString json);
    ~OAITargetGroupConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITargetGroupConfig)

#endif // OAITargetGroupConfig_H
