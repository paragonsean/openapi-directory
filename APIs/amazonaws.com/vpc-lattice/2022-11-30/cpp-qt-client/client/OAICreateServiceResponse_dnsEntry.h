...
/*
 * OAICreateServiceResponse_dnsEntry.h
 *
 * 
 */

#ifndef OAICreateServiceResponse_dnsEntry_H
#define OAICreateServiceResponse_dnsEntry_H
...
class OAICreateServiceResponse_dnsEntry : public OAIObject {
public:
    OAICreateServiceResponse_dnsEntry();
    OAICreateServiceResponse_dnsEntry(QString json);
    ~OAICreateServiceResponse_dnsEntry() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateServiceResponse_dnsEntry)

#endif // OAICreateServiceResponse_dnsEntry_H
