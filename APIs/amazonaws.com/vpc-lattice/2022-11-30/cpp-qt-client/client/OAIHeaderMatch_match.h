...
/*
 * OAIHeaderMatch_match.h
 *
 * 
 */

#ifndef OAIHeaderMatch_match_H
#define OAIHeaderMatch_match_H
...
class OAIHeaderMatch_match : public OAIObject {
public:
    OAIHeaderMatch_match();
    OAIHeaderMatch_match(QString json);
    ~OAIHeaderMatch_match() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHeaderMatch_match)

#endif // OAIHeaderMatch_match_H
