...
/*
 * OAIServiceSummary_dnsEntry.h
 *
 * 
 */

#ifndef OAIServiceSummary_dnsEntry_H
#define OAIServiceSummary_dnsEntry_H
...
class OAIServiceSummary_dnsEntry : public OAIObject {
public:
    OAIServiceSummary_dnsEntry();
    OAIServiceSummary_dnsEntry(QString json);
    ~OAIServiceSummary_dnsEntry() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIServiceSummary_dnsEntry)

#endif // OAIServiceSummary_dnsEntry_H
