...
/*
 * OAIGetAccessLogSubscriptionResponse.h
 *
 * 
 */

#ifndef OAIGetAccessLogSubscriptionResponse_H
#define OAIGetAccessLogSubscriptionResponse_H
...
class OAIGetAccessLogSubscriptionResponse : public OAIObject {
public:
    OAIGetAccessLogSubscriptionResponse();
    OAIGetAccessLogSubscriptionResponse(QString json);
    ~OAIGetAccessLogSubscriptionResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetAccessLogSubscriptionResponse)

#endif // OAIGetAccessLogSubscriptionResponse_H
