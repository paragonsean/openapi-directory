...
/*
 * OAICreateTargetGroupResponse_config.h
 *
 * 
 */

#ifndef OAICreateTargetGroupResponse_config_H
#define OAICreateTargetGroupResponse_config_H
...
class OAICreateTargetGroupResponse_config : public OAIObject {
public:
    OAICreateTargetGroupResponse_config();
    OAICreateTargetGroupResponse_config(QString json);
    ~OAICreateTargetGroupResponse_config() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateTargetGroupResponse_config)

#endif // OAICreateTargetGroupResponse_config_H
