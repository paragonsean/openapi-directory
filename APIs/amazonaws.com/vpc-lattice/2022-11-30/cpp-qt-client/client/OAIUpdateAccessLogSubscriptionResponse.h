...
/*
 * OAIUpdateAccessLogSubscriptionResponse.h
 *
 * 
 */

#ifndef OAIUpdateAccessLogSubscriptionResponse_H
#define OAIUpdateAccessLogSubscriptionResponse_H
...
class OAIUpdateAccessLogSubscriptionResponse : public OAIObject {
public:
    OAIUpdateAccessLogSubscriptionResponse();
    OAIUpdateAccessLogSubscriptionResponse(QString json);
    ~OAIUpdateAccessLogSubscriptionResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateAccessLogSubscriptionResponse)

#endif // OAIUpdateAccessLogSubscriptionResponse_H
