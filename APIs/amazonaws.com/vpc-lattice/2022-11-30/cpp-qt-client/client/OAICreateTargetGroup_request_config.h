...
/*
 * OAICreateTargetGroup_request_config.h
 *
 * Describes the configuration of a target group. Lambda functions don&#39;t support target group configuration.
 */

#ifndef OAICreateTargetGroup_request_config_H
#define OAICreateTargetGroup_request_config_H
...
class OAICreateTargetGroup_request_config : public OAIObject {
public:
    OAICreateTargetGroup_request_config();
    OAICreateTargetGroup_request_config(QString json);
    ~OAICreateTargetGroup_request_config() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateTargetGroup_request_config)

#endif // OAICreateTargetGroup_request_config_H
