...
#ifndef OAIDnsEntry_H
#define OAIDnsEntry_H
...
class OAIDnsEntry : public OAIObject {
public:
    OAIDnsEntry();
    OAIDnsEntry(QString json);
    ~OAIDnsEntry() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDnsEntry)
