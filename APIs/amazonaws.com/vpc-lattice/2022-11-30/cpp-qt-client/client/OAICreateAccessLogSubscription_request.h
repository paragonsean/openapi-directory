...
/*
 * OAICreateAccessLogSubscription_request.h
 *
 * 
 */

#ifndef OAICreateAccessLogSubscription_request_H
#define OAICreateAccessLogSubscription_request_H
...
class OAICreateAccessLogSubscription_request : public OAIObject {
public:
    OAICreateAccessLogSubscription_request();
    OAICreateAccessLogSubscription_request(QString json);
    ~OAICreateAccessLogSubscription_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateAccessLogSubscription_request)

#endif // OAICreateAccessLogSubscription_request_H
