...
/*
 * OAIRuleUpdateSuccess.h
 *
 * Describes a successful rule update.
 */

#ifndef OAIRuleUpdateSuccess_H
#define OAIRuleUpdateSuccess_H
...
class OAIRuleUpdateSuccess : public OAIObject {
public:
    OAIRuleUpdateSuccess();
    OAIRuleUpdateSuccess(QString json);
    ~OAIRuleUpdateSuccess() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRuleUpdateSuccess)

#endif // OAIRuleUpdateSuccess_H
