...
/*
 * OAICreateTargetGroup_request_config_healthCheck.h
 *
 * 
 */

#ifndef OAICreateTargetGroup_request_config_healthCheck_H
#define OAICreateTargetGroup_request_config_healthCheck_H
...
class OAICreateTargetGroup_request_config_healthCheck : public OAIObject {
public:
    OAICreateTargetGroup_request_config_healthCheck();
    OAICreateTargetGroup_request_config_healthCheck(QString json);
    ~OAICreateTargetGroup_request_config_healthCheck() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateTargetGroup_request_config_healthCheck)

#endif // OAICreateTargetGroup_request_config_healthCheck_H
