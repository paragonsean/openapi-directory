...
/*
 * OAIBatchUpdateRuleResponse.h
 *
 * 
 */

#ifndef OAIBatchUpdateRuleResponse_H
#define OAIBatchUpdateRuleResponse_H
...
class OAIBatchUpdateRuleResponse : public OAIObject {
public:
    OAIBatchUpdateRuleResponse();
    OAIBatchUpdateRuleResponse(QString json);
    ~OAIBatchUpdateRuleResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchUpdateRuleResponse)

#endif // OAIBatchUpdateRuleResponse_H
