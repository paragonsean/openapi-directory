...
public class PathRequest {
  ...
  public PathRequest antenna(Antenna antenna) {
  ...
  public PathRequest environment(Environment environment) {
  ...
  public PathRequest model(Model model) {
    this.model = model;
    return this;
  }
  ...
  public PathRequest network(String network) {
  ...
  public PathRequest output(Output output) {
    this.output = output;
    return this;
  }
  ...
  public PathRequest receiver(Receiver receiver) {
  ...
  public PathRequest site(String site) {
    this.site = site;
    return this;
  }
  ...
  public PathRequest transmitter(Transmitter transmitter) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.antenna, pathRequest.antenna) &&
        Objects.equals(this.environment, pathRequest.environment) &&
        Objects.equals(this.model, pathRequest.model) &&
        Objects.equals(this.network, pathRequest.network) &&
        Objects.equals(this.output, pathRequest.output) &&
        Objects.equals(this.receiver, pathRequest.receiver) &&
        Objects.equals(this.site, pathRequest.site) &&
        Objects.equals(this.transmitter, pathRequest.transmitter);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PathRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PathRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PathRequest is not found in the empty JSON string", PathRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PathRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PathRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PathRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PathRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PathRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PathRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PathRequest>() {
           @Override
           public void write(JsonWriter out, PathRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PathRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PathRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PathRequest
   * @throws IOException if the JSON string is invalid with respect to PathRequest
   */
  public static PathRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PathRequest.class);
  }

  /**
   * Convert an instance of PathRequest to an JSON string
   *
   * @return JSON string
   */
