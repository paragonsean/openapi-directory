...
public class ApiClient {
    ...
    private String basePath = "https://api.cloudrf.com";
    ...
    public ApiClient() {
        ...
        authentications.put("ApiKeyAuth", new ApiKeyAuth("header", "key"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.cloudrf.com
