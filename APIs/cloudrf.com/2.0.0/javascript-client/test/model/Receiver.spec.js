...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudRfApi.Receiver();
  });
  ...
  describe('Receiver', function() {
    it('should create an instance of Receiver', function() {
      ...
      //var instance = new CloudRfApi.Receiver();
      //expect(instance).to.be.a(CloudRfApi.Receiver);
    });
    ...
    it('should have the property rxg (base name: "rxg")', function() {
      // uncomment below and update the code to test the property rxg
      //var instance = new CloudRfApi.Receiver();
      //expect(instance).to.be();
    });

    it('should have the property rxs (base name: "rxs")', function() {
      // uncomment below and update the code to test the property rxs
      //var instance = new CloudRfApi.Receiver();
      //expect(instance).to.be();
    });
