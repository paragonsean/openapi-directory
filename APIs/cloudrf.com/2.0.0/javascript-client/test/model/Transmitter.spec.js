...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudRfApi.Transmitter();
  });
  ...
  describe('Transmitter', function() {
    it('should create an instance of Transmitter', function() {
      // uncomment below and update the code to test Transmitter
      //var instance = new CloudRfApi.Transmitter();
      //expect(instance).to.be.a(CloudRfApi.Transmitter);
    });
    ...
    it('should have the property bwi (base name: "bwi")', function() {
      // uncomment below and update the code to test the property bwi
      //var instance = new CloudRfApi.Transmitter();
      //expect(instance).to.be();
    });

    it('should have the property frq (base name: "frq")', function() {
      // uncomment below and update the code to test the property frq
      //var instance = new CloudRfApi.Transmitter();
      //expect(instance).to.be();
    });
    ...
    it('should have the property txw (base name: "txw")', function() {
      // uncomment below and update the code to test the property txw
      //var instance = new CloudRfApi.Transmitter();
      //expect(instance).to.be();
    });
