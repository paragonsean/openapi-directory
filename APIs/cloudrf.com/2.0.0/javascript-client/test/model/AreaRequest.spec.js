...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudRfApi.AreaRequest();
  });
  ...
  describe('AreaRequest', function() {
    it('should create an instance of AreaRequest', function() {
      // uncomment below and update the code to test AreaRequest
      //var instance = new CloudRfApi.AreaRequest();
      //expect(instance).to.be.a(CloudRfApi.AreaRequest);
    });
