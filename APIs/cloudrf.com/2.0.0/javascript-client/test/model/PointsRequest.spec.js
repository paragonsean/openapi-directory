...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudRfApi.PointsRequest();
  });
  ...
  describe('PointsRequest', function() {
    it('should create an instance of PointsRequest', function() {
      // uncomment below and update the code to test PointsRequest
      //var instance = new CloudRfApi.PointsRequest();
      //expect(instance).to.be.a(CloudRfApi.PointsRequest);
    });
