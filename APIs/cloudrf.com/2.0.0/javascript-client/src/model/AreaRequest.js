...
/**
 * The AreaRequest model module.
 * @module model/AreaRequest
 * @version 2.0.0
 */
class AreaRequest {
    /**
     * Constructs a new <code>AreaRequest</code>.
     * @alias module:model/AreaRequest
     */
    constructor() { 
        
        AreaRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AreaRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AreaRequest} obj Optional instance to populate.
     * @return {module:model/AreaRequest} The populated <code>AreaRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AreaRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>AreaRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AreaRequest</code>.
     */
 ...
 */
AreaRequest.prototype['antenna'] = undefined;

/**
 * @member {module:model/Environment} environment
 */
AreaRequest.prototype['environment'] = undefined;

/**
 * @member {module:model/Model} model
 */
AreaRequest.prototype['model'] = undefined;
 ...
 * @default 'Testing'
 */
AreaRequest.prototype['network'] = 'Testing';

/**
 * @member {module:model/Output} output
 */
AreaRequest.prototype['output'] = undefined;

/**
 * @member {module:model/Receiver} receiver
 */
AreaRequest.prototype['receiver'] = undefined;
 ...
 * @default 'A1'
 */
AreaRequest.prototype['site'] = 'A1';

/**
 * @member {module:model/Transmitter} transmitter
 */
AreaRequest.prototype['transmitter'] = undefined;
