...
#ifndef OAIPoints_request_H
#define OAIPoints_request_H
...
class OAIPoints_request : public OAIObject {
public:
    OAIPoints_request();
    OAIPoints_request(QString json);
    ~OAIPoints_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPoints_request)

#endif // OAIPoints_request_H
