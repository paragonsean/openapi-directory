...
#ifndef OAI_OAICloudMonitoringApi_H
#define OAI_OAICloudMonitoringApi_H
...
class OAICloudMonitoringApi : public QObject {
    Q_OBJECT

public:
    OAICloudMonitoringApi(const int timeOut = 0);
    ~OAICloudMonitoringApi();
