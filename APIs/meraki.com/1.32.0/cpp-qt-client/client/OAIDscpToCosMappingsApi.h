...
#ifndef OAI_OAIDscpToCosMappingsApi_H
#define OAI_OAIDscpToCosMappingsApi_H
...
class OAIDscpToCosMappingsApi : public QObject {
    Q_OBJECT

public:
    OAIDscpToCosMappingsApi(const int timeOut = 0);
    ~OAIDscpToCosMappingsApi();
