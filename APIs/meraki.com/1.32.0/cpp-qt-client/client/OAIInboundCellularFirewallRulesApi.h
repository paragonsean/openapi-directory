...
#ifndef OAI_OAIInboundCellularFirewallRulesApi_H
#define OAI_OAIInboundCellularFirewallRulesApi_H
...
class OAIInboundCellularFirewallRulesApi : public QObject {
    Q_OBJECT

public:
    OAIInboundCellularFirewallRulesApi(const int timeOut = 0);
    ~OAIInboundCellularFirewallRulesApi();
