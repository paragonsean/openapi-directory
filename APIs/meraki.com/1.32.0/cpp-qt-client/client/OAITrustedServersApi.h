...
#ifndef OAI_OAITrustedServersApi_H
#define OAI_OAITrustedServersApi_H
...
class OAITrustedServersApi : public QObject {
    Q_OBJECT

public:
    OAITrustedServersApi(const int timeOut = 0);
    ~OAITrustedServersApi();
