...
#ifndef OAI_OAIFailedConnectionsApi_H
#define OAI_OAIFailedConnectionsApi_H
...
class OAIFailedConnectionsApi : public QObject {
    Q_OBJECT

public:
    OAIFailedConnectionsApi(const int timeOut = 0);
    ~OAIFailedConnectionsApi();
