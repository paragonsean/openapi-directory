...
#ifndef OAI_OAINetworkAdaptersApi_H
#define OAI_OAINetworkAdaptersApi_H
...
class OAINetworkAdaptersApi : public QObject {
    Q_OBJECT

public:
    OAINetworkAdaptersApi(const int timeOut = 0);
    ~OAINetworkAdaptersApi();
