...
/*
 * OAIUpdateOrganizationBrandingPolicy_request.h
 *
 * 
 */

#ifndef OAIUpdateOrganizationBrandingPolicy_request_H
#define OAIUpdateOrganizationBrandingPolicy_request_H
...
#include "OAIGetOrganizationBrandingPolicies_200_response_inner_helpSettings.h"
#include <QString>
...
class OAIGetOrganizationBrandingPolicies_200_response_inner_helpSettings;

class OAIUpdateOrganizationBrandingPolicy_request : public OAIObject {
public:
    OAIUpdateOrganizationBrandingPolicy_request();
    OAIUpdateOrganizationBrandingPolicy_request(QString json);
    ~OAIUpdateOrganizationBrandingPolicy_request() override;
    ...
    OAIGetOrganizationBrandingPolicies_200_response_inner_helpSettings getHelpSettings() const;
    void setHelpSettings(const OAIGetOrganizationBrandingPolicies_200_response_inner_helpSettings &help_settings);
...
private:
    ...
    OAIGetOrganizationBrandingPolicies_200_response_inner_helpSettings m_help_settings;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateOrganizationBrandingPolicy_request)

#endif // OAIUpdateOrganizationBrandingPolicy_request_H
