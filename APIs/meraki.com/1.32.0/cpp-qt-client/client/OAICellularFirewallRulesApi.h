...
#ifndef OAI_OAICellularFirewallRulesApi_H
#define OAI_OAICellularFirewallRulesApi_H
...
class OAICellularFirewallRulesApi : public QObject {
    Q_OBJECT

public:
    OAICellularFirewallRulesApi(const int timeOut = 0);
    ~OAICellularFirewallRulesApi();
