...
#ifndef OAI_OAISecurityCentersApi_H
#define OAI_OAISecurityCentersApi_H
...
class OAISecurityCentersApi : public QObject {
    Q_OBJECT

public:
    OAISecurityCentersApi(const int timeOut = 0);
    ~OAISecurityCentersApi();
