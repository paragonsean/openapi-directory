...
#ifndef OAI_OAIBluetoothClientsApi_H
#define OAI_OAIBluetoothClientsApi_H
...
class OAIBluetoothClientsApi : public QObject {
    Q_OBJECT

public:
    OAIBluetoothClientsApi(const int timeOut = 0);
    ~OAIBluetoothClientsApi();
