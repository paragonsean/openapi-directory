...
#ifndef OAI_OAIContentFilteringApi_H
#define OAI_OAIContentFilteringApi_H
...
class OAIContentFilteringApi : public QObject {
    Q_OBJECT

public:
    OAIContentFilteringApi(const int timeOut = 0);
    ~OAIContentFilteringApi();
