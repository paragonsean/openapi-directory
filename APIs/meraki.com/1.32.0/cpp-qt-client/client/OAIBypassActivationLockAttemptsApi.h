...
#ifndef OAI_OAIBypassActivationLockAttemptsApi_H
#define OAI_OAIBypassActivationLockAttemptsApi_H
...
class OAIBypassActivationLockAttemptsApi : public QObject {
    Q_OBJECT

public:
    OAIBypassActivationLockAttemptsApi(const int timeOut = 0);
    ~OAIBypassActivationLockAttemptsApi();
