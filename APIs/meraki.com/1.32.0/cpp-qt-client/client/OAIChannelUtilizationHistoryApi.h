...
#ifndef OAI_OAIChannelUtilizationHistoryApi_H
#define OAI_OAIChannelUtilizationHistoryApi_H
...
class OAIChannelUtilizationHistoryApi : public QObject {
    Q_OBJECT

public:
    OAIChannelUtilizationHistoryApi(const int timeOut = 0);
    ~OAIChannelUtilizationHistoryApi();
