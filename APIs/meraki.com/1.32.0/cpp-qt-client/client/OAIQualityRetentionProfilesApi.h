...
#ifndef OAI_OAIQualityRetentionProfilesApi_H
#define OAI_OAIQualityRetentionProfilesApi_H
...
class OAIQualityRetentionProfilesApi : public QObject {
    Q_OBJECT

public:
    OAIQualityRetentionProfilesApi(const int timeOut = 0);
    ~OAIQualityRetentionProfilesApi();
