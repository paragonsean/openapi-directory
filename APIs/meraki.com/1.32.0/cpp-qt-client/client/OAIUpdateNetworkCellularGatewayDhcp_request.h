...
/*
 * OAIUpdateNetworkCellularGatewayDhcp_request.h
 *
 * 
 */

#ifndef OAIUpdateNetworkCellularGatewayDhcp_request_H
#define OAIUpdateNetworkCellularGatewayDhcp_request_H
...
class OAIUpdateNetworkCellularGatewayDhcp_request : public OAIObject {
public:
    OAIUpdateNetworkCellularGatewayDhcp_request();
    OAIUpdateNetworkCellularGatewayDhcp_request(QString json);
    ~OAIUpdateNetworkCellularGatewayDhcp_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateNetworkCellularGatewayDhcp_request)

#endif // OAIUpdateNetworkCellularGatewayDhcp_request_H
