...
#ifndef OAI_OAISplashAuthorizationStatusApi_H
#define OAI_OAISplashAuthorizationStatusApi_H
...
class OAISplashAuthorizationStatusApi : public QObject {
    Q_OBJECT

public:
    OAISplashAuthorizationStatusApi(const int timeOut = 0);
    ~OAISplashAuthorizationStatusApi();
