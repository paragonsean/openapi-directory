...
#ifndef OAI_OAIUplinkSelectionApi_H
#define OAI_OAIUplinkSelectionApi_H
...
class OAIUplinkSelectionApi : public QObject {
    Q_OBJECT

public:
    OAIUplinkSelectionApi(const int timeOut = 0);
    ~OAIUplinkSelectionApi();
