...
/*
 * OAIGetOrganizationApplianceVpnThirdPartyVPNPeers_200_response_peers_inner_ipsecPolicies.h
 *
 * Custom IPSec policies for the VPN peer. If not included and a preset has not been chosen, the default preset for IPSec policies will be used.
 */

#ifndef OAIGetOrganizationApplianceVpnThirdPartyVPNPeers_200_response_peers_inner_ipsecPolicies_H
#define OAIGetOrganizationApplianceVpnThirdPartyVPNPeers_200_response_peers_inner_ipsecPolicies_H
...
class OAIGetOrganizationApplianceVpnThirdPartyVPNPeers_200_response_peers_inner_ipsecPolicies : public OAIObject {
public:
    OAIGetOrganizationApplianceVpnThirdPartyVPNPeers_200_response_peers_inner_ipsecPolicies();
    OAIGetOrganizationApplianceVpnThirdPartyVPNPeers_200_response_peers_inner_ipsecPolicies(QString json);
    ~OAIGetOrganizationApplianceVpnThirdPartyVPNPeers_200_response_peers_inner_ipsecPolicies() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetOrganizationApplianceVpnThirdPartyVPNPeers_200_response_peers_inner_ipsecPolicies)

#endif // OAIGetOrganizationApplianceVpnThirdPartyVPNPeers_200_response_peers_inner_ipsecPolicies_H
