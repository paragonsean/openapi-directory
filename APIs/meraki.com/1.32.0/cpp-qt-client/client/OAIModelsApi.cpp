...
void OAIModelsApi::getOrganizationSummaryTopDevicesModelsByUsage(const QString &organization_id, const ::OpenAPI::OptionalParam<QString> &t0, const ::OpenAPI::OptionalParam<QString> &t1, const ::OpenAPI::OptionalParam<float> &timespan) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIModelsApi::getOrganizationSummaryTopDevicesModelsByUsageCallback);
...
void OAIModelsApi::getOrganizationSummaryTopDevicesModelsByUsageCallback(OAIHttpRequestWorker *worker) {
