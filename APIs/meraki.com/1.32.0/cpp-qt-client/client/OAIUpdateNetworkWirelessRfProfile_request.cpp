...
OAICreateNetworkWirelessRfProfile_request_perSsidSettings OAIUpdateNetworkWirelessRfProfile_request::getPerSsidSettings() const {
    return m_per_ssid_settings;
}
void OAIUpdateNetworkWirelessRfProfile_request::setPerSsidSettings(const OAICreateNetworkWirelessRfProfile_request_perSsidSettings &per_ssid_settings) {
    m_per_ssid_settings = per_ssid_settings;
    m_per_ssid_settings_isSet = true;
}

bool OAIUpdateNetworkWirelessRfProfile_request::is_per_ssid_settings_Set() const{
    return m_per_ssid_settings_isSet;
}

bool OAIUpdateNetworkWirelessRfProfile_request::is_per_ssid_settings_Valid() const{
    return m_per_ssid_settings_isValid;
}

OAICreateNetworkWirelessRfProfile_request_transmission OAIUpdateNetworkWirelessRfProfile_request::getTransmission() const {
    return m_transmission;
}
void OAIUpdateNetworkWirelessRfProfile_request::setTransmission(const OAICreateNetworkWirelessRfProfile_request_transmission &transmission) {
    m_transmission = transmission;
    m_transmission_isSet = true;
}

bool OAIUpdateNetworkWirelessRfProfile_request::is_transmission_Set() const{
    return m_transmission_isSet;
}

bool OAIUpdateNetworkWirelessRfProfile_request::is_transmission_Valid() const{
