...
#ifndef OAI_OAIUserAccessDevicesApi_H
#define OAI_OAIUserAccessDevicesApi_H
...
class OAIUserAccessDevicesApi : public QObject {
    Q_OBJECT

public:
    OAIUserAccessDevicesApi(const int timeOut = 0);
    ~OAIUserAccessDevicesApi();
