...
#ifndef OAI_OAIUsageHistoriesApi_H
#define OAI_OAIUsageHistoriesApi_H
...
class OAIUsageHistoriesApi : public QObject {
    Q_OBJECT

public:
    OAIUsageHistoriesApi(const int timeOut = 0);
    ~OAIUsageHistoriesApi();
