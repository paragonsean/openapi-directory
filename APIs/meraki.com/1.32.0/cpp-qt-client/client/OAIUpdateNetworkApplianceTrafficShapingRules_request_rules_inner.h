...
/*
 * OAIUpdateNetworkApplianceTrafficShapingRules_request_rules_inner.h
 *
 * 
 */

#ifndef OAIUpdateNetworkApplianceTrafficShapingRules_request_rules_inner_H
#define OAIUpdateNetworkApplianceTrafficShapingRules_request_rules_inner_H
...
class OAIUpdateNetworkApplianceTrafficShapingRules_request_rules_inner : public OAIObject {
public:
    OAIUpdateNetworkApplianceTrafficShapingRules_request_rules_inner();
    OAIUpdateNetworkApplianceTrafficShapingRules_request_rules_inner(QString json);
    ~OAIUpdateNetworkApplianceTrafficShapingRules_request_rules_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateNetworkApplianceTrafficShapingRules_request_rules_inner)

#endif // OAIUpdateNetworkApplianceTrafficShapingRules_request_rules_inner_H
