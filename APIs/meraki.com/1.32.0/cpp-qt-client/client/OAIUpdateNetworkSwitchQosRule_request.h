...
/*
 * OAIUpdateNetworkSwitchQosRule_request.h
 *
 * 
 */

#ifndef OAIUpdateNetworkSwitchQosRule_request_H
#define OAIUpdateNetworkSwitchQosRule_request_H
...
class OAIUpdateNetworkSwitchQosRule_request : public OAIObject {
public:
    OAIUpdateNetworkSwitchQosRule_request();
    OAIUpdateNetworkSwitchQosRule_request(QString json);
    ~OAIUpdateNetworkSwitchQosRule_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateNetworkSwitchQosRule_request)

#endif // OAIUpdateNetworkSwitchQosRule_request_H
