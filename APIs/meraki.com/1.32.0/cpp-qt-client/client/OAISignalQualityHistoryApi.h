...
#ifndef OAI_OAISignalQualityHistoryApi_H
#define OAI_OAISignalQualityHistoryApi_H
...
class OAISignalQualityHistoryApi : public QObject {
    Q_OBJECT

public:
    OAISignalQualityHistoryApi(const int timeOut = 0);
    ~OAISignalQualityHistoryApi();
