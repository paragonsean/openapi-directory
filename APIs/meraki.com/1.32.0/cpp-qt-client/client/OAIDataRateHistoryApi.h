...
#ifndef OAI_OAIDataRateHistoryApi_H
#define OAI_OAIDataRateHistoryApi_H
...
class OAIDataRateHistoryApi : public QObject {
    Q_OBJECT

public:
    OAIDataRateHistoryApi(const int timeOut = 0);
    ~OAIDataRateHistoryApi();
