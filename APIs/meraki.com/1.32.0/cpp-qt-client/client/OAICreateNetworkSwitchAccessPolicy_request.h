...
/*
 * OAICreateNetworkSwitchAccessPolicy_request.h
 *
 * 
 */

#ifndef OAICreateNetworkSwitchAccessPolicy_request_H
#define OAICreateNetworkSwitchAccessPolicy_request_H
...
class OAICreateNetworkSwitchAccessPolicy_request : public OAIObject {
public:
    OAICreateNetworkSwitchAccessPolicy_request();
    OAICreateNetworkSwitchAccessPolicy_request(QString json);
    ~OAICreateNetworkSwitchAccessPolicy_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateNetworkSwitchAccessPolicy_request)

#endif // OAICreateNetworkSwitchAccessPolicy_request_H
