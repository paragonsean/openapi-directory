...
#ifndef OAI_OAIVlanAssignmentsApi_H
#define OAI_OAIVlanAssignmentsApi_H
...
class OAIVlanAssignmentsApi : public QObject {
    Q_OBJECT

public:
    OAIVlanAssignmentsApi(const int timeOut = 0);
    ~OAIVlanAssignmentsApi();
