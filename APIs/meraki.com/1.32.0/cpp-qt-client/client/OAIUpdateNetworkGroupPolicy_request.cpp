...
OAIUpdateNetworkGroupPolicy_request::OAIUpdateNetworkGroupPolicy_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateNetworkGroupPolicy_request::OAIUpdateNetworkGroupPolicy_request() {
    this->initializeModel();
}

OAIUpdateNetworkGroupPolicy_request::~OAIUpdateNetworkGroupPolicy_request() {}

void OAIUpdateNetworkGroupPolicy_request::initializeModel() {
...
void OAIUpdateNetworkGroupPolicy_request::fromJson(QString jsonString) {
...
void OAIUpdateNetworkGroupPolicy_request::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateNetworkGroupPolicy_request::asJson() const {
...
QJsonObject OAIUpdateNetworkGroupPolicy_request::asJsonObject() const {
    QJsonObject obj;
...
OAICreateNetworkGroupPolicy_request_bandwidth OAIUpdateNetworkGroupPolicy_request::getBandwidth() const {
    return m_bandwidth;
}
void OAIUpdateNetworkGroupPolicy_request::setBandwidth(const OAICreateNetworkGroupPolicy_request_bandwidth &bandwidth) {
    m_bandwidth = bandwidth;
    m_bandwidth_isSet = true;
}

bool OAIUpdateNetworkGroupPolicy_request::is_bandwidth_Set() const{
    return m_bandwidth_isSet;
}

bool OAIUpdateNetworkGroupPolicy_request::is_bandwidth_Valid() const{
    return m_bandwidth_isValid;
}

OAICreateNetworkGroupPolicy_request_bonjourForwarding OAIUpdateNetworkGroupPolicy_request::getBonjourForwarding() const {
    return m_bonjour_forwarding;
}
void OAIUpdateNetworkGroupPolicy_request::setBonjourForwarding(const OAICreateNetworkGroupPolicy_request_bonjourForwarding &bonjour_forwarding) {
    m_bonjour_forwarding = bonjour_forwarding;
    m_bonjour_forwarding_isSet = true;
}

bool OAIUpdateNetworkGroupPolicy_request::is_bonjour_forwarding_Set() const{
    return m_bonjour_forwarding_isSet;
}

bool OAIUpdateNetworkGroupPolicy_request::is_bonjour_forwarding_Valid() const{
    return m_bonjour_forwarding_isValid;
}

OAICreateNetworkGroupPolicy_request_contentFiltering OAIUpdateNetworkGroupPolicy_request::getContentFiltering() const {
    return m_content_filtering;
}
void OAIUpdateNetworkGroupPolicy_request::setContentFiltering(const OAICreateNetworkGroupPolicy_request_contentFiltering &content_filtering) {
    m_content_filtering = content_filtering;
    m_content_filtering_isSet = true;
}

bool OAIUpdateNetworkGroupPolicy_request::is_content_filtering_Set() const{
    return m_content_filtering_isSet;
}

bool OAIUpdateNetworkGroupPolicy_request::is_content_filtering_Valid() const{
    return m_content_filtering_isValid;
}

OAICreateNetworkGroupPolicy_request_firewallAndTrafficShaping OAIUpdateNetworkGroupPolicy_request::getFirewallAndTrafficShaping() const {
    return m_firewall_and_traffic_shaping;
}
void OAIUpdateNetworkGroupPolicy_request::setFirewallAndTrafficShaping(const OAICreateNetworkGroupPolicy_request_firewallAndTrafficShaping &firewall_and_traffic_shaping) {
    m_firewall_and_traffic_shaping = firewall_and_traffic_shaping;
    m_firewall_and_traffic_shaping_isSet = true;
}

bool OAIUpdateNetworkGroupPolicy_request::is_firewall_and_traffic_shaping_Set() const{
    return m_firewall_and_traffic_shaping_isSet;
}

bool OAIUpdateNetworkGroupPolicy_request::is_firewall_and_traffic_shaping_Valid() const{
    return m_firewall_and_traffic_shaping_isValid;
}

QString OAIUpdateNetworkGroupPolicy_request::getName() const {
    return m_name;
}
void OAIUpdateNetworkGroupPolicy_request::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIUpdateNetworkGroupPolicy_request::is_name_Set() const{
    return m_name_isSet;
}

bool OAIUpdateNetworkGroupPolicy_request::is_name_Valid() const{
    return m_name_isValid;
}

OAICreateNetworkGroupPolicy_request_scheduling OAIUpdateNetworkGroupPolicy_request::getScheduling() const {
    return m_scheduling;
}
void OAIUpdateNetworkGroupPolicy_request::setScheduling(const OAICreateNetworkGroupPolicy_request_scheduling &scheduling) {
    m_scheduling = scheduling;
    m_scheduling_isSet = true;
}

bool OAIUpdateNetworkGroupPolicy_request::is_scheduling_Set() const{
    return m_scheduling_isSet;
}

bool OAIUpdateNetworkGroupPolicy_request::is_scheduling_Valid() const{
    return m_scheduling_isValid;
}

QString OAIUpdateNetworkGroupPolicy_request::getSplashAuthSettings() const {
    return m_splash_auth_settings;
}
void OAIUpdateNetworkGroupPolicy_request::setSplashAuthSettings(const QString &splash_auth_settings) {
    m_splash_auth_settings = splash_auth_settings;
    m_splash_auth_settings_isSet = true;
}

bool OAIUpdateNetworkGroupPolicy_request::is_splash_auth_settings_Set() const{
    return m_splash_auth_settings_isSet;
}

bool OAIUpdateNetworkGroupPolicy_request::is_splash_auth_settings_Valid() const{
    return m_splash_auth_settings_isValid;
}

OAICreateNetworkGroupPolicy_request_vlanTagging OAIUpdateNetworkGroupPolicy_request::getVlanTagging() const {
    return m_vlan_tagging;
}
void OAIUpdateNetworkGroupPolicy_request::setVlanTagging(const OAICreateNetworkGroupPolicy_request_vlanTagging &vlan_tagging) {
    m_vlan_tagging = vlan_tagging;
    m_vlan_tagging_isSet = true;
}

bool OAIUpdateNetworkGroupPolicy_request::is_vlan_tagging_Set() const{
    return m_vlan_tagging_isSet;
}

bool OAIUpdateNetworkGroupPolicy_request::is_vlan_tagging_Valid() const{
    return m_vlan_tagging_isValid;
}

bool OAIUpdateNetworkGroupPolicy_request::isSet() const {
...
bool OAIUpdateNetworkGroupPolicy_request::isValid() const {
