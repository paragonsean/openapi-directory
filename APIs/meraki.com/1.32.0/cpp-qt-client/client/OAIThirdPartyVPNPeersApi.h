...
#ifndef OAI_OAIThirdPartyVPNPeersApi_H
#define OAI_OAIThirdPartyVPNPeersApi_H
...
class OAIThirdPartyVPNPeersApi : public QObject {
    Q_OBJECT

public:
    OAIThirdPartyVPNPeersApi(const int timeOut = 0);
    ~OAIThirdPartyVPNPeersApi();
