...
#ifndef OAI_OAIRendezvousPointsApi_H
#define OAI_OAIRendezvousPointsApi_H
...
class OAIRendezvousPointsApi : public QObject {
    Q_OBJECT

public:
    OAIRendezvousPointsApi(const int timeOut = 0);
    ~OAIRendezvousPointsApi();
