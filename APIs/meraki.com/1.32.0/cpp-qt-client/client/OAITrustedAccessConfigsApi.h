...
#ifndef OAI_OAITrustedAccessConfigsApi_H
#define OAI_OAITrustedAccessConfigsApi_H
...
class OAITrustedAccessConfigsApi : public QObject {
    Q_OBJECT

public:
    OAITrustedAccessConfigsApi(const int timeOut = 0);
    ~OAITrustedAccessConfigsApi();
