...
#ifndef OAI_OAIChannelUtilizationApi_H
#define OAI_OAIChannelUtilizationApi_H
...
class OAIChannelUtilizationApi : public QObject {
    Q_OBJECT

public:
    OAIChannelUtilizationApi(const int timeOut = 0);
    ~OAIChannelUtilizationApi();
