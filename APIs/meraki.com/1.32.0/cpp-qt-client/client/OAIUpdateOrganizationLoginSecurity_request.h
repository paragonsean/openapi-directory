...
/*
 * OAIUpdateOrganizationLoginSecurity_request.h
 *
 * 
 */

#ifndef OAIUpdateOrganizationLoginSecurity_request_H
#define OAIUpdateOrganizationLoginSecurity_request_H
...
class OAIUpdateOrganizationLoginSecurity_request : public OAIObject {
public:
    OAIUpdateOrganizationLoginSecurity_request();
    OAIUpdateOrganizationLoginSecurity_request(QString json);
    ~OAIUpdateOrganizationLoginSecurity_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateOrganizationLoginSecurity_request)

#endif // OAIUpdateOrganizationLoginSecurity_request_H
