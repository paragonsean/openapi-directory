...
#ifndef OAI_OAIQualityAndRetentionApi_H
#define OAI_OAIQualityAndRetentionApi_H
...
class OAIQualityAndRetentionApi : public QObject {
    Q_OBJECT

public:
    OAIQualityAndRetentionApi(const int timeOut = 0);
    ~OAIQualityAndRetentionApi();
