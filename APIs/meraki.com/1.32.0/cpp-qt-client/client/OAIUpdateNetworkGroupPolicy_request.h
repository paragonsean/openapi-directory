...
/*
 * OAIUpdateNetworkGroupPolicy_request.h
 *
 * 
 */

#ifndef OAIUpdateNetworkGroupPolicy_request_H
#define OAIUpdateNetworkGroupPolicy_request_H
...
class OAIUpdateNetworkGroupPolicy_request : public OAIObject {
public:
    OAIUpdateNetworkGroupPolicy_request();
    OAIUpdateNetworkGroupPolicy_request(QString json);
    ~OAIUpdateNetworkGroupPolicy_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateNetworkGroupPolicy_request)

#endif // OAIUpdateNetworkGroupPolicy_request_H
