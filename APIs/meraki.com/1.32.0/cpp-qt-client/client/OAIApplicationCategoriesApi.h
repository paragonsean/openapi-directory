...
#ifndef OAI_OAIApplicationCategoriesApi_H
#define OAI_OAIApplicationCategoriesApi_H
...
class OAIApplicationCategoriesApi : public QObject {
    Q_OBJECT

public:
    OAIApplicationCategoriesApi(const int timeOut = 0);
    ~OAIApplicationCategoriesApi();
