...
void OAISearchApi::getOrganizationClientsSearch(const QString &organization_id, const QString &mac, const ::OpenAPI::OptionalParam<qint32> &per_page, const ::OpenAPI::OptionalParam<QString> &starting_after, const ::OpenAPI::OptionalParam<QString> &ending_before) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISearchApi::getOrganizationClientsSearchCallback);
...
void OAISearchApi::getOrganizationClientsSearchCallback(OAIHttpRequestWorker *worker) {
