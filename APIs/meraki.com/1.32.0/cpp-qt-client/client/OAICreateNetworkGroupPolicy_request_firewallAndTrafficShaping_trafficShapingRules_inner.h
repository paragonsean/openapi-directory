...
/*
 * OAICreateNetworkGroupPolicy_request_firewallAndTrafficShaping_trafficShapingRules_inner.h
 *
 * 
 */

#ifndef OAICreateNetworkGroupPolicy_request_firewallAndTrafficShaping_trafficShapingRules_inner_H
#define OAICreateNetworkGroupPolicy_request_firewallAndTrafficShaping_trafficShapingRules_inner_H
...
class OAICreateNetworkGroupPolicy_request_firewallAndTrafficShaping_trafficShapingRules_inner : public OAIObject {
public:
    OAICreateNetworkGroupPolicy_request_firewallAndTrafficShaping_trafficShapingRules_inner();
    OAICreateNetworkGroupPolicy_request_firewallAndTrafficShaping_trafficShapingRules_inner(QString json);
    ~OAICreateNetworkGroupPolicy_request_firewallAndTrafficShaping_trafficShapingRules_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateNetworkGroupPolicy_request_firewallAndTrafficShaping_trafficShapingRules_inner)

#endif // OAICreateNetworkGroupPolicy_request_firewallAndTrafficShaping_trafficShapingRules_inner_H
