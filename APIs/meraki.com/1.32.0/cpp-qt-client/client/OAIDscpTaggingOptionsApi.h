...
#ifndef OAI_OAIDscpTaggingOptionsApi_H
#define OAI_OAIDscpTaggingOptionsApi_H
...
class OAIDscpTaggingOptionsApi : public QObject {
    Q_OBJECT

public:
    OAIDscpTaggingOptionsApi(const int timeOut = 0);
    ~OAIDscpTaggingOptionsApi();
