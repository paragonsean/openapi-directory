...
#ifndef OAI_OAIDeviceCommandLogsApi_H
#define OAI_OAIDeviceCommandLogsApi_H
...
class OAIDeviceCommandLogsApi : public QObject {
    Q_OBJECT

public:
    OAIDeviceCommandLogsApi(const int timeOut = 0);
    ~OAIDeviceCommandLogsApi();
