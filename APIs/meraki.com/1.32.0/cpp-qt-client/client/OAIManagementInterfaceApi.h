...
#ifndef OAI_OAIManagementInterfaceApi_H
#define OAI_OAIManagementInterfaceApi_H
...
class OAIManagementInterfaceApi : public QObject {
    Q_OBJECT

public:
    OAIManagementInterfaceApi(const int timeOut = 0);
    ~OAIManagementInterfaceApi();
