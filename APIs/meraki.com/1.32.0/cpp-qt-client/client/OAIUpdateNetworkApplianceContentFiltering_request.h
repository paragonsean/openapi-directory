...
/*
 * OAIUpdateNetworkApplianceContentFiltering_request.h
 *
 * 
 */

#ifndef OAIUpdateNetworkApplianceContentFiltering_request_H
#define OAIUpdateNetworkApplianceContentFiltering_request_H
...
class OAIUpdateNetworkApplianceContentFiltering_request : public OAIObject {
public:
    OAIUpdateNetworkApplianceContentFiltering_request();
    OAIUpdateNetworkApplianceContentFiltering_request(QString json);
    ~OAIUpdateNetworkApplianceContentFiltering_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateNetworkApplianceContentFiltering_request)

#endif // OAIUpdateNetworkApplianceContentFiltering_request_H
