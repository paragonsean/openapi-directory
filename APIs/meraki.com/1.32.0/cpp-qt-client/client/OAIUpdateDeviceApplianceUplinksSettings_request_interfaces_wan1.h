...
/*
 * OAIUpdateDeviceApplianceUplinksSettings_request_interfaces_wan1.h
 *
 * WAN 1 settings.
 */

#ifndef OAIUpdateDeviceApplianceUplinksSettings_request_interfaces_wan1_H
#define OAIUpdateDeviceApplianceUplinksSettings_request_interfaces_wan1_H
...
namespace OpenAPI {
class OAIUpdateDeviceApplianceUplinksSettings_request_interfaces_wan1_pppoe;
...
class OAIUpdateDeviceApplianceUplinksSettings_request_interfaces_wan1 : public OAIObject {
public:
    OAIUpdateDeviceApplianceUplinksSettings_request_interfaces_wan1();
    OAIUpdateDeviceApplianceUplinksSettings_request_interfaces_wan1(QString json);
    ~OAIUpdateDeviceApplianceUplinksSettings_request_interfaces_wan1() override;
    ...
    OAIUpdateDeviceApplianceUplinksSettings_request_interfaces_wan1_pppoe getPppoe() const;
    void setPppoe(const OAIUpdateDeviceApplianceUplinksSettings_request_interfaces_wan1_pppoe &pppoe);
...
private:
    ...
    OAIUpdateDeviceApplianceUplinksSettings_request_interfaces_wan1_pppoe m_pppoe;
    bool m_pppoe_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateDeviceApplianceUplinksSettings_request_interfaces_wan1)

#endif // OAIUpdateDeviceApplianceUplinksSettings_request_interfaces_wan1_H
