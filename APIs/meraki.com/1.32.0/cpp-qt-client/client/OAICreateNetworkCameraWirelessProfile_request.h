...
/*
 * OAICreateNetworkCameraWirelessProfile_request.h
 *
 * 
 */

#ifndef OAICreateNetworkCameraWirelessProfile_request_H
#define OAICreateNetworkCameraWirelessProfile_request_H
...
class OAICreateNetworkCameraWirelessProfile_request : public OAIObject {
public:
    OAICreateNetworkCameraWirelessProfile_request();
    OAICreateNetworkCameraWirelessProfile_request(QString json);
    ~OAICreateNetworkCameraWirelessProfile_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateNetworkCameraWirelessProfile_request)

#endif // OAICreateNetworkCameraWirelessProfile_request_H
