...
/*
 * OAIGetNetworkSensorAlertsOverviewByMetric_200_response_inner_counts.h
 *
 * Counts of sensor alerts over the timespan, by reading metric
 */

#ifndef OAIGetNetworkSensorAlertsOverviewByMetric_200_response_inner_counts_H
#define OAIGetNetworkSensorAlertsOverviewByMetric_200_response_inner_counts_H
...
namespace OpenAPI {
class OAIGetNetworkSensorAlertsOverviewByMetric_200_response_inner_counts_noise;

class OAIGetNetworkSensorAlertsOverviewByMetric_200_response_inner_counts : public OAIObject {
public:
    OAIGetNetworkSensorAlertsOverviewByMetric_200_response_inner_counts();
    OAIGetNetworkSensorAlertsOverviewByMetric_200_response_inner_counts(QString json);
    ~OAIGetNetworkSensorAlertsOverviewByMetric_200_response_inner_counts() override;
    ...
    OAIGetNetworkSensorAlertsOverviewByMetric_200_response_inner_counts_noise getNoise() const;
    void setNoise(const OAIGetNetworkSensorAlertsOverviewByMetric_200_response_inner_counts_noise &noise);
...
private:
    ...
    OAIGetNetworkSensorAlertsOverviewByMetric_200_response_inner_counts_noise m_noise;
    bool m_noise_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetNetworkSensorAlertsOverviewByMetric_200_response_inner_counts)

#endif // OAIGetNetworkSensorAlertsOverviewByMetric_200_response_inner_counts_H
