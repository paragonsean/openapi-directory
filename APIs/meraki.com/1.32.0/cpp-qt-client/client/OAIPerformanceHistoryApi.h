...
#ifndef OAI_OAIPerformanceHistoryApi_H
#define OAI_OAIPerformanceHistoryApi_H
...
class OAIPerformanceHistoryApi : public QObject {
    Q_OBJECT

public:
    OAIPerformanceHistoryApi(const int timeOut = 0);
    ~OAIPerformanceHistoryApi();
