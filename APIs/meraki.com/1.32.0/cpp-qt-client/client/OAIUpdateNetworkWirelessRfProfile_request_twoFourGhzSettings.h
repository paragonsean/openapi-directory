...
/*
 * OAIUpdateNetworkWirelessRfProfile_request_twoFourGhzSettings.h
 *
 * Settings related to 2.4Ghz band
 */

#ifndef OAIUpdateNetworkWirelessRfProfile_request_twoFourGhzSettings_H
#define OAIUpdateNetworkWirelessRfProfile_request_twoFourGhzSettings_H
...
class OAIUpdateNetworkWirelessRfProfile_request_twoFourGhzSettings : public OAIObject {
public:
    OAIUpdateNetworkWirelessRfProfile_request_twoFourGhzSettings();
    OAIUpdateNetworkWirelessRfProfile_request_twoFourGhzSettings(QString json);
    ~OAIUpdateNetworkWirelessRfProfile_request_twoFourGhzSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateNetworkWirelessRfProfile_request_twoFourGhzSettings)

#endif // OAIUpdateNetworkWirelessRfProfile_request_twoFourGhzSettings_H
