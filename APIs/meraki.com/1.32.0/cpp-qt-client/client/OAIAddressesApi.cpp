...
void OAIAddressesApi::getOrganizationDevicesUplinksAddressesByDevice(const QString &organization_id, const ::OpenAPI::OptionalParam<qint32> &per_page, const ::OpenAPI::OptionalParam<QString> &starting_after, const ::OpenAPI::OptionalParam<QString> &ending_before, const ::OpenAPI::OptionalParam<QList<QString>> &network_ids, const ::OpenAPI::OptionalParam<QList<QString>> &product_types, const ::OpenAPI::OptionalParam<QList<QString>> &serials, const ::OpenAPI::OptionalParam<QList<QString>> &tags, const ::OpenAPI::OptionalParam<QString> &tags_filter_type) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAddressesApi::getOrganizationDevicesUplinksAddressesByDeviceCallback);
...
void OAIAddressesApi::getOrganizationDevicesUplinksAddressesByDeviceCallback(OAIHttpRequestWorker *worker) {
