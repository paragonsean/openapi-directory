...
#ifndef OAI_OAIPortForwardingRulesApi_H
#define OAI_OAIPortForwardingRulesApi_H
...
class OAIPortForwardingRulesApi : public QObject {
    Q_OBJECT

public:
    OAIPortForwardingRulesApi(const int timeOut = 0);
    ~OAIPortForwardingRulesApi();
