...
QList<QString> OAILockNetworkSmDevices_request::getIds() const {
    return m_ids;
}
void OAILockNetworkSmDevices_request::setIds(const QList<QString> &ids) {
    m_ids = ids;
    m_ids_isSet = true;
}
...
QList<QString> OAILockNetworkSmDevices_request::getScope() const {
    return m_scope;
}
void OAILockNetworkSmDevices_request::setScope(const QList<QString> &scope) {
    m_scope = scope;
    m_scope_isSet = true;
}
...
QList<QString> OAILockNetworkSmDevices_request::getSerials() const {
    return m_serials;
}
void OAILockNetworkSmDevices_request::setSerials(const QList<QString> &serials) {
    m_serials = serials;
...
QList<QString> OAILockNetworkSmDevices_request::getWifiMacs() const {
    return m_wifi_macs;
}
void OAILockNetworkSmDevices_request::setWifiMacs(const QList<QString> &wifi_macs) {
