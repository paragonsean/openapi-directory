...
#ifndef OAI_OAIBonjourForwardingApi_H
#define OAI_OAIBonjourForwardingApi_H
...
class OAIBonjourForwardingApi : public QObject {
    Q_OBJECT

public:
    OAIBonjourForwardingApi(const int timeOut = 0);
    ~OAIBonjourForwardingApi();
