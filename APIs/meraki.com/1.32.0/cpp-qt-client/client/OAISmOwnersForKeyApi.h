...
#ifndef OAI_OAISmOwnersForKeyApi_H
#define OAI_OAISmOwnersForKeyApi_H
...
class OAISmOwnersForKeyApi : public QObject {
    Q_OBJECT

public:
    OAISmOwnersForKeyApi(const int timeOut = 0);
    ~OAISmOwnersForKeyApi();
