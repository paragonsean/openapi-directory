...
#ifndef OAI_OAIUplinksLossAndLatencyApi_H
#define OAI_OAIUplinksLossAndLatencyApi_H
...
class OAIUplinksLossAndLatencyApi : public QObject {
    Q_OBJECT

public:
    OAIUplinksLossAndLatencyApi(const int timeOut = 0);
    ~OAIUplinksLossAndLatencyApi();
