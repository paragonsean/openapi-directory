...
void OAICategoriesApi::getNetworkApplianceContentFilteringCategories(const QString &network_id) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICategoriesApi::getNetworkApplianceContentFilteringCategoriesCallback);
...
void OAICategoriesApi::getNetworkApplianceContentFilteringCategoriesCallback(OAIHttpRequestWorker *worker) {
