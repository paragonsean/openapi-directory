...
/*
 * OAIUpdateNetworkApplianceVlan_request.h
 *
 * 
 */

#ifndef OAIUpdateNetworkApplianceVlan_request_H
#define OAIUpdateNetworkApplianceVlan_request_H
...
#include "OAIUpdateNetworkApplianceStaticRoute_request_reservedIpRanges_inner.h"
#include <QList>
#include <QString>
...
class OAIUpdateNetworkApplianceStaticRoute_request_reservedIpRanges_inner;

class OAIUpdateNetworkApplianceVlan_request : public OAIObject {
public:
    OAIUpdateNetworkApplianceVlan_request();
    OAIUpdateNetworkApplianceVlan_request(QString json);
    ~OAIUpdateNetworkApplianceVlan_request() override;
    ...
    QList<OAIUpdateNetworkApplianceStaticRoute_request_reservedIpRanges_inner> getReservedIpRanges() const;
    void setReservedIpRanges(const QList<OAIUpdateNetworkApplianceStaticRoute_request_reservedIpRanges_inner> &reserved_ip_ranges);
...
private:
    ...
    QList<OAIUpdateNetworkApplianceStaticRoute_request_reservedIpRanges_inner> m_reserved_ip_ranges;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateNetworkApplianceVlan_request)

#endif // OAIUpdateNetworkApplianceVlan_request_H
