...
/*
 * OAICreateNetworkSwitchQosRule_request.h
 *
 * 
 */

#ifndef OAICreateNetworkSwitchQosRule_request_H
#define OAICreateNetworkSwitchQosRule_request_H
...
class OAICreateNetworkSwitchQosRule_request : public OAIObject {
public:
    OAICreateNetworkSwitchQosRule_request();
    OAICreateNetworkSwitchQosRule_request(QString json);
    ~OAICreateNetworkSwitchQosRule_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateNetworkSwitchQosRule_request)

#endif // OAICreateNetworkSwitchQosRule_request_H
