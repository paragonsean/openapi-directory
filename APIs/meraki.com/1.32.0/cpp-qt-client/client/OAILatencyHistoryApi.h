...
#ifndef OAI_OAILatencyHistoryApi_H
#define OAI_OAILatencyHistoryApi_H
...
class OAILatencyHistoryApi : public QObject {
    Q_OBJECT

public:
    OAILatencyHistoryApi(const int timeOut = 0);
    ~OAILatencyHistoryApi();
