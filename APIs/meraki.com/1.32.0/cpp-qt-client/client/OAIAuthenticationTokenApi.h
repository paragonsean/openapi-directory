...
#ifndef OAI_OAIAuthenticationTokenApi_H
#define OAI_OAIAuthenticationTokenApi_H
...
class OAIAuthenticationTokenApi : public QObject {
    Q_OBJECT

public:
    OAIAuthenticationTokenApi(const int timeOut = 0);
    ~OAIAuthenticationTokenApi();
