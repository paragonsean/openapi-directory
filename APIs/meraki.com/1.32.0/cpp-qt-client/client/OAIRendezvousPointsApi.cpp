...
#include "OAIRendezvousPointsApi.h"
...
OAIRendezvousPointsApi::OAIRendezvousPointsApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIRendezvousPointsApi::~OAIRendezvousPointsApi() {
}

void OAIRendezvousPointsApi::initializeServerConfigs() {
    //Default server
...
*/
int OAIRendezvousPointsApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIRendezvousPointsApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIRendezvousPointsApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIRendezvousPointsApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIRendezvousPointsApi::setUsername(const QString &username) {
    _username = username;
}

void OAIRendezvousPointsApi::setPassword(const QString &password) {
    _password = password;
}


void OAIRendezvousPointsApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIRendezvousPointsApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIRendezvousPointsApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIRendezvousPointsApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIRendezvousPointsApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIRendezvousPointsApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIRendezvousPointsApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIRendezvousPointsApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIRendezvousPointsApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIRendezvousPointsApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIRendezvousPointsApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIRendezvousPointsApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIRendezvousPointsApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIRendezvousPointsApi::createNetworkSwitchRoutingMulticastRendezvousPoint(const QString &network_id, const OAICreateNetworkSwitchRoutingMulticastRendezvousPoint_request &oai_create_network_switch_routing_multicast_rendezvous_point_request) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIRendezvousPointsApi::createNetworkSwitchRoutingMulticastRendezvousPointCallback);
    connect(this, &OAIRendezvousPointsApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIRendezvousPointsApi::createNetworkSwitchRoutingMulticastRendezvousPointCallback(OAIHttpRequestWorker *worker) {
...
void OAIRendezvousPointsApi::deleteNetworkSwitchRoutingMulticastRendezvousPoint(const QString &network_id, const QString &rendezvous_point_id) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIRendezvousPointsApi::deleteNetworkSwitchRoutingMulticastRendezvousPointCallback);
    connect(this, &OAIRendezvousPointsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIRendezvousPointsApi::deleteNetworkSwitchRoutingMulticastRendezvousPointCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void OAIRendezvousPointsApi::getNetworkSwitchRoutingMulticastRendezvousPoint(const QString &network_id, const QString &rendezvous_point_id) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIRendezvousPointsApi::getNetworkSwitchRoutingMulticastRendezvousPointCallback);
    connect(this, &OAIRendezvousPointsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIRendezvousPointsApi::getNetworkSwitchRoutingMulticastRendezvousPointCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void OAIRendezvousPointsApi::getNetworkSwitchRoutingMulticastRendezvousPoints(const QString &network_id) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIRendezvousPointsApi::getNetworkSwitchRoutingMulticastRendezvousPointsCallback);
    connect(this, &OAIRendezvousPointsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIRendezvousPointsApi::getNetworkSwitchRoutingMulticastRendezvousPointsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void OAIRendezvousPointsApi::updateNetworkSwitchRoutingMulticastRendezvousPoint(const QString &network_id, const QString &rendezvous_point_id, const OAIUpdateNetworkSwitchRoutingMulticastRendezvousPoint_request &oai_update_network_switch_routing_multicast_rendezvous_point_request) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIRendezvousPointsApi::updateNetworkSwitchRoutingMulticastRendezvousPointCallback);
    connect(this, &OAIRendezvousPointsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIRendezvousPointsApi::updateNetworkSwitchRoutingMulticastRendezvousPointCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void OAIRendezvousPointsApi::tokenAvailable(){
