...
#ifndef OAI_OAIConnectivityEventsApi_H
#define OAI_OAIConnectivityEventsApi_H
...
class OAIConnectivityEventsApi : public QObject {
    Q_OBJECT

public:
    OAIConnectivityEventsApi(const int timeOut = 0);
    ~OAIConnectivityEventsApi();
