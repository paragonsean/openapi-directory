...
#ifndef OAI_OAIConfigurationChangesApi_H
#define OAI_OAIConfigurationChangesApi_H
...
class OAIConfigurationChangesApi : public QObject {
    Q_OBJECT

public:
    OAIConfigurationChangesApi(const int timeOut = 0);
    ~OAIConfigurationChangesApi();
