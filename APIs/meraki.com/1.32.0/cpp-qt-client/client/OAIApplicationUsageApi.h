...
#ifndef OAI_OAIApplicationUsageApi_H
#define OAI_OAIApplicationUsageApi_H
...
class OAIApplicationUsageApi : public QObject {
    Q_OBJECT

public:
    OAIApplicationUsageApi(const int timeOut = 0);
    ~OAIApplicationUsageApi();
