...
#ifndef OAI_OAICellularUsageHistoryApi_H
#define OAI_OAICellularUsageHistoryApi_H
...
class OAICellularUsageHistoryApi : public QObject {
    Q_OBJECT

public:
    OAICellularUsageHistoryApi(const int timeOut = 0);
    ~OAICellularUsageHistoryApi();
