...
/*
 * OAIUpdateDeviceManagementInterface_request_wan2.h
 *
 * WAN 2 settings (only for MX devices)
 */

#ifndef OAIUpdateDeviceManagementInterface_request_wan2_H
#define OAIUpdateDeviceManagementInterface_request_wan2_H
...
class OAIUpdateDeviceManagementInterface_request_wan2 : public OAIObject {
public:
    OAIUpdateDeviceManagementInterface_request_wan2();
    OAIUpdateDeviceManagementInterface_request_wan2(QString json);
    ~OAIUpdateDeviceManagementInterface_request_wan2() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateDeviceManagementInterface_request_wan2)

#endif // OAIUpdateDeviceManagementInterface_request_wan2_H
