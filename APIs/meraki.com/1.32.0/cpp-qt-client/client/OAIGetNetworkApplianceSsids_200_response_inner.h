...
/*
 * OAIGetNetworkApplianceSsids_200_response_inner.h
 *
 * 
 */

#ifndef OAIGetNetworkApplianceSsids_200_response_inner_H
#define OAIGetNetworkApplianceSsids_200_response_inner_H
...
namespace OpenAPI {
class OAIGetNetworkApplianceSsids_200_response_inner_radiusServers_inner;

class OAIGetNetworkApplianceSsids_200_response_inner : public OAIObject {
public:
    OAIGetNetworkApplianceSsids_200_response_inner();
    OAIGetNetworkApplianceSsids_200_response_inner(QString json);
    ~OAIGetNetworkApplianceSsids_200_response_inner() override;
    ...
    QList<OAIGetNetworkApplianceSsids_200_response_inner_radiusServers_inner> getRadiusServers() const;
    void setRadiusServers(const QList<OAIGetNetworkApplianceSsids_200_response_inner_radiusServers_inner> &radius_servers);
...
private:
    ...
    QList<OAIGetNetworkApplianceSsids_200_response_inner_radiusServers_inner> m_radius_servers;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetNetworkApplianceSsids_200_response_inner)

#endif // OAIGetNetworkApplianceSsids_200_response_inner_H
