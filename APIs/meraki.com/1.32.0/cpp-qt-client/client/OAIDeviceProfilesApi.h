...
#ifndef OAI_OAIDeviceProfilesApi_H
#define OAI_OAIDeviceProfilesApi_H
...
class OAIDeviceProfilesApi : public QObject {
    Q_OBJECT

public:
    OAIDeviceProfilesApi(const int timeOut = 0);
    ~OAIDeviceProfilesApi();
