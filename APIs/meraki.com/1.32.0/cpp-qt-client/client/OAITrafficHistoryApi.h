...
#ifndef OAI_OAITrafficHistoryApi_H
#define OAI_OAITrafficHistoryApi_H
...
class OAITrafficHistoryApi : public QObject {
    Q_OBJECT

public:
    OAITrafficHistoryApi(const int timeOut = 0);
    ~OAITrafficHistoryApi();
