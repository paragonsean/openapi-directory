...
void OAILiveApi::getDeviceCameraAnalyticsLive(const QString &serial) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAILiveApi::getDeviceCameraAnalyticsLiveCallback);
...
void OAILiveApi::getDeviceCameraAnalyticsLiveCallback(OAIHttpRequestWorker *worker) {
