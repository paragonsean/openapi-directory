...
#ifndef OAI_OAIAvailabilitiesApi_H
#define OAI_OAIAvailabilitiesApi_H
...
class OAIAvailabilitiesApi : public QObject {
    Q_OBJECT

public:
    OAIAvailabilitiesApi(const int timeOut = 0);
    ~OAIAvailabilitiesApi();
