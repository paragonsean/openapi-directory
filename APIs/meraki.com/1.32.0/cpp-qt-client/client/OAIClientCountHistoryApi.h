...
#ifndef OAI_OAIClientCountHistoryApi_H
#define OAI_OAIClientCountHistoryApi_H
...
class OAIClientCountHistoryApi : public QObject {
    Q_OBJECT

public:
    OAIClientCountHistoryApi(const int timeOut = 0);
    ~OAIClientCountHistoryApi();
