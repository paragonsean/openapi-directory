...
#ifndef OAI_OAIObjectDetectionModelsApi_H
#define OAI_OAIObjectDetectionModelsApi_H
...
class OAIObjectDetectionModelsApi : public QObject {
    Q_OBJECT

public:
    OAIObjectDetectionModelsApi(const int timeOut = 0);
    ~OAIObjectDetectionModelsApi();
