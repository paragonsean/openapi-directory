...
async def test_get_network_firmware_upgrades_staged_stages_3(client):
    """Test case for get_network_firmware_upgrades_staged_stages_3
...
async def test_update_network_firmware_upgrades_staged_stages_3(client):
    """Test case for update_network_firmware_upgrades_staged_stages_3
