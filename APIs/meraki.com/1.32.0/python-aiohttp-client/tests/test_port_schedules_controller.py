...
async def test_create_network_switch_port_schedule_1(client):
...
async def test_delete_network_switch_port_schedule_1(client):
...
async def test_get_network_switch_port_schedules_1(client):
...
async def test_update_network_switch_port_schedule_1(client):
