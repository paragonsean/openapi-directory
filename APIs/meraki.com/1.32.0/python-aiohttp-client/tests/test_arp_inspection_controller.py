...
async def test_create_network_switch_dhcp_server_policy_arp_inspection_trusted_server_2(client):
...
async def test_delete_network_switch_dhcp_server_policy_arp_inspection_trusted_server_2(client):
...
async def test_get_network_switch_dhcp_server_policy_arp_inspection_trusted_servers_2(client):
...
async def test_get_network_switch_dhcp_server_policy_arp_inspection_warnings_by_device_2(client):
...
async def test_update_network_switch_dhcp_server_policy_arp_inspection_trusted_server_2(client):
