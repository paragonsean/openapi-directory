...
async def test_create_network_appliance_prefixes_delegated_static_1(client):
...
async def test_delete_network_appliance_prefixes_delegated_static_1(client):
...
async def test_get_device_appliance_prefixes_delegated_1(client):
...
async def test_get_device_appliance_prefixes_delegated_vlan_assignments_1(client):
...
async def test_get_network_appliance_prefixes_delegated_static_1(client):
...
async def test_get_network_appliance_prefixes_delegated_statics_1(client):
...
async def test_update_network_appliance_prefixes_delegated_static_1(client):
