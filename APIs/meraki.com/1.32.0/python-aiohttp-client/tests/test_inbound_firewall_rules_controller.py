...
async def test_get_network_appliance_firewall_inbound_firewall_rules_2(client):
    """Test case for get_network_appliance_firewall_inbound_firewall_rules_2
...
async def test_update_network_appliance_firewall_inbound_firewall_rules_2(client):
    """Test case for update_network_appliance_firewall_inbound_firewall_rules_2
