...
async def test_create_network_camera_quality_retention_profile_1(client):
...
async def test_delete_network_camera_quality_retention_profile_1(client):
...
async def test_get_network_camera_quality_retention_profile_1(client):
...
async def test_get_network_camera_quality_retention_profiles_1(client):
...
async def test_update_network_camera_quality_retention_profile_1(client):
