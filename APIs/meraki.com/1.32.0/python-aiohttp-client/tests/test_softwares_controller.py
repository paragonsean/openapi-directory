...
async def test_get_network_sm_device_softwares_2(client):
    """Test case for get_network_sm_device_softwares_2
...
async def test_get_network_sm_user_softwares_2(client):
    """Test case for get_network_sm_user_softwares_2
