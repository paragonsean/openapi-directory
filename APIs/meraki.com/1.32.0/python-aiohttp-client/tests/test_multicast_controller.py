...
async def test_create_network_switch_routing_multicast_rendezvous_point_2(client):
...
async def test_delete_network_switch_routing_multicast_rendezvous_point_2(client):
...
async def test_get_network_switch_routing_multicast_2(client):
...
async def test_get_network_switch_routing_multicast_rendezvous_point_2(client):
...
async def test_get_network_switch_routing_multicast_rendezvous_points_2(client):
...
async def test_update_network_switch_routing_multicast_2(client):
...
async def test_update_network_switch_routing_multicast_rendezvous_point_2(client):
