...
async def test_get_network_appliance_single_lan_1(client):
    """Test case for get_network_appliance_single_lan_1
...
async def test_update_network_appliance_single_lan_1(client):
    """Test case for update_network_appliance_single_lan_1
