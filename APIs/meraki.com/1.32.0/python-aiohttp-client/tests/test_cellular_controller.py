...
async def test_get_device_cellular_sims_1(client):
    """Test case for get_device_cellular_sims_1
...
async def test_update_device_cellular_sims_1(client):
    """Test case for update_device_cellular_sims_1
