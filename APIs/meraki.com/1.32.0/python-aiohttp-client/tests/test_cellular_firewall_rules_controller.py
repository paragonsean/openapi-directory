...
async def test_get_network_appliance_firewall_cellular_firewall_rules_2(client):
...
async def test_update_network_appliance_firewall_cellular_firewall_rules_2(client):
