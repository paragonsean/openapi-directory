...
async def test_get_organization_api_requests_overview_response_codes_by_interval_4(client):
    """Test case for get_organization_api_requests_overview_response_codes_by_interval_4
