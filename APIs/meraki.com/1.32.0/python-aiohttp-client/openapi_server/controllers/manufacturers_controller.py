...
async def get_organization_summary_top_clients_manufacturers_by_usage_4(request: web.Request, organization_id, t0=None, t1=None, timespan=None) -> web.Response:
