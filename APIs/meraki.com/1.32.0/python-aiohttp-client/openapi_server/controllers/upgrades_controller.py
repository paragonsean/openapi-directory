...
async def get_organization_firmware_upgrades_2(request: web.Request, organization_id, status=None, product_type=None) -> web.Response:
...
async def get_organization_firmware_upgrades_by_device_2(request: web.Request, organization_id, per_page=None, starting_after=None, ending_before=None, network_ids=None, serials=None, macs=None, firmware_upgrade_ids=None, firmware_upgrade_batch_ids=None) -> web.Response:
