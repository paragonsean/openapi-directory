...
async def create_network_wireless_rf_profile_1(request: web.Request, network_id, body) -> web.Response:
...
async def delete_network_wireless_rf_profile_1(request: web.Request, network_id, rf_profile_id) -> web.Response:
    """Delete a RF Profile
...
async def get_network_wireless_rf_profile_1(request: web.Request, network_id, rf_profile_id) -> web.Response:
    """Return a RF profile
...
async def get_network_wireless_rf_profiles_1(request: web.Request, network_id, include_template_profiles=None) -> web.Response:
...
async def update_network_wireless_rf_profile_1(request: web.Request, network_id, rf_profile_id, body=None) -> web.Response:
