...
async def get_network_network_health_channel_utilization_1(request: web.Request, network_id, t0=None, t1=None, timespan=None, resolution=None, per_page=None, starting_after=None, ending_before=None) -> web.Response:
