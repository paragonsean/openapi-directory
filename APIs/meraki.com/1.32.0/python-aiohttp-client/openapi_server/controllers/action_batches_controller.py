...
async def create_organization_action_batch_1(request: web.Request, organization_id, body) -> web.Response:
...
async def delete_organization_action_batch_1(request: web.Request, organization_id, action_batch_id) -> web.Response:
...
async def get_organization_action_batch_1(request: web.Request, organization_id, action_batch_id) -> web.Response:
...
async def get_organization_action_batches_1(request: web.Request, organization_id, status=None) -> web.Response:
...
async def update_organization_action_batch_1(request: web.Request, organization_id, action_batch_id, body=None) -> web.Response:
