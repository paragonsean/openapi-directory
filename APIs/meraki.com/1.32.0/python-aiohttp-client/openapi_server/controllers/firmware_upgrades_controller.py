...
async def create_network_firmware_upgrades_rollback_1(request: web.Request, network_id, body) -> web.Response:
...
async def create_network_firmware_upgrades_staged_event_1(request: web.Request, network_id, body) -> web.Response:
...
async def create_network_firmware_upgrades_staged_group_1(request: web.Request, network_id, body) -> web.Response:
...
async def defer_network_firmware_upgrades_staged_events_1(request: web.Request, network_id) -> web.Response:
...
async def delete_network_firmware_upgrades_staged_group_1(request: web.Request, network_id, group_id) -> web.Response:
...
async def get_network_firmware_upgrades_1(request: web.Request, network_id) -> web.Response:
...
async def get_network_firmware_upgrades_staged_events_1(request: web.Request, network_id) -> web.Response:
...
async def get_network_firmware_upgrades_staged_group_1(request: web.Request, network_id, group_id) -> web.Response:
...
async def get_network_firmware_upgrades_staged_groups_1(request: web.Request, network_id) -> web.Response:
...
async def get_network_firmware_upgrades_staged_stages_1(request: web.Request, network_id) -> web.Response:
...
async def rollbacks_network_firmware_upgrades_staged_events_1(request: web.Request, network_id, body) -> web.Response:
...
async def update_network_firmware_upgrades_1(request: web.Request, network_id, body=None) -> web.Response:
...
async def update_network_firmware_upgrades_staged_events_1(request: web.Request, network_id, body) -> web.Response:
...
async def update_network_firmware_upgrades_staged_group_1(request: web.Request, network_id, group_id, body) -> web.Response:
...
async def update_network_firmware_upgrades_staged_stages_1(request: web.Request, network_id, body=None) -> web.Response:
