...
async def get_organization_configuration_changes_1(request: web.Request, organization_id, t0=None, t1=None, timespan=None, per_page=None, starting_after=None, ending_before=None, network_id=None, admin_id=None) -> web.Response:
