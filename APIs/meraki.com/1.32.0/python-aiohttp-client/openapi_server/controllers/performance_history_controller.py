...
async def get_network_sm_device_performance_history_2(request: web.Request, network_id, device_id, per_page=None, starting_after=None, ending_before=None) -> web.Response:
