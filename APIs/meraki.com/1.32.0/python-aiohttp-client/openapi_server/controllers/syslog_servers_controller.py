...
async def get_network_syslog_servers_1(request: web.Request, network_id) -> web.Response:
...
async def update_network_syslog_servers_1(request: web.Request, network_id, body) -> web.Response:
