...
async def get_organization_licensing_coterm_licenses_1(request: web.Request, organization_id, per_page=None, starting_after=None, ending_before=None, invalidated=None, expired=None) -> web.Response:
...
async def move_organization_licensing_coterm_licenses_1(request: web.Request, organization_id, body) -> web.Response:
