...
async def create_network_switch_dhcp_server_policy_arp_inspection_trusted_server_3(request: web.Request, network_id, body) -> web.Response:
...
async def delete_network_switch_dhcp_server_policy_arp_inspection_trusted_server_3(request: web.Request, network_id, trusted_server_id) -> web.Response:
...
async def get_network_switch_dhcp_server_policy_arp_inspection_trusted_servers_3(request: web.Request, network_id, per_page=None, starting_after=None, ending_before=None) -> web.Response:
...
async def update_network_switch_dhcp_server_policy_arp_inspection_trusted_server_3(request: web.Request, network_id, trusted_server_id, body=None) -> web.Response:
