...
async def get_network_policies_by_client_2(request: web.Request, network_id, per_page=None, starting_after=None, ending_before=None, t0=None, timespan=None) -> web.Response:
