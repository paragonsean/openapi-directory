...
async def get_network_insight_application_health_by_time_2(request: web.Request, network_id, application_id, t0=None, t1=None, timespan=None, resolution=None) -> web.Response:
