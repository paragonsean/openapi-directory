...
async def get_organization_appliance_vpn_stats_2(request: web.Request, organization_id, per_page=None, starting_after=None, ending_before=None, network_ids=None, t0=None, t1=None, timespan=None) -> web.Response:
