...
async def get_network_bluetooth_client_1(request: web.Request, network_id, bluetooth_client_id, include_connectivity_history=None, connectivity_history_timespan=None) -> web.Response:
...
async def get_network_bluetooth_clients_1(request: web.Request, network_id, t0=None, timespan=None, per_page=None, starting_after=None, ending_before=None, include_connectivity_history=None) -> web.Response:
