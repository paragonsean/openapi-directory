...
async def get_network_appliance_firewall_one_to_many_nat_rules_2(request: web.Request, network_id) -> web.Response:
...
async def update_network_appliance_firewall_one_to_many_nat_rules_2(request: web.Request, network_id, body) -> web.Response:
