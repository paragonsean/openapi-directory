...
async def get_network_clients_usage_histories_2(request: web.Request, network_id, clients, ssid_number=None, per_page=None, starting_after=None, ending_before=None, t0=None, t1=None, timespan=None) -> web.Response:
