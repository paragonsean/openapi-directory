...
async def get_device_camera_analytics_live_1(request: web.Request, serial) -> web.Response:
...
async def get_device_camera_analytics_overview_1(request: web.Request, serial, t0=None, t1=None, timespan=None, object_type=None) -> web.Response:
...
async def get_device_camera_analytics_recent_1(request: web.Request, serial, object_type=None) -> web.Response:
...
async def get_device_camera_analytics_zone_history_1(request: web.Request, serial, zone_id, t0=None, t1=None, timespan=None, resolution=None, object_type=None) -> web.Response:
...
async def get_device_camera_analytics_zones_1(request: web.Request, serial) -> web.Response:
