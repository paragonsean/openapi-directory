...
async def create_network_pii_request_1(request: web.Request, network_id, body=None) -> web.Response:
...
async def delete_network_pii_request_1(request: web.Request, network_id, request_id) -> web.Response:
...
async def get_network_pii_pii_keys_1(request: web.Request, network_id, username=None, email=None, mac=None, serial=None, imei=None, bluetooth_mac=None) -> web.Response:
...
async def get_network_pii_request_1(request: web.Request, network_id, request_id) -> web.Response:
...
async def get_network_pii_requests_1(request: web.Request, network_id) -> web.Response:
...
async def get_network_pii_sm_devices_for_key_1(request: web.Request, network_id, username=None, email=None, mac=None, serial=None, imei=None, bluetooth_mac=None) -> web.Response:
...
async def get_network_pii_sm_owners_for_key_1(request: web.Request, network_id, username=None, email=None, mac=None, serial=None, imei=None, bluetooth_mac=None) -> web.Response:
