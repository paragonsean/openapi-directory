...
async def get_network_client_traffic_history_2(request: web.Request, network_id, client_id, per_page=None, starting_after=None, ending_before=None) -> web.Response:
