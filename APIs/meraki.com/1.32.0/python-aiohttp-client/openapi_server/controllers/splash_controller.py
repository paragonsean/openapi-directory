...
async def get_network_wireless_ssid_splash_settings_2(request: web.Request, network_id, number) -> web.Response:
...
async def update_network_wireless_ssid_splash_settings_2(request: web.Request, network_id, number, body=None) -> web.Response:
