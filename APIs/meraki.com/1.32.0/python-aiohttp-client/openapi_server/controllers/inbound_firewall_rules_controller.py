...
async def get_network_appliance_firewall_inbound_firewall_rules_2(request: web.Request, network_id) -> web.Response:
...
async def update_network_appliance_firewall_inbound_firewall_rules_2(request: web.Request, network_id, body=None) -> web.Response:
