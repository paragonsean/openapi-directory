...
class UpdateOrganizationLoginSecurityRequest(Model):
    ...
    def __init__(self, account_lockout_attempts: int=None, api_authentication: GetOrganizationLoginSecurity200ResponseApiAuthentication=None, enforce_account_lockout: bool=None, enforce_different_passwords: bool=None, enforce_idle_timeout: bool=None, enforce_login_ip_ranges: bool=None, enforce_password_expiration: bool=None, enforce_strong_passwords: bool=None, enforce_two_factor_auth: bool=None, idle_timeout_minutes: int=None, login_ip_ranges: List[str]=None, num_different_passwords: int=None, password_expiration_days: int=None):
        """UpdateOrganizationLoginSecurityRequest - a model defined in OpenAPI

        :param account_lockout_attempts: The account_lockout_attempts of this UpdateOrganizationLoginSecurityRequest.
        :param api_authentication: The api_authentication of this UpdateOrganizationLoginSecurityRequest.
        :param enforce_account_lockout: The enforce_account_lockout of this UpdateOrganizationLoginSecurityRequest.
        :param enforce_different_passwords: The enforce_different_passwords of this UpdateOrganizationLoginSecurityRequest.
        :param enforce_idle_timeout: The enforce_idle_timeout of this UpdateOrganizationLoginSecurityRequest.
        :param enforce_login_ip_ranges: The enforce_login_ip_ranges of this UpdateOrganizationLoginSecurityRequest.
        :param enforce_password_expiration: The enforce_password_expiration of this UpdateOrganizationLoginSecurityRequest.
        :param enforce_strong_passwords: The enforce_strong_passwords of this UpdateOrganizationLoginSecurityRequest.
        :param enforce_two_factor_auth: The enforce_two_factor_auth of this UpdateOrganizationLoginSecurityRequest.
        :param idle_timeout_minutes: The idle_timeout_minutes of this UpdateOrganizationLoginSecurityRequest.
        :param login_ip_ranges: The login_ip_ranges of this UpdateOrganizationLoginSecurityRequest.
        :param num_different_passwords: The num_different_passwords of this UpdateOrganizationLoginSecurityRequest.
        :param password_expiration_days: The password_expiration_days of this UpdateOrganizationLoginSecurityRequest.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'UpdateOrganizationLoginSecurityRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The updateOrganizationLoginSecurity_request of this UpdateOrganizationLoginSecurityRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def account_lockout_attempts(self):
        """Gets the account_lockout_attempts of this UpdateOrganizationLoginSecurityRequest.

        Number of consecutive failed login attempts after which users' accounts will be locked.

        :return: The account_lockout_attempts of this UpdateOrganizationLoginSecurityRequest.
        :rtype: int
        """
    ...
    def account_lockout_attempts(self, account_lockout_attempts):
        """Sets the account_lockout_attempts of this UpdateOrganizationLoginSecurityRequest.
    ...
    def api_authentication(self):
        """Gets the api_authentication of this UpdateOrganizationLoginSecurityRequest.


        :return: The api_authentication of this UpdateOrganizationLoginSecurityRequest.
    ...
    def api_authentication(self, api_authentication):
        """Sets the api_authentication of this UpdateOrganizationLoginSecurityRequest.
    ...
    def enforce_account_lockout(self):
        """Gets the enforce_account_lockout of this UpdateOrganizationLoginSecurityRequest.
        ...
        :return: The enforce_account_lockout of this UpdateOrganizationLoginSecurityRequest.
        :rtype: bool
        """
    ...
    def enforce_account_lockout(self, enforce_account_lockout):
        """Sets the enforce_account_lockout of this UpdateOrganizationLoginSecurityRequest.
    ...
    def enforce_different_passwords(self):
        """Gets the enforce_different_passwords of this UpdateOrganizationLoginSecurityRequest.
        ...
        :return: The enforce_different_passwords of this UpdateOrganizationLoginSecurityRequest.
        :rtype: bool
        """
    ...
    def enforce_different_passwords(self, enforce_different_passwords):
        """Sets the enforce_different_passwords of this UpdateOrganizationLoginSecurityRequest.
    ...
    def enforce_idle_timeout(self):
        """Gets the enforce_idle_timeout of this UpdateOrganizationLoginSecurityRequest.

        Boolean indicating whether users will be logged out after being idle for the specified number of minutes.

        :return: The enforce_idle_timeout of this UpdateOrganizationLoginSecurityRequest.
        :rtype: bool
        """
    ...
    def enforce_idle_timeout(self, enforce_idle_timeout):
        """Sets the enforce_idle_timeout of this UpdateOrganizationLoginSecurityRequest.
    ...
    def enforce_login_ip_ranges(self):
        """Gets the enforce_login_ip_ranges of this UpdateOrganizationLoginSecurityRequest.

        Boolean indicating whether organization will restrict access to Dashboard (including the API) from certain IP addresses.

        :return: The enforce_login_ip_ranges of this UpdateOrganizationLoginSecurityRequest.
        :rtype: bool
        """
    ...
    def enforce_login_ip_ranges(self, enforce_login_ip_ranges):
        """Sets the enforce_login_ip_ranges of this UpdateOrganizationLoginSecurityRequest.
    ...
    def enforce_password_expiration(self):
        """Gets the enforce_password_expiration of this UpdateOrganizationLoginSecurityRequest.

        Boolean indicating whether users are forced to change their password every X number of days.

        :return: The enforce_password_expiration of this UpdateOrganizationLoginSecurityRequest.
        :rtype: bool
        """
    ...
    def enforce_password_expiration(self, enforce_password_expiration):
        """Sets the enforce_password_expiration of this UpdateOrganizationLoginSecurityRequest.
    ...
    def enforce_strong_passwords(self):
        """Gets the enforce_strong_passwords of this UpdateOrganizationLoginSecurityRequest.
        ...
        :return: The enforce_strong_passwords of this UpdateOrganizationLoginSecurityRequest.
        :rtype: bool
        """
    ...
    def enforce_strong_passwords(self, enforce_strong_passwords):
        """Sets the enforce_strong_passwords of this UpdateOrganizationLoginSecurityRequest.
    ...
    def enforce_two_factor_auth(self):
        """Gets the enforce_two_factor_auth of this UpdateOrganizationLoginSecurityRequest.
        ...
        :return: The enforce_two_factor_auth of this UpdateOrganizationLoginSecurityRequest.
        :rtype: bool
        """
    ...
    def enforce_two_factor_auth(self, enforce_two_factor_auth):
        """Sets the enforce_two_factor_auth of this UpdateOrganizationLoginSecurityRequest.
    ...
    def idle_timeout_minutes(self):
        """Gets the idle_timeout_minutes of this UpdateOrganizationLoginSecurityRequest.

        Number of minutes users can remain idle before being logged out of their accounts.

        :return: The idle_timeout_minutes of this UpdateOrganizationLoginSecurityRequest.
        :rtype: int
        """
    ...
    def idle_timeout_minutes(self, idle_timeout_minutes):
        """Sets the idle_timeout_minutes of this UpdateOrganizationLoginSecurityRequest.
    ...
    def login_ip_ranges(self):
        """Gets the login_ip_ranges of this UpdateOrganizationLoginSecurityRequest.

        List of acceptable IP ranges. Entries can be single IP addresses, IP address ranges, and CIDR subnets.

        :return: The login_ip_ranges of this UpdateOrganizationLoginSecurityRequest.
        :rtype: List[str]
        """
    ...
    def login_ip_ranges(self, login_ip_ranges):
        """Sets the login_ip_ranges of this UpdateOrganizationLoginSecurityRequest.
    ...
    def num_different_passwords(self):
        """Gets the num_different_passwords of this UpdateOrganizationLoginSecurityRequest.

        Number of recent passwords that new password must be distinct from.

        :return: The num_different_passwords of this UpdateOrganizationLoginSecurityRequest.
        :rtype: int
        """
    ...
    def num_different_passwords(self, num_different_passwords):
        """Sets the num_different_passwords of this UpdateOrganizationLoginSecurityRequest.
    ...
    def password_expiration_days(self):
        """Gets the password_expiration_days of this UpdateOrganizationLoginSecurityRequest.

        Number of days after which users will be forced to change their password.

        :return: The password_expiration_days of this UpdateOrganizationLoginSecurityRequest.
        :rtype: int
        """
    ...
    def password_expiration_days(self, password_expiration_days):
        """Sets the password_expiration_days of this UpdateOrganizationLoginSecurityRequest.
