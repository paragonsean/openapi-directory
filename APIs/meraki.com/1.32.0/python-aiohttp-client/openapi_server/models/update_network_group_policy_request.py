...
class UpdateNetworkGroupPolicyRequest(Model):
    ...
    def __init__(self, bandwidth: CreateNetworkGroupPolicyRequestBandwidth=None, bonjour_forwarding: CreateNetworkGroupPolicyRequestBonjourForwarding=None, content_filtering: CreateNetworkGroupPolicyRequestContentFiltering=None, firewall_and_traffic_shaping: CreateNetworkGroupPolicyRequestFirewallAndTrafficShaping=None, name: str=None, scheduling: CreateNetworkGroupPolicyRequestScheduling=None, splash_auth_settings: str=None, vlan_tagging: CreateNetworkGroupPolicyRequestVlanTagging=None):
        """UpdateNetworkGroupPolicyRequest - a model defined in OpenAPI

        :param bandwidth: The bandwidth of this UpdateNetworkGroupPolicyRequest.
        :param bonjour_forwarding: The bonjour_forwarding of this UpdateNetworkGroupPolicyRequest.
        :param content_filtering: The content_filtering of this UpdateNetworkGroupPolicyRequest.
        :param firewall_and_traffic_shaping: The firewall_and_traffic_shaping of this UpdateNetworkGroupPolicyRequest.
        :param name: The name of this UpdateNetworkGroupPolicyRequest.
        :param scheduling: The scheduling of this UpdateNetworkGroupPolicyRequest.
        :param splash_auth_settings: The splash_auth_settings of this UpdateNetworkGroupPolicyRequest.
        :param vlan_tagging: The vlan_tagging of this UpdateNetworkGroupPolicyRequest.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'UpdateNetworkGroupPolicyRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The updateNetworkGroupPolicy_request of this UpdateNetworkGroupPolicyRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def bandwidth(self):
        """Gets the bandwidth of this UpdateNetworkGroupPolicyRequest.


        :return: The bandwidth of this UpdateNetworkGroupPolicyRequest.
    ...
    def bandwidth(self, bandwidth):
        """Sets the bandwidth of this UpdateNetworkGroupPolicyRequest.
    ...
    def bonjour_forwarding(self):
        """Gets the bonjour_forwarding of this UpdateNetworkGroupPolicyRequest.


        :return: The bonjour_forwarding of this UpdateNetworkGroupPolicyRequest.
    ...
    def bonjour_forwarding(self, bonjour_forwarding):
        """Sets the bonjour_forwarding of this UpdateNetworkGroupPolicyRequest.
    ...
    def content_filtering(self):
        """Gets the content_filtering of this UpdateNetworkGroupPolicyRequest.


        :return: The content_filtering of this UpdateNetworkGroupPolicyRequest.
    ...
    def content_filtering(self, content_filtering):
        """Sets the content_filtering of this UpdateNetworkGroupPolicyRequest.
    ...
    def firewall_and_traffic_shaping(self):
        """Gets the firewall_and_traffic_shaping of this UpdateNetworkGroupPolicyRequest.


        :return: The firewall_and_traffic_shaping of this UpdateNetworkGroupPolicyRequest.
    ...
    def firewall_and_traffic_shaping(self, firewall_and_traffic_shaping):
        """Sets the firewall_and_traffic_shaping of this UpdateNetworkGroupPolicyRequest.
    ...
    @property
    def name(self):
        """Gets the name of this UpdateNetworkGroupPolicyRequest.

        The name for your group policy.

        :return: The name of this UpdateNetworkGroupPolicyRequest.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this UpdateNetworkGroupPolicyRequest.
    ...
    @property
    def scheduling(self):
        """Gets the scheduling of this UpdateNetworkGroupPolicyRequest.


        :return: The scheduling of this UpdateNetworkGroupPolicyRequest.
    ...
    def scheduling(self, scheduling):
        """Sets the scheduling of this UpdateNetworkGroupPolicyRequest.
    ...
    def splash_auth_settings(self):
        """Gets the splash_auth_settings of this UpdateNetworkGroupPolicyRequest.
        ...
        :return: The splash_auth_settings of this UpdateNetworkGroupPolicyRequest.
        :rtype: str
        """
    ...
    def splash_auth_settings(self, splash_auth_settings):
        """Sets the splash_auth_settings of this UpdateNetworkGroupPolicyRequest.
    ...
    def vlan_tagging(self):
        """Gets the vlan_tagging of this UpdateNetworkGroupPolicyRequest.


        :return: The vlan_tagging of this UpdateNetworkGroupPolicyRequest.
    ...
    def vlan_tagging(self, vlan_tagging):
        """Sets the vlan_tagging of this UpdateNetworkGroupPolicyRequest.
