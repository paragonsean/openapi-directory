...
class UpdateDeviceSwitchRoutingInterfaceDhcpRequest(Model):
    ...
    def __init__(self, boot_file_name: str=None, boot_next_server: str=None, boot_options_enabled: bool=None, dhcp_lease_time: str=None, dhcp_mode: str=None, dhcp_options: List[UpdateDeviceSwitchRoutingInterfaceDhcpRequestDhcpOptionsInner]=None, dhcp_relay_server_ips: List[str]=None, dns_custom_nameservers: List[str]=None, dns_nameservers_option: str=None, fixed_ip_assignments: List[UpdateDeviceSwitchRoutingInterfaceDhcpRequestFixedIpAssignmentsInner]=None, reserved_ip_ranges: List[UpdateDeviceSwitchRoutingInterfaceDhcpRequestReservedIpRangesInner]=None):
        """UpdateDeviceSwitchRoutingInterfaceDhcpRequest - a model defined in OpenAPI

        :param boot_file_name: The boot_file_name of this UpdateDeviceSwitchRoutingInterfaceDhcpRequest.
        :param boot_next_server: The boot_next_server of this UpdateDeviceSwitchRoutingInterfaceDhcpRequest.
        :param boot_options_enabled: The boot_options_enabled of this UpdateDeviceSwitchRoutingInterfaceDhcpRequest.
        :param dhcp_lease_time: The dhcp_lease_time of this UpdateDeviceSwitchRoutingInterfaceDhcpRequest.
        :param dhcp_mode: The dhcp_mode of this UpdateDeviceSwitchRoutingInterfaceDhcpRequest.
        :param dhcp_options: The dhcp_options of this UpdateDeviceSwitchRoutingInterfaceDhcpRequest.
        :param dhcp_relay_server_ips: The dhcp_relay_server_ips of this UpdateDeviceSwitchRoutingInterfaceDhcpRequest.
        :param dns_custom_nameservers: The dns_custom_nameservers of this UpdateDeviceSwitchRoutingInterfaceDhcpRequest.
        :param dns_nameservers_option: The dns_nameservers_option of this UpdateDeviceSwitchRoutingInterfaceDhcpRequest.
        :param fixed_ip_assignments: The fixed_ip_assignments of this UpdateDeviceSwitchRoutingInterfaceDhcpRequest.
        :param reserved_ip_ranges: The reserved_ip_ranges of this UpdateDeviceSwitchRoutingInterfaceDhcpRequest.
        """
        self.openapi_types = {
            'boot_file_name': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'UpdateDeviceSwitchRoutingInterfaceDhcpRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The updateDeviceSwitchRoutingInterfaceDhcp_request of this UpdateDeviceSwitchRoutingInterfaceDhcpRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def boot_file_name(self):
        """Gets the boot_file_name of this UpdateDeviceSwitchRoutingInterfaceDhcpRequest.

        The PXE boot server filename for the DHCP server running on the switch interface

        :return: The boot_file_name of this UpdateDeviceSwitchRoutingInterfaceDhcpRequest.
        :rtype: str
        """
    ...
    def boot_file_name(self, boot_file_name):
        """Sets the boot_file_name of this UpdateDeviceSwitchRoutingInterfaceDhcpRequest.
    ...
    def boot_next_server(self):
        """Gets the boot_next_server of this UpdateDeviceSwitchRoutingInterfaceDhcpRequest.

        The PXE boot server IP for the DHCP server running on the switch interface

        :return: The boot_next_server of this UpdateDeviceSwitchRoutingInterfaceDhcpRequest.
        :rtype: str
        """
    ...
    def boot_next_server(self, boot_next_server):
        """Sets the boot_next_server of this UpdateDeviceSwitchRoutingInterfaceDhcpRequest.
    ...
    def boot_options_enabled(self):
        """Gets the boot_options_enabled of this UpdateDeviceSwitchRoutingInterfaceDhcpRequest.

        Enable DHCP boot options to provide PXE boot options configs for the dhcp server running on the switch interface

        :return: The boot_options_enabled of this UpdateDeviceSwitchRoutingInterfaceDhcpRequest.
        :rtype: bool
        """
    ...
    def boot_options_enabled(self, boot_options_enabled):
        """Sets the boot_options_enabled of this UpdateDeviceSwitchRoutingInterfaceDhcpRequest.
    ...
    def dhcp_lease_time(self):
        """Gets the dhcp_lease_time of this UpdateDeviceSwitchRoutingInterfaceDhcpRequest.
        ...
        :return: The dhcp_lease_time of this UpdateDeviceSwitchRoutingInterfaceDhcpRequest.
        :rtype: str
        """
    ...
    def dhcp_lease_time(self, dhcp_lease_time):
        """Sets the dhcp_lease_time of this UpdateDeviceSwitchRoutingInterfaceDhcpRequest.
    ...
    @property
    def dhcp_mode(self):
        """Gets the dhcp_mode of this UpdateDeviceSwitchRoutingInterfaceDhcpRequest.

        The DHCP mode options for the switch interface ('dhcpDisabled', 'dhcpRelay' or 'dhcpServer')

        :return: The dhcp_mode of this UpdateDeviceSwitchRoutingInterfaceDhcpRequest.
        :rtype: str
        """
    ...
    def dhcp_mode(self, dhcp_mode):
        """Sets the dhcp_mode of this UpdateDeviceSwitchRoutingInterfaceDhcpRequest.
    ...
    def dhcp_options(self):
        """Gets the dhcp_options of this UpdateDeviceSwitchRoutingInterfaceDhcpRequest.

        Array of DHCP options consisting of code, type and value for the DHCP server running on the switch interface

        :return: The dhcp_options of this UpdateDeviceSwitchRoutingInterfaceDhcpRequest.
    ...
    def dhcp_options(self, dhcp_options):
        """Sets the dhcp_options of this UpdateDeviceSwitchRoutingInterfaceDhcpRequest.
    ...
    def dhcp_relay_server_ips(self):
        """Gets the dhcp_relay_server_ips of this UpdateDeviceSwitchRoutingInterfaceDhcpRequest.

        The DHCP relay server IPs to which DHCP packets would get relayed for the switch interface

        :return: The dhcp_relay_server_ips of this UpdateDeviceSwitchRoutingInterfaceDhcpRequest.
        :rtype: List[str]
        """
    ...
    def dhcp_relay_server_ips(self, dhcp_relay_server_ips):
        """Sets the dhcp_relay_server_ips of this UpdateDeviceSwitchRoutingInterfaceDhcpRequest.
    ...
    def dns_custom_nameservers(self):
        """Gets the dns_custom_nameservers of this UpdateDeviceSwitchRoutingInterfaceDhcpRequest.

        The DHCP name server IPs when DHCP name server option is 'custom'

        :return: The dns_custom_nameservers of this UpdateDeviceSwitchRoutingInterfaceDhcpRequest.
        :rtype: List[str]
        """
    ...
    def dns_custom_nameservers(self, dns_custom_nameservers):
        """Sets the dns_custom_nameservers of this UpdateDeviceSwitchRoutingInterfaceDhcpRequest.
    ...
    def dns_nameservers_option(self):
        """Gets the dns_nameservers_option of this UpdateDeviceSwitchRoutingInterfaceDhcpRequest.

        The DHCP name server option for the dhcp server running on the switch interface ('googlePublicDns', 'openDns' or 'custom')

        :return: The dns_nameservers_option of this UpdateDeviceSwitchRoutingInterfaceDhcpRequest.
        :rtype: str
        """
    ...
    def dns_nameservers_option(self, dns_nameservers_option):
        """Sets the dns_nameservers_option of this UpdateDeviceSwitchRoutingInterfaceDhcpRequest.
    ...
    def fixed_ip_assignments(self):
        """Gets the fixed_ip_assignments of this UpdateDeviceSwitchRoutingInterfaceDhcpRequest.

        Array of DHCP fixed IP assignments for the DHCP server running on the switch interface

        :return: The fixed_ip_assignments of this UpdateDeviceSwitchRoutingInterfaceDhcpRequest.
    ...
    def fixed_ip_assignments(self, fixed_ip_assignments):
        """Sets the fixed_ip_assignments of this UpdateDeviceSwitchRoutingInterfaceDhcpRequest.
    ...
    def reserved_ip_ranges(self):
        """Gets the reserved_ip_ranges of this UpdateDeviceSwitchRoutingInterfaceDhcpRequest.

        Array of DHCP reserved IP assignments for the DHCP server running on the switch interface

        :return: The reserved_ip_ranges of this UpdateDeviceSwitchRoutingInterfaceDhcpRequest.
    ...
    def reserved_ip_ranges(self, reserved_ip_ranges):
        """Sets the reserved_ip_ranges of this UpdateDeviceSwitchRoutingInterfaceDhcpRequest.
