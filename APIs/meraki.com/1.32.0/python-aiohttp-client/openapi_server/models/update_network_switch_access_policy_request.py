...
class UpdateNetworkSwitchAccessPolicyRequest(Model):
    ...
    def __init__(self, access_policy_type: str=None, dot1x: GetNetworkSwitchAccessPolicies200ResponseInnerDot1x=None, guest_port_bouncing: bool=None, guest_vlan_id: int=None, host_mode: str=None, increase_access_speed: bool=None, name: str=None, radius: GetNetworkSwitchAccessPolicies200ResponseInnerRadius=None, radius_accounting_enabled: bool=None, radius_accounting_servers: List[CreateNetworkSwitchAccessPolicyRequestRadiusAccountingServersInner]=None, radius_coa_support_enabled: bool=None, radius_group_attribute: str=None, radius_servers: List[CreateNetworkSwitchAccessPolicyRequestRadiusServersInner]=None, radius_testing_enabled: bool=None, url_redirect_walled_garden_enabled: bool=None, url_redirect_walled_garden_ranges: List[str]=None, voice_vlan_clients: bool=None):
        """UpdateNetworkSwitchAccessPolicyRequest - a model defined in OpenAPI

        :param access_policy_type: The access_policy_type of this UpdateNetworkSwitchAccessPolicyRequest.
        :param dot1x: The dot1x of this UpdateNetworkSwitchAccessPolicyRequest.
        :param guest_port_bouncing: The guest_port_bouncing of this UpdateNetworkSwitchAccessPolicyRequest.
        :param guest_vlan_id: The guest_vlan_id of this UpdateNetworkSwitchAccessPolicyRequest.
        :param host_mode: The host_mode of this UpdateNetworkSwitchAccessPolicyRequest.
        :param increase_access_speed: The increase_access_speed of this UpdateNetworkSwitchAccessPolicyRequest.
        :param name: The name of this UpdateNetworkSwitchAccessPolicyRequest.
        :param radius: The radius of this UpdateNetworkSwitchAccessPolicyRequest.
        :param radius_accounting_enabled: The radius_accounting_enabled of this UpdateNetworkSwitchAccessPolicyRequest.
        :param radius_accounting_servers: The radius_accounting_servers of this UpdateNetworkSwitchAccessPolicyRequest.
        :param radius_coa_support_enabled: The radius_coa_support_enabled of this UpdateNetworkSwitchAccessPolicyRequest.
        :param radius_group_attribute: The radius_group_attribute of this UpdateNetworkSwitchAccessPolicyRequest.
        :param radius_servers: The radius_servers of this UpdateNetworkSwitchAccessPolicyRequest.
        :param radius_testing_enabled: The radius_testing_enabled of this UpdateNetworkSwitchAccessPolicyRequest.
        :param url_redirect_walled_garden_enabled: The url_redirect_walled_garden_enabled of this UpdateNetworkSwitchAccessPolicyRequest.
        :param url_redirect_walled_garden_ranges: The url_redirect_walled_garden_ranges of this UpdateNetworkSwitchAccessPolicyRequest.
        :param voice_vlan_clients: The voice_vlan_clients of this UpdateNetworkSwitchAccessPolicyRequest.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'UpdateNetworkSwitchAccessPolicyRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The updateNetworkSwitchAccessPolicy_request of this UpdateNetworkSwitchAccessPolicyRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def access_policy_type(self):
        """Gets the access_policy_type of this UpdateNetworkSwitchAccessPolicyRequest.

        Access Type of the policy. Automatically 'Hybrid authentication' when hostMode is 'Multi-Domain'.

        :return: The access_policy_type of this UpdateNetworkSwitchAccessPolicyRequest.
        :rtype: str
        """
    ...
    def access_policy_type(self, access_policy_type):
        """Sets the access_policy_type of this UpdateNetworkSwitchAccessPolicyRequest.
    ...
    @property
    def dot1x(self):
        """Gets the dot1x of this UpdateNetworkSwitchAccessPolicyRequest.


        :return: The dot1x of this UpdateNetworkSwitchAccessPolicyRequest.
    ...
    def dot1x(self, dot1x):
        """Sets the dot1x of this UpdateNetworkSwitchAccessPolicyRequest.
    ...
    def guest_port_bouncing(self):
        """Gets the guest_port_bouncing of this UpdateNetworkSwitchAccessPolicyRequest.

        If enabled, Meraki devices will periodically send access-request messages to these RADIUS servers

        :return: The guest_port_bouncing of this UpdateNetworkSwitchAccessPolicyRequest.
        :rtype: bool
        """
    ...
    def guest_port_bouncing(self, guest_port_bouncing):
        """Sets the guest_port_bouncing of this UpdateNetworkSwitchAccessPolicyRequest.
    ...
    def guest_vlan_id(self):
        """Gets the guest_vlan_id of this UpdateNetworkSwitchAccessPolicyRequest.

        ID for the guest VLAN allow unauthorized devices access to limited network resources

        :return: The guest_vlan_id of this UpdateNetworkSwitchAccessPolicyRequest.
        :rtype: int
        """
    ...
    def guest_vlan_id(self, guest_vlan_id):
        """Sets the guest_vlan_id of this UpdateNetworkSwitchAccessPolicyRequest.
    ...
    @property
    def host_mode(self):
        """Gets the host_mode of this UpdateNetworkSwitchAccessPolicyRequest.

        Choose the Host Mode for the access policy.

        :return: The host_mode of this UpdateNetworkSwitchAccessPolicyRequest.
        :rtype: str
        """
    ...
    def host_mode(self, host_mode):
        """Sets the host_mode of this UpdateNetworkSwitchAccessPolicyRequest.
    ...
    def increase_access_speed(self):
        """Gets the increase_access_speed of this UpdateNetworkSwitchAccessPolicyRequest.

        Enabling this option will make switches execute 802.1X and MAC-bypass authentication simultaneously so that clients authenticate faster. Only required when accessPolicyType is 'Hybrid Authentication.

        :return: The increase_access_speed of this UpdateNetworkSwitchAccessPolicyRequest.
        :rtype: bool
        """
    ...
    def increase_access_speed(self, increase_access_speed):
        """Sets the increase_access_speed of this UpdateNetworkSwitchAccessPolicyRequest.
    ...
    @property
    def name(self):
        """Gets the name of this UpdateNetworkSwitchAccessPolicyRequest.

        Name of the access policy

        :return: The name of this UpdateNetworkSwitchAccessPolicyRequest.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this UpdateNetworkSwitchAccessPolicyRequest.
    ...
    @property
    def radius(self):
        """Gets the radius of this UpdateNetworkSwitchAccessPolicyRequest.


        :return: The radius of this UpdateNetworkSwitchAccessPolicyRequest.
    ...
    def radius(self, radius):
        """Sets the radius of this UpdateNetworkSwitchAccessPolicyRequest.
    ...
    def radius_accounting_enabled(self):
        """Gets the radius_accounting_enabled of this UpdateNetworkSwitchAccessPolicyRequest.

        Enable to send start, interim-update and stop messages to a configured RADIUS accounting server for tracking connected clients

        :return: The radius_accounting_enabled of this UpdateNetworkSwitchAccessPolicyRequest.
        :rtype: bool
        """
    ...
    def radius_accounting_enabled(self, radius_accounting_enabled):
        """Sets the radius_accounting_enabled of this UpdateNetworkSwitchAccessPolicyRequest.
    ...
    def radius_accounting_servers(self):
        """Gets the radius_accounting_servers of this UpdateNetworkSwitchAccessPolicyRequest.

        List of RADIUS accounting servers to require connecting devices to authenticate against before granting network access

        :return: The radius_accounting_servers of this UpdateNetworkSwitchAccessPolicyRequest.
    ...
    def radius_accounting_servers(self, radius_accounting_servers):
        """Sets the radius_accounting_servers of this UpdateNetworkSwitchAccessPolicyRequest.
    ...
    def radius_coa_support_enabled(self):
        """Gets the radius_coa_support_enabled of this UpdateNetworkSwitchAccessPolicyRequest.

        Change of authentication for RADIUS re-authentication and disconnection

        :return: The radius_coa_support_enabled of this UpdateNetworkSwitchAccessPolicyRequest.
        :rtype: bool
        """
    ...
    def radius_coa_support_enabled(self, radius_coa_support_enabled):
        """Sets the radius_coa_support_enabled of this UpdateNetworkSwitchAccessPolicyRequest.
    ...
    def radius_group_attribute(self):
        """Gets the radius_group_attribute of this UpdateNetworkSwitchAccessPolicyRequest.

        Acceptable values are `\"\"` for None, or `\"11\"` for Group Policies ACL

        :return: The radius_group_attribute of this UpdateNetworkSwitchAccessPolicyRequest.
        :rtype: str
        """
    ...
    def radius_group_attribute(self, radius_group_attribute):
        """Sets the radius_group_attribute of this UpdateNetworkSwitchAccessPolicyRequest.
    ...
    def radius_servers(self):
        """Gets the radius_servers of this UpdateNetworkSwitchAccessPolicyRequest.

        List of RADIUS servers to require connecting devices to authenticate against before granting network access

        :return: The radius_servers of this UpdateNetworkSwitchAccessPolicyRequest.
    ...
    def radius_servers(self, radius_servers):
        """Sets the radius_servers of this UpdateNetworkSwitchAccessPolicyRequest.
    ...
    def radius_testing_enabled(self):
        """Gets the radius_testing_enabled of this UpdateNetworkSwitchAccessPolicyRequest.

        If enabled, Meraki devices will periodically send access-request messages to these RADIUS servers

        :return: The radius_testing_enabled of this UpdateNetworkSwitchAccessPolicyRequest.
        :rtype: bool
        """
    ...
    def radius_testing_enabled(self, radius_testing_enabled):
        """Sets the radius_testing_enabled of this UpdateNetworkSwitchAccessPolicyRequest.
    ...
    def url_redirect_walled_garden_enabled(self):
        """Gets the url_redirect_walled_garden_enabled of this UpdateNetworkSwitchAccessPolicyRequest.

        Enable to restrict access for clients to a specific set of IP addresses or hostnames prior to authentication

        :return: The url_redirect_walled_garden_enabled of this UpdateNetworkSwitchAccessPolicyRequest.
        :rtype: bool
        """
    ...
    def url_redirect_walled_garden_enabled(self, url_redirect_walled_garden_enabled):
        """Sets the url_redirect_walled_garden_enabled of this UpdateNetworkSwitchAccessPolicyRequest.
    ...
    def url_redirect_walled_garden_ranges(self):
        """Gets the url_redirect_walled_garden_ranges of this UpdateNetworkSwitchAccessPolicyRequest.

        IP address ranges, in CIDR notation, to restrict access for clients to a specific set of IP addresses or hostnames prior to authentication

        :return: The url_redirect_walled_garden_ranges of this UpdateNetworkSwitchAccessPolicyRequest.
        :rtype: List[str]
        """
    ...
    def url_redirect_walled_garden_ranges(self, url_redirect_walled_garden_ranges):
        """Sets the url_redirect_walled_garden_ranges of this UpdateNetworkSwitchAccessPolicyRequest.
    ...
    def voice_vlan_clients(self):
        """Gets the voice_vlan_clients of this UpdateNetworkSwitchAccessPolicyRequest.

        CDP/LLDP capable voice clients will be able to use this VLAN. Automatically true when hostMode is 'Multi-Domain'.

        :return: The voice_vlan_clients of this UpdateNetworkSwitchAccessPolicyRequest.
        :rtype: bool
        """
    ...
    def voice_vlan_clients(self, voice_vlan_clients):
        """Sets the voice_vlan_clients of this UpdateNetworkSwitchAccessPolicyRequest.
