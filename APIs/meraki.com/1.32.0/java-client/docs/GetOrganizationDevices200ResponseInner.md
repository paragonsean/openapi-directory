...
|**lanIp** | **String** | LAN IP address of the device |  [optional] |
...
|**networkId** | **String** | ID of the network the device belongs to |  [optional] |
...
|**tags** | **List&lt;String&gt;** | List of tags assigned to the device |  [optional] |
