...
<a id="createNetworkMerakiAuthUser_1"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      GetNetworkMerakiAuthUsers200ResponseInner result = apiInstance.createNetworkMerakiAuthUser_1(networkId, createNetworkMerakiAuthUserRequest);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling MerakiAuthUsersApi#createNetworkMerakiAuthUser_1");
...
<a id="deleteNetworkMerakiAuthUser_1"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.deleteNetworkMerakiAuthUser_1(networkId, merakiAuthUserId);
    } catch (ApiException e) {
      System.err.println("Exception when calling MerakiAuthUsersApi#deleteNetworkMerakiAuthUser_1");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="getNetworkMerakiAuthUser_1"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String merakiAuthUserId = "merakiAuthUserId_example"; // String | 
    try {
      GetNetworkMerakiAuthUsers200ResponseInner result = apiInstance.getNetworkMerakiAuthUser_1(networkId, merakiAuthUserId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling MerakiAuthUsersApi#getNetworkMerakiAuthUser_1");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="getNetworkMerakiAuthUsers_1"></a>
# **getNetworkMerakiAuthUsers_1**
> List&lt;GetNetworkMerakiAuthUsers200ResponseInner&gt; getNetworkMerakiAuthUsers_1(networkId)
...
public class Example {
  public static void main(String[] args) {
    ...
    String networkId = "networkId_example"; // String | 
    try {
      List<GetNetworkMerakiAuthUsers200ResponseInner> result = apiInstance.getNetworkMerakiAuthUsers_1(networkId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling MerakiAuthUsersApi#getNetworkMerakiAuthUsers_1");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="updateNetworkMerakiAuthUser_1"></a>
# **updateNetworkMerakiAuthUser_1**
> GetNetworkMerakiAuthUsers200ResponseInner updateNetworkMerakiAuthUser_1(networkId, merakiAuthUserId, updateNetworkMerakiAuthUserRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      GetNetworkMerakiAuthUsers200ResponseInner result = apiInstance.updateNetworkMerakiAuthUser_1(networkId, merakiAuthUserId, updateNetworkMerakiAuthUserRequest);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling MerakiAuthUsersApi#updateNetworkMerakiAuthUser_1");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
