...
<a id="getOrganizationConfigurationChanges_1"></a>
# **getOrganizationConfigurationChanges_1**
> List&lt;Object&gt; getOrganizationConfigurationChanges_1(organizationId, t0, t1, timespan, perPage, startingAfter, endingBefore, networkId, adminId)
...
import org.openapitools.client.api.ConfigurationChangesApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    ConfigurationChangesApi apiInstance = new ConfigurationChangesApi(defaultClient);
    ...
    try {
      List<Object> result = apiInstance.getOrganizationConfigurationChanges_1(organizationId, t0, t1, timespan, perPage, startingAfter, endingBefore, networkId, adminId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ConfigurationChangesApi#getOrganizationConfigurationChanges_1");
