...
<a id="getNetworkTopologyLinkLayer_1"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Object result = apiInstance.getNetworkTopologyLinkLayer_1(networkId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling TopologyApi#getNetworkTopologyLinkLayer_1");
