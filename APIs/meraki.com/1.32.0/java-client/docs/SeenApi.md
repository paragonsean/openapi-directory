...
<a id="getNetworkSwitchDhcpV4ServersSeen_4"></a>
# **getNetworkSwitchDhcpV4ServersSeen_4**
> List&lt;GetNetworkSwitchDhcpV4ServersSeen200ResponseInner&gt; getNetworkSwitchDhcpV4ServersSeen_4(networkId, t0, timespan, perPage, startingAfter, endingBefore)
...
import org.openapitools.client.api.SeenApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    SeenApi apiInstance = new SeenApi(defaultClient);
    ...
    try {
      List<GetNetworkSwitchDhcpV4ServersSeen200ResponseInner> result = apiInstance.getNetworkSwitchDhcpV4ServersSeen_4(networkId, t0, timespan, perPage, startingAfter, endingBefore);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling SeenApi#getNetworkSwitchDhcpV4ServersSeen_4");
