...
<a id="getOrganizationDevicesUplinksAddressesByDevice_3"></a>
# **getOrganizationDevicesUplinksAddressesByDevice_3**
> List&lt;GetOrganizationDevicesUplinksAddressesByDevice200ResponseInner&gt; getOrganizationDevicesUplinksAddressesByDevice_3(organizationId, perPage, startingAfter, endingBefore, networkIds, productTypes, serials, tags, tagsFilterType)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      List<GetOrganizationDevicesUplinksAddressesByDevice200ResponseInner> result = apiInstance.getOrganizationDevicesUplinksAddressesByDevice_3(organizationId, perPage, startingAfter, endingBefore, networkIds, productTypes, serials, tags, tagsFilterType);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling AddressesApi#getOrganizationDevicesUplinksAddressesByDevice_3");
