...
|------------ | ------------- | ------------- | -------------|
|**alertTypeId** | **String** | The type of alert which the test webhook will send. Optional. Defaults to power_supply_down. |  [optional] |
...
|**sharedSecret** | **String** | The shared secret the test webhook will send. Optional. Defaults to an empty string. |  [optional] |
