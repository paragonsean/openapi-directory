...
|**orders** | **List&lt;String&gt;** | The numbers of the orders that should be claimed |  [optional] |
|**serials** | **List&lt;String&gt;** | The serials of the devices that should be claimed |  [optional] |
