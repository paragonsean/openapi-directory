...
<a id="getOrganizationClientsSearch_2"></a>
# **getOrganizationClientsSearch_2**
> Object getOrganizationClientsSearch_2(organizationId, mac, perPage, startingAfter, endingBefore)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Object result = apiInstance.getOrganizationClientsSearch_2(organizationId, mac, perPage, startingAfter, endingBefore);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling SearchApi#getOrganizationClientsSearch_2");
