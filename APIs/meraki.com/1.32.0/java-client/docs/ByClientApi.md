...
<a id="getNetworkPoliciesByClient_2"></a>
# **getNetworkPoliciesByClient_2**
> List&lt;GetNetworkPoliciesByClient200ResponseInner&gt; getNetworkPoliciesByClient_2(networkId, perPage, startingAfter, endingBefore, t0, timespan)
...
import org.openapitools.client.api.ByClientApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    ByClientApi apiInstance = new ByClientApi(defaultClient);
    ...
    try {
      List<GetNetworkPoliciesByClient200ResponseInner> result = apiInstance.getNetworkPoliciesByClient_2(networkId, perPage, startingAfter, endingBefore, t0, timespan);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ByClientApi#getNetworkPoliciesByClient_2");
