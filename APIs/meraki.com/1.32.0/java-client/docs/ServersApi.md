...
<a id="getNetworkSwitchDhcpV4ServersSeen_3"></a>
# **getNetworkSwitchDhcpV4ServersSeen_3**
> List&lt;GetNetworkSwitchDhcpV4ServersSeen200ResponseInner&gt; getNetworkSwitchDhcpV4ServersSeen_3(networkId, t0, timespan, perPage, startingAfter, endingBefore)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      List<GetNetworkSwitchDhcpV4ServersSeen200ResponseInner> result = apiInstance.getNetworkSwitchDhcpV4ServersSeen_3(networkId, t0, timespan, perPage, startingAfter, endingBefore);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ServersApi#getNetworkSwitchDhcpV4ServersSeen_3");
