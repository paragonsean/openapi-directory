...
<a id="getOrganizationFirmwareUpgradesByDevice_1"></a>
# **getOrganizationFirmwareUpgradesByDevice_1**
> List&lt;GetOrganizationFirmwareUpgradesByDevice200ResponseInner&gt; getOrganizationFirmwareUpgradesByDevice_1(organizationId, perPage, startingAfter, endingBefore, networkIds, serials, macs, firmwareUpgradeIds, firmwareUpgradeBatchIds)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      List<GetOrganizationFirmwareUpgradesByDevice200ResponseInner> result = apiInstance.getOrganizationFirmwareUpgradesByDevice_1(organizationId, perPage, startingAfter, endingBefore, networkIds, serials, macs, firmwareUpgradeIds, firmwareUpgradeBatchIds);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling FirmwareApi#getOrganizationFirmwareUpgradesByDevice_1");
...
<a id="getOrganizationFirmwareUpgrades_1"></a>
# **getOrganizationFirmwareUpgrades_1**
> List&lt;GetOrganizationFirmwareUpgrades200ResponseInner&gt; getOrganizationFirmwareUpgrades_1(organizationId, status, productType)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      List<GetOrganizationFirmwareUpgrades200ResponseInner> result = apiInstance.getOrganizationFirmwareUpgrades_1(organizationId, status, productType);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling FirmwareApi#getOrganizationFirmwareUpgrades_1");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
