...
|------------- | ------------- | -------------|
| [**getNetworkWirelessSignalQualityHistory_1**](SignalQualityHistoryApi.md#getNetworkWirelessSignalQualityHistory_1) | **GET** /networks/{networkId}/wireless/signalQualityHistory | Return signal quality (SNR/RSSI) over time for a device or network client |


<a id="getNetworkWirelessSignalQualityHistory_1"></a>
# **getNetworkWirelessSignalQualityHistory_1**
> List&lt;GetNetworkWirelessSignalQualityHistory200ResponseInner&gt; getNetworkWirelessSignalQualityHistory_1(networkId, t0, t1, timespan, resolution, autoResolution, clientId, deviceSerial, apTag, band, ssid)
...
import org.openapitools.client.api.SignalQualityHistoryApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    SignalQualityHistoryApi apiInstance = new SignalQualityHistoryApi(defaultClient);
    ...
    try {
      List<GetNetworkWirelessSignalQualityHistory200ResponseInner> result = apiInstance.getNetworkWirelessSignalQualityHistory_1(networkId, t0, t1, timespan, resolution, autoResolution, clientId, deviceSerial, apTag, band, ssid);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling SignalQualityHistoryApi#getNetworkWirelessSignalQualityHistory_1");
