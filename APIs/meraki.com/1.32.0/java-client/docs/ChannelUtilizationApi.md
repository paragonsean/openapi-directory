...
<a id="getNetworkNetworkHealthChannelUtilization_2"></a>
# **getNetworkNetworkHealthChannelUtilization_2**
> List&lt;Object&gt; getNetworkNetworkHealthChannelUtilization_2(networkId, t0, t1, timespan, resolution, perPage, startingAfter, endingBefore)
...
import org.openapitools.client.api.ChannelUtilizationApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    ChannelUtilizationApi apiInstance = new ChannelUtilizationApi(defaultClient);
    ...
    try {
      List<Object> result = apiInstance.getNetworkNetworkHealthChannelUtilization_2(networkId, t0, t1, timespan, resolution, perPage, startingAfter, endingBefore);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ChannelUtilizationApi#getNetworkNetworkHealthChannelUtilization_2");
