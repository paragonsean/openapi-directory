...
|------------ | ------------- | ------------- | -------------|
|**dscp** | **Integer** | DSCP tag that should be assigned to incoming packet. Set this to -1 to trust incoming DSCP. Default value is 0. |  [optional] |
...
|**vlan** | **Integer** | The VLAN of the incoming packet. A null value will match any VLAN. |  [optional] |
