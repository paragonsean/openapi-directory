...
<a id="getNetworkClientsUsageHistories_2"></a>
# **getNetworkClientsUsageHistories_2**
> List&lt;Object&gt; getNetworkClientsUsageHistories_2(networkId, clients, ssidNumber, perPage, startingAfter, endingBefore, t0, t1, timespan)
...
import org.openapitools.client.api.UsageHistoriesApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    UsageHistoriesApi apiInstance = new UsageHistoriesApi(defaultClient);
    ...
    try {
      List<Object> result = apiInstance.getNetworkClientsUsageHistories_2(networkId, clients, ssidNumber, perPage, startingAfter, endingBefore, t0, t1, timespan);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling UsageHistoriesApi#getNetworkClientsUsageHistories_2");
