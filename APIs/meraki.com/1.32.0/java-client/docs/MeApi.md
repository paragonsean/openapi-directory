...
<a id="getAdministeredIdentitiesMe_2"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      GetAdministeredIdentitiesMe200Response result = apiInstance.getAdministeredIdentitiesMe_2();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling MeApi#getAdministeredIdentitiesMe_2");
