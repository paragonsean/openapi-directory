...
|**osName** | **String** | The name of the device OS. |  [optional] |
...
|**systemModel** | **String** | The device model. |  [optional] |
|**tags** | **List&lt;String&gt;** | An array of tags associated with the device. |  [optional] |
|**uuid** | **String** | The UUID of the device. |  [optional] |
|**wifiMac** | **String** | The MAC of the device. |  [optional] |
