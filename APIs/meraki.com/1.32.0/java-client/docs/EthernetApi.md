...
<a id="getOrganizationWirelessDevicesEthernetStatuses_2"></a>
# **getOrganizationWirelessDevicesEthernetStatuses_2**
> List&lt;GetOrganizationWirelessDevicesEthernetStatuses200ResponseInner&gt; getOrganizationWirelessDevicesEthernetStatuses_2(organizationId, perPage, startingAfter, endingBefore, networkIds)
...
import org.openapitools.client.api.EthernetApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    EthernetApi apiInstance = new EthernetApi(defaultClient);
    ...
    try {
      List<GetOrganizationWirelessDevicesEthernetStatuses200ResponseInner> result = apiInstance.getOrganizationWirelessDevicesEthernetStatuses_2(organizationId, perPage, startingAfter, endingBefore, networkIds);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling EthernetApi#getOrganizationWirelessDevicesEthernetStatuses_2");
