...
|------------- | ------------- | -------------|
| [**getNetworkInsightApplicationHealthByTime_2**](HealthByTimeApi.md#getNetworkInsightApplicationHealthByTime_2) | **GET** /networks/{networkId}/insight/applications/{applicationId}/healthByTime | Get application health by time |


<a id="getNetworkInsightApplicationHealthByTime_2"></a>
# **getNetworkInsightApplicationHealthByTime_2**
> List&lt;GetNetworkInsightApplicationHealthByTime200ResponseInner&gt; getNetworkInsightApplicationHealthByTime_2(networkId, applicationId, t0, t1, timespan, resolution)
...
import org.openapitools.client.api.HealthByTimeApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    HealthByTimeApi apiInstance = new HealthByTimeApi(defaultClient);
    ...
    try {
      List<GetNetworkInsightApplicationHealthByTime200ResponseInner> result = apiInstance.getNetworkInsightApplicationHealthByTime_2(networkId, applicationId, t0, t1, timespan, resolution);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling HealthByTimeApi#getNetworkInsightApplicationHealthByTime_2");
