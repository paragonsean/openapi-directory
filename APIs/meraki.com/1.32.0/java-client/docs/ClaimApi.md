...
<a id="vmxNetworkDevicesClaim_2"></a>
...
import org.openapitools.client.api.ClaimApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    ClaimApi apiInstance = new ClaimApi(defaultClient);
    ...
    try {
      Object result = apiInstance.vmxNetworkDevicesClaim_2(networkId, vmxNetworkDevicesClaimRequest);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ClaimApi#vmxNetworkDevicesClaim_2");
