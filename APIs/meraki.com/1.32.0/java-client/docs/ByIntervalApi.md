...
<a id="getOrganizationApiRequestsOverviewResponseCodesByInterval_4"></a>
# **getOrganizationApiRequestsOverviewResponseCodesByInterval_4**
> List&lt;GetOrganizationApiRequestsOverviewResponseCodesByInterval200ResponseInner&gt; getOrganizationApiRequestsOverviewResponseCodesByInterval_4(organizationId, t0, t1, timespan, interval, version, operationIds, sourceIps, adminIds, userAgent)
...
import org.openapitools.client.api.ByIntervalApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    ByIntervalApi apiInstance = new ByIntervalApi(defaultClient);
    ...
    try {
      List<GetOrganizationApiRequestsOverviewResponseCodesByInterval200ResponseInner> result = apiInstance.getOrganizationApiRequestsOverviewResponseCodesByInterval_4(organizationId, t0, t1, timespan, interval, version, operationIds, sourceIps, adminIds, userAgent);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ByIntervalApi#getOrganizationApiRequestsOverviewResponseCodesByInterval_4");
