...
|------------- | ------------- | -------------|
| [**getNetworkSplashLoginAttempts_1**](SplashLoginAttemptsApi.md#getNetworkSplashLoginAttempts_1) | **GET** /networks/{networkId}/splashLoginAttempts | List the splash login attempts for a network |


<a id="getNetworkSplashLoginAttempts_1"></a>
# **getNetworkSplashLoginAttempts_1**
> List&lt;Object&gt; getNetworkSplashLoginAttempts_1(networkId, ssidNumber, loginIdentifier, timespan)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      List<Object> result = apiInstance.getNetworkSplashLoginAttempts_1(networkId, ssidNumber, loginIdentifier, timespan);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling SplashLoginAttemptsApi#getNetworkSplashLoginAttempts_1");
