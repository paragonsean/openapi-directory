...
<a id="getDeviceCameraAnalyticsLive_1"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Object result = apiInstance.getDeviceCameraAnalyticsLive_1(serial);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling AnalyticsApi#getDeviceCameraAnalyticsLive_1");
...
<a id="getDeviceCameraAnalyticsOverview_1"></a>
# **getDeviceCameraAnalyticsOverview_1**
> List&lt;Object&gt; getDeviceCameraAnalyticsOverview_1(serial, t0, t1, timespan, objectType)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      List<Object> result = apiInstance.getDeviceCameraAnalyticsOverview_1(serial, t0, t1, timespan, objectType);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling AnalyticsApi#getDeviceCameraAnalyticsOverview_1");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="getDeviceCameraAnalyticsRecent_1"></a>
# **getDeviceCameraAnalyticsRecent_1**
> List&lt;Object&gt; getDeviceCameraAnalyticsRecent_1(serial, objectType)
...
public class Example {
  public static void main(String[] args) {
    ...
    String objectType = "person"; // String | [optional] The object type for which analytics will be retrieved. The default object type is person. The available types are [person, vehicle].
    try {
      List<Object> result = apiInstance.getDeviceCameraAnalyticsRecent_1(serial, objectType);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling AnalyticsApi#getDeviceCameraAnalyticsRecent_1");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="getDeviceCameraAnalyticsZoneHistory_1"></a>
# **getDeviceCameraAnalyticsZoneHistory_1**
> List&lt;Object&gt; getDeviceCameraAnalyticsZoneHistory_1(serial, zoneId, t0, t1, timespan, resolution, objectType)
...
public class Example {
  public static void main(String[] args) {
    ...
    String objectType = "person"; // String | [optional] The object type for which analytics will be retrieved. The default object type is person. The available types are [person, vehicle].
    try {
      List<Object> result = apiInstance.getDeviceCameraAnalyticsZoneHistory_1(serial, zoneId, t0, t1, timespan, resolution, objectType);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling AnalyticsApi#getDeviceCameraAnalyticsZoneHistory_1");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="getDeviceCameraAnalyticsZones_1"></a>
# **getDeviceCameraAnalyticsZones_1**
> List&lt;Object&gt; getDeviceCameraAnalyticsZones_1(serial)
...
public class Example {
  public static void main(String[] args) {
    ...
    String serial = "serial_example"; // String | 
    try {
      List<Object> result = apiInstance.getDeviceCameraAnalyticsZones_1(serial);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling AnalyticsApi#getDeviceCameraAnalyticsZones_1");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
