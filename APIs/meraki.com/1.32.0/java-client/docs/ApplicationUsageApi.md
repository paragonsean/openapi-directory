...
<a id="getNetworkClientsApplicationUsage_2"></a>
# **getNetworkClientsApplicationUsage_2**
> List&lt;Object&gt; getNetworkClientsApplicationUsage_2(networkId, clients, ssidNumber, perPage, startingAfter, endingBefore, t0, t1, timespan)
...
import org.openapitools.client.api.ApplicationUsageApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    ApplicationUsageApi apiInstance = new ApplicationUsageApi(defaultClient);
    ...
    try {
      List<Object> result = apiInstance.getNetworkClientsApplicationUsage_2(networkId, clients, ssidNumber, perPage, startingAfter, endingBefore, t0, t1, timespan);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApplicationUsageApi#getNetworkClientsApplicationUsage_2");
