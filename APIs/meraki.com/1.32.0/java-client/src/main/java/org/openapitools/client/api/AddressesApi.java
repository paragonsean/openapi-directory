...
public class AddressesApi {
    ...
    /**
     * Build call for getOrganizationDevicesUplinksAddressesByDevice_3
     ...
     */
    public okhttp3.Call getOrganizationDevicesUplinksAddressesByDevice_3Call(String organizationId, Integer perPage, String startingAfter, String endingBefore, List<String> networkIds, List<String> productTypes, List<String> serials, List<String> tags, String tagsFilterType, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getOrganizationDevicesUplinksAddressesByDevice_3ValidateBeforeCall(String organizationId, Integer perPage, String startingAfter, String endingBefore, List<String> networkIds, List<String> productTypes, List<String> serials, List<String> tags, String tagsFilterType, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'organizationId' is set
        if (organizationId == null) {
            throw new ApiException("Missing the required parameter 'organizationId' when calling getOrganizationDevicesUplinksAddressesByDevice_3(Async)");
        }

        return getOrganizationDevicesUplinksAddressesByDevice_3Call(organizationId, perPage, startingAfter, endingBefore, networkIds, productTypes, serials, tags, tagsFilterType, _callback);
    ...
    public List<GetOrganizationDevicesUplinksAddressesByDevice200ResponseInner> getOrganizationDevicesUplinksAddressesByDevice_3(String organizationId, Integer perPage, String startingAfter, String endingBefore, List<String> networkIds, List<String> productTypes, List<String> serials, List<String> tags, String tagsFilterType) throws ApiException {
        ApiResponse<List<GetOrganizationDevicesUplinksAddressesByDevice200ResponseInner>> localVarResp = getOrganizationDevicesUplinksAddressesByDevice_3WithHttpInfo(organizationId, perPage, startingAfter, endingBefore, networkIds, productTypes, serials, tags, tagsFilterType);
     ...
     */
    public ApiResponse<List<GetOrganizationDevicesUplinksAddressesByDevice200ResponseInner>> getOrganizationDevicesUplinksAddressesByDevice_3WithHttpInfo(String organizationId, Integer perPage, String startingAfter, String endingBefore, List<String> networkIds, List<String> productTypes, List<String> serials, List<String> tags, String tagsFilterType) throws ApiException {
        okhttp3.Call localVarCall = getOrganizationDevicesUplinksAddressesByDevice_3ValidateBeforeCall(organizationId, perPage, startingAfter, endingBefore, networkIds, productTypes, serials, tags, tagsFilterType, null);
     ...
     */
    public okhttp3.Call getOrganizationDevicesUplinksAddressesByDevice_3Async(String organizationId, Integer perPage, String startingAfter, String endingBefore, List<String> networkIds, List<String> productTypes, List<String> serials, List<String> tags, String tagsFilterType, final ApiCallback<List<GetOrganizationDevicesUplinksAddressesByDevice200ResponseInner>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getOrganizationDevicesUplinksAddressesByDevice_3ValidateBeforeCall(organizationId, perPage, startingAfter, endingBefore, networkIds, productTypes, serials, tags, tagsFilterType, _callback);
        Type localVarReturnType = new TypeToken<List<GetOrganizationDevicesUplinksAddressesByDevice200ResponseInner>>(){}.getType();
