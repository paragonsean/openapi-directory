...
public class GetNetworkApplianceVlans200ResponseInner {
  ...
  private List<GetNetworkApplianceVlans200ResponseInnerReservedIpRangesInner> reservedIpRanges = new ArrayList<>();
  ...
  public GetNetworkApplianceVlans200ResponseInner() {
  }

  public GetNetworkApplianceVlans200ResponseInner applianceIp(String applianceIp) {
  ...
  public GetNetworkApplianceVlans200ResponseInner cidr(String cidr) {
    this.cidr = cidr;
    return this;
  }
  ...
  public GetNetworkApplianceVlans200ResponseInner dhcpBootFilename(String dhcpBootFilename) {
  ...
  public GetNetworkApplianceVlans200ResponseInner dhcpBootNextServer(String dhcpBootNextServer) {
  ...
  public GetNetworkApplianceVlans200ResponseInner dhcpBootOptionsEnabled(Boolean dhcpBootOptionsEnabled) {
  ...
  public GetNetworkApplianceVlans200ResponseInner dhcpHandling(DhcpHandlingEnum dhcpHandling) {
  ...
  public GetNetworkApplianceVlans200ResponseInner dhcpLeaseTime(DhcpLeaseTimeEnum dhcpLeaseTime) {
  ...
  public GetNetworkApplianceVlans200ResponseInner dhcpOptions(List<GetNetworkApplianceVlans200ResponseInnerDhcpOptionsInner> dhcpOptions) {
    this.dhcpOptions = dhcpOptions;
    return this;
  }

  public GetNetworkApplianceVlans200ResponseInner addDhcpOptionsItem(GetNetworkApplianceVlans200ResponseInnerDhcpOptionsInner dhcpOptionsItem) {
  ...
  public GetNetworkApplianceVlans200ResponseInner dhcpRelayServerIps(List<String> dhcpRelayServerIps) {
    this.dhcpRelayServerIps = dhcpRelayServerIps;
    return this;
  }

  public GetNetworkApplianceVlans200ResponseInner addDhcpRelayServerIpsItem(String dhcpRelayServerIpsItem) {
  ...
  public GetNetworkApplianceVlans200ResponseInner dnsNameservers(String dnsNameservers) {
  ...
  public GetNetworkApplianceVlans200ResponseInner fixedIpAssignments(Object fixedIpAssignments) {
  ...
  public GetNetworkApplianceVlans200ResponseInner groupPolicyId(String groupPolicyId) {
  ...
  public GetNetworkApplianceVlans200ResponseInner id(String id) {
    this.id = id;
    return this;
  }
  ...
  public GetNetworkApplianceVlans200ResponseInner interfaceId(String interfaceId) {
  ...
  public GetNetworkApplianceVlans200ResponseInner ipv6(GetNetworkApplianceVlans200ResponseInnerIpv6 ipv6) {
    this.ipv6 = ipv6;
    return this;
  }
  ...
  public GetNetworkApplianceVlans200ResponseInner mandatoryDhcp(GetNetworkApplianceVlans200ResponseInnerMandatoryDhcp mandatoryDhcp) {
  ...
  public GetNetworkApplianceVlans200ResponseInner mask(Integer mask) {
    this.mask = mask;
    return this;
  }
  ...
  public GetNetworkApplianceVlans200ResponseInner name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GetNetworkApplianceVlans200ResponseInner reservedIpRanges(List<GetNetworkApplianceVlans200ResponseInnerReservedIpRangesInner> reservedIpRanges) {
    this.reservedIpRanges = reservedIpRanges;
    return this;
  }

  public GetNetworkApplianceVlans200ResponseInner addReservedIpRangesItem(GetNetworkApplianceVlans200ResponseInnerReservedIpRangesInner reservedIpRangesItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<GetNetworkApplianceVlans200ResponseInnerReservedIpRangesInner> getReservedIpRanges() {
    return reservedIpRanges;
  }

  public void setReservedIpRanges(List<GetNetworkApplianceVlans200ResponseInnerReservedIpRangesInner> reservedIpRanges) {
    this.reservedIpRanges = reservedIpRanges;
  }


  public GetNetworkApplianceVlans200ResponseInner subnet(String subnet) {
    this.subnet = subnet;
    return this;
  }
  ...
  public GetNetworkApplianceVlans200ResponseInner templateVlanType(TemplateVlanTypeEnum templateVlanType) {
  ...
  public GetNetworkApplianceVlans200ResponseInner vpnNatSubnet(String vpnNatSubnet) {
  ...
  public boolean equals(Object o) {
    ...
    GetNetworkApplianceVlans200ResponseInner getNetworkApplianceVlans200ResponseInner = (GetNetworkApplianceVlans200ResponseInner) o;
    return Objects.equals(this.applianceIp, getNetworkApplianceVlans200ResponseInner.applianceIp) &&
        Objects.equals(this.cidr, getNetworkApplianceVlans200ResponseInner.cidr) &&
        Objects.equals(this.dhcpBootFilename, getNetworkApplianceVlans200ResponseInner.dhcpBootFilename) &&
        Objects.equals(this.dhcpBootNextServer, getNetworkApplianceVlans200ResponseInner.dhcpBootNextServer) &&
        Objects.equals(this.dhcpBootOptionsEnabled, getNetworkApplianceVlans200ResponseInner.dhcpBootOptionsEnabled) &&
        Objects.equals(this.dhcpHandling, getNetworkApplianceVlans200ResponseInner.dhcpHandling) &&
        Objects.equals(this.dhcpLeaseTime, getNetworkApplianceVlans200ResponseInner.dhcpLeaseTime) &&
        Objects.equals(this.dhcpOptions, getNetworkApplianceVlans200ResponseInner.dhcpOptions) &&
        Objects.equals(this.dhcpRelayServerIps, getNetworkApplianceVlans200ResponseInner.dhcpRelayServerIps) &&
        Objects.equals(this.dnsNameservers, getNetworkApplianceVlans200ResponseInner.dnsNameservers) &&
        Objects.equals(this.fixedIpAssignments, getNetworkApplianceVlans200ResponseInner.fixedIpAssignments) &&
        Objects.equals(this.groupPolicyId, getNetworkApplianceVlans200ResponseInner.groupPolicyId) &&
        Objects.equals(this.id, getNetworkApplianceVlans200ResponseInner.id) &&
        Objects.equals(this.interfaceId, getNetworkApplianceVlans200ResponseInner.interfaceId) &&
        Objects.equals(this.ipv6, getNetworkApplianceVlans200ResponseInner.ipv6) &&
        Objects.equals(this.mandatoryDhcp, getNetworkApplianceVlans200ResponseInner.mandatoryDhcp) &&
        Objects.equals(this.mask, getNetworkApplianceVlans200ResponseInner.mask) &&
        Objects.equals(this.name, getNetworkApplianceVlans200ResponseInner.name) &&
        Objects.equals(this.reservedIpRanges, getNetworkApplianceVlans200ResponseInner.reservedIpRanges) &&
        Objects.equals(this.subnet, getNetworkApplianceVlans200ResponseInner.subnet) &&
        Objects.equals(this.templateVlanType, getNetworkApplianceVlans200ResponseInner.templateVlanType) &&
        Objects.equals(this.vpnNatSubnet, getNetworkApplianceVlans200ResponseInner.vpnNatSubnet);
  }

  @Override
  public int hashCode() {
    return Objects.hash(applianceIp, cidr, dhcpBootFilename, dhcpBootNextServer, dhcpBootOptionsEnabled, dhcpHandling, dhcpLeaseTime, dhcpOptions, dhcpRelayServerIps, dnsNameservers, fixedIpAssignments, groupPolicyId, id, interfaceId, ipv6, mandatoryDhcp, mask, name, reservedIpRanges, subnet, templateVlanType, vpnNatSubnet);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetNetworkApplianceVlans200ResponseInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetNetworkApplianceVlans200ResponseInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetNetworkApplianceVlans200ResponseInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetNetworkApplianceVlans200ResponseInner is not found in the empty JSON string", GetNetworkApplianceVlans200ResponseInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetNetworkApplianceVlans200ResponseInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetNetworkApplianceVlans200ResponseInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("reservedIpRanges") != null && !jsonObj.get("reservedIpRanges").isJsonNull()) {
        ...
        if (jsonArrayreservedIpRanges != null) {
          ...
          for (int i = 0; i < jsonArrayreservedIpRanges.size(); i++) {
            GetNetworkApplianceVlans200ResponseInnerReservedIpRangesInner.validateJsonElement(jsonArrayreservedIpRanges.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetNetworkApplianceVlans200ResponseInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetNetworkApplianceVlans200ResponseInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetNetworkApplianceVlans200ResponseInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetNetworkApplianceVlans200ResponseInner.class));

       return (TypeAdapter<T>) new TypeAdapter<GetNetworkApplianceVlans200ResponseInner>() {
           @Override
           public void write(JsonWriter out, GetNetworkApplianceVlans200ResponseInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetNetworkApplianceVlans200ResponseInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetNetworkApplianceVlans200ResponseInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetNetworkApplianceVlans200ResponseInner
   * @throws IOException if the JSON string is invalid with respect to GetNetworkApplianceVlans200ResponseInner
   */
  public static GetNetworkApplianceVlans200ResponseInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetNetworkApplianceVlans200ResponseInner.class);
  }

  /**
   * Convert an instance of GetNetworkApplianceVlans200ResponseInner to an JSON string
   *
   * @return JSON string
   */
