...
public class UpgradesApi {
    ...
    /**
     * Build call for getOrganizationFirmwareUpgradesByDevice_2
    ...
    private okhttp3.Call getOrganizationFirmwareUpgradesByDevice_2ValidateBeforeCall(String organizationId, Integer perPage, String startingAfter, String endingBefore, List<String> networkIds, List<String> serials, List<String> macs, List<String> firmwareUpgradeIds, List<String> firmwareUpgradeBatchIds, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'organizationId' is set
        if (organizationId == null) {
            throw new ApiException("Missing the required parameter 'organizationId' when calling getOrganizationFirmwareUpgradesByDevice_2(Async)");
        }

        return getOrganizationFirmwareUpgradesByDevice_2Call(organizationId, perPage, startingAfter, endingBefore, networkIds, serials, macs, firmwareUpgradeIds, firmwareUpgradeBatchIds, _callback);
     ...
     */
    public List<GetOrganizationFirmwareUpgradesByDevice200ResponseInner> getOrganizationFirmwareUpgradesByDevice_2(String organizationId, Integer perPage, String startingAfter, String endingBefore, List<String> networkIds, List<String> serials, List<String> macs, List<String> firmwareUpgradeIds, List<String> firmwareUpgradeBatchIds) throws ApiException {
        ApiResponse<List<GetOrganizationFirmwareUpgradesByDevice200ResponseInner>> localVarResp = getOrganizationFirmwareUpgradesByDevice_2WithHttpInfo(organizationId, perPage, startingAfter, endingBefore, networkIds, serials, macs, firmwareUpgradeIds, firmwareUpgradeBatchIds);
     ...
     */
    public ApiResponse<List<GetOrganizationFirmwareUpgradesByDevice200ResponseInner>> getOrganizationFirmwareUpgradesByDevice_2WithHttpInfo(String organizationId, Integer perPage, String startingAfter, String endingBefore, List<String> networkIds, List<String> serials, List<String> macs, List<String> firmwareUpgradeIds, List<String> firmwareUpgradeBatchIds) throws ApiException {
        okhttp3.Call localVarCall = getOrganizationFirmwareUpgradesByDevice_2ValidateBeforeCall(organizationId, perPage, startingAfter, endingBefore, networkIds, serials, macs, firmwareUpgradeIds, firmwareUpgradeBatchIds, null);
     ...
     */
    public okhttp3.Call getOrganizationFirmwareUpgradesByDevice_2Async(String organizationId, Integer perPage, String startingAfter, String endingBefore, List<String> networkIds, List<String> serials, List<String> macs, List<String> firmwareUpgradeIds, List<String> firmwareUpgradeBatchIds, final ApiCallback<List<GetOrganizationFirmwareUpgradesByDevice200ResponseInner>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getOrganizationFirmwareUpgradesByDevice_2ValidateBeforeCall(organizationId, perPage, startingAfter, endingBefore, networkIds, serials, macs, firmwareUpgradeIds, firmwareUpgradeBatchIds, _callback);
        Type localVarReturnType = new TypeToken<List<GetOrganizationFirmwareUpgradesByDevice200ResponseInner>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getOrganizationFirmwareUpgrades_2
     * @param organizationId  (required)
     ...
     */
    public okhttp3.Call getOrganizationFirmwareUpgrades_2Call(String organizationId, List<String> status, List<String> productType, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getOrganizationFirmwareUpgrades_2ValidateBeforeCall(String organizationId, List<String> status, List<String> productType, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'organizationId' is set
        if (organizationId == null) {
            throw new ApiException("Missing the required parameter 'organizationId' when calling getOrganizationFirmwareUpgrades_2(Async)");
        }

        return getOrganizationFirmwareUpgrades_2Call(organizationId, status, productType, _callback);
     ...
     */
    public List<GetOrganizationFirmwareUpgrades200ResponseInner> getOrganizationFirmwareUpgrades_2(String organizationId, List<String> status, List<String> productType) throws ApiException {
        ApiResponse<List<GetOrganizationFirmwareUpgrades200ResponseInner>> localVarResp = getOrganizationFirmwareUpgrades_2WithHttpInfo(organizationId, status, productType);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<GetOrganizationFirmwareUpgrades200ResponseInner>> getOrganizationFirmwareUpgrades_2WithHttpInfo(String organizationId, List<String> status, List<String> productType) throws ApiException {
        okhttp3.Call localVarCall = getOrganizationFirmwareUpgrades_2ValidateBeforeCall(organizationId, status, productType, null);
     ...
     */
    public okhttp3.Call getOrganizationFirmwareUpgrades_2Async(String organizationId, List<String> status, List<String> productType, final ApiCallback<List<GetOrganizationFirmwareUpgrades200ResponseInner>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getOrganizationFirmwareUpgrades_2ValidateBeforeCall(organizationId, status, productType, _callback);
        Type localVarReturnType = new TypeToken<List<GetOrganizationFirmwareUpgrades200ResponseInner>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
