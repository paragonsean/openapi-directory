...
public class UpdateDeviceManagementInterfaceRequestWan2 {
  ...
  public UpdateDeviceManagementInterfaceRequestWan2() {
  }

  public UpdateDeviceManagementInterfaceRequestWan2 staticDns(List<String> staticDns) {
    this.staticDns = staticDns;
    return this;
  }

  public UpdateDeviceManagementInterfaceRequestWan2 addStaticDnsItem(String staticDnsItem) {
  ...
  public UpdateDeviceManagementInterfaceRequestWan2 staticGatewayIp(String staticGatewayIp) {
  ...
  public UpdateDeviceManagementInterfaceRequestWan2 staticIp(String staticIp) {
  ...
  public UpdateDeviceManagementInterfaceRequestWan2 staticSubnetMask(String staticSubnetMask) {
  ...
  public UpdateDeviceManagementInterfaceRequestWan2 usingStaticIp(Boolean usingStaticIp) {
  ...
  public UpdateDeviceManagementInterfaceRequestWan2 vlan(Integer vlan) {
    this.vlan = vlan;
    return this;
  }
  ...
  public UpdateDeviceManagementInterfaceRequestWan2 wanEnabled(WanEnabledEnum wanEnabled) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateDeviceManagementInterfaceRequestWan2 updateDeviceManagementInterfaceRequestWan2 = (UpdateDeviceManagementInterfaceRequestWan2) o;
    return Objects.equals(this.staticDns, updateDeviceManagementInterfaceRequestWan2.staticDns) &&
        Objects.equals(this.staticGatewayIp, updateDeviceManagementInterfaceRequestWan2.staticGatewayIp) &&
        Objects.equals(this.staticIp, updateDeviceManagementInterfaceRequestWan2.staticIp) &&
        Objects.equals(this.staticSubnetMask, updateDeviceManagementInterfaceRequestWan2.staticSubnetMask) &&
        Objects.equals(this.usingStaticIp, updateDeviceManagementInterfaceRequestWan2.usingStaticIp) &&
        Objects.equals(this.vlan, updateDeviceManagementInterfaceRequestWan2.vlan) &&
        Objects.equals(this.wanEnabled, updateDeviceManagementInterfaceRequestWan2.wanEnabled);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateDeviceManagementInterfaceRequestWan2 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateDeviceManagementInterfaceRequestWan2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateDeviceManagementInterfaceRequestWan2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateDeviceManagementInterfaceRequestWan2 is not found in the empty JSON string", UpdateDeviceManagementInterfaceRequestWan2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateDeviceManagementInterfaceRequestWan2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateDeviceManagementInterfaceRequestWan2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateDeviceManagementInterfaceRequestWan2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateDeviceManagementInterfaceRequestWan2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateDeviceManagementInterfaceRequestWan2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateDeviceManagementInterfaceRequestWan2.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateDeviceManagementInterfaceRequestWan2>() {
           @Override
           public void write(JsonWriter out, UpdateDeviceManagementInterfaceRequestWan2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateDeviceManagementInterfaceRequestWan2 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateDeviceManagementInterfaceRequestWan2 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateDeviceManagementInterfaceRequestWan2
   * @throws IOException if the JSON string is invalid with respect to UpdateDeviceManagementInterfaceRequestWan2
   */
  public static UpdateDeviceManagementInterfaceRequestWan2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateDeviceManagementInterfaceRequestWan2.class);
  }

  /**
   * Convert an instance of UpdateDeviceManagementInterfaceRequestWan2 to an JSON string
   *
   * @return JSON string
   */
