...
public class ResponseCodesApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public ResponseCodesApi() {
        this(Configuration.getDefaultApiClient());
    }

    public ResponseCodesApi(ApiClient apiClient) {
    ...
    /**
     * Build call for getOrganizationApiRequestsOverviewResponseCodesByInterval_3
    ...
    private okhttp3.Call getOrganizationApiRequestsOverviewResponseCodesByInterval_3ValidateBeforeCall(String organizationId, String t0, String t1, Float timespan, Integer interval, Integer version, List<String> operationIds, List<String> sourceIps, List<String> adminIds, String userAgent, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'organizationId' is set
        if (organizationId == null) {
            throw new ApiException("Missing the required parameter 'organizationId' when calling getOrganizationApiRequestsOverviewResponseCodesByInterval_3(Async)");
        }

        return getOrganizationApiRequestsOverviewResponseCodesByInterval_3Call(organizationId, t0, t1, timespan, interval, version, operationIds, sourceIps, adminIds, userAgent, _callback);
     ...
     */
    public List<GetOrganizationApiRequestsOverviewResponseCodesByInterval200ResponseInner> getOrganizationApiRequestsOverviewResponseCodesByInterval_3(String organizationId, String t0, String t1, Float timespan, Integer interval, Integer version, List<String> operationIds, List<String> sourceIps, List<String> adminIds, String userAgent) throws ApiException {
        ApiResponse<List<GetOrganizationApiRequestsOverviewResponseCodesByInterval200ResponseInner>> localVarResp = getOrganizationApiRequestsOverviewResponseCodesByInterval_3WithHttpInfo(organizationId, t0, t1, timespan, interval, version, operationIds, sourceIps, adminIds, userAgent);
     ...
     */
    public ApiResponse<List<GetOrganizationApiRequestsOverviewResponseCodesByInterval200ResponseInner>> getOrganizationApiRequestsOverviewResponseCodesByInterval_3WithHttpInfo(String organizationId, String t0, String t1, Float timespan, Integer interval, Integer version, List<String> operationIds, List<String> sourceIps, List<String> adminIds, String userAgent) throws ApiException {
        okhttp3.Call localVarCall = getOrganizationApiRequestsOverviewResponseCodesByInterval_3ValidateBeforeCall(organizationId, t0, t1, timespan, interval, version, operationIds, sourceIps, adminIds, userAgent, null);
     ...
     */
    public okhttp3.Call getOrganizationApiRequestsOverviewResponseCodesByInterval_3Async(String organizationId, String t0, String t1, Float timespan, Integer interval, Integer version, List<String> operationIds, List<String> sourceIps, List<String> adminIds, String userAgent, final ApiCallback<List<GetOrganizationApiRequestsOverviewResponseCodesByInterval200ResponseInner>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getOrganizationApiRequestsOverviewResponseCodesByInterval_3ValidateBeforeCall(organizationId, t0, t1, timespan, interval, version, operationIds, sourceIps, adminIds, userAgent, _callback);
        Type localVarReturnType = new TypeToken<List<GetOrganizationApiRequestsOverviewResponseCodesByInterval200ResponseInner>>(){}.getType();
