...
public class UpdateNetworkGroupPolicyRequest {
  ...
  public UpdateNetworkGroupPolicyRequest() {
  }

  public UpdateNetworkGroupPolicyRequest bandwidth(CreateNetworkGroupPolicyRequestBandwidth bandwidth) {
  ...
  public UpdateNetworkGroupPolicyRequest bonjourForwarding(CreateNetworkGroupPolicyRequestBonjourForwarding bonjourForwarding) {
  ...
  public UpdateNetworkGroupPolicyRequest contentFiltering(CreateNetworkGroupPolicyRequestContentFiltering contentFiltering) {
  ...
  public UpdateNetworkGroupPolicyRequest firewallAndTrafficShaping(CreateNetworkGroupPolicyRequestFirewallAndTrafficShaping firewallAndTrafficShaping) {
  ...
  public UpdateNetworkGroupPolicyRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateNetworkGroupPolicyRequest scheduling(CreateNetworkGroupPolicyRequestScheduling scheduling) {
  ...
  public UpdateNetworkGroupPolicyRequest splashAuthSettings(SplashAuthSettingsEnum splashAuthSettings) {
  ...
  public UpdateNetworkGroupPolicyRequest vlanTagging(CreateNetworkGroupPolicyRequestVlanTagging vlanTagging) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateNetworkGroupPolicyRequest updateNetworkGroupPolicyRequest = (UpdateNetworkGroupPolicyRequest) o;
    return Objects.equals(this.bandwidth, updateNetworkGroupPolicyRequest.bandwidth) &&
        Objects.equals(this.bonjourForwarding, updateNetworkGroupPolicyRequest.bonjourForwarding) &&
        Objects.equals(this.contentFiltering, updateNetworkGroupPolicyRequest.contentFiltering) &&
        Objects.equals(this.firewallAndTrafficShaping, updateNetworkGroupPolicyRequest.firewallAndTrafficShaping) &&
        Objects.equals(this.name, updateNetworkGroupPolicyRequest.name) &&
        Objects.equals(this.scheduling, updateNetworkGroupPolicyRequest.scheduling) &&
        Objects.equals(this.splashAuthSettings, updateNetworkGroupPolicyRequest.splashAuthSettings) &&
        Objects.equals(this.vlanTagging, updateNetworkGroupPolicyRequest.vlanTagging);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateNetworkGroupPolicyRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateNetworkGroupPolicyRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateNetworkGroupPolicyRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateNetworkGroupPolicyRequest is not found in the empty JSON string", UpdateNetworkGroupPolicyRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateNetworkGroupPolicyRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateNetworkGroupPolicyRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateNetworkGroupPolicyRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateNetworkGroupPolicyRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateNetworkGroupPolicyRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateNetworkGroupPolicyRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateNetworkGroupPolicyRequest>() {
           @Override
           public void write(JsonWriter out, UpdateNetworkGroupPolicyRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateNetworkGroupPolicyRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateNetworkGroupPolicyRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateNetworkGroupPolicyRequest
   * @throws IOException if the JSON string is invalid with respect to UpdateNetworkGroupPolicyRequest
   */
  public static UpdateNetworkGroupPolicyRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateNetworkGroupPolicyRequest.class);
  }

  /**
   * Convert an instance of UpdateNetworkGroupPolicyRequest to an JSON string
   *
   * @return JSON string
   */
