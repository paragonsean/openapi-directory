...
public class PowerModulesApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public PowerModulesApi() {
        this(Configuration.getDefaultApiClient());
    }

    public PowerModulesApi(ApiClient apiClient) {
    ...
    /**
     * Build call for getOrganizationDevicesPowerModulesStatusesByDevice_2
    ...
    private okhttp3.Call getOrganizationDevicesPowerModulesStatusesByDevice_2ValidateBeforeCall(String organizationId, Integer perPage, String startingAfter, String endingBefore, List<String> networkIds, List<String> productTypes, List<String> serials, List<String> tags, String tagsFilterType, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'organizationId' is set
        if (organizationId == null) {
            throw new ApiException("Missing the required parameter 'organizationId' when calling getOrganizationDevicesPowerModulesStatusesByDevice_2(Async)");
        }

        return getOrganizationDevicesPowerModulesStatusesByDevice_2Call(organizationId, perPage, startingAfter, endingBefore, networkIds, productTypes, serials, tags, tagsFilterType, _callback);
     ...
     */
    public List<GetOrganizationDevicesPowerModulesStatusesByDevice200ResponseInner> getOrganizationDevicesPowerModulesStatusesByDevice_2(String organizationId, Integer perPage, String startingAfter, String endingBefore, List<String> networkIds, List<String> productTypes, List<String> serials, List<String> tags, String tagsFilterType) throws ApiException {
        ApiResponse<List<GetOrganizationDevicesPowerModulesStatusesByDevice200ResponseInner>> localVarResp = getOrganizationDevicesPowerModulesStatusesByDevice_2WithHttpInfo(organizationId, perPage, startingAfter, endingBefore, networkIds, productTypes, serials, tags, tagsFilterType);
     ...
     */
    public ApiResponse<List<GetOrganizationDevicesPowerModulesStatusesByDevice200ResponseInner>> getOrganizationDevicesPowerModulesStatusesByDevice_2WithHttpInfo(String organizationId, Integer perPage, String startingAfter, String endingBefore, List<String> networkIds, List<String> productTypes, List<String> serials, List<String> tags, String tagsFilterType) throws ApiException {
        okhttp3.Call localVarCall = getOrganizationDevicesPowerModulesStatusesByDevice_2ValidateBeforeCall(organizationId, perPage, startingAfter, endingBefore, networkIds, productTypes, serials, tags, tagsFilterType, null);
     ...
     */
    public okhttp3.Call getOrganizationDevicesPowerModulesStatusesByDevice_2Async(String organizationId, Integer perPage, String startingAfter, String endingBefore, List<String> networkIds, List<String> productTypes, List<String> serials, List<String> tags, String tagsFilterType, final ApiCallback<List<GetOrganizationDevicesPowerModulesStatusesByDevice200ResponseInner>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getOrganizationDevicesPowerModulesStatusesByDevice_2ValidateBeforeCall(organizationId, perPage, startingAfter, endingBefore, networkIds, productTypes, serials, tags, tagsFilterType, _callback);
        Type localVarReturnType = new TypeToken<List<GetOrganizationDevicesPowerModulesStatusesByDevice200ResponseInner>>(){}.getType();
