...
public class ApiClient {
    ...
    private String basePath = "https://api.meraki.com/api/v1";
    ...
    public ApiClient() {
        ...
        authentications.put("meraki_api_key", new ApiKeyAuth("header", "X-Cisco-Meraki-API-Key"));
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/1.32.0/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.meraki.com/api/v1
