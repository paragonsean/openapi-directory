...
public class UpdateNetworkSwitchAccessPolicyRequest {
  ...
  public UpdateNetworkSwitchAccessPolicyRequest() {
  }

  public UpdateNetworkSwitchAccessPolicyRequest accessPolicyType(AccessPolicyTypeEnum accessPolicyType) {
  ...
  public UpdateNetworkSwitchAccessPolicyRequest dot1x(GetNetworkSwitchAccessPolicies200ResponseInnerDot1x dot1x) {
    this.dot1x = dot1x;
    return this;
  }
  ...
  public UpdateNetworkSwitchAccessPolicyRequest guestPortBouncing(Boolean guestPortBouncing) {
  ...
  public UpdateNetworkSwitchAccessPolicyRequest guestVlanId(Integer guestVlanId) {
  ...
  public UpdateNetworkSwitchAccessPolicyRequest hostMode(HostModeEnum hostMode) {
  ...
  public UpdateNetworkSwitchAccessPolicyRequest increaseAccessSpeed(Boolean increaseAccessSpeed) {
  ...
  public UpdateNetworkSwitchAccessPolicyRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateNetworkSwitchAccessPolicyRequest radius(GetNetworkSwitchAccessPolicies200ResponseInnerRadius radius) {
    this.radius = radius;
    return this;
  }
  ...
  public UpdateNetworkSwitchAccessPolicyRequest radiusAccountingEnabled(Boolean radiusAccountingEnabled) {
  ...
  public UpdateNetworkSwitchAccessPolicyRequest radiusAccountingServers(List<CreateNetworkSwitchAccessPolicyRequestRadiusAccountingServersInner> radiusAccountingServers) {
    this.radiusAccountingServers = radiusAccountingServers;
    return this;
  }

  public UpdateNetworkSwitchAccessPolicyRequest addRadiusAccountingServersItem(CreateNetworkSwitchAccessPolicyRequestRadiusAccountingServersInner radiusAccountingServersItem) {
  ...
  public UpdateNetworkSwitchAccessPolicyRequest radiusCoaSupportEnabled(Boolean radiusCoaSupportEnabled) {
  ...
  public UpdateNetworkSwitchAccessPolicyRequest radiusGroupAttribute(String radiusGroupAttribute) {
  ...
  public UpdateNetworkSwitchAccessPolicyRequest radiusServers(List<CreateNetworkSwitchAccessPolicyRequestRadiusServersInner> radiusServers) {
    this.radiusServers = radiusServers;
    return this;
  }

  public UpdateNetworkSwitchAccessPolicyRequest addRadiusServersItem(CreateNetworkSwitchAccessPolicyRequestRadiusServersInner radiusServersItem) {
  ...
  public UpdateNetworkSwitchAccessPolicyRequest radiusTestingEnabled(Boolean radiusTestingEnabled) {
  ...
  public UpdateNetworkSwitchAccessPolicyRequest urlRedirectWalledGardenEnabled(Boolean urlRedirectWalledGardenEnabled) {
  ...
  public UpdateNetworkSwitchAccessPolicyRequest urlRedirectWalledGardenRanges(List<String> urlRedirectWalledGardenRanges) {
    this.urlRedirectWalledGardenRanges = urlRedirectWalledGardenRanges;
    return this;
  }

  public UpdateNetworkSwitchAccessPolicyRequest addUrlRedirectWalledGardenRangesItem(String urlRedirectWalledGardenRangesItem) {
  ...
  public UpdateNetworkSwitchAccessPolicyRequest voiceVlanClients(Boolean voiceVlanClients) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateNetworkSwitchAccessPolicyRequest updateNetworkSwitchAccessPolicyRequest = (UpdateNetworkSwitchAccessPolicyRequest) o;
    return Objects.equals(this.accessPolicyType, updateNetworkSwitchAccessPolicyRequest.accessPolicyType) &&
        Objects.equals(this.dot1x, updateNetworkSwitchAccessPolicyRequest.dot1x) &&
        Objects.equals(this.guestPortBouncing, updateNetworkSwitchAccessPolicyRequest.guestPortBouncing) &&
        Objects.equals(this.guestVlanId, updateNetworkSwitchAccessPolicyRequest.guestVlanId) &&
        Objects.equals(this.hostMode, updateNetworkSwitchAccessPolicyRequest.hostMode) &&
        Objects.equals(this.increaseAccessSpeed, updateNetworkSwitchAccessPolicyRequest.increaseAccessSpeed) &&
        Objects.equals(this.name, updateNetworkSwitchAccessPolicyRequest.name) &&
        Objects.equals(this.radius, updateNetworkSwitchAccessPolicyRequest.radius) &&
        Objects.equals(this.radiusAccountingEnabled, updateNetworkSwitchAccessPolicyRequest.radiusAccountingEnabled) &&
        Objects.equals(this.radiusAccountingServers, updateNetworkSwitchAccessPolicyRequest.radiusAccountingServers) &&
        Objects.equals(this.radiusCoaSupportEnabled, updateNetworkSwitchAccessPolicyRequest.radiusCoaSupportEnabled) &&
        Objects.equals(this.radiusGroupAttribute, updateNetworkSwitchAccessPolicyRequest.radiusGroupAttribute) &&
        Objects.equals(this.radiusServers, updateNetworkSwitchAccessPolicyRequest.radiusServers) &&
        Objects.equals(this.radiusTestingEnabled, updateNetworkSwitchAccessPolicyRequest.radiusTestingEnabled) &&
        Objects.equals(this.urlRedirectWalledGardenEnabled, updateNetworkSwitchAccessPolicyRequest.urlRedirectWalledGardenEnabled) &&
        Objects.equals(this.urlRedirectWalledGardenRanges, updateNetworkSwitchAccessPolicyRequest.urlRedirectWalledGardenRanges) &&
        Objects.equals(this.voiceVlanClients, updateNetworkSwitchAccessPolicyRequest.voiceVlanClients);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateNetworkSwitchAccessPolicyRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateNetworkSwitchAccessPolicyRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateNetworkSwitchAccessPolicyRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateNetworkSwitchAccessPolicyRequest is not found in the empty JSON string", UpdateNetworkSwitchAccessPolicyRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateNetworkSwitchAccessPolicyRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateNetworkSwitchAccessPolicyRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateNetworkSwitchAccessPolicyRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateNetworkSwitchAccessPolicyRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateNetworkSwitchAccessPolicyRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateNetworkSwitchAccessPolicyRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateNetworkSwitchAccessPolicyRequest>() {
           @Override
           public void write(JsonWriter out, UpdateNetworkSwitchAccessPolicyRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateNetworkSwitchAccessPolicyRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateNetworkSwitchAccessPolicyRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateNetworkSwitchAccessPolicyRequest
   * @throws IOException if the JSON string is invalid with respect to UpdateNetworkSwitchAccessPolicyRequest
   */
  public static UpdateNetworkSwitchAccessPolicyRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateNetworkSwitchAccessPolicyRequest.class);
  }

  /**
   * Convert an instance of UpdateNetworkSwitchAccessPolicyRequest to an JSON string
   *
   * @return JSON string
   */
