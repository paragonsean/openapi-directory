...
public class GetOrganizationSensorReadingsHistory200ResponseInner {
  ...
  public GetOrganizationSensorReadingsHistory200ResponseInner() {
  }

  public GetOrganizationSensorReadingsHistory200ResponseInner battery(GetOrganizationSensorReadingsHistory200ResponseInnerBattery battery) {
  ...
  public GetOrganizationSensorReadingsHistory200ResponseInner button(GetOrganizationSensorReadingsHistory200ResponseInnerButton button) {
    this.button = button;
    return this;
  }
  ...
  public GetOrganizationSensorReadingsHistory200ResponseInner door(GetOrganizationSensorReadingsHistory200ResponseInnerDoor door) {
    this.door = door;
    return this;
  }
  ...
  public GetOrganizationSensorReadingsHistory200ResponseInner humidity(GetOrganizationSensorReadingsHistory200ResponseInnerHumidity humidity) {
  ...
  public GetOrganizationSensorReadingsHistory200ResponseInner indoorAirQuality(GetOrganizationSensorReadingsHistory200ResponseInnerIndoorAirQuality indoorAirQuality) {
  ...
  public GetOrganizationSensorReadingsHistory200ResponseInner metric(MetricEnum metric) {
    this.metric = metric;
    return this;
  }
  ...
  public GetOrganizationSensorReadingsHistory200ResponseInner network(GetOrganizationSensorReadingsHistory200ResponseInnerNetwork network) {
  ...
  public GetOrganizationSensorReadingsHistory200ResponseInner noise(GetOrganizationSensorReadingsHistory200ResponseInnerNoise noise) {
    this.noise = noise;
    return this;
  }
  ...
  public GetOrganizationSensorReadingsHistory200ResponseInner pm25(GetOrganizationSensorReadingsHistory200ResponseInnerPm25 pm25) {
    this.pm25 = pm25;
    return this;
  }
  ...
  public GetOrganizationSensorReadingsHistory200ResponseInner serial(String serial) {
    this.serial = serial;
    return this;
  }
  ...
  public GetOrganizationSensorReadingsHistory200ResponseInner temperature(GetOrganizationSensorReadingsHistory200ResponseInnerTemperature temperature) {
  ...
  public GetOrganizationSensorReadingsHistory200ResponseInner ts(String ts) {
    this.ts = ts;
    return this;
  }
  ...
  public GetOrganizationSensorReadingsHistory200ResponseInner tvoc(GetOrganizationSensorReadingsHistory200ResponseInnerTvoc tvoc) {
    this.tvoc = tvoc;
    return this;
  }
  ...
  public GetOrganizationSensorReadingsHistory200ResponseInner water(GetOrganizationSensorReadingsHistory200ResponseInnerWater water) {
    this.water = water;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetOrganizationSensorReadingsHistory200ResponseInner getOrganizationSensorReadingsHistory200ResponseInner = (GetOrganizationSensorReadingsHistory200ResponseInner) o;
    return Objects.equals(this.battery, getOrganizationSensorReadingsHistory200ResponseInner.battery) &&
        Objects.equals(this.button, getOrganizationSensorReadingsHistory200ResponseInner.button) &&
        Objects.equals(this.door, getOrganizationSensorReadingsHistory200ResponseInner.door) &&
        Objects.equals(this.humidity, getOrganizationSensorReadingsHistory200ResponseInner.humidity) &&
        Objects.equals(this.indoorAirQuality, getOrganizationSensorReadingsHistory200ResponseInner.indoorAirQuality) &&
        Objects.equals(this.metric, getOrganizationSensorReadingsHistory200ResponseInner.metric) &&
        Objects.equals(this.network, getOrganizationSensorReadingsHistory200ResponseInner.network) &&
        Objects.equals(this.noise, getOrganizationSensorReadingsHistory200ResponseInner.noise) &&
        Objects.equals(this.pm25, getOrganizationSensorReadingsHistory200ResponseInner.pm25) &&
        Objects.equals(this.serial, getOrganizationSensorReadingsHistory200ResponseInner.serial) &&
        Objects.equals(this.temperature, getOrganizationSensorReadingsHistory200ResponseInner.temperature) &&
        Objects.equals(this.ts, getOrganizationSensorReadingsHistory200ResponseInner.ts) &&
        Objects.equals(this.tvoc, getOrganizationSensorReadingsHistory200ResponseInner.tvoc) &&
        Objects.equals(this.water, getOrganizationSensorReadingsHistory200ResponseInner.water);
  }

  @Override
  public int hashCode() {
    return Objects.hash(battery, button, door, humidity, indoorAirQuality, metric, network, noise, pm25, serial, temperature, ts, tvoc, water);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetOrganizationSensorReadingsHistory200ResponseInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetOrganizationSensorReadingsHistory200ResponseInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetOrganizationSensorReadingsHistory200ResponseInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetOrganizationSensorReadingsHistory200ResponseInner is not found in the empty JSON string", GetOrganizationSensorReadingsHistory200ResponseInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetOrganizationSensorReadingsHistory200ResponseInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetOrganizationSensorReadingsHistory200ResponseInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetOrganizationSensorReadingsHistory200ResponseInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetOrganizationSensorReadingsHistory200ResponseInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetOrganizationSensorReadingsHistory200ResponseInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetOrganizationSensorReadingsHistory200ResponseInner.class));

       return (TypeAdapter<T>) new TypeAdapter<GetOrganizationSensorReadingsHistory200ResponseInner>() {
           @Override
           public void write(JsonWriter out, GetOrganizationSensorReadingsHistory200ResponseInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetOrganizationSensorReadingsHistory200ResponseInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetOrganizationSensorReadingsHistory200ResponseInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetOrganizationSensorReadingsHistory200ResponseInner
   * @throws IOException if the JSON string is invalid with respect to GetOrganizationSensorReadingsHistory200ResponseInner
   */
  public static GetOrganizationSensorReadingsHistory200ResponseInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetOrganizationSensorReadingsHistory200ResponseInner.class);
  }

  /**
   * Convert an instance of GetOrganizationSensorReadingsHistory200ResponseInner to an JSON string
   *
   * @return JSON string
   */
