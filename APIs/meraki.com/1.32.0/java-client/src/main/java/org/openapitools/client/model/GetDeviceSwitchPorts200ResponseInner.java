...
public class GetDeviceSwitchPorts200ResponseInner {
  ...
  public static final String SERIALIZED_NAME_LINK_NEGOTIATION_CAPABILITIES = "linkNegotiationCapabilities";
  @SerializedName(SERIALIZED_NAME_LINK_NEGOTIATION_CAPABILITIES)
  private List<String> linkNegotiationCapabilities = new ArrayList<>();
  ...
  public GetDeviceSwitchPorts200ResponseInner() {
  }

  public GetDeviceSwitchPorts200ResponseInner accessPolicyNumber(Integer accessPolicyNumber) {
  ...
  public GetDeviceSwitchPorts200ResponseInner accessPolicyType(AccessPolicyTypeEnum accessPolicyType) {
  ...
  public GetDeviceSwitchPorts200ResponseInner adaptivePolicyGroupId(String adaptivePolicyGroupId) {
  ...
  public GetDeviceSwitchPorts200ResponseInner allowedVlans(String allowedVlans) {
  ...
  public GetDeviceSwitchPorts200ResponseInner daiTrusted(Boolean daiTrusted) {
  ...
  public GetDeviceSwitchPorts200ResponseInner enabled(Boolean enabled) {
  ...
  public GetDeviceSwitchPorts200ResponseInner flexibleStackingEnabled(Boolean flexibleStackingEnabled) {
  ...
  public GetDeviceSwitchPorts200ResponseInner isolationEnabled(Boolean isolationEnabled) {
  ...
  public GetDeviceSwitchPorts200ResponseInner linkNegotiation(String linkNegotiation) {
  ...
  public GetDeviceSwitchPorts200ResponseInner linkNegotiationCapabilities(List<String> linkNegotiationCapabilities) {
    this.linkNegotiationCapabilities = linkNegotiationCapabilities;
    return this;
  }

  public GetDeviceSwitchPorts200ResponseInner addLinkNegotiationCapabilitiesItem(String linkNegotiationCapabilitiesItem) {
    if (this.linkNegotiationCapabilities == null) {
      this.linkNegotiationCapabilities = new ArrayList<>();
    }
    this.linkNegotiationCapabilities.add(linkNegotiationCapabilitiesItem);
    return this;
  }

  /**
   * Available link speeds for the switch port.
   * @return linkNegotiationCapabilities
   */
  @javax.annotation.Nullable
  public List<String> getLinkNegotiationCapabilities() {
    return linkNegotiationCapabilities;
  }

  public void setLinkNegotiationCapabilities(List<String> linkNegotiationCapabilities) {
    this.linkNegotiationCapabilities = linkNegotiationCapabilities;
  }


  public GetDeviceSwitchPorts200ResponseInner macAllowList(List<String> macAllowList) {
    this.macAllowList = macAllowList;
    return this;
  }

  public GetDeviceSwitchPorts200ResponseInner addMacAllowListItem(String macAllowListItem) {
  ...
  public GetDeviceSwitchPorts200ResponseInner name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GetDeviceSwitchPorts200ResponseInner peerSgtCapable(Boolean peerSgtCapable) {
  ...
  public GetDeviceSwitchPorts200ResponseInner poeEnabled(Boolean poeEnabled) {
  ...
  public GetDeviceSwitchPorts200ResponseInner portId(String portId) {
    this.portId = portId;
    return this;
  }
  ...
  public GetDeviceSwitchPorts200ResponseInner portScheduleId(String portScheduleId) {
  ...
  public GetDeviceSwitchPorts200ResponseInner profile(GetDeviceSwitchPorts200ResponseInnerProfile profile) {
  ...
  public GetDeviceSwitchPorts200ResponseInner rstpEnabled(Boolean rstpEnabled) {
  ...
  public GetDeviceSwitchPorts200ResponseInner stickyMacAllowList(List<String> stickyMacAllowList) {
    this.stickyMacAllowList = stickyMacAllowList;
    return this;
  }

  public GetDeviceSwitchPorts200ResponseInner addStickyMacAllowListItem(String stickyMacAllowListItem) {
  ...
  public GetDeviceSwitchPorts200ResponseInner stickyMacAllowListLimit(Integer stickyMacAllowListLimit) {
  ...
  public GetDeviceSwitchPorts200ResponseInner stormControlEnabled(Boolean stormControlEnabled) {
  ...
  public GetDeviceSwitchPorts200ResponseInner stpGuard(StpGuardEnum stpGuard) {
  ...
  public GetDeviceSwitchPorts200ResponseInner tags(List<String> tags) {
    this.tags = tags;
    return this;
  }

  public GetDeviceSwitchPorts200ResponseInner addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public GetDeviceSwitchPorts200ResponseInner type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public GetDeviceSwitchPorts200ResponseInner udld(UdldEnum udld) {
    this.udld = udld;
    return this;
  }
  ...
  public GetDeviceSwitchPorts200ResponseInner vlan(Integer vlan) {
    this.vlan = vlan;
    return this;
  }
  ...
  public GetDeviceSwitchPorts200ResponseInner voiceVlan(Integer voiceVlan) {
  ...
  public boolean equals(Object o) {
    ...
    GetDeviceSwitchPorts200ResponseInner getDeviceSwitchPorts200ResponseInner = (GetDeviceSwitchPorts200ResponseInner) o;
    return Objects.equals(this.accessPolicyNumber, getDeviceSwitchPorts200ResponseInner.accessPolicyNumber) &&
        Objects.equals(this.accessPolicyType, getDeviceSwitchPorts200ResponseInner.accessPolicyType) &&
        Objects.equals(this.adaptivePolicyGroupId, getDeviceSwitchPorts200ResponseInner.adaptivePolicyGroupId) &&
        Objects.equals(this.allowedVlans, getDeviceSwitchPorts200ResponseInner.allowedVlans) &&
        Objects.equals(this.daiTrusted, getDeviceSwitchPorts200ResponseInner.daiTrusted) &&
        Objects.equals(this.enabled, getDeviceSwitchPorts200ResponseInner.enabled) &&
        Objects.equals(this.flexibleStackingEnabled, getDeviceSwitchPorts200ResponseInner.flexibleStackingEnabled) &&
        Objects.equals(this.isolationEnabled, getDeviceSwitchPorts200ResponseInner.isolationEnabled) &&
        Objects.equals(this.linkNegotiation, getDeviceSwitchPorts200ResponseInner.linkNegotiation) &&
        Objects.equals(this.linkNegotiationCapabilities, getDeviceSwitchPorts200ResponseInner.linkNegotiationCapabilities) &&
        Objects.equals(this.macAllowList, getDeviceSwitchPorts200ResponseInner.macAllowList) &&
        Objects.equals(this.name, getDeviceSwitchPorts200ResponseInner.name) &&
        Objects.equals(this.peerSgtCapable, getDeviceSwitchPorts200ResponseInner.peerSgtCapable) &&
        Objects.equals(this.poeEnabled, getDeviceSwitchPorts200ResponseInner.poeEnabled) &&
        Objects.equals(this.portId, getDeviceSwitchPorts200ResponseInner.portId) &&
        Objects.equals(this.portScheduleId, getDeviceSwitchPorts200ResponseInner.portScheduleId) &&
        Objects.equals(this.profile, getDeviceSwitchPorts200ResponseInner.profile) &&
        Objects.equals(this.rstpEnabled, getDeviceSwitchPorts200ResponseInner.rstpEnabled) &&
        Objects.equals(this.stickyMacAllowList, getDeviceSwitchPorts200ResponseInner.stickyMacAllowList) &&
        Objects.equals(this.stickyMacAllowListLimit, getDeviceSwitchPorts200ResponseInner.stickyMacAllowListLimit) &&
        Objects.equals(this.stormControlEnabled, getDeviceSwitchPorts200ResponseInner.stormControlEnabled) &&
        Objects.equals(this.stpGuard, getDeviceSwitchPorts200ResponseInner.stpGuard) &&
        Objects.equals(this.tags, getDeviceSwitchPorts200ResponseInner.tags) &&
        Objects.equals(this.type, getDeviceSwitchPorts200ResponseInner.type) &&
        Objects.equals(this.udld, getDeviceSwitchPorts200ResponseInner.udld) &&
        Objects.equals(this.vlan, getDeviceSwitchPorts200ResponseInner.vlan) &&
        Objects.equals(this.voiceVlan, getDeviceSwitchPorts200ResponseInner.voiceVlan);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accessPolicyNumber, accessPolicyType, adaptivePolicyGroupId, allowedVlans, daiTrusted, enabled, flexibleStackingEnabled, isolationEnabled, linkNegotiation, linkNegotiationCapabilities, macAllowList, name, peerSgtCapable, poeEnabled, portId, portScheduleId, profile, rstpEnabled, stickyMacAllowList, stickyMacAllowListLimit, stormControlEnabled, stpGuard, tags, type, udld, vlan, voiceVlan);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetDeviceSwitchPorts200ResponseInner {\n");
    ...
    sb.append("    linkNegotiationCapabilities: ").append(toIndentedString(linkNegotiationCapabilities)).append("\n");
  ...
  static {
    ...
    openapiFields.add("linkNegotiationCapabilities");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetDeviceSwitchPorts200ResponseInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetDeviceSwitchPorts200ResponseInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetDeviceSwitchPorts200ResponseInner is not found in the empty JSON string", GetDeviceSwitchPorts200ResponseInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetDeviceSwitchPorts200ResponseInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetDeviceSwitchPorts200ResponseInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("linkNegotiationCapabilities") != null && !jsonObj.get("linkNegotiationCapabilities").isJsonNull() && !jsonObj.get("linkNegotiationCapabilities").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `linkNegotiationCapabilities` to be an array in the JSON string but got `%s`", jsonObj.get("linkNegotiationCapabilities").toString()));
      }
      // ensure the optional json data is an array if present
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetDeviceSwitchPorts200ResponseInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetDeviceSwitchPorts200ResponseInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetDeviceSwitchPorts200ResponseInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetDeviceSwitchPorts200ResponseInner.class));

       return (TypeAdapter<T>) new TypeAdapter<GetDeviceSwitchPorts200ResponseInner>() {
           @Override
           public void write(JsonWriter out, GetDeviceSwitchPorts200ResponseInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetDeviceSwitchPorts200ResponseInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetDeviceSwitchPorts200ResponseInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetDeviceSwitchPorts200ResponseInner
   * @throws IOException if the JSON string is invalid with respect to GetDeviceSwitchPorts200ResponseInner
   */
  public static GetDeviceSwitchPorts200ResponseInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetDeviceSwitchPorts200ResponseInner.class);
  }

  /**
   * Convert an instance of GetDeviceSwitchPorts200ResponseInner to an JSON string
   *
   * @return JSON string
   */
