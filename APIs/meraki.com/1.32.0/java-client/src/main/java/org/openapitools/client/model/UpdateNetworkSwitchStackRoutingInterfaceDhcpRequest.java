...
public class UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest {
  ...
  public UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest() {
  }

  public UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest bootFileName(String bootFileName) {
  ...
  public UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest bootNextServer(String bootNextServer) {
  ...
  public UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest bootOptionsEnabled(Boolean bootOptionsEnabled) {
  ...
  public UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest dhcpLeaseTime(DhcpLeaseTimeEnum dhcpLeaseTime) {
  ...
  public UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest dhcpMode(DhcpModeEnum dhcpMode) {
  ...
  public UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest dhcpOptions(List<UpdateDeviceSwitchRoutingInterfaceDhcpRequestDhcpOptionsInner> dhcpOptions) {
    this.dhcpOptions = dhcpOptions;
    return this;
  }

  public UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest addDhcpOptionsItem(UpdateDeviceSwitchRoutingInterfaceDhcpRequestDhcpOptionsInner dhcpOptionsItem) {
  ...
  public UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest dhcpRelayServerIps(List<String> dhcpRelayServerIps) {
    this.dhcpRelayServerIps = dhcpRelayServerIps;
    return this;
  }

  public UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest addDhcpRelayServerIpsItem(String dhcpRelayServerIpsItem) {
  ...
  public UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest dnsCustomNameservers(List<String> dnsCustomNameservers) {
    this.dnsCustomNameservers = dnsCustomNameservers;
    return this;
  }

  public UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest addDnsCustomNameserversItem(String dnsCustomNameserversItem) {
  ...
  public UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest dnsNameserversOption(DnsNameserversOptionEnum dnsNameserversOption) {
  ...
  public UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest fixedIpAssignments(List<UpdateDeviceSwitchRoutingInterfaceDhcpRequestFixedIpAssignmentsInner> fixedIpAssignments) {
    this.fixedIpAssignments = fixedIpAssignments;
    return this;
  }

  public UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest addFixedIpAssignmentsItem(UpdateDeviceSwitchRoutingInterfaceDhcpRequestFixedIpAssignmentsInner fixedIpAssignmentsItem) {
  ...
  public UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest reservedIpRanges(List<UpdateDeviceSwitchRoutingInterfaceDhcpRequestReservedIpRangesInner> reservedIpRanges) {
    this.reservedIpRanges = reservedIpRanges;
    return this;
  }

  public UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest addReservedIpRangesItem(UpdateDeviceSwitchRoutingInterfaceDhcpRequestReservedIpRangesInner reservedIpRangesItem) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest updateNetworkSwitchStackRoutingInterfaceDhcpRequest = (UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest) o;
    return Objects.equals(this.bootFileName, updateNetworkSwitchStackRoutingInterfaceDhcpRequest.bootFileName) &&
        Objects.equals(this.bootNextServer, updateNetworkSwitchStackRoutingInterfaceDhcpRequest.bootNextServer) &&
        Objects.equals(this.bootOptionsEnabled, updateNetworkSwitchStackRoutingInterfaceDhcpRequest.bootOptionsEnabled) &&
        Objects.equals(this.dhcpLeaseTime, updateNetworkSwitchStackRoutingInterfaceDhcpRequest.dhcpLeaseTime) &&
        Objects.equals(this.dhcpMode, updateNetworkSwitchStackRoutingInterfaceDhcpRequest.dhcpMode) &&
        Objects.equals(this.dhcpOptions, updateNetworkSwitchStackRoutingInterfaceDhcpRequest.dhcpOptions) &&
        Objects.equals(this.dhcpRelayServerIps, updateNetworkSwitchStackRoutingInterfaceDhcpRequest.dhcpRelayServerIps) &&
        Objects.equals(this.dnsCustomNameservers, updateNetworkSwitchStackRoutingInterfaceDhcpRequest.dnsCustomNameservers) &&
        Objects.equals(this.dnsNameserversOption, updateNetworkSwitchStackRoutingInterfaceDhcpRequest.dnsNameserversOption) &&
        Objects.equals(this.fixedIpAssignments, updateNetworkSwitchStackRoutingInterfaceDhcpRequest.fixedIpAssignments) &&
        Objects.equals(this.reservedIpRanges, updateNetworkSwitchStackRoutingInterfaceDhcpRequest.reservedIpRanges);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest is not found in the empty JSON string", UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest>() {
           @Override
           public void write(JsonWriter out, UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest
   * @throws IOException if the JSON string is invalid with respect to UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest
   */
  public static UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest.class);
  }

  /**
   * Convert an instance of UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest to an JSON string
   *
   * @return JSON string
   */
