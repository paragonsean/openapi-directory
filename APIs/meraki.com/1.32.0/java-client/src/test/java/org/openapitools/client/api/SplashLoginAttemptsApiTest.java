...
public class SplashLoginAttemptsApiTest {
     ...
     */
    @Test
    public void getNetworkSplashLoginAttempts_1Test() throws ApiException {
        String networkId = null;
        Integer ssidNumber = null;
        String loginIdentifier = null;
        Integer timespan = null;
        List<Object> response = api.getNetworkSplashLoginAttempts_1(networkId, ssidNumber, loginIdentifier, timespan);
