...
/**
 * API tests for SmOwnersForKeyApi
 */
@Disabled
public class SmOwnersForKeyApiTest {

    private final SmOwnersForKeyApi api = new SmOwnersForKeyApi();
     ...
     */
    @Test
    public void getNetworkPiiSmOwnersForKey_2Test() throws ApiException {
        ...
        Object response = api.getNetworkPiiSmOwnersForKey_2(networkId, username, email, mac, serial, imei, bluetoothMac);
