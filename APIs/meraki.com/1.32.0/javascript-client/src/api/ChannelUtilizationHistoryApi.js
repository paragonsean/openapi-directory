...
/**
* ChannelUtilizationHistory service.
* @module api/ChannelUtilizationHistoryApi
* @version 1.32.0
*/
export default class ChannelUtilizationHistoryApi {

    /**
    * Constructs a new ChannelUtilizationHistoryApi. 
    * @alias module:api/ChannelUtilizationHistoryApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getNetworkWirelessChannelUtilizationHistory_1 operation.
     * @callback module:api/ChannelUtilizationHistoryApi~getNetworkWirelessChannelUtilizationHistory_1Callback
     ...
     * @param {module:api/ChannelUtilizationHistoryApi~getNetworkWirelessChannelUtilizationHistory_1Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/GetNetworkWirelessChannelUtilizationHistory200ResponseInner>}
     */
    getNetworkWirelessChannelUtilizationHistory_1(networkId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'networkId' is set
      if (networkId === undefined || networkId === null) {
        throw new Error("Missing the required parameter 'networkId' when calling getNetworkWirelessChannelUtilizationHistory_1");
      }
