...
* @version 1.32.0
*/
export default class V4Api {

    /**
    * Constructs a new V4Api. 
    * @alias module:api/V4Api
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getNetworkSwitchDhcpV4ServersSeen_2 operation.
     * @callback module:api/V4Api~getNetworkSwitchDhcpV4ServersSeen_2Callback
     ...
     * @param {module:api/V4Api~getNetworkSwitchDhcpV4ServersSeen_2Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/GetNetworkSwitchDhcpV4ServersSeen200ResponseInner>}
     */
    getNetworkSwitchDhcpV4ServersSeen_2(networkId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'networkId' is set
      if (networkId === undefined || networkId === null) {
        throw new Error("Missing the required parameter 'networkId' when calling getNetworkSwitchDhcpV4ServersSeen_2");
      }
