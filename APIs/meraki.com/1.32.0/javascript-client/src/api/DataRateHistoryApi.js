...
/**
* DataRateHistory service.
* @module api/DataRateHistoryApi
* @version 1.32.0
*/
export default class DataRateHistoryApi {

    /**
    * Constructs a new DataRateHistoryApi. 
    * @alias module:api/DataRateHistoryApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getNetworkWirelessDataRateHistory_1 operation.
     * @callback module:api/DataRateHistoryApi~getNetworkWirelessDataRateHistory_1Callback
     ...
     * @param {module:api/DataRateHistoryApi~getNetworkWirelessDataRateHistory_1Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/GetNetworkWirelessDataRateHistory200ResponseInner>}
     */
    getNetworkWirelessDataRateHistory_1(networkId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'networkId' is set
      if (networkId === undefined || networkId === null) {
        throw new Error("Missing the required parameter 'networkId' when calling getNetworkWirelessDataRateHistory_1");
      }
