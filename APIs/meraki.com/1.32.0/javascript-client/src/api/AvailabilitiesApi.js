...
* @version 1.32.0
*/
export default class AvailabilitiesApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getOrganizationDevicesAvailabilities_2 operation.
     * @callback module:api/AvailabilitiesApi~getOrganizationDevicesAvailabilities_2Callback
     ...
     * @param {module:api/AvailabilitiesApi~getOrganizationDevicesAvailabilities_2Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/GetOrganizationDevicesAvailabilities200ResponseInner>}
     */
    getOrganizationDevicesAvailabilities_2(organizationId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'organizationId' is set
      if (organizationId === undefined || organizationId === null) {
        throw new Error("Missing the required parameter 'organizationId' when calling getOrganizationDevicesAvailabilities_2");
      }
