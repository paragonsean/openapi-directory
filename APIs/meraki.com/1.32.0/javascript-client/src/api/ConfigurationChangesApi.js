...
export default class ConfigurationChangesApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getOrganizationConfigurationChanges_1 operation.
     * @callback module:api/ConfigurationChangesApi~getOrganizationConfigurationChanges_1Callback
     ...
     * @param {module:api/ConfigurationChangesApi~getOrganizationConfigurationChanges_1Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<Object>}
     */
    getOrganizationConfigurationChanges_1(organizationId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'organizationId' is set
      if (organizationId === undefined || organizationId === null) {
        throw new Error("Missing the required parameter 'organizationId' when calling getOrganizationConfigurationChanges_1");
      }
