...
export default class SmOwnersForKeyApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getNetworkPiiSmOwnersForKey_2 operation.
     * @callback module:api/SmOwnersForKeyApi~getNetworkPiiSmOwnersForKey_2Callback
     ...
     * @param {module:api/SmOwnersForKeyApi~getNetworkPiiSmOwnersForKey_2Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Object}
     */
    getNetworkPiiSmOwnersForKey_2(networkId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'networkId' is set
      if (networkId === undefined || networkId === null) {
        throw new Error("Missing the required parameter 'networkId' when calling getNetworkPiiSmOwnersForKey_2");
      }
