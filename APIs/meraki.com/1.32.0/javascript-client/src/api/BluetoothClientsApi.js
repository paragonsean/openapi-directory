...
export default class BluetoothClientsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getNetworkBluetoothClient_1 operation.
     * @callback module:api/BluetoothClientsApi~getNetworkBluetoothClient_1Callback
     ...
     * @param {module:api/BluetoothClientsApi~getNetworkBluetoothClient_1Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Object}
     */
    getNetworkBluetoothClient_1(networkId, bluetoothClientId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'networkId' is set
      if (networkId === undefined || networkId === null) {
        throw new Error("Missing the required parameter 'networkId' when calling getNetworkBluetoothClient_1");
      }
      // verify the required parameter 'bluetoothClientId' is set
      if (bluetoothClientId === undefined || bluetoothClientId === null) {
        throw new Error("Missing the required parameter 'bluetoothClientId' when calling getNetworkBluetoothClient_1");
      }
    ...
    /**
     * Callback function to receive the result of the getNetworkBluetoothClients_1 operation.
     * @callback module:api/BluetoothClientsApi~getNetworkBluetoothClients_1Callback
     * @param {String} error Error message, if any.
     ...
     * @param {Boolean} [includeConnectivityHistory] Include the connectivity history for this client
     * @param {module:api/BluetoothClientsApi~getNetworkBluetoothClients_1Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<Object>}
     */
    getNetworkBluetoothClients_1(networkId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'networkId' is set
      if (networkId === undefined || networkId === null) {
        throw new Error("Missing the required parameter 'networkId' when calling getNetworkBluetoothClients_1");
      }
