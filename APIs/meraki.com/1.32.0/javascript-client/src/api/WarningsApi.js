...
export default class WarningsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getNetworkSwitchDhcpServerPolicyArpInspectionWarningsByDevice_3 operation.
     * @callback module:api/WarningsApi~getNetworkSwitchDhcpServerPolicyArpInspectionWarningsByDevice_3Callback
     ...
     * @param {module:api/WarningsApi~getNetworkSwitchDhcpServerPolicyArpInspectionWarningsByDevice_3Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/GetNetworkSwitchDhcpServerPolicyArpInspectionWarningsByDevice200ResponseInner>}
     */
    getNetworkSwitchDhcpServerPolicyArpInspectionWarningsByDevice_3(networkId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'networkId' is set
      if (networkId === undefined || networkId === null) {
        throw new Error("Missing the required parameter 'networkId' when calling getNetworkSwitchDhcpServerPolicyArpInspectionWarningsByDevice_3");
      }
