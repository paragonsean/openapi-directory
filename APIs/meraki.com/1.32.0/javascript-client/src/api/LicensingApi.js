...
export default class LicensingApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getOrganizationLicensingCotermLicenses operation.
     * @callback module:api/LicensingApi~getOrganizationLicensingCotermLicensesCallback
     ...
     * @param {module:api/LicensingApi~getOrganizationLicensingCotermLicensesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/GetOrganizationLicensingCotermLicenses200ResponseInner>}
     */
    getOrganizationLicensingCotermLicenses(organizationId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'organizationId' is set
      if (organizationId === undefined || organizationId === null) {
        throw new Error("Missing the required parameter 'organizationId' when calling getOrganizationLicensingCotermLicenses");
      }
    ...
    /**
     * Callback function to receive the result of the moveOrganizationLicensingCotermLicenses operation.
     * @callback module:api/LicensingApi~moveOrganizationLicensingCotermLicensesCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/LicensingApi~moveOrganizationLicensingCotermLicensesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/MoveOrganizationLicensingCotermLicenses200Response}
     */
    moveOrganizationLicensingCotermLicenses(organizationId, moveOrganizationLicensingCotermLicensesRequest, callback) {
      let postBody = moveOrganizationLicensingCotermLicensesRequest;
      // verify the required parameter 'organizationId' is set
      if (organizationId === undefined || organizationId === null) {
        throw new Error("Missing the required parameter 'organizationId' when calling moveOrganizationLicensingCotermLicenses");
      }
      ...
      if (moveOrganizationLicensingCotermLicensesRequest === undefined || moveOrganizationLicensingCotermLicensesRequest === null) {
        throw new Error("Missing the required parameter 'moveOrganizationLicensingCotermLicensesRequest' when calling moveOrganizationLicensingCotermLicenses");
      }
