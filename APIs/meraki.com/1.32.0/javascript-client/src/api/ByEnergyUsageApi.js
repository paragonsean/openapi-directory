...
/**
* ByEnergyUsage service.
* @module api/ByEnergyUsageApi
* @version 1.32.0
*/
export default class ByEnergyUsageApi {

    /**
    * Constructs a new ByEnergyUsageApi. 
    * @alias module:api/ByEnergyUsageApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getOrganizationSummaryTopSwitchesByEnergyUsage_4 operation.
     * @callback module:api/ByEnergyUsageApi~getOrganizationSummaryTopSwitchesByEnergyUsage_4Callback
     ...
     * @param {module:api/ByEnergyUsageApi~getOrganizationSummaryTopSwitchesByEnergyUsage_4Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/GetOrganizationSummaryTopSwitchesByEnergyUsage200ResponseInner>}
     */
    getOrganizationSummaryTopSwitchesByEnergyUsage_4(organizationId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'organizationId' is set
      if (organizationId === undefined || organizationId === null) {
        throw new Error("Missing the required parameter 'organizationId' when calling getOrganizationSummaryTopSwitchesByEnergyUsage_4");
      }
