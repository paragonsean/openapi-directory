...
export default class SignalQualityHistoryApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getNetworkWirelessSignalQualityHistory_1 operation.
     * @callback module:api/SignalQualityHistoryApi~getNetworkWirelessSignalQualityHistory_1Callback
     ...
     * @param {module:api/SignalQualityHistoryApi~getNetworkWirelessSignalQualityHistory_1Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/GetNetworkWirelessSignalQualityHistory200ResponseInner>}
     */
    getNetworkWirelessSignalQualityHistory_1(networkId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'networkId' is set
      if (networkId === undefined || networkId === null) {
        throw new Error("Missing the required parameter 'networkId' when calling getNetworkWirelessSignalQualityHistory_1");
      }
