...
export default class ServersApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getNetworkSwitchDhcpV4ServersSeen_3 operation.
     * @callback module:api/ServersApi~getNetworkSwitchDhcpV4ServersSeen_3Callback
     ...
     * @param {module:api/ServersApi~getNetworkSwitchDhcpV4ServersSeen_3Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/GetNetworkSwitchDhcpV4ServersSeen200ResponseInner>}
     */
    getNetworkSwitchDhcpV4ServersSeen_3(networkId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'networkId' is set
      if (networkId === undefined || networkId === null) {
        throw new Error("Missing the required parameter 'networkId' when calling getNetworkSwitchDhcpV4ServersSeen_3");
      }
