...
export default class ChannelUtilizationApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getNetworkNetworkHealthChannelUtilization_2 operation.
     * @callback module:api/ChannelUtilizationApi~getNetworkNetworkHealthChannelUtilization_2Callback
     ...
     * @param {module:api/ChannelUtilizationApi~getNetworkNetworkHealthChannelUtilization_2Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<Object>}
     */
    getNetworkNetworkHealthChannelUtilization_2(networkId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'networkId' is set
      if (networkId === undefined || networkId === null) {
        throw new Error("Missing the required parameter 'networkId' when calling getNetworkNetworkHealthChannelUtilization_2");
      }
