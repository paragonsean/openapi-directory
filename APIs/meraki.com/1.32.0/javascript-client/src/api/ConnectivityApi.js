...
export default class ConnectivityApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getNetworkSmDeviceConnectivity_2 operation.
     * @callback module:api/ConnectivityApi~getNetworkSmDeviceConnectivity_2Callback
     ...
     * @param {module:api/ConnectivityApi~getNetworkSmDeviceConnectivity_2Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/GetNetworkSmDeviceConnectivity200ResponseInner>}
     */
    getNetworkSmDeviceConnectivity_2(networkId, deviceId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'networkId' is set
      if (networkId === undefined || networkId === null) {
        throw new Error("Missing the required parameter 'networkId' when calling getNetworkSmDeviceConnectivity_2");
      }
      // verify the required parameter 'deviceId' is set
      if (deviceId === undefined || deviceId === null) {
        throw new Error("Missing the required parameter 'deviceId' when calling getNetworkSmDeviceConnectivity_2");
      }
