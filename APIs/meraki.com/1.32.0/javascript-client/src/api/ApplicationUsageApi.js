...
/**
* ApplicationUsage service.
* @module api/ApplicationUsageApi
* @version 1.32.0
*/
export default class ApplicationUsageApi {

    /**
    * Constructs a new ApplicationUsageApi. 
    * @alias module:api/ApplicationUsageApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getNetworkClientsApplicationUsage_2 operation.
     * @callback module:api/ApplicationUsageApi~getNetworkClientsApplicationUsage_2Callback
     ...
     * @param {module:api/ApplicationUsageApi~getNetworkClientsApplicationUsage_2Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<Object>}
     */
    getNetworkClientsApplicationUsage_2(networkId, clients, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'networkId' is set
      if (networkId === undefined || networkId === null) {
        throw new Error("Missing the required parameter 'networkId' when calling getNetworkClientsApplicationUsage_2");
      }
      // verify the required parameter 'clients' is set
      if (clients === undefined || clients === null) {
        throw new Error("Missing the required parameter 'clients' when calling getNetworkClientsApplicationUsage_2");
      }
