...
* @version 1.32.0
*/
export default class IdentitiesApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getAdministeredIdentitiesMe_1 operation.
     * @callback module:api/IdentitiesApi~getAdministeredIdentitiesMe_1Callback
     ...
     * Returns the identity of the current user.
     * @param {module:api/IdentitiesApi~getAdministeredIdentitiesMe_1Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetAdministeredIdentitiesMe200Response}
     */
    getAdministeredIdentitiesMe_1(callback) {
      let postBody = null;
