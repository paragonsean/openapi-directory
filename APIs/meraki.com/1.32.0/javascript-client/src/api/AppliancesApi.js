...
export default class AppliancesApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getOrganizationSummaryTopAppliancesByUtilization_3 operation.
     * @callback module:api/AppliancesApi~getOrganizationSummaryTopAppliancesByUtilization_3Callback
     ...
     * @param {module:api/AppliancesApi~getOrganizationSummaryTopAppliancesByUtilization_3Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/GetOrganizationSummaryTopAppliancesByUtilization200ResponseInner>}
     */
    getOrganizationSummaryTopAppliancesByUtilization_3(organizationId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'organizationId' is set
      if (organizationId === undefined || organizationId === null) {
        throw new Error("Missing the required parameter 'organizationId' when calling getOrganizationSummaryTopAppliancesByUtilization_3");
      }
