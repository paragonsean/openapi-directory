...
export default class DesktopLogsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getNetworkSmDeviceDesktopLogs_2 operation.
     * @callback module:api/DesktopLogsApi~getNetworkSmDeviceDesktopLogs_2Callback
     ...
     * @param {module:api/DesktopLogsApi~getNetworkSmDeviceDesktopLogs_2Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/GetNetworkSmDeviceDesktopLogs200ResponseInner>}
     */
    getNetworkSmDeviceDesktopLogs_2(networkId, deviceId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'networkId' is set
      if (networkId === undefined || networkId === null) {
        throw new Error("Missing the required parameter 'networkId' when calling getNetworkSmDeviceDesktopLogs_2");
      }
      // verify the required parameter 'deviceId' is set
      if (deviceId === undefined || deviceId === null) {
        throw new Error("Missing the required parameter 'deviceId' when calling getNetworkSmDeviceDesktopLogs_2");
      }
