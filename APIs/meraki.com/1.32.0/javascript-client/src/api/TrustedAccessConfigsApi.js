...
/**
* TrustedAccessConfigs service.
* @module api/TrustedAccessConfigsApi
* @version 1.32.0
*/
export default class TrustedAccessConfigsApi {

    /**
    * Constructs a new TrustedAccessConfigsApi. 
    * @alias module:api/TrustedAccessConfigsApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getNetworkSmTrustedAccessConfigs_1 operation.
     * @callback module:api/TrustedAccessConfigsApi~getNetworkSmTrustedAccessConfigs_1Callback
     ...
     * @param {module:api/TrustedAccessConfigsApi~getNetworkSmTrustedAccessConfigs_1Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/GetNetworkSmTrustedAccessConfigs200ResponseInner>}
     */
    getNetworkSmTrustedAccessConfigs_1(networkId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'networkId' is set
      if (networkId === undefined || networkId === null) {
        throw new Error("Missing the required parameter 'networkId' when calling getNetworkSmTrustedAccessConfigs_1");
      }
