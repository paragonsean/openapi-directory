...
/**
* ResponseCodes service.
* @module api/ResponseCodesApi
* @version 1.32.0
*/
export default class ResponseCodesApi {

    /**
    * Constructs a new ResponseCodesApi. 
    * @alias module:api/ResponseCodesApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getOrganizationApiRequestsOverviewResponseCodesByInterval_3 operation.
     * @callback module:api/ResponseCodesApi~getOrganizationApiRequestsOverviewResponseCodesByInterval_3Callback
     ...
     * @param {module:api/ResponseCodesApi~getOrganizationApiRequestsOverviewResponseCodesByInterval_3Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/GetOrganizationApiRequestsOverviewResponseCodesByInterval200ResponseInner>}
     */
    getOrganizationApiRequestsOverviewResponseCodesByInterval_3(organizationId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'organizationId' is set
      if (organizationId === undefined || organizationId === null) {
        throw new Error("Missing the required parameter 'organizationId' when calling getOrganizationApiRequestsOverviewResponseCodesByInterval_3");
      }
