...
/**
 * The GetOrganizationUplinksStatuses200ResponseInnerUplinksInner model module.
 * @module model/GetOrganizationUplinksStatuses200ResponseInnerUplinksInner
 * @version 1.32.0
 */
class GetOrganizationUplinksStatuses200ResponseInnerUplinksInner {
    /**
     * Constructs a new <code>GetOrganizationUplinksStatuses200ResponseInnerUplinksInner</code>.
     * @alias module:model/GetOrganizationUplinksStatuses200ResponseInnerUplinksInner
     */
    constructor() { 
        
        GetOrganizationUplinksStatuses200ResponseInnerUplinksInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetOrganizationUplinksStatuses200ResponseInnerUplinksInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetOrganizationUplinksStatuses200ResponseInnerUplinksInner} obj Optional instance to populate.
     * @return {module:model/GetOrganizationUplinksStatuses200ResponseInnerUplinksInner} The populated <code>GetOrganizationUplinksStatuses200ResponseInnerUplinksInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetOrganizationUplinksStatuses200ResponseInnerUplinksInner();
            ...
            if (data.hasOwnProperty('ipAssignedBy')) {
                obj['ipAssignedBy'] = ApiClient.convertToType(data['ipAssignedBy'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GetOrganizationUplinksStatuses200ResponseInnerUplinksInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetOrganizationUplinksStatuses200ResponseInnerUplinksInner</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['ipAssignedBy'] && !(typeof data['ipAssignedBy'] === 'string' || data['ipAssignedBy'] instanceof String)) {
            throw new Error("Expected the field `ipAssignedBy` to be a primitive type in the JSON string but got " + data['ipAssignedBy']);
        }
        // ensure the json data is a string
 ...
 * @member {String} apn
 */
GetOrganizationUplinksStatuses200ResponseInnerUplinksInner.prototype['apn'] = undefined;

/**
 * Connection Type
 * @member {String} connectionType
 */
GetOrganizationUplinksStatuses200ResponseInnerUplinksInner.prototype['connectionType'] = undefined;

/**
 * Primary DNS IP
 * @member {String} dns1
 */
GetOrganizationUplinksStatuses200ResponseInnerUplinksInner.prototype['dns1'] = undefined;

/**
 * Secondary DNS IP
 * @member {String} dns2
 */
GetOrganizationUplinksStatuses200ResponseInnerUplinksInner.prototype['dns2'] = undefined;

/**
 * Gateway IP
 * @member {String} gateway
 */
GetOrganizationUplinksStatuses200ResponseInnerUplinksInner.prototype['gateway'] = undefined;

/**
 * Integrated Circuit Card Identification Number
 * @member {String} iccid
 */
GetOrganizationUplinksStatuses200ResponseInnerUplinksInner.prototype['iccid'] = undefined;

/**
 * Uplink interface
 * @member {module:model/GetOrganizationUplinksStatuses200ResponseInnerUplinksInner.InterfaceEnum} interface
 */
GetOrganizationUplinksStatuses200ResponseInnerUplinksInner.prototype['interface'] = undefined;

/**
 * Uplink IP
 * @member {String} ip
 */
GetOrganizationUplinksStatuses200ResponseInnerUplinksInner.prototype['ip'] = undefined;

/**
 * The way in which the IP is assigned
 * @member {String} ipAssignedBy
 */
GetOrganizationUplinksStatuses200ResponseInnerUplinksInner.prototype['ipAssignedBy'] = undefined;

/**
 * Primary DNS IP
 * @member {String} primaryDns
 */
GetOrganizationUplinksStatuses200ResponseInnerUplinksInner.prototype['primaryDns'] = undefined;

/**
 * Network Provider
 * @member {String} provider
 */
GetOrganizationUplinksStatuses200ResponseInnerUplinksInner.prototype['provider'] = undefined;

/**
 * Public IP
 * @member {String} publicIp
 */
GetOrganizationUplinksStatuses200ResponseInnerUplinksInner.prototype['publicIp'] = undefined;

/**
 * Secondary DNS IP
 * @member {String} secondaryDns
 */
GetOrganizationUplinksStatuses200ResponseInnerUplinksInner.prototype['secondaryDns'] = undefined;

/**
 * @member {module:model/GetOrganizationCellularGatewayUplinkStatuses200ResponseInnerUplinksInnerSignalStat} signalStat
 */
GetOrganizationUplinksStatuses200ResponseInnerUplinksInner.prototype['signalStat'] = undefined;

/**
 * Signal Type
 * @member {String} signalType
 */
GetOrganizationUplinksStatuses200ResponseInnerUplinksInner.prototype['signalType'] = undefined;

/**
 * Uplink status
 * @member {module:model/GetOrganizationUplinksStatuses200ResponseInnerUplinksInner.StatusEnum} status
 */
GetOrganizationUplinksStatuses200ResponseInnerUplinksInner.prototype['status'] = undefined;
 ...
 * @readonly
 */
GetOrganizationUplinksStatuses200ResponseInnerUplinksInner['InterfaceEnum'] = {
 ...
 * @readonly
 */
GetOrganizationUplinksStatuses200ResponseInnerUplinksInner['StatusEnum'] = {
...
export default GetOrganizationUplinksStatuses200ResponseInnerUplinksInner;
