...
/**
 * The UpdateDeviceSwitchPortRequest model module.
 * @module model/UpdateDeviceSwitchPortRequest
 * @version 1.32.0
 */
class UpdateDeviceSwitchPortRequest {
    /**
     * Constructs a new <code>UpdateDeviceSwitchPortRequest</code>.
     * @alias module:model/UpdateDeviceSwitchPortRequest
     */
    constructor() { 
        
        UpdateDeviceSwitchPortRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateDeviceSwitchPortRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateDeviceSwitchPortRequest} obj Optional instance to populate.
     * @return {module:model/UpdateDeviceSwitchPortRequest} The populated <code>UpdateDeviceSwitchPortRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateDeviceSwitchPortRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateDeviceSwitchPortRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateDeviceSwitchPortRequest</code>.
     */
 ...
 */
UpdateDeviceSwitchPortRequest.prototype['accessPolicyNumber'] = undefined;

/**
 * The type of the access policy of the switch port. Only applicable to access ports. Can be one of 'Open', 'Custom access policy', 'MAC allow list' or 'Sticky MAC allow list'.
 * @member {module:model/UpdateDeviceSwitchPortRequest.AccessPolicyTypeEnum} accessPolicyType
 */
UpdateDeviceSwitchPortRequest.prototype['accessPolicyType'] = undefined;
 ...
 */
UpdateDeviceSwitchPortRequest.prototype['adaptivePolicyGroupId'] = undefined;

/**
 * The VLANs allowed on the switch port. Only applicable to trunk ports.
 * @member {String} allowedVlans
 */
UpdateDeviceSwitchPortRequest.prototype['allowedVlans'] = undefined;

/**
 * If true, ARP packets for this port will be considered trusted, and Dynamic ARP Inspection will allow the traffic.
 * @member {Boolean} daiTrusted
 */
UpdateDeviceSwitchPortRequest.prototype['daiTrusted'] = undefined;

/**
 * The status of the switch port.
 * @member {Boolean} enabled
 */
UpdateDeviceSwitchPortRequest.prototype['enabled'] = undefined;

/**
 * For supported switches (e.g. MS420/MS425), whether or not the port has flexible stacking enabled.
 * @member {Boolean} flexibleStackingEnabled
 */
UpdateDeviceSwitchPortRequest.prototype['flexibleStackingEnabled'] = undefined;

/**
 * The isolation status of the switch port.
 * @member {Boolean} isolationEnabled
 */
UpdateDeviceSwitchPortRequest.prototype['isolationEnabled'] = undefined;

/**
 * The link speed for the switch port.
 * @member {String} linkNegotiation
 */
UpdateDeviceSwitchPortRequest.prototype['linkNegotiation'] = undefined;

/**
 * Only devices with MAC addresses specified in this list will have access to this port. Up to 20 MAC addresses can be defined. Only applicable when 'accessPolicyType' is 'MAC allow list'.
 * @member {Array.<String>} macAllowList
 */
UpdateDeviceSwitchPortRequest.prototype['macAllowList'] = undefined;

/**
 * The name of the switch port.
 * @member {String} name
 */
UpdateDeviceSwitchPortRequest.prototype['name'] = undefined;
 ...
 */
UpdateDeviceSwitchPortRequest.prototype['peerSgtCapable'] = undefined;

/**
 * The PoE status of the switch port.
 * @member {Boolean} poeEnabled
 */
UpdateDeviceSwitchPortRequest.prototype['poeEnabled'] = undefined;

/**
 * The ID of the port schedule. A value of null will clear the port schedule.
 * @member {String} portScheduleId
 */
UpdateDeviceSwitchPortRequest.prototype['portScheduleId'] = undefined;

/**
 * @member {module:model/GetDeviceSwitchPorts200ResponseInnerProfile} profile
 */
UpdateDeviceSwitchPortRequest.prototype['profile'] = undefined;

/**
 * The rapid spanning tree protocol status.
 * @member {Boolean} rstpEnabled
 */
UpdateDeviceSwitchPortRequest.prototype['rstpEnabled'] = undefined;

/**
 * The initial list of MAC addresses for sticky Mac allow list. Only applicable when 'accessPolicyType' is 'Sticky MAC allow list'.
 * @member {Array.<String>} stickyMacAllowList
 */
UpdateDeviceSwitchPortRequest.prototype['stickyMacAllowList'] = undefined;

/**
 * The maximum number of MAC addresses for sticky MAC allow list. Only applicable when 'accessPolicyType' is 'Sticky MAC allow list'.
 * @member {Number} stickyMacAllowListLimit
 */
UpdateDeviceSwitchPortRequest.prototype['stickyMacAllowListLimit'] = undefined;

/**
 * The storm control status of the switch port.
 * @member {Boolean} stormControlEnabled
 */
UpdateDeviceSwitchPortRequest.prototype['stormControlEnabled'] = undefined;

/**
 * The state of the STP guard ('disabled', 'root guard', 'bpdu guard' or 'loop guard').
 * @member {module:model/UpdateDeviceSwitchPortRequest.StpGuardEnum} stpGuard
 */
UpdateDeviceSwitchPortRequest.prototype['stpGuard'] = undefined;

/**
 * The list of tags of the switch port.
 * @member {Array.<String>} tags
 */
UpdateDeviceSwitchPortRequest.prototype['tags'] = undefined;

/**
 * The type of the switch port ('trunk' or 'access').
 * @member {module:model/UpdateDeviceSwitchPortRequest.TypeEnum} type
 */
UpdateDeviceSwitchPortRequest.prototype['type'] = undefined;

/**
 * The action to take when Unidirectional Link is detected (Alert only, Enforce). Default configuration is Alert only.
 * @member {module:model/UpdateDeviceSwitchPortRequest.UdldEnum} udld
 */
UpdateDeviceSwitchPortRequest.prototype['udld'] = undefined;

/**
 * The VLAN of the switch port. A null value will clear the value set for trunk ports.
 * @member {Number} vlan
 */
UpdateDeviceSwitchPortRequest.prototype['vlan'] = undefined;

/**
 * The voice VLAN of the switch port. Only applicable to access ports.
 * @member {Number} voiceVlan
 */
UpdateDeviceSwitchPortRequest.prototype['voiceVlan'] = undefined;
 ...
 * @readonly
 */
UpdateDeviceSwitchPortRequest['AccessPolicyTypeEnum'] = {
 ...
 * @readonly
 */
UpdateDeviceSwitchPortRequest['StpGuardEnum'] = {
 ...
 * @readonly
 */
UpdateDeviceSwitchPortRequest['TypeEnum'] = {
 ...
 * @readonly
 */
UpdateDeviceSwitchPortRequest['UdldEnum'] = {
...
export default UpdateDeviceSwitchPortRequest;
