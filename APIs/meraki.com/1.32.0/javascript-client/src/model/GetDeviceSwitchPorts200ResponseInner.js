...
/**
 * The GetDeviceSwitchPorts200ResponseInner model module.
 * @module model/GetDeviceSwitchPorts200ResponseInner
 * @version 1.32.0
 */
class GetDeviceSwitchPorts200ResponseInner {
    /**
     * Constructs a new <code>GetDeviceSwitchPorts200ResponseInner</code>.
     * @alias module:model/GetDeviceSwitchPorts200ResponseInner
     */
    constructor() { 
        
        GetDeviceSwitchPorts200ResponseInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetDeviceSwitchPorts200ResponseInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetDeviceSwitchPorts200ResponseInner} obj Optional instance to populate.
     * @return {module:model/GetDeviceSwitchPorts200ResponseInner} The populated <code>GetDeviceSwitchPorts200ResponseInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetDeviceSwitchPorts200ResponseInner();
            ...
            if (data.hasOwnProperty('adaptivePolicyGroupId')) {
                obj['adaptivePolicyGroupId'] = ApiClient.convertToType(data['adaptivePolicyGroupId'], 'String');
            }
            ...
            if (data.hasOwnProperty('peerSgtCapable')) {
                obj['peerSgtCapable'] = ApiClient.convertToType(data['peerSgtCapable'], 'Boolean');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GetDeviceSwitchPorts200ResponseInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetDeviceSwitchPorts200ResponseInner</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['adaptivePolicyGroupId'] && !(typeof data['adaptivePolicyGroupId'] === 'string' || data['adaptivePolicyGroupId'] instanceof String)) {
            throw new Error("Expected the field `adaptivePolicyGroupId` to be a primitive type in the JSON string but got " + data['adaptivePolicyGroupId']);
        }
        // ensure the json data is a string
 ...
 */
GetDeviceSwitchPorts200ResponseInner.prototype['accessPolicyNumber'] = undefined;

/**
 * The type of the access policy of the switch port. Only applicable to access ports. Can be one of 'Open', 'Custom access policy', 'MAC allow list' or 'Sticky MAC allow list'.
 * @member {module:model/GetDeviceSwitchPorts200ResponseInner.AccessPolicyTypeEnum} accessPolicyType
 */
GetDeviceSwitchPorts200ResponseInner.prototype['accessPolicyType'] = undefined;
 ...
 * @member {String} adaptivePolicyGroupId
 */
GetDeviceSwitchPorts200ResponseInner.prototype['adaptivePolicyGroupId'] = undefined;

/**
 * The VLANs allowed on the switch port. Only applicable to trunk ports.
 * @member {String} allowedVlans
 */
GetDeviceSwitchPorts200ResponseInner.prototype['allowedVlans'] = undefined;

/**
 * If true, ARP packets for this port will be considered trusted, and Dynamic ARP Inspection will allow the traffic.
 * @member {Boolean} daiTrusted
 */
GetDeviceSwitchPorts200ResponseInner.prototype['daiTrusted'] = undefined;

/**
 * The status of the switch port.
 * @member {Boolean} enabled
 */
GetDeviceSwitchPorts200ResponseInner.prototype['enabled'] = undefined;

/**
 * For supported switches (e.g. MS420/MS425), whether or not the port has flexible stacking enabled.
 * @member {Boolean} flexibleStackingEnabled
 */
GetDeviceSwitchPorts200ResponseInner.prototype['flexibleStackingEnabled'] = undefined;

/**
 * The isolation status of the switch port.
 * @member {Boolean} isolationEnabled
 */
GetDeviceSwitchPorts200ResponseInner.prototype['isolationEnabled'] = undefined;

/**
 * The link speed for the switch port.
 * @member {String} linkNegotiation
 */
GetDeviceSwitchPorts200ResponseInner.prototype['linkNegotiation'] = undefined;

/**
 * Available link speeds for the switch port.
 * @member {Array.<String>} linkNegotiationCapabilities
 */
GetDeviceSwitchPorts200ResponseInner.prototype['linkNegotiationCapabilities'] = undefined;

/**
 * Only devices with MAC addresses specified in this list will have access to this port. Up to 20 MAC addresses can be defined. Only applicable when 'accessPolicyType' is 'MAC allow list'.
 * @member {Array.<String>} macAllowList
 */
GetDeviceSwitchPorts200ResponseInner.prototype['macAllowList'] = undefined;

/**
 * The name of the switch port.
 * @member {String} name
 */
GetDeviceSwitchPorts200ResponseInner.prototype['name'] = undefined;
 ...
 * @member {Boolean} peerSgtCapable
 */
GetDeviceSwitchPorts200ResponseInner.prototype['peerSgtCapable'] = undefined;

/**
 * The PoE status of the switch port.
 * @member {Boolean} poeEnabled
 */
GetDeviceSwitchPorts200ResponseInner.prototype['poeEnabled'] = undefined;

/**
 * The identifier of the switch port.
 * @member {String} portId
 */
GetDeviceSwitchPorts200ResponseInner.prototype['portId'] = undefined;

/**
 * The ID of the port schedule. A value of null will clear the port schedule.
 * @member {String} portScheduleId
 */
GetDeviceSwitchPorts200ResponseInner.prototype['portScheduleId'] = undefined;

/**
 * @member {module:model/GetDeviceSwitchPorts200ResponseInnerProfile} profile
 */
GetDeviceSwitchPorts200ResponseInner.prototype['profile'] = undefined;

/**
 * The rapid spanning tree protocol status.
 * @member {Boolean} rstpEnabled
 */
GetDeviceSwitchPorts200ResponseInner.prototype['rstpEnabled'] = undefined;

/**
 * The initial list of MAC addresses for sticky Mac allow list. Only applicable when 'accessPolicyType' is 'Sticky MAC allow list'.
 * @member {Array.<String>} stickyMacAllowList
 */
GetDeviceSwitchPorts200ResponseInner.prototype['stickyMacAllowList'] = undefined;

/**
 * The maximum number of MAC addresses for sticky MAC allow list. Only applicable when 'accessPolicyType' is 'Sticky MAC allow list'.
 * @member {Number} stickyMacAllowListLimit
 */
GetDeviceSwitchPorts200ResponseInner.prototype['stickyMacAllowListLimit'] = undefined;

/**
 * The storm control status of the switch port.
 * @member {Boolean} stormControlEnabled
 */
GetDeviceSwitchPorts200ResponseInner.prototype['stormControlEnabled'] = undefined;

/**
 * The state of the STP guard ('disabled', 'root guard', 'bpdu guard' or 'loop guard').
 * @member {module:model/GetDeviceSwitchPorts200ResponseInner.StpGuardEnum} stpGuard
 */
GetDeviceSwitchPorts200ResponseInner.prototype['stpGuard'] = undefined;

/**
 * The list of tags of the switch port.
 * @member {Array.<String>} tags
 */
GetDeviceSwitchPorts200ResponseInner.prototype['tags'] = undefined;

/**
 * The type of the switch port ('trunk' or 'access').
 * @member {module:model/GetDeviceSwitchPorts200ResponseInner.TypeEnum} type
 */
GetDeviceSwitchPorts200ResponseInner.prototype['type'] = undefined;

/**
 * The action to take when Unidirectional Link is detected (Alert only, Enforce). Default configuration is Alert only.
 * @member {module:model/GetDeviceSwitchPorts200ResponseInner.UdldEnum} udld
 */
GetDeviceSwitchPorts200ResponseInner.prototype['udld'] = undefined;

/**
 * The VLAN of the switch port. A null value will clear the value set for trunk ports.
 * @member {Number} vlan
 */
GetDeviceSwitchPorts200ResponseInner.prototype['vlan'] = undefined;

/**
 * The voice VLAN of the switch port. Only applicable to access ports.
 * @member {Number} voiceVlan
 */
GetDeviceSwitchPorts200ResponseInner.prototype['voiceVlan'] = undefined;
 ...
 * @readonly
 */
GetDeviceSwitchPorts200ResponseInner['AccessPolicyTypeEnum'] = {
 ...
 * @readonly
 */
GetDeviceSwitchPorts200ResponseInner['StpGuardEnum'] = {
 ...
 * @readonly
 */
GetDeviceSwitchPorts200ResponseInner['TypeEnum'] = {
 ...
 * @readonly
 */
GetDeviceSwitchPorts200ResponseInner['UdldEnum'] = {
...
export default GetDeviceSwitchPorts200ResponseInner;
