...
/**
 * The UpdateOrganizationLoginSecurityRequest model module.
 * @module model/UpdateOrganizationLoginSecurityRequest
 * @version 1.32.0
 */
class UpdateOrganizationLoginSecurityRequest {
    /**
     * Constructs a new <code>UpdateOrganizationLoginSecurityRequest</code>.
     * @alias module:model/UpdateOrganizationLoginSecurityRequest
     */
    constructor() { 
        
        UpdateOrganizationLoginSecurityRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateOrganizationLoginSecurityRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateOrganizationLoginSecurityRequest} obj Optional instance to populate.
     * @return {module:model/UpdateOrganizationLoginSecurityRequest} The populated <code>UpdateOrganizationLoginSecurityRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateOrganizationLoginSecurityRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateOrganizationLoginSecurityRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateOrganizationLoginSecurityRequest</code>.
     */
 ...
 */
UpdateOrganizationLoginSecurityRequest.prototype['accountLockoutAttempts'] = undefined;

/**
 * @member {module:model/GetOrganizationLoginSecurity200ResponseApiAuthentication} apiAuthentication
 */
UpdateOrganizationLoginSecurityRequest.prototype['apiAuthentication'] = undefined;
 ...
 */
UpdateOrganizationLoginSecurityRequest.prototype['enforceAccountLockout'] = undefined;
 ...
 */
UpdateOrganizationLoginSecurityRequest.prototype['enforceDifferentPasswords'] = undefined;
 ...
 */
UpdateOrganizationLoginSecurityRequest.prototype['enforceIdleTimeout'] = undefined;
 ...
 */
UpdateOrganizationLoginSecurityRequest.prototype['enforceLoginIpRanges'] = undefined;
 ...
 */
UpdateOrganizationLoginSecurityRequest.prototype['enforcePasswordExpiration'] = undefined;
 ...
 */
UpdateOrganizationLoginSecurityRequest.prototype['enforceStrongPasswords'] = undefined;
 ...
 */
UpdateOrganizationLoginSecurityRequest.prototype['enforceTwoFactorAuth'] = undefined;

/**
 * Number of minutes users can remain idle before being logged out of their accounts.
 * @member {Number} idleTimeoutMinutes
 */
UpdateOrganizationLoginSecurityRequest.prototype['idleTimeoutMinutes'] = undefined;
 ...
 */
UpdateOrganizationLoginSecurityRequest.prototype['loginIpRanges'] = undefined;

/**
 * Number of recent passwords that new password must be distinct from.
 * @member {Number} numDifferentPasswords
 */
UpdateOrganizationLoginSecurityRequest.prototype['numDifferentPasswords'] = undefined;

/**
 * Number of days after which users will be forced to change their password.
 * @member {Number} passwordExpirationDays
 */
UpdateOrganizationLoginSecurityRequest.prototype['passwordExpirationDays'] = undefined;
...
export default UpdateOrganizationLoginSecurityRequest;
