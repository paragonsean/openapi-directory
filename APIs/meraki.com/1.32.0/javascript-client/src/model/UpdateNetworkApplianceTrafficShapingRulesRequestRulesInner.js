...
/**
 * The UpdateNetworkApplianceTrafficShapingRulesRequestRulesInner model module.
 * @module model/UpdateNetworkApplianceTrafficShapingRulesRequestRulesInner
 * @version 1.32.0
 */
class UpdateNetworkApplianceTrafficShapingRulesRequestRulesInner {
    /**
     * Constructs a new <code>UpdateNetworkApplianceTrafficShapingRulesRequestRulesInner</code>.
     * @alias module:model/UpdateNetworkApplianceTrafficShapingRulesRequestRulesInner
    ...
    constructor(definitions) { 
        ...
        UpdateNetworkApplianceTrafficShapingRulesRequestRulesInner.initialize(this, definitions);
    }
    ...
    /**
     * Constructs a <code>UpdateNetworkApplianceTrafficShapingRulesRequestRulesInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateNetworkApplianceTrafficShapingRulesRequestRulesInner} obj Optional instance to populate.
     * @return {module:model/UpdateNetworkApplianceTrafficShapingRulesRequestRulesInner} The populated <code>UpdateNetworkApplianceTrafficShapingRulesRequestRulesInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateNetworkApplianceTrafficShapingRulesRequestRulesInner();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateNetworkApplianceTrafficShapingRulesRequestRulesInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateNetworkApplianceTrafficShapingRulesRequestRulesInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateNetworkApplianceTrafficShapingRulesRequestRulesInner.RequiredProperties) {
...
UpdateNetworkApplianceTrafficShapingRulesRequestRulesInner.RequiredProperties = ["definitions"];
 ...
 */
UpdateNetworkApplianceTrafficShapingRulesRequestRulesInner.prototype['definitions'] = undefined;
 ...
 */
UpdateNetworkApplianceTrafficShapingRulesRequestRulesInner.prototype['dscpTagValue'] = undefined;
 ...
 */
UpdateNetworkApplianceTrafficShapingRulesRequestRulesInner.prototype['perClientBandwidthLimits'] = undefined;

/**
 *     A string, indicating the priority level for packets bound to your rule.     Can be 'low', 'normal' or 'high'. 
 * @member {String} priority
 */
UpdateNetworkApplianceTrafficShapingRulesRequestRulesInner.prototype['priority'] = undefined;
...
export default UpdateNetworkApplianceTrafficShapingRulesRequestRulesInner;
