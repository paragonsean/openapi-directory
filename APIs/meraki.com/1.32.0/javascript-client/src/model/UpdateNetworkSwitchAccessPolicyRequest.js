...
/**
 * The UpdateNetworkSwitchAccessPolicyRequest model module.
 * @module model/UpdateNetworkSwitchAccessPolicyRequest
 * @version 1.32.0
 */
class UpdateNetworkSwitchAccessPolicyRequest {
    /**
     * Constructs a new <code>UpdateNetworkSwitchAccessPolicyRequest</code>.
     * @alias module:model/UpdateNetworkSwitchAccessPolicyRequest
     */
    constructor() { 
        
        UpdateNetworkSwitchAccessPolicyRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateNetworkSwitchAccessPolicyRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateNetworkSwitchAccessPolicyRequest} obj Optional instance to populate.
     * @return {module:model/UpdateNetworkSwitchAccessPolicyRequest} The populated <code>UpdateNetworkSwitchAccessPolicyRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateNetworkSwitchAccessPolicyRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateNetworkSwitchAccessPolicyRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateNetworkSwitchAccessPolicyRequest</code>.
     */
 ...
 * @member {module:model/UpdateNetworkSwitchAccessPolicyRequest.AccessPolicyTypeEnum} accessPolicyType
 */
UpdateNetworkSwitchAccessPolicyRequest.prototype['accessPolicyType'] = undefined;

/**
 * @member {module:model/GetNetworkSwitchAccessPolicies200ResponseInnerDot1x} dot1x
 */
UpdateNetworkSwitchAccessPolicyRequest.prototype['dot1x'] = undefined;

/**
 * If enabled, Meraki devices will periodically send access-request messages to these RADIUS servers
 * @member {Boolean} guestPortBouncing
 */
UpdateNetworkSwitchAccessPolicyRequest.prototype['guestPortBouncing'] = undefined;

/**
 * ID for the guest VLAN allow unauthorized devices access to limited network resources
 * @member {Number} guestVlanId
 */
UpdateNetworkSwitchAccessPolicyRequest.prototype['guestVlanId'] = undefined;

/**
 * Choose the Host Mode for the access policy.
 * @member {module:model/UpdateNetworkSwitchAccessPolicyRequest.HostModeEnum} hostMode
 */
UpdateNetworkSwitchAccessPolicyRequest.prototype['hostMode'] = undefined;

/**
 * Enabling this option will make switches execute 802.1X and MAC-bypass authentication simultaneously so that clients authenticate faster. Only required when accessPolicyType is 'Hybrid Authentication.
 * @member {Boolean} increaseAccessSpeed
 */
UpdateNetworkSwitchAccessPolicyRequest.prototype['increaseAccessSpeed'] = undefined;

/**
 * Name of the access policy
 * @member {String} name
 */
UpdateNetworkSwitchAccessPolicyRequest.prototype['name'] = undefined;

/**
 * @member {module:model/GetNetworkSwitchAccessPolicies200ResponseInnerRadius} radius
 */
UpdateNetworkSwitchAccessPolicyRequest.prototype['radius'] = undefined;

/**
 * Enable to send start, interim-update and stop messages to a configured RADIUS accounting server for tracking connected clients
 * @member {Boolean} radiusAccountingEnabled
 */
UpdateNetworkSwitchAccessPolicyRequest.prototype['radiusAccountingEnabled'] = undefined;
 ...
 */
UpdateNetworkSwitchAccessPolicyRequest.prototype['radiusAccountingServers'] = undefined;

/**
 * Change of authentication for RADIUS re-authentication and disconnection
 * @member {Boolean} radiusCoaSupportEnabled
 */
UpdateNetworkSwitchAccessPolicyRequest.prototype['radiusCoaSupportEnabled'] = undefined;

/**
 * Acceptable values are `\"\"` for None, or `\"11\"` for Group Policies ACL
 * @member {String} radiusGroupAttribute
 */
UpdateNetworkSwitchAccessPolicyRequest.prototype['radiusGroupAttribute'] = undefined;

/**
 * List of RADIUS servers to require connecting devices to authenticate against before granting network access
 * @member {Array.<module:model/CreateNetworkSwitchAccessPolicyRequestRadiusServersInner>} radiusServers
 */
UpdateNetworkSwitchAccessPolicyRequest.prototype['radiusServers'] = undefined;

/**
 * If enabled, Meraki devices will periodically send access-request messages to these RADIUS servers
 * @member {Boolean} radiusTestingEnabled
 */
UpdateNetworkSwitchAccessPolicyRequest.prototype['radiusTestingEnabled'] = undefined;
 ...
 */
UpdateNetworkSwitchAccessPolicyRequest.prototype['urlRedirectWalledGardenEnabled'] = undefined;

/**
 * IP address ranges, in CIDR notation, to restrict access for clients to a specific set of IP addresses or hostnames prior to authentication
 * @member {Array.<String>} urlRedirectWalledGardenRanges
 */
UpdateNetworkSwitchAccessPolicyRequest.prototype['urlRedirectWalledGardenRanges'] = undefined;

/**
 * CDP/LLDP capable voice clients will be able to use this VLAN. Automatically true when hostMode is 'Multi-Domain'.
 * @member {Boolean} voiceVlanClients
 */
UpdateNetworkSwitchAccessPolicyRequest.prototype['voiceVlanClients'] = undefined;
 ...
 * @readonly
 */
UpdateNetworkSwitchAccessPolicyRequest['AccessPolicyTypeEnum'] = {
 ...
 * @readonly
 */
UpdateNetworkSwitchAccessPolicyRequest['HostModeEnum'] = {
...
export default UpdateNetworkSwitchAccessPolicyRequest;
