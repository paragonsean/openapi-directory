...
/**
 * The CreateNetworkGroupPolicyRequestScheduling model module.
 * @module model/CreateNetworkGroupPolicyRequestScheduling
 * @version 1.32.0
 */
class CreateNetworkGroupPolicyRequestScheduling {
    /**
     * Constructs a new <code>CreateNetworkGroupPolicyRequestScheduling</code>.
     *     The schedule for the group policy. Schedules are applied to days of the week. 
     * @alias module:model/CreateNetworkGroupPolicyRequestScheduling
     */
    constructor() { 
        
        CreateNetworkGroupPolicyRequestScheduling.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateNetworkGroupPolicyRequestScheduling</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateNetworkGroupPolicyRequestScheduling} obj Optional instance to populate.
     * @return {module:model/CreateNetworkGroupPolicyRequestScheduling} The populated <code>CreateNetworkGroupPolicyRequestScheduling</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateNetworkGroupPolicyRequestScheduling();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateNetworkGroupPolicyRequestScheduling</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateNetworkGroupPolicyRequestScheduling</code>.
     */
 ...
 */
CreateNetworkGroupPolicyRequestScheduling.prototype['enabled'] = undefined;

/**
 * @member {module:model/CreateNetworkGroupPolicyRequestSchedulingFriday} friday
 */
CreateNetworkGroupPolicyRequestScheduling.prototype['friday'] = undefined;

/**
 * @member {module:model/CreateNetworkGroupPolicyRequestSchedulingMonday} monday
 */
CreateNetworkGroupPolicyRequestScheduling.prototype['monday'] = undefined;

/**
 * @member {module:model/CreateNetworkGroupPolicyRequestSchedulingSaturday} saturday
 */
CreateNetworkGroupPolicyRequestScheduling.prototype['saturday'] = undefined;

/**
 * @member {module:model/CreateNetworkGroupPolicyRequestSchedulingSunday} sunday
 */
CreateNetworkGroupPolicyRequestScheduling.prototype['sunday'] = undefined;

/**
 * @member {module:model/CreateNetworkGroupPolicyRequestSchedulingThursday} thursday
 */
CreateNetworkGroupPolicyRequestScheduling.prototype['thursday'] = undefined;

/**
 * @member {module:model/CreateNetworkGroupPolicyRequestSchedulingTuesday} tuesday
 */
CreateNetworkGroupPolicyRequestScheduling.prototype['tuesday'] = undefined;

/**
 * @member {module:model/CreateNetworkGroupPolicyRequestSchedulingWednesday} wednesday
 */
CreateNetworkGroupPolicyRequestScheduling.prototype['wednesday'] = undefined;
...
export default CreateNetworkGroupPolicyRequestScheduling;
