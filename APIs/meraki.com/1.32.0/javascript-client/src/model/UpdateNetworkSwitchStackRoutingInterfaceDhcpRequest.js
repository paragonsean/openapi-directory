...
/**
 * The UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest model module.
 * @module model/UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest
 * @version 1.32.0
 */
class UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest {
    /**
     * Constructs a new <code>UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest</code>.
     * @alias module:model/UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest
     */
    constructor() { 
        
        UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest} obj Optional instance to populate.
     * @return {module:model/UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest} The populated <code>UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest</code>.
     */
 ...
 */
UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest.prototype['bootFileName'] = undefined;

/**
 * The PXE boot server IP for the DHCP server running on the switch stack interface
 * @member {String} bootNextServer
 */
UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest.prototype['bootNextServer'] = undefined;
 ...
 */
UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest.prototype['bootOptionsEnabled'] = undefined;
 ...
 * @member {module:model/UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest.DhcpLeaseTimeEnum} dhcpLeaseTime
 */
UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest.prototype['dhcpLeaseTime'] = undefined;

/**
 * The DHCP mode options for the switch stack interface ('dhcpDisabled', 'dhcpRelay' or 'dhcpServer')
 * @member {module:model/UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest.DhcpModeEnum} dhcpMode
 */
UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest.prototype['dhcpMode'] = undefined;
 ...
 */
UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest.prototype['dhcpOptions'] = undefined;
 ...
 */
UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest.prototype['dhcpRelayServerIps'] = undefined;

/**
 * The DHCP name server IPs when DHCP name server option is 'custom'
 * @member {Array.<String>} dnsCustomNameservers
 */
UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest.prototype['dnsCustomNameservers'] = undefined;

/**
 * The DHCP name server option for the dhcp server running on the switch stack interface ('googlePublicDns', 'openDns' or 'custom')
 * @member {module:model/UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest.DnsNameserversOptionEnum} dnsNameserversOption
 */
UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest.prototype['dnsNameserversOption'] = undefined;
 ...
 */
UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest.prototype['fixedIpAssignments'] = undefined;
 ...
 */
UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest.prototype['reservedIpRanges'] = undefined;
 ...
 * @readonly
 */
UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest['DhcpLeaseTimeEnum'] = {
 ...
 * @readonly
 */
UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest['DhcpModeEnum'] = {
 ...
 * @readonly
 */
UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest['DnsNameserversOptionEnum'] = {
...
export default UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest;
