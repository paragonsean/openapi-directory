...
/**
 * The GetOrganizationApplianceVpnThirdPartyVPNPeers200ResponsePeersInner model module.
 * @module model/GetOrganizationApplianceVpnThirdPartyVPNPeers200ResponsePeersInner
 * @version 1.32.0
 */
class GetOrganizationApplianceVpnThirdPartyVPNPeers200ResponsePeersInner {
    /**
     * Constructs a new <code>GetOrganizationApplianceVpnThirdPartyVPNPeers200ResponsePeersInner</code>.
     * @alias module:model/GetOrganizationApplianceVpnThirdPartyVPNPeers200ResponsePeersInner
     */
    constructor() { 
        
        GetOrganizationApplianceVpnThirdPartyVPNPeers200ResponsePeersInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetOrganizationApplianceVpnThirdPartyVPNPeers200ResponsePeersInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetOrganizationApplianceVpnThirdPartyVPNPeers200ResponsePeersInner} obj Optional instance to populate.
     * @return {module:model/GetOrganizationApplianceVpnThirdPartyVPNPeers200ResponsePeersInner} The populated <code>GetOrganizationApplianceVpnThirdPartyVPNPeers200ResponsePeersInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetOrganizationApplianceVpnThirdPartyVPNPeers200ResponsePeersInner();
    ...
    /**
     * Validates the JSON data with respect to <code>GetOrganizationApplianceVpnThirdPartyVPNPeers200ResponsePeersInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetOrganizationApplianceVpnThirdPartyVPNPeers200ResponsePeersInner</code>.
     */
 ...
 * @member {module:model/GetOrganizationApplianceVpnThirdPartyVPNPeers200ResponsePeersInner.IkeVersionEnum} ikeVersion
 * @default '1'
 */
GetOrganizationApplianceVpnThirdPartyVPNPeers200ResponsePeersInner.prototype['ikeVersion'] = '1';

/**
 * @member {module:model/GetOrganizationApplianceVpnThirdPartyVPNPeers200ResponsePeersInnerIpsecPolicies} ipsecPolicies
 */
GetOrganizationApplianceVpnThirdPartyVPNPeers200ResponsePeersInner.prototype['ipsecPolicies'] = undefined;

/**
 * One of the following available presets: 'default', 'aws', 'azure'. If this is provided, the 'ipsecPolicies' parameter is ignored.
 * @member {String} ipsecPoliciesPreset
 */
GetOrganizationApplianceVpnThirdPartyVPNPeers200ResponsePeersInner.prototype['ipsecPoliciesPreset'] = undefined;
 ...
 */
GetOrganizationApplianceVpnThirdPartyVPNPeers200ResponsePeersInner.prototype['localId'] = undefined;

/**
 * The name of the VPN peer
 * @member {String} name
 */
GetOrganizationApplianceVpnThirdPartyVPNPeers200ResponsePeersInner.prototype['name'] = undefined;

/**
 * A list of network tags that will connect with this peer. Use ['all'] for all networks. Use ['none'] for no networks. If not included, the default is ['all'].
 * @member {Array.<String>} networkTags
 */
GetOrganizationApplianceVpnThirdPartyVPNPeers200ResponsePeersInner.prototype['networkTags'] = undefined;

/**
 * The list of the private subnets of the VPN peer
 * @member {Array.<String>} privateSubnets
 */
GetOrganizationApplianceVpnThirdPartyVPNPeers200ResponsePeersInner.prototype['privateSubnets'] = undefined;

/**
 * [optional] The public IP of the VPN peer
 * @member {String} publicIp
 */
GetOrganizationApplianceVpnThirdPartyVPNPeers200ResponsePeersInner.prototype['publicIp'] = undefined;

/**
 * [optional] The remote ID is used to identify the connecting VPN peer. This can either be a valid IPv4 Address, FQDN or User FQDN.
 * @member {String} remoteId
 */
GetOrganizationApplianceVpnThirdPartyVPNPeers200ResponsePeersInner.prototype['remoteId'] = undefined;

/**
 * The shared secret with the VPN peer
 * @member {String} secret
 */
GetOrganizationApplianceVpnThirdPartyVPNPeers200ResponsePeersInner.prototype['secret'] = undefined;
 ...
 * @readonly
 */
GetOrganizationApplianceVpnThirdPartyVPNPeers200ResponsePeersInner['IkeVersionEnum'] = {
...
export default GetOrganizationApplianceVpnThirdPartyVPNPeers200ResponsePeersInner;
