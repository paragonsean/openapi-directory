...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MerakiDashboardApi.UpdateDeviceSwitchRoutingStaticRouteRequest();
  });
  ...
  describe('UpdateDeviceSwitchRoutingStaticRouteRequest', function() {
    it('should create an instance of UpdateDeviceSwitchRoutingStaticRouteRequest', function() {
      // uncomment below and update the code to test UpdateDeviceSwitchRoutingStaticRouteRequest
      //var instance = new MerakiDashboardApi.UpdateDeviceSwitchRoutingStaticRouteRequest();
      //expect(instance).to.be.a(MerakiDashboardApi.UpdateDeviceSwitchRoutingStaticRouteRequest);
    });
