...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MerakiDashboardApi.CreateNetworkSwitchPortScheduleRequestPortSchedule();
  });
  ...
  describe('CreateNetworkSwitchPortScheduleRequestPortSchedule', function() {
    it('should create an instance of CreateNetworkSwitchPortScheduleRequestPortSchedule', function() {
      // uncomment below and update the code to test CreateNetworkSwitchPortScheduleRequestPortSchedule
      //var instance = new MerakiDashboardApi.CreateNetworkSwitchPortScheduleRequestPortSchedule();
      //expect(instance).to.be.a(MerakiDashboardApi.CreateNetworkSwitchPortScheduleRequestPortSchedule);
    });
