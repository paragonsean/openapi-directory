...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MerakiDashboardApi.GetOrganizationSummaryTopDevicesByUsage200ResponseInner();
  });
  ...
  describe('GetOrganizationSummaryTopDevicesByUsage200ResponseInner', function() {
    it('should create an instance of GetOrganizationSummaryTopDevicesByUsage200ResponseInner', function() {
      // uncomment below and update the code to test GetOrganizationSummaryTopDevicesByUsage200ResponseInner
      //var instance = new MerakiDashboardApi.GetOrganizationSummaryTopDevicesByUsage200ResponseInner();
      //expect(instance).to.be.a(MerakiDashboardApi.GetOrganizationSummaryTopDevicesByUsage200ResponseInner);
    });
