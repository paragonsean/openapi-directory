...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MerakiDashboardApi.UpdateNetworkApplianceSsidRequest();
  });
  ...
  describe('UpdateNetworkApplianceSsidRequest', function() {
    it('should create an instance of UpdateNetworkApplianceSsidRequest', function() {
      // uncomment below and update the code to test UpdateNetworkApplianceSsidRequest
      //var instance = new MerakiDashboardApi.UpdateNetworkApplianceSsidRequest();
      //expect(instance).to.be.a(MerakiDashboardApi.UpdateNetworkApplianceSsidRequest);
    });
    ...
    it('should have the property dhcpEnforcedDeauthentication (base name: "dhcpEnforcedDeauthentication")', function() {
      // uncomment below and update the code to test the property dhcpEnforcedDeauthentication
      //var instance = new MerakiDashboardApi.UpdateNetworkApplianceSsidRequest();
      //expect(instance).to.be();
    });
