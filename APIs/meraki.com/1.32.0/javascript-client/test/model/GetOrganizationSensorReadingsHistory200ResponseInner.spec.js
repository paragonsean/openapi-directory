...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MerakiDashboardApi.GetOrganizationSensorReadingsHistory200ResponseInner();
  });
  ...
  describe('GetOrganizationSensorReadingsHistory200ResponseInner', function() {
    it('should create an instance of GetOrganizationSensorReadingsHistory200ResponseInner', function() {
      // uncomment below and update the code to test GetOrganizationSensorReadingsHistory200ResponseInner
      //var instance = new MerakiDashboardApi.GetOrganizationSensorReadingsHistory200ResponseInner();
      //expect(instance).to.be.a(MerakiDashboardApi.GetOrganizationSensorReadingsHistory200ResponseInner);
    });
