...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MerakiDashboardApi.CreateOrganizationRequest();
  });
  ...
  describe('CreateOrganizationRequest', function() {
    it('should create an instance of CreateOrganizationRequest', function() {
      ...
      //var instance = new MerakiDashboardApi.CreateOrganizationRequest();
      //expect(instance).to.be.a(MerakiDashboardApi.CreateOrganizationRequest);
    });
