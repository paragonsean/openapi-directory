...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MerakiDashboardApi.UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest();
  });
  ...
  describe('UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest', function() {
    it('should create an instance of UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest', function() {
      // uncomment below and update the code to test UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest
      //var instance = new MerakiDashboardApi.UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest();
      //expect(instance).to.be.a(MerakiDashboardApi.UpdateNetworkSwitchStackRoutingInterfaceDhcpRequest);
    });
