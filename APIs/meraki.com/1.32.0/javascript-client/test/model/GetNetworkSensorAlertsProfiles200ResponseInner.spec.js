...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MerakiDashboardApi.GetNetworkSensorAlertsProfiles200ResponseInner();
  });
  ...
  describe('GetNetworkSensorAlertsProfiles200ResponseInner', function() {
    it('should create an instance of GetNetworkSensorAlertsProfiles200ResponseInner', function() {
      // uncomment below and update the code to test GetNetworkSensorAlertsProfiles200ResponseInner
      //var instance = new MerakiDashboardApi.GetNetworkSensorAlertsProfiles200ResponseInner();
      //expect(instance).to.be.a(MerakiDashboardApi.GetNetworkSensorAlertsProfiles200ResponseInner);
    });
