...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MerakiDashboardApi.UpdateNetworkSwitchAccessPolicyRequest();
  });
  ...
  describe('UpdateNetworkSwitchAccessPolicyRequest', function() {
    it('should create an instance of UpdateNetworkSwitchAccessPolicyRequest', function() {
      // uncomment below and update the code to test UpdateNetworkSwitchAccessPolicyRequest
      //var instance = new MerakiDashboardApi.UpdateNetworkSwitchAccessPolicyRequest();
      //expect(instance).to.be.a(MerakiDashboardApi.UpdateNetworkSwitchAccessPolicyRequest);
    });
