...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MerakiDashboardApi.CreateOrganizationPolicyObjectRequest();
  });
  ...
  describe('CreateOrganizationPolicyObjectRequest', function() {
    it('should create an instance of CreateOrganizationPolicyObjectRequest', function() {
      // uncomment below and update the code to test CreateOrganizationPolicyObjectRequest
      //var instance = new MerakiDashboardApi.CreateOrganizationPolicyObjectRequest();
      //expect(instance).to.be.a(MerakiDashboardApi.CreateOrganizationPolicyObjectRequest);
    });
