...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MerakiDashboardApi.UpdateDeviceCellularGatewayPortForwardingRulesRequestRulesInner();
  });
  ...
  describe('UpdateDeviceCellularGatewayPortForwardingRulesRequestRulesInner', function() {
    it('should create an instance of UpdateDeviceCellularGatewayPortForwardingRulesRequestRulesInner', function() {
      // uncomment below and update the code to test UpdateDeviceCellularGatewayPortForwardingRulesRequestRulesInner
      //var instance = new MerakiDashboardApi.UpdateDeviceCellularGatewayPortForwardingRulesRequestRulesInner();
      //expect(instance).to.be.a(MerakiDashboardApi.UpdateDeviceCellularGatewayPortForwardingRulesRequestRulesInner);
    });
