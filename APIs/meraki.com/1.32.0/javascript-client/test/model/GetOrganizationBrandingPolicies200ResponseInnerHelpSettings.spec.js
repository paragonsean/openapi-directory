...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MerakiDashboardApi.GetOrganizationBrandingPolicies200ResponseInnerHelpSettings();
  });
  ...
  describe('GetOrganizationBrandingPolicies200ResponseInnerHelpSettings', function() {
    it('should create an instance of GetOrganizationBrandingPolicies200ResponseInnerHelpSettings', function() {
      // uncomment below and update the code to test GetOrganizationBrandingPolicies200ResponseInnerHelpSettings
      //var instance = new MerakiDashboardApi.GetOrganizationBrandingPolicies200ResponseInnerHelpSettings();
      //expect(instance).to.be.a(MerakiDashboardApi.GetOrganizationBrandingPolicies200ResponseInnerHelpSettings);
    });
