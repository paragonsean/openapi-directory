...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MerakiDashboardApi.UpdateNetworkGroupPolicyRequest();
  });
  ...
  describe('UpdateNetworkGroupPolicyRequest', function() {
    it('should create an instance of UpdateNetworkGroupPolicyRequest', function() {
      // uncomment below and update the code to test UpdateNetworkGroupPolicyRequest
      //var instance = new MerakiDashboardApi.UpdateNetworkGroupPolicyRequest();
      //expect(instance).to.be.a(MerakiDashboardApi.UpdateNetworkGroupPolicyRequest);
    });
