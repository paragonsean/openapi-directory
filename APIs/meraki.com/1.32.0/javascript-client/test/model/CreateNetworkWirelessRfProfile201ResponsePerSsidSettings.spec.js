...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MerakiDashboardApi.CreateNetworkWirelessRfProfile201ResponsePerSsidSettings();
  });
  ...
  describe('CreateNetworkWirelessRfProfile201ResponsePerSsidSettings', function() {
    it('should create an instance of CreateNetworkWirelessRfProfile201ResponsePerSsidSettings', function() {
      // uncomment below and update the code to test CreateNetworkWirelessRfProfile201ResponsePerSsidSettings
      //var instance = new MerakiDashboardApi.CreateNetworkWirelessRfProfile201ResponsePerSsidSettings();
      //expect(instance).to.be.a(MerakiDashboardApi.CreateNetworkWirelessRfProfile201ResponsePerSsidSettings);
    });
