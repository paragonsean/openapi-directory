...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MerakiDashboardApi.UpdateDeviceSwitchPortRequest();
  });
  ...
  describe('UpdateDeviceSwitchPortRequest', function() {
    it('should create an instance of UpdateDeviceSwitchPortRequest', function() {
      // uncomment below and update the code to test UpdateDeviceSwitchPortRequest
      //var instance = new MerakiDashboardApi.UpdateDeviceSwitchPortRequest();
      //expect(instance).to.be.a(MerakiDashboardApi.UpdateDeviceSwitchPortRequest);
    });
