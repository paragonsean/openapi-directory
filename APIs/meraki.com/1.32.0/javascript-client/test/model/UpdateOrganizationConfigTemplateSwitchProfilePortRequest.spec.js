...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MerakiDashboardApi.UpdateOrganizationConfigTemplateSwitchProfilePortRequest();
  });
  ...
  describe('UpdateOrganizationConfigTemplateSwitchProfilePortRequest', function() {
    it('should create an instance of UpdateOrganizationConfigTemplateSwitchProfilePortRequest', function() {
      // uncomment below and update the code to test UpdateOrganizationConfigTemplateSwitchProfilePortRequest
      //var instance = new MerakiDashboardApi.UpdateOrganizationConfigTemplateSwitchProfilePortRequest();
      //expect(instance).to.be.a(MerakiDashboardApi.UpdateOrganizationConfigTemplateSwitchProfilePortRequest);
    });
