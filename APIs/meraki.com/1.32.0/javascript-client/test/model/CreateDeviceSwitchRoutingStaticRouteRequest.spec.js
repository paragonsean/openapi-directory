...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MerakiDashboardApi.CreateDeviceSwitchRoutingStaticRouteRequest();
  });
  ...
  describe('CreateDeviceSwitchRoutingStaticRouteRequest', function() {
    it('should create an instance of CreateDeviceSwitchRoutingStaticRouteRequest', function() {
      // uncomment below and update the code to test CreateDeviceSwitchRoutingStaticRouteRequest
      //var instance = new MerakiDashboardApi.CreateDeviceSwitchRoutingStaticRouteRequest();
      //expect(instance).to.be.a(MerakiDashboardApi.CreateDeviceSwitchRoutingStaticRouteRequest);
    });
