...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MerakiDashboardApi.GetOrganizationCellularGatewayUplinkStatuses200ResponseInnerUplinksInner();
  });
  ...
  describe('GetOrganizationCellularGatewayUplinkStatuses200ResponseInnerUplinksInner', function() {
    it('should create an instance of GetOrganizationCellularGatewayUplinkStatuses200ResponseInnerUplinksInner', function() {
      // uncomment below and update the code to test GetOrganizationCellularGatewayUplinkStatuses200ResponseInnerUplinksInner
      //var instance = new MerakiDashboardApi.GetOrganizationCellularGatewayUplinkStatuses200ResponseInnerUplinksInner();
      //expect(instance).to.be.a(MerakiDashboardApi.GetOrganizationCellularGatewayUplinkStatuses200ResponseInnerUplinksInner);
    });
