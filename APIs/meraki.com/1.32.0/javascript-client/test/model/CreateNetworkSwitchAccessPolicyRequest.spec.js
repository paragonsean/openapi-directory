...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MerakiDashboardApi.CreateNetworkSwitchAccessPolicyRequest();
  });
  ...
  describe('CreateNetworkSwitchAccessPolicyRequest', function() {
    it('should create an instance of CreateNetworkSwitchAccessPolicyRequest', function() {
      // uncomment below and update the code to test CreateNetworkSwitchAccessPolicyRequest
      //var instance = new MerakiDashboardApi.CreateNetworkSwitchAccessPolicyRequest();
      //expect(instance).to.be.a(MerakiDashboardApi.CreateNetworkSwitchAccessPolicyRequest);
    });
