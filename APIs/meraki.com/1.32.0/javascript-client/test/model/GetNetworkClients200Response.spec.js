...
(function(root, factory) {
  ...
  describe('GetNetworkClients200Response', function() {
    ...
    it('should have the property adaptivePolicyGroup (base name: "adaptivePolicyGroup")', function() {
      // uncomment below and update the code to test the property adaptivePolicyGroup
      //var instance = new MerakiDashboardApi.GetNetworkClients200Response();
    ...
    it('should have the property deviceTypePrediction (base name: "deviceTypePrediction")', function() {
      // uncomment below and update the code to test the property deviceTypePrediction
      //var instance = new MerakiDashboardApi.GetNetworkClients200Response();
      //expect(instance).to.be();
    });
    ...
    it('should have the property namedVlan (base name: "namedVlan")', function() {
      // uncomment below and update the code to test the property namedVlan
      //var instance = new MerakiDashboardApi.GetNetworkClients200Response();
      //expect(instance).to.be();
    });
    ...
    it('should have the property recentDeviceConnection (base name: "recentDeviceConnection")', function() {
      // uncomment below and update the code to test the property recentDeviceConnection
      //var instance = new MerakiDashboardApi.GetNetworkClients200Response();
      //expect(instance).to.be();
    });
