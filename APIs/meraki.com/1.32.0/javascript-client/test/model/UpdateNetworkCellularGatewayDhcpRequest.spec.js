...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MerakiDashboardApi.UpdateNetworkCellularGatewayDhcpRequest();
  });
  ...
  describe('UpdateNetworkCellularGatewayDhcpRequest', function() {
    it('should create an instance of UpdateNetworkCellularGatewayDhcpRequest', function() {
      // uncomment below and update the code to test UpdateNetworkCellularGatewayDhcpRequest
      //var instance = new MerakiDashboardApi.UpdateNetworkCellularGatewayDhcpRequest();
      //expect(instance).to.be.a(MerakiDashboardApi.UpdateNetworkCellularGatewayDhcpRequest);
    });
