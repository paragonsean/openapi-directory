...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MerakiDashboardApi.CreateNetworkWirelessRfProfileRequestPerSsidSettings();
  });
  ...
  describe('CreateNetworkWirelessRfProfileRequestPerSsidSettings', function() {
    it('should create an instance of CreateNetworkWirelessRfProfileRequestPerSsidSettings', function() {
      // uncomment below and update the code to test CreateNetworkWirelessRfProfileRequestPerSsidSettings
      //var instance = new MerakiDashboardApi.CreateNetworkWirelessRfProfileRequestPerSsidSettings();
      //expect(instance).to.be.a(MerakiDashboardApi.CreateNetworkWirelessRfProfileRequestPerSsidSettings);
    });
