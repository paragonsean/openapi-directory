...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MerakiDashboardApi.ProvisionNetworkClientsRequestPoliciesBySsid();
  });
  ...
  describe('ProvisionNetworkClientsRequestPoliciesBySsid', function() {
    it('should create an instance of ProvisionNetworkClientsRequestPoliciesBySsid', function() {
      // uncomment below and update the code to test ProvisionNetworkClientsRequestPoliciesBySsid
      //var instance = new MerakiDashboardApi.ProvisionNetworkClientsRequestPoliciesBySsid();
      //expect(instance).to.be.a(MerakiDashboardApi.ProvisionNetworkClientsRequestPoliciesBySsid);
    });
