...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MerakiDashboardApi.GetDeviceSwitchPorts200ResponseInner();
  });
  ...
  describe('GetDeviceSwitchPorts200ResponseInner', function() {
    it('should create an instance of GetDeviceSwitchPorts200ResponseInner', function() {
      // uncomment below and update the code to test GetDeviceSwitchPorts200ResponseInner
      //var instance = new MerakiDashboardApi.GetDeviceSwitchPorts200ResponseInner();
      //expect(instance).to.be.a(MerakiDashboardApi.GetDeviceSwitchPorts200ResponseInner);
    });
    ...
    it('should have the property adaptivePolicyGroupId (base name: "adaptivePolicyGroupId")', function() {
      // uncomment below and update the code to test the property adaptivePolicyGroupId
      //var instance = new MerakiDashboardApi.GetDeviceSwitchPorts200ResponseInner();
      //expect(instance).to.be();
    });
    ...
    it('should have the property peerSgtCapable (base name: "peerSgtCapable")', function() {
      // uncomment below and update the code to test the property peerSgtCapable
      //var instance = new MerakiDashboardApi.GetDeviceSwitchPorts200ResponseInner();
      //expect(instance).to.be();
    });
