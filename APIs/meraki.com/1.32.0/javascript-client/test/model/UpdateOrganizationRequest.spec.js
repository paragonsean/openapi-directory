...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MerakiDashboardApi.UpdateOrganizationRequest();
  });
  ...
  describe('UpdateOrganizationRequest', function() {
    it('should create an instance of UpdateOrganizationRequest', function() {
      ...
      //var instance = new MerakiDashboardApi.UpdateOrganizationRequest();
      //expect(instance).to.be.a(MerakiDashboardApi.UpdateOrganizationRequest);
    });
