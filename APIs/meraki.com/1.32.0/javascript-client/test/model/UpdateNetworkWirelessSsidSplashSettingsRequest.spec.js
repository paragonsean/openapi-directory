...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MerakiDashboardApi.UpdateNetworkWirelessSsidSplashSettingsRequest();
  });
  ...
  describe('UpdateNetworkWirelessSsidSplashSettingsRequest', function() {
    it('should create an instance of UpdateNetworkWirelessSsidSplashSettingsRequest', function() {
      // uncomment below and update the code to test UpdateNetworkWirelessSsidSplashSettingsRequest
      //var instance = new MerakiDashboardApi.UpdateNetworkWirelessSsidSplashSettingsRequest();
      //expect(instance).to.be.a(MerakiDashboardApi.UpdateNetworkWirelessSsidSplashSettingsRequest);
    });
