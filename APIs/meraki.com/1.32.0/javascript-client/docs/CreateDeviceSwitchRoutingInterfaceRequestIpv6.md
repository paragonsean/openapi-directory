# MerakiDashboardApi.CreateDeviceSwitchRoutingInterfaceRequestIpv6
...
**gateway** | **String** | The IPv6 default gateway of the interface. Required if prefix is defined and this is the first           interface with IPv6 configured for the switch. | [optional] 
