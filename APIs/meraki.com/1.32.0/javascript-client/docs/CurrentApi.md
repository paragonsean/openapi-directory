...
let apiInstance = new MerakiDashboardApi.CurrentApi();
let networkId = "networkId_example"; // String | 
apiInstance.getNetworkSensorAlertsCurrentOverviewByMetric_2(networkId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
