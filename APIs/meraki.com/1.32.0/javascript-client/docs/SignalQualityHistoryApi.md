...
> [GetNetworkWirelessSignalQualityHistory200ResponseInner] getNetworkWirelessSignalQualityHistory_1(networkId, opts)
...
apiInstance.getNetworkWirelessSignalQualityHistory_1(networkId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
