# MerakiDashboardApi.GetNetworkAppliancePrefixesDelegatedStatics200ResponseInner

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**createdAt** | **Date** | Prefix creation time. | [optional] 
...
**staticDelegatedPrefixId** | **String** | Static delegated prefix id. | [optional] 
**updatedAt** | **Date** | Prefix Updated time. | [optional] 
