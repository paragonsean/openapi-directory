...
apiInstance.createOrganizationAdmin_1(organizationId, createOrganizationAdminRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
apiInstance.deleteOrganizationAdmin_1(organizationId, adminId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> [Object] getOrganizationAdmins_1(organizationId)
...
let apiInstance = new MerakiDashboardApi.AdminsApi();
let organizationId = "organizationId_example"; // String | 
apiInstance.getOrganizationAdmins_1(organizationId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Object updateOrganizationAdmin_1(organizationId, adminId, opts)
...
apiInstance.updateOrganizationAdmin_1(organizationId, adminId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
