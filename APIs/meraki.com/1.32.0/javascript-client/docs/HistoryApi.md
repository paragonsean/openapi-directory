...
> [Object] getDeviceCameraAnalyticsZoneHistory_3(serial, zoneId, opts)
...
apiInstance.getDeviceCameraAnalyticsZoneHistory_3(serial, zoneId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> [GetNetworkAlertsHistory200ResponseInner] getNetworkAlertsHistory_2(networkId, opts)
...
apiInstance.getNetworkAlertsHistory_2(networkId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [GetOrganizationSensorReadingsHistory200ResponseInner] getOrganizationSensorReadingsHistory_2(organizationId, opts)
...
apiInstance.getOrganizationSensorReadingsHistory_2(organizationId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
