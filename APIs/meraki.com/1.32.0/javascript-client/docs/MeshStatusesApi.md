...
> Object getNetworkWirelessMeshStatuses_1(networkId, opts)
...
let apiInstance = new MerakiDashboardApi.MeshStatusesApi();
...
apiInstance.getNetworkWirelessMeshStatuses_1(networkId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
