# MerakiDashboardApi.GetNetworkSmDeviceNetworkAdapters200ResponseInner

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**dhcpServer** | **String** | The IP address of the DCHP Server. | [optional] 
**dnsServer** | **String** | The IP address of the DNS Server. | [optional] 
