...
> [GetOrganizationSummaryTopSwitchesByEnergyUsage200ResponseInner] getOrganizationSummaryTopSwitchesByEnergyUsage_3(organizationId, opts)
...
let apiInstance = new MerakiDashboardApi.SwitchesApi();
...
apiInstance.getOrganizationSummaryTopSwitchesByEnergyUsage_3(organizationId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
