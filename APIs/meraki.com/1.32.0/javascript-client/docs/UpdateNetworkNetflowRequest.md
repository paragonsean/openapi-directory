# MerakiDashboardApi.UpdateNetworkNetflowRequest
...
**etaDstPort** | **Number** | The port that the Encrypted Traffic Analytics collector will be listening on. | [optional] 
**etaEnabled** | **Boolean** | Boolean indicating whether Encrypted Traffic Analytics is enabled (true) or disabled (false). | [optional] 
