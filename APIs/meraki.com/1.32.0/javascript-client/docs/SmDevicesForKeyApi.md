# MerakiDashboardApi.SmDevicesForKeyApi
...
> Object getNetworkPiiSmDevicesForKey_2(networkId, opts)
...
apiInstance.getNetworkPiiSmDevicesForKey_2(networkId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
