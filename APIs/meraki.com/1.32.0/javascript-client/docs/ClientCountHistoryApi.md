...
> [GetNetworkWirelessClientCountHistory200ResponseInner] getNetworkWirelessClientCountHistory_1(networkId, opts)
...
apiInstance.getNetworkWirelessClientCountHistory_1(networkId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
