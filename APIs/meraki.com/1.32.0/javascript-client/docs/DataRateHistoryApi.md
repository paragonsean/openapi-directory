# MerakiDashboardApi.DataRateHistoryApi
...
> [GetNetworkWirelessDataRateHistory200ResponseInner] getNetworkWirelessDataRateHistory_1(networkId, opts)
...
apiInstance.getNetworkWirelessDataRateHistory_1(networkId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
