# MerakiDashboardApi.PowerModulesApi
...
> [GetOrganizationDevicesPowerModulesStatusesByDevice200ResponseInner] getOrganizationDevicesPowerModulesStatusesByDevice_2(organizationId, opts)
...
let apiInstance = new MerakiDashboardApi.PowerModulesApi();
...
apiInstance.getOrganizationDevicesPowerModulesStatusesByDevice_2(organizationId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
