# MerakiDashboardApi.UsageHistoriesApi

All URIs are relative to *https://api.meraki.com/api/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**getNetworkClientsUsageHistories_2**](UsageHistoriesApi.md#getNetworkClientsUsageHistories_2) | **GET** /networks/{networkId}/clients/usageHistories | Return the usage histories for clients



## getNetworkClientsUsageHistories_2

> [Object] getNetworkClientsUsageHistories_2(networkId, clients, opts)
...
let apiInstance = new MerakiDashboardApi.UsageHistoriesApi();
...
apiInstance.getNetworkClientsUsageHistories_2(networkId, clients, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
