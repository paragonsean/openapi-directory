# MerakiDashboardApi.ChannelUtilizationApi

All URIs are relative to *https://api.meraki.com/api/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**getNetworkNetworkHealthChannelUtilization_2**](ChannelUtilizationApi.md#getNetworkNetworkHealthChannelUtilization_2) | **GET** /networks/{networkId}/networkHealth/channelUtilization | Get the channel utilization over each radio for all APs in a network.



## getNetworkNetworkHealthChannelUtilization_2

> [Object] getNetworkNetworkHealthChannelUtilization_2(networkId, opts)
...
apiInstance.getNetworkNetworkHealthChannelUtilization_2(networkId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
