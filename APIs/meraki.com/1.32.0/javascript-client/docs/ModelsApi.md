...
> [GetOrganizationSummaryTopDevicesModelsByUsage200ResponseInner] getOrganizationSummaryTopDevicesModelsByUsage_4(organizationId, opts)
...
let apiInstance = new MerakiDashboardApi.ModelsApi();
...
apiInstance.getOrganizationSummaryTopDevicesModelsByUsage_4(organizationId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
