# MerakiDashboardApi.DelegatedApi
...
let apiInstance = new MerakiDashboardApi.DelegatedApi();
...
apiInstance.createNetworkAppliancePrefixesDelegatedStatic_2(networkId, createNetworkAppliancePrefixesDelegatedStaticRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
apiInstance.deleteNetworkAppliancePrefixesDelegatedStatic_2(networkId, staticDelegatedPrefixId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> [Object] getDeviceAppliancePrefixesDelegatedVlanAssignments_2(serial)
...
apiInstance.getDeviceAppliancePrefixesDelegatedVlanAssignments_2(serial, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [Object] getDeviceAppliancePrefixesDelegated_2(serial)
...
let apiInstance = new MerakiDashboardApi.DelegatedApi();
let serial = "serial_example"; // String | 
apiInstance.getDeviceAppliancePrefixesDelegated_2(serial, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let networkId = "networkId_example"; // String | 
let staticDelegatedPrefixId = "staticDelegatedPrefixId_example"; // String | 
apiInstance.getNetworkAppliancePrefixesDelegatedStatic_2(networkId, staticDelegatedPrefixId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [GetNetworkAppliancePrefixesDelegatedStatics200ResponseInner] getNetworkAppliancePrefixesDelegatedStatics_2(networkId)
...
let apiInstance = new MerakiDashboardApi.DelegatedApi();
let networkId = "networkId_example"; // String | 
apiInstance.getNetworkAppliancePrefixesDelegatedStatics_2(networkId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Object updateNetworkAppliancePrefixesDelegatedStatic_2(networkId, staticDelegatedPrefixId, opts)
...
apiInstance.updateNetworkAppliancePrefixesDelegatedStatic_2(networkId, staticDelegatedPrefixId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
