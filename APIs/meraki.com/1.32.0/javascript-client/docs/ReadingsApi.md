# MerakiDashboardApi.ReadingsApi
...
> [GetOrganizationSensorReadingsHistory200ResponseInner] getOrganizationSensorReadingsHistory_1(organizationId, opts)
...
let apiInstance = new MerakiDashboardApi.ReadingsApi();
...
apiInstance.getOrganizationSensorReadingsHistory_1(organizationId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> [GetOrganizationSensorReadingsLatest200ResponseInner] getOrganizationSensorReadingsLatest_1(organizationId, opts)
...
apiInstance.getOrganizationSensorReadingsLatest_1(organizationId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
