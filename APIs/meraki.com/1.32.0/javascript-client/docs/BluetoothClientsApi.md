...
> Object getNetworkBluetoothClient_1(networkId, bluetoothClientId, opts)
...
apiInstance.getNetworkBluetoothClient_1(networkId, bluetoothClientId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> [Object] getNetworkBluetoothClients_1(networkId, opts)
...
apiInstance.getNetworkBluetoothClients_1(networkId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
