# MerakiDashboardApi.PerformanceHistoryApi
...
> [GetNetworkSmDevicePerformanceHistory200ResponseInner] getNetworkSmDevicePerformanceHistory_2(networkId, deviceId, opts)
...
let apiInstance = new MerakiDashboardApi.PerformanceHistoryApi();
...
apiInstance.getNetworkSmDevicePerformanceHistory_2(networkId, deviceId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
