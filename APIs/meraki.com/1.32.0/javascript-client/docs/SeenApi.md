# MerakiDashboardApi.SeenApi

All URIs are relative to *https://api.meraki.com/api/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**getNetworkSwitchDhcpV4ServersSeen_4**](SeenApi.md#getNetworkSwitchDhcpV4ServersSeen_4) | **GET** /networks/{networkId}/switch/dhcp/v4/servers/seen | Return the network&#39;s DHCPv4 servers seen within the selected timeframe (default 1 day)



## getNetworkSwitchDhcpV4ServersSeen_4

> [GetNetworkSwitchDhcpV4ServersSeen200ResponseInner] getNetworkSwitchDhcpV4ServersSeen_4(networkId, opts)
...
let apiInstance = new MerakiDashboardApi.SeenApi();
...
apiInstance.getNetworkSwitchDhcpV4ServersSeen_4(networkId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
