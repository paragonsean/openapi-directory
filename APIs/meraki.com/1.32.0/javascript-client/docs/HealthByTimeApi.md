# MerakiDashboardApi.HealthByTimeApi
...
> [GetNetworkInsightApplicationHealthByTime200ResponseInner] getNetworkInsightApplicationHealthByTime_2(networkId, applicationId, opts)
...
let apiInstance = new MerakiDashboardApi.HealthByTimeApi();
...
apiInstance.getNetworkInsightApplicationHealthByTime_2(networkId, applicationId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
