# MerakiDashboardApi.ByClientApi

All URIs are relative to *https://api.meraki.com/api/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**getNetworkPoliciesByClient_2**](ByClientApi.md#getNetworkPoliciesByClient_2) | **GET** /networks/{networkId}/policies/byClient | Get policies for all clients with policies



## getNetworkPoliciesByClient_2

> [GetNetworkPoliciesByClient200ResponseInner] getNetworkPoliciesByClient_2(networkId, opts)
...
let apiInstance = new MerakiDashboardApi.ByClientApi();
...
apiInstance.getNetworkPoliciesByClient_2(networkId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
