# MerakiDashboardApi.GetOrganizationLicenses200ResponseInner
...
**durationInDays** | **Number** | The duration of the individual license | [optional] 
...
* `recentlyQueued` (value: `"recentlyQueued"`)

* `unused` (value: `"unused"`)

* `unusedActive` (value: `"unusedActive"`)
