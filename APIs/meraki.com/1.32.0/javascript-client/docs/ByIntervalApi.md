...
------------- | ------------- | -------------
[**getOrganizationApiRequestsOverviewResponseCodesByInterval_4**](ByIntervalApi.md#getOrganizationApiRequestsOverviewResponseCodesByInterval_4) | **GET** /organizations/{organizationId}/apiRequests/overview/responseCodes/byInterval | Tracks organizations&#39; API requests by response code across a given time period



## getOrganizationApiRequestsOverviewResponseCodesByInterval_4

> [GetOrganizationApiRequestsOverviewResponseCodesByInterval200ResponseInner] getOrganizationApiRequestsOverviewResponseCodesByInterval_4(organizationId, opts)
...
let apiInstance = new MerakiDashboardApi.ByIntervalApi();
...
apiInstance.getOrganizationApiRequestsOverviewResponseCodesByInterval_4(organizationId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
