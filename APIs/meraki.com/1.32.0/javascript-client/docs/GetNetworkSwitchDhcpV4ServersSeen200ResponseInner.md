# MerakiDashboardApi.GetNetworkSwitchDhcpV4ServersSeen200ResponseInner
...
**lastSeenAt** | **Date** | Last time the server was seen. | [optional] 
**mac** | **String** | Mac address of the server. | [optional] 
**seenBy** | [**[GetNetworkSwitchDhcpV4ServersSeen200ResponseInnerSeenByInner]**](GetNetworkSwitchDhcpV4ServersSeen200ResponseInnerSeenByInner.md) | Devices that saw the server. | [optional] 
**type** | **String** | server type. Can be a &#39;device&#39;, &#39;stack&#39;, or &#39;discovered&#39; (i.e client). | [optional] 
**vlan** | **Number** | Vlan id of the server. | [optional] 
