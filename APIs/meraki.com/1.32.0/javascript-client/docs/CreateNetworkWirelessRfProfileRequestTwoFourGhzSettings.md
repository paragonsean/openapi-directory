# MerakiDashboardApi.CreateNetworkWirelessRfProfileRequestTwoFourGhzSettings
...
**maxPower** | **Number** | Sets max power (dBm) of 2.4Ghz band. Can be integer between 2 and 30. Defaults to 30. | [optional] 
...
**minPower** | **Number** | Sets min power (dBm) of 2.4Ghz band. Can be integer between 2 and 30. Defaults to 5. | [optional] 
