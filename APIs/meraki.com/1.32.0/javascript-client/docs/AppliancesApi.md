# MerakiDashboardApi.AppliancesApi

All URIs are relative to *https://api.meraki.com/api/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**getOrganizationSummaryTopAppliancesByUtilization_3**](AppliancesApi.md#getOrganizationSummaryTopAppliancesByUtilization_3) | **GET** /organizations/{organizationId}/summary/top/appliances/byUtilization | Return the top 10 appliances sorted by utilization over given time range.



## getOrganizationSummaryTopAppliancesByUtilization_3

> [GetOrganizationSummaryTopAppliancesByUtilization200ResponseInner] getOrganizationSummaryTopAppliancesByUtilization_3(organizationId, opts)
...
let apiInstance = new MerakiDashboardApi.AppliancesApi();
...
apiInstance.getOrganizationSummaryTopAppliancesByUtilization_3(organizationId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
