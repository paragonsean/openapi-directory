# MerakiDashboardApi.GetDeviceSwitchPortsStatuses200ResponseInnerCdp
...
**nativeVlan** | **Number** | Indicates, per interface, the assumed VLAN for untagged packets on the interface. | [optional] 
