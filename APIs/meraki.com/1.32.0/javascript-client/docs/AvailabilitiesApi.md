# MerakiDashboardApi.AvailabilitiesApi

All URIs are relative to *https://api.meraki.com/api/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**getOrganizationDevicesAvailabilities_2**](AvailabilitiesApi.md#getOrganizationDevicesAvailabilities_2) | **GET** /organizations/{organizationId}/devices/availabilities | List the availability information for devices in an organization



## getOrganizationDevicesAvailabilities_2

> [GetOrganizationDevicesAvailabilities200ResponseInner] getOrganizationDevicesAvailabilities_2(organizationId, opts)
...
let apiInstance = new MerakiDashboardApi.AvailabilitiesApi();
...
apiInstance.getOrganizationDevicesAvailabilities_2(organizationId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
