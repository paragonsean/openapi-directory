...
> [Object] getNetworkWirelessClientLatencyHistory_2(networkId, clientId, opts)
...
let apiInstance = new MerakiDashboardApi.LatencyHistoryApi();
...
apiInstance.getNetworkWirelessClientLatencyHistory_2(networkId, clientId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> [GetNetworkWirelessLatencyHistory200ResponseInner] getNetworkWirelessLatencyHistory_1(networkId, opts)
...
apiInstance.getNetworkWirelessLatencyHistory_1(networkId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
