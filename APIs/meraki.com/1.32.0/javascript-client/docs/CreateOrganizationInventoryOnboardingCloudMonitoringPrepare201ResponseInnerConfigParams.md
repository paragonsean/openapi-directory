# MerakiDashboardApi.CreateOrganizationInventoryOnboardingCloudMonitoringPrepare201ResponseInnerConfigParams

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**cloudStaticIp** | **String** | Static IP Address used to connect to the device | [optional] 
