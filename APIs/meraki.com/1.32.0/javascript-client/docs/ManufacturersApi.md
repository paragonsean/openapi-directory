# MerakiDashboardApi.ManufacturersApi
...
> [GetOrganizationSummaryTopClientsManufacturersByUsage200ResponseInner] getOrganizationSummaryTopClientsManufacturersByUsage_4(organizationId, opts)
...
let apiInstance = new MerakiDashboardApi.ManufacturersApi();
...
apiInstance.getOrganizationSummaryTopClientsManufacturersByUsage_4(organizationId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
