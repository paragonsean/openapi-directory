...
> [GetNetworkSwitchDhcpV4ServersSeen200ResponseInner] getNetworkSwitchDhcpV4ServersSeen_2(networkId, opts)
...
let apiInstance = new MerakiDashboardApi.V4Api();
...
apiInstance.getNetworkSwitchDhcpV4ServersSeen_2(networkId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
