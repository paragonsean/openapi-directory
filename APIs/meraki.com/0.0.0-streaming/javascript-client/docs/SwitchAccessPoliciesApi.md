# MerakiDashboardApi.SwitchAccessPoliciesApi
...
> [Object] getNetworkAccessPolicies(networkId)
...
let apiInstance = new MerakiDashboardApi.SwitchAccessPoliciesApi();
let networkId = "networkId_example"; // String | 
apiInstance.getNetworkAccessPolicies(networkId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
