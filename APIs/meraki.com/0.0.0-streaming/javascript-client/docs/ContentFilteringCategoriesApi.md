# MerakiDashboardApi.ContentFilteringCategoriesApi
...
let apiInstance = new MerakiDashboardApi.ContentFilteringCategoriesApi();
let networkId = "networkId_example"; // String | 
apiInstance.getNetworkContentFilteringCategories(networkId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
