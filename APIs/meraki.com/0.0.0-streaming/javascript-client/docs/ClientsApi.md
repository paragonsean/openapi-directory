...
> [Object] getNetworkClientEvents(networkId, clientId, opts)
...
apiInstance.getNetworkClientEvents(networkId, clientId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [Object] getNetworkClientLatencyHistory(networkId, clientId, opts)
...
apiInstance.getNetworkClientLatencyHistory(networkId, clientId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
