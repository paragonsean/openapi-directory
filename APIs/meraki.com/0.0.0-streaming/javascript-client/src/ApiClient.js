...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.meraki.com/api/v0') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
        ...
        this.authentications = {
            'meraki_api_key': {type: 'apiKey', 'in': 'header', name: 'X-Cisco-Meraki-API-Key'}
        }
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/0.0.0-streaming/Javascript'
        };
