...
*/
export default class APIUsageApi {
    ...
    */
     ...
     * @callback module:api/APIUsageApi~getOrganizationApiRequestsCallback
     ...
     * @param {module:api/APIUsageApi~getOrganizationApiRequestsCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/APIUsageApi~getOrganizationApiRequestsOverviewCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} [t1] The end of the timespan for the data. t1 can be a maximum of 31 days after t0.
     * @param {Number} [timespan] The timespan for which the information will be fetched. If specifying timespan, do not specify parameters t0 and t1. The value must be in seconds and be less than or equal to 31 days. The default is 31 days.
     * @param {module:api/APIUsageApi~getOrganizationApiRequestsOverviewCallback} callback The callback function, accepting three arguments: error, data, response
