...
import UpdateNetworkApplianceFirewallInboundFirewallRulesRequestRulesInner from './UpdateNetworkApplianceFirewallInboundFirewallRulesRequestRulesInner';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('rules')) {
                obj['rules'] = ApiClient.convertToType(data['rules'], [UpdateNetworkApplianceFirewallInboundFirewallRulesRequestRulesInner]);
            }
    ...
    static validateJSON(data) {
        if (data['rules']) { // data not null
            ...
            for (const item of data['rules']) {
                UpdateNetworkApplianceFirewallInboundFirewallRulesRequestRulesInner.validateJSON(item);
            };
        }
 ...
 * @member {Array.<module:model/UpdateNetworkApplianceFirewallInboundFirewallRulesRequestRulesInner>} rules
 */
