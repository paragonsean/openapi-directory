...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MerakiDashboardApi.UpdateDeviceCellularGatewaySettingsPortForwardingRulesRequestRulesInner();
  });
  ...
  describe('UpdateDeviceCellularGatewaySettingsPortForwardingRulesRequestRulesInner', function() {
    it('should create an instance of UpdateDeviceCellularGatewaySettingsPortForwardingRulesRequestRulesInner', function() {
      // uncomment below and update the code to test UpdateDeviceCellularGatewaySettingsPortForwardingRulesRequestRulesInner
      //var instance = new MerakiDashboardApi.UpdateDeviceCellularGatewaySettingsPortForwardingRulesRequestRulesInner();
      //expect(instance).to.be.a(MerakiDashboardApi.UpdateDeviceCellularGatewaySettingsPortForwardingRulesRequestRulesInner);
    });
