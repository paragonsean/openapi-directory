...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MerakiDashboardApi.UpdateNetworkStaticRouteRequest();
  });
  ...
  describe('UpdateNetworkStaticRouteRequest', function() {
    it('should create an instance of UpdateNetworkStaticRouteRequest', function() {
      // uncomment below and update the code to test UpdateNetworkStaticRouteRequest
      //var instance = new MerakiDashboardApi.UpdateNetworkStaticRouteRequest();
      //expect(instance).to.be.a(MerakiDashboardApi.UpdateNetworkStaticRouteRequest);
    });
