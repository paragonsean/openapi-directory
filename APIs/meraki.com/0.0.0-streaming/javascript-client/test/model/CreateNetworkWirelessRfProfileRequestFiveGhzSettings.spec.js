...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MerakiDashboardApi.CreateNetworkWirelessRfProfileRequestFiveGhzSettings();
  });
  ...
  describe('CreateNetworkWirelessRfProfileRequestFiveGhzSettings', function() {
    it('should create an instance of CreateNetworkWirelessRfProfileRequestFiveGhzSettings', function() {
      // uncomment below and update the code to test CreateNetworkWirelessRfProfileRequestFiveGhzSettings
      //var instance = new MerakiDashboardApi.CreateNetworkWirelessRfProfileRequestFiveGhzSettings();
      //expect(instance).to.be.a(MerakiDashboardApi.CreateNetworkWirelessRfProfileRequestFiveGhzSettings);
    });
