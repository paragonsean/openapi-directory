...
Q_SIGNALS:
    ...
    void getNetworkEventsSignal(OAIObject summary);
    void getNetworkEventsEventTypesSignal(QList<OAIObject> summary);


    void getNetworkEventsSignalFull(OAIHttpRequestWorker *worker, OAIObject summary);
    void getNetworkEventsEventTypesSignalFull(OAIHttpRequestWorker *worker, QList<OAIObject> summary);

    Q_DECL_DEPRECATED_X("Use getNetworkEventsSignalError() instead")
    void getNetworkEventsSignalE(OAIObject summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getNetworkEventsSignalError(OAIObject summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getNetworkEventsEventTypesSignalError() instead")
    void getNetworkEventsEventTypesSignalE(QList<OAIObject> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getNetworkEventsEventTypesSignalError(QList<OAIObject> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
