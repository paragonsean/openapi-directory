...
/*
 * OAIUpdateNetworkWirelessRfProfile_request_fiveGhzSettings.h
 *
 * Settings related to 5Ghz band
 */

#ifndef OAIUpdateNetworkWirelessRfProfile_request_fiveGhzSettings_H
#define OAIUpdateNetworkWirelessRfProfile_request_fiveGhzSettings_H
...
class OAIUpdateNetworkWirelessRfProfile_request_fiveGhzSettings : public OAIObject {
public:
    OAIUpdateNetworkWirelessRfProfile_request_fiveGhzSettings();
    OAIUpdateNetworkWirelessRfProfile_request_fiveGhzSettings(QString json);
    ~OAIUpdateNetworkWirelessRfProfile_request_fiveGhzSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateNetworkWirelessRfProfile_request_fiveGhzSettings)

#endif // OAIUpdateNetworkWirelessRfProfile_request_fiveGhzSettings_H
