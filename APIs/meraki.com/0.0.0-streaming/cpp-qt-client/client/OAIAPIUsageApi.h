...
#ifndef OAI_OAIAPIUsageApi_H
#define OAI_OAIAPIUsageApi_H
...
class OAIAPIUsageApi : public QObject {
    Q_OBJECT

public:
    OAIAPIUsageApi(const int timeOut = 0);
    ~OAIAPIUsageApi();
...
Q_SIGNALS:
    ...
    void getOrganizationApiRequestsSignal(QList<OAIObject> summary);
    void getOrganizationApiRequestsOverviewSignal(OAIObject summary);


    void getOrganizationApiRequestsSignalFull(OAIHttpRequestWorker *worker, QList<OAIObject> summary);
    ...
    void getOrganizationApiRequestsSignalE(QList<OAIObject> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getOrganizationApiRequestsSignalError(QList<OAIObject> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
