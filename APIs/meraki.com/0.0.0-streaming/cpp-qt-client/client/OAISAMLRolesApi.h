...
Q_SIGNALS:
    ...
    void updateOrganizationSamlRoleSignal(OAIObject summary);
    ...
    void updateOrganizationSamlRoleSignalFull(OAIHttpRequestWorker *worker, OAIObject summary);
    ...
    void updateOrganizationSamlRoleSignalE(OAIObject summary, QNetworkReply::NetworkError error_type, QString error_str);
    void updateOrganizationSamlRoleSignalError(OAIObject summary, QNetworkReply::NetworkError error_type, const QString &error_str);
