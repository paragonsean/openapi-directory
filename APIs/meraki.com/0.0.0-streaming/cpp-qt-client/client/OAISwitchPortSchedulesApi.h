...
#ifndef OAI_OAISwitchPortSchedulesApi_H
#define OAI_OAISwitchPortSchedulesApi_H
...
class OAISwitchPortSchedulesApi : public QObject {
    Q_OBJECT

public:
    OAISwitchPortSchedulesApi(const int timeOut = 0);
    ~OAISwitchPortSchedulesApi();
