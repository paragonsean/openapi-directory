...
#ifndef OAI_OAIRadioSettingsApi_H
#define OAI_OAIRadioSettingsApi_H
...
class OAIRadioSettingsApi : public QObject {
    Q_OBJECT

public:
    OAIRadioSettingsApi(const int timeOut = 0);
    ~OAIRadioSettingsApi();
...
Q_SIGNALS:
    ...
    void createNetworkWirelessRfProfileSignal(OAIObject summary);
    ...
    void updateNetworkWirelessRfProfileSignal(OAIObject summary);


    void createNetworkWirelessRfProfileSignalFull(OAIHttpRequestWorker *worker, OAIObject summary);
    ...
    void updateNetworkWirelessRfProfileSignalFull(OAIHttpRequestWorker *worker, OAIObject summary);

    Q_DECL_DEPRECATED_X("Use createNetworkWirelessRfProfileSignalError() instead")
    void createNetworkWirelessRfProfileSignalE(OAIObject summary, QNetworkReply::NetworkError error_type, QString error_str);
    void createNetworkWirelessRfProfileSignalError(OAIObject summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void updateNetworkWirelessRfProfileSignalE(OAIObject summary, QNetworkReply::NetworkError error_type, QString error_str);
    void updateNetworkWirelessRfProfileSignalError(OAIObject summary, QNetworkReply::NetworkError error_type, const QString &error_str);
