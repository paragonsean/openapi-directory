...
/*
 * OAIUpdateDeviceCellularGatewaySettingsPortForwardingRules_request_rules_inner.h
 *
 * 
 */

#ifndef OAIUpdateDeviceCellularGatewaySettingsPortForwardingRules_request_rules_inner_H
#define OAIUpdateDeviceCellularGatewaySettingsPortForwardingRules_request_rules_inner_H
...
class OAIUpdateDeviceCellularGatewaySettingsPortForwardingRules_request_rules_inner : public OAIObject {
public:
    OAIUpdateDeviceCellularGatewaySettingsPortForwardingRules_request_rules_inner();
    OAIUpdateDeviceCellularGatewaySettingsPortForwardingRules_request_rules_inner(QString json);
    ~OAIUpdateDeviceCellularGatewaySettingsPortForwardingRules_request_rules_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateDeviceCellularGatewaySettingsPortForwardingRules_request_rules_inner)

#endif // OAIUpdateDeviceCellularGatewaySettingsPortForwardingRules_request_rules_inner_H
