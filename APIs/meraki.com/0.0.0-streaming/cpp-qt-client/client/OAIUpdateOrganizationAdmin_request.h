...
/*
 * OAIUpdateOrganizationAdmin_request.h
 *
 * 
 */

#ifndef OAIUpdateOrganizationAdmin_request_H
#define OAIUpdateOrganizationAdmin_request_H
...
class OAIUpdateOrganizationAdmin_request : public OAIObject {
public:
    OAIUpdateOrganizationAdmin_request();
    OAIUpdateOrganizationAdmin_request(QString json);
    ~OAIUpdateOrganizationAdmin_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateOrganizationAdmin_request)

#endif // OAIUpdateOrganizationAdmin_request_H
