...
/*
 * OAIUpdateOrganizationThirdPartyVPNPeers_request_peers_inner.h
 *
 * 
 */

#ifndef OAIUpdateOrganizationThirdPartyVPNPeers_request_peers_inner_H
#define OAIUpdateOrganizationThirdPartyVPNPeers_request_peers_inner_H
...
namespace OpenAPI {
class OAIUpdateOrganizationThirdPartyVPNPeers_request_peers_inner_ipsecPolicies;

class OAIUpdateOrganizationThirdPartyVPNPeers_request_peers_inner : public OAIObject {
public:
    OAIUpdateOrganizationThirdPartyVPNPeers_request_peers_inner();
    OAIUpdateOrganizationThirdPartyVPNPeers_request_peers_inner(QString json);
    ~OAIUpdateOrganizationThirdPartyVPNPeers_request_peers_inner() override;
    ...
    OAIUpdateOrganizationThirdPartyVPNPeers_request_peers_inner_ipsecPolicies getIpsecPolicies() const;
    void setIpsecPolicies(const OAIUpdateOrganizationThirdPartyVPNPeers_request_peers_inner_ipsecPolicies &ipsec_policies);
...
private:
    ...
    OAIUpdateOrganizationThirdPartyVPNPeers_request_peers_inner_ipsecPolicies m_ipsec_policies;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateOrganizationThirdPartyVPNPeers_request_peers_inner)

#endif // OAIUpdateOrganizationThirdPartyVPNPeers_request_peers_inner_H
