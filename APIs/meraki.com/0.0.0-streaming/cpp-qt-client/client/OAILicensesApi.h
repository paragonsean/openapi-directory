...
public:
    ...
    * @param[in]  organization_id QString [required]
    */
    virtual void getOrganizationLicenseState(const QString &organization_id);
...
private:
    ...
    void getOrganizationLicenseStateCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void assignOrganizationLicensesSeatsSignal(OAIObject summary);
    void getOrganizationLicenseSignal(OAIObject summary);
    void getOrganizationLicenseStateSignal(OAIObject summary);
    void getOrganizationLicensesSignal(QList<OAIObject> summary);
    void moveOrganizationLicensesSeatsSignal(OAIObject summary);
    void renewOrganizationLicensesSeatsSignal(OAIObject summary);


    void assignOrganizationLicensesSeatsSignalFull(OAIHttpRequestWorker *worker, OAIObject summary);
    void getOrganizationLicenseSignalFull(OAIHttpRequestWorker *worker, OAIObject summary);
    void getOrganizationLicenseStateSignalFull(OAIHttpRequestWorker *worker, OAIObject summary);
    void getOrganizationLicensesSignalFull(OAIHttpRequestWorker *worker, QList<OAIObject> summary);
    void moveOrganizationLicensesSeatsSignalFull(OAIHttpRequestWorker *worker, OAIObject summary);
    void renewOrganizationLicensesSeatsSignalFull(OAIHttpRequestWorker *worker, OAIObject summary);

    Q_DECL_DEPRECATED_X("Use assignOrganizationLicensesSeatsSignalError() instead")
    void assignOrganizationLicensesSeatsSignalE(OAIObject summary, QNetworkReply::NetworkError error_type, QString error_str);
    void assignOrganizationLicensesSeatsSignalError(OAIObject summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getOrganizationLicenseSignalError() instead")
    void getOrganizationLicenseSignalE(OAIObject summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getOrganizationLicenseSignalError(OAIObject summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getOrganizationLicenseStateSignalError() instead")
    void getOrganizationLicenseStateSignalE(OAIObject summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getOrganizationLicenseStateSignalError(OAIObject summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getOrganizationLicensesSignalError() instead")
    void getOrganizationLicensesSignalE(QList<OAIObject> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getOrganizationLicensesSignalError(QList<OAIObject> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use moveOrganizationLicensesSeatsSignalError() instead")
    void moveOrganizationLicensesSeatsSignalE(OAIObject summary, QNetworkReply::NetworkError error_type, QString error_str);
    void moveOrganizationLicensesSeatsSignalError(OAIObject summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use renewOrganizationLicensesSeatsSignalError() instead")
    void renewOrganizationLicensesSeatsSignalE(OAIObject summary, QNetworkReply::NetworkError error_type, QString error_str);
    void renewOrganizationLicensesSeatsSignalError(OAIObject summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use getOrganizationLicenseStateSignalErrorFull() instead")
    void getOrganizationLicenseStateSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getOrganizationLicenseStateSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
