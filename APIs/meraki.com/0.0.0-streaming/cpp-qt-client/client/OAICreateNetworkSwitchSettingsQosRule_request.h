...
/*
 * OAICreateNetworkSwitchSettingsQosRule_request.h
 *
 * 
 */

#ifndef OAICreateNetworkSwitchSettingsQosRule_request_H
#define OAICreateNetworkSwitchSettingsQosRule_request_H
...
class OAICreateNetworkSwitchSettingsQosRule_request : public OAIObject {
public:
    OAICreateNetworkSwitchSettingsQosRule_request();
    OAICreateNetworkSwitchSettingsQosRule_request(QString json);
    ~OAICreateNetworkSwitchSettingsQosRule_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateNetworkSwitchSettingsQosRule_request)

#endif // OAICreateNetworkSwitchSettingsQosRule_request_H
