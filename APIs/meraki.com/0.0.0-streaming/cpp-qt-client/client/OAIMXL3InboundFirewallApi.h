...
#ifndef OAI_OAIMXL3InboundFirewallApi_H
#define OAI_OAIMXL3InboundFirewallApi_H
...
class OAIMXL3InboundFirewallApi : public QObject {
    Q_OBJECT

public:
    OAIMXL3InboundFirewallApi(const int timeOut = 0);
    ~OAIMXL3InboundFirewallApi();
