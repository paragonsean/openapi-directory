...
QString OAIProvisionNetworkClients_request::getMac() const {
    return m_mac;
}
void OAIProvisionNetworkClients_request::setMac(const QString &mac) {
    m_mac = mac;
    m_mac_isSet = true;
}

bool OAIProvisionNetworkClients_request::is_mac_Set() const{
    return m_mac_isSet;
}

bool OAIProvisionNetworkClients_request::is_mac_Valid() const{
    return m_mac_isValid;
}

QString OAIProvisionNetworkClients_request::getName() const {
    return m_name;
}
void OAIProvisionNetworkClients_request::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIProvisionNetworkClients_request::is_name_Set() const{
    return m_name_isSet;
}

bool OAIProvisionNetworkClients_request::is_name_Valid() const{
...
bool OAIProvisionNetworkClients_request::isValid() const {
    ...
    return m_device_policy_isValid && m_mac_isValid && true;
}
