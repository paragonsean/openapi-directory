...
/*
 * OAICreateNetworkCameraQualityRetentionProfile_request.h
 *
 * 
 */

#ifndef OAICreateNetworkCameraQualityRetentionProfile_request_H
#define OAICreateNetworkCameraQualityRetentionProfile_request_H
...
class OAICreateNetworkCameraQualityRetentionProfile_request : public OAIObject {
public:
    OAICreateNetworkCameraQualityRetentionProfile_request();
    OAICreateNetworkCameraQualityRetentionProfile_request(QString json);
    ~OAICreateNetworkCameraQualityRetentionProfile_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateNetworkCameraQualityRetentionProfile_request)

#endif // OAICreateNetworkCameraQualityRetentionProfile_request_H
