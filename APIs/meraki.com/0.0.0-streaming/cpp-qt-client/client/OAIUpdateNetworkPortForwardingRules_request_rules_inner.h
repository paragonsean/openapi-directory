...
/*
 * OAIUpdateNetworkPortForwardingRules_request_rules_inner.h
 *
 * 
 */

#ifndef OAIUpdateNetworkPortForwardingRules_request_rules_inner_H
#define OAIUpdateNetworkPortForwardingRules_request_rules_inner_H
...
class OAIUpdateNetworkPortForwardingRules_request_rules_inner : public OAIObject {
public:
    OAIUpdateNetworkPortForwardingRules_request_rules_inner();
    OAIUpdateNetworkPortForwardingRules_request_rules_inner(QString json);
    ~OAIUpdateNetworkPortForwardingRules_request_rules_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateNetworkPortForwardingRules_request_rules_inner)

#endif // OAIUpdateNetworkPortForwardingRules_request_rules_inner_H
