...
#ifndef OAI_OAISyslogServersApi_H
#define OAI_OAISyslogServersApi_H
...
class OAISyslogServersApi : public QObject {
    Q_OBJECT

public:
    OAISyslogServersApi(const int timeOut = 0);
    ~OAISyslogServersApi();
...
Q_SIGNALS:
    ...
    void getNetworkSyslogServersSignal(QList<OAIObject> summary);
    void updateNetworkSyslogServersSignal(QList<OAIObject> summary);


    void getNetworkSyslogServersSignalFull(OAIHttpRequestWorker *worker, QList<OAIObject> summary);
    void updateNetworkSyslogServersSignalFull(OAIHttpRequestWorker *worker, QList<OAIObject> summary);

    Q_DECL_DEPRECATED_X("Use getNetworkSyslogServersSignalError() instead")
    void getNetworkSyslogServersSignalE(QList<OAIObject> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getNetworkSyslogServersSignalError(QList<OAIObject> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use updateNetworkSyslogServersSignalError() instead")
    void updateNetworkSyslogServersSignalE(QList<OAIObject> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void updateNetworkSyslogServersSignalError(QList<OAIObject> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
