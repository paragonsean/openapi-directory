...
/*
 * OAIUpdateNetworkDevice_request.h
 *
 * 
 */

#ifndef OAIUpdateNetworkDevice_request_H
#define OAIUpdateNetworkDevice_request_H
...
class OAIUpdateNetworkDevice_request : public OAIObject {
public:
    OAIUpdateNetworkDevice_request();
    OAIUpdateNetworkDevice_request(QString json);
    ~OAIUpdateNetworkDevice_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateNetworkDevice_request)

#endif // OAIUpdateNetworkDevice_request_H
