...
|------------- | ------------- | -------------|
| [**getOrganizationConfigurationChanges**](ChangeLogApi.md#getOrganizationConfigurationChanges) | **GET** /organizations/{organizationId}/configurationChanges | View the Change Log for your organization |
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling ChangeLogApi#getOrganizationConfigurationChanges");
