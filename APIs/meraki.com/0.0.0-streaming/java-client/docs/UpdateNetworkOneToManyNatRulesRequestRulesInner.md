...
|------------ | ------------- | ------------- | -------------|
|**portRules** | [**List&lt;UpdateNetworkOneToManyNatRulesRequestRulesInnerPortRulesInner&gt;**](UpdateNetworkOneToManyNatRulesRequestRulesInnerPortRulesInner.md) | An array of associated forwarding rules |  |
