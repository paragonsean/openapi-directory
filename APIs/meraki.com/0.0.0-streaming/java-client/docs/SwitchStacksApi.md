...
import org.openapitools.client.api.SwitchStacksApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    SwitchStacksApi apiInstance = new SwitchStacksApi(defaultClient);
    String networkId = "networkId_example"; // String | 
    try {
      List<Object> result = apiInstance.getNetworkSwitchStacks(networkId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling SwitchStacksApi#getNetworkSwitchStacks");
