...
public class ApiClient {
    ...
    private String basePath = "https://api.meraki.com/api/v0";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/0.0.0-streaming/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.meraki.com/api/v0
