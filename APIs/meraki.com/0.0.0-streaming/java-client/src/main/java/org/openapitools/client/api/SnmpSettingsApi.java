...
public class SnmpSettingsApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public SnmpSettingsApi() {
        this(Configuration.getDefaultApiClient());
    }

    public SnmpSettingsApi(ApiClient apiClient) {
    ...
    /**
     * Build call for getNetworkSnmpSettings
     ...
     */
    public okhttp3.Call getNetworkSnmpSettingsCall(String networkId, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/networks/{networkId}/snmpSettings"
    ...
    private okhttp3.Call getNetworkSnmpSettingsValidateBeforeCall(String networkId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'networkId' is set
        if (networkId == null) {
            throw new ApiException("Missing the required parameter 'networkId' when calling getNetworkSnmpSettings(Async)");
        }

        return getNetworkSnmpSettingsCall(networkId, _callback);
     ...
     */
    public Object getNetworkSnmpSettings(String networkId) throws ApiException {
        ApiResponse<Object> localVarResp = getNetworkSnmpSettingsWithHttpInfo(networkId);
     ...
     */
    public ApiResponse<Object> getNetworkSnmpSettingsWithHttpInfo(String networkId) throws ApiException {
        okhttp3.Call localVarCall = getNetworkSnmpSettingsValidateBeforeCall(networkId, null);
     ...
     */
    public okhttp3.Call getNetworkSnmpSettingsAsync(String networkId, final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = getNetworkSnmpSettingsValidateBeforeCall(networkId, _callback);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
