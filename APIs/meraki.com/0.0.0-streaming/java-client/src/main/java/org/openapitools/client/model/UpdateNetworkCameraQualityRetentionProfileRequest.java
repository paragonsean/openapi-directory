...
public class UpdateNetworkCameraQualityRetentionProfileRequest {
  ...
  public UpdateNetworkCameraQualityRetentionProfileRequest() {
  }

  public UpdateNetworkCameraQualityRetentionProfileRequest audioRecordingEnabled(Boolean audioRecordingEnabled) {
  ...
  public UpdateNetworkCameraQualityRetentionProfileRequest cloudArchiveEnabled(Boolean cloudArchiveEnabled) {
  ...
  public UpdateNetworkCameraQualityRetentionProfileRequest maxRetentionDays(Integer maxRetentionDays) {
  ...
  public UpdateNetworkCameraQualityRetentionProfileRequest motionBasedRetentionEnabled(Boolean motionBasedRetentionEnabled) {
  ...
  public UpdateNetworkCameraQualityRetentionProfileRequest motionDetectorVersion(Integer motionDetectorVersion) {
  ...
  public UpdateNetworkCameraQualityRetentionProfileRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateNetworkCameraQualityRetentionProfileRequest restrictedBandwidthModeEnabled(Boolean restrictedBandwidthModeEnabled) {
  ...
  public UpdateNetworkCameraQualityRetentionProfileRequest scheduleId(String scheduleId) {
  ...
  public UpdateNetworkCameraQualityRetentionProfileRequest videoSettings(CreateNetworkCameraQualityRetentionProfileRequestVideoSettings videoSettings) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateNetworkCameraQualityRetentionProfileRequest updateNetworkCameraQualityRetentionProfileRequest = (UpdateNetworkCameraQualityRetentionProfileRequest) o;
    return Objects.equals(this.audioRecordingEnabled, updateNetworkCameraQualityRetentionProfileRequest.audioRecordingEnabled) &&
        Objects.equals(this.cloudArchiveEnabled, updateNetworkCameraQualityRetentionProfileRequest.cloudArchiveEnabled) &&
        Objects.equals(this.maxRetentionDays, updateNetworkCameraQualityRetentionProfileRequest.maxRetentionDays) &&
        Objects.equals(this.motionBasedRetentionEnabled, updateNetworkCameraQualityRetentionProfileRequest.motionBasedRetentionEnabled) &&
        Objects.equals(this.motionDetectorVersion, updateNetworkCameraQualityRetentionProfileRequest.motionDetectorVersion) &&
        Objects.equals(this.name, updateNetworkCameraQualityRetentionProfileRequest.name) &&
        Objects.equals(this.restrictedBandwidthModeEnabled, updateNetworkCameraQualityRetentionProfileRequest.restrictedBandwidthModeEnabled) &&
        Objects.equals(this.scheduleId, updateNetworkCameraQualityRetentionProfileRequest.scheduleId) &&
        Objects.equals(this.videoSettings, updateNetworkCameraQualityRetentionProfileRequest.videoSettings);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateNetworkCameraQualityRetentionProfileRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateNetworkCameraQualityRetentionProfileRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateNetworkCameraQualityRetentionProfileRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateNetworkCameraQualityRetentionProfileRequest is not found in the empty JSON string", UpdateNetworkCameraQualityRetentionProfileRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateNetworkCameraQualityRetentionProfileRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateNetworkCameraQualityRetentionProfileRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateNetworkCameraQualityRetentionProfileRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateNetworkCameraQualityRetentionProfileRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateNetworkCameraQualityRetentionProfileRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateNetworkCameraQualityRetentionProfileRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateNetworkCameraQualityRetentionProfileRequest>() {
           @Override
           public void write(JsonWriter out, UpdateNetworkCameraQualityRetentionProfileRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateNetworkCameraQualityRetentionProfileRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateNetworkCameraQualityRetentionProfileRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateNetworkCameraQualityRetentionProfileRequest
   * @throws IOException if the JSON string is invalid with respect to UpdateNetworkCameraQualityRetentionProfileRequest
   */
  public static UpdateNetworkCameraQualityRetentionProfileRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateNetworkCameraQualityRetentionProfileRequest.class);
  }

  /**
   * Convert an instance of UpdateNetworkCameraQualityRetentionProfileRequest to an JSON string
   *
   * @return JSON string
   */
