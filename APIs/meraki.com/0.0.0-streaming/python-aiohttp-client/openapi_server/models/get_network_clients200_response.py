...
class GetNetworkClients200Response(Model):
    ...
    def __init__(self, description: str=None, first_seen: int=None, group_policy8021x: str=None, id: str=None, ip: str=None, ip6: str=None, ip6_local: str=None, last_seen: int=None, mac: str=None, manufacturer: str=None, notes: str=None, os: str=None, recent_device_mac: str=None, recent_device_name: str=None, recent_device_serial: str=None, sm_installed: bool=None, ssid: str=None, status: str=None, switchport: str=None, usage: GetNetworkClients200ResponseUsage=None, user: str=None, vlan: str=None):
