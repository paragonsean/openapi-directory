...
class UpdateNetworkContentFilteringRequest(Model):
    ...
    def __init__(self, allowed_url_patterns: List[str]=None, blocked_url_categories: List[str]=None, blocked_url_patterns: List[str]=None, url_category_list_size: str=None):
        """UpdateNetworkContentFilteringRequest - a model defined in OpenAPI

        :param allowed_url_patterns: The allowed_url_patterns of this UpdateNetworkContentFilteringRequest.
        :param blocked_url_categories: The blocked_url_categories of this UpdateNetworkContentFilteringRequest.
        :param blocked_url_patterns: The blocked_url_patterns of this UpdateNetworkContentFilteringRequest.
        :param url_category_list_size: The url_category_list_size of this UpdateNetworkContentFilteringRequest.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'UpdateNetworkContentFilteringRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The updateNetworkContentFiltering_request of this UpdateNetworkContentFilteringRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def allowed_url_patterns(self):
        """Gets the allowed_url_patterns of this UpdateNetworkContentFilteringRequest.

        A list of URL patterns that are allowed

        :return: The allowed_url_patterns of this UpdateNetworkContentFilteringRequest.
        :rtype: List[str]
        """
    ...
    def allowed_url_patterns(self, allowed_url_patterns):
        """Sets the allowed_url_patterns of this UpdateNetworkContentFilteringRequest.
    ...
    def blocked_url_categories(self):
        """Gets the blocked_url_categories of this UpdateNetworkContentFilteringRequest.

        A list of URL categories to block

        :return: The blocked_url_categories of this UpdateNetworkContentFilteringRequest.
        :rtype: List[str]
        """
    ...
    def blocked_url_categories(self, blocked_url_categories):
        """Sets the blocked_url_categories of this UpdateNetworkContentFilteringRequest.
    ...
    def blocked_url_patterns(self):
        """Gets the blocked_url_patterns of this UpdateNetworkContentFilteringRequest.

        A list of URL patterns that are blocked

        :return: The blocked_url_patterns of this UpdateNetworkContentFilteringRequest.
        :rtype: List[str]
        """
    ...
    def blocked_url_patterns(self, blocked_url_patterns):
        """Sets the blocked_url_patterns of this UpdateNetworkContentFilteringRequest.
    ...
    def url_category_list_size(self):
        """Gets the url_category_list_size of this UpdateNetworkContentFilteringRequest.

        URL category list size which is either 'topSites' or 'fullList'

        :return: The url_category_list_size of this UpdateNetworkContentFilteringRequest.
        :rtype: str
        """
    ...
    def url_category_list_size(self, url_category_list_size):
        """Sets the url_category_list_size of this UpdateNetworkContentFilteringRequest.
