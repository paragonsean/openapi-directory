...
class UpdateNetworkWirelessRfProfileRequest(Model):
    ...
    def __init__(self, ap_band_settings: UpdateNetworkWirelessRfProfileRequestApBandSettings=None, band_selection_type: str=None, client_balancing_enabled: bool=None, five_ghz_settings: UpdateNetworkWirelessRfProfileRequestFiveGhzSettings=None, min_bitrate_type: str=None, name: str=None, two_four_ghz_settings: UpdateNetworkWirelessRfProfileRequestTwoFourGhzSettings=None):
