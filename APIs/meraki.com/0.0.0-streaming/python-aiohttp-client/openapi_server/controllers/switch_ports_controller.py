...
async def get_device_switch_port_statuses(request: web.Request, serial, t0=None, timespan=None) -> web.Response:
...
async def get_device_switch_port_statuses_packets(request: web.Request, serial, t0=None, timespan=None) -> web.Response:
