...
(function(root, factory) {
  ...
  describe('Serie', function() {
    it('should create an instance of Serie', function() {
      // uncomment below and update the code to test Serie
      //var instance = new TcGdexApi.Serie();
      //expect(instance).to.be.a(TcGdexApi.Serie);
    });
