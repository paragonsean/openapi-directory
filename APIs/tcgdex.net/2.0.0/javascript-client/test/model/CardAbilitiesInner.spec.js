...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TcGdexApi.CardAbilitiesInner();
  });
  ...
  describe('CardAbilitiesInner', function() {
    it('should create an instance of CardAbilitiesInner', function() {
      // uncomment below and update the code to test CardAbilitiesInner
      //var instance = new TcGdexApi.CardAbilitiesInner();
      //expect(instance).to.be.a(TcGdexApi.CardAbilitiesInner);
    });
