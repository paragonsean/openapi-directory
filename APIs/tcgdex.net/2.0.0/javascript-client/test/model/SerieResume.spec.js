...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TcGdexApi.SerieResume();
  });
  ...
  describe('SerieResume', function() {
    it('should create an instance of SerieResume', function() {
      // uncomment below and update the code to test SerieResume
      //var instance = new TcGdexApi.SerieResume();
      //expect(instance).to.be.a(TcGdexApi.SerieResume);
    });
