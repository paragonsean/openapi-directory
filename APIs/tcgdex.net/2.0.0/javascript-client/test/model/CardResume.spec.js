...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TcGdexApi.CardResume();
  });
  ...
  describe('CardResume', function() {
    it('should create an instance of CardResume', function() {
      // uncomment below and update the code to test CardResume
      //var instance = new TcGdexApi.CardResume();
      //expect(instance).to.be.a(TcGdexApi.CardResume);
    });
