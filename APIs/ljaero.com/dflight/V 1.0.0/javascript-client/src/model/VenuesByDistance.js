...
/**
 * The VenuesByDistance model module.
 * @module model/VenuesByDistance
 * @version V 1.0.0
 */
class VenuesByDistance {
    /**
     * Constructs a new <code>VenuesByDistance</code>.
     * Geometry-defining arguments for point/distance requests
     * @alias module:model/VenuesByDistance
    ...
    constructor(distance, latitude, longitude) { 
        ...
        VenuesByDistance.initialize(this, distance, latitude, longitude);
    }
    ...
    /**
     * Constructs a <code>VenuesByDistance</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VenuesByDistance} obj Optional instance to populate.
     * @return {module:model/VenuesByDistance} The populated <code>VenuesByDistance</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VenuesByDistance();
    ...
    /**
     * Validates the JSON data with respect to <code>VenuesByDistance</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VenuesByDistance</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of VenuesByDistance.RequiredProperties) {
...
VenuesByDistance.RequiredProperties = ["distance", "latitude", "longitude"];

/**
 * @member {module:model/Distance} distance
 */
VenuesByDistance.prototype['distance'] = undefined;

/**
 * @member {module:model/Latitude} latitude
 */
VenuesByDistance.prototype['latitude'] = undefined;

/**
 * @member {module:model/Longitude} longitude
 */
VenuesByDistance.prototype['longitude'] = undefined;
...
export default VenuesByDistance;
