...
/**
 * The SSAByPolygon model module.
 * @module model/SSAByPolygon
 * @version V 1.0.0
 */
class SSAByPolygon {
    /**
     * Constructs a new <code>SSAByPolygon</code>.
     * Geometry-defining arguments for polygon requests
     * @alias module:model/SSAByPolygon
     * @param poly {Object} 
     */
    constructor(poly) { 
        
        SSAByPolygon.initialize(this, poly);
    }
    ...
    /**
     * Constructs a <code>SSAByPolygon</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SSAByPolygon} obj Optional instance to populate.
     * @return {module:model/SSAByPolygon} The populated <code>SSAByPolygon</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SSAByPolygon();
    ...
    /**
     * Validates the JSON data with respect to <code>SSAByPolygon</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SSAByPolygon</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SSAByPolygon.RequiredProperties) {
...
SSAByPolygon.RequiredProperties = ["poly"];

/**
 * @member {Object} poly
 */
SSAByPolygon.prototype['poly'] = undefined;
