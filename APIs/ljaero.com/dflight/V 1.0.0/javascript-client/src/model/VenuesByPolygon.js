...
/**
 * The VenuesByPolygon model module.
 * @module model/VenuesByPolygon
 * @version V 1.0.0
 */
class VenuesByPolygon {
    /**
     * Constructs a new <code>VenuesByPolygon</code>.
     * Geometry-defining arguments for polygon requests
     * @alias module:model/VenuesByPolygon
     * @param poly {Object} 
     */
    constructor(poly) { 
        
        VenuesByPolygon.initialize(this, poly);
    }
    ...
    /**
     * Constructs a <code>VenuesByPolygon</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VenuesByPolygon} obj Optional instance to populate.
     * @return {module:model/VenuesByPolygon} The populated <code>VenuesByPolygon</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VenuesByPolygon();
    ...
    /**
     * Validates the JSON data with respect to <code>VenuesByPolygon</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VenuesByPolygon</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of VenuesByPolygon.RequiredProperties) {
...
VenuesByPolygon.RequiredProperties = ["poly"];

/**
 * @member {Object} poly
 */
VenuesByPolygon.prototype['poly'] = undefined;
...
export default VenuesByPolygon;
