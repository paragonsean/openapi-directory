...
/**
 * The AerodromesByDistance model module.
 * @module model/AerodromesByDistance
 * @version V 1.0.0
 */
class AerodromesByDistance {
    /**
     * Constructs a new <code>AerodromesByDistance</code>.
     * Geometry-defining arguments for point/distance requests
     * @alias module:model/AerodromesByDistance
    ...
    constructor(distance, latitude, longitude) { 
        ...
        AerodromesByDistance.initialize(this, distance, latitude, longitude);
    }
    ...
    /**
     * Constructs a <code>AerodromesByDistance</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AerodromesByDistance} obj Optional instance to populate.
     * @return {module:model/AerodromesByDistance} The populated <code>AerodromesByDistance</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AerodromesByDistance();
    ...
    /**
     * Validates the JSON data with respect to <code>AerodromesByDistance</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AerodromesByDistance</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AerodromesByDistance.RequiredProperties) {
...
AerodromesByDistance.RequiredProperties = ["distance", "latitude", "longitude"];

/**
 * @member {module:model/Distance} distance
 */
AerodromesByDistance.prototype['distance'] = undefined;

/**
 * @member {module:model/Latitude} latitude
 */
AerodromesByDistance.prototype['latitude'] = undefined;

/**
 * @member {module:model/Longitude} longitude
 */
AerodromesByDistance.prototype['longitude'] = undefined;
...
export default AerodromesByDistance;
