...
/**
 * The AirspacePolyResponse model module.
 * @module model/AirspacePolyResponse
 * @version V 1.0.0
 */
class AirspacePolyResponse {
    /**
     * Constructs a new <code>AirspacePolyResponse</code>.
     * @alias module:model/AirspacePolyResponse
     * @param found {Array.<Object>} 
     */
    constructor(found) { 
        
        AirspacePolyResponse.initialize(this, found);
    }
    ...
    /**
     * Constructs a <code>AirspacePolyResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AirspacePolyResponse} obj Optional instance to populate.
     * @return {module:model/AirspacePolyResponse} The populated <code>AirspacePolyResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AirspacePolyResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>AirspacePolyResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AirspacePolyResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AirspacePolyResponse.RequiredProperties) {
...
AirspacePolyResponse.RequiredProperties = ["found"];

/**
 * @member {Array.<Object>} found
 */
AirspacePolyResponse.prototype['found'] = undefined;
...
export default AirspacePolyResponse;
