...
/**
 * The NOTAMsByPolygon model module.
 * @module model/NOTAMsByPolygon
 * @version V 1.0.0
 */
class NOTAMsByPolygon {
    /**
     * Constructs a new <code>NOTAMsByPolygon</code>.
     * Geometry-defining arguments for polygon requests
     * @alias module:model/NOTAMsByPolygon
     * @param poly {Object} 
     */
    constructor(poly) { 
        
        NOTAMsByPolygon.initialize(this, poly);
    }
    ...
    /**
     * Constructs a <code>NOTAMsByPolygon</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NOTAMsByPolygon} obj Optional instance to populate.
     * @return {module:model/NOTAMsByPolygon} The populated <code>NOTAMsByPolygon</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NOTAMsByPolygon();
    ...
    /**
     * Validates the JSON data with respect to <code>NOTAMsByPolygon</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NOTAMsByPolygon</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of NOTAMsByPolygon.RequiredProperties) {
...
NOTAMsByPolygon.RequiredProperties = ["poly"];

/**
 * @member {Object} poly
 */
NOTAMsByPolygon.prototype['poly'] = undefined;
...
export default NOTAMsByPolygon;
