...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DFlightApi.AirspaceByRoute();
  });
  ...
  describe('AirspaceByRoute', function() {
    it('should create an instance of AirspaceByRoute', function() {
      // uncomment below and update the code to test AirspaceByRoute
      //var instance = new DFlightApi.AirspaceByRoute();
      //expect(instance).to.be.a(DFlightApi.AirspaceByRoute);
    });
