...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DFlightApi.WxByDistance();
  });
  ...
  describe('WxByDistance', function() {
    it('should create an instance of WxByDistance', function() {
      // uncomment below and update the code to test WxByDistance
      //var instance = new DFlightApi.WxByDistance();
      //expect(instance).to.be.a(DFlightApi.WxByDistance);
    });
