...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DFlightApi.VenuesByRoute();
  });
  ...
  describe('VenuesByRoute', function() {
    it('should create an instance of VenuesByRoute', function() {
      // uncomment below and update the code to test VenuesByRoute
      //var instance = new DFlightApi.VenuesByRoute();
      //expect(instance).to.be.a(DFlightApi.VenuesByRoute);
    });
