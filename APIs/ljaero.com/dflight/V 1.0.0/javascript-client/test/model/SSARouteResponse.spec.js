...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DFlightApi.SSARouteResponse();
  });
  ...
  describe('SSARouteResponse', function() {
    it('should create an instance of SSARouteResponse', function() {
      // uncomment below and update the code to test SSARouteResponse
      //var instance = new DFlightApi.SSARouteResponse();
      //expect(instance).to.be.a(DFlightApi.SSARouteResponse);
    });
