...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DFlightApi.SSAByPolygon();
  });
  ...
  describe('SSAByPolygon', function() {
    it('should create an instance of SSAByPolygon', function() {
      // uncomment below and update the code to test SSAByPolygon
      //var instance = new DFlightApi.SSAByPolygon();
      //expect(instance).to.be.a(DFlightApi.SSAByPolygon);
    });
