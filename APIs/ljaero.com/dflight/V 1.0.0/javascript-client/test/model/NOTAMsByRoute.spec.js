...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DFlightApi.NOTAMsByRoute();
  });
  ...
  describe('NOTAMsByRoute', function() {
    it('should create an instance of NOTAMsByRoute', function() {
      // uncomment below and update the code to test NOTAMsByRoute
      //var instance = new DFlightApi.NOTAMsByRoute();
      //expect(instance).to.be.a(DFlightApi.NOTAMsByRoute);
    });
