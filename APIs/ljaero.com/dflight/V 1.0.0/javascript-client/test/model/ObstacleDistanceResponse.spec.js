...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DFlightApi.ObstacleDistanceResponse();
  });
  ...
  describe('ObstacleDistanceResponse', function() {
    it('should create an instance of ObstacleDistanceResponse', function() {
      // uncomment below and update the code to test ObstacleDistanceResponse
      //var instance = new DFlightApi.ObstacleDistanceResponse();
      //expect(instance).to.be.a(DFlightApi.ObstacleDistanceResponse);
    });
