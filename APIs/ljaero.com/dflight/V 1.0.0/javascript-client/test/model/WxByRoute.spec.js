...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DFlightApi.WxByRoute();
  });
  ...
  describe('WxByRoute', function() {
    it('should create an instance of WxByRoute', function() {
      // uncomment below and update the code to test WxByRoute
      //var instance = new DFlightApi.WxByRoute();
      //expect(instance).to.be.a(DFlightApi.WxByRoute);
    });
    ...
    it('should have the property wxtypes (base name: "wxtypes")', function() {
      // uncomment below and update the code to test the property wxtypes
      //var instance = new DFlightApi.WxByRoute();
      //expect(instance).to.be();
    });
