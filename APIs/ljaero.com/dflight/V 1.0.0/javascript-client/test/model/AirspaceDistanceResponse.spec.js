...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DFlightApi.AirspaceDistanceResponse();
  });
  ...
  describe('AirspaceDistanceResponse', function() {
    it('should create an instance of AirspaceDistanceResponse', function() {
      // uncomment below and update the code to test AirspaceDistanceResponse
      //var instance = new DFlightApi.AirspaceDistanceResponse();
      //expect(instance).to.be.a(DFlightApi.AirspaceDistanceResponse);
    });
