...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DFlightApi.VenuesByPolygon();
  });
  ...
  describe('VenuesByPolygon', function() {
    it('should create an instance of VenuesByPolygon', function() {
      // uncomment below and update the code to test VenuesByPolygon
      //var instance = new DFlightApi.VenuesByPolygon();
      //expect(instance).to.be.a(DFlightApi.VenuesByPolygon);
    });
