...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DFlightApi.UOAsRouteResponse();
  });
  ...
  describe('UOAsRouteResponse', function() {
    it('should create an instance of UOAsRouteResponse', function() {
      // uncomment below and update the code to test UOAsRouteResponse
      //var instance = new DFlightApi.UOAsRouteResponse();
      //expect(instance).to.be.a(DFlightApi.UOAsRouteResponse);
    });
