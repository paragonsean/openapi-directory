...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DFlightApi.UOAsByRoute();
  });
  ...
  describe('UOAsByRoute', function() {
    it('should create an instance of UOAsByRoute', function() {
      // uncomment below and update the code to test UOAsByRoute
      //var instance = new DFlightApi.UOAsByRoute();
      //expect(instance).to.be.a(DFlightApi.UOAsByRoute);
    });
