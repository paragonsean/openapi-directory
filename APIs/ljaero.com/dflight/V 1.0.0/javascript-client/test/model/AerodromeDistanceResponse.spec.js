...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DFlightApi.AerodromeDistanceResponse();
  });
  ...
  describe('AerodromeDistanceResponse', function() {
    it('should create an instance of AerodromeDistanceResponse', function() {
      // uncomment below and update the code to test AerodromeDistanceResponse
      //var instance = new DFlightApi.AerodromeDistanceResponse();
      //expect(instance).to.be.a(DFlightApi.AerodromeDistanceResponse);
    });
