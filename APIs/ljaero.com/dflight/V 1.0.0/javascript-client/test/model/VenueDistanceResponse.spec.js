...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DFlightApi.VenueDistanceResponse();
  });
  ...
  describe('VenueDistanceResponse', function() {
    it('should create an instance of VenueDistanceResponse', function() {
      // uncomment below and update the code to test VenueDistanceResponse
      //var instance = new DFlightApi.VenueDistanceResponse();
      //expect(instance).to.be.a(DFlightApi.VenueDistanceResponse);
    });
