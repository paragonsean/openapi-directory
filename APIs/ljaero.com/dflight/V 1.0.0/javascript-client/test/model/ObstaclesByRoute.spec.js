...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DFlightApi.ObstaclesByRoute();
  });
  ...
  describe('ObstaclesByRoute', function() {
    it('should create an instance of ObstaclesByRoute', function() {
      // uncomment below and update the code to test ObstaclesByRoute
      //var instance = new DFlightApi.ObstaclesByRoute();
      //expect(instance).to.be.a(DFlightApi.ObstaclesByRoute);
    });
