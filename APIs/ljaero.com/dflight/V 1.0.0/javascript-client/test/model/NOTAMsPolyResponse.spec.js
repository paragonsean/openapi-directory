...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DFlightApi.NOTAMsPolyResponse();
  });
  ...
  describe('NOTAMsPolyResponse', function() {
    it('should create an instance of NOTAMsPolyResponse', function() {
      // uncomment below and update the code to test NOTAMsPolyResponse
      //var instance = new DFlightApi.NOTAMsPolyResponse();
      //expect(instance).to.be.a(DFlightApi.NOTAMsPolyResponse);
    });
