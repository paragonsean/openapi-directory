...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DFlightApi.AerodromesByDistance();
  });
  ...
  describe('AerodromesByDistance', function() {
    it('should create an instance of AerodromesByDistance', function() {
      // uncomment below and update the code to test AerodromesByDistance
      //var instance = new DFlightApi.AerodromesByDistance();
      //expect(instance).to.be.a(DFlightApi.AerodromesByDistance);
    });
