...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DFlightApi.AirspaceRouteResponse();
  });
  ...
  describe('AirspaceRouteResponse', function() {
    it('should create an instance of AirspaceRouteResponse', function() {
      // uncomment below and update the code to test AirspaceRouteResponse
      //var instance = new DFlightApi.AirspaceRouteResponse();
      //expect(instance).to.be.a(DFlightApi.AirspaceRouteResponse);
    });
