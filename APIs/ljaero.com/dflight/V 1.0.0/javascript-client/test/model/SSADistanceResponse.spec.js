...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DFlightApi.SSADistanceResponse();
  });
  ...
  describe('SSADistanceResponse', function() {
    it('should create an instance of SSADistanceResponse', function() {
      // uncomment below and update the code to test SSADistanceResponse
      //var instance = new DFlightApi.SSADistanceResponse();
      //expect(instance).to.be.a(DFlightApi.SSADistanceResponse);
    });
