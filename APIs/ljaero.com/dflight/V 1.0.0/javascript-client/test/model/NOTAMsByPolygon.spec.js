...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DFlightApi.NOTAMsByPolygon();
  });
  ...
  describe('NOTAMsByPolygon', function() {
    it('should create an instance of NOTAMsByPolygon', function() {
      // uncomment below and update the code to test NOTAMsByPolygon
      //var instance = new DFlightApi.NOTAMsByPolygon();
      //expect(instance).to.be.a(DFlightApi.NOTAMsByPolygon);
    });
