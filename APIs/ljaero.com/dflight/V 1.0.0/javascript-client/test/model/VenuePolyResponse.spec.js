...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DFlightApi.VenuePolyResponse();
  });
  ...
  describe('VenuePolyResponse', function() {
    it('should create an instance of VenuePolyResponse', function() {
      // uncomment below and update the code to test VenuePolyResponse
      //var instance = new DFlightApi.VenuePolyResponse();
      //expect(instance).to.be.a(DFlightApi.VenuePolyResponse);
    });
