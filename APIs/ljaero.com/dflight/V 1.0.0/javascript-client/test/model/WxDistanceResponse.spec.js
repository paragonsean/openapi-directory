...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DFlightApi.WxDistanceResponse();
  });
  ...
  describe('WxDistanceResponse', function() {
    it('should create an instance of WxDistanceResponse', function() {
      // uncomment below and update the code to test WxDistanceResponse
      //var instance = new DFlightApi.WxDistanceResponse();
      //expect(instance).to.be.a(DFlightApi.WxDistanceResponse);
    });
