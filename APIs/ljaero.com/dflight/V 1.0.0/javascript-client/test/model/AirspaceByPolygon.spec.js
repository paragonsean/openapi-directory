...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DFlightApi.AirspaceByPolygon();
  });
  ...
  describe('AirspaceByPolygon', function() {
    it('should create an instance of AirspaceByPolygon', function() {
      // uncomment below and update the code to test AirspaceByPolygon
      //var instance = new DFlightApi.AirspaceByPolygon();
      //expect(instance).to.be.a(DFlightApi.AirspaceByPolygon);
    });

    it('should have the property asptypes (base name: "asptypes")', function() {
      // uncomment below and update the code to test the property asptypes
      //var instance = new DFlightApi.AirspaceByPolygon();
      //expect(instance).to.be();
    });

    it('should have the property poly (base name: "poly")', function() {
      // uncomment below and update the code to test the property poly
      //var instance = new DFlightApi.AirspaceByPolygon();
      //expect(instance).to.be();
    });
