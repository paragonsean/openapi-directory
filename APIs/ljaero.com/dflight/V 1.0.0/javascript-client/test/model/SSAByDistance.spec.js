...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DFlightApi.SSAByDistance();
  });
  ...
  describe('SSAByDistance', function() {
    it('should create an instance of SSAByDistance', function() {
      // uncomment below and update the code to test SSAByDistance
      //var instance = new DFlightApi.SSAByDistance();
      //expect(instance).to.be.a(DFlightApi.SSAByDistance);
    });
