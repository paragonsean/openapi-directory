...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DFlightApi.AirspaceByDistance();
  });
  ...
  describe('AirspaceByDistance', function() {
    it('should create an instance of AirspaceByDistance', function() {
      // uncomment below and update the code to test AirspaceByDistance
      //var instance = new DFlightApi.AirspaceByDistance();
      //expect(instance).to.be.a(DFlightApi.AirspaceByDistance);
    });
