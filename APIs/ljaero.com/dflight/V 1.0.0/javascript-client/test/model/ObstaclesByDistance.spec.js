...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DFlightApi.ObstaclesByDistance();
  });
  ...
  describe('ObstaclesByDistance', function() {
    it('should create an instance of ObstaclesByDistance', function() {
      // uncomment below and update the code to test ObstaclesByDistance
      //var instance = new DFlightApi.ObstaclesByDistance();
      //expect(instance).to.be.a(DFlightApi.ObstaclesByDistance);
    });
