...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DFlightApi.AerodromePolyResponse();
  });
  ...
  describe('AerodromePolyResponse', function() {
    it('should create an instance of AerodromePolyResponse', function() {
      // uncomment below and update the code to test AerodromePolyResponse
      //var instance = new DFlightApi.AerodromePolyResponse();
      //expect(instance).to.be.a(DFlightApi.AerodromePolyResponse);
    });
