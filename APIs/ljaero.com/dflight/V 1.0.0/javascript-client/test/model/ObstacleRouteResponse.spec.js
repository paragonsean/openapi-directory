...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DFlightApi.ObstacleRouteResponse();
  });
  ...
  describe('ObstacleRouteResponse', function() {
    it('should create an instance of ObstacleRouteResponse', function() {
      // uncomment below and update the code to test ObstacleRouteResponse
      //var instance = new DFlightApi.ObstacleRouteResponse();
      //expect(instance).to.be.a(DFlightApi.ObstacleRouteResponse);
    });
