...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DFlightApi.ObstaclesByPolygon();
  });
  ...
  describe('ObstaclesByPolygon', function() {
    it('should create an instance of ObstaclesByPolygon', function() {
      // uncomment below and update the code to test ObstaclesByPolygon
      //var instance = new DFlightApi.ObstaclesByPolygon();
      //expect(instance).to.be.a(DFlightApi.ObstaclesByPolygon);
    });
