...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DFlightApi.NOTAMsRouteResponse();
  });
  ...
  describe('NOTAMsRouteResponse', function() {
    it('should create an instance of NOTAMsRouteResponse', function() {
      // uncomment below and update the code to test NOTAMsRouteResponse
      //var instance = new DFlightApi.NOTAMsRouteResponse();
      //expect(instance).to.be.a(DFlightApi.NOTAMsRouteResponse);
    });
