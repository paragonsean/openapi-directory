...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DFlightApi.AirspacePolyResponse();
  });
  ...
  describe('AirspacePolyResponse', function() {
    it('should create an instance of AirspacePolyResponse', function() {
      // uncomment below and update the code to test AirspacePolyResponse
      //var instance = new DFlightApi.AirspacePolyResponse();
      //expect(instance).to.be.a(DFlightApi.AirspacePolyResponse);
    });
