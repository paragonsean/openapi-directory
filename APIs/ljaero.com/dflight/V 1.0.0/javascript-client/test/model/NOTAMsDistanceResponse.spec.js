...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DFlightApi.NOTAMsDistanceResponse();
  });
  ...
  describe('NOTAMsDistanceResponse', function() {
    it('should create an instance of NOTAMsDistanceResponse', function() {
      // uncomment below and update the code to test NOTAMsDistanceResponse
      //var instance = new DFlightApi.NOTAMsDistanceResponse();
      //expect(instance).to.be.a(DFlightApi.NOTAMsDistanceResponse);
    });
