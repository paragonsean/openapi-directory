...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DFlightApi.VenuesByDistance();
  });
  ...
  describe('VenuesByDistance', function() {
    it('should create an instance of VenuesByDistance', function() {
      // uncomment below and update the code to test VenuesByDistance
      //var instance = new DFlightApi.VenuesByDistance();
      //expect(instance).to.be.a(DFlightApi.VenuesByDistance);
    });
