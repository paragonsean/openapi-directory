...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DFlightApi.SSAPolyResponse();
  });
  ...
  describe('SSAPolyResponse', function() {
    it('should create an instance of SSAPolyResponse', function() {
      // uncomment below and update the code to test SSAPolyResponse
      //var instance = new DFlightApi.SSAPolyResponse();
      //expect(instance).to.be.a(DFlightApi.SSAPolyResponse);
    });
