...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DFlightApi.UOAsByPolygon();
  });
  ...
  describe('UOAsByPolygon', function() {
    it('should create an instance of UOAsByPolygon', function() {
      // uncomment below and update the code to test UOAsByPolygon
      //var instance = new DFlightApi.UOAsByPolygon();
      //expect(instance).to.be.a(DFlightApi.UOAsByPolygon);
    });
