...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DFlightApi.UOAsByDistance();
  });
  ...
  describe('UOAsByDistance', function() {
    it('should create an instance of UOAsByDistance', function() {
      // uncomment below and update the code to test UOAsByDistance
      //var instance = new DFlightApi.UOAsByDistance();
      //expect(instance).to.be.a(DFlightApi.UOAsByDistance);
    });
