...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DFlightApi.AerodromesByPolygon();
  });
  ...
  describe('AerodromesByPolygon', function() {
    it('should create an instance of AerodromesByPolygon', function() {
      // uncomment below and update the code to test AerodromesByPolygon
      //var instance = new DFlightApi.AerodromesByPolygon();
      //expect(instance).to.be.a(DFlightApi.AerodromesByPolygon);
    });
