...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DFlightApi.SSAByRoute();
  });
  ...
  describe('SSAByRoute', function() {
    it('should create an instance of SSAByRoute', function() {
      // uncomment below and update the code to test SSAByRoute
      //var instance = new DFlightApi.SSAByRoute();
      //expect(instance).to.be.a(DFlightApi.SSAByRoute);
    });
