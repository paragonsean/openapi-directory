...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DFlightApi.ObstaclePolyResponse();
  });
  ...
  describe('ObstaclePolyResponse', function() {
    it('should create an instance of ObstaclePolyResponse', function() {
      // uncomment below and update the code to test ObstaclePolyResponse
      //var instance = new DFlightApi.ObstaclePolyResponse();
      //expect(instance).to.be.a(DFlightApi.ObstaclePolyResponse);
    });
