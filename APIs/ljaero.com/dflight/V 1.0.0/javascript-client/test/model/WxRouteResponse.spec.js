...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DFlightApi.WxRouteResponse();
  });
  ...
  describe('WxRouteResponse', function() {
    it('should create an instance of WxRouteResponse', function() {
      // uncomment below and update the code to test WxRouteResponse
      //var instance = new DFlightApi.WxRouteResponse();
      //expect(instance).to.be.a(DFlightApi.WxRouteResponse);
    });
