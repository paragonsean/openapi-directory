...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DFlightApi.UOAsDistanceResponse();
  });
  ...
  describe('UOAsDistanceResponse', function() {
    it('should create an instance of UOAsDistanceResponse', function() {
      // uncomment below and update the code to test UOAsDistanceResponse
      //var instance = new DFlightApi.UOAsDistanceResponse();
      //expect(instance).to.be.a(DFlightApi.UOAsDistanceResponse);
    });
