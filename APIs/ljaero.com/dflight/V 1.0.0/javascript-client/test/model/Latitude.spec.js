...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DFlightApi.Latitude();
  });
  ...
  describe('Latitude', function() {
    it('should create an instance of Latitude', function() {
      // uncomment below and update the code to test Latitude
      //var instance = new DFlightApi.Latitude();
      //expect(instance).to.be.a(DFlightApi.Latitude);
    });
