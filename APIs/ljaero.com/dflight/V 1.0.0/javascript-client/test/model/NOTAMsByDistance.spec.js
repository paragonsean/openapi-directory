...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DFlightApi.NOTAMsByDistance();
  });
  ...
  describe('NOTAMsByDistance', function() {
    it('should create an instance of NOTAMsByDistance', function() {
      // uncomment below and update the code to test NOTAMsByDistance
      //var instance = new DFlightApi.NOTAMsByDistance();
      //expect(instance).to.be.a(DFlightApi.NOTAMsByDistance);
    });
