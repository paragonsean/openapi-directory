...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DFlightApi.AerodromesByRoute();
  });
  ...
  describe('AerodromesByRoute', function() {
    it('should create an instance of AerodromesByRoute', function() {
      // uncomment below and update the code to test AerodromesByRoute
      //var instance = new DFlightApi.AerodromesByRoute();
      //expect(instance).to.be.a(DFlightApi.AerodromesByRoute);
    });
