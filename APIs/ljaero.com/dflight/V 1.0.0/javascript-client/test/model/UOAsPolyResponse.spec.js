...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DFlightApi.UOAsPolyResponse();
  });
  ...
  describe('UOAsPolyResponse', function() {
    it('should create an instance of UOAsPolyResponse', function() {
      // uncomment below and update the code to test UOAsPolyResponse
      //var instance = new DFlightApi.UOAsPolyResponse();
      //expect(instance).to.be.a(DFlightApi.UOAsPolyResponse);
    });
