...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DFlightApi.VenueRouteResponse();
  });
  ...
  describe('VenueRouteResponse', function() {
    it('should create an instance of VenueRouteResponse', function() {
      // uncomment below and update the code to test VenueRouteResponse
      //var instance = new DFlightApi.VenueRouteResponse();
      //expect(instance).to.be.a(DFlightApi.VenueRouteResponse);
    });
