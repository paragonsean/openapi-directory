...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DFlightApi.Longitude();
  });
  ...
  describe('Longitude', function() {
    it('should create an instance of Longitude', function() {
      // uncomment below and update the code to test Longitude
      //var instance = new DFlightApi.Longitude();
      //expect(instance).to.be.a(DFlightApi.Longitude);
    });
