...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DFlightApi.AerodromeRouteResponse();
  });
  ...
  describe('AerodromeRouteResponse', function() {
    it('should create an instance of AerodromeRouteResponse', function() {
      // uncomment below and update the code to test AerodromeRouteResponse
      //var instance = new DFlightApi.AerodromeRouteResponse();
      //expect(instance).to.be.a(DFlightApi.AerodromeRouteResponse);
    });
