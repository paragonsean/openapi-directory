...
<a id="obstaclesByDistanceUsV1ObstaclesDistanceQueryPost"></a>
# **obstaclesByDistanceUsV1ObstaclesDistanceQueryPost**
> ObstacleDistanceResponse obstaclesByDistanceUsV1ObstaclesDistanceQueryPost(obstaclesByDistance, xApiKey)
...
import org.openapitools.client.api.SurfaceObstaclesApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    SurfaceObstaclesApi apiInstance = new SurfaceObstaclesApi(defaultClient);
    ObstaclesByDistance obstaclesByDistance = new ObstaclesByDistance(); // ObstaclesByDistance | 
    String xApiKey = "xApiKey_example"; // String | 
    try {
      ObstacleDistanceResponse result = apiInstance.obstaclesByDistanceUsV1ObstaclesDistanceQueryPost(obstaclesByDistance, xApiKey);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling SurfaceObstaclesApi#obstaclesByDistanceUsV1ObstaclesDistanceQueryPost");
...
<a id="obstaclesByPolyUsV1ObstaclesPolygonQueryPost"></a>
# **obstaclesByPolyUsV1ObstaclesPolygonQueryPost**
> ObstaclePolyResponse obstaclesByPolyUsV1ObstaclesPolygonQueryPost(obstaclesByPolygon, xApiKey)
...
public class Example {
  public static void main(String[] args) {
    ...
    SurfaceObstaclesApi apiInstance = new SurfaceObstaclesApi(defaultClient);
    ObstaclesByPolygon obstaclesByPolygon = new ObstaclesByPolygon(); // ObstaclesByPolygon | 
    String xApiKey = "xApiKey_example"; // String | 
    try {
      ObstaclePolyResponse result = apiInstance.obstaclesByPolyUsV1ObstaclesPolygonQueryPost(obstaclesByPolygon, xApiKey);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling SurfaceObstaclesApi#obstaclesByPolyUsV1ObstaclesPolygonQueryPost");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="obstaclesByRouteUsV1ObstaclesRouteQueryPost"></a>
# **obstaclesByRouteUsV1ObstaclesRouteQueryPost**
> ObstacleRouteResponse obstaclesByRouteUsV1ObstaclesRouteQueryPost(obstaclesByRoute, xApiKey)
...
public class Example {
  public static void main(String[] args) {
    ...
    SurfaceObstaclesApi apiInstance = new SurfaceObstaclesApi(defaultClient);
    ObstaclesByRoute obstaclesByRoute = new ObstaclesByRoute(); // ObstaclesByRoute | 
    String xApiKey = "xApiKey_example"; // String | 
    try {
      ObstacleRouteResponse result = apiInstance.obstaclesByRouteUsV1ObstaclesRouteQueryPost(obstaclesByRoute, xApiKey);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling SurfaceObstaclesApi#obstaclesByRouteUsV1ObstaclesRouteQueryPost");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
