...
public class Latitude extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(Latitude.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!Latitude.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'Latitude' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<Latitude>() {
                @Override
                public void write(JsonWriter out, Latitude value) throws IOException {
                ...
                @Override
                public Latitude read(JsonReader in) throws IOException {
                    ...
                    throw new IOException(String.format("Failed deserialization for Latitude: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to Latitude
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format("The JSON string is invalid for Latitude with anyOf schemas: BigDecimal, Integer. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of Latitude given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of Latitude
     * @throws IOException if the JSON string is invalid with respect to Latitude
     */
    public static Latitude fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, Latitude.class);
    }

    /**
     * Convert an instance of Latitude to an JSON string
     *
     * @return JSON string
     */
