...
public class ApiClient {
    ...
    private String basePath = "https://dflight-api.ljaero.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/V 1.0.0/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://dflight-api.ljaero.com
