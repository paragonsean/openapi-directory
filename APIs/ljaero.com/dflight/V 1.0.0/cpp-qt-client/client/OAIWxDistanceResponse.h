...
/*
 * OAIWxDistanceResponse.h
 *
 * 
 */

#ifndef OAIWxDistanceResponse_H
#define OAIWxDistanceResponse_H
...
class OAIWxDistanceResponse : public OAIObject {
public:
    OAIWxDistanceResponse();
    OAIWxDistanceResponse(QString json);
    ~OAIWxDistanceResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWxDistanceResponse)

#endif // OAIWxDistanceResponse_H
