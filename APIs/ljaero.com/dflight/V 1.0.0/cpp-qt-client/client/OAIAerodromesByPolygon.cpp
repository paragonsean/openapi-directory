...
OAIAerodromesByPolygon::OAIAerodromesByPolygon(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAerodromesByPolygon::OAIAerodromesByPolygon() {
    this->initializeModel();
}

OAIAerodromesByPolygon::~OAIAerodromesByPolygon() {}

void OAIAerodromesByPolygon::initializeModel() {

    m_poly_isSet = false;
    m_poly_isValid = false;
}

void OAIAerodromesByPolygon::fromJson(QString jsonString) {
...
QJsonObject OAIAerodromesByPolygon::asJsonObject() const {
    QJsonObject obj;
    if (m_poly_isSet) {
...
OAIObject OAIAerodromesByPolygon::getPoly() const {
    return m_poly;
}
void OAIAerodromesByPolygon::setPoly(const OAIObject &poly) {
    m_poly = poly;
    m_poly_isSet = true;
}

bool OAIAerodromesByPolygon::is_poly_Set() const{
    return m_poly_isSet;
}

bool OAIAerodromesByPolygon::is_poly_Valid() const{
    return m_poly_isValid;
}

bool OAIAerodromesByPolygon::isSet() const {
...
bool OAIAerodromesByPolygon::isValid() const {
