...
/*
 * OAIAirspacePolyResponse.h
 *
 * 
 */

#ifndef OAIAirspacePolyResponse_H
#define OAIAirspacePolyResponse_H
...
class OAIAirspacePolyResponse : public OAIObject {
public:
    OAIAirspacePolyResponse();
    OAIAirspacePolyResponse(QString json);
    ~OAIAirspacePolyResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAirspacePolyResponse)

#endif // OAIAirspacePolyResponse_H
