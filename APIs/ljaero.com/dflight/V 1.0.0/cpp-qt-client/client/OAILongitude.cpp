...
OAILongitude::OAILongitude(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILongitude::OAILongitude() {
    this->initializeModel();
}

OAILongitude::~OAILongitude() {}

void OAILongitude::initializeModel() {

}

void OAILongitude::fromJson(QString jsonString) {
...
void OAILongitude::fromJsonObject(QJsonObject json) {

}

QString OAILongitude::asJson() const {
...
QJsonObject OAILongitude::asJsonObject() const {
    QJsonObject obj;
    return obj;
}

bool OAILongitude::isSet() const {
...
bool OAILongitude::isValid() const {
