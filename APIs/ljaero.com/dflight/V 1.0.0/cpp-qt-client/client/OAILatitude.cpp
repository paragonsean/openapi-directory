...
OAILatitude::OAILatitude(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILatitude::OAILatitude() {
    this->initializeModel();
}

OAILatitude::~OAILatitude() {}

void OAILatitude::initializeModel() {

}

void OAILatitude::fromJson(QString jsonString) {
...
void OAILatitude::fromJsonObject(QJsonObject json) {

}

QString OAILatitude::asJson() const {
...
QJsonObject OAILatitude::asJsonObject() const {
    QJsonObject obj;
    return obj;
}

bool OAILatitude::isSet() const {
...
bool OAILatitude::isValid() const {
