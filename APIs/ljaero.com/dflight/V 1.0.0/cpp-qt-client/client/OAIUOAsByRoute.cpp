...
OAIUOAsByRoute::OAIUOAsByRoute(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUOAsByRoute::OAIUOAsByRoute() {
    this->initializeModel();
}

OAIUOAsByRoute::~OAIUOAsByRoute() {}

void OAIUOAsByRoute::initializeModel() {

    m_route_isSet = false;
    m_route_isValid = false;
}

void OAIUOAsByRoute::fromJson(QString jsonString) {
...
QJsonObject OAIUOAsByRoute::asJsonObject() const {
    QJsonObject obj;
    if (m_route_isSet) {
...
OAIObject OAIUOAsByRoute::getRoute() const {
    return m_route;
}
void OAIUOAsByRoute::setRoute(const OAIObject &route) {
    m_route = route;
    m_route_isSet = true;
}

bool OAIUOAsByRoute::is_route_Set() const{
    return m_route_isSet;
}

bool OAIUOAsByRoute::is_route_Valid() const{
    return m_route_isValid;
}

bool OAIUOAsByRoute::isSet() const {
...
bool OAIUOAsByRoute::isValid() const {
