...
OAISSAByRoute::OAISSAByRoute(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISSAByRoute::OAISSAByRoute() {
    this->initializeModel();
}

OAISSAByRoute::~OAISSAByRoute() {}

void OAISSAByRoute::initializeModel() {

    m_route_isSet = false;
    m_route_isValid = false;
}

void OAISSAByRoute::fromJson(QString jsonString) {
...
QJsonObject OAISSAByRoute::asJsonObject() const {
    QJsonObject obj;
    if (m_route_isSet) {
...
OAIObject OAISSAByRoute::getRoute() const {
    return m_route;
}
void OAISSAByRoute::setRoute(const OAIObject &route) {
    m_route = route;
    m_route_isSet = true;
}

bool OAISSAByRoute::is_route_Set() const{
    return m_route_isSet;
}

bool OAISSAByRoute::is_route_Valid() const{
    return m_route_isValid;
}

bool OAISSAByRoute::isSet() const {
...
bool OAISSAByRoute::isValid() const {
