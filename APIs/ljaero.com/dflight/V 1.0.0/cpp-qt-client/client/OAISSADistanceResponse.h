...
/*
 * OAISSADistanceResponse.h
 *
 * 
 */

#ifndef OAISSADistanceResponse_H
#define OAISSADistanceResponse_H
...
class OAISSADistanceResponse : public OAIObject {
public:
    OAISSADistanceResponse();
    OAISSADistanceResponse(QString json);
    ~OAISSADistanceResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISSADistanceResponse)

#endif // OAISSADistanceResponse_H
