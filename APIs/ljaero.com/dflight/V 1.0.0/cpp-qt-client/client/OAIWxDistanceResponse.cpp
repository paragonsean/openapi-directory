...
OAIWxDistanceResponse::OAIWxDistanceResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIWxDistanceResponse::OAIWxDistanceResponse() {
    this->initializeModel();
}

OAIWxDistanceResponse::~OAIWxDistanceResponse() {}

void OAIWxDistanceResponse::initializeModel() {

    m_found_isSet = false;
    m_found_isValid = false;
}

void OAIWxDistanceResponse::fromJson(QString jsonString) {
...
QJsonObject OAIWxDistanceResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_found_isSet) {
...
OAIObject OAIWxDistanceResponse::getFound() const {
    return m_found;
}
void OAIWxDistanceResponse::setFound(const OAIObject &found) {
    m_found = found;
    m_found_isSet = true;
}

bool OAIWxDistanceResponse::is_found_Set() const{
    return m_found_isSet;
}

bool OAIWxDistanceResponse::is_found_Valid() const{
    return m_found_isValid;
}

bool OAIWxDistanceResponse::isSet() const {
...
bool OAIWxDistanceResponse::isValid() const {
