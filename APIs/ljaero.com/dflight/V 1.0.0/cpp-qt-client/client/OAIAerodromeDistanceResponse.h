...
/*
 * OAIAerodromeDistanceResponse.h
 *
 * 
 */

#ifndef OAIAerodromeDistanceResponse_H
#define OAIAerodromeDistanceResponse_H
...
class OAIAerodromeDistanceResponse : public OAIObject {
public:
    OAIAerodromeDistanceResponse();
    OAIAerodromeDistanceResponse(QString json);
    ~OAIAerodromeDistanceResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAerodromeDistanceResponse)

#endif // OAIAerodromeDistanceResponse_H
