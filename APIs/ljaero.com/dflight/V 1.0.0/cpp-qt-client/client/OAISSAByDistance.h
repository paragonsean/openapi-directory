...
#ifndef OAISSAByDistance_H
#define OAISSAByDistance_H
...
class OAISSAByDistance : public OAIObject {
public:
    OAISSAByDistance();
    OAISSAByDistance(QString json);
    ~OAISSAByDistance() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISSAByDistance)

#endif // OAISSAByDistance_H
