...
OAINOTAMsPolyResponse::OAINOTAMsPolyResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINOTAMsPolyResponse::OAINOTAMsPolyResponse() {
    this->initializeModel();
}

OAINOTAMsPolyResponse::~OAINOTAMsPolyResponse() {}

void OAINOTAMsPolyResponse::initializeModel() {

    m_found_isSet = false;
    m_found_isValid = false;
}

void OAINOTAMsPolyResponse::fromJson(QString jsonString) {
...
QJsonObject OAINOTAMsPolyResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_found_isSet) {
...
OAIObject OAINOTAMsPolyResponse::getFound() const {
    return m_found;
}
void OAINOTAMsPolyResponse::setFound(const OAIObject &found) {
    m_found = found;
    m_found_isSet = true;
}

bool OAINOTAMsPolyResponse::is_found_Set() const{
    return m_found_isSet;
}

bool OAINOTAMsPolyResponse::is_found_Valid() const{
    return m_found_isValid;
}

bool OAINOTAMsPolyResponse::isSet() const {
...
bool OAINOTAMsPolyResponse::isValid() const {
