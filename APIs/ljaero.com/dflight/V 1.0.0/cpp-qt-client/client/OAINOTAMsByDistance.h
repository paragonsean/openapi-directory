...
/*
 * OAINOTAMsByDistance.h
 *
 * Geometry-defining arguments for point/distance requests
 */

#ifndef OAINOTAMsByDistance_H
#define OAINOTAMsByDistance_H
...
class OAINOTAMsByDistance : public OAIObject {
public:
    OAINOTAMsByDistance();
    OAINOTAMsByDistance(QString json);
    ~OAINOTAMsByDistance() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINOTAMsByDistance)

#endif // OAINOTAMsByDistance_H
