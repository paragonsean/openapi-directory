...
#ifndef OAINOTAMsByRoute_H
#define OAINOTAMsByRoute_H
...
class OAINOTAMsByRoute : public OAIObject {
public:
    OAINOTAMsByRoute();
    OAINOTAMsByRoute(QString json);
    ~OAINOTAMsByRoute() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINOTAMsByRoute)

#endif // OAINOTAMsByRoute_H
