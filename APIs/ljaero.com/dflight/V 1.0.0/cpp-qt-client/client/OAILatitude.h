...
#ifndef OAILatitude_H
#define OAILatitude_H
...
class OAILatitude : public OAIObject {
public:
    OAILatitude();
    OAILatitude(QString json);
    ~OAILatitude() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILatitude)
