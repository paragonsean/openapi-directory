...
OAIAirspaceDistanceResponse::OAIAirspaceDistanceResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAirspaceDistanceResponse::OAIAirspaceDistanceResponse() {
    this->initializeModel();
}

OAIAirspaceDistanceResponse::~OAIAirspaceDistanceResponse() {}

void OAIAirspaceDistanceResponse::initializeModel() {

    m_found_isSet = false;
    m_found_isValid = false;
}

void OAIAirspaceDistanceResponse::fromJson(QString jsonString) {
...
QJsonObject OAIAirspaceDistanceResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_found.size() > 0) {
...
QList<OAIObject> OAIAirspaceDistanceResponse::getFound() const {
    return m_found;
}
void OAIAirspaceDistanceResponse::setFound(const QList<OAIObject> &found) {
    m_found = found;
    m_found_isSet = true;
}

bool OAIAirspaceDistanceResponse::is_found_Set() const{
    return m_found_isSet;
}

bool OAIAirspaceDistanceResponse::is_found_Valid() const{
    return m_found_isValid;
}

bool OAIAirspaceDistanceResponse::isSet() const {
...
bool OAIAirspaceDistanceResponse::isValid() const {
