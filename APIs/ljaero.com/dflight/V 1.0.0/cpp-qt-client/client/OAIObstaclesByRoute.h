...
/*
 * OAIObstaclesByRoute.h
 *
 * Geometry-defining arguments for along-route requests
 */

#ifndef OAIObstaclesByRoute_H
#define OAIObstaclesByRoute_H
...
class OAIObstaclesByRoute : public OAIObject {
public:
    OAIObstaclesByRoute();
    OAIObstaclesByRoute(QString json);
    ~OAIObstaclesByRoute() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIObstaclesByRoute)

#endif // OAIObstaclesByRoute_H
