...
OAISSAPolyResponse::OAISSAPolyResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISSAPolyResponse::OAISSAPolyResponse() {
    this->initializeModel();
}

OAISSAPolyResponse::~OAISSAPolyResponse() {}

void OAISSAPolyResponse::initializeModel() {

    m_found_isSet = false;
    m_found_isValid = false;
}

void OAISSAPolyResponse::fromJson(QString jsonString) {
...
QJsonObject OAISSAPolyResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_found_isSet) {
...
OAIObject OAISSAPolyResponse::getFound() const {
    return m_found;
}
void OAISSAPolyResponse::setFound(const OAIObject &found) {
    m_found = found;
    m_found_isSet = true;
}

bool OAISSAPolyResponse::is_found_Set() const{
    return m_found_isSet;
}

bool OAISSAPolyResponse::is_found_Valid() const{
    return m_found_isValid;
}

bool OAISSAPolyResponse::isSet() const {
...
bool OAISSAPolyResponse::isValid() const {
