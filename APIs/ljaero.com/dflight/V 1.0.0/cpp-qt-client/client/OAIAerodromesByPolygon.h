...
/*
 * OAIAerodromesByPolygon.h
 *
 * Geometry-defining arguments for polygon requests
 */

#ifndef OAIAerodromesByPolygon_H
#define OAIAerodromesByPolygon_H
...
class OAIAerodromesByPolygon : public OAIObject {
public:
    OAIAerodromesByPolygon();
    OAIAerodromesByPolygon(QString json);
    ~OAIAerodromesByPolygon() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAerodromesByPolygon)

#endif // OAIAerodromesByPolygon_H
