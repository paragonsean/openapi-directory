...
OAIUOAsPolyResponse::OAIUOAsPolyResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUOAsPolyResponse::OAIUOAsPolyResponse() {
    this->initializeModel();
}

OAIUOAsPolyResponse::~OAIUOAsPolyResponse() {}

void OAIUOAsPolyResponse::initializeModel() {

    m_found_isSet = false;
    m_found_isValid = false;
}

void OAIUOAsPolyResponse::fromJson(QString jsonString) {
...
QJsonObject OAIUOAsPolyResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_found_isSet) {
...
OAIObject OAIUOAsPolyResponse::getFound() const {
    return m_found;
}
void OAIUOAsPolyResponse::setFound(const OAIObject &found) {
    m_found = found;
    m_found_isSet = true;
}

bool OAIUOAsPolyResponse::is_found_Set() const{
    return m_found_isSet;
}

bool OAIUOAsPolyResponse::is_found_Valid() const{
    return m_found_isValid;
}

bool OAIUOAsPolyResponse::isSet() const {
...
bool OAIUOAsPolyResponse::isValid() const {
