...
/*
 * OAIVenuesByDistance.h
 *
 * Geometry-defining arguments for point/distance requests
 */

#ifndef OAIVenuesByDistance_H
#define OAIVenuesByDistance_H
...
class OAIVenuesByDistance : public OAIObject {
public:
    OAIVenuesByDistance();
    OAIVenuesByDistance(QString json);
    ~OAIVenuesByDistance() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVenuesByDistance)

#endif // OAIVenuesByDistance_H
