...
OAIAerodromesByRoute::OAIAerodromesByRoute(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAerodromesByRoute::OAIAerodromesByRoute() {
    this->initializeModel();
}

OAIAerodromesByRoute::~OAIAerodromesByRoute() {}

void OAIAerodromesByRoute::initializeModel() {

    m_route_isSet = false;
    m_route_isValid = false;
}

void OAIAerodromesByRoute::fromJson(QString jsonString) {
...
QJsonObject OAIAerodromesByRoute::asJsonObject() const {
    QJsonObject obj;
    if (m_route_isSet) {
...
OAIObject OAIAerodromesByRoute::getRoute() const {
    return m_route;
}
void OAIAerodromesByRoute::setRoute(const OAIObject &route) {
    m_route = route;
    m_route_isSet = true;
}

bool OAIAerodromesByRoute::is_route_Set() const{
    return m_route_isSet;
}

bool OAIAerodromesByRoute::is_route_Valid() const{
    return m_route_isValid;
}

bool OAIAerodromesByRoute::isSet() const {
...
bool OAIAerodromesByRoute::isValid() const {
