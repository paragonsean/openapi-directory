...
/*
 * OAIObstacleRouteResponse.h
 *
 * 
 */

#ifndef OAIObstacleRouteResponse_H
#define OAIObstacleRouteResponse_H
...
class OAIObstacleRouteResponse : public OAIObject {
public:
    OAIObstacleRouteResponse();
    OAIObstacleRouteResponse(QString json);
    ~OAIObstacleRouteResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIObstacleRouteResponse)

#endif // OAIObstacleRouteResponse_H
