...
/*
 * OAIVenueDistanceResponse.h
 *
 * 
 */

#ifndef OAIVenueDistanceResponse_H
#define OAIVenueDistanceResponse_H
...
class OAIVenueDistanceResponse : public OAIObject {
public:
    OAIVenueDistanceResponse();
    OAIVenueDistanceResponse(QString json);
    ~OAIVenueDistanceResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVenueDistanceResponse)

#endif // OAIVenueDistanceResponse_H
