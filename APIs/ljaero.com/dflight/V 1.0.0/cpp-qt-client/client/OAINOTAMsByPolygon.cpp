...
OAINOTAMsByPolygon::OAINOTAMsByPolygon(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINOTAMsByPolygon::OAINOTAMsByPolygon() {
    this->initializeModel();
}

OAINOTAMsByPolygon::~OAINOTAMsByPolygon() {}

void OAINOTAMsByPolygon::initializeModel() {

    m_poly_isSet = false;
    m_poly_isValid = false;
}

void OAINOTAMsByPolygon::fromJson(QString jsonString) {
...
QJsonObject OAINOTAMsByPolygon::asJsonObject() const {
    QJsonObject obj;
    if (m_poly_isSet) {
...
OAIObject OAINOTAMsByPolygon::getPoly() const {
    return m_poly;
}
void OAINOTAMsByPolygon::setPoly(const OAIObject &poly) {
    m_poly = poly;
    m_poly_isSet = true;
}

bool OAINOTAMsByPolygon::is_poly_Set() const{
    return m_poly_isSet;
}

bool OAINOTAMsByPolygon::is_poly_Valid() const{
    return m_poly_isValid;
}

bool OAINOTAMsByPolygon::isSet() const {
...
bool OAINOTAMsByPolygon::isValid() const {
