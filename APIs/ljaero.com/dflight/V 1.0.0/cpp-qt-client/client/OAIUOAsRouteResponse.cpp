...
OAIUOAsRouteResponse::OAIUOAsRouteResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUOAsRouteResponse::OAIUOAsRouteResponse() {
    this->initializeModel();
}

OAIUOAsRouteResponse::~OAIUOAsRouteResponse() {}

void OAIUOAsRouteResponse::initializeModel() {

    m_found_isSet = false;
    m_found_isValid = false;
}

void OAIUOAsRouteResponse::fromJson(QString jsonString) {
...
QJsonObject OAIUOAsRouteResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_found_isSet) {
...
OAIObject OAIUOAsRouteResponse::getFound() const {
    return m_found;
}
void OAIUOAsRouteResponse::setFound(const OAIObject &found) {
    m_found = found;
    m_found_isSet = true;
}

bool OAIUOAsRouteResponse::is_found_Set() const{
    return m_found_isSet;
}

bool OAIUOAsRouteResponse::is_found_Valid() const{
    return m_found_isValid;
}

bool OAIUOAsRouteResponse::isSet() const {
...
bool OAIUOAsRouteResponse::isValid() const {
