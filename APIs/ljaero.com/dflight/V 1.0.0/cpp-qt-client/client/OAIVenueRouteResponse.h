...
/*
 * OAIVenueRouteResponse.h
 *
 * 
 */

#ifndef OAIVenueRouteResponse_H
#define OAIVenueRouteResponse_H
...
class OAIVenueRouteResponse : public OAIObject {
public:
    OAIVenueRouteResponse();
    OAIVenueRouteResponse(QString json);
    ~OAIVenueRouteResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVenueRouteResponse)

#endif // OAIVenueRouteResponse_H
