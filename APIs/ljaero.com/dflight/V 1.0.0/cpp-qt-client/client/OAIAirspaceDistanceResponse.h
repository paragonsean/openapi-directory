...
/*
 * OAIAirspaceDistanceResponse.h
 *
 * 
 */

#ifndef OAIAirspaceDistanceResponse_H
#define OAIAirspaceDistanceResponse_H
...
class OAIAirspaceDistanceResponse : public OAIObject {
public:
    OAIAirspaceDistanceResponse();
    OAIAirspaceDistanceResponse(QString json);
    ~OAIAirspaceDistanceResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAirspaceDistanceResponse)

#endif // OAIAirspaceDistanceResponse_H
