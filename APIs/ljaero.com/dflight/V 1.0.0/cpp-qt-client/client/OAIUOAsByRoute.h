...
#ifndef OAIUOAsByRoute_H
#define OAIUOAsByRoute_H
...
class OAIUOAsByRoute : public OAIObject {
public:
    OAIUOAsByRoute();
    OAIUOAsByRoute(QString json);
    ~OAIUOAsByRoute() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUOAsByRoute)

#endif // OAIUOAsByRoute_H
