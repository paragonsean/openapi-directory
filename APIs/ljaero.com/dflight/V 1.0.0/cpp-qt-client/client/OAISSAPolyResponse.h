...
/*
 * OAISSAPolyResponse.h
 *
 * 
 */

#ifndef OAISSAPolyResponse_H
#define OAISSAPolyResponse_H
...
class OAISSAPolyResponse : public OAIObject {
public:
    OAISSAPolyResponse();
    OAISSAPolyResponse(QString json);
    ~OAISSAPolyResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISSAPolyResponse)

#endif // OAISSAPolyResponse_H
