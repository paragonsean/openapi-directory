...
/*
 * OAIVenuePolyResponse.h
 *
 * 
 */

#ifndef OAIVenuePolyResponse_H
#define OAIVenuePolyResponse_H
...
class OAIVenuePolyResponse : public OAIObject {
public:
    OAIVenuePolyResponse();
    OAIVenuePolyResponse(QString json);
    ~OAIVenuePolyResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVenuePolyResponse)

#endif // OAIVenuePolyResponse_H
