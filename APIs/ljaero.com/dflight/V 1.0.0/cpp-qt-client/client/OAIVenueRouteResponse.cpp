...
OAIVenueRouteResponse::OAIVenueRouteResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIVenueRouteResponse::OAIVenueRouteResponse() {
    this->initializeModel();
}

OAIVenueRouteResponse::~OAIVenueRouteResponse() {}

void OAIVenueRouteResponse::initializeModel() {

    m_found_isSet = false;
    m_found_isValid = false;
}

void OAIVenueRouteResponse::fromJson(QString jsonString) {
...
QJsonObject OAIVenueRouteResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_found_isSet) {
...
OAIObject OAIVenueRouteResponse::getFound() const {
    return m_found;
}
void OAIVenueRouteResponse::setFound(const OAIObject &found) {
    m_found = found;
    m_found_isSet = true;
}

bool OAIVenueRouteResponse::is_found_Set() const{
    return m_found_isSet;
}

bool OAIVenueRouteResponse::is_found_Valid() const{
    return m_found_isValid;
}

bool OAIVenueRouteResponse::isSet() const {
...
bool OAIVenueRouteResponse::isValid() const {
