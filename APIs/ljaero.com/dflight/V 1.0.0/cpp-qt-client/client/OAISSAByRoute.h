...
#ifndef OAISSAByRoute_H
#define OAISSAByRoute_H
...
class OAISSAByRoute : public OAIObject {
public:
    OAISSAByRoute();
    OAISSAByRoute(QString json);
    ~OAISSAByRoute() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISSAByRoute)

#endif // OAISSAByRoute_H
