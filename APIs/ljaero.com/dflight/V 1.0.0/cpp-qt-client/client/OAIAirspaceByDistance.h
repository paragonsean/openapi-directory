...
/*
 * OAIAirspaceByDistance.h
 *
 * Geometry-defining arguments for point/distance requests
 */

#ifndef OAIAirspaceByDistance_H
#define OAIAirspaceByDistance_H
...
class OAIAirspaceByDistance : public OAIObject {
public:
    OAIAirspaceByDistance();
    OAIAirspaceByDistance(QString json);
    ~OAIAirspaceByDistance() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAirspaceByDistance)

#endif // OAIAirspaceByDistance_H
