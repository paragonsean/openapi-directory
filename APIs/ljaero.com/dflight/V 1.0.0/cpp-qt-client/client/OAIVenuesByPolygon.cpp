...
OAIVenuesByPolygon::OAIVenuesByPolygon(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIVenuesByPolygon::OAIVenuesByPolygon() {
    this->initializeModel();
}

OAIVenuesByPolygon::~OAIVenuesByPolygon() {}

void OAIVenuesByPolygon::initializeModel() {

    m_poly_isSet = false;
    m_poly_isValid = false;
}

void OAIVenuesByPolygon::fromJson(QString jsonString) {
...
QJsonObject OAIVenuesByPolygon::asJsonObject() const {
    QJsonObject obj;
    if (m_poly_isSet) {
...
OAIObject OAIVenuesByPolygon::getPoly() const {
    return m_poly;
}
void OAIVenuesByPolygon::setPoly(const OAIObject &poly) {
    m_poly = poly;
    m_poly_isSet = true;
}

bool OAIVenuesByPolygon::is_poly_Set() const{
    return m_poly_isSet;
}

bool OAIVenuesByPolygon::is_poly_Valid() const{
    return m_poly_isValid;
}

bool OAIVenuesByPolygon::isSet() const {
...
bool OAIVenuesByPolygon::isValid() const {
