...
/*
 * OAIUOAsRouteResponse.h
 *
 * 
 */

#ifndef OAIUOAsRouteResponse_H
#define OAIUOAsRouteResponse_H
...
class OAIUOAsRouteResponse : public OAIObject {
public:
    OAIUOAsRouteResponse();
    OAIUOAsRouteResponse(QString json);
    ~OAIUOAsRouteResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUOAsRouteResponse)

#endif // OAIUOAsRouteResponse_H
