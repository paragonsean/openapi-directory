...
/*
 * OAINOTAMsRouteResponse.h
 *
 * 
 */

#ifndef OAINOTAMsRouteResponse_H
#define OAINOTAMsRouteResponse_H
...
class OAINOTAMsRouteResponse : public OAIObject {
public:
    OAINOTAMsRouteResponse();
    OAINOTAMsRouteResponse(QString json);
    ~OAINOTAMsRouteResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINOTAMsRouteResponse)

#endif // OAINOTAMsRouteResponse_H
