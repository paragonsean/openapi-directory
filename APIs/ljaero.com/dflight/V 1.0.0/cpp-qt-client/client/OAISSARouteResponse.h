...
/*
 * OAISSARouteResponse.h
 *
 * 
 */

#ifndef OAISSARouteResponse_H
#define OAISSARouteResponse_H
...
class OAISSARouteResponse : public OAIObject {
public:
    OAISSARouteResponse();
    OAISSARouteResponse(QString json);
    ~OAISSARouteResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISSARouteResponse)

#endif // OAISSARouteResponse_H
