...
/*
 * OAIObstaclePolyResponse.h
 *
 * 
 */

#ifndef OAIObstaclePolyResponse_H
#define OAIObstaclePolyResponse_H
...
class OAIObstaclePolyResponse : public OAIObject {
public:
    OAIObstaclePolyResponse();
    OAIObstaclePolyResponse(QString json);
    ~OAIObstaclePolyResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIObstaclePolyResponse)

#endif // OAIObstaclePolyResponse_H
