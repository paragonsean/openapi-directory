...
/*
 * OAIUOAsDistanceResponse.h
 *
 * 
 */

#ifndef OAIUOAsDistanceResponse_H
#define OAIUOAsDistanceResponse_H
...
class OAIUOAsDistanceResponse : public OAIObject {
public:
    OAIUOAsDistanceResponse();
    OAIUOAsDistanceResponse(QString json);
    ~OAIUOAsDistanceResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUOAsDistanceResponse)

#endif // OAIUOAsDistanceResponse_H
