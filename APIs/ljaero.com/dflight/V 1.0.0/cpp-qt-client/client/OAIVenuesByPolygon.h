...
/*
 * OAIVenuesByPolygon.h
 *
 * Geometry-defining arguments for polygon requests
 */

#ifndef OAIVenuesByPolygon_H
#define OAIVenuesByPolygon_H
...
class OAIVenuesByPolygon : public OAIObject {
public:
    OAIVenuesByPolygon();
    OAIVenuesByPolygon(QString json);
    ~OAIVenuesByPolygon() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVenuesByPolygon)

#endif // OAIVenuesByPolygon_H
