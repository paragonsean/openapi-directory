...
#ifndef OAIVenuesByRoute_H
#define OAIVenuesByRoute_H
...
class OAIVenuesByRoute : public OAIObject {
public:
    OAIVenuesByRoute();
    OAIVenuesByRoute(QString json);
    ~OAIVenuesByRoute() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVenuesByRoute)

#endif // OAIVenuesByRoute_H
