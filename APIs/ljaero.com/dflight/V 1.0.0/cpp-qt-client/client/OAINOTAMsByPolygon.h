...
/*
 * OAINOTAMsByPolygon.h
 *
 * Geometry-defining arguments for polygon requests
 */

#ifndef OAINOTAMsByPolygon_H
#define OAINOTAMsByPolygon_H
...
class OAINOTAMsByPolygon : public OAIObject {
public:
    OAINOTAMsByPolygon();
    OAINOTAMsByPolygon(QString json);
    ~OAINOTAMsByPolygon() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINOTAMsByPolygon)

#endif // OAINOTAMsByPolygon_H
