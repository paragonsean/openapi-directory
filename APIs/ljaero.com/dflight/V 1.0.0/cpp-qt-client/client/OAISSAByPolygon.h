...
#ifndef OAISSAByPolygon_H
#define OAISSAByPolygon_H
...
class OAISSAByPolygon : public OAIObject {
public:
    OAISSAByPolygon();
    OAISSAByPolygon(QString json);
    ~OAISSAByPolygon() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISSAByPolygon)

#endif // OAISSAByPolygon_H
