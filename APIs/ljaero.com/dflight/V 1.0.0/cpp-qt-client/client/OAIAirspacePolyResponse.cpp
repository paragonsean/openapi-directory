...
OAIAirspacePolyResponse::OAIAirspacePolyResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAirspacePolyResponse::OAIAirspacePolyResponse() {
    this->initializeModel();
}

OAIAirspacePolyResponse::~OAIAirspacePolyResponse() {}

void OAIAirspacePolyResponse::initializeModel() {

    m_found_isSet = false;
    m_found_isValid = false;
}

void OAIAirspacePolyResponse::fromJson(QString jsonString) {
...
QJsonObject OAIAirspacePolyResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_found.size() > 0) {
...
QList<OAIObject> OAIAirspacePolyResponse::getFound() const {
    return m_found;
}
void OAIAirspacePolyResponse::setFound(const QList<OAIObject> &found) {
    m_found = found;
    m_found_isSet = true;
}

bool OAIAirspacePolyResponse::is_found_Set() const{
    return m_found_isSet;
}

bool OAIAirspacePolyResponse::is_found_Valid() const{
    return m_found_isValid;
}

bool OAIAirspacePolyResponse::isSet() const {
...
bool OAIAirspacePolyResponse::isValid() const {
