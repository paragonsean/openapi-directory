...
OAIVenueDistanceResponse::OAIVenueDistanceResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIVenueDistanceResponse::OAIVenueDistanceResponse() {
    this->initializeModel();
}

OAIVenueDistanceResponse::~OAIVenueDistanceResponse() {}

void OAIVenueDistanceResponse::initializeModel() {

    m_found_isSet = false;
    m_found_isValid = false;
}

void OAIVenueDistanceResponse::fromJson(QString jsonString) {
...
QJsonObject OAIVenueDistanceResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_found_isSet) {
...
OAIObject OAIVenueDistanceResponse::getFound() const {
    return m_found;
}
void OAIVenueDistanceResponse::setFound(const OAIObject &found) {
    m_found = found;
    m_found_isSet = true;
}

bool OAIVenueDistanceResponse::is_found_Set() const{
    return m_found_isSet;
}

bool OAIVenueDistanceResponse::is_found_Valid() const{
    return m_found_isValid;
}

bool OAIVenueDistanceResponse::isSet() const {
...
bool OAIVenueDistanceResponse::isValid() const {
