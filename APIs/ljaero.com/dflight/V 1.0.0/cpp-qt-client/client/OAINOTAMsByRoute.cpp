...
OAINOTAMsByRoute::OAINOTAMsByRoute(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINOTAMsByRoute::OAINOTAMsByRoute() {
    this->initializeModel();
}

OAINOTAMsByRoute::~OAINOTAMsByRoute() {}

void OAINOTAMsByRoute::initializeModel() {

    m_route_isSet = false;
    m_route_isValid = false;
}

void OAINOTAMsByRoute::fromJson(QString jsonString) {
...
QJsonObject OAINOTAMsByRoute::asJsonObject() const {
    QJsonObject obj;
    if (m_route_isSet) {
...
OAIObject OAINOTAMsByRoute::getRoute() const {
    return m_route;
}
void OAINOTAMsByRoute::setRoute(const OAIObject &route) {
    m_route = route;
    m_route_isSet = true;
}

bool OAINOTAMsByRoute::is_route_Set() const{
    return m_route_isSet;
}

bool OAINOTAMsByRoute::is_route_Valid() const{
    return m_route_isValid;
}

bool OAINOTAMsByRoute::isSet() const {
...
bool OAINOTAMsByRoute::isValid() const {
