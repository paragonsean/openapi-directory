...
OAIUOAsDistanceResponse::OAIUOAsDistanceResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUOAsDistanceResponse::OAIUOAsDistanceResponse() {
    this->initializeModel();
}

OAIUOAsDistanceResponse::~OAIUOAsDistanceResponse() {}

void OAIUOAsDistanceResponse::initializeModel() {

    m_found_isSet = false;
    m_found_isValid = false;
}

void OAIUOAsDistanceResponse::fromJson(QString jsonString) {
...
QJsonObject OAIUOAsDistanceResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_found_isSet) {
...
OAIObject OAIUOAsDistanceResponse::getFound() const {
    return m_found;
}
void OAIUOAsDistanceResponse::setFound(const OAIObject &found) {
    m_found = found;
    m_found_isSet = true;
}

bool OAIUOAsDistanceResponse::is_found_Set() const{
    return m_found_isSet;
}

bool OAIUOAsDistanceResponse::is_found_Valid() const{
    return m_found_isValid;
}

bool OAIUOAsDistanceResponse::isSet() const {
...
bool OAIUOAsDistanceResponse::isValid() const {
