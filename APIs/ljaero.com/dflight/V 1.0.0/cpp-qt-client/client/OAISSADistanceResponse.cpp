...
OAISSADistanceResponse::OAISSADistanceResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISSADistanceResponse::OAISSADistanceResponse() {
    this->initializeModel();
}

OAISSADistanceResponse::~OAISSADistanceResponse() {}

void OAISSADistanceResponse::initializeModel() {

    m_found_isSet = false;
    m_found_isValid = false;
}

void OAISSADistanceResponse::fromJson(QString jsonString) {
...
QJsonObject OAISSADistanceResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_found_isSet) {
...
OAIObject OAISSADistanceResponse::getFound() const {
    return m_found;
}
void OAISSADistanceResponse::setFound(const OAIObject &found) {
    m_found = found;
    m_found_isSet = true;
}

bool OAISSADistanceResponse::is_found_Set() const{
    return m_found_isSet;
}

bool OAISSADistanceResponse::is_found_Valid() const{
    return m_found_isValid;
}

bool OAISSADistanceResponse::isSet() const {
...
bool OAISSADistanceResponse::isValid() const {
