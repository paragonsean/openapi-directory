...
#ifndef OAIUOAsByDistance_H
#define OAIUOAsByDistance_H
...
class OAIUOAsByDistance : public OAIObject {
public:
    OAIUOAsByDistance();
    OAIUOAsByDistance(QString json);
    ~OAIUOAsByDistance() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUOAsByDistance)

#endif // OAIUOAsByDistance_H
