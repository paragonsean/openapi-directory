...
#ifndef OAIUOAsByPolygon_H
#define OAIUOAsByPolygon_H
...
class OAIUOAsByPolygon : public OAIObject {
public:
    OAIUOAsByPolygon();
    OAIUOAsByPolygon(QString json);
    ~OAIUOAsByPolygon() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUOAsByPolygon)

#endif // OAIUOAsByPolygon_H
