...
OAINOTAMsDistanceResponse::OAINOTAMsDistanceResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINOTAMsDistanceResponse::OAINOTAMsDistanceResponse() {
    this->initializeModel();
}

OAINOTAMsDistanceResponse::~OAINOTAMsDistanceResponse() {}

void OAINOTAMsDistanceResponse::initializeModel() {

    m_found_isSet = false;
    m_found_isValid = false;
}

void OAINOTAMsDistanceResponse::fromJson(QString jsonString) {
...
QJsonObject OAINOTAMsDistanceResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_found_isSet) {
...
OAIObject OAINOTAMsDistanceResponse::getFound() const {
    return m_found;
}
void OAINOTAMsDistanceResponse::setFound(const OAIObject &found) {
    m_found = found;
    m_found_isSet = true;
}

bool OAINOTAMsDistanceResponse::is_found_Set() const{
    return m_found_isSet;
}

bool OAINOTAMsDistanceResponse::is_found_Valid() const{
    return m_found_isValid;
}

bool OAINOTAMsDistanceResponse::isSet() const {
...
bool OAINOTAMsDistanceResponse::isValid() const {
