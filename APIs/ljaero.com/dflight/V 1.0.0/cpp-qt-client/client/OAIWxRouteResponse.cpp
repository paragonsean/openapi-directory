...
OAIWxRouteResponse::OAIWxRouteResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIWxRouteResponse::OAIWxRouteResponse() {
    this->initializeModel();
}

OAIWxRouteResponse::~OAIWxRouteResponse() {}

void OAIWxRouteResponse::initializeModel() {

    m_found_isSet = false;
    m_found_isValid = false;
}

void OAIWxRouteResponse::fromJson(QString jsonString) {
...
QJsonObject OAIWxRouteResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_found_isSet) {
...
OAIObject OAIWxRouteResponse::getFound() const {
    return m_found;
}
void OAIWxRouteResponse::setFound(const OAIObject &found) {
    m_found = found;
    m_found_isSet = true;
}

bool OAIWxRouteResponse::is_found_Set() const{
    return m_found_isSet;
}

bool OAIWxRouteResponse::is_found_Valid() const{
    return m_found_isValid;
}

bool OAIWxRouteResponse::isSet() const {
...
bool OAIWxRouteResponse::isValid() const {
