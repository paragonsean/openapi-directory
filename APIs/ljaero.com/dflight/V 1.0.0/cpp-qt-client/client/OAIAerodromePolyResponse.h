...
/*
 * OAIAerodromePolyResponse.h
 *
 * 
 */

#ifndef OAIAerodromePolyResponse_H
#define OAIAerodromePolyResponse_H
...
class OAIAerodromePolyResponse : public OAIObject {
public:
    OAIAerodromePolyResponse();
    OAIAerodromePolyResponse(QString json);
    ~OAIAerodromePolyResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAerodromePolyResponse)

#endif // OAIAerodromePolyResponse_H
