...
OAIAirspaceRouteResponse::OAIAirspaceRouteResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAirspaceRouteResponse::OAIAirspaceRouteResponse() {
    this->initializeModel();
}

OAIAirspaceRouteResponse::~OAIAirspaceRouteResponse() {}

void OAIAirspaceRouteResponse::initializeModel() {

    m_found_isSet = false;
    m_found_isValid = false;
}

void OAIAirspaceRouteResponse::fromJson(QString jsonString) {
...
QJsonObject OAIAirspaceRouteResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_found.size() > 0) {
...
QList<OAIObject> OAIAirspaceRouteResponse::getFound() const {
    return m_found;
}
void OAIAirspaceRouteResponse::setFound(const QList<OAIObject> &found) {
    m_found = found;
    m_found_isSet = true;
}

bool OAIAirspaceRouteResponse::is_found_Set() const{
    return m_found_isSet;
}

bool OAIAirspaceRouteResponse::is_found_Valid() const{
    return m_found_isValid;
}

bool OAIAirspaceRouteResponse::isSet() const {
...
bool OAIAirspaceRouteResponse::isValid() const {
