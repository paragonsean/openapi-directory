...
/*
 * OAIWxRouteResponse.h
 *
 * 
 */

#ifndef OAIWxRouteResponse_H
#define OAIWxRouteResponse_H
...
class OAIWxRouteResponse : public OAIObject {
public:
    OAIWxRouteResponse();
    OAIWxRouteResponse(QString json);
    ~OAIWxRouteResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWxRouteResponse)

#endif // OAIWxRouteResponse_H
