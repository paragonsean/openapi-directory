...
OAIAerodromeDistanceResponse::OAIAerodromeDistanceResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAerodromeDistanceResponse::OAIAerodromeDistanceResponse() {
    this->initializeModel();
}

OAIAerodromeDistanceResponse::~OAIAerodromeDistanceResponse() {}

void OAIAerodromeDistanceResponse::initializeModel() {

    m_found_isSet = false;
    m_found_isValid = false;
}

void OAIAerodromeDistanceResponse::fromJson(QString jsonString) {
...
QJsonObject OAIAerodromeDistanceResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_found_isSet) {
...
OAIObject OAIAerodromeDistanceResponse::getFound() const {
    return m_found;
}
void OAIAerodromeDistanceResponse::setFound(const OAIObject &found) {
    m_found = found;
    m_found_isSet = true;
}

bool OAIAerodromeDistanceResponse::is_found_Set() const{
    return m_found_isSet;
}

bool OAIAerodromeDistanceResponse::is_found_Valid() const{
    return m_found_isValid;
}

bool OAIAerodromeDistanceResponse::isSet() const {
...
bool OAIAerodromeDistanceResponse::isValid() const {
