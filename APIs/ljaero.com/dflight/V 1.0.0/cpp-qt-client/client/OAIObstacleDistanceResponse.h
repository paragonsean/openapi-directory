...
/*
 * OAIObstacleDistanceResponse.h
 *
 * 
 */

#ifndef OAIObstacleDistanceResponse_H
#define OAIObstacleDistanceResponse_H
...
class OAIObstacleDistanceResponse : public OAIObject {
public:
    OAIObstacleDistanceResponse();
    OAIObstacleDistanceResponse(QString json);
    ~OAIObstacleDistanceResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIObstacleDistanceResponse)

#endif // OAIObstacleDistanceResponse_H
