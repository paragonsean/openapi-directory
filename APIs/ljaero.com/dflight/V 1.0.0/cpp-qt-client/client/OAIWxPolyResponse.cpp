...
OAIWxPolyResponse::OAIWxPolyResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIWxPolyResponse::OAIWxPolyResponse() {
    this->initializeModel();
}

OAIWxPolyResponse::~OAIWxPolyResponse() {}

void OAIWxPolyResponse::initializeModel() {

    m_found_isSet = false;
    m_found_isValid = false;
}

void OAIWxPolyResponse::fromJson(QString jsonString) {
...
QJsonObject OAIWxPolyResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_found_isSet) {
...
OAIObject OAIWxPolyResponse::getFound() const {
    return m_found;
}
void OAIWxPolyResponse::setFound(const OAIObject &found) {
    m_found = found;
    m_found_isSet = true;
}

bool OAIWxPolyResponse::is_found_Set() const{
    return m_found_isSet;
}

bool OAIWxPolyResponse::is_found_Valid() const{
    return m_found_isValid;
}

bool OAIWxPolyResponse::isSet() const {
...
bool OAIWxPolyResponse::isValid() const {
