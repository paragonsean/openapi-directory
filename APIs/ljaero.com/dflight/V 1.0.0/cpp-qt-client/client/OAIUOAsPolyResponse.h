...
/*
 * OAIUOAsPolyResponse.h
 *
 * 
 */

#ifndef OAIUOAsPolyResponse_H
#define OAIUOAsPolyResponse_H
...
class OAIUOAsPolyResponse : public OAIObject {
public:
    OAIUOAsPolyResponse();
    OAIUOAsPolyResponse(QString json);
    ~OAIUOAsPolyResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUOAsPolyResponse)

#endif // OAIUOAsPolyResponse_H
