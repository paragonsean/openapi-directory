...
/*
 * OAIObstaclesByDistance.h
 *
 * Geometry-defining arguments for point/distance requests
 */

#ifndef OAIObstaclesByDistance_H
#define OAIObstaclesByDistance_H
...
class OAIObstaclesByDistance : public OAIObject {
public:
    OAIObstaclesByDistance();
    OAIObstaclesByDistance(QString json);
    ~OAIObstaclesByDistance() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIObstaclesByDistance)

#endif // OAIObstaclesByDistance_H
