...
/*
 * OAINOTAMsDistanceResponse.h
 *
 * 
 */

#ifndef OAINOTAMsDistanceResponse_H
#define OAINOTAMsDistanceResponse_H
...
class OAINOTAMsDistanceResponse : public OAIObject {
public:
    OAINOTAMsDistanceResponse();
    OAINOTAMsDistanceResponse(QString json);
    ~OAINOTAMsDistanceResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINOTAMsDistanceResponse)

#endif // OAINOTAMsDistanceResponse_H
