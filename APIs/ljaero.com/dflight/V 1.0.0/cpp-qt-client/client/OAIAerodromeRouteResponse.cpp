...
OAIAerodromeRouteResponse::OAIAerodromeRouteResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAerodromeRouteResponse::OAIAerodromeRouteResponse() {
    this->initializeModel();
}

OAIAerodromeRouteResponse::~OAIAerodromeRouteResponse() {}

void OAIAerodromeRouteResponse::initializeModel() {

    m_found_isSet = false;
    m_found_isValid = false;
}

void OAIAerodromeRouteResponse::fromJson(QString jsonString) {
...
QJsonObject OAIAerodromeRouteResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_found_isSet) {
...
OAIObject OAIAerodromeRouteResponse::getFound() const {
    return m_found;
}
void OAIAerodromeRouteResponse::setFound(const OAIObject &found) {
    m_found = found;
    m_found_isSet = true;
}

bool OAIAerodromeRouteResponse::is_found_Set() const{
    return m_found_isSet;
}

bool OAIAerodromeRouteResponse::is_found_Valid() const{
    return m_found_isValid;
}

bool OAIAerodromeRouteResponse::isSet() const {
...
bool OAIAerodromeRouteResponse::isValid() const {
