...
/*
 * OAIObstaclesByPolygon.h
 *
 * Geometry-defining arguments for polygon requests
 */

#ifndef OAIObstaclesByPolygon_H
#define OAIObstaclesByPolygon_H
...
class OAIObstaclesByPolygon : public OAIObject {
public:
    OAIObstaclesByPolygon();
    OAIObstaclesByPolygon(QString json);
    ~OAIObstaclesByPolygon() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIObstaclesByPolygon)

#endif // OAIObstaclesByPolygon_H
