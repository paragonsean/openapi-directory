...
OAINOTAMsRouteResponse::OAINOTAMsRouteResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINOTAMsRouteResponse::OAINOTAMsRouteResponse() {
    this->initializeModel();
}

OAINOTAMsRouteResponse::~OAINOTAMsRouteResponse() {}

void OAINOTAMsRouteResponse::initializeModel() {

    m_found_isSet = false;
    m_found_isValid = false;
}

void OAINOTAMsRouteResponse::fromJson(QString jsonString) {
...
QJsonObject OAINOTAMsRouteResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_found_isSet) {
...
OAIObject OAINOTAMsRouteResponse::getFound() const {
    return m_found;
}
void OAINOTAMsRouteResponse::setFound(const OAIObject &found) {
    m_found = found;
    m_found_isSet = true;
}

bool OAINOTAMsRouteResponse::is_found_Set() const{
    return m_found_isSet;
}

bool OAINOTAMsRouteResponse::is_found_Valid() const{
    return m_found_isValid;
}

bool OAINOTAMsRouteResponse::isSet() const {
...
bool OAINOTAMsRouteResponse::isValid() const {
