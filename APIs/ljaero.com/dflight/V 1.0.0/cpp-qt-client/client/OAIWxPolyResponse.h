...
#ifndef OAIWxPolyResponse_H
#define OAIWxPolyResponse_H
...
class OAIWxPolyResponse : public OAIObject {
public:
    OAIWxPolyResponse();
    OAIWxPolyResponse(QString json);
    ~OAIWxPolyResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWxPolyResponse)

#endif // OAIWxPolyResponse_H
