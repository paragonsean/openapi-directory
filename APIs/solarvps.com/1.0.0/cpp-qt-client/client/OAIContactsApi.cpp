...
void OAIContactsApi::contactsGet() {
...
void OAIContactsApi::contactsGetCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT contactsGetSignal();
        Q_EMIT contactsGetSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT contactsGetSignalE(error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT contactsGetSignalError(error_type, error_str);
