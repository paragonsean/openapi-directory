...
public class UserList {
  ...
  private List<SingleUser> values = new ArrayList<>();

  public UserList() {
  }

  public UserList values(List<SingleUser> values) {
    this.values = values;
    return this;
  }

  public UserList addValuesItem(SingleUser valuesItem) {
    if (this.values == null) {
  ...
  public List<SingleUser> getValues() {
    return values;
  }

  public void setValues(List<SingleUser> values) {
    this.values = values;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.values, userList.values);
  }
      ...
      if (jsonObj.get("values") != null && !jsonObj.get("values").isJsonNull()) {
        ...
        if (jsonArrayvalues != null) {
          ...
          for (int i = 0; i < jsonArrayvalues.size(); i++) {
            SingleUser.validateJsonElement(jsonArrayvalues.get(i));
          };
        }
      }
  }
