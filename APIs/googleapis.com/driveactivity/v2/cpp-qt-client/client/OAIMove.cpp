...
QList<OAITargetReference> OAIMove::getAddedParents() const {
    return m_added_parents;
}
void OAIMove::setAddedParents(const QList<OAITargetReference> &added_parents) {
...
QList<OAITargetReference> OAIMove::getRemovedParents() const {
    return m_removed_parents;
}
void OAIMove::setRemovedParents(const QList<OAITargetReference> &removed_parents) {
