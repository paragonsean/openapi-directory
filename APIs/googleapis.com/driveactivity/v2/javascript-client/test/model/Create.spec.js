...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DriveActivityApi.Create();
  });
  ...
  describe('Create', function() {
    it('should create an instance of Create', function() {
      // uncomment below and update the code to test Create
      //var instance = new DriveActivityApi.Create();
      //expect(instance).to.be.a(DriveActivityApi.Create);
    });
