...
void OAIModelsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("bigquery_models_delete", defaultConf);
    _serverIndices.insert("bigquery_models_delete", 0);
    _serverConfigs.insert("bigquery_models_get", defaultConf);
    _serverIndices.insert("bigquery_models_get", 0);
    _serverConfigs.insert("bigquery_models_list", defaultConf);
    _serverIndices.insert("bigquery_models_list", 0);
    _serverConfigs.insert("bigquery_models_patch", defaultConf);
    _serverIndices.insert("bigquery_models_patch", 0);
}
...
void OAIModelsApi::bigquery_models_delete(const QString &project_id, const QString &dataset_id, const QString &model_id, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type) {
    QString fullPath = QString(_serverConfigs["bigquery_models_delete"][_serverIndices.value("bigquery_models_delete")].URL()+"/projects/{projectId}/datasets/{datasetId}/models/{modelId}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIModelsApi::bigquery_models_deleteCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIModelsApi::bigquery_models_deleteCallback);
...
void OAIModelsApi::bigquery_models_deleteCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT bigquery_models_deleteSignal();
        Q_EMIT bigquery_models_deleteSignalFull(worker);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT bigquery_models_deleteSignalE(error_type, error_str);
        Q_EMIT bigquery_models_deleteSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT bigquery_models_deleteSignalError(error_type, error_str);
        Q_EMIT bigquery_models_deleteSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIModelsApi::bigquery_models_get(const QString &project_id, const QString &dataset_id, const QString &model_id, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type) {
    QString fullPath = QString(_serverConfigs["bigquery_models_get"][_serverIndices.value("bigquery_models_get")].URL()+"/projects/{projectId}/datasets/{datasetId}/models/{modelId}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIModelsApi::bigquery_models_getCallback);
    connect(this, &OAIModelsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIModelsApi::bigquery_models_getCallback);
    connect(this, &OAIModelsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIModelsApi::bigquery_models_getCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT bigquery_models_getSignal(output);
        Q_EMIT bigquery_models_getSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        QString scopeStr = scope.join(" ");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT bigquery_models_getSignalE(output, error_type, error_str);
        Q_EMIT bigquery_models_getSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT bigquery_models_getSignalError(output, error_type, error_str);
        Q_EMIT bigquery_models_getSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIModelsApi::bigquery_models_list(const QString &project_id, const QString &dataset_id, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<qint32> &max_results, const ::OpenAPI::OptionalParam<QString> &page_token) {
    QString fullPath = QString(_serverConfigs["bigquery_models_list"][_serverIndices.value("bigquery_models_list")].URL()+"/projects/{projectId}/datasets/{datasetId}/models");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIModelsApi::bigquery_models_listCallback);
    connect(this, &OAIModelsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIModelsApi::bigquery_models_listCallback);
    connect(this, &OAIModelsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIModelsApi::bigquery_models_listCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT bigquery_models_listSignal(output);
        Q_EMIT bigquery_models_listSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        QString scopeStr = scope.join(" ");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT bigquery_models_listSignalE(output, error_type, error_str);
        Q_EMIT bigquery_models_listSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT bigquery_models_listSignalError(output, error_type, error_str);
        Q_EMIT bigquery_models_listSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIModelsApi::bigquery_models_patch(const QString &project_id, const QString &dataset_id, const QString &model_id, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<OAIModel> &oai_model) {
    QString fullPath = QString(_serverConfigs["bigquery_models_patch"][_serverIndices.value("bigquery_models_patch")].URL()+"/projects/{projectId}/datasets/{datasetId}/models/{modelId}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIModelsApi::bigquery_models_patchCallback);
    connect(this, &OAIModelsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIModelsApi::bigquery_models_patchCallback);
    connect(this, &OAIModelsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIModelsApi::bigquery_models_patchCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT bigquery_models_patchSignal(output);
        Q_EMIT bigquery_models_patchSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        QString scopeStr = scope.join(" ");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT bigquery_models_patchSignalE(output, error_type, error_str);
        Q_EMIT bigquery_models_patchSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT bigquery_models_patchSignalError(output, error_type, error_str);
        Q_EMIT bigquery_models_patchSignalErrorFull(worker, error_type, error_str);
    }
}
