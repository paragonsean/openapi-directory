...
#include "OAIRowAccessPoliciesApi.h"
...
OAIRowAccessPoliciesApi::OAIRowAccessPoliciesApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIRowAccessPoliciesApi::~OAIRowAccessPoliciesApi() {
}

void OAIRowAccessPoliciesApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("bigquery_rowAccessPolicies_list", defaultConf);
    _serverIndices.insert("bigquery_rowAccessPolicies_list", 0);
}
...
*/
int OAIRowAccessPoliciesApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIRowAccessPoliciesApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIRowAccessPoliciesApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIRowAccessPoliciesApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIRowAccessPoliciesApi::setUsername(const QString &username) {
    _username = username;
}

void OAIRowAccessPoliciesApi::setPassword(const QString &password) {
    _password = password;
}


void OAIRowAccessPoliciesApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIRowAccessPoliciesApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIRowAccessPoliciesApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIRowAccessPoliciesApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIRowAccessPoliciesApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIRowAccessPoliciesApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIRowAccessPoliciesApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIRowAccessPoliciesApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIRowAccessPoliciesApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIRowAccessPoliciesApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIRowAccessPoliciesApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIRowAccessPoliciesApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIRowAccessPoliciesApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIRowAccessPoliciesApi::bigquery_rowAccessPolicies_list(const QString &project_id, const QString &dataset_id, const QString &table_id, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &page_token) {
    QString fullPath = QString(_serverConfigs["bigquery_rowAccessPolicies_list"][_serverIndices.value("bigquery_rowAccessPolicies_list")].URL()+"/projects/{projectId}/datasets/{datasetId}/tables/{tableId}/rowAccessPolicies");
    ...
    {
        QString table_idPathParam("{");
        table_idPathParam.append("tableId").append("}");
        QString pathPrefix, pathSuffix, pathDelimiter;
        QString pathStyle = "simple";
        if (pathStyle == "")
            pathStyle = "simple";
        pathPrefix = getParamStylePrefix(pathStyle);
        pathSuffix = getParamStyleSuffix(pathStyle);
        pathDelimiter = getParamStyleDelimiter(pathStyle, "tableId", false);
        QString paramString = (pathStyle == "matrix") ? pathPrefix+"tableId"+pathSuffix : pathPrefix;
        fullPath.replace(table_idPathParam, paramString+QUrl::toPercentEncoding(::OpenAPI::toStringValue(table_id)));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIRowAccessPoliciesApi::bigquery_rowAccessPolicies_listCallback);
    connect(this, &OAIRowAccessPoliciesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIRowAccessPoliciesApi::bigquery_rowAccessPolicies_listCallback);
    connect(this, &OAIRowAccessPoliciesApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
...
void OAIRowAccessPoliciesApi::bigquery_rowAccessPolicies_listCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIListRowAccessPoliciesResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT bigquery_rowAccessPolicies_listSignal(output);
        Q_EMIT bigquery_rowAccessPolicies_listSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT bigquery_rowAccessPolicies_listSignalE(output, error_type, error_str);
        Q_EMIT bigquery_rowAccessPolicies_listSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT bigquery_rowAccessPolicies_listSignalError(output, error_type, error_str);
        Q_EMIT bigquery_rowAccessPolicies_listSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIRowAccessPoliciesApi::tokenAvailable(){
