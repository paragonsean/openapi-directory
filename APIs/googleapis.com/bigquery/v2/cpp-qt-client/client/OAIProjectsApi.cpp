...
void OAIProjectsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("bigquery_projects_getServiceAccount", defaultConf);
    _serverIndices.insert("bigquery_projects_getServiceAccount", 0);
    _serverConfigs.insert("bigquery_projects_list", defaultConf);
    _serverIndices.insert("bigquery_projects_list", 0);
}
...
void OAIProjectsApi::bigquery_projects_getServiceAccount(const QString &project_id, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type) {
    QString fullPath = QString(_serverConfigs["bigquery_projects_getServiceAccount"][_serverIndices.value("bigquery_projects_getServiceAccount")].URL()+"/projects/{projectId}/serviceAccount");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::bigquery_projects_getServiceAccountCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::bigquery_projects_getServiceAccountCallback);
...
void OAIProjectsApi::bigquery_projects_getServiceAccountCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIGetServiceAccountResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT bigquery_projects_getServiceAccountSignal(output);
        Q_EMIT bigquery_projects_getServiceAccountSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT bigquery_projects_getServiceAccountSignalE(output, error_type, error_str);
        Q_EMIT bigquery_projects_getServiceAccountSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT bigquery_projects_getServiceAccountSignalError(output, error_type, error_str);
        Q_EMIT bigquery_projects_getServiceAccountSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectsApi::bigquery_projects_list(const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<qint32> &max_results, const ::OpenAPI::OptionalParam<QString> &page_token) {
    QString fullPath = QString(_serverConfigs["bigquery_projects_list"][_serverIndices.value("bigquery_projects_list")].URL()+"/projects");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::bigquery_projects_listCallback);
    connect(this, &OAIProjectsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::bigquery_projects_listCallback);
    connect(this, &OAIProjectsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectsApi::bigquery_projects_listCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT bigquery_projects_listSignal(output);
        Q_EMIT bigquery_projects_listSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        QString scopeStr = scope.join(" ");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT bigquery_projects_listSignalE(output, error_type, error_str);
        Q_EMIT bigquery_projects_listSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT bigquery_projects_listSignalError(output, error_type, error_str);
        Q_EMIT bigquery_projects_listSignalErrorFull(worker, error_type, error_str);
    }
}
