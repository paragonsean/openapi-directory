...
namespace OpenAPI {
class OAIProjectList_projects_inner;
...
public:
    ...
    QList<OAIProjectList_projects_inner> getProjects() const;
    void setProjects(const QList<OAIProjectList_projects_inner> &projects);
...
private:
    ...
    QList<OAIProjectList_projects_inner> m_projects;
