...
namespace OpenAPI {
class OAIDatasetList_datasets_inner;
...
public:
    ...
    QList<OAIDatasetList_datasets_inner> getDatasets() const;
    void setDatasets(const QList<OAIDatasetList_datasets_inner> &datasets);
...
private:
    ...
    QList<OAIDatasetList_datasets_inner> m_datasets;
