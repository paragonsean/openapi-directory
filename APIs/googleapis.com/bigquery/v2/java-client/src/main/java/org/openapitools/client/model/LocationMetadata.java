...
public class LocationMetadata {
  public static final String SERIALIZED_NAME_LEGACY_LOCATION_ID = "legacyLocationId";
  @SerializedName(SERIALIZED_NAME_LEGACY_LOCATION_ID)
  ...
  static {
    ...
    openapiFields.add("legacyLocationId");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("legacyLocationId") != null && !jsonObj.get("legacyLocationId").isJsonNull()) && !jsonObj.get("legacyLocationId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `legacyLocationId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("legacyLocationId").toString()));
      }
  }
