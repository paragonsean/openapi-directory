...
public class VectorSearchStatistics {
  ...
  public VectorSearchStatistics() {
  }

  public VectorSearchStatistics indexUnusedReasons(List<IndexUnusedReason> indexUnusedReasons) {
    this.indexUnusedReasons = indexUnusedReasons;
    return this;
  }

  public VectorSearchStatistics addIndexUnusedReasonsItem(IndexUnusedReason indexUnusedReasonsItem) {
  ...
  public VectorSearchStatistics indexUsageMode(IndexUsageModeEnum indexUsageMode) {
  ...
  public boolean equals(Object o) {
    ...
    VectorSearchStatistics vectorSearchStatistics = (VectorSearchStatistics) o;
    return Objects.equals(this.indexUnusedReasons, vectorSearchStatistics.indexUnusedReasons) &&
        Objects.equals(this.indexUsageMode, vectorSearchStatistics.indexUsageMode);
  }
  ...
  public String toString() {
    ...
    sb.append("class VectorSearchStatistics {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to VectorSearchStatistics
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VectorSearchStatistics.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VectorSearchStatistics is not found in the empty JSON string", VectorSearchStatistics.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VectorSearchStatistics.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VectorSearchStatistics` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VectorSearchStatistics.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VectorSearchStatistics' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VectorSearchStatistics> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VectorSearchStatistics.class));

       return (TypeAdapter<T>) new TypeAdapter<VectorSearchStatistics>() {
           @Override
           public void write(JsonWriter out, VectorSearchStatistics value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public VectorSearchStatistics read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of VectorSearchStatistics given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of VectorSearchStatistics
   * @throws IOException if the JSON string is invalid with respect to VectorSearchStatistics
   */
  public static VectorSearchStatistics fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VectorSearchStatistics.class);
  }

  /**
   * Convert an instance of VectorSearchStatistics to an JSON string
   *
   * @return JSON string
   */
