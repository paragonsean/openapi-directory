...
|**kind** | **String** | Output only. The resource type. |  [optional] [readonly] |
|**labels** | **Map&lt;String, String&gt;** | The labels associated with this dataset. You can use these to organize and group your datasets. You can set this property when inserting or updating a dataset. See Creating and Updating Dataset Labels for more information. |  [optional] |
...
|**storageBillingModel** | [**StorageBillingModelEnum**](#StorageBillingModelEnum) | Optional. Updates storage_billing_model for the dataset. |  [optional] |
