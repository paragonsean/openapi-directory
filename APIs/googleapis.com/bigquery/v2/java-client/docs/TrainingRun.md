...
|------------ | ------------- | ------------- | -------------|
|**classLevelGlobalExplanations** | [**List&lt;GlobalExplanation&gt;**](GlobalExplanation.md) | Output only. Global explanation contains the explanation of top features on the class level. Applies to classification models only. |  [optional] [readonly] |
