...
|**roundingMode** | [**RoundingModeEnum**](#RoundingModeEnum) | Optional. Specifies the rounding mode to be used when storing values of NUMERIC and BIGNUMERIC type. |  [optional] |
