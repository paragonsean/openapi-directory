...
|**kind** | **String** | Optional. The resource type of the response. The value is not checked at the backend. Historically, it has been set to \&quot;bigquery#tableDataInsertAllRequest\&quot; but you are not required to set it. |  [optional] |
