# BigQueryApi.DatasetList

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**datasets** | [**[DatasetListDatasetsInner]**](DatasetListDatasetsInner.md) | An array of the dataset resources in the project. Each resource contains basic information. For full information about a particular dataset resource, use the Datasets: get method. This property is omitted when there are no datasets in the project. | [optional] 
...
**kind** | **String** | Output only. The resource type. This property always returns the value \&quot;bigquery#datasetList\&quot; | [optional] [readonly] [default to &#39;bigquery#datasetList&#39;]
