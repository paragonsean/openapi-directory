# BigQueryApi.MaterializedViewDefinition
...
**maxStaleness** | **Blob** | [Optional] Max staleness of data that could be returned when materizlized view is queried (formatted as Google SQL Interval type). | [optional] 
