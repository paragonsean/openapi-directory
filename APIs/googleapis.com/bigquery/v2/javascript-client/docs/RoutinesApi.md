...
> bigqueryRoutinesDelete(projectId, datasetId, routineId, opts)
...
let apiInstance = new BigQueryApi.RoutinesApi();
let projectId = "projectId_example"; // String | Required. Project ID of the routine to delete
let datasetId = "datasetId_example"; // String | Required. Dataset ID of the routine to delete
let routineId = "routineId_example"; // String | Required. Routine ID of the routine to delete
let opts = {
...
apiInstance.bigqueryRoutinesDelete(projectId, datasetId, routineId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> Routine bigqueryRoutinesGet(projectId, datasetId, routineId, opts)
...
let apiInstance = new BigQueryApi.RoutinesApi();
let projectId = "projectId_example"; // String | Required. Project ID of the requested routine
let datasetId = "datasetId_example"; // String | Required. Dataset ID of the requested routine
let routineId = "routineId_example"; // String | Required. Routine ID of the requested routine
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'readMask': "readMask_example" // String | If set, only the Routine fields in the field mask are returned in the response. If unset, all Routine fields are returned.
};
apiInstance.bigqueryRoutinesGet(projectId, datasetId, routineId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> Routine bigqueryRoutinesInsert(projectId, datasetId, opts)
...
let apiInstance = new BigQueryApi.RoutinesApi();
let projectId = "projectId_example"; // String | Required. Project ID of the new routine
let datasetId = "datasetId_example"; // String | Required. Dataset ID of the new routine
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'routine': new BigQueryApi.Routine() // Routine | 
};
apiInstance.bigqueryRoutinesInsert(projectId, datasetId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ListRoutinesResponse bigqueryRoutinesList(projectId, datasetId, opts)
...
let apiInstance = new BigQueryApi.RoutinesApi();
let projectId = "projectId_example"; // String | Required. Project ID of the routines to list
let datasetId = "datasetId_example"; // String | Required. Dataset ID of the routines to list
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'filter': "filter_example", // String | If set, then only the Routines matching this filter are returned. The supported format is `routineType:{RoutineType}`, where `{RoutineType}` is a RoutineType enum. For example: `routineType:SCALAR_FUNCTION`.
  ...
  'readMask': "readMask_example" // String | If set, then only the Routine fields in the field mask, as well as project_id, dataset_id and routine_id, are returned in the response. If unset, then the following Routine fields are returned: etag, project_id, dataset_id, routine_id, routine_type, creation_time, last_modified_time, and language.
};
apiInstance.bigqueryRoutinesList(projectId, datasetId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Routine bigqueryRoutinesUpdate(projectId, datasetId, routineId, opts)
...
let apiInstance = new BigQueryApi.RoutinesApi();
let projectId = "projectId_example"; // String | Required. Project ID of the routine to update
let datasetId = "datasetId_example"; // String | Required. Dataset ID of the routine to update
let routineId = "routineId_example"; // String | Required. Routine ID of the routine to update
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
apiInstance.bigqueryRoutinesUpdate(projectId, datasetId, routineId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
