# BigQueryApi.JobStatistics

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**completionRatio** | **Number** | Output only. [TrustedTester] Job progress (0.0 -&gt; 1.0) for LOAD and EXTRACT jobs. | [optional] [readonly] 
...
**quotaDeferments** | **[String]** | Output only. Quotas which delayed this job&#39;s start time. | [optional] [readonly] 
**reservationUsage** | [**[JobStatisticsReservationUsageInner]**](JobStatisticsReservationUsageInner.md) | Output only. Job resource usage breakdown by reservation. This field reported misleading information and will no longer be populated. | [optional] [readonly] 
