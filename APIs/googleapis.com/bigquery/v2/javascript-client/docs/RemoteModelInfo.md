...
**remoteServiceType** | **String** | Output only. The remote service type for remote model. | [optional] [readonly] 
...
* `REMOTE_SERVICE_TYPE_UNSPECIFIED` (value: `"REMOTE_SERVICE_TYPE_UNSPECIFIED"`)

* `CLOUD_AI_TRANSLATE_V3` (value: `"CLOUD_AI_TRANSLATE_V3"`)

* `CLOUD_AI_VISION_V1` (value: `"CLOUD_AI_VISION_V1"`)

* `CLOUD_AI_NATURAL_LANGUAGE_V1` (value: `"CLOUD_AI_NATURAL_LANGUAGE_V1"`)

* `CLOUD_AI_SPEECH_TO_TEXT_V2` (value: `"CLOUD_AI_SPEECH_TO_TEXT_V2"`)
