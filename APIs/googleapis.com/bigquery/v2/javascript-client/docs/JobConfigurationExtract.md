# BigQueryApi.JobConfigurationExtract
...
**destinationUris** | **[String]** | [Pick one] A list of fully-qualified Google Cloud Storage URIs where the extracted table should be written. | [optional] 
...
**printHeader** | **Boolean** | Optional. Whether to print out a header row in the results. Default is true. Not applicable when extracting models. | [optional] [default to true]
