...
> bigqueryTablesDelete(projectId, datasetId, tableId, opts)
...
let apiInstance = new BigQueryApi.TablesApi();
let projectId = "projectId_example"; // String | Required. Project ID of the table to delete
let datasetId = "datasetId_example"; // String | Required. Dataset ID of the table to delete
let tableId = "tableId_example"; // String | Required. Table ID of the table to delete
let opts = {
...
apiInstance.bigqueryTablesDelete(projectId, datasetId, tableId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> Table bigqueryTablesGet(projectId, datasetId, tableId, opts)
...
let apiInstance = new BigQueryApi.TablesApi();
let projectId = "projectId_example"; // String | Required. Project ID of the requested table
let datasetId = "datasetId_example"; // String | Required. Dataset ID of the requested table
let tableId = "tableId_example"; // String | Required. Table ID of the requested table
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'selectedFields': "selectedFields_example", // String | List of table schema fields to return (comma-separated). If unspecified, all fields are returned. A fieldMask cannot be used here because the fields will automatically be converted from camelCase to snake_case and the conversion will fail if there are underscores. Since these are fields in BigQuery table schemas, underscores are allowed.
  'view': "view_example" // String | Optional. Specifies the view that determines which table information is returned. By default, basic table information and storage statistics (STORAGE_STATS) are returned.
};
apiInstance.bigqueryTablesGet(projectId, datasetId, tableId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
 ...
 **view** | **String**| Optional. Specifies the view that determines which table information is returned. By default, basic table information and storage statistics (STORAGE_STATS) are returned. | [optional] 
...
> Policy bigqueryTablesGetIamPolicy(resource, opts)
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'getIamPolicyRequest': new BigQueryApi.GetIamPolicyRequest() // GetIamPolicyRequest | 
};
apiInstance.bigqueryTablesGetIamPolicy(resource, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Table bigqueryTablesInsert(projectId, datasetId, opts)
...
let apiInstance = new BigQueryApi.TablesApi();
let projectId = "projectId_example"; // String | Required. Project ID of the new table
let datasetId = "datasetId_example"; // String | Required. Dataset ID of the new table
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'table': new BigQueryApi.Table() // Table | 
};
apiInstance.bigqueryTablesInsert(projectId, datasetId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> TableList bigqueryTablesList(projectId, datasetId, opts)
...
let apiInstance = new BigQueryApi.TablesApi();
let projectId = "projectId_example"; // String | Required. Project ID of the tables to list
let datasetId = "datasetId_example"; // String | Required. Dataset ID of the tables to list
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
apiInstance.bigqueryTablesList(projectId, datasetId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Table bigqueryTablesPatch(projectId, datasetId, tableId, opts)
...
let apiInstance = new BigQueryApi.TablesApi();
let projectId = "projectId_example"; // String | Required. Project ID of the table to update
let datasetId = "datasetId_example"; // String | Required. Dataset ID of the table to update
let tableId = "tableId_example"; // String | Required. Table ID of the table to update
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'autodetectSchema': true, // Boolean | Optional.  When true will autodetect schema, else will keep original schema
  'table': new BigQueryApi.Table() // Table | 
};
apiInstance.bigqueryTablesPatch(projectId, datasetId, tableId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Policy bigqueryTablesSetIamPolicy(resource, opts)
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'setIamPolicyRequest': new BigQueryApi.SetIamPolicyRequest() // SetIamPolicyRequest | 
};
apiInstance.bigqueryTablesSetIamPolicy(resource, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> TestIamPermissionsResponse bigqueryTablesTestIamPermissions(resource, opts)
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'testIamPermissionsRequest': new BigQueryApi.TestIamPermissionsRequest() // TestIamPermissionsRequest | 
};
apiInstance.bigqueryTablesTestIamPermissions(resource, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Table bigqueryTablesUpdate(projectId, datasetId, tableId, opts)
...
apiInstance.bigqueryTablesUpdate(projectId, datasetId, tableId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
