...
/**
 * The SearchStatistics model module.
 * @module model/SearchStatistics
 * @version v2
 */
class SearchStatistics {
    /**
     * Constructs a new <code>SearchStatistics</code>.
     * Statistics for a search query. Populated as part of JobStatistics2.
     * @alias module:model/SearchStatistics
     */
    constructor() { 
        
        SearchStatistics.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SearchStatistics</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SearchStatistics} obj Optional instance to populate.
     * @return {module:model/SearchStatistics} The populated <code>SearchStatistics</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SearchStatistics();
    ...
    /**
     * Validates the JSON data with respect to <code>SearchStatistics</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SearchStatistics</code>.
     */
 ...
 */
SearchStatistics.prototype['indexUnusedReasons'] = undefined;

/**
 * Specifies the index usage mode for the query.
 * @member {module:model/SearchStatistics.IndexUsageModeEnum} indexUsageMode
 */
SearchStatistics.prototype['indexUsageMode'] = undefined;
 ...
 * @readonly
 */
SearchStatistics['IndexUsageModeEnum'] = {
