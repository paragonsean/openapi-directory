...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BigQueryApi.ListRoutinesResponse();
  });
  ...
  describe('ListRoutinesResponse', function() {
    it('should create an instance of ListRoutinesResponse', function() {
      // uncomment below and update the code to test ListRoutinesResponse
      //var instance = new BigQueryApi.ListRoutinesResponse();
      //expect(instance).to.be.a(BigQueryApi.ListRoutinesResponse);
    });
