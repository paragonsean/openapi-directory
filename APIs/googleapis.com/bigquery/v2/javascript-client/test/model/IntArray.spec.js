...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BigQueryApi.IntArray();
  });
  ...
  describe('IntArray', function() {
    it('should create an instance of IntArray', function() {
      // uncomment below and update the code to test IntArray
      //var instance = new BigQueryApi.IntArray();
      //expect(instance).to.be.a(BigQueryApi.IntArray);
    });
