...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BigQueryApi.IntRange();
  });
  ...
  describe('IntRange', function() {
    it('should create an instance of IntRange', function() {
      // uncomment below and update the code to test IntRange
      //var instance = new BigQueryApi.IntRange();
      //expect(instance).to.be.a(BigQueryApi.IntRange);
    });
