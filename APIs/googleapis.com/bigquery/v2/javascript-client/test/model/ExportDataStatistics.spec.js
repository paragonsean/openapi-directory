...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BigQueryApi.ExportDataStatistics();
  });
  ...
  describe('ExportDataStatistics', function() {
    it('should create an instance of ExportDataStatistics', function() {
      // uncomment below and update the code to test ExportDataStatistics
      //var instance = new BigQueryApi.ExportDataStatistics();
      //expect(instance).to.be.a(BigQueryApi.ExportDataStatistics);
    });
