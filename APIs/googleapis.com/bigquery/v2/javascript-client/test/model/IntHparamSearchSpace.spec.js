...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BigQueryApi.IntHparamSearchSpace();
  });
  ...
  describe('IntHparamSearchSpace', function() {
    it('should create an instance of IntHparamSearchSpace', function() {
      // uncomment below and update the code to test IntHparamSearchSpace
      //var instance = new BigQueryApi.IntHparamSearchSpace();
      //expect(instance).to.be.a(BigQueryApi.IntHparamSearchSpace);
    });
