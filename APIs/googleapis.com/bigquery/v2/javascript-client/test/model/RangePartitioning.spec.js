...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BigQueryApi.RangePartitioning();
  });
  ...
  describe('RangePartitioning', function() {
    it('should create an instance of RangePartitioning', function() {
      // uncomment below and update the code to test RangePartitioning
      //var instance = new BigQueryApi.RangePartitioning();
      //expect(instance).to.be.a(BigQueryApi.RangePartitioning);
    });
