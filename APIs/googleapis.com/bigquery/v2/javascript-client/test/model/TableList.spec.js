...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BigQueryApi.TableList();
  });
  ...
  describe('TableList', function() {
    it('should create an instance of TableList', function() {
      // uncomment below and update the code to test TableList
      //var instance = new BigQueryApi.TableList();
      //expect(instance).to.be.a(BigQueryApi.TableList);
    });
