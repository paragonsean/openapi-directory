...
#include "OAIPhotoSequencesApi.h"
...
OAIPhotoSequencesApi::OAIPhotoSequencesApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIPhotoSequencesApi::~OAIPhotoSequencesApi() {
}

void OAIPhotoSequencesApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("streetviewpublish_photoSequences_list", defaultConf);
    _serverIndices.insert("streetviewpublish_photoSequences_list", 0);
}
...
*/
int OAIPhotoSequencesApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIPhotoSequencesApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIPhotoSequencesApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIPhotoSequencesApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIPhotoSequencesApi::setUsername(const QString &username) {
    _username = username;
}

void OAIPhotoSequencesApi::setPassword(const QString &password) {
    _password = password;
}


void OAIPhotoSequencesApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIPhotoSequencesApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIPhotoSequencesApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIPhotoSequencesApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIPhotoSequencesApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIPhotoSequencesApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIPhotoSequencesApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIPhotoSequencesApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIPhotoSequencesApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIPhotoSequencesApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIPhotoSequencesApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIPhotoSequencesApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIPhotoSequencesApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIPhotoSequencesApi::streetviewpublish_photoSequences_list(const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<QString> &filter, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &page_token) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIPhotoSequencesApi::streetviewpublish_photoSequences_listCallback);
    connect(this, &OAIPhotoSequencesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIPhotoSequencesApi::streetviewpublish_photoSequences_listCallback);
    connect(this, &OAIPhotoSequencesApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
...
void OAIPhotoSequencesApi::streetviewpublish_photoSequences_listCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIListPhotoSequencesResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT streetviewpublish_photoSequences_listSignal(output);
        Q_EMIT streetviewpublish_photoSequences_listSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT streetviewpublish_photoSequences_listSignalE(output, error_type, error_str);
        Q_EMIT streetviewpublish_photoSequences_listSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT streetviewpublish_photoSequences_listSignalError(output, error_type, error_str);
        Q_EMIT streetviewpublish_photoSequences_listSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIPhotoSequencesApi::tokenAvailable(){
