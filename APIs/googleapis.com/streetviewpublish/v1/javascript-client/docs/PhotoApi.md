...
> Photo streetviewpublishPhotoCreate(opts)
...
let apiInstance = new StreetViewPublishApi.PhotoApi();
let opts = {
...
apiInstance.streetviewpublishPhotoCreate(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> Object streetviewpublishPhotoDelete(photoId, opts)
...
let apiInstance = new StreetViewPublishApi.PhotoApi();
let photoId = "photoId_example"; // String | Required. ID of the Photo.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
apiInstance.streetviewpublishPhotoDelete(photoId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Photo streetviewpublishPhotoGet(photoId, opts)
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'languageCode': "languageCode_example", // String | The BCP-47 language code, such as \"en-US\" or \"sr-Latn\". For more information, see http://www.unicode.org/reports/tr35/#Unicode_locale_identifier. If language_code is unspecified, the user's language preference for Google services is used.
...
apiInstance.streetviewpublishPhotoGet(photoId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> UploadRef streetviewpublishPhotoStartUpload(opts)
...
apiInstance.streetviewpublishPhotoStartUpload(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Photo streetviewpublishPhotoUpdate(id, opts)
...
let apiInstance = new StreetViewPublishApi.PhotoApi();
let id = "id_example"; // String | A unique identifier for a photo.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
