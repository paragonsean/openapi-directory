...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StreetViewPublishApi.ListPhotosResponse();
  });
  ...
  describe('ListPhotosResponse', function() {
    it('should create an instance of ListPhotosResponse', function() {
      // uncomment below and update the code to test ListPhotosResponse
      //var instance = new StreetViewPublishApi.ListPhotosResponse();
      //expect(instance).to.be.a(StreetViewPublishApi.ListPhotosResponse);
    });
