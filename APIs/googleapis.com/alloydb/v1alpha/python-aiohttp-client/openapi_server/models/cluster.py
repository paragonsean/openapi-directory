...
class Cluster(Model):
    ...
    def __init__(self, annotations: Dict[str, str]=None, automated_backup_policy: AutomatedBackupPolicy=None, backup_source: BackupSource=None, cluster_type: str=None, continuous_backup_config: ContinuousBackupConfig=None, continuous_backup_info: ContinuousBackupInfo=None, create_time: str=None, database_version: str=None, delete_time: str=None, display_name: str=None, encryption_config: EncryptionConfig=None, encryption_info: EncryptionInfo=None, etag: str=None, initial_user: UserPassword=None, labels: Dict[str, str]=None, migration_source: MigrationSource=None, name: str=None, network: str=None, network_config: NetworkConfig=None, primary_config: PrimaryConfig=None, psc_config: PscConfig=None, reconciling: bool=None, satisfies_pzi: bool=None, satisfies_pzs: bool=None, secondary_config: SecondaryConfig=None, ssl_config: SslConfig=None, state: str=None, uid: str=None, update_time: str=None):
        ...
        :param psc_config: The psc_config of this Cluster.
        :param reconciling: The reconciling of this Cluster.
        :param satisfies_pzi: The satisfies_pzi of this Cluster.
    ...
    @property
    def psc_config(self):
        """Gets the psc_config of this Cluster.


        :return: The psc_config of this Cluster.
        :rtype: PscConfig
        """
    ...
    def psc_config(self, psc_config):
        """Sets the psc_config of this Cluster.
    ...
    def satisfies_pzi(self):
        """Gets the satisfies_pzi of this Cluster.

        Output only. Reserved for future use.

        :return: The satisfies_pzi of this Cluster.
        :rtype: bool
        """
    ...
    def satisfies_pzi(self, satisfies_pzi):
        """Sets the satisfies_pzi of this Cluster.
