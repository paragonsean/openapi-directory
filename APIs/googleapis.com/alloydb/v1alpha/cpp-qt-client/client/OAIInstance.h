...
class OAIInstanceNetworkConfig;
class OAINode;
class OAIPscInstanceConfig;
...
public:
    ...
    OAIInstanceNetworkConfig getNetworkConfig() const;
    void setNetworkConfig(const OAIInstanceNetworkConfig &network_config);
    ...
    OAIPscInstanceConfig getPscInstanceConfig() const;
    void setPscInstanceConfig(const OAIPscInstanceConfig &psc_instance_config);
    bool is_psc_instance_config_Set() const;
    bool is_psc_instance_config_Valid() const;
...
private:
    ...
    OAIInstanceNetworkConfig m_network_config;
    ...
    OAIPscInstanceConfig m_psc_instance_config;
    bool m_psc_instance_config_isSet;
    bool m_psc_instance_config_isValid;
