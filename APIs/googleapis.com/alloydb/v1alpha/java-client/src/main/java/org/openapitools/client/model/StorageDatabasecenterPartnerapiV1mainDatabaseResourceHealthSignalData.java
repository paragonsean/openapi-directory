...
public class StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData {
  ...
  private List<StorageDatabasecenterPartnerapiV1mainCompliance> compliance = new ArrayList<>();
  ...
  public StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData() {
  }

  public StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData additionalMetadata(Map<String, Object> additionalMetadata) {
    this.additionalMetadata = additionalMetadata;
    return this;
  }

  public StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData putAdditionalMetadataItem(String key, Object additionalMetadataItem) {
  ...
  public StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData compliance(List<StorageDatabasecenterPartnerapiV1mainCompliance> compliance) {
    this.compliance = compliance;
    return this;
  }

  public StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData addComplianceItem(StorageDatabasecenterPartnerapiV1mainCompliance complianceItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<StorageDatabasecenterPartnerapiV1mainCompliance> getCompliance() {
    return compliance;
  }

  public void setCompliance(List<StorageDatabasecenterPartnerapiV1mainCompliance> compliance) {
    this.compliance = compliance;
  }


  public StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData description(String description) {
  ...
  public StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData eventTime(String eventTime) {
  ...
  public StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData externalUri(String externalUri) {
  ...
  public StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData name(String name) {
    this.name = name;
    return this;
  }
  ...
  public StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData provider(ProviderEnum provider) {
  ...
  public StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData resourceContainer(String resourceContainer) {
  ...
  public StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData resourceName(String resourceName) {
  ...
  public StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData signalClass(SignalClassEnum signalClass) {
  ...
  public StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData signalId(String signalId) {
  ...
  public StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData signalType(SignalTypeEnum signalType) {
  ...
  public StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData storageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData = (StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData) o;
    return Objects.equals(this.additionalMetadata, storageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData.additionalMetadata) &&
        Objects.equals(this.compliance, storageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData.compliance) &&
        Objects.equals(this.description, storageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData.description) &&
        Objects.equals(this.eventTime, storageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData.eventTime) &&
        Objects.equals(this.externalUri, storageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData.externalUri) &&
        Objects.equals(this.name, storageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData.name) &&
        Objects.equals(this.provider, storageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData.provider) &&
        Objects.equals(this.resourceContainer, storageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData.resourceContainer) &&
        Objects.equals(this.resourceName, storageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData.resourceName) &&
        Objects.equals(this.signalClass, storageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData.signalClass) &&
        Objects.equals(this.signalId, storageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData.signalId) &&
        Objects.equals(this.signalType, storageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData.signalType) &&
        Objects.equals(this.state, storageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData.state);
  }
  ...
  public String toString() {
    ...
    sb.append("class StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData is not found in the empty JSON string", StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("compliance") != null && !jsonObj.get("compliance").isJsonNull()) {
        ...
        if (jsonArraycompliance != null) {
          ...
          for (int i = 0; i < jsonArraycompliance.size(); i++) {
            StorageDatabasecenterPartnerapiV1mainCompliance.validateJsonElement(jsonArraycompliance.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData.class));

       return (TypeAdapter<T>) new TypeAdapter<StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData>() {
           @Override
           public void write(JsonWriter out, StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData
   * @throws IOException if the JSON string is invalid with respect to StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData
   */
  public static StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData.class);
  }

  /**
   * Convert an instance of StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData to an JSON string
   *
   * @return JSON string
   */
