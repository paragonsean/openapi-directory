...
|**databaseVersion** | [**DatabaseVersionEnum**](#DatabaseVersionEnum) | Output only. The database engine major version of the cluster this backup was created from. Any restored cluster created from this backup will have the same database version. |  [optional] [readonly] |
...
|**type** | [**TypeEnum**](#TypeEnum) | The backup type, which suggests the trigger for the backup. |  [optional] |
