...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlloyDbApi.MigrationSource();
  });
  ...
  describe('MigrationSource', function() {
    it('should create an instance of MigrationSource', function() {
      // uncomment below and update the code to test MigrationSource
      //var instance = new AlloyDbApi.MigrationSource();
      //expect(instance).to.be.a(AlloyDbApi.MigrationSource);
    });
