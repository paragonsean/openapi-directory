...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlloyDbApi.StorageDatabasecenterPartnerapiV1mainDatabaseMetadata();
  });
  ...
  describe('StorageDatabasecenterPartnerapiV1mainDatabaseMetadata', function() {
    it('should create an instance of StorageDatabasecenterPartnerapiV1mainDatabaseMetadata', function() {
      // uncomment below and update the code to test StorageDatabasecenterPartnerapiV1mainDatabaseMetadata
      //var instance = new AlloyDbApi.StorageDatabasecenterPartnerapiV1mainDatabaseMetadata();
      //expect(instance).to.be.a(AlloyDbApi.StorageDatabasecenterPartnerapiV1mainDatabaseMetadata);
    });
