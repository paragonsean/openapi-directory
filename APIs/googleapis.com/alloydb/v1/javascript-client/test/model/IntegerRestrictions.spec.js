...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlloyDbApi.IntegerRestrictions();
  });
  ...
  describe('IntegerRestrictions', function() {
    it('should create an instance of IntegerRestrictions', function() {
      // uncomment below and update the code to test IntegerRestrictions
      //var instance = new AlloyDbApi.IntegerRestrictions();
      //expect(instance).to.be.a(AlloyDbApi.IntegerRestrictions);
    });
