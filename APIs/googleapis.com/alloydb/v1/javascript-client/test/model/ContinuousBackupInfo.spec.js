...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlloyDbApi.ContinuousBackupInfo();
  });
  ...
  describe('ContinuousBackupInfo', function() {
    it('should create an instance of ContinuousBackupInfo', function() {
      // uncomment below and update the code to test ContinuousBackupInfo
      //var instance = new AlloyDbApi.ContinuousBackupInfo();
      //expect(instance).to.be.a(AlloyDbApi.ContinuousBackupInfo);
    });
