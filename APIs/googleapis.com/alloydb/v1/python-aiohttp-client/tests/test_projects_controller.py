...
async def test_alloydb_projects_locations_clusters_createsecondary(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/clusters:createsecondary'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_alloydb_projects_locations_clusters_generate_client_certificate(client):
    ...
    """
    body = {"requestId":"requestId","certDuration":"certDuration","publicKey":"publicKey","useMetadataExchange":True}
    params = [('$.xgafv', 'xgafv_example'),
                    ('access_token', 'access_token_example'),
                    ('alt', 'alt_example'),
                    ('callback', 'param_callback_example'),
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parentgenerate_client_certificat}'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_alloydb_projects_locations_clusters_instances_create(client):
    ...
    """
    body = {"writableNode":{"ip":"ip","zoneId":"zoneId","id":"id","state":"state"},"machineConfig":{"cpuCount":0},"databaseFlags":{"key":"databaseFlags"},"displayName":"displayName","instanceType":"INSTANCE_TYPE_UNSPECIFIED","ipAddress":"ipAddress","annotations":{"key":"annotations"},"reconciling":True,"satisfiesPzs":True,"updateTime":"updateTime","queryInsightsConfig":{"recordClientAddress":True,"queryStringLength":1,"queryPlansPerMinute":6,"recordApplicationTags":True},"labels":{"key":"labels"},"uid":"uid","availabilityType":"AVAILABILITY_TYPE_UNSPECIFIED","nodes":[{"ip":"ip","zoneId":"zoneId","id":"id","state":"state"},{"ip":"ip","zoneId":"zoneId","id":"id","state":"state"}],"clientConnectionConfig":{"sslConfig":{"caSource":"CA_SOURCE_UNSPECIFIED","sslMode":"SSL_MODE_UNSPECIFIED"},"requireConnectors":True},"createTime":"createTime","deleteTime":"deleteTime","readPoolConfig":{"nodeCount":5},"name":"name","etag":"etag","state":"STATE_UNSPECIFIED","gceZone":"gceZone"}
    params = [('$.xgafv', 'xgafv_example'),
                    ('access_token', 'access_token_example'),
                    ('alt', 'alt_example'),
                    ('callback', 'param_callback_example'),
...
async def test_alloydb_projects_locations_clusters_instances_createsecondary(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/instances:createsecondary'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_alloydb_projects_locations_clusters_instances_get_connection_info(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/{parent}/connectionInfo'.format(parent='parent_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_alloydb_projects_locations_clusters_instances_inject_fault(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{nameinject_faul}'.format(name='name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_alloydb_projects_locations_clusters_restore(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/clusters:restore'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_alloydb_projects_locations_supported_database_flags_list(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/{parent}/supportedDatabaseFlags'.format(parent='parent_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
