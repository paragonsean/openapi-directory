...
async def test_alloydb_projects_locations_backups_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta/{parent}/backups'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_alloydb_projects_locations_clusters_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta/{parent}/clusters'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_alloydb_projects_locations_clusters_createsecondary(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta/{parent}/clusters:createsecondary'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_alloydb_projects_locations_clusters_generate_client_certificate(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta/{parentgenerate_client_certificat}'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_alloydb_projects_locations_clusters_instances_createsecondary(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta/{parent}/instances:createsecondary'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_alloydb_projects_locations_clusters_instances_failover(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta/{namefailove}'.format(name='name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_alloydb_projects_locations_clusters_instances_get_connection_info(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1beta/{parent}/connectionInfo'.format(parent='parent_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_alloydb_projects_locations_clusters_instances_inject_fault(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta/{nameinject_faul}'.format(name='name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_alloydb_projects_locations_clusters_instances_restart(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta/{namerestar}'.format(name='name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_alloydb_projects_locations_clusters_promote(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta/{namepromot}'.format(name='name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_alloydb_projects_locations_clusters_restore(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta/{parent}/clusters:restore'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_alloydb_projects_locations_clusters_users_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta/{parent}/users'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_alloydb_projects_locations_supported_database_flags_list(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1beta/{parent}/supportedDatabaseFlags'.format(parent='parent_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
