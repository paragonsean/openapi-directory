...
class GenerateClientCertificateRequest(Model):
    ...
    def __init__(self, cert_duration: str=None, pem_csr: str=None, public_key: str=None, request_id: str=None, use_metadata_exchange: bool=None):
        ...
        :param pem_csr: The pem_csr of this GenerateClientCertificateRequest.
    ...
    @property
    def pem_csr(self):
        """Gets the pem_csr of this GenerateClientCertificateRequest.

        Optional. A pem-encoded X.509 certificate signing request (CSR). It is recommended to use public_key instead.

        :return: The pem_csr of this GenerateClientCertificateRequest.
        :rtype: str
        """
    ...
    def pem_csr(self, pem_csr):
        """Sets the pem_csr of this GenerateClientCertificateRequest.
