...
public class Backup {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(annotations, clusterName, clusterUid, createTime, databaseVersion, deleteTime, description, displayName, encryptionConfig, encryptionInfo, etag, expiryQuantity, expiryTime, labels, name, reconciling, satisfiesPzs, sizeBytes, state, type, uid, updateTime);
  }
