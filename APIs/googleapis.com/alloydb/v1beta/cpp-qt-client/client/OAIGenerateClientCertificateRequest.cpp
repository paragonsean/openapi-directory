...
QString OAIGenerateClientCertificateRequest::getPemCsr() const {
    return m_pem_csr;
}
void OAIGenerateClientCertificateRequest::setPemCsr(const QString &pem_csr) {
    m_pem_csr = pem_csr;
    m_pem_csr_isSet = true;
}

bool OAIGenerateClientCertificateRequest::is_pem_csr_Set() const{
    return m_pem_csr_isSet;
}

bool OAIGenerateClientCertificateRequest::is_pem_csr_Valid() const{
