...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AlloyDbApi.ContinuousBackupSource();
  });
  ...
  describe('ContinuousBackupSource', function() {
    it('should create an instance of ContinuousBackupSource', function() {
      // uncomment below and update the code to test ContinuousBackupSource
      //var instance = new AlloyDbApi.ContinuousBackupSource();
      //expect(instance).to.be.a(AlloyDbApi.ContinuousBackupSource);
    });
