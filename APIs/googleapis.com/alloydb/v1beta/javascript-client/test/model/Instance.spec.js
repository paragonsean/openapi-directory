...
(function(root, factory) {
  ...
  describe('Instance', function() {
    ...
    it('should have the property pscInstanceConfig (base name: "pscInstanceConfig")', function() {
      // uncomment below and update the code to test the property pscInstanceConfig
      //var instance = new AlloyDbApi.Instance();
      //expect(instance).to.be();
    });
