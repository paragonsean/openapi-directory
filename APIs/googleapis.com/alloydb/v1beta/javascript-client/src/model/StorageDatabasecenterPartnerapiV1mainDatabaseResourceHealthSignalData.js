...
import StorageDatabasecenterPartnerapiV1mainCompliance from './StorageDatabasecenterPartnerapiV1mainCompliance';

/**
 * The StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData model module.
 * @module model/StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData
 * @version v1beta
 */
class StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData {
    /**
     * Constructs a new <code>StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData</code>.
     * Common model for database resource health signal data.
     * @alias module:model/StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData
     */
    constructor() { 
        
        StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData} obj Optional instance to populate.
     * @return {module:model/StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData} The populated <code>StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData();
            ...
            if (data.hasOwnProperty('compliance')) {
                obj['compliance'] = ApiClient.convertToType(data['compliance'], [StorageDatabasecenterPartnerapiV1mainCompliance]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData</code>.
     */
    static validateJSON(data) {
        if (data['compliance']) { // data not null
            ...
            for (const item of data['compliance']) {
                StorageDatabasecenterPartnerapiV1mainCompliance.validateJSON(item);
            };
        }
 ...
 */
StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData.prototype['additionalMetadata'] = undefined;
 ...
 * @member {Array.<module:model/StorageDatabasecenterPartnerapiV1mainCompliance>} compliance
 */
StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData.prototype['compliance'] = undefined;

/**
 * Description associated with signal
 * @member {String} description
 */
StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData.prototype['description'] = undefined;

/**
 * Required. The last time at which the event described by this signal took place
 * @member {String} eventTime
 */
StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData.prototype['eventTime'] = undefined;
 ...
 */
StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData.prototype['externalUri'] = undefined;

/**
 * Required. The name of the signal, ex: PUBLIC_SQL_INSTANCE, SQL_LOG_ERROR_VERBOSITY etc.
 * @member {String} name
 */
StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData.prototype['name'] = undefined;

/**
 * Cloud provider name. Ex: GCP/AWS/Azure/OnPrem/SelfManaged
 * @member {module:model/StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData.ProviderEnum} provider
 */
StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData.prototype['provider'] = undefined;
 ...
 */
StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData.prototype['resourceContainer'] = undefined;
 ...
 */
StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData.prototype['resourceName'] = undefined;

/**
 * Required. The class of the signal, such as if it's a THREAT or VULNERABILITY.
 * @member {module:model/StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData.SignalClassEnum} signalClass
 */
StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData.prototype['signalClass'] = undefined;
 ...
 */
StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData.prototype['signalId'] = undefined;

/**
 * Required. Type of signal, for example, `AVAILABLE_IN_MULTIPLE_ZONES`, `LOGGING_MOST_ERRORS`, etc.
 * @member {module:model/StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData.SignalTypeEnum} signalType
 */
StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData.prototype['signalType'] = undefined;

/**
 * @member {module:model/StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData.StateEnum} state
 */
StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData.prototype['state'] = undefined;
 ...
 * @readonly
 */
StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData['ProviderEnum'] = {
 ...
 * @readonly
 */
StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData['SignalClassEnum'] = {
 ...
 * @readonly
 */
StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData['SignalTypeEnum'] = {
 ...
 * @readonly
 */
StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData['StateEnum'] = {
...
export default StorageDatabasecenterPartnerapiV1mainDatabaseResourceHealthSignalData;
