# ConnectorsApi.CustomConnectorVersion
...
**backendVariableTemplates** | [**[ConfigVariableTemplate]**](ConfigVariableTemplate.md) | Optional. Backend variables config templates. This translates to additional variable templates in connection. | [optional] 
**createTime** | **String** | Output only. Created time. | [optional] [readonly] 
**destinationConfigs** | [**[DestinationConfig]**](DestinationConfig.md) | Optional. Destination config(s) for accessing connector facade/ proxy. This is used only when enable_backend_destination_config is true. | [optional] 
...
**state** | **String** | Output only. State of the custom connector version. | [optional] [readonly] 
