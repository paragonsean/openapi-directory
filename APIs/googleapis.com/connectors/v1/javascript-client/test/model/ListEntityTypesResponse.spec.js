...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConnectorsApi.ListEntityTypesResponse();
  });
  ...
  describe('ListEntityTypesResponse', function() {
    it('should create an instance of ListEntityTypesResponse', function() {
      // uncomment below and update the code to test ListEntityTypesResponse
      //var instance = new ConnectorsApi.ListEntityTypesResponse();
      //expect(instance).to.be.a(ConnectorsApi.ListEntityTypesResponse);
    });
