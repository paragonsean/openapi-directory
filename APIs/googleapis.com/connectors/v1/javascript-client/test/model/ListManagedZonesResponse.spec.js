...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConnectorsApi.ListManagedZonesResponse();
  });
  ...
  describe('ListManagedZonesResponse', function() {
    it('should create an instance of ListManagedZonesResponse', function() {
      // uncomment below and update the code to test ListManagedZonesResponse
      //var instance = new ConnectorsApi.ListManagedZonesResponse();
      //expect(instance).to.be.a(ConnectorsApi.ListManagedZonesResponse);
    });
