...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConnectorsApi.JwtClaims();
  });
  ...
  describe('JwtClaims', function() {
    it('should create an instance of JwtClaims', function() {
      // uncomment below and update the code to test JwtClaims
      //var instance = new ConnectorsApi.JwtClaims();
      //expect(instance).to.be.a(ConnectorsApi.JwtClaims);
    });
