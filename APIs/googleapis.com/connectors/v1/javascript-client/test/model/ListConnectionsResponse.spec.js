...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConnectorsApi.ListConnectionsResponse();
  });
  ...
  describe('ListConnectionsResponse', function() {
    it('should create an instance of ListConnectionsResponse', function() {
      // uncomment below and update the code to test ListConnectionsResponse
      //var instance = new ConnectorsApi.ListConnectionsResponse();
      //expect(instance).to.be.a(ConnectorsApi.ListConnectionsResponse);
    });
