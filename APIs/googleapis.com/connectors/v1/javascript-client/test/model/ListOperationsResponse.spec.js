...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConnectorsApi.ListOperationsResponse();
  });
  ...
  describe('ListOperationsResponse', function() {
    it('should create an instance of ListOperationsResponse', function() {
      ...
      //var instance = new ConnectorsApi.ListOperationsResponse();
      //expect(instance).to.be.a(ConnectorsApi.ListOperationsResponse);
    });
