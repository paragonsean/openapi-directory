...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConnectorsApi.ListEventTypesResponse();
  });
  ...
  describe('ListEventTypesResponse', function() {
    it('should create an instance of ListEventTypesResponse', function() {
      // uncomment below and update the code to test ListEventTypesResponse
      //var instance = new ConnectorsApi.ListEventTypesResponse();
      //expect(instance).to.be.a(ConnectorsApi.ListEventTypesResponse);
    });
