...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConnectorsApi.ListLocationsResponse();
  });
  ...
  describe('ListLocationsResponse', function() {
    it('should create an instance of ListLocationsResponse', function() {
      ...
      //var instance = new ConnectorsApi.ListLocationsResponse();
      //expect(instance).to.be.a(ConnectorsApi.ListLocationsResponse);
    });
