...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConnectorsApi.ListProvidersResponse();
  });
  ...
  describe('ListProvidersResponse', function() {
    it('should create an instance of ListProvidersResponse', function() {
      // uncomment below and update the code to test ListProvidersResponse
      //var instance = new ConnectorsApi.ListProvidersResponse();
      //expect(instance).to.be.a(ConnectorsApi.ListProvidersResponse);
    });
