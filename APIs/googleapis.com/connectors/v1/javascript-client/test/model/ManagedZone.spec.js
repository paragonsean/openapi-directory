...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConnectorsApi.ManagedZone();
  });
  ...
  describe('ManagedZone', function() {
    it('should create an instance of ManagedZone', function() {
      ...
      //var instance = new ConnectorsApi.ManagedZone();
      //expect(instance).to.be.a(ConnectorsApi.ManagedZone);
    });
    ...
    it('should have the property targetVpc (base name: "targetVpc")', function() {
      // uncomment below and update the code to test the property targetVpc
      //var instance = new ConnectorsApi.ManagedZone();
      //expect(instance).to.be();
    });
