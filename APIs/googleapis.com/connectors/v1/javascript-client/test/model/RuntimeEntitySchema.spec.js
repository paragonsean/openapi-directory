...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConnectorsApi.RuntimeEntitySchema();
  });
  ...
  describe('RuntimeEntitySchema', function() {
    it('should create an instance of RuntimeEntitySchema', function() {
      // uncomment below and update the code to test RuntimeEntitySchema
      //var instance = new ConnectorsApi.RuntimeEntitySchema();
      //expect(instance).to.be.a(ConnectorsApi.RuntimeEntitySchema);
    });
