...
class ConnectorInfraConfig(Model):
    ...
    def __init__(self, connection_ratelimit_window_seconds: str=None, deployment_model: str=None, hpa_config: HPAConfig=None, internalclient_ratelimit_threshold: str=None, ratelimit_threshold: str=None, resource_limits: ResourceLimits=None, resource_requests: ResourceRequests=None, shared_deployment: str=None):
        """ConnectorInfraConfig - a model defined in OpenAPI

        :param connection_ratelimit_window_seconds: The connection_ratelimit_window_seconds of this ConnectorInfraConfig.
        :param deployment_model: The deployment_model of this ConnectorInfraConfig.
        :param hpa_config: The hpa_config of this ConnectorInfraConfig.
        :param internalclient_ratelimit_threshold: The internalclient_ratelimit_threshold of this ConnectorInfraConfig.
        :param ratelimit_threshold: The ratelimit_threshold of this ConnectorInfraConfig.
        :param resource_limits: The resource_limits of this ConnectorInfraConfig.
        :param resource_requests: The resource_requests of this ConnectorInfraConfig.
        :param shared_deployment: The shared_deployment of this ConnectorInfraConfig.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ConnectorInfraConfig':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ConnectorInfraConfig of this ConnectorInfraConfig.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def connection_ratelimit_window_seconds(self):
        """Gets the connection_ratelimit_window_seconds of this ConnectorInfraConfig.

        The window used for ratelimiting runtime requests to connections.

        :return: The connection_ratelimit_window_seconds of this ConnectorInfraConfig.
        :rtype: str
        """
    ...
    def connection_ratelimit_window_seconds(self, connection_ratelimit_window_seconds):
        """Sets the connection_ratelimit_window_seconds of this ConnectorInfraConfig.
    ...
    def deployment_model(self):
        """Gets the deployment_model of this ConnectorInfraConfig.

        Indicate whether connector is deployed on GKE/CloudRun

        :return: The deployment_model of this ConnectorInfraConfig.
        :rtype: str
        """
    ...
    def deployment_model(self, deployment_model):
        """Sets the deployment_model of this ConnectorInfraConfig.
    ...
    @property
    def hpa_config(self):
        """Gets the hpa_config of this ConnectorInfraConfig.


        :return: The hpa_config of this ConnectorInfraConfig.
        :rtype: HPAConfig
        """
    ...
    def hpa_config(self, hpa_config):
        """Sets the hpa_config of this ConnectorInfraConfig.
    ...
    def internalclient_ratelimit_threshold(self):
        """Gets the internalclient_ratelimit_threshold of this ConnectorInfraConfig.

        Max QPS supported for internal requests originating from Connd.

        :return: The internalclient_ratelimit_threshold of this ConnectorInfraConfig.
        :rtype: str
        """
    ...
    def internalclient_ratelimit_threshold(self, internalclient_ratelimit_threshold):
        """Sets the internalclient_ratelimit_threshold of this ConnectorInfraConfig.
    ...
    def ratelimit_threshold(self):
        """Gets the ratelimit_threshold of this ConnectorInfraConfig.

        Max QPS supported by the connector version before throttling of requests.

        :return: The ratelimit_threshold of this ConnectorInfraConfig.
        :rtype: str
        """
    ...
    def ratelimit_threshold(self, ratelimit_threshold):
        """Sets the ratelimit_threshold of this ConnectorInfraConfig.
    ...
    def resource_limits(self):
        """Gets the resource_limits of this ConnectorInfraConfig.


        :return: The resource_limits of this ConnectorInfraConfig.
    ...
    def resource_limits(self, resource_limits):
        """Sets the resource_limits of this ConnectorInfraConfig.
    ...
    def resource_requests(self):
        """Gets the resource_requests of this ConnectorInfraConfig.


        :return: The resource_requests of this ConnectorInfraConfig.
    ...
    def resource_requests(self, resource_requests):
        """Sets the resource_requests of this ConnectorInfraConfig.
    ...
    def shared_deployment(self):
        """Gets the shared_deployment of this ConnectorInfraConfig.

        The name of shared connector deployment.

        :return: The shared_deployment of this ConnectorInfraConfig.
        :rtype: str
        """
    ...
    def shared_deployment(self, shared_deployment):
        """Sets the shared_deployment of this ConnectorInfraConfig.
