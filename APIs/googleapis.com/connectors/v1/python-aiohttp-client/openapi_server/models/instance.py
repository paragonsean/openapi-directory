...
class Instance(Model):
    ...
    def __init__(self, consumer_defined_name: str=None, create_time: str=None, instance_type: str=None, labels: Dict[str, str]=None, maintenance_policy_names: Dict[str, str]=None, maintenance_schedules: Dict[str, MaintenanceSchedule]=None, maintenance_settings: MaintenanceSettings=None, name: str=None, notification_parameters: Dict[str, NotificationParameter]=None, producer_metadata: Dict[str, str]=None, provisioned_resources: List[ProvisionedResource]=None, slm_instance_template: str=None, slo_metadata: SloMetadata=None, software_versions: Dict[str, str]=None, state: str=None, tenant_project_id: str=None, update_time: str=None):
        """Instance - a model defined in OpenAPI

        :param consumer_defined_name: The consumer_defined_name of this Instance.
        ...
        :param maintenance_policy_names: The maintenance_policy_names of this Instance.
        :param maintenance_schedules: The maintenance_schedules of this Instance.
        :param maintenance_settings: The maintenance_settings of this Instance.
        :param name: The name of this Instance.
        :param notification_parameters: The notification_parameters of this Instance.
        :param producer_metadata: The producer_metadata of this Instance.
        :param provisioned_resources: The provisioned_resources of this Instance.
        :param slm_instance_template: The slm_instance_template of this Instance.
        :param slo_metadata: The slo_metadata of this Instance.
        :param software_versions: The software_versions of this Instance.
        ...
        self.openapi_types = {
            ...
            'maintenance_schedules': Dict[str, MaintenanceSchedule],
            'maintenance_settings': MaintenanceSettings,
            'name': str,
            'notification_parameters': Dict[str, NotificationParameter],
    ...
    def consumer_defined_name(self):
        """Gets the consumer_defined_name of this Instance.

        consumer_defined_name is the name of the instance set by the service consumers. Generally this is different from the `name` field which reperesents the system-assigned id of the instance which the service consumers do not recognize. This is a required field for tenants onboarding to Maintenance Window notifications (go/slm-rollout-maintenance-policies#prerequisites).

        :return: The consumer_defined_name of this Instance.
        :rtype: str
        """
    ...
    def consumer_defined_name(self, consumer_defined_name):
        """Sets the consumer_defined_name of this Instance.
    ...
    def maintenance_policy_names(self):
        """Gets the maintenance_policy_names of this Instance.
        ...
        :return: The maintenance_policy_names of this Instance.
        :rtype: Dict[str, str]
        """
    ...
    def maintenance_policy_names(self, maintenance_policy_names):
        """Sets the maintenance_policy_names of this Instance.
    ...
    def maintenance_schedules(self):
        """Gets the maintenance_schedules of this Instance.

        The MaintenanceSchedule contains the scheduling information of published maintenance schedule with same key as software_versions.

        :return: The maintenance_schedules of this Instance.
        :rtype: Dict[str, MaintenanceSchedule]
        """
        return self._maintenance_schedules

    @maintenance_schedules.setter
    def maintenance_schedules(self, maintenance_schedules):
        """Sets the maintenance_schedules of this Instance.

        The MaintenanceSchedule contains the scheduling information of published maintenance schedule with same key as software_versions.

        :param maintenance_schedules: The maintenance_schedules of this Instance.
        :type maintenance_schedules: Dict[str, MaintenanceSchedule]
        """
    ...
    def maintenance_settings(self):
        """Gets the maintenance_settings of this Instance.


        :return: The maintenance_settings of this Instance.
        :rtype: MaintenanceSettings
        """
        return self._maintenance_settings

    @maintenance_settings.setter
    def maintenance_settings(self, maintenance_settings):
        """Sets the maintenance_settings of this Instance.
    ...
    def notification_parameters(self):
        """Gets the notification_parameters of this Instance.
        ...
        :return: The notification_parameters of this Instance.
        :rtype: Dict[str, NotificationParameter]
        """
    ...
    def notification_parameters(self, notification_parameters):
        """Sets the notification_parameters of this Instance.

        Optional. notification_parameter are information that service producers may like to include that is not relevant to Rollout. This parameter will only be passed to Gamma and Cloud Logging for notification/logging purpose.

        :param notification_parameters: The notification_parameters of this Instance.
        :type notification_parameters: Dict[str, NotificationParameter]
        """
    ...
    def producer_metadata(self):
        """Gets the producer_metadata of this Instance.

        Output only. Custom string attributes used primarily to expose producer-specific information in monitoring dashboards. See go/get-instance-metadata.

        :return: The producer_metadata of this Instance.
        :rtype: Dict[str, str]
        """
    ...
    def producer_metadata(self, producer_metadata):
        """Sets the producer_metadata of this Instance.
    ...
    def provisioned_resources(self):
        """Gets the provisioned_resources of this Instance.

        Output only. The list of data plane resources provisioned for this instance, e.g. compute VMs. See go/get-instance-metadata.

        :return: The provisioned_resources of this Instance.
        :rtype: List[ProvisionedResource]
        """
        return self._provisioned_resources

    @provisioned_resources.setter
    def provisioned_resources(self, provisioned_resources):
        """Sets the provisioned_resources of this Instance.

        Output only. The list of data plane resources provisioned for this instance, e.g. compute VMs. See go/get-instance-metadata.

        :param provisioned_resources: The provisioned_resources of this Instance.
        :type provisioned_resources: List[ProvisionedResource]
        """
    ...
    def slm_instance_template(self):
        """Gets the slm_instance_template of this Instance.

        Link to the SLM instance template. Only populated when updating SLM instances via SSA's Actuation service adaptor. Service producers with custom control plane (e.g. Cloud SQL) doesn't need to populate this field. Instead they should use software_versions.

        :return: The slm_instance_template of this Instance.
        :rtype: str
        """
    ...
    def slm_instance_template(self, slm_instance_template):
        """Sets the slm_instance_template of this Instance.
    ...
    def slo_metadata(self):
        """Gets the slo_metadata of this Instance.


        :return: The slo_metadata of this Instance.
        :rtype: SloMetadata
        """
    ...
    def slo_metadata(self, slo_metadata):
        """Sets the slo_metadata of this Instance.


        :param slo_metadata: The slo_metadata of this Instance.
        :type slo_metadata: SloMetadata
        """
    ...
    def software_versions(self):
        """Gets the software_versions of this Instance.

        Software versions that are used to deploy this instance. This can be mutated by rollout services.

        :return: The software_versions of this Instance.
        :rtype: Dict[str, str]
        """
    ...
    def software_versions(self, software_versions):
        """Sets the software_versions of this Instance.
