...
OAIConnectorInfraConfig::OAIConnectorInfraConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIConnectorInfraConfig::OAIConnectorInfraConfig() {
    this->initializeModel();
}

OAIConnectorInfraConfig::~OAIConnectorInfraConfig() {}

void OAIConnectorInfraConfig::initializeModel() {
...
void OAIConnectorInfraConfig::fromJson(QString jsonString) {
...
void OAIConnectorInfraConfig::fromJsonObject(QJsonObject json) {
...
QString OAIConnectorInfraConfig::asJson() const {
...
QJsonObject OAIConnectorInfraConfig::asJsonObject() const {
    QJsonObject obj;
...
QString OAIConnectorInfraConfig::getConnectionRatelimitWindowSeconds() const {
    return m_connection_ratelimit_window_seconds;
}
void OAIConnectorInfraConfig::setConnectionRatelimitWindowSeconds(const QString &connection_ratelimit_window_seconds) {
...
bool OAIConnectorInfraConfig::is_connection_ratelimit_window_seconds_Set() const{
    return m_connection_ratelimit_window_seconds_isSet;
}

bool OAIConnectorInfraConfig::is_connection_ratelimit_window_seconds_Valid() const{
    return m_connection_ratelimit_window_seconds_isValid;
}

QString OAIConnectorInfraConfig::getDeploymentModel() const {
    return m_deployment_model;
}
void OAIConnectorInfraConfig::setDeploymentModel(const QString &deployment_model) {
    m_deployment_model = deployment_model;
    m_deployment_model_isSet = true;
}

bool OAIConnectorInfraConfig::is_deployment_model_Set() const{
    return m_deployment_model_isSet;
}

bool OAIConnectorInfraConfig::is_deployment_model_Valid() const{
    return m_deployment_model_isValid;
}

OAIHPAConfig OAIConnectorInfraConfig::getHpaConfig() const {
    return m_hpa_config;
}
void OAIConnectorInfraConfig::setHpaConfig(const OAIHPAConfig &hpa_config) {
    m_hpa_config = hpa_config;
    m_hpa_config_isSet = true;
}

bool OAIConnectorInfraConfig::is_hpa_config_Set() const{
    return m_hpa_config_isSet;
}

bool OAIConnectorInfraConfig::is_hpa_config_Valid() const{
    return m_hpa_config_isValid;
}

QString OAIConnectorInfraConfig::getInternalclientRatelimitThreshold() const {
    return m_internalclient_ratelimit_threshold;
}
void OAIConnectorInfraConfig::setInternalclientRatelimitThreshold(const QString &internalclient_ratelimit_threshold) {
    m_internalclient_ratelimit_threshold = internalclient_ratelimit_threshold;
    m_internalclient_ratelimit_threshold_isSet = true;
}

bool OAIConnectorInfraConfig::is_internalclient_ratelimit_threshold_Set() const{
    return m_internalclient_ratelimit_threshold_isSet;
}

bool OAIConnectorInfraConfig::is_internalclient_ratelimit_threshold_Valid() const{
    return m_internalclient_ratelimit_threshold_isValid;
}

QString OAIConnectorInfraConfig::getRatelimitThreshold() const {
    return m_ratelimit_threshold;
}
void OAIConnectorInfraConfig::setRatelimitThreshold(const QString &ratelimit_threshold) {
    m_ratelimit_threshold = ratelimit_threshold;
    m_ratelimit_threshold_isSet = true;
}

bool OAIConnectorInfraConfig::is_ratelimit_threshold_Set() const{
    return m_ratelimit_threshold_isSet;
}

bool OAIConnectorInfraConfig::is_ratelimit_threshold_Valid() const{
    return m_ratelimit_threshold_isValid;
}

OAIResourceLimits OAIConnectorInfraConfig::getResourceLimits() const {
    return m_resource_limits;
}
void OAIConnectorInfraConfig::setResourceLimits(const OAIResourceLimits &resource_limits) {
    m_resource_limits = resource_limits;
    m_resource_limits_isSet = true;
}

bool OAIConnectorInfraConfig::is_resource_limits_Set() const{
    return m_resource_limits_isSet;
}

bool OAIConnectorInfraConfig::is_resource_limits_Valid() const{
    return m_resource_limits_isValid;
}

OAIResourceRequests OAIConnectorInfraConfig::getResourceRequests() const {
    return m_resource_requests;
}
void OAIConnectorInfraConfig::setResourceRequests(const OAIResourceRequests &resource_requests) {
    m_resource_requests = resource_requests;
    m_resource_requests_isSet = true;
}

bool OAIConnectorInfraConfig::is_resource_requests_Set() const{
    return m_resource_requests_isSet;
}

bool OAIConnectorInfraConfig::is_resource_requests_Valid() const{
    return m_resource_requests_isValid;
}

QString OAIConnectorInfraConfig::getSharedDeployment() const {
    return m_shared_deployment;
}
void OAIConnectorInfraConfig::setSharedDeployment(const QString &shared_deployment) {
    m_shared_deployment = shared_deployment;
    m_shared_deployment_isSet = true;
}

bool OAIConnectorInfraConfig::is_shared_deployment_Set() const{
    return m_shared_deployment_isSet;
}

bool OAIConnectorInfraConfig::is_shared_deployment_Valid() const{
    return m_shared_deployment_isValid;
}

bool OAIConnectorInfraConfig::isSet() const {
...
bool OAIConnectorInfraConfig::isValid() const {
