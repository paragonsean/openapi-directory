...
/*
 * OAIConnectorInfraConfig.h
 *
 * This cofiguration provides infra configs like rate limit threshold which need to be configurable for every connector version
 */

#ifndef OAIConnectorInfraConfig_H
#define OAIConnectorInfraConfig_H
...
class OAIConnectorInfraConfig : public OAIObject {
public:
    OAIConnectorInfraConfig();
    OAIConnectorInfraConfig(QString json);
    ~OAIConnectorInfraConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConnectorInfraConfig)

#endif // OAIConnectorInfraConfig_H
