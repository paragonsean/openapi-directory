...
public class ListEntityTypesResponse {
  ...
  private List<RuntimeEntitySchema> entityTypes = new ArrayList<>();
  ...
  public ListEntityTypesResponse entityTypes(List<RuntimeEntitySchema> entityTypes) {
    this.entityTypes = entityTypes;
    return this;
  }

  public ListEntityTypesResponse addEntityTypesItem(RuntimeEntitySchema entityTypesItem) {
  ...
  public List<RuntimeEntitySchema> getEntityTypes() {
    return entityTypes;
  }

  public void setEntityTypes(List<RuntimeEntitySchema> entityTypes) {
    this.entityTypes = entityTypes;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.entityTypes, listEntityTypesResponse.entityTypes) &&
        Objects.equals(this.nextPageToken, listEntityTypesResponse.nextPageToken);
  }
      ...
      if (jsonObj.get("entityTypes") != null && !jsonObj.get("entityTypes").isJsonNull()) {
        ...
        if (jsonArrayentityTypes != null) {
          ...
          for (int i = 0; i < jsonArrayentityTypes.size(); i++) {
            RuntimeEntitySchema.validateJsonElement(jsonArrayentityTypes.get(i));
          };
        }
      }
