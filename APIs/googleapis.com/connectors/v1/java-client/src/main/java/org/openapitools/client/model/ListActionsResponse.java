...
public class ListActionsResponse {
  ...
  private List<RuntimeActionSchema> actions = new ArrayList<>();
  ...
  public ListActionsResponse actions(List<RuntimeActionSchema> actions) {
    this.actions = actions;
    return this;
  }

  public ListActionsResponse addActionsItem(RuntimeActionSchema actionsItem) {
  ...
  public List<RuntimeActionSchema> getActions() {
    return actions;
  }

  public void setActions(List<RuntimeActionSchema> actions) {
    this.actions = actions;
  }


  public ListActionsResponse nextPageToken(String nextPageToken) {
      ...
      if (jsonObj.get("actions") != null && !jsonObj.get("actions").isJsonNull()) {
        ...
        if (jsonArrayactions != null) {
          ...
          for (int i = 0; i < jsonArrayactions.size(); i++) {
            RuntimeActionSchema.validateJsonElement(jsonArrayactions.get(i));
          };
        }
      }
