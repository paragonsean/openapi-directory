...
QString OAIMaintenanceSchedule::getRolloutManagementPolicy() const {
    return m_rollout_management_policy;
}
void OAIMaintenanceSchedule::setRolloutManagementPolicy(const QString &rollout_management_policy) {
    m_rollout_management_policy = rollout_management_policy;
    m_rollout_management_policy_isSet = true;
}

bool OAIMaintenanceSchedule::is_rollout_management_policy_Set() const{
    return m_rollout_management_policy_isSet;
}

bool OAIMaintenanceSchedule::is_rollout_management_policy_Valid() const{
