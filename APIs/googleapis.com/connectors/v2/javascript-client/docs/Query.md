...
**queryParameters** | [**[QueryParameter]**](QueryParameter.md) | In the struct, the value corresponds to the value of query parameter and date type corresponds to the date type of the query parameter. | [optional] 
