...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConnectorsApi.ResultMetadata();
  });
  ...
  describe('ResultMetadata', function() {
    it('should create an instance of ResultMetadata', function() {
      // uncomment below and update the code to test ResultMetadata
      //var instance = new ConnectorsApi.ResultMetadata();
      //expect(instance).to.be.a(ConnectorsApi.ResultMetadata);
    });
