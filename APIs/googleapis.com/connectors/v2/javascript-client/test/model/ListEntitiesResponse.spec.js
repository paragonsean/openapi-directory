...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ConnectorsApi.ListEntitiesResponse();
  });
  ...
  describe('ListEntitiesResponse', function() {
    it('should create an instance of ListEntitiesResponse', function() {
      ...
      //var instance = new ConnectorsApi.ListEntitiesResponse();
      //expect(instance).to.be.a(ConnectorsApi.ListEntitiesResponse);
    });
