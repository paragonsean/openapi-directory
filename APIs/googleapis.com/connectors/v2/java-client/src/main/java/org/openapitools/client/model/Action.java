...
public class Action {
  ...
  public Action displayName(String displayName) {
  ...
  public Action inputJsonSchema(JsonSchema inputJsonSchema) {
  ...
  public Action resultJsonSchema(JsonSchema resultJsonSchema) {
