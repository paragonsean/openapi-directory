...
|------------ | ------------- | ------------- | -------------|
|**membership** | [**MembershipEnum**](#MembershipEnum) | Indicates whether the binding includes the member. |  [optional] |
|**relevance** | [**RelevanceEnum**](#RelevanceEnum) | The relevance of the member&#39;s status to the overall determination for the binding. |  [optional] |
