...
public class GoogleCloudPolicytroubleshooterV1betaBindingExplanation {
  ...
  private Map<String, GoogleCloudPolicytroubleshooterV1betaBindingExplanationAnnotatedMembership> memberships = new HashMap<>();
  ...
  public GoogleCloudPolicytroubleshooterV1betaBindingExplanation access(AccessEnum access) {
    this.access = access;
    return this;
  }
  ...
  public GoogleCloudPolicytroubleshooterV1betaBindingExplanation condition(GoogleTypeExpr condition) {
  ...
  public GoogleCloudPolicytroubleshooterV1betaBindingExplanation memberships(Map<String, GoogleCloudPolicytroubleshooterV1betaBindingExplanationAnnotatedMembership> memberships) {
    this.memberships = memberships;
    return this;
  }

  public GoogleCloudPolicytroubleshooterV1betaBindingExplanation putMembershipsItem(String key, GoogleCloudPolicytroubleshooterV1betaBindingExplanationAnnotatedMembership membershipsItem) {
   ...
   */
  @javax.annotation.Nullable
  public Map<String, GoogleCloudPolicytroubleshooterV1betaBindingExplanationAnnotatedMembership> getMemberships() {
    return memberships;
  }

  public void setMemberships(Map<String, GoogleCloudPolicytroubleshooterV1betaBindingExplanationAnnotatedMembership> memberships) {
    this.memberships = memberships;
  }


  public GoogleCloudPolicytroubleshooterV1betaBindingExplanation relevance(RelevanceEnum relevance) {
  ...
  public GoogleCloudPolicytroubleshooterV1betaBindingExplanation role(String role) {
    this.role = role;
    return this;
  }
  ...
  public GoogleCloudPolicytroubleshooterV1betaBindingExplanation rolePermission(RolePermissionEnum rolePermission) {
  ...
  public GoogleCloudPolicytroubleshooterV1betaBindingExplanation rolePermissionRelevance(RolePermissionRelevanceEnum rolePermissionRelevance) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudPolicytroubleshooterV1betaBindingExplanation googleCloudPolicytroubleshooterV1betaBindingExplanation = (GoogleCloudPolicytroubleshooterV1betaBindingExplanation) o;
    return Objects.equals(this.access, googleCloudPolicytroubleshooterV1betaBindingExplanation.access) &&
        Objects.equals(this.condition, googleCloudPolicytroubleshooterV1betaBindingExplanation.condition) &&
        Objects.equals(this.memberships, googleCloudPolicytroubleshooterV1betaBindingExplanation.memberships) &&
        Objects.equals(this.relevance, googleCloudPolicytroubleshooterV1betaBindingExplanation.relevance) &&
        Objects.equals(this.role, googleCloudPolicytroubleshooterV1betaBindingExplanation.role) &&
        Objects.equals(this.rolePermission, googleCloudPolicytroubleshooterV1betaBindingExplanation.rolePermission) &&
        Objects.equals(this.rolePermissionRelevance, googleCloudPolicytroubleshooterV1betaBindingExplanation.rolePermissionRelevance);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudPolicytroubleshooterV1betaBindingExplanation {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudPolicytroubleshooterV1betaBindingExplanation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudPolicytroubleshooterV1betaBindingExplanation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudPolicytroubleshooterV1betaBindingExplanation is not found in the empty JSON string", GoogleCloudPolicytroubleshooterV1betaBindingExplanation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudPolicytroubleshooterV1betaBindingExplanation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudPolicytroubleshooterV1betaBindingExplanation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudPolicytroubleshooterV1betaBindingExplanation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudPolicytroubleshooterV1betaBindingExplanation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudPolicytroubleshooterV1betaBindingExplanation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudPolicytroubleshooterV1betaBindingExplanation.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudPolicytroubleshooterV1betaBindingExplanation>() {
           @Override
           public void write(JsonWriter out, GoogleCloudPolicytroubleshooterV1betaBindingExplanation value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudPolicytroubleshooterV1betaBindingExplanation read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudPolicytroubleshooterV1betaBindingExplanation given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudPolicytroubleshooterV1betaBindingExplanation
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudPolicytroubleshooterV1betaBindingExplanation
   */
  public static GoogleCloudPolicytroubleshooterV1betaBindingExplanation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudPolicytroubleshooterV1betaBindingExplanation.class);
  }

  /**
   * Convert an instance of GoogleCloudPolicytroubleshooterV1betaBindingExplanation to an JSON string
   *
   * @return JSON string
   */
