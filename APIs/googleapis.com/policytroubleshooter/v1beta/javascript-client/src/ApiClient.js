...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://policytroubleshooter.googleapis.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://policytroubleshooter.googleapis.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/v1beta/Javascript'
        };
