...
/**
 * The GoogleCloudPolicytroubleshooterV1BindingExplanation model module.
 * @module model/GoogleCloudPolicytroubleshooterV1BindingExplanation
 * @version v1
 */
class GoogleCloudPolicytroubleshooterV1BindingExplanation {
    /**
     * Constructs a new <code>GoogleCloudPolicytroubleshooterV1BindingExplanation</code>.
     * Details about how a binding in a policy affects a principal&#39;s ability to use a permission.
     * @alias module:model/GoogleCloudPolicytroubleshooterV1BindingExplanation
     */
    constructor() { 
        
        GoogleCloudPolicytroubleshooterV1BindingExplanation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudPolicytroubleshooterV1BindingExplanation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudPolicytroubleshooterV1BindingExplanation} obj Optional instance to populate.
     * @return {module:model/GoogleCloudPolicytroubleshooterV1BindingExplanation} The populated <code>GoogleCloudPolicytroubleshooterV1BindingExplanation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudPolicytroubleshooterV1BindingExplanation();
            ...
            if (data.hasOwnProperty('memberships')) {
                obj['memberships'] = ApiClient.convertToType(data['memberships'], {'String': GoogleCloudPolicytroubleshooterV1BindingExplanationAnnotatedMembership});
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudPolicytroubleshooterV1BindingExplanation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudPolicytroubleshooterV1BindingExplanation</code>.
     */
 ...
 * @member {module:model/GoogleCloudPolicytroubleshooterV1BindingExplanation.AccessEnum} access
 */
GoogleCloudPolicytroubleshooterV1BindingExplanation.prototype['access'] = undefined;

/**
 * @member {module:model/GoogleTypeExpr} condition
 */
GoogleCloudPolicytroubleshooterV1BindingExplanation.prototype['condition'] = undefined;
 ...
 * @member {Object.<String, module:model/GoogleCloudPolicytroubleshooterV1BindingExplanationAnnotatedMembership>} memberships
 */
GoogleCloudPolicytroubleshooterV1BindingExplanation.prototype['memberships'] = undefined;

/**
 * The relevance of this binding to the overall determination for the entire policy.
 * @member {module:model/GoogleCloudPolicytroubleshooterV1BindingExplanation.RelevanceEnum} relevance
 */
GoogleCloudPolicytroubleshooterV1BindingExplanation.prototype['relevance'] = undefined;
 ...
 * @member {String} role
 */
GoogleCloudPolicytroubleshooterV1BindingExplanation.prototype['role'] = undefined;

/**
 * Indicates whether the role granted by this binding contains the specified permission.
 * @member {module:model/GoogleCloudPolicytroubleshooterV1BindingExplanation.RolePermissionEnum} rolePermission
 */
GoogleCloudPolicytroubleshooterV1BindingExplanation.prototype['rolePermission'] = undefined;

/**
 * The relevance of the permission's existence, or nonexistence, in the role to the overall determination for the entire policy.
 * @member {module:model/GoogleCloudPolicytroubleshooterV1BindingExplanation.RolePermissionRelevanceEnum} rolePermissionRelevance
 */
GoogleCloudPolicytroubleshooterV1BindingExplanation.prototype['rolePermissionRelevance'] = undefined;
 ...
 * @readonly
 */
GoogleCloudPolicytroubleshooterV1BindingExplanation['AccessEnum'] = {
 ...
 * @readonly
 */
GoogleCloudPolicytroubleshooterV1BindingExplanation['RelevanceEnum'] = {
 ...
 * @readonly
 */
GoogleCloudPolicytroubleshooterV1BindingExplanation['RolePermissionEnum'] = {
 ...
 * @readonly
 */
GoogleCloudPolicytroubleshooterV1BindingExplanation['RolePermissionRelevanceEnum'] = {
...
export default GoogleCloudPolicytroubleshooterV1BindingExplanation;
