...
/**
 * The GoogleCloudPolicytroubleshooterV1AccessTuple model module.
 * @module model/GoogleCloudPolicytroubleshooterV1AccessTuple
 * @version v1
 */
class GoogleCloudPolicytroubleshooterV1AccessTuple {
    /**
     * Constructs a new <code>GoogleCloudPolicytroubleshooterV1AccessTuple</code>.
     * Information about the principal, resource, and permission to check.
     * @alias module:model/GoogleCloudPolicytroubleshooterV1AccessTuple
     */
    constructor() { 
        
        GoogleCloudPolicytroubleshooterV1AccessTuple.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudPolicytroubleshooterV1AccessTuple</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudPolicytroubleshooterV1AccessTuple} obj Optional instance to populate.
     * @return {module:model/GoogleCloudPolicytroubleshooterV1AccessTuple} The populated <code>GoogleCloudPolicytroubleshooterV1AccessTuple</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudPolicytroubleshooterV1AccessTuple();
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudPolicytroubleshooterV1AccessTuple</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudPolicytroubleshooterV1AccessTuple</code>.
     */
...
export default GoogleCloudPolicytroubleshooterV1AccessTuple;
