...
|**bindingExplanations** | [**List&lt;GoogleCloudPolicytroubleshooterV1BindingExplanation&gt;**](GoogleCloudPolicytroubleshooterV1BindingExplanation.md) | Details about how each binding in the policy affects the principal&#39;s ability, or inability, to use the permission for the resource. If the sender of the request does not have access to the policy, this field is omitted. |  [optional] |
