...
public class GoogleCloudPolicytroubleshooterV1BindingExplanation {
  ...
  private Map<String, GoogleCloudPolicytroubleshooterV1BindingExplanationAnnotatedMembership> memberships = new HashMap<>();
  ...
  public GoogleCloudPolicytroubleshooterV1BindingExplanation() {
  }

  public GoogleCloudPolicytroubleshooterV1BindingExplanation access(AccessEnum access) {
    this.access = access;
    return this;
  }
  ...
  public GoogleCloudPolicytroubleshooterV1BindingExplanation condition(GoogleTypeExpr condition) {
  ...
  public GoogleCloudPolicytroubleshooterV1BindingExplanation memberships(Map<String, GoogleCloudPolicytroubleshooterV1BindingExplanationAnnotatedMembership> memberships) {
    this.memberships = memberships;
    return this;
  }

  public GoogleCloudPolicytroubleshooterV1BindingExplanation putMembershipsItem(String key, GoogleCloudPolicytroubleshooterV1BindingExplanationAnnotatedMembership membershipsItem) {
  ...
  public void setMemberships(Map<String, GoogleCloudPolicytroubleshooterV1BindingExplanationAnnotatedMembership> memberships) {
    this.memberships = memberships;
  }


  public GoogleCloudPolicytroubleshooterV1BindingExplanation relevance(RelevanceEnum relevance) {
  ...
  public GoogleCloudPolicytroubleshooterV1BindingExplanation role(String role) {
    this.role = role;
    return this;
  }
  ...
  public GoogleCloudPolicytroubleshooterV1BindingExplanation rolePermission(RolePermissionEnum rolePermission) {
  ...
  public GoogleCloudPolicytroubleshooterV1BindingExplanation rolePermissionRelevance(RolePermissionRelevanceEnum rolePermissionRelevance) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudPolicytroubleshooterV1BindingExplanation googleCloudPolicytroubleshooterV1BindingExplanation = (GoogleCloudPolicytroubleshooterV1BindingExplanation) o;
    return Objects.equals(this.access, googleCloudPolicytroubleshooterV1BindingExplanation.access) &&
        Objects.equals(this.condition, googleCloudPolicytroubleshooterV1BindingExplanation.condition) &&
        Objects.equals(this.memberships, googleCloudPolicytroubleshooterV1BindingExplanation.memberships) &&
        Objects.equals(this.relevance, googleCloudPolicytroubleshooterV1BindingExplanation.relevance) &&
        Objects.equals(this.role, googleCloudPolicytroubleshooterV1BindingExplanation.role) &&
        Objects.equals(this.rolePermission, googleCloudPolicytroubleshooterV1BindingExplanation.rolePermission) &&
        Objects.equals(this.rolePermissionRelevance, googleCloudPolicytroubleshooterV1BindingExplanation.rolePermissionRelevance);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudPolicytroubleshooterV1BindingExplanation {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudPolicytroubleshooterV1BindingExplanation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudPolicytroubleshooterV1BindingExplanation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudPolicytroubleshooterV1BindingExplanation is not found in the empty JSON string", GoogleCloudPolicytroubleshooterV1BindingExplanation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudPolicytroubleshooterV1BindingExplanation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudPolicytroubleshooterV1BindingExplanation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudPolicytroubleshooterV1BindingExplanation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudPolicytroubleshooterV1BindingExplanation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudPolicytroubleshooterV1BindingExplanation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudPolicytroubleshooterV1BindingExplanation.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudPolicytroubleshooterV1BindingExplanation>() {
           @Override
           public void write(JsonWriter out, GoogleCloudPolicytroubleshooterV1BindingExplanation value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudPolicytroubleshooterV1BindingExplanation read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudPolicytroubleshooterV1BindingExplanation given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudPolicytroubleshooterV1BindingExplanation
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudPolicytroubleshooterV1BindingExplanation
   */
  public static GoogleCloudPolicytroubleshooterV1BindingExplanation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudPolicytroubleshooterV1BindingExplanation.class);
  }

  /**
   * Convert an instance of GoogleCloudPolicytroubleshooterV1BindingExplanation to an JSON string
   *
   * @return JSON string
   */
