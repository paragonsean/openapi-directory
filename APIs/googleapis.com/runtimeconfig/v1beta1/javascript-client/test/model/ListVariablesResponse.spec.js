...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudRuntimeConfigurationApi.ListVariablesResponse();
  });
  ...
  describe('ListVariablesResponse', function() {
    it('should create an instance of ListVariablesResponse', function() {
      // uncomment below and update the code to test ListVariablesResponse
      //var instance = new CloudRuntimeConfigurationApi.ListVariablesResponse();
      //expect(instance).to.be.a(CloudRuntimeConfigurationApi.ListVariablesResponse);
    });
