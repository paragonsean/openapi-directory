...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudRuntimeConfigurationApi.Waiter();
  });
  ...
  describe('Waiter', function() {
    it('should create an instance of Waiter', function() {
      // uncomment below and update the code to test Waiter
      //var instance = new CloudRuntimeConfigurationApi.Waiter();
      //expect(instance).to.be.a(CloudRuntimeConfigurationApi.Waiter);
    });
