...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudRuntimeConfigurationApi.ListConfigsResponse();
  });
  ...
  describe('ListConfigsResponse', function() {
    it('should create an instance of ListConfigsResponse', function() {
      // uncomment below and update the code to test ListConfigsResponse
      //var instance = new CloudRuntimeConfigurationApi.ListConfigsResponse();
      //expect(instance).to.be.a(CloudRuntimeConfigurationApi.ListConfigsResponse);
    });
