# CloudRuntimeConfigurationApi.ListVariablesResponse
...
**variables** | [**[Variable]**](Variable.md) | A list of variables and their values. The order of returned variable objects is arbitrary. | [optional] 
