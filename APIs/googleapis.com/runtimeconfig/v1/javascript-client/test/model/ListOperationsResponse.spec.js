...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudRuntimeConfigurationApi.ListOperationsResponse();
  });
  ...
  describe('ListOperationsResponse', function() {
    it('should create an instance of ListOperationsResponse', function() {
      ...
      //var instance = new CloudRuntimeConfigurationApi.ListOperationsResponse();
      //expect(instance).to.be.a(CloudRuntimeConfigurationApi.ListOperationsResponse);
    });
