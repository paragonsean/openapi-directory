...
**otherDeviceIds** | [**[AgentOtherDeviceId]**](AgentOtherDeviceId.md) | Alternate IDs associated with this device. This is used to identify cloud synced devices enabled for [local fulfillment](https://developers.home.google.com/local-home/overview). | [optional] 
...
**traits** | **[String]** | Traits supported by the device. See [device traits](https://developers.home.google.com/cloud-to-cloud/traits). | [optional] 
