...
public class Video {
  ...
  public static final String SERIALIZED_NAME_VIDEO_PROPERTIES = "videoProperties";
  @SerializedName(SERIALIZED_NAME_VIDEO_PROPERTIES)
  ...
  public Video source(SourceEnum source) {
    this.source = source;
    return this;
  }
  ...
  public Video videoProperties(VideoProperties videoProperties) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, video.id) &&
        ...
        Objects.equals(this.videoProperties, video.videoProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, source, url, videoProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    videoProperties: ").append(toIndentedString(videoProperties)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("videoProperties");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("videoProperties") != null && !jsonObj.get("videoProperties").isJsonNull()) {
        VideoProperties.validateJsonElement(jsonObj.get("videoProperties"));
      }
  }
