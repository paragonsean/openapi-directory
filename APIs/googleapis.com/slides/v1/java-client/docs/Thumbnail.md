...
|**height** | **Integer** | The positive height in pixels of the thumbnail image. |  [optional] |
|**width** | **Integer** | The positive width in pixels of the thumbnail image. |  [optional] |
