...
|------------ | ------------- | ------------- | -------------|
|**columnIndices** | **List&lt;Integer&gt;** | The list of zero-based indices specifying which columns to update. If no indices are provided, all columns in the table will be updated. |  [optional] |
