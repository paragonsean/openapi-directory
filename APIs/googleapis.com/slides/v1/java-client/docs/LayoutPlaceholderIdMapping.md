...
|------------ | ------------- | ------------- | -------------|
|**layoutPlaceholder** | [**Placeholder**](Placeholder.md) |  |  [optional] |
|**layoutPlaceholderObjectId** | **String** | The object ID of the placeholder on a layout that will be applied to a slide. |  [optional] |
