...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleSlidesApi.RgbColor();
  });
  ...
  describe('RgbColor', function() {
    it('should create an instance of RgbColor', function() {
      // uncomment below and update the code to test RgbColor
      //var instance = new GoogleSlidesApi.RgbColor();
      //expect(instance).to.be.a(GoogleSlidesApi.RgbColor);
    });
