...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleSlidesApi.DuplicateObjectRequest();
  });
  ...
  describe('DuplicateObjectRequest', function() {
    it('should create an instance of DuplicateObjectRequest', function() {
      // uncomment below and update the code to test DuplicateObjectRequest
      //var instance = new GoogleSlidesApi.DuplicateObjectRequest();
      //expect(instance).to.be.a(GoogleSlidesApi.DuplicateObjectRequest);
    });
