...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleSlidesApi.UpdatePageElementTransformRequest();
  });
  ...
  describe('UpdatePageElementTransformRequest', function() {
    it('should create an instance of UpdatePageElementTransformRequest', function() {
      // uncomment below and update the code to test UpdatePageElementTransformRequest
      //var instance = new GoogleSlidesApi.UpdatePageElementTransformRequest();
      //expect(instance).to.be.a(GoogleSlidesApi.UpdatePageElementTransformRequest);
    });
