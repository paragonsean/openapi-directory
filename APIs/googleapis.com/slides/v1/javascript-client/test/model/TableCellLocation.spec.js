...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleSlidesApi.TableCellLocation();
  });
  ...
  describe('TableCellLocation', function() {
    it('should create an instance of TableCellLocation', function() {
      // uncomment below and update the code to test TableCellLocation
      //var instance = new GoogleSlidesApi.TableCellLocation();
      //expect(instance).to.be.a(GoogleSlidesApi.TableCellLocation);
    });
