...
/*
 * OAIDeleteTextRequest.h
 *
 * Deletes text from a shape or a table cell.
 */

#ifndef OAIDeleteTextRequest_H
#define OAIDeleteTextRequest_H
...
class OAIDeleteTextRequest : public OAIObject {
public:
    OAIDeleteTextRequest();
    OAIDeleteTextRequest(QString json);
    ~OAIDeleteTextRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteTextRequest)

#endif // OAIDeleteTextRequest_H
