...
QString OAIThumbnail::getContentUrl() const {
    return m_content_url;
}
void OAIThumbnail::setContentUrl(const QString &content_url) {
    m_content_url = content_url;
    m_content_url_isSet = true;
}

bool OAIThumbnail::is_content_url_Set() const{
    return m_content_url_isSet;
}

bool OAIThumbnail::is_content_url_Valid() const{
