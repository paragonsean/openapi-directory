...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudDocumentAiApi.GoogleCloudDocumentaiV1beta2DocumentPageTableTableCell();
  });
  ...
  describe('GoogleCloudDocumentaiV1beta2DocumentPageTableTableCell', function() {
    it('should create an instance of GoogleCloudDocumentaiV1beta2DocumentPageTableTableCell', function() {
      // uncomment below and update the code to test GoogleCloudDocumentaiV1beta2DocumentPageTableTableCell
      //var instance = new CloudDocumentAiApi.GoogleCloudDocumentaiV1beta2DocumentPageTableTableCell();
      //expect(instance).to.be.a(CloudDocumentAiApi.GoogleCloudDocumentaiV1beta2DocumentPageTableTableCell);
    });
