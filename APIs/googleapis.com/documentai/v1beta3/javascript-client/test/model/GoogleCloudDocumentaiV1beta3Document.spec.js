...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudDocumentAiApi.GoogleCloudDocumentaiV1beta3Document();
  });
  ...
  describe('GoogleCloudDocumentaiV1beta3Document', function() {
    it('should create an instance of GoogleCloudDocumentaiV1beta3Document', function() {
      // uncomment below and update the code to test GoogleCloudDocumentaiV1beta3Document
      //var instance = new CloudDocumentAiApi.GoogleCloudDocumentaiV1beta3Document();
      //expect(instance).to.be.a(CloudDocumentAiApi.GoogleCloudDocumentaiV1beta3Document);
    });
