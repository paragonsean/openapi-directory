...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudDocumentAiApi.GoogleTypeDateTime();
  });
  ...
  describe('GoogleTypeDateTime', function() {
    it('should create an instance of GoogleTypeDateTime', function() {
      ...
      //var instance = new CloudDocumentAiApi.GoogleTypeDateTime();
      //expect(instance).to.be.a(CloudDocumentAiApi.GoogleTypeDateTime);
    });
