...
import GoogleCloudDocumentaiV1beta1DocumentStyleFontSize from './GoogleCloudDocumentaiV1beta1DocumentStyleFontSize';
...
/**
 * The GoogleCloudDocumentaiV1beta1DocumentStyle model module.
 * @module model/GoogleCloudDocumentaiV1beta1DocumentStyle
 * @version v1beta3
 */
class GoogleCloudDocumentaiV1beta1DocumentStyle {
    /**
     * Constructs a new <code>GoogleCloudDocumentaiV1beta1DocumentStyle</code>.
     * Annotation for common text style attributes. This adheres to CSS conventions as much as possible.
     * @alias module:model/GoogleCloudDocumentaiV1beta1DocumentStyle
     */
    constructor() { 
        
        GoogleCloudDocumentaiV1beta1DocumentStyle.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudDocumentaiV1beta1DocumentStyle</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudDocumentaiV1beta1DocumentStyle} obj Optional instance to populate.
     * @return {module:model/GoogleCloudDocumentaiV1beta1DocumentStyle} The populated <code>GoogleCloudDocumentaiV1beta1DocumentStyle</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudDocumentaiV1beta1DocumentStyle();
            ...
            if (data.hasOwnProperty('fontSize')) {
                obj['fontSize'] = GoogleCloudDocumentaiV1beta1DocumentStyleFontSize.constructFromObject(data['fontSize']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudDocumentaiV1beta1DocumentStyle</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudDocumentaiV1beta1DocumentStyle</code>.
     */
    static validateJSON(data) {
        ...
        if (data['fontSize']) { // data not null
          GoogleCloudDocumentaiV1beta1DocumentStyleFontSize.validateJSON(data['fontSize']);
        }
        // ensure the json data is a string
 ...
 */
GoogleCloudDocumentaiV1beta1DocumentStyle.prototype['backgroundColor'] = undefined;

/**
 * @member {module:model/GoogleTypeColor} color
 */
GoogleCloudDocumentaiV1beta1DocumentStyle.prototype['color'] = undefined;

/**
 * Font family such as `Arial`, `Times New Roman`. https://www.w3schools.com/cssref/pr_font_font-family.asp
 * @member {String} fontFamily
 */
GoogleCloudDocumentaiV1beta1DocumentStyle.prototype['fontFamily'] = undefined;

/**
 * @member {module:model/GoogleCloudDocumentaiV1beta1DocumentStyleFontSize} fontSize
 */
GoogleCloudDocumentaiV1beta1DocumentStyle.prototype['fontSize'] = undefined;

/**
 * [Font weight](https://www.w3schools.com/cssref/pr_font_weight.asp). Possible values are `normal`, `bold`, `bolder`, and `lighter`.
 * @member {String} fontWeight
 */
GoogleCloudDocumentaiV1beta1DocumentStyle.prototype['fontWeight'] = undefined;

/**
 * @member {module:model/GoogleCloudDocumentaiV1beta1DocumentTextAnchor} textAnchor
 */
GoogleCloudDocumentaiV1beta1DocumentStyle.prototype['textAnchor'] = undefined;

/**
 * [Text decoration](https://www.w3schools.com/cssref/pr_text_text-decoration.asp). Follows CSS standard. 
 * @member {String} textDecoration
 */
GoogleCloudDocumentaiV1beta1DocumentStyle.prototype['textDecoration'] = undefined;

/**
 * [Text style](https://www.w3schools.com/cssref/pr_font_font-style.asp). Possible values are `normal`, `italic`, and `oblique`.
 * @member {String} textStyle
 */
GoogleCloudDocumentaiV1beta1DocumentStyle.prototype['textStyle'] = undefined;
...
export default GoogleCloudDocumentaiV1beta1DocumentStyle;
