...
public class GoogleCloudDocumentaiV1beta3EvaluationMetrics {
  ...
  public GoogleCloudDocumentaiV1beta3EvaluationMetrics f1Score(Float f1Score) {
  ...
  public GoogleCloudDocumentaiV1beta3EvaluationMetrics falseNegativesCount(Integer falseNegativesCount) {
  ...
  public GoogleCloudDocumentaiV1beta3EvaluationMetrics falsePositivesCount(Integer falsePositivesCount) {
  ...
  public GoogleCloudDocumentaiV1beta3EvaluationMetrics groundTruthDocumentCount(Integer groundTruthDocumentCount) {
  ...
  public GoogleCloudDocumentaiV1beta3EvaluationMetrics groundTruthOccurrencesCount(Integer groundTruthOccurrencesCount) {
  ...
  public GoogleCloudDocumentaiV1beta3EvaluationMetrics precision(Float precision) {
  ...
  public GoogleCloudDocumentaiV1beta3EvaluationMetrics predictedDocumentCount(Integer predictedDocumentCount) {
  ...
  public GoogleCloudDocumentaiV1beta3EvaluationMetrics predictedOccurrencesCount(Integer predictedOccurrencesCount) {
  ...
  public GoogleCloudDocumentaiV1beta3EvaluationMetrics recall(Float recall) {
    this.recall = recall;
    return this;
  }
  ...
  public GoogleCloudDocumentaiV1beta3EvaluationMetrics totalDocumentsCount(Integer totalDocumentsCount) {
  ...
  public GoogleCloudDocumentaiV1beta3EvaluationMetrics truePositivesCount(Integer truePositivesCount) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudDocumentaiV1beta3EvaluationMetrics googleCloudDocumentaiV1beta3EvaluationMetrics = (GoogleCloudDocumentaiV1beta3EvaluationMetrics) o;
    return Objects.equals(this.f1Score, googleCloudDocumentaiV1beta3EvaluationMetrics.f1Score) &&
        Objects.equals(this.falseNegativesCount, googleCloudDocumentaiV1beta3EvaluationMetrics.falseNegativesCount) &&
        Objects.equals(this.falsePositivesCount, googleCloudDocumentaiV1beta3EvaluationMetrics.falsePositivesCount) &&
        Objects.equals(this.groundTruthDocumentCount, googleCloudDocumentaiV1beta3EvaluationMetrics.groundTruthDocumentCount) &&
        Objects.equals(this.groundTruthOccurrencesCount, googleCloudDocumentaiV1beta3EvaluationMetrics.groundTruthOccurrencesCount) &&
        Objects.equals(this.precision, googleCloudDocumentaiV1beta3EvaluationMetrics.precision) &&
        Objects.equals(this.predictedDocumentCount, googleCloudDocumentaiV1beta3EvaluationMetrics.predictedDocumentCount) &&
        Objects.equals(this.predictedOccurrencesCount, googleCloudDocumentaiV1beta3EvaluationMetrics.predictedOccurrencesCount) &&
        Objects.equals(this.recall, googleCloudDocumentaiV1beta3EvaluationMetrics.recall) &&
        Objects.equals(this.totalDocumentsCount, googleCloudDocumentaiV1beta3EvaluationMetrics.totalDocumentsCount) &&
        Objects.equals(this.truePositivesCount, googleCloudDocumentaiV1beta3EvaluationMetrics.truePositivesCount);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudDocumentaiV1beta3EvaluationMetrics {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudDocumentaiV1beta3EvaluationMetrics
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudDocumentaiV1beta3EvaluationMetrics.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudDocumentaiV1beta3EvaluationMetrics is not found in the empty JSON string", GoogleCloudDocumentaiV1beta3EvaluationMetrics.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudDocumentaiV1beta3EvaluationMetrics.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudDocumentaiV1beta3EvaluationMetrics` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudDocumentaiV1beta3EvaluationMetrics.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudDocumentaiV1beta3EvaluationMetrics' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudDocumentaiV1beta3EvaluationMetrics> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudDocumentaiV1beta3EvaluationMetrics.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudDocumentaiV1beta3EvaluationMetrics>() {
           @Override
           public void write(JsonWriter out, GoogleCloudDocumentaiV1beta3EvaluationMetrics value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudDocumentaiV1beta3EvaluationMetrics read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudDocumentaiV1beta3EvaluationMetrics given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudDocumentaiV1beta3EvaluationMetrics
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudDocumentaiV1beta3EvaluationMetrics
   */
  public static GoogleCloudDocumentaiV1beta3EvaluationMetrics fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudDocumentaiV1beta3EvaluationMetrics.class);
  }

  /**
   * Convert an instance of GoogleCloudDocumentaiV1beta3EvaluationMetrics to an JSON string
   *
   * @return JSON string
   */
