...
import org.openapitools.client.model.GoogleCloudDocumentaiV1beta3DocumentStyleFontSize;
...
public class GoogleCloudDocumentaiV1beta3DocumentStyle {
  ...
  public GoogleCloudDocumentaiV1beta3DocumentStyle backgroundColor(GoogleTypeColor backgroundColor) {
  ...
  public GoogleCloudDocumentaiV1beta3DocumentStyle color(GoogleTypeColor color) {
    this.color = color;
    return this;
  }
  ...
  public GoogleCloudDocumentaiV1beta3DocumentStyle fontFamily(String fontFamily) {
  ...
  public GoogleCloudDocumentaiV1beta3DocumentStyle fontSize(GoogleCloudDocumentaiV1beta3DocumentStyleFontSize fontSize) {
  ...
  public void setFontSize(GoogleCloudDocumentaiV1beta3DocumentStyleFontSize fontSize) {
    this.fontSize = fontSize;
  }


  public GoogleCloudDocumentaiV1beta3DocumentStyle fontWeight(String fontWeight) {
  ...
  public GoogleCloudDocumentaiV1beta3DocumentStyle textAnchor(GoogleCloudDocumentaiV1beta3DocumentTextAnchor textAnchor) {
  ...
  public GoogleCloudDocumentaiV1beta3DocumentStyle textDecoration(String textDecoration) {
  ...
  public GoogleCloudDocumentaiV1beta3DocumentStyle textStyle(String textStyle) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudDocumentaiV1beta3DocumentStyle googleCloudDocumentaiV1beta3DocumentStyle = (GoogleCloudDocumentaiV1beta3DocumentStyle) o;
    return Objects.equals(this.backgroundColor, googleCloudDocumentaiV1beta3DocumentStyle.backgroundColor) &&
        Objects.equals(this.color, googleCloudDocumentaiV1beta3DocumentStyle.color) &&
        Objects.equals(this.fontFamily, googleCloudDocumentaiV1beta3DocumentStyle.fontFamily) &&
        Objects.equals(this.fontSize, googleCloudDocumentaiV1beta3DocumentStyle.fontSize) &&
        Objects.equals(this.fontWeight, googleCloudDocumentaiV1beta3DocumentStyle.fontWeight) &&
        Objects.equals(this.textAnchor, googleCloudDocumentaiV1beta3DocumentStyle.textAnchor) &&
        Objects.equals(this.textDecoration, googleCloudDocumentaiV1beta3DocumentStyle.textDecoration) &&
        Objects.equals(this.textStyle, googleCloudDocumentaiV1beta3DocumentStyle.textStyle);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudDocumentaiV1beta3DocumentStyle {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudDocumentaiV1beta3DocumentStyle
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudDocumentaiV1beta3DocumentStyle.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudDocumentaiV1beta3DocumentStyle is not found in the empty JSON string", GoogleCloudDocumentaiV1beta3DocumentStyle.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudDocumentaiV1beta3DocumentStyle.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudDocumentaiV1beta3DocumentStyle` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("fontSize") != null && !jsonObj.get("fontSize").isJsonNull()) {
        GoogleCloudDocumentaiV1beta3DocumentStyleFontSize.validateJsonElement(jsonObj.get("fontSize"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudDocumentaiV1beta3DocumentStyle.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudDocumentaiV1beta3DocumentStyle' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudDocumentaiV1beta3DocumentStyle> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudDocumentaiV1beta3DocumentStyle.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudDocumentaiV1beta3DocumentStyle>() {
           @Override
           public void write(JsonWriter out, GoogleCloudDocumentaiV1beta3DocumentStyle value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudDocumentaiV1beta3DocumentStyle read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudDocumentaiV1beta3DocumentStyle given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudDocumentaiV1beta3DocumentStyle
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudDocumentaiV1beta3DocumentStyle
   */
  public static GoogleCloudDocumentaiV1beta3DocumentStyle fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudDocumentaiV1beta3DocumentStyle.class);
  }

  /**
   * Convert an instance of GoogleCloudDocumentaiV1beta3DocumentStyle to an JSON string
   *
   * @return JSON string
   */
