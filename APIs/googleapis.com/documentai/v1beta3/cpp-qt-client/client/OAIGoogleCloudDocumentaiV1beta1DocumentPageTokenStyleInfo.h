...
/*
 * OAIGoogleCloudDocumentaiV1beta1DocumentPageTokenStyleInfo.h
 *
 * Font and other text style attributes.
 */

#ifndef OAIGoogleCloudDocumentaiV1beta1DocumentPageTokenStyleInfo_H
#define OAIGoogleCloudDocumentaiV1beta1DocumentPageTokenStyleInfo_H
...
class OAIGoogleCloudDocumentaiV1beta1DocumentPageTokenStyleInfo : public OAIObject {
public:
    OAIGoogleCloudDocumentaiV1beta1DocumentPageTokenStyleInfo();
    OAIGoogleCloudDocumentaiV1beta1DocumentPageTokenStyleInfo(QString json);
    ~OAIGoogleCloudDocumentaiV1beta1DocumentPageTokenStyleInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudDocumentaiV1beta1DocumentPageTokenStyleInfo)

#endif // OAIGoogleCloudDocumentaiV1beta1DocumentPageTokenStyleInfo_H
