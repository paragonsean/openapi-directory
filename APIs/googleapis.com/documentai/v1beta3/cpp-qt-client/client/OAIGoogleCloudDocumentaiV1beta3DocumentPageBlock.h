...
/*
 * OAIGoogleCloudDocumentaiV1beta3DocumentPageBlock.h
 *
 * A block has a set of lines (collected into paragraphs) that have a common line-spacing and orientation.
 */

#ifndef OAIGoogleCloudDocumentaiV1beta3DocumentPageBlock_H
#define OAIGoogleCloudDocumentaiV1beta3DocumentPageBlock_H
...
class OAIGoogleCloudDocumentaiV1beta3DocumentPageBlock : public OAIObject {
public:
    OAIGoogleCloudDocumentaiV1beta3DocumentPageBlock();
    OAIGoogleCloudDocumentaiV1beta3DocumentPageBlock(QString json);
    ~OAIGoogleCloudDocumentaiV1beta3DocumentPageBlock() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudDocumentaiV1beta3DocumentPageBlock)

#endif // OAIGoogleCloudDocumentaiV1beta3DocumentPageBlock_H
