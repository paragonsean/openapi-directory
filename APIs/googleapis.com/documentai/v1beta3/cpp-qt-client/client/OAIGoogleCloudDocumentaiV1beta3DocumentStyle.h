...
/*
 * OAIGoogleCloudDocumentaiV1beta3DocumentStyle.h
 *
 * Annotation for common text style attributes. This adheres to CSS conventions as much as possible.
 */

#ifndef OAIGoogleCloudDocumentaiV1beta3DocumentStyle_H
#define OAIGoogleCloudDocumentaiV1beta3DocumentStyle_H
...
class OAIGoogleCloudDocumentaiV1beta3DocumentStyleFontSize;
class OAIGoogleCloudDocumentaiV1beta3DocumentTextAnchor;

class OAIGoogleCloudDocumentaiV1beta3DocumentStyle : public OAIObject {
public:
    OAIGoogleCloudDocumentaiV1beta3DocumentStyle();
    OAIGoogleCloudDocumentaiV1beta3DocumentStyle(QString json);
    ~OAIGoogleCloudDocumentaiV1beta3DocumentStyle() override;
    ...
    OAIGoogleCloudDocumentaiV1beta3DocumentStyleFontSize getFontSize() const;
    void setFontSize(const OAIGoogleCloudDocumentaiV1beta3DocumentStyleFontSize &font_size);
...
private:
    ...
    OAIGoogleCloudDocumentaiV1beta3DocumentStyleFontSize m_font_size;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudDocumentaiV1beta3DocumentStyle)

#endif // OAIGoogleCloudDocumentaiV1beta3DocumentStyle_H
