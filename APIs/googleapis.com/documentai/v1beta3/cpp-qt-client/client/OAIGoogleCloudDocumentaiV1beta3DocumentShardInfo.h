...
/*
 * OAIGoogleCloudDocumentaiV1beta3DocumentShardInfo.h
 *
 * For a large document, sharding may be performed to produce several document shards. Each document shard contains this field to detail which shard it is.
 */

#ifndef OAIGoogleCloudDocumentaiV1beta3DocumentShardInfo_H
#define OAIGoogleCloudDocumentaiV1beta3DocumentShardInfo_H
...
class OAIGoogleCloudDocumentaiV1beta3DocumentShardInfo : public OAIObject {
public:
    OAIGoogleCloudDocumentaiV1beta3DocumentShardInfo();
    OAIGoogleCloudDocumentaiV1beta3DocumentShardInfo(QString json);
    ~OAIGoogleCloudDocumentaiV1beta3DocumentShardInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudDocumentaiV1beta3DocumentShardInfo)

#endif // OAIGoogleCloudDocumentaiV1beta3DocumentShardInfo_H
