...
/*
 * OAIGoogleCloudDocumentaiV1beta1DocumentShardInfo.h
 *
 * For a large document, sharding may be performed to produce several document shards. Each document shard contains this field to detail which shard it is.
 */

#ifndef OAIGoogleCloudDocumentaiV1beta1DocumentShardInfo_H
#define OAIGoogleCloudDocumentaiV1beta1DocumentShardInfo_H
...
class OAIGoogleCloudDocumentaiV1beta1DocumentShardInfo : public OAIObject {
public:
    OAIGoogleCloudDocumentaiV1beta1DocumentShardInfo();
    OAIGoogleCloudDocumentaiV1beta1DocumentShardInfo(QString json);
    ~OAIGoogleCloudDocumentaiV1beta1DocumentShardInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudDocumentaiV1beta1DocumentShardInfo)

#endif // OAIGoogleCloudDocumentaiV1beta1DocumentShardInfo_H
