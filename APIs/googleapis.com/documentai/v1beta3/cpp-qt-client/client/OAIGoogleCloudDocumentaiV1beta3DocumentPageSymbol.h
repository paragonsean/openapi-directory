...
/*
 * OAIGoogleCloudDocumentaiV1beta3DocumentPageSymbol.h
 *
 * A detected symbol.
 */

#ifndef OAIGoogleCloudDocumentaiV1beta3DocumentPageSymbol_H
#define OAIGoogleCloudDocumentaiV1beta3DocumentPageSymbol_H
...
class OAIGoogleCloudDocumentaiV1beta3DocumentPageSymbol : public OAIObject {
public:
    OAIGoogleCloudDocumentaiV1beta3DocumentPageSymbol();
    OAIGoogleCloudDocumentaiV1beta3DocumentPageSymbol(QString json);
    ~OAIGoogleCloudDocumentaiV1beta3DocumentPageSymbol() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudDocumentaiV1beta3DocumentPageSymbol)

#endif // OAIGoogleCloudDocumentaiV1beta3DocumentPageSymbol_H
