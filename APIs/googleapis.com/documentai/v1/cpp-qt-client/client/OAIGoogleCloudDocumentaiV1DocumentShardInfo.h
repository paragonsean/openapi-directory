...
/*
 * OAIGoogleCloudDocumentaiV1DocumentShardInfo.h
 *
 * For a large document, sharding may be performed to produce several document shards. Each document shard contains this field to detail which shard it is.
 */

#ifndef OAIGoogleCloudDocumentaiV1DocumentShardInfo_H
#define OAIGoogleCloudDocumentaiV1DocumentShardInfo_H
...
class OAIGoogleCloudDocumentaiV1DocumentShardInfo : public OAIObject {
public:
    OAIGoogleCloudDocumentaiV1DocumentShardInfo();
    OAIGoogleCloudDocumentaiV1DocumentShardInfo(QString json);
    ~OAIGoogleCloudDocumentaiV1DocumentShardInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudDocumentaiV1DocumentShardInfo)

#endif // OAIGoogleCloudDocumentaiV1DocumentShardInfo_H
