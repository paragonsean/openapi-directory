...
/*
 * OAIGoogleCloudDocumentaiV1DocumentPageTableTableCell.h
 *
 * A cell representation inside the table.
 */

#ifndef OAIGoogleCloudDocumentaiV1DocumentPageTableTableCell_H
#define OAIGoogleCloudDocumentaiV1DocumentPageTableTableCell_H
...
class OAIGoogleCloudDocumentaiV1DocumentPageTableTableCell : public OAIObject {
public:
    OAIGoogleCloudDocumentaiV1DocumentPageTableTableCell();
    OAIGoogleCloudDocumentaiV1DocumentPageTableTableCell(QString json);
    ~OAIGoogleCloudDocumentaiV1DocumentPageTableTableCell() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudDocumentaiV1DocumentPageTableTableCell)

#endif // OAIGoogleCloudDocumentaiV1DocumentPageTableTableCell_H
