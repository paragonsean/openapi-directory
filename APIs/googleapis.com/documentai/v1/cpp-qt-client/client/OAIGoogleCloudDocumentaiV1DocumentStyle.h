...
/*
 * OAIGoogleCloudDocumentaiV1DocumentStyle.h
 *
 * Annotation for common text style attributes. This adheres to CSS conventions as much as possible.
 */

#ifndef OAIGoogleCloudDocumentaiV1DocumentStyle_H
#define OAIGoogleCloudDocumentaiV1DocumentStyle_H
...
class OAIGoogleCloudDocumentaiV1DocumentStyleFontSize;
class OAIGoogleCloudDocumentaiV1DocumentTextAnchor;

class OAIGoogleCloudDocumentaiV1DocumentStyle : public OAIObject {
public:
    OAIGoogleCloudDocumentaiV1DocumentStyle();
    OAIGoogleCloudDocumentaiV1DocumentStyle(QString json);
    ~OAIGoogleCloudDocumentaiV1DocumentStyle() override;
    ...
    OAIGoogleCloudDocumentaiV1DocumentStyleFontSize getFontSize() const;
    void setFontSize(const OAIGoogleCloudDocumentaiV1DocumentStyleFontSize &font_size);
...
private:
    ...
    OAIGoogleCloudDocumentaiV1DocumentStyleFontSize m_font_size;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudDocumentaiV1DocumentStyle)

#endif // OAIGoogleCloudDocumentaiV1DocumentStyle_H
