...
/*
 * OAIGoogleCloudDocumentaiV1DocumentPageBlock.h
 *
 * A block has a set of lines (collected into paragraphs) that have a common line-spacing and orientation.
 */

#ifndef OAIGoogleCloudDocumentaiV1DocumentPageBlock_H
#define OAIGoogleCloudDocumentaiV1DocumentPageBlock_H
...
class OAIGoogleCloudDocumentaiV1DocumentPageBlock : public OAIObject {
public:
    OAIGoogleCloudDocumentaiV1DocumentPageBlock();
    OAIGoogleCloudDocumentaiV1DocumentPageBlock(QString json);
    ~OAIGoogleCloudDocumentaiV1DocumentPageBlock() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudDocumentaiV1DocumentPageBlock)

#endif // OAIGoogleCloudDocumentaiV1DocumentPageBlock_H
