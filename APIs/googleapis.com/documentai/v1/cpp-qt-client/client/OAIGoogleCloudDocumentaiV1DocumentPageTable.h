...
/*
 * OAIGoogleCloudDocumentaiV1DocumentPageTable.h
 *
 * A table representation similar to HTML table structure.
 */

#ifndef OAIGoogleCloudDocumentaiV1DocumentPageTable_H
#define OAIGoogleCloudDocumentaiV1DocumentPageTable_H

#include <QJsonObject>

#include "OAIGoogleCloudDocumentaiV1DocumentPageDetectedLanguage.h"
#include "OAIGoogleCloudDocumentaiV1DocumentPageLayout.h"
#include "OAIGoogleCloudDocumentaiV1DocumentPageTableTableRow.h"
...
namespace OpenAPI {
class OAIGoogleCloudDocumentaiV1DocumentPageTableTableRow;
...
class OAIGoogleCloudDocumentaiV1DocumentPageTable : public OAIObject {
public:
    OAIGoogleCloudDocumentaiV1DocumentPageTable();
    OAIGoogleCloudDocumentaiV1DocumentPageTable(QString json);
    ~OAIGoogleCloudDocumentaiV1DocumentPageTable() override;
    ...
    QList<OAIGoogleCloudDocumentaiV1DocumentPageTableTableRow> getBodyRows() const;
    void setBodyRows(const QList<OAIGoogleCloudDocumentaiV1DocumentPageTableTableRow> &body_rows);
    ...
    QList<OAIGoogleCloudDocumentaiV1DocumentPageTableTableRow> getHeaderRows() const;
    void setHeaderRows(const QList<OAIGoogleCloudDocumentaiV1DocumentPageTableTableRow> &header_rows);
...
private:
    ...
    QList<OAIGoogleCloudDocumentaiV1DocumentPageTableTableRow> m_body_rows;
    ...
    QList<OAIGoogleCloudDocumentaiV1DocumentPageTableTableRow> m_header_rows;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudDocumentaiV1DocumentPageTable)

#endif // OAIGoogleCloudDocumentaiV1DocumentPageTable_H
