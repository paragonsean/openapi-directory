...
OAIGoogleCloudDocumentaiV1OcrConfig::OAIGoogleCloudDocumentaiV1OcrConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGoogleCloudDocumentaiV1OcrConfig::OAIGoogleCloudDocumentaiV1OcrConfig() {
    this->initializeModel();
}

OAIGoogleCloudDocumentaiV1OcrConfig::~OAIGoogleCloudDocumentaiV1OcrConfig() {}

void OAIGoogleCloudDocumentaiV1OcrConfig::initializeModel() {
...
void OAIGoogleCloudDocumentaiV1OcrConfig::fromJson(QString jsonString) {
...
void OAIGoogleCloudDocumentaiV1OcrConfig::fromJsonObject(QJsonObject json) {
...
QString OAIGoogleCloudDocumentaiV1OcrConfig::asJson() const {
...
QJsonObject OAIGoogleCloudDocumentaiV1OcrConfig::asJsonObject() const {
    QJsonObject obj;
...
QList<QString> OAIGoogleCloudDocumentaiV1OcrConfig::getAdvancedOcrOptions() const {
    return m_advanced_ocr_options;
}
void OAIGoogleCloudDocumentaiV1OcrConfig::setAdvancedOcrOptions(const QList<QString> &advanced_ocr_options) {
    m_advanced_ocr_options = advanced_ocr_options;
    m_advanced_ocr_options_isSet = true;
}

bool OAIGoogleCloudDocumentaiV1OcrConfig::is_advanced_ocr_options_Set() const{
    return m_advanced_ocr_options_isSet;
}

bool OAIGoogleCloudDocumentaiV1OcrConfig::is_advanced_ocr_options_Valid() const{
    return m_advanced_ocr_options_isValid;
}

bool OAIGoogleCloudDocumentaiV1OcrConfig::isComputeStyleInfo() const {
    return m_compute_style_info;
}
void OAIGoogleCloudDocumentaiV1OcrConfig::setComputeStyleInfo(const bool &compute_style_info) {
    m_compute_style_info = compute_style_info;
    m_compute_style_info_isSet = true;
}

bool OAIGoogleCloudDocumentaiV1OcrConfig::is_compute_style_info_Set() const{
    return m_compute_style_info_isSet;
}

bool OAIGoogleCloudDocumentaiV1OcrConfig::is_compute_style_info_Valid() const{
    return m_compute_style_info_isValid;
}

bool OAIGoogleCloudDocumentaiV1OcrConfig::isDisableCharacterBoxesDetection() const {
    return m_disable_character_boxes_detection;
}
void OAIGoogleCloudDocumentaiV1OcrConfig::setDisableCharacterBoxesDetection(const bool &disable_character_boxes_detection) {
    m_disable_character_boxes_detection = disable_character_boxes_detection;
    m_disable_character_boxes_detection_isSet = true;
}

bool OAIGoogleCloudDocumentaiV1OcrConfig::is_disable_character_boxes_detection_Set() const{
    return m_disable_character_boxes_detection_isSet;
}

bool OAIGoogleCloudDocumentaiV1OcrConfig::is_disable_character_boxes_detection_Valid() const{
    return m_disable_character_boxes_detection_isValid;
}

bool OAIGoogleCloudDocumentaiV1OcrConfig::isEnableImageQualityScores() const {
    return m_enable_image_quality_scores;
}
void OAIGoogleCloudDocumentaiV1OcrConfig::setEnableImageQualityScores(const bool &enable_image_quality_scores) {
    m_enable_image_quality_scores = enable_image_quality_scores;
    m_enable_image_quality_scores_isSet = true;
}

bool OAIGoogleCloudDocumentaiV1OcrConfig::is_enable_image_quality_scores_Set() const{
    return m_enable_image_quality_scores_isSet;
}

bool OAIGoogleCloudDocumentaiV1OcrConfig::is_enable_image_quality_scores_Valid() const{
    return m_enable_image_quality_scores_isValid;
}

bool OAIGoogleCloudDocumentaiV1OcrConfig::isEnableNativePdfParsing() const {
    return m_enable_native_pdf_parsing;
}
void OAIGoogleCloudDocumentaiV1OcrConfig::setEnableNativePdfParsing(const bool &enable_native_pdf_parsing) {
    m_enable_native_pdf_parsing = enable_native_pdf_parsing;
    m_enable_native_pdf_parsing_isSet = true;
}

bool OAIGoogleCloudDocumentaiV1OcrConfig::is_enable_native_pdf_parsing_Set() const{
    return m_enable_native_pdf_parsing_isSet;
}

bool OAIGoogleCloudDocumentaiV1OcrConfig::is_enable_native_pdf_parsing_Valid() const{
    return m_enable_native_pdf_parsing_isValid;
}

bool OAIGoogleCloudDocumentaiV1OcrConfig::isEnableSymbol() const {
    return m_enable_symbol;
}
void OAIGoogleCloudDocumentaiV1OcrConfig::setEnableSymbol(const bool &enable_symbol) {
    m_enable_symbol = enable_symbol;
    m_enable_symbol_isSet = true;
}

bool OAIGoogleCloudDocumentaiV1OcrConfig::is_enable_symbol_Set() const{
    return m_enable_symbol_isSet;
}

bool OAIGoogleCloudDocumentaiV1OcrConfig::is_enable_symbol_Valid() const{
    return m_enable_symbol_isValid;
}

OAIGoogleCloudDocumentaiV1OcrConfigHints OAIGoogleCloudDocumentaiV1OcrConfig::getHints() const {
    return m_hints;
}
void OAIGoogleCloudDocumentaiV1OcrConfig::setHints(const OAIGoogleCloudDocumentaiV1OcrConfigHints &hints) {
    m_hints = hints;
    m_hints_isSet = true;
}

bool OAIGoogleCloudDocumentaiV1OcrConfig::is_hints_Set() const{
    return m_hints_isSet;
}

bool OAIGoogleCloudDocumentaiV1OcrConfig::is_hints_Valid() const{
    return m_hints_isValid;
}

OAIGoogleCloudDocumentaiV1OcrConfigPremiumFeatures OAIGoogleCloudDocumentaiV1OcrConfig::getPremiumFeatures() const {
    return m_premium_features;
}
void OAIGoogleCloudDocumentaiV1OcrConfig::setPremiumFeatures(const OAIGoogleCloudDocumentaiV1OcrConfigPremiumFeatures &premium_features) {
    m_premium_features = premium_features;
    m_premium_features_isSet = true;
}

bool OAIGoogleCloudDocumentaiV1OcrConfig::is_premium_features_Set() const{
    return m_premium_features_isSet;
}

bool OAIGoogleCloudDocumentaiV1OcrConfig::is_premium_features_Valid() const{
    return m_premium_features_isValid;
}

bool OAIGoogleCloudDocumentaiV1OcrConfig::isSet() const {
...
bool OAIGoogleCloudDocumentaiV1OcrConfig::isValid() const {
