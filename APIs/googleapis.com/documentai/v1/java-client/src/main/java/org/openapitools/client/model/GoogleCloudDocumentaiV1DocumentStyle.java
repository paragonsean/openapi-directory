...
public class GoogleCloudDocumentaiV1DocumentStyle {
  ...
  public GoogleCloudDocumentaiV1DocumentStyle backgroundColor(GoogleTypeColor backgroundColor) {
  ...
  public GoogleCloudDocumentaiV1DocumentStyle color(GoogleTypeColor color) {
    this.color = color;
    return this;
  }
  ...
  public GoogleCloudDocumentaiV1DocumentStyle fontFamily(String fontFamily) {
  ...
  public GoogleCloudDocumentaiV1DocumentStyle fontSize(GoogleCloudDocumentaiV1DocumentStyleFontSize fontSize) {
  ...
  public void setFontSize(GoogleCloudDocumentaiV1DocumentStyleFontSize fontSize) {
    this.fontSize = fontSize;
  }


  public GoogleCloudDocumentaiV1DocumentStyle fontWeight(String fontWeight) {
  ...
  public GoogleCloudDocumentaiV1DocumentStyle textAnchor(GoogleCloudDocumentaiV1DocumentTextAnchor textAnchor) {
  ...
  public GoogleCloudDocumentaiV1DocumentStyle textDecoration(String textDecoration) {
  ...
  public GoogleCloudDocumentaiV1DocumentStyle textStyle(String textStyle) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudDocumentaiV1DocumentStyle googleCloudDocumentaiV1DocumentStyle = (GoogleCloudDocumentaiV1DocumentStyle) o;
    return Objects.equals(this.backgroundColor, googleCloudDocumentaiV1DocumentStyle.backgroundColor) &&
        Objects.equals(this.color, googleCloudDocumentaiV1DocumentStyle.color) &&
        Objects.equals(this.fontFamily, googleCloudDocumentaiV1DocumentStyle.fontFamily) &&
        Objects.equals(this.fontSize, googleCloudDocumentaiV1DocumentStyle.fontSize) &&
        Objects.equals(this.fontWeight, googleCloudDocumentaiV1DocumentStyle.fontWeight) &&
        Objects.equals(this.textAnchor, googleCloudDocumentaiV1DocumentStyle.textAnchor) &&
        Objects.equals(this.textDecoration, googleCloudDocumentaiV1DocumentStyle.textDecoration) &&
        Objects.equals(this.textStyle, googleCloudDocumentaiV1DocumentStyle.textStyle);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudDocumentaiV1DocumentStyle {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudDocumentaiV1DocumentStyle
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudDocumentaiV1DocumentStyle.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudDocumentaiV1DocumentStyle is not found in the empty JSON string", GoogleCloudDocumentaiV1DocumentStyle.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudDocumentaiV1DocumentStyle.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudDocumentaiV1DocumentStyle` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("fontSize") != null && !jsonObj.get("fontSize").isJsonNull()) {
        GoogleCloudDocumentaiV1DocumentStyleFontSize.validateJsonElement(jsonObj.get("fontSize"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudDocumentaiV1DocumentStyle.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudDocumentaiV1DocumentStyle' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudDocumentaiV1DocumentStyle> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudDocumentaiV1DocumentStyle.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudDocumentaiV1DocumentStyle>() {
           @Override
           public void write(JsonWriter out, GoogleCloudDocumentaiV1DocumentStyle value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudDocumentaiV1DocumentStyle read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudDocumentaiV1DocumentStyle given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudDocumentaiV1DocumentStyle
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudDocumentaiV1DocumentStyle
   */
  public static GoogleCloudDocumentaiV1DocumentStyle fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudDocumentaiV1DocumentStyle.class);
  }

  /**
   * Convert an instance of GoogleCloudDocumentaiV1DocumentStyle to an JSON string
   *
   * @return JSON string
   */
