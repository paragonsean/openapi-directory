...
import org.openapitools.client.model.GoogleCloudDocumentaiV1EvaluationConfidenceLevelMetrics;
...
public class GoogleCloudDocumentaiV1EvaluationMultiConfidenceMetrics {
  ...
  private List<GoogleCloudDocumentaiV1EvaluationConfidenceLevelMetrics> confidenceLevelMetrics = new ArrayList<>();
  ...
  private List<GoogleCloudDocumentaiV1EvaluationConfidenceLevelMetrics> confidenceLevelMetricsExact = new ArrayList<>();
  ...
  public GoogleCloudDocumentaiV1EvaluationMultiConfidenceMetrics auprc(Float auprc) {
    this.auprc = auprc;
    return this;
  }
  ...
  public GoogleCloudDocumentaiV1EvaluationMultiConfidenceMetrics auprcExact(Float auprcExact) {
  ...
  public GoogleCloudDocumentaiV1EvaluationMultiConfidenceMetrics confidenceLevelMetrics(List<GoogleCloudDocumentaiV1EvaluationConfidenceLevelMetrics> confidenceLevelMetrics) {
    this.confidenceLevelMetrics = confidenceLevelMetrics;
    return this;
  }

  public GoogleCloudDocumentaiV1EvaluationMultiConfidenceMetrics addConfidenceLevelMetricsItem(GoogleCloudDocumentaiV1EvaluationConfidenceLevelMetrics confidenceLevelMetricsItem) {
  ...
  public void setConfidenceLevelMetrics(List<GoogleCloudDocumentaiV1EvaluationConfidenceLevelMetrics> confidenceLevelMetrics) {
    this.confidenceLevelMetrics = confidenceLevelMetrics;
  }


  public GoogleCloudDocumentaiV1EvaluationMultiConfidenceMetrics confidenceLevelMetricsExact(List<GoogleCloudDocumentaiV1EvaluationConfidenceLevelMetrics> confidenceLevelMetricsExact) {
    this.confidenceLevelMetricsExact = confidenceLevelMetricsExact;
    return this;
  }

  public GoogleCloudDocumentaiV1EvaluationMultiConfidenceMetrics addConfidenceLevelMetricsExactItem(GoogleCloudDocumentaiV1EvaluationConfidenceLevelMetrics confidenceLevelMetricsExactItem) {
  ...
  public void setConfidenceLevelMetricsExact(List<GoogleCloudDocumentaiV1EvaluationConfidenceLevelMetrics> confidenceLevelMetricsExact) {
    this.confidenceLevelMetricsExact = confidenceLevelMetricsExact;
  }


  public GoogleCloudDocumentaiV1EvaluationMultiConfidenceMetrics estimatedCalibrationError(Float estimatedCalibrationError) {
  ...
  public GoogleCloudDocumentaiV1EvaluationMultiConfidenceMetrics estimatedCalibrationErrorExact(Float estimatedCalibrationErrorExact) {
  ...
  public GoogleCloudDocumentaiV1EvaluationMultiConfidenceMetrics metricsType(MetricsTypeEnum metricsType) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudDocumentaiV1EvaluationMultiConfidenceMetrics googleCloudDocumentaiV1EvaluationMultiConfidenceMetrics = (GoogleCloudDocumentaiV1EvaluationMultiConfidenceMetrics) o;
    return Objects.equals(this.auprc, googleCloudDocumentaiV1EvaluationMultiConfidenceMetrics.auprc) &&
        Objects.equals(this.auprcExact, googleCloudDocumentaiV1EvaluationMultiConfidenceMetrics.auprcExact) &&
        Objects.equals(this.confidenceLevelMetrics, googleCloudDocumentaiV1EvaluationMultiConfidenceMetrics.confidenceLevelMetrics) &&
        Objects.equals(this.confidenceLevelMetricsExact, googleCloudDocumentaiV1EvaluationMultiConfidenceMetrics.confidenceLevelMetricsExact) &&
        Objects.equals(this.estimatedCalibrationError, googleCloudDocumentaiV1EvaluationMultiConfidenceMetrics.estimatedCalibrationError) &&
        Objects.equals(this.estimatedCalibrationErrorExact, googleCloudDocumentaiV1EvaluationMultiConfidenceMetrics.estimatedCalibrationErrorExact) &&
        Objects.equals(this.metricsType, googleCloudDocumentaiV1EvaluationMultiConfidenceMetrics.metricsType);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudDocumentaiV1EvaluationMultiConfidenceMetrics {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudDocumentaiV1EvaluationMultiConfidenceMetrics
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudDocumentaiV1EvaluationMultiConfidenceMetrics.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudDocumentaiV1EvaluationMultiConfidenceMetrics is not found in the empty JSON string", GoogleCloudDocumentaiV1EvaluationMultiConfidenceMetrics.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudDocumentaiV1EvaluationMultiConfidenceMetrics.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudDocumentaiV1EvaluationMultiConfidenceMetrics` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("confidenceLevelMetrics") != null && !jsonObj.get("confidenceLevelMetrics").isJsonNull()) {
        ...
        if (jsonArrayconfidenceLevelMetrics != null) {
          ...
          for (int i = 0; i < jsonArrayconfidenceLevelMetrics.size(); i++) {
            GoogleCloudDocumentaiV1EvaluationConfidenceLevelMetrics.validateJsonElement(jsonArrayconfidenceLevelMetrics.get(i));
          };
        }
      }
      if (jsonObj.get("confidenceLevelMetricsExact") != null && !jsonObj.get("confidenceLevelMetricsExact").isJsonNull()) {
        ...
        if (jsonArrayconfidenceLevelMetricsExact != null) {
          ...
          for (int i = 0; i < jsonArrayconfidenceLevelMetricsExact.size(); i++) {
            GoogleCloudDocumentaiV1EvaluationConfidenceLevelMetrics.validateJsonElement(jsonArrayconfidenceLevelMetricsExact.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudDocumentaiV1EvaluationMultiConfidenceMetrics.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudDocumentaiV1EvaluationMultiConfidenceMetrics' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudDocumentaiV1EvaluationMultiConfidenceMetrics> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudDocumentaiV1EvaluationMultiConfidenceMetrics.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudDocumentaiV1EvaluationMultiConfidenceMetrics>() {
           @Override
           public void write(JsonWriter out, GoogleCloudDocumentaiV1EvaluationMultiConfidenceMetrics value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudDocumentaiV1EvaluationMultiConfidenceMetrics read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudDocumentaiV1EvaluationMultiConfidenceMetrics given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudDocumentaiV1EvaluationMultiConfidenceMetrics
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudDocumentaiV1EvaluationMultiConfidenceMetrics
   */
  public static GoogleCloudDocumentaiV1EvaluationMultiConfidenceMetrics fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudDocumentaiV1EvaluationMultiConfidenceMetrics.class);
  }

  /**
   * Convert an instance of GoogleCloudDocumentaiV1EvaluationMultiConfidenceMetrics to an JSON string
   *
   * @return JSON string
   */
