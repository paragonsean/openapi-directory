...
|**properties** | [**List&lt;GoogleCloudDocumentaiV1DocumentEntity&gt;**](GoogleCloudDocumentaiV1DocumentEntity.md) | Optional. Entities can be nested to form a hierarchical data structure representing the content in the document. |  [optional] |
