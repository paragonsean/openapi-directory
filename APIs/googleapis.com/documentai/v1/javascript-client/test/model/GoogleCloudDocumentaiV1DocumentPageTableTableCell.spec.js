...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudDocumentAiApi.GoogleCloudDocumentaiV1DocumentPageTableTableCell();
  });
  ...
  describe('GoogleCloudDocumentaiV1DocumentPageTableTableCell', function() {
    it('should create an instance of GoogleCloudDocumentaiV1DocumentPageTableTableCell', function() {
      // uncomment below and update the code to test GoogleCloudDocumentaiV1DocumentPageTableTableCell
      //var instance = new CloudDocumentAiApi.GoogleCloudDocumentaiV1DocumentPageTableTableCell();
      //expect(instance).to.be.a(CloudDocumentAiApi.GoogleCloudDocumentaiV1DocumentPageTableTableCell);
    });
