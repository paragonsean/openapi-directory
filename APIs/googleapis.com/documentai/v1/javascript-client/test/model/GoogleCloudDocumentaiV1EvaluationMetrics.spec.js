...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudDocumentAiApi.GoogleCloudDocumentaiV1EvaluationMetrics();
  });
  ...
  describe('GoogleCloudDocumentaiV1EvaluationMetrics', function() {
    it('should create an instance of GoogleCloudDocumentaiV1EvaluationMetrics', function() {
      // uncomment below and update the code to test GoogleCloudDocumentaiV1EvaluationMetrics
      //var instance = new CloudDocumentAiApi.GoogleCloudDocumentaiV1EvaluationMetrics();
      //expect(instance).to.be.a(CloudDocumentAiApi.GoogleCloudDocumentaiV1EvaluationMetrics);
    });
