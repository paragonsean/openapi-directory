...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudDocumentAiApi.GoogleTypeColor();
  });
  ...
  describe('GoogleTypeColor', function() {
    it('should create an instance of GoogleTypeColor', function() {
      ...
      //var instance = new CloudDocumentAiApi.GoogleTypeColor();
      //expect(instance).to.be.a(CloudDocumentAiApi.GoogleTypeColor);
    });
