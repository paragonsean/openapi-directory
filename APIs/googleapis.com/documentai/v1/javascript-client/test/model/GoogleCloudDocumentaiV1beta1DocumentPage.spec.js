...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudDocumentAiApi.GoogleCloudDocumentaiV1beta1DocumentPage();
  });
  ...
  describe('GoogleCloudDocumentaiV1beta1DocumentPage', function() {
    it('should create an instance of GoogleCloudDocumentaiV1beta1DocumentPage', function() {
      // uncomment below and update the code to test GoogleCloudDocumentaiV1beta1DocumentPage
      //var instance = new CloudDocumentAiApi.GoogleCloudDocumentaiV1beta1DocumentPage();
      //expect(instance).to.be.a(CloudDocumentAiApi.GoogleCloudDocumentaiV1beta1DocumentPage);
    });
