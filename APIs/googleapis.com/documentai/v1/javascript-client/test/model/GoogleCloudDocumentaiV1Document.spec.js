...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudDocumentAiApi.GoogleCloudDocumentaiV1Document();
  });
  ...
  describe('GoogleCloudDocumentaiV1Document', function() {
    it('should create an instance of GoogleCloudDocumentaiV1Document', function() {
      // uncomment below and update the code to test GoogleCloudDocumentaiV1Document
      //var instance = new CloudDocumentAiApi.GoogleCloudDocumentaiV1Document();
      //expect(instance).to.be.a(CloudDocumentAiApi.GoogleCloudDocumentaiV1Document);
    });
