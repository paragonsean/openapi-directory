...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudDocumentAiApi.GoogleCloudDocumentaiV1DocumentPage();
  });
  ...
  describe('GoogleCloudDocumentaiV1DocumentPage', function() {
    it('should create an instance of GoogleCloudDocumentaiV1DocumentPage', function() {
      // uncomment below and update the code to test GoogleCloudDocumentaiV1DocumentPage
      //var instance = new CloudDocumentAiApi.GoogleCloudDocumentaiV1DocumentPage();
      //expect(instance).to.be.a(CloudDocumentAiApi.GoogleCloudDocumentaiV1DocumentPage);
    });
