...
/**
 * The GoogleCloudDocumentaiV1DocumentPageLine model module.
 * @module model/GoogleCloudDocumentaiV1DocumentPageLine
 * @version v1
 */
class GoogleCloudDocumentaiV1DocumentPageLine {
    /**
     * Constructs a new <code>GoogleCloudDocumentaiV1DocumentPageLine</code>.
     * A collection of tokens that a human would perceive as a line. Does not cross column boundaries, can be horizontal, vertical, etc.
     * @alias module:model/GoogleCloudDocumentaiV1DocumentPageLine
     */
    constructor() { 
        
        GoogleCloudDocumentaiV1DocumentPageLine.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudDocumentaiV1DocumentPageLine</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudDocumentaiV1DocumentPageLine} obj Optional instance to populate.
     * @return {module:model/GoogleCloudDocumentaiV1DocumentPageLine} The populated <code>GoogleCloudDocumentaiV1DocumentPageLine</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudDocumentaiV1DocumentPageLine();
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudDocumentaiV1DocumentPageLine</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudDocumentaiV1DocumentPageLine</code>.
     */
 ...
 */
GoogleCloudDocumentaiV1DocumentPageLine.prototype['detectedLanguages'] = undefined;

/**
 * @member {module:model/GoogleCloudDocumentaiV1DocumentPageLayout} layout
 */
GoogleCloudDocumentaiV1DocumentPageLine.prototype['layout'] = undefined;

/**
 * @member {module:model/GoogleCloudDocumentaiV1DocumentProvenance} provenance
 */
GoogleCloudDocumentaiV1DocumentPageLine.prototype['provenance'] = undefined;
...
export default GoogleCloudDocumentaiV1DocumentPageLine;
