...
/**
 * The GoogleCloudDocumentaiV1DocumentPageFormField model module.
 * @module model/GoogleCloudDocumentaiV1DocumentPageFormField
 * @version v1
 */
class GoogleCloudDocumentaiV1DocumentPageFormField {
    /**
     * Constructs a new <code>GoogleCloudDocumentaiV1DocumentPageFormField</code>.
     * A form field detected on the page.
     * @alias module:model/GoogleCloudDocumentaiV1DocumentPageFormField
     */
    constructor() { 
        
        GoogleCloudDocumentaiV1DocumentPageFormField.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudDocumentaiV1DocumentPageFormField</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudDocumentaiV1DocumentPageFormField} obj Optional instance to populate.
     * @return {module:model/GoogleCloudDocumentaiV1DocumentPageFormField} The populated <code>GoogleCloudDocumentaiV1DocumentPageFormField</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudDocumentaiV1DocumentPageFormField();
            ...
            if (data.hasOwnProperty('fieldName')) {
                obj['fieldName'] = GoogleCloudDocumentaiV1DocumentPageLayout.constructFromObject(data['fieldName']);
            }
            if (data.hasOwnProperty('fieldValue')) {
                obj['fieldValue'] = GoogleCloudDocumentaiV1DocumentPageLayout.constructFromObject(data['fieldValue']);
            }
            if (data.hasOwnProperty('nameDetectedLanguages')) {
                obj['nameDetectedLanguages'] = ApiClient.convertToType(data['nameDetectedLanguages'], [GoogleCloudDocumentaiV1DocumentPageDetectedLanguage]);
            }
            ...
            if (data.hasOwnProperty('valueDetectedLanguages')) {
                obj['valueDetectedLanguages'] = ApiClient.convertToType(data['valueDetectedLanguages'], [GoogleCloudDocumentaiV1DocumentPageDetectedLanguage]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudDocumentaiV1DocumentPageFormField</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudDocumentaiV1DocumentPageFormField</code>.
     */
    static validateJSON(data) {
        ...
        if (data['fieldName']) { // data not null
          GoogleCloudDocumentaiV1DocumentPageLayout.validateJSON(data['fieldName']);
        }
        // validate the optional field `fieldValue`
        if (data['fieldValue']) { // data not null
          GoogleCloudDocumentaiV1DocumentPageLayout.validateJSON(data['fieldValue']);
        }
 ...
 */
GoogleCloudDocumentaiV1DocumentPageFormField.prototype['correctedKeyText'] = undefined;

/**
 * Created for Labeling UI to export value text. If corrections were made to the text identified by the `field_value.text_anchor`, this field will contain the correction.
 * @member {String} correctedValueText
 */
GoogleCloudDocumentaiV1DocumentPageFormField.prototype['correctedValueText'] = undefined;

/**
 * @member {module:model/GoogleCloudDocumentaiV1DocumentPageLayout} fieldName
 */
GoogleCloudDocumentaiV1DocumentPageFormField.prototype['fieldName'] = undefined;

/**
 * @member {module:model/GoogleCloudDocumentaiV1DocumentPageLayout} fieldValue
 */
GoogleCloudDocumentaiV1DocumentPageFormField.prototype['fieldValue'] = undefined;

/**
 * A list of detected languages for name together with confidence.
 * @member {Array.<module:model/GoogleCloudDocumentaiV1DocumentPageDetectedLanguage>} nameDetectedLanguages
 */
GoogleCloudDocumentaiV1DocumentPageFormField.prototype['nameDetectedLanguages'] = undefined;

/**
 * @member {module:model/GoogleCloudDocumentaiV1DocumentProvenance} provenance
 */
GoogleCloudDocumentaiV1DocumentPageFormField.prototype['provenance'] = undefined;

/**
 * A list of detected languages for value together with confidence.
 * @member {Array.<module:model/GoogleCloudDocumentaiV1DocumentPageDetectedLanguage>} valueDetectedLanguages
 */
GoogleCloudDocumentaiV1DocumentPageFormField.prototype['valueDetectedLanguages'] = undefined;

/**
 * If the value is non-textual, this field represents the type. Current valid values are: - blank (this indicates the `field_value` is normal text) - `unfilled_checkbox` - `filled_checkbox`
 * @member {String} valueType
 */
GoogleCloudDocumentaiV1DocumentPageFormField.prototype['valueType'] = undefined;
...
export default GoogleCloudDocumentaiV1DocumentPageFormField;
