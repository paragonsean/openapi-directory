...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudDocumentAiApi.GoogleCloudDocumentaiV1beta1DocumentPageTableTableCell();
  });
  ...
  describe('GoogleCloudDocumentaiV1beta1DocumentPageTableTableCell', function() {
    it('should create an instance of GoogleCloudDocumentaiV1beta1DocumentPageTableTableCell', function() {
      // uncomment below and update the code to test GoogleCloudDocumentaiV1beta1DocumentPageTableTableCell
      //var instance = new CloudDocumentAiApi.GoogleCloudDocumentaiV1beta1DocumentPageTableTableCell();
      //expect(instance).to.be.a(CloudDocumentAiApi.GoogleCloudDocumentaiV1beta1DocumentPageTableTableCell);
    });
