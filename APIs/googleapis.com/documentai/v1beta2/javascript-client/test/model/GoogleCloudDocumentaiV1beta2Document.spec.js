...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudDocumentAiApi.GoogleCloudDocumentaiV1beta2Document();
  });
  ...
  describe('GoogleCloudDocumentaiV1beta2Document', function() {
    it('should create an instance of GoogleCloudDocumentaiV1beta2Document', function() {
      // uncomment below and update the code to test GoogleCloudDocumentaiV1beta2Document
      //var instance = new CloudDocumentAiApi.GoogleCloudDocumentaiV1beta2Document();
      //expect(instance).to.be.a(CloudDocumentAiApi.GoogleCloudDocumentaiV1beta2Document);
    });
