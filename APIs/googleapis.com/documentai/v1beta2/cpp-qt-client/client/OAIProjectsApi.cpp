...
void OAIProjectsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("documentai_projects_locations_documents_batchProcess", defaultConf);
    _serverIndices.insert("documentai_projects_locations_documents_batchProcess", 0);
    _serverConfigs.insert("documentai_projects_locations_documents_process", defaultConf);
    _serverIndices.insert("documentai_projects_locations_documents_process", 0);
    _serverConfigs.insert("documentai_projects_operations_get", defaultConf);
    _serverIndices.insert("documentai_projects_operations_get", 0);
}
...
void OAIProjectsApi::documentai_projects_locations_documents_batchProcess(const QString &parent, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<OAIGoogleCloudDocumentaiV1beta2BatchProcessDocumentsRequest> &oai_google_cloud_documentai_v1beta2_batch_process_documents_request) {
    QString fullPath = QString(_serverConfigs["documentai_projects_locations_documents_batchProcess"][_serverIndices.value("documentai_projects_locations_documents_batchProcess")].URL()+"/v1beta2/{parent}/documents:batchProcess");
    ...
    if (oai_google_cloud_documentai_v1beta2_batch_process_documents_request.hasValue()){

        
        QByteArray output = oai_google_cloud_documentai_v1beta2_batch_process_documents_request.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::documentai_projects_locations_documents_batchProcessCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::documentai_projects_locations_documents_batchProcessCallback);
...
void OAIProjectsApi::documentai_projects_locations_documents_batchProcessCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT documentai_projects_locations_documents_batchProcessSignal(output);
        Q_EMIT documentai_projects_locations_documents_batchProcessSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT documentai_projects_locations_documents_batchProcessSignalE(output, error_type, error_str);
        Q_EMIT documentai_projects_locations_documents_batchProcessSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT documentai_projects_locations_documents_batchProcessSignalError(output, error_type, error_str);
        Q_EMIT documentai_projects_locations_documents_batchProcessSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectsApi::documentai_projects_locations_documents_process(const QString &parent, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<OAIGoogleCloudDocumentaiV1beta2ProcessDocumentRequest> &oai_google_cloud_documentai_v1beta2_process_document_request) {
    QString fullPath = QString(_serverConfigs["documentai_projects_locations_documents_process"][_serverIndices.value("documentai_projects_locations_documents_process")].URL()+"/v1beta2/{parent}/documents:process");
    ...
    if (oai_google_cloud_documentai_v1beta2_process_document_request.hasValue()){

        
        QByteArray output = oai_google_cloud_documentai_v1beta2_process_document_request.value().asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::documentai_projects_locations_documents_processCallback);
    connect(this, &OAIProjectsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::documentai_projects_locations_documents_processCallback);
    connect(this, &OAIProjectsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectsApi::documentai_projects_locations_documents_processCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIGoogleCloudDocumentaiV1beta2Document output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT documentai_projects_locations_documents_processSignal(output);
        Q_EMIT documentai_projects_locations_documents_processSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("https://www.googleapis.com/auth/cloud-platform");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT documentai_projects_locations_documents_processSignalE(output, error_type, error_str);
        Q_EMIT documentai_projects_locations_documents_processSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT documentai_projects_locations_documents_processSignalError(output, error_type, error_str);
        Q_EMIT documentai_projects_locations_documents_processSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectsApi::documentai_projects_operations_get(const QString &name, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type) {
    QString fullPath = QString(_serverConfigs["documentai_projects_operations_get"][_serverIndices.value("documentai_projects_operations_get")].URL()+"/v1beta2/{name}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::documentai_projects_operations_getCallback);
    connect(this, &OAIProjectsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::documentai_projects_operations_getCallback);
    connect(this, &OAIProjectsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectsApi::documentai_projects_operations_getCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT documentai_projects_operations_getSignal(output);
        Q_EMIT documentai_projects_operations_getSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("https://www.googleapis.com/auth/cloud-platform");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT documentai_projects_operations_getSignalE(output, error_type, error_str);
        Q_EMIT documentai_projects_operations_getSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT documentai_projects_operations_getSignalError(output, error_type, error_str);
        Q_EMIT documentai_projects_operations_getSignalErrorFull(worker, error_type, error_str);
    }
}
