...
#include "OAIAvailableProjectsApi.h"
...
OAIAvailableProjectsApi::OAIAvailableProjectsApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIAvailableProjectsApi::~OAIAvailableProjectsApi() {
}

void OAIAvailableProjectsApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("firebase_availableProjects_list", defaultConf);
    _serverIndices.insert("firebase_availableProjects_list", 0);
}
...
*/
int OAIAvailableProjectsApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIAvailableProjectsApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIAvailableProjectsApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIAvailableProjectsApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIAvailableProjectsApi::setUsername(const QString &username) {
    _username = username;
}

void OAIAvailableProjectsApi::setPassword(const QString &password) {
    _password = password;
}


void OAIAvailableProjectsApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIAvailableProjectsApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIAvailableProjectsApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIAvailableProjectsApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIAvailableProjectsApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIAvailableProjectsApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIAvailableProjectsApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIAvailableProjectsApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIAvailableProjectsApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIAvailableProjectsApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIAvailableProjectsApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIAvailableProjectsApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIAvailableProjectsApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIAvailableProjectsApi::firebase_availableProjects_list(const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &page_token) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAvailableProjectsApi::firebase_availableProjects_listCallback);
    connect(this, &OAIAvailableProjectsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAvailableProjectsApi::firebase_availableProjects_listCallback);
    connect(this, &OAIAvailableProjectsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
...
void OAIAvailableProjectsApi::firebase_availableProjects_listCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIListAvailableProjectsResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT firebase_availableProjects_listSignal(output);
        Q_EMIT firebase_availableProjects_listSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT firebase_availableProjects_listSignalE(output, error_type, error_str);
        Q_EMIT firebase_availableProjects_listSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT firebase_availableProjects_listSignalError(output, error_type, error_str);
        Q_EMIT firebase_availableProjects_listSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIAvailableProjectsApi::tokenAvailable(){
