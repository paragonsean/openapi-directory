...
/*
 * OAIRemoveWebAppRequest.h
 *
 * 
 */

#ifndef OAIRemoveWebAppRequest_H
#define OAIRemoveWebAppRequest_H
...
class OAIRemoveWebAppRequest : public OAIObject {
public:
    OAIRemoveWebAppRequest();
    OAIRemoveWebAppRequest(QString json);
    ~OAIRemoveWebAppRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRemoveWebAppRequest)

#endif // OAIRemoveWebAppRequest_H
