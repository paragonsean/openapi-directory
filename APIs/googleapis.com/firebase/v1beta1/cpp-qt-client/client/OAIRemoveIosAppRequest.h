...
/*
 * OAIRemoveIosAppRequest.h
 *
 * 
 */

#ifndef OAIRemoveIosAppRequest_H
#define OAIRemoveIosAppRequest_H
...
class OAIRemoveIosAppRequest : public OAIObject {
public:
    OAIRemoveIosAppRequest();
    OAIRemoveIosAppRequest(QString json);
    ~OAIRemoveIosAppRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRemoveIosAppRequest)

#endif // OAIRemoveIosAppRequest_H
