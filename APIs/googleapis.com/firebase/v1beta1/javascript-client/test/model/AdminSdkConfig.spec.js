...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FirebaseManagementApi.AdminSdkConfig();
  });
  ...
  describe('AdminSdkConfig', function() {
    it('should create an instance of AdminSdkConfig', function() {
      // uncomment below and update the code to test AdminSdkConfig
      //var instance = new FirebaseManagementApi.AdminSdkConfig();
      //expect(instance).to.be.a(FirebaseManagementApi.AdminSdkConfig);
    });
