...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FirebaseManagementApi.FirebaseAppInfo();
  });
  ...
  describe('FirebaseAppInfo', function() {
    it('should create an instance of FirebaseAppInfo', function() {
      // uncomment below and update the code to test FirebaseAppInfo
      //var instance = new FirebaseManagementApi.FirebaseAppInfo();
      //expect(instance).to.be.a(FirebaseManagementApi.FirebaseAppInfo);
    });
