...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FirebaseManagementApi.WebAppConfig();
  });
  ...
  describe('WebAppConfig', function() {
    it('should create an instance of WebAppConfig', function() {
      // uncomment below and update the code to test WebAppConfig
      //var instance = new FirebaseManagementApi.WebAppConfig();
      //expect(instance).to.be.a(FirebaseManagementApi.WebAppConfig);
    });
