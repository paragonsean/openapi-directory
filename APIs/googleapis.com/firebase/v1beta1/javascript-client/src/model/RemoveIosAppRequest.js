...
/**
 * The RemoveIosAppRequest model module.
 * @module model/RemoveIosAppRequest
 * @version v1beta1
 */
class RemoveIosAppRequest {
    /**
     * Constructs a new <code>RemoveIosAppRequest</code>.
     * @alias module:model/RemoveIosAppRequest
     */
    constructor() { 
        
        RemoveIosAppRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RemoveIosAppRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RemoveIosAppRequest} obj Optional instance to populate.
     * @return {module:model/RemoveIosAppRequest} The populated <code>RemoveIosAppRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RemoveIosAppRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>RemoveIosAppRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RemoveIosAppRequest</code>.
     */
 ...
 */
RemoveIosAppRequest.prototype['allowMissing'] = undefined;
 ...
 * @member {String} etag
 */
RemoveIosAppRequest.prototype['etag'] = undefined;
 ...
 */
RemoveIosAppRequest.prototype['immediate'] = undefined;

/**
 * If set to true, the request is only validated. The App will _not_ be removed.
 * @member {Boolean} validateOnly
 */
RemoveIosAppRequest.prototype['validateOnly'] = undefined;
...
export default RemoveIosAppRequest;
