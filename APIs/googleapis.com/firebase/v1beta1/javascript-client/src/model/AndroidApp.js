...
class AndroidApp {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('sha1Hashes')) {
                obj['sha1Hashes'] = ApiClient.convertToType(data['sha1Hashes'], ['String']);
            }
            if (data.hasOwnProperty('sha256Hashes')) {
                obj['sha256Hashes'] = ApiClient.convertToType(data['sha256Hashes'], ['String']);
            }
    ...
    static validateJSON(data) {
        ...
        if (!Array.isArray(data['sha1Hashes'])) {
            throw new Error("Expected the field `sha1Hashes` to be an array in the JSON data but got " + data['sha1Hashes']);
        }
        // ensure the json data is an array
        if (!Array.isArray(data['sha256Hashes'])) {
            throw new Error("Expected the field `sha256Hashes` to be an array in the JSON data but got " + data['sha256Hashes']);
        }
        // ensure the json data is a string
 ...
 */
AndroidApp.prototype['apiKeyId'] = undefined;
 ...
 * @member {String} appId
 */
AndroidApp.prototype['appId'] = undefined;

/**
 * The user-assigned display name for the `AndroidApp`.
 * @member {String} displayName
 */
AndroidApp.prototype['displayName'] = undefined;

/**
 * This checksum is computed by the server based on the value of other fields, and it may be sent with update requests to ensure the client has an up-to-date value before proceeding. Learn more about `etag` in Google's [AIP-154 standard](https://google.aip.dev/154#declarative-friendly-resources). This etag is strongly validated.
 * @member {String} etag
 */
AndroidApp.prototype['etag'] = undefined;
 ...
 */
AndroidApp.prototype['projectId'] = undefined;

/**
 * The SHA1 certificate hashes for the AndroidApp.
 * @member {Array.<String>} sha1Hashes
 */
AndroidApp.prototype['sha1Hashes'] = undefined;

/**
 * The SHA256 certificate hashes for the AndroidApp.
 * @member {Array.<String>} sha256Hashes
 */
AndroidApp.prototype['sha256Hashes'] = undefined;

/**
 * Output only. The lifecycle state of the App.
 * @member {module:model/AndroidApp.StateEnum} state
 */
AndroidApp.prototype['state'] = undefined;
