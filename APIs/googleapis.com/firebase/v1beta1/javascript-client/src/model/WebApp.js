...
class WebApp {
    ...
    static validateJSON(data) {
        ...
        if (!Array.isArray(data['appUrls'])) {
            throw new Error("Expected the field `appUrls` to be an array in the JSON data but got " + data['appUrls']);
        }
        // ensure the json data is a string
 ...
 */
WebApp.prototype['apiKeyId'] = undefined;
 ...
 * @member {String} appId
 */
WebApp.prototype['appId'] = undefined;

/**
 * The URLs where the `WebApp` is hosted.
 * @member {Array.<String>} appUrls
 */
WebApp.prototype['appUrls'] = undefined;

/**
 * The user-assigned display name for the `WebApp`.
 * @member {String} displayName
 */
WebApp.prototype['displayName'] = undefined;

/**
 * This checksum is computed by the server based on the value of other fields, and it may be sent with update requests to ensure the client has an up-to-date value before proceeding. Learn more about `etag` in Google's [AIP-154 standard](https://google.aip.dev/154#declarative-friendly-resources). This etag is strongly validated.
 * @member {String} etag
 */
WebApp.prototype['etag'] = undefined;
 ...
 * @member {String} webId
 */
WebApp.prototype['webId'] = undefined;
