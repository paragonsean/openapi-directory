...
/**
 * The RemoveAndroidAppRequest model module.
 * @module model/RemoveAndroidAppRequest
 * @version v1beta1
 */
class RemoveAndroidAppRequest {
    /**
     * Constructs a new <code>RemoveAndroidAppRequest</code>.
     * @alias module:model/RemoveAndroidAppRequest
     */
    constructor() { 
        
        RemoveAndroidAppRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RemoveAndroidAppRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RemoveAndroidAppRequest} obj Optional instance to populate.
     * @return {module:model/RemoveAndroidAppRequest} The populated <code>RemoveAndroidAppRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RemoveAndroidAppRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>RemoveAndroidAppRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RemoveAndroidAppRequest</code>.
     */
 ...
 */
RemoveAndroidAppRequest.prototype['allowMissing'] = undefined;
 ...
 * @member {String} etag
 */
RemoveAndroidAppRequest.prototype['etag'] = undefined;
 ...
 */
RemoveAndroidAppRequest.prototype['immediate'] = undefined;

/**
 * If set to true, the request is only validated. The App will _not_ be removed.
 * @member {Boolean} validateOnly
 */
RemoveAndroidAppRequest.prototype['validateOnly'] = undefined;
...
export default RemoveAndroidAppRequest;
