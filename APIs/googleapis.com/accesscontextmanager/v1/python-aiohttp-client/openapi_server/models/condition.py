...
class Condition(Model):
    ...
    def __init__(self, device_policy: DevicePolicy=None, ip_subnetworks: List[str]=None, members: List[str]=None, negate: bool=None, regions: List[str]=None, required_access_levels: List[str]=None, vpc_network_sources: List[VpcNetworkSource]=None):
        ...
        :param vpc_network_sources: The vpc_network_sources of this Condition.
        """
        self.openapi_types = {
            ...
            'vpc_network_sources': List[VpcNetworkSource]
        }
    ...
    def vpc_network_sources(self):
        """Gets the vpc_network_sources of this Condition.

        The request must originate from one of the provided VPC networks in Google Cloud. Cannot specify this field together with `ip_subnetworks`.

        :return: The vpc_network_sources of this Condition.
        :rtype: List[VpcNetworkSource]
        """
        return self._vpc_network_sources

    @vpc_network_sources.setter
    def vpc_network_sources(self, vpc_network_sources):
        """Sets the vpc_network_sources of this Condition.

        The request must originate from one of the provided VPC networks in Google Cloud. Cannot specify this field together with `ip_subnetworks`.

        :param vpc_network_sources: The vpc_network_sources of this Condition.
        :type vpc_network_sources: List[VpcNetworkSource]
        """
