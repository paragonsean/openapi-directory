...
class DevicePolicy(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, allowed_device_management_levels: List[str]=None, allowed_encryption_statuses: List[str]=None, os_constraints: List[OsConstraint]=None, require_admin_approval: bool=None, require_corp_owned: bool=None, require_screenlock: bool=None):
        """DevicePolicy - a model defined in OpenAPI

        :param allowed_device_management_levels: The allowed_device_management_levels of this DevicePolicy.
        :param allowed_encryption_statuses: The allowed_encryption_statuses of this DevicePolicy.
        :param os_constraints: The os_constraints of this DevicePolicy.
        :param require_admin_approval: The require_admin_approval of this DevicePolicy.
        :param require_corp_owned: The require_corp_owned of this DevicePolicy.
        :param require_screenlock: The require_screenlock of this DevicePolicy.
        """
        self.openapi_types = {
            'allowed_device_management_levels': List[str],
            'allowed_encryption_statuses': List[str],
            'os_constraints': List[OsConstraint],
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DevicePolicy':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DevicePolicy of this DevicePolicy.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def allowed_device_management_levels(self):
        """Gets the allowed_device_management_levels of this DevicePolicy.

        Allowed device management levels, an empty list allows all management levels.

        :return: The allowed_device_management_levels of this DevicePolicy.
        :rtype: List[str]
        """
    ...
    def allowed_device_management_levels(self, allowed_device_management_levels):
        """Sets the allowed_device_management_levels of this DevicePolicy.
    ...
    def allowed_encryption_statuses(self):
        """Gets the allowed_encryption_statuses of this DevicePolicy.

        Allowed encryptions statuses, an empty list allows all statuses.

        :return: The allowed_encryption_statuses of this DevicePolicy.
        :rtype: List[str]
        """
    ...
    def allowed_encryption_statuses(self, allowed_encryption_statuses):
        """Sets the allowed_encryption_statuses of this DevicePolicy.
    ...
    def os_constraints(self):
        """Gets the os_constraints of this DevicePolicy.

        Allowed OS versions, an empty list allows all types and all versions.

        :return: The os_constraints of this DevicePolicy.
        :rtype: List[OsConstraint]
        """
        return self._os_constraints

    @os_constraints.setter
    def os_constraints(self, os_constraints):
        """Sets the os_constraints of this DevicePolicy.

        Allowed OS versions, an empty list allows all types and all versions.

        :param os_constraints: The os_constraints of this DevicePolicy.
        :type os_constraints: List[OsConstraint]
        """
    ...
    def require_admin_approval(self):
        """Gets the require_admin_approval of this DevicePolicy.

        Whether the device needs to be approved by the customer admin.

        :return: The require_admin_approval of this DevicePolicy.
        :rtype: bool
        """
    ...
    def require_admin_approval(self, require_admin_approval):
        """Sets the require_admin_approval of this DevicePolicy.
    ...
    def require_corp_owned(self):
        """Gets the require_corp_owned of this DevicePolicy.

        Whether the device needs to be corp owned.

        :return: The require_corp_owned of this DevicePolicy.
        :rtype: bool
        """
    ...
    def require_corp_owned(self, require_corp_owned):
        """Sets the require_corp_owned of this DevicePolicy.
    ...
    def require_screenlock(self):
        """Gets the require_screenlock of this DevicePolicy.

        Whether or not screenlock is required for the DevicePolicy to be true. Defaults to `false`.

        :return: The require_screenlock of this DevicePolicy.
        :rtype: bool
        """
    ...
    def require_screenlock(self, require_screenlock):
        """Sets the require_screenlock of this DevicePolicy.
