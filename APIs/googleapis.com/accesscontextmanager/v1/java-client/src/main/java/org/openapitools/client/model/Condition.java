...
public class Condition {
  ...
  private List<VpcNetworkSource> vpcNetworkSources = new ArrayList<>();
  ...
  public Condition vpcNetworkSources(List<VpcNetworkSource> vpcNetworkSources) {
    this.vpcNetworkSources = vpcNetworkSources;
    return this;
  }

  public Condition addVpcNetworkSourcesItem(VpcNetworkSource vpcNetworkSourcesItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<VpcNetworkSource> getVpcNetworkSources() {
    return vpcNetworkSources;
  }

  public void setVpcNetworkSources(List<VpcNetworkSource> vpcNetworkSources) {
    this.vpcNetworkSources = vpcNetworkSources;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.devicePolicy, condition.devicePolicy) &&
        ...
        Objects.equals(this.vpcNetworkSources, condition.vpcNetworkSources);
  }
      ...
      if (jsonObj.get("vpcNetworkSources") != null && !jsonObj.get("vpcNetworkSources").isJsonNull()) {
        ...
        if (jsonArrayvpcNetworkSources != null) {
          ...
          for (int i = 0; i < jsonArrayvpcNetworkSources.size(); i++) {
            VpcNetworkSource.validateJsonElement(jsonArrayvpcNetworkSources.get(i));
          };
        }
      }
  }
