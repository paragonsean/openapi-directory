...
public class DevicePolicy {
  ...
  private List<OsConstraint> osConstraints = new ArrayList<>();
  ...
  public DevicePolicy allowedDeviceManagementLevels(List<AllowedDeviceManagementLevelsEnum> allowedDeviceManagementLevels) {
    this.allowedDeviceManagementLevels = allowedDeviceManagementLevels;
    return this;
  }

  public DevicePolicy addAllowedDeviceManagementLevelsItem(AllowedDeviceManagementLevelsEnum allowedDeviceManagementLevelsItem) {
  ...
  public DevicePolicy allowedEncryptionStatuses(List<AllowedEncryptionStatusesEnum> allowedEncryptionStatuses) {
    this.allowedEncryptionStatuses = allowedEncryptionStatuses;
    return this;
  }

  public DevicePolicy addAllowedEncryptionStatusesItem(AllowedEncryptionStatusesEnum allowedEncryptionStatusesItem) {
  ...
  public DevicePolicy osConstraints(List<OsConstraint> osConstraints) {
    this.osConstraints = osConstraints;
    return this;
  }

  public DevicePolicy addOsConstraintsItem(OsConstraint osConstraintsItem) {
  ...
  public DevicePolicy requireAdminApproval(Boolean requireAdminApproval) {
  ...
  public DevicePolicy requireCorpOwned(Boolean requireCorpOwned) {
  ...
  public DevicePolicy requireScreenlock(Boolean requireScreenlock) {
  ...
  public boolean equals(Object o) {
    ...
    DevicePolicy devicePolicy = (DevicePolicy) o;
    return Objects.equals(this.allowedDeviceManagementLevels, devicePolicy.allowedDeviceManagementLevels) &&
        Objects.equals(this.allowedEncryptionStatuses, devicePolicy.allowedEncryptionStatuses) &&
        Objects.equals(this.osConstraints, devicePolicy.osConstraints) &&
        Objects.equals(this.requireAdminApproval, devicePolicy.requireAdminApproval) &&
        Objects.equals(this.requireCorpOwned, devicePolicy.requireCorpOwned) &&
        Objects.equals(this.requireScreenlock, devicePolicy.requireScreenlock);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DevicePolicy
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DevicePolicy.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DevicePolicy is not found in the empty JSON string", DevicePolicy.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DevicePolicy.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DevicePolicy` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("osConstraints") != null && !jsonObj.get("osConstraints").isJsonNull()) {
        ...
        if (jsonArrayosConstraints != null) {
          ...
          for (int i = 0; i < jsonArrayosConstraints.size(); i++) {
            OsConstraint.validateJsonElement(jsonArrayosConstraints.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DevicePolicy.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DevicePolicy' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DevicePolicy> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DevicePolicy.class));

       return (TypeAdapter<T>) new TypeAdapter<DevicePolicy>() {
           @Override
           public void write(JsonWriter out, DevicePolicy value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DevicePolicy read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DevicePolicy given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DevicePolicy
   * @throws IOException if the JSON string is invalid with respect to DevicePolicy
   */
  public static DevicePolicy fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DevicePolicy.class);
  }

  /**
   * Convert an instance of DevicePolicy to an JSON string
   *
   * @return JSON string
   */
