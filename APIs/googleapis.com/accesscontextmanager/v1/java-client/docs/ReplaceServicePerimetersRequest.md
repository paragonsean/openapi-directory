...
|**servicePerimeters** | [**List&lt;ServicePerimeter&gt;**](ServicePerimeter.md) | Required. The desired Service Perimeters that should replace all existing Service Perimeters in the Access Policy. |  [optional] |
