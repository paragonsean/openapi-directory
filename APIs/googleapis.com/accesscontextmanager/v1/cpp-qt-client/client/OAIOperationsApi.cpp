...
void OAIOperationsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("accesscontextmanager_operations_cancel", defaultConf);
    _serverIndices.insert("accesscontextmanager_operations_cancel", 0);
}
...
void OAIOperationsApi::accesscontextmanager_operations_cancel(const QString &name, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<OAIObject> &body) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIOperationsApi::accesscontextmanager_operations_cancelCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIOperationsApi::accesscontextmanager_operations_cancelCallback);
...
void OAIOperationsApi::accesscontextmanager_operations_cancelCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT accesscontextmanager_operations_cancelSignal(output);
        Q_EMIT accesscontextmanager_operations_cancelSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT accesscontextmanager_operations_cancelSignalE(output, error_type, error_str);
        Q_EMIT accesscontextmanager_operations_cancelSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT accesscontextmanager_operations_cancelSignalError(output, error_type, error_str);
        Q_EMIT accesscontextmanager_operations_cancelSignalErrorFull(worker, error_type, error_str);
    }
}
