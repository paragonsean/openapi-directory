# AccessContextManagerApi.GcpUserAccessBinding

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**accessLevels** | **[String]** | Optional. Access level that a user must have to be granted access. Only one access level is supported, not multiple. This repeated field must have exactly one element. Example: \&quot;accessPolicies/9522/accessLevels/device_trusted\&quot; | [optional] 
