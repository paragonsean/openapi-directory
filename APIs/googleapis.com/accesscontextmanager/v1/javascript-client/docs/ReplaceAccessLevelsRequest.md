# AccessContextManagerApi.ReplaceAccessLevelsRequest

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**accessLevels** | [**[AccessLevel]**](AccessLevel.md) | Required. The desired Access Levels that should replace all existing Access Levels in the Access Policy. | [optional] 
