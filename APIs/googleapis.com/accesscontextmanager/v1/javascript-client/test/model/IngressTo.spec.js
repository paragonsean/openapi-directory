...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AccessContextManagerApi.IngressTo();
  });
  ...
  describe('IngressTo', function() {
    it('should create an instance of IngressTo', function() {
      // uncomment below and update the code to test IngressTo
      //var instance = new AccessContextManagerApi.IngressTo();
      //expect(instance).to.be.a(AccessContextManagerApi.IngressTo);
    });
