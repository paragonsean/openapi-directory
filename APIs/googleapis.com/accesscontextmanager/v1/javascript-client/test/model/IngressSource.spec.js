...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AccessContextManagerApi.IngressSource();
  });
  ...
  describe('IngressSource', function() {
    it('should create an instance of IngressSource', function() {
      // uncomment below and update the code to test IngressSource
      //var instance = new AccessContextManagerApi.IngressSource();
      //expect(instance).to.be.a(AccessContextManagerApi.IngressSource);
    });
