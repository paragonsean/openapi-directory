...
class ServicePerimeter {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('spec')) {
                obj['spec'] = ServicePerimeterConfig.constructFromObject(data['spec']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['spec']) { // data not null
          ServicePerimeterConfig.validateJSON(data['spec']);
        }
...
/**
 * @member {module:model/ServicePerimeterConfig} spec
 */
ServicePerimeter.prototype['spec'] = undefined;
 ...
 */
ServicePerimeter.prototype['useExplicitDryRunSpec'] = undefined;
