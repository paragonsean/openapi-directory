...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AccessContextManagerApi.Operation();
  });
  ...
  describe('Operation', function() {
    it('should create an instance of Operation', function() {
      ...
      //var instance = new AccessContextManagerApi.Operation();
      //expect(instance).to.be.a(AccessContextManagerApi.Operation);
    });
