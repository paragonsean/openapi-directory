...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AccessContextManagerApi.AccessLevel();
  });
  ...
  describe('AccessLevel', function() {
    it('should create an instance of AccessLevel', function() {
      ...
      //var instance = new AccessContextManagerApi.AccessLevel();
      //expect(instance).to.be.a(AccessContextManagerApi.AccessLevel);
    });
