...
|------------ | ------------- | ------------- | -------------|
|**apiProducts** | **List&lt;String&gt;** | List of API products associated with the developer app. |  [optional] |
...
|**scopes** | **List&lt;String&gt;** | Scopes to apply to the developer app. The specified scopes must already exist for the API product that you associate with the developer app. |  [optional] |
