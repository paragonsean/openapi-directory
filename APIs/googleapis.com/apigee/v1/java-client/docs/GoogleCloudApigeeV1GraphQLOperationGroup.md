...
|**operationConfigs** | [**List&lt;GoogleCloudApigeeV1GraphQLOperationConfig&gt;**](GoogleCloudApigeeV1GraphQLOperationConfig.md) | Required. List of operation configurations for either Apigee API proxies or other remote services that are associated with this API product. |  [optional] |
