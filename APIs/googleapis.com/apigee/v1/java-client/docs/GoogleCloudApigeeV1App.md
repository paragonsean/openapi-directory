...
|------------ | ------------- | ------------- | -------------|
|**apiProducts** | [**List&lt;GoogleCloudApigeeV1ApiProductRef&gt;**](GoogleCloudApigeeV1ApiProductRef.md) | List of API products associated with the app. |  [optional] |
...
|**scopes** | **List&lt;String&gt;** | Scopes to apply to the app. The specified scope names must already exist on the API product that you associate with the app. |  [optional] |
