...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApigeeApi.GoogleCloudApigeeV1SecurityAction();
  });
  ...
  describe('GoogleCloudApigeeV1SecurityAction', function() {
    it('should create an instance of GoogleCloudApigeeV1SecurityAction', function() {
      // uncomment below and update the code to test GoogleCloudApigeeV1SecurityAction
      //var instance = new ApigeeApi.GoogleCloudApigeeV1SecurityAction();
      //expect(instance).to.be.a(ApigeeApi.GoogleCloudApigeeV1SecurityAction);
    });
    ...
    it('should have the property conditionConfig (base name: "conditionConfig")', function() {
      // uncomment below and update the code to test the property conditionConfig
      //var instance = new ApigeeApi.GoogleCloudApigeeV1SecurityAction();
      //expect(instance).to.be();
    });
