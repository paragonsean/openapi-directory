...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApigeeApi.GoogleCloudApigeeV1QueryMetadata();
  });
  ...
  describe('GoogleCloudApigeeV1QueryMetadata', function() {
    it('should create an instance of GoogleCloudApigeeV1QueryMetadata', function() {
      // uncomment below and update the code to test GoogleCloudApigeeV1QueryMetadata
      //var instance = new ApigeeApi.GoogleCloudApigeeV1QueryMetadata();
      //expect(instance).to.be.a(ApigeeApi.GoogleCloudApigeeV1QueryMetadata);
    });
