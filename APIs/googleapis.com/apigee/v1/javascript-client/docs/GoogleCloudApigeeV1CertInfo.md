# ApigeeApi.GoogleCloudApigeeV1CertInfo
...
**subjectAlternativeNames** | **[String]** | X.509 subject alternative names (SANs) extension. | [optional] 
**validFrom** | **String** | X.509 &#x60;notBefore&#x60; validity period in milliseconds since epoch. | [optional] 
**version** | **Number** | X.509 version. | [optional] 
