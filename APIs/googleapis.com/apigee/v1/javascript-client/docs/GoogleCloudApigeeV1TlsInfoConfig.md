# ApigeeApi.GoogleCloudApigeeV1TlsInfoConfig

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**ciphers** | **[String]** | List of ciphers that are granted access. | [optional] 
...
**protocols** | **[String]** | List of TLS protocols that are granted access. | [optional] 
