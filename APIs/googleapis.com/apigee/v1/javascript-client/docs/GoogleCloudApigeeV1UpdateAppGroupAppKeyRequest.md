# ApigeeApi.GoogleCloudApigeeV1UpdateAppGroupAppKeyRequest
...
**apiProducts** | **[String]** | The list of API products that will be associated with the credential. This list will be appended to the existing list of associated API Products for this App Key. Duplicates will be ignored. | [optional] 
