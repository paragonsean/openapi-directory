    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('auditConfigs')) {
                obj['auditConfigs'] = ApiClient.convertToType(data['auditConfigs'], [GoogleIamV1AuditConfig]);
            }
    ...
    static validateJSON(data) {
        if (data['auditConfigs']) { // data not null
            ...
            for (const item of data['auditConfigs']) {
                GoogleIamV1AuditConfig.validateJSON(item);
            };
        }
 ...
 * @member {Array.<module:model/GoogleIamV1AuditConfig>} auditConfigs
 */
GoogleIamV1Policy.prototype['auditConfigs'] = undefined;
