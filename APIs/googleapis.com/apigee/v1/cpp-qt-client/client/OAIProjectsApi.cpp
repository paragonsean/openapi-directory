...
void OAIProjectsApi::initializeServerConfigs() {
    ...
    QUrl("https://apigee.googleapis.com/"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("apigee_projects_provisionOrganization", defaultConf);
    _serverIndices.insert("apigee_projects_provisionOrganization", 0);
}
...
void OAIProjectsApi::apigee_projects_provisionOrganization(const QString &project, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<OAIGoogleCloudApigeeV1ProvisionOrganizationRequest> &oai_google_cloud_apigee_v1_provision_organization_request) {
    ...
    if (oai_google_cloud_apigee_v1_provision_organization_request.hasValue()){

        
        QByteArray output = oai_google_cloud_apigee_v1_provision_organization_request.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::apigee_projects_provisionOrganizationCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::apigee_projects_provisionOrganizationCallback);
...
void OAIProjectsApi::apigee_projects_provisionOrganizationCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT apigee_projects_provisionOrganizationSignal(output);
        Q_EMIT apigee_projects_provisionOrganizationSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT apigee_projects_provisionOrganizationSignalE(output, error_type, error_str);
        Q_EMIT apigee_projects_provisionOrganizationSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT apigee_projects_provisionOrganizationSignalError(output, error_type, error_str);
        Q_EMIT apigee_projects_provisionOrganizationSignalErrorFull(worker, error_type, error_str);
    }
}
