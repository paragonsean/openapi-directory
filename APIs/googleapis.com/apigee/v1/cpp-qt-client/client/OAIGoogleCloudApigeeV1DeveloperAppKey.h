...
/*
 * OAIGoogleCloudApigeeV1DeveloperAppKey.h
 *
 * 
 */

#ifndef OAIGoogleCloudApigeeV1DeveloperAppKey_H
#define OAIGoogleCloudApigeeV1DeveloperAppKey_H
...
class OAIGoogleCloudApigeeV1DeveloperAppKey : public OAIObject {
public:
    OAIGoogleCloudApigeeV1DeveloperAppKey();
    OAIGoogleCloudApigeeV1DeveloperAppKey(QString json);
    ~OAIGoogleCloudApigeeV1DeveloperAppKey() override;
    ...
    QList<QJsonValue> getApiProducts() const;
    void setApiProducts(const QList<QJsonValue> &api_products);
...
private:
    ...
    QList<QJsonValue> m_api_products;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudApigeeV1DeveloperAppKey)

#endif // OAIGoogleCloudApigeeV1DeveloperAppKey_H
