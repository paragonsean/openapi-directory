...
/*
 * OAIGoogleCloudApigeeV1Credential.h
 *
 * 
 */

#ifndef OAIGoogleCloudApigeeV1Credential_H
#define OAIGoogleCloudApigeeV1Credential_H
...
class OAIGoogleCloudApigeeV1Credential : public OAIObject {
public:
    OAIGoogleCloudApigeeV1Credential();
    OAIGoogleCloudApigeeV1Credential(QString json);
    ~OAIGoogleCloudApigeeV1Credential() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudApigeeV1Credential)

#endif // OAIGoogleCloudApigeeV1Credential_H
