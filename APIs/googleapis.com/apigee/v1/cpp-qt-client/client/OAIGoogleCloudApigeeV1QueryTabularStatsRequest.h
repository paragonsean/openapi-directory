...
/*
 * OAIGoogleCloudApigeeV1QueryTabularStatsRequest.h
 *
 * Request payload representing the query to be run for fetching security statistics as rows.
 */

#ifndef OAIGoogleCloudApigeeV1QueryTabularStatsRequest_H
#define OAIGoogleCloudApigeeV1QueryTabularStatsRequest_H
...
class OAIGoogleCloudApigeeV1QueryTabularStatsRequest : public OAIObject {
public:
    OAIGoogleCloudApigeeV1QueryTabularStatsRequest();
    OAIGoogleCloudApigeeV1QueryTabularStatsRequest(QString json);
    ~OAIGoogleCloudApigeeV1QueryTabularStatsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudApigeeV1QueryTabularStatsRequest)

#endif // OAIGoogleCloudApigeeV1QueryTabularStatsRequest_H
