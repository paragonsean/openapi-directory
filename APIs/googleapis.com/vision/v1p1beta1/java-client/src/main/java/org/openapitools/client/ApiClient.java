...
public class ApiClient {
    ...
    private String basePath = "https://vision.googleapis.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/v1p1beta1/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://vision.googleapis.com
