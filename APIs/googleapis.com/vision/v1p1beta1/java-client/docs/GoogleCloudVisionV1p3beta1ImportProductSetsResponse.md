...
|------------ | ------------- | ------------- | -------------|
|**referenceImages** | [**List&lt;GoogleCloudVisionV1p3beta1ReferenceImage&gt;**](GoogleCloudVisionV1p3beta1ReferenceImage.md) | The list of reference_images that are imported successfully. |  [optional] |
