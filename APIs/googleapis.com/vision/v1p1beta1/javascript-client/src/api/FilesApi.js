...
export default class FilesApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the visionFilesAnnotate operation.
     * @callback module:api/FilesApi~visionFilesAnnotateCallback
     ...
     * @param {module:api/FilesApi~visionFilesAnnotateCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GoogleCloudVisionV1p1beta1BatchAnnotateFilesResponse}
     */
    visionFilesAnnotate(opts, callback) {
      opts = opts || {};
    ...
    /**
     * Callback function to receive the result of the visionFilesAsyncBatchAnnotate operation.
     * @callback module:api/FilesApi~visionFilesAsyncBatchAnnotateCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/FilesApi~visionFilesAsyncBatchAnnotateCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Operation}
     */
    visionFilesAsyncBatchAnnotate(opts, callback) {
      opts = opts || {};
      ...
      return this.apiClient.callApi(
        '/v1p1beta1/files:asyncBatchAnnotate', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
