...
/**
 * The SafeSearchAnnotation model module.
 * @module model/SafeSearchAnnotation
 * @version v1p1beta1
 */
class SafeSearchAnnotation {
    /**
     * Constructs a new <code>SafeSearchAnnotation</code>.
     * Set of features pertaining to the image, computed by computer vision methods over safe-search verticals (for example, adult, spoof, medical, violence).
     * @alias module:model/SafeSearchAnnotation
     */
    constructor() { 
        
        SafeSearchAnnotation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SafeSearchAnnotation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SafeSearchAnnotation} obj Optional instance to populate.
     * @return {module:model/SafeSearchAnnotation} The populated <code>SafeSearchAnnotation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SafeSearchAnnotation();
    ...
    /**
     * Validates the JSON data with respect to <code>SafeSearchAnnotation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SafeSearchAnnotation</code>.
     */
 ...
 * @member {module:model/SafeSearchAnnotation.AdultEnum} adult
 */
SafeSearchAnnotation.prototype['adult'] = undefined;

/**
 * Likelihood that this is a medical image.
 * @member {module:model/SafeSearchAnnotation.MedicalEnum} medical
 */
SafeSearchAnnotation.prototype['medical'] = undefined;

/**
 * Likelihood that the request image contains racy content. Racy content may include (but is not limited to) skimpy or sheer clothing, strategically covered nudity, lewd or provocative poses, or close-ups of sensitive body areas.
 * @member {module:model/SafeSearchAnnotation.RacyEnum} racy
 */
SafeSearchAnnotation.prototype['racy'] = undefined;

/**
 * Spoof likelihood. The likelihood that an modification was made to the image's canonical version to make it appear funny or offensive.
 * @member {module:model/SafeSearchAnnotation.SpoofEnum} spoof
 */
SafeSearchAnnotation.prototype['spoof'] = undefined;
 ...
 * @member {module:model/SafeSearchAnnotation.ViolenceEnum} violence
 */
SafeSearchAnnotation.prototype['violence'] = undefined;
 ...
 * @readonly
 */
SafeSearchAnnotation['AdultEnum'] = {
 ...
 * @readonly
 */
SafeSearchAnnotation['MedicalEnum'] = {
 ...
 * @readonly
 */
SafeSearchAnnotation['SpoofEnum'] = {
 ...
 * @readonly
 */
SafeSearchAnnotation['ViolenceEnum'] = {
...
export default SafeSearchAnnotation;
