    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('productLabels')) {
                obj['productLabels'] = ApiClient.convertToType(data['productLabels'], [KeyValue]);
            }
        }
        return obj;
    }
 ...
 * @member {Array.<module:model/KeyValue>} productLabels
 */
Product.prototype['productLabels'] = undefined;
