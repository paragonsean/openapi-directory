...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudVisionApi.LocalizedObjectAnnotation();
  });
  ...
  describe('LocalizedObjectAnnotation', function() {
    it('should create an instance of LocalizedObjectAnnotation', function() {
      // uncomment below and update the code to test LocalizedObjectAnnotation
      //var instance = new CloudVisionApi.LocalizedObjectAnnotation();
      //expect(instance).to.be.a(CloudVisionApi.LocalizedObjectAnnotation);
    });
