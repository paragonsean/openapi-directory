...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudVisionApi.GoogleCloudVisionV1p3beta1Page();
  });
  ...
  describe('GoogleCloudVisionV1p3beta1Page', function() {
    it('should create an instance of GoogleCloudVisionV1p3beta1Page', function() {
      // uncomment below and update the code to test GoogleCloudVisionV1p3beta1Page
      //var instance = new CloudVisionApi.GoogleCloudVisionV1p3beta1Page();
      //expect(instance).to.be.a(CloudVisionApi.GoogleCloudVisionV1p3beta1Page);
    });
