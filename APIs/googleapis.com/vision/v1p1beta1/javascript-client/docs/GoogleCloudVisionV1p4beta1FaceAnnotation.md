# CloudVisionApi.GoogleCloudVisionV1p4beta1FaceAnnotation
...
**fdBoundingPoly** | [**GoogleCloudVisionV1p4beta1BoundingPoly**](GoogleCloudVisionV1p4beta1BoundingPoly.md) |  | [optional] 
...
**landmarks** | [**[GoogleCloudVisionV1p4beta1FaceAnnotationLandmark]**](GoogleCloudVisionV1p4beta1FaceAnnotationLandmark.md) | Detected face landmarks. | [optional] 
...
**recognitionResult** | [**[GoogleCloudVisionV1p4beta1FaceRecognitionResult]**](GoogleCloudVisionV1p4beta1FaceRecognitionResult.md) | Additional recognition information. Only computed if image_context.face_recognition_params is provided, **and** a match is found to a Celebrity in the input CelebritySet. This field is sorted in order of decreasing confidence values. | [optional] 
