...
async def test_vision_projects_locations_files_annotate(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1p1beta1/{parent}/files:annotate'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_vision_projects_locations_files_async_batch_annotate(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1p1beta1/{parent}/files:asyncBatchAnnotate'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_vision_projects_locations_images_annotate(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1p1beta1/{parent}/images:annotate'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_vision_projects_locations_images_async_batch_annotate(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1p1beta1/{parent}/images:asyncBatchAnnotate'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
