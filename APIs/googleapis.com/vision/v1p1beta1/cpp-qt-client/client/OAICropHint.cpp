...
OAICropHint::OAICropHint(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICropHint::OAICropHint() {
    this->initializeModel();
}

OAICropHint::~OAICropHint() {}

void OAICropHint::initializeModel() {
...
void OAICropHint::fromJson(QString jsonString) {
...
void OAICropHint::fromJsonObject(QJsonObject json) {
...
QString OAICropHint::asJson() const {
...
QJsonObject OAICropHint::asJsonObject() const {
    QJsonObject obj;
...
OAIBoundingPoly OAICropHint::getBoundingPoly() const {
    return m_bounding_poly;
}
void OAICropHint::setBoundingPoly(const OAIBoundingPoly &bounding_poly) {
    m_bounding_poly = bounding_poly;
    m_bounding_poly_isSet = true;
}

bool OAICropHint::is_bounding_poly_Set() const{
    return m_bounding_poly_isSet;
}

bool OAICropHint::is_bounding_poly_Valid() const{
    return m_bounding_poly_isValid;
}

float OAICropHint::getConfidence() const {
    return m_confidence;
}
void OAICropHint::setConfidence(const float &confidence) {
    m_confidence = confidence;
    m_confidence_isSet = true;
}

bool OAICropHint::is_confidence_Set() const{
    return m_confidence_isSet;
}

bool OAICropHint::is_confidence_Valid() const{
    return m_confidence_isValid;
}

float OAICropHint::getImportanceFraction() const {
    return m_importance_fraction;
}
void OAICropHint::setImportanceFraction(const float &importance_fraction) {
    m_importance_fraction = importance_fraction;
    m_importance_fraction_isSet = true;
}

bool OAICropHint::is_importance_fraction_Set() const{
    return m_importance_fraction_isSet;
}

bool OAICropHint::is_importance_fraction_Valid() const{
    return m_importance_fraction_isValid;
}

bool OAICropHint::isSet() const {
...
bool OAICropHint::isValid() const {
