...
void OAIFilesApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("vision_files_annotate", defaultConf);
    _serverIndices.insert("vision_files_annotate", 0);
    _serverConfigs.insert("vision_files_asyncBatchAnnotate", defaultConf);
    _serverIndices.insert("vision_files_asyncBatchAnnotate", 0);
}
...
void OAIFilesApi::vision_files_annotate(const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<OAIGoogleCloudVisionV1p1beta1BatchAnnotateFilesRequest> &oai_google_cloud_vision_v1p1beta1_batch_annotate_files_request) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIFilesApi::vision_files_annotateCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIFilesApi::vision_files_annotateCallback);
...
void OAIFilesApi::vision_files_annotateCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT vision_files_annotateSignal(output);
        Q_EMIT vision_files_annotateSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT vision_files_annotateSignalE(output, error_type, error_str);
        Q_EMIT vision_files_annotateSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT vision_files_annotateSignalError(output, error_type, error_str);
        Q_EMIT vision_files_annotateSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIFilesApi::vision_files_asyncBatchAnnotate(const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<OAIGoogleCloudVisionV1p1beta1AsyncBatchAnnotateFilesRequest> &oai_google_cloud_vision_v1p1beta1_async_batch_annotate_files_request) {
    QString fullPath = QString(_serverConfigs["vision_files_asyncBatchAnnotate"][_serverIndices.value("vision_files_asyncBatchAnnotate")].URL()+"/v1p1beta1/files:asyncBatchAnnotate");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIFilesApi::vision_files_asyncBatchAnnotateCallback);
    connect(this, &OAIFilesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIFilesApi::vision_files_asyncBatchAnnotateCallback);
    connect(this, &OAIFilesApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIFilesApi::vision_files_asyncBatchAnnotateCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT vision_files_asyncBatchAnnotateSignal(output);
        Q_EMIT vision_files_asyncBatchAnnotateSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        QString scopeStr = scope.join(" ");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT vision_files_asyncBatchAnnotateSignalE(output, error_type, error_str);
        Q_EMIT vision_files_asyncBatchAnnotateSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT vision_files_asyncBatchAnnotateSignalError(output, error_type, error_str);
        Q_EMIT vision_files_asyncBatchAnnotateSignalErrorFull(worker, error_type, error_str);
    }
}
