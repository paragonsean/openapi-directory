...
#ifndef OAIFaceAnnotation_H
#define OAIFaceAnnotation_H
...
class OAIFaceAnnotation : public OAIObject {
public:
    OAIFaceAnnotation();
    OAIFaceAnnotation(QString json);
    ~OAIFaceAnnotation() override;
    ...
    OAIBoundingPoly getFdBoundingPoly() const;
    void setFdBoundingPoly(const OAIBoundingPoly &fd_bounding_poly);
    ...
    QList<OAILandmark> getLandmarks() const;
    void setLandmarks(const QList<OAILandmark> &landmarks);
...
private:
    ...
    OAIBoundingPoly m_fd_bounding_poly;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFaceAnnotation)

#endif // OAIFaceAnnotation_H
