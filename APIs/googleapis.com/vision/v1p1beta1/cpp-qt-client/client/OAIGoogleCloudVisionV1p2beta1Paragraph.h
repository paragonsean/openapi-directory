...
/*
 * OAIGoogleCloudVisionV1p2beta1Paragraph.h
 *
 * Structural unit of text representing a number of words in certain order.
 */

#ifndef OAIGoogleCloudVisionV1p2beta1Paragraph_H
#define OAIGoogleCloudVisionV1p2beta1Paragraph_H
...
class OAIGoogleCloudVisionV1p2beta1Word;

class OAIGoogleCloudVisionV1p2beta1Paragraph : public OAIObject {
public:
    OAIGoogleCloudVisionV1p2beta1Paragraph();
    OAIGoogleCloudVisionV1p2beta1Paragraph(QString json);
    ~OAIGoogleCloudVisionV1p2beta1Paragraph() override;
    ...
    QList<OAIGoogleCloudVisionV1p2beta1Word> getWords() const;
    void setWords(const QList<OAIGoogleCloudVisionV1p2beta1Word> &words);
...
private:
    ...
    QList<OAIGoogleCloudVisionV1p2beta1Word> m_words;
    bool m_words_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudVisionV1p2beta1Paragraph)

#endif // OAIGoogleCloudVisionV1p2beta1Paragraph_H
