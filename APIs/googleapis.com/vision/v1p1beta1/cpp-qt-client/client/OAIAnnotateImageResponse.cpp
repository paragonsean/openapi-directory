...
OAIAnnotateImageResponse::OAIAnnotateImageResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAnnotateImageResponse::OAIAnnotateImageResponse() {
    this->initializeModel();
}

OAIAnnotateImageResponse::~OAIAnnotateImageResponse() {}

void OAIAnnotateImageResponse::initializeModel() {
...
void OAIAnnotateImageResponse::fromJson(QString jsonString) {
...
void OAIAnnotateImageResponse::fromJsonObject(QJsonObject json) {
...
QString OAIAnnotateImageResponse::asJson() const {
...
QJsonObject OAIAnnotateImageResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_context.isSet()) {
...
OAIImageAnnotationContext OAIAnnotateImageResponse::getContext() const {
    return m_context;
}
void OAIAnnotateImageResponse::setContext(const OAIImageAnnotationContext &context) {
    m_context = context;
    m_context_isSet = true;
}

bool OAIAnnotateImageResponse::is_context_Set() const{
    return m_context_isSet;
}

bool OAIAnnotateImageResponse::is_context_Valid() const{
    return m_context_isValid;
}

OAICropHintsAnnotation OAIAnnotateImageResponse::getCropHintsAnnotation() const {
    return m_crop_hints_annotation;
}
void OAIAnnotateImageResponse::setCropHintsAnnotation(const OAICropHintsAnnotation &crop_hints_annotation) {
    m_crop_hints_annotation = crop_hints_annotation;
    m_crop_hints_annotation_isSet = true;
}

bool OAIAnnotateImageResponse::is_crop_hints_annotation_Set() const{
    return m_crop_hints_annotation_isSet;
}

bool OAIAnnotateImageResponse::is_crop_hints_annotation_Valid() const{
    return m_crop_hints_annotation_isValid;
}

OAIStatus OAIAnnotateImageResponse::getError() const {
    return m_error;
}
void OAIAnnotateImageResponse::setError(const OAIStatus &error) {
    m_error = error;
    m_error_isSet = true;
}

bool OAIAnnotateImageResponse::is_error_Set() const{
    return m_error_isSet;
}

bool OAIAnnotateImageResponse::is_error_Valid() const{
    return m_error_isValid;
}

QList<OAIFaceAnnotation> OAIAnnotateImageResponse::getFaceAnnotations() const {
    return m_face_annotations;
}
void OAIAnnotateImageResponse::setFaceAnnotations(const QList<OAIFaceAnnotation> &face_annotations) {
    m_face_annotations = face_annotations;
    m_face_annotations_isSet = true;
}

bool OAIAnnotateImageResponse::is_face_annotations_Set() const{
    return m_face_annotations_isSet;
}

bool OAIAnnotateImageResponse::is_face_annotations_Valid() const{
    return m_face_annotations_isValid;
}

OAITextAnnotation OAIAnnotateImageResponse::getFullTextAnnotation() const {
    return m_full_text_annotation;
}
void OAIAnnotateImageResponse::setFullTextAnnotation(const OAITextAnnotation &full_text_annotation) {
    m_full_text_annotation = full_text_annotation;
    m_full_text_annotation_isSet = true;
}

bool OAIAnnotateImageResponse::is_full_text_annotation_Set() const{
    return m_full_text_annotation_isSet;
}

bool OAIAnnotateImageResponse::is_full_text_annotation_Valid() const{
    return m_full_text_annotation_isValid;
}

OAIImageProperties OAIAnnotateImageResponse::getImagePropertiesAnnotation() const {
    return m_image_properties_annotation;
}
void OAIAnnotateImageResponse::setImagePropertiesAnnotation(const OAIImageProperties &image_properties_annotation) {
    m_image_properties_annotation = image_properties_annotation;
    m_image_properties_annotation_isSet = true;
}

bool OAIAnnotateImageResponse::is_image_properties_annotation_Set() const{
    return m_image_properties_annotation_isSet;
}

bool OAIAnnotateImageResponse::is_image_properties_annotation_Valid() const{
    return m_image_properties_annotation_isValid;
}

QList<OAIEntityAnnotation> OAIAnnotateImageResponse::getLabelAnnotations() const {
    return m_label_annotations;
}
void OAIAnnotateImageResponse::setLabelAnnotations(const QList<OAIEntityAnnotation> &label_annotations) {
    m_label_annotations = label_annotations;
    m_label_annotations_isSet = true;
}

bool OAIAnnotateImageResponse::is_label_annotations_Set() const{
    return m_label_annotations_isSet;
}

bool OAIAnnotateImageResponse::is_label_annotations_Valid() const{
    return m_label_annotations_isValid;
}

QList<OAIEntityAnnotation> OAIAnnotateImageResponse::getLandmarkAnnotations() const {
    return m_landmark_annotations;
}
void OAIAnnotateImageResponse::setLandmarkAnnotations(const QList<OAIEntityAnnotation> &landmark_annotations) {
    m_landmark_annotations = landmark_annotations;
    m_landmark_annotations_isSet = true;
}

bool OAIAnnotateImageResponse::is_landmark_annotations_Set() const{
    return m_landmark_annotations_isSet;
}

bool OAIAnnotateImageResponse::is_landmark_annotations_Valid() const{
    return m_landmark_annotations_isValid;
}

QList<OAILocalizedObjectAnnotation> OAIAnnotateImageResponse::getLocalizedObjectAnnotations() const {
    return m_localized_object_annotations;
}
void OAIAnnotateImageResponse::setLocalizedObjectAnnotations(const QList<OAILocalizedObjectAnnotation> &localized_object_annotations) {
    m_localized_object_annotations = localized_object_annotations;
    m_localized_object_annotations_isSet = true;
}

bool OAIAnnotateImageResponse::is_localized_object_annotations_Set() const{
    return m_localized_object_annotations_isSet;
}

bool OAIAnnotateImageResponse::is_localized_object_annotations_Valid() const{
    return m_localized_object_annotations_isValid;
}

QList<OAIEntityAnnotation> OAIAnnotateImageResponse::getLogoAnnotations() const {
    return m_logo_annotations;
}
void OAIAnnotateImageResponse::setLogoAnnotations(const QList<OAIEntityAnnotation> &logo_annotations) {
    m_logo_annotations = logo_annotations;
    m_logo_annotations_isSet = true;
}

bool OAIAnnotateImageResponse::is_logo_annotations_Set() const{
    return m_logo_annotations_isSet;
}

bool OAIAnnotateImageResponse::is_logo_annotations_Valid() const{
    return m_logo_annotations_isValid;
}

OAIProductSearchResults OAIAnnotateImageResponse::getProductSearchResults() const {
    return m_product_search_results;
}
void OAIAnnotateImageResponse::setProductSearchResults(const OAIProductSearchResults &product_search_results) {
    m_product_search_results = product_search_results;
    m_product_search_results_isSet = true;
}

bool OAIAnnotateImageResponse::is_product_search_results_Set() const{
    return m_product_search_results_isSet;
}

bool OAIAnnotateImageResponse::is_product_search_results_Valid() const{
    return m_product_search_results_isValid;
}

OAISafeSearchAnnotation OAIAnnotateImageResponse::getSafeSearchAnnotation() const {
    return m_safe_search_annotation;
}
void OAIAnnotateImageResponse::setSafeSearchAnnotation(const OAISafeSearchAnnotation &safe_search_annotation) {
    m_safe_search_annotation = safe_search_annotation;
    m_safe_search_annotation_isSet = true;
}

bool OAIAnnotateImageResponse::is_safe_search_annotation_Set() const{
    return m_safe_search_annotation_isSet;
}

bool OAIAnnotateImageResponse::is_safe_search_annotation_Valid() const{
    return m_safe_search_annotation_isValid;
}

QList<OAIEntityAnnotation> OAIAnnotateImageResponse::getTextAnnotations() const {
    return m_text_annotations;
}
void OAIAnnotateImageResponse::setTextAnnotations(const QList<OAIEntityAnnotation> &text_annotations) {
    m_text_annotations = text_annotations;
    m_text_annotations_isSet = true;
}

bool OAIAnnotateImageResponse::is_text_annotations_Set() const{
    return m_text_annotations_isSet;
}

bool OAIAnnotateImageResponse::is_text_annotations_Valid() const{
    return m_text_annotations_isValid;
}

OAIWebDetection OAIAnnotateImageResponse::getWebDetection() const {
    return m_web_detection;
}
void OAIAnnotateImageResponse::setWebDetection(const OAIWebDetection &web_detection) {
    m_web_detection = web_detection;
    m_web_detection_isSet = true;
}

bool OAIAnnotateImageResponse::is_web_detection_Set() const{
    return m_web_detection_isSet;
}

bool OAIAnnotateImageResponse::is_web_detection_Valid() const{
    return m_web_detection_isValid;
}

bool OAIAnnotateImageResponse::isSet() const {
...
bool OAIAnnotateImageResponse::isValid() const {
