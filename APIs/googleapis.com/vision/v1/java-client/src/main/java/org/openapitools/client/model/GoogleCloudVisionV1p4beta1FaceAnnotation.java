...
import org.openapitools.client.model.GoogleCloudVisionV1p4beta1FaceAnnotationLandmark;
import org.openapitools.client.model.GoogleCloudVisionV1p4beta1FaceRecognitionResult;
...
public class GoogleCloudVisionV1p4beta1FaceAnnotation {
  ...
  private GoogleCloudVisionV1p4beta1BoundingPoly fdBoundingPoly;
  ...
  private List<GoogleCloudVisionV1p4beta1FaceAnnotationLandmark> landmarks = new ArrayList<>();
  ...
  private List<GoogleCloudVisionV1p4beta1FaceRecognitionResult> recognitionResult = new ArrayList<>();
  ...
  public GoogleCloudVisionV1p4beta1FaceAnnotation() {
  }

  public GoogleCloudVisionV1p4beta1FaceAnnotation angerLikelihood(AngerLikelihoodEnum angerLikelihood) {
  ...
  public GoogleCloudVisionV1p4beta1FaceAnnotation blurredLikelihood(BlurredLikelihoodEnum blurredLikelihood) {
  ...
  public GoogleCloudVisionV1p4beta1FaceAnnotation boundingPoly(GoogleCloudVisionV1p4beta1BoundingPoly boundingPoly) {
  ...
  public GoogleCloudVisionV1p4beta1FaceAnnotation detectionConfidence(Float detectionConfidence) {
  ...
  public GoogleCloudVisionV1p4beta1FaceAnnotation fdBoundingPoly(GoogleCloudVisionV1p4beta1BoundingPoly fdBoundingPoly) {
   ...
   */
  @javax.annotation.Nullable
  public GoogleCloudVisionV1p4beta1BoundingPoly getFdBoundingPoly() {
    return fdBoundingPoly;
  }

  public void setFdBoundingPoly(GoogleCloudVisionV1p4beta1BoundingPoly fdBoundingPoly) {
    this.fdBoundingPoly = fdBoundingPoly;
  }


  public GoogleCloudVisionV1p4beta1FaceAnnotation headwearLikelihood(HeadwearLikelihoodEnum headwearLikelihood) {
  ...
  public GoogleCloudVisionV1p4beta1FaceAnnotation joyLikelihood(JoyLikelihoodEnum joyLikelihood) {
  ...
  public GoogleCloudVisionV1p4beta1FaceAnnotation landmarkingConfidence(Float landmarkingConfidence) {
  ...
  public GoogleCloudVisionV1p4beta1FaceAnnotation landmarks(List<GoogleCloudVisionV1p4beta1FaceAnnotationLandmark> landmarks) {
    this.landmarks = landmarks;
    return this;
  }

  public GoogleCloudVisionV1p4beta1FaceAnnotation addLandmarksItem(GoogleCloudVisionV1p4beta1FaceAnnotationLandmark landmarksItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<GoogleCloudVisionV1p4beta1FaceAnnotationLandmark> getLandmarks() {
    return landmarks;
  }

  public void setLandmarks(List<GoogleCloudVisionV1p4beta1FaceAnnotationLandmark> landmarks) {
    this.landmarks = landmarks;
  }


  public GoogleCloudVisionV1p4beta1FaceAnnotation panAngle(Float panAngle) {
  ...
  public GoogleCloudVisionV1p4beta1FaceAnnotation recognitionResult(List<GoogleCloudVisionV1p4beta1FaceRecognitionResult> recognitionResult) {
    this.recognitionResult = recognitionResult;
    return this;
  }

  public GoogleCloudVisionV1p4beta1FaceAnnotation addRecognitionResultItem(GoogleCloudVisionV1p4beta1FaceRecognitionResult recognitionResultItem) {
    if (this.recognitionResult == null) {
      this.recognitionResult = new ArrayList<>();
    }
    this.recognitionResult.add(recognitionResultItem);
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public List<GoogleCloudVisionV1p4beta1FaceRecognitionResult> getRecognitionResult() {
    return recognitionResult;
  }

  public void setRecognitionResult(List<GoogleCloudVisionV1p4beta1FaceRecognitionResult> recognitionResult) {
    this.recognitionResult = recognitionResult;
  }


  public GoogleCloudVisionV1p4beta1FaceAnnotation rollAngle(Float rollAngle) {
  ...
  public GoogleCloudVisionV1p4beta1FaceAnnotation sorrowLikelihood(SorrowLikelihoodEnum sorrowLikelihood) {
  ...
  public GoogleCloudVisionV1p4beta1FaceAnnotation surpriseLikelihood(SurpriseLikelihoodEnum surpriseLikelihood) {
  ...
  public GoogleCloudVisionV1p4beta1FaceAnnotation tiltAngle(Float tiltAngle) {
  ...
  public GoogleCloudVisionV1p4beta1FaceAnnotation underExposedLikelihood(UnderExposedLikelihoodEnum underExposedLikelihood) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudVisionV1p4beta1FaceAnnotation googleCloudVisionV1p4beta1FaceAnnotation = (GoogleCloudVisionV1p4beta1FaceAnnotation) o;
    return Objects.equals(this.angerLikelihood, googleCloudVisionV1p4beta1FaceAnnotation.angerLikelihood) &&
        Objects.equals(this.blurredLikelihood, googleCloudVisionV1p4beta1FaceAnnotation.blurredLikelihood) &&
        Objects.equals(this.boundingPoly, googleCloudVisionV1p4beta1FaceAnnotation.boundingPoly) &&
        Objects.equals(this.detectionConfidence, googleCloudVisionV1p4beta1FaceAnnotation.detectionConfidence) &&
        Objects.equals(this.fdBoundingPoly, googleCloudVisionV1p4beta1FaceAnnotation.fdBoundingPoly) &&
        Objects.equals(this.headwearLikelihood, googleCloudVisionV1p4beta1FaceAnnotation.headwearLikelihood) &&
        Objects.equals(this.joyLikelihood, googleCloudVisionV1p4beta1FaceAnnotation.joyLikelihood) &&
        Objects.equals(this.landmarkingConfidence, googleCloudVisionV1p4beta1FaceAnnotation.landmarkingConfidence) &&
        Objects.equals(this.landmarks, googleCloudVisionV1p4beta1FaceAnnotation.landmarks) &&
        Objects.equals(this.panAngle, googleCloudVisionV1p4beta1FaceAnnotation.panAngle) &&
        Objects.equals(this.recognitionResult, googleCloudVisionV1p4beta1FaceAnnotation.recognitionResult) &&
        Objects.equals(this.rollAngle, googleCloudVisionV1p4beta1FaceAnnotation.rollAngle) &&
        Objects.equals(this.sorrowLikelihood, googleCloudVisionV1p4beta1FaceAnnotation.sorrowLikelihood) &&
        Objects.equals(this.surpriseLikelihood, googleCloudVisionV1p4beta1FaceAnnotation.surpriseLikelihood) &&
        Objects.equals(this.tiltAngle, googleCloudVisionV1p4beta1FaceAnnotation.tiltAngle) &&
        Objects.equals(this.underExposedLikelihood, googleCloudVisionV1p4beta1FaceAnnotation.underExposedLikelihood);
  }

  @Override
  public int hashCode() {
    return Objects.hash(angerLikelihood, blurredLikelihood, boundingPoly, detectionConfidence, fdBoundingPoly, headwearLikelihood, joyLikelihood, landmarkingConfidence, landmarks, panAngle, recognitionResult, rollAngle, sorrowLikelihood, surpriseLikelihood, tiltAngle, underExposedLikelihood);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GoogleCloudVisionV1p4beta1FaceAnnotation {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudVisionV1p4beta1FaceAnnotation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudVisionV1p4beta1FaceAnnotation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudVisionV1p4beta1FaceAnnotation is not found in the empty JSON string", GoogleCloudVisionV1p4beta1FaceAnnotation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudVisionV1p4beta1FaceAnnotation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudVisionV1p4beta1FaceAnnotation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("fdBoundingPoly") != null && !jsonObj.get("fdBoundingPoly").isJsonNull()) {
        GoogleCloudVisionV1p4beta1BoundingPoly.validateJsonElement(jsonObj.get("fdBoundingPoly"));
      }
      ...
      if (jsonObj.get("landmarks") != null && !jsonObj.get("landmarks").isJsonNull()) {
        ...
        if (jsonArraylandmarks != null) {
          ...
          for (int i = 0; i < jsonArraylandmarks.size(); i++) {
            GoogleCloudVisionV1p4beta1FaceAnnotationLandmark.validateJsonElement(jsonArraylandmarks.get(i));
          };
        }
      }
      if (jsonObj.get("recognitionResult") != null && !jsonObj.get("recognitionResult").isJsonNull()) {
        JsonArray jsonArrayrecognitionResult = jsonObj.getAsJsonArray("recognitionResult");
        if (jsonArrayrecognitionResult != null) {
          // ensure the json data is an array
          if (!jsonObj.get("recognitionResult").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `recognitionResult` to be an array in the JSON string but got `%s`", jsonObj.get("recognitionResult").toString()));
          }

          // validate the optional field `recognitionResult` (array)
          for (int i = 0; i < jsonArrayrecognitionResult.size(); i++) {
            GoogleCloudVisionV1p4beta1FaceRecognitionResult.validateJsonElement(jsonArrayrecognitionResult.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudVisionV1p4beta1FaceAnnotation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudVisionV1p4beta1FaceAnnotation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudVisionV1p4beta1FaceAnnotation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudVisionV1p4beta1FaceAnnotation.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudVisionV1p4beta1FaceAnnotation>() {
           @Override
           public void write(JsonWriter out, GoogleCloudVisionV1p4beta1FaceAnnotation value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudVisionV1p4beta1FaceAnnotation read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudVisionV1p4beta1FaceAnnotation given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudVisionV1p4beta1FaceAnnotation
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudVisionV1p4beta1FaceAnnotation
   */
  public static GoogleCloudVisionV1p4beta1FaceAnnotation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudVisionV1p4beta1FaceAnnotation.class);
  }

  /**
   * Convert an instance of GoogleCloudVisionV1p4beta1FaceAnnotation to an JSON string
   *
   * @return JSON string
   */
