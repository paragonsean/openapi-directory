...
public class GoogleCloudVisionV1p3beta1SafeSearchAnnotation {
  ...
  public GoogleCloudVisionV1p3beta1SafeSearchAnnotation() {
  }

  public GoogleCloudVisionV1p3beta1SafeSearchAnnotation adult(AdultEnum adult) {
    this.adult = adult;
    return this;
  }
  ...
  public GoogleCloudVisionV1p3beta1SafeSearchAnnotation medical(MedicalEnum medical) {
  ...
  public GoogleCloudVisionV1p3beta1SafeSearchAnnotation racy(RacyEnum racy) {
    this.racy = racy;
    return this;
  }
  ...
  public GoogleCloudVisionV1p3beta1SafeSearchAnnotation spoof(SpoofEnum spoof) {
    this.spoof = spoof;
    return this;
  }
  ...
  public GoogleCloudVisionV1p3beta1SafeSearchAnnotation violence(ViolenceEnum violence) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudVisionV1p3beta1SafeSearchAnnotation googleCloudVisionV1p3beta1SafeSearchAnnotation = (GoogleCloudVisionV1p3beta1SafeSearchAnnotation) o;
    return Objects.equals(this.adult, googleCloudVisionV1p3beta1SafeSearchAnnotation.adult) &&
        Objects.equals(this.medical, googleCloudVisionV1p3beta1SafeSearchAnnotation.medical) &&
        Objects.equals(this.racy, googleCloudVisionV1p3beta1SafeSearchAnnotation.racy) &&
        Objects.equals(this.spoof, googleCloudVisionV1p3beta1SafeSearchAnnotation.spoof) &&
        Objects.equals(this.violence, googleCloudVisionV1p3beta1SafeSearchAnnotation.violence);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudVisionV1p3beta1SafeSearchAnnotation {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudVisionV1p3beta1SafeSearchAnnotation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudVisionV1p3beta1SafeSearchAnnotation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudVisionV1p3beta1SafeSearchAnnotation is not found in the empty JSON string", GoogleCloudVisionV1p3beta1SafeSearchAnnotation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudVisionV1p3beta1SafeSearchAnnotation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudVisionV1p3beta1SafeSearchAnnotation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudVisionV1p3beta1SafeSearchAnnotation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudVisionV1p3beta1SafeSearchAnnotation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudVisionV1p3beta1SafeSearchAnnotation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudVisionV1p3beta1SafeSearchAnnotation.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudVisionV1p3beta1SafeSearchAnnotation>() {
           @Override
           public void write(JsonWriter out, GoogleCloudVisionV1p3beta1SafeSearchAnnotation value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudVisionV1p3beta1SafeSearchAnnotation read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudVisionV1p3beta1SafeSearchAnnotation given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudVisionV1p3beta1SafeSearchAnnotation
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudVisionV1p3beta1SafeSearchAnnotation
   */
  public static GoogleCloudVisionV1p3beta1SafeSearchAnnotation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudVisionV1p3beta1SafeSearchAnnotation.class);
  }

  /**
   * Convert an instance of GoogleCloudVisionV1p3beta1SafeSearchAnnotation to an JSON string
   *
   * @return JSON string
   */
