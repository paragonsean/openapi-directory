...
|**recognitionResult** | [**List&lt;GoogleCloudVisionV1p4beta1FaceRecognitionResult&gt;**](GoogleCloudVisionV1p4beta1FaceRecognitionResult.md) | Additional recognition information. Only computed if image_context.face_recognition_params is provided, **and** a match is found to a Celebrity in the input CelebritySet. This field is sorted in order of decreasing confidence values. |  [optional] |
