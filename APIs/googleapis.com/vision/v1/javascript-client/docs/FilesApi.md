...
------------- | ------------- | -------------
[**visionFilesAnnotate**](FilesApi.md#visionFilesAnnotate) | **POST** /v1/files:annotate | 
[**visionFilesAsyncBatchAnnotate**](FilesApi.md#visionFilesAsyncBatchAnnotate) | **POST** /v1/files:asyncBatchAnnotate | 



## visionFilesAnnotate

> BatchAnnotateFilesResponse visionFilesAnnotate(opts)
