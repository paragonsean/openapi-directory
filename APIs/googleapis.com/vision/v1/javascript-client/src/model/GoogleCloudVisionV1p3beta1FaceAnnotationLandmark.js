...
import GoogleCloudVisionV1p3beta1Position from './GoogleCloudVisionV1p3beta1Position';

/**
 * The GoogleCloudVisionV1p3beta1FaceAnnotationLandmark model module.
 * @module model/GoogleCloudVisionV1p3beta1FaceAnnotationLandmark
 * @version v1
 */
class GoogleCloudVisionV1p3beta1FaceAnnotationLandmark {
    /**
     * Constructs a new <code>GoogleCloudVisionV1p3beta1FaceAnnotationLandmark</code>.
     * A face-specific landmark (for example, a face feature).
     * @alias module:model/GoogleCloudVisionV1p3beta1FaceAnnotationLandmark
     */
    constructor() { 
        
        GoogleCloudVisionV1p3beta1FaceAnnotationLandmark.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudVisionV1p3beta1FaceAnnotationLandmark</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudVisionV1p3beta1FaceAnnotationLandmark} obj Optional instance to populate.
     * @return {module:model/GoogleCloudVisionV1p3beta1FaceAnnotationLandmark} The populated <code>GoogleCloudVisionV1p3beta1FaceAnnotationLandmark</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudVisionV1p3beta1FaceAnnotationLandmark();

            if (data.hasOwnProperty('position')) {
                obj['position'] = GoogleCloudVisionV1p3beta1Position.constructFromObject(data['position']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudVisionV1p3beta1FaceAnnotationLandmark</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudVisionV1p3beta1FaceAnnotationLandmark</code>.
     */
    static validateJSON(data) {
        // validate the optional field `position`
        if (data['position']) { // data not null
          GoogleCloudVisionV1p3beta1Position.validateJSON(data['position']);
        }
...
/**
 * @member {module:model/GoogleCloudVisionV1p3beta1Position} position
 */
GoogleCloudVisionV1p3beta1FaceAnnotationLandmark.prototype['position'] = undefined;

/**
 * Face landmark type.
 * @member {module:model/GoogleCloudVisionV1p3beta1FaceAnnotationLandmark.TypeEnum} type
 */
GoogleCloudVisionV1p3beta1FaceAnnotationLandmark.prototype['type'] = undefined;
 ...
 * @readonly
 */
GoogleCloudVisionV1p3beta1FaceAnnotationLandmark['TypeEnum'] = {
...
export default GoogleCloudVisionV1p3beta1FaceAnnotationLandmark;
