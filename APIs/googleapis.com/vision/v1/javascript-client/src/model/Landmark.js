...
/**
 * The Landmark model module.
 * @module model/Landmark
 * @version v1
 */
class Landmark {
    /**
     * Constructs a new <code>Landmark</code>.
     * A face-specific landmark (for example, a face feature).
     * @alias module:model/Landmark
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>Landmark</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Landmark} obj Optional instance to populate.
     * @return {module:model/Landmark} The populated <code>Landmark</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Landmark();
    ...
    /**
     * Validates the JSON data with respect to <code>Landmark</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Landmark</code>.
     */
 ...
 */
Landmark.prototype['position'] = undefined;

/**
 * Face landmark type.
 * @member {module:model/Landmark.TypeEnum} type
 */
Landmark.prototype['type'] = undefined;
