...
/**
 * The ProductSearchParams model module.
 * @module model/ProductSearchParams
 * @version v1
 */
class ProductSearchParams {
    /**
     * Constructs a new <code>ProductSearchParams</code>.
     * Parameters for a product search request.
     * @alias module:model/ProductSearchParams
     */
    constructor() { 
        
        ProductSearchParams.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ProductSearchParams</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ProductSearchParams} obj Optional instance to populate.
     * @return {module:model/ProductSearchParams} The populated <code>ProductSearchParams</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProductSearchParams();
    ...
    /**
     * Validates the JSON data with respect to <code>ProductSearchParams</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProductSearchParams</code>.
     */
 ...
 */
ProductSearchParams.prototype['boundingPoly'] = undefined;

/**
 * The filtering expression. This can be used to restrict search results based on Product labels. We currently support an AND of OR of key-value expressions, where each expression within an OR must have the same key. An '=' should be used to connect the key and value. For example, \"(color = red OR color = blue) AND brand = Google\" is acceptable, but \"(color = red OR brand = Google)\" is not acceptable. \"color: red\" is not acceptable because it uses a ':' instead of an '='.
 * @member {String} filter
 */
ProductSearchParams.prototype['filter'] = undefined;
 ...
 */
ProductSearchParams.prototype['productCategories'] = undefined;
 ...
 */
ProductSearchParams.prototype['productSet'] = undefined;
