...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudVisionApi.GoogleCloudVisionV1p4beta1EntityAnnotation();
  });
  ...
  describe('GoogleCloudVisionV1p4beta1EntityAnnotation', function() {
    it('should create an instance of GoogleCloudVisionV1p4beta1EntityAnnotation', function() {
      // uncomment below and update the code to test GoogleCloudVisionV1p4beta1EntityAnnotation
      //var instance = new CloudVisionApi.GoogleCloudVisionV1p4beta1EntityAnnotation();
      //expect(instance).to.be.a(CloudVisionApi.GoogleCloudVisionV1p4beta1EntityAnnotation);
    });
    ...
    it('should have the property topicality (base name: "topicality")', function() {
      // uncomment below and update the code to test the property topicality
      //var instance = new CloudVisionApi.GoogleCloudVisionV1p4beta1EntityAnnotation();
      //expect(instance).to.be();
    });
