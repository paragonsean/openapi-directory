...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudVisionApi.GoogleCloudVisionV1p2beta1Page();
  });
  ...
  describe('GoogleCloudVisionV1p2beta1Page', function() {
    it('should create an instance of GoogleCloudVisionV1p2beta1Page', function() {
      // uncomment below and update the code to test GoogleCloudVisionV1p2beta1Page
      //var instance = new CloudVisionApi.GoogleCloudVisionV1p2beta1Page();
      //expect(instance).to.be.a(CloudVisionApi.GoogleCloudVisionV1p2beta1Page);
    });
