...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudVisionApi.ListOperationsResponse();
  });
  ...
  describe('ListOperationsResponse', function() {
    it('should create an instance of ListOperationsResponse', function() {
      ...
      //var instance = new CloudVisionApi.ListOperationsResponse();
      //expect(instance).to.be.a(CloudVisionApi.ListOperationsResponse);
    });
