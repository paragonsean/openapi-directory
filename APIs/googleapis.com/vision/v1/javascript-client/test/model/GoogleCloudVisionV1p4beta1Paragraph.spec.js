...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudVisionApi.GoogleCloudVisionV1p4beta1Paragraph();
  });
  ...
  describe('GoogleCloudVisionV1p4beta1Paragraph', function() {
    it('should create an instance of GoogleCloudVisionV1p4beta1Paragraph', function() {
      // uncomment below and update the code to test GoogleCloudVisionV1p4beta1Paragraph
      //var instance = new CloudVisionApi.GoogleCloudVisionV1p4beta1Paragraph();
      //expect(instance).to.be.a(CloudVisionApi.GoogleCloudVisionV1p4beta1Paragraph);
    });
