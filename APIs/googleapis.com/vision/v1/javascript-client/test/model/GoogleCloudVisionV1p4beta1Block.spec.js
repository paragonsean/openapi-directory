...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudVisionApi.GoogleCloudVisionV1p4beta1Block();
  });
  ...
  describe('GoogleCloudVisionV1p4beta1Block', function() {
    it('should create an instance of GoogleCloudVisionV1p4beta1Block', function() {
      // uncomment below and update the code to test GoogleCloudVisionV1p4beta1Block
      //var instance = new CloudVisionApi.GoogleCloudVisionV1p4beta1Block();
      //expect(instance).to.be.a(CloudVisionApi.GoogleCloudVisionV1p4beta1Block);
    });
