...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudVisionApi.SafeSearchAnnotation();
  });
  ...
  describe('SafeSearchAnnotation', function() {
    it('should create an instance of SafeSearchAnnotation', function() {
      // uncomment below and update the code to test SafeSearchAnnotation
      //var instance = new CloudVisionApi.SafeSearchAnnotation();
      //expect(instance).to.be.a(CloudVisionApi.SafeSearchAnnotation);
    });
