...
class Feature(Model):
    ...
    def __init__(self, max_results: int=None, model: str=None, type: str=None):
        ...
        :param max_results: The max_results of this Feature.
        :param model: The model of this Feature.
    ...
    def max_results(self):
        """Gets the max_results of this Feature.

        Maximum number of results of this type. Does not apply to `TEXT_DETECTION`, `DOCUMENT_TEXT_DETECTION`, or `CROP_HINTS`.

        :return: The max_results of this Feature.
        :rtype: int
        """
    ...
    def max_results(self, max_results):
        """Sets the max_results of this Feature.
    ...
    @property
    def model(self):
        """Gets the model of this Feature.
        ...
        :return: The model of this Feature.
        :rtype: str
        """
        return self._model
    ...
    def model(self, model):
        """Sets the model of this Feature.
