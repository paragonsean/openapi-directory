...
class TextDetectionParams(Model):
    ...
    def __init__(self, advanced_ocr_options: List[str]=None, enable_text_detection_confidence_score: bool=None):
        """TextDetectionParams - a model defined in OpenAPI

        :param advanced_ocr_options: The advanced_ocr_options of this TextDetectionParams.
        :param enable_text_detection_confidence_score: The enable_text_detection_confidence_score of this TextDetectionParams.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TextDetectionParams':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TextDetectionParams of this TextDetectionParams.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def advanced_ocr_options(self):
        """Gets the advanced_ocr_options of this TextDetectionParams.

        A list of advanced OCR options to further fine-tune OCR behavior. Current valid values are: - `legacy_layout`: a heuristics layout detection algorithm, which serves as an alternative to the current ML-based layout detection algorithm. Customers can choose the best suitable layout algorithm based on their situation.

        :return: The advanced_ocr_options of this TextDetectionParams.
        :rtype: List[str]
        """
    ...
    def advanced_ocr_options(self, advanced_ocr_options):
        """Sets the advanced_ocr_options of this TextDetectionParams.
    ...
    def enable_text_detection_confidence_score(self):
        """Gets the enable_text_detection_confidence_score of this TextDetectionParams.

        By default, Cloud Vision API only includes confidence score for DOCUMENT_TEXT_DETECTION result. Set the flag to true to include confidence score for TEXT_DETECTION as well.

        :return: The enable_text_detection_confidence_score of this TextDetectionParams.
        :rtype: bool
        """
    ...
    def enable_text_detection_confidence_score(self, enable_text_detection_confidence_score):
        """Sets the enable_text_detection_confidence_score of this TextDetectionParams.
