...
/*
 * OAIGoogleCloudVisionV1p2beta1LocalizedObjectAnnotation.h
 *
 * Set of detected objects with bounding boxes.
 */

#ifndef OAIGoogleCloudVisionV1p2beta1LocalizedObjectAnnotation_H
#define OAIGoogleCloudVisionV1p2beta1LocalizedObjectAnnotation_H
...
class OAIGoogleCloudVisionV1p2beta1LocalizedObjectAnnotation : public OAIObject {
public:
    OAIGoogleCloudVisionV1p2beta1LocalizedObjectAnnotation();
    OAIGoogleCloudVisionV1p2beta1LocalizedObjectAnnotation(QString json);
    ~OAIGoogleCloudVisionV1p2beta1LocalizedObjectAnnotation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudVisionV1p2beta1LocalizedObjectAnnotation)

#endif // OAIGoogleCloudVisionV1p2beta1LocalizedObjectAnnotation_H
