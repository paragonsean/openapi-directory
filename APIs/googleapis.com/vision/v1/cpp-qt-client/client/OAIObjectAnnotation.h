...
/*
 * OAIObjectAnnotation.h
 *
 * Prediction for what the object in the bounding box is.
 */

#ifndef OAIObjectAnnotation_H
#define OAIObjectAnnotation_H
...
class OAIObjectAnnotation : public OAIObject {
public:
    OAIObjectAnnotation();
    OAIObjectAnnotation(QString json);
    ~OAIObjectAnnotation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIObjectAnnotation)

#endif // OAIObjectAnnotation_H
