...
/*
 * OAIGoogleCloudVisionV1p1beta1Block.h
 *
 * Logical element on the page.
 */

#ifndef OAIGoogleCloudVisionV1p1beta1Block_H
#define OAIGoogleCloudVisionV1p1beta1Block_H
...
class OAIGoogleCloudVisionV1p1beta1Paragraph;
class OAIGoogleCloudVisionV1p1beta1TextAnnotationTextProperty;

class OAIGoogleCloudVisionV1p1beta1Block : public OAIObject {
public:
    OAIGoogleCloudVisionV1p1beta1Block();
    OAIGoogleCloudVisionV1p1beta1Block(QString json);
    ~OAIGoogleCloudVisionV1p1beta1Block() override;
    ...
    QList<OAIGoogleCloudVisionV1p1beta1Paragraph> getParagraphs() const;
    void setParagraphs(const QList<OAIGoogleCloudVisionV1p1beta1Paragraph> &paragraphs);
...
private:
    ...
    QList<OAIGoogleCloudVisionV1p1beta1Paragraph> m_paragraphs;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudVisionV1p1beta1Block)

#endif // OAIGoogleCloudVisionV1p1beta1Block_H
