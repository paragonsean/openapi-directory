...
/*
 * OAIGoogleCloudVisionV1p4beta1FaceAnnotation.h
 *
 * A face annotation object contains the results of face detection.
 */

#ifndef OAIGoogleCloudVisionV1p4beta1FaceAnnotation_H
#define OAIGoogleCloudVisionV1p4beta1FaceAnnotation_H
...
class OAIGoogleCloudVisionV1p4beta1FaceAnnotationLandmark;
class OAIGoogleCloudVisionV1p4beta1FaceRecognitionResult;

class OAIGoogleCloudVisionV1p4beta1FaceAnnotation : public OAIObject {
public:
    OAIGoogleCloudVisionV1p4beta1FaceAnnotation();
    OAIGoogleCloudVisionV1p4beta1FaceAnnotation(QString json);
    ~OAIGoogleCloudVisionV1p4beta1FaceAnnotation() override;
    ...
    OAIGoogleCloudVisionV1p4beta1BoundingPoly getFdBoundingPoly() const;
    void setFdBoundingPoly(const OAIGoogleCloudVisionV1p4beta1BoundingPoly &fd_bounding_poly);
    ...
    QList<OAIGoogleCloudVisionV1p4beta1FaceAnnotationLandmark> getLandmarks() const;
    void setLandmarks(const QList<OAIGoogleCloudVisionV1p4beta1FaceAnnotationLandmark> &landmarks);
    ...
    QList<OAIGoogleCloudVisionV1p4beta1FaceRecognitionResult> getRecognitionResult() const;
    void setRecognitionResult(const QList<OAIGoogleCloudVisionV1p4beta1FaceRecognitionResult> &recognition_result);
...
private:
    ...
    OAIGoogleCloudVisionV1p4beta1BoundingPoly m_fd_bounding_poly;
    ...
    QList<OAIGoogleCloudVisionV1p4beta1FaceAnnotationLandmark> m_landmarks;
    ...
    QList<OAIGoogleCloudVisionV1p4beta1FaceRecognitionResult> m_recognition_result;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudVisionV1p4beta1FaceAnnotation)

#endif // OAIGoogleCloudVisionV1p4beta1FaceAnnotation_H
