...
/*
 * OAIGoogleCloudVisionV1p2beta1Page.h
 *
 * Detected page from OCR.
 */

#ifndef OAIGoogleCloudVisionV1p2beta1Page_H
#define OAIGoogleCloudVisionV1p2beta1Page_H
...
namespace OpenAPI {
class OAIGoogleCloudVisionV1p2beta1Block;
class OAIGoogleCloudVisionV1p2beta1TextAnnotationTextProperty;

class OAIGoogleCloudVisionV1p2beta1Page : public OAIObject {
public:
    OAIGoogleCloudVisionV1p2beta1Page();
    OAIGoogleCloudVisionV1p2beta1Page(QString json);
    ~OAIGoogleCloudVisionV1p2beta1Page() override;
    ...
    QList<OAIGoogleCloudVisionV1p2beta1Block> getBlocks() const;
    void setBlocks(const QList<OAIGoogleCloudVisionV1p2beta1Block> &blocks);
...
private:
    ...
    QList<OAIGoogleCloudVisionV1p2beta1Block> m_blocks;
    bool m_blocks_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudVisionV1p2beta1Page)

#endif // OAIGoogleCloudVisionV1p2beta1Page_H
