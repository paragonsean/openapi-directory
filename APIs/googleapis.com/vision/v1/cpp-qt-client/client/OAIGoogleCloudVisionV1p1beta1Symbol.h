...
/*
 * OAIGoogleCloudVisionV1p1beta1Symbol.h
 *
 * A single symbol representation.
 */

#ifndef OAIGoogleCloudVisionV1p1beta1Symbol_H
#define OAIGoogleCloudVisionV1p1beta1Symbol_H
...
class OAIGoogleCloudVisionV1p1beta1Symbol : public OAIObject {
public:
    OAIGoogleCloudVisionV1p1beta1Symbol();
    OAIGoogleCloudVisionV1p1beta1Symbol(QString json);
    ~OAIGoogleCloudVisionV1p1beta1Symbol() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudVisionV1p1beta1Symbol)

#endif // OAIGoogleCloudVisionV1p1beta1Symbol_H
