...
/*
 * OAIGoogleCloudVisionV1p1beta1FaceAnnotation.h
 *
 * A face annotation object contains the results of face detection.
 */

#ifndef OAIGoogleCloudVisionV1p1beta1FaceAnnotation_H
#define OAIGoogleCloudVisionV1p1beta1FaceAnnotation_H
...
class OAIGoogleCloudVisionV1p1beta1FaceAnnotationLandmark;

class OAIGoogleCloudVisionV1p1beta1FaceAnnotation : public OAIObject {
public:
    OAIGoogleCloudVisionV1p1beta1FaceAnnotation();
    OAIGoogleCloudVisionV1p1beta1FaceAnnotation(QString json);
    ~OAIGoogleCloudVisionV1p1beta1FaceAnnotation() override;
    ...
    OAIGoogleCloudVisionV1p1beta1BoundingPoly getFdBoundingPoly() const;
    void setFdBoundingPoly(const OAIGoogleCloudVisionV1p1beta1BoundingPoly &fd_bounding_poly);
    ...
    QList<OAIGoogleCloudVisionV1p1beta1FaceAnnotationLandmark> getLandmarks() const;
    void setLandmarks(const QList<OAIGoogleCloudVisionV1p1beta1FaceAnnotationLandmark> &landmarks);
...
private:
    ...
    OAIGoogleCloudVisionV1p1beta1BoundingPoly m_fd_bounding_poly;
    ...
    QList<OAIGoogleCloudVisionV1p1beta1FaceAnnotationLandmark> m_landmarks;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudVisionV1p1beta1FaceAnnotation)

#endif // OAIGoogleCloudVisionV1p1beta1FaceAnnotation_H
