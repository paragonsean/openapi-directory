...
OAIFaceAnnotation::OAIFaceAnnotation(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFaceAnnotation::OAIFaceAnnotation() {
    this->initializeModel();
}

OAIFaceAnnotation::~OAIFaceAnnotation() {}

void OAIFaceAnnotation::initializeModel() {
...
void OAIFaceAnnotation::fromJson(QString jsonString) {
...
void OAIFaceAnnotation::fromJsonObject(QJsonObject json) {
...
QString OAIFaceAnnotation::asJson() const {
...
QJsonObject OAIFaceAnnotation::asJsonObject() const {
    QJsonObject obj;
...
QString OAIFaceAnnotation::getAngerLikelihood() const {
    return m_anger_likelihood;
}
void OAIFaceAnnotation::setAngerLikelihood(const QString &anger_likelihood) {
    m_anger_likelihood = anger_likelihood;
    m_anger_likelihood_isSet = true;
}

bool OAIFaceAnnotation::is_anger_likelihood_Set() const{
    return m_anger_likelihood_isSet;
}

bool OAIFaceAnnotation::is_anger_likelihood_Valid() const{
    return m_anger_likelihood_isValid;
}

QString OAIFaceAnnotation::getBlurredLikelihood() const {
    return m_blurred_likelihood;
}
void OAIFaceAnnotation::setBlurredLikelihood(const QString &blurred_likelihood) {
    m_blurred_likelihood = blurred_likelihood;
    m_blurred_likelihood_isSet = true;
}

bool OAIFaceAnnotation::is_blurred_likelihood_Set() const{
    return m_blurred_likelihood_isSet;
}

bool OAIFaceAnnotation::is_blurred_likelihood_Valid() const{
    return m_blurred_likelihood_isValid;
}

OAIBoundingPoly OAIFaceAnnotation::getBoundingPoly() const {
    return m_bounding_poly;
}
void OAIFaceAnnotation::setBoundingPoly(const OAIBoundingPoly &bounding_poly) {
    m_bounding_poly = bounding_poly;
    m_bounding_poly_isSet = true;
}

bool OAIFaceAnnotation::is_bounding_poly_Set() const{
    return m_bounding_poly_isSet;
}

bool OAIFaceAnnotation::is_bounding_poly_Valid() const{
    return m_bounding_poly_isValid;
}

float OAIFaceAnnotation::getDetectionConfidence() const {
    return m_detection_confidence;
}
void OAIFaceAnnotation::setDetectionConfidence(const float &detection_confidence) {
    m_detection_confidence = detection_confidence;
    m_detection_confidence_isSet = true;
}

bool OAIFaceAnnotation::is_detection_confidence_Set() const{
    return m_detection_confidence_isSet;
}

bool OAIFaceAnnotation::is_detection_confidence_Valid() const{
    return m_detection_confidence_isValid;
}

OAIBoundingPoly OAIFaceAnnotation::getFdBoundingPoly() const {
    return m_fd_bounding_poly;
}
void OAIFaceAnnotation::setFdBoundingPoly(const OAIBoundingPoly &fd_bounding_poly) {
    m_fd_bounding_poly = fd_bounding_poly;
    m_fd_bounding_poly_isSet = true;
}

bool OAIFaceAnnotation::is_fd_bounding_poly_Set() const{
    return m_fd_bounding_poly_isSet;
}

bool OAIFaceAnnotation::is_fd_bounding_poly_Valid() const{
    return m_fd_bounding_poly_isValid;
}

QString OAIFaceAnnotation::getHeadwearLikelihood() const {
    return m_headwear_likelihood;
}
void OAIFaceAnnotation::setHeadwearLikelihood(const QString &headwear_likelihood) {
    m_headwear_likelihood = headwear_likelihood;
    m_headwear_likelihood_isSet = true;
}

bool OAIFaceAnnotation::is_headwear_likelihood_Set() const{
    return m_headwear_likelihood_isSet;
}

bool OAIFaceAnnotation::is_headwear_likelihood_Valid() const{
    return m_headwear_likelihood_isValid;
}

QString OAIFaceAnnotation::getJoyLikelihood() const {
    return m_joy_likelihood;
}
void OAIFaceAnnotation::setJoyLikelihood(const QString &joy_likelihood) {
    m_joy_likelihood = joy_likelihood;
    m_joy_likelihood_isSet = true;
}

bool OAIFaceAnnotation::is_joy_likelihood_Set() const{
    return m_joy_likelihood_isSet;
}

bool OAIFaceAnnotation::is_joy_likelihood_Valid() const{
    return m_joy_likelihood_isValid;
}

float OAIFaceAnnotation::getLandmarkingConfidence() const {
    return m_landmarking_confidence;
}
void OAIFaceAnnotation::setLandmarkingConfidence(const float &landmarking_confidence) {
    m_landmarking_confidence = landmarking_confidence;
    m_landmarking_confidence_isSet = true;
}

bool OAIFaceAnnotation::is_landmarking_confidence_Set() const{
    return m_landmarking_confidence_isSet;
}

bool OAIFaceAnnotation::is_landmarking_confidence_Valid() const{
    return m_landmarking_confidence_isValid;
}

QList<OAILandmark> OAIFaceAnnotation::getLandmarks() const {
    return m_landmarks;
}
void OAIFaceAnnotation::setLandmarks(const QList<OAILandmark> &landmarks) {
    m_landmarks = landmarks;
    m_landmarks_isSet = true;
}

bool OAIFaceAnnotation::is_landmarks_Set() const{
    return m_landmarks_isSet;
}

bool OAIFaceAnnotation::is_landmarks_Valid() const{
    return m_landmarks_isValid;
}

float OAIFaceAnnotation::getPanAngle() const {
    return m_pan_angle;
}
void OAIFaceAnnotation::setPanAngle(const float &pan_angle) {
    m_pan_angle = pan_angle;
    m_pan_angle_isSet = true;
}

bool OAIFaceAnnotation::is_pan_angle_Set() const{
    return m_pan_angle_isSet;
}

bool OAIFaceAnnotation::is_pan_angle_Valid() const{
    return m_pan_angle_isValid;
}

float OAIFaceAnnotation::getRollAngle() const {
    return m_roll_angle;
}
void OAIFaceAnnotation::setRollAngle(const float &roll_angle) {
    m_roll_angle = roll_angle;
    m_roll_angle_isSet = true;
}

bool OAIFaceAnnotation::is_roll_angle_Set() const{
    return m_roll_angle_isSet;
}

bool OAIFaceAnnotation::is_roll_angle_Valid() const{
    return m_roll_angle_isValid;
}

QString OAIFaceAnnotation::getSorrowLikelihood() const {
    return m_sorrow_likelihood;
}
void OAIFaceAnnotation::setSorrowLikelihood(const QString &sorrow_likelihood) {
    m_sorrow_likelihood = sorrow_likelihood;
    m_sorrow_likelihood_isSet = true;
}

bool OAIFaceAnnotation::is_sorrow_likelihood_Set() const{
    return m_sorrow_likelihood_isSet;
}

bool OAIFaceAnnotation::is_sorrow_likelihood_Valid() const{
    return m_sorrow_likelihood_isValid;
}

QString OAIFaceAnnotation::getSurpriseLikelihood() const {
    return m_surprise_likelihood;
}
void OAIFaceAnnotation::setSurpriseLikelihood(const QString &surprise_likelihood) {
    m_surprise_likelihood = surprise_likelihood;
    m_surprise_likelihood_isSet = true;
}

bool OAIFaceAnnotation::is_surprise_likelihood_Set() const{
    return m_surprise_likelihood_isSet;
}

bool OAIFaceAnnotation::is_surprise_likelihood_Valid() const{
    return m_surprise_likelihood_isValid;
}

float OAIFaceAnnotation::getTiltAngle() const {
    return m_tilt_angle;
}
void OAIFaceAnnotation::setTiltAngle(const float &tilt_angle) {
    m_tilt_angle = tilt_angle;
    m_tilt_angle_isSet = true;
}

bool OAIFaceAnnotation::is_tilt_angle_Set() const{
    return m_tilt_angle_isSet;
}

bool OAIFaceAnnotation::is_tilt_angle_Valid() const{
    return m_tilt_angle_isValid;
}

QString OAIFaceAnnotation::getUnderExposedLikelihood() const {
    return m_under_exposed_likelihood;
}
void OAIFaceAnnotation::setUnderExposedLikelihood(const QString &under_exposed_likelihood) {
    m_under_exposed_likelihood = under_exposed_likelihood;
    m_under_exposed_likelihood_isSet = true;
}

bool OAIFaceAnnotation::is_under_exposed_likelihood_Set() const{
    return m_under_exposed_likelihood_isSet;
}

bool OAIFaceAnnotation::is_under_exposed_likelihood_Valid() const{
    return m_under_exposed_likelihood_isValid;
}

bool OAIFaceAnnotation::isSet() const {
...
bool OAIFaceAnnotation::isValid() const {
