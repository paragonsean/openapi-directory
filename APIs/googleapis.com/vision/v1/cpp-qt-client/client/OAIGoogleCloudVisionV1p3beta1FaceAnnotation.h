...
/*
 * OAIGoogleCloudVisionV1p3beta1FaceAnnotation.h
 *
 * A face annotation object contains the results of face detection.
 */

#ifndef OAIGoogleCloudVisionV1p3beta1FaceAnnotation_H
#define OAIGoogleCloudVisionV1p3beta1FaceAnnotation_H

#include <QJsonObject>

#include "OAIGoogleCloudVisionV1p3beta1BoundingPoly.h"
#include "OAIGoogleCloudVisionV1p3beta1FaceAnnotationLandmark.h"
#include <QList>
#include <QString>
...
class OAIGoogleCloudVisionV1p3beta1FaceAnnotationLandmark;

class OAIGoogleCloudVisionV1p3beta1FaceAnnotation : public OAIObject {
public:
    OAIGoogleCloudVisionV1p3beta1FaceAnnotation();
    OAIGoogleCloudVisionV1p3beta1FaceAnnotation(QString json);
    ~OAIGoogleCloudVisionV1p3beta1FaceAnnotation() override;
    ...
    OAIGoogleCloudVisionV1p3beta1BoundingPoly getBoundingPoly() const;
    void setBoundingPoly(const OAIGoogleCloudVisionV1p3beta1BoundingPoly &bounding_poly);
    ...
    OAIGoogleCloudVisionV1p3beta1BoundingPoly getFdBoundingPoly() const;
    void setFdBoundingPoly(const OAIGoogleCloudVisionV1p3beta1BoundingPoly &fd_bounding_poly);
    ...
    QList<OAIGoogleCloudVisionV1p3beta1FaceAnnotationLandmark> getLandmarks() const;
    void setLandmarks(const QList<OAIGoogleCloudVisionV1p3beta1FaceAnnotationLandmark> &landmarks);
...
private:
    ...
    OAIGoogleCloudVisionV1p3beta1BoundingPoly m_bounding_poly;
    ...
    OAIGoogleCloudVisionV1p3beta1BoundingPoly m_fd_bounding_poly;
    ...
    QList<OAIGoogleCloudVisionV1p3beta1FaceAnnotationLandmark> m_landmarks;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudVisionV1p3beta1FaceAnnotation)

#endif // OAIGoogleCloudVisionV1p3beta1FaceAnnotation_H
