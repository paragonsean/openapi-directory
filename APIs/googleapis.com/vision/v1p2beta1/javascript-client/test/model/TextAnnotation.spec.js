...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudVisionApi.TextAnnotation();
  });
  ...
  describe('TextAnnotation', function() {
    it('should create an instance of TextAnnotation', function() {
      // uncomment below and update the code to test TextAnnotation
      //var instance = new CloudVisionApi.TextAnnotation();
      //expect(instance).to.be.a(CloudVisionApi.TextAnnotation);
    });
