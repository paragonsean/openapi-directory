...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudVisionApi.GoogleCloudVisionV1p2beta1Position();
  });
  ...
  describe('GoogleCloudVisionV1p2beta1Position', function() {
    it('should create an instance of GoogleCloudVisionV1p2beta1Position', function() {
      // uncomment below and update the code to test GoogleCloudVisionV1p2beta1Position
      //var instance = new CloudVisionApi.GoogleCloudVisionV1p2beta1Position();
      //expect(instance).to.be.a(CloudVisionApi.GoogleCloudVisionV1p2beta1Position);
    });
