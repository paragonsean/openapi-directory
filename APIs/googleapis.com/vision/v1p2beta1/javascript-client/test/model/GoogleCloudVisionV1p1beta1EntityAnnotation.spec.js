...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudVisionApi.GoogleCloudVisionV1p1beta1EntityAnnotation();
  });
  ...
  describe('GoogleCloudVisionV1p1beta1EntityAnnotation', function() {
    it('should create an instance of GoogleCloudVisionV1p1beta1EntityAnnotation', function() {
      // uncomment below and update the code to test GoogleCloudVisionV1p1beta1EntityAnnotation
      //var instance = new CloudVisionApi.GoogleCloudVisionV1p1beta1EntityAnnotation();
      //expect(instance).to.be.a(CloudVisionApi.GoogleCloudVisionV1p1beta1EntityAnnotation);
    });
