...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudVisionApi.GoogleCloudVisionV1p4beta1Position();
  });
  ...
  describe('GoogleCloudVisionV1p4beta1Position', function() {
    it('should create an instance of GoogleCloudVisionV1p4beta1Position', function() {
      // uncomment below and update the code to test GoogleCloudVisionV1p4beta1Position
      //var instance = new CloudVisionApi.GoogleCloudVisionV1p4beta1Position();
      //expect(instance).to.be.a(CloudVisionApi.GoogleCloudVisionV1p4beta1Position);
    });
