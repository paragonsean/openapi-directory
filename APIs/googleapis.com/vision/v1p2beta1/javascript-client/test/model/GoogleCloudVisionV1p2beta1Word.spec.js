...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudVisionApi.GoogleCloudVisionV1p2beta1Word();
  });
  ...
  describe('GoogleCloudVisionV1p2beta1Word', function() {
    it('should create an instance of GoogleCloudVisionV1p2beta1Word', function() {
      // uncomment below and update the code to test GoogleCloudVisionV1p2beta1Word
      //var instance = new CloudVisionApi.GoogleCloudVisionV1p2beta1Word();
      //expect(instance).to.be.a(CloudVisionApi.GoogleCloudVisionV1p2beta1Word);
    });
