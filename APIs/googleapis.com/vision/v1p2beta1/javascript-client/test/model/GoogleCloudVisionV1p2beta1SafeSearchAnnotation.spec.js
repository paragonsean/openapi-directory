...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudVisionApi.GoogleCloudVisionV1p2beta1SafeSearchAnnotation();
  });
  ...
  describe('GoogleCloudVisionV1p2beta1SafeSearchAnnotation', function() {
    it('should create an instance of GoogleCloudVisionV1p2beta1SafeSearchAnnotation', function() {
      // uncomment below and update the code to test GoogleCloudVisionV1p2beta1SafeSearchAnnotation
      //var instance = new CloudVisionApi.GoogleCloudVisionV1p2beta1SafeSearchAnnotation();
      //expect(instance).to.be.a(CloudVisionApi.GoogleCloudVisionV1p2beta1SafeSearchAnnotation);
    });
