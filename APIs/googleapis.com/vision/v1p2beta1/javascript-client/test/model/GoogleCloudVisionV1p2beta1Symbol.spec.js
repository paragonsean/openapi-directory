...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudVisionApi.GoogleCloudVisionV1p2beta1Symbol();
  });
  ...
  describe('GoogleCloudVisionV1p2beta1Symbol', function() {
    it('should create an instance of GoogleCloudVisionV1p2beta1Symbol', function() {
      // uncomment below and update the code to test GoogleCloudVisionV1p2beta1Symbol
      //var instance = new CloudVisionApi.GoogleCloudVisionV1p2beta1Symbol();
      //expect(instance).to.be.a(CloudVisionApi.GoogleCloudVisionV1p2beta1Symbol);
    });
