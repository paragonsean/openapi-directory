...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudVisionApi.EntityAnnotation();
  });
  ...
  describe('EntityAnnotation', function() {
    it('should create an instance of EntityAnnotation', function() {
      // uncomment below and update the code to test EntityAnnotation
      //var instance = new CloudVisionApi.EntityAnnotation();
      //expect(instance).to.be.a(CloudVisionApi.EntityAnnotation);
    });
