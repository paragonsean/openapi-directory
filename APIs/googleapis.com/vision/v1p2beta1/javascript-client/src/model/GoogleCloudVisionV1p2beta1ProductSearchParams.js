...
/**
 * The GoogleCloudVisionV1p2beta1ProductSearchParams model module.
 * @module model/GoogleCloudVisionV1p2beta1ProductSearchParams
 * @version v1p2beta1
 */
class GoogleCloudVisionV1p2beta1ProductSearchParams {
    /**
     * Constructs a new <code>GoogleCloudVisionV1p2beta1ProductSearchParams</code>.
     * Parameters for a product search request.
     * @alias module:model/GoogleCloudVisionV1p2beta1ProductSearchParams
     */
    constructor() { 
        
        GoogleCloudVisionV1p2beta1ProductSearchParams.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudVisionV1p2beta1ProductSearchParams</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudVisionV1p2beta1ProductSearchParams} obj Optional instance to populate.
     * @return {module:model/GoogleCloudVisionV1p2beta1ProductSearchParams} The populated <code>GoogleCloudVisionV1p2beta1ProductSearchParams</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudVisionV1p2beta1ProductSearchParams();
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudVisionV1p2beta1ProductSearchParams</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudVisionV1p2beta1ProductSearchParams</code>.
     */
 ...
 */
GoogleCloudVisionV1p2beta1ProductSearchParams.prototype['boundingPoly'] = undefined;

/**
 * The filtering expression. This can be used to restrict search results based on Product labels. We currently support an AND of OR of key-value expressions, where each expression within an OR must have the same key. An '=' should be used to connect the key and value. For example, \"(color = red OR color = blue) AND brand = Google\" is acceptable, but \"(color = red OR brand = Google)\" is not acceptable. \"color: red\" is not acceptable because it uses a ':' instead of an '='.
 * @member {String} filter
 */
GoogleCloudVisionV1p2beta1ProductSearchParams.prototype['filter'] = undefined;
 ...
 */
GoogleCloudVisionV1p2beta1ProductSearchParams.prototype['productCategories'] = undefined;
 ...
 */
GoogleCloudVisionV1p2beta1ProductSearchParams.prototype['productSet'] = undefined;
...
export default GoogleCloudVisionV1p2beta1ProductSearchParams;
