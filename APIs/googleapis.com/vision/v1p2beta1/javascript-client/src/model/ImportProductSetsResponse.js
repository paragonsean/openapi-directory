...
/**
 * The ImportProductSetsResponse model module.
 * @module model/ImportProductSetsResponse
 * @version v1p2beta1
 */
class ImportProductSetsResponse {
    /**
     * Constructs a new <code>ImportProductSetsResponse</code>.
     ...
     * @alias module:model/ImportProductSetsResponse
     */
    constructor() { 
        
        ImportProductSetsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ImportProductSetsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ImportProductSetsResponse} obj Optional instance to populate.
     * @return {module:model/ImportProductSetsResponse} The populated <code>ImportProductSetsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ImportProductSetsResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>ImportProductSetsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ImportProductSetsResponse</code>.
     */
 ...
 */
ImportProductSetsResponse.prototype['referenceImages'] = undefined;
 ...
 */
ImportProductSetsResponse.prototype['statuses'] = undefined;
...
export default ImportProductSetsResponse;
