...
/*
 * OAIGoogleCloudVisionV1p2beta1WebDetectionWebPage.h
 *
 * Metadata for web pages.
 */

#ifndef OAIGoogleCloudVisionV1p2beta1WebDetectionWebPage_H
#define OAIGoogleCloudVisionV1p2beta1WebDetectionWebPage_H
...
class OAIGoogleCloudVisionV1p2beta1WebDetectionWebPage : public OAIObject {
public:
    OAIGoogleCloudVisionV1p2beta1WebDetectionWebPage();
    OAIGoogleCloudVisionV1p2beta1WebDetectionWebPage(QString json);
    ~OAIGoogleCloudVisionV1p2beta1WebDetectionWebPage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudVisionV1p2beta1WebDetectionWebPage)

#endif // OAIGoogleCloudVisionV1p2beta1WebDetectionWebPage_H
