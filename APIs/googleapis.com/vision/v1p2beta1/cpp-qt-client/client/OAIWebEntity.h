...
#ifndef OAIWebEntity_H
#define OAIWebEntity_H
...
class OAIWebEntity : public OAIObject {
public:
    OAIWebEntity();
    OAIWebEntity(QString json);
    ~OAIWebEntity() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWebEntity)

#endif // OAIWebEntity_H
