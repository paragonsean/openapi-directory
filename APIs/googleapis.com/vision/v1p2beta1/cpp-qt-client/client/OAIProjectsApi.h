...
Q_SIGNALS:
    ...
    void vision_projects_locations_files_annotateSignal(OAIGoogleCloudVisionV1p2beta1BatchAnnotateFilesResponse summary);
    void vision_projects_locations_files_asyncBatchAnnotateSignal(OAIOperation summary);
    void vision_projects_locations_images_annotateSignal(OAIGoogleCloudVisionV1p2beta1BatchAnnotateImagesResponse summary);
    void vision_projects_locations_images_asyncBatchAnnotateSignal(OAIOperation summary);


    void vision_projects_locations_files_annotateSignalFull(OAIHttpRequestWorker *worker, OAIGoogleCloudVisionV1p2beta1BatchAnnotateFilesResponse summary);
    void vision_projects_locations_files_asyncBatchAnnotateSignalFull(OAIHttpRequestWorker *worker, OAIOperation summary);
    void vision_projects_locations_images_annotateSignalFull(OAIHttpRequestWorker *worker, OAIGoogleCloudVisionV1p2beta1BatchAnnotateImagesResponse summary);
    ...
    void vision_projects_locations_files_annotateSignalE(OAIGoogleCloudVisionV1p2beta1BatchAnnotateFilesResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void vision_projects_locations_files_annotateSignalError(OAIGoogleCloudVisionV1p2beta1BatchAnnotateFilesResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void vision_projects_locations_images_annotateSignalE(OAIGoogleCloudVisionV1p2beta1BatchAnnotateImagesResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void vision_projects_locations_images_annotateSignalError(OAIGoogleCloudVisionV1p2beta1BatchAnnotateImagesResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
