...
/*
 * OAIGoogleCloudVisionV1p2beta1Block.h
 *
 * Logical element on the page.
 */

#ifndef OAIGoogleCloudVisionV1p2beta1Block_H
#define OAIGoogleCloudVisionV1p2beta1Block_H

#include <QJsonObject>

#include "OAIGoogleCloudVisionV1p2beta1BoundingPoly.h"
#include "OAIGoogleCloudVisionV1p2beta1Paragraph.h"
...
class OAIGoogleCloudVisionV1p2beta1Paragraph;
class OAIGoogleCloudVisionV1p2beta1TextAnnotationTextProperty;

class OAIGoogleCloudVisionV1p2beta1Block : public OAIObject {
public:
    OAIGoogleCloudVisionV1p2beta1Block();
    OAIGoogleCloudVisionV1p2beta1Block(QString json);
    ~OAIGoogleCloudVisionV1p2beta1Block() override;
    ...
    QList<OAIGoogleCloudVisionV1p2beta1Paragraph> getParagraphs() const;
    void setParagraphs(const QList<OAIGoogleCloudVisionV1p2beta1Paragraph> &paragraphs);
...
private:
    ...
    QList<OAIGoogleCloudVisionV1p2beta1Paragraph> m_paragraphs;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudVisionV1p2beta1Block)

#endif // OAIGoogleCloudVisionV1p2beta1Block_H
