...
import org.openapitools.client.model.GoogleCloudVisionV1p1beta1FaceAnnotationLandmark;
...
public class GoogleCloudVisionV1p1beta1FaceAnnotation {
  ...
  private List<GoogleCloudVisionV1p1beta1FaceAnnotationLandmark> landmarks = new ArrayList<>();
  ...
  public GoogleCloudVisionV1p1beta1FaceAnnotation angerLikelihood(AngerLikelihoodEnum angerLikelihood) {
  ...
  public GoogleCloudVisionV1p1beta1FaceAnnotation blurredLikelihood(BlurredLikelihoodEnum blurredLikelihood) {
  ...
  public GoogleCloudVisionV1p1beta1FaceAnnotation boundingPoly(GoogleCloudVisionV1p1beta1BoundingPoly boundingPoly) {
  ...
  public GoogleCloudVisionV1p1beta1FaceAnnotation detectionConfidence(Float detectionConfidence) {
  ...
  public GoogleCloudVisionV1p1beta1FaceAnnotation fdBoundingPoly(GoogleCloudVisionV1p1beta1BoundingPoly fdBoundingPoly) {
  ...
  public void setFdBoundingPoly(GoogleCloudVisionV1p1beta1BoundingPoly fdBoundingPoly) {
    this.fdBoundingPoly = fdBoundingPoly;
  }


  public GoogleCloudVisionV1p1beta1FaceAnnotation headwearLikelihood(HeadwearLikelihoodEnum headwearLikelihood) {
  ...
  public GoogleCloudVisionV1p1beta1FaceAnnotation joyLikelihood(JoyLikelihoodEnum joyLikelihood) {
  ...
  public GoogleCloudVisionV1p1beta1FaceAnnotation landmarkingConfidence(Float landmarkingConfidence) {
  ...
  public GoogleCloudVisionV1p1beta1FaceAnnotation landmarks(List<GoogleCloudVisionV1p1beta1FaceAnnotationLandmark> landmarks) {
    this.landmarks = landmarks;
    return this;
  }

  public GoogleCloudVisionV1p1beta1FaceAnnotation addLandmarksItem(GoogleCloudVisionV1p1beta1FaceAnnotationLandmark landmarksItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<GoogleCloudVisionV1p1beta1FaceAnnotationLandmark> getLandmarks() {
    return landmarks;
  }

  public void setLandmarks(List<GoogleCloudVisionV1p1beta1FaceAnnotationLandmark> landmarks) {
    this.landmarks = landmarks;
  }


  public GoogleCloudVisionV1p1beta1FaceAnnotation panAngle(Float panAngle) {
  ...
  public GoogleCloudVisionV1p1beta1FaceAnnotation rollAngle(Float rollAngle) {
  ...
  public GoogleCloudVisionV1p1beta1FaceAnnotation sorrowLikelihood(SorrowLikelihoodEnum sorrowLikelihood) {
  ...
  public GoogleCloudVisionV1p1beta1FaceAnnotation surpriseLikelihood(SurpriseLikelihoodEnum surpriseLikelihood) {
  ...
  public GoogleCloudVisionV1p1beta1FaceAnnotation tiltAngle(Float tiltAngle) {
  ...
  public GoogleCloudVisionV1p1beta1FaceAnnotation underExposedLikelihood(UnderExposedLikelihoodEnum underExposedLikelihood) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudVisionV1p1beta1FaceAnnotation googleCloudVisionV1p1beta1FaceAnnotation = (GoogleCloudVisionV1p1beta1FaceAnnotation) o;
    return Objects.equals(this.angerLikelihood, googleCloudVisionV1p1beta1FaceAnnotation.angerLikelihood) &&
        Objects.equals(this.blurredLikelihood, googleCloudVisionV1p1beta1FaceAnnotation.blurredLikelihood) &&
        Objects.equals(this.boundingPoly, googleCloudVisionV1p1beta1FaceAnnotation.boundingPoly) &&
        Objects.equals(this.detectionConfidence, googleCloudVisionV1p1beta1FaceAnnotation.detectionConfidence) &&
        Objects.equals(this.fdBoundingPoly, googleCloudVisionV1p1beta1FaceAnnotation.fdBoundingPoly) &&
        Objects.equals(this.headwearLikelihood, googleCloudVisionV1p1beta1FaceAnnotation.headwearLikelihood) &&
        Objects.equals(this.joyLikelihood, googleCloudVisionV1p1beta1FaceAnnotation.joyLikelihood) &&
        Objects.equals(this.landmarkingConfidence, googleCloudVisionV1p1beta1FaceAnnotation.landmarkingConfidence) &&
        Objects.equals(this.landmarks, googleCloudVisionV1p1beta1FaceAnnotation.landmarks) &&
        Objects.equals(this.panAngle, googleCloudVisionV1p1beta1FaceAnnotation.panAngle) &&
        Objects.equals(this.rollAngle, googleCloudVisionV1p1beta1FaceAnnotation.rollAngle) &&
        Objects.equals(this.sorrowLikelihood, googleCloudVisionV1p1beta1FaceAnnotation.sorrowLikelihood) &&
        Objects.equals(this.surpriseLikelihood, googleCloudVisionV1p1beta1FaceAnnotation.surpriseLikelihood) &&
        Objects.equals(this.tiltAngle, googleCloudVisionV1p1beta1FaceAnnotation.tiltAngle) &&
        Objects.equals(this.underExposedLikelihood, googleCloudVisionV1p1beta1FaceAnnotation.underExposedLikelihood);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudVisionV1p1beta1FaceAnnotation {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudVisionV1p1beta1FaceAnnotation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudVisionV1p1beta1FaceAnnotation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudVisionV1p1beta1FaceAnnotation is not found in the empty JSON string", GoogleCloudVisionV1p1beta1FaceAnnotation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudVisionV1p1beta1FaceAnnotation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudVisionV1p1beta1FaceAnnotation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("fdBoundingPoly") != null && !jsonObj.get("fdBoundingPoly").isJsonNull()) {
        GoogleCloudVisionV1p1beta1BoundingPoly.validateJsonElement(jsonObj.get("fdBoundingPoly"));
      }
      ...
      if (jsonObj.get("landmarks") != null && !jsonObj.get("landmarks").isJsonNull()) {
        ...
        if (jsonArraylandmarks != null) {
          ...
          for (int i = 0; i < jsonArraylandmarks.size(); i++) {
            GoogleCloudVisionV1p1beta1FaceAnnotationLandmark.validateJsonElement(jsonArraylandmarks.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudVisionV1p1beta1FaceAnnotation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudVisionV1p1beta1FaceAnnotation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudVisionV1p1beta1FaceAnnotation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudVisionV1p1beta1FaceAnnotation.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudVisionV1p1beta1FaceAnnotation>() {
           @Override
           public void write(JsonWriter out, GoogleCloudVisionV1p1beta1FaceAnnotation value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudVisionV1p1beta1FaceAnnotation read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudVisionV1p1beta1FaceAnnotation given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudVisionV1p1beta1FaceAnnotation
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudVisionV1p1beta1FaceAnnotation
   */
  public static GoogleCloudVisionV1p1beta1FaceAnnotation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudVisionV1p1beta1FaceAnnotation.class);
  }

  /**
   * Convert an instance of GoogleCloudVisionV1p1beta1FaceAnnotation to an JSON string
   *
   * @return JSON string
   */
