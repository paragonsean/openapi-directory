...
import org.openapitools.client.model.GoogleCloudVisionV1p4beta1WebDetectionWebEntity;
import org.openapitools.client.model.GoogleCloudVisionV1p4beta1WebDetectionWebImage;
import org.openapitools.client.model.GoogleCloudVisionV1p4beta1WebDetectionWebLabel;
import org.openapitools.client.model.GoogleCloudVisionV1p4beta1WebDetectionWebPage;
...
public class GoogleCloudVisionV1p4beta1WebDetection {
  ...
  private List<GoogleCloudVisionV1p4beta1WebDetectionWebLabel> bestGuessLabels = new ArrayList<>();
  ...
  private List<GoogleCloudVisionV1p4beta1WebDetectionWebPage> pagesWithMatchingImages = new ArrayList<>();
  ...
  private List<GoogleCloudVisionV1p4beta1WebDetectionWebImage> visuallySimilarImages = new ArrayList<>();

  public static final String SERIALIZED_NAME_WEB_ENTITIES = "webEntities";
  @SerializedName(SERIALIZED_NAME_WEB_ENTITIES)
  private List<GoogleCloudVisionV1p4beta1WebDetectionWebEntity> webEntities = new ArrayList<>();

  public GoogleCloudVisionV1p4beta1WebDetection() {
  }

  public GoogleCloudVisionV1p4beta1WebDetection bestGuessLabels(List<GoogleCloudVisionV1p4beta1WebDetectionWebLabel> bestGuessLabels) {
    this.bestGuessLabels = bestGuessLabels;
    return this;
  }

  public GoogleCloudVisionV1p4beta1WebDetection addBestGuessLabelsItem(GoogleCloudVisionV1p4beta1WebDetectionWebLabel bestGuessLabelsItem) {
  ...
  public void setBestGuessLabels(List<GoogleCloudVisionV1p4beta1WebDetectionWebLabel> bestGuessLabels) {
    this.bestGuessLabels = bestGuessLabels;
  }


  public GoogleCloudVisionV1p4beta1WebDetection fullMatchingImages(List<GoogleCloudVisionV1p4beta1WebDetectionWebImage> fullMatchingImages) {
    this.fullMatchingImages = fullMatchingImages;
    return this;
  }

  public GoogleCloudVisionV1p4beta1WebDetection addFullMatchingImagesItem(GoogleCloudVisionV1p4beta1WebDetectionWebImage fullMatchingImagesItem) {
  ...
  public GoogleCloudVisionV1p4beta1WebDetection pagesWithMatchingImages(List<GoogleCloudVisionV1p4beta1WebDetectionWebPage> pagesWithMatchingImages) {
    this.pagesWithMatchingImages = pagesWithMatchingImages;
    return this;
  }

  public GoogleCloudVisionV1p4beta1WebDetection addPagesWithMatchingImagesItem(GoogleCloudVisionV1p4beta1WebDetectionWebPage pagesWithMatchingImagesItem) {
  ...
  public void setPagesWithMatchingImages(List<GoogleCloudVisionV1p4beta1WebDetectionWebPage> pagesWithMatchingImages) {
    this.pagesWithMatchingImages = pagesWithMatchingImages;
  }


  public GoogleCloudVisionV1p4beta1WebDetection partialMatchingImages(List<GoogleCloudVisionV1p4beta1WebDetectionWebImage> partialMatchingImages) {
    this.partialMatchingImages = partialMatchingImages;
    return this;
  }

  public GoogleCloudVisionV1p4beta1WebDetection addPartialMatchingImagesItem(GoogleCloudVisionV1p4beta1WebDetectionWebImage partialMatchingImagesItem) {
  ...
  public GoogleCloudVisionV1p4beta1WebDetection visuallySimilarImages(List<GoogleCloudVisionV1p4beta1WebDetectionWebImage> visuallySimilarImages) {
    this.visuallySimilarImages = visuallySimilarImages;
    return this;
  }

  public GoogleCloudVisionV1p4beta1WebDetection addVisuallySimilarImagesItem(GoogleCloudVisionV1p4beta1WebDetectionWebImage visuallySimilarImagesItem) {
  ...
  public void setVisuallySimilarImages(List<GoogleCloudVisionV1p4beta1WebDetectionWebImage> visuallySimilarImages) {
    this.visuallySimilarImages = visuallySimilarImages;
  }


  public GoogleCloudVisionV1p4beta1WebDetection webEntities(List<GoogleCloudVisionV1p4beta1WebDetectionWebEntity> webEntities) {
    this.webEntities = webEntities;
    return this;
  }

  public GoogleCloudVisionV1p4beta1WebDetection addWebEntitiesItem(GoogleCloudVisionV1p4beta1WebDetectionWebEntity webEntitiesItem) {
  ...
  public void setWebEntities(List<GoogleCloudVisionV1p4beta1WebDetectionWebEntity> webEntities) {
    this.webEntities = webEntities;
  }
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudVisionV1p4beta1WebDetection googleCloudVisionV1p4beta1WebDetection = (GoogleCloudVisionV1p4beta1WebDetection) o;
    return Objects.equals(this.bestGuessLabels, googleCloudVisionV1p4beta1WebDetection.bestGuessLabels) &&
        Objects.equals(this.fullMatchingImages, googleCloudVisionV1p4beta1WebDetection.fullMatchingImages) &&
        Objects.equals(this.pagesWithMatchingImages, googleCloudVisionV1p4beta1WebDetection.pagesWithMatchingImages) &&
        Objects.equals(this.partialMatchingImages, googleCloudVisionV1p4beta1WebDetection.partialMatchingImages) &&
        Objects.equals(this.visuallySimilarImages, googleCloudVisionV1p4beta1WebDetection.visuallySimilarImages) &&
        Objects.equals(this.webEntities, googleCloudVisionV1p4beta1WebDetection.webEntities);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudVisionV1p4beta1WebDetection {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudVisionV1p4beta1WebDetection
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudVisionV1p4beta1WebDetection.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudVisionV1p4beta1WebDetection is not found in the empty JSON string", GoogleCloudVisionV1p4beta1WebDetection.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudVisionV1p4beta1WebDetection.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudVisionV1p4beta1WebDetection` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("bestGuessLabels") != null && !jsonObj.get("bestGuessLabels").isJsonNull()) {
        ...
        if (jsonArraybestGuessLabels != null) {
          ...
          for (int i = 0; i < jsonArraybestGuessLabels.size(); i++) {
            GoogleCloudVisionV1p4beta1WebDetectionWebLabel.validateJsonElement(jsonArraybestGuessLabels.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("pagesWithMatchingImages") != null && !jsonObj.get("pagesWithMatchingImages").isJsonNull()) {
        ...
        if (jsonArraypagesWithMatchingImages != null) {
          ...
          for (int i = 0; i < jsonArraypagesWithMatchingImages.size(); i++) {
            GoogleCloudVisionV1p4beta1WebDetectionWebPage.validateJsonElement(jsonArraypagesWithMatchingImages.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("visuallySimilarImages") != null && !jsonObj.get("visuallySimilarImages").isJsonNull()) {
        ...
        if (jsonArrayvisuallySimilarImages != null) {
          ...
          for (int i = 0; i < jsonArrayvisuallySimilarImages.size(); i++) {
            GoogleCloudVisionV1p4beta1WebDetectionWebImage.validateJsonElement(jsonArrayvisuallySimilarImages.get(i));
          };
        }
      }
      if (jsonObj.get("webEntities") != null && !jsonObj.get("webEntities").isJsonNull()) {
        ...
        if (jsonArraywebEntities != null) {
          ...
          for (int i = 0; i < jsonArraywebEntities.size(); i++) {
            GoogleCloudVisionV1p4beta1WebDetectionWebEntity.validateJsonElement(jsonArraywebEntities.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudVisionV1p4beta1WebDetection.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudVisionV1p4beta1WebDetection' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudVisionV1p4beta1WebDetection> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudVisionV1p4beta1WebDetection.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudVisionV1p4beta1WebDetection>() {
           @Override
           public void write(JsonWriter out, GoogleCloudVisionV1p4beta1WebDetection value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudVisionV1p4beta1WebDetection read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudVisionV1p4beta1WebDetection given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudVisionV1p4beta1WebDetection
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudVisionV1p4beta1WebDetection
   */
  public static GoogleCloudVisionV1p4beta1WebDetection fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudVisionV1p4beta1WebDetection.class);
  }

  /**
   * Convert an instance of GoogleCloudVisionV1p4beta1WebDetection to an JSON string
   *
   * @return JSON string
   */
