...
public class SafeSearchAnnotation {
  ...
  public SafeSearchAnnotation adult(AdultEnum adult) {
    this.adult = adult;
    return this;
  }
  ...
  public SafeSearchAnnotation medical(MedicalEnum medical) {
  ...
  public SafeSearchAnnotation racy(RacyEnum racy) {
    this.racy = racy;
    return this;
  }
  ...
  public SafeSearchAnnotation spoof(SpoofEnum spoof) {
    this.spoof = spoof;
    return this;
  }
  ...
  public SafeSearchAnnotation violence(ViolenceEnum violence) {
  ...
  public boolean equals(Object o) {
    ...
    SafeSearchAnnotation safeSearchAnnotation = (SafeSearchAnnotation) o;
    return Objects.equals(this.adult, safeSearchAnnotation.adult) &&
        Objects.equals(this.medical, safeSearchAnnotation.medical) &&
        Objects.equals(this.racy, safeSearchAnnotation.racy) &&
        Objects.equals(this.spoof, safeSearchAnnotation.spoof) &&
        Objects.equals(this.violence, safeSearchAnnotation.violence);
  }
  ...
  public String toString() {
    ...
    sb.append("class SafeSearchAnnotation {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SafeSearchAnnotation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SafeSearchAnnotation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SafeSearchAnnotation is not found in the empty JSON string", SafeSearchAnnotation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SafeSearchAnnotation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SafeSearchAnnotation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SafeSearchAnnotation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SafeSearchAnnotation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SafeSearchAnnotation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SafeSearchAnnotation.class));

       return (TypeAdapter<T>) new TypeAdapter<SafeSearchAnnotation>() {
           @Override
           public void write(JsonWriter out, SafeSearchAnnotation value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SafeSearchAnnotation read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SafeSearchAnnotation given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SafeSearchAnnotation
   * @throws IOException if the JSON string is invalid with respect to SafeSearchAnnotation
   */
  public static SafeSearchAnnotation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SafeSearchAnnotation.class);
  }

  /**
   * Convert an instance of SafeSearchAnnotation to an JSON string
   *
   * @return JSON string
   */
