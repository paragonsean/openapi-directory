...
public class Row {
  ...
  public Row createTime(String createTime) {
  ...
  public Row updateTime(String updateTime) {
  ...
  public Row values(Map<String, Object> values) {
    this.values = values;
    return this;
  }

  public Row putValuesItem(String key, Object valuesItem) {
    if (this.values == null) {
  ...
  public boolean equals(Object o) {
    ...
    Row row = (Row) o;
    return Objects.equals(this.createTime, row.createTime) &&
        Objects.equals(this.name, row.name) &&
        Objects.equals(this.updateTime, row.updateTime) &&
        Objects.equals(this.values, row.values);
  }

  @Override
  public int hashCode() {
    return Objects.hash(createTime, name, updateTime, values);
  }
