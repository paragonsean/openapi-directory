...
public class ApiClient {
    ...
    private String basePath = "https://admin-remotebuildexecution.googleapis.com";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://admin-remotebuildexecution.googleapis.com
