...
|------------ | ------------- | ------------- | -------------|
|**auxiliaryMetadata** | **List&lt;Map&lt;String, Object&gt;&gt;** | Details that are specific to the kind of worker used. For example, on POSIX-like systems this could contain a message with getrusage(2) statistics. |  [optional] |
