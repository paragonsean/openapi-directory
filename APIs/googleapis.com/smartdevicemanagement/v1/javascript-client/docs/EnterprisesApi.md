# SmartDeviceManagementApi.EnterprisesApi
...
> GoogleHomeEnterpriseSdmV1ExecuteDeviceCommandResponse smartdevicemanagementEnterprisesDevicesExecuteCommand(name, opts)
...
```javascript
import SmartDeviceManagementApi from 'smart_device_management_api';
let defaultClient = SmartDeviceManagementApi.ApiClient.instance;
...
let apiInstance = new SmartDeviceManagementApi.EnterprisesApi();
let name = "name_example"; // String | The name of the device requested. For example: \"enterprises/XYZ/devices/123\"
let opts = {
...
apiInstance.smartdevicemanagementEnterprisesDevicesExecuteCommand(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> GoogleHomeEnterpriseSdmV1ListDevicesResponse smartdevicemanagementEnterprisesDevicesList(parent, opts)
...
let apiInstance = new SmartDeviceManagementApi.EnterprisesApi();
let parent = "parent_example"; // String | The parent enterprise to list devices under. E.g. \"enterprises/XYZ\".
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'filter': "filter_example" // String | Optional filter to list devices. Filters can be done on: Device custom name (substring match): 'customName=wing'
};
apiInstance.smartdevicemanagementEnterprisesDevicesList(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> GoogleHomeEnterpriseSdmV1ListStructuresResponse smartdevicemanagementEnterprisesStructuresList(parent, opts)
...
let apiInstance = new SmartDeviceManagementApi.EnterprisesApi();
let parent = "parent_example"; // String | The parent enterprise to list structures under. E.g. \"enterprises/XYZ\".
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'filter': "filter_example" // String | Optional filter to list structures.
};
apiInstance.smartdevicemanagementEnterprisesStructuresList(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> GoogleHomeEnterpriseSdmV1Room smartdevicemanagementEnterprisesStructuresRoomsGet(name, opts)
...
let apiInstance = new SmartDeviceManagementApi.EnterprisesApi();
let name = "name_example"; // String | The name of the room requested. For example: \"enterprises/XYZ/structures/ABC/rooms/123\".
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
apiInstance.smartdevicemanagementEnterprisesStructuresRoomsGet(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> GoogleHomeEnterpriseSdmV1ListRoomsResponse smartdevicemanagementEnterprisesStructuresRoomsList(parent, opts)
...
let apiInstance = new SmartDeviceManagementApi.EnterprisesApi();
let parent = "parent_example"; // String | The parent resource name of the rooms requested. For example: \"enterprises/XYZ/structures/ABC\".
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
apiInstance.smartdevicemanagementEnterprisesStructuresRoomsList(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
