...
#ifndef OAIGoogleApi__HttpBody_H
#define OAIGoogleApi__HttpBody_H
...
class OAIGoogleApi__HttpBody : public OAIObject {
public:
    OAIGoogleApi__HttpBody();
    OAIGoogleApi__HttpBody(QString json);
    ~OAIGoogleApi__HttpBody() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleApi__HttpBody)

#endif // OAIGoogleApi__HttpBody_H
