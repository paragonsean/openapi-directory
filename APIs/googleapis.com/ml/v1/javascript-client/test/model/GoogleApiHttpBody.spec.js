...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AiPlatformTrainingPredictionApi.GoogleApiHttpBody();
  });
  ...
  describe('GoogleApiHttpBody', function() {
    it('should create an instance of GoogleApiHttpBody', function() {
      ...
      //var instance = new AiPlatformTrainingPredictionApi.GoogleApiHttpBody();
      //expect(instance).to.be.a(AiPlatformTrainingPredictionApi.GoogleApiHttpBody);
    });
