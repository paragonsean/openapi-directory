# AiPlatformTrainingPredictionApi.GoogleCloudMlV1Model

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**defaultVersion** | [**GoogleCloudMlV1Version**](GoogleCloudMlV1Version.md) |  | [optional] 
**description** | **String** | Optional. The description specified for the model when it was created. | [optional] 
**etag** | **Blob** | &#x60;etag&#x60; is used for optimistic concurrency control as a way to help prevent simultaneous updates of a model from overwriting each other. It is strongly suggested that systems make use of the &#x60;etag&#x60; in the read-modify-write cycle to perform model updates in order to avoid race conditions: An &#x60;etag&#x60; is returned in the response to &#x60;GetModel&#x60;, and systems are expected to put that etag in the request to &#x60;UpdateModel&#x60; to ensure that their change will be applied to the model as intended. | [optional] 
...
**name** | **String** | Required. The name specified for the model when it was created. The model name must be unique within the project it is created in. | [optional] 
