# AiPlatformTrainingPredictionApi.GoogleCloudMlV1ReplicaConfig
...
**diskConfig** | [**GoogleCloudMlV1DiskConfig**](GoogleCloudMlV1DiskConfig.md) |  | [optional] 
**imageUri** | **String** | The Docker image to run on the replica. This image must be in Container Registry. Learn more about [configuring custom containers](/ai-platform/training/docs/distributed-training-containers). | [optional] 
