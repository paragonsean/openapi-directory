# AiPlatformTrainingPredictionApi.GoogleCloudMlV1TrainingInput

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**args** | **[String]** | Optional. Command-line arguments passed to the training application when it starts. If your job uses a custom container, then the arguments are passed to the container&#39;s &#x60;ENTRYPOINT&#x60; command. | [optional] 
...
**packageUris** | **[String]** | Required. The Google Cloud Storage location of the packages with the training program and any additional dependencies. The maximum number of package URIs is 100. | [optional] 
...
**scaleTier** | **String** | Required. Specifies the machine types, the number of replicas for workers and parameter servers. | [optional] 
...
* `STANDARD_1` (value: `"STANDARD_1"`)

* `PREMIUM_1` (value: `"PREMIUM_1"`)

* `BASIC_GPU` (value: `"BASIC_GPU"`)

* `BASIC_TPU` (value: `"BASIC_TPU"`)
