...
class GoogleCloudMlV1ContainerSpec(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, args: List[str]=None, command: List[str]=None, env: List[GoogleCloudMlV1EnvVar]=None, image: str=None, ports: List[GoogleCloudMlV1ContainerPort]=None):
        """GoogleCloudMlV1ContainerSpec - a model defined in OpenAPI

        :param args: The args of this GoogleCloudMlV1ContainerSpec.
        :param command: The command of this GoogleCloudMlV1ContainerSpec.
        :param env: The env of this GoogleCloudMlV1ContainerSpec.
        :param image: The image of this GoogleCloudMlV1ContainerSpec.
        :param ports: The ports of this GoogleCloudMlV1ContainerSpec.
        """
        self.openapi_types = {
            'args': List[str],
            'command': List[str],
            'env': List[GoogleCloudMlV1EnvVar],
            'image': str,
            'ports': List[GoogleCloudMlV1ContainerPort]
        }
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'GoogleCloudMlV1ContainerSpec':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The GoogleCloudMlV1__ContainerSpec of this GoogleCloudMlV1ContainerSpec.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def args(self):
        """Gets the args of this GoogleCloudMlV1ContainerSpec.
        ...
        :return: The args of this GoogleCloudMlV1ContainerSpec.
        :rtype: List[str]
        """
        return self._args
    ...
    @args.setter
    def args(self, args):
        """Sets the args of this GoogleCloudMlV1ContainerSpec.
    ...
    @property
    def command(self):
        """Gets the command of this GoogleCloudMlV1ContainerSpec.
        ...
        :return: The command of this GoogleCloudMlV1ContainerSpec.
        :rtype: List[str]
        """
    ...
    def command(self, command):
        """Sets the command of this GoogleCloudMlV1ContainerSpec.
    ...
    @property
    def env(self):
        """Gets the env of this GoogleCloudMlV1ContainerSpec.
        ...
        :return: The env of this GoogleCloudMlV1ContainerSpec.
        :rtype: List[GoogleCloudMlV1EnvVar]
        """
        return self._env

    @env.setter
    def env(self, env):
        """Sets the env of this GoogleCloudMlV1ContainerSpec.

        Immutable. List of environment variables to set in the container. After the container starts running, code running in the container can read these environment variables. Additionally, the command and args fields can reference these variables. Later entries in this list can also reference earlier entries. For example, the following example sets the variable `VAR_2` to have the value `foo bar`: ```json [ { \"name\": \"VAR_1\", \"value\": \"foo\" }, { \"name\": \"VAR_2\", \"value\": \"$(VAR_1) bar\" } ] ``` If you switch the order of the variables in the example, then the expansion does not occur. This field corresponds to the `env` field of the [Kubernetes Containers v1 core API](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.18/#container-v1-core).

        :param env: The env of this GoogleCloudMlV1ContainerSpec.
        :type env: List[GoogleCloudMlV1EnvVar]
        """
    ...
    @property
    def image(self):
        """Gets the image of this GoogleCloudMlV1ContainerSpec.
        ...
        :return: The image of this GoogleCloudMlV1ContainerSpec.
        :rtype: str
        """
        return self._image
    ...
    def image(self, image):
        """Sets the image of this GoogleCloudMlV1ContainerSpec.
    ...
    @property
    def ports(self):
        """Gets the ports of this GoogleCloudMlV1ContainerSpec.
        ...
        :return: The ports of this GoogleCloudMlV1ContainerSpec.
        :rtype: List[GoogleCloudMlV1ContainerPort]
        """
        return self._ports

    @ports.setter
    def ports(self, ports):
        """Sets the ports of this GoogleCloudMlV1ContainerSpec.

        Immutable. List of ports to expose from the container. AI Platform Prediction sends any prediction requests that it receives to the first port on this list. AI Platform Prediction also sends [liveness and health checks](/ai-platform/prediction/docs/custom-container-requirements#health) to this port. If you do not specify this field, it defaults to following value: ```json [ { \"containerPort\": 8080 } ] ``` AI Platform Prediction does not use ports other than the first one listed. This field corresponds to the `ports` field of the [Kubernetes Containers v1 core API](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.18/#container-v1-core).

        :param ports: The ports of this GoogleCloudMlV1ContainerSpec.
        :type ports: List[GoogleCloudMlV1ContainerPort]
        """
