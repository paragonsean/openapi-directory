...
|**dataFormat** | [**DataFormatEnum**](#DataFormatEnum) | Required. The format of the input data files. |  [optional] |
|**inputPaths** | **List&lt;String&gt;** | Required. The Cloud Storage location of the input data files. May contain wildcards. |  [optional] |
...
|**outputDataFormat** | [**OutputDataFormatEnum**](#OutputDataFormatEnum) | Optional. Format of the output data files, defaults to JSON. |  [optional] |
