...
|**etag** | **byte[]** | &#x60;etag&#x60; is used for optimistic concurrency control as a way to help prevent simultaneous updates of a model from overwriting each other. It is strongly suggested that systems make use of the &#x60;etag&#x60; in the read-modify-write cycle to perform model updates in order to avoid race conditions: An &#x60;etag&#x60; is returned in the response to &#x60;GetModel&#x60;, and systems are expected to put that etag in the request to &#x60;UpdateModel&#x60; to ensure that their change will be applied to the model as intended. |  [optional] |
