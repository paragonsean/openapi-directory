...
void OAIProjectsApi::initializeServerConfigs() {
    ...
    QUrl("https://resourcesettings.googleapis.com/"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("resourcesettings_projects_settings_get", defaultConf);
    _serverIndices.insert("resourcesettings_projects_settings_get", 0);
    _serverConfigs.insert("resourcesettings_projects_settings_list", defaultConf);
    _serverIndices.insert("resourcesettings_projects_settings_list", 0);
    _serverConfigs.insert("resourcesettings_projects_settings_patch", defaultConf);
    _serverIndices.insert("resourcesettings_projects_settings_patch", 0);
}
...
void OAIProjectsApi::resourcesettings_projects_settings_get(const QString &name, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<QString> &view) {
    QString fullPath = QString(_serverConfigs["resourcesettings_projects_settings_get"][_serverIndices.value("resourcesettings_projects_settings_get")].URL()+"/v1/{name}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::resourcesettings_projects_settings_getCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::resourcesettings_projects_settings_getCallback);
...
void OAIProjectsApi::resourcesettings_projects_settings_getCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIGoogleCloudResourcesettingsV1Setting output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT resourcesettings_projects_settings_getSignal(output);
        Q_EMIT resourcesettings_projects_settings_getSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT resourcesettings_projects_settings_getSignalE(output, error_type, error_str);
        Q_EMIT resourcesettings_projects_settings_getSignalEFull(worker, error_type, error_str);
...
void OAIProjectsApi::resourcesettings_projects_settings_list(const QString &parent, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &page_token, const ::OpenAPI::OptionalParam<QString> &view) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::resourcesettings_projects_settings_listCallback);
    connect(this, &OAIProjectsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::resourcesettings_projects_settings_listCallback);
    connect(this, &OAIProjectsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectsApi::resourcesettings_projects_settings_listCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIGoogleCloudResourcesettingsV1ListSettingsResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT resourcesettings_projects_settings_listSignal(output);
        Q_EMIT resourcesettings_projects_settings_listSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("https://www.googleapis.com/auth/cloud-platform");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT resourcesettings_projects_settings_listSignalE(output, error_type, error_str);
        Q_EMIT resourcesettings_projects_settings_listSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT resourcesettings_projects_settings_listSignalError(output, error_type, error_str);
        Q_EMIT resourcesettings_projects_settings_listSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectsApi::resourcesettings_projects_settings_patch(const QString &name, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<OAIGoogleCloudResourcesettingsV1Setting> &oai_google_cloud_resourcesettings_v1_setting) {
    QString fullPath = QString(_serverConfigs["resourcesettings_projects_settings_patch"][_serverIndices.value("resourcesettings_projects_settings_patch")].URL()+"/v1/{name}");
    ...
    if (oai_google_cloud_resourcesettings_v1_setting.hasValue()){

        
        QByteArray output = oai_google_cloud_resourcesettings_v1_setting.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::resourcesettings_projects_settings_patchCallback);
    connect(this, &OAIProjectsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::resourcesettings_projects_settings_patchCallback);
    connect(this, &OAIProjectsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectsApi::resourcesettings_projects_settings_patchCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT resourcesettings_projects_settings_patchSignal(output);
        Q_EMIT resourcesettings_projects_settings_patchSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("https://www.googleapis.com/auth/cloud-platform");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT resourcesettings_projects_settings_patchSignalE(output, error_type, error_str);
        Q_EMIT resourcesettings_projects_settings_patchSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT resourcesettings_projects_settings_patchSignalError(output, error_type, error_str);
        Q_EMIT resourcesettings_projects_settings_patchSignalErrorFull(worker, error_type, error_str);
    }
}
