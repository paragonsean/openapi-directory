# ResourceSettingsApi.ProjectsApi
...
> GoogleCloudResourcesettingsV1Setting resourcesettingsProjectsSettingsGet(name, opts)
...
```javascript
import ResourceSettingsApi from 'resource_settings_api';
let defaultClient = ResourceSettingsApi.ApiClient.instance;
...
let apiInstance = new ResourceSettingsApi.ProjectsApi();
let name = "name_example"; // String | Required. The name of the setting to get. See Setting for naming requirements.
let opts = {
...
apiInstance.resourcesettingsProjectsSettingsGet(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
 ...
 **view** | **String**| The SettingView for this request. | [optional] 
...
> GoogleCloudResourcesettingsV1ListSettingsResponse resourcesettingsProjectsSettingsList(parent, opts)
...
let apiInstance = new ResourceSettingsApi.ProjectsApi();
let parent = "parent_example"; // String | Required. The project, folder, or organization that is the parent resource for this setting. Must be in one of the following forms: * `projects/{project_number}` * `projects/{project_id}` * `folders/{folder_id}` * `organizations/{organization_id}`
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'pageSize': 56, // Number | Unused. The size of the page to be returned.
  'pageToken': "pageToken_example", // String | Unused. A page token used to retrieve the next page.
  'view': "view_example" // String | The SettingView for this request.
};
apiInstance.resourcesettingsProjectsSettingsList(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **uploadProtocol** | **String**| Upload protocol for media (e.g. \&quot;raw\&quot;, \&quot;multipart\&quot;). | [optional] 
 **uploadType** | **String**| Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;). | [optional] 
 **pageSize** | **Number**| Unused. The size of the page to be returned. | [optional] 
...
> GoogleCloudResourcesettingsV1Setting resourcesettingsProjectsSettingsPatch(name, opts)
...
let apiInstance = new ResourceSettingsApi.ProjectsApi();
let name = "name_example"; // String | The resource name of the setting. Must be in one of the following forms: * `projects/{project_number}/settings/{setting_name}` * `folders/{folder_id}/settings/{setting_name}` * `organizations/{organization_id}/settings/{setting_name}` For example, \"/projects/123/settings/gcp-enableMyFeature\"
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'googleCloudResourcesettingsV1Setting': new ResourceSettingsApi.GoogleCloudResourcesettingsV1Setting() // GoogleCloudResourcesettingsV1Setting | 
};
apiInstance.resourcesettingsProjectsSettingsPatch(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
