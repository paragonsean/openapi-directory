...
(function(root, factory) {
  ...
  describe('ProjectsApi', function() {
    describe('composerProjectsLocationsEnvironmentsCheckUpgrade', function() {
      it('should call composerProjectsLocationsEnvironmentsCheckUpgrade successfully', function(done) {
        //uncomment below and update the code to test composerProjectsLocationsEnvironmentsCheckUpgrade
        //instance.composerProjectsLocationsEnvironmentsCheckUpgrade(function(error) {
    ...
    describe('composerProjectsLocationsEnvironmentsRestartWebServer', function() {
      it('should call composerProjectsLocationsEnvironmentsRestartWebServer successfully', function(done) {
        //uncomment below and update the code to test composerProjectsLocationsEnvironmentsRestartWebServer
        //instance.composerProjectsLocationsEnvironmentsRestartWebServer(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
