...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudComposerApi.ExitInfo();
  });
  ...
  describe('ExitInfo', function() {
    it('should create an instance of ExitInfo', function() {
      // uncomment below and update the code to test ExitInfo
      //var instance = new CloudComposerApi.ExitInfo();
      //expect(instance).to.be.a(CloudComposerApi.ExitInfo);
    });
