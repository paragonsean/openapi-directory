...
public class StorageConfig {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.bucket, storageConfig.bucket);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StorageConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StorageConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
