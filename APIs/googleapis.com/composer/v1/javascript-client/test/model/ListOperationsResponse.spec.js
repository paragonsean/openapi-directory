...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudComposerApi.ListOperationsResponse();
  });
  ...
  describe('ListOperationsResponse', function() {
    it('should create an instance of ListOperationsResponse', function() {
      ...
      //var instance = new CloudComposerApi.ListOperationsResponse();
      //expect(instance).to.be.a(CloudComposerApi.ListOperationsResponse);
    });
