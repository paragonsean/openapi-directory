...
------------ | ------------- | ------------- | -------------
**endTime** | **String** | Required. Maintenance window end time. It is used only to calculate the duration of the maintenance window. The value for end-time must be in the future, relative to &#x60;start_time&#x60;. | [optional] 
