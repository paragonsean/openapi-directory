...
**schedulerCount** | **Number** | Optional. The number of schedulers for Airflow. This field is supported for Cloud Composer environments in versions composer-1.*.*-airflow-2.*.*. | [optional] 
**webServerPluginsMode** | **String** | Optional. Whether or not the web server uses custom plugins. If unspecified, the field defaults to &#x60;PLUGINS_ENABLED&#x60;. This field is supported for Cloud Composer environments in versions composer-3.*.*-airflow-*.*.* and newer. | [optional] 



## Enum: WebServerPluginsModeEnum


* `WEB_SERVER_PLUGINS_MODE_UNSPECIFIED` (value: `"WEB_SERVER_PLUGINS_MODE_UNSPECIFIED"`)

* `PLUGINS_DISABLED` (value: `"PLUGINS_DISABLED"`)
