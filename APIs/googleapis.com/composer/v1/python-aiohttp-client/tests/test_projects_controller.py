...
async def test_composer_projects_locations_environments_database_failover(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{environmentdatabase_failove}'.format(environment='environment_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_composer_projects_locations_environments_execute_airflow_command(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{environmentexecute_airflow_comman}'.format(environment='environment_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_composer_projects_locations_environments_fetch_database_properties(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/{environmentfetch_database_propertie}'.format(environment='environment_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_composer_projects_locations_environments_load_snapshot(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{environmentload_snapsho}'.format(environment='environment_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_composer_projects_locations_environments_poll_airflow_command(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{environmentpoll_airflow_comman}'.format(environment='environment_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_composer_projects_locations_environments_save_snapshot(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{environmentsave_snapsho}'.format(environment='environment_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_composer_projects_locations_environments_stop_airflow_command(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{environmentstop_airflow_comman}'.format(environment='environment_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_composer_projects_locations_environments_user_workloads_config_maps_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/userWorkloadsConfigMaps'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_composer_projects_locations_environments_user_workloads_secrets_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/userWorkloadsSecrets'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_composer_projects_locations_image_versions_list(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/{parent}/imageVersions'.format(parent='parent_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
