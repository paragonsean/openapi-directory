...
|**schedulerCount** | **Integer** | Optional. The number of schedulers for Airflow. This field is supported for Cloud Composer environments in versions composer-1.*.*-airflow-2.*.*. |  [optional] |
|**webServerPluginsMode** | [**WebServerPluginsModeEnum**](#WebServerPluginsModeEnum) | Optional. Whether or not the web server uses custom plugins. If unspecified, the field defaults to &#x60;PLUGINS_ENABLED&#x60;. This field is supported for Cloud Composer environments in versions composer-3.*.*-airflow-*.*.* and newer. |  [optional] |
