...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CertificateManagerApi.ListLocationsResponse();
  });
  ...
  describe('ListLocationsResponse', function() {
    it('should create an instance of ListLocationsResponse', function() {
      ...
      //var instance = new CertificateManagerApi.ListLocationsResponse();
      //expect(instance).to.be.a(CertificateManagerApi.ListLocationsResponse);
    });
