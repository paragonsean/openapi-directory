...
from openapi_server.models.generic_class_add_message_response import GenericClassAddMessageResponse
from openapi_server.models.generic_class_list_response import GenericClassListResponse


pytestmark = pytest.mark.asyncio

async def test_walletobjects_genericclass_addmessage(client):
    """Test case for walletobjects_genericclass_addmessage

    
    """
    body = {"message":{"localizedBody":{"defaultValue":{"kind":"kind","language":"language","value":"value"},"kind":"kind","translatedValues":[{"kind":"kind","language":"language","value":"value"},{"kind":"kind","language":"language","value":"value"}]},"displayInterval":{"kind":"kind","start":{"date":"date"},"end":{"date":"date"}},"messageType":"MESSAGE_TYPE_UNSPECIFIED","localizedHeader":{"defaultValue":{"kind":"kind","language":"language","value":"value"},"kind":"kind","translatedValues":[{"kind":"kind","language":"language","value":"value"},{"kind":"kind","language":"language","value":"value"}]},"kind":"kind","header":"header","id":"id","body":"body"}}
    ...
    response = await client.request(
        method='POST',
        path='/walletobjects/v1/genericClass/{resource_id}/addMessage'.format(resource_id='resource_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
