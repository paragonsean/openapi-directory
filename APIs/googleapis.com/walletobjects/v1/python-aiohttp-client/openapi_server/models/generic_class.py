...
class GenericClass(Model):
    ...
    def __init__(self, callback_options: CallbackOptions=None, class_template_info: ClassTemplateInfo=None, enable_smart_tap: bool=None, id: str=None, image_modules_data: List[ImageModuleData]=None, links_module_data: LinksModuleData=None, messages: List[Message]=None, multiple_devices_and_holders_allowed_status: str=None, redemption_issuers: List[str]=None, security_animation: SecurityAnimation=None, text_modules_data: List[TextModuleData]=None, view_unlock_requirement: str=None):
        ...
        :param messages: The messages of this GenericClass.
    ...
    @property
    def messages(self):
        """Gets the messages of this GenericClass.

        An array of messages displayed in the app. All users of this object will receive its associated messages. The maximum number of these fields is 10.

        :return: The messages of this GenericClass.
        :rtype: List[Message]
        """
    ...
    def messages(self, messages):
        """Sets the messages of this GenericClass.
