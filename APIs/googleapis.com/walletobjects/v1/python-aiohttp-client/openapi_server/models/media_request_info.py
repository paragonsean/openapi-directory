...
class MediaRequestInfo(Model):
    ...
    def __init__(self, current_bytes: str=None, custom_data: str=None, diff_object_version: str=None, final_status: int=None, notification_type: str=None, request_id: str=None, request_received_params_serving_info: str=None, total_bytes: str=None, total_bytes_is_estimated: bool=None):
        ...
        :param request_received_params_serving_info: The request_received_params_serving_info of this MediaRequestInfo.
        ...
        self.openapi_types = {
            ...
            'request_id': str,
            'request_received_params_serving_info': str,
            'total_bytes': str,
        ...
        self.attribute_map = {
            ...
            'request_received_params_serving_info': 'requestReceivedParamsServingInfo',
        ...
        self._request_received_params_serving_info = request_received_params_serving_info
    ...
    @property
    def request_received_params_serving_info(self):
        """Gets the request_received_params_serving_info of this MediaRequestInfo.
        ...
        :return: The request_received_params_serving_info of this MediaRequestInfo.
        :rtype: str
        """
        return self._request_received_params_serving_info

    @request_received_params_serving_info.setter
    def request_received_params_serving_info(self, request_received_params_serving_info):
        """Sets the request_received_params_serving_info of this MediaRequestInfo.

        The partition of the Scotty server handling this request. type is uploader_service.RequestReceivedParamsServingInfo LINT.IfChange(request_received_params_serving_info_annotations) LINT.ThenChange()

        :param request_received_params_serving_info: The request_received_params_serving_info of this MediaRequestInfo.
        :type request_received_params_serving_info: str
        """
