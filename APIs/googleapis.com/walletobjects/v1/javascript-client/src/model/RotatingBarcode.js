...
class RotatingBarcode {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('initialRotatingBarcodeValues')) {
                obj['initialRotatingBarcodeValues'] = RotatingBarcodeValues.constructFromObject(data['initialRotatingBarcodeValues']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['initialRotatingBarcodeValues']) { // data not null
          RotatingBarcodeValues.validateJSON(data['initialRotatingBarcodeValues']);
        }
        // ensure the json data is a string
...
/**
 * @member {module:model/RotatingBarcodeValues} initialRotatingBarcodeValues
 */
RotatingBarcode.prototype['initialRotatingBarcodeValues'] = undefined;
