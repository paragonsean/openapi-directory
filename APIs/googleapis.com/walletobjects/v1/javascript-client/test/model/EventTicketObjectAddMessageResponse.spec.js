...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleWalletApi.EventTicketObjectAddMessageResponse();
  });
  ...
  describe('EventTicketObjectAddMessageResponse', function() {
    it('should create an instance of EventTicketObjectAddMessageResponse', function() {
      ...
      //var instance = new GoogleWalletApi.EventTicketObjectAddMessageResponse();
      //expect(instance).to.be.a(GoogleWalletApi.EventTicketObjectAddMessageResponse);
    });
