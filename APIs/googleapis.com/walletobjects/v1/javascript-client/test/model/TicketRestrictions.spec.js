...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleWalletApi.TicketRestrictions();
  });
  ...
  describe('TicketRestrictions', function() {
    it('should create an instance of TicketRestrictions', function() {
      ...
      //var instance = new GoogleWalletApi.TicketRestrictions();
      //expect(instance).to.be.a(GoogleWalletApi.TicketRestrictions);
    });
