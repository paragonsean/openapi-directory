...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleWalletApi.DetailsTemplateOverride();
  });
  ...
  describe('DetailsTemplateOverride', function() {
    it('should create an instance of DetailsTemplateOverride', function() {
      ...
      //var instance = new GoogleWalletApi.DetailsTemplateOverride();
      //expect(instance).to.be.a(GoogleWalletApi.DetailsTemplateOverride);
    });
