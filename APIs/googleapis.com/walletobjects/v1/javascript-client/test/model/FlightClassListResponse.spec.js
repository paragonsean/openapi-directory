...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleWalletApi.FlightClassListResponse();
  });
  ...
  describe('FlightClassListResponse', function() {
    it('should create an instance of FlightClassListResponse', function() {
      ...
      //var instance = new GoogleWalletApi.FlightClassListResponse();
      //expect(instance).to.be.a(GoogleWalletApi.FlightClassListResponse);
    });
