...
<a id="walletobjectsGenericobjectAddmessage"></a>
# **walletobjectsGenericobjectAddmessage**
> GenericObjectAddMessageResponse walletobjectsGenericobjectAddmessage(resourceId, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, addMessageRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    String resourceId = "resourceId_example"; // String | The unique identifier for an object. This ID must be unique across all classes from an issuer. This value should follow the format issuer ID. identifier where the former is issued by Google and latter is chosen by you. Your unique identifier should only include alphanumeric characters, '.', '_', or '-'.
    ...
    try {
      GenericObjectAddMessageResponse result = apiInstance.walletobjectsGenericobjectAddmessage(resourceId, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, addMessageRequest);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling GenericobjectApi#walletobjectsGenericobjectAddmessage");
