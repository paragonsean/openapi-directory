...
public class MediaRequestInfo {
  ...
  public static final String SERIALIZED_NAME_REQUEST_RECEIVED_PARAMS_SERVING_INFO = "requestReceivedParamsServingInfo";
  @SerializedName(SERIALIZED_NAME_REQUEST_RECEIVED_PARAMS_SERVING_INFO)
  private byte[] requestReceivedParamsServingInfo;
  ...
  public MediaRequestInfo requestReceivedParamsServingInfo(byte[] requestReceivedParamsServingInfo) {
   ...
   */
  @javax.annotation.Nullable
  public byte[] getRequestReceivedParamsServingInfo() {
    return requestReceivedParamsServingInfo;
  }

  public void setRequestReceivedParamsServingInfo(byte[] requestReceivedParamsServingInfo) {
    this.requestReceivedParamsServingInfo = requestReceivedParamsServingInfo;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.currentBytes, mediaRequestInfo.currentBytes) &&
        ...
        Arrays.equals(this.requestReceivedParamsServingInfo, mediaRequestInfo.requestReceivedParamsServingInfo) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(currentBytes, customData, diffObjectVersion, finalStatus, notificationType, requestId, Arrays.hashCode(requestReceivedParamsServingInfo), totalBytes, totalBytesIsEstimated);
  }
  ...
  public String toString() {
    ...
    sb.append("    requestReceivedParamsServingInfo: ").append(toIndentedString(requestReceivedParamsServingInfo)).append("\n");
  ...
  static {
    ...
    openapiFields.add("requestReceivedParamsServingInfo");
