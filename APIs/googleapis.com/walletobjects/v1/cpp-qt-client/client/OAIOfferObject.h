...
#ifndef OAIOfferObject_H
#define OAIOfferObject_H
...
class OAIOfferObject : public OAIObject {
public:
    OAIOfferObject();
    OAIOfferObject(QString json);
    ~OAIOfferObject() override;
    ...
    OAIOfferClass getClassReference() const;
    void setClassReference(const OAIOfferClass &class_reference);
...
private:
    ...
    OAIOfferClass m_class_reference;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOfferObject)

#endif // OAIOfferObject_H
