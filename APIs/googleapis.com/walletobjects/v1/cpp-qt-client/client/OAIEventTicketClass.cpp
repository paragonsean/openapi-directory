...
OAIImage OAIEventTicketClass::getWideLogo() const {
    return m_wide_logo;
}
void OAIEventTicketClass::setWideLogo(const OAIImage &wide_logo) {
    m_wide_logo = wide_logo;
    m_wide_logo_isSet = true;
}

bool OAIEventTicketClass::is_wide_logo_Set() const{
    return m_wide_logo_isSet;
}

bool OAIEventTicketClass::is_wide_logo_Valid() const{
