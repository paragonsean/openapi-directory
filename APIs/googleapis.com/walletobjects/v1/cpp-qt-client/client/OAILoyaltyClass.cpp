...
void OAILoyaltyClass::initializeModel() {
    ...
    m_wide_program_logo_isSet = false;
    m_wide_program_logo_isValid = false;
...
void OAILoyaltyClass::fromJsonObject(QJsonObject json) {
    ...
    m_wide_program_logo_isValid = ::OpenAPI::fromJsonValue(m_wide_program_logo, json[QString("wideProgramLogo")]);
    m_wide_program_logo_isSet = !json[QString("wideProgramLogo")].isNull() && m_wide_program_logo_isValid;
...
QJsonObject OAILoyaltyClass::asJsonObject() const {
    ...
    if (m_wide_program_logo.isSet()) {
        obj.insert(QString("wideProgramLogo"), ::OpenAPI::toJsonValue(m_wide_program_logo));
    }
...
OAIImage OAILoyaltyClass::getWideProgramLogo() const {
    return m_wide_program_logo;
}
void OAILoyaltyClass::setWideProgramLogo(const OAIImage &wide_program_logo) {
    m_wide_program_logo = wide_program_logo;
    m_wide_program_logo_isSet = true;
}

bool OAILoyaltyClass::is_wide_program_logo_Set() const{
    return m_wide_program_logo_isSet;
}

bool OAILoyaltyClass::is_wide_program_logo_Valid() const{
    return m_wide_program_logo_isValid;
}
