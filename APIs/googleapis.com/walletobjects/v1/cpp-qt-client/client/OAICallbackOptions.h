...
public:
    ...
    Q_DECL_DEPRECATED QString getUpdateRequestUrl() const;
    Q_DECL_DEPRECATED void setUpdateRequestUrl(const QString &update_request_url);
    Q_DECL_DEPRECATED bool is_update_request_url_Set() const;
    Q_DECL_DEPRECATED bool is_update_request_url_Valid() const;
