...
OAIImage OAITransitClass::getWideLogo() const {
    return m_wide_logo;
}
void OAITransitClass::setWideLogo(const OAIImage &wide_logo) {
    m_wide_logo = wide_logo;
    m_wide_logo_isSet = true;
}

bool OAITransitClass::is_wide_logo_Set() const{
    return m_wide_logo_isSet;
}

bool OAITransitClass::is_wide_logo_Valid() const{
