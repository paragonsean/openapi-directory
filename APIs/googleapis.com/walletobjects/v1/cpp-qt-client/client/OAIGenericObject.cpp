...
OAIImage OAIGenericObject::getWideLogo() const {
    return m_wide_logo;
}
void OAIGenericObject::setWideLogo(const OAIImage &wide_logo) {
    m_wide_logo = wide_logo;
    m_wide_logo_isSet = true;
}

bool OAIGenericObject::is_wide_logo_Set() const{
    return m_wide_logo_isSet;
}

bool OAIGenericObject::is_wide_logo_Valid() const{
