...
void OAIPermissionsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("walletobjects_permissions_get", defaultConf);
    _serverIndices.insert("walletobjects_permissions_get", 0);
    _serverConfigs.insert("walletobjects_permissions_update", defaultConf);
    _serverIndices.insert("walletobjects_permissions_update", 0);
}
...
void OAIPermissionsApi::walletobjects_permissions_get(const QString &resource_id, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type) {
    QString fullPath = QString(_serverConfigs["walletobjects_permissions_get"][_serverIndices.value("walletobjects_permissions_get")].URL()+"/walletobjects/v1/permissions/{resourceId}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIPermissionsApi::walletobjects_permissions_getCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIPermissionsApi::walletobjects_permissions_getCallback);
...
void OAIPermissionsApi::walletobjects_permissions_getCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT walletobjects_permissions_getSignal(output);
        Q_EMIT walletobjects_permissions_getSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT walletobjects_permissions_getSignalE(output, error_type, error_str);
        Q_EMIT walletobjects_permissions_getSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT walletobjects_permissions_getSignalError(output, error_type, error_str);
        Q_EMIT walletobjects_permissions_getSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIPermissionsApi::walletobjects_permissions_update(const QString &resource_id, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<OAIPermissions> &oai_permissions) {
    QString fullPath = QString(_serverConfigs["walletobjects_permissions_update"][_serverIndices.value("walletobjects_permissions_update")].URL()+"/walletobjects/v1/permissions/{resourceId}");
    ...
    if (oai_permissions.hasValue()){

        
        QByteArray output = oai_permissions.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIPermissionsApi::walletobjects_permissions_updateCallback);
    connect(this, &OAIPermissionsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIPermissionsApi::walletobjects_permissions_updateCallback);
    connect(this, &OAIPermissionsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIPermissionsApi::walletobjects_permissions_updateCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT walletobjects_permissions_updateSignal(output);
        Q_EMIT walletobjects_permissions_updateSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("https://www.googleapis.com/auth/wallet_object.issuer");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT walletobjects_permissions_updateSignalE(output, error_type, error_str);
        Q_EMIT walletobjects_permissions_updateSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT walletobjects_permissions_updateSignalError(output, error_type, error_str);
        Q_EMIT walletobjects_permissions_updateSignalErrorFull(worker, error_type, error_str);
    }
}
