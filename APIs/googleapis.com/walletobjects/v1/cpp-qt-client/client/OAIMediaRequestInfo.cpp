...
void OAIMediaRequestInfo::initializeModel() {
    ...
    m_request_received_params_serving_info_isSet = false;
    m_request_received_params_serving_info_isValid = false;
...
void OAIMediaRequestInfo::fromJsonObject(QJsonObject json) {
    ...
    m_request_received_params_serving_info_isValid = ::OpenAPI::fromJsonValue(m_request_received_params_serving_info, json[QString("requestReceivedParamsServingInfo")]);
    m_request_received_params_serving_info_isSet = !json[QString("requestReceivedParamsServingInfo")].isNull() && m_request_received_params_serving_info_isValid;
...
QJsonObject OAIMediaRequestInfo::asJsonObject() const {
    ...
    if (m_request_received_params_serving_info_isSet) {
        obj.insert(QString("requestReceivedParamsServingInfo"), ::OpenAPI::toJsonValue(m_request_received_params_serving_info));
    }
...
QByteArray OAIMediaRequestInfo::getRequestReceivedParamsServingInfo() const {
    return m_request_received_params_serving_info;
}
void OAIMediaRequestInfo::setRequestReceivedParamsServingInfo(const QByteArray &request_received_params_serving_info) {
    m_request_received_params_serving_info = request_received_params_serving_info;
    m_request_received_params_serving_info_isSet = true;
}

bool OAIMediaRequestInfo::is_request_received_params_serving_info_Set() const{
    return m_request_received_params_serving_info_isSet;
}

bool OAIMediaRequestInfo::is_request_received_params_serving_info_Valid() const{
    return m_request_received_params_serving_info_isValid;
}
