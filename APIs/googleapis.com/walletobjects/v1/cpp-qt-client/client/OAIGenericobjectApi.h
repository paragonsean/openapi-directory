...
private:
    ...
    void walletobjects_genericobject_addmessageCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void walletobjects_genericobject_addmessageSignal(OAIGenericObjectAddMessageResponse summary);
    ...
    void walletobjects_genericobject_addmessageSignalFull(OAIHttpRequestWorker *worker, OAIGenericObjectAddMessageResponse summary);
    ...
    Q_DECL_DEPRECATED_X("Use walletobjects_genericobject_addmessageSignalError() instead")
    void walletobjects_genericobject_addmessageSignalE(OAIGenericObjectAddMessageResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void walletobjects_genericobject_addmessageSignalError(OAIGenericObjectAddMessageResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use walletobjects_genericobject_addmessageSignalErrorFull() instead")
    void walletobjects_genericobject_addmessageSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void walletobjects_genericobject_addmessageSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
