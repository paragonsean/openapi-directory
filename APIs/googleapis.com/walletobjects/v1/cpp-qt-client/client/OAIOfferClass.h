...
public:
    ...
    OAIImage getWideTitleImage() const;
    void setWideTitleImage(const OAIImage &wide_title_image);
    bool is_wide_title_image_Set() const;
    bool is_wide_title_image_Valid() const;
...
private:
    ...
    OAIImage m_wide_title_image;
    bool m_wide_title_image_isSet;
    bool m_wide_title_image_isValid;
