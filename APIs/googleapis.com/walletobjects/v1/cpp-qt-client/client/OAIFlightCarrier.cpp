...
void OAIFlightCarrier::initializeModel() {
    ...
    m_wide_airline_logo_isSet = false;
    m_wide_airline_logo_isValid = false;
}
...
void OAIFlightCarrier::fromJsonObject(QJsonObject json) {
    ...
    m_wide_airline_logo_isValid = ::OpenAPI::fromJsonValue(m_wide_airline_logo, json[QString("wideAirlineLogo")]);
    m_wide_airline_logo_isSet = !json[QString("wideAirlineLogo")].isNull() && m_wide_airline_logo_isValid;
}
...
QJsonObject OAIFlightCarrier::asJsonObject() const {
    ...
    if (m_wide_airline_logo.isSet()) {
        obj.insert(QString("wideAirlineLogo"), ::OpenAPI::toJsonValue(m_wide_airline_logo));
    }
    return obj;
}
...
OAIImage OAIFlightCarrier::getWideAirlineLogo() const {
    return m_wide_airline_logo;
}
void OAIFlightCarrier::setWideAirlineLogo(const OAIImage &wide_airline_logo) {
    m_wide_airline_logo = wide_airline_logo;
    m_wide_airline_logo_isSet = true;
}

bool OAIFlightCarrier::is_wide_airline_logo_Set() const{
    return m_wide_airline_logo_isSet;
}

bool OAIFlightCarrier::is_wide_airline_logo_Valid() const{
    return m_wide_airline_logo_isValid;
}
