...
class AggregationResult {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('aggregateFields')) {
                obj['aggregateFields'] = ApiClient.convertToType(data['aggregateFields'], {'String': Value});
            }
        }
        return obj;
    }
 ...
 * @member {Object.<String, module:model/Value>} aggregateFields
 */
AggregationResult.prototype['aggregateFields'] = undefined;
