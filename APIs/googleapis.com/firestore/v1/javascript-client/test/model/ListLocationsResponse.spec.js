...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudFirestoreApi.ListLocationsResponse();
  });
  ...
  describe('ListLocationsResponse', function() {
    it('should create an instance of ListLocationsResponse', function() {
      ...
      //var instance = new CloudFirestoreApi.ListLocationsResponse();
      //expect(instance).to.be.a(CloudFirestoreApi.ListLocationsResponse);
    });
