...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudFirestoreApi.FieldFilter();
  });
  ...
  describe('FieldFilter', function() {
    it('should create an instance of FieldFilter', function() {
      // uncomment below and update the code to test FieldFilter
      //var instance = new CloudFirestoreApi.FieldFilter();
      //expect(instance).to.be.a(CloudFirestoreApi.FieldFilter);
    });
