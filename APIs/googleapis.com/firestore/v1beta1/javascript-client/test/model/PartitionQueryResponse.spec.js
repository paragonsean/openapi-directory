...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudFirestoreApi.PartitionQueryResponse();
  });
  ...
  describe('PartitionQueryResponse', function() {
    it('should create an instance of PartitionQueryResponse', function() {
      // uncomment below and update the code to test PartitionQueryResponse
      //var instance = new CloudFirestoreApi.PartitionQueryResponse();
      //expect(instance).to.be.a(CloudFirestoreApi.PartitionQueryResponse);
    });
