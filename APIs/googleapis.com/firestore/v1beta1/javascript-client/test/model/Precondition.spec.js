...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudFirestoreApi.Precondition();
  });
  ...
  describe('Precondition', function() {
    it('should create an instance of Precondition', function() {
      // uncomment below and update the code to test Precondition
      //var instance = new CloudFirestoreApi.Precondition();
      //expect(instance).to.be.a(CloudFirestoreApi.Precondition);
    });
