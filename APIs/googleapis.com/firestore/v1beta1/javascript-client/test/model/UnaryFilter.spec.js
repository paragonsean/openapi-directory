...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudFirestoreApi.UnaryFilter();
  });
  ...
  describe('UnaryFilter', function() {
    it('should create an instance of UnaryFilter', function() {
      // uncomment below and update the code to test UnaryFilter
      //var instance = new CloudFirestoreApi.UnaryFilter();
      //expect(instance).to.be.a(CloudFirestoreApi.UnaryFilter);
    });
