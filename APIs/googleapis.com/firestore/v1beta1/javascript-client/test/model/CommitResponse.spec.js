...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudFirestoreApi.CommitResponse();
  });
  ...
  describe('CommitResponse', function() {
    it('should create an instance of CommitResponse', function() {
      ...
      //var instance = new CloudFirestoreApi.CommitResponse();
      //expect(instance).to.be.a(CloudFirestoreApi.CommitResponse);
    });
