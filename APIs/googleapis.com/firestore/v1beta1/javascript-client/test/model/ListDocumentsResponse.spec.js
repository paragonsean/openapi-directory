...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudFirestoreApi.ListDocumentsResponse();
  });
  ...
  describe('ListDocumentsResponse', function() {
    it('should create an instance of ListDocumentsResponse', function() {
      // uncomment below and update the code to test ListDocumentsResponse
      //var instance = new CloudFirestoreApi.ListDocumentsResponse();
      //expect(instance).to.be.a(CloudFirestoreApi.ListDocumentsResponse);
    });
