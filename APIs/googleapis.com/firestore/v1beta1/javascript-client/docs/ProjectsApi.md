...
> BatchGetDocumentsResponse firestoreProjectsDatabasesDocumentsBatchGet(database, opts)
...
let database = "database_example"; // String | Required. The database name. In the format: `projects/{project_id}/databases/{database_id}`.
let opts = {
...
apiInstance.firestoreProjectsDatabasesDocumentsBatchGet(database, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> BatchWriteResponse firestoreProjectsDatabasesDocumentsBatchWrite(database, opts)
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'batchWriteRequest': new CloudFirestoreApi.BatchWriteRequest() // BatchWriteRequest | 
};
apiInstance.firestoreProjectsDatabasesDocumentsBatchWrite(database, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> BeginTransactionResponse firestoreProjectsDatabasesDocumentsBeginTransaction(database, opts)
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'beginTransactionRequest': new CloudFirestoreApi.BeginTransactionRequest() // BeginTransactionRequest | 
};
apiInstance.firestoreProjectsDatabasesDocumentsBeginTransaction(database, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> CommitResponse firestoreProjectsDatabasesDocumentsCommit(database, opts)
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'commitRequest': new CloudFirestoreApi.CommitRequest() // CommitRequest | 
};
apiInstance.firestoreProjectsDatabasesDocumentsCommit(database, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Document firestoreProjectsDatabasesDocumentsCreateDocument(parent, collectionId, opts)
...
let apiInstance = new CloudFirestoreApi.ProjectsApi();
let parent = "parent_example"; // String | Required. The parent resource. For example: `projects/{project_id}/databases/{database_id}/documents` or `projects/{project_id}/databases/{database_id}/documents/chatrooms/{chatroom_id}`
let collectionId = "collectionId_example"; // String | Required. The collection ID, relative to `parent`, to list. For example: `chatrooms`.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'documentId': "documentId_example", // String | The client-assigned document ID to use for this document. Optional. If not specified, an ID will be assigned by the service.
  'maskFieldPaths': ["null"], // [String] | The list of field paths in the mask. See Document.fields for a field path syntax reference.
  'document': new CloudFirestoreApi.Document() // Document | 
};
apiInstance.firestoreProjectsDatabasesDocumentsCreateDocument(parent, collectionId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **maskFieldPaths** | [**[String]**](String.md)| The list of field paths in the mask. See Document.fields for a field path syntax reference. | [optional] 
...
> ListCollectionIdsResponse firestoreProjectsDatabasesDocumentsListCollectionIds(parent, opts)
...
let apiInstance = new CloudFirestoreApi.ProjectsApi();
let parent = "parent_example"; // String | Required. The parent document. In the format: `projects/{project_id}/databases/{database_id}/documents/{document_path}`. For example: `projects/my-project/databases/my-database/documents/chatrooms/my-chatroom`
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'listCollectionIdsRequest': new CloudFirestoreApi.ListCollectionIdsRequest() // ListCollectionIdsRequest | 
};
apiInstance.firestoreProjectsDatabasesDocumentsListCollectionIds(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ListDocumentsResponse firestoreProjectsDatabasesDocumentsListDocuments(parent, collectionId, opts)
...
let apiInstance = new CloudFirestoreApi.ProjectsApi();
let parent = "parent_example"; // String | Required. The parent resource name. In the format: `projects/{project_id}/databases/{database_id}/documents` or `projects/{project_id}/databases/{database_id}/documents/{document_path}`. For example: `projects/my-project/databases/my-database/documents` or `projects/my-project/databases/my-database/documents/chatrooms/my-chatroom`
let collectionId = "collectionId_example"; // String | Optional. The collection ID, relative to `parent`, to list. For example: `chatrooms` or `messages`. This is optional, and when not provided, Firestore will list documents from all collections under the provided `parent`.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'maskFieldPaths': ["null"], // [String] | The list of field paths in the mask. See Document.fields for a field path syntax reference.
  'orderBy': "orderBy_example", // String | Optional. The optional ordering of the documents to return. For example: `priority desc, __name__ desc`. This mirrors the `ORDER BY` used in Firestore queries but in a string representation. When absent, documents are ordered based on `__name__ ASC`.
  'pageSize': 56, // Number | Optional. The maximum number of documents to return in a single response. Firestore may return fewer than this value.
  'pageToken': "pageToken_example", // String | Optional. A page token, received from a previous `ListDocuments` response. Provide this to retrieve the subsequent page. When paginating, all other parameters (with the exception of `page_size`) must match the values set in the request that generated the page token.
  'readTime': "readTime_example", // String | Perform the read at the provided time. This must be a microsecond precision timestamp within the past one hour, or if Point-in-Time Recovery is enabled, can additionally be a whole minute timestamp within the past 7 days.
  'showMissing': true, // Boolean | If the list should show missing documents. A document is missing if it does not exist, but there are sub-documents nested underneath it. When true, such missing documents will be returned with a key but will not have fields, `create_time`, or `update_time` set. Requests with `show_missing` may not specify `where` or `order_by`.
  'transaction': "transaction_example" // String | Perform the read as part of an already active transaction.
};
apiInstance.firestoreProjectsDatabasesDocumentsListDocuments(parent, collectionId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **pageSize** | **Number**| Optional. The maximum number of documents to return in a single response. Firestore may return fewer than this value. | [optional] 
...
> ListenResponse firestoreProjectsDatabasesDocumentsListen(database, opts)
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'listenRequest': new CloudFirestoreApi.ListenRequest() // ListenRequest | 
};
apiInstance.firestoreProjectsDatabasesDocumentsListen(database, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> PartitionQueryResponse firestoreProjectsDatabasesDocumentsPartitionQuery(parent, opts)
...
let apiInstance = new CloudFirestoreApi.ProjectsApi();
let parent = "parent_example"; // String | Required. The parent resource name. In the format: `projects/{project_id}/databases/{database_id}/documents`. Document resource names are not supported; only database resource names can be specified.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'partitionQueryRequest': new CloudFirestoreApi.PartitionQueryRequest() // PartitionQueryRequest | 
};
apiInstance.firestoreProjectsDatabasesDocumentsPartitionQuery(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Document firestoreProjectsDatabasesDocumentsPatch(name, opts)
...
let apiInstance = new CloudFirestoreApi.ProjectsApi();
let name = "name_example"; // String | The resource name of the document, for example `projects/{project_id}/databases/{database_id}/documents/{document_path}`.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'currentDocumentExists': true, // Boolean | When set to `true`, the target document must exist. When set to `false`, the target document must not exist.
  'currentDocumentUpdateTime': "currentDocumentUpdateTime_example", // String | When set, the target document must exist and have been last updated at that time. Timestamp must be microsecond aligned.
  'maskFieldPaths': ["null"], // [String] | The list of field paths in the mask. See Document.fields for a field path syntax reference.
  'updateMaskFieldPaths': ["null"], // [String] | The list of field paths in the mask. See Document.fields for a field path syntax reference.
  'document': new CloudFirestoreApi.Document() // Document | 
};
apiInstance.firestoreProjectsDatabasesDocumentsPatch(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **maskFieldPaths** | [**[String]**](String.md)| The list of field paths in the mask. See Document.fields for a field path syntax reference. | [optional] 
 **updateMaskFieldPaths** | [**[String]**](String.md)| The list of field paths in the mask. See Document.fields for a field path syntax reference. | [optional] 
 **document** | [**Document**](Document.md)|  | [optional] 
...
> Object firestoreProjectsDatabasesDocumentsRollback(database, opts)
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'rollbackRequest': new CloudFirestoreApi.RollbackRequest() // RollbackRequest | 
};
apiInstance.firestoreProjectsDatabasesDocumentsRollback(database, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> RunAggregationQueryResponse firestoreProjectsDatabasesDocumentsRunAggregationQuery(parent, opts)
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'runAggregationQueryRequest': new CloudFirestoreApi.RunAggregationQueryRequest() // RunAggregationQueryRequest | 
};
apiInstance.firestoreProjectsDatabasesDocumentsRunAggregationQuery(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> RunQueryResponse firestoreProjectsDatabasesDocumentsRunQuery(parent, opts)
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'runQueryRequest': new CloudFirestoreApi.RunQueryRequest() // RunQueryRequest | 
};
apiInstance.firestoreProjectsDatabasesDocumentsRunQuery(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> WriteResponse firestoreProjectsDatabasesDocumentsWrite(database, opts)
...
let apiInstance = new CloudFirestoreApi.ProjectsApi();
let database = "database_example"; // String | Required. The database name. In the format: `projects/{project_id}/databases/{database_id}`. This is only required in the first message.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'writeRequest': new CloudFirestoreApi.WriteRequest() // WriteRequest | 
};
apiInstance.firestoreProjectsDatabasesDocumentsWrite(database, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'googleFirestoreAdminV1beta1ExportDocumentsRequest': new CloudFirestoreApi.GoogleFirestoreAdminV1beta1ExportDocumentsRequest() // GoogleFirestoreAdminV1beta1ExportDocumentsRequest | 
};
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'googleFirestoreAdminV1beta1ImportDocumentsRequest': new CloudFirestoreApi.GoogleFirestoreAdminV1beta1ImportDocumentsRequest() // GoogleFirestoreAdminV1beta1ImportDocumentsRequest | 
};
...
> GoogleLongrunningOperation firestoreProjectsDatabasesIndexesCreate(parent, opts)
...
let apiInstance = new CloudFirestoreApi.ProjectsApi();
let parent = "parent_example"; // String | The name of the database this index will apply to. For example: `projects/{project_id}/databases/{database_id}`
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'googleFirestoreAdminV1beta1Index': new CloudFirestoreApi.GoogleFirestoreAdminV1beta1Index() // GoogleFirestoreAdminV1beta1Index | 
};
apiInstance.firestoreProjectsDatabasesIndexesCreate(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Object firestoreProjectsDatabasesIndexesDelete(name, opts)
...
let apiInstance = new CloudFirestoreApi.ProjectsApi();
let name = "name_example"; // String | The index name. For example: `projects/{project_id}/databases/{database_id}/indexes/{index_id}`
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
apiInstance.firestoreProjectsDatabasesIndexesDelete(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> GoogleFirestoreAdminV1beta1Index firestoreProjectsDatabasesIndexesGet(name, opts)
...
let apiInstance = new CloudFirestoreApi.ProjectsApi();
let name = "name_example"; // String | The name of the index. For example: `projects/{project_id}/databases/{database_id}/indexes/{index_id}`
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'maskFieldPaths': ["null"], // [String] | The list of field paths in the mask. See Document.fields for a field path syntax reference.
  'readTime': "readTime_example", // String | Reads the version of the document at the given time. This must be a microsecond precision timestamp within the past one hour, or if Point-in-Time Recovery is enabled, can additionally be a whole minute timestamp within the past 7 days.
  'transaction': "transaction_example" // String | Reads the document in a transaction.
};
apiInstance.firestoreProjectsDatabasesIndexesGet(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> GoogleFirestoreAdminV1beta1ListIndexesResponse firestoreProjectsDatabasesIndexesList(parent, opts)
...
let apiInstance = new CloudFirestoreApi.ProjectsApi();
let parent = "parent_example"; // String | The database name. For example: `projects/{project_id}/databases/{database_id}`
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
apiInstance.firestoreProjectsDatabasesIndexesList(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
