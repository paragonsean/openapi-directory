...
from openapi_server.models.google_firestore_admin_v1beta1_export_documents_request import GoogleFirestoreAdminV1beta1ExportDocumentsRequest
from openapi_server.models.google_firestore_admin_v1beta1_import_documents_request import GoogleFirestoreAdminV1beta1ImportDocumentsRequest
from openapi_server.models.google_firestore_admin_v1beta1_index import GoogleFirestoreAdminV1beta1Index
from openapi_server.models.google_firestore_admin_v1beta1_list_indexes_response import GoogleFirestoreAdminV1beta1ListIndexesResponse
...
async def test_firestore_projects_databases_documents_batch_get(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/{database}/documents:batchGet'.format(database='database_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_firestore_projects_databases_documents_batch_write(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/{database}/documents:batchWrite'.format(database='database_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_firestore_projects_databases_documents_begin_transaction(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/{database}/documents:beginTransaction'.format(database='database_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_firestore_projects_databases_documents_commit(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/{database}/documents:commit'.format(database='database_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_firestore_projects_databases_documents_create_document(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/{parent}/{collection_id}'.format(parent='parent_example', collection_id='collection_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_firestore_projects_databases_documents_list_collection_ids(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/{parentlist_collection_id}'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_firestore_projects_databases_documents_listen(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/{database}/documents:listen'.format(database='database_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_firestore_projects_databases_documents_partition_query(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/{parentpartition_quer}'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_firestore_projects_databases_documents_rollback(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/{database}/documents:rollback'.format(database='database_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_firestore_projects_databases_documents_run_aggregation_query(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/{parentrun_aggregation_quer}'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_firestore_projects_databases_documents_run_query(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/{parentrun_quer}'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_firestore_projects_databases_documents_write(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/{database}/documents:write'.format(database='database_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_firestore_projects_databases_export_documents(client):
    ...
    """
    body = {"collectionIds":["collectionIds","collectionIds"],"outputUriPrefix":"outputUriPrefix"}
    params = [('$.xgafv', 'xgafv_example'),
                    ('access_token', 'access_token_example'),
                    ('alt', 'alt_example'),
                    ('callback', 'param_callback_example'),
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/{nameexport_document}'.format(name='name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_firestore_projects_databases_import_documents(client):
    ...
    """
    body = {"inputUriPrefix":"inputUriPrefix","collectionIds":["collectionIds","collectionIds"]}
    params = [('$.xgafv', 'xgafv_example'),
                    ('access_token', 'access_token_example'),
                    ('alt', 'alt_example'),
                    ('callback', 'param_callback_example'),
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/{nameimport_document}'.format(name='name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_firestore_projects_databases_indexes_create(client):
    """Test case for firestore_projects_databases_indexes_create

    
    """
    body = {"name":"name","state":"STATE_UNSPECIFIED","fields":[{"mode":"MODE_UNSPECIFIED","fieldPath":"fieldPath"},{"mode":"MODE_UNSPECIFIED","fieldPath":"fieldPath"}],"collectionId":"collectionId"}
    params = [('$.xgafv', 'xgafv_example'),
                    ('access_token', 'access_token_example'),
                    ('alt', 'alt_example'),
                    ('callback', 'param_callback_example'),
...
async def test_firestore_projects_databases_indexes_delete(client):
...
async def test_firestore_projects_databases_indexes_get(client):
...
async def test_firestore_projects_databases_indexes_list(client):
