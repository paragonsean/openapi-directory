...
public class Filter {
  ...
  public static final String SERIALIZED_NAME_UNARY_FILTER = "unaryFilter";
  @SerializedName(SERIALIZED_NAME_UNARY_FILTER)
  ...
  public Filter fieldFilter(FieldFilter fieldFilter) {
  ...
  public Filter unaryFilter(UnaryFilter unaryFilter) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.compositeFilter, filter.compositeFilter) &&
        Objects.equals(this.fieldFilter, filter.fieldFilter) &&
        Objects.equals(this.unaryFilter, filter.unaryFilter);
  }

  @Override
  public int hashCode() {
    return Objects.hash(compositeFilter, fieldFilter, unaryFilter);
  }
  ...
  public String toString() {
    ...
    sb.append("    unaryFilter: ").append(toIndentedString(unaryFilter)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("fieldFilter") != null && !jsonObj.get("fieldFilter").isJsonNull()) {
        FieldFilter.validateJsonElement(jsonObj.get("fieldFilter"));
      }
      // validate the optional field `unaryFilter`
      if (jsonObj.get("unaryFilter") != null && !jsonObj.get("unaryFilter").isJsonNull()) {
        UnaryFilter.validateJsonElement(jsonObj.get("unaryFilter"));
      }
  }
