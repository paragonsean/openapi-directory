...
> GoogleFirestoreAdminV1beta2ListFieldsResponse firestoreProjectsDatabasesCollectionGroupsFieldsList(parent, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, filter, pageSize, pageToken)
...
<a id="firestoreProjectsDatabasesCollectionGroupsFieldsPatch"></a>
# **firestoreProjectsDatabasesCollectionGroupsFieldsPatch**
> GoogleLongrunningOperation firestoreProjectsDatabasesCollectionGroupsFieldsPatch(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, updateMask, googleFirestoreAdminV1beta2Field)
...
public class Example {
  public static void main(String[] args) {
    ...
    String uploadProtocol = "uploadProtocol_example"; // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
    String uploadType = "uploadType_example"; // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
    String updateMask = "updateMask_example"; // String | A mask, relative to the field. If specified, only configuration specified by this field_mask will be updated in the field.
    GoogleFirestoreAdminV1beta2Field googleFirestoreAdminV1beta2Field = new GoogleFirestoreAdminV1beta2Field(); // GoogleFirestoreAdminV1beta2Field | 
    try {
      GoogleLongrunningOperation result = apiInstance.firestoreProjectsDatabasesCollectionGroupsFieldsPatch(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, updateMask, googleFirestoreAdminV1beta2Field);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProjectsApi#firestoreProjectsDatabasesCollectionGroupsFieldsPatch");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
> GoogleLongrunningOperation firestoreProjectsDatabasesCollectionGroupsIndexesCreate(parent, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, googleFirestoreAdminV1beta2Index)
...
public class Example {
  public static void main(String[] args) {
    ...
    String uploadProtocol = "uploadProtocol_example"; // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
    String uploadType = "uploadType_example"; // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
    GoogleFirestoreAdminV1beta2Index googleFirestoreAdminV1beta2Index = new GoogleFirestoreAdminV1beta2Index(); // GoogleFirestoreAdminV1beta2Index | 
    try {
      GoogleLongrunningOperation result = apiInstance.firestoreProjectsDatabasesCollectionGroupsIndexesCreate(parent, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, googleFirestoreAdminV1beta2Index);
      System.out.println(result);
    } catch (ApiException e) {
...
<a id="firestoreProjectsDatabasesCollectionGroupsIndexesDelete"></a>
# **firestoreProjectsDatabasesCollectionGroupsIndexesDelete**
> Object firestoreProjectsDatabasesCollectionGroupsIndexesDelete(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType)
...
public class Example {
  public static void main(String[] args) {
    ...
    ProjectsApi apiInstance = new ProjectsApi(defaultClient);
    String name = "name_example"; // String | A name of the form `projects/{project_id}/databases/{database_id}/collectionGroups/{collection_id}/indexes/{index_id}`
    String $xgafv = "1"; // String | V1 error format.
    String accessToken = "accessToken_example"; // String | OAuth access token.
    String alt = "json"; // String | Data format for response.
    String paramCallback = "paramCallback_example"; // String | JSONP
    ...
    String uploadType = "uploadType_example"; // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
    try {
      Object result = apiInstance.firestoreProjectsDatabasesCollectionGroupsIndexesDelete(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProjectsApi#firestoreProjectsDatabasesCollectionGroupsIndexesDelete");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="firestoreProjectsDatabasesCollectionGroupsIndexesGet"></a>
# **firestoreProjectsDatabasesCollectionGroupsIndexesGet**
> GoogleFirestoreAdminV1beta2Index firestoreProjectsDatabasesCollectionGroupsIndexesGet(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType)
...
public class Example {
  public static void main(String[] args) {
    ...
    String uploadType = "uploadType_example"; // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
    try {
      GoogleFirestoreAdminV1beta2Index result = apiInstance.firestoreProjectsDatabasesCollectionGroupsIndexesGet(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProjectsApi#firestoreProjectsDatabasesCollectionGroupsIndexesGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
> GoogleFirestoreAdminV1beta2ListIndexesResponse firestoreProjectsDatabasesCollectionGroupsIndexesList(parent, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, filter, pageSize, pageToken)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      GoogleFirestoreAdminV1beta2ListIndexesResponse result = apiInstance.firestoreProjectsDatabasesCollectionGroupsIndexesList(parent, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, filter, pageSize, pageToken);
      System.out.println(result);
    } catch (ApiException e) {
...
> GoogleLongrunningOperation firestoreProjectsDatabasesExportDocuments(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, googleFirestoreAdminV1beta2ExportDocumentsRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    String uploadProtocol = "uploadProtocol_example"; // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
    String uploadType = "uploadType_example"; // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
    GoogleFirestoreAdminV1beta2ExportDocumentsRequest googleFirestoreAdminV1beta2ExportDocumentsRequest = new GoogleFirestoreAdminV1beta2ExportDocumentsRequest(); // GoogleFirestoreAdminV1beta2ExportDocumentsRequest | 
    try {
      GoogleLongrunningOperation result = apiInstance.firestoreProjectsDatabasesExportDocuments(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, googleFirestoreAdminV1beta2ExportDocumentsRequest);
      System.out.println(result);
    } catch (ApiException e) {
...
> GoogleLongrunningOperation firestoreProjectsDatabasesImportDocuments(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, googleFirestoreAdminV1beta2ImportDocumentsRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    String uploadProtocol = "uploadProtocol_example"; // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
    String uploadType = "uploadType_example"; // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
    GoogleFirestoreAdminV1beta2ImportDocumentsRequest googleFirestoreAdminV1beta2ImportDocumentsRequest = new GoogleFirestoreAdminV1beta2ImportDocumentsRequest(); // GoogleFirestoreAdminV1beta2ImportDocumentsRequest | 
    try {
      GoogleLongrunningOperation result = apiInstance.firestoreProjectsDatabasesImportDocuments(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, googleFirestoreAdminV1beta2ImportDocumentsRequest);
      System.out.println(result);
    } catch (ApiException e) {
