...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CertificateAuthorityApi.ListLocationsResponse();
  });
  ...
  describe('ListLocationsResponse', function() {
    it('should create an instance of ListLocationsResponse', function() {
      ...
      //var instance = new CertificateAuthorityApi.ListLocationsResponse();
      //expect(instance).to.be.a(CertificateAuthorityApi.ListLocationsResponse);
    });
