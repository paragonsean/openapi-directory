# CertificateAuthorityApi.ProjectsApi
...
> ListLocationsResponse privatecaProjectsLocationsList(name, opts)
...
```javascript
import CertificateAuthorityApi from 'certificate_authority_api';
let defaultClient = CertificateAuthorityApi.ApiClient.instance;
...
let apiInstance = new CertificateAuthorityApi.ProjectsApi();
...
apiInstance.privatecaProjectsLocationsList(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> Object privatecaProjectsLocationsOperationsCancel(name, opts)
...
apiInstance.privatecaProjectsLocationsOperationsCancel(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Object privatecaProjectsLocationsOperationsDelete(name, opts)
...
apiInstance.privatecaProjectsLocationsOperationsDelete(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Operation privatecaProjectsLocationsOperationsGet(name, opts)
...
apiInstance.privatecaProjectsLocationsOperationsGet(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ListOperationsResponse privatecaProjectsLocationsOperationsList(name, opts)
...
apiInstance.privatecaProjectsLocationsOperationsList(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Policy privatecaProjectsLocationsReusableConfigsGetIamPolicy(resource, opts)
...
apiInstance.privatecaProjectsLocationsReusableConfigsGetIamPolicy(resource, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Policy privatecaProjectsLocationsReusableConfigsSetIamPolicy(resource, opts)
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'setIamPolicyRequest': new CertificateAuthorityApi.SetIamPolicyRequest() // SetIamPolicyRequest | 
};
apiInstance.privatecaProjectsLocationsReusableConfigsSetIamPolicy(resource, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> TestIamPermissionsResponse privatecaProjectsLocationsReusableConfigsTestIamPermissions(resource, opts)
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'testIamPermissionsRequest': new CertificateAuthorityApi.TestIamPermissionsRequest() // TestIamPermissionsRequest | 
};
apiInstance.privatecaProjectsLocationsReusableConfigsTestIamPermissions(resource, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
