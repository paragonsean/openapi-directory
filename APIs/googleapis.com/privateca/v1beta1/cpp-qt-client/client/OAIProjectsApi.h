...
public:
    ...
    */
    virtual void privateca_projects_locations_reusableConfigs_setIamPolicy(const QString &resource, const ::OpenAPI::OptionalParam<QString> &_xgafv = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &access_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &alt = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &callback = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &fields = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &key = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &oauth_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &pretty_print = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &quota_user = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &upload_protocol = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &upload_type = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAISetIamPolicyRequest> &oai_set_iam_policy_request = ::OpenAPI::OptionalParam<OAISetIamPolicyRequest>());
    ...
    */
    virtual void privateca_projects_locations_reusableConfigs_testIamPermissions(const QString &resource, const ::OpenAPI::OptionalParam<QString> &_xgafv = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &access_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &alt = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &callback = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &fields = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &key = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &oauth_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &pretty_print = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &quota_user = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &upload_protocol = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &upload_type = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAITestIamPermissionsRequest> &oai_test_iam_permissions_request = ::OpenAPI::OptionalParam<OAITestIamPermissionsRequest>());
...
private:
    ...
    void privateca_projects_locations_reusableConfigs_getIamPolicyCallback(OAIHttpRequestWorker *worker);
    void privateca_projects_locations_reusableConfigs_setIamPolicyCallback(OAIHttpRequestWorker *worker);
    void privateca_projects_locations_reusableConfigs_testIamPermissionsCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void privateca_projects_locations_reusableConfigs_getIamPolicySignal(OAIPolicy summary);
    void privateca_projects_locations_reusableConfigs_setIamPolicySignal(OAIPolicy summary);
    void privateca_projects_locations_reusableConfigs_testIamPermissionsSignal(OAITestIamPermissionsResponse summary);
    ...
    void privateca_projects_locations_reusableConfigs_getIamPolicySignalFull(OAIHttpRequestWorker *worker, OAIPolicy summary);
    void privateca_projects_locations_reusableConfigs_setIamPolicySignalFull(OAIHttpRequestWorker *worker, OAIPolicy summary);
    void privateca_projects_locations_reusableConfigs_testIamPermissionsSignalFull(OAIHttpRequestWorker *worker, OAITestIamPermissionsResponse summary);
    ...
    Q_DECL_DEPRECATED_X("Use privateca_projects_locations_reusableConfigs_getIamPolicySignalError() instead")
    void privateca_projects_locations_reusableConfigs_getIamPolicySignalE(OAIPolicy summary, QNetworkReply::NetworkError error_type, QString error_str);
    void privateca_projects_locations_reusableConfigs_getIamPolicySignalError(OAIPolicy summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use privateca_projects_locations_reusableConfigs_setIamPolicySignalError() instead")
    void privateca_projects_locations_reusableConfigs_setIamPolicySignalE(OAIPolicy summary, QNetworkReply::NetworkError error_type, QString error_str);
    void privateca_projects_locations_reusableConfigs_setIamPolicySignalError(OAIPolicy summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use privateca_projects_locations_reusableConfigs_testIamPermissionsSignalError() instead")
    void privateca_projects_locations_reusableConfigs_testIamPermissionsSignalE(OAITestIamPermissionsResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void privateca_projects_locations_reusableConfigs_testIamPermissionsSignalError(OAITestIamPermissionsResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use privateca_projects_locations_reusableConfigs_getIamPolicySignalErrorFull() instead")
    void privateca_projects_locations_reusableConfigs_getIamPolicySignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void privateca_projects_locations_reusableConfigs_getIamPolicySignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use privateca_projects_locations_reusableConfigs_setIamPolicySignalErrorFull() instead")
    void privateca_projects_locations_reusableConfigs_setIamPolicySignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void privateca_projects_locations_reusableConfigs_setIamPolicySignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use privateca_projects_locations_reusableConfigs_testIamPermissionsSignalErrorFull() instead")
    void privateca_projects_locations_reusableConfigs_testIamPermissionsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void privateca_projects_locations_reusableConfigs_testIamPermissionsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
