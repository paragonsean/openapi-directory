...
async def test_privateca_projects_locations_reusable_configs_get_iam_policy(client):
...
async def test_privateca_projects_locations_reusable_configs_set_iam_policy(client):
...
async def test_privateca_projects_locations_reusable_configs_test_iam_permissions(client):
