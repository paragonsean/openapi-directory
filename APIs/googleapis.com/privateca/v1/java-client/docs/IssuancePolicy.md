...
|**allowedKeyTypes** | [**List&lt;AllowedKeyType&gt;**](AllowedKeyType.md) | Optional. If any AllowedKeyType is specified, then the certificate request&#39;s public key must match one of the key types listed here. Otherwise, any key may be used. |  [optional] |
