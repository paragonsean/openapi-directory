...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CertificateAuthorityApi.ListCertificatesResponse();
  });
  ...
  describe('ListCertificatesResponse', function() {
    it('should create an instance of ListCertificatesResponse', function() {
      ...
      //var instance = new CertificateAuthorityApi.ListCertificatesResponse();
      //expect(instance).to.be.a(CertificateAuthorityApi.ListCertificatesResponse);
    });
