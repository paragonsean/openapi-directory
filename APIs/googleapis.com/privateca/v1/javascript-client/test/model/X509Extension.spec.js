...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CertificateAuthorityApi.X509Extension();
  });
  ...
  describe('X509Extension', function() {
    it('should create an instance of X509Extension', function() {
      // uncomment below and update the code to test X509Extension
      //var instance = new CertificateAuthorityApi.X509Extension();
      //expect(instance).to.be.a(CertificateAuthorityApi.X509Extension);
    });
