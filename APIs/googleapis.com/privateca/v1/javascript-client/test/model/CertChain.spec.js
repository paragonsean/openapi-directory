...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CertificateAuthorityApi.CertChain();
  });
  ...
  describe('CertChain', function() {
    it('should create an instance of CertChain', function() {
      ...
      //var instance = new CertificateAuthorityApi.CertChain();
      //expect(instance).to.be.a(CertificateAuthorityApi.CertChain);
    });
