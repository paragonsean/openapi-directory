# CertificateAuthorityApi.Certificate
...
**pemCertificateChain** | **[String]** | Output only. The chain that may be used to verify the X.509 certificate. Expected to be in issuer-to-root order according to RFC 5246. | [optional] [readonly] 
...
**subjectMode** | **String** | Immutable. Specifies how the Certificate&#39;s identity fields are to be decided. If this is omitted, the &#x60;DEFAULT&#x60; subject mode will be used. | [optional] 
...
* `SUBJECT_REQUEST_MODE_UNSPECIFIED` (value: `"SUBJECT_REQUEST_MODE_UNSPECIFIED"`)

* `DEFAULT` (value: `"DEFAULT"`)

* `REFLECTED_SPIFFE` (value: `"REFLECTED_SPIFFE"`)
