    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('rules')) {
                obj['rules'] = ApiClient.convertToType(data['rules'], [HttpRouteRouteRule]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['rules']) { // data not null
            ...
            for (const item of data['rules']) {
                HttpRouteRouteRule.validateJSON(item);
            };
        }
        // ensure the json data is a string
 ...
 */
HttpRoute.prototype['createTime'] = undefined;

/**
 * Optional. A free-text description of the resource. Max length 1024 characters.
 * @member {String} description
 */
HttpRoute.prototype['description'] = undefined;
 ...
 */
HttpRoute.prototype['gateways'] = undefined;
 ...
 */
HttpRoute.prototype['hostnames'] = undefined;

/**
 * Optional. Set of label tags associated with the HttpRoute resource.
 * @member {Object.<String, String>} labels
 */
HttpRoute.prototype['labels'] = undefined;
 ...
 * @member {Array.<module:model/HttpRouteRouteRule>} rules
 */
HttpRoute.prototype['rules'] = undefined;

/**
 * Output only. Server-defined URL of this resource
 * @member {String} selfLink
 */
HttpRoute.prototype['selfLink'] = undefined;

/**
 * Output only. The timestamp when the resource was updated.
 * @member {String} updateTime
 */
HttpRoute.prototype['updateTime'] = undefined;
