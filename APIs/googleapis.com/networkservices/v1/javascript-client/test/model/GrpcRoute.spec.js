...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkServicesApi.GrpcRoute();
  });
  ...
  describe('GrpcRoute', function() {
    it('should create an instance of GrpcRoute', function() {
      // uncomment below and update the code to test GrpcRoute
      //var instance = new NetworkServicesApi.GrpcRoute();
      //expect(instance).to.be.a(NetworkServicesApi.GrpcRoute);
    });
