...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkServicesApi.Mesh();
  });
  ...
  describe('Mesh', function() {
    it('should create an instance of Mesh', function() {
      // uncomment below and update the code to test Mesh
      //var instance = new NetworkServicesApi.Mesh();
      //expect(instance).to.be.a(NetworkServicesApi.Mesh);
    });
    ...
    it('should have the property interceptionPort (base name: "interceptionPort")', function() {
      // uncomment below and update the code to test the property interceptionPort
      //var instance = new NetworkServicesApi.Mesh();
      //expect(instance).to.be();
    });
