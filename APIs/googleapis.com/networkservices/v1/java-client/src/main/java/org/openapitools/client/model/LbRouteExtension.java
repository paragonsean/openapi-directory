...
public class LbRouteExtension {
  ...
  public LbRouteExtension description(String description) {
  ...
  public LbRouteExtension extensionChains(List<ExtensionChain> extensionChains) {
    this.extensionChains = extensionChains;
    return this;
  }

  public LbRouteExtension addExtensionChainsItem(ExtensionChain extensionChainsItem) {
  ...
  public LbRouteExtension forwardingRules(List<String> forwardingRules) {
    this.forwardingRules = forwardingRules;
    return this;
  }

  public LbRouteExtension addForwardingRulesItem(String forwardingRulesItem) {
  ...
  public LbRouteExtension labels(Map<String, String> labels) {
    this.labels = labels;
    return this;
  }

  public LbRouteExtension putLabelsItem(String key, String labelsItem) {
    if (this.labels == null) {
  ...
  public LbRouteExtension loadBalancingScheme(LoadBalancingSchemeEnum loadBalancingScheme) {
  ...
  public LbRouteExtension name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    LbRouteExtension lbRouteExtension = (LbRouteExtension) o;
    return Objects.equals(this.createTime, lbRouteExtension.createTime) &&
        Objects.equals(this.description, lbRouteExtension.description) &&
        Objects.equals(this.extensionChains, lbRouteExtension.extensionChains) &&
        Objects.equals(this.forwardingRules, lbRouteExtension.forwardingRules) &&
        Objects.equals(this.labels, lbRouteExtension.labels) &&
        Objects.equals(this.loadBalancingScheme, lbRouteExtension.loadBalancingScheme) &&
        Objects.equals(this.name, lbRouteExtension.name) &&
        Objects.equals(this.updateTime, lbRouteExtension.updateTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class LbRouteExtension {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LbRouteExtension
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LbRouteExtension.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LbRouteExtension is not found in the empty JSON string", LbRouteExtension.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LbRouteExtension.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LbRouteExtension` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LbRouteExtension.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LbRouteExtension' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LbRouteExtension> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LbRouteExtension.class));

       return (TypeAdapter<T>) new TypeAdapter<LbRouteExtension>() {
           @Override
           public void write(JsonWriter out, LbRouteExtension value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LbRouteExtension read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LbRouteExtension given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LbRouteExtension
   * @throws IOException if the JSON string is invalid with respect to LbRouteExtension
   */
  public static LbRouteExtension fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LbRouteExtension.class);
  }

  /**
   * Convert an instance of LbRouteExtension to an JSON string
   *
   * @return JSON string
   */
