...
|------------ | ------------- | ------------- | -------------|
|**serviceName** | **String** | Required. The URL of a destination service to which to route traffic. Must refer to either a BackendService or ServiceDirectoryService. |  [optional] |
