...
|------------ | ------------- | ------------- | -------------|
|**numRetries** | **Integer** | Specifies the allowed number of retries. This number must be &gt; 0. If not specified, default to 1. |  [optional] |
|**perTryTimeout** | **String** | Specifies a non-zero timeout per retry attempt. |  [optional] |
