...
|**forwardHeaders** | **List&lt;String&gt;** | Optional. List of the HTTP headers to forward to the extension (from the client or backend). If omitted, all headers are sent. Each element is a string indicating the header name. |  [optional] |
...
|**supportedEvents** | [**List&lt;SupportedEventsEnum&gt;**](#List&lt;SupportedEventsEnum&gt;) | Optional. A set of events during request or response processing for which this extension is called. This field is required for the &#x60;LbTrafficExtension&#x60; resource. It&#39;s not relevant for the &#x60;LbRouteExtension&#x60; resource. |  [optional] |
