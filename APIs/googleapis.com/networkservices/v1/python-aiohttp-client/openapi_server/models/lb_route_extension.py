...
class LbRouteExtension(Model):
    ...
    def __init__(self, create_time: str=None, description: str=None, extension_chains: List[ExtensionChain]=None, forwarding_rules: List[str]=None, labels: Dict[str, str]=None, load_balancing_scheme: str=None, name: str=None, update_time: str=None):
        """LbRouteExtension - a model defined in OpenAPI

        :param create_time: The create_time of this LbRouteExtension.
        :param description: The description of this LbRouteExtension.
        :param extension_chains: The extension_chains of this LbRouteExtension.
        :param forwarding_rules: The forwarding_rules of this LbRouteExtension.
        :param labels: The labels of this LbRouteExtension.
        :param load_balancing_scheme: The load_balancing_scheme of this LbRouteExtension.
        :param name: The name of this LbRouteExtension.
        :param update_time: The update_time of this LbRouteExtension.
        """
        self.openapi_types = {
            'create_time': str,
            'description': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'LbRouteExtension':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The LbRouteExtension of this LbRouteExtension.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def create_time(self):
        """Gets the create_time of this LbRouteExtension.

        Output only. The timestamp when the resource was created.

        :return: The create_time of this LbRouteExtension.
        :rtype: str
        """
    ...
    def create_time(self, create_time):
        """Sets the create_time of this LbRouteExtension.
    ...
    def description(self):
        """Gets the description of this LbRouteExtension.

        Optional. A human-readable description of the resource.

        :return: The description of this LbRouteExtension.
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this LbRouteExtension.
    ...
    def extension_chains(self):
        """Gets the extension_chains of this LbRouteExtension.

        Required. A set of ordered extension chains that contain the match conditions and extensions to execute. Match conditions for each extension chain are evaluated in sequence for a given request. The first extension chain that has a condition that matches the request is executed. Any subsequent extension chains do not execute. Limited to 5 extension chains per resource.

        :return: The extension_chains of this LbRouteExtension.
    ...
    def extension_chains(self, extension_chains):
        """Sets the extension_chains of this LbRouteExtension.
    ...
    def forwarding_rules(self):
        """Gets the forwarding_rules of this LbRouteExtension.
        ...
        :return: The forwarding_rules of this LbRouteExtension.
        :rtype: List[str]
        """
    ...
    def forwarding_rules(self, forwarding_rules):
        """Sets the forwarding_rules of this LbRouteExtension.
    ...
    @property
    def labels(self):
        """Gets the labels of this LbRouteExtension.
        ...
        :return: The labels of this LbRouteExtension.
        :rtype: Dict[str, str]
        """
        return self._labels
    ...
    def labels(self, labels):
        """Sets the labels of this LbRouteExtension.
    ...
    def load_balancing_scheme(self):
        """Gets the load_balancing_scheme of this LbRouteExtension.
        ...
        :return: The load_balancing_scheme of this LbRouteExtension.
        :rtype: str
        """
    ...
    def load_balancing_scheme(self, load_balancing_scheme):
        """Sets the load_balancing_scheme of this LbRouteExtension.
    ...
    @property
    def name(self):
        """Gets the name of this LbRouteExtension.
        ...
        :return: The name of this LbRouteExtension.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this LbRouteExtension.
    ...
    def update_time(self):
        """Gets the update_time of this LbRouteExtension.

        Output only. The timestamp when the resource was updated.

        :return: The update_time of this LbRouteExtension.
        :rtype: str
        """
    ...
    def update_time(self, update_time):
        """Sets the update_time of this LbRouteExtension.
