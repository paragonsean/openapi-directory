...
public:
    ...
    QList<OAIHttpRouteRouteRule> getRules() const;
    void setRules(const QList<OAIHttpRouteRouteRule> &rules);
...
private:
    ...
    QList<OAIHttpRouteRouteRule> m_rules;
    bool m_rules_isSet;
