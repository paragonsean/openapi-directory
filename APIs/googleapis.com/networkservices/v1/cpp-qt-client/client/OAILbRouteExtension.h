...
class OAILbRouteExtension : public OAIObject {
public:
    OAILbRouteExtension();
    OAILbRouteExtension(QString json);
    ~OAILbRouteExtension() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILbRouteExtension)

#endif // OAILbRouteExtension_H
