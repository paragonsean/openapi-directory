# NetworkServicesApi.TlsRouteRouteAction

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**destinations** | [**[TlsRouteRouteDestination]**](TlsRouteRouteDestination.md) | Required. The destination services to which traffic should be forwarded. At least one destination service is required. | [optional] 
