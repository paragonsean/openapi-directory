# NetworkServicesApi.EndpointPolicy
...
**labels** | **{String: String}** | Optional. Set of label tags associated with the EndpointPolicy resource. | [optional] 
...
**type** | **String** | Required. The type of endpoint policy. This is primarily used to validate the configuration. | [optional] 
...
* `ENDPOINT_POLICY_TYPE_UNSPECIFIED` (value: `"ENDPOINT_POLICY_TYPE_UNSPECIFIED"`)

* `SIDECAR_PROXY` (value: `"SIDECAR_PROXY"`)

* `GRPC_SERVER` (value: `"GRPC_SERVER"`)
