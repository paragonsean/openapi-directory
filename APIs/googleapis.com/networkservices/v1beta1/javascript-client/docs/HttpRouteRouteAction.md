# NetworkServicesApi.HttpRouteRouteAction
...
**destinations** | [**[HttpRouteDestination]**](HttpRouteDestination.md) | The destination to which traffic should be forwarded. | [optional] 
