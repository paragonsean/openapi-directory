...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkServicesApi.ServiceBinding();
  });
  ...
  describe('ServiceBinding', function() {
    it('should create an instance of ServiceBinding', function() {
      // uncomment below and update the code to test ServiceBinding
      //var instance = new NetworkServicesApi.ServiceBinding();
      //expect(instance).to.be.a(NetworkServicesApi.ServiceBinding);
    });
