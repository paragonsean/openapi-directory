...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkServicesApi.TlsRoute();
  });
  ...
  describe('TlsRoute', function() {
    it('should create an instance of TlsRoute', function() {
      // uncomment below and update the code to test TlsRoute
      //var instance = new NetworkServicesApi.TlsRoute();
      //expect(instance).to.be.a(NetworkServicesApi.TlsRoute);
    });
