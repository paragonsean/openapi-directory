...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkServicesApi.TcpRoute();
  });
  ...
  describe('TcpRoute', function() {
    it('should create an instance of TcpRoute', function() {
      // uncomment below and update the code to test TcpRoute
      //var instance = new NetworkServicesApi.TcpRoute();
      //expect(instance).to.be.a(NetworkServicesApi.TcpRoute);
    });
