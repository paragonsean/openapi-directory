...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkServicesApi.ListLocationsResponse();
  });
  ...
  describe('ListLocationsResponse', function() {
    it('should create an instance of ListLocationsResponse', function() {
      ...
      //var instance = new NetworkServicesApi.ListLocationsResponse();
      //expect(instance).to.be.a(NetworkServicesApi.ListLocationsResponse);
    });
