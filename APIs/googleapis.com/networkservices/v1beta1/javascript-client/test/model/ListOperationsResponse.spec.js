...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkServicesApi.ListOperationsResponse();
  });
  ...
  describe('ListOperationsResponse', function() {
    it('should create an instance of ListOperationsResponse', function() {
      ...
      //var instance = new NetworkServicesApi.ListOperationsResponse();
      //expect(instance).to.be.a(NetworkServicesApi.ListOperationsResponse);
    });
