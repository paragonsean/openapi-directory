...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkServicesApi.TlsRouteRouteAction();
  });
  ...
  describe('TlsRouteRouteAction', function() {
    it('should create an instance of TlsRouteRouteAction', function() {
      // uncomment below and update the code to test TlsRouteRouteAction
      //var instance = new NetworkServicesApi.TlsRouteRouteAction();
      //expect(instance).to.be.a(NetworkServicesApi.TlsRouteRouteAction);
    });
