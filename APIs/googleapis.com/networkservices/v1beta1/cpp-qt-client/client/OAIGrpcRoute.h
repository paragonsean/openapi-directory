...
public:
    ...
    QList<OAIGrpcRouteRouteRule> getRules() const;
    void setRules(const QList<OAIGrpcRouteRouteRule> &rules);
...
private:
    ...
    QList<OAIGrpcRouteRouteRule> m_rules;
    bool m_rules_isSet;
