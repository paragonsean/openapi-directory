...
class OAIMesh : public OAIObject {
public:
    OAIMesh();
    OAIMesh(QString json);
    ~OAIMesh() override;
    ...
    qint32 getInterceptionPort() const;
    void setInterceptionPort(const qint32 &interception_port);
    bool is_interception_port_Set() const;
    bool is_interception_port_Valid() const;
...
private:
    ...
    qint32 m_interception_port;
    bool m_interception_port_isSet;
    bool m_interception_port_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMesh)
