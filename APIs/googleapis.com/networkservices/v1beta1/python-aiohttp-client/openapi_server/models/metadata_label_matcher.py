...
class MetadataLabelMatcher(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, metadata_label_match_criteria: str=None, metadata_labels: List[MetadataLabels]=None):
        """MetadataLabelMatcher - a model defined in OpenAPI

        :param metadata_label_match_criteria: The metadata_label_match_criteria of this MetadataLabelMatcher.
        :param metadata_labels: The metadata_labels of this MetadataLabelMatcher.
        """
        self.openapi_types = {
            'metadata_label_match_criteria': str,
            'metadata_labels': List[MetadataLabels]
        }
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'MetadataLabelMatcher':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The MetadataLabelMatcher of this MetadataLabelMatcher.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def metadata_label_match_criteria(self):
        """Gets the metadata_label_match_criteria of this MetadataLabelMatcher.
        ...
        :return: The metadata_label_match_criteria of this MetadataLabelMatcher.
        :rtype: str
        """
    ...
    def metadata_label_match_criteria(self, metadata_label_match_criteria):
        """Sets the metadata_label_match_criteria of this MetadataLabelMatcher.
    ...
    def metadata_labels(self):
        """Gets the metadata_labels of this MetadataLabelMatcher.

        The list of label value pairs that must match labels in the provided metadata based on filterMatchCriteria This list can have at most 64 entries. The list can be empty if the match criteria is MATCH_ANY, to specify a wildcard match (i.e this matches any client).

        :return: The metadata_labels of this MetadataLabelMatcher.
        :rtype: List[MetadataLabels]
        """
        return self._metadata_labels

    @metadata_labels.setter
    def metadata_labels(self, metadata_labels):
        """Sets the metadata_labels of this MetadataLabelMatcher.

        The list of label value pairs that must match labels in the provided metadata based on filterMatchCriteria This list can have at most 64 entries. The list can be empty if the match criteria is MATCH_ANY, to specify a wildcard match (i.e this matches any client).

        :param metadata_labels: The metadata_labels of this MetadataLabelMatcher.
        :type metadata_labels: List[MetadataLabels]
        """
