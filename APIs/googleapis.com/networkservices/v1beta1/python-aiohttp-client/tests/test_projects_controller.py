...
async def test_networkservices_projects_locations_endpoint_policies_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/{parent}/endpointPolicies'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_networkservices_projects_locations_gateways_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/{parent}/gateways'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_networkservices_projects_locations_grpc_routes_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/{parent}/grpcRoutes'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_networkservices_projects_locations_http_routes_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/{parent}/httpRoutes'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_networkservices_projects_locations_lb_route_extensions_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/{parent}/lbRouteExtensions'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_networkservices_projects_locations_lb_traffic_extensions_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/{parent}/lbTrafficExtensions'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_networkservices_projects_locations_meshes_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/{parent}/meshes'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_networkservices_projects_locations_service_bindings_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/{parent}/serviceBindings'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_networkservices_projects_locations_service_lb_policies_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/{parent}/serviceLbPolicies'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_networkservices_projects_locations_tcp_routes_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/{parent}/tcpRoutes'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_networkservices_projects_locations_tls_routes_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/{parent}/tlsRoutes'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
