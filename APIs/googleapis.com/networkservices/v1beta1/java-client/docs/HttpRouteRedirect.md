...
|**portRedirect** | **Integer** | The port that will be used in the redirected request instead of the one that was supplied in the request. |  [optional] |
...
|**responseCode** | [**ResponseCodeEnum**](#ResponseCodeEnum) | The HTTP Status code to use for the redirect. |  [optional] |
