...
public class MetadataLabelMatcher {
  ...
  private List<MetadataLabels> metadataLabels = new ArrayList<>();

  public MetadataLabelMatcher() {
  }

  public MetadataLabelMatcher metadataLabelMatchCriteria(MetadataLabelMatchCriteriaEnum metadataLabelMatchCriteria) {
  ...
  public MetadataLabelMatcher metadataLabels(List<MetadataLabels> metadataLabels) {
    this.metadataLabels = metadataLabels;
    return this;
  }

  public MetadataLabelMatcher addMetadataLabelsItem(MetadataLabels metadataLabelsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<MetadataLabels> getMetadataLabels() {
    return metadataLabels;
  }

  public void setMetadataLabels(List<MetadataLabels> metadataLabels) {
    this.metadataLabels = metadataLabels;
  }
  ...
  public boolean equals(Object o) {
    ...
    MetadataLabelMatcher metadataLabelMatcher = (MetadataLabelMatcher) o;
    return Objects.equals(this.metadataLabelMatchCriteria, metadataLabelMatcher.metadataLabelMatchCriteria) &&
        Objects.equals(this.metadataLabels, metadataLabelMatcher.metadataLabels);
  }
  ...
  public String toString() {
    ...
    sb.append("class MetadataLabelMatcher {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MetadataLabelMatcher
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MetadataLabelMatcher.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MetadataLabelMatcher is not found in the empty JSON string", MetadataLabelMatcher.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MetadataLabelMatcher.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MetadataLabelMatcher` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("metadataLabels") != null && !jsonObj.get("metadataLabels").isJsonNull()) {
        ...
        if (jsonArraymetadataLabels != null) {
          ...
          for (int i = 0; i < jsonArraymetadataLabels.size(); i++) {
            MetadataLabels.validateJsonElement(jsonArraymetadataLabels.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MetadataLabelMatcher.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MetadataLabelMatcher' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MetadataLabelMatcher> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MetadataLabelMatcher.class));

       return (TypeAdapter<T>) new TypeAdapter<MetadataLabelMatcher>() {
           @Override
           public void write(JsonWriter out, MetadataLabelMatcher value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MetadataLabelMatcher read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MetadataLabelMatcher given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MetadataLabelMatcher
   * @throws IOException if the JSON string is invalid with respect to MetadataLabelMatcher
   */
  public static MetadataLabelMatcher fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MetadataLabelMatcher.class);
  }

  /**
   * Convert an instance of MetadataLabelMatcher to an JSON string
   *
   * @return JSON string
   */
