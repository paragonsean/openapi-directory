...
class DatabaseResourceHealthSignalData(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, additional_metadata: Dict[str, object]=None, compliance: List[Compliance]=None, description: str=None, event_time: str=None, external_uri: str=None, name: str=None, provider: str=None, resource_container: str=None, resource_name: str=None, signal_class: str=None, signal_id: str=None, signal_type: str=None, state: str=None):
        """DatabaseResourceHealthSignalData - a model defined in OpenAPI

        :param additional_metadata: The additional_metadata of this DatabaseResourceHealthSignalData.
        :param compliance: The compliance of this DatabaseResourceHealthSignalData.
        :param description: The description of this DatabaseResourceHealthSignalData.
        :param event_time: The event_time of this DatabaseResourceHealthSignalData.
        :param external_uri: The external_uri of this DatabaseResourceHealthSignalData.
        :param name: The name of this DatabaseResourceHealthSignalData.
        :param provider: The provider of this DatabaseResourceHealthSignalData.
        :param resource_container: The resource_container of this DatabaseResourceHealthSignalData.
        :param resource_name: The resource_name of this DatabaseResourceHealthSignalData.
        :param signal_class: The signal_class of this DatabaseResourceHealthSignalData.
        :param signal_id: The signal_id of this DatabaseResourceHealthSignalData.
        :param signal_type: The signal_type of this DatabaseResourceHealthSignalData.
        :param state: The state of this DatabaseResourceHealthSignalData.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DatabaseResourceHealthSignalData':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DatabaseResourceHealthSignalData of this DatabaseResourceHealthSignalData.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def additional_metadata(self):
        """Gets the additional_metadata of this DatabaseResourceHealthSignalData.

        Any other additional metadata

        :return: The additional_metadata of this DatabaseResourceHealthSignalData.
    ...
    def additional_metadata(self, additional_metadata):
        """Sets the additional_metadata of this DatabaseResourceHealthSignalData.
    ...
    @property
    def compliance(self):
        """Gets the compliance of this DatabaseResourceHealthSignalData.
        ...
        :return: The compliance of this DatabaseResourceHealthSignalData.
    ...
    def compliance(self, compliance):
        """Sets the compliance of this DatabaseResourceHealthSignalData.
    ...
    def description(self):
        """Gets the description of this DatabaseResourceHealthSignalData.

        Description associated with signal

        :return: The description of this DatabaseResourceHealthSignalData.
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this DatabaseResourceHealthSignalData.
    ...
    @property
    def event_time(self):
        """Gets the event_time of this DatabaseResourceHealthSignalData.

        Required. The last time at which the event described by this signal took place

        :return: The event_time of this DatabaseResourceHealthSignalData.
        :rtype: str
        """
    ...
    def event_time(self, event_time):
        """Sets the event_time of this DatabaseResourceHealthSignalData.
    ...
    def external_uri(self):
        """Gets the external_uri of this DatabaseResourceHealthSignalData.
        ...
        :return: The external_uri of this DatabaseResourceHealthSignalData.
        :rtype: str
        """
    ...
    def external_uri(self, external_uri):
        """Sets the external_uri of this DatabaseResourceHealthSignalData.
    ...
    @property
    def name(self):
        """Gets the name of this DatabaseResourceHealthSignalData.

        Required. The name of the signal, ex: PUBLIC_SQL_INSTANCE, SQL_LOG_ERROR_VERBOSITY etc.

        :return: The name of this DatabaseResourceHealthSignalData.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this DatabaseResourceHealthSignalData.
    ...
    @property
    def provider(self):
        """Gets the provider of this DatabaseResourceHealthSignalData.

        Cloud provider name. Ex: GCP/AWS/Azure/OnPrem/SelfManaged

        :return: The provider of this DatabaseResourceHealthSignalData.
        :rtype: str
        """
    ...
    def provider(self, provider):
        """Sets the provider of this DatabaseResourceHealthSignalData.
    ...
    def resource_container(self):
        """Gets the resource_container of this DatabaseResourceHealthSignalData.
        ...
        :return: The resource_container of this DatabaseResourceHealthSignalData.
        :rtype: str
        """
    ...
    def resource_container(self, resource_container):
        """Sets the resource_container of this DatabaseResourceHealthSignalData.
    ...
    def resource_name(self):
        """Gets the resource_name of this DatabaseResourceHealthSignalData.
        ...
        :return: The resource_name of this DatabaseResourceHealthSignalData.
        :rtype: str
        """
    ...
    def resource_name(self, resource_name):
        """Sets the resource_name of this DatabaseResourceHealthSignalData.
    ...
    def signal_class(self):
        """Gets the signal_class of this DatabaseResourceHealthSignalData.

        Required. The class of the signal, such as if it's a THREAT or VULNERABILITY.

        :return: The signal_class of this DatabaseResourceHealthSignalData.
        :rtype: str
        """
    ...
    def signal_class(self, signal_class):
        """Sets the signal_class of this DatabaseResourceHealthSignalData.
    ...
    @property
    def signal_id(self):
        """Gets the signal_id of this DatabaseResourceHealthSignalData.

        Required. Unique identifier for the signal. This is an unique id which would be mainatined by partner to identify a signal.

        :return: The signal_id of this DatabaseResourceHealthSignalData.
        :rtype: str
        """
    ...
    def signal_id(self, signal_id):
        """Sets the signal_id of this DatabaseResourceHealthSignalData.
    ...
    def signal_type(self):
        """Gets the signal_type of this DatabaseResourceHealthSignalData.

        Required. Type of signal, for example, `AVAILABLE_IN_MULTIPLE_ZONES`, `LOGGING_MOST_ERRORS`, etc.

        :return: The signal_type of this DatabaseResourceHealthSignalData.
        :rtype: str
        """
    ...
    def signal_type(self, signal_type):
        """Sets the signal_type of this DatabaseResourceHealthSignalData.
    ...
    @property
    def state(self):
        """Gets the state of this DatabaseResourceHealthSignalData.


        :return: The state of this DatabaseResourceHealthSignalData.
        :rtype: str
        """
        return self._state
    ...
    def state(self, state):
        """Sets the state of this DatabaseResourceHealthSignalData.
