...
/**
 * The DatabaseResourceRecommendationSignalData model module.
 * @module model/DatabaseResourceRecommendationSignalData
 * @version v1beta1
 */
class DatabaseResourceRecommendationSignalData {
    /**
     * Constructs a new <code>DatabaseResourceRecommendationSignalData</code>.
     * Common model for database resource recommendation signal data.
     * @alias module:model/DatabaseResourceRecommendationSignalData
     */
    constructor() { 
        
        DatabaseResourceRecommendationSignalData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DatabaseResourceRecommendationSignalData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DatabaseResourceRecommendationSignalData} obj Optional instance to populate.
     * @return {module:model/DatabaseResourceRecommendationSignalData} The populated <code>DatabaseResourceRecommendationSignalData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DatabaseResourceRecommendationSignalData();
    ...
    /**
     * Validates the JSON data with respect to <code>DatabaseResourceRecommendationSignalData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DatabaseResourceRecommendationSignalData</code>.
     */
 ...
 */
DatabaseResourceRecommendationSignalData.prototype['additionalMetadata'] = undefined;

/**
 * Required. last time recommendationw as refreshed
 * @member {String} lastRefreshTime
 */
DatabaseResourceRecommendationSignalData.prototype['lastRefreshTime'] = undefined;

/**
 * Required. Recommendation state
 * @member {module:model/DatabaseResourceRecommendationSignalData.RecommendationStateEnum} recommendationState
 */
DatabaseResourceRecommendationSignalData.prototype['recommendationState'] = undefined;
 ...
 */
DatabaseResourceRecommendationSignalData.prototype['recommender'] = undefined;

/**
 * Required. ID of recommender. Examples: \"google.cloudsql.instance.PerformanceRecommender\"
 * @member {String} recommenderId
 */
DatabaseResourceRecommendationSignalData.prototype['recommenderId'] = undefined;
 ...
 */
DatabaseResourceRecommendationSignalData.prototype['recommenderSubtype'] = undefined;
 ...
 */
DatabaseResourceRecommendationSignalData.prototype['resourceName'] = undefined;

/**
 * Required. Type of signal, for example, `SIGNAL_TYPE_IDLE`, `SIGNAL_TYPE_HIGH_NUMBER_OF_TABLES`, etc.
 * @member {module:model/DatabaseResourceRecommendationSignalData.SignalTypeEnum} signalType
 */
DatabaseResourceRecommendationSignalData.prototype['signalType'] = undefined;
 ...
 * @readonly
 */
DatabaseResourceRecommendationSignalData['RecommendationStateEnum'] = {
 ...
 * @readonly
 */
DatabaseResourceRecommendationSignalData['SignalTypeEnum'] = {
...
export default DatabaseResourceRecommendationSignalData;
