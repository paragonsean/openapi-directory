...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleCloudMemorystoreForRedisApi.TimeOfDay();
  });
  ...
  describe('TimeOfDay', function() {
    it('should create an instance of TimeOfDay', function() {
      ...
      //var instance = new GoogleCloudMemorystoreForRedisApi.TimeOfDay();
      //expect(instance).to.be.a(GoogleCloudMemorystoreForRedisApi.TimeOfDay);
    });
