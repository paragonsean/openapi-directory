...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleCloudMemorystoreForRedisApi.Status();
  });
  ...
  describe('Status', function() {
    it('should create an instance of Status', function() {
      ...
      //var instance = new GoogleCloudMemorystoreForRedisApi.Status();
      //expect(instance).to.be.a(GoogleCloudMemorystoreForRedisApi.Status);
    });
