...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleCloudMemorystoreForRedisApi.ListOperationsResponse();
  });
  ...
  describe('ListOperationsResponse', function() {
    it('should create an instance of ListOperationsResponse', function() {
      ...
      //var instance = new GoogleCloudMemorystoreForRedisApi.ListOperationsResponse();
      //expect(instance).to.be.a(GoogleCloudMemorystoreForRedisApi.ListOperationsResponse);
    });
