...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleCloudMemorystoreForRedisApi.GoogleCloudCommonOperationMetadata();
  });
  ...
  describe('GoogleCloudCommonOperationMetadata', function() {
    it('should create an instance of GoogleCloudCommonOperationMetadata', function() {
      ...
      //var instance = new GoogleCloudMemorystoreForRedisApi.GoogleCloudCommonOperationMetadata();
      //expect(instance).to.be.a(GoogleCloudMemorystoreForRedisApi.GoogleCloudCommonOperationMetadata);
    });
