...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleCloudMemorystoreForRedisApi.Location();
  });
  ...
  describe('Location', function() {
    it('should create an instance of Location', function() {
      ...
      //var instance = new GoogleCloudMemorystoreForRedisApi.Location();
      //expect(instance).to.be.a(GoogleCloudMemorystoreForRedisApi.Location);
    });
