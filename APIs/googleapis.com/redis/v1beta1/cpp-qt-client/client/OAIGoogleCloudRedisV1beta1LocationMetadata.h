...
/*
 * OAIGoogleCloudRedisV1beta1LocationMetadata.h
 *
...
#ifndef OAIGoogleCloudRedisV1beta1LocationMetadata_H
#define OAIGoogleCloudRedisV1beta1LocationMetadata_H
...
class OAIGoogleCloudRedisV1beta1LocationMetadata : public OAIObject {
public:
    OAIGoogleCloudRedisV1beta1LocationMetadata();
    OAIGoogleCloudRedisV1beta1LocationMetadata(QString json);
    ~OAIGoogleCloudRedisV1beta1LocationMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudRedisV1beta1LocationMetadata)

#endif // OAIGoogleCloudRedisV1beta1LocationMetadata_H
