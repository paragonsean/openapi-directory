...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleCloudMemorystoreForRedisApi.ListClustersResponse();
  });
  ...
  describe('ListClustersResponse', function() {
    it('should create an instance of ListClustersResponse', function() {
      ...
      //var instance = new GoogleCloudMemorystoreForRedisApi.ListClustersResponse();
      //expect(instance).to.be.a(GoogleCloudMemorystoreForRedisApi.ListClustersResponse);
    });
