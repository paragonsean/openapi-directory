...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleCloudMemorystoreForRedisApi.ListLocationsResponse();
  });
  ...
  describe('ListLocationsResponse', function() {
    it('should create an instance of ListLocationsResponse', function() {
      ...
      //var instance = new GoogleCloudMemorystoreForRedisApi.ListLocationsResponse();
      //expect(instance).to.be.a(GoogleCloudMemorystoreForRedisApi.ListLocationsResponse);
    });
