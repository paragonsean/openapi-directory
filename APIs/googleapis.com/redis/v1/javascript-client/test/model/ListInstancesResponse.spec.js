...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleCloudMemorystoreForRedisApi.ListInstancesResponse();
  });
  ...
  describe('ListInstancesResponse', function() {
    it('should create an instance of ListInstancesResponse', function() {
      ...
      //var instance = new GoogleCloudMemorystoreForRedisApi.ListInstancesResponse();
      //expect(instance).to.be.a(GoogleCloudMemorystoreForRedisApi.ListInstancesResponse);
    });
