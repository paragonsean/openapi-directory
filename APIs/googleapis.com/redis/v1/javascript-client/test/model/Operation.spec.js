...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleCloudMemorystoreForRedisApi.Operation();
  });
  ...
  describe('Operation', function() {
    it('should create an instance of Operation', function() {
      ...
      //var instance = new GoogleCloudMemorystoreForRedisApi.Operation();
      //expect(instance).to.be.a(GoogleCloudMemorystoreForRedisApi.Operation);
    });
