...
class MaintenancePolicy(Model):
    ...
    def __init__(self, create_time: str=None, description: str=None, update_time: str=None, weekly_maintenance_window: List[WeeklyMaintenanceWindow]=None):
        ...
        :param weekly_maintenance_window: The weekly_maintenance_window of this MaintenancePolicy.
        """
        self.openapi_types = {
            'create_time': str,
            'description': str,
    ...
    def weekly_maintenance_window(self):
        """Gets the weekly_maintenance_window of this MaintenancePolicy.

        Optional. Maintenance window that is applied to resources covered by this policy. Minimum 1. For the current version, the maximum number of weekly_window is expected to be one.

        :return: The weekly_maintenance_window of this MaintenancePolicy.
    ...
    def weekly_maintenance_window(self, weekly_maintenance_window):
        """Sets the weekly_maintenance_window of this MaintenancePolicy.
