...
public class DatabaseResourceRecommendationSignalData {
  ...
  public DatabaseResourceRecommendationSignalData() {
  }

  public DatabaseResourceRecommendationSignalData additionalMetadata(Map<String, Object> additionalMetadata) {
    this.additionalMetadata = additionalMetadata;
    return this;
  }

  public DatabaseResourceRecommendationSignalData putAdditionalMetadataItem(String key, Object additionalMetadataItem) {
  ...
  public DatabaseResourceRecommendationSignalData lastRefreshTime(String lastRefreshTime) {
  ...
  public DatabaseResourceRecommendationSignalData recommendationState(RecommendationStateEnum recommendationState) {
  ...
  public DatabaseResourceRecommendationSignalData recommender(String recommender) {
  ...
  public DatabaseResourceRecommendationSignalData recommenderId(String recommenderId) {
  ...
  public DatabaseResourceRecommendationSignalData recommenderSubtype(String recommenderSubtype) {
  ...
  public DatabaseResourceRecommendationSignalData resourceName(String resourceName) {
  ...
  public DatabaseResourceRecommendationSignalData signalType(SignalTypeEnum signalType) {
  ...
  public boolean equals(Object o) {
    ...
    DatabaseResourceRecommendationSignalData databaseResourceRecommendationSignalData = (DatabaseResourceRecommendationSignalData) o;
    return Objects.equals(this.additionalMetadata, databaseResourceRecommendationSignalData.additionalMetadata) &&
        Objects.equals(this.lastRefreshTime, databaseResourceRecommendationSignalData.lastRefreshTime) &&
        Objects.equals(this.recommendationState, databaseResourceRecommendationSignalData.recommendationState) &&
        Objects.equals(this.recommender, databaseResourceRecommendationSignalData.recommender) &&
        Objects.equals(this.recommenderId, databaseResourceRecommendationSignalData.recommenderId) &&
        Objects.equals(this.recommenderSubtype, databaseResourceRecommendationSignalData.recommenderSubtype) &&
        Objects.equals(this.resourceName, databaseResourceRecommendationSignalData.resourceName) &&
        Objects.equals(this.signalType, databaseResourceRecommendationSignalData.signalType);
  }
  ...
  public String toString() {
    ...
    sb.append("class DatabaseResourceRecommendationSignalData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DatabaseResourceRecommendationSignalData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DatabaseResourceRecommendationSignalData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DatabaseResourceRecommendationSignalData is not found in the empty JSON string", DatabaseResourceRecommendationSignalData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DatabaseResourceRecommendationSignalData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DatabaseResourceRecommendationSignalData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DatabaseResourceRecommendationSignalData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DatabaseResourceRecommendationSignalData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DatabaseResourceRecommendationSignalData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DatabaseResourceRecommendationSignalData.class));

       return (TypeAdapter<T>) new TypeAdapter<DatabaseResourceRecommendationSignalData>() {
           @Override
           public void write(JsonWriter out, DatabaseResourceRecommendationSignalData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DatabaseResourceRecommendationSignalData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DatabaseResourceRecommendationSignalData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DatabaseResourceRecommendationSignalData
   * @throws IOException if the JSON string is invalid with respect to DatabaseResourceRecommendationSignalData
   */
  public static DatabaseResourceRecommendationSignalData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DatabaseResourceRecommendationSignalData.class);
  }

  /**
   * Convert an instance of DatabaseResourceRecommendationSignalData to an JSON string
   *
   * @return JSON string
   */
