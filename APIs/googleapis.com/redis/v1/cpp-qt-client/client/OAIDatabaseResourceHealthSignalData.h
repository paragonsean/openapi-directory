...
/*
 * OAIDatabaseResourceHealthSignalData.h
 *
 * Common model for database resource health signal data.
 */

#ifndef OAIDatabaseResourceHealthSignalData_H
#define OAIDatabaseResourceHealthSignalData_H
...
class OAIDatabaseResourceHealthSignalData : public OAIObject {
public:
    OAIDatabaseResourceHealthSignalData();
    OAIDatabaseResourceHealthSignalData(QString json);
    ~OAIDatabaseResourceHealthSignalData() override;
    ...
    QList<OAICompliance> getCompliance() const;
    void setCompliance(const QList<OAICompliance> &compliance);
...
private:
    ...
    QList<OAICompliance> m_compliance;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDatabaseResourceHealthSignalData)

#endif // OAIDatabaseResourceHealthSignalData_H
