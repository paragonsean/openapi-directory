...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceNetworkingApi.FieldPolicy();
  });
  ...
  describe('FieldPolicy', function() {
    it('should create an instance of FieldPolicy', function() {
      ...
      //var instance = new ServiceNetworkingApi.FieldPolicy();
      //expect(instance).to.be.a(ServiceNetworkingApi.FieldPolicy);
    });
