# ServiceNetworkingApi.GoogleCloudServicenetworkingV1betaConnection
...
**reservedPeeringRanges** | **[String]** | The name of one or more allocated IP address ranges for this service producer of type &#x60;PEERING&#x60;. Note that invoking this method with a different range when connection is already established will not modify already provisioned service producer subnetworks. | [optional] 
