...
|------------ | ------------- | ------------- | -------------|
|**cloudsqlConfigs** | [**List&lt;CloudSQLConfig&gt;**](CloudSQLConfig.md) | Represents one or multiple Cloud SQL configurations. |  [optional] |
...
|**reservedRanges** | [**List&lt;GoogleCloudServicenetworkingV1ConsumerConfigReservedRange&gt;**](GoogleCloudServicenetworkingV1ConsumerConfigReservedRange.md) | Output only. The reserved ranges associated with this private service access connection. |  [optional] [readonly] |
|**usedIpRanges** | **List&lt;String&gt;** | Output only. The IP ranges already in use by consumer or producer |  [optional] [readonly] |
