...
- API version: v1beta
  - Build date: 2024-10-12T11:30:18.071541-04:00[America/New_York]
...
------------ | ------------- | ------------- | -------------
*OperationsApi* | [**servicenetworkingOperationsGet**](docs/OperationsApi.md#servicenetworkingOperationsGet) | **GET** /v1beta/{name} | 
*ServicesApi* | [**servicenetworkingServicesAddSubnetwork**](docs/ServicesApi.md#servicenetworkingServicesAddSubnetwork) | **POST** /v1beta/{parent}:addSubnetwork | 
*ServicesApi* | [**servicenetworkingServicesConnectionsCreate**](docs/ServicesApi.md#servicenetworkingServicesConnectionsCreate) | **POST** /v1beta/{parent}/connections | 
*ServicesApi* | [**servicenetworkingServicesConnectionsList**](docs/ServicesApi.md#servicenetworkingServicesConnectionsList) | **GET** /v1beta/{parent}/connections | 
*ServicesApi* | [**servicenetworkingServicesSearchRange**](docs/ServicesApi.md#servicenetworkingServicesSearchRange) | **POST** /v1beta/{parent}:searchRange | 
*ServicesApi* | [**servicenetworkingServicesUpdateConnections**](docs/ServicesApi.md#servicenetworkingServicesUpdateConnections) | **PATCH** /v1beta/{name}/connections | 
