...
class GetDnsZoneResponse(Model):
    ...
    def __init__(self, consumer_peering_zone: DnsZone=None, producer_private_zone: DnsZone=None):
        """GetDnsZoneResponse - a model defined in OpenAPI

        :param consumer_peering_zone: The consumer_peering_zone of this GetDnsZoneResponse.
        :param producer_private_zone: The producer_private_zone of this GetDnsZoneResponse.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'GetDnsZoneResponse':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The GetDnsZoneResponse of this GetDnsZoneResponse.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def consumer_peering_zone(self):
        """Gets the consumer_peering_zone of this GetDnsZoneResponse.


        :return: The consumer_peering_zone of this GetDnsZoneResponse.
        :rtype: DnsZone
        """
    ...
    def consumer_peering_zone(self, consumer_peering_zone):
        """Sets the consumer_peering_zone of this GetDnsZoneResponse.
    ...
    def producer_private_zone(self):
        """Gets the producer_private_zone of this GetDnsZoneResponse.


        :return: The producer_private_zone of this GetDnsZoneResponse.
        :rtype: DnsZone
        """
    ...
    def producer_private_zone(self, producer_private_zone):
        """Sets the producer_private_zone of this GetDnsZoneResponse.
