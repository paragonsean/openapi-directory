...
class AddDnsZoneResponse(Model):
    ...
    def __init__(self, consumer_peering_zone: DnsZone=None, producer_private_zone: DnsZone=None):
        """AddDnsZoneResponse - a model defined in OpenAPI

        :param consumer_peering_zone: The consumer_peering_zone of this AddDnsZoneResponse.
        :param producer_private_zone: The producer_private_zone of this AddDnsZoneResponse.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'AddDnsZoneResponse':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The AddDnsZoneResponse of this AddDnsZoneResponse.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def consumer_peering_zone(self):
        """Gets the consumer_peering_zone of this AddDnsZoneResponse.


        :return: The consumer_peering_zone of this AddDnsZoneResponse.
        :rtype: DnsZone
        """
    ...
    def consumer_peering_zone(self, consumer_peering_zone):
        """Sets the consumer_peering_zone of this AddDnsZoneResponse.
    ...
    def producer_private_zone(self):
        """Gets the producer_private_zone of this AddDnsZoneResponse.


        :return: The producer_private_zone of this AddDnsZoneResponse.
        :rtype: DnsZone
        """
    ...
    def producer_private_zone(self, producer_private_zone):
        """Sets the producer_private_zone of this AddDnsZoneResponse.
