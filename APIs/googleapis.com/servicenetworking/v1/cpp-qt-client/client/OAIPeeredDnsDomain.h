...
#ifndef OAIPeeredDnsDomain_H
#define OAIPeeredDnsDomain_H
...
class OAIPeeredDnsDomain : public OAIObject {
public:
    OAIPeeredDnsDomain();
    OAIPeeredDnsDomain(QString json);
    ~OAIPeeredDnsDomain() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPeeredDnsDomain)

#endif // OAIPeeredDnsDomain_H
