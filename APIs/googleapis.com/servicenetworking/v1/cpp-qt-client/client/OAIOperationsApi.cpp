...
void OAIOperationsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("servicenetworking_operations_cancel", defaultConf);
    _serverIndices.insert("servicenetworking_operations_cancel", 0);
}
...
void OAIOperationsApi::servicenetworking_operations_cancel(const QString &name, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<OAIObject> &body) {
    QString fullPath = QString(_serverConfigs["servicenetworking_operations_cancel"][_serverIndices.value("servicenetworking_operations_cancel")].URL()+"/v1/{name}:cancel");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIOperationsApi::servicenetworking_operations_cancelCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIOperationsApi::servicenetworking_operations_cancelCallback);
...
void OAIOperationsApi::servicenetworking_operations_cancelCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT servicenetworking_operations_cancelSignal(output);
        Q_EMIT servicenetworking_operations_cancelSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT servicenetworking_operations_cancelSignalE(output, error_type, error_str);
        Q_EMIT servicenetworking_operations_cancelSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT servicenetworking_operations_cancelSignalError(output, error_type, error_str);
        Q_EMIT servicenetworking_operations_cancelSignalErrorFull(worker, error_type, error_str);
    }
}
