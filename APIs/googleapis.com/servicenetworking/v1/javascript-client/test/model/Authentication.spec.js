...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceNetworkingApi.Authentication();
  });
  ...
  describe('Authentication', function() {
    it('should create an instance of Authentication', function() {
      ...
      //var instance = new ServiceNetworkingApi.Authentication();
      //expect(instance).to.be.a(ServiceNetworkingApi.Authentication);
    });
