...
/**
 * The GoogleCloudServicenetworkingV1betaConnection model module.
 * @module model/GoogleCloudServicenetworkingV1betaConnection
 * @version v1
 */
class GoogleCloudServicenetworkingV1betaConnection {
    /**
     * Constructs a new <code>GoogleCloudServicenetworkingV1betaConnection</code>.
     * Represents a private connection resource. A private connection is implemented as a VPC Network Peering connection between a service producer&#39;s VPC network and a service consumer&#39;s VPC network.
     * @alias module:model/GoogleCloudServicenetworkingV1betaConnection
     */
    constructor() { 
        
        GoogleCloudServicenetworkingV1betaConnection.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudServicenetworkingV1betaConnection</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudServicenetworkingV1betaConnection} obj Optional instance to populate.
     * @return {module:model/GoogleCloudServicenetworkingV1betaConnection} The populated <code>GoogleCloudServicenetworkingV1betaConnection</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudServicenetworkingV1betaConnection();
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudServicenetworkingV1betaConnection</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudServicenetworkingV1betaConnection</code>.
     */
 ...
 */
GoogleCloudServicenetworkingV1betaConnection.prototype['network'] = undefined;

/**
 * Output only. The name of the VPC Network Peering connection that was created by the service producer.
 * @member {String} peering
 */
GoogleCloudServicenetworkingV1betaConnection.prototype['peering'] = undefined;
 ...
 */
GoogleCloudServicenetworkingV1betaConnection.prototype['reservedPeeringRanges'] = undefined;
 ...
 */
GoogleCloudServicenetworkingV1betaConnection.prototype['service'] = undefined;
...
export default GoogleCloudServicenetworkingV1betaConnection;
