# ServiceNetworkingApi.RemoveDnsZoneRequest
...
**name** | **String** | Required. The name for both the private zone in the shared producer host project and the peering zone in the consumer project. | [optional] 
