# ServiceNetworkingApi.DnsZone

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**dnsSuffix** | **String** | The DNS name suffix of this zone e.g. &#x60;example.com.&#x60;. Cloud DNS requires that a DNS suffix ends with a trailing dot. | [optional] 
