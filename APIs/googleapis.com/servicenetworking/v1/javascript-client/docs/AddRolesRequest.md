# ServiceNetworkingApi.AddRolesRequest
...
**policyBinding** | [**[PolicyBinding]**](PolicyBinding.md) | Required. List of policy bindings to add to shared VPC host project. | [optional] 
