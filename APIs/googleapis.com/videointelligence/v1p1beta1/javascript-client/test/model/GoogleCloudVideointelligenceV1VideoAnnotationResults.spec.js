...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudVideoIntelligenceApi.GoogleCloudVideointelligenceV1VideoAnnotationResults();
  });
  ...
  describe('GoogleCloudVideointelligenceV1VideoAnnotationResults', function() {
    it('should create an instance of GoogleCloudVideointelligenceV1VideoAnnotationResults', function() {
      // uncomment below and update the code to test GoogleCloudVideointelligenceV1VideoAnnotationResults
      //var instance = new CloudVideoIntelligenceApi.GoogleCloudVideointelligenceV1VideoAnnotationResults();
      //expect(instance).to.be.a(CloudVideoIntelligenceApi.GoogleCloudVideointelligenceV1VideoAnnotationResults);
    });
