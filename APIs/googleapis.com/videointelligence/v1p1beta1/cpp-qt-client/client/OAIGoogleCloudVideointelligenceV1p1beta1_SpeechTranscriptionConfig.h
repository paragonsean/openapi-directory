...
/*
 * OAIGoogleCloudVideointelligenceV1p1beta1_SpeechTranscriptionConfig.h
 *
 * Config for SPEECH_TRANSCRIPTION.
 */

#ifndef OAIGoogleCloudVideointelligenceV1p1beta1_SpeechTranscriptionConfig_H
#define OAIGoogleCloudVideointelligenceV1p1beta1_SpeechTranscriptionConfig_H

#include <QJsonObject>

#include "OAIGoogleCloudVideointelligenceV1p1beta1_SpeechContext.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAIGoogleCloudVideointelligenceV1p1beta1_SpeechContext;

class OAIGoogleCloudVideointelligenceV1p1beta1_SpeechTranscriptionConfig : public OAIObject {
public:
    OAIGoogleCloudVideointelligenceV1p1beta1_SpeechTranscriptionConfig();
    OAIGoogleCloudVideointelligenceV1p1beta1_SpeechTranscriptionConfig(QString json);
    ~OAIGoogleCloudVideointelligenceV1p1beta1_SpeechTranscriptionConfig() override;
    ...
    QList<OAIGoogleCloudVideointelligenceV1p1beta1_SpeechContext> getSpeechContexts() const;
    void setSpeechContexts(const QList<OAIGoogleCloudVideointelligenceV1p1beta1_SpeechContext> &speech_contexts);
...
private:
    ...
    QList<OAIGoogleCloudVideointelligenceV1p1beta1_SpeechContext> m_speech_contexts;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudVideointelligenceV1p1beta1_SpeechTranscriptionConfig)

#endif // OAIGoogleCloudVideointelligenceV1p1beta1_SpeechTranscriptionConfig_H
