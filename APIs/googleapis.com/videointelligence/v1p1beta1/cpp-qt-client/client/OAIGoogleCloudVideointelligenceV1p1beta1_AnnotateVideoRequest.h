...
/*
 * OAIGoogleCloudVideointelligenceV1p1beta1_AnnotateVideoRequest.h
 *
 * Video annotation request.
 */

#ifndef OAIGoogleCloudVideointelligenceV1p1beta1_AnnotateVideoRequest_H
#define OAIGoogleCloudVideointelligenceV1p1beta1_AnnotateVideoRequest_H

#include <QJsonObject>

#include "OAIGoogleCloudVideointelligenceV1p1beta1_VideoContext.h"
#include <QByteArray>
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAIGoogleCloudVideointelligenceV1p1beta1_VideoContext;

class OAIGoogleCloudVideointelligenceV1p1beta1_AnnotateVideoRequest : public OAIObject {
public:
    OAIGoogleCloudVideointelligenceV1p1beta1_AnnotateVideoRequest();
    OAIGoogleCloudVideointelligenceV1p1beta1_AnnotateVideoRequest(QString json);
    ~OAIGoogleCloudVideointelligenceV1p1beta1_AnnotateVideoRequest() override;
    ...
    OAIGoogleCloudVideointelligenceV1p1beta1_VideoContext getVideoContext() const;
    void setVideoContext(const OAIGoogleCloudVideointelligenceV1p1beta1_VideoContext &video_context);
...
private:
    ...
    OAIGoogleCloudVideointelligenceV1p1beta1_VideoContext m_video_context;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudVideointelligenceV1p1beta1_AnnotateVideoRequest)

#endif // OAIGoogleCloudVideointelligenceV1p1beta1_AnnotateVideoRequest_H
