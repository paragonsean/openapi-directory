...
public class GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults {
  public static final String SERIALIZED_NAME_CELEBRITY_RECOGNITION_ANNOTATIONS = "celebrityRecognitionAnnotations";
  @SerializedName(SERIALIZED_NAME_CELEBRITY_RECOGNITION_ANNOTATIONS)
  ...
  private List<GoogleCloudVideointelligenceV1p3beta1FaceAnnotation> faceAnnotations = new ArrayList<>();
  ...
  private List<GoogleCloudVideointelligenceV1p3beta1FaceDetectionAnnotation> faceDetectionAnnotations = new ArrayList<>();
  ...
  private List<GoogleCloudVideointelligenceV1p3beta1LabelAnnotation> frameLabelAnnotations = new ArrayList<>();
  ...
  private List<GoogleCloudVideointelligenceV1p3beta1LogoRecognitionAnnotation> logoRecognitionAnnotations = new ArrayList<>();
  ...
  private List<GoogleCloudVideointelligenceV1p3beta1PersonDetectionAnnotation> personDetectionAnnotations = new ArrayList<>();
  ...
  private List<GoogleCloudVideointelligenceV1p3beta1LabelAnnotation> segmentLabelAnnotations = new ArrayList<>();
  ...
  private List<GoogleCloudVideointelligenceV1p3beta1LabelAnnotation> segmentPresenceLabelAnnotations = new ArrayList<>();
  ...
  private List<GoogleCloudVideointelligenceV1p3beta1LabelAnnotation> shotLabelAnnotations = new ArrayList<>();
  ...
  private List<GoogleCloudVideointelligenceV1p3beta1LabelAnnotation> shotPresenceLabelAnnotations = new ArrayList<>();
  ...
  private List<GoogleCloudVideointelligenceV1p3beta1SpeechTranscription> speechTranscriptions = new ArrayList<>();
  ...
  private List<GoogleCloudVideointelligenceV1p3beta1TextAnnotation> textAnnotations = new ArrayList<>();

  public GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults() {
  }

  public GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults celebrityRecognitionAnnotations(GoogleCloudVideointelligenceV1p3beta1CelebrityRecognitionAnnotation celebrityRecognitionAnnotations) {
    this.celebrityRecognitionAnnotations = celebrityRecognitionAnnotations;
    return this;
  }

  /**
   * Get celebrityRecognitionAnnotations
  ...
  public void setCelebrityRecognitionAnnotations(GoogleCloudVideointelligenceV1p3beta1CelebrityRecognitionAnnotation celebrityRecognitionAnnotations) {
    this.celebrityRecognitionAnnotations = celebrityRecognitionAnnotations;
  }


  public GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults error(GoogleRpcStatus error) {
    this.error = error;
    return this;
  }
  ...
  public GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults explicitAnnotation(GoogleCloudVideointelligenceV1p3beta1ExplicitContentAnnotation explicitAnnotation) {
  ...
  @Deprecated
  public GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults faceAnnotations(List<GoogleCloudVideointelligenceV1p3beta1FaceAnnotation> faceAnnotations) {
    this.faceAnnotations = faceAnnotations;
    return this;
  }

  public GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults addFaceAnnotationsItem(GoogleCloudVideointelligenceV1p3beta1FaceAnnotation faceAnnotationsItem) {
  ...
  @Deprecated
  @javax.annotation.Nullable
  public List<GoogleCloudVideointelligenceV1p3beta1FaceAnnotation> getFaceAnnotations() {
    return faceAnnotations;
  }

  @Deprecated
  public void setFaceAnnotations(List<GoogleCloudVideointelligenceV1p3beta1FaceAnnotation> faceAnnotations) {
    this.faceAnnotations = faceAnnotations;
  }


  public GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults faceDetectionAnnotations(List<GoogleCloudVideointelligenceV1p3beta1FaceDetectionAnnotation> faceDetectionAnnotations) {
    this.faceDetectionAnnotations = faceDetectionAnnotations;
    return this;
  }

  public GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults addFaceDetectionAnnotationsItem(GoogleCloudVideointelligenceV1p3beta1FaceDetectionAnnotation faceDetectionAnnotationsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<GoogleCloudVideointelligenceV1p3beta1FaceDetectionAnnotation> getFaceDetectionAnnotations() {
    return faceDetectionAnnotations;
  }

  public void setFaceDetectionAnnotations(List<GoogleCloudVideointelligenceV1p3beta1FaceDetectionAnnotation> faceDetectionAnnotations) {
    this.faceDetectionAnnotations = faceDetectionAnnotations;
  }


  public GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults frameLabelAnnotations(List<GoogleCloudVideointelligenceV1p3beta1LabelAnnotation> frameLabelAnnotations) {
    this.frameLabelAnnotations = frameLabelAnnotations;
    return this;
  }

  public GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults addFrameLabelAnnotationsItem(GoogleCloudVideointelligenceV1p3beta1LabelAnnotation frameLabelAnnotationsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<GoogleCloudVideointelligenceV1p3beta1LabelAnnotation> getFrameLabelAnnotations() {
    return frameLabelAnnotations;
  }

  public void setFrameLabelAnnotations(List<GoogleCloudVideointelligenceV1p3beta1LabelAnnotation> frameLabelAnnotations) {
    this.frameLabelAnnotations = frameLabelAnnotations;
  }


  public GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults inputUri(String inputUri) {
  ...
  public GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults logoRecognitionAnnotations(List<GoogleCloudVideointelligenceV1p3beta1LogoRecognitionAnnotation> logoRecognitionAnnotations) {
    this.logoRecognitionAnnotations = logoRecognitionAnnotations;
    return this;
  }

  public GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults addLogoRecognitionAnnotationsItem(GoogleCloudVideointelligenceV1p3beta1LogoRecognitionAnnotation logoRecognitionAnnotationsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<GoogleCloudVideointelligenceV1p3beta1LogoRecognitionAnnotation> getLogoRecognitionAnnotations() {
    return logoRecognitionAnnotations;
  }

  public void setLogoRecognitionAnnotations(List<GoogleCloudVideointelligenceV1p3beta1LogoRecognitionAnnotation> logoRecognitionAnnotations) {
    this.logoRecognitionAnnotations = logoRecognitionAnnotations;
  }


  public GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults objectAnnotations(List<GoogleCloudVideointelligenceV1p3beta1ObjectTrackingAnnotation> objectAnnotations) {
    this.objectAnnotations = objectAnnotations;
    return this;
  }

  public GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults addObjectAnnotationsItem(GoogleCloudVideointelligenceV1p3beta1ObjectTrackingAnnotation objectAnnotationsItem) {
  ...
  public GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults personDetectionAnnotations(List<GoogleCloudVideointelligenceV1p3beta1PersonDetectionAnnotation> personDetectionAnnotations) {
    this.personDetectionAnnotations = personDetectionAnnotations;
    return this;
  }

  public GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults addPersonDetectionAnnotationsItem(GoogleCloudVideointelligenceV1p3beta1PersonDetectionAnnotation personDetectionAnnotationsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<GoogleCloudVideointelligenceV1p3beta1PersonDetectionAnnotation> getPersonDetectionAnnotations() {
    return personDetectionAnnotations;
  }

  public void setPersonDetectionAnnotations(List<GoogleCloudVideointelligenceV1p3beta1PersonDetectionAnnotation> personDetectionAnnotations) {
    this.personDetectionAnnotations = personDetectionAnnotations;
  }


  public GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults segment(GoogleCloudVideointelligenceV1p3beta1VideoSegment segment) {
  ...
  public GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults segmentLabelAnnotations(List<GoogleCloudVideointelligenceV1p3beta1LabelAnnotation> segmentLabelAnnotations) {
    this.segmentLabelAnnotations = segmentLabelAnnotations;
    return this;
  }

  public GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults addSegmentLabelAnnotationsItem(GoogleCloudVideointelligenceV1p3beta1LabelAnnotation segmentLabelAnnotationsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<GoogleCloudVideointelligenceV1p3beta1LabelAnnotation> getSegmentLabelAnnotations() {
    return segmentLabelAnnotations;
  }

  public void setSegmentLabelAnnotations(List<GoogleCloudVideointelligenceV1p3beta1LabelAnnotation> segmentLabelAnnotations) {
    this.segmentLabelAnnotations = segmentLabelAnnotations;
  }


  public GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults segmentPresenceLabelAnnotations(List<GoogleCloudVideointelligenceV1p3beta1LabelAnnotation> segmentPresenceLabelAnnotations) {
    this.segmentPresenceLabelAnnotations = segmentPresenceLabelAnnotations;
    return this;
  }

  public GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults addSegmentPresenceLabelAnnotationsItem(GoogleCloudVideointelligenceV1p3beta1LabelAnnotation segmentPresenceLabelAnnotationsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<GoogleCloudVideointelligenceV1p3beta1LabelAnnotation> getSegmentPresenceLabelAnnotations() {
    return segmentPresenceLabelAnnotations;
  }

  public void setSegmentPresenceLabelAnnotations(List<GoogleCloudVideointelligenceV1p3beta1LabelAnnotation> segmentPresenceLabelAnnotations) {
    this.segmentPresenceLabelAnnotations = segmentPresenceLabelAnnotations;
  }


  public GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults shotAnnotations(List<GoogleCloudVideointelligenceV1p3beta1VideoSegment> shotAnnotations) {
    this.shotAnnotations = shotAnnotations;
    return this;
  }

  public GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults addShotAnnotationsItem(GoogleCloudVideointelligenceV1p3beta1VideoSegment shotAnnotationsItem) {
  ...
  public GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults shotLabelAnnotations(List<GoogleCloudVideointelligenceV1p3beta1LabelAnnotation> shotLabelAnnotations) {
    this.shotLabelAnnotations = shotLabelAnnotations;
    return this;
  }

  public GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults addShotLabelAnnotationsItem(GoogleCloudVideointelligenceV1p3beta1LabelAnnotation shotLabelAnnotationsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<GoogleCloudVideointelligenceV1p3beta1LabelAnnotation> getShotLabelAnnotations() {
    return shotLabelAnnotations;
  }

  public void setShotLabelAnnotations(List<GoogleCloudVideointelligenceV1p3beta1LabelAnnotation> shotLabelAnnotations) {
    this.shotLabelAnnotations = shotLabelAnnotations;
  }


  public GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults shotPresenceLabelAnnotations(List<GoogleCloudVideointelligenceV1p3beta1LabelAnnotation> shotPresenceLabelAnnotations) {
    this.shotPresenceLabelAnnotations = shotPresenceLabelAnnotations;
    return this;
  }

  public GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults addShotPresenceLabelAnnotationsItem(GoogleCloudVideointelligenceV1p3beta1LabelAnnotation shotPresenceLabelAnnotationsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<GoogleCloudVideointelligenceV1p3beta1LabelAnnotation> getShotPresenceLabelAnnotations() {
    return shotPresenceLabelAnnotations;
  }

  public void setShotPresenceLabelAnnotations(List<GoogleCloudVideointelligenceV1p3beta1LabelAnnotation> shotPresenceLabelAnnotations) {
    this.shotPresenceLabelAnnotations = shotPresenceLabelAnnotations;
  }


  public GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults speechTranscriptions(List<GoogleCloudVideointelligenceV1p3beta1SpeechTranscription> speechTranscriptions) {
    this.speechTranscriptions = speechTranscriptions;
    return this;
  }

  public GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults addSpeechTranscriptionsItem(GoogleCloudVideointelligenceV1p3beta1SpeechTranscription speechTranscriptionsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<GoogleCloudVideointelligenceV1p3beta1SpeechTranscription> getSpeechTranscriptions() {
    return speechTranscriptions;
  }

  public void setSpeechTranscriptions(List<GoogleCloudVideointelligenceV1p3beta1SpeechTranscription> speechTranscriptions) {
    this.speechTranscriptions = speechTranscriptions;
  }


  public GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults textAnnotations(List<GoogleCloudVideointelligenceV1p3beta1TextAnnotation> textAnnotations) {
    this.textAnnotations = textAnnotations;
    return this;
  }

  public GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults addTextAnnotationsItem(GoogleCloudVideointelligenceV1p3beta1TextAnnotation textAnnotationsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<GoogleCloudVideointelligenceV1p3beta1TextAnnotation> getTextAnnotations() {
    return textAnnotations;
  }

  public void setTextAnnotations(List<GoogleCloudVideointelligenceV1p3beta1TextAnnotation> textAnnotations) {
    this.textAnnotations = textAnnotations;
  }
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults googleCloudVideointelligenceV1p3beta1VideoAnnotationResults = (GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults) o;
    return Objects.equals(this.celebrityRecognitionAnnotations, googleCloudVideointelligenceV1p3beta1VideoAnnotationResults.celebrityRecognitionAnnotations) &&
        Objects.equals(this.error, googleCloudVideointelligenceV1p3beta1VideoAnnotationResults.error) &&
        Objects.equals(this.explicitAnnotation, googleCloudVideointelligenceV1p3beta1VideoAnnotationResults.explicitAnnotation) &&
        Objects.equals(this.faceAnnotations, googleCloudVideointelligenceV1p3beta1VideoAnnotationResults.faceAnnotations) &&
        Objects.equals(this.faceDetectionAnnotations, googleCloudVideointelligenceV1p3beta1VideoAnnotationResults.faceDetectionAnnotations) &&
        Objects.equals(this.frameLabelAnnotations, googleCloudVideointelligenceV1p3beta1VideoAnnotationResults.frameLabelAnnotations) &&
        Objects.equals(this.inputUri, googleCloudVideointelligenceV1p3beta1VideoAnnotationResults.inputUri) &&
        Objects.equals(this.logoRecognitionAnnotations, googleCloudVideointelligenceV1p3beta1VideoAnnotationResults.logoRecognitionAnnotations) &&
        Objects.equals(this.objectAnnotations, googleCloudVideointelligenceV1p3beta1VideoAnnotationResults.objectAnnotations) &&
        Objects.equals(this.personDetectionAnnotations, googleCloudVideointelligenceV1p3beta1VideoAnnotationResults.personDetectionAnnotations) &&
        Objects.equals(this.segment, googleCloudVideointelligenceV1p3beta1VideoAnnotationResults.segment) &&
        Objects.equals(this.segmentLabelAnnotations, googleCloudVideointelligenceV1p3beta1VideoAnnotationResults.segmentLabelAnnotations) &&
        Objects.equals(this.segmentPresenceLabelAnnotations, googleCloudVideointelligenceV1p3beta1VideoAnnotationResults.segmentPresenceLabelAnnotations) &&
        Objects.equals(this.shotAnnotations, googleCloudVideointelligenceV1p3beta1VideoAnnotationResults.shotAnnotations) &&
        Objects.equals(this.shotLabelAnnotations, googleCloudVideointelligenceV1p3beta1VideoAnnotationResults.shotLabelAnnotations) &&
        Objects.equals(this.shotPresenceLabelAnnotations, googleCloudVideointelligenceV1p3beta1VideoAnnotationResults.shotPresenceLabelAnnotations) &&
        Objects.equals(this.speechTranscriptions, googleCloudVideointelligenceV1p3beta1VideoAnnotationResults.speechTranscriptions) &&
        Objects.equals(this.textAnnotations, googleCloudVideointelligenceV1p3beta1VideoAnnotationResults.textAnnotations);
  }

  @Override
  public int hashCode() {
    return Objects.hash(celebrityRecognitionAnnotations, error, explicitAnnotation, faceAnnotations, faceDetectionAnnotations, frameLabelAnnotations, inputUri, logoRecognitionAnnotations, objectAnnotations, personDetectionAnnotations, segment, segmentLabelAnnotations, segmentPresenceLabelAnnotations, shotAnnotations, shotLabelAnnotations, shotPresenceLabelAnnotations, speechTranscriptions, textAnnotations);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults {\n");
    sb.append("    celebrityRecognitionAnnotations: ").append(toIndentedString(celebrityRecognitionAnnotations)).append("\n");
  ...
  static {
    ...
    openapiFields.add("celebrityRecognitionAnnotations");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults is not found in the empty JSON string", GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `celebrityRecognitionAnnotations`
      if (jsonObj.get("celebrityRecognitionAnnotations") != null && !jsonObj.get("celebrityRecognitionAnnotations").isJsonNull()) {
        GoogleCloudVideointelligenceV1p3beta1CelebrityRecognitionAnnotation.validateJsonElement(jsonObj.get("celebrityRecognitionAnnotations"));
      }
      ...
      if (jsonObj.get("faceAnnotations") != null && !jsonObj.get("faceAnnotations").isJsonNull()) {
        ...
        if (jsonArrayfaceAnnotations != null) {
          ...
          for (int i = 0; i < jsonArrayfaceAnnotations.size(); i++) {
            GoogleCloudVideointelligenceV1p3beta1FaceAnnotation.validateJsonElement(jsonArrayfaceAnnotations.get(i));
          };
        }
      }
      if (jsonObj.get("faceDetectionAnnotations") != null && !jsonObj.get("faceDetectionAnnotations").isJsonNull()) {
        ...
        if (jsonArrayfaceDetectionAnnotations != null) {
          ...
          for (int i = 0; i < jsonArrayfaceDetectionAnnotations.size(); i++) {
            GoogleCloudVideointelligenceV1p3beta1FaceDetectionAnnotation.validateJsonElement(jsonArrayfaceDetectionAnnotations.get(i));
          };
        }
      }
      if (jsonObj.get("frameLabelAnnotations") != null && !jsonObj.get("frameLabelAnnotations").isJsonNull()) {
        ...
        if (jsonArrayframeLabelAnnotations != null) {
          ...
          for (int i = 0; i < jsonArrayframeLabelAnnotations.size(); i++) {
            GoogleCloudVideointelligenceV1p3beta1LabelAnnotation.validateJsonElement(jsonArrayframeLabelAnnotations.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("logoRecognitionAnnotations") != null && !jsonObj.get("logoRecognitionAnnotations").isJsonNull()) {
        ...
        if (jsonArraylogoRecognitionAnnotations != null) {
          ...
          for (int i = 0; i < jsonArraylogoRecognitionAnnotations.size(); i++) {
            GoogleCloudVideointelligenceV1p3beta1LogoRecognitionAnnotation.validateJsonElement(jsonArraylogoRecognitionAnnotations.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("personDetectionAnnotations") != null && !jsonObj.get("personDetectionAnnotations").isJsonNull()) {
        ...
        if (jsonArraypersonDetectionAnnotations != null) {
          ...
          for (int i = 0; i < jsonArraypersonDetectionAnnotations.size(); i++) {
            GoogleCloudVideointelligenceV1p3beta1PersonDetectionAnnotation.validateJsonElement(jsonArraypersonDetectionAnnotations.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("segmentLabelAnnotations") != null && !jsonObj.get("segmentLabelAnnotations").isJsonNull()) {
        ...
        if (jsonArraysegmentLabelAnnotations != null) {
          ...
          for (int i = 0; i < jsonArraysegmentLabelAnnotations.size(); i++) {
            GoogleCloudVideointelligenceV1p3beta1LabelAnnotation.validateJsonElement(jsonArraysegmentLabelAnnotations.get(i));
          };
        }
      }
      if (jsonObj.get("segmentPresenceLabelAnnotations") != null && !jsonObj.get("segmentPresenceLabelAnnotations").isJsonNull()) {
        ...
        if (jsonArraysegmentPresenceLabelAnnotations != null) {
          ...
          for (int i = 0; i < jsonArraysegmentPresenceLabelAnnotations.size(); i++) {
            GoogleCloudVideointelligenceV1p3beta1LabelAnnotation.validateJsonElement(jsonArraysegmentPresenceLabelAnnotations.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("shotLabelAnnotations") != null && !jsonObj.get("shotLabelAnnotations").isJsonNull()) {
        ...
        if (jsonArrayshotLabelAnnotations != null) {
          ...
          for (int i = 0; i < jsonArrayshotLabelAnnotations.size(); i++) {
            GoogleCloudVideointelligenceV1p3beta1LabelAnnotation.validateJsonElement(jsonArrayshotLabelAnnotations.get(i));
          };
        }
      }
      if (jsonObj.get("shotPresenceLabelAnnotations") != null && !jsonObj.get("shotPresenceLabelAnnotations").isJsonNull()) {
        ...
        if (jsonArrayshotPresenceLabelAnnotations != null) {
          ...
          for (int i = 0; i < jsonArrayshotPresenceLabelAnnotations.size(); i++) {
            GoogleCloudVideointelligenceV1p3beta1LabelAnnotation.validateJsonElement(jsonArrayshotPresenceLabelAnnotations.get(i));
          };
        }
      }
      if (jsonObj.get("speechTranscriptions") != null && !jsonObj.get("speechTranscriptions").isJsonNull()) {
        ...
        if (jsonArrayspeechTranscriptions != null) {
          ...
          for (int i = 0; i < jsonArrayspeechTranscriptions.size(); i++) {
            GoogleCloudVideointelligenceV1p3beta1SpeechTranscription.validateJsonElement(jsonArrayspeechTranscriptions.get(i));
          };
        }
      }
      if (jsonObj.get("textAnnotations") != null && !jsonObj.get("textAnnotations").isJsonNull()) {
        ...
        if (jsonArraytextAnnotations != null) {
          ...
          for (int i = 0; i < jsonArraytextAnnotations.size(); i++) {
            GoogleCloudVideointelligenceV1p3beta1TextAnnotation.validateJsonElement(jsonArraytextAnnotations.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults>() {
           @Override
           public void write(JsonWriter out, GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults
   */
  public static GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults.class);
  }

  /**
   * Convert an instance of GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults to an JSON string
   *
   * @return JSON string
   */
