...
import org.openapitools.client.model.GoogleCloudVideointelligenceV1beta2SpeechContext;
...
public class GoogleCloudVideointelligenceV1beta2SpeechTranscriptionConfig {
  ...
  private List<GoogleCloudVideointelligenceV1beta2SpeechContext> speechContexts = new ArrayList<>();

  public GoogleCloudVideointelligenceV1beta2SpeechTranscriptionConfig() {
  }

  public GoogleCloudVideointelligenceV1beta2SpeechTranscriptionConfig audioTracks(List<Integer> audioTracks) {
    this.audioTracks = audioTracks;
    return this;
  }

  public GoogleCloudVideointelligenceV1beta2SpeechTranscriptionConfig addAudioTracksItem(Integer audioTracksItem) {
  ...
  public GoogleCloudVideointelligenceV1beta2SpeechTranscriptionConfig diarizationSpeakerCount(Integer diarizationSpeakerCount) {
  ...
  public GoogleCloudVideointelligenceV1beta2SpeechTranscriptionConfig enableAutomaticPunctuation(Boolean enableAutomaticPunctuation) {
  ...
  public GoogleCloudVideointelligenceV1beta2SpeechTranscriptionConfig enableSpeakerDiarization(Boolean enableSpeakerDiarization) {
  ...
  public GoogleCloudVideointelligenceV1beta2SpeechTranscriptionConfig enableWordConfidence(Boolean enableWordConfidence) {
  ...
  public GoogleCloudVideointelligenceV1beta2SpeechTranscriptionConfig filterProfanity(Boolean filterProfanity) {
  ...
  public GoogleCloudVideointelligenceV1beta2SpeechTranscriptionConfig languageCode(String languageCode) {
  ...
  public GoogleCloudVideointelligenceV1beta2SpeechTranscriptionConfig maxAlternatives(Integer maxAlternatives) {
  ...
  public GoogleCloudVideointelligenceV1beta2SpeechTranscriptionConfig speechContexts(List<GoogleCloudVideointelligenceV1beta2SpeechContext> speechContexts) {
    this.speechContexts = speechContexts;
    return this;
  }

  public GoogleCloudVideointelligenceV1beta2SpeechTranscriptionConfig addSpeechContextsItem(GoogleCloudVideointelligenceV1beta2SpeechContext speechContextsItem) {
  ...
  public void setSpeechContexts(List<GoogleCloudVideointelligenceV1beta2SpeechContext> speechContexts) {
    this.speechContexts = speechContexts;
  }
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudVideointelligenceV1beta2SpeechTranscriptionConfig googleCloudVideointelligenceV1beta2SpeechTranscriptionConfig = (GoogleCloudVideointelligenceV1beta2SpeechTranscriptionConfig) o;
    return Objects.equals(this.audioTracks, googleCloudVideointelligenceV1beta2SpeechTranscriptionConfig.audioTracks) &&
        Objects.equals(this.diarizationSpeakerCount, googleCloudVideointelligenceV1beta2SpeechTranscriptionConfig.diarizationSpeakerCount) &&
        Objects.equals(this.enableAutomaticPunctuation, googleCloudVideointelligenceV1beta2SpeechTranscriptionConfig.enableAutomaticPunctuation) &&
        Objects.equals(this.enableSpeakerDiarization, googleCloudVideointelligenceV1beta2SpeechTranscriptionConfig.enableSpeakerDiarization) &&
        Objects.equals(this.enableWordConfidence, googleCloudVideointelligenceV1beta2SpeechTranscriptionConfig.enableWordConfidence) &&
        Objects.equals(this.filterProfanity, googleCloudVideointelligenceV1beta2SpeechTranscriptionConfig.filterProfanity) &&
        Objects.equals(this.languageCode, googleCloudVideointelligenceV1beta2SpeechTranscriptionConfig.languageCode) &&
        Objects.equals(this.maxAlternatives, googleCloudVideointelligenceV1beta2SpeechTranscriptionConfig.maxAlternatives) &&
        Objects.equals(this.speechContexts, googleCloudVideointelligenceV1beta2SpeechTranscriptionConfig.speechContexts);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudVideointelligenceV1beta2SpeechTranscriptionConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudVideointelligenceV1beta2SpeechTranscriptionConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudVideointelligenceV1beta2SpeechTranscriptionConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudVideointelligenceV1beta2SpeechTranscriptionConfig is not found in the empty JSON string", GoogleCloudVideointelligenceV1beta2SpeechTranscriptionConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudVideointelligenceV1beta2SpeechTranscriptionConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudVideointelligenceV1beta2SpeechTranscriptionConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("speechContexts") != null && !jsonObj.get("speechContexts").isJsonNull()) {
        ...
        if (jsonArrayspeechContexts != null) {
          ...
          for (int i = 0; i < jsonArrayspeechContexts.size(); i++) {
            GoogleCloudVideointelligenceV1beta2SpeechContext.validateJsonElement(jsonArrayspeechContexts.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudVideointelligenceV1beta2SpeechTranscriptionConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudVideointelligenceV1beta2SpeechTranscriptionConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudVideointelligenceV1beta2SpeechTranscriptionConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudVideointelligenceV1beta2SpeechTranscriptionConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudVideointelligenceV1beta2SpeechTranscriptionConfig>() {
           @Override
           public void write(JsonWriter out, GoogleCloudVideointelligenceV1beta2SpeechTranscriptionConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudVideointelligenceV1beta2SpeechTranscriptionConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudVideointelligenceV1beta2SpeechTranscriptionConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudVideointelligenceV1beta2SpeechTranscriptionConfig
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudVideointelligenceV1beta2SpeechTranscriptionConfig
   */
  public static GoogleCloudVideointelligenceV1beta2SpeechTranscriptionConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudVideointelligenceV1beta2SpeechTranscriptionConfig.class);
  }

  /**
   * Convert an instance of GoogleCloudVideointelligenceV1beta2SpeechTranscriptionConfig to an JSON string
   *
   * @return JSON string
   */
