...
import org.openapitools.client.model.GoogleCloudVideointelligenceV1beta2VideoContext;
...
public class GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest {
  ...
  public GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest features(List<FeaturesEnum> features) {
    this.features = features;
    return this;
  }

  public GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest addFeaturesItem(FeaturesEnum featuresItem) {
  ...
  public GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest inputContent(byte[] inputContent) {
  ...
  public GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest inputUri(String inputUri) {
  ...
  public GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest locationId(String locationId) {
  ...
  public GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest outputUri(String outputUri) {
  ...
  public GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest videoContext(GoogleCloudVideointelligenceV1beta2VideoContext videoContext) {
  ...
  public void setVideoContext(GoogleCloudVideointelligenceV1beta2VideoContext videoContext) {
    this.videoContext = videoContext;
  }
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest googleCloudVideointelligenceV1beta2AnnotateVideoRequest = (GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest) o;
    return Objects.equals(this.features, googleCloudVideointelligenceV1beta2AnnotateVideoRequest.features) &&
        Arrays.equals(this.inputContent, googleCloudVideointelligenceV1beta2AnnotateVideoRequest.inputContent) &&
        Objects.equals(this.inputUri, googleCloudVideointelligenceV1beta2AnnotateVideoRequest.inputUri) &&
        Objects.equals(this.locationId, googleCloudVideointelligenceV1beta2AnnotateVideoRequest.locationId) &&
        Objects.equals(this.outputUri, googleCloudVideointelligenceV1beta2AnnotateVideoRequest.outputUri) &&
        Objects.equals(this.videoContext, googleCloudVideointelligenceV1beta2AnnotateVideoRequest.videoContext);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest is not found in the empty JSON string", GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("videoContext") != null && !jsonObj.get("videoContext").isJsonNull()) {
        GoogleCloudVideointelligenceV1beta2VideoContext.validateJsonElement(jsonObj.get("videoContext"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest>() {
           @Override
           public void write(JsonWriter out, GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest
   */
  public static GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest.class);
  }

  /**
   * Convert an instance of GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest to an JSON string
   *
   * @return JSON string
   */
