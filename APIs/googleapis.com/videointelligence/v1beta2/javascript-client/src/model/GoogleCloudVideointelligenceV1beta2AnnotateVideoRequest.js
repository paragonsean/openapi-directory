...
/**
 * The GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest model module.
 * @module model/GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest
 * @version v1beta2
 */
class GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest {
    /**
     * Constructs a new <code>GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest</code>.
     * Video annotation request.
     * @alias module:model/GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest
     */
    constructor() { 
        
        GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest} obj Optional instance to populate.
     * @return {module:model/GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest} The populated <code>GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest();
            ...
            if (data.hasOwnProperty('videoContext')) {
                obj['videoContext'] = GoogleCloudVideointelligenceV1beta2VideoContext.constructFromObject(data['videoContext']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest</code>.
     */
    static validateJSON(data) {
        ...
        if (data['videoContext']) { // data not null
          GoogleCloudVideointelligenceV1beta2VideoContext.validateJSON(data['videoContext']);
        }
 ...
 * @member {Array.<module:model/GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest.FeaturesEnum>} features
 */
GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest.prototype['features'] = undefined;
 ...
 */
GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest.prototype['inputContent'] = undefined;
 ...
 */
GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest.prototype['inputUri'] = undefined;
 ...
 */
GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest.prototype['locationId'] = undefined;
 ...
 */
GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest.prototype['outputUri'] = undefined;

/**
 * @member {module:model/GoogleCloudVideointelligenceV1beta2VideoContext} videoContext
 */
GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest.prototype['videoContext'] = undefined;
 ...
 * @readonly
 */
GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest['FeaturesEnum'] = {
...
export default GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest;
