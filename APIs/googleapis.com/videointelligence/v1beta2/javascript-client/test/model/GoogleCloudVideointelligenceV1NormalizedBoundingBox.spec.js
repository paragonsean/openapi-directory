...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudVideoIntelligenceApi.GoogleCloudVideointelligenceV1NormalizedBoundingBox();
  });
  ...
  describe('GoogleCloudVideointelligenceV1NormalizedBoundingBox', function() {
    it('should create an instance of GoogleCloudVideointelligenceV1NormalizedBoundingBox', function() {
      // uncomment below and update the code to test GoogleCloudVideointelligenceV1NormalizedBoundingBox
      //var instance = new CloudVideoIntelligenceApi.GoogleCloudVideointelligenceV1NormalizedBoundingBox();
      //expect(instance).to.be.a(CloudVideoIntelligenceApi.GoogleCloudVideointelligenceV1NormalizedBoundingBox);
    });
