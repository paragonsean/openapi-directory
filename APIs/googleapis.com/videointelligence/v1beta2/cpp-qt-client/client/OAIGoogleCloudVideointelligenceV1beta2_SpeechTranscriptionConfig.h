...
/*
 * OAIGoogleCloudVideointelligenceV1beta2_SpeechTranscriptionConfig.h
 *
 * Config for SPEECH_TRANSCRIPTION.
 */

#ifndef OAIGoogleCloudVideointelligenceV1beta2_SpeechTranscriptionConfig_H
#define OAIGoogleCloudVideointelligenceV1beta2_SpeechTranscriptionConfig_H
...
namespace OpenAPI {
class OAIGoogleCloudVideointelligenceV1beta2_SpeechContext;

class OAIGoogleCloudVideointelligenceV1beta2_SpeechTranscriptionConfig : public OAIObject {
public:
    OAIGoogleCloudVideointelligenceV1beta2_SpeechTranscriptionConfig();
    OAIGoogleCloudVideointelligenceV1beta2_SpeechTranscriptionConfig(QString json);
    ~OAIGoogleCloudVideointelligenceV1beta2_SpeechTranscriptionConfig() override;
    ...
    QList<OAIGoogleCloudVideointelligenceV1beta2_SpeechContext> getSpeechContexts() const;
    void setSpeechContexts(const QList<OAIGoogleCloudVideointelligenceV1beta2_SpeechContext> &speech_contexts);
...
private:
    ...
    QList<OAIGoogleCloudVideointelligenceV1beta2_SpeechContext> m_speech_contexts;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudVideointelligenceV1beta2_SpeechTranscriptionConfig)

#endif // OAIGoogleCloudVideointelligenceV1beta2_SpeechTranscriptionConfig_H
