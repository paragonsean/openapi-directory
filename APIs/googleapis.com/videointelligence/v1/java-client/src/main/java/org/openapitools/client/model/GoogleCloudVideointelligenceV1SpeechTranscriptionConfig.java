...
import org.openapitools.client.model.GoogleCloudVideointelligenceV1SpeechContext;
...
public class GoogleCloudVideointelligenceV1SpeechTranscriptionConfig {
  ...
  private List<GoogleCloudVideointelligenceV1SpeechContext> speechContexts = new ArrayList<>();

  public GoogleCloudVideointelligenceV1SpeechTranscriptionConfig() {
  }

  public GoogleCloudVideointelligenceV1SpeechTranscriptionConfig audioTracks(List<Integer> audioTracks) {
    this.audioTracks = audioTracks;
    return this;
  }

  public GoogleCloudVideointelligenceV1SpeechTranscriptionConfig addAudioTracksItem(Integer audioTracksItem) {
  ...
  public GoogleCloudVideointelligenceV1SpeechTranscriptionConfig diarizationSpeakerCount(Integer diarizationSpeakerCount) {
  ...
  public GoogleCloudVideointelligenceV1SpeechTranscriptionConfig enableAutomaticPunctuation(Boolean enableAutomaticPunctuation) {
  ...
  public GoogleCloudVideointelligenceV1SpeechTranscriptionConfig enableSpeakerDiarization(Boolean enableSpeakerDiarization) {
  ...
  public GoogleCloudVideointelligenceV1SpeechTranscriptionConfig enableWordConfidence(Boolean enableWordConfidence) {
  ...
  public GoogleCloudVideointelligenceV1SpeechTranscriptionConfig filterProfanity(Boolean filterProfanity) {
  ...
  public GoogleCloudVideointelligenceV1SpeechTranscriptionConfig languageCode(String languageCode) {
  ...
  public GoogleCloudVideointelligenceV1SpeechTranscriptionConfig maxAlternatives(Integer maxAlternatives) {
  ...
  public GoogleCloudVideointelligenceV1SpeechTranscriptionConfig speechContexts(List<GoogleCloudVideointelligenceV1SpeechContext> speechContexts) {
    this.speechContexts = speechContexts;
    return this;
  }

  public GoogleCloudVideointelligenceV1SpeechTranscriptionConfig addSpeechContextsItem(GoogleCloudVideointelligenceV1SpeechContext speechContextsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<GoogleCloudVideointelligenceV1SpeechContext> getSpeechContexts() {
    return speechContexts;
  }

  public void setSpeechContexts(List<GoogleCloudVideointelligenceV1SpeechContext> speechContexts) {
    this.speechContexts = speechContexts;
  }
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudVideointelligenceV1SpeechTranscriptionConfig googleCloudVideointelligenceV1SpeechTranscriptionConfig = (GoogleCloudVideointelligenceV1SpeechTranscriptionConfig) o;
    return Objects.equals(this.audioTracks, googleCloudVideointelligenceV1SpeechTranscriptionConfig.audioTracks) &&
        Objects.equals(this.diarizationSpeakerCount, googleCloudVideointelligenceV1SpeechTranscriptionConfig.diarizationSpeakerCount) &&
        Objects.equals(this.enableAutomaticPunctuation, googleCloudVideointelligenceV1SpeechTranscriptionConfig.enableAutomaticPunctuation) &&
        Objects.equals(this.enableSpeakerDiarization, googleCloudVideointelligenceV1SpeechTranscriptionConfig.enableSpeakerDiarization) &&
        Objects.equals(this.enableWordConfidence, googleCloudVideointelligenceV1SpeechTranscriptionConfig.enableWordConfidence) &&
        Objects.equals(this.filterProfanity, googleCloudVideointelligenceV1SpeechTranscriptionConfig.filterProfanity) &&
        Objects.equals(this.languageCode, googleCloudVideointelligenceV1SpeechTranscriptionConfig.languageCode) &&
        Objects.equals(this.maxAlternatives, googleCloudVideointelligenceV1SpeechTranscriptionConfig.maxAlternatives) &&
        Objects.equals(this.speechContexts, googleCloudVideointelligenceV1SpeechTranscriptionConfig.speechContexts);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudVideointelligenceV1SpeechTranscriptionConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudVideointelligenceV1SpeechTranscriptionConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudVideointelligenceV1SpeechTranscriptionConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudVideointelligenceV1SpeechTranscriptionConfig is not found in the empty JSON string", GoogleCloudVideointelligenceV1SpeechTranscriptionConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudVideointelligenceV1SpeechTranscriptionConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudVideointelligenceV1SpeechTranscriptionConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("speechContexts") != null && !jsonObj.get("speechContexts").isJsonNull()) {
        ...
        if (jsonArrayspeechContexts != null) {
          ...
          for (int i = 0; i < jsonArrayspeechContexts.size(); i++) {
            GoogleCloudVideointelligenceV1SpeechContext.validateJsonElement(jsonArrayspeechContexts.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudVideointelligenceV1SpeechTranscriptionConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudVideointelligenceV1SpeechTranscriptionConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudVideointelligenceV1SpeechTranscriptionConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudVideointelligenceV1SpeechTranscriptionConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudVideointelligenceV1SpeechTranscriptionConfig>() {
           @Override
           public void write(JsonWriter out, GoogleCloudVideointelligenceV1SpeechTranscriptionConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudVideointelligenceV1SpeechTranscriptionConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudVideointelligenceV1SpeechTranscriptionConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudVideointelligenceV1SpeechTranscriptionConfig
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudVideointelligenceV1SpeechTranscriptionConfig
   */
  public static GoogleCloudVideointelligenceV1SpeechTranscriptionConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudVideointelligenceV1SpeechTranscriptionConfig.class);
  }

  /**
   * Convert an instance of GoogleCloudVideointelligenceV1SpeechTranscriptionConfig to an JSON string
   *
   * @return JSON string
   */
