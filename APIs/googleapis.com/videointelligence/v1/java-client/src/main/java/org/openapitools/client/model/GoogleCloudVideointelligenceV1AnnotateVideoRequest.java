...
public class GoogleCloudVideointelligenceV1AnnotateVideoRequest {
  ...
  public GoogleCloudVideointelligenceV1AnnotateVideoRequest() {
  }

  public GoogleCloudVideointelligenceV1AnnotateVideoRequest features(List<FeaturesEnum> features) {
    this.features = features;
    return this;
  }

  public GoogleCloudVideointelligenceV1AnnotateVideoRequest addFeaturesItem(FeaturesEnum featuresItem) {
  ...
  public GoogleCloudVideointelligenceV1AnnotateVideoRequest inputContent(byte[] inputContent) {
  ...
  public GoogleCloudVideointelligenceV1AnnotateVideoRequest inputUri(String inputUri) {
  ...
  public GoogleCloudVideointelligenceV1AnnotateVideoRequest locationId(String locationId) {
  ...
  public GoogleCloudVideointelligenceV1AnnotateVideoRequest outputUri(String outputUri) {
  ...
  public GoogleCloudVideointelligenceV1AnnotateVideoRequest videoContext(GoogleCloudVideointelligenceV1VideoContext videoContext) {
  ...
  public void setVideoContext(GoogleCloudVideointelligenceV1VideoContext videoContext) {
    this.videoContext = videoContext;
  }
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudVideointelligenceV1AnnotateVideoRequest googleCloudVideointelligenceV1AnnotateVideoRequest = (GoogleCloudVideointelligenceV1AnnotateVideoRequest) o;
    return Objects.equals(this.features, googleCloudVideointelligenceV1AnnotateVideoRequest.features) &&
        Arrays.equals(this.inputContent, googleCloudVideointelligenceV1AnnotateVideoRequest.inputContent) &&
        Objects.equals(this.inputUri, googleCloudVideointelligenceV1AnnotateVideoRequest.inputUri) &&
        Objects.equals(this.locationId, googleCloudVideointelligenceV1AnnotateVideoRequest.locationId) &&
        Objects.equals(this.outputUri, googleCloudVideointelligenceV1AnnotateVideoRequest.outputUri) &&
        Objects.equals(this.videoContext, googleCloudVideointelligenceV1AnnotateVideoRequest.videoContext);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudVideointelligenceV1AnnotateVideoRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudVideointelligenceV1AnnotateVideoRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudVideointelligenceV1AnnotateVideoRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudVideointelligenceV1AnnotateVideoRequest is not found in the empty JSON string", GoogleCloudVideointelligenceV1AnnotateVideoRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudVideointelligenceV1AnnotateVideoRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudVideointelligenceV1AnnotateVideoRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("videoContext") != null && !jsonObj.get("videoContext").isJsonNull()) {
        GoogleCloudVideointelligenceV1VideoContext.validateJsonElement(jsonObj.get("videoContext"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudVideointelligenceV1AnnotateVideoRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudVideointelligenceV1AnnotateVideoRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudVideointelligenceV1AnnotateVideoRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudVideointelligenceV1AnnotateVideoRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudVideointelligenceV1AnnotateVideoRequest>() {
           @Override
           public void write(JsonWriter out, GoogleCloudVideointelligenceV1AnnotateVideoRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudVideointelligenceV1AnnotateVideoRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudVideointelligenceV1AnnotateVideoRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudVideointelligenceV1AnnotateVideoRequest
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudVideointelligenceV1AnnotateVideoRequest
   */
  public static GoogleCloudVideointelligenceV1AnnotateVideoRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudVideointelligenceV1AnnotateVideoRequest.class);
  }

  /**
   * Convert an instance of GoogleCloudVideointelligenceV1AnnotateVideoRequest to an JSON string
   *
   * @return JSON string
   */
