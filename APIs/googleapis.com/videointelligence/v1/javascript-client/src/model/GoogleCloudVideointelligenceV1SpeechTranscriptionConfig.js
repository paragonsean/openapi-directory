...
/**
 * The GoogleCloudVideointelligenceV1SpeechTranscriptionConfig model module.
 * @module model/GoogleCloudVideointelligenceV1SpeechTranscriptionConfig
 * @version v1
 */
class GoogleCloudVideointelligenceV1SpeechTranscriptionConfig {
    /**
     * Constructs a new <code>GoogleCloudVideointelligenceV1SpeechTranscriptionConfig</code>.
     * Config for SPEECH_TRANSCRIPTION.
     * @alias module:model/GoogleCloudVideointelligenceV1SpeechTranscriptionConfig
     */
    constructor() { 
        
        GoogleCloudVideointelligenceV1SpeechTranscriptionConfig.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudVideointelligenceV1SpeechTranscriptionConfig</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudVideointelligenceV1SpeechTranscriptionConfig} obj Optional instance to populate.
     * @return {module:model/GoogleCloudVideointelligenceV1SpeechTranscriptionConfig} The populated <code>GoogleCloudVideointelligenceV1SpeechTranscriptionConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudVideointelligenceV1SpeechTranscriptionConfig();
            ...
            if (data.hasOwnProperty('speechContexts')) {
                obj['speechContexts'] = ApiClient.convertToType(data['speechContexts'], [GoogleCloudVideointelligenceV1SpeechContext]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudVideointelligenceV1SpeechTranscriptionConfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudVideointelligenceV1SpeechTranscriptionConfig</code>.
     */
    static validateJSON(data) {
        ...
        if (data['speechContexts']) { // data not null
            ...
            for (const item of data['speechContexts']) {
                GoogleCloudVideointelligenceV1SpeechContext.validateJSON(item);
            };
        }
 ...
 */
GoogleCloudVideointelligenceV1SpeechTranscriptionConfig.prototype['audioTracks'] = undefined;
 ...
 */
GoogleCloudVideointelligenceV1SpeechTranscriptionConfig.prototype['diarizationSpeakerCount'] = undefined;
 ...
 */
GoogleCloudVideointelligenceV1SpeechTranscriptionConfig.prototype['enableAutomaticPunctuation'] = undefined;
 ...
 */
GoogleCloudVideointelligenceV1SpeechTranscriptionConfig.prototype['enableSpeakerDiarization'] = undefined;
 ...
 */
GoogleCloudVideointelligenceV1SpeechTranscriptionConfig.prototype['enableWordConfidence'] = undefined;

/**
 * Optional. If set to `true`, the server will attempt to filter out profanities, replacing all but the initial character in each filtered word with asterisks, e.g. \"f***\". If set to `false` or omitted, profanities won't be filtered out.
 * @member {Boolean} filterProfanity
 */
GoogleCloudVideointelligenceV1SpeechTranscriptionConfig.prototype['filterProfanity'] = undefined;
 ...
 */
GoogleCloudVideointelligenceV1SpeechTranscriptionConfig.prototype['languageCode'] = undefined;
 ...
 */
GoogleCloudVideointelligenceV1SpeechTranscriptionConfig.prototype['maxAlternatives'] = undefined;

/**
 * Optional. A means to provide context to assist the speech recognition.
 * @member {Array.<module:model/GoogleCloudVideointelligenceV1SpeechContext>} speechContexts
 */
GoogleCloudVideointelligenceV1SpeechTranscriptionConfig.prototype['speechContexts'] = undefined;
...
export default GoogleCloudVideointelligenceV1SpeechTranscriptionConfig;
