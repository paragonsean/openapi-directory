...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudVideoIntelligenceApi.GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults();
  });
  ...
  describe('GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults', function() {
    it('should create an instance of GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults', function() {
      // uncomment below and update the code to test GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults
      //var instance = new CloudVideoIntelligenceApi.GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults();
      //expect(instance).to.be.a(CloudVideoIntelligenceApi.GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults);
    });

    it('should have the property celebrityRecognitionAnnotations (base name: "celebrityRecognitionAnnotations")', function() {
      // uncomment below and update the code to test the property celebrityRecognitionAnnotations
      //var instance = new CloudVideoIntelligenceApi.GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults();
