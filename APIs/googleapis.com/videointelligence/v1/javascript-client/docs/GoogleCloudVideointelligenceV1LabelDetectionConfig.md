# CloudVideoIntelligenceApi.GoogleCloudVideointelligenceV1LabelDetectionConfig
...
**labelDetectionMode** | **String** | What labels should be detected with LABEL_DETECTION, in addition to video-level labels or segment-level labels. If unspecified, defaults to &#x60;SHOT_MODE&#x60;. | [optional] 
...
* `LABEL_DETECTION_MODE_UNSPECIFIED` (value: `"LABEL_DETECTION_MODE_UNSPECIFIED"`)

* `SHOT_MODE` (value: `"SHOT_MODE"`)

* `FRAME_MODE` (value: `"FRAME_MODE"`)

* `SHOT_AND_FRAME_MODE` (value: `"SHOT_AND_FRAME_MODE"`)
