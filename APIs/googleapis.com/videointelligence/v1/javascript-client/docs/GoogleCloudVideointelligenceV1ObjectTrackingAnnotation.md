# CloudVideoIntelligenceApi.GoogleCloudVideointelligenceV1ObjectTrackingAnnotation
...
**frames** | [**[GoogleCloudVideointelligenceV1ObjectTrackingFrame]**](GoogleCloudVideointelligenceV1ObjectTrackingFrame.md) | Information corresponding to all frames where this object track appears. Non-streaming batch mode: it may be one or multiple ObjectTrackingFrame messages in frames. Streaming mode: it can only be one ObjectTrackingFrame message in frames. | [optional] 
