...
/*
 * OAIGoogleCloudVideointelligenceV1_AnnotateVideoRequest.h
 *
 * Video annotation request.
 */

#ifndef OAIGoogleCloudVideointelligenceV1_AnnotateVideoRequest_H
#define OAIGoogleCloudVideointelligenceV1_AnnotateVideoRequest_H

#include <QJsonObject>

#include "OAIGoogleCloudVideointelligenceV1_VideoContext.h"
#include <QByteArray>
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAIGoogleCloudVideointelligenceV1_VideoContext;

class OAIGoogleCloudVideointelligenceV1_AnnotateVideoRequest : public OAIObject {
public:
    OAIGoogleCloudVideointelligenceV1_AnnotateVideoRequest();
    OAIGoogleCloudVideointelligenceV1_AnnotateVideoRequest(QString json);
    ~OAIGoogleCloudVideointelligenceV1_AnnotateVideoRequest() override;
    ...
    OAIGoogleCloudVideointelligenceV1_VideoContext getVideoContext() const;
    void setVideoContext(const OAIGoogleCloudVideointelligenceV1_VideoContext &video_context);
...
private:
    ...
    OAIGoogleCloudVideointelligenceV1_VideoContext m_video_context;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudVideointelligenceV1_AnnotateVideoRequest)

#endif // OAIGoogleCloudVideointelligenceV1_AnnotateVideoRequest_H
