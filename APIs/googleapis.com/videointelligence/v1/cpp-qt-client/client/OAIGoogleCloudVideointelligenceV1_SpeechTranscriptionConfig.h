...
/*
 * OAIGoogleCloudVideointelligenceV1_SpeechTranscriptionConfig.h
 *
 * Config for SPEECH_TRANSCRIPTION.
 */

#ifndef OAIGoogleCloudVideointelligenceV1_SpeechTranscriptionConfig_H
#define OAIGoogleCloudVideointelligenceV1_SpeechTranscriptionConfig_H
...
namespace OpenAPI {
class OAIGoogleCloudVideointelligenceV1_SpeechContext;

class OAIGoogleCloudVideointelligenceV1_SpeechTranscriptionConfig : public OAIObject {
public:
    OAIGoogleCloudVideointelligenceV1_SpeechTranscriptionConfig();
    OAIGoogleCloudVideointelligenceV1_SpeechTranscriptionConfig(QString json);
    ~OAIGoogleCloudVideointelligenceV1_SpeechTranscriptionConfig() override;
    ...
    QList<OAIGoogleCloudVideointelligenceV1_SpeechContext> getSpeechContexts() const;
    void setSpeechContexts(const QList<OAIGoogleCloudVideointelligenceV1_SpeechContext> &speech_contexts);
...
private:
    ...
    QList<OAIGoogleCloudVideointelligenceV1_SpeechContext> m_speech_contexts;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudVideointelligenceV1_SpeechTranscriptionConfig)

#endif // OAIGoogleCloudVideointelligenceV1_SpeechTranscriptionConfig_H
