...
void OAIVideosApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("videointelligence_videos_annotate", defaultConf);
    _serverIndices.insert("videointelligence_videos_annotate", 0);
}
...
void OAIVideosApi::videointelligence_videos_annotate(const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<OAIGoogleCloudVideointelligenceV1_AnnotateVideoRequest> &oai_google_cloud_videointelligence_v1_annotate_video_request) {
    ...
    if (oai_google_cloud_videointelligence_v1_annotate_video_request.hasValue()){

        
        QByteArray output = oai_google_cloud_videointelligence_v1_annotate_video_request.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVideosApi::videointelligence_videos_annotateCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVideosApi::videointelligence_videos_annotateCallback);
...
void OAIVideosApi::videointelligence_videos_annotateCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT videointelligence_videos_annotateSignal(output);
        Q_EMIT videointelligence_videos_annotateSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT videointelligence_videos_annotateSignalE(output, error_type, error_str);
        Q_EMIT videointelligence_videos_annotateSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT videointelligence_videos_annotateSignalError(output, error_type, error_str);
        Q_EMIT videointelligence_videos_annotateSignalErrorFull(worker, error_type, error_str);
    }
}
