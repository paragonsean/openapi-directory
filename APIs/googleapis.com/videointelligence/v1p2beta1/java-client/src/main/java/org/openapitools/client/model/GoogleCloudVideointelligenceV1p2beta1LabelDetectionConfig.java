...
public class GoogleCloudVideointelligenceV1p2beta1LabelDetectionConfig {
  ...
  public GoogleCloudVideointelligenceV1p2beta1LabelDetectionConfig frameConfidenceThreshold(Float frameConfidenceThreshold) {
  ...
  public GoogleCloudVideointelligenceV1p2beta1LabelDetectionConfig labelDetectionMode(LabelDetectionModeEnum labelDetectionMode) {
  ...
  public GoogleCloudVideointelligenceV1p2beta1LabelDetectionConfig model(String model) {
    this.model = model;
    return this;
  }
  ...
  public GoogleCloudVideointelligenceV1p2beta1LabelDetectionConfig stationaryCamera(Boolean stationaryCamera) {
  ...
  public GoogleCloudVideointelligenceV1p2beta1LabelDetectionConfig videoConfidenceThreshold(Float videoConfidenceThreshold) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudVideointelligenceV1p2beta1LabelDetectionConfig googleCloudVideointelligenceV1p2beta1LabelDetectionConfig = (GoogleCloudVideointelligenceV1p2beta1LabelDetectionConfig) o;
    return Objects.equals(this.frameConfidenceThreshold, googleCloudVideointelligenceV1p2beta1LabelDetectionConfig.frameConfidenceThreshold) &&
        Objects.equals(this.labelDetectionMode, googleCloudVideointelligenceV1p2beta1LabelDetectionConfig.labelDetectionMode) &&
        Objects.equals(this.model, googleCloudVideointelligenceV1p2beta1LabelDetectionConfig.model) &&
        Objects.equals(this.stationaryCamera, googleCloudVideointelligenceV1p2beta1LabelDetectionConfig.stationaryCamera) &&
        Objects.equals(this.videoConfidenceThreshold, googleCloudVideointelligenceV1p2beta1LabelDetectionConfig.videoConfidenceThreshold);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudVideointelligenceV1p2beta1LabelDetectionConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudVideointelligenceV1p2beta1LabelDetectionConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudVideointelligenceV1p2beta1LabelDetectionConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudVideointelligenceV1p2beta1LabelDetectionConfig is not found in the empty JSON string", GoogleCloudVideointelligenceV1p2beta1LabelDetectionConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudVideointelligenceV1p2beta1LabelDetectionConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudVideointelligenceV1p2beta1LabelDetectionConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudVideointelligenceV1p2beta1LabelDetectionConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudVideointelligenceV1p2beta1LabelDetectionConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudVideointelligenceV1p2beta1LabelDetectionConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudVideointelligenceV1p2beta1LabelDetectionConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudVideointelligenceV1p2beta1LabelDetectionConfig>() {
           @Override
           public void write(JsonWriter out, GoogleCloudVideointelligenceV1p2beta1LabelDetectionConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudVideointelligenceV1p2beta1LabelDetectionConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudVideointelligenceV1p2beta1LabelDetectionConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudVideointelligenceV1p2beta1LabelDetectionConfig
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudVideointelligenceV1p2beta1LabelDetectionConfig
   */
  public static GoogleCloudVideointelligenceV1p2beta1LabelDetectionConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudVideointelligenceV1p2beta1LabelDetectionConfig.class);
  }

  /**
   * Convert an instance of GoogleCloudVideointelligenceV1p2beta1LabelDetectionConfig to an JSON string
   *
   * @return JSON string
   */
