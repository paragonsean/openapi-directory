...
- API version: v1p2beta1
  - Build date: 2024-10-12T11:50:43.288649-04:00[America/New_York]
...
```groovy
  ...
  dependencies {
     implementation "org.openapitools:openapi-java-client:v1p2beta1"
  }
```
...
* `target/openapi-java-client-v1p2beta1.jar`
* `target/lib/*.jar`
...
------------ | ------------- | ------------- | -------------
*VideosApi* | [**videointelligenceVideosAnnotate**](docs/VideosApi.md#videointelligenceVideosAnnotate) | **POST** /v1p2beta1/videos:annotate | 
...
## Documentation for Models
 ...
 - [GoogleCloudVideointelligenceV1p2beta1AnnotateVideoRequest](docs/GoogleCloudVideointelligenceV1p2beta1AnnotateVideoRequest.md)
 ...
 - [GoogleCloudVideointelligenceV1p2beta1ExplicitContentDetectionConfig](docs/GoogleCloudVideointelligenceV1p2beta1ExplicitContentDetectionConfig.md)
 ...
 - [GoogleCloudVideointelligenceV1p2beta1FaceDetectionConfig](docs/GoogleCloudVideointelligenceV1p2beta1FaceDetectionConfig.md)
 ...
 - [GoogleCloudVideointelligenceV1p2beta1LabelDetectionConfig](docs/GoogleCloudVideointelligenceV1p2beta1LabelDetectionConfig.md)
 ...
 - [GoogleCloudVideointelligenceV1p2beta1ObjectTrackingConfig](docs/GoogleCloudVideointelligenceV1p2beta1ObjectTrackingConfig.md)
 ...
 - [GoogleCloudVideointelligenceV1p2beta1PersonDetectionConfig](docs/GoogleCloudVideointelligenceV1p2beta1PersonDetectionConfig.md)
 - [GoogleCloudVideointelligenceV1p2beta1ShotChangeDetectionConfig](docs/GoogleCloudVideointelligenceV1p2beta1ShotChangeDetectionConfig.md)
 - [GoogleCloudVideointelligenceV1p2beta1SpeechContext](docs/GoogleCloudVideointelligenceV1p2beta1SpeechContext.md)
 ...
 - [GoogleCloudVideointelligenceV1p2beta1SpeechTranscriptionConfig](docs/GoogleCloudVideointelligenceV1p2beta1SpeechTranscriptionConfig.md)
 - [GoogleCloudVideointelligenceV1p2beta1TextAnnotation](docs/GoogleCloudVideointelligenceV1p2beta1TextAnnotation.md)
 - [GoogleCloudVideointelligenceV1p2beta1TextDetectionConfig](docs/GoogleCloudVideointelligenceV1p2beta1TextDetectionConfig.md)
 ...
 - [GoogleCloudVideointelligenceV1p2beta1VideoContext](docs/GoogleCloudVideointelligenceV1p2beta1VideoContext.md)
