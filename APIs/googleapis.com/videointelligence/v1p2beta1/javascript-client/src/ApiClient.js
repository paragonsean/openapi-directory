...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://videointelligence.googleapis.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://videointelligence.googleapis.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/v1p2beta1/Javascript'
        };
