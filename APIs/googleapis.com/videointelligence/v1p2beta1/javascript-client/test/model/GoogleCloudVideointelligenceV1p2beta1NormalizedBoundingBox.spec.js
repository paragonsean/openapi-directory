...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudVideoIntelligenceApi.GoogleCloudVideointelligenceV1p2beta1NormalizedBoundingBox();
  });
  ...
  describe('GoogleCloudVideointelligenceV1p2beta1NormalizedBoundingBox', function() {
    it('should create an instance of GoogleCloudVideointelligenceV1p2beta1NormalizedBoundingBox', function() {
      // uncomment below and update the code to test GoogleCloudVideointelligenceV1p2beta1NormalizedBoundingBox
      //var instance = new CloudVideoIntelligenceApi.GoogleCloudVideointelligenceV1p2beta1NormalizedBoundingBox();
      //expect(instance).to.be.a(CloudVideoIntelligenceApi.GoogleCloudVideointelligenceV1p2beta1NormalizedBoundingBox);
    });
