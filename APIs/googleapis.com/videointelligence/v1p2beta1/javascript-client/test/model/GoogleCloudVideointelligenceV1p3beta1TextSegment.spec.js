...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudVideoIntelligenceApi.GoogleCloudVideointelligenceV1p3beta1TextSegment();
  });
  ...
  describe('GoogleCloudVideointelligenceV1p3beta1TextSegment', function() {
    it('should create an instance of GoogleCloudVideointelligenceV1p3beta1TextSegment', function() {
      // uncomment below and update the code to test GoogleCloudVideointelligenceV1p3beta1TextSegment
      //var instance = new CloudVideoIntelligenceApi.GoogleCloudVideointelligenceV1p3beta1TextSegment();
      //expect(instance).to.be.a(CloudVideoIntelligenceApi.GoogleCloudVideointelligenceV1p3beta1TextSegment);
    });
