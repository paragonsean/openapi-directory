...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudVideoIntelligenceApi.GoogleCloudVideointelligenceV1p2beta1VideoAnnotationResults();
  });
  ...
  describe('GoogleCloudVideointelligenceV1p2beta1VideoAnnotationResults', function() {
    it('should create an instance of GoogleCloudVideointelligenceV1p2beta1VideoAnnotationResults', function() {
      // uncomment below and update the code to test GoogleCloudVideointelligenceV1p2beta1VideoAnnotationResults
      //var instance = new CloudVideoIntelligenceApi.GoogleCloudVideointelligenceV1p2beta1VideoAnnotationResults();
      //expect(instance).to.be.a(CloudVideoIntelligenceApi.GoogleCloudVideointelligenceV1p2beta1VideoAnnotationResults);
    });
