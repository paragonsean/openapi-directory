...
/*
 * OAIGoogleCloudVideointelligenceV1p3beta1_AnnotateVideoRequest.h
 *
 * Video annotation request.
 */

#ifndef OAIGoogleCloudVideointelligenceV1p3beta1_AnnotateVideoRequest_H
#define OAIGoogleCloudVideointelligenceV1p3beta1_AnnotateVideoRequest_H
...
namespace OpenAPI {
class OAIGoogleCloudVideointelligenceV1p3beta1_VideoContext;

class OAIGoogleCloudVideointelligenceV1p3beta1_AnnotateVideoRequest : public OAIObject {
public:
    OAIGoogleCloudVideointelligenceV1p3beta1_AnnotateVideoRequest();
    OAIGoogleCloudVideointelligenceV1p3beta1_AnnotateVideoRequest(QString json);
    ~OAIGoogleCloudVideointelligenceV1p3beta1_AnnotateVideoRequest() override;
    ...
    OAIGoogleCloudVideointelligenceV1p3beta1_VideoContext getVideoContext() const;
    void setVideoContext(const OAIGoogleCloudVideointelligenceV1p3beta1_VideoContext &video_context);
...
private:
    ...
    OAIGoogleCloudVideointelligenceV1p3beta1_VideoContext m_video_context;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudVideointelligenceV1p3beta1_AnnotateVideoRequest)

#endif // OAIGoogleCloudVideointelligenceV1p3beta1_AnnotateVideoRequest_H
