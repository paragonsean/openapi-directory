...
- API version: v1p3beta1
  - Build date: 2024-10-12T11:50:38.853834-04:00[America/New_York]
...
```groovy
  ...
  dependencies {
     implementation "org.openapitools:openapi-java-client:v1p3beta1"
  }
```
...
* `target/openapi-java-client-v1p3beta1.jar`
* `target/lib/*.jar`
...
------------ | ------------- | ------------- | -------------
*VideosApi* | [**videointelligenceVideosAnnotate**](docs/VideosApi.md#videointelligenceVideosAnnotate) | **POST** /v1p3beta1/videos:annotate | 
