...
public class ApiClient {
    ...
    private String basePath = "https://videointelligence.googleapis.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/v1p3beta1/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://videointelligence.googleapis.com
