...
/**
 * The GoogleCloudVideointelligenceV1p3beta1AnnotateVideoRequest model module.
 * @module model/GoogleCloudVideointelligenceV1p3beta1AnnotateVideoRequest
 * @version v1p3beta1
 */
class GoogleCloudVideointelligenceV1p3beta1AnnotateVideoRequest {
    /**
     * Constructs a new <code>GoogleCloudVideointelligenceV1p3beta1AnnotateVideoRequest</code>.
     * Video annotation request.
     * @alias module:model/GoogleCloudVideointelligenceV1p3beta1AnnotateVideoRequest
     */
    constructor() { 
        
        GoogleCloudVideointelligenceV1p3beta1AnnotateVideoRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudVideointelligenceV1p3beta1AnnotateVideoRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudVideointelligenceV1p3beta1AnnotateVideoRequest} obj Optional instance to populate.
     * @return {module:model/GoogleCloudVideointelligenceV1p3beta1AnnotateVideoRequest} The populated <code>GoogleCloudVideointelligenceV1p3beta1AnnotateVideoRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudVideointelligenceV1p3beta1AnnotateVideoRequest();
            ...
            if (data.hasOwnProperty('videoContext')) {
                obj['videoContext'] = GoogleCloudVideointelligenceV1p3beta1VideoContext.constructFromObject(data['videoContext']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudVideointelligenceV1p3beta1AnnotateVideoRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudVideointelligenceV1p3beta1AnnotateVideoRequest</code>.
     */
    static validateJSON(data) {
        ...
        if (data['videoContext']) { // data not null
          GoogleCloudVideointelligenceV1p3beta1VideoContext.validateJSON(data['videoContext']);
        }
 ...
 * @member {Array.<module:model/GoogleCloudVideointelligenceV1p3beta1AnnotateVideoRequest.FeaturesEnum>} features
 */
GoogleCloudVideointelligenceV1p3beta1AnnotateVideoRequest.prototype['features'] = undefined;
 ...
 */
GoogleCloudVideointelligenceV1p3beta1AnnotateVideoRequest.prototype['inputContent'] = undefined;
 ...
 */
GoogleCloudVideointelligenceV1p3beta1AnnotateVideoRequest.prototype['inputUri'] = undefined;
 ...
 */
GoogleCloudVideointelligenceV1p3beta1AnnotateVideoRequest.prototype['locationId'] = undefined;
 ...
 */
GoogleCloudVideointelligenceV1p3beta1AnnotateVideoRequest.prototype['outputUri'] = undefined;

/**
 * @member {module:model/GoogleCloudVideointelligenceV1p3beta1VideoContext} videoContext
 */
GoogleCloudVideointelligenceV1p3beta1AnnotateVideoRequest.prototype['videoContext'] = undefined;
 ...
 * @readonly
 */
GoogleCloudVideointelligenceV1p3beta1AnnotateVideoRequest['FeaturesEnum'] = {
...
export default GoogleCloudVideointelligenceV1p3beta1AnnotateVideoRequest;
