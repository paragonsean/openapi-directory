...
async def test_datamigration_projects_locations_connection_profiles_create(client):
    ...
    """
    body = {"createTime":"createTime","provider":"DATABASE_PROVIDER_UNSPECIFIED","cloudsql":{"settings":{"sourceId":"sourceId","dataDiskSizeGb":"dataDiskSizeGb","storageAutoResizeLimit":"storageAutoResizeLimit","databaseFlags":{"key":"databaseFlags"},"rootPasswordSet":True,"dataDiskType":"SQL_DATA_DISK_TYPE_UNSPECIFIED","activationPolicy":"SQL_ACTIVATION_POLICY_UNSPECIFIED","userLabels":{"key":"userLabels"},"databaseVersion":"SQL_DATABASE_VERSION_UNSPECIFIED","autoStorageIncrease":True,"ipConfig":{"requireSsl":True,"privateNetwork":"privateNetwork","authorizedNetworks":[{"expireTime":"expireTime","label":"label","ttl":"ttl","value":"value"},{"expireTime":"expireTime","label":"label","ttl":"ttl","value":"value"}],"enableIpv4":True},"tier":"tier","zone":"zone","rootPassword":"rootPassword"},"privateIp":"privateIp","cloudSqlId":"cloudSqlId","publicIp":"publicIp"},"displayName":"displayName","name":"name","mysql":{"password":"password","port":0,"cloudSqlId":"cloudSqlId","host":"host","passwordSet":True,"ssl":{"clientCertificate":"clientCertificate","clientKey":"clientKey","type":"SSL_TYPE_UNSPECIFIED","caCertificate":"caCertificate"},"username":"username"},"updateTime":"updateTime","state":"STATE_UNSPECIFIED","error":{"code":0,"details":[{"key":""},{"key":""}],"message":"message"},"labels":{"key":"labels"}}
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/{parent}/connectionProfiles'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_datamigration_projects_locations_migration_jobs_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/{parent}/migrationJobs'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_datamigration_projects_locations_migration_jobs_generate_ssh_script(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/{migration_jobgenerate_ssh_scrip}'.format(migration_job='migration_job_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_datamigration_projects_locations_migration_jobs_get_iam_policy(client):
...
async def test_datamigration_projects_locations_migration_jobs_promote(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/{namepromot}'.format(name='name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_datamigration_projects_locations_migration_jobs_set_iam_policy(client):
...
async def test_datamigration_projects_locations_migration_jobs_test_iam_permissions(client):
...
async def test_datamigration_projects_locations_migration_jobs_verify(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/{nameverif}'.format(name='name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_datamigration_projects_locations_operations_delete(client):
...
async def test_datamigration_projects_locations_operations_get(client):
