...
public class MigrationJob {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.createTime, migrationJob.createTime) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(createTime, destination, destinationDatabase, displayName, dumpPath, duration, endTime, error, labels, name, phase, reverseSshConnectivity, source, sourceDatabase, state, staticIpConnectivity, type, updateTime, vpcPeeringConnectivity);
  }
