...
> Operation datamigrationProjectsLocationsConnectionProfilesCreate(parent, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, connectionProfileId, requestId, skipValidation, validateOnly, connectionProfile)
...
public class Example {
  public static void main(String[] args) {
    ...
    String orderBy = "orderBy_example"; // String | A comma-separated list of fields to order results according to.
    Integer pageSize = 56; // Integer | The maximum number of connection profiles to return. The service may return fewer than this value. If unspecified, at most 50 connection profiles will be returned. The maximum value is 1000; values above 1000 are coerced to 1000.
...
| **pageSize** | **Integer**| The maximum number of connection profiles to return. The service may return fewer than this value. If unspecified, at most 50 connection profiles will be returned. The maximum value is 1000; values above 1000 are coerced to 1000. | [optional] |
...
<a id="datamigrationProjectsLocationsConversionWorkspacesApply"></a>
# **datamigrationProjectsLocationsConversionWorkspacesApply**
> Operation datamigrationProjectsLocationsConversionWorkspacesApply(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, applyConversionWorkspaceRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    ProjectsApi apiInstance = new ProjectsApi(defaultClient);
    String name = "name_example"; // String | Required. The name of the conversion workspace resource for which to apply the draft tree. Must be in the form of: projects/{project}/locations/{location}/conversionWorkspaces/{conversion_workspace}.
    String $xgafv = "1"; // String | V1 error format.
    String accessToken = "accessToken_example"; // String | OAuth access token.
    String alt = "json"; // String | Data format for response.
    String paramCallback = "paramCallback_example"; // String | JSONP
    ...
    String uploadProtocol = "uploadProtocol_example"; // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
    String uploadType = "uploadType_example"; // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
    ApplyConversionWorkspaceRequest applyConversionWorkspaceRequest = new ApplyConversionWorkspaceRequest(); // ApplyConversionWorkspaceRequest | 
    try {
      Operation result = apiInstance.datamigrationProjectsLocationsConversionWorkspacesApply(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, applyConversionWorkspaceRequest);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProjectsApi#datamigrationProjectsLocationsConversionWorkspacesApply");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="datamigrationProjectsLocationsConversionWorkspacesCommit"></a>
# **datamigrationProjectsLocationsConversionWorkspacesCommit**
> Operation datamigrationProjectsLocationsConversionWorkspacesCommit(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, commitConversionWorkspaceRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    ProjectsApi apiInstance = new ProjectsApi(defaultClient);
    String name = "name_example"; // String | Required. Name of the conversion workspace resource to commit.
    String $xgafv = "1"; // String | V1 error format.
    String accessToken = "accessToken_example"; // String | OAuth access token.
    String alt = "json"; // String | Data format for response.
    String paramCallback = "paramCallback_example"; // String | JSONP
    ...
    String uploadProtocol = "uploadProtocol_example"; // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
    String uploadType = "uploadType_example"; // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
    CommitConversionWorkspaceRequest commitConversionWorkspaceRequest = new CommitConversionWorkspaceRequest(); // CommitConversionWorkspaceRequest | 
    try {
      Operation result = apiInstance.datamigrationProjectsLocationsConversionWorkspacesCommit(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, commitConversionWorkspaceRequest);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProjectsApi#datamigrationProjectsLocationsConversionWorkspacesCommit");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="datamigrationProjectsLocationsConversionWorkspacesConvert"></a>
# **datamigrationProjectsLocationsConversionWorkspacesConvert**
> Operation datamigrationProjectsLocationsConversionWorkspacesConvert(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, convertConversionWorkspaceRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    ProjectsApi apiInstance = new ProjectsApi(defaultClient);
    String name = "name_example"; // String | Name of the conversion workspace resource to convert in the form of: projects/{project}/locations/{location}/conversionWorkspaces/{conversion_workspace}.
    String $xgafv = "1"; // String | V1 error format.
    String accessToken = "accessToken_example"; // String | OAuth access token.
    String alt = "json"; // String | Data format for response.
    String paramCallback = "paramCallback_example"; // String | JSONP
    ...
    String uploadProtocol = "uploadProtocol_example"; // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
    String uploadType = "uploadType_example"; // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
    ConvertConversionWorkspaceRequest convertConversionWorkspaceRequest = new ConvertConversionWorkspaceRequest(); // ConvertConversionWorkspaceRequest | 
    try {
      Operation result = apiInstance.datamigrationProjectsLocationsConversionWorkspacesConvert(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, convertConversionWorkspaceRequest);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProjectsApi#datamigrationProjectsLocationsConversionWorkspacesConvert");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="datamigrationProjectsLocationsConversionWorkspacesCreate"></a>
# **datamigrationProjectsLocationsConversionWorkspacesCreate**
> Operation datamigrationProjectsLocationsConversionWorkspacesCreate(parent, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, conversionWorkspaceId, requestId, conversionWorkspace)
...
public class Example {
  public static void main(String[] args) {
    ...
    ProjectsApi apiInstance = new ProjectsApi(defaultClient);
    String parent = "parent_example"; // String | Required. The parent which owns this collection of conversion workspaces.
    String $xgafv = "1"; // String | V1 error format.
    String accessToken = "accessToken_example"; // String | OAuth access token.
    String alt = "json"; // String | Data format for response.
    String paramCallback = "paramCallback_example"; // String | JSONP
    ...
    String uploadProtocol = "uploadProtocol_example"; // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
    String uploadType = "uploadType_example"; // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
    String conversionWorkspaceId = "conversionWorkspaceId_example"; // String | Required. The ID of the conversion workspace to create.
    String requestId = "requestId_example"; // String | A unique ID used to identify the request. If the server receives two requests with the same ID, then the second request is ignored. It is recommended to always set this value to a UUID. The ID must contain only letters (a-z, A-Z), numbers (0-9), underscores (_), and hyphens (-). The maximum length is 40 characters.
    ConversionWorkspace conversionWorkspace = new ConversionWorkspace(); // ConversionWorkspace | 
    try {
      Operation result = apiInstance.datamigrationProjectsLocationsConversionWorkspacesCreate(parent, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, conversionWorkspaceId, requestId, conversionWorkspace);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProjectsApi#datamigrationProjectsLocationsConversionWorkspacesCreate");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="datamigrationProjectsLocationsConversionWorkspacesDescribeConversionWorkspaceRevisions"></a>
# **datamigrationProjectsLocationsConversionWorkspacesDescribeConversionWorkspaceRevisions**
> DescribeConversionWorkspaceRevisionsResponse datamigrationProjectsLocationsConversionWorkspacesDescribeConversionWorkspaceRevisions(conversionWorkspace, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, commitId)
...
public class Example {
  public static void main(String[] args) {
    ...
    ProjectsApi apiInstance = new ProjectsApi(defaultClient);
    String conversionWorkspace = "conversionWorkspace_example"; // String | Required. Name of the conversion workspace resource whose revisions are listed. Must be in the form of: projects/{project}/locations/{location}/conversionWorkspaces/{conversion_workspace}.
    String $xgafv = "1"; // String | V1 error format.
    String accessToken = "accessToken_example"; // String | OAuth access token.
    String alt = "json"; // String | Data format for response.
    String paramCallback = "paramCallback_example"; // String | JSONP
    ...
    String uploadProtocol = "uploadProtocol_example"; // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
    String uploadType = "uploadType_example"; // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
    String commitId = "commitId_example"; // String | Optional. Optional filter to request a specific commit ID.
    try {
      DescribeConversionWorkspaceRevisionsResponse result = apiInstance.datamigrationProjectsLocationsConversionWorkspacesDescribeConversionWorkspaceRevisions(conversionWorkspace, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, commitId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProjectsApi#datamigrationProjectsLocationsConversionWorkspacesDescribeConversionWorkspaceRevisions");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="datamigrationProjectsLocationsConversionWorkspacesDescribeDatabaseEntities"></a>
# **datamigrationProjectsLocationsConversionWorkspacesDescribeDatabaseEntities**
> DescribeDatabaseEntitiesResponse datamigrationProjectsLocationsConversionWorkspacesDescribeDatabaseEntities(conversionWorkspace, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, commitId, filter, pageSize, pageToken, tree, uncommitted, view)
...
public class Example {
  public static void main(String[] args) {
    ...
    ProjectsApi apiInstance = new ProjectsApi(defaultClient);
    String conversionWorkspace = "conversionWorkspace_example"; // String | Required. Name of the conversion workspace resource whose database entities are described. Must be in the form of: projects/{project}/locations/{location}/conversionWorkspaces/{conversion_workspace}.
    String $xgafv = "1"; // String | V1 error format.
    String accessToken = "accessToken_example"; // String | OAuth access token.
    String alt = "json"; // String | Data format for response.
    String paramCallback = "paramCallback_example"; // String | JSONP
    ...
    String uploadProtocol = "uploadProtocol_example"; // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
    String uploadType = "uploadType_example"; // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
    String commitId = "commitId_example"; // String | Optional. Request a specific commit ID. If not specified, the entities from the latest commit are returned.
    String filter = "filter_example"; // String | Optional. Filter the returned entities based on AIP-160 standard.
    Integer pageSize = 56; // Integer | Optional. The maximum number of entities to return. The service may return fewer entities than the value specifies.
    String pageToken = "pageToken_example"; // String | Optional. The nextPageToken value received in the previous call to conversionWorkspace.describeDatabaseEntities, used in the subsequent request to retrieve the next page of results. On first call this should be left blank. When paginating, all other parameters provided to conversionWorkspace.describeDatabaseEntities must match the call that provided the page token.
    String tree = "DB_TREE_TYPE_UNSPECIFIED"; // String | Required. The tree to fetch.
    Boolean uncommitted = true; // Boolean | Optional. Whether to retrieve the latest committed version of the entities or the latest version. This field is ignored if a specific commit_id is specified.
    String view = "DATABASE_ENTITY_VIEW_UNSPECIFIED"; // String | Optional. Results view based on AIP-157
    try {
      DescribeDatabaseEntitiesResponse result = apiInstance.datamigrationProjectsLocationsConversionWorkspacesDescribeDatabaseEntities(conversionWorkspace, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, commitId, filter, pageSize, pageToken, tree, uncommitted, view);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProjectsApi#datamigrationProjectsLocationsConversionWorkspacesDescribeDatabaseEntities");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| **pageSize** | **Integer**| Optional. The maximum number of entities to return. The service may return fewer entities than the value specifies. | [optional] |
...
| **tree** | **String**| Required. The tree to fetch. | [optional] [enum: DB_TREE_TYPE_UNSPECIFIED, SOURCE_TREE, DRAFT_TREE, DESTINATION_TREE] |
...
| **view** | **String**| Optional. Results view based on AIP-157 | [optional] [enum: DATABASE_ENTITY_VIEW_UNSPECIFIED, DATABASE_ENTITY_VIEW_BASIC, DATABASE_ENTITY_VIEW_FULL, DATABASE_ENTITY_VIEW_ROOT_SUMMARY] |
...
<a id="datamigrationProjectsLocationsConversionWorkspacesList"></a>
# **datamigrationProjectsLocationsConversionWorkspacesList**
> ListConversionWorkspacesResponse datamigrationProjectsLocationsConversionWorkspacesList(parent, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, filter, pageSize, pageToken)
...
public class Example {
  public static void main(String[] args) {
    ...
    String uploadProtocol = "uploadProtocol_example"; // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
    String uploadType = "uploadType_example"; // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
    String filter = "filter_example"; // String | A filter expression that filters conversion workspaces listed in the response. The expression must specify the field name, a comparison operator, and the value that you want to use for filtering. The value must be a string, a number, or a boolean. The comparison operator must be either =, !=, >, or <. For example, list conversion workspaces created this year by specifying **createTime %gt; 2020-01-01T00:00:00.000000000Z.** You can also filter nested fields. For example, you could specify **source.version = \"12.c.1\"** to select all conversion workspaces with source database version equal to 12.c.1.
    Integer pageSize = 56; // Integer | The maximum number of conversion workspaces to return. The service may return fewer than this value. If unspecified, at most 50 sets are returned.
    String pageToken = "pageToken_example"; // String | The nextPageToken value received in the previous call to conversionWorkspaces.list, used in the subsequent request to retrieve the next page of results. On first call this should be left blank. When paginating, all other parameters provided to conversionWorkspaces.list must match the call that provided the page token.
    try {
      ListConversionWorkspacesResponse result = apiInstance.datamigrationProjectsLocationsConversionWorkspacesList(parent, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, filter, pageSize, pageToken);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProjectsApi#datamigrationProjectsLocationsConversionWorkspacesList");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| **pageSize** | **Integer**| The maximum number of conversion workspaces to return. The service may return fewer than this value. If unspecified, at most 50 sets are returned. | [optional] |
...
<a id="datamigrationProjectsLocationsConversionWorkspacesMappingRulesCreate"></a>
# **datamigrationProjectsLocationsConversionWorkspacesMappingRulesCreate**
> MappingRule datamigrationProjectsLocationsConversionWorkspacesMappingRulesCreate(parent, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, mappingRuleId, requestId, mappingRule)
...
public class Example {
  public static void main(String[] args) {
    ...
    ProjectsApi apiInstance = new ProjectsApi(defaultClient);
    String parent = "parent_example"; // String | Required. The parent which owns this collection of mapping rules.
    String $xgafv = "1"; // String | V1 error format.
    String accessToken = "accessToken_example"; // String | OAuth access token.
    String alt = "json"; // String | Data format for response.
    String paramCallback = "paramCallback_example"; // String | JSONP
    ...
    String uploadProtocol = "uploadProtocol_example"; // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
    String uploadType = "uploadType_example"; // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
    String mappingRuleId = "mappingRuleId_example"; // String | Required. The ID of the rule to create.
    String requestId = "requestId_example"; // String | A unique ID used to identify the request. If the server receives two requests with the same ID, then the second request is ignored. It is recommended to always set this value to a UUID. The ID must contain only letters (a-z, A-Z), numbers (0-9), underscores (_), and hyphens (-). The maximum length is 40 characters.
    MappingRule mappingRule = new MappingRule(); // MappingRule | 
    try {
      MappingRule result = apiInstance.datamigrationProjectsLocationsConversionWorkspacesMappingRulesCreate(parent, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, mappingRuleId, requestId, mappingRule);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProjectsApi#datamigrationProjectsLocationsConversionWorkspacesMappingRulesCreate");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="datamigrationProjectsLocationsConversionWorkspacesMappingRulesImport"></a>
# **datamigrationProjectsLocationsConversionWorkspacesMappingRulesImport**
> Operation datamigrationProjectsLocationsConversionWorkspacesMappingRulesImport(parent, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, importMappingRulesRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    ProjectsApi apiInstance = new ProjectsApi(defaultClient);
    String parent = "parent_example"; // String | Required. Name of the conversion workspace resource to import the rules to in the form of: projects/{project}/locations/{location}/conversionWorkspaces/{conversion_workspace}.
    String $xgafv = "1"; // String | V1 error format.
    String accessToken = "accessToken_example"; // String | OAuth access token.
    String alt = "json"; // String | Data format for response.
    String paramCallback = "paramCallback_example"; // String | JSONP
    ...
    String uploadProtocol = "uploadProtocol_example"; // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
    String uploadType = "uploadType_example"; // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
    ImportMappingRulesRequest importMappingRulesRequest = new ImportMappingRulesRequest(); // ImportMappingRulesRequest | 
    try {
      Operation result = apiInstance.datamigrationProjectsLocationsConversionWorkspacesMappingRulesImport(parent, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, importMappingRulesRequest);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProjectsApi#datamigrationProjectsLocationsConversionWorkspacesMappingRulesImport");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="datamigrationProjectsLocationsConversionWorkspacesMappingRulesList"></a>
# **datamigrationProjectsLocationsConversionWorkspacesMappingRulesList**
> ListMappingRulesResponse datamigrationProjectsLocationsConversionWorkspacesMappingRulesList(parent, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, pageSize, pageToken)
...
public class Example {
  public static void main(String[] args) {
    ...
    ProjectsApi apiInstance = new ProjectsApi(defaultClient);
    String parent = "parent_example"; // String | Required. Name of the conversion workspace resource whose mapping rules are listed in the form of: projects/{project}/locations/{location}/conversionWorkspaces/{conversion_workspace}.
    String $xgafv = "1"; // String | V1 error format.
    String accessToken = "accessToken_example"; // String | OAuth access token.
    String alt = "json"; // String | Data format for response.
    String paramCallback = "paramCallback_example"; // String | JSONP
    ...
    String uploadProtocol = "uploadProtocol_example"; // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
    String uploadType = "uploadType_example"; // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
    Integer pageSize = 56; // Integer | The maximum number of rules to return. The service may return fewer than this value.
    ...
    try {
      ListMappingRulesResponse result = apiInstance.datamigrationProjectsLocationsConversionWorkspacesMappingRulesList(parent, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, pageSize, pageToken);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProjectsApi#datamigrationProjectsLocationsConversionWorkspacesMappingRulesList");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| **uploadProtocol** | **String**| Upload protocol for media (e.g. \&quot;raw\&quot;, \&quot;multipart\&quot;). | [optional] |
| **uploadType** | **String**| Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;). | [optional] |
| **pageSize** | **Integer**| The maximum number of rules to return. The service may return fewer than this value. | [optional] |
...
<a id="datamigrationProjectsLocationsConversionWorkspacesRollback"></a>
# **datamigrationProjectsLocationsConversionWorkspacesRollback**
> Operation datamigrationProjectsLocationsConversionWorkspacesRollback(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, body)
...
public class Example {
  public static void main(String[] args) {
    ...
    ProjectsApi apiInstance = new ProjectsApi(defaultClient);
    String name = "name_example"; // String | Required. Name of the conversion workspace resource to roll back to.
    String $xgafv = "1"; // String | V1 error format.
    String accessToken = "accessToken_example"; // String | OAuth access token.
    String alt = "json"; // String | Data format for response.
    String paramCallback = "paramCallback_example"; // String | JSONP
    ...
    try {
      Operation result = apiInstance.datamigrationProjectsLocationsConversionWorkspacesRollback(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, body);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProjectsApi#datamigrationProjectsLocationsConversionWorkspacesRollback");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="datamigrationProjectsLocationsConversionWorkspacesSearchBackgroundJobs"></a>
# **datamigrationProjectsLocationsConversionWorkspacesSearchBackgroundJobs**
> SearchBackgroundJobsResponse datamigrationProjectsLocationsConversionWorkspacesSearchBackgroundJobs(conversionWorkspace, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, completedUntilTime, maxSize, returnMostRecentPerJobType)
...
public class Example {
  public static void main(String[] args) {
    ...
    ProjectsApi apiInstance = new ProjectsApi(defaultClient);
    String conversionWorkspace = "conversionWorkspace_example"; // String | Required. Name of the conversion workspace resource whose jobs are listed, in the form of: projects/{project}/locations/{location}/conversionWorkspaces/{conversion_workspace}.
    String $xgafv = "1"; // String | V1 error format.
    String accessToken = "accessToken_example"; // String | OAuth access token.
    String alt = "json"; // String | Data format for response.
    String paramCallback = "paramCallback_example"; // String | JSONP
    ...
    String uploadProtocol = "uploadProtocol_example"; // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
    String uploadType = "uploadType_example"; // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
    String completedUntilTime = "completedUntilTime_example"; // String | Optional. If provided, only returns jobs that completed until (not including) the given timestamp.
    Integer maxSize = 56; // Integer | Optional. The maximum number of jobs to return. The service may return fewer than this value. If unspecified, at most 100 jobs are returned. The maximum value is 100; values above 100 are coerced to 100.
    Boolean returnMostRecentPerJobType = true; // Boolean | Optional. Whether or not to return just the most recent job per job type,
    try {
      SearchBackgroundJobsResponse result = apiInstance.datamigrationProjectsLocationsConversionWorkspacesSearchBackgroundJobs(conversionWorkspace, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, completedUntilTime, maxSize, returnMostRecentPerJobType);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProjectsApi#datamigrationProjectsLocationsConversionWorkspacesSearchBackgroundJobs");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| **maxSize** | **Integer**| Optional. The maximum number of jobs to return. The service may return fewer than this value. If unspecified, at most 100 jobs are returned. The maximum value is 100; values above 100 are coerced to 100. | [optional] |
...
<a id="datamigrationProjectsLocationsConversionWorkspacesSeed"></a>
# **datamigrationProjectsLocationsConversionWorkspacesSeed**
> Operation datamigrationProjectsLocationsConversionWorkspacesSeed(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, seedConversionWorkspaceRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    ProjectsApi apiInstance = new ProjectsApi(defaultClient);
    String name = "name_example"; // String | Name of the conversion workspace resource to seed with new database structure, in the form of: projects/{project}/locations/{location}/conversionWorkspaces/{conversion_workspace}.
    String $xgafv = "1"; // String | V1 error format.
    String accessToken = "accessToken_example"; // String | OAuth access token.
    String alt = "json"; // String | Data format for response.
    String paramCallback = "paramCallback_example"; // String | JSONP
    ...
    String uploadProtocol = "uploadProtocol_example"; // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
    String uploadType = "uploadType_example"; // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
    SeedConversionWorkspaceRequest seedConversionWorkspaceRequest = new SeedConversionWorkspaceRequest(); // SeedConversionWorkspaceRequest | 
    try {
      Operation result = apiInstance.datamigrationProjectsLocationsConversionWorkspacesSeed(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, seedConversionWorkspaceRequest);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProjectsApi#datamigrationProjectsLocationsConversionWorkspacesSeed");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="datamigrationProjectsLocationsFetchStaticIps"></a>
# **datamigrationProjectsLocationsFetchStaticIps**
> FetchStaticIpsResponse datamigrationProjectsLocationsFetchStaticIps(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, pageSize, pageToken)
...
public class Example {
  public static void main(String[] args) {
    ...
    ProjectsApi apiInstance = new ProjectsApi(defaultClient);
    String name = "name_example"; // String | Required. The resource name for the location for which static IPs should be returned. Must be in the format `projects/_*_/locations/_*`.
    String $xgafv = "1"; // String | V1 error format.
    String accessToken = "accessToken_example"; // String | OAuth access token.
    String alt = "json"; // String | Data format for response.
    String paramCallback = "paramCallback_example"; // String | JSONP
    ...
    String uploadProtocol = "uploadProtocol_example"; // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
    String uploadType = "uploadType_example"; // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
    Integer pageSize = 56; // Integer | Maximum number of IPs to return.
    String pageToken = "pageToken_example"; // String | A page token, received from a previous `FetchStaticIps` call.
    try {
      FetchStaticIpsResponse result = apiInstance.datamigrationProjectsLocationsFetchStaticIps(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, pageSize, pageToken);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProjectsApi#datamigrationProjectsLocationsFetchStaticIps");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| **uploadProtocol** | **String**| Upload protocol for media (e.g. \&quot;raw\&quot;, \&quot;multipart\&quot;). | [optional] |
| **uploadType** | **String**| Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;). | [optional] |
| **pageSize** | **Integer**| Maximum number of IPs to return. | [optional] |
...
<a id="datamigrationProjectsLocationsMigrationJobsDemoteDestination"></a>
# **datamigrationProjectsLocationsMigrationJobsDemoteDestination**
> Operation datamigrationProjectsLocationsMigrationJobsDemoteDestination(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, body)
...
public class Example {
  public static void main(String[] args) {
    ...
    ProjectsApi apiInstance = new ProjectsApi(defaultClient);
    String name = "name_example"; // String | Name of the migration job resource to demote its destination.
    String $xgafv = "1"; // String | V1 error format.
    String accessToken = "accessToken_example"; // String | OAuth access token.
    String alt = "json"; // String | Data format for response.
    String paramCallback = "paramCallback_example"; // String | JSONP
    ...
    Object body = null; // Object | 
    try {
      Operation result = apiInstance.datamigrationProjectsLocationsMigrationJobsDemoteDestination(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, body);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProjectsApi#datamigrationProjectsLocationsMigrationJobsDemoteDestination");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="datamigrationProjectsLocationsMigrationJobsGenerateTcpProxyScript"></a>
# **datamigrationProjectsLocationsMigrationJobsGenerateTcpProxyScript**
> TcpProxyScript datamigrationProjectsLocationsMigrationJobsGenerateTcpProxyScript(migrationJob, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, generateTcpProxyScriptRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    ProjectsApi apiInstance = new ProjectsApi(defaultClient);
    String migrationJob = "migrationJob_example"; // String | Name of the migration job resource to generate the TCP Proxy script.
    String $xgafv = "1"; // String | V1 error format.
    String accessToken = "accessToken_example"; // String | OAuth access token.
    String alt = "json"; // String | Data format for response.
    String paramCallback = "paramCallback_example"; // String | JSONP
    ...
    String uploadProtocol = "uploadProtocol_example"; // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
    String uploadType = "uploadType_example"; // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
    GenerateTcpProxyScriptRequest generateTcpProxyScriptRequest = new GenerateTcpProxyScriptRequest(); // GenerateTcpProxyScriptRequest | 
    try {
      TcpProxyScript result = apiInstance.datamigrationProjectsLocationsMigrationJobsGenerateTcpProxyScript(migrationJob, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, generateTcpProxyScriptRequest);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProjectsApi#datamigrationProjectsLocationsMigrationJobsGenerateTcpProxyScript");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer pageSize = 56; // Integer | The maximum number of migration jobs to return. The service may return fewer than this value. If unspecified, at most 50 migration jobs will be returned. The maximum value is 1000; values above 1000 are coerced to 1000.
...
| **pageSize** | **Integer**| The maximum number of migration jobs to return. The service may return fewer than this value. If unspecified, at most 50 migration jobs will be returned. The maximum value is 1000; values above 1000 are coerced to 1000. | [optional] |
...
> Operation datamigrationProjectsLocationsMigrationJobsPatch(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, requestId, updateMask, validateOnly, migrationJob)
...
public class Example {
  public static void main(String[] args) {
    ...
    String uploadType = "uploadType_example"; // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
    String requestId = "requestId_example"; // String | A unique ID used to identify the request. If the server receives two requests with the same ID, then the second request is ignored. It is recommended to always set this value to a UUID. The ID must contain only letters (a-z, A-Z), numbers (0-9), underscores (_), and hyphens (-). The maximum length is 40 characters.
    String updateMask = "updateMask_example"; // String | Required. Field mask is used to specify the fields to be overwritten by the update in the conversion workspace resource.
    Boolean validateOnly = true; // Boolean | Optional. Only validate the connection profile, but don't update any resources. The default is false. Only supported for Oracle connection profiles.
    MigrationJob migrationJob = new MigrationJob(); // MigrationJob | 
    try {
      Operation result = apiInstance.datamigrationProjectsLocationsMigrationJobsPatch(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, requestId, updateMask, validateOnly, migrationJob);
      System.out.println(result);
    } catch (ApiException e) {
...
> Operation datamigrationProjectsLocationsMigrationJobsRestart(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, restartMigrationJobRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    String uploadProtocol = "uploadProtocol_example"; // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
    String uploadType = "uploadType_example"; // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
    RestartMigrationJobRequest restartMigrationJobRequest = new RestartMigrationJobRequest(); // RestartMigrationJobRequest | 
    try {
      Operation result = apiInstance.datamigrationProjectsLocationsMigrationJobsRestart(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, restartMigrationJobRequest);
      System.out.println(result);
    } catch (ApiException e) {
...
> Operation datamigrationProjectsLocationsMigrationJobsStart(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, startMigrationJobRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    String uploadProtocol = "uploadProtocol_example"; // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
    String uploadType = "uploadType_example"; // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
    StartMigrationJobRequest startMigrationJobRequest = new StartMigrationJobRequest(); // StartMigrationJobRequest | 
    try {
      Operation result = apiInstance.datamigrationProjectsLocationsMigrationJobsStart(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, startMigrationJobRequest);
      System.out.println(result);
    } catch (ApiException e) {
...
> Operation datamigrationProjectsLocationsMigrationJobsVerify(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, verifyMigrationJobRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    String uploadProtocol = "uploadProtocol_example"; // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
    String uploadType = "uploadType_example"; // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
    VerifyMigrationJobRequest verifyMigrationJobRequest = new VerifyMigrationJobRequest(); // VerifyMigrationJobRequest | 
    try {
      Operation result = apiInstance.datamigrationProjectsLocationsMigrationJobsVerify(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, verifyMigrationJobRequest);
      System.out.println(result);
    } catch (ApiException e) {
...
<a id="datamigrationProjectsLocationsPrivateConnectionsCreate"></a>
# **datamigrationProjectsLocationsPrivateConnectionsCreate**
> Operation datamigrationProjectsLocationsPrivateConnectionsCreate(parent, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, privateConnectionId, requestId, skipValidation, privateConnection)
...
public class Example {
  public static void main(String[] args) {
    ...
    String uploadProtocol = "uploadProtocol_example"; // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
    String uploadType = "uploadType_example"; // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
    String privateConnectionId = "privateConnectionId_example"; // String | Required. The private connection identifier.
    String requestId = "requestId_example"; // String | Optional. A unique ID used to identify the request. If the server receives two requests with the same ID, then the second request is ignored. It is recommended to always set this value to a UUID. The ID must contain only letters (a-z, A-Z), numbers (0-9), underscores (_), and hyphens (-). The maximum length is 40 characters.
    Boolean skipValidation = true; // Boolean | Optional. If set to true, will skip validations.
    PrivateConnection privateConnection = new PrivateConnection(); // PrivateConnection | 
    try {
      Operation result = apiInstance.datamigrationProjectsLocationsPrivateConnectionsCreate(parent, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, privateConnectionId, requestId, skipValidation, privateConnection);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProjectsApi#datamigrationProjectsLocationsPrivateConnectionsCreate");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="datamigrationProjectsLocationsPrivateConnectionsDelete"></a>
# **datamigrationProjectsLocationsPrivateConnectionsDelete**
> Operation datamigrationProjectsLocationsPrivateConnectionsDelete(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, requestId)
...
public class Example {
  public static void main(String[] args) {
    ...
    ProjectsApi apiInstance = new ProjectsApi(defaultClient);
    String name = "name_example"; // String | Required. The name of the private connection to delete.
    String $xgafv = "1"; // String | V1 error format.
    String accessToken = "accessToken_example"; // String | OAuth access token.
    String alt = "json"; // String | Data format for response.
    String paramCallback = "paramCallback_example"; // String | JSONP
    ...
    String requestId = "requestId_example"; // String | Optional. A unique ID used to identify the request. If the server receives two requests with the same ID, then the second request is ignored. It is recommended to always set this value to a UUID. The ID must contain only letters (a-z, A-Z), numbers (0-9), underscores (_), and hyphens (-). The maximum length is 40 characters.
    try {
      Operation result = apiInstance.datamigrationProjectsLocationsPrivateConnectionsDelete(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, requestId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProjectsApi#datamigrationProjectsLocationsPrivateConnectionsDelete");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="datamigrationProjectsLocationsPrivateConnectionsGet"></a>
# **datamigrationProjectsLocationsPrivateConnectionsGet**
> PrivateConnection datamigrationProjectsLocationsPrivateConnectionsGet(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType)
...
public class Example {
  public static void main(String[] args) {
    ...
    ProjectsApi apiInstance = new ProjectsApi(defaultClient);
    String name = "name_example"; // String | Required. The name of the private connection to get.
    String $xgafv = "1"; // String | V1 error format.
    String accessToken = "accessToken_example"; // String | OAuth access token.
    String alt = "json"; // String | Data format for response.
    String paramCallback = "paramCallback_example"; // String | JSONP
    ...
    String uploadType = "uploadType_example"; // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
    try {
      PrivateConnection result = apiInstance.datamigrationProjectsLocationsPrivateConnectionsGet(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProjectsApi#datamigrationProjectsLocationsPrivateConnectionsGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="datamigrationProjectsLocationsPrivateConnectionsGetIamPolicy"></a>
# **datamigrationProjectsLocationsPrivateConnectionsGetIamPolicy**
> Policy datamigrationProjectsLocationsPrivateConnectionsGetIamPolicy(resource, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, optionsRequestedPolicyVersion)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Policy result = apiInstance.datamigrationProjectsLocationsPrivateConnectionsGetIamPolicy(resource, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, optionsRequestedPolicyVersion);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProjectsApi#datamigrationProjectsLocationsPrivateConnectionsGetIamPolicy");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="datamigrationProjectsLocationsPrivateConnectionsList"></a>
# **datamigrationProjectsLocationsPrivateConnectionsList**
> ListPrivateConnectionsResponse datamigrationProjectsLocationsPrivateConnectionsList(parent, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, filter, orderBy, pageSize, pageToken)
...
public class Example {
  public static void main(String[] args) {
    ...
    ProjectsApi apiInstance = new ProjectsApi(defaultClient);
    String parent = "parent_example"; // String | Required. The parent that owns the collection of private connections.
    String $xgafv = "1"; // String | V1 error format.
    String accessToken = "accessToken_example"; // String | OAuth access token.
    String alt = "json"; // String | Data format for response.
    String paramCallback = "paramCallback_example"; // String | JSONP
    ...
    String uploadProtocol = "uploadProtocol_example"; // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
    String uploadType = "uploadType_example"; // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
    String filter = "filter_example"; // String | A filter expression that filters private connections listed in the response. The expression must specify the field name, a comparison operator, and the value that you want to use for filtering. The value must be a string, a number, or a boolean. The comparison operator must be either =, !=, >, or <. For example, list private connections created this year by specifying **createTime %gt; 2021-01-01T00:00:00.000000000Z**.
    String orderBy = "orderBy_example"; // String | Order by fields for the result.
    Integer pageSize = 56; // Integer | Maximum number of private connections to return. If unspecified, at most 50 private connections that are returned. The maximum value is 1000; values above 1000 are coerced to 1000.
    ...
    try {
      ListPrivateConnectionsResponse result = apiInstance.datamigrationProjectsLocationsPrivateConnectionsList(parent, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, filter, orderBy, pageSize, pageToken);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProjectsApi#datamigrationProjectsLocationsPrivateConnectionsList");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| **pageSize** | **Integer**| Maximum number of private connections to return. If unspecified, at most 50 private connections that are returned. The maximum value is 1000; values above 1000 are coerced to 1000. | [optional] |
...
<a id="datamigrationProjectsLocationsPrivateConnectionsSetIamPolicy"></a>
# **datamigrationProjectsLocationsPrivateConnectionsSetIamPolicy**
> Policy datamigrationProjectsLocationsPrivateConnectionsSetIamPolicy(resource, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, setIamPolicyRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Policy result = apiInstance.datamigrationProjectsLocationsPrivateConnectionsSetIamPolicy(resource, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, setIamPolicyRequest);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProjectsApi#datamigrationProjectsLocationsPrivateConnectionsSetIamPolicy");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="datamigrationProjectsLocationsPrivateConnectionsTestIamPermissions"></a>
# **datamigrationProjectsLocationsPrivateConnectionsTestIamPermissions**
> TestIamPermissionsResponse datamigrationProjectsLocationsPrivateConnectionsTestIamPermissions(resource, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, testIamPermissionsRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      TestIamPermissionsResponse result = apiInstance.datamigrationProjectsLocationsPrivateConnectionsTestIamPermissions(resource, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, testIamPermissionsRequest);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProjectsApi#datamigrationProjectsLocationsPrivateConnectionsTestIamPermissions");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
