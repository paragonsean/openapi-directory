...
public class ConnectionProfile {
  public static final String SERIALIZED_NAME_ALLOYDB = "alloydb";
  @SerializedName(SERIALIZED_NAME_ALLOYDB)
  ...
  public ConnectionProfile alloydb(AlloyDbConnectionProfile alloydb) {
  ...
  public void setAlloydb(AlloyDbConnectionProfile alloydb) {
    this.alloydb = alloydb;
  }
  ...
  public ConnectionProfile oracle(OracleConnectionProfile oracle) {
    this.oracle = oracle;
    return this;
  }
  ...
  public void setOracle(OracleConnectionProfile oracle) {
    this.oracle = oracle;
  }


  public ConnectionProfile postgresql(PostgreSqlConnectionProfile postgresql) {
  ...
  public void setPostgresql(PostgreSqlConnectionProfile postgresql) {
    this.postgresql = postgresql;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.alloydb, connectionProfile.alloydb) &&
        Objects.equals(this.cloudsql, connectionProfile.cloudsql) &&
        ...
        Objects.equals(this.oracle, connectionProfile.oracle) &&
        Objects.equals(this.postgresql, connectionProfile.postgresql) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(alloydb, cloudsql, createTime, displayName, error, labels, mysql, name, oracle, postgresql, provider, state, updateTime);
  }
  ...
  public String toString() {
    ...
    sb.append("    alloydb: ").append(toIndentedString(alloydb)).append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("alloydb") != null && !jsonObj.get("alloydb").isJsonNull()) {
        AlloyDbConnectionProfile.validateJsonElement(jsonObj.get("alloydb"));
      }
      ...
      if (jsonObj.get("oracle") != null && !jsonObj.get("oracle").isJsonNull()) {
        OracleConnectionProfile.validateJsonElement(jsonObj.get("oracle"));
      }
      // validate the optional field `postgresql`
      if (jsonObj.get("postgresql") != null && !jsonObj.get("postgresql").isJsonNull()) {
        PostgreSqlConnectionProfile.validateJsonElement(jsonObj.get("postgresql"));
      }
