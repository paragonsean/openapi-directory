...
public class ViewEntity {
  ...
  public ViewEntity constraints(List<ConstraintEntity> constraints) {
    this.constraints = constraints;
    return this;
  }

  public ViewEntity addConstraintsItem(ConstraintEntity constraintsItem) {
  ...
  public ViewEntity customFeatures(Map<String, Object> customFeatures) {
    this.customFeatures = customFeatures;
    return this;
  }

  public ViewEntity putCustomFeaturesItem(String key, Object customFeaturesItem) {
  ...
  public ViewEntity sqlCode(String sqlCode) {
  ...
  public boolean equals(Object o) {
    ...
    ViewEntity viewEntity = (ViewEntity) o;
    return Objects.equals(this.constraints, viewEntity.constraints) &&
        Objects.equals(this.customFeatures, viewEntity.customFeatures) &&
        Objects.equals(this.sqlCode, viewEntity.sqlCode);
  }

  @Override
  public int hashCode() {
    return Objects.hash(constraints, customFeatures, sqlCode);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ViewEntity {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewEntity
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewEntity.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ViewEntity is not found in the empty JSON string", ViewEntity.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewEntity.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ViewEntity` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewEntity.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewEntity' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewEntity> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewEntity.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewEntity>() {
           @Override
           public void write(JsonWriter out, ViewEntity value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewEntity read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewEntity given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewEntity
   * @throws IOException if the JSON string is invalid with respect to ViewEntity
   */
  public static ViewEntity fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewEntity.class);
  }

  /**
   * Convert an instance of ViewEntity to an JSON string
   *
   * @return JSON string
   */
