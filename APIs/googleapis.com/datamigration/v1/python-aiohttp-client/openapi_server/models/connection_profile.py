...
class ConnectionProfile(Model):
    ...
    def __init__(self, alloydb: AlloyDbConnectionProfile=None, cloudsql: CloudSqlConnectionProfile=None, create_time: str=None, display_name: str=None, error: Status=None, labels: Dict[str, str]=None, mysql: MySqlConnectionProfile=None, name: str=None, oracle: OracleConnectionProfile=None, postgresql: PostgreSqlConnectionProfile=None, provider: str=None, state: str=None, update_time: str=None):
        """ConnectionProfile - a model defined in OpenAPI

        :param alloydb: The alloydb of this ConnectionProfile.
        ...
        :param oracle: The oracle of this ConnectionProfile.
        :param postgresql: The postgresql of this ConnectionProfile.
    ...
    @property
    def alloydb(self):
        """Gets the alloydb of this ConnectionProfile.


        :return: The alloydb of this ConnectionProfile.
        :rtype: AlloyDbConnectionProfile
        """
        return self._alloydb

    @alloydb.setter
    def alloydb(self, alloydb):
        """Sets the alloydb of this ConnectionProfile.


        :param alloydb: The alloydb of this ConnectionProfile.
        :type alloydb: AlloyDbConnectionProfile
        """
    ...
    @property
    def oracle(self):
        """Gets the oracle of this ConnectionProfile.


        :return: The oracle of this ConnectionProfile.
        :rtype: OracleConnectionProfile
        """
        return self._oracle

    @oracle.setter
    def oracle(self, oracle):
        """Sets the oracle of this ConnectionProfile.


        :param oracle: The oracle of this ConnectionProfile.
        :type oracle: OracleConnectionProfile
        """
    ...
    @property
    def postgresql(self):
        """Gets the postgresql of this ConnectionProfile.


        :return: The postgresql of this ConnectionProfile.
        :rtype: PostgreSqlConnectionProfile
        """
        return self._postgresql

    @postgresql.setter
    def postgresql(self, postgresql):
        """Sets the postgresql of this ConnectionProfile.


        :param postgresql: The postgresql of this ConnectionProfile.
        :type postgresql: PostgreSqlConnectionProfile
        """
    ...
    def provider(self, provider):
        ...
        :type provider: str
        """
        allowed_values = ["DATABASE_PROVIDER_UNSPECIFIED", "CLOUDSQL", "RDS", "AURORA", "ALLOYDB"]  # noqa: E501
