...
class SqlIpConfig(Model):
    ...
    def __init__(self, allocated_ip_range: str=None, authorized_networks: List[SqlAclEntry]=None, enable_ipv4: bool=None, private_network: str=None, require_ssl: bool=None):
        """SqlIpConfig - a model defined in OpenAPI

        :param allocated_ip_range: The allocated_ip_range of this SqlIpConfig.
    ...
    def allocated_ip_range(self):
        """Gets the allocated_ip_range of this SqlIpConfig.
        ...
        :return: The allocated_ip_range of this SqlIpConfig.
        :rtype: str
        """
    ...
    def allocated_ip_range(self, allocated_ip_range):
        """Sets the allocated_ip_range of this SqlIpConfig.
