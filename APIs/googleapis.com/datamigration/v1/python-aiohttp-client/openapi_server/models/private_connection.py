...
class PrivateConnection(Model):
    ...
    def __init__(self, create_time: str=None, display_name: str=None, error: Status=None, labels: Dict[str, str]=None, name: str=None, state: str=None, update_time: str=None, vpc_peering_config: VpcPeeringConfig=None):
    ...
    def state(self, state):
        ...
        :type state: str
        """
        allowed_values = ["STATE_UNSPECIFIED", "CREATING", "CREATED", "FAILED", "DELETING", "FAILED_TO_DELETE", "DELETED"]  # noqa: E501
