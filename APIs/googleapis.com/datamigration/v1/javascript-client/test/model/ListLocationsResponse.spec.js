...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DatabaseMigrationApi.ListLocationsResponse();
  });
  ...
  describe('ListLocationsResponse', function() {
    it('should create an instance of ListLocationsResponse', function() {
      ...
      //var instance = new DatabaseMigrationApi.ListLocationsResponse();
      //expect(instance).to.be.a(DatabaseMigrationApi.ListLocationsResponse);
    });
