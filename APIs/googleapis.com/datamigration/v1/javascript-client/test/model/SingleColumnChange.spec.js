...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DatabaseMigrationApi.SingleColumnChange();
  });
  ...
  describe('SingleColumnChange', function() {
    it('should create an instance of SingleColumnChange', function() {
      // uncomment below and update the code to test SingleColumnChange
      //var instance = new DatabaseMigrationApi.SingleColumnChange();
      //expect(instance).to.be.a(DatabaseMigrationApi.SingleColumnChange);
    });
