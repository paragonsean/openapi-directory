...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DatabaseMigrationApi.ListOperationsResponse();
  });
  ...
  describe('ListOperationsResponse', function() {
    it('should create an instance of ListOperationsResponse', function() {
      ...
      //var instance = new DatabaseMigrationApi.ListOperationsResponse();
      //expect(instance).to.be.a(DatabaseMigrationApi.ListOperationsResponse);
    });
