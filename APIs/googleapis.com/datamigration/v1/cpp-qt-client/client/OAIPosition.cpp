...
qint32 OAIPosition::getColumn() const {
    return m_column;
}
void OAIPosition::setColumn(const qint32 &column) {
    m_column = column;
    m_column_isSet = true;
}
...
qint32 OAIPosition::getLength() const {
    return m_length;
}
void OAIPosition::setLength(const qint32 &length) {
    m_length = length;
    m_length_isSet = true;
}
...
qint32 OAIPosition::getLine() const {
    return m_line;
}
void OAIPosition::setLine(const qint32 &line) {
    m_line = line;
    m_line_isSet = true;
}
...
qint32 OAIPosition::getOffset() const {
    return m_offset;
}
void OAIPosition::setOffset(const qint32 &offset) {
    m_offset = offset;
    m_offset_isSet = true;
}

bool OAIPosition::is_offset_Set() const{
    return m_offset_isSet;
}

bool OAIPosition::is_offset_Valid() const{
