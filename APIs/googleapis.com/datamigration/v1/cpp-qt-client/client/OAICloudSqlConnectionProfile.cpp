...
void OAICloudSqlConnectionProfile::initializeModel() {
    ...
    m_additional_public_ip_isSet = false;
    m_additional_public_ip_isValid = false;
...
void OAICloudSqlConnectionProfile::fromJsonObject(QJsonObject json) {
    ...
    m_additional_public_ip_isValid = ::OpenAPI::fromJsonValue(m_additional_public_ip, json[QString("additionalPublicIp")]);
    m_additional_public_ip_isSet = !json[QString("additionalPublicIp")].isNull() && m_additional_public_ip_isValid;
...
QJsonObject OAICloudSqlConnectionProfile::asJsonObject() const {
    QJsonObject obj;
    if (m_additional_public_ip_isSet) {
        obj.insert(QString("additionalPublicIp"), ::OpenAPI::toJsonValue(m_additional_public_ip));
    }
...
QString OAICloudSqlConnectionProfile::getAdditionalPublicIp() const {
    return m_additional_public_ip;
}
void OAICloudSqlConnectionProfile::setAdditionalPublicIp(const QString &additional_public_ip) {
    m_additional_public_ip = additional_public_ip;
    m_additional_public_ip_isSet = true;
}

bool OAICloudSqlConnectionProfile::is_additional_public_ip_Set() const{
    return m_additional_public_ip_isSet;
}

bool OAICloudSqlConnectionProfile::is_additional_public_ip_Valid() const{
    return m_additional_public_ip_isValid;
}
