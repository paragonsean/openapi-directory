...
QString OAICloudSqlSettings::getAvailabilityType() const {
    return m_availability_type;
}
void OAICloudSqlSettings::setAvailabilityType(const QString &availability_type) {
    m_availability_type = availability_type;
    m_availability_type_isSet = true;
}

bool OAICloudSqlSettings::is_availability_type_Set() const{
    return m_availability_type_isSet;
}

bool OAICloudSqlSettings::is_availability_type_Valid() const{
    return m_availability_type_isValid;
}

QString OAICloudSqlSettings::getCmekKeyName() const {
    return m_cmek_key_name;
}
void OAICloudSqlSettings::setCmekKeyName(const QString &cmek_key_name) {
    m_cmek_key_name = cmek_key_name;
    m_cmek_key_name_isSet = true;
}

bool OAICloudSqlSettings::is_cmek_key_name_Set() const{
    return m_cmek_key_name_isSet;
}

bool OAICloudSqlSettings::is_cmek_key_name_Valid() const{
    return m_cmek_key_name_isValid;
}

QString OAICloudSqlSettings::getCollation() const {
    return m_collation;
}
void OAICloudSqlSettings::setCollation(const QString &collation) {
    m_collation = collation;
    m_collation_isSet = true;
}

bool OAICloudSqlSettings::is_collation_Set() const{
    return m_collation_isSet;
}

bool OAICloudSqlSettings::is_collation_Valid() const{
    return m_collation_isValid;
}

OAIDataCacheConfig OAICloudSqlSettings::getDataCacheConfig() const {
    return m_data_cache_config;
}
void OAICloudSqlSettings::setDataCacheConfig(const OAIDataCacheConfig &data_cache_config) {
    m_data_cache_config = data_cache_config;
    m_data_cache_config_isSet = true;
}

bool OAICloudSqlSettings::is_data_cache_config_Set() const{
    return m_data_cache_config_isSet;
}

bool OAICloudSqlSettings::is_data_cache_config_Valid() const{
...
QString OAICloudSqlSettings::getEdition() const {
    return m_edition;
}
void OAICloudSqlSettings::setEdition(const QString &edition) {
    m_edition = edition;
    m_edition_isSet = true;
}

bool OAICloudSqlSettings::is_edition_Set() const{
    return m_edition_isSet;
}

bool OAICloudSqlSettings::is_edition_Valid() const{
...
QString OAICloudSqlSettings::getSecondaryZone() const {
    return m_secondary_zone;
}
void OAICloudSqlSettings::setSecondaryZone(const QString &secondary_zone) {
    m_secondary_zone = secondary_zone;
    m_secondary_zone_isSet = true;
}

bool OAICloudSqlSettings::is_secondary_zone_Set() const{
    return m_secondary_zone_isSet;
}

bool OAICloudSqlSettings::is_secondary_zone_Valid() const{
