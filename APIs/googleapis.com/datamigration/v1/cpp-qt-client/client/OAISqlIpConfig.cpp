...
QString OAISqlIpConfig::getAllocatedIpRange() const {
    return m_allocated_ip_range;
}
void OAISqlIpConfig::setAllocatedIpRange(const QString &allocated_ip_range) {
    m_allocated_ip_range = allocated_ip_range;
    m_allocated_ip_range_isSet = true;
}

bool OAISqlIpConfig::is_allocated_ip_range_Set() const{
    return m_allocated_ip_range_isSet;
}

bool OAISqlIpConfig::is_allocated_ip_range_Valid() const{
