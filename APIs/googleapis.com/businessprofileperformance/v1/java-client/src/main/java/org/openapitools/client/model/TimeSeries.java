...
public class TimeSeries {
  public static final String SERIALIZED_NAME_DATED_VALUES = "datedValues";
  @SerializedName(SERIALIZED_NAME_DATED_VALUES)
  private List<DatedValue> datedValues = new ArrayList<>();

  public TimeSeries() {
  }

  public TimeSeries datedValues(List<DatedValue> datedValues) {
    this.datedValues = datedValues;
    return this;
  }

  public TimeSeries addDatedValuesItem(DatedValue datedValuesItem) {
    if (this.datedValues == null) {
      this.datedValues = new ArrayList<>();
    }
    this.datedValues.add(datedValuesItem);
    return this;
  }
  ...
  public void setDatedValues(List<DatedValue> datedValues) {
    this.datedValues = datedValues;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.datedValues, timeSeries.datedValues);
  }

  @Override
  public int hashCode() {
    return Objects.hash(datedValues);
  }
  ...
  public String toString() {
    ...
    sb.append("    datedValues: ").append(toIndentedString(datedValues)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("datedValues") != null && !jsonObj.get("datedValues").isJsonNull()) {
        JsonArray jsonArraydatedValues = jsonObj.getAsJsonArray("datedValues");
        if (jsonArraydatedValues != null) {
          // ensure the json data is an array
          if (!jsonObj.get("datedValues").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `datedValues` to be an array in the JSON string but got `%s`", jsonObj.get("datedValues").toString()));
          }

          // validate the optional field `datedValues` (array)
          for (int i = 0; i < jsonArraydatedValues.size(); i++) {
            DatedValue.validateJsonElement(jsonArraydatedValues.get(i));
          };
        }
      }
  }
