...
OAIIdeasApi::OAIIdeasApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIIdeasApi::~OAIIdeasApi() {
}

void OAIIdeasApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("ideahub_ideas_list", defaultConf);
    _serverIndices.insert("ideahub_ideas_list", 0);
}
...
*/
int OAIIdeasApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIIdeasApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIIdeasApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIIdeasApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIIdeasApi::setUsername(const QString &username) {
    _username = username;
}

void OAIIdeasApi::setPassword(const QString &password) {
    _password = password;
}


void OAIIdeasApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIIdeasApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIIdeasApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIIdeasApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIIdeasApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIIdeasApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIIdeasApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIIdeasApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIIdeasApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIIdeasApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIIdeasApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIIdeasApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIIdeasApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIIdeasApi::ideahub_ideas_list(const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<QString> &filter, const ::OpenAPI::OptionalParam<QString> &order_by, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &page_token, const ::OpenAPI::OptionalParam<QString> &parent) {
    QString fullPath = QString(_serverConfigs["ideahub_ideas_list"][_serverIndices.value("ideahub_ideas_list")].URL()+"/v1alpha/ideas");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIIdeasApi::ideahub_ideas_listCallback);
    connect(this, &OAIIdeasApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIIdeasApi::ideahub_ideas_listCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT ideahub_ideas_listSignal(output);
        Q_EMIT ideahub_ideas_listSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT ideahub_ideas_listSignalE(output, error_type, error_str);
        Q_EMIT ideahub_ideas_listSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT ideahub_ideas_listSignalError(output, error_type, error_str);
        Q_EMIT ideahub_ideas_listSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIIdeasApi::tokenAvailable(){
