...
**courseMaterialSets** | [**[CourseMaterialSet]**](CourseMaterialSet.md) | Sets of materials that appear on the \&quot;about\&quot; page of this course. Read-only. | [optional] 
**courseState** | **String** | State of the course. If unspecified, the default state is &#x60;PROVISIONED&#x60;. | [optional] 
...
* `COURSE_STATE_UNSPECIFIED` (value: `"COURSE_STATE_UNSPECIFIED"`)
