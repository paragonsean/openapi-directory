...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleClassroomApi.CourseWorkMaterial();
  });
  ...
  describe('CourseWorkMaterial', function() {
    it('should create an instance of CourseWorkMaterial', function() {
      // uncomment below and update the code to test CourseWorkMaterial
      //var instance = new GoogleClassroomApi.CourseWorkMaterial();
      //expect(instance).to.be.a(GoogleClassroomApi.CourseWorkMaterial);
    });
