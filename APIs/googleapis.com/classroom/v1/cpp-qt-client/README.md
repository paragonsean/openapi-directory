...
#include <iostream>
#include "../client/OAICoursesApi.h"
...
QString Example::create(){
    QString obj;
OAICourseAlias Example::create(){
    OAICourseAlias obj;
 return obj;
}

void Example::exampleFunction1(){
     OAICoursesApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAICoursesApi::classroom_courses_aliases_createSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAICoursesApi::classroom_courses_aliases_createSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      QString course_id = create(); // QString | Identifier of the course to alias. This identifier can be either the Classroom-assigned identifier or an alias.
      ...
      OAICourseAlias oai_course_alias = create(); // OAICourseAlias | 
      apiInstance.classroom_courses_aliases_create(course_id_xgafvaccess_tokenaltcallbackfieldskeyoauth_tokenpretty_printquota_userupload_protocolupload_typeoai_course_alias);
