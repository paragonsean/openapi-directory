...
class OperationMetadata(Model):
    ...
    def __init__(self, additional_info: Dict[str, str]=None, api_version: str=None, create_time: str=None, end_time: str=None, requested_cancellation: bool=None, status_message: str=None, target: str=None, verb: str=None):
        """OperationMetadata - a model defined in OpenAPI

        :param additional_info: The additional_info of this OperationMetadata.
    ...
    def additional_info(self):
        """Gets the additional_info of this OperationMetadata.

        Output only. AdditionalInfo contains additional Info related to backup plan association resource.

        :return: The additional_info of this OperationMetadata.
        :rtype: Dict[str, str]
        """
    ...
    def additional_info(self, additional_info):
        """Sets the additional_info of this OperationMetadata.
