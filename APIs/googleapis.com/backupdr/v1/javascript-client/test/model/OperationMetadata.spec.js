...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BackupAndDrServiceApi.OperationMetadata();
  });
  ...
  describe('OperationMetadata', function() {
    it('should create an instance of OperationMetadata', function() {
      ...
      //var instance = new BackupAndDrServiceApi.OperationMetadata();
      //expect(instance).to.be.a(BackupAndDrServiceApi.OperationMetadata);
    });
