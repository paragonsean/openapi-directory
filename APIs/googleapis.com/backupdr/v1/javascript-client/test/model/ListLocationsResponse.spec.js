...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BackupAndDrServiceApi.ListLocationsResponse();
  });
  ...
  describe('ListLocationsResponse', function() {
    it('should create an instance of ListLocationsResponse', function() {
      ...
      //var instance = new BackupAndDrServiceApi.ListLocationsResponse();
      //expect(instance).to.be.a(BackupAndDrServiceApi.ListLocationsResponse);
    });
