...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BackupAndDrServiceApi.ListOperationsResponse();
  });
  ...
  describe('ListOperationsResponse', function() {
    it('should create an instance of ListOperationsResponse', function() {
      ...
      //var instance = new BackupAndDrServiceApi.ListOperationsResponse();
      //expect(instance).to.be.a(BackupAndDrServiceApi.ListOperationsResponse);
    });
