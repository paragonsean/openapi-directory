# BackupAndDrServiceApi.ProjectsApi
...
> ListLocationsResponse backupdrProjectsLocationsList(name, opts)
...
```javascript
import BackupAndDrServiceApi from 'backup_and_dr_service_api';
let defaultClient = BackupAndDrServiceApi.ApiClient.instance;
...
let apiInstance = new BackupAndDrServiceApi.ProjectsApi();
...
apiInstance.backupdrProjectsLocationsList(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> Operation backupdrProjectsLocationsManagementServersCreate(parent, opts)
...
let apiInstance = new BackupAndDrServiceApi.ProjectsApi();
let parent = "parent_example"; // String | Required. The management server project and location in the format `projects/{project_id}/locations/{location}`. In Cloud Backup and DR locations map to GCP regions, for example **us-central1**.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'managementServerId': "managementServerId_example", // String | Required. The name of the management server to create. The name must be unique for the specified project and location.
  ...
  'managementServer': new BackupAndDrServiceApi.ManagementServer() // ManagementServer | 
};
apiInstance.backupdrProjectsLocationsManagementServersCreate(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Policy backupdrProjectsLocationsManagementServersGetIamPolicy(resource, opts)
...
apiInstance.backupdrProjectsLocationsManagementServersGetIamPolicy(resource, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ListManagementServersResponse backupdrProjectsLocationsManagementServersList(parent, opts)
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'filter': "filter_example", // String | Optional. Filtering results.
  'orderBy': "orderBy_example", // String | Optional. Hint for how to order the results.
  'pageSize': 56, // Number | Optional. Requested page size. Server may return fewer items than requested. If unspecified, server will pick an appropriate default.
  'pageToken': "pageToken_example" // String | Optional. A token identifying a page of results the server should return.
};
apiInstance.backupdrProjectsLocationsManagementServersList(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **pageSize** | **Number**| Optional. Requested page size. Server may return fewer items than requested. If unspecified, server will pick an appropriate default. | [optional] 
...
> Policy backupdrProjectsLocationsManagementServersSetIamPolicy(resource, opts)
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'setIamPolicyRequest': new BackupAndDrServiceApi.SetIamPolicyRequest() // SetIamPolicyRequest | 
};
apiInstance.backupdrProjectsLocationsManagementServersSetIamPolicy(resource, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> TestIamPermissionsResponse backupdrProjectsLocationsManagementServersTestIamPermissions(resource, opts)
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'testIamPermissionsRequest': new BackupAndDrServiceApi.TestIamPermissionsRequest() // TestIamPermissionsRequest | 
};
apiInstance.backupdrProjectsLocationsManagementServersTestIamPermissions(resource, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Object backupdrProjectsLocationsOperationsCancel(name, opts)
...
apiInstance.backupdrProjectsLocationsOperationsCancel(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Object backupdrProjectsLocationsOperationsDelete(name, opts)
...
apiInstance.backupdrProjectsLocationsOperationsDelete(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Operation backupdrProjectsLocationsOperationsGet(name, opts)
...
apiInstance.backupdrProjectsLocationsOperationsGet(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ListOperationsResponse backupdrProjectsLocationsOperationsList(name, opts)
...
apiInstance.backupdrProjectsLocationsOperationsList(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
