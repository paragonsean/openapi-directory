...
QMap<QString, QString> OAIOperationMetadata::getAdditionalInfo() const {
    return m_additional_info;
}
void OAIOperationMetadata::setAdditionalInfo(const QMap<QString, QString> &additional_info) {
    m_additional_info = additional_info;
    m_additional_info_isSet = true;
}

bool OAIOperationMetadata::is_additional_info_Set() const{
    return m_additional_info_isSet;
}

bool OAIOperationMetadata::is_additional_info_Valid() const{
