...
**mediaFormat** | **String** | The format of this media item. Must be set when the media item is created, and is read-only on all other requests. Cannot be updated. | [optional] 
...
* `MEDIA_FORMAT_UNSPECIFIED` (value: `"MEDIA_FORMAT_UNSPECIFIED"`)
