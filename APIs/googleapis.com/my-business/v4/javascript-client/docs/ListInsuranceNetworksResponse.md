# GoogleMyBusinessApi.ListInsuranceNetworksResponse

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**networks** | [**[InsuranceNetwork]**](InsuranceNetwork.md) | A list of insurance networks that are supported by Google. | [optional] 
