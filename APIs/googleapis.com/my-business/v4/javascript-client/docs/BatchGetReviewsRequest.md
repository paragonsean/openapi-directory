...
**locationNames** | **[String]** | A collection of locations to fetch reviews for, specified by their names. | [optional] 
...
**pageSize** | **Number** | How many reviews to fetch per page. The default value is 200. | [optional] 
