# GoogleMyBusinessApi.FoodAndDrink
...
**barException** | **String** | Bar exception. | [optional] 
...
**breakfastAvailableException** | **String** | Breakfast available exception. | [optional] 
...
**breakfastBuffetException** | **String** | Breakfast buffet exception. | [optional] 
...
**buffetException** | **String** | Buffet exception. | [optional] 
...
**dinnerBuffetException** | **String** | Dinner buffet exception. | [optional] 
...
**freeBreakfastException** | **String** | Free breakfast exception. | [optional] 
...
**restaurantException** | **String** | Restaurant exception. | [optional] 
**restaurantsCount** | **Number** | Restaurants count. The number of restaurants at the hotel. | [optional] 
**restaurantsCountException** | **String** | Restaurants count exception. | [optional] 
...
**roomServiceException** | **String** | Room service exception. | [optional] 
...
**tableServiceException** | **String** | Table service exception. | [optional] 
**twentyFourHourRoomService** | **Boolean** | 24hr room service. Room service is available 24 hours a day. | [optional] 
**twentyFourHourRoomServiceException** | **String** | 24hr room service exception. | [optional] 
...
**vendingMachineException** | **String** | Vending machine exception. | [optional] 
