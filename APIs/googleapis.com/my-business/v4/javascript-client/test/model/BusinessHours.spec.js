...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleMyBusinessApi.BusinessHours();
  });
  ...
  describe('BusinessHours', function() {
    it('should create an instance of BusinessHours', function() {
      ...
      //var instance = new GoogleMyBusinessApi.BusinessHours();
      //expect(instance).to.be.a(GoogleMyBusinessApi.BusinessHours);
    });
