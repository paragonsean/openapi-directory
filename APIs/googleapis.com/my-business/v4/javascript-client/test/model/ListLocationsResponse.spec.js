...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleMyBusinessApi.ListLocationsResponse();
  });
  ...
  describe('ListLocationsResponse', function() {
    it('should create an instance of ListLocationsResponse', function() {
      ...
      //var instance = new GoogleMyBusinessApi.ListLocationsResponse();
      //expect(instance).to.be.a(GoogleMyBusinessApi.ListLocationsResponse);
    });
