...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleMyBusinessApi.FoodMenu();
  });
  ...
  describe('FoodMenu', function() {
    it('should create an instance of FoodMenu', function() {
      // uncomment below and update the code to test FoodMenu
      //var instance = new GoogleMyBusinessApi.FoodMenu();
      //expect(instance).to.be.a(GoogleMyBusinessApi.FoodMenu);
    });
