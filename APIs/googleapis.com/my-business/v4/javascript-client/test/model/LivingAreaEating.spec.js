...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleMyBusinessApi.LivingAreaEating();
  });
  ...
  describe('LivingAreaEating', function() {
    it('should create an instance of LivingAreaEating', function() {
      ...
      //var instance = new GoogleMyBusinessApi.LivingAreaEating();
      //expect(instance).to.be.a(GoogleMyBusinessApi.LivingAreaEating);
    });
