...
class Families(Model):
    ...
    def __init__(self, babysitting: bool=None, babysitting_exception: str=None, kids_activities: bool=None, kids_activities_exception: str=None, kids_club: bool=None, kids_club_exception: str=None):
