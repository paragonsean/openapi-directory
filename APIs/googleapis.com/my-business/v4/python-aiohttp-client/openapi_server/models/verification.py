...
class Verification(Model):
    ...
    def __init__(self, create_time: str=None, method: str=None, name: str=None, state: str=None):
    ...
    def state(self, state):
        ...
        :type state: str
        """
        allowed_values = ["VERIFICATION_STATE_UNSPECIFIED", "PENDING", "COMPLETED", "FAILED"]  # noqa: E501
