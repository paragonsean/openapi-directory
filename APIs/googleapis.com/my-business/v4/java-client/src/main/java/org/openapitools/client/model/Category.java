...
public class Category {
  ...
  public Category serviceTypes(List<ServiceType> serviceTypes) {
    this.serviceTypes = serviceTypes;
    return this;
  }

  public Category addServiceTypesItem(ServiceType serviceTypesItem) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(categoryId, displayName, moreHoursTypes, serviceTypes);
  }
