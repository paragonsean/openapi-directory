...
public class Lodging {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accessibility, activities, allUnits, business, commonLivingArea, connectivity, families, foodAndDrink, guestUnits, healthAndSafety, housekeeping, metadata, name, parking, pets, policies, pools, property, services, someUnits, transportation, wellness);
  }
