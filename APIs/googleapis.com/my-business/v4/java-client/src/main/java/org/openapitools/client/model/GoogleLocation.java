...
public class GoogleLocation {
  ...
  public static final String SERIALIZED_NAME_REQUEST_ADMIN_RIGHTS_URL = "requestAdminRightsUrl";
  @SerializedName(SERIALIZED_NAME_REQUEST_ADMIN_RIGHTS_URL)
  private String requestAdminRightsUrl;
  ...
  public GoogleLocation requestAdminRightsUrl(String requestAdminRightsUrl) {
   ...
   */
  @javax.annotation.Nullable
  public String getRequestAdminRightsUrl() {
    return requestAdminRightsUrl;
  }

  public void setRequestAdminRightsUrl(String requestAdminRightsUrl) {
    this.requestAdminRightsUrl = requestAdminRightsUrl;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.location, googleLocation.location) &&
        ...
        Objects.equals(this.requestAdminRightsUrl, googleLocation.requestAdminRightsUrl);
  }

  @Override
  public int hashCode() {
    return Objects.hash(location, name, requestAdminRightsUrl);
  }
  ...
  public String toString() {
    ...
    sb.append("    requestAdminRightsUrl: ").append(toIndentedString(requestAdminRightsUrl)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("requestAdminRightsUrl");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("requestAdminRightsUrl") != null && !jsonObj.get("requestAdminRightsUrl").isJsonNull()) && !jsonObj.get("requestAdminRightsUrl").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `requestAdminRightsUrl` to be a primitive type in the JSON string but got `%s`", jsonObj.get("requestAdminRightsUrl").toString()));
      }
  }
