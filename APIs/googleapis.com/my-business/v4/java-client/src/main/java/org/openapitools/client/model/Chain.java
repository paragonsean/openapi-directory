...
public class Chain {
  ...
  private List<ChainUrl> websites = new ArrayList<>();
  ...
  public Chain websites(List<ChainUrl> websites) {
    this.websites = websites;
    return this;
  }

  public Chain addWebsitesItem(ChainUrl websitesItem) {
  ...
  public void setWebsites(List<ChainUrl> websites) {
    this.websites = websites;
  }
      ...
      if (jsonObj.get("websites") != null && !jsonObj.get("websites").isJsonNull()) {
        ...
        if (jsonArraywebsites != null) {
          ...
          for (int i = 0; i < jsonArraywebsites.size(); i++) {
            ChainUrl.validateJsonElement(jsonArraywebsites.get(i));
          };
        }
      }
  }
