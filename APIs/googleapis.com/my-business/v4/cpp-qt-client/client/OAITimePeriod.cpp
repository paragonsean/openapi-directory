...
QString OAITimePeriod::getCloseTime() const {
    return m_close_time;
}
void OAITimePeriod::setCloseTime(const QString &close_time) {
...
QString OAITimePeriod::getOpenTime() const {
    return m_open_time;
}
void OAITimePeriod::setOpenTime(const QString &open_time) {
