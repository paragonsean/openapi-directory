...
OAILanguagesSpoken OAIServices::getLanguagesSpoken() const {
    return m_languages_spoken;
}
void OAIServices::setLanguagesSpoken(const OAILanguagesSpoken &languages_spoken) {
