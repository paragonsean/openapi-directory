...
void OAICategoriesApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("mybusiness_categories_batchGet", defaultConf);
    _serverIndices.insert("mybusiness_categories_batchGet", 0);
    _serverConfigs.insert("mybusiness_categories_list", defaultConf);
    _serverIndices.insert("mybusiness_categories_list", 0);
}
...
void OAICategoriesApi::mybusiness_categories_batchGet(const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<QList<QString>> &category_ids, const ::OpenAPI::OptionalParam<QString> &language_code, const ::OpenAPI::OptionalParam<QString> &region_code, const ::OpenAPI::OptionalParam<QString> &view) {
    ...
    if (category_ids.hasValue())
    {
        ...
        if (category_ids.value().size() > 0) {
            if (QString("multi").indexOf("multi") == 0) {
                for (QString t : category_ids.value()) {
                    if (fullPath.indexOf("?") > 0)
                        fullPath.append(queryPrefix);
                    else
                        fullPath.append("?");
                    fullPath.append("categoryIds=").append(::OpenAPI::toStringValue(t));
                }
            } else if (QString("multi").indexOf("ssv") == 0) {
                if (fullPath.indexOf("?") > 0)
                    fullPath.append("&");
                else
                    fullPath.append("?").append(queryPrefix).append("categoryIds").append(querySuffix);
                qint32 count = 0;
                for (QString t : category_ids.value()) {
                    if (count > 0) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICategoriesApi::mybusiness_categories_batchGetCallback);
...
void OAICategoriesApi::mybusiness_categories_batchGetCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIBatchGetBusinessCategoriesResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT mybusiness_categories_batchGetSignal(output);
        Q_EMIT mybusiness_categories_batchGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT mybusiness_categories_batchGetSignalE(output, error_type, error_str);
        Q_EMIT mybusiness_categories_batchGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT mybusiness_categories_batchGetSignalError(output, error_type, error_str);
        Q_EMIT mybusiness_categories_batchGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAICategoriesApi::mybusiness_categories_list(const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<QString> &language_code, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &page_token, const ::OpenAPI::OptionalParam<QString> &region_code, const ::OpenAPI::OptionalParam<QString> &search_term, const ::OpenAPI::OptionalParam<QString> &view) {
    QString fullPath = QString(_serverConfigs["mybusiness_categories_list"][_serverIndices.value("mybusiness_categories_list")].URL()+"/v4/categories");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICategoriesApi::mybusiness_categories_listCallback);
    connect(this, &OAICategoriesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAICategoriesApi::mybusiness_categories_listCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIListBusinessCategoriesResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT mybusiness_categories_listSignal(output);
        Q_EMIT mybusiness_categories_listSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT mybusiness_categories_listSignalE(output, error_type, error_str);
        Q_EMIT mybusiness_categories_listSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT mybusiness_categories_listSignalError(output, error_type, error_str);
        Q_EMIT mybusiness_categories_listSignalErrorFull(worker, error_type, error_str);
    }
}
