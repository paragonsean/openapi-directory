...
void OAIAttributesApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("mybusiness_attributes_list", defaultConf);
    _serverIndices.insert("mybusiness_attributes_list", 0);
}
...
void OAIAttributesApi::mybusiness_attributes_list(const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<QString> &category_id, const ::OpenAPI::OptionalParam<QString> &country, const ::OpenAPI::OptionalParam<QString> &language_code, const ::OpenAPI::OptionalParam<QString> &name, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &page_token) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAttributesApi::mybusiness_attributes_listCallback);
...
void OAIAttributesApi::mybusiness_attributes_listCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT mybusiness_attributes_listSignal(output);
        Q_EMIT mybusiness_attributes_listSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT mybusiness_attributes_listSignalE(output, error_type, error_str);
        Q_EMIT mybusiness_attributes_listSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT mybusiness_attributes_listSignalError(output, error_type, error_str);
        Q_EMIT mybusiness_attributes_listSignalErrorFull(worker, error_type, error_str);
    }
}
