# GoogleSheetsApi.WaterfallChartSeries

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**customSubtotals** | [**[WaterfallChartCustomSubtotal]**](WaterfallChartCustomSubtotal.md) | Custom subtotal columns appearing in this series. The order in which subtotals are defined is not significant. Only one subtotal may be defined for each data point. | [optional] 
