# GoogleSheetsApi.SpreadsheetProperties

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**autoRecalc** | **String** | The amount of time to wait before volatile functions are recalculated. | [optional] 
...
* `RECALCULATION_INTERVAL_UNSPECIFIED` (value: `"RECALCULATION_INTERVAL_UNSPECIFIED"`)
