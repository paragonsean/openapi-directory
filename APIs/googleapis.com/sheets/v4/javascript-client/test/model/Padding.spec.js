...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleSheetsApi.Padding();
  });
  ...
  describe('Padding', function() {
    it('should create an instance of Padding', function() {
      // uncomment below and update the code to test Padding
      //var instance = new GoogleSheetsApi.Padding();
      //expect(instance).to.be.a(GoogleSheetsApi.Padding);
    });
