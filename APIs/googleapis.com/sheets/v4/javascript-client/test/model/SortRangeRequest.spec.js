...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleSheetsApi.SortRangeRequest();
  });
  ...
  describe('SortRangeRequest', function() {
    it('should create an instance of SortRangeRequest', function() {
      // uncomment below and update the code to test SortRangeRequest
      //var instance = new GoogleSheetsApi.SortRangeRequest();
      //expect(instance).to.be.a(GoogleSheetsApi.SortRangeRequest);
    });
