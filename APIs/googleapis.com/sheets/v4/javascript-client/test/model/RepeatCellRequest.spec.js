...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleSheetsApi.RepeatCellRequest();
  });
  ...
  describe('RepeatCellRequest', function() {
    it('should create an instance of RepeatCellRequest', function() {
      // uncomment below and update the code to test RepeatCellRequest
      //var instance = new GoogleSheetsApi.RepeatCellRequest();
      //expect(instance).to.be.a(GoogleSheetsApi.RepeatCellRequest);
    });
