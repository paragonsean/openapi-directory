...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleSheetsApi.Borders();
  });
  ...
  describe('Borders', function() {
    it('should create an instance of Borders', function() {
      // uncomment below and update the code to test Borders
      //var instance = new GoogleSheetsApi.Borders();
      //expect(instance).to.be.a(GoogleSheetsApi.Borders);
    });
