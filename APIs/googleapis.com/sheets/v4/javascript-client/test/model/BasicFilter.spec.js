...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleSheetsApi.BasicFilter();
  });
  ...
  describe('BasicFilter', function() {
    it('should create an instance of BasicFilter', function() {
      // uncomment below and update the code to test BasicFilter
      //var instance = new GoogleSheetsApi.BasicFilter();
      //expect(instance).to.be.a(GoogleSheetsApi.BasicFilter);
    });
