...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleSheetsApi.RefreshDataSourceRequest();
  });
  ...
  describe('RefreshDataSourceRequest', function() {
    it('should create an instance of RefreshDataSourceRequest', function() {
      // uncomment below and update the code to test RefreshDataSourceRequest
      //var instance = new GoogleSheetsApi.RefreshDataSourceRequest();
      //expect(instance).to.be.a(GoogleSheetsApi.RefreshDataSourceRequest);
    });
    ...
    it('should have the property isAll (base name: "isAll")', function() {
      // uncomment below and update the code to test the property isAll
      //var instance = new GoogleSheetsApi.RefreshDataSourceRequest();
      //expect(instance).to.be();
    });
