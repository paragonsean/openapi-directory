...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleSheetsApi.DimensionGroup();
  });
  ...
  describe('DimensionGroup', function() {
    it('should create an instance of DimensionGroup', function() {
      // uncomment below and update the code to test DimensionGroup
      //var instance = new GoogleSheetsApi.DimensionGroup();
      //expect(instance).to.be.a(GoogleSheetsApi.DimensionGroup);
    });
