...
OAIBatchUpdateValuesByDataFilterResponse::OAIBatchUpdateValuesByDataFilterResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBatchUpdateValuesByDataFilterResponse::OAIBatchUpdateValuesByDataFilterResponse() {
    this->initializeModel();
}

OAIBatchUpdateValuesByDataFilterResponse::~OAIBatchUpdateValuesByDataFilterResponse() {}

void OAIBatchUpdateValuesByDataFilterResponse::initializeModel() {
...
void OAIBatchUpdateValuesByDataFilterResponse::fromJson(QString jsonString) {
...
void OAIBatchUpdateValuesByDataFilterResponse::fromJsonObject(QJsonObject json) {
...
QString OAIBatchUpdateValuesByDataFilterResponse::asJson() const {
...
QJsonObject OAIBatchUpdateValuesByDataFilterResponse::asJsonObject() const {
    QJsonObject obj;
...
QList<OAIUpdateValuesByDataFilterResponse> OAIBatchUpdateValuesByDataFilterResponse::getResponses() const {
    return m_responses;
}
void OAIBatchUpdateValuesByDataFilterResponse::setResponses(const QList<OAIUpdateValuesByDataFilterResponse> &responses) {
    m_responses = responses;
    m_responses_isSet = true;
}

bool OAIBatchUpdateValuesByDataFilterResponse::is_responses_Set() const{
    return m_responses_isSet;
}

bool OAIBatchUpdateValuesByDataFilterResponse::is_responses_Valid() const{
    return m_responses_isValid;
}

QString OAIBatchUpdateValuesByDataFilterResponse::getSpreadsheetId() const {
    return m_spreadsheet_id;
}
void OAIBatchUpdateValuesByDataFilterResponse::setSpreadsheetId(const QString &spreadsheet_id) {
    m_spreadsheet_id = spreadsheet_id;
    m_spreadsheet_id_isSet = true;
}

bool OAIBatchUpdateValuesByDataFilterResponse::is_spreadsheet_id_Set() const{
    return m_spreadsheet_id_isSet;
}

bool OAIBatchUpdateValuesByDataFilterResponse::is_spreadsheet_id_Valid() const{
    return m_spreadsheet_id_isValid;
}

qint32 OAIBatchUpdateValuesByDataFilterResponse::getTotalUpdatedCells() const {
    return m_total_updated_cells;
}
void OAIBatchUpdateValuesByDataFilterResponse::setTotalUpdatedCells(const qint32 &total_updated_cells) {
    m_total_updated_cells = total_updated_cells;
    m_total_updated_cells_isSet = true;
}

bool OAIBatchUpdateValuesByDataFilterResponse::is_total_updated_cells_Set() const{
    return m_total_updated_cells_isSet;
}

bool OAIBatchUpdateValuesByDataFilterResponse::is_total_updated_cells_Valid() const{
    return m_total_updated_cells_isValid;
}

qint32 OAIBatchUpdateValuesByDataFilterResponse::getTotalUpdatedColumns() const {
    return m_total_updated_columns;
}
void OAIBatchUpdateValuesByDataFilterResponse::setTotalUpdatedColumns(const qint32 &total_updated_columns) {
    m_total_updated_columns = total_updated_columns;
    m_total_updated_columns_isSet = true;
}

bool OAIBatchUpdateValuesByDataFilterResponse::is_total_updated_columns_Set() const{
    return m_total_updated_columns_isSet;
}

bool OAIBatchUpdateValuesByDataFilterResponse::is_total_updated_columns_Valid() const{
    return m_total_updated_columns_isValid;
}

qint32 OAIBatchUpdateValuesByDataFilterResponse::getTotalUpdatedRows() const {
    return m_total_updated_rows;
}
void OAIBatchUpdateValuesByDataFilterResponse::setTotalUpdatedRows(const qint32 &total_updated_rows) {
    m_total_updated_rows = total_updated_rows;
    m_total_updated_rows_isSet = true;
}

bool OAIBatchUpdateValuesByDataFilterResponse::is_total_updated_rows_Set() const{
    return m_total_updated_rows_isSet;
}

bool OAIBatchUpdateValuesByDataFilterResponse::is_total_updated_rows_Valid() const{
    return m_total_updated_rows_isValid;
}

qint32 OAIBatchUpdateValuesByDataFilterResponse::getTotalUpdatedSheets() const {
    return m_total_updated_sheets;
}
void OAIBatchUpdateValuesByDataFilterResponse::setTotalUpdatedSheets(const qint32 &total_updated_sheets) {
    m_total_updated_sheets = total_updated_sheets;
    m_total_updated_sheets_isSet = true;
}

bool OAIBatchUpdateValuesByDataFilterResponse::is_total_updated_sheets_Set() const{
    return m_total_updated_sheets_isSet;
}

bool OAIBatchUpdateValuesByDataFilterResponse::is_total_updated_sheets_Valid() const{
    return m_total_updated_sheets_isValid;
}

bool OAIBatchUpdateValuesByDataFilterResponse::isSet() const {
...
bool OAIBatchUpdateValuesByDataFilterResponse::isValid() const {
