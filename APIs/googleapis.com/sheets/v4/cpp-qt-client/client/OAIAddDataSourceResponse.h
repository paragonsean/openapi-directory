...
/*
 * OAIAddDataSourceResponse.h
 *
 * The result of adding a data source.
 */

#ifndef OAIAddDataSourceResponse_H
#define OAIAddDataSourceResponse_H
...
class OAIAddDataSourceResponse : public OAIObject {
public:
    OAIAddDataSourceResponse();
    OAIAddDataSourceResponse(QString json);
    ~OAIAddDataSourceResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddDataSourceResponse)

#endif // OAIAddDataSourceResponse_H
