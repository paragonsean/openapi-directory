...
#ifndef OAIHistogramRule_H
#define OAIHistogramRule_H
...
class OAIHistogramRule : public OAIObject {
public:
    OAIHistogramRule();
    OAIHistogramRule(QString json);
    ~OAIHistogramRule() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHistogramRule)

#endif // OAIHistogramRule_H
