...
OAIGridRange OAINamedRange::getRange() const {
    return m_range;
}
void OAINamedRange::setRange(const OAIGridRange &range) {
    m_range = range;
    m_range_isSet = true;
}

bool OAINamedRange::is_range_Set() const{
    return m_range_isSet;
}

bool OAINamedRange::is_range_Valid() const{
