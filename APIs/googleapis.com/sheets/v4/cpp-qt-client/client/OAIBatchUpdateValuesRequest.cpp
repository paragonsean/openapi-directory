...
OAIBatchUpdateValuesRequest::OAIBatchUpdateValuesRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBatchUpdateValuesRequest::OAIBatchUpdateValuesRequest() {
    this->initializeModel();
}

OAIBatchUpdateValuesRequest::~OAIBatchUpdateValuesRequest() {}

void OAIBatchUpdateValuesRequest::initializeModel() {
...
void OAIBatchUpdateValuesRequest::fromJson(QString jsonString) {
...
void OAIBatchUpdateValuesRequest::fromJsonObject(QJsonObject json) {
...
QString OAIBatchUpdateValuesRequest::asJson() const {
...
QJsonObject OAIBatchUpdateValuesRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_data.size() > 0) {
...
QList<OAIValueRange> OAIBatchUpdateValuesRequest::getData() const {
    return m_data;
}
void OAIBatchUpdateValuesRequest::setData(const QList<OAIValueRange> &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIBatchUpdateValuesRequest::is_data_Set() const{
    return m_data_isSet;
}

bool OAIBatchUpdateValuesRequest::is_data_Valid() const{
    return m_data_isValid;
}

bool OAIBatchUpdateValuesRequest::isIncludeValuesInResponse() const {
    return m_include_values_in_response;
}
void OAIBatchUpdateValuesRequest::setIncludeValuesInResponse(const bool &include_values_in_response) {
    m_include_values_in_response = include_values_in_response;
    m_include_values_in_response_isSet = true;
}

bool OAIBatchUpdateValuesRequest::is_include_values_in_response_Set() const{
    return m_include_values_in_response_isSet;
}

bool OAIBatchUpdateValuesRequest::is_include_values_in_response_Valid() const{
    return m_include_values_in_response_isValid;
}

QString OAIBatchUpdateValuesRequest::getResponseDateTimeRenderOption() const {
    return m_response_date_time_render_option;
}
void OAIBatchUpdateValuesRequest::setResponseDateTimeRenderOption(const QString &response_date_time_render_option) {
    m_response_date_time_render_option = response_date_time_render_option;
    m_response_date_time_render_option_isSet = true;
}

bool OAIBatchUpdateValuesRequest::is_response_date_time_render_option_Set() const{
    return m_response_date_time_render_option_isSet;
}

bool OAIBatchUpdateValuesRequest::is_response_date_time_render_option_Valid() const{
    return m_response_date_time_render_option_isValid;
}

QString OAIBatchUpdateValuesRequest::getResponseValueRenderOption() const {
    return m_response_value_render_option;
}
void OAIBatchUpdateValuesRequest::setResponseValueRenderOption(const QString &response_value_render_option) {
    m_response_value_render_option = response_value_render_option;
    m_response_value_render_option_isSet = true;
}

bool OAIBatchUpdateValuesRequest::is_response_value_render_option_Set() const{
    return m_response_value_render_option_isSet;
}

bool OAIBatchUpdateValuesRequest::is_response_value_render_option_Valid() const{
    return m_response_value_render_option_isValid;
}

QString OAIBatchUpdateValuesRequest::getValueInputOption() const {
    return m_value_input_option;
}
void OAIBatchUpdateValuesRequest::setValueInputOption(const QString &value_input_option) {
    m_value_input_option = value_input_option;
    m_value_input_option_isSet = true;
}

bool OAIBatchUpdateValuesRequest::is_value_input_option_Set() const{
    return m_value_input_option_isSet;
}

bool OAIBatchUpdateValuesRequest::is_value_input_option_Valid() const{
    return m_value_input_option_isValid;
}

bool OAIBatchUpdateValuesRequest::isSet() const {
...
bool OAIBatchUpdateValuesRequest::isValid() const {
