...
/*
 * OAIDataSourceFormula.h
 *
 * A data source formula.
 */

#ifndef OAIDataSourceFormula_H
#define OAIDataSourceFormula_H
...
class OAIDataSourceFormula : public OAIObject {
public:
    OAIDataSourceFormula();
    OAIDataSourceFormula(QString json);
    ~OAIDataSourceFormula() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDataSourceFormula)

#endif // OAIDataSourceFormula_H
