...
import org.openapitools.client.model.DataFilterValueRange;
...
public class BatchUpdateValuesByDataFilterRequest {
  ...
  private List<DataFilterValueRange> data = new ArrayList<>();
  ...
  public BatchUpdateValuesByDataFilterRequest data(List<DataFilterValueRange> data) {
    this.data = data;
    return this;
  }

  public BatchUpdateValuesByDataFilterRequest addDataItem(DataFilterValueRange dataItem) {
    if (this.data == null) {
  ...
  public void setData(List<DataFilterValueRange> data) {
    this.data = data;
  }


  public BatchUpdateValuesByDataFilterRequest includeValuesInResponse(Boolean includeValuesInResponse) {
  ...
  public BatchUpdateValuesByDataFilterRequest responseDateTimeRenderOption(ResponseDateTimeRenderOptionEnum responseDateTimeRenderOption) {
  ...
  public BatchUpdateValuesByDataFilterRequest responseValueRenderOption(ResponseValueRenderOptionEnum responseValueRenderOption) {
  ...
  public BatchUpdateValuesByDataFilterRequest valueInputOption(ValueInputOptionEnum valueInputOption) {
  ...
  public boolean equals(Object o) {
    ...
    BatchUpdateValuesByDataFilterRequest batchUpdateValuesByDataFilterRequest = (BatchUpdateValuesByDataFilterRequest) o;
    return Objects.equals(this.data, batchUpdateValuesByDataFilterRequest.data) &&
        Objects.equals(this.includeValuesInResponse, batchUpdateValuesByDataFilterRequest.includeValuesInResponse) &&
        Objects.equals(this.responseDateTimeRenderOption, batchUpdateValuesByDataFilterRequest.responseDateTimeRenderOption) &&
        Objects.equals(this.responseValueRenderOption, batchUpdateValuesByDataFilterRequest.responseValueRenderOption) &&
        Objects.equals(this.valueInputOption, batchUpdateValuesByDataFilterRequest.valueInputOption);
  }
  ...
  public String toString() {
    ...
    sb.append("class BatchUpdateValuesByDataFilterRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BatchUpdateValuesByDataFilterRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BatchUpdateValuesByDataFilterRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BatchUpdateValuesByDataFilterRequest is not found in the empty JSON string", BatchUpdateValuesByDataFilterRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BatchUpdateValuesByDataFilterRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BatchUpdateValuesByDataFilterRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            DataFilterValueRange.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BatchUpdateValuesByDataFilterRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BatchUpdateValuesByDataFilterRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BatchUpdateValuesByDataFilterRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BatchUpdateValuesByDataFilterRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<BatchUpdateValuesByDataFilterRequest>() {
           @Override
           public void write(JsonWriter out, BatchUpdateValuesByDataFilterRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BatchUpdateValuesByDataFilterRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BatchUpdateValuesByDataFilterRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BatchUpdateValuesByDataFilterRequest
   * @throws IOException if the JSON string is invalid with respect to BatchUpdateValuesByDataFilterRequest
   */
  public static BatchUpdateValuesByDataFilterRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BatchUpdateValuesByDataFilterRequest.class);
  }

  /**
   * Convert an instance of BatchUpdateValuesByDataFilterRequest to an JSON string
   *
   * @return JSON string
   */
