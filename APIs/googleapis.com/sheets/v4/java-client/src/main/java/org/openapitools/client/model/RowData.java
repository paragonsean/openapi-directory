...
public class RowData {
  ...
  private List<CellData> values = new ArrayList<>();

  public RowData() {
  }

  public RowData values(List<CellData> values) {
    this.values = values;
    return this;
  }

  public RowData addValuesItem(CellData valuesItem) {
    if (this.values == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.values, rowData.values);
  }
      ...
      if (jsonObj.get("values") != null && !jsonObj.get("values").isJsonNull()) {
        ...
        if (jsonArrayvalues != null) {
          ...
          for (int i = 0; i < jsonArrayvalues.size(); i++) {
            CellData.validateJsonElement(jsonArrayvalues.get(i));
          };
        }
      }
  }
