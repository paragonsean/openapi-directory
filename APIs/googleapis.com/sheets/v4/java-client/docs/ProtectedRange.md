...
|**protectedRangeId** | **Integer** | The ID of the protected range. This field is read-only. |  [optional] |
...
|**unprotectedRanges** | [**List&lt;GridRange&gt;**](GridRange.md) | The list of unprotected ranges within a protected sheet. Unprotected ranges are only supported on protected sheets. |  [optional] |
