...
------------ | ------------- | ------------- | -------------
**attackComplexity** | **String** | Defined in CVSS v3, CVSS v2 | [optional] 
**attackVector** | **String** | Base Metrics Represents the intrinsic characteristics of a vulnerability that are constant over time and across user environments. Defined in CVSS v3, CVSS v2 | [optional] 
**authentication** | **String** | Defined in CVSS v2 | [optional] 
**availabilityImpact** | **String** | Defined in CVSS v3, CVSS v2 | [optional] 
**baseScore** | **Number** | The base score is a function of the base metric scores. | [optional] 
**confidentialityImpact** | **String** | Defined in CVSS v3, CVSS v2 | [optional] 
**exploitabilityScore** | **Number** |  | [optional] 
**impactScore** | **Number** |  | [optional] 
**integrityImpact** | **String** | Defined in CVSS v3, CVSS v2 | [optional] 
**privilegesRequired** | **String** | Defined in CVSS v3 | [optional] 
**scope** | **String** | Defined in CVSS v3 | [optional] 
**userInteraction** | **String** | Defined in CVSS v3 | [optional] 
