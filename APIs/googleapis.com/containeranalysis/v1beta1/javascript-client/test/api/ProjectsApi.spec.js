...
(function(root, factory) {
  ...
  describe('ProjectsApi', function() {
    ...
    describe('containeranalysisProjectsResourcesGeneratePackagesSummary', function() {
      it('should call containeranalysisProjectsResourcesGeneratePackagesSummary successfully', function(done) {
        //uncomment below and update the code to test containeranalysisProjectsResourcesGeneratePackagesSummary
        //instance.containeranalysisProjectsResourcesGeneratePackagesSummary(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
