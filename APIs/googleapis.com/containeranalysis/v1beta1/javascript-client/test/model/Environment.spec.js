...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContainerAnalysisApi.Environment();
  });
  ...
  describe('Environment', function() {
    it('should create an instance of Environment', function() {
      ...
      //var instance = new ContainerAnalysisApi.Environment();
      //expect(instance).to.be.a(ContainerAnalysisApi.Environment);
    });
