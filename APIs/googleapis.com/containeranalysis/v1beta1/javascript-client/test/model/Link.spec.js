...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContainerAnalysisApi.Link();
  });
  ...
  describe('Link', function() {
    it('should create an instance of Link', function() {
      ...
      //var instance = new ContainerAnalysisApi.Link();
      //expect(instance).to.be.a(ContainerAnalysisApi.Link);
    });

    it('should have the property byproducts (base name: "byproducts")', function() {
      // uncomment below and update the code to test the property byproducts
      //var instance = new ContainerAnalysisApi.Link();
