...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContainerAnalysisApi.ByProducts();
  });
  ...
  describe('ByProducts', function() {
    it('should create an instance of ByProducts', function() {
      // uncomment below and update the code to test ByProducts
      //var instance = new ContainerAnalysisApi.ByProducts();
      //expect(instance).to.be.a(ContainerAnalysisApi.ByProducts);
    });
