...
(function(root, factory) {
  ...
  describe('Detail', function() {
    ...
    it('should have the property maxAffectedVersion (base name: "maxAffectedVersion")', function() {
      // uncomment below and update the code to test the property maxAffectedVersion
      //var instance = new ContainerAnalysisApi.Detail();
      //expect(instance).to.be();
    });

    it('should have the property minAffectedVersion (base name: "minAffectedVersion")', function() {
      // uncomment below and update the code to test the property minAffectedVersion
      //var instance = new ContainerAnalysisApi.Detail();
      //expect(instance).to.be();
    });
