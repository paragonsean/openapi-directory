    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('additionalContexts')) {
                obj['additionalContexts'] = ApiClient.convertToType(data['additionalContexts'], [SourceContext]);
            }
            if (data.hasOwnProperty('artifactStorageSourceUri')) {
                obj['artifactStorageSourceUri'] = ApiClient.convertToType(data['artifactStorageSourceUri'], 'String');
            }
            if (data.hasOwnProperty('context')) {
                obj['context'] = SourceContext.constructFromObject(data['context']);
            }
    ...
    static validateJSON(data) {
        if (data['additionalContexts']) { // data not null
            ...
            for (const item of data['additionalContexts']) {
                SourceContext.validateJSON(item);
            };
        }
        // ensure the json data is a string
        if (data['artifactStorageSourceUri'] && !(typeof data['artifactStorageSourceUri'] === 'string' || data['artifactStorageSourceUri'] instanceof String)) {
            throw new Error("Expected the field `artifactStorageSourceUri` to be a primitive type in the JSON string but got " + data['artifactStorageSourceUri']);
        }
        // validate the optional field `context`
        if (data['context']) { // data not null
          SourceContext.validateJSON(data['context']);
        }
 ...
 * @member {Array.<module:model/SourceContext>} additionalContexts
 */
 ...
 */
Source.prototype['artifactStorageSourceUri'] = undefined;

/**
 * @member {module:model/SourceContext} context
 */
