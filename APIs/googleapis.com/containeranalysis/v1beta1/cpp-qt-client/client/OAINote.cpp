...
OAIAuthority OAINote::getAttestationAuthority() const {
    return m_attestation_authority;
}
void OAINote::setAttestationAuthority(const OAIAuthority &attestation_authority) {
...
OAIBuild OAINote::getBuild() const {
    return m_build;
}
void OAINote::setBuild(const OAIBuild &build) {
    m_build = build;
    m_build_isSet = true;
}
...
OAIInToto OAINote::getIntoto() const {
    return m_intoto;
}
void OAINote::setIntoto(const OAIInToto &intoto) {
    m_intoto = intoto;
    m_intoto_isSet = true;
}

bool OAINote::is_intoto_Set() const{
    return m_intoto_isSet;
}

bool OAINote::is_intoto_Valid() const{
...
OAIVulnerability OAINote::getVulnerability() const {
    return m_vulnerability;
}
void OAINote::setVulnerability(const OAIVulnerability &vulnerability) {
