...
public:
    ...
    * @param[in]  body OAIObject [optional]
    */
    virtual void containeranalysis_projects_resources_generatePackagesSummary(const QString &name, const ::OpenAPI::OptionalParam<QString> &_xgafv = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &access_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &alt = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &callback = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &fields = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &key = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &oauth_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &pretty_print = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &quota_user = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &upload_protocol = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &upload_type = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAIObject> &body = ::OpenAPI::OptionalParam<OAIObject>());
...
private:
    ...
    void containeranalysis_projects_resources_generatePackagesSummaryCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void containeranalysis_projects_resources_generatePackagesSummarySignal(OAIPackagesSummaryResponse summary);
    ...
    void containeranalysis_projects_resources_generatePackagesSummarySignalFull(OAIHttpRequestWorker *worker, OAIPackagesSummaryResponse summary);
    ...
    Q_DECL_DEPRECATED_X("Use containeranalysis_projects_resources_generatePackagesSummarySignalError() instead")
    void containeranalysis_projects_resources_generatePackagesSummarySignalE(OAIPackagesSummaryResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void containeranalysis_projects_resources_generatePackagesSummarySignalError(OAIPackagesSummaryResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use containeranalysis_projects_resources_generatePackagesSummarySignalErrorFull() instead")
    void containeranalysis_projects_resources_generatePackagesSummarySignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void containeranalysis_projects_resources_generatePackagesSummarySignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
