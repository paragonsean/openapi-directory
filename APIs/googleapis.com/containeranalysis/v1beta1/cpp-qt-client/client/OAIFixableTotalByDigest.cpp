...
OAIResource OAIFixableTotalByDigest::getResource() const {
    return m_resource;
}
void OAIFixableTotalByDigest::setResource(const OAIResource &resource) {
    m_resource = resource;
    m_resource_isSet = true;
}

bool OAIFixableTotalByDigest::is_resource_Set() const{
    return m_resource_isSet;
}

bool OAIFixableTotalByDigest::is_resource_Valid() const{
