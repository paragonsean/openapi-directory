...
public class Detail {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(cpeUri, description, fixedLocation, isObsolete, maxAffectedVersion, minAffectedVersion, _package, packageType, severityName, source, sourceUpdateTime, vendor);
  }
