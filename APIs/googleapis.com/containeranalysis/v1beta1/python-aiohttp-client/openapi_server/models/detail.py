...
class Detail(Model):
    ...
    def __init__(self, cpe_uri: str=None, description: str=None, fixed_location: VulnerabilityLocation=None, is_obsolete: bool=None, max_affected_version: Version=None, min_affected_version: Version=None, package: str=None, package_type: str=None, severity_name: str=None, source: str=None, source_update_time: str=None, vendor: str=None):
