...
QString OAIDiscovered::getArchiveTime() const {
    return m_archive_time;
}
void OAIDiscovered::setArchiveTime(const QString &archive_time) {
    m_archive_time = archive_time;
    m_archive_time_isSet = true;
}

bool OAIDiscovered::is_archive_time_Set() const{
    return m_archive_time_isSet;
}

bool OAIDiscovered::is_archive_time_Valid() const{
...
QString OAIDiscovered::getCpe() const {
    return m_cpe;
}
void OAIDiscovered::setCpe(const QString &cpe) {
    m_cpe = cpe;
    m_cpe_isSet = true;
}

bool OAIDiscovered::is_cpe_Set() const{
    return m_cpe_isSet;
}

bool OAIDiscovered::is_cpe_Valid() const{
...
OAIOperation OAIDiscovered::getOperation() const {
    return m_operation;
}
void OAIDiscovered::setOperation(const OAIOperation &operation) {
    m_operation = operation;
    m_operation_isSet = true;
}

bool OAIDiscovered::is_operation_Set() const{
    return m_operation_isSet;
}

bool OAIDiscovered::is_operation_Valid() const{
