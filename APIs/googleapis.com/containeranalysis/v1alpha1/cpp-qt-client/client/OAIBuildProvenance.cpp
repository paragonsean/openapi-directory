...
QString OAIBuildProvenance::getFinishTime() const {
    return m_finish_time;
}
void OAIBuildProvenance::setFinishTime(const QString &finish_time) {
    m_finish_time = finish_time;
    m_finish_time_isSet = true;
}

bool OAIBuildProvenance::is_finish_time_Set() const{
    return m_finish_time_isSet;
}

bool OAIBuildProvenance::is_finish_time_Valid() const{
...
QString OAIBuildProvenance::getLogsBucket() const {
    return m_logs_bucket;
}
void OAIBuildProvenance::setLogsBucket(const QString &logs_bucket) {
    m_logs_bucket = logs_bucket;
    m_logs_bucket_isSet = true;
}

bool OAIBuildProvenance::is_logs_bucket_Set() const{
    return m_logs_bucket_isSet;
}

bool OAIBuildProvenance::is_logs_bucket_Valid() const{
