...
OAIBuildDetails::OAIBuildDetails(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBuildDetails::OAIBuildDetails() {
    this->initializeModel();
}

OAIBuildDetails::~OAIBuildDetails() {}

void OAIBuildDetails::initializeModel() {
...
void OAIBuildDetails::fromJson(QString jsonString) {
...
void OAIBuildDetails::fromJsonObject(QJsonObject json) {
...
QString OAIBuildDetails::asJson() const {
...
QJsonObject OAIBuildDetails::asJsonObject() const {
    QJsonObject obj;
...
OAIInTotoSlsaProvenanceV1 OAIBuildDetails::getInTotoSlsaProvenanceV1() const {
    return m_in_toto_slsa_provenance_v1;
}
void OAIBuildDetails::setInTotoSlsaProvenanceV1(const OAIInTotoSlsaProvenanceV1 &in_toto_slsa_provenance_v1) {
    m_in_toto_slsa_provenance_v1 = in_toto_slsa_provenance_v1;
    m_in_toto_slsa_provenance_v1_isSet = true;
}

bool OAIBuildDetails::is_in_toto_slsa_provenance_v1_Set() const{
    return m_in_toto_slsa_provenance_v1_isSet;
}

bool OAIBuildDetails::is_in_toto_slsa_provenance_v1_Valid() const{
    return m_in_toto_slsa_provenance_v1_isValid;
}

OAIInTotoProvenance OAIBuildDetails::getIntotoProvenance() const {
    return m_intoto_provenance;
}
void OAIBuildDetails::setIntotoProvenance(const OAIInTotoProvenance &intoto_provenance) {
    m_intoto_provenance = intoto_provenance;
    m_intoto_provenance_isSet = true;
}

bool OAIBuildDetails::is_intoto_provenance_Set() const{
    return m_intoto_provenance_isSet;
}

bool OAIBuildDetails::is_intoto_provenance_Valid() const{
    return m_intoto_provenance_isValid;
}

OAIInTotoStatement OAIBuildDetails::getIntotoStatement() const {
    return m_intoto_statement;
}
void OAIBuildDetails::setIntotoStatement(const OAIInTotoStatement &intoto_statement) {
    m_intoto_statement = intoto_statement;
    m_intoto_statement_isSet = true;
}

bool OAIBuildDetails::is_intoto_statement_Set() const{
    return m_intoto_statement_isSet;
}

bool OAIBuildDetails::is_intoto_statement_Valid() const{
    return m_intoto_statement_isValid;
}

OAIBuildProvenance OAIBuildDetails::getProvenance() const {
    return m_provenance;
}
void OAIBuildDetails::setProvenance(const OAIBuildProvenance &provenance) {
    m_provenance = provenance;
    m_provenance_isSet = true;
}

bool OAIBuildDetails::is_provenance_Set() const{
    return m_provenance_isSet;
}

bool OAIBuildDetails::is_provenance_Valid() const{
    return m_provenance_isValid;
}

QString OAIBuildDetails::getProvenanceBytes() const {
    return m_provenance_bytes;
}
void OAIBuildDetails::setProvenanceBytes(const QString &provenance_bytes) {
    m_provenance_bytes = provenance_bytes;
    m_provenance_bytes_isSet = true;
}

bool OAIBuildDetails::is_provenance_bytes_Set() const{
    return m_provenance_bytes_isSet;
}

bool OAIBuildDetails::is_provenance_bytes_Valid() const{
    return m_provenance_bytes_isValid;
}

bool OAIBuildDetails::isSet() const {
...
bool OAIBuildDetails::isValid() const {
