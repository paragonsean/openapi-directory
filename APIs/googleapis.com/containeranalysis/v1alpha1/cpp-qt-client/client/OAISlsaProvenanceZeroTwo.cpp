...
OAIGoogleDevtoolsContaineranalysisV1alpha1SlsaProvenanceZeroTwoSlsaBuilder OAISlsaProvenanceZeroTwo::getBuilder() const {
    return m_builder;
}
void OAISlsaProvenanceZeroTwo::setBuilder(const OAIGoogleDevtoolsContaineranalysisV1alpha1SlsaProvenanceZeroTwoSlsaBuilder &builder) {
    m_builder = builder;
...
OAIGoogleDevtoolsContaineranalysisV1alpha1SlsaProvenanceZeroTwoSlsaInvocation OAISlsaProvenanceZeroTwo::getInvocation() const {
    return m_invocation;
}
void OAISlsaProvenanceZeroTwo::setInvocation(const OAIGoogleDevtoolsContaineranalysisV1alpha1SlsaProvenanceZeroTwoSlsaInvocation &invocation) {
...
QList<OAIGoogleDevtoolsContaineranalysisV1alpha1SlsaProvenanceZeroTwoSlsaMaterial> OAISlsaProvenanceZeroTwo::getMaterials() const {
    return m_materials;
}
void OAISlsaProvenanceZeroTwo::setMaterials(const QList<OAIGoogleDevtoolsContaineranalysisV1alpha1SlsaProvenanceZeroTwoSlsaMaterial> &materials) {
...
OAIGoogleDevtoolsContaineranalysisV1alpha1SlsaProvenanceZeroTwoSlsaMetadata OAISlsaProvenanceZeroTwo::getMetadata() const {
    return m_metadata;
}
void OAISlsaProvenanceZeroTwo::setMetadata(const OAIGoogleDevtoolsContaineranalysisV1alpha1SlsaProvenanceZeroTwoSlsaMetadata &metadata) {
    m_metadata = metadata;
