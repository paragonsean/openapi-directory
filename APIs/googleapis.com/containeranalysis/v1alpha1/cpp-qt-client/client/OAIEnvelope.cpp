...
OAIEnvelope::OAIEnvelope(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEnvelope::OAIEnvelope() {
    this->initializeModel();
}

OAIEnvelope::~OAIEnvelope() {}

void OAIEnvelope::initializeModel() {
...
void OAIEnvelope::fromJson(QString jsonString) {
...
void OAIEnvelope::fromJsonObject(QJsonObject json) {
...
QString OAIEnvelope::asJson() const {
...
QJsonObject OAIEnvelope::asJsonObject() const {
    QJsonObject obj;
    if (m_payload_isSet) {
...
QByteArray OAIEnvelope::getPayload() const {
    return m_payload;
}
void OAIEnvelope::setPayload(const QByteArray &payload) {
    m_payload = payload;
    m_payload_isSet = true;
}

bool OAIEnvelope::is_payload_Set() const{
    return m_payload_isSet;
}

bool OAIEnvelope::is_payload_Valid() const{
    return m_payload_isValid;
}

QString OAIEnvelope::getPayloadType() const {
    return m_payload_type;
}
void OAIEnvelope::setPayloadType(const QString &payload_type) {
    m_payload_type = payload_type;
    m_payload_type_isSet = true;
}

bool OAIEnvelope::is_payload_type_Set() const{
    return m_payload_type_isSet;
}

bool OAIEnvelope::is_payload_type_Valid() const{
    return m_payload_type_isValid;
}

QList<OAIEnvelopeSignature> OAIEnvelope::getSignatures() const {
    return m_signatures;
}
void OAIEnvelope::setSignatures(const QList<OAIEnvelopeSignature> &signatures) {
    m_signatures = signatures;
    m_signatures_isSet = true;
}

bool OAIEnvelope::is_signatures_Set() const{
    return m_signatures_isSet;
}

bool OAIEnvelope::is_signatures_Valid() const{
    return m_signatures_isValid;
}

bool OAIEnvelope::isSet() const {
...
bool OAIEnvelope::isValid() const {
