...
#ifndef OAIBuildType_H
#define OAIBuildType_H
...
class OAIBuildType : public OAIObject {
public:
    OAIBuildType();
    OAIBuildType(QString json);
    ~OAIBuildType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBuildType)

#endif // OAIBuildType_H
