...
/*
 * OAIContaineranalysisGoogleDevtoolsCloudbuildV1UploadedNpmPackage.h
 *
 * An npm package uploaded to Artifact Registry using the NpmPackage directive.
 */

#ifndef OAIContaineranalysisGoogleDevtoolsCloudbuildV1UploadedNpmPackage_H
#define OAIContaineranalysisGoogleDevtoolsCloudbuildV1UploadedNpmPackage_H
...
class OAIContaineranalysisGoogleDevtoolsCloudbuildV1UploadedNpmPackage : public OAIObject {
public:
    OAIContaineranalysisGoogleDevtoolsCloudbuildV1UploadedNpmPackage();
    OAIContaineranalysisGoogleDevtoolsCloudbuildV1UploadedNpmPackage(QString json);
    ~OAIContaineranalysisGoogleDevtoolsCloudbuildV1UploadedNpmPackage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIContaineranalysisGoogleDevtoolsCloudbuildV1UploadedNpmPackage)

#endif // OAIContaineranalysisGoogleDevtoolsCloudbuildV1UploadedNpmPackage_H
