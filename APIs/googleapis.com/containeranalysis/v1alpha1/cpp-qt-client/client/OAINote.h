...
public:
    ...
    OAIAttestationAuthority getAttestationAuthority() const;
    void setAttestationAuthority(const OAIAttestationAuthority &attestation_authority);
    ...
    OAIBuildType getBuildType() const;
    void setBuildType(const OAIBuildType &build_type);
    ...
    OAIVulnerabilityType getVulnerabilityType() const;
    void setVulnerabilityType(const OAIVulnerabilityType &vulnerability_type);
    bool is_vulnerability_type_Set() const;
    bool is_vulnerability_type_Valid() const;
...
private:
    ...
    OAIAttestationAuthority m_attestation_authority;
    ...
    OAIVulnerabilityType m_vulnerability_type;
    bool m_vulnerability_type_isSet;
    bool m_vulnerability_type_isValid;
};
