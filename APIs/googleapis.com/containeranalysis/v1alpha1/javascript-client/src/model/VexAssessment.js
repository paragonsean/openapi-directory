...
/**
 * The VexAssessment model module.
 * @module model/VexAssessment
 * @version v1alpha1
 */
class VexAssessment {
    /**
     * Constructs a new <code>VexAssessment</code>.
     * VexAssessment provides all publisher provided Vex information that is related to this vulnerability.
     * @alias module:model/VexAssessment
     */
    constructor() { 
        
        VexAssessment.initialize(this);
    }
    ...
    /**
     * Constructs a <code>VexAssessment</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VexAssessment} obj Optional instance to populate.
     * @return {module:model/VexAssessment} The populated <code>VexAssessment</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VexAssessment();
            ...
            if (data.hasOwnProperty('relatedUris')) {
                obj['relatedUris'] = ApiClient.convertToType(data['relatedUris'], ['String']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>VexAssessment</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VexAssessment</code>.
     */
 ...
 * @member {String} cve
 */
VexAssessment.prototype['cve'] = undefined;

/**
 * Contains information about the impact of this vulnerability, this will change with time.
 * @member {Array.<String>} impacts
 */
VexAssessment.prototype['impacts'] = undefined;

/**
 * @member {module:model/Justification} justification
 */
VexAssessment.prototype['justification'] = undefined;

/**
 * The VulnerabilityAssessment note from which this VexAssessment was generated. This will be of the form: `projects/[PROJECT_ID]/notes/[NOTE_ID]`.
 * @member {String} noteName
 */
VexAssessment.prototype['noteName'] = undefined;

/**
 * Holds a list of references associated with this vulnerability item and assessment. These uris have additional information about the vulnerability and the assessment itself. E.g. Link to a document which details how this assessment concluded the state of this vulnerability.
 * @member {Array.<String>} relatedUris
 */
VexAssessment.prototype['relatedUris'] = undefined;

/**
 * Specifies details on how to handle (and presumably, fix) a vulnerability.
 * @member {Array.<module:model/Remediation>} remediations
 */
VexAssessment.prototype['remediations'] = undefined;

/**
 * Provides the state of this Vulnerability assessment.
 * @member {module:model/VexAssessment.StateEnum} state
 */
VexAssessment.prototype['state'] = undefined;

/**
 * The vulnerability identifier for this Assessment. Will hold one of common identifiers e.g. CVE, GHSA etc.
 * @member {String} vulnerabilityId
 */
VexAssessment.prototype['vulnerabilityId'] = undefined;
