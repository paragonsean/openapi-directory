...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContainerAnalysisApi.BuildType();
  });
  ...
  describe('BuildType', function() {
    it('should create an instance of BuildType', function() {
      // uncomment below and update the code to test BuildType
      //var instance = new ContainerAnalysisApi.BuildType();
      //expect(instance).to.be.a(ContainerAnalysisApi.BuildType);
    });
