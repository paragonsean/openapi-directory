...
(function(root, factory) {
  ...
  describe('Note', function() {
    ...
    it('should have the property vulnerabilityType (base name: "vulnerabilityType")', function() {
      // uncomment below and update the code to test the property vulnerabilityType
      //var instance = new ContainerAnalysisApi.Note();
      //expect(instance).to.be();
    });
