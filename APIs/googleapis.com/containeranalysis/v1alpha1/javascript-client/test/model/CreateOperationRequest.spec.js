...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContainerAnalysisApi.CreateOperationRequest();
  });
  ...
  describe('CreateOperationRequest', function() {
    it('should create an instance of CreateOperationRequest', function() {
      ...
      //var instance = new ContainerAnalysisApi.CreateOperationRequest();
      //expect(instance).to.be.a(ContainerAnalysisApi.CreateOperationRequest);
    });
