...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContainerAnalysisApi.Basis();
  });
  ...
  describe('Basis', function() {
    it('should create an instance of Basis', function() {
      // uncomment below and update the code to test Basis
      //var instance = new ContainerAnalysisApi.Basis();
      //expect(instance).to.be.a(ContainerAnalysisApi.Basis);
    });
