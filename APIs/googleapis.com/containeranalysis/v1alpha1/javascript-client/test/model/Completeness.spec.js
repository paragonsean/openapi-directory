...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContainerAnalysisApi.Completeness();
  });
  ...
  describe('Completeness', function() {
    it('should create an instance of Completeness', function() {
      ...
      //var instance = new ContainerAnalysisApi.Completeness();
      //expect(instance).to.be.a(ContainerAnalysisApi.Completeness);
    });
