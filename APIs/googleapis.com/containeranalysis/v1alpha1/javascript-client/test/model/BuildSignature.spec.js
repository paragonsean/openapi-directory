...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContainerAnalysisApi.BuildSignature();
  });
  ...
  describe('BuildSignature', function() {
    it('should create an instance of BuildSignature', function() {
      // uncomment below and update the code to test BuildSignature
      //var instance = new ContainerAnalysisApi.BuildSignature();
      //expect(instance).to.be.a(ContainerAnalysisApi.BuildSignature);
    });
