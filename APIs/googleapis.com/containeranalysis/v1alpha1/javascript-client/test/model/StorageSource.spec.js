...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContainerAnalysisApi.StorageSource();
  });
  ...
  describe('StorageSource', function() {
    it('should create an instance of StorageSource', function() {
      ...
      //var instance = new ContainerAnalysisApi.StorageSource();
      //expect(instance).to.be.a(ContainerAnalysisApi.StorageSource);
    });
