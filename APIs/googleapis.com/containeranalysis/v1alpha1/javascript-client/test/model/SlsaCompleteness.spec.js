...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContainerAnalysisApi.SlsaCompleteness();
  });
  ...
  describe('SlsaCompleteness', function() {
    it('should create an instance of SlsaCompleteness', function() {
      // uncomment below and update the code to test SlsaCompleteness
      //var instance = new ContainerAnalysisApi.SlsaCompleteness();
      //expect(instance).to.be.a(ContainerAnalysisApi.SlsaCompleteness);
    });
