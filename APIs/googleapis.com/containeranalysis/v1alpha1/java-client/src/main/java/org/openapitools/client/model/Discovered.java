...
public class Discovered {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(analysisCompleted, analysisError, analysisStatus, analysisStatusError, archiveTime, continuousAnalysis, cpe, lastScanTime, operation, sbomStatus);
  }
