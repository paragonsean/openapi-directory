...
class BuildProvenance(Model):
    ...
    def __init__(self, build_options: Dict[str, str]=None, builder_version: str=None, built_artifacts: List[Artifact]=None, commands: List[Command]=None, create_time: str=None, creator: str=None, finish_time: str=None, id: str=None, logs_bucket: str=None, project_id: str=None, source_provenance: Source=None, start_time: str=None, trigger_id: str=None):
