...
class VexAssessment(Model):
    ...
    def __init__(self, cve: str=None, impacts: List[str]=None, justification: Justification=None, note_name: str=None, related_uris: List[str]=None, remediations: List[Remediation]=None, state: str=None, vulnerability_id: str=None):
