...
/**
 * The PackageNote model module.
 * @module model/PackageNote
 * @version v1
 */
class PackageNote {
    /**
     * Constructs a new <code>PackageNote</code>.
     * PackageNote represents a particular package version.
     * @alias module:model/PackageNote
     */
    constructor() { 
        
        PackageNote.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PackageNote</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PackageNote} obj Optional instance to populate.
     * @return {module:model/PackageNote} The populated <code>PackageNote</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PackageNote();
    ...
    /**
     * Validates the JSON data with respect to <code>PackageNote</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PackageNote</code>.
     */
 ...
 * @member {module:model/PackageNote.ArchitectureEnum} architecture
 */
PackageNote.prototype['architecture'] = undefined;

/**
 * The cpe_uri in [CPE format](https://cpe.mitre.org/specification/) denoting the package manager version distributing a package. The cpe_uri will be blank for language packages.
 * @member {String} cpeUri
 */
PackageNote.prototype['cpeUri'] = undefined;

/**
 * The description of this package.
 * @member {String} description
 */
PackageNote.prototype['description'] = undefined;

/**
 * Hash value, typically a file digest, that allows unique identification a specific package.
 * @member {Array.<module:model/Digest>} digest
 */
PackageNote.prototype['digest'] = undefined;

/**
 * Deprecated. The various channels by which a package is distributed.
 * @member {Array.<module:model/Distribution>} distribution
 */
PackageNote.prototype['distribution'] = undefined;

/**
 * @member {module:model/License} license
 */
PackageNote.prototype['license'] = undefined;

/**
 * A freeform text denoting the maintainer of this package.
 * @member {String} maintainer
 */
PackageNote.prototype['maintainer'] = undefined;

/**
 * Required. Immutable. The name of the package.
 * @member {String} name
 */
PackageNote.prototype['name'] = undefined;

/**
 * The type of package; whether native or non native (e.g., ruby gems, node.js packages, etc.).
 * @member {String} packageType
 */
PackageNote.prototype['packageType'] = undefined;

/**
 * The homepage for this package.
 * @member {String} url
 */
PackageNote.prototype['url'] = undefined;

/**
 * @member {module:model/Version} version
 */
PackageNote.prototype['version'] = undefined;
