...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContainerAnalysisApi.BuildNote();
  });
  ...
  describe('BuildNote', function() {
    it('should create an instance of BuildNote', function() {
      // uncomment below and update the code to test BuildNote
      //var instance = new ContainerAnalysisApi.BuildNote();
      //expect(instance).to.be.a(ContainerAnalysisApi.BuildNote);
    });
