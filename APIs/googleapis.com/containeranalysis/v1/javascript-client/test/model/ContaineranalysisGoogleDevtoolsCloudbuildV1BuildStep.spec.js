...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContainerAnalysisApi.ContaineranalysisGoogleDevtoolsCloudbuildV1BuildStep();
  });
  ...
  describe('ContaineranalysisGoogleDevtoolsCloudbuildV1BuildStep', function() {
    it('should create an instance of ContaineranalysisGoogleDevtoolsCloudbuildV1BuildStep', function() {
      // uncomment below and update the code to test ContaineranalysisGoogleDevtoolsCloudbuildV1BuildStep
      //var instance = new ContainerAnalysisApi.ContaineranalysisGoogleDevtoolsCloudbuildV1BuildStep();
      //expect(instance).to.be.a(ContainerAnalysisApi.ContaineranalysisGoogleDevtoolsCloudbuildV1BuildStep);
    });
