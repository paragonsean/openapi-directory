...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContainerAnalysisApi.UpgradeDistribution();
  });
  ...
  describe('UpgradeDistribution', function() {
    it('should create an instance of UpgradeDistribution', function() {
      // uncomment below and update the code to test UpgradeDistribution
      //var instance = new ContainerAnalysisApi.UpgradeDistribution();
      //expect(instance).to.be.a(ContainerAnalysisApi.UpgradeDistribution);
    });
