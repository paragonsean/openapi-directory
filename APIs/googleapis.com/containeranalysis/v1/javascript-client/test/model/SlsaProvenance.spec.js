...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContainerAnalysisApi.SlsaProvenance();
  });
  ...
  describe('SlsaProvenance', function() {
    it('should create an instance of SlsaProvenance', function() {
      // uncomment below and update the code to test SlsaProvenance
      //var instance = new ContainerAnalysisApi.SlsaProvenance();
      //expect(instance).to.be.a(ContainerAnalysisApi.SlsaProvenance);
    });
