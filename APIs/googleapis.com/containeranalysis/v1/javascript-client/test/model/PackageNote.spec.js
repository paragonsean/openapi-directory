...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContainerAnalysisApi.PackageNote();
  });
  ...
  describe('PackageNote', function() {
    it('should create an instance of PackageNote', function() {
      // uncomment below and update the code to test PackageNote
      //var instance = new ContainerAnalysisApi.PackageNote();
      //expect(instance).to.be.a(ContainerAnalysisApi.PackageNote);
    });
