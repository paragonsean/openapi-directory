...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContainerAnalysisApi.ListOccurrencesResponse();
  });
  ...
  describe('ListOccurrencesResponse', function() {
    it('should create an instance of ListOccurrencesResponse', function() {
      // uncomment below and update the code to test ListOccurrencesResponse
      //var instance = new ContainerAnalysisApi.ListOccurrencesResponse();
      //expect(instance).to.be.a(ContainerAnalysisApi.ListOccurrencesResponse);
    });
