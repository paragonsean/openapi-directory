...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContainerAnalysisApi.ImageNote();
  });
  ...
  describe('ImageNote', function() {
    it('should create an instance of ImageNote', function() {
      // uncomment below and update the code to test ImageNote
      //var instance = new ContainerAnalysisApi.ImageNote();
      //expect(instance).to.be.a(ContainerAnalysisApi.ImageNote);
    });
