...
public class DiscoveryOccurrence {
  ...
  public DiscoveryOccurrence analysisCompleted(AnalysisCompleted analysisCompleted) {
  ...
  public DiscoveryOccurrence analysisError(List<Status> analysisError) {
    this.analysisError = analysisError;
    return this;
  }

  public DiscoveryOccurrence addAnalysisErrorItem(Status analysisErrorItem) {
  ...
  public DiscoveryOccurrence analysisStatus(AnalysisStatusEnum analysisStatus) {
  ...
  public DiscoveryOccurrence analysisStatusError(Status analysisStatusError) {
  ...
  public DiscoveryOccurrence continuousAnalysis(ContinuousAnalysisEnum continuousAnalysis) {
  ...
  public DiscoveryOccurrence cpe(String cpe) {
    this.cpe = cpe;
    return this;
  }
  ...
  public DiscoveryOccurrence lastScanTime(String lastScanTime) {
  ...
  public DiscoveryOccurrence sbomStatus(SBOMStatus sbomStatus) {
  ...
  public boolean equals(Object o) {
    ...
    DiscoveryOccurrence discoveryOccurrence = (DiscoveryOccurrence) o;
    return Objects.equals(this.analysisCompleted, discoveryOccurrence.analysisCompleted) &&
        Objects.equals(this.analysisError, discoveryOccurrence.analysisError) &&
        Objects.equals(this.analysisStatus, discoveryOccurrence.analysisStatus) &&
        Objects.equals(this.analysisStatusError, discoveryOccurrence.analysisStatusError) &&
        Objects.equals(this.archiveTime, discoveryOccurrence.archiveTime) &&
        Objects.equals(this.continuousAnalysis, discoveryOccurrence.continuousAnalysis) &&
        Objects.equals(this.cpe, discoveryOccurrence.cpe) &&
        Objects.equals(this.lastScanTime, discoveryOccurrence.lastScanTime) &&
        Objects.equals(this.sbomStatus, discoveryOccurrence.sbomStatus);
  }

  @Override
  public int hashCode() {
    return Objects.hash(analysisCompleted, analysisError, analysisStatus, analysisStatusError, archiveTime, continuousAnalysis, cpe, lastScanTime, sbomStatus);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DiscoveryOccurrence {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DiscoveryOccurrence
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DiscoveryOccurrence.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DiscoveryOccurrence is not found in the empty JSON string", DiscoveryOccurrence.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DiscoveryOccurrence.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DiscoveryOccurrence` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DiscoveryOccurrence.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DiscoveryOccurrence' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DiscoveryOccurrence> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DiscoveryOccurrence.class));

       return (TypeAdapter<T>) new TypeAdapter<DiscoveryOccurrence>() {
           @Override
           public void write(JsonWriter out, DiscoveryOccurrence value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DiscoveryOccurrence read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DiscoveryOccurrence given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DiscoveryOccurrence
   * @throws IOException if the JSON string is invalid with respect to DiscoveryOccurrence
   */
  public static DiscoveryOccurrence fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DiscoveryOccurrence.class);
  }

  /**
   * Convert an instance of DiscoveryOccurrence to an JSON string
   *
   * @return JSON string
   */
