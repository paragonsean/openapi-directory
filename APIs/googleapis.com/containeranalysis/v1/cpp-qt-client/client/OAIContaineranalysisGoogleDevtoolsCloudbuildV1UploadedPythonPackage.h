...
/*
 * OAIContaineranalysisGoogleDevtoolsCloudbuildV1UploadedPythonPackage.h
 *
 * Artifact uploaded using the PythonPackage directive.
 */

#ifndef OAIContaineranalysisGoogleDevtoolsCloudbuildV1UploadedPythonPackage_H
#define OAIContaineranalysisGoogleDevtoolsCloudbuildV1UploadedPythonPackage_H
...
class OAIContaineranalysisGoogleDevtoolsCloudbuildV1UploadedPythonPackage : public OAIObject {
public:
    OAIContaineranalysisGoogleDevtoolsCloudbuildV1UploadedPythonPackage();
    OAIContaineranalysisGoogleDevtoolsCloudbuildV1UploadedPythonPackage(QString json);
    ~OAIContaineranalysisGoogleDevtoolsCloudbuildV1UploadedPythonPackage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIContaineranalysisGoogleDevtoolsCloudbuildV1UploadedPythonPackage)

#endif // OAIContaineranalysisGoogleDevtoolsCloudbuildV1UploadedPythonPackage_H
