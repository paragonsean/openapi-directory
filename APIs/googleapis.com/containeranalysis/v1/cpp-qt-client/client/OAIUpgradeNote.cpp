...
OAIWindowsUpdate OAIUpgradeNote::getWindowsUpdate() const {
    return m_windows_update;
}
void OAIUpgradeNote::setWindowsUpdate(const OAIWindowsUpdate &windows_update) {
    m_windows_update = windows_update;
    m_windows_update_isSet = true;
}

bool OAIUpgradeNote::is_windows_update_Set() const{
    return m_windows_update_isSet;
}

bool OAIUpgradeNote::is_windows_update_Valid() const{
