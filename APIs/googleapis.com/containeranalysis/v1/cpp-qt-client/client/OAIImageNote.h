...
#ifndef OAIImageNote_H
#define OAIImageNote_H
...
class OAIImageNote : public OAIObject {
public:
    OAIImageNote();
    OAIImageNote(QString json);
    ~OAIImageNote() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImageNote)

#endif // OAIImageNote_H
