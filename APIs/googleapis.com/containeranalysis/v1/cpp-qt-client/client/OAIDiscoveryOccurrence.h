...
/*
 * OAIDiscoveryOccurrence.h
 *
 * Provides information about the analysis status of a discovered resource.
 */

#ifndef OAIDiscoveryOccurrence_H
#define OAIDiscoveryOccurrence_H
...
class OAIDiscoveryOccurrence : public OAIObject {
public:
    OAIDiscoveryOccurrence();
    OAIDiscoveryOccurrence(QString json);
    ~OAIDiscoveryOccurrence() override;
    ...
    QString getCpe() const;
    void setCpe(const QString &cpe);
...
Q_DECLARE_METATYPE(OpenAPI::OAIDiscoveryOccurrence)

#endif // OAIDiscoveryOccurrence_H
