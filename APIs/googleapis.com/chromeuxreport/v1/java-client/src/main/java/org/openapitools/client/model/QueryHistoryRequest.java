...
public class QueryHistoryRequest {
  ...
  public QueryHistoryRequest formFactor(FormFactorEnum formFactor) {
  ...
  public QueryHistoryRequest metrics(List<String> metrics) {
    this.metrics = metrics;
    return this;
  }

  public QueryHistoryRequest addMetricsItem(String metricsItem) {
  ...
  public QueryHistoryRequest origin(String origin) {
    this.origin = origin;
    return this;
  }
  ...
  public QueryHistoryRequest url(String url) {
    this.url = url;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    QueryHistoryRequest queryHistoryRequest = (QueryHistoryRequest) o;
    return Objects.equals(this.formFactor, queryHistoryRequest.formFactor) &&
        Objects.equals(this.metrics, queryHistoryRequest.metrics) &&
        Objects.equals(this.origin, queryHistoryRequest.origin) &&
        Objects.equals(this.url, queryHistoryRequest.url);
  }

  @Override
  public int hashCode() {
    return Objects.hash(formFactor, metrics, origin, url);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class QueryHistoryRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to QueryHistoryRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!QueryHistoryRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in QueryHistoryRequest is not found in the empty JSON string", QueryHistoryRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!QueryHistoryRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `QueryHistoryRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!QueryHistoryRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'QueryHistoryRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<QueryHistoryRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(QueryHistoryRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<QueryHistoryRequest>() {
           @Override
           public void write(JsonWriter out, QueryHistoryRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public QueryHistoryRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of QueryHistoryRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of QueryHistoryRequest
   * @throws IOException if the JSON string is invalid with respect to QueryHistoryRequest
   */
  public static QueryHistoryRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, QueryHistoryRequest.class);
  }

  /**
   * Convert an instance of QueryHistoryRequest to an JSON string
   *
   * @return JSON string
   */
