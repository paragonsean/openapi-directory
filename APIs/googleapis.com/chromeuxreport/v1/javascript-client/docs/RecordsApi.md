...
> QueryHistoryResponse chromeuxreportRecordsQueryHistoryRecord(opts)
...
```javascript
import ChromeUxReportApi from 'chrome_ux_report_api';

let apiInstance = new ChromeUxReportApi.RecordsApi();
let opts = {
...
apiInstance.chromeuxreportRecordsQueryHistoryRecord(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> QueryResponse chromeuxreportRecordsQueryRecord(opts)
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'queryRequest': new ChromeUxReportApi.QueryRequest() // QueryRequest | 
};
apiInstance.chromeuxreportRecordsQueryRecord(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
