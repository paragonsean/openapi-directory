# DataflowApi.FlexTemplateRuntimeEnvironment
...
**additionalUserLabels** | **{String: String}** | Additional user labels to be specified for the job. Keys and values must follow the restrictions specified in the [labeling restrictions](https://cloud.google.com/compute/docs/labeling-resources#restrictions) page. An object containing a list of \&quot;key\&quot;: value pairs. Example: { \&quot;name\&quot;: \&quot;wrench\&quot;, \&quot;mass\&quot;: \&quot;1kg\&quot;, \&quot;count\&quot;: \&quot;3\&quot; }. | [optional] 
**autoscalingAlgorithm** | **String** | The algorithm to use for autoscaling | [optional] 
**diskSizeGb** | **Number** | Worker disk size, in gigabytes. | [optional] 
...
**maxWorkers** | **Number** | The maximum number of Google Compute Engine instances to be made available to your pipeline during execution, from 1 to 1000. | [optional] 
...
**numWorkers** | **Number** | The initial number of Google Compute Engine instances for the job. | [optional] 
...
* `UNKNOWN` (value: `"AUTOSCALING_ALGORITHM_UNKNOWN"`)

* `NONE` (value: `"AUTOSCALING_ALGORITHM_NONE"`)

* `BASIC` (value: `"AUTOSCALING_ALGORITHM_BASIC"`)
