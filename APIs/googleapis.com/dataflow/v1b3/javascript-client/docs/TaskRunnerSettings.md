# DataflowApi.TaskRunnerSettings
...
**oauthScopes** | **[String]** | The OAuth2 scopes to be requested by the taskrunner in order to access the Cloud Dataflow API. | [optional] 
