...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataflowApi.SpannerIODetails();
  });
  ...
  describe('SpannerIODetails', function() {
    it('should create an instance of SpannerIODetails', function() {
      // uncomment below and update the code to test SpannerIODetails
      //var instance = new DataflowApi.SpannerIODetails();
      //expect(instance).to.be.a(DataflowApi.SpannerIODetails);
    });
