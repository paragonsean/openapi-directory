...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataflowApi.SdkBug();
  });
  ...
  describe('SdkBug', function() {
    it('should create an instance of SdkBug', function() {
      // uncomment below and update the code to test SdkBug
      //var instance = new DataflowApi.SdkBug();
      //expect(instance).to.be.a(DataflowApi.SdkBug);
    });
