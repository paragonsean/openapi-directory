...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataflowApi.StageExecutionDetails();
  });
  ...
  describe('StageExecutionDetails', function() {
    it('should create an instance of StageExecutionDetails', function() {
      // uncomment below and update the code to test StageExecutionDetails
      //var instance = new DataflowApi.StageExecutionDetails();
      //expect(instance).to.be.a(DataflowApi.StageExecutionDetails);
    });
