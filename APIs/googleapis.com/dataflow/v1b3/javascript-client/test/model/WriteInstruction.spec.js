...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataflowApi.WriteInstruction();
  });
  ...
  describe('WriteInstruction', function() {
    it('should create an instance of WriteInstruction', function() {
      // uncomment below and update the code to test WriteInstruction
      //var instance = new DataflowApi.WriteInstruction();
      //expect(instance).to.be.a(DataflowApi.WriteInstruction);
    });
