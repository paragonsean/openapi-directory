...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataflowApi.ProgressTimeseries();
  });
  ...
  describe('ProgressTimeseries', function() {
    it('should create an instance of ProgressTimeseries', function() {
      // uncomment below and update the code to test ProgressTimeseries
      //var instance = new DataflowApi.ProgressTimeseries();
      //expect(instance).to.be.a(DataflowApi.ProgressTimeseries);
    });
