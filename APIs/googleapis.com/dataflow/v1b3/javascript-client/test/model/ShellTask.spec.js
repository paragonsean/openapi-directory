...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataflowApi.ShellTask();
  });
  ...
  describe('ShellTask', function() {
    it('should create an instance of ShellTask', function() {
      // uncomment below and update the code to test ShellTask
      //var instance = new DataflowApi.ShellTask();
      //expect(instance).to.be.a(DataflowApi.ShellTask);
    });
