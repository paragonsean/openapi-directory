...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataflowApi.PubSubIODetails();
  });
  ...
  describe('PubSubIODetails', function() {
    it('should create an instance of PubSubIODetails', function() {
      // uncomment below and update the code to test PubSubIODetails
      //var instance = new DataflowApi.PubSubIODetails();
      //expect(instance).to.be.a(DataflowApi.PubSubIODetails);
    });
