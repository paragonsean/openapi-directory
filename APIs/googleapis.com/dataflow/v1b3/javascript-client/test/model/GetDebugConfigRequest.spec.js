...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataflowApi.GetDebugConfigRequest();
  });
  ...
  describe('GetDebugConfigRequest', function() {
    it('should create an instance of GetDebugConfigRequest', function() {
      // uncomment below and update the code to test GetDebugConfigRequest
      //var instance = new DataflowApi.GetDebugConfigRequest();
      //expect(instance).to.be.a(DataflowApi.GetDebugConfigRequest);
    });
