...
void OAIListJobsResponse::initializeModel() {
    ...
    m_failed_location_isSet = false;
    m_failed_location_isValid = false;
...
void OAIListJobsResponse::fromJsonObject(QJsonObject json) {
    ...
    m_failed_location_isValid = ::OpenAPI::fromJsonValue(m_failed_location, json[QString("failedLocation")]);
    m_failed_location_isSet = !json[QString("failedLocation")].isNull() && m_failed_location_isValid;
...
QJsonObject OAIListJobsResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_failed_location.size() > 0) {
        obj.insert(QString("failedLocation"), ::OpenAPI::toJsonValue(m_failed_location));
    }
    if (m_jobs.size() > 0) {
...
QList<OAIFailedLocation> OAIListJobsResponse::getFailedLocation() const {
    return m_failed_location;
}
void OAIListJobsResponse::setFailedLocation(const QList<OAIFailedLocation> &failed_location) {
    m_failed_location = failed_location;
    m_failed_location_isSet = true;
}

bool OAIListJobsResponse::is_failed_location_Set() const{
    return m_failed_location_isSet;
}

bool OAIListJobsResponse::is_failed_location_Valid() const{
    return m_failed_location_isValid;
}
