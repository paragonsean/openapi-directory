...
#ifndef OAIConcatPosition_H
#define OAIConcatPosition_H
...
class OAIConcatPosition : public OAIObject {
public:
    OAIConcatPosition();
    OAIConcatPosition(QString json);
    ~OAIConcatPosition() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConcatPosition)

#endif // OAIConcatPosition_H
