...
|**mountPoint** | **String** | Directory in a VM where disk is mounted. |  [optional] |
|**sizeGb** | **Integer** | Size of disk in GB. If zero or unspecified, the service will attempt to choose a reasonable default. |  [optional] |
