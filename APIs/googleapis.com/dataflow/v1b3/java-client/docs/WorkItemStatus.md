...
|**counterUpdates** | [**List&lt;CounterUpdate&gt;**](CounterUpdate.md) | Worker output counters for this WorkItem. |  [optional] |
...
|**metricUpdates** | [**List&lt;MetricUpdate&gt;**](MetricUpdate.md) | DEPRECATED in favor of counter_updates. |  [optional] |
...
|**totalThrottlerWaitTimeSeconds** | **Double** | Total time the worker spent being throttled by external systems. |  [optional] |
