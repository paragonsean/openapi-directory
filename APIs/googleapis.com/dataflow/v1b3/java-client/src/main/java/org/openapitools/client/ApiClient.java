...
public class ApiClient {
    ...
    private String basePath = "https://dataflow.googleapis.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/v1b3/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://dataflow.googleapis.com
