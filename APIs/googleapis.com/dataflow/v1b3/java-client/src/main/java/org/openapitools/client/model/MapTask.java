...
public class MapTask {
  public static final String SERIALIZED_NAME_COUNTER_PREFIX = "counterPrefix";
  @SerializedName(SERIALIZED_NAME_COUNTER_PREFIX)
  ...
  public MapTask counterPrefix(String counterPrefix) {
  ...
  public MapTask instructions(List<ParallelInstruction> instructions) {
    this.instructions = instructions;
    return this;
  }

  public MapTask addInstructionsItem(ParallelInstruction instructionsItem) {
  ...
  public MapTask stageName(String stageName) {
  ...
  public MapTask systemName(String systemName) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.counterPrefix, mapTask.counterPrefix) &&
        Objects.equals(this.instructions, mapTask.instructions) &&
        Objects.equals(this.stageName, mapTask.stageName) &&
        Objects.equals(this.systemName, mapTask.systemName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(counterPrefix, instructions, stageName, systemName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MapTask {\n");
    sb.append("    counterPrefix: ").append(toIndentedString(counterPrefix)).append("\n");
  ...
  static {
    ...
    openapiFields.add("counterPrefix");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MapTask
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MapTask.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MapTask is not found in the empty JSON string", MapTask.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MapTask.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MapTask` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("counterPrefix") != null && !jsonObj.get("counterPrefix").isJsonNull()) && !jsonObj.get("counterPrefix").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `counterPrefix` to be a primitive type in the JSON string but got `%s`", jsonObj.get("counterPrefix").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MapTask.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MapTask' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MapTask> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MapTask.class));

       return (TypeAdapter<T>) new TypeAdapter<MapTask>() {
           @Override
           public void write(JsonWriter out, MapTask value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MapTask read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MapTask given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MapTask
   * @throws IOException if the JSON string is invalid with respect to MapTask
   */
  public static MapTask fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MapTask.class);
  }

  /**
   * Convert an instance of MapTask to an JSON string
   *
   * @return JSON string
   */
