...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudKeyManagementServiceKmsApi.ListLocationsResponse();
  });
  ...
  describe('ListLocationsResponse', function() {
    it('should create an instance of ListLocationsResponse', function() {
      ...
      //var instance = new CloudKeyManagementServiceKmsApi.ListLocationsResponse();
      //expect(instance).to.be.a(CloudKeyManagementServiceKmsApi.ListLocationsResponse);
    });
