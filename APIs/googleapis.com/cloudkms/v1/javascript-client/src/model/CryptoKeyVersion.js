...
/**
 * The CryptoKeyVersion model module.
 * @module model/CryptoKeyVersion
 * @version v1
 */
class CryptoKeyVersion {
    /**
     * Constructs a new <code>CryptoKeyVersion</code>.
     * A CryptoKeyVersion represents an individual cryptographic key, and the associated key material. An ENABLED version can be used for cryptographic operations. For security reasons, the raw cryptographic key material represented by a CryptoKeyVersion can never be viewed or exported. It can only be used to encrypt, decrypt, or sign data when an authorized user or application invokes Cloud KMS.
     * @alias module:model/CryptoKeyVersion
     */
    constructor() { 
        
        CryptoKeyVersion.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CryptoKeyVersion</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CryptoKeyVersion} obj Optional instance to populate.
     * @return {module:model/CryptoKeyVersion} The populated <code>CryptoKeyVersion</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CryptoKeyVersion();
            ...
            if (data.hasOwnProperty('externalProtectionLevelOptions')) {
                obj['externalProtectionLevelOptions'] = ExternalProtectionLevelOptions.constructFromObject(data['externalProtectionLevelOptions']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CryptoKeyVersion</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CryptoKeyVersion</code>.
     */
    static validateJSON(data) {
        ...
        if (data['externalProtectionLevelOptions']) { // data not null
          ExternalProtectionLevelOptions.validateJSON(data['externalProtectionLevelOptions']);
        }
        // ensure the json data is a string
 ...
 * @member {module:model/CryptoKeyVersion.AlgorithmEnum} algorithm
 */
CryptoKeyVersion.prototype['algorithm'] = undefined;

/**
 * @member {module:model/KeyOperationAttestation} attestation
 */
CryptoKeyVersion.prototype['attestation'] = undefined;

/**
 * Output only. The time at which this CryptoKeyVersion was created.
 * @member {String} createTime
 */
CryptoKeyVersion.prototype['createTime'] = undefined;

/**
 * Output only. The time this CryptoKeyVersion's key material was destroyed. Only present if state is DESTROYED.
 * @member {String} destroyEventTime
 */
CryptoKeyVersion.prototype['destroyEventTime'] = undefined;

/**
 * Output only. The time this CryptoKeyVersion's key material is scheduled for destruction. Only present if state is DESTROY_SCHEDULED.
 * @member {String} destroyTime
 */
CryptoKeyVersion.prototype['destroyTime'] = undefined;

/**
 * Output only. The root cause of the most recent external destruction failure. Only present if state is EXTERNAL_DESTRUCTION_FAILED.
 * @member {String} externalDestructionFailureReason
 */
CryptoKeyVersion.prototype['externalDestructionFailureReason'] = undefined;

/**
 * @member {module:model/ExternalProtectionLevelOptions} externalProtectionLevelOptions
 */
CryptoKeyVersion.prototype['externalProtectionLevelOptions'] = undefined;

/**
 * Output only. The time this CryptoKeyVersion's key material was generated.
 * @member {String} generateTime
 */
CryptoKeyVersion.prototype['generateTime'] = undefined;

/**
 * Output only. The root cause of the most recent generation failure. Only present if state is GENERATION_FAILED.
 * @member {String} generationFailureReason
 */
CryptoKeyVersion.prototype['generationFailureReason'] = undefined;

/**
 * Output only. The root cause of the most recent import failure. Only present if state is IMPORT_FAILED.
 * @member {String} importFailureReason
 */
CryptoKeyVersion.prototype['importFailureReason'] = undefined;

/**
 * Output only. The name of the ImportJob used in the most recent import of this CryptoKeyVersion. Only present if the underlying key material was imported.
 * @member {String} importJob
 */
CryptoKeyVersion.prototype['importJob'] = undefined;

/**
 * Output only. The time at which this CryptoKeyVersion's key material was most recently imported.
 * @member {String} importTime
 */
CryptoKeyVersion.prototype['importTime'] = undefined;
 ...
 * @member {String} name
 */
CryptoKeyVersion.prototype['name'] = undefined;

/**
 * Output only. The ProtectionLevel describing how crypto operations are performed with this CryptoKeyVersion.
 * @member {module:model/CryptoKeyVersion.ProtectionLevelEnum} protectionLevel
 */
CryptoKeyVersion.prototype['protectionLevel'] = undefined;

/**
 * Output only. Whether or not this key version is eligible for reimport, by being specified as a target in ImportCryptoKeyVersionRequest.crypto_key_version.
 * @member {Boolean} reimportEligible
 */
CryptoKeyVersion.prototype['reimportEligible'] = undefined;

/**
 * The current state of the CryptoKeyVersion.
 * @member {module:model/CryptoKeyVersion.StateEnum} state
 */
CryptoKeyVersion.prototype['state'] = undefined;
 ...
 * @readonly
 */
CryptoKeyVersion['AlgorithmEnum'] = {
 ...
 * @readonly
 */
CryptoKeyVersion['ProtectionLevelEnum'] = {
...
export default CryptoKeyVersion;
