...
/**
 * The CryptoKeyVersionTemplate model module.
 * @module model/CryptoKeyVersionTemplate
 * @version v1
 */
class CryptoKeyVersionTemplate {
    /**
     * Constructs a new <code>CryptoKeyVersionTemplate</code>.
     * A CryptoKeyVersionTemplate specifies the properties to use when creating a new CryptoKeyVersion, either manually with CreateCryptoKeyVersion or automatically as a result of auto-rotation.
     * @alias module:model/CryptoKeyVersionTemplate
     */
    constructor() { 
        
        CryptoKeyVersionTemplate.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CryptoKeyVersionTemplate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CryptoKeyVersionTemplate} obj Optional instance to populate.
     * @return {module:model/CryptoKeyVersionTemplate} The populated <code>CryptoKeyVersionTemplate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CryptoKeyVersionTemplate();
    ...
    /**
     * Validates the JSON data with respect to <code>CryptoKeyVersionTemplate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CryptoKeyVersionTemplate</code>.
     */
 ...
 * @member {module:model/CryptoKeyVersionTemplate.AlgorithmEnum} algorithm
 */
CryptoKeyVersionTemplate.prototype['algorithm'] = undefined;

/**
 * ProtectionLevel to use when creating a CryptoKeyVersion based on this template. Immutable. Defaults to SOFTWARE.
 * @member {module:model/CryptoKeyVersionTemplate.ProtectionLevelEnum} protectionLevel
 */
CryptoKeyVersionTemplate.prototype['protectionLevel'] = undefined;
 ...
 * @readonly
 */
CryptoKeyVersionTemplate['AlgorithmEnum'] = {
 ...
 * @readonly
 */
CryptoKeyVersionTemplate['ProtectionLevelEnum'] = {
...
export default CryptoKeyVersionTemplate;
