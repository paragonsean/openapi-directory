...
/**
 * The MacSignResponse model module.
 * @module model/MacSignResponse
 * @version v1
 */
class MacSignResponse {
    /**
     * Constructs a new <code>MacSignResponse</code>.
     * Response message for KeyManagementService.MacSign.
     * @alias module:model/MacSignResponse
     */
    constructor() { 
        
        MacSignResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MacSignResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MacSignResponse} obj Optional instance to populate.
     * @return {module:model/MacSignResponse} The populated <code>MacSignResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MacSignResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>MacSignResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MacSignResponse</code>.
     */
 ...
 * @member {Blob} mac
 */
MacSignResponse.prototype['mac'] = undefined;
 ...
 */
MacSignResponse.prototype['macCrc32c'] = undefined;
 ...
 * @member {String} name
 */
MacSignResponse.prototype['name'] = undefined;

/**
 * The ProtectionLevel of the CryptoKeyVersion used for signing.
 * @member {module:model/MacSignResponse.ProtectionLevelEnum} protectionLevel
 */
MacSignResponse.prototype['protectionLevel'] = undefined;
 ...
 */
MacSignResponse.prototype['verifiedDataCrc32c'] = undefined;
 ...
 * @readonly
 */
MacSignResponse['ProtectionLevelEnum'] = {
...
export default MacSignResponse;
