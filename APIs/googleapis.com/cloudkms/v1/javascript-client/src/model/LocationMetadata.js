...
class LocationMetadata {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('ekmAvailable')) {
                obj['ekmAvailable'] = ApiClient.convertToType(data['ekmAvailable'], 'Boolean');
            }
            if (data.hasOwnProperty('hsmAvailable')) {
                obj['hsmAvailable'] = ApiClient.convertToType(data['hsmAvailable'], 'Boolean');
            }
        }
        return obj;
    }
 ...
 */
LocationMetadata.prototype['ekmAvailable'] = undefined;

/**
 * Indicates whether CryptoKeys with protection_level HSM can be created in this location.
 * @member {Boolean} hsmAvailable
 */
LocationMetadata.prototype['hsmAvailable'] = undefined;
