# CloudKeyManagementServiceKmsApi.AsymmetricDecryptRequest

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**ciphertext** | **Blob** | Required. The data encrypted with the named CryptoKeyVersion&#39;s public key using OAEP. | [optional] 
