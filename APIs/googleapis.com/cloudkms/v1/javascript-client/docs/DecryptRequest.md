# CloudKeyManagementServiceKmsApi.DecryptRequest

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**additionalAuthenticatedData** | **Blob** | Optional. Optional data that must match the data originally supplied in EncryptRequest.additional_authenticated_data. | [optional] 
...
**ciphertext** | **Blob** | Required. The encrypted data originally returned in EncryptResponse.ciphertext. | [optional] 
