# CloudKeyManagementServiceKmsApi.Certificate
...
**rawDer** | **Blob** | Required. The raw certificate bytes in DER format. | [optional] 
...
**subjectAlternativeDnsNames** | **[String]** | Output only. The subject Alternative DNS names. Only present if parsed is true. | [optional] [readonly] 
