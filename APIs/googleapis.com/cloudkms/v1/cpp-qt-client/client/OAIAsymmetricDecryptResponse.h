...
/*
 * OAIAsymmetricDecryptResponse.h
 *
 * Response message for KeyManagementService.AsymmetricDecrypt.
 */

#ifndef OAIAsymmetricDecryptResponse_H
#define OAIAsymmetricDecryptResponse_H
...
class OAIAsymmetricDecryptResponse : public OAIObject {
public:
    OAIAsymmetricDecryptResponse();
    OAIAsymmetricDecryptResponse(QString json);
    ~OAIAsymmetricDecryptResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAsymmetricDecryptResponse)

#endif // OAIAsymmetricDecryptResponse_H
