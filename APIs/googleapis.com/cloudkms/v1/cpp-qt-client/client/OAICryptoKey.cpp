...
QString OAICryptoKey::getCreateTime() const {
    return m_create_time;
}
void OAICryptoKey::setCreateTime(const QString &create_time) {
    m_create_time = create_time;
    m_create_time_isSet = true;
}

bool OAICryptoKey::is_create_time_Set() const{
    return m_create_time_isSet;
}

bool OAICryptoKey::is_create_time_Valid() const{
    return m_create_time_isValid;
}

QString OAICryptoKey::getCryptoKeyBackend() const {
    return m_crypto_key_backend;
}
void OAICryptoKey::setCryptoKeyBackend(const QString &crypto_key_backend) {
    m_crypto_key_backend = crypto_key_backend;
    m_crypto_key_backend_isSet = true;
}

bool OAICryptoKey::is_crypto_key_backend_Set() const{
    return m_crypto_key_backend_isSet;
}

bool OAICryptoKey::is_crypto_key_backend_Valid() const{
    return m_crypto_key_backend_isValid;
}

QString OAICryptoKey::getDestroyScheduledDuration() const {
    return m_destroy_scheduled_duration;
}
void OAICryptoKey::setDestroyScheduledDuration(const QString &destroy_scheduled_duration) {
    m_destroy_scheduled_duration = destroy_scheduled_duration;
    m_destroy_scheduled_duration_isSet = true;
}

bool OAICryptoKey::is_destroy_scheduled_duration_Set() const{
    return m_destroy_scheduled_duration_isSet;
}

bool OAICryptoKey::is_destroy_scheduled_duration_Valid() const{
    return m_destroy_scheduled_duration_isValid;
}

bool OAICryptoKey::isImportOnly() const {
    return m_import_only;
}
void OAICryptoKey::setImportOnly(const bool &import_only) {
    m_import_only = import_only;
    m_import_only_isSet = true;
}

bool OAICryptoKey::is_import_only_Set() const{
    return m_import_only_isSet;
}

bool OAICryptoKey::is_import_only_Valid() const{
    return m_import_only_isValid;
}

QMap<QString, QString> OAICryptoKey::getLabels() const {
    return m_labels;
}
void OAICryptoKey::setLabels(const QMap<QString, QString> &labels) {
    m_labels = labels;
    m_labels_isSet = true;
}

bool OAICryptoKey::is_labels_Set() const{
    return m_labels_isSet;
}

bool OAICryptoKey::is_labels_Valid() const{
    return m_labels_isValid;
}

QString OAICryptoKey::getName() const {
    return m_name;
}
void OAICryptoKey::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICryptoKey::is_name_Set() const{
    return m_name_isSet;
}

bool OAICryptoKey::is_name_Valid() const{
    return m_name_isValid;
}

QString OAICryptoKey::getNextRotationTime() const {
    return m_next_rotation_time;
}
void OAICryptoKey::setNextRotationTime(const QString &next_rotation_time) {
    m_next_rotation_time = next_rotation_time;
    m_next_rotation_time_isSet = true;
}

bool OAICryptoKey::is_next_rotation_time_Set() const{
    return m_next_rotation_time_isSet;
}

bool OAICryptoKey::is_next_rotation_time_Valid() const{
    return m_next_rotation_time_isValid;
}

OAICryptoKeyVersion OAICryptoKey::getPrimary() const {
    return m_primary;
}
void OAICryptoKey::setPrimary(const OAICryptoKeyVersion &primary) {
    m_primary = primary;
    m_primary_isSet = true;
}

bool OAICryptoKey::is_primary_Set() const{
    return m_primary_isSet;
}

bool OAICryptoKey::is_primary_Valid() const{
    return m_primary_isValid;
}

QString OAICryptoKey::getPurpose() const {
    return m_purpose;
}
void OAICryptoKey::setPurpose(const QString &purpose) {
    m_purpose = purpose;
    m_purpose_isSet = true;
}

bool OAICryptoKey::is_purpose_Set() const{
    return m_purpose_isSet;
}

bool OAICryptoKey::is_purpose_Valid() const{
    return m_purpose_isValid;
}

QString OAICryptoKey::getRotationPeriod() const {
    return m_rotation_period;
}
void OAICryptoKey::setRotationPeriod(const QString &rotation_period) {
    m_rotation_period = rotation_period;
    m_rotation_period_isSet = true;
}

bool OAICryptoKey::is_rotation_period_Set() const{
    return m_rotation_period_isSet;
}

bool OAICryptoKey::is_rotation_period_Valid() const{
    return m_rotation_period_isValid;
}

OAICryptoKeyVersionTemplate OAICryptoKey::getVersionTemplate() const {
    return m_version_template;
}
void OAICryptoKey::setVersionTemplate(const OAICryptoKeyVersionTemplate &version_template) {
    m_version_template = version_template;
    m_version_template_isSet = true;
}

bool OAICryptoKey::is_version_template_Set() const{
    return m_version_template_isSet;
}

bool OAICryptoKey::is_version_template_Valid() const{
