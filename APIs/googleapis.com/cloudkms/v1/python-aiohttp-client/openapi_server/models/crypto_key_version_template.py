...
class CryptoKeyVersionTemplate(Model):
    ...
    def __init__(self, algorithm: str=None, protection_level: str=None):
        """CryptoKeyVersionTemplate - a model defined in OpenAPI

        :param algorithm: The algorithm of this CryptoKeyVersionTemplate.
        :param protection_level: The protection_level of this CryptoKeyVersionTemplate.
        """
        self.openapi_types = {
            'algorithm': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CryptoKeyVersionTemplate':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The CryptoKeyVersionTemplate of this CryptoKeyVersionTemplate.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def algorithm(self):
        """Gets the algorithm of this CryptoKeyVersionTemplate.

        Required. Algorithm to use when creating a CryptoKeyVersion based on this template. For backwards compatibility, GOOGLE_SYMMETRIC_ENCRYPTION is implied if both this field is omitted and CryptoKey.purpose is ENCRYPT_DECRYPT.

        :return: The algorithm of this CryptoKeyVersionTemplate.
        :rtype: str
        """
    ...
    def algorithm(self, algorithm):
        """Sets the algorithm of this CryptoKeyVersionTemplate.
    ...
    def protection_level(self):
        """Gets the protection_level of this CryptoKeyVersionTemplate.

        ProtectionLevel to use when creating a CryptoKeyVersion based on this template. Immutable. Defaults to SOFTWARE.

        :return: The protection_level of this CryptoKeyVersionTemplate.
        :rtype: str
        """
    ...
    def protection_level(self, protection_level):
        """Sets the protection_level of this CryptoKeyVersionTemplate.
