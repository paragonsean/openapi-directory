...
|------------ | ------------- | ------------- | -------------|
|**data** | **byte[]** | Required. The data used previously as a MacSignRequest.data to generate the MAC tag. |  [optional] |
...
|**mac** | **byte[]** | Required. The signature to verify. |  [optional] |
