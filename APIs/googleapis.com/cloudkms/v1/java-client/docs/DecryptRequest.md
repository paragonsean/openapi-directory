...
|------------ | ------------- | ------------- | -------------|
|**additionalAuthenticatedData** | **byte[]** | Optional. Optional data that must match the data originally supplied in EncryptRequest.additional_authenticated_data. |  [optional] |
...
|**ciphertext** | **byte[]** | Required. The encrypted data originally returned in EncryptResponse.ciphertext. |  [optional] |
