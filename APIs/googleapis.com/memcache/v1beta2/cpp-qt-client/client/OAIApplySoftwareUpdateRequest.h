...
/*
 * OAIApplySoftwareUpdateRequest.h
 *
 * Request for ApplySoftwareUpdate.
 */

#ifndef OAIApplySoftwareUpdateRequest_H
#define OAIApplySoftwareUpdateRequest_H
...
class OAIApplySoftwareUpdateRequest : public OAIObject {
public:
    OAIApplySoftwareUpdateRequest();
    OAIApplySoftwareUpdateRequest(QString json);
    ~OAIApplySoftwareUpdateRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApplySoftwareUpdateRequest)

#endif // OAIApplySoftwareUpdateRequest_H
