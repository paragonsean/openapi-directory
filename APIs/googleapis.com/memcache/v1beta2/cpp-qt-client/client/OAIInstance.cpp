...
OAIGoogleCloudMemcacheV1beta2MaintenancePolicy OAIInstance::getMaintenancePolicy() const {
    return m_maintenance_policy;
}
void OAIInstance::setMaintenancePolicy(const OAIGoogleCloudMemcacheV1beta2MaintenancePolicy &maintenance_policy) {
...
bool OAIInstance::isUpdateAvailable() const {
    return m_update_available;
}
void OAIInstance::setUpdateAvailable(const bool &update_available) {
    m_update_available = update_available;
    m_update_available_isSet = true;
}

bool OAIInstance::is_update_available_Set() const{
    return m_update_available_isSet;
}

bool OAIInstance::is_update_available_Valid() const{
