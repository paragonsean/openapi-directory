...
QList<OAIInstance> OAIListInstancesResponse::getResources() const {
    return m_resources;
}
void OAIListInstancesResponse::setResources(const QList<OAIInstance> &resources) {
    m_resources = resources;
    m_resources_isSet = true;
}

bool OAIListInstancesResponse::is_resources_Set() const{
    return m_resources_isSet;
}

bool OAIListInstancesResponse::is_resources_Valid() const{
