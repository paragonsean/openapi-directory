...
class Node(Model):
    ...
    def __init__(self, host: str=None, memcache_full_version: str=None, memcache_version: str=None, node_id: str=None, parameters: MemcacheParameters=None, port: int=None, state: str=None, update_available: bool=None, zone: str=None):
        ...
        :param update_available: The update_available of this Node.
    ...
    def update_available(self):
        """Gets the update_available of this Node.

        Output only. Returns true if there is an update waiting to be applied

        :return: The update_available of this Node.
        :rtype: bool
        """
    ...
    def update_available(self, update_available):
        """Sets the update_available of this Node.
