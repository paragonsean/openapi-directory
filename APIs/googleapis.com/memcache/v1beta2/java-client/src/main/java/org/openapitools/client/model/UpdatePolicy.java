...
public class UpdatePolicy {
  ...
  public UpdatePolicy channel(ChannelEnum channel) {
  ...
  public UpdatePolicy denyMaintenancePeriods(List<DenyMaintenancePeriod> denyMaintenancePeriods) {
  ...
  public UpdatePolicy window(MaintenanceWindow window) {
    this.window = window;
    return this;
  }
