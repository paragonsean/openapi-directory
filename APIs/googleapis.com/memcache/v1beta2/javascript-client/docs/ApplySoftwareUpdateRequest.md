# CloudMemorystoreForMemcachedApi.ApplySoftwareUpdateRequest
...
**nodeIds** | **[String]** | Nodes to which we should apply the update to. Note all the selected nodes are updated in parallel. | [optional] 
