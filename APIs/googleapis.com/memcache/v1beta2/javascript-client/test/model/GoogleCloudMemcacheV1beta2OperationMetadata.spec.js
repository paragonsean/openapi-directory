...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudMemorystoreForMemcachedApi.GoogleCloudMemcacheV1beta2OperationMetadata();
  });
  ...
  describe('GoogleCloudMemcacheV1beta2OperationMetadata', function() {
    it('should create an instance of GoogleCloudMemcacheV1beta2OperationMetadata', function() {
      // uncomment below and update the code to test GoogleCloudMemcacheV1beta2OperationMetadata
      //var instance = new CloudMemorystoreForMemcachedApi.GoogleCloudMemcacheV1beta2OperationMetadata();
      //expect(instance).to.be.a(CloudMemorystoreForMemcachedApi.GoogleCloudMemcacheV1beta2OperationMetadata);
    });
