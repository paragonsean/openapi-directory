...
class OAIGoogleCloudMemcacheV1MaintenancePolicy;
...
public:
    ...
    OAIGoogleCloudMemcacheV1MaintenancePolicy getMaintenancePolicy() const;
    void setMaintenancePolicy(const OAIGoogleCloudMemcacheV1MaintenancePolicy &maintenance_policy);
...
private:
    ...
    OAIGoogleCloudMemcacheV1MaintenancePolicy m_maintenance_policy;
