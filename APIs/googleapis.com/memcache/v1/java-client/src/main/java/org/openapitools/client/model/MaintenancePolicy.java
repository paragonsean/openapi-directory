...
public class MaintenancePolicy {
  ...
  public MaintenancePolicy createTime(String createTime) {
  ...
  public MaintenancePolicy description(String description) {
  ...
  public MaintenancePolicy labels(Map<String, String> labels) {
    this.labels = labels;
    return this;
  }
  ...
  public MaintenancePolicy name(String name) {
    this.name = name;
    return this;
  }
  ...
  public MaintenancePolicy state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  public MaintenancePolicy updatePolicy(UpdatePolicy updatePolicy) {
  ...
  public MaintenancePolicy updateTime(String updateTime) {
