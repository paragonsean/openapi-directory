...
public class Instance {
  ...
  public Instance maintenancePolicy(GoogleCloudMemcacheV1MaintenancePolicy maintenancePolicy) {
  ...
  public void setMaintenancePolicy(GoogleCloudMemcacheV1MaintenancePolicy maintenancePolicy) {
    this.maintenancePolicy = maintenancePolicy;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(authorizedNetwork, createTime, discoveryEndpoint, displayName, instanceMessages, labels, maintenancePolicy, maintenanceSchedule, memcacheFullVersion, memcacheNodes, memcacheVersion, name, nodeConfig, nodeCount, parameters, reservedIpRangeId, state, updateTime, zones);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("maintenancePolicy") != null && !jsonObj.get("maintenancePolicy").isJsonNull()) {
        GoogleCloudMemcacheV1MaintenancePolicy.validateJsonElement(jsonObj.get("maintenancePolicy"));
      }
