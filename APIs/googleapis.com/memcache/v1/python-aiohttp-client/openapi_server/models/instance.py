...
class Instance(Model):
    ...
    def __init__(self, authorized_network: str=None, create_time: str=None, discovery_endpoint: str=None, display_name: str=None, instance_messages: List[InstanceMessage]=None, labels: Dict[str, str]=None, maintenance_policy: GoogleCloudMemcacheV1MaintenancePolicy=None, maintenance_schedule: MaintenanceSchedule=None, memcache_full_version: str=None, memcache_nodes: List[Node]=None, memcache_version: str=None, name: str=None, node_config: NodeConfig=None, node_count: int=None, parameters: MemcacheParameters=None, reserved_ip_range_id: List[str]=None, state: str=None, update_time: str=None, zones: List[str]=None):
        ...
        self.openapi_types = {
            ...
            'labels': Dict[str, str],
            'maintenance_policy': GoogleCloudMemcacheV1MaintenancePolicy,
    ...
    def maintenance_policy(self):
        ...
        :rtype: GoogleCloudMemcacheV1MaintenancePolicy
        """
    ...
    def maintenance_policy(self, maintenance_policy):
        ...
        :param maintenance_policy: The maintenance_policy of this Instance.
        :type maintenance_policy: GoogleCloudMemcacheV1MaintenancePolicy
        """
