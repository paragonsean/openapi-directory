...
async def test_memcache_projects_locations_instances_apply_parameters(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{nameapply_parameter}'.format(name='name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_memcache_projects_locations_instances_reschedule_maintenance(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{instancereschedule_maintenanc}'.format(instance='instance_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_memcache_projects_locations_instances_update_parameters(client):
    ...
    response = await client.request(
        method='PATCH',
        path='/v1/{nameupdate_parameter}'.format(name='name_example'),
        headers=headers,
        json=body,
        params=params,
        )
