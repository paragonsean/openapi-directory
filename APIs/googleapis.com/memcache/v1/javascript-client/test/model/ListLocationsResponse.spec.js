...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudMemorystoreForMemcachedApi.ListLocationsResponse();
  });
  ...
  describe('ListLocationsResponse', function() {
    it('should create an instance of ListLocationsResponse', function() {
      ...
      //var instance = new CloudMemorystoreForMemcachedApi.ListLocationsResponse();
      //expect(instance).to.be.a(CloudMemorystoreForMemcachedApi.ListLocationsResponse);
    });
