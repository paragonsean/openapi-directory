...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudMemorystoreForMemcachedApi.Location();
  });
  ...
  describe('Location', function() {
    it('should create an instance of Location', function() {
      ...
      //var instance = new CloudMemorystoreForMemcachedApi.Location();
      //expect(instance).to.be.a(CloudMemorystoreForMemcachedApi.Location);
    });
