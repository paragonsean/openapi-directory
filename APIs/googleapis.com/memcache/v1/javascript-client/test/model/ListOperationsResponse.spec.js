...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudMemorystoreForMemcachedApi.ListOperationsResponse();
  });
  ...
  describe('ListOperationsResponse', function() {
    it('should create an instance of ListOperationsResponse', function() {
      ...
      //var instance = new CloudMemorystoreForMemcachedApi.ListOperationsResponse();
      //expect(instance).to.be.a(CloudMemorystoreForMemcachedApi.ListOperationsResponse);
    });
