...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudMemorystoreForMemcachedApi.ModelDate();
  });
  ...
  describe('ModelDate', function() {
    it('should create an instance of ModelDate', function() {
      ...
      //var instance = new CloudMemorystoreForMemcachedApi.ModelDate();
      //expect(instance).to.be.a(CloudMemorystoreForMemcachedApi.ModelDate);
    });
