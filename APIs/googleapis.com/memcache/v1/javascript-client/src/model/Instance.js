...
class Instance {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('maintenancePolicy')) {
                obj['maintenancePolicy'] = GoogleCloudMemcacheV1MaintenancePolicy.constructFromObject(data['maintenancePolicy']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['maintenancePolicy']) { // data not null
          GoogleCloudMemcacheV1MaintenancePolicy.validateJSON(data['maintenancePolicy']);
        }
...
/**
 * @member {module:model/GoogleCloudMemcacheV1MaintenancePolicy} maintenancePolicy
 */
