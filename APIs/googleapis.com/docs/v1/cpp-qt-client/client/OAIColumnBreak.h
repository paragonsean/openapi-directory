...
#ifndef OAIColumnBreak_H
#define OAIColumnBreak_H
...
class OAIColumnBreak : public OAIObject {
public:
    OAIColumnBreak();
    OAIColumnBreak(QString json);
    ~OAIColumnBreak() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIColumnBreak)

#endif // OAIColumnBreak_H
