...
#ifndef OAIHorizontalRule_H
#define OAIHorizontalRule_H
...
class OAIHorizontalRule : public OAIObject {
public:
    OAIHorizontalRule();
    OAIHorizontalRule(QString json);
    ~OAIHorizontalRule() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHorizontalRule)

#endif // OAIHorizontalRule_H
