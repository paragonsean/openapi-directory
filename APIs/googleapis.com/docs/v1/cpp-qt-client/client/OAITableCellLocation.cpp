...
OAILocation OAITableCellLocation::getTableStartLocation() const {
    return m_table_start_location;
}
void OAITableCellLocation::setTableStartLocation(const OAILocation &table_start_location) {
    m_table_start_location = table_start_location;
    m_table_start_location_isSet = true;
}

bool OAITableCellLocation::is_table_start_location_Set() const{
    return m_table_start_location_isSet;
}

bool OAITableCellLocation::is_table_start_location_Valid() const{
