...
class PageBreak(Model):
    ...
    def __init__(self, suggested_deletion_ids: List[str]=None, suggested_insertion_ids: List[str]=None, suggested_text_style_changes: Dict[str, SuggestedTextStyle]=None, text_style: TextStyle=None):
        """PageBreak - a model defined in OpenAPI

        :param suggested_deletion_ids: The suggested_deletion_ids of this PageBreak.
        :param suggested_insertion_ids: The suggested_insertion_ids of this PageBreak.
        :param suggested_text_style_changes: The suggested_text_style_changes of this PageBreak.
        :param text_style: The text_style of this PageBreak.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'PageBreak':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The PageBreak of this PageBreak.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def suggested_deletion_ids(self):
        """Gets the suggested_deletion_ids of this PageBreak.

        The suggested deletion IDs. If empty, then there are no suggested deletions of this content.

        :return: The suggested_deletion_ids of this PageBreak.
        :rtype: List[str]
        """
    ...
    def suggested_deletion_ids(self, suggested_deletion_ids):
        """Sets the suggested_deletion_ids of this PageBreak.
    ...
    def suggested_insertion_ids(self):
        """Gets the suggested_insertion_ids of this PageBreak.
        ...
        :return: The suggested_insertion_ids of this PageBreak.
        :rtype: List[str]
        """
    ...
    def suggested_insertion_ids(self, suggested_insertion_ids):
        """Sets the suggested_insertion_ids of this PageBreak.
    ...
    def suggested_text_style_changes(self):
        """Gets the suggested_text_style_changes of this PageBreak.

        The suggested text style changes to this PageBreak, keyed by suggestion ID.

        :return: The suggested_text_style_changes of this PageBreak.
    ...
    def suggested_text_style_changes(self, suggested_text_style_changes):
        """Sets the suggested_text_style_changes of this PageBreak.
    ...
    @property
    def text_style(self):
        """Gets the text_style of this PageBreak.


        :return: The text_style of this PageBreak.
        :rtype: TextStyle
        """
    ...
    def text_style(self, text_style):
        """Sets the text_style of this PageBreak.
