...
class TextStyle(Model):
    ...
    def __init__(self, background_color: OptionalColor=None, baseline_offset: str=None, bold: bool=None, font_size: Dimension=None, foreground_color: OptionalColor=None, italic: bool=None, link: Link=None, small_caps: bool=None, strikethrough: bool=None, underline: bool=None, weighted_font_family: WeightedFontFamily=None):
