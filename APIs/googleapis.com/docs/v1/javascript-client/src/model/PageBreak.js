...
/**
 * The PageBreak model module.
 * @module model/PageBreak
 * @version v1
 */
class PageBreak {
    /**
     * Constructs a new <code>PageBreak</code>.
     * A ParagraphElement representing a page break. A page break makes the subsequent text start at the top of the next page.
     * @alias module:model/PageBreak
     */
    constructor() { 
        
        PageBreak.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PageBreak</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PageBreak} obj Optional instance to populate.
     * @return {module:model/PageBreak} The populated <code>PageBreak</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PageBreak();
    ...
    /**
     * Validates the JSON data with respect to <code>PageBreak</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PageBreak</code>.
     */
 ...
 */
PageBreak.prototype['suggestedDeletionIds'] = undefined;
 ...
 */
PageBreak.prototype['suggestedInsertionIds'] = undefined;
 ...
 */
PageBreak.prototype['suggestedTextStyleChanges'] = undefined;

/**
 * @member {module:model/TextStyle} textStyle
 */
PageBreak.prototype['textStyle'] = undefined;
