# GoogleDocsApi.UpdateTableRowStyleRequest
...
**rowIndices** | **[Number]** | The list of zero-based row indices whose style should be updated. If no indices are specified, all rows will be updated. | [optional] 
