...
public class Equation {
  ...
  public Equation suggestedDeletionIds(List<String> suggestedDeletionIds) {
    this.suggestedDeletionIds = suggestedDeletionIds;
    return this;
  }

  public Equation addSuggestedDeletionIdsItem(String suggestedDeletionIdsItem) {
  ...
  public Equation suggestedInsertionIds(List<String> suggestedInsertionIds) {
    this.suggestedInsertionIds = suggestedInsertionIds;
    return this;
  }

  public Equation addSuggestedInsertionIdsItem(String suggestedInsertionIdsItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.suggestedDeletionIds, equation.suggestedDeletionIds) &&
        Objects.equals(this.suggestedInsertionIds, equation.suggestedInsertionIds);
  }

  @Override
  public int hashCode() {
    return Objects.hash(suggestedDeletionIds, suggestedInsertionIds);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Equation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Equation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Equation is not found in the empty JSON string", Equation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Equation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Equation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Equation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Equation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Equation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Equation.class));

       return (TypeAdapter<T>) new TypeAdapter<Equation>() {
           @Override
           public void write(JsonWriter out, Equation value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Equation read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Equation given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Equation
   * @throws IOException if the JSON string is invalid with respect to Equation
   */
  public static Equation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Equation.class);
  }

  /**
   * Convert an instance of Equation to an JSON string
   *
   * @return JSON string
   */
