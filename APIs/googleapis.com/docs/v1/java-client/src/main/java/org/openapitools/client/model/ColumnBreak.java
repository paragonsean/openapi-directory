...
public class ColumnBreak {
  ...
  public ColumnBreak suggestedDeletionIds(List<String> suggestedDeletionIds) {
    this.suggestedDeletionIds = suggestedDeletionIds;
    return this;
  }

  public ColumnBreak addSuggestedDeletionIdsItem(String suggestedDeletionIdsItem) {
  ...
  public ColumnBreak suggestedInsertionIds(List<String> suggestedInsertionIds) {
    this.suggestedInsertionIds = suggestedInsertionIds;
    return this;
  }

  public ColumnBreak addSuggestedInsertionIdsItem(String suggestedInsertionIdsItem) {
  ...
  public ColumnBreak suggestedTextStyleChanges(Map<String, SuggestedTextStyle> suggestedTextStyleChanges) {
    this.suggestedTextStyleChanges = suggestedTextStyleChanges;
    return this;
  }

  public ColumnBreak putSuggestedTextStyleChangesItem(String key, SuggestedTextStyle suggestedTextStyleChangesItem) {
  ...
  public ColumnBreak textStyle(TextStyle textStyle) {
  ...
  public boolean equals(Object o) {
    ...
    ColumnBreak columnBreak = (ColumnBreak) o;
    return Objects.equals(this.suggestedDeletionIds, columnBreak.suggestedDeletionIds) &&
        Objects.equals(this.suggestedInsertionIds, columnBreak.suggestedInsertionIds) &&
        Objects.equals(this.suggestedTextStyleChanges, columnBreak.suggestedTextStyleChanges) &&
        Objects.equals(this.textStyle, columnBreak.textStyle);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ColumnBreak
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ColumnBreak.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ColumnBreak is not found in the empty JSON string", ColumnBreak.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ColumnBreak.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ColumnBreak` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ColumnBreak.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ColumnBreak' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ColumnBreak> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ColumnBreak.class));

       return (TypeAdapter<T>) new TypeAdapter<ColumnBreak>() {
           @Override
           public void write(JsonWriter out, ColumnBreak value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ColumnBreak read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ColumnBreak given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ColumnBreak
   * @throws IOException if the JSON string is invalid with respect to ColumnBreak
   */
  public static ColumnBreak fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ColumnBreak.class);
  }

  /**
   * Convert an instance of ColumnBreak to an JSON string
   *
   * @return JSON string
   */
