...
public class HorizontalRule {
  ...
  public HorizontalRule suggestedDeletionIds(List<String> suggestedDeletionIds) {
    this.suggestedDeletionIds = suggestedDeletionIds;
    return this;
  }

  public HorizontalRule addSuggestedDeletionIdsItem(String suggestedDeletionIdsItem) {
  ...
  public HorizontalRule suggestedInsertionIds(List<String> suggestedInsertionIds) {
    this.suggestedInsertionIds = suggestedInsertionIds;
    return this;
  }

  public HorizontalRule addSuggestedInsertionIdsItem(String suggestedInsertionIdsItem) {
  ...
  public HorizontalRule suggestedTextStyleChanges(Map<String, SuggestedTextStyle> suggestedTextStyleChanges) {
    this.suggestedTextStyleChanges = suggestedTextStyleChanges;
    return this;
  }

  public HorizontalRule putSuggestedTextStyleChangesItem(String key, SuggestedTextStyle suggestedTextStyleChangesItem) {
  ...
  public HorizontalRule textStyle(TextStyle textStyle) {
  ...
  public boolean equals(Object o) {
    ...
    HorizontalRule horizontalRule = (HorizontalRule) o;
    return Objects.equals(this.suggestedDeletionIds, horizontalRule.suggestedDeletionIds) &&
        Objects.equals(this.suggestedInsertionIds, horizontalRule.suggestedInsertionIds) &&
        Objects.equals(this.suggestedTextStyleChanges, horizontalRule.suggestedTextStyleChanges) &&
        Objects.equals(this.textStyle, horizontalRule.textStyle);
  }
  ...
  public String toString() {
    ...
    sb.append("class HorizontalRule {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to HorizontalRule
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!HorizontalRule.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in HorizontalRule is not found in the empty JSON string", HorizontalRule.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!HorizontalRule.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `HorizontalRule` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!HorizontalRule.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'HorizontalRule' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<HorizontalRule> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(HorizontalRule.class));

       return (TypeAdapter<T>) new TypeAdapter<HorizontalRule>() {
           @Override
           public void write(JsonWriter out, HorizontalRule value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public HorizontalRule read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of HorizontalRule given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of HorizontalRule
   * @throws IOException if the JSON string is invalid with respect to HorizontalRule
   */
  public static HorizontalRule fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, HorizontalRule.class);
  }

  /**
   * Convert an instance of HorizontalRule to an JSON string
   *
   * @return JSON string
   */
