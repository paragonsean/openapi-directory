...
|------------ | ------------- | ------------- | -------------|
|**columnIndices** | **List&lt;Integer&gt;** | The list of zero-based column indices whose property should be updated. If no indices are specified, all columns will be updated. |  [optional] |
