...
import EnvoyInternalAddress from './EnvoyInternalAddress';
...
class Address {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('envoyInternalAddress')) {
                obj['envoyInternalAddress'] = EnvoyInternalAddress.constructFromObject(data['envoyInternalAddress']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['envoyInternalAddress']) { // data not null
          EnvoyInternalAddress.validateJSON(data['envoyInternalAddress']);
        }
...
/**
 * @member {module:model/EnvoyInternalAddress} envoyInternalAddress
 */
Address.prototype['envoyInternalAddress'] = undefined;
