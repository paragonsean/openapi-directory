...
class Extension {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('typeUrls')) {
                obj['typeUrls'] = ApiClient.convertToType(data['typeUrls'], ['String']);
            }
    ...
    static validateJSON(data) {
        ...
        if (!Array.isArray(data['typeUrls'])) {
            throw new Error("Expected the field `typeUrls` to be an array in the JSON data but got " + data['typeUrls']);
        }
 ...
 * @member {Array.<String>} typeUrls
 */
Extension.prototype['typeUrls'] = undefined;
