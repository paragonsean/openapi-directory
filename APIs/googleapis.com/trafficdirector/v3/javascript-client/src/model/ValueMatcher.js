...
class ValueMatcher {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('orMatch')) {
                obj['orMatch'] = OrMatcher.constructFromObject(data['orMatch']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['orMatch']) { // data not null
          OrMatcher.validateJSON(data['orMatch']);
        }
...
/**
 * @member {module:model/OrMatcher} orMatch
 */
ValueMatcher.prototype['orMatch'] = undefined;
