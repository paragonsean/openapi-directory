...
class Node {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('dynamicParameters')) {
                obj['dynamicParameters'] = ApiClient.convertToType(data['dynamicParameters'], {'String': ContextParams});
            }
 ...
 * @member {Object.<String, module:model/ContextParams>} dynamicParameters
 */
Node.prototype['dynamicParameters'] = undefined;
