...
class DynamicListener(Model):
    ...
    def __init__(self, active_state: DynamicListenerState=None, client_status: str=None, draining_state: DynamicListenerState=None, error_state: UpdateFailureState=None, name: str=None, warming_state: DynamicListenerState=None):
        """DynamicListener - a model defined in OpenAPI

        :param active_state: The active_state of this DynamicListener.
        :param client_status: The client_status of this DynamicListener.
    ...
    def client_status(self):
        """Gets the client_status of this DynamicListener.

        The client status of this resource. [#not-implemented-hide:]

        :return: The client_status of this DynamicListener.
        :rtype: str
        """
    ...
    def client_status(self, client_status):
        """Sets the client_status of this DynamicListener.
