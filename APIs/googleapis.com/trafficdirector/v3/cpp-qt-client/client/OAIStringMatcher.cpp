...
QString OAIStringMatcher::getContains() const {
    return m_contains;
}
void OAIStringMatcher::setContains(const QString &contains) {
    m_contains = contains;
    m_contains_isSet = true;
}

bool OAIStringMatcher::is_contains_Set() const{
    return m_contains_isSet;
}

bool OAIStringMatcher::is_contains_Valid() const{
