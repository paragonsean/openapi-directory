...
public:
    ...
    OAIOrMatcher getOrMatch() const;
    void setOrMatch(const OAIOrMatcher &or_match);
    bool is_or_match_Set() const;
    bool is_or_match_Valid() const;
...
private:
    ...
    OAIOrMatcher m_or_match;
    bool m_or_match_isSet;
    bool m_or_match_isValid;
