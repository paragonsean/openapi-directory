...
/*
 * OAIDynamicRouteConfig.h
 *
 * [#next-free-field: 6]
 */

#ifndef OAIDynamicRouteConfig_H
#define OAIDynamicRouteConfig_H
...
class OAIDynamicRouteConfig : public OAIObject {
public:
    OAIDynamicRouteConfig();
    OAIDynamicRouteConfig(QString json);
    ~OAIDynamicRouteConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDynamicRouteConfig)

#endif // OAIDynamicRouteConfig_H
