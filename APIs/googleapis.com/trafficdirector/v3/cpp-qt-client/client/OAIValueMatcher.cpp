...
void OAIValueMatcher::initializeModel() {
    ...
    m_or_match_isSet = false;
    m_or_match_isValid = false;
...
void OAIValueMatcher::fromJsonObject(QJsonObject json) {
    ...
    m_or_match_isValid = ::OpenAPI::fromJsonValue(m_or_match, json[QString("orMatch")]);
    m_or_match_isSet = !json[QString("orMatch")].isNull() && m_or_match_isValid;
...
QJsonObject OAIValueMatcher::asJsonObject() const {
    ...
    if (m_or_match.isSet()) {
        obj.insert(QString("orMatch"), ::OpenAPI::toJsonValue(m_or_match));
    }
...
OAIOrMatcher OAIValueMatcher::getOrMatch() const {
    return m_or_match;
}
void OAIValueMatcher::setOrMatch(const OAIOrMatcher &or_match) {
    m_or_match = or_match;
    m_or_match_isSet = true;
}

bool OAIValueMatcher::is_or_match_Set() const{
    return m_or_match_isSet;
}

bool OAIValueMatcher::is_or_match_Valid() const{
    return m_or_match_isValid;
}
