...
QString OAIDynamicCluster::getClientStatus() const {
    return m_client_status;
}
void OAIDynamicCluster::setClientStatus(const QString &client_status) {
    m_client_status = client_status;
    m_client_status_isSet = true;
}

bool OAIDynamicCluster::is_client_status_Set() const{
    return m_client_status_isSet;
}

bool OAIDynamicCluster::is_client_status_Valid() const{
...
OAIUpdateFailureState OAIDynamicCluster::getErrorState() const {
    return m_error_state;
}
void OAIDynamicCluster::setErrorState(const OAIUpdateFailureState &error_state) {
    m_error_state = error_state;
    m_error_state_isSet = true;
}

bool OAIDynamicCluster::is_error_state_Set() const{
    return m_error_state_isSet;
}

bool OAIDynamicCluster::is_error_state_Valid() const{
