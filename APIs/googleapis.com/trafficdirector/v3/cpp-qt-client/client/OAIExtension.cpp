...
void OAIExtension::initializeModel() {
    ...
    m_type_urls_isSet = false;
    m_type_urls_isValid = false;
...
void OAIExtension::fromJsonObject(QJsonObject json) {
    ...
    m_type_urls_isValid = ::OpenAPI::fromJsonValue(m_type_urls, json[QString("typeUrls")]);
    m_type_urls_isSet = !json[QString("typeUrls")].isNull() && m_type_urls_isValid;
...
QJsonObject OAIExtension::asJsonObject() const {
    ...
    if (m_type_urls.size() > 0) {
        obj.insert(QString("typeUrls"), ::OpenAPI::toJsonValue(m_type_urls));
    }
    if (m_version.isSet()) {
...
QList<QString> OAIExtension::getTypeUrls() const {
    return m_type_urls;
}
void OAIExtension::setTypeUrls(const QList<QString> &type_urls) {
    m_type_urls = type_urls;
    m_type_urls_isSet = true;
}

bool OAIExtension::is_type_urls_Set() const{
    return m_type_urls_isSet;
}

bool OAIExtension::is_type_urls_Valid() const{
    return m_type_urls_isValid;
}
