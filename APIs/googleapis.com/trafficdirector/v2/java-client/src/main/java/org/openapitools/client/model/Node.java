...
public class Node {
  ...
  @Deprecated
  public Node buildVersion(String buildVersion) {
  ...
  public boolean equals(Object o) {
    ...
    Node node = (Node) o;
    return Objects.equals(this.buildVersion, node.buildVersion) &&
        Objects.equals(this.clientFeatures, node.clientFeatures) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(buildVersion, clientFeatures, cluster, extensions, id, listeningAddresses, locality, metadata, userAgentBuildVersion, userAgentName, userAgentVersion);
  }
