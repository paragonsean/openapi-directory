...
QString OAINode::getBuildVersion() const {
    return m_build_version;
}
void OAINode::setBuildVersion(const QString &build_version) {
    m_build_version = build_version;
    m_build_version_isSet = true;
}

bool OAINode::is_build_version_Set() const{
    return m_build_version_isSet;
}

bool OAINode::is_build_version_Valid() const{
