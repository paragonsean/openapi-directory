...
public:
    ...
    Q_DECL_DEPRECATED QString getRegex() const;
    Q_DECL_DEPRECATED void setRegex(const QString &regex);
    Q_DECL_DEPRECATED bool is_regex_Set() const;
    Q_DECL_DEPRECATED bool is_regex_Valid() const;
