...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudIdentityAwareProxyApi.Policy();
  });
  ...
  describe('Policy', function() {
    it('should create an instance of Policy', function() {
      ...
      //var instance = new CloudIdentityAwareProxyApi.Policy();
      //expect(instance).to.be.a(CloudIdentityAwareProxyApi.Policy);
    });
