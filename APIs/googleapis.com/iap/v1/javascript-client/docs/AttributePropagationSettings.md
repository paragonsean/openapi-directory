# CloudIdentityAwareProxyApi.AttributePropagationSettings
...
**outputCredentials** | **[String]** | Which output credentials attributes selected by the CEL expression should be propagated in. All attributes will be fully duplicated in each selected output credential. | [optional] 



## Enum: [OutputCredentialsEnum]


* `OUTPUT_CREDENTIALS_UNSPECIFIED` (value: `"OUTPUT_CREDENTIALS_UNSPECIFIED"`)

* `HEADER` (value: `"HEADER"`)

* `JWT` (value: `"JWT"`)

* `RCTOKEN` (value: `"RCTOKEN"`)
