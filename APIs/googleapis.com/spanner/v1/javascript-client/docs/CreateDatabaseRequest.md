# CloudSpannerApi.CreateDatabaseRequest
...
**databaseDialect** | **String** | Optional. The dialect of the Cloud Spanner Database. | [optional] 
**encryptionConfig** | [**EncryptionConfig**](EncryptionConfig.md) |  | [optional] 
**extraStatements** | **[String]** | Optional. A list of DDL statements to run inside the newly created database. Statements can create tables, indexes, etc. These statements execute atomically with the creation of the database: if there is an error in any statement, the database is not created. | [optional] 
