...
> ListInstanceConfigOperationsResponse spannerProjectsInstanceConfigOperationsList(parent, opts)
...
let apiInstance = new CloudSpannerApi.ProjectsApi();
let parent = "parent_example"; // String | Required. The project of the instance config operations. Values are of the form `projects/`.
let opts = {
...
apiInstance.spannerProjectsInstanceConfigOperationsList(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
 ...
 **pageSize** | **Number**| Number of operations to be returned in the response. If 0 or less, defaults to the server&#39;s maximum allowed page size. | [optional] 
...
> Operation spannerProjectsInstanceConfigsCreate(parent, opts)
...
let apiInstance = new CloudSpannerApi.ProjectsApi();
let parent = "parent_example"; // String | Required. The name of the project in which to create the instance config. Values are of the form `projects/`.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'createInstanceConfigRequest': new CloudSpannerApi.CreateInstanceConfigRequest() // CreateInstanceConfigRequest | 
};
apiInstance.spannerProjectsInstanceConfigsCreate(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ListInstanceConfigsResponse spannerProjectsInstanceConfigsList(parent, opts)
...
let apiInstance = new CloudSpannerApi.ProjectsApi();
let parent = "parent_example"; // String | Required. The name of the project for which a list of supported instance configurations is requested. Values are of the form `projects/`.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'pageSize': 56, // Number | Number of instance configurations to be returned in the response. If 0 or less, defaults to the server's maximum allowed page size.
  'pageToken': "pageToken_example" // String | If non-empty, `page_token` should contain a next_page_token from a previous ListInstanceConfigsResponse.
};
apiInstance.spannerProjectsInstanceConfigsList(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **uploadProtocol** | **String**| Upload protocol for media (e.g. \&quot;raw\&quot;, \&quot;multipart\&quot;). | [optional] 
 **uploadType** | **String**| Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;). | [optional] 
 **pageSize** | **Number**| Number of instance configurations to be returned in the response. If 0 or less, defaults to the server&#39;s maximum allowed page size. | [optional] 
...
> ListBackupOperationsResponse spannerProjectsInstancesBackupOperationsList(parent, opts)
...
let apiInstance = new CloudSpannerApi.ProjectsApi();
let parent = "parent_example"; // String | Required. The instance of the backup operations. Values are of the form `projects//instances/`.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
> Operation spannerProjectsInstancesBackupsCopy(parent, opts)
...
let apiInstance = new CloudSpannerApi.ProjectsApi();
let parent = "parent_example"; // String | Required. The name of the destination instance that will contain the backup copy. Values are of the form: `projects//instances/`.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'copyBackupRequest': new CloudSpannerApi.CopyBackupRequest() // CopyBackupRequest | 
};
apiInstance.spannerProjectsInstancesBackupsCopy(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Operation spannerProjectsInstancesBackupsCreate(parent, opts)
...
let apiInstance = new CloudSpannerApi.ProjectsApi();
let parent = "parent_example"; // String | Required. The name of the instance in which the backup will be created. This must be the same instance that contains the database the backup will be created from. The backup will be stored in the location(s) specified in the instance configuration of this instance. Values are of the form `projects//instances/`.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'backupId': "backupId_example", // String | Required. The id of the backup to be created. The `backup_id` appended to `parent` forms the full backup name of the form `projects//instances//backups/`.
  'encryptionConfigEncryptionType': "encryptionConfigEncryptionType_example", // String | Required. The encryption type of the backup.
  'encryptionConfigKmsKeyName': "encryptionConfigKmsKeyName_example", // String | Optional. The Cloud KMS key that will be used to protect the backup. This field should be set only when encryption_type is `CUSTOMER_MANAGED_ENCRYPTION`. Values are of the form `projects//locations//keyRings//cryptoKeys/`.
  'backup': new CloudSpannerApi.Backup() // Backup | 
};
apiInstance.spannerProjectsInstancesBackupsCreate(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **encryptionConfigEncryptionType** | **String**| Required. The encryption type of the backup. | [optional] 
...
> ListBackupsResponse spannerProjectsInstancesBackupsList(parent, opts)
...
let apiInstance = new CloudSpannerApi.ProjectsApi();
let parent = "parent_example"; // String | Required. The instance to list backups from. Values are of the form `projects//instances/`.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
 ...
 **pageSize** | **Number**| Number of backups to be returned in the response. If 0 or less, defaults to the server&#39;s maximum allowed page size. | [optional] 
...
> Operation spannerProjectsInstancesCreate(parent, opts)
...
let apiInstance = new CloudSpannerApi.ProjectsApi();
let parent = "parent_example"; // String | Required. The name of the project in which to create the instance. Values are of the form `projects/`.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'createInstanceRequest': new CloudSpannerApi.CreateInstanceRequest() // CreateInstanceRequest | 
};
apiInstance.spannerProjectsInstancesCreate(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ListDatabaseOperationsResponse spannerProjectsInstancesDatabaseOperationsList(parent, opts)
...
let apiInstance = new CloudSpannerApi.ProjectsApi();
let parent = "parent_example"; // String | Required. The instance of the database operations. Values are of the form `projects//instances/`.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'pageSize': 56, // Number | Number of operations to be returned in the response. If 0 or less, defaults to the server's maximum allowed page size.
  'pageToken': "pageToken_example" // String | If non-empty, `page_token` should contain a next_page_token from a previous ListDatabaseOperationsResponse to the same `parent` and with the same `filter`.
};
apiInstance.spannerProjectsInstancesDatabaseOperationsList(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Operation spannerProjectsInstancesDatabasesCreate(parent, opts)
...
let apiInstance = new CloudSpannerApi.ProjectsApi();
let parent = "parent_example"; // String | Required. The name of the instance that will serve the new database. Values are of the form `projects//instances/`.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'createDatabaseRequest': new CloudSpannerApi.CreateDatabaseRequest() // CreateDatabaseRequest | 
};
apiInstance.spannerProjectsInstancesDatabasesCreate(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ListDatabaseRolesResponse spannerProjectsInstancesDatabasesDatabaseRolesList(parent, opts)
...
let apiInstance = new CloudSpannerApi.ProjectsApi();
let parent = "parent_example"; // String | Required. The database whose roles should be listed. Values are of the form `projects//instances//databases/`.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'pageSize': 56, // Number | Number of database roles to be returned in the response. If 0 or less, defaults to the server's maximum allowed page size.
  'pageToken': "pageToken_example" // String | If non-empty, `page_token` should contain a next_page_token from a previous ListDatabaseRolesResponse.
};
apiInstance.spannerProjectsInstancesDatabasesDatabaseRolesList(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **uploadProtocol** | **String**| Upload protocol for media (e.g. \&quot;raw\&quot;, \&quot;multipart\&quot;). | [optional] 
 **uploadType** | **String**| Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;). | [optional] 
 **pageSize** | **Number**| Number of database roles to be returned in the response. If 0 or less, defaults to the server&#39;s maximum allowed page size. | [optional] 
...
> TestIamPermissionsResponse spannerProjectsInstancesDatabasesDatabaseRolesTestIamPermissions(resource, opts)
...
let apiInstance = new CloudSpannerApi.ProjectsApi();
let resource = "resource_example"; // String | REQUIRED: The Cloud Spanner resource for which permissions are being tested. The format is `projects//instances/` for instance resources and `projects//instances//databases/` for database resources.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'testIamPermissionsRequest': new CloudSpannerApi.TestIamPermissionsRequest() // TestIamPermissionsRequest | 
};
apiInstance.spannerProjectsInstancesDatabasesDatabaseRolesTestIamPermissions(resource, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Object spannerProjectsInstancesDatabasesDropDatabase(database, opts)
...
let apiInstance = new CloudSpannerApi.ProjectsApi();
let database = "database_example"; // String | Required. The database to be dropped.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
apiInstance.spannerProjectsInstancesDatabasesDropDatabase(database, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> GetDatabaseDdlResponse spannerProjectsInstancesDatabasesGetDdl(database, opts)
...
let apiInstance = new CloudSpannerApi.ProjectsApi();
let database = "database_example"; // String | Required. The database whose schema we wish to get. Values are of the form `projects//instances//databases/`
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
apiInstance.spannerProjectsInstancesDatabasesGetDdl(database, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Policy spannerProjectsInstancesDatabasesGetIamPolicy(resource, opts)
...
let apiInstance = new CloudSpannerApi.ProjectsApi();
let resource = "resource_example"; // String | REQUIRED: The Cloud Spanner resource for which the policy is being retrieved. The format is `projects//instances/` for instance resources and `projects//instances//databases/` for database resources.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'getIamPolicyRequest': new CloudSpannerApi.GetIamPolicyRequest() // GetIamPolicyRequest | 
};
apiInstance.spannerProjectsInstancesDatabasesGetIamPolicy(resource, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Scan spannerProjectsInstancesDatabasesGetScans(name, opts)
...
let apiInstance = new CloudSpannerApi.ProjectsApi();
let name = "name_example"; // String | Required. The unique name of the scan containing the requested information, specific to the Database service implementing this interface.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'endTime': "endTime_example", // String | The upper bound for the time range to retrieve Scan data for.
  ...
  'view': "view_example" // String | Specifies which parts of the Scan should be returned in the response. Note, if left unspecified, the FULL view is assumed.
};
apiInstance.spannerProjectsInstancesDatabasesGetScans(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **view** | **String**| Specifies which parts of the Scan should be returned in the response. Note, if left unspecified, the FULL view is assumed. | [optional] 
...
> ListDatabasesResponse spannerProjectsInstancesDatabasesList(parent, opts)
...
let apiInstance = new CloudSpannerApi.ProjectsApi();
let parent = "parent_example"; // String | Required. The instance whose databases should be listed. Values are of the form `projects//instances/`.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'pageSize': 56, // Number | Number of databases to be returned in the response. If 0 or less, defaults to the server's maximum allowed page size.
  'pageToken': "pageToken_example" // String | If non-empty, `page_token` should contain a next_page_token from a previous ListDatabasesResponse.
};
apiInstance.spannerProjectsInstancesDatabasesList(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **uploadProtocol** | **String**| Upload protocol for media (e.g. \&quot;raw\&quot;, \&quot;multipart\&quot;). | [optional] 
 **uploadType** | **String**| Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;). | [optional] 
 **pageSize** | **Number**| Number of databases to be returned in the response. If 0 or less, defaults to the server&#39;s maximum allowed page size. | [optional] 
...
> Operation spannerProjectsInstancesDatabasesPatch(name, opts)
...
let apiInstance = new CloudSpannerApi.ProjectsApi();
let name = "name_example"; // String | Required. The name of the database. Values are of the form `projects//instances//databases/`, where `` is as specified in the `CREATE DATABASE` statement. This name can be passed to other API methods to identify the database.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'updateMask': "updateMask_example", // String | Required. The list of fields to update. Currently, only `enable_drop_protection` field can be updated.
  'database': new CloudSpannerApi.Database() // Database | 
};
apiInstance.spannerProjectsInstancesDatabasesPatch(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Operation spannerProjectsInstancesDatabasesRestore(parent, opts)
...
let apiInstance = new CloudSpannerApi.ProjectsApi();
let parent = "parent_example"; // String | Required. The name of the instance in which to create the restored database. This instance must be in the same project and have the same instance configuration as the instance containing the source backup. Values are of the form `projects//instances/`.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'restoreDatabaseRequest': new CloudSpannerApi.RestoreDatabaseRequest() // RestoreDatabaseRequest | 
};
apiInstance.spannerProjectsInstancesDatabasesRestore(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> BatchCreateSessionsResponse spannerProjectsInstancesDatabasesSessionsBatchCreate(database, opts)
...
let apiInstance = new CloudSpannerApi.ProjectsApi();
let database = "database_example"; // String | Required. The database in which the new sessions are created.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'batchCreateSessionsRequest': new CloudSpannerApi.BatchCreateSessionsRequest() // BatchCreateSessionsRequest | 
};
apiInstance.spannerProjectsInstancesDatabasesSessionsBatchCreate(database, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> BatchWriteResponse spannerProjectsInstancesDatabasesSessionsBatchWrite(session, opts)
...
let apiInstance = new CloudSpannerApi.ProjectsApi();
let session = "session_example"; // String | Required. The session in which the batch request is to be run.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'batchWriteRequest': new CloudSpannerApi.BatchWriteRequest() // BatchWriteRequest | 
};
apiInstance.spannerProjectsInstancesDatabasesSessionsBatchWrite(session, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Transaction spannerProjectsInstancesDatabasesSessionsBeginTransaction(session, opts)
...
let apiInstance = new CloudSpannerApi.ProjectsApi();
let session = "session_example"; // String | Required. The session in which the transaction runs.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'beginTransactionRequest': new CloudSpannerApi.BeginTransactionRequest() // BeginTransactionRequest | 
};
apiInstance.spannerProjectsInstancesDatabasesSessionsBeginTransaction(session, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> CommitResponse spannerProjectsInstancesDatabasesSessionsCommit(session, opts)
...
let apiInstance = new CloudSpannerApi.ProjectsApi();
let session = "session_example"; // String | Required. The session in which the transaction to be committed is running.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'commitRequest': new CloudSpannerApi.CommitRequest() // CommitRequest | 
};
apiInstance.spannerProjectsInstancesDatabasesSessionsCommit(session, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Session spannerProjectsInstancesDatabasesSessionsCreate(database, opts)
...
let apiInstance = new CloudSpannerApi.ProjectsApi();
let database = "database_example"; // String | Required. The database in which the new session is created.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'createSessionRequest': new CloudSpannerApi.CreateSessionRequest() // CreateSessionRequest | 
};
apiInstance.spannerProjectsInstancesDatabasesSessionsCreate(database, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ExecuteBatchDmlResponse spannerProjectsInstancesDatabasesSessionsExecuteBatchDml(session, opts)
...
let apiInstance = new CloudSpannerApi.ProjectsApi();
let session = "session_example"; // String | Required. The session in which the DML statements should be performed.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'executeBatchDmlRequest': new CloudSpannerApi.ExecuteBatchDmlRequest() // ExecuteBatchDmlRequest | 
};
apiInstance.spannerProjectsInstancesDatabasesSessionsExecuteBatchDml(session, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ResultSet spannerProjectsInstancesDatabasesSessionsExecuteSql(session, opts)
...
let apiInstance = new CloudSpannerApi.ProjectsApi();
let session = "session_example"; // String | Required. The session in which the SQL query should be performed.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'executeSqlRequest': new CloudSpannerApi.ExecuteSqlRequest() // ExecuteSqlRequest | 
};
apiInstance.spannerProjectsInstancesDatabasesSessionsExecuteSql(session, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> PartialResultSet spannerProjectsInstancesDatabasesSessionsExecuteStreamingSql(session, opts)
...
apiInstance.spannerProjectsInstancesDatabasesSessionsExecuteStreamingSql(session, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ListSessionsResponse spannerProjectsInstancesDatabasesSessionsList(database, opts)
...
let apiInstance = new CloudSpannerApi.ProjectsApi();
let database = "database_example"; // String | Required. The database in which to list sessions.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'pageSize': 56, // Number | Number of sessions to be returned in the response. If 0 or less, defaults to the server's maximum allowed page size.
  'pageToken': "pageToken_example" // String | If non-empty, `page_token` should contain a next_page_token from a previous ListSessionsResponse.
};
apiInstance.spannerProjectsInstancesDatabasesSessionsList(database, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **pageSize** | **Number**| Number of sessions to be returned in the response. If 0 or less, defaults to the server&#39;s maximum allowed page size. | [optional] 
...
> PartitionResponse spannerProjectsInstancesDatabasesSessionsPartitionQuery(session, opts)
...
let apiInstance = new CloudSpannerApi.ProjectsApi();
let session = "session_example"; // String | Required. The session used to create the partitions.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'partitionQueryRequest': new CloudSpannerApi.PartitionQueryRequest() // PartitionQueryRequest | 
};
apiInstance.spannerProjectsInstancesDatabasesSessionsPartitionQuery(session, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> PartitionResponse spannerProjectsInstancesDatabasesSessionsPartitionRead(session, opts)
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'partitionReadRequest': new CloudSpannerApi.PartitionReadRequest() // PartitionReadRequest | 
};
apiInstance.spannerProjectsInstancesDatabasesSessionsPartitionRead(session, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ResultSet spannerProjectsInstancesDatabasesSessionsRead(session, opts)
...
let apiInstance = new CloudSpannerApi.ProjectsApi();
let session = "session_example"; // String | Required. The session in which the read should be performed.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'readRequest': new CloudSpannerApi.ReadRequest() // ReadRequest | 
};
apiInstance.spannerProjectsInstancesDatabasesSessionsRead(session, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Object spannerProjectsInstancesDatabasesSessionsRollback(session, opts)
...
let apiInstance = new CloudSpannerApi.ProjectsApi();
let session = "session_example"; // String | Required. The session in which the transaction to roll back is running.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'rollbackRequest': new CloudSpannerApi.RollbackRequest() // RollbackRequest | 
};
apiInstance.spannerProjectsInstancesDatabasesSessionsRollback(session, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> PartialResultSet spannerProjectsInstancesDatabasesSessionsStreamingRead(session, opts)
...
apiInstance.spannerProjectsInstancesDatabasesSessionsStreamingRead(session, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Policy spannerProjectsInstancesDatabasesSetIamPolicy(resource, opts)
...
let apiInstance = new CloudSpannerApi.ProjectsApi();
let resource = "resource_example"; // String | REQUIRED: The Cloud Spanner resource for which the policy is being set. The format is `projects//instances/` for instance resources and `projects//instances//databases/` for databases resources.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'setIamPolicyRequest': new CloudSpannerApi.SetIamPolicyRequest() // SetIamPolicyRequest | 
};
apiInstance.spannerProjectsInstancesDatabasesSetIamPolicy(resource, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Operation spannerProjectsInstancesDatabasesUpdateDdl(database, opts)
...
let apiInstance = new CloudSpannerApi.ProjectsApi();
let database = "database_example"; // String | Required. The database to update.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'updateDatabaseDdlRequest': new CloudSpannerApi.UpdateDatabaseDdlRequest() // UpdateDatabaseDdlRequest | 
};
apiInstance.spannerProjectsInstancesDatabasesUpdateDdl(database, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ListInstancesResponse spannerProjectsInstancesList(parent, opts)
...
let apiInstance = new CloudSpannerApi.ProjectsApi();
let parent = "parent_example"; // String | Required. The name of the project for which a list of instances is requested. Values are of the form `projects/`.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'instanceDeadline': "instanceDeadline_example", // String | Deadline used while retrieving metadata for instances. Instances whose metadata cannot be retrieved within this deadline will be added to unreachable in ListInstancesResponse.
  'pageSize': 56, // Number | Number of instances to be returned in the response. If 0 or less, defaults to the server's maximum allowed page size.
  'pageToken': "pageToken_example" // String | If non-empty, `page_token` should contain a next_page_token from a previous ListInstancesResponse.
};
apiInstance.spannerProjectsInstancesList(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **pageSize** | **Number**| Number of instances to be returned in the response. If 0 or less, defaults to the server&#39;s maximum allowed page size. | [optional] 
...
> Object spannerProjectsInstancesOperationsCancel(name, opts)
...
apiInstance.spannerProjectsInstancesOperationsCancel(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Object spannerProjectsInstancesOperationsDelete(name, opts)
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'etag': "etag_example", // String | Used for optimistic concurrency control as a way to help prevent simultaneous deletes of an instance config from overwriting each other. If not empty, the API only deletes the instance config when the etag provided matches the current status of the requested instance config. Otherwise, deletes the instance config without checking the current status of the requested instance config.
  'validateOnly': true // Boolean | An option to validate, but not actually execute, a request, and provide the same response.
};
apiInstance.spannerProjectsInstancesOperationsDelete(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ListOperationsResponse spannerProjectsInstancesOperationsList(name, opts)
...
apiInstance.spannerProjectsInstancesOperationsList(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
