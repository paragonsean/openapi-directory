...
**mutations** | [**[Mutation]**](Mutation.md) | The mutations to be executed when this transaction commits. All mutations are applied atomically, in the order they appear in this list. | [optional] 
...
**transactionId** | **Blob** | Commit a previously-started transaction. | [optional] 
