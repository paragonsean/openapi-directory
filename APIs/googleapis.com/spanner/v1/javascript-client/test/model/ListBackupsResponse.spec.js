...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudSpannerApi.ListBackupsResponse();
  });
  ...
  describe('ListBackupsResponse', function() {
    it('should create an instance of ListBackupsResponse', function() {
      ...
      //var instance = new CloudSpannerApi.ListBackupsResponse();
      //expect(instance).to.be.a(CloudSpannerApi.ListBackupsResponse);
    });
