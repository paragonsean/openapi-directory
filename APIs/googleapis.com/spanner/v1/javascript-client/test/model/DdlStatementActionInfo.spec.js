...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudSpannerApi.DdlStatementActionInfo();
  });
  ...
  describe('DdlStatementActionInfo', function() {
    it('should create an instance of DdlStatementActionInfo', function() {
      // uncomment below and update the code to test DdlStatementActionInfo
      //var instance = new CloudSpannerApi.DdlStatementActionInfo();
      //expect(instance).to.be.a(CloudSpannerApi.DdlStatementActionInfo);
    });
