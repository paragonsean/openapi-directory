...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudSpannerApi.PrefixNode();
  });
  ...
  describe('PrefixNode', function() {
    it('should create an instance of PrefixNode', function() {
      // uncomment below and update the code to test PrefixNode
      //var instance = new CloudSpannerApi.PrefixNode();
      //expect(instance).to.be.a(CloudSpannerApi.PrefixNode);
    });

    it('should have the property dataSourceNode (base name: "dataSourceNode")', function() {
      // uncomment below and update the code to test the property dataSourceNode
      //var instance = new CloudSpannerApi.PrefixNode();
