...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudSpannerApi.RestoreDatabaseRequest();
  });
  ...
  describe('RestoreDatabaseRequest', function() {
    it('should create an instance of RestoreDatabaseRequest', function() {
      // uncomment below and update the code to test RestoreDatabaseRequest
      //var instance = new CloudSpannerApi.RestoreDatabaseRequest();
      //expect(instance).to.be.a(CloudSpannerApi.RestoreDatabaseRequest);
    });
