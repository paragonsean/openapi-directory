...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudSpannerApi.CopyBackupRequest();
  });
  ...
  describe('CopyBackupRequest', function() {
    it('should create an instance of CopyBackupRequest', function() {
      ...
      //var instance = new CloudSpannerApi.CopyBackupRequest();
      //expect(instance).to.be.a(CloudSpannerApi.CopyBackupRequest);
    });
