...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudSpannerApi.ListSessionsResponse();
  });
  ...
  describe('ListSessionsResponse', function() {
    it('should create an instance of ListSessionsResponse', function() {
      ...
      //var instance = new CloudSpannerApi.ListSessionsResponse();
      //expect(instance).to.be.a(CloudSpannerApi.ListSessionsResponse);
    });
