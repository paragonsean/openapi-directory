...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudSpannerApi.CreateInstanceRequest();
  });
  ...
  describe('CreateInstanceRequest', function() {
    it('should create an instance of CreateInstanceRequest', function() {
      // uncomment below and update the code to test CreateInstanceRequest
      //var instance = new CloudSpannerApi.CreateInstanceRequest();
      //expect(instance).to.be.a(CloudSpannerApi.CreateInstanceRequest);
    });
