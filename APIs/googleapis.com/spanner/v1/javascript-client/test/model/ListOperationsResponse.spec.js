...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudSpannerApi.ListOperationsResponse();
  });
  ...
  describe('ListOperationsResponse', function() {
    it('should create an instance of ListOperationsResponse', function() {
      ...
      //var instance = new CloudSpannerApi.ListOperationsResponse();
      //expect(instance).to.be.a(CloudSpannerApi.ListOperationsResponse);
    });
