...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudSpannerApi.ListDatabasesResponse();
  });
  ...
  describe('ListDatabasesResponse', function() {
    it('should create an instance of ListDatabasesResponse', function() {
      // uncomment below and update the code to test ListDatabasesResponse
      //var instance = new CloudSpannerApi.ListDatabasesResponse();
      //expect(instance).to.be.a(CloudSpannerApi.ListDatabasesResponse);
    });
