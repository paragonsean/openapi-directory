...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudSpannerApi.ListScansResponse();
  });
  ...
  describe('ListScansResponse', function() {
    it('should create an instance of ListScansResponse', function() {
      ...
      //var instance = new CloudSpannerApi.ListScansResponse();
      //expect(instance).to.be.a(CloudSpannerApi.ListScansResponse);
    });
