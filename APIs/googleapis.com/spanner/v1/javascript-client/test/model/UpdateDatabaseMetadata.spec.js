...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudSpannerApi.UpdateDatabaseMetadata();
  });
  ...
  describe('UpdateDatabaseMetadata', function() {
    it('should create an instance of UpdateDatabaseMetadata', function() {
      // uncomment below and update the code to test UpdateDatabaseMetadata
      //var instance = new CloudSpannerApi.UpdateDatabaseMetadata();
      //expect(instance).to.be.a(CloudSpannerApi.UpdateDatabaseMetadata);
    });
