...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudSpannerApi.CreateBackupMetadata();
  });
  ...
  describe('CreateBackupMetadata', function() {
    it('should create an instance of CreateBackupMetadata', function() {
      // uncomment below and update the code to test CreateBackupMetadata
      //var instance = new CloudSpannerApi.CreateBackupMetadata();
      //expect(instance).to.be.a(CloudSpannerApi.CreateBackupMetadata);
    });
