...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudSpannerApi.PartitionResponse();
  });
  ...
  describe('PartitionResponse', function() {
    it('should create an instance of PartitionResponse', function() {
      // uncomment below and update the code to test PartitionResponse
      //var instance = new CloudSpannerApi.PartitionResponse();
      //expect(instance).to.be.a(CloudSpannerApi.PartitionResponse);
    });
