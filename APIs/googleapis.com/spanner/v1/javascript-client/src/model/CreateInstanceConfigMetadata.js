...
/**
 * The CreateInstanceConfigMetadata model module.
 * @module model/CreateInstanceConfigMetadata
 * @version v1
 */
class CreateInstanceConfigMetadata {
    /**
     * Constructs a new <code>CreateInstanceConfigMetadata</code>.
     * Metadata type for the operation returned by CreateInstanceConfig.
     * @alias module:model/CreateInstanceConfigMetadata
     */
    constructor() { 
        
        CreateInstanceConfigMetadata.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateInstanceConfigMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateInstanceConfigMetadata} obj Optional instance to populate.
     * @return {module:model/CreateInstanceConfigMetadata} The populated <code>CreateInstanceConfigMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateInstanceConfigMetadata();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateInstanceConfigMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateInstanceConfigMetadata</code>.
     */
 ...
 */
CreateInstanceConfigMetadata.prototype['cancelTime'] = undefined;

/**
 * @member {module:model/InstanceConfig} instanceConfig
 */
CreateInstanceConfigMetadata.prototype['instanceConfig'] = undefined;

/**
 * @member {module:model/InstanceOperationProgress} progress
 */
CreateInstanceConfigMetadata.prototype['progress'] = undefined;
...
export default CreateInstanceConfigMetadata;
