...
class TransactionOptions {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('partitionedDml')) {
                obj['partitionedDml'] = ApiClient.convertToType(data['partitionedDml'], Object);
            }
 ...
 * @member {Object} partitionedDml
 */
TransactionOptions.prototype['partitionedDml'] = undefined;
