...
/**
 * The CopyBackupEncryptionConfig model module.
 * @module model/CopyBackupEncryptionConfig
 * @version v1
 */
class CopyBackupEncryptionConfig {
    /**
     * Constructs a new <code>CopyBackupEncryptionConfig</code>.
     * Encryption configuration for the copied backup.
     * @alias module:model/CopyBackupEncryptionConfig
     */
    constructor() { 
        
        CopyBackupEncryptionConfig.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CopyBackupEncryptionConfig</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CopyBackupEncryptionConfig} obj Optional instance to populate.
     * @return {module:model/CopyBackupEncryptionConfig} The populated <code>CopyBackupEncryptionConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CopyBackupEncryptionConfig();
    ...
    /**
     * Validates the JSON data with respect to <code>CopyBackupEncryptionConfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CopyBackupEncryptionConfig</code>.
     */
 ...
 * @member {module:model/CopyBackupEncryptionConfig.EncryptionTypeEnum} encryptionType
 */
CopyBackupEncryptionConfig.prototype['encryptionType'] = undefined;
 ...
 */
CopyBackupEncryptionConfig.prototype['kmsKeyName'] = undefined;
 ...
 * @readonly
 */
CopyBackupEncryptionConfig['EncryptionTypeEnum'] = {
...
export default CopyBackupEncryptionConfig;
