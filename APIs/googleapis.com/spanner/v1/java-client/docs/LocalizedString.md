...
|------------ | ------------- | ------------- | -------------|
|**args** | **Map&lt;String, String&gt;** | A map of arguments used when creating the localized message. Keys represent parameter names which may be used by the localized version when substituting dynamic values. |  [optional] |
