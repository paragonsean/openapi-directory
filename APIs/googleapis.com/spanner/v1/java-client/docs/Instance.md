...
|**endpointUris** | **List&lt;String&gt;** | Deprecated. This field is not populated. |  [optional] |
|**freeInstanceMetadata** | [**FreeInstanceMetadata**](FreeInstanceMetadata.md) |  |  [optional] |
|**instanceType** | [**InstanceTypeEnum**](#InstanceTypeEnum) | The &#x60;InstanceType&#x60; of the current instance. |  [optional] |
...
|**state** | [**StateEnum**](#StateEnum) | Output only. The current instance state. For CreateInstance, the state must be either omitted or set to &#x60;CREATING&#x60;. For UpdateInstance, the state must be either omitted or set to &#x60;READY&#x60;. |  [optional] [readonly] |
