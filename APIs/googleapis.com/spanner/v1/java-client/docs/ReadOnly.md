...
|**returnReadTimestamp** | **Boolean** | If true, the Cloud Spanner-selected read timestamp is included in the Transaction message that describes the transaction. |  [optional] |
|**strong** | **Boolean** | Read at a timestamp where all previously committed transactions are visible. |  [optional] |
