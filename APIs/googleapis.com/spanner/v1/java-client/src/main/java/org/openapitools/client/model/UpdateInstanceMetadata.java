...
public class UpdateInstanceMetadata {
  ...
  public UpdateInstanceMetadata cancelTime(String cancelTime) {
  ...
  public UpdateInstanceMetadata endTime(String endTime) {
  ...
  public UpdateInstanceMetadata expectedFulfillmentPeriod(ExpectedFulfillmentPeriodEnum expectedFulfillmentPeriod) {
  ...
  public UpdateInstanceMetadata instance(Instance instance) {
  ...
  public UpdateInstanceMetadata startTime(String startTime) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateInstanceMetadata updateInstanceMetadata = (UpdateInstanceMetadata) o;
    return Objects.equals(this.cancelTime, updateInstanceMetadata.cancelTime) &&
        Objects.equals(this.endTime, updateInstanceMetadata.endTime) &&
        Objects.equals(this.expectedFulfillmentPeriod, updateInstanceMetadata.expectedFulfillmentPeriod) &&
        Objects.equals(this.instance, updateInstanceMetadata.instance) &&
        Objects.equals(this.startTime, updateInstanceMetadata.startTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateInstanceMetadata {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateInstanceMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateInstanceMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateInstanceMetadata is not found in the empty JSON string", UpdateInstanceMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateInstanceMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateInstanceMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateInstanceMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateInstanceMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateInstanceMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateInstanceMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateInstanceMetadata>() {
           @Override
           public void write(JsonWriter out, UpdateInstanceMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateInstanceMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateInstanceMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateInstanceMetadata
   * @throws IOException if the JSON string is invalid with respect to UpdateInstanceMetadata
   */
  public static UpdateInstanceMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateInstanceMetadata.class);
  }

  /**
   * Convert an instance of UpdateInstanceMetadata to an JSON string
   *
   * @return JSON string
   */
