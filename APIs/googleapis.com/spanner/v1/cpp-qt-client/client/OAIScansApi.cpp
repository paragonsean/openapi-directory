...
OAIScansApi::OAIScansApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIScansApi::~OAIScansApi() {
}

void OAIScansApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("spanner_scans_list", defaultConf);
    _serverIndices.insert("spanner_scans_list", 0);
}
...
*/
int OAIScansApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIScansApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIScansApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIScansApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIScansApi::setUsername(const QString &username) {
    _username = username;
}

void OAIScansApi::setPassword(const QString &password) {
    _password = password;
}


void OAIScansApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIScansApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIScansApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIScansApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIScansApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIScansApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIScansApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIScansApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIScansApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIScansApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIScansApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIScansApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIScansApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIScansApi::spanner_scans_list(const QString &parent, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<QString> &filter, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &page_token, const ::OpenAPI::OptionalParam<QString> &view) {
    QString fullPath = QString(_serverConfigs["spanner_scans_list"][_serverIndices.value("spanner_scans_list")].URL()+"/v1/{parent}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIScansApi::spanner_scans_listCallback);
    connect(this, &OAIScansApi::abortRequestsSignal, worker, &QObject::deleteLater);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIScansApi::spanner_scans_listCallback);
    connect(this, &OAIScansApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
...
void OAIScansApi::spanner_scans_listCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT spanner_scans_listSignal(output);
        Q_EMIT spanner_scans_listSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT spanner_scans_listSignalE(output, error_type, error_str);
        Q_EMIT spanner_scans_listSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT spanner_scans_listSignalError(output, error_type, error_str);
        Q_EMIT spanner_scans_listSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIScansApi::tokenAvailable(){
