...
/*
 * OAIInstanceOperationProgress.h
 *
 * Encapsulates progress related information for a Cloud Spanner long running instance operations.
 */

#ifndef OAIInstanceOperationProgress_H
#define OAIInstanceOperationProgress_H
...
class OAIInstanceOperationProgress : public OAIObject {
public:
    OAIInstanceOperationProgress();
    OAIInstanceOperationProgress(QString json);
    ~OAIInstanceOperationProgress() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInstanceOperationProgress)

#endif // OAIInstanceOperationProgress_H
