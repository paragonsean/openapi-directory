...
|**fileOperations** | [**Map&lt;String, FileOperation&gt;**](FileOperation.md) | A map to the path of the file to the operation. The path is the full file path including filename, from repository root. |  [optional] |
