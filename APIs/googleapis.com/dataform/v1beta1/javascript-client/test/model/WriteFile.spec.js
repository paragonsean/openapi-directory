...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataformApi.WriteFile();
  });
  ...
  describe('WriteFile', function() {
    it('should create an instance of WriteFile', function() {
      // uncomment below and update the code to test WriteFile
      //var instance = new DataformApi.WriteFile();
      //expect(instance).to.be.a(DataformApi.WriteFile);
    });
