...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataformApi.SearchFilesResponse();
  });
  ...
  describe('SearchFilesResponse', function() {
    it('should create an instance of SearchFilesResponse', function() {
      // uncomment below and update the code to test SearchFilesResponse
      //var instance = new DataformApi.SearchFilesResponse();
      //expect(instance).to.be.a(DataformApi.SearchFilesResponse);
    });
