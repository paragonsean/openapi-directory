...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataformApi.ListLocationsResponse();
  });
  ...
  describe('ListLocationsResponse', function() {
    it('should create an instance of ListLocationsResponse', function() {
      ...
      //var instance = new DataformApi.ListLocationsResponse();
      //expect(instance).to.be.a(DataformApi.ListLocationsResponse);
    });
