# DataformApi.CodeCompilationConfig
...
**vars** | **{String: String}** | Optional. User-defined variables that are made available to project code during compilation. | [optional] 
