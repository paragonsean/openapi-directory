...
**recentScheduledReleaseRecords** | [**[ScheduledReleaseRecord]**](ScheduledReleaseRecord.md) | Output only. Records of the 10 most recent scheduled release attempts, ordered in in descending order of &#x60;release_time&#x60;. Updated whenever automatic creation of a compilation result is triggered by cron_schedule. | [optional] [readonly] 
