...
QList<QString> OAIListWorkspacesResponse::getUnreachable() const {
    return m_unreachable;
}
void OAIListWorkspacesResponse::setUnreachable(const QList<QString> &unreachable) {
    m_unreachable = unreachable;
    m_unreachable_isSet = true;
}

bool OAIListWorkspacesResponse::is_unreachable_Set() const{
    return m_unreachable_isSet;
}

bool OAIListWorkspacesResponse::is_unreachable_Valid() const{
