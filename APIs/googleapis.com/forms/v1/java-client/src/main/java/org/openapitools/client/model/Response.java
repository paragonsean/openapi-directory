...
public class Response {
  ...
  public Response createItem(CreateItemResponse createItem) {
  ...
  public void setCreateItem(CreateItemResponse createItem) {
    this.createItem = createItem;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.createItem, response.createItem);
  }

  @Override
  public int hashCode() {
    return Objects.hash(createItem);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("createItem") != null && !jsonObj.get("createItem").isJsonNull()) {
        CreateItemResponse.validateJsonElement(jsonObj.get("createItem"));
      }
  }
