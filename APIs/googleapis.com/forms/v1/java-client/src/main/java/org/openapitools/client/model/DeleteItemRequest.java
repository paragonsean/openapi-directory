...
public class DeleteItemRequest {
  ...
  public DeleteItemRequest location(Location location) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.location, deleteItemRequest.location);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteItemRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteItemRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteItemRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteItemRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
