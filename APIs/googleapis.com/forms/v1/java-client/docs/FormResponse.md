...
|------------ | ------------- | ------------- | -------------|
|**answers** | [**Map&lt;String, Answer&gt;**](Answer.md) | Output only. The actual answers to the questions, keyed by question_id. |  [optional] [readonly] |
...
|**totalScore** | **Double** | Output only. The total number of points the respondent received for their submission Only set if the form was a quiz and the response was graded. This includes points automatically awarded via autograding adjusted by any manual corrections entered by the form owner. |  [optional] [readonly] |
