...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleFormsApi.Watch();
  });
  ...
  describe('Watch', function() {
    it('should create an instance of Watch', function() {
      // uncomment below and update the code to test Watch
      //var instance = new GoogleFormsApi.Watch();
      //expect(instance).to.be.a(GoogleFormsApi.Watch);
    });
