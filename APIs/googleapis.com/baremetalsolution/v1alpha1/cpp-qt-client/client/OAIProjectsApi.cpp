...
void OAIProjectsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("baremetalsolution_projects_locations_submitProvisioningConfig", defaultConf);
    _serverIndices.insert("baremetalsolution_projects_locations_submitProvisioningConfig", 0);
    _serverConfigs.insert("baremetalsolution_projects_provisioningQuotas_list", defaultConf);
    _serverIndices.insert("baremetalsolution_projects_provisioningQuotas_list", 0);
}
...
void OAIProjectsApi::baremetalsolution_projects_locations_submitProvisioningConfig(const QString &project, const QString &location, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<OAISubmitProvisioningConfigRequest> &oai_submit_provisioning_config_request) {
    QString fullPath = QString(_serverConfigs["baremetalsolution_projects_locations_submitProvisioningConfig"][_serverIndices.value("baremetalsolution_projects_locations_submitProvisioningConfig")].URL()+"/v1alpha1/{project}/{location}:submitProvisioningConfig");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::baremetalsolution_projects_locations_submitProvisioningConfigCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::baremetalsolution_projects_locations_submitProvisioningConfigCallback);
...
void OAIProjectsApi::baremetalsolution_projects_locations_submitProvisioningConfigCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT baremetalsolution_projects_locations_submitProvisioningConfigSignal(output);
        Q_EMIT baremetalsolution_projects_locations_submitProvisioningConfigSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT baremetalsolution_projects_locations_submitProvisioningConfigSignalE(output, error_type, error_str);
        Q_EMIT baremetalsolution_projects_locations_submitProvisioningConfigSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT baremetalsolution_projects_locations_submitProvisioningConfigSignalError(output, error_type, error_str);
        Q_EMIT baremetalsolution_projects_locations_submitProvisioningConfigSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectsApi::baremetalsolution_projects_provisioningQuotas_list(const QString &parent, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &page_token) {
    QString fullPath = QString(_serverConfigs["baremetalsolution_projects_provisioningQuotas_list"][_serverIndices.value("baremetalsolution_projects_provisioningQuotas_list")].URL()+"/v1alpha1/{parent}/provisioningQuotas");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::baremetalsolution_projects_provisioningQuotas_listCallback);
    connect(this, &OAIProjectsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::baremetalsolution_projects_provisioningQuotas_listCallback);
    connect(this, &OAIProjectsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectsApi::baremetalsolution_projects_provisioningQuotas_listCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT baremetalsolution_projects_provisioningQuotas_listSignal(output);
        Q_EMIT baremetalsolution_projects_provisioningQuotas_listSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("https://www.googleapis.com/auth/cloud-platform");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT baremetalsolution_projects_provisioningQuotas_listSignalE(output, error_type, error_str);
        Q_EMIT baremetalsolution_projects_provisioningQuotas_listSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT baremetalsolution_projects_provisioningQuotas_listSignalError(output, error_type, error_str);
        Q_EMIT baremetalsolution_projects_provisioningQuotas_listSignalErrorFull(worker, error_type, error_str);
    }
}
