...
QString OAIVolumeConfig::getLocation() const {
    return m_location;
}
void OAIVolumeConfig::setLocation(const QString &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAIVolumeConfig::is_location_Set() const{
    return m_location_isSet;
}

bool OAIVolumeConfig::is_location_Valid() const{
