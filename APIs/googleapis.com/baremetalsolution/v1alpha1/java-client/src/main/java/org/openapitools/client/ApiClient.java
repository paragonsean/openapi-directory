...
public class ApiClient {
    ...
    private String basePath = "https://baremetalsolution.googleapis.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/v1alpha1/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://baremetalsolution.googleapis.com
