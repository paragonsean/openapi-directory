...
public class NetworkConfig {
  ...
  private List<IntakeVlanAttachment> vlanAttachments = new ArrayList<>();

  public static final String SERIALIZED_NAME_VLAN_SAME_PROJECT = "vlanSameProject";
  @SerializedName(SERIALIZED_NAME_VLAN_SAME_PROJECT)
  ...
  public NetworkConfig gcpService(String gcpService) {
  ...
  public NetworkConfig jumboFramesEnabled(Boolean jumboFramesEnabled) {
  ...
  public NetworkConfig vlanAttachments(List<IntakeVlanAttachment> vlanAttachments) {
    this.vlanAttachments = vlanAttachments;
    return this;
  }

  public NetworkConfig addVlanAttachmentsItem(IntakeVlanAttachment vlanAttachmentsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<IntakeVlanAttachment> getVlanAttachments() {
    return vlanAttachments;
  }

  public void setVlanAttachments(List<IntakeVlanAttachment> vlanAttachments) {
    this.vlanAttachments = vlanAttachments;
  }


  public NetworkConfig vlanSameProject(Boolean vlanSameProject) {
  ...
  public void setVlanSameProject(Boolean vlanSameProject) {
    this.vlanSameProject = vlanSameProject;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.bandwidth, networkConfig.bandwidth) &&
        ...
        Objects.equals(this.gcpService, networkConfig.gcpService) &&
        Objects.equals(this.id, networkConfig.id) &&
        Objects.equals(this.jumboFramesEnabled, networkConfig.jumboFramesEnabled) &&
        Objects.equals(this.name, networkConfig.name) &&
        ...
        Objects.equals(this.vlanSameProject, networkConfig.vlanSameProject);
  }

  @Override
  public int hashCode() {
    return Objects.hash(bandwidth, cidr, gcpService, id, jumboFramesEnabled, name, serviceCidr, type, userNote, vlanAttachments, vlanSameProject);
  }
  ...
  public String toString() {
    ...
    sb.append("    vlanSameProject: ").append(toIndentedString(vlanSameProject)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("vlanSameProject");
      ...
      if (jsonObj.get("vlanAttachments") != null && !jsonObj.get("vlanAttachments").isJsonNull()) {
        ...
        if (jsonArrayvlanAttachments != null) {
          ...
          for (int i = 0; i < jsonArrayvlanAttachments.size(); i++) {
            IntakeVlanAttachment.validateJsonElement(jsonArrayvlanAttachments.get(i));
          };
        }
      }
  }
