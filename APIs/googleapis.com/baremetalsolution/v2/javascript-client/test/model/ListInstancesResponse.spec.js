...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BareMetalSolutionApi.ListInstancesResponse();
  });
  ...
  describe('ListInstancesResponse', function() {
    it('should create an instance of ListInstancesResponse', function() {
      ...
      //var instance = new BareMetalSolutionApi.ListInstancesResponse();
      //expect(instance).to.be.a(BareMetalSolutionApi.ListInstancesResponse);
    });
