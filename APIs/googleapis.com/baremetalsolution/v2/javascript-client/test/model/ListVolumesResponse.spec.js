...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BareMetalSolutionApi.ListVolumesResponse();
  });
  ...
  describe('ListVolumesResponse', function() {
    it('should create an instance of ListVolumesResponse', function() {
      // uncomment below and update the code to test ListVolumesResponse
      //var instance = new BareMetalSolutionApi.ListVolumesResponse();
      //expect(instance).to.be.a(BareMetalSolutionApi.ListVolumesResponse);
    });
