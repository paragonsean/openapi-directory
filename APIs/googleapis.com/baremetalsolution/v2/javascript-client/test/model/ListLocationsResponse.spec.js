...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BareMetalSolutionApi.ListLocationsResponse();
  });
  ...
  describe('ListLocationsResponse', function() {
    it('should create an instance of ListLocationsResponse', function() {
      ...
      //var instance = new BareMetalSolutionApi.ListLocationsResponse();
      //expect(instance).to.be.a(BareMetalSolutionApi.ListLocationsResponse);
    });
