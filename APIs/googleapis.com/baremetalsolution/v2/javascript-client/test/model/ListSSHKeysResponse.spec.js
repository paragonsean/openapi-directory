...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BareMetalSolutionApi.ListSSHKeysResponse();
  });
  ...
  describe('ListSSHKeysResponse', function() {
    it('should create an instance of ListSSHKeysResponse', function() {
      // uncomment below and update the code to test ListSSHKeysResponse
      //var instance = new BareMetalSolutionApi.ListSSHKeysResponse();
      //expect(instance).to.be.a(BareMetalSolutionApi.ListSSHKeysResponse);
    });
