...
QList<OAIGoogleCloudBaremetalsolutionV2ServerNetworkTemplateLogicalInterface> OAIServerNetworkTemplate::getLogicalInterfaces() const {
    return m_logical_interfaces;
}
void OAIServerNetworkTemplate::setLogicalInterfaces(const QList<OAIGoogleCloudBaremetalsolutionV2ServerNetworkTemplateLogicalInterface> &logical_interfaces) {
