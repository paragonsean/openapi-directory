...
from openapi_server.models.logical_interface import LogicalInterface
...
class ServerNetworkTemplate(Model):
    ...
    def __init__(self, applicable_instance_types: List[str]=None, logical_interfaces: List[LogicalInterface]=None, name: str=None):
    ...
    def logical_interfaces(self, logical_interfaces):
        ...
        :param logical_interfaces: The logical_interfaces of this ServerNetworkTemplate.
        :type logical_interfaces: List[LogicalInterface]
        """
