...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BareMetalSolutionApi.ListOperationsResponse();
  });
  ...
  describe('ListOperationsResponse', function() {
    it('should create an instance of ListOperationsResponse', function() {
      ...
      //var instance = new BareMetalSolutionApi.ListOperationsResponse();
      //expect(instance).to.be.a(BareMetalSolutionApi.ListOperationsResponse);
    });
