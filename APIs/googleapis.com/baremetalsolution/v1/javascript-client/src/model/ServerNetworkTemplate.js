    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('logicalInterfaces')) {
                obj['logicalInterfaces'] = ApiClient.convertToType(data['logicalInterfaces'], [LogicalInterface]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['logicalInterfaces']) { // data not null
            ...
            for (const item of data['logicalInterfaces']) {
                LogicalInterface.validateJSON(item);
            };
        }
...
/**
 * Logical interfaces.
 * @member {Array.<module:model/LogicalInterface>} logicalInterfaces
 */
