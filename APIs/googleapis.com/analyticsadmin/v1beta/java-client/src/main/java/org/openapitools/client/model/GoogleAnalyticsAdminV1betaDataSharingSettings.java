...
public class GoogleAnalyticsAdminV1betaDataSharingSettings {
  ...
  public GoogleAnalyticsAdminV1betaDataSharingSettings() {
  }
  ...
  public GoogleAnalyticsAdminV1betaDataSharingSettings sharingWithGoogleAnySalesEnabled(Boolean sharingWithGoogleAnySalesEnabled) {
  ...
  public GoogleAnalyticsAdminV1betaDataSharingSettings sharingWithGoogleAssignedSalesEnabled(Boolean sharingWithGoogleAssignedSalesEnabled) {
  ...
  public GoogleAnalyticsAdminV1betaDataSharingSettings sharingWithGoogleProductsEnabled(Boolean sharingWithGoogleProductsEnabled) {
  ...
  public GoogleAnalyticsAdminV1betaDataSharingSettings sharingWithGoogleSupportEnabled(Boolean sharingWithGoogleSupportEnabled) {
  ...
  public GoogleAnalyticsAdminV1betaDataSharingSettings sharingWithOthersEnabled(Boolean sharingWithOthersEnabled) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleAnalyticsAdminV1betaDataSharingSettings googleAnalyticsAdminV1betaDataSharingSettings = (GoogleAnalyticsAdminV1betaDataSharingSettings) o;
    return Objects.equals(this.name, googleAnalyticsAdminV1betaDataSharingSettings.name) &&
        Objects.equals(this.sharingWithGoogleAnySalesEnabled, googleAnalyticsAdminV1betaDataSharingSettings.sharingWithGoogleAnySalesEnabled) &&
        Objects.equals(this.sharingWithGoogleAssignedSalesEnabled, googleAnalyticsAdminV1betaDataSharingSettings.sharingWithGoogleAssignedSalesEnabled) &&
        Objects.equals(this.sharingWithGoogleProductsEnabled, googleAnalyticsAdminV1betaDataSharingSettings.sharingWithGoogleProductsEnabled) &&
        Objects.equals(this.sharingWithGoogleSupportEnabled, googleAnalyticsAdminV1betaDataSharingSettings.sharingWithGoogleSupportEnabled) &&
        Objects.equals(this.sharingWithOthersEnabled, googleAnalyticsAdminV1betaDataSharingSettings.sharingWithOthersEnabled);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleAnalyticsAdminV1betaDataSharingSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleAnalyticsAdminV1betaDataSharingSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleAnalyticsAdminV1betaDataSharingSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleAnalyticsAdminV1betaDataSharingSettings is not found in the empty JSON string", GoogleAnalyticsAdminV1betaDataSharingSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleAnalyticsAdminV1betaDataSharingSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleAnalyticsAdminV1betaDataSharingSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleAnalyticsAdminV1betaDataSharingSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleAnalyticsAdminV1betaDataSharingSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleAnalyticsAdminV1betaDataSharingSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleAnalyticsAdminV1betaDataSharingSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleAnalyticsAdminV1betaDataSharingSettings>() {
           @Override
           public void write(JsonWriter out, GoogleAnalyticsAdminV1betaDataSharingSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleAnalyticsAdminV1betaDataSharingSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleAnalyticsAdminV1betaDataSharingSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleAnalyticsAdminV1betaDataSharingSettings
   * @throws IOException if the JSON string is invalid with respect to GoogleAnalyticsAdminV1betaDataSharingSettings
   */
  public static GoogleAnalyticsAdminV1betaDataSharingSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleAnalyticsAdminV1betaDataSharingSettings.class);
  }

  /**
   * Convert an instance of GoogleAnalyticsAdminV1betaDataSharingSettings to an JSON string
   *
   * @return JSON string
   */
