...
/**
 * The GoogleAnalyticsAdminV1betaProperty model module.
 * @module model/GoogleAnalyticsAdminV1betaProperty
 * @version v1beta
 */
class GoogleAnalyticsAdminV1betaProperty {
    /**
     * Constructs a new <code>GoogleAnalyticsAdminV1betaProperty</code>.
     * A resource message representing a Google Analytics GA4 property.
     * @alias module:model/GoogleAnalyticsAdminV1betaProperty
     */
    constructor() { 
        
        GoogleAnalyticsAdminV1betaProperty.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleAnalyticsAdminV1betaProperty</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleAnalyticsAdminV1betaProperty} obj Optional instance to populate.
     * @return {module:model/GoogleAnalyticsAdminV1betaProperty} The populated <code>GoogleAnalyticsAdminV1betaProperty</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleAnalyticsAdminV1betaProperty();
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleAnalyticsAdminV1betaProperty</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleAnalyticsAdminV1betaProperty</code>.
     */
 ...
 */
GoogleAnalyticsAdminV1betaProperty.prototype['account'] = undefined;

/**
 * Output only. Time when the entity was originally created.
 * @member {String} createTime
 */
GoogleAnalyticsAdminV1betaProperty.prototype['createTime'] = undefined;
 ...
 */
GoogleAnalyticsAdminV1betaProperty.prototype['currencyCode'] = undefined;
 ...
 */
GoogleAnalyticsAdminV1betaProperty.prototype['deleteTime'] = undefined;

/**
 * Required. Human-readable display name for this property. The max allowed display name length is 100 UTF-16 code units.
 * @member {String} displayName
 */
GoogleAnalyticsAdminV1betaProperty.prototype['displayName'] = undefined;
 ...
 */
GoogleAnalyticsAdminV1betaProperty.prototype['expireTime'] = undefined;

/**
 * Industry associated with this property Example: AUTOMOTIVE, FOOD_AND_DRINK
 * @member {module:model/GoogleAnalyticsAdminV1betaProperty.IndustryCategoryEnum} industryCategory
 */
GoogleAnalyticsAdminV1betaProperty.prototype['industryCategory'] = undefined;

/**
 * Output only. Resource name of this property. Format: properties/{property_id} Example: \"properties/1000\"
 * @member {String} name
 */
GoogleAnalyticsAdminV1betaProperty.prototype['name'] = undefined;
 ...
 */
GoogleAnalyticsAdminV1betaProperty.prototype['parent'] = undefined;
 ...
 * @member {module:model/GoogleAnalyticsAdminV1betaProperty.PropertyTypeEnum} propertyType
 */
GoogleAnalyticsAdminV1betaProperty.prototype['propertyType'] = undefined;

/**
 * Output only. The Google Analytics service level that applies to this property.
 * @member {module:model/GoogleAnalyticsAdminV1betaProperty.ServiceLevelEnum} serviceLevel
 */
GoogleAnalyticsAdminV1betaProperty.prototype['serviceLevel'] = undefined;

/**
 * Required. Reporting Time Zone, used as the day boundary for reports, regardless of where the data originates. If the time zone honors DST, Analytics will automatically adjust for the changes. NOTE: Changing the time zone only affects data going forward, and is not applied retroactively. Format: https://www.iana.org/time-zones Example: \"America/Los_Angeles\"
 * @member {String} timeZone
 */
GoogleAnalyticsAdminV1betaProperty.prototype['timeZone'] = undefined;

/**
 * Output only. Time when entity payload fields were last updated.
 * @member {String} updateTime
 */
GoogleAnalyticsAdminV1betaProperty.prototype['updateTime'] = undefined;
 ...
 * @readonly
 */
GoogleAnalyticsAdminV1betaProperty['IndustryCategoryEnum'] = {
 ...
 * @readonly
 */
GoogleAnalyticsAdminV1betaProperty['PropertyTypeEnum'] = {
 ...
 * @readonly
 */
GoogleAnalyticsAdminV1betaProperty['ServiceLevelEnum'] = {
...
export default GoogleAnalyticsAdminV1betaProperty;
