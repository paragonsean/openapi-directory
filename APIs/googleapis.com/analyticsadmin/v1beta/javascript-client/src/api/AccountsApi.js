...
export default class AccountsApi {
    ...
    */
     ...
     * @param {module:model/GoogleAnalyticsAdminV1betaListAccountsResponse} data The data returned by the service call.
     ...
     * data is of type: {@link module:model/GoogleAnalyticsAdminV1betaListAccountsResponse}
     */
    analyticsadminAccountsList(opts, callback) {
      ...
      let returnType = GoogleAnalyticsAdminV1betaListAccountsResponse;
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/GoogleAnalyticsAdminV1betaProvisionAccountTicketResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} [uploadProtocol] Upload protocol for media (e.g. \"raw\", \"multipart\").
     * @param {String} [uploadType] Legacy upload protocol for media (e.g. \"media\", \"multipart\").
     * @param {module:model/GoogleAnalyticsAdminV1betaProvisionAccountTicketRequest} [googleAnalyticsAdminV1betaProvisionAccountTicketRequest] 
     ...
     * data is of type: {@link module:model/GoogleAnalyticsAdminV1betaProvisionAccountTicketResponse}
     */
    analyticsadminAccountsProvisionAccountTicket(opts, callback) {
      opts = opts || {};
      let postBody = opts['googleAnalyticsAdminV1betaProvisionAccountTicketRequest'];
      ...
      let accepts = ['application/json'];
      let returnType = GoogleAnalyticsAdminV1betaProvisionAccountTicketResponse;
      return this.apiClient.callApi(
        '/v1beta/accounts:provisionAccountTicket', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/GoogleAnalyticsAdminV1betaSearchChangeHistoryEventsResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} [uploadProtocol] Upload protocol for media (e.g. \"raw\", \"multipart\").
     * @param {String} [uploadType] Legacy upload protocol for media (e.g. \"media\", \"multipart\").
     * @param {module:model/GoogleAnalyticsAdminV1betaSearchChangeHistoryEventsRequest} [googleAnalyticsAdminV1betaSearchChangeHistoryEventsRequest] 
     ...
     * data is of type: {@link module:model/GoogleAnalyticsAdminV1betaSearchChangeHistoryEventsResponse}
     */
    analyticsadminAccountsSearchChangeHistoryEvents(account, opts, callback) {
      opts = opts || {};
      let postBody = opts['googleAnalyticsAdminV1betaSearchChangeHistoryEventsRequest'];
      ...
      let contentTypes = ['application/json'];
      let accepts = ['application/json'];
      let returnType = GoogleAnalyticsAdminV1betaSearchChangeHistoryEventsResponse;
      return this.apiClient.callApi(
        '/v1beta/{account}:searchChangeHistoryEvents', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
