...
public:
    ...
    * @param[in]  upload_protocol QString [optional]
    * @param[in]  upload_type QString [optional]
    * @param[in]  oai_google_analytics_admin_v1alpha_provision_account_ticket_request OAIGoogleAnalyticsAdminV1alphaProvisionAccountTicketRequest [optional]
    */
    virtual void analyticsadmin_accounts_provisionAccountTicket(const ::OpenAPI::OptionalParam<QString> &_xgafv = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &access_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &alt = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &callback = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &fields = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &key = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &oauth_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &pretty_print = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &quota_user = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &upload_protocol = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &upload_type = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAIGoogleAnalyticsAdminV1alphaProvisionAccountTicketRequest> &oai_google_analytics_admin_v1alpha_provision_account_ticket_request = ::OpenAPI::OptionalParam<OAIGoogleAnalyticsAdminV1alphaProvisionAccountTicketRequest>());
    ...
    * @param[in]  upload_protocol QString [optional]
    * @param[in]  upload_type QString [optional]
    * @param[in]  oai_google_analytics_admin_v1alpha_search_change_history_events_request OAIGoogleAnalyticsAdminV1alphaSearchChangeHistoryEventsRequest [optional]
    */
    virtual void analyticsadmin_accounts_searchChangeHistoryEvents(const QString &account, const ::OpenAPI::OptionalParam<QString> &_xgafv = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &access_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &alt = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &callback = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &fields = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &key = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &oauth_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &pretty_print = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &quota_user = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &upload_protocol = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &upload_type = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAIGoogleAnalyticsAdminV1alphaSearchChangeHistoryEventsRequest> &oai_google_analytics_admin_v1alpha_search_change_history_events_request = ::OpenAPI::OptionalParam<OAIGoogleAnalyticsAdminV1alphaSearchChangeHistoryEventsRequest>());
...
Q_SIGNALS:
    ...
    void analyticsadmin_accounts_listSignal(OAIGoogleAnalyticsAdminV1alphaListAccountsResponse summary);
    void analyticsadmin_accounts_provisionAccountTicketSignal(OAIGoogleAnalyticsAdminV1alphaProvisionAccountTicketResponse summary);
    void analyticsadmin_accounts_searchChangeHistoryEventsSignal(OAIGoogleAnalyticsAdminV1alphaSearchChangeHistoryEventsResponse summary);


    void analyticsadmin_accounts_listSignalFull(OAIHttpRequestWorker *worker, OAIGoogleAnalyticsAdminV1alphaListAccountsResponse summary);
    void analyticsadmin_accounts_provisionAccountTicketSignalFull(OAIHttpRequestWorker *worker, OAIGoogleAnalyticsAdminV1alphaProvisionAccountTicketResponse summary);
    void analyticsadmin_accounts_searchChangeHistoryEventsSignalFull(OAIHttpRequestWorker *worker, OAIGoogleAnalyticsAdminV1alphaSearchChangeHistoryEventsResponse summary);

    Q_DECL_DEPRECATED_X("Use analyticsadmin_accounts_listSignalError() instead")
    void analyticsadmin_accounts_listSignalE(OAIGoogleAnalyticsAdminV1alphaListAccountsResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void analyticsadmin_accounts_listSignalError(OAIGoogleAnalyticsAdminV1alphaListAccountsResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use analyticsadmin_accounts_provisionAccountTicketSignalError() instead")
    void analyticsadmin_accounts_provisionAccountTicketSignalE(OAIGoogleAnalyticsAdminV1alphaProvisionAccountTicketResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void analyticsadmin_accounts_provisionAccountTicketSignalError(OAIGoogleAnalyticsAdminV1alphaProvisionAccountTicketResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use analyticsadmin_accounts_searchChangeHistoryEventsSignalError() instead")
    void analyticsadmin_accounts_searchChangeHistoryEventsSignalE(OAIGoogleAnalyticsAdminV1alphaSearchChangeHistoryEventsResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void analyticsadmin_accounts_searchChangeHistoryEventsSignalError(OAIGoogleAnalyticsAdminV1alphaSearchChangeHistoryEventsResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
