...
/*
 * OAIGoogleAnalyticsAdminV1alphaChangeHistoryEvent.h
 *
 * A set of changes within a Google Analytics account or its child properties that resulted from the same cause. Common causes would be updates made in the Google Analytics UI, changes from customer support, or automatic Google Analytics system changes.
 */

#ifndef OAIGoogleAnalyticsAdminV1alphaChangeHistoryEvent_H
#define OAIGoogleAnalyticsAdminV1alphaChangeHistoryEvent_H
...
namespace OpenAPI {
class OAIGoogleAnalyticsAdminV1alphaChangeHistoryChange;

class OAIGoogleAnalyticsAdminV1alphaChangeHistoryEvent : public OAIObject {
public:
    OAIGoogleAnalyticsAdminV1alphaChangeHistoryEvent();
    OAIGoogleAnalyticsAdminV1alphaChangeHistoryEvent(QString json);
    ~OAIGoogleAnalyticsAdminV1alphaChangeHistoryEvent() override;
    ...
    QList<OAIGoogleAnalyticsAdminV1alphaChangeHistoryChange> getChanges() const;
    void setChanges(const QList<OAIGoogleAnalyticsAdminV1alphaChangeHistoryChange> &changes);
...
private:
    ...
    QList<OAIGoogleAnalyticsAdminV1alphaChangeHistoryChange> m_changes;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleAnalyticsAdminV1alphaChangeHistoryEvent)

#endif // OAIGoogleAnalyticsAdminV1alphaChangeHistoryEvent_H
