...
|**maxEventValue** | **Double** | The maximum revenue generated due to the event. Revenue currency will be defined at the property level. If not set, maximum event value won&#39;t be checked. |  [optional] |
...
|**minEventValue** | **Double** | The minimum revenue generated due to the event. Revenue currency will be defined at the property level. If not set, minimum event value won&#39;t be checked. |  [optional] |
