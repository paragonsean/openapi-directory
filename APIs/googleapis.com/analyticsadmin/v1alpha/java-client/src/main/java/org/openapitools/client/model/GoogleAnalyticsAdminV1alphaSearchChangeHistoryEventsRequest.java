...
public class GoogleAnalyticsAdminV1alphaSearchChangeHistoryEventsRequest {
  ...
  public GoogleAnalyticsAdminV1alphaSearchChangeHistoryEventsRequest action(List<ActionEnum> action) {
    this.action = action;
    return this;
  }

  public GoogleAnalyticsAdminV1alphaSearchChangeHistoryEventsRequest addActionItem(ActionEnum actionItem) {
    if (this.action == null) {
  ...
  public GoogleAnalyticsAdminV1alphaSearchChangeHistoryEventsRequest actorEmail(List<String> actorEmail) {
    this.actorEmail = actorEmail;
    return this;
  }

  public GoogleAnalyticsAdminV1alphaSearchChangeHistoryEventsRequest addActorEmailItem(String actorEmailItem) {
  ...
  public GoogleAnalyticsAdminV1alphaSearchChangeHistoryEventsRequest earliestChangeTime(String earliestChangeTime) {
  ...
  public GoogleAnalyticsAdminV1alphaSearchChangeHistoryEventsRequest latestChangeTime(String latestChangeTime) {
  ...
  public GoogleAnalyticsAdminV1alphaSearchChangeHistoryEventsRequest pageSize(Integer pageSize) {
  ...
  public GoogleAnalyticsAdminV1alphaSearchChangeHistoryEventsRequest pageToken(String pageToken) {
  ...
  public GoogleAnalyticsAdminV1alphaSearchChangeHistoryEventsRequest property(String property) {
  ...
  public GoogleAnalyticsAdminV1alphaSearchChangeHistoryEventsRequest resourceType(List<ResourceTypeEnum> resourceType) {
    this.resourceType = resourceType;
    return this;
  }

  public GoogleAnalyticsAdminV1alphaSearchChangeHistoryEventsRequest addResourceTypeItem(ResourceTypeEnum resourceTypeItem) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleAnalyticsAdminV1alphaSearchChangeHistoryEventsRequest googleAnalyticsAdminV1alphaSearchChangeHistoryEventsRequest = (GoogleAnalyticsAdminV1alphaSearchChangeHistoryEventsRequest) o;
    return Objects.equals(this.action, googleAnalyticsAdminV1alphaSearchChangeHistoryEventsRequest.action) &&
        Objects.equals(this.actorEmail, googleAnalyticsAdminV1alphaSearchChangeHistoryEventsRequest.actorEmail) &&
        Objects.equals(this.earliestChangeTime, googleAnalyticsAdminV1alphaSearchChangeHistoryEventsRequest.earliestChangeTime) &&
        Objects.equals(this.latestChangeTime, googleAnalyticsAdminV1alphaSearchChangeHistoryEventsRequest.latestChangeTime) &&
        Objects.equals(this.pageSize, googleAnalyticsAdminV1alphaSearchChangeHistoryEventsRequest.pageSize) &&
        Objects.equals(this.pageToken, googleAnalyticsAdminV1alphaSearchChangeHistoryEventsRequest.pageToken) &&
        Objects.equals(this.property, googleAnalyticsAdminV1alphaSearchChangeHistoryEventsRequest.property) &&
        Objects.equals(this.resourceType, googleAnalyticsAdminV1alphaSearchChangeHistoryEventsRequest.resourceType);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleAnalyticsAdminV1alphaSearchChangeHistoryEventsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleAnalyticsAdminV1alphaSearchChangeHistoryEventsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleAnalyticsAdminV1alphaSearchChangeHistoryEventsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleAnalyticsAdminV1alphaSearchChangeHistoryEventsRequest is not found in the empty JSON string", GoogleAnalyticsAdminV1alphaSearchChangeHistoryEventsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleAnalyticsAdminV1alphaSearchChangeHistoryEventsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleAnalyticsAdminV1alphaSearchChangeHistoryEventsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleAnalyticsAdminV1alphaSearchChangeHistoryEventsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleAnalyticsAdminV1alphaSearchChangeHistoryEventsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleAnalyticsAdminV1alphaSearchChangeHistoryEventsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleAnalyticsAdminV1alphaSearchChangeHistoryEventsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleAnalyticsAdminV1alphaSearchChangeHistoryEventsRequest>() {
           @Override
           public void write(JsonWriter out, GoogleAnalyticsAdminV1alphaSearchChangeHistoryEventsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleAnalyticsAdminV1alphaSearchChangeHistoryEventsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleAnalyticsAdminV1alphaSearchChangeHistoryEventsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleAnalyticsAdminV1alphaSearchChangeHistoryEventsRequest
   * @throws IOException if the JSON string is invalid with respect to GoogleAnalyticsAdminV1alphaSearchChangeHistoryEventsRequest
   */
  public static GoogleAnalyticsAdminV1alphaSearchChangeHistoryEventsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleAnalyticsAdminV1alphaSearchChangeHistoryEventsRequest.class);
  }

  /**
   * Convert an instance of GoogleAnalyticsAdminV1alphaSearchChangeHistoryEventsRequest to an JSON string
   *
   * @return JSON string
   */
