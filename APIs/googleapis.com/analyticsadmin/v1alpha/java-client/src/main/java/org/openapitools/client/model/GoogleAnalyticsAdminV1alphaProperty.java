...
public class GoogleAnalyticsAdminV1alphaProperty {
  ...
  public GoogleAnalyticsAdminV1alphaProperty account(String account) {
  ...
  public GoogleAnalyticsAdminV1alphaProperty currencyCode(String currencyCode) {
  ...
  public GoogleAnalyticsAdminV1alphaProperty displayName(String displayName) {
  ...
  public GoogleAnalyticsAdminV1alphaProperty industryCategory(IndustryCategoryEnum industryCategory) {
  ...
  public GoogleAnalyticsAdminV1alphaProperty parent(String parent) {
    this.parent = parent;
    return this;
  }
  ...
  public GoogleAnalyticsAdminV1alphaProperty propertyType(PropertyTypeEnum propertyType) {
  ...
  public GoogleAnalyticsAdminV1alphaProperty timeZone(String timeZone) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleAnalyticsAdminV1alphaProperty googleAnalyticsAdminV1alphaProperty = (GoogleAnalyticsAdminV1alphaProperty) o;
    return Objects.equals(this.account, googleAnalyticsAdminV1alphaProperty.account) &&
        Objects.equals(this.createTime, googleAnalyticsAdminV1alphaProperty.createTime) &&
        Objects.equals(this.currencyCode, googleAnalyticsAdminV1alphaProperty.currencyCode) &&
        Objects.equals(this.deleteTime, googleAnalyticsAdminV1alphaProperty.deleteTime) &&
        Objects.equals(this.displayName, googleAnalyticsAdminV1alphaProperty.displayName) &&
        Objects.equals(this.expireTime, googleAnalyticsAdminV1alphaProperty.expireTime) &&
        Objects.equals(this.industryCategory, googleAnalyticsAdminV1alphaProperty.industryCategory) &&
        Objects.equals(this.name, googleAnalyticsAdminV1alphaProperty.name) &&
        Objects.equals(this.parent, googleAnalyticsAdminV1alphaProperty.parent) &&
        Objects.equals(this.propertyType, googleAnalyticsAdminV1alphaProperty.propertyType) &&
        Objects.equals(this.serviceLevel, googleAnalyticsAdminV1alphaProperty.serviceLevel) &&
        Objects.equals(this.timeZone, googleAnalyticsAdminV1alphaProperty.timeZone) &&
        Objects.equals(this.updateTime, googleAnalyticsAdminV1alphaProperty.updateTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleAnalyticsAdminV1alphaProperty {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleAnalyticsAdminV1alphaProperty
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleAnalyticsAdminV1alphaProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleAnalyticsAdminV1alphaProperty is not found in the empty JSON string", GoogleAnalyticsAdminV1alphaProperty.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleAnalyticsAdminV1alphaProperty.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleAnalyticsAdminV1alphaProperty` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleAnalyticsAdminV1alphaProperty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleAnalyticsAdminV1alphaProperty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleAnalyticsAdminV1alphaProperty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleAnalyticsAdminV1alphaProperty.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleAnalyticsAdminV1alphaProperty>() {
           @Override
           public void write(JsonWriter out, GoogleAnalyticsAdminV1alphaProperty value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleAnalyticsAdminV1alphaProperty read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleAnalyticsAdminV1alphaProperty given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleAnalyticsAdminV1alphaProperty
   * @throws IOException if the JSON string is invalid with respect to GoogleAnalyticsAdminV1alphaProperty
   */
  public static GoogleAnalyticsAdminV1alphaProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleAnalyticsAdminV1alphaProperty.class);
  }

  /**
   * Convert an instance of GoogleAnalyticsAdminV1alphaProperty to an JSON string
   *
   * @return JSON string
   */
