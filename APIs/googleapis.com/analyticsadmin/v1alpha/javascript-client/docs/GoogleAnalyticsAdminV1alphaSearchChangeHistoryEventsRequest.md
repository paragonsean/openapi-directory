# GoogleAnalyticsAdminApi.GoogleAnalyticsAdminV1alphaSearchChangeHistoryEventsRequest
...
* `CUSTOM_DIMENSION` (value: `"CUSTOM_DIMENSION"`)
...
* `SEARCH_ADS_360_LINK` (value: `"SEARCH_ADS_360_LINK"`)

* `DATA_STREAM` (value: `"DATA_STREAM"`)

* `ATTRIBUTION_SETTINGS` (value: `"ATTRIBUTION_SETTINGS"`)

* `EXPANDED_DATA_SET` (value: `"EXPANDED_DATA_SET"`)

* `CHANNEL_GROUP` (value: `"CHANNEL_GROUP"`)

* `ENHANCED_MEASUREMENT_SETTINGS` (value: `"ENHANCED_MEASUREMENT_SETTINGS"`)

* `DATA_REDACTION_SETTINGS` (value: `"DATA_REDACTION_SETTINGS"`)

* `SKADNETWORK_CONVERSION_VALUE_SCHEMA` (value: `"SKADNETWORK_CONVERSION_VALUE_SCHEMA"`)

* `ADSENSE_LINK` (value: `"ADSENSE_LINK"`)

* `AUDIENCE` (value: `"AUDIENCE"`)

* `EVENT_CREATE_RULE` (value: `"EVENT_CREATE_RULE"`)

* `CALCULATED_METRIC` (value: `"CALCULATED_METRIC"`)
