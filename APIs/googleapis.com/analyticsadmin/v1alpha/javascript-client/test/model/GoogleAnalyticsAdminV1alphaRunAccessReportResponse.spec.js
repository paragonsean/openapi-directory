...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleAnalyticsAdminApi.GoogleAnalyticsAdminV1alphaRunAccessReportResponse();
  });
  ...
  describe('GoogleAnalyticsAdminV1alphaRunAccessReportResponse', function() {
    it('should create an instance of GoogleAnalyticsAdminV1alphaRunAccessReportResponse', function() {
      // uncomment below and update the code to test GoogleAnalyticsAdminV1alphaRunAccessReportResponse
      //var instance = new GoogleAnalyticsAdminApi.GoogleAnalyticsAdminV1alphaRunAccessReportResponse();
      //expect(instance).to.be.a(GoogleAnalyticsAdminApi.GoogleAnalyticsAdminV1alphaRunAccessReportResponse);
    });
