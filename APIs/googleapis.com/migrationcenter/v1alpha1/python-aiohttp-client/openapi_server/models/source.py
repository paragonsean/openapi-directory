...
class Source(Model):
    ...
    def __init__(self, create_time: str=None, description: str=None, display_name: str=None, error_frame_count: int=None, is_managed: bool=None, name: str=None, pending_frame_count: int=None, priority: int=None, state: str=None, type: str=None, update_time: str=None):
        ...
        :param is_managed: The is_managed of this Source.
    ...
    @property
    def is_managed(self):
        """Gets the is_managed of this Source.

        If `true`, the source is managed by other service(s).

        :return: The is_managed of this Source.
        :rtype: bool
        """
    ...
    def is_managed(self, is_managed):
        """Sets the is_managed of this Source.
