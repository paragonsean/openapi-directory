...
class VirtualMachinePreferences(Model):
    ...
    def __init__(self, commitment_plan: str=None, compute_engine_preferences: ComputeEnginePreferences=None, network_cost_parameters: VirtualMachinePreferencesNetworkCostParameters=None, region_preferences: RegionPreferences=None, sizing_optimization_custom_parameters: VirtualMachinePreferencesSizingOptimizationCustomParameters=None, sizing_optimization_strategy: str=None, sole_tenancy_preferences: SoleTenancyPreferences=None, target_product: str=None, vmware_engine_preferences: VmwareEnginePreferences=None):
        ...
        :param network_cost_parameters: The network_cost_parameters of this VirtualMachinePreferences.
        :param region_preferences: The region_preferences of this VirtualMachinePreferences.
        :param sizing_optimization_custom_parameters: The sizing_optimization_custom_parameters of this VirtualMachinePreferences.
        ...
        self.openapi_types = {
            ...
            'network_cost_parameters': VirtualMachinePreferencesNetworkCostParameters,
            'region_preferences': RegionPreferences,
            'sizing_optimization_custom_parameters': VirtualMachinePreferencesSizingOptimizationCustomParameters,
        ...
        self.attribute_map = {
            ...
            'compute_engine_preferences': 'computeEnginePreferences',
            'network_cost_parameters': 'networkCostParameters',
            'region_preferences': 'regionPreferences',
            'sizing_optimization_custom_parameters': 'sizingOptimizationCustomParameters',
        ...
        self._network_cost_parameters = network_cost_parameters
        self._region_preferences = region_preferences
        self._sizing_optimization_custom_parameters = sizing_optimization_custom_parameters
    ...
    @property
    def network_cost_parameters(self):
        """Gets the network_cost_parameters of this VirtualMachinePreferences.


        :return: The network_cost_parameters of this VirtualMachinePreferences.
        :rtype: VirtualMachinePreferencesNetworkCostParameters
        """
        return self._network_cost_parameters

    @network_cost_parameters.setter
    def network_cost_parameters(self, network_cost_parameters):
        """Sets the network_cost_parameters of this VirtualMachinePreferences.


        :param network_cost_parameters: The network_cost_parameters of this VirtualMachinePreferences.
        :type network_cost_parameters: VirtualMachinePreferencesNetworkCostParameters
        """
    ...
    @property
    def sizing_optimization_custom_parameters(self):
        """Gets the sizing_optimization_custom_parameters of this VirtualMachinePreferences.


        :return: The sizing_optimization_custom_parameters of this VirtualMachinePreferences.
        :rtype: VirtualMachinePreferencesSizingOptimizationCustomParameters
        """
        return self._sizing_optimization_custom_parameters

    @sizing_optimization_custom_parameters.setter
    def sizing_optimization_custom_parameters(self, sizing_optimization_custom_parameters):
        """Sets the sizing_optimization_custom_parameters of this VirtualMachinePreferences.


        :param sizing_optimization_custom_parameters: The sizing_optimization_custom_parameters of this VirtualMachinePreferences.
        :type sizing_optimization_custom_parameters: VirtualMachinePreferencesSizingOptimizationCustomParameters
        """
    ...
    def sizing_optimization_strategy(self, sizing_optimization_strategy):
        ...
        """
        allowed_values = ["SIZING_OPTIMIZATION_STRATEGY_UNSPECIFIED", "SIZING_OPTIMIZATION_STRATEGY_SAME_AS_SOURCE", "SIZING_OPTIMIZATION_STRATEGY_MODERATE", "SIZING_OPTIMIZATION_STRATEGY_AGGRESSIVE", "SIZING_OPTIMIZATION_STRATEGY_CUSTOM"]  # noqa: E501
