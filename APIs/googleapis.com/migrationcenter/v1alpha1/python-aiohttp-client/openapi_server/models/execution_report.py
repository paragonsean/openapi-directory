...
class ExecutionReport(Model):
    ...
    def __init__(self, execution_errors: ValidationReport=None, frames_reported: int=None, job_errors: List[ImportError]=None, total_rows_count: int=None):
        ...
        :param job_errors: The job_errors of this ExecutionReport.
    ...
    @property
    def job_errors(self):
        """Gets the job_errors of this ExecutionReport.

        List of job-level errors. Deprecated, use the job errors under execution_errors instead.

        :return: The job_errors of this ExecutionReport.
    ...
    def job_errors(self, job_errors):
        """Sets the job_errors of this ExecutionReport.
