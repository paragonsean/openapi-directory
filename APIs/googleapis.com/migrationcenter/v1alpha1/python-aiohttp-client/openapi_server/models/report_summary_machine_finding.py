...
class ReportSummaryMachineFinding(Model):
    ...
    def __init__(self, allocated_asset_count: str=None, allocated_disk_types: List[str]=None, allocated_regions: List[str]=None, machine_series_allocations: List[ReportSummaryMachineSeriesAllocation]=None):
        """ReportSummaryMachineFinding - a model defined in OpenAPI

        :param allocated_asset_count: The allocated_asset_count of this ReportSummaryMachineFinding.
        :param allocated_disk_types: The allocated_disk_types of this ReportSummaryMachineFinding.
        :param allocated_regions: The allocated_regions of this ReportSummaryMachineFinding.
        :param machine_series_allocations: The machine_series_allocations of this ReportSummaryMachineFinding.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ReportSummaryMachineFinding':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ReportSummaryMachineFinding of this ReportSummaryMachineFinding.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def allocated_asset_count(self):
        """Gets the allocated_asset_count of this ReportSummaryMachineFinding.

        Count of assets which were allocated.

        :return: The allocated_asset_count of this ReportSummaryMachineFinding.
        :rtype: str
        """
    ...
    def allocated_asset_count(self, allocated_asset_count):
        """Sets the allocated_asset_count of this ReportSummaryMachineFinding.
    ...
    def allocated_disk_types(self):
        """Gets the allocated_disk_types of this ReportSummaryMachineFinding.

        Set of disk types allocated to assets.

        :return: The allocated_disk_types of this ReportSummaryMachineFinding.
        :rtype: List[str]
        """
    ...
    def allocated_disk_types(self, allocated_disk_types):
        """Sets the allocated_disk_types of this ReportSummaryMachineFinding.
    ...
    def allocated_regions(self):
        """Gets the allocated_regions of this ReportSummaryMachineFinding.

        Set of regions in which the assets were allocated.

        :return: The allocated_regions of this ReportSummaryMachineFinding.
        :rtype: List[str]
        """
    ...
    def allocated_regions(self, allocated_regions):
        """Sets the allocated_regions of this ReportSummaryMachineFinding.
    ...
    def machine_series_allocations(self):
        """Gets the machine_series_allocations of this ReportSummaryMachineFinding.

        Distribution of assets based on the Machine Series.

        :return: The machine_series_allocations of this ReportSummaryMachineFinding.
    ...
    def machine_series_allocations(self, machine_series_allocations):
        """Sets the machine_series_allocations of this ReportSummaryMachineFinding.
