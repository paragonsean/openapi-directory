...
class ImportJob(Model):
    ...
    def __init__(self, asset_source: str=None, complete_time: str=None, create_time: str=None, display_name: str=None, execution_report: ExecutionReport=None, gcs_payload: GCSPayloadInfo=None, inline_payload: InlinePayloadInfo=None, labels: Dict[str, str]=None, name: str=None, state: str=None, update_time: str=None, validation_report: ValidationReport=None):
        ...
        :param gcs_payload: The gcs_payload of this ImportJob.
        :param inline_payload: The inline_payload of this ImportJob.
        ...
        self.openapi_types = {
            ...
            'gcs_payload': GCSPayloadInfo,
            'inline_payload': InlinePayloadInfo,
            'labels': Dict[str, str],
            'name': str,
            'state': str,
            'update_time': str,
    ...
    @property
    def gcs_payload(self):
        """Gets the gcs_payload of this ImportJob.


        :return: The gcs_payload of this ImportJob.
        :rtype: GCSPayloadInfo
        """
        return self._gcs_payload

    @gcs_payload.setter
    def gcs_payload(self, gcs_payload):
        """Sets the gcs_payload of this ImportJob.


        :param gcs_payload: The gcs_payload of this ImportJob.
        :type gcs_payload: GCSPayloadInfo
        """
    ...
    def inline_payload(self):
        """Gets the inline_payload of this ImportJob.


        :return: The inline_payload of this ImportJob.
        :rtype: InlinePayloadInfo
        """
        return self._inline_payload

    @inline_payload.setter
    def inline_payload(self, inline_payload):
        """Sets the inline_payload of this ImportJob.


        :param inline_payload: The inline_payload of this ImportJob.
        :type inline_payload: InlinePayloadInfo
        """
