...
bool OAISource::isIsManaged() const {
    return m_is_managed;
}
void OAISource::setIsManaged(const bool &is_managed) {
    m_is_managed = is_managed;
    m_is_managed_isSet = true;
}

bool OAISource::is_is_managed_Set() const{
    return m_is_managed_isSet;
}

bool OAISource::is_is_managed_Valid() const{
