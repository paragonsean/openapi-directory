...
void OAIGuestConfigDetails::initializeModel() {
    ...
    m_selinux_isSet = false;
    m_selinux_isValid = false;
}
...
void OAIGuestConfigDetails::fromJsonObject(QJsonObject json) {
    ...
    m_selinux_isValid = ::OpenAPI::fromJsonValue(m_selinux, json[QString("selinux")]);
    m_selinux_isSet = !json[QString("selinux")].isNull() && m_selinux_isValid;
}
...
QJsonObject OAIGuestConfigDetails::asJsonObject() const {
    ...
    if (m_selinux.isSet()) {
        obj.insert(QString("selinux"), ::OpenAPI::toJsonValue(m_selinux));
    }
    return obj;
}
...
OAISelinux OAIGuestConfigDetails::getSelinux() const {
    return m_selinux;
}
void OAIGuestConfigDetails::setSelinux(const OAISelinux &selinux) {
    m_selinux = selinux;
    m_selinux_isSet = true;
}

bool OAIGuestConfigDetails::is_selinux_Set() const{
    return m_selinux_isSet;
}

bool OAIGuestConfigDetails::is_selinux_Valid() const{
    return m_selinux_isValid;
}
