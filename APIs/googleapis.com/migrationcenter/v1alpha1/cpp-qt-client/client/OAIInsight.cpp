...
void OAIInsight::initializeModel() {
    ...
    m_software_insight_isSet = false;
    m_software_insight_isValid = false;
}
...
void OAIInsight::fromJsonObject(QJsonObject json) {
    ...
    m_software_insight_isValid = ::OpenAPI::fromJsonValue(m_software_insight, json[QString("softwareInsight")]);
    m_software_insight_isSet = !json[QString("softwareInsight")].isNull() && m_software_insight_isValid;
}
...
QJsonObject OAIInsight::asJsonObject() const {
    ...
    if (m_software_insight.isSet()) {
        obj.insert(QString("softwareInsight"), ::OpenAPI::toJsonValue(m_software_insight));
    }
    return obj;
}
...
OAISoftwareInsight OAIInsight::getSoftwareInsight() const {
    return m_software_insight;
}
void OAIInsight::setSoftwareInsight(const OAISoftwareInsight &software_insight) {
    m_software_insight = software_insight;
    m_software_insight_isSet = true;
}

bool OAIInsight::is_software_insight_Set() const{
    return m_software_insight_isSet;
}

bool OAIInsight::is_software_insight_Valid() const{
    return m_software_insight_isValid;
}
