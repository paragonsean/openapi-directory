...
public:
    ...
    OAIReportSummaryChartData getAssetAge() const;
    void setAssetAge(const OAIReportSummaryChartData &asset_age);
    bool is_asset_age_Set() const;
    bool is_asset_age_Valid() const;
    ...
    OAIReportSummaryChartData getMemoryUtilization() const;
    void setMemoryUtilization(const OAIReportSummaryChartData &memory_utilization);
    ...
    OAIReportSummaryChartData getStorageUtilization() const;
    void setStorageUtilization(const OAIReportSummaryChartData &storage_utilization);
    bool is_storage_utilization_Set() const;
    bool is_storage_utilization_Valid() const;
...
private:
    ...
    OAIReportSummaryChartData m_asset_age;
    bool m_asset_age_isSet;
    bool m_asset_age_isValid;
    ...
    OAIReportSummaryChartData m_memory_utilization;
    ...
    OAIReportSummaryChartData m_storage_utilization;
    bool m_storage_utilization_isSet;
    bool m_storage_utilization_isValid;
