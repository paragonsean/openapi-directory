...
QList<OAIImportError> OAIExecutionReport::getJobErrors() const {
    return m_job_errors;
}
void OAIExecutionReport::setJobErrors(const QList<OAIImportError> &job_errors) {
    m_job_errors = job_errors;
    m_job_errors_isSet = true;
}

bool OAIExecutionReport::is_job_errors_Set() const{
    return m_job_errors_isSet;
}

bool OAIExecutionReport::is_job_errors_Valid() const{
