...
void OAIVirtualMachinePreferences::initializeModel() {
    ...
    m_network_cost_parameters_isSet = false;
    m_network_cost_parameters_isValid = false;

    m_region_preferences_isSet = false;
    m_region_preferences_isValid = false;

    m_sizing_optimization_custom_parameters_isSet = false;
    m_sizing_optimization_custom_parameters_isValid = false;
...
void OAIVirtualMachinePreferences::fromJsonObject(QJsonObject json) {
    ...
    m_network_cost_parameters_isValid = ::OpenAPI::fromJsonValue(m_network_cost_parameters, json[QString("networkCostParameters")]);
    m_network_cost_parameters_isSet = !json[QString("networkCostParameters")].isNull() && m_network_cost_parameters_isValid;
    ...
    m_sizing_optimization_custom_parameters_isValid = ::OpenAPI::fromJsonValue(m_sizing_optimization_custom_parameters, json[QString("sizingOptimizationCustomParameters")]);
    m_sizing_optimization_custom_parameters_isSet = !json[QString("sizingOptimizationCustomParameters")].isNull() && m_sizing_optimization_custom_parameters_isValid;
...
QJsonObject OAIVirtualMachinePreferences::asJsonObject() const {
    ...
    if (m_network_cost_parameters.isSet()) {
        obj.insert(QString("networkCostParameters"), ::OpenAPI::toJsonValue(m_network_cost_parameters));
    }
    if (m_region_preferences.isSet()) {
        obj.insert(QString("regionPreferences"), ::OpenAPI::toJsonValue(m_region_preferences));
    }
    if (m_sizing_optimization_custom_parameters.isSet()) {
        obj.insert(QString("sizingOptimizationCustomParameters"), ::OpenAPI::toJsonValue(m_sizing_optimization_custom_parameters));
    }
...
OAIVirtualMachinePreferencesNetworkCostParameters OAIVirtualMachinePreferences::getNetworkCostParameters() const {
    return m_network_cost_parameters;
}
void OAIVirtualMachinePreferences::setNetworkCostParameters(const OAIVirtualMachinePreferencesNetworkCostParameters &network_cost_parameters) {
    m_network_cost_parameters = network_cost_parameters;
    m_network_cost_parameters_isSet = true;
}

bool OAIVirtualMachinePreferences::is_network_cost_parameters_Set() const{
    return m_network_cost_parameters_isSet;
}

bool OAIVirtualMachinePreferences::is_network_cost_parameters_Valid() const{
    return m_network_cost_parameters_isValid;
}
...
OAIVirtualMachinePreferencesSizingOptimizationCustomParameters OAIVirtualMachinePreferences::getSizingOptimizationCustomParameters() const {
    return m_sizing_optimization_custom_parameters;
}
void OAIVirtualMachinePreferences::setSizingOptimizationCustomParameters(const OAIVirtualMachinePreferencesSizingOptimizationCustomParameters &sizing_optimization_custom_parameters) {
    m_sizing_optimization_custom_parameters = sizing_optimization_custom_parameters;
    m_sizing_optimization_custom_parameters_isSet = true;
}

bool OAIVirtualMachinePreferences::is_sizing_optimization_custom_parameters_Set() const{
    return m_sizing_optimization_custom_parameters_isSet;
}

bool OAIVirtualMachinePreferences::is_sizing_optimization_custom_parameters_Valid() const{
    return m_sizing_optimization_custom_parameters_isValid;
}
