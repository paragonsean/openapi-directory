...
/*
 * OAIVirtualMachineArchitectureDetails.h
 *
 * Details of the VM architecture.
 */

#ifndef OAIVirtualMachineArchitectureDetails_H
#define OAIVirtualMachineArchitectureDetails_H
...
class OAIVirtualMachineArchitectureDetails : public OAIObject {
public:
    OAIVirtualMachineArchitectureDetails();
    OAIVirtualMachineArchitectureDetails(QString json);
    ~OAIVirtualMachineArchitectureDetails() override;
    ...
    QString getCpuManufacturer() const;
    void setCpuManufacturer(const QString &cpu_manufacturer);
    bool is_cpu_manufacturer_Set() const;
    bool is_cpu_manufacturer_Valid() const;
...
private:
    ...
    QString m_cpu_manufacturer;
    bool m_cpu_manufacturer_isSet;
    bool m_cpu_manufacturer_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVirtualMachineArchitectureDetails)

#endif // OAIVirtualMachineArchitectureDetails_H
