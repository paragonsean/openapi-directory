...
class Settings {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('disableCloudLogging')) {
                obj['disableCloudLogging'] = ApiClient.convertToType(data['disableCloudLogging'], 'Boolean');
            }
 ...
 * @member {Boolean} disableCloudLogging
 */
Settings.prototype['disableCloudLogging'] = undefined;
 ...
 */
Settings.prototype['preferenceSet'] = undefined;
