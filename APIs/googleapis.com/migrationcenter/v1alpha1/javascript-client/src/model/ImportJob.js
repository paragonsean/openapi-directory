...
class ImportJob {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('gcsPayload')) {
                obj['gcsPayload'] = GCSPayloadInfo.constructFromObject(data['gcsPayload']);
            }
            if (data.hasOwnProperty('inlinePayload')) {
                obj['inlinePayload'] = InlinePayloadInfo.constructFromObject(data['inlinePayload']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['gcsPayload']) { // data not null
          GCSPayloadInfo.validateJSON(data['gcsPayload']);
        }
        // validate the optional field `inlinePayload`
        if (data['inlinePayload']) { // data not null
          InlinePayloadInfo.validateJSON(data['inlinePayload']);
        }
        // ensure the json data is a string
...
/**
 * @member {module:model/GCSPayloadInfo} gcsPayload
 */
ImportJob.prototype['gcsPayload'] = undefined;

/**
 * @member {module:model/InlinePayloadInfo} inlinePayload
 */
ImportJob.prototype['inlinePayload'] = undefined;
