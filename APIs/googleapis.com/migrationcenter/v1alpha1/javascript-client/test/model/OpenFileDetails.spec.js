...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MigrationCenterApi.OpenFileDetails();
  });
  ...
  describe('OpenFileDetails', function() {
    it('should create an instance of OpenFileDetails', function() {
      // uncomment below and update the code to test OpenFileDetails
      //var instance = new MigrationCenterApi.OpenFileDetails();
      //expect(instance).to.be.a(MigrationCenterApi.OpenFileDetails);
    });
