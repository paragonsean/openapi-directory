...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MigrationCenterApi.AggregationResult();
  });
  ...
  describe('AggregationResult', function() {
    it('should create an instance of AggregationResult', function() {
      // uncomment below and update the code to test AggregationResult
      //var instance = new MigrationCenterApi.AggregationResult();
      //expect(instance).to.be.a(MigrationCenterApi.AggregationResult);
    });
