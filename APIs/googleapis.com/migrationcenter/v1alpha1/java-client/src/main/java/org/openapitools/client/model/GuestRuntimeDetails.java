...
public class GuestRuntimeDetails {
  ...
  public static final String SERIALIZED_NAME_LAST_UPTIME = "lastUptime";
  @SerializedName(SERIALIZED_NAME_LAST_UPTIME)
  ...
  public GuestRuntimeDetails lastUptime(Date lastUptime) {
  ...
  public GuestRuntimeDetails networkInfo(RuntimeNetworkInfo networkInfo) {
  ...
  public void setNetworkInfo(RuntimeNetworkInfo networkInfo) {
    this.networkInfo = networkInfo;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.domain, guestRuntimeDetails.domain) &&
        ...
        Objects.equals(this.lastUptime, guestRuntimeDetails.lastUptime) &&
        Objects.equals(this.machineName, guestRuntimeDetails.machineName) &&
        Objects.equals(this.networkInfo, guestRuntimeDetails.networkInfo) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(domain, installedApps, lastUptime, machineName, networkInfo, openFileList, processes, services);
  }
  ...
  public String toString() {
    ...
    sb.append("    lastUptime: ").append(toIndentedString(lastUptime)).append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("lastUptime") != null && !jsonObj.get("lastUptime").isJsonNull()) {
        Date.validateJsonElement(jsonObj.get("lastUptime"));
      }
      ...
      if (jsonObj.get("networkInfo") != null && !jsonObj.get("networkInfo").isJsonNull()) {
        RuntimeNetworkInfo.validateJsonElement(jsonObj.get("networkInfo"));
      }
