...
QString OAIGuestRuntimeDetails::getLastBootTime() const {
    return m_last_boot_time;
}
void OAIGuestRuntimeDetails::setLastBootTime(const QString &last_boot_time) {
    m_last_boot_time = last_boot_time;
    m_last_boot_time_isSet = true;
}

bool OAIGuestRuntimeDetails::is_last_boot_time_Set() const{
    return m_last_boot_time_isSet;
}

bool OAIGuestRuntimeDetails::is_last_boot_time_Valid() const{
...
OAIRuntimeNetworkInfo OAIGuestRuntimeDetails::getNetwork() const {
    return m_network;
}
void OAIGuestRuntimeDetails::setNetwork(const OAIRuntimeNetworkInfo &network) {
    m_network = network;
    m_network_isSet = true;
}

bool OAIGuestRuntimeDetails::is_network_Set() const{
    return m_network_isSet;
}

bool OAIGuestRuntimeDetails::is_network_Valid() const{
