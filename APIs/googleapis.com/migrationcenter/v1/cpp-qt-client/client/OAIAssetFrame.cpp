...
OAIMachineDetails OAIAssetFrame::getMachineDetails() const {
    return m_machine_details;
}
void OAIAssetFrame::setMachineDetails(const OAIMachineDetails &machine_details) {
    m_machine_details = machine_details;
    m_machine_details_isSet = true;
}

bool OAIAssetFrame::is_machine_details_Set() const{
    return m_machine_details_isSet;
}

bool OAIAssetFrame::is_machine_details_Valid() const{
