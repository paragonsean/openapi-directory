...
class ReportSummaryAssetAggregateStats(Model):
    ...
    def __init__(self, core_count_histogram: ReportSummaryHistogramChartData=None, memory_bytes_histogram: ReportSummaryHistogramChartData=None, memory_utilization_chart: ReportSummaryUtilizationChartData=None, operating_system: ReportSummaryChartData=None, storage_bytes_histogram: ReportSummaryHistogramChartData=None, storage_utilization_chart: ReportSummaryUtilizationChartData=None, total_assets: str=None, total_cores: str=None, total_memory_bytes: str=None, total_storage_bytes: str=None):
