...
|**groupPreferencesetAssignments** | [**List&lt;ReportConfigGroupPreferenceSetAssignment&gt;**](ReportConfigGroupPreferenceSetAssignment.md) | Required. Collection of combinations of groups and preference sets. |  [optional] |
|**name** | **String** | Output only. Name of resource. |  [optional] [readonly] |
|**updateTime** | **String** | Output only. The timestamp when the resource was last updated. |  [optional] [readonly] |
