...
public class ReportSummaryComputeEngineFinding {
  ...
  public ReportSummaryComputeEngineFinding() {
  }

  public ReportSummaryComputeEngineFinding allocatedAssetCount(String allocatedAssetCount) {
  ...
  public ReportSummaryComputeEngineFinding allocatedDiskTypes(List<AllocatedDiskTypesEnum> allocatedDiskTypes) {
    this.allocatedDiskTypes = allocatedDiskTypes;
    return this;
  }

  public ReportSummaryComputeEngineFinding addAllocatedDiskTypesItem(AllocatedDiskTypesEnum allocatedDiskTypesItem) {
  ...
  public ReportSummaryComputeEngineFinding allocatedRegions(List<String> allocatedRegions) {
    this.allocatedRegions = allocatedRegions;
    return this;
  }

  public ReportSummaryComputeEngineFinding addAllocatedRegionsItem(String allocatedRegionsItem) {
  ...
  public ReportSummaryComputeEngineFinding machineSeriesAllocations(List<ReportSummaryMachineSeriesAllocation> machineSeriesAllocations) {
    this.machineSeriesAllocations = machineSeriesAllocations;
    return this;
  }

  public ReportSummaryComputeEngineFinding addMachineSeriesAllocationsItem(ReportSummaryMachineSeriesAllocation machineSeriesAllocationsItem) {
  ...
  public boolean equals(Object o) {
    ...
    ReportSummaryComputeEngineFinding reportSummaryComputeEngineFinding = (ReportSummaryComputeEngineFinding) o;
    return Objects.equals(this.allocatedAssetCount, reportSummaryComputeEngineFinding.allocatedAssetCount) &&
        Objects.equals(this.allocatedDiskTypes, reportSummaryComputeEngineFinding.allocatedDiskTypes) &&
        Objects.equals(this.allocatedRegions, reportSummaryComputeEngineFinding.allocatedRegions) &&
        Objects.equals(this.machineSeriesAllocations, reportSummaryComputeEngineFinding.machineSeriesAllocations);
  }
  ...
  public String toString() {
    ...
    sb.append("class ReportSummaryComputeEngineFinding {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReportSummaryComputeEngineFinding
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReportSummaryComputeEngineFinding.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReportSummaryComputeEngineFinding is not found in the empty JSON string", ReportSummaryComputeEngineFinding.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReportSummaryComputeEngineFinding.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReportSummaryComputeEngineFinding` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReportSummaryComputeEngineFinding.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReportSummaryComputeEngineFinding' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReportSummaryComputeEngineFinding> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReportSummaryComputeEngineFinding.class));

       return (TypeAdapter<T>) new TypeAdapter<ReportSummaryComputeEngineFinding>() {
           @Override
           public void write(JsonWriter out, ReportSummaryComputeEngineFinding value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReportSummaryComputeEngineFinding read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ReportSummaryComputeEngineFinding given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReportSummaryComputeEngineFinding
   * @throws IOException if the JSON string is invalid with respect to ReportSummaryComputeEngineFinding
   */
  public static ReportSummaryComputeEngineFinding fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReportSummaryComputeEngineFinding.class);
  }

  /**
   * Convert an instance of ReportSummaryComputeEngineFinding to an JSON string
   *
   * @return JSON string
   */
