...
public class GuestConfigDetails {
   ...
   */
  @JsonAdapter(SelinuxModeEnum.Adapter.class)
  public enum SelinuxModeEnum {
    ...
    public static SelinuxModeEnum fromValue(String value) {
      for (SelinuxModeEnum b : SelinuxModeEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<SelinuxModeEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final SelinuxModeEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public SelinuxModeEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return SelinuxModeEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      SelinuxModeEnum.fromValue(value);
    }
  }

  public static final String SERIALIZED_NAME_SELINUX_MODE = "selinuxMode";
  @SerializedName(SERIALIZED_NAME_SELINUX_MODE)
  ...
  public GuestConfigDetails selinuxMode(SelinuxModeEnum selinuxMode) {
   ...
   */
  @javax.annotation.Nullable
  public SelinuxModeEnum getSelinuxMode() {
    return selinuxMode;
  }

  public void setSelinuxMode(SelinuxModeEnum selinuxMode) {
    this.selinuxMode = selinuxMode;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.fstab, guestConfigDetails.fstab) &&
        ...
        Objects.equals(this.selinuxMode, guestConfigDetails.selinuxMode);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fstab, hosts, issue, nfsExports, selinuxMode);
  }
  ...
  public String toString() {
    ...
    sb.append("    selinuxMode: ").append(toIndentedString(selinuxMode)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("selinuxMode") != null && !jsonObj.get("selinuxMode").isJsonNull()) && !jsonObj.get("selinuxMode").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `selinuxMode` to be a primitive type in the JSON string but got `%s`", jsonObj.get("selinuxMode").toString()));
      }
      // validate the optional field `selinuxMode`
      if (jsonObj.get("selinuxMode") != null && !jsonObj.get("selinuxMode").isJsonNull()) {
        SelinuxModeEnum.validateJsonElement(jsonObj.get("selinuxMode"));
      }
  }
