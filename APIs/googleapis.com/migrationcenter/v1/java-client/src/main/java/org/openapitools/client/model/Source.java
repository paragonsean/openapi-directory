...
public class Source {
  ...
  public Source managed(Boolean managed) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(createTime, description, displayName, errorFrameCount, managed, name, pendingFrameCount, priority, state, type, updateTime);
  }
