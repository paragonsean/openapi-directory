...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MigrationCenterApi.GuestInstalledApplication();
  });
  ...
  describe('GuestInstalledApplication', function() {
    it('should create an instance of GuestInstalledApplication', function() {
      // uncomment below and update the code to test GuestInstalledApplication
      //var instance = new MigrationCenterApi.GuestInstalledApplication();
      //expect(instance).to.be.a(MigrationCenterApi.GuestInstalledApplication);
    });
