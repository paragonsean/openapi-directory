...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MigrationCenterApi.ListSourcesResponse();
  });
  ...
  describe('ListSourcesResponse', function() {
    it('should create an instance of ListSourcesResponse', function() {
      // uncomment below and update the code to test ListSourcesResponse
      //var instance = new MigrationCenterApi.ListSourcesResponse();
      //expect(instance).to.be.a(MigrationCenterApi.ListSourcesResponse);
    });
