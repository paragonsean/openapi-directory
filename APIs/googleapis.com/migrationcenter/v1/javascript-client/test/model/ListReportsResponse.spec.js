...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MigrationCenterApi.ListReportsResponse();
  });
  ...
  describe('ListReportsResponse', function() {
    it('should create an instance of ListReportsResponse', function() {
      ...
      //var instance = new MigrationCenterApi.ListReportsResponse();
      //expect(instance).to.be.a(MigrationCenterApi.ListReportsResponse);
    });
