...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MigrationCenterApi.ListLocationsResponse();
  });
  ...
  describe('ListLocationsResponse', function() {
    it('should create an instance of ListLocationsResponse', function() {
      ...
      //var instance = new MigrationCenterApi.ListLocationsResponse();
      //expect(instance).to.be.a(MigrationCenterApi.ListLocationsResponse);
    });
