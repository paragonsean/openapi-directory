...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MigrationCenterApi.ListOperationsResponse();
  });
  ...
  describe('ListOperationsResponse', function() {
    it('should create an instance of ListOperationsResponse', function() {
      ...
      //var instance = new MigrationCenterApi.ListOperationsResponse();
      //expect(instance).to.be.a(MigrationCenterApi.ListOperationsResponse);
    });
