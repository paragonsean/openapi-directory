...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MigrationCenterApi.ListGroupsResponse();
  });
  ...
  describe('ListGroupsResponse', function() {
    it('should create an instance of ListGroupsResponse', function() {
      ...
      //var instance = new MigrationCenterApi.ListGroupsResponse();
      //expect(instance).to.be.a(MigrationCenterApi.ListGroupsResponse);
    });
