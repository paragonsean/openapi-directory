...
public class Report {
  ...
  private List<ReportHeadersInner> headers = new ArrayList<>();

  public static final String SERIALIZED_NAME_KIND = "kind";
  @SerializedName(SERIALIZED_NAME_KIND)
  private String kind = "adsensehost#report";
  ...
  public Report averages(List<String> averages) {
    this.averages = averages;
    return this;
  }

  public Report addAveragesItem(String averagesItem) {
  ...
  public Report headers(List<ReportHeadersInner> headers) {
    this.headers = headers;
    return this;
  }

  public Report addHeadersItem(ReportHeadersInner headersItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<ReportHeadersInner> getHeaders() {
    return headers;
  }

  public void setHeaders(List<ReportHeadersInner> headers) {
    this.headers = headers;
  }
  ...
  public Report rows(List<List<String>> rows) {
    this.rows = rows;
    return this;
  }

  public Report addRowsItem(List<String> rowsItem) {
    if (this.rows == null) {
  ...
  public Report totalMatchedRows(String totalMatchedRows) {
  ...
  public Report totals(List<String> totals) {
    this.totals = totals;
    return this;
  }

  public Report addTotalsItem(String totalsItem) {
    if (this.totals == null) {
  ...
  public Report warnings(List<String> warnings) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.averages, report.averages) &&
        Objects.equals(this.headers, report.headers) &&
        Objects.equals(this.kind, report.kind) &&
        Objects.equals(this.rows, report.rows) &&
        Objects.equals(this.totalMatchedRows, report.totalMatchedRows) &&
        Objects.equals(this.totals, report.totals) &&
        Objects.equals(this.warnings, report.warnings);
  }

  @Override
  public int hashCode() {
    return Objects.hash(averages, headers, kind, rows, totalMatchedRows, totals, warnings);
  }
      ...
      if (jsonObj.get("headers") != null && !jsonObj.get("headers").isJsonNull()) {
        ...
        if (jsonArrayheaders != null) {
          ...
          for (int i = 0; i < jsonArrayheaders.size(); i++) {
            ReportHeadersInner.validateJsonElement(jsonArrayheaders.get(i));
          };
        }
      }
