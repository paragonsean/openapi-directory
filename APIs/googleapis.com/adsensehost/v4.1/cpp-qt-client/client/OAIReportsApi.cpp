...
void OAIReportsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("adsensehost_reports_generate", defaultConf);
    _serverIndices.insert("adsensehost_reports_generate", 0);
}
...
void OAIReportsApi::adsensehost_reports_generate(const QString &start_date, const QString &end_date, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &user_ip, const ::OpenAPI::OptionalParam<QList<QString>> &dimension, const ::OpenAPI::OptionalParam<QList<QString>> &filter, const ::OpenAPI::OptionalParam<QString> &locale, const ::OpenAPI::OptionalParam<qint32> &max_results, const ::OpenAPI::OptionalParam<QList<QString>> &metric, const ::OpenAPI::OptionalParam<QList<QString>> &sort, const ::OpenAPI::OptionalParam<qint32> &start_index) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIReportsApi::adsensehost_reports_generateCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIReportsApi::adsensehost_reports_generateCallback);
...
void OAIReportsApi::adsensehost_reports_generateCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT adsensehost_reports_generateSignal(output);
        Q_EMIT adsensehost_reports_generateSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT adsensehost_reports_generateSignalE(output, error_type, error_str);
        Q_EMIT adsensehost_reports_generateSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT adsensehost_reports_generateSignalError(output, error_type, error_str);
        Q_EMIT adsensehost_reports_generateSignalErrorFull(worker, error_type, error_str);
    }
}
