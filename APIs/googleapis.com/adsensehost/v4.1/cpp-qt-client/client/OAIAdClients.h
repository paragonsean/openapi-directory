...
#ifndef OAIAdClients_H
#define OAIAdClients_H
...
class OAIAdClients : public OAIObject {
public:
    OAIAdClients();
    OAIAdClients(QString json);
    ~OAIAdClients() override;
    ...
    QList<OAIAdClient> getItems() const;
    void setItems(const QList<OAIAdClient> &items);
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdClients)

#endif // OAIAdClients_H
