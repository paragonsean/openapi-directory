...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdSenseHostApi.AdUnits();
  });
  ...
  describe('AdUnits', function() {
    it('should create an instance of AdUnits', function() {
      // uncomment below and update the code to test AdUnits
      //var instance = new AdSenseHostApi.AdUnits();
      //expect(instance).to.be.a(AdSenseHostApi.AdUnits);
    });
