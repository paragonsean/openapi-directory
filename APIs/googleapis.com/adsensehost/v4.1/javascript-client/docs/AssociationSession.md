# AdSenseHostApi.AssociationSession
...
**kind** | **String** | Kind of resource this is, in this case adsensehost#associationSession. | [optional] [default to &#39;adsensehost#associationSession&#39;]
**productCodes** | **[String]** | The products to associate with the user. Options: AFC, AFG, AFV, AFS (deprecated), AFMC (deprecated) | [optional] 
