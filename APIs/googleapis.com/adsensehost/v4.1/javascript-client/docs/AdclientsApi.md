...
> AdClient adsensehostAdclientsGet(adClientId, opts)
...
let apiInstance = new AdSenseHostApi.AdclientsApi();
...
apiInstance.adsensehostAdclientsGet(adClientId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> AdClients adsensehostAdclientsList(opts)
...
apiInstance.adsensehostAdclientsList(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
