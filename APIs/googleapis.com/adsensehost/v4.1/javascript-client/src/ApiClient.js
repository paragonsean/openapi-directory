...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://www.googleapis.com/adsensehost/v4.1') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://www.googleapis.com/adsensehost/v4.1
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/v4.1/Javascript'
        };
  ...
  /**
    ...
    */
    hostSettings() {
        return [
            {
              'url': "https://www.googleapis.com/adsensehost/v4.1",
