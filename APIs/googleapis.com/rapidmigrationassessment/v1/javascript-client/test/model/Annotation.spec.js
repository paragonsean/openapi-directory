...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RapidMigrationAssessmentApi.Annotation();
  });
  ...
  describe('Annotation', function() {
    it('should create an instance of Annotation', function() {
      ...
      //var instance = new RapidMigrationAssessmentApi.Annotation();
      //expect(instance).to.be.a(RapidMigrationAssessmentApi.Annotation);
    });
