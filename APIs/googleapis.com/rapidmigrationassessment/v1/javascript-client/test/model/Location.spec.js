...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RapidMigrationAssessmentApi.Location();
  });
  ...
  describe('Location', function() {
    it('should create an instance of Location', function() {
      ...
      //var instance = new RapidMigrationAssessmentApi.Location();
      //expect(instance).to.be.a(RapidMigrationAssessmentApi.Location);
    });
