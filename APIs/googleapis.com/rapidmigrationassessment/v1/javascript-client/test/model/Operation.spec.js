...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RapidMigrationAssessmentApi.Operation();
  });
  ...
  describe('Operation', function() {
    it('should create an instance of Operation', function() {
      ...
      //var instance = new RapidMigrationAssessmentApi.Operation();
      //expect(instance).to.be.a(RapidMigrationAssessmentApi.Operation);
    });
