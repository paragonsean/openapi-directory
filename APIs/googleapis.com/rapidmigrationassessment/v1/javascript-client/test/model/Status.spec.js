...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RapidMigrationAssessmentApi.Status();
  });
  ...
  describe('Status', function() {
    it('should create an instance of Status', function() {
      ...
      //var instance = new RapidMigrationAssessmentApi.Status();
      //expect(instance).to.be.a(RapidMigrationAssessmentApi.Status);
    });
