...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RapidMigrationAssessmentApi.ListOperationsResponse();
  });
  ...
  describe('ListOperationsResponse', function() {
    it('should create an instance of ListOperationsResponse', function() {
      ...
      //var instance = new RapidMigrationAssessmentApi.ListOperationsResponse();
      //expect(instance).to.be.a(RapidMigrationAssessmentApi.ListOperationsResponse);
    });
