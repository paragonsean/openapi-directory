...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RapidMigrationAssessmentApi.ListLocationsResponse();
  });
  ...
  describe('ListLocationsResponse', function() {
    it('should create an instance of ListLocationsResponse', function() {
      ...
      //var instance = new RapidMigrationAssessmentApi.ListLocationsResponse();
      //expect(instance).to.be.a(RapidMigrationAssessmentApi.ListLocationsResponse);
    });
