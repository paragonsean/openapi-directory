...
class GoogleChecksReportV1alphaCheckDataTypeEvidence(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, data_type: str=None, data_type_evidence: GoogleChecksReportV1alphaDataTypeEvidence=None):
        """GoogleChecksReportV1alphaCheckDataTypeEvidence - a model defined in OpenAPI

        :param data_type: The data_type of this GoogleChecksReportV1alphaCheckDataTypeEvidence.
        :param data_type_evidence: The data_type_evidence of this GoogleChecksReportV1alphaCheckDataTypeEvidence.
        """
        self.openapi_types = {
            'data_type': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'GoogleChecksReportV1alphaCheckDataTypeEvidence':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The GoogleChecksReportV1alphaCheckDataTypeEvidence of this GoogleChecksReportV1alphaCheckDataTypeEvidence.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def data_type(self):
        """Gets the data_type of this GoogleChecksReportV1alphaCheckDataTypeEvidence.

        The data type that was found in your app.

        :return: The data_type of this GoogleChecksReportV1alphaCheckDataTypeEvidence.
        :rtype: str
        """
    ...
    def data_type(self, data_type):
        """Sets the data_type of this GoogleChecksReportV1alphaCheckDataTypeEvidence.
    ...
    def data_type_evidence(self):
        """Gets the data_type_evidence of this GoogleChecksReportV1alphaCheckDataTypeEvidence.


        :return: The data_type_evidence of this GoogleChecksReportV1alphaCheckDataTypeEvidence.
    ...
    def data_type_evidence(self, data_type_evidence):
        """Sets the data_type_evidence of this GoogleChecksReportV1alphaCheckDataTypeEvidence.
