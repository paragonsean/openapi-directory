...
class ScanRun(Model):
    ...
    def __init__(self, end_time: str=None, execution_state: str=None, has_vulnerabilities: bool=None, name: str=None, progress_percent: int=None, result_state: str=None, start_time: str=None, urls_crawled_count: str=None, urls_tested_count: str=None):
