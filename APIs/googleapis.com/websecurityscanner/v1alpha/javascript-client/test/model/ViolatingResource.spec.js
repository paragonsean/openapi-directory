...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebSecurityScannerApi.ViolatingResource();
  });
  ...
  describe('ViolatingResource', function() {
    it('should create an instance of ViolatingResource', function() {
      // uncomment below and update the code to test ViolatingResource
      //var instance = new WebSecurityScannerApi.ViolatingResource();
      //expect(instance).to.be.a(WebSecurityScannerApi.ViolatingResource);
    });
