...
public class Finding {
  ...
  public Finding findingType(FindingTypeEnum findingType) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(body, description, finalUrl, findingType, frameUrl, fuzzedUrl, httpMethod, name, outdatedLibrary, reproductionUrl, trackingId, violatingResource, vulnerableHeaders, vulnerableParameters, xss);
  }
