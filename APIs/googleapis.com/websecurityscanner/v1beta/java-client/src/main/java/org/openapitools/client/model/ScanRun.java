...
public class ScanRun {
  ...
  public static final String SERIALIZED_NAME_WARNING_TRACES = "warningTraces";
  @SerializedName(SERIALIZED_NAME_WARNING_TRACES)
  private List<ScanRunWarningTrace> warningTraces = new ArrayList<>();
  ...
  public ScanRun errorTrace(ScanRunErrorTrace errorTrace) {
  ...
  public void setErrorTrace(ScanRunErrorTrace errorTrace) {
    this.errorTrace = errorTrace;
  }
  ...
  public ScanRun warningTraces(List<ScanRunWarningTrace> warningTraces) {
    this.warningTraces = warningTraces;
    return this;
  }

  public ScanRun addWarningTracesItem(ScanRunWarningTrace warningTracesItem) {
    if (this.warningTraces == null) {
      this.warningTraces = new ArrayList<>();
    }
    this.warningTraces.add(warningTracesItem);
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public List<ScanRunWarningTrace> getWarningTraces() {
    return warningTraces;
  }

  public void setWarningTraces(List<ScanRunWarningTrace> warningTraces) {
    this.warningTraces = warningTraces;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.endTime, scanRun.endTime) &&
        Objects.equals(this.errorTrace, scanRun.errorTrace) &&
        ...
        Objects.equals(this.warningTraces, scanRun.warningTraces);
  }

  @Override
  public int hashCode() {
    return Objects.hash(endTime, errorTrace, executionState, hasVulnerabilities, name, progressPercent, resultState, startTime, urlsCrawledCount, urlsTestedCount, warningTraces);
  }
  ...
  public String toString() {
    ...
    sb.append("    warningTraces: ").append(toIndentedString(warningTraces)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("warningTraces");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("errorTrace") != null && !jsonObj.get("errorTrace").isJsonNull()) {
        ScanRunErrorTrace.validateJsonElement(jsonObj.get("errorTrace"));
      }
      ...
      if (jsonObj.get("warningTraces") != null && !jsonObj.get("warningTraces").isJsonNull()) {
        JsonArray jsonArraywarningTraces = jsonObj.getAsJsonArray("warningTraces");
        if (jsonArraywarningTraces != null) {
          // ensure the json data is an array
          if (!jsonObj.get("warningTraces").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `warningTraces` to be an array in the JSON string but got `%s`", jsonObj.get("warningTraces").toString()));
          }

          // validate the optional field `warningTraces` (array)
          for (int i = 0; i < jsonArraywarningTraces.size(); i++) {
            ScanRunWarningTrace.validateJsonElement(jsonArraywarningTraces.get(i));
          };
        }
      }
  }
