...
public class ScanConfig {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(authentication, blacklistPatterns, displayName, exportToSecurityCommandCenter, ignoreHttpStatusErrors, latestRun, managedScan, maxQps, name, riskLevel, schedule, startingUrls, staticIpScan, targetPlatforms, userAgent);
  }
