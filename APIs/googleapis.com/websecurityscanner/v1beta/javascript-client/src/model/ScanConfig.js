...
class ScanConfig {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('exportToSecurityCommandCenter')) {
                obj['exportToSecurityCommandCenter'] = ApiClient.convertToType(data['exportToSecurityCommandCenter'], 'String');
            }
            if (data.hasOwnProperty('ignoreHttpStatusErrors')) {
                obj['ignoreHttpStatusErrors'] = ApiClient.convertToType(data['ignoreHttpStatusErrors'], 'Boolean');
            }
            if (data.hasOwnProperty('latestRun')) {
                obj['latestRun'] = ScanRun.constructFromObject(data['latestRun']);
            }
            if (data.hasOwnProperty('managedScan')) {
                obj['managedScan'] = ApiClient.convertToType(data['managedScan'], 'Boolean');
            }
            ...
            if (data.hasOwnProperty('staticIpScan')) {
                obj['staticIpScan'] = ApiClient.convertToType(data['staticIpScan'], 'Boolean');
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['exportToSecurityCommandCenter'] && !(typeof data['exportToSecurityCommandCenter'] === 'string' || data['exportToSecurityCommandCenter'] instanceof String)) {
            throw new Error("Expected the field `exportToSecurityCommandCenter` to be a primitive type in the JSON string but got " + data['exportToSecurityCommandCenter']);
        }
 ...
 * @member {module:model/ScanConfig.ExportToSecurityCommandCenterEnum} exportToSecurityCommandCenter
 */
ScanConfig.prototype['exportToSecurityCommandCenter'] = undefined;

/**
 * Whether to keep scanning even if most requests return HTTP error codes.
 * @member {Boolean} ignoreHttpStatusErrors
 */
ScanConfig.prototype['ignoreHttpStatusErrors'] = undefined;
 ...
 */
ScanConfig.prototype['managedScan'] = undefined;
 ...
 * @member {module:model/ScanConfig.RiskLevelEnum} riskLevel
 */
ScanConfig.prototype['riskLevel'] = undefined;
 ...
 */
ScanConfig.prototype['staticIpScan'] = undefined;
...
/**
 * Allowed values for the <code>exportToSecurityCommandCenter</code> property.
 * @enum {String}
 * @readonly
 */
ScanConfig['ExportToSecurityCommandCenterEnum'] = {
