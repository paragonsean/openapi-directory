...
namespace OpenAPI {
class OAIScanRunErrorTrace;
class OAIScanRunWarningTrace;
...
public:
    ...
    OAIScanRunErrorTrace getErrorTrace() const;
    void setErrorTrace(const OAIScanRunErrorTrace &error_trace);
    bool is_error_trace_Set() const;
    bool is_error_trace_Valid() const;
    ...
    QList<OAIScanRunWarningTrace> getWarningTraces() const;
    void setWarningTraces(const QList<OAIScanRunWarningTrace> &warning_traces);
    bool is_warning_traces_Set() const;
    bool is_warning_traces_Valid() const;
...
private:
    ...
    OAIScanRunErrorTrace m_error_trace;
    bool m_error_trace_isSet;
    bool m_error_trace_isValid;
    ...
    QList<OAIScanRunWarningTrace> m_warning_traces;
    bool m_warning_traces_isSet;
    bool m_warning_traces_isValid;
};
