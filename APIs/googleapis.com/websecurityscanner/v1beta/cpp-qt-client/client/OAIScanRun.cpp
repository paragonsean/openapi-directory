...
void OAIScanRun::initializeModel() {
    ...
    m_error_trace_isSet = false;
    m_error_trace_isValid = false;
    ...
    m_warning_traces_isSet = false;
    m_warning_traces_isValid = false;
}
...
void OAIScanRun::fromJsonObject(QJsonObject json) {
    ...
    m_error_trace_isValid = ::OpenAPI::fromJsonValue(m_error_trace, json[QString("errorTrace")]);
    m_error_trace_isSet = !json[QString("errorTrace")].isNull() && m_error_trace_isValid;
    ...
    m_warning_traces_isValid = ::OpenAPI::fromJsonValue(m_warning_traces, json[QString("warningTraces")]);
    m_warning_traces_isSet = !json[QString("warningTraces")].isNull() && m_warning_traces_isValid;
}
...
QJsonObject OAIScanRun::asJsonObject() const {
    ...
    if (m_error_trace.isSet()) {
        obj.insert(QString("errorTrace"), ::OpenAPI::toJsonValue(m_error_trace));
    }
    ...
    if (m_warning_traces.size() > 0) {
        obj.insert(QString("warningTraces"), ::OpenAPI::toJsonValue(m_warning_traces));
    }
    return obj;
}
...
OAIScanRunErrorTrace OAIScanRun::getErrorTrace() const {
    return m_error_trace;
}
void OAIScanRun::setErrorTrace(const OAIScanRunErrorTrace &error_trace) {
    m_error_trace = error_trace;
    m_error_trace_isSet = true;
}

bool OAIScanRun::is_error_trace_Set() const{
    return m_error_trace_isSet;
}

bool OAIScanRun::is_error_trace_Valid() const{
    return m_error_trace_isValid;
}
...
QList<OAIScanRunWarningTrace> OAIScanRun::getWarningTraces() const {
    return m_warning_traces;
}
void OAIScanRun::setWarningTraces(const QList<OAIScanRunWarningTrace> &warning_traces) {
    m_warning_traces = warning_traces;
    m_warning_traces_isSet = true;
}

bool OAIScanRun::is_warning_traces_Set() const{
    return m_warning_traces_isSet;
}

bool OAIScanRun::is_warning_traces_Valid() const{
    return m_warning_traces_isValid;
}
