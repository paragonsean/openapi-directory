...
void OAIFinding::fromJsonObject(QJsonObject json) {
    ...
    m_xxe_isValid = ::OpenAPI::fromJsonValue(m_xxe, json[QString("xxe")]);
    m_xxe_isSet = !json[QString("xxe")].isNull() && m_xxe_isValid;
}
...
QJsonObject OAIFinding::asJsonObject() const {
    ...
    if (m_xxe.isSet()) {
        obj.insert(QString("xxe"), ::OpenAPI::toJsonValue(m_xxe));
    }
    return obj;
}
...
OAIForm OAIFinding::getForm() const {
    return m_form;
}
void OAIFinding::setForm(const OAIForm &form) {
    m_form = form;
    m_form_isSet = true;
}

bool OAIFinding::is_form_Set() const{
    return m_form_isSet;
}

bool OAIFinding::is_form_Valid() const{
...
QString OAIFinding::getSeverity() const {
    return m_severity;
}
void OAIFinding::setSeverity(const QString &severity) {
    m_severity = severity;
...
OAIXxe OAIFinding::getXxe() const {
    return m_xxe;
}
void OAIFinding::setXxe(const OAIXxe &xxe) {
    m_xxe = xxe;
    m_xxe_isSet = true;
}

bool OAIFinding::is_xxe_Set() const{
    return m_xxe_isSet;
}

bool OAIFinding::is_xxe_Valid() const{
    return m_xxe_isValid;
}
