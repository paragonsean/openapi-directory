...
async def test_websecurityscanner_projects_scan_configs_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/scanConfigs'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_websecurityscanner_projects_scan_configs_scan_runs_crawled_urls_list(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/{parent}/crawledUrls'.format(parent='parent_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_websecurityscanner_projects_scan_configs_scan_runs_finding_type_stats_list(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/{parent}/findingTypeStats'.format(parent='parent_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_websecurityscanner_projects_scan_configs_scan_runs_findings_list(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/{parent}/findings'.format(parent='parent_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_websecurityscanner_projects_scan_configs_scan_runs_list(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/{parent}/scanRuns'.format(parent='parent_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
