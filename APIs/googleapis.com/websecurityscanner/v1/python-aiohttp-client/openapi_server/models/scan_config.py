...
class ScanConfig(Model):
    ...
    def __init__(self, authentication: Authentication=None, blacklist_patterns: List[str]=None, display_name: str=None, export_to_security_command_center: str=None, ignore_http_status_errors: bool=None, managed_scan: bool=None, max_qps: int=None, name: str=None, risk_level: str=None, schedule: Schedule=None, starting_urls: List[str]=None, static_ip_scan: bool=None, user_agent: str=None):
