# ChromeManagementApi.GoogleChromeManagementV1AppDetails
...
**reviewRating** | **Number** | Output only. The rating of the app (on 5 stars). Chrome Web Store review information will always be for the latest version of an app. | [optional] [readonly] 
...
**type** | **String** | Output only. App type. | [optional] [readonly] 
...
* `APP_ITEM_TYPE_UNSPECIFIED` (value: `"APP_ITEM_TYPE_UNSPECIFIED"`)
