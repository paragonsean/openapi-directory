...
async def test_chromemanagement_customers_apps_count_chrome_app_requests(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/{customer}/apps:countChromeAppRequests'.format(customer='customer_example'),
        headers=headers,
        params=params,
        )
...
async def test_chromemanagement_customers_reports_count_chrome_browsers_needing_attention(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/{customer}/reports:countChromeBrowsersNeedingAttention'.format(customer='customer_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_chromemanagement_customers_reports_count_chrome_devices_reaching_auto_expiration_date(client):
    ...
    params = [('$.xgafv', 'xgafv_example'),
                    ...
                    ('upload_protocol', 'upload_protocol_example'),
                    ('uploadType', 'upload_type_example'),
                    ('maxAueDate', 'max_aue_date_example'),
                    ('minAueDate', 'min_aue_date_example'),
                    ('orgUnitId', 'org_unit_id_example')]
    headers = { 
        'Accept': 'application/json',
        'Authorization': 'Bearer special-key',
    ...
    response = await client.request(
        method='GET',
        path='/v1/{customer}/reports:countChromeDevicesReachingAutoExpirationDate'.format(customer='customer_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_chromemanagement_customers_reports_count_chrome_devices_that_need_attention(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/{customer}/reports:countChromeDevicesThatNeedAttention'.format(customer='customer_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_chromemanagement_customers_reports_count_chrome_hardware_fleet_devices(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/{customer}/reports:countChromeHardwareFleetDevices'.format(customer='customer_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_chromemanagement_customers_reports_count_chrome_versions(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/{customer}/reports:countChromeVersions'.format(customer='customer_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_chromemanagement_customers_reports_count_installed_apps(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/{customer}/reports:countInstalledApps'.format(customer='customer_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_chromemanagement_customers_reports_count_print_jobs_by_printer(client):
    ...
    params = [('$.xgafv', 'xgafv_example'),
                    ...
                    ('pageSize', 56),
                    ('pageToken', 'page_token_example'),
                    ('printerOrgUnitId', 'printer_org_unit_id_example')]
    headers = { 
        'Accept': 'application/json',
        'Authorization': 'Bearer special-key',
        'Authorization': 'Bearer special-key',
    ...
    response = await client.request(
        method='GET',
        path='/v1/{customer}/reports:countPrintJobsByPrinter'.format(customer='customer_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_chromemanagement_customers_reports_count_print_jobs_by_user(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/{customer}/reports:countPrintJobsByUser'.format(customer='customer_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_chromemanagement_customers_reports_enumerate_print_jobs(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/{customer}/reports:enumeratePrintJobs'.format(customer='customer_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_chromemanagement_customers_reports_find_installed_app_devices(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/{customer}/reports:findInstalledAppDevices'.format(customer='customer_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_chromemanagement_customers_telemetry_devices_list(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/{parent}/telemetry/devices'.format(parent='parent_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_chromemanagement_customers_telemetry_events_list(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/{parent}/telemetry/events'.format(parent='parent_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_chromemanagement_customers_telemetry_notification_configs_create(client):
    """Test case for chromemanagement_customers_telemetry_notification_configs_create

    
    """
    body = {"filter":{"userOrgUnitId":"userOrgUnitId","deviceOrgUnitId":"deviceOrgUnitId","telemetryEventNotificationFilter":{"eventTypes":["EVENT_TYPE_UNSPECIFIED","EVENT_TYPE_UNSPECIFIED"]},"userEmail":"userEmail","deviceId":"deviceId"},"googleCloudPubsubTopic":"googleCloudPubsubTopic","name":"name","customer":"customer"}
    params = [('$.xgafv', 'xgafv_example'),
                    ('access_token', 'access_token_example'),
                    ('alt', 'alt_example'),
                    ('callback', 'param_callback_example'),
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/telemetry/notificationConfigs'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_chromemanagement_customers_telemetry_notification_configs_delete(client):
...
async def test_chromemanagement_customers_telemetry_notification_configs_list(client):
...
async def test_chromemanagement_customers_telemetry_users_get(client):
...
async def test_chromemanagement_customers_telemetry_users_list(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/{parent}/telemetry/users'.format(parent='parent_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
