...
class CapacityCommitment(Model):
    ...
    def __init__(self, commitment_end_time: str=None, commitment_start_time: str=None, failure_status: Status=None, multi_region_auxiliary: bool=None, name: str=None, plan: str=None, renewal_plan: str=None, slot_count: str=None, state: str=None):
    ...
    def plan(self, plan):
        ...
        :type plan: str
        """
        allowed_values = ["COMMITMENT_PLAN_UNSPECIFIED", "FLEX", "TRIAL", "MONTHLY", "ANNUAL"]  # noqa: E501
