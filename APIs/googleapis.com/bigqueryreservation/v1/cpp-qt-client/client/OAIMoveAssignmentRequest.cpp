...
QString OAIMoveAssignmentRequest::getAssignmentId() const {
    return m_assignment_id;
}
void OAIMoveAssignmentRequest::setAssignmentId(const QString &assignment_id) {
    m_assignment_id = assignment_id;
    m_assignment_id_isSet = true;
}

bool OAIMoveAssignmentRequest::is_assignment_id_Set() const{
    return m_assignment_id_isSet;
}

bool OAIMoveAssignmentRequest::is_assignment_id_Valid() const{
