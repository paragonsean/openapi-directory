...
/*
 * OAISearchAllAssignmentsResponse.h
 *
 * The response for ReservationService.SearchAllAssignments.
 */

#ifndef OAISearchAllAssignmentsResponse_H
#define OAISearchAllAssignmentsResponse_H
...
class OAISearchAllAssignmentsResponse : public OAIObject {
public:
    OAISearchAllAssignmentsResponse();
    OAISearchAllAssignmentsResponse(QString json);
    ~OAISearchAllAssignmentsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISearchAllAssignmentsResponse)

#endif // OAISearchAllAssignmentsResponse_H
