...
public:
    ...
    */
    virtual void bigqueryreservation_projects_locations_searchAllAssignments(const QString &parent, const ::OpenAPI::OptionalParam<QString> &_xgafv = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &access_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &alt = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &callback = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &fields = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &key = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &oauth_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &pretty_print = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &quota_user = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &upload_protocol = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &upload_type = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &page_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &query = ::OpenAPI::OptionalParam<QString>());
...
private:
    ...
    void bigqueryreservation_projects_locations_searchAllAssignmentsCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void bigqueryreservation_projects_locations_searchAllAssignmentsSignal(OAISearchAllAssignmentsResponse summary);
    ...
    void bigqueryreservation_projects_locations_searchAllAssignmentsSignalFull(OAIHttpRequestWorker *worker, OAISearchAllAssignmentsResponse summary);
    ...
    Q_DECL_DEPRECATED_X("Use bigqueryreservation_projects_locations_searchAllAssignmentsSignalError() instead")
    void bigqueryreservation_projects_locations_searchAllAssignmentsSignalE(OAISearchAllAssignmentsResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void bigqueryreservation_projects_locations_searchAllAssignmentsSignalError(OAISearchAllAssignmentsResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use bigqueryreservation_projects_locations_searchAllAssignmentsSignalErrorFull() instead")
    void bigqueryreservation_projects_locations_searchAllAssignmentsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void bigqueryreservation_projects_locations_searchAllAssignmentsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
