...
OAIAutoscale OAIReservation::getAutoscale() const {
    return m_autoscale;
}
void OAIReservation::setAutoscale(const OAIAutoscale &autoscale) {
    m_autoscale = autoscale;
    m_autoscale_isSet = true;
}

bool OAIReservation::is_autoscale_Set() const{
    return m_autoscale_isSet;
}

bool OAIReservation::is_autoscale_Valid() const{
...
QString OAIReservation::getEdition() const {
    return m_edition;
}
void OAIReservation::setEdition(const QString &edition) {
    m_edition = edition;
    m_edition_isSet = true;
}

bool OAIReservation::is_edition_Set() const{
    return m_edition_isSet;
}

bool OAIReservation::is_edition_Valid() const{
