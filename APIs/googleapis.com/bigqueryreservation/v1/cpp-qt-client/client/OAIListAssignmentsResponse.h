...
/*
 * OAIListAssignmentsResponse.h
 *
 * The response for ReservationService.ListAssignments.
 */

#ifndef OAIListAssignmentsResponse_H
#define OAIListAssignmentsResponse_H
...
class OAIListAssignmentsResponse : public OAIObject {
public:
    OAIListAssignmentsResponse();
    OAIListAssignmentsResponse(QString json);
    ~OAIListAssignmentsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListAssignmentsResponse)

#endif // OAIListAssignmentsResponse_H
