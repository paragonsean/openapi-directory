...
class CapacityCommitment {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('isFlatRate')) {
                obj['isFlatRate'] = ApiClient.convertToType(data['isFlatRate'], 'Boolean');
            }
 ...
 * @member {module:model/CapacityCommitment.EditionEnum} edition
 */
CapacityCommitment.prototype['edition'] = undefined;
 ...
 * @member {Boolean} isFlatRate
 */
CapacityCommitment.prototype['isFlatRate'] = undefined;
 ...
 * @readonly
 */
CapacityCommitment['EditionEnum'] = {
