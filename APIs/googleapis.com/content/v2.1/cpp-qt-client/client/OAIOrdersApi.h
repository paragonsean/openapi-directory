...
public:
    ...
    * @param[in]  upload_protocol QString [optional]
    * @param[in]  upload_type QString [optional]
    * @param[in]  oai_orders_refund_item_request OAIOrdersRefundItemRequest [optional]
    */
    virtual void content_orders_refunditem(const QString &merchant_id, const QString &order_id, const ::OpenAPI::OptionalParam<QString> &_xgafv = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &access_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &alt = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &callback = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &fields = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &key = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &oauth_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &pretty_print = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &quota_user = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &upload_protocol = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &upload_type = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAIOrdersRefundItemRequest> &oai_orders_refund_item_request = ::OpenAPI::OptionalParam<OAIOrdersRefundItemRequest>());
    ...
    * @param[in]  upload_protocol QString [optional]
    * @param[in]  upload_type QString [optional]
    * @param[in]  oai_orders_refund_order_request OAIOrdersRefundOrderRequest [optional]
    */
    virtual void content_orders_refundorder(const QString &merchant_id, const QString &order_id, const ::OpenAPI::OptionalParam<QString> &_xgafv = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &access_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &alt = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &callback = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &fields = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &key = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &oauth_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &pretty_print = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &quota_user = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &upload_protocol = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &upload_type = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAIOrdersRefundOrderRequest> &oai_orders_refund_order_request = ::OpenAPI::OptionalParam<OAIOrdersRefundOrderRequest>());
...
private:
    ...
    void content_orders_captureOrderCallback(OAIHttpRequestWorker *worker);
    ...
    void content_orders_refunditemCallback(OAIHttpRequestWorker *worker);
    void content_orders_refundorderCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void content_orders_captureOrderSignal(OAICaptureOrderResponse summary);
    ...
    void content_orders_refunditemSignal(OAIOrdersRefundItemResponse summary);
    void content_orders_refundorderSignal(OAIOrdersRefundOrderResponse summary);
    ...
    void content_orders_captureOrderSignalFull(OAIHttpRequestWorker *worker, OAICaptureOrderResponse summary);
    ...
    void content_orders_refunditemSignalFull(OAIHttpRequestWorker *worker, OAIOrdersRefundItemResponse summary);
    void content_orders_refundorderSignalFull(OAIHttpRequestWorker *worker, OAIOrdersRefundOrderResponse summary);
    ...
    Q_DECL_DEPRECATED_X("Use content_orders_captureOrderSignalError() instead")
    void content_orders_captureOrderSignalE(OAICaptureOrderResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void content_orders_captureOrderSignalError(OAICaptureOrderResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use content_orders_refunditemSignalError() instead")
    void content_orders_refunditemSignalE(OAIOrdersRefundItemResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void content_orders_refunditemSignalError(OAIOrdersRefundItemResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use content_orders_refundorderSignalError() instead")
    void content_orders_refundorderSignalE(OAIOrdersRefundOrderResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void content_orders_refundorderSignalError(OAIOrdersRefundOrderResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use content_orders_captureOrderSignalErrorFull() instead")
    void content_orders_captureOrderSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void content_orders_captureOrderSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use content_orders_refunditemSignalErrorFull() instead")
    void content_orders_refunditemSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void content_orders_refunditemSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use content_orders_refundorderSignalErrorFull() instead")
    void content_orders_refundorderSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void content_orders_refundorderSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
