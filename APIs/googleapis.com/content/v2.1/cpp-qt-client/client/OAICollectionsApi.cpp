...
void OAICollectionsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("content_collections_create", defaultConf);
    _serverIndices.insert("content_collections_create", 0);
    _serverConfigs.insert("content_collections_delete", defaultConf);
    _serverIndices.insert("content_collections_delete", 0);
    _serverConfigs.insert("content_collections_get", defaultConf);
    _serverIndices.insert("content_collections_get", 0);
    _serverConfigs.insert("content_collections_list", defaultConf);
    _serverIndices.insert("content_collections_list", 0);
}
...
void OAICollectionsApi::content_collections_create(const QString &merchant_id, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<OAICollection> &oai_collection) {
    QString fullPath = QString(_serverConfigs["content_collections_create"][_serverIndices.value("content_collections_create")].URL()+"/{merchantId}/collections");
    ...
    if (oai_collection.hasValue()){

        
        QByteArray output = oai_collection.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICollectionsApi::content_collections_createCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICollectionsApi::content_collections_createCallback);
...
void OAICollectionsApi::content_collections_createCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT content_collections_createSignal(output);
        Q_EMIT content_collections_createSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT content_collections_createSignalE(output, error_type, error_str);
        Q_EMIT content_collections_createSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT content_collections_createSignalError(output, error_type, error_str);
        Q_EMIT content_collections_createSignalErrorFull(worker, error_type, error_str);
    }
}

void OAICollectionsApi::content_collections_delete(const QString &merchant_id, const QString &collection_id, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type) {
    QString fullPath = QString(_serverConfigs["content_collections_delete"][_serverIndices.value("content_collections_delete")].URL()+"/{merchantId}/collections/{collectionId}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICollectionsApi::content_collections_deleteCallback);
    connect(this, &OAICollectionsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICollectionsApi::content_collections_deleteCallback);
    connect(this, &OAICollectionsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAICollectionsApi::content_collections_deleteCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT content_collections_deleteSignal();
        Q_EMIT content_collections_deleteSignalFull(worker);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("https://www.googleapis.com/auth/content");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT content_collections_deleteSignalE(error_type, error_str);
        Q_EMIT content_collections_deleteSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT content_collections_deleteSignalError(error_type, error_str);
        Q_EMIT content_collections_deleteSignalErrorFull(worker, error_type, error_str);
    }
}

void OAICollectionsApi::content_collections_get(const QString &merchant_id, const QString &collection_id, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type) {
    QString fullPath = QString(_serverConfigs["content_collections_get"][_serverIndices.value("content_collections_get")].URL()+"/{merchantId}/collections/{collectionId}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICollectionsApi::content_collections_getCallback);
    connect(this, &OAICollectionsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICollectionsApi::content_collections_getCallback);
    connect(this, &OAICollectionsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAICollectionsApi::content_collections_getCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT content_collections_getSignal(output);
        Q_EMIT content_collections_getSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("https://www.googleapis.com/auth/content");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT content_collections_getSignalE(output, error_type, error_str);
        Q_EMIT content_collections_getSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT content_collections_getSignalError(output, error_type, error_str);
        Q_EMIT content_collections_getSignalErrorFull(worker, error_type, error_str);
    }
}

void OAICollectionsApi::content_collections_list(const QString &merchant_id, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &page_token) {
    QString fullPath = QString(_serverConfigs["content_collections_list"][_serverIndices.value("content_collections_list")].URL()+"/{merchantId}/collections");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICollectionsApi::content_collections_listCallback);
    connect(this, &OAICollectionsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICollectionsApi::content_collections_listCallback);
    connect(this, &OAICollectionsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAICollectionsApi::content_collections_listCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT content_collections_listSignal(output);
        Q_EMIT content_collections_listSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("https://www.googleapis.com/auth/content");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT content_collections_listSignalE(output, error_type, error_str);
        Q_EMIT content_collections_listSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT content_collections_listSignalError(output, error_type, error_str);
        Q_EMIT content_collections_listSignalErrorFull(worker, error_type, error_str);
    }
}
