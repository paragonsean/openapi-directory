...
void OAIQuotasApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("content_quotas_list", defaultConf);
    _serverIndices.insert("content_quotas_list", 0);
}
...
void OAIQuotasApi::content_quotas_list(const QString &merchant_id, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &page_token) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIQuotasApi::content_quotas_listCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIQuotasApi::content_quotas_listCallback);
...
void OAIQuotasApi::content_quotas_listCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIListMethodQuotasResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT content_quotas_listSignal(output);
        Q_EMIT content_quotas_listSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT content_quotas_listSignalE(output, error_type, error_str);
        Q_EMIT content_quotas_listSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT content_quotas_listSignalError(output, error_type, error_str);
        Q_EMIT content_quotas_listSignalErrorFull(worker, error_type, error_str);
    }
}
