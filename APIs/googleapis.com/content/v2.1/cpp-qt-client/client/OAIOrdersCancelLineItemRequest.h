...
/*
 * OAIOrdersCancelLineItemRequest.h
 *
 * 
 */

#ifndef OAIOrdersCancelLineItemRequest_H
#define OAIOrdersCancelLineItemRequest_H
...
class OAIOrdersCancelLineItemRequest : public OAIObject {
public:
    OAIOrdersCancelLineItemRequest();
    OAIOrdersCancelLineItemRequest(QString json);
    ~OAIOrdersCancelLineItemRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrdersCancelLineItemRequest)

#endif // OAIOrdersCancelLineItemRequest_H
