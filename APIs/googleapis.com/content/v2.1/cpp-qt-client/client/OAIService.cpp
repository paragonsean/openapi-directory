...
void OAIService::initializeModel() {
    ...
    m_store_config_isSet = false;
    m_store_config_isValid = false;
}
...
void OAIService::fromJsonObject(QJsonObject json) {
    ...
    m_store_config_isValid = ::OpenAPI::fromJsonValue(m_store_config, json[QString("storeConfig")]);
    m_store_config_isSet = !json[QString("storeConfig")].isNull() && m_store_config_isValid;
}
...
QJsonObject OAIService::asJsonObject() const {
    ...
    if (m_store_config.isSet()) {
        obj.insert(QString("storeConfig"), ::OpenAPI::toJsonValue(m_store_config));
    }
    return obj;
}
...
OAIServiceStoreConfig OAIService::getStoreConfig() const {
    return m_store_config;
}
void OAIService::setStoreConfig(const OAIServiceStoreConfig &store_config) {
    m_store_config = store_config;
    m_store_config_isSet = true;
}

bool OAIService::is_store_config_Set() const{
    return m_store_config_isSet;
}

bool OAIService::is_store_config_Valid() const{
    return m_store_config_isValid;
}
