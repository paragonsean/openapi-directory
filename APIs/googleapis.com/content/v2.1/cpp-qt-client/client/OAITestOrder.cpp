...
void OAITestOrder::initializeModel() {
    ...
    m_predefined_email_isSet = false;
    m_predefined_email_isValid = false;
...
void OAITestOrder::fromJsonObject(QJsonObject json) {
    ...
    m_predefined_email_isValid = ::OpenAPI::fromJsonValue(m_predefined_email, json[QString("predefinedEmail")]);
    m_predefined_email_isSet = !json[QString("predefinedEmail")].isNull() && m_predefined_email_isValid;
...
QJsonObject OAITestOrder::asJsonObject() const {
    ...
    if (m_predefined_email_isSet) {
        obj.insert(QString("predefinedEmail"), ::OpenAPI::toJsonValue(m_predefined_email));
    }
...
OAITestOrderDeliveryDetails OAITestOrder::getDeliveryDetails() const {
    return m_delivery_details;
}
void OAITestOrder::setDeliveryDetails(const OAITestOrderDeliveryDetails &delivery_details) {
    m_delivery_details = delivery_details;
    m_delivery_details_isSet = true;
}

bool OAITestOrder::is_delivery_details_Set() const{
    return m_delivery_details_isSet;
}

bool OAITestOrder::is_delivery_details_Valid() const{
...
OAITestOrderPickupDetails OAITestOrder::getPickupDetails() const {
    return m_pickup_details;
}
void OAITestOrder::setPickupDetails(const OAITestOrderPickupDetails &pickup_details) {
    m_pickup_details = pickup_details;
    m_pickup_details_isSet = true;
}

bool OAITestOrder::is_pickup_details_Set() const{
    return m_pickup_details_isSet;
}

bool OAITestOrder::is_pickup_details_Valid() const{
    return m_pickup_details_isValid;
}

QString OAITestOrder::getPredefinedBillingAddress() const {
    return m_predefined_billing_address;
}
void OAITestOrder::setPredefinedBillingAddress(const QString &predefined_billing_address) {
    m_predefined_billing_address = predefined_billing_address;
    m_predefined_billing_address_isSet = true;
}

bool OAITestOrder::is_predefined_billing_address_Set() const{
    return m_predefined_billing_address_isSet;
}

bool OAITestOrder::is_predefined_billing_address_Valid() const{
...
QString OAITestOrder::getPredefinedEmail() const {
    return m_predefined_email;
}
void OAITestOrder::setPredefinedEmail(const QString &predefined_email) {
    m_predefined_email = predefined_email;
    m_predefined_email_isSet = true;
}

bool OAITestOrder::is_predefined_email_Set() const{
    return m_predefined_email_isSet;
}

bool OAITestOrder::is_predefined_email_Valid() const{
    return m_predefined_email_isValid;
}
...
QList<OAIOrderPromotion> OAITestOrder::getPromotions() const {
    return m_promotions;
}
void OAITestOrder::setPromotions(const QList<OAIOrderPromotion> &promotions) {
