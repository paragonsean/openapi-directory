...
/*
 * OAIOrderPromotionItem.h
 *
 * 
 */

#ifndef OAIOrderPromotionItem_H
#define OAIOrderPromotionItem_H
...
class OAIOrderPromotionItem : public OAIObject {
public:
    OAIOrderPromotionItem();
    OAIOrderPromotionItem(QString json);
    ~OAIOrderPromotionItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrderPromotionItem)

#endif // OAIOrderPromotionItem_H
