...
void OAIReportsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("content_reports_search", defaultConf);
    _serverIndices.insert("content_reports_search", 0);
}
...
void OAIReportsApi::content_reports_search(const QString &merchant_id, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<OAISearchRequest> &oai_search_request) {
    QString fullPath = QString(_serverConfigs["content_reports_search"][_serverIndices.value("content_reports_search")].URL()+"/{merchantId}/reports/search");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIReportsApi::content_reports_searchCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIReportsApi::content_reports_searchCallback);
...
void OAIReportsApi::content_reports_searchCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT content_reports_searchSignal(output);
        Q_EMIT content_reports_searchSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT content_reports_searchSignalE(output, error_type, error_str);
        Q_EMIT content_reports_searchSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT content_reports_searchSignalError(output, error_type, error_str);
        Q_EMIT content_reports_searchSignalErrorFull(worker, error_type, error_str);
    }
}
