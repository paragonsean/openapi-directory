...
/*
 * OAITestOrderAddress.h
 *
 * 
 */

#ifndef OAITestOrderAddress_H
#define OAITestOrderAddress_H
...
class OAITestOrderAddress : public OAIObject {
public:
    OAITestOrderAddress();
    OAITestOrderAddress(QString json);
    ~OAITestOrderAddress() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITestOrderAddress)

#endif // OAITestOrderAddress_H
