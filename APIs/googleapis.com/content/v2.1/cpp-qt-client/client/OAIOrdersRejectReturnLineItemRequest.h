...
/*
 * OAIOrdersRejectReturnLineItemRequest.h
 *
 * 
 */

#ifndef OAIOrdersRejectReturnLineItemRequest_H
#define OAIOrdersRejectReturnLineItemRequest_H
...
class OAIOrdersRejectReturnLineItemRequest : public OAIObject {
public:
    OAIOrdersRejectReturnLineItemRequest();
    OAIOrdersRejectReturnLineItemRequest(QString json);
    ~OAIOrdersRejectReturnLineItemRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrdersRejectReturnLineItemRequest)

#endif // OAIOrdersRejectReturnLineItemRequest_H
