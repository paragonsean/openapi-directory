...
void OAIPosStore::initializeModel() {
    ...
    m_matching_status_isSet = false;
    m_matching_status_isValid = false;

    m_matching_status_hint_isSet = false;
    m_matching_status_hint_isValid = false;
...
void OAIPosStore::fromJsonObject(QJsonObject json) {
    ...
    m_matching_status_isValid = ::OpenAPI::fromJsonValue(m_matching_status, json[QString("matchingStatus")]);
    m_matching_status_isSet = !json[QString("matchingStatus")].isNull() && m_matching_status_isValid;

    m_matching_status_hint_isValid = ::OpenAPI::fromJsonValue(m_matching_status_hint, json[QString("matchingStatusHint")]);
    m_matching_status_hint_isSet = !json[QString("matchingStatusHint")].isNull() && m_matching_status_hint_isValid;
...
QJsonObject OAIPosStore::asJsonObject() const {
    ...
    if (m_matching_status_isSet) {
        obj.insert(QString("matchingStatus"), ::OpenAPI::toJsonValue(m_matching_status));
    }
    if (m_matching_status_hint_isSet) {
        obj.insert(QString("matchingStatusHint"), ::OpenAPI::toJsonValue(m_matching_status_hint));
    }
...
QString OAIPosStore::getMatchingStatus() const {
    return m_matching_status;
}
void OAIPosStore::setMatchingStatus(const QString &matching_status) {
    m_matching_status = matching_status;
    m_matching_status_isSet = true;
}

bool OAIPosStore::is_matching_status_Set() const{
    return m_matching_status_isSet;
}

bool OAIPosStore::is_matching_status_Valid() const{
    return m_matching_status_isValid;
}

QString OAIPosStore::getMatchingStatusHint() const {
    return m_matching_status_hint;
}
void OAIPosStore::setMatchingStatusHint(const QString &matching_status_hint) {
    m_matching_status_hint = matching_status_hint;
    m_matching_status_hint_isSet = true;
}

bool OAIPosStore::is_matching_status_hint_Set() const{
    return m_matching_status_hint_isSet;
}

bool OAIPosStore::is_matching_status_hint_Valid() const{
    return m_matching_status_hint_isValid;
}
