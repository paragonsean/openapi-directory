...
/*
 * OAIOrderShipmentLineItemShipment.h
 *
 * 
 */

#ifndef OAIOrderShipmentLineItemShipment_H
#define OAIOrderShipmentLineItemShipment_H
...
class OAIOrderShipmentLineItemShipment : public OAIObject {
public:
    OAIOrderShipmentLineItemShipment();
    OAIOrderShipmentLineItemShipment(QString json);
    ~OAIOrderShipmentLineItemShipment() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrderShipmentLineItemShipment)

#endif // OAIOrderShipmentLineItemShipment_H
