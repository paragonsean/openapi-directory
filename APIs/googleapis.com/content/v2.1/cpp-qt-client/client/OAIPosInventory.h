...
#ifndef OAIPosInventory_H
#define OAIPosInventory_H
...
class OAIPosInventory : public OAIObject {
public:
    OAIPosInventory();
    OAIPosInventory(QString json);
    ~OAIPosInventory() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPosInventory)

#endif // OAIPosInventory_H
