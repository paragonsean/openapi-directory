...
QString OAIOrderShipment::getShipmentGroupId() const {
    return m_shipment_group_id;
}
void OAIOrderShipment::setShipmentGroupId(const QString &shipment_group_id) {
    m_shipment_group_id = shipment_group_id;
    m_shipment_group_id_isSet = true;
}

bool OAIOrderShipment::is_shipment_group_id_Set() const{
    return m_shipment_group_id_isSet;
}

bool OAIOrderShipment::is_shipment_group_id_Valid() const{
