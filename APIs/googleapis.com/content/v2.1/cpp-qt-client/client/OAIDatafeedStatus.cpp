...
QString OAIDatafeedStatus::getFeedLabel() const {
    return m_feed_label;
}
void OAIDatafeedStatus::setFeedLabel(const QString &feed_label) {
    m_feed_label = feed_label;
    m_feed_label_isSet = true;
}

bool OAIDatafeedStatus::is_feed_label_Set() const{
    return m_feed_label_isSet;
}

bool OAIDatafeedStatus::is_feed_label_Valid() const{
