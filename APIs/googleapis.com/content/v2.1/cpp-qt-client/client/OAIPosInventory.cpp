...
QString OAIPosInventory::getPickupMethod() const {
    return m_pickup_method;
}
void OAIPosInventory::setPickupMethod(const QString &pickup_method) {
    m_pickup_method = pickup_method;
    m_pickup_method_isSet = true;
}

bool OAIPosInventory::is_pickup_method_Set() const{
    return m_pickup_method_isSet;
}

bool OAIPosInventory::is_pickup_method_Valid() const{
    return m_pickup_method_isValid;
}

QString OAIPosInventory::getPickupSla() const {
    return m_pickup_sla;
}
void OAIPosInventory::setPickupSla(const QString &pickup_sla) {
    m_pickup_sla = pickup_sla;
    m_pickup_sla_isSet = true;
}

bool OAIPosInventory::is_pickup_sla_Set() const{
    return m_pickup_sla_isSet;
}

bool OAIPosInventory::is_pickup_sla_Valid() const{
