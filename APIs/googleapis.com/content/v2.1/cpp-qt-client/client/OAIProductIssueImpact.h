...
/*
 * OAIProductIssueImpact.h
 *
 * Overall impact of product issue.
 */

#ifndef OAIProductIssueImpact_H
#define OAIProductIssueImpact_H
...
class OAIProductIssueImpact : public OAIObject {
public:
    OAIProductIssueImpact();
    OAIProductIssueImpact(QString json);
    ~OAIProductIssueImpact() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProductIssueImpact)

#endif // OAIProductIssueImpact_H
