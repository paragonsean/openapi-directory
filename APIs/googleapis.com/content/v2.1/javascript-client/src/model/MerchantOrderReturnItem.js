...
class MerchantOrderReturnItem {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('merchantRejectionReason')) {
                obj['merchantRejectionReason'] = MerchantRejectionReason.constructFromObject(data['merchantRejectionReason']);
            }
            ...
            if (data.hasOwnProperty('refundableAmount')) {
                obj['refundableAmount'] = MonetaryAmount.constructFromObject(data['refundableAmount']);
            }
            ...
            if (data.hasOwnProperty('shipmentUnitId')) {
                obj['shipmentUnitId'] = ApiClient.convertToType(data['shipmentUnitId'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        if (data['merchantRejectionReason']) { // data not null
          MerchantRejectionReason.validateJSON(data['merchantRejectionReason']);
        }
        ...
        if (data['refundableAmount']) { // data not null
          MonetaryAmount.validateJSON(data['refundableAmount']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['shipmentUnitId'] && !(typeof data['shipmentUnitId'] === 'string' || data['shipmentUnitId'] instanceof String)) {
            throw new Error("Expected the field `shipmentUnitId` to be a primitive type in the JSON string but got " + data['shipmentUnitId']);
        }
        // ensure the json data is a string
...
/**
 * @member {module:model/MerchantRejectionReason} merchantRejectionReason
 */
MerchantOrderReturnItem.prototype['merchantRejectionReason'] = undefined;
...
/**
 * @member {module:model/MonetaryAmount} refundableAmount
 */
MerchantOrderReturnItem.prototype['refundableAmount'] = undefined;

/**
 * Unit level ID for the return item. Different units of the same product will have different IDs.
 * @member {String} returnItemId
 */
MerchantOrderReturnItem.prototype['returnItemId'] = undefined;
 ...
 */
MerchantOrderReturnItem.prototype['shipmentGroupId'] = undefined;

/**
 * ID of the shipment unit assigned by the merchant. Provided for shipments with invoice support.
 * @member {String} shipmentUnitId
 */
MerchantOrderReturnItem.prototype['shipmentUnitId'] = undefined;
