...
/**
 * The PosSaleRequest model module.
 * @module model/PosSaleRequest
 * @version v2.1
 */
class PosSaleRequest {
    /**
     * Constructs a new <code>PosSaleRequest</code>.
     * @alias module:model/PosSaleRequest
     */
    constructor() { 
        
        PosSaleRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PosSaleRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PosSaleRequest} obj Optional instance to populate.
     * @return {module:model/PosSaleRequest} The populated <code>PosSaleRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PosSaleRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>PosSaleRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PosSaleRequest</code>.
     */
 ...
 */
PosSaleRequest.prototype['contentLanguage'] = undefined;

/**
 * Global Trade Item Number.
 * @member {String} gtin
 */
PosSaleRequest.prototype['gtin'] = undefined;

/**
 * Required. A unique identifier for the item.
 * @member {String} itemId
 */
PosSaleRequest.prototype['itemId'] = undefined;

/**
 * @member {module:model/Price} price
 */
PosSaleRequest.prototype['price'] = undefined;

/**
 * Required. The relative change of the available quantity. Negative for items returned.
 * @member {String} quantity
 */
PosSaleRequest.prototype['quantity'] = undefined;

/**
 * A unique ID to group items from the same sale event.
 * @member {String} saleId
 */
PosSaleRequest.prototype['saleId'] = undefined;
 ...
 */
PosSaleRequest.prototype['storeCode'] = undefined;

/**
 * Required. The CLDR territory code for the item.
 * @member {String} targetCountry
 */
PosSaleRequest.prototype['targetCountry'] = undefined;

/**
 * Required. The inventory timestamp, in ISO 8601 format.
 * @member {String} timestamp
 */
PosSaleRequest.prototype['timestamp'] = undefined;
