...
/**
 * The ReturnAddressAddress model module.
 * @module model/ReturnAddressAddress
 * @version v2.1
 */
class ReturnAddressAddress {
    /**
     * Constructs a new <code>ReturnAddressAddress</code>.
     * @alias module:model/ReturnAddressAddress
     */
    constructor() { 
        
        ReturnAddressAddress.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ReturnAddressAddress</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ReturnAddressAddress} obj Optional instance to populate.
     * @return {module:model/ReturnAddressAddress} The populated <code>ReturnAddressAddress</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ReturnAddressAddress();
    ...
    /**
     * Validates the JSON data with respect to <code>ReturnAddressAddress</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ReturnAddressAddress</code>.
     */
 ...
 */
ReturnAddressAddress.prototype['country'] = undefined;

/**
 * City, town or commune. May also include dependent localities or sublocalities (for example, neighborhoods or suburbs).
 * @member {String} locality
 */
ReturnAddressAddress.prototype['locality'] = undefined;

/**
 * Postal code or ZIP (for example, \"94043\").
 * @member {String} postalCode
 */
ReturnAddressAddress.prototype['postalCode'] = undefined;

/**
 * Name of the recipient to address returns to.
 * @member {String} recipientName
 */
ReturnAddressAddress.prototype['recipientName'] = undefined;

/**
 * Top-level administrative subdivision of the country. For example, a state like California (\"CA\") or a province like Quebec (\"QC\").
 * @member {String} region
 */
ReturnAddressAddress.prototype['region'] = undefined;
 ...
 */
ReturnAddressAddress.prototype['streetAddress'] = undefined;
...
export default ReturnAddressAddress;
