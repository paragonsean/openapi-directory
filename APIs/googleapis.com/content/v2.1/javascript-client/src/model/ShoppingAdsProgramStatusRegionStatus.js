...
/**
 * The ShoppingAdsProgramStatusRegionStatus model module.
 * @module model/ShoppingAdsProgramStatusRegionStatus
 * @version v2.1
 */
class ShoppingAdsProgramStatusRegionStatus {
    /**
     * Constructs a new <code>ShoppingAdsProgramStatusRegionStatus</code>.
     * Status of program and region.
     * @alias module:model/ShoppingAdsProgramStatusRegionStatus
     */
    constructor() { 
        
        ShoppingAdsProgramStatusRegionStatus.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ShoppingAdsProgramStatusRegionStatus</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ShoppingAdsProgramStatusRegionStatus} obj Optional instance to populate.
     * @return {module:model/ShoppingAdsProgramStatusRegionStatus} The populated <code>ShoppingAdsProgramStatusRegionStatus</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ShoppingAdsProgramStatusRegionStatus();
            ...
            if (data.hasOwnProperty('reviewIneligibilityReasonDetails')) {
                obj['reviewIneligibilityReasonDetails'] = ShoppingAdsProgramStatusReviewIneligibilityReasonDetails.constructFromObject(data['reviewIneligibilityReasonDetails']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ShoppingAdsProgramStatusRegionStatus</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ShoppingAdsProgramStatusRegionStatus</code>.
     */
    static validateJSON(data) {
        ...
        if (data['reviewIneligibilityReasonDetails']) { // data not null
          ShoppingAdsProgramStatusReviewIneligibilityReasonDetails.validateJSON(data['reviewIneligibilityReasonDetails']);
        }
        // ensure the json data is an array
 ...
 */
ShoppingAdsProgramStatusRegionStatus.prototype['disapprovalDate'] = undefined;

/**
 * Eligibility status of the Shopping Ads program.
 * @member {module:model/ShoppingAdsProgramStatusRegionStatus.EligibilityStatusEnum} eligibilityStatus
 */
ShoppingAdsProgramStatusRegionStatus.prototype['eligibilityStatus'] = undefined;

/**
 * Issues that must be fixed to be eligible for review.
 * @member {Array.<String>} onboardingIssues
 */
ShoppingAdsProgramStatusRegionStatus.prototype['onboardingIssues'] = undefined;
 ...
 */
ShoppingAdsProgramStatusRegionStatus.prototype['regionCodes'] = undefined;

/**
 * If a program is eligible for review in a specific region. Only visible if `eligibilityStatus` is `DISAPPROVED`.
 * @member {module:model/ShoppingAdsProgramStatusRegionStatus.ReviewEligibilityStatusEnum} reviewEligibilityStatus
 */
ShoppingAdsProgramStatusRegionStatus.prototype['reviewEligibilityStatus'] = undefined;

/**
 * Review ineligibility reason if account is not eligible for review.
 * @member {module:model/ShoppingAdsProgramStatusRegionStatus.ReviewIneligibilityReasonEnum} reviewIneligibilityReason
 */
ShoppingAdsProgramStatusRegionStatus.prototype['reviewIneligibilityReason'] = undefined;
 ...
 */
ShoppingAdsProgramStatusRegionStatus.prototype['reviewIneligibilityReasonDescription'] = undefined;

/**
 * @member {module:model/ShoppingAdsProgramStatusReviewIneligibilityReasonDetails} reviewIneligibilityReasonDetails
 */
ShoppingAdsProgramStatusRegionStatus.prototype['reviewIneligibilityReasonDetails'] = undefined;

/**
 * Issues evaluated in the review process. Fix all issues before requesting a review.
 * @member {Array.<String>} reviewIssues
 */
ShoppingAdsProgramStatusRegionStatus.prototype['reviewIssues'] = undefined;
 ...
 * @readonly
 */
ShoppingAdsProgramStatusRegionStatus['EligibilityStatusEnum'] = {
 ...
 * @readonly
 */
ShoppingAdsProgramStatusRegionStatus['ReviewEligibilityStatusEnum'] = {
 ...
 * @readonly
 */
ShoppingAdsProgramStatusRegionStatus['ReviewIneligibilityReasonEnum'] = {
...
export default ShoppingAdsProgramStatusRegionStatus;
