...
import AccountIssueImpact from './AccountIssueImpact';
import Action from './Action';

/**
 * The AccountIssue model module.
 * @module model/AccountIssue
 * @version v2.1
 */
class AccountIssue {
    /**
     * Constructs a new <code>AccountIssue</code>.
     * An issue affecting specific merchant.
     * @alias module:model/AccountIssue
     */
    constructor() { 
        
        AccountIssue.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AccountIssue</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AccountIssue} obj Optional instance to populate.
     * @return {module:model/AccountIssue} The populated <code>AccountIssue</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AccountIssue();

            if (data.hasOwnProperty('actions')) {
                obj['actions'] = ApiClient.convertToType(data['actions'], [Action]);
            }
            if (data.hasOwnProperty('impact')) {
                obj['impact'] = AccountIssueImpact.constructFromObject(data['impact']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>AccountIssue</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AccountIssue</code>.
     */
    static validateJSON(data) {
        ...
        if (data['impact']) { // data not null
          AccountIssueImpact.validateJSON(data['impact']);
        }
 ...
 */
AccountIssue.prototype['actions'] = undefined;

/**
 * @member {module:model/AccountIssueImpact} impact
 */
AccountIssue.prototype['impact'] = undefined;
 ...
 */
AccountIssue.prototype['prerenderedContent'] = undefined;

/**
 * Title of the issue.
 * @member {String} title
 */
AccountIssue.prototype['title'] = undefined;
