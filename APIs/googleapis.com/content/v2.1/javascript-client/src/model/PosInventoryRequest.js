...
/**
 * The PosInventoryRequest model module.
 * @module model/PosInventoryRequest
 * @version v2.1
 */
class PosInventoryRequest {
    /**
     * Constructs a new <code>PosInventoryRequest</code>.
     * @alias module:model/PosInventoryRequest
     */
    constructor() { 
        
        PosInventoryRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PosInventoryRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PosInventoryRequest} obj Optional instance to populate.
     * @return {module:model/PosInventoryRequest} The populated <code>PosInventoryRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PosInventoryRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>PosInventoryRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PosInventoryRequest</code>.
     */
 ...
 */
PosInventoryRequest.prototype['contentLanguage'] = undefined;

/**
 * Global Trade Item Number.
 * @member {String} gtin
 */
PosInventoryRequest.prototype['gtin'] = undefined;

/**
 * Required. A unique identifier for the item.
 * @member {String} itemId
 */
PosInventoryRequest.prototype['itemId'] = undefined;
 ...
 */
PosInventoryRequest.prototype['pickupMethod'] = undefined;
 ...
 */
PosInventoryRequest.prototype['pickupSla'] = undefined;

/**
 * @member {module:model/Price} price
 */
PosInventoryRequest.prototype['price'] = undefined;

/**
 * Required. The available quantity of the item.
 * @member {String} quantity
 */
PosInventoryRequest.prototype['quantity'] = undefined;
 ...
 */
PosInventoryRequest.prototype['storeCode'] = undefined;

/**
 * Required. The CLDR territory code for the item.
 * @member {String} targetCountry
 */
PosInventoryRequest.prototype['targetCountry'] = undefined;

/**
 * Required. The inventory timestamp, in ISO 8601 format.
 * @member {String} timestamp
 */
PosInventoryRequest.prototype['timestamp'] = undefined;
...
export default PosInventoryRequest;
