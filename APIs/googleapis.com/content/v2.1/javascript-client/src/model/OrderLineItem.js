    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('adjustments')) {
                obj['adjustments'] = ApiClient.convertToType(data['adjustments'], [OrderLineItemAdjustment]);
            }
            ...
            if (data.hasOwnProperty('quantityUndeliverable')) {
                obj['quantityUndeliverable'] = ApiClient.convertToType(data['quantityUndeliverable'], 'Number');
            }
    ...
    static validateJSON(data) {
        if (data['adjustments']) { // data not null
            ...
            for (const item of data['adjustments']) {
                OrderLineItemAdjustment.validateJSON(item);
            };
        }
 ...
 * @member {Array.<module:model/OrderLineItemAdjustment>} adjustments
 */
OrderLineItem.prototype['adjustments'] = undefined;
 ...
 * @member {Number} quantityUndeliverable
 */
OrderLineItem.prototype['quantityUndeliverable'] = undefined;
