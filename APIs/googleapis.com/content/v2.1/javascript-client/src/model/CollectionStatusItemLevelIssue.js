...
/**
 * The CollectionStatusItemLevelIssue model module.
 * @module model/CollectionStatusItemLevelIssue
 * @version v2.1
 */
class CollectionStatusItemLevelIssue {
    /**
     * Constructs a new <code>CollectionStatusItemLevelIssue</code>.
     * Issue associated with the collection.
     * @alias module:model/CollectionStatusItemLevelIssue
     */
    constructor() { 
        
        CollectionStatusItemLevelIssue.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CollectionStatusItemLevelIssue</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CollectionStatusItemLevelIssue} obj Optional instance to populate.
     * @return {module:model/CollectionStatusItemLevelIssue} The populated <code>CollectionStatusItemLevelIssue</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CollectionStatusItemLevelIssue();
    ...
    /**
     * Validates the JSON data with respect to <code>CollectionStatusItemLevelIssue</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CollectionStatusItemLevelIssue</code>.
     */
 ...
 */
CollectionStatusItemLevelIssue.prototype['applicableCountries'] = undefined;

/**
 * The attribute's name, if the issue is caused by a single attribute.
 * @member {String} attributeName
 */
CollectionStatusItemLevelIssue.prototype['attributeName'] = undefined;

/**
 * The error code of the issue.
 * @member {String} code
 */
CollectionStatusItemLevelIssue.prototype['code'] = undefined;

/**
 * A short issue description in English.
 * @member {String} description
 */
CollectionStatusItemLevelIssue.prototype['description'] = undefined;

/**
 * The destination the issue applies to.
 * @member {String} destination
 */
CollectionStatusItemLevelIssue.prototype['destination'] = undefined;

/**
 * A detailed issue description in English.
 * @member {String} detail
 */
CollectionStatusItemLevelIssue.prototype['detail'] = undefined;

/**
 * The URL of a web page to help with resolving this issue.
 * @member {String} documentation
 */
CollectionStatusItemLevelIssue.prototype['documentation'] = undefined;

/**
 * Whether the issue can be resolved by the merchant.
 * @member {String} resolution
 */
CollectionStatusItemLevelIssue.prototype['resolution'] = undefined;

/**
 * How this issue affects the serving of the collection.
 * @member {String} servability
 */
CollectionStatusItemLevelIssue.prototype['servability'] = undefined;
...
export default CollectionStatusItemLevelIssue;
