# ContentApiForShopping.ReturnpolicyApi
...
> ReturnpolicyCustomBatchResponse contentReturnpolicyCustombatch(opts)
...
let apiInstance = new ContentApiForShopping.ReturnpolicyApi();
let opts = {
  ...
  'returnpolicyCustomBatchRequest': new ContentApiForShopping.ReturnpolicyCustomBatchRequest() // ReturnpolicyCustomBatchRequest | 
};
apiInstance.contentReturnpolicyCustombatch(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> contentReturnpolicyDelete(merchantId, returnPolicyId, opts)
...
let apiInstance = new ContentApiForShopping.ReturnpolicyApi();
let merchantId = "merchantId_example"; // String | The Merchant Center account from which to delete the given return policy.
let returnPolicyId = "returnPolicyId_example"; // String | Return policy ID generated by Google.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
apiInstance.contentReturnpolicyDelete(merchantId, returnPolicyId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> ReturnPolicy contentReturnpolicyGet(merchantId, returnPolicyId, opts)
...
let apiInstance = new ContentApiForShopping.ReturnpolicyApi();
let merchantId = "merchantId_example"; // String | The Merchant Center account to get a return policy for.
let returnPolicyId = "returnPolicyId_example"; // String | Return policy ID generated by Google.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
...
apiInstance.contentReturnpolicyGet(merchantId, returnPolicyId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ReturnPolicy contentReturnpolicyInsert(merchantId, opts)
...
let apiInstance = new ContentApiForShopping.ReturnpolicyApi();
let merchantId = "merchantId_example"; // String | The Merchant Center account to insert a return policy for.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'returnPolicy': new ContentApiForShopping.ReturnPolicy() // ReturnPolicy | 
};
apiInstance.contentReturnpolicyInsert(merchantId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ReturnpolicyListResponse contentReturnpolicyList(merchantId, opts)
...
let apiInstance = new ContentApiForShopping.ReturnpolicyApi();
let merchantId = "merchantId_example"; // String | The Merchant Center account to list return policies for.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
apiInstance.contentReturnpolicyList(merchantId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
