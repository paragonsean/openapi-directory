# ContentApiForShopping.BuyongoogleprogramsApi
...
> contentBuyongoogleprogramsActivate(merchantId, regionCode, opts)
...
let apiInstance = new ContentApiForShopping.BuyongoogleprogramsApi();
let merchantId = "merchantId_example"; // String | Required. The ID of the account.
let regionCode = "regionCode_example"; // String | Required. The program region code [ISO 3166-1 alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2). Currently only US is available.
let opts = {
...
apiInstance.contentBuyongoogleprogramsActivate(merchantId, regionCode, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> BuyOnGoogleProgramStatus contentBuyongoogleprogramsGet(merchantId, regionCode, opts)
...
apiInstance.contentBuyongoogleprogramsGet(merchantId, regionCode, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> contentBuyongoogleprogramsOnboard(merchantId, regionCode, opts)
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'onboardBuyOnGoogleProgramRequest': new ContentApiForShopping.OnboardBuyOnGoogleProgramRequest() // OnboardBuyOnGoogleProgramRequest | 
};
apiInstance.contentBuyongoogleprogramsOnboard(merchantId, regionCode, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
> BuyOnGoogleProgramStatus contentBuyongoogleprogramsPatch(merchantId, regionCode, opts)
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'updateMask': "updateMask_example", // String | The list of fields to update. If the update mask is not provided, then all the fields set in buyOnGoogleProgramStatus will be updated. Clearing fields is only possible if update mask is provided.
  'buyOnGoogleProgramStatus': new ContentApiForShopping.BuyOnGoogleProgramStatus() // BuyOnGoogleProgramStatus | 
};
apiInstance.contentBuyongoogleprogramsPatch(merchantId, regionCode, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> contentBuyongoogleprogramsPause(merchantId, regionCode, opts)
...
apiInstance.contentBuyongoogleprogramsPause(merchantId, regionCode, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
> contentBuyongoogleprogramsRequestreview(merchantId, regionCode, opts)
...
apiInstance.contentBuyongoogleprogramsRequestreview(merchantId, regionCode, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
