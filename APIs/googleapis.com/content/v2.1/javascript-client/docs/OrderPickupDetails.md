# ContentApiForShopping.OrderPickupDetails
...
**collectors** | [**[OrderPickupDetailsCollector]**](OrderPickupDetailsCollector.md) | Collectors authorized to pick up shipment from the pickup location. | [optional] 
