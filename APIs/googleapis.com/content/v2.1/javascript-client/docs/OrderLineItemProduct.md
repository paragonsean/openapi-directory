# ContentApiForShopping.OrderLineItemProduct
...
**fees** | [**[OrderLineItemProductFee]**](OrderLineItemProductFee.md) | Associated fees at order creation time. | [optional] 
...
**variantAttributes** | [**[OrderLineItemProductVariantAttribute]**](OrderLineItemProductVariantAttribute.md) | Variant attributes for the item. These are dimensions of the product, such as color, gender, material, pattern, and size. You can find a comprehensive list of variant attributes here. | [optional] 
