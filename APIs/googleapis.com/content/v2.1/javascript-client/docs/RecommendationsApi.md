# ContentApiForShopping.RecommendationsApi
...
> GenerateRecommendationsResponse contentRecommendationsGenerate(merchantId, opts)
...
let apiInstance = new ContentApiForShopping.RecommendationsApi();
let merchantId = "merchantId_example"; // String | Required. The ID of the account to fetch recommendations for.
let opts = {
...
apiInstance.contentRecommendationsGenerate(merchantId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
 ...
 **allowedTag** | [**[String]**](String.md)| Optional. List of allowed tags. Tags are a set of predefined strings that describe the category that individual recommendation types belong to. User can specify zero or more tags in this field to indicate what categories of recommendations they want to receive. Current list of supported tags: - TREND | [optional] 
...
> contentRecommendationsReportInteraction(merchantId, opts)
...
let apiInstance = new ContentApiForShopping.RecommendationsApi();
let merchantId = "merchantId_example"; // String | Required. The ID of the account that wants to report an interaction.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'reportInteractionRequest': new ContentApiForShopping.ReportInteractionRequest() // ReportInteractionRequest | 
};
apiInstance.contentRecommendationsReportInteraction(merchantId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
