...
**adsLinks** | [**[AccountAdsLink]**](AccountAdsLink.md) | Linked Ads accounts that are active or pending approval. To create a new link request, add a new link with status &#x60;active&#x60; to the list. It will remain in a &#x60;pending&#x60; state until approved or rejected either in the Ads interface or through the Google Ads API. To delete an active link, or to cancel a link request, remove it from the list. | [optional] 
...
**automaticLabelIds** | **[String]** | Automatically created label IDs that are assigned to the account by CSS Center. | [optional] 
...
**labelIds** | **[String]** | Manually created label IDs that are assigned to the account by CSS. | [optional] 
