# ContentApiForShopping.ReportInteractionRequest

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**interactionType** | **String** | Required. Type of the interaction that is reported, for example INTERACTION_CLICK. | [optional] 
...
* `TYPE_UNSPECIFIED` (value: `"INTERACTION_TYPE_UNSPECIFIED"`)

* `DISMISS` (value: `"INTERACTION_DISMISS"`)

* `CLICK` (value: `"INTERACTION_CLICK"`)
