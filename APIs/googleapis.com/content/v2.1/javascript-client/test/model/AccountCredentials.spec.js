...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentApiForShopping.AccountCredentials();
  });
  ...
  describe('AccountCredentials', function() {
    it('should create an instance of AccountCredentials', function() {
      ...
      //var instance = new ContentApiForShopping.AccountCredentials();
      //expect(instance).to.be.a(ContentApiForShopping.AccountCredentials);
    });
