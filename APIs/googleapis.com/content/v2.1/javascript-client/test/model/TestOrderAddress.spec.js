...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentApiForShopping.TestOrderAddress();
  });
  ...
  describe('TestOrderAddress', function() {
    it('should create an instance of TestOrderAddress', function() {
      // uncomment below and update the code to test TestOrderAddress
      //var instance = new ContentApiForShopping.TestOrderAddress();
      //expect(instance).to.be.a(ContentApiForShopping.TestOrderAddress);
    });
