...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentApiForShopping.PosSaleRequest();
  });
  ...
  describe('PosSaleRequest', function() {
    it('should create an instance of PosSaleRequest', function() {
      // uncomment below and update the code to test PosSaleRequest
      //var instance = new ContentApiForShopping.PosSaleRequest();
      //expect(instance).to.be.a(ContentApiForShopping.PosSaleRequest);
    });
