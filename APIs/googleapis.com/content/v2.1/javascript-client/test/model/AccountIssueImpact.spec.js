...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentApiForShopping.AccountIssueImpact();
  });
  ...
  describe('AccountIssueImpact', function() {
    it('should create an instance of AccountIssueImpact', function() {
      // uncomment below and update the code to test AccountIssueImpact
      //var instance = new ContentApiForShopping.AccountIssueImpact();
      //expect(instance).to.be.a(ContentApiForShopping.AccountIssueImpact);
    });
