...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentApiForShopping.PosCustomBatchResponseEntry();
  });
  ...
  describe('PosCustomBatchResponseEntry', function() {
    it('should create an instance of PosCustomBatchResponseEntry', function() {
      // uncomment below and update the code to test PosCustomBatchResponseEntry
      //var instance = new ContentApiForShopping.PosCustomBatchResponseEntry();
      //expect(instance).to.be.a(ContentApiForShopping.PosCustomBatchResponseEntry);
    });
