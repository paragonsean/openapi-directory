...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentApiForShopping.TimePeriod();
  });
  ...
  describe('TimePeriod', function() {
    it('should create an instance of TimePeriod', function() {
      ...
      //var instance = new ContentApiForShopping.TimePeriod();
      //expect(instance).to.be.a(ContentApiForShopping.TimePeriod);
    });
