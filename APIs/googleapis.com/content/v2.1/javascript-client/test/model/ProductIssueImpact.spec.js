...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentApiForShopping.ProductIssueImpact();
  });
  ...
  describe('ProductIssueImpact', function() {
    it('should create an instance of ProductIssueImpact', function() {
      // uncomment below and update the code to test ProductIssueImpact
      //var instance = new ContentApiForShopping.ProductIssueImpact();
      //expect(instance).to.be.a(ContentApiForShopping.ProductIssueImpact);
    });
