...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentApiForShopping.OrderCancellation();
  });
  ...
  describe('OrderCancellation', function() {
    it('should create an instance of OrderCancellation', function() {
      // uncomment below and update the code to test OrderCancellation
      //var instance = new ContentApiForShopping.OrderCancellation();
      //expect(instance).to.be.a(ContentApiForShopping.OrderCancellation);
    });
