...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentApiForShopping.OrderPromotionItem();
  });
  ...
  describe('OrderPromotionItem', function() {
    it('should create an instance of OrderPromotionItem', function() {
      // uncomment below and update the code to test OrderPromotionItem
      //var instance = new ContentApiForShopping.OrderPromotionItem();
      //expect(instance).to.be.a(ContentApiForShopping.OrderPromotionItem);
    });
