...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentApiForShopping.CollectionFeaturedProduct();
  });
  ...
  describe('CollectionFeaturedProduct', function() {
    it('should create an instance of CollectionFeaturedProduct', function() {
      // uncomment below and update the code to test CollectionFeaturedProduct
      //var instance = new ContentApiForShopping.CollectionFeaturedProduct();
      //expect(instance).to.be.a(ContentApiForShopping.CollectionFeaturedProduct);
    });
