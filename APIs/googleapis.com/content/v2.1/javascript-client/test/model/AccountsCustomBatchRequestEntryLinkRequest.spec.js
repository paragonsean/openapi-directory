...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentApiForShopping.AccountsCustomBatchRequestEntryLinkRequest();
  });
  ...
  describe('AccountsCustomBatchRequestEntryLinkRequest', function() {
    it('should create an instance of AccountsCustomBatchRequestEntryLinkRequest', function() {
      // uncomment below and update the code to test AccountsCustomBatchRequestEntryLinkRequest
      //var instance = new ContentApiForShopping.AccountsCustomBatchRequestEntryLinkRequest();
      //expect(instance).to.be.a(ContentApiForShopping.AccountsCustomBatchRequestEntryLinkRequest);
    });
