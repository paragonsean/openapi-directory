...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentApiForShopping.ListPromotionResponse();
  });
  ...
  describe('ListPromotionResponse', function() {
    it('should create an instance of ListPromotionResponse', function() {
      // uncomment below and update the code to test ListPromotionResponse
      //var instance = new ContentApiForShopping.ListPromotionResponse();
      //expect(instance).to.be.a(ContentApiForShopping.ListPromotionResponse);
    });
