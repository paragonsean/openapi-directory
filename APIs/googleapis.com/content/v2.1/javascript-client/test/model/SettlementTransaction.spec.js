...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentApiForShopping.SettlementTransaction();
  });
  ...
  describe('SettlementTransaction', function() {
    it('should create an instance of SettlementTransaction', function() {
      // uncomment below and update the code to test SettlementTransaction
      //var instance = new ContentApiForShopping.SettlementTransaction();
      //expect(instance).to.be.a(ContentApiForShopping.SettlementTransaction);
    });
