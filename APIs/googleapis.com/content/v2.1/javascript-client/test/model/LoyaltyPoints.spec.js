...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentApiForShopping.LoyaltyPoints();
  });
  ...
  describe('LoyaltyPoints', function() {
    it('should create an instance of LoyaltyPoints', function() {
      ...
      //var instance = new ContentApiForShopping.LoyaltyPoints();
      //expect(instance).to.be.a(ContentApiForShopping.LoyaltyPoints);
    });
