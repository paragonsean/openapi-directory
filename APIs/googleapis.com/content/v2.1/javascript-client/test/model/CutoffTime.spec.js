...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentApiForShopping.CutoffTime();
  });
  ...
  describe('CutoffTime', function() {
    it('should create an instance of CutoffTime', function() {
      // uncomment below and update the code to test CutoffTime
      //var instance = new ContentApiForShopping.CutoffTime();
      //expect(instance).to.be.a(ContentApiForShopping.CutoffTime);
    });
