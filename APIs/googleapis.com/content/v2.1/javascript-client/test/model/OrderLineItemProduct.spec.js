...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentApiForShopping.OrderLineItemProduct();
  });
  ...
  describe('OrderLineItemProduct', function() {
    it('should create an instance of OrderLineItemProduct', function() {
      // uncomment below and update the code to test OrderLineItemProduct
      //var instance = new ContentApiForShopping.OrderLineItemProduct();
      //expect(instance).to.be.a(ContentApiForShopping.OrderLineItemProduct);
    });
    ...
    it('should have the property shownImage (base name: "shownImage")', function() {
      // uncomment below and update the code to test the property shownImage
      //var instance = new ContentApiForShopping.OrderLineItemProduct();
      //expect(instance).to.be();
    });
