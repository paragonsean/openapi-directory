...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentApiForShopping.ListRegionsResponse();
  });
  ...
  describe('ListRegionsResponse', function() {
    it('should create an instance of ListRegionsResponse', function() {
      ...
      //var instance = new ContentApiForShopping.ListRegionsResponse();
      //expect(instance).to.be.a(ContentApiForShopping.ListRegionsResponse);
    });
