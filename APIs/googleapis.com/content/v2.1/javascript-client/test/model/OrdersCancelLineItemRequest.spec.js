...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentApiForShopping.OrdersCancelLineItemRequest();
  });
  ...
  describe('OrdersCancelLineItemRequest', function() {
    it('should create an instance of OrdersCancelLineItemRequest', function() {
      // uncomment below and update the code to test OrdersCancelLineItemRequest
      //var instance = new ContentApiForShopping.OrdersCancelLineItemRequest();
      //expect(instance).to.be.a(ContentApiForShopping.OrdersCancelLineItemRequest);
    });
