...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentApiForShopping.ProductProductDetail();
  });
  ...
  describe('ProductProductDetail', function() {
    it('should create an instance of ProductProductDetail', function() {
      // uncomment below and update the code to test ProductProductDetail
      //var instance = new ContentApiForShopping.ProductProductDetail();
      //expect(instance).to.be.a(ContentApiForShopping.ProductProductDetail);
    });
