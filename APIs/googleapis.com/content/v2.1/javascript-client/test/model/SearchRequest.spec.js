...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentApiForShopping.SearchRequest();
  });
  ...
  describe('SearchRequest', function() {
    it('should create an instance of SearchRequest', function() {
      ...
      //var instance = new ContentApiForShopping.SearchRequest();
      //expect(instance).to.be.a(ContentApiForShopping.SearchRequest);
    });
