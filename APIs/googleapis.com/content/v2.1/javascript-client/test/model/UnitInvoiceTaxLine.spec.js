...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentApiForShopping.UnitInvoiceTaxLine();
  });
  ...
  describe('UnitInvoiceTaxLine', function() {
    it('should create an instance of UnitInvoiceTaxLine', function() {
      // uncomment below and update the code to test UnitInvoiceTaxLine
      //var instance = new ContentApiForShopping.UnitInvoiceTaxLine();
      //expect(instance).to.be.a(ContentApiForShopping.UnitInvoiceTaxLine);
    });
