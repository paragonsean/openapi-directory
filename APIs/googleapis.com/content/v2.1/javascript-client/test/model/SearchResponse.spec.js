...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentApiForShopping.SearchResponse();
  });
  ...
  describe('SearchResponse', function() {
    it('should create an instance of SearchResponse', function() {
      ...
      //var instance = new ContentApiForShopping.SearchResponse();
      //expect(instance).to.be.a(ContentApiForShopping.SearchResponse);
    });
