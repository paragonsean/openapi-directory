...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentApiForShopping.OrdersRefundItemRequest();
  });
  ...
  describe('OrdersRefundItemRequest', function() {
    it('should create an instance of OrdersRefundItemRequest', function() {
      // uncomment below and update the code to test OrdersRefundItemRequest
      //var instance = new ContentApiForShopping.OrdersRefundItemRequest();
      //expect(instance).to.be.a(ContentApiForShopping.OrdersRefundItemRequest);
    });
