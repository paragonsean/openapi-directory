...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentApiForShopping.AccountStatusAccountLevelIssue();
  });
  ...
  describe('AccountStatusAccountLevelIssue', function() {
    it('should create an instance of AccountStatusAccountLevelIssue', function() {
      // uncomment below and update the code to test AccountStatusAccountLevelIssue
      //var instance = new ContentApiForShopping.AccountStatusAccountLevelIssue();
      //expect(instance).to.be.a(ContentApiForShopping.AccountStatusAccountLevelIssue);
    });
