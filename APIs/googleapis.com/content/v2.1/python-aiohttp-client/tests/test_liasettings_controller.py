...
async def test_content_liasettings_custombatch(client):
    ...
    """
    body = {"entries":[{"posExternalAccountId":"posExternalAccountId","accountId":"accountId","country":"country","liaSettings":{"accountId":"accountId","kind":"kind","countrySettings":[{"country":"country","hostedLocalStorefrontActive":True,"omnichannelExperience":{"country":"country","lsfType":"lsfType","pickupTypes":["pickupTypes","pickupTypes"]},"onDisplayToOrder":{"shippingCostPolicyUrl":"shippingCostPolicyUrl","status":"status"},"about":{"url":"url","status":"status"},"storePickupActive":True,"inventory":{"inventoryVerificationContactStatus":"inventoryVerificationContactStatus","inventoryVerificationContactEmail":"inventoryVerificationContactEmail","inventoryVerificationContactName":"inventoryVerificationContactName","status":"status"},"posDataProvider":{"posExternalAccountId":"posExternalAccountId","posDataProviderId":"posDataProviderId"}},{"country":"country","hostedLocalStorefrontActive":True,"omnichannelExperience":{"country":"country","lsfType":"lsfType","pickupTypes":["pickupTypes","pickupTypes"]},"onDisplayToOrder":{"shippingCostPolicyUrl":"shippingCostPolicyUrl","status":"status"},"about":{"url":"url","status":"status"},"storePickupActive":True,"inventory":{"inventoryVerificationContactStatus":"inventoryVerificationContactStatus","inventoryVerificationContactEmail":"inventoryVerificationContactEmail","inventoryVerificationContactName":"inventoryVerificationContactName","status":"status"},"posDataProvider":{"posExternalAccountId":"posExternalAccountId","posDataProviderId":"posDataProviderId"}}]},"method":"method","omnichannelExperience":{"country":"country","lsfType":"lsfType","pickupTypes":["pickupTypes","pickupTypes"]},"contactEmail":"contactEmail","merchantId":"merchantId","contactName":"contactName","posDataProviderId":"posDataProviderId","gmbEmail":"gmbEmail","batchId":0},{"posExternalAccountId":"posExternalAccountId","accountId":"accountId","country":"country","liaSettings":{"accountId":"accountId","kind":"kind","countrySettings":[{"country":"country","hostedLocalStorefrontActive":True,"omnichannelExperience":{"country":"country","lsfType":"lsfType","pickupTypes":["pickupTypes","pickupTypes"]},"onDisplayToOrder":{"shippingCostPolicyUrl":"shippingCostPolicyUrl","status":"status"},"about":{"url":"url","status":"status"},"storePickupActive":True,"inventory":{"inventoryVerificationContactStatus":"inventoryVerificationContactStatus","inventoryVerificationContactEmail":"inventoryVerificationContactEmail","inventoryVerificationContactName":"inventoryVerificationContactName","status":"status"},"posDataProvider":{"posExternalAccountId":"posExternalAccountId","posDataProviderId":"posDataProviderId"}},{"country":"country","hostedLocalStorefrontActive":True,"omnichannelExperience":{"country":"country","lsfType":"lsfType","pickupTypes":["pickupTypes","pickupTypes"]},"onDisplayToOrder":{"shippingCostPolicyUrl":"shippingCostPolicyUrl","status":"status"},"about":{"url":"url","status":"status"},"storePickupActive":True,"inventory":{"inventoryVerificationContactStatus":"inventoryVerificationContactStatus","inventoryVerificationContactEmail":"inventoryVerificationContactEmail","inventoryVerificationContactName":"inventoryVerificationContactName","status":"status"},"posDataProvider":{"posExternalAccountId":"posExternalAccountId","posDataProviderId":"posDataProviderId"}}]},"method":"method","omnichannelExperience":{"country":"country","lsfType":"lsfType","pickupTypes":["pickupTypes","pickupTypes"]},"contactEmail":"contactEmail","merchantId":"merchantId","contactName":"contactName","posDataProviderId":"posDataProviderId","gmbEmail":"gmbEmail","batchId":0}]}
...
async def test_content_liasettings_get(client):
    ...
    response = await client.request(
        method='GET',
        path='/content/v2.1/{merchant_id}/liasettings/{account_id}'.format(merchant_id='merchant_id_example', account_id='account_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_content_liasettings_getaccessiblegmbaccounts(client):
    ...
    response = await client.request(
        method='GET',
        path='/content/v2.1/{merchant_id}/liasettings/{account_id}/accessiblegmbaccounts'.format(merchant_id='merchant_id_example', account_id='account_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_content_liasettings_list(client):
    ...
    response = await client.request(
        method='GET',
        path='/content/v2.1/{merchant_id}/liasettings'.format(merchant_id='merchant_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_content_liasettings_requestgmbaccess(client):
    ...
    response = await client.request(
        method='POST',
        path='/content/v2.1/{merchant_id}/liasettings/{account_id}/requestgmbaccess'.format(merchant_id='merchant_id_example', account_id='account_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_content_liasettings_requestinventoryverification(client):
    ...
    response = await client.request(
        method='POST',
        path='/content/v2.1/{merchant_id}/liasettings/{account_id}/requestinventoryverification/{country}'.format(merchant_id='merchant_id_example', account_id='account_id_example', country='country_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_content_liasettings_setinventoryverificationcontact(client):
    ...
    response = await client.request(
        method='POST',
        path='/content/v2.1/{merchant_id}/liasettings/{account_id}/setinventoryverificationcontact'.format(merchant_id='merchant_id_example', account_id='account_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_content_liasettings_setomnichannelexperience(client):
    """Test case for content_liasettings_setomnichannelexperience
    ...
    params = [('$.xgafv', 'xgafv_example'),
                    ...
                    ('uploadType', 'upload_type_example'),
                    ('country', 'country_example'),
                    ('lsfType', 'lsf_type_example'),
                    ('pickupTypes', ['pickup_types_example'])]
    headers = { 
        'Accept': 'application/json',
        'Authorization': 'Bearer special-key',
        'Authorization': 'Bearer special-key',
    ...
    response = await client.request(
        method='POST',
        path='/content/v2.1/{merchant_id}/liasettings/{account_id}/setomnichannelexperience'.format(merchant_id='merchant_id_example', account_id='account_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_content_liasettings_setposdataprovider(client):
    ...
    response = await client.request(
        method='POST',
        path='/content/v2.1/{merchant_id}/liasettings/{account_id}/setposdataprovider'.format(merchant_id='merchant_id_example', account_id='account_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
