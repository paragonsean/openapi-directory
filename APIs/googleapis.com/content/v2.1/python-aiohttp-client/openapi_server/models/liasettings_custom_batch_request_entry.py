...
class LiasettingsCustomBatchRequestEntry(Model):
    ...
    def __init__(self, account_id: str=None, batch_id: int=None, contact_email: str=None, contact_name: str=None, country: str=None, gmb_email: str=None, lia_settings: LiaSettings=None, merchant_id: str=None, method: str=None, omnichannel_experience: LiaOmnichannelExperience=None, pos_data_provider_id: str=None, pos_external_account_id: str=None):
        ...
        :param omnichannel_experience: The omnichannel_experience of this LiasettingsCustomBatchRequestEntry.
    ...
    def omnichannel_experience(self):
        """Gets the omnichannel_experience of this LiasettingsCustomBatchRequestEntry.


        :return: The omnichannel_experience of this LiasettingsCustomBatchRequestEntry.
    ...
    def omnichannel_experience(self, omnichannel_experience):
        """Sets the omnichannel_experience of this LiasettingsCustomBatchRequestEntry.
