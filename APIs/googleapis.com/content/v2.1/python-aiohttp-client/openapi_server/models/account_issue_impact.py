...
class AccountIssueImpact(Model):
    ...
    def __init__(self, breakdowns: List[Breakdown]=None, message: str=None, severity: str=None):
        """AccountIssueImpact - a model defined in OpenAPI

        :param breakdowns: The breakdowns of this AccountIssueImpact.
        :param message: The message of this AccountIssueImpact.
        :param severity: The severity of this AccountIssueImpact.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'AccountIssueImpact':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The AccountIssueImpact of this AccountIssueImpact.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def breakdowns(self):
        """Gets the breakdowns of this AccountIssueImpact.
        ...
        :return: The breakdowns of this AccountIssueImpact.
    ...
    def breakdowns(self, breakdowns):
        """Sets the breakdowns of this AccountIssueImpact.
    ...
    @property
    def message(self):
        """Gets the message of this AccountIssueImpact.
        ...
        :return: The message of this AccountIssueImpact.
        :rtype: str
        """
    ...
    def message(self, message):
        """Sets the message of this AccountIssueImpact.
    ...
    @property
    def severity(self):
        """Gets the severity of this AccountIssueImpact.

        The severity of the issue.

        :return: The severity of this AccountIssueImpact.
        :rtype: str
        """
    ...
    def severity(self, severity):
        """Sets the severity of this AccountIssueImpact.
