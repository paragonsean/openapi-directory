...
class RenderProductIssuesRequestPayload(Model):
    ...
    def __init__(self, content_option: str=None):
        """RenderProductIssuesRequestPayload - a model defined in OpenAPI

        :param content_option: The content_option of this RenderProductIssuesRequestPayload.
        """
        self.openapi_types = {
            'content_option': str
        }
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'RenderProductIssuesRequestPayload':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The RenderProductIssuesRequestPayload of this RenderProductIssuesRequestPayload.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def content_option(self):
        """Gets the content_option of this RenderProductIssuesRequestPayload.

        Optional. How the detailed content should be returned. Default option is to return the content as a pre-rendered HTML text.

        :return: The content_option of this RenderProductIssuesRequestPayload.
        :rtype: str
        """
    ...
    def content_option(self, content_option):
        """Sets the content_option of this RenderProductIssuesRequestPayload.
