...
class FreeListingsProgramStatusRegionStatus(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, disapproval_date: str=None, eligibility_status: str=None, onboarding_issues: List[str]=None, region_codes: List[str]=None, review_eligibility_status: str=None, review_ineligibility_reason: str=None, review_ineligibility_reason_description: str=None, review_ineligibility_reason_details: FreeListingsProgramStatusReviewIneligibilityReasonDetails=None, review_issues: List[str]=None):
        """FreeListingsProgramStatusRegionStatus - a model defined in OpenAPI

        :param disapproval_date: The disapproval_date of this FreeListingsProgramStatusRegionStatus.
        :param eligibility_status: The eligibility_status of this FreeListingsProgramStatusRegionStatus.
        :param onboarding_issues: The onboarding_issues of this FreeListingsProgramStatusRegionStatus.
        :param region_codes: The region_codes of this FreeListingsProgramStatusRegionStatus.
        :param review_eligibility_status: The review_eligibility_status of this FreeListingsProgramStatusRegionStatus.
        :param review_ineligibility_reason: The review_ineligibility_reason of this FreeListingsProgramStatusRegionStatus.
        :param review_ineligibility_reason_description: The review_ineligibility_reason_description of this FreeListingsProgramStatusRegionStatus.
        :param review_ineligibility_reason_details: The review_ineligibility_reason_details of this FreeListingsProgramStatusRegionStatus.
        :param review_issues: The review_issues of this FreeListingsProgramStatusRegionStatus.
        """
        self.openapi_types = {
            ...
            'review_ineligibility_reason_details': FreeListingsProgramStatusReviewIneligibilityReasonDetails,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'FreeListingsProgramStatusRegionStatus':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The FreeListingsProgramStatusRegionStatus of this FreeListingsProgramStatusRegionStatus.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def disapproval_date(self):
        """Gets the disapproval_date of this FreeListingsProgramStatusRegionStatus.
        ...
        :return: The disapproval_date of this FreeListingsProgramStatusRegionStatus.
        :rtype: str
        """
    ...
    def disapproval_date(self, disapproval_date):
        """Sets the disapproval_date of this FreeListingsProgramStatusRegionStatus.
    ...
    def eligibility_status(self):
        """Gets the eligibility_status of this FreeListingsProgramStatusRegionStatus.

        Eligibility status of the standard free listing program.

        :return: The eligibility_status of this FreeListingsProgramStatusRegionStatus.
        :rtype: str
        """
    ...
    def eligibility_status(self, eligibility_status):
        """Sets the eligibility_status of this FreeListingsProgramStatusRegionStatus.
    ...
    def onboarding_issues(self):
        """Gets the onboarding_issues of this FreeListingsProgramStatusRegionStatus.

        Issues that must be fixed to be eligible for review.

        :return: The onboarding_issues of this FreeListingsProgramStatusRegionStatus.
        :rtype: List[str]
        """
    ...
    def onboarding_issues(self, onboarding_issues):
        """Sets the onboarding_issues of this FreeListingsProgramStatusRegionStatus.
    ...
    def region_codes(self):
        """Gets the region_codes of this FreeListingsProgramStatusRegionStatus.
        ...
        :return: The region_codes of this FreeListingsProgramStatusRegionStatus.
        :rtype: List[str]
        """
    ...
    def region_codes(self, region_codes):
        """Sets the region_codes of this FreeListingsProgramStatusRegionStatus.
    ...
    def review_eligibility_status(self):
        """Gets the review_eligibility_status of this FreeListingsProgramStatusRegionStatus.

        If a program is eligible for review in a specific region. Only visible if `eligibilityStatus` is `DISAPPROVED`.

        :return: The review_eligibility_status of this FreeListingsProgramStatusRegionStatus.
        :rtype: str
        """
    ...
    def review_eligibility_status(self, review_eligibility_status):
        """Sets the review_eligibility_status of this FreeListingsProgramStatusRegionStatus.
    ...
    def review_ineligibility_reason(self):
        """Gets the review_ineligibility_reason of this FreeListingsProgramStatusRegionStatus.

        Review ineligibility reason if account is not eligible for review.

        :return: The review_ineligibility_reason of this FreeListingsProgramStatusRegionStatus.
        :rtype: str
        """
    ...
    def review_ineligibility_reason(self, review_ineligibility_reason):
        """Sets the review_ineligibility_reason of this FreeListingsProgramStatusRegionStatus.
    ...
    def review_ineligibility_reason_description(self):
        """Gets the review_ineligibility_reason_description of this FreeListingsProgramStatusRegionStatus.

        Reason a program in a specific region isn’t eligible for review. Only visible if `reviewEligibilityStatus` is `INELIGIBLE`.

        :return: The review_ineligibility_reason_description of this FreeListingsProgramStatusRegionStatus.
        :rtype: str
        """
    ...
    def review_ineligibility_reason_description(self, review_ineligibility_reason_description):
        """Sets the review_ineligibility_reason_description of this FreeListingsProgramStatusRegionStatus.
    ...
    def review_ineligibility_reason_details(self):
        """Gets the review_ineligibility_reason_details of this FreeListingsProgramStatusRegionStatus.


        :return: The review_ineligibility_reason_details of this FreeListingsProgramStatusRegionStatus.
        :rtype: FreeListingsProgramStatusReviewIneligibilityReasonDetails
        """
    ...
    def review_ineligibility_reason_details(self, review_ineligibility_reason_details):
        """Sets the review_ineligibility_reason_details of this FreeListingsProgramStatusRegionStatus.


        :param review_ineligibility_reason_details: The review_ineligibility_reason_details of this FreeListingsProgramStatusRegionStatus.
        :type review_ineligibility_reason_details: FreeListingsProgramStatusReviewIneligibilityReasonDetails
        """
    ...
    def review_issues(self):
        """Gets the review_issues of this FreeListingsProgramStatusRegionStatus.

        Issues evaluated in the review process. Fix all issues before requesting a review.

        :return: The review_issues of this FreeListingsProgramStatusRegionStatus.
        :rtype: List[str]
        """
    ...
    def review_issues(self, review_issues):
        """Sets the review_issues of this FreeListingsProgramStatusRegionStatus.
