...
class AccountStatus(Model):
    ...
    def __init__(self, account_id: str=None, account_level_issues: List[AccountStatusAccountLevelIssue]=None, account_management: str=None, kind: str=None, products: List[AccountStatusProducts]=None, website_claimed: bool=None):
        ...
        :param account_management: The account_management of this AccountStatus.
    ...
    def account_management(self):
        """Gets the account_management of this AccountStatus.

        How the account is managed. Acceptable values are: - \"`manual`\" - \"`automatic`\" 

        :return: The account_management of this AccountStatus.
        :rtype: str
        """
    ...
    def account_management(self, account_management):
        """Sets the account_management of this AccountStatus.
