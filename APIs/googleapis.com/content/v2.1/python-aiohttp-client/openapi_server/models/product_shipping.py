...
class ProductShipping(Model):
    ...
    def __init__(self, country: str=None, location_group_name: str=None, location_id: str=None, max_handling_time: str=None, max_transit_time: str=None, min_handling_time: str=None, min_transit_time: str=None, postal_code: str=None, price: Price=None, region: str=None, service: str=None):
        ...
        :param max_handling_time: The max_handling_time of this ProductShipping.
        :param max_transit_time: The max_transit_time of this ProductShipping.
        :param min_handling_time: The min_handling_time of this ProductShipping.
        :param min_transit_time: The min_transit_time of this ProductShipping.
        ...
        self.openapi_types = {
            ...
            'max_transit_time': str,
            'min_handling_time': str,
            'min_transit_time': str,
            'postal_code': str,
            'price': Price,
            'region': str,
            'service': str
        ...
        self._max_transit_time = max_transit_time
        self._min_handling_time = min_handling_time
        self._min_transit_time = min_transit_time
    ...
    def max_handling_time(self):
        """Gets the max_handling_time of this ProductShipping.
        ...
        :return: The max_handling_time of this ProductShipping.
        :rtype: str
        """
    ...
    def max_handling_time(self, max_handling_time):
        """Sets the max_handling_time of this ProductShipping.
    ...
    @property
    def max_transit_time(self):
        """Gets the max_transit_time of this ProductShipping.
        ...
        :return: The max_transit_time of this ProductShipping.
        :rtype: str
        """
        return self._max_transit_time

    @max_transit_time.setter
    def max_transit_time(self, max_transit_time):
        """Sets the max_transit_time of this ProductShipping.

        Maximum transit time (inclusive) between when the order has shipped and when it's delivered in business days. 0 means that the order is delivered on the same day as it ships. Both maxHandlingTime and maxTransitTime are required if providing shipping speeds.

        :param max_transit_time: The max_transit_time of this ProductShipping.
        :type max_transit_time: str
        """
    ...
    def min_handling_time(self):
        """Gets the min_handling_time of this ProductShipping.
        ...
        :return: The min_handling_time of this ProductShipping.
        :rtype: str
        """
    ...
    def min_handling_time(self, min_handling_time):
        """Sets the min_handling_time of this ProductShipping.
    ...
    @property
    def min_transit_time(self):
        """Gets the min_transit_time of this ProductShipping.
        ...
        :return: The min_transit_time of this ProductShipping.
        :rtype: str
        """
        return self._min_transit_time

    @min_transit_time.setter
    def min_transit_time(self, min_transit_time):
        """Sets the min_transit_time of this ProductShipping.

        Minimum transit time (inclusive) between when the order has shipped and when it's delivered in business days. 0 means that the order is delivered on the same day as it ships. minTransitTime can only be present together with maxTransitTime; but it's not required if maxTransitTime is present.

        :param min_transit_time: The min_transit_time of this ProductShipping.
        :type min_transit_time: str
        """
