...
class AccountUser(Model):
    ...
    def __init__(self, admin: bool=None, email_address: str=None, order_manager: bool=None, payments_analyst: bool=None, payments_manager: bool=None, reporting_manager: bool=None):
        ...
        :param reporting_manager: The reporting_manager of this AccountUser.
        """
        self.openapi_types = {
            'admin': bool,
            'email_address': str,
    ...
    def reporting_manager(self):
        """Gets the reporting_manager of this AccountUser.

        Whether user is a reporting manager.

        :return: The reporting_manager of this AccountUser.
        :rtype: bool
        """
        return self._reporting_manager

    @reporting_manager.setter
    def reporting_manager(self, reporting_manager):
        """Sets the reporting_manager of this AccountUser.

        Whether user is a reporting manager.

        :param reporting_manager: The reporting_manager of this AccountUser.
        :type reporting_manager: bool
        """
