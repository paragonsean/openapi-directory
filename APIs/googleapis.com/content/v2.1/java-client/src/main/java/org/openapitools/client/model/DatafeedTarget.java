...
public class DatafeedTarget {
  ...
  public static final String SERIALIZED_NAME_TARGET_COUNTRIES = "targetCountries";
  @SerializedName(SERIALIZED_NAME_TARGET_COUNTRIES)
  ...
  public DatafeedTarget feedLabel(String feedLabel) {
  ...
  public DatafeedTarget targetCountries(List<String> targetCountries) {
    this.targetCountries = targetCountries;
    return this;
  }

  public DatafeedTarget addTargetCountriesItem(String targetCountriesItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.country, datafeedTarget.country) &&
        ...
        Objects.equals(this.feedLabel, datafeedTarget.feedLabel) &&
        ...
        Objects.equals(this.targetCountries, datafeedTarget.targetCountries);
  }

  @Override
  public int hashCode() {
    return Objects.hash(country, excludedDestinations, feedLabel, includedDestinations, language, targetCountries);
  }
  ...
  public String toString() {
    ...
    sb.append("    targetCountries: ").append(toIndentedString(targetCountries)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("targetCountries");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // ensure the optional json data is an array if present
      if (jsonObj.get("targetCountries") != null && !jsonObj.get("targetCountries").isJsonNull() && !jsonObj.get("targetCountries").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `targetCountries` to be an array in the JSON string but got `%s`", jsonObj.get("targetCountries").toString()));
      }
  }
