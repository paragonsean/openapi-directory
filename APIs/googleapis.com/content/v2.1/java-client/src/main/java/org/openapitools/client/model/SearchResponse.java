...
public class SearchResponse {
  ...
  private List<ReportRow> results = new ArrayList<>();

  public SearchResponse() {
  }

  public SearchResponse nextPageToken(String nextPageToken) {
  ...
  public SearchResponse results(List<ReportRow> results) {
    this.results = results;
    return this;
  }

  public SearchResponse addResultsItem(ReportRow resultsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<ReportRow> getResults() {
    return results;
  }

  public void setResults(List<ReportRow> results) {
    this.results = results;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.nextPageToken, searchResponse.nextPageToken) &&
      ...
      if (jsonObj.get("results") != null && !jsonObj.get("results").isJsonNull()) {
        ...
        if (jsonArrayresults != null) {
          ...
          for (int i = 0; i < jsonArrayresults.size(); i++) {
            ReportRow.validateJsonElement(jsonArrayresults.get(i));
          };
        }
      }
  }
