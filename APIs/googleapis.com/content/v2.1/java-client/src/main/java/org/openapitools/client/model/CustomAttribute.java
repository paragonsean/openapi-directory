...
public class CustomAttribute {
  ...
  private List<CustomAttribute> groupValues = new ArrayList<>();
  ...
  public CustomAttribute groupValues(List<CustomAttribute> groupValues) {
    this.groupValues = groupValues;
    return this;
  }

  public CustomAttribute addGroupValuesItem(CustomAttribute groupValuesItem) {
  ...
  public void setGroupValues(List<CustomAttribute> groupValues) {
    this.groupValues = groupValues;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.groupValues, customAttribute.groupValues) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(groupValues, name, value);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("groupValues") != null && !jsonObj.get("groupValues").isJsonNull()) {
        JsonArray jsonArraygroupValues = jsonObj.getAsJsonArray("groupValues");
        if (jsonArraygroupValues != null) {
          // ensure the json data is an array
          if (!jsonObj.get("groupValues").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `groupValues` to be an array in the JSON string but got `%s`", jsonObj.get("groupValues").toString()));
          }

          // validate the optional field `groupValues` (array)
          for (int i = 0; i < jsonArraygroupValues.size(); i++) {
            CustomAttribute.validateJsonElement(jsonArraygroupValues.get(i));
          };
        }
      }
