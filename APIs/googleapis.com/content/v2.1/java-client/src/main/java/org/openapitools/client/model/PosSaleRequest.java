...
public class PosSaleRequest {
  ...
  public PosSaleRequest contentLanguage(String contentLanguage) {
  ...
  public PosSaleRequest gtin(String gtin) {
    this.gtin = gtin;
    return this;
  }
  ...
  public PosSaleRequest itemId(String itemId) {
    this.itemId = itemId;
    return this;
  }
  ...
  public PosSaleRequest price(Price price) {
    this.price = price;
    return this;
  }
  ...
  public PosSaleRequest quantity(String quantity) {
  ...
  public PosSaleRequest saleId(String saleId) {
    this.saleId = saleId;
    return this;
  }
  ...
  public PosSaleRequest storeCode(String storeCode) {
  ...
  public PosSaleRequest targetCountry(String targetCountry) {
  ...
  public PosSaleRequest timestamp(String timestamp) {
  ...
  public boolean equals(Object o) {
    ...
    PosSaleRequest posSaleRequest = (PosSaleRequest) o;
    return Objects.equals(this.contentLanguage, posSaleRequest.contentLanguage) &&
        Objects.equals(this.gtin, posSaleRequest.gtin) &&
        Objects.equals(this.itemId, posSaleRequest.itemId) &&
        Objects.equals(this.price, posSaleRequest.price) &&
        Objects.equals(this.quantity, posSaleRequest.quantity) &&
        Objects.equals(this.saleId, posSaleRequest.saleId) &&
        Objects.equals(this.storeCode, posSaleRequest.storeCode) &&
        Objects.equals(this.targetCountry, posSaleRequest.targetCountry) &&
        Objects.equals(this.timestamp, posSaleRequest.timestamp);
  }

  @Override
  public int hashCode() {
    return Objects.hash(contentLanguage, gtin, itemId, price, quantity, saleId, storeCode, targetCountry, timestamp);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PosSaleRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PosSaleRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PosSaleRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PosSaleRequest is not found in the empty JSON string", PosSaleRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PosSaleRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PosSaleRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PosSaleRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PosSaleRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PosSaleRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PosSaleRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PosSaleRequest>() {
           @Override
           public void write(JsonWriter out, PosSaleRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PosSaleRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PosSaleRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PosSaleRequest
   * @throws IOException if the JSON string is invalid with respect to PosSaleRequest
   */
  public static PosSaleRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PosSaleRequest.class);
  }

  /**
   * Convert an instance of PosSaleRequest to an JSON string
   *
   * @return JSON string
   */
