...
public class PosSaleResponse {
  ...
  public PosSaleResponse contentLanguage(String contentLanguage) {
  ...
  public PosSaleResponse gtin(String gtin) {
    this.gtin = gtin;
    return this;
  }
  ...
  public PosSaleResponse itemId(String itemId) {
    this.itemId = itemId;
    return this;
  }
  ...
  public PosSaleResponse kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  public PosSaleResponse price(Price price) {
    this.price = price;
    return this;
  }
  ...
  public PosSaleResponse quantity(String quantity) {
  ...
  public PosSaleResponse saleId(String saleId) {
    this.saleId = saleId;
    return this;
  }
  ...
  public PosSaleResponse storeCode(String storeCode) {
  ...
  public PosSaleResponse targetCountry(String targetCountry) {
  ...
  public PosSaleResponse timestamp(String timestamp) {
  ...
  public boolean equals(Object o) {
    ...
    PosSaleResponse posSaleResponse = (PosSaleResponse) o;
    return Objects.equals(this.contentLanguage, posSaleResponse.contentLanguage) &&
        Objects.equals(this.gtin, posSaleResponse.gtin) &&
        Objects.equals(this.itemId, posSaleResponse.itemId) &&
        Objects.equals(this.kind, posSaleResponse.kind) &&
        Objects.equals(this.price, posSaleResponse.price) &&
        Objects.equals(this.quantity, posSaleResponse.quantity) &&
        Objects.equals(this.saleId, posSaleResponse.saleId) &&
        Objects.equals(this.storeCode, posSaleResponse.storeCode) &&
        Objects.equals(this.targetCountry, posSaleResponse.targetCountry) &&
        Objects.equals(this.timestamp, posSaleResponse.timestamp);
  }
  ...
  public String toString() {
    ...
    sb.append("class PosSaleResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PosSaleResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PosSaleResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PosSaleResponse is not found in the empty JSON string", PosSaleResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PosSaleResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PosSaleResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PosSaleResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PosSaleResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PosSaleResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PosSaleResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PosSaleResponse>() {
           @Override
           public void write(JsonWriter out, PosSaleResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PosSaleResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PosSaleResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PosSaleResponse
   * @throws IOException if the JSON string is invalid with respect to PosSaleResponse
   */
  public static PosSaleResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PosSaleResponse.class);
  }

  /**
   * Convert an instance of PosSaleResponse to an JSON string
   *
   * @return JSON string
   */
