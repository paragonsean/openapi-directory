...
public class FreeListingsProgramStatusRegionStatus {
  ...
  public FreeListingsProgramStatusRegionStatus disapprovalDate(String disapprovalDate) {
  ...
  public FreeListingsProgramStatusRegionStatus eligibilityStatus(EligibilityStatusEnum eligibilityStatus) {
  ...
  public FreeListingsProgramStatusRegionStatus onboardingIssues(List<String> onboardingIssues) {
    this.onboardingIssues = onboardingIssues;
    return this;
  }

  public FreeListingsProgramStatusRegionStatus addOnboardingIssuesItem(String onboardingIssuesItem) {
  ...
  public FreeListingsProgramStatusRegionStatus regionCodes(List<String> regionCodes) {
    this.regionCodes = regionCodes;
    return this;
  }

  public FreeListingsProgramStatusRegionStatus addRegionCodesItem(String regionCodesItem) {
  ...
  public FreeListingsProgramStatusRegionStatus reviewEligibilityStatus(ReviewEligibilityStatusEnum reviewEligibilityStatus) {
  ...
  public FreeListingsProgramStatusRegionStatus reviewIneligibilityReason(ReviewIneligibilityReasonEnum reviewIneligibilityReason) {
  ...
  public FreeListingsProgramStatusRegionStatus reviewIneligibilityReasonDescription(String reviewIneligibilityReasonDescription) {
  ...
  public FreeListingsProgramStatusRegionStatus reviewIneligibilityReasonDetails(FreeListingsProgramStatusReviewIneligibilityReasonDetails reviewIneligibilityReasonDetails) {
  ...
  public void setReviewIneligibilityReasonDetails(FreeListingsProgramStatusReviewIneligibilityReasonDetails reviewIneligibilityReasonDetails) {
    this.reviewIneligibilityReasonDetails = reviewIneligibilityReasonDetails;
  }


  public FreeListingsProgramStatusRegionStatus reviewIssues(List<String> reviewIssues) {
    this.reviewIssues = reviewIssues;
    return this;
  }

  public FreeListingsProgramStatusRegionStatus addReviewIssuesItem(String reviewIssuesItem) {
  ...
  public boolean equals(Object o) {
    ...
    FreeListingsProgramStatusRegionStatus freeListingsProgramStatusRegionStatus = (FreeListingsProgramStatusRegionStatus) o;
    return Objects.equals(this.disapprovalDate, freeListingsProgramStatusRegionStatus.disapprovalDate) &&
        Objects.equals(this.eligibilityStatus, freeListingsProgramStatusRegionStatus.eligibilityStatus) &&
        Objects.equals(this.onboardingIssues, freeListingsProgramStatusRegionStatus.onboardingIssues) &&
        Objects.equals(this.regionCodes, freeListingsProgramStatusRegionStatus.regionCodes) &&
        Objects.equals(this.reviewEligibilityStatus, freeListingsProgramStatusRegionStatus.reviewEligibilityStatus) &&
        Objects.equals(this.reviewIneligibilityReason, freeListingsProgramStatusRegionStatus.reviewIneligibilityReason) &&
        Objects.equals(this.reviewIneligibilityReasonDescription, freeListingsProgramStatusRegionStatus.reviewIneligibilityReasonDescription) &&
        Objects.equals(this.reviewIneligibilityReasonDetails, freeListingsProgramStatusRegionStatus.reviewIneligibilityReasonDetails) &&
        Objects.equals(this.reviewIssues, freeListingsProgramStatusRegionStatus.reviewIssues);
  }
  ...
  public String toString() {
    ...
    sb.append("class FreeListingsProgramStatusRegionStatus {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FreeListingsProgramStatusRegionStatus
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FreeListingsProgramStatusRegionStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FreeListingsProgramStatusRegionStatus is not found in the empty JSON string", FreeListingsProgramStatusRegionStatus.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FreeListingsProgramStatusRegionStatus.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FreeListingsProgramStatusRegionStatus` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("reviewIneligibilityReasonDetails") != null && !jsonObj.get("reviewIneligibilityReasonDetails").isJsonNull()) {
        FreeListingsProgramStatusReviewIneligibilityReasonDetails.validateJsonElement(jsonObj.get("reviewIneligibilityReasonDetails"));
      }
      // ensure the optional json data is an array if present
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FreeListingsProgramStatusRegionStatus.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FreeListingsProgramStatusRegionStatus' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FreeListingsProgramStatusRegionStatus> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FreeListingsProgramStatusRegionStatus.class));

       return (TypeAdapter<T>) new TypeAdapter<FreeListingsProgramStatusRegionStatus>() {
           @Override
           public void write(JsonWriter out, FreeListingsProgramStatusRegionStatus value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FreeListingsProgramStatusRegionStatus read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FreeListingsProgramStatusRegionStatus given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FreeListingsProgramStatusRegionStatus
   * @throws IOException if the JSON string is invalid with respect to FreeListingsProgramStatusRegionStatus
   */
  public static FreeListingsProgramStatusRegionStatus fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FreeListingsProgramStatusRegionStatus.class);
  }

  /**
   * Convert an instance of FreeListingsProgramStatusRegionStatus to an JSON string
   *
   * @return JSON string
   */
