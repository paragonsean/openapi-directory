...
public class ApiClient {
    ...
    private String basePath = "https://shoppingcontent.googleapis.com/content/v2.1";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://shoppingcontent.googleapis.com/content/v2.1
