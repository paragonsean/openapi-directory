...
public class OrderLineItemProduct {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(brand, condition, contentLanguage, fees, gtin, id, imageLink, itemGroupId, mpn, offerId, price, shownImage, targetCountry, title, variantAttributes);
  }
