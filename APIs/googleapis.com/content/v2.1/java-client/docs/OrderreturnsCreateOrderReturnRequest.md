...
|------------ | ------------- | ------------- | -------------|
|**lineItems** | [**List&lt;OrderreturnsLineItem&gt;**](OrderreturnsLineItem.md) | The list of line items to return. |  [optional] |
...
|**returnMethodType** | **String** | The way of the package being returned. |  [optional] |
