...
**pricePercentage** | **String** | A percentage of the price represented as a number in decimal notation (e.g., &#x60;\&quot;5.4\&quot;&#x60;). Can only be set if all other fields are not set. | [optional] 
**subtableName** | **String** | The name of a subtable. Can only be set in table cells (i.e., not for single values), and only if all other fields are not set. | [optional] 
