# ContentApiForShopping.Datafeed
...
**intendedDestinations** | **[String]** | [DEPRECATED] Please use targets[].includedDestinations instead. The list of intended destinations (corresponds to checked check boxes in Merchant Center). | [optional] 
...
**targets** | [**[DatafeedTarget]**](DatafeedTarget.md) | The targets this feed should apply to (country, language, destinations). | [optional] 
