...
class UnitInvoice {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('unitPricePretax')) {
                obj['unitPricePretax'] = Price.constructFromObject(data['unitPricePretax']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['unitPricePretax']) { // data not null
          Price.validateJSON(data['unitPricePretax']);
        }
 ...
 */
UnitInvoice.prototype['promotions'] = undefined;

/**
 * @member {module:model/Price} unitPricePretax
 */
UnitInvoice.prototype['unitPricePretax'] = undefined;
