...
class ProductStatus {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('dataQualityIssues')) {
                obj['dataQualityIssues'] = ApiClient.convertToType(data['dataQualityIssues'], [ProductStatusDataQualityIssue]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['dataQualityIssues']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['dataQualityIssues'])) {
                throw new Error("Expected the field `dataQualityIssues` to be an array in the JSON data but got " + data['dataQualityIssues']);
            }
            // validate the optional field `dataQualityIssues` (array)
            for (const item of data['dataQualityIssues']) {
                ProductStatusDataQualityIssue.validateJSON(item);
            };
        }
 ...
 * @member {Array.<module:model/ProductStatusDataQualityIssue>} dataQualityIssues
 */
ProductStatus.prototype['dataQualityIssues'] = undefined;
 ...
 */
ProductStatus.prototype['product'] = undefined;
