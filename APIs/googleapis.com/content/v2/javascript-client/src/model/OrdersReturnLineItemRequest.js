...
/**
 * The OrdersReturnLineItemRequest model module.
 * @module model/OrdersReturnLineItemRequest
 * @version v2
 */
class OrdersReturnLineItemRequest {
    /**
     * Constructs a new <code>OrdersReturnLineItemRequest</code>.
     * @alias module:model/OrdersReturnLineItemRequest
     */
    constructor() { 
        
        OrdersReturnLineItemRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OrdersReturnLineItemRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OrdersReturnLineItemRequest} obj Optional instance to populate.
     * @return {module:model/OrdersReturnLineItemRequest} The populated <code>OrdersReturnLineItemRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrdersReturnLineItemRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>OrdersReturnLineItemRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrdersReturnLineItemRequest</code>.
     */
 ...
 */
OrdersReturnLineItemRequest.prototype['lineItemId'] = undefined;

/**
 * The ID of the operation. Unique across all operations for a given order.
 * @member {String} operationId
 */
OrdersReturnLineItemRequest.prototype['operationId'] = undefined;

/**
 * The ID of the product to return. This is the REST ID used in the products service. Either lineItemId or productId is required.
 * @member {String} productId
 */
OrdersReturnLineItemRequest.prototype['productId'] = undefined;

/**
 * The quantity to return.
 * @member {Number} quantity
 */
OrdersReturnLineItemRequest.prototype['quantity'] = undefined;
 ...
 */
OrdersReturnLineItemRequest.prototype['reason'] = undefined;

/**
 * The explanation of the reason.
 * @member {String} reasonText
 */
OrdersReturnLineItemRequest.prototype['reasonText'] = undefined;
...
export default OrdersReturnLineItemRequest;
