...
class OrderReportTransaction {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('productAmount')) {
                obj['productAmount'] = Amount.constructFromObject(data['productAmount']);
            }
            if (data.hasOwnProperty('productAmountWithRemittedTax')) {
                obj['productAmountWithRemittedTax'] = ProductAmount.constructFromObject(data['productAmountWithRemittedTax']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['productAmount']) { // data not null
          Amount.validateJSON(data['productAmount']);
        }
        // validate the optional field `productAmountWithRemittedTax`
        if (data['productAmountWithRemittedTax']) { // data not null
          ProductAmount.validateJSON(data['productAmountWithRemittedTax']);
        }
        // ensure the json data is a string
...
/**
 * @member {module:model/Amount} productAmount
 */
OrderReportTransaction.prototype['productAmount'] = undefined;

/**
 * @member {module:model/ProductAmount} productAmountWithRemittedTax
 */
OrderReportTransaction.prototype['productAmountWithRemittedTax'] = undefined;
