...
/**
 * The RefundReason model module.
 * @module model/RefundReason
 * @version v2
 */
class RefundReason {
    /**
     * Constructs a new <code>RefundReason</code>.
     * @alias module:model/RefundReason
     */
    constructor() { 
        
        RefundReason.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RefundReason</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RefundReason} obj Optional instance to populate.
     * @return {module:model/RefundReason} The populated <code>RefundReason</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RefundReason();
    ...
    /**
     * Validates the JSON data with respect to <code>RefundReason</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RefundReason</code>.
     */
 ...
 */
RefundReason.prototype['description'] = undefined;
 ...
 */
RefundReason.prototype['reasonCode'] = undefined;
