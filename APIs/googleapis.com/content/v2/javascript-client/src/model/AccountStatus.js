    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('dataQualityIssues')) {
                obj['dataQualityIssues'] = ApiClient.convertToType(data['dataQualityIssues'], [AccountStatusDataQualityIssue]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['dataQualityIssues']) { // data not null
            ...
            for (const item of data['dataQualityIssues']) {
                AccountStatusDataQualityIssue.validateJSON(item);
            };
        }
        // ensure the json data is a string
 ...
 * @member {Array.<module:model/AccountStatusDataQualityIssue>} dataQualityIssues
 */
AccountStatus.prototype['dataQualityIssues'] = undefined;
