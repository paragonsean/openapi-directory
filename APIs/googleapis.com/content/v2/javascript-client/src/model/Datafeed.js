...
class Datafeed {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('intendedDestinations')) {
                obj['intendedDestinations'] = ApiClient.convertToType(data['intendedDestinations'], ['String']);
            }
    ...
    static validateJSON(data) {
        ...
        if (!Array.isArray(data['intendedDestinations'])) {
            throw new Error("Expected the field `intendedDestinations` to be an array in the JSON data but got " + data['intendedDestinations']);
        }
        // ensure the json data is a string
 ...
 */
Datafeed.prototype['contentLanguage'] = undefined;
 ...
 * @member {Array.<String>} intendedDestinations
 */
Datafeed.prototype['intendedDestinations'] = undefined;
 ...
 */
Datafeed.prototype['targetCountry'] = undefined;
