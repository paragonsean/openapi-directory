...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentApiForShopping.OrdersReturnLineItemRequest();
  });
  ...
  describe('OrdersReturnLineItemRequest', function() {
    it('should create an instance of OrdersReturnLineItemRequest', function() {
      // uncomment below and update the code to test OrdersReturnLineItemRequest
      //var instance = new ContentApiForShopping.OrdersReturnLineItemRequest();
      //expect(instance).to.be.a(ContentApiForShopping.OrdersReturnLineItemRequest);
    });
