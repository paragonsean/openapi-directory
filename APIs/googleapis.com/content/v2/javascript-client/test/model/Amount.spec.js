...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentApiForShopping.Amount();
  });
  ...
  describe('Amount', function() {
    it('should create an instance of Amount', function() {
      ...
      //var instance = new ContentApiForShopping.Amount();
      //expect(instance).to.be.a(ContentApiForShopping.Amount);
    });

    it('should have the property pretax (base name: "pretax")', function() {
      // uncomment below and update the code to test the property pretax
      //var instance = new ContentApiForShopping.Amount();
