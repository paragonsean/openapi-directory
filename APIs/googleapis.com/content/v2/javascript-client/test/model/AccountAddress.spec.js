...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentApiForShopping.AccountAddress();
  });
  ...
  describe('AccountAddress', function() {
    it('should create an instance of AccountAddress', function() {
      // uncomment below and update the code to test AccountAddress
      //var instance = new ContentApiForShopping.AccountAddress();
      //expect(instance).to.be.a(ContentApiForShopping.AccountAddress);
    });
