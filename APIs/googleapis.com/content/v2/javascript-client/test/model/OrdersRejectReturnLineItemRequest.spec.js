...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentApiForShopping.OrdersRejectReturnLineItemRequest();
  });
  ...
  describe('OrdersRejectReturnLineItemRequest', function() {
    it('should create an instance of OrdersRejectReturnLineItemRequest', function() {
      // uncomment below and update the code to test OrdersRejectReturnLineItemRequest
      //var instance = new ContentApiForShopping.OrdersRejectReturnLineItemRequest();
      //expect(instance).to.be.a(ContentApiForShopping.OrdersRejectReturnLineItemRequest);
    });
