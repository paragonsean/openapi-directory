...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentApiForShopping.PosInventory();
  });
  ...
  describe('PosInventory', function() {
    it('should create an instance of PosInventory', function() {
      // uncomment below and update the code to test PosInventory
      //var instance = new ContentApiForShopping.PosInventory();
      //expect(instance).to.be.a(ContentApiForShopping.PosInventory);
    });
