...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentApiForShopping.OrdersCustomBatchRequestEntryUpdateShipment();
  });
  ...
  describe('OrdersCustomBatchRequestEntryUpdateShipment', function() {
    it('should create an instance of OrdersCustomBatchRequestEntryUpdateShipment', function() {
      // uncomment below and update the code to test OrdersCustomBatchRequestEntryUpdateShipment
      //var instance = new ContentApiForShopping.OrdersCustomBatchRequestEntryUpdateShipment();
      //expect(instance).to.be.a(ContentApiForShopping.OrdersCustomBatchRequestEntryUpdateShipment);
    });
