...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentApiForShopping.ShipmentTrackingInfo();
  });
  ...
  describe('ShipmentTrackingInfo', function() {
    it('should create an instance of ShipmentTrackingInfo', function() {
      // uncomment below and update the code to test ShipmentTrackingInfo
      //var instance = new ContentApiForShopping.ShipmentTrackingInfo();
      //expect(instance).to.be.a(ContentApiForShopping.ShipmentTrackingInfo);
    });
