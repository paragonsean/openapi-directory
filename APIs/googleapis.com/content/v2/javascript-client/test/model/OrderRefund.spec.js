...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentApiForShopping.OrderRefund();
  });
  ...
  describe('OrderRefund', function() {
    it('should create an instance of OrderRefund', function() {
      ...
      //var instance = new ContentApiForShopping.OrderRefund();
      //expect(instance).to.be.a(ContentApiForShopping.OrderRefund);
    });
