...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContentApiForShopping.PosSale();
  });
  ...
  describe('PosSale', function() {
    it('should create an instance of PosSale', function() {
      // uncomment below and update the code to test PosSale
      //var instance = new ContentApiForShopping.PosSale();
      //expect(instance).to.be.a(ContentApiForShopping.PosSale);
    });
