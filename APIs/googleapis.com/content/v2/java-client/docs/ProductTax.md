...
|**locationId** | **String** | The numeric ID of a location that the tax rate applies to as defined in the AdWords API. |  [optional] |
...
|**taxShip** | **Boolean** | Should be set to true if tax is charged on shipping. |  [optional] |
