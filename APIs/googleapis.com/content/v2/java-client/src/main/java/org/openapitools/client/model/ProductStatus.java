...
public class ProductStatus {
  ...
  private List<ProductStatusDataQualityIssue> dataQualityIssues = new ArrayList<>();
  ...
  public ProductStatus dataQualityIssues(List<ProductStatusDataQualityIssue> dataQualityIssues) {
    this.dataQualityIssues = dataQualityIssues;
    return this;
  }

  public ProductStatus addDataQualityIssuesItem(ProductStatusDataQualityIssue dataQualityIssuesItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<ProductStatusDataQualityIssue> getDataQualityIssues() {
    return dataQualityIssues;
  }

  public void setDataQualityIssues(List<ProductStatusDataQualityIssue> dataQualityIssues) {
    this.dataQualityIssues = dataQualityIssues;
  }
  ...
  public ProductStatus product(Product product) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.creationDate, productStatus.creationDate) &&
        Objects.equals(this.dataQualityIssues, productStatus.dataQualityIssues) &&
        ...
        Objects.equals(this.product, productStatus.product) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(creationDate, dataQualityIssues, destinationStatuses, googleExpirationDate, itemLevelIssues, kind, lastUpdateDate, link, product, productId, title);
  }
      ...
      if (jsonObj.get("dataQualityIssues") != null && !jsonObj.get("dataQualityIssues").isJsonNull()) {
        ...
        if (jsonArraydataQualityIssues != null) {
          ...
          for (int i = 0; i < jsonArraydataQualityIssues.size(); i++) {
            ProductStatusDataQualityIssue.validateJsonElement(jsonArraydataQualityIssues.get(i));
          };
        }
      }
