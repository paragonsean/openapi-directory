...
public class Service {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(active, currency, deliveryCountry, deliveryTime, eligibility, minimumOrderValue, minimumOrderValueTable, name, pickupService, rateGroups, shipmentType);
  }
