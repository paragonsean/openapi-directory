...
public class OrderinvoicesCreateChargeInvoiceRequest {
  ...
  public OrderinvoicesCreateChargeInvoiceRequest invoiceId(String invoiceId) {
  ...
  public OrderinvoicesCreateChargeInvoiceRequest invoiceSummary(InvoiceSummary invoiceSummary) {
  ...
  public OrderinvoicesCreateChargeInvoiceRequest lineItemInvoices(List<ShipmentInvoiceLineItemInvoice> lineItemInvoices) {
    this.lineItemInvoices = lineItemInvoices;
    return this;
  }

  public OrderinvoicesCreateChargeInvoiceRequest addLineItemInvoicesItem(ShipmentInvoiceLineItemInvoice lineItemInvoicesItem) {
  ...
  public OrderinvoicesCreateChargeInvoiceRequest operationId(String operationId) {
  ...
  public OrderinvoicesCreateChargeInvoiceRequest shipmentGroupId(String shipmentGroupId) {
  ...
  public boolean equals(Object o) {
    ...
    OrderinvoicesCreateChargeInvoiceRequest orderinvoicesCreateChargeInvoiceRequest = (OrderinvoicesCreateChargeInvoiceRequest) o;
    return Objects.equals(this.invoiceId, orderinvoicesCreateChargeInvoiceRequest.invoiceId) &&
        Objects.equals(this.invoiceSummary, orderinvoicesCreateChargeInvoiceRequest.invoiceSummary) &&
        Objects.equals(this.lineItemInvoices, orderinvoicesCreateChargeInvoiceRequest.lineItemInvoices) &&
        Objects.equals(this.operationId, orderinvoicesCreateChargeInvoiceRequest.operationId) &&
        Objects.equals(this.shipmentGroupId, orderinvoicesCreateChargeInvoiceRequest.shipmentGroupId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(invoiceId, invoiceSummary, lineItemInvoices, operationId, shipmentGroupId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OrderinvoicesCreateChargeInvoiceRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OrderinvoicesCreateChargeInvoiceRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrderinvoicesCreateChargeInvoiceRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrderinvoicesCreateChargeInvoiceRequest is not found in the empty JSON string", OrderinvoicesCreateChargeInvoiceRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrderinvoicesCreateChargeInvoiceRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrderinvoicesCreateChargeInvoiceRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrderinvoicesCreateChargeInvoiceRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrderinvoicesCreateChargeInvoiceRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrderinvoicesCreateChargeInvoiceRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrderinvoicesCreateChargeInvoiceRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<OrderinvoicesCreateChargeInvoiceRequest>() {
           @Override
           public void write(JsonWriter out, OrderinvoicesCreateChargeInvoiceRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrderinvoicesCreateChargeInvoiceRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OrderinvoicesCreateChargeInvoiceRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OrderinvoicesCreateChargeInvoiceRequest
   * @throws IOException if the JSON string is invalid with respect to OrderinvoicesCreateChargeInvoiceRequest
   */
  public static OrderinvoicesCreateChargeInvoiceRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrderinvoicesCreateChargeInvoiceRequest.class);
  }

  /**
   * Convert an instance of OrderinvoicesCreateChargeInvoiceRequest to an JSON string
   *
   * @return JSON string
   */
