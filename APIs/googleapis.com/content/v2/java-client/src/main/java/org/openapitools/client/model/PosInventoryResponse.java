...
public class PosInventoryResponse {
  ...
  public PosInventoryResponse() {
  }

  public PosInventoryResponse contentLanguage(String contentLanguage) {
  ...
  public PosInventoryResponse gtin(String gtin) {
    this.gtin = gtin;
    return this;
  }
  ...
  public PosInventoryResponse itemId(String itemId) {
    this.itemId = itemId;
    return this;
  }
  ...
  public PosInventoryResponse kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  public PosInventoryResponse price(Price price) {
    this.price = price;
    return this;
  }
  ...
  public PosInventoryResponse quantity(String quantity) {
  ...
  public PosInventoryResponse storeCode(String storeCode) {
  ...
  public PosInventoryResponse targetCountry(String targetCountry) {
  ...
  public PosInventoryResponse timestamp(String timestamp) {
  ...
  public boolean equals(Object o) {
    ...
    PosInventoryResponse posInventoryResponse = (PosInventoryResponse) o;
    return Objects.equals(this.contentLanguage, posInventoryResponse.contentLanguage) &&
        Objects.equals(this.gtin, posInventoryResponse.gtin) &&
        Objects.equals(this.itemId, posInventoryResponse.itemId) &&
        Objects.equals(this.kind, posInventoryResponse.kind) &&
        Objects.equals(this.price, posInventoryResponse.price) &&
        Objects.equals(this.quantity, posInventoryResponse.quantity) &&
        Objects.equals(this.storeCode, posInventoryResponse.storeCode) &&
        Objects.equals(this.targetCountry, posInventoryResponse.targetCountry) &&
        Objects.equals(this.timestamp, posInventoryResponse.timestamp);
  }
  ...
  public String toString() {
    ...
    sb.append("class PosInventoryResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PosInventoryResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PosInventoryResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PosInventoryResponse is not found in the empty JSON string", PosInventoryResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PosInventoryResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PosInventoryResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PosInventoryResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PosInventoryResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PosInventoryResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PosInventoryResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PosInventoryResponse>() {
           @Override
           public void write(JsonWriter out, PosInventoryResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PosInventoryResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PosInventoryResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PosInventoryResponse
   * @throws IOException if the JSON string is invalid with respect to PosInventoryResponse
   */
  public static PosInventoryResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PosInventoryResponse.class);
  }

  /**
   * Convert an instance of PosInventoryResponse to an JSON string
   *
   * @return JSON string
   */
