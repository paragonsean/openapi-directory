...
public class Order {
  ...
  public Order channelType(String channelType) {
  ...
  public Order netAmount(Price netAmount) {
  ...
  public void setNetAmount(Price netAmount) {
    this.netAmount = netAmount;
  }
  ...
  public Order promotions(List<OrderLegacyPromotion> promotions) {
    this.promotions = promotions;
    return this;
  }

  public Order addPromotionsItem(OrderLegacyPromotion promotionsItem) {
  ...
  public Order shippingOption(String shippingOption) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.acknowledged, order.acknowledged) &&
        Objects.equals(this.channelType, order.channelType) &&
        ...
        Objects.equals(this.netAmount, order.netAmount) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(acknowledged, channelType, customer, deliveryDetails, id, kind, lineItems, merchantId, merchantOrderId, netAmount, paymentMethod, paymentStatus, pickupDetails, placedDate, promotions, refunds, shipments, shippingCost, shippingCostTax, shippingOption, status, taxCollector);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("netAmount") != null && !jsonObj.get("netAmount").isJsonNull()) {
        Price.validateJsonElement(jsonObj.get("netAmount"));
      }
      // validate the optional field `paymentMethod`
      if (jsonObj.get("paymentMethod") != null && !jsonObj.get("paymentMethod").isJsonNull()) {
        OrderPaymentMethod.validateJsonElement(jsonObj.get("paymentMethod"));
      }
