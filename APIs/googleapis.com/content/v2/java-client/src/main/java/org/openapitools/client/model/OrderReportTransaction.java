...
public class OrderReportTransaction {
  ...
  public static final String SERIALIZED_NAME_PRODUCT_AMOUNT_WITH_REMITTED_TAX = "productAmountWithRemittedTax";
  @SerializedName(SERIALIZED_NAME_PRODUCT_AMOUNT_WITH_REMITTED_TAX)
  ...
  public OrderReportTransaction productAmount(Amount productAmount) {
  ...
  public OrderReportTransaction productAmountWithRemittedTax(ProductAmount productAmountWithRemittedTax) {
    this.productAmountWithRemittedTax = productAmountWithRemittedTax;
    return this;
  }

  /**
   * Get productAmountWithRemittedTax
  ...
  public void setProductAmountWithRemittedTax(ProductAmount productAmountWithRemittedTax) {
    this.productAmountWithRemittedTax = productAmountWithRemittedTax;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.disbursementAmount, orderReportTransaction.disbursementAmount) &&
        ...
        Objects.equals(this.productAmountWithRemittedTax, orderReportTransaction.productAmountWithRemittedTax) &&
        Objects.equals(this.transactionDate, orderReportTransaction.transactionDate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(disbursementAmount, disbursementCreationDate, disbursementDate, disbursementId, merchantId, merchantOrderId, orderId, productAmount, productAmountWithRemittedTax, transactionDate);
  }
  ...
  public String toString() {
    ...
    sb.append("    productAmountWithRemittedTax: ").append(toIndentedString(productAmountWithRemittedTax)).append("\n");
  ...
  static {
    ...
    openapiFields.add("productAmountWithRemittedTax");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("productAmount") != null && !jsonObj.get("productAmount").isJsonNull()) {
        Amount.validateJsonElement(jsonObj.get("productAmount"));
      }
      // validate the optional field `productAmountWithRemittedTax`
      if (jsonObj.get("productAmountWithRemittedTax") != null && !jsonObj.get("productAmountWithRemittedTax").isJsonNull()) {
        ProductAmount.validateJsonElement(jsonObj.get("productAmountWithRemittedTax"));
      }
