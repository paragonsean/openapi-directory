...
class LiasettingsCustomBatchResponseEntry(Model):
    ...
    def __init__(self, batch_id: int=None, errors: Errors=None, gmb_accounts: GmbAccounts=None, kind: str=None, lia_settings: LiaSettings=None, pos_data_providers: List[PosDataProviders]=None):
