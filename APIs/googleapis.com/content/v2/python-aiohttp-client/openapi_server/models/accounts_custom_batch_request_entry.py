...
class AccountsCustomBatchRequestEntry(Model):
    ...
    def __init__(self, account: Account=None, account_id: str=None, batch_id: int=None, force: bool=None, label_ids: List[str]=None, link_request: AccountsCustomBatchRequestEntryLinkRequest=None, merchant_id: str=None, method: str=None, overwrite: bool=None):
