...
class OrderShipment(Model):
    ...
    def __init__(self, carrier: str=None, creation_date: str=None, delivery_date: str=None, id: str=None, line_items: List[OrderShipmentLineItemShipment]=None, scheduled_delivery_details: OrderShipmentScheduledDeliveryDetails=None, status: str=None, tracking_id: str=None):
