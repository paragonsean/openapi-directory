...
class ProductStatus(Model):
    ...
    def __init__(self, creation_date: str=None, data_quality_issues: List[ProductStatusDataQualityIssue]=None, destination_statuses: List[ProductStatusDestinationStatus]=None, google_expiration_date: str=None, item_level_issues: List[ProductStatusItemLevelIssue]=None, kind: str=None, last_update_date: str=None, link: str=None, product: Product=None, product_id: str=None, title: str=None):
        """ProductStatus - a model defined in OpenAPI

        :param creation_date: The creation_date of this ProductStatus.
        :param data_quality_issues: The data_quality_issues of this ProductStatus.
        ...
        :param product: The product of this ProductStatus.
        :param product_id: The product_id of this ProductStatus.
        :param title: The title of this ProductStatus.
        """
        self.openapi_types = {
            'creation_date': str,
            'data_quality_issues': List[ProductStatusDataQualityIssue],
    ...
    def data_quality_issues(self):
        """Gets the data_quality_issues of this ProductStatus.

        DEPRECATED - never populated

        :return: The data_quality_issues of this ProductStatus.
        :rtype: List[ProductStatusDataQualityIssue]
        """
        return self._data_quality_issues

    @data_quality_issues.setter
    def data_quality_issues(self, data_quality_issues):
        """Sets the data_quality_issues of this ProductStatus.

        DEPRECATED - never populated

        :param data_quality_issues: The data_quality_issues of this ProductStatus.
        :type data_quality_issues: List[ProductStatusDataQualityIssue]
        """
    ...
    @property
    def product(self):
        """Gets the product of this ProductStatus.


        :return: The product of this ProductStatus.
        :rtype: Product
        """
    ...
    def product(self, product):
        """Sets the product of this ProductStatus.
