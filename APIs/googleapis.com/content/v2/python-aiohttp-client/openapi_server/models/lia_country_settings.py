...
class LiaCountrySettings(Model):
    ...
    def __init__(self, about: LiaAboutPageSettings=None, country: str=None, hosted_local_storefront_active: bool=None, inventory: LiaInventorySettings=None, on_display_to_order: LiaOnDisplayToOrderSettings=None, pos_data_provider: LiaPosDataProvider=None, store_pickup_active: bool=None):
