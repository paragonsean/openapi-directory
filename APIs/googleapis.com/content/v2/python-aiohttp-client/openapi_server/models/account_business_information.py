...
class AccountBusinessInformation(Model):
    ...
    def __init__(self, address: AccountAddress=None, customer_service: AccountCustomerService=None, korean_business_registration_number: str=None, phone_number: str=None):
