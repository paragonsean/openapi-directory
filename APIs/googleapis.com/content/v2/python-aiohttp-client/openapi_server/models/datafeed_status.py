...
class DatafeedStatus(Model):
    ...
    def __init__(self, country: str=None, datafeed_id: str=None, errors: List[DatafeedStatusError]=None, items_total: str=None, items_valid: str=None, kind: str=None, language: str=None, last_upload_date: str=None, processing_status: str=None, warnings: List[DatafeedStatusError]=None):
