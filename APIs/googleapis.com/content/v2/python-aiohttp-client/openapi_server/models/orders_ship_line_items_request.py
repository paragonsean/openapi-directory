...
class OrdersShipLineItemsRequest(Model):
    ...
    def __init__(self, carrier: str=None, line_items: List[OrderShipmentLineItemShipment]=None, operation_id: str=None, shipment_group_id: str=None, shipment_id: str=None, shipment_infos: List[OrdersCustomBatchRequestEntryShipLineItemsShipmentInfo]=None, tracking_id: str=None):
        """OrdersShipLineItemsRequest - a model defined in OpenAPI

        :param carrier: The carrier of this OrdersShipLineItemsRequest.
        ...
        :param shipment_id: The shipment_id of this OrdersShipLineItemsRequest.
        :param shipment_infos: The shipment_infos of this OrdersShipLineItemsRequest.
        :param tracking_id: The tracking_id of this OrdersShipLineItemsRequest.
        """
        self.openapi_types = {
            'carrier': str,
    ...
    @property
    def carrier(self):
        """Gets the carrier of this OrdersShipLineItemsRequest.
        ...
        :return: The carrier of this OrdersShipLineItemsRequest.
        :rtype: str
        """
    ...
    def carrier(self, carrier):
        """Sets the carrier of this OrdersShipLineItemsRequest.
    ...
    def shipment_id(self):
        """Gets the shipment_id of this OrdersShipLineItemsRequest.

        Deprecated. Please use shipmentInfo instead. The ID of the shipment.

        :return: The shipment_id of this OrdersShipLineItemsRequest.
        :rtype: str
        """
    ...
    def shipment_id(self, shipment_id):
        """Sets the shipment_id of this OrdersShipLineItemsRequest.
    ...
    def tracking_id(self):
        """Gets the tracking_id of this OrdersShipLineItemsRequest.

        Deprecated. Please use shipmentInfo instead. The tracking ID for the shipment.

        :return: The tracking_id of this OrdersShipLineItemsRequest.
        :rtype: str
        """
    ...
    def tracking_id(self, tracking_id):
        """Sets the tracking_id of this OrdersShipLineItemsRequest.
