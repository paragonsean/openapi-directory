...
QString OAIOrderLineItemProduct::getChannel() const {
    return m_channel;
}
void OAIOrderLineItemProduct::setChannel(const QString &channel) {
    m_channel = channel;
    m_channel_isSet = true;
}

bool OAIOrderLineItemProduct::is_channel_Set() const{
    return m_channel_isSet;
}

bool OAIOrderLineItemProduct::is_channel_Valid() const{
