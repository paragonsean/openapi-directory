...
public:
    ...
    OAIPrice getNetAmount() const;
    void setNetAmount(const OAIPrice &net_amount);
    bool is_net_amount_Set() const;
    bool is_net_amount_Valid() const;

    OAIOrderPaymentMethod getPaymentMethod() const;
    void setPaymentMethod(const OAIOrderPaymentMethod &payment_method);
...
private:
    ...
    OAIPrice m_net_amount;
    bool m_net_amount_isSet;
    bool m_net_amount_isValid;

    OAIOrderPaymentMethod m_payment_method;
