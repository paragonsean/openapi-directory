# OnDemandScanningApi.SbomReferenceIntotoPayload
...
**subject** | [**[Subject]**](Subject.md) | Set of software artifacts that the attestation applies to. Each element represents a single software artifact. | [optional] 
