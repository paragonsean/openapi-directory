# OnDemandScanningApi.WindowsUpdate

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**categories** | [**[Category]**](Category.md) | The list of categories to which the update belongs. | [optional] 
**description** | **String** | The localized description of the update. | [optional] 
**identity** | [**Identity**](Identity.md) |  | [optional] 
**kbArticleIds** | **[String]** | The Microsoft Knowledge Base article IDs that are associated with the update. | [optional] 
