...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnDemandScanningApi.SlsaProvenance();
  });
  ...
  describe('SlsaProvenance', function() {
    it('should create an instance of SlsaProvenance', function() {
      ...
      //var instance = new OnDemandScanningApi.SlsaProvenance();
      //expect(instance).to.be.a(OnDemandScanningApi.SlsaProvenance);
    });
