...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnDemandScanningApi.SlsaCompleteness();
  });
  ...
  describe('SlsaCompleteness', function() {
    it('should create an instance of SlsaCompleteness', function() {
      ...
      //var instance = new OnDemandScanningApi.SlsaCompleteness();
      //expect(instance).to.be.a(OnDemandScanningApi.SlsaCompleteness);
    });
