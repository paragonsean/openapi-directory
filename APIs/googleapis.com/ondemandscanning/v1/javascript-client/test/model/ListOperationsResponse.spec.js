...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnDemandScanningApi.ListOperationsResponse();
  });
  ...
  describe('ListOperationsResponse', function() {
    it('should create an instance of ListOperationsResponse', function() {
      ...
      //var instance = new OnDemandScanningApi.ListOperationsResponse();
      //expect(instance).to.be.a(OnDemandScanningApi.ListOperationsResponse);
    });
