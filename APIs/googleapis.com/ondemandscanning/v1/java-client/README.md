...
- API version: v1
  - Build date: 2024-10-12T11:44:36.182229-04:00[America/New_York]
...
------------ | ------------- | ------------- | -------------
*ProjectsApi* | [**ondemandscanningProjectsLocationsOperationsCancel**](docs/ProjectsApi.md#ondemandscanningProjectsLocationsOperationsCancel) | **POST** /v1/{name}:cancel | 
*ProjectsApi* | [**ondemandscanningProjectsLocationsOperationsDelete**](docs/ProjectsApi.md#ondemandscanningProjectsLocationsOperationsDelete) | **DELETE** /v1/{name} | 
*ProjectsApi* | [**ondemandscanningProjectsLocationsOperationsGet**](docs/ProjectsApi.md#ondemandscanningProjectsLocationsOperationsGet) | **GET** /v1/{name} | 
*ProjectsApi* | [**ondemandscanningProjectsLocationsOperationsList**](docs/ProjectsApi.md#ondemandscanningProjectsLocationsOperationsList) | **GET** /v1/{name}/operations | 
*ProjectsApi* | [**ondemandscanningProjectsLocationsOperationsWait**](docs/ProjectsApi.md#ondemandscanningProjectsLocationsOperationsWait) | **POST** /v1/{name}:wait | 
*ProjectsApi* | [**ondemandscanningProjectsLocationsScansAnalyzePackages**](docs/ProjectsApi.md#ondemandscanningProjectsLocationsScansAnalyzePackages) | **POST** /v1/{parent}/scans:analyzePackages | 
*ProjectsApi* | [**ondemandscanningProjectsLocationsScansVulnerabilitiesList**](docs/ProjectsApi.md#ondemandscanningProjectsLocationsScansVulnerabilitiesList) | **GET** /v1/{parent}/vulnerabilities | 
