...
from openapi_server.models.analyze_packages_request_v1 import AnalyzePackagesRequestV1
from openapi_server.models.list_operations_response import ListOperationsResponse
from openapi_server.models.list_vulnerabilities_response_v1 import ListVulnerabilitiesResponseV1
...
async def test_ondemandscanning_projects_locations_scans_analyze_packages(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/scans:analyzePackages'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_ondemandscanning_projects_locations_scans_vulnerabilities_list(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/{parent}/vulnerabilities'.format(parent='parent_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
