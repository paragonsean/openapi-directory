...
public:
    ...
    QString getLogsUri() const;
    void setLogsUri(const QString &logs_uri);
    bool is_logs_uri_Set() const;
    bool is_logs_uri_Valid() const;
...
private:
    ...
    QString m_logs_uri;
    bool m_logs_uri_isSet;
    bool m_logs_uri_isValid;
