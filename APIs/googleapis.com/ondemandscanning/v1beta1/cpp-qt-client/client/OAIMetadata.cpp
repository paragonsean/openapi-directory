...
QString OAIMetadata::getBuildFinishedOn() const {
    return m_build_finished_on;
}
void OAIMetadata::setBuildFinishedOn(const QString &build_finished_on) {
    m_build_finished_on = build_finished_on;
    m_build_finished_on_isSet = true;
}

bool OAIMetadata::is_build_finished_on_Set() const{
    return m_build_finished_on_isSet;
}

bool OAIMetadata::is_build_finished_on_Valid() const{
    return m_build_finished_on_isValid;
}

QString OAIMetadata::getBuildInvocationId() const {
    return m_build_invocation_id;
}
void OAIMetadata::setBuildInvocationId(const QString &build_invocation_id) {
    m_build_invocation_id = build_invocation_id;
    m_build_invocation_id_isSet = true;
}

bool OAIMetadata::is_build_invocation_id_Set() const{
    return m_build_invocation_id_isSet;
}

bool OAIMetadata::is_build_invocation_id_Valid() const{
    return m_build_invocation_id_isValid;
}

QString OAIMetadata::getBuildStartedOn() const {
    return m_build_started_on;
}
void OAIMetadata::setBuildStartedOn(const QString &build_started_on) {
    m_build_started_on = build_started_on;
    m_build_started_on_isSet = true;
}

bool OAIMetadata::is_build_started_on_Set() const{
    return m_build_started_on_isSet;
}

bool OAIMetadata::is_build_started_on_Valid() const{
    return m_build_started_on_isValid;
}

OAICompleteness OAIMetadata::getCompleteness() const {
    return m_completeness;
}
void OAIMetadata::setCompleteness(const OAICompleteness &completeness) {
    m_completeness = completeness;
    m_completeness_isSet = true;
}

bool OAIMetadata::is_completeness_Set() const{
    return m_completeness_isSet;
}

bool OAIMetadata::is_completeness_Valid() const{
    return m_completeness_isValid;
}

bool OAIMetadata::isReproducible() const {
    return m_reproducible;
}
void OAIMetadata::setReproducible(const bool &reproducible) {
    m_reproducible = reproducible;
    m_reproducible_isSet = true;
}

bool OAIMetadata::is_reproducible_Set() const{
    return m_reproducible_isSet;
}

bool OAIMetadata::is_reproducible_Valid() const{
