...
|**system** | [**SystemEnum**](#SystemEnum) | Required. Immutable. Identifies the storage system of the entity data. |  [optional] |
|**type** | [**TypeEnum**](#TypeEnum) | Required. Immutable. The type of entity. |  [optional] |
