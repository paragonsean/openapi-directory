# CloudDataplexApi.GoogleCloudDataplexV1Partition
...
**values** | **[String]** | Required. Immutable. The set of values representing the partition, which correspond to the partition schema defined in the parent entity. | [optional] 
