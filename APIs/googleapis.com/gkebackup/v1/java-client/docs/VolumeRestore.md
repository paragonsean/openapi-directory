...
|**state** | [**StateEnum**](#StateEnum) | Output only. The current state of this VolumeRestore. |  [optional] [readonly] |
...
|**volumeType** | [**VolumeTypeEnum**](#VolumeTypeEnum) | Output only. The type of volume provisioned |  [optional] [readonly] |
