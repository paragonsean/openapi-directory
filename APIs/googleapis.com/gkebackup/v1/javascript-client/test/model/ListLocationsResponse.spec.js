...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BackupForGkeApi.ListLocationsResponse();
  });
  ...
  describe('ListLocationsResponse', function() {
    it('should create an instance of ListLocationsResponse', function() {
      ...
      //var instance = new BackupForGkeApi.ListLocationsResponse();
      //expect(instance).to.be.a(BackupForGkeApi.ListLocationsResponse);
    });
