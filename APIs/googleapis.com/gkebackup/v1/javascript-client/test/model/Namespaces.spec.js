...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BackupForGkeApi.Namespaces();
  });
  ...
  describe('Namespaces', function() {
    it('should create an instance of Namespaces', function() {
      // uncomment below and update the code to test Namespaces
      //var instance = new BackupForGkeApi.Namespaces();
      //expect(instance).to.be.a(BackupForGkeApi.Namespaces);
    });
