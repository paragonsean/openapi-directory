...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BackupForGkeApi.ListBackupsResponse();
  });
  ...
  describe('ListBackupsResponse', function() {
    it('should create an instance of ListBackupsResponse', function() {
      ...
      //var instance = new BackupForGkeApi.ListBackupsResponse();
      //expect(instance).to.be.a(BackupForGkeApi.ListBackupsResponse);
    });
