...
**protectedPodCount** | **Number** | Output only. The number of Kubernetes Pods backed up in the last successful Backup created via this BackupPlan. | [optional] [readonly] 
**retentionPolicy** | [**RetentionPolicy**](RetentionPolicy.md) |  | [optional] 
**state** | **String** | Output only. State of the BackupPlan. This State field reflects the various stages a BackupPlan can be in during the Create operation. It will be set to \&quot;DEACTIVATED\&quot; if the BackupPlan is deactivated on an Update | [optional] [readonly] 
...
* `CLUSTER_PENDING` (value: `"CLUSTER_PENDING"`)
