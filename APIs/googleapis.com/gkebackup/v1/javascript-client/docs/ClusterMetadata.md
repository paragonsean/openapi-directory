# BackupForGkeApi.ClusterMetadata
...
**backupCrdVersions** | **{String: String}** | Output only. A list of the Backup for GKE CRD versions found in the cluster. | [optional] [readonly] 
