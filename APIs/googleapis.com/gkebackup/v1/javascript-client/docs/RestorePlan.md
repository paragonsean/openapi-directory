...
**state** | **String** | Output only. State of the RestorePlan. This State field reflects the various stages a RestorePlan can be in during the Create operation. | [optional] [readonly] 
