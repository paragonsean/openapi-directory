...
void OAIProjectsApi::initializeServerConfigs() {
    ...
    QUrl("https://cloudprofiler.googleapis.com/"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("cloudprofiler_projects_profiles_create", defaultConf);
    _serverIndices.insert("cloudprofiler_projects_profiles_create", 0);
    _serverConfigs.insert("cloudprofiler_projects_profiles_createOffline", defaultConf);
    _serverIndices.insert("cloudprofiler_projects_profiles_createOffline", 0);
    _serverConfigs.insert("cloudprofiler_projects_profiles_list", defaultConf);
    _serverIndices.insert("cloudprofiler_projects_profiles_list", 0);
    _serverConfigs.insert("cloudprofiler_projects_profiles_patch", defaultConf);
    _serverIndices.insert("cloudprofiler_projects_profiles_patch", 0);
}
...
void OAIProjectsApi::cloudprofiler_projects_profiles_create(const QString &parent, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<OAICreateProfileRequest> &oai_create_profile_request) {
    ...
    if (oai_create_profile_request.hasValue()){

        
        QByteArray output = oai_create_profile_request.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::cloudprofiler_projects_profiles_createCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::cloudprofiler_projects_profiles_createCallback);
...
void OAIProjectsApi::cloudprofiler_projects_profiles_createCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT cloudprofiler_projects_profiles_createSignal(output);
        Q_EMIT cloudprofiler_projects_profiles_createSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT cloudprofiler_projects_profiles_createSignalE(output, error_type, error_str);
        Q_EMIT cloudprofiler_projects_profiles_createSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT cloudprofiler_projects_profiles_createSignalError(output, error_type, error_str);
        Q_EMIT cloudprofiler_projects_profiles_createSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectsApi::cloudprofiler_projects_profiles_createOffline(const QString &parent, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<OAIProfile> &oai_profile) {
    QString fullPath = QString(_serverConfigs["cloudprofiler_projects_profiles_createOffline"][_serverIndices.value("cloudprofiler_projects_profiles_createOffline")].URL()+"/v2/{parent}/profiles:createOffline");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::cloudprofiler_projects_profiles_createOfflineCallback);
    connect(this, &OAIProjectsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::cloudprofiler_projects_profiles_createOfflineCallback);
    connect(this, &OAIProjectsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectsApi::cloudprofiler_projects_profiles_createOfflineCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT cloudprofiler_projects_profiles_createOfflineSignal(output);
        Q_EMIT cloudprofiler_projects_profiles_createOfflineSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        QString scopeStr = scope.join(" ");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT cloudprofiler_projects_profiles_createOfflineSignalE(output, error_type, error_str);
        Q_EMIT cloudprofiler_projects_profiles_createOfflineSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT cloudprofiler_projects_profiles_createOfflineSignalError(output, error_type, error_str);
        Q_EMIT cloudprofiler_projects_profiles_createOfflineSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectsApi::cloudprofiler_projects_profiles_list(const QString &parent, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &page_token) {
    QString fullPath = QString(_serverConfigs["cloudprofiler_projects_profiles_list"][_serverIndices.value("cloudprofiler_projects_profiles_list")].URL()+"/v2/{parent}/profiles");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::cloudprofiler_projects_profiles_listCallback);
    connect(this, &OAIProjectsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::cloudprofiler_projects_profiles_listCallback);
    connect(this, &OAIProjectsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectsApi::cloudprofiler_projects_profiles_listCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT cloudprofiler_projects_profiles_listSignal(output);
        Q_EMIT cloudprofiler_projects_profiles_listSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        QString scopeStr = scope.join(" ");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT cloudprofiler_projects_profiles_listSignalE(output, error_type, error_str);
        Q_EMIT cloudprofiler_projects_profiles_listSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT cloudprofiler_projects_profiles_listSignalError(output, error_type, error_str);
        Q_EMIT cloudprofiler_projects_profiles_listSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectsApi::cloudprofiler_projects_profiles_patch(const QString &name, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<QString> &update_mask, const ::OpenAPI::OptionalParam<OAIProfile> &oai_profile) {
    QString fullPath = QString(_serverConfigs["cloudprofiler_projects_profiles_patch"][_serverIndices.value("cloudprofiler_projects_profiles_patch")].URL()+"/v2/{name}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::cloudprofiler_projects_profiles_patchCallback);
    connect(this, &OAIProjectsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::cloudprofiler_projects_profiles_patchCallback);
    connect(this, &OAIProjectsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectsApi::cloudprofiler_projects_profiles_patchCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT cloudprofiler_projects_profiles_patchSignal(output);
        Q_EMIT cloudprofiler_projects_profiles_patchSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        QString scopeStr = scope.join(" ");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT cloudprofiler_projects_profiles_patchSignalE(output, error_type, error_str);
        Q_EMIT cloudprofiler_projects_profiles_patchSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT cloudprofiler_projects_profiles_patchSignalError(output, error_type, error_str);
        Q_EMIT cloudprofiler_projects_profiles_patchSignalErrorFull(worker, error_type, error_str);
    }
}
