...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleWorkspaceEventsApi.Operation();
  });
  ...
  describe('Operation', function() {
    it('should create an instance of Operation', function() {
      ...
      //var instance = new GoogleWorkspaceEventsApi.Operation();
      //expect(instance).to.be.a(GoogleWorkspaceEventsApi.Operation);
    });
