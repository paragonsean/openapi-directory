...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudTestingApi.RoboDirective();
  });
  ...
  describe('RoboDirective', function() {
    it('should create an instance of RoboDirective', function() {
      // uncomment below and update the code to test RoboDirective
      //var instance = new CloudTestingApi.RoboDirective();
      //expect(instance).to.be.a(CloudTestingApi.RoboDirective);
    });
