...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudTestingApi.ToolResultsStep();
  });
  ...
  describe('ToolResultsStep', function() {
    it('should create an instance of ToolResultsStep', function() {
      // uncomment below and update the code to test ToolResultsStep
      //var instance = new CloudTestingApi.ToolResultsStep();
      //expect(instance).to.be.a(CloudTestingApi.ToolResultsStep);
    });
