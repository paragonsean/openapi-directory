...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudTestingApi.DeviceIpBlock();
  });
  ...
  describe('DeviceIpBlock', function() {
    it('should create an instance of DeviceIpBlock', function() {
      // uncomment below and update the code to test DeviceIpBlock
      //var instance = new CloudTestingApi.DeviceIpBlock();
      //expect(instance).to.be.a(CloudTestingApi.DeviceIpBlock);
    });
