...
/*
 * OAIGoogleCloudRetailV2alphaPredictRequest.h
 *
 * Request message for Predict method.
 */

#ifndef OAIGoogleCloudRetailV2alphaPredictRequest_H
#define OAIGoogleCloudRetailV2alphaPredictRequest_H
...
class OAIGoogleCloudRetailV2alphaPredictRequest : public OAIObject {
public:
    OAIGoogleCloudRetailV2alphaPredictRequest();
    OAIGoogleCloudRetailV2alphaPredictRequest(QString json);
    ~OAIGoogleCloudRetailV2alphaPredictRequest() override;
    ...
    OAIGoogleCloudRetailV2alphaUserEvent getUserEvent() const;
    void setUserEvent(const OAIGoogleCloudRetailV2alphaUserEvent &user_event);
...
private:
    ...
    OAIGoogleCloudRetailV2alphaUserEvent m_user_event;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudRetailV2alphaPredictRequest)

#endif // OAIGoogleCloudRetailV2alphaPredictRequest_H
