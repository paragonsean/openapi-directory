...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VertexAiSearchForRetailApi.GoogleCloudRetailV2alphaInterval();
  });
  ...
  describe('GoogleCloudRetailV2alphaInterval', function() {
    it('should create an instance of GoogleCloudRetailV2alphaInterval', function() {
      // uncomment below and update the code to test GoogleCloudRetailV2alphaInterval
      //var instance = new VertexAiSearchForRetailApi.GoogleCloudRetailV2alphaInterval();
      //expect(instance).to.be.a(VertexAiSearchForRetailApi.GoogleCloudRetailV2alphaInterval);
    });
