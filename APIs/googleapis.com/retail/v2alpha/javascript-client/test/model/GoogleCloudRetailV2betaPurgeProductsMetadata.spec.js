...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VertexAiSearchForRetailApi.GoogleCloudRetailV2betaPurgeProductsMetadata();
  });
  ...
  describe('GoogleCloudRetailV2betaPurgeProductsMetadata', function() {
    it('should create an instance of GoogleCloudRetailV2betaPurgeProductsMetadata', function() {
      // uncomment below and update the code to test GoogleCloudRetailV2betaPurgeProductsMetadata
      //var instance = new VertexAiSearchForRetailApi.GoogleCloudRetailV2betaPurgeProductsMetadata();
      //expect(instance).to.be.a(VertexAiSearchForRetailApi.GoogleCloudRetailV2betaPurgeProductsMetadata);
    });
