...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VertexAiSearchForRetailApi.GoogleCloudRetailV2alphaSearchRequest();
  });
  ...
  describe('GoogleCloudRetailV2alphaSearchRequest', function() {
    it('should create an instance of GoogleCloudRetailV2alphaSearchRequest', function() {
      // uncomment below and update the code to test GoogleCloudRetailV2alphaSearchRequest
      //var instance = new VertexAiSearchForRetailApi.GoogleCloudRetailV2alphaSearchRequest();
      //expect(instance).to.be.a(VertexAiSearchForRetailApi.GoogleCloudRetailV2alphaSearchRequest);
    });
    ...
    it('should have the property relevanceThreshold (base name: "relevanceThreshold")', function() {
      // uncomment below and update the code to test the property relevanceThreshold
      //var instance = new VertexAiSearchForRetailApi.GoogleCloudRetailV2alphaSearchRequest();
      //expect(instance).to.be();
    });
