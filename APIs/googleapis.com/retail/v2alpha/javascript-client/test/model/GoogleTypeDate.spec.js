...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VertexAiSearchForRetailApi.GoogleTypeDate();
  });
  ...
  describe('GoogleTypeDate', function() {
    it('should create an instance of GoogleTypeDate', function() {
      ...
      //var instance = new VertexAiSearchForRetailApi.GoogleTypeDate();
      //expect(instance).to.be.a(VertexAiSearchForRetailApi.GoogleTypeDate);
    });
