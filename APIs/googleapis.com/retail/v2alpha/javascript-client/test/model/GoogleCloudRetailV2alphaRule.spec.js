...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VertexAiSearchForRetailApi.GoogleCloudRetailV2alphaRule();
  });
  ...
  describe('GoogleCloudRetailV2alphaRule', function() {
    it('should create an instance of GoogleCloudRetailV2alphaRule', function() {
      // uncomment below and update the code to test GoogleCloudRetailV2alphaRule
      //var instance = new VertexAiSearchForRetailApi.GoogleCloudRetailV2alphaRule();
      //expect(instance).to.be.a(VertexAiSearchForRetailApi.GoogleCloudRetailV2alphaRule);
    });
