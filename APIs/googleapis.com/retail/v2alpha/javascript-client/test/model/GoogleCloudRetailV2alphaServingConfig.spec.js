...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VertexAiSearchForRetailApi.GoogleCloudRetailV2alphaServingConfig();
  });
  ...
  describe('GoogleCloudRetailV2alphaServingConfig', function() {
    it('should create an instance of GoogleCloudRetailV2alphaServingConfig', function() {
      // uncomment below and update the code to test GoogleCloudRetailV2alphaServingConfig
      //var instance = new VertexAiSearchForRetailApi.GoogleCloudRetailV2alphaServingConfig();
      //expect(instance).to.be.a(VertexAiSearchForRetailApi.GoogleCloudRetailV2alphaServingConfig);
    });
