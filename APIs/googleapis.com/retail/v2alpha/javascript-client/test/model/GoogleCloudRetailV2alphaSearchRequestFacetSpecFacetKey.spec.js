...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VertexAiSearchForRetailApi.GoogleCloudRetailV2alphaSearchRequestFacetSpecFacetKey();
  });
  ...
  describe('GoogleCloudRetailV2alphaSearchRequestFacetSpecFacetKey', function() {
    it('should create an instance of GoogleCloudRetailV2alphaSearchRequestFacetSpecFacetKey', function() {
      // uncomment below and update the code to test GoogleCloudRetailV2alphaSearchRequestFacetSpecFacetKey
      //var instance = new VertexAiSearchForRetailApi.GoogleCloudRetailV2alphaSearchRequestFacetSpecFacetKey();
      //expect(instance).to.be.a(VertexAiSearchForRetailApi.GoogleCloudRetailV2alphaSearchRequestFacetSpecFacetKey);
    });
