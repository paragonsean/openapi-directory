# VertexAiSearchForRetailApi.GoogleCloudRetailV2alphaCondition

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**activeTimeRange** | [**[GoogleCloudRetailV2alphaConditionTimeRange]**](GoogleCloudRetailV2alphaConditionTimeRange.md) | Range of time(s) specifying when Condition is active. Condition true if any time range matches. | [optional] 
