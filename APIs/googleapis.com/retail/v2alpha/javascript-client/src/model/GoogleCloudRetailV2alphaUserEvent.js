...
/**
 * The GoogleCloudRetailV2alphaUserEvent model module.
 * @module model/GoogleCloudRetailV2alphaUserEvent
 * @version v2alpha
 */
class GoogleCloudRetailV2alphaUserEvent {
    /**
     * Constructs a new <code>GoogleCloudRetailV2alphaUserEvent</code>.
     * UserEvent captures all metadata information Retail API needs to know about how end users interact with customers&#39; website.
     * @alias module:model/GoogleCloudRetailV2alphaUserEvent
     */
    constructor() { 
        
        GoogleCloudRetailV2alphaUserEvent.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudRetailV2alphaUserEvent</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudRetailV2alphaUserEvent} obj Optional instance to populate.
     * @return {module:model/GoogleCloudRetailV2alphaUserEvent} The populated <code>GoogleCloudRetailV2alphaUserEvent</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudRetailV2alphaUserEvent();
            ...
            if (data.hasOwnProperty('completionDetail')) {
                obj['completionDetail'] = GoogleCloudRetailV2alphaCompletionDetail.constructFromObject(data['completionDetail']);
            }
            ...
            if (data.hasOwnProperty('productDetails')) {
                obj['productDetails'] = ApiClient.convertToType(data['productDetails'], [GoogleCloudRetailV2alphaProductDetail]);
            }
            if (data.hasOwnProperty('purchaseTransaction')) {
                obj['purchaseTransaction'] = GoogleCloudRetailV2alphaPurchaseTransaction.constructFromObject(data['purchaseTransaction']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudRetailV2alphaUserEvent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudRetailV2alphaUserEvent</code>.
     */
    static validateJSON(data) {
        ...
        if (data['completionDetail']) { // data not null
          GoogleCloudRetailV2alphaCompletionDetail.validateJSON(data['completionDetail']);
        }
        // ensure the json data is a string
        ...
        if (data['productDetails']) { // data not null
            ...
            for (const item of data['productDetails']) {
                GoogleCloudRetailV2alphaProductDetail.validateJSON(item);
            };
        }
        // validate the optional field `purchaseTransaction`
        if (data['purchaseTransaction']) { // data not null
          GoogleCloudRetailV2alphaPurchaseTransaction.validateJSON(data['purchaseTransaction']);
        }
        // ensure the json data is a string
 ...
 */
GoogleCloudRetailV2alphaUserEvent.prototype['attributes'] = undefined;
 ...
 */
GoogleCloudRetailV2alphaUserEvent.prototype['attributionToken'] = undefined;
 ...
 */
GoogleCloudRetailV2alphaUserEvent.prototype['cartId'] = undefined;

/**
 * @member {module:model/GoogleCloudRetailV2alphaCompletionDetail} completionDetail
 */
GoogleCloudRetailV2alphaUserEvent.prototype['completionDetail'] = undefined;
 ...
 */
GoogleCloudRetailV2alphaUserEvent.prototype['entity'] = undefined;

/**
 * Only required for UserEventService.ImportUserEvents method. Timestamp of when the user event happened.
 * @member {String} eventTime
 */
GoogleCloudRetailV2alphaUserEvent.prototype['eventTime'] = undefined;
 ...
 */
GoogleCloudRetailV2alphaUserEvent.prototype['eventType'] = undefined;
 ...
 */
GoogleCloudRetailV2alphaUserEvent.prototype['experimentIds'] = undefined;

/**
 * The filter syntax consists of an expression language for constructing a predicate from one or more fields of the products being filtered. See SearchRequest.filter for definition and syntax. The value must be a UTF-8 encoded string with a length limit of 1,000 characters. Otherwise, an INVALID_ARGUMENT error is returned.
 * @member {String} filter
 */
GoogleCloudRetailV2alphaUserEvent.prototype['filter'] = undefined;

/**
 * An integer that specifies the current offset for pagination (the 0-indexed starting location, amongst the products deemed by the API as relevant). See SearchRequest.offset for definition. If this field is negative, an INVALID_ARGUMENT is returned. This can only be set for `search` events. Other event types should not set this field. Otherwise, an INVALID_ARGUMENT error is returned.
 * @member {Number} offset
 */
GoogleCloudRetailV2alphaUserEvent.prototype['offset'] = undefined;

/**
 * The order in which products are returned. See SearchRequest.order_by for definition and syntax. The value must be a UTF-8 encoded string with a length limit of 1,000 characters. Otherwise, an INVALID_ARGUMENT error is returned. This can only be set for `search` events. Other event types should not set this field. Otherwise, an INVALID_ARGUMENT error is returned.
 * @member {String} orderBy
 */
GoogleCloudRetailV2alphaUserEvent.prototype['orderBy'] = undefined;
 ...
 */
GoogleCloudRetailV2alphaUserEvent.prototype['pageCategories'] = undefined;

/**
 * A unique ID of a web page view. This should be kept the same for all user events triggered from the same pageview. For example, an item detail page view could trigger multiple events as the user is browsing the page. The `pageViewId` property should be kept the same for all these events so that they can be grouped together properly. When using the client side event reporting with JavaScript pixel and Google Tag Manager, this value is filled in automatically.
 * @member {String} pageViewId
 */
GoogleCloudRetailV2alphaUserEvent.prototype['pageViewId'] = undefined;
 ...
 * @member {Array.<module:model/GoogleCloudRetailV2alphaProductDetail>} productDetails
 */
GoogleCloudRetailV2alphaUserEvent.prototype['productDetails'] = undefined;

/**
 * @member {module:model/GoogleCloudRetailV2alphaPurchaseTransaction} purchaseTransaction
 */
GoogleCloudRetailV2alphaUserEvent.prototype['purchaseTransaction'] = undefined;
 ...
 */
GoogleCloudRetailV2alphaUserEvent.prototype['referrerUri'] = undefined;

/**
 * The user's search query. See SearchRequest.query for definition. The value must be a UTF-8 encoded string with a length limit of 5,000 characters. Otherwise, an INVALID_ARGUMENT error is returned. At least one of search_query or page_categories is required for `search` events. Other event types should not set this field. Otherwise, an INVALID_ARGUMENT error is returned.
 * @member {String} searchQuery
 */
GoogleCloudRetailV2alphaUserEvent.prototype['searchQuery'] = undefined;
 ...
 */
GoogleCloudRetailV2alphaUserEvent.prototype['sessionId'] = undefined;

/**
 * Complete URL (window.location.href) of the user's current page. When using the client side event reporting with JavaScript pixel and Google Tag Manager, this value is filled in automatically. Maximum length 5,000 characters.
 * @member {String} uri
 */
GoogleCloudRetailV2alphaUserEvent.prototype['uri'] = undefined;

/**
 * @member {module:model/GoogleCloudRetailV2alphaUserInfo} userInfo
 */
GoogleCloudRetailV2alphaUserEvent.prototype['userInfo'] = undefined;
 ...
 */
GoogleCloudRetailV2alphaUserEvent.prototype['visitorId'] = undefined;
...
export default GoogleCloudRetailV2alphaUserEvent;
