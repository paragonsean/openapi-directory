...
/**
 * The GoogleCloudRetailV2alphaSearchRequest model module.
 * @module model/GoogleCloudRetailV2alphaSearchRequest
 * @version v2alpha
 */
class GoogleCloudRetailV2alphaSearchRequest {
    /**
     * Constructs a new <code>GoogleCloudRetailV2alphaSearchRequest</code>.
     * Request message for SearchService.Search method.
     * @alias module:model/GoogleCloudRetailV2alphaSearchRequest
     */
    constructor() { 
        
        GoogleCloudRetailV2alphaSearchRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudRetailV2alphaSearchRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudRetailV2alphaSearchRequest} obj Optional instance to populate.
     * @return {module:model/GoogleCloudRetailV2alphaSearchRequest} The populated <code>GoogleCloudRetailV2alphaSearchRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudRetailV2alphaSearchRequest();

            if (data.hasOwnProperty('boostSpec')) {
                obj['boostSpec'] = GoogleCloudRetailV2alphaSearchRequestBoostSpec.constructFromObject(data['boostSpec']);
            }
            ...
            if (data.hasOwnProperty('dynamicFacetSpec')) {
                obj['dynamicFacetSpec'] = GoogleCloudRetailV2alphaSearchRequestDynamicFacetSpec.constructFromObject(data['dynamicFacetSpec']);
            }
            if (data.hasOwnProperty('entity')) {
                obj['entity'] = ApiClient.convertToType(data['entity'], 'String');
            }
            if (data.hasOwnProperty('facetSpecs')) {
                obj['facetSpecs'] = ApiClient.convertToType(data['facetSpecs'], [GoogleCloudRetailV2alphaSearchRequestFacetSpec]);
            }
            ...
            if (data.hasOwnProperty('personalizationSpec')) {
                obj['personalizationSpec'] = GoogleCloudRetailV2alphaSearchRequestPersonalizationSpec.constructFromObject(data['personalizationSpec']);
            }
            if (data.hasOwnProperty('query')) {
                obj['query'] = ApiClient.convertToType(data['query'], 'String');
            }
            if (data.hasOwnProperty('queryExpansionSpec')) {
                obj['queryExpansionSpec'] = GoogleCloudRetailV2alphaSearchRequestQueryExpansionSpec.constructFromObject(data['queryExpansionSpec']);
            }
            if (data.hasOwnProperty('relevanceThreshold')) {
                obj['relevanceThreshold'] = ApiClient.convertToType(data['relevanceThreshold'], 'String');
            }
            ...
            if (data.hasOwnProperty('spellCorrectionSpec')) {
                obj['spellCorrectionSpec'] = GoogleCloudRetailV2alphaSearchRequestSpellCorrectionSpec.constructFromObject(data['spellCorrectionSpec']);
            }
            if (data.hasOwnProperty('userInfo')) {
                obj['userInfo'] = GoogleCloudRetailV2alphaUserInfo.constructFromObject(data['userInfo']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudRetailV2alphaSearchRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudRetailV2alphaSearchRequest</code>.
     */
    static validateJSON(data) {
        // validate the optional field `boostSpec`
        if (data['boostSpec']) { // data not null
          GoogleCloudRetailV2alphaSearchRequestBoostSpec.validateJSON(data['boostSpec']);
        }
        ...
        if (data['dynamicFacetSpec']) { // data not null
          GoogleCloudRetailV2alphaSearchRequestDynamicFacetSpec.validateJSON(data['dynamicFacetSpec']);
        }
        // ensure the json data is a string
        ...
        if (data['facetSpecs']) { // data not null
            ...
            for (const item of data['facetSpecs']) {
                GoogleCloudRetailV2alphaSearchRequestFacetSpec.validateJSON(item);
            };
        }
        // ensure the json data is a string
        ...
        if (data['personalizationSpec']) { // data not null
          GoogleCloudRetailV2alphaSearchRequestPersonalizationSpec.validateJSON(data['personalizationSpec']);
        }
        // ensure the json data is a string
        ...
        if (data['queryExpansionSpec']) { // data not null
          GoogleCloudRetailV2alphaSearchRequestQueryExpansionSpec.validateJSON(data['queryExpansionSpec']);
        }
        // ensure the json data is a string
        if (data['relevanceThreshold'] && !(typeof data['relevanceThreshold'] === 'string' || data['relevanceThreshold'] instanceof String)) {
            throw new Error("Expected the field `relevanceThreshold` to be a primitive type in the JSON string but got " + data['relevanceThreshold']);
        }
        // ensure the json data is a string
        ...
        if (data['spellCorrectionSpec']) { // data not null
          GoogleCloudRetailV2alphaSearchRequestSpellCorrectionSpec.validateJSON(data['spellCorrectionSpec']);
        }
        // validate the optional field `userInfo`
        if (data['userInfo']) { // data not null
          GoogleCloudRetailV2alphaUserInfo.validateJSON(data['userInfo']);
        }
        // ensure the json data is an array
...
/**
 * @member {module:model/GoogleCloudRetailV2alphaSearchRequestBoostSpec} boostSpec
 */
GoogleCloudRetailV2alphaSearchRequest.prototype['boostSpec'] = undefined;
 ...
 */
GoogleCloudRetailV2alphaSearchRequest.prototype['branch'] = undefined;
 ...
 */
GoogleCloudRetailV2alphaSearchRequest.prototype['canonicalFilter'] = undefined;

/**
 * @member {module:model/GoogleCloudRetailV2alphaSearchRequestDynamicFacetSpec} dynamicFacetSpec
 */
GoogleCloudRetailV2alphaSearchRequest.prototype['dynamicFacetSpec'] = undefined;
 ...
 */
GoogleCloudRetailV2alphaSearchRequest.prototype['entity'] = undefined;
 ...
 * @member {Array.<module:model/GoogleCloudRetailV2alphaSearchRequestFacetSpec>} facetSpecs
 */
GoogleCloudRetailV2alphaSearchRequest.prototype['facetSpecs'] = undefined;
 ...
 */
GoogleCloudRetailV2alphaSearchRequest.prototype['filter'] = undefined;
 ...
 */
GoogleCloudRetailV2alphaSearchRequest.prototype['labels'] = undefined;
 ...
 */
GoogleCloudRetailV2alphaSearchRequest.prototype['offset'] = undefined;
 ...
 */
GoogleCloudRetailV2alphaSearchRequest.prototype['orderBy'] = undefined;
 ...
 */
GoogleCloudRetailV2alphaSearchRequest.prototype['pageCategories'] = undefined;
 ...
 */
GoogleCloudRetailV2alphaSearchRequest.prototype['pageSize'] = undefined;

/**
 * A page token SearchResponse.next_page_token, received from a previous SearchService.Search call. Provide this to retrieve the subsequent page. When paginating, all other parameters provided to SearchService.Search must match the call that provided the page token. Otherwise, an INVALID_ARGUMENT error is returned.
 * @member {String} pageToken
 */
GoogleCloudRetailV2alphaSearchRequest.prototype['pageToken'] = undefined;

/**
 * @member {module:model/GoogleCloudRetailV2alphaSearchRequestPersonalizationSpec} personalizationSpec
 */
GoogleCloudRetailV2alphaSearchRequest.prototype['personalizationSpec'] = undefined;
 ...
 * @member {String} query
 */
GoogleCloudRetailV2alphaSearchRequest.prototype['query'] = undefined;

/**
 * @member {module:model/GoogleCloudRetailV2alphaSearchRequestQueryExpansionSpec} queryExpansionSpec
 */
GoogleCloudRetailV2alphaSearchRequest.prototype['queryExpansionSpec'] = undefined;
 ...
 * @member {module:model/GoogleCloudRetailV2alphaSearchRequest.RelevanceThresholdEnum} relevanceThreshold
 */
GoogleCloudRetailV2alphaSearchRequest.prototype['relevanceThreshold'] = undefined;
 ...
 * @member {module:model/GoogleCloudRetailV2alphaSearchRequest.SearchModeEnum} searchMode
 */
GoogleCloudRetailV2alphaSearchRequest.prototype['searchMode'] = undefined;

/**
 * @member {module:model/GoogleCloudRetailV2alphaSearchRequestSpellCorrectionSpec} spellCorrectionSpec
 */
GoogleCloudRetailV2alphaSearchRequest.prototype['spellCorrectionSpec'] = undefined;

/**
 * @member {module:model/GoogleCloudRetailV2alphaUserInfo} userInfo
 */
GoogleCloudRetailV2alphaSearchRequest.prototype['userInfo'] = undefined;
 ...
 */
GoogleCloudRetailV2alphaSearchRequest.prototype['variantRollupKeys'] = undefined;

/**
 * Required. A unique identifier for tracking visitors. For example, this could be implemented with an HTTP cookie, which should be able to uniquely identify a visitor on a single device. This unique identifier should not change if the visitor logs in or out of the website. This should be the same identifier as UserEvent.visitor_id. The field must be a UTF-8 encoded string with a length limit of 128 characters. Otherwise, an INVALID_ARGUMENT error is returned.
 * @member {String} visitorId
 */
GoogleCloudRetailV2alphaSearchRequest.prototype['visitorId'] = undefined;
...
/**
 * Allowed values for the <code>relevanceThreshold</code> property.
 * @enum {String}
 * @readonly
 */
GoogleCloudRetailV2alphaSearchRequest['RelevanceThresholdEnum'] = {
 ...
 * @readonly
 */
GoogleCloudRetailV2alphaSearchRequest['SearchModeEnum'] = {
...
export default GoogleCloudRetailV2alphaSearchRequest;
