...
/**
 * The GoogleCloudRetailV2alphaServingConfig model module.
 * @module model/GoogleCloudRetailV2alphaServingConfig
 * @version v2alpha
 */
class GoogleCloudRetailV2alphaServingConfig {
    /**
     * Constructs a new <code>GoogleCloudRetailV2alphaServingConfig</code>.
     * Configures metadata that is used to generate serving time results (e.g. search results or recommendation predictions).
     * @alias module:model/GoogleCloudRetailV2alphaServingConfig
     */
    constructor() { 
        
        GoogleCloudRetailV2alphaServingConfig.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudRetailV2alphaServingConfig</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudRetailV2alphaServingConfig} obj Optional instance to populate.
     * @return {module:model/GoogleCloudRetailV2alphaServingConfig} The populated <code>GoogleCloudRetailV2alphaServingConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudRetailV2alphaServingConfig();
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudRetailV2alphaServingConfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudRetailV2alphaServingConfig</code>.
     */
 ...
 */
GoogleCloudRetailV2alphaServingConfig.prototype['boostControlIds'] = undefined;
 ...
 */
GoogleCloudRetailV2alphaServingConfig.prototype['displayName'] = undefined;

/**
 * How much diversity to use in recommendation model results e.g. `medium-diversity` or `high-diversity`. Currently supported values: * `no-diversity` * `low-diversity` * `medium-diversity` * `high-diversity` * `auto-diversity` If not specified, we choose default based on recommendation model type. Default value: `no-diversity`. Can only be set if solution_types is SOLUTION_TYPE_RECOMMENDATION.
 * @member {String} diversityLevel
 */
GoogleCloudRetailV2alphaServingConfig.prototype['diversityLevel'] = undefined;

/**
 * What kind of diversity to use - data driven or rule based. If unset, the server behavior defaults to RULE_BASED_DIVERSITY.
 * @member {module:model/GoogleCloudRetailV2alphaServingConfig.DiversityTypeEnum} diversityType
 */
GoogleCloudRetailV2alphaServingConfig.prototype['diversityType'] = undefined;

/**
 * Condition do not associate specifications. If multiple do not associate conditions match, all matching do not associate controls in the list will execute. - Order does not matter. - Maximum number of specifications is 100. Can only be set if solution_types is SOLUTION_TYPE_SEARCH.
 * @member {Array.<String>} doNotAssociateControlIds
 */
GoogleCloudRetailV2alphaServingConfig.prototype['doNotAssociateControlIds'] = undefined;

/**
 * @member {module:model/GoogleCloudRetailV2alphaSearchRequestDynamicFacetSpec} dynamicFacetSpec
 */
GoogleCloudRetailV2alphaServingConfig.prototype['dynamicFacetSpec'] = undefined;
 ...
 */
GoogleCloudRetailV2alphaServingConfig.prototype['priceRerankingLevel'] = undefined;

/**
 * Condition redirect specifications. Only the first triggered redirect action is applied, even if multiple apply. Maximum number of specifications is 1000. Can only be set if solution_types is SOLUTION_TYPE_SEARCH.
 * @member {Array.<String>} redirectControlIds
 */
GoogleCloudRetailV2alphaServingConfig.prototype['redirectControlIds'] = undefined;

/**
 * Condition replacement specifications. - Applied according to the order in the list. - A previously replaced term can not be re-replaced. - Maximum number of specifications is 100. Can only be set if solution_types is SOLUTION_TYPE_SEARCH.
 * @member {Array.<String>} replacementControlIds
 */
GoogleCloudRetailV2alphaServingConfig.prototype['replacementControlIds'] = undefined;
 ...
 * @member {Array.<module:model/GoogleCloudRetailV2alphaServingConfig.SolutionTypesEnum>} solutionTypes
 */
GoogleCloudRetailV2alphaServingConfig.prototype['solutionTypes'] = undefined;

/**
 * Condition synonyms specifications. If multiple syonyms conditions match, all matching synonyms control in the list will execute. Order of controls in the list will not matter. Maximum number of specifications is 100. Can only be set if solution_types is SOLUTION_TYPE_SEARCH.
 * @member {Array.<String>} twowaySynonymsControlIds
 */
GoogleCloudRetailV2alphaServingConfig.prototype['twowaySynonymsControlIds'] = undefined;
 ...
 * @readonly
 */
GoogleCloudRetailV2alphaServingConfig['DiversityTypeEnum'] = {
 ...
 * @readonly
 */
GoogleCloudRetailV2alphaServingConfig['SolutionTypesEnum'] = {
...
export default GoogleCloudRetailV2alphaServingConfig;
