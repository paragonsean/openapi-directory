...
/**
 * The GoogleCloudRetailV2alphaControl model module.
 * @module model/GoogleCloudRetailV2alphaControl
 * @version v2alpha
 */
class GoogleCloudRetailV2alphaControl {
    /**
     * Constructs a new <code>GoogleCloudRetailV2alphaControl</code>.
     * Configures dynamic metadata that can be linked to a ServingConfig and affect search or recommendation results at serving time.
     * @alias module:model/GoogleCloudRetailV2alphaControl
     */
    constructor() { 
        
        GoogleCloudRetailV2alphaControl.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudRetailV2alphaControl</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudRetailV2alphaControl} obj Optional instance to populate.
     * @return {module:model/GoogleCloudRetailV2alphaControl} The populated <code>GoogleCloudRetailV2alphaControl</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudRetailV2alphaControl();
            ...
            if (data.hasOwnProperty('facetSpec')) {
                obj['facetSpec'] = GoogleCloudRetailV2alphaSearchRequestFacetSpec.constructFromObject(data['facetSpec']);
            }
            if (data.hasOwnProperty('name')) {
                obj['name'] = ApiClient.convertToType(data['name'], 'String');
            }
            if (data.hasOwnProperty('rule')) {
                obj['rule'] = GoogleCloudRetailV2alphaRule.constructFromObject(data['rule']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudRetailV2alphaControl</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudRetailV2alphaControl</code>.
     */
    static validateJSON(data) {
        ...
        if (data['facetSpec']) { // data not null
          GoogleCloudRetailV2alphaSearchRequestFacetSpec.validateJSON(data['facetSpec']);
        }
        // ensure the json data is a string
        ...
        if (data['rule']) { // data not null
          GoogleCloudRetailV2alphaRule.validateJSON(data['rule']);
        }
        // ensure the json data is an array
 ...
 */
GoogleCloudRetailV2alphaControl.prototype['associatedServingConfigIds'] = undefined;
 ...
 */
GoogleCloudRetailV2alphaControl.prototype['displayName'] = undefined;

/**
 * @member {module:model/GoogleCloudRetailV2alphaSearchRequestFacetSpec} facetSpec
 */
GoogleCloudRetailV2alphaControl.prototype['facetSpec'] = undefined;

/**
 * Immutable. Fully qualified name `projects/_*_/locations/global/catalogs/_*_/controls/_*`
 * @member {String} name
 */
GoogleCloudRetailV2alphaControl.prototype['name'] = undefined;

/**
 * @member {module:model/GoogleCloudRetailV2alphaRule} rule
 */
GoogleCloudRetailV2alphaControl.prototype['rule'] = undefined;

/**
 * Specifies the use case for the control. Affects what condition fields can be set. Only settable by search controls. Will default to SEARCH_SOLUTION_USE_CASE_SEARCH if not specified. Currently only allow one search_solution_use_case per control.
 * @member {Array.<module:model/GoogleCloudRetailV2alphaControl.SearchSolutionUseCaseEnum>} searchSolutionUseCase
 */
GoogleCloudRetailV2alphaControl.prototype['searchSolutionUseCase'] = undefined;
 ...
 * @member {Array.<module:model/GoogleCloudRetailV2alphaControl.SolutionTypesEnum>} solutionTypes
 */
GoogleCloudRetailV2alphaControl.prototype['solutionTypes'] = undefined;
 ...
 * @readonly
 */
GoogleCloudRetailV2alphaControl['SearchSolutionUseCaseEnum'] = {
 ...
 * @readonly
 */
GoogleCloudRetailV2alphaControl['SolutionTypesEnum'] = {
...
export default GoogleCloudRetailV2alphaControl;
