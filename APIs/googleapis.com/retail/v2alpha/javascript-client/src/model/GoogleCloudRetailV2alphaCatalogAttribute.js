...
import GoogleCloudRetailV2alphaCatalogAttributeFacetConfig from './GoogleCloudRetailV2alphaCatalogAttributeFacetConfig';

/**
 * The GoogleCloudRetailV2alphaCatalogAttribute model module.
 * @module model/GoogleCloudRetailV2alphaCatalogAttribute
 * @version v2alpha
 */
class GoogleCloudRetailV2alphaCatalogAttribute {
    /**
     * Constructs a new <code>GoogleCloudRetailV2alphaCatalogAttribute</code>.
     * Catalog level attribute config for an attribute. For example, if customers want to enable/disable facet for a specific attribute.
     * @alias module:model/GoogleCloudRetailV2alphaCatalogAttribute
     */
    constructor() { 
        
        GoogleCloudRetailV2alphaCatalogAttribute.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudRetailV2alphaCatalogAttribute</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudRetailV2alphaCatalogAttribute} obj Optional instance to populate.
     * @return {module:model/GoogleCloudRetailV2alphaCatalogAttribute} The populated <code>GoogleCloudRetailV2alphaCatalogAttribute</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudRetailV2alphaCatalogAttribute();
            ...
            if (data.hasOwnProperty('facetConfig')) {
                obj['facetConfig'] = GoogleCloudRetailV2alphaCatalogAttributeFacetConfig.constructFromObject(data['facetConfig']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudRetailV2alphaCatalogAttribute</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudRetailV2alphaCatalogAttribute</code>.
     */
    static validateJSON(data) {
        ...
        if (data['facetConfig']) { // data not null
          GoogleCloudRetailV2alphaCatalogAttributeFacetConfig.validateJSON(data['facetConfig']);
        }
        // ensure the json data is a string
 ...
 * @member {module:model/GoogleCloudRetailV2alphaCatalogAttribute.DynamicFacetableOptionEnum} dynamicFacetableOption
 */
GoogleCloudRetailV2alphaCatalogAttribute.prototype['dynamicFacetableOption'] = undefined;
 ...
 * @member {module:model/GoogleCloudRetailV2alphaCatalogAttribute.ExactSearchableOptionEnum} exactSearchableOption
 */
GoogleCloudRetailV2alphaCatalogAttribute.prototype['exactSearchableOption'] = undefined;

/**
 * @member {module:model/GoogleCloudRetailV2alphaCatalogAttributeFacetConfig} facetConfig
 */
GoogleCloudRetailV2alphaCatalogAttribute.prototype['facetConfig'] = undefined;
 ...
 */
GoogleCloudRetailV2alphaCatalogAttribute.prototype['inUse'] = undefined;
 ...
 * @member {module:model/GoogleCloudRetailV2alphaCatalogAttribute.IndexableOptionEnum} indexableOption
 */
GoogleCloudRetailV2alphaCatalogAttribute.prototype['indexableOption'] = undefined;
 ...
 * @member {String} key
 */
GoogleCloudRetailV2alphaCatalogAttribute.prototype['key'] = undefined;
 ...
 * @member {module:model/GoogleCloudRetailV2alphaCatalogAttribute.RecommendationsFilteringOptionEnum} recommendationsFilteringOption
 */
GoogleCloudRetailV2alphaCatalogAttribute.prototype['recommendationsFilteringOption'] = undefined;
 ...
 * @member {module:model/GoogleCloudRetailV2alphaCatalogAttribute.RetrievableOptionEnum} retrievableOption
 */
GoogleCloudRetailV2alphaCatalogAttribute.prototype['retrievableOption'] = undefined;
 ...
 * @member {module:model/GoogleCloudRetailV2alphaCatalogAttribute.SearchableOptionEnum} searchableOption
 */
GoogleCloudRetailV2alphaCatalogAttribute.prototype['searchableOption'] = undefined;

/**
 * Output only. The type of this attribute. This is derived from the attribute in Product.attributes.
 * @member {module:model/GoogleCloudRetailV2alphaCatalogAttribute.TypeEnum} type
 */
GoogleCloudRetailV2alphaCatalogAttribute.prototype['type'] = undefined;
 ...
 * @readonly
 */
GoogleCloudRetailV2alphaCatalogAttribute['DynamicFacetableOptionEnum'] = {
 ...
 * @readonly
 */
GoogleCloudRetailV2alphaCatalogAttribute['ExactSearchableOptionEnum'] = {
 ...
 * @readonly
 */
GoogleCloudRetailV2alphaCatalogAttribute['IndexableOptionEnum'] = {
 ...
 * @readonly
 */
GoogleCloudRetailV2alphaCatalogAttribute['RecommendationsFilteringOptionEnum'] = {
 ...
 * @readonly
 */
GoogleCloudRetailV2alphaCatalogAttribute['RetrievableOptionEnum'] = {
 ...
 * @readonly
 */
GoogleCloudRetailV2alphaCatalogAttribute['SearchableOptionEnum'] = {
 ...
 * @readonly
 */
GoogleCloudRetailV2alphaCatalogAttribute['TypeEnum'] = {
...
export default GoogleCloudRetailV2alphaCatalogAttribute;
