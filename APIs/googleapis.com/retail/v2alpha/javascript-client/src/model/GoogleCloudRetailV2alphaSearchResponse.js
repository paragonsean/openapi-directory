...
/**
 * The GoogleCloudRetailV2alphaSearchResponse model module.
 * @module model/GoogleCloudRetailV2alphaSearchResponse
 * @version v2alpha
 */
class GoogleCloudRetailV2alphaSearchResponse {
    /**
     * Constructs a new <code>GoogleCloudRetailV2alphaSearchResponse</code>.
     * Response message for SearchService.Search method.
     * @alias module:model/GoogleCloudRetailV2alphaSearchResponse
     */
    constructor() { 
        
        GoogleCloudRetailV2alphaSearchResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudRetailV2alphaSearchResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudRetailV2alphaSearchResponse} obj Optional instance to populate.
     * @return {module:model/GoogleCloudRetailV2alphaSearchResponse} The populated <code>GoogleCloudRetailV2alphaSearchResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudRetailV2alphaSearchResponse();
            ...
            if (data.hasOwnProperty('experimentInfo')) {
                obj['experimentInfo'] = ApiClient.convertToType(data['experimentInfo'], [GoogleCloudRetailV2alphaExperimentInfo]);
            }
            ...
            if (data.hasOwnProperty('invalidConditionBoostSpecs')) {
                obj['invalidConditionBoostSpecs'] = ApiClient.convertToType(data['invalidConditionBoostSpecs'], [GoogleCloudRetailV2alphaSearchRequestBoostSpecConditionBoostSpec]);
            }
            if (data.hasOwnProperty('nextPageToken')) {
                obj['nextPageToken'] = ApiClient.convertToType(data['nextPageToken'], 'String');
            }
            if (data.hasOwnProperty('queryExpansionInfo')) {
                obj['queryExpansionInfo'] = GoogleCloudRetailV2alphaSearchResponseQueryExpansionInfo.constructFromObject(data['queryExpansionInfo']);
            }
            if (data.hasOwnProperty('redirectUri')) {
                obj['redirectUri'] = ApiClient.convertToType(data['redirectUri'], 'String');
            }
            if (data.hasOwnProperty('results')) {
                obj['results'] = ApiClient.convertToType(data['results'], [GoogleCloudRetailV2alphaSearchResponseSearchResult]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudRetailV2alphaSearchResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudRetailV2alphaSearchResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['experimentInfo']) { // data not null
            ...
            for (const item of data['experimentInfo']) {
                GoogleCloudRetailV2alphaExperimentInfo.validateJSON(item);
            };
        }
        ...
        if (data['queryExpansionInfo']) { // data not null
          GoogleCloudRetailV2alphaSearchResponseQueryExpansionInfo.validateJSON(data['queryExpansionInfo']);
        }
        // ensure the json data is a string
        ...
        if (data['results']) { // data not null
            ...
            for (const item of data['results']) {
                GoogleCloudRetailV2alphaSearchResponseSearchResult.validateJSON(item);
            };
        }
 ...
 */
GoogleCloudRetailV2alphaSearchResponse.prototype['appliedControls'] = undefined;

/**
 * A unique search token. This should be included in the UserEvent logs resulting from this search, which enables accurate attribution of search model performance.
 * @member {String} attributionToken
 */
GoogleCloudRetailV2alphaSearchResponse.prototype['attributionToken'] = undefined;

/**
 * Contains the spell corrected query, if found. If the spell correction type is AUTOMATIC, then the search results are based on corrected_query. Otherwise the original query is used for search.
 * @member {String} correctedQuery
 */
GoogleCloudRetailV2alphaSearchResponse.prototype['correctedQuery'] = undefined;

/**
 * Metadata related to A/B testing Experiment associated with this response. Only exists when an experiment is triggered.
 * @member {Array.<module:model/GoogleCloudRetailV2alphaExperimentInfo>} experimentInfo
 */
GoogleCloudRetailV2alphaSearchResponse.prototype['experimentInfo'] = undefined;

/**
 * Results of facets requested by user.
 * @member {Array.<module:model/GoogleCloudRetailV2alphaSearchResponseFacet>} facets
 */
GoogleCloudRetailV2alphaSearchResponse.prototype['facets'] = undefined;

/**
 * The invalid SearchRequest.BoostSpec.condition_boost_specs that are not applied during serving.
 * @member {Array.<module:model/GoogleCloudRetailV2alphaSearchRequestBoostSpecConditionBoostSpec>} invalidConditionBoostSpecs
 */
GoogleCloudRetailV2alphaSearchResponse.prototype['invalidConditionBoostSpecs'] = undefined;

/**
 * A token that can be sent as SearchRequest.page_token to retrieve the next page. If this field is omitted, there are no subsequent pages.
 * @member {String} nextPageToken
 */
GoogleCloudRetailV2alphaSearchResponse.prototype['nextPageToken'] = undefined;

/**
 * @member {module:model/GoogleCloudRetailV2alphaSearchResponseQueryExpansionInfo} queryExpansionInfo
 */
GoogleCloudRetailV2alphaSearchResponse.prototype['queryExpansionInfo'] = undefined;

/**
 * The URI of a customer-defined redirect page. If redirect action is triggered, no search is performed, and only redirect_uri and attribution_token are set in the response.
 * @member {String} redirectUri
 */
GoogleCloudRetailV2alphaSearchResponse.prototype['redirectUri'] = undefined;

/**
 * A list of matched items. The order represents the ranking.
 * @member {Array.<module:model/GoogleCloudRetailV2alphaSearchResponseSearchResult>} results
 */
GoogleCloudRetailV2alphaSearchResponse.prototype['results'] = undefined;

/**
 * The estimated total count of matched items irrespective of pagination. The count of results returned by pagination may be less than the total_size that matches.
 * @member {Number} totalSize
 */
GoogleCloudRetailV2alphaSearchResponse.prototype['totalSize'] = undefined;
...
export default GoogleCloudRetailV2alphaSearchResponse;
