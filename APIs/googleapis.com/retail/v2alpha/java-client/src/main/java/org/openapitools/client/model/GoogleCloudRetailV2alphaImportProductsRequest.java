...
public class GoogleCloudRetailV2alphaImportProductsRequest {
  ...
  public static final String SERIALIZED_NAME_SKIP_DEFAULT_BRANCH_PROTECTION = "skipDefaultBranchProtection";
  @SerializedName(SERIALIZED_NAME_SKIP_DEFAULT_BRANCH_PROTECTION)
  ...
  public GoogleCloudRetailV2alphaImportProductsRequest() {
  }

  public GoogleCloudRetailV2alphaImportProductsRequest errorsConfig(GoogleCloudRetailV2alphaImportErrorsConfig errorsConfig) {
  ...
  public GoogleCloudRetailV2alphaImportProductsRequest inputConfig(GoogleCloudRetailV2alphaProductInputConfig inputConfig) {
  ...
  public void setInputConfig(GoogleCloudRetailV2alphaProductInputConfig inputConfig) {
    this.inputConfig = inputConfig;
  }


  public GoogleCloudRetailV2alphaImportProductsRequest notificationPubsubTopic(String notificationPubsubTopic) {
  ...
  public GoogleCloudRetailV2alphaImportProductsRequest reconciliationMode(ReconciliationModeEnum reconciliationMode) {
  ...
  @Deprecated
  public GoogleCloudRetailV2alphaImportProductsRequest requestId(String requestId) {
  ...
  public GoogleCloudRetailV2alphaImportProductsRequest skipDefaultBranchProtection(Boolean skipDefaultBranchProtection) {
  ...
  public void setSkipDefaultBranchProtection(Boolean skipDefaultBranchProtection) {
    this.skipDefaultBranchProtection = skipDefaultBranchProtection;
  }


  public GoogleCloudRetailV2alphaImportProductsRequest updateMask(String updateMask) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudRetailV2alphaImportProductsRequest googleCloudRetailV2alphaImportProductsRequest = (GoogleCloudRetailV2alphaImportProductsRequest) o;
    return Objects.equals(this.errorsConfig, googleCloudRetailV2alphaImportProductsRequest.errorsConfig) &&
        Objects.equals(this.inputConfig, googleCloudRetailV2alphaImportProductsRequest.inputConfig) &&
        Objects.equals(this.notificationPubsubTopic, googleCloudRetailV2alphaImportProductsRequest.notificationPubsubTopic) &&
        Objects.equals(this.reconciliationMode, googleCloudRetailV2alphaImportProductsRequest.reconciliationMode) &&
        Objects.equals(this.requestId, googleCloudRetailV2alphaImportProductsRequest.requestId) &&
        Objects.equals(this.skipDefaultBranchProtection, googleCloudRetailV2alphaImportProductsRequest.skipDefaultBranchProtection) &&
        Objects.equals(this.updateMask, googleCloudRetailV2alphaImportProductsRequest.updateMask);
  }

  @Override
  public int hashCode() {
    return Objects.hash(errorsConfig, inputConfig, notificationPubsubTopic, reconciliationMode, requestId, skipDefaultBranchProtection, updateMask);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GoogleCloudRetailV2alphaImportProductsRequest {\n");
    ...
    sb.append("    skipDefaultBranchProtection: ").append(toIndentedString(skipDefaultBranchProtection)).append("\n");
  ...
  static {
    ...
    openapiFields.add("skipDefaultBranchProtection");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudRetailV2alphaImportProductsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudRetailV2alphaImportProductsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudRetailV2alphaImportProductsRequest is not found in the empty JSON string", GoogleCloudRetailV2alphaImportProductsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudRetailV2alphaImportProductsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudRetailV2alphaImportProductsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("inputConfig") != null && !jsonObj.get("inputConfig").isJsonNull()) {
        GoogleCloudRetailV2alphaProductInputConfig.validateJsonElement(jsonObj.get("inputConfig"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudRetailV2alphaImportProductsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudRetailV2alphaImportProductsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudRetailV2alphaImportProductsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudRetailV2alphaImportProductsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudRetailV2alphaImportProductsRequest>() {
           @Override
           public void write(JsonWriter out, GoogleCloudRetailV2alphaImportProductsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudRetailV2alphaImportProductsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudRetailV2alphaImportProductsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudRetailV2alphaImportProductsRequest
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudRetailV2alphaImportProductsRequest
   */
  public static GoogleCloudRetailV2alphaImportProductsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudRetailV2alphaImportProductsRequest.class);
  }

  /**
   * Convert an instance of GoogleCloudRetailV2alphaImportProductsRequest to an JSON string
   *
   * @return JSON string
   */
