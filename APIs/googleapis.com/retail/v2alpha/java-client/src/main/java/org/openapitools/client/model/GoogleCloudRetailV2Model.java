...
public class GoogleCloudRetailV2Model {
  ...
  private GoogleCloudRetailV2ModelModelFeaturesConfig modelFeaturesConfig;
  ...
  private List<GoogleCloudRetailV2ModelServingConfigList> servingConfigLists = new ArrayList<>();
  ...
  public GoogleCloudRetailV2Model(
     ...
     String lastTuneTime, 
     List<GoogleCloudRetailV2ModelServingConfigList> servingConfigLists, 
  ...
  public GoogleCloudRetailV2Model displayName(String displayName) {
  ...
  public GoogleCloudRetailV2Model filteringOption(FilteringOptionEnum filteringOption) {
  ...
  public GoogleCloudRetailV2Model modelFeaturesConfig(GoogleCloudRetailV2ModelModelFeaturesConfig modelFeaturesConfig) {
   ...
   */
  @javax.annotation.Nullable
  public GoogleCloudRetailV2ModelModelFeaturesConfig getModelFeaturesConfig() {
    return modelFeaturesConfig;
  }

  public void setModelFeaturesConfig(GoogleCloudRetailV2ModelModelFeaturesConfig modelFeaturesConfig) {
    this.modelFeaturesConfig = modelFeaturesConfig;
  }


  public GoogleCloudRetailV2Model name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GoogleCloudRetailV2Model optimizationObjective(String optimizationObjective) {
  ...
  public GoogleCloudRetailV2Model periodicTuningState(PeriodicTuningStateEnum periodicTuningState) {
   ...
   */
  @javax.annotation.Nullable
  public List<GoogleCloudRetailV2ModelServingConfigList> getServingConfigLists() {
    return servingConfigLists;
  }
  ...
  public GoogleCloudRetailV2Model trainingState(TrainingStateEnum trainingState) {
  ...
  public GoogleCloudRetailV2Model type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudRetailV2Model googleCloudRetailV2Model = (GoogleCloudRetailV2Model) o;
    return Objects.equals(this.createTime, googleCloudRetailV2Model.createTime) &&
        Objects.equals(this.dataState, googleCloudRetailV2Model.dataState) &&
        Objects.equals(this.displayName, googleCloudRetailV2Model.displayName) &&
        Objects.equals(this.filteringOption, googleCloudRetailV2Model.filteringOption) &&
        Objects.equals(this.lastTuneTime, googleCloudRetailV2Model.lastTuneTime) &&
        Objects.equals(this.modelFeaturesConfig, googleCloudRetailV2Model.modelFeaturesConfig) &&
        Objects.equals(this.name, googleCloudRetailV2Model.name) &&
        Objects.equals(this.optimizationObjective, googleCloudRetailV2Model.optimizationObjective) &&
        Objects.equals(this.periodicTuningState, googleCloudRetailV2Model.periodicTuningState) &&
        Objects.equals(this.servingConfigLists, googleCloudRetailV2Model.servingConfigLists) &&
        Objects.equals(this.servingState, googleCloudRetailV2Model.servingState) &&
        Objects.equals(this.trainingState, googleCloudRetailV2Model.trainingState) &&
        Objects.equals(this.tuningOperation, googleCloudRetailV2Model.tuningOperation) &&
        Objects.equals(this.type, googleCloudRetailV2Model.type) &&
        Objects.equals(this.updateTime, googleCloudRetailV2Model.updateTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudRetailV2Model {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudRetailV2Model
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudRetailV2Model.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudRetailV2Model is not found in the empty JSON string", GoogleCloudRetailV2Model.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudRetailV2Model.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudRetailV2Model` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("modelFeaturesConfig") != null && !jsonObj.get("modelFeaturesConfig").isJsonNull()) {
        GoogleCloudRetailV2ModelModelFeaturesConfig.validateJsonElement(jsonObj.get("modelFeaturesConfig"));
      }
      ...
      if (jsonObj.get("servingConfigLists") != null && !jsonObj.get("servingConfigLists").isJsonNull()) {
        ...
        if (jsonArrayservingConfigLists != null) {
          ...
          for (int i = 0; i < jsonArrayservingConfigLists.size(); i++) {
            GoogleCloudRetailV2ModelServingConfigList.validateJsonElement(jsonArrayservingConfigLists.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudRetailV2Model.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudRetailV2Model' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudRetailV2Model> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudRetailV2Model.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudRetailV2Model>() {
           @Override
           public void write(JsonWriter out, GoogleCloudRetailV2Model value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudRetailV2Model read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudRetailV2Model given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudRetailV2Model
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudRetailV2Model
   */
  public static GoogleCloudRetailV2Model fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudRetailV2Model.class);
  }

  /**
   * Convert an instance of GoogleCloudRetailV2Model to an JSON string
   *
   * @return JSON string
   */
