...
public class GoogleCloudRetailV2alphaControl {
  ...
  public GoogleCloudRetailV2alphaControl displayName(String displayName) {
  ...
  public GoogleCloudRetailV2alphaControl facetSpec(GoogleCloudRetailV2alphaSearchRequestFacetSpec facetSpec) {
  ...
  public void setFacetSpec(GoogleCloudRetailV2alphaSearchRequestFacetSpec facetSpec) {
    this.facetSpec = facetSpec;
  }


  public GoogleCloudRetailV2alphaControl name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GoogleCloudRetailV2alphaControl rule(GoogleCloudRetailV2alphaRule rule) {
    this.rule = rule;
    return this;
  }
  ...
  public void setRule(GoogleCloudRetailV2alphaRule rule) {
    this.rule = rule;
  }


  public GoogleCloudRetailV2alphaControl searchSolutionUseCase(List<SearchSolutionUseCaseEnum> searchSolutionUseCase) {
    this.searchSolutionUseCase = searchSolutionUseCase;
    return this;
  }

  public GoogleCloudRetailV2alphaControl addSearchSolutionUseCaseItem(SearchSolutionUseCaseEnum searchSolutionUseCaseItem) {
  ...
  public GoogleCloudRetailV2alphaControl solutionTypes(List<SolutionTypesEnum> solutionTypes) {
    this.solutionTypes = solutionTypes;
    return this;
  }

  public GoogleCloudRetailV2alphaControl addSolutionTypesItem(SolutionTypesEnum solutionTypesItem) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudRetailV2alphaControl googleCloudRetailV2alphaControl = (GoogleCloudRetailV2alphaControl) o;
    return Objects.equals(this.associatedServingConfigIds, googleCloudRetailV2alphaControl.associatedServingConfigIds) &&
        Objects.equals(this.displayName, googleCloudRetailV2alphaControl.displayName) &&
        Objects.equals(this.facetSpec, googleCloudRetailV2alphaControl.facetSpec) &&
        Objects.equals(this.name, googleCloudRetailV2alphaControl.name) &&
        Objects.equals(this.rule, googleCloudRetailV2alphaControl.rule) &&
        Objects.equals(this.searchSolutionUseCase, googleCloudRetailV2alphaControl.searchSolutionUseCase) &&
        Objects.equals(this.solutionTypes, googleCloudRetailV2alphaControl.solutionTypes);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudRetailV2alphaControl {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudRetailV2alphaControl
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudRetailV2alphaControl.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudRetailV2alphaControl is not found in the empty JSON string", GoogleCloudRetailV2alphaControl.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudRetailV2alphaControl.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudRetailV2alphaControl` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("facetSpec") != null && !jsonObj.get("facetSpec").isJsonNull()) {
        GoogleCloudRetailV2alphaSearchRequestFacetSpec.validateJsonElement(jsonObj.get("facetSpec"));
      }
      ...
      if (jsonObj.get("rule") != null && !jsonObj.get("rule").isJsonNull()) {
        GoogleCloudRetailV2alphaRule.validateJsonElement(jsonObj.get("rule"));
      }
      // ensure the optional json data is an array if present
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudRetailV2alphaControl.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudRetailV2alphaControl' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudRetailV2alphaControl> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudRetailV2alphaControl.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudRetailV2alphaControl>() {
           @Override
           public void write(JsonWriter out, GoogleCloudRetailV2alphaControl value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudRetailV2alphaControl read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudRetailV2alphaControl given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudRetailV2alphaControl
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudRetailV2alphaControl
   */
  public static GoogleCloudRetailV2alphaControl fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudRetailV2alphaControl.class);
  }

  /**
   * Convert an instance of GoogleCloudRetailV2alphaControl to an JSON string
   *
   * @return JSON string
   */
