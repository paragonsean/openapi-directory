...
public class GoogleCloudRetailV2alphaMerchantCenterLink {
  ...
  private List<GoogleCloudRetailV2alphaMerchantCenterFeedFilter> feeds = new ArrayList<>();
  ...
  public GoogleCloudRetailV2alphaMerchantCenterLink branchId(String branchId) {
  ...
  public GoogleCloudRetailV2alphaMerchantCenterLink destinations(List<String> destinations) {
    this.destinations = destinations;
    return this;
  }

  public GoogleCloudRetailV2alphaMerchantCenterLink addDestinationsItem(String destinationsItem) {
  ...
  public GoogleCloudRetailV2alphaMerchantCenterLink feeds(List<GoogleCloudRetailV2alphaMerchantCenterFeedFilter> feeds) {
    this.feeds = feeds;
    return this;
  }

  public GoogleCloudRetailV2alphaMerchantCenterLink addFeedsItem(GoogleCloudRetailV2alphaMerchantCenterFeedFilter feedsItem) {
    if (this.feeds == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<GoogleCloudRetailV2alphaMerchantCenterFeedFilter> getFeeds() {
    return feeds;
  }

  public void setFeeds(List<GoogleCloudRetailV2alphaMerchantCenterFeedFilter> feeds) {
    this.feeds = feeds;
  }


  public GoogleCloudRetailV2alphaMerchantCenterLink languageCode(String languageCode) {
  ...
  public GoogleCloudRetailV2alphaMerchantCenterLink merchantCenterAccountId(String merchantCenterAccountId) {
  ...
  public GoogleCloudRetailV2alphaMerchantCenterLink regionCode(String regionCode) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudRetailV2alphaMerchantCenterLink googleCloudRetailV2alphaMerchantCenterLink = (GoogleCloudRetailV2alphaMerchantCenterLink) o;
    return Objects.equals(this.branchId, googleCloudRetailV2alphaMerchantCenterLink.branchId) &&
        Objects.equals(this.destinations, googleCloudRetailV2alphaMerchantCenterLink.destinations) &&
        Objects.equals(this.feeds, googleCloudRetailV2alphaMerchantCenterLink.feeds) &&
        Objects.equals(this.languageCode, googleCloudRetailV2alphaMerchantCenterLink.languageCode) &&
        Objects.equals(this.merchantCenterAccountId, googleCloudRetailV2alphaMerchantCenterLink.merchantCenterAccountId) &&
        Objects.equals(this.regionCode, googleCloudRetailV2alphaMerchantCenterLink.regionCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudRetailV2alphaMerchantCenterLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudRetailV2alphaMerchantCenterLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudRetailV2alphaMerchantCenterLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudRetailV2alphaMerchantCenterLink is not found in the empty JSON string", GoogleCloudRetailV2alphaMerchantCenterLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudRetailV2alphaMerchantCenterLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudRetailV2alphaMerchantCenterLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("feeds") != null && !jsonObj.get("feeds").isJsonNull()) {
        ...
        if (jsonArrayfeeds != null) {
          ...
          for (int i = 0; i < jsonArrayfeeds.size(); i++) {
            GoogleCloudRetailV2alphaMerchantCenterFeedFilter.validateJsonElement(jsonArrayfeeds.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudRetailV2alphaMerchantCenterLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudRetailV2alphaMerchantCenterLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudRetailV2alphaMerchantCenterLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudRetailV2alphaMerchantCenterLink.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudRetailV2alphaMerchantCenterLink>() {
           @Override
           public void write(JsonWriter out, GoogleCloudRetailV2alphaMerchantCenterLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudRetailV2alphaMerchantCenterLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudRetailV2alphaMerchantCenterLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudRetailV2alphaMerchantCenterLink
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudRetailV2alphaMerchantCenterLink
   */
  public static GoogleCloudRetailV2alphaMerchantCenterLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudRetailV2alphaMerchantCenterLink.class);
  }

  /**
   * Convert an instance of GoogleCloudRetailV2alphaMerchantCenterLink to an JSON string
   *
   * @return JSON string
   */
