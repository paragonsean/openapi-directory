...
public class GoogleCloudRetailV2alphaProduct {
  ...
  private List<GoogleCloudRetailV2alphaFulfillmentInfo> fulfillmentInfo = new ArrayList<>();
  ...
  private List<GoogleCloudRetailV2alphaImage> images = new ArrayList<>();
  ...
  private List<GoogleCloudRetailV2alphaPromotion> promotions = new ArrayList<>();
  ...
  private List<GoogleCloudRetailV2alphaProduct> variants = new ArrayList<>();

  public GoogleCloudRetailV2alphaProduct() {
  }

  public GoogleCloudRetailV2alphaProduct(
     List<GoogleCloudRetailV2alphaLocalInventory> localInventories, 
     List<GoogleCloudRetailV2alphaProduct> variants
  ) {
    this();
  ...
  public GoogleCloudRetailV2alphaProduct attributes(Map<String, GoogleCloudRetailV2alphaCustomAttribute> attributes) {
    this.attributes = attributes;
    return this;
  }

  public GoogleCloudRetailV2alphaProduct putAttributesItem(String key, GoogleCloudRetailV2alphaCustomAttribute attributesItem) {
  ...
  public GoogleCloudRetailV2alphaProduct audience(GoogleCloudRetailV2alphaAudience audience) {
  ...
  public void setAudience(GoogleCloudRetailV2alphaAudience audience) {
    this.audience = audience;
  }


  public GoogleCloudRetailV2alphaProduct availability(AvailabilityEnum availability) {
  ...
  public GoogleCloudRetailV2alphaProduct availableQuantity(Integer availableQuantity) {
  ...
  public GoogleCloudRetailV2alphaProduct availableTime(String availableTime) {
  ...
  public GoogleCloudRetailV2alphaProduct brands(List<String> brands) {
    this.brands = brands;
    return this;
  }

  public GoogleCloudRetailV2alphaProduct addBrandsItem(String brandsItem) {
    if (this.brands == null) {
  ...
  public GoogleCloudRetailV2alphaProduct categories(List<String> categories) {
    this.categories = categories;
    return this;
  }

  public GoogleCloudRetailV2alphaProduct addCategoriesItem(String categoriesItem) {
  ...
  public GoogleCloudRetailV2alphaProduct collectionMemberIds(List<String> collectionMemberIds) {
    this.collectionMemberIds = collectionMemberIds;
    return this;
  }

  public GoogleCloudRetailV2alphaProduct addCollectionMemberIdsItem(String collectionMemberIdsItem) {
  ...
  public GoogleCloudRetailV2alphaProduct colorInfo(GoogleCloudRetailV2alphaColorInfo colorInfo) {
  ...
  public void setColorInfo(GoogleCloudRetailV2alphaColorInfo colorInfo) {
    this.colorInfo = colorInfo;
  }


  public GoogleCloudRetailV2alphaProduct conditions(List<String> conditions) {
    this.conditions = conditions;
    return this;
  }

  public GoogleCloudRetailV2alphaProduct addConditionsItem(String conditionsItem) {
  ...
  public GoogleCloudRetailV2alphaProduct description(String description) {
  ...
  public GoogleCloudRetailV2alphaProduct expireTime(String expireTime) {
  ...
  public GoogleCloudRetailV2alphaProduct fulfillmentInfo(List<GoogleCloudRetailV2alphaFulfillmentInfo> fulfillmentInfo) {
    this.fulfillmentInfo = fulfillmentInfo;
    return this;
  }

  public GoogleCloudRetailV2alphaProduct addFulfillmentInfoItem(GoogleCloudRetailV2alphaFulfillmentInfo fulfillmentInfoItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<GoogleCloudRetailV2alphaFulfillmentInfo> getFulfillmentInfo() {
    return fulfillmentInfo;
  }

  public void setFulfillmentInfo(List<GoogleCloudRetailV2alphaFulfillmentInfo> fulfillmentInfo) {
    this.fulfillmentInfo = fulfillmentInfo;
  }


  public GoogleCloudRetailV2alphaProduct gtin(String gtin) {
    this.gtin = gtin;
    return this;
  }
  ...
  public GoogleCloudRetailV2alphaProduct id(String id) {
    this.id = id;
    return this;
  }
  ...
  public GoogleCloudRetailV2alphaProduct images(List<GoogleCloudRetailV2alphaImage> images) {
    this.images = images;
    return this;
  }

  public GoogleCloudRetailV2alphaProduct addImagesItem(GoogleCloudRetailV2alphaImage imagesItem) {
    if (this.images == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<GoogleCloudRetailV2alphaImage> getImages() {
    return images;
  }

  public void setImages(List<GoogleCloudRetailV2alphaImage> images) {
    this.images = images;
  }


  public GoogleCloudRetailV2alphaProduct languageCode(String languageCode) {
  ...
  public GoogleCloudRetailV2alphaProduct materials(List<String> materials) {
    this.materials = materials;
    return this;
  }

  public GoogleCloudRetailV2alphaProduct addMaterialsItem(String materialsItem) {
  ...
  public GoogleCloudRetailV2alphaProduct name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GoogleCloudRetailV2alphaProduct patterns(List<String> patterns) {
    this.patterns = patterns;
    return this;
  }

  public GoogleCloudRetailV2alphaProduct addPatternsItem(String patternsItem) {
  ...
  public GoogleCloudRetailV2alphaProduct priceInfo(GoogleCloudRetailV2alphaPriceInfo priceInfo) {
  ...
  public void setPriceInfo(GoogleCloudRetailV2alphaPriceInfo priceInfo) {
    this.priceInfo = priceInfo;
  }


  public GoogleCloudRetailV2alphaProduct primaryProductId(String primaryProductId) {
  ...
  public GoogleCloudRetailV2alphaProduct promotions(List<GoogleCloudRetailV2alphaPromotion> promotions) {
    this.promotions = promotions;
    return this;
  }

  public GoogleCloudRetailV2alphaProduct addPromotionsItem(GoogleCloudRetailV2alphaPromotion promotionsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<GoogleCloudRetailV2alphaPromotion> getPromotions() {
    return promotions;
  }

  public void setPromotions(List<GoogleCloudRetailV2alphaPromotion> promotions) {
    this.promotions = promotions;
  }


  public GoogleCloudRetailV2alphaProduct publishTime(String publishTime) {
  ...
  public GoogleCloudRetailV2alphaProduct rating(GoogleCloudRetailV2alphaRating rating) {
    this.rating = rating;
    return this;
  }
  ...
  public void setRating(GoogleCloudRetailV2alphaRating rating) {
    this.rating = rating;
  }


  @Deprecated
  public GoogleCloudRetailV2alphaProduct retrievableFields(String retrievableFields) {
  ...
  public GoogleCloudRetailV2alphaProduct sizes(List<String> sizes) {
    this.sizes = sizes;
    return this;
  }

  public GoogleCloudRetailV2alphaProduct addSizesItem(String sizesItem) {
    if (this.sizes == null) {
  ...
  public GoogleCloudRetailV2alphaProduct tags(List<String> tags) {
    this.tags = tags;
    return this;
  }

  public GoogleCloudRetailV2alphaProduct addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public GoogleCloudRetailV2alphaProduct title(String title) {
    this.title = title;
    return this;
  }
  ...
  public GoogleCloudRetailV2alphaProduct ttl(String ttl) {
    this.ttl = ttl;
    return this;
  }
  ...
  public GoogleCloudRetailV2alphaProduct type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public GoogleCloudRetailV2alphaProduct uri(String uri) {
    this.uri = uri;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public List<GoogleCloudRetailV2alphaProduct> getVariants() {
    return variants;
  }
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudRetailV2alphaProduct googleCloudRetailV2alphaProduct = (GoogleCloudRetailV2alphaProduct) o;
    return Objects.equals(this.attributes, googleCloudRetailV2alphaProduct.attributes) &&
        Objects.equals(this.audience, googleCloudRetailV2alphaProduct.audience) &&
        Objects.equals(this.availability, googleCloudRetailV2alphaProduct.availability) &&
        Objects.equals(this.availableQuantity, googleCloudRetailV2alphaProduct.availableQuantity) &&
        Objects.equals(this.availableTime, googleCloudRetailV2alphaProduct.availableTime) &&
        Objects.equals(this.brands, googleCloudRetailV2alphaProduct.brands) &&
        Objects.equals(this.categories, googleCloudRetailV2alphaProduct.categories) &&
        Objects.equals(this.collectionMemberIds, googleCloudRetailV2alphaProduct.collectionMemberIds) &&
        Objects.equals(this.colorInfo, googleCloudRetailV2alphaProduct.colorInfo) &&
        Objects.equals(this.conditions, googleCloudRetailV2alphaProduct.conditions) &&
        Objects.equals(this.description, googleCloudRetailV2alphaProduct.description) &&
        Objects.equals(this.expireTime, googleCloudRetailV2alphaProduct.expireTime) &&
        Objects.equals(this.fulfillmentInfo, googleCloudRetailV2alphaProduct.fulfillmentInfo) &&
        Objects.equals(this.gtin, googleCloudRetailV2alphaProduct.gtin) &&
        Objects.equals(this.id, googleCloudRetailV2alphaProduct.id) &&
        Objects.equals(this.images, googleCloudRetailV2alphaProduct.images) &&
        Objects.equals(this.languageCode, googleCloudRetailV2alphaProduct.languageCode) &&
        Objects.equals(this.localInventories, googleCloudRetailV2alphaProduct.localInventories) &&
        Objects.equals(this.materials, googleCloudRetailV2alphaProduct.materials) &&
        Objects.equals(this.name, googleCloudRetailV2alphaProduct.name) &&
        Objects.equals(this.patterns, googleCloudRetailV2alphaProduct.patterns) &&
        Objects.equals(this.priceInfo, googleCloudRetailV2alphaProduct.priceInfo) &&
        Objects.equals(this.primaryProductId, googleCloudRetailV2alphaProduct.primaryProductId) &&
        Objects.equals(this.promotions, googleCloudRetailV2alphaProduct.promotions) &&
        Objects.equals(this.publishTime, googleCloudRetailV2alphaProduct.publishTime) &&
        Objects.equals(this.rating, googleCloudRetailV2alphaProduct.rating) &&
        Objects.equals(this.retrievableFields, googleCloudRetailV2alphaProduct.retrievableFields) &&
        Objects.equals(this.sizes, googleCloudRetailV2alphaProduct.sizes) &&
        Objects.equals(this.tags, googleCloudRetailV2alphaProduct.tags) &&
        Objects.equals(this.title, googleCloudRetailV2alphaProduct.title) &&
        Objects.equals(this.ttl, googleCloudRetailV2alphaProduct.ttl) &&
        Objects.equals(this.type, googleCloudRetailV2alphaProduct.type) &&
        Objects.equals(this.uri, googleCloudRetailV2alphaProduct.uri) &&
        Objects.equals(this.variants, googleCloudRetailV2alphaProduct.variants);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudRetailV2alphaProduct {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudRetailV2alphaProduct
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudRetailV2alphaProduct.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudRetailV2alphaProduct is not found in the empty JSON string", GoogleCloudRetailV2alphaProduct.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudRetailV2alphaProduct.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudRetailV2alphaProduct` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `audience`
      if (jsonObj.get("audience") != null && !jsonObj.get("audience").isJsonNull()) {
        GoogleCloudRetailV2alphaAudience.validateJsonElement(jsonObj.get("audience"));
      }
      ...
      if (jsonObj.get("colorInfo") != null && !jsonObj.get("colorInfo").isJsonNull()) {
        GoogleCloudRetailV2alphaColorInfo.validateJsonElement(jsonObj.get("colorInfo"));
      }
      // ensure the optional json data is an array if present
      ...
      if (jsonObj.get("fulfillmentInfo") != null && !jsonObj.get("fulfillmentInfo").isJsonNull()) {
        ...
        if (jsonArrayfulfillmentInfo != null) {
          ...
          for (int i = 0; i < jsonArrayfulfillmentInfo.size(); i++) {
            GoogleCloudRetailV2alphaFulfillmentInfo.validateJsonElement(jsonArrayfulfillmentInfo.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("images") != null && !jsonObj.get("images").isJsonNull()) {
        ...
        if (jsonArrayimages != null) {
          ...
          for (int i = 0; i < jsonArrayimages.size(); i++) {
            GoogleCloudRetailV2alphaImage.validateJsonElement(jsonArrayimages.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("priceInfo") != null && !jsonObj.get("priceInfo").isJsonNull()) {
        GoogleCloudRetailV2alphaPriceInfo.validateJsonElement(jsonObj.get("priceInfo"));
      }
      ...
      if (jsonObj.get("promotions") != null && !jsonObj.get("promotions").isJsonNull()) {
        ...
        if (jsonArraypromotions != null) {
          ...
          for (int i = 0; i < jsonArraypromotions.size(); i++) {
            GoogleCloudRetailV2alphaPromotion.validateJsonElement(jsonArraypromotions.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("rating") != null && !jsonObj.get("rating").isJsonNull()) {
        GoogleCloudRetailV2alphaRating.validateJsonElement(jsonObj.get("rating"));
      }
      ...
      if (jsonObj.get("variants") != null && !jsonObj.get("variants").isJsonNull()) {
        ...
        if (jsonArrayvariants != null) {
          ...
          for (int i = 0; i < jsonArrayvariants.size(); i++) {
            GoogleCloudRetailV2alphaProduct.validateJsonElement(jsonArrayvariants.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudRetailV2alphaProduct.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudRetailV2alphaProduct' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudRetailV2alphaProduct> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudRetailV2alphaProduct.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudRetailV2alphaProduct>() {
           @Override
           public void write(JsonWriter out, GoogleCloudRetailV2alphaProduct value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudRetailV2alphaProduct read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudRetailV2alphaProduct given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudRetailV2alphaProduct
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudRetailV2alphaProduct
   */
  public static GoogleCloudRetailV2alphaProduct fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudRetailV2alphaProduct.class);
  }

  /**
   * Convert an instance of GoogleCloudRetailV2alphaProduct to an JSON string
   *
   * @return JSON string
   */
