...
import org.openapitools.client.model.GoogleCloudRetailV2betaModelModelFeaturesConfig;
import org.openapitools.client.model.GoogleCloudRetailV2betaModelServingConfigList;
...
public class GoogleCloudRetailV2betaModel {
  ...
  private GoogleCloudRetailV2betaModelModelFeaturesConfig modelFeaturesConfig;
  ...
  private List<GoogleCloudRetailV2betaModelServingConfigList> servingConfigLists = new ArrayList<>();
  ...
  public GoogleCloudRetailV2betaModel(
     ...
     String lastTuneTime, 
     List<GoogleCloudRetailV2betaModelServingConfigList> servingConfigLists, 
  ...
  public GoogleCloudRetailV2betaModel displayName(String displayName) {
  ...
  public GoogleCloudRetailV2betaModel filteringOption(FilteringOptionEnum filteringOption) {
  ...
  public GoogleCloudRetailV2betaModel modelFeaturesConfig(GoogleCloudRetailV2betaModelModelFeaturesConfig modelFeaturesConfig) {
   ...
   */
  @javax.annotation.Nullable
  public GoogleCloudRetailV2betaModelModelFeaturesConfig getModelFeaturesConfig() {
    return modelFeaturesConfig;
  }

  public void setModelFeaturesConfig(GoogleCloudRetailV2betaModelModelFeaturesConfig modelFeaturesConfig) {
    this.modelFeaturesConfig = modelFeaturesConfig;
  }


  public GoogleCloudRetailV2betaModel name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GoogleCloudRetailV2betaModel optimizationObjective(String optimizationObjective) {
  ...
  public GoogleCloudRetailV2betaModel periodicTuningState(PeriodicTuningStateEnum periodicTuningState) {
   ...
   */
  @javax.annotation.Nullable
  public List<GoogleCloudRetailV2betaModelServingConfigList> getServingConfigLists() {
    return servingConfigLists;
  }
  ...
  public GoogleCloudRetailV2betaModel trainingState(TrainingStateEnum trainingState) {
  ...
  public GoogleCloudRetailV2betaModel type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudRetailV2betaModel googleCloudRetailV2betaModel = (GoogleCloudRetailV2betaModel) o;
    return Objects.equals(this.createTime, googleCloudRetailV2betaModel.createTime) &&
        Objects.equals(this.dataState, googleCloudRetailV2betaModel.dataState) &&
        Objects.equals(this.displayName, googleCloudRetailV2betaModel.displayName) &&
        Objects.equals(this.filteringOption, googleCloudRetailV2betaModel.filteringOption) &&
        Objects.equals(this.lastTuneTime, googleCloudRetailV2betaModel.lastTuneTime) &&
        Objects.equals(this.modelFeaturesConfig, googleCloudRetailV2betaModel.modelFeaturesConfig) &&
        Objects.equals(this.name, googleCloudRetailV2betaModel.name) &&
        Objects.equals(this.optimizationObjective, googleCloudRetailV2betaModel.optimizationObjective) &&
        Objects.equals(this.periodicTuningState, googleCloudRetailV2betaModel.periodicTuningState) &&
        Objects.equals(this.servingConfigLists, googleCloudRetailV2betaModel.servingConfigLists) &&
        Objects.equals(this.servingState, googleCloudRetailV2betaModel.servingState) &&
        Objects.equals(this.trainingState, googleCloudRetailV2betaModel.trainingState) &&
        Objects.equals(this.tuningOperation, googleCloudRetailV2betaModel.tuningOperation) &&
        Objects.equals(this.type, googleCloudRetailV2betaModel.type) &&
        Objects.equals(this.updateTime, googleCloudRetailV2betaModel.updateTime);
  }

  @Override
  public int hashCode() {
    return Objects.hash(createTime, dataState, displayName, filteringOption, lastTuneTime, modelFeaturesConfig, name, optimizationObjective, periodicTuningState, servingConfigLists, servingState, trainingState, tuningOperation, type, updateTime);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GoogleCloudRetailV2betaModel {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudRetailV2betaModel
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudRetailV2betaModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudRetailV2betaModel is not found in the empty JSON string", GoogleCloudRetailV2betaModel.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudRetailV2betaModel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudRetailV2betaModel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("modelFeaturesConfig") != null && !jsonObj.get("modelFeaturesConfig").isJsonNull()) {
        GoogleCloudRetailV2betaModelModelFeaturesConfig.validateJsonElement(jsonObj.get("modelFeaturesConfig"));
      }
      ...
      if (jsonObj.get("servingConfigLists") != null && !jsonObj.get("servingConfigLists").isJsonNull()) {
        ...
        if (jsonArrayservingConfigLists != null) {
          ...
          for (int i = 0; i < jsonArrayservingConfigLists.size(); i++) {
            GoogleCloudRetailV2betaModelServingConfigList.validateJsonElement(jsonArrayservingConfigLists.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudRetailV2betaModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudRetailV2betaModel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudRetailV2betaModel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudRetailV2betaModel.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudRetailV2betaModel>() {
           @Override
           public void write(JsonWriter out, GoogleCloudRetailV2betaModel value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudRetailV2betaModel read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudRetailV2betaModel given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudRetailV2betaModel
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudRetailV2betaModel
   */
  public static GoogleCloudRetailV2betaModel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudRetailV2betaModel.class);
  }

  /**
   * Convert an instance of GoogleCloudRetailV2betaModel to an JSON string
   *
   * @return JSON string
   */
