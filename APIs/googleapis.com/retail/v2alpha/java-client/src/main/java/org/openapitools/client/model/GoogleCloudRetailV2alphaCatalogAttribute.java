...
public class GoogleCloudRetailV2alphaCatalogAttribute {
  /**
  ...
  public GoogleCloudRetailV2alphaCatalogAttribute() {
  }
  ...
  public GoogleCloudRetailV2alphaCatalogAttribute dynamicFacetableOption(DynamicFacetableOptionEnum dynamicFacetableOption) {
  ...
  public GoogleCloudRetailV2alphaCatalogAttribute exactSearchableOption(ExactSearchableOptionEnum exactSearchableOption) {
  ...
  public GoogleCloudRetailV2alphaCatalogAttribute facetConfig(GoogleCloudRetailV2alphaCatalogAttributeFacetConfig facetConfig) {
  ...
  public void setFacetConfig(GoogleCloudRetailV2alphaCatalogAttributeFacetConfig facetConfig) {
    this.facetConfig = facetConfig;
  }
  ...
  public GoogleCloudRetailV2alphaCatalogAttribute indexableOption(IndexableOptionEnum indexableOption) {
  ...
  public GoogleCloudRetailV2alphaCatalogAttribute key(String key) {
    this.key = key;
    return this;
  }
  ...
  public GoogleCloudRetailV2alphaCatalogAttribute recommendationsFilteringOption(RecommendationsFilteringOptionEnum recommendationsFilteringOption) {
  ...
  public GoogleCloudRetailV2alphaCatalogAttribute retrievableOption(RetrievableOptionEnum retrievableOption) {
  ...
  public GoogleCloudRetailV2alphaCatalogAttribute searchableOption(SearchableOptionEnum searchableOption) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudRetailV2alphaCatalogAttribute googleCloudRetailV2alphaCatalogAttribute = (GoogleCloudRetailV2alphaCatalogAttribute) o;
    return Objects.equals(this.dynamicFacetableOption, googleCloudRetailV2alphaCatalogAttribute.dynamicFacetableOption) &&
        Objects.equals(this.exactSearchableOption, googleCloudRetailV2alphaCatalogAttribute.exactSearchableOption) &&
        Objects.equals(this.facetConfig, googleCloudRetailV2alphaCatalogAttribute.facetConfig) &&
        Objects.equals(this.inUse, googleCloudRetailV2alphaCatalogAttribute.inUse) &&
        Objects.equals(this.indexableOption, googleCloudRetailV2alphaCatalogAttribute.indexableOption) &&
        Objects.equals(this.key, googleCloudRetailV2alphaCatalogAttribute.key) &&
        Objects.equals(this.recommendationsFilteringOption, googleCloudRetailV2alphaCatalogAttribute.recommendationsFilteringOption) &&
        Objects.equals(this.retrievableOption, googleCloudRetailV2alphaCatalogAttribute.retrievableOption) &&
        Objects.equals(this.searchableOption, googleCloudRetailV2alphaCatalogAttribute.searchableOption) &&
        Objects.equals(this.type, googleCloudRetailV2alphaCatalogAttribute.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudRetailV2alphaCatalogAttribute {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudRetailV2alphaCatalogAttribute
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudRetailV2alphaCatalogAttribute.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudRetailV2alphaCatalogAttribute is not found in the empty JSON string", GoogleCloudRetailV2alphaCatalogAttribute.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudRetailV2alphaCatalogAttribute.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudRetailV2alphaCatalogAttribute` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("facetConfig") != null && !jsonObj.get("facetConfig").isJsonNull()) {
        GoogleCloudRetailV2alphaCatalogAttributeFacetConfig.validateJsonElement(jsonObj.get("facetConfig"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudRetailV2alphaCatalogAttribute.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudRetailV2alphaCatalogAttribute' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudRetailV2alphaCatalogAttribute> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudRetailV2alphaCatalogAttribute.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudRetailV2alphaCatalogAttribute>() {
           @Override
           public void write(JsonWriter out, GoogleCloudRetailV2alphaCatalogAttribute value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudRetailV2alphaCatalogAttribute read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudRetailV2alphaCatalogAttribute given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudRetailV2alphaCatalogAttribute
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudRetailV2alphaCatalogAttribute
   */
  public static GoogleCloudRetailV2alphaCatalogAttribute fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudRetailV2alphaCatalogAttribute.class);
  }

  /**
   * Convert an instance of GoogleCloudRetailV2alphaCatalogAttribute to an JSON string
   *
   * @return JSON string
   */
