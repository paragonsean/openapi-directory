...
|------------ | ------------- | ------------- | -------------|
|**activeTimeRange** | [**List&lt;GoogleCloudRetailV2ConditionTimeRange&gt;**](GoogleCloudRetailV2ConditionTimeRange.md) | Range of time(s) specifying when Condition is active. Condition true if any time range matches. |  [optional] |
