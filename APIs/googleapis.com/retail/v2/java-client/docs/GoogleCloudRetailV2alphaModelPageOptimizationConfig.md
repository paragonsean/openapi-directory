...
|**restriction** | [**RestrictionEnum**](#RestrictionEnum) | Optional. How to restrict results across panels e.g. can the same ServingConfig be shown on multiple panels at once. If unspecified, default to &#x60;UNIQUE_MODEL_RESTRICTION&#x60;. |  [optional] |
