...
|**localInventories** | [**List&lt;GoogleCloudRetailV2LocalInventory&gt;**](GoogleCloudRetailV2LocalInventory.md) | Required. A list of inventory information at difference places. Each place is identified by its place ID. At most 3000 inventories are allowed per request. |  [optional] |
