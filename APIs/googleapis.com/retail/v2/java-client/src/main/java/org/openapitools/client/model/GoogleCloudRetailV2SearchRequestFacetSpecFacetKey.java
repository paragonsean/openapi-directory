...
public class GoogleCloudRetailV2SearchRequestFacetSpecFacetKey {
  ...
  private List<GoogleCloudRetailV2Interval> intervals = new ArrayList<>();
  ...
  public GoogleCloudRetailV2SearchRequestFacetSpecFacetKey caseInsensitive(Boolean caseInsensitive) {
  ...
  public GoogleCloudRetailV2SearchRequestFacetSpecFacetKey contains(List<String> contains) {
    this.contains = contains;
    return this;
  }

  public GoogleCloudRetailV2SearchRequestFacetSpecFacetKey addContainsItem(String containsItem) {
  ...
  public GoogleCloudRetailV2SearchRequestFacetSpecFacetKey intervals(List<GoogleCloudRetailV2Interval> intervals) {
    this.intervals = intervals;
    return this;
  }

  public GoogleCloudRetailV2SearchRequestFacetSpecFacetKey addIntervalsItem(GoogleCloudRetailV2Interval intervalsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<GoogleCloudRetailV2Interval> getIntervals() {
    return intervals;
  }

  public void setIntervals(List<GoogleCloudRetailV2Interval> intervals) {
    this.intervals = intervals;
  }


  public GoogleCloudRetailV2SearchRequestFacetSpecFacetKey key(String key) {
    this.key = key;
    return this;
  }
  ...
  public GoogleCloudRetailV2SearchRequestFacetSpecFacetKey orderBy(String orderBy) {
  ...
  public GoogleCloudRetailV2SearchRequestFacetSpecFacetKey prefixes(List<String> prefixes) {
    this.prefixes = prefixes;
    return this;
  }

  public GoogleCloudRetailV2SearchRequestFacetSpecFacetKey addPrefixesItem(String prefixesItem) {
  ...
  public GoogleCloudRetailV2SearchRequestFacetSpecFacetKey query(String query) {
    this.query = query;
    return this;
  }
  ...
  public GoogleCloudRetailV2SearchRequestFacetSpecFacetKey restrictedValues(List<String> restrictedValues) {
    this.restrictedValues = restrictedValues;
    return this;
  }

  public GoogleCloudRetailV2SearchRequestFacetSpecFacetKey addRestrictedValuesItem(String restrictedValuesItem) {
  ...
  public GoogleCloudRetailV2SearchRequestFacetSpecFacetKey returnMinMax(Boolean returnMinMax) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudRetailV2SearchRequestFacetSpecFacetKey googleCloudRetailV2SearchRequestFacetSpecFacetKey = (GoogleCloudRetailV2SearchRequestFacetSpecFacetKey) o;
    return Objects.equals(this.caseInsensitive, googleCloudRetailV2SearchRequestFacetSpecFacetKey.caseInsensitive) &&
        Objects.equals(this.contains, googleCloudRetailV2SearchRequestFacetSpecFacetKey.contains) &&
        Objects.equals(this.intervals, googleCloudRetailV2SearchRequestFacetSpecFacetKey.intervals) &&
        Objects.equals(this.key, googleCloudRetailV2SearchRequestFacetSpecFacetKey.key) &&
        Objects.equals(this.orderBy, googleCloudRetailV2SearchRequestFacetSpecFacetKey.orderBy) &&
        Objects.equals(this.prefixes, googleCloudRetailV2SearchRequestFacetSpecFacetKey.prefixes) &&
        Objects.equals(this.query, googleCloudRetailV2SearchRequestFacetSpecFacetKey.query) &&
        Objects.equals(this.restrictedValues, googleCloudRetailV2SearchRequestFacetSpecFacetKey.restrictedValues) &&
        Objects.equals(this.returnMinMax, googleCloudRetailV2SearchRequestFacetSpecFacetKey.returnMinMax);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudRetailV2SearchRequestFacetSpecFacetKey {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudRetailV2SearchRequestFacetSpecFacetKey
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudRetailV2SearchRequestFacetSpecFacetKey.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudRetailV2SearchRequestFacetSpecFacetKey is not found in the empty JSON string", GoogleCloudRetailV2SearchRequestFacetSpecFacetKey.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudRetailV2SearchRequestFacetSpecFacetKey.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudRetailV2SearchRequestFacetSpecFacetKey` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("intervals") != null && !jsonObj.get("intervals").isJsonNull()) {
        ...
        if (jsonArrayintervals != null) {
          ...
          for (int i = 0; i < jsonArrayintervals.size(); i++) {
            GoogleCloudRetailV2Interval.validateJsonElement(jsonArrayintervals.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudRetailV2SearchRequestFacetSpecFacetKey.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudRetailV2SearchRequestFacetSpecFacetKey' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudRetailV2SearchRequestFacetSpecFacetKey> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudRetailV2SearchRequestFacetSpecFacetKey.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudRetailV2SearchRequestFacetSpecFacetKey>() {
           @Override
           public void write(JsonWriter out, GoogleCloudRetailV2SearchRequestFacetSpecFacetKey value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudRetailV2SearchRequestFacetSpecFacetKey read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudRetailV2SearchRequestFacetSpecFacetKey given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudRetailV2SearchRequestFacetSpecFacetKey
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudRetailV2SearchRequestFacetSpecFacetKey
   */
  public static GoogleCloudRetailV2SearchRequestFacetSpecFacetKey fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudRetailV2SearchRequestFacetSpecFacetKey.class);
  }

  /**
   * Convert an instance of GoogleCloudRetailV2SearchRequestFacetSpecFacetKey to an JSON string
   *
   * @return JSON string
   */
