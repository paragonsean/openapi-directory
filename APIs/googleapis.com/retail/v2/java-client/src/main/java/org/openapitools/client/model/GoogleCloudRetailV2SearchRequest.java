...
public class GoogleCloudRetailV2SearchRequest {
  ...
  private List<GoogleCloudRetailV2SearchRequestFacetSpec> facetSpecs = new ArrayList<>();
  ...
  public GoogleCloudRetailV2SearchRequest boostSpec(GoogleCloudRetailV2SearchRequestBoostSpec boostSpec) {
  ...
  public void setBoostSpec(GoogleCloudRetailV2SearchRequestBoostSpec boostSpec) {
    this.boostSpec = boostSpec;
  }


  public GoogleCloudRetailV2SearchRequest branch(String branch) {
    this.branch = branch;
    return this;
  }
  ...
  public GoogleCloudRetailV2SearchRequest canonicalFilter(String canonicalFilter) {
  ...
  public GoogleCloudRetailV2SearchRequest dynamicFacetSpec(GoogleCloudRetailV2SearchRequestDynamicFacetSpec dynamicFacetSpec) {
  ...
  public void setDynamicFacetSpec(GoogleCloudRetailV2SearchRequestDynamicFacetSpec dynamicFacetSpec) {
    this.dynamicFacetSpec = dynamicFacetSpec;
  }


  public GoogleCloudRetailV2SearchRequest entity(String entity) {
    this.entity = entity;
    return this;
  }
  ...
  public GoogleCloudRetailV2SearchRequest facetSpecs(List<GoogleCloudRetailV2SearchRequestFacetSpec> facetSpecs) {
    this.facetSpecs = facetSpecs;
    return this;
  }

  public GoogleCloudRetailV2SearchRequest addFacetSpecsItem(GoogleCloudRetailV2SearchRequestFacetSpec facetSpecsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<GoogleCloudRetailV2SearchRequestFacetSpec> getFacetSpecs() {
    return facetSpecs;
  }

  public void setFacetSpecs(List<GoogleCloudRetailV2SearchRequestFacetSpec> facetSpecs) {
    this.facetSpecs = facetSpecs;
  }


  public GoogleCloudRetailV2SearchRequest filter(String filter) {
    this.filter = filter;
    return this;
  }
  ...
  public GoogleCloudRetailV2SearchRequest labels(Map<String, String> labels) {
    this.labels = labels;
    return this;
  }

  public GoogleCloudRetailV2SearchRequest putLabelsItem(String key, String labelsItem) {
    if (this.labels == null) {
  ...
  public GoogleCloudRetailV2SearchRequest offset(Integer offset) {
    this.offset = offset;
    return this;
  }
  ...
  public GoogleCloudRetailV2SearchRequest orderBy(String orderBy) {
  ...
  public GoogleCloudRetailV2SearchRequest pageCategories(List<String> pageCategories) {
    this.pageCategories = pageCategories;
    return this;
  }

  public GoogleCloudRetailV2SearchRequest addPageCategoriesItem(String pageCategoriesItem) {
  ...
  public GoogleCloudRetailV2SearchRequest pageSize(Integer pageSize) {
  ...
  public GoogleCloudRetailV2SearchRequest pageToken(String pageToken) {
  ...
  public GoogleCloudRetailV2SearchRequest personalizationSpec(GoogleCloudRetailV2SearchRequestPersonalizationSpec personalizationSpec) {
  ...
  public void setPersonalizationSpec(GoogleCloudRetailV2SearchRequestPersonalizationSpec personalizationSpec) {
    this.personalizationSpec = personalizationSpec;
  }


  public GoogleCloudRetailV2SearchRequest query(String query) {
    this.query = query;
    return this;
  }
  ...
  public GoogleCloudRetailV2SearchRequest queryExpansionSpec(GoogleCloudRetailV2SearchRequestQueryExpansionSpec queryExpansionSpec) {
  ...
  public void setQueryExpansionSpec(GoogleCloudRetailV2SearchRequestQueryExpansionSpec queryExpansionSpec) {
    this.queryExpansionSpec = queryExpansionSpec;
  }


  public GoogleCloudRetailV2SearchRequest searchMode(SearchModeEnum searchMode) {
  ...
  public GoogleCloudRetailV2SearchRequest spellCorrectionSpec(GoogleCloudRetailV2SearchRequestSpellCorrectionSpec spellCorrectionSpec) {
  ...
  public void setSpellCorrectionSpec(GoogleCloudRetailV2SearchRequestSpellCorrectionSpec spellCorrectionSpec) {
    this.spellCorrectionSpec = spellCorrectionSpec;
  }


  public GoogleCloudRetailV2SearchRequest userInfo(GoogleCloudRetailV2UserInfo userInfo) {
  ...
  public void setUserInfo(GoogleCloudRetailV2UserInfo userInfo) {
    this.userInfo = userInfo;
  }


  public GoogleCloudRetailV2SearchRequest variantRollupKeys(List<String> variantRollupKeys) {
    this.variantRollupKeys = variantRollupKeys;
    return this;
  }

  public GoogleCloudRetailV2SearchRequest addVariantRollupKeysItem(String variantRollupKeysItem) {
  ...
  public GoogleCloudRetailV2SearchRequest visitorId(String visitorId) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudRetailV2SearchRequest googleCloudRetailV2SearchRequest = (GoogleCloudRetailV2SearchRequest) o;
    return Objects.equals(this.boostSpec, googleCloudRetailV2SearchRequest.boostSpec) &&
        Objects.equals(this.branch, googleCloudRetailV2SearchRequest.branch) &&
        Objects.equals(this.canonicalFilter, googleCloudRetailV2SearchRequest.canonicalFilter) &&
        Objects.equals(this.dynamicFacetSpec, googleCloudRetailV2SearchRequest.dynamicFacetSpec) &&
        Objects.equals(this.entity, googleCloudRetailV2SearchRequest.entity) &&
        Objects.equals(this.facetSpecs, googleCloudRetailV2SearchRequest.facetSpecs) &&
        Objects.equals(this.filter, googleCloudRetailV2SearchRequest.filter) &&
        Objects.equals(this.labels, googleCloudRetailV2SearchRequest.labels) &&
        Objects.equals(this.offset, googleCloudRetailV2SearchRequest.offset) &&
        Objects.equals(this.orderBy, googleCloudRetailV2SearchRequest.orderBy) &&
        Objects.equals(this.pageCategories, googleCloudRetailV2SearchRequest.pageCategories) &&
        Objects.equals(this.pageSize, googleCloudRetailV2SearchRequest.pageSize) &&
        Objects.equals(this.pageToken, googleCloudRetailV2SearchRequest.pageToken) &&
        Objects.equals(this.personalizationSpec, googleCloudRetailV2SearchRequest.personalizationSpec) &&
        Objects.equals(this.query, googleCloudRetailV2SearchRequest.query) &&
        Objects.equals(this.queryExpansionSpec, googleCloudRetailV2SearchRequest.queryExpansionSpec) &&
        Objects.equals(this.searchMode, googleCloudRetailV2SearchRequest.searchMode) &&
        Objects.equals(this.spellCorrectionSpec, googleCloudRetailV2SearchRequest.spellCorrectionSpec) &&
        Objects.equals(this.userInfo, googleCloudRetailV2SearchRequest.userInfo) &&
        Objects.equals(this.variantRollupKeys, googleCloudRetailV2SearchRequest.variantRollupKeys) &&
        Objects.equals(this.visitorId, googleCloudRetailV2SearchRequest.visitorId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(boostSpec, branch, canonicalFilter, dynamicFacetSpec, entity, facetSpecs, filter, labels, offset, orderBy, pageCategories, pageSize, pageToken, personalizationSpec, query, queryExpansionSpec, searchMode, spellCorrectionSpec, userInfo, variantRollupKeys, visitorId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GoogleCloudRetailV2SearchRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudRetailV2SearchRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudRetailV2SearchRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudRetailV2SearchRequest is not found in the empty JSON string", GoogleCloudRetailV2SearchRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudRetailV2SearchRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudRetailV2SearchRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `boostSpec`
      if (jsonObj.get("boostSpec") != null && !jsonObj.get("boostSpec").isJsonNull()) {
        GoogleCloudRetailV2SearchRequestBoostSpec.validateJsonElement(jsonObj.get("boostSpec"));
      }
      ...
      if (jsonObj.get("dynamicFacetSpec") != null && !jsonObj.get("dynamicFacetSpec").isJsonNull()) {
        GoogleCloudRetailV2SearchRequestDynamicFacetSpec.validateJsonElement(jsonObj.get("dynamicFacetSpec"));
      }
      ...
      if (jsonObj.get("facetSpecs") != null && !jsonObj.get("facetSpecs").isJsonNull()) {
        ...
        if (jsonArrayfacetSpecs != null) {
          ...
          for (int i = 0; i < jsonArrayfacetSpecs.size(); i++) {
            GoogleCloudRetailV2SearchRequestFacetSpec.validateJsonElement(jsonArrayfacetSpecs.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("personalizationSpec") != null && !jsonObj.get("personalizationSpec").isJsonNull()) {
        GoogleCloudRetailV2SearchRequestPersonalizationSpec.validateJsonElement(jsonObj.get("personalizationSpec"));
      }
      ...
      if (jsonObj.get("queryExpansionSpec") != null && !jsonObj.get("queryExpansionSpec").isJsonNull()) {
        GoogleCloudRetailV2SearchRequestQueryExpansionSpec.validateJsonElement(jsonObj.get("queryExpansionSpec"));
      }
      ...
      if (jsonObj.get("spellCorrectionSpec") != null && !jsonObj.get("spellCorrectionSpec").isJsonNull()) {
        GoogleCloudRetailV2SearchRequestSpellCorrectionSpec.validateJsonElement(jsonObj.get("spellCorrectionSpec"));
      }
      // validate the optional field `userInfo`
      if (jsonObj.get("userInfo") != null && !jsonObj.get("userInfo").isJsonNull()) {
        GoogleCloudRetailV2UserInfo.validateJsonElement(jsonObj.get("userInfo"));
      }
      // ensure the optional json data is an array if present
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudRetailV2SearchRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudRetailV2SearchRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudRetailV2SearchRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudRetailV2SearchRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudRetailV2SearchRequest>() {
           @Override
           public void write(JsonWriter out, GoogleCloudRetailV2SearchRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudRetailV2SearchRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudRetailV2SearchRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudRetailV2SearchRequest
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudRetailV2SearchRequest
   */
  public static GoogleCloudRetailV2SearchRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudRetailV2SearchRequest.class);
  }

  /**
   * Convert an instance of GoogleCloudRetailV2SearchRequest to an JSON string
   *
   * @return JSON string
   */
