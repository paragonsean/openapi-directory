...
public class GoogleCloudRetailV2ServingConfig {
  ...
  public GoogleCloudRetailV2ServingConfig() {
  }

  public GoogleCloudRetailV2ServingConfig boostControlIds(List<String> boostControlIds) {
    this.boostControlIds = boostControlIds;
    return this;
  }

  public GoogleCloudRetailV2ServingConfig addBoostControlIdsItem(String boostControlIdsItem) {
  ...
  public GoogleCloudRetailV2ServingConfig displayName(String displayName) {
  ...
  public GoogleCloudRetailV2ServingConfig diversityLevel(String diversityLevel) {
  ...
  public GoogleCloudRetailV2ServingConfig diversityType(DiversityTypeEnum diversityType) {
  ...
  public GoogleCloudRetailV2ServingConfig doNotAssociateControlIds(List<String> doNotAssociateControlIds) {
    this.doNotAssociateControlIds = doNotAssociateControlIds;
    return this;
  }

  public GoogleCloudRetailV2ServingConfig addDoNotAssociateControlIdsItem(String doNotAssociateControlIdsItem) {
  ...
  public GoogleCloudRetailV2ServingConfig dynamicFacetSpec(GoogleCloudRetailV2SearchRequestDynamicFacetSpec dynamicFacetSpec) {
  ...
  public GoogleCloudRetailV2ServingConfig enableCategoryFilterLevel(String enableCategoryFilterLevel) {
  ...
  public GoogleCloudRetailV2ServingConfig facetControlIds(List<String> facetControlIds) {
    this.facetControlIds = facetControlIds;
    return this;
  }

  public GoogleCloudRetailV2ServingConfig addFacetControlIdsItem(String facetControlIdsItem) {
  ...
  public GoogleCloudRetailV2ServingConfig filterControlIds(List<String> filterControlIds) {
    this.filterControlIds = filterControlIds;
    return this;
  }

  public GoogleCloudRetailV2ServingConfig addFilterControlIdsItem(String filterControlIdsItem) {
  ...
  public GoogleCloudRetailV2ServingConfig ignoreControlIds(List<String> ignoreControlIds) {
    this.ignoreControlIds = ignoreControlIds;
    return this;
  }

  public GoogleCloudRetailV2ServingConfig addIgnoreControlIdsItem(String ignoreControlIdsItem) {
  ...
  public GoogleCloudRetailV2ServingConfig modelId(String modelId) {
  ...
  public GoogleCloudRetailV2ServingConfig name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GoogleCloudRetailV2ServingConfig onewaySynonymsControlIds(List<String> onewaySynonymsControlIds) {
    this.onewaySynonymsControlIds = onewaySynonymsControlIds;
    return this;
  }

  public GoogleCloudRetailV2ServingConfig addOnewaySynonymsControlIdsItem(String onewaySynonymsControlIdsItem) {
  ...
  public GoogleCloudRetailV2ServingConfig personalizationSpec(GoogleCloudRetailV2SearchRequestPersonalizationSpec personalizationSpec) {
  ...
  public GoogleCloudRetailV2ServingConfig priceRerankingLevel(String priceRerankingLevel) {
  ...
  public GoogleCloudRetailV2ServingConfig redirectControlIds(List<String> redirectControlIds) {
    this.redirectControlIds = redirectControlIds;
    return this;
  }

  public GoogleCloudRetailV2ServingConfig addRedirectControlIdsItem(String redirectControlIdsItem) {
  ...
  public GoogleCloudRetailV2ServingConfig replacementControlIds(List<String> replacementControlIds) {
    this.replacementControlIds = replacementControlIds;
    return this;
  }

  public GoogleCloudRetailV2ServingConfig addReplacementControlIdsItem(String replacementControlIdsItem) {
  ...
  public GoogleCloudRetailV2ServingConfig solutionTypes(List<SolutionTypesEnum> solutionTypes) {
    this.solutionTypes = solutionTypes;
    return this;
  }

  public GoogleCloudRetailV2ServingConfig addSolutionTypesItem(SolutionTypesEnum solutionTypesItem) {
  ...
  public GoogleCloudRetailV2ServingConfig twowaySynonymsControlIds(List<String> twowaySynonymsControlIds) {
    this.twowaySynonymsControlIds = twowaySynonymsControlIds;
    return this;
  }

  public GoogleCloudRetailV2ServingConfig addTwowaySynonymsControlIdsItem(String twowaySynonymsControlIdsItem) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudRetailV2ServingConfig googleCloudRetailV2ServingConfig = (GoogleCloudRetailV2ServingConfig) o;
    return Objects.equals(this.boostControlIds, googleCloudRetailV2ServingConfig.boostControlIds) &&
        Objects.equals(this.displayName, googleCloudRetailV2ServingConfig.displayName) &&
        Objects.equals(this.diversityLevel, googleCloudRetailV2ServingConfig.diversityLevel) &&
        Objects.equals(this.diversityType, googleCloudRetailV2ServingConfig.diversityType) &&
        Objects.equals(this.doNotAssociateControlIds, googleCloudRetailV2ServingConfig.doNotAssociateControlIds) &&
        Objects.equals(this.dynamicFacetSpec, googleCloudRetailV2ServingConfig.dynamicFacetSpec) &&
        Objects.equals(this.enableCategoryFilterLevel, googleCloudRetailV2ServingConfig.enableCategoryFilterLevel) &&
        Objects.equals(this.facetControlIds, googleCloudRetailV2ServingConfig.facetControlIds) &&
        Objects.equals(this.filterControlIds, googleCloudRetailV2ServingConfig.filterControlIds) &&
        Objects.equals(this.ignoreControlIds, googleCloudRetailV2ServingConfig.ignoreControlIds) &&
        Objects.equals(this.modelId, googleCloudRetailV2ServingConfig.modelId) &&
        Objects.equals(this.name, googleCloudRetailV2ServingConfig.name) &&
        Objects.equals(this.onewaySynonymsControlIds, googleCloudRetailV2ServingConfig.onewaySynonymsControlIds) &&
        Objects.equals(this.personalizationSpec, googleCloudRetailV2ServingConfig.personalizationSpec) &&
        Objects.equals(this.priceRerankingLevel, googleCloudRetailV2ServingConfig.priceRerankingLevel) &&
        Objects.equals(this.redirectControlIds, googleCloudRetailV2ServingConfig.redirectControlIds) &&
        Objects.equals(this.replacementControlIds, googleCloudRetailV2ServingConfig.replacementControlIds) &&
        Objects.equals(this.solutionTypes, googleCloudRetailV2ServingConfig.solutionTypes) &&
        Objects.equals(this.twowaySynonymsControlIds, googleCloudRetailV2ServingConfig.twowaySynonymsControlIds);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudRetailV2ServingConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudRetailV2ServingConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudRetailV2ServingConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudRetailV2ServingConfig is not found in the empty JSON string", GoogleCloudRetailV2ServingConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudRetailV2ServingConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudRetailV2ServingConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudRetailV2ServingConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudRetailV2ServingConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudRetailV2ServingConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudRetailV2ServingConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudRetailV2ServingConfig>() {
           @Override
           public void write(JsonWriter out, GoogleCloudRetailV2ServingConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudRetailV2ServingConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudRetailV2ServingConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudRetailV2ServingConfig
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudRetailV2ServingConfig
   */
  public static GoogleCloudRetailV2ServingConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudRetailV2ServingConfig.class);
  }

  /**
   * Convert an instance of GoogleCloudRetailV2ServingConfig to an JSON string
   *
   * @return JSON string
   */
