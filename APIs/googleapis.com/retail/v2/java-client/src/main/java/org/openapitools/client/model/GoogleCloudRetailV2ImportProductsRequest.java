...
public class GoogleCloudRetailV2ImportProductsRequest {
  ...
  public GoogleCloudRetailV2ImportProductsRequest() {
  }

  public GoogleCloudRetailV2ImportProductsRequest errorsConfig(GoogleCloudRetailV2ImportErrorsConfig errorsConfig) {
  ...
  public GoogleCloudRetailV2ImportProductsRequest inputConfig(GoogleCloudRetailV2ProductInputConfig inputConfig) {
  ...
  public void setInputConfig(GoogleCloudRetailV2ProductInputConfig inputConfig) {
    this.inputConfig = inputConfig;
  }


  public GoogleCloudRetailV2ImportProductsRequest notificationPubsubTopic(String notificationPubsubTopic) {
  ...
  public GoogleCloudRetailV2ImportProductsRequest reconciliationMode(ReconciliationModeEnum reconciliationMode) {
  ...
  @Deprecated
  public GoogleCloudRetailV2ImportProductsRequest requestId(String requestId) {
  ...
  public GoogleCloudRetailV2ImportProductsRequest updateMask(String updateMask) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudRetailV2ImportProductsRequest googleCloudRetailV2ImportProductsRequest = (GoogleCloudRetailV2ImportProductsRequest) o;
    return Objects.equals(this.errorsConfig, googleCloudRetailV2ImportProductsRequest.errorsConfig) &&
        Objects.equals(this.inputConfig, googleCloudRetailV2ImportProductsRequest.inputConfig) &&
        Objects.equals(this.notificationPubsubTopic, googleCloudRetailV2ImportProductsRequest.notificationPubsubTopic) &&
        Objects.equals(this.reconciliationMode, googleCloudRetailV2ImportProductsRequest.reconciliationMode) &&
        Objects.equals(this.requestId, googleCloudRetailV2ImportProductsRequest.requestId) &&
        Objects.equals(this.updateMask, googleCloudRetailV2ImportProductsRequest.updateMask);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudRetailV2ImportProductsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudRetailV2ImportProductsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudRetailV2ImportProductsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudRetailV2ImportProductsRequest is not found in the empty JSON string", GoogleCloudRetailV2ImportProductsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudRetailV2ImportProductsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudRetailV2ImportProductsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("inputConfig") != null && !jsonObj.get("inputConfig").isJsonNull()) {
        GoogleCloudRetailV2ProductInputConfig.validateJsonElement(jsonObj.get("inputConfig"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudRetailV2ImportProductsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudRetailV2ImportProductsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudRetailV2ImportProductsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudRetailV2ImportProductsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudRetailV2ImportProductsRequest>() {
           @Override
           public void write(JsonWriter out, GoogleCloudRetailV2ImportProductsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudRetailV2ImportProductsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudRetailV2ImportProductsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudRetailV2ImportProductsRequest
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudRetailV2ImportProductsRequest
   */
  public static GoogleCloudRetailV2ImportProductsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudRetailV2ImportProductsRequest.class);
  }

  /**
   * Convert an instance of GoogleCloudRetailV2ImportProductsRequest to an JSON string
   *
   * @return JSON string
   */
