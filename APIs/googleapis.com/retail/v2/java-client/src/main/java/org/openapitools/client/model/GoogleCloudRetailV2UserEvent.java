...
public class GoogleCloudRetailV2UserEvent {
  ...
  private List<GoogleCloudRetailV2ProductDetail> productDetails = new ArrayList<>();
  ...
  public GoogleCloudRetailV2UserEvent() {
  }

  public GoogleCloudRetailV2UserEvent attributes(Map<String, GoogleCloudRetailV2CustomAttribute> attributes) {
    this.attributes = attributes;
    return this;
  }

  public GoogleCloudRetailV2UserEvent putAttributesItem(String key, GoogleCloudRetailV2CustomAttribute attributesItem) {
  ...
  public GoogleCloudRetailV2UserEvent attributionToken(String attributionToken) {
  ...
  public GoogleCloudRetailV2UserEvent cartId(String cartId) {
    this.cartId = cartId;
    return this;
  }
  ...
  public GoogleCloudRetailV2UserEvent completionDetail(GoogleCloudRetailV2CompletionDetail completionDetail) {
  ...
  public void setCompletionDetail(GoogleCloudRetailV2CompletionDetail completionDetail) {
    this.completionDetail = completionDetail;
  }


  public GoogleCloudRetailV2UserEvent entity(String entity) {
    this.entity = entity;
    return this;
  }
  ...
  public GoogleCloudRetailV2UserEvent eventTime(String eventTime) {
  ...
  public GoogleCloudRetailV2UserEvent eventType(String eventType) {
  ...
  public GoogleCloudRetailV2UserEvent experimentIds(List<String> experimentIds) {
    this.experimentIds = experimentIds;
    return this;
  }

  public GoogleCloudRetailV2UserEvent addExperimentIdsItem(String experimentIdsItem) {
  ...
  public GoogleCloudRetailV2UserEvent filter(String filter) {
    this.filter = filter;
    return this;
  }
  ...
  public GoogleCloudRetailV2UserEvent offset(Integer offset) {
    this.offset = offset;
    return this;
  }
  ...
  public GoogleCloudRetailV2UserEvent orderBy(String orderBy) {
  ...
  public GoogleCloudRetailV2UserEvent pageCategories(List<String> pageCategories) {
    this.pageCategories = pageCategories;
    return this;
  }

  public GoogleCloudRetailV2UserEvent addPageCategoriesItem(String pageCategoriesItem) {
  ...
  public GoogleCloudRetailV2UserEvent pageViewId(String pageViewId) {
  ...
  public GoogleCloudRetailV2UserEvent productDetails(List<GoogleCloudRetailV2ProductDetail> productDetails) {
    this.productDetails = productDetails;
    return this;
  }

  public GoogleCloudRetailV2UserEvent addProductDetailsItem(GoogleCloudRetailV2ProductDetail productDetailsItem) {
  ...
  public void setProductDetails(List<GoogleCloudRetailV2ProductDetail> productDetails) {
    this.productDetails = productDetails;
  }


  public GoogleCloudRetailV2UserEvent purchaseTransaction(GoogleCloudRetailV2PurchaseTransaction purchaseTransaction) {
  ...
  public void setPurchaseTransaction(GoogleCloudRetailV2PurchaseTransaction purchaseTransaction) {
    this.purchaseTransaction = purchaseTransaction;
  }


  public GoogleCloudRetailV2UserEvent referrerUri(String referrerUri) {
  ...
  public GoogleCloudRetailV2UserEvent searchQuery(String searchQuery) {
  ...
  public GoogleCloudRetailV2UserEvent sessionId(String sessionId) {
  ...
  public GoogleCloudRetailV2UserEvent uri(String uri) {
    this.uri = uri;
    return this;
  }
  ...
  public GoogleCloudRetailV2UserEvent userInfo(GoogleCloudRetailV2UserInfo userInfo) {
  ...
  public GoogleCloudRetailV2UserEvent visitorId(String visitorId) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudRetailV2UserEvent googleCloudRetailV2UserEvent = (GoogleCloudRetailV2UserEvent) o;
    return Objects.equals(this.attributes, googleCloudRetailV2UserEvent.attributes) &&
        Objects.equals(this.attributionToken, googleCloudRetailV2UserEvent.attributionToken) &&
        Objects.equals(this.cartId, googleCloudRetailV2UserEvent.cartId) &&
        Objects.equals(this.completionDetail, googleCloudRetailV2UserEvent.completionDetail) &&
        Objects.equals(this.entity, googleCloudRetailV2UserEvent.entity) &&
        Objects.equals(this.eventTime, googleCloudRetailV2UserEvent.eventTime) &&
        Objects.equals(this.eventType, googleCloudRetailV2UserEvent.eventType) &&
        Objects.equals(this.experimentIds, googleCloudRetailV2UserEvent.experimentIds) &&
        Objects.equals(this.filter, googleCloudRetailV2UserEvent.filter) &&
        Objects.equals(this.offset, googleCloudRetailV2UserEvent.offset) &&
        Objects.equals(this.orderBy, googleCloudRetailV2UserEvent.orderBy) &&
        Objects.equals(this.pageCategories, googleCloudRetailV2UserEvent.pageCategories) &&
        Objects.equals(this.pageViewId, googleCloudRetailV2UserEvent.pageViewId) &&
        Objects.equals(this.productDetails, googleCloudRetailV2UserEvent.productDetails) &&
        Objects.equals(this.purchaseTransaction, googleCloudRetailV2UserEvent.purchaseTransaction) &&
        Objects.equals(this.referrerUri, googleCloudRetailV2UserEvent.referrerUri) &&
        Objects.equals(this.searchQuery, googleCloudRetailV2UserEvent.searchQuery) &&
        Objects.equals(this.sessionId, googleCloudRetailV2UserEvent.sessionId) &&
        Objects.equals(this.uri, googleCloudRetailV2UserEvent.uri) &&
        Objects.equals(this.userInfo, googleCloudRetailV2UserEvent.userInfo) &&
        Objects.equals(this.visitorId, googleCloudRetailV2UserEvent.visitorId);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudRetailV2UserEvent {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudRetailV2UserEvent
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudRetailV2UserEvent.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudRetailV2UserEvent is not found in the empty JSON string", GoogleCloudRetailV2UserEvent.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudRetailV2UserEvent.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudRetailV2UserEvent` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("completionDetail") != null && !jsonObj.get("completionDetail").isJsonNull()) {
        GoogleCloudRetailV2CompletionDetail.validateJsonElement(jsonObj.get("completionDetail"));
      }
      ...
      if (jsonObj.get("productDetails") != null && !jsonObj.get("productDetails").isJsonNull()) {
        ...
        if (jsonArrayproductDetails != null) {
          ...
          for (int i = 0; i < jsonArrayproductDetails.size(); i++) {
            GoogleCloudRetailV2ProductDetail.validateJsonElement(jsonArrayproductDetails.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("purchaseTransaction") != null && !jsonObj.get("purchaseTransaction").isJsonNull()) {
        GoogleCloudRetailV2PurchaseTransaction.validateJsonElement(jsonObj.get("purchaseTransaction"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudRetailV2UserEvent.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudRetailV2UserEvent' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudRetailV2UserEvent> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudRetailV2UserEvent.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudRetailV2UserEvent>() {
           @Override
           public void write(JsonWriter out, GoogleCloudRetailV2UserEvent value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudRetailV2UserEvent read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudRetailV2UserEvent given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudRetailV2UserEvent
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudRetailV2UserEvent
   */
  public static GoogleCloudRetailV2UserEvent fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudRetailV2UserEvent.class);
  }

  /**
   * Convert an instance of GoogleCloudRetailV2UserEvent to an JSON string
   *
   * @return JSON string
   */
