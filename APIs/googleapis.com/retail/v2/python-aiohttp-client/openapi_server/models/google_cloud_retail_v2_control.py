...
class GoogleCloudRetailV2Control(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, associated_serving_config_ids: List[str]=None, display_name: str=None, name: str=None, rule: GoogleCloudRetailV2Rule=None, search_solution_use_case: List[str]=None, solution_types: List[str]=None):
        """GoogleCloudRetailV2Control - a model defined in OpenAPI

        :param associated_serving_config_ids: The associated_serving_config_ids of this GoogleCloudRetailV2Control.
        :param display_name: The display_name of this GoogleCloudRetailV2Control.
        :param name: The name of this GoogleCloudRetailV2Control.
        :param rule: The rule of this GoogleCloudRetailV2Control.
        :param search_solution_use_case: The search_solution_use_case of this GoogleCloudRetailV2Control.
        :param solution_types: The solution_types of this GoogleCloudRetailV2Control.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'GoogleCloudRetailV2Control':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The GoogleCloudRetailV2Control of this GoogleCloudRetailV2Control.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def associated_serving_config_ids(self):
        """Gets the associated_serving_config_ids of this GoogleCloudRetailV2Control.
        ...
        :return: The associated_serving_config_ids of this GoogleCloudRetailV2Control.
        :rtype: List[str]
        """
    ...
    def associated_serving_config_ids(self, associated_serving_config_ids):
        """Sets the associated_serving_config_ids of this GoogleCloudRetailV2Control.
    ...
    def display_name(self):
        """Gets the display_name of this GoogleCloudRetailV2Control.
        ...
        :return: The display_name of this GoogleCloudRetailV2Control.
        :rtype: str
        """
    ...
    def display_name(self, display_name):
        """Sets the display_name of this GoogleCloudRetailV2Control.
    ...
    @property
    def name(self):
        """Gets the name of this GoogleCloudRetailV2Control.

        Immutable. Fully qualified name `projects/*/locations/global/catalogs/*/controls/*`

        :return: The name of this GoogleCloudRetailV2Control.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this GoogleCloudRetailV2Control.
    ...
    @property
    def rule(self):
        """Gets the rule of this GoogleCloudRetailV2Control.


        :return: The rule of this GoogleCloudRetailV2Control.
        :rtype: GoogleCloudRetailV2Rule
        """
        return self._rule

    @rule.setter
    def rule(self, rule):
        """Sets the rule of this GoogleCloudRetailV2Control.


        :param rule: The rule of this GoogleCloudRetailV2Control.
        :type rule: GoogleCloudRetailV2Rule
        """
    ...
    def search_solution_use_case(self):
        """Gets the search_solution_use_case of this GoogleCloudRetailV2Control.

        Specifies the use case for the control. Affects what condition fields can be set. Only settable by search controls. Will default to SEARCH_SOLUTION_USE_CASE_SEARCH if not specified. Currently only allow one search_solution_use_case per control.

        :return: The search_solution_use_case of this GoogleCloudRetailV2Control.
        :rtype: List[str]
        """
    ...
    def search_solution_use_case(self, search_solution_use_case):
        """Sets the search_solution_use_case of this GoogleCloudRetailV2Control.
    ...
    def solution_types(self):
        """Gets the solution_types of this GoogleCloudRetailV2Control.
        ...
        :return: The solution_types of this GoogleCloudRetailV2Control.
        :rtype: List[str]
        """
    ...
    def solution_types(self, solution_types):
        """Sets the solution_types of this GoogleCloudRetailV2Control.
