...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VertexAiSearchForRetailApi.GoogleCloudRetailV2Product();
  });
  ...
  describe('GoogleCloudRetailV2Product', function() {
    it('should create an instance of GoogleCloudRetailV2Product', function() {
      // uncomment below and update the code to test GoogleCloudRetailV2Product
      //var instance = new VertexAiSearchForRetailApi.GoogleCloudRetailV2Product();
      //expect(instance).to.be.a(VertexAiSearchForRetailApi.GoogleCloudRetailV2Product);
    });
