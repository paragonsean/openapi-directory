...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VertexAiSearchForRetailApi.GoogleCloudRetailV2Rule();
  });
  ...
  describe('GoogleCloudRetailV2Rule', function() {
    it('should create an instance of GoogleCloudRetailV2Rule', function() {
      // uncomment below and update the code to test GoogleCloudRetailV2Rule
      //var instance = new VertexAiSearchForRetailApi.GoogleCloudRetailV2Rule();
      //expect(instance).to.be.a(VertexAiSearchForRetailApi.GoogleCloudRetailV2Rule);
    });
