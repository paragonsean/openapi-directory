...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VertexAiSearchForRetailApi.GoogleCloudRetailV2SearchRequestFacetSpecFacetKey();
  });
  ...
  describe('GoogleCloudRetailV2SearchRequestFacetSpecFacetKey', function() {
    it('should create an instance of GoogleCloudRetailV2SearchRequestFacetSpecFacetKey', function() {
      // uncomment below and update the code to test GoogleCloudRetailV2SearchRequestFacetSpecFacetKey
      //var instance = new VertexAiSearchForRetailApi.GoogleCloudRetailV2SearchRequestFacetSpecFacetKey();
      //expect(instance).to.be.a(VertexAiSearchForRetailApi.GoogleCloudRetailV2SearchRequestFacetSpecFacetKey);
    });
