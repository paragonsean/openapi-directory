...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VertexAiSearchForRetailApi.GoogleCloudRetailV2ServingConfig();
  });
  ...
  describe('GoogleCloudRetailV2ServingConfig', function() {
    it('should create an instance of GoogleCloudRetailV2ServingConfig', function() {
      // uncomment below and update the code to test GoogleCloudRetailV2ServingConfig
      //var instance = new VertexAiSearchForRetailApi.GoogleCloudRetailV2ServingConfig();
      //expect(instance).to.be.a(VertexAiSearchForRetailApi.GoogleCloudRetailV2ServingConfig);
    });
