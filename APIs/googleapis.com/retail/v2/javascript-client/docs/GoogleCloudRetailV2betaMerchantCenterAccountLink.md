# VertexAiSearchForRetailApi.GoogleCloudRetailV2betaMerchantCenterAccountLink
...
**state** | **String** | Output only. Represents the state of the link. | [optional] [readonly] 
