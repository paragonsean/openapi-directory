# VertexAiSearchForRetailApi.GoogleCloudRetailV2PredictResponse
...
**results** | [**[GoogleCloudRetailV2PredictResponsePredictionResult]**](GoogleCloudRetailV2PredictResponsePredictionResult.md) | A list of recommended products. The order represents the ranking (from the most relevant product to the least). | [optional] 
