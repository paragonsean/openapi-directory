...
/**
 * The GoogleCloudRetailV2ServingConfig model module.
 * @module model/GoogleCloudRetailV2ServingConfig
 * @version v2
 */
class GoogleCloudRetailV2ServingConfig {
    /**
     * Constructs a new <code>GoogleCloudRetailV2ServingConfig</code>.
     * Configures metadata that is used to generate serving time results (e.g. search results or recommendation predictions).
     * @alias module:model/GoogleCloudRetailV2ServingConfig
     */
    constructor() { 
        
        GoogleCloudRetailV2ServingConfig.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudRetailV2ServingConfig</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudRetailV2ServingConfig} obj Optional instance to populate.
     * @return {module:model/GoogleCloudRetailV2ServingConfig} The populated <code>GoogleCloudRetailV2ServingConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudRetailV2ServingConfig();
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudRetailV2ServingConfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudRetailV2ServingConfig</code>.
     */
 ...
 */
GoogleCloudRetailV2ServingConfig.prototype['boostControlIds'] = undefined;
 ...
 */
GoogleCloudRetailV2ServingConfig.prototype['displayName'] = undefined;

/**
 * How much diversity to use in recommendation model results e.g. `medium-diversity` or `high-diversity`. Currently supported values: * `no-diversity` * `low-diversity` * `medium-diversity` * `high-diversity` * `auto-diversity` If not specified, we choose default based on recommendation model type. Default value: `no-diversity`. Can only be set if solution_types is SOLUTION_TYPE_RECOMMENDATION.
 * @member {String} diversityLevel
 */
GoogleCloudRetailV2ServingConfig.prototype['diversityLevel'] = undefined;

/**
 * What kind of diversity to use - data driven or rule based. If unset, the server behavior defaults to RULE_BASED_DIVERSITY.
 * @member {module:model/GoogleCloudRetailV2ServingConfig.DiversityTypeEnum} diversityType
 */
GoogleCloudRetailV2ServingConfig.prototype['diversityType'] = undefined;

/**
 * Condition do not associate specifications. If multiple do not associate conditions match, all matching do not associate controls in the list will execute. - Order does not matter. - Maximum number of specifications is 100. Can only be set if solution_types is SOLUTION_TYPE_SEARCH.
 * @member {Array.<String>} doNotAssociateControlIds
 */
GoogleCloudRetailV2ServingConfig.prototype['doNotAssociateControlIds'] = undefined;

/**
 * @member {module:model/GoogleCloudRetailV2SearchRequestDynamicFacetSpec} dynamicFacetSpec
 */
GoogleCloudRetailV2ServingConfig.prototype['dynamicFacetSpec'] = undefined;
 ...
 */
GoogleCloudRetailV2ServingConfig.prototype['priceRerankingLevel'] = undefined;

/**
 * Condition redirect specifications. Only the first triggered redirect action is applied, even if multiple apply. Maximum number of specifications is 1000. Can only be set if solution_types is SOLUTION_TYPE_SEARCH.
 * @member {Array.<String>} redirectControlIds
 */
GoogleCloudRetailV2ServingConfig.prototype['redirectControlIds'] = undefined;

/**
 * Condition replacement specifications. - Applied according to the order in the list. - A previously replaced term can not be re-replaced. - Maximum number of specifications is 100. Can only be set if solution_types is SOLUTION_TYPE_SEARCH.
 * @member {Array.<String>} replacementControlIds
 */
GoogleCloudRetailV2ServingConfig.prototype['replacementControlIds'] = undefined;
 ...
 * @member {Array.<module:model/GoogleCloudRetailV2ServingConfig.SolutionTypesEnum>} solutionTypes
 */
GoogleCloudRetailV2ServingConfig.prototype['solutionTypes'] = undefined;

/**
 * Condition synonyms specifications. If multiple syonyms conditions match, all matching synonyms control in the list will execute. Order of controls in the list will not matter. Maximum number of specifications is 100. Can only be set if solution_types is SOLUTION_TYPE_SEARCH.
 * @member {Array.<String>} twowaySynonymsControlIds
 */
GoogleCloudRetailV2ServingConfig.prototype['twowaySynonymsControlIds'] = undefined;
 ...
 * @readonly
 */
GoogleCloudRetailV2ServingConfig['DiversityTypeEnum'] = {
 ...
 * @readonly
 */
GoogleCloudRetailV2ServingConfig['SolutionTypesEnum'] = {
...
export default GoogleCloudRetailV2ServingConfig;
