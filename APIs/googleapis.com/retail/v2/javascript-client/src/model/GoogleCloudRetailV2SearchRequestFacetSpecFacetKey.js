...
/**
 * The GoogleCloudRetailV2SearchRequestFacetSpecFacetKey model module.
 * @module model/GoogleCloudRetailV2SearchRequestFacetSpecFacetKey
 * @version v2
 */
class GoogleCloudRetailV2SearchRequestFacetSpecFacetKey {
    /**
     * Constructs a new <code>GoogleCloudRetailV2SearchRequestFacetSpecFacetKey</code>.
     * Specifies how a facet is computed.
     * @alias module:model/GoogleCloudRetailV2SearchRequestFacetSpecFacetKey
     */
    constructor() { 
        
        GoogleCloudRetailV2SearchRequestFacetSpecFacetKey.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudRetailV2SearchRequestFacetSpecFacetKey</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudRetailV2SearchRequestFacetSpecFacetKey} obj Optional instance to populate.
     * @return {module:model/GoogleCloudRetailV2SearchRequestFacetSpecFacetKey} The populated <code>GoogleCloudRetailV2SearchRequestFacetSpecFacetKey</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudRetailV2SearchRequestFacetSpecFacetKey();
            ...
            if (data.hasOwnProperty('intervals')) {
                obj['intervals'] = ApiClient.convertToType(data['intervals'], [GoogleCloudRetailV2Interval]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudRetailV2SearchRequestFacetSpecFacetKey</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudRetailV2SearchRequestFacetSpecFacetKey</code>.
     */
 ...
 */
GoogleCloudRetailV2SearchRequestFacetSpecFacetKey.prototype['caseInsensitive'] = undefined;
 ...
 */
GoogleCloudRetailV2SearchRequestFacetSpecFacetKey.prototype['contains'] = undefined;
 ...
 * @member {Array.<module:model/GoogleCloudRetailV2Interval>} intervals
 */
GoogleCloudRetailV2SearchRequestFacetSpecFacetKey.prototype['intervals'] = undefined;
 ...
 * @member {String} key
 */
GoogleCloudRetailV2SearchRequestFacetSpecFacetKey.prototype['key'] = undefined;

/**
 * The order in which SearchResponse.Facet.values are returned. Allowed values are: * \"count desc\", which means order by SearchResponse.Facet.values.count descending. * \"value desc\", which means order by SearchResponse.Facet.values.value descending. Only applies to textual facets. If not set, textual values are sorted in [natural order](https://en.wikipedia.org/wiki/Natural_sort_order); numerical intervals are sorted in the order given by FacetSpec.FacetKey.intervals; FulfillmentInfo.place_ids are sorted in the order given by FacetSpec.FacetKey.restricted_values.
 * @member {String} orderBy
 */
GoogleCloudRetailV2SearchRequestFacetSpecFacetKey.prototype['orderBy'] = undefined;
 ...
 */
GoogleCloudRetailV2SearchRequestFacetSpecFacetKey.prototype['prefixes'] = undefined;
 ...
 * @member {String} query
 */
GoogleCloudRetailV2SearchRequestFacetSpecFacetKey.prototype['query'] = undefined;
 ...
 */
GoogleCloudRetailV2SearchRequestFacetSpecFacetKey.prototype['restrictedValues'] = undefined;

/**
 * Returns the min and max value for each numerical facet intervals. Ignored for textual facets.
 * @member {Boolean} returnMinMax
 */
GoogleCloudRetailV2SearchRequestFacetSpecFacetKey.prototype['returnMinMax'] = undefined;
...
export default GoogleCloudRetailV2SearchRequestFacetSpecFacetKey;
