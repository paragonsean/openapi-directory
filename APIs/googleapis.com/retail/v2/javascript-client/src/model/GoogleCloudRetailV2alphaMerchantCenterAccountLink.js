...
/**
 * The GoogleCloudRetailV2alphaMerchantCenterAccountLink model module.
 * @module model/GoogleCloudRetailV2alphaMerchantCenterAccountLink
 * @version v2
 */
class GoogleCloudRetailV2alphaMerchantCenterAccountLink {
    /**
     * Constructs a new <code>GoogleCloudRetailV2alphaMerchantCenterAccountLink</code>.
     ...
     * @alias module:model/GoogleCloudRetailV2alphaMerchantCenterAccountLink
     */
    constructor() { 
        
        GoogleCloudRetailV2alphaMerchantCenterAccountLink.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudRetailV2alphaMerchantCenterAccountLink</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudRetailV2alphaMerchantCenterAccountLink} obj Optional instance to populate.
     * @return {module:model/GoogleCloudRetailV2alphaMerchantCenterAccountLink} The populated <code>GoogleCloudRetailV2alphaMerchantCenterAccountLink</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudRetailV2alphaMerchantCenterAccountLink();
            ...
            if (data.hasOwnProperty('feedFilters')) {
                obj['feedFilters'] = ApiClient.convertToType(data['feedFilters'], [GoogleCloudRetailV2alphaMerchantCenterAccountLinkMerchantCenterFeedFilter]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudRetailV2alphaMerchantCenterAccountLink</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudRetailV2alphaMerchantCenterAccountLink</code>.
     */
    static validateJSON(data) {
        ...
        if (data['feedFilters']) { // data not null
            ...
            for (const item of data['feedFilters']) {
                GoogleCloudRetailV2alphaMerchantCenterAccountLinkMerchantCenterFeedFilter.validateJSON(item);
            };
        }
        // ensure the json data is a string
 ...
 */
GoogleCloudRetailV2alphaMerchantCenterAccountLink.prototype['branchId'] = undefined;

/**
 * Criteria for the Merchant Center feeds to be ingested via the link. All offers will be ingested if the list is empty. Otherwise the offers will be ingested from selected feeds.
 * @member {Array.<module:model/GoogleCloudRetailV2alphaMerchantCenterAccountLinkMerchantCenterFeedFilter>} feedFilters
 */
GoogleCloudRetailV2alphaMerchantCenterAccountLink.prototype['feedFilters'] = undefined;
 ...
 */
GoogleCloudRetailV2alphaMerchantCenterAccountLink.prototype['feedLabel'] = undefined;
 ...
 * @member {String} id
 */
GoogleCloudRetailV2alphaMerchantCenterAccountLink.prototype['id'] = undefined;
 ...
 */
GoogleCloudRetailV2alphaMerchantCenterAccountLink.prototype['languageCode'] = undefined;
 ...
 */
GoogleCloudRetailV2alphaMerchantCenterAccountLink.prototype['merchantCenterAccountId'] = undefined;
 ...
 * @member {String} name
 */
GoogleCloudRetailV2alphaMerchantCenterAccountLink.prototype['name'] = undefined;

/**
 * Output only. Google Cloud project ID.
 * @member {String} projectId
 */
GoogleCloudRetailV2alphaMerchantCenterAccountLink.prototype['projectId'] = undefined;

/**
 * Optional. An optional arbitrary string that could be used as a tag for tracking link source.
 * @member {String} source
 */
GoogleCloudRetailV2alphaMerchantCenterAccountLink.prototype['source'] = undefined;

/**
 * Output only. Represents the state of the link.
 * @member {module:model/GoogleCloudRetailV2alphaMerchantCenterAccountLink.StateEnum} state
 */
GoogleCloudRetailV2alphaMerchantCenterAccountLink.prototype['state'] = undefined;
 ...
 * @readonly
 */
GoogleCloudRetailV2alphaMerchantCenterAccountLink['StateEnum'] = {
...
export default GoogleCloudRetailV2alphaMerchantCenterAccountLink;
