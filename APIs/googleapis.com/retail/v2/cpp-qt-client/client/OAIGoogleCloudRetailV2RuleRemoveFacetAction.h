...
/*
 * OAIGoogleCloudRetailV2RuleRemoveFacetAction.h
 *
...
#ifndef OAIGoogleCloudRetailV2RuleRemoveFacetAction_H
#define OAIGoogleCloudRetailV2RuleRemoveFacetAction_H
...
class OAIGoogleCloudRetailV2RuleRemoveFacetAction : public OAIObject {
public:
    OAIGoogleCloudRetailV2RuleRemoveFacetAction();
    OAIGoogleCloudRetailV2RuleRemoveFacetAction(QString json);
    ~OAIGoogleCloudRetailV2RuleRemoveFacetAction() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudRetailV2RuleRemoveFacetAction)

#endif // OAIGoogleCloudRetailV2RuleRemoveFacetAction_H
