...
OAIGoogleCloudRetailV2CompletionDetail::OAIGoogleCloudRetailV2CompletionDetail(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGoogleCloudRetailV2CompletionDetail::OAIGoogleCloudRetailV2CompletionDetail() {
    this->initializeModel();
}

OAIGoogleCloudRetailV2CompletionDetail::~OAIGoogleCloudRetailV2CompletionDetail() {}

void OAIGoogleCloudRetailV2CompletionDetail::initializeModel() {
...
void OAIGoogleCloudRetailV2CompletionDetail::fromJson(QString jsonString) {
...
void OAIGoogleCloudRetailV2CompletionDetail::fromJsonObject(QJsonObject json) {
...
QString OAIGoogleCloudRetailV2CompletionDetail::asJson() const {
...
QJsonObject OAIGoogleCloudRetailV2CompletionDetail::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGoogleCloudRetailV2CompletionDetail::getCompletionAttributionToken() const {
    return m_completion_attribution_token;
}
void OAIGoogleCloudRetailV2CompletionDetail::setCompletionAttributionToken(const QString &completion_attribution_token) {
    m_completion_attribution_token = completion_attribution_token;
    m_completion_attribution_token_isSet = true;
}

bool OAIGoogleCloudRetailV2CompletionDetail::is_completion_attribution_token_Set() const{
    return m_completion_attribution_token_isSet;
}

bool OAIGoogleCloudRetailV2CompletionDetail::is_completion_attribution_token_Valid() const{
    return m_completion_attribution_token_isValid;
}

qint32 OAIGoogleCloudRetailV2CompletionDetail::getSelectedPosition() const {
    return m_selected_position;
}
void OAIGoogleCloudRetailV2CompletionDetail::setSelectedPosition(const qint32 &selected_position) {
    m_selected_position = selected_position;
    m_selected_position_isSet = true;
}

bool OAIGoogleCloudRetailV2CompletionDetail::is_selected_position_Set() const{
    return m_selected_position_isSet;
}

bool OAIGoogleCloudRetailV2CompletionDetail::is_selected_position_Valid() const{
    return m_selected_position_isValid;
}

QString OAIGoogleCloudRetailV2CompletionDetail::getSelectedSuggestion() const {
    return m_selected_suggestion;
}
void OAIGoogleCloudRetailV2CompletionDetail::setSelectedSuggestion(const QString &selected_suggestion) {
    m_selected_suggestion = selected_suggestion;
    m_selected_suggestion_isSet = true;
}

bool OAIGoogleCloudRetailV2CompletionDetail::is_selected_suggestion_Set() const{
    return m_selected_suggestion_isSet;
}

bool OAIGoogleCloudRetailV2CompletionDetail::is_selected_suggestion_Valid() const{
    return m_selected_suggestion_isValid;
}

bool OAIGoogleCloudRetailV2CompletionDetail::isSet() const {
...
bool OAIGoogleCloudRetailV2CompletionDetail::isValid() const {
