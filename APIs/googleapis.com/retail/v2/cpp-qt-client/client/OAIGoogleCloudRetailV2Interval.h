...
/*
 * OAIGoogleCloudRetailV2Interval.h
 *
 * A floating point interval.
 */

#ifndef OAIGoogleCloudRetailV2Interval_H
#define OAIGoogleCloudRetailV2Interval_H
...
class OAIGoogleCloudRetailV2Interval : public OAIObject {
public:
    OAIGoogleCloudRetailV2Interval();
    OAIGoogleCloudRetailV2Interval(QString json);
    ~OAIGoogleCloudRetailV2Interval() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudRetailV2Interval)

#endif // OAIGoogleCloudRetailV2Interval_H
