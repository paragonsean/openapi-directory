...
/*
 * OAIGoogleCloudRetailV2SearchRequestFacetSpecFacetKey.h
 *
 * Specifies how a facet is computed.
 */

#ifndef OAIGoogleCloudRetailV2SearchRequestFacetSpecFacetKey_H
#define OAIGoogleCloudRetailV2SearchRequestFacetSpecFacetKey_H
...
class OAIGoogleCloudRetailV2SearchRequestFacetSpecFacetKey : public OAIObject {
public:
    OAIGoogleCloudRetailV2SearchRequestFacetSpecFacetKey();
    OAIGoogleCloudRetailV2SearchRequestFacetSpecFacetKey(QString json);
    ~OAIGoogleCloudRetailV2SearchRequestFacetSpecFacetKey() override;
    ...
    QList<OAIGoogleCloudRetailV2Interval> getIntervals() const;
    void setIntervals(const QList<OAIGoogleCloudRetailV2Interval> &intervals);
...
private:
    ...
    QList<OAIGoogleCloudRetailV2Interval> m_intervals;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudRetailV2SearchRequestFacetSpecFacetKey)

#endif // OAIGoogleCloudRetailV2SearchRequestFacetSpecFacetKey_H
