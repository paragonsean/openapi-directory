...
/*
 * OAIGoogleCloudRetailV2betaInterval.h
 *
 * A floating point interval.
 */

#ifndef OAIGoogleCloudRetailV2betaInterval_H
#define OAIGoogleCloudRetailV2betaInterval_H
...
class OAIGoogleCloudRetailV2betaInterval : public OAIObject {
public:
    OAIGoogleCloudRetailV2betaInterval();
    OAIGoogleCloudRetailV2betaInterval(QString json);
    ~OAIGoogleCloudRetailV2betaInterval() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudRetailV2betaInterval)

#endif // OAIGoogleCloudRetailV2betaInterval_H
