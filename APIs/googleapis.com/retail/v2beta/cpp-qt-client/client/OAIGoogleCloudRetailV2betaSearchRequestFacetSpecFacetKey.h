...
/*
 * OAIGoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey.h
 *
 * Specifies how a facet is computed.
 */

#ifndef OAIGoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey_H
#define OAIGoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey_H
...
class OAIGoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey : public OAIObject {
public:
    OAIGoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey();
    OAIGoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey(QString json);
    ~OAIGoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey() override;
    ...
    QList<OAIGoogleCloudRetailV2betaInterval> getIntervals() const;
    void setIntervals(const QList<OAIGoogleCloudRetailV2betaInterval> &intervals);
...
private:
    ...
    QList<OAIGoogleCloudRetailV2betaInterval> m_intervals;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey)

#endif // OAIGoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey_H
