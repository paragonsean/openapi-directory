# VertexAiSearchForRetailApi.GoogleCloudRetailV2betaMerchantCenterLink
...
**feeds** | [**[GoogleCloudRetailV2betaMerchantCenterFeedFilter]**](GoogleCloudRetailV2betaMerchantCenterFeedFilter.md) | Criteria for the Merchant Center feeds to be ingested via the link. All offers will be ingested if the list is empty. Otherwise the offers will be ingested from selected feeds. | [optional] 
