# VertexAiSearchForRetailApi.GoogleCloudRetailV2betaPredictResponse
...
**results** | [**[GoogleCloudRetailV2betaPredictResponsePredictionResult]**](GoogleCloudRetailV2betaPredictResponsePredictionResult.md) | A list of recommended products. The order represents the ranking (from the most relevant product to the least). | [optional] 
