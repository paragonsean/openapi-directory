...
(function(root, factory) {
  ...
  describe('ProjectsApi', function() {
    ...
    describe('retailProjectsLocationsCatalogsAttributesConfigBatchRemoveCatalogAttributes', function() {
      it('should call retailProjectsLocationsCatalogsAttributesConfigBatchRemoveCatalogAttributes successfully', function(done) {
        //uncomment below and update the code to test retailProjectsLocationsCatalogsAttributesConfigBatchRemoveCatalogAttributes
        //instance.retailProjectsLocationsCatalogsAttributesConfigBatchRemoveCatalogAttributes(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
