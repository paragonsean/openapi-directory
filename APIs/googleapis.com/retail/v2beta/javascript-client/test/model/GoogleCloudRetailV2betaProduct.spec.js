...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VertexAiSearchForRetailApi.GoogleCloudRetailV2betaProduct();
  });
  ...
  describe('GoogleCloudRetailV2betaProduct', function() {
    it('should create an instance of GoogleCloudRetailV2betaProduct', function() {
      // uncomment below and update the code to test GoogleCloudRetailV2betaProduct
      //var instance = new VertexAiSearchForRetailApi.GoogleCloudRetailV2betaProduct();
      //expect(instance).to.be.a(VertexAiSearchForRetailApi.GoogleCloudRetailV2betaProduct);
    });
