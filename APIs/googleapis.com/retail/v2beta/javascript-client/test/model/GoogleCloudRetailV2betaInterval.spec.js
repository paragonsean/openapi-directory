...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VertexAiSearchForRetailApi.GoogleCloudRetailV2betaInterval();
  });
  ...
  describe('GoogleCloudRetailV2betaInterval', function() {
    it('should create an instance of GoogleCloudRetailV2betaInterval', function() {
      // uncomment below and update the code to test GoogleCloudRetailV2betaInterval
      //var instance = new VertexAiSearchForRetailApi.GoogleCloudRetailV2betaInterval();
      //expect(instance).to.be.a(VertexAiSearchForRetailApi.GoogleCloudRetailV2betaInterval);
    });
