...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VertexAiSearchForRetailApi.GoogleApiHttpBody();
  });
  ...
  describe('GoogleApiHttpBody', function() {
    it('should create an instance of GoogleApiHttpBody', function() {
      ...
      //var instance = new VertexAiSearchForRetailApi.GoogleApiHttpBody();
      //expect(instance).to.be.a(VertexAiSearchForRetailApi.GoogleApiHttpBody);
    });
