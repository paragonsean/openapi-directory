...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VertexAiSearchForRetailApi.GoogleCloudRetailV2PurgeProductsMetadata();
  });
  ...
  describe('GoogleCloudRetailV2PurgeProductsMetadata', function() {
    it('should create an instance of GoogleCloudRetailV2PurgeProductsMetadata', function() {
      // uncomment below and update the code to test GoogleCloudRetailV2PurgeProductsMetadata
      //var instance = new VertexAiSearchForRetailApi.GoogleCloudRetailV2PurgeProductsMetadata();
      //expect(instance).to.be.a(VertexAiSearchForRetailApi.GoogleCloudRetailV2PurgeProductsMetadata);
    });
