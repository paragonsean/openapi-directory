...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VertexAiSearchForRetailApi.GoogleCloudRetailV2betaBigQuerySource();
  });
  ...
  describe('GoogleCloudRetailV2betaBigQuerySource', function() {
    it('should create an instance of GoogleCloudRetailV2betaBigQuerySource', function() {
      // uncomment below and update the code to test GoogleCloudRetailV2betaBigQuerySource
      //var instance = new VertexAiSearchForRetailApi.GoogleCloudRetailV2betaBigQuerySource();
      //expect(instance).to.be.a(VertexAiSearchForRetailApi.GoogleCloudRetailV2betaBigQuerySource);
    });
