...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VertexAiSearchForRetailApi.GoogleCloudRetailV2betaUserEvent();
  });
  ...
  describe('GoogleCloudRetailV2betaUserEvent', function() {
    it('should create an instance of GoogleCloudRetailV2betaUserEvent', function() {
      // uncomment below and update the code to test GoogleCloudRetailV2betaUserEvent
      //var instance = new VertexAiSearchForRetailApi.GoogleCloudRetailV2betaUserEvent();
      //expect(instance).to.be.a(VertexAiSearchForRetailApi.GoogleCloudRetailV2betaUserEvent);
    });
