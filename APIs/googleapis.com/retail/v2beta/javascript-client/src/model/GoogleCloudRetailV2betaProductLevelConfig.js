...
/**
 * The GoogleCloudRetailV2betaProductLevelConfig model module.
 * @module model/GoogleCloudRetailV2betaProductLevelConfig
 * @version v2beta
 */
class GoogleCloudRetailV2betaProductLevelConfig {
    /**
     * Constructs a new <code>GoogleCloudRetailV2betaProductLevelConfig</code>.
     * Configures what level the product should be uploaded with regards to how users will be send events and how predictions will be made.
     * @alias module:model/GoogleCloudRetailV2betaProductLevelConfig
     */
    constructor() { 
        
        GoogleCloudRetailV2betaProductLevelConfig.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudRetailV2betaProductLevelConfig</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudRetailV2betaProductLevelConfig} obj Optional instance to populate.
     * @return {module:model/GoogleCloudRetailV2betaProductLevelConfig} The populated <code>GoogleCloudRetailV2betaProductLevelConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudRetailV2betaProductLevelConfig();
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudRetailV2betaProductLevelConfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudRetailV2betaProductLevelConfig</code>.
     */
 ...
 */
GoogleCloudRetailV2betaProductLevelConfig.prototype['ingestionProductType'] = undefined;
 ...
 */
GoogleCloudRetailV2betaProductLevelConfig.prototype['merchantCenterProductIdField'] = undefined;
...
export default GoogleCloudRetailV2betaProductLevelConfig;
