...
/**
 * The GoogleCloudRetailV2betaPredictRequest model module.
 * @module model/GoogleCloudRetailV2betaPredictRequest
 * @version v2beta
 */
class GoogleCloudRetailV2betaPredictRequest {
    /**
     * Constructs a new <code>GoogleCloudRetailV2betaPredictRequest</code>.
     * Request message for Predict method.
     * @alias module:model/GoogleCloudRetailV2betaPredictRequest
     */
    constructor() { 
        
        GoogleCloudRetailV2betaPredictRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudRetailV2betaPredictRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudRetailV2betaPredictRequest} obj Optional instance to populate.
     * @return {module:model/GoogleCloudRetailV2betaPredictRequest} The populated <code>GoogleCloudRetailV2betaPredictRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudRetailV2betaPredictRequest();
            ...
            if (data.hasOwnProperty('userEvent')) {
                obj['userEvent'] = GoogleCloudRetailV2betaUserEvent.constructFromObject(data['userEvent']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudRetailV2betaPredictRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudRetailV2betaPredictRequest</code>.
     */
    static validateJSON(data) {
        ...
        if (data['userEvent']) { // data not null
          GoogleCloudRetailV2betaUserEvent.validateJSON(data['userEvent']);
        }
 ...
 */
GoogleCloudRetailV2betaPredictRequest.prototype['filter'] = undefined;
 ...
 */
GoogleCloudRetailV2betaPredictRequest.prototype['labels'] = undefined;
 ...
 */
GoogleCloudRetailV2betaPredictRequest.prototype['pageSize'] = undefined;

/**
 * This field is not used; leave it unset.
 * @member {String} pageToken
 */
GoogleCloudRetailV2betaPredictRequest.prototype['pageToken'] = undefined;
 ...
 */
GoogleCloudRetailV2betaPredictRequest.prototype['params'] = undefined;

/**
 * @member {module:model/GoogleCloudRetailV2betaUserEvent} userEvent
 */
GoogleCloudRetailV2betaPredictRequest.prototype['userEvent'] = undefined;
 ...
 */
GoogleCloudRetailV2betaPredictRequest.prototype['validateOnly'] = undefined;
...
export default GoogleCloudRetailV2betaPredictRequest;
