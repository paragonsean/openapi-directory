...
/**
 * The GoogleCloudRetailV2betaBigQuerySource model module.
 * @module model/GoogleCloudRetailV2betaBigQuerySource
 * @version v2beta
 */
class GoogleCloudRetailV2betaBigQuerySource {
    /**
     * Constructs a new <code>GoogleCloudRetailV2betaBigQuerySource</code>.
     * BigQuery source import data from.
     * @alias module:model/GoogleCloudRetailV2betaBigQuerySource
     */
    constructor() { 
        
        GoogleCloudRetailV2betaBigQuerySource.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudRetailV2betaBigQuerySource</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudRetailV2betaBigQuerySource} obj Optional instance to populate.
     * @return {module:model/GoogleCloudRetailV2betaBigQuerySource} The populated <code>GoogleCloudRetailV2betaBigQuerySource</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudRetailV2betaBigQuerySource();
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudRetailV2betaBigQuerySource</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudRetailV2betaBigQuerySource</code>.
     */
 ...
 */
GoogleCloudRetailV2betaBigQuerySource.prototype['dataSchema'] = undefined;

/**
 * Required. The BigQuery data set to copy the data from with a length limit of 1,024 characters.
 * @member {String} datasetId
 */
GoogleCloudRetailV2betaBigQuerySource.prototype['datasetId'] = undefined;

/**
 * Intermediate Cloud Storage directory used for the import with a length limit of 2,000 characters. Can be specified if one wants to have the BigQuery export to a specific Cloud Storage directory.
 * @member {String} gcsStagingDir
 */
GoogleCloudRetailV2betaBigQuerySource.prototype['gcsStagingDir'] = undefined;

/**
 * @member {module:model/GoogleTypeDate} partitionDate
 */
GoogleCloudRetailV2betaBigQuerySource.prototype['partitionDate'] = undefined;

/**
 * The project ID (can be project # or ID) that the BigQuery source is in with a length limit of 128 characters. If not specified, inherits the project ID from the parent request.
 * @member {String} projectId
 */
GoogleCloudRetailV2betaBigQuerySource.prototype['projectId'] = undefined;

/**
 * Required. The BigQuery table to copy the data from with a length limit of 1,024 characters.
 * @member {String} tableId
 */
GoogleCloudRetailV2betaBigQuerySource.prototype['tableId'] = undefined;
...
export default GoogleCloudRetailV2betaBigQuerySource;
