...
/**
 * The GoogleCloudRetailV2betaControl model module.
 * @module model/GoogleCloudRetailV2betaControl
 * @version v2beta
 */
class GoogleCloudRetailV2betaControl {
    /**
     * Constructs a new <code>GoogleCloudRetailV2betaControl</code>.
     * Configures dynamic metadata that can be linked to a ServingConfig and affect search or recommendation results at serving time.
     * @alias module:model/GoogleCloudRetailV2betaControl
     */
    constructor() { 
        
        GoogleCloudRetailV2betaControl.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudRetailV2betaControl</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudRetailV2betaControl} obj Optional instance to populate.
     * @return {module:model/GoogleCloudRetailV2betaControl} The populated <code>GoogleCloudRetailV2betaControl</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudRetailV2betaControl();
            ...
            if (data.hasOwnProperty('facetSpec')) {
                obj['facetSpec'] = GoogleCloudRetailV2betaSearchRequestFacetSpec.constructFromObject(data['facetSpec']);
            }
            if (data.hasOwnProperty('name')) {
                obj['name'] = ApiClient.convertToType(data['name'], 'String');
            }
            if (data.hasOwnProperty('rule')) {
                obj['rule'] = GoogleCloudRetailV2betaRule.constructFromObject(data['rule']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudRetailV2betaControl</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudRetailV2betaControl</code>.
     */
    static validateJSON(data) {
        ...
        if (data['facetSpec']) { // data not null
          GoogleCloudRetailV2betaSearchRequestFacetSpec.validateJSON(data['facetSpec']);
        }
        // ensure the json data is a string
        ...
        if (data['rule']) { // data not null
          GoogleCloudRetailV2betaRule.validateJSON(data['rule']);
        }
        // ensure the json data is an array
 ...
 */
GoogleCloudRetailV2betaControl.prototype['associatedServingConfigIds'] = undefined;
 ...
 */
GoogleCloudRetailV2betaControl.prototype['displayName'] = undefined;

/**
 * @member {module:model/GoogleCloudRetailV2betaSearchRequestFacetSpec} facetSpec
 */
GoogleCloudRetailV2betaControl.prototype['facetSpec'] = undefined;

/**
 * Immutable. Fully qualified name `projects/_*_/locations/global/catalogs/_*_/controls/_*`
 * @member {String} name
 */
GoogleCloudRetailV2betaControl.prototype['name'] = undefined;

/**
 * @member {module:model/GoogleCloudRetailV2betaRule} rule
 */
GoogleCloudRetailV2betaControl.prototype['rule'] = undefined;

/**
 * Specifies the use case for the control. Affects what condition fields can be set. Only settable by search controls. Will default to SEARCH_SOLUTION_USE_CASE_SEARCH if not specified. Currently only allow one search_solution_use_case per control.
 * @member {Array.<module:model/GoogleCloudRetailV2betaControl.SearchSolutionUseCaseEnum>} searchSolutionUseCase
 */
GoogleCloudRetailV2betaControl.prototype['searchSolutionUseCase'] = undefined;
 ...
 * @member {Array.<module:model/GoogleCloudRetailV2betaControl.SolutionTypesEnum>} solutionTypes
 */
GoogleCloudRetailV2betaControl.prototype['solutionTypes'] = undefined;
 ...
 * @readonly
 */
GoogleCloudRetailV2betaControl['SearchSolutionUseCaseEnum'] = {
 ...
 * @readonly
 */
GoogleCloudRetailV2betaControl['SolutionTypesEnum'] = {
...
export default GoogleCloudRetailV2betaControl;
