...
/**
 * The GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey model module.
 * @module model/GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey
 * @version v2beta
 */
class GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey {
    /**
     * Constructs a new <code>GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey</code>.
     * Specifies how a facet is computed.
     * @alias module:model/GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey
     */
    constructor() { 
        
        GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey} obj Optional instance to populate.
     * @return {module:model/GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey} The populated <code>GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey();
            ...
            if (data.hasOwnProperty('intervals')) {
                obj['intervals'] = ApiClient.convertToType(data['intervals'], [GoogleCloudRetailV2betaInterval]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey</code>.
     */
 ...
 */
GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey.prototype['caseInsensitive'] = undefined;
 ...
 */
GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey.prototype['contains'] = undefined;
 ...
 * @member {Array.<module:model/GoogleCloudRetailV2betaInterval>} intervals
 */
GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey.prototype['intervals'] = undefined;
 ...
 * @member {String} key
 */
GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey.prototype['key'] = undefined;

/**
 * The order in which SearchResponse.Facet.values are returned. Allowed values are: * \"count desc\", which means order by SearchResponse.Facet.values.count descending. * \"value desc\", which means order by SearchResponse.Facet.values.value descending. Only applies to textual facets. If not set, textual values are sorted in [natural order](https://en.wikipedia.org/wiki/Natural_sort_order); numerical intervals are sorted in the order given by FacetSpec.FacetKey.intervals; FulfillmentInfo.place_ids are sorted in the order given by FacetSpec.FacetKey.restricted_values.
 * @member {String} orderBy
 */
GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey.prototype['orderBy'] = undefined;
 ...
 */
GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey.prototype['prefixes'] = undefined;
 ...
 * @member {String} query
 */
GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey.prototype['query'] = undefined;
 ...
 */
GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey.prototype['restrictedValues'] = undefined;

/**
 * Returns the min and max value for each numerical facet intervals. Ignored for textual facets.
 * @member {Boolean} returnMinMax
 */
GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey.prototype['returnMinMax'] = undefined;
...
export default GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey;
