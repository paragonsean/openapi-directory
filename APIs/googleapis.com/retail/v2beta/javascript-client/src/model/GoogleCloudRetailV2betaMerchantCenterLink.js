...
/**
 * The GoogleCloudRetailV2betaMerchantCenterLink model module.
 * @module model/GoogleCloudRetailV2betaMerchantCenterLink
 * @version v2beta
 */
class GoogleCloudRetailV2betaMerchantCenterLink {
    /**
     * Constructs a new <code>GoogleCloudRetailV2betaMerchantCenterLink</code>.
     ...
     * @alias module:model/GoogleCloudRetailV2betaMerchantCenterLink
     */
    constructor() { 
        
        GoogleCloudRetailV2betaMerchantCenterLink.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudRetailV2betaMerchantCenterLink</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudRetailV2betaMerchantCenterLink} obj Optional instance to populate.
     * @return {module:model/GoogleCloudRetailV2betaMerchantCenterLink} The populated <code>GoogleCloudRetailV2betaMerchantCenterLink</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudRetailV2betaMerchantCenterLink();
            ...
            if (data.hasOwnProperty('feeds')) {
                obj['feeds'] = ApiClient.convertToType(data['feeds'], [GoogleCloudRetailV2betaMerchantCenterFeedFilter]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudRetailV2betaMerchantCenterLink</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudRetailV2betaMerchantCenterLink</code>.
     */
    static validateJSON(data) {
        ...
        if (data['feeds']) { // data not null
            ...
            for (const item of data['feeds']) {
                GoogleCloudRetailV2betaMerchantCenterFeedFilter.validateJSON(item);
            };
        }
        // ensure the json data is a string
 ...
 */
GoogleCloudRetailV2betaMerchantCenterLink.prototype['branchId'] = undefined;
 ...
 */
GoogleCloudRetailV2betaMerchantCenterLink.prototype['destinations'] = undefined;

/**
 * Criteria for the Merchant Center feeds to be ingested via the link. All offers will be ingested if the list is empty. Otherwise the offers will be ingested from selected feeds.
 * @member {Array.<module:model/GoogleCloudRetailV2betaMerchantCenterFeedFilter>} feeds
 */
GoogleCloudRetailV2betaMerchantCenterLink.prototype['feeds'] = undefined;
 ...
 */
GoogleCloudRetailV2betaMerchantCenterLink.prototype['languageCode'] = undefined;
 ...
 */
GoogleCloudRetailV2betaMerchantCenterLink.prototype['merchantCenterAccountId'] = undefined;
 ...
 */
GoogleCloudRetailV2betaMerchantCenterLink.prototype['regionCode'] = undefined;
...
export default GoogleCloudRetailV2betaMerchantCenterLink;
