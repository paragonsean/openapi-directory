...
|**localInventories** | [**List&lt;GoogleCloudRetailV2betaLocalInventory&gt;**](GoogleCloudRetailV2betaLocalInventory.md) | Required. A list of inventory information at difference places. Each place is identified by its place ID. At most 3000 inventories are allowed per request. |  [optional] |
