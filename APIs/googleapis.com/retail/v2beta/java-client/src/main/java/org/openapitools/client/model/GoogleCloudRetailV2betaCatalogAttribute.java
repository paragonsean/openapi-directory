...
public class GoogleCloudRetailV2betaCatalogAttribute {
  /**
  ...
  private GoogleCloudRetailV2betaCatalogAttributeFacetConfig facetConfig;
   ...
   */
  @JsonAdapter(RecommendationsFilteringOptionEnum.Adapter.class)
  public enum RecommendationsFilteringOptionEnum {
    ...
    RecommendationsFilteringOptionEnum(String value) {
      this.value = value;
    }
    ...
    public static RecommendationsFilteringOptionEnum fromValue(String value) {
      for (RecommendationsFilteringOptionEnum b : RecommendationsFilteringOptionEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
    ...
    public static class Adapter extends TypeAdapter<RecommendationsFilteringOptionEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final RecommendationsFilteringOptionEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public RecommendationsFilteringOptionEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return RecommendationsFilteringOptionEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      RecommendationsFilteringOptionEnum.fromValue(value);
    }
  }

  public static final String SERIALIZED_NAME_RECOMMENDATIONS_FILTERING_OPTION = "recommendationsFilteringOption";
  @SerializedName(SERIALIZED_NAME_RECOMMENDATIONS_FILTERING_OPTION)
  private RecommendationsFilteringOptionEnum recommendationsFilteringOption;
  ...
  public GoogleCloudRetailV2betaCatalogAttribute dynamicFacetableOption(DynamicFacetableOptionEnum dynamicFacetableOption) {
  ...
  public GoogleCloudRetailV2betaCatalogAttribute exactSearchableOption(ExactSearchableOptionEnum exactSearchableOption) {
  ...
  public GoogleCloudRetailV2betaCatalogAttribute facetConfig(GoogleCloudRetailV2betaCatalogAttributeFacetConfig facetConfig) {
   ...
   */
  @javax.annotation.Nullable
  public GoogleCloudRetailV2betaCatalogAttributeFacetConfig getFacetConfig() {
    return facetConfig;
  }

  public void setFacetConfig(GoogleCloudRetailV2betaCatalogAttributeFacetConfig facetConfig) {
    this.facetConfig = facetConfig;
  }
  ...
  public GoogleCloudRetailV2betaCatalogAttribute indexableOption(IndexableOptionEnum indexableOption) {
  ...
  public GoogleCloudRetailV2betaCatalogAttribute key(String key) {
    this.key = key;
    return this;
  }
  ...
  public GoogleCloudRetailV2betaCatalogAttribute recommendationsFilteringOption(RecommendationsFilteringOptionEnum recommendationsFilteringOption) {
   ...
   */
  @javax.annotation.Nullable
  public RecommendationsFilteringOptionEnum getRecommendationsFilteringOption() {
    return recommendationsFilteringOption;
  }

  public void setRecommendationsFilteringOption(RecommendationsFilteringOptionEnum recommendationsFilteringOption) {
    this.recommendationsFilteringOption = recommendationsFilteringOption;
  }


  public GoogleCloudRetailV2betaCatalogAttribute retrievableOption(RetrievableOptionEnum retrievableOption) {
  ...
  public GoogleCloudRetailV2betaCatalogAttribute searchableOption(SearchableOptionEnum searchableOption) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudRetailV2betaCatalogAttribute googleCloudRetailV2betaCatalogAttribute = (GoogleCloudRetailV2betaCatalogAttribute) o;
    return Objects.equals(this.dynamicFacetableOption, googleCloudRetailV2betaCatalogAttribute.dynamicFacetableOption) &&
        Objects.equals(this.exactSearchableOption, googleCloudRetailV2betaCatalogAttribute.exactSearchableOption) &&
        Objects.equals(this.facetConfig, googleCloudRetailV2betaCatalogAttribute.facetConfig) &&
        Objects.equals(this.inUse, googleCloudRetailV2betaCatalogAttribute.inUse) &&
        Objects.equals(this.indexableOption, googleCloudRetailV2betaCatalogAttribute.indexableOption) &&
        Objects.equals(this.key, googleCloudRetailV2betaCatalogAttribute.key) &&
        Objects.equals(this.recommendationsFilteringOption, googleCloudRetailV2betaCatalogAttribute.recommendationsFilteringOption) &&
        Objects.equals(this.retrievableOption, googleCloudRetailV2betaCatalogAttribute.retrievableOption) &&
        Objects.equals(this.searchableOption, googleCloudRetailV2betaCatalogAttribute.searchableOption) &&
        Objects.equals(this.type, googleCloudRetailV2betaCatalogAttribute.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(dynamicFacetableOption, exactSearchableOption, facetConfig, inUse, indexableOption, key, recommendationsFilteringOption, retrievableOption, searchableOption, type);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GoogleCloudRetailV2betaCatalogAttribute {\n");
    ...
    sb.append("    recommendationsFilteringOption: ").append(toIndentedString(recommendationsFilteringOption)).append("\n");
  ...
  static {
    ...
    openapiFields.add("recommendationsFilteringOption");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudRetailV2betaCatalogAttribute
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudRetailV2betaCatalogAttribute.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudRetailV2betaCatalogAttribute is not found in the empty JSON string", GoogleCloudRetailV2betaCatalogAttribute.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudRetailV2betaCatalogAttribute.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudRetailV2betaCatalogAttribute` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("facetConfig") != null && !jsonObj.get("facetConfig").isJsonNull()) {
        GoogleCloudRetailV2betaCatalogAttributeFacetConfig.validateJsonElement(jsonObj.get("facetConfig"));
      }
      ...
      if ((jsonObj.get("recommendationsFilteringOption") != null && !jsonObj.get("recommendationsFilteringOption").isJsonNull()) && !jsonObj.get("recommendationsFilteringOption").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `recommendationsFilteringOption` to be a primitive type in the JSON string but got `%s`", jsonObj.get("recommendationsFilteringOption").toString()));
      }
      // validate the optional field `recommendationsFilteringOption`
      if (jsonObj.get("recommendationsFilteringOption") != null && !jsonObj.get("recommendationsFilteringOption").isJsonNull()) {
        RecommendationsFilteringOptionEnum.validateJsonElement(jsonObj.get("recommendationsFilteringOption"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudRetailV2betaCatalogAttribute.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudRetailV2betaCatalogAttribute' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudRetailV2betaCatalogAttribute> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudRetailV2betaCatalogAttribute.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudRetailV2betaCatalogAttribute>() {
           @Override
           public void write(JsonWriter out, GoogleCloudRetailV2betaCatalogAttribute value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudRetailV2betaCatalogAttribute read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudRetailV2betaCatalogAttribute given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudRetailV2betaCatalogAttribute
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudRetailV2betaCatalogAttribute
   */
  public static GoogleCloudRetailV2betaCatalogAttribute fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudRetailV2betaCatalogAttribute.class);
  }

  /**
   * Convert an instance of GoogleCloudRetailV2betaCatalogAttribute to an JSON string
   *
   * @return JSON string
   */
