...
public class GoogleCloudRetailV2betaServingConfig {
  ...
  public GoogleCloudRetailV2betaServingConfig boostControlIds(List<String> boostControlIds) {
    this.boostControlIds = boostControlIds;
    return this;
  }

  public GoogleCloudRetailV2betaServingConfig addBoostControlIdsItem(String boostControlIdsItem) {
  ...
  public GoogleCloudRetailV2betaServingConfig displayName(String displayName) {
  ...
  public GoogleCloudRetailV2betaServingConfig diversityLevel(String diversityLevel) {
  ...
  public GoogleCloudRetailV2betaServingConfig diversityType(DiversityTypeEnum diversityType) {
  ...
  public GoogleCloudRetailV2betaServingConfig doNotAssociateControlIds(List<String> doNotAssociateControlIds) {
    this.doNotAssociateControlIds = doNotAssociateControlIds;
    return this;
  }

  public GoogleCloudRetailV2betaServingConfig addDoNotAssociateControlIdsItem(String doNotAssociateControlIdsItem) {
  ...
  public GoogleCloudRetailV2betaServingConfig dynamicFacetSpec(GoogleCloudRetailV2betaSearchRequestDynamicFacetSpec dynamicFacetSpec) {
  ...
  public GoogleCloudRetailV2betaServingConfig enableCategoryFilterLevel(String enableCategoryFilterLevel) {
  ...
  public GoogleCloudRetailV2betaServingConfig facetControlIds(List<String> facetControlIds) {
    this.facetControlIds = facetControlIds;
    return this;
  }

  public GoogleCloudRetailV2betaServingConfig addFacetControlIdsItem(String facetControlIdsItem) {
  ...
  public GoogleCloudRetailV2betaServingConfig filterControlIds(List<String> filterControlIds) {
    this.filterControlIds = filterControlIds;
    return this;
  }

  public GoogleCloudRetailV2betaServingConfig addFilterControlIdsItem(String filterControlIdsItem) {
  ...
  public GoogleCloudRetailV2betaServingConfig ignoreControlIds(List<String> ignoreControlIds) {
    this.ignoreControlIds = ignoreControlIds;
    return this;
  }

  public GoogleCloudRetailV2betaServingConfig addIgnoreControlIdsItem(String ignoreControlIdsItem) {
  ...
  public GoogleCloudRetailV2betaServingConfig modelId(String modelId) {
  ...
  public GoogleCloudRetailV2betaServingConfig name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GoogleCloudRetailV2betaServingConfig onewaySynonymsControlIds(List<String> onewaySynonymsControlIds) {
    this.onewaySynonymsControlIds = onewaySynonymsControlIds;
    return this;
  }

  public GoogleCloudRetailV2betaServingConfig addOnewaySynonymsControlIdsItem(String onewaySynonymsControlIdsItem) {
  ...
  public GoogleCloudRetailV2betaServingConfig personalizationSpec(GoogleCloudRetailV2betaSearchRequestPersonalizationSpec personalizationSpec) {
  ...
  public GoogleCloudRetailV2betaServingConfig priceRerankingLevel(String priceRerankingLevel) {
  ...
  public GoogleCloudRetailV2betaServingConfig redirectControlIds(List<String> redirectControlIds) {
    this.redirectControlIds = redirectControlIds;
    return this;
  }

  public GoogleCloudRetailV2betaServingConfig addRedirectControlIdsItem(String redirectControlIdsItem) {
  ...
  public GoogleCloudRetailV2betaServingConfig replacementControlIds(List<String> replacementControlIds) {
    this.replacementControlIds = replacementControlIds;
    return this;
  }

  public GoogleCloudRetailV2betaServingConfig addReplacementControlIdsItem(String replacementControlIdsItem) {
  ...
  public GoogleCloudRetailV2betaServingConfig solutionTypes(List<SolutionTypesEnum> solutionTypes) {
    this.solutionTypes = solutionTypes;
    return this;
  }

  public GoogleCloudRetailV2betaServingConfig addSolutionTypesItem(SolutionTypesEnum solutionTypesItem) {
  ...
  public GoogleCloudRetailV2betaServingConfig twowaySynonymsControlIds(List<String> twowaySynonymsControlIds) {
    this.twowaySynonymsControlIds = twowaySynonymsControlIds;
    return this;
  }

  public GoogleCloudRetailV2betaServingConfig addTwowaySynonymsControlIdsItem(String twowaySynonymsControlIdsItem) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudRetailV2betaServingConfig googleCloudRetailV2betaServingConfig = (GoogleCloudRetailV2betaServingConfig) o;
    return Objects.equals(this.boostControlIds, googleCloudRetailV2betaServingConfig.boostControlIds) &&
        Objects.equals(this.displayName, googleCloudRetailV2betaServingConfig.displayName) &&
        Objects.equals(this.diversityLevel, googleCloudRetailV2betaServingConfig.diversityLevel) &&
        Objects.equals(this.diversityType, googleCloudRetailV2betaServingConfig.diversityType) &&
        Objects.equals(this.doNotAssociateControlIds, googleCloudRetailV2betaServingConfig.doNotAssociateControlIds) &&
        Objects.equals(this.dynamicFacetSpec, googleCloudRetailV2betaServingConfig.dynamicFacetSpec) &&
        Objects.equals(this.enableCategoryFilterLevel, googleCloudRetailV2betaServingConfig.enableCategoryFilterLevel) &&
        Objects.equals(this.facetControlIds, googleCloudRetailV2betaServingConfig.facetControlIds) &&
        Objects.equals(this.filterControlIds, googleCloudRetailV2betaServingConfig.filterControlIds) &&
        Objects.equals(this.ignoreControlIds, googleCloudRetailV2betaServingConfig.ignoreControlIds) &&
        Objects.equals(this.modelId, googleCloudRetailV2betaServingConfig.modelId) &&
        Objects.equals(this.name, googleCloudRetailV2betaServingConfig.name) &&
        Objects.equals(this.onewaySynonymsControlIds, googleCloudRetailV2betaServingConfig.onewaySynonymsControlIds) &&
        Objects.equals(this.personalizationSpec, googleCloudRetailV2betaServingConfig.personalizationSpec) &&
        Objects.equals(this.priceRerankingLevel, googleCloudRetailV2betaServingConfig.priceRerankingLevel) &&
        Objects.equals(this.redirectControlIds, googleCloudRetailV2betaServingConfig.redirectControlIds) &&
        Objects.equals(this.replacementControlIds, googleCloudRetailV2betaServingConfig.replacementControlIds) &&
        Objects.equals(this.solutionTypes, googleCloudRetailV2betaServingConfig.solutionTypes) &&
        Objects.equals(this.twowaySynonymsControlIds, googleCloudRetailV2betaServingConfig.twowaySynonymsControlIds);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudRetailV2betaServingConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudRetailV2betaServingConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudRetailV2betaServingConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudRetailV2betaServingConfig is not found in the empty JSON string", GoogleCloudRetailV2betaServingConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudRetailV2betaServingConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudRetailV2betaServingConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudRetailV2betaServingConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudRetailV2betaServingConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudRetailV2betaServingConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudRetailV2betaServingConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudRetailV2betaServingConfig>() {
           @Override
           public void write(JsonWriter out, GoogleCloudRetailV2betaServingConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudRetailV2betaServingConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudRetailV2betaServingConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudRetailV2betaServingConfig
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudRetailV2betaServingConfig
   */
  public static GoogleCloudRetailV2betaServingConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudRetailV2betaServingConfig.class);
  }

  /**
   * Convert an instance of GoogleCloudRetailV2betaServingConfig to an JSON string
   *
   * @return JSON string
   */
