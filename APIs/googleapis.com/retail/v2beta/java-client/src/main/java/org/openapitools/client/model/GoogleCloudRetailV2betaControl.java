...
import org.openapitools.client.model.GoogleCloudRetailV2betaRule;
import org.openapitools.client.model.GoogleCloudRetailV2betaSearchRequestFacetSpec;
...
public class GoogleCloudRetailV2betaControl {
  ...
  public static final String SERIALIZED_NAME_FACET_SPEC = "facetSpec";
  @SerializedName(SERIALIZED_NAME_FACET_SPEC)
  ...
  public GoogleCloudRetailV2betaControl displayName(String displayName) {
  ...
  public GoogleCloudRetailV2betaControl facetSpec(GoogleCloudRetailV2betaSearchRequestFacetSpec facetSpec) {
  ...
  public void setFacetSpec(GoogleCloudRetailV2betaSearchRequestFacetSpec facetSpec) {
    this.facetSpec = facetSpec;
  }


  public GoogleCloudRetailV2betaControl name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GoogleCloudRetailV2betaControl rule(GoogleCloudRetailV2betaRule rule) {
    this.rule = rule;
    return this;
  }
  ...
  public void setRule(GoogleCloudRetailV2betaRule rule) {
    this.rule = rule;
  }


  public GoogleCloudRetailV2betaControl searchSolutionUseCase(List<SearchSolutionUseCaseEnum> searchSolutionUseCase) {
    this.searchSolutionUseCase = searchSolutionUseCase;
    return this;
  }

  public GoogleCloudRetailV2betaControl addSearchSolutionUseCaseItem(SearchSolutionUseCaseEnum searchSolutionUseCaseItem) {
  ...
  public GoogleCloudRetailV2betaControl solutionTypes(List<SolutionTypesEnum> solutionTypes) {
    this.solutionTypes = solutionTypes;
    return this;
  }

  public GoogleCloudRetailV2betaControl addSolutionTypesItem(SolutionTypesEnum solutionTypesItem) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudRetailV2betaControl googleCloudRetailV2betaControl = (GoogleCloudRetailV2betaControl) o;
    return Objects.equals(this.associatedServingConfigIds, googleCloudRetailV2betaControl.associatedServingConfigIds) &&
        Objects.equals(this.displayName, googleCloudRetailV2betaControl.displayName) &&
        Objects.equals(this.facetSpec, googleCloudRetailV2betaControl.facetSpec) &&
        Objects.equals(this.name, googleCloudRetailV2betaControl.name) &&
        Objects.equals(this.rule, googleCloudRetailV2betaControl.rule) &&
        Objects.equals(this.searchSolutionUseCase, googleCloudRetailV2betaControl.searchSolutionUseCase) &&
        Objects.equals(this.solutionTypes, googleCloudRetailV2betaControl.solutionTypes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(associatedServingConfigIds, displayName, facetSpec, name, rule, searchSolutionUseCase, solutionTypes);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GoogleCloudRetailV2betaControl {\n");
    sb.append("    associatedServingConfigIds: ").append(toIndentedString(associatedServingConfigIds)).append("\n");
    sb.append("    displayName: ").append(toIndentedString(displayName)).append("\n");
    sb.append("    facetSpec: ").append(toIndentedString(facetSpec)).append("\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudRetailV2betaControl
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudRetailV2betaControl.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudRetailV2betaControl is not found in the empty JSON string", GoogleCloudRetailV2betaControl.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudRetailV2betaControl.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudRetailV2betaControl` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // validate the optional field `facetSpec`
      if (jsonObj.get("facetSpec") != null && !jsonObj.get("facetSpec").isJsonNull()) {
        GoogleCloudRetailV2betaSearchRequestFacetSpec.validateJsonElement(jsonObj.get("facetSpec"));
      }
      ...
      if (jsonObj.get("rule") != null && !jsonObj.get("rule").isJsonNull()) {
        GoogleCloudRetailV2betaRule.validateJsonElement(jsonObj.get("rule"));
      }
      // ensure the optional json data is an array if present
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudRetailV2betaControl.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudRetailV2betaControl' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudRetailV2betaControl> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudRetailV2betaControl.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudRetailV2betaControl>() {
           @Override
           public void write(JsonWriter out, GoogleCloudRetailV2betaControl value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudRetailV2betaControl read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudRetailV2betaControl given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudRetailV2betaControl
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudRetailV2betaControl
   */
  public static GoogleCloudRetailV2betaControl fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudRetailV2betaControl.class);
  }

  /**
   * Convert an instance of GoogleCloudRetailV2betaControl to an JSON string
   *
   * @return JSON string
   */
