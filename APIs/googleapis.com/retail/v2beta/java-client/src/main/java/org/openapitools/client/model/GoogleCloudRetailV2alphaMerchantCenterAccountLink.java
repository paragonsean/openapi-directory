...
public class GoogleCloudRetailV2alphaMerchantCenterAccountLink {
  ...
  private List<GoogleCloudRetailV2alphaMerchantCenterAccountLinkMerchantCenterFeedFilter> feedFilters = new ArrayList<>();
  ...
  public GoogleCloudRetailV2alphaMerchantCenterAccountLink branchId(String branchId) {
  ...
  public GoogleCloudRetailV2alphaMerchantCenterAccountLink feedFilters(List<GoogleCloudRetailV2alphaMerchantCenterAccountLinkMerchantCenterFeedFilter> feedFilters) {
    this.feedFilters = feedFilters;
    return this;
  }

  public GoogleCloudRetailV2alphaMerchantCenterAccountLink addFeedFiltersItem(GoogleCloudRetailV2alphaMerchantCenterAccountLinkMerchantCenterFeedFilter feedFiltersItem) {
  ...
  public void setFeedFilters(List<GoogleCloudRetailV2alphaMerchantCenterAccountLinkMerchantCenterFeedFilter> feedFilters) {
    this.feedFilters = feedFilters;
  }


  public GoogleCloudRetailV2alphaMerchantCenterAccountLink feedLabel(String feedLabel) {
  ...
  public GoogleCloudRetailV2alphaMerchantCenterAccountLink languageCode(String languageCode) {
  ...
  public GoogleCloudRetailV2alphaMerchantCenterAccountLink merchantCenterAccountId(String merchantCenterAccountId) {
  ...
  public GoogleCloudRetailV2alphaMerchantCenterAccountLink source(String source) {
    this.source = source;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudRetailV2alphaMerchantCenterAccountLink googleCloudRetailV2alphaMerchantCenterAccountLink = (GoogleCloudRetailV2alphaMerchantCenterAccountLink) o;
    return Objects.equals(this.branchId, googleCloudRetailV2alphaMerchantCenterAccountLink.branchId) &&
        Objects.equals(this.feedFilters, googleCloudRetailV2alphaMerchantCenterAccountLink.feedFilters) &&
        Objects.equals(this.feedLabel, googleCloudRetailV2alphaMerchantCenterAccountLink.feedLabel) &&
        Objects.equals(this.id, googleCloudRetailV2alphaMerchantCenterAccountLink.id) &&
        Objects.equals(this.languageCode, googleCloudRetailV2alphaMerchantCenterAccountLink.languageCode) &&
        Objects.equals(this.merchantCenterAccountId, googleCloudRetailV2alphaMerchantCenterAccountLink.merchantCenterAccountId) &&
        Objects.equals(this.name, googleCloudRetailV2alphaMerchantCenterAccountLink.name) &&
        Objects.equals(this.projectId, googleCloudRetailV2alphaMerchantCenterAccountLink.projectId) &&
        Objects.equals(this.source, googleCloudRetailV2alphaMerchantCenterAccountLink.source) &&
        Objects.equals(this.state, googleCloudRetailV2alphaMerchantCenterAccountLink.state);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudRetailV2alphaMerchantCenterAccountLink {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudRetailV2alphaMerchantCenterAccountLink
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudRetailV2alphaMerchantCenterAccountLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudRetailV2alphaMerchantCenterAccountLink is not found in the empty JSON string", GoogleCloudRetailV2alphaMerchantCenterAccountLink.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudRetailV2alphaMerchantCenterAccountLink.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudRetailV2alphaMerchantCenterAccountLink` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("feedFilters") != null && !jsonObj.get("feedFilters").isJsonNull()) {
        ...
        if (jsonArrayfeedFilters != null) {
          ...
          for (int i = 0; i < jsonArrayfeedFilters.size(); i++) {
            GoogleCloudRetailV2alphaMerchantCenterAccountLinkMerchantCenterFeedFilter.validateJsonElement(jsonArrayfeedFilters.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudRetailV2alphaMerchantCenterAccountLink.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudRetailV2alphaMerchantCenterAccountLink' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudRetailV2alphaMerchantCenterAccountLink> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudRetailV2alphaMerchantCenterAccountLink.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudRetailV2alphaMerchantCenterAccountLink>() {
           @Override
           public void write(JsonWriter out, GoogleCloudRetailV2alphaMerchantCenterAccountLink value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudRetailV2alphaMerchantCenterAccountLink read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudRetailV2alphaMerchantCenterAccountLink given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudRetailV2alphaMerchantCenterAccountLink
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudRetailV2alphaMerchantCenterAccountLink
   */
  public static GoogleCloudRetailV2alphaMerchantCenterAccountLink fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudRetailV2alphaMerchantCenterAccountLink.class);
  }

  /**
   * Convert an instance of GoogleCloudRetailV2alphaMerchantCenterAccountLink to an JSON string
   *
   * @return JSON string
   */
