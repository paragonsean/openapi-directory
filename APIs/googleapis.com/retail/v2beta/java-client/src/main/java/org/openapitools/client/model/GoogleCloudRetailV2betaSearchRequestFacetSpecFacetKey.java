...
public class GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey {
  ...
  private List<GoogleCloudRetailV2betaInterval> intervals = new ArrayList<>();
  ...
  public GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey() {
  }

  public GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey caseInsensitive(Boolean caseInsensitive) {
  ...
  public GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey contains(List<String> contains) {
    this.contains = contains;
    return this;
  }

  public GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey addContainsItem(String containsItem) {
  ...
  public GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey intervals(List<GoogleCloudRetailV2betaInterval> intervals) {
    this.intervals = intervals;
    return this;
  }

  public GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey addIntervalsItem(GoogleCloudRetailV2betaInterval intervalsItem) {
  ...
  public void setIntervals(List<GoogleCloudRetailV2betaInterval> intervals) {
    this.intervals = intervals;
  }


  public GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey key(String key) {
    this.key = key;
    return this;
  }
  ...
  public GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey orderBy(String orderBy) {
  ...
  public GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey prefixes(List<String> prefixes) {
    this.prefixes = prefixes;
    return this;
  }

  public GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey addPrefixesItem(String prefixesItem) {
  ...
  public GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey query(String query) {
    this.query = query;
    return this;
  }
  ...
  public GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey restrictedValues(List<String> restrictedValues) {
    this.restrictedValues = restrictedValues;
    return this;
  }

  public GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey addRestrictedValuesItem(String restrictedValuesItem) {
  ...
  public GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey returnMinMax(Boolean returnMinMax) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey googleCloudRetailV2betaSearchRequestFacetSpecFacetKey = (GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey) o;
    return Objects.equals(this.caseInsensitive, googleCloudRetailV2betaSearchRequestFacetSpecFacetKey.caseInsensitive) &&
        Objects.equals(this.contains, googleCloudRetailV2betaSearchRequestFacetSpecFacetKey.contains) &&
        Objects.equals(this.intervals, googleCloudRetailV2betaSearchRequestFacetSpecFacetKey.intervals) &&
        Objects.equals(this.key, googleCloudRetailV2betaSearchRequestFacetSpecFacetKey.key) &&
        Objects.equals(this.orderBy, googleCloudRetailV2betaSearchRequestFacetSpecFacetKey.orderBy) &&
        Objects.equals(this.prefixes, googleCloudRetailV2betaSearchRequestFacetSpecFacetKey.prefixes) &&
        Objects.equals(this.query, googleCloudRetailV2betaSearchRequestFacetSpecFacetKey.query) &&
        Objects.equals(this.restrictedValues, googleCloudRetailV2betaSearchRequestFacetSpecFacetKey.restrictedValues) &&
        Objects.equals(this.returnMinMax, googleCloudRetailV2betaSearchRequestFacetSpecFacetKey.returnMinMax);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey is not found in the empty JSON string", GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("intervals") != null && !jsonObj.get("intervals").isJsonNull()) {
        ...
        if (jsonArrayintervals != null) {
          ...
          for (int i = 0; i < jsonArrayintervals.size(); i++) {
            GoogleCloudRetailV2betaInterval.validateJsonElement(jsonArrayintervals.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey>() {
           @Override
           public void write(JsonWriter out, GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey
   */
  public static GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey.class);
  }

  /**
   * Convert an instance of GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey to an JSON string
   *
   * @return JSON string
   */
