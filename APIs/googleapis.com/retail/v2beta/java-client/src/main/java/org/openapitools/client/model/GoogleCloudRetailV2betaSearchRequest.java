...
public class GoogleCloudRetailV2betaSearchRequest {
  ...
  private List<GoogleCloudRetailV2betaSearchRequestFacetSpec> facetSpecs = new ArrayList<>();
  ...
  public GoogleCloudRetailV2betaSearchRequest boostSpec(GoogleCloudRetailV2betaSearchRequestBoostSpec boostSpec) {
  ...
  public void setBoostSpec(GoogleCloudRetailV2betaSearchRequestBoostSpec boostSpec) {
    this.boostSpec = boostSpec;
  }


  public GoogleCloudRetailV2betaSearchRequest branch(String branch) {
    this.branch = branch;
    return this;
  }
  ...
  public GoogleCloudRetailV2betaSearchRequest canonicalFilter(String canonicalFilter) {
  ...
  public GoogleCloudRetailV2betaSearchRequest dynamicFacetSpec(GoogleCloudRetailV2betaSearchRequestDynamicFacetSpec dynamicFacetSpec) {
  ...
  public void setDynamicFacetSpec(GoogleCloudRetailV2betaSearchRequestDynamicFacetSpec dynamicFacetSpec) {
    this.dynamicFacetSpec = dynamicFacetSpec;
  }


  public GoogleCloudRetailV2betaSearchRequest entity(String entity) {
    this.entity = entity;
    return this;
  }
  ...
  public GoogleCloudRetailV2betaSearchRequest facetSpecs(List<GoogleCloudRetailV2betaSearchRequestFacetSpec> facetSpecs) {
    this.facetSpecs = facetSpecs;
    return this;
  }

  public GoogleCloudRetailV2betaSearchRequest addFacetSpecsItem(GoogleCloudRetailV2betaSearchRequestFacetSpec facetSpecsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<GoogleCloudRetailV2betaSearchRequestFacetSpec> getFacetSpecs() {
    return facetSpecs;
  }

  public void setFacetSpecs(List<GoogleCloudRetailV2betaSearchRequestFacetSpec> facetSpecs) {
    this.facetSpecs = facetSpecs;
  }


  public GoogleCloudRetailV2betaSearchRequest filter(String filter) {
    this.filter = filter;
    return this;
  }
  ...
  public GoogleCloudRetailV2betaSearchRequest labels(Map<String, String> labels) {
    this.labels = labels;
    return this;
  }

  public GoogleCloudRetailV2betaSearchRequest putLabelsItem(String key, String labelsItem) {
    if (this.labels == null) {
  ...
  public GoogleCloudRetailV2betaSearchRequest offset(Integer offset) {
    this.offset = offset;
    return this;
  }
  ...
  public GoogleCloudRetailV2betaSearchRequest orderBy(String orderBy) {
  ...
  public GoogleCloudRetailV2betaSearchRequest pageCategories(List<String> pageCategories) {
    this.pageCategories = pageCategories;
    return this;
  }

  public GoogleCloudRetailV2betaSearchRequest addPageCategoriesItem(String pageCategoriesItem) {
  ...
  public GoogleCloudRetailV2betaSearchRequest pageSize(Integer pageSize) {
  ...
  public GoogleCloudRetailV2betaSearchRequest pageToken(String pageToken) {
  ...
  public GoogleCloudRetailV2betaSearchRequest personalizationSpec(GoogleCloudRetailV2betaSearchRequestPersonalizationSpec personalizationSpec) {
  ...
  public void setPersonalizationSpec(GoogleCloudRetailV2betaSearchRequestPersonalizationSpec personalizationSpec) {
    this.personalizationSpec = personalizationSpec;
  }


  public GoogleCloudRetailV2betaSearchRequest query(String query) {
    this.query = query;
    return this;
  }
  ...
  public GoogleCloudRetailV2betaSearchRequest queryExpansionSpec(GoogleCloudRetailV2betaSearchRequestQueryExpansionSpec queryExpansionSpec) {
  ...
  public void setQueryExpansionSpec(GoogleCloudRetailV2betaSearchRequestQueryExpansionSpec queryExpansionSpec) {
    this.queryExpansionSpec = queryExpansionSpec;
  }


  public GoogleCloudRetailV2betaSearchRequest searchMode(SearchModeEnum searchMode) {
  ...
  public GoogleCloudRetailV2betaSearchRequest spellCorrectionSpec(GoogleCloudRetailV2betaSearchRequestSpellCorrectionSpec spellCorrectionSpec) {
  ...
  public void setSpellCorrectionSpec(GoogleCloudRetailV2betaSearchRequestSpellCorrectionSpec spellCorrectionSpec) {
    this.spellCorrectionSpec = spellCorrectionSpec;
  }


  public GoogleCloudRetailV2betaSearchRequest userInfo(GoogleCloudRetailV2betaUserInfo userInfo) {
  ...
  public GoogleCloudRetailV2betaSearchRequest variantRollupKeys(List<String> variantRollupKeys) {
    this.variantRollupKeys = variantRollupKeys;
    return this;
  }

  public GoogleCloudRetailV2betaSearchRequest addVariantRollupKeysItem(String variantRollupKeysItem) {
  ...
  public GoogleCloudRetailV2betaSearchRequest visitorId(String visitorId) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudRetailV2betaSearchRequest googleCloudRetailV2betaSearchRequest = (GoogleCloudRetailV2betaSearchRequest) o;
    return Objects.equals(this.boostSpec, googleCloudRetailV2betaSearchRequest.boostSpec) &&
        Objects.equals(this.branch, googleCloudRetailV2betaSearchRequest.branch) &&
        Objects.equals(this.canonicalFilter, googleCloudRetailV2betaSearchRequest.canonicalFilter) &&
        Objects.equals(this.dynamicFacetSpec, googleCloudRetailV2betaSearchRequest.dynamicFacetSpec) &&
        Objects.equals(this.entity, googleCloudRetailV2betaSearchRequest.entity) &&
        Objects.equals(this.facetSpecs, googleCloudRetailV2betaSearchRequest.facetSpecs) &&
        Objects.equals(this.filter, googleCloudRetailV2betaSearchRequest.filter) &&
        Objects.equals(this.labels, googleCloudRetailV2betaSearchRequest.labels) &&
        Objects.equals(this.offset, googleCloudRetailV2betaSearchRequest.offset) &&
        Objects.equals(this.orderBy, googleCloudRetailV2betaSearchRequest.orderBy) &&
        Objects.equals(this.pageCategories, googleCloudRetailV2betaSearchRequest.pageCategories) &&
        Objects.equals(this.pageSize, googleCloudRetailV2betaSearchRequest.pageSize) &&
        Objects.equals(this.pageToken, googleCloudRetailV2betaSearchRequest.pageToken) &&
        Objects.equals(this.personalizationSpec, googleCloudRetailV2betaSearchRequest.personalizationSpec) &&
        Objects.equals(this.query, googleCloudRetailV2betaSearchRequest.query) &&
        Objects.equals(this.queryExpansionSpec, googleCloudRetailV2betaSearchRequest.queryExpansionSpec) &&
        Objects.equals(this.searchMode, googleCloudRetailV2betaSearchRequest.searchMode) &&
        Objects.equals(this.spellCorrectionSpec, googleCloudRetailV2betaSearchRequest.spellCorrectionSpec) &&
        Objects.equals(this.userInfo, googleCloudRetailV2betaSearchRequest.userInfo) &&
        Objects.equals(this.variantRollupKeys, googleCloudRetailV2betaSearchRequest.variantRollupKeys) &&
        Objects.equals(this.visitorId, googleCloudRetailV2betaSearchRequest.visitorId);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudRetailV2betaSearchRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudRetailV2betaSearchRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudRetailV2betaSearchRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudRetailV2betaSearchRequest is not found in the empty JSON string", GoogleCloudRetailV2betaSearchRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudRetailV2betaSearchRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudRetailV2betaSearchRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `boostSpec`
      if (jsonObj.get("boostSpec") != null && !jsonObj.get("boostSpec").isJsonNull()) {
        GoogleCloudRetailV2betaSearchRequestBoostSpec.validateJsonElement(jsonObj.get("boostSpec"));
      }
      ...
      if (jsonObj.get("dynamicFacetSpec") != null && !jsonObj.get("dynamicFacetSpec").isJsonNull()) {
        GoogleCloudRetailV2betaSearchRequestDynamicFacetSpec.validateJsonElement(jsonObj.get("dynamicFacetSpec"));
      }
      ...
      if (jsonObj.get("facetSpecs") != null && !jsonObj.get("facetSpecs").isJsonNull()) {
        ...
        if (jsonArrayfacetSpecs != null) {
          ...
          for (int i = 0; i < jsonArrayfacetSpecs.size(); i++) {
            GoogleCloudRetailV2betaSearchRequestFacetSpec.validateJsonElement(jsonArrayfacetSpecs.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("personalizationSpec") != null && !jsonObj.get("personalizationSpec").isJsonNull()) {
        GoogleCloudRetailV2betaSearchRequestPersonalizationSpec.validateJsonElement(jsonObj.get("personalizationSpec"));
      }
      ...
      if (jsonObj.get("queryExpansionSpec") != null && !jsonObj.get("queryExpansionSpec").isJsonNull()) {
        GoogleCloudRetailV2betaSearchRequestQueryExpansionSpec.validateJsonElement(jsonObj.get("queryExpansionSpec"));
      }
      ...
      if (jsonObj.get("spellCorrectionSpec") != null && !jsonObj.get("spellCorrectionSpec").isJsonNull()) {
        GoogleCloudRetailV2betaSearchRequestSpellCorrectionSpec.validateJsonElement(jsonObj.get("spellCorrectionSpec"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudRetailV2betaSearchRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudRetailV2betaSearchRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudRetailV2betaSearchRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudRetailV2betaSearchRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudRetailV2betaSearchRequest>() {
           @Override
           public void write(JsonWriter out, GoogleCloudRetailV2betaSearchRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudRetailV2betaSearchRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudRetailV2betaSearchRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudRetailV2betaSearchRequest
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudRetailV2betaSearchRequest
   */
  public static GoogleCloudRetailV2betaSearchRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudRetailV2betaSearchRequest.class);
  }

  /**
   * Convert an instance of GoogleCloudRetailV2betaSearchRequest to an JSON string
   *
   * @return JSON string
   */
