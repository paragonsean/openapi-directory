...
public class GoogleCloudRetailV2betaProduct {
  ...
  private List<GoogleCloudRetailV2betaFulfillmentInfo> fulfillmentInfo = new ArrayList<>();
  ...
  private List<GoogleCloudRetailV2betaImage> images = new ArrayList<>();
  ...
  private List<GoogleCloudRetailV2betaPromotion> promotions = new ArrayList<>();
  ...
  private List<GoogleCloudRetailV2betaProduct> variants = new ArrayList<>();

  public GoogleCloudRetailV2betaProduct() {
  }

  public GoogleCloudRetailV2betaProduct(
     List<GoogleCloudRetailV2betaLocalInventory> localInventories, 
     List<GoogleCloudRetailV2betaProduct> variants
  ) {
    this();
  ...
  public GoogleCloudRetailV2betaProduct attributes(Map<String, GoogleCloudRetailV2betaCustomAttribute> attributes) {
    this.attributes = attributes;
    return this;
  }

  public GoogleCloudRetailV2betaProduct putAttributesItem(String key, GoogleCloudRetailV2betaCustomAttribute attributesItem) {
  ...
  public GoogleCloudRetailV2betaProduct audience(GoogleCloudRetailV2betaAudience audience) {
  ...
  public void setAudience(GoogleCloudRetailV2betaAudience audience) {
    this.audience = audience;
  }


  public GoogleCloudRetailV2betaProduct availability(AvailabilityEnum availability) {
  ...
  public GoogleCloudRetailV2betaProduct availableQuantity(Integer availableQuantity) {
  ...
  public GoogleCloudRetailV2betaProduct availableTime(String availableTime) {
  ...
  public GoogleCloudRetailV2betaProduct brands(List<String> brands) {
    this.brands = brands;
    return this;
  }

  public GoogleCloudRetailV2betaProduct addBrandsItem(String brandsItem) {
    if (this.brands == null) {
  ...
  public GoogleCloudRetailV2betaProduct categories(List<String> categories) {
    this.categories = categories;
    return this;
  }

  public GoogleCloudRetailV2betaProduct addCategoriesItem(String categoriesItem) {
  ...
  public GoogleCloudRetailV2betaProduct collectionMemberIds(List<String> collectionMemberIds) {
    this.collectionMemberIds = collectionMemberIds;
    return this;
  }

  public GoogleCloudRetailV2betaProduct addCollectionMemberIdsItem(String collectionMemberIdsItem) {
  ...
  public GoogleCloudRetailV2betaProduct colorInfo(GoogleCloudRetailV2betaColorInfo colorInfo) {
  ...
  public void setColorInfo(GoogleCloudRetailV2betaColorInfo colorInfo) {
    this.colorInfo = colorInfo;
  }


  public GoogleCloudRetailV2betaProduct conditions(List<String> conditions) {
    this.conditions = conditions;
    return this;
  }

  public GoogleCloudRetailV2betaProduct addConditionsItem(String conditionsItem) {
  ...
  public GoogleCloudRetailV2betaProduct description(String description) {
  ...
  public GoogleCloudRetailV2betaProduct expireTime(String expireTime) {
  ...
  public GoogleCloudRetailV2betaProduct fulfillmentInfo(List<GoogleCloudRetailV2betaFulfillmentInfo> fulfillmentInfo) {
    this.fulfillmentInfo = fulfillmentInfo;
    return this;
  }

  public GoogleCloudRetailV2betaProduct addFulfillmentInfoItem(GoogleCloudRetailV2betaFulfillmentInfo fulfillmentInfoItem) {
  ...
  public void setFulfillmentInfo(List<GoogleCloudRetailV2betaFulfillmentInfo> fulfillmentInfo) {
    this.fulfillmentInfo = fulfillmentInfo;
  }


  public GoogleCloudRetailV2betaProduct gtin(String gtin) {
    this.gtin = gtin;
    return this;
  }
  ...
  public GoogleCloudRetailV2betaProduct id(String id) {
    this.id = id;
    return this;
  }
  ...
  public GoogleCloudRetailV2betaProduct images(List<GoogleCloudRetailV2betaImage> images) {
    this.images = images;
    return this;
  }

  public GoogleCloudRetailV2betaProduct addImagesItem(GoogleCloudRetailV2betaImage imagesItem) {
    if (this.images == null) {
  ...
  public void setImages(List<GoogleCloudRetailV2betaImage> images) {
    this.images = images;
  }


  public GoogleCloudRetailV2betaProduct languageCode(String languageCode) {
  ...
  public GoogleCloudRetailV2betaProduct materials(List<String> materials) {
    this.materials = materials;
    return this;
  }

  public GoogleCloudRetailV2betaProduct addMaterialsItem(String materialsItem) {
  ...
  public GoogleCloudRetailV2betaProduct name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GoogleCloudRetailV2betaProduct patterns(List<String> patterns) {
    this.patterns = patterns;
    return this;
  }

  public GoogleCloudRetailV2betaProduct addPatternsItem(String patternsItem) {
  ...
  public GoogleCloudRetailV2betaProduct priceInfo(GoogleCloudRetailV2betaPriceInfo priceInfo) {
  ...
  public GoogleCloudRetailV2betaProduct primaryProductId(String primaryProductId) {
  ...
  public GoogleCloudRetailV2betaProduct promotions(List<GoogleCloudRetailV2betaPromotion> promotions) {
    this.promotions = promotions;
    return this;
  }

  public GoogleCloudRetailV2betaProduct addPromotionsItem(GoogleCloudRetailV2betaPromotion promotionsItem) {
  ...
  public void setPromotions(List<GoogleCloudRetailV2betaPromotion> promotions) {
    this.promotions = promotions;
  }


  public GoogleCloudRetailV2betaProduct publishTime(String publishTime) {
  ...
  public GoogleCloudRetailV2betaProduct rating(GoogleCloudRetailV2betaRating rating) {
    this.rating = rating;
    return this;
  }
  ...
  public void setRating(GoogleCloudRetailV2betaRating rating) {
    this.rating = rating;
  }


  @Deprecated
  public GoogleCloudRetailV2betaProduct retrievableFields(String retrievableFields) {
  ...
  public GoogleCloudRetailV2betaProduct sizes(List<String> sizes) {
    this.sizes = sizes;
    return this;
  }

  public GoogleCloudRetailV2betaProduct addSizesItem(String sizesItem) {
    if (this.sizes == null) {
  ...
  public GoogleCloudRetailV2betaProduct tags(List<String> tags) {
    this.tags = tags;
    return this;
  }

  public GoogleCloudRetailV2betaProduct addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public GoogleCloudRetailV2betaProduct title(String title) {
    this.title = title;
    return this;
  }
  ...
  public GoogleCloudRetailV2betaProduct ttl(String ttl) {
    this.ttl = ttl;
    return this;
  }
  ...
  public GoogleCloudRetailV2betaProduct type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public GoogleCloudRetailV2betaProduct uri(String uri) {
    this.uri = uri;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudRetailV2betaProduct googleCloudRetailV2betaProduct = (GoogleCloudRetailV2betaProduct) o;
    return Objects.equals(this.attributes, googleCloudRetailV2betaProduct.attributes) &&
        Objects.equals(this.audience, googleCloudRetailV2betaProduct.audience) &&
        Objects.equals(this.availability, googleCloudRetailV2betaProduct.availability) &&
        Objects.equals(this.availableQuantity, googleCloudRetailV2betaProduct.availableQuantity) &&
        Objects.equals(this.availableTime, googleCloudRetailV2betaProduct.availableTime) &&
        Objects.equals(this.brands, googleCloudRetailV2betaProduct.brands) &&
        Objects.equals(this.categories, googleCloudRetailV2betaProduct.categories) &&
        Objects.equals(this.collectionMemberIds, googleCloudRetailV2betaProduct.collectionMemberIds) &&
        Objects.equals(this.colorInfo, googleCloudRetailV2betaProduct.colorInfo) &&
        Objects.equals(this.conditions, googleCloudRetailV2betaProduct.conditions) &&
        Objects.equals(this.description, googleCloudRetailV2betaProduct.description) &&
        Objects.equals(this.expireTime, googleCloudRetailV2betaProduct.expireTime) &&
        Objects.equals(this.fulfillmentInfo, googleCloudRetailV2betaProduct.fulfillmentInfo) &&
        Objects.equals(this.gtin, googleCloudRetailV2betaProduct.gtin) &&
        Objects.equals(this.id, googleCloudRetailV2betaProduct.id) &&
        Objects.equals(this.images, googleCloudRetailV2betaProduct.images) &&
        Objects.equals(this.languageCode, googleCloudRetailV2betaProduct.languageCode) &&
        Objects.equals(this.localInventories, googleCloudRetailV2betaProduct.localInventories) &&
        Objects.equals(this.materials, googleCloudRetailV2betaProduct.materials) &&
        Objects.equals(this.name, googleCloudRetailV2betaProduct.name) &&
        Objects.equals(this.patterns, googleCloudRetailV2betaProduct.patterns) &&
        Objects.equals(this.priceInfo, googleCloudRetailV2betaProduct.priceInfo) &&
        Objects.equals(this.primaryProductId, googleCloudRetailV2betaProduct.primaryProductId) &&
        Objects.equals(this.promotions, googleCloudRetailV2betaProduct.promotions) &&
        Objects.equals(this.publishTime, googleCloudRetailV2betaProduct.publishTime) &&
        Objects.equals(this.rating, googleCloudRetailV2betaProduct.rating) &&
        Objects.equals(this.retrievableFields, googleCloudRetailV2betaProduct.retrievableFields) &&
        Objects.equals(this.sizes, googleCloudRetailV2betaProduct.sizes) &&
        Objects.equals(this.tags, googleCloudRetailV2betaProduct.tags) &&
        Objects.equals(this.title, googleCloudRetailV2betaProduct.title) &&
        Objects.equals(this.ttl, googleCloudRetailV2betaProduct.ttl) &&
        Objects.equals(this.type, googleCloudRetailV2betaProduct.type) &&
        Objects.equals(this.uri, googleCloudRetailV2betaProduct.uri) &&
        Objects.equals(this.variants, googleCloudRetailV2betaProduct.variants);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudRetailV2betaProduct {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudRetailV2betaProduct
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudRetailV2betaProduct.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudRetailV2betaProduct is not found in the empty JSON string", GoogleCloudRetailV2betaProduct.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudRetailV2betaProduct.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudRetailV2betaProduct` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `audience`
      if (jsonObj.get("audience") != null && !jsonObj.get("audience").isJsonNull()) {
        GoogleCloudRetailV2betaAudience.validateJsonElement(jsonObj.get("audience"));
      }
      ...
      if (jsonObj.get("colorInfo") != null && !jsonObj.get("colorInfo").isJsonNull()) {
        GoogleCloudRetailV2betaColorInfo.validateJsonElement(jsonObj.get("colorInfo"));
      }
      // ensure the optional json data is an array if present
      ...
      if (jsonObj.get("fulfillmentInfo") != null && !jsonObj.get("fulfillmentInfo").isJsonNull()) {
        ...
        if (jsonArrayfulfillmentInfo != null) {
          ...
          for (int i = 0; i < jsonArrayfulfillmentInfo.size(); i++) {
            GoogleCloudRetailV2betaFulfillmentInfo.validateJsonElement(jsonArrayfulfillmentInfo.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("images") != null && !jsonObj.get("images").isJsonNull()) {
        ...
        if (jsonArrayimages != null) {
          ...
          for (int i = 0; i < jsonArrayimages.size(); i++) {
            GoogleCloudRetailV2betaImage.validateJsonElement(jsonArrayimages.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("promotions") != null && !jsonObj.get("promotions").isJsonNull()) {
        ...
        if (jsonArraypromotions != null) {
          ...
          for (int i = 0; i < jsonArraypromotions.size(); i++) {
            GoogleCloudRetailV2betaPromotion.validateJsonElement(jsonArraypromotions.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("rating") != null && !jsonObj.get("rating").isJsonNull()) {
        GoogleCloudRetailV2betaRating.validateJsonElement(jsonObj.get("rating"));
      }
      ...
      if (jsonObj.get("variants") != null && !jsonObj.get("variants").isJsonNull()) {
        ...
        if (jsonArrayvariants != null) {
          ...
          for (int i = 0; i < jsonArrayvariants.size(); i++) {
            GoogleCloudRetailV2betaProduct.validateJsonElement(jsonArrayvariants.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudRetailV2betaProduct.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudRetailV2betaProduct' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudRetailV2betaProduct> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudRetailV2betaProduct.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudRetailV2betaProduct>() {
           @Override
           public void write(JsonWriter out, GoogleCloudRetailV2betaProduct value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudRetailV2betaProduct read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudRetailV2betaProduct given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudRetailV2betaProduct
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudRetailV2betaProduct
   */
  public static GoogleCloudRetailV2betaProduct fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudRetailV2betaProduct.class);
  }

  /**
   * Convert an instance of GoogleCloudRetailV2betaProduct to an JSON string
   *
   * @return JSON string
   */
