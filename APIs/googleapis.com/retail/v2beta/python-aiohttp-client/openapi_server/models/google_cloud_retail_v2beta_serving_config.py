...
class GoogleCloudRetailV2betaServingConfig(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, boost_control_ids: List[str]=None, display_name: str=None, diversity_level: str=None, diversity_type: str=None, do_not_associate_control_ids: List[str]=None, dynamic_facet_spec: GoogleCloudRetailV2betaSearchRequestDynamicFacetSpec=None, enable_category_filter_level: str=None, facet_control_ids: List[str]=None, filter_control_ids: List[str]=None, ignore_control_ids: List[str]=None, model_id: str=None, name: str=None, oneway_synonyms_control_ids: List[str]=None, personalization_spec: GoogleCloudRetailV2betaSearchRequestPersonalizationSpec=None, price_reranking_level: str=None, redirect_control_ids: List[str]=None, replacement_control_ids: List[str]=None, solution_types: List[str]=None, twoway_synonyms_control_ids: List[str]=None):
        """GoogleCloudRetailV2betaServingConfig - a model defined in OpenAPI

        :param boost_control_ids: The boost_control_ids of this GoogleCloudRetailV2betaServingConfig.
        :param display_name: The display_name of this GoogleCloudRetailV2betaServingConfig.
        :param diversity_level: The diversity_level of this GoogleCloudRetailV2betaServingConfig.
        :param diversity_type: The diversity_type of this GoogleCloudRetailV2betaServingConfig.
        :param do_not_associate_control_ids: The do_not_associate_control_ids of this GoogleCloudRetailV2betaServingConfig.
        :param dynamic_facet_spec: The dynamic_facet_spec of this GoogleCloudRetailV2betaServingConfig.
        :param enable_category_filter_level: The enable_category_filter_level of this GoogleCloudRetailV2betaServingConfig.
        :param facet_control_ids: The facet_control_ids of this GoogleCloudRetailV2betaServingConfig.
        :param filter_control_ids: The filter_control_ids of this GoogleCloudRetailV2betaServingConfig.
        :param ignore_control_ids: The ignore_control_ids of this GoogleCloudRetailV2betaServingConfig.
        :param model_id: The model_id of this GoogleCloudRetailV2betaServingConfig.
        :param name: The name of this GoogleCloudRetailV2betaServingConfig.
        :param oneway_synonyms_control_ids: The oneway_synonyms_control_ids of this GoogleCloudRetailV2betaServingConfig.
        :param personalization_spec: The personalization_spec of this GoogleCloudRetailV2betaServingConfig.
        :param price_reranking_level: The price_reranking_level of this GoogleCloudRetailV2betaServingConfig.
        :param redirect_control_ids: The redirect_control_ids of this GoogleCloudRetailV2betaServingConfig.
        :param replacement_control_ids: The replacement_control_ids of this GoogleCloudRetailV2betaServingConfig.
        :param solution_types: The solution_types of this GoogleCloudRetailV2betaServingConfig.
        :param twoway_synonyms_control_ids: The twoway_synonyms_control_ids of this GoogleCloudRetailV2betaServingConfig.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'GoogleCloudRetailV2betaServingConfig':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The GoogleCloudRetailV2betaServingConfig of this GoogleCloudRetailV2betaServingConfig.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def boost_control_ids(self):
        """Gets the boost_control_ids of this GoogleCloudRetailV2betaServingConfig.

        Condition boost specifications. If a product matches multiple conditions in the specifications, boost scores from these specifications are all applied and combined in a non-linear way. Maximum number of specifications is 100. Notice that if both ServingConfig.boost_control_ids and SearchRequest.boost_spec are set, the boost conditions from both places are evaluated. If a search request matches multiple boost conditions, the final boost score is equal to the sum of the boost scores from all matched boost conditions. Can only be set if solution_types is SOLUTION_TYPE_SEARCH.

        :return: The boost_control_ids of this GoogleCloudRetailV2betaServingConfig.
        :rtype: List[str]
        """
    ...
    def boost_control_ids(self, boost_control_ids):
        """Sets the boost_control_ids of this GoogleCloudRetailV2betaServingConfig.
    ...
    def display_name(self):
        """Gets the display_name of this GoogleCloudRetailV2betaServingConfig.
        ...
        :return: The display_name of this GoogleCloudRetailV2betaServingConfig.
        :rtype: str
        """
    ...
    def display_name(self, display_name):
        """Sets the display_name of this GoogleCloudRetailV2betaServingConfig.
    ...
    def diversity_level(self):
        """Gets the diversity_level of this GoogleCloudRetailV2betaServingConfig.

        How much diversity to use in recommendation model results e.g. `medium-diversity` or `high-diversity`. Currently supported values: * `no-diversity` * `low-diversity` * `medium-diversity` * `high-diversity` * `auto-diversity` If not specified, we choose default based on recommendation model type. Default value: `no-diversity`. Can only be set if solution_types is SOLUTION_TYPE_RECOMMENDATION.

        :return: The diversity_level of this GoogleCloudRetailV2betaServingConfig.
        :rtype: str
        """
    ...
    def diversity_level(self, diversity_level):
        """Sets the diversity_level of this GoogleCloudRetailV2betaServingConfig.
    ...
    def diversity_type(self):
        """Gets the diversity_type of this GoogleCloudRetailV2betaServingConfig.

        What kind of diversity to use - data driven or rule based. If unset, the server behavior defaults to RULE_BASED_DIVERSITY.

        :return: The diversity_type of this GoogleCloudRetailV2betaServingConfig.
        :rtype: str
        """
    ...
    def diversity_type(self, diversity_type):
        """Sets the diversity_type of this GoogleCloudRetailV2betaServingConfig.
    ...
    def do_not_associate_control_ids(self):
        """Gets the do_not_associate_control_ids of this GoogleCloudRetailV2betaServingConfig.

        Condition do not associate specifications. If multiple do not associate conditions match, all matching do not associate controls in the list will execute. - Order does not matter. - Maximum number of specifications is 100. Can only be set if solution_types is SOLUTION_TYPE_SEARCH.

        :return: The do_not_associate_control_ids of this GoogleCloudRetailV2betaServingConfig.
        :rtype: List[str]
        """
    ...
    def do_not_associate_control_ids(self, do_not_associate_control_ids):
        """Sets the do_not_associate_control_ids of this GoogleCloudRetailV2betaServingConfig.
    ...
    def dynamic_facet_spec(self):
        """Gets the dynamic_facet_spec of this GoogleCloudRetailV2betaServingConfig.


        :return: The dynamic_facet_spec of this GoogleCloudRetailV2betaServingConfig.
    ...
    def dynamic_facet_spec(self, dynamic_facet_spec):
        """Sets the dynamic_facet_spec of this GoogleCloudRetailV2betaServingConfig.
    ...
    def enable_category_filter_level(self):
        """Gets the enable_category_filter_level of this GoogleCloudRetailV2betaServingConfig.

        Whether to add additional category filters on the `similar-items` model. If not specified, we enable it by default. Allowed values are: * `no-category-match`: No additional filtering of original results from the model and the customer's filters. * `relaxed-category-match`: Only keep results with categories that match at least one item categories in the PredictRequests's context item. * If customer also sends filters in the PredictRequest, then the results will satisfy both conditions (user given and category match). Can only be set if solution_types is SOLUTION_TYPE_RECOMMENDATION.

        :return: The enable_category_filter_level of this GoogleCloudRetailV2betaServingConfig.
        :rtype: str
        """
    ...
    def enable_category_filter_level(self, enable_category_filter_level):
        """Sets the enable_category_filter_level of this GoogleCloudRetailV2betaServingConfig.
    ...
    def facet_control_ids(self):
        """Gets the facet_control_ids of this GoogleCloudRetailV2betaServingConfig.

        Facet specifications for faceted search. If empty, no facets are returned. The ids refer to the ids of Control resources with only the Facet control set. These controls are assumed to be in the same Catalog as the ServingConfig. A maximum of 100 values are allowed. Otherwise, an INVALID_ARGUMENT error is returned. Can only be set if solution_types is SOLUTION_TYPE_SEARCH.

        :return: The facet_control_ids of this GoogleCloudRetailV2betaServingConfig.
        :rtype: List[str]
        """
    ...
    def facet_control_ids(self, facet_control_ids):
        """Sets the facet_control_ids of this GoogleCloudRetailV2betaServingConfig.
    ...
    def filter_control_ids(self):
        """Gets the filter_control_ids of this GoogleCloudRetailV2betaServingConfig.

        Condition filter specifications. If a product matches multiple conditions in the specifications, filters from these specifications are all applied and combined via the AND operator. Maximum number of specifications is 100. Can only be set if solution_types is SOLUTION_TYPE_SEARCH.

        :return: The filter_control_ids of this GoogleCloudRetailV2betaServingConfig.
        :rtype: List[str]
        """
    ...
    def filter_control_ids(self, filter_control_ids):
        """Sets the filter_control_ids of this GoogleCloudRetailV2betaServingConfig.
    ...
    def ignore_control_ids(self):
        """Gets the ignore_control_ids of this GoogleCloudRetailV2betaServingConfig.

        Condition ignore specifications. If multiple ignore conditions match, all matching ignore controls in the list will execute. - Order does not matter. - Maximum number of specifications is 100. Can only be set if solution_types is SOLUTION_TYPE_SEARCH.

        :return: The ignore_control_ids of this GoogleCloudRetailV2betaServingConfig.
        :rtype: List[str]
        """
    ...
    def ignore_control_ids(self, ignore_control_ids):
        """Sets the ignore_control_ids of this GoogleCloudRetailV2betaServingConfig.
    ...
    @property
    def model_id(self):
        """Gets the model_id of this GoogleCloudRetailV2betaServingConfig.

        The id of the model in the same Catalog to use at serving time. Currently only RecommendationModels are supported: https://cloud.google.com/retail/recommendations-ai/docs/create-models Can be changed but only to a compatible model (e.g. others-you-may-like CTR to others-you-may-like CVR). Required when solution_types is SOLUTION_TYPE_RECOMMENDATION.

        :return: The model_id of this GoogleCloudRetailV2betaServingConfig.
        :rtype: str
        """
    ...
    def model_id(self, model_id):
        """Sets the model_id of this GoogleCloudRetailV2betaServingConfig.
    ...
    @property
    def name(self):
        """Gets the name of this GoogleCloudRetailV2betaServingConfig.

        Immutable. Fully qualified name `projects/*/locations/global/catalogs/*/servingConfig/*`

        :return: The name of this GoogleCloudRetailV2betaServingConfig.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this GoogleCloudRetailV2betaServingConfig.
    ...
    def oneway_synonyms_control_ids(self):
        """Gets the oneway_synonyms_control_ids of this GoogleCloudRetailV2betaServingConfig.

        Condition oneway synonyms specifications. If multiple oneway synonyms conditions match, all matching oneway synonyms controls in the list will execute. Order of controls in the list will not matter. Maximum number of specifications is 100. Can only be set if solution_types is SOLUTION_TYPE_SEARCH.

        :return: The oneway_synonyms_control_ids of this GoogleCloudRetailV2betaServingConfig.
        :rtype: List[str]
        """
    ...
    def oneway_synonyms_control_ids(self, oneway_synonyms_control_ids):
        """Sets the oneway_synonyms_control_ids of this GoogleCloudRetailV2betaServingConfig.
    ...
    def personalization_spec(self):
        """Gets the personalization_spec of this GoogleCloudRetailV2betaServingConfig.


        :return: The personalization_spec of this GoogleCloudRetailV2betaServingConfig.
    ...
    def personalization_spec(self, personalization_spec):
        """Sets the personalization_spec of this GoogleCloudRetailV2betaServingConfig.
    ...
    def price_reranking_level(self):
        """Gets the price_reranking_level of this GoogleCloudRetailV2betaServingConfig.
        ...
        :return: The price_reranking_level of this GoogleCloudRetailV2betaServingConfig.
        :rtype: str
        """
    ...
    def price_reranking_level(self, price_reranking_level):
        """Sets the price_reranking_level of this GoogleCloudRetailV2betaServingConfig.
    ...
    def redirect_control_ids(self):
        """Gets the redirect_control_ids of this GoogleCloudRetailV2betaServingConfig.

        Condition redirect specifications. Only the first triggered redirect action is applied, even if multiple apply. Maximum number of specifications is 1000. Can only be set if solution_types is SOLUTION_TYPE_SEARCH.

        :return: The redirect_control_ids of this GoogleCloudRetailV2betaServingConfig.
        :rtype: List[str]
        """
    ...
    def redirect_control_ids(self, redirect_control_ids):
        """Sets the redirect_control_ids of this GoogleCloudRetailV2betaServingConfig.
    ...
    def replacement_control_ids(self):
        """Gets the replacement_control_ids of this GoogleCloudRetailV2betaServingConfig.

        Condition replacement specifications. - Applied according to the order in the list. - A previously replaced term can not be re-replaced. - Maximum number of specifications is 100. Can only be set if solution_types is SOLUTION_TYPE_SEARCH.

        :return: The replacement_control_ids of this GoogleCloudRetailV2betaServingConfig.
        :rtype: List[str]
        """
    ...
    def replacement_control_ids(self, replacement_control_ids):
        """Sets the replacement_control_ids of this GoogleCloudRetailV2betaServingConfig.
    ...
    def solution_types(self):
        """Gets the solution_types of this GoogleCloudRetailV2betaServingConfig.
        ...
        :return: The solution_types of this GoogleCloudRetailV2betaServingConfig.
        :rtype: List[str]
        """
    ...
    def solution_types(self, solution_types):
        """Sets the solution_types of this GoogleCloudRetailV2betaServingConfig.
    ...
    def twoway_synonyms_control_ids(self):
        """Gets the twoway_synonyms_control_ids of this GoogleCloudRetailV2betaServingConfig.

        Condition synonyms specifications. If multiple syonyms conditions match, all matching synonyms control in the list will execute. Order of controls in the list will not matter. Maximum number of specifications is 100. Can only be set if solution_types is SOLUTION_TYPE_SEARCH.

        :return: The twoway_synonyms_control_ids of this GoogleCloudRetailV2betaServingConfig.
        :rtype: List[str]
        """
    ...
    def twoway_synonyms_control_ids(self, twoway_synonyms_control_ids):
        """Sets the twoway_synonyms_control_ids of this GoogleCloudRetailV2betaServingConfig.
