...
|**state** | [**StateEnum**](#StateEnum) | Output only. The state of the queue. &#x60;state&#x60; can only be changed by called PauseQueue, ResumeQueue, or uploading [queue.yaml/xml](https://cloud.google.com/appengine/docs/python/config/queueref). UpdateQueue cannot be used to change &#x60;state&#x60;. |  [optional] |
...
|**type** | [**TypeEnum**](#TypeEnum) | Immutable. The type of a queue (push or pull). &#x60;Queue.type&#x60; is an immutable property of the queue that is set at the queue creation time. When left unspecified, the default value of &#x60;PUSH&#x60; is selected. |  [optional] |
