...
class Queue(Model):
    ...
    def __init__(self, app_engine_http_queue: AppEngineHttpQueue=None, http_target: HttpTarget=None, name: str=None, purge_time: str=None, rate_limits: RateLimits=None, retry_config: RetryConfig=None, stackdriver_logging_config: StackdriverLoggingConfig=None, state: str=None, stats: QueueStats=None, task_ttl: str=None, tombstone_ttl: str=None, type: str=None):
        """Queue - a model defined in OpenAPI

        :param app_engine_http_queue: The app_engine_http_queue of this Queue.
        ...
        self._app_engine_http_queue = app_engine_http_queue
    ...
    @property
    def app_engine_http_queue(self):
        """Gets the app_engine_http_queue of this Queue.


        :return: The app_engine_http_queue of this Queue.
        :rtype: AppEngineHttpQueue
        """
        return self._app_engine_http_queue

    @app_engine_http_queue.setter
    def app_engine_http_queue(self, app_engine_http_queue):
        """Sets the app_engine_http_queue of this Queue.


        :param app_engine_http_queue: The app_engine_http_queue of this Queue.
        :type app_engine_http_queue: AppEngineHttpQueue
        """
    ...
    def type(self, type):
        ...
        :type type: str
        """
        allowed_values = ["TYPE_UNSPECIFIED", "PULL", "PUSH"]  # noqa: E501
