...
class Task(Model):
    ...
    def __init__(self, app_engine_http_request: AppEngineHttpRequest=None, create_time: str=None, dispatch_count: int=None, dispatch_deadline: str=None, first_attempt: Attempt=None, http_request: HttpRequest=None, last_attempt: Attempt=None, name: str=None, pull_message: PullMessage=None, response_count: int=None, schedule_time: str=None, view: str=None):
