...
void OAIQueue::initializeModel() {
    ...
    m_app_engine_http_queue_isSet = false;
    m_app_engine_http_queue_isValid = false;
...
void OAIQueue::fromJsonObject(QJsonObject json) {
    ...
    m_app_engine_http_queue_isValid = ::OpenAPI::fromJsonValue(m_app_engine_http_queue, json[QString("appEngineHttpQueue")]);
    m_app_engine_http_queue_isSet = !json[QString("appEngineHttpQueue")].isNull() && m_app_engine_http_queue_isValid;
...
QJsonObject OAIQueue::asJsonObject() const {
    QJsonObject obj;
    if (m_app_engine_http_queue.isSet()) {
        obj.insert(QString("appEngineHttpQueue"), ::OpenAPI::toJsonValue(m_app_engine_http_queue));
    }
...
OAIAppEngineHttpQueue OAIQueue::getAppEngineHttpQueue() const {
    return m_app_engine_http_queue;
}
void OAIQueue::setAppEngineHttpQueue(const OAIAppEngineHttpQueue &app_engine_http_queue) {
    m_app_engine_http_queue = app_engine_http_queue;
    m_app_engine_http_queue_isSet = true;
}

bool OAIQueue::is_app_engine_http_queue_Set() const{
    return m_app_engine_http_queue_isSet;
}

bool OAIQueue::is_app_engine_http_queue_Valid() const{
    return m_app_engine_http_queue_isValid;
}
...
QString OAIQueue::getType() const {
    return m_type;
}
void OAIQueue::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}
