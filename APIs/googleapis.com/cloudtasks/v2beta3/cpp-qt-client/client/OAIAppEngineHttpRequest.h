...
public:
    ...
    QString getRelativeUri() const;
    void setRelativeUri(const QString &relative_uri);
    bool is_relative_uri_Set() const;
    bool is_relative_uri_Valid() const;
...
private:
    ...
    QString m_relative_uri;
    bool m_relative_uri_isSet;
    bool m_relative_uri_isValid;
};
