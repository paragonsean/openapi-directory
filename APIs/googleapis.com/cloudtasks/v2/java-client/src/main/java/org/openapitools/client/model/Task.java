...
public class Task {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(appEngineHttpRequest, createTime, dispatchCount, dispatchDeadline, firstAttempt, httpRequest, lastAttempt, name, responseCount, scheduleTime, view);
  }
