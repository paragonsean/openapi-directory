...
|**dispatchCount** | **Integer** | Output only. The number of attempts dispatched. This count includes attempts which have been dispatched but haven&#39;t received a response. |  [optional] |
...
|**responseCount** | **Integer** | Output only. The number of attempts which have received a response. |  [optional] |
...
|**view** | [**ViewEnum**](#ViewEnum) | Output only. The view specifies which subset of the Task has been returned. |  [optional] |
