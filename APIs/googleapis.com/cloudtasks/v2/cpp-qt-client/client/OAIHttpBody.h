...
#ifndef OAIHttpBody_H
#define OAIHttpBody_H
...
class OAIHttpBody : public OAIObject {
public:
    OAIHttpBody();
    OAIHttpBody(QString json);
    ~OAIHttpBody() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHttpBody)
