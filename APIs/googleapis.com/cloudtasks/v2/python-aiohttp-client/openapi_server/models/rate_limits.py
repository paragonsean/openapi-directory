...
class RateLimits(Model):
    ...
    def __init__(self, max_burst_size: int=None, max_concurrent_dispatches: int=None, max_dispatches_per_second: float=None):
        """RateLimits - a model defined in OpenAPI

        :param max_burst_size: The max_burst_size of this RateLimits.
        :param max_concurrent_dispatches: The max_concurrent_dispatches of this RateLimits.
        :param max_dispatches_per_second: The max_dispatches_per_second of this RateLimits.
        """
        self.openapi_types = {
            'max_burst_size': int,
        ...
        self._max_dispatches_per_second = max_dispatches_per_second
    ...
    @property
    def max_concurrent_dispatches(self):
        """Gets the max_concurrent_dispatches of this RateLimits.

        The maximum number of concurrent tasks that Cloud Tasks allows to be dispatched for this queue. After this threshold has been reached, Cloud Tasks stops dispatching tasks until the number of concurrent requests decreases. If unspecified when the queue is created, Cloud Tasks will pick the default. The maximum allowed value is 5,000. This field has the same meaning as [max_concurrent_requests in queue.yaml/xml](https://cloud.google.com/appengine/docs/standard/python/config/queueref#max_concurrent_requests).

        :return: The max_concurrent_dispatches of this RateLimits.
        :rtype: int
        """
        return self._max_concurrent_dispatches

    @max_concurrent_dispatches.setter
    def max_concurrent_dispatches(self, max_concurrent_dispatches):
        """Sets the max_concurrent_dispatches of this RateLimits.

        The maximum number of concurrent tasks that Cloud Tasks allows to be dispatched for this queue. After this threshold has been reached, Cloud Tasks stops dispatching tasks until the number of concurrent requests decreases. If unspecified when the queue is created, Cloud Tasks will pick the default. The maximum allowed value is 5,000. This field has the same meaning as [max_concurrent_requests in queue.yaml/xml](https://cloud.google.com/appengine/docs/standard/python/config/queueref#max_concurrent_requests).

        :param max_concurrent_dispatches: The max_concurrent_dispatches of this RateLimits.
        :type max_concurrent_dispatches: int
        """

        self._max_concurrent_dispatches = max_concurrent_dispatches

    @property
    def max_dispatches_per_second(self):
        """Gets the max_dispatches_per_second of this RateLimits.

        The maximum rate at which tasks are dispatched from this queue. If unspecified when the queue is created, Cloud Tasks will pick the default. * The maximum allowed value is 500. This field has the same meaning as [rate in queue.yaml/xml](https://cloud.google.com/appengine/docs/standard/python/config/queueref#rate).

        :return: The max_dispatches_per_second of this RateLimits.
        :rtype: float
        """
        return self._max_dispatches_per_second

    @max_dispatches_per_second.setter
    def max_dispatches_per_second(self, max_dispatches_per_second):
        """Sets the max_dispatches_per_second of this RateLimits.

        The maximum rate at which tasks are dispatched from this queue. If unspecified when the queue is created, Cloud Tasks will pick the default. * The maximum allowed value is 500. This field has the same meaning as [rate in queue.yaml/xml](https://cloud.google.com/appengine/docs/standard/python/config/queueref#rate).

        :param max_dispatches_per_second: The max_dispatches_per_second of this RateLimits.
        :type max_dispatches_per_second: float
        """
