...
public class AppEngineHttpRequest {
  ...
  public AppEngineHttpRequest payload(byte[] payload) {
  ...
  public AppEngineHttpRequest relativeUrl(String relativeUrl) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.appEngineRouting, appEngineHttpRequest.appEngineRouting) &&
        ...
        Arrays.equals(this.payload, appEngineHttpRequest.payload) &&
        Objects.equals(this.relativeUrl, appEngineHttpRequest.relativeUrl);
  }

  @Override
  public int hashCode() {
    return Objects.hash(appEngineRouting, headers, httpMethod, Arrays.hashCode(payload), relativeUrl);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("relativeUrl") != null && !jsonObj.get("relativeUrl").isJsonNull()) && !jsonObj.get("relativeUrl").isJsonPrimitive()) {
