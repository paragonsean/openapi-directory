...
public class CancelLeaseRequest {
  ...
  public CancelLeaseRequest responseView(ResponseViewEnum responseView) {
  ...
  public CancelLeaseRequest scheduleTime(String scheduleTime) {
  ...
  public boolean equals(Object o) {
    ...
    CancelLeaseRequest cancelLeaseRequest = (CancelLeaseRequest) o;
    return Objects.equals(this.responseView, cancelLeaseRequest.responseView) &&
        Objects.equals(this.scheduleTime, cancelLeaseRequest.scheduleTime);
  }

  @Override
  public int hashCode() {
    return Objects.hash(responseView, scheduleTime);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CancelLeaseRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CancelLeaseRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CancelLeaseRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CancelLeaseRequest is not found in the empty JSON string", CancelLeaseRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CancelLeaseRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CancelLeaseRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CancelLeaseRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CancelLeaseRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CancelLeaseRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CancelLeaseRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CancelLeaseRequest>() {
           @Override
           public void write(JsonWriter out, CancelLeaseRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CancelLeaseRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CancelLeaseRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CancelLeaseRequest
   * @throws IOException if the JSON string is invalid with respect to CancelLeaseRequest
   */
  public static CancelLeaseRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CancelLeaseRequest.class);
  }

  /**
   * Convert an instance of CancelLeaseRequest to an JSON string
   *
   * @return JSON string
   */
