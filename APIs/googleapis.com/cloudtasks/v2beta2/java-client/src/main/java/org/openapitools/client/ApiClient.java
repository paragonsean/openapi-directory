...
public class ApiClient {
    ...
    private String basePath = "https://cloudtasks.googleapis.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/v2beta2/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://cloudtasks.googleapis.com
