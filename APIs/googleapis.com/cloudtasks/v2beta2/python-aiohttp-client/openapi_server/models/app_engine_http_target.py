...
class AppEngineHttpTarget(Model):
    ...
    def __init__(self, app_engine_routing_override: AppEngineRouting=None):
        ...
        :param app_engine_routing_override: The app_engine_routing_override of this AppEngineHttpTarget.
        """
        self.openapi_types = {
    ...
    def app_engine_routing_override(self):
        """Gets the app_engine_routing_override of this AppEngineHttpTarget.


        :return: The app_engine_routing_override of this AppEngineHttpTarget.
    ...
    def app_engine_routing_override(self, app_engine_routing_override):
        """Sets the app_engine_routing_override of this AppEngineHttpTarget.
