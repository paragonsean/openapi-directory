...
class RetryConfig {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('unlimitedAttempts')) {
                obj['unlimitedAttempts'] = ApiClient.convertToType(data['unlimitedAttempts'], 'Boolean');
            }
        }
        return obj;
    }
 ...
 * @member {Boolean} unlimitedAttempts
 */
RetryConfig.prototype['unlimitedAttempts'] = undefined;
