...
class Queue {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('pullTarget')) {
                obj['pullTarget'] = ApiClient.convertToType(data['pullTarget'], Object);
            }
 ...
 */
Queue.prototype['appEngineHttpTarget'] = undefined;
...
/**
 * Pull target.
 * @member {Object} pullTarget
 */
Queue.prototype['pullTarget'] = undefined;
