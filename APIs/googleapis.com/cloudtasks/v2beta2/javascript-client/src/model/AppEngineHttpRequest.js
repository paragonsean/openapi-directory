...
class AppEngineHttpRequest {
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['relativeUrl'] && !(typeof data['relativeUrl'] === 'string' || data['relativeUrl'] instanceof String)) {
            throw new Error("Expected the field `relativeUrl` to be a primitive type in the JSON string but got " + data['relativeUrl']);
        }
 ...
 * @member {Blob} payload
 */
AppEngineHttpRequest.prototype['payload'] = undefined;
 ...
 */
AppEngineHttpRequest.prototype['relativeUrl'] = undefined;
