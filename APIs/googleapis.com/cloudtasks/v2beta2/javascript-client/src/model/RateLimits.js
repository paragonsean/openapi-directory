...
class RateLimits {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('maxConcurrentTasks')) {
                obj['maxConcurrentTasks'] = ApiClient.convertToType(data['maxConcurrentTasks'], 'Number');
            }
            if (data.hasOwnProperty('maxTasksDispatchedPerSecond')) {
                obj['maxTasksDispatchedPerSecond'] = ApiClient.convertToType(data['maxTasksDispatchedPerSecond'], 'Number');
            }
        }
        return obj;
    }
 ...
 */
RateLimits.prototype['maxConcurrentTasks'] = undefined;
 ...
 */
RateLimits.prototype['maxTasksDispatchedPerSecond'] = undefined;
