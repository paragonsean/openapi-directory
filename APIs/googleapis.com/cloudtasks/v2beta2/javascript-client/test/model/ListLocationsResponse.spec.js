...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudTasksApi.ListLocationsResponse();
  });
  ...
  describe('ListLocationsResponse', function() {
    it('should create an instance of ListLocationsResponse', function() {
      ...
      //var instance = new CloudTasksApi.ListLocationsResponse();
      //expect(instance).to.be.a(CloudTasksApi.ListLocationsResponse);
    });
