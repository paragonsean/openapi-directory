...
void OAIApiApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("cloudtasks_api_queue_update", defaultConf);
    _serverIndices.insert("cloudtasks_api_queue_update", 0);
}
...
void OAIApiApi::cloudtasks_api_queue_update(const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<QString> &app_id, const ::OpenAPI::OptionalParam<OAIHttpBody> &oai_http_body) {
    QString fullPath = QString(_serverConfigs["cloudtasks_api_queue_update"][_serverIndices.value("cloudtasks_api_queue_update")].URL()+"/api/queue/update");
    ...
    if (oai_http_body.hasValue()){

        
        QByteArray output = oai_http_body.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIApiApi::cloudtasks_api_queue_updateCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIApiApi::cloudtasks_api_queue_updateCallback);
...
void OAIApiApi::cloudtasks_api_queue_updateCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT cloudtasks_api_queue_updateSignal(output);
        Q_EMIT cloudtasks_api_queue_updateSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT cloudtasks_api_queue_updateSignalE(output, error_type, error_str);
        Q_EMIT cloudtasks_api_queue_updateSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT cloudtasks_api_queue_updateSignalError(output, error_type, error_str);
        Q_EMIT cloudtasks_api_queue_updateSignalErrorFull(worker, error_type, error_str);
    }
}
