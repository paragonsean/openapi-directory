...
void OAIRetryConfig::initializeModel() {
    ...
    m_unlimited_attempts_isSet = false;
    m_unlimited_attempts_isValid = false;
}
...
void OAIRetryConfig::fromJsonObject(QJsonObject json) {
    ...
    m_unlimited_attempts_isValid = ::OpenAPI::fromJsonValue(m_unlimited_attempts, json[QString("unlimitedAttempts")]);
    m_unlimited_attempts_isSet = !json[QString("unlimitedAttempts")].isNull() && m_unlimited_attempts_isValid;
}
...
QJsonObject OAIRetryConfig::asJsonObject() const {
    ...
    if (m_unlimited_attempts_isSet) {
        obj.insert(QString("unlimitedAttempts"), ::OpenAPI::toJsonValue(m_unlimited_attempts));
    }
    return obj;
}
...
bool OAIRetryConfig::isUnlimitedAttempts() const {
    return m_unlimited_attempts;
}
void OAIRetryConfig::setUnlimitedAttempts(const bool &unlimited_attempts) {
    m_unlimited_attempts = unlimited_attempts;
    m_unlimited_attempts_isSet = true;
}

bool OAIRetryConfig::is_unlimited_attempts_Set() const{
    return m_unlimited_attempts_isSet;
}

bool OAIRetryConfig::is_unlimited_attempts_Valid() const{
    return m_unlimited_attempts_isValid;
}
