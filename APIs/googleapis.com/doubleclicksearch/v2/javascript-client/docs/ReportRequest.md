...
**maxRowsPerFile** | **Number** | Asynchronous report only. The maximum number of rows per report file. A large report is split into many files based on this field. Acceptable values are &#x60;1000000&#x60; to &#x60;100000000&#x60;, inclusive. | [optional] 
**orderBy** | [**[ReportRequestOrderByInner]**](ReportRequestOrderByInner.md) | Synchronous report only. A list of columns and directions defining sorting to be performed on the report rows.\\ The maximum number of orderings per request is 300. | [optional] 
...
**rowCount** | **Number** | Synchronous report only. The maximum number of rows to return; additional rows are dropped. Acceptable values are &#x60;0&#x60; to &#x60;10000&#x60;, inclusive. Defaults to &#x60;10000&#x60;. | [optional] 
**startRow** | **Number** | Synchronous report only. Zero-based index of the first row to return. Acceptable values are &#x60;0&#x60; to &#x60;50000&#x60;, inclusive. Defaults to &#x60;0&#x60;. | [optional] 
