...
**availabilityTimestamp** | **String** | The time by which all conversions have been uploaded, in epoch millis UTC. | [optional] 
...
**segmentationType** | **String** | The segmentation type that this availability is for (its default value is &#x60;FLOODLIGHT&#x60;). | [optional] 
