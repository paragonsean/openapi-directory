...
/**
 * The GoogleApiServiceusageV1ServiceConfig model module.
 * @module model/GoogleApiServiceusageV1ServiceConfig
 * @version v1
 */
class GoogleApiServiceusageV1ServiceConfig {
    /**
     * Constructs a new <code>GoogleApiServiceusageV1ServiceConfig</code>.
     * The configuration of the service.
     * @alias module:model/GoogleApiServiceusageV1ServiceConfig
     */
    constructor() { 
        
        GoogleApiServiceusageV1ServiceConfig.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleApiServiceusageV1ServiceConfig</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleApiServiceusageV1ServiceConfig} obj Optional instance to populate.
     * @return {module:model/GoogleApiServiceusageV1ServiceConfig} The populated <code>GoogleApiServiceusageV1ServiceConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleApiServiceusageV1ServiceConfig();
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleApiServiceusageV1ServiceConfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleApiServiceusageV1ServiceConfig</code>.
     */
 ...
 */
GoogleApiServiceusageV1ServiceConfig.prototype['apis'] = undefined;

/**
 * @member {module:model/Authentication} authentication
 */
GoogleApiServiceusageV1ServiceConfig.prototype['authentication'] = undefined;

/**
 * @member {module:model/Documentation} documentation
 */
GoogleApiServiceusageV1ServiceConfig.prototype['documentation'] = undefined;

/**
 * Configuration for network endpoints. Contains only the names and aliases of the endpoints.
 * @member {Array.<module:model/Endpoint>} endpoints
 */
GoogleApiServiceusageV1ServiceConfig.prototype['endpoints'] = undefined;

/**
 * Defines the monitored resources used by this service. This is required by the Service.monitoring and Service.logging configurations.
 * @member {Array.<module:model/MonitoredResourceDescriptor>} monitoredResources
 */
GoogleApiServiceusageV1ServiceConfig.prototype['monitoredResources'] = undefined;

/**
 * @member {module:model/Monitoring} monitoring
 */
GoogleApiServiceusageV1ServiceConfig.prototype['monitoring'] = undefined;

/**
 * The DNS address at which this service is available. An example DNS address would be: `calendar.googleapis.com`.
 * @member {String} name
 */
GoogleApiServiceusageV1ServiceConfig.prototype['name'] = undefined;

/**
 * @member {module:model/Quota} quota
 */
GoogleApiServiceusageV1ServiceConfig.prototype['quota'] = undefined;

/**
 * The product title for this service.
 * @member {String} title
 */
GoogleApiServiceusageV1ServiceConfig.prototype['title'] = undefined;

/**
 * @member {module:model/Usage} usage
 */
GoogleApiServiceusageV1ServiceConfig.prototype['usage'] = undefined;
...
export default GoogleApiServiceusageV1ServiceConfig;
