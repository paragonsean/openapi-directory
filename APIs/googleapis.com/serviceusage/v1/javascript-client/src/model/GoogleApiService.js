...
/**
 * The GoogleApiService model module.
 * @module model/GoogleApiService
 * @version v1
 */
class GoogleApiService {
    /**
     * Constructs a new <code>GoogleApiService</code>.
     ...
     * @alias module:model/GoogleApiService
     */
    constructor() { 
        
        GoogleApiService.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleApiService</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleApiService} obj Optional instance to populate.
     * @return {module:model/GoogleApiService} The populated <code>GoogleApiService</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleApiService();
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleApiService</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleApiService</code>.
     */
