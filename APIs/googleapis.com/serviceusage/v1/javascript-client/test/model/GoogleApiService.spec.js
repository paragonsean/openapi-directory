...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceUsageApi.GoogleApiService();
  });
  ...
  describe('GoogleApiService', function() {
    it('should create an instance of GoogleApiService', function() {
      // uncomment below and update the code to test GoogleApiService
      //var instance = new ServiceUsageApi.GoogleApiService();
      //expect(instance).to.be.a(ServiceUsageApi.GoogleApiService);
    });
