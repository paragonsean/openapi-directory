...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceUsageApi.BillingDestination();
  });
  ...
  describe('BillingDestination', function() {
    it('should create an instance of BillingDestination', function() {
      ...
      //var instance = new ServiceUsageApi.BillingDestination();
      //expect(instance).to.be.a(ServiceUsageApi.BillingDestination);
    });
