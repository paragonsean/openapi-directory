...
public class GoogleApiService {
  ...
  public GoogleApiService apis(List<Api> apis) {
    this.apis = apis;
    return this;
  }

  public GoogleApiService addApisItem(Api apisItem) {
    if (this.apis == null) {
  ...
  public GoogleApiService authentication(Authentication authentication) {
  ...
  public GoogleApiService backend(Backend backend) {
  ...
  public GoogleApiService billing(Billing billing) {
  ...
  public GoogleApiService configVersion(Integer configVersion) {
  ...
  public GoogleApiService context(Context context) {
  ...
  public GoogleApiService control(Control control) {
  ...
  public GoogleApiService customError(CustomError customError) {
  ...
  public GoogleApiService documentation(Documentation documentation) {
  ...
  public GoogleApiService endpoints(List<Endpoint> endpoints) {
    this.endpoints = endpoints;
    return this;
  }

  public GoogleApiService addEndpointsItem(Endpoint endpointsItem) {
  ...
  public GoogleApiService enums(List<ModelEnum> enums) {
    this.enums = enums;
    return this;
  }

  public GoogleApiService addEnumsItem(ModelEnum enumsItem) {
    if (this.enums == null) {
  ...
  public GoogleApiService http(Http http) {
    this.http = http;
    return this;
  }
  ...
  public GoogleApiService id(String id) {
    this.id = id;
    return this;
  }
  ...
  public GoogleApiService logging(Logging logging) {
  ...
  public GoogleApiService logs(List<LogDescriptor> logs) {
    this.logs = logs;
    return this;
  }

  public GoogleApiService addLogsItem(LogDescriptor logsItem) {
    if (this.logs == null) {
  ...
  public GoogleApiService metrics(List<MetricDescriptor> metrics) {
    this.metrics = metrics;
    return this;
  }

  public GoogleApiService addMetricsItem(MetricDescriptor metricsItem) {
  ...
  public GoogleApiService monitoredResources(List<MonitoredResourceDescriptor> monitoredResources) {
    this.monitoredResources = monitoredResources;
    return this;
  }

  public GoogleApiService addMonitoredResourcesItem(MonitoredResourceDescriptor monitoredResourcesItem) {
  ...
  public GoogleApiService monitoring(Monitoring monitoring) {
  ...
  public GoogleApiService name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GoogleApiService producerProjectId(String producerProjectId) {
  ...
  public GoogleApiService publishing(Publishing publishing) {
  ...
  public GoogleApiService quota(Quota quota) {
    this.quota = quota;
    return this;
  }
  ...
  public GoogleApiService sourceInfo(SourceInfo sourceInfo) {
  ...
  public GoogleApiService systemParameters(SystemParameters systemParameters) {
  ...
  public GoogleApiService systemTypes(List<Type> systemTypes) {
    this.systemTypes = systemTypes;
    return this;
  }

  public GoogleApiService addSystemTypesItem(Type systemTypesItem) {
  ...
  public GoogleApiService title(String title) {
    this.title = title;
    return this;
  }
  ...
  public GoogleApiService types(List<Type> types) {
    this.types = types;
    return this;
  }

  public GoogleApiService addTypesItem(Type typesItem) {
    if (this.types == null) {
  ...
  public GoogleApiService usage(Usage usage) {
    this.usage = usage;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GoogleApiService googleApiService = (GoogleApiService) o;
    return Objects.equals(this.apis, googleApiService.apis) &&
        Objects.equals(this.authentication, googleApiService.authentication) &&
        Objects.equals(this.backend, googleApiService.backend) &&
        Objects.equals(this.billing, googleApiService.billing) &&
        Objects.equals(this.configVersion, googleApiService.configVersion) &&
        Objects.equals(this.context, googleApiService.context) &&
        Objects.equals(this.control, googleApiService.control) &&
        Objects.equals(this.customError, googleApiService.customError) &&
        Objects.equals(this.documentation, googleApiService.documentation) &&
        Objects.equals(this.endpoints, googleApiService.endpoints) &&
        Objects.equals(this.enums, googleApiService.enums) &&
        Objects.equals(this.http, googleApiService.http) &&
        Objects.equals(this.id, googleApiService.id) &&
        Objects.equals(this.logging, googleApiService.logging) &&
        Objects.equals(this.logs, googleApiService.logs) &&
        Objects.equals(this.metrics, googleApiService.metrics) &&
        Objects.equals(this.monitoredResources, googleApiService.monitoredResources) &&
        Objects.equals(this.monitoring, googleApiService.monitoring) &&
        Objects.equals(this.name, googleApiService.name) &&
        Objects.equals(this.producerProjectId, googleApiService.producerProjectId) &&
        Objects.equals(this.publishing, googleApiService.publishing) &&
        Objects.equals(this.quota, googleApiService.quota) &&
        Objects.equals(this.sourceInfo, googleApiService.sourceInfo) &&
        Objects.equals(this.systemParameters, googleApiService.systemParameters) &&
        Objects.equals(this.systemTypes, googleApiService.systemTypes) &&
        Objects.equals(this.title, googleApiService.title) &&
        Objects.equals(this.types, googleApiService.types) &&
        Objects.equals(this.usage, googleApiService.usage);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleApiService {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleApiService
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleApiService.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleApiService is not found in the empty JSON string", GoogleApiService.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleApiService.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleApiService` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleApiService.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleApiService' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleApiService> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleApiService.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleApiService>() {
           @Override
           public void write(JsonWriter out, GoogleApiService value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleApiService read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleApiService given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleApiService
   * @throws IOException if the JSON string is invalid with respect to GoogleApiService
   */
  public static GoogleApiService fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleApiService.class);
  }

  /**
   * Convert an instance of GoogleApiService to an JSON string
   *
   * @return JSON string
   */
