...
|------------- | ------------- | -------------|
| [**serviceusageServicesBatchEnable**](ServicesApi.md#serviceusageServicesBatchEnable) | **POST** /v1/{parent}/services:batchEnable |  |
| [**serviceusageServicesBatchGet**](ServicesApi.md#serviceusageServicesBatchGet) | **GET** /v1/{parent}/services:batchGet |  |
| [**serviceusageServicesDisable**](ServicesApi.md#serviceusageServicesDisable) | **POST** /v1/{name}:disable |  |
| [**serviceusageServicesEnable**](ServicesApi.md#serviceusageServicesEnable) | **POST** /v1/{name}:enable |  |
| [**serviceusageServicesGet**](ServicesApi.md#serviceusageServicesGet) | **GET** /v1/{name} |  |
| [**serviceusageServicesList**](ServicesApi.md#serviceusageServicesList) | **GET** /v1/{parent}/services |  |
...
public class Example {
  public static void main(String[] args) {
    ...
    String parent = "parent_example"; // String | Parent to enable services on. An example name would be: `projects/123` where `123` is the project number. The `BatchEnableServices` method currently only supports projects.
...
<a id="serviceusageServicesBatchGet"></a>
# **serviceusageServicesBatchGet**
> BatchGetServicesResponse serviceusageServicesBatchGet(parent, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, names)
...
public class Example {
  public static void main(String[] args) {
    ...
    ServicesApi apiInstance = new ServicesApi(defaultClient);
    String parent = "parent_example"; // String | Parent to retrieve services from. If this is set, the parent of all of the services specified in `names` must match this field. An example name would be: `projects/123` where `123` is the project number. The `BatchGetServices` method currently only supports projects.
    String $xgafv = "1"; // String | V1 error format.
    String accessToken = "accessToken_example"; // String | OAuth access token.
    String alt = "json"; // String | Data format for response.
    String paramCallback = "paramCallback_example"; // String | JSONP
    ...
    String uploadProtocol = "uploadProtocol_example"; // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
    String uploadType = "uploadType_example"; // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
    List<String> names = Arrays.asList(); // List<String> | Names of the services to retrieve. An example name would be: `projects/123/services/serviceusage.googleapis.com` where `123` is the project number. A single request can get a maximum of 30 services at a time.
    try {
      BatchGetServicesResponse result = apiInstance.serviceusageServicesBatchGet(parent, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, names);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ServicesApi#serviceusageServicesBatchGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| **uploadProtocol** | **String**| Upload protocol for media (e.g. \&quot;raw\&quot;, \&quot;multipart\&quot;). | [optional] |
| **uploadType** | **String**| Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;). | [optional] |
| **names** | [**List&lt;String&gt;**](String.md)| Names of the services to retrieve. An example name would be: &#x60;projects/123/services/serviceusage.googleapis.com&#x60; where &#x60;123&#x60; is the project number. A single request can get a maximum of 30 services at a time. | [optional] |

### Return type

[**BatchGetServicesResponse**](BatchGetServicesResponse.md)
...
> Operation serviceusageServicesDisable(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, disableServiceRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    ServicesApi apiInstance = new ServicesApi(defaultClient);
    String name = "name_example"; // String | Name of the consumer and service to disable the service on. The enable and disable methods currently only support projects. An example name would be: `projects/123/services/serviceusage.googleapis.com` where `123` is the project number.
    String $xgafv = "1"; // String | V1 error format.
    String accessToken = "accessToken_example"; // String | OAuth access token.
    String alt = "json"; // String | Data format for response.
    String paramCallback = "paramCallback_example"; // String | JSONP
    ...
    String uploadProtocol = "uploadProtocol_example"; // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
    String uploadType = "uploadType_example"; // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
    DisableServiceRequest disableServiceRequest = new DisableServiceRequest(); // DisableServiceRequest | 
    try {
      Operation result = apiInstance.serviceusageServicesDisable(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, disableServiceRequest);
      System.out.println(result);
    } catch (ApiException e) {
...
| **uploadProtocol** | **String**| Upload protocol for media (e.g. \&quot;raw\&quot;, \&quot;multipart\&quot;). | [optional] |
| **uploadType** | **String**| Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;). | [optional] |
| **disableServiceRequest** | [**DisableServiceRequest**](DisableServiceRequest.md)|  | [optional] |
...
<a id="serviceusageServicesGet"></a>
# **serviceusageServicesGet**
> GoogleApiServiceusageV1Service serviceusageServicesGet(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType)
...
public class Example {
  public static void main(String[] args) {
    ...
    ServicesApi apiInstance = new ServicesApi(defaultClient);
    String name = "name_example"; // String | Name of the consumer and service to get the `ConsumerState` for. An example name would be: `projects/123/services/serviceusage.googleapis.com` where `123` is the project number.
    String $xgafv = "1"; // String | V1 error format.
    String accessToken = "accessToken_example"; // String | OAuth access token.
    String alt = "json"; // String | Data format for response.
    String paramCallback = "paramCallback_example"; // String | JSONP
    ...
    String uploadType = "uploadType_example"; // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
    try {
      GoogleApiServiceusageV1Service result = apiInstance.serviceusageServicesGet(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ServicesApi#serviceusageServicesGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
[**GoogleApiServiceusageV1Service**](GoogleApiServiceusageV1Service.md)
...
public class Example {
  public static void main(String[] args) {
    ...
    ServicesApi apiInstance = new ServicesApi(defaultClient);
    String parent = "parent_example"; // String | Parent to search for services on. An example name would be: `projects/123` where `123` is the project number.
    String $xgafv = "1"; // String | V1 error format.
    String accessToken = "accessToken_example"; // String | OAuth access token.
    String alt = "json"; // String | Data format for response.
    String paramCallback = "paramCallback_example"; // String | JSONP
