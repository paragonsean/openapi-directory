...
QList<OAIGoogleApiServiceusageV1Service> OAIListServicesResponse::getServices() const {
    return m_services;
}
void OAIListServicesResponse::setServices(const QList<OAIGoogleApiServiceusageV1Service> &services) {
    m_services = services;
