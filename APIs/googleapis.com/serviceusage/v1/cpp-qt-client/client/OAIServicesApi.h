...
public:
    ...
    */
    virtual void serviceusage_services_batchGet(const QString &parent, const ::OpenAPI::OptionalParam<QString> &_xgafv = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &access_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &alt = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &callback = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &fields = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &key = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &oauth_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &pretty_print = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &quota_user = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &upload_protocol = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &upload_type = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QList<QString>> &names = ::OpenAPI::OptionalParam<QList<QString>>());
    ...
    * @param[in]  upload_type QString [optional]
    */
    virtual void serviceusage_services_get(const QString &name, const ::OpenAPI::OptionalParam<QString> &_xgafv = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &access_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &alt = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &callback = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &fields = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &key = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &oauth_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &pretty_print = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &quota_user = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &upload_protocol = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &upload_type = ::OpenAPI::OptionalParam<QString>());
...
private:
    ...
    void serviceusage_services_batchGetCallback(OAIHttpRequestWorker *worker);
    ...
    void serviceusage_services_getCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void serviceusage_services_batchGetSignal(OAIBatchGetServicesResponse summary);
    ...
    void serviceusage_services_getSignal(OAIGoogleApiServiceusageV1Service summary);
    ...
    void serviceusage_services_batchGetSignalFull(OAIHttpRequestWorker *worker, OAIBatchGetServicesResponse summary);
    ...
    void serviceusage_services_getSignalFull(OAIHttpRequestWorker *worker, OAIGoogleApiServiceusageV1Service summary);
    ...
    Q_DECL_DEPRECATED_X("Use serviceusage_services_batchGetSignalError() instead")
    void serviceusage_services_batchGetSignalE(OAIBatchGetServicesResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void serviceusage_services_batchGetSignalError(OAIBatchGetServicesResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use serviceusage_services_getSignalError() instead")
    void serviceusage_services_getSignalE(OAIGoogleApiServiceusageV1Service summary, QNetworkReply::NetworkError error_type, QString error_str);
    void serviceusage_services_getSignalError(OAIGoogleApiServiceusageV1Service summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use serviceusage_services_batchGetSignalErrorFull() instead")
    void serviceusage_services_batchGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void serviceusage_services_batchGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use serviceusage_services_getSignalErrorFull() instead")
    void serviceusage_services_getSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void serviceusage_services_getSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
