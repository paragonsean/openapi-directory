...
OAIGoogleApiService::OAIGoogleApiService(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGoogleApiService::OAIGoogleApiService() {
    this->initializeModel();
}

OAIGoogleApiService::~OAIGoogleApiService() {}

void OAIGoogleApiService::initializeModel() {
...
void OAIGoogleApiService::fromJson(QString jsonString) {
...
void OAIGoogleApiService::fromJsonObject(QJsonObject json) {
...
QString OAIGoogleApiService::asJson() const {
...
QJsonObject OAIGoogleApiService::asJsonObject() const {
    QJsonObject obj;
    if (m_apis.size() > 0) {
...
QList<OAIApi> OAIGoogleApiService::getApis() const {
    return m_apis;
}
void OAIGoogleApiService::setApis(const QList<OAIApi> &apis) {
    m_apis = apis;
    m_apis_isSet = true;
}

bool OAIGoogleApiService::is_apis_Set() const{
    return m_apis_isSet;
}

bool OAIGoogleApiService::is_apis_Valid() const{
    return m_apis_isValid;
}

OAIAuthentication OAIGoogleApiService::getAuthentication() const {
    return m_authentication;
}
void OAIGoogleApiService::setAuthentication(const OAIAuthentication &authentication) {
    m_authentication = authentication;
    m_authentication_isSet = true;
}

bool OAIGoogleApiService::is_authentication_Set() const{
    return m_authentication_isSet;
}

bool OAIGoogleApiService::is_authentication_Valid() const{
    return m_authentication_isValid;
}

OAIBackend OAIGoogleApiService::getBackend() const {
    return m_backend;
}
void OAIGoogleApiService::setBackend(const OAIBackend &backend) {
    m_backend = backend;
    m_backend_isSet = true;
}

bool OAIGoogleApiService::is_backend_Set() const{
    return m_backend_isSet;
}

bool OAIGoogleApiService::is_backend_Valid() const{
    return m_backend_isValid;
}

OAIBilling OAIGoogleApiService::getBilling() const {
    return m_billing;
}
void OAIGoogleApiService::setBilling(const OAIBilling &billing) {
    m_billing = billing;
    m_billing_isSet = true;
}

bool OAIGoogleApiService::is_billing_Set() const{
    return m_billing_isSet;
}

bool OAIGoogleApiService::is_billing_Valid() const{
    return m_billing_isValid;
}

qint32 OAIGoogleApiService::getConfigVersion() const {
    return m_config_version;
}
void OAIGoogleApiService::setConfigVersion(const qint32 &config_version) {
    m_config_version = config_version;
    m_config_version_isSet = true;
}

bool OAIGoogleApiService::is_config_version_Set() const{
    return m_config_version_isSet;
}

bool OAIGoogleApiService::is_config_version_Valid() const{
    return m_config_version_isValid;
}

OAIContext OAIGoogleApiService::getContext() const {
    return m_context;
}
void OAIGoogleApiService::setContext(const OAIContext &context) {
    m_context = context;
    m_context_isSet = true;
}

bool OAIGoogleApiService::is_context_Set() const{
    return m_context_isSet;
}

bool OAIGoogleApiService::is_context_Valid() const{
    return m_context_isValid;
}

OAIControl OAIGoogleApiService::getControl() const {
    return m_control;
}
void OAIGoogleApiService::setControl(const OAIControl &control) {
    m_control = control;
    m_control_isSet = true;
}

bool OAIGoogleApiService::is_control_Set() const{
    return m_control_isSet;
}

bool OAIGoogleApiService::is_control_Valid() const{
    return m_control_isValid;
}

OAICustomError OAIGoogleApiService::getCustomError() const {
    return m_custom_error;
}
void OAIGoogleApiService::setCustomError(const OAICustomError &custom_error) {
    m_custom_error = custom_error;
    m_custom_error_isSet = true;
}

bool OAIGoogleApiService::is_custom_error_Set() const{
    return m_custom_error_isSet;
}

bool OAIGoogleApiService::is_custom_error_Valid() const{
    return m_custom_error_isValid;
}

OAIDocumentation OAIGoogleApiService::getDocumentation() const {
    return m_documentation;
}
void OAIGoogleApiService::setDocumentation(const OAIDocumentation &documentation) {
    m_documentation = documentation;
    m_documentation_isSet = true;
}

bool OAIGoogleApiService::is_documentation_Set() const{
    return m_documentation_isSet;
}

bool OAIGoogleApiService::is_documentation_Valid() const{
    return m_documentation_isValid;
}

QList<OAIEndpoint> OAIGoogleApiService::getEndpoints() const {
    return m_endpoints;
}
void OAIGoogleApiService::setEndpoints(const QList<OAIEndpoint> &endpoints) {
    m_endpoints = endpoints;
    m_endpoints_isSet = true;
}

bool OAIGoogleApiService::is_endpoints_Set() const{
    return m_endpoints_isSet;
}

bool OAIGoogleApiService::is_endpoints_Valid() const{
    return m_endpoints_isValid;
}

QList<OAIEnum> OAIGoogleApiService::getEnums() const {
    return m_enums;
}
void OAIGoogleApiService::setEnums(const QList<OAIEnum> &enums) {
    m_enums = enums;
    m_enums_isSet = true;
}

bool OAIGoogleApiService::is_enums_Set() const{
    return m_enums_isSet;
}

bool OAIGoogleApiService::is_enums_Valid() const{
    return m_enums_isValid;
}

OAIHttp OAIGoogleApiService::getHttp() const {
    return m_http;
}
void OAIGoogleApiService::setHttp(const OAIHttp &http) {
    m_http = http;
    m_http_isSet = true;
}

bool OAIGoogleApiService::is_http_Set() const{
    return m_http_isSet;
}

bool OAIGoogleApiService::is_http_Valid() const{
    return m_http_isValid;
}

QString OAIGoogleApiService::getId() const {
    return m_id;
}
void OAIGoogleApiService::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIGoogleApiService::is_id_Set() const{
    return m_id_isSet;
}

bool OAIGoogleApiService::is_id_Valid() const{
    return m_id_isValid;
}

OAILogging OAIGoogleApiService::getLogging() const {
    return m_logging;
}
void OAIGoogleApiService::setLogging(const OAILogging &logging) {
    m_logging = logging;
    m_logging_isSet = true;
}

bool OAIGoogleApiService::is_logging_Set() const{
    return m_logging_isSet;
}

bool OAIGoogleApiService::is_logging_Valid() const{
    return m_logging_isValid;
}

QList<OAILogDescriptor> OAIGoogleApiService::getLogs() const {
    return m_logs;
}
void OAIGoogleApiService::setLogs(const QList<OAILogDescriptor> &logs) {
    m_logs = logs;
    m_logs_isSet = true;
}

bool OAIGoogleApiService::is_logs_Set() const{
    return m_logs_isSet;
}

bool OAIGoogleApiService::is_logs_Valid() const{
    return m_logs_isValid;
}

QList<OAIMetricDescriptor> OAIGoogleApiService::getMetrics() const {
    return m_metrics;
}
void OAIGoogleApiService::setMetrics(const QList<OAIMetricDescriptor> &metrics) {
    m_metrics = metrics;
    m_metrics_isSet = true;
}

bool OAIGoogleApiService::is_metrics_Set() const{
    return m_metrics_isSet;
}

bool OAIGoogleApiService::is_metrics_Valid() const{
    return m_metrics_isValid;
}

QList<OAIMonitoredResourceDescriptor> OAIGoogleApiService::getMonitoredResources() const {
    return m_monitored_resources;
}
void OAIGoogleApiService::setMonitoredResources(const QList<OAIMonitoredResourceDescriptor> &monitored_resources) {
    m_monitored_resources = monitored_resources;
    m_monitored_resources_isSet = true;
}

bool OAIGoogleApiService::is_monitored_resources_Set() const{
    return m_monitored_resources_isSet;
}

bool OAIGoogleApiService::is_monitored_resources_Valid() const{
    return m_monitored_resources_isValid;
}

OAIMonitoring OAIGoogleApiService::getMonitoring() const {
    return m_monitoring;
}
void OAIGoogleApiService::setMonitoring(const OAIMonitoring &monitoring) {
    m_monitoring = monitoring;
    m_monitoring_isSet = true;
}

bool OAIGoogleApiService::is_monitoring_Set() const{
    return m_monitoring_isSet;
}

bool OAIGoogleApiService::is_monitoring_Valid() const{
    return m_monitoring_isValid;
}

QString OAIGoogleApiService::getName() const {
    return m_name;
}
void OAIGoogleApiService::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIGoogleApiService::is_name_Set() const{
    return m_name_isSet;
}

bool OAIGoogleApiService::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIGoogleApiService::getProducerProjectId() const {
    return m_producer_project_id;
}
void OAIGoogleApiService::setProducerProjectId(const QString &producer_project_id) {
    m_producer_project_id = producer_project_id;
    m_producer_project_id_isSet = true;
}

bool OAIGoogleApiService::is_producer_project_id_Set() const{
    return m_producer_project_id_isSet;
}

bool OAIGoogleApiService::is_producer_project_id_Valid() const{
    return m_producer_project_id_isValid;
}

OAIPublishing OAIGoogleApiService::getPublishing() const {
    return m_publishing;
}
void OAIGoogleApiService::setPublishing(const OAIPublishing &publishing) {
    m_publishing = publishing;
    m_publishing_isSet = true;
}

bool OAIGoogleApiService::is_publishing_Set() const{
    return m_publishing_isSet;
}

bool OAIGoogleApiService::is_publishing_Valid() const{
    return m_publishing_isValid;
}

OAIQuota OAIGoogleApiService::getQuota() const {
    return m_quota;
}
void OAIGoogleApiService::setQuota(const OAIQuota &quota) {
    m_quota = quota;
    m_quota_isSet = true;
}

bool OAIGoogleApiService::is_quota_Set() const{
    return m_quota_isSet;
}

bool OAIGoogleApiService::is_quota_Valid() const{
    return m_quota_isValid;
}

OAISourceInfo OAIGoogleApiService::getSourceInfo() const {
    return m_source_info;
}
void OAIGoogleApiService::setSourceInfo(const OAISourceInfo &source_info) {
    m_source_info = source_info;
    m_source_info_isSet = true;
}

bool OAIGoogleApiService::is_source_info_Set() const{
    return m_source_info_isSet;
}

bool OAIGoogleApiService::is_source_info_Valid() const{
    return m_source_info_isValid;
}

OAISystemParameters OAIGoogleApiService::getSystemParameters() const {
    return m_system_parameters;
}
void OAIGoogleApiService::setSystemParameters(const OAISystemParameters &system_parameters) {
    m_system_parameters = system_parameters;
    m_system_parameters_isSet = true;
}

bool OAIGoogleApiService::is_system_parameters_Set() const{
    return m_system_parameters_isSet;
}

bool OAIGoogleApiService::is_system_parameters_Valid() const{
    return m_system_parameters_isValid;
}

QList<OAIType> OAIGoogleApiService::getSystemTypes() const {
    return m_system_types;
}
void OAIGoogleApiService::setSystemTypes(const QList<OAIType> &system_types) {
    m_system_types = system_types;
    m_system_types_isSet = true;
}

bool OAIGoogleApiService::is_system_types_Set() const{
    return m_system_types_isSet;
}

bool OAIGoogleApiService::is_system_types_Valid() const{
    return m_system_types_isValid;
}

QString OAIGoogleApiService::getTitle() const {
    return m_title;
}
void OAIGoogleApiService::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAIGoogleApiService::is_title_Set() const{
    return m_title_isSet;
}

bool OAIGoogleApiService::is_title_Valid() const{
    return m_title_isValid;
}

QList<OAIType> OAIGoogleApiService::getTypes() const {
    return m_types;
}
void OAIGoogleApiService::setTypes(const QList<OAIType> &types) {
    m_types = types;
    m_types_isSet = true;
}

bool OAIGoogleApiService::is_types_Set() const{
    return m_types_isSet;
}

bool OAIGoogleApiService::is_types_Valid() const{
    return m_types_isValid;
}

OAIUsage OAIGoogleApiService::getUsage() const {
    return m_usage;
}
void OAIGoogleApiService::setUsage(const OAIUsage &usage) {
    m_usage = usage;
    m_usage_isSet = true;
}

bool OAIGoogleApiService::is_usage_Set() const{
    return m_usage_isSet;
}

bool OAIGoogleApiService::is_usage_Valid() const{
    return m_usage_isValid;
}

bool OAIGoogleApiService::isSet() const {
...
bool OAIGoogleApiService::isValid() const {
