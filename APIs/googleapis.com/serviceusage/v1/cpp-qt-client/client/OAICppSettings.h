...
#ifndef OAICppSettings_H
#define OAICppSettings_H
...
class OAICppSettings : public OAIObject {
public:
    OAICppSettings();
    OAICppSettings(QString json);
    ~OAICppSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICppSettings)

#endif // OAICppSettings_H
