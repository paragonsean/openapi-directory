...
public class Service {
  ...
  public Service config(ServiceConfig config) {
    this.config = config;
    return this;
  }
  ...
  public Service parent(String parent) {
    this.parent = parent;
    return this;
  }
  ...
  public Service state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.config, service.config) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("config") != null && !jsonObj.get("config").isJsonNull()) {
        ServiceConfig.validateJsonElement(jsonObj.get("config"));
      }
