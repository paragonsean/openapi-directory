...
public class ImportConsumerOverridesRequest {
  ...
  public ImportConsumerOverridesRequest force(Boolean force) {
    this.force = force;
    return this;
  }
  ...
  public ImportConsumerOverridesRequest forceOnly(List<ForceOnlyEnum> forceOnly) {
    this.forceOnly = forceOnly;
    return this;
  }

  public ImportConsumerOverridesRequest addForceOnlyItem(ForceOnlyEnum forceOnlyItem) {
  ...
  public ImportConsumerOverridesRequest inlineSource(OverrideInlineSource inlineSource) {
  ...
  public boolean equals(Object o) {
    ...
    ImportConsumerOverridesRequest importConsumerOverridesRequest = (ImportConsumerOverridesRequest) o;
    return Objects.equals(this.force, importConsumerOverridesRequest.force) &&
        Objects.equals(this.forceOnly, importConsumerOverridesRequest.forceOnly) &&
        Objects.equals(this.inlineSource, importConsumerOverridesRequest.inlineSource);
  }
  ...
  public String toString() {
    ...
    sb.append("class ImportConsumerOverridesRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ImportConsumerOverridesRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ImportConsumerOverridesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImportConsumerOverridesRequest is not found in the empty JSON string", ImportConsumerOverridesRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ImportConsumerOverridesRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ImportConsumerOverridesRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImportConsumerOverridesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImportConsumerOverridesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImportConsumerOverridesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImportConsumerOverridesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ImportConsumerOverridesRequest>() {
           @Override
           public void write(JsonWriter out, ImportConsumerOverridesRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ImportConsumerOverridesRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ImportConsumerOverridesRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ImportConsumerOverridesRequest
   * @throws IOException if the JSON string is invalid with respect to ImportConsumerOverridesRequest
   */
  public static ImportConsumerOverridesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImportConsumerOverridesRequest.class);
  }

  /**
   * Convert an instance of ImportConsumerOverridesRequest to an JSON string
   *
   * @return JSON string
   */
