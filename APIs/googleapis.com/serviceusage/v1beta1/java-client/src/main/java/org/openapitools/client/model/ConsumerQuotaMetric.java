...
public class ConsumerQuotaMetric {
  ...
  private List<ConsumerQuotaLimit> consumerQuotaLimits = new ArrayList<>();
  ...
  private List<ConsumerQuotaLimit> descendantConsumerQuotaLimits = new ArrayList<>();
  ...
  public ConsumerQuotaMetric consumerQuotaLimits(List<ConsumerQuotaLimit> consumerQuotaLimits) {
    this.consumerQuotaLimits = consumerQuotaLimits;
    return this;
  }

  public ConsumerQuotaMetric addConsumerQuotaLimitsItem(ConsumerQuotaLimit consumerQuotaLimitsItem) {
  ...
  public void setConsumerQuotaLimits(List<ConsumerQuotaLimit> consumerQuotaLimits) {
    this.consumerQuotaLimits = consumerQuotaLimits;
  }


  public ConsumerQuotaMetric descendantConsumerQuotaLimits(List<ConsumerQuotaLimit> descendantConsumerQuotaLimits) {
    this.descendantConsumerQuotaLimits = descendantConsumerQuotaLimits;
    return this;
  }

  public ConsumerQuotaMetric addDescendantConsumerQuotaLimitsItem(ConsumerQuotaLimit descendantConsumerQuotaLimitsItem) {
  ...
  public void setDescendantConsumerQuotaLimits(List<ConsumerQuotaLimit> descendantConsumerQuotaLimits) {
    this.descendantConsumerQuotaLimits = descendantConsumerQuotaLimits;
  }


  public ConsumerQuotaMetric displayName(String displayName) {
  ...
  public ConsumerQuotaMetric metric(String metric) {
    this.metric = metric;
    return this;
  }
  ...
  public ConsumerQuotaMetric name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ConsumerQuotaMetric unit(String unit) {
    this.unit = unit;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ConsumerQuotaMetric consumerQuotaMetric = (ConsumerQuotaMetric) o;
    return Objects.equals(this.consumerQuotaLimits, consumerQuotaMetric.consumerQuotaLimits) &&
        Objects.equals(this.descendantConsumerQuotaLimits, consumerQuotaMetric.descendantConsumerQuotaLimits) &&
        Objects.equals(this.displayName, consumerQuotaMetric.displayName) &&
        Objects.equals(this.metric, consumerQuotaMetric.metric) &&
        Objects.equals(this.name, consumerQuotaMetric.name) &&
        Objects.equals(this.unit, consumerQuotaMetric.unit);
  }
  ...
  public String toString() {
    ...
    sb.append("class ConsumerQuotaMetric {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConsumerQuotaMetric
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConsumerQuotaMetric.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConsumerQuotaMetric is not found in the empty JSON string", ConsumerQuotaMetric.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConsumerQuotaMetric.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConsumerQuotaMetric` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("consumerQuotaLimits") != null && !jsonObj.get("consumerQuotaLimits").isJsonNull()) {
        ...
        if (jsonArrayconsumerQuotaLimits != null) {
          ...
          for (int i = 0; i < jsonArrayconsumerQuotaLimits.size(); i++) {
            ConsumerQuotaLimit.validateJsonElement(jsonArrayconsumerQuotaLimits.get(i));
          };
        }
      }
      if (jsonObj.get("descendantConsumerQuotaLimits") != null && !jsonObj.get("descendantConsumerQuotaLimits").isJsonNull()) {
        ...
        if (jsonArraydescendantConsumerQuotaLimits != null) {
          ...
          for (int i = 0; i < jsonArraydescendantConsumerQuotaLimits.size(); i++) {
            ConsumerQuotaLimit.validateJsonElement(jsonArraydescendantConsumerQuotaLimits.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConsumerQuotaMetric.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConsumerQuotaMetric' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConsumerQuotaMetric> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConsumerQuotaMetric.class));

       return (TypeAdapter<T>) new TypeAdapter<ConsumerQuotaMetric>() {
           @Override
           public void write(JsonWriter out, ConsumerQuotaMetric value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ConsumerQuotaMetric read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ConsumerQuotaMetric given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ConsumerQuotaMetric
   * @throws IOException if the JSON string is invalid with respect to ConsumerQuotaMetric
   */
  public static ConsumerQuotaMetric fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConsumerQuotaMetric.class);
  }

  /**
   * Convert an instance of ConsumerQuotaMetric to an JSON string
   *
   * @return JSON string
   */
