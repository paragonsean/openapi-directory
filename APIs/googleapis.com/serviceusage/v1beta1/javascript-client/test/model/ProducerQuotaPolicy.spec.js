...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceUsageApi.ProducerQuotaPolicy();
  });
  ...
  describe('ProducerQuotaPolicy', function() {
    it('should create an instance of ProducerQuotaPolicy', function() {
      // uncomment below and update the code to test ProducerQuotaPolicy
      //var instance = new ServiceUsageApi.ProducerQuotaPolicy();
      //expect(instance).to.be.a(ServiceUsageApi.ProducerQuotaPolicy);
    });
