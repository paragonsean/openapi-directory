...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceUsageApi.ListOperationsResponse();
  });
  ...
  describe('ListOperationsResponse', function() {
    it('should create an instance of ListOperationsResponse', function() {
      ...
      //var instance = new ServiceUsageApi.ListOperationsResponse();
      //expect(instance).to.be.a(ServiceUsageApi.ListOperationsResponse);
    });
