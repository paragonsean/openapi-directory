...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceUsageApi.ListServicesResponse();
  });
  ...
  describe('ListServicesResponse', function() {
    it('should create an instance of ListServicesResponse', function() {
      ...
      //var instance = new ServiceUsageApi.ListServicesResponse();
      //expect(instance).to.be.a(ServiceUsageApi.ListServicesResponse);
    });
