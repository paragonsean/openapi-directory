...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceUsageApi.LoggingDestination();
  });
  ...
  describe('LoggingDestination', function() {
    it('should create an instance of LoggingDestination', function() {
      ...
      //var instance = new ServiceUsageApi.LoggingDestination();
      //expect(instance).to.be.a(ServiceUsageApi.LoggingDestination);
    });
