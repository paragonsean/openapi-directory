...
/**
 * The ProducerQuotaPolicy model module.
 * @module model/ProducerQuotaPolicy
 * @version v1beta1
 */
class ProducerQuotaPolicy {
    /**
     * Constructs a new <code>ProducerQuotaPolicy</code>.
     * Quota policy created by service producer.
     * @alias module:model/ProducerQuotaPolicy
     */
    constructor() { 
        
        ProducerQuotaPolicy.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ProducerQuotaPolicy</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ProducerQuotaPolicy} obj Optional instance to populate.
     * @return {module:model/ProducerQuotaPolicy} The populated <code>ProducerQuotaPolicy</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProducerQuotaPolicy();
    ...
    /**
     * Validates the JSON data with respect to <code>ProducerQuotaPolicy</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProducerQuotaPolicy</code>.
     */
 ...
 */
ProducerQuotaPolicy.prototype['container'] = undefined;
 ...
 */
ProducerQuotaPolicy.prototype['dimensions'] = undefined;
 ...
 */
ProducerQuotaPolicy.prototype['metric'] = undefined;
 ...
 * @member {String} name
 */
ProducerQuotaPolicy.prototype['name'] = undefined;

/**
 * The quota policy value. Can be any nonnegative integer, or -1 (unlimited quota).
 * @member {String} policyValue
 */
ProducerQuotaPolicy.prototype['policyValue'] = undefined;
 ...
 * @member {String} unit
 */
ProducerQuotaPolicy.prototype['unit'] = undefined;
...
export default ProducerQuotaPolicy;
