# ServiceUsageApi.ConsumerQuotaLimit
...
**quotaBuckets** | [**[QuotaBucket]**](QuotaBucket.md) | Summary of the enforced quota buckets, organized by quota dimension, ordered from least specific to most specific (for example, the global default bucket, with no quota dimensions, will always appear first). | [optional] 
