...
> Operation serviceusageServicesBatchEnable(parent, opts)
...
let apiInstance = new ServiceUsageApi.ServicesApi();
let parent = "parent_example"; // String | Parent to enable services on. An example name would be: `projects/123` where `123` is the project number (not project ID). The `BatchEnableServices` method currently only supports projects.
let opts = {
  ...
  'batchEnableServicesRequest': new ServiceUsageApi.BatchEnableServicesRequest() // BatchEnableServicesRequest | 
};
apiInstance.serviceusageServicesBatchEnable(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> Operation serviceusageServicesConsumerQuotaMetricsImportAdminOverrides(parent, opts)
...
let apiInstance = new ServiceUsageApi.ServicesApi();
let parent = "parent_example"; // String | The resource name of the consumer. An example name would be: `projects/123/services/compute.googleapis.com`
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'importAdminOverridesRequest': new ServiceUsageApi.ImportAdminOverridesRequest() // ImportAdminOverridesRequest | 
};
apiInstance.serviceusageServicesConsumerQuotaMetricsImportAdminOverrides(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Operation serviceusageServicesConsumerQuotaMetricsImportConsumerOverrides(parent, opts)
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'importConsumerOverridesRequest': new ServiceUsageApi.ImportConsumerOverridesRequest() // ImportConsumerOverridesRequest | 
};
apiInstance.serviceusageServicesConsumerQuotaMetricsImportConsumerOverrides(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Operation serviceusageServicesConsumerQuotaMetricsLimitsAdminOverridesCreate(parent, opts)
...
let apiInstance = new ServiceUsageApi.ServicesApi();
let parent = "parent_example"; // String | The resource name of the parent quota limit, returned by a ListConsumerQuotaMetrics or GetConsumerQuotaMetric call. An example name would be: `projects/123/services/compute.googleapis.com/consumerQuotaMetrics/compute.googleapis.com%2Fcpus/limits/%2Fproject%2Fregion`
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'quotaOverride': new ServiceUsageApi.QuotaOverride() // QuotaOverride | 
};
apiInstance.serviceusageServicesConsumerQuotaMetricsLimitsAdminOverridesCreate(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ListAdminOverridesResponse serviceusageServicesConsumerQuotaMetricsLimitsAdminOverridesList(parent, opts)
...
apiInstance.serviceusageServicesConsumerQuotaMetricsLimitsAdminOverridesList(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Operation serviceusageServicesConsumerQuotaMetricsLimitsConsumerOverridesCreate(parent, opts)
...
apiInstance.serviceusageServicesConsumerQuotaMetricsLimitsConsumerOverridesCreate(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Operation serviceusageServicesConsumerQuotaMetricsLimitsConsumerOverridesDelete(name, opts)
...
let apiInstance = new ServiceUsageApi.ServicesApi();
let name = "name_example"; // String | The resource name of the override to delete. An example name would be: `projects/123/services/compute.googleapis.com/consumerQuotaMetrics/compute.googleapis.com%2Fcpus/limits/%2Fproject%2Fregion/consumerOverrides/4a3f2c1d`
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
apiInstance.serviceusageServicesConsumerQuotaMetricsLimitsConsumerOverridesDelete(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ListConsumerOverridesResponse serviceusageServicesConsumerQuotaMetricsLimitsConsumerOverridesList(parent, opts)
...
apiInstance.serviceusageServicesConsumerQuotaMetricsLimitsConsumerOverridesList(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Operation serviceusageServicesConsumerQuotaMetricsLimitsConsumerOverridesPatch(name, opts)
...
let apiInstance = new ServiceUsageApi.ServicesApi();
let name = "name_example"; // String | The resource name of the override to update. An example name would be: `projects/123/services/compute.googleapis.com/consumerQuotaMetrics/compute.googleapis.com%2Fcpus/limits/%2Fproject%2Fregion/consumerOverrides/4a3f2c1d`
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'forceOnly': ["null"], // [String] | The list of quota safety checks to ignore before the override mutation. Unlike 'force' field that ignores all the quota safety checks, the 'force_only' field ignores only the specified checks; other checks are still enforced. The 'force' and 'force_only' fields cannot both be set.
  'updateMask': "updateMask_example", // String | Update only the specified fields of the override. If unset, all fields will be updated.
  'quotaOverride': new ServiceUsageApi.QuotaOverride() // QuotaOverride | 
};
apiInstance.serviceusageServicesConsumerQuotaMetricsLimitsConsumerOverridesPatch(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ConsumerQuotaLimit serviceusageServicesConsumerQuotaMetricsLimitsGet(name, opts)
...
let apiInstance = new ServiceUsageApi.ServicesApi();
let name = "name_example"; // String | The resource name of the quota limit. Use the quota limit resource name returned by previous ListConsumerQuotaMetrics and GetConsumerQuotaMetric API calls.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
apiInstance.serviceusageServicesConsumerQuotaMetricsLimitsGet(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ListConsumerQuotaMetricsResponse serviceusageServicesConsumerQuotaMetricsList(parent, opts)
...
let apiInstance = new ServiceUsageApi.ServicesApi();
let parent = "parent_example"; // String | Parent of the quotas resource. Some example names would be: `projects/123/services/serviceconsumermanagement.googleapis.com` `folders/345/services/serviceconsumermanagement.googleapis.com` `organizations/456/services/serviceconsumermanagement.googleapis.com`
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
apiInstance.serviceusageServicesConsumerQuotaMetricsList(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Operation serviceusageServicesDisable(name, opts)
...
let apiInstance = new ServiceUsageApi.ServicesApi();
let name = "name_example"; // String | Name of the consumer and service to disable the service on. The enable and disable methods currently only support projects. An example name would be: `projects/123/services/serviceusage.googleapis.com` where `123` is the project number (not project ID).
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
apiInstance.serviceusageServicesDisable(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Operation serviceusageServicesEnable(name, opts)
...
let apiInstance = new ServiceUsageApi.ServicesApi();
let name = "name_example"; // String | Name of the consumer and service to enable the service on. The `EnableService` and `DisableService` methods currently only support projects. Enabling a service requires that the service is public or is shared with the user enabling the service. An example name would be: `projects/123/services/serviceusage.googleapis.com` where `123` is the project number (not project ID).
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
apiInstance.serviceusageServicesEnable(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Operation serviceusageServicesGenerateServiceIdentity(parent, opts)
...
let apiInstance = new ServiceUsageApi.ServicesApi();
let parent = "parent_example"; // String | Name of the consumer and service to generate an identity for. The `GenerateServiceIdentity` methods currently support projects, folders, organizations. Example parents would be: `projects/123/services/example.googleapis.com` `folders/123/services/example.googleapis.com` `organizations/123/services/example.googleapis.com`
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
apiInstance.serviceusageServicesGenerateServiceIdentity(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ListServicesResponse serviceusageServicesList(parent, opts)
...
let apiInstance = new ServiceUsageApi.ServicesApi();
let parent = "parent_example"; // String | Parent to search for services on. An example name would be: `projects/123` where `123` is the project number (not project ID).
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'filter': "filter_example", // String | Only list services that conform to the given filter. The allowed filter strings are `state:ENABLED` and `state:DISABLED`.
  'pageSize': 56, // Number | Requested size of the next page of data. Requested page size cannot exceed 200. If not set, the default page size is 50.
...
apiInstance.serviceusageServicesList(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **pageSize** | **Number**| Requested size of the next page of data. Requested page size cannot exceed 200. If not set, the default page size is 50. | [optional] 
