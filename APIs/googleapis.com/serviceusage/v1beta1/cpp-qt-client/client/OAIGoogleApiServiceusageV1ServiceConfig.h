...
/*
 * OAIGoogleApiServiceusageV1ServiceConfig.h
 *
 * The configuration of the service.
 */

#ifndef OAIGoogleApiServiceusageV1ServiceConfig_H
#define OAIGoogleApiServiceusageV1ServiceConfig_H
...
class OAIGoogleApiServiceusageV1ServiceConfig : public OAIObject {
public:
    OAIGoogleApiServiceusageV1ServiceConfig();
    OAIGoogleApiServiceusageV1ServiceConfig(QString json);
    ~OAIGoogleApiServiceusageV1ServiceConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleApiServiceusageV1ServiceConfig)

#endif // OAIGoogleApiServiceusageV1ServiceConfig_H
