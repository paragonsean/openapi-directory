...
#ifndef OAIGoogleApiService_H
#define OAIGoogleApiService_H
...
class OAIGoogleApiService : public OAIObject {
public:
    OAIGoogleApiService();
    OAIGoogleApiService(QString json);
    ~OAIGoogleApiService() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleApiService)

#endif // OAIGoogleApiService_H
