...
/*
 * OAIProducerQuotaPolicy.h
 *
 * Quota policy created by service producer.
 */

#ifndef OAIProducerQuotaPolicy_H
#define OAIProducerQuotaPolicy_H
...
class OAIProducerQuotaPolicy : public OAIObject {
public:
    OAIProducerQuotaPolicy();
    OAIProducerQuotaPolicy(QString json);
    ~OAIProducerQuotaPolicy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProducerQuotaPolicy)

#endif // OAIProducerQuotaPolicy_H
