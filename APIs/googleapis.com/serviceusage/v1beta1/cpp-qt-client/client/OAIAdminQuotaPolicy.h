...
/*
 * OAIAdminQuotaPolicy.h
 *
 * Quota policy created by quota administrator.
 */

#ifndef OAIAdminQuotaPolicy_H
#define OAIAdminQuotaPolicy_H
...
class OAIAdminQuotaPolicy : public OAIObject {
public:
    OAIAdminQuotaPolicy();
    OAIAdminQuotaPolicy(QString json);
    ~OAIAdminQuotaPolicy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdminQuotaPolicy)

#endif // OAIAdminQuotaPolicy_H
