...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LookerGoogleCloudCoreApi.Location();
  });
  ...
  describe('Location', function() {
    it('should create an instance of Location', function() {
      ...
      //var instance = new LookerGoogleCloudCoreApi.Location();
      //expect(instance).to.be.a(LookerGoogleCloudCoreApi.Location);
    });
