...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LookerGoogleCloudCoreApi.TimeOfDay();
  });
  ...
  describe('TimeOfDay', function() {
    it('should create an instance of TimeOfDay', function() {
      ...
      //var instance = new LookerGoogleCloudCoreApi.TimeOfDay();
      //expect(instance).to.be.a(LookerGoogleCloudCoreApi.TimeOfDay);
    });
