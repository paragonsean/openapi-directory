...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LookerGoogleCloudCoreApi.Binding();
  });
  ...
  describe('Binding', function() {
    it('should create an instance of Binding', function() {
      ...
      //var instance = new LookerGoogleCloudCoreApi.Binding();
      //expect(instance).to.be.a(LookerGoogleCloudCoreApi.Binding);
    });
