...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LookerGoogleCloudCoreApi.Operation();
  });
  ...
  describe('Operation', function() {
    it('should create an instance of Operation', function() {
      ...
      //var instance = new LookerGoogleCloudCoreApi.Operation();
      //expect(instance).to.be.a(LookerGoogleCloudCoreApi.Operation);
    });
