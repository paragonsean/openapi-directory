...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LookerGoogleCloudCoreApi.ListOperationsResponse();
  });
  ...
  describe('ListOperationsResponse', function() {
    it('should create an instance of ListOperationsResponse', function() {
      ...
      //var instance = new LookerGoogleCloudCoreApi.ListOperationsResponse();
      //expect(instance).to.be.a(LookerGoogleCloudCoreApi.ListOperationsResponse);
    });
