...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LookerGoogleCloudCoreApi.OAuthConfig();
  });
  ...
  describe('OAuthConfig', function() {
    it('should create an instance of OAuthConfig', function() {
      // uncomment below and update the code to test OAuthConfig
      //var instance = new LookerGoogleCloudCoreApi.OAuthConfig();
      //expect(instance).to.be.a(LookerGoogleCloudCoreApi.OAuthConfig);
    });
