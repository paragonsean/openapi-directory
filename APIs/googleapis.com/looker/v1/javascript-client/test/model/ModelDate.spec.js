...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LookerGoogleCloudCoreApi.ModelDate();
  });
  ...
  describe('ModelDate', function() {
    it('should create an instance of ModelDate', function() {
      ...
      //var instance = new LookerGoogleCloudCoreApi.ModelDate();
      //expect(instance).to.be.a(LookerGoogleCloudCoreApi.ModelDate);
    });
