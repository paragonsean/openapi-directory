...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LookerGoogleCloudCoreApi.ListLocationsResponse();
  });
  ...
  describe('ListLocationsResponse', function() {
    it('should create an instance of ListLocationsResponse', function() {
      ...
      //var instance = new LookerGoogleCloudCoreApi.ListLocationsResponse();
      //expect(instance).to.be.a(LookerGoogleCloudCoreApi.ListLocationsResponse);
    });
