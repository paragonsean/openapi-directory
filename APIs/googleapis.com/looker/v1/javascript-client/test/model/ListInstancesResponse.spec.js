...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LookerGoogleCloudCoreApi.ListInstancesResponse();
  });
  ...
  describe('ListInstancesResponse', function() {
    it('should create an instance of ListInstancesResponse', function() {
      ...
      //var instance = new LookerGoogleCloudCoreApi.ListInstancesResponse();
      //expect(instance).to.be.a(LookerGoogleCloudCoreApi.ListInstancesResponse);
    });
