...
public class MediationReportSpecSortCondition {
  ...
  public MediationReportSpecSortCondition dimension(DimensionEnum dimension) {
  ...
  public MediationReportSpecSortCondition metric(MetricEnum metric) {
    this.metric = metric;
    return this;
  }
  ...
  public MediationReportSpecSortCondition order(OrderEnum order) {
    this.order = order;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    MediationReportSpecSortCondition mediationReportSpecSortCondition = (MediationReportSpecSortCondition) o;
    return Objects.equals(this.dimension, mediationReportSpecSortCondition.dimension) &&
        Objects.equals(this.metric, mediationReportSpecSortCondition.metric) &&
        Objects.equals(this.order, mediationReportSpecSortCondition.order);
  }
  ...
  public String toString() {
    ...
    sb.append("class MediationReportSpecSortCondition {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MediationReportSpecSortCondition
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MediationReportSpecSortCondition.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MediationReportSpecSortCondition is not found in the empty JSON string", MediationReportSpecSortCondition.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MediationReportSpecSortCondition.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MediationReportSpecSortCondition` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MediationReportSpecSortCondition.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MediationReportSpecSortCondition' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MediationReportSpecSortCondition> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MediationReportSpecSortCondition.class));

       return (TypeAdapter<T>) new TypeAdapter<MediationReportSpecSortCondition>() {
           @Override
           public void write(JsonWriter out, MediationReportSpecSortCondition value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MediationReportSpecSortCondition read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MediationReportSpecSortCondition given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MediationReportSpecSortCondition
   * @throws IOException if the JSON string is invalid with respect to MediationReportSpecSortCondition
   */
  public static MediationReportSpecSortCondition fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MediationReportSpecSortCondition.class);
  }

  /**
   * Convert an instance of MediationReportSpecSortCondition to an JSON string
   *
   * @return JSON string
   */
