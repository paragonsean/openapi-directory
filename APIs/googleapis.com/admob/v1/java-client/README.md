...
AdMob API
- API version: v1
  - Build date: 2024-10-12T11:42:44.550729-04:00[America/New_York]
...
------------ | ------------- | ------------- | -------------
*AccountsApi* | [**admobAccountsAdUnitsList**](docs/AccountsApi.md#admobAccountsAdUnitsList) | **GET** /v1/{parent}/adUnits | 
*AccountsApi* | [**admobAccountsAppsList**](docs/AccountsApi.md#admobAccountsAppsList) | **GET** /v1/{parent}/apps | 
*AccountsApi* | [**admobAccountsGet**](docs/AccountsApi.md#admobAccountsGet) | **GET** /v1/{name} | 
*AccountsApi* | [**admobAccountsList**](docs/AccountsApi.md#admobAccountsList) | **GET** /v1/accounts | 
*AccountsApi* | [**admobAccountsMediationReportGenerate**](docs/AccountsApi.md#admobAccountsMediationReportGenerate) | **POST** /v1/{parent}/mediationReport:generate | 
*AccountsApi* | [**admobAccountsNetworkReportGenerate**](docs/AccountsApi.md#admobAccountsNetworkReportGenerate) | **POST** /v1/{parent}/networkReport:generate | 
