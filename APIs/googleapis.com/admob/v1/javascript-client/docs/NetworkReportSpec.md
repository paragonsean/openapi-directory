...
**dimensionFilters** | [**[NetworkReportSpecDimensionFilter]**](NetworkReportSpecDimensionFilter.md) | Describes which report rows to match based on their dimension values. | [optional] 
...
* `IMPRESSION_RPM` (value: `"IMPRESSION_RPM"`)
