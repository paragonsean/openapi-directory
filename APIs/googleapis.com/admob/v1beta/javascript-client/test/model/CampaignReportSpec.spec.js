...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdMobApi.CampaignReportSpec();
  });
  ...
  describe('CampaignReportSpec', function() {
    it('should create an instance of CampaignReportSpec', function() {
      // uncomment below and update the code to test CampaignReportSpec
      //var instance = new AdMobApi.CampaignReportSpec();
      //expect(instance).to.be.a(AdMobApi.CampaignReportSpec);
    });
