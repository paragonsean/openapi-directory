...
/**
 * The NetworkReportSpecSortCondition model module.
 * @module model/NetworkReportSpecSortCondition
 * @version v1beta
 */
class NetworkReportSpecSortCondition {
    /**
     * Constructs a new <code>NetworkReportSpecSortCondition</code>.
     * Sorting direction to be applied on a dimension or a metric.
     * @alias module:model/NetworkReportSpecSortCondition
     */
    constructor() { 
        
        NetworkReportSpecSortCondition.initialize(this);
    }
    ...
    /**
     * Constructs a <code>NetworkReportSpecSortCondition</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NetworkReportSpecSortCondition} obj Optional instance to populate.
     * @return {module:model/NetworkReportSpecSortCondition} The populated <code>NetworkReportSpecSortCondition</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NetworkReportSpecSortCondition();
    ...
    /**
     * Validates the JSON data with respect to <code>NetworkReportSpecSortCondition</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NetworkReportSpecSortCondition</code>.
     */
 ...
 * @member {module:model/NetworkReportSpecSortCondition.DimensionEnum} dimension
 */
NetworkReportSpecSortCondition.prototype['dimension'] = undefined;

/**
 * Sort by the specified metric.
 * @member {module:model/NetworkReportSpecSortCondition.MetricEnum} metric
 */
NetworkReportSpecSortCondition.prototype['metric'] = undefined;

/**
 * Sorting order of the dimension or metric.
 * @member {module:model/NetworkReportSpecSortCondition.OrderEnum} order
 */
NetworkReportSpecSortCondition.prototype['order'] = undefined;
 ...
 * @readonly
 */
NetworkReportSpecSortCondition['DimensionEnum'] = {
 ...
 * @readonly
 */
NetworkReportSpecSortCondition['MetricEnum'] = {
 ...
 * @readonly
 */
NetworkReportSpecSortCondition['OrderEnum'] = {
...
export default NetworkReportSpecSortCondition;
