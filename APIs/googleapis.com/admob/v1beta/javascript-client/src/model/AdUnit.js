...
import AdUnitRewardSettings from './AdUnitRewardSettings';
...
class AdUnit {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('rewardSettings')) {
                obj['rewardSettings'] = AdUnitRewardSettings.constructFromObject(data['rewardSettings']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['rewardSettings']) { // data not null
          AdUnitRewardSettings.validateJSON(data['rewardSettings']);
        }
...
/**
 * @member {module:model/AdUnitRewardSettings} rewardSettings
 */
AdUnit.prototype['rewardSettings'] = undefined;
