...
void OAIAdUnit::initializeModel() {
    ...
    m_reward_settings_isSet = false;
    m_reward_settings_isValid = false;
}
...
void OAIAdUnit::fromJsonObject(QJsonObject json) {
    ...
    m_reward_settings_isValid = ::OpenAPI::fromJsonValue(m_reward_settings, json[QString("rewardSettings")]);
    m_reward_settings_isSet = !json[QString("rewardSettings")].isNull() && m_reward_settings_isValid;
}
...
QJsonObject OAIAdUnit::asJsonObject() const {
    ...
    if (m_reward_settings.isSet()) {
        obj.insert(QString("rewardSettings"), ::OpenAPI::toJsonValue(m_reward_settings));
    }
    return obj;
}
...
OAIAdUnitRewardSettings OAIAdUnit::getRewardSettings() const {
    return m_reward_settings;
}
void OAIAdUnit::setRewardSettings(const OAIAdUnitRewardSettings &reward_settings) {
    m_reward_settings = reward_settings;
    m_reward_settings_isSet = true;
}

bool OAIAdUnit::is_reward_settings_Set() const{
    return m_reward_settings_isSet;
}

bool OAIAdUnit::is_reward_settings_Valid() const{
    return m_reward_settings_isValid;
}
