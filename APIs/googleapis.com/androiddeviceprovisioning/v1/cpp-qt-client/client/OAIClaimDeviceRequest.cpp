...
QString OAIClaimDeviceRequest::getConfigurationId() const {
    return m_configuration_id;
}
void OAIClaimDeviceRequest::setConfigurationId(const QString &configuration_id) {
    m_configuration_id = configuration_id;
    m_configuration_id_isSet = true;
}

bool OAIClaimDeviceRequest::is_configuration_id_Set() const{
    return m_configuration_id_isSet;
}

bool OAIClaimDeviceRequest::is_configuration_id_Valid() const{
    return m_configuration_id_isValid;
}

QString OAIClaimDeviceRequest::getCustomerId() const {
    return m_customer_id;
}
void OAIClaimDeviceRequest::setCustomerId(const QString &customer_id) {
    m_customer_id = customer_id;
    m_customer_id_isSet = true;
}

bool OAIClaimDeviceRequest::is_customer_id_Set() const{
    return m_customer_id_isSet;
}

bool OAIClaimDeviceRequest::is_customer_id_Valid() const{
    return m_customer_id_isValid;
}

OAIDeviceIdentifier OAIClaimDeviceRequest::getDeviceIdentifier() const {
    return m_device_identifier;
}
void OAIClaimDeviceRequest::setDeviceIdentifier(const OAIDeviceIdentifier &device_identifier) {
    m_device_identifier = device_identifier;
    m_device_identifier_isSet = true;
}

bool OAIClaimDeviceRequest::is_device_identifier_Set() const{
    return m_device_identifier_isSet;
}

bool OAIClaimDeviceRequest::is_device_identifier_Valid() const{
    return m_device_identifier_isValid;
}

OAIDeviceMetadata OAIClaimDeviceRequest::getDeviceMetadata() const {
    return m_device_metadata;
}
void OAIClaimDeviceRequest::setDeviceMetadata(const OAIDeviceMetadata &device_metadata) {
    m_device_metadata = device_metadata;
    m_device_metadata_isSet = true;
}

bool OAIClaimDeviceRequest::is_device_metadata_Set() const{
    return m_device_metadata_isSet;
}

bool OAIClaimDeviceRequest::is_device_metadata_Valid() const{
    return m_device_metadata_isValid;
}

QString OAIClaimDeviceRequest::getGoogleWorkspaceCustomerId() const {
    return m_google_workspace_customer_id;
}
void OAIClaimDeviceRequest::setGoogleWorkspaceCustomerId(const QString &google_workspace_customer_id) {
    m_google_workspace_customer_id = google_workspace_customer_id;
    m_google_workspace_customer_id_isSet = true;
}

bool OAIClaimDeviceRequest::is_google_workspace_customer_id_Set() const{
    return m_google_workspace_customer_id_isSet;
}

bool OAIClaimDeviceRequest::is_google_workspace_customer_id_Valid() const{
    return m_google_workspace_customer_id_isValid;
}

QString OAIClaimDeviceRequest::getPreProvisioningToken() const {
    return m_pre_provisioning_token;
}
void OAIClaimDeviceRequest::setPreProvisioningToken(const QString &pre_provisioning_token) {
    m_pre_provisioning_token = pre_provisioning_token;
    m_pre_provisioning_token_isSet = true;
}

bool OAIClaimDeviceRequest::is_pre_provisioning_token_Set() const{
    return m_pre_provisioning_token_isSet;
}

bool OAIClaimDeviceRequest::is_pre_provisioning_token_Valid() const{
    return m_pre_provisioning_token_isValid;
}

QString OAIClaimDeviceRequest::getSectionType() const {
    return m_section_type;
}
void OAIClaimDeviceRequest::setSectionType(const QString &section_type) {
    m_section_type = section_type;
    m_section_type_isSet = true;
}

bool OAIClaimDeviceRequest::is_section_type_Set() const{
    return m_section_type_isSet;
}

bool OAIClaimDeviceRequest::is_section_type_Valid() const{
    return m_section_type_isValid;
}

QString OAIClaimDeviceRequest::getSimlockProfileId() const {
    return m_simlock_profile_id;
}
void OAIClaimDeviceRequest::setSimlockProfileId(const QString &simlock_profile_id) {
    m_simlock_profile_id = simlock_profile_id;
    m_simlock_profile_id_isSet = true;
}

bool OAIClaimDeviceRequest::is_simlock_profile_id_Set() const{
    return m_simlock_profile_id_isSet;
}

bool OAIClaimDeviceRequest::is_simlock_profile_id_Valid() const{
