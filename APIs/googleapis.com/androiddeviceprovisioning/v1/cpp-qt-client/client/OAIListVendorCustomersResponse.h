...
/*
 * OAIListVendorCustomersResponse.h
 *
 * Response message to list customers of the vendor.
 */

#ifndef OAIListVendorCustomersResponse_H
#define OAIListVendorCustomersResponse_H
...
class OAIListVendorCustomersResponse : public OAIObject {
public:
    OAIListVendorCustomersResponse();
    OAIListVendorCustomersResponse(QString json);
    ~OAIListVendorCustomersResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListVendorCustomersResponse)

#endif // OAIListVendorCustomersResponse_H
