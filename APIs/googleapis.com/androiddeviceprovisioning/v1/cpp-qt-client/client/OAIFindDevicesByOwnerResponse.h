...
/*
 * OAIFindDevicesByOwnerResponse.h
 *
 * Response containing found devices.
 */

#ifndef OAIFindDevicesByOwnerResponse_H
#define OAIFindDevicesByOwnerResponse_H
...
class OAIFindDevicesByOwnerResponse : public OAIObject {
public:
    OAIFindDevicesByOwnerResponse();
    OAIFindDevicesByOwnerResponse(QString json);
    ~OAIFindDevicesByOwnerResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFindDevicesByOwnerResponse)

#endif // OAIFindDevicesByOwnerResponse_H
