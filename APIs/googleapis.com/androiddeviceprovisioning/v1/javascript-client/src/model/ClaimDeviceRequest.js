...
class ClaimDeviceRequest {
    ...
    constructor() { 
        ...
        ClaimDeviceRequest.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ClaimDeviceRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ClaimDeviceRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ClaimDeviceRequest</code>.
     */
 ...
 */
ClaimDeviceRequest.prototype['configurationId'] = undefined;

/**
 * The ID of the customer for whom the device is being claimed.
 * @member {String} customerId
 */
ClaimDeviceRequest.prototype['customerId'] = undefined;

/**
 * @member {module:model/DeviceIdentifier} deviceIdentifier
 */
ClaimDeviceRequest.prototype['deviceIdentifier'] = undefined;

/**
 * @member {module:model/DeviceMetadata} deviceMetadata
 */
ClaimDeviceRequest.prototype['deviceMetadata'] = undefined;

/**
 * The Google Workspace customer ID.
 * @member {String} googleWorkspaceCustomerId
 */
ClaimDeviceRequest.prototype['googleWorkspaceCustomerId'] = undefined;

/**
 * Optional. Must and can only be set for Chrome OS devices.
 * @member {String} preProvisioningToken
 */
ClaimDeviceRequest.prototype['preProvisioningToken'] = undefined;

/**
 * Required. The section type of the device's provisioning record.
 * @member {module:model/ClaimDeviceRequest.SectionTypeEnum} sectionType
 */
ClaimDeviceRequest.prototype['sectionType'] = undefined;
 ...
 */
ClaimDeviceRequest.prototype['simlockProfileId'] = undefined;
 ...
 * @readonly
 */
ClaimDeviceRequest['SectionTypeEnum'] = {
...
export default ClaimDeviceRequest;
