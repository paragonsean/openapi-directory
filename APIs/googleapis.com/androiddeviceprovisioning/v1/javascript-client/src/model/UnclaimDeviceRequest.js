...
/**
 * The UnclaimDeviceRequest model module.
 * @module model/UnclaimDeviceRequest
 * @version v1
 */
class UnclaimDeviceRequest {
    /**
     * Constructs a new <code>UnclaimDeviceRequest</code>.
     * Request message to unclaim a device.
     * @alias module:model/UnclaimDeviceRequest
     */
    constructor() { 
        
        UnclaimDeviceRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UnclaimDeviceRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UnclaimDeviceRequest} obj Optional instance to populate.
     * @return {module:model/UnclaimDeviceRequest} The populated <code>UnclaimDeviceRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UnclaimDeviceRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>UnclaimDeviceRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UnclaimDeviceRequest</code>.
     */
 ...
 */
UnclaimDeviceRequest.prototype['deviceId'] = undefined;

/**
 * @member {module:model/DeviceIdentifier} deviceIdentifier
 */
UnclaimDeviceRequest.prototype['deviceIdentifier'] = undefined;

/**
 * Required. The section type of the device's provisioning record.
 * @member {module:model/UnclaimDeviceRequest.SectionTypeEnum} sectionType
 */
UnclaimDeviceRequest.prototype['sectionType'] = undefined;
 ...
 */
UnclaimDeviceRequest.prototype['vacationModeDays'] = undefined;

/**
 * The expiration time of the vacation unlock.
 * @member {String} vacationModeExpireTime
 */
UnclaimDeviceRequest.prototype['vacationModeExpireTime'] = undefined;
 ...
 * @readonly
 */
UnclaimDeviceRequest['SectionTypeEnum'] = {
...
export default UnclaimDeviceRequest;
