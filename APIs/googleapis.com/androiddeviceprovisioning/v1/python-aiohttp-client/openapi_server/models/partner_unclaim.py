...
class PartnerUnclaim(Model):
    ...
    def __init__(self, device_id: str=None, device_identifier: DeviceIdentifier=None, section_type: str=None, vacation_mode_days: int=None, vacation_mode_expire_time: str=None):
        """PartnerUnclaim - a model defined in OpenAPI

        :param device_id: The device_id of this PartnerUnclaim.
        :param device_identifier: The device_identifier of this PartnerUnclaim.
        :param section_type: The section_type of this PartnerUnclaim.
        :param vacation_mode_days: The vacation_mode_days of this PartnerUnclaim.
        :param vacation_mode_expire_time: The vacation_mode_expire_time of this PartnerUnclaim.
        """
        self.openapi_types = {
            'device_id': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'PartnerUnclaim':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The PartnerUnclaim of this PartnerUnclaim.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def device_id(self):
        """Gets the device_id of this PartnerUnclaim.

        Required. Device ID of the device.

        :return: The device_id of this PartnerUnclaim.
        :rtype: str
        """
    ...
    def device_id(self, device_id):
        """Sets the device_id of this PartnerUnclaim.
    ...
    def device_identifier(self):
        """Gets the device_identifier of this PartnerUnclaim.


        :return: The device_identifier of this PartnerUnclaim.
    ...
    def device_identifier(self, device_identifier):
        """Sets the device_identifier of this PartnerUnclaim.
    ...
    def section_type(self):
        """Gets the section_type of this PartnerUnclaim.

        Required. The section type of the device's provisioning record.

        :return: The section_type of this PartnerUnclaim.
        :rtype: str
        """
    ...
    def section_type(self, section_type):
        """Sets the section_type of this PartnerUnclaim.
    ...
    def vacation_mode_days(self, vacation_mode_days):
        """Sets the vacation_mode_days of this PartnerUnclaim.
    ...
    def vacation_mode_expire_time(self):
        """Gets the vacation_mode_expire_time of this PartnerUnclaim.

        Optional. The expiration time of the vacation unlock.

        :return: The vacation_mode_expire_time of this PartnerUnclaim.
        :rtype: str
        """
    ...
    def vacation_mode_expire_time(self, vacation_mode_expire_time):
        """Sets the vacation_mode_expire_time of this PartnerUnclaim.
