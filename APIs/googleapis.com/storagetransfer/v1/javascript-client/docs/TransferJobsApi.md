# StorageTransferApi.TransferJobsApi
...
> TransferJob storagetransferTransferJobsCreate(opts)
...
let apiInstance = new StorageTransferApi.TransferJobsApi();
let opts = {
  ...
  'transferJob': new StorageTransferApi.TransferJob() // TransferJob | 
};
apiInstance.storagetransferTransferJobsCreate(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> Object storagetransferTransferJobsDelete(jobName, projectId, opts)
...
let apiInstance = new StorageTransferApi.TransferJobsApi();
let jobName = "jobName_example"; // String | Required. The job to delete.
...
apiInstance.storagetransferTransferJobsDelete(jobName, projectId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> TransferJob storagetransferTransferJobsGet(jobName, projectId, opts)
...
let apiInstance = new StorageTransferApi.TransferJobsApi();
let jobName = "jobName_example"; // String | Required. The job to get.
let projectId = "projectId_example"; // String | Required. The ID of the Google Cloud project that owns the job.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
...
apiInstance.storagetransferTransferJobsGet(jobName, projectId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ListTransferJobsResponse storagetransferTransferJobsList(filter, opts)
...
apiInstance.storagetransferTransferJobsList(filter, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> TransferJob storagetransferTransferJobsPatch(jobName, opts)
...
let apiInstance = new StorageTransferApi.TransferJobsApi();
let jobName = "jobName_example"; // String | Required. The name of job to update.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'updateTransferJobRequest': new StorageTransferApi.UpdateTransferJobRequest() // UpdateTransferJobRequest | 
};
apiInstance.storagetransferTransferJobsPatch(jobName, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Operation storagetransferTransferJobsRun(jobName, opts)
...
let apiInstance = new StorageTransferApi.TransferJobsApi();
let jobName = "jobName_example"; // String | Required. The name of the transfer job.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'runTransferJobRequest': new StorageTransferApi.RunTransferJobRequest() // RunTransferJobRequest | 
};
apiInstance.storagetransferTransferJobsRun(jobName, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
