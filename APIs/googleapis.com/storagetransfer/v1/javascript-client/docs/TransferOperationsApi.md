# StorageTransferApi.TransferOperationsApi
...
> Object storagetransferTransferOperationsCancel(name, opts)
...
let apiInstance = new StorageTransferApi.TransferOperationsApi();
...
apiInstance.storagetransferTransferOperationsCancel(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> ListOperationsResponse storagetransferTransferOperationsList(name, filter, opts)
...
let apiInstance = new StorageTransferApi.TransferOperationsApi();
let name = "name_example"; // String | Required. The name of the type being listed; must be `transferOperations`.
...
apiInstance.storagetransferTransferOperationsList(name, filter, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Object storagetransferTransferOperationsPause(name, opts)
...
let apiInstance = new StorageTransferApi.TransferOperationsApi();
let name = "name_example"; // String | Required. The name of the transfer operation.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
apiInstance.storagetransferTransferOperationsPause(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Object storagetransferTransferOperationsResume(name, opts)
...
apiInstance.storagetransferTransferOperationsResume(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
