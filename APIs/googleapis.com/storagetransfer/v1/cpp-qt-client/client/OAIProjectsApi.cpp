...
void OAIProjectsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("storagetransfer_projects_agentPools_create", defaultConf);
    _serverIndices.insert("storagetransfer_projects_agentPools_create", 0);
    _serverConfigs.insert("storagetransfer_projects_agentPools_delete", defaultConf);
    _serverIndices.insert("storagetransfer_projects_agentPools_delete", 0);
    _serverConfigs.insert("storagetransfer_projects_agentPools_list", defaultConf);
    _serverIndices.insert("storagetransfer_projects_agentPools_list", 0);
    _serverConfigs.insert("storagetransfer_projects_agentPools_patch", defaultConf);
    _serverIndices.insert("storagetransfer_projects_agentPools_patch", 0);
}
...
void OAIProjectsApi::storagetransfer_projects_agentPools_create(const QString &project_id, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<QString> &agent_pool_id, const ::OpenAPI::OptionalParam<OAIAgentPool> &oai_agent_pool) {
    QString fullPath = QString(_serverConfigs["storagetransfer_projects_agentPools_create"][_serverIndices.value("storagetransfer_projects_agentPools_create")].URL()+"/v1/projects/{projectId}/agentPools");
    ...
    if (agent_pool_id.hasValue())
    {
        ...
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "agentPoolId", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("agentPoolId")).append(querySuffix).append(QUrl::toPercentEncoding(agent_pool_id.stringValue()));
    }
    ...
    if (oai_agent_pool.hasValue()){

        
        QByteArray output = oai_agent_pool.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::storagetransfer_projects_agentPools_createCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::storagetransfer_projects_agentPools_createCallback);
...
void OAIProjectsApi::storagetransfer_projects_agentPools_createCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT storagetransfer_projects_agentPools_createSignal(output);
        Q_EMIT storagetransfer_projects_agentPools_createSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT storagetransfer_projects_agentPools_createSignalE(output, error_type, error_str);
        Q_EMIT storagetransfer_projects_agentPools_createSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT storagetransfer_projects_agentPools_createSignalError(output, error_type, error_str);
        Q_EMIT storagetransfer_projects_agentPools_createSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectsApi::storagetransfer_projects_agentPools_delete(const QString &name, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type) {
    QString fullPath = QString(_serverConfigs["storagetransfer_projects_agentPools_delete"][_serverIndices.value("storagetransfer_projects_agentPools_delete")].URL()+"/v1/{name}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::storagetransfer_projects_agentPools_deleteCallback);
    connect(this, &OAIProjectsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::storagetransfer_projects_agentPools_deleteCallback);
    connect(this, &OAIProjectsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectsApi::storagetransfer_projects_agentPools_deleteCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT storagetransfer_projects_agentPools_deleteSignal(output);
        Q_EMIT storagetransfer_projects_agentPools_deleteSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("https://www.googleapis.com/auth/cloud-platform");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT storagetransfer_projects_agentPools_deleteSignalE(output, error_type, error_str);
        Q_EMIT storagetransfer_projects_agentPools_deleteSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT storagetransfer_projects_agentPools_deleteSignalError(output, error_type, error_str);
        Q_EMIT storagetransfer_projects_agentPools_deleteSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectsApi::storagetransfer_projects_agentPools_list(const QString &project_id, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<QString> &filter, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &page_token) {
    QString fullPath = QString(_serverConfigs["storagetransfer_projects_agentPools_list"][_serverIndices.value("storagetransfer_projects_agentPools_list")].URL()+"/v1/projects/{projectId}/agentPools");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::storagetransfer_projects_agentPools_listCallback);
    connect(this, &OAIProjectsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::storagetransfer_projects_agentPools_listCallback);
    connect(this, &OAIProjectsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectsApi::storagetransfer_projects_agentPools_listCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIListAgentPoolsResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT storagetransfer_projects_agentPools_listSignal(output);
        Q_EMIT storagetransfer_projects_agentPools_listSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("https://www.googleapis.com/auth/cloud-platform");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT storagetransfer_projects_agentPools_listSignalE(output, error_type, error_str);
        Q_EMIT storagetransfer_projects_agentPools_listSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT storagetransfer_projects_agentPools_listSignalError(output, error_type, error_str);
        Q_EMIT storagetransfer_projects_agentPools_listSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectsApi::storagetransfer_projects_agentPools_patch(const QString &name, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<QString> &update_mask, const ::OpenAPI::OptionalParam<OAIAgentPool> &oai_agent_pool) {
    QString fullPath = QString(_serverConfigs["storagetransfer_projects_agentPools_patch"][_serverIndices.value("storagetransfer_projects_agentPools_patch")].URL()+"/v1/{name}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::storagetransfer_projects_agentPools_patchCallback);
    connect(this, &OAIProjectsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::storagetransfer_projects_agentPools_patchCallback);
    connect(this, &OAIProjectsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectsApi::storagetransfer_projects_agentPools_patchCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT storagetransfer_projects_agentPools_patchSignal(output);
        Q_EMIT storagetransfer_projects_agentPools_patchSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("https://www.googleapis.com/auth/cloud-platform");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT storagetransfer_projects_agentPools_patchSignalE(output, error_type, error_str);
        Q_EMIT storagetransfer_projects_agentPools_patchSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT storagetransfer_projects_agentPools_patchSignalError(output, error_type, error_str);
        Q_EMIT storagetransfer_projects_agentPools_patchSignalErrorFull(worker, error_type, error_str);
    }
}
