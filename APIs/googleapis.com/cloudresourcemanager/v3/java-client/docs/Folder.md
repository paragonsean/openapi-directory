...
|**state** | [**StateEnum**](#StateEnum) | Output only. The lifecycle state of the folder. Updates to the state must be performed using DeleteFolder and UndeleteFolder. |  [optional] [readonly] |
