...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudResourceManagerApi.TagHold();
  });
  ...
  describe('TagHold', function() {
    it('should create an instance of TagHold', function() {
      // uncomment below and update the code to test TagHold
      //var instance = new CloudResourceManagerApi.TagHold();
      //expect(instance).to.be.a(CloudResourceManagerApi.TagHold);
    });
