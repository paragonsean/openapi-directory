...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudResourceManagerApi.ListFoldersResponse();
  });
  ...
  describe('ListFoldersResponse', function() {
    it('should create an instance of ListFoldersResponse', function() {
      ...
      //var instance = new CloudResourceManagerApi.ListFoldersResponse();
      //expect(instance).to.be.a(CloudResourceManagerApi.ListFoldersResponse);
    });
