...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudResourceManagerApi.SearchFoldersResponse();
  });
  ...
  describe('SearchFoldersResponse', function() {
    it('should create an instance of SearchFoldersResponse', function() {
      // uncomment below and update the code to test SearchFoldersResponse
      //var instance = new CloudResourceManagerApi.SearchFoldersResponse();
      //expect(instance).to.be.a(CloudResourceManagerApi.SearchFoldersResponse);
    });
