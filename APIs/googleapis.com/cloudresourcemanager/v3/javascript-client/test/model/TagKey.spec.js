...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudResourceManagerApi.TagKey();
  });
  ...
  describe('TagKey', function() {
    it('should create an instance of TagKey', function() {
      ...
      //var instance = new CloudResourceManagerApi.TagKey();
      //expect(instance).to.be.a(CloudResourceManagerApi.TagKey);
    });
    ...
    it('should have the property namespacedName (base name: "namespacedName")', function() {
      // uncomment below and update the code to test the property namespacedName
      //var instance = new CloudResourceManagerApi.TagKey();
      //expect(instance).to.be();
    });
    ...
    it('should have the property purposeData (base name: "purposeData")', function() {
      // uncomment below and update the code to test the property purposeData
      //var instance = new CloudResourceManagerApi.TagKey();
      //expect(instance).to.be();
    });
