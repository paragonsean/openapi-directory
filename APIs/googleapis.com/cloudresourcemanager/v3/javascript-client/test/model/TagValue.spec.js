...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudResourceManagerApi.TagValue();
  });
  ...
  describe('TagValue', function() {
    it('should create an instance of TagValue', function() {
      ...
      //var instance = new CloudResourceManagerApi.TagValue();
      //expect(instance).to.be.a(CloudResourceManagerApi.TagValue);
    });
