...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudResourceManagerApi.SearchProjectsResponse();
  });
  ...
  describe('SearchProjectsResponse', function() {
    it('should create an instance of SearchProjectsResponse', function() {
      // uncomment below and update the code to test SearchProjectsResponse
      //var instance = new CloudResourceManagerApi.SearchProjectsResponse();
      //expect(instance).to.be.a(CloudResourceManagerApi.SearchProjectsResponse);
    });
