...
let opts = {
  ...
  'parent': "parent_example", // String | Required. The name of the parent resource whose projects are being listed. Only children of this parent resource are listed; descendants are not listed. If the parent is a folder, use the value `folders/{folder_id}`. If the parent is an organization, use the value `organizations/{org_id}`.
  'showDeleted': true // Boolean | Optional. Indicate that projects in the `DELETE_REQUESTED` state should also be returned. Normally only `ACTIVE` projects are returned.
};
...
> Operation cloudresourcemanagerProjectsMove(name, opts)
...
let apiInstance = new CloudResourceManagerApi.ProjectsApi();
let name = "name_example"; // String | Required. The name of the project to move.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'moveProjectRequest': new CloudResourceManagerApi.MoveProjectRequest() // MoveProjectRequest | 
};
apiInstance.cloudresourcemanagerProjectsMove(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> SearchProjectsResponse cloudresourcemanagerProjectsSearch(opts)
...
apiInstance.cloudresourcemanagerProjectsSearch(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Operation cloudresourcemanagerProjectsUndelete(name, opts)
...
let apiInstance = new CloudResourceManagerApi.ProjectsApi();
let name = "name_example"; // String | Required. The name of the project (for example, `projects/415104041262`). Required.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
apiInstance.cloudresourcemanagerProjectsUndelete(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
