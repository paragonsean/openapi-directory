# CloudResourceManagerApi.SearchProjectsResponse
...
**projects** | [**[Project]**](Project.md) | The list of Projects that matched the list filter query. This list can be paginated. | [optional] 
