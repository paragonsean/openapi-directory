# CloudResourceManagerApi.ListEffectiveTagsResponse

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**effectiveTags** | [**[EffectiveTag]**](EffectiveTag.md) | A possibly paginated list of effective tags for the specified resource. | [optional] 
