...
/**
 * The SearchProjectsResponse model module.
 * @module model/SearchProjectsResponse
 * @version v3
 */
class SearchProjectsResponse {
    /**
     * Constructs a new <code>SearchProjectsResponse</code>.
     ...
     * @alias module:model/SearchProjectsResponse
     */
    constructor() { 
        
        SearchProjectsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SearchProjectsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SearchProjectsResponse} obj Optional instance to populate.
     * @return {module:model/SearchProjectsResponse} The populated <code>SearchProjectsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SearchProjectsResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>SearchProjectsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SearchProjectsResponse</code>.
     */
 ...
 */
SearchProjectsResponse.prototype['nextPageToken'] = undefined;
 ...
 */
SearchProjectsResponse.prototype['projects'] = undefined;
...
export default SearchProjectsResponse;
