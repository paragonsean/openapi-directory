...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudResourceManagerApi.Operation();
  });
  ...
  describe('Operation', function() {
    it('should create an instance of Operation', function() {
      ...
      //var instance = new CloudResourceManagerApi.Operation();
      //expect(instance).to.be.a(CloudResourceManagerApi.Operation);
    });
