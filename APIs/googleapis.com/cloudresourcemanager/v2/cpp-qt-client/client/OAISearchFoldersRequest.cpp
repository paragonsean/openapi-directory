...
qint32 OAISearchFoldersRequest::getPageSize() const {
    return m_page_size;
}
void OAISearchFoldersRequest::setPageSize(const qint32 &page_size) {
    m_page_size = page_size;
    m_page_size_isSet = true;
}

bool OAISearchFoldersRequest::is_page_size_Set() const{
    return m_page_size_isSet;
}

bool OAISearchFoldersRequest::is_page_size_Valid() const{
    return m_page_size_isValid;
}

QString OAISearchFoldersRequest::getPageToken() const {
    return m_page_token;
}
void OAISearchFoldersRequest::setPageToken(const QString &page_token) {
    m_page_token = page_token;
    m_page_token_isSet = true;
}

bool OAISearchFoldersRequest::is_page_token_Set() const{
    return m_page_token_isSet;
}

bool OAISearchFoldersRequest::is_page_token_Valid() const{
    return m_page_token_isValid;
}

QString OAISearchFoldersRequest::getQuery() const {
    return m_query;
}
void OAISearchFoldersRequest::setQuery(const QString &query) {
    m_query = query;
    m_query_isSet = true;
}

bool OAISearchFoldersRequest::is_query_Set() const{
    return m_query_isSet;
}

bool OAISearchFoldersRequest::is_query_Valid() const{
