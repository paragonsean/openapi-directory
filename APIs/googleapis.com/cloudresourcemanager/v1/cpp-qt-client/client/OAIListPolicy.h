...
#ifndef OAIListPolicy_H
#define OAIListPolicy_H
...
class OAIListPolicy : public OAIObject {
public:
    OAIListPolicy();
    OAIListPolicy(QString json);
    ~OAIListPolicy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListPolicy)

#endif // OAIListPolicy_H
