...
public class ListPolicy {
  ...
  public ListPolicy allValues(AllValuesEnum allValues) {
  ...
  public ListPolicy allowedValues(List<String> allowedValues) {
    this.allowedValues = allowedValues;
    return this;
  }

  public ListPolicy addAllowedValuesItem(String allowedValuesItem) {
  ...
  public ListPolicy deniedValues(List<String> deniedValues) {
    this.deniedValues = deniedValues;
    return this;
  }

  public ListPolicy addDeniedValuesItem(String deniedValuesItem) {
  ...
  public ListPolicy inheritFromParent(Boolean inheritFromParent) {
  ...
  public ListPolicy suggestedValue(String suggestedValue) {
  ...
  public boolean equals(Object o) {
    ...
    ListPolicy listPolicy = (ListPolicy) o;
    return Objects.equals(this.allValues, listPolicy.allValues) &&
        Objects.equals(this.allowedValues, listPolicy.allowedValues) &&
        Objects.equals(this.deniedValues, listPolicy.deniedValues) &&
        Objects.equals(this.inheritFromParent, listPolicy.inheritFromParent) &&
        Objects.equals(this.suggestedValue, listPolicy.suggestedValue);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListPolicy
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListPolicy.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListPolicy is not found in the empty JSON string", ListPolicy.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListPolicy.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListPolicy` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListPolicy.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListPolicy' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListPolicy> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListPolicy.class));

       return (TypeAdapter<T>) new TypeAdapter<ListPolicy>() {
           @Override
           public void write(JsonWriter out, ListPolicy value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListPolicy read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListPolicy given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListPolicy
   * @throws IOException if the JSON string is invalid with respect to ListPolicy
   */
  public static ListPolicy fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListPolicy.class);
  }

  /**
   * Convert an instance of ListPolicy to an JSON string
   *
   * @return JSON string
   */
