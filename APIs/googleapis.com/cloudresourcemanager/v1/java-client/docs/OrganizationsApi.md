...
> Organization cloudresourcemanagerOrganizationsGet(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Organization result = apiInstance.cloudresourcemanagerOrganizationsGet(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType);
...
> SearchOrganizationsResponse cloudresourcemanagerOrganizationsSearch($xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, searchOrganizationsRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    String uploadProtocol = "uploadProtocol_example"; // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
    String uploadType = "uploadType_example"; // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
    SearchOrganizationsRequest searchOrganizationsRequest = new SearchOrganizationsRequest(); // SearchOrganizationsRequest | 
    try {
      SearchOrganizationsResponse result = apiInstance.cloudresourcemanagerOrganizationsSearch($xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, searchOrganizationsRequest);
      System.out.println(result);
    } catch (ApiException e) {
