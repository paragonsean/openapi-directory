...
------------- | ------------- | -------------
[**cloudresourcemanagerOrganizationsGet**](OrganizationsApi.md#cloudresourcemanagerOrganizationsGet) | **GET** /v1/{name} | 
[**cloudresourcemanagerOrganizationsGetIamPolicy**](OrganizationsApi.md#cloudresourcemanagerOrganizationsGetIamPolicy) | **POST** /v1/{resource}:getIamPolicy | 
[**cloudresourcemanagerOrganizationsSearch**](OrganizationsApi.md#cloudresourcemanagerOrganizationsSearch) | **POST** /v1/organizations:search | 
[**cloudresourcemanagerOrganizationsSetIamPolicy**](OrganizationsApi.md#cloudresourcemanagerOrganizationsSetIamPolicy) | **POST** /v1/{resource}:setIamPolicy | 
[**cloudresourcemanagerOrganizationsTestIamPermissions**](OrganizationsApi.md#cloudresourcemanagerOrganizationsTestIamPermissions) | **POST** /v1/{resource}:testIamPermissions | 



## cloudresourcemanagerOrganizationsGet

> Organization cloudresourcemanagerOrganizationsGet(name, opts)
...
let name = "name_example"; // String | The resource name of the Organization to fetch. This is the organization's relative path in the API, formatted as \"organizations/[organizationId]\". For example, \"organizations/1234\".
let opts = {
...
apiInstance.cloudresourcemanagerOrganizationsGet(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> Policy cloudresourcemanagerOrganizationsGetIamPolicy(resource, opts)
...
apiInstance.cloudresourcemanagerOrganizationsGetIamPolicy(resource, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'searchOrganizationsRequest': new CloudResourceManagerApi.SearchOrganizationsRequest() // SearchOrganizationsRequest | 
};
 ...
 **uploadProtocol** | **String**| Upload protocol for media (e.g. \&quot;raw\&quot;, \&quot;multipart\&quot;). | [optional] 
 **uploadType** | **String**| Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;). | [optional] 
 **searchOrganizationsRequest** | [**SearchOrganizationsRequest**](SearchOrganizationsRequest.md)|  | [optional] 
...
> Policy cloudresourcemanagerOrganizationsSetIamPolicy(resource, opts)
...
apiInstance.cloudresourcemanagerOrganizationsSetIamPolicy(resource, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> TestIamPermissionsResponse cloudresourcemanagerOrganizationsTestIamPermissions(resource, opts)
...
apiInstance.cloudresourcemanagerOrganizationsTestIamPermissions(resource, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
