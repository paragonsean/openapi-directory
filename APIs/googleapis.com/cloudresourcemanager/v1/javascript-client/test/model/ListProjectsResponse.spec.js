...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudResourceManagerApi.ListProjectsResponse();
  });
  ...
  describe('ListProjectsResponse', function() {
    it('should create an instance of ListProjectsResponse', function() {
      // uncomment below and update the code to test ListProjectsResponse
      //var instance = new CloudResourceManagerApi.ListProjectsResponse();
      //expect(instance).to.be.a(CloudResourceManagerApi.ListProjectsResponse);
    });
