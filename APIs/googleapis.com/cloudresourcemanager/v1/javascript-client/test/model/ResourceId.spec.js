...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudResourceManagerApi.ResourceId();
  });
  ...
  describe('ResourceId', function() {
    it('should create an instance of ResourceId', function() {
      ...
      //var instance = new CloudResourceManagerApi.ResourceId();
      //expect(instance).to.be.a(CloudResourceManagerApi.ResourceId);
    });
