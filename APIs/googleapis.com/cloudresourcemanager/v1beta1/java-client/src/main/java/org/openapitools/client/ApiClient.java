...
public class ApiClient {
    ...
    private String basePath = "https://cloudresourcemanager.googleapis.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/v1beta1/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://cloudresourcemanager.googleapis.com
