# CloudResourceManagerApi.ListOrganizationsResponse
...
**organizations** | [**[Organization]**](Organization.md) | The list of Organizations that matched the list query, possibly paginated. | [optional] 
