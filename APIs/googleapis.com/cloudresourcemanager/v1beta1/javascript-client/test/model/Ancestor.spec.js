...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudResourceManagerApi.Ancestor();
  });
  ...
  describe('Ancestor', function() {
    it('should create an instance of Ancestor', function() {
      // uncomment below and update the code to test Ancestor
      //var instance = new CloudResourceManagerApi.Ancestor();
      //expect(instance).to.be.a(CloudResourceManagerApi.Ancestor);
    });
