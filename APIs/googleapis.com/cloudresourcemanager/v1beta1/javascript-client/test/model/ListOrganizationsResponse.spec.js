...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudResourceManagerApi.ListOrganizationsResponse();
  });
  ...
  describe('ListOrganizationsResponse', function() {
    it('should create an instance of ListOrganizationsResponse', function() {
      // uncomment below and update the code to test ListOrganizationsResponse
      //var instance = new CloudResourceManagerApi.ListOrganizationsResponse();
      //expect(instance).to.be.a(CloudResourceManagerApi.ListOrganizationsResponse);
    });
