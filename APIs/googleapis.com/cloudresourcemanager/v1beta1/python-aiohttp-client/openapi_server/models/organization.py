...
class Organization(Model):
    ...
    def __init__(self, creation_time: str=None, display_name: str=None, lifecycle_state: str=None, name: str=None, organization_id: str=None, owner: OrganizationOwner=None):
