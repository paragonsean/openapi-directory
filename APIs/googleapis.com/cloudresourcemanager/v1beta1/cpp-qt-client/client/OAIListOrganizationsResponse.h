...
/*
 * OAIListOrganizationsResponse.h
 *
 * The response returned from the &#x60;ListOrganizations&#x60; method.
 */

#ifndef OAIListOrganizationsResponse_H
#define OAIListOrganizationsResponse_H
...
class OAIListOrganizationsResponse : public OAIObject {
public:
    OAIListOrganizationsResponse();
    OAIListOrganizationsResponse(QString json);
    ~OAIListOrganizationsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListOrganizationsResponse)

#endif // OAIListOrganizationsResponse_H
