...
Q_SIGNALS:
    ...
    void cloudresourcemanager_projects_createSignal(OAIProject summary);
    ...
    void cloudresourcemanager_projects_createSignalFull(OAIHttpRequestWorker *worker, OAIProject summary);
    ...
    void cloudresourcemanager_projects_createSignalE(OAIProject summary, QNetworkReply::NetworkError error_type, QString error_str);
    void cloudresourcemanager_projects_createSignalError(OAIProject summary, QNetworkReply::NetworkError error_type, const QString &error_str);
