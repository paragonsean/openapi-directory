...
public class GoogleCloudDialogflowV2beta1InputAudioConfig {
  ...
  private List<GoogleCloudDialogflowV2beta1SpeechContext> speechContexts = new ArrayList<>();

  public GoogleCloudDialogflowV2beta1InputAudioConfig() {
  }

  public GoogleCloudDialogflowV2beta1InputAudioConfig audioEncoding(AudioEncodingEnum audioEncoding) {
  ...
  public GoogleCloudDialogflowV2beta1InputAudioConfig bargeInConfig(GoogleCloudDialogflowV2beta1BargeInConfig bargeInConfig) {
  ...
  public void setBargeInConfig(GoogleCloudDialogflowV2beta1BargeInConfig bargeInConfig) {
    this.bargeInConfig = bargeInConfig;
  }


  public GoogleCloudDialogflowV2beta1InputAudioConfig disableNoSpeechRecognizedEvent(Boolean disableNoSpeechRecognizedEvent) {
  ...
  public GoogleCloudDialogflowV2beta1InputAudioConfig enableAutomaticPunctuation(Boolean enableAutomaticPunctuation) {
  ...
  public GoogleCloudDialogflowV2beta1InputAudioConfig enableWordInfo(Boolean enableWordInfo) {
  ...
  public GoogleCloudDialogflowV2beta1InputAudioConfig languageCode(String languageCode) {
  ...
  public GoogleCloudDialogflowV2beta1InputAudioConfig model(String model) {
    this.model = model;
    return this;
  }
  ...
  public GoogleCloudDialogflowV2beta1InputAudioConfig modelVariant(ModelVariantEnum modelVariant) {
  ...
  public GoogleCloudDialogflowV2beta1InputAudioConfig optOutConformerModelMigration(Boolean optOutConformerModelMigration) {
  ...
  @Deprecated
  public GoogleCloudDialogflowV2beta1InputAudioConfig phraseHints(List<String> phraseHints) {
    this.phraseHints = phraseHints;
    return this;
  }

  public GoogleCloudDialogflowV2beta1InputAudioConfig addPhraseHintsItem(String phraseHintsItem) {
  ...
  public GoogleCloudDialogflowV2beta1InputAudioConfig sampleRateHertz(Integer sampleRateHertz) {
  ...
  public GoogleCloudDialogflowV2beta1InputAudioConfig singleUtterance(Boolean singleUtterance) {
  ...
  public GoogleCloudDialogflowV2beta1InputAudioConfig speechContexts(List<GoogleCloudDialogflowV2beta1SpeechContext> speechContexts) {
    this.speechContexts = speechContexts;
    return this;
  }

  public GoogleCloudDialogflowV2beta1InputAudioConfig addSpeechContextsItem(GoogleCloudDialogflowV2beta1SpeechContext speechContextsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<GoogleCloudDialogflowV2beta1SpeechContext> getSpeechContexts() {
    return speechContexts;
  }

  public void setSpeechContexts(List<GoogleCloudDialogflowV2beta1SpeechContext> speechContexts) {
    this.speechContexts = speechContexts;
  }
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudDialogflowV2beta1InputAudioConfig googleCloudDialogflowV2beta1InputAudioConfig = (GoogleCloudDialogflowV2beta1InputAudioConfig) o;
    return Objects.equals(this.audioEncoding, googleCloudDialogflowV2beta1InputAudioConfig.audioEncoding) &&
        Objects.equals(this.bargeInConfig, googleCloudDialogflowV2beta1InputAudioConfig.bargeInConfig) &&
        Objects.equals(this.disableNoSpeechRecognizedEvent, googleCloudDialogflowV2beta1InputAudioConfig.disableNoSpeechRecognizedEvent) &&
        Objects.equals(this.enableAutomaticPunctuation, googleCloudDialogflowV2beta1InputAudioConfig.enableAutomaticPunctuation) &&
        Objects.equals(this.enableWordInfo, googleCloudDialogflowV2beta1InputAudioConfig.enableWordInfo) &&
        Objects.equals(this.languageCode, googleCloudDialogflowV2beta1InputAudioConfig.languageCode) &&
        Objects.equals(this.model, googleCloudDialogflowV2beta1InputAudioConfig.model) &&
        Objects.equals(this.modelVariant, googleCloudDialogflowV2beta1InputAudioConfig.modelVariant) &&
        Objects.equals(this.optOutConformerModelMigration, googleCloudDialogflowV2beta1InputAudioConfig.optOutConformerModelMigration) &&
        Objects.equals(this.phraseHints, googleCloudDialogflowV2beta1InputAudioConfig.phraseHints) &&
        Objects.equals(this.sampleRateHertz, googleCloudDialogflowV2beta1InputAudioConfig.sampleRateHertz) &&
        Objects.equals(this.singleUtterance, googleCloudDialogflowV2beta1InputAudioConfig.singleUtterance) &&
        Objects.equals(this.speechContexts, googleCloudDialogflowV2beta1InputAudioConfig.speechContexts);
  }

  @Override
  public int hashCode() {
    return Objects.hash(audioEncoding, bargeInConfig, disableNoSpeechRecognizedEvent, enableAutomaticPunctuation, enableWordInfo, languageCode, model, modelVariant, optOutConformerModelMigration, phraseHints, sampleRateHertz, singleUtterance, speechContexts);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GoogleCloudDialogflowV2beta1InputAudioConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudDialogflowV2beta1InputAudioConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudDialogflowV2beta1InputAudioConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudDialogflowV2beta1InputAudioConfig is not found in the empty JSON string", GoogleCloudDialogflowV2beta1InputAudioConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudDialogflowV2beta1InputAudioConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudDialogflowV2beta1InputAudioConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("bargeInConfig") != null && !jsonObj.get("bargeInConfig").isJsonNull()) {
        GoogleCloudDialogflowV2beta1BargeInConfig.validateJsonElement(jsonObj.get("bargeInConfig"));
      }
      ...
      if (jsonObj.get("speechContexts") != null && !jsonObj.get("speechContexts").isJsonNull()) {
        ...
        if (jsonArrayspeechContexts != null) {
          ...
          for (int i = 0; i < jsonArrayspeechContexts.size(); i++) {
            GoogleCloudDialogflowV2beta1SpeechContext.validateJsonElement(jsonArrayspeechContexts.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudDialogflowV2beta1InputAudioConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudDialogflowV2beta1InputAudioConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudDialogflowV2beta1InputAudioConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudDialogflowV2beta1InputAudioConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudDialogflowV2beta1InputAudioConfig>() {
           @Override
           public void write(JsonWriter out, GoogleCloudDialogflowV2beta1InputAudioConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudDialogflowV2beta1InputAudioConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudDialogflowV2beta1InputAudioConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudDialogflowV2beta1InputAudioConfig
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudDialogflowV2beta1InputAudioConfig
   */
  public static GoogleCloudDialogflowV2beta1InputAudioConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudDialogflowV2beta1InputAudioConfig.class);
  }

  /**
   * Convert an instance of GoogleCloudDialogflowV2beta1InputAudioConfig to an JSON string
   *
   * @return JSON string
   */
