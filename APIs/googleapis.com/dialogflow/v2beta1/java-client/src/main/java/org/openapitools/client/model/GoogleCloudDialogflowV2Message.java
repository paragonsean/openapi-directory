...
public class GoogleCloudDialogflowV2Message {
  ...
  public GoogleCloudDialogflowV2Message content(String content) {
  ...
  public GoogleCloudDialogflowV2Message languageCode(String languageCode) {
  ...
  public GoogleCloudDialogflowV2Message messageAnnotation(GoogleCloudDialogflowV2MessageAnnotation messageAnnotation) {
  ...
  public void setMessageAnnotation(GoogleCloudDialogflowV2MessageAnnotation messageAnnotation) {
    this.messageAnnotation = messageAnnotation;
  }


  public GoogleCloudDialogflowV2Message name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GoogleCloudDialogflowV2Message sendTime(String sendTime) {
  ...
  public GoogleCloudDialogflowV2Message sentimentAnalysis(GoogleCloudDialogflowV2SentimentAnalysisResult sentimentAnalysis) {
  ...
  public void setSentimentAnalysis(GoogleCloudDialogflowV2SentimentAnalysisResult sentimentAnalysis) {
    this.sentimentAnalysis = sentimentAnalysis;
  }
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudDialogflowV2Message googleCloudDialogflowV2Message = (GoogleCloudDialogflowV2Message) o;
    return Objects.equals(this.content, googleCloudDialogflowV2Message.content) &&
        Objects.equals(this.createTime, googleCloudDialogflowV2Message.createTime) &&
        Objects.equals(this.languageCode, googleCloudDialogflowV2Message.languageCode) &&
        Objects.equals(this.messageAnnotation, googleCloudDialogflowV2Message.messageAnnotation) &&
        Objects.equals(this.name, googleCloudDialogflowV2Message.name) &&
        Objects.equals(this.participant, googleCloudDialogflowV2Message.participant) &&
        Objects.equals(this.participantRole, googleCloudDialogflowV2Message.participantRole) &&
        Objects.equals(this.sendTime, googleCloudDialogflowV2Message.sendTime) &&
        Objects.equals(this.sentimentAnalysis, googleCloudDialogflowV2Message.sentimentAnalysis);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudDialogflowV2Message {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudDialogflowV2Message
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudDialogflowV2Message.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudDialogflowV2Message is not found in the empty JSON string", GoogleCloudDialogflowV2Message.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudDialogflowV2Message.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudDialogflowV2Message` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("messageAnnotation") != null && !jsonObj.get("messageAnnotation").isJsonNull()) {
        GoogleCloudDialogflowV2MessageAnnotation.validateJsonElement(jsonObj.get("messageAnnotation"));
      }
      ...
      if (jsonObj.get("sentimentAnalysis") != null && !jsonObj.get("sentimentAnalysis").isJsonNull()) {
        GoogleCloudDialogflowV2SentimentAnalysisResult.validateJsonElement(jsonObj.get("sentimentAnalysis"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudDialogflowV2Message.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudDialogflowV2Message' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudDialogflowV2Message> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudDialogflowV2Message.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudDialogflowV2Message>() {
           @Override
           public void write(JsonWriter out, GoogleCloudDialogflowV2Message value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudDialogflowV2Message read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudDialogflowV2Message given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudDialogflowV2Message
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudDialogflowV2Message
   */
  public static GoogleCloudDialogflowV2Message fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudDialogflowV2Message.class);
  }

  /**
   * Convert an instance of GoogleCloudDialogflowV2Message to an JSON string
   *
   * @return JSON string
   */
