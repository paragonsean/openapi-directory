...
public class GoogleCloudDialogflowV2beta1Conversation {
  ...
  public GoogleCloudDialogflowV2beta1Conversation conversationProfile(String conversationProfile) {
  ...
  public GoogleCloudDialogflowV2beta1Conversation conversationStage(ConversationStageEnum conversationStage) {
  ...
  public GoogleCloudDialogflowV2beta1Conversation phoneNumber(GoogleCloudDialogflowV2beta1ConversationPhoneNumber phoneNumber) {
  ...
  public void setPhoneNumber(GoogleCloudDialogflowV2beta1ConversationPhoneNumber phoneNumber) {
    this.phoneNumber = phoneNumber;
  }
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudDialogflowV2beta1Conversation googleCloudDialogflowV2beta1Conversation = (GoogleCloudDialogflowV2beta1Conversation) o;
    return Objects.equals(this.conversationProfile, googleCloudDialogflowV2beta1Conversation.conversationProfile) &&
        Objects.equals(this.conversationStage, googleCloudDialogflowV2beta1Conversation.conversationStage) &&
        Objects.equals(this.endTime, googleCloudDialogflowV2beta1Conversation.endTime) &&
        Objects.equals(this.lifecycleState, googleCloudDialogflowV2beta1Conversation.lifecycleState) &&
        Objects.equals(this.name, googleCloudDialogflowV2beta1Conversation.name) &&
        Objects.equals(this.phoneNumber, googleCloudDialogflowV2beta1Conversation.phoneNumber) &&
        Objects.equals(this.startTime, googleCloudDialogflowV2beta1Conversation.startTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudDialogflowV2beta1Conversation {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudDialogflowV2beta1Conversation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudDialogflowV2beta1Conversation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudDialogflowV2beta1Conversation is not found in the empty JSON string", GoogleCloudDialogflowV2beta1Conversation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudDialogflowV2beta1Conversation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudDialogflowV2beta1Conversation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("phoneNumber") != null && !jsonObj.get("phoneNumber").isJsonNull()) {
        GoogleCloudDialogflowV2beta1ConversationPhoneNumber.validateJsonElement(jsonObj.get("phoneNumber"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudDialogflowV2beta1Conversation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudDialogflowV2beta1Conversation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudDialogflowV2beta1Conversation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudDialogflowV2beta1Conversation.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudDialogflowV2beta1Conversation>() {
           @Override
           public void write(JsonWriter out, GoogleCloudDialogflowV2beta1Conversation value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudDialogflowV2beta1Conversation read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudDialogflowV2beta1Conversation given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudDialogflowV2beta1Conversation
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudDialogflowV2beta1Conversation
   */
  public static GoogleCloudDialogflowV2beta1Conversation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudDialogflowV2beta1Conversation.class);
  }

  /**
   * Convert an instance of GoogleCloudDialogflowV2beta1Conversation to an JSON string
   *
   * @return JSON string
   */
