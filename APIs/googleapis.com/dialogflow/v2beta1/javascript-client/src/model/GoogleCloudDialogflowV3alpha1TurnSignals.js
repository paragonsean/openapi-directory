...
/**
 * The GoogleCloudDialogflowV3alpha1TurnSignals model module.
 * @module model/GoogleCloudDialogflowV3alpha1TurnSignals
 * @version v2beta1
 */
class GoogleCloudDialogflowV3alpha1TurnSignals {
    /**
     * Constructs a new <code>GoogleCloudDialogflowV3alpha1TurnSignals</code>.
     * Collection of all signals that were extracted for a single turn of the conversation.
     * @alias module:model/GoogleCloudDialogflowV3alpha1TurnSignals
     */
    constructor() { 
        
        GoogleCloudDialogflowV3alpha1TurnSignals.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudDialogflowV3alpha1TurnSignals</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudDialogflowV3alpha1TurnSignals} obj Optional instance to populate.
     * @return {module:model/GoogleCloudDialogflowV3alpha1TurnSignals} The populated <code>GoogleCloudDialogflowV3alpha1TurnSignals</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudDialogflowV3alpha1TurnSignals();
            ...
            if (data.hasOwnProperty('triggeredAbandonmentEvent')) {
                obj['triggeredAbandonmentEvent'] = ApiClient.convertToType(data['triggeredAbandonmentEvent'], 'Boolean');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudDialogflowV3alpha1TurnSignals</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudDialogflowV3alpha1TurnSignals</code>.
     */
 ...
 */
GoogleCloudDialogflowV3alpha1TurnSignals.prototype['agentEscalated'] = undefined;

/**
 * Whether user was using DTMF input.
 * @member {Boolean} dtmfUsed
 */
GoogleCloudDialogflowV3alpha1TurnSignals.prototype['dtmfUsed'] = undefined;

/**
 * Failure reasons of the turn.
 * @member {Array.<module:model/GoogleCloudDialogflowV3alpha1TurnSignals.FailureReasonsEnum>} failureReasons
 */
GoogleCloudDialogflowV3alpha1TurnSignals.prototype['failureReasons'] = undefined;

/**
 * Whether NLU predicted NO_MATCH.
 * @member {Boolean} noMatch
 */
GoogleCloudDialogflowV3alpha1TurnSignals.prototype['noMatch'] = undefined;

/**
 * Whether user provided no input.
 * @member {Boolean} noUserInput
 */
GoogleCloudDialogflowV3alpha1TurnSignals.prototype['noUserInput'] = undefined;

/**
 * Whether turn resulted in End Session page.
 * @member {Boolean} reachedEndPage
 */
GoogleCloudDialogflowV3alpha1TurnSignals.prototype['reachedEndPage'] = undefined;
 ...
 */
GoogleCloudDialogflowV3alpha1TurnSignals.prototype['sentimentMagnitude'] = undefined;
 ...
 */
GoogleCloudDialogflowV3alpha1TurnSignals.prototype['sentimentScore'] = undefined;

/**
 * Whether agent has triggered the event corresponding to user abandoning the conversation.
 * @member {Boolean} triggeredAbandonmentEvent
 */
GoogleCloudDialogflowV3alpha1TurnSignals.prototype['triggeredAbandonmentEvent'] = undefined;

/**
 * Whether user was specifically asking for a live agent.
 * @member {Boolean} userEscalated
 */
GoogleCloudDialogflowV3alpha1TurnSignals.prototype['userEscalated'] = undefined;

/**
 * Human-readable statuses of the webhooks triggered during this turn.
 * @member {Array.<String>} webhookStatuses
 */
GoogleCloudDialogflowV3alpha1TurnSignals.prototype['webhookStatuses'] = undefined;
 ...
 * @readonly
 */
GoogleCloudDialogflowV3alpha1TurnSignals['FailureReasonsEnum'] = {
...
export default GoogleCloudDialogflowV3alpha1TurnSignals;
