...
/**
 * The GoogleCloudDialogflowV2beta1Agent model module.
 * @module model/GoogleCloudDialogflowV2beta1Agent
 * @version v2beta1
 */
class GoogleCloudDialogflowV2beta1Agent {
    /**
     * Constructs a new <code>GoogleCloudDialogflowV2beta1Agent</code>.
     ...
     * @alias module:model/GoogleCloudDialogflowV2beta1Agent
     */
    constructor() { 
        
        GoogleCloudDialogflowV2beta1Agent.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudDialogflowV2beta1Agent</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudDialogflowV2beta1Agent} obj Optional instance to populate.
     * @return {module:model/GoogleCloudDialogflowV2beta1Agent} The populated <code>GoogleCloudDialogflowV2beta1Agent</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudDialogflowV2beta1Agent();
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudDialogflowV2beta1Agent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudDialogflowV2beta1Agent</code>.
     */
 ...
 * @member {module:model/GoogleCloudDialogflowV2beta1Agent.ApiVersionEnum} apiVersion
 */
GoogleCloudDialogflowV2beta1Agent.prototype['apiVersion'] = undefined;
 ...
 */
GoogleCloudDialogflowV2beta1Agent.prototype['avatarUri'] = undefined;
 ...
 */
GoogleCloudDialogflowV2beta1Agent.prototype['classificationThreshold'] = undefined;
 ...
 */
GoogleCloudDialogflowV2beta1Agent.prototype['defaultLanguageCode'] = undefined;

/**
 * Optional. The description of this agent. The maximum length is 500 characters. If exceeded, the request is rejected.
 * @member {String} description
 */
GoogleCloudDialogflowV2beta1Agent.prototype['description'] = undefined;

/**
 * Required. The name of this agent.
 * @member {String} displayName
 */
GoogleCloudDialogflowV2beta1Agent.prototype['displayName'] = undefined;

/**
 * Optional. Determines whether this agent should log conversation queries.
 * @member {Boolean} enableLogging
 */
GoogleCloudDialogflowV2beta1Agent.prototype['enableLogging'] = undefined;

/**
 * Optional. Determines how intents are detected from user queries.
 * @member {module:model/GoogleCloudDialogflowV2beta1Agent.MatchModeEnum} matchMode
 */
GoogleCloudDialogflowV2beta1Agent.prototype['matchMode'] = undefined;

/**
 * Required. The project of this agent. Format: `projects/` or `projects//locations/`
 * @member {String} parent
 */
GoogleCloudDialogflowV2beta1Agent.prototype['parent'] = undefined;
 ...
 */
GoogleCloudDialogflowV2beta1Agent.prototype['supportedLanguageCodes'] = undefined;

/**
 * Optional. The agent tier. If not specified, TIER_STANDARD is assumed.
 * @member {module:model/GoogleCloudDialogflowV2beta1Agent.TierEnum} tier
 */
GoogleCloudDialogflowV2beta1Agent.prototype['tier'] = undefined;
 ...
 */
GoogleCloudDialogflowV2beta1Agent.prototype['timeZone'] = undefined;
 ...
 * @readonly
 */
GoogleCloudDialogflowV2beta1Agent['ApiVersionEnum'] = {
 ...
 * @readonly
 */
GoogleCloudDialogflowV2beta1Agent['MatchModeEnum'] = {
 ...
 * @readonly
 */
GoogleCloudDialogflowV2beta1Agent['TierEnum'] = {
...
export default GoogleCloudDialogflowV2beta1Agent;
