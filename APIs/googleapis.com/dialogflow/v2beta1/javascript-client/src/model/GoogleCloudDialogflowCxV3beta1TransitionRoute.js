...
/**
 * The GoogleCloudDialogflowCxV3beta1TransitionRoute model module.
 * @module model/GoogleCloudDialogflowCxV3beta1TransitionRoute
 * @version v2beta1
 */
class GoogleCloudDialogflowCxV3beta1TransitionRoute {
    /**
     * Constructs a new <code>GoogleCloudDialogflowCxV3beta1TransitionRoute</code>.
     * A transition route specifies a intent that can be matched and/or a data condition that can be evaluated during a session. When a specified transition is matched, the following actions are taken in order: * If there is a &#x60;trigger_fulfillment&#x60; associated with the transition, it will be called. * If there is a &#x60;target_page&#x60; associated with the transition, the session will transition into the specified page. * If there is a &#x60;target_flow&#x60; associated with the transition, the session will transition into the specified flow.
     * @alias module:model/GoogleCloudDialogflowCxV3beta1TransitionRoute
     */
    constructor() { 
        
        GoogleCloudDialogflowCxV3beta1TransitionRoute.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudDialogflowCxV3beta1TransitionRoute</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudDialogflowCxV3beta1TransitionRoute} obj Optional instance to populate.
     * @return {module:model/GoogleCloudDialogflowCxV3beta1TransitionRoute} The populated <code>GoogleCloudDialogflowCxV3beta1TransitionRoute</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudDialogflowCxV3beta1TransitionRoute();
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudDialogflowCxV3beta1TransitionRoute</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudDialogflowCxV3beta1TransitionRoute</code>.
     */
 ...
 */
GoogleCloudDialogflowCxV3beta1TransitionRoute.prototype['condition'] = undefined;

/**
 * Optional. The description of the transition route. The maximum length is 500 characters.
 * @member {String} description
 */
GoogleCloudDialogflowCxV3beta1TransitionRoute.prototype['description'] = undefined;

/**
 * The unique identifier of an Intent. Format: `projects//locations//agents//intents/`. Indicates that the transition can only happen when the given intent is matched. At least one of `intent` or `condition` must be specified. When both `intent` and `condition` are specified, the transition can only happen when both are fulfilled.
 * @member {String} intent
 */
GoogleCloudDialogflowCxV3beta1TransitionRoute.prototype['intent'] = undefined;

/**
 * Output only. The unique identifier of this transition route.
 * @member {String} name
 */
GoogleCloudDialogflowCxV3beta1TransitionRoute.prototype['name'] = undefined;

/**
 * The target flow to transition to. Format: `projects//locations//agents//flows/`.
 * @member {String} targetFlow
 */
GoogleCloudDialogflowCxV3beta1TransitionRoute.prototype['targetFlow'] = undefined;

/**
 * The target page to transition to. Format: `projects//locations//agents//flows//pages/`.
 * @member {String} targetPage
 */
GoogleCloudDialogflowCxV3beta1TransitionRoute.prototype['targetPage'] = undefined;

/**
 * @member {module:model/GoogleCloudDialogflowCxV3beta1Fulfillment} triggerFulfillment
 */
GoogleCloudDialogflowCxV3beta1TransitionRoute.prototype['triggerFulfillment'] = undefined;
...
export default GoogleCloudDialogflowCxV3beta1TransitionRoute;
