# DialogflowApi.GoogleCloudDialogflowV2beta1HumanAgentAssistantConfigSuggestionQueryConfig
...
**maxResults** | **Number** | Maximum number of results to return. Currently, if unset, defaults to 10. And the max number is 20. | [optional] 
