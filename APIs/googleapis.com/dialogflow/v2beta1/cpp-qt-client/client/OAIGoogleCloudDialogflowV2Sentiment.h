...
/*
 * OAIGoogleCloudDialogflowV2Sentiment.h
 *
...
#ifndef OAIGoogleCloudDialogflowV2Sentiment_H
#define OAIGoogleCloudDialogflowV2Sentiment_H
...
class OAIGoogleCloudDialogflowV2Sentiment : public OAIObject {
public:
    OAIGoogleCloudDialogflowV2Sentiment();
    OAIGoogleCloudDialogflowV2Sentiment(QString json);
    ~OAIGoogleCloudDialogflowV2Sentiment() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudDialogflowV2Sentiment)

#endif // OAIGoogleCloudDialogflowV2Sentiment_H
