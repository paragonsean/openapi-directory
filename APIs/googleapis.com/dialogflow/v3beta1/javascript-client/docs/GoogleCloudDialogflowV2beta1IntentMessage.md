# DialogflowApi.GoogleCloudDialogflowV2beta1IntentMessage
...
**payload** | **{String: Object}** | A custom platform-specific response. | [optional] 
**platform** | **String** | Optional. The platform that this message is intended for. | [optional] 
