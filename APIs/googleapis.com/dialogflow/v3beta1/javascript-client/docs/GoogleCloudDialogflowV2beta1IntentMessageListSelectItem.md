# DialogflowApi.GoogleCloudDialogflowV2beta1IntentMessageListSelectItem

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**description** | **String** | Optional. The main text describing the item. | [optional] 
...
**title** | **String** | Required. The title of the list item. | [optional] 
