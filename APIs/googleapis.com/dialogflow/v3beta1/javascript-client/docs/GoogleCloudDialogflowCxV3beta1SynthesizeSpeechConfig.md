# DialogflowApi.GoogleCloudDialogflowCxV3beta1SynthesizeSpeechConfig

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**effectsProfileId** | **[String]** | Optional. An identifier which selects &#39;audio effects&#39; profiles that are applied on (post synthesized) text to speech. Effects are applied on top of each other in the order they are given. | [optional] 
...
**voice** | [**GoogleCloudDialogflowCxV3beta1VoiceSelectionParams**](GoogleCloudDialogflowCxV3beta1VoiceSelectionParams.md) |  | [optional] 
