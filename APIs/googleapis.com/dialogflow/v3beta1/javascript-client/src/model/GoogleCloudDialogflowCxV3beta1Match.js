...
/**
 * The GoogleCloudDialogflowCxV3beta1Match model module.
 * @module model/GoogleCloudDialogflowCxV3beta1Match
 * @version v3beta1
 */
class GoogleCloudDialogflowCxV3beta1Match {
    /**
     * Constructs a new <code>GoogleCloudDialogflowCxV3beta1Match</code>.
     * Represents one match result of MatchIntent.
     * @alias module:model/GoogleCloudDialogflowCxV3beta1Match
     */
    constructor() { 
        
        GoogleCloudDialogflowCxV3beta1Match.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudDialogflowCxV3beta1Match</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudDialogflowCxV3beta1Match} obj Optional instance to populate.
     * @return {module:model/GoogleCloudDialogflowCxV3beta1Match} The populated <code>GoogleCloudDialogflowCxV3beta1Match</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudDialogflowCxV3beta1Match();
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudDialogflowCxV3beta1Match</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudDialogflowCxV3beta1Match</code>.
     */
 ...
 */
GoogleCloudDialogflowCxV3beta1Match.prototype['confidence'] = undefined;

/**
 * The event that matched the query. Filled for `EVENT`, `NO_MATCH` and `NO_INPUT` match types.
 * @member {String} event
 */
GoogleCloudDialogflowCxV3beta1Match.prototype['event'] = undefined;

/**
 * @member {module:model/GoogleCloudDialogflowCxV3beta1Intent} intent
 */
GoogleCloudDialogflowCxV3beta1Match.prototype['intent'] = undefined;

/**
 * Type of this Match.
 * @member {module:model/GoogleCloudDialogflowCxV3beta1Match.MatchTypeEnum} matchType
 */
GoogleCloudDialogflowCxV3beta1Match.prototype['matchType'] = undefined;
 ...
 */
GoogleCloudDialogflowCxV3beta1Match.prototype['parameters'] = undefined;
 ...
 */
GoogleCloudDialogflowCxV3beta1Match.prototype['resolvedInput'] = undefined;
 ...
 * @readonly
 */
GoogleCloudDialogflowCxV3beta1Match['MatchTypeEnum'] = {
...
export default GoogleCloudDialogflowCxV3beta1Match;
