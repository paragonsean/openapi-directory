...
import GoogleCloudDialogflowCxV3beta1BargeInConfig from './GoogleCloudDialogflowCxV3beta1BargeInConfig';

/**
 * The GoogleCloudDialogflowCxV3beta1InputAudioConfig model module.
 * @module model/GoogleCloudDialogflowCxV3beta1InputAudioConfig
 * @version v3beta1
 */
class GoogleCloudDialogflowCxV3beta1InputAudioConfig {
    /**
     * Constructs a new <code>GoogleCloudDialogflowCxV3beta1InputAudioConfig</code>.
     * Instructs the speech recognizer on how to process the audio content.
     * @alias module:model/GoogleCloudDialogflowCxV3beta1InputAudioConfig
     */
    constructor() { 
        
        GoogleCloudDialogflowCxV3beta1InputAudioConfig.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudDialogflowCxV3beta1InputAudioConfig</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudDialogflowCxV3beta1InputAudioConfig} obj Optional instance to populate.
     * @return {module:model/GoogleCloudDialogflowCxV3beta1InputAudioConfig} The populated <code>GoogleCloudDialogflowCxV3beta1InputAudioConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudDialogflowCxV3beta1InputAudioConfig();
            ...
            if (data.hasOwnProperty('bargeInConfig')) {
                obj['bargeInConfig'] = GoogleCloudDialogflowCxV3beta1BargeInConfig.constructFromObject(data['bargeInConfig']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudDialogflowCxV3beta1InputAudioConfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudDialogflowCxV3beta1InputAudioConfig</code>.
     */
    static validateJSON(data) {
        ...
        if (data['bargeInConfig']) { // data not null
          GoogleCloudDialogflowCxV3beta1BargeInConfig.validateJSON(data['bargeInConfig']);
        }
        // ensure the json data is a string
 ...
 * @member {module:model/GoogleCloudDialogflowCxV3beta1InputAudioConfig.AudioEncodingEnum} audioEncoding
 */
GoogleCloudDialogflowCxV3beta1InputAudioConfig.prototype['audioEncoding'] = undefined;

/**
 * @member {module:model/GoogleCloudDialogflowCxV3beta1BargeInConfig} bargeInConfig
 */
GoogleCloudDialogflowCxV3beta1InputAudioConfig.prototype['bargeInConfig'] = undefined;

/**
 * Optional. If `true`, Dialogflow returns SpeechWordInfo in StreamingRecognitionResult with information about the recognized speech words, e.g. start and end time offsets. If false or unspecified, Speech doesn't return any word-level information.
 * @member {Boolean} enableWordInfo
 */
GoogleCloudDialogflowCxV3beta1InputAudioConfig.prototype['enableWordInfo'] = undefined;
 ...
 * @member {String} model
 */
GoogleCloudDialogflowCxV3beta1InputAudioConfig.prototype['model'] = undefined;

/**
 * Optional. Which variant of the Speech model to use.
 * @member {module:model/GoogleCloudDialogflowCxV3beta1InputAudioConfig.ModelVariantEnum} modelVariant
 */
GoogleCloudDialogflowCxV3beta1InputAudioConfig.prototype['modelVariant'] = undefined;
 ...
 */
GoogleCloudDialogflowCxV3beta1InputAudioConfig.prototype['optOutConformerModelMigration'] = undefined;
 ...
 */
GoogleCloudDialogflowCxV3beta1InputAudioConfig.prototype['phraseHints'] = undefined;

/**
 * Sample rate (in Hertz) of the audio content sent in the query. Refer to [Cloud Speech API documentation](https://cloud.google.com/speech-to-text/docs/basics) for more details.
 * @member {Number} sampleRateHertz
 */
GoogleCloudDialogflowCxV3beta1InputAudioConfig.prototype['sampleRateHertz'] = undefined;

/**
 * Optional. If `false` (default), recognition does not cease until the client closes the stream. If `true`, the recognizer will detect a single spoken utterance in input audio. Recognition ceases when it detects the audio's voice has stopped or paused. In this case, once a detected intent is received, the client should close the stream and start a new request with a new stream as needed. Note: This setting is relevant only for streaming methods.
 * @member {Boolean} singleUtterance
 */
GoogleCloudDialogflowCxV3beta1InputAudioConfig.prototype['singleUtterance'] = undefined;
 ...
 * @readonly
 */
GoogleCloudDialogflowCxV3beta1InputAudioConfig['AudioEncodingEnum'] = {
 ...
 * @readonly
 */
GoogleCloudDialogflowCxV3beta1InputAudioConfig['ModelVariantEnum'] = {
...
export default GoogleCloudDialogflowCxV3beta1InputAudioConfig;
