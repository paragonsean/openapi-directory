...
/**
 * The GoogleCloudDialogflowCxV3TurnSignals model module.
 * @module model/GoogleCloudDialogflowCxV3TurnSignals
 * @version v3beta1
 */
class GoogleCloudDialogflowCxV3TurnSignals {
    /**
     * Constructs a new <code>GoogleCloudDialogflowCxV3TurnSignals</code>.
     * Collection of all signals that were extracted for a single turn of the conversation.
     * @alias module:model/GoogleCloudDialogflowCxV3TurnSignals
     */
    constructor() { 
        
        GoogleCloudDialogflowCxV3TurnSignals.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudDialogflowCxV3TurnSignals</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudDialogflowCxV3TurnSignals} obj Optional instance to populate.
     * @return {module:model/GoogleCloudDialogflowCxV3TurnSignals} The populated <code>GoogleCloudDialogflowCxV3TurnSignals</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudDialogflowCxV3TurnSignals();
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudDialogflowCxV3TurnSignals</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudDialogflowCxV3TurnSignals</code>.
     */
 ...
 */
GoogleCloudDialogflowCxV3TurnSignals.prototype['agentEscalated'] = undefined;

/**
 * Whether user was using DTMF input.
 * @member {Boolean} dtmfUsed
 */
GoogleCloudDialogflowCxV3TurnSignals.prototype['dtmfUsed'] = undefined;

/**
 * Failure reasons of the turn.
 * @member {Array.<module:model/GoogleCloudDialogflowCxV3TurnSignals.FailureReasonsEnum>} failureReasons
 */
GoogleCloudDialogflowCxV3TurnSignals.prototype['failureReasons'] = undefined;

/**
 * Whether NLU predicted NO_MATCH.
 * @member {Boolean} noMatch
 */
GoogleCloudDialogflowCxV3TurnSignals.prototype['noMatch'] = undefined;

/**
 * Whether user provided no input.
 * @member {Boolean} noUserInput
 */
GoogleCloudDialogflowCxV3TurnSignals.prototype['noUserInput'] = undefined;

/**
 * Whether turn resulted in End Session page.
 * @member {Boolean} reachedEndPage
 */
GoogleCloudDialogflowCxV3TurnSignals.prototype['reachedEndPage'] = undefined;
 ...
 */
GoogleCloudDialogflowCxV3TurnSignals.prototype['sentimentMagnitude'] = undefined;
 ...
 */
GoogleCloudDialogflowCxV3TurnSignals.prototype['sentimentScore'] = undefined;

/**
 * Whether user was specifically asking for a live agent.
 * @member {Boolean} userEscalated
 */
GoogleCloudDialogflowCxV3TurnSignals.prototype['userEscalated'] = undefined;

/**
 * Human-readable statuses of the webhooks triggered during this turn.
 * @member {Array.<String>} webhookStatuses
 */
GoogleCloudDialogflowCxV3TurnSignals.prototype['webhookStatuses'] = undefined;
 ...
 * @readonly
 */
GoogleCloudDialogflowCxV3TurnSignals['FailureReasonsEnum'] = {
...
export default GoogleCloudDialogflowCxV3TurnSignals;
