...
|**rolloutSteps** | [**List&lt;GoogleCloudDialogflowCxV3beta1RolloutConfigRolloutStep&gt;**](GoogleCloudDialogflowCxV3beta1RolloutConfigRolloutStep.md) | Steps to roll out a flow version. Steps should be sorted by percentage in ascending order. |  [optional] |
