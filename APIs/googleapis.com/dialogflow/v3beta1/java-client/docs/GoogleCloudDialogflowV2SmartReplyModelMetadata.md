...
|------------ | ------------- | ------------- | -------------|
|**trainingModelType** | [**TrainingModelTypeEnum**](#TrainingModelTypeEnum) | Optional. Type of the smart reply model. If not provided, model_type is used. |  [optional] |



## Enum: TrainingModelTypeEnum
