...
|------------ | ------------- | ------------- | -------------|
|**generators** | [**List&lt;GoogleCloudDialogflowCxV3beta1Generator&gt;**](GoogleCloudDialogflowCxV3beta1Generator.md) | The list of generators. There will be a maximum number of items returned based on the page_size field in the request. |  [optional] |
