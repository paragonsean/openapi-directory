...
public class GoogleCloudDialogflowCxV3beta1Flow {
  ...
  public GoogleCloudDialogflowCxV3beta1Flow() {
  }

  public GoogleCloudDialogflowCxV3beta1Flow advancedSettings(GoogleCloudDialogflowCxV3beta1AdvancedSettings advancedSettings) {
  ...
  public GoogleCloudDialogflowCxV3beta1Flow description(String description) {
  ...
  public GoogleCloudDialogflowCxV3beta1Flow displayName(String displayName) {
  ...
  public GoogleCloudDialogflowCxV3beta1Flow eventHandlers(List<GoogleCloudDialogflowCxV3beta1EventHandler> eventHandlers) {
    this.eventHandlers = eventHandlers;
    return this;
  }

  public GoogleCloudDialogflowCxV3beta1Flow addEventHandlersItem(GoogleCloudDialogflowCxV3beta1EventHandler eventHandlersItem) {
  ...
  public GoogleCloudDialogflowCxV3beta1Flow knowledgeConnectorSettings(GoogleCloudDialogflowCxV3beta1KnowledgeConnectorSettings knowledgeConnectorSettings) {
  ...
  public GoogleCloudDialogflowCxV3beta1Flow name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GoogleCloudDialogflowCxV3beta1Flow nluSettings(GoogleCloudDialogflowCxV3beta1NluSettings nluSettings) {
  ...
  public void setNluSettings(GoogleCloudDialogflowCxV3beta1NluSettings nluSettings) {
    this.nluSettings = nluSettings;
  }


  public GoogleCloudDialogflowCxV3beta1Flow transitionRouteGroups(List<String> transitionRouteGroups) {
    this.transitionRouteGroups = transitionRouteGroups;
    return this;
  }

  public GoogleCloudDialogflowCxV3beta1Flow addTransitionRouteGroupsItem(String transitionRouteGroupsItem) {
  ...
  public GoogleCloudDialogflowCxV3beta1Flow transitionRoutes(List<GoogleCloudDialogflowCxV3beta1TransitionRoute> transitionRoutes) {
    this.transitionRoutes = transitionRoutes;
    return this;
  }

  public GoogleCloudDialogflowCxV3beta1Flow addTransitionRoutesItem(GoogleCloudDialogflowCxV3beta1TransitionRoute transitionRoutesItem) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudDialogflowCxV3beta1Flow googleCloudDialogflowCxV3beta1Flow = (GoogleCloudDialogflowCxV3beta1Flow) o;
    return Objects.equals(this.advancedSettings, googleCloudDialogflowCxV3beta1Flow.advancedSettings) &&
        Objects.equals(this.description, googleCloudDialogflowCxV3beta1Flow.description) &&
        Objects.equals(this.displayName, googleCloudDialogflowCxV3beta1Flow.displayName) &&
        Objects.equals(this.eventHandlers, googleCloudDialogflowCxV3beta1Flow.eventHandlers) &&
        Objects.equals(this.knowledgeConnectorSettings, googleCloudDialogflowCxV3beta1Flow.knowledgeConnectorSettings) &&
        Objects.equals(this.name, googleCloudDialogflowCxV3beta1Flow.name) &&
        Objects.equals(this.nluSettings, googleCloudDialogflowCxV3beta1Flow.nluSettings) &&
        Objects.equals(this.transitionRouteGroups, googleCloudDialogflowCxV3beta1Flow.transitionRouteGroups) &&
        Objects.equals(this.transitionRoutes, googleCloudDialogflowCxV3beta1Flow.transitionRoutes);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudDialogflowCxV3beta1Flow {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudDialogflowCxV3beta1Flow
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudDialogflowCxV3beta1Flow.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudDialogflowCxV3beta1Flow is not found in the empty JSON string", GoogleCloudDialogflowCxV3beta1Flow.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudDialogflowCxV3beta1Flow.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudDialogflowCxV3beta1Flow` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("nluSettings") != null && !jsonObj.get("nluSettings").isJsonNull()) {
        GoogleCloudDialogflowCxV3beta1NluSettings.validateJsonElement(jsonObj.get("nluSettings"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudDialogflowCxV3beta1Flow.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudDialogflowCxV3beta1Flow' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudDialogflowCxV3beta1Flow> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudDialogflowCxV3beta1Flow.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudDialogflowCxV3beta1Flow>() {
           @Override
           public void write(JsonWriter out, GoogleCloudDialogflowCxV3beta1Flow value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudDialogflowCxV3beta1Flow read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudDialogflowCxV3beta1Flow given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudDialogflowCxV3beta1Flow
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudDialogflowCxV3beta1Flow
   */
  public static GoogleCloudDialogflowCxV3beta1Flow fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudDialogflowCxV3beta1Flow.class);
  }

  /**
   * Convert an instance of GoogleCloudDialogflowCxV3beta1Flow to an JSON string
   *
   * @return JSON string
   */
