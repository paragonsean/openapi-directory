...
public class GoogleCloudDialogflowCxV3beta1SecuritySettings {
  ...
  public GoogleCloudDialogflowCxV3beta1SecuritySettings() {
  }

  public GoogleCloudDialogflowCxV3beta1SecuritySettings audioExportSettings(GoogleCloudDialogflowCxV3beta1SecuritySettingsAudioExportSettings audioExportSettings) {
  ...
  public void setAudioExportSettings(GoogleCloudDialogflowCxV3beta1SecuritySettingsAudioExportSettings audioExportSettings) {
    this.audioExportSettings = audioExportSettings;
  }


  public GoogleCloudDialogflowCxV3beta1SecuritySettings deidentifyTemplate(String deidentifyTemplate) {
  ...
  public GoogleCloudDialogflowCxV3beta1SecuritySettings displayName(String displayName) {
  ...
  public GoogleCloudDialogflowCxV3beta1SecuritySettings insightsExportSettings(GoogleCloudDialogflowCxV3beta1SecuritySettingsInsightsExportSettings insightsExportSettings) {
  ...
  public void setInsightsExportSettings(GoogleCloudDialogflowCxV3beta1SecuritySettingsInsightsExportSettings insightsExportSettings) {
    this.insightsExportSettings = insightsExportSettings;
  }


  public GoogleCloudDialogflowCxV3beta1SecuritySettings inspectTemplate(String inspectTemplate) {
  ...
  public GoogleCloudDialogflowCxV3beta1SecuritySettings name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GoogleCloudDialogflowCxV3beta1SecuritySettings purgeDataTypes(List<PurgeDataTypesEnum> purgeDataTypes) {
    this.purgeDataTypes = purgeDataTypes;
    return this;
  }

  public GoogleCloudDialogflowCxV3beta1SecuritySettings addPurgeDataTypesItem(PurgeDataTypesEnum purgeDataTypesItem) {
  ...
  public GoogleCloudDialogflowCxV3beta1SecuritySettings redactionScope(RedactionScopeEnum redactionScope) {
  ...
  public GoogleCloudDialogflowCxV3beta1SecuritySettings redactionStrategy(RedactionStrategyEnum redactionStrategy) {
  ...
  public GoogleCloudDialogflowCxV3beta1SecuritySettings retentionStrategy(RetentionStrategyEnum retentionStrategy) {
  ...
  public GoogleCloudDialogflowCxV3beta1SecuritySettings retentionWindowDays(Integer retentionWindowDays) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudDialogflowCxV3beta1SecuritySettings googleCloudDialogflowCxV3beta1SecuritySettings = (GoogleCloudDialogflowCxV3beta1SecuritySettings) o;
    return Objects.equals(this.audioExportSettings, googleCloudDialogflowCxV3beta1SecuritySettings.audioExportSettings) &&
        Objects.equals(this.deidentifyTemplate, googleCloudDialogflowCxV3beta1SecuritySettings.deidentifyTemplate) &&
        Objects.equals(this.displayName, googleCloudDialogflowCxV3beta1SecuritySettings.displayName) &&
        Objects.equals(this.insightsExportSettings, googleCloudDialogflowCxV3beta1SecuritySettings.insightsExportSettings) &&
        Objects.equals(this.inspectTemplate, googleCloudDialogflowCxV3beta1SecuritySettings.inspectTemplate) &&
        Objects.equals(this.name, googleCloudDialogflowCxV3beta1SecuritySettings.name) &&
        Objects.equals(this.purgeDataTypes, googleCloudDialogflowCxV3beta1SecuritySettings.purgeDataTypes) &&
        Objects.equals(this.redactionScope, googleCloudDialogflowCxV3beta1SecuritySettings.redactionScope) &&
        Objects.equals(this.redactionStrategy, googleCloudDialogflowCxV3beta1SecuritySettings.redactionStrategy) &&
        Objects.equals(this.retentionStrategy, googleCloudDialogflowCxV3beta1SecuritySettings.retentionStrategy) &&
        Objects.equals(this.retentionWindowDays, googleCloudDialogflowCxV3beta1SecuritySettings.retentionWindowDays);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudDialogflowCxV3beta1SecuritySettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudDialogflowCxV3beta1SecuritySettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudDialogflowCxV3beta1SecuritySettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudDialogflowCxV3beta1SecuritySettings is not found in the empty JSON string", GoogleCloudDialogflowCxV3beta1SecuritySettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudDialogflowCxV3beta1SecuritySettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudDialogflowCxV3beta1SecuritySettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("audioExportSettings") != null && !jsonObj.get("audioExportSettings").isJsonNull()) {
        GoogleCloudDialogflowCxV3beta1SecuritySettingsAudioExportSettings.validateJsonElement(jsonObj.get("audioExportSettings"));
      }
      ...
      if (jsonObj.get("insightsExportSettings") != null && !jsonObj.get("insightsExportSettings").isJsonNull()) {
        GoogleCloudDialogflowCxV3beta1SecuritySettingsInsightsExportSettings.validateJsonElement(jsonObj.get("insightsExportSettings"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudDialogflowCxV3beta1SecuritySettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudDialogflowCxV3beta1SecuritySettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudDialogflowCxV3beta1SecuritySettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudDialogflowCxV3beta1SecuritySettings.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudDialogflowCxV3beta1SecuritySettings>() {
           @Override
           public void write(JsonWriter out, GoogleCloudDialogflowCxV3beta1SecuritySettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudDialogflowCxV3beta1SecuritySettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudDialogflowCxV3beta1SecuritySettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudDialogflowCxV3beta1SecuritySettings
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudDialogflowCxV3beta1SecuritySettings
   */
  public static GoogleCloudDialogflowCxV3beta1SecuritySettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudDialogflowCxV3beta1SecuritySettings.class);
  }

  /**
   * Convert an instance of GoogleCloudDialogflowCxV3beta1SecuritySettings to an JSON string
   *
   * @return JSON string
   */
