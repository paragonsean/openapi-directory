...
public class GoogleCloudDialogflowCxV3WebhookGenericWebService {
  ...
  public GoogleCloudDialogflowCxV3WebhookGenericWebService allowedCaCerts(List<byte[]> allowedCaCerts) {
    this.allowedCaCerts = allowedCaCerts;
    return this;
  }

  public GoogleCloudDialogflowCxV3WebhookGenericWebService addAllowedCaCertsItem(byte[] allowedCaCertsItem) {
  ...
  public GoogleCloudDialogflowCxV3WebhookGenericWebService httpMethod(HttpMethodEnum httpMethod) {
  ...
  public GoogleCloudDialogflowCxV3WebhookGenericWebService parameterMapping(Map<String, String> parameterMapping) {
    this.parameterMapping = parameterMapping;
    return this;
  }

  public GoogleCloudDialogflowCxV3WebhookGenericWebService putParameterMappingItem(String key, String parameterMappingItem) {
  ...
  @Deprecated
  public GoogleCloudDialogflowCxV3WebhookGenericWebService password(String password) {
  ...
  public GoogleCloudDialogflowCxV3WebhookGenericWebService requestBody(String requestBody) {
  ...
  public GoogleCloudDialogflowCxV3WebhookGenericWebService requestHeaders(Map<String, String> requestHeaders) {
    this.requestHeaders = requestHeaders;
    return this;
  }

  public GoogleCloudDialogflowCxV3WebhookGenericWebService putRequestHeadersItem(String key, String requestHeadersItem) {
  ...
  public GoogleCloudDialogflowCxV3WebhookGenericWebService uri(String uri) {
    this.uri = uri;
    return this;
  }
  ...
  @Deprecated
  public GoogleCloudDialogflowCxV3WebhookGenericWebService username(String username) {
  ...
  public GoogleCloudDialogflowCxV3WebhookGenericWebService webhookType(WebhookTypeEnum webhookType) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudDialogflowCxV3WebhookGenericWebService googleCloudDialogflowCxV3WebhookGenericWebService = (GoogleCloudDialogflowCxV3WebhookGenericWebService) o;
    return Objects.equals(this.allowedCaCerts, googleCloudDialogflowCxV3WebhookGenericWebService.allowedCaCerts) &&
        Objects.equals(this.httpMethod, googleCloudDialogflowCxV3WebhookGenericWebService.httpMethod) &&
        Objects.equals(this.parameterMapping, googleCloudDialogflowCxV3WebhookGenericWebService.parameterMapping) &&
        Objects.equals(this.password, googleCloudDialogflowCxV3WebhookGenericWebService.password) &&
        Objects.equals(this.requestBody, googleCloudDialogflowCxV3WebhookGenericWebService.requestBody) &&
        Objects.equals(this.requestHeaders, googleCloudDialogflowCxV3WebhookGenericWebService.requestHeaders) &&
        Objects.equals(this.uri, googleCloudDialogflowCxV3WebhookGenericWebService.uri) &&
        Objects.equals(this.username, googleCloudDialogflowCxV3WebhookGenericWebService.username) &&
        Objects.equals(this.webhookType, googleCloudDialogflowCxV3WebhookGenericWebService.webhookType);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudDialogflowCxV3WebhookGenericWebService {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudDialogflowCxV3WebhookGenericWebService
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudDialogflowCxV3WebhookGenericWebService.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudDialogflowCxV3WebhookGenericWebService is not found in the empty JSON string", GoogleCloudDialogflowCxV3WebhookGenericWebService.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudDialogflowCxV3WebhookGenericWebService.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudDialogflowCxV3WebhookGenericWebService` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudDialogflowCxV3WebhookGenericWebService.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudDialogflowCxV3WebhookGenericWebService' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudDialogflowCxV3WebhookGenericWebService> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudDialogflowCxV3WebhookGenericWebService.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudDialogflowCxV3WebhookGenericWebService>() {
           @Override
           public void write(JsonWriter out, GoogleCloudDialogflowCxV3WebhookGenericWebService value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudDialogflowCxV3WebhookGenericWebService read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudDialogflowCxV3WebhookGenericWebService given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudDialogflowCxV3WebhookGenericWebService
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudDialogflowCxV3WebhookGenericWebService
   */
  public static GoogleCloudDialogflowCxV3WebhookGenericWebService fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudDialogflowCxV3WebhookGenericWebService.class);
  }

  /**
   * Convert an instance of GoogleCloudDialogflowCxV3WebhookGenericWebService to an JSON string
   *
   * @return JSON string
   */
