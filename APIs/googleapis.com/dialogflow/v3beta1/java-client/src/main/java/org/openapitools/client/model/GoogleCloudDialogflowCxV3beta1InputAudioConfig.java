...
public class GoogleCloudDialogflowCxV3beta1InputAudioConfig {
  ...
  private GoogleCloudDialogflowCxV3beta1BargeInConfig bargeInConfig;
  ...
  public GoogleCloudDialogflowCxV3beta1InputAudioConfig audioEncoding(AudioEncodingEnum audioEncoding) {
  ...
  public GoogleCloudDialogflowCxV3beta1InputAudioConfig bargeInConfig(GoogleCloudDialogflowCxV3beta1BargeInConfig bargeInConfig) {
   ...
   */
  @javax.annotation.Nullable
  public GoogleCloudDialogflowCxV3beta1BargeInConfig getBargeInConfig() {
    return bargeInConfig;
  }

  public void setBargeInConfig(GoogleCloudDialogflowCxV3beta1BargeInConfig bargeInConfig) {
    this.bargeInConfig = bargeInConfig;
  }


  public GoogleCloudDialogflowCxV3beta1InputAudioConfig enableWordInfo(Boolean enableWordInfo) {
  ...
  public GoogleCloudDialogflowCxV3beta1InputAudioConfig model(String model) {
    this.model = model;
    return this;
  }
  ...
  public GoogleCloudDialogflowCxV3beta1InputAudioConfig modelVariant(ModelVariantEnum modelVariant) {
  ...
  public GoogleCloudDialogflowCxV3beta1InputAudioConfig optOutConformerModelMigration(Boolean optOutConformerModelMigration) {
  ...
  public GoogleCloudDialogflowCxV3beta1InputAudioConfig phraseHints(List<String> phraseHints) {
    this.phraseHints = phraseHints;
    return this;
  }

  public GoogleCloudDialogflowCxV3beta1InputAudioConfig addPhraseHintsItem(String phraseHintsItem) {
  ...
  public GoogleCloudDialogflowCxV3beta1InputAudioConfig sampleRateHertz(Integer sampleRateHertz) {
  ...
  public GoogleCloudDialogflowCxV3beta1InputAudioConfig singleUtterance(Boolean singleUtterance) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudDialogflowCxV3beta1InputAudioConfig googleCloudDialogflowCxV3beta1InputAudioConfig = (GoogleCloudDialogflowCxV3beta1InputAudioConfig) o;
    return Objects.equals(this.audioEncoding, googleCloudDialogflowCxV3beta1InputAudioConfig.audioEncoding) &&
        Objects.equals(this.bargeInConfig, googleCloudDialogflowCxV3beta1InputAudioConfig.bargeInConfig) &&
        Objects.equals(this.enableWordInfo, googleCloudDialogflowCxV3beta1InputAudioConfig.enableWordInfo) &&
        Objects.equals(this.model, googleCloudDialogflowCxV3beta1InputAudioConfig.model) &&
        Objects.equals(this.modelVariant, googleCloudDialogflowCxV3beta1InputAudioConfig.modelVariant) &&
        Objects.equals(this.optOutConformerModelMigration, googleCloudDialogflowCxV3beta1InputAudioConfig.optOutConformerModelMigration) &&
        Objects.equals(this.phraseHints, googleCloudDialogflowCxV3beta1InputAudioConfig.phraseHints) &&
        Objects.equals(this.sampleRateHertz, googleCloudDialogflowCxV3beta1InputAudioConfig.sampleRateHertz) &&
        Objects.equals(this.singleUtterance, googleCloudDialogflowCxV3beta1InputAudioConfig.singleUtterance);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudDialogflowCxV3beta1InputAudioConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudDialogflowCxV3beta1InputAudioConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudDialogflowCxV3beta1InputAudioConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudDialogflowCxV3beta1InputAudioConfig is not found in the empty JSON string", GoogleCloudDialogflowCxV3beta1InputAudioConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudDialogflowCxV3beta1InputAudioConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudDialogflowCxV3beta1InputAudioConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("bargeInConfig") != null && !jsonObj.get("bargeInConfig").isJsonNull()) {
        GoogleCloudDialogflowCxV3beta1BargeInConfig.validateJsonElement(jsonObj.get("bargeInConfig"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudDialogflowCxV3beta1InputAudioConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudDialogflowCxV3beta1InputAudioConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudDialogflowCxV3beta1InputAudioConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudDialogflowCxV3beta1InputAudioConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudDialogflowCxV3beta1InputAudioConfig>() {
           @Override
           public void write(JsonWriter out, GoogleCloudDialogflowCxV3beta1InputAudioConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudDialogflowCxV3beta1InputAudioConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudDialogflowCxV3beta1InputAudioConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudDialogflowCxV3beta1InputAudioConfig
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudDialogflowCxV3beta1InputAudioConfig
   */
  public static GoogleCloudDialogflowCxV3beta1InputAudioConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudDialogflowCxV3beta1InputAudioConfig.class);
  }

  /**
   * Convert an instance of GoogleCloudDialogflowCxV3beta1InputAudioConfig to an JSON string
   *
   * @return JSON string
   */
