...
public class GoogleCloudDialogflowCxV3beta1QueryParameters {
  ...
  public GoogleCloudDialogflowCxV3beta1QueryParameters analyzeQueryTextSentiment(Boolean analyzeQueryTextSentiment) {
  ...
  public GoogleCloudDialogflowCxV3beta1QueryParameters channel(String channel) {
  ...
  public GoogleCloudDialogflowCxV3beta1QueryParameters currentPage(String currentPage) {
  ...
  public GoogleCloudDialogflowCxV3beta1QueryParameters disableWebhook(Boolean disableWebhook) {
  ...
  public GoogleCloudDialogflowCxV3beta1QueryParameters endUserMetadata(Map<String, Object> endUserMetadata) {
    this.endUserMetadata = endUserMetadata;
    return this;
  }

  public GoogleCloudDialogflowCxV3beta1QueryParameters putEndUserMetadataItem(String key, Object endUserMetadataItem) {
  ...
  public GoogleCloudDialogflowCxV3beta1QueryParameters flowVersions(List<String> flowVersions) {
    this.flowVersions = flowVersions;
    return this;
  }

  public GoogleCloudDialogflowCxV3beta1QueryParameters addFlowVersionsItem(String flowVersionsItem) {
  ...
  public GoogleCloudDialogflowCxV3beta1QueryParameters geoLocation(GoogleTypeLatLng geoLocation) {
  ...
  public GoogleCloudDialogflowCxV3beta1QueryParameters parameters(Map<String, Object> parameters) {
    this.parameters = parameters;
    return this;
  }

  public GoogleCloudDialogflowCxV3beta1QueryParameters putParametersItem(String key, Object parametersItem) {
  ...
  public GoogleCloudDialogflowCxV3beta1QueryParameters payload(Map<String, Object> payload) {
    this.payload = payload;
    return this;
  }

  public GoogleCloudDialogflowCxV3beta1QueryParameters putPayloadItem(String key, Object payloadItem) {
  ...
  public GoogleCloudDialogflowCxV3beta1QueryParameters searchConfig(GoogleCloudDialogflowCxV3beta1SearchConfig searchConfig) {
  ...
  public void setSearchConfig(GoogleCloudDialogflowCxV3beta1SearchConfig searchConfig) {
    this.searchConfig = searchConfig;
  }


  public GoogleCloudDialogflowCxV3beta1QueryParameters sessionEntityTypes(List<GoogleCloudDialogflowCxV3beta1SessionEntityType> sessionEntityTypes) {
    this.sessionEntityTypes = sessionEntityTypes;
    return this;
  }

  public GoogleCloudDialogflowCxV3beta1QueryParameters addSessionEntityTypesItem(GoogleCloudDialogflowCxV3beta1SessionEntityType sessionEntityTypesItem) {
  ...
  public GoogleCloudDialogflowCxV3beta1QueryParameters sessionTtl(String sessionTtl) {
  ...
  public GoogleCloudDialogflowCxV3beta1QueryParameters timeZone(String timeZone) {
  ...
  public GoogleCloudDialogflowCxV3beta1QueryParameters webhookHeaders(Map<String, String> webhookHeaders) {
    this.webhookHeaders = webhookHeaders;
    return this;
  }

  public GoogleCloudDialogflowCxV3beta1QueryParameters putWebhookHeadersItem(String key, String webhookHeadersItem) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudDialogflowCxV3beta1QueryParameters googleCloudDialogflowCxV3beta1QueryParameters = (GoogleCloudDialogflowCxV3beta1QueryParameters) o;
    return Objects.equals(this.analyzeQueryTextSentiment, googleCloudDialogflowCxV3beta1QueryParameters.analyzeQueryTextSentiment) &&
        Objects.equals(this.channel, googleCloudDialogflowCxV3beta1QueryParameters.channel) &&
        Objects.equals(this.currentPage, googleCloudDialogflowCxV3beta1QueryParameters.currentPage) &&
        Objects.equals(this.disableWebhook, googleCloudDialogflowCxV3beta1QueryParameters.disableWebhook) &&
        Objects.equals(this.endUserMetadata, googleCloudDialogflowCxV3beta1QueryParameters.endUserMetadata) &&
        Objects.equals(this.flowVersions, googleCloudDialogflowCxV3beta1QueryParameters.flowVersions) &&
        Objects.equals(this.geoLocation, googleCloudDialogflowCxV3beta1QueryParameters.geoLocation) &&
        Objects.equals(this.parameters, googleCloudDialogflowCxV3beta1QueryParameters.parameters) &&
        Objects.equals(this.payload, googleCloudDialogflowCxV3beta1QueryParameters.payload) &&
        Objects.equals(this.searchConfig, googleCloudDialogflowCxV3beta1QueryParameters.searchConfig) &&
        Objects.equals(this.sessionEntityTypes, googleCloudDialogflowCxV3beta1QueryParameters.sessionEntityTypes) &&
        Objects.equals(this.sessionTtl, googleCloudDialogflowCxV3beta1QueryParameters.sessionTtl) &&
        Objects.equals(this.timeZone, googleCloudDialogflowCxV3beta1QueryParameters.timeZone) &&
        Objects.equals(this.webhookHeaders, googleCloudDialogflowCxV3beta1QueryParameters.webhookHeaders);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudDialogflowCxV3beta1QueryParameters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudDialogflowCxV3beta1QueryParameters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudDialogflowCxV3beta1QueryParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudDialogflowCxV3beta1QueryParameters is not found in the empty JSON string", GoogleCloudDialogflowCxV3beta1QueryParameters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudDialogflowCxV3beta1QueryParameters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudDialogflowCxV3beta1QueryParameters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("searchConfig") != null && !jsonObj.get("searchConfig").isJsonNull()) {
        GoogleCloudDialogflowCxV3beta1SearchConfig.validateJsonElement(jsonObj.get("searchConfig"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudDialogflowCxV3beta1QueryParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudDialogflowCxV3beta1QueryParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudDialogflowCxV3beta1QueryParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudDialogflowCxV3beta1QueryParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudDialogflowCxV3beta1QueryParameters>() {
           @Override
           public void write(JsonWriter out, GoogleCloudDialogflowCxV3beta1QueryParameters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudDialogflowCxV3beta1QueryParameters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudDialogflowCxV3beta1QueryParameters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudDialogflowCxV3beta1QueryParameters
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudDialogflowCxV3beta1QueryParameters
   */
  public static GoogleCloudDialogflowCxV3beta1QueryParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudDialogflowCxV3beta1QueryParameters.class);
  }

  /**
   * Convert an instance of GoogleCloudDialogflowCxV3beta1QueryParameters to an JSON string
   *
   * @return JSON string
   */
