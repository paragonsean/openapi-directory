...
public class GoogleCloudDialogflowCxV3beta1DetectIntentResponse {
  ...
  public GoogleCloudDialogflowCxV3beta1DetectIntentResponse allowCancellation(Boolean allowCancellation) {
  ...
  public GoogleCloudDialogflowCxV3beta1DetectIntentResponse outputAudio(byte[] outputAudio) {
  ...
  public GoogleCloudDialogflowCxV3beta1DetectIntentResponse outputAudioConfig(GoogleCloudDialogflowCxV3beta1OutputAudioConfig outputAudioConfig) {
  ...
  public GoogleCloudDialogflowCxV3beta1DetectIntentResponse queryResult(GoogleCloudDialogflowCxV3beta1QueryResult queryResult) {
  ...
  public GoogleCloudDialogflowCxV3beta1DetectIntentResponse responseId(String responseId) {
  ...
  public GoogleCloudDialogflowCxV3beta1DetectIntentResponse responseType(ResponseTypeEnum responseType) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudDialogflowCxV3beta1DetectIntentResponse googleCloudDialogflowCxV3beta1DetectIntentResponse = (GoogleCloudDialogflowCxV3beta1DetectIntentResponse) o;
    return Objects.equals(this.allowCancellation, googleCloudDialogflowCxV3beta1DetectIntentResponse.allowCancellation) &&
        Arrays.equals(this.outputAudio, googleCloudDialogflowCxV3beta1DetectIntentResponse.outputAudio) &&
        Objects.equals(this.outputAudioConfig, googleCloudDialogflowCxV3beta1DetectIntentResponse.outputAudioConfig) &&
        Objects.equals(this.queryResult, googleCloudDialogflowCxV3beta1DetectIntentResponse.queryResult) &&
        Objects.equals(this.responseId, googleCloudDialogflowCxV3beta1DetectIntentResponse.responseId) &&
        Objects.equals(this.responseType, googleCloudDialogflowCxV3beta1DetectIntentResponse.responseType);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudDialogflowCxV3beta1DetectIntentResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudDialogflowCxV3beta1DetectIntentResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudDialogflowCxV3beta1DetectIntentResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudDialogflowCxV3beta1DetectIntentResponse is not found in the empty JSON string", GoogleCloudDialogflowCxV3beta1DetectIntentResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudDialogflowCxV3beta1DetectIntentResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudDialogflowCxV3beta1DetectIntentResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudDialogflowCxV3beta1DetectIntentResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudDialogflowCxV3beta1DetectIntentResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudDialogflowCxV3beta1DetectIntentResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudDialogflowCxV3beta1DetectIntentResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudDialogflowCxV3beta1DetectIntentResponse>() {
           @Override
           public void write(JsonWriter out, GoogleCloudDialogflowCxV3beta1DetectIntentResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudDialogflowCxV3beta1DetectIntentResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudDialogflowCxV3beta1DetectIntentResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudDialogflowCxV3beta1DetectIntentResponse
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudDialogflowCxV3beta1DetectIntentResponse
   */
  public static GoogleCloudDialogflowCxV3beta1DetectIntentResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudDialogflowCxV3beta1DetectIntentResponse.class);
  }

  /**
   * Convert an instance of GoogleCloudDialogflowCxV3beta1DetectIntentResponse to an JSON string
   *
   * @return JSON string
   */
