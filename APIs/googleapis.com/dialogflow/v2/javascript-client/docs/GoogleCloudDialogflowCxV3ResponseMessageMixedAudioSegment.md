# DialogflowApi.GoogleCloudDialogflowCxV3ResponseMessageMixedAudioSegment
...
**audio** | **Blob** | Raw audio synthesized from the Dialogflow agent&#39;s response using the output config specified in the request. | [optional] 
