# DialogflowApi.GoogleCloudDialogflowV2EnvironmentHistory

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**entries** | [**[GoogleCloudDialogflowV2EnvironmentHistoryEntry]**](GoogleCloudDialogflowV2EnvironmentHistoryEntry.md) | Output only. The list of agent environments. There will be a maximum number of items returned based on the page_size field in the request. | [optional] [readonly] 
