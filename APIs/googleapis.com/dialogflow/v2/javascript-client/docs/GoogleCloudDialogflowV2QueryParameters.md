# DialogflowApi.GoogleCloudDialogflowV2QueryParameters

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**contexts** | [**[GoogleCloudDialogflowV2Context]**](GoogleCloudDialogflowV2Context.md) | The collection of contexts to be activated before this query is executed. | [optional] 
...
**sessionEntityTypes** | [**[GoogleCloudDialogflowV2SessionEntityType]**](GoogleCloudDialogflowV2SessionEntityType.md) | Additional session entity types to replace or extend developer entity types with. The entity synonyms apply to all languages and persist for the session of this query. | [optional] 
