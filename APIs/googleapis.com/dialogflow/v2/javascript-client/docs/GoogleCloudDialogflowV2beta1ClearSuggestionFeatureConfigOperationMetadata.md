# DialogflowApi.GoogleCloudDialogflowV2beta1ClearSuggestionFeatureConfigOperationMetadata
...
* `DIALOGFLOW_ASSIST` (value: `"DIALOGFLOW_ASSIST"`)

* `CONVERSATION_SUMMARIZATION` (value: `"CONVERSATION_SUMMARIZATION"`)
