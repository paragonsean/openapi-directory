...
/**
 * The GoogleCloudDialogflowCxV3Page model module.
 * @module model/GoogleCloudDialogflowCxV3Page
 * @version v2
 */
class GoogleCloudDialogflowCxV3Page {
    /**
     * Constructs a new <code>GoogleCloudDialogflowCxV3Page</code>.
     ...
     * @alias module:model/GoogleCloudDialogflowCxV3Page
     */
    constructor() { 
        
        GoogleCloudDialogflowCxV3Page.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudDialogflowCxV3Page</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudDialogflowCxV3Page} obj Optional instance to populate.
     * @return {module:model/GoogleCloudDialogflowCxV3Page} The populated <code>GoogleCloudDialogflowCxV3Page</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudDialogflowCxV3Page();
            ...
            if (data.hasOwnProperty('entryFulfillment')) {
                obj['entryFulfillment'] = GoogleCloudDialogflowCxV3Fulfillment.constructFromObject(data['entryFulfillment']);
            }
            ...
            if (data.hasOwnProperty('form')) {
                obj['form'] = GoogleCloudDialogflowCxV3Form.constructFromObject(data['form']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudDialogflowCxV3Page</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudDialogflowCxV3Page</code>.
     */
    static validateJSON(data) {
        ...
        if (data['entryFulfillment']) { // data not null
          GoogleCloudDialogflowCxV3Fulfillment.validateJSON(data['entryFulfillment']);
        }
        ...
        if (data['form']) { // data not null
          GoogleCloudDialogflowCxV3Form.validateJSON(data['form']);
        }
 ...
 */
GoogleCloudDialogflowCxV3Page.prototype['advancedSettings'] = undefined;

/**
 * The description of the page. The maximum length is 500 characters.
 * @member {String} description
 */
GoogleCloudDialogflowCxV3Page.prototype['description'] = undefined;

/**
 * Required. The human-readable name of the page, unique within the flow.
 * @member {String} displayName
 */
GoogleCloudDialogflowCxV3Page.prototype['displayName'] = undefined;

/**
 * @member {module:model/GoogleCloudDialogflowCxV3Fulfillment} entryFulfillment
 */
GoogleCloudDialogflowCxV3Page.prototype['entryFulfillment'] = undefined;

/**
 * Handlers associated with the page to handle events such as webhook errors, no match or no input.
 * @member {Array.<module:model/GoogleCloudDialogflowCxV3EventHandler>} eventHandlers
 */
GoogleCloudDialogflowCxV3Page.prototype['eventHandlers'] = undefined;

/**
 * @member {module:model/GoogleCloudDialogflowCxV3Form} form
 */
GoogleCloudDialogflowCxV3Page.prototype['form'] = undefined;

/**
 * @member {module:model/GoogleCloudDialogflowCxV3KnowledgeConnectorSettings} knowledgeConnectorSettings
 */
GoogleCloudDialogflowCxV3Page.prototype['knowledgeConnectorSettings'] = undefined;

/**
 * The unique identifier of the page. Required for the Pages.UpdatePage method. Pages.CreatePage populates the name automatically. Format: `projects//locations//agents//flows//pages/`.
 * @member {String} name
 */
GoogleCloudDialogflowCxV3Page.prototype['name'] = undefined;
 ...
 */
GoogleCloudDialogflowCxV3Page.prototype['transitionRouteGroups'] = undefined;
 ...
 */
GoogleCloudDialogflowCxV3Page.prototype['transitionRoutes'] = undefined;
...
export default GoogleCloudDialogflowCxV3Page;
