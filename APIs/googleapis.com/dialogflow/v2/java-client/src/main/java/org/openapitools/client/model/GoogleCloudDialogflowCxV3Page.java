...
import org.openapitools.client.model.GoogleCloudDialogflowCxV3Form;
...
public class GoogleCloudDialogflowCxV3Page {
  ...
  public GoogleCloudDialogflowCxV3Page advancedSettings(GoogleCloudDialogflowCxV3AdvancedSettings advancedSettings) {
  ...
  public GoogleCloudDialogflowCxV3Page description(String description) {
  ...
  public GoogleCloudDialogflowCxV3Page displayName(String displayName) {
  ...
  public GoogleCloudDialogflowCxV3Page entryFulfillment(GoogleCloudDialogflowCxV3Fulfillment entryFulfillment) {
  ...
  public void setEntryFulfillment(GoogleCloudDialogflowCxV3Fulfillment entryFulfillment) {
    this.entryFulfillment = entryFulfillment;
  }


  public GoogleCloudDialogflowCxV3Page eventHandlers(List<GoogleCloudDialogflowCxV3EventHandler> eventHandlers) {
    this.eventHandlers = eventHandlers;
    return this;
  }

  public GoogleCloudDialogflowCxV3Page addEventHandlersItem(GoogleCloudDialogflowCxV3EventHandler eventHandlersItem) {
  ...
  public GoogleCloudDialogflowCxV3Page form(GoogleCloudDialogflowCxV3Form form) {
    this.form = form;
    return this;
  }
  ...
  public void setForm(GoogleCloudDialogflowCxV3Form form) {
    this.form = form;
  }


  public GoogleCloudDialogflowCxV3Page knowledgeConnectorSettings(GoogleCloudDialogflowCxV3KnowledgeConnectorSettings knowledgeConnectorSettings) {
  ...
  public GoogleCloudDialogflowCxV3Page name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GoogleCloudDialogflowCxV3Page transitionRouteGroups(List<String> transitionRouteGroups) {
    this.transitionRouteGroups = transitionRouteGroups;
    return this;
  }

  public GoogleCloudDialogflowCxV3Page addTransitionRouteGroupsItem(String transitionRouteGroupsItem) {
  ...
  public GoogleCloudDialogflowCxV3Page transitionRoutes(List<GoogleCloudDialogflowCxV3TransitionRoute> transitionRoutes) {
    this.transitionRoutes = transitionRoutes;
    return this;
  }

  public GoogleCloudDialogflowCxV3Page addTransitionRoutesItem(GoogleCloudDialogflowCxV3TransitionRoute transitionRoutesItem) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudDialogflowCxV3Page googleCloudDialogflowCxV3Page = (GoogleCloudDialogflowCxV3Page) o;
    return Objects.equals(this.advancedSettings, googleCloudDialogflowCxV3Page.advancedSettings) &&
        Objects.equals(this.description, googleCloudDialogflowCxV3Page.description) &&
        Objects.equals(this.displayName, googleCloudDialogflowCxV3Page.displayName) &&
        Objects.equals(this.entryFulfillment, googleCloudDialogflowCxV3Page.entryFulfillment) &&
        Objects.equals(this.eventHandlers, googleCloudDialogflowCxV3Page.eventHandlers) &&
        Objects.equals(this.form, googleCloudDialogflowCxV3Page.form) &&
        Objects.equals(this.knowledgeConnectorSettings, googleCloudDialogflowCxV3Page.knowledgeConnectorSettings) &&
        Objects.equals(this.name, googleCloudDialogflowCxV3Page.name) &&
        Objects.equals(this.transitionRouteGroups, googleCloudDialogflowCxV3Page.transitionRouteGroups) &&
        Objects.equals(this.transitionRoutes, googleCloudDialogflowCxV3Page.transitionRoutes);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudDialogflowCxV3Page {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudDialogflowCxV3Page
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudDialogflowCxV3Page.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudDialogflowCxV3Page is not found in the empty JSON string", GoogleCloudDialogflowCxV3Page.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudDialogflowCxV3Page.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudDialogflowCxV3Page` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("entryFulfillment") != null && !jsonObj.get("entryFulfillment").isJsonNull()) {
        GoogleCloudDialogflowCxV3Fulfillment.validateJsonElement(jsonObj.get("entryFulfillment"));
      }
      ...
      if (jsonObj.get("form") != null && !jsonObj.get("form").isJsonNull()) {
        GoogleCloudDialogflowCxV3Form.validateJsonElement(jsonObj.get("form"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudDialogflowCxV3Page.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudDialogflowCxV3Page' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudDialogflowCxV3Page> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudDialogflowCxV3Page.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudDialogflowCxV3Page>() {
           @Override
           public void write(JsonWriter out, GoogleCloudDialogflowCxV3Page value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudDialogflowCxV3Page read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudDialogflowCxV3Page given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudDialogflowCxV3Page
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudDialogflowCxV3Page
   */
  public static GoogleCloudDialogflowCxV3Page fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudDialogflowCxV3Page.class);
  }

  /**
   * Convert an instance of GoogleCloudDialogflowCxV3Page to an JSON string
   *
   * @return JSON string
   */
