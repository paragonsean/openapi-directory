...
public class GoogleCloudDialogflowV2Agent {
  ...
  public GoogleCloudDialogflowV2Agent apiVersion(ApiVersionEnum apiVersion) {
  ...
  public GoogleCloudDialogflowV2Agent avatarUri(String avatarUri) {
  ...
  public GoogleCloudDialogflowV2Agent classificationThreshold(Float classificationThreshold) {
  ...
  public GoogleCloudDialogflowV2Agent defaultLanguageCode(String defaultLanguageCode) {
  ...
  public GoogleCloudDialogflowV2Agent description(String description) {
  ...
  public GoogleCloudDialogflowV2Agent displayName(String displayName) {
  ...
  public GoogleCloudDialogflowV2Agent enableLogging(Boolean enableLogging) {
  ...
  @Deprecated
  public GoogleCloudDialogflowV2Agent matchMode(MatchModeEnum matchMode) {
  ...
  public GoogleCloudDialogflowV2Agent parent(String parent) {
    this.parent = parent;
    return this;
  }
  ...
  public GoogleCloudDialogflowV2Agent supportedLanguageCodes(List<String> supportedLanguageCodes) {
    this.supportedLanguageCodes = supportedLanguageCodes;
    return this;
  }

  public GoogleCloudDialogflowV2Agent addSupportedLanguageCodesItem(String supportedLanguageCodesItem) {
  ...
  public GoogleCloudDialogflowV2Agent tier(TierEnum tier) {
    this.tier = tier;
    return this;
  }
  ...
  public GoogleCloudDialogflowV2Agent timeZone(String timeZone) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudDialogflowV2Agent googleCloudDialogflowV2Agent = (GoogleCloudDialogflowV2Agent) o;
    return Objects.equals(this.apiVersion, googleCloudDialogflowV2Agent.apiVersion) &&
        Objects.equals(this.avatarUri, googleCloudDialogflowV2Agent.avatarUri) &&
        Objects.equals(this.classificationThreshold, googleCloudDialogflowV2Agent.classificationThreshold) &&
        Objects.equals(this.defaultLanguageCode, googleCloudDialogflowV2Agent.defaultLanguageCode) &&
        Objects.equals(this.description, googleCloudDialogflowV2Agent.description) &&
        Objects.equals(this.displayName, googleCloudDialogflowV2Agent.displayName) &&
        Objects.equals(this.enableLogging, googleCloudDialogflowV2Agent.enableLogging) &&
        Objects.equals(this.matchMode, googleCloudDialogflowV2Agent.matchMode) &&
        Objects.equals(this.parent, googleCloudDialogflowV2Agent.parent) &&
        Objects.equals(this.supportedLanguageCodes, googleCloudDialogflowV2Agent.supportedLanguageCodes) &&
        Objects.equals(this.tier, googleCloudDialogflowV2Agent.tier) &&
        Objects.equals(this.timeZone, googleCloudDialogflowV2Agent.timeZone);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudDialogflowV2Agent {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudDialogflowV2Agent
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudDialogflowV2Agent.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudDialogflowV2Agent is not found in the empty JSON string", GoogleCloudDialogflowV2Agent.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudDialogflowV2Agent.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudDialogflowV2Agent` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudDialogflowV2Agent.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudDialogflowV2Agent' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudDialogflowV2Agent> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudDialogflowV2Agent.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudDialogflowV2Agent>() {
           @Override
           public void write(JsonWriter out, GoogleCloudDialogflowV2Agent value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudDialogflowV2Agent read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudDialogflowV2Agent given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudDialogflowV2Agent
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudDialogflowV2Agent
   */
  public static GoogleCloudDialogflowV2Agent fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudDialogflowV2Agent.class);
  }

  /**
   * Convert an instance of GoogleCloudDialogflowV2Agent to an JSON string
   *
   * @return JSON string
   */
