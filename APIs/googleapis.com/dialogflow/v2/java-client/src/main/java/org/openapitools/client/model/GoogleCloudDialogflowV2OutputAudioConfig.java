...
public class GoogleCloudDialogflowV2OutputAudioConfig {
  ...
  public GoogleCloudDialogflowV2OutputAudioConfig audioEncoding(AudioEncodingEnum audioEncoding) {
  ...
  public GoogleCloudDialogflowV2OutputAudioConfig sampleRateHertz(Integer sampleRateHertz) {
  ...
  public GoogleCloudDialogflowV2OutputAudioConfig synthesizeSpeechConfig(GoogleCloudDialogflowV2SynthesizeSpeechConfig synthesizeSpeechConfig) {
  ...
  public void setSynthesizeSpeechConfig(GoogleCloudDialogflowV2SynthesizeSpeechConfig synthesizeSpeechConfig) {
    this.synthesizeSpeechConfig = synthesizeSpeechConfig;
  }
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudDialogflowV2OutputAudioConfig googleCloudDialogflowV2OutputAudioConfig = (GoogleCloudDialogflowV2OutputAudioConfig) o;
    return Objects.equals(this.audioEncoding, googleCloudDialogflowV2OutputAudioConfig.audioEncoding) &&
        Objects.equals(this.sampleRateHertz, googleCloudDialogflowV2OutputAudioConfig.sampleRateHertz) &&
        Objects.equals(this.synthesizeSpeechConfig, googleCloudDialogflowV2OutputAudioConfig.synthesizeSpeechConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudDialogflowV2OutputAudioConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudDialogflowV2OutputAudioConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudDialogflowV2OutputAudioConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudDialogflowV2OutputAudioConfig is not found in the empty JSON string", GoogleCloudDialogflowV2OutputAudioConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudDialogflowV2OutputAudioConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudDialogflowV2OutputAudioConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("synthesizeSpeechConfig") != null && !jsonObj.get("synthesizeSpeechConfig").isJsonNull()) {
        GoogleCloudDialogflowV2SynthesizeSpeechConfig.validateJsonElement(jsonObj.get("synthesizeSpeechConfig"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudDialogflowV2OutputAudioConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudDialogflowV2OutputAudioConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudDialogflowV2OutputAudioConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudDialogflowV2OutputAudioConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudDialogflowV2OutputAudioConfig>() {
           @Override
           public void write(JsonWriter out, GoogleCloudDialogflowV2OutputAudioConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudDialogflowV2OutputAudioConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudDialogflowV2OutputAudioConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudDialogflowV2OutputAudioConfig
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudDialogflowV2OutputAudioConfig
   */
  public static GoogleCloudDialogflowV2OutputAudioConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudDialogflowV2OutputAudioConfig.class);
  }

  /**
   * Convert an instance of GoogleCloudDialogflowV2OutputAudioConfig to an JSON string
   *
   * @return JSON string
   */
