...
public class GoogleCloudDialogflowV2AnswerFeedback {
  ...
  public GoogleCloudDialogflowV2AnswerFeedback agentAssistantDetailFeedback(GoogleCloudDialogflowV2AgentAssistantFeedback agentAssistantDetailFeedback) {
  ...
  public void setAgentAssistantDetailFeedback(GoogleCloudDialogflowV2AgentAssistantFeedback agentAssistantDetailFeedback) {
    this.agentAssistantDetailFeedback = agentAssistantDetailFeedback;
  }


  public GoogleCloudDialogflowV2AnswerFeedback clickTime(String clickTime) {
  ...
  public GoogleCloudDialogflowV2AnswerFeedback clicked(Boolean clicked) {
  ...
  public GoogleCloudDialogflowV2AnswerFeedback correctnessLevel(CorrectnessLevelEnum correctnessLevel) {
  ...
  public GoogleCloudDialogflowV2AnswerFeedback displayTime(String displayTime) {
  ...
  public GoogleCloudDialogflowV2AnswerFeedback displayed(Boolean displayed) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudDialogflowV2AnswerFeedback googleCloudDialogflowV2AnswerFeedback = (GoogleCloudDialogflowV2AnswerFeedback) o;
    return Objects.equals(this.agentAssistantDetailFeedback, googleCloudDialogflowV2AnswerFeedback.agentAssistantDetailFeedback) &&
        Objects.equals(this.clickTime, googleCloudDialogflowV2AnswerFeedback.clickTime) &&
        Objects.equals(this.clicked, googleCloudDialogflowV2AnswerFeedback.clicked) &&
        Objects.equals(this.correctnessLevel, googleCloudDialogflowV2AnswerFeedback.correctnessLevel) &&
        Objects.equals(this.displayTime, googleCloudDialogflowV2AnswerFeedback.displayTime) &&
        Objects.equals(this.displayed, googleCloudDialogflowV2AnswerFeedback.displayed);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudDialogflowV2AnswerFeedback {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudDialogflowV2AnswerFeedback
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudDialogflowV2AnswerFeedback.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudDialogflowV2AnswerFeedback is not found in the empty JSON string", GoogleCloudDialogflowV2AnswerFeedback.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudDialogflowV2AnswerFeedback.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudDialogflowV2AnswerFeedback` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("agentAssistantDetailFeedback") != null && !jsonObj.get("agentAssistantDetailFeedback").isJsonNull()) {
        GoogleCloudDialogflowV2AgentAssistantFeedback.validateJsonElement(jsonObj.get("agentAssistantDetailFeedback"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudDialogflowV2AnswerFeedback.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudDialogflowV2AnswerFeedback' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudDialogflowV2AnswerFeedback> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudDialogflowV2AnswerFeedback.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudDialogflowV2AnswerFeedback>() {
           @Override
           public void write(JsonWriter out, GoogleCloudDialogflowV2AnswerFeedback value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudDialogflowV2AnswerFeedback read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudDialogflowV2AnswerFeedback given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudDialogflowV2AnswerFeedback
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudDialogflowV2AnswerFeedback
   */
  public static GoogleCloudDialogflowV2AnswerFeedback fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudDialogflowV2AnswerFeedback.class);
  }

  /**
   * Convert an instance of GoogleCloudDialogflowV2AnswerFeedback to an JSON string
   *
   * @return JSON string
   */
