...
public class GoogleCloudDialogflowV2InputAudioConfig {
  ...
  public static final String SERIALIZED_NAME_DISABLE_NO_SPEECH_RECOGNIZED_EVENT = "disableNoSpeechRecognizedEvent";
  @SerializedName(SERIALIZED_NAME_DISABLE_NO_SPEECH_RECOGNIZED_EVENT)
  private Boolean disableNoSpeechRecognizedEvent;
  ...
  private List<GoogleCloudDialogflowV2SpeechContext> speechContexts = new ArrayList<>();

  public GoogleCloudDialogflowV2InputAudioConfig() {
  }

  public GoogleCloudDialogflowV2InputAudioConfig audioEncoding(AudioEncodingEnum audioEncoding) {
  ...
  public GoogleCloudDialogflowV2InputAudioConfig disableNoSpeechRecognizedEvent(Boolean disableNoSpeechRecognizedEvent) {
  ...
  public void setDisableNoSpeechRecognizedEvent(Boolean disableNoSpeechRecognizedEvent) {
    this.disableNoSpeechRecognizedEvent = disableNoSpeechRecognizedEvent;
  }


  public GoogleCloudDialogflowV2InputAudioConfig enableAutomaticPunctuation(Boolean enableAutomaticPunctuation) {
  ...
  public GoogleCloudDialogflowV2InputAudioConfig enableWordInfo(Boolean enableWordInfo) {
  ...
  public GoogleCloudDialogflowV2InputAudioConfig languageCode(String languageCode) {
  ...
  public GoogleCloudDialogflowV2InputAudioConfig model(String model) {
    this.model = model;
    return this;
  }
  ...
  public GoogleCloudDialogflowV2InputAudioConfig modelVariant(ModelVariantEnum modelVariant) {
  ...
  public GoogleCloudDialogflowV2InputAudioConfig optOutConformerModelMigration(Boolean optOutConformerModelMigration) {
  ...
  @Deprecated
  public GoogleCloudDialogflowV2InputAudioConfig phraseHints(List<String> phraseHints) {
    this.phraseHints = phraseHints;
    return this;
  }

  public GoogleCloudDialogflowV2InputAudioConfig addPhraseHintsItem(String phraseHintsItem) {
  ...
  public GoogleCloudDialogflowV2InputAudioConfig sampleRateHertz(Integer sampleRateHertz) {
  ...
  public GoogleCloudDialogflowV2InputAudioConfig singleUtterance(Boolean singleUtterance) {
  ...
  public GoogleCloudDialogflowV2InputAudioConfig speechContexts(List<GoogleCloudDialogflowV2SpeechContext> speechContexts) {
    this.speechContexts = speechContexts;
    return this;
  }

  public GoogleCloudDialogflowV2InputAudioConfig addSpeechContextsItem(GoogleCloudDialogflowV2SpeechContext speechContextsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<GoogleCloudDialogflowV2SpeechContext> getSpeechContexts() {
    return speechContexts;
  }

  public void setSpeechContexts(List<GoogleCloudDialogflowV2SpeechContext> speechContexts) {
    this.speechContexts = speechContexts;
  }
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudDialogflowV2InputAudioConfig googleCloudDialogflowV2InputAudioConfig = (GoogleCloudDialogflowV2InputAudioConfig) o;
    return Objects.equals(this.audioEncoding, googleCloudDialogflowV2InputAudioConfig.audioEncoding) &&
        Objects.equals(this.disableNoSpeechRecognizedEvent, googleCloudDialogflowV2InputAudioConfig.disableNoSpeechRecognizedEvent) &&
        Objects.equals(this.enableAutomaticPunctuation, googleCloudDialogflowV2InputAudioConfig.enableAutomaticPunctuation) &&
        Objects.equals(this.enableWordInfo, googleCloudDialogflowV2InputAudioConfig.enableWordInfo) &&
        Objects.equals(this.languageCode, googleCloudDialogflowV2InputAudioConfig.languageCode) &&
        Objects.equals(this.model, googleCloudDialogflowV2InputAudioConfig.model) &&
        Objects.equals(this.modelVariant, googleCloudDialogflowV2InputAudioConfig.modelVariant) &&
        Objects.equals(this.optOutConformerModelMigration, googleCloudDialogflowV2InputAudioConfig.optOutConformerModelMigration) &&
        Objects.equals(this.phraseHints, googleCloudDialogflowV2InputAudioConfig.phraseHints) &&
        Objects.equals(this.sampleRateHertz, googleCloudDialogflowV2InputAudioConfig.sampleRateHertz) &&
        Objects.equals(this.singleUtterance, googleCloudDialogflowV2InputAudioConfig.singleUtterance) &&
        Objects.equals(this.speechContexts, googleCloudDialogflowV2InputAudioConfig.speechContexts);
  }

  @Override
  public int hashCode() {
    return Objects.hash(audioEncoding, disableNoSpeechRecognizedEvent, enableAutomaticPunctuation, enableWordInfo, languageCode, model, modelVariant, optOutConformerModelMigration, phraseHints, sampleRateHertz, singleUtterance, speechContexts);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GoogleCloudDialogflowV2InputAudioConfig {\n");
    sb.append("    audioEncoding: ").append(toIndentedString(audioEncoding)).append("\n");
    sb.append("    disableNoSpeechRecognizedEvent: ").append(toIndentedString(disableNoSpeechRecognizedEvent)).append("\n");
  ...
  static {
    ...
    openapiFields.add("disableNoSpeechRecognizedEvent");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudDialogflowV2InputAudioConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudDialogflowV2InputAudioConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudDialogflowV2InputAudioConfig is not found in the empty JSON string", GoogleCloudDialogflowV2InputAudioConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudDialogflowV2InputAudioConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudDialogflowV2InputAudioConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("speechContexts") != null && !jsonObj.get("speechContexts").isJsonNull()) {
        ...
        if (jsonArrayspeechContexts != null) {
          ...
          for (int i = 0; i < jsonArrayspeechContexts.size(); i++) {
            GoogleCloudDialogflowV2SpeechContext.validateJsonElement(jsonArrayspeechContexts.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudDialogflowV2InputAudioConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudDialogflowV2InputAudioConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudDialogflowV2InputAudioConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudDialogflowV2InputAudioConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudDialogflowV2InputAudioConfig>() {
           @Override
           public void write(JsonWriter out, GoogleCloudDialogflowV2InputAudioConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudDialogflowV2InputAudioConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudDialogflowV2InputAudioConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudDialogflowV2InputAudioConfig
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudDialogflowV2InputAudioConfig
   */
  public static GoogleCloudDialogflowV2InputAudioConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudDialogflowV2InputAudioConfig.class);
  }

  /**
   * Convert an instance of GoogleCloudDialogflowV2InputAudioConfig to an JSON string
   *
   * @return JSON string
   */
