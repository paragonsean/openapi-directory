...
|------------ | ------------- | ------------- | -------------|
|**agentAssistantDetailFeedback** | [**GoogleCloudDialogflowV2AgentAssistantFeedback**](GoogleCloudDialogflowV2AgentAssistantFeedback.md) |  |  [optional] |
|**clickTime** | **String** | Time when the answer/item was clicked. |  [optional] |
|**clicked** | **Boolean** | Indicates whether the answer/item was clicked by the human agent or not. Default to false. For knowledge search and knowledge assist, the answer record is considered to be clicked if the answer was copied or any URI was clicked. |  [optional] |
