...
|------------ | ------------- | ------------- | -------------|
|**agentContent** | **byte[]** | Uncompressed raw byte content for agent. This field is populated if none of &#x60;agent_uri&#x60; and &#x60;git_destination&#x60; are specified in ExportAgentRequest. |  [optional] |
