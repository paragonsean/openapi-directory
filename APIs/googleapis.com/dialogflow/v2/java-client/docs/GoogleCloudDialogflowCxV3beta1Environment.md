...
|**versionConfigs** | [**List&lt;GoogleCloudDialogflowCxV3beta1EnvironmentVersionConfig&gt;**](GoogleCloudDialogflowCxV3beta1EnvironmentVersionConfig.md) | A list of configurations for flow versions. You should include version configs for all flows that are reachable from &#x60;Start Flow&#x60; in the agent. Otherwise, an error will be returned. |  [optional] |
