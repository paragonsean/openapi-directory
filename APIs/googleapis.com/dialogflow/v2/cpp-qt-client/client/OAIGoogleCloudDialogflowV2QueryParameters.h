...
/*
 * OAIGoogleCloudDialogflowV2QueryParameters.h
 *
 * Represents the parameters of the conversational query.
 */

#ifndef OAIGoogleCloudDialogflowV2QueryParameters_H
#define OAIGoogleCloudDialogflowV2QueryParameters_H
...
class OAIGoogleCloudDialogflowV2SentimentAnalysisRequestConfig;
class OAIGoogleCloudDialogflowV2SessionEntityType;

class OAIGoogleCloudDialogflowV2QueryParameters : public OAIObject {
public:
    OAIGoogleCloudDialogflowV2QueryParameters();
    OAIGoogleCloudDialogflowV2QueryParameters(QString json);
    ~OAIGoogleCloudDialogflowV2QueryParameters() override;
    ...
    OAIGoogleCloudDialogflowV2SentimentAnalysisRequestConfig getSentimentAnalysisRequestConfig() const;
    void setSentimentAnalysisRequestConfig(const OAIGoogleCloudDialogflowV2SentimentAnalysisRequestConfig &sentiment_analysis_request_config);
...
private:
    ...
    OAIGoogleCloudDialogflowV2SentimentAnalysisRequestConfig m_sentiment_analysis_request_config;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudDialogflowV2QueryParameters)

#endif // OAIGoogleCloudDialogflowV2QueryParameters_H
