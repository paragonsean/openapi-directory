...
/*
 * OAIGoogleCloudDialogflowCxV3QueryParameters.h
 *
 * Represents the parameters of a conversational query.
 */

#ifndef OAIGoogleCloudDialogflowCxV3QueryParameters_H
#define OAIGoogleCloudDialogflowCxV3QueryParameters_H
...
class OAIGoogleCloudDialogflowCxV3SearchConfig;
class OAIGoogleCloudDialogflowCxV3SessionEntityType;

class OAIGoogleCloudDialogflowCxV3QueryParameters : public OAIObject {
public:
    OAIGoogleCloudDialogflowCxV3QueryParameters();
    OAIGoogleCloudDialogflowCxV3QueryParameters(QString json);
    ~OAIGoogleCloudDialogflowCxV3QueryParameters() override;
    ...
    OAIGoogleCloudDialogflowCxV3SearchConfig getSearchConfig() const;
    void setSearchConfig(const OAIGoogleCloudDialogflowCxV3SearchConfig &search_config);
...
private:
    ...
    OAIGoogleCloudDialogflowCxV3SearchConfig m_search_config;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudDialogflowCxV3QueryParameters)

#endif // OAIGoogleCloudDialogflowCxV3QueryParameters_H
