...
/*
 * OAIGoogleCloudDialogflowV2EventInput.h
 *
...
#ifndef OAIGoogleCloudDialogflowV2EventInput_H
#define OAIGoogleCloudDialogflowV2EventInput_H
...
class OAIGoogleCloudDialogflowV2EventInput : public OAIObject {
public:
    OAIGoogleCloudDialogflowV2EventInput();
    OAIGoogleCloudDialogflowV2EventInput(QString json);
    ~OAIGoogleCloudDialogflowV2EventInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudDialogflowV2EventInput)

#endif // OAIGoogleCloudDialogflowV2EventInput_H
