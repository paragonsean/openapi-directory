...
/*
 * OAIGoogleCloudDialogflowCxV3beta1WebhookGenericWebService.h
 *
 * Represents configuration for a generic web service.
 */

#ifndef OAIGoogleCloudDialogflowCxV3beta1WebhookGenericWebService_H
#define OAIGoogleCloudDialogflowCxV3beta1WebhookGenericWebService_H
...
class OAIGoogleCloudDialogflowCxV3beta1WebhookGenericWebService : public OAIObject {
public:
    OAIGoogleCloudDialogflowCxV3beta1WebhookGenericWebService();
    OAIGoogleCloudDialogflowCxV3beta1WebhookGenericWebService(QString json);
    ~OAIGoogleCloudDialogflowCxV3beta1WebhookGenericWebService() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudDialogflowCxV3beta1WebhookGenericWebService)

#endif // OAIGoogleCloudDialogflowCxV3beta1WebhookGenericWebService_H
