...
/*
 * OAIGoogleCloudDialogflowCxV3ExportEntityTypesRequest.h
 *
 * The request message for EntityTypes.ExportEntityTypes.
 */

#ifndef OAIGoogleCloudDialogflowCxV3ExportEntityTypesRequest_H
#define OAIGoogleCloudDialogflowCxV3ExportEntityTypesRequest_H
...
class OAIGoogleCloudDialogflowCxV3ExportEntityTypesRequest : public OAIObject {
public:
    OAIGoogleCloudDialogflowCxV3ExportEntityTypesRequest();
    OAIGoogleCloudDialogflowCxV3ExportEntityTypesRequest(QString json);
    ~OAIGoogleCloudDialogflowCxV3ExportEntityTypesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudDialogflowCxV3ExportEntityTypesRequest)

#endif // OAIGoogleCloudDialogflowCxV3ExportEntityTypesRequest_H
