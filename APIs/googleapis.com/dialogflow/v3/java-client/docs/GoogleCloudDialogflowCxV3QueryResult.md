...
|**responseMessages** | [**List&lt;GoogleCloudDialogflowCxV3ResponseMessage&gt;**](GoogleCloudDialogflowCxV3ResponseMessage.md) | The list of rich messages returned to the client. Responses vary from simple text messages to more sophisticated, structured payloads used to drive complex logic. |  [optional] |
