...
|------------ | ------------- | ------------- | -------------|
|**dataStoreConnections** | [**List&lt;GoogleCloudDialogflowCxV3beta1DataStoreConnection&gt;**](GoogleCloudDialogflowCxV3beta1DataStoreConnection.md) | Optional. List of related data store connections. |  [optional] |
