...
|------------ | ------------- | ------------- | -------------|
|**globalImportStrategy** | [**GlobalImportStrategyEnum**](#GlobalImportStrategyEnum) | Optional. Import strategy for resource conflict resolution, applied globally throughout the flow. It will be applied for all display name conflicts in the imported content. If not specified, &#39;CREATE_NEW&#39; is assumed. |  [optional] |
