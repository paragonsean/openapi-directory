...
public class GoogleCloudDialogflowV2beta1QueryResult {
  ...
  public static final String SERIALIZED_NAME_KNOWLEDGE_ANSWERS = "knowledgeAnswers";
  @SerializedName(SERIALIZED_NAME_KNOWLEDGE_ANSWERS)
  ...
  public GoogleCloudDialogflowV2beta1QueryResult() {
  }

  public GoogleCloudDialogflowV2beta1QueryResult action(String action) {
    this.action = action;
    return this;
  }
  ...
  public GoogleCloudDialogflowV2beta1QueryResult allRequiredParamsPresent(Boolean allRequiredParamsPresent) {
  ...
  public GoogleCloudDialogflowV2beta1QueryResult cancelsSlotFilling(Boolean cancelsSlotFilling) {
  ...
  public GoogleCloudDialogflowV2beta1QueryResult diagnosticInfo(Map<String, Object> diagnosticInfo) {
    this.diagnosticInfo = diagnosticInfo;
    return this;
  }

  public GoogleCloudDialogflowV2beta1QueryResult putDiagnosticInfoItem(String key, Object diagnosticInfoItem) {
  ...
  public GoogleCloudDialogflowV2beta1QueryResult fulfillmentMessages(List<GoogleCloudDialogflowV2beta1IntentMessage> fulfillmentMessages) {
    this.fulfillmentMessages = fulfillmentMessages;
    return this;
  }

  public GoogleCloudDialogflowV2beta1QueryResult addFulfillmentMessagesItem(GoogleCloudDialogflowV2beta1IntentMessage fulfillmentMessagesItem) {
  ...
  public GoogleCloudDialogflowV2beta1QueryResult fulfillmentText(String fulfillmentText) {
  ...
  public GoogleCloudDialogflowV2beta1QueryResult intent(GoogleCloudDialogflowV2beta1Intent intent) {
    this.intent = intent;
    return this;
  }
  ...
  public void setIntent(GoogleCloudDialogflowV2beta1Intent intent) {
    this.intent = intent;
  }


  public GoogleCloudDialogflowV2beta1QueryResult intentDetectionConfidence(Float intentDetectionConfidence) {
  ...
  public GoogleCloudDialogflowV2beta1QueryResult knowledgeAnswers(GoogleCloudDialogflowV2beta1KnowledgeAnswers knowledgeAnswers) {
    this.knowledgeAnswers = knowledgeAnswers;
    return this;
  }

  /**
   * Get knowledgeAnswers
  ...
  public void setKnowledgeAnswers(GoogleCloudDialogflowV2beta1KnowledgeAnswers knowledgeAnswers) {
    this.knowledgeAnswers = knowledgeAnswers;
  }


  public GoogleCloudDialogflowV2beta1QueryResult languageCode(String languageCode) {
  ...
  public GoogleCloudDialogflowV2beta1QueryResult outputContexts(List<GoogleCloudDialogflowV2beta1Context> outputContexts) {
    this.outputContexts = outputContexts;
    return this;
  }

  public GoogleCloudDialogflowV2beta1QueryResult addOutputContextsItem(GoogleCloudDialogflowV2beta1Context outputContextsItem) {
  ...
  public GoogleCloudDialogflowV2beta1QueryResult parameters(Map<String, Object> parameters) {
    this.parameters = parameters;
    return this;
  }

  public GoogleCloudDialogflowV2beta1QueryResult putParametersItem(String key, Object parametersItem) {
  ...
  public GoogleCloudDialogflowV2beta1QueryResult queryText(String queryText) {
  ...
  public GoogleCloudDialogflowV2beta1QueryResult sentimentAnalysisResult(GoogleCloudDialogflowV2beta1SentimentAnalysisResult sentimentAnalysisResult) {
  ...
  public void setSentimentAnalysisResult(GoogleCloudDialogflowV2beta1SentimentAnalysisResult sentimentAnalysisResult) {
    this.sentimentAnalysisResult = sentimentAnalysisResult;
  }


  public GoogleCloudDialogflowV2beta1QueryResult speechRecognitionConfidence(Float speechRecognitionConfidence) {
  ...
  public GoogleCloudDialogflowV2beta1QueryResult webhookPayload(Map<String, Object> webhookPayload) {
    this.webhookPayload = webhookPayload;
    return this;
  }

  public GoogleCloudDialogflowV2beta1QueryResult putWebhookPayloadItem(String key, Object webhookPayloadItem) {
  ...
  public GoogleCloudDialogflowV2beta1QueryResult webhookSource(String webhookSource) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudDialogflowV2beta1QueryResult googleCloudDialogflowV2beta1QueryResult = (GoogleCloudDialogflowV2beta1QueryResult) o;
    return Objects.equals(this.action, googleCloudDialogflowV2beta1QueryResult.action) &&
        Objects.equals(this.allRequiredParamsPresent, googleCloudDialogflowV2beta1QueryResult.allRequiredParamsPresent) &&
        Objects.equals(this.cancelsSlotFilling, googleCloudDialogflowV2beta1QueryResult.cancelsSlotFilling) &&
        Objects.equals(this.diagnosticInfo, googleCloudDialogflowV2beta1QueryResult.diagnosticInfo) &&
        Objects.equals(this.fulfillmentMessages, googleCloudDialogflowV2beta1QueryResult.fulfillmentMessages) &&
        Objects.equals(this.fulfillmentText, googleCloudDialogflowV2beta1QueryResult.fulfillmentText) &&
        Objects.equals(this.intent, googleCloudDialogflowV2beta1QueryResult.intent) &&
        Objects.equals(this.intentDetectionConfidence, googleCloudDialogflowV2beta1QueryResult.intentDetectionConfidence) &&
        Objects.equals(this.knowledgeAnswers, googleCloudDialogflowV2beta1QueryResult.knowledgeAnswers) &&
        Objects.equals(this.languageCode, googleCloudDialogflowV2beta1QueryResult.languageCode) &&
        Objects.equals(this.outputContexts, googleCloudDialogflowV2beta1QueryResult.outputContexts) &&
        Objects.equals(this.parameters, googleCloudDialogflowV2beta1QueryResult.parameters) &&
        Objects.equals(this.queryText, googleCloudDialogflowV2beta1QueryResult.queryText) &&
        Objects.equals(this.sentimentAnalysisResult, googleCloudDialogflowV2beta1QueryResult.sentimentAnalysisResult) &&
        Objects.equals(this.speechRecognitionConfidence, googleCloudDialogflowV2beta1QueryResult.speechRecognitionConfidence) &&
        Objects.equals(this.webhookPayload, googleCloudDialogflowV2beta1QueryResult.webhookPayload) &&
        Objects.equals(this.webhookSource, googleCloudDialogflowV2beta1QueryResult.webhookSource);
  }

  @Override
  public int hashCode() {
    return Objects.hash(action, allRequiredParamsPresent, cancelsSlotFilling, diagnosticInfo, fulfillmentMessages, fulfillmentText, intent, intentDetectionConfidence, knowledgeAnswers, languageCode, outputContexts, parameters, queryText, sentimentAnalysisResult, speechRecognitionConfidence, webhookPayload, webhookSource);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GoogleCloudDialogflowV2beta1QueryResult {\n");
    ...
    sb.append("    knowledgeAnswers: ").append(toIndentedString(knowledgeAnswers)).append("\n");
  ...
  static {
    ...
    openapiFields.add("knowledgeAnswers");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudDialogflowV2beta1QueryResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudDialogflowV2beta1QueryResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudDialogflowV2beta1QueryResult is not found in the empty JSON string", GoogleCloudDialogflowV2beta1QueryResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudDialogflowV2beta1QueryResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudDialogflowV2beta1QueryResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("intent") != null && !jsonObj.get("intent").isJsonNull()) {
        GoogleCloudDialogflowV2beta1Intent.validateJsonElement(jsonObj.get("intent"));
      }
      // validate the optional field `knowledgeAnswers`
      if (jsonObj.get("knowledgeAnswers") != null && !jsonObj.get("knowledgeAnswers").isJsonNull()) {
        GoogleCloudDialogflowV2beta1KnowledgeAnswers.validateJsonElement(jsonObj.get("knowledgeAnswers"));
      }
      ...
      if (jsonObj.get("sentimentAnalysisResult") != null && !jsonObj.get("sentimentAnalysisResult").isJsonNull()) {
        GoogleCloudDialogflowV2beta1SentimentAnalysisResult.validateJsonElement(jsonObj.get("sentimentAnalysisResult"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudDialogflowV2beta1QueryResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudDialogflowV2beta1QueryResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudDialogflowV2beta1QueryResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudDialogflowV2beta1QueryResult.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudDialogflowV2beta1QueryResult>() {
           @Override
           public void write(JsonWriter out, GoogleCloudDialogflowV2beta1QueryResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudDialogflowV2beta1QueryResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudDialogflowV2beta1QueryResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudDialogflowV2beta1QueryResult
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudDialogflowV2beta1QueryResult
   */
  public static GoogleCloudDialogflowV2beta1QueryResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudDialogflowV2beta1QueryResult.class);
  }

  /**
   * Convert an instance of GoogleCloudDialogflowV2beta1QueryResult to an JSON string
   *
   * @return JSON string
   */
