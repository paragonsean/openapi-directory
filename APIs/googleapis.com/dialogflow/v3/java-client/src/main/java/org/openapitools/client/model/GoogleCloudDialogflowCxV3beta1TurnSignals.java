...
public class GoogleCloudDialogflowCxV3beta1TurnSignals {
  ...
  public GoogleCloudDialogflowCxV3beta1TurnSignals() {
  }

  public GoogleCloudDialogflowCxV3beta1TurnSignals agentEscalated(Boolean agentEscalated) {
  ...
  public GoogleCloudDialogflowCxV3beta1TurnSignals dtmfUsed(Boolean dtmfUsed) {
  ...
  public GoogleCloudDialogflowCxV3beta1TurnSignals failureReasons(List<FailureReasonsEnum> failureReasons) {
    this.failureReasons = failureReasons;
    return this;
  }

  public GoogleCloudDialogflowCxV3beta1TurnSignals addFailureReasonsItem(FailureReasonsEnum failureReasonsItem) {
  ...
  public GoogleCloudDialogflowCxV3beta1TurnSignals noMatch(Boolean noMatch) {
  ...
  public GoogleCloudDialogflowCxV3beta1TurnSignals noUserInput(Boolean noUserInput) {
  ...
  public GoogleCloudDialogflowCxV3beta1TurnSignals reachedEndPage(Boolean reachedEndPage) {
  ...
  public GoogleCloudDialogflowCxV3beta1TurnSignals sentimentMagnitude(Float sentimentMagnitude) {
  ...
  public GoogleCloudDialogflowCxV3beta1TurnSignals sentimentScore(Float sentimentScore) {
  ...
  public GoogleCloudDialogflowCxV3beta1TurnSignals userEscalated(Boolean userEscalated) {
  ...
  public GoogleCloudDialogflowCxV3beta1TurnSignals webhookStatuses(List<String> webhookStatuses) {
    this.webhookStatuses = webhookStatuses;
    return this;
  }

  public GoogleCloudDialogflowCxV3beta1TurnSignals addWebhookStatusesItem(String webhookStatusesItem) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudDialogflowCxV3beta1TurnSignals googleCloudDialogflowCxV3beta1TurnSignals = (GoogleCloudDialogflowCxV3beta1TurnSignals) o;
    return Objects.equals(this.agentEscalated, googleCloudDialogflowCxV3beta1TurnSignals.agentEscalated) &&
        Objects.equals(this.dtmfUsed, googleCloudDialogflowCxV3beta1TurnSignals.dtmfUsed) &&
        Objects.equals(this.failureReasons, googleCloudDialogflowCxV3beta1TurnSignals.failureReasons) &&
        Objects.equals(this.noMatch, googleCloudDialogflowCxV3beta1TurnSignals.noMatch) &&
        Objects.equals(this.noUserInput, googleCloudDialogflowCxV3beta1TurnSignals.noUserInput) &&
        Objects.equals(this.reachedEndPage, googleCloudDialogflowCxV3beta1TurnSignals.reachedEndPage) &&
        Objects.equals(this.sentimentMagnitude, googleCloudDialogflowCxV3beta1TurnSignals.sentimentMagnitude) &&
        Objects.equals(this.sentimentScore, googleCloudDialogflowCxV3beta1TurnSignals.sentimentScore) &&
        Objects.equals(this.userEscalated, googleCloudDialogflowCxV3beta1TurnSignals.userEscalated) &&
        Objects.equals(this.webhookStatuses, googleCloudDialogflowCxV3beta1TurnSignals.webhookStatuses);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudDialogflowCxV3beta1TurnSignals {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudDialogflowCxV3beta1TurnSignals
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudDialogflowCxV3beta1TurnSignals.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudDialogflowCxV3beta1TurnSignals is not found in the empty JSON string", GoogleCloudDialogflowCxV3beta1TurnSignals.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudDialogflowCxV3beta1TurnSignals.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudDialogflowCxV3beta1TurnSignals` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudDialogflowCxV3beta1TurnSignals.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudDialogflowCxV3beta1TurnSignals' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudDialogflowCxV3beta1TurnSignals> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudDialogflowCxV3beta1TurnSignals.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudDialogflowCxV3beta1TurnSignals>() {
           @Override
           public void write(JsonWriter out, GoogleCloudDialogflowCxV3beta1TurnSignals value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudDialogflowCxV3beta1TurnSignals read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudDialogflowCxV3beta1TurnSignals given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudDialogflowCxV3beta1TurnSignals
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudDialogflowCxV3beta1TurnSignals
   */
  public static GoogleCloudDialogflowCxV3beta1TurnSignals fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudDialogflowCxV3beta1TurnSignals.class);
  }

  /**
   * Convert an instance of GoogleCloudDialogflowCxV3beta1TurnSignals to an JSON string
   *
   * @return JSON string
   */
