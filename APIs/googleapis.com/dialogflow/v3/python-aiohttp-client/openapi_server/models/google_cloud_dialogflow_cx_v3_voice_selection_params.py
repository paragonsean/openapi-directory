...
class GoogleCloudDialogflowCxV3VoiceSelectionParams(Model):
    ...
    def __init__(self, name: str=None, ssml_gender: str=None):
        """GoogleCloudDialogflowCxV3VoiceSelectionParams - a model defined in OpenAPI

        :param name: The name of this GoogleCloudDialogflowCxV3VoiceSelectionParams.
        :param ssml_gender: The ssml_gender of this GoogleCloudDialogflowCxV3VoiceSelectionParams.
        """
        self.openapi_types = {
            'name': str,
            'ssml_gender': str
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'GoogleCloudDialogflowCxV3VoiceSelectionParams':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The GoogleCloudDialogflowCxV3VoiceSelectionParams of this GoogleCloudDialogflowCxV3VoiceSelectionParams.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def name(self):
        """Gets the name of this GoogleCloudDialogflowCxV3VoiceSelectionParams.
        ...
        :return: The name of this GoogleCloudDialogflowCxV3VoiceSelectionParams.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this GoogleCloudDialogflowCxV3VoiceSelectionParams.
    ...
    def ssml_gender(self):
        """Gets the ssml_gender of this GoogleCloudDialogflowCxV3VoiceSelectionParams.
        ...
        :return: The ssml_gender of this GoogleCloudDialogflowCxV3VoiceSelectionParams.
        :rtype: str
        """
    ...
    def ssml_gender(self, ssml_gender):
        """Sets the ssml_gender of this GoogleCloudDialogflowCxV3VoiceSelectionParams.
