# DialogflowApi.GoogleCloudDialogflowCxV3ExportTestCasesRequest

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**dataFormat** | **String** | The data format of the exported test cases. If not specified, &#x60;BLOB&#x60; is assumed. | [optional] 
