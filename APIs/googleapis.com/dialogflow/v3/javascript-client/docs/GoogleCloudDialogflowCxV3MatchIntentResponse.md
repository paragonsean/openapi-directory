# DialogflowApi.GoogleCloudDialogflowCxV3MatchIntentResponse
...
**matches** | [**[GoogleCloudDialogflowCxV3Match]**](GoogleCloudDialogflowCxV3Match.md) | Match results, if more than one, ordered descendingly by the confidence we have that the particular intent matches the query. | [optional] 
