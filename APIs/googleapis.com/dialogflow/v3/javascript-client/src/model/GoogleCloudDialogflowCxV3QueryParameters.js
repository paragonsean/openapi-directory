...
import GoogleCloudDialogflowCxV3SearchConfig from './GoogleCloudDialogflowCxV3SearchConfig';
...
/**
 * The GoogleCloudDialogflowCxV3QueryParameters model module.
 * @module model/GoogleCloudDialogflowCxV3QueryParameters
 * @version v3
 */
class GoogleCloudDialogflowCxV3QueryParameters {
    /**
     * Constructs a new <code>GoogleCloudDialogflowCxV3QueryParameters</code>.
     * Represents the parameters of a conversational query.
     * @alias module:model/GoogleCloudDialogflowCxV3QueryParameters
     */
    constructor() { 
        
        GoogleCloudDialogflowCxV3QueryParameters.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudDialogflowCxV3QueryParameters</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudDialogflowCxV3QueryParameters} obj Optional instance to populate.
     * @return {module:model/GoogleCloudDialogflowCxV3QueryParameters} The populated <code>GoogleCloudDialogflowCxV3QueryParameters</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudDialogflowCxV3QueryParameters();
            ...
            if (data.hasOwnProperty('searchConfig')) {
                obj['searchConfig'] = GoogleCloudDialogflowCxV3SearchConfig.constructFromObject(data['searchConfig']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudDialogflowCxV3QueryParameters</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudDialogflowCxV3QueryParameters</code>.
     */
    static validateJSON(data) {
        ...
        if (data['searchConfig']) { // data not null
          GoogleCloudDialogflowCxV3SearchConfig.validateJSON(data['searchConfig']);
        }
 ...
 */
GoogleCloudDialogflowCxV3QueryParameters.prototype['analyzeQueryTextSentiment'] = undefined;
 ...
 */
GoogleCloudDialogflowCxV3QueryParameters.prototype['channel'] = undefined;
 ...
 */
GoogleCloudDialogflowCxV3QueryParameters.prototype['currentPage'] = undefined;

/**
 * Whether to disable webhook calls for this request.
 * @member {Boolean} disableWebhook
 */
GoogleCloudDialogflowCxV3QueryParameters.prototype['disableWebhook'] = undefined;
 ...
 */
GoogleCloudDialogflowCxV3QueryParameters.prototype['endUserMetadata'] = undefined;
 ...
 */
GoogleCloudDialogflowCxV3QueryParameters.prototype['flowVersions'] = undefined;

/**
 * @member {module:model/GoogleTypeLatLng} geoLocation
 */
GoogleCloudDialogflowCxV3QueryParameters.prototype['geoLocation'] = undefined;
 ...
 */
GoogleCloudDialogflowCxV3QueryParameters.prototype['parameters'] = undefined;
 ...
 */
GoogleCloudDialogflowCxV3QueryParameters.prototype['payload'] = undefined;

/**
 * @member {module:model/GoogleCloudDialogflowCxV3SearchConfig} searchConfig
 */
GoogleCloudDialogflowCxV3QueryParameters.prototype['searchConfig'] = undefined;

/**
 * Additional session entity types to replace or extend developer entity types with. The entity synonyms apply to all languages and persist for the session of this query.
 * @member {Array.<module:model/GoogleCloudDialogflowCxV3SessionEntityType>} sessionEntityTypes
 */
GoogleCloudDialogflowCxV3QueryParameters.prototype['sessionEntityTypes'] = undefined;
 ...
 */
GoogleCloudDialogflowCxV3QueryParameters.prototype['sessionTtl'] = undefined;
 ...
 */
GoogleCloudDialogflowCxV3QueryParameters.prototype['timeZone'] = undefined;
 ...
 */
GoogleCloudDialogflowCxV3QueryParameters.prototype['webhookHeaders'] = undefined;
...
export default GoogleCloudDialogflowCxV3QueryParameters;
