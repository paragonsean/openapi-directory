...
|------------ | ------------- | ------------- | -------------|
|**excludedAppIds** | **List&lt;String&gt;** | A list of application IDs to be excluded. |  [optional] |
|**targetedAppIds** | **List&lt;String&gt;** | A list of application IDs to be included. |  [optional] |
