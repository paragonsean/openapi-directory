...
|**dealType** | [**DealTypeEnum**](#DealTypeEnum) | Output only. Type of deal the proposal contains. |  [optional] [readonly] |
...
|**sellerContacts** | [**List&lt;Contact&gt;**](Contact.md) | Output only. Contact information for the seller. |  [optional] [readonly] |
|**state** | [**StateEnum**](#StateEnum) | Output only. Indicates the state of the proposal. |  [optional] [readonly] |
