...
public class ClientUser {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.email, clientUser.email) &&
        Objects.equals(this.name, clientUser.name) &&
        Objects.equals(this.state, clientUser.state);
  }

  @Override
  public int hashCode() {
    return Objects.hash(email, name, state);
  }
