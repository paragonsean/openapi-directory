...
public class ApiClient {
    ...
    private String basePath = "https://authorizedbuyersmarketplace.googleapis.com";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://authorizedbuyersmarketplace.googleapis.com
