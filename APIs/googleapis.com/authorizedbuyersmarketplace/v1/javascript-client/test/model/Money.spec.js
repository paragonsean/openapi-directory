...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AuthorizedBuyersMarketplaceApi.Money();
  });
  ...
  describe('Money', function() {
    it('should create an instance of Money', function() {
      ...
      //var instance = new AuthorizedBuyersMarketplaceApi.Money();
      //expect(instance).to.be.a(AuthorizedBuyersMarketplaceApi.Money);
    });
