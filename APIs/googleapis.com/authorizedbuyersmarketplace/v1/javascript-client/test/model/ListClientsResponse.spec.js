...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AuthorizedBuyersMarketplaceApi.ListClientsResponse();
  });
  ...
  describe('ListClientsResponse', function() {
    it('should create an instance of ListClientsResponse', function() {
      ...
      //var instance = new AuthorizedBuyersMarketplaceApi.ListClientsResponse();
      //expect(instance).to.be.a(AuthorizedBuyersMarketplaceApi.ListClientsResponse);
    });
