...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AuthorizedBuyersMarketplaceApi.TimeOfDay();
  });
  ...
  describe('TimeOfDay', function() {
    it('should create an instance of TimeOfDay', function() {
      ...
      //var instance = new AuthorizedBuyersMarketplaceApi.TimeOfDay();
      //expect(instance).to.be.a(AuthorizedBuyersMarketplaceApi.TimeOfDay);
    });
