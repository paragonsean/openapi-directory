...
class FrequencyCap {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('timeUnitsCount')) {
                obj['timeUnitsCount'] = ApiClient.convertToType(data['timeUnitsCount'], 'Number');
            }
        }
        return obj;
    }
 ...
 * @member {Number} timeUnitsCount
 */
FrequencyCap.prototype['timeUnitsCount'] = undefined;
