...
class Creative(Model):
    ...
    def __init__(self, html_snippet: str=None, account_id: int=None, advertiser_id: List[str]=None, advertiser_name: str=None, agency_id: str=None, api_upload_timestamp: datetime=None, attribute: List[int]=None, buyer_creative_id: str=None, click_through_url: List[str]=None, corrections: List[CreativeCorrectionsInner]=None, disapproval_reasons: List[CreativeDisapprovalReasonsInner]=None, filtering_reasons: CreativeFilteringReasons=None, height: int=None, impression_tracking_url: List[str]=None, kind: str='adexchangebuyer#creative', product_categories: List[int]=None, restricted_categories: List[int]=None, sensitive_categories: List[int]=None, status: str=None, vendor_type: List[int]=None, version: int=None, video_url: str=None, width: int=None):
