...
async def adexchangebuyer_accounts_patch(request: web.Request, id, alt=None, fields=None, key=None, oauth_token=None, pretty_print=None, quota_user=None, user_ip=None, body=None) -> web.Response:
...
async def adexchangebuyer_accounts_update(request: web.Request, id, alt=None, fields=None, key=None, oauth_token=None, pretty_print=None, quota_user=None, user_ip=None, body=None) -> web.Response:
