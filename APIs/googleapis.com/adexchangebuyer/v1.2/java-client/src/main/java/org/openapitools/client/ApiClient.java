...
public class ApiClient {
    ...
    private String basePath = "https://www.googleapis.com/adexchangebuyer/v1.2";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://www.googleapis.com/adexchangebuyer/v1.2
