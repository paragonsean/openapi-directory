...
public class Example {
  public static void main(String[] args) {
    ...
    defaultClient.setBasePath("https://www.googleapis.com/adexchangebuyer/v1.2");
...
> CreativesList adexchangebuyerCreativesList(alt, fields, key, oauthToken, prettyPrint, quotaUser, userIp, maxResults, pageToken, statusFilter)
...
public class Example {
  public static void main(String[] args) {
    ...
    String statusFilter = "approved"; // String | When specified, only creatives having the given status are returned.
    try {
      CreativesList result = apiInstance.adexchangebuyerCreativesList(alt, fields, key, oauthToken, prettyPrint, quotaUser, userIp, maxResults, pageToken, statusFilter);
      System.out.println(result);
    } catch (ApiException e) {
...
| **statusFilter** | **String**| When specified, only creatives having the given status are returned. | [optional] [enum: approved, disapproved, not_checked] |
