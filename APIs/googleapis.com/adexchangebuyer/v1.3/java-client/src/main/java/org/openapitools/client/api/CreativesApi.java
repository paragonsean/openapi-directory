...
public class CreativesApi {
     ...
     * @param quotaUser An opaque string that represents a user for quota purposes. Must not exceed 40 characters. (optional)
     * @param userIp Deprecated. Please use quotaUser instead. (optional)
     * @param accountId When specified, only creatives for the given account ids are returned. (optional)
     * @param buyerCreativeId When specified, only creatives for the given buyer creative ids are returned. (optional)
     ...
     */
    public okhttp3.Call adexchangebuyerCreativesListCall(String alt, String fields, String key, String oauthToken, Boolean prettyPrint, String quotaUser, String userIp, List<Integer> accountId, List<String> buyerCreativeId, Integer maxResults, String pageToken, String statusFilter, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        if (buyerCreativeId != null) {
            localVarCollectionQueryParams.addAll(localVarApiClient.parameterToPairs("multi", "buyerCreativeId", buyerCreativeId));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call adexchangebuyerCreativesListValidateBeforeCall(String alt, String fields, String key, String oauthToken, Boolean prettyPrint, String quotaUser, String userIp, List<Integer> accountId, List<String> buyerCreativeId, Integer maxResults, String pageToken, String statusFilter, final ApiCallback _callback) throws ApiException {
        return adexchangebuyerCreativesListCall(alt, fields, key, oauthToken, prettyPrint, quotaUser, userIp, accountId, buyerCreativeId, maxResults, pageToken, statusFilter, _callback);
     ...
     */
    public CreativesList adexchangebuyerCreativesList(String alt, String fields, String key, String oauthToken, Boolean prettyPrint, String quotaUser, String userIp, List<Integer> accountId, List<String> buyerCreativeId, Integer maxResults, String pageToken, String statusFilter) throws ApiException {
        ApiResponse<CreativesList> localVarResp = adexchangebuyerCreativesListWithHttpInfo(alt, fields, key, oauthToken, prettyPrint, quotaUser, userIp, accountId, buyerCreativeId, maxResults, pageToken, statusFilter);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<CreativesList> adexchangebuyerCreativesListWithHttpInfo(String alt, String fields, String key, String oauthToken, Boolean prettyPrint, String quotaUser, String userIp, List<Integer> accountId, List<String> buyerCreativeId, Integer maxResults, String pageToken, String statusFilter) throws ApiException {
        okhttp3.Call localVarCall = adexchangebuyerCreativesListValidateBeforeCall(alt, fields, key, oauthToken, prettyPrint, quotaUser, userIp, accountId, buyerCreativeId, maxResults, pageToken, statusFilter, null);
     ...
     */
    public okhttp3.Call adexchangebuyerCreativesListAsync(String alt, String fields, String key, String oauthToken, Boolean prettyPrint, String quotaUser, String userIp, List<Integer> accountId, List<String> buyerCreativeId, Integer maxResults, String pageToken, String statusFilter, final ApiCallback<CreativesList> _callback) throws ApiException {

        okhttp3.Call localVarCall = adexchangebuyerCreativesListValidateBeforeCall(alt, fields, key, oauthToken, prettyPrint, quotaUser, userIp, accountId, buyerCreativeId, maxResults, pageToken, statusFilter, _callback);
        Type localVarReturnType = new TypeToken<CreativesList>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
