...
public class ApiClient {
    ...
    private String basePath = "https://www.googleapis.com/adexchangebuyer/v1.3";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/v1.3/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://www.googleapis.com/adexchangebuyer/v1.3
