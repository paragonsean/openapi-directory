...
> CreativesList adexchangebuyerCreativesList(alt, fields, key, oauthToken, prettyPrint, quotaUser, userIp, accountId, buyerCreativeId, maxResults, pageToken, statusFilter)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      CreativesList result = apiInstance.adexchangebuyerCreativesList(alt, fields, key, oauthToken, prettyPrint, quotaUser, userIp, accountId, buyerCreativeId, maxResults, pageToken, statusFilter);
      System.out.println(result);
    } catch (ApiException e) {
