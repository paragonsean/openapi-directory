...
async def adexchangebuyer_creatives_list(request: web.Request, alt=None, fields=None, key=None, oauth_token=None, pretty_print=None, quota_user=None, user_ip=None, account_id=None, buyer_creative_id=None, max_results=None, page_token=None, status_filter=None) -> web.Response:
