# AdExchangeBuyerApi.DirectDeal

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**accountId** | **Number** | The account id of the buyer this deal is for. | [optional] 
...
**kind** | **String** | Resource type. | [optional] [default to &#39;adexchangebuyer#directDeal&#39;]
