...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://www.googleapis.com/adexchangebuyer/v1.3') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://www.googleapis.com/adexchangebuyer/v1.3
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/v1.3/Javascript'
        };
