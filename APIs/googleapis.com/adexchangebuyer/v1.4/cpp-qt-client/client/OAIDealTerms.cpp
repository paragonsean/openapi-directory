...
void OAIDealTerms::initializeModel() {
    ...
    m_cross_listed_external_deal_id_type_isSet = false;
    m_cross_listed_external_deal_id_type_isValid = false;
    ...
    m_rubicon_non_guaranteed_terms_isSet = false;
    m_rubicon_non_guaranteed_terms_isValid = false;
...
void OAIDealTerms::fromJsonObject(QJsonObject json) {
    ...
    m_cross_listed_external_deal_id_type_isValid = ::OpenAPI::fromJsonValue(m_cross_listed_external_deal_id_type, json[QString("crossListedExternalDealIdType")]);
    m_cross_listed_external_deal_id_type_isSet = !json[QString("crossListedExternalDealIdType")].isNull() && m_cross_listed_external_deal_id_type_isValid;
    ...
    m_rubicon_non_guaranteed_terms_isValid = ::OpenAPI::fromJsonValue(m_rubicon_non_guaranteed_terms, json[QString("rubiconNonGuaranteedTerms")]);
    m_rubicon_non_guaranteed_terms_isSet = !json[QString("rubiconNonGuaranteedTerms")].isNull() && m_rubicon_non_guaranteed_terms_isValid;
...
QJsonObject OAIDealTerms::asJsonObject() const {
    ...
    if (m_cross_listed_external_deal_id_type_isSet) {
        obj.insert(QString("crossListedExternalDealIdType"), ::OpenAPI::toJsonValue(m_cross_listed_external_deal_id_type));
    }
    ...
    if (m_rubicon_non_guaranteed_terms.isSet()) {
        obj.insert(QString("rubiconNonGuaranteedTerms"), ::OpenAPI::toJsonValue(m_rubicon_non_guaranteed_terms));
    }
...
QString OAIDealTerms::getCrossListedExternalDealIdType() const {
    return m_cross_listed_external_deal_id_type;
}
void OAIDealTerms::setCrossListedExternalDealIdType(const QString &cross_listed_external_deal_id_type) {
    m_cross_listed_external_deal_id_type = cross_listed_external_deal_id_type;
    m_cross_listed_external_deal_id_type_isSet = true;
}

bool OAIDealTerms::is_cross_listed_external_deal_id_type_Set() const{
    return m_cross_listed_external_deal_id_type_isSet;
}

bool OAIDealTerms::is_cross_listed_external_deal_id_type_Valid() const{
    return m_cross_listed_external_deal_id_type_isValid;
}
...
OAIDealTermsGuaranteedFixedPriceTerms OAIDealTerms::getGuaranteedFixedPriceTerms() const {
    return m_guaranteed_fixed_price_terms;
}
void OAIDealTerms::setGuaranteedFixedPriceTerms(const OAIDealTermsGuaranteedFixedPriceTerms &guaranteed_fixed_price_terms) {
...
OAIDealTermsNonGuaranteedAuctionTerms OAIDealTerms::getNonGuaranteedAuctionTerms() const {
    return m_non_guaranteed_auction_terms;
}
void OAIDealTerms::setNonGuaranteedAuctionTerms(const OAIDealTermsNonGuaranteedAuctionTerms &non_guaranteed_auction_terms) {
...
OAIDealTermsNonGuaranteedFixedPriceTerms OAIDealTerms::getNonGuaranteedFixedPriceTerms() const {
    return m_non_guaranteed_fixed_price_terms;
}
void OAIDealTerms::setNonGuaranteedFixedPriceTerms(const OAIDealTermsNonGuaranteedFixedPriceTerms &non_guaranteed_fixed_price_terms) {
...
OAIDealTermsRubiconNonGuaranteedTerms OAIDealTerms::getRubiconNonGuaranteedTerms() const {
    return m_rubicon_non_guaranteed_terms;
}
void OAIDealTerms::setRubiconNonGuaranteedTerms(const OAIDealTermsRubiconNonGuaranteedTerms &rubicon_non_guaranteed_terms) {
    m_rubicon_non_guaranteed_terms = rubicon_non_guaranteed_terms;
    m_rubicon_non_guaranteed_terms_isSet = true;
}

bool OAIDealTerms::is_rubicon_non_guaranteed_terms_Set() const{
    return m_rubicon_non_guaranteed_terms_isSet;
}

bool OAIDealTerms::is_rubicon_non_guaranteed_terms_Valid() const{
    return m_rubicon_non_guaranteed_terms_isValid;
}
