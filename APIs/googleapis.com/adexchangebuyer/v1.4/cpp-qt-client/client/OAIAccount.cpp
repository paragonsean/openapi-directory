...
void OAIAccount::initializeModel() {
    ...
    m_apply_pretargeting_to_non_guaranteed_deals_isSet = false;
    m_apply_pretargeting_to_non_guaranteed_deals_isValid = false;
...
void OAIAccount::fromJsonObject(QJsonObject json) {
    ...
    m_apply_pretargeting_to_non_guaranteed_deals_isValid = ::OpenAPI::fromJsonValue(m_apply_pretargeting_to_non_guaranteed_deals, json[QString("applyPretargetingToNonGuaranteedDeals")]);
    m_apply_pretargeting_to_non_guaranteed_deals_isSet = !json[QString("applyPretargetingToNonGuaranteedDeals")].isNull() && m_apply_pretargeting_to_non_guaranteed_deals_isValid;
...
QJsonObject OAIAccount::asJsonObject() const {
    QJsonObject obj;
    if (m_apply_pretargeting_to_non_guaranteed_deals_isSet) {
        obj.insert(QString("applyPretargetingToNonGuaranteedDeals"), ::OpenAPI::toJsonValue(m_apply_pretargeting_to_non_guaranteed_deals));
    }
...
bool OAIAccount::isApplyPretargetingToNonGuaranteedDeals() const {
    return m_apply_pretargeting_to_non_guaranteed_deals;
}
void OAIAccount::setApplyPretargetingToNonGuaranteedDeals(const bool &apply_pretargeting_to_non_guaranteed_deals) {
    m_apply_pretargeting_to_non_guaranteed_deals = apply_pretargeting_to_non_guaranteed_deals;
    m_apply_pretargeting_to_non_guaranteed_deals_isSet = true;
}

bool OAIAccount::is_apply_pretargeting_to_non_guaranteed_deals_Set() const{
    return m_apply_pretargeting_to_non_guaranteed_deals_isSet;
}

bool OAIAccount::is_apply_pretargeting_to_non_guaranteed_deals_Valid() const{
    return m_apply_pretargeting_to_non_guaranteed_deals_isValid;
}
