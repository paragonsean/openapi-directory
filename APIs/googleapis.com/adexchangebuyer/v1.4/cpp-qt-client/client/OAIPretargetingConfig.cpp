...
void OAIPretargetingConfig::initializeModel() {
    ...
    m_user_identifier_data_required_isSet = false;
    m_user_identifier_data_required_isValid = false;
    ...
    m_video_player_sizes_isSet = false;
    m_video_player_sizes_isValid = false;
}
...
void OAIPretargetingConfig::fromJsonObject(QJsonObject json) {
    ...
    m_user_identifier_data_required_isValid = ::OpenAPI::fromJsonValue(m_user_identifier_data_required, json[QString("userIdentifierDataRequired")]);
    m_user_identifier_data_required_isSet = !json[QString("userIdentifierDataRequired")].isNull() && m_user_identifier_data_required_isValid;
    ...
    m_video_player_sizes_isValid = ::OpenAPI::fromJsonValue(m_video_player_sizes, json[QString("videoPlayerSizes")]);
    m_video_player_sizes_isSet = !json[QString("videoPlayerSizes")].isNull() && m_video_player_sizes_isValid;
}
...
QJsonObject OAIPretargetingConfig::asJsonObject() const {
    ...
    if (m_user_identifier_data_required.size() > 0) {
        obj.insert(QString("userIdentifierDataRequired"), ::OpenAPI::toJsonValue(m_user_identifier_data_required));
    }
    ...
    if (m_video_player_sizes.size() > 0) {
        obj.insert(QString("videoPlayerSizes"), ::OpenAPI::toJsonValue(m_video_player_sizes));
    }
    return obj;
}
...
QList<QString> OAIPretargetingConfig::getUserIdentifierDataRequired() const {
    return m_user_identifier_data_required;
}
void OAIPretargetingConfig::setUserIdentifierDataRequired(const QList<QString> &user_identifier_data_required) {
    m_user_identifier_data_required = user_identifier_data_required;
    m_user_identifier_data_required_isSet = true;
}

bool OAIPretargetingConfig::is_user_identifier_data_required_Set() const{
    return m_user_identifier_data_required_isSet;
}

bool OAIPretargetingConfig::is_user_identifier_data_required_Valid() const{
    return m_user_identifier_data_required_isValid;
}
...
QList<OAIPretargetingConfig_videoPlayerSizes_inner> OAIPretargetingConfig::getVideoPlayerSizes() const {
    return m_video_player_sizes;
}
void OAIPretargetingConfig::setVideoPlayerSizes(const QList<OAIPretargetingConfig_videoPlayerSizes_inner> &video_player_sizes) {
    m_video_player_sizes = video_player_sizes;
    m_video_player_sizes_isSet = true;
}

bool OAIPretargetingConfig::is_video_player_sizes_Set() const{
    return m_video_player_sizes_isSet;
}

bool OAIPretargetingConfig::is_video_player_sizes_Valid() const{
    return m_video_player_sizes_isValid;
}
