...
QString OAICreative_nativeAd::getClickLinkUrl() const {
    return m_click_link_url;
}
void OAICreative_nativeAd::setClickLinkUrl(const QString &click_link_url) {
    m_click_link_url = click_link_url;
    m_click_link_url_isSet = true;
}

bool OAICreative_nativeAd::is_click_link_url_Set() const{
    return m_click_link_url_isSet;
}

bool OAICreative_nativeAd::is_click_link_url_Valid() const{
...
QString OAICreative_nativeAd::getVideoUrl() const {
    return m_video_url;
}
void OAICreative_nativeAd::setVideoUrl(const QString &video_url) {
    m_video_url = video_url;
    m_video_url_isSet = true;
}

bool OAICreative_nativeAd::is_video_url_Set() const{
    return m_video_url_isSet;
}

bool OAICreative_nativeAd::is_video_url_Valid() const{
