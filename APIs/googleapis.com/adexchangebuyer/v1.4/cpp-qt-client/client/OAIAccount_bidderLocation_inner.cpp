...
QString OAIAccount_bidderLocation_inner::getBidProtocol() const {
    return m_bid_protocol;
}
void OAIAccount_bidderLocation_inner::setBidProtocol(const QString &bid_protocol) {
    m_bid_protocol = bid_protocol;
    m_bid_protocol_isSet = true;
}

bool OAIAccount_bidderLocation_inner::is_bid_protocol_Set() const{
    return m_bid_protocol_isSet;
}

bool OAIAccount_bidderLocation_inner::is_bid_protocol_Valid() const{
