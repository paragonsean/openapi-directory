...
class OAICreative_servingRestrictions_inner;
...
public:
    ...
    QString getCreativeStatusIdentityType() const;
    void setCreativeStatusIdentityType(const QString &creative_status_identity_type);
    bool is_creative_status_identity_type_Set() const;
    bool is_creative_status_identity_type_Valid() const;
    ...
    QList<OAICreative_servingRestrictions_inner> getServingRestrictions() const;
    void setServingRestrictions(const QList<OAICreative_servingRestrictions_inner> &serving_restrictions);
...
private:
    ...
    QString m_creative_status_identity_type;
    bool m_creative_status_identity_type_isSet;
    bool m_creative_status_identity_type_isValid;
    ...
    QList<OAICreative_servingRestrictions_inner> m_serving_restrictions;
