...
(function(root, factory) {
  ...
  describe('Creative', function() {
    ...
    it('should have the property creativeStatusIdentityType (base name: "creativeStatusIdentityType")', function() {
      // uncomment below and update the code to test the property creativeStatusIdentityType
      //var instance = new AdExchangeBuyerApi.Creative();
      //expect(instance).to.be();
    });
    ...
    it('should have the property nativeAd (base name: "nativeAd")', function() {
      // uncomment below and update the code to test the property nativeAd
      //var instance = new AdExchangeBuyerApi.Creative();
      //expect(instance).to.be();
    });
