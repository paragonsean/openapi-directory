...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdExchangeBuyerApi.PretargetingConfigVideoPlayerSizesInner();
  });
  ...
  describe('PretargetingConfigVideoPlayerSizesInner', function() {
    it('should create an instance of PretargetingConfigVideoPlayerSizesInner', function() {
      // uncomment below and update the code to test PretargetingConfigVideoPlayerSizesInner
      //var instance = new AdExchangeBuyerApi.PretargetingConfigVideoPlayerSizesInner();
      //expect(instance).to.be.a(AdExchangeBuyerApi.PretargetingConfigVideoPlayerSizesInner);
    });
