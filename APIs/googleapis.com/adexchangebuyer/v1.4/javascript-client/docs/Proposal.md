...
**buyerContacts** | [**[ContactInformation]**](ContactInformation.md) | Optional contact information of the buyer. (seller-readonly) | [optional] 
**buyerPrivateData** | [**PrivateData**](PrivateData.md) |  | [optional] 
**dbmAdvertiserIds** | **[String]** | IDs of DBM advertisers permission to this proposal. | [optional] 
...
**kind** | **String** | Identifies what kind of resource this is. Value: the fixed string \&quot;adexchangebuyer#proposal\&quot;. | [optional] [default to &#39;adexchangebuyer#proposal&#39;]
**labels** | [**[MarketplaceLabel]**](MarketplaceLabel.md) | List of labels associated with the proposal. (readonly) | [optional] 
...
**sellerContacts** | [**[ContactInformation]**](ContactInformation.md) | Optional contact information of the seller (buyer-readonly). | [optional] 
