# AdExchangeBuyerApi.PubprofilesApi
...
> GetPublisherProfilesByAccountIdResponse adexchangebuyerPubprofilesList(accountId, opts)
...
let apiInstance = new AdExchangeBuyerApi.PubprofilesApi();
let accountId = 56; // Number | The accountId of the publisher to get profiles for.
let opts = {
...
apiInstance.adexchangebuyerPubprofilesList(accountId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
------------- | ------------- | ------------- | -------------
 **accountId** | **Number**| The accountId of the publisher to get profiles for. | 
