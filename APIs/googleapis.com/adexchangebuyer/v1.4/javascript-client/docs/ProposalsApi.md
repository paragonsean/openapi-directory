# AdExchangeBuyerApi.ProposalsApi
...
> Proposal adexchangebuyerProposalsGet(proposalId, opts)
...
let apiInstance = new AdExchangeBuyerApi.ProposalsApi();
let proposalId = "proposalId_example"; // String | Id of the proposal to retrieve.
let opts = {
...
apiInstance.adexchangebuyerProposalsGet(proposalId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> CreateOrdersResponse adexchangebuyerProposalsInsert(opts)
...
let opts = {
  ...
  'quotaUser': "quotaUser_example", // String | An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
  'userIp': "userIp_example", // String | Deprecated. Please use quotaUser instead.
  'createOrdersRequest': new AdExchangeBuyerApi.CreateOrdersRequest() // CreateOrdersRequest | 
};
apiInstance.adexchangebuyerProposalsInsert(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Proposal adexchangebuyerProposalsPatch(proposalId, revisionNumber, updateAction, opts)
...
let apiInstance = new AdExchangeBuyerApi.ProposalsApi();
let proposalId = "proposalId_example"; // String | The proposal id to update.
let revisionNumber = "revisionNumber_example"; // String | The last known revision number to update. If the head revision in the marketplace database has since changed, an error will be thrown. The caller should then fetch the latest proposal at head revision and retry the update at that revision.
let updateAction = "updateAction_example"; // String | The proposed action to take on the proposal. This field is required and it must be set when updating a proposal.
let opts = {
  'alt': "alt_example", // String | Data format for the response.
  'fields': "fields_example", // String | Selector specifying which fields to include in a partial response.
  'key': "key_example", // String | API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.
  ...
  'quotaUser': "quotaUser_example", // String | An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
  'userIp': "userIp_example", // String | Deprecated. Please use quotaUser instead.
  'proposal': new AdExchangeBuyerApi.Proposal() // Proposal | 
};
apiInstance.adexchangebuyerProposalsPatch(proposalId, revisionNumber, updateAction, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **updateAction** | **String**| The proposed action to take on the proposal. This field is required and it must be set when updating a proposal. | 
 **alt** | **String**| Data format for the response. | [optional] 
 **fields** | **String**| Selector specifying which fields to include in a partial response. | [optional] 
 **key** | **String**| API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token. | [optional] 
 **oauthToken** | **String**| OAuth 2.0 token for the current user. | [optional] 
...
> GetOrdersResponse adexchangebuyerProposalsSearch(opts)
...
let opts = {
  ...
  'quotaUser': "quotaUser_example", // String | An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
  'userIp': "userIp_example", // String | Deprecated. Please use quotaUser instead.
  'pqlQuery': "pqlQuery_example" // String | Query string to retrieve specific proposals.
};
apiInstance.adexchangebuyerProposalsSearch(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> adexchangebuyerProposalsSetupcomplete(proposalId, opts)
...
let apiInstance = new AdExchangeBuyerApi.ProposalsApi();
let proposalId = "proposalId_example"; // String | The proposal id for which the setup is complete
let opts = {
  'alt': "alt_example", // String | Data format for the response.
  'fields': "fields_example", // String | Selector specifying which fields to include in a partial response.
  'key': "key_example", // String | API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.
...
apiInstance.adexchangebuyerProposalsSetupcomplete(proposalId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> Proposal adexchangebuyerProposalsUpdate(proposalId, revisionNumber, updateAction, opts)
...
apiInstance.adexchangebuyerProposalsUpdate(proposalId, revisionNumber, updateAction, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
