# AdExchangeBuyerApi.BillingInfoApi
...
> BillingInfo adexchangebuyerBillingInfoGet(accountId, opts)
...
let apiInstance = new AdExchangeBuyerApi.BillingInfoApi();
let accountId = 56; // Number | The account id.
let opts = {
...
apiInstance.adexchangebuyerBillingInfoGet(accountId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> BillingInfoList adexchangebuyerBillingInfoList(opts)
...
apiInstance.adexchangebuyerBillingInfoList(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
