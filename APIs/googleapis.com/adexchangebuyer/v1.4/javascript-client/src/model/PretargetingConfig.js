...
import PretargetingConfigVideoPlayerSizesInner from './PretargetingConfigVideoPlayerSizesInner';
...
class PretargetingConfig {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('userIdentifierDataRequired')) {
                obj['userIdentifierDataRequired'] = ApiClient.convertToType(data['userIdentifierDataRequired'], ['String']);
            }
            ...
            if (data.hasOwnProperty('videoPlayerSizes')) {
                obj['videoPlayerSizes'] = ApiClient.convertToType(data['videoPlayerSizes'], [PretargetingConfigVideoPlayerSizesInner]);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is an array
        if (!Array.isArray(data['userIdentifierDataRequired'])) {
            throw new Error("Expected the field `userIdentifierDataRequired` to be an array in the JSON data but got " + data['userIdentifierDataRequired']);
        }
        // ensure the json data is an array
        ...
        if (data['videoPlayerSizes']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['videoPlayerSizes'])) {
                throw new Error("Expected the field `videoPlayerSizes` to be an array in the JSON data but got " + data['videoPlayerSizes']);
            }
            // validate the optional field `videoPlayerSizes` (array)
            for (const item of data['videoPlayerSizes']) {
                PretargetingConfigVideoPlayerSizesInner.validateJSON(item);
            };
        }
 ...
 * @member {Array.<String>} userIdentifierDataRequired
 */
PretargetingConfig.prototype['userIdentifierDataRequired'] = undefined;
 ...
 * @member {Array.<module:model/PretargetingConfigVideoPlayerSizesInner>} videoPlayerSizes
 */
PretargetingConfig.prototype['videoPlayerSizes'] = undefined;
