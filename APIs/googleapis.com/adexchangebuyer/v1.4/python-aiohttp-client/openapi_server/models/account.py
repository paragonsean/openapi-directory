...
class Account(Model):
    ...
    def __init__(self, apply_pretargeting_to_non_guaranteed_deals: bool=None, bidder_location: List[AccountBidderLocationInner]=None, cookie_matching_nid: str=None, cookie_matching_url: str=None, id: int=None, kind: str='adexchangebuyer#account', maximum_active_creatives: int=None, maximum_total_qps: int=None, number_active_creatives: int=None):
        """Account - a model defined in OpenAPI

        :param apply_pretargeting_to_non_guaranteed_deals: The apply_pretargeting_to_non_guaranteed_deals of this Account.
        ...
        """
        self.openapi_types = {
            'apply_pretargeting_to_non_guaranteed_deals': bool,
        ...
        self.attribute_map = {
            'apply_pretargeting_to_non_guaranteed_deals': 'applyPretargetingToNonGuaranteedDeals',
        ...
        self._apply_pretargeting_to_non_guaranteed_deals = apply_pretargeting_to_non_guaranteed_deals
    ...
    @property
    def apply_pretargeting_to_non_guaranteed_deals(self):
        """Gets the apply_pretargeting_to_non_guaranteed_deals of this Account.
        ...
        :return: The apply_pretargeting_to_non_guaranteed_deals of this Account.
        :rtype: bool
        """
        return self._apply_pretargeting_to_non_guaranteed_deals

    @apply_pretargeting_to_non_guaranteed_deals.setter
    def apply_pretargeting_to_non_guaranteed_deals(self, apply_pretargeting_to_non_guaranteed_deals):
        """Sets the apply_pretargeting_to_non_guaranteed_deals of this Account.

        When this is false, bid requests that include a deal ID for a private auction or preferred deal are always sent to your bidder. When true, all active pretargeting configs will be applied to private auctions and preferred deals. Programmatic Guaranteed deals (when enabled) are always sent to your bidder.

        :param apply_pretargeting_to_non_guaranteed_deals: The apply_pretargeting_to_non_guaranteed_deals of this Account.
        :type apply_pretargeting_to_non_guaranteed_deals: bool
        """
