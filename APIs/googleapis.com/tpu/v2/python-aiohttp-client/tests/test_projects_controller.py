...
async def test_tpu_projects_locations_accelerator_types_list(client):
    ...
    response = await client.request(
        method='GET',
        path='/v2/{parent}/acceleratorTypes'.format(parent='parent_example'),
        headers=headers,
        params=params,
        )
...
async def test_tpu_projects_locations_generate_service_identity(client):
    ...
    response = await client.request(
        method='POST',
        path='/v2/{parentgenerate_service_identit}'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_tpu_projects_locations_nodes_create(client):
    ...
    """
    body = {"metadata":{"key":"metadata"},"runtimeVersion":"runtimeVersion","shieldedInstanceConfig":{"enableSecureBoot":True},"cidrBlock":"cidrBlock","networkConfig":{"queueCount":0,"canIpForward":True,"enableExternalIps":True,"subnetwork":"subnetwork","network":"network"},"description":"description","health":"HEALTH_UNSPECIFIED","multisliceNode":True,"serviceAccount":{"scope":["scope","scope"],"email":"email"},"healthDescription":"healthDescription","labels":{"key":"labels"},"tags":["tags","tags"],"acceleratorType":"acceleratorType","symptoms":[{"workerId":"workerId","createTime":"createTime","details":"details","symptomType":"SYMPTOM_TYPE_UNSPECIFIED"},{"workerId":"workerId","createTime":"createTime","details":"details","symptomType":"SYMPTOM_TYPE_UNSPECIFIED"}],"apiVersion":"API_VERSION_UNSPECIFIED","networkEndpoints":[{"port":6,"ipAddress":"ipAddress","accessConfig":{"externalIp":"externalIp"}},{"port":6,"ipAddress":"ipAddress","accessConfig":{"externalIp":"externalIp"}}],"acceleratorConfig":{"topology":"topology","type":"TYPE_UNSPECIFIED"},"createTime":"createTime","name":"name","dataDisks":[{"mode":"DISK_MODE_UNSPECIFIED","sourceDisk":"sourceDisk"},{"mode":"DISK_MODE_UNSPECIFIED","sourceDisk":"sourceDisk"}],"id":"id","state":"STATE_UNSPECIFIED","schedulingConfig":{"preemptible":True,"reserved":True,"spot":True},"queuedResource":"queuedResource"}
    params = [('$.xgafv', 'xgafv_example'),
                    ('access_token', 'access_token_example'),
                    ('alt', 'alt_example'),
                    ('callback', 'param_callback_example'),
    ...
    response = await client.request(
        method='POST',
        path='/v2/{parent}/nodes'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_tpu_projects_locations_nodes_get_guest_attributes(client):
    ...
    response = await client.request(
        method='POST',
        path='/v2/{nameget_guest_attribute}'.format(name='name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_tpu_projects_locations_queued_resources_create(client):
    ...
    """
    body = {"createTime":"createTime","queueingPolicy":{"validAfterDuration":"validAfterDuration","validInterval":{"startTime":"startTime","endTime":"endTime"},"validUntilDuration":"validUntilDuration","validUntilTime":"validUntilTime","validAfterTime":"validAfterTime"},"spot":"{}","name":"name","tpu":{"nodeSpec":[{"node":{"metadata":{"key":"metadata"},"runtimeVersion":"runtimeVersion","shieldedInstanceConfig":{"enableSecureBoot":True},"cidrBlock":"cidrBlock","networkConfig":{"queueCount":0,"canIpForward":True,"enableExternalIps":True,"subnetwork":"subnetwork","network":"network"},"description":"description","health":"HEALTH_UNSPECIFIED","multisliceNode":True,"serviceAccount":{"scope":["scope","scope"],"email":"email"},"healthDescription":"healthDescription","labels":{"key":"labels"},"tags":["tags","tags"],"acceleratorType":"acceleratorType","symptoms":[{"workerId":"workerId","createTime":"createTime","details":"details","symptomType":"SYMPTOM_TYPE_UNSPECIFIED"},{"workerId":"workerId","createTime":"createTime","details":"details","symptomType":"SYMPTOM_TYPE_UNSPECIFIED"}],"apiVersion":"API_VERSION_UNSPECIFIED","networkEndpoints":[{"port":6,"ipAddress":"ipAddress","accessConfig":{"externalIp":"externalIp"}},{"port":6,"ipAddress":"ipAddress","accessConfig":{"externalIp":"externalIp"}}],"acceleratorConfig":{"topology":"topology","type":"TYPE_UNSPECIFIED"},"createTime":"createTime","name":"name","dataDisks":[{"mode":"DISK_MODE_UNSPECIFIED","sourceDisk":"sourceDisk"},{"mode":"DISK_MODE_UNSPECIFIED","sourceDisk":"sourceDisk"}],"id":"id","state":"STATE_UNSPECIFIED","schedulingConfig":{"preemptible":True,"reserved":True,"spot":True},"queuedResource":"queuedResource"},"parent":"parent","multisliceParams":{"nodeIdPrefix":"nodeIdPrefix","nodeCount":0},"nodeId":"nodeId"},{"node":{"metadata":{"key":"metadata"},"runtimeVersion":"runtimeVersion","shieldedInstanceConfig":{"enableSecureBoot":True},"cidrBlock":"cidrBlock","networkConfig":{"queueCount":0,"canIpForward":True,"enableExternalIps":True,"subnetwork":"subnetwork","network":"network"},"description":"description","health":"HEALTH_UNSPECIFIED","multisliceNode":True,"serviceAccount":{"scope":["scope","scope"],"email":"email"},"healthDescription":"healthDescription","labels":{"key":"labels"},"tags":["tags","tags"],"acceleratorType":"acceleratorType","symptoms":[{"workerId":"workerId","createTime":"createTime","details":"details","symptomType":"SYMPTOM_TYPE_UNSPECIFIED"},{"workerId":"workerId","createTime":"createTime","details":"details","symptomType":"SYMPTOM_TYPE_UNSPECIFIED"}],"apiVersion":"API_VERSION_UNSPECIFIED","networkEndpoints":[{"port":6,"ipAddress":"ipAddress","accessConfig":{"externalIp":"externalIp"}},{"port":6,"ipAddress":"ipAddress","accessConfig":{"externalIp":"externalIp"}}],"acceleratorConfig":{"topology":"topology","type":"TYPE_UNSPECIFIED"},"createTime":"createTime","name":"name","dataDisks":[{"mode":"DISK_MODE_UNSPECIFIED","sourceDisk":"sourceDisk"},{"mode":"DISK_MODE_UNSPECIFIED","sourceDisk":"sourceDisk"}],"id":"id","state":"STATE_UNSPECIFIED","schedulingConfig":{"preemptible":True,"reserved":True,"spot":True},"queuedResource":"queuedResource"},"parent":"parent","multisliceParams":{"nodeIdPrefix":"nodeIdPrefix","nodeCount":0},"nodeId":"nodeId"}]},"guaranteed":{"minDuration":"minDuration"},"state":{"deletingData":"{}","suspendedData":"{}","suspendingData":"{}","acceptedData":"{}","creatingData":"{}","state":"STATE_UNSPECIFIED","stateInitiator":"STATE_INITIATOR_UNSPECIFIED","activeData":"{}","provisioningData":"{}","failedData":{"error":{"code":0,"details":[{"key":""},{"key":""}],"message":"message"}}},"reservationName":"reservationName"}
    params = [('$.xgafv', 'xgafv_example'),
                    ('access_token', 'access_token_example'),
                    ('alt', 'alt_example'),
                    ('callback', 'param_callback_example'),
    ...
    response = await client.request(
        method='POST',
        path='/v2/{parent}/queuedResources'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_tpu_projects_locations_runtime_versions_list(client):
    ...
    response = await client.request(
        method='GET',
        path='/v2/{parent}/runtimeVersions'.format(parent='parent_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
