...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudTpuApi.ListLocationsResponse();
  });
  ...
  describe('ListLocationsResponse', function() {
    it('should create an instance of ListLocationsResponse', function() {
      ...
      //var instance = new CloudTpuApi.ListLocationsResponse();
      //expect(instance).to.be.a(CloudTpuApi.ListLocationsResponse);
    });
