...
import BootDiskConfig from './BootDiskConfig';
...
class Node {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('autocheckpointEnabled')) {
                obj['autocheckpointEnabled'] = ApiClient.convertToType(data['autocheckpointEnabled'], 'Boolean');
            }
            if (data.hasOwnProperty('bootDiskConfig')) {
                obj['bootDiskConfig'] = BootDiskConfig.constructFromObject(data['bootDiskConfig']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['bootDiskConfig']) { // data not null
          BootDiskConfig.validateJSON(data['bootDiskConfig']);
        }
        // ensure the json data is a string
 ...
 */
Node.prototype['autocheckpointEnabled'] = undefined;

/**
 * @member {module:model/BootDiskConfig} bootDiskConfig
 */
Node.prototype['bootDiskConfig'] = undefined;
