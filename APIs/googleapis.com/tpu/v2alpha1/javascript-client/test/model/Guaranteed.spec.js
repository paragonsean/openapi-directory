...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudTpuApi.Guaranteed();
  });
  ...
  describe('Guaranteed', function() {
    it('should create an instance of Guaranteed', function() {
      // uncomment below and update the code to test Guaranteed
      //var instance = new CloudTpuApi.Guaranteed();
      //expect(instance).to.be.a(CloudTpuApi.Guaranteed);
    });
