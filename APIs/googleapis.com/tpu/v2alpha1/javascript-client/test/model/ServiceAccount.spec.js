...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudTpuApi.ServiceAccount();
  });
  ...
  describe('ServiceAccount', function() {
    it('should create an instance of ServiceAccount', function() {
      // uncomment below and update the code to test ServiceAccount
      //var instance = new CloudTpuApi.ServiceAccount();
      //expect(instance).to.be.a(CloudTpuApi.ServiceAccount);
    });
