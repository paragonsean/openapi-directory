...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudTpuApi.ListReservationsResponse();
  });
  ...
  describe('ListReservationsResponse', function() {
    it('should create an instance of ListReservationsResponse', function() {
      ...
      //var instance = new CloudTpuApi.ListReservationsResponse();
      //expect(instance).to.be.a(CloudTpuApi.ListReservationsResponse);
    });
