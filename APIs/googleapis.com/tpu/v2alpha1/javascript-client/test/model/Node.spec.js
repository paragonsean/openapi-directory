...
(function(root, factory) {
  ...
  describe('Node', function() {
    ...
    it('should have the property autocheckpointEnabled (base name: "autocheckpointEnabled")', function() {
      // uncomment below and update the code to test the property autocheckpointEnabled
      //var instance = new CloudTpuApi.Node();
      //expect(instance).to.be();
    });

    it('should have the property bootDiskConfig (base name: "bootDiskConfig")', function() {
      // uncomment below and update the code to test the property bootDiskConfig
      //var instance = new CloudTpuApi.Node();
      //expect(instance).to.be();
    });
