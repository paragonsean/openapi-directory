...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudTpuApi.SchedulingConfig();
  });
  ...
  describe('SchedulingConfig', function() {
    it('should create an instance of SchedulingConfig', function() {
      // uncomment below and update the code to test SchedulingConfig
      //var instance = new CloudTpuApi.SchedulingConfig();
      //expect(instance).to.be.a(CloudTpuApi.SchedulingConfig);
    });
