...
class QueuedResource(Model):
    ...
    def __init__(self, best_effort: object=None, create_time: str=None, guaranteed: Guaranteed=None, name: str=None, queueing_policy: QueueingPolicy=None, reservation_name: str=None, spot: object=None, state: QueuedResourceState=None, tpu: Tpu=None):
        """QueuedResource - a model defined in OpenAPI

        :param best_effort: The best_effort of this QueuedResource.
    ...
    def best_effort(self):
        """Gets the best_effort of this QueuedResource.

        BestEffort tier definition.

        :return: The best_effort of this QueuedResource.
        :rtype: object
        """
    ...
    def best_effort(self, best_effort):
        """Sets the best_effort of this QueuedResource.

        BestEffort tier definition.

        :param best_effort: The best_effort of this QueuedResource.
        :type best_effort: object
        """
