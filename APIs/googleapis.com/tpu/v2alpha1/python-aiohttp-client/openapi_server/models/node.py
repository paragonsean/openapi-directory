...
class Node(Model):
    ...
    def __init__(self, accelerator_config: AcceleratorConfig=None, accelerator_type: str=None, api_version: str=None, autocheckpoint_enabled: bool=None, boot_disk_config: BootDiskConfig=None, cidr_block: str=None, create_time: str=None, data_disks: List[AttachedDisk]=None, description: str=None, health: str=None, health_description: str=None, id: str=None, labels: Dict[str, str]=None, metadata: Dict[str, str]=None, multislice_node: bool=None, name: str=None, network_config: NetworkConfig=None, network_endpoints: List[NetworkEndpoint]=None, queued_resource: str=None, runtime_version: str=None, scheduling_config: SchedulingConfig=None, service_account: ServiceAccount=None, shielded_instance_config: ShieldedInstanceConfig=None, state: str=None, symptoms: List[Symptom]=None, tags: List[str]=None):
        ...
        :param autocheckpoint_enabled: The autocheckpoint_enabled of this Node.
        :param boot_disk_config: The boot_disk_config of this Node.
        ...
        self.attribute_map = {
            ...
            'autocheckpoint_enabled': 'autocheckpointEnabled',
            'boot_disk_config': 'bootDiskConfig',
        ...
        self._autocheckpoint_enabled = autocheckpoint_enabled
        self._boot_disk_config = boot_disk_config
    ...
    @property
    def autocheckpoint_enabled(self):
        """Gets the autocheckpoint_enabled of this Node.

        Optional. Whether Autocheckpoint is enabled.

        :return: The autocheckpoint_enabled of this Node.
        :rtype: bool
        """
        return self._autocheckpoint_enabled

    @autocheckpoint_enabled.setter
    def autocheckpoint_enabled(self, autocheckpoint_enabled):
        """Sets the autocheckpoint_enabled of this Node.

        Optional. Whether Autocheckpoint is enabled.

        :param autocheckpoint_enabled: The autocheckpoint_enabled of this Node.
        :type autocheckpoint_enabled: bool
        """

        self._autocheckpoint_enabled = autocheckpoint_enabled

    @property
    def boot_disk_config(self):
        """Gets the boot_disk_config of this Node.


        :return: The boot_disk_config of this Node.
        :rtype: BootDiskConfig
        """
        return self._boot_disk_config

    @boot_disk_config.setter
    def boot_disk_config(self, boot_disk_config):
        """Sets the boot_disk_config of this Node.


        :param boot_disk_config: The boot_disk_config of this Node.
        :type boot_disk_config: BootDiskConfig
        """
