...
|**acceleratorType** | **String** | The type of hardware accelerators associated with this node. |  [optional] |
|**apiVersion** | [**ApiVersionEnum**](#ApiVersionEnum) | Output only. The API version that created this Node. |  [optional] [readonly] |
|**autocheckpointEnabled** | **Boolean** | Optional. Whether Autocheckpoint is enabled. |  [optional] |
|**bootDiskConfig** | [**BootDiskConfig**](BootDiskConfig.md) |  |  [optional] |
