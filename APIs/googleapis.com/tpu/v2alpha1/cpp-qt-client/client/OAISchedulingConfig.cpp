...
bool OAISchedulingConfig::isSpot() const {
    return m_spot;
}
void OAISchedulingConfig::setSpot(const bool &spot) {
    m_spot = spot;
    m_spot_isSet = true;
}

bool OAISchedulingConfig::is_spot_Set() const{
    return m_spot_isSet;
}

bool OAISchedulingConfig::is_spot_Valid() const{
