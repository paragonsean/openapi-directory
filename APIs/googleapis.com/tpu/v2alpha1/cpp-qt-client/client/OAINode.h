...
public:
    ...
    bool isAutocheckpointEnabled() const;
    void setAutocheckpointEnabled(const bool &autocheckpoint_enabled);
    bool is_autocheckpoint_enabled_Set() const;
    bool is_autocheckpoint_enabled_Valid() const;

    OAIBootDiskConfig getBootDiskConfig() const;
    void setBootDiskConfig(const OAIBootDiskConfig &boot_disk_config);
    bool is_boot_disk_config_Set() const;
    bool is_boot_disk_config_Valid() const;
...
private:
    ...
    bool m_autocheckpoint_enabled;
    bool m_autocheckpoint_enabled_isSet;
    bool m_autocheckpoint_enabled_isValid;

    OAIBootDiskConfig m_boot_disk_config;
    bool m_boot_disk_config_isSet;
    bool m_boot_disk_config_isValid;
