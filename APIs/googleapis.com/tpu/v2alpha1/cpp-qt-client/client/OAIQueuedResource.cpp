...
OAIObject OAIQueuedResource::getBestEffort() const {
    return m_best_effort;
}
void OAIQueuedResource::setBestEffort(const OAIObject &best_effort) {
    m_best_effort = best_effort;
    m_best_effort_isSet = true;
}

bool OAIQueuedResource::is_best_effort_Set() const{
    return m_best_effort_isSet;
}

bool OAIQueuedResource::is_best_effort_Valid() const{
