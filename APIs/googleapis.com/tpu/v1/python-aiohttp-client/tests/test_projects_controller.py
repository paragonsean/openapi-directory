...
async def test_tpu_projects_locations_accelerator_types_list(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/{parent}/acceleratorTypes'.format(parent='parent_example'),
        headers=headers,
        params=params,
        )
...
async def test_tpu_projects_locations_nodes_reimage(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{namereimag}'.format(name='name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_tpu_projects_locations_tensorflow_versions_list(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/{parent}/tensorflowVersions'.format(parent='parent_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
