...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudTpuApi.ListOperationsResponse();
  });
  ...
  describe('ListOperationsResponse', function() {
    it('should create an instance of ListOperationsResponse', function() {
      ...
      //var instance = new CloudTpuApi.ListOperationsResponse();
      //expect(instance).to.be.a(CloudTpuApi.ListOperationsResponse);
    });
