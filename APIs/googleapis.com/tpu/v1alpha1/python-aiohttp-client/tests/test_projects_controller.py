...
async def test_tpu_projects_locations_accelerator_types_list(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1alpha1/{parent}/acceleratorTypes'.format(parent='parent_example'),
        headers=headers,
        params=params,
        )
...
async def test_tpu_projects_locations_nodes_create(client):
    ...
    """
    body = {"cidrBlock":"cidrBlock","ipAddress":"ipAddress","description":"description","health":"HEALTH_UNSPECIFIED","serviceAccount":"serviceAccount","tensorflowVersion":"tensorflowVersion","healthDescription":"healthDescription","labels":{"key":"labels"},"network":"network","acceleratorType":"acceleratorType","symptoms":[{"workerId":"workerId","createTime":"createTime","details":"details","symptomType":"SYMPTOM_TYPE_UNSPECIFIED"},{"workerId":"workerId","createTime":"createTime","details":"details","symptomType":"SYMPTOM_TYPE_UNSPECIFIED"}],"apiVersion":"API_VERSION_UNSPECIFIED","networkEndpoints":[{"port":0,"ipAddress":"ipAddress"},{"port":0,"ipAddress":"ipAddress"}],"createTime":"createTime","port":"port","name":"name","useServiceNetworking":True,"state":"STATE_UNSPECIFIED","schedulingConfig":{"preemptible":True,"reserved":True}}
    params = [('$.xgafv', 'xgafv_example'),
                    ('access_token', 'access_token_example'),
                    ('alt', 'alt_example'),
                    ('callback', 'param_callback_example'),
...
async def test_tpu_projects_locations_nodes_reimage(client):
    """Test case for tpu_projects_locations_nodes_reimage

    
    """
    body = {"tensorflowVersion":"tensorflowVersion"}
    params = [('$.xgafv', 'xgafv_example'),
                    ('access_token', 'access_token_example'),
                    ('alt', 'alt_example'),
                    ('callback', 'param_callback_example'),
    ...
    response = await client.request(
        method='POST',
        path='/v1alpha1/{namereimag}'.format(name='name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_tpu_projects_locations_nodes_start(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1alpha1/{namestar}'.format(name='name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_tpu_projects_locations_nodes_stop(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1alpha1/{namesto}'.format(name='name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_tpu_projects_locations_operations_delete(client):
...
async def test_tpu_projects_locations_tensorflow_versions_get(client):
...
async def test_tpu_projects_locations_tensorflow_versions_list(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1alpha1/{parent}/tensorflowVersions'.format(parent='parent_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
