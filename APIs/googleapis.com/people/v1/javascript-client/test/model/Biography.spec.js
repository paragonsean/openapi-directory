...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PeopleApi.Biography();
  });
  ...
  describe('Biography', function() {
    it('should create an instance of Biography', function() {
      // uncomment below and update the code to test Biography
      //var instance = new PeopleApi.Biography();
      //expect(instance).to.be.a(PeopleApi.Biography);
    });
