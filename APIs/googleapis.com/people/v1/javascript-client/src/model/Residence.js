...
class Residence {
    ...
    /**
     * Validates the JSON data with respect to <code>Residence</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Residence</code>.
     */
 ...
 */
Residence.prototype['current'] = undefined;

/**
 * @member {module:model/FieldMetadata} metadata
 */
Residence.prototype['metadata'] = undefined;

/**
 * The address of the residence.
 * @member {String} value
 */
Residence.prototype['value'] = undefined;
