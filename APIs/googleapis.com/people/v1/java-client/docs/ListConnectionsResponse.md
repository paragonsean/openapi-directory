...
|**totalItems** | **Integer** | The total number of items in the list without pagination. |  [optional] |
|**totalPeople** | **Integer** | **DEPRECATED** (Please use totalItems) The total number of people in the list without pagination. |  [optional] |
