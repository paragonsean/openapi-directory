...
#ifndef OAINickname_H
#define OAINickname_H
...
class OAINickname : public OAIObject {
public:
    OAINickname();
    OAINickname(QString json);
    ~OAINickname() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINickname)
