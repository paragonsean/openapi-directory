...
#ifndef OAIExternalId_H
#define OAIExternalId_H
...
class OAIExternalId : public OAIObject {
public:
    OAIExternalId();
    OAIExternalId(QString json);
    ~OAIExternalId() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExternalId)

#endif // OAIExternalId_H
