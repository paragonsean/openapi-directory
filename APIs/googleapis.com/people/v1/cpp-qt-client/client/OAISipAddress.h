...
#ifndef OAISipAddress_H
#define OAISipAddress_H
...
class OAISipAddress : public OAIObject {
public:
    OAISipAddress();
    OAISipAddress(QString json);
    ~OAISipAddress() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISipAddress)

#endif // OAISipAddress_H
