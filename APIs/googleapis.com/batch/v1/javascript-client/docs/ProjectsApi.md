...
> Job batchProjectsLocationsJobsCreate(parent, opts)
...
```javascript
import BatchApi from 'batch_api';
let defaultClient = BatchApi.ApiClient.instance;
...
let apiInstance = new BatchApi.ProjectsApi();
let parent = "parent_example"; // String | Required. The parent resource name where the Job will be created. Pattern: \"projects/{project}/locations/{location}\"
let opts = {
...
apiInstance.batchProjectsLocationsJobsCreate(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> ListJobsResponse batchProjectsLocationsJobsList(parent, opts)
...
let apiInstance = new BatchApi.ProjectsApi();
let parent = "parent_example"; // String | Parent path.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'orderBy': "orderBy_example", // String | Optional. Sort results. Supported are \"name\", \"name desc\", \"create_time\", and \"create_time desc\".
  'pageSize': 56, // Number | Page size.
  'pageToken': "pageToken_example" // String | Page token.
};
apiInstance.batchProjectsLocationsJobsList(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ListTasksResponse batchProjectsLocationsJobsTaskGroupsTasksList(parent, opts)
...
let apiInstance = new BatchApi.ProjectsApi();
let parent = "parent_example"; // String | Required. Name of a TaskGroup from which Tasks are being requested. Pattern: \"projects/{project}/locations/{location}/jobs/{job}/taskGroups/{task_group}\"
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'filter': "filter_example", // String | Task filter, null filter matches all Tasks. Filter string should be of the format State=TaskStatus.State e.g. State=RUNNING
  'pageSize': 56, // Number | Page size.
  'pageToken': "pageToken_example" // String | Page token.
};
apiInstance.batchProjectsLocationsJobsTaskGroupsTasksList(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ListLocationsResponse batchProjectsLocationsList(name, opts)
...
apiInstance.batchProjectsLocationsList(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Object batchProjectsLocationsOperationsCancel(name, opts)
...
apiInstance.batchProjectsLocationsOperationsCancel(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Object batchProjectsLocationsOperationsDelete(name, opts)
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'reason': "reason_example", // String | Optional. Reason for this deletion.
  'requestId': "requestId_example" // String | Optional. An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. The server will guarantee that for at least 60 minutes after the first request. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
};
apiInstance.batchProjectsLocationsOperationsDelete(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Operation batchProjectsLocationsOperationsGet(name, opts)
...
apiInstance.batchProjectsLocationsOperationsGet(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ListOperationsResponse batchProjectsLocationsOperationsList(name, opts)
...
apiInstance.batchProjectsLocationsOperationsList(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ReportAgentStateResponse batchProjectsLocationsStateReport(parent, opts)
...
let apiInstance = new BatchApi.ProjectsApi();
let parent = "parent_example"; // String | Required. Format: projects/{project}/locations/{location} {project} should be a project number.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'reportAgentStateRequest': new BatchApi.ReportAgentStateRequest() // ReportAgentStateRequest | 
};
apiInstance.batchProjectsLocationsStateReport(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
