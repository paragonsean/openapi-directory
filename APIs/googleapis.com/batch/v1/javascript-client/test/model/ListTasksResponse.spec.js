...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BatchApi.ListTasksResponse();
  });
  ...
  describe('ListTasksResponse', function() {
    it('should create an instance of ListTasksResponse', function() {
      // uncomment below and update the code to test ListTasksResponse
      //var instance = new BatchApi.ListTasksResponse();
      //expect(instance).to.be.a(BatchApi.ListTasksResponse);
    });
