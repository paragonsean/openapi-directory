...
import GoogleCloudPolicyanalyzerV1beta1QueryActivityResponse from '../model/GoogleCloudPolicyanalyzerV1beta1QueryActivityResponse';
...
export default class ProjectsApi {
    ...
    */
     ...
     * @param {module:model/GoogleCloudPolicyanalyzerV1beta1QueryActivityResponse} data The data returned by the service call.
     ...
     * data is of type: {@link module:model/GoogleCloudPolicyanalyzerV1beta1QueryActivityResponse}
     */
    policyanalyzerProjectsLocationsActivityTypesActivitiesQuery(parent, opts, callback) {
      ...
      let returnType = GoogleCloudPolicyanalyzerV1beta1QueryActivityResponse;
      return this.apiClient.callApi(
        '/v1beta1/{parent}/activities:query', 'GET',
