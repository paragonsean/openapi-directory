...
void OAIProjectsApi::initializeServerConfigs() {
    ...
    QUrl("https://policyanalyzer.googleapis.com/"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("policyanalyzer_projects_locations_activityTypes_activities_query", defaultConf);
    _serverIndices.insert("policyanalyzer_projects_locations_activityTypes_activities_query", 0);
}
...
void OAIProjectsApi::policyanalyzer_projects_locations_activityTypes_activities_query(const QString &parent, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<QString> &filter, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &page_token) {
    QString fullPath = QString(_serverConfigs["policyanalyzer_projects_locations_activityTypes_activities_query"][_serverIndices.value("policyanalyzer_projects_locations_activityTypes_activities_query")].URL()+"/v1/{parent}/activities:query");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::policyanalyzer_projects_locations_activityTypes_activities_queryCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::policyanalyzer_projects_locations_activityTypes_activities_queryCallback);
...
void OAIProjectsApi::policyanalyzer_projects_locations_activityTypes_activities_queryCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIGoogleCloudPolicyanalyzerV1QueryActivityResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT policyanalyzer_projects_locations_activityTypes_activities_querySignal(output);
        Q_EMIT policyanalyzer_projects_locations_activityTypes_activities_querySignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT policyanalyzer_projects_locations_activityTypes_activities_querySignalE(output, error_type, error_str);
        Q_EMIT policyanalyzer_projects_locations_activityTypes_activities_querySignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT policyanalyzer_projects_locations_activityTypes_activities_querySignalError(output, error_type, error_str);
        Q_EMIT policyanalyzer_projects_locations_activityTypes_activities_querySignalErrorFull(worker, error_type, error_str);
    }
}
