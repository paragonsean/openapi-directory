...
public class ApiClient {
    ...
    private String basePath = "https://storage.googleapis.com/storage/v1beta2";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://storage.googleapis.com/storage/v1beta2
