...
public class ModelObject {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(acl, bucket, cacheControl, componentCount, contentDisposition, contentEncoding, contentLanguage, contentType, crc32c, etag, generation, id, kind, md5Hash, mediaLink, metadata, metageneration, name, owner, selfLink, size, storageClass, timeDeleted, updated);
  }
