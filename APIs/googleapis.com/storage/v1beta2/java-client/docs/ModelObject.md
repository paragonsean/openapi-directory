...
|**componentCount** | **Integer** | Number of underlying components that make up this object. Components are accumulated by compose operations and are limited to a count of 32. |  [optional] |
...
|**timeDeleted** | **OffsetDateTime** | Deletion time of the object in RFC 3339 format. Will be returned if and only if this version of the object has been deleted. |  [optional] |
|**updated** | **OffsetDateTime** | Modification time of the object metadata in RFC 3339 format. |  [optional] |
