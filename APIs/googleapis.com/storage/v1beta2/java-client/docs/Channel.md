...
|**kind** | **String** | Identifies this as a notification channel used to watch for changes to a resource, which is \&quot;api#channel\&quot;. |  [optional] |
|**params** | **Map&lt;String, String&gt;** | Additional parameters controlling delivery channel behavior. Optional. |  [optional] |
...
|**type** | **String** | The type of delivery mechanism used for this channel. |  [optional] |
