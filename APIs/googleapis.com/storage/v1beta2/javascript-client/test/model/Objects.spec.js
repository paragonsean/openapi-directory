...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudStorageJsonApi.Objects();
  });
  ...
  describe('Objects', function() {
    it('should create an instance of Objects', function() {
      // uncomment below and update the code to test Objects
      //var instance = new CloudStorageJsonApi.Objects();
      //expect(instance).to.be.a(CloudStorageJsonApi.Objects);
    });
