...
async def test_storage_default_object_access_controls_delete(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/storage/v1beta2/b/{bucket}/defaultObjectAcl/{entity}'.format(bucket='bucket_example', entity='entity_example'),
        headers=headers,
        params=params,
        )
...
async def test_storage_default_object_access_controls_insert(client):
    ...
    response = await client.request(
        method='POST',
        path='/storage/v1beta2/b/{bucket}/defaultObjectAcl'.format(bucket='bucket_example'),
        headers=headers,
        json=body,
        params=params,
        )
