...
async def test_storage_bucket_access_controls_delete(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/storage/v1beta2/b/{bucket}/acl/{entity}'.format(bucket='bucket_example', entity='entity_example'),
        headers=headers,
        params=params,
        )
...
async def test_storage_bucket_access_controls_insert(client):
    ...
    """
    body = {"bucket":"bucket","role":"role","kind":"storage#bucketAccessControl","domain":"domain","entityId":"entityId","etag":"etag","id":"id","email":"email","entity":"entity","selfLink":"selfLink"}
    params = [('alt', 'alt_example'),
                    ('fields', 'fields_example'),
                    ('key', 'key_example'),
                    ('oauth_token', 'oauth_token_example'),
    ...
    response = await client.request(
        method='POST',
        path='/storage/v1beta2/b/{bucket}/acl'.format(bucket='bucket_example'),
        headers=headers,
        json=body,
        params=params,
        )
