...
class ObjectAccessControl(Model):
    ...
    def __init__(self, bucket: str=None, domain: str=None, email: str=None, entity: str=None, entity_id: str=None, etag: str=None, generation: str=None, id: str=None, kind: str='storage#objectAccessControl', object: str=None, role: str=None, self_link: str=None):
