# CloudStorageJsonApi.ChannelsApi

All URIs are relative to *https://storage.googleapis.com/storage/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**storageChannelsStop**](ChannelsApi.md#storageChannelsStop) | **POST** /channels/stop | 



## storageChannelsStop

> storageChannelsStop(opts)
...
let apiInstance = new CloudStorageJsonApi.ChannelsApi();
let opts = {
...
apiInstance.storageChannelsStop(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
