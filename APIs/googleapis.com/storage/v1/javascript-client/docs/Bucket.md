# CloudStorageJsonApi.Bucket

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**acl** | [**[BucketAccessControl]**](BucketAccessControl.md) | Access controls on the bucket. | [optional] 
**autoclass** | [**BucketAutoclass**](BucketAutoclass.md) |  | [optional] 
**billing** | [**BucketBilling**](BucketBilling.md) |  | [optional] 
**cors** | [**[BucketCorsInner]**](BucketCorsInner.md) | The bucket&#39;s Cross-Origin Resource Sharing (CORS) configuration. | [optional] 
...
**defaultObjectAcl** | [**[ObjectAccessControl]**](ObjectAccessControl.md) | Default access controls to apply to new objects when no ACL is provided. | [optional] 
...
**kind** | **String** | The kind of item this is. For buckets, this is always storage#bucket. | [optional] [default to &#39;storage#bucket&#39;]
**labels** | **{String: String}** | User-provided labels, in key/value pairs. | [optional] 
...
**timeCreated** | **Date** | The creation time of the bucket in RFC 3339 format. | [optional] 
**updated** | **Date** | The modification time of the bucket in RFC 3339 format. | [optional] 
