    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [Folder]);
            }
...
/**
 * The list of items.
 * @member {Array.<module:model/Folder>} items
 */
Folders.prototype['items'] = undefined;
 ...
 */
Folders.prototype['kind'] = 'storage#folders';

/**
 * The continuation token, used to page through large result sets. Provide this value in a subsequent request to return the next page of results.
 * @member {String} nextPageToken
 */
Folders.prototype['nextPageToken'] = undefined;
