...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudStorageJsonApi.ServiceAccount();
  });
  ...
  describe('ServiceAccount', function() {
    it('should create an instance of ServiceAccount', function() {
      ...
      //var instance = new CloudStorageJsonApi.ServiceAccount();
      //expect(instance).to.be.a(CloudStorageJsonApi.ServiceAccount);
    });
