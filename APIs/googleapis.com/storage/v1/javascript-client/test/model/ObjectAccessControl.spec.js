...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudStorageJsonApi.ObjectAccessControl();
  });
  ...
  describe('ObjectAccessControl', function() {
    it('should create an instance of ObjectAccessControl', function() {
      // uncomment below and update the code to test ObjectAccessControl
      //var instance = new CloudStorageJsonApi.ObjectAccessControl();
      //expect(instance).to.be.a(CloudStorageJsonApi.ObjectAccessControl);
    });
    ...
    it('should have the property projectTeam (base name: "projectTeam")', function() {
      // uncomment below and update the code to test the property projectTeam
      //var instance = new CloudStorageJsonApi.ObjectAccessControl();
      //expect(instance).to.be();
    });
