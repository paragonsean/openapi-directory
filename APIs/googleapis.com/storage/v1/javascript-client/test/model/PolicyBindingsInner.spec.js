...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudStorageJsonApi.PolicyBindingsInner();
  });
  ...
  describe('PolicyBindingsInner', function() {
    it('should create an instance of PolicyBindingsInner', function() {
      // uncomment below and update the code to test PolicyBindingsInner
      //var instance = new CloudStorageJsonApi.PolicyBindingsInner();
      //expect(instance).to.be.a(CloudStorageJsonApi.PolicyBindingsInner);
    });
