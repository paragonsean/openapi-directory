...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudStorageJsonApi.Folder();
  });
  ...
  describe('Folder', function() {
    it('should create an instance of Folder', function() {
      ...
      //var instance = new CloudStorageJsonApi.Folder();
      //expect(instance).to.be.a(CloudStorageJsonApi.Folder);
    });
    ...
    it('should have the property pendingRenameInfo (base name: "pendingRenameInfo")', function() {
      // uncomment below and update the code to test the property pendingRenameInfo
      //var instance = new CloudStorageJsonApi.Folder();
      //expect(instance).to.be();
    });
