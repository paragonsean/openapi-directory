...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudStorageJsonApi.ManagedFolder();
  });
  ...
  describe('ManagedFolder', function() {
    it('should create an instance of ManagedFolder', function() {
      // uncomment below and update the code to test ManagedFolder
      //var instance = new CloudStorageJsonApi.ManagedFolder();
      //expect(instance).to.be.a(CloudStorageJsonApi.ManagedFolder);
    });
