...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudStorageJsonApi.Notifications();
  });
  ...
  describe('Notifications', function() {
    it('should create an instance of Notifications', function() {
      ...
      //var instance = new CloudStorageJsonApi.Notifications();
      //expect(instance).to.be.a(CloudStorageJsonApi.Notifications);
    });
