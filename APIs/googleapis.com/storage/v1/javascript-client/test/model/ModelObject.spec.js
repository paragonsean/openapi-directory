...
(function(root, factory) {
  ...
  describe('ModelObject', function() {
    ...
    it('should have the property customTime (base name: "customTime")', function() {
      // uncomment below and update the code to test the property customTime
      //var instance = new CloudStorageJsonApi.ModelObject();
      //expect(instance).to.be();
    });

    it('should have the property customerEncryption (base name: "customerEncryption")', function() {
      // uncomment below and update the code to test the property customerEncryption
      //var instance = new CloudStorageJsonApi.ModelObject();
      //expect(instance).to.be();
    });
    ...
    it('should have the property eventBasedHold (base name: "eventBasedHold")', function() {
      // uncomment below and update the code to test the property eventBasedHold
      //var instance = new CloudStorageJsonApi.ModelObject();
      //expect(instance).to.be();
    });
    ...
    it('should have the property hardDeleteTime (base name: "hardDeleteTime")', function() {
      // uncomment below and update the code to test the property hardDeleteTime
      //var instance = new CloudStorageJsonApi.ModelObject();
      //expect(instance).to.be();
    });
    ...
    it('should have the property retentionExpirationTime (base name: "retentionExpirationTime")', function() {
      // uncomment below and update the code to test the property retentionExpirationTime
      //var instance = new CloudStorageJsonApi.ModelObject();
      //expect(instance).to.be();
    });
    ...
    it('should have the property softDeleteTime (base name: "softDeleteTime")', function() {
      // uncomment below and update the code to test the property softDeleteTime
      //var instance = new CloudStorageJsonApi.ModelObject();
      //expect(instance).to.be();
    });
    ...
    it('should have the property timeStorageClassUpdated (base name: "timeStorageClassUpdated")', function() {
      // uncomment below and update the code to test the property timeStorageClassUpdated
      //var instance = new CloudStorageJsonApi.ModelObject();
      //expect(instance).to.be();
    });
