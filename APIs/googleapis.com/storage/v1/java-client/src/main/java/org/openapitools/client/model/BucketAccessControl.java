...
public class BucketAccessControl {
  ...
  public static final String SERIALIZED_NAME_PROJECT_TEAM = "projectTeam";
  @SerializedName(SERIALIZED_NAME_PROJECT_TEAM)
  ...
  public BucketAccessControl projectTeam(BucketAccessControlProjectTeam projectTeam) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.bucket, bucketAccessControl.bucket) &&
        ...
        Objects.equals(this.projectTeam, bucketAccessControl.projectTeam) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(bucket, domain, email, entity, entityId, etag, id, kind, projectTeam, role, selfLink);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("projectTeam") != null && !jsonObj.get("projectTeam").isJsonNull()) {
        BucketAccessControlProjectTeam.validateJsonElement(jsonObj.get("projectTeam"));
      }
