...
# **storageChannelsStop**
> storageChannelsStop(alt, fields, key, oauthToken, prettyPrint, quotaUser, uploadType, userIp, channel)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.storageChannelsStop(alt, fields, key, oauthToken, prettyPrint, quotaUser, uploadType, userIp, channel);
