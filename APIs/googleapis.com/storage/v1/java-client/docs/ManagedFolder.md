...
|**createTime** | **OffsetDateTime** | The creation time of the managed folder in RFC 3339 format. |  [optional] |
|**id** | **String** | The ID of the managed folder, including the bucket name and managed folder name. |  [optional] |
|**kind** | **String** | The kind of item this is. For managed folders, this is always storage#managedFolder. |  [optional] |
...
|**updateTime** | **OffsetDateTime** | The last update time of the managed folder metadata in RFC 3339 format. |  [optional] |
