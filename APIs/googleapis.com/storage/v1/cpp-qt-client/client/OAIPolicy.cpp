...
QList<OAIPolicy_bindings_inner> OAIPolicy::getBindings() const {
    return m_bindings;
}
void OAIPolicy::setBindings(const QList<OAIPolicy_bindings_inner> &bindings) {
    m_bindings = bindings;
...
QString OAIPolicy::getResourceId() const {
    return m_resource_id;
}
void OAIPolicy::setResourceId(const QString &resource_id) {
    m_resource_id = resource_id;
    m_resource_id_isSet = true;
}

bool OAIPolicy::is_resource_id_Set() const{
    return m_resource_id_isSet;
}

bool OAIPolicy::is_resource_id_Valid() const{
