...
#ifndef OAIManagedFolder_H
#define OAIManagedFolder_H
...
class OAIManagedFolder : public OAIObject {
public:
    OAIManagedFolder();
    OAIManagedFolder(QString json);
    ~OAIManagedFolder() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIManagedFolder)

#endif // OAIManagedFolder_H
