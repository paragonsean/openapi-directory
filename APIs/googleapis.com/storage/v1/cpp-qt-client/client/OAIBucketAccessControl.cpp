...
void OAIBucketAccessControl::initializeModel() {
    ...
    m_project_team_isSet = false;
    m_project_team_isValid = false;
...
void OAIBucketAccessControl::fromJsonObject(QJsonObject json) {
    ...
    m_project_team_isValid = ::OpenAPI::fromJsonValue(m_project_team, json[QString("projectTeam")]);
    m_project_team_isSet = !json[QString("projectTeam")].isNull() && m_project_team_isValid;
...
QJsonObject OAIBucketAccessControl::asJsonObject() const {
    ...
    if (m_project_team.isSet()) {
        obj.insert(QString("projectTeam"), ::OpenAPI::toJsonValue(m_project_team));
    }
    if (m_role_isSet) {
...
OAIBucketAccessControl_projectTeam OAIBucketAccessControl::getProjectTeam() const {
    return m_project_team;
}
void OAIBucketAccessControl::setProjectTeam(const OAIBucketAccessControl_projectTeam &project_team) {
    m_project_team = project_team;
    m_project_team_isSet = true;
}

bool OAIBucketAccessControl::is_project_team_Set() const{
    return m_project_team_isSet;
}

bool OAIBucketAccessControl::is_project_team_Valid() const{
    return m_project_team_isValid;
}
