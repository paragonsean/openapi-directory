...
async def test_storage_object_access_controls_delete(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/storage/v1/b/{bucket}/o/{object}/acl/{entity}'.format(bucket='bucket_example', object='object_example', entity='entity_example'),
        headers=headers,
        params=params,
        )
...
async def test_storage_object_access_controls_insert(client):
    ...
    response = await client.request(
        method='POST',
        path='/storage/v1/b/{bucket}/o/{object}/acl'.format(bucket='bucket_example', object='object_example'),
        headers=headers,
        json=body,
        params=params,
        )
