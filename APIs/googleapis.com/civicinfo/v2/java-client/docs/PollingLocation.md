...
|**latitude** | **Double** | Latitude of the location, in degrees north of the equator. Note this field may not be available for some locations. |  [optional] |
|**longitude** | **Double** | Longitude of the location, in degrees east of the Prime Meridian. Note this field may not be available for some locations. |  [optional] |
