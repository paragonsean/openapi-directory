...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleCivicInformationApi.Source();
  });
  ...
  describe('Source', function() {
    it('should create an instance of Source', function() {
      ...
      //var instance = new GoogleCivicInformationApi.Source();
      //expect(instance).to.be.a(GoogleCivicInformationApi.Source);
    });
