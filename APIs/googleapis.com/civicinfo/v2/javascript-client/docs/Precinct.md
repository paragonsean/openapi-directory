# GoogleCivicInformationApi.Precinct
...
**contestId** | **[String]** | ID(s) of the Contest message(s) for this precinct. | [optional] 
**datasetId** | **String** | Required. Dataset ID. What datasets our Precincts come from. | [optional] 
**earlyVoteSiteId** | **[String]** | ID(s) of the PollingLocation message(s) for this precinct. | [optional] 
**electoralDistrictId** | **[String]** | ID(s) of the ElectoralDistrict message(s) for this precinct. | [optional] 
...
**ocdId** | **[String]** | Encouraged. The OCD ID of the precinct | [optional] 
**pollingLocationId** | **[String]** | ID(s) of the PollingLocation message(s) for this precinct. | [optional] 
**spatialBoundaryId** | **[String]** | ID(s) of the SpatialBoundary message(s) for this precinct. Used to specify a geometrical boundary of the precinct. | [optional] 
