...
|------------ | ------------- | ------------- | -------------|
|**achievementState** | [**AchievementStateEnum**](#AchievementStateEnum) | The state of the achievement. |  [optional] |
|**currentSteps** | **Integer** | The current steps for an incremental achievement. |  [optional] |
