...
|**currentState** | [**CurrentStateEnum**](#CurrentStateEnum) | The current state of the achievement. |  [optional] |
|**currentSteps** | **Integer** | The current steps recorded for this achievement if it is incremental. |  [optional] |
