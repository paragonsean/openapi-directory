...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GooglePlayGameServices.EventPeriodUpdate();
  });
  ...
  describe('EventPeriodUpdate', function() {
    it('should create an instance of EventPeriodUpdate', function() {
      // uncomment below and update the code to test EventPeriodUpdate
      //var instance = new GooglePlayGameServices.EventPeriodUpdate();
      //expect(instance).to.be.a(GooglePlayGameServices.EventPeriodUpdate);
    });
