...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GooglePlayGameServices.UnlinkPersonaRequest();
  });
  ...
  describe('UnlinkPersonaRequest', function() {
    it('should create an instance of UnlinkPersonaRequest', function() {
      // uncomment below and update the code to test UnlinkPersonaRequest
      //var instance = new GooglePlayGameServices.UnlinkPersonaRequest();
      //expect(instance).to.be.a(GooglePlayGameServices.UnlinkPersonaRequest);
    });
