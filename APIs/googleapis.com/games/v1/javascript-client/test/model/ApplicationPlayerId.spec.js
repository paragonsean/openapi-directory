...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GooglePlayGameServices.ApplicationPlayerId();
  });
  ...
  describe('ApplicationPlayerId', function() {
    it('should create an instance of ApplicationPlayerId', function() {
      // uncomment below and update the code to test ApplicationPlayerId
      //var instance = new GooglePlayGameServices.ApplicationPlayerId();
      //expect(instance).to.be.a(GooglePlayGameServices.ApplicationPlayerId);
    });
