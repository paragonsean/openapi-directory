...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GooglePlayGameServices.ApplicationCategory();
  });
  ...
  describe('ApplicationCategory', function() {
    it('should create an instance of ApplicationCategory', function() {
      // uncomment below and update the code to test ApplicationCategory
      //var instance = new GooglePlayGameServices.ApplicationCategory();
      //expect(instance).to.be.a(GooglePlayGameServices.ApplicationCategory);
    });
