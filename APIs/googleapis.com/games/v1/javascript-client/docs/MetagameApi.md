# GooglePlayGameServices.MetagameApi
...
> MetagameConfig gamesMetagameGetMetagameConfig(opts)
...
let apiInstance = new GooglePlayGameServices.MetagameApi();
let opts = {
...
apiInstance.gamesMetagameGetMetagameConfig(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> CategoryListResponse gamesMetagameListCategoriesByPlayer(playerId, collection, opts)
...
let collection = "collection_example"; // String | The collection of categories for which data will be returned.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'maxResults': 56, // Number | The maximum number of category resources to return in the response, used for paging. For any response, the actual number of category resources returned may be less than the specified `maxResults`.
  'pageToken': "pageToken_example" // String | The token returned by the previous request.
};
apiInstance.gamesMetagameListCategoriesByPlayer(playerId, collection, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **maxResults** | **Number**| The maximum number of category resources to return in the response, used for paging. For any response, the actual number of category resources returned may be less than the specified &#x60;maxResults&#x60;. | [optional] 
