# GooglePlayGameServices.Leaderboard
...
**order** | **String** | How scores are ordered. | [optional] 
...
* `LARGER_IS_BETTER` (value: `"LARGER_IS_BETTER"`)

* `SMALLER_IS_BETTER` (value: `"SMALLER_IS_BETTER"`)
