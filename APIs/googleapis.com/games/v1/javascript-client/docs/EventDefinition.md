# GooglePlayGameServices.EventDefinition

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**childEvents** | [**[EventChild]**](EventChild.md) | A list of events that are a child of this event. | [optional] 
...
**visibility** | **String** | The visibility of event being tracked in this definition. | [optional] 
