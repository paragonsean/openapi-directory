# GooglePlayGameServices.EventRecordRequest
...
**timePeriods** | [**[EventPeriodUpdate]**](EventPeriodUpdate.md) | A list of the time period updates being made in this request. | [optional] 
