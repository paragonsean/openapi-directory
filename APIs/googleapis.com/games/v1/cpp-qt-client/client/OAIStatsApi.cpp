...
void OAIStatsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("games_stats_get", defaultConf);
    _serverIndices.insert("games_stats_get", 0);
}
...
void OAIStatsApi::games_stats_get(const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type) {
    QString fullPath = QString(_serverConfigs["games_stats_get"][_serverIndices.value("games_stats_get")].URL()+"/games/v1/stats");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIStatsApi::games_stats_getCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIStatsApi::games_stats_getCallback);
...
void OAIStatsApi::games_stats_getCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIStatsResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT games_stats_getSignal(output);
        Q_EMIT games_stats_getSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT games_stats_getSignalE(output, error_type, error_str);
        Q_EMIT games_stats_getSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT games_stats_getSignalError(output, error_type, error_str);
        Q_EMIT games_stats_getSignalErrorFull(worker, error_type, error_str);
    }
}
