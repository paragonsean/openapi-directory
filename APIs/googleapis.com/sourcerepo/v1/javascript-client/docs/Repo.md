# CloudSourceRepositoriesApi.Repo
...
**pubsubConfigs** | [**{String: PubsubConfig}**](PubsubConfig.md) | How this repository publishes a change in the repository through Cloud Pub/Sub. Keyed by the topic names. | [optional] 
