...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudSourceRepositoriesApi.Status();
  });
  ...
  describe('Status', function() {
    it('should create an instance of Status', function() {
      ...
      //var instance = new CloudSourceRepositoriesApi.Status();
      //expect(instance).to.be.a(CloudSourceRepositoriesApi.Status);
    });
