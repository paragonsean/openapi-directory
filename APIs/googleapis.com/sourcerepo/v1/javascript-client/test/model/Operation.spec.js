...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudSourceRepositoriesApi.Operation();
  });
  ...
  describe('Operation', function() {
    it('should create an instance of Operation', function() {
      ...
      //var instance = new CloudSourceRepositoriesApi.Operation();
      //expect(instance).to.be.a(CloudSourceRepositoriesApi.Operation);
    });
