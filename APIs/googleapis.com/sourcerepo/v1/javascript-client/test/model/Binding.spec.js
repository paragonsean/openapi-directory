...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudSourceRepositoriesApi.Binding();
  });
  ...
  describe('Binding', function() {
    it('should create an instance of Binding', function() {
      ...
      //var instance = new CloudSourceRepositoriesApi.Binding();
      //expect(instance).to.be.a(CloudSourceRepositoriesApi.Binding);
    });
