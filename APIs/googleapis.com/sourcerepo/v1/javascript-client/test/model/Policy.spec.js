...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudSourceRepositoriesApi.Policy();
  });
  ...
  describe('Policy', function() {
    it('should create an instance of Policy', function() {
      ...
      //var instance = new CloudSourceRepositoriesApi.Policy();
      //expect(instance).to.be.a(CloudSourceRepositoriesApi.Policy);
    });
