...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudSourceRepositoriesApi.SyncRepoMetadata();
  });
  ...
  describe('SyncRepoMetadata', function() {
    it('should create an instance of SyncRepoMetadata', function() {
      // uncomment below and update the code to test SyncRepoMetadata
      //var instance = new CloudSourceRepositoriesApi.SyncRepoMetadata();
      //expect(instance).to.be.a(CloudSourceRepositoriesApi.SyncRepoMetadata);
    });
