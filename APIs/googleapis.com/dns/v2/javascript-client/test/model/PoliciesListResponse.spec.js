...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudDnsApi.PoliciesListResponse();
  });
  ...
  describe('PoliciesListResponse', function() {
    it('should create an instance of PoliciesListResponse', function() {
      // uncomment below and update the code to test PoliciesListResponse
      //var instance = new CloudDnsApi.PoliciesListResponse();
      //expect(instance).to.be.a(CloudDnsApi.PoliciesListResponse);
    });
