...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudDnsApi.ResponsePoliciesListResponse();
  });
  ...
  describe('ResponsePoliciesListResponse', function() {
    it('should create an instance of ResponsePoliciesListResponse', function() {
      // uncomment below and update the code to test ResponsePoliciesListResponse
      //var instance = new CloudDnsApi.ResponsePoliciesListResponse();
      //expect(instance).to.be.a(CloudDnsApi.ResponsePoliciesListResponse);
    });
