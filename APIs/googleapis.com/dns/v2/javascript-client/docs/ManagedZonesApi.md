...
> ManagedZone dnsManagedZonesCreate(project, location, opts)
...
apiInstance.dnsManagedZonesCreate(project, location, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> dnsManagedZonesDelete(project, location, managedZone, opts)
...
apiInstance.dnsManagedZonesDelete(project, location, managedZone, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> ManagedZone dnsManagedZonesGet(project, location, managedZone, opts)
...
apiInstance.dnsManagedZonesGet(project, location, managedZone, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ManagedZonesListResponse dnsManagedZonesList(project, location, opts)
...
apiInstance.dnsManagedZonesList(project, location, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Operation dnsManagedZonesPatch(project, location, managedZone, opts)
...
apiInstance.dnsManagedZonesPatch(project, location, managedZone, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Operation dnsManagedZonesUpdate(project, location, managedZone, opts)
...
apiInstance.dnsManagedZonesUpdate(project, location, managedZone, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
