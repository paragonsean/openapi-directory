...
> Operation dnsManagedZoneOperationsGet(project, location, managedZone, operation, opts)
...
apiInstance.dnsManagedZoneOperationsGet(project, location, managedZone, operation, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> ManagedZoneOperationsListResponse dnsManagedZoneOperationsList(project, location, managedZone, opts)
...
apiInstance.dnsManagedZoneOperationsList(project, location, managedZone, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
