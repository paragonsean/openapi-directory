...
**kind** | **String** |  | [optional] [default to &#39;dns#policy&#39;]
**name** | **String** | User-assigned name for this policy. | [optional] 
**networks** | [**[PolicyNetwork]**](PolicyNetwork.md) | List of network names specifying networks to which this policy is applied. | [optional] 
