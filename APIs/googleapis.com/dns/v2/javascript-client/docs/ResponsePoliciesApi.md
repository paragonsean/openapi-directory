...
> ResponsePolicy dnsResponsePoliciesCreate(project, location, opts)
...
let location = "location_example"; // String | Specifies the location of the resource, only applicable in the v APIs. This information will be used for routing and will be part of the resource name.
let opts = {
...
apiInstance.dnsResponsePoliciesCreate(project, location, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> dnsResponsePoliciesDelete(project, location, responsePolicy, opts)
...
apiInstance.dnsResponsePoliciesDelete(project, location, responsePolicy, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> ResponsePolicy dnsResponsePoliciesGet(project, location, responsePolicy, opts)
...
apiInstance.dnsResponsePoliciesGet(project, location, responsePolicy, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ResponsePoliciesListResponse dnsResponsePoliciesList(project, location, opts)
...
apiInstance.dnsResponsePoliciesList(project, location, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ResponsePoliciesPatchResponse dnsResponsePoliciesPatch(project, location, responsePolicy, opts)
...
apiInstance.dnsResponsePoliciesPatch(project, location, responsePolicy, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ResponsePoliciesUpdateResponse dnsResponsePoliciesUpdate(project, location, responsePolicy, opts)
...
apiInstance.dnsResponsePoliciesUpdate(project, location, responsePolicy, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
