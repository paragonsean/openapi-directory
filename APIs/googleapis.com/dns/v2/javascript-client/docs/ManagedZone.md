...
**kind** | **String** |  | [optional] [default to &#39;dns#managedZone&#39;]
...
**nameServers** | **[String]** | Delegate your managed_zone to these virtual name servers; defined by the server (output only) | [optional] 
...
**visibility** | **String** | The zone&#39;s visibility: public zones are exposed to the Internet, while private zones are visible only to Virtual Private Cloud resources. | [optional] 
