# CloudDnsApi.ProjectsApi

All URIs are relative to *https://dns.googleapis.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**dnsProjectsGet**](ProjectsApi.md#dnsProjectsGet) | **GET** /dns/v2/projects/{project}/locations/{location} | 



## dnsProjectsGet

> Project dnsProjectsGet(project, location, opts)
...
let apiInstance = new CloudDnsApi.ProjectsApi();
...
apiInstance.dnsProjectsGet(project, location, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
