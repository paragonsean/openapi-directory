...
> Policy dnsPoliciesCreate(project, location, opts)
...
apiInstance.dnsPoliciesCreate(project, location, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> dnsPoliciesDelete(project, location, policy, opts)
...
apiInstance.dnsPoliciesDelete(project, location, policy, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> Policy dnsPoliciesGet(project, location, policy, opts)
...
apiInstance.dnsPoliciesGet(project, location, policy, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> PoliciesListResponse dnsPoliciesList(project, location, opts)
...
apiInstance.dnsPoliciesList(project, location, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> PoliciesPatchResponse dnsPoliciesPatch(project, location, policy, opts)
...
apiInstance.dnsPoliciesPatch(project, location, policy, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> PoliciesUpdateResponse dnsPoliciesUpdate(project, location, policy, opts)
...
apiInstance.dnsPoliciesUpdate(project, location, policy, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
