...
> DnsKey dnsDnsKeysGet(project, location, managedZone, dnsKeyId, opts)
...
apiInstance.dnsDnsKeysGet(project, location, managedZone, dnsKeyId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> DnsKeysListResponse dnsDnsKeysList(project, location, managedZone, opts)
...
apiInstance.dnsDnsKeysList(project, location, managedZone, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
