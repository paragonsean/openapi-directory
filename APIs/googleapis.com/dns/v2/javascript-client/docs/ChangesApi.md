...
> Change dnsChangesCreate(project, location, managedZone, opts)
...
apiInstance.dnsChangesCreate(project, location, managedZone, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> Change dnsChangesGet(project, location, managedZone, changeId, opts)
...
apiInstance.dnsChangesGet(project, location, managedZone, changeId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ChangesListResponse dnsChangesList(project, location, managedZone, opts)
...
apiInstance.dnsChangesList(project, location, managedZone, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
