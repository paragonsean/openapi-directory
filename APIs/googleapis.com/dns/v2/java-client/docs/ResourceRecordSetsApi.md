...
> ResourceRecordSet dnsResourceRecordSetsCreate(project, location, managedZone, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, clientOperationId, resourceRecordSet)
...
public class Example {
  public static void main(String[] args) {
    ...
    String location = "location_example"; // String | Specifies the location of the resource. This information is used for routing and is part of the resource name.
    ...
    try {
      ResourceRecordSet result = apiInstance.dnsResourceRecordSetsCreate(project, location, managedZone, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, clientOperationId, resourceRecordSet);
...
> dnsResourceRecordSetsDelete(project, location, managedZone, name, type, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, clientOperationId)
...
public class Example {
  public static void main(String[] args) {
    ...
    String clientOperationId = "clientOperationId_example"; // String | For mutating operation requests only. An optional identifier specified by the client. Must be unique for operation resources in the Operations collection.
    try {
      apiInstance.dnsResourceRecordSetsDelete(project, location, managedZone, name, type, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, clientOperationId);
    } catch (ApiException e) {
...
> ResourceRecordSet dnsResourceRecordSetsGet(project, location, managedZone, name, type, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, clientOperationId)
...
public class Example {
  public static void main(String[] args) {
    ...
    String clientOperationId = "clientOperationId_example"; // String | For mutating operation requests only. An optional identifier specified by the client. Must be unique for operation resources in the Operations collection.
    try {
      ResourceRecordSet result = apiInstance.dnsResourceRecordSetsGet(project, location, managedZone, name, type, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, clientOperationId);
      System.out.println(result);
    } catch (ApiException e) {
...
> ResourceRecordSetsListResponse dnsResourceRecordSetsList(project, location, managedZone, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, maxResults, name, pageToken, type)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ResourceRecordSetsListResponse result = apiInstance.dnsResourceRecordSetsList(project, location, managedZone, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, maxResults, name, pageToken, type);
      System.out.println(result);
    } catch (ApiException e) {
...
> ResourceRecordSet dnsResourceRecordSetsPatch(project, location, managedZone, name, type, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, clientOperationId, resourceRecordSet)
...
public class Example {
  public static void main(String[] args) {
    ...
    ResourceRecordSet resourceRecordSet = new ResourceRecordSet(); // ResourceRecordSet | 
    try {
      ResourceRecordSet result = apiInstance.dnsResourceRecordSetsPatch(project, location, managedZone, name, type, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, clientOperationId, resourceRecordSet);
      System.out.println(result);
    } catch (ApiException e) {
