...
|------------- | ------------- | -------------|
| [**dnsDnsKeysGet**](DnsKeysApi.md#dnsDnsKeysGet) | **GET** /dns/v2/projects/{project}/locations/{location}/managedZones/{managedZone}/dnsKeys/{dnsKeyId} |  |
| [**dnsDnsKeysList**](DnsKeysApi.md#dnsDnsKeysList) | **GET** /dns/v2/projects/{project}/locations/{location}/managedZones/{managedZone}/dnsKeys |  |


<a id="dnsDnsKeysGet"></a>
# **dnsDnsKeysGet**
> DnsKey dnsDnsKeysGet(project, location, managedZone, dnsKeyId, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, clientOperationId, digestType)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      DnsKey result = apiInstance.dnsDnsKeysGet(project, location, managedZone, dnsKeyId, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, clientOperationId, digestType);
...
# **dnsDnsKeysList**
> DnsKeysListResponse dnsDnsKeysList(project, location, managedZone, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, digestType, maxResults, pageToken)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      DnsKeysListResponse result = apiInstance.dnsDnsKeysList(project, location, managedZone, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, digestType, maxResults, pageToken);
      System.out.println(result);
    } catch (ApiException e) {
