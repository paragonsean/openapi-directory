...
|------------- | ------------- | -------------|
| [**dnsManagedZonesCreate**](ManagedZonesApi.md#dnsManagedZonesCreate) | **POST** /dns/v2/projects/{project}/locations/{location}/managedZones |  |
| [**dnsManagedZonesDelete**](ManagedZonesApi.md#dnsManagedZonesDelete) | **DELETE** /dns/v2/projects/{project}/locations/{location}/managedZones/{managedZone} |  |
| [**dnsManagedZonesGet**](ManagedZonesApi.md#dnsManagedZonesGet) | **GET** /dns/v2/projects/{project}/locations/{location}/managedZones/{managedZone} |  |
| [**dnsManagedZonesGetIamPolicy**](ManagedZonesApi.md#dnsManagedZonesGetIamPolicy) | **POST** /dns/v2/{resource}:getIamPolicy |  |
| [**dnsManagedZonesList**](ManagedZonesApi.md#dnsManagedZonesList) | **GET** /dns/v2/projects/{project}/locations/{location}/managedZones |  |
| [**dnsManagedZonesPatch**](ManagedZonesApi.md#dnsManagedZonesPatch) | **PATCH** /dns/v2/projects/{project}/locations/{location}/managedZones/{managedZone} |  |
| [**dnsManagedZonesSetIamPolicy**](ManagedZonesApi.md#dnsManagedZonesSetIamPolicy) | **POST** /dns/v2/{resource}:setIamPolicy |  |
| [**dnsManagedZonesTestIamPermissions**](ManagedZonesApi.md#dnsManagedZonesTestIamPermissions) | **POST** /dns/v2/{resource}:testIamPermissions |  |
| [**dnsManagedZonesUpdate**](ManagedZonesApi.md#dnsManagedZonesUpdate) | **PUT** /dns/v2/projects/{project}/locations/{location}/managedZones/{managedZone} |  |


<a id="dnsManagedZonesCreate"></a>
# **dnsManagedZonesCreate**
> ManagedZone dnsManagedZonesCreate(project, location, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, clientOperationId, managedZone)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ManagedZone result = apiInstance.dnsManagedZonesCreate(project, location, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, clientOperationId, managedZone);
...
> dnsManagedZonesDelete(project, location, managedZone, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, clientOperationId)
...
public class Example {
  public static void main(String[] args) {
    ...
    String clientOperationId = "clientOperationId_example"; // String | For mutating operation requests only. An optional identifier specified by the client. Must be unique for operation resources in the Operations collection.
    try {
      apiInstance.dnsManagedZonesDelete(project, location, managedZone, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, clientOperationId);
    } catch (ApiException e) {
...
# **dnsManagedZonesGet**
> ManagedZone dnsManagedZonesGet(project, location, managedZone, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, clientOperationId)
...
public class Example {
  public static void main(String[] args) {
    ...
    String clientOperationId = "clientOperationId_example"; // String | For mutating operation requests only. An optional identifier specified by the client. Must be unique for operation resources in the Operations collection.
    try {
      ManagedZone result = apiInstance.dnsManagedZonesGet(project, location, managedZone, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, clientOperationId);
      System.out.println(result);
    } catch (ApiException e) {
...
# **dnsManagedZonesList**
> ManagedZonesListResponse dnsManagedZonesList(project, location, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, dnsName, maxResults, pageToken)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ManagedZonesListResponse result = apiInstance.dnsManagedZonesList(project, location, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, dnsName, maxResults, pageToken);
      System.out.println(result);
    } catch (ApiException e) {
...
> Operation dnsManagedZonesPatch(project, location, managedZone, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, clientOperationId, managedZone2)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Operation result = apiInstance.dnsManagedZonesPatch(project, location, managedZone, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, clientOperationId, managedZone2);
      System.out.println(result);
    } catch (ApiException e) {
...
> Operation dnsManagedZonesUpdate(project, location, managedZone, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, clientOperationId, managedZone2)
...
public class Example {
  public static void main(String[] args) {
    ...
    ManagedZone managedZone2 = new ManagedZone(); // ManagedZone | 
    try {
      Operation result = apiInstance.dnsManagedZonesUpdate(project, location, managedZone, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, clientOperationId, managedZone2);
      System.out.println(result);
    } catch (ApiException e) {
