...
void OAIProjectsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("dns_projects_get", defaultConf);
    _serverIndices.insert("dns_projects_get", 0);
}
...
void OAIProjectsApi::dns_projects_get(const QString &project, const QString &location, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<QString> &client_operation_id) {
    QString fullPath = QString(_serverConfigs["dns_projects_get"][_serverIndices.value("dns_projects_get")].URL()+"/dns/v2/projects/{project}/locations/{location}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::dns_projects_getCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::dns_projects_getCallback);
...
void OAIProjectsApi::dns_projects_getCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT dns_projects_getSignal(output);
        Q_EMIT dns_projects_getSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT dns_projects_getSignalE(output, error_type, error_str);
        Q_EMIT dns_projects_getSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT dns_projects_getSignalError(output, error_type, error_str);
        Q_EMIT dns_projects_getSignalErrorFull(worker, error_type, error_str);
    }
}
