...
async def test_dns_managed_zones_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/dns/v2/projects/{project}/locations/{location}/managedZones'.format(project='project_example', location='location_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_dns_managed_zones_delete(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/dns/v2/projects/{project}/locations/{location}/managedZones/{managed_zone}'.format(project='project_example', location='location_example', managed_zone='managed_zone_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_dns_managed_zones_get_iam_policy(client):
    ...
    response = await client.request(
        method='POST',
        path='/dns/v2/{resourceget_iam_polic}'.format(resource='resource_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_dns_managed_zones_set_iam_policy(client):
    ...
    response = await client.request(
        method='POST',
        path='/dns/v2/{resourceset_iam_polic}'.format(resource='resource_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_dns_managed_zones_test_iam_permissions(client):
    ...
    response = await client.request(
        method='POST',
        path='/dns/v2/{resourcetest_iam_permission}'.format(resource='resource_example'),
        headers=headers,
        json=body,
        params=params,
        )
