...
async def test_dns_response_policy_rules_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/dns/v2/projects/{project}/locations/{location}/responsePolicies/{response_policy}/rules'.format(project='project_example', location='location_example', response_policy='response_policy_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_dns_response_policy_rules_delete(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/dns/v2/projects/{project}/locations/{location}/responsePolicies/{response_policy}/rules/{response_policy_rule}'.format(project='project_example', location='location_example', response_policy='response_policy_example', response_policy_rule='response_policy_rule_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
