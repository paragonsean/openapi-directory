...
async def dns_managed_zone_operations_get(request: web.Request, project, location, managed_zone, operation, xgafv=None, access_token=None, alt=None, param_callback=None, fields=None, key=None, oauth_token=None, pretty_print=None, quota_user=None, upload_protocol=None, upload_type=None, client_operation_id=None) -> web.Response:
    ...
    :type location: str
    :param managed_zone: Identifies the managed zone addressed by this request.
