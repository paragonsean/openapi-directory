...
async def dns_resource_record_sets_create(request: web.Request, project, location, managed_zone, xgafv=None, access_token=None, alt=None, param_callback=None, fields=None, key=None, oauth_token=None, pretty_print=None, quota_user=None, upload_protocol=None, upload_type=None, client_operation_id=None, body=None) -> web.Response:
    ...
    :type project: str
    :param location: Specifies the location of the resource. This information is used for routing and is part of the resource name.
    :type location: str
...
async def dns_resource_record_sets_delete(request: web.Request, project, location, managed_zone, name, type, xgafv=None, access_token=None, alt=None, param_callback=None, fields=None, key=None, oauth_token=None, pretty_print=None, quota_user=None, upload_protocol=None, upload_type=None, client_operation_id=None) -> web.Response:
...
async def dns_resource_record_sets_get(request: web.Request, project, location, managed_zone, name, type, xgafv=None, access_token=None, alt=None, param_callback=None, fields=None, key=None, oauth_token=None, pretty_print=None, quota_user=None, upload_protocol=None, upload_type=None, client_operation_id=None) -> web.Response:
    """dns_resource_record_sets_get
...
async def dns_resource_record_sets_patch(request: web.Request, project, location, managed_zone, name, type, xgafv=None, access_token=None, alt=None, param_callback=None, fields=None, key=None, oauth_token=None, pretty_print=None, quota_user=None, upload_protocol=None, upload_type=None, client_operation_id=None, body=None) -> web.Response:
