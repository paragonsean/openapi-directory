...
> Policy dnsPoliciesCreate(project, opts)
...
let apiInstance = new CloudDnsApi.PoliciesApi();
...
let opts = {
  ...
  'policy': new CloudDnsApi.Policy() // Policy | 
};
apiInstance.dnsPoliciesCreate(project, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> dnsPoliciesDelete(project, policy, opts)
...
let apiInstance = new CloudDnsApi.PoliciesApi();
let project = "project_example"; // String | Identifies the project addressed by this request.
let policy = "policy_example"; // String | User given friendly name of the policy addressed by this request.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
apiInstance.dnsPoliciesDelete(project, policy, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> Policy dnsPoliciesGet(project, policy, opts)
...
apiInstance.dnsPoliciesGet(project, policy, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> PoliciesListResponse dnsPoliciesList(project, opts)
...
apiInstance.dnsPoliciesList(project, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> PoliciesPatchResponse dnsPoliciesPatch(project, policy, opts)
...
let opts = {
  ...
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'clientOperationId': "clientOperationId_example", // String | For mutating operation requests only. An optional identifier specified by the client. Must be unique for operation resources in the Operations collection.
  'policy2': new CloudDnsApi.Policy() // Policy | 
};
apiInstance.dnsPoliciesPatch(project, policy, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> PoliciesUpdateResponse dnsPoliciesUpdate(project, policy, opts)
...
apiInstance.dnsPoliciesUpdate(project, policy, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
