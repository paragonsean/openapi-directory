...
> ResponsePolicyRule dnsResponsePolicyRulesCreate(project, responsePolicy, opts)
...
apiInstance.dnsResponsePolicyRulesCreate(project, responsePolicy, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> dnsResponsePolicyRulesDelete(project, responsePolicy, responsePolicyRule, opts)
...
apiInstance.dnsResponsePolicyRulesDelete(project, responsePolicy, responsePolicyRule, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> ResponsePolicyRule dnsResponsePolicyRulesGet(project, responsePolicy, responsePolicyRule, opts)
...
apiInstance.dnsResponsePolicyRulesGet(project, responsePolicy, responsePolicyRule, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ResponsePolicyRulesListResponse dnsResponsePolicyRulesList(project, responsePolicy, opts)
...
apiInstance.dnsResponsePolicyRulesList(project, responsePolicy, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ResponsePolicyRulesPatchResponse dnsResponsePolicyRulesPatch(project, responsePolicy, responsePolicyRule, opts)
...
apiInstance.dnsResponsePolicyRulesPatch(project, responsePolicy, responsePolicyRule, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ResponsePolicyRulesUpdateResponse dnsResponsePolicyRulesUpdate(project, responsePolicy, responsePolicyRule, opts)
...
apiInstance.dnsResponsePolicyRulesUpdate(project, responsePolicy, responsePolicyRule, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
