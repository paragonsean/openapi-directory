...
------------- | ------------- | -------------
[**dnsProjectsGet**](ProjectsApi.md#dnsProjectsGet) | **GET** /dns/v1beta2/projects/{project} | 



## dnsProjectsGet

> Project dnsProjectsGet(project, opts)
...
apiInstance.dnsProjectsGet(project, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
