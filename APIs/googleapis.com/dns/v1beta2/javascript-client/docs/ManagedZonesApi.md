...
> ManagedZone dnsManagedZonesCreate(project, opts)
...
let apiInstance = new CloudDnsApi.ManagedZonesApi();
...
let opts = {
  ...
  'managedZone': new CloudDnsApi.ManagedZone() // ManagedZone | 
};
apiInstance.dnsManagedZonesCreate(project, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> dnsManagedZonesDelete(project, managedZone, opts)
...
apiInstance.dnsManagedZonesDelete(project, managedZone, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> ManagedZone dnsManagedZonesGet(project, managedZone, opts)
...
apiInstance.dnsManagedZonesGet(project, managedZone, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> GoogleIamV1Policy dnsManagedZonesGetIamPolicy(resource, opts)
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'googleIamV1GetIamPolicyRequest': new CloudDnsApi.GoogleIamV1GetIamPolicyRequest() // GoogleIamV1GetIamPolicyRequest | 
};
apiInstance.dnsManagedZonesGetIamPolicy(resource, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ManagedZonesListResponse dnsManagedZonesList(project, opts)
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'dnsName': "dnsName_example", // String | Restricts the list to return only zones with this domain name.
...
apiInstance.dnsManagedZonesList(project, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Operation dnsManagedZonesPatch(project, managedZone, opts)
...
let opts = {
  ...
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'clientOperationId': "clientOperationId_example", // String | For mutating operation requests only. An optional identifier specified by the client. Must be unique for operation resources in the Operations collection.
  'managedZone2': new CloudDnsApi.ManagedZone() // ManagedZone | 
};
apiInstance.dnsManagedZonesPatch(project, managedZone, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> GoogleIamV1Policy dnsManagedZonesSetIamPolicy(resource, opts)
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'googleIamV1SetIamPolicyRequest': new CloudDnsApi.GoogleIamV1SetIamPolicyRequest() // GoogleIamV1SetIamPolicyRequest | 
};
apiInstance.dnsManagedZonesSetIamPolicy(resource, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> GoogleIamV1TestIamPermissionsResponse dnsManagedZonesTestIamPermissions(resource, opts)
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'googleIamV1TestIamPermissionsRequest': new CloudDnsApi.GoogleIamV1TestIamPermissionsRequest() // GoogleIamV1TestIamPermissionsRequest | 
};
apiInstance.dnsManagedZonesTestIamPermissions(resource, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Operation dnsManagedZonesUpdate(project, managedZone, opts)
...
apiInstance.dnsManagedZonesUpdate(project, managedZone, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
