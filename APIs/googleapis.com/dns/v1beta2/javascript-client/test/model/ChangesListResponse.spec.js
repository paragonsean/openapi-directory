...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudDnsApi.ChangesListResponse();
  });
  ...
  describe('ChangesListResponse', function() {
    it('should create an instance of ChangesListResponse', function() {
      // uncomment below and update the code to test ChangesListResponse
      //var instance = new CloudDnsApi.ChangesListResponse();
      //expect(instance).to.be.a(CloudDnsApi.ChangesListResponse);
    });
