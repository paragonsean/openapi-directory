...
export default class ManagedZonesApi {
    ...
    */
     ...
     */
    dnsManagedZonesCreate(project, opts, callback) {
      opts = opts || {};
      ...
      return this.apiClient.callApi(
        '/dns/v1beta2/projects/{project}/managedZones', 'POST',
     ...
     */
    dnsManagedZonesDelete(project, managedZone, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'project' is set
      if (project === undefined || project === null) {
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/dns/v1beta2/projects/{project}/managedZones/{managedZone}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
     ...
     * data is of type: {@link module:model/ManagedZone}
     */
    dnsManagedZonesGet(project, managedZone, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'project' is set
      if (project === undefined || project === null) {
      ...
      let returnType = ManagedZone;
      return this.apiClient.callApi(
        '/dns/v1beta2/projects/{project}/managedZones/{managedZone}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    dnsManagedZonesGetIamPolicy(resource, opts, callback) {
      ...
      return this.apiClient.callApi(
        '/dns/v1beta2/{resource}:getIamPolicy', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
     ...
     */
    dnsManagedZonesList(project, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'project' is set
      if (project === undefined || project === null) {
      ...
      return this.apiClient.callApi(
        '/dns/v1beta2/projects/{project}/managedZones', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
     ...
     */
    dnsManagedZonesPatch(project, managedZone, opts, callback) {
      opts = opts || {};
      ...
      return this.apiClient.callApi(
        '/dns/v1beta2/projects/{project}/managedZones/{managedZone}', 'PATCH',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    dnsManagedZonesSetIamPolicy(resource, opts, callback) {
      ...
      let returnType = GoogleIamV1Policy;
      return this.apiClient.callApi(
        '/dns/v1beta2/{resource}:setIamPolicy', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    dnsManagedZonesTestIamPermissions(resource, opts, callback) {
      ...
      return this.apiClient.callApi(
        '/dns/v1beta2/{resource}:testIamPermissions', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
     ...
     * data is of type: {@link module:model/Operation}
     */
    dnsManagedZonesUpdate(project, managedZone, opts, callback) {
      opts = opts || {};
      let postBody = opts['managedZone2'];
      // verify the required parameter 'project' is set
      if (project === undefined || project === null) {
      ...
      let returnType = Operation;
      return this.apiClient.callApi(
        '/dns/v1beta2/projects/{project}/managedZones/{managedZone}', 'PUT',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
