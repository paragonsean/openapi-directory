...
export default class DnsKeysApi {
    ...
    */
     ...
     */
    dnsDnsKeysGet(project, managedZone, dnsKeyId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      return this.apiClient.callApi(
        '/dns/v1/projects/{project}/managedZones/{managedZone}/dnsKeys/{dnsKeyId}', 'GET',
     ...
     */
    dnsDnsKeysList(project, managedZone, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'project' is set
      if (project === undefined || project === null) {
      ...
      return this.apiClient.callApi(
        '/dns/v1/projects/{project}/managedZones/{managedZone}/dnsKeys', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
