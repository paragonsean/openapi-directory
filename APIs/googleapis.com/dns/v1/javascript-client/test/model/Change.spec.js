...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudDnsApi.Change();
  });
  ...
  describe('Change', function() {
    it('should create an instance of Change', function() {
      ...
      //var instance = new CloudDnsApi.Change();
      //expect(instance).to.be.a(CloudDnsApi.Change);
    });
    ...
    it('should have the property isServing (base name: "isServing")', function() {
      // uncomment below and update the code to test the property isServing
      //var instance = new CloudDnsApi.Change();
      //expect(instance).to.be();
    });
