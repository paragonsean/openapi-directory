...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudDnsApi.ManagedZoneOperationsListResponse();
  });
  ...
  describe('ManagedZoneOperationsListResponse', function() {
    it('should create an instance of ManagedZoneOperationsListResponse', function() {
      // uncomment below and update the code to test ManagedZoneOperationsListResponse
      //var instance = new CloudDnsApi.ManagedZoneOperationsListResponse();
      //expect(instance).to.be.a(CloudDnsApi.ManagedZoneOperationsListResponse);
    });
