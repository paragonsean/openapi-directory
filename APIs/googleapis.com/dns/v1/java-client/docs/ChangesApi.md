...
|------------- | ------------- | -------------|
| [**dnsChangesCreate**](ChangesApi.md#dnsChangesCreate) | **POST** /dns/v1/projects/{project}/managedZones/{managedZone}/changes |  |
| [**dnsChangesGet**](ChangesApi.md#dnsChangesGet) | **GET** /dns/v1/projects/{project}/managedZones/{managedZone}/changes/{changeId} |  |
| [**dnsChangesList**](ChangesApi.md#dnsChangesList) | **GET** /dns/v1/projects/{project}/managedZones/{managedZone}/changes |  |


<a id="dnsChangesCreate"></a>
# **dnsChangesCreate**
> Change dnsChangesCreate(project, managedZone, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, clientOperationId, change)
...
# **dnsChangesGet**
> Change dnsChangesGet(project, managedZone, changeId, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, clientOperationId)
...
public class Example {
  public static void main(String[] args) {
    ...
    String clientOperationId = "clientOperationId_example"; // String | For mutating operation requests only. An optional identifier specified by the client. Must be unique for operation resources in the Operations collection.
    try {
      Change result = apiInstance.dnsChangesGet(project, managedZone, changeId, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, clientOperationId);
      System.out.println(result);
    } catch (ApiException e) {
...
# **dnsChangesList**
> ChangesListResponse dnsChangesList(project, managedZone, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, maxResults, pageToken, sortBy, sortOrder)
...
public class Example {
  public static void main(String[] args) {
    ...
    String sortBy = "changeSequence"; // String | Sorting criterion. The only supported value is change sequence.
    String sortOrder = "sortOrder_example"; // String | Sorting order direction: 'ascending' or 'descending'.
    try {
      ChangesListResponse result = apiInstance.dnsChangesList(project, managedZone, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, maxResults, pageToken, sortBy, sortOrder);
      System.out.println(result);
    } catch (ApiException e) {
...
| **sortBy** | **String**| Sorting criterion. The only supported value is change sequence. | [optional] [enum: changeSequence] |
