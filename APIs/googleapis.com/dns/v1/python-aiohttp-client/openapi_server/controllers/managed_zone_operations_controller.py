...
async def dns_managed_zone_operations_get(request: web.Request, project, managed_zone, operation, xgafv=None, access_token=None, alt=None, param_callback=None, fields=None, key=None, oauth_token=None, pretty_print=None, quota_user=None, upload_protocol=None, upload_type=None, client_operation_id=None) -> web.Response:
...
async def dns_managed_zone_operations_list(request: web.Request, project, managed_zone, xgafv=None, access_token=None, alt=None, param_callback=None, fields=None, key=None, oauth_token=None, pretty_print=None, quota_user=None, upload_protocol=None, upload_type=None, max_results=None, page_token=None, sort_by=None) -> web.Response:
