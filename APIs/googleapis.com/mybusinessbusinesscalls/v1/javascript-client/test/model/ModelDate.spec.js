...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MyBusinessBusinessCallsApi.ModelDate();
  });
  ...
  describe('ModelDate', function() {
    it('should create an instance of ModelDate', function() {
      ...
      //var instance = new MyBusinessBusinessCallsApi.ModelDate();
      //expect(instance).to.be.a(MyBusinessBusinessCallsApi.ModelDate);
    });
