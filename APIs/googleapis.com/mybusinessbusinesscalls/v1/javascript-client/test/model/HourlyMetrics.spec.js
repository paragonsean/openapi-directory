...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MyBusinessBusinessCallsApi.HourlyMetrics();
  });
  ...
  describe('HourlyMetrics', function() {
    it('should create an instance of HourlyMetrics', function() {
      // uncomment below and update the code to test HourlyMetrics
      //var instance = new MyBusinessBusinessCallsApi.HourlyMetrics();
      //expect(instance).to.be.a(MyBusinessBusinessCallsApi.HourlyMetrics);
    });
