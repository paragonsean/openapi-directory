...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MyBusinessBusinessCallsApi.WeekDayMetrics();
  });
  ...
  describe('WeekDayMetrics', function() {
    it('should create an instance of WeekDayMetrics', function() {
      // uncomment below and update the code to test WeekDayMetrics
      //var instance = new MyBusinessBusinessCallsApi.WeekDayMetrics();
      //expect(instance).to.be.a(MyBusinessBusinessCallsApi.WeekDayMetrics);
    });
