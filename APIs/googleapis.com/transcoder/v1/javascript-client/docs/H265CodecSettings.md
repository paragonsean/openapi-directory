# TranscoderApi.H265CodecSettings
...
**bFrameCount** | **Number** | The number of consecutive B-frames. Must be greater than or equal to zero. Must be less than H265CodecSettings.gop_frame_count if set. The default is 0. | [optional] 
...
**vbvFullnessBits** | **Number** | Initial fullness of the Video Buffering Verifier (VBV) buffer in bits. Must be greater than zero. The default is equal to 90% of H265CodecSettings.vbv_size_bits. | [optional] 
