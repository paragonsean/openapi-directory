...
**editList** | [**[EditAtom]**](EditAtom.md) | List of edit atoms. Defines the ultimate timeline of the resulting file or manifest. | [optional] 
**elementaryStreams** | [**[ElementaryStream]**](ElementaryStream.md) | List of elementary streams. | [optional] 
**encryptions** | [**[Encryption]**](Encryption.md) | List of encryption configurations for the content. Each configuration has an ID. Specify this ID in the MuxStream.encryption_id field to indicate the configuration to use for that &#x60;MuxStream&#x60; output. | [optional] 
...
**spriteSheets** | [**[SpriteSheet]**](SpriteSheet.md) | List of output sprite sheets. Spritesheets require at least one VideoStream in the Jobconfig. | [optional] 
