...
/**
 * The H265CodecSettings model module.
 * @module model/H265CodecSettings
 * @version v1
 */
class H265CodecSettings {
    /**
     * Constructs a new <code>H265CodecSettings</code>.
     * H265 codec settings.
     * @alias module:model/H265CodecSettings
     */
    constructor() { 
        
        H265CodecSettings.initialize(this);
    }
    ...
    /**
     * Constructs a <code>H265CodecSettings</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/H265CodecSettings} obj Optional instance to populate.
     * @return {module:model/H265CodecSettings} The populated <code>H265CodecSettings</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new H265CodecSettings();
            ...
            if (data.hasOwnProperty('hdr10')) {
                obj['hdr10'] = ApiClient.convertToType(data['hdr10'], Object);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>H265CodecSettings</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>H265CodecSettings</code>.
     */
 ...
 */
H265CodecSettings.prototype['allowOpenGop'] = undefined;

/**
 * Specify the intensity of the adaptive quantizer (AQ). Must be between 0 and 1, where 0 disables the quantizer and 1 maximizes the quantizer. A higher value equals a lower bitrate but smoother image. The default is 0.
 * @member {Number} aqStrength
 */
H265CodecSettings.prototype['aqStrength'] = undefined;
 ...
 */
H265CodecSettings.prototype['bFrameCount'] = undefined;

/**
 * Allow B-pyramid for reference frame selection. This may not be supported on all decoders. The default is `false`.
 * @member {Boolean} bPyramid
 */
H265CodecSettings.prototype['bPyramid'] = undefined;
 ...
 */
H265CodecSettings.prototype['bitrateBps'] = undefined;

/**
 * Target CRF level. Must be between 10 and 36, where 10 is the highest quality and 36 is the most efficient compression. The default is 21.
 * @member {Number} crfLevel
 */
H265CodecSettings.prototype['crfLevel'] = undefined;
 ...
 */
H265CodecSettings.prototype['rateControlMode'] = undefined;

/**
 * Convert the input video to a Standard Dynamic Range (SDR) video.
 * @member {Object} sdr
 */
H265CodecSettings.prototype['sdr'] = undefined;
 ...
 * @member {String} tune
 */
H265CodecSettings.prototype['tune'] = undefined;
 ...
 */
H265CodecSettings.prototype['vbvFullnessBits'] = undefined;

/**
 * Size of the Video Buffering Verifier (VBV) buffer in bits. Must be greater than zero. The default is equal to `VideoStream.bitrate_bps`.
 * @member {Number} vbvSizeBits
 */
H265CodecSettings.prototype['vbvSizeBits'] = undefined;

/**
 * The width of the video in pixels. Must be an even integer. When not specified, the width is adjusted to match the specified height and input aspect ratio. If both are omitted, the input width is used. For portrait videos that contain horizontal ASR and rotation metadata, provide the width, in pixels, per the horizontal ASR. The API calculates the height per the horizontal ASR. The API detects any rotation metadata and swaps the requested height and width for the output.
 * @member {Number} widthPixels
 */
H265CodecSettings.prototype['widthPixels'] = undefined;
 ...
 * @readonly
 */
H265CodecSettings['FrameRateConversionStrategyEnum'] = {
...
export default H265CodecSettings;
