...
class Manifest {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('dash')) {
                obj['dash'] = DashConfig.constructFromObject(data['dash']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['dash']) { // data not null
          DashConfig.validateJSON(data['dash']);
        }
...
/**
 * @member {module:model/DashConfig} dash
 */
Manifest.prototype['dash'] = undefined;
