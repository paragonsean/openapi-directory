...
/**
 * The BwdifConfig model module.
 * @module model/BwdifConfig
 * @version v1
 */
class BwdifConfig {
    /**
     * Constructs a new <code>BwdifConfig</code>.
     * Bob Weaver Deinterlacing Filter Configuration.
     * @alias module:model/BwdifConfig
     */
    constructor() { 
        
        BwdifConfig.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BwdifConfig</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BwdifConfig} obj Optional instance to populate.
     * @return {module:model/BwdifConfig} The populated <code>BwdifConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BwdifConfig();
    ...
    /**
     * Validates the JSON data with respect to <code>BwdifConfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BwdifConfig</code>.
     */
 ...
 */
BwdifConfig.prototype['deinterlaceAllFrames'] = undefined;
 ...
 * @member {String} mode
 */
BwdifConfig.prototype['mode'] = undefined;
 ...
 */
BwdifConfig.prototype['parity'] = undefined;
