...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TranscoderApi.AudioStream();
  });
  ...
  describe('AudioStream', function() {
    it('should create an instance of AudioStream', function() {
      // uncomment below and update the code to test AudioStream
      //var instance = new TranscoderApi.AudioStream();
      //expect(instance).to.be.a(TranscoderApi.AudioStream);
    });
