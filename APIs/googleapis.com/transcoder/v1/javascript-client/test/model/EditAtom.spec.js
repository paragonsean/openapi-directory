...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TranscoderApi.EditAtom();
  });
  ...
  describe('EditAtom', function() {
    it('should create an instance of EditAtom', function() {
      // uncomment below and update the code to test EditAtom
      //var instance = new TranscoderApi.EditAtom();
      //expect(instance).to.be.a(TranscoderApi.EditAtom);
    });
