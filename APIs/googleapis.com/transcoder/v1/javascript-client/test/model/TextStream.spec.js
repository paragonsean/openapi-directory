...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TranscoderApi.TextStream();
  });
  ...
  describe('TextStream', function() {
    it('should create an instance of TextStream', function() {
      // uncomment below and update the code to test TextStream
      //var instance = new TranscoderApi.TextStream();
      //expect(instance).to.be.a(TranscoderApi.TextStream);
    });
