...
|------------ | ------------- | ------------- | -------------|
|**bitrateBps** | **Integer** | Required. The video bitrate in bits per second. The minimum value is 1,000. The maximum value is 480,000,000. |  [optional] |
|**crfLevel** | **Integer** | Target CRF level. Must be between 10 and 36, where 10 is the highest quality and 36 is the most efficient compression. The default is 21. **Note:** This field is not supported. |  [optional] |
