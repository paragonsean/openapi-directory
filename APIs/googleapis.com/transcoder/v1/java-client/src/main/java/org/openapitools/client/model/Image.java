...
public class Image {
  ...
  public Image resolution(NormalizedCoordinate resolution) {
  ...
  public void setResolution(NormalizedCoordinate resolution) {
    this.resolution = resolution;
  }
  ...
  public boolean equals(Object o) {
    ...
    Image image = (Image) o;
    return Objects.equals(this.alpha, image.alpha) &&
        Objects.equals(this.resolution, image.resolution) &&
        Objects.equals(this.uri, image.uri);
  }

  @Override
  public int hashCode() {
    return Objects.hash(alpha, resolution, uri);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("resolution") != null && !jsonObj.get("resolution").isJsonNull()) {
        NormalizedCoordinate.validateJsonElement(jsonObj.get("resolution"));
      }
