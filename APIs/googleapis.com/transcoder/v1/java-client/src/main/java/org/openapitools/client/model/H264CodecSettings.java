...
public class H264CodecSettings {
  ...
  public H264CodecSettings allowOpenGop(Boolean allowOpenGop) {
  ...
  public H264CodecSettings aqStrength(Double aqStrength) {
  ...
  public H264CodecSettings bFrameCount(Integer bFrameCount) {
  ...
  public H264CodecSettings bPyramid(Boolean bPyramid) {
  ...
  public H264CodecSettings bitrateBps(Integer bitrateBps) {
  ...
  public H264CodecSettings crfLevel(Integer crfLevel) {
  ...
  public H264CodecSettings enableTwoPass(Boolean enableTwoPass) {
  ...
  public H264CodecSettings entropyCoder(String entropyCoder) {
  ...
  public H264CodecSettings frameRate(Double frameRate) {
  ...
  public H264CodecSettings frameRateConversionStrategy(FrameRateConversionStrategyEnum frameRateConversionStrategy) {
  ...
  public H264CodecSettings gopDuration(String gopDuration) {
  ...
  public H264CodecSettings gopFrameCount(Integer gopFrameCount) {
  ...
  public H264CodecSettings heightPixels(Integer heightPixels) {
  ...
  public H264CodecSettings hlg(Object hlg) {
    this.hlg = hlg;
    return this;
  }
  ...
  public H264CodecSettings pixelFormat(String pixelFormat) {
  ...
  public H264CodecSettings preset(String preset) {
    this.preset = preset;
    return this;
  }
  ...
  public H264CodecSettings profile(String profile) {
  ...
  public H264CodecSettings rateControlMode(String rateControlMode) {
  ...
  public H264CodecSettings sdr(Object sdr) {
    this.sdr = sdr;
    return this;
  }
  ...
  public H264CodecSettings tune(String tune) {
    this.tune = tune;
    return this;
  }
  ...
  public H264CodecSettings vbvFullnessBits(Integer vbvFullnessBits) {
  ...
  public H264CodecSettings vbvSizeBits(Integer vbvSizeBits) {
  ...
  public H264CodecSettings widthPixels(Integer widthPixels) {
  ...
  public boolean equals(Object o) {
    ...
    H264CodecSettings h264CodecSettings = (H264CodecSettings) o;
    return Objects.equals(this.allowOpenGop, h264CodecSettings.allowOpenGop) &&
        Objects.equals(this.aqStrength, h264CodecSettings.aqStrength) &&
        Objects.equals(this.bFrameCount, h264CodecSettings.bFrameCount) &&
        Objects.equals(this.bPyramid, h264CodecSettings.bPyramid) &&
        Objects.equals(this.bitrateBps, h264CodecSettings.bitrateBps) &&
        Objects.equals(this.crfLevel, h264CodecSettings.crfLevel) &&
        Objects.equals(this.enableTwoPass, h264CodecSettings.enableTwoPass) &&
        Objects.equals(this.entropyCoder, h264CodecSettings.entropyCoder) &&
        Objects.equals(this.frameRate, h264CodecSettings.frameRate) &&
        Objects.equals(this.frameRateConversionStrategy, h264CodecSettings.frameRateConversionStrategy) &&
        Objects.equals(this.gopDuration, h264CodecSettings.gopDuration) &&
        Objects.equals(this.gopFrameCount, h264CodecSettings.gopFrameCount) &&
        Objects.equals(this.heightPixels, h264CodecSettings.heightPixels) &&
        Objects.equals(this.hlg, h264CodecSettings.hlg) &&
        Objects.equals(this.pixelFormat, h264CodecSettings.pixelFormat) &&
        Objects.equals(this.preset, h264CodecSettings.preset) &&
        Objects.equals(this.profile, h264CodecSettings.profile) &&
        Objects.equals(this.rateControlMode, h264CodecSettings.rateControlMode) &&
        Objects.equals(this.sdr, h264CodecSettings.sdr) &&
        Objects.equals(this.tune, h264CodecSettings.tune) &&
        Objects.equals(this.vbvFullnessBits, h264CodecSettings.vbvFullnessBits) &&
        Objects.equals(this.vbvSizeBits, h264CodecSettings.vbvSizeBits) &&
        Objects.equals(this.widthPixels, h264CodecSettings.widthPixels);
  }

  @Override
  public int hashCode() {
    return Objects.hash(allowOpenGop, aqStrength, bFrameCount, bPyramid, bitrateBps, crfLevel, enableTwoPass, entropyCoder, frameRate, frameRateConversionStrategy, gopDuration, gopFrameCount, heightPixels, hlg, pixelFormat, preset, profile, rateControlMode, sdr, tune, vbvFullnessBits, vbvSizeBits, widthPixels);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class H264CodecSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to H264CodecSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!H264CodecSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in H264CodecSettings is not found in the empty JSON string", H264CodecSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!H264CodecSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `H264CodecSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!H264CodecSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'H264CodecSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<H264CodecSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(H264CodecSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<H264CodecSettings>() {
           @Override
           public void write(JsonWriter out, H264CodecSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public H264CodecSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of H264CodecSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of H264CodecSettings
   * @throws IOException if the JSON string is invalid with respect to H264CodecSettings
   */
  public static H264CodecSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, H264CodecSettings.class);
  }

  /**
   * Convert an instance of H264CodecSettings to an JSON string
   *
   * @return JSON string
   */
