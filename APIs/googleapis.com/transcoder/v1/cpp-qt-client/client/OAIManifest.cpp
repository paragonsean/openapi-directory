...
OAIDashConfig OAIManifest::getDash() const {
    return m_dash;
}
void OAIManifest::setDash(const OAIDashConfig &dash) {
    m_dash = dash;
    m_dash_isSet = true;
}

bool OAIManifest::is_dash_Set() const{
    return m_dash_isSet;
}

bool OAIManifest::is_dash_Valid() const{
