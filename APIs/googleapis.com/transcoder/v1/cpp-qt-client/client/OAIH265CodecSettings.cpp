...
OAIH265CodecSettings::OAIH265CodecSettings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIH265CodecSettings::OAIH265CodecSettings() {
    this->initializeModel();
}

OAIH265CodecSettings::~OAIH265CodecSettings() {}

void OAIH265CodecSettings::initializeModel() {
...
void OAIH265CodecSettings::fromJson(QString jsonString) {
...
void OAIH265CodecSettings::fromJsonObject(QJsonObject json) {
    ...
    m_hdr10_isValid = ::OpenAPI::fromJsonValue(m_hdr10, json[QString("hdr10")]);
    m_hdr10_isSet = !json[QString("hdr10")].isNull() && m_hdr10_isValid;
...
QString OAIH265CodecSettings::asJson() const {
...
QJsonObject OAIH265CodecSettings::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_hdr10_isSet) {
        obj.insert(QString("hdr10"), ::OpenAPI::toJsonValue(m_hdr10));
    }
...
bool OAIH265CodecSettings::isAllowOpenGop() const {
    return m_allow_open_gop;
}
void OAIH265CodecSettings::setAllowOpenGop(const bool &allow_open_gop) {
    m_allow_open_gop = allow_open_gop;
    m_allow_open_gop_isSet = true;
}

bool OAIH265CodecSettings::is_allow_open_gop_Set() const{
    return m_allow_open_gop_isSet;
}

bool OAIH265CodecSettings::is_allow_open_gop_Valid() const{
    return m_allow_open_gop_isValid;
}

double OAIH265CodecSettings::getAqStrength() const {
    return m_aq_strength;
}
void OAIH265CodecSettings::setAqStrength(const double &aq_strength) {
    m_aq_strength = aq_strength;
    m_aq_strength_isSet = true;
}

bool OAIH265CodecSettings::is_aq_strength_Set() const{
    return m_aq_strength_isSet;
}

bool OAIH265CodecSettings::is_aq_strength_Valid() const{
    return m_aq_strength_isValid;
}

qint32 OAIH265CodecSettings::getBFrameCount() const {
    return m_b_frame_count;
}
void OAIH265CodecSettings::setBFrameCount(const qint32 &b_frame_count) {
    m_b_frame_count = b_frame_count;
    m_b_frame_count_isSet = true;
}

bool OAIH265CodecSettings::is_b_frame_count_Set() const{
    return m_b_frame_count_isSet;
}

bool OAIH265CodecSettings::is_b_frame_count_Valid() const{
    return m_b_frame_count_isValid;
}

bool OAIH265CodecSettings::isBPyramid() const {
    return m_b_pyramid;
}
void OAIH265CodecSettings::setBPyramid(const bool &b_pyramid) {
    m_b_pyramid = b_pyramid;
    m_b_pyramid_isSet = true;
}

bool OAIH265CodecSettings::is_b_pyramid_Set() const{
    return m_b_pyramid_isSet;
}

bool OAIH265CodecSettings::is_b_pyramid_Valid() const{
    return m_b_pyramid_isValid;
}

qint32 OAIH265CodecSettings::getBitrateBps() const {
    return m_bitrate_bps;
}
void OAIH265CodecSettings::setBitrateBps(const qint32 &bitrate_bps) {
    m_bitrate_bps = bitrate_bps;
    m_bitrate_bps_isSet = true;
}

bool OAIH265CodecSettings::is_bitrate_bps_Set() const{
    return m_bitrate_bps_isSet;
}

bool OAIH265CodecSettings::is_bitrate_bps_Valid() const{
    return m_bitrate_bps_isValid;
}

qint32 OAIH265CodecSettings::getCrfLevel() const {
    return m_crf_level;
}
void OAIH265CodecSettings::setCrfLevel(const qint32 &crf_level) {
    m_crf_level = crf_level;
    m_crf_level_isSet = true;
}

bool OAIH265CodecSettings::is_crf_level_Set() const{
    return m_crf_level_isSet;
}

bool OAIH265CodecSettings::is_crf_level_Valid() const{
    return m_crf_level_isValid;
}

bool OAIH265CodecSettings::isEnableTwoPass() const {
    return m_enable_two_pass;
}
void OAIH265CodecSettings::setEnableTwoPass(const bool &enable_two_pass) {
    m_enable_two_pass = enable_two_pass;
    m_enable_two_pass_isSet = true;
}

bool OAIH265CodecSettings::is_enable_two_pass_Set() const{
    return m_enable_two_pass_isSet;
}

bool OAIH265CodecSettings::is_enable_two_pass_Valid() const{
    return m_enable_two_pass_isValid;
}

double OAIH265CodecSettings::getFrameRate() const {
    return m_frame_rate;
}
void OAIH265CodecSettings::setFrameRate(const double &frame_rate) {
    m_frame_rate = frame_rate;
    m_frame_rate_isSet = true;
}

bool OAIH265CodecSettings::is_frame_rate_Set() const{
    return m_frame_rate_isSet;
}

bool OAIH265CodecSettings::is_frame_rate_Valid() const{
    return m_frame_rate_isValid;
}

QString OAIH265CodecSettings::getFrameRateConversionStrategy() const {
    return m_frame_rate_conversion_strategy;
}
void OAIH265CodecSettings::setFrameRateConversionStrategy(const QString &frame_rate_conversion_strategy) {
    m_frame_rate_conversion_strategy = frame_rate_conversion_strategy;
    m_frame_rate_conversion_strategy_isSet = true;
}

bool OAIH265CodecSettings::is_frame_rate_conversion_strategy_Set() const{
    return m_frame_rate_conversion_strategy_isSet;
}

bool OAIH265CodecSettings::is_frame_rate_conversion_strategy_Valid() const{
    return m_frame_rate_conversion_strategy_isValid;
}

QString OAIH265CodecSettings::getGopDuration() const {
    return m_gop_duration;
}
void OAIH265CodecSettings::setGopDuration(const QString &gop_duration) {
    m_gop_duration = gop_duration;
    m_gop_duration_isSet = true;
}

bool OAIH265CodecSettings::is_gop_duration_Set() const{
    return m_gop_duration_isSet;
}

bool OAIH265CodecSettings::is_gop_duration_Valid() const{
    return m_gop_duration_isValid;
}

qint32 OAIH265CodecSettings::getGopFrameCount() const {
    return m_gop_frame_count;
}
void OAIH265CodecSettings::setGopFrameCount(const qint32 &gop_frame_count) {
    m_gop_frame_count = gop_frame_count;
    m_gop_frame_count_isSet = true;
}

bool OAIH265CodecSettings::is_gop_frame_count_Set() const{
    return m_gop_frame_count_isSet;
}

bool OAIH265CodecSettings::is_gop_frame_count_Valid() const{
    return m_gop_frame_count_isValid;
}

OAIObject OAIH265CodecSettings::getHdr10() const {
    return m_hdr10;
}
void OAIH265CodecSettings::setHdr10(const OAIObject &hdr10) {
    m_hdr10 = hdr10;
    m_hdr10_isSet = true;
}

bool OAIH265CodecSettings::is_hdr10_Set() const{
    return m_hdr10_isSet;
}

bool OAIH265CodecSettings::is_hdr10_Valid() const{
    return m_hdr10_isValid;
}

qint32 OAIH265CodecSettings::getHeightPixels() const {
    return m_height_pixels;
}
void OAIH265CodecSettings::setHeightPixels(const qint32 &height_pixels) {
    m_height_pixels = height_pixels;
    m_height_pixels_isSet = true;
}

bool OAIH265CodecSettings::is_height_pixels_Set() const{
    return m_height_pixels_isSet;
}

bool OAIH265CodecSettings::is_height_pixels_Valid() const{
    return m_height_pixels_isValid;
}

OAIObject OAIH265CodecSettings::getHlg() const {
    return m_hlg;
}
void OAIH265CodecSettings::setHlg(const OAIObject &hlg) {
    m_hlg = hlg;
    m_hlg_isSet = true;
}

bool OAIH265CodecSettings::is_hlg_Set() const{
    return m_hlg_isSet;
}

bool OAIH265CodecSettings::is_hlg_Valid() const{
    return m_hlg_isValid;
}

QString OAIH265CodecSettings::getPixelFormat() const {
    return m_pixel_format;
}
void OAIH265CodecSettings::setPixelFormat(const QString &pixel_format) {
    m_pixel_format = pixel_format;
    m_pixel_format_isSet = true;
}

bool OAIH265CodecSettings::is_pixel_format_Set() const{
    return m_pixel_format_isSet;
}

bool OAIH265CodecSettings::is_pixel_format_Valid() const{
    return m_pixel_format_isValid;
}

QString OAIH265CodecSettings::getPreset() const {
    return m_preset;
}
void OAIH265CodecSettings::setPreset(const QString &preset) {
    m_preset = preset;
    m_preset_isSet = true;
}

bool OAIH265CodecSettings::is_preset_Set() const{
    return m_preset_isSet;
}

bool OAIH265CodecSettings::is_preset_Valid() const{
    return m_preset_isValid;
}

QString OAIH265CodecSettings::getProfile() const {
    return m_profile;
}
void OAIH265CodecSettings::setProfile(const QString &profile) {
    m_profile = profile;
    m_profile_isSet = true;
}

bool OAIH265CodecSettings::is_profile_Set() const{
    return m_profile_isSet;
}

bool OAIH265CodecSettings::is_profile_Valid() const{
    return m_profile_isValid;
}

QString OAIH265CodecSettings::getRateControlMode() const {
    return m_rate_control_mode;
}
void OAIH265CodecSettings::setRateControlMode(const QString &rate_control_mode) {
    m_rate_control_mode = rate_control_mode;
    m_rate_control_mode_isSet = true;
}

bool OAIH265CodecSettings::is_rate_control_mode_Set() const{
    return m_rate_control_mode_isSet;
}

bool OAIH265CodecSettings::is_rate_control_mode_Valid() const{
    return m_rate_control_mode_isValid;
}

OAIObject OAIH265CodecSettings::getSdr() const {
    return m_sdr;
}
void OAIH265CodecSettings::setSdr(const OAIObject &sdr) {
    m_sdr = sdr;
    m_sdr_isSet = true;
}

bool OAIH265CodecSettings::is_sdr_Set() const{
    return m_sdr_isSet;
}

bool OAIH265CodecSettings::is_sdr_Valid() const{
    return m_sdr_isValid;
}

QString OAIH265CodecSettings::getTune() const {
    return m_tune;
}
void OAIH265CodecSettings::setTune(const QString &tune) {
    m_tune = tune;
    m_tune_isSet = true;
}

bool OAIH265CodecSettings::is_tune_Set() const{
    return m_tune_isSet;
}

bool OAIH265CodecSettings::is_tune_Valid() const{
    return m_tune_isValid;
}

qint32 OAIH265CodecSettings::getVbvFullnessBits() const {
    return m_vbv_fullness_bits;
}
void OAIH265CodecSettings::setVbvFullnessBits(const qint32 &vbv_fullness_bits) {
    m_vbv_fullness_bits = vbv_fullness_bits;
    m_vbv_fullness_bits_isSet = true;
}

bool OAIH265CodecSettings::is_vbv_fullness_bits_Set() const{
    return m_vbv_fullness_bits_isSet;
}

bool OAIH265CodecSettings::is_vbv_fullness_bits_Valid() const{
    return m_vbv_fullness_bits_isValid;
}

qint32 OAIH265CodecSettings::getVbvSizeBits() const {
    return m_vbv_size_bits;
}
void OAIH265CodecSettings::setVbvSizeBits(const qint32 &vbv_size_bits) {
    m_vbv_size_bits = vbv_size_bits;
    m_vbv_size_bits_isSet = true;
}

bool OAIH265CodecSettings::is_vbv_size_bits_Set() const{
    return m_vbv_size_bits_isSet;
}

bool OAIH265CodecSettings::is_vbv_size_bits_Valid() const{
    return m_vbv_size_bits_isValid;
}

qint32 OAIH265CodecSettings::getWidthPixels() const {
    return m_width_pixels;
}
void OAIH265CodecSettings::setWidthPixels(const qint32 &width_pixels) {
    m_width_pixels = width_pixels;
    m_width_pixels_isSet = true;
}

bool OAIH265CodecSettings::is_width_pixels_Set() const{
    return m_width_pixels_isSet;
}

bool OAIH265CodecSettings::is_width_pixels_Valid() const{
    return m_width_pixels_isValid;
}

bool OAIH265CodecSettings::isSet() const {
...
bool OAIH265CodecSettings::isValid() const {
