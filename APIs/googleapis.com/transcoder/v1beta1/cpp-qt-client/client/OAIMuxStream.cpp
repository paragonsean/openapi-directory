...
OAIEncryption OAIMuxStream::getEncryption() const {
    return m_encryption;
}
void OAIMuxStream::setEncryption(const OAIEncryption &encryption) {
    m_encryption = encryption;
    m_encryption_isSet = true;
}

bool OAIMuxStream::is_encryption_Set() const{
    return m_encryption_isSet;
}

bool OAIMuxStream::is_encryption_Valid() const{
