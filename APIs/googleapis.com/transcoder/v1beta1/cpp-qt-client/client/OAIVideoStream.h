...
public:
    ...
    QString getEntropyCoder() const;
    void setEntropyCoder(const QString &entropy_coder);
    bool is_entropy_coder_Set() const;
    bool is_entropy_coder_Valid() const;
...
private:
    ...
    QString m_entropy_coder;
    bool m_entropy_coder_isSet;
    bool m_entropy_coder_isValid;
