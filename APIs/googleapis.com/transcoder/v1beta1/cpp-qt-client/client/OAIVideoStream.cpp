...
bool OAIVideoStream::isAllowOpenGop() const {
    return m_allow_open_gop;
}
void OAIVideoStream::setAllowOpenGop(const bool &allow_open_gop) {
    m_allow_open_gop = allow_open_gop;
    m_allow_open_gop_isSet = true;
}

bool OAIVideoStream::is_allow_open_gop_Set() const{
    return m_allow_open_gop_isSet;
}

bool OAIVideoStream::is_allow_open_gop_Valid() const{
    return m_allow_open_gop_isValid;
}

double OAIVideoStream::getAqStrength() const {
    return m_aq_strength;
}
void OAIVideoStream::setAqStrength(const double &aq_strength) {
    m_aq_strength = aq_strength;
    m_aq_strength_isSet = true;
}

bool OAIVideoStream::is_aq_strength_Set() const{
    return m_aq_strength_isSet;
}

bool OAIVideoStream::is_aq_strength_Valid() const{
    return m_aq_strength_isValid;
}

qint32 OAIVideoStream::getBFrameCount() const {
    return m_b_frame_count;
}
void OAIVideoStream::setBFrameCount(const qint32 &b_frame_count) {
    m_b_frame_count = b_frame_count;
    m_b_frame_count_isSet = true;
}

bool OAIVideoStream::is_b_frame_count_Set() const{
    return m_b_frame_count_isSet;
}

bool OAIVideoStream::is_b_frame_count_Valid() const{
    return m_b_frame_count_isValid;
}

bool OAIVideoStream::isBPyramid() const {
    return m_b_pyramid;
}
void OAIVideoStream::setBPyramid(const bool &b_pyramid) {
    m_b_pyramid = b_pyramid;
    m_b_pyramid_isSet = true;
}

bool OAIVideoStream::is_b_pyramid_Set() const{
    return m_b_pyramid_isSet;
}

bool OAIVideoStream::is_b_pyramid_Valid() const{
    return m_b_pyramid_isValid;
}

qint32 OAIVideoStream::getBitrateBps() const {
    return m_bitrate_bps;
}
void OAIVideoStream::setBitrateBps(const qint32 &bitrate_bps) {
    m_bitrate_bps = bitrate_bps;
    m_bitrate_bps_isSet = true;
}

bool OAIVideoStream::is_bitrate_bps_Set() const{
    return m_bitrate_bps_isSet;
}

bool OAIVideoStream::is_bitrate_bps_Valid() const{
    return m_bitrate_bps_isValid;
}

QString OAIVideoStream::getCodec() const {
    return m_codec;
}
void OAIVideoStream::setCodec(const QString &codec) {
    m_codec = codec;
    m_codec_isSet = true;
}

bool OAIVideoStream::is_codec_Set() const{
    return m_codec_isSet;
}

bool OAIVideoStream::is_codec_Valid() const{
    return m_codec_isValid;
}

qint32 OAIVideoStream::getCrfLevel() const {
    return m_crf_level;
}
void OAIVideoStream::setCrfLevel(const qint32 &crf_level) {
    m_crf_level = crf_level;
    m_crf_level_isSet = true;
}

bool OAIVideoStream::is_crf_level_Set() const{
    return m_crf_level_isSet;
}

bool OAIVideoStream::is_crf_level_Valid() const{
    return m_crf_level_isValid;
}

bool OAIVideoStream::isEnableTwoPass() const {
    return m_enable_two_pass;
}
void OAIVideoStream::setEnableTwoPass(const bool &enable_two_pass) {
    m_enable_two_pass = enable_two_pass;
    m_enable_two_pass_isSet = true;
}

bool OAIVideoStream::is_enable_two_pass_Set() const{
    return m_enable_two_pass_isSet;
}

bool OAIVideoStream::is_enable_two_pass_Valid() const{
    return m_enable_two_pass_isValid;
}

QString OAIVideoStream::getEntropyCoder() const {
    return m_entropy_coder;
}
void OAIVideoStream::setEntropyCoder(const QString &entropy_coder) {
    m_entropy_coder = entropy_coder;
    m_entropy_coder_isSet = true;
}

bool OAIVideoStream::is_entropy_coder_Set() const{
    return m_entropy_coder_isSet;
}

bool OAIVideoStream::is_entropy_coder_Valid() const{
    return m_entropy_coder_isValid;
}

double OAIVideoStream::getFrameRate() const {
    return m_frame_rate;
}
void OAIVideoStream::setFrameRate(const double &frame_rate) {
    m_frame_rate = frame_rate;
    m_frame_rate_isSet = true;
}

bool OAIVideoStream::is_frame_rate_Set() const{
    return m_frame_rate_isSet;
}

bool OAIVideoStream::is_frame_rate_Valid() const{
    return m_frame_rate_isValid;
}

QString OAIVideoStream::getGopDuration() const {
    return m_gop_duration;
}
void OAIVideoStream::setGopDuration(const QString &gop_duration) {
    m_gop_duration = gop_duration;
    m_gop_duration_isSet = true;
}

bool OAIVideoStream::is_gop_duration_Set() const{
    return m_gop_duration_isSet;
}

bool OAIVideoStream::is_gop_duration_Valid() const{
    return m_gop_duration_isValid;
}

qint32 OAIVideoStream::getGopFrameCount() const {
    return m_gop_frame_count;
}
void OAIVideoStream::setGopFrameCount(const qint32 &gop_frame_count) {
    m_gop_frame_count = gop_frame_count;
    m_gop_frame_count_isSet = true;
}

bool OAIVideoStream::is_gop_frame_count_Set() const{
    return m_gop_frame_count_isSet;
}

bool OAIVideoStream::is_gop_frame_count_Valid() const{
    return m_gop_frame_count_isValid;
}

qint32 OAIVideoStream::getHeightPixels() const {
    return m_height_pixels;
}
void OAIVideoStream::setHeightPixels(const qint32 &height_pixels) {
    m_height_pixels = height_pixels;
    m_height_pixels_isSet = true;
}

bool OAIVideoStream::is_height_pixels_Set() const{
    return m_height_pixels_isSet;
}

bool OAIVideoStream::is_height_pixels_Valid() const{
    return m_height_pixels_isValid;
}

QString OAIVideoStream::getPixelFormat() const {
    return m_pixel_format;
}
void OAIVideoStream::setPixelFormat(const QString &pixel_format) {
    m_pixel_format = pixel_format;
    m_pixel_format_isSet = true;
}

bool OAIVideoStream::is_pixel_format_Set() const{
    return m_pixel_format_isSet;
}

bool OAIVideoStream::is_pixel_format_Valid() const{
    return m_pixel_format_isValid;
}

QString OAIVideoStream::getPreset() const {
    return m_preset;
}
void OAIVideoStream::setPreset(const QString &preset) {
    m_preset = preset;
    m_preset_isSet = true;
}

bool OAIVideoStream::is_preset_Set() const{
    return m_preset_isSet;
}

bool OAIVideoStream::is_preset_Valid() const{
    return m_preset_isValid;
}

QString OAIVideoStream::getProfile() const {
    return m_profile;
}
void OAIVideoStream::setProfile(const QString &profile) {
    m_profile = profile;
    m_profile_isSet = true;
}

bool OAIVideoStream::is_profile_Set() const{
    return m_profile_isSet;
}

bool OAIVideoStream::is_profile_Valid() const{
    return m_profile_isValid;
}

QString OAIVideoStream::getRateControlMode() const {
    return m_rate_control_mode;
}
void OAIVideoStream::setRateControlMode(const QString &rate_control_mode) {
    m_rate_control_mode = rate_control_mode;
    m_rate_control_mode_isSet = true;
}

bool OAIVideoStream::is_rate_control_mode_Set() const{
    return m_rate_control_mode_isSet;
}

bool OAIVideoStream::is_rate_control_mode_Valid() const{
    return m_rate_control_mode_isValid;
}

QString OAIVideoStream::getTune() const {
    return m_tune;
}
void OAIVideoStream::setTune(const QString &tune) {
    m_tune = tune;
    m_tune_isSet = true;
}

bool OAIVideoStream::is_tune_Set() const{
    return m_tune_isSet;
}

bool OAIVideoStream::is_tune_Valid() const{
    return m_tune_isValid;
}

qint32 OAIVideoStream::getVbvFullnessBits() const {
    return m_vbv_fullness_bits;
}
void OAIVideoStream::setVbvFullnessBits(const qint32 &vbv_fullness_bits) {
    m_vbv_fullness_bits = vbv_fullness_bits;
    m_vbv_fullness_bits_isSet = true;
}

bool OAIVideoStream::is_vbv_fullness_bits_Set() const{
    return m_vbv_fullness_bits_isSet;
}

bool OAIVideoStream::is_vbv_fullness_bits_Valid() const{
    return m_vbv_fullness_bits_isValid;
}

qint32 OAIVideoStream::getVbvSizeBits() const {
    return m_vbv_size_bits;
}
void OAIVideoStream::setVbvSizeBits(const qint32 &vbv_size_bits) {
    m_vbv_size_bits = vbv_size_bits;
    m_vbv_size_bits_isSet = true;
}

bool OAIVideoStream::is_vbv_size_bits_Set() const{
    return m_vbv_size_bits_isSet;
}

bool OAIVideoStream::is_vbv_size_bits_Valid() const{
    return m_vbv_size_bits_isValid;
}

qint32 OAIVideoStream::getWidthPixels() const {
    return m_width_pixels;
}
void OAIVideoStream::setWidthPixels(const qint32 &width_pixels) {
    m_width_pixels = width_pixels;
    m_width_pixels_isSet = true;
}

bool OAIVideoStream::is_width_pixels_Set() const{
    return m_width_pixels_isSet;
}

bool OAIVideoStream::is_width_pixels_Valid() const{
