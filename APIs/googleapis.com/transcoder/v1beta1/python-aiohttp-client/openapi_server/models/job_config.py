...
class JobConfig(Model):
    ...
    def __init__(self, ad_breaks: List[AdBreak]=None, edit_list: List[EditAtom]=None, elementary_streams: List[ElementaryStream]=None, inputs: List[Input]=None, manifests: List[Manifest]=None, mux_streams: List[MuxStream]=None, output: Output=None, overlays: List[Overlay]=None, pubsub_destination: PubsubDestination=None, sprite_sheets: List[SpriteSheet]=None):
