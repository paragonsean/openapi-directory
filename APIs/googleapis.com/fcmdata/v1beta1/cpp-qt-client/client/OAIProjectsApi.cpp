...
void OAIProjectsApi::initializeServerConfigs() {
    ...
    QUrl("https://fcmdata.googleapis.com/"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("fcmdata_projects_androidApps_deliveryData_list", defaultConf);
    _serverIndices.insert("fcmdata_projects_androidApps_deliveryData_list", 0);
}
...
void OAIProjectsApi::fcmdata_projects_androidApps_deliveryData_list(const QString &parent, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &page_token) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::fcmdata_projects_androidApps_deliveryData_listCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::fcmdata_projects_androidApps_deliveryData_listCallback);
...
void OAIProjectsApi::fcmdata_projects_androidApps_deliveryData_listCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIGoogleFirebaseFcmDataV1beta1ListAndroidDeliveryDataResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT fcmdata_projects_androidApps_deliveryData_listSignal(output);
        Q_EMIT fcmdata_projects_androidApps_deliveryData_listSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT fcmdata_projects_androidApps_deliveryData_listSignalE(output, error_type, error_str);
        Q_EMIT fcmdata_projects_androidApps_deliveryData_listSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT fcmdata_projects_androidApps_deliveryData_listSignalError(output, error_type, error_str);
        Q_EMIT fcmdata_projects_androidApps_deliveryData_listSignalErrorFull(worker, error_type, error_str);
    }
}
