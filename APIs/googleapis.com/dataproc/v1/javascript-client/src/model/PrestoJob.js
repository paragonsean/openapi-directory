...
/**
 * The PrestoJob model module.
 * @module model/PrestoJob
 * @version v1
 */
class PrestoJob {
    /**
     * Constructs a new <code>PrestoJob</code>.
     * A Dataproc job for running Presto (https://prestosql.io/) queries. IMPORTANT: The Dataproc Presto Optional Component (https://cloud.google.com/dataproc/docs/concepts/components/presto) must be enabled when the cluster is created to submit a Presto job to the cluster.
     * @alias module:model/PrestoJob
     */
    constructor() { 
        
        PrestoJob.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PrestoJob</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PrestoJob} obj Optional instance to populate.
     * @return {module:model/PrestoJob} The populated <code>PrestoJob</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PrestoJob();
    ...
    /**
     * Validates the JSON data with respect to <code>PrestoJob</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PrestoJob</code>.
     */
 ...
 */
PrestoJob.prototype['clientTags'] = undefined;

/**
 * Optional. Whether to continue executing queries if a query fails. The default value is false. Setting to true can be useful when executing independent parallel queries.
 * @member {Boolean} continueOnFailure
 */
PrestoJob.prototype['continueOnFailure'] = undefined;

/**
 * @member {module:model/LoggingConfig} loggingConfig
 */
PrestoJob.prototype['loggingConfig'] = undefined;

/**
 * Optional. The format in which query output will be displayed. See the Presto documentation for supported output formats
 * @member {String} outputFormat
 */
PrestoJob.prototype['outputFormat'] = undefined;

/**
 * Optional. A mapping of property names to values. Used to set Presto session properties (https://prestodb.io/docs/current/sql/set-session.html) Equivalent to using the --session flag in the Presto CLI
 * @member {Object.<String, String>} properties
 */
PrestoJob.prototype['properties'] = undefined;

/**
 * The HCFS URI of the script that contains SQL queries.
 * @member {String} queryFileUri
 */
PrestoJob.prototype['queryFileUri'] = undefined;

/**
 * @member {module:model/QueryList} queryList
 */
PrestoJob.prototype['queryList'] = undefined;
