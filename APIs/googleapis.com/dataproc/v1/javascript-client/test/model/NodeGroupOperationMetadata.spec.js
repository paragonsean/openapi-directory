...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudDataprocApi.NodeGroupOperationMetadata();
  });
  ...
  describe('NodeGroupOperationMetadata', function() {
    it('should create an instance of NodeGroupOperationMetadata', function() {
      // uncomment below and update the code to test NodeGroupOperationMetadata
      //var instance = new CloudDataprocApi.NodeGroupOperationMetadata();
      //expect(instance).to.be.a(CloudDataprocApi.NodeGroupOperationMetadata);
    });
    ...
    it('should have the property nodeGroupId (base name: "nodeGroupId")', function() {
      // uncomment below and update the code to test the property nodeGroupId
      //var instance = new CloudDataprocApi.NodeGroupOperationMetadata();
      //expect(instance).to.be();
    });
