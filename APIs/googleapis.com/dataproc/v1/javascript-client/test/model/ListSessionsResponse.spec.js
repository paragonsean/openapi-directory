...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudDataprocApi.ListSessionsResponse();
  });
  ...
  describe('ListSessionsResponse', function() {
    it('should create an instance of ListSessionsResponse', function() {
      ...
      //var instance = new CloudDataprocApi.ListSessionsResponse();
      //expect(instance).to.be.a(CloudDataprocApi.ListSessionsResponse);
    });
