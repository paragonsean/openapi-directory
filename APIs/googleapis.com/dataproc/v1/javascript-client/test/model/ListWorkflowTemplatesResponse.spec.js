...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudDataprocApi.ListWorkflowTemplatesResponse();
  });
  ...
  describe('ListWorkflowTemplatesResponse', function() {
    it('should create an instance of ListWorkflowTemplatesResponse', function() {
      // uncomment below and update the code to test ListWorkflowTemplatesResponse
      //var instance = new CloudDataprocApi.ListWorkflowTemplatesResponse();
      //expect(instance).to.be.a(CloudDataprocApi.ListWorkflowTemplatesResponse);
    });
