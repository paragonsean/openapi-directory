...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudDataprocApi.ListClustersResponse();
  });
  ...
  describe('ListClustersResponse', function() {
    it('should create an instance of ListClustersResponse', function() {
      ...
      //var instance = new CloudDataprocApi.ListClustersResponse();
      //expect(instance).to.be.a(CloudDataprocApi.ListClustersResponse);
    });
