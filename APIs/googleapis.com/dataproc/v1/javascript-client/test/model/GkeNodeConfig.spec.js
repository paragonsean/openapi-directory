...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudDataprocApi.GkeNodeConfig();
  });
  ...
  describe('GkeNodeConfig', function() {
    it('should create an instance of GkeNodeConfig', function() {
      // uncomment below and update the code to test GkeNodeConfig
      //var instance = new CloudDataprocApi.GkeNodeConfig();
      //expect(instance).to.be.a(CloudDataprocApi.GkeNodeConfig);
    });
