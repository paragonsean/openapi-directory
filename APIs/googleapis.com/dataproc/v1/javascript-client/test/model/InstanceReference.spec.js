...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudDataprocApi.InstanceReference();
  });
  ...
  describe('InstanceReference', function() {
    it('should create an instance of InstanceReference', function() {
      // uncomment below and update the code to test InstanceReference
      //var instance = new CloudDataprocApi.InstanceReference();
      //expect(instance).to.be.a(CloudDataprocApi.InstanceReference);
    });
    ...
    it('should have the property publicEciesKey (base name: "publicEciesKey")', function() {
      // uncomment below and update the code to test the property publicEciesKey
      //var instance = new CloudDataprocApi.InstanceReference();
      //expect(instance).to.be();
    });
