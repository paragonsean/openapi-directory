...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudDataprocApi.ListOperationsResponse();
  });
  ...
  describe('ListOperationsResponse', function() {
    it('should create an instance of ListOperationsResponse', function() {
      ...
      //var instance = new CloudDataprocApi.ListOperationsResponse();
      //expect(instance).to.be.a(CloudDataprocApi.ListOperationsResponse);
    });
