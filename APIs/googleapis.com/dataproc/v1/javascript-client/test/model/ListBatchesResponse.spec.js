...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudDataprocApi.ListBatchesResponse();
  });
  ...
  describe('ListBatchesResponse', function() {
    it('should create an instance of ListBatchesResponse', function() {
      // uncomment below and update the code to test ListBatchesResponse
      //var instance = new CloudDataprocApi.ListBatchesResponse();
      //expect(instance).to.be.a(CloudDataprocApi.ListBatchesResponse);
    });
