...
**state** | **String** | Output only. The state of the batch. | [optional] [readonly] 
**stateHistory** | [**[StateHistory]**](StateHistory.md) | Output only. Historical state information for the batch. | [optional] [readonly] 
