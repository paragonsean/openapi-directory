...
**state** | **String** | Output only. A state of the session. | [optional] [readonly] 
**stateHistory** | [**[SessionStateHistory]**](SessionStateHistory.md) | Output only. Historical state information for the session. | [optional] [readonly] 
