# CloudDataprocApi.WorkflowMetadata
...
**parameters** | **{String: String}** | Map from parameter names to values that were used for those parameters. | [optional] 
**startTime** | **String** | Output only. Workflow start time. | [optional] [readonly] 
**state** | **String** | Output only. The workflow state. | [optional] [readonly] 
...
**version** | **Number** | Output only. The version of template at the time of workflow instantiation. | [optional] [readonly] 
