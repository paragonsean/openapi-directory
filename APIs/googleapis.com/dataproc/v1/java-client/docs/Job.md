...
|**statusHistory** | [**List&lt;JobStatus&gt;**](JobStatus.md) | Output only. The previous job status. |  [optional] [readonly] |
|**trinoJob** | [**TrinoJob**](TrinoJob.md) |  |  [optional] |
|**yarnApplications** | [**List&lt;YarnApplication&gt;**](YarnApplication.md) | Output only. The collection of YARN applications spun up by this job.Beta Feature: This report is available for testing purposes only. It might be changed before final release. |  [optional] [readonly] |
