...
|**metadata** | **Map&lt;String, String&gt;** | Optional. The Compute Engine metadata entries to add to all instances (see Project and instance metadata (https://cloud.google.com/compute/docs/storing-retrieving-metadata#project_and_instance_metadata)). |  [optional] |
...
|**privateIpv6GoogleAccess** | [**PrivateIpv6GoogleAccessEnum**](#PrivateIpv6GoogleAccessEnum) | Optional. The type of IPv6 access for a cluster. |  [optional] |
...
|**tags** | **List&lt;String&gt;** | The Compute Engine tags to add to all instances (see Tagging instances (https://cloud.google.com/compute/docs/label-or-tag-resources#tags)). |  [optional] |
