...
|------------ | ------------- | ------------- | -------------|
|**acceleratorCount** | **String** | The number of accelerator cards exposed to an instance. |  [optional] |
|**acceleratorType** | **String** | The accelerator type resource namename (see GPUs on Compute Engine). |  [optional] |
