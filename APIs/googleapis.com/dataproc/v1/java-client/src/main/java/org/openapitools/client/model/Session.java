...
public class Session {
  ...
  private List<SessionStateHistory> stateHistory = new ArrayList<>();
  ...
  public Session environmentConfig(EnvironmentConfig environmentConfig) {
  ...
  public Session jupyterSession(JupyterConfig jupyterSession) {
  ...
  public Session runtimeConfig(RuntimeConfig runtimeConfig) {
  ...
  public Session runtimeInfo(RuntimeInfo runtimeInfo) {
  ...
  public Session sessionTemplate(String sessionTemplate) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.createTime, session.createTime) &&
        Objects.equals(this.creator, session.creator) &&
        Objects.equals(this.environmentConfig, session.environmentConfig) &&
        Objects.equals(this.jupyterSession, session.jupyterSession) &&
        Objects.equals(this.labels, session.labels) &&
        Objects.equals(this.name, session.name) &&
        Objects.equals(this.runtimeConfig, session.runtimeConfig) &&
        Objects.equals(this.runtimeInfo, session.runtimeInfo) &&
        Objects.equals(this.sessionTemplate, session.sessionTemplate) &&
        Objects.equals(this.state, session.state) &&
        Objects.equals(this.stateHistory, session.stateHistory) &&
        Objects.equals(this.stateMessage, session.stateMessage) &&
        Objects.equals(this.stateTime, session.stateTime) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(createTime, creator, environmentConfig, jupyterSession, labels, name, runtimeConfig, runtimeInfo, sessionTemplate, state, stateHistory, stateMessage, stateTime, user, uuid);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("sessionTemplate") != null && !jsonObj.get("sessionTemplate").isJsonNull()) && !jsonObj.get("sessionTemplate").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `sessionTemplate` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sessionTemplate").toString()));
      }
      ...
      if (jsonObj.get("stateHistory") != null && !jsonObj.get("stateHistory").isJsonNull()) {
        ...
        if (jsonArraystateHistory != null) {
          ...
          for (int i = 0; i < jsonArraystateHistory.size(); i++) {
            SessionStateHistory.validateJsonElement(jsonArraystateHistory.get(i));
          };
        }
      }
