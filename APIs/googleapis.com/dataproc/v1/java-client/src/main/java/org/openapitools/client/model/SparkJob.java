...
public class SparkJob {
  ...
  public SparkJob archiveUris(List<String> archiveUris) {
    this.archiveUris = archiveUris;
    return this;
  }

  public SparkJob addArchiveUrisItem(String archiveUrisItem) {
  ...
  public SparkJob args(List<String> args) {
    this.args = args;
    return this;
  }

  public SparkJob addArgsItem(String argsItem) {
    if (this.args == null) {
  ...
  public SparkJob fileUris(List<String> fileUris) {
    this.fileUris = fileUris;
    return this;
  }

  public SparkJob addFileUrisItem(String fileUrisItem) {
  ...
  public SparkJob jarFileUris(List<String> jarFileUris) {
    this.jarFileUris = jarFileUris;
    return this;
  }

  public SparkJob addJarFileUrisItem(String jarFileUrisItem) {
  ...
  public SparkJob loggingConfig(LoggingConfig loggingConfig) {
  ...
  public SparkJob mainClass(String mainClass) {
  ...
  public SparkJob mainJarFileUri(String mainJarFileUri) {
  ...
  public SparkJob properties(Map<String, String> properties) {
    this.properties = properties;
    return this;
  }

  public SparkJob putPropertiesItem(String key, String propertiesItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.archiveUris, sparkJob.archiveUris) &&
        Objects.equals(this.args, sparkJob.args) &&
        Objects.equals(this.fileUris, sparkJob.fileUris) &&
        Objects.equals(this.jarFileUris, sparkJob.jarFileUris) &&
        Objects.equals(this.loggingConfig, sparkJob.loggingConfig) &&
        Objects.equals(this.mainClass, sparkJob.mainClass) &&
        Objects.equals(this.mainJarFileUri, sparkJob.mainJarFileUri) &&
        Objects.equals(this.properties, sparkJob.properties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SparkJob
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SparkJob.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SparkJob is not found in the empty JSON string", SparkJob.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SparkJob.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SparkJob` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SparkJob.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SparkJob' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SparkJob> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SparkJob.class));

       return (TypeAdapter<T>) new TypeAdapter<SparkJob>() {
           @Override
           public void write(JsonWriter out, SparkJob value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SparkJob read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SparkJob given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SparkJob
   * @throws IOException if the JSON string is invalid with respect to SparkJob
   */
  public static SparkJob fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SparkJob.class);
  }

  /**
   * Convert an instance of SparkJob to an JSON string
   *
   * @return JSON string
   */
