...
bool OAIShieldedInstanceConfig::isEnableVtpm() const {
    return m_enable_vtpm;
}
void OAIShieldedInstanceConfig::setEnableVtpm(const bool &enable_vtpm) {
    m_enable_vtpm = enable_vtpm;
    m_enable_vtpm_isSet = true;
}

bool OAIShieldedInstanceConfig::is_enable_vtpm_Set() const{
    return m_enable_vtpm_isSet;
}

bool OAIShieldedInstanceConfig::is_enable_vtpm_Valid() const{
