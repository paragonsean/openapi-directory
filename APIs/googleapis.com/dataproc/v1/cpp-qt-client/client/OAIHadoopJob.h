...
#ifndef OAIHadoopJob_H
#define OAIHadoopJob_H
...
class OAIHadoopJob : public OAIObject {
public:
    OAIHadoopJob();
    OAIHadoopJob(QString json);
    ~OAIHadoopJob() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHadoopJob)

#endif // OAIHadoopJob_H
