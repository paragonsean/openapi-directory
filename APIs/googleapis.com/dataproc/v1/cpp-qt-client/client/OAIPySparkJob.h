...
#ifndef OAIPySparkJob_H
#define OAIPySparkJob_H
...
class OAIPySparkJob : public OAIObject {
public:
    OAIPySparkJob();
    OAIPySparkJob(QString json);
    ~OAIPySparkJob() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPySparkJob)

#endif // OAIPySparkJob_H
