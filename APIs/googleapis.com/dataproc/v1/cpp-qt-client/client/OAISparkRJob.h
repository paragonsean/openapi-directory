...
#ifndef OAISparkRJob_H
#define OAISparkRJob_H
...
class OAISparkRJob : public OAIObject {
public:
    OAISparkRJob();
    OAISparkRJob(QString json);
    ~OAISparkRJob() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISparkRJob)

#endif // OAISparkRJob_H
