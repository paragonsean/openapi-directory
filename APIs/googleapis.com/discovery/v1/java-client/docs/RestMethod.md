...
|**parameterOrder** | **List&lt;String&gt;** | Ordered list of required parameters, serves as a hint to clients on how to structure their method signatures. The array is ordered such that the \&quot;most-significant\&quot; parameter appears first. |  [optional] |
|**parameters** | [**Map&lt;String, JsonSchema&gt;**](JsonSchema.md) | Details for all parameters in this method. |  [optional] |
...
|**scopes** | **List&lt;String&gt;** | OAuth 2.0 scopes applicable to this method. |  [optional] |
