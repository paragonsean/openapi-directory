...
|**discoveryVersion** | **String** | Indicate the version of the Discovery API used to generate this doc. |  [optional] |
...
|**features** | **List&lt;String&gt;** | A list of supported features for this API. |  [optional] |
|**icons** | [**DirectoryListItemsInnerIcons**](DirectoryListItemsInnerIcons.md) |  |  [optional] |
|**id** | **String** | The ID of this API. |  [optional] |
|**kind** | **String** | The kind for this response. |  [optional] |
|**labels** | **List&lt;String&gt;** | Labels for the status of this API, such as labs or deprecated. |  [optional] |
|**methods** | [**Map&lt;String, RestMethod&gt;**](RestMethod.md) | API-level methods for this API. |  [optional] |
...
|**parameters** | [**Map&lt;String, JsonSchema&gt;**](JsonSchema.md) | Common parameters that apply across all apis. |  [optional] |
|**protocol** | **String** | The protocol described by this document. |  [optional] |
|**resources** | [**Map&lt;String, RestResource&gt;**](RestResource.md) | The resources in this API. |  [optional] |
|**revision** | **String** | The version of this API. |  [optional] |
|**rootUrl** | **String** | The root URL under which all API services live. |  [optional] |
|**schemas** | [**Map&lt;String, JsonSchema&gt;**](JsonSchema.md) | The schemas for this API. |  [optional] |
