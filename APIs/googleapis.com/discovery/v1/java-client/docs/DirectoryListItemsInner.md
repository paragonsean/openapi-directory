...
|**discoveryLink** | **String** | A link to the discovery document. |  [optional] |
|**discoveryRestUrl** | **String** | The URL for the discovery REST document. |  [optional] |
...
|**preferred** | **Boolean** | True if this version is the preferred version to use. |  [optional] |
