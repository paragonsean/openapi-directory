...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiDiscoveryService.RestMethodMediaUpload();
  });
  ...
  describe('RestMethodMediaUpload', function() {
    it('should create an instance of RestMethodMediaUpload', function() {
      // uncomment below and update the code to test RestMethodMediaUpload
      //var instance = new ApiDiscoveryService.RestMethodMediaUpload();
      //expect(instance).to.be.a(ApiDiscoveryService.RestMethodMediaUpload);
    });
