...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AppsScriptApi.ListDeploymentsResponse();
  });
  ...
  describe('ListDeploymentsResponse', function() {
    it('should create an instance of ListDeploymentsResponse', function() {
      ...
      //var instance = new AppsScriptApi.ListDeploymentsResponse();
      //expect(instance).to.be.a(AppsScriptApi.ListDeploymentsResponse);
    });
