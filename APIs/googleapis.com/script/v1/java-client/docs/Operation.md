...
|------------ | ------------- | ------------- | -------------|
|**done** | **Boolean** | This field indicates whether the script execution has completed. A completed execution has a populated &#x60;response&#x60; field containing the ExecutionResponse from function that was executed. |  [optional] |
|**error** | [**Status**](Status.md) |  |  [optional] |
|**response** | **Map&lt;String, Object&gt;** | If the script function returns successfully, this field contains an ExecutionResponse object with the function&#39;s return value. |  [optional] |
