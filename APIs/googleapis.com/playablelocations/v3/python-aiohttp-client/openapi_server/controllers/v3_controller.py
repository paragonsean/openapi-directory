...
async def playablelocations_log_impressions(request: web.Request, xgafv=None, access_token=None, alt=None, param_callback=None, fields=None, key=None, oauth_token=None, pretty_print=None, quota_user=None, upload_protocol=None, upload_type=None, body=None) -> web.Response:
    ...
    """
    body = GoogleMapsPlayablelocationsV3LogImpressionsRequest.from_dict(body)
    return web.Response(status=200)


async def playablelocations_log_player_reports(request: web.Request, xgafv=None, access_token=None, alt=None, param_callback=None, fields=None, key=None, oauth_token=None, pretty_print=None, quota_user=None, upload_protocol=None, upload_type=None, body=None) -> web.Response:
    ...
    """
    body = GoogleMapsPlayablelocationsV3LogPlayerReportsRequest.from_dict(body)
    return web.Response(status=200)


async def playablelocations_sample_playable_locations(request: web.Request, xgafv=None, access_token=None, alt=None, param_callback=None, fields=None, key=None, oauth_token=None, pretty_print=None, quota_user=None, upload_protocol=None, upload_type=None, body=None) -> web.Response:
    ...
    """
    body = GoogleMapsPlayablelocationsV3SamplePlayableLocationsRequest.from_dict(body)
    return web.Response(status=200)
