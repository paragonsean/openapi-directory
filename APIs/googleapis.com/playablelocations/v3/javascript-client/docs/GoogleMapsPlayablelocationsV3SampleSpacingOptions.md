# PlayableLocationsApi.GoogleMapsPlayablelocationsV3SampleSpacingOptions
...
* `POINT_TYPE_UNSPECIFIED` (value: `"POINT_TYPE_UNSPECIFIED"`)

* `CENTER_POINT` (value: `"CENTER_POINT"`)

* `SNAPPED_POINT` (value: `"SNAPPED_POINT"`)
