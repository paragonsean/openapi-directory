...
QString OAINote::getNoteId() const {
    return m_note_id;
}
void OAINote::setNoteId(const QString &note_id) {
    m_note_id = note_id;
    m_note_id_isSet = true;
}

bool OAINote::is_note_id_Set() const{
    return m_note_id_isSet;
}

bool OAINote::is_note_id_Valid() const{
    return m_note_id_isValid;
}

QString OAINote::getProposalRevision() const {
    return m_proposal_revision;
}
void OAINote::setProposalRevision(const QString &proposal_revision) {
    m_proposal_revision = proposal_revision;
    m_proposal_revision_isSet = true;
}

bool OAINote::is_proposal_revision_Set() const{
    return m_proposal_revision_isSet;
}

bool OAINote::is_proposal_revision_Valid() const{
