# AdExchangeBuyerApiIi.FrequencyCap
...
**numTimeUnits** | **Number** | The amount of time, in the units specified by time_unit_type. Defines the amount of time over which impressions per user are counted and capped. | [optional] 
