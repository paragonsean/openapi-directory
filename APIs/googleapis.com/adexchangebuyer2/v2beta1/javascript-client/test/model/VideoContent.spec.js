...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdExchangeBuyerApiIi.VideoContent();
  });
  ...
  describe('VideoContent', function() {
    it('should create an instance of VideoContent', function() {
      ...
      //var instance = new AdExchangeBuyerApiIi.VideoContent();
      //expect(instance).to.be.a(AdExchangeBuyerApiIi.VideoContent);
    });
