...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdExchangeBuyerApiIi.RowDimensions();
  });
  ...
  describe('RowDimensions', function() {
    it('should create an instance of RowDimensions', function() {
      // uncomment below and update the code to test RowDimensions
      //var instance = new AdExchangeBuyerApiIi.RowDimensions();
      //expect(instance).to.be.a(AdExchangeBuyerApiIi.RowDimensions);
    });
