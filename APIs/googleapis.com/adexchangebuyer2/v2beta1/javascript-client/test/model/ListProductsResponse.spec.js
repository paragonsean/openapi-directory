...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdExchangeBuyerApiIi.ListProductsResponse();
  });
  ...
  describe('ListProductsResponse', function() {
    it('should create an instance of ListProductsResponse', function() {
      ...
      //var instance = new AdExchangeBuyerApiIi.ListProductsResponse();
      //expect(instance).to.be.a(AdExchangeBuyerApiIi.ListProductsResponse);
    });
