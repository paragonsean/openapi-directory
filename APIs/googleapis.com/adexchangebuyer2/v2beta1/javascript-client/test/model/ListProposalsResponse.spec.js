...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdExchangeBuyerApiIi.ListProposalsResponse();
  });
  ...
  describe('ListProposalsResponse', function() {
    it('should create an instance of ListProposalsResponse', function() {
      ...
      //var instance = new AdExchangeBuyerApiIi.ListProposalsResponse();
      //expect(instance).to.be.a(AdExchangeBuyerApiIi.ListProposalsResponse);
    });
