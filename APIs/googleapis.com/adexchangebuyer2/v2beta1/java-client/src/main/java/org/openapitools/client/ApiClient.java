...
public class ApiClient {
    ...
    private String basePath = "https://adexchangebuyer.googleapis.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/v2beta1/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://adexchangebuyer.googleapis.com
