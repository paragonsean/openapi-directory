...
class PublisherProfileMobileApplication(Model):
    ...
    def app_store(self, app_store):
        ...
        :type app_store: str
        """
        allowed_values = ["APP_STORE_TYPE_UNSPECIFIED", "APPLE_ITUNES", "GOOGLE_PLAY", "ROKU", "AMAZON_FIRETV", "PLAYSTATION", "XBOX", "SAMSUNG_TV", "AMAZON", "OPPO", "SAMSUNG", "VIVO", "XIAOMI", "LG_TV"]  # noqa: E501
