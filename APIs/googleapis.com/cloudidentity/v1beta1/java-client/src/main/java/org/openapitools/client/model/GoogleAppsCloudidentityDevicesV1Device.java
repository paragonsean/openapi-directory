...
public class GoogleAppsCloudidentityDevicesV1Device {
  ...
  public GoogleAppsCloudidentityDevicesV1Device androidSpecificAttributes(GoogleAppsCloudidentityDevicesV1AndroidAttributes androidSpecificAttributes) {
  ...
  public void setAndroidSpecificAttributes(GoogleAppsCloudidentityDevicesV1AndroidAttributes androidSpecificAttributes) {
    this.androidSpecificAttributes = androidSpecificAttributes;
  }


  public GoogleAppsCloudidentityDevicesV1Device assetTag(String assetTag) {
  ...
  public GoogleAppsCloudidentityDevicesV1Device deviceId(String deviceId) {
  ...
  public GoogleAppsCloudidentityDevicesV1Device hostname(String hostname) {
  ...
  public GoogleAppsCloudidentityDevicesV1Device lastSyncTime(String lastSyncTime) {
  ...
  public GoogleAppsCloudidentityDevicesV1Device serialNumber(String serialNumber) {
  ...
  public GoogleAppsCloudidentityDevicesV1Device wifiMacAddresses(List<String> wifiMacAddresses) {
    this.wifiMacAddresses = wifiMacAddresses;
    return this;
  }

  public GoogleAppsCloudidentityDevicesV1Device addWifiMacAddressesItem(String wifiMacAddressesItem) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleAppsCloudidentityDevicesV1Device googleAppsCloudidentityDevicesV1Device = (GoogleAppsCloudidentityDevicesV1Device) o;
    return Objects.equals(this.androidSpecificAttributes, googleAppsCloudidentityDevicesV1Device.androidSpecificAttributes) &&
        Objects.equals(this.assetTag, googleAppsCloudidentityDevicesV1Device.assetTag) &&
        Objects.equals(this.basebandVersion, googleAppsCloudidentityDevicesV1Device.basebandVersion) &&
        Objects.equals(this.bootloaderVersion, googleAppsCloudidentityDevicesV1Device.bootloaderVersion) &&
        Objects.equals(this.brand, googleAppsCloudidentityDevicesV1Device.brand) &&
        Objects.equals(this.buildNumber, googleAppsCloudidentityDevicesV1Device.buildNumber) &&
        Objects.equals(this.compromisedState, googleAppsCloudidentityDevicesV1Device.compromisedState) &&
        Objects.equals(this.createTime, googleAppsCloudidentityDevicesV1Device.createTime) &&
        Objects.equals(this.deviceId, googleAppsCloudidentityDevicesV1Device.deviceId) &&
        Objects.equals(this.deviceType, googleAppsCloudidentityDevicesV1Device.deviceType) &&
        Objects.equals(this.enabledDeveloperOptions, googleAppsCloudidentityDevicesV1Device.enabledDeveloperOptions) &&
        Objects.equals(this.enabledUsbDebugging, googleAppsCloudidentityDevicesV1Device.enabledUsbDebugging) &&
        Objects.equals(this.encryptionState, googleAppsCloudidentityDevicesV1Device.encryptionState) &&
        Objects.equals(this.hostname, googleAppsCloudidentityDevicesV1Device.hostname) &&
        Objects.equals(this.imei, googleAppsCloudidentityDevicesV1Device.imei) &&
        Objects.equals(this.kernelVersion, googleAppsCloudidentityDevicesV1Device.kernelVersion) &&
        Objects.equals(this.lastSyncTime, googleAppsCloudidentityDevicesV1Device.lastSyncTime) &&
        Objects.equals(this.managementState, googleAppsCloudidentityDevicesV1Device.managementState) &&
        Objects.equals(this.manufacturer, googleAppsCloudidentityDevicesV1Device.manufacturer) &&
        Objects.equals(this.meid, googleAppsCloudidentityDevicesV1Device.meid) &&
        Objects.equals(this.model, googleAppsCloudidentityDevicesV1Device.model) &&
        Objects.equals(this.name, googleAppsCloudidentityDevicesV1Device.name) &&
        Objects.equals(this.networkOperator, googleAppsCloudidentityDevicesV1Device.networkOperator) &&
        Objects.equals(this.osVersion, googleAppsCloudidentityDevicesV1Device.osVersion) &&
        Objects.equals(this.otherAccounts, googleAppsCloudidentityDevicesV1Device.otherAccounts) &&
        Objects.equals(this.ownerType, googleAppsCloudidentityDevicesV1Device.ownerType) &&
        Objects.equals(this.releaseVersion, googleAppsCloudidentityDevicesV1Device.releaseVersion) &&
        Objects.equals(this.securityPatchTime, googleAppsCloudidentityDevicesV1Device.securityPatchTime) &&
        Objects.equals(this.serialNumber, googleAppsCloudidentityDevicesV1Device.serialNumber) &&
        Objects.equals(this.wifiMacAddresses, googleAppsCloudidentityDevicesV1Device.wifiMacAddresses);
  }

  @Override
  public int hashCode() {
    return Objects.hash(androidSpecificAttributes, assetTag, basebandVersion, bootloaderVersion, brand, buildNumber, compromisedState, createTime, deviceId, deviceType, enabledDeveloperOptions, enabledUsbDebugging, encryptionState, hostname, imei, kernelVersion, lastSyncTime, managementState, manufacturer, meid, model, name, networkOperator, osVersion, otherAccounts, ownerType, releaseVersion, securityPatchTime, serialNumber, wifiMacAddresses);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GoogleAppsCloudidentityDevicesV1Device {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleAppsCloudidentityDevicesV1Device
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleAppsCloudidentityDevicesV1Device.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleAppsCloudidentityDevicesV1Device is not found in the empty JSON string", GoogleAppsCloudidentityDevicesV1Device.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleAppsCloudidentityDevicesV1Device.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleAppsCloudidentityDevicesV1Device` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("androidSpecificAttributes") != null && !jsonObj.get("androidSpecificAttributes").isJsonNull()) {
        GoogleAppsCloudidentityDevicesV1AndroidAttributes.validateJsonElement(jsonObj.get("androidSpecificAttributes"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleAppsCloudidentityDevicesV1Device.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleAppsCloudidentityDevicesV1Device' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleAppsCloudidentityDevicesV1Device> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleAppsCloudidentityDevicesV1Device.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleAppsCloudidentityDevicesV1Device>() {
           @Override
           public void write(JsonWriter out, GoogleAppsCloudidentityDevicesV1Device value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleAppsCloudidentityDevicesV1Device read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleAppsCloudidentityDevicesV1Device given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleAppsCloudidentityDevicesV1Device
   * @throws IOException if the JSON string is invalid with respect to GoogleAppsCloudidentityDevicesV1Device
   */
  public static GoogleAppsCloudidentityDevicesV1Device fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleAppsCloudidentityDevicesV1Device.class);
  }

  /**
   * Convert an instance of GoogleAppsCloudidentityDevicesV1Device to an JSON string
   *
   * @return JSON string
   */
