...
|------------- | ------------- | -------------|
| [**cloudidentityInboundSsoAssignmentsCreate**](InboundSsoAssignmentsApi.md#cloudidentityInboundSsoAssignmentsCreate) | **POST** /v1beta1/inboundSsoAssignments |  |
| [**cloudidentityInboundSsoAssignmentsDelete**](InboundSsoAssignmentsApi.md#cloudidentityInboundSsoAssignmentsDelete) | **DELETE** /v1beta1/{name} |  |
| [**cloudidentityInboundSsoAssignmentsGet**](InboundSsoAssignmentsApi.md#cloudidentityInboundSsoAssignmentsGet) | **GET** /v1beta1/{name} |  |
| [**cloudidentityInboundSsoAssignmentsList**](InboundSsoAssignmentsApi.md#cloudidentityInboundSsoAssignmentsList) | **GET** /v1beta1/inboundSsoAssignments |  |
| [**cloudidentityInboundSsoAssignmentsPatch**](InboundSsoAssignmentsApi.md#cloudidentityInboundSsoAssignmentsPatch) | **PATCH** /v1beta1/{name} |  |
