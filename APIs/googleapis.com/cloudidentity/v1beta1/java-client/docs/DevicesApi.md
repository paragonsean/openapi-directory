...
> Operation cloudidentityDevicesCreate($xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, createDeviceRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Operation result = apiInstance.cloudidentityDevicesCreate($xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, createDeviceRequest);
...
> Operation cloudidentityDevicesDeviceUsersApprove(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, approveDeviceUserRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    DevicesApi apiInstance = new DevicesApi(defaultClient);
    String name = "name_example"; // String | Required. [Resource name](https://cloud.google.com/apis/design/resource_names) of the Device in format: `devices/{device_id}/deviceUsers/{device_user_id}`, where device_id is the unique ID assigned to the Device, and device_user_id is the unique ID assigned to the User.
    String $xgafv = "1"; // String | V1 error format.
    String accessToken = "accessToken_example"; // String | OAuth access token.
    String alt = "json"; // String | Data format for response.
    String paramCallback = "paramCallback_example"; // String | JSONP
    ...
    String uploadProtocol = "uploadProtocol_example"; // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
    String uploadType = "uploadType_example"; // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
    ApproveDeviceUserRequest approveDeviceUserRequest = new ApproveDeviceUserRequest(); // ApproveDeviceUserRequest | 
    try {
      Operation result = apiInstance.cloudidentityDevicesDeviceUsersApprove(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, approveDeviceUserRequest);
      System.out.println(result);
    } catch (ApiException e) {
...
> Operation cloudidentityDevicesDeviceUsersBlock(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, blockDeviceUserRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    String uploadProtocol = "uploadProtocol_example"; // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
    String uploadType = "uploadType_example"; // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
    BlockDeviceUserRequest blockDeviceUserRequest = new BlockDeviceUserRequest(); // BlockDeviceUserRequest | 
    try {
      Operation result = apiInstance.cloudidentityDevicesDeviceUsersBlock(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, blockDeviceUserRequest);
      System.out.println(result);
    } catch (ApiException e) {
...
> Operation cloudidentityDevicesDeviceUsersCancelWipe(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, cancelWipeDeviceUserRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    String uploadProtocol = "uploadProtocol_example"; // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
    String uploadType = "uploadType_example"; // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
    CancelWipeDeviceUserRequest cancelWipeDeviceUserRequest = new CancelWipeDeviceUserRequest(); // CancelWipeDeviceUserRequest | 
    try {
      Operation result = apiInstance.cloudidentityDevicesDeviceUsersCancelWipe(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, cancelWipeDeviceUserRequest);
      System.out.println(result);
    } catch (ApiException e) {
...
> ListDeviceUsersResponse cloudidentityDevicesDeviceUsersList(parent, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, customer, filter, orderBy, pageSize, pageToken)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ListDeviceUsersResponse result = apiInstance.cloudidentityDevicesDeviceUsersList(parent, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, customer, filter, orderBy, pageSize, pageToken);
      System.out.println(result);
    } catch (ApiException e) {
...
> LookupSelfDeviceUsersResponse cloudidentityDevicesDeviceUsersLookup(parent, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, androidId, pageSize, pageToken, rawResourceId, userId)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      LookupSelfDeviceUsersResponse result = apiInstance.cloudidentityDevicesDeviceUsersLookup(parent, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, androidId, pageSize, pageToken, rawResourceId, userId);
      System.out.println(result);
    } catch (ApiException e) {
...
> Operation cloudidentityDevicesDeviceUsersWipe(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, wipeDeviceUserRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    String uploadProtocol = "uploadProtocol_example"; // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
    String uploadType = "uploadType_example"; // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
    WipeDeviceUserRequest wipeDeviceUserRequest = new WipeDeviceUserRequest(); // WipeDeviceUserRequest | 
    try {
      Operation result = apiInstance.cloudidentityDevicesDeviceUsersWipe(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, wipeDeviceUserRequest);
      System.out.println(result);
    } catch (ApiException e) {
...
> ListDevicesResponse cloudidentityDevicesList($xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, customer, filter, orderBy, pageSize, pageToken, view)
...
public class Example {
  public static void main(String[] args) {
    ...
    String uploadProtocol = "uploadProtocol_example"; // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
    String uploadType = "uploadType_example"; // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
    String customer = "customer_example"; // String | Optional. [Resource name](https://cloud.google.com/apis/design/resource_names) of the customer.
    String filter = "filter_example"; // String | Optional. Additional restrictions when fetching list of devices. For a list of search fields, refer to [Mobile device search fields](https://developers.google.com/admin-sdk/directory/v1/search-operators). Multiple search fields are separated by the space character.
    ...
    try {
      ListDevicesResponse result = apiInstance.cloudidentityDevicesList($xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, customer, filter, orderBy, pageSize, pageToken, view);
      System.out.println(result);
    } catch (ApiException e) {
