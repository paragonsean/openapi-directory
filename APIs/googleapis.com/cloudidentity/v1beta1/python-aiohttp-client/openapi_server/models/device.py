...
class Device(Model):
    ...
    def __init__(self, android_specific_attributes: AndroidAttributes=None, asset_tag: str=None, baseband_version: str=None, bootloader_version: str=None, brand: str=None, build_number: str=None, client_types: List[str]=None, compromised_state: str=None, create_time: str=None, device_id: str=None, device_type: str=None, enabled_developer_options: bool=None, enabled_usb_debugging: bool=None, encryption_state: str=None, endpoint_verification_specific_attributes: EndpointVerificationSpecificAttributes=None, hostname: str=None, imei: str=None, kernel_version: str=None, last_sync_time: str=None, management_state: str=None, manufacturer: str=None, meid: str=None, model: str=None, name: str=None, network_operator: str=None, os_version: str=None, other_accounts: List[str]=None, owner_type: str=None, release_version: str=None, security_patch_time: str=None, serial_number: str=None, wifi_mac_addresses: List[str]=None):
        """Device - a model defined in OpenAPI

        :param android_specific_attributes: The android_specific_attributes of this Device.
        :param asset_tag: The asset_tag of this Device.
        :param baseband_version: The baseband_version of this Device.
        :param bootloader_version: The bootloader_version of this Device.
        :param brand: The brand of this Device.
        :param build_number: The build_number of this Device.
        :param client_types: The client_types of this Device.
        :param compromised_state: The compromised_state of this Device.
        :param create_time: The create_time of this Device.
        :param device_id: The device_id of this Device.
        :param device_type: The device_type of this Device.
        :param enabled_developer_options: The enabled_developer_options of this Device.
        :param enabled_usb_debugging: The enabled_usb_debugging of this Device.
        :param encryption_state: The encryption_state of this Device.
        :param endpoint_verification_specific_attributes: The endpoint_verification_specific_attributes of this Device.
        :param hostname: The hostname of this Device.
        :param imei: The imei of this Device.
        :param kernel_version: The kernel_version of this Device.
        :param last_sync_time: The last_sync_time of this Device.
        :param management_state: The management_state of this Device.
        :param manufacturer: The manufacturer of this Device.
        :param meid: The meid of this Device.
        :param model: The model of this Device.
        :param name: The name of this Device.
        :param network_operator: The network_operator of this Device.
        :param os_version: The os_version of this Device.
        :param other_accounts: The other_accounts of this Device.
        :param owner_type: The owner_type of this Device.
        :param release_version: The release_version of this Device.
        :param security_patch_time: The security_patch_time of this Device.
        :param serial_number: The serial_number of this Device.
        :param wifi_mac_addresses: The wifi_mac_addresses of this Device.
        """
        self.openapi_types = {
            'android_specific_attributes': AndroidAttributes,
            'asset_tag': str,
            ...
            'endpoint_verification_specific_attributes': EndpointVerificationSpecificAttributes,
            'hostname': str,
            'imei': str,
            'kernel_version': str,
            'last_sync_time': str,
        ...
        self._endpoint_verification_specific_attributes = endpoint_verification_specific_attributes
    ...
    def android_specific_attributes(self):
        """Gets the android_specific_attributes of this Device.


        :return: The android_specific_attributes of this Device.
        :rtype: AndroidAttributes
        """
    ...
    def android_specific_attributes(self, android_specific_attributes):
        """Sets the android_specific_attributes of this Device.


        :param android_specific_attributes: The android_specific_attributes of this Device.
        :type android_specific_attributes: AndroidAttributes
        """
    ...
    def baseband_version(self):
        """Gets the baseband_version of this Device.

        Output only. Baseband version of the device.

        :return: The baseband_version of this Device.
        :rtype: str
        """
    ...
    def baseband_version(self, baseband_version):
        """Sets the baseband_version of this Device.
    ...
    def bootloader_version(self):
        """Gets the bootloader_version of this Device.

        Output only. Device bootloader version. Example: 0.6.7.

        :return: The bootloader_version of this Device.
        :rtype: str
        """
    ...
    def bootloader_version(self, bootloader_version):
        """Sets the bootloader_version of this Device.
    ...
    def build_number(self):
        """Gets the build_number of this Device.

        Output only. Build number of the device.

        :return: The build_number of this Device.
        :rtype: str
        """
    ...
    def build_number(self, build_number):
        """Sets the build_number of this Device.
    ...
    def client_types(self):
        """Gets the client_types of this Device.

        List of the clients the device is reporting to.

        :return: The client_types of this Device.
        :rtype: List[str]
        """
    ...
    def client_types(self, client_types):
        """Sets the client_types of this Device.
        ...
        """
        allowed_values = ["CLIENT_TYPE_UNSPECIFIED", "DRIVE_FS", "FUNDAMENTAL", "ENDPOINT_VERIFICATION", "WINDOWS_ADVANCED", "GOOGLE_CREDENTIALS_PROVIDER_FOR_WINDOWS"]  # noqa: E501
        if not set(client_types).issubset(set(allowed_values)):
            raise ValueError(
                "Invalid values for `client_types` [{0}], must be a subset of [{1}]"
                .format(", ".join(map(str, set(client_types) - set(allowed_values))),
    ...
    def compromised_state(self):
        """Gets the compromised_state of this Device.

        Output only. Represents whether the Device is compromised.

        :return: The compromised_state of this Device.
        :rtype: str
        """
    ...
    def compromised_state(self, compromised_state):
        """Sets the compromised_state of this Device.
    ...
    def create_time(self):
        """Gets the create_time of this Device.

        Output only. When the Company-Owned device was imported. This field is empty for BYOD devices.

        :return: The create_time of this Device.
        :rtype: str
        """
    ...
    def enabled_developer_options(self):
        """Gets the enabled_developer_options of this Device.

        Output only. Whether developer options is enabled on device.

        :return: The enabled_developer_options of this Device.
        :rtype: bool
        """
    ...
    def enabled_developer_options(self, enabled_developer_options):
        """Sets the enabled_developer_options of this Device.
    ...
    def enabled_usb_debugging(self):
        """Gets the enabled_usb_debugging of this Device.

        Output only. Whether USB debugging is enabled on device.

        :return: The enabled_usb_debugging of this Device.
        :rtype: bool
        """
    ...
    def enabled_usb_debugging(self, enabled_usb_debugging):
        """Sets the enabled_usb_debugging of this Device.
    ...
    def encryption_state(self):
        """Gets the encryption_state of this Device.

        Output only. Device encryption state.

        :return: The encryption_state of this Device.
        :rtype: str
        """
    ...
    def encryption_state(self, encryption_state):
        """Sets the encryption_state of this Device.
    ...
    @property
    def endpoint_verification_specific_attributes(self):
        """Gets the endpoint_verification_specific_attributes of this Device.


        :return: The endpoint_verification_specific_attributes of this Device.
        :rtype: EndpointVerificationSpecificAttributes
        """
        return self._endpoint_verification_specific_attributes

    @endpoint_verification_specific_attributes.setter
    def endpoint_verification_specific_attributes(self, endpoint_verification_specific_attributes):
        """Sets the endpoint_verification_specific_attributes of this Device.


        :param endpoint_verification_specific_attributes: The endpoint_verification_specific_attributes of this Device.
        :type endpoint_verification_specific_attributes: EndpointVerificationSpecificAttributes
        """
    ...
    def kernel_version(self):
        """Gets the kernel_version of this Device.

        Output only. Kernel version of the device.

        :return: The kernel_version of this Device.
        :rtype: str
        """
    ...
    def kernel_version(self, kernel_version):
        """Sets the kernel_version of this Device.
    ...
    def last_sync_time(self):
        """Gets the last_sync_time of this Device.

        Most recent time when device synced with this service.

        :return: The last_sync_time of this Device.
        :rtype: str
        """
    ...
    def last_sync_time(self, last_sync_time):
        """Sets the last_sync_time of this Device.
    ...
    def management_state(self):
        """Gets the management_state of this Device.

        Output only. Management state of the device

        :return: The management_state of this Device.
        :rtype: str
        """
    ...
    def management_state(self, management_state):
        """Sets the management_state of this Device.
    ...
    @property
    def meid(self):
        """Gets the meid of this Device.

        Output only. MEID number of device if CDMA device; empty otherwise.

        :return: The meid of this Device.
        :rtype: str
        """
        return self._meid
    ...
    def network_operator(self):
        """Gets the network_operator of this Device.

        Output only. Mobile or network operator of device, if available.

        :return: The network_operator of this Device.
        :rtype: str
        """
    ...
    def network_operator(self, network_operator):
        """Sets the network_operator of this Device.
    ...
    def other_accounts(self):
        """Gets the other_accounts of this Device.

        Output only. Domain name for Google accounts on device. Type for other accounts on device. On Android, will only be populated if |ownership_privilege| is |PROFILE_OWNER| or |DEVICE_OWNER|. Does not include the account signed in to the device policy app if that account's domain has only one account. Examples: \"com.example\", \"xyz.com\".

        :return: The other_accounts of this Device.
        :rtype: List[str]
        """
    ...
    def other_accounts(self, other_accounts):
        """Sets the other_accounts of this Device.
    ...
    @property
    def owner_type(self):
        """Gets the owner_type of this Device.

        Output only. Whether the device is owned by the company or an individual

        :return: The owner_type of this Device.
        :rtype: str
        """
    ...
    def owner_type(self, owner_type):
        """Sets the owner_type of this Device.
    ...
    def release_version(self):
        """Gets the release_version of this Device.

        Output only. OS release version. Example: 6.0.

        :return: The release_version of this Device.
        :rtype: str
        """
    ...
    def release_version(self, release_version):
        """Sets the release_version of this Device.
    ...
    def security_patch_time(self):
        """Gets the security_patch_time of this Device.

        Output only. OS security patch update time on device.

        :return: The security_patch_time of this Device.
        :rtype: str
        """
    ...
    def security_patch_time(self, security_patch_time):
        """Sets the security_patch_time of this Device.
    ...
    def wifi_mac_addresses(self):
        """Gets the wifi_mac_addresses of this Device.

        WiFi MAC addresses of device.

        :return: The wifi_mac_addresses of this Device.
        :rtype: List[str]
        """
    ...
    def wifi_mac_addresses(self, wifi_mac_addresses):
        """Sets the wifi_mac_addresses of this Device.
