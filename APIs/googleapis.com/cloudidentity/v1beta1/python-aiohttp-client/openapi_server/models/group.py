...
class Group(Model):
    ...
    def __init__(self, additional_group_keys: List[EntityKey]=None, create_time: str=None, description: str=None, display_name: str=None, dynamic_group_metadata: DynamicGroupMetadata=None, group_key: EntityKey=None, labels: Dict[str, str]=None, name: str=None, parent: str=None, posix_groups: List[PosixGroup]=None, update_time: str=None):
        ...
        :param posix_groups: The posix_groups of this Group.
    ...
    def posix_groups(self):
        """Gets the posix_groups of this Group.

        Optional. The POSIX groups associated with the `Group`.

        :return: The posix_groups of this Group.
        :rtype: List[PosixGroup]
        """
        return self._posix_groups

    @posix_groups.setter
    def posix_groups(self, posix_groups):
        """Sets the posix_groups of this Group.

        Optional. The POSIX groups associated with the `Group`.

        :param posix_groups: The posix_groups of this Group.
        :type posix_groups: List[PosixGroup]
        """
