...
/*
 * OAILookupSelfDeviceUsersResponse.h
 *
 * Response containing resource names of the DeviceUsers associated with the caller&#39;s credentials.
 */

#ifndef OAILookupSelfDeviceUsersResponse_H
#define OAILookupSelfDeviceUsersResponse_H
...
class OAILookupSelfDeviceUsersResponse : public OAIObject {
public:
    OAILookupSelfDeviceUsersResponse();
    OAILookupSelfDeviceUsersResponse(QString json);
    ~OAILookupSelfDeviceUsersResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILookupSelfDeviceUsersResponse)

#endif // OAILookupSelfDeviceUsersResponse_H
