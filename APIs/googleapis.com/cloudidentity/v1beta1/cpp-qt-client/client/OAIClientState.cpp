...
OAIClientState::OAIClientState(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIClientState::OAIClientState() {
    this->initializeModel();
}

OAIClientState::~OAIClientState() {}

void OAIClientState::initializeModel() {
...
void OAIClientState::fromJson(QString jsonString) {
...
void OAIClientState::fromJsonObject(QJsonObject json) {
...
QString OAIClientState::asJson() const {
...
QJsonObject OAIClientState::asJsonObject() const {
    QJsonObject obj;
...
QList<QString> OAIClientState::getAssetTags() const {
    return m_asset_tags;
}
void OAIClientState::setAssetTags(const QList<QString> &asset_tags) {
    m_asset_tags = asset_tags;
    m_asset_tags_isSet = true;
}

bool OAIClientState::is_asset_tags_Set() const{
    return m_asset_tags_isSet;
}

bool OAIClientState::is_asset_tags_Valid() const{
    return m_asset_tags_isValid;
}

QString OAIClientState::getComplianceState() const {
    return m_compliance_state;
}
void OAIClientState::setComplianceState(const QString &compliance_state) {
    m_compliance_state = compliance_state;
    m_compliance_state_isSet = true;
}

bool OAIClientState::is_compliance_state_Set() const{
    return m_compliance_state_isSet;
}

bool OAIClientState::is_compliance_state_Valid() const{
    return m_compliance_state_isValid;
}

QString OAIClientState::getCreateTime() const {
    return m_create_time;
}
void OAIClientState::setCreateTime(const QString &create_time) {
    m_create_time = create_time;
    m_create_time_isSet = true;
}

bool OAIClientState::is_create_time_Set() const{
    return m_create_time_isSet;
}

bool OAIClientState::is_create_time_Valid() const{
    return m_create_time_isValid;
}

QString OAIClientState::getCustomId() const {
    return m_custom_id;
}
void OAIClientState::setCustomId(const QString &custom_id) {
    m_custom_id = custom_id;
    m_custom_id_isSet = true;
}

bool OAIClientState::is_custom_id_Set() const{
    return m_custom_id_isSet;
}

bool OAIClientState::is_custom_id_Valid() const{
    return m_custom_id_isValid;
}

QString OAIClientState::getEtag() const {
    return m_etag;
}
void OAIClientState::setEtag(const QString &etag) {
    m_etag = etag;
    m_etag_isSet = true;
}

bool OAIClientState::is_etag_Set() const{
    return m_etag_isSet;
}

bool OAIClientState::is_etag_Valid() const{
    return m_etag_isValid;
}

QString OAIClientState::getHealthScore() const {
    return m_health_score;
}
void OAIClientState::setHealthScore(const QString &health_score) {
    m_health_score = health_score;
    m_health_score_isSet = true;
}

bool OAIClientState::is_health_score_Set() const{
    return m_health_score_isSet;
}

bool OAIClientState::is_health_score_Valid() const{
    return m_health_score_isValid;
}

QMap<QString, OAICustomAttributeValue> OAIClientState::getKeyValuePairs() const {
    return m_key_value_pairs;
}
void OAIClientState::setKeyValuePairs(const QMap<QString, OAICustomAttributeValue> &key_value_pairs) {
    m_key_value_pairs = key_value_pairs;
    m_key_value_pairs_isSet = true;
}

bool OAIClientState::is_key_value_pairs_Set() const{
    return m_key_value_pairs_isSet;
}

bool OAIClientState::is_key_value_pairs_Valid() const{
    return m_key_value_pairs_isValid;
}

QString OAIClientState::getLastUpdateTime() const {
    return m_last_update_time;
}
void OAIClientState::setLastUpdateTime(const QString &last_update_time) {
    m_last_update_time = last_update_time;
    m_last_update_time_isSet = true;
}

bool OAIClientState::is_last_update_time_Set() const{
    return m_last_update_time_isSet;
}

bool OAIClientState::is_last_update_time_Valid() const{
    return m_last_update_time_isValid;
}

QString OAIClientState::getManaged() const {
    return m_managed;
}
void OAIClientState::setManaged(const QString &managed) {
    m_managed = managed;
    m_managed_isSet = true;
}

bool OAIClientState::is_managed_Set() const{
    return m_managed_isSet;
}

bool OAIClientState::is_managed_Valid() const{
    return m_managed_isValid;
}

QString OAIClientState::getName() const {
    return m_name;
}
void OAIClientState::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIClientState::is_name_Set() const{
    return m_name_isSet;
}

bool OAIClientState::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIClientState::getOwnerType() const {
    return m_owner_type;
}
void OAIClientState::setOwnerType(const QString &owner_type) {
    m_owner_type = owner_type;
    m_owner_type_isSet = true;
}

bool OAIClientState::is_owner_type_Set() const{
    return m_owner_type_isSet;
}

bool OAIClientState::is_owner_type_Valid() const{
    return m_owner_type_isValid;
}

QString OAIClientState::getScoreReason() const {
    return m_score_reason;
}
void OAIClientState::setScoreReason(const QString &score_reason) {
    m_score_reason = score_reason;
    m_score_reason_isSet = true;
}

bool OAIClientState::is_score_reason_Set() const{
    return m_score_reason_isSet;
}

bool OAIClientState::is_score_reason_Valid() const{
    return m_score_reason_isValid;
}

bool OAIClientState::isSet() const {
...
bool OAIClientState::isValid() const {
