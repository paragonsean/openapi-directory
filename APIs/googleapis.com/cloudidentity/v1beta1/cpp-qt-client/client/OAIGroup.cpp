...
void OAIGroup::initializeModel() {
    ...
    m_posix_groups_isSet = false;
    m_posix_groups_isValid = false;
...
void OAIGroup::fromJsonObject(QJsonObject json) {
    ...
    m_posix_groups_isValid = ::OpenAPI::fromJsonValue(m_posix_groups, json[QString("posixGroups")]);
    m_posix_groups_isSet = !json[QString("posixGroups")].isNull() && m_posix_groups_isValid;
...
QJsonObject OAIGroup::asJsonObject() const {
    ...
    if (m_posix_groups.size() > 0) {
        obj.insert(QString("posixGroups"), ::OpenAPI::toJsonValue(m_posix_groups));
    }
...
QList<OAIPosixGroup> OAIGroup::getPosixGroups() const {
    return m_posix_groups;
}
void OAIGroup::setPosixGroups(const QList<OAIPosixGroup> &posix_groups) {
    m_posix_groups = posix_groups;
    m_posix_groups_isSet = true;
}

bool OAIGroup::is_posix_groups_Set() const{
    return m_posix_groups_isSet;
}

bool OAIGroup::is_posix_groups_Valid() const{
    return m_posix_groups_isValid;
}
