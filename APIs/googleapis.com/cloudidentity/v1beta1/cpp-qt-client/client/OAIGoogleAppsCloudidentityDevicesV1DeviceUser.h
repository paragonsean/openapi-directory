...
/*
 * OAIGoogleAppsCloudidentityDevicesV1DeviceUser.h
 *
 * Represents a user&#39;s use of a Device in the Cloud Identity Devices API. A DeviceUser is a resource representing a user&#39;s use of a Device
 */

#ifndef OAIGoogleAppsCloudidentityDevicesV1DeviceUser_H
#define OAIGoogleAppsCloudidentityDevicesV1DeviceUser_H
...
class OAIGoogleAppsCloudidentityDevicesV1DeviceUser : public OAIObject {
public:
    OAIGoogleAppsCloudidentityDevicesV1DeviceUser();
    OAIGoogleAppsCloudidentityDevicesV1DeviceUser(QString json);
    ~OAIGoogleAppsCloudidentityDevicesV1DeviceUser() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleAppsCloudidentityDevicesV1DeviceUser)

#endif // OAIGoogleAppsCloudidentityDevicesV1DeviceUser_H
