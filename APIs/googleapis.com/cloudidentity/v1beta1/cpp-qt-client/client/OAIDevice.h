...
namespace OpenAPI {
class OAIAndroidAttributes;
class OAIEndpointVerificationSpecificAttributes;
...
public:
    ...
    OAIAndroidAttributes getAndroidSpecificAttributes() const;
    void setAndroidSpecificAttributes(const OAIAndroidAttributes &android_specific_attributes);
    ...
    QList<QString> getClientTypes() const;
    void setClientTypes(const QList<QString> &client_types);
    bool is_client_types_Set() const;
    bool is_client_types_Valid() const;
    ...
    OAIEndpointVerificationSpecificAttributes getEndpointVerificationSpecificAttributes() const;
    void setEndpointVerificationSpecificAttributes(const OAIEndpointVerificationSpecificAttributes &endpoint_verification_specific_attributes);
    bool is_endpoint_verification_specific_attributes_Set() const;
    bool is_endpoint_verification_specific_attributes_Valid() const;
...
private:
    ...
    OAIAndroidAttributes m_android_specific_attributes;
    ...
    QList<QString> m_client_types;
    bool m_client_types_isSet;
    bool m_client_types_isValid;
    ...
    OAIEndpointVerificationSpecificAttributes m_endpoint_verification_specific_attributes;
    bool m_endpoint_verification_specific_attributes_isSet;
    bool m_endpoint_verification_specific_attributes_isValid;
