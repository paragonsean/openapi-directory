...
class Membership {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('memberKey')) {
                obj['memberKey'] = EntityKey.constructFromObject(data['memberKey']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['memberKey']) { // data not null
          EntityKey.validateJSON(data['memberKey']);
        }
        // ensure the json data is a string
...
/**
 * @member {module:model/EntityKey} memberKey
 */
Membership.prototype['memberKey'] = undefined;
