...
/**
 * The DeviceUser model module.
 * @module model/DeviceUser
 * @version v1beta1
 */
class DeviceUser {
    /**
     * Constructs a new <code>DeviceUser</code>.
     * Represents a user&#39;s use of a Device in the Cloud Identity Devices API. A DeviceUser is a resource representing a user&#39;s use of a Device
     * @alias module:model/DeviceUser
     */
    constructor() { 
        
        DeviceUser.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeviceUser</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeviceUser} obj Optional instance to populate.
     * @return {module:model/DeviceUser} The populated <code>DeviceUser</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeviceUser();
    ...
    /**
     * Validates the JSON data with respect to <code>DeviceUser</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeviceUser</code>.
     */
 ...
 * @member {module:model/DeviceUser.CompromisedStateEnum} compromisedState
 */
DeviceUser.prototype['compromisedState'] = undefined;

/**
 * When the user first signed in to the device
 * @member {String} createTime
 */
DeviceUser.prototype['createTime'] = undefined;

/**
 * Output only. Most recent time when user registered with this service.
 * @member {String} firstSyncTime
 */
DeviceUser.prototype['firstSyncTime'] = undefined;

/**
 * Output only. Default locale used on device, in IETF BCP-47 format.
 * @member {String} languageCode
 */
DeviceUser.prototype['languageCode'] = undefined;

/**
 * Output only. Last time when user synced with policies.
 * @member {String} lastSyncTime
 */
DeviceUser.prototype['lastSyncTime'] = undefined;

/**
 * Output only. Management state of the user on the device.
 * @member {module:model/DeviceUser.ManagementStateEnum} managementState
 */
DeviceUser.prototype['managementState'] = undefined;
 ...
 * @member {String} name
 */
DeviceUser.prototype['name'] = undefined;

/**
 * Password state of the DeviceUser object
 * @member {module:model/DeviceUser.PasswordStateEnum} passwordState
 */
DeviceUser.prototype['passwordState'] = undefined;

/**
 * Output only. User agent on the device for this specific user
 * @member {String} userAgent
 */
DeviceUser.prototype['userAgent'] = undefined;

/**
 * Email address of the user registered on the device.
 * @member {String} userEmail
 */
DeviceUser.prototype['userEmail'] = undefined;
 ...
 * @readonly
 */
DeviceUser['CompromisedStateEnum'] = {
 ...
 * @readonly
 */
DeviceUser['ManagementStateEnum'] = {
