...
/**
 * The LookupSelfDeviceUsersResponse model module.
 * @module model/LookupSelfDeviceUsersResponse
 * @version v1beta1
 */
class LookupSelfDeviceUsersResponse {
    /**
     * Constructs a new <code>LookupSelfDeviceUsersResponse</code>.
     * Response containing resource names of the DeviceUsers associated with the caller&#39;s credentials.
     * @alias module:model/LookupSelfDeviceUsersResponse
     */
    constructor() { 
        
        LookupSelfDeviceUsersResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LookupSelfDeviceUsersResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LookupSelfDeviceUsersResponse} obj Optional instance to populate.
     * @return {module:model/LookupSelfDeviceUsersResponse} The populated <code>LookupSelfDeviceUsersResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LookupSelfDeviceUsersResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>LookupSelfDeviceUsersResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LookupSelfDeviceUsersResponse</code>.
     */
 ...
 */
LookupSelfDeviceUsersResponse.prototype['customer'] = undefined;
 ...
 */
LookupSelfDeviceUsersResponse.prototype['names'] = undefined;

/**
 * Token to retrieve the next page of results. Empty if there are no more results.
 * @member {String} nextPageToken
 */
LookupSelfDeviceUsersResponse.prototype['nextPageToken'] = undefined;
...
export default LookupSelfDeviceUsersResponse;
