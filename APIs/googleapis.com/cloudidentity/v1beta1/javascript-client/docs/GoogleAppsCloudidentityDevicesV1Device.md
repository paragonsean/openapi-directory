# CloudIdentityApi.GoogleAppsCloudidentityDevicesV1Device

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**androidSpecificAttributes** | [**GoogleAppsCloudidentityDevicesV1AndroidAttributes**](GoogleAppsCloudidentityDevicesV1AndroidAttributes.md) |  | [optional] 
...
**name** | **String** | Output only. [Resource name](https://cloud.google.com/apis/design/resource_names) of the Device in format: &#x60;devices/{device}&#x60;, where device is the unique id assigned to the Device. | [optional] [readonly] 
