...
------------- | ------------- | -------------
[**cloudidentityDevicesCreate**](DevicesApi.md#cloudidentityDevicesCreate) | **POST** /v1beta1/devices | 
[**cloudidentityDevicesDeviceUsersApprove**](DevicesApi.md#cloudidentityDevicesDeviceUsersApprove) | **POST** /v1beta1/{name}:approve | 
[**cloudidentityDevicesDeviceUsersBlock**](DevicesApi.md#cloudidentityDevicesDeviceUsersBlock) | **POST** /v1beta1/{name}:block | 
[**cloudidentityDevicesDeviceUsersCancelWipe**](DevicesApi.md#cloudidentityDevicesDeviceUsersCancelWipe) | **POST** /v1beta1/{name}:cancelWipe | 
[**cloudidentityDevicesDeviceUsersList**](DevicesApi.md#cloudidentityDevicesDeviceUsersList) | **GET** /v1beta1/{parent}/deviceUsers | 
[**cloudidentityDevicesDeviceUsersLookup**](DevicesApi.md#cloudidentityDevicesDeviceUsersLookup) | **GET** /v1beta1/{parent}:lookup | 
[**cloudidentityDevicesDeviceUsersWipe**](DevicesApi.md#cloudidentityDevicesDeviceUsersWipe) | **POST** /v1beta1/{name}:wipe | 
[**cloudidentityDevicesList**](DevicesApi.md#cloudidentityDevicesList) | **GET** /v1beta1/devices | 
...
let opts = {
  ...
  'createDeviceRequest': new CloudIdentityApi.CreateDeviceRequest() // CreateDeviceRequest | 
};
...
let apiInstance = new CloudIdentityApi.DevicesApi();
let name = "name_example"; // String | Required. [Resource name](https://cloud.google.com/apis/design/resource_names) of the Device in format: `devices/{device_id}/deviceUsers/{device_user_id}`, where device_id is the unique ID assigned to the Device, and device_user_id is the unique ID assigned to the User.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'approveDeviceUserRequest': new CloudIdentityApi.ApproveDeviceUserRequest() // ApproveDeviceUserRequest | 
};
 ...
 **uploadProtocol** | **String**| Upload protocol for media (e.g. \&quot;raw\&quot;, \&quot;multipart\&quot;). | [optional] 
 **uploadType** | **String**| Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;). | [optional] 
 **approveDeviceUserRequest** | [**ApproveDeviceUserRequest**](ApproveDeviceUserRequest.md)|  | [optional] 
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'blockDeviceUserRequest': new CloudIdentityApi.BlockDeviceUserRequest() // BlockDeviceUserRequest | 
};
 ...
 **uploadProtocol** | **String**| Upload protocol for media (e.g. \&quot;raw\&quot;, \&quot;multipart\&quot;). | [optional] 
 **uploadType** | **String**| Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;). | [optional] 
 **blockDeviceUserRequest** | [**BlockDeviceUserRequest**](BlockDeviceUserRequest.md)|  | [optional] 
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'cancelWipeDeviceUserRequest': new CloudIdentityApi.CancelWipeDeviceUserRequest() // CancelWipeDeviceUserRequest | 
};
 ...
 **uploadProtocol** | **String**| Upload protocol for media (e.g. \&quot;raw\&quot;, \&quot;multipart\&quot;). | [optional] 
 **uploadType** | **String**| Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;). | [optional] 
 **cancelWipeDeviceUserRequest** | [**CancelWipeDeviceUserRequest**](CancelWipeDeviceUserRequest.md)|  | [optional] 
...
> ListDeviceUsersResponse cloudidentityDevicesDeviceUsersList(parent, opts)
...
> LookupSelfDeviceUsersResponse cloudidentityDevicesDeviceUsersLookup(parent, opts)
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'wipeDeviceUserRequest': new CloudIdentityApi.WipeDeviceUserRequest() // WipeDeviceUserRequest | 
};
 ...
 **uploadProtocol** | **String**| Upload protocol for media (e.g. \&quot;raw\&quot;, \&quot;multipart\&quot;). | [optional] 
 **uploadType** | **String**| Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;). | [optional] 
 **wipeDeviceUserRequest** | [**WipeDeviceUserRequest**](WipeDeviceUserRequest.md)|  | [optional] 
...
> ListDevicesResponse cloudidentityDevicesList(opts)
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'customer': "customer_example", // String | Optional. [Resource name](https://cloud.google.com/apis/design/resource_names) of the customer.
  'filter': "filter_example", // String | Optional. Additional restrictions when fetching list of devices. For a list of search fields, refer to [Mobile device search fields](https://developers.google.com/admin-sdk/directory/v1/search-operators). Multiple search fields are separated by the space character.
 ...
 **uploadProtocol** | **String**| Upload protocol for media (e.g. \&quot;raw\&quot;, \&quot;multipart\&quot;). | [optional] 
 **uploadType** | **String**| Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;). | [optional] 
 **customer** | **String**| Optional. [Resource name](https://cloud.google.com/apis/design/resource_names) of the customer. | [optional] 
 **filter** | **String**| Optional. Additional restrictions when fetching list of devices. For a list of search fields, refer to [Mobile device search fields](https://developers.google.com/admin-sdk/directory/v1/search-operators). Multiple search fields are separated by the space character. | [optional] 
