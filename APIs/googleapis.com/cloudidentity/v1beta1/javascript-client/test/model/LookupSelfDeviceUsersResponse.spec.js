...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudIdentityApi.LookupSelfDeviceUsersResponse();
  });
  ...
  describe('LookupSelfDeviceUsersResponse', function() {
    it('should create an instance of LookupSelfDeviceUsersResponse', function() {
      // uncomment below and update the code to test LookupSelfDeviceUsersResponse
      //var instance = new CloudIdentityApi.LookupSelfDeviceUsersResponse();
      //expect(instance).to.be.a(CloudIdentityApi.LookupSelfDeviceUsersResponse);
    });
