...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudIdentityApi.ListDevicesResponse();
  });
  ...
  describe('ListDevicesResponse', function() {
    it('should create an instance of ListDevicesResponse', function() {
      ...
      //var instance = new CloudIdentityApi.ListDevicesResponse();
      //expect(instance).to.be.a(CloudIdentityApi.ListDevicesResponse);
    });
