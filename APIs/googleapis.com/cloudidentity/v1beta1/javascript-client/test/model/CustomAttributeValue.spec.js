...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudIdentityApi.CustomAttributeValue();
  });
  ...
  describe('CustomAttributeValue', function() {
    it('should create an instance of CustomAttributeValue', function() {
      // uncomment below and update the code to test CustomAttributeValue
      //var instance = new CloudIdentityApi.CustomAttributeValue();
      //expect(instance).to.be.a(CloudIdentityApi.CustomAttributeValue);
    });
