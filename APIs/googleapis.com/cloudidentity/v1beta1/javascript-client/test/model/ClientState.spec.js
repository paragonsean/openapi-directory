...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudIdentityApi.ClientState();
  });
  ...
  describe('ClientState', function() {
    it('should create an instance of ClientState', function() {
      // uncomment below and update the code to test ClientState
      //var instance = new CloudIdentityApi.ClientState();
      //expect(instance).to.be.a(CloudIdentityApi.ClientState);
    });
