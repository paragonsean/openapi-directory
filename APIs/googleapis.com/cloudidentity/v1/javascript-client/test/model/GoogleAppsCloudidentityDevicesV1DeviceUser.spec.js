...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudIdentityApi.GoogleAppsCloudidentityDevicesV1DeviceUser();
  });
  ...
  describe('GoogleAppsCloudidentityDevicesV1DeviceUser', function() {
    it('should create an instance of GoogleAppsCloudidentityDevicesV1DeviceUser', function() {
      // uncomment below and update the code to test GoogleAppsCloudidentityDevicesV1DeviceUser
      //var instance = new CloudIdentityApi.GoogleAppsCloudidentityDevicesV1DeviceUser();
      //expect(instance).to.be.a(CloudIdentityApi.GoogleAppsCloudidentityDevicesV1DeviceUser);
    });
