...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudIdentityApi.UserInvitation();
  });
  ...
  describe('UserInvitation', function() {
    it('should create an instance of UserInvitation', function() {
      ...
      //var instance = new CloudIdentityApi.UserInvitation();
      //expect(instance).to.be.a(CloudIdentityApi.UserInvitation);
    });

    it('should have the property mailsSentCount (base name: "mailsSentCount")', function() {
      // uncomment below and update the code to test the property mailsSentCount
      //var instance = new CloudIdentityApi.UserInvitation();
