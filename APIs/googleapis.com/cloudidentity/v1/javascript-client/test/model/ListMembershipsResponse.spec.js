...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudIdentityApi.ListMembershipsResponse();
  });
  ...
  describe('ListMembershipsResponse', function() {
    it('should create an instance of ListMembershipsResponse', function() {
      ...
      //var instance = new CloudIdentityApi.ListMembershipsResponse();
      //expect(instance).to.be.a(CloudIdentityApi.ListMembershipsResponse);
    });
