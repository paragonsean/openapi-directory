...
(function(root, factory) {
  ...
  describe('GroupsApi', function() {
    ...
    describe('cloudidentityGroupsMembershipsList', function() {
      it('should call cloudidentityGroupsMembershipsList successfully', function(done) {
        //uncomment below and update the code to test cloudidentityGroupsMembershipsList
        //instance.cloudidentityGroupsMembershipsList(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
