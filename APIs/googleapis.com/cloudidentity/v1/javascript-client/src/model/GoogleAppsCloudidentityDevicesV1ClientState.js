...
/**
 * The GoogleAppsCloudidentityDevicesV1ClientState model module.
 * @module model/GoogleAppsCloudidentityDevicesV1ClientState
 * @version v1
 */
class GoogleAppsCloudidentityDevicesV1ClientState {
    /**
     * Constructs a new <code>GoogleAppsCloudidentityDevicesV1ClientState</code>.
     * Represents the state associated with an API client calling the Devices API. Resource representing ClientState and supports updates from API users
     * @alias module:model/GoogleAppsCloudidentityDevicesV1ClientState
     */
    constructor() { 
        
        GoogleAppsCloudidentityDevicesV1ClientState.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleAppsCloudidentityDevicesV1ClientState</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleAppsCloudidentityDevicesV1ClientState} obj Optional instance to populate.
     * @return {module:model/GoogleAppsCloudidentityDevicesV1ClientState} The populated <code>GoogleAppsCloudidentityDevicesV1ClientState</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleAppsCloudidentityDevicesV1ClientState();
            ...
            if (data.hasOwnProperty('keyValuePairs')) {
                obj['keyValuePairs'] = ApiClient.convertToType(data['keyValuePairs'], {'String': GoogleAppsCloudidentityDevicesV1CustomAttributeValue});
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleAppsCloudidentityDevicesV1ClientState</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleAppsCloudidentityDevicesV1ClientState</code>.
     */
 ...
 */
GoogleAppsCloudidentityDevicesV1ClientState.prototype['assetTags'] = undefined;

/**
 * The compliance state of the resource as specified by the API client.
 * @member {module:model/GoogleAppsCloudidentityDevicesV1ClientState.ComplianceStateEnum} complianceState
 */
GoogleAppsCloudidentityDevicesV1ClientState.prototype['complianceState'] = undefined;

/**
 * Output only. The time the client state data was created.
 * @member {String} createTime
 */
GoogleAppsCloudidentityDevicesV1ClientState.prototype['createTime'] = undefined;

/**
 * This field may be used to store a unique identifier for the API resource within which these CustomAttributes are a field.
 * @member {String} customId
 */
GoogleAppsCloudidentityDevicesV1ClientState.prototype['customId'] = undefined;

/**
 * The token that needs to be passed back for concurrency control in updates. Token needs to be passed back in UpdateRequest
 * @member {String} etag
 */
GoogleAppsCloudidentityDevicesV1ClientState.prototype['etag'] = undefined;
 ...
 * @member {module:model/GoogleAppsCloudidentityDevicesV1ClientState.HealthScoreEnum} healthScore
 */
GoogleAppsCloudidentityDevicesV1ClientState.prototype['healthScore'] = undefined;
 ...
 * @member {Object.<String, module:model/GoogleAppsCloudidentityDevicesV1CustomAttributeValue>} keyValuePairs
 */
GoogleAppsCloudidentityDevicesV1ClientState.prototype['keyValuePairs'] = undefined;

/**
 * Output only. The time the client state data was last updated.
 * @member {String} lastUpdateTime
 */
GoogleAppsCloudidentityDevicesV1ClientState.prototype['lastUpdateTime'] = undefined;

/**
 * The management state of the resource as specified by the API client.
 * @member {module:model/GoogleAppsCloudidentityDevicesV1ClientState.ManagedEnum} managed
 */
GoogleAppsCloudidentityDevicesV1ClientState.prototype['managed'] = undefined;
 ...
 * @member {String} name
 */
GoogleAppsCloudidentityDevicesV1ClientState.prototype['name'] = undefined;

/**
 * Output only. The owner of the ClientState
 * @member {module:model/GoogleAppsCloudidentityDevicesV1ClientState.OwnerTypeEnum} ownerType
 */
GoogleAppsCloudidentityDevicesV1ClientState.prototype['ownerType'] = undefined;

/**
 * A descriptive cause of the health score.
 * @member {String} scoreReason
 */
GoogleAppsCloudidentityDevicesV1ClientState.prototype['scoreReason'] = undefined;
 ...
 * @readonly
 */
GoogleAppsCloudidentityDevicesV1ClientState['ComplianceStateEnum'] = {
 ...
 * @readonly
 */
GoogleAppsCloudidentityDevicesV1ClientState['HealthScoreEnum'] = {
 ...
 * @readonly
 */
GoogleAppsCloudidentityDevicesV1ClientState['ManagedEnum'] = {
 ...
 * @readonly
 */
GoogleAppsCloudidentityDevicesV1ClientState['OwnerTypeEnum'] = {
...
export default GoogleAppsCloudidentityDevicesV1ClientState;
