...
public class GoogleAppsCloudidentityDevicesV1DeviceUser {
  ...
  public GoogleAppsCloudidentityDevicesV1DeviceUser compromisedState(CompromisedStateEnum compromisedState) {
  ...
  public GoogleAppsCloudidentityDevicesV1DeviceUser createTime(String createTime) {
  ...
  public GoogleAppsCloudidentityDevicesV1DeviceUser passwordState(PasswordStateEnum passwordState) {
  ...
  public GoogleAppsCloudidentityDevicesV1DeviceUser userEmail(String userEmail) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleAppsCloudidentityDevicesV1DeviceUser googleAppsCloudidentityDevicesV1DeviceUser = (GoogleAppsCloudidentityDevicesV1DeviceUser) o;
    return Objects.equals(this.compromisedState, googleAppsCloudidentityDevicesV1DeviceUser.compromisedState) &&
        Objects.equals(this.createTime, googleAppsCloudidentityDevicesV1DeviceUser.createTime) &&
        Objects.equals(this.firstSyncTime, googleAppsCloudidentityDevicesV1DeviceUser.firstSyncTime) &&
        Objects.equals(this.languageCode, googleAppsCloudidentityDevicesV1DeviceUser.languageCode) &&
        Objects.equals(this.lastSyncTime, googleAppsCloudidentityDevicesV1DeviceUser.lastSyncTime) &&
        Objects.equals(this.managementState, googleAppsCloudidentityDevicesV1DeviceUser.managementState) &&
        Objects.equals(this.name, googleAppsCloudidentityDevicesV1DeviceUser.name) &&
        Objects.equals(this.passwordState, googleAppsCloudidentityDevicesV1DeviceUser.passwordState) &&
        Objects.equals(this.userAgent, googleAppsCloudidentityDevicesV1DeviceUser.userAgent) &&
        Objects.equals(this.userEmail, googleAppsCloudidentityDevicesV1DeviceUser.userEmail);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleAppsCloudidentityDevicesV1DeviceUser {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleAppsCloudidentityDevicesV1DeviceUser
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleAppsCloudidentityDevicesV1DeviceUser.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleAppsCloudidentityDevicesV1DeviceUser is not found in the empty JSON string", GoogleAppsCloudidentityDevicesV1DeviceUser.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleAppsCloudidentityDevicesV1DeviceUser.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleAppsCloudidentityDevicesV1DeviceUser` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleAppsCloudidentityDevicesV1DeviceUser.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleAppsCloudidentityDevicesV1DeviceUser' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleAppsCloudidentityDevicesV1DeviceUser> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleAppsCloudidentityDevicesV1DeviceUser.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleAppsCloudidentityDevicesV1DeviceUser>() {
           @Override
           public void write(JsonWriter out, GoogleAppsCloudidentityDevicesV1DeviceUser value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleAppsCloudidentityDevicesV1DeviceUser read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleAppsCloudidentityDevicesV1DeviceUser given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleAppsCloudidentityDevicesV1DeviceUser
   * @throws IOException if the JSON string is invalid with respect to GoogleAppsCloudidentityDevicesV1DeviceUser
   */
  public static GoogleAppsCloudidentityDevicesV1DeviceUser fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleAppsCloudidentityDevicesV1DeviceUser.class);
  }

  /**
   * Convert an instance of GoogleAppsCloudidentityDevicesV1DeviceUser to an JSON string
   *
   * @return JSON string
   */
