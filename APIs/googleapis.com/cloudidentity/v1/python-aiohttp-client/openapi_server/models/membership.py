...
class Membership(Model):
    ...
    def __init__(self, create_time: str=None, delivery_setting: str=None, name: str=None, preferred_member_key: EntityKey=None, roles: List[MembershipRole]=None, type: str=None, update_time: str=None):
