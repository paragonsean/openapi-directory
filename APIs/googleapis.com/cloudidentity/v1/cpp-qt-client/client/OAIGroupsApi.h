...
public:
    ...
    * @param[in]  view QString [optional]
    */
    virtual void cloudidentity_groups_memberships_list(const QString &parent, const ::OpenAPI::OptionalParam<QString> &_xgafv = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &access_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &alt = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &callback = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &fields = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &key = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &oauth_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &pretty_print = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &quota_user = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &upload_protocol = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &upload_type = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &page_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &view = ::OpenAPI::OptionalParam<QString>());
...
private:
    ...
    void cloudidentity_groups_memberships_listCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void cloudidentity_groups_memberships_listSignal(OAIListMembershipsResponse summary);
    ...
    void cloudidentity_groups_memberships_listSignalFull(OAIHttpRequestWorker *worker, OAIListMembershipsResponse summary);
    ...
    Q_DECL_DEPRECATED_X("Use cloudidentity_groups_memberships_listSignalError() instead")
    void cloudidentity_groups_memberships_listSignalE(OAIListMembershipsResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void cloudidentity_groups_memberships_listSignalError(OAIListMembershipsResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use cloudidentity_groups_memberships_listSignalErrorFull() instead")
    void cloudidentity_groups_memberships_listSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void cloudidentity_groups_memberships_listSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
