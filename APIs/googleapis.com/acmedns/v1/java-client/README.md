...
ACME DNS API
- API version: v1
  - Build date: 2024-10-12T11:36:06.018144-04:00[America/New_York]
...
------------ | ------------- | ------------- | -------------
*AcmeChallengeSetsApi* | [**acmednsAcmeChallengeSetsGet**](docs/AcmeChallengeSetsApi.md#acmednsAcmeChallengeSetsGet) | **GET** /v1/acmeChallengeSets/{rootDomain} | 
*AcmeChallengeSetsApi* | [**acmednsAcmeChallengeSetsRotateChallenges**](docs/AcmeChallengeSetsApi.md#acmednsAcmeChallengeSetsRotateChallenges) | **POST** /v1/acmeChallengeSets/{rootDomain}:rotateChallenges | 
