...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudIoTApi.PublicKeyCertificate();
  });
  ...
  describe('PublicKeyCertificate', function() {
    it('should create an instance of PublicKeyCertificate', function() {
      ...
      //var instance = new CloudIoTApi.PublicKeyCertificate();
      //expect(instance).to.be.a(CloudIoTApi.PublicKeyCertificate);
    });
