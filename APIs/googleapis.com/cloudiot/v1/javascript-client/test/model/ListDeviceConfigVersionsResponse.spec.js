...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudIoTApi.ListDeviceConfigVersionsResponse();
  });
  ...
  describe('ListDeviceConfigVersionsResponse', function() {
    it('should create an instance of ListDeviceConfigVersionsResponse', function() {
      ...
      //var instance = new CloudIoTApi.ListDeviceConfigVersionsResponse();
      //expect(instance).to.be.a(CloudIoTApi.ListDeviceConfigVersionsResponse);
    });
