...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudIoTApi.ListDeviceRegistriesResponse();
  });
  ...
  describe('ListDeviceRegistriesResponse', function() {
    it('should create an instance of ListDeviceRegistriesResponse', function() {
      ...
      //var instance = new CloudIoTApi.ListDeviceRegistriesResponse();
      //expect(instance).to.be.a(CloudIoTApi.ListDeviceRegistriesResponse);
    });
