...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudIoTApi.X509CertificateDetails();
  });
  ...
  describe('X509CertificateDetails', function() {
    it('should create an instance of X509CertificateDetails', function() {
      ...
      //var instance = new CloudIoTApi.X509CertificateDetails();
      //expect(instance).to.be.a(CloudIoTApi.X509CertificateDetails);
    });
