...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BigQueryDataTransferApi.TransferMessage();
  });
  ...
  describe('TransferMessage', function() {
    it('should create an instance of TransferMessage', function() {
      // uncomment below and update the code to test TransferMessage
      //var instance = new BigQueryDataTransferApi.TransferMessage();
      //expect(instance).to.be.a(BigQueryDataTransferApi.TransferMessage);
    });
