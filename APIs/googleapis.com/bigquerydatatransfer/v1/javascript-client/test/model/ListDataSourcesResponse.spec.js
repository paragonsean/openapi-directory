...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BigQueryDataTransferApi.ListDataSourcesResponse();
  });
  ...
  describe('ListDataSourcesResponse', function() {
    it('should create an instance of ListDataSourcesResponse', function() {
      // uncomment below and update the code to test ListDataSourcesResponse
      //var instance = new BigQueryDataTransferApi.ListDataSourcesResponse();
      //expect(instance).to.be.a(BigQueryDataTransferApi.ListDataSourcesResponse);
    });
