...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BigQueryDataTransferApi.ListLocationsResponse();
  });
  ...
  describe('ListLocationsResponse', function() {
    it('should create an instance of ListLocationsResponse', function() {
      ...
      //var instance = new BigQueryDataTransferApi.ListLocationsResponse();
      //expect(instance).to.be.a(BigQueryDataTransferApi.ListLocationsResponse);
    });
