...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BigQueryDataTransferApi.Location();
  });
  ...
  describe('Location', function() {
    it('should create an instance of Location', function() {
      ...
      //var instance = new BigQueryDataTransferApi.Location();
      //expect(instance).to.be.a(BigQueryDataTransferApi.Location);
    });
