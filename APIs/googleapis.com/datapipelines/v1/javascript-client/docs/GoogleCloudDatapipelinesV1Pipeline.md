# DataPipelinesApi.GoogleCloudDatapipelinesV1Pipeline
...
**jobCount** | **Number** | Output only. Number of jobs. | [optional] [readonly] 
...
**pipelineSources** | **{String: String}** | Immutable. The sources of the pipeline (for example, Dataplex). The keys and values are set by the corresponding sources during pipeline creation. | [optional] 
...
**state** | **String** | Required. The state of the pipeline. When the pipeline is created, the state is set to &#39;PIPELINE_STATE_ACTIVE&#39; by default. State changes can be requested by setting the state to stopping, paused, or resuming. State cannot be changed through UpdatePipeline requests. | [optional] 
**type** | **String** | Required. The type of the pipeline. This field affects the scheduling of the pipeline and the type of metrics to show for the pipeline. | [optional] 
...
* `RESUMING` (value: `"STATE_RESUMING"`)

* `ACTIVE` (value: `"STATE_ACTIVE"`)

* `STOPPING` (value: `"STATE_STOPPING"`)

* `ARCHIVED` (value: `"STATE_ARCHIVED"`)
...
* `UNSPECIFIED` (value: `"PIPELINE_TYPE_UNSPECIFIED"`)

* `BATCH` (value: `"PIPELINE_TYPE_BATCH"`)

* `STREAMING` (value: `"PIPELINE_TYPE_STREAMING"`)
