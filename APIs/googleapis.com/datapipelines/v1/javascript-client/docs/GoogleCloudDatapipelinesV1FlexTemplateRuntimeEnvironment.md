# DataPipelinesApi.GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**additionalExperiments** | **[String]** | Additional experiment flags for the job. | [optional] 
**additionalUserLabels** | **{String: String}** | Additional user labels to be specified for the job. Keys and values must follow the restrictions specified in the [labeling restrictions](https://cloud.google.com/compute/docs/labeling-resources#restrictions). An object containing a list of key/value pairs. Example: &#x60;{ \&quot;name\&quot;: \&quot;wrench\&quot;, \&quot;mass\&quot;: \&quot;1kg\&quot;, \&quot;count\&quot;: \&quot;3\&quot; }&#x60;. | [optional] 
**enableStreamingEngine** | **Boolean** | Whether to enable Streaming Engine for the job. | [optional] 
**flexrsGoal** | **String** | Set FlexRS goal for the job. https://cloud.google.com/dataflow/docs/guides/flexrs | [optional] 
...
**maxWorkers** | **Number** | The maximum number of Compute Engine instances to be made available to your pipeline during execution, from 1 to 1000. | [optional] 
...
**numWorkers** | **Number** | The initial number of Compute Engine instances for the job. | [optional] 
