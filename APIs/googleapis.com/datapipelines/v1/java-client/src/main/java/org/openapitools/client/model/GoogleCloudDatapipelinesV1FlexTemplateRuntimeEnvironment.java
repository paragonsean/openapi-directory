...
public class GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment {
  ...
  public GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment additionalExperiments(List<String> additionalExperiments) {
    this.additionalExperiments = additionalExperiments;
    return this;
  }

  public GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment addAdditionalExperimentsItem(String additionalExperimentsItem) {
  ...
  public GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment additionalUserLabels(Map<String, String> additionalUserLabels) {
    this.additionalUserLabels = additionalUserLabels;
    return this;
  }

  public GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment putAdditionalUserLabelsItem(String key, String additionalUserLabelsItem) {
  ...
  public GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment enableStreamingEngine(Boolean enableStreamingEngine) {
  ...
  public GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment flexrsGoal(FlexrsGoalEnum flexrsGoal) {
  ...
  public GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment ipConfiguration(IpConfigurationEnum ipConfiguration) {
  ...
  public GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment kmsKeyName(String kmsKeyName) {
  ...
  public GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment machineType(String machineType) {
  ...
  public GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment maxWorkers(Integer maxWorkers) {
  ...
  public GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment network(String network) {
  ...
  public GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment numWorkers(Integer numWorkers) {
  ...
  public GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment serviceAccountEmail(String serviceAccountEmail) {
  ...
  public GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment subnetwork(String subnetwork) {
  ...
  public GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment tempLocation(String tempLocation) {
  ...
  public GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment workerRegion(String workerRegion) {
  ...
  public GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment workerZone(String workerZone) {
  ...
  public GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment zone(String zone) {
    this.zone = zone;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment googleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment = (GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment) o;
    return Objects.equals(this.additionalExperiments, googleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment.additionalExperiments) &&
        Objects.equals(this.additionalUserLabels, googleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment.additionalUserLabels) &&
        Objects.equals(this.enableStreamingEngine, googleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment.enableStreamingEngine) &&
        Objects.equals(this.flexrsGoal, googleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment.flexrsGoal) &&
        Objects.equals(this.ipConfiguration, googleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment.ipConfiguration) &&
        Objects.equals(this.kmsKeyName, googleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment.kmsKeyName) &&
        Objects.equals(this.machineType, googleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment.machineType) &&
        Objects.equals(this.maxWorkers, googleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment.maxWorkers) &&
        Objects.equals(this.network, googleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment.network) &&
        Objects.equals(this.numWorkers, googleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment.numWorkers) &&
        Objects.equals(this.serviceAccountEmail, googleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment.serviceAccountEmail) &&
        Objects.equals(this.subnetwork, googleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment.subnetwork) &&
        Objects.equals(this.tempLocation, googleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment.tempLocation) &&
        Objects.equals(this.workerRegion, googleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment.workerRegion) &&
        Objects.equals(this.workerZone, googleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment.workerZone) &&
        Objects.equals(this.zone, googleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment.zone);
  }

  @Override
  public int hashCode() {
    return Objects.hash(additionalExperiments, additionalUserLabels, enableStreamingEngine, flexrsGoal, ipConfiguration, kmsKeyName, machineType, maxWorkers, network, numWorkers, serviceAccountEmail, subnetwork, tempLocation, workerRegion, workerZone, zone);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment is not found in the empty JSON string", GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment>() {
           @Override
           public void write(JsonWriter out, GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment
   */
  public static GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment.class);
  }

  /**
   * Convert an instance of GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment to an JSON string
   *
   * @return JSON string
   */
