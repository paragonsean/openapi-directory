...
void OAILocation::initializeModel() {
    ...
    m_radius_in_miles_isSet = false;
    m_radius_in_miles_isValid = false;
}
...
void OAILocation::fromJsonObject(QJsonObject json) {
    ...
    m_radius_in_miles_isValid = ::OpenAPI::fromJsonValue(m_radius_in_miles, json[QString("radiusInMiles")]);
    m_radius_in_miles_isSet = !json[QString("radiusInMiles")].isNull() && m_radius_in_miles_isValid;
}
...
QJsonObject OAILocation::asJsonObject() const {
    ...
    if (m_radius_in_miles_isSet) {
        obj.insert(QString("radiusInMiles"), ::OpenAPI::toJsonValue(m_radius_in_miles));
    }
    return obj;
}
...
double OAILocation::getRadiusInMiles() const {
    return m_radius_in_miles;
}
void OAILocation::setRadiusInMiles(const double &radius_in_miles) {
    m_radius_in_miles = radius_in_miles;
    m_radius_in_miles_isSet = true;
}

bool OAILocation::is_radius_in_miles_Set() const{
    return m_radius_in_miles_isSet;
}

bool OAILocation::is_radius_in_miles_Valid() const{
    return m_radius_in_miles_isValid;
}
