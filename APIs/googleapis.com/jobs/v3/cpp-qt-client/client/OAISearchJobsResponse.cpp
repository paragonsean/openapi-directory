...
void OAISearchJobsResponse::initializeModel() {
    ...
    m_estimated_total_size_isSet = false;
    m_estimated_total_size_isValid = false;

    m_histogram_results_isSet = false;
    m_histogram_results_isValid = false;
...
void OAISearchJobsResponse::fromJsonObject(QJsonObject json) {
    ...
    m_estimated_total_size_isValid = ::OpenAPI::fromJsonValue(m_estimated_total_size, json[QString("estimatedTotalSize")]);
    m_estimated_total_size_isSet = !json[QString("estimatedTotalSize")].isNull() && m_estimated_total_size_isValid;

    m_histogram_results_isValid = ::OpenAPI::fromJsonValue(m_histogram_results, json[QString("histogramResults")]);
    m_histogram_results_isSet = !json[QString("histogramResults")].isNull() && m_histogram_results_isValid;
...
QJsonObject OAISearchJobsResponse::asJsonObject() const {
    ...
    if (m_estimated_total_size_isSet) {
        obj.insert(QString("estimatedTotalSize"), ::OpenAPI::toJsonValue(m_estimated_total_size));
    }
    if (m_histogram_results.isSet()) {
        obj.insert(QString("histogramResults"), ::OpenAPI::toJsonValue(m_histogram_results));
    }
...
qint32 OAISearchJobsResponse::getEstimatedTotalSize() const {
    return m_estimated_total_size;
}
void OAISearchJobsResponse::setEstimatedTotalSize(const qint32 &estimated_total_size) {
    m_estimated_total_size = estimated_total_size;
    m_estimated_total_size_isSet = true;
}

bool OAISearchJobsResponse::is_estimated_total_size_Set() const{
    return m_estimated_total_size_isSet;
}

bool OAISearchJobsResponse::is_estimated_total_size_Valid() const{
    return m_estimated_total_size_isValid;
}

OAIHistogramResults OAISearchJobsResponse::getHistogramResults() const {
    return m_histogram_results;
}
void OAISearchJobsResponse::setHistogramResults(const OAIHistogramResults &histogram_results) {
    m_histogram_results = histogram_results;
    m_histogram_results_isSet = true;
}

bool OAISearchJobsResponse::is_histogram_results_Set() const{
    return m_histogram_results_isSet;
}

bool OAISearchJobsResponse::is_histogram_results_Valid() const{
    return m_histogram_results_isValid;
}
