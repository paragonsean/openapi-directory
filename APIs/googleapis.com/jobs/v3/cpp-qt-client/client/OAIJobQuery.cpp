...
void OAIJobQuery::initializeModel() {
    ...
    m_company_names_isSet = false;
    m_company_names_isValid = false;
...
void OAIJobQuery::fromJsonObject(QJsonObject json) {
    ...
    m_company_names_isValid = ::OpenAPI::fromJsonValue(m_company_names, json[QString("companyNames")]);
    m_company_names_isSet = !json[QString("companyNames")].isNull() && m_company_names_isValid;
...
QJsonObject OAIJobQuery::asJsonObject() const {
    ...
    if (m_company_names.size() > 0) {
        obj.insert(QString("companyNames"), ::OpenAPI::toJsonValue(m_company_names));
    }
...
QList<QString> OAIJobQuery::getCompanyNames() const {
    return m_company_names;
}
void OAIJobQuery::setCompanyNames(const QList<QString> &company_names) {
    m_company_names = company_names;
    m_company_names_isSet = true;
}

bool OAIJobQuery::is_company_names_Set() const{
    return m_company_names_isSet;
}

bool OAIJobQuery::is_company_names_Valid() const{
    return m_company_names_isValid;
}
