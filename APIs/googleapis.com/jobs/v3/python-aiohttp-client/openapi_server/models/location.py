...
class Location(Model):
    ...
    def __init__(self, lat_lng: LatLng=None, location_type: str=None, postal_address: PostalAddress=None, radius_in_miles: float=None):
        ...
        :param radius_in_miles: The radius_in_miles of this Location.
        """
        self.openapi_types = {
            'lat_lng': LatLng,
            'location_type': str,
        ...
        self._radius_in_miles = radius_in_miles
    ...
    @property
    def radius_in_miles(self):
        """Gets the radius_in_miles of this Location.
        ...
        :return: The radius_in_miles of this Location.
        :rtype: float
        """
        return self._radius_in_miles

    @radius_in_miles.setter
    def radius_in_miles(self, radius_in_miles):
        """Sets the radius_in_miles of this Location.

        Radius in miles of the job location. This value is derived from the location bounding box in which a circle with the specified radius centered from LatLng covers the area associated with the job location. For example, currently, \"Mountain View, CA, USA\" has a radius of 6.17 miles.

        :param radius_in_miles: The radius_in_miles of this Location.
        :type radius_in_miles: float
        """
