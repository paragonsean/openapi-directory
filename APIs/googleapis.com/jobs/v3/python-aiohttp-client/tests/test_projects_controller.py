...
async def test_jobs_projects_client_events_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v3/{parent}/clientEvents'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_jobs_projects_companies_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v3/{parent}/companies'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_jobs_projects_complete(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/{namecomplet}'.format(name='name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_jobs_projects_jobs_batch_delete(client):
    ...
    response = await client.request(
        method='POST',
        path='/v3/{parent}/jobs:batchDelete'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_jobs_projects_jobs_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v3/{parent}/jobs'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_jobs_projects_jobs_get(client):
    """Test case for jobs_projects_jobs_get
...
async def test_jobs_projects_jobs_search(client):
    ...
    response = await client.request(
        method='POST',
        path='/v3/{parent}/jobs:search'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_jobs_projects_jobs_search_for_alert(client):
    ...
    response = await client.request(
        method='POST',
        path='/v3/{parent}/jobs:searchForAlert'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
