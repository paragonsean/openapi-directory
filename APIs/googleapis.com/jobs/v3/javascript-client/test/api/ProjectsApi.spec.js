...
(function(root, factory) {
  ...
  describe('ProjectsApi', function() {
    ...
    describe('jobsProjectsJobsGet', function() {
      it('should call jobsProjectsJobsGet successfully', function(done) {
        //uncomment below and update the code to test jobsProjectsJobsGet
        //instance.jobsProjectsJobsGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
