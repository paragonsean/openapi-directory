...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudTalentSolutionApi.TimeOfDay();
  });
  ...
  describe('TimeOfDay', function() {
    it('should create an instance of TimeOfDay', function() {
      ...
      //var instance = new CloudTalentSolutionApi.TimeOfDay();
      //expect(instance).to.be.a(CloudTalentSolutionApi.TimeOfDay);
    });
