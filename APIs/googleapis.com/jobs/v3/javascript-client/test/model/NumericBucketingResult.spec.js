...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudTalentSolutionApi.NumericBucketingResult();
  });
  ...
  describe('NumericBucketingResult', function() {
    it('should create an instance of NumericBucketingResult', function() {
      // uncomment below and update the code to test NumericBucketingResult
      //var instance = new CloudTalentSolutionApi.NumericBucketingResult();
      //expect(instance).to.be.a(CloudTalentSolutionApi.NumericBucketingResult);
    });
