...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudTalentSolutionApi.CreateJobRequest();
  });
  ...
  describe('CreateJobRequest', function() {
    it('should create an instance of CreateJobRequest', function() {
      ...
      //var instance = new CloudTalentSolutionApi.CreateJobRequest();
      //expect(instance).to.be.a(CloudTalentSolutionApi.CreateJobRequest);
    });
