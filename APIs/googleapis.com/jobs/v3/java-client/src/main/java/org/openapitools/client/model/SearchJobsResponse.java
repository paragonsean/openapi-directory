...
public class SearchJobsResponse {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(broadenedQueryJobsCount, estimatedTotalSize, histogramResults, locationFilters, matchingJobs, metadata, nextPageToken, spellCorrection, totalSize);
  }
