...
public class JobQuery {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(commuteFilter, companyDisplayNames, companyNames, compensationFilter, customAttributeFilter, disableSpellCheck, employmentTypes, jobCategories, languageCodes, locationFilters, publishTimeRange, query, queryLanguageCode);
  }
