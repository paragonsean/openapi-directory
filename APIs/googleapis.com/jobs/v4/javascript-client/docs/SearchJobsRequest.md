...
**pageToken** | **String** | The token specifying the current offset within search results. See SearchJobsResponse.next_page_token for an explanation of how to obtain the next set of query results. | [optional] 
**requestMetadata** | [**RequestMetadata**](RequestMetadata.md) |  | [optional] 
**searchMode** | **String** | Mode of a search. Defaults to SearchMode.JOB_SEARCH. | [optional] 



## Enum: DiversificationLevelEnum


* `DIVERSIFICATION_LEVEL_UNSPECIFIED` (value: `"DIVERSIFICATION_LEVEL_UNSPECIFIED"`)

* `DISABLED` (value: `"DISABLED"`)

* `SIMPLE` (value: `"SIMPLE"`)

* `ONE_PER_COMPANY` (value: `"ONE_PER_COMPANY"`)

* `TWO_PER_COMPANY` (value: `"TWO_PER_COMPANY"`)

* `MAX_THREE_PER_COMPANY` (value: `"MAX_THREE_PER_COMPANY"`)

* `DIVERSIFY_BY_LOOSER_SIMILARITY` (value: `"DIVERSIFY_BY_LOOSER_SIMILARITY"`)
...
* `UNSPECIFIED` (value: `"JOB_VIEW_UNSPECIFIED"`)

* `ID_ONLY` (value: `"JOB_VIEW_ID_ONLY"`)

* `MINIMAL` (value: `"JOB_VIEW_MINIMAL"`)

* `SMALL` (value: `"JOB_VIEW_SMALL"`)

* `FULL` (value: `"JOB_VIEW_FULL"`)





## Enum: KeywordMatchModeEnum


* `MODE_UNSPECIFIED` (value: `"KEYWORD_MATCH_MODE_UNSPECIFIED"`)

* `DISABLED` (value: `"KEYWORD_MATCH_DISABLED"`)

* `ALL` (value: `"KEYWORD_MATCH_ALL"`)

* `TITLE_ONLY` (value: `"KEYWORD_MATCH_TITLE_ONLY"`)
...
* `SEARCH_MODE_UNSPECIFIED` (value: `"SEARCH_MODE_UNSPECIFIED"`)

* `JOB_SEARCH` (value: `"JOB_SEARCH"`)

* `FEATURED_JOB_SEARCH` (value: `"FEATURED_JOB_SEARCH"`)
