# CloudTalentSolutionApi.CustomRankingInfo

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**importanceLevel** | **String** | Required. Controls over how important the score of CustomRankingInfo.ranking_expression gets applied to job&#39;s final ranking position. An error is thrown if not specified. | [optional] 
...
* `IMPORTANCE_LEVEL_UNSPECIFIED` (value: `"IMPORTANCE_LEVEL_UNSPECIFIED"`)
