...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudTalentSolutionApi.ListTenantsResponse();
  });
  ...
  describe('ListTenantsResponse', function() {
    it('should create an instance of ListTenantsResponse', function() {
      // uncomment below and update the code to test ListTenantsResponse
      //var instance = new CloudTalentSolutionApi.ListTenantsResponse();
      //expect(instance).to.be.a(CloudTalentSolutionApi.ListTenantsResponse);
    });
