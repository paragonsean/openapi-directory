...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudTalentSolutionApi.Operation();
  });
  ...
  describe('Operation', function() {
    it('should create an instance of Operation', function() {
      ...
      //var instance = new CloudTalentSolutionApi.Operation();
      //expect(instance).to.be.a(CloudTalentSolutionApi.Operation);
    });
