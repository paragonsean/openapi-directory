...
class RequestMetadata {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('allowMissingIds')) {
                obj['allowMissingIds'] = ApiClient.convertToType(data['allowMissingIds'], 'Boolean');
            }
 ...
 */
RequestMetadata.prototype['allowMissingIds'] = undefined;
