...
class JobQuery {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('excludedJobs')) {
                obj['excludedJobs'] = ApiClient.convertToType(data['excludedJobs'], ['String']);
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is an array
        if (!Array.isArray(data['excludedJobs'])) {
            throw new Error("Expected the field `excludedJobs` to be an array in the JSON data but got " + data['excludedJobs']);
        }
        // ensure the json data is an array
 ...
 */
JobQuery.prototype['companies'] = undefined;
 ...
 */
JobQuery.prototype['excludedJobs'] = undefined;
