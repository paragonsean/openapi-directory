...
class CustomAttribute {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('keywordSearchable')) {
                obj['keywordSearchable'] = ApiClient.convertToType(data['keywordSearchable'], 'Boolean');
            }
 ...
 */
CustomAttribute.prototype['keywordSearchable'] = undefined;
