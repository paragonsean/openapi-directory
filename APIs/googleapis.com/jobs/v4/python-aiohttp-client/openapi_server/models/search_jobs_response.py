...
class SearchJobsResponse(Model):
    ...
    def __init__(self, broadened_query_jobs_count: int=None, histogram_query_results: List[HistogramQueryResult]=None, location_filters: List[Location]=None, matching_jobs: List[MatchingJob]=None, metadata: ResponseMetadata=None, next_page_token: str=None, spell_correction: SpellingCorrection=None, total_size: int=None):
