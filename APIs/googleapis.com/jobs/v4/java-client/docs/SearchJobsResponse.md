...
|**locationFilters** | [**List&lt;Location&gt;**](Location.md) | The location filters that the service applied to the specified query. If any filters are lat-lng based, the Location.location_type is Location.LocationType.LOCATION_TYPE_UNSPECIFIED. |  [optional] |
...
|**totalSize** | **Integer** | Number of jobs that match the specified query. Note: This size is precise only if the total is less than 100,000. |  [optional] |
