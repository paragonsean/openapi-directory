...
public class JobQuery {
  ...
  public JobQuery companies(List<String> companies) {
    this.companies = companies;
    return this;
  }

  public JobQuery addCompaniesItem(String companiesItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.commuteFilter, jobQuery.commuteFilter) &&
        Objects.equals(this.companies, jobQuery.companies) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(commuteFilter, companies, companyDisplayNames, compensationFilter, customAttributeFilter, disableSpellCheck, employmentTypes, excludedJobs, jobCategories, languageCodes, locationFilters, publishTimeRange, query, queryLanguageCode);
  }
