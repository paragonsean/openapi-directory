...
public:
    ...
    double getRadiusMiles() const;
    void setRadiusMiles(const double &radius_miles);
    bool is_radius_miles_Set() const;
    bool is_radius_miles_Valid() const;
...
private:
    ...
    double m_radius_miles;
    bool m_radius_miles_isSet;
    bool m_radius_miles_isValid;
};
