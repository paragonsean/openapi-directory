...
void OAIClientEvent::initializeModel() {
    ...
    m_event_notes_isSet = false;
    m_event_notes_isValid = false;
...
void OAIClientEvent::fromJsonObject(QJsonObject json) {
    ...
    m_event_notes_isValid = ::OpenAPI::fromJsonValue(m_event_notes, json[QString("eventNotes")]);
    m_event_notes_isSet = !json[QString("eventNotes")].isNull() && m_event_notes_isValid;
...
QJsonObject OAIClientEvent::asJsonObject() const {
    ...
    if (m_event_notes_isSet) {
        obj.insert(QString("eventNotes"), ::OpenAPI::toJsonValue(m_event_notes));
    }
...
QString OAIClientEvent::getEventNotes() const {
    return m_event_notes;
}
void OAIClientEvent::setEventNotes(const QString &event_notes) {
    m_event_notes = event_notes;
    m_event_notes_isSet = true;
}

bool OAIClientEvent::is_event_notes_Set() const{
    return m_event_notes_isSet;
}

bool OAIClientEvent::is_event_notes_Valid() const{
    return m_event_notes_isValid;
}
