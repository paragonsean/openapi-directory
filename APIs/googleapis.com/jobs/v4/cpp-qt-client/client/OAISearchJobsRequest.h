...
public:
    ...
    Q_DECL_DEPRECATED bool isDisableKeywordMatch() const;
    Q_DECL_DEPRECATED void setDisableKeywordMatch(const bool &disable_keyword_match);
    Q_DECL_DEPRECATED bool is_disable_keyword_match_Set() const;
    Q_DECL_DEPRECATED bool is_disable_keyword_match_Valid() const;
    ...
    QString getKeywordMatchMode() const;
    void setKeywordMatchMode(const QString &keyword_match_mode);
    bool is_keyword_match_mode_Set() const;
    bool is_keyword_match_mode_Valid() const;
...
private:
    ...
    QString m_keyword_match_mode;
    bool m_keyword_match_mode_isSet;
    bool m_keyword_match_mode_isValid;
