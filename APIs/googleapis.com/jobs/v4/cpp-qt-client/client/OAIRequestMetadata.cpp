...
void OAIRequestMetadata::initializeModel() {
    ...
    m_allow_missing_ids_isSet = false;
    m_allow_missing_ids_isValid = false;
...
void OAIRequestMetadata::fromJsonObject(QJsonObject json) {
    ...
    m_allow_missing_ids_isValid = ::OpenAPI::fromJsonValue(m_allow_missing_ids, json[QString("allowMissingIds")]);
    m_allow_missing_ids_isSet = !json[QString("allowMissingIds")].isNull() && m_allow_missing_ids_isValid;
...
QJsonObject OAIRequestMetadata::asJsonObject() const {
    QJsonObject obj;
    if (m_allow_missing_ids_isSet) {
        obj.insert(QString("allowMissingIds"), ::OpenAPI::toJsonValue(m_allow_missing_ids));
    }
...
bool OAIRequestMetadata::isAllowMissingIds() const {
    return m_allow_missing_ids;
}
void OAIRequestMetadata::setAllowMissingIds(const bool &allow_missing_ids) {
    m_allow_missing_ids = allow_missing_ids;
    m_allow_missing_ids_isSet = true;
}

bool OAIRequestMetadata::is_allow_missing_ids_Set() const{
    return m_allow_missing_ids_isSet;
}

bool OAIRequestMetadata::is_allow_missing_ids_Valid() const{
    return m_allow_missing_ids_isValid;
}
