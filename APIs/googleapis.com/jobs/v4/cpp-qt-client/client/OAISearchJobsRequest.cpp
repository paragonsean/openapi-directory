...
void OAISearchJobsRequest::initializeModel() {
    ...
    m_keyword_match_mode_isSet = false;
    m_keyword_match_mode_isValid = false;
...
void OAISearchJobsRequest::fromJsonObject(QJsonObject json) {
    ...
    m_keyword_match_mode_isValid = ::OpenAPI::fromJsonValue(m_keyword_match_mode, json[QString("keywordMatchMode")]);
    m_keyword_match_mode_isSet = !json[QString("keywordMatchMode")].isNull() && m_keyword_match_mode_isValid;
...
QJsonObject OAISearchJobsRequest::asJsonObject() const {
    ...
    if (m_keyword_match_mode_isSet) {
        obj.insert(QString("keywordMatchMode"), ::OpenAPI::toJsonValue(m_keyword_match_mode));
    }
...
QString OAISearchJobsRequest::getKeywordMatchMode() const {
    return m_keyword_match_mode;
}
void OAISearchJobsRequest::setKeywordMatchMode(const QString &keyword_match_mode) {
    m_keyword_match_mode = keyword_match_mode;
    m_keyword_match_mode_isSet = true;
}

bool OAISearchJobsRequest::is_keyword_match_mode_Set() const{
    return m_keyword_match_mode_isSet;
}

bool OAISearchJobsRequest::is_keyword_match_mode_Valid() const{
    return m_keyword_match_mode_isValid;
}

qint32 OAISearchJobsRequest::getMaxPageSize() const {
    return m_max_page_size;
}
void OAISearchJobsRequest::setMaxPageSize(const qint32 &max_page_size) {
    m_max_page_size = max_page_size;
    m_max_page_size_isSet = true;
}

bool OAISearchJobsRequest::is_max_page_size_Set() const{
    return m_max_page_size_isSet;
}

bool OAISearchJobsRequest::is_max_page_size_Valid() const{
