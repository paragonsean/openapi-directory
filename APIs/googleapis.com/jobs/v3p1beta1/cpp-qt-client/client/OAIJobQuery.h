...
public:
    ...
    QList<QString> getCompanyNames() const;
    void setCompanyNames(const QList<QString> &company_names);
    bool is_company_names_Set() const;
    bool is_company_names_Valid() const;
...
private:
    ...
    QList<QString> m_company_names;
    bool m_company_names_isSet;
    bool m_company_names_isValid;
