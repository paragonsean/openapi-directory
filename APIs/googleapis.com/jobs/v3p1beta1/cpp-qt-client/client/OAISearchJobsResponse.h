...
public:
    ...
    QList<OAIHistogramQueryResult> getHistogramQueryResults() const;
    void setHistogramQueryResults(const QList<OAIHistogramQueryResult> &histogram_query_results);
    bool is_histogram_query_results_Set() const;
    bool is_histogram_query_results_Valid() const;
...
private:
    ...
    QList<OAIHistogramQueryResult> m_histogram_query_results;
    bool m_histogram_query_results_isSet;
    bool m_histogram_query_results_isValid;
