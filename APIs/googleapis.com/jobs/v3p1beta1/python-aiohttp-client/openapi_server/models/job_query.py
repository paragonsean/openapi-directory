...
class JobQuery(Model):
    ...
    def __init__(self, commute_filter: CommuteFilter=None, company_display_names: List[str]=None, company_names: List[str]=None, compensation_filter: CompensationFilter=None, custom_attribute_filter: str=None, disable_spell_check: bool=None, employment_types: List[str]=None, excluded_jobs: List[str]=None, job_categories: List[str]=None, language_codes: List[str]=None, location_filters: List[LocationFilter]=None, publish_time_range: TimestampRange=None, query: str=None, query_language_code: str=None):
        ...
        :param company_names: The company_names of this JobQuery.
    ...
    def company_names(self):
        """Gets the company_names of this JobQuery.
        ...
        :return: The company_names of this JobQuery.
        :rtype: List[str]
        """
    ...
    def company_names(self, company_names):
        """Sets the company_names of this JobQuery.
