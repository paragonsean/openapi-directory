...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudTalentSolutionApi.ListCompaniesResponse();
  });
  ...
  describe('ListCompaniesResponse', function() {
    it('should create an instance of ListCompaniesResponse', function() {
      // uncomment below and update the code to test ListCompaniesResponse
      //var instance = new CloudTalentSolutionApi.ListCompaniesResponse();
      //expect(instance).to.be.a(CloudTalentSolutionApi.ListCompaniesResponse);
    });
