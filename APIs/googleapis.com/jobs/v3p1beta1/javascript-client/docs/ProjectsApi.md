...
------------- | ------------- | -------------
[**jobsProjectsClientEventsCreate**](ProjectsApi.md#jobsProjectsClientEventsCreate) | **POST** /v3p1beta1/{parent}/clientEvents | 
[**jobsProjectsCompaniesCreate**](ProjectsApi.md#jobsProjectsCompaniesCreate) | **POST** /v3p1beta1/{parent}/companies | 
[**jobsProjectsCompaniesList**](ProjectsApi.md#jobsProjectsCompaniesList) | **GET** /v3p1beta1/{parent}/companies | 
[**jobsProjectsComplete**](ProjectsApi.md#jobsProjectsComplete) | **GET** /v3p1beta1/{name}:complete | 
[**jobsProjectsJobsBatchDelete**](ProjectsApi.md#jobsProjectsJobsBatchDelete) | **POST** /v3p1beta1/{parent}/jobs:batchDelete | 
[**jobsProjectsJobsCreate**](ProjectsApi.md#jobsProjectsJobsCreate) | **POST** /v3p1beta1/{parent}/jobs | 
[**jobsProjectsJobsDelete**](ProjectsApi.md#jobsProjectsJobsDelete) | **DELETE** /v3p1beta1/{name} | 
[**jobsProjectsJobsList**](ProjectsApi.md#jobsProjectsJobsList) | **GET** /v3p1beta1/{parent}/jobs | 
[**jobsProjectsJobsPatch**](ProjectsApi.md#jobsProjectsJobsPatch) | **PATCH** /v3p1beta1/{name} | 
[**jobsProjectsJobsSearch**](ProjectsApi.md#jobsProjectsJobsSearch) | **POST** /v3p1beta1/{parent}/jobs:search | 
[**jobsProjectsJobsSearchForAlert**](ProjectsApi.md#jobsProjectsJobsSearchForAlert) | **POST** /v3p1beta1/{parent}/jobs:searchForAlert | 
[**jobsProjectsOperationsGet**](ProjectsApi.md#jobsProjectsOperationsGet) | **GET** /v3p1beta1/{name} | 
...
> Operation jobsProjectsOperationsGet(name, opts)
...
apiInstance.jobsProjectsOperationsGet(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
