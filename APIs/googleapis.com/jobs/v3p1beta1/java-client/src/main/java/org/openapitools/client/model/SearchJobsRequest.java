...
public class SearchJobsRequest {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(customRankingInfo, disableKeywordMatch, diversificationLevel, enableBroadening, histogramFacets, histogramQueries, jobQuery, jobView, offset, orderBy, pageSize, pageToken, requestMetadata, requirePreciseResultSize, searchMode);
  }
