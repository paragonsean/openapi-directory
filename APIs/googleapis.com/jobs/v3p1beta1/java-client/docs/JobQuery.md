...
|**excludedJobs** | **List&lt;String&gt;** | Optional. This filter specifies a list of job names to be excluded during search. At most 400 excluded job names are allowed. |  [optional] |
