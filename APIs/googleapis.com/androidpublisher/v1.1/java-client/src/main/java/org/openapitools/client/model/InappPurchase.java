 ...
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-10-12T11:48:28.412895-04:00[America/New_York]", comments = "Generator version: 7.9.0")
public class InappPurchase {
  ...
  private String kind = "androidpublisher#inappPurchase";
  ...
  public InappPurchase consumptionState(Integer consumptionState) {
  ...
  public InappPurchase developerPayload(String developerPayload) {
  ...
  public InappPurchase kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  public InappPurchase orderId(String orderId) {
  ...
  public InappPurchase purchaseState(Integer purchaseState) {
  ...
  public InappPurchase purchaseTime(String purchaseTime) {
  ...
  public InappPurchase purchaseType(Integer purchaseType) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.consumptionState, inappPurchase.consumptionState) &&
        Objects.equals(this.developerPayload, inappPurchase.developerPayload) &&
        Objects.equals(this.kind, inappPurchase.kind) &&
        Objects.equals(this.orderId, inappPurchase.orderId) &&
        Objects.equals(this.purchaseState, inappPurchase.purchaseState) &&
        Objects.equals(this.purchaseTime, inappPurchase.purchaseTime) &&
        Objects.equals(this.purchaseType, inappPurchase.purchaseType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(consumptionState, developerPayload, kind, orderId, purchaseState, purchaseTime, purchaseType);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to InappPurchase
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InappPurchase.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InappPurchase is not found in the empty JSON string", InappPurchase.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InappPurchase.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InappPurchase` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InappPurchase.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InappPurchase' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InappPurchase> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InappPurchase.class));

       return (TypeAdapter<T>) new TypeAdapter<InappPurchase>() {
           @Override
           public void write(JsonWriter out, InappPurchase value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InappPurchase read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InappPurchase given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InappPurchase
   * @throws IOException if the JSON string is invalid with respect to InappPurchase
   */
  public static InappPurchase fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InappPurchase.class);
  }

  /**
   * Convert an instance of InappPurchase to an JSON string
   *
   * @return JSON string
   */
