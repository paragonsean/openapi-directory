# GooglePlayAndroidDeveloperApi.PurchasesApi
...
> androidpublisherPurchasesProductsAcknowledge(packageName, productId, token, opts)
...
let apiInstance = new GooglePlayAndroidDeveloperApi.PurchasesApi();
...
let opts = {
  ...
  'productPurchasesAcknowledgeRequest': new GooglePlayAndroidDeveloperApi.ProductPurchasesAcknowledgeRequest() // ProductPurchasesAcknowledgeRequest | 
};
apiInstance.androidpublisherPurchasesProductsAcknowledge(packageName, productId, token, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> androidpublisherPurchasesProductsConsume(packageName, productId, token, opts)
...
apiInstance.androidpublisherPurchasesProductsConsume(packageName, productId, token, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
> androidpublisherPurchasesSubscriptionsAcknowledge(packageName, subscriptionId, token, opts)
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'subscriptionPurchasesAcknowledgeRequest': new GooglePlayAndroidDeveloperApi.SubscriptionPurchasesAcknowledgeRequest() // SubscriptionPurchasesAcknowledgeRequest | 
};
apiInstance.androidpublisherPurchasesSubscriptionsAcknowledge(packageName, subscriptionId, token, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'subscriptionPurchasesDeferRequest': new GooglePlayAndroidDeveloperApi.SubscriptionPurchasesDeferRequest() // SubscriptionPurchasesDeferRequest | 
};
...
> SubscriptionPurchaseV2 androidpublisherPurchasesSubscriptionsv2Get(packageName, token, opts)
...
let apiInstance = new GooglePlayAndroidDeveloperApi.PurchasesApi();
let packageName = "packageName_example"; // String | The package of the application for which this subscription was purchased (for example, 'com.some.thing').
let token = "token_example"; // String | Required. The token provided to the user's device when the subscription was purchased.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
apiInstance.androidpublisherPurchasesSubscriptionsv2Get(packageName, token, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Object androidpublisherPurchasesSubscriptionsv2Revoke(packageName, token, opts)
...
let apiInstance = new GooglePlayAndroidDeveloperApi.PurchasesApi();
let packageName = "packageName_example"; // String | Required. The package of the application for which this subscription was purchased (for example, 'com.some.thing').
let token = "token_example"; // String | Required. The token provided to the user's device when the subscription was purchased.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'revokeSubscriptionPurchaseRequest': new GooglePlayAndroidDeveloperApi.RevokeSubscriptionPurchaseRequest() // RevokeSubscriptionPurchaseRequest | 
};
apiInstance.androidpublisherPurchasesSubscriptionsv2Revoke(packageName, token, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let opts = {
  ...
  'startIndex': 56, // Number | Defines the index of the first element to return. This can only be used if indexed paging is enabled.
  ...
  'type': 56 // Number | The type of voided purchases that you want to see in the response. Possible values are: 0. Only voided in-app product purchases will be returned in the response. This is the default value. 1. Both voided in-app purchases and voided subscription purchases will be returned in the response. Note: Before requesting to receive voided subscription purchases, you must switch to use orderId in the response which uniquely identifies one-time purchases and subscriptions. Otherwise, you will receive multiple subscription orders with the same PurchaseToken, because subscription renewal orders share the same PurchaseToken.
};
 ...
 **startIndex** | **Number**| Defines the index of the first element to return. This can only be used if indexed paging is enabled. | [optional] 
 ...
 **type** | **Number**| The type of voided purchases that you want to see in the response. Possible values are: 0. Only voided in-app product purchases will be returned in the response. This is the default value. 1. Both voided in-app purchases and voided subscription purchases will be returned in the response. Note: Before requesting to receive voided subscription purchases, you must switch to use orderId in the response which uniquely identifies one-time purchases and subscriptions. Otherwise, you will receive multiple subscription orders with the same PurchaseToken, because subscription renewal orders share the same PurchaseToken. | [optional] 
