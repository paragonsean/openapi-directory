# GooglePlayAndroidDeveloperApi.Subscription
...
**basePlans** | [**[BasePlan]**](BasePlan.md) | The set of base plans for this subscription. Represents the prices and duration of the subscription if no other offers apply. | [optional] 
**listings** | [**[SubscriptionListing]**](SubscriptionListing.md) | Required. List of localized listings for this subscription. Must contain at least an entry for the default language of the parent app. | [optional] 
