# GooglePlayAndroidDeveloperApi.ReviewsApi
...
let apiInstance = new GooglePlayAndroidDeveloperApi.ReviewsApi();
let packageName = "packageName_example"; // String | Package name of the app.
let reviewId = "reviewId_example"; // String | Unique identifier for a review.
let opts = {
  ...
  'translationLanguage': "translationLanguage_example" // String | Language localization code.
};
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'maxResults': 56, // Number | How many results the list operation should return.
  'startIndex': 56, // Number | The index of the first element to return.
  'token': "token_example", // String | Pagination token. If empty, list starts at the first review.
  'translationLanguage': "translationLanguage_example" // String | Language localization code.
};
 ...
 **uploadProtocol** | **String**| Upload protocol for media (e.g. \&quot;raw\&quot;, \&quot;multipart\&quot;). | [optional] 
 **uploadType** | **String**| Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;). | [optional] 
 **maxResults** | **Number**| How many results the list operation should return. | [optional] 
 **startIndex** | **Number**| The index of the first element to return. | [optional] 
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'reviewsReplyRequest': new GooglePlayAndroidDeveloperApi.ReviewsReplyRequest() // ReviewsReplyRequest | 
};
