# GooglePlayAndroidDeveloperApi.ApplicationsApi
...
> Object androidpublisherApplicationsDataSafety(packageName, opts)
...
let apiInstance = new GooglePlayAndroidDeveloperApi.ApplicationsApi();
...
apiInstance.androidpublisherApplicationsDataSafety(packageName, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> DeviceTierConfig androidpublisherApplicationsDeviceTierConfigsCreate(packageName, opts)
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'allowUnknownDevices': true, // Boolean | Whether the service should accept device IDs that are unknown to Play's device catalog.
  'deviceTierConfig': new GooglePlayAndroidDeveloperApi.DeviceTierConfig() // DeviceTierConfig | 
};
apiInstance.androidpublisherApplicationsDeviceTierConfigsCreate(packageName, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> DeviceTierConfig androidpublisherApplicationsDeviceTierConfigsGet(packageName, deviceTierConfigId, opts)
...
let apiInstance = new GooglePlayAndroidDeveloperApi.ApplicationsApi();
let packageName = "packageName_example"; // String | Package name of the app.
let deviceTierConfigId = "deviceTierConfigId_example"; // String | Required. Id of an existing device tier config.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
apiInstance.androidpublisherApplicationsDeviceTierConfigsGet(packageName, deviceTierConfigId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ListDeviceTierConfigsResponse androidpublisherApplicationsDeviceTierConfigsList(packageName, opts)
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'pageSize': 56, // Number | The maximum number of device tier configs to return. The service may return fewer than this value. If unspecified, at most 10 device tier configs will be returned. The maximum value for this field is 100; values above 100 will be coerced to 100. Device tier configs will be ordered by descending creation time.
  'pageToken': "pageToken_example" // String | A page token, received from a previous `ListDeviceTierConfigs` call. Provide this to retrieve the subsequent page.
};
apiInstance.androidpublisherApplicationsDeviceTierConfigsList(packageName, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
