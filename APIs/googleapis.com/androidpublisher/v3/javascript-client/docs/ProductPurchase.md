# GooglePlayAndroidDeveloperApi.ProductPurchase

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**acknowledgementState** | **Number** | The acknowledgement state of the inapp product. Possible values are: 0. Yet to be acknowledged 1. Acknowledged | [optional] 
**consumptionState** | **Number** | The consumption state of the inapp product. Possible values are: 0. Yet to be consumed 1. Consumed | [optional] 
...
**purchaseState** | **Number** | The purchase state of the order. Possible values are: 0. Purchased 1. Canceled 2. Pending | [optional] 
...
**quantity** | **Number** | The quantity associated with the purchase of the inapp product. If not present, the quantity is 1. | [optional] 
