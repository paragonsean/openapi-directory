...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GooglePlayAndroidDeveloperApi.Listing();
  });
  ...
  describe('Listing', function() {
    it('should create an instance of Listing', function() {
      ...
      //var instance = new GooglePlayAndroidDeveloperApi.Listing();
      //expect(instance).to.be.a(GooglePlayAndroidDeveloperApi.Listing);
    });
