...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GooglePlayAndroidDeveloperApi.ModuleMetadata();
  });
  ...
  describe('ModuleMetadata', function() {
    it('should create an instance of ModuleMetadata', function() {
      // uncomment below and update the code to test ModuleMetadata
      //var instance = new GooglePlayAndroidDeveloperApi.ModuleMetadata();
      //expect(instance).to.be.a(GooglePlayAndroidDeveloperApi.ModuleMetadata);
    });
    ...
    it('should have the property moduleType (base name: "moduleType")', function() {
