...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GooglePlayAndroidDeveloperApi.Timestamp();
  });
  ...
  describe('Timestamp', function() {
    it('should create an instance of Timestamp', function() {
      ...
      //var instance = new GooglePlayAndroidDeveloperApi.Timestamp();
      //expect(instance).to.be.a(GooglePlayAndroidDeveloperApi.Timestamp);
    });
