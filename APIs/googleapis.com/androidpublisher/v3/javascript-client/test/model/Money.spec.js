...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GooglePlayAndroidDeveloperApi.Money();
  });
  ...
  describe('Money', function() {
    it('should create an instance of Money', function() {
      ...
      //var instance = new GooglePlayAndroidDeveloperApi.Money();
      //expect(instance).to.be.a(GooglePlayAndroidDeveloperApi.Money);
    });
