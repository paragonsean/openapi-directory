...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GooglePlayAndroidDeveloperApi.Bundle();
  });
  ...
  describe('Bundle', function() {
    it('should create an instance of Bundle', function() {
      ...
      //var instance = new GooglePlayAndroidDeveloperApi.Bundle();
      //expect(instance).to.be.a(GooglePlayAndroidDeveloperApi.Bundle);
    });
