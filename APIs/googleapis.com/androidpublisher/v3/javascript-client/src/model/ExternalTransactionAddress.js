...
/**
 * The ExternalTransactionAddress model module.
 * @module model/ExternalTransactionAddress
 * @version v3
 */
class ExternalTransactionAddress {
    /**
     * Constructs a new <code>ExternalTransactionAddress</code>.
     * User&#39;s address for the external transaction.
     * @alias module:model/ExternalTransactionAddress
     */
    constructor() { 
        
        ExternalTransactionAddress.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ExternalTransactionAddress</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ExternalTransactionAddress} obj Optional instance to populate.
     * @return {module:model/ExternalTransactionAddress} The populated <code>ExternalTransactionAddress</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ExternalTransactionAddress();
    ...
    /**
     * Validates the JSON data with respect to <code>ExternalTransactionAddress</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ExternalTransactionAddress</code>.
     */
 ...
 */
ExternalTransactionAddress.prototype['administrativeArea'] = undefined;

/**
 * Required. Two letter region code based on ISO-3166-1 Alpha-2 (UN region codes).
 * @member {String} regionCode
 */
ExternalTransactionAddress.prototype['regionCode'] = undefined;
...
export default ExternalTransactionAddress;
