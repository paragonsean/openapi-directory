    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('usesPermissions')) {
                obj['usesPermissions'] = ApiClient.convertToType(data['usesPermissions'], [UsesPermission]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['usesPermissions']) { // data not null
            ...
            for (const item of data['usesPermissions']) {
                UsesPermission.validateJSON(item);
            };
        }
        // ensure the json data is a string
 ...
 * @member {Array.<module:model/UsesPermission>} usesPermissions
 */
