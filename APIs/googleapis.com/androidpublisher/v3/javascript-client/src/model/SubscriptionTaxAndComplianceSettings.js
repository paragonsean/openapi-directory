...
/**
 * The SubscriptionTaxAndComplianceSettings model module.
 * @module model/SubscriptionTaxAndComplianceSettings
 * @version v3
 */
class SubscriptionTaxAndComplianceSettings {
    /**
     * Constructs a new <code>SubscriptionTaxAndComplianceSettings</code>.
     * Details about taxation, Google Play policy and legal compliance for subscription products.
     * @alias module:model/SubscriptionTaxAndComplianceSettings
     */
    constructor() { 
        
        SubscriptionTaxAndComplianceSettings.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SubscriptionTaxAndComplianceSettings</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SubscriptionTaxAndComplianceSettings} obj Optional instance to populate.
     * @return {module:model/SubscriptionTaxAndComplianceSettings} The populated <code>SubscriptionTaxAndComplianceSettings</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SubscriptionTaxAndComplianceSettings();
    ...
    /**
     * Validates the JSON data with respect to <code>SubscriptionTaxAndComplianceSettings</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SubscriptionTaxAndComplianceSettings</code>.
     */
 ...
 * @member {module:model/SubscriptionTaxAndComplianceSettings.EeaWithdrawalRightTypeEnum} eeaWithdrawalRightType
 */
SubscriptionTaxAndComplianceSettings.prototype['eeaWithdrawalRightType'] = undefined;
 ...
 */
SubscriptionTaxAndComplianceSettings.prototype['isTokenizedDigitalAsset'] = undefined;

/**
 * A mapping from region code to tax rate details. The keys are region codes as defined by Unicode's \"CLDR\".
 * @member {Object.<String, module:model/RegionalTaxRateInfo>} taxRateInfoByRegionCode
 */
SubscriptionTaxAndComplianceSettings.prototype['taxRateInfoByRegionCode'] = undefined;
 ...
 * @readonly
 */
SubscriptionTaxAndComplianceSettings['EeaWithdrawalRightTypeEnum'] = {
...
export default SubscriptionTaxAndComplianceSettings;
