...
class ExternallyHostedApk(Model):
    ...
    def uses_permissions(self, uses_permissions):
        ...
        :param uses_permissions: The uses_permissions of this ExternallyHostedApk.
        :type uses_permissions: List[UsesPermission]
        """
