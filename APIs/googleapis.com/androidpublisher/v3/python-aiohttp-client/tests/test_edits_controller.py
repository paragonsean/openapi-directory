...
async def test_androidpublisher_edits_apks_addexternallyhosted(client):
    ...
    response = await client.request(
        method='POST',
        path='/androidpublisher/v3/applications/{package_name}/edits/{edit_id}/apks/externallyHosted'.format(package_name='package_name_example', edit_id='edit_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_androidpublisher_edits_apks_list(client):
    ...
    response = await client.request(
        method='GET',
        path='/androidpublisher/v3/applications/{package_name}/edits/{edit_id}/apks'.format(package_name='package_name_example', edit_id='edit_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_androidpublisher_edits_bundles_list(client):
    ...
    response = await client.request(
        method='GET',
        path='/androidpublisher/v3/applications/{package_name}/edits/{edit_id}/bundles'.format(package_name='package_name_example', edit_id='edit_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_androidpublisher_edits_bundles_upload(client):
    ...
    params = [('$.xgafv', 'xgafv_example'),
                    ...
                    ('deviceTierConfigId', 'device_tier_config_id_example')]
    headers = { 
        'Accept': 'application/json',
        'Authorization': 'Bearer special-key',
        'Authorization': 'Bearer special-key',
...
async def test_androidpublisher_edits_commit(client):
    ...
    response = await client.request(
        method='POST',
        path='/androidpublisher/v3/applications/{package_name}/edits/{edit_idcommi}'.format(package_name='package_name_example', edit_id='edit_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_androidpublisher_edits_countryavailability_get(client):
    ...
    response = await client.request(
        method='GET',
        path='/androidpublisher/v3/applications/{package_name}/edits/{edit_id}/countryAvailability/{track}'.format(package_name='package_name_example', edit_id='edit_id_example', track='track_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_androidpublisher_edits_delete(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/androidpublisher/v3/applications/{package_name}/edits/{edit_id}'.format(package_name='package_name_example', edit_id='edit_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_androidpublisher_edits_deobfuscationfiles_upload(client):
    ...
    response = await client.request(
        method='POST',
        path='/androidpublisher/v3/applications/{package_name}/edits/{edit_id}/apks/{apk_version_code}/deobfuscationFiles/{deobfuscation_file_type}'.format(package_name='package_name_example', edit_id='edit_id_example', apk_version_code=56, deobfuscation_file_type='deobfuscation_file_type_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_androidpublisher_edits_details_get(client):
    ...
    response = await client.request(
        method='GET',
        path='/androidpublisher/v3/applications/{package_name}/edits/{edit_id}/details'.format(package_name='package_name_example', edit_id='edit_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_androidpublisher_edits_expansionfiles_get(client):
    ...
    response = await client.request(
        method='GET',
        path='/androidpublisher/v3/applications/{package_name}/edits/{edit_id}/apks/{apk_version_code}/expansionFiles/{expansion_file_type}'.format(package_name='package_name_example', edit_id='edit_id_example', apk_version_code=56, expansion_file_type='expansion_file_type_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_androidpublisher_edits_images_delete(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/androidpublisher/v3/applications/{package_name}/edits/{edit_id}/listings/{language}/{image_type}/{image_id}'.format(package_name='package_name_example', edit_id='edit_id_example', language='language_example', image_type='image_type_example', image_id='image_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_androidpublisher_edits_images_deleteall(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/androidpublisher/v3/applications/{package_name}/edits/{edit_id}/listings/{language}/{image_type}'.format(package_name='package_name_example', edit_id='edit_id_example', language='language_example', image_type='image_type_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_androidpublisher_edits_insert(client):
    ...
    response = await client.request(
        method='POST',
        path='/androidpublisher/v3/applications/{package_name}/edits'.format(package_name='package_name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_androidpublisher_edits_listings_delete(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/androidpublisher/v3/applications/{package_name}/edits/{edit_id}/listings/{language}'.format(package_name='package_name_example', edit_id='edit_id_example', language='language_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_androidpublisher_edits_listings_deleteall(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/androidpublisher/v3/applications/{package_name}/edits/{edit_id}/listings'.format(package_name='package_name_example', edit_id='edit_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_androidpublisher_edits_testers_get(client):
    ...
    response = await client.request(
        method='GET',
        path='/androidpublisher/v3/applications/{package_name}/edits/{edit_id}/testers/{track}'.format(package_name='package_name_example', edit_id='edit_id_example', track='track_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_androidpublisher_edits_tracks_create(client):
    """Test case for androidpublisher_edits_tracks_create

    
    """
    body = {"formFactor":"FORM_FACTOR_UNSPECIFIED","track":"track","type":"TRACK_TYPE_UNSPECIFIED"}
    params = [('$.xgafv', 'xgafv_example'),
                    ('access_token', 'access_token_example'),
                    ('alt', 'alt_example'),
                    ('callback', 'param_callback_example'),
    ...
    response = await client.request(
        method='POST',
        path='/androidpublisher/v3/applications/{package_name}/edits/{edit_id}/tracks'.format(package_name='package_name_example', edit_id='edit_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_androidpublisher_edits_tracks_get(client):
    ...
    response = await client.request(
        method='GET',
        path='/androidpublisher/v3/applications/{package_name}/edits/{edit_id}/tracks/{track}'.format(package_name='package_name_example', edit_id='edit_id_example', track='track_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_androidpublisher_edits_tracks_patch(client):
    ...
    """
    body = {"track":"track","releases":[{"countryTargeting":{"includeRestOfWorld":True,"countries":["countries","countries"]},"releaseNotes":[{"language":"language","text":"text"},{"language":"language","text":"text"}],"userFraction":6.027456183070403,"inAppUpdatePriority":0,"name":"name","versionCodes":["versionCodes","versionCodes"],"status":"statusUnspecified"},{"countryTargeting":{"includeRestOfWorld":True,"countries":["countries","countries"]},"releaseNotes":[{"language":"language","text":"text"},{"language":"language","text":"text"}],"userFraction":6.027456183070403,"inAppUpdatePriority":0,"name":"name","versionCodes":["versionCodes","versionCodes"],"status":"statusUnspecified"}]}
    params = [('$.xgafv', 'xgafv_example'),
                    ('access_token', 'access_token_example'),
                    ('alt', 'alt_example'),
                    ('callback', 'param_callback_example'),
...
async def test_androidpublisher_edits_validate(client):
    ...
    response = await client.request(
        method='POST',
        path='/androidpublisher/v3/applications/{package_name}/edits/{edit_idvalidat}'.format(package_name='package_name_example', edit_id='edit_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
