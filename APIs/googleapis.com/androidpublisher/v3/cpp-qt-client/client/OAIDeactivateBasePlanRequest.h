...
/*
 * OAIDeactivateBasePlanRequest.h
 *
 * Request message for DeactivateBasePlan.
 */

#ifndef OAIDeactivateBasePlanRequest_H
#define OAIDeactivateBasePlanRequest_H
...
class OAIDeactivateBasePlanRequest : public OAIObject {
public:
    OAIDeactivateBasePlanRequest();
    OAIDeactivateBasePlanRequest(QString json);
    ~OAIDeactivateBasePlanRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeactivateBasePlanRequest)

#endif // OAIDeactivateBasePlanRequest_H
