...
OAIGrantsApi::OAIGrantsApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIGrantsApi::~OAIGrantsApi() {
}

void OAIGrantsApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("androidpublisher_grants_create", defaultConf);
    _serverIndices.insert("androidpublisher_grants_create", 0);
}
...
*/
int OAIGrantsApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIGrantsApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIGrantsApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIGrantsApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIGrantsApi::setUsername(const QString &username) {
    _username = username;
}

void OAIGrantsApi::setPassword(const QString &password) {
    _password = password;
}


void OAIGrantsApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIGrantsApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIGrantsApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIGrantsApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIGrantsApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIGrantsApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIGrantsApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIGrantsApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIGrantsApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIGrantsApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIGrantsApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIGrantsApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIGrantsApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIGrantsApi::androidpublisher_grants_create(const QString &parent, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<OAIGrant> &oai_grant) {
    ...
    if (oai_grant.hasValue()){

        
        QByteArray output = oai_grant.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIGrantsApi::androidpublisher_grants_createCallback);
    connect(this, &OAIGrantsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIGrantsApi::androidpublisher_grants_createCallback);
    connect(this, &OAIGrantsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
...
void OAIGrantsApi::androidpublisher_grants_createCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIGrant output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT androidpublisher_grants_createSignal(output);
        Q_EMIT androidpublisher_grants_createSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT androidpublisher_grants_createSignalE(output, error_type, error_str);
        Q_EMIT androidpublisher_grants_createSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT androidpublisher_grants_createSignalError(output, error_type, error_str);
        Q_EMIT androidpublisher_grants_createSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIGrantsApi::tokenAvailable(){
