...
void OAIOrdersApi::androidpublisher_orders_refund(const QString &package_name, const QString &order_id, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<bool> &revoke) {
    QString fullPath = QString(_serverConfigs["androidpublisher_orders_refund"][_serverIndices.value("androidpublisher_orders_refund")].URL()+"/androidpublisher/v3/applications/{packageName}/orders/{orderId}:refund");
