...
void OAIReviewsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("androidpublisher_reviews_get", defaultConf);
    _serverIndices.insert("androidpublisher_reviews_get", 0);
    _serverConfigs.insert("androidpublisher_reviews_list", defaultConf);
    _serverIndices.insert("androidpublisher_reviews_list", 0);
    _serverConfigs.insert("androidpublisher_reviews_reply", defaultConf);
    _serverIndices.insert("androidpublisher_reviews_reply", 0);
}
...
void OAIReviewsApi::androidpublisher_reviews_get(const QString &package_name, const QString &review_id, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<QString> &translation_language) {
    QString fullPath = QString(_serverConfigs["androidpublisher_reviews_get"][_serverIndices.value("androidpublisher_reviews_get")].URL()+"/androidpublisher/v3/applications/{packageName}/reviews/{reviewId}");
    ...
    if (translation_language.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "translationLanguage", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("translationLanguage")).append(querySuffix).append(QUrl::toPercentEncoding(translation_language.stringValue()));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIReviewsApi::androidpublisher_reviews_getCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIReviewsApi::androidpublisher_reviews_getCallback);
    connect(this, &OAIReviewsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
...
void OAIReviewsApi::androidpublisher_reviews_getCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT androidpublisher_reviews_getSignal(output);
        Q_EMIT androidpublisher_reviews_getSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT androidpublisher_reviews_getSignalE(output, error_type, error_str);
        Q_EMIT androidpublisher_reviews_getSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT androidpublisher_reviews_getSignalError(output, error_type, error_str);
        Q_EMIT androidpublisher_reviews_getSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIReviewsApi::androidpublisher_reviews_list(const QString &package_name, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<qint32> &max_results, const ::OpenAPI::OptionalParam<qint32> &start_index, const ::OpenAPI::OptionalParam<QString> &token, const ::OpenAPI::OptionalParam<QString> &translation_language) {
    QString fullPath = QString(_serverConfigs["androidpublisher_reviews_list"][_serverIndices.value("androidpublisher_reviews_list")].URL()+"/androidpublisher/v3/applications/{packageName}/reviews");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIReviewsApi::androidpublisher_reviews_listCallback);
    connect(this, &OAIReviewsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIReviewsApi::androidpublisher_reviews_listCallback);
    connect(this, &OAIReviewsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIReviewsApi::androidpublisher_reviews_listCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIReviewsListResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT androidpublisher_reviews_listSignal(output);
        Q_EMIT androidpublisher_reviews_listSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("https://www.googleapis.com/auth/androidpublisher");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT androidpublisher_reviews_listSignalE(output, error_type, error_str);
        Q_EMIT androidpublisher_reviews_listSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT androidpublisher_reviews_listSignalError(output, error_type, error_str);
        Q_EMIT androidpublisher_reviews_listSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIReviewsApi::androidpublisher_reviews_reply(const QString &package_name, const QString &review_id, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<OAIReviewsReplyRequest> &oai_reviews_reply_request) {
    QString fullPath = QString(_serverConfigs["androidpublisher_reviews_reply"][_serverIndices.value("androidpublisher_reviews_reply")].URL()+"/androidpublisher/v3/applications/{packageName}/reviews/{reviewId}:reply");
    ...
    if (oai_reviews_reply_request.hasValue()){

        
        QByteArray output = oai_reviews_reply_request.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIReviewsApi::androidpublisher_reviews_replyCallback);
    connect(this, &OAIReviewsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIReviewsApi::androidpublisher_reviews_replyCallback);
    connect(this, &OAIReviewsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIReviewsApi::androidpublisher_reviews_replyCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIReviewsReplyResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT androidpublisher_reviews_replySignal(output);
        Q_EMIT androidpublisher_reviews_replySignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("https://www.googleapis.com/auth/androidpublisher");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT androidpublisher_reviews_replySignalE(output, error_type, error_str);
        Q_EMIT androidpublisher_reviews_replySignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT androidpublisher_reviews_replySignalError(output, error_type, error_str);
        Q_EMIT androidpublisher_reviews_replySignalErrorFull(worker, error_type, error_str);
    }
}
