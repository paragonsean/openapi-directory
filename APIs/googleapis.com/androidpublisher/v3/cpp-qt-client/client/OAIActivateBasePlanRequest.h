...
/*
 * OAIActivateBasePlanRequest.h
 *
 * Request message for ActivateBasePlan.
 */

#ifndef OAIActivateBasePlanRequest_H
#define OAIActivateBasePlanRequest_H
...
class OAIActivateBasePlanRequest : public OAIObject {
public:
    OAIActivateBasePlanRequest();
    OAIActivateBasePlanRequest(QString json);
    ~OAIActivateBasePlanRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActivateBasePlanRequest)

#endif // OAIActivateBasePlanRequest_H
