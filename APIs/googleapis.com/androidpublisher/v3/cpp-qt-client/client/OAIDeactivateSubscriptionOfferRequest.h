...
/*
 * OAIDeactivateSubscriptionOfferRequest.h
 *
 * Request message for DeactivateSubscriptionOffer.
 */

#ifndef OAIDeactivateSubscriptionOfferRequest_H
#define OAIDeactivateSubscriptionOfferRequest_H
...
class OAIDeactivateSubscriptionOfferRequest : public OAIObject {
public:
    OAIDeactivateSubscriptionOfferRequest();
    OAIDeactivateSubscriptionOfferRequest(QString json);
    ~OAIDeactivateSubscriptionOfferRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeactivateSubscriptionOfferRequest)

#endif // OAIDeactivateSubscriptionOfferRequest_H
