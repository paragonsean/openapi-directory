...
#ifndef OAIUserCountrySet_H
#define OAIUserCountrySet_H
...
class OAIUserCountrySet : public OAIObject {
public:
    OAIUserCountrySet();
    OAIUserCountrySet(QString json);
    ~OAIUserCountrySet() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserCountrySet)

#endif // OAIUserCountrySet_H
