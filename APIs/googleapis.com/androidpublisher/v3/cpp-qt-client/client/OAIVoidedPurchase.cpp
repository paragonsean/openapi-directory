...
void OAIVoidedPurchase::initializeModel() {
    ...
    m_voided_reason_isSet = false;
    m_voided_reason_isValid = false;

    m_voided_source_isSet = false;
    m_voided_source_isValid = false;
...
void OAIVoidedPurchase::fromJsonObject(QJsonObject json) {
    ...
    m_voided_reason_isValid = ::OpenAPI::fromJsonValue(m_voided_reason, json[QString("voidedReason")]);
    m_voided_reason_isSet = !json[QString("voidedReason")].isNull() && m_voided_reason_isValid;

    m_voided_source_isValid = ::OpenAPI::fromJsonValue(m_voided_source, json[QString("voidedSource")]);
    m_voided_source_isSet = !json[QString("voidedSource")].isNull() && m_voided_source_isValid;
...
QJsonObject OAIVoidedPurchase::asJsonObject() const {
    ...
    if (m_voided_reason_isSet) {
        obj.insert(QString("voidedReason"), ::OpenAPI::toJsonValue(m_voided_reason));
    }
    if (m_voided_source_isSet) {
        obj.insert(QString("voidedSource"), ::OpenAPI::toJsonValue(m_voided_source));
    }
...
QString OAIVoidedPurchase::getOrderId() const {
    return m_order_id;
}
void OAIVoidedPurchase::setOrderId(const QString &order_id) {
    m_order_id = order_id;
    m_order_id_isSet = true;
}

bool OAIVoidedPurchase::is_order_id_Set() const{
    return m_order_id_isSet;
}

bool OAIVoidedPurchase::is_order_id_Valid() const{
...
qint32 OAIVoidedPurchase::getVoidedReason() const {
    return m_voided_reason;
}
void OAIVoidedPurchase::setVoidedReason(const qint32 &voided_reason) {
    m_voided_reason = voided_reason;
    m_voided_reason_isSet = true;
}

bool OAIVoidedPurchase::is_voided_reason_Set() const{
    return m_voided_reason_isSet;
}

bool OAIVoidedPurchase::is_voided_reason_Valid() const{
    return m_voided_reason_isValid;
}

qint32 OAIVoidedPurchase::getVoidedSource() const {
    return m_voided_source;
}
void OAIVoidedPurchase::setVoidedSource(const qint32 &voided_source) {
    m_voided_source = voided_source;
    m_voided_source_isSet = true;
}

bool OAIVoidedPurchase::is_voided_source_Set() const{
    return m_voided_source_isSet;
}

bool OAIVoidedPurchase::is_voided_source_Valid() const{
    return m_voided_source_isValid;
}
