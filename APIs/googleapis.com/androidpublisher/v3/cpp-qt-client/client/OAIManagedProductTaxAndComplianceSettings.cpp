...
OAIManagedProductTaxAndComplianceSettings::OAIManagedProductTaxAndComplianceSettings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIManagedProductTaxAndComplianceSettings::OAIManagedProductTaxAndComplianceSettings() {
    this->initializeModel();
}

OAIManagedProductTaxAndComplianceSettings::~OAIManagedProductTaxAndComplianceSettings() {}

void OAIManagedProductTaxAndComplianceSettings::initializeModel() {
...
void OAIManagedProductTaxAndComplianceSettings::fromJson(QString jsonString) {
...
void OAIManagedProductTaxAndComplianceSettings::fromJsonObject(QJsonObject json) {
...
QString OAIManagedProductTaxAndComplianceSettings::asJson() const {
...
QJsonObject OAIManagedProductTaxAndComplianceSettings::asJsonObject() const {
    QJsonObject obj;
...
QString OAIManagedProductTaxAndComplianceSettings::getEeaWithdrawalRightType() const {
    return m_eea_withdrawal_right_type;
}
void OAIManagedProductTaxAndComplianceSettings::setEeaWithdrawalRightType(const QString &eea_withdrawal_right_type) {
    m_eea_withdrawal_right_type = eea_withdrawal_right_type;
    m_eea_withdrawal_right_type_isSet = true;
}

bool OAIManagedProductTaxAndComplianceSettings::is_eea_withdrawal_right_type_Set() const{
    return m_eea_withdrawal_right_type_isSet;
}

bool OAIManagedProductTaxAndComplianceSettings::is_eea_withdrawal_right_type_Valid() const{
    return m_eea_withdrawal_right_type_isValid;
}

bool OAIManagedProductTaxAndComplianceSettings::isIsTokenizedDigitalAsset() const {
    return m_is_tokenized_digital_asset;
}
void OAIManagedProductTaxAndComplianceSettings::setIsTokenizedDigitalAsset(const bool &is_tokenized_digital_asset) {
    m_is_tokenized_digital_asset = is_tokenized_digital_asset;
    m_is_tokenized_digital_asset_isSet = true;
}

bool OAIManagedProductTaxAndComplianceSettings::is_is_tokenized_digital_asset_Set() const{
    return m_is_tokenized_digital_asset_isSet;
}

bool OAIManagedProductTaxAndComplianceSettings::is_is_tokenized_digital_asset_Valid() const{
    return m_is_tokenized_digital_asset_isValid;
}

QMap<QString, OAIRegionalTaxRateInfo> OAIManagedProductTaxAndComplianceSettings::getTaxRateInfoByRegionCode() const {
    return m_tax_rate_info_by_region_code;
}
void OAIManagedProductTaxAndComplianceSettings::setTaxRateInfoByRegionCode(const QMap<QString, OAIRegionalTaxRateInfo> &tax_rate_info_by_region_code) {
    m_tax_rate_info_by_region_code = tax_rate_info_by_region_code;
    m_tax_rate_info_by_region_code_isSet = true;
}

bool OAIManagedProductTaxAndComplianceSettings::is_tax_rate_info_by_region_code_Set() const{
    return m_tax_rate_info_by_region_code_isSet;
}

bool OAIManagedProductTaxAndComplianceSettings::is_tax_rate_info_by_region_code_Valid() const{
    return m_tax_rate_info_by_region_code_isValid;
}

bool OAIManagedProductTaxAndComplianceSettings::isSet() const {
...
bool OAIManagedProductTaxAndComplianceSettings::isValid() const {
