...
|**certificateBase64s** | **List&lt;String&gt;** | A certificate (or array of certificates if a certificate-chain is used) used to sign this APK, represented as a base64 encoded byte array. |  [optional] |
...
|**usesPermissions** | [**List&lt;UsesPermission&gt;**](UsesPermission.md) | The permissions requested by this APK. |  [optional] |
