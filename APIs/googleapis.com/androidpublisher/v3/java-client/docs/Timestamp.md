...
|------------ | ------------- | ------------- | -------------|
|**nanos** | **Integer** | Non-negative fractions of a second at nanosecond resolution. Must be from 0 to 999,999,999 inclusive. |  [optional] |
|**seconds** | **String** | Represents seconds of UTC time since Unix epoch. |  [optional] |
