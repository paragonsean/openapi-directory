...
public class SubscriptionTaxAndComplianceSettings {
  ...
  public SubscriptionTaxAndComplianceSettings eeaWithdrawalRightType(EeaWithdrawalRightTypeEnum eeaWithdrawalRightType) {
  ...
  public SubscriptionTaxAndComplianceSettings isTokenizedDigitalAsset(Boolean isTokenizedDigitalAsset) {
  ...
  public SubscriptionTaxAndComplianceSettings taxRateInfoByRegionCode(Map<String, RegionalTaxRateInfo> taxRateInfoByRegionCode) {
    this.taxRateInfoByRegionCode = taxRateInfoByRegionCode;
    return this;
  }

  public SubscriptionTaxAndComplianceSettings putTaxRateInfoByRegionCodeItem(String key, RegionalTaxRateInfo taxRateInfoByRegionCodeItem) {
  ...
  public boolean equals(Object o) {
    ...
    SubscriptionTaxAndComplianceSettings subscriptionTaxAndComplianceSettings = (SubscriptionTaxAndComplianceSettings) o;
    return Objects.equals(this.eeaWithdrawalRightType, subscriptionTaxAndComplianceSettings.eeaWithdrawalRightType) &&
        Objects.equals(this.isTokenizedDigitalAsset, subscriptionTaxAndComplianceSettings.isTokenizedDigitalAsset) &&
        Objects.equals(this.taxRateInfoByRegionCode, subscriptionTaxAndComplianceSettings.taxRateInfoByRegionCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class SubscriptionTaxAndComplianceSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SubscriptionTaxAndComplianceSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SubscriptionTaxAndComplianceSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SubscriptionTaxAndComplianceSettings is not found in the empty JSON string", SubscriptionTaxAndComplianceSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SubscriptionTaxAndComplianceSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SubscriptionTaxAndComplianceSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SubscriptionTaxAndComplianceSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SubscriptionTaxAndComplianceSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SubscriptionTaxAndComplianceSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SubscriptionTaxAndComplianceSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<SubscriptionTaxAndComplianceSettings>() {
           @Override
           public void write(JsonWriter out, SubscriptionTaxAndComplianceSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SubscriptionTaxAndComplianceSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SubscriptionTaxAndComplianceSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SubscriptionTaxAndComplianceSettings
   * @throws IOException if the JSON string is invalid with respect to SubscriptionTaxAndComplianceSettings
   */
  public static SubscriptionTaxAndComplianceSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SubscriptionTaxAndComplianceSettings.class);
  }

  /**
   * Convert an instance of SubscriptionTaxAndComplianceSettings to an JSON string
   *
   * @return JSON string
   */
