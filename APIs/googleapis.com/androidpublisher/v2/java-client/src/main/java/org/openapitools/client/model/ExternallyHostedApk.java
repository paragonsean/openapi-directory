...
public class ExternallyHostedApk {
  ...
  private List<ExternallyHostedApkUsesPermission> usesPermissions = new ArrayList<>();
  ...
  public ExternallyHostedApk usesPermissions(List<ExternallyHostedApkUsesPermission> usesPermissions) {
    this.usesPermissions = usesPermissions;
    return this;
  }

  public ExternallyHostedApk addUsesPermissionsItem(ExternallyHostedApkUsesPermission usesPermissionsItem) {
  ...
  public void setUsesPermissions(List<ExternallyHostedApkUsesPermission> usesPermissions) {
    this.usesPermissions = usesPermissions;
  }
      ...
      if (jsonObj.get("usesPermissions") != null && !jsonObj.get("usesPermissions").isJsonNull()) {
        ...
        if (jsonArrayusesPermissions != null) {
          ...
          for (int i = 0; i < jsonArrayusesPermissions.size(); i++) {
            ExternallyHostedApkUsesPermission.validateJsonElement(jsonArrayusesPermissions.get(i));
          };
        }
      }
