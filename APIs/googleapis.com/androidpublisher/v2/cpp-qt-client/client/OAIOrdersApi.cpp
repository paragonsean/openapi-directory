...
void OAIOrdersApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("androidpublisher_orders_refund", defaultConf);
    _serverIndices.insert("androidpublisher_orders_refund", 0);
}
...
void OAIOrdersApi::androidpublisher_orders_refund(const QString &package_name, const QString &order_id, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &user_ip, const ::OpenAPI::OptionalParam<bool> &revoke) {
    QString fullPath = QString(_serverConfigs["androidpublisher_orders_refund"][_serverIndices.value("androidpublisher_orders_refund")].URL()+"/{packageName}/orders/{orderId}:refund");
    ...
    if (revoke.hasValue())
    {
        ...
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "revoke", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("revoke")).append(querySuffix).append(QUrl::toPercentEncoding(revoke.stringValue()));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIOrdersApi::androidpublisher_orders_refundCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIOrdersApi::androidpublisher_orders_refundCallback);
...
void OAIOrdersApi::androidpublisher_orders_refundCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT androidpublisher_orders_refundSignal();
        Q_EMIT androidpublisher_orders_refundSignalFull(worker);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT androidpublisher_orders_refundSignalE(error_type, error_str);
        Q_EMIT androidpublisher_orders_refundSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT androidpublisher_orders_refundSignalError(error_type, error_str);
        Q_EMIT androidpublisher_orders_refundSignalErrorFull(worker, error_type, error_str);
    }
}
