...
QList<OAIExternallyHostedApkUsesPermission> OAIExternallyHostedApk::getUsesPermissions() const {
    return m_uses_permissions;
}
void OAIExternallyHostedApk::setUsesPermissions(const QList<OAIExternallyHostedApkUsesPermission> &uses_permissions) {
