...
namespace OpenAPI {
class OAIExternallyHostedApkUsesPermission;
...
public:
    ...
    QList<OAIExternallyHostedApkUsesPermission> getUsesPermissions() const;
    void setUsesPermissions(const QList<OAIExternallyHostedApkUsesPermission> &uses_permissions);
...
private:
    ...
    QList<OAIExternallyHostedApkUsesPermission> m_uses_permissions;
