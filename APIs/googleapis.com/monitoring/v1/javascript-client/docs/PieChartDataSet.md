# CloudMonitoringApi.PieChartDataSet

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**dimensions** | [**[Dimension]**](Dimension.md) | A dimension is a structured label, class, or category for a set of measurements in your data. | [optional] 
**measures** | [**[Measure]**](Measure.md) | A measure is a measured value of a property in your data. For example, rainfall in inches, number of units sold, revenue gained, etc. | [optional] 
