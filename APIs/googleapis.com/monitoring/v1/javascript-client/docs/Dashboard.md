...
**dashboardFilters** | [**[DashboardFilter]**](DashboardFilter.md) | Filters to reduce the amount of data charted based on the filter criteria. | [optional] 
...
**labels** | **{String: String}** | Labels applied to the dashboard | [optional] 
