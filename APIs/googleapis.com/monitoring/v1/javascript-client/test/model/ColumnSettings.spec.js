...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudMonitoringApi.ColumnSettings();
  });
  ...
  describe('ColumnSettings', function() {
    it('should create an instance of ColumnSettings', function() {
      // uncomment below and update the code to test ColumnSettings
      //var instance = new CloudMonitoringApi.ColumnSettings();
      //expect(instance).to.be.a(CloudMonitoringApi.ColumnSettings);
    });
