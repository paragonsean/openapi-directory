...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudMonitoringApi.ListDashboardsResponse();
  });
  ...
  describe('ListDashboardsResponse', function() {
    it('should create an instance of ListDashboardsResponse', function() {
      ...
      //var instance = new CloudMonitoringApi.ListDashboardsResponse();
      //expect(instance).to.be.a(CloudMonitoringApi.ListDashboardsResponse);
    });
