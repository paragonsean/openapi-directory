...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudMonitoringApi.GridLayout();
  });
  ...
  describe('GridLayout', function() {
    it('should create an instance of GridLayout', function() {
      // uncomment below and update the code to test GridLayout
      //var instance = new CloudMonitoringApi.GridLayout();
      //expect(instance).to.be.a(CloudMonitoringApi.GridLayout);
    });
