...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudMonitoringApi.MosaicLayout();
  });
  ...
  describe('MosaicLayout', function() {
    it('should create an instance of MosaicLayout', function() {
      // uncomment below and update the code to test MosaicLayout
      //var instance = new CloudMonitoringApi.MosaicLayout();
      //expect(instance).to.be.a(CloudMonitoringApi.MosaicLayout);
    });
