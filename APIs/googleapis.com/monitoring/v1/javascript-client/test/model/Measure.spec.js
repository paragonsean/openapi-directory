...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudMonitoringApi.Measure();
  });
  ...
  describe('Measure', function() {
    it('should create an instance of Measure', function() {
      // uncomment below and update the code to test Measure
      //var instance = new CloudMonitoringApi.Measure();
      //expect(instance).to.be.a(CloudMonitoringApi.Measure);
    });
