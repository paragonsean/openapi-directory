...
/*
 * OAIQuerySeriesRequest.h
 *
 * QuerySeries holds all parameters of the Prometheus upstream API for querying series.
 */

#ifndef OAIQuerySeriesRequest_H
#define OAIQuerySeriesRequest_H
...
class OAIQuerySeriesRequest : public OAIObject {
public:
    OAIQuerySeriesRequest();
    OAIQuerySeriesRequest(QString json);
    ~OAIQuerySeriesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIQuerySeriesRequest)

#endif // OAIQuerySeriesRequest_H
