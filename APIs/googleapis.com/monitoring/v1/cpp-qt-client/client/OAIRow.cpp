...
QString OAIRow::getWeight() const {
    return m_weight;
}
void OAIRow::setWeight(const QString &weight) {
    m_weight = weight;
    m_weight_isSet = true;
}

bool OAIRow::is_weight_Set() const{
    return m_weight_isSet;
}

bool OAIRow::is_weight_Valid() const{
    return m_weight_isValid;
}

QList<OAIWidget> OAIRow::getWidgets() const {
    return m_widgets;
}
void OAIRow::setWidgets(const QList<OAIWidget> &widgets) {
    m_widgets = widgets;
    m_widgets_isSet = true;
}

bool OAIRow::is_widgets_Set() const{
    return m_widgets_isSet;
}

bool OAIRow::is_widgets_Valid() const{
