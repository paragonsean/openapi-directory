# CloudMonitoringApi.ListTimeSeriesResponse

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**executionErrors** | [**[Status]**](Status.md) | Query execution errors that may have caused the time series data returned to be incomplete. | [optional] 
...
**timeSeries** | [**[TimeSeries]**](TimeSeries.md) | One or more time series that match the filter included in the request. | [optional] 
