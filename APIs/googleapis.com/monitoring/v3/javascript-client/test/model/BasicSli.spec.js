...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudMonitoringApi.BasicSli();
  });
  ...
  describe('BasicSli', function() {
    it('should create an instance of BasicSli', function() {
      // uncomment below and update the code to test BasicSli
      //var instance = new CloudMonitoringApi.BasicSli();
      //expect(instance).to.be.a(CloudMonitoringApi.BasicSli);
    });
