...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudMonitoringApi.CloudRun();
  });
  ...
  describe('CloudRun', function() {
    it('should create an instance of CloudRun', function() {
      // uncomment below and update the code to test CloudRun
      //var instance = new CloudMonitoringApi.CloudRun();
      //expect(instance).to.be.a(CloudMonitoringApi.CloudRun);
    });
