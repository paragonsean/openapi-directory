...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudMonitoringApi.PointData();
  });
  ...
  describe('PointData', function() {
    it('should create an instance of PointData', function() {
      // uncomment below and update the code to test PointData
      //var instance = new CloudMonitoringApi.PointData();
      //expect(instance).to.be.a(CloudMonitoringApi.PointData);
    });
