...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudMonitoringApi.ListServicesResponse();
  });
  ...
  describe('ListServicesResponse', function() {
    it('should create an instance of ListServicesResponse', function() {
      ...
      //var instance = new CloudMonitoringApi.ListServicesResponse();
      //expect(instance).to.be.a(CloudMonitoringApi.ListServicesResponse);
    });
