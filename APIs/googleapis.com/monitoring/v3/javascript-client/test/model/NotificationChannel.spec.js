...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudMonitoringApi.NotificationChannel();
  });
  ...
  describe('NotificationChannel', function() {
    it('should create an instance of NotificationChannel', function() {
      ...
      //var instance = new CloudMonitoringApi.NotificationChannel();
      //expect(instance).to.be.a(CloudMonitoringApi.NotificationChannel);
    });
    ...
    it('should have the property mutationRecords (base name: "mutationRecords")', function() {
      // uncomment below and update the code to test the property mutationRecords
      //var instance = new CloudMonitoringApi.NotificationChannel();
      //expect(instance).to.be();
    });
