...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudMonitoringApi.ListNotificationChannelsResponse();
  });
  ...
  describe('ListNotificationChannelsResponse', function() {
    it('should create an instance of ListNotificationChannelsResponse', function() {
      // uncomment below and update the code to test ListNotificationChannelsResponse
      //var instance = new CloudMonitoringApi.ListNotificationChannelsResponse();
      //expect(instance).to.be.a(CloudMonitoringApi.ListNotificationChannelsResponse);
    });
