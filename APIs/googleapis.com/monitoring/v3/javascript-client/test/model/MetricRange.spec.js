...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudMonitoringApi.MetricRange();
  });
  ...
  describe('MetricRange', function() {
    it('should create an instance of MetricRange', function() {
      // uncomment below and update the code to test MetricRange
      //var instance = new CloudMonitoringApi.MetricRange();
      //expect(instance).to.be.a(CloudMonitoringApi.MetricRange);
    });
