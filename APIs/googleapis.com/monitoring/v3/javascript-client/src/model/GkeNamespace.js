...
/**
 * The GkeNamespace model module.
 * @module model/GkeNamespace
 * @version v3
 */
class GkeNamespace {
    /**
     * Constructs a new <code>GkeNamespace</code>.
     * GKE Namespace. The field names correspond to the resource metadata labels on monitored resources that fall under a namespace (for example, k8s_container or k8s_pod).
     * @alias module:model/GkeNamespace
     */
    constructor() { 
        
        GkeNamespace.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GkeNamespace</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GkeNamespace} obj Optional instance to populate.
     * @return {module:model/GkeNamespace} The populated <code>GkeNamespace</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GkeNamespace();
    ...
    /**
     * Validates the JSON data with respect to <code>GkeNamespace</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GkeNamespace</code>.
     */
 ...
 */
GkeNamespace.prototype['clusterName'] = undefined;

/**
 * The location of the parent cluster. This may be a zone or region.
 * @member {String} location
 */
GkeNamespace.prototype['location'] = undefined;

/**
 * The name of this namespace.
 * @member {String} namespaceName
 */
GkeNamespace.prototype['namespaceName'] = undefined;
 ...
 */
GkeNamespace.prototype['projectId'] = undefined;
