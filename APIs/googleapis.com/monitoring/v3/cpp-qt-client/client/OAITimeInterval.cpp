...
QString OAITimeInterval::getEndTime() const {
    return m_end_time;
}
void OAITimeInterval::setEndTime(const QString &end_time) {
    m_end_time = end_time;
...
QString OAITimeInterval::getStartTime() const {
    return m_start_time;
}
void OAITimeInterval::setStartTime(const QString &start_time) {
