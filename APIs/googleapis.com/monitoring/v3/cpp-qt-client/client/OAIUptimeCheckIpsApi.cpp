...
#include "OAIUptimeCheckIpsApi.h"
...
OAIUptimeCheckIpsApi::OAIUptimeCheckIpsApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIUptimeCheckIpsApi::~OAIUptimeCheckIpsApi() {
}

void OAIUptimeCheckIpsApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("monitoring_uptimeCheckIps_list", defaultConf);
    _serverIndices.insert("monitoring_uptimeCheckIps_list", 0);
}
...
*/
int OAIUptimeCheckIpsApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIUptimeCheckIpsApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIUptimeCheckIpsApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIUptimeCheckIpsApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIUptimeCheckIpsApi::setUsername(const QString &username) {
    _username = username;
}

void OAIUptimeCheckIpsApi::setPassword(const QString &password) {
    _password = password;
}


void OAIUptimeCheckIpsApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIUptimeCheckIpsApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIUptimeCheckIpsApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIUptimeCheckIpsApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIUptimeCheckIpsApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIUptimeCheckIpsApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIUptimeCheckIpsApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIUptimeCheckIpsApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIUptimeCheckIpsApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIUptimeCheckIpsApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIUptimeCheckIpsApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIUptimeCheckIpsApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIUptimeCheckIpsApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIUptimeCheckIpsApi::monitoring_uptimeCheckIps_list(const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &page_token) {
    QString fullPath = QString(_serverConfigs["monitoring_uptimeCheckIps_list"][_serverIndices.value("monitoring_uptimeCheckIps_list")].URL()+"/v3/uptimeCheckIps");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIUptimeCheckIpsApi::monitoring_uptimeCheckIps_listCallback);
    connect(this, &OAIUptimeCheckIpsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIUptimeCheckIpsApi::monitoring_uptimeCheckIps_listCallback);
    connect(this, &OAIUptimeCheckIpsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
...
void OAIUptimeCheckIpsApi::monitoring_uptimeCheckIps_listCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIListUptimeCheckIpsResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT monitoring_uptimeCheckIps_listSignal(output);
        Q_EMIT monitoring_uptimeCheckIps_listSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT monitoring_uptimeCheckIps_listSignalE(output, error_type, error_str);
        Q_EMIT monitoring_uptimeCheckIps_listSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT monitoring_uptimeCheckIps_listSignalError(output, error_type, error_str);
        Q_EMIT monitoring_uptimeCheckIps_listSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIUptimeCheckIpsApi::tokenAvailable(){
