...
async def test_gkehub_projects_locations_memberships_create(client):
    ...
    """
    body = {"description":"description","externalId":"externalId","updateTime":"updateTime","labels":{"key":"labels"},"endpoint":{"edgeCluster":{"resourceLink":"resourceLink"},"multiCloudCluster":{"clusterMissing":True,"resourceLink":"resourceLink"},"onPremCluster":{"clusterMissing":True,"clusterType":"CLUSTERTYPE_UNSPECIFIED","adminCluster":True,"resourceLink":"resourceLink"},"gkeCluster":{"clusterMissing":True,"resourceLink":"resourceLink"},"applianceCluster":{"resourceLink":"resourceLink"},"kubernetesResource":{"membershipResources":[{"clusterScoped":True,"manifest":"manifest"},{"clusterScoped":True,"manifest":"manifest"}],"membershipCrManifest":"membershipCrManifest","connectResources":[{"clusterScoped":True,"manifest":"manifest"},{"clusterScoped":True,"manifest":"manifest"}],"resourceOptions":{"v1beta1Crd":True,"connectVersion":"connectVersion","k8sVersion":"k8sVersion"}},"kubernetesMetadata":{"memoryMb":0,"nodeProviderId":"nodeProviderId","vcpuCount":1,"nodeCount":6,"updateTime":"updateTime","kubernetesApiServerVersion":"kubernetesApiServerVersion"}},"monitoringConfig":{"kubernetesMetricsPrefix":"kubernetesMetricsPrefix","cluster":"cluster","clusterHash":"clusterHash","location":"location","projectId":"projectId"},"createTime":"createTime","deleteTime":"deleteTime","infrastructureType":"INFRASTRUCTURE_TYPE_UNSPECIFIED","lastConnectionTime":"lastConnectionTime","authority":{"oidcJwks":"oidcJwks","workloadIdentityPool":"workloadIdentityPool","identityProvider":"identityProvider","issuer":"issuer"},"name":"name","state":{"code":"CODE_UNSPECIFIED","description":"description","updateTime":"updateTime"},"uniqueId":"uniqueId"}
    params = [('$.xgafv', 'xgafv_example'),
                    ('access_token', 'access_token_example'),
                    ('alt', 'alt_example'),
                    ('callback', 'param_callback_example'),
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/{parent}/memberships'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_gkehub_projects_locations_memberships_generate_connect_manifest(client):
    ...
    params = [('$.xgafv', 'xgafv_example'),
                    ...
                    ('upload_protocol', 'upload_protocol_example'),
                    ('uploadType', 'upload_type_example'),
                    ('connectAgent.name', 'connect_agent_name_example'),
                    ('connectAgent.namespace', 'connect_agent_namespace_example'),
                    ('connectAgent.proxy', 'connect_agent_proxy_example'),
    ...
    response = await client.request(
        method='GET',
        path='/v1beta1/{namegenerate_connect_manifes}'.format(name='name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_gkehub_projects_locations_memberships_generate_exclusivity_manifest(client):
    ...
    params = [('$.xgafv', 'xgafv_example'),
                    ...
                    ('upload_protocol', 'upload_protocol_example'),
                    ('uploadType', 'upload_type_example'),
                    ('crManifest', 'cr_manifest_example'),
                    ('crdManifest', 'crd_manifest_example')]
    headers = { 
        'Accept': 'application/json',
        'Authorization': 'Bearer special-key',
        'Authorization': 'Bearer special-key',
    ...
    response = await client.request(
        method='GET',
        path='/v1beta1/{namegenerate_exclusivity_manifes}'.format(name='name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_gkehub_projects_locations_memberships_get_iam_policy(client):
...
async def test_gkehub_projects_locations_memberships_patch(client):
...
async def test_gkehub_projects_locations_memberships_set_iam_policy(client):
...
async def test_gkehub_projects_locations_memberships_test_iam_permissions(client):
...
async def test_gkehub_projects_locations_memberships_validate_exclusivity(client):
    ...
    params = [('$.xgafv', 'xgafv_example'),
                    ...
                    ('uploadType', 'upload_type_example'),
                    ('crManifest', 'cr_manifest_example'),
                    ('intendedMembership', 'intended_membership_example')]
    headers = { 
        'Accept': 'application/json',
        'Authorization': 'Bearer special-key',
        'Authorization': 'Bearer special-key',
    ...
    response = await client.request(
        method='GET',
        path='/v1beta1/{parent}/memberships:validateExclusivity'.format(parent='parent_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_gkehub_projects_locations_operations_delete(client):
