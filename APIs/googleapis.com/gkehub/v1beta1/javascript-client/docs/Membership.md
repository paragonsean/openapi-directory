...
**infrastructureType** | **String** | Optional. The infrastructure type this Membership is running on. | [optional] 
**labels** | **{String: String}** | Optional. GCP labels for this membership. | [optional] 
...
* `INFRASTRUCTURE_TYPE_UNSPECIFIED` (value: `"INFRASTRUCTURE_TYPE_UNSPECIFIED"`)

* `ON_PREM` (value: `"ON_PREM"`)

* `MULTI_CLOUD` (value: `"MULTI_CLOUD"`)
