...
(function(root, factory) {
  ...
  describe('Membership', function() {
    ...
    it('should have the property infrastructureType (base name: "infrastructureType")', function() {
      // uncomment below and update the code to test the property infrastructureType
      //var instance = new GkeHubApi.Membership();
      //expect(instance).to.be();
    });
