...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GkeHubApi.Namespace();
  });
  ...
  describe('Namespace', function() {
    it('should create an instance of Namespace', function() {
      ...
      //var instance = new GkeHubApi.Namespace();
      //expect(instance).to.be.a(GkeHubApi.Namespace);
    });
    ...
    it('should have the property namespaceLabels (base name: "namespaceLabels")', function() {
      // uncomment below and update the code to test the property namespaceLabels
      //var instance = new GkeHubApi.Namespace();
      //expect(instance).to.be();
    });
