...
class MembershipFeatureState(Model):
    ...
    def __init__(self, appdevexperience: AppDevExperienceFeatureState=None, clusterupgrade: ClusterUpgradeMembershipState=None, configmanagement: ConfigManagementMembershipState=None, fleetobservability: object=None, identityservice: IdentityServiceMembershipState=None, policycontroller: PolicyControllerMembershipState=None, servicemesh: ServiceMeshMembershipState=None, state: FeatureState=None):
