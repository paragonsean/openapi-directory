...
class ConfigManagementMembershipSpec(Model):
    ...
    def __init__(self, cluster: str=None, config_sync: ConfigManagementConfigSync=None, hierarchy_controller: ConfigManagementHierarchyControllerConfig=None, management: str=None, policy_controller: ConfigManagementPolicyController=None, version: str=None):
