...
bool OAIMembershipEndpoint::isGoogleManaged() const {
    return m_google_managed;
}
void OAIMembershipEndpoint::setGoogleManaged(const bool &google_managed) {
    m_google_managed = google_managed;
    m_google_managed_isSet = true;
}

bool OAIMembershipEndpoint::is_google_managed_Set() const{
    return m_google_managed_isSet;
}

bool OAIMembershipEndpoint::is_google_managed_Valid() const{
