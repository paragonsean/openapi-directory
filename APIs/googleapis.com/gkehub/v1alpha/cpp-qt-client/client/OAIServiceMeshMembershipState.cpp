...
void OAIServiceMeshMembershipState::initializeModel() {
    ...
    m_config_api_version_isSet = false;
    m_config_api_version_isValid = false;
...
void OAIServiceMeshMembershipState::fromJsonObject(QJsonObject json) {
    ...
    m_config_api_version_isValid = ::OpenAPI::fromJsonValue(m_config_api_version, json[QString("configApiVersion")]);
    m_config_api_version_isSet = !json[QString("configApiVersion")].isNull() && m_config_api_version_isValid;
...
QJsonObject OAIServiceMeshMembershipState::asJsonObject() const {
    ...
    if (m_config_api_version_isSet) {
        obj.insert(QString("configApiVersion"), ::OpenAPI::toJsonValue(m_config_api_version));
    }
...
QList<OAIServiceMeshAnalysisMessage> OAIServiceMeshMembershipState::getAnalysisMessages() const {
    return m_analysis_messages;
}
void OAIServiceMeshMembershipState::setAnalysisMessages(const QList<OAIServiceMeshAnalysisMessage> &analysis_messages) {
    m_analysis_messages = analysis_messages;
    m_analysis_messages_isSet = true;
}

bool OAIServiceMeshMembershipState::is_analysis_messages_Set() const{
    return m_analysis_messages_isSet;
}

bool OAIServiceMeshMembershipState::is_analysis_messages_Valid() const{
    return m_analysis_messages_isValid;
}

QString OAIServiceMeshMembershipState::getConfigApiVersion() const {
    return m_config_api_version;
}
void OAIServiceMeshMembershipState::setConfigApiVersion(const QString &config_api_version) {
    m_config_api_version = config_api_version;
    m_config_api_version_isSet = true;
}

bool OAIServiceMeshMembershipState::is_config_api_version_Set() const{
    return m_config_api_version_isSet;
}

bool OAIServiceMeshMembershipState::is_config_api_version_Valid() const{
    return m_config_api_version_isValid;
}
