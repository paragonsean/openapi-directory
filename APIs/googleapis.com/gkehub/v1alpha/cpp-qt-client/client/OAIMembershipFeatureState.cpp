...
OAIObject OAIMembershipFeatureState::getNamespaceactuation() const {
    return m_namespaceactuation;
}
void OAIMembershipFeatureState::setNamespaceactuation(const OAIObject &namespaceactuation) {
    m_namespaceactuation = namespaceactuation;
    m_namespaceactuation_isSet = true;
}

bool OAIMembershipFeatureState::is_namespaceactuation_Set() const{
    return m_namespaceactuation_isSet;
}

bool OAIMembershipFeatureState::is_namespaceactuation_Valid() const{
