...
class OAIServiceMeshFeatureState;
...
public:
    ...
    OAIServiceMeshFeatureState getServicemesh() const;
    void setServicemesh(const OAIServiceMeshFeatureState &servicemesh);
...
private:
    ...
    OAIServiceMeshFeatureState m_servicemesh;
