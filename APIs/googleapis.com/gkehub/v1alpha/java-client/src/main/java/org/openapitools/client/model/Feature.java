...
public class Feature {
  ...
  private Map<String, ScopeFeatureSpec> scopeSpecs = new HashMap<>();
  ...
  public Feature scopeSpecs(Map<String, ScopeFeatureSpec> scopeSpecs) {
    this.scopeSpecs = scopeSpecs;
    return this;
  }

  public Feature putScopeSpecsItem(String key, ScopeFeatureSpec scopeSpecsItem) {
   ...
   */
  @javax.annotation.Nullable
  public Map<String, ScopeFeatureSpec> getScopeSpecs() {
    return scopeSpecs;
  }

  public void setScopeSpecs(Map<String, ScopeFeatureSpec> scopeSpecs) {
    this.scopeSpecs = scopeSpecs;
  }
