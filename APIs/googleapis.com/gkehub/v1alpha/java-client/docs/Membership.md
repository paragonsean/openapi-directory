...
|**description** | **String** | Output only. Description of this membership, limited to 63 characters. Must match the regex: &#x60;a-zA-Z0-9*&#x60; This field is present for legacy purposes. |  [optional] [readonly] |
...
|**labels** | **Map&lt;String, String&gt;** | Optional. Labels for this membership. |  [optional] |
