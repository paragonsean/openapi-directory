...
import ScopeFeatureSpec from './ScopeFeatureSpec';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('scopeSpecs')) {
                obj['scopeSpecs'] = ApiClient.convertToType(data['scopeSpecs'], {'String': ScopeFeatureSpec});
            }
 ...
 * @member {Object.<String, module:model/ScopeFeatureSpec>} scopeSpecs
 */
