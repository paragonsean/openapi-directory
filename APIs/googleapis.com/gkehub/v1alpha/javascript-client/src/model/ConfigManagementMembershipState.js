...
class ConfigManagementMembershipState {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('binauthzState')) {
                obj['binauthzState'] = ConfigManagementBinauthzState.constructFromObject(data['binauthzState']);
            }
    ...
    static validateJSON(data) {
        // validate the optional field `binauthzState`
        if (data['binauthzState']) { // data not null
          ConfigManagementBinauthzState.validateJSON(data['binauthzState']);
        }
...
/**
 * @member {module:model/ConfigManagementBinauthzState} binauthzState
 */
ConfigManagementMembershipState.prototype['binauthzState'] = undefined;
