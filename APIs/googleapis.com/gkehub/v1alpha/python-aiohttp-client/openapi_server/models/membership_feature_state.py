...
class MembershipFeatureState(Model):
    ...
    def __init__(self, appdevexperience: AppDevExperienceFeatureState=None, clusterupgrade: ClusterUpgradeMembershipState=None, configmanagement: ConfigManagementMembershipState=None, fleetobservability: object=None, identityservice: IdentityServiceMembershipState=None, metering: MeteringMembershipState=None, namespaceactuation: object=None, policycontroller: PolicyControllerMembershipState=None, servicemesh: ServiceMeshMembershipState=None, state: FeatureState=None):
        ...
        :param namespaceactuation: The namespaceactuation of this MembershipFeatureState.
    ...
    def namespaceactuation(self):
        """Gets the namespaceactuation of this MembershipFeatureState.

        **Namespace Actuation**: An empty state left as an example membership-specific Feature state.

        :return: The namespaceactuation of this MembershipFeatureState.
        :rtype: object
        """
    ...
    def namespaceactuation(self, namespaceactuation):
        """Sets the namespaceactuation of this MembershipFeatureState.
