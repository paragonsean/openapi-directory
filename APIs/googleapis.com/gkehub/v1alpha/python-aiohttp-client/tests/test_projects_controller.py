...
from openapi_server.models.list_admin_cluster_memberships_response import ListAdminClusterMembershipsResponse
from openapi_server.models.list_bound_memberships_response import ListBoundMembershipsResponse
...
from openapi_server.models.list_permitted_scopes_response import ListPermittedScopesResponse
...
from openapi_server.models.validate_create_membership_request import ValidateCreateMembershipRequest
from openapi_server.models.validate_create_membership_response import ValidateCreateMembershipResponse
...
async def test_gkehub_projects_locations_features_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1alpha/{parent}/features'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_gkehub_projects_locations_fleets_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1alpha/{parent}/fleets'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_gkehub_projects_locations_memberships_bindings_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1alpha/{parent}/bindings'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_gkehub_projects_locations_memberships_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1alpha/{parent}/memberships'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_gkehub_projects_locations_memberships_generate_connect_manifest(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1alpha/{namegenerate_connect_manifes}'.format(name='name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_gkehub_projects_locations_memberships_list_admin(client):
    """Test case for gkehub_projects_locations_memberships_list_admin
    ...
    response = await client.request(
        method='GET',
        path='/v1alpha/{parent}/memberships:listAdmin'.format(parent='parent_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_gkehub_projects_locations_memberships_rbacrolebindings_generate_membership_rbac_role_binding_yaml(client):
    """Test case for gkehub_projects_locations_memberships_rbacrolebindings_generate_membership_rbac_role_binding_yaml
    ...
    response = await client.request(
        method='POST',
        path='/v1alpha/{parent}/rbacrolebindings:generateMembershipRBACRoleBindingYAML'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_gkehub_projects_locations_memberships_validate_create(client):
    """Test case for gkehub_projects_locations_memberships_validate_create

    
    """
    body = {"membership":{"description":"description","externalId":"externalId","updateTime":"updateTime","labels":{"key":"labels"},"endpoint":{"edgeCluster":{"resourceLink":"resourceLink"},"multiCloudCluster":{"clusterMissing":True,"resourceLink":"resourceLink"},"onPremCluster":{"clusterMissing":True,"clusterType":"CLUSTERTYPE_UNSPECIFIED","adminCluster":True,"resourceLink":"resourceLink"},"gkeCluster":{"clusterMissing":True,"resourceLink":"resourceLink"},"applianceCluster":{"resourceLink":"resourceLink"},"googleManaged":True,"kubernetesResource":{"membershipResources":[{"clusterScoped":True,"manifest":"manifest"},{"clusterScoped":True,"manifest":"manifest"}],"membershipCrManifest":"membershipCrManifest","connectResources":[{"clusterScoped":True,"manifest":"manifest"},{"clusterScoped":True,"manifest":"manifest"}],"resourceOptions":{"v1beta1Crd":True,"connectVersion":"connectVersion","k8sVersion":"k8sVersion"}},"kubernetesMetadata":{"memoryMb":0,"nodeProviderId":"nodeProviderId","vcpuCount":1,"nodeCount":6,"updateTime":"updateTime","kubernetesApiServerVersion":"kubernetesApiServerVersion"}},"monitoringConfig":{"kubernetesMetricsPrefix":"kubernetesMetricsPrefix","cluster":"cluster","clusterHash":"clusterHash","location":"location","projectId":"projectId"},"createTime":"createTime","deleteTime":"deleteTime","lastConnectionTime":"lastConnectionTime","authority":{"oidcJwks":"oidcJwks","workloadIdentityPool":"workloadIdentityPool","identityProvider":"identityProvider","issuer":"issuer"},"name":"name","state":{"code":"CODE_UNSPECIFIED"},"uniqueId":"uniqueId"},"membershipId":"membershipId"}
    params = [('$.xgafv', 'xgafv_example'),
                    ('access_token', 'access_token_example'),
                    ('alt', 'alt_example'),
                    ('callback', 'param_callback_example'),
    ...
    response = await client.request(
        method='POST',
        path='/v1alpha/{parent}/memberships:validateCreate'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_gkehub_projects_locations_scopes_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1alpha/{parent}/scopes'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_gkehub_projects_locations_scopes_get_iam_policy(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1alpha/{resourceget_iam_polic}'.format(resource='resource_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_gkehub_projects_locations_scopes_list_memberships(client):
    """Test case for gkehub_projects_locations_scopes_list_memberships
    ...
    response = await client.request(
        method='GET',
        path='/v1alpha/{scope_namelist_membership}'.format(scope_name='scope_name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_gkehub_projects_locations_scopes_list_permitted(client):
    """Test case for gkehub_projects_locations_scopes_list_permitted
    ...
    response = await client.request(
        method='GET',
        path='/v1alpha/{parent}/scopes:listPermitted'.format(parent='parent_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_gkehub_projects_locations_scopes_namespaces_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1alpha/{parent}/namespaces'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_gkehub_projects_locations_scopes_rbacrolebindings_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1alpha/{parent}/rbacrolebindings'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_gkehub_projects_locations_scopes_set_iam_policy(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1alpha/{resourceset_iam_polic}'.format(resource='resource_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_gkehub_projects_locations_scopes_test_iam_permissions(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1alpha/{resourcetest_iam_permission}'.format(resource='resource_example'),
        headers=headers,
        json=body,
        params=params,
        )
