...
public:
    ...
    */
    virtual void gkehub_projects_locations_memberships_create(const QString &parent, const ::OpenAPI::OptionalParam<QString> &_xgafv = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &access_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &alt = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &callback = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &fields = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &key = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &oauth_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &pretty_print = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &quota_user = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &upload_protocol = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &upload_type = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &membership_id = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAIMembership> &oai_membership = ::OpenAPI::OptionalParam<OAIMembership>());
...
private:
    ...
    void gkehub_projects_locations_global_memberships_initializeHubCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void gkehub_projects_locations_global_memberships_initializeHubSignal(OAIInitializeHubResponse summary);
    ...
    void gkehub_projects_locations_global_memberships_initializeHubSignalFull(OAIHttpRequestWorker *worker, OAIInitializeHubResponse summary);
    ...
    Q_DECL_DEPRECATED_X("Use gkehub_projects_locations_global_memberships_initializeHubSignalError() instead")
    void gkehub_projects_locations_global_memberships_initializeHubSignalE(OAIInitializeHubResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void gkehub_projects_locations_global_memberships_initializeHubSignalError(OAIInitializeHubResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use gkehub_projects_locations_global_memberships_initializeHubSignalErrorFull() instead")
    void gkehub_projects_locations_global_memberships_initializeHubSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void gkehub_projects_locations_global_memberships_initializeHubSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
