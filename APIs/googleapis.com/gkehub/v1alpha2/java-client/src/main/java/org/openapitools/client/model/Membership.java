...
public class Membership {
   ...
   */
  @JsonAdapter(InfrastructureTypeEnum.Adapter.class)
  public enum InfrastructureTypeEnum {
    ...
    InfrastructureTypeEnum(String value) {
      this.value = value;
    }
    ...
    public static InfrastructureTypeEnum fromValue(String value) {
      for (InfrastructureTypeEnum b : InfrastructureTypeEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<InfrastructureTypeEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final InfrastructureTypeEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public InfrastructureTypeEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return InfrastructureTypeEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      InfrastructureTypeEnum.fromValue(value);
    }
  }
  ...
  private InfrastructureTypeEnum infrastructureType;
  ...
  public Membership infrastructureType(InfrastructureTypeEnum infrastructureType) {
  ...
  public void setInfrastructureType(InfrastructureTypeEnum infrastructureType) {
    this.infrastructureType = infrastructureType;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.authority, membership.authority) &&
        ...
        Objects.equals(this.infrastructureType, membership.infrastructureType) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(authority, createTime, deleteTime, description, endpoint, externalId, infrastructureType, labels, lastConnectionTime, monitoringConfig, name, state, uniqueId, updateTime);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("infrastructureType") != null && !jsonObj.get("infrastructureType").isJsonNull()) && !jsonObj.get("infrastructureType").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `infrastructureType` to be a primitive type in the JSON string but got `%s`", jsonObj.get("infrastructureType").toString()));
      }
      // validate the optional field `infrastructureType`
      if (jsonObj.get("infrastructureType") != null && !jsonObj.get("infrastructureType").isJsonNull()) {
        InfrastructureTypeEnum.validateJsonElement(jsonObj.get("infrastructureType"));
      }
