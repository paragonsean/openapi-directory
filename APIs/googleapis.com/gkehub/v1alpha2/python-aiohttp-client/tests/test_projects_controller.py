...
async def test_gkehub_projects_locations_global_memberships_initialize_hub(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1alpha2/{projectinitialize_hu}'.format(project='project_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_gkehub_projects_locations_list(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1alpha2/{name}/locations'.format(name='name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_gkehub_projects_locations_memberships_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1alpha2/{parent}/memberships'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_gkehub_projects_locations_memberships_generate_connect_manifest(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1alpha2/{namegenerate_connect_manifes}'.format(name='name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_gkehub_projects_locations_memberships_get_iam_policy(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1alpha2/{resourceget_iam_polic}'.format(resource='resource_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_gkehub_projects_locations_memberships_patch(client):
    ...
    response = await client.request(
        method='PATCH',
        path='/v1alpha2/{name}'.format(name='name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_gkehub_projects_locations_memberships_set_iam_policy(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1alpha2/{resourceset_iam_polic}'.format(resource='resource_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_gkehub_projects_locations_memberships_test_iam_permissions(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1alpha2/{resourcetest_iam_permission}'.format(resource='resource_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_gkehub_projects_locations_operations_cancel(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1alpha2/{namecance}'.format(name='name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_gkehub_projects_locations_operations_list(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1alpha2/{name}/operations'.format(name='name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
