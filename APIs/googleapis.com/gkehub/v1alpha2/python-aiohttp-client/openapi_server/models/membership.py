...
class Membership(Model):
    ...
    def __init__(self, authority: Authority=None, create_time: str=None, delete_time: str=None, description: str=None, endpoint: MembershipEndpoint=None, external_id: str=None, infrastructure_type: str=None, labels: Dict[str, str]=None, last_connection_time: str=None, monitoring_config: MonitoringConfig=None, name: str=None, state: MembershipState=None, unique_id: str=None, update_time: str=None):
        ...
        :param infrastructure_type: The infrastructure_type of this Membership.
    ...
    def infrastructure_type(self):
        """Gets the infrastructure_type of this Membership.

        Optional. The infrastructure type this Membership is running on.

        :return: The infrastructure_type of this Membership.
        :rtype: str
        """
    ...
    def infrastructure_type(self, infrastructure_type):
        """Sets the infrastructure_type of this Membership.
        ...
        """
        allowed_values = ["INFRASTRUCTURE_TYPE_UNSPECIFIED", "ON_PREM", "MULTI_CLOUD"]  # noqa: E501
        if infrastructure_type not in allowed_values:
            raise ValueError(
                "Invalid value for `infrastructure_type` ({0}), must be one of {1}"
                .format(infrastructure_type, allowed_values)
            )
