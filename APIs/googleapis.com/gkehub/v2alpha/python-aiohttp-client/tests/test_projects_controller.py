...
async def test_gkehub_projects_locations_list(client):
    ...
    response = await client.request(
        method='GET',
        path='/v2alpha/{name}/locations'.format(name='name_example'),
        headers=headers,
        params=params,
        )
...
async def test_gkehub_projects_locations_operations_cancel(client):
    ...
    response = await client.request(
        method='POST',
        path='/v2alpha/{namecance}'.format(name='name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_gkehub_projects_locations_operations_get(client):
