...
class ConfigManagementMembershipState(Model):
    ...
    def __init__(self, binauthz_state: ConfigManagementBinauthzState=None, cluster_name: str=None, config_sync_state: ConfigManagementConfigSyncState=None, hierarchy_controller_state: ConfigManagementHierarchyControllerState=None, membership_spec: ConfigManagementMembershipSpec=None, operator_state: ConfigManagementOperatorState=None, policy_controller_state: ConfigManagementPolicyControllerState=None):
        ...
        """
        self.openapi_types = {
            'binauthz_state': ConfigManagementBinauthzState,
            'cluster_name': str,
        ...
        self._binauthz_state = binauthz_state
    ...
    @property
    def binauthz_state(self):
        """Gets the binauthz_state of this ConfigManagementMembershipState.


        :return: The binauthz_state of this ConfigManagementMembershipState.
        :rtype: ConfigManagementBinauthzState
        """
        return self._binauthz_state

    @binauthz_state.setter
    def binauthz_state(self, binauthz_state):
        """Sets the binauthz_state of this ConfigManagementMembershipState.


        :param binauthz_state: The binauthz_state of this ConfigManagementMembershipState.
        :type binauthz_state: ConfigManagementBinauthzState
        """
