...
class CommonFeatureState(Model):
    ...
    def __init__(self, appdevexperience: AppDevExperienceFeatureState=None, clusterupgrade: ClusterUpgradeFleetState=None, fleetobservability: FleetObservabilityFeatureState=None, state: FeatureState=None):
