...
async def test_gkehub_projects_locations_features_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta/{parent}/features'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_gkehub_projects_locations_fleets_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta/{parent}/fleets'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_gkehub_projects_locations_memberships_bindings_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta/{parent}/bindings'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_gkehub_projects_locations_memberships_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta/{parent}/memberships'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_gkehub_projects_locations_memberships_generate_connect_manifest(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1beta/{namegenerate_connect_manifes}'.format(name='name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_gkehub_projects_locations_memberships_rbacrolebindings_generate_membership_rbac_role_binding_yaml(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta/{parent}/rbacrolebindings:generateMembershipRBACRoleBindingYAML'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_gkehub_projects_locations_scopes_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta/{parent}/scopes'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_gkehub_projects_locations_scopes_namespaces_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta/{parent}/namespaces'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_gkehub_projects_locations_scopes_rbacrolebindings_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta/{parent}/rbacrolebindings'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
