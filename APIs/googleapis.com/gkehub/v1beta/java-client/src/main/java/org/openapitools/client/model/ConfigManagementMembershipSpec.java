...
public class ConfigManagementMembershipSpec {
  public static final String SERIALIZED_NAME_BINAUTHZ = "binauthz";
  @SerializedName(SERIALIZED_NAME_BINAUTHZ)
  ...
  public ConfigManagementMembershipSpec binauthz(ConfigManagementBinauthzConfig binauthz) {
  ...
  public void setBinauthz(ConfigManagementBinauthzConfig binauthz) {
    this.binauthz = binauthz;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.binauthz, configManagementMembershipSpec.binauthz) &&
        Objects.equals(this.cluster, configManagementMembershipSpec.cluster) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(binauthz, cluster, configSync, hierarchyController, management, policyController, version);
  }
  ...
  public String toString() {
    ...
    sb.append("    binauthz: ").append(toIndentedString(binauthz)).append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("binauthz") != null && !jsonObj.get("binauthz").isJsonNull()) {
        ConfigManagementBinauthzConfig.validateJsonElement(jsonObj.get("binauthz"));
      }
