...
public class MembershipFeatureState {
  ...
  public MembershipFeatureState metering(MeteringMembershipState metering) {
  ...
  public void setMetering(MeteringMembershipState metering) {
    this.metering = metering;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.appdevexperience, membershipFeatureState.appdevexperience) &&
        ...
        Objects.equals(this.metering, membershipFeatureState.metering) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(appdevexperience, clusterupgrade, configmanagement, fleetobservability, identityservice, metering, policycontroller, servicemesh, state);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("metering") != null && !jsonObj.get("metering").isJsonNull()) {
        MeteringMembershipState.validateJsonElement(jsonObj.get("metering"));
      }
