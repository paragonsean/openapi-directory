...
public:
    ...
    */
    virtual void gkehub_projects_locations_memberships_rbacrolebindings_generateMembershipRBACRoleBindingYAML(const QString &parent, const ::OpenAPI::OptionalParam<QString> &_xgafv = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &access_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &alt = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &callback = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &fields = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &key = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &oauth_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &pretty_print = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &quota_user = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &upload_protocol = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &upload_type = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &rbacrolebinding_id = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAIRBACRoleBinding> &oairbac_role_binding = ::OpenAPI::OptionalParam<OAIRBACRoleBinding>());
...
private:
    ...
    void gkehub_projects_locations_memberships_rbacrolebindings_generateMembershipRBACRoleBindingYAMLCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void gkehub_projects_locations_memberships_rbacrolebindings_generateMembershipRBACRoleBindingYAMLSignal(OAIGenerateMembershipRBACRoleBindingYAMLResponse summary);
    ...
    void gkehub_projects_locations_memberships_rbacrolebindings_generateMembershipRBACRoleBindingYAMLSignalFull(OAIHttpRequestWorker *worker, OAIGenerateMembershipRBACRoleBindingYAMLResponse summary);
    ...
    Q_DECL_DEPRECATED_X("Use gkehub_projects_locations_memberships_rbacrolebindings_generateMembershipRBACRoleBindingYAMLSignalError() instead")
    void gkehub_projects_locations_memberships_rbacrolebindings_generateMembershipRBACRoleBindingYAMLSignalE(OAIGenerateMembershipRBACRoleBindingYAMLResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void gkehub_projects_locations_memberships_rbacrolebindings_generateMembershipRBACRoleBindingYAMLSignalError(OAIGenerateMembershipRBACRoleBindingYAMLResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use gkehub_projects_locations_memberships_rbacrolebindings_generateMembershipRBACRoleBindingYAMLSignalErrorFull() instead")
    void gkehub_projects_locations_memberships_rbacrolebindings_generateMembershipRBACRoleBindingYAMLSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void gkehub_projects_locations_memberships_rbacrolebindings_generateMembershipRBACRoleBindingYAMLSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
