...
class UserOwnedDrydockNote(Model):
    ...
    def __init__(self, delegation_service_account_email: str=None, note_reference: str=None, public_keys: List[AttestorPublicKey]=None):
        """UserOwnedDrydockNote - a model defined in OpenAPI

        :param delegation_service_account_email: The delegation_service_account_email of this UserOwnedDrydockNote.
        :param note_reference: The note_reference of this UserOwnedDrydockNote.
        :param public_keys: The public_keys of this UserOwnedDrydockNote.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'UserOwnedDrydockNote':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The UserOwnedDrydockNote of this UserOwnedDrydockNote.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def delegation_service_account_email(self):
        """Gets the delegation_service_account_email of this UserOwnedDrydockNote.

        Output only. This field will contain the service account email address that this Attestor will use as the principal when querying Container Analysis. Attestor administrators must grant this service account the IAM role needed to read attestations from the note_reference in Container Analysis (`containeranalysis.notes.occurrences.viewer`). This email address is fixed for the lifetime of the Attestor, but callers should not make any other assumptions about the service account email; future versions may use an email based on a different naming pattern.

        :return: The delegation_service_account_email of this UserOwnedDrydockNote.
        :rtype: str
        """
    ...
    def delegation_service_account_email(self, delegation_service_account_email):
        """Sets the delegation_service_account_email of this UserOwnedDrydockNote.
    ...
    def note_reference(self):
        """Gets the note_reference of this UserOwnedDrydockNote.
        ...
        :return: The note_reference of this UserOwnedDrydockNote.
        :rtype: str
        """
    ...
    def note_reference(self, note_reference):
        """Sets the note_reference of this UserOwnedDrydockNote.
    ...
    def public_keys(self):
        """Gets the public_keys of this UserOwnedDrydockNote.

        Optional. Public keys that verify attestations signed by this attestor. This field may be updated. If this field is non-empty, one of the specified public keys must verify that an attestation was signed by this attestor for the image specified in the admission request. If this field is empty, this attestor always returns that no valid attestations exist.

        :return: The public_keys of this UserOwnedDrydockNote.
    ...
    def public_keys(self, public_keys):
        """Sets the public_keys of this UserOwnedDrydockNote.
