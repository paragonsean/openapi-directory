...
public class CheckSet {
  ...
  public CheckSet checks(List<Check> checks) {
    this.checks = checks;
    return this;
  }

  public CheckSet addChecksItem(Check checksItem) {
    if (this.checks == null) {
  ...
  public CheckSet displayName(String displayName) {
  ...
  public CheckSet imageAllowlist(ImageAllowlist imageAllowlist) {
  ...
  public CheckSet scope(Scope scope) {
    this.scope = scope;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.checks, checkSet.checks) &&
        Objects.equals(this.displayName, checkSet.displayName) &&
        Objects.equals(this.imageAllowlist, checkSet.imageAllowlist) &&
        Objects.equals(this.scope, checkSet.scope);
  }

  @Override
  public int hashCode() {
    return Objects.hash(checks, displayName, imageAllowlist, scope);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CheckSet {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CheckSet
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CheckSet.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CheckSet is not found in the empty JSON string", CheckSet.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CheckSet.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CheckSet` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CheckSet.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CheckSet' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CheckSet> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CheckSet.class));

       return (TypeAdapter<T>) new TypeAdapter<CheckSet>() {
           @Override
           public void write(JsonWriter out, CheckSet value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CheckSet read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CheckSet given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CheckSet
   * @throws IOException if the JSON string is invalid with respect to CheckSet
   */
  public static CheckSet fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CheckSet.class);
  }

  /**
   * Convert an instance of CheckSet to an JSON string
   *
   * @return JSON string
   */
