...
public class UserOwnedGrafeasNote {
  ...
  public UserOwnedGrafeasNote noteReference(String noteReference) {
  ...
  public UserOwnedGrafeasNote publicKeys(List<AttestorPublicKey> publicKeys) {
    this.publicKeys = publicKeys;
    return this;
  }

  public UserOwnedGrafeasNote addPublicKeysItem(AttestorPublicKey publicKeysItem) {
  ...
  public boolean equals(Object o) {
    ...
    UserOwnedGrafeasNote userOwnedGrafeasNote = (UserOwnedGrafeasNote) o;
    return Objects.equals(this.delegationServiceAccountEmail, userOwnedGrafeasNote.delegationServiceAccountEmail) &&
        Objects.equals(this.noteReference, userOwnedGrafeasNote.noteReference) &&
        Objects.equals(this.publicKeys, userOwnedGrafeasNote.publicKeys);
  }
  ...
  public String toString() {
    ...
    sb.append("class UserOwnedGrafeasNote {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UserOwnedGrafeasNote
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserOwnedGrafeasNote.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserOwnedGrafeasNote is not found in the empty JSON string", UserOwnedGrafeasNote.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserOwnedGrafeasNote.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserOwnedGrafeasNote` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserOwnedGrafeasNote.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserOwnedGrafeasNote' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserOwnedGrafeasNote> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserOwnedGrafeasNote.class));

       return (TypeAdapter<T>) new TypeAdapter<UserOwnedGrafeasNote>() {
           @Override
           public void write(JsonWriter out, UserOwnedGrafeasNote value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserOwnedGrafeasNote read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UserOwnedGrafeasNote given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UserOwnedGrafeasNote
   * @throws IOException if the JSON string is invalid with respect to UserOwnedGrafeasNote
   */
  public static UserOwnedGrafeasNote fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserOwnedGrafeasNote.class);
  }

  /**
   * Convert an instance of UserOwnedGrafeasNote to an JSON string
   *
   * @return JSON string
   */
