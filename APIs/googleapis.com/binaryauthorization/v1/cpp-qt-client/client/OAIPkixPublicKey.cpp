...
QString OAIPkixPublicKey::getKeyId() const {
    return m_key_id;
}
void OAIPkixPublicKey::setKeyId(const QString &key_id) {
    m_key_id = key_id;
    m_key_id_isSet = true;
}

bool OAIPkixPublicKey::is_key_id_Set() const{
    return m_key_id_isSet;
}

bool OAIPkixPublicKey::is_key_id_Valid() const{
