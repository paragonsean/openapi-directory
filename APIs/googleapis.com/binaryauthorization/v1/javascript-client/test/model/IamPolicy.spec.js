...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BinaryAuthorizationApi.IamPolicy();
  });
  ...
  describe('IamPolicy', function() {
    it('should create an instance of IamPolicy', function() {
      // uncomment below and update the code to test IamPolicy
      //var instance = new BinaryAuthorizationApi.IamPolicy();
      //expect(instance).to.be.a(BinaryAuthorizationApi.IamPolicy);
    });
