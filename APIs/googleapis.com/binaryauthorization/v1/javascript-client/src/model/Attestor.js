...
class Attestor {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('userOwnedGrafeasNote')) {
                obj['userOwnedGrafeasNote'] = UserOwnedGrafeasNote.constructFromObject(data['userOwnedGrafeasNote']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['userOwnedGrafeasNote']) { // data not null
          UserOwnedGrafeasNote.validateJSON(data['userOwnedGrafeasNote']);
        }
...
/**
 * @member {module:model/UserOwnedGrafeasNote} userOwnedGrafeasNote
 */
Attestor.prototype['userOwnedGrafeasNote'] = undefined;
