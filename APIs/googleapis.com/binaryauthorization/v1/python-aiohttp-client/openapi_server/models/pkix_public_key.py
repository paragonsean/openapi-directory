...
class PkixPublicKey(Model):
    ...
    def __init__(self, key_id: str=None, public_key_pem: str=None, signature_algorithm: str=None):
        """PkixPublicKey - a model defined in OpenAPI

        :param key_id: The key_id of this PkixPublicKey.
    ...
    @property
    def key_id(self):
        """Gets the key_id of this PkixPublicKey.
        ...
        :return: The key_id of this PkixPublicKey.
        :rtype: str
        """
        return self._key_id
    ...
    def key_id(self, key_id):
        """Sets the key_id of this PkixPublicKey.
