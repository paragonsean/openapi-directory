...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ReaderRevenueSubscriptionLinkingApi.Entitlement();
  });
  ...
  describe('Entitlement', function() {
    it('should create an instance of Entitlement', function() {
      ...
      //var instance = new ReaderRevenueSubscriptionLinkingApi.Entitlement();
      //expect(instance).to.be.a(ReaderRevenueSubscriptionLinkingApi.Entitlement);
    });
    ...
    it('should have the property subscriptionToken (base name: "subscriptionToken")', function() {
      // uncomment below and update the code to test the property subscriptionToken
      //var instance = new ReaderRevenueSubscriptionLinkingApi.Entitlement();
      //expect(instance).to.be();
    });
