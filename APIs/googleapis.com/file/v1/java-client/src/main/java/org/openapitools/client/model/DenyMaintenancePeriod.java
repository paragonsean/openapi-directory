...
public class DenyMaintenancePeriod {
  ...
  public DenyMaintenancePeriod endDate(Date endDate) {
  ...
  public DenyMaintenancePeriod startDate(Date startDate) {
  ...
  public DenyMaintenancePeriod time(TimeOfDay time) {
    this.time = time;
    return this;
  }
