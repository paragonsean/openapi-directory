...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudFilestoreApi.ListBackupsResponse();
  });
  ...
  describe('ListBackupsResponse', function() {
    it('should create an instance of ListBackupsResponse', function() {
      ...
      //var instance = new CloudFilestoreApi.ListBackupsResponse();
      //expect(instance).to.be.a(CloudFilestoreApi.ListBackupsResponse);
    });
