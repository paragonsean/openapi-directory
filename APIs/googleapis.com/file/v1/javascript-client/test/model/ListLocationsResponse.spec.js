...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudFilestoreApi.ListLocationsResponse();
  });
  ...
  describe('ListLocationsResponse', function() {
    it('should create an instance of ListLocationsResponse', function() {
      ...
      //var instance = new CloudFilestoreApi.ListLocationsResponse();
      //expect(instance).to.be.a(CloudFilestoreApi.ListLocationsResponse);
    });
