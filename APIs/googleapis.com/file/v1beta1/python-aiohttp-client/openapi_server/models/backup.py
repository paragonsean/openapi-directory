...
class Backup(Model):
    ...
    def __init__(self, capacity_gb: str=None, create_time: str=None, description: str=None, download_bytes: str=None, kms_key_name: str=None, labels: Dict[str, str]=None, name: str=None, satisfies_pzi: bool=None, satisfies_pzs: bool=None, source_file_share: str=None, source_instance: str=None, source_instance_tier: str=None, state: str=None, storage_bytes: str=None):
        ...
        :param kms_key_name: The kms_key_name of this Backup.
    ...
    def kms_key_name(self):
        """Gets the kms_key_name of this Backup.

        Immutable. KMS key name used for data encryption.

        :return: The kms_key_name of this Backup.
        :rtype: str
        """
    ...
    def kms_key_name(self, kms_key_name):
        """Sets the kms_key_name of this Backup.
