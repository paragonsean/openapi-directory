...
QString OAIBackup::getKmsKeyName() const {
    return m_kms_key_name;
}
void OAIBackup::setKmsKeyName(const QString &kms_key_name) {
    m_kms_key_name = kms_key_name;
    m_kms_key_name_isSet = true;
}

bool OAIBackup::is_kms_key_name_Set() const{
    return m_kms_key_name_isSet;
}

bool OAIBackup::is_kms_key_name_Valid() const{
