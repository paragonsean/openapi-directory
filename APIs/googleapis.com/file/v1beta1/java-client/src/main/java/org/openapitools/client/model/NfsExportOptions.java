...
public class NfsExportOptions {
  ...
  public enum SecurityFlavorsEnum {
    ...
    public static SecurityFlavorsEnum fromValue(String value) {
    ...
    public static class Adapter extends TypeAdapter<SecurityFlavorsEnum> {
      ...
      public SecurityFlavorsEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return SecurityFlavorsEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      SecurityFlavorsEnum.fromValue(value);
    }
  }

  public static final String SERIALIZED_NAME_SECURITY_FLAVORS = "securityFlavors";
  @SerializedName(SERIALIZED_NAME_SECURITY_FLAVORS)
  private List<SecurityFlavorsEnum> securityFlavors = new ArrayList<>();
  ...
  public NfsExportOptions securityFlavors(List<SecurityFlavorsEnum> securityFlavors) {
    this.securityFlavors = securityFlavors;
    return this;
  }

  public NfsExportOptions addSecurityFlavorsItem(SecurityFlavorsEnum securityFlavorsItem) {
    if (this.securityFlavors == null) {
      this.securityFlavors = new ArrayList<>();
    }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accessMode, nfsExportOptions.accessMode) &&
        ...
        Objects.equals(this.securityFlavors, nfsExportOptions.securityFlavors) &&
        Objects.equals(this.squashMode, nfsExportOptions.squashMode);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accessMode, anonGid, anonUid, ipRanges, securityFlavors, squashMode);
  }
  ...
  static {
    ...
    openapiFields.add("securityFlavors");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // ensure the optional json data is an array if present
      if (jsonObj.get("securityFlavors") != null && !jsonObj.get("securityFlavors").isJsonNull() && !jsonObj.get("securityFlavors").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `securityFlavors` to be an array in the JSON string but got `%s`", jsonObj.get("securityFlavors").toString()));
      }
