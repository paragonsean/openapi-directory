...
(function(root, factory) {
  ...
  describe('ProjectsApi', function() {
    ...
    describe('fileProjectsLocationsInstancesSharesCreate', function() {
      it('should call fileProjectsLocationsInstancesSharesCreate successfully', function(done) {
        //uncomment below and update the code to test fileProjectsLocationsInstancesSharesCreate
        //instance.fileProjectsLocationsInstancesSharesCreate(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('fileProjectsLocationsInstancesSharesList', function() {
      it('should call fileProjectsLocationsInstancesSharesList successfully', function(done) {
        //uncomment below and update the code to test fileProjectsLocationsInstancesSharesList
        //instance.fileProjectsLocationsInstancesSharesList(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
