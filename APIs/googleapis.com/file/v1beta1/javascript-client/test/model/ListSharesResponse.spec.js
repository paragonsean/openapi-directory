...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudFilestoreApi.ListSharesResponse();
  });
  ...
  describe('ListSharesResponse', function() {
    it('should create an instance of ListSharesResponse', function() {
      // uncomment below and update the code to test ListSharesResponse
      //var instance = new CloudFilestoreApi.ListSharesResponse();
      //expect(instance).to.be.a(CloudFilestoreApi.ListSharesResponse);
    });
