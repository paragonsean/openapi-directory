...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudFilestoreApi.ListInstancesResponse();
  });
  ...
  describe('ListInstancesResponse', function() {
    it('should create an instance of ListInstancesResponse', function() {
      ...
      //var instance = new CloudFilestoreApi.ListInstancesResponse();
      //expect(instance).to.be.a(CloudFilestoreApi.ListInstancesResponse);
    });
