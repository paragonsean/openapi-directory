...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudFilestoreApi.OperationMetadata();
  });
  ...
  describe('OperationMetadata', function() {
    it('should create an instance of OperationMetadata', function() {
      ...
      //var instance = new CloudFilestoreApi.OperationMetadata();
      //expect(instance).to.be.a(CloudFilestoreApi.OperationMetadata);
    });
