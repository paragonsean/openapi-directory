# CloudLifeSciencesApi.Network

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**network** | **String** | The network name to attach the VM&#39;s network interface to. The value will be prefixed with &#x60;global/networks/&#x60; unless it contains a &#x60;/&#x60;, in which case it is assumed to be a fully specified network resource URL. If unspecified, the global default network is used. | [optional] 
