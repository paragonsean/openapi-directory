...
**events** | [**[Event]**](Event.md) | The list of events that have happened so far during the execution of this operation. | [optional] 
**labels** | **{String: String}** | The user-defined labels associated with this operation. | [optional] 
