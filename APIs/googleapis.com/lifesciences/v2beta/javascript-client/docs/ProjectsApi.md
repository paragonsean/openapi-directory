# CloudLifeSciencesApi.ProjectsApi
...
> ListLocationsResponse lifesciencesProjectsLocationsList(name, opts)
...
```javascript
import CloudLifeSciencesApi from 'cloud_life_sciences_api';
let defaultClient = CloudLifeSciencesApi.ApiClient.instance;
...
let apiInstance = new CloudLifeSciencesApi.ProjectsApi();
...
apiInstance.lifesciencesProjectsLocationsList(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> Object lifesciencesProjectsLocationsOperationsCancel(name, opts)
...
apiInstance.lifesciencesProjectsLocationsOperationsCancel(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Operation lifesciencesProjectsLocationsOperationsGet(name, opts)
...
apiInstance.lifesciencesProjectsLocationsOperationsGet(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ListOperationsResponse lifesciencesProjectsLocationsOperationsList(name, opts)
...
let opts = {
  ...
  'pageSize': 56, // Number | The maximum number of results to return. The maximum value is 256.
  'pageToken': "pageToken_example" // String | The standard list page token.
};
apiInstance.lifesciencesProjectsLocationsOperationsList(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **pageSize** | **Number**| The maximum number of results to return. The maximum value is 256. | [optional] 
...
> Operation lifesciencesProjectsLocationsPipelinesRun(parent, opts)
...
let apiInstance = new CloudLifeSciencesApi.ProjectsApi();
let parent = "parent_example"; // String | The project and location that this request should be executed against.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'runPipelineRequest': new CloudLifeSciencesApi.RunPipelineRequest() // RunPipelineRequest | 
};
apiInstance.lifesciencesProjectsLocationsPipelinesRun(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
