...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudLifeSciencesApi.ListLocationsResponse();
  });
  ...
  describe('ListLocationsResponse', function() {
    it('should create an instance of ListLocationsResponse', function() {
      ...
      //var instance = new CloudLifeSciencesApi.ListLocationsResponse();
      //expect(instance).to.be.a(CloudLifeSciencesApi.ListLocationsResponse);
    });
