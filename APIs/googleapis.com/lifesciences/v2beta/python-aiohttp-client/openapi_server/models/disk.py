...
class Disk(Model):
    ...
    def __init__(self, name: str=None, size_gb: int=None, source_image: str=None, type: str=None):
        """Disk - a model defined in OpenAPI

        :param name: The name of this Disk.
        :param size_gb: The size_gb of this Disk.
        :param source_image: The source_image of this Disk.
    ...
    def source_image(self):
        """Gets the source_image of this Disk.

        An optional image to put on the disk before attaching it to the VM.

        :return: The source_image of this Disk.
        :rtype: str
        """
    ...
    def source_image(self, source_image):
        """Sets the source_image of this Disk.
