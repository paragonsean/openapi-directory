...
class Metadata(Model):
    ...
    def __init__(self, create_time: str=None, end_time: str=None, events: List[Event]=None, labels: Dict[str, str]=None, pipeline: Pipeline=None, pub_sub_topic: str=None, start_time: str=None):
        ...
        :param pub_sub_topic: The pub_sub_topic of this Metadata.
    ...
    def pub_sub_topic(self, pub_sub_topic):
        """Sets the pub_sub_topic of this Metadata.
