...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceManagementApi.Authentication();
  });
  ...
  describe('Authentication', function() {
    it('should create an instance of Authentication', function() {
      ...
      //var instance = new ServiceManagementApi.Authentication();
      //expect(instance).to.be.a(ServiceManagementApi.Authentication);
    });
