...
/*
 * OAIMonitoringDestination.h
 *
 * Configuration of a specific monitoring destination (the producer project or the consumer project).
 */

#ifndef OAIMonitoringDestination_H
#define OAIMonitoringDestination_H
...
class OAIMonitoringDestination : public OAIObject {
public:
    OAIMonitoringDestination();
    OAIMonitoringDestination(QString json);
    ~OAIMonitoringDestination() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMonitoringDestination)

#endif // OAIMonitoringDestination_H
