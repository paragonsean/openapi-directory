...
public:
    ...
    Q_DECL_DEPRECATED QString getObfuscatedId() const;
    Q_DECL_DEPRECATED void setObfuscatedId(const QString &obfuscated_id);
    Q_DECL_DEPRECATED bool is_obfuscated_id_Set() const;
    Q_DECL_DEPRECATED bool is_obfuscated_id_Valid() const;
