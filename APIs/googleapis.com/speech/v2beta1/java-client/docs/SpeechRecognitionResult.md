...
|**channelTag** | **Integer** | Output only. For multi-channel audio, this is the channel number corresponding to the recognized result for the audio from that channel. For &#x60;audio_channel_count&#x60; &#x3D; N, its output values can range from &#x60;1&#x60; to &#x60;N&#x60;. |  [optional] [readonly] |
