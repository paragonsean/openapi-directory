...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudSpeechToTextApi.CustomClass();
  });
  ...
  describe('CustomClass', function() {
    it('should create an instance of CustomClass', function() {
      // uncomment below and update the code to test CustomClass
      //var instance = new CloudSpeechToTextApi.CustomClass();
      //expect(instance).to.be.a(CloudSpeechToTextApi.CustomClass);
    });
