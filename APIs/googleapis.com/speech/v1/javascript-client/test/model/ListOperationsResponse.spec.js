...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudSpeechToTextApi.ListOperationsResponse();
  });
  ...
  describe('ListOperationsResponse', function() {
    it('should create an instance of ListOperationsResponse', function() {
      ...
      //var instance = new CloudSpeechToTextApi.ListOperationsResponse();
      //expect(instance).to.be.a(CloudSpeechToTextApi.ListOperationsResponse);
    });
