...
class SpeechRecognitionResult {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('resultEndTime')) {
                obj['resultEndTime'] = ApiClient.convertToType(data['resultEndTime'], 'String');
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['resultEndTime'] && !(typeof data['resultEndTime'] === 'string' || data['resultEndTime'] instanceof String)) {
            throw new Error("Expected the field `resultEndTime` to be a primitive type in the JSON string but got " + data['resultEndTime']);
        }
 ...
 * @member {String} resultEndTime
 */
SpeechRecognitionResult.prototype['resultEndTime'] = undefined;
