...
class RecognitionMetadata(Model):
    ...
    def __init__(self, audio_topic: str=None, industry_naics_code_of_audio: int=None, interaction_type: str=None, microphone_distance: str=None, original_media_type: str=None, original_mime_type: str=None, recording_device_name: str=None, recording_device_type: str=None):
