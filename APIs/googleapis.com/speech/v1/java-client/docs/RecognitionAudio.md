...
|------------ | ------------- | ------------- | -------------|
|**content** | **byte[]** | The audio data bytes encoded as specified in &#x60;RecognitionConfig&#x60;. Note: as with all bytes fields, proto buffers use a pure binary representation, whereas JSON representations use base64. |  [optional] |
