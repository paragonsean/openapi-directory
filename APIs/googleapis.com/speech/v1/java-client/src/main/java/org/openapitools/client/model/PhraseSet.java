...
public class PhraseSet {
  ...
  public PhraseSet boost(Float boost) {
    this.boost = boost;
    return this;
  }
  ...
  public PhraseSet name(String name) {
    this.name = name;
    return this;
  }
  ...
  public PhraseSet phrases(List<Phrase> phrases) {
    this.phrases = phrases;
    return this;
  }

  public PhraseSet addPhrasesItem(Phrase phrasesItem) {
  ...
  public boolean equals(Object o) {
    ...
    PhraseSet phraseSet = (PhraseSet) o;
    return Objects.equals(this.annotations, phraseSet.annotations) &&
        Objects.equals(this.boost, phraseSet.boost) &&
        Objects.equals(this.deleteTime, phraseSet.deleteTime) &&
        Objects.equals(this.displayName, phraseSet.displayName) &&
        Objects.equals(this.etag, phraseSet.etag) &&
        Objects.equals(this.expireTime, phraseSet.expireTime) &&
        Objects.equals(this.kmsKeyName, phraseSet.kmsKeyName) &&
        Objects.equals(this.kmsKeyVersionName, phraseSet.kmsKeyVersionName) &&
        Objects.equals(this.name, phraseSet.name) &&
        Objects.equals(this.phrases, phraseSet.phrases) &&
        Objects.equals(this.reconciling, phraseSet.reconciling) &&
        Objects.equals(this.state, phraseSet.state) &&
        Objects.equals(this.uid, phraseSet.uid);
  }

  @Override
  public int hashCode() {
    return Objects.hash(annotations, boost, deleteTime, displayName, etag, expireTime, kmsKeyName, kmsKeyVersionName, name, phrases, reconciling, state, uid);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PhraseSet {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PhraseSet
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PhraseSet.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PhraseSet is not found in the empty JSON string", PhraseSet.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PhraseSet.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PhraseSet` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PhraseSet.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PhraseSet' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PhraseSet> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PhraseSet.class));

       return (TypeAdapter<T>) new TypeAdapter<PhraseSet>() {
           @Override
           public void write(JsonWriter out, PhraseSet value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PhraseSet read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PhraseSet given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PhraseSet
   * @throws IOException if the JSON string is invalid with respect to PhraseSet
   */
  public static PhraseSet fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PhraseSet.class);
  }

  /**
   * Convert an instance of PhraseSet to an JSON string
   *
   * @return JSON string
   */
