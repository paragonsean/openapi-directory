...
public class RecognitionMetadata {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(audioTopic, industryNaicsCodeOfAudio, interactionType, microphoneDistance, originalMediaType, originalMimeType, recordingDeviceName, recordingDeviceType);
  }
