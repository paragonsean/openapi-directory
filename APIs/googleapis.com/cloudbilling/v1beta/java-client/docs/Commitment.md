...
|------------ | ------------- | ------------- | -------------|
|**name** | **String** | Required. A name for this commitment. All commitments in a CostScenario must have unique names. Each name may be at most 128 characters long. |  [optional] |
|**vmResourceBasedCud** | [**VmResourceBasedCud**](VmResourceBasedCud.md) |  |  [optional] |
