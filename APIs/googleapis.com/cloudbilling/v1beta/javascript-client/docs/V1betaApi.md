...
> EstimateCostScenarioWithListPriceResponse cloudbillingEstimateCostScenario(opts)
...
let apiInstance = new CloudBillingApi.V1betaApi();
let opts = {
  ...
  'estimateCostScenarioWithListPriceRequest': new CloudBillingApi.EstimateCostScenarioWithListPriceRequest() // EstimateCostScenarioWithListPriceRequest | 
};
apiInstance.cloudbillingEstimateCostScenario(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
