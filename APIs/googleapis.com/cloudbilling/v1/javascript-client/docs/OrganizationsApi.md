# CloudBillingApi.OrganizationsApi
...
> BillingAccount cloudbillingOrganizationsBillingAccountsCreate(parent, opts)
...
let apiInstance = new CloudBillingApi.OrganizationsApi();
...
apiInstance.cloudbillingOrganizationsBillingAccountsCreate(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> ListBillingAccountsResponse cloudbillingOrganizationsBillingAccountsList(parent, opts)
...
apiInstance.cloudbillingOrganizationsBillingAccountsList(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> BillingAccount cloudbillingOrganizationsBillingAccountsMove(destinationParent, name, opts)
...
let apiInstance = new CloudBillingApi.OrganizationsApi();
let destinationParent = "destinationParent_example"; // String | Required. The resource name of the Organization to move the billing account under. Must be of the form `organizations/{organization_id}`.
...
apiInstance.cloudbillingOrganizationsBillingAccountsMove(destinationParent, name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
