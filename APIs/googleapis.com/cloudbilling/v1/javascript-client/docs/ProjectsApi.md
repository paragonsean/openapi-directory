...
> ProjectBillingInfo cloudbillingProjectsGetBillingInfo(name, opts)
...
let apiInstance = new CloudBillingApi.ProjectsApi();
let name = "name_example"; // String | Required. The resource name of the project for which billing information is retrieved. For example, `projects/tokyo-rain-123`.
let opts = {
...
apiInstance.cloudbillingProjectsGetBillingInfo(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> ProjectBillingInfo cloudbillingProjectsUpdateBillingInfo(name, opts)
...
let apiInstance = new CloudBillingApi.ProjectsApi();
let name = "name_example"; // String | Required. The resource name of the project associated with the billing information that you want to update. For example, `projects/tokyo-rain-123`.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'projectBillingInfo': new CloudBillingApi.ProjectBillingInfo() // ProjectBillingInfo | 
};
apiInstance.cloudbillingProjectsUpdateBillingInfo(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
