...
void OAIProjectsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("cloudbilling_projects_getBillingInfo", defaultConf);
    _serverIndices.insert("cloudbilling_projects_getBillingInfo", 0);
    _serverConfigs.insert("cloudbilling_projects_updateBillingInfo", defaultConf);
    _serverIndices.insert("cloudbilling_projects_updateBillingInfo", 0);
}
...
void OAIProjectsApi::cloudbilling_projects_getBillingInfo(const QString &name, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type) {
    QString fullPath = QString(_serverConfigs["cloudbilling_projects_getBillingInfo"][_serverIndices.value("cloudbilling_projects_getBillingInfo")].URL()+"/v1/{name}/billingInfo");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::cloudbilling_projects_getBillingInfoCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::cloudbilling_projects_getBillingInfoCallback);
...
void OAIProjectsApi::cloudbilling_projects_getBillingInfoCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIProjectBillingInfo output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT cloudbilling_projects_getBillingInfoSignal(output);
        Q_EMIT cloudbilling_projects_getBillingInfoSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT cloudbilling_projects_getBillingInfoSignalE(output, error_type, error_str);
        Q_EMIT cloudbilling_projects_getBillingInfoSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT cloudbilling_projects_getBillingInfoSignalError(output, error_type, error_str);
        Q_EMIT cloudbilling_projects_getBillingInfoSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectsApi::cloudbilling_projects_updateBillingInfo(const QString &name, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<OAIProjectBillingInfo> &oai_project_billing_info) {
    QString fullPath = QString(_serverConfigs["cloudbilling_projects_updateBillingInfo"][_serverIndices.value("cloudbilling_projects_updateBillingInfo")].URL()+"/v1/{name}/billingInfo");
    ...
    if (oai_project_billing_info.hasValue()){

        
        QByteArray output = oai_project_billing_info.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::cloudbilling_projects_updateBillingInfoCallback);
    connect(this, &OAIProjectsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::cloudbilling_projects_updateBillingInfoCallback);
    connect(this, &OAIProjectsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectsApi::cloudbilling_projects_updateBillingInfoCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT cloudbilling_projects_updateBillingInfoSignal(output);
        Q_EMIT cloudbilling_projects_updateBillingInfoSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        QString scopeStr = scope.join(" ");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT cloudbilling_projects_updateBillingInfoSignalE(output, error_type, error_str);
        Q_EMIT cloudbilling_projects_updateBillingInfoSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT cloudbilling_projects_updateBillingInfoSignalError(output, error_type, error_str);
        Q_EMIT cloudbilling_projects_updateBillingInfoSignalErrorFull(worker, error_type, error_str);
    }
}
