...
void OAIOrganizationsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("cloudbilling_organizations_billingAccounts_create", defaultConf);
    _serverIndices.insert("cloudbilling_organizations_billingAccounts_create", 0);
    _serverConfigs.insert("cloudbilling_organizations_billingAccounts_list", defaultConf);
    _serverIndices.insert("cloudbilling_organizations_billingAccounts_list", 0);
    _serverConfigs.insert("cloudbilling_organizations_billingAccounts_move", defaultConf);
    _serverIndices.insert("cloudbilling_organizations_billingAccounts_move", 0);
}
...
void OAIOrganizationsApi::cloudbilling_organizations_billingAccounts_create(const QString &parent, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<OAIBillingAccount> &oai_billing_account) {
    QString fullPath = QString(_serverConfigs["cloudbilling_organizations_billingAccounts_create"][_serverIndices.value("cloudbilling_organizations_billingAccounts_create")].URL()+"/v1/{parent}/billingAccounts");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIOrganizationsApi::cloudbilling_organizations_billingAccounts_createCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIOrganizationsApi::cloudbilling_organizations_billingAccounts_createCallback);
...
void OAIOrganizationsApi::cloudbilling_organizations_billingAccounts_createCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT cloudbilling_organizations_billingAccounts_createSignal(output);
        Q_EMIT cloudbilling_organizations_billingAccounts_createSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT cloudbilling_organizations_billingAccounts_createSignalE(output, error_type, error_str);
        Q_EMIT cloudbilling_organizations_billingAccounts_createSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT cloudbilling_organizations_billingAccounts_createSignalError(output, error_type, error_str);
        Q_EMIT cloudbilling_organizations_billingAccounts_createSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIOrganizationsApi::cloudbilling_organizations_billingAccounts_list(const QString &parent, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<QString> &filter, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &page_token) {
    QString fullPath = QString(_serverConfigs["cloudbilling_organizations_billingAccounts_list"][_serverIndices.value("cloudbilling_organizations_billingAccounts_list")].URL()+"/v1/{parent}/billingAccounts");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIOrganizationsApi::cloudbilling_organizations_billingAccounts_listCallback);
    connect(this, &OAIOrganizationsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIOrganizationsApi::cloudbilling_organizations_billingAccounts_listCallback);
    connect(this, &OAIOrganizationsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIOrganizationsApi::cloudbilling_organizations_billingAccounts_listCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT cloudbilling_organizations_billingAccounts_listSignal(output);
        Q_EMIT cloudbilling_organizations_billingAccounts_listSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        QString scopeStr = scope.join(" ");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT cloudbilling_organizations_billingAccounts_listSignalE(output, error_type, error_str);
        Q_EMIT cloudbilling_organizations_billingAccounts_listSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT cloudbilling_organizations_billingAccounts_listSignalError(output, error_type, error_str);
        Q_EMIT cloudbilling_organizations_billingAccounts_listSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIOrganizationsApi::cloudbilling_organizations_billingAccounts_move(const QString &destination_parent, const QString &name, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type) {
    QString fullPath = QString(_serverConfigs["cloudbilling_organizations_billingAccounts_move"][_serverIndices.value("cloudbilling_organizations_billingAccounts_move")].URL()+"/v1/{destinationParent}/{name}:move");
    
    
    {
        QString destination_parentPathParam("{");
        destination_parentPathParam.append("destinationParent").append("}");
        QString pathPrefix, pathSuffix, pathDelimiter;
        QString pathStyle = "simple";
        if (pathStyle == "")
            pathStyle = "simple";
        pathPrefix = getParamStylePrefix(pathStyle);
        pathSuffix = getParamStyleSuffix(pathStyle);
        pathDelimiter = getParamStyleDelimiter(pathStyle, "destinationParent", false);
        QString paramString = (pathStyle == "matrix") ? pathPrefix+"destinationParent"+pathSuffix : pathPrefix;
        fullPath.replace(destination_parentPathParam, paramString+QUrl::toPercentEncoding(::OpenAPI::toStringValue(destination_parent)));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIOrganizationsApi::cloudbilling_organizations_billingAccounts_moveCallback);
    connect(this, &OAIOrganizationsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIOrganizationsApi::cloudbilling_organizations_billingAccounts_moveCallback);
    connect(this, &OAIOrganizationsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIOrganizationsApi::cloudbilling_organizations_billingAccounts_moveCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT cloudbilling_organizations_billingAccounts_moveSignal(output);
        Q_EMIT cloudbilling_organizations_billingAccounts_moveSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        QString scopeStr = scope.join(" ");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT cloudbilling_organizations_billingAccounts_moveSignalE(output, error_type, error_str);
        Q_EMIT cloudbilling_organizations_billingAccounts_moveSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT cloudbilling_organizations_billingAccounts_moveSignalError(output, error_type, error_str);
        Q_EMIT cloudbilling_organizations_billingAccounts_moveSignalErrorFull(worker, error_type, error_str);
    }
}
