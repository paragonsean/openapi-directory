...
public class WorkstationConfig {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(annotations, conditions, container, createTime, degraded, deleteTime, disableTcpConnections, displayName, enableAuditAgent, encryptionKey, etag, host, idleTimeout, labels, name, persistentDirectories, readinessChecks, reconciling, replicaZones, runningTimeout, uid, updateTime);
  }
