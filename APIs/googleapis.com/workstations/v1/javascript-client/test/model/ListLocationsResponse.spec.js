...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudWorkstationsApi.ListLocationsResponse();
  });
  ...
  describe('ListLocationsResponse', function() {
    it('should create an instance of ListLocationsResponse', function() {
      ...
      //var instance = new CloudWorkstationsApi.ListLocationsResponse();
      //expect(instance).to.be.a(CloudWorkstationsApi.ListLocationsResponse);
    });
