...
class WorkstationConfig(Model):
    ...
    def __init__(self, annotations: Dict[str, str]=None, conditions: List[Status]=None, container: Container=None, create_time: str=None, degraded: bool=None, delete_time: str=None, disable_tcp_connections: bool=None, display_name: str=None, enable_audit_agent: bool=None, encryption_key: CustomerEncryptionKey=None, ephemeral_directories: List[EphemeralDirectory]=None, etag: str=None, host: Host=None, idle_timeout: str=None, labels: Dict[str, str]=None, name: str=None, persistent_directories: List[PersistentDirectory]=None, readiness_checks: List[ReadinessCheck]=None, reconciling: bool=None, replica_zones: List[str]=None, running_timeout: str=None, uid: str=None, update_time: str=None):
        ...
        :param ephemeral_directories: The ephemeral_directories of this WorkstationConfig.
        ...
        self.openapi_types = {
            ...
            'ephemeral_directories': List[EphemeralDirectory],
            'etag': str,
            'host': Host,
            'idle_timeout': str,
            'labels': Dict[str, str],
        ...
        self._ephemeral_directories = ephemeral_directories
        self._etag = etag
        self._host = host
    ...
    @property
    def ephemeral_directories(self):
        """Gets the ephemeral_directories of this WorkstationConfig.

        Optional. Ephemeral directories which won't persist across workstation sessions.

        :return: The ephemeral_directories of this WorkstationConfig.
        :rtype: List[EphemeralDirectory]
        """
        return self._ephemeral_directories

    @ephemeral_directories.setter
    def ephemeral_directories(self, ephemeral_directories):
        """Sets the ephemeral_directories of this WorkstationConfig.

        Optional. Ephemeral directories which won't persist across workstation sessions.

        :param ephemeral_directories: The ephemeral_directories of this WorkstationConfig.
        :type ephemeral_directories: List[EphemeralDirectory]
        """
