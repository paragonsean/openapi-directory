...
class GceInstance(Model):
    ...
    def __init__(self, accelerators: List[Accelerator]=None, boot_disk_size_gb: int=None, confidential_instance_config: GceConfidentialInstanceConfig=None, disable_public_ip_addresses: bool=None, disable_ssh: bool=None, enable_nested_virtualization: bool=None, machine_type: str=None, pool_size: int=None, pooled_instances: int=None, service_account: str=None, service_account_scopes: List[str]=None, shielded_instance_config: GceShieldedInstanceConfig=None, tags: List[str]=None):
        """GceInstance - a model defined in OpenAPI

        :param accelerators: The accelerators of this GceInstance.
        ...
        :param disable_ssh: The disable_ssh of this GceInstance.
    ...
    def accelerators(self):
        """Gets the accelerators of this GceInstance.

        Optional. A list of the type and count of accelerator cards attached to the instance.

        :return: The accelerators of this GceInstance.
    ...
    def accelerators(self, accelerators):
        """Sets the accelerators of this GceInstance.
    ...
    def disable_ssh(self):
        """Gets the disable_ssh of this GceInstance.

        Optional. Whether to disable SSH access to the VM.

        :return: The disable_ssh of this GceInstance.
        :rtype: bool
        """
        return self._disable_ssh

    @disable_ssh.setter
    def disable_ssh(self, disable_ssh):
        """Sets the disable_ssh of this GceInstance.

        Optional. Whether to disable SSH access to the VM.

        :param disable_ssh: The disable_ssh of this GceInstance.
        :type disable_ssh: bool
        """
