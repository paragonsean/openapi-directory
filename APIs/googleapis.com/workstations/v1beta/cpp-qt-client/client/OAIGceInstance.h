...
public:
    ...
    bool isDisableSsh() const;
    void setDisableSsh(const bool &disable_ssh);
    bool is_disable_ssh_Set() const;
    bool is_disable_ssh_Valid() const;
...
private:
    ...
    bool m_disable_ssh;
    bool m_disable_ssh_isSet;
    bool m_disable_ssh_isValid;
