...
class GceInstance {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('disableSsh')) {
                obj['disableSsh'] = ApiClient.convertToType(data['disableSsh'], 'Boolean');
            }
 ...
 */
GceInstance.prototype['accelerators'] = undefined;
 ...
 * @member {Boolean} disableSsh
 */
GceInstance.prototype['disableSsh'] = undefined;
