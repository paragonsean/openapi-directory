# CloudWorkstationsApi.WorkstationCluster
...
**conditions** | [**[Status]**](Status.md) | Output only. Status conditions describing the workstation cluster&#39;s current state. | [optional] [readonly] 
...
**labels** | **{String: String}** | Optional. [Labels](https://cloud.google.com/workstations/docs/label-resources) that are applied to the workstation cluster and that are also propagated to the underlying Compute Engine resources. | [optional] 
