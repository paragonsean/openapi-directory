# CloudWorkstationsApi.OperationMetadata
...
**createTime** | **String** | Output only. Time that the operation was created. | [optional] [readonly] 
**endTime** | **String** | Output only. Time that the operation finished running. | [optional] [readonly] 
**requestedCancellation** | **Boolean** | Output only. Identifies whether the user has requested cancellation of the operation. | [optional] [readonly] 
