...
void OAIOrganizationsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("orgpolicy_organizations_customConstraints_create", defaultConf);
    _serverIndices.insert("orgpolicy_organizations_customConstraints_create", 0);
    _serverConfigs.insert("orgpolicy_organizations_customConstraints_list", defaultConf);
    _serverIndices.insert("orgpolicy_organizations_customConstraints_list", 0);
}
...
void OAIOrganizationsApi::orgpolicy_organizations_customConstraints_create(const QString &parent, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<OAIGoogleCloudOrgpolicyV2CustomConstraint> &oai_google_cloud_orgpolicy_v2_custom_constraint) {
    ...
    if (oai_google_cloud_orgpolicy_v2_custom_constraint.hasValue()){

        
        QByteArray output = oai_google_cloud_orgpolicy_v2_custom_constraint.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIOrganizationsApi::orgpolicy_organizations_customConstraints_createCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIOrganizationsApi::orgpolicy_organizations_customConstraints_createCallback);
...
void OAIOrganizationsApi::orgpolicy_organizations_customConstraints_createCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIGoogleCloudOrgpolicyV2CustomConstraint output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT orgpolicy_organizations_customConstraints_createSignal(output);
        Q_EMIT orgpolicy_organizations_customConstraints_createSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT orgpolicy_organizations_customConstraints_createSignalE(output, error_type, error_str);
        Q_EMIT orgpolicy_organizations_customConstraints_createSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT orgpolicy_organizations_customConstraints_createSignalError(output, error_type, error_str);
        Q_EMIT orgpolicy_organizations_customConstraints_createSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIOrganizationsApi::orgpolicy_organizations_customConstraints_list(const QString &parent, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &page_token) {
    QString fullPath = QString(_serverConfigs["orgpolicy_organizations_customConstraints_list"][_serverIndices.value("orgpolicy_organizations_customConstraints_list")].URL()+"/v2/{parent}/customConstraints");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIOrganizationsApi::orgpolicy_organizations_customConstraints_listCallback);
    connect(this, &OAIOrganizationsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIOrganizationsApi::orgpolicy_organizations_customConstraints_listCallback);
    connect(this, &OAIOrganizationsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIOrganizationsApi::orgpolicy_organizations_customConstraints_listCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIGoogleCloudOrgpolicyV2ListCustomConstraintsResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT orgpolicy_organizations_customConstraints_listSignal(output);
        Q_EMIT orgpolicy_organizations_customConstraints_listSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("https://www.googleapis.com/auth/cloud-platform");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT orgpolicy_organizations_customConstraints_listSignalE(output, error_type, error_str);
        Q_EMIT orgpolicy_organizations_customConstraints_listSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT orgpolicy_organizations_customConstraints_listSignalError(output, error_type, error_str);
        Q_EMIT orgpolicy_organizations_customConstraints_listSignalErrorFull(worker, error_type, error_str);
    }
}
