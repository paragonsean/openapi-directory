...
class ListTopicsResponse(Model):
    ...
    def __init__(self, next_page_token: str=None, topic: List[Topic]=None):
        ...
        :param topic: The topic of this ListTopicsResponse.
        """
        self.openapi_types = {
            'next_page_token': str,
            'topic': List[Topic]
    ...
    @property
    def topic(self):
        """Gets the topic of this ListTopicsResponse.

        The resulting topics.

        :return: The topic of this ListTopicsResponse.
        :rtype: List[Topic]
        """
        return self._topic
    ...
    def topic(self, topic):
        """Sets the topic of this ListTopicsResponse.
