...
**state** | **String** | Output only. An output-only field indicating the state of the topic. | [optional] [readonly] 
...
* `INGESTION_RESOURCE_ERROR` (value: `"INGESTION_RESOURCE_ERROR"`)
