# CloudPubSubApi.ListTopicSubscriptionsResponse
...
**subscriptions** | **[String]** | Optional. The names of subscriptions attached to the topic specified in the request. | [optional] 
