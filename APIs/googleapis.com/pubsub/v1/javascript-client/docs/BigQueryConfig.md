...
**state** | **String** | Output only. An output-only field that indicates whether or not the subscription can receive messages. | [optional] [readonly] 
...
* `IN_TRANSIT_LOCATION_RESTRICTION` (value: `"IN_TRANSIT_LOCATION_RESTRICTION"`)
