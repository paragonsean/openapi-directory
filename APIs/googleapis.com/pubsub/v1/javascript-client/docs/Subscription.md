...
**state** | **String** | Output only. An output-only field indicating whether or not the subscription can receive messages. | [optional] [readonly] 
...
* `RESOURCE_ERROR` (value: `"RESOURCE_ERROR"`)
