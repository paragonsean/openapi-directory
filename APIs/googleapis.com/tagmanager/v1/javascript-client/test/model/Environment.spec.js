...
(function(root, factory) {
  ...
  describe('Environment', function() {
    ...
    it('should have the property authorizationTimestampMs (base name: "authorizationTimestampMs")', function() {
      // uncomment below and update the code to test the property authorizationTimestampMs
      //var instance = new TagManagerApi.Environment();
      //expect(instance).to.be();
    });
