...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TagManagerApi.ContainerAccess();
  });
  ...
  describe('ContainerAccess', function() {
    it('should create an instance of ContainerAccess', function() {
      // uncomment below and update the code to test ContainerAccess
      //var instance = new TagManagerApi.ContainerAccess();
      //expect(instance).to.be.a(TagManagerApi.ContainerAccess);
    });
