...
public class Trigger {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, autoEventFilter, checkValidation, containerId, continuousTimeMinMilliseconds, customEventFilter, eventName, filter, fingerprint, horizontalScrollPercentageList, interval, intervalSeconds, limit, maxTimerLengthSeconds, name, parameter, parentFolderId, selector, totalTimeMinMilliseconds, triggerId, type, uniqueTriggerId, verticalScrollPercentageList, visibilitySelector, visiblePercentageMax, visiblePercentageMin, waitForTags, waitForTagsTimeout);
  }
