...
public class Environment {
  ...
  public static final String SERIALIZED_NAME_AUTHORIZATION_TIMESTAMP_MS = "authorizationTimestampMs";
  @SerializedName(SERIALIZED_NAME_AUTHORIZATION_TIMESTAMP_MS)
  private String authorizationTimestampMs;
  ...
  public Environment authorizationTimestampMs(String authorizationTimestampMs) {
   ...
   */
  @javax.annotation.Nullable
  public String getAuthorizationTimestampMs() {
    return authorizationTimestampMs;
  }

  public void setAuthorizationTimestampMs(String authorizationTimestampMs) {
    this.authorizationTimestampMs = authorizationTimestampMs;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountId, environment.accountId) &&
        ...
        Objects.equals(this.authorizationTimestampMs, environment.authorizationTimestampMs) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, authorizationCode, authorizationTimestampMs, containerId, containerVersionId, description, enableDebug, environmentId, fingerprint, name, type, url);
  }
  ...
  public String toString() {
    ...
    sb.append("    authorizationTimestampMs: ").append(toIndentedString(authorizationTimestampMs)).append("\n");
  ...
  static {
    ...
    openapiFields.add("authorizationTimestampMs");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("authorizationTimestampMs") != null && !jsonObj.get("authorizationTimestampMs").isJsonNull()) && !jsonObj.get("authorizationTimestampMs").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `authorizationTimestampMs` to be a primitive type in the JSON string but got `%s`", jsonObj.get("authorizationTimestampMs").toString()));
      }
