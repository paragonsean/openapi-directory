...
public class Variable {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, containerId, disablingTriggerId, enablingTriggerId, fingerprint, name, notes, parameter, parentFolderId, scheduleEndMs, scheduleStartMs, type, variableId);
  }
