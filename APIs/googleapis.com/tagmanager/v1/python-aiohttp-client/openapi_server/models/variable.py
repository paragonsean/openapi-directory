...
class Variable(Model):
    ...
    def __init__(self, account_id: str=None, container_id: str=None, disabling_trigger_id: List[str]=None, enabling_trigger_id: List[str]=None, fingerprint: str=None, name: str=None, notes: str=None, parameter: List[Parameter]=None, parent_folder_id: str=None, schedule_end_ms: str=None, schedule_start_ms: str=None, type: str=None, variable_id: str=None):
