...
class Trigger(Model):
    ...
    def __init__(self, account_id: str=None, auto_event_filter: List[Condition]=None, check_validation: Parameter=None, container_id: str=None, continuous_time_min_milliseconds: Parameter=None, custom_event_filter: List[Condition]=None, event_name: Parameter=None, filter: List[Condition]=None, fingerprint: str=None, horizontal_scroll_percentage_list: Parameter=None, interval: Parameter=None, interval_seconds: Parameter=None, limit: Parameter=None, max_timer_length_seconds: Parameter=None, name: str=None, parameter: List[Parameter]=None, parent_folder_id: str=None, selector: Parameter=None, total_time_min_milliseconds: Parameter=None, trigger_id: str=None, type: str=None, unique_trigger_id: Parameter=None, vertical_scroll_percentage_list: Parameter=None, visibility_selector: Parameter=None, visible_percentage_max: Parameter=None, visible_percentage_min: Parameter=None, wait_for_tags: Parameter=None, wait_for_tags_timeout: Parameter=None):
    ...
    def type(self, type):
        ...
        :type type: str
        """
        allowed_values = ["pageview", "domReady", "windowLoaded", "customEvent", "triggerGroup", "always", "formSubmission", "click", "linkClick", "jsError", "historyChange", "timer", "ampClick", "ampTimer", "ampScroll", "ampVisibility", "youTubeVideo", "scrollDepth", "elementVisibility"]  # noqa: E501
