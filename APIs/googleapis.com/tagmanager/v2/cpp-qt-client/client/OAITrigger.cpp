...
QString OAITrigger::getNotes() const {
    return m_notes;
}
void OAITrigger::setNotes(const QString &notes) {
    m_notes = notes;
    m_notes_isSet = true;
}

bool OAITrigger::is_notes_Set() const{
    return m_notes_isSet;
}

bool OAITrigger::is_notes_Valid() const{
...
QString OAITrigger::getPath() const {
    return m_path;
}
void OAITrigger::setPath(const QString &path) {
    m_path = path;
    m_path_isSet = true;
}

bool OAITrigger::is_path_Set() const{
    return m_path_isSet;
}

bool OAITrigger::is_path_Valid() const{
...
QString OAITrigger::getTagManagerUrl() const {
    return m_tag_manager_url;
}
void OAITrigger::setTagManagerUrl(const QString &tag_manager_url) {
    m_tag_manager_url = tag_manager_url;
    m_tag_manager_url_isSet = true;
}

bool OAITrigger::is_tag_manager_url_Set() const{
    return m_tag_manager_url_isSet;
}

bool OAITrigger::is_tag_manager_url_Valid() const{
...
QString OAITrigger::getWorkspaceId() const {
    return m_workspace_id;
}
void OAITrigger::setWorkspaceId(const QString &workspace_id) {
    m_workspace_id = workspace_id;
    m_workspace_id_isSet = true;
}

bool OAITrigger::is_workspace_id_Set() const{
    return m_workspace_id_isSet;
}

bool OAITrigger::is_workspace_id_Valid() const{
