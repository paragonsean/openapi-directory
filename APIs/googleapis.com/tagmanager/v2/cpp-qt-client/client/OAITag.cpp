...
void OAITag::initializeModel() {
    ...
    m_consent_settings_isSet = false;
    m_consent_settings_isValid = false;
    ...
    m_monitoring_metadata_isSet = false;
    m_monitoring_metadata_isValid = false;

    m_monitoring_metadata_tag_name_key_isSet = false;
    m_monitoring_metadata_tag_name_key_isValid = false;
...
void OAITag::fromJsonObject(QJsonObject json) {
    ...
    m_consent_settings_isValid = ::OpenAPI::fromJsonValue(m_consent_settings, json[QString("consentSettings")]);
    m_consent_settings_isSet = !json[QString("consentSettings")].isNull() && m_consent_settings_isValid;
    ...
    m_monitoring_metadata_isValid = ::OpenAPI::fromJsonValue(m_monitoring_metadata, json[QString("monitoringMetadata")]);
    m_monitoring_metadata_isSet = !json[QString("monitoringMetadata")].isNull() && m_monitoring_metadata_isValid;

    m_monitoring_metadata_tag_name_key_isValid = ::OpenAPI::fromJsonValue(m_monitoring_metadata_tag_name_key, json[QString("monitoringMetadataTagNameKey")]);
    m_monitoring_metadata_tag_name_key_isSet = !json[QString("monitoringMetadataTagNameKey")].isNull() && m_monitoring_metadata_tag_name_key_isValid;
...
QJsonObject OAITag::asJsonObject() const {
    ...
    if (m_consent_settings.isSet()) {
        obj.insert(QString("consentSettings"), ::OpenAPI::toJsonValue(m_consent_settings));
    }
    ...
    if (m_monitoring_metadata.isSet()) {
        obj.insert(QString("monitoringMetadata"), ::OpenAPI::toJsonValue(m_monitoring_metadata));
    }
    if (m_monitoring_metadata_tag_name_key_isSet) {
        obj.insert(QString("monitoringMetadataTagNameKey"), ::OpenAPI::toJsonValue(m_monitoring_metadata_tag_name_key));
    }
    if (m_name_isSet) {
...
OAITagConsentSetting OAITag::getConsentSettings() const {
    return m_consent_settings;
}
void OAITag::setConsentSettings(const OAITagConsentSetting &consent_settings) {
    m_consent_settings = consent_settings;
    m_consent_settings_isSet = true;
}

bool OAITag::is_consent_settings_Set() const{
    return m_consent_settings_isSet;
}

bool OAITag::is_consent_settings_Valid() const{
    return m_consent_settings_isValid;
}
...
OAIParameter OAITag::getMonitoringMetadata() const {
    return m_monitoring_metadata;
}
void OAITag::setMonitoringMetadata(const OAIParameter &monitoring_metadata) {
    m_monitoring_metadata = monitoring_metadata;
    m_monitoring_metadata_isSet = true;
}

bool OAITag::is_monitoring_metadata_Set() const{
    return m_monitoring_metadata_isSet;
}

bool OAITag::is_monitoring_metadata_Valid() const{
    return m_monitoring_metadata_isValid;
}

QString OAITag::getMonitoringMetadataTagNameKey() const {
    return m_monitoring_metadata_tag_name_key;
}
void OAITag::setMonitoringMetadataTagNameKey(const QString &monitoring_metadata_tag_name_key) {
    m_monitoring_metadata_tag_name_key = monitoring_metadata_tag_name_key;
    m_monitoring_metadata_tag_name_key_isSet = true;
}

bool OAITag::is_monitoring_metadata_tag_name_key_Set() const{
    return m_monitoring_metadata_tag_name_key_isSet;
}

bool OAITag::is_monitoring_metadata_tag_name_key_Valid() const{
    return m_monitoring_metadata_tag_name_key_isValid;
}
...
QString OAITag::getPath() const {
    return m_path;
}
void OAITag::setPath(const QString &path) {
    m_path = path;
    m_path_isSet = true;
}

bool OAITag::is_path_Set() const{
    return m_path_isSet;
}

bool OAITag::is_path_Valid() const{
...
QString OAITag::getTagManagerUrl() const {
    return m_tag_manager_url;
}
void OAITag::setTagManagerUrl(const QString &tag_manager_url) {
    m_tag_manager_url = tag_manager_url;
    m_tag_manager_url_isSet = true;
}

bool OAITag::is_tag_manager_url_Set() const{
    return m_tag_manager_url_isSet;
}

bool OAITag::is_tag_manager_url_Valid() const{
...
QString OAITag::getWorkspaceId() const {
    return m_workspace_id;
}
void OAITag::setWorkspaceId(const QString &workspace_id) {
    m_workspace_id = workspace_id;
    m_workspace_id_isSet = true;
}

bool OAITag::is_workspace_id_Set() const{
    return m_workspace_id_isSet;
}

bool OAITag::is_workspace_id_Valid() const{
