...
public:
    ...
    QString getDestinationLinkId() const;
    void setDestinationLinkId(const QString &destination_link_id);
    bool is_destination_link_id_Set() const;
    bool is_destination_link_id_Valid() const;
...
private:
    ...
    QString m_destination_link_id;
    bool m_destination_link_id_isSet;
    bool m_destination_link_id_isValid;
