...
class Parameter {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('isWeakReference')) {
                obj['isWeakReference'] = ApiClient.convertToType(data['isWeakReference'], 'Boolean');
            }
 ...
 * @member {Boolean} isWeakReference
 */
Parameter.prototype['isWeakReference'] = undefined;
