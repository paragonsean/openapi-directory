...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TagManagerApi.BuiltInVariable();
  });
  ...
  describe('BuiltInVariable', function() {
    it('should create an instance of BuiltInVariable', function() {
      // uncomment below and update the code to test BuiltInVariable
      //var instance = new TagManagerApi.BuiltInVariable();
      //expect(instance).to.be.a(TagManagerApi.BuiltInVariable);
    });
