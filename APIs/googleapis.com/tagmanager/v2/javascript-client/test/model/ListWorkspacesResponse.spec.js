...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TagManagerApi.ListWorkspacesResponse();
  });
  ...
  describe('ListWorkspacesResponse', function() {
    it('should create an instance of ListWorkspacesResponse', function() {
      ...
      //var instance = new TagManagerApi.ListWorkspacesResponse();
      //expect(instance).to.be.a(TagManagerApi.ListWorkspacesResponse);
    });
