...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TagManagerApi.ListClientsResponse();
  });
  ...
  describe('ListClientsResponse', function() {
    it('should create an instance of ListClientsResponse', function() {
      ...
      //var instance = new TagManagerApi.ListClientsResponse();
      //expect(instance).to.be.a(TagManagerApi.ListClientsResponse);
    });
