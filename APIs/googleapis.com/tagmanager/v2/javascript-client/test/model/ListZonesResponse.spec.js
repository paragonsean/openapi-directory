...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TagManagerApi.ListZonesResponse();
  });
  ...
  describe('ListZonesResponse', function() {
    it('should create an instance of ListZonesResponse', function() {
      // uncomment below and update the code to test ListZonesResponse
      //var instance = new TagManagerApi.ListZonesResponse();
      //expect(instance).to.be.a(TagManagerApi.ListZonesResponse);
    });
