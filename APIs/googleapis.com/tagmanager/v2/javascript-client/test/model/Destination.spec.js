...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TagManagerApi.Destination();
  });
  ...
  describe('Destination', function() {
    it('should create an instance of Destination', function() {
      ...
      //var instance = new TagManagerApi.Destination();
      //expect(instance).to.be.a(TagManagerApi.Destination);
    });
    ...
    it('should have the property destinationLinkId (base name: "destinationLinkId")', function() {
      // uncomment below and update the code to test the property destinationLinkId
      //var instance = new TagManagerApi.Destination();
      //expect(instance).to.be();
    });
