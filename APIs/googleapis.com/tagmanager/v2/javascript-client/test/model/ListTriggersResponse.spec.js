...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TagManagerApi.ListTriggersResponse();
  });
  ...
  describe('ListTriggersResponse', function() {
    it('should create an instance of ListTriggersResponse', function() {
      // uncomment below and update the code to test ListTriggersResponse
      //var instance = new TagManagerApi.ListTriggersResponse();
      //expect(instance).to.be.a(TagManagerApi.ListTriggersResponse);
    });
