...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TagManagerApi.Account();
  });
  ...
  describe('Account', function() {
    it('should create an instance of Account', function() {
      ...
      //var instance = new TagManagerApi.Account();
      //expect(instance).to.be.a(TagManagerApi.Account);
    });
    ...
    it('should have the property shareData (base name: "shareData")', function() {
      // uncomment below and update the code to test the property shareData
      //var instance = new TagManagerApi.Account();
      //expect(instance).to.be();
    });
