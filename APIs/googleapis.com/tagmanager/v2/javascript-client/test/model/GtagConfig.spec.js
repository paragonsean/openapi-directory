...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TagManagerApi.GtagConfig();
  });
  ...
  describe('GtagConfig', function() {
    it('should create an instance of GtagConfig', function() {
      // uncomment below and update the code to test GtagConfig
      //var instance = new TagManagerApi.GtagConfig();
      //expect(instance).to.be.a(TagManagerApi.GtagConfig);
    });
    ...
    it('should have the property gtagConfigId (base name: "gtagConfigId")', function() {
      // uncomment below and update the code to test the property gtagConfigId
      //var instance = new TagManagerApi.GtagConfig();
      //expect(instance).to.be();
    });
