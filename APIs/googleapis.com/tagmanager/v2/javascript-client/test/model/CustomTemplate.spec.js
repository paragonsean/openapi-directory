...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TagManagerApi.CustomTemplate();
  });
  ...
  describe('CustomTemplate', function() {
    it('should create an instance of CustomTemplate', function() {
      // uncomment below and update the code to test CustomTemplate
      //var instance = new TagManagerApi.CustomTemplate();
      //expect(instance).to.be.a(TagManagerApi.CustomTemplate);
    });
    ...
    it('should have the property galleryReference (base name: "galleryReference")', function() {
      // uncomment below and update the code to test the property galleryReference
      //var instance = new TagManagerApi.CustomTemplate();
      //expect(instance).to.be();
    });
