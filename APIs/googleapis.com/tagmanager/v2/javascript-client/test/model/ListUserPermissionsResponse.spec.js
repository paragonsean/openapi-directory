...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TagManagerApi.ListUserPermissionsResponse();
  });
  ...
  describe('ListUserPermissionsResponse', function() {
    it('should create an instance of ListUserPermissionsResponse', function() {
      // uncomment below and update the code to test ListUserPermissionsResponse
      //var instance = new TagManagerApi.ListUserPermissionsResponse();
      //expect(instance).to.be.a(TagManagerApi.ListUserPermissionsResponse);
    });
