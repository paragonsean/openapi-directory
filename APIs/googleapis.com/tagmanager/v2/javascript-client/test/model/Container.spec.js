...
(function(root, factory) {
  ...
  describe('Container', function() {
    ...
    it('should have the property taggingServerUrls (base name: "taggingServerUrls")', function() {
      // uncomment below and update the code to test the property taggingServerUrls
      //var instance = new TagManagerApi.Container();
      //expect(instance).to.be();
    });
