...
class Parameter(Model):
    ...
    def __init__(self, is_weak_reference: bool=None, key: str=None, list: List[Parameter]=None, map: List[Parameter]=None, type: str=None, value: str=None):
        """Parameter - a model defined in OpenAPI

        :param is_weak_reference: The is_weak_reference of this Parameter.
        ...
        self.attribute_map = {
            'is_weak_reference': 'isWeakReference',
            'key': 'key',
            'list': 'list',
            'map': 'map',
            'type': 'type',
        ...
        self._is_weak_reference = is_weak_reference
        self._key = key
        self._list = list
        self._map = map
        self._type = type
    ...
    @property
    def is_weak_reference(self):
        """Gets the is_weak_reference of this Parameter.
        ...
        :return: The is_weak_reference of this Parameter.
        :rtype: bool
        """
        return self._is_weak_reference

    @is_weak_reference.setter
    def is_weak_reference(self, is_weak_reference):
        """Sets the is_weak_reference of this Parameter.

        Whether or not a reference type parameter is strongly or weakly referenced. Only used by Transformations. @mutable tagmanager.accounts.containers.workspaces.transformations.create @mutable tagmanager.accounts.containers.workspaces.transformations.update

        :param is_weak_reference: The is_weak_reference of this Parameter.
        :type is_weak_reference: bool
        """
    ...
    def type(self, type):
        ...
        :type type: str
        """
        allowed_values = ["typeUnspecified", "template", "integer", "boolean", "list", "map", "triggerReference", "tagReference"]  # noqa: E501
