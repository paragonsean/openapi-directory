...
class Tag(Model):
    ...
    def __init__(self, account_id: str=None, blocking_rule_id: List[str]=None, blocking_trigger_id: List[str]=None, consent_settings: TagConsentSetting=None, container_id: str=None, fingerprint: str=None, firing_rule_id: List[str]=None, firing_trigger_id: List[str]=None, live_only: bool=None, monitoring_metadata: Parameter=None, monitoring_metadata_tag_name_key: str=None, name: str=None, notes: str=None, parameter: List[Parameter]=None, parent_folder_id: str=None, path: str=None, paused: bool=None, priority: Parameter=None, schedule_end_ms: str=None, schedule_start_ms: str=None, setup_tag: List[SetupTag]=None, tag_firing_option: str=None, tag_id: str=None, tag_manager_url: str=None, teardown_tag: List[TeardownTag]=None, type: str=None, workspace_id: str=None):
        ...
        :param consent_settings: The consent_settings of this Tag.
        ...
        :param monitoring_metadata: The monitoring_metadata of this Tag.
        :param monitoring_metadata_tag_name_key: The monitoring_metadata_tag_name_key of this Tag.
        ...
        :param tag_manager_url: The tag_manager_url of this Tag.
        :param teardown_tag: The teardown_tag of this Tag.
        :param type: The type of this Tag.
        :param workspace_id: The workspace_id of this Tag.
        """
        self.openapi_types = {
            'account_id': str,
            'blocking_rule_id': List[str],
            'blocking_trigger_id': List[str],
            'consent_settings': TagConsentSetting,
            'container_id': str,
            'fingerprint': str,
            'firing_rule_id': List[str],
            'firing_trigger_id': List[str],
            'live_only': bool,
            'monitoring_metadata': Parameter,
            'monitoring_metadata_tag_name_key': str,
            'name': str,
            'notes': str,
        ...
        self.attribute_map = {
            ...
            'monitoring_metadata_tag_name_key': 'monitoringMetadataTagNameKey',
            'name': 'name',
            'notes': 'notes',
            'parameter': 'parameter',
        ...
        self._consent_settings = consent_settings
        self._container_id = container_id
        self._fingerprint = fingerprint
        self._firing_rule_id = firing_rule_id
        self._firing_trigger_id = firing_trigger_id
        self._live_only = live_only
        self._monitoring_metadata = monitoring_metadata
        self._monitoring_metadata_tag_name_key = monitoring_metadata_tag_name_key
        self._name = name
        self._notes = notes
    ...
    @property
    def consent_settings(self):
        """Gets the consent_settings of this Tag.


        :return: The consent_settings of this Tag.
        :rtype: TagConsentSetting
        """
        return self._consent_settings

    @consent_settings.setter
    def consent_settings(self, consent_settings):
        """Sets the consent_settings of this Tag.


        :param consent_settings: The consent_settings of this Tag.
        :type consent_settings: TagConsentSetting
        """
    ...
    @property
    def monitoring_metadata(self):
        """Gets the monitoring_metadata of this Tag.


        :return: The monitoring_metadata of this Tag.
        :rtype: Parameter
        """
        return self._monitoring_metadata

    @monitoring_metadata.setter
    def monitoring_metadata(self, monitoring_metadata):
        """Sets the monitoring_metadata of this Tag.


        :param monitoring_metadata: The monitoring_metadata of this Tag.
        :type monitoring_metadata: Parameter
        """

        self._monitoring_metadata = monitoring_metadata

    @property
    def monitoring_metadata_tag_name_key(self):
        """Gets the monitoring_metadata_tag_name_key of this Tag.
        ...
        :return: The monitoring_metadata_tag_name_key of this Tag.
        :rtype: str
        """
        return self._monitoring_metadata_tag_name_key

    @monitoring_metadata_tag_name_key.setter
    def monitoring_metadata_tag_name_key(self, monitoring_metadata_tag_name_key):
        """Sets the monitoring_metadata_tag_name_key of this Tag.

        If non-empty, then the tag display name will be included in the monitoring metadata map using the key specified. @mutable tagmanager.accounts.containers.workspaces.tags.create @mutable tagmanager.accounts.containers.workspaces.tags.update

        :param monitoring_metadata_tag_name_key: The monitoring_metadata_tag_name_key of this Tag.
        :type monitoring_metadata_tag_name_key: str
        """
    ...
    def tag_firing_option(self, tag_firing_option):
        ...
        """
        allowed_values = ["tagFiringOptionUnspecified", "unlimited", "oncePerEvent", "oncePerLoad"]  # noqa: E501
    ...
    def tag_manager_url(self):
        """Gets the tag_manager_url of this Tag.

        Auto generated link to the tag manager UI

        :return: The tag_manager_url of this Tag.
        :rtype: str
        """
    ...
    def tag_manager_url(self, tag_manager_url):
        """Sets the tag_manager_url of this Tag.
    ...
    def workspace_id(self):
        """Gets the workspace_id of this Tag.

        GTM Workspace ID.

        :return: The workspace_id of this Tag.
        :rtype: str
        """
    ...
    def workspace_id(self, workspace_id):
        """Sets the workspace_id of this Tag.
