...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://gamesconfiguration.googleapis.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://gamesconfiguration.googleapis.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/v1configuration/Javascript'
        };
