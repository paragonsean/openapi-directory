...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GooglePlayGameServicesPublishingApi.LeaderboardConfiguration();
  });
  ...
  describe('LeaderboardConfiguration', function() {
    it('should create an instance of LeaderboardConfiguration', function() {
      // uncomment below and update the code to test LeaderboardConfiguration
      //var instance = new GooglePlayGameServicesPublishingApi.LeaderboardConfiguration();
      //expect(instance).to.be.a(GooglePlayGameServicesPublishingApi.LeaderboardConfiguration);
    });
    ...
    it('should have the property scoreOrder (base name: "scoreOrder")', function() {
      // uncomment below and update the code to test the property scoreOrder
      //var instance = new GooglePlayGameServicesPublishingApi.LeaderboardConfiguration();
      //expect(instance).to.be();
    });
