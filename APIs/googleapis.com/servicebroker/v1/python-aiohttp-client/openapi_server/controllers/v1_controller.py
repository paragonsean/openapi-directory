...
async def servicebroker_get_iam_policy(request: web.Request, resource, xgafv=None, oauth_token=None, param_callback=None, alt=None, key=None, access_token=None, upload_protocol=None, pretty_print=None, quota_user=None, fields=None, upload_type=None, options_requested_policy_version=None) -> web.Response:
...
async def servicebroker_set_iam_policy(request: web.Request, resource, xgafv=None, oauth_token=None, param_callback=None, alt=None, key=None, access_token=None, upload_protocol=None, pretty_print=None, quota_user=None, fields=None, upload_type=None, body=None) -> web.Response:
...
async def servicebroker_test_iam_permissions(request: web.Request, resource, xgafv=None, oauth_token=None, param_callback=None, alt=None, key=None, access_token=None, upload_protocol=None, pretty_print=None, quota_user=None, fields=None, upload_type=None, body=None) -> web.Response:
