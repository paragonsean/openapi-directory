...
void OAIV1Api::servicebroker_getIamPolicy(const QString &resource, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<qint32> &options_requested_policy_version) {
    QString fullPath = QString(_serverConfigs["servicebroker_getIamPolicy"][_serverIndices.value("servicebroker_getIamPolicy")].URL()+"/v1/{resource}:getIamPolicy");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIV1Api::servicebroker_getIamPolicyCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIV1Api::servicebroker_getIamPolicyCallback);
...
void OAIV1Api::servicebroker_getIamPolicyCallback(OAIHttpRequestWorker *worker) {
...
void OAIV1Api::servicebroker_setIamPolicy(const QString &resource, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<OAIGoogleIamV1__SetIamPolicyRequest> &oai_google_iam_v1__set_iam_policy_request) {
    QString fullPath = QString(_serverConfigs["servicebroker_setIamPolicy"][_serverIndices.value("servicebroker_setIamPolicy")].URL()+"/v1/{resource}:setIamPolicy");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIV1Api::servicebroker_setIamPolicyCallback);
    connect(this, &OAIV1Api::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIV1Api::servicebroker_setIamPolicyCallback);
    connect(this, &OAIV1Api::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIV1Api::servicebroker_setIamPolicyCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void OAIV1Api::servicebroker_testIamPermissions(const QString &resource, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<OAIGoogleIamV1__TestIamPermissionsRequest> &oai_google_iam_v1__test_iam_permissions_request) {
    QString fullPath = QString(_serverConfigs["servicebroker_testIamPermissions"][_serverIndices.value("servicebroker_testIamPermissions")].URL()+"/v1/{resource}:testIamPermissions");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIV1Api::servicebroker_testIamPermissionsCallback);
    connect(this, &OAIV1Api::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIV1Api::servicebroker_testIamPermissionsCallback);
    connect(this, &OAIV1Api::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIV1Api::servicebroker_testIamPermissionsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
