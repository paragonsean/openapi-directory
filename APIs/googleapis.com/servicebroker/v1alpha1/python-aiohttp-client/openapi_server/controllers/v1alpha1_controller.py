...
async def servicebroker_get_iam_policy(request: web.Request, resource, upload_protocol=None, quota_user=None, pretty_print=None, upload_type=None, fields=None, param_callback=None, oauth_token=None, xgafv=None, alt=None, key=None, access_token=None, options_requested_policy_version=None) -> web.Response:
...
async def servicebroker_set_iam_policy(request: web.Request, resource, upload_protocol=None, quota_user=None, pretty_print=None, upload_type=None, fields=None, param_callback=None, oauth_token=None, xgafv=None, alt=None, key=None, access_token=None, body=None) -> web.Response:
...
async def servicebroker_test_iam_permissions(request: web.Request, resource, upload_protocol=None, quota_user=None, pretty_print=None, upload_type=None, fields=None, param_callback=None, oauth_token=None, xgafv=None, alt=None, key=None, access_token=None, body=None) -> web.Response:
