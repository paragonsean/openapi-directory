...
|**instances** | [**List&lt;GoogleCloudServicebrokerV1alpha1ServiceInstance&gt;**](GoogleCloudServicebrokerV1alpha1ServiceInstance.md) | The list of the instances in the broker. |  [optional] |
