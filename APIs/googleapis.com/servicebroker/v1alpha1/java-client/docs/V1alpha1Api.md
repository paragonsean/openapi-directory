...
> GoogleIamV1Policy servicebrokerGetIamPolicy(resource, uploadProtocol, quotaUser, prettyPrint, uploadType, fields, paramCallback, oauthToken, $xgafv, alt, key, accessToken, optionsRequestedPolicyVersion)
...
import org.openapitools.client.api.V1alpha1Api;
...
public class Example {
  public static void main(String[] args) {
    ...
    V1alpha1Api apiInstance = new V1alpha1Api(defaultClient);
    ...
    try {
      GoogleIamV1Policy result = apiInstance.servicebrokerGetIamPolicy(resource, uploadProtocol, quotaUser, prettyPrint, uploadType, fields, paramCallback, oauthToken, $xgafv, alt, key, accessToken, optionsRequestedPolicyVersion);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling V1alpha1Api#servicebrokerGetIamPolicy");
...
> GoogleIamV1Policy servicebrokerSetIamPolicy(resource, uploadProtocol, quotaUser, prettyPrint, uploadType, fields, paramCallback, oauthToken, $xgafv, alt, key, accessToken, googleIamV1SetIamPolicyRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      GoogleIamV1Policy result = apiInstance.servicebrokerSetIamPolicy(resource, uploadProtocol, quotaUser, prettyPrint, uploadType, fields, paramCallback, oauthToken, $xgafv, alt, key, accessToken, googleIamV1SetIamPolicyRequest);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling V1alpha1Api#servicebrokerSetIamPolicy");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
> GoogleIamV1TestIamPermissionsResponse servicebrokerTestIamPermissions(resource, uploadProtocol, quotaUser, prettyPrint, uploadType, fields, paramCallback, oauthToken, $xgafv, alt, key, accessToken, googleIamV1TestIamPermissionsRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      GoogleIamV1TestIamPermissionsResponse result = apiInstance.servicebrokerTestIamPermissions(resource, uploadProtocol, quotaUser, prettyPrint, uploadType, fields, paramCallback, oauthToken, $xgafv, alt, key, accessToken, googleIamV1TestIamPermissionsRequest);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling V1alpha1Api#servicebrokerTestIamPermissions");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
