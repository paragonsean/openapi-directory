...
/**
 * API tests for V1alpha1Api
 */
@Disabled
public class V1alpha1ApiTest {

    private final V1alpha1Api api = new V1alpha1Api();
    ...
    public void servicebrokerGetIamPolicyTest() throws ApiException {
        ...
        GoogleIamV1Policy response = api.servicebrokerGetIamPolicy(resource, uploadProtocol, quotaUser, prettyPrint, uploadType, fields, paramCallback, oauthToken, $xgafv, alt, key, accessToken, optionsRequestedPolicyVersion);
    ...
    public void servicebrokerSetIamPolicyTest() throws ApiException {
        ...
        GoogleIamV1Policy response = api.servicebrokerSetIamPolicy(resource, uploadProtocol, quotaUser, prettyPrint, uploadType, fields, paramCallback, oauthToken, $xgafv, alt, key, accessToken, googleIamV1SetIamPolicyRequest);
        // TODO: test validations
    }
    ...
    public void servicebrokerTestIamPermissionsTest() throws ApiException {
        ...
        GoogleIamV1TestIamPermissionsResponse response = api.servicebrokerTestIamPermissions(resource, uploadProtocol, quotaUser, prettyPrint, uploadType, fields, paramCallback, oauthToken, $xgafv, alt, key, accessToken, googleIamV1TestIamPermissionsRequest);
        // TODO: test validations
    }
