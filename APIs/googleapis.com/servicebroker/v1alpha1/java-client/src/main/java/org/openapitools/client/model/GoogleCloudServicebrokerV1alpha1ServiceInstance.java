...
public class GoogleCloudServicebrokerV1alpha1ServiceInstance {
  ...
  public GoogleCloudServicebrokerV1alpha1ServiceInstance() {
  }

  public GoogleCloudServicebrokerV1alpha1ServiceInstance context(Map<String, Object> context) {
    this.context = context;
    return this;
  }

  public GoogleCloudServicebrokerV1alpha1ServiceInstance putContextItem(String key, Object contextItem) {
  ...
  public GoogleCloudServicebrokerV1alpha1ServiceInstance createTime(String createTime) {
  ...
  public GoogleCloudServicebrokerV1alpha1ServiceInstance deploymentName(String deploymentName) {
  ...
  public GoogleCloudServicebrokerV1alpha1ServiceInstance instanceId(String instanceId) {
  ...
  public GoogleCloudServicebrokerV1alpha1ServiceInstance organizationGuid(String organizationGuid) {
  ...
  public GoogleCloudServicebrokerV1alpha1ServiceInstance parameters(Map<String, Object> parameters) {
    this.parameters = parameters;
    return this;
  }

  public GoogleCloudServicebrokerV1alpha1ServiceInstance putParametersItem(String key, Object parametersItem) {
  ...
  public GoogleCloudServicebrokerV1alpha1ServiceInstance planId(String planId) {
    this.planId = planId;
    return this;
  }
  ...
  public GoogleCloudServicebrokerV1alpha1ServiceInstance previousValues(Map<String, Object> previousValues) {
    this.previousValues = previousValues;
    return this;
  }

  public GoogleCloudServicebrokerV1alpha1ServiceInstance putPreviousValuesItem(String key, Object previousValuesItem) {
  ...
  public GoogleCloudServicebrokerV1alpha1ServiceInstance resourceName(String resourceName) {
  ...
  public GoogleCloudServicebrokerV1alpha1ServiceInstance serviceId(String serviceId) {
  ...
  public GoogleCloudServicebrokerV1alpha1ServiceInstance spaceGuid(String spaceGuid) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudServicebrokerV1alpha1ServiceInstance googleCloudServicebrokerV1alpha1ServiceInstance = (GoogleCloudServicebrokerV1alpha1ServiceInstance) o;
    return Objects.equals(this.context, googleCloudServicebrokerV1alpha1ServiceInstance.context) &&
        Objects.equals(this.createTime, googleCloudServicebrokerV1alpha1ServiceInstance.createTime) &&
        Objects.equals(this.deploymentName, googleCloudServicebrokerV1alpha1ServiceInstance.deploymentName) &&
        Objects.equals(this.instanceId, googleCloudServicebrokerV1alpha1ServiceInstance.instanceId) &&
        Objects.equals(this.organizationGuid, googleCloudServicebrokerV1alpha1ServiceInstance.organizationGuid) &&
        Objects.equals(this.parameters, googleCloudServicebrokerV1alpha1ServiceInstance.parameters) &&
        Objects.equals(this.planId, googleCloudServicebrokerV1alpha1ServiceInstance.planId) &&
        Objects.equals(this.previousValues, googleCloudServicebrokerV1alpha1ServiceInstance.previousValues) &&
        Objects.equals(this.resourceName, googleCloudServicebrokerV1alpha1ServiceInstance.resourceName) &&
        Objects.equals(this.serviceId, googleCloudServicebrokerV1alpha1ServiceInstance.serviceId) &&
        Objects.equals(this.spaceGuid, googleCloudServicebrokerV1alpha1ServiceInstance.spaceGuid);
  }

  @Override
  public int hashCode() {
    return Objects.hash(context, createTime, deploymentName, instanceId, organizationGuid, parameters, planId, previousValues, resourceName, serviceId, spaceGuid);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GoogleCloudServicebrokerV1alpha1ServiceInstance {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudServicebrokerV1alpha1ServiceInstance
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudServicebrokerV1alpha1ServiceInstance.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudServicebrokerV1alpha1ServiceInstance is not found in the empty JSON string", GoogleCloudServicebrokerV1alpha1ServiceInstance.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudServicebrokerV1alpha1ServiceInstance.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudServicebrokerV1alpha1ServiceInstance` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudServicebrokerV1alpha1ServiceInstance.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudServicebrokerV1alpha1ServiceInstance' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudServicebrokerV1alpha1ServiceInstance> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudServicebrokerV1alpha1ServiceInstance.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudServicebrokerV1alpha1ServiceInstance>() {
           @Override
           public void write(JsonWriter out, GoogleCloudServicebrokerV1alpha1ServiceInstance value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudServicebrokerV1alpha1ServiceInstance read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudServicebrokerV1alpha1ServiceInstance given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudServicebrokerV1alpha1ServiceInstance
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudServicebrokerV1alpha1ServiceInstance
   */
  public static GoogleCloudServicebrokerV1alpha1ServiceInstance fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudServicebrokerV1alpha1ServiceInstance.class);
  }

  /**
   * Convert an instance of GoogleCloudServicebrokerV1alpha1ServiceInstance to an JSON string
   *
   * @return JSON string
   */
