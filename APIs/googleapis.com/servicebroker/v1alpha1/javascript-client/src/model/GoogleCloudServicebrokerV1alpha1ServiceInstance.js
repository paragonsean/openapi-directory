...
/**
 * The GoogleCloudServicebrokerV1alpha1ServiceInstance model module.
 * @module model/GoogleCloudServicebrokerV1alpha1ServiceInstance
 * @version v1alpha1
 */
class GoogleCloudServicebrokerV1alpha1ServiceInstance {
    /**
     * Constructs a new <code>GoogleCloudServicebrokerV1alpha1ServiceInstance</code>.
     * Message describing inputs to Provision and Update Service instance requests.
     * @alias module:model/GoogleCloudServicebrokerV1alpha1ServiceInstance
     */
    constructor() { 
        
        GoogleCloudServicebrokerV1alpha1ServiceInstance.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudServicebrokerV1alpha1ServiceInstance</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudServicebrokerV1alpha1ServiceInstance} obj Optional instance to populate.
     * @return {module:model/GoogleCloudServicebrokerV1alpha1ServiceInstance} The populated <code>GoogleCloudServicebrokerV1alpha1ServiceInstance</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudServicebrokerV1alpha1ServiceInstance();
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudServicebrokerV1alpha1ServiceInstance</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudServicebrokerV1alpha1ServiceInstance</code>.
     */
 ...
 */
GoogleCloudServicebrokerV1alpha1ServiceInstance.prototype['context'] = undefined;

/**
 * Output only. Timestamp for when the instance was created.
 * @member {String} createTime
 */
GoogleCloudServicebrokerV1alpha1ServiceInstance.prototype['createTime'] = undefined;
 ...
 */
GoogleCloudServicebrokerV1alpha1ServiceInstance.prototype['deploymentName'] = undefined;
 ...
 */
GoogleCloudServicebrokerV1alpha1ServiceInstance.prototype['instance_id'] = undefined;
 ...
 */
GoogleCloudServicebrokerV1alpha1ServiceInstance.prototype['organization_guid'] = undefined;
 ...
 */
GoogleCloudServicebrokerV1alpha1ServiceInstance.prototype['parameters'] = undefined;
 ...
 */
GoogleCloudServicebrokerV1alpha1ServiceInstance.prototype['plan_id'] = undefined;
 ...
 */
GoogleCloudServicebrokerV1alpha1ServiceInstance.prototype['previous_values'] = undefined;
 ...
 */
GoogleCloudServicebrokerV1alpha1ServiceInstance.prototype['resourceName'] = undefined;
 ...
 */
GoogleCloudServicebrokerV1alpha1ServiceInstance.prototype['service_id'] = undefined;

/**
 * The identifier for the project space within the platform organization. Required.
 * @member {String} space_guid
 */
GoogleCloudServicebrokerV1alpha1ServiceInstance.prototype['space_guid'] = undefined;
...
export default GoogleCloudServicebrokerV1alpha1ServiceInstance;
