# ServiceBroker.GoogleCloudServicebrokerV1alpha1Binding

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**bindResource** | **{String: Object}** | A JSON object that contains data for platform resources associated with the binding to be created. | [optional] 
...
**parameters** | **{String: Object}** | Configuration options for the service binding. | [optional] 
