# ServiceBroker.V1alpha1Api

All URIs are relative to *https://servicebroker.googleapis.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**servicebrokerGetIamPolicy**](V1alpha1Api.md#servicebrokerGetIamPolicy) | **GET** /v1alpha1/{resource}:getIamPolicy | 
[**servicebrokerSetIamPolicy**](V1alpha1Api.md#servicebrokerSetIamPolicy) | **POST** /v1alpha1/{resource}:setIamPolicy | 
[**servicebrokerTestIamPermissions**](V1alpha1Api.md#servicebrokerTestIamPermissions) | **POST** /v1alpha1/{resource}:testIamPermissions | 
...
let apiInstance = new ServiceBroker.V1alpha1Api();
