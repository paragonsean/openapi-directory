...
/*
 * OAIGoogleCloudServicebrokerV1alpha1__ServiceInstance.h
 *
 * Message describing inputs to Provision and Update Service instance requests.
 */

#ifndef OAIGoogleCloudServicebrokerV1alpha1__ServiceInstance_H
#define OAIGoogleCloudServicebrokerV1alpha1__ServiceInstance_H
...
class OAIGoogleCloudServicebrokerV1alpha1__ServiceInstance : public OAIObject {
public:
    OAIGoogleCloudServicebrokerV1alpha1__ServiceInstance();
    OAIGoogleCloudServicebrokerV1alpha1__ServiceInstance(QString json);
    ~OAIGoogleCloudServicebrokerV1alpha1__ServiceInstance() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudServicebrokerV1alpha1__ServiceInstance)

#endif // OAIGoogleCloudServicebrokerV1alpha1__ServiceInstance_H
