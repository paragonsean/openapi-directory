...
> GoogleIamV1Policy servicebrokerGetIamPolicy(resource, fields, uploadType, paramCallback, oauthToken, $xgafv, alt, accessToken, key, uploadProtocol, quotaUser, prettyPrint, optionsRequestedPolicyVersion)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      GoogleIamV1Policy result = apiInstance.servicebrokerGetIamPolicy(resource, fields, uploadType, paramCallback, oauthToken, $xgafv, alt, accessToken, key, uploadProtocol, quotaUser, prettyPrint, optionsRequestedPolicyVersion);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling V1beta1Api#servicebrokerGetIamPolicy");
...
> GoogleIamV1Policy servicebrokerSetIamPolicy(resource, fields, uploadType, paramCallback, oauthToken, $xgafv, alt, accessToken, key, uploadProtocol, quotaUser, prettyPrint, googleIamV1SetIamPolicyRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      GoogleIamV1Policy result = apiInstance.servicebrokerSetIamPolicy(resource, fields, uploadType, paramCallback, oauthToken, $xgafv, alt, accessToken, key, uploadProtocol, quotaUser, prettyPrint, googleIamV1SetIamPolicyRequest);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling V1beta1Api#servicebrokerSetIamPolicy");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
> GoogleIamV1TestIamPermissionsResponse servicebrokerTestIamPermissions(resource, fields, uploadType, paramCallback, oauthToken, $xgafv, alt, accessToken, key, uploadProtocol, quotaUser, prettyPrint, googleIamV1TestIamPermissionsRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      GoogleIamV1TestIamPermissionsResponse result = apiInstance.servicebrokerTestIamPermissions(resource, fields, uploadType, paramCallback, oauthToken, $xgafv, alt, accessToken, key, uploadProtocol, quotaUser, prettyPrint, googleIamV1TestIamPermissionsRequest);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling V1beta1Api#servicebrokerTestIamPermissions");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
