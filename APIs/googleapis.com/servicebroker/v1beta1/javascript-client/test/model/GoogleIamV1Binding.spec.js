...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceBroker.GoogleIamV1Binding();
  });
  ...
  describe('GoogleIamV1Binding', function() {
    it('should create an instance of GoogleIamV1Binding', function() {
      ...
      //var instance = new ServiceBroker.GoogleIamV1Binding();
      //expect(instance).to.be.a(ServiceBroker.GoogleIamV1Binding);
    });
