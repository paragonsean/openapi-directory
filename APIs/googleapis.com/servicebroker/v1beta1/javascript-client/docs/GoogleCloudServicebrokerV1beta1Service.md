# ServiceBroker.GoogleCloudServicebrokerV1beta1Service
...
**bindingsRetrievable** | **Boolean** | Whether the service provides an endpoint to get service bindings. | [optional] 
**dashboardClient** | [**GoogleCloudServicebrokerV1beta1DashboardClient**](GoogleCloudServicebrokerV1beta1DashboardClient.md) |  | [optional] 
...
**instancesRetrievable** | **Boolean** | Whether the service provides an endpoint to get service instances. | [optional] 
...
**plans** | [**[GoogleCloudServicebrokerV1beta1Plan]**](GoogleCloudServicebrokerV1beta1Plan.md) | A list of plans for this service. At least one plan is required. | [optional] 
