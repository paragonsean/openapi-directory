# ServiceBroker.GoogleCloudServicebrokerV1beta1ServiceInstance
...
**deploymentName** | **String** | Output only. String containing the Deployment Manager deployment name that was created for this instance, | [optional] 
**description** | **String** | To return errors when GetInstance call is done via HTTP to be unified with other methods. | [optional] 
