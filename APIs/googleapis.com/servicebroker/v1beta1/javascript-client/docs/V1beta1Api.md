# ServiceBroker.V1beta1Api

All URIs are relative to *https://servicebroker.googleapis.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**servicebrokerGetIamPolicy**](V1beta1Api.md#servicebrokerGetIamPolicy) | **GET** /v1beta1/{resource}:getIamPolicy | 
[**servicebrokerSetIamPolicy**](V1beta1Api.md#servicebrokerSetIamPolicy) | **POST** /v1beta1/{resource}:setIamPolicy | 
[**servicebrokerTestIamPermissions**](V1beta1Api.md#servicebrokerTestIamPermissions) | **POST** /v1beta1/{resource}:testIamPermissions | 
...
let apiInstance = new ServiceBroker.V1beta1Api();
