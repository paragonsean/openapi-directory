...
/**
 * The GoogleCloudServicebrokerV1beta1Binding model module.
 * @module model/GoogleCloudServicebrokerV1beta1Binding
 * @version v1beta1
 */
class GoogleCloudServicebrokerV1beta1Binding {
    /**
     * Constructs a new <code>GoogleCloudServicebrokerV1beta1Binding</code>.
     * Describes the binding.
     * @alias module:model/GoogleCloudServicebrokerV1beta1Binding
     */
    constructor() { 
        
        GoogleCloudServicebrokerV1beta1Binding.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudServicebrokerV1beta1Binding</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudServicebrokerV1beta1Binding} obj Optional instance to populate.
     * @return {module:model/GoogleCloudServicebrokerV1beta1Binding} The populated <code>GoogleCloudServicebrokerV1beta1Binding</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudServicebrokerV1beta1Binding();
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudServicebrokerV1beta1Binding</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudServicebrokerV1beta1Binding</code>.
     */
 ...
 */
GoogleCloudServicebrokerV1beta1Binding.prototype['bind_resource'] = undefined;
 ...
 */
GoogleCloudServicebrokerV1beta1Binding.prototype['binding_id'] = undefined;

/**
 * Output only. Timestamp for when the binding was created.
 * @member {String} createTime
 */
GoogleCloudServicebrokerV1beta1Binding.prototype['createTime'] = undefined;
 ...
 */
GoogleCloudServicebrokerV1beta1Binding.prototype['deploymentName'] = undefined;

/**
 * Configuration options for the service binding.
 * @member {Object.<String, Object>} parameters
 */
GoogleCloudServicebrokerV1beta1Binding.prototype['parameters'] = undefined;
 ...
 */
GoogleCloudServicebrokerV1beta1Binding.prototype['plan_id'] = undefined;
 ...
 */
GoogleCloudServicebrokerV1beta1Binding.prototype['resourceName'] = undefined;
 ...
 */
GoogleCloudServicebrokerV1beta1Binding.prototype['service_id'] = undefined;
...
export default GoogleCloudServicebrokerV1beta1Binding;
