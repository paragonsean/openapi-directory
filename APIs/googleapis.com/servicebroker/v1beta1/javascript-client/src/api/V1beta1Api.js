...
export default class V1beta1Api {
    ...
    */
     ...
     * @callback module:api/V1beta1Api~servicebrokerGetIamPolicyCallback
     ...
     * @param {module:api/V1beta1Api~servicebrokerGetIamPolicyCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/V1beta1Api~servicebrokerSetIamPolicyCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GoogleIamV1Policy} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/V1beta1Api~servicebrokerSetIamPolicyCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GoogleIamV1Policy}
     */
     ...
     * @callback module:api/V1beta1Api~servicebrokerTestIamPermissionsCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/V1beta1Api~servicebrokerTestIamPermissionsCallback} callback The callback function, accepting three arguments: error, data, response
