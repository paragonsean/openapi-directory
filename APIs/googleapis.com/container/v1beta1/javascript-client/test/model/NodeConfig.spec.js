...
(function(root, factory) {
  ...
  describe('NodeConfig', function() {
    ...
    it('should have the property ephemeralStorageConfig (base name: "ephemeralStorageConfig")', function() {
      // uncomment below and update the code to test the property ephemeralStorageConfig
      //var instance = new KubernetesEngineApi.NodeConfig();
      //expect(instance).to.be();
    });
