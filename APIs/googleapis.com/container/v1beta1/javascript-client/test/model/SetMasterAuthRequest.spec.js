...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesEngineApi.SetMasterAuthRequest();
  });
  ...
  describe('SetMasterAuthRequest', function() {
    it('should create an instance of SetMasterAuthRequest', function() {
      // uncomment below and update the code to test SetMasterAuthRequest
      //var instance = new KubernetesEngineApi.SetMasterAuthRequest();
      //expect(instance).to.be.a(KubernetesEngineApi.SetMasterAuthRequest);
    });
