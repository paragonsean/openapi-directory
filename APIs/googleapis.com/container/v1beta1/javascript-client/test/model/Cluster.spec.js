...
(function(root, factory) {
  ...
  describe('Cluster', function() {
    ...
    it('should have the property clusterTelemetry (base name: "clusterTelemetry")', function() {
      // uncomment below and update the code to test the property clusterTelemetry
      //var instance = new KubernetesEngineApi.Cluster();
      //expect(instance).to.be();
    });
    ...
    it('should have the property podSecurityPolicyConfig (base name: "podSecurityPolicyConfig")', function() {
      // uncomment below and update the code to test the property podSecurityPolicyConfig
      //var instance = new KubernetesEngineApi.Cluster();
      //expect(instance).to.be();
    });

    it('should have the property privateCluster (base name: "privateCluster")', function() {
      // uncomment below and update the code to test the property privateCluster
      //var instance = new KubernetesEngineApi.Cluster();
      //expect(instance).to.be();
    });
    ...
    it('should have the property protectConfig (base name: "protectConfig")', function() {
      // uncomment below and update the code to test the property protectConfig
      //var instance = new KubernetesEngineApi.Cluster();
      //expect(instance).to.be();
    });
    ...
    it('should have the property tpuConfig (base name: "tpuConfig")', function() {
      // uncomment below and update the code to test the property tpuConfig
      //var instance = new KubernetesEngineApi.Cluster();
      //expect(instance).to.be();
    });
    ...
    it('should have the property workloadAltsConfig (base name: "workloadAltsConfig")', function() {
      // uncomment below and update the code to test the property workloadAltsConfig
      //var instance = new KubernetesEngineApi.Cluster();
      //expect(instance).to.be();
    });

    it('should have the property workloadCertificates (base name: "workloadCertificates")', function() {
      // uncomment below and update the code to test the property workloadCertificates
      //var instance = new KubernetesEngineApi.Cluster();
      //expect(instance).to.be();
    });
