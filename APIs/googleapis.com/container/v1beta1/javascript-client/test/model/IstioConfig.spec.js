...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesEngineApi.IstioConfig();
  });
  ...
  describe('IstioConfig', function() {
    it('should create an instance of IstioConfig', function() {
      // uncomment below and update the code to test IstioConfig
      //var instance = new KubernetesEngineApi.IstioConfig();
      //expect(instance).to.be.a(KubernetesEngineApi.IstioConfig);
    });
