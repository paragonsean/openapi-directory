...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesEngineApi.SetLoggingServiceRequest();
  });
  ...
  describe('SetLoggingServiceRequest', function() {
    it('should create an instance of SetLoggingServiceRequest', function() {
      // uncomment below and update the code to test SetLoggingServiceRequest
      //var instance = new KubernetesEngineApi.SetLoggingServiceRequest();
      //expect(instance).to.be.a(KubernetesEngineApi.SetLoggingServiceRequest);
    });
