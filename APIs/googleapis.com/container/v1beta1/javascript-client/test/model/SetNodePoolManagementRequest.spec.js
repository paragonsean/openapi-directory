...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesEngineApi.SetNodePoolManagementRequest();
  });
  ...
  describe('SetNodePoolManagementRequest', function() {
    it('should create an instance of SetNodePoolManagementRequest', function() {
      // uncomment below and update the code to test SetNodePoolManagementRequest
      //var instance = new KubernetesEngineApi.SetNodePoolManagementRequest();
      //expect(instance).to.be.a(KubernetesEngineApi.SetNodePoolManagementRequest);
    });
