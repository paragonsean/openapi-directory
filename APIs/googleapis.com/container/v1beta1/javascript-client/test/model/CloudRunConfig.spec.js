...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesEngineApi.CloudRunConfig();
  });
  ...
  describe('CloudRunConfig', function() {
    it('should create an instance of CloudRunConfig', function() {
      ...
      //var instance = new KubernetesEngineApi.CloudRunConfig();
      //expect(instance).to.be.a(KubernetesEngineApi.CloudRunConfig);
    });
