...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesEngineApi.SetNodePoolSizeRequest();
  });
  ...
  describe('SetNodePoolSizeRequest', function() {
    it('should create an instance of SetNodePoolSizeRequest', function() {
      // uncomment below and update the code to test SetNodePoolSizeRequest
      //var instance = new KubernetesEngineApi.SetNodePoolSizeRequest();
      //expect(instance).to.be.a(KubernetesEngineApi.SetNodePoolSizeRequest);
    });
