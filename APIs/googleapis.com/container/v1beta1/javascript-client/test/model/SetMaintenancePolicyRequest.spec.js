...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesEngineApi.SetMaintenancePolicyRequest();
  });
  ...
  describe('SetMaintenancePolicyRequest', function() {
    it('should create an instance of SetMaintenancePolicyRequest', function() {
      // uncomment below and update the code to test SetMaintenancePolicyRequest
      //var instance = new KubernetesEngineApi.SetMaintenancePolicyRequest();
      //expect(instance).to.be.a(KubernetesEngineApi.SetMaintenancePolicyRequest);
    });
