...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesEngineApi.SetLabelsRequest();
  });
  ...
  describe('SetLabelsRequest', function() {
    it('should create an instance of SetLabelsRequest', function() {
      // uncomment below and update the code to test SetLabelsRequest
      //var instance = new KubernetesEngineApi.SetLabelsRequest();
      //expect(instance).to.be.a(KubernetesEngineApi.SetLabelsRequest);
    });
