...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesEngineApi.ListLocationsResponse();
  });
  ...
  describe('ListLocationsResponse', function() {
    it('should create an instance of ListLocationsResponse', function() {
      ...
      //var instance = new KubernetesEngineApi.ListLocationsResponse();
      //expect(instance).to.be.a(KubernetesEngineApi.ListLocationsResponse);
    });
