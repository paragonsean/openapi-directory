...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesEngineApi.SetAddonsConfigRequest();
  });
  ...
  describe('SetAddonsConfigRequest', function() {
    it('should create an instance of SetAddonsConfigRequest', function() {
      // uncomment below and update the code to test SetAddonsConfigRequest
      //var instance = new KubernetesEngineApi.SetAddonsConfigRequest();
      //expect(instance).to.be.a(KubernetesEngineApi.SetAddonsConfigRequest);
    });
