...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesEngineApi.SetLocationsRequest();
  });
  ...
  describe('SetLocationsRequest', function() {
    it('should create an instance of SetLocationsRequest', function() {
      // uncomment below and update the code to test SetLocationsRequest
      //var instance = new KubernetesEngineApi.SetLocationsRequest();
      //expect(instance).to.be.a(KubernetesEngineApi.SetLocationsRequest);
    });
