...
(function(root, factory) {
  ...
  describe('ProjectsApi', function() {
    ...
    describe('containerProjectsLocationsList', function() {
      it('should call containerProjectsLocationsList successfully', function(done) {
        //uncomment below and update the code to test containerProjectsLocationsList
        //instance.containerProjectsLocationsList(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
