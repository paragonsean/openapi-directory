...
class ServerConfig {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('windowsVersionMaps')) {
                obj['windowsVersionMaps'] = ApiClient.convertToType(data['windowsVersionMaps'], {'String': WindowsVersions});
            }
        }
        return obj;
    }
 ...
 * @member {Object.<String, module:model/WindowsVersions>} windowsVersionMaps
 */
ServerConfig.prototype['windowsVersionMaps'] = undefined;
