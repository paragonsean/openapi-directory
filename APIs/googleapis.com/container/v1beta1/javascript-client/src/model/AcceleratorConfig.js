...
class AcceleratorConfig {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('maxTimeSharedClientsPerGpu')) {
                obj['maxTimeSharedClientsPerGpu'] = ApiClient.convertToType(data['maxTimeSharedClientsPerGpu'], 'String');
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['maxTimeSharedClientsPerGpu'] && !(typeof data['maxTimeSharedClientsPerGpu'] === 'string' || data['maxTimeSharedClientsPerGpu'] instanceof String)) {
            throw new Error("Expected the field `maxTimeSharedClientsPerGpu` to be a primitive type in the JSON string but got " + data['maxTimeSharedClientsPerGpu']);
        }
 ...
 * @member {String} maxTimeSharedClientsPerGpu
 */
AcceleratorConfig.prototype['maxTimeSharedClientsPerGpu'] = undefined;
