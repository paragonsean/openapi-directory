...
class NodeConfig {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('ephemeralStorageConfig')) {
                obj['ephemeralStorageConfig'] = EphemeralStorageConfig.constructFromObject(data['ephemeralStorageConfig']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['ephemeralStorageConfig']) { // data not null
          EphemeralStorageConfig.validateJSON(data['ephemeralStorageConfig']);
        }
...
/**
 * @member {module:model/EphemeralStorageConfig} ephemeralStorageConfig
 */
NodeConfig.prototype['ephemeralStorageConfig'] = undefined;
 ...
 */
NodeConfig.prototype['hostMaintenancePolicy'] = undefined;
