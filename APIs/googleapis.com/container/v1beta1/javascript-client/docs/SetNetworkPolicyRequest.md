# KubernetesEngineApi.SetNetworkPolicyRequest
...
**name** | **String** | The name (project, location, cluster name) of the cluster to set networking policy. Specified in the format &#x60;projects/_*_/locations/_*_/clusters/_*&#x60;. | [optional] 
