...
------------- | ------------- | -------------
[**containerProjectsAggregatedUsableSubnetworksList**](ProjectsApi.md#containerProjectsAggregatedUsableSubnetworksList) | **GET** /v1beta1/{parent}/aggregated/usableSubnetworks | 
[**containerProjectsLocationsClustersCheckAutopilotCompatibility**](ProjectsApi.md#containerProjectsLocationsClustersCheckAutopilotCompatibility) | **GET** /v1beta1/{name}:checkAutopilotCompatibility | 
[**containerProjectsLocationsClustersCompleteIpRotation**](ProjectsApi.md#containerProjectsLocationsClustersCompleteIpRotation) | **POST** /v1beta1/{name}:completeIpRotation | 
[**containerProjectsLocationsClustersCreate**](ProjectsApi.md#containerProjectsLocationsClustersCreate) | **POST** /v1beta1/{parent}/clusters | 
[**containerProjectsLocationsClustersGetJwks**](ProjectsApi.md#containerProjectsLocationsClustersGetJwks) | **GET** /v1beta1/{parent}/jwks | 
[**containerProjectsLocationsClustersList**](ProjectsApi.md#containerProjectsLocationsClustersList) | **GET** /v1beta1/{parent}/clusters | 
[**containerProjectsLocationsClustersNodePoolsCompleteUpgrade**](ProjectsApi.md#containerProjectsLocationsClustersNodePoolsCompleteUpgrade) | **POST** /v1beta1/{name}:completeUpgrade | 
[**containerProjectsLocationsClustersNodePoolsCreate**](ProjectsApi.md#containerProjectsLocationsClustersNodePoolsCreate) | **POST** /v1beta1/{parent}/nodePools | 
[**containerProjectsLocationsClustersNodePoolsDelete**](ProjectsApi.md#containerProjectsLocationsClustersNodePoolsDelete) | **DELETE** /v1beta1/{name} | 
[**containerProjectsLocationsClustersNodePoolsList**](ProjectsApi.md#containerProjectsLocationsClustersNodePoolsList) | **GET** /v1beta1/{parent}/nodePools | 
[**containerProjectsLocationsClustersNodePoolsRollback**](ProjectsApi.md#containerProjectsLocationsClustersNodePoolsRollback) | **POST** /v1beta1/{name}:rollback | 
[**containerProjectsLocationsClustersNodePoolsSetAutoscaling**](ProjectsApi.md#containerProjectsLocationsClustersNodePoolsSetAutoscaling) | **POST** /v1beta1/{name}:setAutoscaling | 
[**containerProjectsLocationsClustersNodePoolsSetManagement**](ProjectsApi.md#containerProjectsLocationsClustersNodePoolsSetManagement) | **POST** /v1beta1/{name}:setManagement | 
[**containerProjectsLocationsClustersNodePoolsSetSize**](ProjectsApi.md#containerProjectsLocationsClustersNodePoolsSetSize) | **POST** /v1beta1/{name}:setSize | 
[**containerProjectsLocationsClustersNodePoolsUpdate**](ProjectsApi.md#containerProjectsLocationsClustersNodePoolsUpdate) | **PUT** /v1beta1/{name} | 
[**containerProjectsLocationsClustersSetAddons**](ProjectsApi.md#containerProjectsLocationsClustersSetAddons) | **POST** /v1beta1/{name}:setAddons | 
[**containerProjectsLocationsClustersSetLegacyAbac**](ProjectsApi.md#containerProjectsLocationsClustersSetLegacyAbac) | **POST** /v1beta1/{name}:setLegacyAbac | 
[**containerProjectsLocationsClustersSetLocations**](ProjectsApi.md#containerProjectsLocationsClustersSetLocations) | **POST** /v1beta1/{name}:setLocations | 
[**containerProjectsLocationsClustersSetLogging**](ProjectsApi.md#containerProjectsLocationsClustersSetLogging) | **POST** /v1beta1/{name}:setLogging | 
[**containerProjectsLocationsClustersSetMaintenancePolicy**](ProjectsApi.md#containerProjectsLocationsClustersSetMaintenancePolicy) | **POST** /v1beta1/{name}:setMaintenancePolicy | 
[**containerProjectsLocationsClustersSetMasterAuth**](ProjectsApi.md#containerProjectsLocationsClustersSetMasterAuth) | **POST** /v1beta1/{name}:setMasterAuth | 
[**containerProjectsLocationsClustersSetMonitoring**](ProjectsApi.md#containerProjectsLocationsClustersSetMonitoring) | **POST** /v1beta1/{name}:setMonitoring | 
[**containerProjectsLocationsClustersSetNetworkPolicy**](ProjectsApi.md#containerProjectsLocationsClustersSetNetworkPolicy) | **POST** /v1beta1/{name}:setNetworkPolicy | 
[**containerProjectsLocationsClustersSetResourceLabels**](ProjectsApi.md#containerProjectsLocationsClustersSetResourceLabels) | **POST** /v1beta1/{name}:setResourceLabels | 
[**containerProjectsLocationsClustersStartIpRotation**](ProjectsApi.md#containerProjectsLocationsClustersStartIpRotation) | **POST** /v1beta1/{name}:startIpRotation | 
[**containerProjectsLocationsClustersUpdateMaster**](ProjectsApi.md#containerProjectsLocationsClustersUpdateMaster) | **POST** /v1beta1/{name}:updateMaster | 
[**containerProjectsLocationsClustersWellKnownGetOpenidConfiguration**](ProjectsApi.md#containerProjectsLocationsClustersWellKnownGetOpenidConfiguration) | **GET** /v1beta1/{parent}/.well-known/openid-configuration | 
[**containerProjectsLocationsGetServerConfig**](ProjectsApi.md#containerProjectsLocationsGetServerConfig) | **GET** /v1beta1/{name}/serverConfig | 
[**containerProjectsLocationsList**](ProjectsApi.md#containerProjectsLocationsList) | **GET** /v1beta1/{parent}/locations | 
[**containerProjectsLocationsOperationsCancel**](ProjectsApi.md#containerProjectsLocationsOperationsCancel) | **POST** /v1beta1/{name}:cancel | 
[**containerProjectsLocationsOperationsGet**](ProjectsApi.md#containerProjectsLocationsOperationsGet) | **GET** /v1beta1/{name} | 
[**containerProjectsLocationsOperationsList**](ProjectsApi.md#containerProjectsLocationsOperationsList) | **GET** /v1beta1/{parent}/operations | 
[**containerProjectsZonesClustersAddons**](ProjectsApi.md#containerProjectsZonesClustersAddons) | **POST** /v1beta1/projects/{projectId}/zones/{zone}/clusters/{clusterId}/addons | 
[**containerProjectsZonesClustersCompleteIpRotation**](ProjectsApi.md#containerProjectsZonesClustersCompleteIpRotation) | **POST** /v1beta1/projects/{projectId}/zones/{zone}/clusters/{clusterId}:completeIpRotation | 
[**containerProjectsZonesClustersCreate**](ProjectsApi.md#containerProjectsZonesClustersCreate) | **POST** /v1beta1/projects/{projectId}/zones/{zone}/clusters | 
[**containerProjectsZonesClustersDelete**](ProjectsApi.md#containerProjectsZonesClustersDelete) | **DELETE** /v1beta1/projects/{projectId}/zones/{zone}/clusters/{clusterId} | 
[**containerProjectsZonesClustersGet**](ProjectsApi.md#containerProjectsZonesClustersGet) | **GET** /v1beta1/projects/{projectId}/zones/{zone}/clusters/{clusterId} | 
[**containerProjectsZonesClustersLegacyAbac**](ProjectsApi.md#containerProjectsZonesClustersLegacyAbac) | **POST** /v1beta1/projects/{projectId}/zones/{zone}/clusters/{clusterId}/legacyAbac | 
[**containerProjectsZonesClustersList**](ProjectsApi.md#containerProjectsZonesClustersList) | **GET** /v1beta1/projects/{projectId}/zones/{zone}/clusters | 
[**containerProjectsZonesClustersLocations**](ProjectsApi.md#containerProjectsZonesClustersLocations) | **POST** /v1beta1/projects/{projectId}/zones/{zone}/clusters/{clusterId}/locations | 
[**containerProjectsZonesClustersLogging**](ProjectsApi.md#containerProjectsZonesClustersLogging) | **POST** /v1beta1/projects/{projectId}/zones/{zone}/clusters/{clusterId}/logging | 
[**containerProjectsZonesClustersMaster**](ProjectsApi.md#containerProjectsZonesClustersMaster) | **POST** /v1beta1/projects/{projectId}/zones/{zone}/clusters/{clusterId}/master | 
[**containerProjectsZonesClustersMonitoring**](ProjectsApi.md#containerProjectsZonesClustersMonitoring) | **POST** /v1beta1/projects/{projectId}/zones/{zone}/clusters/{clusterId}/monitoring | 
[**containerProjectsZonesClustersNodePoolsAutoscaling**](ProjectsApi.md#containerProjectsZonesClustersNodePoolsAutoscaling) | **POST** /v1beta1/projects/{projectId}/zones/{zone}/clusters/{clusterId}/nodePools/{nodePoolId}/autoscaling | 
[**containerProjectsZonesClustersNodePoolsCreate**](ProjectsApi.md#containerProjectsZonesClustersNodePoolsCreate) | **POST** /v1beta1/projects/{projectId}/zones/{zone}/clusters/{clusterId}/nodePools | 
[**containerProjectsZonesClustersNodePoolsDelete**](ProjectsApi.md#containerProjectsZonesClustersNodePoolsDelete) | **DELETE** /v1beta1/projects/{projectId}/zones/{zone}/clusters/{clusterId}/nodePools/{nodePoolId} | 
[**containerProjectsZonesClustersNodePoolsGet**](ProjectsApi.md#containerProjectsZonesClustersNodePoolsGet) | **GET** /v1beta1/projects/{projectId}/zones/{zone}/clusters/{clusterId}/nodePools/{nodePoolId} | 
[**containerProjectsZonesClustersNodePoolsList**](ProjectsApi.md#containerProjectsZonesClustersNodePoolsList) | **GET** /v1beta1/projects/{projectId}/zones/{zone}/clusters/{clusterId}/nodePools | 
[**containerProjectsZonesClustersNodePoolsRollback**](ProjectsApi.md#containerProjectsZonesClustersNodePoolsRollback) | **POST** /v1beta1/projects/{projectId}/zones/{zone}/clusters/{clusterId}/nodePools/{nodePoolId}:rollback | 
[**containerProjectsZonesClustersNodePoolsSetManagement**](ProjectsApi.md#containerProjectsZonesClustersNodePoolsSetManagement) | **POST** /v1beta1/projects/{projectId}/zones/{zone}/clusters/{clusterId}/nodePools/{nodePoolId}/setManagement | 
[**containerProjectsZonesClustersNodePoolsSetSize**](ProjectsApi.md#containerProjectsZonesClustersNodePoolsSetSize) | **POST** /v1beta1/projects/{projectId}/zones/{zone}/clusters/{clusterId}/nodePools/{nodePoolId}/setSize | 
[**containerProjectsZonesClustersNodePoolsUpdate**](ProjectsApi.md#containerProjectsZonesClustersNodePoolsUpdate) | **POST** /v1beta1/projects/{projectId}/zones/{zone}/clusters/{clusterId}/nodePools/{nodePoolId}/update | 
[**containerProjectsZonesClustersResourceLabels**](ProjectsApi.md#containerProjectsZonesClustersResourceLabels) | **POST** /v1beta1/projects/{projectId}/zones/{zone}/clusters/{clusterId}/resourceLabels | 
[**containerProjectsZonesClustersSetMaintenancePolicy**](ProjectsApi.md#containerProjectsZonesClustersSetMaintenancePolicy) | **POST** /v1beta1/projects/{projectId}/zones/{zone}/clusters/{clusterId}:setMaintenancePolicy | 
[**containerProjectsZonesClustersSetMasterAuth**](ProjectsApi.md#containerProjectsZonesClustersSetMasterAuth) | **POST** /v1beta1/projects/{projectId}/zones/{zone}/clusters/{clusterId}:setMasterAuth | 
[**containerProjectsZonesClustersSetNetworkPolicy**](ProjectsApi.md#containerProjectsZonesClustersSetNetworkPolicy) | **POST** /v1beta1/projects/{projectId}/zones/{zone}/clusters/{clusterId}:setNetworkPolicy | 
[**containerProjectsZonesClustersStartIpRotation**](ProjectsApi.md#containerProjectsZonesClustersStartIpRotation) | **POST** /v1beta1/projects/{projectId}/zones/{zone}/clusters/{clusterId}:startIpRotation | 
[**containerProjectsZonesClustersUpdate**](ProjectsApi.md#containerProjectsZonesClustersUpdate) | **PUT** /v1beta1/projects/{projectId}/zones/{zone}/clusters/{clusterId} | 
[**containerProjectsZonesGetServerconfig**](ProjectsApi.md#containerProjectsZonesGetServerconfig) | **GET** /v1beta1/projects/{projectId}/zones/{zone}/serverconfig | 
[**containerProjectsZonesOperationsCancel**](ProjectsApi.md#containerProjectsZonesOperationsCancel) | **POST** /v1beta1/projects/{projectId}/zones/{zone}/operations/{operationId}:cancel | 
[**containerProjectsZonesOperationsGet**](ProjectsApi.md#containerProjectsZonesOperationsGet) | **GET** /v1beta1/projects/{projectId}/zones/{zone}/operations/{operationId} | 
[**containerProjectsZonesOperationsList**](ProjectsApi.md#containerProjectsZonesOperationsList) | **GET** /v1beta1/projects/{projectId}/zones/{zone}/operations | 
...
let parent = "parent_example"; // String | Required. The parent project where subnetworks are usable. Specified in the format `projects/_*`.
let opts = {
...
------------- | ------------- | ------------- | -------------
 **parent** | **String**| Required. The parent project where subnetworks are usable. Specified in the format &#x60;projects/_*&#x60;. | 
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'projectId': "projectId_example", // String | Required. Deprecated. The Google Developers Console [project ID or project number](https://cloud.google.com/resource-manager/docs/creating-managing-projects). This field has been deprecated and replaced by the parent field.
  'zone': "zone_example" // String | Required. Deprecated. The name of the Google Compute Engine [zone](https://cloud.google.com/compute/docs/zones#available) in which the cluster resides, or \"-\" for all zones. This field has been deprecated and replaced by the parent field.
};
 ...
 **zone** | **String**| Required. Deprecated. The name of the Google Compute Engine [zone](https://cloud.google.com/compute/docs/zones#available) in which the cluster resides, or \&quot;-\&quot; for all zones. This field has been deprecated and replaced by the parent field. | [optional] 
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'clusterId': "clusterId_example", // String | Required. Deprecated. The name of the cluster. This field has been deprecated and replaced by the name field.
  'nodePoolId': "nodePoolId_example", // String | Required. Deprecated. The name of the node pool to delete. This field has been deprecated and replaced by the name field.
  'projectId': "projectId_example", // String | Required. Deprecated. The Google Developers Console [project ID or project number](https://cloud.google.com/resource-manager/docs/creating-managing-projects). This field has been deprecated and replaced by the name field.
  'zone': "zone_example" // String | Required. Deprecated. The name of the Google Compute Engine [zone](https://cloud.google.com/compute/docs/zones#available) in which the cluster resides. This field has been deprecated and replaced by the name field.
};
 ...
 **nodePoolId** | **String**| Required. Deprecated. The name of the node pool to delete. This field has been deprecated and replaced by the name field. | [optional] 
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'clusterId': "clusterId_example", // String | Required. Deprecated. The name of the cluster. This field has been deprecated and replaced by the parent field.
  'projectId': "projectId_example", // String | Required. Deprecated. The Google Developers Console [project ID or project number](https://cloud.google.com/resource-manager/docs/creating-managing-projects). This field has been deprecated and replaced by the parent field.
  'zone': "zone_example" // String | Required. Deprecated. The name of the Google Compute Engine [zone](https://cloud.google.com/compute/docs/zones#available) in which the cluster resides. This field has been deprecated and replaced by the parent field.
};
...
let opts = {
  ...
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'projectId': "projectId_example", // String | Required. Deprecated. The Google Developers Console [project ID or project number](https://cloud.google.com/resource-manager/docs/creating-managing-projects). This field has been deprecated and replaced by the name field.
  'zone': "zone_example" // String | Required. Deprecated. The name of the Google Compute Engine [zone](https://cloud.google.com/compute/docs/zones#available) to return operations for. This field has been deprecated and replaced by the name field.
};
 ...
 **uploadType** | **String**| Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;). | [optional] 
 **projectId** | **String**| Required. Deprecated. The Google Developers Console [project ID or project number](https://cloud.google.com/resource-manager/docs/creating-managing-projects). This field has been deprecated and replaced by the name field. | [optional] 
 **zone** | **String**| Required. Deprecated. The name of the Google Compute Engine [zone](https://cloud.google.com/compute/docs/zones#available) to return operations for. This field has been deprecated and replaced by the name field. | [optional] 
...
> ListLocationsResponse containerProjectsLocationsList(parent, opts)
...
let apiInstance = new KubernetesEngineApi.ProjectsApi();
let parent = "parent_example"; // String | Required. Contains the name of the resource requested. Specified in the format `projects/_*`.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
apiInstance.containerProjectsLocationsList(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **parent** | **String**| Required. Contains the name of the resource requested. Specified in the format &#x60;projects/_*&#x60;. | 
 **xgafv** | **String**| V1 error format. | [optional] 
 **accessToken** | **String**| OAuth access token. | [optional] 
 **alt** | **String**| Data format for response. | [optional] 
 **callback** | **String**| JSONP | [optional] 
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'operationId': "operationId_example", // String | Required. Deprecated. The server-assigned `name` of the operation. This field has been deprecated and replaced by the name field.
  'projectId': "projectId_example", // String | Required. Deprecated. The Google Developers Console [project ID or project number](https://cloud.google.com/resource-manager/docs/creating-managing-projects). This field has been deprecated and replaced by the name field.
  'zone': "zone_example" // String | Required. Deprecated. The name of the Google Compute Engine [zone](https://cloud.google.com/compute/docs/zones#available) in which the cluster resides. This field has been deprecated and replaced by the name field.
};
...
let opts = {
  ...
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'projectId': "projectId_example", // String | Required. Deprecated. The Google Developers Console [project ID or project number](https://cloud.google.com/resource-manager/docs/creating-managing-projects). This field has been deprecated and replaced by the parent field.
  'zone': "zone_example" // String | Required. Deprecated. The name of the Google Compute Engine [zone](https://cloud.google.com/compute/docs/zones#available) to return operations for, or `-` for all zones. This field has been deprecated and replaced by the parent field.
};
 ...
 **uploadType** | **String**| Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;). | [optional] 
 **projectId** | **String**| Required. Deprecated. The Google Developers Console [project ID or project number](https://cloud.google.com/resource-manager/docs/creating-managing-projects). This field has been deprecated and replaced by the parent field. | [optional] 
 **zone** | **String**| Required. Deprecated. The name of the Google Compute Engine [zone](https://cloud.google.com/compute/docs/zones#available) to return operations for, or &#x60;-&#x60; for all zones. This field has been deprecated and replaced by the parent field. | [optional] 
...
let apiInstance = new KubernetesEngineApi.ProjectsApi();
let projectId = "projectId_example"; // String | Required. Deprecated. The Google Developers Console [project ID or project number](https://cloud.google.com/resource-manager/docs/creating-managing-projects). This field has been deprecated and replaced by the name field.
let zone = "zone_example"; // String | Required. Deprecated. The name of the Google Compute Engine [zone](https://cloud.google.com/compute/docs/zones#available) in which the cluster resides. This field has been deprecated and replaced by the name field.
let clusterId = "clusterId_example"; // String | Required. Deprecated. The name of the cluster to upgrade. This field has been deprecated and replaced by the name field.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
let projectId = "projectId_example"; // String | Required. Deprecated. The Google Developers Console [project ID or project number](https://cloud.google.com/resource-manager/docs/creating-managing-projects). This field has been deprecated and replaced by the name field.
let zone = "zone_example"; // String | Required. Deprecated. The name of the Google Compute Engine [zone](https://cloud.google.com/compute/docs/zones#available) in which the cluster resides. This field has been deprecated and replaced by the name field.
let clusterId = "clusterId_example"; // String | Required. Deprecated. The name of the cluster. This field has been deprecated and replaced by the name field.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
let apiInstance = new KubernetesEngineApi.ProjectsApi();
let projectId = "projectId_example"; // String | Required. Deprecated. The Google Developers Console [project ID or project number](https://cloud.google.com/resource-manager/docs/creating-managing-projects). This field has been deprecated and replaced by the parent field.
let zone = "zone_example"; // String | Required. Deprecated. The name of the Google Compute Engine [zone](https://cloud.google.com/compute/docs/zones#available) in which the cluster resides. This field has been deprecated and replaced by the parent field.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
let projectId = "projectId_example"; // String | Required. Deprecated. The Google Developers Console [project ID or project number](https://cloud.google.com/resource-manager/docs/creating-managing-projects). This field has been deprecated and replaced by the name field.
let zone = "zone_example"; // String | Required. Deprecated. The name of the Google Compute Engine [zone](https://cloud.google.com/compute/docs/zones#available) in which the cluster resides. This field has been deprecated and replaced by the name field.
let clusterId = "clusterId_example"; // String | Required. Deprecated. The name of the cluster to delete. This field has been deprecated and replaced by the name field.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
let projectId = "projectId_example"; // String | Required. Deprecated. The Google Developers Console [project ID or project number](https://cloud.google.com/resource-manager/docs/creating-managing-projects). This field has been deprecated and replaced by the name field.
let zone = "zone_example"; // String | Required. Deprecated. The name of the Google Compute Engine [zone](https://cloud.google.com/compute/docs/zones#available) in which the cluster resides. This field has been deprecated and replaced by the name field.
let clusterId = "clusterId_example"; // String | Required. Deprecated. The name of the cluster to retrieve. This field has been deprecated and replaced by the name field.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
let projectId = "projectId_example"; // String | Required. Deprecated. The Google Developers Console [project ID or project number](https://cloud.google.com/resource-manager/docs/creating-managing-projects). This field has been deprecated and replaced by the name field.
let zone = "zone_example"; // String | Required. Deprecated. The name of the Google Compute Engine [zone](https://cloud.google.com/compute/docs/zones#available) in which the cluster resides. This field has been deprecated and replaced by the name field.
let clusterId = "clusterId_example"; // String | Required. Deprecated. The name of the cluster to update. This field has been deprecated and replaced by the name field.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
let apiInstance = new KubernetesEngineApi.ProjectsApi();
let projectId = "projectId_example"; // String | Required. Deprecated. The Google Developers Console [project ID or project number](https://cloud.google.com/resource-manager/docs/creating-managing-projects). This field has been deprecated and replaced by the parent field.
let zone = "zone_example"; // String | Required. Deprecated. The name of the Google Compute Engine [zone](https://cloud.google.com/compute/docs/zones#available) in which the cluster resides, or \"-\" for all zones. This field has been deprecated and replaced by the parent field.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
let zone = "zone_example"; // String | Required. Deprecated. The name of the Google Compute Engine [zone](https://cloud.google.com/compute/docs/zones#available) in which the cluster resides. This field has been deprecated and replaced by the name field.
let clusterId = "clusterId_example"; // String | Required. Deprecated. The name of the cluster to upgrade. This field has been deprecated and replaced by the name field.
let nodePoolId = "nodePoolId_example"; // String | Required. Deprecated. The name of the node pool to upgrade. This field has been deprecated and replaced by the name field.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
let projectId = "projectId_example"; // String | Required. Deprecated. The Google Developers Console [project ID or project number](https://cloud.google.com/resource-manager/docs/creating-managing-projects). This field has been deprecated and replaced by the parent field.
let zone = "zone_example"; // String | Required. Deprecated. The name of the Google Compute Engine [zone](https://cloud.google.com/compute/docs/zones#available) in which the cluster resides. This field has been deprecated and replaced by the parent field.
let clusterId = "clusterId_example"; // String | Required. Deprecated. The name of the cluster. This field has been deprecated and replaced by the parent field.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
let zone = "zone_example"; // String | Required. Deprecated. The name of the Google Compute Engine [zone](https://cloud.google.com/compute/docs/zones#available) in which the cluster resides. This field has been deprecated and replaced by the name field.
let clusterId = "clusterId_example"; // String | Required. Deprecated. The name of the cluster. This field has been deprecated and replaced by the name field.
let nodePoolId = "nodePoolId_example"; // String | Required. Deprecated. The name of the node pool to delete. This field has been deprecated and replaced by the name field.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
let zone = "zone_example"; // String | Required. Deprecated. The name of the Google Compute Engine [zone](https://cloud.google.com/compute/docs/zones#available) in which the cluster resides. This field has been deprecated and replaced by the name field.
let clusterId = "clusterId_example"; // String | Required. Deprecated. The name of the cluster. This field has been deprecated and replaced by the name field.
let nodePoolId = "nodePoolId_example"; // String | Required. Deprecated. The name of the node pool. This field has been deprecated and replaced by the name field.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
let projectId = "projectId_example"; // String | Required. Deprecated. The Google Developers Console [project ID or project number](https://cloud.google.com/resource-manager/docs/creating-managing-projects). This field has been deprecated and replaced by the name field.
let zone = "zone_example"; // String | Required. Deprecated. The name of the Google Compute Engine [zone](https://cloud.google.com/compute/docs/zones#available) in which the cluster resides. This field has been deprecated and replaced by the name field.
let clusterId = "clusterId_example"; // String | Required. Deprecated. The name of the cluster to rollback. This field has been deprecated and replaced by the name field.
let nodePoolId = "nodePoolId_example"; // String | Required. Deprecated. The name of the node pool to rollback. This field has been deprecated and replaced by the name field.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
let zone = "zone_example"; // String | Required. Deprecated. The name of the Google Compute Engine [zone](https://cloud.google.com/compute/docs/zones#available) in which the cluster resides. This field has been deprecated and replaced by the name field.
let clusterId = "clusterId_example"; // String | Required. Deprecated. The name of the cluster to update. This field has been deprecated and replaced by the name field.
let nodePoolId = "nodePoolId_example"; // String | Required. Deprecated. The name of the node pool to update. This field has been deprecated and replaced by the name field.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
let apiInstance = new KubernetesEngineApi.ProjectsApi();
let projectId = "projectId_example"; // String | Required. Deprecated. The Google Developers Console [project ID or project number](https://cloud.google.com/resource-manager/docs/creating-managing-projects). This field has been deprecated and replaced by the name field.
let zone = "zone_example"; // String | Required. Deprecated. The name of the Google Compute Engine [zone](https://cloud.google.com/compute/docs/zones#available) to return operations for. This field has been deprecated and replaced by the name field.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
let apiInstance = new KubernetesEngineApi.ProjectsApi();
let projectId = "projectId_example"; // String | Required. Deprecated. The Google Developers Console [project ID or project number](https://cloud.google.com/resource-manager/docs/creating-managing-projects). This field has been deprecated and replaced by the name field.
let zone = "zone_example"; // String | Required. Deprecated. The name of the Google Compute Engine [zone](https://cloud.google.com/compute/docs/zones#available) in which the operation resides. This field has been deprecated and replaced by the name field.
let operationId = "operationId_example"; // String | Required. Deprecated. The server-assigned `name` of the operation. This field has been deprecated and replaced by the name field.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
let apiInstance = new KubernetesEngineApi.ProjectsApi();
let projectId = "projectId_example"; // String | Required. Deprecated. The Google Developers Console [project ID or project number](https://cloud.google.com/resource-manager/docs/creating-managing-projects). This field has been deprecated and replaced by the parent field.
let zone = "zone_example"; // String | Required. Deprecated. The name of the Google Compute Engine [zone](https://cloud.google.com/compute/docs/zones#available) to return operations for, or `-` for all zones. This field has been deprecated and replaced by the parent field.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
