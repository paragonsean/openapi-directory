...
async def test_container_projects_aggregated_usable_subnetworks_list(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1beta1/{parent}/aggregated/usableSubnetworks'.format(parent='parent_example'),
        headers=headers,
        params=params,
        )
...
async def test_container_projects_locations_clusters_check_autopilot_compatibility(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1beta1/{namecheck_autopilot_compatibilit}'.format(name='name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_container_projects_locations_clusters_complete_ip_rotation(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/{namecomplete_ip_rotatio}'.format(name='name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_container_projects_locations_clusters_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/{parent}/clusters'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_container_projects_locations_clusters_get_jwks(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1beta1/{parent}/jwks'.format(parent='parent_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_container_projects_locations_clusters_node_pools_complete_upgrade(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/{namecomplete_upgrad}'.format(name='name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_container_projects_locations_clusters_node_pools_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/{parent}/nodePools'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_container_projects_locations_clusters_node_pools_set_autoscaling(client):
    ...
    """
    body = {"nodePoolId":"nodePoolId","zone":"zone","name":"name","autoscaling":{"locationPolicy":"LOCATION_POLICY_UNSPECIFIED","autoprovisioned":True,"minNodeCount":7,"totalMinNodeCount":4,"maxNodeCount":6,"totalMaxNodeCount":1,"enabled":True},"clusterId":"clusterId","projectId":"projectId"}
    params = [('$.xgafv', 'xgafv_example'),
                    ('access_token', 'access_token_example'),
                    ('alt', 'alt_example'),
                    ('callback', 'param_callback_example'),
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/{nameset_autoscalin}'.format(name='name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_container_projects_locations_clusters_node_pools_set_management(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/{nameset_managemen}'.format(name='name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_container_projects_locations_clusters_node_pools_set_size(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/{nameset_siz}'.format(name='name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_container_projects_locations_clusters_set_addons(client):
    ...
    """
    body = {"addonsConfig":{"configConnectorConfig":{"enabled":True},"gcePersistentDiskCsiDriverConfig":{"enabled":True},"httpLoadBalancing":{"disabled":True},"horizontalPodAutoscaling":{"disabled":True},"dnsCacheConfig":{"enabled":True},"gcsFuseCsiDriverConfig":{"enabled":True},"kubernetesDashboard":{"disabled":True},"istioConfig":{"auth":"AUTH_NONE","disabled":True},"statefulHaConfig":{"enabled":True},"kalmConfig":{"enabled":True},"gkeBackupAgentConfig":{"enabled":True},"cloudRunConfig":{"loadBalancerType":"LOAD_BALANCER_TYPE_UNSPECIFIED","disabled":True},"networkPolicyConfig":{"disabled":True},"gcpFilestoreCsiDriverConfig":{"enabled":True}},"zone":"zone","name":"name","clusterId":"clusterId","projectId":"projectId"}
    params = [('$.xgafv', 'xgafv_example'),
                    ('access_token', 'access_token_example'),
                    ('alt', 'alt_example'),
                    ('callback', 'param_callback_example'),
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/{nameset_addon}'.format(name='name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_container_projects_locations_clusters_set_legacy_abac(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/{nameset_legacy_aba}'.format(name='name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_container_projects_locations_clusters_set_locations(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/{nameset_location}'.format(name='name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_container_projects_locations_clusters_set_logging(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/{nameset_loggin}'.format(name='name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_container_projects_locations_clusters_set_maintenance_policy(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/{nameset_maintenance_polic}'.format(name='name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_container_projects_locations_clusters_set_master_auth(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/{nameset_master_aut}'.format(name='name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_container_projects_locations_clusters_set_monitoring(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/{nameset_monitorin}'.format(name='name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_container_projects_locations_clusters_set_network_policy(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/{nameset_network_polic}'.format(name='name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_container_projects_locations_clusters_set_resource_labels(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/{nameset_resource_label}'.format(name='name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_container_projects_locations_clusters_start_ip_rotation(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/{namestart_ip_rotatio}'.format(name='name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_container_projects_locations_clusters_update_master(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/{nameupdate_maste}'.format(name='name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_container_projects_locations_clusters_well_known_get_openid_configuration(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1beta1/{parent}/.well-known/openid-configuration'.format(parent='parent_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_container_projects_locations_get_server_config(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1beta1/{name}/serverConfig'.format(name='name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_container_projects_locations_list(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1beta1/{parent}/locations'.format(parent='parent_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_container_projects_locations_operations_list(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1beta1/{parent}/operations'.format(parent='parent_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_container_projects_zones_clusters_addons(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/projects/{project_id}/zones/{zone}/clusters/{cluster_id}/addons'.format(project_id='project_id_example', zone='zone_example', cluster_id='cluster_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_container_projects_zones_clusters_complete_ip_rotation(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/projects/{project_id}/zones/{zone}/clusters/{cluster_idcomplete_ip_rotatio}'.format(project_id='project_id_example', zone='zone_example', cluster_id='cluster_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_container_projects_zones_clusters_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/projects/{project_id}/zones/{zone}/clusters'.format(project_id='project_id_example', zone='zone_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_container_projects_zones_clusters_delete(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/v1beta1/projects/{project_id}/zones/{zone}/clusters/{cluster_id}'.format(project_id='project_id_example', zone='zone_example', cluster_id='cluster_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_container_projects_zones_clusters_legacy_abac(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/projects/{project_id}/zones/{zone}/clusters/{cluster_id}/legacyAbac'.format(project_id='project_id_example', zone='zone_example', cluster_id='cluster_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_container_projects_zones_clusters_locations(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/projects/{project_id}/zones/{zone}/clusters/{cluster_id}/locations'.format(project_id='project_id_example', zone='zone_example', cluster_id='cluster_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_container_projects_zones_clusters_logging(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/projects/{project_id}/zones/{zone}/clusters/{cluster_id}/logging'.format(project_id='project_id_example', zone='zone_example', cluster_id='cluster_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_container_projects_zones_clusters_master(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/projects/{project_id}/zones/{zone}/clusters/{cluster_id}/master'.format(project_id='project_id_example', zone='zone_example', cluster_id='cluster_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_container_projects_zones_clusters_monitoring(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/projects/{project_id}/zones/{zone}/clusters/{cluster_id}/monitoring'.format(project_id='project_id_example', zone='zone_example', cluster_id='cluster_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_container_projects_zones_clusters_node_pools_autoscaling(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/projects/{project_id}/zones/{zone}/clusters/{cluster_id}/nodePools/{node_pool_id}/autoscaling'.format(project_id='project_id_example', zone='zone_example', cluster_id='cluster_id_example', node_pool_id='node_pool_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_container_projects_zones_clusters_node_pools_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/projects/{project_id}/zones/{zone}/clusters/{cluster_id}/nodePools'.format(project_id='project_id_example', zone='zone_example', cluster_id='cluster_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_container_projects_zones_clusters_node_pools_delete(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/v1beta1/projects/{project_id}/zones/{zone}/clusters/{cluster_id}/nodePools/{node_pool_id}'.format(project_id='project_id_example', zone='zone_example', cluster_id='cluster_id_example', node_pool_id='node_pool_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_container_projects_zones_clusters_node_pools_rollback(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/projects/{project_id}/zones/{zone}/clusters/{cluster_id}/nodePools/{node_pool_idrollbac}'.format(project_id='project_id_example', zone='zone_example', cluster_id='cluster_id_example', node_pool_id='node_pool_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_container_projects_zones_clusters_node_pools_set_management(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/projects/{project_id}/zones/{zone}/clusters/{cluster_id}/nodePools/{node_pool_id}/setManagement'.format(project_id='project_id_example', zone='zone_example', cluster_id='cluster_id_example', node_pool_id='node_pool_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_container_projects_zones_clusters_node_pools_set_size(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/projects/{project_id}/zones/{zone}/clusters/{cluster_id}/nodePools/{node_pool_id}/setSize'.format(project_id='project_id_example', zone='zone_example', cluster_id='cluster_id_example', node_pool_id='node_pool_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_container_projects_zones_clusters_node_pools_update(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/projects/{project_id}/zones/{zone}/clusters/{cluster_id}/nodePools/{node_pool_id}/update'.format(project_id='project_id_example', zone='zone_example', cluster_id='cluster_id_example', node_pool_id='node_pool_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_container_projects_zones_clusters_resource_labels(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/projects/{project_id}/zones/{zone}/clusters/{cluster_id}/resourceLabels'.format(project_id='project_id_example', zone='zone_example', cluster_id='cluster_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_container_projects_zones_clusters_set_maintenance_policy(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/projects/{project_id}/zones/{zone}/clusters/{cluster_idset_maintenance_polic}'.format(project_id='project_id_example', zone='zone_example', cluster_id='cluster_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_container_projects_zones_clusters_set_master_auth(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/projects/{project_id}/zones/{zone}/clusters/{cluster_idset_master_aut}'.format(project_id='project_id_example', zone='zone_example', cluster_id='cluster_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_container_projects_zones_clusters_set_network_policy(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/projects/{project_id}/zones/{zone}/clusters/{cluster_idset_network_polic}'.format(project_id='project_id_example', zone='zone_example', cluster_id='cluster_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_container_projects_zones_clusters_start_ip_rotation(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/projects/{project_id}/zones/{zone}/clusters/{cluster_idstart_ip_rotatio}'.format(project_id='project_id_example', zone='zone_example', cluster_id='cluster_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_container_projects_zones_get_serverconfig(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1beta1/projects/{project_id}/zones/{zone}/serverconfig'.format(project_id='project_id_example', zone='zone_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_container_projects_zones_operations_cancel(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/projects/{project_id}/zones/{zone}/operations/{operation_idcance}'.format(project_id='project_id_example', zone='zone_example', operation_id='operation_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_container_projects_zones_operations_get(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1beta1/projects/{project_id}/zones/{zone}/operations/{operation_id}'.format(project_id='project_id_example', zone='zone_example', operation_id='operation_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_container_projects_zones_operations_list(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1beta1/projects/{project_id}/zones/{zone}/operations'.format(project_id='project_id_example', zone='zone_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
