...
from openapi_server.models.available_version import AvailableVersion
...
class ReleaseChannelConfig(Model):
    ...
    def __init__(self, available_versions: List[AvailableVersion]=None, channel: str=None, default_version: str=None, valid_versions: List[str]=None):
        """ReleaseChannelConfig - a model defined in OpenAPI

        :param available_versions: The available_versions of this ReleaseChannelConfig.
    ...
    def available_versions(self):
        """Gets the available_versions of this ReleaseChannelConfig.

        Deprecated. This field has been deprecated and replaced with the valid_versions field.

        :return: The available_versions of this ReleaseChannelConfig.
    ...
    def available_versions(self, available_versions):
        """Sets the available_versions of this ReleaseChannelConfig.

        Deprecated. This field has been deprecated and replaced with the valid_versions field.

        :param available_versions: The available_versions of this ReleaseChannelConfig.
        :type available_versions: List[AvailableVersion]
        """
