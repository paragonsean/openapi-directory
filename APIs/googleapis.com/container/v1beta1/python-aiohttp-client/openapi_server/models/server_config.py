...
class ServerConfig(Model):
    ...
    def __init__(self, channels: List[ReleaseChannelConfig]=None, default_cluster_version: str=None, default_image_type: str=None, valid_image_types: List[str]=None, valid_master_versions: List[str]=None, valid_node_versions: List[str]=None, windows_version_maps: Dict[str, WindowsVersions]=None):
        ...
        :param windows_version_maps: The windows_version_maps of this ServerConfig.
        """
        self.openapi_types = {
            ...
            'windows_version_maps': Dict[str, WindowsVersions]
        }
        ...
        self.attribute_map = {
            ...
            'windows_version_maps': 'windowsVersionMaps'
        }
        ...
        self._windows_version_maps = windows_version_maps
    ...
    @property
    def windows_version_maps(self):
        """Gets the windows_version_maps of this ServerConfig.

        Maps of Kubernetes version and supported Windows server versions.

        :return: The windows_version_maps of this ServerConfig.
        :rtype: Dict[str, WindowsVersions]
        """
        return self._windows_version_maps

    @windows_version_maps.setter
    def windows_version_maps(self, windows_version_maps):
        """Sets the windows_version_maps of this ServerConfig.

        Maps of Kubernetes version and supported Windows server versions.

        :param windows_version_maps: The windows_version_maps of this ServerConfig.
        :type windows_version_maps: Dict[str, WindowsVersions]
        """
