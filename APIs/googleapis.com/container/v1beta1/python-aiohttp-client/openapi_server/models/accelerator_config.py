...
class AcceleratorConfig(Model):
    ...
    def __init__(self, accelerator_count: str=None, accelerator_type: str=None, gpu_driver_installation_config: GPUDriverInstallationConfig=None, gpu_partition_size: str=None, gpu_sharing_config: GPUSharingConfig=None, max_time_shared_clients_per_gpu: str=None):
        ...
        :param max_time_shared_clients_per_gpu: The max_time_shared_clients_per_gpu of this AcceleratorConfig.
        """
        self.openapi_types = {
        ...
        self.attribute_map = {
            ...
            'gpu_sharing_config': 'gpuSharingConfig',
            'max_time_shared_clients_per_gpu': 'maxTimeSharedClientsPerGpu'
        }
        ...
        self._max_time_shared_clients_per_gpu = max_time_shared_clients_per_gpu
    ...
    @property
    def max_time_shared_clients_per_gpu(self):
        """Gets the max_time_shared_clients_per_gpu of this AcceleratorConfig.

        The number of time-shared GPU resources to expose for each physical GPU.

        :return: The max_time_shared_clients_per_gpu of this AcceleratorConfig.
        :rtype: str
        """
        return self._max_time_shared_clients_per_gpu

    @max_time_shared_clients_per_gpu.setter
    def max_time_shared_clients_per_gpu(self, max_time_shared_clients_per_gpu):
        """Sets the max_time_shared_clients_per_gpu of this AcceleratorConfig.

        The number of time-shared GPU resources to expose for each physical GPU.

        :param max_time_shared_clients_per_gpu: The max_time_shared_clients_per_gpu of this AcceleratorConfig.
        :type max_time_shared_clients_per_gpu: str
        """
