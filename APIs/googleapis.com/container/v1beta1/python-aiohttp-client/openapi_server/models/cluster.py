...
class Cluster(Model):
    ...
    def __init__(self, addons_config: AddonsConfig=None, authenticator_groups_config: AuthenticatorGroupsConfig=None, autopilot: Autopilot=None, autoscaling: ClusterAutoscaling=None, binary_authorization: BinaryAuthorization=None, cluster_ipv4_cidr: str=None, cluster_telemetry: ClusterTelemetry=None, conditions: List[StatusCondition]=None, confidential_nodes: ConfidentialNodes=None, cost_management_config: CostManagementConfig=None, create_time: str=None, current_master_version: str=None, current_node_count: int=None, current_node_version: str=None, database_encryption: DatabaseEncryption=None, default_max_pods_constraint: MaxPodsConstraint=None, description: str=None, enable_k8s_beta_apis: K8sBetaAPIConfig=None, enable_kubernetes_alpha: bool=None, enable_tpu: bool=None, endpoint: str=None, enterprise_config: EnterpriseConfig=None, etag: str=None, expire_time: str=None, fleet: Fleet=None, id: str=None, identity_service_config: IdentityServiceConfig=None, initial_cluster_version: str=None, initial_node_count: int=None, instance_group_urls: List[str]=None, ip_allocation_policy: IPAllocationPolicy=None, label_fingerprint: str=None, legacy_abac: LegacyAbac=None, location: str=None, locations: List[str]=None, logging_config: LoggingConfig=None, logging_service: str=None, maintenance_policy: MaintenancePolicy=None, master: object=None, master_auth: MasterAuth=None, master_authorized_networks_config: MasterAuthorizedNetworksConfig=None, master_ipv4_cidr_block: str=None, mesh_certificates: MeshCertificates=None, monitoring_config: MonitoringConfig=None, monitoring_service: str=None, name: str=None, network: str=None, network_config: NetworkConfig=None, network_policy: NetworkPolicy=None, node_config: NodeConfig=None, node_ipv4_cidr_size: int=None, node_pool_auto_config: NodePoolAutoConfig=None, node_pool_defaults: NodePoolDefaults=None, node_pools: List[NodePool]=None, notification_config: NotificationConfig=None, parent_product_config: ParentProductConfig=None, pod_security_policy_config: PodSecurityPolicyConfig=None, private_cluster: bool=None, private_cluster_config: PrivateClusterConfig=None, protect_config: ProtectConfig=None, release_channel: ReleaseChannel=None, resource_labels: Dict[str, str]=None, resource_usage_export_config: ResourceUsageExportConfig=None, security_posture_config: SecurityPostureConfig=None, self_link: str=None, services_ipv4_cidr: str=None, shielded_nodes: ShieldedNodes=None, status: str=None, status_message: str=None, subnetwork: str=None, tpu_config: TpuConfig=None, tpu_ipv4_cidr_block: str=None, vertical_pod_autoscaling: VerticalPodAutoscaling=None, workload_alts_config: WorkloadALTSConfig=None, workload_certificates: WorkloadCertificates=None, workload_identity_config: WorkloadIdentityConfig=None, zone: str=None):
        ...
        :param cluster_telemetry: The cluster_telemetry of this Cluster.
        ...
        :param master_ipv4_cidr_block: The master_ipv4_cidr_block of this Cluster.
        ...
        :param pod_security_policy_config: The pod_security_policy_config of this Cluster.
        :param private_cluster: The private_cluster of this Cluster.
        :param private_cluster_config: The private_cluster_config of this Cluster.
        :param protect_config: The protect_config of this Cluster.
        ...
        :param tpu_config: The tpu_config of this Cluster.
        ...
        :param workload_alts_config: The workload_alts_config of this Cluster.
        :param workload_certificates: The workload_certificates of this Cluster.
        ...
        self._cluster_telemetry = cluster_telemetry
        ...
        self._pod_security_policy_config = pod_security_policy_config
        self._private_cluster = private_cluster
        ...
        self._tpu_config = tpu_config
        self._tpu_ipv4_cidr_block = tpu_ipv4_cidr_block
        self._vertical_pod_autoscaling = vertical_pod_autoscaling
        self._workload_alts_config = workload_alts_config
        self._workload_certificates = workload_certificates
    ...
    @property
    def cluster_telemetry(self):
        """Gets the cluster_telemetry of this Cluster.


        :return: The cluster_telemetry of this Cluster.
        :rtype: ClusterTelemetry
        """
        return self._cluster_telemetry

    @cluster_telemetry.setter
    def cluster_telemetry(self, cluster_telemetry):
        """Sets the cluster_telemetry of this Cluster.


        :param cluster_telemetry: The cluster_telemetry of this Cluster.
        :type cluster_telemetry: ClusterTelemetry
        """
    ...
    def master_ipv4_cidr_block(self):
        """Gets the master_ipv4_cidr_block of this Cluster.
        ...
        :return: The master_ipv4_cidr_block of this Cluster.
        :rtype: str
        """
    ...
    def master_ipv4_cidr_block(self, master_ipv4_cidr_block):
        """Sets the master_ipv4_cidr_block of this Cluster.
    ...
    @property
    def pod_security_policy_config(self):
        """Gets the pod_security_policy_config of this Cluster.


        :return: The pod_security_policy_config of this Cluster.
        :rtype: PodSecurityPolicyConfig
        """
        return self._pod_security_policy_config

    @pod_security_policy_config.setter
    def pod_security_policy_config(self, pod_security_policy_config):
        """Sets the pod_security_policy_config of this Cluster.


        :param pod_security_policy_config: The pod_security_policy_config of this Cluster.
        :type pod_security_policy_config: PodSecurityPolicyConfig
        """

        self._pod_security_policy_config = pod_security_policy_config

    @property
    def private_cluster(self):
        """Gets the private_cluster of this Cluster.
        ...
        :return: The private_cluster of this Cluster.
        :rtype: bool
        """
        return self._private_cluster

    @private_cluster.setter
    def private_cluster(self, private_cluster):
        """Sets the private_cluster of this Cluster.

        If this is a private cluster setup. Private clusters are clusters that, by default have no external IP addresses on the nodes and where nodes and the master communicate over private IP addresses. This field is deprecated, use private_cluster_config.enable_private_nodes instead.

        :param private_cluster: The private_cluster of this Cluster.
        :type private_cluster: bool
        """
    ...
    @property
    def protect_config(self):
        """Gets the protect_config of this Cluster.


        :return: The protect_config of this Cluster.
        :rtype: ProtectConfig
        """
        return self._protect_config

    @protect_config.setter
    def protect_config(self, protect_config):
        """Sets the protect_config of this Cluster.


        :param protect_config: The protect_config of this Cluster.
        :type protect_config: ProtectConfig
        """
    ...
    @property
    def tpu_config(self):
        """Gets the tpu_config of this Cluster.


        :return: The tpu_config of this Cluster.
        :rtype: TpuConfig
        """
        return self._tpu_config

    @tpu_config.setter
    def tpu_config(self, tpu_config):
        """Sets the tpu_config of this Cluster.


        :param tpu_config: The tpu_config of this Cluster.
        :type tpu_config: TpuConfig
        """
    ...
    @property
    def workload_alts_config(self):
        """Gets the workload_alts_config of this Cluster.


        :return: The workload_alts_config of this Cluster.
        :rtype: WorkloadALTSConfig
        """
        return self._workload_alts_config

    @workload_alts_config.setter
    def workload_alts_config(self, workload_alts_config):
        """Sets the workload_alts_config of this Cluster.


        :param workload_alts_config: The workload_alts_config of this Cluster.
        :type workload_alts_config: WorkloadALTSConfig
        """

        self._workload_alts_config = workload_alts_config

    @property
    def workload_certificates(self):
        """Gets the workload_certificates of this Cluster.


        :return: The workload_certificates of this Cluster.
        :rtype: WorkloadCertificates
        """
        return self._workload_certificates

    @workload_certificates.setter
    def workload_certificates(self, workload_certificates):
        """Sets the workload_certificates of this Cluster.


        :param workload_certificates: The workload_certificates of this Cluster.
        :type workload_certificates: WorkloadCertificates
        """
