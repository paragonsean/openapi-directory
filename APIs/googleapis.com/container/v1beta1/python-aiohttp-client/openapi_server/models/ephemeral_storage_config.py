...
class EphemeralStorageConfig(Model):
    ...
    def __init__(self, local_ssd_count: int=None):
        """EphemeralStorageConfig - a model defined in OpenAPI

        :param local_ssd_count: The local_ssd_count of this EphemeralStorageConfig.
        """
        self.openapi_types = {
            'local_ssd_count': int
        }
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'EphemeralStorageConfig':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The EphemeralStorageConfig of this EphemeralStorageConfig.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def local_ssd_count(self):
        """Gets the local_ssd_count of this EphemeralStorageConfig.
        ...
        :return: The local_ssd_count of this EphemeralStorageConfig.
        :rtype: int
        """
    ...
    def local_ssd_count(self, local_ssd_count):
        """Sets the local_ssd_count of this EphemeralStorageConfig.
