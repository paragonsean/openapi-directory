...
public class IPAllocationPolicy {
  ...
  public static final String SERIALIZED_NAME_ALLOW_ROUTE_OVERLAP = "allowRouteOverlap";
  @SerializedName(SERIALIZED_NAME_ALLOW_ROUTE_OVERLAP)
  ...
  public IPAllocationPolicy allowRouteOverlap(Boolean allowRouteOverlap) {
  ...
  public void setAllowRouteOverlap(Boolean allowRouteOverlap) {
    this.allowRouteOverlap = allowRouteOverlap;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.additionalPodRangesConfig, ipAllocationPolicy.additionalPodRangesConfig) &&
        Objects.equals(this.allowRouteOverlap, ipAllocationPolicy.allowRouteOverlap) &&
  ...
  public String toString() {
    ...
    sb.append("    allowRouteOverlap: ").append(toIndentedString(allowRouteOverlap)).append("\n");
  ...
  static {
    ...
    openapiFields.add("allowRouteOverlap");
