...
import org.openapitools.client.model.PubSub;
...
public class NotificationConfig {
  public static final String SERIALIZED_NAME_PUBSUB = "pubsub";
  @SerializedName(SERIALIZED_NAME_PUBSUB)
  private PubSub pubsub;

  public NotificationConfig() {
  }

  public NotificationConfig pubsub(PubSub pubsub) {
    this.pubsub = pubsub;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pubsub, notificationConfig.pubsub);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pubsub);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("pubsub") != null && !jsonObj.get("pubsub").isJsonNull()) {
        PubSub.validateJsonElement(jsonObj.get("pubsub"));
      }
  }
