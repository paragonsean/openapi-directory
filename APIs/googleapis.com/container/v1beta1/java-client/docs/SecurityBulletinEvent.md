...
|------------ | ------------- | ------------- | -------------|
|**affectedSupportedMinors** | **List&lt;String&gt;** | The GKE minor versions affected by this vulnerability. |  [optional] |
...
|**cveIds** | **List&lt;String&gt;** | The CVEs associated with this bulletin. |  [optional] |
...
|**patchedVersions** | **List&lt;String&gt;** | The GKE versions where this vulnerability is patched. |  [optional] |
