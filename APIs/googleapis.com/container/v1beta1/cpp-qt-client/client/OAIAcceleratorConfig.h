...
public:
    ...
    Q_DECL_DEPRECATED QString getMaxTimeSharedClientsPerGpu() const;
    Q_DECL_DEPRECATED void setMaxTimeSharedClientsPerGpu(const QString &max_time_shared_clients_per_gpu);
    Q_DECL_DEPRECATED bool is_max_time_shared_clients_per_gpu_Set() const;
    Q_DECL_DEPRECATED bool is_max_time_shared_clients_per_gpu_Valid() const;
...
private:
    ...
    QString m_max_time_shared_clients_per_gpu;
    bool m_max_time_shared_clients_per_gpu_isSet;
    bool m_max_time_shared_clients_per_gpu_isValid;
};
