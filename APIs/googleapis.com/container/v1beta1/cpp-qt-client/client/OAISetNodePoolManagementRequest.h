...
/*
 * OAISetNodePoolManagementRequest.h
 *
 * SetNodePoolManagementRequest sets the node management properties of a node pool.
 */

#ifndef OAISetNodePoolManagementRequest_H
#define OAISetNodePoolManagementRequest_H
...
class OAISetNodePoolManagementRequest : public OAIObject {
public:
    OAISetNodePoolManagementRequest();
    OAISetNodePoolManagementRequest(QString json);
    ~OAISetNodePoolManagementRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISetNodePoolManagementRequest)

#endif // OAISetNodePoolManagementRequest_H
