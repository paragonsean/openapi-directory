...
void OAINodeConfig::initializeModel() {
    ...
    m_ephemeral_storage_config_isSet = false;
    m_ephemeral_storage_config_isValid = false;
...
void OAINodeConfig::fromJsonObject(QJsonObject json) {
    ...
    m_ephemeral_storage_config_isValid = ::OpenAPI::fromJsonValue(m_ephemeral_storage_config, json[QString("ephemeralStorageConfig")]);
    m_ephemeral_storage_config_isSet = !json[QString("ephemeralStorageConfig")].isNull() && m_ephemeral_storage_config_isValid;
...
QJsonObject OAINodeConfig::asJsonObject() const {
    ...
    if (m_ephemeral_storage_config.isSet()) {
        obj.insert(QString("ephemeralStorageConfig"), ::OpenAPI::toJsonValue(m_ephemeral_storage_config));
    }
...
OAIEphemeralStorageConfig OAINodeConfig::getEphemeralStorageConfig() const {
    return m_ephemeral_storage_config;
}
void OAINodeConfig::setEphemeralStorageConfig(const OAIEphemeralStorageConfig &ephemeral_storage_config) {
    m_ephemeral_storage_config = ephemeral_storage_config;
    m_ephemeral_storage_config_isSet = true;
}

bool OAINodeConfig::is_ephemeral_storage_config_Set() const{
    return m_ephemeral_storage_config_isSet;
}

bool OAINodeConfig::is_ephemeral_storage_config_Valid() const{
    return m_ephemeral_storage_config_isValid;
}
...
OAIHostMaintenancePolicy OAINodeConfig::getHostMaintenancePolicy() const {
    return m_host_maintenance_policy;
}
void OAINodeConfig::setHostMaintenancePolicy(const OAIHostMaintenancePolicy &host_maintenance_policy) {
    m_host_maintenance_policy = host_maintenance_policy;
    m_host_maintenance_policy_isSet = true;
}

bool OAINodeConfig::is_host_maintenance_policy_Set() const{
    return m_host_maintenance_policy_isSet;
}

bool OAINodeConfig::is_host_maintenance_policy_Valid() const{
