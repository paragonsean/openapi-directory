...
void OAIIPAllocationPolicy::initializeModel() {
    ...
    m_allow_route_overlap_isSet = false;
    m_allow_route_overlap_isValid = false;
...
void OAIIPAllocationPolicy::fromJsonObject(QJsonObject json) {
    ...
    m_allow_route_overlap_isValid = ::OpenAPI::fromJsonValue(m_allow_route_overlap, json[QString("allowRouteOverlap")]);
    m_allow_route_overlap_isSet = !json[QString("allowRouteOverlap")].isNull() && m_allow_route_overlap_isValid;
...
QJsonObject OAIIPAllocationPolicy::asJsonObject() const {
    ...
    if (m_allow_route_overlap_isSet) {
        obj.insert(QString("allowRouteOverlap"), ::OpenAPI::toJsonValue(m_allow_route_overlap));
    }
...
bool OAIIPAllocationPolicy::isAllowRouteOverlap() const {
    return m_allow_route_overlap;
}
void OAIIPAllocationPolicy::setAllowRouteOverlap(const bool &allow_route_overlap) {
    m_allow_route_overlap = allow_route_overlap;
    m_allow_route_overlap_isSet = true;
}

bool OAIIPAllocationPolicy::is_allow_route_overlap_Set() const{
    return m_allow_route_overlap_isSet;
}

bool OAIIPAllocationPolicy::is_allow_route_overlap_Valid() const{
    return m_allow_route_overlap_isValid;
}
