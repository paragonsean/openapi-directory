...
void OAIBlueGreenSettings::initializeModel() {
    ...
    m_autoscaled_rollout_policy_isSet = false;
    m_autoscaled_rollout_policy_isValid = false;
...
void OAIBlueGreenSettings::fromJsonObject(QJsonObject json) {
    ...
    m_autoscaled_rollout_policy_isValid = ::OpenAPI::fromJsonValue(m_autoscaled_rollout_policy, json[QString("autoscaledRolloutPolicy")]);
    m_autoscaled_rollout_policy_isSet = !json[QString("autoscaledRolloutPolicy")].isNull() && m_autoscaled_rollout_policy_isValid;
...
QJsonObject OAIBlueGreenSettings::asJsonObject() const {
    QJsonObject obj;
    if (m_autoscaled_rollout_policy_isSet) {
        obj.insert(QString("autoscaledRolloutPolicy"), ::OpenAPI::toJsonValue(m_autoscaled_rollout_policy));
    }
...
OAIObject OAIBlueGreenSettings::getAutoscaledRolloutPolicy() const {
    return m_autoscaled_rollout_policy;
}
void OAIBlueGreenSettings::setAutoscaledRolloutPolicy(const OAIObject &autoscaled_rollout_policy) {
    m_autoscaled_rollout_policy = autoscaled_rollout_policy;
    m_autoscaled_rollout_policy_isSet = true;
}

bool OAIBlueGreenSettings::is_autoscaled_rollout_policy_Set() const{
    return m_autoscaled_rollout_policy_isSet;
}

bool OAIBlueGreenSettings::is_autoscaled_rollout_policy_Valid() const{
    return m_autoscaled_rollout_policy_isValid;
}
