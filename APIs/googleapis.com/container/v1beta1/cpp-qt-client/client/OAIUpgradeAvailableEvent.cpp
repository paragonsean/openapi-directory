...
OAIWindowsVersions OAIUpgradeAvailableEvent::getWindowsVersions() const {
    return m_windows_versions;
}
void OAIUpgradeAvailableEvent::setWindowsVersions(const OAIWindowsVersions &windows_versions) {
    m_windows_versions = windows_versions;
    m_windows_versions_isSet = true;
}

bool OAIUpgradeAvailableEvent::is_windows_versions_Set() const{
    return m_windows_versions_isSet;
}

bool OAIUpgradeAvailableEvent::is_windows_versions_Valid() const{
