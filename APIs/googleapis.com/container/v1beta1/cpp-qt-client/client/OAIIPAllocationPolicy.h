...
public:
    ...
    bool isAllowRouteOverlap() const;
    void setAllowRouteOverlap(const bool &allow_route_overlap);
    bool is_allow_route_overlap_Set() const;
    bool is_allow_route_overlap_Valid() const;
...
private:
    ...
    bool m_allow_route_overlap;
    bool m_allow_route_overlap_isSet;
    bool m_allow_route_overlap_isValid;
