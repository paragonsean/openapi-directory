...
void OAICluster::initializeModel() {
    ...
    m_cluster_telemetry_isSet = false;
    m_cluster_telemetry_isValid = false;
    ...
    m_pod_security_policy_config_isSet = false;
    m_pod_security_policy_config_isValid = false;

    m_private_cluster_isSet = false;
    m_private_cluster_isValid = false;

    m_private_cluster_config_isSet = false;
    m_private_cluster_config_isValid = false;

    m_protect_config_isSet = false;
    m_protect_config_isValid = false;
    ...
    m_tpu_config_isSet = false;
    m_tpu_config_isValid = false;
    ...
    m_workload_alts_config_isSet = false;
    m_workload_alts_config_isValid = false;

    m_workload_certificates_isSet = false;
    m_workload_certificates_isValid = false;
...
void OAICluster::fromJsonObject(QJsonObject json) {
    ...
    m_cluster_telemetry_isValid = ::OpenAPI::fromJsonValue(m_cluster_telemetry, json[QString("clusterTelemetry")]);
    m_cluster_telemetry_isSet = !json[QString("clusterTelemetry")].isNull() && m_cluster_telemetry_isValid;
    ...
    m_pod_security_policy_config_isValid = ::OpenAPI::fromJsonValue(m_pod_security_policy_config, json[QString("podSecurityPolicyConfig")]);
    m_pod_security_policy_config_isSet = !json[QString("podSecurityPolicyConfig")].isNull() && m_pod_security_policy_config_isValid;

    m_private_cluster_isValid = ::OpenAPI::fromJsonValue(m_private_cluster, json[QString("privateCluster")]);
    m_private_cluster_isSet = !json[QString("privateCluster")].isNull() && m_private_cluster_isValid;
    ...
    m_protect_config_isValid = ::OpenAPI::fromJsonValue(m_protect_config, json[QString("protectConfig")]);
    m_protect_config_isSet = !json[QString("protectConfig")].isNull() && m_protect_config_isValid;
    ...
    m_tpu_config_isValid = ::OpenAPI::fromJsonValue(m_tpu_config, json[QString("tpuConfig")]);
    m_tpu_config_isSet = !json[QString("tpuConfig")].isNull() && m_tpu_config_isValid;
    ...
    m_workload_alts_config_isValid = ::OpenAPI::fromJsonValue(m_workload_alts_config, json[QString("workloadAltsConfig")]);
    m_workload_alts_config_isSet = !json[QString("workloadAltsConfig")].isNull() && m_workload_alts_config_isValid;

    m_workload_certificates_isValid = ::OpenAPI::fromJsonValue(m_workload_certificates, json[QString("workloadCertificates")]);
    m_workload_certificates_isSet = !json[QString("workloadCertificates")].isNull() && m_workload_certificates_isValid;
...
QJsonObject OAICluster::asJsonObject() const {
    ...
    if (m_cluster_telemetry.isSet()) {
        obj.insert(QString("clusterTelemetry"), ::OpenAPI::toJsonValue(m_cluster_telemetry));
    }
    ...
    if (m_pod_security_policy_config.isSet()) {
        obj.insert(QString("podSecurityPolicyConfig"), ::OpenAPI::toJsonValue(m_pod_security_policy_config));
    }
    if (m_private_cluster_isSet) {
        obj.insert(QString("privateCluster"), ::OpenAPI::toJsonValue(m_private_cluster));
    }
    if (m_private_cluster_config.isSet()) {
        obj.insert(QString("privateClusterConfig"), ::OpenAPI::toJsonValue(m_private_cluster_config));
    }
    if (m_protect_config.isSet()) {
        obj.insert(QString("protectConfig"), ::OpenAPI::toJsonValue(m_protect_config));
    }
    ...
    if (m_tpu_config.isSet()) {
        obj.insert(QString("tpuConfig"), ::OpenAPI::toJsonValue(m_tpu_config));
    }
    ...
    if (m_workload_alts_config.isSet()) {
        obj.insert(QString("workloadAltsConfig"), ::OpenAPI::toJsonValue(m_workload_alts_config));
    }
    if (m_workload_certificates.isSet()) {
        obj.insert(QString("workloadCertificates"), ::OpenAPI::toJsonValue(m_workload_certificates));
    }
...
OAIClusterTelemetry OAICluster::getClusterTelemetry() const {
    return m_cluster_telemetry;
}
void OAICluster::setClusterTelemetry(const OAIClusterTelemetry &cluster_telemetry) {
    m_cluster_telemetry = cluster_telemetry;
    m_cluster_telemetry_isSet = true;
}

bool OAICluster::is_cluster_telemetry_Set() const{
    return m_cluster_telemetry_isSet;
}

bool OAICluster::is_cluster_telemetry_Valid() const{
    return m_cluster_telemetry_isValid;
}
...
OAIObject OAICluster::getMaster() const {
    return m_master;
}
void OAICluster::setMaster(const OAIObject &master) {
    m_master = master;
    m_master_isSet = true;
}

bool OAICluster::is_master_Set() const{
    return m_master_isSet;
}

bool OAICluster::is_master_Valid() const{
...
QString OAICluster::getMasterIpv4CidrBlock() const {
    return m_master_ipv4_cidr_block;
}
void OAICluster::setMasterIpv4CidrBlock(const QString &master_ipv4_cidr_block) {
    m_master_ipv4_cidr_block = master_ipv4_cidr_block;
    m_master_ipv4_cidr_block_isSet = true;
}

bool OAICluster::is_master_ipv4_cidr_block_Set() const{
    return m_master_ipv4_cidr_block_isSet;
}

bool OAICluster::is_master_ipv4_cidr_block_Valid() const{
...
OAIPodSecurityPolicyConfig OAICluster::getPodSecurityPolicyConfig() const {
    return m_pod_security_policy_config;
}
void OAICluster::setPodSecurityPolicyConfig(const OAIPodSecurityPolicyConfig &pod_security_policy_config) {
    m_pod_security_policy_config = pod_security_policy_config;
    m_pod_security_policy_config_isSet = true;
}

bool OAICluster::is_pod_security_policy_config_Set() const{
    return m_pod_security_policy_config_isSet;
}

bool OAICluster::is_pod_security_policy_config_Valid() const{
    return m_pod_security_policy_config_isValid;
}

bool OAICluster::isPrivateCluster() const {
    return m_private_cluster;
}
void OAICluster::setPrivateCluster(const bool &private_cluster) {
    m_private_cluster = private_cluster;
    m_private_cluster_isSet = true;
}

bool OAICluster::is_private_cluster_Set() const{
    return m_private_cluster_isSet;
}

bool OAICluster::is_private_cluster_Valid() const{
    return m_private_cluster_isValid;
}
...
OAIProtectConfig OAICluster::getProtectConfig() const {
    return m_protect_config;
}
void OAICluster::setProtectConfig(const OAIProtectConfig &protect_config) {
    m_protect_config = protect_config;
    m_protect_config_isSet = true;
}

bool OAICluster::is_protect_config_Set() const{
    return m_protect_config_isSet;
}

bool OAICluster::is_protect_config_Valid() const{
    return m_protect_config_isValid;
}
...
OAITpuConfig OAICluster::getTpuConfig() const {
    return m_tpu_config;
}
void OAICluster::setTpuConfig(const OAITpuConfig &tpu_config) {
    m_tpu_config = tpu_config;
    m_tpu_config_isSet = true;
}

bool OAICluster::is_tpu_config_Set() const{
    return m_tpu_config_isSet;
}

bool OAICluster::is_tpu_config_Valid() const{
    return m_tpu_config_isValid;
}
...
OAIWorkloadALTSConfig OAICluster::getWorkloadAltsConfig() const {
    return m_workload_alts_config;
}
void OAICluster::setWorkloadAltsConfig(const OAIWorkloadALTSConfig &workload_alts_config) {
    m_workload_alts_config = workload_alts_config;
    m_workload_alts_config_isSet = true;
}

bool OAICluster::is_workload_alts_config_Set() const{
    return m_workload_alts_config_isSet;
}

bool OAICluster::is_workload_alts_config_Valid() const{
    return m_workload_alts_config_isValid;
}

OAIWorkloadCertificates OAICluster::getWorkloadCertificates() const {
    return m_workload_certificates;
}
void OAICluster::setWorkloadCertificates(const OAIWorkloadCertificates &workload_certificates) {
    m_workload_certificates = workload_certificates;
    m_workload_certificates_isSet = true;
}

bool OAICluster::is_workload_certificates_Set() const{
    return m_workload_certificates_isSet;
}

bool OAICluster::is_workload_certificates_Valid() const{
    return m_workload_certificates_isValid;
}
