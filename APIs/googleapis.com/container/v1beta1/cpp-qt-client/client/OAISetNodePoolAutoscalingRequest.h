...
/*
 * OAISetNodePoolAutoscalingRequest.h
 *
 * SetNodePoolAutoscalingRequest sets the autoscaler settings of a node pool.
 */

#ifndef OAISetNodePoolAutoscalingRequest_H
#define OAISetNodePoolAutoscalingRequest_H
...
class OAISetNodePoolAutoscalingRequest : public OAIObject {
public:
    OAISetNodePoolAutoscalingRequest();
    OAISetNodePoolAutoscalingRequest(QString json);
    ~OAISetNodePoolAutoscalingRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISetNodePoolAutoscalingRequest)

#endif // OAISetNodePoolAutoscalingRequest_H
