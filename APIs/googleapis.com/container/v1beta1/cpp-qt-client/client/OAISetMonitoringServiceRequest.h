...
/*
 * OAISetMonitoringServiceRequest.h
 *
 * SetMonitoringServiceRequest sets the monitoring service of a cluster.
 */

#ifndef OAISetMonitoringServiceRequest_H
#define OAISetMonitoringServiceRequest_H
...
class OAISetMonitoringServiceRequest : public OAIObject {
public:
    OAISetMonitoringServiceRequest();
    OAISetMonitoringServiceRequest(QString json);
    ~OAISetMonitoringServiceRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISetMonitoringServiceRequest)

#endif // OAISetMonitoringServiceRequest_H
