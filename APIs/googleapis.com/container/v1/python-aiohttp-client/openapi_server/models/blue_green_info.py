...
class BlueGreenInfo(Model):
    ...
    def phase(self, phase):
        ...
        :type phase: str
        """
        allowed_values = ["PHASE_UNSPECIFIED", "UPDATE_STARTED", "CREATING_GREEN_POOL", "CORDONING_BLUE_POOL", "DRAINING_BLUE_POOL", "NODE_POOL_SOAKING", "DELETING_BLUE_POOL", "ROLLBACK_STARTED"]  # noqa: E501
