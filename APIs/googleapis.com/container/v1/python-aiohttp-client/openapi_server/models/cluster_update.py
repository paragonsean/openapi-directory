...
class ClusterUpdate(Model):
    ...
    def __init__(self, additional_pod_ranges_config: AdditionalPodRangesConfig=None, desired_addons_config: AddonsConfig=None, desired_authenticator_groups_config: AuthenticatorGroupsConfig=None, desired_autopilot_workload_policy_config: WorkloadPolicyConfig=None, desired_binary_authorization: BinaryAuthorization=None, desired_cluster_autoscaling: ClusterAutoscaling=None, desired_cost_management_config: CostManagementConfig=None, desired_database_encryption: DatabaseEncryption=None, desired_datapath_provider: str=None, desired_default_snat_status: DefaultSnatStatus=None, desired_dns_config: DNSConfig=None, desired_enable_fqdn_network_policy: bool=None, desired_enable_private_endpoint: bool=None, desired_fleet: Fleet=None, desired_gateway_api_config: GatewayAPIConfig=None, desired_gcfs_config: GcfsConfig=None, desired_identity_service_config: IdentityServiceConfig=None, desired_image_type: str=None, desired_in_transit_encryption_config: str=None, desired_intra_node_visibility_config: IntraNodeVisibilityConfig=None, desired_k8s_beta_apis: K8sBetaAPIConfig=None, desired_l4ilb_subsetting_config: ILBSubsettingConfig=None, desired_locations: List[str]=None, desired_logging_config: LoggingConfig=None, desired_logging_service: str=None, desired_master_authorized_networks_config: MasterAuthorizedNetworksConfig=None, desired_master_version: str=None, desired_mesh_certificates: MeshCertificates=None, desired_monitoring_config: MonitoringConfig=None, desired_monitoring_service: str=None, desired_network_performance_config: ClusterNetworkPerformanceConfig=None, desired_node_pool_auto_config_network_tags: NetworkTags=None, desired_node_pool_auto_config_resource_manager_tags: ResourceManagerTags=None, desired_node_pool_autoscaling: NodePoolAutoscaling=None, desired_node_pool_id: str=None, desired_node_pool_logging_config: NodePoolLoggingConfig=None, desired_node_version: str=None, desired_notification_config: NotificationConfig=None, desired_parent_product_config: ParentProductConfig=None, desired_private_cluster_config: PrivateClusterConfig=None, desired_private_ipv6_google_access: str=None, desired_release_channel: ReleaseChannel=None, desired_resource_usage_export_config: ResourceUsageExportConfig=None, desired_security_posture_config: SecurityPostureConfig=None, desired_service_external_ips_config: ServiceExternalIPsConfig=None, desired_shielded_nodes: ShieldedNodes=None, desired_stack_type: str=None, desired_vertical_pod_autoscaling: VerticalPodAutoscaling=None, desired_workload_identity_config: WorkloadIdentityConfig=None, enable_k8s_beta_apis: K8sBetaAPIConfig=None, etag: str=None, removed_additional_pod_ranges_config: AdditionalPodRangesConfig=None):
