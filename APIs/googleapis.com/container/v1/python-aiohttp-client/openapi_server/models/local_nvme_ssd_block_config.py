...
class LocalNvmeSsdBlockConfig(Model):
    ...
    def __init__(self, local_ssd_count: int=None):
        """LocalNvmeSsdBlockConfig - a model defined in OpenAPI

        :param local_ssd_count: The local_ssd_count of this LocalNvmeSsdBlockConfig.
        """
        self.openapi_types = {
            'local_ssd_count': int
        }
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'LocalNvmeSsdBlockConfig':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The LocalNvmeSsdBlockConfig of this LocalNvmeSsdBlockConfig.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def local_ssd_count(self):
        """Gets the local_ssd_count of this LocalNvmeSsdBlockConfig.
        ...
        :return: The local_ssd_count of this LocalNvmeSsdBlockConfig.
        :rtype: int
        """
    ...
    def local_ssd_count(self, local_ssd_count):
        """Sets the local_ssd_count of this LocalNvmeSsdBlockConfig.
