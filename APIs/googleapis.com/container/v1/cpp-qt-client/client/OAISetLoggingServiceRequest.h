...
/*
 * OAISetLoggingServiceRequest.h
 *
 * SetLoggingServiceRequest sets the logging service of a cluster.
 */

#ifndef OAISetLoggingServiceRequest_H
#define OAISetLoggingServiceRequest_H
...
class OAISetLoggingServiceRequest : public OAIObject {
public:
    OAISetLoggingServiceRequest();
    OAISetLoggingServiceRequest(QString json);
    ~OAISetLoggingServiceRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISetLoggingServiceRequest)

#endif // OAISetLoggingServiceRequest_H
