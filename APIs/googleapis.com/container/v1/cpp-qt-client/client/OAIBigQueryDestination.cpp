...
QString OAIBigQueryDestination::getDatasetId() const {
    return m_dataset_id;
}
void OAIBigQueryDestination::setDatasetId(const QString &dataset_id) {
    m_dataset_id = dataset_id;
    m_dataset_id_isSet = true;
}

bool OAIBigQueryDestination::is_dataset_id_Set() const{
    return m_dataset_id_isSet;
}

bool OAIBigQueryDestination::is_dataset_id_Valid() const{
