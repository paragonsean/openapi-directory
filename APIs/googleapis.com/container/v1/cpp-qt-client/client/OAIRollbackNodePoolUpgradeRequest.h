...
/*
 * OAIRollbackNodePoolUpgradeRequest.h
 *
 * RollbackNodePoolUpgradeRequest rollbacks the previously Aborted or Failed NodePool upgrade. This will be an no-op if the last upgrade successfully completed.
 */

#ifndef OAIRollbackNodePoolUpgradeRequest_H
#define OAIRollbackNodePoolUpgradeRequest_H
...
class OAIRollbackNodePoolUpgradeRequest : public OAIObject {
public:
    OAIRollbackNodePoolUpgradeRequest();
    OAIRollbackNodePoolUpgradeRequest(QString json);
    ~OAIRollbackNodePoolUpgradeRequest() override;
    ...
    bool isRespectPdb() const;
    void setRespectPdb(const bool &respect_pdb);
    bool is_respect_pdb_Set() const;
    bool is_respect_pdb_Valid() const;
...
private:
    ...
    bool m_respect_pdb;
    bool m_respect_pdb_isSet;
    bool m_respect_pdb_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRollbackNodePoolUpgradeRequest)

#endif // OAIRollbackNodePoolUpgradeRequest_H
