...
public class UpdateClusterRequest {
  ...
  @Deprecated
  public UpdateClusterRequest projectId(String projectId) {
  ...
  public UpdateClusterRequest update(ClusterUpdate update) {
    this.update = update;
    return this;
  }
  ...
  public void setUpdate(ClusterUpdate update) {
    this.update = update;
  }


  @Deprecated
  public UpdateClusterRequest zone(String zone) {
    this.zone = zone;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.clusterId, updateClusterRequest.clusterId) &&
        Objects.equals(this.name, updateClusterRequest.name) &&
        Objects.equals(this.projectId, updateClusterRequest.projectId) &&
        Objects.equals(this.update, updateClusterRequest.update) &&
        Objects.equals(this.zone, updateClusterRequest.zone);
  }

  @Override
  public int hashCode() {
    return Objects.hash(clusterId, name, projectId, update, zone);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("update") != null && !jsonObj.get("update").isJsonNull()) {
        ClusterUpdate.validateJsonElement(jsonObj.get("update"));
      }
