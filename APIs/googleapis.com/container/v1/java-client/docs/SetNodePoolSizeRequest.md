...
|**name** | **String** | The name (project, location, cluster, node pool id) of the node pool to set size. Specified in the format &#x60;projects/_*_/locations/_*_/clusters/_*_/nodePools/_*&#x60;. |  [optional] |
|**nodeCount** | **Integer** | Required. The desired node count for the pool. |  [optional] |
