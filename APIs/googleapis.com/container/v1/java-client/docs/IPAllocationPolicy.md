...
|**defaultPodIpv4RangeUtilization** | **Double** | Output only. [Output only] The utilization of the cluster default IPv4 range for the pod. The ratio is Usage/[Total number of IPs in the secondary range], Usage&#x3D;numNodes*numZones*podIPsPerNode. |  [optional] [readonly] |
|**ipv6AccessType** | [**Ipv6AccessTypeEnum**](#Ipv6AccessTypeEnum) | The ipv6 access type (internal or external) when create_subnetwork is true |  [optional] |
...
|**stackType** | [**StackTypeEnum**](#StackTypeEnum) | The IP stack type of the cluster |  [optional] |
