...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesEngineApi.OperationProgress();
  });
  ...
  describe('OperationProgress', function() {
    it('should create an instance of OperationProgress', function() {
      // uncomment below and update the code to test OperationProgress
      //var instance = new KubernetesEngineApi.OperationProgress();
      //expect(instance).to.be.a(KubernetesEngineApi.OperationProgress);
    });
