...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesEngineApi.CreateClusterRequest();
  });
  ...
  describe('CreateClusterRequest', function() {
    it('should create an instance of CreateClusterRequest', function() {
      ...
      //var instance = new KubernetesEngineApi.CreateClusterRequest();
      //expect(instance).to.be.a(KubernetesEngineApi.CreateClusterRequest);
    });
