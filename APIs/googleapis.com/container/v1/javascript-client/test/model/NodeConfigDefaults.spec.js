...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesEngineApi.NodeConfigDefaults();
  });
  ...
  describe('NodeConfigDefaults', function() {
    it('should create an instance of NodeConfigDefaults', function() {
      // uncomment below and update the code to test NodeConfigDefaults
      //var instance = new KubernetesEngineApi.NodeConfigDefaults();
      //expect(instance).to.be.a(KubernetesEngineApi.NodeConfigDefaults);
    });
