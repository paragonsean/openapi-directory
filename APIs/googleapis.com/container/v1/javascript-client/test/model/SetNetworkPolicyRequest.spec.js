...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesEngineApi.SetNetworkPolicyRequest();
  });
  ...
  describe('SetNetworkPolicyRequest', function() {
    it('should create an instance of SetNetworkPolicyRequest', function() {
      // uncomment below and update the code to test SetNetworkPolicyRequest
      //var instance = new KubernetesEngineApi.SetNetworkPolicyRequest();
      //expect(instance).to.be.a(KubernetesEngineApi.SetNetworkPolicyRequest);
    });
