...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesEngineApi.MaintenancePolicy();
  });
  ...
  describe('MaintenancePolicy', function() {
    it('should create an instance of MaintenancePolicy', function() {
      ...
      //var instance = new KubernetesEngineApi.MaintenancePolicy();
      //expect(instance).to.be.a(KubernetesEngineApi.MaintenancePolicy);
    });
