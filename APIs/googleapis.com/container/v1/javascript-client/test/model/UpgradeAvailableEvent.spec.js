...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesEngineApi.UpgradeAvailableEvent();
  });
  ...
  describe('UpgradeAvailableEvent', function() {
    it('should create an instance of UpgradeAvailableEvent', function() {
      // uncomment below and update the code to test UpgradeAvailableEvent
      //var instance = new KubernetesEngineApi.UpgradeAvailableEvent();
      //expect(instance).to.be.a(KubernetesEngineApi.UpgradeAvailableEvent);
    });
