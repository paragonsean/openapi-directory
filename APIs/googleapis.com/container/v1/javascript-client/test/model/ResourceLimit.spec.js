...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KubernetesEngineApi.ResourceLimit();
  });
  ...
  describe('ResourceLimit', function() {
    it('should create an instance of ResourceLimit', function() {
      // uncomment below and update the code to test ResourceLimit
      //var instance = new KubernetesEngineApi.ResourceLimit();
      //expect(instance).to.be.a(KubernetesEngineApi.ResourceLimit);
    });
