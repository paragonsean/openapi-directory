...
**conditions** | [**[StatusCondition]**](StatusCondition.md) | Which conditions caused the current cluster state. | [optional] 
...
**currentNodeCount** | **Number** | [Output only] The number of nodes currently in the cluster. Deprecated. Call Kubernetes API directly to retrieve node information. | [optional] 
...
**nodeIpv4CidrSize** | **Number** | [Output only] The size of the address space on each node for hosting containers. This is provisioned from within the &#x60;container_ipv4_cidr&#x60; range. This field will only be set when cluster is in route-based network mode. | [optional] 
...
**nodePools** | [**[NodePool]**](NodePool.md) | The node pools associated with this cluster. This field should not be set if \&quot;node_config\&quot; or \&quot;initial_node_count\&quot; are specified. | [optional] 
...
**resourceLabels** | **{String: String}** | The resource labels for the cluster to use to annotate any related Google Compute Engine resources. | [optional] 
...
**status** | **String** | [Output only] The current status of this cluster. | [optional] 
