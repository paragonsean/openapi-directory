...
class NetworkConfig {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('customRoutesEnabled')) {
                obj['customRoutesEnabled'] = ApiClient.convertToType(data['customRoutesEnabled'], 'Boolean');
            }
        }
        return obj;
    }
 ...
 */
NetworkConfig.prototype['customRoutesEnabled'] = undefined;
