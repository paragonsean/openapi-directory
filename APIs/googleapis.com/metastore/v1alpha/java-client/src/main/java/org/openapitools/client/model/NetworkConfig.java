...
public class NetworkConfig {
  ...
  public static final String SERIALIZED_NAME_CUSTOM_ROUTES_ENABLED = "customRoutesEnabled";
  @SerializedName(SERIALIZED_NAME_CUSTOM_ROUTES_ENABLED)
  private Boolean customRoutesEnabled;

  public NetworkConfig() {
  }

  public NetworkConfig consumers(List<Consumer> consumers) {
    this.consumers = consumers;
    return this;
  }

  public NetworkConfig addConsumersItem(Consumer consumersItem) {
  ...
  public NetworkConfig customRoutesEnabled(Boolean customRoutesEnabled) {
  ...
  public void setCustomRoutesEnabled(Boolean customRoutesEnabled) {
    this.customRoutesEnabled = customRoutesEnabled;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.consumers, networkConfig.consumers) &&
        Objects.equals(this.customRoutesEnabled, networkConfig.customRoutesEnabled);
  }

  @Override
  public int hashCode() {
    return Objects.hash(consumers, customRoutesEnabled);
  }
  ...
  public String toString() {
    ...
    sb.append("    customRoutesEnabled: ").append(toIndentedString(customRoutesEnabled)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("customRoutesEnabled");
      ...
      if (jsonObj.get("consumers") != null && !jsonObj.get("consumers").isJsonNull()) {
        ...
        if (jsonArrayconsumers != null) {
          ...
          for (int i = 0; i < jsonArrayconsumers.size(); i++) {
            Consumer.validateJsonElement(jsonArrayconsumers.get(i));
          };
        }
      }
  }
