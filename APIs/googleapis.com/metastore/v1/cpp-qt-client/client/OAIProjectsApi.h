...
public:
    ...
    */
    virtual void metastore_projects_locations_services_backups_getIamPolicy(const QString &resource, const ::OpenAPI::OptionalParam<QString> &_xgafv = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &access_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &alt = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &callback = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &fields = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &key = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &oauth_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &pretty_print = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &quota_user = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &upload_protocol = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &upload_type = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &options_requested_policy_version = ::OpenAPI::OptionalParam<qint32>());
    ...
    */
    virtual void metastore_projects_locations_services_backups_setIamPolicy(const QString &resource, const ::OpenAPI::OptionalParam<QString> &_xgafv = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &access_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &alt = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &callback = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &fields = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &key = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &oauth_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &pretty_print = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &quota_user = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &upload_protocol = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &upload_type = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAISetIamPolicyRequest> &oai_set_iam_policy_request = ::OpenAPI::OptionalParam<OAISetIamPolicyRequest>());
...
private:
    ...
    void metastore_projects_locations_services_backups_getIamPolicyCallback(OAIHttpRequestWorker *worker);
    void metastore_projects_locations_services_backups_listCallback(OAIHttpRequestWorker *worker);
    void metastore_projects_locations_services_backups_setIamPolicyCallback(OAIHttpRequestWorker *worker);
    ...
    void metastore_projects_locations_services_testIamPermissionsCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void metastore_projects_locations_services_backups_getIamPolicySignal(OAIPolicy summary);
    void metastore_projects_locations_services_backups_listSignal(OAIListBackupsResponse summary);
    void metastore_projects_locations_services_backups_setIamPolicySignal(OAIPolicy summary);
    ...
    void metastore_projects_locations_services_testIamPermissionsSignal(OAITestIamPermissionsResponse summary);
    ...
    void metastore_projects_locations_services_backups_getIamPolicySignalFull(OAIHttpRequestWorker *worker, OAIPolicy summary);
    ...
    void metastore_projects_locations_services_backups_setIamPolicySignalFull(OAIHttpRequestWorker *worker, OAIPolicy summary);
    ...
    void metastore_projects_locations_services_testIamPermissionsSignalFull(OAIHttpRequestWorker *worker, OAITestIamPermissionsResponse summary);
    ...
    Q_DECL_DEPRECATED_X("Use metastore_projects_locations_services_backups_getIamPolicySignalError() instead")
    void metastore_projects_locations_services_backups_getIamPolicySignalE(OAIPolicy summary, QNetworkReply::NetworkError error_type, QString error_str);
    void metastore_projects_locations_services_backups_getIamPolicySignalError(OAIPolicy summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use metastore_projects_locations_services_backups_setIamPolicySignalError() instead")
    void metastore_projects_locations_services_backups_setIamPolicySignalE(OAIPolicy summary, QNetworkReply::NetworkError error_type, QString error_str);
    void metastore_projects_locations_services_backups_setIamPolicySignalError(OAIPolicy summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use metastore_projects_locations_services_testIamPermissionsSignalError() instead")
    void metastore_projects_locations_services_testIamPermissionsSignalE(OAITestIamPermissionsResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void metastore_projects_locations_services_testIamPermissionsSignalError(OAITestIamPermissionsResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use metastore_projects_locations_services_backups_getIamPolicySignalErrorFull() instead")
    void metastore_projects_locations_services_backups_getIamPolicySignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void metastore_projects_locations_services_backups_getIamPolicySignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use metastore_projects_locations_services_backups_setIamPolicySignalErrorFull() instead")
    void metastore_projects_locations_services_backups_setIamPolicySignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void metastore_projects_locations_services_backups_setIamPolicySignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use metastore_projects_locations_services_testIamPermissionsSignalErrorFull() instead")
    void metastore_projects_locations_services_testIamPermissionsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void metastore_projects_locations_services_testIamPermissionsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
