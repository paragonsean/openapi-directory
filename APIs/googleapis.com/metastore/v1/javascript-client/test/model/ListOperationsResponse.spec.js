...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataprocMetastoreApi.ListOperationsResponse();
  });
  ...
  describe('ListOperationsResponse', function() {
    it('should create an instance of ListOperationsResponse', function() {
      ...
      //var instance = new DataprocMetastoreApi.ListOperationsResponse();
      //expect(instance).to.be.a(DataprocMetastoreApi.ListOperationsResponse);
    });
