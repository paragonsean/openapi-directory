# DataprocMetastoreApi.OperationMetadata
...
**requestedCancellation** | **Boolean** | Output only. Identifies whether the caller has requested cancellation of the operation. Operations that have successfully been cancelled have Operation.error value with a google.rpc.Status.code of 1, corresponding to Code.CANCELLED. | [optional] [readonly] 
