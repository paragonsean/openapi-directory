...
------------- | ------------- | -------------
[**metastoreProjectsLocationsFederationsCreate**](ProjectsApi.md#metastoreProjectsLocationsFederationsCreate) | **POST** /v1/{parent}/federations | 
[**metastoreProjectsLocationsFederationsList**](ProjectsApi.md#metastoreProjectsLocationsFederationsList) | **GET** /v1/{parent}/federations | 
[**metastoreProjectsLocationsList**](ProjectsApi.md#metastoreProjectsLocationsList) | **GET** /v1/{name}/locations | 
[**metastoreProjectsLocationsOperationsCancel**](ProjectsApi.md#metastoreProjectsLocationsOperationsCancel) | **POST** /v1/{name}:cancel | 
[**metastoreProjectsLocationsOperationsList**](ProjectsApi.md#metastoreProjectsLocationsOperationsList) | **GET** /v1/{name}/operations | 
[**metastoreProjectsLocationsServicesAlterLocation**](ProjectsApi.md#metastoreProjectsLocationsServicesAlterLocation) | **POST** /v1/{service}:alterLocation | 
[**metastoreProjectsLocationsServicesAlterTableProperties**](ProjectsApi.md#metastoreProjectsLocationsServicesAlterTableProperties) | **POST** /v1/{service}:alterTableProperties | 
[**metastoreProjectsLocationsServicesBackupsCreate**](ProjectsApi.md#metastoreProjectsLocationsServicesBackupsCreate) | **POST** /v1/{parent}/backups | 
[**metastoreProjectsLocationsServicesBackupsGetIamPolicy**](ProjectsApi.md#metastoreProjectsLocationsServicesBackupsGetIamPolicy) | **GET** /v1/{resource}:getIamPolicy | 
[**metastoreProjectsLocationsServicesBackupsList**](ProjectsApi.md#metastoreProjectsLocationsServicesBackupsList) | **GET** /v1/{parent}/backups | 
[**metastoreProjectsLocationsServicesBackupsSetIamPolicy**](ProjectsApi.md#metastoreProjectsLocationsServicesBackupsSetIamPolicy) | **POST** /v1/{resource}:setIamPolicy | 
[**metastoreProjectsLocationsServicesCreate**](ProjectsApi.md#metastoreProjectsLocationsServicesCreate) | **POST** /v1/{parent}/services | 
[**metastoreProjectsLocationsServicesExportMetadata**](ProjectsApi.md#metastoreProjectsLocationsServicesExportMetadata) | **POST** /v1/{service}:exportMetadata | 
[**metastoreProjectsLocationsServicesList**](ProjectsApi.md#metastoreProjectsLocationsServicesList) | **GET** /v1/{parent}/services | 
[**metastoreProjectsLocationsServicesMetadataImportsCreate**](ProjectsApi.md#metastoreProjectsLocationsServicesMetadataImportsCreate) | **POST** /v1/{parent}/metadataImports | 
[**metastoreProjectsLocationsServicesMetadataImportsGet**](ProjectsApi.md#metastoreProjectsLocationsServicesMetadataImportsGet) | **GET** /v1/{name} | 
[**metastoreProjectsLocationsServicesMetadataImportsList**](ProjectsApi.md#metastoreProjectsLocationsServicesMetadataImportsList) | **GET** /v1/{parent}/metadataImports | 
[**metastoreProjectsLocationsServicesMetadataImportsPatch**](ProjectsApi.md#metastoreProjectsLocationsServicesMetadataImportsPatch) | **PATCH** /v1/{name} | 
[**metastoreProjectsLocationsServicesMigrationExecutionsDelete**](ProjectsApi.md#metastoreProjectsLocationsServicesMigrationExecutionsDelete) | **DELETE** /v1/{name} | 
[**metastoreProjectsLocationsServicesMoveTableToDatabase**](ProjectsApi.md#metastoreProjectsLocationsServicesMoveTableToDatabase) | **POST** /v1/{service}:moveTableToDatabase | 
[**metastoreProjectsLocationsServicesQueryMetadata**](ProjectsApi.md#metastoreProjectsLocationsServicesQueryMetadata) | **POST** /v1/{service}:queryMetadata | 
[**metastoreProjectsLocationsServicesRestore**](ProjectsApi.md#metastoreProjectsLocationsServicesRestore) | **POST** /v1/{service}:restore | 
[**metastoreProjectsLocationsServicesTestIamPermissions**](ProjectsApi.md#metastoreProjectsLocationsServicesTestIamPermissions) | **POST** /v1/{resource}:testIamPermissions | 
...
> Policy metastoreProjectsLocationsServicesBackupsGetIamPolicy(resource, opts)
...
apiInstance.metastoreProjectsLocationsServicesBackupsGetIamPolicy(resource, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Policy metastoreProjectsLocationsServicesBackupsSetIamPolicy(resource, opts)
...
apiInstance.metastoreProjectsLocationsServicesBackupsSetIamPolicy(resource, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> TestIamPermissionsResponse metastoreProjectsLocationsServicesTestIamPermissions(resource, opts)
...
apiInstance.metastoreProjectsLocationsServicesTestIamPermissions(resource, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
