...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataprocMetastoreApi.ListLocationsResponse();
  });
  ...
  describe('ListLocationsResponse', function() {
    it('should create an instance of ListLocationsResponse', function() {
      ...
      //var instance = new DataprocMetastoreApi.ListLocationsResponse();
      //expect(instance).to.be.a(DataprocMetastoreApi.ListLocationsResponse);
    });
