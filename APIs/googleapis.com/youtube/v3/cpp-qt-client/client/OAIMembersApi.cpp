...
void OAIMembersApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("youtube_members_list", defaultConf);
    _serverIndices.insert("youtube_members_list", 0);
}
...
void OAIMembersApi::youtube_members_list(const QList<QString> &part, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<QString> &filter_by_member_channel_id, const ::OpenAPI::OptionalParam<QString> &has_access_to_level, const ::OpenAPI::OptionalParam<qint32> &max_results, const ::OpenAPI::OptionalParam<QString> &mode, const ::OpenAPI::OptionalParam<QString> &page_token) {
    ...
    if (filter_by_member_channel_id.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "filterByMemberChannelId", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("filterByMemberChannelId")).append(querySuffix).append(QUrl::toPercentEncoding(filter_by_member_channel_id.stringValue()));
    }
    if (has_access_to_level.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "hasAccessToLevel", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("hasAccessToLevel")).append(querySuffix).append(QUrl::toPercentEncoding(has_access_to_level.stringValue()));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMembersApi::youtube_members_listCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMembersApi::youtube_members_listCallback);
    connect(this, &OAIMembersApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
...
void OAIMembersApi::youtube_members_listCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIMemberListResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT youtube_members_listSignal(output);
        Q_EMIT youtube_members_listSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT youtube_members_listSignalE(output, error_type, error_str);
        Q_EMIT youtube_members_listSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT youtube_members_listSignalError(output, error_type, error_str);
        Q_EMIT youtube_members_listSignalErrorFull(worker, error_type, error_str);
    }
}
