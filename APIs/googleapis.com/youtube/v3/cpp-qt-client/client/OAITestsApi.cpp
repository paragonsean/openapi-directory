...
void OAITestsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("youtube_tests_insert", defaultConf);
    _serverIndices.insert("youtube_tests_insert", 0);
}
...
void OAITestsApi::youtube_tests_insert(const QList<QString> &part, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<QString> &external_channel_id, const ::OpenAPI::OptionalParam<OAITestItem> &oai_test_item) {
    ...
    if (oai_test_item.hasValue()){

        
        QByteArray output = oai_test_item.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITestsApi::youtube_tests_insertCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITestsApi::youtube_tests_insertCallback);
...
void OAITestsApi::youtube_tests_insertCallback(OAIHttpRequestWorker *worker) {
    ...
    OAITestItem output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT youtube_tests_insertSignal(output);
        Q_EMIT youtube_tests_insertSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT youtube_tests_insertSignalE(output, error_type, error_str);
        Q_EMIT youtube_tests_insertSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT youtube_tests_insertSignalError(output, error_type, error_str);
        Q_EMIT youtube_tests_insertSignalErrorFull(worker, error_type, error_str);
    }
}
