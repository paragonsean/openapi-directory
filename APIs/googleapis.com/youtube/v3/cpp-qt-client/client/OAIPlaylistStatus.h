...
#ifndef OAIPlaylistStatus_H
#define OAIPlaylistStatus_H
...
class OAIPlaylistStatus : public OAIObject {
public:
    OAIPlaylistStatus();
    OAIPlaylistStatus(QString json);
    ~OAIPlaylistStatus() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPlaylistStatus)

#endif // OAIPlaylistStatus_H
