...
/*
 * OAISubscriptionSnippet.h
 *
 * Basic details about a subscription, including title, description and thumbnails of the subscribed item.
 */

#ifndef OAISubscriptionSnippet_H
#define OAISubscriptionSnippet_H
...
class OAISubscriptionSnippet : public OAIObject {
public:
    OAISubscriptionSnippet();
    OAISubscriptionSnippet(QString json);
    ~OAISubscriptionSnippet() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISubscriptionSnippet)

#endif // OAISubscriptionSnippet_H
