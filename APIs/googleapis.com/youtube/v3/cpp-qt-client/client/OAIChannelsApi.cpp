...
void OAIChannelsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("youtube_channels_list", defaultConf);
    _serverIndices.insert("youtube_channels_list", 0);
    _serverConfigs.insert("youtube_channels_update", defaultConf);
    _serverIndices.insert("youtube_channels_update", 0);
}
...
void OAIChannelsApi::youtube_channels_list(const QList<QString> &part, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<QString> &category_id, const ::OpenAPI::OptionalParam<QString> &for_handle, const ::OpenAPI::OptionalParam<QString> &for_username, const ::OpenAPI::OptionalParam<QString> &hl, const ::OpenAPI::OptionalParam<QList<QString>> &id, const ::OpenAPI::OptionalParam<bool> &managed_by_me, const ::OpenAPI::OptionalParam<qint32> &max_results, const ::OpenAPI::OptionalParam<bool> &mine, const ::OpenAPI::OptionalParam<bool> &my_subscribers, const ::OpenAPI::OptionalParam<QString> &on_behalf_of_content_owner, const ::OpenAPI::OptionalParam<QString> &page_token) {
    QString fullPath = QString(_serverConfigs["youtube_channels_list"][_serverIndices.value("youtube_channels_list")].URL()+"/youtube/v3/channels");
    ...
    if (for_handle.hasValue())
    {
        ...
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "forHandle", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("forHandle")).append(querySuffix).append(QUrl::toPercentEncoding(for_handle.stringValue()));
    }
    if (for_username.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "forUsername", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("forUsername")).append(querySuffix).append(QUrl::toPercentEncoding(for_username.stringValue()));
    }
    if (hl.hasValue())
    {
        queryStyle = "form";
    ...
    if (managed_by_me.hasValue())
    {
        ...
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "managedByMe", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("managedByMe")).append(querySuffix).append(QUrl::toPercentEncoding(managed_by_me.stringValue()));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIChannelsApi::youtube_channels_listCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIChannelsApi::youtube_channels_listCallback);
...
void OAIChannelsApi::youtube_channels_listCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIChannelListResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT youtube_channels_listSignal(output);
        Q_EMIT youtube_channels_listSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT youtube_channels_listSignalE(output, error_type, error_str);
        Q_EMIT youtube_channels_listSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT youtube_channels_listSignalError(output, error_type, error_str);
        Q_EMIT youtube_channels_listSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIChannelsApi::youtube_channels_update(const QList<QString> &part, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<QString> &on_behalf_of_content_owner, const ::OpenAPI::OptionalParam<OAIChannel> &oai_channel) {
    QString fullPath = QString(_serverConfigs["youtube_channels_update"][_serverIndices.value("youtube_channels_update")].URL()+"/youtube/v3/channels");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIChannelsApi::youtube_channels_updateCallback);
    connect(this, &OAIChannelsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIChannelsApi::youtube_channels_updateCallback);
    connect(this, &OAIChannelsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIChannelsApi::youtube_channels_updateCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT youtube_channels_updateSignal(output);
        Q_EMIT youtube_channels_updateSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        QString scopeStr = scope.join(" ");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT youtube_channels_updateSignalE(output, error_type, error_str);
        Q_EMIT youtube_channels_updateSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT youtube_channels_updateSignalError(output, error_type, error_str);
        Q_EMIT youtube_channels_updateSignalErrorFull(worker, error_type, error_str);
    }
}
