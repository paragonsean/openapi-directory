...
/*
 * OAILiveChatSuperStickerDetails.h
 *
 * 
 */

#ifndef OAILiveChatSuperStickerDetails_H
#define OAILiveChatSuperStickerDetails_H
...
class OAILiveChatSuperStickerDetails : public OAIObject {
public:
    OAILiveChatSuperStickerDetails();
    OAILiveChatSuperStickerDetails(QString json);
    ~OAILiveChatSuperStickerDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILiveChatSuperStickerDetails)

#endif // OAILiveChatSuperStickerDetails_H
