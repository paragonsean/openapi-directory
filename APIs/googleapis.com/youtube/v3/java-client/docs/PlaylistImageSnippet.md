...
|------------ | ------------- | ------------- | -------------|
|**height** | **Integer** | The image height. |  [optional] |
|**playlistId** | **String** | The Playlist ID of the playlist this image is associated with. |  [optional] |
|**type** | [**TypeEnum**](#TypeEnum) | The image type. |  [optional] |
|**width** | **Integer** | The image width. |  [optional] |
