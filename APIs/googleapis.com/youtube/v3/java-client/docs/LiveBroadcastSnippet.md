...
|**scheduledEndTime** | **OffsetDateTime** | The date and time that the broadcast is scheduled to end. |  [optional] |
|**scheduledStartTime** | **OffsetDateTime** | The date and time that the broadcast is scheduled to start. |  [optional] |
