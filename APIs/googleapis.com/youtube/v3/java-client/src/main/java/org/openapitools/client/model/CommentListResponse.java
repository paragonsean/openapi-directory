...
public class CommentListResponse {
   ...
   * @throws IOException if the JSON Element is invalid with respect to CommentListResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CommentListResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CommentListResponse is not found in the empty JSON string", CommentListResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CommentListResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CommentListResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CommentListResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CommentListResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CommentListResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CommentListResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CommentListResponse>() {
           @Override
           public void write(JsonWriter out, CommentListResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CommentListResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CommentListResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CommentListResponse
   * @throws IOException if the JSON string is invalid with respect to CommentListResponse
   */
  public static CommentListResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CommentListResponse.class);
  }

  /**
   * Convert an instance of CommentListResponse to an JSON string
   *
   * @return JSON string
   */
