...
public class MembershipsLevelListResponse {
  ...
  private List<MembershipsLevel> items = new ArrayList<>();
  ...
  public MembershipsLevelListResponse() {
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to MembershipsLevelListResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MembershipsLevelListResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MembershipsLevelListResponse is not found in the empty JSON string", MembershipsLevelListResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MembershipsLevelListResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MembershipsLevelListResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("items") != null && !jsonObj.get("items").isJsonNull()) {
        ...
        if (jsonArrayitems != null) {
          ...
          for (int i = 0; i < jsonArrayitems.size(); i++) {
            MembershipsLevel.validateJsonElement(jsonArrayitems.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MembershipsLevelListResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MembershipsLevelListResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MembershipsLevelListResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MembershipsLevelListResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<MembershipsLevelListResponse>() {
           @Override
           public void write(JsonWriter out, MembershipsLevelListResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MembershipsLevelListResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MembershipsLevelListResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MembershipsLevelListResponse
   * @throws IOException if the JSON string is invalid with respect to MembershipsLevelListResponse
   */
  public static MembershipsLevelListResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MembershipsLevelListResponse.class);
  }

  /**
   * Convert an instance of MembershipsLevelListResponse to an JSON string
   *
   * @return JSON string
   */
