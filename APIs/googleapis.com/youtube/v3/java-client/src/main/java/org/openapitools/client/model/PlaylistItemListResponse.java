...
public class PlaylistItemListResponse {
   ...
   * @throws IOException if the JSON Element is invalid with respect to PlaylistItemListResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PlaylistItemListResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PlaylistItemListResponse is not found in the empty JSON string", PlaylistItemListResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PlaylistItemListResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PlaylistItemListResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PlaylistItemListResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PlaylistItemListResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PlaylistItemListResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PlaylistItemListResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PlaylistItemListResponse>() {
           @Override
           public void write(JsonWriter out, PlaylistItemListResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PlaylistItemListResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PlaylistItemListResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PlaylistItemListResponse
   * @throws IOException if the JSON string is invalid with respect to PlaylistItemListResponse
   */
  public static PlaylistItemListResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PlaylistItemListResponse.class);
  }

  /**
   * Convert an instance of PlaylistItemListResponse to an JSON string
   *
   * @return JSON string
   */
