...
public class ChannelListResponse {
   ...
   * @throws IOException if the JSON Element is invalid with respect to ChannelListResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ChannelListResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ChannelListResponse is not found in the empty JSON string", ChannelListResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ChannelListResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ChannelListResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("items") != null && !jsonObj.get("items").isJsonNull()) {
        ...
        if (jsonArrayitems != null) {
          ...
          for (int i = 0; i < jsonArrayitems.size(); i++) {
            Channel.validateJsonElement(jsonArrayitems.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ChannelListResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ChannelListResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ChannelListResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ChannelListResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ChannelListResponse>() {
           @Override
           public void write(JsonWriter out, ChannelListResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ChannelListResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ChannelListResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ChannelListResponse
   * @throws IOException if the JSON string is invalid with respect to ChannelListResponse
   */
  public static ChannelListResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ChannelListResponse.class);
  }

  /**
   * Convert an instance of ChannelListResponse to an JSON string
   *
   * @return JSON string
   */
