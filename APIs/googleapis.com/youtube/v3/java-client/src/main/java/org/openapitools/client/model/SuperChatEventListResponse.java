...
public class SuperChatEventListResponse {
  ...
  private List<SuperChatEvent> items = new ArrayList<>();
   ...
   * @throws IOException if the JSON Element is invalid with respect to SuperChatEventListResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SuperChatEventListResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SuperChatEventListResponse is not found in the empty JSON string", SuperChatEventListResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SuperChatEventListResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SuperChatEventListResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("items") != null && !jsonObj.get("items").isJsonNull()) {
        ...
        if (jsonArrayitems != null) {
          ...
          for (int i = 0; i < jsonArrayitems.size(); i++) {
            SuperChatEvent.validateJsonElement(jsonArrayitems.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SuperChatEventListResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SuperChatEventListResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SuperChatEventListResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SuperChatEventListResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<SuperChatEventListResponse>() {
           @Override
           public void write(JsonWriter out, SuperChatEventListResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SuperChatEventListResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SuperChatEventListResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SuperChatEventListResponse
   * @throws IOException if the JSON string is invalid with respect to SuperChatEventListResponse
   */
  public static SuperChatEventListResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SuperChatEventListResponse.class);
  }

  /**
   * Convert an instance of SuperChatEventListResponse to an JSON string
   *
   * @return JSON string
   */
