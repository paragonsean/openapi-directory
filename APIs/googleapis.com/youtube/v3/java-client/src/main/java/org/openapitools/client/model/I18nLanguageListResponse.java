...
public class I18nLanguageListResponse {
  ...
  private List<I18nLanguage> items = new ArrayList<>();
   ...
   * @throws IOException if the JSON Element is invalid with respect to I18nLanguageListResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!I18nLanguageListResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in I18nLanguageListResponse is not found in the empty JSON string", I18nLanguageListResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!I18nLanguageListResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `I18nLanguageListResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("items") != null && !jsonObj.get("items").isJsonNull()) {
        ...
        if (jsonArrayitems != null) {
          ...
          for (int i = 0; i < jsonArrayitems.size(); i++) {
            I18nLanguage.validateJsonElement(jsonArrayitems.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!I18nLanguageListResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'I18nLanguageListResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<I18nLanguageListResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(I18nLanguageListResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<I18nLanguageListResponse>() {
           @Override
           public void write(JsonWriter out, I18nLanguageListResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public I18nLanguageListResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of I18nLanguageListResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of I18nLanguageListResponse
   * @throws IOException if the JSON string is invalid with respect to I18nLanguageListResponse
   */
  public static I18nLanguageListResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, I18nLanguageListResponse.class);
  }

  /**
   * Convert an instance of I18nLanguageListResponse to an JSON string
   *
   * @return JSON string
   */
