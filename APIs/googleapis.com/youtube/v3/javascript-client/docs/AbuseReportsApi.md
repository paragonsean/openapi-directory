# YouTubeDataApiV3.AbuseReportsApi
...
> AbuseReport youtubeAbuseReportsInsert(part, opts)
...
let apiInstance = new YouTubeDataApiV3.AbuseReportsApi();
...
apiInstance.youtubeAbuseReportsInsert(part, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
