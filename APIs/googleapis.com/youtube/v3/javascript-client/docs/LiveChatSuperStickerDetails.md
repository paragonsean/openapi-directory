# YouTubeDataApiV3.LiveChatSuperStickerDetails
...
**tier** | **Number** | The tier in which the amount belongs. Lower amounts belong to lower tiers. The lowest tier is 1. | [optional] 
