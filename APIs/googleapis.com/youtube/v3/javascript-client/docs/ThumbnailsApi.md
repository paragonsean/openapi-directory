# YouTubeDataApiV3.ThumbnailsApi

All URIs are relative to *https://youtube.googleapis.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**youtubeThumbnailsSet**](ThumbnailsApi.md#youtubeThumbnailsSet) | **POST** /youtube/v3/thumbnails/set | 



## youtubeThumbnailsSet

> ThumbnailSetResponse youtubeThumbnailsSet(videoId, opts)
...
let apiInstance = new YouTubeDataApiV3.ThumbnailsApi();
...
apiInstance.youtubeThumbnailsSet(videoId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
