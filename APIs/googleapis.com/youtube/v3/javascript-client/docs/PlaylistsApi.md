...
> youtubePlaylistsDelete(id, opts)
...
let apiInstance = new YouTubeDataApiV3.PlaylistsApi();
...
apiInstance.youtubePlaylistsDelete(id, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> Playlist youtubePlaylistsInsert(part, opts)
...
let opts = {
  ...
  'playlist': new YouTubeDataApiV3.Playlist() // Playlist | 
};
apiInstance.youtubePlaylistsInsert(part, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> PlaylistListResponse youtubePlaylistsList(part, opts)
...
let apiInstance = new YouTubeDataApiV3.PlaylistsApi();
let part = ["null"]; // [String] | The *part* parameter specifies a comma-separated list of one or more playlist resource properties that the API response will include. If the parameter identifies a property that contains child properties, the child properties will be included in the response. For example, in a playlist resource, the snippet property contains properties like author, title, description, tags, and timeCreated. As such, if you set *part=snippet*, the API response will contain all of those properties.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'id': ["null"], // [String] | Return the playlists with the given IDs for Stubby or Apiary.
...
apiInstance.youtubePlaylistsList(part, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Playlist youtubePlaylistsUpdate(part, opts)
...
apiInstance.youtubePlaylistsUpdate(part, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
