# YouTubeDataApiV3.LiveBroadcastContentDetails
...
* `closedCaptionsTypeUnspecified` (value: `"closedCaptionsTypeUnspecified"`)

* `closedCaptionsDisabled` (value: `"closedCaptionsDisabled"`)

* `closedCaptionsHttpPost` (value: `"closedCaptionsHttpPost"`)

* `closedCaptionsEmbedded` (value: `"closedCaptionsEmbedded"`)
...
* `latencyPreferenceUnspecified` (value: `"latencyPreferenceUnspecified"`)

* `normal` (value: `"normal"`)

* `low` (value: `"low"`)

* `ultraLow` (value: `"ultraLow"`)
...
* `projectionUnspecified` (value: `"projectionUnspecified"`)
...
* `stereoLayoutUnspecified` (value: `"stereoLayoutUnspecified"`)

* `mono` (value: `"mono"`)

* `leftRight` (value: `"leftRight"`)

* `topBottom` (value: `"topBottom"`)
