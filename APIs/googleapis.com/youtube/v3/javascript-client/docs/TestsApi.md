...
> TestItem youtubeTestsInsert(part, opts)
...
let apiInstance = new YouTubeDataApiV3.TestsApi();
let part = ["null"]; // [String] | 
let opts = {
  ...
  'externalChannelId': "externalChannelId_example", // String | 
  'testItem': new YouTubeDataApiV3.TestItem() // TestItem | 
};
apiInstance.youtubeTestsInsert(part, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
