# YouTubeDataApiV3.LiveChatModeratorsApi
...
> youtubeLiveChatModeratorsDelete(id, opts)
...
let apiInstance = new YouTubeDataApiV3.LiveChatModeratorsApi();
...
apiInstance.youtubeLiveChatModeratorsDelete(id, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> LiveChatModerator youtubeLiveChatModeratorsInsert(part, opts)
...
let apiInstance = new YouTubeDataApiV3.LiveChatModeratorsApi();
let part = ["null"]; // [String] | The *part* parameter serves two purposes in this operation. It identifies the properties that the write operation will set as well as the properties that the API response returns. Set the parameter value to snippet.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'liveChatModerator': new YouTubeDataApiV3.LiveChatModerator() // LiveChatModerator | 
};
apiInstance.youtubeLiveChatModeratorsInsert(part, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> LiveChatModeratorListResponse youtubeLiveChatModeratorsList(liveChatId, part, opts)
...
let part = ["null"]; // [String] | The *part* parameter specifies the liveChatModerator resource parts that the API response will include. Supported values are id and snippet.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
apiInstance.youtubeLiveChatModeratorsList(liveChatId, part, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
