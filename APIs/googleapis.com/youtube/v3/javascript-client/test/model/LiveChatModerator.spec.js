...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YouTubeDataApiV3.LiveChatModerator();
  });
  ...
  describe('LiveChatModerator', function() {
    it('should create an instance of LiveChatModerator', function() {
      // uncomment below and update the code to test LiveChatModerator
      //var instance = new YouTubeDataApiV3.LiveChatModerator();
      //expect(instance).to.be.a(YouTubeDataApiV3.LiveChatModerator);
    });
