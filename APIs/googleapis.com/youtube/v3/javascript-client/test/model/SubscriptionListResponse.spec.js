...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YouTubeDataApiV3.SubscriptionListResponse();
  });
  ...
  describe('SubscriptionListResponse', function() {
    it('should create an instance of SubscriptionListResponse', function() {
      ...
      //var instance = new YouTubeDataApiV3.SubscriptionListResponse();
      //expect(instance).to.be.a(YouTubeDataApiV3.SubscriptionListResponse);
    });
