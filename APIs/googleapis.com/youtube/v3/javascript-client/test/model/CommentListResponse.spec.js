...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YouTubeDataApiV3.CommentListResponse();
  });
  ...
  describe('CommentListResponse', function() {
    it('should create an instance of CommentListResponse', function() {
      // uncomment below and update the code to test CommentListResponse
      //var instance = new YouTubeDataApiV3.CommentListResponse();
      //expect(instance).to.be.a(YouTubeDataApiV3.CommentListResponse);
    });
