...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YouTubeDataApiV3.PlaylistListResponse();
  });
  ...
  describe('PlaylistListResponse', function() {
    it('should create an instance of PlaylistListResponse', function() {
      ...
      //var instance = new YouTubeDataApiV3.PlaylistListResponse();
      //expect(instance).to.be.a(YouTubeDataApiV3.PlaylistListResponse);
    });
