...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YouTubeDataApiV3.VideoCategoryListResponse();
  });
  ...
  describe('VideoCategoryListResponse', function() {
    it('should create an instance of VideoCategoryListResponse', function() {
      ...
      //var instance = new YouTubeDataApiV3.VideoCategoryListResponse();
      //expect(instance).to.be.a(YouTubeDataApiV3.VideoCategoryListResponse);
    });
