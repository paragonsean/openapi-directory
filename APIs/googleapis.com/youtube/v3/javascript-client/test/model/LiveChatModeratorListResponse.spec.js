...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YouTubeDataApiV3.LiveChatModeratorListResponse();
  });
  ...
  describe('LiveChatModeratorListResponse', function() {
    it('should create an instance of LiveChatModeratorListResponse', function() {
      // uncomment below and update the code to test LiveChatModeratorListResponse
      //var instance = new YouTubeDataApiV3.LiveChatModeratorListResponse();
      //expect(instance).to.be.a(YouTubeDataApiV3.LiveChatModeratorListResponse);
    });
