...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YouTubeDataApiV3.ActivitySnippet();
  });
  ...
  describe('ActivitySnippet', function() {
    it('should create an instance of ActivitySnippet', function() {
      // uncomment below and update the code to test ActivitySnippet
      //var instance = new YouTubeDataApiV3.ActivitySnippet();
      //expect(instance).to.be.a(YouTubeDataApiV3.ActivitySnippet);
    });
