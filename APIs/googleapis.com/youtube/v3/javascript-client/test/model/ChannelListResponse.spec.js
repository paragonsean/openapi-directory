...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YouTubeDataApiV3.ChannelListResponse();
  });
  ...
  describe('ChannelListResponse', function() {
    it('should create an instance of ChannelListResponse', function() {
      // uncomment below and update the code to test ChannelListResponse
      //var instance = new YouTubeDataApiV3.ChannelListResponse();
      //expect(instance).to.be.a(YouTubeDataApiV3.ChannelListResponse);
    });
