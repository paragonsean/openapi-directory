...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YouTubeDataApiV3.CommentThreadListResponse();
  });
  ...
  describe('CommentThreadListResponse', function() {
    it('should create an instance of CommentThreadListResponse', function() {
      // uncomment below and update the code to test CommentThreadListResponse
      //var instance = new YouTubeDataApiV3.CommentThreadListResponse();
      //expect(instance).to.be.a(YouTubeDataApiV3.CommentThreadListResponse);
    });
