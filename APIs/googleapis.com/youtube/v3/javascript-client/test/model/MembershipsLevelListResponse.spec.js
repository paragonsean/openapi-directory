...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YouTubeDataApiV3.MembershipsLevelListResponse();
  });
  ...
  describe('MembershipsLevelListResponse', function() {
    it('should create an instance of MembershipsLevelListResponse', function() {
      // uncomment below and update the code to test MembershipsLevelListResponse
      //var instance = new YouTubeDataApiV3.MembershipsLevelListResponse();
      //expect(instance).to.be.a(YouTubeDataApiV3.MembershipsLevelListResponse);
    });
