...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YouTubeDataApiV3.MemberListResponse();
  });
  ...
  describe('MemberListResponse', function() {
    it('should create an instance of MemberListResponse', function() {
      ...
      //var instance = new YouTubeDataApiV3.MemberListResponse();
      //expect(instance).to.be.a(YouTubeDataApiV3.MemberListResponse);
    });
