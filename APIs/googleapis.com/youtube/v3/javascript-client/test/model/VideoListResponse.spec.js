...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YouTubeDataApiV3.VideoListResponse();
  });
  ...
  describe('VideoListResponse', function() {
    it('should create an instance of VideoListResponse', function() {
      ...
      //var instance = new YouTubeDataApiV3.VideoListResponse();
      //expect(instance).to.be.a(YouTubeDataApiV3.VideoListResponse);
    });
