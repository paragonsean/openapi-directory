...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YouTubeDataApiV3.ChannelSection();
  });
  ...
  describe('ChannelSection', function() {
    it('should create an instance of ChannelSection', function() {
      // uncomment below and update the code to test ChannelSection
      //var instance = new YouTubeDataApiV3.ChannelSection();
      //expect(instance).to.be.a(YouTubeDataApiV3.ChannelSection);
    });
