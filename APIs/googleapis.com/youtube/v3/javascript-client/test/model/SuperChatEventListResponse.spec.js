...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YouTubeDataApiV3.SuperChatEventListResponse();
  });
  ...
  describe('SuperChatEventListResponse', function() {
    it('should create an instance of SuperChatEventListResponse', function() {
      // uncomment below and update the code to test SuperChatEventListResponse
      //var instance = new YouTubeDataApiV3.SuperChatEventListResponse();
      //expect(instance).to.be.a(YouTubeDataApiV3.SuperChatEventListResponse);
    });
