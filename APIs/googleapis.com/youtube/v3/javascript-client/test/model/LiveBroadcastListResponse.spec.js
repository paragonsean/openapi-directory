...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YouTubeDataApiV3.LiveBroadcastListResponse();
  });
  ...
  describe('LiveBroadcastListResponse', function() {
    it('should create an instance of LiveBroadcastListResponse', function() {
      // uncomment below and update the code to test LiveBroadcastListResponse
      //var instance = new YouTubeDataApiV3.LiveBroadcastListResponse();
      //expect(instance).to.be.a(YouTubeDataApiV3.LiveBroadcastListResponse);
    });
