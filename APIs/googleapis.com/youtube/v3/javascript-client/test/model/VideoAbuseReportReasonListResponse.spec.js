...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YouTubeDataApiV3.VideoAbuseReportReasonListResponse();
  });
  ...
  describe('VideoAbuseReportReasonListResponse', function() {
    it('should create an instance of VideoAbuseReportReasonListResponse', function() {
      // uncomment below and update the code to test VideoAbuseReportReasonListResponse
      //var instance = new YouTubeDataApiV3.VideoAbuseReportReasonListResponse();
      //expect(instance).to.be.a(YouTubeDataApiV3.VideoAbuseReportReasonListResponse);
    });
