...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YouTubeDataApiV3.PlaylistSnippet();
  });
  ...
  describe('PlaylistSnippet', function() {
    it('should create an instance of PlaylistSnippet', function() {
      // uncomment below and update the code to test PlaylistSnippet
      //var instance = new YouTubeDataApiV3.PlaylistSnippet();
      //expect(instance).to.be.a(YouTubeDataApiV3.PlaylistSnippet);
    });
    ...
    it('should have the property thumbnailVideoId (base name: "thumbnailVideoId")', function() {
      // uncomment below and update the code to test the property thumbnailVideoId
      //var instance = new YouTubeDataApiV3.PlaylistSnippet();
      //expect(instance).to.be();
    });
