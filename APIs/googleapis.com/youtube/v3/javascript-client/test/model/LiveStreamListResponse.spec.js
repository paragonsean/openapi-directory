...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YouTubeDataApiV3.LiveStreamListResponse();
  });
  ...
  describe('LiveStreamListResponse', function() {
    it('should create an instance of LiveStreamListResponse', function() {
      ...
      //var instance = new YouTubeDataApiV3.LiveStreamListResponse();
      //expect(instance).to.be.a(YouTubeDataApiV3.LiveStreamListResponse);
    });
