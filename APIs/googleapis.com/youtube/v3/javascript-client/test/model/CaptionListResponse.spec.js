...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YouTubeDataApiV3.CaptionListResponse();
  });
  ...
  describe('CaptionListResponse', function() {
    it('should create an instance of CaptionListResponse', function() {
      // uncomment below and update the code to test CaptionListResponse
      //var instance = new YouTubeDataApiV3.CaptionListResponse();
      //expect(instance).to.be.a(YouTubeDataApiV3.CaptionListResponse);
    });
