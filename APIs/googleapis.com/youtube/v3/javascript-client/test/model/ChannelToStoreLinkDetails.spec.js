...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YouTubeDataApiV3.ChannelToStoreLinkDetails();
  });
  ...
  describe('ChannelToStoreLinkDetails', function() {
    it('should create an instance of ChannelToStoreLinkDetails', function() {
      // uncomment below and update the code to test ChannelToStoreLinkDetails
      //var instance = new YouTubeDataApiV3.ChannelToStoreLinkDetails();
      //expect(instance).to.be.a(YouTubeDataApiV3.ChannelToStoreLinkDetails);
    });
