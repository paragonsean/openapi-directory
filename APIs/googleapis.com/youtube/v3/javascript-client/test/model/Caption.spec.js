...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YouTubeDataApiV3.Caption();
  });
  ...
  describe('Caption', function() {
    it('should create an instance of Caption', function() {
      // uncomment below and update the code to test Caption
      //var instance = new YouTubeDataApiV3.Caption();
      //expect(instance).to.be.a(YouTubeDataApiV3.Caption);
    });
