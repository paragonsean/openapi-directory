...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YouTubeDataApiV3.VideoCategorySnippet();
  });
  ...
  describe('VideoCategorySnippet', function() {
    it('should create an instance of VideoCategorySnippet', function() {
      // uncomment below and update the code to test VideoCategorySnippet
      //var instance = new YouTubeDataApiV3.VideoCategorySnippet();
      //expect(instance).to.be.a(YouTubeDataApiV3.VideoCategorySnippet);
    });
