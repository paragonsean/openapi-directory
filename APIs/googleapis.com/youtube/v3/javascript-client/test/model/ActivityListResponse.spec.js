...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YouTubeDataApiV3.ActivityListResponse();
  });
  ...
  describe('ActivityListResponse', function() {
    it('should create an instance of ActivityListResponse', function() {
      // uncomment below and update the code to test ActivityListResponse
      //var instance = new YouTubeDataApiV3.ActivityListResponse();
      //expect(instance).to.be.a(YouTubeDataApiV3.ActivityListResponse);
    });
