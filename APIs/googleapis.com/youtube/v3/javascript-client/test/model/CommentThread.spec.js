...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YouTubeDataApiV3.CommentThread();
  });
  ...
  describe('CommentThread', function() {
    it('should create an instance of CommentThread', function() {
      // uncomment below and update the code to test CommentThread
      //var instance = new YouTubeDataApiV3.CommentThread();
      //expect(instance).to.be.a(YouTubeDataApiV3.CommentThread);
    });
