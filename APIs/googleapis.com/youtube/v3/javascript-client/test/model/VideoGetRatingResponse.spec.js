...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YouTubeDataApiV3.VideoGetRatingResponse();
  });
  ...
  describe('VideoGetRatingResponse', function() {
    it('should create an instance of VideoGetRatingResponse', function() {
      // uncomment below and update the code to test VideoGetRatingResponse
      //var instance = new YouTubeDataApiV3.VideoGetRatingResponse();
      //expect(instance).to.be.a(YouTubeDataApiV3.VideoGetRatingResponse);
    });
