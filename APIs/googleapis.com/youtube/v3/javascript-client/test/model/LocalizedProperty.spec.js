...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YouTubeDataApiV3.LocalizedProperty();
  });
  ...
  describe('LocalizedProperty', function() {
    it('should create an instance of LocalizedProperty', function() {
      // uncomment below and update the code to test LocalizedProperty
      //var instance = new YouTubeDataApiV3.LocalizedProperty();
      //expect(instance).to.be.a(YouTubeDataApiV3.LocalizedProperty);
    });
