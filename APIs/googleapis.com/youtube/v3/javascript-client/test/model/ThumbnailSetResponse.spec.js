...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YouTubeDataApiV3.ThumbnailSetResponse();
  });
  ...
  describe('ThumbnailSetResponse', function() {
    it('should create an instance of ThumbnailSetResponse', function() {
      // uncomment below and update the code to test ThumbnailSetResponse
      //var instance = new YouTubeDataApiV3.ThumbnailSetResponse();
      //expect(instance).to.be.a(YouTubeDataApiV3.ThumbnailSetResponse);
    });
