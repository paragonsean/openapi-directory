...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YouTubeDataApiV3.MembershipsLevel();
  });
  ...
  describe('MembershipsLevel', function() {
    it('should create an instance of MembershipsLevel', function() {
      // uncomment below and update the code to test MembershipsLevel
      //var instance = new YouTubeDataApiV3.MembershipsLevel();
      //expect(instance).to.be.a(YouTubeDataApiV3.MembershipsLevel);
    });
