...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YouTubeDataApiV3.LiveChatBan();
  });
  ...
  describe('LiveChatBan', function() {
    it('should create an instance of LiveChatBan', function() {
      // uncomment below and update the code to test LiveChatBan
      //var instance = new YouTubeDataApiV3.LiveChatBan();
      //expect(instance).to.be.a(YouTubeDataApiV3.LiveChatBan);
    });
