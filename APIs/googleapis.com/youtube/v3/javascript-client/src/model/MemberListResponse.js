...
class MemberListResponse {
    ...
    constructor() { 
        ...
        MemberListResponse.initialize(this);
    }
    ...
    static initialize(obj) { 
        obj['kind'] = 'youtube#memberListResponse';
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MemberListResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>MemberListResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MemberListResponse</code>.
     */
 ...
 * @member {String} etag
 */
MemberListResponse.prototype['etag'] = undefined;

/**
 * Serialized EventId of the request which produced this response.
 * @member {String} eventId
 */
MemberListResponse.prototype['eventId'] = undefined;

/**
 * A list of members that match the request criteria.
 * @member {Array.<module:model/Member>} items
 */
MemberListResponse.prototype['items'] = undefined;
 ...
 */
MemberListResponse.prototype['kind'] = 'youtube#memberListResponse';

/**
 * The token that can be used as the value of the pageToken parameter to retrieve the next page in the result set.
 * @member {String} nextPageToken
 */
MemberListResponse.prototype['nextPageToken'] = undefined;

/**
 * @member {module:model/PageInfo} pageInfo
 */
MemberListResponse.prototype['pageInfo'] = undefined;

/**
 * Stub token pagination template to suppress results.
 * @member {Object} tokenPagination
 */
MemberListResponse.prototype['tokenPagination'] = undefined;

/**
 * The visitorId identifies the visitor.
 * @member {String} visitorId
 */
MemberListResponse.prototype['visitorId'] = undefined;
