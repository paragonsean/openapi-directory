...
class PlaylistListResponse {
    ...
    constructor() { 
        ...
        PlaylistListResponse.initialize(this);
    }
    ...
    static initialize(obj) { 
        obj['kind'] = 'youtube#playlistListResponse';
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PlaylistListResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>PlaylistListResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PlaylistListResponse</code>.
     */
 ...
 * @member {String} etag
 */
PlaylistListResponse.prototype['etag'] = undefined;

/**
 * Serialized EventId of the request which produced this response.
 * @member {String} eventId
 */
PlaylistListResponse.prototype['eventId'] = undefined;

/**
 * A list of playlists that match the request criteria
 * @member {Array.<module:model/Playlist>} items
 */
PlaylistListResponse.prototype['items'] = undefined;
 ...
 */
PlaylistListResponse.prototype['kind'] = 'youtube#playlistListResponse';

/**
 * The token that can be used as the value of the pageToken parameter to retrieve the next page in the result set.
 * @member {String} nextPageToken
 */
PlaylistListResponse.prototype['nextPageToken'] = undefined;

/**
 * @member {module:model/PageInfo} pageInfo
 */
PlaylistListResponse.prototype['pageInfo'] = undefined;

/**
 * The token that can be used as the value of the pageToken parameter to retrieve the previous page in the result set.
 * @member {String} prevPageToken
 */
PlaylistListResponse.prototype['prevPageToken'] = undefined;

/**
 * Stub token pagination template to suppress results.
 * @member {Object} tokenPagination
 */
PlaylistListResponse.prototype['tokenPagination'] = undefined;

/**
 * The visitorId identifies the visitor.
 * @member {String} visitorId
 */
PlaylistListResponse.prototype['visitorId'] = undefined;
...
export default PlaylistListResponse;
