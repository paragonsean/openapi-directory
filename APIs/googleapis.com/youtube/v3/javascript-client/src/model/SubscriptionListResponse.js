...
class SubscriptionListResponse {
    ...
    static initialize(obj) { 
        obj['kind'] = 'youtube#subscriptionListResponse';
    }
 ...
 * @member {String} etag
 */
SubscriptionListResponse.prototype['etag'] = undefined;

/**
 * Serialized EventId of the request which produced this response.
 * @member {String} eventId
 */
SubscriptionListResponse.prototype['eventId'] = undefined;

/**
 * A list of subscriptions that match the request criteria.
 * @member {Array.<module:model/Subscription>} items
 */
SubscriptionListResponse.prototype['items'] = undefined;
 ...
 */
SubscriptionListResponse.prototype['kind'] = 'youtube#subscriptionListResponse';

/**
 * The token that can be used as the value of the pageToken parameter to retrieve the next page in the result set.
 * @member {String} nextPageToken
 */
SubscriptionListResponse.prototype['nextPageToken'] = undefined;

/**
 * @member {module:model/PageInfo} pageInfo
 */
SubscriptionListResponse.prototype['pageInfo'] = undefined;

/**
 * The token that can be used as the value of the pageToken parameter to retrieve the previous page in the result set.
 * @member {String} prevPageToken
 */
SubscriptionListResponse.prototype['prevPageToken'] = undefined;

/**
 * Stub token pagination template to suppress results.
 * @member {Object} tokenPagination
 */
SubscriptionListResponse.prototype['tokenPagination'] = undefined;

/**
 * The visitorId identifies the visitor.
 * @member {String} visitorId
 */
SubscriptionListResponse.prototype['visitorId'] = undefined;
