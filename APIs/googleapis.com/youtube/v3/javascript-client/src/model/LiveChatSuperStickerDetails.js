...
/**
 * The LiveChatSuperStickerDetails model module.
 * @module model/LiveChatSuperStickerDetails
 * @version v3
 */
class LiveChatSuperStickerDetails {
    /**
     * Constructs a new <code>LiveChatSuperStickerDetails</code>.
     * @alias module:model/LiveChatSuperStickerDetails
     */
    constructor() { 
        
        LiveChatSuperStickerDetails.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LiveChatSuperStickerDetails</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LiveChatSuperStickerDetails} obj Optional instance to populate.
     * @return {module:model/LiveChatSuperStickerDetails} The populated <code>LiveChatSuperStickerDetails</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LiveChatSuperStickerDetails();
    ...
    /**
     * Validates the JSON data with respect to <code>LiveChatSuperStickerDetails</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LiveChatSuperStickerDetails</code>.
     */
 ...
 */
LiveChatSuperStickerDetails.prototype['amountDisplayString'] = undefined;

/**
 * The amount purchased by the user, in micros (1,750,000 micros = 1.75).
 * @member {String} amountMicros
 */
LiveChatSuperStickerDetails.prototype['amountMicros'] = undefined;

/**
 * The currency in which the purchase was made.
 * @member {String} currency
 */
LiveChatSuperStickerDetails.prototype['currency'] = undefined;

/**
 * @member {module:model/SuperStickerMetadata} superStickerMetadata
 */
LiveChatSuperStickerDetails.prototype['superStickerMetadata'] = undefined;

/**
 * The tier in which the amount belongs. Lower amounts belong to lower tiers. The lowest tier is 1.
 * @member {Number} tier
 */
LiveChatSuperStickerDetails.prototype['tier'] = undefined;
...
export default LiveChatSuperStickerDetails;
