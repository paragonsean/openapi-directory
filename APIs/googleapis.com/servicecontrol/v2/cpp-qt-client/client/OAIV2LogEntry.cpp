...
OAIV2LogEntry::OAIV2LogEntry(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIV2LogEntry::OAIV2LogEntry() {
    this->initializeModel();
}

OAIV2LogEntry::~OAIV2LogEntry() {}

void OAIV2LogEntry::initializeModel() {
...
void OAIV2LogEntry::fromJson(QString jsonString) {
...
void OAIV2LogEntry::fromJsonObject(QJsonObject json) {
...
QString OAIV2LogEntry::asJson() const {
...
QJsonObject OAIV2LogEntry::asJsonObject() const {
    QJsonObject obj;
...
OAIV2HttpRequest OAIV2LogEntry::getHttpRequest() const {
    return m_http_request;
}
void OAIV2LogEntry::setHttpRequest(const OAIV2HttpRequest &http_request) {
    m_http_request = http_request;
    m_http_request_isSet = true;
}

bool OAIV2LogEntry::is_http_request_Set() const{
    return m_http_request_isSet;
}

bool OAIV2LogEntry::is_http_request_Valid() const{
    return m_http_request_isValid;
}

QString OAIV2LogEntry::getInsertId() const {
    return m_insert_id;
}
void OAIV2LogEntry::setInsertId(const QString &insert_id) {
    m_insert_id = insert_id;
    m_insert_id_isSet = true;
}

bool OAIV2LogEntry::is_insert_id_Set() const{
    return m_insert_id_isSet;
}

bool OAIV2LogEntry::is_insert_id_Valid() const{
    return m_insert_id_isValid;
}

QMap<QString, QString> OAIV2LogEntry::getLabels() const {
    return m_labels;
}
void OAIV2LogEntry::setLabels(const QMap<QString, QString> &labels) {
    m_labels = labels;
    m_labels_isSet = true;
}

bool OAIV2LogEntry::is_labels_Set() const{
    return m_labels_isSet;
}

bool OAIV2LogEntry::is_labels_Valid() const{
    return m_labels_isValid;
}

QMap<QString, QString> OAIV2LogEntry::getMonitoredResourceLabels() const {
    return m_monitored_resource_labels;
}
void OAIV2LogEntry::setMonitoredResourceLabels(const QMap<QString, QString> &monitored_resource_labels) {
    m_monitored_resource_labels = monitored_resource_labels;
    m_monitored_resource_labels_isSet = true;
}

bool OAIV2LogEntry::is_monitored_resource_labels_Set() const{
    return m_monitored_resource_labels_isSet;
}

bool OAIV2LogEntry::is_monitored_resource_labels_Valid() const{
    return m_monitored_resource_labels_isValid;
}

QString OAIV2LogEntry::getName() const {
    return m_name;
}
void OAIV2LogEntry::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIV2LogEntry::is_name_Set() const{
    return m_name_isSet;
}

bool OAIV2LogEntry::is_name_Valid() const{
    return m_name_isValid;
}

OAIV2LogEntryOperation OAIV2LogEntry::getOperation() const {
    return m_operation;
}
void OAIV2LogEntry::setOperation(const OAIV2LogEntryOperation &operation) {
    m_operation = operation;
    m_operation_isSet = true;
}

bool OAIV2LogEntry::is_operation_Set() const{
    return m_operation_isSet;
}

bool OAIV2LogEntry::is_operation_Valid() const{
    return m_operation_isValid;
}

QMap<QString, QJsonValue> OAIV2LogEntry::getProtoPayload() const {
    return m_proto_payload;
}
void OAIV2LogEntry::setProtoPayload(const QMap<QString, QJsonValue> &proto_payload) {
    m_proto_payload = proto_payload;
    m_proto_payload_isSet = true;
}

bool OAIV2LogEntry::is_proto_payload_Set() const{
    return m_proto_payload_isSet;
}

bool OAIV2LogEntry::is_proto_payload_Valid() const{
    return m_proto_payload_isValid;
}

QString OAIV2LogEntry::getSeverity() const {
    return m_severity;
}
void OAIV2LogEntry::setSeverity(const QString &severity) {
    m_severity = severity;
    m_severity_isSet = true;
}

bool OAIV2LogEntry::is_severity_Set() const{
    return m_severity_isSet;
}

bool OAIV2LogEntry::is_severity_Valid() const{
    return m_severity_isValid;
}

OAIV2LogEntrySourceLocation OAIV2LogEntry::getSourceLocation() const {
    return m_source_location;
}
void OAIV2LogEntry::setSourceLocation(const OAIV2LogEntrySourceLocation &source_location) {
    m_source_location = source_location;
    m_source_location_isSet = true;
}

bool OAIV2LogEntry::is_source_location_Set() const{
    return m_source_location_isSet;
}

bool OAIV2LogEntry::is_source_location_Valid() const{
    return m_source_location_isValid;
}

QMap<QString, QJsonValue> OAIV2LogEntry::getStructPayload() const {
    return m_struct_payload;
}
void OAIV2LogEntry::setStructPayload(const QMap<QString, QJsonValue> &struct_payload) {
    m_struct_payload = struct_payload;
    m_struct_payload_isSet = true;
}

bool OAIV2LogEntry::is_struct_payload_Set() const{
    return m_struct_payload_isSet;
}

bool OAIV2LogEntry::is_struct_payload_Valid() const{
    return m_struct_payload_isValid;
}

QString OAIV2LogEntry::getTextPayload() const {
    return m_text_payload;
}
void OAIV2LogEntry::setTextPayload(const QString &text_payload) {
    m_text_payload = text_payload;
    m_text_payload_isSet = true;
}

bool OAIV2LogEntry::is_text_payload_Set() const{
    return m_text_payload_isSet;
}

bool OAIV2LogEntry::is_text_payload_Valid() const{
    return m_text_payload_isValid;
}

QString OAIV2LogEntry::getTimestamp() const {
    return m_timestamp;
}
void OAIV2LogEntry::setTimestamp(const QString &timestamp) {
    m_timestamp = timestamp;
    m_timestamp_isSet = true;
}

bool OAIV2LogEntry::is_timestamp_Set() const{
    return m_timestamp_isSet;
}

bool OAIV2LogEntry::is_timestamp_Valid() const{
    return m_timestamp_isValid;
}

QString OAIV2LogEntry::getTrace() const {
    return m_trace;
}
void OAIV2LogEntry::setTrace(const QString &trace) {
    m_trace = trace;
    m_trace_isSet = true;
}

bool OAIV2LogEntry::is_trace_Set() const{
    return m_trace_isSet;
}

bool OAIV2LogEntry::is_trace_Valid() const{
    return m_trace_isValid;
}

bool OAIV2LogEntry::isSet() const {
...
bool OAIV2LogEntry::isValid() const {
