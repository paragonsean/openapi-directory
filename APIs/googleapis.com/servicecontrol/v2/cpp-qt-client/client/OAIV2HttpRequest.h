...
#ifndef OAIV2HttpRequest_H
#define OAIV2HttpRequest_H
...
class OAIV2HttpRequest : public OAIObject {
public:
    OAIV2HttpRequest();
    OAIV2HttpRequest(QString json);
    ~OAIV2HttpRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIV2HttpRequest)

#endif // OAIV2HttpRequest_H
