...
#ifndef OAIV2LogEntry_H
#define OAIV2LogEntry_H
...
namespace OpenAPI {
class OAIV2HttpRequest;
class OAIV2LogEntryOperation;
class OAIV2LogEntrySourceLocation;

class OAIV2LogEntry : public OAIObject {
public:
    OAIV2LogEntry();
    OAIV2LogEntry(QString json);
    ~OAIV2LogEntry() override;
    ...
    OAIV2HttpRequest getHttpRequest() const;
    void setHttpRequest(const OAIV2HttpRequest &http_request);
    ...
    OAIV2LogEntryOperation getOperation() const;
    void setOperation(const OAIV2LogEntryOperation &operation);
    ...
    OAIV2LogEntrySourceLocation getSourceLocation() const;
    void setSourceLocation(const OAIV2LogEntrySourceLocation &source_location);
...
private:
    ...
    OAIV2HttpRequest m_http_request;
    ...
    OAIV2LogEntryOperation m_operation;
    ...
    OAIV2LogEntrySourceLocation m_source_location;
...
Q_DECLARE_METATYPE(OpenAPI::OAIV2LogEntry)

#endif // OAIV2LogEntry_H
