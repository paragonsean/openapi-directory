...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceControlApi.V2LogEntry();
  });
  ...
  describe('V2LogEntry', function() {
    it('should create an instance of V2LogEntry', function() {
      // uncomment below and update the code to test V2LogEntry
      //var instance = new ServiceControlApi.V2LogEntry();
      //expect(instance).to.be.a(ServiceControlApi.V2LogEntry);
    });
