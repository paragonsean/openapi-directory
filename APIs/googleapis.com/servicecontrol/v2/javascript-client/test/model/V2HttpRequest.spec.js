...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceControlApi.V2HttpRequest();
  });
  ...
  describe('V2HttpRequest', function() {
    it('should create an instance of V2HttpRequest', function() {
      // uncomment below and update the code to test V2HttpRequest
      //var instance = new ServiceControlApi.V2HttpRequest();
      //expect(instance).to.be.a(ServiceControlApi.V2HttpRequest);
    });
