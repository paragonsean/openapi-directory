...
> Object servicecontrolServicesReport(serviceName, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, reportRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Object result = apiInstance.servicecontrolServicesReport(serviceName, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, reportRequest);
      System.out.println(result);
    } catch (ApiException e) {
