...
OAIV1HttpRequest::OAIV1HttpRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIV1HttpRequest::OAIV1HttpRequest() {
    this->initializeModel();
}

OAIV1HttpRequest::~OAIV1HttpRequest() {}

void OAIV1HttpRequest::initializeModel() {
...
void OAIV1HttpRequest::fromJson(QString jsonString) {
...
void OAIV1HttpRequest::fromJsonObject(QJsonObject json) {
...
QString OAIV1HttpRequest::asJson() const {
...
QJsonObject OAIV1HttpRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIV1HttpRequest::getCacheFillBytes() const {
    return m_cache_fill_bytes;
}
void OAIV1HttpRequest::setCacheFillBytes(const QString &cache_fill_bytes) {
    m_cache_fill_bytes = cache_fill_bytes;
    m_cache_fill_bytes_isSet = true;
}

bool OAIV1HttpRequest::is_cache_fill_bytes_Set() const{
    return m_cache_fill_bytes_isSet;
}

bool OAIV1HttpRequest::is_cache_fill_bytes_Valid() const{
    return m_cache_fill_bytes_isValid;
}

bool OAIV1HttpRequest::isCacheHit() const {
    return m_cache_hit;
}
void OAIV1HttpRequest::setCacheHit(const bool &cache_hit) {
    m_cache_hit = cache_hit;
    m_cache_hit_isSet = true;
}

bool OAIV1HttpRequest::is_cache_hit_Set() const{
    return m_cache_hit_isSet;
}

bool OAIV1HttpRequest::is_cache_hit_Valid() const{
    return m_cache_hit_isValid;
}

bool OAIV1HttpRequest::isCacheLookup() const {
    return m_cache_lookup;
}
void OAIV1HttpRequest::setCacheLookup(const bool &cache_lookup) {
    m_cache_lookup = cache_lookup;
    m_cache_lookup_isSet = true;
}

bool OAIV1HttpRequest::is_cache_lookup_Set() const{
    return m_cache_lookup_isSet;
}

bool OAIV1HttpRequest::is_cache_lookup_Valid() const{
    return m_cache_lookup_isValid;
}

bool OAIV1HttpRequest::isCacheValidatedWithOriginServer() const {
    return m_cache_validated_with_origin_server;
}
void OAIV1HttpRequest::setCacheValidatedWithOriginServer(const bool &cache_validated_with_origin_server) {
    m_cache_validated_with_origin_server = cache_validated_with_origin_server;
    m_cache_validated_with_origin_server_isSet = true;
}

bool OAIV1HttpRequest::is_cache_validated_with_origin_server_Set() const{
    return m_cache_validated_with_origin_server_isSet;
}

bool OAIV1HttpRequest::is_cache_validated_with_origin_server_Valid() const{
    return m_cache_validated_with_origin_server_isValid;
}

QString OAIV1HttpRequest::getLatency() const {
    return m_latency;
}
void OAIV1HttpRequest::setLatency(const QString &latency) {
    m_latency = latency;
    m_latency_isSet = true;
}

bool OAIV1HttpRequest::is_latency_Set() const{
    return m_latency_isSet;
}

bool OAIV1HttpRequest::is_latency_Valid() const{
    return m_latency_isValid;
}

QString OAIV1HttpRequest::getProtocol() const {
    return m_protocol;
}
void OAIV1HttpRequest::setProtocol(const QString &protocol) {
    m_protocol = protocol;
    m_protocol_isSet = true;
}

bool OAIV1HttpRequest::is_protocol_Set() const{
    return m_protocol_isSet;
}

bool OAIV1HttpRequest::is_protocol_Valid() const{
    return m_protocol_isValid;
}

QString OAIV1HttpRequest::getReferer() const {
    return m_referer;
}
void OAIV1HttpRequest::setReferer(const QString &referer) {
    m_referer = referer;
    m_referer_isSet = true;
}

bool OAIV1HttpRequest::is_referer_Set() const{
    return m_referer_isSet;
}

bool OAIV1HttpRequest::is_referer_Valid() const{
    return m_referer_isValid;
}

QString OAIV1HttpRequest::getRemoteIp() const {
    return m_remote_ip;
}
void OAIV1HttpRequest::setRemoteIp(const QString &remote_ip) {
    m_remote_ip = remote_ip;
    m_remote_ip_isSet = true;
}

bool OAIV1HttpRequest::is_remote_ip_Set() const{
    return m_remote_ip_isSet;
}

bool OAIV1HttpRequest::is_remote_ip_Valid() const{
    return m_remote_ip_isValid;
}

QString OAIV1HttpRequest::getRequestMethod() const {
    return m_request_method;
}
void OAIV1HttpRequest::setRequestMethod(const QString &request_method) {
    m_request_method = request_method;
    m_request_method_isSet = true;
}

bool OAIV1HttpRequest::is_request_method_Set() const{
    return m_request_method_isSet;
}

bool OAIV1HttpRequest::is_request_method_Valid() const{
    return m_request_method_isValid;
}

QString OAIV1HttpRequest::getRequestSize() const {
    return m_request_size;
}
void OAIV1HttpRequest::setRequestSize(const QString &request_size) {
    m_request_size = request_size;
    m_request_size_isSet = true;
}

bool OAIV1HttpRequest::is_request_size_Set() const{
    return m_request_size_isSet;
}

bool OAIV1HttpRequest::is_request_size_Valid() const{
    return m_request_size_isValid;
}

QString OAIV1HttpRequest::getRequestUrl() const {
    return m_request_url;
}
void OAIV1HttpRequest::setRequestUrl(const QString &request_url) {
    m_request_url = request_url;
    m_request_url_isSet = true;
}

bool OAIV1HttpRequest::is_request_url_Set() const{
    return m_request_url_isSet;
}

bool OAIV1HttpRequest::is_request_url_Valid() const{
    return m_request_url_isValid;
}

QString OAIV1HttpRequest::getResponseSize() const {
    return m_response_size;
}
void OAIV1HttpRequest::setResponseSize(const QString &response_size) {
    m_response_size = response_size;
    m_response_size_isSet = true;
}

bool OAIV1HttpRequest::is_response_size_Set() const{
    return m_response_size_isSet;
}

bool OAIV1HttpRequest::is_response_size_Valid() const{
    return m_response_size_isValid;
}

QString OAIV1HttpRequest::getServerIp() const {
    return m_server_ip;
}
void OAIV1HttpRequest::setServerIp(const QString &server_ip) {
    m_server_ip = server_ip;
    m_server_ip_isSet = true;
}

bool OAIV1HttpRequest::is_server_ip_Set() const{
    return m_server_ip_isSet;
}

bool OAIV1HttpRequest::is_server_ip_Valid() const{
    return m_server_ip_isValid;
}

qint32 OAIV1HttpRequest::getStatus() const {
    return m_status;
}
void OAIV1HttpRequest::setStatus(const qint32 &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIV1HttpRequest::is_status_Set() const{
    return m_status_isSet;
}

bool OAIV1HttpRequest::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIV1HttpRequest::getUserAgent() const {
    return m_user_agent;
}
void OAIV1HttpRequest::setUserAgent(const QString &user_agent) {
    m_user_agent = user_agent;
    m_user_agent_isSet = true;
}

bool OAIV1HttpRequest::is_user_agent_Set() const{
    return m_user_agent_isSet;
}

bool OAIV1HttpRequest::is_user_agent_Valid() const{
    return m_user_agent_isValid;
}

bool OAIV1HttpRequest::isSet() const {
...
bool OAIV1HttpRequest::isValid() const {
