...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceControlApi.V1LogEntryOperation();
  });
  ...
  describe('V1LogEntryOperation', function() {
    it('should create an instance of V1LogEntryOperation', function() {
      // uncomment below and update the code to test V1LogEntryOperation
      //var instance = new ServiceControlApi.V1LogEntryOperation();
      //expect(instance).to.be.a(ServiceControlApi.V1LogEntryOperation);
    });
