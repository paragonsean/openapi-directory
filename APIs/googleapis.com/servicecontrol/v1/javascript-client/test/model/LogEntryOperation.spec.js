...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceControlApi.LogEntryOperation();
  });
  ...
  describe('LogEntryOperation', function() {
    it('should create an instance of LogEntryOperation', function() {
      // uncomment below and update the code to test LogEntryOperation
      //var instance = new ServiceControlApi.LogEntryOperation();
      //expect(instance).to.be.a(ServiceControlApi.LogEntryOperation);
    });
