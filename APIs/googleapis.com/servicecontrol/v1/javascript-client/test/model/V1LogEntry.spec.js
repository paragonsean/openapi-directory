...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceControlApi.V1LogEntry();
  });
  ...
  describe('V1LogEntry', function() {
    it('should create an instance of V1LogEntry', function() {
      // uncomment below and update the code to test V1LogEntry
      //var instance = new ServiceControlApi.V1LogEntry();
      //expect(instance).to.be.a(ServiceControlApi.V1LogEntry);
    });
    ...
    it('should have the property monitoredResourceLabels (base name: "monitoredResourceLabels")', function() {
      // uncomment below and update the code to test the property monitoredResourceLabels
      //var instance = new ServiceControlApi.V1LogEntry();
      //expect(instance).to.be();
    });
