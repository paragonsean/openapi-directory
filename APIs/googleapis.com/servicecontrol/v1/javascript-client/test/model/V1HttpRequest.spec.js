...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceControlApi.V1HttpRequest();
  });
  ...
  describe('V1HttpRequest', function() {
    it('should create an instance of V1HttpRequest', function() {
      // uncomment below and update the code to test V1HttpRequest
      //var instance = new ServiceControlApi.V1HttpRequest();
      //expect(instance).to.be.a(ServiceControlApi.V1HttpRequest);
    });
