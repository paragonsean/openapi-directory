# ServiceControlApi.QuotaOperation
...
**labels** | **{String: String}** | Labels describing the operation. | [optional] 
...
* `CHECK_ONLY` (value: `"CHECK_ONLY"`)

* `ADJUST_ONLY` (value: `"ADJUST_ONLY"`)
