...
/**
 * The V1HttpRequest model module.
 * @module model/V1HttpRequest
 * @version v1
 */
class V1HttpRequest {
    /**
     * Constructs a new <code>V1HttpRequest</code>.
     * A common proto for logging HTTP requests. Only contains semantics defined by the HTTP specification. Product-specific logging information MUST be defined in a separate message.
     * @alias module:model/V1HttpRequest
     */
    constructor() { 
        
        V1HttpRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>V1HttpRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V1HttpRequest} obj Optional instance to populate.
     * @return {module:model/V1HttpRequest} The populated <code>V1HttpRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1HttpRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>V1HttpRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>V1HttpRequest</code>.
     */
 ...
 */
V1HttpRequest.prototype['cacheFillBytes'] = undefined;

/**
 * Whether or not an entity was served from cache (with or without validation).
 * @member {Boolean} cacheHit
 */
V1HttpRequest.prototype['cacheHit'] = undefined;

/**
 * Whether or not a cache lookup was attempted.
 * @member {Boolean} cacheLookup
 */
V1HttpRequest.prototype['cacheLookup'] = undefined;

/**
 * Whether or not the response was validated with the origin server before being served from cache. This field is only meaningful if `cache_hit` is True.
 * @member {Boolean} cacheValidatedWithOriginServer
 */
V1HttpRequest.prototype['cacheValidatedWithOriginServer'] = undefined;

/**
 * The request processing latency on the server, from the time the request was received until the response was sent.
 * @member {String} latency
 */
V1HttpRequest.prototype['latency'] = undefined;

/**
 * Protocol used for the request. Examples: \"HTTP/1.1\", \"HTTP/2\", \"websocket\"
 * @member {String} protocol
 */
V1HttpRequest.prototype['protocol'] = undefined;

/**
 * The referer URL of the request, as defined in [HTTP/1.1 Header Field Definitions](http://www.w3.org/Protocols/rfc2616/rfc2616-sec14.html).
 * @member {String} referer
 */
V1HttpRequest.prototype['referer'] = undefined;

/**
 * The IP address (IPv4 or IPv6) of the client that issued the HTTP request. Examples: `\"192.168.1.1\"`, `\"FE80::0202:B3FF:FE1E:8329\"`.
 * @member {String} remoteIp
 */
V1HttpRequest.prototype['remoteIp'] = undefined;

/**
 * The request method. Examples: `\"GET\"`, `\"HEAD\"`, `\"PUT\"`, `\"POST\"`.
 * @member {String} requestMethod
 */
V1HttpRequest.prototype['requestMethod'] = undefined;

/**
 * The size of the HTTP request message in bytes, including the request headers and the request body.
 * @member {String} requestSize
 */
V1HttpRequest.prototype['requestSize'] = undefined;

/**
 * The scheme (http, https), the host name, the path, and the query portion of the URL that was requested. Example: `\"http://example.com/some/info?color=red\"`.
 * @member {String} requestUrl
 */
V1HttpRequest.prototype['requestUrl'] = undefined;

/**
 * The size of the HTTP response message sent back to the client, in bytes, including the response headers and the response body.
 * @member {String} responseSize
 */
V1HttpRequest.prototype['responseSize'] = undefined;

/**
 * The IP address (IPv4 or IPv6) of the origin server that the request was sent to.
 * @member {String} serverIp
 */
V1HttpRequest.prototype['serverIp'] = undefined;

/**
 * The response code indicating the status of the response. Examples: 200, 404.
 * @member {Number} status
 */
V1HttpRequest.prototype['status'] = undefined;

/**
 * The user agent sent by the client. Example: `\"Mozilla/4.0 (compatible; MSIE 6.0; Windows 98; Q312461; .NET CLR 1.0.3705)\"`.
 * @member {String} userAgent
 */
V1HttpRequest.prototype['userAgent'] = undefined;
