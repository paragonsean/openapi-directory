...
class LogEntry(Model):
    ...
    def __init__(self, http_request: HttpRequest=None, insert_id: str=None, labels: Dict[str, str]=None, name: str=None, operation: LogEntryOperation=None, proto_payload: Dict[str, object]=None, severity: str=None, source_location: LogEntrySourceLocation=None, struct_payload: Dict[str, object]=None, text_payload: str=None, timestamp: str=None, trace: str=None):
        ...
        :param struct_payload: The struct_payload of this LogEntry.
    ...
    def struct_payload(self):
        """Gets the struct_payload of this LogEntry.

        The log entry payload, represented as a structure that is expressed as a JSON object.

        :return: The struct_payload of this LogEntry.
        :rtype: Dict[str, object]
        """
    ...
    def struct_payload(self, struct_payload):
        """Sets the struct_payload of this LogEntry.
