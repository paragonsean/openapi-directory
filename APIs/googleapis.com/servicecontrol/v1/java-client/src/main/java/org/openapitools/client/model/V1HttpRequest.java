...
public class V1HttpRequest {
  ...
  public V1HttpRequest() {
  }

  public V1HttpRequest cacheFillBytes(String cacheFillBytes) {
  ...
  public V1HttpRequest cacheHit(Boolean cacheHit) {
  ...
  public V1HttpRequest cacheLookup(Boolean cacheLookup) {
  ...
  public V1HttpRequest cacheValidatedWithOriginServer(Boolean cacheValidatedWithOriginServer) {
  ...
  public V1HttpRequest latency(String latency) {
  ...
  public V1HttpRequest protocol(String protocol) {
  ...
  public V1HttpRequest referer(String referer) {
  ...
  public V1HttpRequest remoteIp(String remoteIp) {
  ...
  public V1HttpRequest requestMethod(String requestMethod) {
  ...
  public V1HttpRequest requestSize(String requestSize) {
  ...
  public V1HttpRequest requestUrl(String requestUrl) {
  ...
  public V1HttpRequest responseSize(String responseSize) {
  ...
  public V1HttpRequest serverIp(String serverIp) {
  ...
  public V1HttpRequest status(Integer status) {
    this.status = status;
    return this;
  }
  ...
  public V1HttpRequest userAgent(String userAgent) {
  ...
  public boolean equals(Object o) {
    ...
    V1HttpRequest v1HttpRequest = (V1HttpRequest) o;
    return Objects.equals(this.cacheFillBytes, v1HttpRequest.cacheFillBytes) &&
        Objects.equals(this.cacheHit, v1HttpRequest.cacheHit) &&
        Objects.equals(this.cacheLookup, v1HttpRequest.cacheLookup) &&
        Objects.equals(this.cacheValidatedWithOriginServer, v1HttpRequest.cacheValidatedWithOriginServer) &&
        Objects.equals(this.latency, v1HttpRequest.latency) &&
        Objects.equals(this.protocol, v1HttpRequest.protocol) &&
        Objects.equals(this.referer, v1HttpRequest.referer) &&
        Objects.equals(this.remoteIp, v1HttpRequest.remoteIp) &&
        Objects.equals(this.requestMethod, v1HttpRequest.requestMethod) &&
        Objects.equals(this.requestSize, v1HttpRequest.requestSize) &&
        Objects.equals(this.requestUrl, v1HttpRequest.requestUrl) &&
        Objects.equals(this.responseSize, v1HttpRequest.responseSize) &&
        Objects.equals(this.serverIp, v1HttpRequest.serverIp) &&
        Objects.equals(this.status, v1HttpRequest.status) &&
        Objects.equals(this.userAgent, v1HttpRequest.userAgent);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to V1HttpRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V1HttpRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in V1HttpRequest is not found in the empty JSON string", V1HttpRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V1HttpRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `V1HttpRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V1HttpRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V1HttpRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V1HttpRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V1HttpRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<V1HttpRequest>() {
           @Override
           public void write(JsonWriter out, V1HttpRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V1HttpRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of V1HttpRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of V1HttpRequest
   * @throws IOException if the JSON string is invalid with respect to V1HttpRequest
   */
  public static V1HttpRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V1HttpRequest.class);
  }

  /**
   * Convert an instance of V1HttpRequest to an JSON string
   *
   * @return JSON string
   */
