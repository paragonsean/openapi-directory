...
|**importance** | [**ImportanceEnum**](#ImportanceEnum) | DO NOT USE. This is an experimental field. |  [optional] |
...
|**traceSpans** | [**List&lt;TraceSpan&gt;**](TraceSpan.md) | Unimplemented. A list of Cloud Trace spans. The span names shall contain the id of the destination project which can be either the produce or the consumer project. |  [optional] |
|**userLabels** | **Map&lt;String, String&gt;** | Private Preview. This feature is only available for approved services. User defined labels for the resource that this operation is associated with. |  [optional] |
