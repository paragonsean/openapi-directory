# SensitiveDataProtectionDlp.LocationsApi
...
> GooglePrivacyDlpV2ListInfoTypesResponse dlpLocationsInfoTypesList(parent, opts)
...
let apiInstance = new SensitiveDataProtectionDlp.LocationsApi();
let parent = "parent_example"; // String | The parent resource name. The format of this value is as follows: locations/ LOCATION_ID
let opts = {
...
apiInstance.dlpLocationsInfoTypesList(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
