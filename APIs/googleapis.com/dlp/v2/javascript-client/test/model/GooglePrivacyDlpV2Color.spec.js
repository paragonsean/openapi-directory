...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SensitiveDataProtectionDlp.GooglePrivacyDlpV2Color();
  });
  ...
  describe('GooglePrivacyDlpV2Color', function() {
    it('should create an instance of GooglePrivacyDlpV2Color', function() {
      // uncomment below and update the code to test GooglePrivacyDlpV2Color
      //var instance = new SensitiveDataProtectionDlp.GooglePrivacyDlpV2Color();
      //expect(instance).to.be.a(SensitiveDataProtectionDlp.GooglePrivacyDlpV2Color);
    });
