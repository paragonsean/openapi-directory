...
OAIInfoTypesApi::OAIInfoTypesApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIInfoTypesApi::~OAIInfoTypesApi() {
}

void OAIInfoTypesApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("dlp_infoTypes_list", defaultConf);
    _serverIndices.insert("dlp_infoTypes_list", 0);
}
...
*/
int OAIInfoTypesApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIInfoTypesApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIInfoTypesApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIInfoTypesApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIInfoTypesApi::setUsername(const QString &username) {
    _username = username;
}

void OAIInfoTypesApi::setPassword(const QString &password) {
    _password = password;
}


void OAIInfoTypesApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIInfoTypesApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIInfoTypesApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIInfoTypesApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIInfoTypesApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIInfoTypesApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIInfoTypesApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIInfoTypesApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIInfoTypesApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIInfoTypesApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIInfoTypesApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIInfoTypesApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIInfoTypesApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIInfoTypesApi::dlp_infoTypes_list(const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<QString> &filter, const ::OpenAPI::OptionalParam<QString> &language_code, const ::OpenAPI::OptionalParam<QString> &location_id, const ::OpenAPI::OptionalParam<QString> &parent) {
    QString fullPath = QString(_serverConfigs["dlp_infoTypes_list"][_serverIndices.value("dlp_infoTypes_list")].URL()+"/v2/infoTypes");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIInfoTypesApi::dlp_infoTypes_listCallback);
    connect(this, &OAIInfoTypesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIInfoTypesApi::dlp_infoTypes_listCallback);
    connect(this, &OAIInfoTypesApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
...
void OAIInfoTypesApi::dlp_infoTypes_listCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT dlp_infoTypes_listSignal(output);
        Q_EMIT dlp_infoTypes_listSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT dlp_infoTypes_listSignalE(output, error_type, error_str);
        Q_EMIT dlp_infoTypes_listSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT dlp_infoTypes_listSignalError(output, error_type, error_str);
        Q_EMIT dlp_infoTypes_listSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIInfoTypesApi::tokenAvailable(){
