...
/*
 * OAIGooglePrivacyDlpV2QuasiId.h
 *
 * A column with a semantic tag attached.
 */

#ifndef OAIGooglePrivacyDlpV2QuasiId_H
#define OAIGooglePrivacyDlpV2QuasiId_H
...
class OAIGooglePrivacyDlpV2QuasiId : public OAIObject {
public:
    OAIGooglePrivacyDlpV2QuasiId();
    OAIGooglePrivacyDlpV2QuasiId(QString json);
    ~OAIGooglePrivacyDlpV2QuasiId() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGooglePrivacyDlpV2QuasiId)

#endif // OAIGooglePrivacyDlpV2QuasiId_H
