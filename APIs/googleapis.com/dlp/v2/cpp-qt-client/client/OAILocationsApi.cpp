...
void OAILocationsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("dlp_locations_infoTypes_list", defaultConf);
    _serverIndices.insert("dlp_locations_infoTypes_list", 0);
}
...
void OAILocationsApi::dlp_locations_infoTypes_list(const QString &parent, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<QString> &filter, const ::OpenAPI::OptionalParam<QString> &language_code, const ::OpenAPI::OptionalParam<QString> &location_id) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAILocationsApi::dlp_locations_infoTypes_listCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAILocationsApi::dlp_locations_infoTypes_listCallback);
...
void OAILocationsApi::dlp_locations_infoTypes_listCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIGooglePrivacyDlpV2ListInfoTypesResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT dlp_locations_infoTypes_listSignal(output);
        Q_EMIT dlp_locations_infoTypes_listSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT dlp_locations_infoTypes_listSignalE(output, error_type, error_str);
        Q_EMIT dlp_locations_infoTypes_listSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT dlp_locations_infoTypes_listSignalError(output, error_type, error_str);
        Q_EMIT dlp_locations_infoTypes_listSignalErrorFull(worker, error_type, error_str);
    }
}
