...
/*
 * OAIGooglePrivacyDlpV2StatisticalTable.h
 *
 * An auxiliary table containing statistical information on the relative frequency of different quasi-identifiers values. It has one or several quasi-identifiers columns, and one column that indicates the relative frequency of each quasi-identifier tuple. If a tuple is present in the data but not in the auxiliary table, the corresponding relative frequency is assumed to be zero (and thus, the tuple is highly reidentifiable).
 */

#ifndef OAIGooglePrivacyDlpV2StatisticalTable_H
#define OAIGooglePrivacyDlpV2StatisticalTable_H
...
namespace OpenAPI {
class OAIGooglePrivacyDlpV2QuasiIdentifierField;
class OAIGooglePrivacyDlpV2FieldId;
class OAIGooglePrivacyDlpV2BigQueryTable;

class OAIGooglePrivacyDlpV2StatisticalTable : public OAIObject {
public:
    OAIGooglePrivacyDlpV2StatisticalTable();
    OAIGooglePrivacyDlpV2StatisticalTable(QString json);
    ~OAIGooglePrivacyDlpV2StatisticalTable() override;
    ...
    QList<OAIGooglePrivacyDlpV2QuasiIdentifierField> getQuasiIds() const;
    void setQuasiIds(const QList<OAIGooglePrivacyDlpV2QuasiIdentifierField> &quasi_ids);
...
private:
    ...
    QList<OAIGooglePrivacyDlpV2QuasiIdentifierField> m_quasi_ids;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGooglePrivacyDlpV2StatisticalTable)

#endif // OAIGooglePrivacyDlpV2StatisticalTable_H
