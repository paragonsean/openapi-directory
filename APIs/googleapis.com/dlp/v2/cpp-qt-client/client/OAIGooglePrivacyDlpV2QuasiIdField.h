...
/*
 * OAIGooglePrivacyDlpV2QuasiIdField.h
 *
 * A quasi-identifier column has a custom_tag, used to know which column in the data corresponds to which column in the statistical model.
 */

#ifndef OAIGooglePrivacyDlpV2QuasiIdField_H
#define OAIGooglePrivacyDlpV2QuasiIdField_H
...
class OAIGooglePrivacyDlpV2QuasiIdField : public OAIObject {
public:
    OAIGooglePrivacyDlpV2QuasiIdField();
    OAIGooglePrivacyDlpV2QuasiIdField(QString json);
    ~OAIGooglePrivacyDlpV2QuasiIdField() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGooglePrivacyDlpV2QuasiIdField)

#endif // OAIGooglePrivacyDlpV2QuasiIdField_H
