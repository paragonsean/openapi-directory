...
|------------- | ------------- | -------------|
| [**workflowexecutionsProjectsLocationsWorkflowsExecutionsCancel**](ProjectsApi.md#workflowexecutionsProjectsLocationsWorkflowsExecutionsCancel) | **POST** /v1beta/{name}:cancel |  |
| [**workflowexecutionsProjectsLocationsWorkflowsExecutionsCreate**](ProjectsApi.md#workflowexecutionsProjectsLocationsWorkflowsExecutionsCreate) | **POST** /v1beta/{parent}/executions |  |
| [**workflowexecutionsProjectsLocationsWorkflowsExecutionsGet**](ProjectsApi.md#workflowexecutionsProjectsLocationsWorkflowsExecutionsGet) | **GET** /v1beta/{name} |  |
| [**workflowexecutionsProjectsLocationsWorkflowsExecutionsList**](ProjectsApi.md#workflowexecutionsProjectsLocationsWorkflowsExecutionsList) | **GET** /v1beta/{parent}/executions |  |
...
<a id="workflowexecutionsProjectsLocationsWorkflowsExecutionsGet"></a>
# **workflowexecutionsProjectsLocationsWorkflowsExecutionsGet**
> Execution workflowexecutionsProjectsLocationsWorkflowsExecutionsGet(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, view)
...
public class Example {
  public static void main(String[] args) {
    ...
    ProjectsApi apiInstance = new ProjectsApi(defaultClient);
    String name = "name_example"; // String | Required. Name of the execution to be retrieved. Format: projects/{project}/locations/{location}/workflows/{workflow}/executions/{execution}
    String $xgafv = "1"; // String | V1 error format.
    String accessToken = "accessToken_example"; // String | OAuth access token.
    String alt = "json"; // String | Data format for response.
    String paramCallback = "paramCallback_example"; // String | JSONP
    ...
    try {
      Execution result = apiInstance.workflowexecutionsProjectsLocationsWorkflowsExecutionsGet(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, view);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProjectsApi#workflowexecutionsProjectsLocationsWorkflowsExecutionsGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
> ListExecutionsResponse workflowexecutionsProjectsLocationsWorkflowsExecutionsList(parent, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, pageSize, pageToken, view)
...
public class Example {
  public static void main(String[] args) {
    ...
    String uploadProtocol = "uploadProtocol_example"; // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
    String uploadType = "uploadType_example"; // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
    Integer pageSize = 56; // Integer | Maximum number of executions to return per call. Max supported value depends on the selected Execution view: it's 10000 for BASIC and 100 for FULL. The default value used if the field is not specified is 100, regardless of the selected view. Values greater than the max value will be coerced down to it.
    String pageToken = "pageToken_example"; // String | A page token, received from a previous `ListExecutions` call. Provide this to retrieve the subsequent page. When paginating, all other parameters provided to `ListExecutions` must match the call that provided the page token.
    ...
    try {
      ListExecutionsResponse result = apiInstance.workflowexecutionsProjectsLocationsWorkflowsExecutionsList(parent, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, pageSize, pageToken, view);
      System.out.println(result);
    } catch (ApiException e) {
...
| **pageToken** | **String**| A page token, received from a previous &#x60;ListExecutions&#x60; call. Provide this to retrieve the subsequent page. When paginating, all other parameters provided to &#x60;ListExecutions&#x60; must match the call that provided the page token. | [optional] |
