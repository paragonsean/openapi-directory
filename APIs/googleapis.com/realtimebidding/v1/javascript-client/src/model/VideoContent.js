...
class VideoContent {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('videoMetadata')) {
                obj['videoMetadata'] = VideoMetadata.constructFromObject(data['videoMetadata']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['videoMetadata']) { // data not null
          VideoMetadata.validateJSON(data['videoMetadata']);
        }
...
/**
 * @member {module:model/VideoMetadata} videoMetadata
 */
VideoContent.prototype['videoMetadata'] = undefined;
