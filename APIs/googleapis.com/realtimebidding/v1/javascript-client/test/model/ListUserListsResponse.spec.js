...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RealTimeBiddingApi.ListUserListsResponse();
  });
  ...
  describe('ListUserListsResponse', function() {
    it('should create an instance of ListUserListsResponse', function() {
      // uncomment below and update the code to test ListUserListsResponse
      //var instance = new RealTimeBiddingApi.ListUserListsResponse();
      //expect(instance).to.be.a(RealTimeBiddingApi.ListUserListsResponse);
    });
