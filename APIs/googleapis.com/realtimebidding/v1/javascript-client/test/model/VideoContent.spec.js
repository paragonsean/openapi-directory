...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RealTimeBiddingApi.VideoContent();
  });
  ...
  describe('VideoContent', function() {
    it('should create an instance of VideoContent', function() {
      // uncomment below and update the code to test VideoContent
      //var instance = new RealTimeBiddingApi.VideoContent();
      //expect(instance).to.be.a(RealTimeBiddingApi.VideoContent);
    });
