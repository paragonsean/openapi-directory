...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RealTimeBiddingApi.ListEndpointsResponse();
  });
  ...
  describe('ListEndpointsResponse', function() {
    it('should create an instance of ListEndpointsResponse', function() {
      ...
      //var instance = new RealTimeBiddingApi.ListEndpointsResponse();
      //expect(instance).to.be.a(RealTimeBiddingApi.ListEndpointsResponse);
    });
