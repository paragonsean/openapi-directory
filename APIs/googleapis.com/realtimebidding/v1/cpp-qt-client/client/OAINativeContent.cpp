...
QString OAINativeContent::getVideoVastXml() const {
    return m_video_vast_xml;
}
void OAINativeContent::setVideoVastXml(const QString &video_vast_xml) {
    m_video_vast_xml = video_vast_xml;
    m_video_vast_xml_isSet = true;
}

bool OAINativeContent::is_video_vast_xml_Set() const{
    return m_video_vast_xml_isSet;
}

bool OAINativeContent::is_video_vast_xml_Valid() const{
