...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AnalyticsReportingApi.MetricFilterClause();
  });
  ...
  describe('MetricFilterClause', function() {
    it('should create an instance of MetricFilterClause', function() {
      // uncomment below and update the code to test MetricFilterClause
      //var instance = new AnalyticsReportingApi.MetricFilterClause();
      //expect(instance).to.be.a(AnalyticsReportingApi.MetricFilterClause);
    });
