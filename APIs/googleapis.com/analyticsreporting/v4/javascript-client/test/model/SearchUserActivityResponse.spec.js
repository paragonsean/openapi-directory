...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AnalyticsReportingApi.SearchUserActivityResponse();
  });
  ...
  describe('SearchUserActivityResponse', function() {
    it('should create an instance of SearchUserActivityResponse', function() {
      // uncomment below and update the code to test SearchUserActivityResponse
      //var instance = new AnalyticsReportingApi.SearchUserActivityResponse();
      //expect(instance).to.be.a(AnalyticsReportingApi.SearchUserActivityResponse);
    });
