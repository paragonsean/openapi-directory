...
public class Report {
  ...
  public Report columnHeader(ColumnHeader columnHeader) {
  ...
  public Report nextPageToken(String nextPageToken) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.columnHeader, report.columnHeader) &&
        Objects.equals(this.data, report.data) &&
        Objects.equals(this.nextPageToken, report.nextPageToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(columnHeader, data, nextPageToken);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("columnHeader") != null && !jsonObj.get("columnHeader").isJsonNull()) {
        ColumnHeader.validateJsonElement(jsonObj.get("columnHeader"));
      }
      // validate the optional field `data`
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ReportData.validateJsonElement(jsonObj.get("data"));
      }
