...
void OAIReportsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("analyticsreporting_reports_batchGet", defaultConf);
    _serverIndices.insert("analyticsreporting_reports_batchGet", 0);
}
...
void OAIReportsApi::analyticsreporting_reports_batchGet(const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<OAIGetReportsRequest> &oai_get_reports_request) {
    ...
    if (oai_get_reports_request.hasValue()){

        
        QByteArray output = oai_get_reports_request.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIReportsApi::analyticsreporting_reports_batchGetCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIReportsApi::analyticsreporting_reports_batchGetCallback);
...
void OAIReportsApi::analyticsreporting_reports_batchGetCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIGetReportsResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT analyticsreporting_reports_batchGetSignal(output);
        Q_EMIT analyticsreporting_reports_batchGetSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT analyticsreporting_reports_batchGetSignalE(output, error_type, error_str);
        Q_EMIT analyticsreporting_reports_batchGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT analyticsreporting_reports_batchGetSignalError(output, error_type, error_str);
        Q_EMIT analyticsreporting_reports_batchGetSignalErrorFull(worker, error_type, error_str);
    }
}
