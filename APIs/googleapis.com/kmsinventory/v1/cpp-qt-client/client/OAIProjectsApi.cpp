...
void OAIProjectsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("kmsinventory_projects_cryptoKeys_list", defaultConf);
    _serverIndices.insert("kmsinventory_projects_cryptoKeys_list", 0);
    _serverConfigs.insert("kmsinventory_projects_locations_keyRings_cryptoKeys_getProtectedResourcesSummary", defaultConf);
    _serverIndices.insert("kmsinventory_projects_locations_keyRings_cryptoKeys_getProtectedResourcesSummary", 0);
}
...
void OAIProjectsApi::kmsinventory_projects_cryptoKeys_list(const QString &parent, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &page_token) {
    QString fullPath = QString(_serverConfigs["kmsinventory_projects_cryptoKeys_list"][_serverIndices.value("kmsinventory_projects_cryptoKeys_list")].URL()+"/v1/{parent}/cryptoKeys");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::kmsinventory_projects_cryptoKeys_listCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::kmsinventory_projects_cryptoKeys_listCallback);
...
void OAIProjectsApi::kmsinventory_projects_cryptoKeys_listCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIGoogleCloudKmsInventoryV1ListCryptoKeysResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT kmsinventory_projects_cryptoKeys_listSignal(output);
        Q_EMIT kmsinventory_projects_cryptoKeys_listSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT kmsinventory_projects_cryptoKeys_listSignalE(output, error_type, error_str);
        Q_EMIT kmsinventory_projects_cryptoKeys_listSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT kmsinventory_projects_cryptoKeys_listSignalError(output, error_type, error_str);
        Q_EMIT kmsinventory_projects_cryptoKeys_listSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectsApi::kmsinventory_projects_locations_keyRings_cryptoKeys_getProtectedResourcesSummary(const QString &name, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type) {
    QString fullPath = QString(_serverConfigs["kmsinventory_projects_locations_keyRings_cryptoKeys_getProtectedResourcesSummary"][_serverIndices.value("kmsinventory_projects_locations_keyRings_cryptoKeys_getProtectedResourcesSummary")].URL()+"/v1/{name}/protectedResourcesSummary");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::kmsinventory_projects_locations_keyRings_cryptoKeys_getProtectedResourcesSummaryCallback);
    connect(this, &OAIProjectsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::kmsinventory_projects_locations_keyRings_cryptoKeys_getProtectedResourcesSummaryCallback);
    connect(this, &OAIProjectsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectsApi::kmsinventory_projects_locations_keyRings_cryptoKeys_getProtectedResourcesSummaryCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIGoogleCloudKmsInventoryV1ProtectedResourcesSummary output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT kmsinventory_projects_locations_keyRings_cryptoKeys_getProtectedResourcesSummarySignal(output);
        Q_EMIT kmsinventory_projects_locations_keyRings_cryptoKeys_getProtectedResourcesSummarySignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("https://www.googleapis.com/auth/cloud-platform");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT kmsinventory_projects_locations_keyRings_cryptoKeys_getProtectedResourcesSummarySignalE(output, error_type, error_str);
        Q_EMIT kmsinventory_projects_locations_keyRings_cryptoKeys_getProtectedResourcesSummarySignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT kmsinventory_projects_locations_keyRings_cryptoKeys_getProtectedResourcesSummarySignalError(output, error_type, error_str);
        Q_EMIT kmsinventory_projects_locations_keyRings_cryptoKeys_getProtectedResourcesSummarySignalErrorFull(worker, error_type, error_str);
    }
}
