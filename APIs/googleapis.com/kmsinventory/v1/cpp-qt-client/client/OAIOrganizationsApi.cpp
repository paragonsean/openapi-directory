...
void OAIOrganizationsApi::initializeServerConfigs() {
    ...
    QUrl("https://kmsinventory.googleapis.com/"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("kmsinventory_organizations_protectedResources_search", defaultConf);
    _serverIndices.insert("kmsinventory_organizations_protectedResources_search", 0);
}
...
void OAIOrganizationsApi::kmsinventory_organizations_protectedResources_search(const QString &scope, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<QString> &crypto_key, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &page_token, const ::OpenAPI::OptionalParam<QList<QString>> &resource_types) {
    QString fullPath = QString(_serverConfigs["kmsinventory_organizations_protectedResources_search"][_serverIndices.value("kmsinventory_organizations_protectedResources_search")].URL()+"/v1/{scope}/protectedResources:search");
    ...
    if (crypto_key.hasValue())
    {
        ...
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "cryptoKey", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("cryptoKey")).append(querySuffix).append(QUrl::toPercentEncoding(crypto_key.stringValue()));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIOrganizationsApi::kmsinventory_organizations_protectedResources_searchCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIOrganizationsApi::kmsinventory_organizations_protectedResources_searchCallback);
...
void OAIOrganizationsApi::kmsinventory_organizations_protectedResources_searchCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIGoogleCloudKmsInventoryV1SearchProtectedResourcesResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT kmsinventory_organizations_protectedResources_searchSignal(output);
        Q_EMIT kmsinventory_organizations_protectedResources_searchSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT kmsinventory_organizations_protectedResources_searchSignalE(output, error_type, error_str);
        Q_EMIT kmsinventory_organizations_protectedResources_searchSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT kmsinventory_organizations_protectedResources_searchSignalError(output, error_type, error_str);
        Q_EMIT kmsinventory_organizations_protectedResources_searchSignalErrorFull(worker, error_type, error_str);
    }
}
