...
public class GoogleCloudKmsV1CryptoKeyVersion {
  ...
  public GoogleCloudKmsV1CryptoKeyVersion attestation(GoogleCloudKmsV1KeyOperationAttestation attestation) {
  ...
  public void setAttestation(GoogleCloudKmsV1KeyOperationAttestation attestation) {
    this.attestation = attestation;
  }
  ...
  public GoogleCloudKmsV1CryptoKeyVersion externalProtectionLevelOptions(GoogleCloudKmsV1ExternalProtectionLevelOptions externalProtectionLevelOptions) {
  ...
  public void setExternalProtectionLevelOptions(GoogleCloudKmsV1ExternalProtectionLevelOptions externalProtectionLevelOptions) {
    this.externalProtectionLevelOptions = externalProtectionLevelOptions;
  }
  ...
  public GoogleCloudKmsV1CryptoKeyVersion state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudKmsV1CryptoKeyVersion googleCloudKmsV1CryptoKeyVersion = (GoogleCloudKmsV1CryptoKeyVersion) o;
    return Objects.equals(this.algorithm, googleCloudKmsV1CryptoKeyVersion.algorithm) &&
        Objects.equals(this.attestation, googleCloudKmsV1CryptoKeyVersion.attestation) &&
        Objects.equals(this.createTime, googleCloudKmsV1CryptoKeyVersion.createTime) &&
        Objects.equals(this.destroyEventTime, googleCloudKmsV1CryptoKeyVersion.destroyEventTime) &&
        Objects.equals(this.destroyTime, googleCloudKmsV1CryptoKeyVersion.destroyTime) &&
        Objects.equals(this.externalDestructionFailureReason, googleCloudKmsV1CryptoKeyVersion.externalDestructionFailureReason) &&
        Objects.equals(this.externalProtectionLevelOptions, googleCloudKmsV1CryptoKeyVersion.externalProtectionLevelOptions) &&
        Objects.equals(this.generateTime, googleCloudKmsV1CryptoKeyVersion.generateTime) &&
        Objects.equals(this.generationFailureReason, googleCloudKmsV1CryptoKeyVersion.generationFailureReason) &&
        Objects.equals(this.importFailureReason, googleCloudKmsV1CryptoKeyVersion.importFailureReason) &&
        Objects.equals(this.importJob, googleCloudKmsV1CryptoKeyVersion.importJob) &&
        Objects.equals(this.importTime, googleCloudKmsV1CryptoKeyVersion.importTime) &&
        Objects.equals(this.name, googleCloudKmsV1CryptoKeyVersion.name) &&
        Objects.equals(this.protectionLevel, googleCloudKmsV1CryptoKeyVersion.protectionLevel) &&
        Objects.equals(this.reimportEligible, googleCloudKmsV1CryptoKeyVersion.reimportEligible) &&
        Objects.equals(this.state, googleCloudKmsV1CryptoKeyVersion.state);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudKmsV1CryptoKeyVersion {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudKmsV1CryptoKeyVersion
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudKmsV1CryptoKeyVersion.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudKmsV1CryptoKeyVersion is not found in the empty JSON string", GoogleCloudKmsV1CryptoKeyVersion.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudKmsV1CryptoKeyVersion.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudKmsV1CryptoKeyVersion` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("attestation") != null && !jsonObj.get("attestation").isJsonNull()) {
        GoogleCloudKmsV1KeyOperationAttestation.validateJsonElement(jsonObj.get("attestation"));
      }
      ...
      if (jsonObj.get("externalProtectionLevelOptions") != null && !jsonObj.get("externalProtectionLevelOptions").isJsonNull()) {
        GoogleCloudKmsV1ExternalProtectionLevelOptions.validateJsonElement(jsonObj.get("externalProtectionLevelOptions"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudKmsV1CryptoKeyVersion.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudKmsV1CryptoKeyVersion' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudKmsV1CryptoKeyVersion> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudKmsV1CryptoKeyVersion.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudKmsV1CryptoKeyVersion>() {
           @Override
           public void write(JsonWriter out, GoogleCloudKmsV1CryptoKeyVersion value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudKmsV1CryptoKeyVersion read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudKmsV1CryptoKeyVersion given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudKmsV1CryptoKeyVersion
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudKmsV1CryptoKeyVersion
   */
  public static GoogleCloudKmsV1CryptoKeyVersion fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudKmsV1CryptoKeyVersion.class);
  }

  /**
   * Convert an instance of GoogleCloudKmsV1CryptoKeyVersion to an JSON string
   *
   * @return JSON string
   */
