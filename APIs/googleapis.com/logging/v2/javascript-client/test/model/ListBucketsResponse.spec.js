...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudLoggingApi.ListBucketsResponse();
  });
  ...
  describe('ListBucketsResponse', function() {
    it('should create an instance of ListBucketsResponse', function() {
      // uncomment below and update the code to test ListBucketsResponse
      //var instance = new CloudLoggingApi.ListBucketsResponse();
      //expect(instance).to.be.a(CloudLoggingApi.ListBucketsResponse);
    });
