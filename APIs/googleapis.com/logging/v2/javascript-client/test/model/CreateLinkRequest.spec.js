...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudLoggingApi.CreateLinkRequest();
  });
  ...
  describe('CreateLinkRequest', function() {
    it('should create an instance of CreateLinkRequest', function() {
      ...
      //var instance = new CloudLoggingApi.CreateLinkRequest();
      //expect(instance).to.be.a(CloudLoggingApi.CreateLinkRequest);
    });
