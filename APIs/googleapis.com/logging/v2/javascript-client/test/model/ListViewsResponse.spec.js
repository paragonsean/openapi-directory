...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudLoggingApi.ListViewsResponse();
  });
  ...
  describe('ListViewsResponse', function() {
    it('should create an instance of ListViewsResponse', function() {
      // uncomment below and update the code to test ListViewsResponse
      //var instance = new CloudLoggingApi.ListViewsResponse();
      //expect(instance).to.be.a(CloudLoggingApi.ListViewsResponse);
    });
