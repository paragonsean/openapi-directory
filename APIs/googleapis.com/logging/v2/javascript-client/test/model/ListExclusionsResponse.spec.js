...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudLoggingApi.ListExclusionsResponse();
  });
  ...
  describe('ListExclusionsResponse', function() {
    it('should create an instance of ListExclusionsResponse', function() {
      // uncomment below and update the code to test ListExclusionsResponse
      //var instance = new CloudLoggingApi.ListExclusionsResponse();
      //expect(instance).to.be.a(CloudLoggingApi.ListExclusionsResponse);
    });
