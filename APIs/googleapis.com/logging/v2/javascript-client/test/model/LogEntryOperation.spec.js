...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudLoggingApi.LogEntryOperation();
  });
  ...
  describe('LogEntryOperation', function() {
    it('should create an instance of LogEntryOperation', function() {
      ...
      //var instance = new CloudLoggingApi.LogEntryOperation();
      //expect(instance).to.be.a(CloudLoggingApi.LogEntryOperation);
    });
