...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudLoggingApi.UpdateBucketRequest();
  });
  ...
  describe('UpdateBucketRequest', function() {
    it('should create an instance of UpdateBucketRequest', function() {
      ...
      //var instance = new CloudLoggingApi.UpdateBucketRequest();
      //expect(instance).to.be.a(CloudLoggingApi.UpdateBucketRequest);
    });
