...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudLoggingApi.ListLogMetricsResponse();
  });
  ...
  describe('ListLogMetricsResponse', function() {
    it('should create an instance of ListLogMetricsResponse', function() {
      // uncomment below and update the code to test ListLogMetricsResponse
      //var instance = new CloudLoggingApi.ListLogMetricsResponse();
      //expect(instance).to.be.a(CloudLoggingApi.ListLogMetricsResponse);
    });
