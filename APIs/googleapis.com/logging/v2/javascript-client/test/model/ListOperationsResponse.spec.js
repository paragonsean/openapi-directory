...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudLoggingApi.ListOperationsResponse();
  });
  ...
  describe('ListOperationsResponse', function() {
    it('should create an instance of ListOperationsResponse', function() {
      ...
      //var instance = new CloudLoggingApi.ListOperationsResponse();
      //expect(instance).to.be.a(CloudLoggingApi.ListOperationsResponse);
    });
