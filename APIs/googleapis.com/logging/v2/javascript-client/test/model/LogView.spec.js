...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudLoggingApi.LogView();
  });
  ...
  describe('LogView', function() {
    it('should create an instance of LogView', function() {
      // uncomment below and update the code to test LogView
      //var instance = new CloudLoggingApi.LogView();
      //expect(instance).to.be.a(CloudLoggingApi.LogView);
    });
