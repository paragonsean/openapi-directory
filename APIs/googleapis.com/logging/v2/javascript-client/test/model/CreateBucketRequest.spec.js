...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudLoggingApi.CreateBucketRequest();
  });
  ...
  describe('CreateBucketRequest', function() {
    it('should create an instance of CreateBucketRequest', function() {
      ...
      //var instance = new CloudLoggingApi.CreateBucketRequest();
      //expect(instance).to.be.a(CloudLoggingApi.CreateBucketRequest);
    });
