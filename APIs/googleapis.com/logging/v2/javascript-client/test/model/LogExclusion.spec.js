...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudLoggingApi.LogExclusion();
  });
  ...
  describe('LogExclusion', function() {
    it('should create an instance of LogExclusion', function() {
      // uncomment below and update the code to test LogExclusion
      //var instance = new CloudLoggingApi.LogExclusion();
      //expect(instance).to.be.a(CloudLoggingApi.LogExclusion);
    });
