...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudLoggingApi.SourceReference();
  });
  ...
  describe('SourceReference', function() {
    it('should create an instance of SourceReference', function() {
      // uncomment below and update the code to test SourceReference
      //var instance = new CloudLoggingApi.SourceReference();
      //expect(instance).to.be.a(CloudLoggingApi.SourceReference);
    });
