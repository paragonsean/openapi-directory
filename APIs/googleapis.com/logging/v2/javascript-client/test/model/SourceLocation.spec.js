...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudLoggingApi.SourceLocation();
  });
  ...
  describe('SourceLocation', function() {
    it('should create an instance of SourceLocation', function() {
      // uncomment below and update the code to test SourceLocation
      //var instance = new CloudLoggingApi.SourceLocation();
      //expect(instance).to.be.a(CloudLoggingApi.SourceLocation);
    });
