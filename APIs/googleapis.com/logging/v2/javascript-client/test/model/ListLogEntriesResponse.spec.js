...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudLoggingApi.ListLogEntriesResponse();
  });
  ...
  describe('ListLogEntriesResponse', function() {
    it('should create an instance of ListLogEntriesResponse', function() {
      // uncomment below and update the code to test ListLogEntriesResponse
      //var instance = new CloudLoggingApi.ListLogEntriesResponse();
      //expect(instance).to.be.a(CloudLoggingApi.ListLogEntriesResponse);
    });
