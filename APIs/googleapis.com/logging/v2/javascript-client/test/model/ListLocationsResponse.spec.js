...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudLoggingApi.ListLocationsResponse();
  });
  ...
  describe('ListLocationsResponse', function() {
    it('should create an instance of ListLocationsResponse', function() {
      ...
      //var instance = new CloudLoggingApi.ListLocationsResponse();
      //expect(instance).to.be.a(CloudLoggingApi.ListLocationsResponse);
    });
