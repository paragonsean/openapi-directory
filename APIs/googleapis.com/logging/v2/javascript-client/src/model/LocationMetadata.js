...
class LocationMetadata {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('logAnalyticsEnabled')) {
                obj['logAnalyticsEnabled'] = ApiClient.convertToType(data['logAnalyticsEnabled'], 'Boolean');
            }
        }
        return obj;
    }
 ...
 */
LocationMetadata.prototype['logAnalyticsEnabled'] = undefined;
