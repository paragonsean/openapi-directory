...
|**version** | [**VersionEnum**](#VersionEnum) | Deprecated. The API version that created or updated this metric. The v2 format is used by default and cannot be changed. |  [optional] |
