...
public class Link {
  ...
  public Link bigqueryDataset(BigQueryDataset bigqueryDataset) {
  ...
  public boolean equals(Object o) {
    ...
    Link link = (Link) o;
    return Objects.equals(this.bigqueryDataset, link.bigqueryDataset) &&
        Objects.equals(this.createTime, link.createTime) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(bigqueryDataset, createTime, description, lifecycleState, name);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("bigqueryDataset") != null && !jsonObj.get("bigqueryDataset").isJsonNull()) {
        BigQueryDataset.validateJsonElement(jsonObj.get("bigqueryDataset"));
      }
