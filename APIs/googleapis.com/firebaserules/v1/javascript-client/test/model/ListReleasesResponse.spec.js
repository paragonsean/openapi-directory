...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FirebaseRulesApi.ListReleasesResponse();
  });
  ...
  describe('ListReleasesResponse', function() {
    it('should create an instance of ListReleasesResponse', function() {
      ...
      //var instance = new FirebaseRulesApi.ListReleasesResponse();
      //expect(instance).to.be.a(FirebaseRulesApi.ListReleasesResponse);
    });
