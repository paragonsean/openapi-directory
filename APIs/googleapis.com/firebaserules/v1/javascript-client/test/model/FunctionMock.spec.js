...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FirebaseRulesApi.FunctionMock();
  });
  ...
  describe('FunctionMock', function() {
    it('should create an instance of FunctionMock', function() {
      // uncomment below and update the code to test FunctionMock
      //var instance = new FirebaseRulesApi.FunctionMock();
      //expect(instance).to.be.a(FirebaseRulesApi.FunctionMock);
    });
