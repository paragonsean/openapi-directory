...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FirebaseRulesApi.ListRulesetsResponse();
  });
  ...
  describe('ListRulesetsResponse', function() {
    it('should create an instance of ListRulesetsResponse', function() {
      // uncomment below and update the code to test ListRulesetsResponse
      //var instance = new FirebaseRulesApi.ListRulesetsResponse();
      //expect(instance).to.be.a(FirebaseRulesApi.ListRulesetsResponse);
    });
