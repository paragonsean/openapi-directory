...
public class Alert {
  ...
  private String kind = "adsense#alert";
  ...
  public Alert isDismissible(Boolean isDismissible) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, alert.id) &&
        Objects.equals(this.isDismissible, alert.isDismissible) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, isDismissible, kind, message, severity, type);
  }
