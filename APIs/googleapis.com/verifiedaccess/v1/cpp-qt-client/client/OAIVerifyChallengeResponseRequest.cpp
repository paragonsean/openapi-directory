...
OAISignedData OAIVerifyChallengeResponseRequest::getChallengeResponse() const {
    return m_challenge_response;
}
void OAIVerifyChallengeResponseRequest::setChallengeResponse(const OAISignedData &challenge_response) {
