...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BloggerApi.PostList();
  });
  ...
  describe('PostList', function() {
    it('should create an instance of PostList', function() {
      // uncomment below and update the code to test PostList
      //var instance = new BloggerApi.PostList();
      //expect(instance).to.be.a(BloggerApi.PostList);
    });
