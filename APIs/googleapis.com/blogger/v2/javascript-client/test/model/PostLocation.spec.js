...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BloggerApi.PostLocation();
  });
  ...
  describe('PostLocation', function() {
    it('should create an instance of PostLocation', function() {
      // uncomment below and update the code to test PostLocation
      //var instance = new BloggerApi.PostLocation();
      //expect(instance).to.be.a(BloggerApi.PostLocation);
    });
