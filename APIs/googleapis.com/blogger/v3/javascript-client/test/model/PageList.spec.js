...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BloggerApi.PageList();
  });
  ...
  describe('PageList', function() {
    it('should create an instance of PageList', function() {
      // uncomment below and update the code to test PageList
      //var instance = new BloggerApi.PageList();
      //expect(instance).to.be.a(BloggerApi.PageList);
    });
