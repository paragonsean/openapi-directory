...
> PostUserInfo bloggerPostUserInfosGet(userId, blogId, postId, opts)
...
let apiInstance = new BloggerApi.PostUserInfosApi();
...
apiInstance.bloggerPostUserInfosGet(userId, blogId, postId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> PostUserInfosList bloggerPostUserInfosList(userId, blogId, opts)
...
apiInstance.bloggerPostUserInfosList(userId, blogId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
