...
|**labels** | **List&lt;String&gt;** | The list of labels this Post was tagged with. |  [optional] |
|**location** | [**PostLocation**](PostLocation.md) |  |  [optional] |
|**published** | **String** | RFC 3339 date-time when this Post was published. |  [optional] |
|**readerComments** | [**ReaderCommentsEnum**](#ReaderCommentsEnum) | Comment control and display setting for readers of this post. |  [optional] |
|**replies** | [**PostReplies**](PostReplies.md) |  |  [optional] |
|**selfLink** | **String** | The API REST URL to fetch this resource from. |  [optional] |
|**status** | [**StatusEnum**](#StatusEnum) | Status of the post. Only set for admin-level requests. |  [optional] |
