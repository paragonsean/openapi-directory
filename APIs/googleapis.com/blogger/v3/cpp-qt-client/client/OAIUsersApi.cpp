...
void OAIUsersApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("blogger_users_get", defaultConf);
    _serverIndices.insert("blogger_users_get", 0);
}
...
void OAIUsersApi::blogger_users_get(const QString &user_id, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIUsersApi::blogger_users_getCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIUsersApi::blogger_users_getCallback);
...
void OAIUsersApi::blogger_users_getCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT blogger_users_getSignal(output);
        Q_EMIT blogger_users_getSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT blogger_users_getSignalE(output, error_type, error_str);
        Q_EMIT blogger_users_getSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT blogger_users_getSignalError(output, error_type, error_str);
        Q_EMIT blogger_users_getSignalErrorFull(worker, error_type, error_str);
    }
}
