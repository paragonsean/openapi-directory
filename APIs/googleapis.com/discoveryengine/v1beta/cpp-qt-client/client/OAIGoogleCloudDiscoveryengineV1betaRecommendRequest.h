...
/*
 * OAIGoogleCloudDiscoveryengineV1betaRecommendRequest.h
 *
 * Request message for Recommend method.
 */

#ifndef OAIGoogleCloudDiscoveryengineV1betaRecommendRequest_H
#define OAIGoogleCloudDiscoveryengineV1betaRecommendRequest_H
...
class OAIGoogleCloudDiscoveryengineV1betaRecommendRequest : public OAIObject {
public:
    OAIGoogleCloudDiscoveryengineV1betaRecommendRequest();
    OAIGoogleCloudDiscoveryengineV1betaRecommendRequest(QString json);
    ~OAIGoogleCloudDiscoveryengineV1betaRecommendRequest() override;
    ...
    OAIGoogleCloudDiscoveryengineV1betaUserEvent getUserEvent() const;
    void setUserEvent(const OAIGoogleCloudDiscoveryengineV1betaUserEvent &user_event);
...
private:
    ...
    OAIGoogleCloudDiscoveryengineV1betaUserEvent m_user_event;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudDiscoveryengineV1betaRecommendRequest)

#endif // OAIGoogleCloudDiscoveryengineV1betaRecommendRequest_H
