...
/*
 * OAIGoogleCloudDiscoveryengineV1alphaEngineChatEngineConfigAgentCreationConfig.h
 *
...
#ifndef OAIGoogleCloudDiscoveryengineV1alphaEngineChatEngineConfigAgentCreationConfig_H
#define OAIGoogleCloudDiscoveryengineV1alphaEngineChatEngineConfigAgentCreationConfig_H
...
class OAIGoogleCloudDiscoveryengineV1alphaEngineChatEngineConfigAgentCreationConfig : public OAIObject {
public:
    OAIGoogleCloudDiscoveryengineV1alphaEngineChatEngineConfigAgentCreationConfig();
    OAIGoogleCloudDiscoveryengineV1alphaEngineChatEngineConfigAgentCreationConfig(QString json);
    ~OAIGoogleCloudDiscoveryengineV1alphaEngineChatEngineConfigAgentCreationConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudDiscoveryengineV1alphaEngineChatEngineConfigAgentCreationConfig)

#endif // OAIGoogleCloudDiscoveryengineV1alphaEngineChatEngineConfigAgentCreationConfig_H
