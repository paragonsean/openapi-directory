...
/*
 * OAIGoogleCloudDiscoveryengineV1betaEngineChatEngineConfigAgentCreationConfig.h
 *
...
#ifndef OAIGoogleCloudDiscoveryengineV1betaEngineChatEngineConfigAgentCreationConfig_H
#define OAIGoogleCloudDiscoveryengineV1betaEngineChatEngineConfigAgentCreationConfig_H
...
class OAIGoogleCloudDiscoveryengineV1betaEngineChatEngineConfigAgentCreationConfig : public OAIObject {
public:
    OAIGoogleCloudDiscoveryengineV1betaEngineChatEngineConfigAgentCreationConfig();
    OAIGoogleCloudDiscoveryengineV1betaEngineChatEngineConfigAgentCreationConfig(QString json);
    ~OAIGoogleCloudDiscoveryengineV1betaEngineChatEngineConfigAgentCreationConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudDiscoveryengineV1betaEngineChatEngineConfigAgentCreationConfig)

#endif // OAIGoogleCloudDiscoveryengineV1betaEngineChatEngineConfigAgentCreationConfig_H
