# DiscoveryEngineApi.GoogleCloudDiscoveryengineV1betaDocument
...
**derivedStructData** | **{String: Object}** | Output only. This field is OUTPUT_ONLY. It contains derived data that are not in the original input document. | [optional] [readonly] 
...
**structData** | **{String: Object}** | The structured JSON data for the document. It should conform to the registered Schema or an &#x60;INVALID_ARGUMENT&#x60; error is thrown. | [optional] 
