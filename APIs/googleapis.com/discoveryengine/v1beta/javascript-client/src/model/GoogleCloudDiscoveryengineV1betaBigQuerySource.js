...
/**
 * The GoogleCloudDiscoveryengineV1betaBigQuerySource model module.
 * @module model/GoogleCloudDiscoveryengineV1betaBigQuerySource
 * @version v1beta
 */
class GoogleCloudDiscoveryengineV1betaBigQuerySource {
    /**
     * Constructs a new <code>GoogleCloudDiscoveryengineV1betaBigQuerySource</code>.
     * BigQuery source import data from.
     * @alias module:model/GoogleCloudDiscoveryengineV1betaBigQuerySource
     */
    constructor() { 
        
        GoogleCloudDiscoveryengineV1betaBigQuerySource.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudDiscoveryengineV1betaBigQuerySource</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudDiscoveryengineV1betaBigQuerySource} obj Optional instance to populate.
     * @return {module:model/GoogleCloudDiscoveryengineV1betaBigQuerySource} The populated <code>GoogleCloudDiscoveryengineV1betaBigQuerySource</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudDiscoveryengineV1betaBigQuerySource();
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudDiscoveryengineV1betaBigQuerySource</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudDiscoveryengineV1betaBigQuerySource</code>.
     */
 ...
 */
GoogleCloudDiscoveryengineV1betaBigQuerySource.prototype['dataSchema'] = undefined;

/**
 * Required. The BigQuery data set to copy the data from with a length limit of 1,024 characters.
 * @member {String} datasetId
 */
GoogleCloudDiscoveryengineV1betaBigQuerySource.prototype['datasetId'] = undefined;

/**
 * Intermediate Cloud Storage directory used for the import with a length limit of 2,000 characters. Can be specified if one wants to have the BigQuery export to a specific Cloud Storage directory.
 * @member {String} gcsStagingDir
 */
GoogleCloudDiscoveryengineV1betaBigQuerySource.prototype['gcsStagingDir'] = undefined;

/**
 * @member {module:model/GoogleTypeDate} partitionDate
 */
GoogleCloudDiscoveryengineV1betaBigQuerySource.prototype['partitionDate'] = undefined;

/**
 * The project ID (can be project # or ID) that the BigQuery source is in with a length limit of 128 characters. If not specified, inherits the project ID from the parent request.
 * @member {String} projectId
 */
GoogleCloudDiscoveryengineV1betaBigQuerySource.prototype['projectId'] = undefined;

/**
 * Required. The BigQuery table to copy the data from with a length limit of 1,024 characters.
 * @member {String} tableId
 */
GoogleCloudDiscoveryengineV1betaBigQuerySource.prototype['tableId'] = undefined;
...
export default GoogleCloudDiscoveryengineV1betaBigQuerySource;
