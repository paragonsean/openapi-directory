...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DiscoveryEngineApi.GoogleCloudDiscoveryengineV1betaSearchRequestFacetSpecFacetKey();
  });
  ...
  describe('GoogleCloudDiscoveryengineV1betaSearchRequestFacetSpecFacetKey', function() {
    it('should create an instance of GoogleCloudDiscoveryengineV1betaSearchRequestFacetSpecFacetKey', function() {
      // uncomment below and update the code to test GoogleCloudDiscoveryengineV1betaSearchRequestFacetSpecFacetKey
      //var instance = new DiscoveryEngineApi.GoogleCloudDiscoveryengineV1betaSearchRequestFacetSpecFacetKey();
      //expect(instance).to.be.a(DiscoveryEngineApi.GoogleCloudDiscoveryengineV1betaSearchRequestFacetSpecFacetKey);
    });
