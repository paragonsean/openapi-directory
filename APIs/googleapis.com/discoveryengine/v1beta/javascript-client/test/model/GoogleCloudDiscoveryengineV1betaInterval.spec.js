...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DiscoveryEngineApi.GoogleCloudDiscoveryengineV1betaInterval();
  });
  ...
  describe('GoogleCloudDiscoveryengineV1betaInterval', function() {
    it('should create an instance of GoogleCloudDiscoveryengineV1betaInterval', function() {
      // uncomment below and update the code to test GoogleCloudDiscoveryengineV1betaInterval
      //var instance = new DiscoveryEngineApi.GoogleCloudDiscoveryengineV1betaInterval();
      //expect(instance).to.be.a(DiscoveryEngineApi.GoogleCloudDiscoveryengineV1betaInterval);
    });
