...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DiscoveryEngineApi.GoogleTypeDate();
  });
  ...
  describe('GoogleTypeDate', function() {
    it('should create an instance of GoogleTypeDate', function() {
      ...
      //var instance = new DiscoveryEngineApi.GoogleTypeDate();
      //expect(instance).to.be.a(DiscoveryEngineApi.GoogleTypeDate);
    });
