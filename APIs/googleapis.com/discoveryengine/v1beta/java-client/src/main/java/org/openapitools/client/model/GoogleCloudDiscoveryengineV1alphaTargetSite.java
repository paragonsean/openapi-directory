...
public class GoogleCloudDiscoveryengineV1alphaTargetSite {
  ...
  public GoogleCloudDiscoveryengineV1alphaTargetSite() {
  }
  ...
  public GoogleCloudDiscoveryengineV1alphaTargetSite exactMatch(Boolean exactMatch) {
  ...
  public GoogleCloudDiscoveryengineV1alphaTargetSite failureReason(GoogleCloudDiscoveryengineV1alphaTargetSiteFailureReason failureReason) {
  ...
  public void setFailureReason(GoogleCloudDiscoveryengineV1alphaTargetSiteFailureReason failureReason) {
    this.failureReason = failureReason;
  }
  ...
  public GoogleCloudDiscoveryengineV1alphaTargetSite providedUriPattern(String providedUriPattern) {
  ...
  public GoogleCloudDiscoveryengineV1alphaTargetSite siteVerificationInfo(GoogleCloudDiscoveryengineV1alphaSiteVerificationInfo siteVerificationInfo) {
  ...
  public void setSiteVerificationInfo(GoogleCloudDiscoveryengineV1alphaSiteVerificationInfo siteVerificationInfo) {
    this.siteVerificationInfo = siteVerificationInfo;
  }


  public GoogleCloudDiscoveryengineV1alphaTargetSite type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudDiscoveryengineV1alphaTargetSite googleCloudDiscoveryengineV1alphaTargetSite = (GoogleCloudDiscoveryengineV1alphaTargetSite) o;
    return Objects.equals(this.exactMatch, googleCloudDiscoveryengineV1alphaTargetSite.exactMatch) &&
        Objects.equals(this.failureReason, googleCloudDiscoveryengineV1alphaTargetSite.failureReason) &&
        Objects.equals(this.generatedUriPattern, googleCloudDiscoveryengineV1alphaTargetSite.generatedUriPattern) &&
        Objects.equals(this.indexingStatus, googleCloudDiscoveryengineV1alphaTargetSite.indexingStatus) &&
        Objects.equals(this.name, googleCloudDiscoveryengineV1alphaTargetSite.name) &&
        Objects.equals(this.providedUriPattern, googleCloudDiscoveryengineV1alphaTargetSite.providedUriPattern) &&
        Objects.equals(this.siteVerificationInfo, googleCloudDiscoveryengineV1alphaTargetSite.siteVerificationInfo) &&
        Objects.equals(this.type, googleCloudDiscoveryengineV1alphaTargetSite.type) &&
        Objects.equals(this.updateTime, googleCloudDiscoveryengineV1alphaTargetSite.updateTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudDiscoveryengineV1alphaTargetSite {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudDiscoveryengineV1alphaTargetSite
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudDiscoveryengineV1alphaTargetSite.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudDiscoveryengineV1alphaTargetSite is not found in the empty JSON string", GoogleCloudDiscoveryengineV1alphaTargetSite.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudDiscoveryengineV1alphaTargetSite.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudDiscoveryengineV1alphaTargetSite` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `failureReason`
      if (jsonObj.get("failureReason") != null && !jsonObj.get("failureReason").isJsonNull()) {
        GoogleCloudDiscoveryengineV1alphaTargetSiteFailureReason.validateJsonElement(jsonObj.get("failureReason"));
      }
      ...
      if (jsonObj.get("siteVerificationInfo") != null && !jsonObj.get("siteVerificationInfo").isJsonNull()) {
        GoogleCloudDiscoveryengineV1alphaSiteVerificationInfo.validateJsonElement(jsonObj.get("siteVerificationInfo"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudDiscoveryengineV1alphaTargetSite.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudDiscoveryengineV1alphaTargetSite' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudDiscoveryengineV1alphaTargetSite> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudDiscoveryengineV1alphaTargetSite.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudDiscoveryengineV1alphaTargetSite>() {
           @Override
           public void write(JsonWriter out, GoogleCloudDiscoveryengineV1alphaTargetSite value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudDiscoveryengineV1alphaTargetSite read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudDiscoveryengineV1alphaTargetSite given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudDiscoveryengineV1alphaTargetSite
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudDiscoveryengineV1alphaTargetSite
   */
  public static GoogleCloudDiscoveryengineV1alphaTargetSite fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudDiscoveryengineV1alphaTargetSite.class);
  }

  /**
   * Convert an instance of GoogleCloudDiscoveryengineV1alphaTargetSite to an JSON string
   *
   * @return JSON string
   */
