...
public class GoogleCloudDiscoveryengineV1betaEngine {
  ...
  public GoogleCloudDiscoveryengineV1betaEngine() {
  }
  ...
  public GoogleCloudDiscoveryengineV1betaEngine chatEngineConfig(GoogleCloudDiscoveryengineV1betaEngineChatEngineConfig chatEngineConfig) {
  ...
  public void setChatEngineConfig(GoogleCloudDiscoveryengineV1betaEngineChatEngineConfig chatEngineConfig) {
    this.chatEngineConfig = chatEngineConfig;
  }


  public GoogleCloudDiscoveryengineV1betaEngine chatEngineMetadata(GoogleCloudDiscoveryengineV1betaEngineChatEngineMetadata chatEngineMetadata) {
  ...
  public void setChatEngineMetadata(GoogleCloudDiscoveryengineV1betaEngineChatEngineMetadata chatEngineMetadata) {
    this.chatEngineMetadata = chatEngineMetadata;
  }


  public GoogleCloudDiscoveryengineV1betaEngine commonConfig(GoogleCloudDiscoveryengineV1betaEngineCommonConfig commonConfig) {
  ...
  public void setCommonConfig(GoogleCloudDiscoveryengineV1betaEngineCommonConfig commonConfig) {
    this.commonConfig = commonConfig;
  }
  ...
  public GoogleCloudDiscoveryengineV1betaEngine dataStoreIds(List<String> dataStoreIds) {
    this.dataStoreIds = dataStoreIds;
    return this;
  }

  public GoogleCloudDiscoveryengineV1betaEngine addDataStoreIdsItem(String dataStoreIdsItem) {
  ...
  public GoogleCloudDiscoveryengineV1betaEngine displayName(String displayName) {
  ...
  public GoogleCloudDiscoveryengineV1betaEngine industryVertical(IndustryVerticalEnum industryVertical) {
  ...
  public GoogleCloudDiscoveryengineV1betaEngine name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GoogleCloudDiscoveryengineV1betaEngine searchEngineConfig(GoogleCloudDiscoveryengineV1betaEngineSearchEngineConfig searchEngineConfig) {
  ...
  public void setSearchEngineConfig(GoogleCloudDiscoveryengineV1betaEngineSearchEngineConfig searchEngineConfig) {
    this.searchEngineConfig = searchEngineConfig;
  }


  public GoogleCloudDiscoveryengineV1betaEngine solutionType(SolutionTypeEnum solutionType) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudDiscoveryengineV1betaEngine googleCloudDiscoveryengineV1betaEngine = (GoogleCloudDiscoveryengineV1betaEngine) o;
    return Objects.equals(this.chatEngineConfig, googleCloudDiscoveryengineV1betaEngine.chatEngineConfig) &&
        Objects.equals(this.chatEngineMetadata, googleCloudDiscoveryengineV1betaEngine.chatEngineMetadata) &&
        Objects.equals(this.commonConfig, googleCloudDiscoveryengineV1betaEngine.commonConfig) &&
        Objects.equals(this.createTime, googleCloudDiscoveryengineV1betaEngine.createTime) &&
        Objects.equals(this.dataStoreIds, googleCloudDiscoveryengineV1betaEngine.dataStoreIds) &&
        Objects.equals(this.displayName, googleCloudDiscoveryengineV1betaEngine.displayName) &&
        Objects.equals(this.industryVertical, googleCloudDiscoveryengineV1betaEngine.industryVertical) &&
        Objects.equals(this.name, googleCloudDiscoveryengineV1betaEngine.name) &&
        Objects.equals(this.searchEngineConfig, googleCloudDiscoveryengineV1betaEngine.searchEngineConfig) &&
        Objects.equals(this.solutionType, googleCloudDiscoveryengineV1betaEngine.solutionType) &&
        Objects.equals(this.updateTime, googleCloudDiscoveryengineV1betaEngine.updateTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudDiscoveryengineV1betaEngine {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudDiscoveryengineV1betaEngine
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudDiscoveryengineV1betaEngine.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudDiscoveryengineV1betaEngine is not found in the empty JSON string", GoogleCloudDiscoveryengineV1betaEngine.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudDiscoveryengineV1betaEngine.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudDiscoveryengineV1betaEngine` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("chatEngineConfig") != null && !jsonObj.get("chatEngineConfig").isJsonNull()) {
        GoogleCloudDiscoveryengineV1betaEngineChatEngineConfig.validateJsonElement(jsonObj.get("chatEngineConfig"));
      }
      ...
      if (jsonObj.get("chatEngineMetadata") != null && !jsonObj.get("chatEngineMetadata").isJsonNull()) {
        GoogleCloudDiscoveryengineV1betaEngineChatEngineMetadata.validateJsonElement(jsonObj.get("chatEngineMetadata"));
      }
      // validate the optional field `commonConfig`
      if (jsonObj.get("commonConfig") != null && !jsonObj.get("commonConfig").isJsonNull()) {
        GoogleCloudDiscoveryengineV1betaEngineCommonConfig.validateJsonElement(jsonObj.get("commonConfig"));
      }
      ...
      if (jsonObj.get("searchEngineConfig") != null && !jsonObj.get("searchEngineConfig").isJsonNull()) {
        GoogleCloudDiscoveryengineV1betaEngineSearchEngineConfig.validateJsonElement(jsonObj.get("searchEngineConfig"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudDiscoveryengineV1betaEngine.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudDiscoveryengineV1betaEngine' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudDiscoveryengineV1betaEngine> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudDiscoveryengineV1betaEngine.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudDiscoveryengineV1betaEngine>() {
           @Override
           public void write(JsonWriter out, GoogleCloudDiscoveryengineV1betaEngine value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudDiscoveryengineV1betaEngine read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudDiscoveryengineV1betaEngine given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudDiscoveryengineV1betaEngine
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudDiscoveryengineV1betaEngine
   */
  public static GoogleCloudDiscoveryengineV1betaEngine fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudDiscoveryengineV1betaEngine.class);
  }

  /**
   * Convert an instance of GoogleCloudDiscoveryengineV1betaEngine to an JSON string
   *
   * @return JSON string
   */
