...
|------------ | ------------- | ------------- | -------------|
|**errorMessage** | **String** | The error produced. |  [optional] |
|**originalAddressQuery** | **String** | The address from which forward geocoding ingestion produced issues. |  [optional] |
