# DiscoveryEngineApi.GoogleCloudDiscoveryengineV1alphaImportDocumentsRequest
...
**reconciliationMode** | **String** | The mode of reconciliation between existing documents and the documents to be imported. Defaults to ReconciliationMode.INCREMENTAL. | [optional] 
