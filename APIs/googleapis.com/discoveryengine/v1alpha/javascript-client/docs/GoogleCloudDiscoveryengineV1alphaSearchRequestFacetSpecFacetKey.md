# DiscoveryEngineApi.GoogleCloudDiscoveryengineV1alphaSearchRequestFacetSpecFacetKey
...
**intervals** | [**[GoogleCloudDiscoveryengineV1alphaInterval]**](GoogleCloudDiscoveryengineV1alphaInterval.md) | Set only if values should be bucketed into intervals. Must be set for facets with numerical values. Must not be set for facet with text values. Maximum number of intervals is 30. | [optional] 
