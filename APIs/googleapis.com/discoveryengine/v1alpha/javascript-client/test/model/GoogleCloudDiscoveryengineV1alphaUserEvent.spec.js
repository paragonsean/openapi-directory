...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DiscoveryEngineApi.GoogleCloudDiscoveryengineV1alphaUserEvent();
  });
  ...
  describe('GoogleCloudDiscoveryengineV1alphaUserEvent', function() {
    it('should create an instance of GoogleCloudDiscoveryengineV1alphaUserEvent', function() {
      // uncomment below and update the code to test GoogleCloudDiscoveryengineV1alphaUserEvent
      //var instance = new DiscoveryEngineApi.GoogleCloudDiscoveryengineV1alphaUserEvent();
      //expect(instance).to.be.a(DiscoveryEngineApi.GoogleCloudDiscoveryengineV1alphaUserEvent);
    });
