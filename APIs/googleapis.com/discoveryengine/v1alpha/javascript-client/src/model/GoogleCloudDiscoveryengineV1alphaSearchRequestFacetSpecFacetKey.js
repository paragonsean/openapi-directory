...
/**
 * The GoogleCloudDiscoveryengineV1alphaSearchRequestFacetSpecFacetKey model module.
 * @module model/GoogleCloudDiscoveryengineV1alphaSearchRequestFacetSpecFacetKey
 * @version v1alpha
 */
class GoogleCloudDiscoveryengineV1alphaSearchRequestFacetSpecFacetKey {
    /**
     * Constructs a new <code>GoogleCloudDiscoveryengineV1alphaSearchRequestFacetSpecFacetKey</code>.
     * Specifies how a facet is computed.
     * @alias module:model/GoogleCloudDiscoveryengineV1alphaSearchRequestFacetSpecFacetKey
     */
    constructor() { 
        
        GoogleCloudDiscoveryengineV1alphaSearchRequestFacetSpecFacetKey.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudDiscoveryengineV1alphaSearchRequestFacetSpecFacetKey</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudDiscoveryengineV1alphaSearchRequestFacetSpecFacetKey} obj Optional instance to populate.
     * @return {module:model/GoogleCloudDiscoveryengineV1alphaSearchRequestFacetSpecFacetKey} The populated <code>GoogleCloudDiscoveryengineV1alphaSearchRequestFacetSpecFacetKey</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudDiscoveryengineV1alphaSearchRequestFacetSpecFacetKey();
            ...
            if (data.hasOwnProperty('intervals')) {
                obj['intervals'] = ApiClient.convertToType(data['intervals'], [GoogleCloudDiscoveryengineV1alphaInterval]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudDiscoveryengineV1alphaSearchRequestFacetSpecFacetKey</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudDiscoveryengineV1alphaSearchRequestFacetSpecFacetKey</code>.
     */
    static validateJSON(data) {
        ...
        if (data['intervals']) { // data not null
            ...
            for (const item of data['intervals']) {
                GoogleCloudDiscoveryengineV1alphaInterval.validateJSON(item);
            };
        }
 ...
 */
GoogleCloudDiscoveryengineV1alphaSearchRequestFacetSpecFacetKey.prototype['caseInsensitive'] = undefined;
 ...
 */
GoogleCloudDiscoveryengineV1alphaSearchRequestFacetSpecFacetKey.prototype['contains'] = undefined;
 ...
 * @member {Array.<module:model/GoogleCloudDiscoveryengineV1alphaInterval>} intervals
 */
GoogleCloudDiscoveryengineV1alphaSearchRequestFacetSpecFacetKey.prototype['intervals'] = undefined;
 ...
 * @member {String} key
 */
GoogleCloudDiscoveryengineV1alphaSearchRequestFacetSpecFacetKey.prototype['key'] = undefined;

/**
 * The order in which documents are returned. Allowed values are: * \"count desc\", which means order by SearchResponse.Facet.values.count descending. * \"value desc\", which means order by SearchResponse.Facet.values.value descending. Only applies to textual facets. If not set, textual values are sorted in [natural order](https://en.wikipedia.org/wiki/Natural_sort_order); numerical intervals are sorted in the order given by FacetSpec.FacetKey.intervals.
 * @member {String} orderBy
 */
GoogleCloudDiscoveryengineV1alphaSearchRequestFacetSpecFacetKey.prototype['orderBy'] = undefined;
 ...
 */
GoogleCloudDiscoveryengineV1alphaSearchRequestFacetSpecFacetKey.prototype['prefixes'] = undefined;
 ...
 */
GoogleCloudDiscoveryengineV1alphaSearchRequestFacetSpecFacetKey.prototype['restrictedValues'] = undefined;
...
export default GoogleCloudDiscoveryengineV1alphaSearchRequestFacetSpecFacetKey;
