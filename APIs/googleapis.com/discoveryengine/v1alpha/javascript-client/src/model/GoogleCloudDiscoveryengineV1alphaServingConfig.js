...
import GoogleCloudDiscoveryengineV1alphaEmbeddingConfig from './GoogleCloudDiscoveryengineV1alphaEmbeddingConfig';
import GoogleCloudDiscoveryengineV1alphaGuidedSearchSpec from './GoogleCloudDiscoveryengineV1alphaGuidedSearchSpec';
import GoogleCloudDiscoveryengineV1alphaServingConfigGenericConfig from './GoogleCloudDiscoveryengineV1alphaServingConfigGenericConfig';
import GoogleCloudDiscoveryengineV1alphaServingConfigMediaConfig from './GoogleCloudDiscoveryengineV1alphaServingConfigMediaConfig';

/**
 * The GoogleCloudDiscoveryengineV1alphaServingConfig model module.
 * @module model/GoogleCloudDiscoveryengineV1alphaServingConfig
 * @version v1alpha
 */
class GoogleCloudDiscoveryengineV1alphaServingConfig {
    /**
     * Constructs a new <code>GoogleCloudDiscoveryengineV1alphaServingConfig</code>.
     ...
     * @alias module:model/GoogleCloudDiscoveryengineV1alphaServingConfig
     */
    constructor() { 
        
        GoogleCloudDiscoveryengineV1alphaServingConfig.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudDiscoveryengineV1alphaServingConfig</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudDiscoveryengineV1alphaServingConfig} obj Optional instance to populate.
     * @return {module:model/GoogleCloudDiscoveryengineV1alphaServingConfig} The populated <code>GoogleCloudDiscoveryengineV1alphaServingConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudDiscoveryengineV1alphaServingConfig();
            ...
            if (data.hasOwnProperty('embeddingConfig')) {
                obj['embeddingConfig'] = GoogleCloudDiscoveryengineV1alphaEmbeddingConfig.constructFromObject(data['embeddingConfig']);
            }
            ...
            if (data.hasOwnProperty('genericConfig')) {
                obj['genericConfig'] = GoogleCloudDiscoveryengineV1alphaServingConfigGenericConfig.constructFromObject(data['genericConfig']);
            }
            if (data.hasOwnProperty('guidedSearchSpec')) {
                obj['guidedSearchSpec'] = GoogleCloudDiscoveryengineV1alphaGuidedSearchSpec.constructFromObject(data['guidedSearchSpec']);
            }
            ...
            if (data.hasOwnProperty('mediaConfig')) {
                obj['mediaConfig'] = GoogleCloudDiscoveryengineV1alphaServingConfigMediaConfig.constructFromObject(data['mediaConfig']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudDiscoveryengineV1alphaServingConfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudDiscoveryengineV1alphaServingConfig</code>.
     */
    static validateJSON(data) {
        ...
        if (data['embeddingConfig']) { // data not null
          GoogleCloudDiscoveryengineV1alphaEmbeddingConfig.validateJSON(data['embeddingConfig']);
        }
        // ensure the json data is an array
        ...
        if (data['genericConfig']) { // data not null
          GoogleCloudDiscoveryengineV1alphaServingConfigGenericConfig.validateJSON(data['genericConfig']);
        }
        // validate the optional field `guidedSearchSpec`
        if (data['guidedSearchSpec']) { // data not null
          GoogleCloudDiscoveryengineV1alphaGuidedSearchSpec.validateJSON(data['guidedSearchSpec']);
        }
        // ensure the json data is an array
        ...
        if (data['mediaConfig']) { // data not null
          GoogleCloudDiscoveryengineV1alphaServingConfigMediaConfig.validateJSON(data['mediaConfig']);
        }
        // ensure the json data is a string
 ...
 */
GoogleCloudDiscoveryengineV1alphaServingConfig.prototype['boostControlIds'] = undefined;

/**
 * Output only. ServingConfig created timestamp.
 * @member {String} createTime
 */
GoogleCloudDiscoveryengineV1alphaServingConfig.prototype['createTime'] = undefined;

/**
 * @member {module:model/GoogleCloudDiscoveryengineV1alphaCustomFineTuningSpec} customFineTuningSpec
 */
GoogleCloudDiscoveryengineV1alphaServingConfig.prototype['customFineTuningSpec'] = undefined;
 ...
 */
GoogleCloudDiscoveryengineV1alphaServingConfig.prototype['displayName'] = undefined;
 ...
 */
GoogleCloudDiscoveryengineV1alphaServingConfig.prototype['dissociateControlIds'] = undefined;
 ...
 */
GoogleCloudDiscoveryengineV1alphaServingConfig.prototype['diversityLevel'] = undefined;

/**
 * @member {module:model/GoogleCloudDiscoveryengineV1alphaEmbeddingConfig} embeddingConfig
 */
GoogleCloudDiscoveryengineV1alphaServingConfig.prototype['embeddingConfig'] = undefined;
 ...
 */
GoogleCloudDiscoveryengineV1alphaServingConfig.prototype['filterControlIds'] = undefined;

/**
 * @member {module:model/GoogleCloudDiscoveryengineV1alphaServingConfigGenericConfig} genericConfig
 */
GoogleCloudDiscoveryengineV1alphaServingConfig.prototype['genericConfig'] = undefined;

/**
 * @member {module:model/GoogleCloudDiscoveryengineV1alphaGuidedSearchSpec} guidedSearchSpec
 */
GoogleCloudDiscoveryengineV1alphaServingConfig.prototype['guidedSearchSpec'] = undefined;
 ...
 */
GoogleCloudDiscoveryengineV1alphaServingConfig.prototype['ignoreControlIds'] = undefined;

/**
 * @member {module:model/GoogleCloudDiscoveryengineV1alphaServingConfigMediaConfig} mediaConfig
 */
GoogleCloudDiscoveryengineV1alphaServingConfig.prototype['mediaConfig'] = undefined;
 ...
 */
GoogleCloudDiscoveryengineV1alphaServingConfig.prototype['modelId'] = undefined;
 ...
 * @member {String} name
 */
GoogleCloudDiscoveryengineV1alphaServingConfig.prototype['name'] = undefined;
 ...
 */
GoogleCloudDiscoveryengineV1alphaServingConfig.prototype['onewaySynonymsControlIds'] = undefined;
 ...
 */
GoogleCloudDiscoveryengineV1alphaServingConfig.prototype['rankingExpression'] = undefined;
 ...
 */
GoogleCloudDiscoveryengineV1alphaServingConfig.prototype['redirectControlIds'] = undefined;
 ...
 */
GoogleCloudDiscoveryengineV1alphaServingConfig.prototype['replacementControlIds'] = undefined;

/**
 * Required. Immutable. Specifies the solution type that a serving config can be associated with.
 * @member {module:model/GoogleCloudDiscoveryengineV1alphaServingConfig.SolutionTypeEnum} solutionType
 */
GoogleCloudDiscoveryengineV1alphaServingConfig.prototype['solutionType'] = undefined;
 ...
 */
GoogleCloudDiscoveryengineV1alphaServingConfig.prototype['synonymsControlIds'] = undefined;

/**
 * Output only. ServingConfig updated timestamp.
 * @member {String} updateTime
 */
GoogleCloudDiscoveryengineV1alphaServingConfig.prototype['updateTime'] = undefined;
 ...
 * @readonly
 */
GoogleCloudDiscoveryengineV1alphaServingConfig['SolutionTypeEnum'] = {
...
export default GoogleCloudDiscoveryengineV1alphaServingConfig;
