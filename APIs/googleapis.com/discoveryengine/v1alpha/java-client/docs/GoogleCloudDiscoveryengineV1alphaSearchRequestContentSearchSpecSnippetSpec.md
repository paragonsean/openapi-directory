...
|------------ | ------------- | ------------- | -------------|
|**maxSnippetCount** | **Integer** | [DEPRECATED] This field is deprecated. To control snippet return, use &#x60;return_snippet&#x60; field. For backwards compatibility, we will return snippet if max_snippet_count &gt; 0. |  [optional] |
