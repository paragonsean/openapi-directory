...
|**rawBytes** | **byte[]** | The content represented as a stream of bytes. The maximum length is 1,000,000 bytes (1 MB / ~0.95 MiB). Note: As with all &#x60;bytes&#x60; fields, this field is represented as pure binary in Protocol Buffers and base64-encoded string in JSON. For example, &#x60;abc123!?$*&amp;()&#39;-&#x3D;@~&#x60; should be represented as &#x60;YWJjMTIzIT8kKiYoKSctPUB+&#x60; in JSON. See https://developers.google.com/protocol-buffers/docs/proto3#json. |  [optional] |
