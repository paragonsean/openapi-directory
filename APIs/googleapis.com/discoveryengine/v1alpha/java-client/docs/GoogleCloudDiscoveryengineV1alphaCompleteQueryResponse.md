...
|------------ | ------------- | ------------- | -------------|
|**querySuggestions** | [**List&lt;GoogleCloudDiscoveryengineV1alphaCompleteQueryResponseQuerySuggestion&gt;**](GoogleCloudDiscoveryengineV1alphaCompleteQueryResponseQuerySuggestion.md) | Results of the matched query suggestions. The result list is ordered and the first result is a top suggestion. |  [optional] |
