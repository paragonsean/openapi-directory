...
public class GoogleCloudDiscoveryengineV1betaDataStore {
  /**
  ...
  private GoogleCloudDiscoveryengineV1betaDocumentProcessingConfig documentProcessingConfig;
  ...
  public GoogleCloudDiscoveryengineV1betaDataStore() {
  }
  ...
  public GoogleCloudDiscoveryengineV1betaDataStore contentConfig(ContentConfigEnum contentConfig) {
  ...
  public GoogleCloudDiscoveryengineV1betaDataStore displayName(String displayName) {
  ...
  public GoogleCloudDiscoveryengineV1betaDataStore documentProcessingConfig(GoogleCloudDiscoveryengineV1betaDocumentProcessingConfig documentProcessingConfig) {
   ...
   */
  @javax.annotation.Nullable
  public GoogleCloudDiscoveryengineV1betaDocumentProcessingConfig getDocumentProcessingConfig() {
    return documentProcessingConfig;
  }

  public void setDocumentProcessingConfig(GoogleCloudDiscoveryengineV1betaDocumentProcessingConfig documentProcessingConfig) {
    this.documentProcessingConfig = documentProcessingConfig;
  }


  public GoogleCloudDiscoveryengineV1betaDataStore industryVertical(IndustryVerticalEnum industryVertical) {
  ...
  public GoogleCloudDiscoveryengineV1betaDataStore name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GoogleCloudDiscoveryengineV1betaDataStore solutionTypes(List<SolutionTypesEnum> solutionTypes) {
    this.solutionTypes = solutionTypes;
    return this;
  }

  public GoogleCloudDiscoveryengineV1betaDataStore addSolutionTypesItem(SolutionTypesEnum solutionTypesItem) {
  ...
  public GoogleCloudDiscoveryengineV1betaDataStore startingSchema(GoogleCloudDiscoveryengineV1betaSchema startingSchema) {
   ...
   */
  @javax.annotation.Nullable
  public GoogleCloudDiscoveryengineV1betaSchema getStartingSchema() {
    return startingSchema;
  }

  public void setStartingSchema(GoogleCloudDiscoveryengineV1betaSchema startingSchema) {
    this.startingSchema = startingSchema;
  }
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudDiscoveryengineV1betaDataStore googleCloudDiscoveryengineV1betaDataStore = (GoogleCloudDiscoveryengineV1betaDataStore) o;
    return Objects.equals(this.contentConfig, googleCloudDiscoveryengineV1betaDataStore.contentConfig) &&
        Objects.equals(this.createTime, googleCloudDiscoveryengineV1betaDataStore.createTime) &&
        Objects.equals(this.defaultSchemaId, googleCloudDiscoveryengineV1betaDataStore.defaultSchemaId) &&
        Objects.equals(this.displayName, googleCloudDiscoveryengineV1betaDataStore.displayName) &&
        Objects.equals(this.documentProcessingConfig, googleCloudDiscoveryengineV1betaDataStore.documentProcessingConfig) &&
        Objects.equals(this.industryVertical, googleCloudDiscoveryengineV1betaDataStore.industryVertical) &&
        Objects.equals(this.name, googleCloudDiscoveryengineV1betaDataStore.name) &&
        Objects.equals(this.solutionTypes, googleCloudDiscoveryengineV1betaDataStore.solutionTypes) &&
        Objects.equals(this.startingSchema, googleCloudDiscoveryengineV1betaDataStore.startingSchema);
  }

  @Override
  public int hashCode() {
    return Objects.hash(contentConfig, createTime, defaultSchemaId, displayName, documentProcessingConfig, industryVertical, name, solutionTypes, startingSchema);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GoogleCloudDiscoveryengineV1betaDataStore {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudDiscoveryengineV1betaDataStore
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudDiscoveryengineV1betaDataStore.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudDiscoveryengineV1betaDataStore is not found in the empty JSON string", GoogleCloudDiscoveryengineV1betaDataStore.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudDiscoveryengineV1betaDataStore.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudDiscoveryengineV1betaDataStore` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("documentProcessingConfig") != null && !jsonObj.get("documentProcessingConfig").isJsonNull()) {
        GoogleCloudDiscoveryengineV1betaDocumentProcessingConfig.validateJsonElement(jsonObj.get("documentProcessingConfig"));
      }
      ...
      if (jsonObj.get("startingSchema") != null && !jsonObj.get("startingSchema").isJsonNull()) {
        GoogleCloudDiscoveryengineV1betaSchema.validateJsonElement(jsonObj.get("startingSchema"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudDiscoveryengineV1betaDataStore.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudDiscoveryengineV1betaDataStore' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudDiscoveryengineV1betaDataStore> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudDiscoveryengineV1betaDataStore.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudDiscoveryengineV1betaDataStore>() {
           @Override
           public void write(JsonWriter out, GoogleCloudDiscoveryengineV1betaDataStore value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudDiscoveryengineV1betaDataStore read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudDiscoveryengineV1betaDataStore given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudDiscoveryengineV1betaDataStore
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudDiscoveryengineV1betaDataStore
   */
  public static GoogleCloudDiscoveryengineV1betaDataStore fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudDiscoveryengineV1betaDataStore.class);
  }

  /**
   * Convert an instance of GoogleCloudDiscoveryengineV1betaDataStore to an JSON string
   *
   * @return JSON string
   */
