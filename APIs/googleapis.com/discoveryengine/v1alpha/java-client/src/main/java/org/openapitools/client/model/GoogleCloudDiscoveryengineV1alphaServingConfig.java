...
public class GoogleCloudDiscoveryengineV1alphaServingConfig {
  ...
  public static final String SERIALIZED_NAME_GUIDED_SEARCH_SPEC = "guidedSearchSpec";
  @SerializedName(SERIALIZED_NAME_GUIDED_SEARCH_SPEC)
  ...
  public GoogleCloudDiscoveryengineV1alphaServingConfig() {
  }
  ...
  public GoogleCloudDiscoveryengineV1alphaServingConfig boostControlIds(List<String> boostControlIds) {
    this.boostControlIds = boostControlIds;
    return this;
  }

  public GoogleCloudDiscoveryengineV1alphaServingConfig addBoostControlIdsItem(String boostControlIdsItem) {
  ...
  public GoogleCloudDiscoveryengineV1alphaServingConfig customFineTuningSpec(GoogleCloudDiscoveryengineV1alphaCustomFineTuningSpec customFineTuningSpec) {
  ...
  public GoogleCloudDiscoveryengineV1alphaServingConfig displayName(String displayName) {
  ...
  public GoogleCloudDiscoveryengineV1alphaServingConfig dissociateControlIds(List<String> dissociateControlIds) {
    this.dissociateControlIds = dissociateControlIds;
    return this;
  }

  public GoogleCloudDiscoveryengineV1alphaServingConfig addDissociateControlIdsItem(String dissociateControlIdsItem) {
  ...
  public GoogleCloudDiscoveryengineV1alphaServingConfig diversityLevel(String diversityLevel) {
  ...
  public GoogleCloudDiscoveryengineV1alphaServingConfig embeddingConfig(GoogleCloudDiscoveryengineV1alphaEmbeddingConfig embeddingConfig) {
  ...
  public void setEmbeddingConfig(GoogleCloudDiscoveryengineV1alphaEmbeddingConfig embeddingConfig) {
    this.embeddingConfig = embeddingConfig;
  }


  public GoogleCloudDiscoveryengineV1alphaServingConfig filterControlIds(List<String> filterControlIds) {
    this.filterControlIds = filterControlIds;
    return this;
  }

  public GoogleCloudDiscoveryengineV1alphaServingConfig addFilterControlIdsItem(String filterControlIdsItem) {
  ...
  public GoogleCloudDiscoveryengineV1alphaServingConfig genericConfig(GoogleCloudDiscoveryengineV1alphaServingConfigGenericConfig genericConfig) {
  ...
  public void setGenericConfig(GoogleCloudDiscoveryengineV1alphaServingConfigGenericConfig genericConfig) {
    this.genericConfig = genericConfig;
  }


  public GoogleCloudDiscoveryengineV1alphaServingConfig guidedSearchSpec(GoogleCloudDiscoveryengineV1alphaGuidedSearchSpec guidedSearchSpec) {
    this.guidedSearchSpec = guidedSearchSpec;
    return this;
  }

  /**
   * Get guidedSearchSpec
  ...
  public void setGuidedSearchSpec(GoogleCloudDiscoveryengineV1alphaGuidedSearchSpec guidedSearchSpec) {
    this.guidedSearchSpec = guidedSearchSpec;
  }


  public GoogleCloudDiscoveryengineV1alphaServingConfig ignoreControlIds(List<String> ignoreControlIds) {
    this.ignoreControlIds = ignoreControlIds;
    return this;
  }

  public GoogleCloudDiscoveryengineV1alphaServingConfig addIgnoreControlIdsItem(String ignoreControlIdsItem) {
  ...
  public GoogleCloudDiscoveryengineV1alphaServingConfig mediaConfig(GoogleCloudDiscoveryengineV1alphaServingConfigMediaConfig mediaConfig) {
  ...
  public void setMediaConfig(GoogleCloudDiscoveryengineV1alphaServingConfigMediaConfig mediaConfig) {
    this.mediaConfig = mediaConfig;
  }


  public GoogleCloudDiscoveryengineV1alphaServingConfig modelId(String modelId) {
  ...
  public GoogleCloudDiscoveryengineV1alphaServingConfig name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GoogleCloudDiscoveryengineV1alphaServingConfig onewaySynonymsControlIds(List<String> onewaySynonymsControlIds) {
    this.onewaySynonymsControlIds = onewaySynonymsControlIds;
    return this;
  }

  public GoogleCloudDiscoveryengineV1alphaServingConfig addOnewaySynonymsControlIdsItem(String onewaySynonymsControlIdsItem) {
  ...
  public GoogleCloudDiscoveryengineV1alphaServingConfig rankingExpression(String rankingExpression) {
  ...
  public GoogleCloudDiscoveryengineV1alphaServingConfig redirectControlIds(List<String> redirectControlIds) {
    this.redirectControlIds = redirectControlIds;
    return this;
  }

  public GoogleCloudDiscoveryengineV1alphaServingConfig addRedirectControlIdsItem(String redirectControlIdsItem) {
  ...
  public GoogleCloudDiscoveryengineV1alphaServingConfig replacementControlIds(List<String> replacementControlIds) {
    this.replacementControlIds = replacementControlIds;
    return this;
  }

  public GoogleCloudDiscoveryengineV1alphaServingConfig addReplacementControlIdsItem(String replacementControlIdsItem) {
  ...
  public GoogleCloudDiscoveryengineV1alphaServingConfig solutionType(SolutionTypeEnum solutionType) {
  ...
  public GoogleCloudDiscoveryengineV1alphaServingConfig synonymsControlIds(List<String> synonymsControlIds) {
    this.synonymsControlIds = synonymsControlIds;
    return this;
  }

  public GoogleCloudDiscoveryengineV1alphaServingConfig addSynonymsControlIdsItem(String synonymsControlIdsItem) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudDiscoveryengineV1alphaServingConfig googleCloudDiscoveryengineV1alphaServingConfig = (GoogleCloudDiscoveryengineV1alphaServingConfig) o;
    return Objects.equals(this.boostControlIds, googleCloudDiscoveryengineV1alphaServingConfig.boostControlIds) &&
        Objects.equals(this.createTime, googleCloudDiscoveryengineV1alphaServingConfig.createTime) &&
        Objects.equals(this.customFineTuningSpec, googleCloudDiscoveryengineV1alphaServingConfig.customFineTuningSpec) &&
        Objects.equals(this.displayName, googleCloudDiscoveryengineV1alphaServingConfig.displayName) &&
        Objects.equals(this.dissociateControlIds, googleCloudDiscoveryengineV1alphaServingConfig.dissociateControlIds) &&
        Objects.equals(this.diversityLevel, googleCloudDiscoveryengineV1alphaServingConfig.diversityLevel) &&
        Objects.equals(this.embeddingConfig, googleCloudDiscoveryengineV1alphaServingConfig.embeddingConfig) &&
        Objects.equals(this.filterControlIds, googleCloudDiscoveryengineV1alphaServingConfig.filterControlIds) &&
        Objects.equals(this.genericConfig, googleCloudDiscoveryengineV1alphaServingConfig.genericConfig) &&
        Objects.equals(this.guidedSearchSpec, googleCloudDiscoveryengineV1alphaServingConfig.guidedSearchSpec) &&
        Objects.equals(this.ignoreControlIds, googleCloudDiscoveryengineV1alphaServingConfig.ignoreControlIds) &&
        Objects.equals(this.mediaConfig, googleCloudDiscoveryengineV1alphaServingConfig.mediaConfig) &&
        Objects.equals(this.modelId, googleCloudDiscoveryengineV1alphaServingConfig.modelId) &&
        Objects.equals(this.name, googleCloudDiscoveryengineV1alphaServingConfig.name) &&
        Objects.equals(this.onewaySynonymsControlIds, googleCloudDiscoveryengineV1alphaServingConfig.onewaySynonymsControlIds) &&
        Objects.equals(this.rankingExpression, googleCloudDiscoveryengineV1alphaServingConfig.rankingExpression) &&
        Objects.equals(this.redirectControlIds, googleCloudDiscoveryengineV1alphaServingConfig.redirectControlIds) &&
        Objects.equals(this.replacementControlIds, googleCloudDiscoveryengineV1alphaServingConfig.replacementControlIds) &&
        Objects.equals(this.solutionType, googleCloudDiscoveryengineV1alphaServingConfig.solutionType) &&
        Objects.equals(this.synonymsControlIds, googleCloudDiscoveryengineV1alphaServingConfig.synonymsControlIds) &&
        Objects.equals(this.updateTime, googleCloudDiscoveryengineV1alphaServingConfig.updateTime);
  }

  @Override
  public int hashCode() {
    return Objects.hash(boostControlIds, createTime, customFineTuningSpec, displayName, dissociateControlIds, diversityLevel, embeddingConfig, filterControlIds, genericConfig, guidedSearchSpec, ignoreControlIds, mediaConfig, modelId, name, onewaySynonymsControlIds, rankingExpression, redirectControlIds, replacementControlIds, solutionType, synonymsControlIds, updateTime);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GoogleCloudDiscoveryengineV1alphaServingConfig {\n");
    ...
    sb.append("    guidedSearchSpec: ").append(toIndentedString(guidedSearchSpec)).append("\n");
  ...
  static {
    ...
    openapiFields.add("guidedSearchSpec");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudDiscoveryengineV1alphaServingConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudDiscoveryengineV1alphaServingConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudDiscoveryengineV1alphaServingConfig is not found in the empty JSON string", GoogleCloudDiscoveryengineV1alphaServingConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudDiscoveryengineV1alphaServingConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudDiscoveryengineV1alphaServingConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("embeddingConfig") != null && !jsonObj.get("embeddingConfig").isJsonNull()) {
        GoogleCloudDiscoveryengineV1alphaEmbeddingConfig.validateJsonElement(jsonObj.get("embeddingConfig"));
      }
      // ensure the optional json data is an array if present
      ...
      if (jsonObj.get("genericConfig") != null && !jsonObj.get("genericConfig").isJsonNull()) {
        GoogleCloudDiscoveryengineV1alphaServingConfigGenericConfig.validateJsonElement(jsonObj.get("genericConfig"));
      }
      // validate the optional field `guidedSearchSpec`
      if (jsonObj.get("guidedSearchSpec") != null && !jsonObj.get("guidedSearchSpec").isJsonNull()) {
        GoogleCloudDiscoveryengineV1alphaGuidedSearchSpec.validateJsonElement(jsonObj.get("guidedSearchSpec"));
      }
      // ensure the optional json data is an array if present
      ...
      if (jsonObj.get("mediaConfig") != null && !jsonObj.get("mediaConfig").isJsonNull()) {
        GoogleCloudDiscoveryengineV1alphaServingConfigMediaConfig.validateJsonElement(jsonObj.get("mediaConfig"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudDiscoveryengineV1alphaServingConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudDiscoveryengineV1alphaServingConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudDiscoveryengineV1alphaServingConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudDiscoveryengineV1alphaServingConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudDiscoveryengineV1alphaServingConfig>() {
           @Override
           public void write(JsonWriter out, GoogleCloudDiscoveryengineV1alphaServingConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudDiscoveryengineV1alphaServingConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudDiscoveryengineV1alphaServingConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudDiscoveryengineV1alphaServingConfig
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudDiscoveryengineV1alphaServingConfig
   */
  public static GoogleCloudDiscoveryengineV1alphaServingConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudDiscoveryengineV1alphaServingConfig.class);
  }

  /**
   * Convert an instance of GoogleCloudDiscoveryengineV1alphaServingConfig to an JSON string
   *
   * @return JSON string
   */
