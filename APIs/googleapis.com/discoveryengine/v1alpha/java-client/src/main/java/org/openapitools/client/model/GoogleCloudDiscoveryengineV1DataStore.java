...
import org.openapitools.client.model.GoogleCloudDiscoveryengineV1DocumentProcessingConfig;
import org.openapitools.client.model.GoogleCloudDiscoveryengineV1Schema;
...
public class GoogleCloudDiscoveryengineV1DataStore {
  /**
  ...
  public GoogleCloudDiscoveryengineV1DataStore() {
  }
  ...
  public GoogleCloudDiscoveryengineV1DataStore contentConfig(ContentConfigEnum contentConfig) {
  ...
  public GoogleCloudDiscoveryengineV1DataStore displayName(String displayName) {
  ...
  public GoogleCloudDiscoveryengineV1DataStore documentProcessingConfig(GoogleCloudDiscoveryengineV1DocumentProcessingConfig documentProcessingConfig) {
  ...
  public void setDocumentProcessingConfig(GoogleCloudDiscoveryengineV1DocumentProcessingConfig documentProcessingConfig) {
    this.documentProcessingConfig = documentProcessingConfig;
  }


  public GoogleCloudDiscoveryengineV1DataStore industryVertical(IndustryVerticalEnum industryVertical) {
  ...
  public GoogleCloudDiscoveryengineV1DataStore name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GoogleCloudDiscoveryengineV1DataStore solutionTypes(List<SolutionTypesEnum> solutionTypes) {
    this.solutionTypes = solutionTypes;
    return this;
  }

  public GoogleCloudDiscoveryengineV1DataStore addSolutionTypesItem(SolutionTypesEnum solutionTypesItem) {
  ...
  public GoogleCloudDiscoveryengineV1DataStore startingSchema(GoogleCloudDiscoveryengineV1Schema startingSchema) {
  ...
  public void setStartingSchema(GoogleCloudDiscoveryengineV1Schema startingSchema) {
    this.startingSchema = startingSchema;
  }
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudDiscoveryengineV1DataStore googleCloudDiscoveryengineV1DataStore = (GoogleCloudDiscoveryengineV1DataStore) o;
    return Objects.equals(this.contentConfig, googleCloudDiscoveryengineV1DataStore.contentConfig) &&
        Objects.equals(this.createTime, googleCloudDiscoveryengineV1DataStore.createTime) &&
        Objects.equals(this.defaultSchemaId, googleCloudDiscoveryengineV1DataStore.defaultSchemaId) &&
        Objects.equals(this.displayName, googleCloudDiscoveryengineV1DataStore.displayName) &&
        Objects.equals(this.documentProcessingConfig, googleCloudDiscoveryengineV1DataStore.documentProcessingConfig) &&
        Objects.equals(this.industryVertical, googleCloudDiscoveryengineV1DataStore.industryVertical) &&
        Objects.equals(this.name, googleCloudDiscoveryengineV1DataStore.name) &&
        Objects.equals(this.solutionTypes, googleCloudDiscoveryengineV1DataStore.solutionTypes) &&
        Objects.equals(this.startingSchema, googleCloudDiscoveryengineV1DataStore.startingSchema);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudDiscoveryengineV1DataStore {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudDiscoveryengineV1DataStore
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudDiscoveryengineV1DataStore.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudDiscoveryengineV1DataStore is not found in the empty JSON string", GoogleCloudDiscoveryengineV1DataStore.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudDiscoveryengineV1DataStore.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudDiscoveryengineV1DataStore` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("documentProcessingConfig") != null && !jsonObj.get("documentProcessingConfig").isJsonNull()) {
        GoogleCloudDiscoveryengineV1DocumentProcessingConfig.validateJsonElement(jsonObj.get("documentProcessingConfig"));
      }
      ...
      if (jsonObj.get("startingSchema") != null && !jsonObj.get("startingSchema").isJsonNull()) {
        GoogleCloudDiscoveryengineV1Schema.validateJsonElement(jsonObj.get("startingSchema"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudDiscoveryengineV1DataStore.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudDiscoveryengineV1DataStore' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudDiscoveryengineV1DataStore> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudDiscoveryengineV1DataStore.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudDiscoveryengineV1DataStore>() {
           @Override
           public void write(JsonWriter out, GoogleCloudDiscoveryengineV1DataStore value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudDiscoveryengineV1DataStore read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudDiscoveryengineV1DataStore given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudDiscoveryengineV1DataStore
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudDiscoveryengineV1DataStore
   */
  public static GoogleCloudDiscoveryengineV1DataStore fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudDiscoveryengineV1DataStore.class);
  }

  /**
   * Convert an instance of GoogleCloudDiscoveryengineV1DataStore to an JSON string
   *
   * @return JSON string
   */
