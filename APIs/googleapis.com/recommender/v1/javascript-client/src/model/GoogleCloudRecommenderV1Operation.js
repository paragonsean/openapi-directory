...
/**
 * The GoogleCloudRecommenderV1Operation model module.
 * @module model/GoogleCloudRecommenderV1Operation
 * @version v1
 */
class GoogleCloudRecommenderV1Operation {
    /**
     * Constructs a new <code>GoogleCloudRecommenderV1Operation</code>.
     * Contains an operation for a resource loosely based on the JSON-PATCH format with support for: * Custom filters for describing partial array patch. * Extended path values for describing nested arrays. * Custom fields for describing the resource for which the operation is being described. * Allows extension to custom operations not natively supported by RFC6902. See https://tools.ietf.org/html/rfc6902 for details on the original RFC.
     * @alias module:model/GoogleCloudRecommenderV1Operation
     */
    constructor() { 
        
        GoogleCloudRecommenderV1Operation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudRecommenderV1Operation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudRecommenderV1Operation} obj Optional instance to populate.
     * @return {module:model/GoogleCloudRecommenderV1Operation} The populated <code>GoogleCloudRecommenderV1Operation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudRecommenderV1Operation();
            ...
            if (data.hasOwnProperty('pathValueMatchers')) {
                obj['pathValueMatchers'] = ApiClient.convertToType(data['pathValueMatchers'], {'String': GoogleCloudRecommenderV1ValueMatcher});
            }
            ...
            if (data.hasOwnProperty('valueMatcher')) {
                obj['valueMatcher'] = GoogleCloudRecommenderV1ValueMatcher.constructFromObject(data['valueMatcher']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudRecommenderV1Operation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudRecommenderV1Operation</code>.
     */
    static validateJSON(data) {
        ...
        if (data['valueMatcher']) { // data not null
          GoogleCloudRecommenderV1ValueMatcher.validateJSON(data['valueMatcher']);
        }
 ...
 */
GoogleCloudRecommenderV1Operation.prototype['action'] = undefined;

/**
 * Path to the target field being operated on. If the operation is at the resource level, then path should be \"/\". This field is always populated.
 * @member {String} path
 */
GoogleCloudRecommenderV1Operation.prototype['path'] = undefined;
 ...
 */
GoogleCloudRecommenderV1Operation.prototype['pathFilters'] = undefined;
 ...
 * @member {Object.<String, module:model/GoogleCloudRecommenderV1ValueMatcher>} pathValueMatchers
 */
GoogleCloudRecommenderV1Operation.prototype['pathValueMatchers'] = undefined;

/**
 * Contains the fully qualified resource name. This field is always populated. ex: //cloudresourcemanager.googleapis.com/projects/foo.
 * @member {String} resource
 */
GoogleCloudRecommenderV1Operation.prototype['resource'] = undefined;

/**
 * Type of GCP resource being modified/tested. This field is always populated. Example: cloudresourcemanager.googleapis.com/Project, compute.googleapis.com/Instance
 * @member {String} resourceType
 */
GoogleCloudRecommenderV1Operation.prototype['resourceType'] = undefined;

/**
 * Can be set with action 'copy' or 'move' to indicate the source field within resource or source_resource, ignored if provided for other operation types.
 * @member {String} sourcePath
 */
GoogleCloudRecommenderV1Operation.prototype['sourcePath'] = undefined;
 ...
 */
GoogleCloudRecommenderV1Operation.prototype['sourceResource'] = undefined;
 ...
 * @member {Object} value
 */
GoogleCloudRecommenderV1Operation.prototype['value'] = undefined;

/**
 * @member {module:model/GoogleCloudRecommenderV1ValueMatcher} valueMatcher
 */
GoogleCloudRecommenderV1Operation.prototype['valueMatcher'] = undefined;
...
export default GoogleCloudRecommenderV1Operation;
