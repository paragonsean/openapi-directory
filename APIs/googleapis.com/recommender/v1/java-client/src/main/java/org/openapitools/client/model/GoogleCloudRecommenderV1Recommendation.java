...
public class GoogleCloudRecommenderV1Recommendation {
  ...
  private List<GoogleCloudRecommenderV1Impact> additionalImpact = new ArrayList<>();
  ...
  private List<GoogleCloudRecommenderV1RecommendationInsightReference> associatedInsights = new ArrayList<>();
  ...
  public GoogleCloudRecommenderV1Recommendation() {
  }

  public GoogleCloudRecommenderV1Recommendation additionalImpact(List<GoogleCloudRecommenderV1Impact> additionalImpact) {
    this.additionalImpact = additionalImpact;
    return this;
  }

  public GoogleCloudRecommenderV1Recommendation addAdditionalImpactItem(GoogleCloudRecommenderV1Impact additionalImpactItem) {
  ...
  public List<GoogleCloudRecommenderV1Impact> getAdditionalImpact() {
    return additionalImpact;
  }

  public void setAdditionalImpact(List<GoogleCloudRecommenderV1Impact> additionalImpact) {
    this.additionalImpact = additionalImpact;
  }


  public GoogleCloudRecommenderV1Recommendation associatedInsights(List<GoogleCloudRecommenderV1RecommendationInsightReference> associatedInsights) {
    this.associatedInsights = associatedInsights;
    return this;
  }

  public GoogleCloudRecommenderV1Recommendation addAssociatedInsightsItem(GoogleCloudRecommenderV1RecommendationInsightReference associatedInsightsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<GoogleCloudRecommenderV1RecommendationInsightReference> getAssociatedInsights() {
    return associatedInsights;
  }

  public void setAssociatedInsights(List<GoogleCloudRecommenderV1RecommendationInsightReference> associatedInsights) {
    this.associatedInsights = associatedInsights;
  }


  public GoogleCloudRecommenderV1Recommendation content(GoogleCloudRecommenderV1RecommendationContent content) {
  ...
  public void setContent(GoogleCloudRecommenderV1RecommendationContent content) {
    this.content = content;
  }


  public GoogleCloudRecommenderV1Recommendation description(String description) {
  ...
  public GoogleCloudRecommenderV1Recommendation etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  public GoogleCloudRecommenderV1Recommendation lastRefreshTime(String lastRefreshTime) {
  ...
  public GoogleCloudRecommenderV1Recommendation name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GoogleCloudRecommenderV1Recommendation primaryImpact(GoogleCloudRecommenderV1Impact primaryImpact) {
  ...
  public void setPrimaryImpact(GoogleCloudRecommenderV1Impact primaryImpact) {
    this.primaryImpact = primaryImpact;
  }


  public GoogleCloudRecommenderV1Recommendation priority(PriorityEnum priority) {
  ...
  public GoogleCloudRecommenderV1Recommendation recommenderSubtype(String recommenderSubtype) {
  ...
  public GoogleCloudRecommenderV1Recommendation stateInfo(GoogleCloudRecommenderV1RecommendationStateInfo stateInfo) {
  ...
  public void setStateInfo(GoogleCloudRecommenderV1RecommendationStateInfo stateInfo) {
    this.stateInfo = stateInfo;
  }


  public GoogleCloudRecommenderV1Recommendation targetResources(List<String> targetResources) {
    this.targetResources = targetResources;
    return this;
  }

  public GoogleCloudRecommenderV1Recommendation addTargetResourcesItem(String targetResourcesItem) {
  ...
  public GoogleCloudRecommenderV1Recommendation xorGroupId(String xorGroupId) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudRecommenderV1Recommendation googleCloudRecommenderV1Recommendation = (GoogleCloudRecommenderV1Recommendation) o;
    return Objects.equals(this.additionalImpact, googleCloudRecommenderV1Recommendation.additionalImpact) &&
        Objects.equals(this.associatedInsights, googleCloudRecommenderV1Recommendation.associatedInsights) &&
        Objects.equals(this.content, googleCloudRecommenderV1Recommendation.content) &&
        Objects.equals(this.description, googleCloudRecommenderV1Recommendation.description) &&
        Objects.equals(this.etag, googleCloudRecommenderV1Recommendation.etag) &&
        Objects.equals(this.lastRefreshTime, googleCloudRecommenderV1Recommendation.lastRefreshTime) &&
        Objects.equals(this.name, googleCloudRecommenderV1Recommendation.name) &&
        Objects.equals(this.primaryImpact, googleCloudRecommenderV1Recommendation.primaryImpact) &&
        Objects.equals(this.priority, googleCloudRecommenderV1Recommendation.priority) &&
        Objects.equals(this.recommenderSubtype, googleCloudRecommenderV1Recommendation.recommenderSubtype) &&
        Objects.equals(this.stateInfo, googleCloudRecommenderV1Recommendation.stateInfo) &&
        Objects.equals(this.targetResources, googleCloudRecommenderV1Recommendation.targetResources) &&
        Objects.equals(this.xorGroupId, googleCloudRecommenderV1Recommendation.xorGroupId);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudRecommenderV1Recommendation {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudRecommenderV1Recommendation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudRecommenderV1Recommendation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudRecommenderV1Recommendation is not found in the empty JSON string", GoogleCloudRecommenderV1Recommendation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudRecommenderV1Recommendation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudRecommenderV1Recommendation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("additionalImpact") != null && !jsonObj.get("additionalImpact").isJsonNull()) {
        ...
        if (jsonArrayadditionalImpact != null) {
          ...
          for (int i = 0; i < jsonArrayadditionalImpact.size(); i++) {
            GoogleCloudRecommenderV1Impact.validateJsonElement(jsonArrayadditionalImpact.get(i));
          };
        }
      }
      if (jsonObj.get("associatedInsights") != null && !jsonObj.get("associatedInsights").isJsonNull()) {
        ...
        if (jsonArrayassociatedInsights != null) {
          ...
          for (int i = 0; i < jsonArrayassociatedInsights.size(); i++) {
            GoogleCloudRecommenderV1RecommendationInsightReference.validateJsonElement(jsonArrayassociatedInsights.get(i));
          };
        }
      }
      // validate the optional field `content`
      if (jsonObj.get("content") != null && !jsonObj.get("content").isJsonNull()) {
        GoogleCloudRecommenderV1RecommendationContent.validateJsonElement(jsonObj.get("content"));
      }
      ...
      if (jsonObj.get("primaryImpact") != null && !jsonObj.get("primaryImpact").isJsonNull()) {
        GoogleCloudRecommenderV1Impact.validateJsonElement(jsonObj.get("primaryImpact"));
      }
      ...
      if (jsonObj.get("stateInfo") != null && !jsonObj.get("stateInfo").isJsonNull()) {
        GoogleCloudRecommenderV1RecommendationStateInfo.validateJsonElement(jsonObj.get("stateInfo"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudRecommenderV1Recommendation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudRecommenderV1Recommendation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudRecommenderV1Recommendation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudRecommenderV1Recommendation.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudRecommenderV1Recommendation>() {
           @Override
           public void write(JsonWriter out, GoogleCloudRecommenderV1Recommendation value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudRecommenderV1Recommendation read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudRecommenderV1Recommendation given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudRecommenderV1Recommendation
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudRecommenderV1Recommendation
   */
  public static GoogleCloudRecommenderV1Recommendation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudRecommenderV1Recommendation.class);
  }

  /**
   * Convert an instance of GoogleCloudRecommenderV1Recommendation to an JSON string
   *
   * @return JSON string
   */
