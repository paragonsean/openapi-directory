...
public class GoogleCloudRecommenderV1Operation {
  ...
  private Map<String, GoogleCloudRecommenderV1ValueMatcher> pathValueMatchers = new HashMap<>();
  ...
  public GoogleCloudRecommenderV1Operation() {
  }

  public GoogleCloudRecommenderV1Operation action(String action) {
    this.action = action;
    return this;
  }
  ...
  public GoogleCloudRecommenderV1Operation path(String path) {
    this.path = path;
    return this;
  }
  ...
  public GoogleCloudRecommenderV1Operation pathFilters(Map<String, Object> pathFilters) {
    this.pathFilters = pathFilters;
    return this;
  }

  public GoogleCloudRecommenderV1Operation putPathFiltersItem(String key, Object pathFiltersItem) {
  ...
  public GoogleCloudRecommenderV1Operation pathValueMatchers(Map<String, GoogleCloudRecommenderV1ValueMatcher> pathValueMatchers) {
    this.pathValueMatchers = pathValueMatchers;
    return this;
  }

  public GoogleCloudRecommenderV1Operation putPathValueMatchersItem(String key, GoogleCloudRecommenderV1ValueMatcher pathValueMatchersItem) {
   ...
   */
  @javax.annotation.Nullable
  public Map<String, GoogleCloudRecommenderV1ValueMatcher> getPathValueMatchers() {
    return pathValueMatchers;
  }

  public void setPathValueMatchers(Map<String, GoogleCloudRecommenderV1ValueMatcher> pathValueMatchers) {
    this.pathValueMatchers = pathValueMatchers;
  }


  public GoogleCloudRecommenderV1Operation resource(String resource) {
  ...
  public GoogleCloudRecommenderV1Operation resourceType(String resourceType) {
  ...
  public GoogleCloudRecommenderV1Operation sourcePath(String sourcePath) {
  ...
  public GoogleCloudRecommenderV1Operation sourceResource(String sourceResource) {
  ...
  public GoogleCloudRecommenderV1Operation value(Object value) {
    this.value = value;
    return this;
  }
  ...
  public GoogleCloudRecommenderV1Operation valueMatcher(GoogleCloudRecommenderV1ValueMatcher valueMatcher) {
  ...
  public void setValueMatcher(GoogleCloudRecommenderV1ValueMatcher valueMatcher) {
    this.valueMatcher = valueMatcher;
  }
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudRecommenderV1Operation googleCloudRecommenderV1Operation = (GoogleCloudRecommenderV1Operation) o;
    return Objects.equals(this.action, googleCloudRecommenderV1Operation.action) &&
        Objects.equals(this.path, googleCloudRecommenderV1Operation.path) &&
        Objects.equals(this.pathFilters, googleCloudRecommenderV1Operation.pathFilters) &&
        Objects.equals(this.pathValueMatchers, googleCloudRecommenderV1Operation.pathValueMatchers) &&
        Objects.equals(this.resource, googleCloudRecommenderV1Operation.resource) &&
        Objects.equals(this.resourceType, googleCloudRecommenderV1Operation.resourceType) &&
        Objects.equals(this.sourcePath, googleCloudRecommenderV1Operation.sourcePath) &&
        Objects.equals(this.sourceResource, googleCloudRecommenderV1Operation.sourceResource) &&
        Objects.equals(this.value, googleCloudRecommenderV1Operation.value) &&
        Objects.equals(this.valueMatcher, googleCloudRecommenderV1Operation.valueMatcher);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudRecommenderV1Operation {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudRecommenderV1Operation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudRecommenderV1Operation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudRecommenderV1Operation is not found in the empty JSON string", GoogleCloudRecommenderV1Operation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudRecommenderV1Operation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudRecommenderV1Operation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("valueMatcher") != null && !jsonObj.get("valueMatcher").isJsonNull()) {
        GoogleCloudRecommenderV1ValueMatcher.validateJsonElement(jsonObj.get("valueMatcher"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudRecommenderV1Operation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudRecommenderV1Operation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudRecommenderV1Operation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudRecommenderV1Operation.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudRecommenderV1Operation>() {
           @Override
           public void write(JsonWriter out, GoogleCloudRecommenderV1Operation value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudRecommenderV1Operation read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudRecommenderV1Operation given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudRecommenderV1Operation
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudRecommenderV1Operation
   */
  public static GoogleCloudRecommenderV1Operation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudRecommenderV1Operation.class);
  }

  /**
   * Convert an instance of GoogleCloudRecommenderV1Operation to an JSON string
   *
   * @return JSON string
   */
