...
OAIRecommendersApi::OAIRecommendersApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIRecommendersApi::~OAIRecommendersApi() {
}

void OAIRecommendersApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("recommender_recommenders_list", defaultConf);
    _serverIndices.insert("recommender_recommenders_list", 0);
}
...
*/
int OAIRecommendersApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIRecommendersApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIRecommendersApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIRecommendersApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIRecommendersApi::setUsername(const QString &username) {
    _username = username;
}

void OAIRecommendersApi::setPassword(const QString &password) {
    _password = password;
}


void OAIRecommendersApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIRecommendersApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIRecommendersApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIRecommendersApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIRecommendersApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIRecommendersApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIRecommendersApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIRecommendersApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIRecommendersApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIRecommendersApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIRecommendersApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIRecommendersApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIRecommendersApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIRecommendersApi::recommender_recommenders_list(const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &page_token) {
    QString fullPath = QString(_serverConfigs["recommender_recommenders_list"][_serverIndices.value("recommender_recommenders_list")].URL()+"/v1beta1/recommenders");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIRecommendersApi::recommender_recommenders_listCallback);
    connect(this, &OAIRecommendersApi::abortRequestsSignal, worker, &QObject::deleteLater);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIRecommendersApi::recommender_recommenders_listCallback);
    connect(this, &OAIRecommendersApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
...
void OAIRecommendersApi::recommender_recommenders_listCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIGoogleCloudRecommenderV1beta1ListRecommendersResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT recommender_recommenders_listSignal(output);
        Q_EMIT recommender_recommenders_listSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT recommender_recommenders_listSignalE(output, error_type, error_str);
        Q_EMIT recommender_recommenders_listSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT recommender_recommenders_listSignalError(output, error_type, error_str);
        Q_EMIT recommender_recommenders_listSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIRecommendersApi::tokenAvailable(){
