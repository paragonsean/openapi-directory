...
OAIInsightTypesApi::OAIInsightTypesApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIInsightTypesApi::~OAIInsightTypesApi() {
}

void OAIInsightTypesApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("recommender_insightTypes_list", defaultConf);
    _serverIndices.insert("recommender_insightTypes_list", 0);
}
...
*/
int OAIInsightTypesApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIInsightTypesApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIInsightTypesApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIInsightTypesApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIInsightTypesApi::setUsername(const QString &username) {
    _username = username;
}

void OAIInsightTypesApi::setPassword(const QString &password) {
    _password = password;
}


void OAIInsightTypesApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIInsightTypesApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIInsightTypesApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIInsightTypesApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIInsightTypesApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIInsightTypesApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIInsightTypesApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIInsightTypesApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIInsightTypesApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIInsightTypesApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIInsightTypesApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIInsightTypesApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIInsightTypesApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIInsightTypesApi::recommender_insightTypes_list(const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &page_token) {
    QString fullPath = QString(_serverConfigs["recommender_insightTypes_list"][_serverIndices.value("recommender_insightTypes_list")].URL()+"/v1beta1/insightTypes");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIInsightTypesApi::recommender_insightTypes_listCallback);
    connect(this, &OAIInsightTypesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIInsightTypesApi::recommender_insightTypes_listCallback);
    connect(this, &OAIInsightTypesApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
...
void OAIInsightTypesApi::recommender_insightTypes_listCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIGoogleCloudRecommenderV1beta1ListInsightTypesResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT recommender_insightTypes_listSignal(output);
        Q_EMIT recommender_insightTypes_listSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT recommender_insightTypes_listSignalE(output, error_type, error_str);
        Q_EMIT recommender_insightTypes_listSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT recommender_insightTypes_listSignalError(output, error_type, error_str);
        Q_EMIT recommender_insightTypes_listSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIInsightTypesApi::tokenAvailable(){
