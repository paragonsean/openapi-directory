...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CalendarApi.EventAttachment();
  });
  ...
  describe('EventAttachment', function() {
    it('should create an instance of EventAttachment', function() {
      // uncomment below and update the code to test EventAttachment
      //var instance = new CalendarApi.EventAttachment();
      //expect(instance).to.be.a(CalendarApi.EventAttachment);
    });
