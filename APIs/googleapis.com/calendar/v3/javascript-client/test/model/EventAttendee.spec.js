...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CalendarApi.EventAttendee();
  });
  ...
  describe('EventAttendee', function() {
    it('should create an instance of EventAttendee', function() {
      // uncomment below and update the code to test EventAttendee
      //var instance = new CalendarApi.EventAttendee();
      //expect(instance).to.be.a(CalendarApi.EventAttendee);
    });

    it('should have the property additionalGuests (base name: "additionalGuests")', function() {
      // uncomment below and update the code to test the property additionalGuests
      //var instance = new CalendarApi.EventAttendee();
