# CalendarApi.EventDateTime

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**date** | **Date** | The date, in the format \&quot;yyyy-mm-dd\&quot;, if this is an all-day event. | [optional] 
**dateTime** | **Date** | The time, as a combined date-time value (formatted according to RFC3339). A time zone offset is required unless a time zone is explicitly specified in timeZone. | [optional] 
