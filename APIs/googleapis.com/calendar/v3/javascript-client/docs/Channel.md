...
**type** | **String** | The type of delivery mechanism used for this channel. Valid values are \&quot;web_hook\&quot; (or \&quot;webhook\&quot;). Both values refer to a channel where Http requests are used to deliver messages. | [optional] 
