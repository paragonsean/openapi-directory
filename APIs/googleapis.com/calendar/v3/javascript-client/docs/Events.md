...
**defaultReminders** | [**[EventReminder]**](EventReminder.md) | The default reminders on the calendar for the authenticated user. These reminders apply to all events on this calendar that do not explicitly override them (i.e. do not have reminders.useDefault set to True). | [optional] 
**description** | **String** | Description of the calendar. Read-only. | [optional] 
**etag** | **String** | ETag of the collection. | [optional] 
**items** | [**[Event]**](Event.md) | List of events on the calendar. | [optional] 
**kind** | **String** | Type of the collection (\&quot;calendar#events\&quot;). | [optional] [default to &#39;calendar#events&#39;]
...
**updated** | **Date** | Last modification time of the calendar (as a RFC3339 timestamp). Read-only. | [optional] 
