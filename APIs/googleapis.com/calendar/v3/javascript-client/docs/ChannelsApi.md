# CalendarApi.ChannelsApi

All URIs are relative to *https://www.googleapis.com/calendar/v3*

Method | HTTP request | Description
------------- | ------------- | -------------
[**calendarChannelsStop**](ChannelsApi.md#calendarChannelsStop) | **POST** /channels/stop | 



## calendarChannelsStop

> calendarChannelsStop(opts)
...
let apiInstance = new CalendarApi.ChannelsApi();
let opts = {
...
apiInstance.calendarChannelsStop(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
