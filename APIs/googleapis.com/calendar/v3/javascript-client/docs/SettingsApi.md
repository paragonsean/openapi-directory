...
> Setting calendarSettingsGet(setting, opts)
...
let apiInstance = new CalendarApi.SettingsApi();
let setting = "setting_example"; // String | The id of the user setting.
let opts = {
...
apiInstance.calendarSettingsGet(setting, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> Settings calendarSettingsList(opts)
...
apiInstance.calendarSettingsList(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Channel calendarSettingsWatch(opts)
...
apiInstance.calendarSettingsWatch(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
