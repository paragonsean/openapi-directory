...
------------ | ------------- | ------------- | -------------
**additionalGuests** | **Number** | Number of additional guests. Optional. The default is 0. | [optional] [default to 0]
...
**optional** | **Boolean** | Whether this is an optional attendee. Optional. The default is False. | [optional] [default to false]
**organizer** | **Boolean** | Whether the attendee is the organizer of the event. Read-only. The default is False. | [optional] 
**resource** | **Boolean** | Whether the attendee is a resource. Can only be set when the attendee is added to the event for the first time. Subsequent modifications are ignored. Optional. The default is False. | [optional] [default to false]
...
**self** | **Boolean** | Whether this entry represents the calendar on which this copy of the event appears. Read-only. The default is False. | [optional] [default to false]
