# CalendarApi.FreebusyApi

All URIs are relative to *https://www.googleapis.com/calendar/v3*

Method | HTTP request | Description
------------- | ------------- | -------------
[**calendarFreebusyQuery**](FreebusyApi.md#calendarFreebusyQuery) | **POST** /freeBusy | 



## calendarFreebusyQuery

> FreeBusyResponse calendarFreebusyQuery(opts)
...
let apiInstance = new CalendarApi.FreebusyApi();
let opts = {
  ...
  'freeBusyRequest': new CalendarApi.FreeBusyRequest() // FreeBusyRequest | 
};
apiInstance.calendarFreebusyQuery(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
