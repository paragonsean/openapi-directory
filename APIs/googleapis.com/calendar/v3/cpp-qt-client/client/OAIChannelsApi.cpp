...
void OAIChannelsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("calendar_channels_stop", defaultConf);
    _serverIndices.insert("calendar_channels_stop", 0);
}
...
void OAIChannelsApi::calendar_channels_stop(const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &user_ip, const ::OpenAPI::OptionalParam<OAIChannel> &oai_channel) {
    QString fullPath = QString(_serverConfigs["calendar_channels_stop"][_serverIndices.value("calendar_channels_stop")].URL()+"/channels/stop");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIChannelsApi::calendar_channels_stopCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIChannelsApi::calendar_channels_stopCallback);
...
void OAIChannelsApi::calendar_channels_stopCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT calendar_channels_stopSignal();
        Q_EMIT calendar_channels_stopSignalFull(worker);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT calendar_channels_stopSignalE(error_type, error_str);
        Q_EMIT calendar_channels_stopSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT calendar_channels_stopSignalError(error_type, error_str);
        Q_EMIT calendar_channels_stopSignalErrorFull(worker, error_type, error_str);
    }
}
