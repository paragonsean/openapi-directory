...
QDateTime OAITimePeriod::getEnd() const {
    return m_end;
}
void OAITimePeriod::setEnd(const QDateTime &end) {
    m_end = end;
    m_end_isSet = true;
}

bool OAITimePeriod::is_end_Set() const{
    return m_end_isSet;
}

bool OAITimePeriod::is_end_Valid() const{
    return m_end_isValid;
}

QDateTime OAITimePeriod::getStart() const {
    return m_start;
}
void OAITimePeriod::setStart(const QDateTime &start) {
    m_start = start;
    m_start_isSet = true;
}

bool OAITimePeriod::is_start_Set() const{
    return m_start_isSet;
}

bool OAITimePeriod::is_start_Valid() const{
