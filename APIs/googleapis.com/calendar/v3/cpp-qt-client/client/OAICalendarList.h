...
#ifndef OAICalendarList_H
#define OAICalendarList_H
...
namespace OpenAPI {
class OAICalendarListEntry;

class OAICalendarList : public OAIObject {
public:
    OAICalendarList();
    OAICalendarList(QString json);
    ~OAICalendarList() override;
    ...
    QList<OAICalendarListEntry> getItems() const;
    void setItems(const QList<OAICalendarListEntry> &items);
...
private:
    ...
    QList<OAICalendarListEntry> m_items;
    bool m_items_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAICalendarList)

#endif // OAICalendarList_H
