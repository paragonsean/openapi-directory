...
async def test_calendar_settings_get(client):
    ...
    response = await client.request(
        method='GET',
        path='/calendar/v3/users/me/settings/{setting}'.format(setting='setting_example'),
        headers=headers,
        params=params,
        )
...
async def test_calendar_settings_list(client):
...
async def test_calendar_settings_watch(client):
