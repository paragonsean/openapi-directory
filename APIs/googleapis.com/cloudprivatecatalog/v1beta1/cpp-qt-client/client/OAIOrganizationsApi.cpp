...
void OAIOrganizationsApi::initializeServerConfigs() {
    ...
    QUrl("https://cloudprivatecatalog.googleapis.com/"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("cloudprivatecatalog_organizations_catalogs_search", defaultConf);
    _serverIndices.insert("cloudprivatecatalog_organizations_catalogs_search", 0);
    _serverConfigs.insert("cloudprivatecatalog_organizations_products_search", defaultConf);
    _serverIndices.insert("cloudprivatecatalog_organizations_products_search", 0);
    _serverConfigs.insert("cloudprivatecatalog_organizations_versions_search", defaultConf);
    _serverIndices.insert("cloudprivatecatalog_organizations_versions_search", 0);
}
...
void OAIOrganizationsApi::cloudprivatecatalog_organizations_catalogs_search(const QString &resource, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &page_token, const ::OpenAPI::OptionalParam<QString> &query) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIOrganizationsApi::cloudprivatecatalog_organizations_catalogs_searchCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIOrganizationsApi::cloudprivatecatalog_organizations_catalogs_searchCallback);
...
void OAIOrganizationsApi::cloudprivatecatalog_organizations_catalogs_searchCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIGoogleCloudPrivatecatalogV1beta1SearchCatalogsResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT cloudprivatecatalog_organizations_catalogs_searchSignal(output);
        Q_EMIT cloudprivatecatalog_organizations_catalogs_searchSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT cloudprivatecatalog_organizations_catalogs_searchSignalE(output, error_type, error_str);
        Q_EMIT cloudprivatecatalog_organizations_catalogs_searchSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT cloudprivatecatalog_organizations_catalogs_searchSignalError(output, error_type, error_str);
        Q_EMIT cloudprivatecatalog_organizations_catalogs_searchSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIOrganizationsApi::cloudprivatecatalog_organizations_products_search(const QString &resource, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &page_token, const ::OpenAPI::OptionalParam<QString> &query) {
    QString fullPath = QString(_serverConfigs["cloudprivatecatalog_organizations_products_search"][_serverIndices.value("cloudprivatecatalog_organizations_products_search")].URL()+"/v1beta1/{resource}/products:search");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIOrganizationsApi::cloudprivatecatalog_organizations_products_searchCallback);
    connect(this, &OAIOrganizationsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIOrganizationsApi::cloudprivatecatalog_organizations_products_searchCallback);
    connect(this, &OAIOrganizationsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIOrganizationsApi::cloudprivatecatalog_organizations_products_searchCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIGoogleCloudPrivatecatalogV1beta1SearchProductsResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT cloudprivatecatalog_organizations_products_searchSignal(output);
        Q_EMIT cloudprivatecatalog_organizations_products_searchSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("https://www.googleapis.com/auth/cloud-platform");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT cloudprivatecatalog_organizations_products_searchSignalE(output, error_type, error_str);
        Q_EMIT cloudprivatecatalog_organizations_products_searchSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT cloudprivatecatalog_organizations_products_searchSignalError(output, error_type, error_str);
        Q_EMIT cloudprivatecatalog_organizations_products_searchSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIOrganizationsApi::cloudprivatecatalog_organizations_versions_search(const QString &resource, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &page_token, const ::OpenAPI::OptionalParam<QString> &query) {
    QString fullPath = QString(_serverConfigs["cloudprivatecatalog_organizations_versions_search"][_serverIndices.value("cloudprivatecatalog_organizations_versions_search")].URL()+"/v1beta1/{resource}/versions:search");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIOrganizationsApi::cloudprivatecatalog_organizations_versions_searchCallback);
    connect(this, &OAIOrganizationsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIOrganizationsApi::cloudprivatecatalog_organizations_versions_searchCallback);
    connect(this, &OAIOrganizationsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIOrganizationsApi::cloudprivatecatalog_organizations_versions_searchCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIGoogleCloudPrivatecatalogV1beta1SearchVersionsResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT cloudprivatecatalog_organizations_versions_searchSignal(output);
        Q_EMIT cloudprivatecatalog_organizations_versions_searchSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("https://www.googleapis.com/auth/cloud-platform");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT cloudprivatecatalog_organizations_versions_searchSignalE(output, error_type, error_str);
        Q_EMIT cloudprivatecatalog_organizations_versions_searchSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT cloudprivatecatalog_organizations_versions_searchSignalError(output, error_type, error_str);
        Q_EMIT cloudprivatecatalog_organizations_versions_searchSignalErrorFull(worker, error_type, error_str);
    }
}
