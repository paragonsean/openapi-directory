...
/**
 * The GoogleCloudPrivatecatalogV1beta1Product model module.
 * @module model/GoogleCloudPrivatecatalogV1beta1Product
 * @version v1beta1
 */
class GoogleCloudPrivatecatalogV1beta1Product {
    /**
     * Constructs a new <code>GoogleCloudPrivatecatalogV1beta1Product</code>.
     * The readonly representation of a product computed with a given resource context.
     * @alias module:model/GoogleCloudPrivatecatalogV1beta1Product
     */
    constructor() { 
        
        GoogleCloudPrivatecatalogV1beta1Product.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudPrivatecatalogV1beta1Product</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudPrivatecatalogV1beta1Product} obj Optional instance to populate.
     * @return {module:model/GoogleCloudPrivatecatalogV1beta1Product} The populated <code>GoogleCloudPrivatecatalogV1beta1Product</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudPrivatecatalogV1beta1Product();
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudPrivatecatalogV1beta1Product</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudPrivatecatalogV1beta1Product</code>.
     */
 ...
 */
GoogleCloudPrivatecatalogV1beta1Product.prototype['assetType'] = undefined;

/**
 * Output only. The time when the product was created.
 * @member {String} createTime
 */
GoogleCloudPrivatecatalogV1beta1Product.prototype['createTime'] = undefined;
 ...
 */
GoogleCloudPrivatecatalogV1beta1Product.prototype['displayMetadata'] = undefined;

/**
 * Output only. The icon URI of the product.
 * @member {String} iconUri
 */
GoogleCloudPrivatecatalogV1beta1Product.prototype['iconUri'] = undefined;
 ...
 * @member {String} name
 */
GoogleCloudPrivatecatalogV1beta1Product.prototype['name'] = undefined;

/**
 * Output only. The time when the product was last updated.
 * @member {String} updateTime
 */
GoogleCloudPrivatecatalogV1beta1Product.prototype['updateTime'] = undefined;
...
export default GoogleCloudPrivatecatalogV1beta1Product;
