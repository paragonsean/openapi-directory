...
void OAIProjectsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("texttospeech_projects_locations_operations_get", defaultConf);
    _serverIndices.insert("texttospeech_projects_locations_operations_get", 0);
    _serverConfigs.insert("texttospeech_projects_locations_operations_list", defaultConf);
    _serverIndices.insert("texttospeech_projects_locations_operations_list", 0);
    _serverConfigs.insert("texttospeech_projects_locations_synthesizeLongAudio", defaultConf);
    _serverIndices.insert("texttospeech_projects_locations_synthesizeLongAudio", 0);
}
...
void OAIProjectsApi::texttospeech_projects_locations_operations_get(const QString &name, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::texttospeech_projects_locations_operations_getCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::texttospeech_projects_locations_operations_getCallback);
...
void OAIProjectsApi::texttospeech_projects_locations_operations_getCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT texttospeech_projects_locations_operations_getSignal(output);
        Q_EMIT texttospeech_projects_locations_operations_getSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT texttospeech_projects_locations_operations_getSignalE(output, error_type, error_str);
        Q_EMIT texttospeech_projects_locations_operations_getSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT texttospeech_projects_locations_operations_getSignalError(output, error_type, error_str);
        Q_EMIT texttospeech_projects_locations_operations_getSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectsApi::texttospeech_projects_locations_operations_list(const QString &name, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<QString> &filter, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &page_token) {
    QString fullPath = QString(_serverConfigs["texttospeech_projects_locations_operations_list"][_serverIndices.value("texttospeech_projects_locations_operations_list")].URL()+"/v1beta1/{name}/operations");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::texttospeech_projects_locations_operations_listCallback);
    connect(this, &OAIProjectsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::texttospeech_projects_locations_operations_listCallback);
    connect(this, &OAIProjectsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectsApi::texttospeech_projects_locations_operations_listCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT texttospeech_projects_locations_operations_listSignal(output);
        Q_EMIT texttospeech_projects_locations_operations_listSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("https://www.googleapis.com/auth/cloud-platform");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT texttospeech_projects_locations_operations_listSignalE(output, error_type, error_str);
        Q_EMIT texttospeech_projects_locations_operations_listSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT texttospeech_projects_locations_operations_listSignalError(output, error_type, error_str);
        Q_EMIT texttospeech_projects_locations_operations_listSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectsApi::texttospeech_projects_locations_synthesizeLongAudio(const QString &parent, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<OAISynthesizeLongAudioRequest> &oai_synthesize_long_audio_request) {
    QString fullPath = QString(_serverConfigs["texttospeech_projects_locations_synthesizeLongAudio"][_serverIndices.value("texttospeech_projects_locations_synthesizeLongAudio")].URL()+"/v1beta1/{parent}:synthesizeLongAudio");
    ...
    if (oai_synthesize_long_audio_request.hasValue()){

        
        QByteArray output = oai_synthesize_long_audio_request.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::texttospeech_projects_locations_synthesizeLongAudioCallback);
    connect(this, &OAIProjectsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::texttospeech_projects_locations_synthesizeLongAudioCallback);
    connect(this, &OAIProjectsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectsApi::texttospeech_projects_locations_synthesizeLongAudioCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT texttospeech_projects_locations_synthesizeLongAudioSignal(output);
        Q_EMIT texttospeech_projects_locations_synthesizeLongAudioSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("https://www.googleapis.com/auth/cloud-platform");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT texttospeech_projects_locations_synthesizeLongAudioSignalE(output, error_type, error_str);
        Q_EMIT texttospeech_projects_locations_synthesizeLongAudioSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT texttospeech_projects_locations_synthesizeLongAudioSignalError(output, error_type, error_str);
        Q_EMIT texttospeech_projects_locations_synthesizeLongAudioSignalErrorFull(worker, error_type, error_str);
    }
}
