...
void OAITextApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("texttospeech_text_synthesize", defaultConf);
    _serverIndices.insert("texttospeech_text_synthesize", 0);
}
...
void OAITextApi::texttospeech_text_synthesize(const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<OAISynthesizeSpeechRequest> &oai_synthesize_speech_request) {
    QString fullPath = QString(_serverConfigs["texttospeech_text_synthesize"][_serverIndices.value("texttospeech_text_synthesize")].URL()+"/v1beta1/text:synthesize");
    ...
    if (oai_synthesize_speech_request.hasValue()){

        
        QByteArray output = oai_synthesize_speech_request.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITextApi::texttospeech_text_synthesizeCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITextApi::texttospeech_text_synthesizeCallback);
    connect(this, &OAITextApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
...
void OAITextApi::texttospeech_text_synthesizeCallback(OAIHttpRequestWorker *worker) {
    ...
    OAISynthesizeSpeechResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT texttospeech_text_synthesizeSignal(output);
        Q_EMIT texttospeech_text_synthesizeSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT texttospeech_text_synthesizeSignalE(output, error_type, error_str);
        Q_EMIT texttospeech_text_synthesizeSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT texttospeech_text_synthesizeSignalError(output, error_type, error_str);
        Q_EMIT texttospeech_text_synthesizeSignalErrorFull(worker, error_type, error_str);
    }
}
