...
void OAIVoicesApi::initializeServerConfigs() {
    ...
    QUrl("https://texttospeech.googleapis.com/"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("texttospeech_voices_list", defaultConf);
    _serverIndices.insert("texttospeech_voices_list", 0);
}
...
void OAIVoicesApi::texttospeech_voices_list(const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<QString> &language_code) {
    QString fullPath = QString(_serverConfigs["texttospeech_voices_list"][_serverIndices.value("texttospeech_voices_list")].URL()+"/v1beta1/voices");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVoicesApi::texttospeech_voices_listCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIVoicesApi::texttospeech_voices_listCallback);
    connect(this, &OAIVoicesApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
...
void OAIVoicesApi::texttospeech_voices_listCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIListVoicesResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT texttospeech_voices_listSignal(output);
        Q_EMIT texttospeech_voices_listSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT texttospeech_voices_listSignalE(output, error_type, error_str);
        Q_EMIT texttospeech_voices_listSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT texttospeech_voices_listSignalError(output, error_type, error_str);
        Q_EMIT texttospeech_voices_listSignalErrorFull(worker, error_type, error_str);
    }
}
