...
async def test_texttospeech_text_synthesize(client):
    ...
    """
    body = {"voice":{"ssmlGender":"SSML_VOICE_GENDER_UNSPECIFIED","name":"name","customVoice":{"model":"model","reportedUsage":"REPORTED_USAGE_UNSPECIFIED"},"languageCode":"languageCode"},"input":{"ssml":"ssml","text":"text"},"audioConfig":{"sampleRateHertz":6,"volumeGainDb":5.962133916683182,"speakingRate":1.4658129805029452,"audioEncoding":"AUDIO_ENCODING_UNSPECIFIED","pitch":0.8008281904610115,"effectsProfileId":["effectsProfileId","effectsProfileId"]}}
