...
|------------ | ------------- | ------------- | -------------|
|**id** | **String** | Unique ID of this cluster. Assigned by the server. Immutable once assigned. |  [optional] |
...
|**productId** | **List&lt;String&gt;** | List of products in the order they are displayed in the cluster. There should not be duplicates within a cluster. |  [optional] |
