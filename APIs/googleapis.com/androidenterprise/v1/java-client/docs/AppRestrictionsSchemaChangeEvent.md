...
|------------ | ------------- | ------------- | -------------|
|**productId** | **String** | The id of the product (e.g. \&quot;app:com.google.android.gm\&quot;) for which the app restriction schema changed. This field will always be present. |  [optional] |
