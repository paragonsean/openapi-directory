...
void OAIPermissionsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("androidenterprise_permissions_get", defaultConf);
    _serverIndices.insert("androidenterprise_permissions_get", 0);
}
...
void OAIPermissionsApi::androidenterprise_permissions_get(const QString &permission_id, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<QString> &language) {
    QString fullPath = QString(_serverConfigs["androidenterprise_permissions_get"][_serverIndices.value("androidenterprise_permissions_get")].URL()+"/androidenterprise/v1/permissions/{permissionId}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIPermissionsApi::androidenterprise_permissions_getCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIPermissionsApi::androidenterprise_permissions_getCallback);
...
void OAIPermissionsApi::androidenterprise_permissions_getCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT androidenterprise_permissions_getSignal(output);
        Q_EMIT androidenterprise_permissions_getSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT androidenterprise_permissions_getSignalE(output, error_type, error_str);
        Q_EMIT androidenterprise_permissions_getSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT androidenterprise_permissions_getSignalError(output, error_type, error_str);
        Q_EMIT androidenterprise_permissions_getSignalErrorFull(worker, error_type, error_str);
    }
}
