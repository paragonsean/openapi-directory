# GooglePlayEmmApi.ManagedconfigurationsforuserApi
...
> androidenterpriseManagedconfigurationsforuserDelete(enterpriseId, userId, managedConfigurationForUserId, opts)
...
let apiInstance = new GooglePlayEmmApi.ManagedconfigurationsforuserApi();
let enterpriseId = "enterpriseId_example"; // String | The ID of the enterprise.
let userId = "userId_example"; // String | The ID of the user.
let managedConfigurationForUserId = "managedConfigurationForUserId_example"; // String | The ID of the managed configuration (a product ID), e.g. \"app:com.google.android.gm\".
let opts = {
...
apiInstance.androidenterpriseManagedconfigurationsforuserDelete(enterpriseId, userId, managedConfigurationForUserId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> ManagedConfiguration androidenterpriseManagedconfigurationsforuserGet(enterpriseId, userId, managedConfigurationForUserId, opts)
...
apiInstance.androidenterpriseManagedconfigurationsforuserGet(enterpriseId, userId, managedConfigurationForUserId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> ManagedConfigurationsForUserListResponse androidenterpriseManagedconfigurationsforuserList(enterpriseId, userId, opts)
...
apiInstance.androidenterpriseManagedconfigurationsforuserList(enterpriseId, userId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ManagedConfiguration androidenterpriseManagedconfigurationsforuserUpdate(enterpriseId, userId, managedConfigurationForUserId, opts)
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'managedConfiguration': new GooglePlayEmmApi.ManagedConfiguration() // ManagedConfiguration | 
};
apiInstance.androidenterpriseManagedconfigurationsforuserUpdate(enterpriseId, userId, managedConfigurationForUserId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
