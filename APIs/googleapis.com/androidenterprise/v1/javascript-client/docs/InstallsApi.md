...
> androidenterpriseInstallsDelete(enterpriseId, userId, deviceId, installId, opts)
...
let apiInstance = new GooglePlayEmmApi.InstallsApi();
let enterpriseId = "enterpriseId_example"; // String | The ID of the enterprise.
let userId = "userId_example"; // String | The ID of the user.
let deviceId = "deviceId_example"; // String | The Android ID of the device.
let installId = "installId_example"; // String | The ID of the product represented by the install, e.g. \"app:com.google.android.gm\".
let opts = {
...
apiInstance.androidenterpriseInstallsDelete(enterpriseId, userId, deviceId, installId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> Install androidenterpriseInstallsGet(enterpriseId, userId, deviceId, installId, opts)
...
apiInstance.androidenterpriseInstallsGet(enterpriseId, userId, deviceId, installId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> InstallsListResponse androidenterpriseInstallsList(enterpriseId, userId, deviceId, opts)
...
apiInstance.androidenterpriseInstallsList(enterpriseId, userId, deviceId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Install androidenterpriseInstallsUpdate(enterpriseId, userId, deviceId, installId, opts)
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'install': new GooglePlayEmmApi.Install() // Install | 
};
apiInstance.androidenterpriseInstallsUpdate(enterpriseId, userId, deviceId, installId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
