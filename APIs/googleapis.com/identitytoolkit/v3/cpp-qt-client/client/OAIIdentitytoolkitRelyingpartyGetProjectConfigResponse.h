...
/*
 * OAIIdentitytoolkitRelyingpartyGetProjectConfigResponse.h
 *
 * Response of getting the project configuration.
 */

#ifndef OAIIdentitytoolkitRelyingpartyGetProjectConfigResponse_H
#define OAIIdentitytoolkitRelyingpartyGetProjectConfigResponse_H
...
class OAIIdentitytoolkitRelyingpartyGetProjectConfigResponse : public OAIObject {
public:
    OAIIdentitytoolkitRelyingpartyGetProjectConfigResponse();
    OAIIdentitytoolkitRelyingpartyGetProjectConfigResponse(QString json);
    ~OAIIdentitytoolkitRelyingpartyGetProjectConfigResponse() override;
    ...
    QString getDynamicLinksDomain() const;
    void setDynamicLinksDomain(const QString &dynamic_links_domain);
    bool is_dynamic_links_domain_Set() const;
    bool is_dynamic_links_domain_Valid() const;
...
private:
    ...
    QString m_dynamic_links_domain;
    bool m_dynamic_links_domain_isSet;
    bool m_dynamic_links_domain_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIdentitytoolkitRelyingpartyGetProjectConfigResponse)

#endif // OAIIdentitytoolkitRelyingpartyGetProjectConfigResponse_H
