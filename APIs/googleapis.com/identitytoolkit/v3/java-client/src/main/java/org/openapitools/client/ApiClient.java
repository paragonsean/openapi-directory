...
public class ApiClient {
    ...
    private String basePath = "https://www.googleapis.com/identitytoolkit/v3/relyingparty";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://www.googleapis.com/identitytoolkit/v3/relyingparty
