...
|**authorizedDomains** | **List&lt;String&gt;** | Authorized domains for widget redirect. |  [optional] |
...
|**idpConfig** | [**List&lt;IdpConfig&gt;**](IdpConfig.md) | Oauth2 provider configuration. |  [optional] |
