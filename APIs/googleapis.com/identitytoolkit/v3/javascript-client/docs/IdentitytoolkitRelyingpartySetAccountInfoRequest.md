# GoogleIdentityToolkitApi.IdentitytoolkitRelyingpartySetAccountInfoRequest
...
**deleteAttribute** | **[String]** | The attributes users request to delete. | [optional] 
**deleteProvider** | **[String]** | The IDPs the user request to delete. | [optional] 
...
**provider** | **[String]** | The associated IDPs of the user. | [optional] 
