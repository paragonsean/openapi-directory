# GoogleIdentityToolkitApi.IdentitytoolkitRelyingpartyDeleteAccountRequest
...
**idToken** | **String** | The GITKit token or STS id token of the authenticated user. | [optional] 
