...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleIdentityToolkitApi.ResetPasswordResponse();
  });
  ...
  describe('ResetPasswordResponse', function() {
    it('should create an instance of ResetPasswordResponse', function() {
      // uncomment below and update the code to test ResetPasswordResponse
      //var instance = new GoogleIdentityToolkitApi.ResetPasswordResponse();
      //expect(instance).to.be.a(GoogleIdentityToolkitApi.ResetPasswordResponse);
    });
