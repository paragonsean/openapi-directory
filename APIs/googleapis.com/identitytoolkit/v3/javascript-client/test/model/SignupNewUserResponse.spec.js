...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleIdentityToolkitApi.SignupNewUserResponse();
  });
  ...
  describe('SignupNewUserResponse', function() {
    it('should create an instance of SignupNewUserResponse', function() {
      // uncomment below and update the code to test SignupNewUserResponse
      //var instance = new GoogleIdentityToolkitApi.SignupNewUserResponse();
      //expect(instance).to.be.a(GoogleIdentityToolkitApi.SignupNewUserResponse);
    });
