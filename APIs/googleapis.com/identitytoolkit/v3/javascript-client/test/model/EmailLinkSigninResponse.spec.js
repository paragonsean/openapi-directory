...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleIdentityToolkitApi.EmailLinkSigninResponse();
  });
  ...
  describe('EmailLinkSigninResponse', function() {
    it('should create an instance of EmailLinkSigninResponse', function() {
      // uncomment below and update the code to test EmailLinkSigninResponse
      //var instance = new GoogleIdentityToolkitApi.EmailLinkSigninResponse();
      //expect(instance).to.be.a(GoogleIdentityToolkitApi.EmailLinkSigninResponse);
    });
