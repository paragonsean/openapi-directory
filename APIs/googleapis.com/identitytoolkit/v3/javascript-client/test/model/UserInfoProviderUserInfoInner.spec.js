...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleIdentityToolkitApi.UserInfoProviderUserInfoInner();
  });
  ...
  describe('UserInfoProviderUserInfoInner', function() {
    it('should create an instance of UserInfoProviderUserInfoInner', function() {
      // uncomment below and update the code to test UserInfoProviderUserInfoInner
      //var instance = new GoogleIdentityToolkitApi.UserInfoProviderUserInfoInner();
      //expect(instance).to.be.a(GoogleIdentityToolkitApi.UserInfoProviderUserInfoInner);
    });
