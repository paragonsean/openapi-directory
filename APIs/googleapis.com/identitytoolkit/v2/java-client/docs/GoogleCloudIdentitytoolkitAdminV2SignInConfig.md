...
|------------ | ------------- | ------------- | -------------|
|**allowDuplicateEmails** | **Boolean** | Whether to allow more than one account to have the same email. |  [optional] |
...
|**phoneNumber** | [**GoogleCloudIdentitytoolkitAdminV2PhoneNumber**](GoogleCloudIdentitytoolkitAdminV2PhoneNumber.md) |  |  [optional] |
