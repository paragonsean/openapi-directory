# IdentityToolkitApi.ProjectsApi
...
> Object identitytoolkitProjectsIdentityPlatformInitializeAuth(project, opts)
...
let apiInstance = new IdentityToolkitApi.ProjectsApi();
let project = "project_example"; // String | The resource name of the target project the developer wants to enable Identity Platform for.
let opts = {
...
apiInstance.identitytoolkitProjectsIdentityPlatformInitializeAuth(project, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> GoogleCloudIdentitytoolkitAdminV2Tenant identitytoolkitProjectsTenantsCreate(parent, opts)
...
let apiInstance = new IdentityToolkitApi.ProjectsApi();
let parent = "parent_example"; // String | The parent resource name where the tenant will be created. For example, \"projects/project1\".
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'googleCloudIdentitytoolkitAdminV2Tenant': new IdentityToolkitApi.GoogleCloudIdentitytoolkitAdminV2Tenant() // GoogleCloudIdentitytoolkitAdminV2Tenant | 
};
apiInstance.identitytoolkitProjectsTenantsCreate(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> GoogleCloudIdentitytoolkitAdminV2DefaultSupportedIdpConfig identitytoolkitProjectsTenantsDefaultSupportedIdpConfigsCreate(parent, opts)
...
let apiInstance = new IdentityToolkitApi.ProjectsApi();
let parent = "parent_example"; // String | The parent resource name where the config to be created, for example: \"projects/my-awesome-project\"
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'idpId': "idpId_example", // String | The id of the Idp to create a config for. Call ListDefaultSupportedIdps for list of all default supported Idps.
  'googleCloudIdentitytoolkitAdminV2DefaultSupportedIdpConfig': new IdentityToolkitApi.GoogleCloudIdentitytoolkitAdminV2DefaultSupportedIdpConfig() // GoogleCloudIdentitytoolkitAdminV2DefaultSupportedIdpConfig | 
};
apiInstance.identitytoolkitProjectsTenantsDefaultSupportedIdpConfigsCreate(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> GoogleCloudIdentitytoolkitAdminV2ListDefaultSupportedIdpConfigsResponse identitytoolkitProjectsTenantsDefaultSupportedIdpConfigsList(parent, opts)
...
let apiInstance = new IdentityToolkitApi.ProjectsApi();
let parent = "parent_example"; // String | The parent resource name, for example, \"projects/my-awesome-project\".
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
apiInstance.identitytoolkitProjectsTenantsDefaultSupportedIdpConfigsList(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> GoogleIamV1Policy identitytoolkitProjectsTenantsGetIamPolicy(resource, opts)
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'googleIamV1GetIamPolicyRequest': new IdentityToolkitApi.GoogleIamV1GetIamPolicyRequest() // GoogleIamV1GetIamPolicyRequest | 
};
apiInstance.identitytoolkitProjectsTenantsGetIamPolicy(resource, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> GoogleCloudIdentitytoolkitAdminV2InboundSamlConfig identitytoolkitProjectsTenantsInboundSamlConfigsCreate(parent, opts)
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'inboundSamlConfigId': "inboundSamlConfigId_example", // String | The id to use for this config.
  'googleCloudIdentitytoolkitAdminV2InboundSamlConfig': new IdentityToolkitApi.GoogleCloudIdentitytoolkitAdminV2InboundSamlConfig() // GoogleCloudIdentitytoolkitAdminV2InboundSamlConfig | 
};
apiInstance.identitytoolkitProjectsTenantsInboundSamlConfigsCreate(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> GoogleCloudIdentitytoolkitAdminV2ListInboundSamlConfigsResponse identitytoolkitProjectsTenantsInboundSamlConfigsList(parent, opts)
...
apiInstance.identitytoolkitProjectsTenantsInboundSamlConfigsList(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> GoogleCloudIdentitytoolkitAdminV2ListTenantsResponse identitytoolkitProjectsTenantsList(parent, opts)
...
let apiInstance = new IdentityToolkitApi.ProjectsApi();
let parent = "parent_example"; // String | Required. The parent resource name to list tenants for.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'pageSize': 56, // Number | The maximum number of results to return, capped at 1000. If not specified, the default value is 20.
  'pageToken': "pageToken_example" // String | The pagination token from the response of a previous request.
};
apiInstance.identitytoolkitProjectsTenantsList(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **uploadProtocol** | **String**| Upload protocol for media (e.g. \&quot;raw\&quot;, \&quot;multipart\&quot;). | [optional] 
 **uploadType** | **String**| Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;). | [optional] 
 **pageSize** | **Number**| The maximum number of results to return, capped at 1000. If not specified, the default value is 20. | [optional] 
...
> GoogleCloudIdentitytoolkitAdminV2OAuthIdpConfig identitytoolkitProjectsTenantsOauthIdpConfigsCreate(parent, opts)
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'oauthIdpConfigId': "oauthIdpConfigId_example", // String | The id to use for this config.
  'googleCloudIdentitytoolkitAdminV2OAuthIdpConfig': new IdentityToolkitApi.GoogleCloudIdentitytoolkitAdminV2OAuthIdpConfig() // GoogleCloudIdentitytoolkitAdminV2OAuthIdpConfig | 
};
apiInstance.identitytoolkitProjectsTenantsOauthIdpConfigsCreate(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Object identitytoolkitProjectsTenantsOauthIdpConfigsDelete(name, opts)
...
let apiInstance = new IdentityToolkitApi.ProjectsApi();
let name = "name_example"; // String | The resource name of the config to be deleted, for example: 'projects/my-awesome-project/oauthIdpConfigs/oauth-config-id'.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
apiInstance.identitytoolkitProjectsTenantsOauthIdpConfigsDelete(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> GoogleCloudIdentitytoolkitAdminV2OAuthIdpConfig identitytoolkitProjectsTenantsOauthIdpConfigsGet(name, opts)
...
let apiInstance = new IdentityToolkitApi.ProjectsApi();
let name = "name_example"; // String | The resource name of the config, for example: 'projects/my-awesome-project/oauthIdpConfigs/oauth-config-id'.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
apiInstance.identitytoolkitProjectsTenantsOauthIdpConfigsGet(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> GoogleCloudIdentitytoolkitAdminV2ListOAuthIdpConfigsResponse identitytoolkitProjectsTenantsOauthIdpConfigsList(parent, opts)
...
apiInstance.identitytoolkitProjectsTenantsOauthIdpConfigsList(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> GoogleCloudIdentitytoolkitAdminV2OAuthIdpConfig identitytoolkitProjectsTenantsOauthIdpConfigsPatch(name, opts)
...
let apiInstance = new IdentityToolkitApi.ProjectsApi();
let name = "name_example"; // String | The name of the OAuthIdpConfig resource, for example: 'projects/my-awesome-project/oauthIdpConfigs/oauth-config-id'. Ignored during create requests.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'updateMask': "updateMask_example", // String | The update mask applies to the resource. Empty update mask will result in updating nothing. For the `FieldMask` definition, see https://developers.google.com/protocol-buffers/docs/reference/google.protobuf#fieldmask
  'googleCloudIdentitytoolkitAdminV2OAuthIdpConfig': new IdentityToolkitApi.GoogleCloudIdentitytoolkitAdminV2OAuthIdpConfig() // GoogleCloudIdentitytoolkitAdminV2OAuthIdpConfig | 
};
apiInstance.identitytoolkitProjectsTenantsOauthIdpConfigsPatch(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> GoogleIamV1Policy identitytoolkitProjectsTenantsSetIamPolicy(resource, opts)
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'googleIamV1SetIamPolicyRequest': new IdentityToolkitApi.GoogleIamV1SetIamPolicyRequest() // GoogleIamV1SetIamPolicyRequest | 
};
apiInstance.identitytoolkitProjectsTenantsSetIamPolicy(resource, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> GoogleIamV1TestIamPermissionsResponse identitytoolkitProjectsTenantsTestIamPermissions(resource, opts)
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'googleIamV1TestIamPermissionsRequest': new IdentityToolkitApi.GoogleIamV1TestIamPermissionsRequest() // GoogleIamV1TestIamPermissionsRequest | 
};
apiInstance.identitytoolkitProjectsTenantsTestIamPermissions(resource, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
