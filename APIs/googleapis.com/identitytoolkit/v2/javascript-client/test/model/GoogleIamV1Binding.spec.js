...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IdentityToolkitApi.GoogleIamV1Binding();
  });
  ...
  describe('GoogleIamV1Binding', function() {
    it('should create an instance of GoogleIamV1Binding', function() {
      ...
      //var instance = new IdentityToolkitApi.GoogleIamV1Binding();
      //expect(instance).to.be.a(IdentityToolkitApi.GoogleIamV1Binding);
    });
