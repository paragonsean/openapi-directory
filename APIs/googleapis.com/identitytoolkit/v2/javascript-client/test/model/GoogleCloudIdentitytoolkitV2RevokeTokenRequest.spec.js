...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IdentityToolkitApi.GoogleCloudIdentitytoolkitV2RevokeTokenRequest();
  });
  ...
  describe('GoogleCloudIdentitytoolkitV2RevokeTokenRequest', function() {
    it('should create an instance of GoogleCloudIdentitytoolkitV2RevokeTokenRequest', function() {
      // uncomment below and update the code to test GoogleCloudIdentitytoolkitV2RevokeTokenRequest
      //var instance = new IdentityToolkitApi.GoogleCloudIdentitytoolkitV2RevokeTokenRequest();
      //expect(instance).to.be.a(IdentityToolkitApi.GoogleCloudIdentitytoolkitV2RevokeTokenRequest);
    });
