...
/*
 * OAIGoogleCloudIdentitytoolkitAdminV2CustomStrengthOptions.h
 *
 * Custom strength options to enforce on user passwords.
 */

#ifndef OAIGoogleCloudIdentitytoolkitAdminV2CustomStrengthOptions_H
#define OAIGoogleCloudIdentitytoolkitAdminV2CustomStrengthOptions_H
...
class OAIGoogleCloudIdentitytoolkitAdminV2CustomStrengthOptions : public OAIObject {
public:
    OAIGoogleCloudIdentitytoolkitAdminV2CustomStrengthOptions();
    OAIGoogleCloudIdentitytoolkitAdminV2CustomStrengthOptions(QString json);
    ~OAIGoogleCloudIdentitytoolkitAdminV2CustomStrengthOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudIdentitytoolkitAdminV2CustomStrengthOptions)

#endif // OAIGoogleCloudIdentitytoolkitAdminV2CustomStrengthOptions_H
