...
#include "OAIDefaultSupportedIdpsApi.h"
...
OAIDefaultSupportedIdpsApi::OAIDefaultSupportedIdpsApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIDefaultSupportedIdpsApi::~OAIDefaultSupportedIdpsApi() {
}

void OAIDefaultSupportedIdpsApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("identitytoolkit_defaultSupportedIdps_list", defaultConf);
    _serverIndices.insert("identitytoolkit_defaultSupportedIdps_list", 0);
}
...
*/
int OAIDefaultSupportedIdpsApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIDefaultSupportedIdpsApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIDefaultSupportedIdpsApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIDefaultSupportedIdpsApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIDefaultSupportedIdpsApi::setUsername(const QString &username) {
    _username = username;
}

void OAIDefaultSupportedIdpsApi::setPassword(const QString &password) {
    _password = password;
}


void OAIDefaultSupportedIdpsApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIDefaultSupportedIdpsApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIDefaultSupportedIdpsApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIDefaultSupportedIdpsApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIDefaultSupportedIdpsApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIDefaultSupportedIdpsApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIDefaultSupportedIdpsApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIDefaultSupportedIdpsApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIDefaultSupportedIdpsApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIDefaultSupportedIdpsApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIDefaultSupportedIdpsApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIDefaultSupportedIdpsApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIDefaultSupportedIdpsApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIDefaultSupportedIdpsApi::identitytoolkit_defaultSupportedIdps_list(const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &page_token) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultSupportedIdpsApi::identitytoolkit_defaultSupportedIdps_listCallback);
    connect(this, &OAIDefaultSupportedIdpsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultSupportedIdpsApi::identitytoolkit_defaultSupportedIdps_listCallback);
    connect(this, &OAIDefaultSupportedIdpsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
...
void OAIDefaultSupportedIdpsApi::identitytoolkit_defaultSupportedIdps_listCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIGoogleCloudIdentitytoolkitAdminV2ListDefaultSupportedIdpsResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT identitytoolkit_defaultSupportedIdps_listSignal(output);
        Q_EMIT identitytoolkit_defaultSupportedIdps_listSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT identitytoolkit_defaultSupportedIdps_listSignalE(output, error_type, error_str);
        Q_EMIT identitytoolkit_defaultSupportedIdps_listSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT identitytoolkit_defaultSupportedIdps_listSignalError(output, error_type, error_str);
        Q_EMIT identitytoolkit_defaultSupportedIdps_listSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIDefaultSupportedIdpsApi::tokenAvailable(){
