...
async def content_liasettings_custombatch(request: web.Request, xgafv=None, access_token=None, alt=None, param_callback=None, fields=None, key=None, oauth_token=None, pretty_print=None, quota_user=None, upload_protocol=None, upload_type=None, dry_run=None, body=None) -> web.Response:
...
async def content_liasettings_getaccessiblegmbaccounts(request: web.Request, merchant_id, account_id, xgafv=None, access_token=None, alt=None, param_callback=None, fields=None, key=None, oauth_token=None, pretty_print=None, quota_user=None, upload_protocol=None, upload_type=None) -> web.Response:
    ...
    :param merchant_id: The ID of the managing account. If this parameter is not the same as accountId, then this account must be a multi-client account and &#x60;accountId&#x60; must be the ID of a sub-account of this account.
    :type merchant_id: str
    :param account_id: The ID of the account for which to retrieve accessible Google My Business accounts.
    :type account_id: str
    :param xgafv: V1 error format.
    :type xgafv: str
    :param access_token: OAuth access token.
...
async def content_liasettings_requestgmbaccess(request: web.Request, merchant_id, account_id, gmb_email, xgafv=None, access_token=None, alt=None, param_callback=None, fields=None, key=None, oauth_token=None, pretty_print=None, quota_user=None, upload_protocol=None, upload_type=None) -> web.Response:
    ...
    :param merchant_id: The ID of the managing account. If this parameter is not the same as accountId, then this account must be a multi-client account and &#x60;accountId&#x60; must be the ID of a sub-account of this account.
    :type merchant_id: str
    :param account_id: The ID of the account for which GMB access is requested.
    :type account_id: str
    :param gmb_email: The email of the Google My Business account.
    :type gmb_email: str
    :param xgafv: V1 error format.
    :type xgafv: str
    :param access_token: OAuth access token.
...
async def content_liasettings_update(request: web.Request, merchant_id, account_id, xgafv=None, access_token=None, alt=None, param_callback=None, fields=None, key=None, oauth_token=None, pretty_print=None, quota_user=None, upload_protocol=None, upload_type=None, dry_run=None, body=None) -> web.Response:
