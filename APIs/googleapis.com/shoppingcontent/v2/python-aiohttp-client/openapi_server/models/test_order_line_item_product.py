...
class TestOrderLineItemProduct(Model):
    ...
    def __init__(self, brand: str=None, channel: str=None, condition: str=None, content_language: str=None, fees: List[OrderLineItemProductFee]=None, gtin: str=None, image_link: str=None, item_group_id: str=None, mpn: str=None, offer_id: str=None, price: Price=None, target_country: str=None, title: str=None, variant_attributes: List[OrderLineItemProductVariantAttribute]=None):
        ...
        :param channel: The channel of this TestOrderLineItemProduct.
    ...
    @property
    def channel(self):
        """Gets the channel of this TestOrderLineItemProduct.

        Deprecated. Acceptable values are: - \"`online`\" 

        :return: The channel of this TestOrderLineItemProduct.
        :rtype: str
        """
    ...
    def channel(self, channel):
        """Sets the channel of this TestOrderLineItemProduct.
