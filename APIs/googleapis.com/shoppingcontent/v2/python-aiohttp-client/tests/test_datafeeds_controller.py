...
async def test_content_datafeeds_custombatch(client):
    ...
    """
    body = {"entries":[{"datafeed":{"fetchSchedule":{"password":"password","paused":True,"hour":1,"dayOfMonth":6,"fetchUrl":"fetchUrl","weekday":"weekday","timeZone":"timeZone","minuteOfHour":5,"username":"username"},"fileName":"fileName","intendedDestinations":["intendedDestinations","intendedDestinations"],"kind":"kind","format":{"fileEncoding":"fileEncoding","quotingMode":"quotingMode","columnDelimiter":"columnDelimiter"},"name":"name","contentLanguage":"contentLanguage","attributeLanguage":"attributeLanguage","id":"id","contentType":"contentType","targets":[{"country":"country","includedDestinations":["includedDestinations","includedDestinations"],"excludedDestinations":["excludedDestinations","excludedDestinations"],"language":"language"},{"country":"country","includedDestinations":["includedDestinations","includedDestinations"],"excludedDestinations":["excludedDestinations","excludedDestinations"],"language":"language"}],"targetCountry":"targetCountry"},"datafeedId":"datafeedId","method":"method","merchantId":"merchantId","batchId":0},{"datafeed":{"fetchSchedule":{"password":"password","paused":True,"hour":1,"dayOfMonth":6,"fetchUrl":"fetchUrl","weekday":"weekday","timeZone":"timeZone","minuteOfHour":5,"username":"username"},"fileName":"fileName","intendedDestinations":["intendedDestinations","intendedDestinations"],"kind":"kind","format":{"fileEncoding":"fileEncoding","quotingMode":"quotingMode","columnDelimiter":"columnDelimiter"},"name":"name","contentLanguage":"contentLanguage","attributeLanguage":"attributeLanguage","id":"id","contentType":"contentType","targets":[{"country":"country","includedDestinations":["includedDestinations","includedDestinations"],"excludedDestinations":["excludedDestinations","excludedDestinations"],"language":"language"},{"country":"country","includedDestinations":["includedDestinations","includedDestinations"],"excludedDestinations":["excludedDestinations","excludedDestinations"],"language":"language"}],"targetCountry":"targetCountry"},"datafeedId":"datafeedId","method":"method","merchantId":"merchantId","batchId":0}]}
...
async def test_content_datafeeds_delete(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/content/v2/{merchant_id}/datafeeds/{datafeed_id}'.format(merchant_id='merchant_id_example', datafeed_id='datafeed_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_content_datafeeds_fetchnow(client):
    ...
    response = await client.request(
        method='POST',
        path='/content/v2/{merchant_id}/datafeeds/{datafeed_id}/fetchNow'.format(merchant_id='merchant_id_example', datafeed_id='datafeed_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_content_datafeeds_insert(client):
    ...
    """
    body = {"fetchSchedule":{"password":"password","paused":True,"hour":1,"dayOfMonth":6,"fetchUrl":"fetchUrl","weekday":"weekday","timeZone":"timeZone","minuteOfHour":5,"username":"username"},"fileName":"fileName","intendedDestinations":["intendedDestinations","intendedDestinations"],"kind":"kind","format":{"fileEncoding":"fileEncoding","quotingMode":"quotingMode","columnDelimiter":"columnDelimiter"},"name":"name","contentLanguage":"contentLanguage","attributeLanguage":"attributeLanguage","id":"id","contentType":"contentType","targets":[{"country":"country","includedDestinations":["includedDestinations","includedDestinations"],"excludedDestinations":["excludedDestinations","excludedDestinations"],"language":"language"},{"country":"country","includedDestinations":["includedDestinations","includedDestinations"],"excludedDestinations":["excludedDestinations","excludedDestinations"],"language":"language"}],"targetCountry":"targetCountry"}
    params = [('$.xgafv', 'xgafv_example'),
                    ('access_token', 'access_token_example'),
                    ('alt', 'alt_example'),
                    ('callback', 'param_callback_example'),
    ...
    response = await client.request(
        method='POST',
        path='/content/v2/{merchant_id}/datafeeds'.format(merchant_id='merchant_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
