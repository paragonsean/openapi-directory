...
export default class OrdersApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the contentOrdersCustombatch operation.
     * @callback module:api/OrdersApi~contentOrdersCustombatchCallback
     * @param {String} error Error message, if any.
     * @param {module:model/OrdersCustomBatchResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} [uploadProtocol] Upload protocol for media (e.g. \"raw\", \"multipart\").
     * @param {String} [uploadType] Legacy upload protocol for media (e.g. \"media\", \"multipart\").
     * @param {module:model/OrdersCustomBatchRequest} [ordersCustomBatchRequest] 
     * @param {module:api/OrdersApi~contentOrdersCustombatchCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/OrdersCustomBatchResponse}
     */
    contentOrdersCustombatch(opts, callback) {
      opts = opts || {};
      let postBody = opts['ordersCustomBatchRequest'];
      ...
      let contentTypes = ['application/json'];
      let accepts = ['application/json'];
      let returnType = OrdersCustomBatchResponse;
      return this.apiClient.callApi(
        '/orders/batch', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
     ...
     * @param {Array.<module:model/String>} [statuses] Obtains orders that match any of the specified statuses. Please note that `active` is a shortcut for `pendingShipment` and `partiallyShipped`, and `completed` is a shortcut for `shipped`, `partiallyDelivered`, `delivered`, `partiallyReturned`, `returned`, and `canceled`.
    ...
    /**
     * Callback function to receive the result of the contentOrdersRefund operation.
     * @callback module:api/OrdersApi~contentOrdersRefundCallback
     * @param {String} error Error message, if any.
     * @param {module:model/OrdersRefundResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} [uploadProtocol] Upload protocol for media (e.g. \"raw\", \"multipart\").
     * @param {String} [uploadType] Legacy upload protocol for media (e.g. \"media\", \"multipart\").
     * @param {module:model/OrdersRefundRequest} [ordersRefundRequest] 
     * @param {module:api/OrdersApi~contentOrdersRefundCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/OrdersRefundResponse}
     */
    contentOrdersRefund(merchantId, orderId, opts, callback) {
      opts = opts || {};
      let postBody = opts['ordersRefundRequest'];
      // verify the required parameter 'merchantId' is set
      if (merchantId === undefined || merchantId === null) {
        throw new Error("Missing the required parameter 'merchantId' when calling contentOrdersRefund");
      }
      // verify the required parameter 'orderId' is set
      if (orderId === undefined || orderId === null) {
        throw new Error("Missing the required parameter 'orderId' when calling contentOrdersRefund");
      }
      ...
      let contentTypes = ['application/json'];
      let accepts = ['application/json'];
      let returnType = OrdersRefundResponse;
      return this.apiClient.callApi(
        '/{merchantId}/orders/{orderId}/refund', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the contentOrdersReturnlineitem operation.
     * @callback module:api/OrdersApi~contentOrdersReturnlineitemCallback
     * @param {String} error Error message, if any.
     * @param {module:model/OrdersReturnLineItemResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} [uploadProtocol] Upload protocol for media (e.g. \"raw\", \"multipart\").
     * @param {String} [uploadType] Legacy upload protocol for media (e.g. \"media\", \"multipart\").
     * @param {module:model/OrdersReturnLineItemRequest} [ordersReturnLineItemRequest] 
     * @param {module:api/OrdersApi~contentOrdersReturnlineitemCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/OrdersReturnLineItemResponse}
     */
    contentOrdersReturnlineitem(merchantId, orderId, opts, callback) {
      opts = opts || {};
      let postBody = opts['ordersReturnLineItemRequest'];
      // verify the required parameter 'merchantId' is set
      if (merchantId === undefined || merchantId === null) {
        throw new Error("Missing the required parameter 'merchantId' when calling contentOrdersReturnlineitem");
      }
      // verify the required parameter 'orderId' is set
      if (orderId === undefined || orderId === null) {
        throw new Error("Missing the required parameter 'orderId' when calling contentOrdersReturnlineitem");
      }
      ...
      let contentTypes = ['application/json'];
      let accepts = ['application/json'];
      let returnType = OrdersReturnLineItemResponse;
      return this.apiClient.callApi(
        '/{merchantId}/orders/{orderId}/returnLineItem', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
