# ContentApiForShopping.OrderinvoicesApi
...
> OrderinvoicesCreateChargeInvoiceResponse contentOrderinvoicesCreatechargeinvoice(merchantId, orderId, opts)
...
let apiInstance = new ContentApiForShopping.OrderinvoicesApi();
...
let orderId = "orderId_example"; // String | The ID of the order.
let opts = {
  ...
  'orderinvoicesCreateChargeInvoiceRequest': new ContentApiForShopping.OrderinvoicesCreateChargeInvoiceRequest() // OrderinvoicesCreateChargeInvoiceRequest | 
};
apiInstance.contentOrderinvoicesCreatechargeinvoice(merchantId, orderId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> OrderinvoicesCreateRefundInvoiceResponse contentOrderinvoicesCreaterefundinvoice(merchantId, orderId, opts)
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'orderinvoicesCreateRefundInvoiceRequest': new ContentApiForShopping.OrderinvoicesCreateRefundInvoiceRequest() // OrderinvoicesCreateRefundInvoiceRequest | 
};
apiInstance.contentOrderinvoicesCreaterefundinvoice(merchantId, orderId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
