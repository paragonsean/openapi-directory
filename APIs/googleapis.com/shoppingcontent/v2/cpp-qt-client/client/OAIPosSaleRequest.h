...
#ifndef OAIPosSaleRequest_H
#define OAIPosSaleRequest_H
...
class OAIPosSaleRequest : public OAIObject {
public:
    OAIPosSaleRequest();
    OAIPosSaleRequest(QString json);
    ~OAIPosSaleRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPosSaleRequest)

#endif // OAIPosSaleRequest_H
