...
void OAIUnitInvoice::initializeModel() {
    ...
    m_unit_price_pretax_isSet = false;
    m_unit_price_pretax_isValid = false;
...
void OAIUnitInvoice::fromJsonObject(QJsonObject json) {
    ...
    m_unit_price_pretax_isValid = ::OpenAPI::fromJsonValue(m_unit_price_pretax, json[QString("unitPricePretax")]);
    m_unit_price_pretax_isSet = !json[QString("unitPricePretax")].isNull() && m_unit_price_pretax_isValid;
...
QJsonObject OAIUnitInvoice::asJsonObject() const {
    ...
    if (m_unit_price_pretax.isSet()) {
        obj.insert(QString("unitPricePretax"), ::OpenAPI::toJsonValue(m_unit_price_pretax));
    }
...
QList<OAIPromotion> OAIUnitInvoice::getPromotions() const {
    return m_promotions;
}
void OAIUnitInvoice::setPromotions(const QList<OAIPromotion> &promotions) {
    m_promotions = promotions;
    m_promotions_isSet = true;
}

bool OAIUnitInvoice::is_promotions_Set() const{
    return m_promotions_isSet;
}

bool OAIUnitInvoice::is_promotions_Valid() const{
    return m_promotions_isValid;
}

OAIPrice OAIUnitInvoice::getUnitPricePretax() const {
    return m_unit_price_pretax;
}
void OAIUnitInvoice::setUnitPricePretax(const OAIPrice &unit_price_pretax) {
    m_unit_price_pretax = unit_price_pretax;
    m_unit_price_pretax_isSet = true;
}

bool OAIUnitInvoice::is_unit_price_pretax_Set() const{
    return m_unit_price_pretax_isSet;
}

bool OAIUnitInvoice::is_unit_price_pretax_Valid() const{
    return m_unit_price_pretax_isValid;
}
