...
void OAITestOrderLineItem::initializeModel() {
    ...
    m_unit_tax_isSet = false;
    m_unit_tax_isValid = false;
}
...
void OAITestOrderLineItem::fromJsonObject(QJsonObject json) {
    ...
    m_unit_tax_isValid = ::OpenAPI::fromJsonValue(m_unit_tax, json[QString("unitTax")]);
    m_unit_tax_isSet = !json[QString("unitTax")].isNull() && m_unit_tax_isValid;
}
...
QJsonObject OAITestOrderLineItem::asJsonObject() const {
    ...
    if (m_unit_tax.isSet()) {
        obj.insert(QString("unitTax"), ::OpenAPI::toJsonValue(m_unit_tax));
    }
    return obj;
}
...
OAIPrice OAITestOrderLineItem::getUnitTax() const {
    return m_unit_tax;
}
void OAITestOrderLineItem::setUnitTax(const OAIPrice &unit_tax) {
    m_unit_tax = unit_tax;
    m_unit_tax_isSet = true;
}

bool OAITestOrderLineItem::is_unit_tax_Set() const{
    return m_unit_tax_isSet;
}

bool OAITestOrderLineItem::is_unit_tax_Valid() const{
    return m_unit_tax_isValid;
}
