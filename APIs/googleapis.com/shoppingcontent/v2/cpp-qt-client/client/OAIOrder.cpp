...
QString OAIOrder::getChannelType() const {
    return m_channel_type;
}
void OAIOrder::setChannelType(const QString &channel_type) {
    m_channel_type = channel_type;
    m_channel_type_isSet = true;
}

bool OAIOrder::is_channel_type_Set() const{
    return m_channel_type_isSet;
}

bool OAIOrder::is_channel_type_Valid() const{
...
OAIPrice OAIOrder::getNetAmount() const {
    return m_net_amount;
}
void OAIOrder::setNetAmount(const OAIPrice &net_amount) {
    m_net_amount = net_amount;
    m_net_amount_isSet = true;
}

bool OAIOrder::is_net_amount_Set() const{
    return m_net_amount_isSet;
}

bool OAIOrder::is_net_amount_Valid() const{
    return m_net_amount_isValid;
}

OAIOrderPaymentMethod OAIOrder::getPaymentMethod() const {
    return m_payment_method;
}
void OAIOrder::setPaymentMethod(const OAIOrderPaymentMethod &payment_method) {
...
QList<OAIOrderLegacyPromotion> OAIOrder::getPromotions() const {
    return m_promotions;
}
void OAIOrder::setPromotions(const QList<OAIOrderLegacyPromotion> &promotions) {
...
QString OAIOrder::getShippingOption() const {
    return m_shipping_option;
}
void OAIOrder::setShippingOption(const QString &shipping_option) {
