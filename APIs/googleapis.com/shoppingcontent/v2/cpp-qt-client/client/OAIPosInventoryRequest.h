...
/*
 * OAIPosInventoryRequest.h
 *
 * 
 */

#ifndef OAIPosInventoryRequest_H
#define OAIPosInventoryRequest_H
...
class OAIPosInventoryRequest : public OAIObject {
public:
    OAIPosInventoryRequest();
    OAIPosInventoryRequest(QString json);
    ~OAIPosInventoryRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPosInventoryRequest)

#endif // OAIPosInventoryRequest_H
