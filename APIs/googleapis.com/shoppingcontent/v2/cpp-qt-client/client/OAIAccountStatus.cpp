...
QList<OAIAccountStatusDataQualityIssue> OAIAccountStatus::getDataQualityIssues() const {
    return m_data_quality_issues;
}
void OAIAccountStatus::setDataQualityIssues(const QList<OAIAccountStatusDataQualityIssue> &data_quality_issues) {
    m_data_quality_issues = data_quality_issues;
    m_data_quality_issues_isSet = true;
}

bool OAIAccountStatus::is_data_quality_issues_Set() const{
    return m_data_quality_issues_isSet;
}

bool OAIAccountStatus::is_data_quality_issues_Valid() const{
