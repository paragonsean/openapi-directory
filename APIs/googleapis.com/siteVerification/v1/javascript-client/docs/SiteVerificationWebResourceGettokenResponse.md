# GoogleSiteVerificationApi.SiteVerificationWebResourceGettokenResponse
...
**token** | **String** | The verification token. The token must be placed appropriately in order for verification to succeed. | [optional] 
