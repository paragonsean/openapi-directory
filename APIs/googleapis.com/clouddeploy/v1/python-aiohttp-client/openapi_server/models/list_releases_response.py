...
class ListReleasesResponse(Model):
    ...
    def __init__(self, next_page_token: str=None, releases: List[Release]=None, unreachable: List[str]=None):
        ...
        :param unreachable: The unreachable of this ListReleasesResponse.
        """
        self.openapi_types = {
            'next_page_token': str,
    ...
    def unreachable(self):
        """Gets the unreachable of this ListReleasesResponse.

        Locations that could not be reached.

        :return: The unreachable of this ListReleasesResponse.
        :rtype: List[str]
        """
    ...
    def unreachable(self, unreachable):
        """Sets the unreachable of this ListReleasesResponse.
