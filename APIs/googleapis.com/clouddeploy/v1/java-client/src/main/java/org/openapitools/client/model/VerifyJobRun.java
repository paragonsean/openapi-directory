...
public class VerifyJobRun {
  ...
  public static final String SERIALIZED_NAME_EVENT_LOG_PATH = "eventLogPath";
  @SerializedName(SERIALIZED_NAME_EVENT_LOG_PATH)
  ...
  public boolean equals(Object o) {
    ...
    VerifyJobRun verifyJobRun = (VerifyJobRun) o;
    return Objects.equals(this.artifactUri, verifyJobRun.artifactUri) &&
        Objects.equals(this.build, verifyJobRun.build) &&
        Objects.equals(this.eventLogPath, verifyJobRun.eventLogPath) &&
        Objects.equals(this.failureCause, verifyJobRun.failureCause) &&
        Objects.equals(this.failureMessage, verifyJobRun.failureMessage);
  }

  @Override
  public int hashCode() {
    return Objects.hash(artifactUri, build, eventLogPath, failureCause, failureMessage);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class VerifyJobRun {\n");
    sb.append("    artifactUri: ").append(toIndentedString(artifactUri)).append("\n");
    sb.append("    build: ").append(toIndentedString(build)).append("\n");
    sb.append("    eventLogPath: ").append(toIndentedString(eventLogPath)).append("\n");
  ...
  static {
    ...
    openapiFields.add("eventLogPath");
   ...
   * @throws IOException if the JSON Element is invalid with respect to VerifyJobRun
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VerifyJobRun.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VerifyJobRun is not found in the empty JSON string", VerifyJobRun.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VerifyJobRun.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VerifyJobRun` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("eventLogPath") != null && !jsonObj.get("eventLogPath").isJsonNull()) && !jsonObj.get("eventLogPath").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `eventLogPath` to be a primitive type in the JSON string but got `%s`", jsonObj.get("eventLogPath").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VerifyJobRun.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VerifyJobRun' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VerifyJobRun> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VerifyJobRun.class));

       return (TypeAdapter<T>) new TypeAdapter<VerifyJobRun>() {
           @Override
           public void write(JsonWriter out, VerifyJobRun value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public VerifyJobRun read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of VerifyJobRun given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of VerifyJobRun
   * @throws IOException if the JSON string is invalid with respect to VerifyJobRun
   */
  public static VerifyJobRun fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VerifyJobRun.class);
  }

  /**
   * Convert an instance of VerifyJobRun to an JSON string
   *
   * @return JSON string
   */
