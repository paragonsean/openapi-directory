...
public class CustomMetadata {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.values, customMetadata.values);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CustomMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CustomMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
