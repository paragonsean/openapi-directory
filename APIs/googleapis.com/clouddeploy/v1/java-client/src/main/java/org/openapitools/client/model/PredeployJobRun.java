...
public class PredeployJobRun {
  ...
  public boolean equals(Object o) {
    ...
    PredeployJobRun predeployJobRun = (PredeployJobRun) o;
    return Objects.equals(this.build, predeployJobRun.build) &&
        Objects.equals(this.failureCause, predeployJobRun.failureCause) &&
        Objects.equals(this.failureMessage, predeployJobRun.failureMessage);
  }
  ...
  public String toString() {
    ...
    sb.append("class PredeployJobRun {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PredeployJobRun
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PredeployJobRun.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PredeployJobRun is not found in the empty JSON string", PredeployJobRun.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PredeployJobRun.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PredeployJobRun` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PredeployJobRun.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PredeployJobRun' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PredeployJobRun> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PredeployJobRun.class));

       return (TypeAdapter<T>) new TypeAdapter<PredeployJobRun>() {
           @Override
           public void write(JsonWriter out, PredeployJobRun value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PredeployJobRun read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PredeployJobRun given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PredeployJobRun
   * @throws IOException if the JSON string is invalid with respect to PredeployJobRun
   */
  public static PredeployJobRun fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PredeployJobRun.class);
  }

  /**
   * Convert an instance of PredeployJobRun to an JSON string
   *
   * @return JSON string
   */
