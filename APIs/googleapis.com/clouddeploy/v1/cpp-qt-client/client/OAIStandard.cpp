...
OAIPostdeploy OAIStandard::getPostdeploy() const {
    return m_postdeploy;
}
void OAIStandard::setPostdeploy(const OAIPostdeploy &postdeploy) {
    m_postdeploy = postdeploy;
    m_postdeploy_isSet = true;
}

bool OAIStandard::is_postdeploy_Set() const{
    return m_postdeploy_isSet;
}

bool OAIStandard::is_postdeploy_Valid() const{
    return m_postdeploy_isValid;
}

OAIPredeploy OAIStandard::getPredeploy() const {
    return m_predeploy;
}
void OAIStandard::setPredeploy(const OAIPredeploy &predeploy) {
    m_predeploy = predeploy;
    m_predeploy_isSet = true;
}

bool OAIStandard::is_predeploy_Set() const{
    return m_predeploy_isSet;
}

bool OAIStandard::is_predeploy_Valid() const{
    return m_predeploy_isValid;
}

bool OAIStandard::isVerify() const {
    return m_verify;
}
void OAIStandard::setVerify(const bool &verify) {
    m_verify = verify;
    m_verify_isSet = true;
}

bool OAIStandard::is_verify_Set() const{
    return m_verify_isSet;
}

bool OAIStandard::is_verify_Valid() const{
