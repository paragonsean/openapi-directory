...
#ifndef OAIPostdeploy_H
#define OAIPostdeploy_H
...
class OAIPostdeploy : public OAIObject {
public:
    OAIPostdeploy();
    OAIPostdeploy(QString json);
    ~OAIPostdeploy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPostdeploy)

#endif // OAIPostdeploy_H
