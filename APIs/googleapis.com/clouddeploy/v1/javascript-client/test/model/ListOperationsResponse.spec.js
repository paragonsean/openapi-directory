...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudDeployApi.ListOperationsResponse();
  });
  ...
  describe('ListOperationsResponse', function() {
    it('should create an instance of ListOperationsResponse', function() {
      ...
      //var instance = new CloudDeployApi.ListOperationsResponse();
      //expect(instance).to.be.a(CloudDeployApi.ListOperationsResponse);
    });
