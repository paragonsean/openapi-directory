...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudDeployApi.ListTargetsResponse();
  });
  ...
  describe('ListTargetsResponse', function() {
    it('should create an instance of ListTargetsResponse', function() {
      ...
      //var instance = new CloudDeployApi.ListTargetsResponse();
      //expect(instance).to.be.a(CloudDeployApi.ListTargetsResponse);
    });
