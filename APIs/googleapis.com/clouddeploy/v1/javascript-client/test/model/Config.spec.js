...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudDeployApi.Config();
  });
  ...
  describe('Config', function() {
    it('should create an instance of Config', function() {
      ...
      //var instance = new CloudDeployApi.Config();
      //expect(instance).to.be.a(CloudDeployApi.Config);
    });

    it('should have the property defaultSkaffoldVersion (base name: "defaultSkaffoldVersion")', function() {
      // uncomment below and update the code to test the property defaultSkaffoldVersion
      //var instance = new CloudDeployApi.Config();
