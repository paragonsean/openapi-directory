...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudDeployApi.DeliveryPipeline();
  });
  ...
  describe('DeliveryPipeline', function() {
    it('should create an instance of DeliveryPipeline', function() {
      // uncomment below and update the code to test DeliveryPipeline
      //var instance = new CloudDeployApi.DeliveryPipeline();
      //expect(instance).to.be.a(CloudDeployApi.DeliveryPipeline);
    });
    ...
    it('should have the property serialPipeline (base name: "serialPipeline")', function() {
      // uncomment below and update the code to test the property serialPipeline
      //var instance = new CloudDeployApi.DeliveryPipeline();
      //expect(instance).to.be();
    });
