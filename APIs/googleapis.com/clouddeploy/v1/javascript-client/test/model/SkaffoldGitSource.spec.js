...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudDeployApi.SkaffoldGitSource();
  });
  ...
  describe('SkaffoldGitSource', function() {
    it('should create an instance of SkaffoldGitSource', function() {
      // uncomment below and update the code to test SkaffoldGitSource
      //var instance = new CloudDeployApi.SkaffoldGitSource();
      //expect(instance).to.be.a(CloudDeployApi.SkaffoldGitSource);
    });
