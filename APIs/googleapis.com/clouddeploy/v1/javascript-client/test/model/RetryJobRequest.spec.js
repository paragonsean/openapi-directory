...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudDeployApi.RetryJobRequest();
  });
  ...
  describe('RetryJobRequest', function() {
    it('should create an instance of RetryJobRequest', function() {
      // uncomment below and update the code to test RetryJobRequest
      //var instance = new CloudDeployApi.RetryJobRequest();
      //expect(instance).to.be.a(CloudDeployApi.RetryJobRequest);
    });
