...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudDeployApi.ListAutomationsResponse();
  });
  ...
  describe('ListAutomationsResponse', function() {
    it('should create an instance of ListAutomationsResponse', function() {
      // uncomment below and update the code to test ListAutomationsResponse
      //var instance = new CloudDeployApi.ListAutomationsResponse();
      //expect(instance).to.be.a(CloudDeployApi.ListAutomationsResponse);
    });
