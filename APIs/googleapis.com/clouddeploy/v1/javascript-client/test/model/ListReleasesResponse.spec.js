...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudDeployApi.ListReleasesResponse();
  });
  ...
  describe('ListReleasesResponse', function() {
    it('should create an instance of ListReleasesResponse', function() {
      ...
      //var instance = new CloudDeployApi.ListReleasesResponse();
      //expect(instance).to.be.a(CloudDeployApi.ListReleasesResponse);
    });
