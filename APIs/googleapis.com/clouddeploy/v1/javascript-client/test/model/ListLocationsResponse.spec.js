...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudDeployApi.ListLocationsResponse();
  });
  ...
  describe('ListLocationsResponse', function() {
    it('should create an instance of ListLocationsResponse', function() {
      ...
      //var instance = new CloudDeployApi.ListLocationsResponse();
      //expect(instance).to.be.a(CloudDeployApi.ListLocationsResponse);
    });
