...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudDeployApi.IgnoreJobRequest();
  });
  ...
  describe('IgnoreJobRequest', function() {
    it('should create an instance of IgnoreJobRequest', function() {
      // uncomment below and update the code to test IgnoreJobRequest
      //var instance = new CloudDeployApi.IgnoreJobRequest();
      //expect(instance).to.be.a(CloudDeployApi.IgnoreJobRequest);
    });
