...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudDeployApi.RepairPhase();
  });
  ...
  describe('RepairPhase', function() {
    it('should create an instance of RepairPhase', function() {
      // uncomment below and update the code to test RepairPhase
      //var instance = new CloudDeployApi.RepairPhase();
      //expect(instance).to.be.a(CloudDeployApi.RepairPhase);
    });
