...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudDeployApi.PromoteReleaseOperation();
  });
  ...
  describe('PromoteReleaseOperation', function() {
    it('should create an instance of PromoteReleaseOperation', function() {
      // uncomment below and update the code to test PromoteReleaseOperation
      //var instance = new CloudDeployApi.PromoteReleaseOperation();
      //expect(instance).to.be.a(CloudDeployApi.PromoteReleaseOperation);
    });
