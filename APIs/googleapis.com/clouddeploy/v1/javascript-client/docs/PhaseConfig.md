# CloudDeployApi.PhaseConfig

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**percentage** | **Number** | Required. Percentage deployment for the phase. | [optional] 
...
**profiles** | **[String]** | Skaffold profiles to use when rendering the manifest for this phase. These are in addition to the profiles list specified in the &#x60;DeliveryPipeline&#x60; stage. | [optional] 
