# CloudDeployApi.Stage

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**deployParameters** | [**[DeployParameters]**](DeployParameters.md) | Optional. The deploy parameters to use for the target in this stage. | [optional] 
**profiles** | **[String]** | Skaffold profiles to use when rendering the manifest for this stage&#39;s &#x60;Target&#x60;. | [optional] 
