...
/**
 * The AutomationEvent model module.
 * @module model/AutomationEvent
 * @version v1
 */
class AutomationEvent {
    /**
     * Constructs a new <code>AutomationEvent</code>.
     * Payload proto for \&quot;clouddeploy.googleapis.com/automation\&quot; Platform Log event that describes the Automation related events.
     * @alias module:model/AutomationEvent
     */
    constructor() { 
        
        AutomationEvent.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AutomationEvent</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AutomationEvent} obj Optional instance to populate.
     * @return {module:model/AutomationEvent} The populated <code>AutomationEvent</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AutomationEvent();
    ...
    /**
     * Validates the JSON data with respect to <code>AutomationEvent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AutomationEvent</code>.
     */
 ...
 */
AutomationEvent.prototype['automation'] = undefined;
 ...
 */
AutomationEvent.prototype['message'] = undefined;

/**
 * Unique identifier of the `DeliveryPipeline`.
 * @member {String} pipelineUid
 */
AutomationEvent.prototype['pipelineUid'] = undefined;

/**
 * Type of this notification, e.g. for a Pub/Sub failure.
 * @member {module:model/AutomationEvent.TypeEnum} type
 */
AutomationEvent.prototype['type'] = undefined;
