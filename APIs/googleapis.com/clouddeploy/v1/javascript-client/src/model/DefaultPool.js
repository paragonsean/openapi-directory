...
/**
 * The DefaultPool model module.
 * @module model/DefaultPool
 * @version v1
 */
class DefaultPool {
    /**
     * Constructs a new <code>DefaultPool</code>.
     * Execution using the default Cloud Build pool.
     * @alias module:model/DefaultPool
     */
    constructor() { 
        
        DefaultPool.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DefaultPool</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DefaultPool} obj Optional instance to populate.
     * @return {module:model/DefaultPool} The populated <code>DefaultPool</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DefaultPool();
    ...
    /**
     * Validates the JSON data with respect to <code>DefaultPool</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DefaultPool</code>.
     */
 ...
 */
DefaultPool.prototype['artifactStorage'] = undefined;

/**
 * Optional. Google service account to use for execution. If unspecified, the project execution service account (-compute@developer.gserviceaccount.com) will be used.
 * @member {String} serviceAccount
 */
DefaultPool.prototype['serviceAccount'] = undefined;
