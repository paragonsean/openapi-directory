...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DoubleClickBidManagerApi.EventFilter();
  });
  ...
  describe('EventFilter', function() {
    it('should create an instance of EventFilter', function() {
      ...
      //var instance = new DoubleClickBidManagerApi.EventFilter();
      //expect(instance).to.be.a(DoubleClickBidManagerApi.EventFilter);
    });
