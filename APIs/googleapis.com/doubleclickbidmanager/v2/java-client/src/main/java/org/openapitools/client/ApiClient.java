...
public class ApiClient {
    ...
    private String basePath = "https://doubleclickbidmanager.googleapis.com/v2";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://doubleclickbidmanager.googleapis.com/v2
