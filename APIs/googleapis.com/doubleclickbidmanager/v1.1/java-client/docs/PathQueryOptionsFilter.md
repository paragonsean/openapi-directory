...
|------------ | ------------- | ------------- | -------------|
|**filter** | [**FilterEnum**](#FilterEnum) | Dimension the filter is applied to. |  [optional] |
|**match** | [**MatchEnum**](#MatchEnum) | Indicates how the filter should be matched to the value. |  [optional] |
|**values** | **List&lt;String&gt;** | Value to filter on. |  [optional] |
