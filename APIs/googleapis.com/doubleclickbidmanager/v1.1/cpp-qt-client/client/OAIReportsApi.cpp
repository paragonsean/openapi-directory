...
void OAIReportsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("doubleclickbidmanager_reports_listreports", defaultConf);
    _serverIndices.insert("doubleclickbidmanager_reports_listreports", 0);
}
...
void OAIReportsApi::doubleclickbidmanager_reports_listreports(const QString &query_id, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &page_token) {
    QString fullPath = QString(_serverConfigs["doubleclickbidmanager_reports_listreports"][_serverIndices.value("doubleclickbidmanager_reports_listreports")].URL()+"/queries/{queryId}/reports");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIReportsApi::doubleclickbidmanager_reports_listreportsCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIReportsApi::doubleclickbidmanager_reports_listreportsCallback);
...
void OAIReportsApi::doubleclickbidmanager_reports_listreportsCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT doubleclickbidmanager_reports_listreportsSignal(output);
        Q_EMIT doubleclickbidmanager_reports_listreportsSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT doubleclickbidmanager_reports_listreportsSignalE(output, error_type, error_str);
        Q_EMIT doubleclickbidmanager_reports_listreportsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT doubleclickbidmanager_reports_listreportsSignalError(output, error_type, error_str);
        Q_EMIT doubleclickbidmanager_reports_listreportsSignalErrorFull(worker, error_type, error_str);
    }
}
