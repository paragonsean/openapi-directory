...
class Version(Model):
    ...
    def __init__(self, create_time: str=None, description: str=None, metadata: Dict[str, object]=None, name: str=None, related_tags: List[Tag]=None, update_time: str=None):
