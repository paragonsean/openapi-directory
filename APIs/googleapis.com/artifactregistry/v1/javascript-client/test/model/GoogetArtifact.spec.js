...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ArtifactRegistryApi.GoogetArtifact();
  });
  ...
  describe('GoogetArtifact', function() {
    it('should create an instance of GoogetArtifact', function() {
      // uncomment below and update the code to test GoogetArtifact
      //var instance = new ArtifactRegistryApi.GoogetArtifact();
      //expect(instance).to.be.a(ArtifactRegistryApi.GoogetArtifact);
    });
