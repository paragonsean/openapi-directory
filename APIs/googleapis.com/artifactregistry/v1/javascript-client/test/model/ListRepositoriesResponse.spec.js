...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ArtifactRegistryApi.ListRepositoriesResponse();
  });
  ...
  describe('ListRepositoriesResponse', function() {
    it('should create an instance of ListRepositoriesResponse', function() {
      ...
      //var instance = new ArtifactRegistryApi.ListRepositoriesResponse();
      //expect(instance).to.be.a(ArtifactRegistryApi.ListRepositoriesResponse);
    });
