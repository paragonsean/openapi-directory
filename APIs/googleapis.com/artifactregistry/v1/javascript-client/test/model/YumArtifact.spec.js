...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ArtifactRegistryApi.YumArtifact();
  });
  ...
  describe('YumArtifact', function() {
    it('should create an instance of YumArtifact', function() {
      // uncomment below and update the code to test YumArtifact
      //var instance = new ArtifactRegistryApi.YumArtifact();
      //expect(instance).to.be.a(ArtifactRegistryApi.YumArtifact);
    });
