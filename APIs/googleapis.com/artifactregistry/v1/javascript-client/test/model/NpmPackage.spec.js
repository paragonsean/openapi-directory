...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ArtifactRegistryApi.NpmPackage();
  });
  ...
  describe('NpmPackage', function() {
    it('should create an instance of NpmPackage', function() {
      // uncomment below and update the code to test NpmPackage
      //var instance = new ArtifactRegistryApi.NpmPackage();
      //expect(instance).to.be.a(ArtifactRegistryApi.NpmPackage);
    });
