    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('files')) {
                obj['files'] = ApiClient.convertToType(data['files'], [GoogleDevtoolsArtifactregistryV1File]);
            }
    ...
    static validateJSON(data) {
        if (data['files']) { // data not null
            ...
            for (const item of data['files']) {
                GoogleDevtoolsArtifactregistryV1File.validateJSON(item);
            };
        }
...
/**
 * The files returned.
 * @member {Array.<module:model/GoogleDevtoolsArtifactregistryV1File>} files
 */
