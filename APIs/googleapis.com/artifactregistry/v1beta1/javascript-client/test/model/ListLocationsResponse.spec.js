...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ArtifactRegistryApi.ListLocationsResponse();
  });
  ...
  describe('ListLocationsResponse', function() {
    it('should create an instance of ListLocationsResponse', function() {
      ...
      //var instance = new ArtifactRegistryApi.ListLocationsResponse();
      //expect(instance).to.be.a(ArtifactRegistryApi.ListLocationsResponse);
    });
