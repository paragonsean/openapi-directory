...
class Repository(Model):
    ...
    def __init__(self, create_time: str=None, description: str=None, format: str=None, kms_key_name: str=None, labels: Dict[str, str]=None, maven_config: MavenRepositoryConfig=None, name: str=None, satisfies_pzs: bool=None, size_bytes: str=None, update_time: str=None):
