...
namespace OpenAPI {
class OAIGoogleDevtoolsArtifactregistryV1beta2File;
...
public:
    ...
    QList<OAIGoogleDevtoolsArtifactregistryV1beta2File> getFiles() const;
    void setFiles(const QList<OAIGoogleDevtoolsArtifactregistryV1beta2File> &files);
...
private:
    ...
    QList<OAIGoogleDevtoolsArtifactregistryV1beta2File> m_files;
    bool m_files_isSet;
