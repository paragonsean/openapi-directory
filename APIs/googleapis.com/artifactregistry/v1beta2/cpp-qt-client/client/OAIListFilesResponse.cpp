...
QList<OAIGoogleDevtoolsArtifactregistryV1beta2File> OAIListFilesResponse::getFiles() const {
    return m_files;
}
void OAIListFilesResponse::setFiles(const QList<OAIGoogleDevtoolsArtifactregistryV1beta2File> &files) {
    m_files = files;
    m_files_isSet = true;
}
