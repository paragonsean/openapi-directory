...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ArtifactRegistryApi.ListVersionsResponse();
  });
  ...
  describe('ListVersionsResponse', function() {
    it('should create an instance of ListVersionsResponse', function() {
      ...
      //var instance = new ArtifactRegistryApi.ListVersionsResponse();
      //expect(instance).to.be.a(ArtifactRegistryApi.ListVersionsResponse);
    });
