...
void Example::exampleFunction1(){
     OAIUsersApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIUsersApi::fitness_users_dataSources_createSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIUsersApi::fitness_users_dataSources_createSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      QString user_id = create(); // QString | Create the data source for the person identified. Use me to indicate the authenticated user. Only me is supported at this time.
      ...
      OAIDataSource oai_data_source = create(); // OAIDataSource | 
      apiInstance.fitness_users_dataSources_create(user_id_xgafvaccess_tokenaltcallbackfieldskeyoauth_tokenpretty_printquota_userupload_protocolupload_typeoai_data_source);
