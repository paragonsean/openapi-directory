...
from openapi_server.models.google_cloud_policysimulator_v1beta_list_org_policy_violations_previews_response import GoogleCloudPolicysimulatorV1betaListOrgPolicyViolationsPreviewsResponse
from openapi_server.models.google_cloud_policysimulator_v1beta_list_org_policy_violations_response import GoogleCloudPolicysimulatorV1betaListOrgPolicyViolationsResponse
...
async def test_policysimulator_organizations_locations_org_policy_violations_previews_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta/{parent}/orgPolicyViolationsPreviews'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_policysimulator_organizations_locations_org_policy_violations_previews_generate(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta/{parent}/orgPolicyViolationsPreviews:generate'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_policysimulator_organizations_locations_org_policy_violations_previews_org_policy_violations_list(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1beta/{parent}/orgPolicyViolations'.format(parent='parent_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
