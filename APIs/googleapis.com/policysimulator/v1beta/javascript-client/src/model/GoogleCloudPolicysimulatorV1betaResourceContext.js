...
/**
 * The GoogleCloudPolicysimulatorV1betaResourceContext model module.
 * @module model/GoogleCloudPolicysimulatorV1betaResourceContext
 * @version v1beta
 */
class GoogleCloudPolicysimulatorV1betaResourceContext {
    /**
     * Constructs a new <code>GoogleCloudPolicysimulatorV1betaResourceContext</code>.
     ...
     * @alias module:model/GoogleCloudPolicysimulatorV1betaResourceContext
     */
    constructor() { 
        
        GoogleCloudPolicysimulatorV1betaResourceContext.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudPolicysimulatorV1betaResourceContext</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudPolicysimulatorV1betaResourceContext} obj Optional instance to populate.
     * @return {module:model/GoogleCloudPolicysimulatorV1betaResourceContext} The populated <code>GoogleCloudPolicysimulatorV1betaResourceContext</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudPolicysimulatorV1betaResourceContext();
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudPolicysimulatorV1betaResourceContext</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudPolicysimulatorV1betaResourceContext</code>.
     */
 ...
 */
GoogleCloudPolicysimulatorV1betaResourceContext.prototype['ancestors'] = undefined;
 ...
 */
GoogleCloudPolicysimulatorV1betaResourceContext.prototype['assetType'] = undefined;
 ...
 */
GoogleCloudPolicysimulatorV1betaResourceContext.prototype['resource'] = undefined;
...
export default GoogleCloudPolicysimulatorV1betaResourceContext;
