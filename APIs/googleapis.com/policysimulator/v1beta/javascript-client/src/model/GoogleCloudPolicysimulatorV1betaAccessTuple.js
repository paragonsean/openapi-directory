...
/**
 * The GoogleCloudPolicysimulatorV1betaAccessTuple model module.
 * @module model/GoogleCloudPolicysimulatorV1betaAccessTuple
 * @version v1beta
 */
class GoogleCloudPolicysimulatorV1betaAccessTuple {
    /**
     * Constructs a new <code>GoogleCloudPolicysimulatorV1betaAccessTuple</code>.
     * Information about the principal, resource, and permission to check.
     * @alias module:model/GoogleCloudPolicysimulatorV1betaAccessTuple
     */
    constructor() { 
        
        GoogleCloudPolicysimulatorV1betaAccessTuple.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudPolicysimulatorV1betaAccessTuple</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudPolicysimulatorV1betaAccessTuple} obj Optional instance to populate.
     * @return {module:model/GoogleCloudPolicysimulatorV1betaAccessTuple} The populated <code>GoogleCloudPolicysimulatorV1betaAccessTuple</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudPolicysimulatorV1betaAccessTuple();
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudPolicysimulatorV1betaAccessTuple</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudPolicysimulatorV1betaAccessTuple</code>.
     */
...
export default GoogleCloudPolicysimulatorV1betaAccessTuple;
