...
let opts = {
  ...
  'googleCloudPolicysimulatorV1betaOrgPolicyViolationsPreview': new PolicySimulatorApi.GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreview() // GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreview | 
};
...
> GoogleCloudPolicysimulatorV1betaListOrgPolicyViolationsPreviewsResponse policysimulatorOrganizationsLocationsOrgPolicyViolationsPreviewsList(parent, opts)
...
> GoogleCloudPolicysimulatorV1betaListOrgPolicyViolationsResponse policysimulatorOrganizationsLocationsOrgPolicyViolationsPreviewsOrgPolicyViolationsList(parent, opts)
