...
let opts = {
  ...
  'googleCloudPolicysimulatorV1betaReplay': new PolicySimulatorApi.GoogleCloudPolicysimulatorV1betaReplay() // GoogleCloudPolicysimulatorV1betaReplay | 
};
...
> GoogleCloudPolicysimulatorV1betaListReplaysResponse policysimulatorProjectsLocationsReplaysList(parent, opts)
...
> GoogleCloudPolicysimulatorV1betaListReplayResultsResponse policysimulatorProjectsLocationsReplaysResultsList(parent, opts)
