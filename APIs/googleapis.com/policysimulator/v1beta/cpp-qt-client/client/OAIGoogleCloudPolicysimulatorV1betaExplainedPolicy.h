...
/*
 * OAIGoogleCloudPolicysimulatorV1betaExplainedPolicy.h
 *
 * Details about how a specific IAM Policy contributed to the access check.
 */

#ifndef OAIGoogleCloudPolicysimulatorV1betaExplainedPolicy_H
#define OAIGoogleCloudPolicysimulatorV1betaExplainedPolicy_H
...
namespace OpenAPI {
class OAIGoogleCloudPolicysimulatorV1betaBindingExplanation;
class OAIGoogleIamV1Policy;

class OAIGoogleCloudPolicysimulatorV1betaExplainedPolicy : public OAIObject {
public:
    OAIGoogleCloudPolicysimulatorV1betaExplainedPolicy();
    OAIGoogleCloudPolicysimulatorV1betaExplainedPolicy(QString json);
    ~OAIGoogleCloudPolicysimulatorV1betaExplainedPolicy() override;
    ...
    QList<OAIGoogleCloudPolicysimulatorV1betaBindingExplanation> getBindingExplanations() const;
    void setBindingExplanations(const QList<OAIGoogleCloudPolicysimulatorV1betaBindingExplanation> &binding_explanations);
...
private:
    ...
    QList<OAIGoogleCloudPolicysimulatorV1betaBindingExplanation> m_binding_explanations;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudPolicysimulatorV1betaExplainedPolicy)

#endif // OAIGoogleCloudPolicysimulatorV1betaExplainedPolicy_H
