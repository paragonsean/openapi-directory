...
/*
 * OAIGoogleCloudPolicysimulatorV1alphaCreateOrgPolicyViolationsPreviewOperationMetadata.h
 *
 * CreateOrgPolicyViolationsPreviewOperationMetadata is metadata about an OrgPolicyViolationsPreview generations operation.
 */

#ifndef OAIGoogleCloudPolicysimulatorV1alphaCreateOrgPolicyViolationsPreviewOperationMetadata_H
#define OAIGoogleCloudPolicysimulatorV1alphaCreateOrgPolicyViolationsPreviewOperationMetadata_H
...
class OAIGoogleCloudPolicysimulatorV1alphaCreateOrgPolicyViolationsPreviewOperationMetadata : public OAIObject {
public:
    OAIGoogleCloudPolicysimulatorV1alphaCreateOrgPolicyViolationsPreviewOperationMetadata();
    OAIGoogleCloudPolicysimulatorV1alphaCreateOrgPolicyViolationsPreviewOperationMetadata(QString json);
    ~OAIGoogleCloudPolicysimulatorV1alphaCreateOrgPolicyViolationsPreviewOperationMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudPolicysimulatorV1alphaCreateOrgPolicyViolationsPreviewOperationMetadata)

#endif // OAIGoogleCloudPolicysimulatorV1alphaCreateOrgPolicyViolationsPreviewOperationMetadata_H
