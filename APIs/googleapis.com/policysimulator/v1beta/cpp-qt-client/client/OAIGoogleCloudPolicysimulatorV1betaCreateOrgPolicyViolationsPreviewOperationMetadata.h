...
/*
 * OAIGoogleCloudPolicysimulatorV1betaCreateOrgPolicyViolationsPreviewOperationMetadata.h
 *
 * CreateOrgPolicyViolationsPreviewOperationMetadata is metadata about an OrgPolicyViolationsPreview generations operation.
 */

#ifndef OAIGoogleCloudPolicysimulatorV1betaCreateOrgPolicyViolationsPreviewOperationMetadata_H
#define OAIGoogleCloudPolicysimulatorV1betaCreateOrgPolicyViolationsPreviewOperationMetadata_H
...
class OAIGoogleCloudPolicysimulatorV1betaCreateOrgPolicyViolationsPreviewOperationMetadata : public OAIObject {
public:
    OAIGoogleCloudPolicysimulatorV1betaCreateOrgPolicyViolationsPreviewOperationMetadata();
    OAIGoogleCloudPolicysimulatorV1betaCreateOrgPolicyViolationsPreviewOperationMetadata(QString json);
    ~OAIGoogleCloudPolicysimulatorV1betaCreateOrgPolicyViolationsPreviewOperationMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudPolicysimulatorV1betaCreateOrgPolicyViolationsPreviewOperationMetadata)

#endif // OAIGoogleCloudPolicysimulatorV1betaCreateOrgPolicyViolationsPreviewOperationMetadata_H
