...
|**bindingExplanations** | [**List&lt;GoogleCloudPolicysimulatorV1betaBindingExplanation&gt;**](GoogleCloudPolicysimulatorV1betaBindingExplanation.md) | Details about how each binding in the policy affects the principal&#39;s ability, or inability, to use the permission for the resource. If the user who created the Replay does not have access to the policy, this field is omitted. |  [optional] |
