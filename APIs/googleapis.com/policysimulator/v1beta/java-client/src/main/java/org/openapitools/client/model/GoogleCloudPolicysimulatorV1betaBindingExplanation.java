...
public class GoogleCloudPolicysimulatorV1betaBindingExplanation {
  /**
  ...
  private Map<String, GoogleCloudPolicysimulatorV1betaBindingExplanationAnnotatedMembership> memberships = new HashMap<>();
  ...
  public GoogleCloudPolicysimulatorV1betaBindingExplanation() {
  }

  public GoogleCloudPolicysimulatorV1betaBindingExplanation access(AccessEnum access) {
    this.access = access;
    return this;
  }
  ...
  public GoogleCloudPolicysimulatorV1betaBindingExplanation condition(GoogleTypeExpr condition) {
  ...
  public GoogleCloudPolicysimulatorV1betaBindingExplanation memberships(Map<String, GoogleCloudPolicysimulatorV1betaBindingExplanationAnnotatedMembership> memberships) {
    this.memberships = memberships;
    return this;
  }

  public GoogleCloudPolicysimulatorV1betaBindingExplanation putMembershipsItem(String key, GoogleCloudPolicysimulatorV1betaBindingExplanationAnnotatedMembership membershipsItem) {
   ...
   */
  @javax.annotation.Nullable
  public Map<String, GoogleCloudPolicysimulatorV1betaBindingExplanationAnnotatedMembership> getMemberships() {
    return memberships;
  }

  public void setMemberships(Map<String, GoogleCloudPolicysimulatorV1betaBindingExplanationAnnotatedMembership> memberships) {
    this.memberships = memberships;
  }


  public GoogleCloudPolicysimulatorV1betaBindingExplanation relevance(RelevanceEnum relevance) {
  ...
  public GoogleCloudPolicysimulatorV1betaBindingExplanation role(String role) {
    this.role = role;
    return this;
  }
  ...
  public GoogleCloudPolicysimulatorV1betaBindingExplanation rolePermission(RolePermissionEnum rolePermission) {
  ...
  public GoogleCloudPolicysimulatorV1betaBindingExplanation rolePermissionRelevance(RolePermissionRelevanceEnum rolePermissionRelevance) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudPolicysimulatorV1betaBindingExplanation googleCloudPolicysimulatorV1betaBindingExplanation = (GoogleCloudPolicysimulatorV1betaBindingExplanation) o;
    return Objects.equals(this.access, googleCloudPolicysimulatorV1betaBindingExplanation.access) &&
        Objects.equals(this.condition, googleCloudPolicysimulatorV1betaBindingExplanation.condition) &&
        Objects.equals(this.memberships, googleCloudPolicysimulatorV1betaBindingExplanation.memberships) &&
        Objects.equals(this.relevance, googleCloudPolicysimulatorV1betaBindingExplanation.relevance) &&
        Objects.equals(this.role, googleCloudPolicysimulatorV1betaBindingExplanation.role) &&
        Objects.equals(this.rolePermission, googleCloudPolicysimulatorV1betaBindingExplanation.rolePermission) &&
        Objects.equals(this.rolePermissionRelevance, googleCloudPolicysimulatorV1betaBindingExplanation.rolePermissionRelevance);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudPolicysimulatorV1betaBindingExplanation {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudPolicysimulatorV1betaBindingExplanation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudPolicysimulatorV1betaBindingExplanation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudPolicysimulatorV1betaBindingExplanation is not found in the empty JSON string", GoogleCloudPolicysimulatorV1betaBindingExplanation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudPolicysimulatorV1betaBindingExplanation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudPolicysimulatorV1betaBindingExplanation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudPolicysimulatorV1betaBindingExplanation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudPolicysimulatorV1betaBindingExplanation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudPolicysimulatorV1betaBindingExplanation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudPolicysimulatorV1betaBindingExplanation.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudPolicysimulatorV1betaBindingExplanation>() {
           @Override
           public void write(JsonWriter out, GoogleCloudPolicysimulatorV1betaBindingExplanation value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudPolicysimulatorV1betaBindingExplanation read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudPolicysimulatorV1betaBindingExplanation given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudPolicysimulatorV1betaBindingExplanation
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudPolicysimulatorV1betaBindingExplanation
   */
  public static GoogleCloudPolicysimulatorV1betaBindingExplanation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudPolicysimulatorV1betaBindingExplanation.class);
  }

  /**
   * Convert an instance of GoogleCloudPolicysimulatorV1betaBindingExplanation to an JSON string
   *
   * @return JSON string
   */
