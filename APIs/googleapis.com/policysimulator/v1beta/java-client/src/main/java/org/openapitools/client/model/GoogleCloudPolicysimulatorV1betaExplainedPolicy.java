...
import org.openapitools.client.model.GoogleCloudPolicysimulatorV1betaBindingExplanation;
...
public class GoogleCloudPolicysimulatorV1betaExplainedPolicy {
  /**
  ...
  private List<GoogleCloudPolicysimulatorV1betaBindingExplanation> bindingExplanations = new ArrayList<>();
  ...
  public GoogleCloudPolicysimulatorV1betaExplainedPolicy() {
  }

  public GoogleCloudPolicysimulatorV1betaExplainedPolicy access(AccessEnum access) {
    this.access = access;
    return this;
  }
  ...
  public GoogleCloudPolicysimulatorV1betaExplainedPolicy bindingExplanations(List<GoogleCloudPolicysimulatorV1betaBindingExplanation> bindingExplanations) {
    this.bindingExplanations = bindingExplanations;
    return this;
  }

  public GoogleCloudPolicysimulatorV1betaExplainedPolicy addBindingExplanationsItem(GoogleCloudPolicysimulatorV1betaBindingExplanation bindingExplanationsItem) {
  ...
  public void setBindingExplanations(List<GoogleCloudPolicysimulatorV1betaBindingExplanation> bindingExplanations) {
    this.bindingExplanations = bindingExplanations;
  }


  public GoogleCloudPolicysimulatorV1betaExplainedPolicy fullResourceName(String fullResourceName) {
  ...
  public GoogleCloudPolicysimulatorV1betaExplainedPolicy policy(GoogleIamV1Policy policy) {
    this.policy = policy;
    return this;
  }
  ...
  public GoogleCloudPolicysimulatorV1betaExplainedPolicy relevance(RelevanceEnum relevance) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudPolicysimulatorV1betaExplainedPolicy googleCloudPolicysimulatorV1betaExplainedPolicy = (GoogleCloudPolicysimulatorV1betaExplainedPolicy) o;
    return Objects.equals(this.access, googleCloudPolicysimulatorV1betaExplainedPolicy.access) &&
        Objects.equals(this.bindingExplanations, googleCloudPolicysimulatorV1betaExplainedPolicy.bindingExplanations) &&
        Objects.equals(this.fullResourceName, googleCloudPolicysimulatorV1betaExplainedPolicy.fullResourceName) &&
        Objects.equals(this.policy, googleCloudPolicysimulatorV1betaExplainedPolicy.policy) &&
        Objects.equals(this.relevance, googleCloudPolicysimulatorV1betaExplainedPolicy.relevance);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudPolicysimulatorV1betaExplainedPolicy {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudPolicysimulatorV1betaExplainedPolicy
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudPolicysimulatorV1betaExplainedPolicy.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudPolicysimulatorV1betaExplainedPolicy is not found in the empty JSON string", GoogleCloudPolicysimulatorV1betaExplainedPolicy.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudPolicysimulatorV1betaExplainedPolicy.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudPolicysimulatorV1betaExplainedPolicy` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("bindingExplanations") != null && !jsonObj.get("bindingExplanations").isJsonNull()) {
        ...
        if (jsonArraybindingExplanations != null) {
          ...
          for (int i = 0; i < jsonArraybindingExplanations.size(); i++) {
            GoogleCloudPolicysimulatorV1betaBindingExplanation.validateJsonElement(jsonArraybindingExplanations.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudPolicysimulatorV1betaExplainedPolicy.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudPolicysimulatorV1betaExplainedPolicy' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudPolicysimulatorV1betaExplainedPolicy> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudPolicysimulatorV1betaExplainedPolicy.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudPolicysimulatorV1betaExplainedPolicy>() {
           @Override
           public void write(JsonWriter out, GoogleCloudPolicysimulatorV1betaExplainedPolicy value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudPolicysimulatorV1betaExplainedPolicy read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudPolicysimulatorV1betaExplainedPolicy given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudPolicysimulatorV1betaExplainedPolicy
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudPolicysimulatorV1betaExplainedPolicy
   */
  public static GoogleCloudPolicysimulatorV1betaExplainedPolicy fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudPolicysimulatorV1betaExplainedPolicy.class);
  }

  /**
   * Convert an instance of GoogleCloudPolicysimulatorV1betaExplainedPolicy to an JSON string
   *
   * @return JSON string
   */
