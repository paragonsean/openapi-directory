...
public class OrganizationsApiTest {
    ...
    public void policysimulatorOrganizationsLocationsOrgPolicyViolationsPreviewsCreateTest() throws ApiException {
        ...
        GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreview googleCloudPolicysimulatorV1betaOrgPolicyViolationsPreview = null;
    ...
    public void policysimulatorOrganizationsLocationsOrgPolicyViolationsPreviewsGenerateTest() throws ApiException {
        ...
        String uploadType = null;
        GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreview googleCloudPolicysimulatorV1betaOrgPolicyViolationsPreview = null;
        GoogleLongrunningOperation response = api.policysimulatorOrganizationsLocationsOrgPolicyViolationsPreviewsGenerate(parent, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, googleCloudPolicysimulatorV1betaOrgPolicyViolationsPreview);
        // TODO: test validations
    }
    ...
    public void policysimulatorOrganizationsLocationsOrgPolicyViolationsPreviewsListTest() throws ApiException {
        ...
        GoogleCloudPolicysimulatorV1betaListOrgPolicyViolationsPreviewsResponse response = api.policysimulatorOrganizationsLocationsOrgPolicyViolationsPreviewsList(parent, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, pageSize, pageToken);
        // TODO: test validations
    }
    ...
    public void policysimulatorOrganizationsLocationsOrgPolicyViolationsPreviewsOrgPolicyViolationsListTest() throws ApiException {
        ...
        Integer pageSize = null;
        String pageToken = null;
        GoogleCloudPolicysimulatorV1betaListOrgPolicyViolationsResponse response = api.policysimulatorOrganizationsLocationsOrgPolicyViolationsPreviewsOrgPolicyViolationsList(parent, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, pageSize, pageToken);
        // TODO: test validations
    }
