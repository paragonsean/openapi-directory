...
/*
 * OAIGoogleCloudPolicysimulatorV1ResourceContext.h
 *
...
#ifndef OAIGoogleCloudPolicysimulatorV1ResourceContext_H
#define OAIGoogleCloudPolicysimulatorV1ResourceContext_H
...
class OAIGoogleCloudPolicysimulatorV1ResourceContext : public OAIObject {
public:
    OAIGoogleCloudPolicysimulatorV1ResourceContext();
    OAIGoogleCloudPolicysimulatorV1ResourceContext(QString json);
    ~OAIGoogleCloudPolicysimulatorV1ResourceContext() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudPolicysimulatorV1ResourceContext)

#endif // OAIGoogleCloudPolicysimulatorV1ResourceContext_H
