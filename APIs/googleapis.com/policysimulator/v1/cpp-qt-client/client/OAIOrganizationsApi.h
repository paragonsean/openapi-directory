...
Q_SIGNALS:
    ...
    void policysimulator_organizations_locations_orgPolicyViolationsPreviews_listSignal(OAIGoogleCloudPolicysimulatorV1ListOrgPolicyViolationsPreviewsResponse summary);
    void policysimulator_organizations_locations_orgPolicyViolationsPreviews_orgPolicyViolations_listSignal(OAIGoogleCloudPolicysimulatorV1ListOrgPolicyViolationsResponse summary);
    ...
    void policysimulator_organizations_locations_orgPolicyViolationsPreviews_listSignalFull(OAIHttpRequestWorker *worker, OAIGoogleCloudPolicysimulatorV1ListOrgPolicyViolationsPreviewsResponse summary);
    void policysimulator_organizations_locations_orgPolicyViolationsPreviews_orgPolicyViolations_listSignalFull(OAIHttpRequestWorker *worker, OAIGoogleCloudPolicysimulatorV1ListOrgPolicyViolationsResponse summary);
    ...
    void policysimulator_organizations_locations_orgPolicyViolationsPreviews_listSignalE(OAIGoogleCloudPolicysimulatorV1ListOrgPolicyViolationsPreviewsResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void policysimulator_organizations_locations_orgPolicyViolationsPreviews_listSignalError(OAIGoogleCloudPolicysimulatorV1ListOrgPolicyViolationsPreviewsResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void policysimulator_organizations_locations_orgPolicyViolationsPreviews_orgPolicyViolations_listSignalE(OAIGoogleCloudPolicysimulatorV1ListOrgPolicyViolationsResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void policysimulator_organizations_locations_orgPolicyViolationsPreviews_orgPolicyViolations_listSignalError(OAIGoogleCloudPolicysimulatorV1ListOrgPolicyViolationsResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
