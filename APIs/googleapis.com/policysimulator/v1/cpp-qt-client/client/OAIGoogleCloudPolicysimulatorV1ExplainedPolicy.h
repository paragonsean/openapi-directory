...
/*
 * OAIGoogleCloudPolicysimulatorV1ExplainedPolicy.h
 *
 * Details about how a specific IAM Policy contributed to the access check.
 */

#ifndef OAIGoogleCloudPolicysimulatorV1ExplainedPolicy_H
#define OAIGoogleCloudPolicysimulatorV1ExplainedPolicy_H

#include <QJsonObject>

#include "OAIGoogleCloudPolicysimulatorV1BindingExplanation.h"
...
namespace OpenAPI {
class OAIGoogleCloudPolicysimulatorV1BindingExplanation;
class OAIGoogleIamV1Policy;

class OAIGoogleCloudPolicysimulatorV1ExplainedPolicy : public OAIObject {
public:
    OAIGoogleCloudPolicysimulatorV1ExplainedPolicy();
    OAIGoogleCloudPolicysimulatorV1ExplainedPolicy(QString json);
    ~OAIGoogleCloudPolicysimulatorV1ExplainedPolicy() override;
    ...
    QList<OAIGoogleCloudPolicysimulatorV1BindingExplanation> getBindingExplanations() const;
    void setBindingExplanations(const QList<OAIGoogleCloudPolicysimulatorV1BindingExplanation> &binding_explanations);
...
private:
    ...
    QList<OAIGoogleCloudPolicysimulatorV1BindingExplanation> m_binding_explanations;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudPolicysimulatorV1ExplainedPolicy)

#endif // OAIGoogleCloudPolicysimulatorV1ExplainedPolicy_H
