...
void OAIProjectsApi::initializeServerConfigs() {
    ...
    QUrl("https://policysimulator.googleapis.com/"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("policysimulator_projects_locations_replays_create", defaultConf);
    _serverIndices.insert("policysimulator_projects_locations_replays_create", 0);
    _serverConfigs.insert("policysimulator_projects_locations_replays_operations_list", defaultConf);
    _serverIndices.insert("policysimulator_projects_locations_replays_operations_list", 0);
    _serverConfigs.insert("policysimulator_projects_locations_replays_results_list", defaultConf);
    _serverIndices.insert("policysimulator_projects_locations_replays_results_list", 0);
}
...
void OAIProjectsApi::policysimulator_projects_locations_replays_create(const QString &parent, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<OAIGoogleCloudPolicysimulatorV1Replay> &oai_google_cloud_policysimulator_v1_replay) {
    ...
    if (oai_google_cloud_policysimulator_v1_replay.hasValue()){

        
        QByteArray output = oai_google_cloud_policysimulator_v1_replay.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::policysimulator_projects_locations_replays_createCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::policysimulator_projects_locations_replays_createCallback);
...
void OAIProjectsApi::policysimulator_projects_locations_replays_createCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT policysimulator_projects_locations_replays_createSignal(output);
        Q_EMIT policysimulator_projects_locations_replays_createSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT policysimulator_projects_locations_replays_createSignalE(output, error_type, error_str);
        Q_EMIT policysimulator_projects_locations_replays_createSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT policysimulator_projects_locations_replays_createSignalError(output, error_type, error_str);
        Q_EMIT policysimulator_projects_locations_replays_createSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectsApi::policysimulator_projects_locations_replays_operations_list(const QString &name, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<QString> &filter, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &page_token) {
    QString fullPath = QString(_serverConfigs["policysimulator_projects_locations_replays_operations_list"][_serverIndices.value("policysimulator_projects_locations_replays_operations_list")].URL()+"/v1/{name}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::policysimulator_projects_locations_replays_operations_listCallback);
    connect(this, &OAIProjectsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::policysimulator_projects_locations_replays_operations_listCallback);
    connect(this, &OAIProjectsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectsApi::policysimulator_projects_locations_replays_operations_listCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT policysimulator_projects_locations_replays_operations_listSignal(output);
        Q_EMIT policysimulator_projects_locations_replays_operations_listSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("https://www.googleapis.com/auth/cloud-platform");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT policysimulator_projects_locations_replays_operations_listSignalE(output, error_type, error_str);
        Q_EMIT policysimulator_projects_locations_replays_operations_listSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT policysimulator_projects_locations_replays_operations_listSignalError(output, error_type, error_str);
        Q_EMIT policysimulator_projects_locations_replays_operations_listSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectsApi::policysimulator_projects_locations_replays_results_list(const QString &parent, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &page_token) {
    QString fullPath = QString(_serverConfigs["policysimulator_projects_locations_replays_results_list"][_serverIndices.value("policysimulator_projects_locations_replays_results_list")].URL()+"/v1/{parent}/results");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::policysimulator_projects_locations_replays_results_listCallback);
    connect(this, &OAIProjectsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::policysimulator_projects_locations_replays_results_listCallback);
    connect(this, &OAIProjectsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectsApi::policysimulator_projects_locations_replays_results_listCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIGoogleCloudPolicysimulatorV1ListReplayResultsResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT policysimulator_projects_locations_replays_results_listSignal(output);
        Q_EMIT policysimulator_projects_locations_replays_results_listSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("https://www.googleapis.com/auth/cloud-platform");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT policysimulator_projects_locations_replays_results_listSignalE(output, error_type, error_str);
        Q_EMIT policysimulator_projects_locations_replays_results_listSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT policysimulator_projects_locations_replays_results_listSignalError(output, error_type, error_str);
        Q_EMIT policysimulator_projects_locations_replays_results_listSignalErrorFull(worker, error_type, error_str);
    }
}
