...
/*
 * OAIGoogleCloudPolicysimulatorV1AccessTuple.h
 *
 * Information about the principal, resource, and permission to check.
 */

#ifndef OAIGoogleCloudPolicysimulatorV1AccessTuple_H
#define OAIGoogleCloudPolicysimulatorV1AccessTuple_H
...
class OAIGoogleCloudPolicysimulatorV1AccessTuple : public OAIObject {
public:
    OAIGoogleCloudPolicysimulatorV1AccessTuple();
    OAIGoogleCloudPolicysimulatorV1AccessTuple(QString json);
    ~OAIGoogleCloudPolicysimulatorV1AccessTuple() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudPolicysimulatorV1AccessTuple)

#endif // OAIGoogleCloudPolicysimulatorV1AccessTuple_H
