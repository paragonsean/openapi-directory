...
import org.openapitools.client.model.GoogleCloudPolicysimulatorV1BindingExplanationAnnotatedMembership;
...
public class GoogleCloudPolicysimulatorV1BindingExplanation {
  ...
  private Map<String, GoogleCloudPolicysimulatorV1BindingExplanationAnnotatedMembership> memberships = new HashMap<>();
  ...
  public GoogleCloudPolicysimulatorV1BindingExplanation access(AccessEnum access) {
    this.access = access;
    return this;
  }
  ...
  public GoogleCloudPolicysimulatorV1BindingExplanation condition(GoogleTypeExpr condition) {
  ...
  public GoogleCloudPolicysimulatorV1BindingExplanation memberships(Map<String, GoogleCloudPolicysimulatorV1BindingExplanationAnnotatedMembership> memberships) {
    this.memberships = memberships;
    return this;
  }

  public GoogleCloudPolicysimulatorV1BindingExplanation putMembershipsItem(String key, GoogleCloudPolicysimulatorV1BindingExplanationAnnotatedMembership membershipsItem) {
   ...
   */
  @javax.annotation.Nullable
  public Map<String, GoogleCloudPolicysimulatorV1BindingExplanationAnnotatedMembership> getMemberships() {
    return memberships;
  }

  public void setMemberships(Map<String, GoogleCloudPolicysimulatorV1BindingExplanationAnnotatedMembership> memberships) {
    this.memberships = memberships;
  }


  public GoogleCloudPolicysimulatorV1BindingExplanation relevance(RelevanceEnum relevance) {
  ...
  public GoogleCloudPolicysimulatorV1BindingExplanation role(String role) {
    this.role = role;
    return this;
  }
  ...
  public GoogleCloudPolicysimulatorV1BindingExplanation rolePermission(RolePermissionEnum rolePermission) {
  ...
  public GoogleCloudPolicysimulatorV1BindingExplanation rolePermissionRelevance(RolePermissionRelevanceEnum rolePermissionRelevance) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudPolicysimulatorV1BindingExplanation googleCloudPolicysimulatorV1BindingExplanation = (GoogleCloudPolicysimulatorV1BindingExplanation) o;
    return Objects.equals(this.access, googleCloudPolicysimulatorV1BindingExplanation.access) &&
        Objects.equals(this.condition, googleCloudPolicysimulatorV1BindingExplanation.condition) &&
        Objects.equals(this.memberships, googleCloudPolicysimulatorV1BindingExplanation.memberships) &&
        Objects.equals(this.relevance, googleCloudPolicysimulatorV1BindingExplanation.relevance) &&
        Objects.equals(this.role, googleCloudPolicysimulatorV1BindingExplanation.role) &&
        Objects.equals(this.rolePermission, googleCloudPolicysimulatorV1BindingExplanation.rolePermission) &&
        Objects.equals(this.rolePermissionRelevance, googleCloudPolicysimulatorV1BindingExplanation.rolePermissionRelevance);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudPolicysimulatorV1BindingExplanation {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudPolicysimulatorV1BindingExplanation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudPolicysimulatorV1BindingExplanation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudPolicysimulatorV1BindingExplanation is not found in the empty JSON string", GoogleCloudPolicysimulatorV1BindingExplanation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudPolicysimulatorV1BindingExplanation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudPolicysimulatorV1BindingExplanation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudPolicysimulatorV1BindingExplanation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudPolicysimulatorV1BindingExplanation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudPolicysimulatorV1BindingExplanation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudPolicysimulatorV1BindingExplanation.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudPolicysimulatorV1BindingExplanation>() {
           @Override
           public void write(JsonWriter out, GoogleCloudPolicysimulatorV1BindingExplanation value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudPolicysimulatorV1BindingExplanation read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudPolicysimulatorV1BindingExplanation given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudPolicysimulatorV1BindingExplanation
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudPolicysimulatorV1BindingExplanation
   */
  public static GoogleCloudPolicysimulatorV1BindingExplanation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudPolicysimulatorV1BindingExplanation.class);
  }

  /**
   * Convert an instance of GoogleCloudPolicysimulatorV1BindingExplanation to an JSON string
   *
   * @return JSON string
   */
