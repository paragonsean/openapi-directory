...
public class GoogleCloudPolicysimulatorV1ExplainedPolicy {
  ...
  private List<GoogleCloudPolicysimulatorV1BindingExplanation> bindingExplanations = new ArrayList<>();
  ...
  public GoogleCloudPolicysimulatorV1ExplainedPolicy access(AccessEnum access) {
    this.access = access;
    return this;
  }
  ...
  public GoogleCloudPolicysimulatorV1ExplainedPolicy bindingExplanations(List<GoogleCloudPolicysimulatorV1BindingExplanation> bindingExplanations) {
    this.bindingExplanations = bindingExplanations;
    return this;
  }

  public GoogleCloudPolicysimulatorV1ExplainedPolicy addBindingExplanationsItem(GoogleCloudPolicysimulatorV1BindingExplanation bindingExplanationsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<GoogleCloudPolicysimulatorV1BindingExplanation> getBindingExplanations() {
    return bindingExplanations;
  }

  public void setBindingExplanations(List<GoogleCloudPolicysimulatorV1BindingExplanation> bindingExplanations) {
    this.bindingExplanations = bindingExplanations;
  }


  public GoogleCloudPolicysimulatorV1ExplainedPolicy fullResourceName(String fullResourceName) {
  ...
  public GoogleCloudPolicysimulatorV1ExplainedPolicy policy(GoogleIamV1Policy policy) {
    this.policy = policy;
    return this;
  }
  ...
  public GoogleCloudPolicysimulatorV1ExplainedPolicy relevance(RelevanceEnum relevance) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudPolicysimulatorV1ExplainedPolicy googleCloudPolicysimulatorV1ExplainedPolicy = (GoogleCloudPolicysimulatorV1ExplainedPolicy) o;
    return Objects.equals(this.access, googleCloudPolicysimulatorV1ExplainedPolicy.access) &&
        Objects.equals(this.bindingExplanations, googleCloudPolicysimulatorV1ExplainedPolicy.bindingExplanations) &&
        Objects.equals(this.fullResourceName, googleCloudPolicysimulatorV1ExplainedPolicy.fullResourceName) &&
        Objects.equals(this.policy, googleCloudPolicysimulatorV1ExplainedPolicy.policy) &&
        Objects.equals(this.relevance, googleCloudPolicysimulatorV1ExplainedPolicy.relevance);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudPolicysimulatorV1ExplainedPolicy {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudPolicysimulatorV1ExplainedPolicy
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudPolicysimulatorV1ExplainedPolicy.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudPolicysimulatorV1ExplainedPolicy is not found in the empty JSON string", GoogleCloudPolicysimulatorV1ExplainedPolicy.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudPolicysimulatorV1ExplainedPolicy.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudPolicysimulatorV1ExplainedPolicy` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("bindingExplanations") != null && !jsonObj.get("bindingExplanations").isJsonNull()) {
        ...
        if (jsonArraybindingExplanations != null) {
          ...
          for (int i = 0; i < jsonArraybindingExplanations.size(); i++) {
            GoogleCloudPolicysimulatorV1BindingExplanation.validateJsonElement(jsonArraybindingExplanations.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudPolicysimulatorV1ExplainedPolicy.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudPolicysimulatorV1ExplainedPolicy' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudPolicysimulatorV1ExplainedPolicy> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudPolicysimulatorV1ExplainedPolicy.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudPolicysimulatorV1ExplainedPolicy>() {
           @Override
           public void write(JsonWriter out, GoogleCloudPolicysimulatorV1ExplainedPolicy value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudPolicysimulatorV1ExplainedPolicy read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudPolicysimulatorV1ExplainedPolicy given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudPolicysimulatorV1ExplainedPolicy
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudPolicysimulatorV1ExplainedPolicy
   */
  public static GoogleCloudPolicysimulatorV1ExplainedPolicy fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudPolicysimulatorV1ExplainedPolicy.class);
  }

  /**
   * Convert an instance of GoogleCloudPolicysimulatorV1ExplainedPolicy to an JSON string
   *
   * @return JSON string
   */
