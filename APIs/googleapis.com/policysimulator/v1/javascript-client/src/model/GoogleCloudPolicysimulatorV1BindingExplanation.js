...
/**
 * The GoogleCloudPolicysimulatorV1BindingExplanation model module.
 * @module model/GoogleCloudPolicysimulatorV1BindingExplanation
 * @version v1
 */
class GoogleCloudPolicysimulatorV1BindingExplanation {
    /**
     * Constructs a new <code>GoogleCloudPolicysimulatorV1BindingExplanation</code>.
     * Details about how a binding in a policy affects a principal&#39;s ability to use a permission.
     * @alias module:model/GoogleCloudPolicysimulatorV1BindingExplanation
     */
    constructor() { 
        
        GoogleCloudPolicysimulatorV1BindingExplanation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudPolicysimulatorV1BindingExplanation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudPolicysimulatorV1BindingExplanation} obj Optional instance to populate.
     * @return {module:model/GoogleCloudPolicysimulatorV1BindingExplanation} The populated <code>GoogleCloudPolicysimulatorV1BindingExplanation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudPolicysimulatorV1BindingExplanation();
            ...
            if (data.hasOwnProperty('memberships')) {
                obj['memberships'] = ApiClient.convertToType(data['memberships'], {'String': GoogleCloudPolicysimulatorV1BindingExplanationAnnotatedMembership});
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudPolicysimulatorV1BindingExplanation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudPolicysimulatorV1BindingExplanation</code>.
     */
 ...
 * @member {module:model/GoogleCloudPolicysimulatorV1BindingExplanation.AccessEnum} access
 */
GoogleCloudPolicysimulatorV1BindingExplanation.prototype['access'] = undefined;

/**
 * @member {module:model/GoogleTypeExpr} condition
 */
GoogleCloudPolicysimulatorV1BindingExplanation.prototype['condition'] = undefined;
 ...
 * @member {Object.<String, module:model/GoogleCloudPolicysimulatorV1BindingExplanationAnnotatedMembership>} memberships
 */
GoogleCloudPolicysimulatorV1BindingExplanation.prototype['memberships'] = undefined;

/**
 * The relevance of this binding to the overall determination for the entire policy.
 * @member {module:model/GoogleCloudPolicysimulatorV1BindingExplanation.RelevanceEnum} relevance
 */
GoogleCloudPolicysimulatorV1BindingExplanation.prototype['relevance'] = undefined;
 ...
 * @member {String} role
 */
GoogleCloudPolicysimulatorV1BindingExplanation.prototype['role'] = undefined;

/**
 * Indicates whether the role granted by this binding contains the specified permission.
 * @member {module:model/GoogleCloudPolicysimulatorV1BindingExplanation.RolePermissionEnum} rolePermission
 */
GoogleCloudPolicysimulatorV1BindingExplanation.prototype['rolePermission'] = undefined;

/**
 * The relevance of the permission's existence, or nonexistence, in the role to the overall determination for the entire policy.
 * @member {module:model/GoogleCloudPolicysimulatorV1BindingExplanation.RolePermissionRelevanceEnum} rolePermissionRelevance
 */
GoogleCloudPolicysimulatorV1BindingExplanation.prototype['rolePermissionRelevance'] = undefined;
 ...
 * @readonly
 */
GoogleCloudPolicysimulatorV1BindingExplanation['AccessEnum'] = {
 ...
 * @readonly
 */
GoogleCloudPolicysimulatorV1BindingExplanation['RelevanceEnum'] = {
 ...
 * @readonly
 */
GoogleCloudPolicysimulatorV1BindingExplanation['RolePermissionEnum'] = {
 ...
 * @readonly
 */
GoogleCloudPolicysimulatorV1BindingExplanation['RolePermissionRelevanceEnum'] = {
...
export default GoogleCloudPolicysimulatorV1BindingExplanation;
