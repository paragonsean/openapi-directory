...
/*
 * OAIGoogleCloudPolicysimulatorV1alphaOrgPolicyViolation.h
 *
 * OrgPolicyViolation is a resource representing a single resource violating a single OrgPolicy constraint.
 */

#ifndef OAIGoogleCloudPolicysimulatorV1alphaOrgPolicyViolation_H
#define OAIGoogleCloudPolicysimulatorV1alphaOrgPolicyViolation_H
...
class OAIGoogleCloudPolicysimulatorV1alphaResourceContext;

class OAIGoogleCloudPolicysimulatorV1alphaOrgPolicyViolation : public OAIObject {
public:
    OAIGoogleCloudPolicysimulatorV1alphaOrgPolicyViolation();
    OAIGoogleCloudPolicysimulatorV1alphaOrgPolicyViolation(QString json);
    ~OAIGoogleCloudPolicysimulatorV1alphaOrgPolicyViolation() override;
    ...
    OAIGoogleCloudPolicysimulatorV1alphaResourceContext getResource() const;
    void setResource(const OAIGoogleCloudPolicysimulatorV1alphaResourceContext &resource);
...
private:
    ...
    OAIGoogleCloudPolicysimulatorV1alphaResourceContext m_resource;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudPolicysimulatorV1alphaOrgPolicyViolation)

#endif // OAIGoogleCloudPolicysimulatorV1alphaOrgPolicyViolation_H
