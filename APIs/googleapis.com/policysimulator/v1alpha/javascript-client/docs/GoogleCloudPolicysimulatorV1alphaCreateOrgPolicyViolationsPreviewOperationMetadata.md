# PolicySimulatorApi.GoogleCloudPolicysimulatorV1alphaCreateOrgPolicyViolationsPreviewOperationMetadata
...
**state** | **String** | Output only. The current state of the operation. | [optional] [readonly] 
