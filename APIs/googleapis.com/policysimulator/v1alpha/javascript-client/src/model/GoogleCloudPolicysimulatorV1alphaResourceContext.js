...
/**
 * The GoogleCloudPolicysimulatorV1alphaResourceContext model module.
 * @module model/GoogleCloudPolicysimulatorV1alphaResourceContext
 * @version v1alpha
 */
class GoogleCloudPolicysimulatorV1alphaResourceContext {
    /**
     * Constructs a new <code>GoogleCloudPolicysimulatorV1alphaResourceContext</code>.
     ...
     * @alias module:model/GoogleCloudPolicysimulatorV1alphaResourceContext
     */
    constructor() { 
        
        GoogleCloudPolicysimulatorV1alphaResourceContext.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudPolicysimulatorV1alphaResourceContext</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudPolicysimulatorV1alphaResourceContext} obj Optional instance to populate.
     * @return {module:model/GoogleCloudPolicysimulatorV1alphaResourceContext} The populated <code>GoogleCloudPolicysimulatorV1alphaResourceContext</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudPolicysimulatorV1alphaResourceContext();
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudPolicysimulatorV1alphaResourceContext</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudPolicysimulatorV1alphaResourceContext</code>.
     */
 ...
 */
GoogleCloudPolicysimulatorV1alphaResourceContext.prototype['ancestors'] = undefined;
 ...
 */
GoogleCloudPolicysimulatorV1alphaResourceContext.prototype['assetType'] = undefined;
 ...
 */
GoogleCloudPolicysimulatorV1alphaResourceContext.prototype['resource'] = undefined;
...
export default GoogleCloudPolicysimulatorV1alphaResourceContext;
