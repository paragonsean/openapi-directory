...
/**
 * The GoogleCloudPolicysimulatorV1alphaAccessTuple model module.
 * @module model/GoogleCloudPolicysimulatorV1alphaAccessTuple
 * @version v1alpha
 */
class GoogleCloudPolicysimulatorV1alphaAccessTuple {
    /**
     * Constructs a new <code>GoogleCloudPolicysimulatorV1alphaAccessTuple</code>.
     * Information about the principal, resource, and permission to check.
     * @alias module:model/GoogleCloudPolicysimulatorV1alphaAccessTuple
     */
    constructor() { 
        
        GoogleCloudPolicysimulatorV1alphaAccessTuple.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudPolicysimulatorV1alphaAccessTuple</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudPolicysimulatorV1alphaAccessTuple} obj Optional instance to populate.
     * @return {module:model/GoogleCloudPolicysimulatorV1alphaAccessTuple} The populated <code>GoogleCloudPolicysimulatorV1alphaAccessTuple</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudPolicysimulatorV1alphaAccessTuple();
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudPolicysimulatorV1alphaAccessTuple</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudPolicysimulatorV1alphaAccessTuple</code>.
     */
...
export default GoogleCloudPolicysimulatorV1alphaAccessTuple;
