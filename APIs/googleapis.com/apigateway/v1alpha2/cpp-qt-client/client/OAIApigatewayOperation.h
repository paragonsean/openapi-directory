...
/*
 * OAIApigatewayOperation.h
 *
 * This resource represents a long-running operation that is the result of a network API call.
 */

#ifndef OAIApigatewayOperation_H
#define OAIApigatewayOperation_H
...
namespace OpenAPI {
class OAIApigatewayStatus;

class OAIApigatewayOperation : public OAIObject {
public:
    OAIApigatewayOperation();
    OAIApigatewayOperation(QString json);
    ~OAIApigatewayOperation() override;
    ...
    OAIApigatewayStatus getError() const;
    void setError(const OAIApigatewayStatus &error);
...
Q_DECLARE_METATYPE(OpenAPI::OAIApigatewayOperation)

#endif // OAIApigatewayOperation_H
