...
OAIApigatewayGatewayConfig OAIApigatewayApiConfig::getGatewayConfig() const {
    return m_gateway_config;
}
void OAIApigatewayApiConfig::setGatewayConfig(const OAIApigatewayGatewayConfig &gateway_config) {
    m_gateway_config = gateway_config;
    m_gateway_config_isSet = true;
}

bool OAIApigatewayApiConfig::is_gateway_config_Set() const{
    return m_gateway_config_isSet;
}

bool OAIApigatewayApiConfig::is_gateway_config_Valid() const{
