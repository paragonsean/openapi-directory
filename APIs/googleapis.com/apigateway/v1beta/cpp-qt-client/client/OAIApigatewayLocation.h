...
/*
 * OAIApigatewayLocation.h
 *
 * A resource that represents a Google Cloud location.
 */

#ifndef OAIApigatewayLocation_H
#define OAIApigatewayLocation_H
...
class OAIApigatewayLocation : public OAIObject {
public:
    OAIApigatewayLocation();
    OAIApigatewayLocation(QString json);
    ~OAIApigatewayLocation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApigatewayLocation)

#endif // OAIApigatewayLocation_H
