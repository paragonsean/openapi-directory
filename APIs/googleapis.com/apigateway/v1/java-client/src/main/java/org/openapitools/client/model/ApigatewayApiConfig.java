...
public class ApigatewayApiConfig {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(createTime, displayName, gatewayServiceAccount, grpcServices, labels, managedServiceConfigs, name, openapiDocuments, serviceConfigId, state, updateTime);
  }
