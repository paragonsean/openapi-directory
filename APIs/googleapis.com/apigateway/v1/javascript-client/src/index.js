...
import ApigatewayApiConfigFile from './model/ApigatewayApiConfigFile';
import ApigatewayApiConfigGrpcServiceDefinition from './model/ApigatewayApiConfigGrpcServiceDefinition';
import ApigatewayApiConfigOpenApiDocument from './model/ApigatewayApiConfigOpenApiDocument';
...
import ApigatewayOperationMetadata from './model/ApigatewayOperationMetadata';
import ApigatewayOperationMetadataDiagnostic from './model/ApigatewayOperationMetadataDiagnostic';
...
export {
    ...
    /**
     * The ApigatewayApi model constructor.
     * @property {module:model/ApigatewayApi}
     */
    ApigatewayApi,

    /**
     * The ApigatewayApiConfig model constructor.
     * @property {module:model/ApigatewayApiConfig}
     */
    ApigatewayApiConfig,

    /**
     * The ApigatewayApiConfigFile model constructor.
     * @property {module:model/ApigatewayApiConfigFile}
     */
    ApigatewayApiConfigFile,

    /**
     * The ApigatewayApiConfigGrpcServiceDefinition model constructor.
     * @property {module:model/ApigatewayApiConfigGrpcServiceDefinition}
     */
    ApigatewayApiConfigGrpcServiceDefinition,

    /**
     * The ApigatewayApiConfigOpenApiDocument model constructor.
     * @property {module:model/ApigatewayApiConfigOpenApiDocument}
     */
    ...
    /**
     * The ApigatewayGateway model constructor.
     * @property {module:model/ApigatewayGateway}
     */
    ApigatewayGateway,

    /**
     * The ApigatewayListApiConfigsResponse model constructor.
     * @property {module:model/ApigatewayListApiConfigsResponse}
     */
    ApigatewayListApiConfigsResponse,

    /**
     * The ApigatewayListApisResponse model constructor.
     * @property {module:model/ApigatewayListApisResponse}
     */
    ApigatewayListApisResponse,

    /**
     * The ApigatewayListGatewaysResponse model constructor.
     * @property {module:model/ApigatewayListGatewaysResponse}
     */
    ...
    /**
     * The ApigatewayOperationMetadata model constructor.
     * @property {module:model/ApigatewayOperationMetadata}
     */
    ApigatewayOperationMetadata,

    /**
     * The ApigatewayOperationMetadataDiagnostic model constructor.
     * @property {module:model/ApigatewayOperationMetadataDiagnostic}
     */
