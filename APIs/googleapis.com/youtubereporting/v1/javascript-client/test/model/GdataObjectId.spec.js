...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YouTubeReportingApi.GdataObjectId();
  });
  ...
  describe('GdataObjectId', function() {
    it('should create an instance of GdataObjectId', function() {
      // uncomment below and update the code to test GdataObjectId
      //var instance = new YouTubeReportingApi.GdataObjectId();
      //expect(instance).to.be.a(YouTubeReportingApi.GdataObjectId);
    });
