...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new YouTubeReportingApi.ListReportTypesResponse();
  });
  ...
  describe('ListReportTypesResponse', function() {
    it('should create an instance of ListReportTypesResponse', function() {
      // uncomment below and update the code to test ListReportTypesResponse
      //var instance = new YouTubeReportingApi.ListReportTypesResponse();
      //expect(instance).to.be.a(YouTubeReportingApi.ListReportTypesResponse);
    });
