...
void OAIMediaApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("youtubereporting_media_download", defaultConf);
    _serverIndices.insert("youtubereporting_media_download", 0);
}
...
void OAIMediaApi::youtubereporting_media_download(const QString &resource_name, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type) {
    QString fullPath = QString(_serverConfigs["youtubereporting_media_download"][_serverIndices.value("youtubereporting_media_download")].URL()+"/v1/media/{resourceName}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMediaApi::youtubereporting_media_downloadCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMediaApi::youtubereporting_media_downloadCallback);
...
void OAIMediaApi::youtubereporting_media_downloadCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIGdataMedia output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT youtubereporting_media_downloadSignal(output);
        Q_EMIT youtubereporting_media_downloadSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT youtubereporting_media_downloadSignalE(output, error_type, error_str);
        Q_EMIT youtubereporting_media_downloadSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT youtubereporting_media_downloadSignalError(output, error_type, error_str);
        Q_EMIT youtubereporting_media_downloadSignalErrorFull(worker, error_type, error_str);
    }
}
