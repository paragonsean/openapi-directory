...
class Reschedule(Model):
    ...
    def __init__(self, reschedule_type: str=None, schedule_time: str=None):
        """Reschedule - a model defined in OpenAPI

        :param reschedule_type: The reschedule_type of this Reschedule.
        :param schedule_time: The schedule_time of this Reschedule.
        """
        self.openapi_types = {
            'reschedule_type': str,
            'schedule_time': str
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'Reschedule':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The Reschedule of this Reschedule.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def reschedule_type(self):
        """Gets the reschedule_type of this Reschedule.

        Required. The type of the reschedule.

        :return: The reschedule_type of this Reschedule.
        :rtype: str
        """
    ...
    def reschedule_type(self, reschedule_type):
        """Sets the reschedule_type of this Reschedule.
    ...
    def schedule_time(self):
        """Gets the schedule_time of this Reschedule.
        ...
        :return: The schedule_time of this Reschedule.
        :rtype: str
        """
    ...
    def schedule_time(self, schedule_time):
        """Sets the schedule_time of this Reschedule.
