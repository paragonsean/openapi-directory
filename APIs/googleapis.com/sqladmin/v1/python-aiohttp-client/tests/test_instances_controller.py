...
async def test_sql_instances_add_server_ca(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/projects/{project}/instances/{instance}/addServerCa'.format(project='project_example', instance='instance_example'),
        headers=headers,
        params=params,
        )
...
async def test_sql_instances_clone(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/projects/{project}/instances/{instance}/clone'.format(project='project_example', instance='instance_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_sql_instances_delete(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/v1/projects/{project}/instances/{instance}'.format(project='project_example', instance='instance_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_sql_instances_demote(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/projects/{project}/instances/{instance}/demote'.format(project='project_example', instance='instance_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_sql_instances_demote_master(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/projects/{project}/instances/{instance}/demoteMaster'.format(project='project_example', instance='instance_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_sql_instances_export(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/projects/{project}/instances/{instance}/export'.format(project='project_example', instance='instance_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_sql_instances_failover(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/projects/{project}/instances/{instance}/failover'.format(project='project_example', instance='instance_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_sql_instances_import(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/projects/{project}/instances/{instance}/import'.format(project='project_example', instance='instance_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_sql_instances_insert(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/projects/{project}/instances'.format(project='project_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_sql_instances_list_server_cas(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/projects/{project}/instances/{instance}/listServerCas'.format(project='project_example', instance='instance_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_sql_instances_promote_replica(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/projects/{project}/instances/{instance}/promoteReplica'.format(project='project_example', instance='instance_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_sql_instances_reencrypt(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/projects/{project}/instances/{instance}/reencrypt'.format(project='project_example', instance='instance_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_sql_instances_reset_ssl_config(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/projects/{project}/instances/{instance}/resetSslConfig'.format(project='project_example', instance='instance_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_sql_instances_restart(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/projects/{project}/instances/{instance}/restart'.format(project='project_example', instance='instance_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_sql_instances_restore_backup(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/projects/{project}/instances/{instance}/restoreBackup'.format(project='project_example', instance='instance_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_sql_instances_rotate_server_ca(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/projects/{project}/instances/{instance}/rotateServerCa'.format(project='project_example', instance='instance_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_sql_instances_start_replica(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/projects/{project}/instances/{instance}/startReplica'.format(project='project_example', instance='instance_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_sql_instances_stop_replica(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/projects/{project}/instances/{instance}/stopReplica'.format(project='project_example', instance='instance_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_sql_instances_switchover(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/projects/{project}/instances/{instance}/switchover'.format(project='project_example', instance='instance_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_sql_instances_truncate_log(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/projects/{project}/instances/{instance}/truncateLog'.format(project='project_example', instance='instance_example'),
        headers=headers,
        json=body,
        params=params,
        )
