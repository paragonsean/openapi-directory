...
async def test_sql_backup_runs_delete(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/v1/projects/{project}/instances/{instance}/backupRuns/{id}'.format(project='project_example', instance='instance_example', id='id_example'),
        headers=headers,
        params=params,
        )
...
async def test_sql_backup_runs_insert(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/projects/{project}/instances/{instance}/backupRuns'.format(project='project_example', instance='instance_example'),
        headers=headers,
        json=body,
        params=params,
        )
