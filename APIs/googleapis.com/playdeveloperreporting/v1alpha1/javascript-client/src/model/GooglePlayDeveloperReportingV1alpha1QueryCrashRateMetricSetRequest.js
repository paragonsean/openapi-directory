...
/**
 * The GooglePlayDeveloperReportingV1alpha1QueryCrashRateMetricSetRequest model module.
 * @module model/GooglePlayDeveloperReportingV1alpha1QueryCrashRateMetricSetRequest
 * @version v1alpha1
 */
class GooglePlayDeveloperReportingV1alpha1QueryCrashRateMetricSetRequest {
    /**
     * Constructs a new <code>GooglePlayDeveloperReportingV1alpha1QueryCrashRateMetricSetRequest</code>.
     * Request message for QueryCrashRateMetricSet.
     * @alias module:model/GooglePlayDeveloperReportingV1alpha1QueryCrashRateMetricSetRequest
     */
    constructor() { 
        
        GooglePlayDeveloperReportingV1alpha1QueryCrashRateMetricSetRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GooglePlayDeveloperReportingV1alpha1QueryCrashRateMetricSetRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GooglePlayDeveloperReportingV1alpha1QueryCrashRateMetricSetRequest} obj Optional instance to populate.
     * @return {module:model/GooglePlayDeveloperReportingV1alpha1QueryCrashRateMetricSetRequest} The populated <code>GooglePlayDeveloperReportingV1alpha1QueryCrashRateMetricSetRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GooglePlayDeveloperReportingV1alpha1QueryCrashRateMetricSetRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GooglePlayDeveloperReportingV1alpha1QueryCrashRateMetricSetRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GooglePlayDeveloperReportingV1alpha1QueryCrashRateMetricSetRequest</code>.
     */
 ...
 */
GooglePlayDeveloperReportingV1alpha1QueryCrashRateMetricSetRequest.prototype['dimensions'] = undefined;
 ...
 */
GooglePlayDeveloperReportingV1alpha1QueryCrashRateMetricSetRequest.prototype['filter'] = undefined;
 ...
 */
GooglePlayDeveloperReportingV1alpha1QueryCrashRateMetricSetRequest.prototype['metrics'] = undefined;
 ...
 */
GooglePlayDeveloperReportingV1alpha1QueryCrashRateMetricSetRequest.prototype['pageSize'] = undefined;
 ...
 */
GooglePlayDeveloperReportingV1alpha1QueryCrashRateMetricSetRequest.prototype['pageToken'] = undefined;

/**
 * @member {module:model/GooglePlayDeveloperReportingV1alpha1TimelineSpec} timelineSpec
 */
GooglePlayDeveloperReportingV1alpha1QueryCrashRateMetricSetRequest.prototype['timelineSpec'] = undefined;
 ...
 * @member {module:model/GooglePlayDeveloperReportingV1alpha1QueryCrashRateMetricSetRequest.UserCohortEnum} userCohort
 */
GooglePlayDeveloperReportingV1alpha1QueryCrashRateMetricSetRequest.prototype['userCohort'] = undefined;
 ...
 * @readonly
 */
GooglePlayDeveloperReportingV1alpha1QueryCrashRateMetricSetRequest['UserCohortEnum'] = {
...
export default GooglePlayDeveloperReportingV1alpha1QueryCrashRateMetricSetRequest;
