...
/**
 * The GooglePlayDeveloperReportingV1alpha1QuerySlowRenderingRateMetricSetRequest model module.
 * @module model/GooglePlayDeveloperReportingV1alpha1QuerySlowRenderingRateMetricSetRequest
 * @version v1alpha1
 */
class GooglePlayDeveloperReportingV1alpha1QuerySlowRenderingRateMetricSetRequest {
    /**
     * Constructs a new <code>GooglePlayDeveloperReportingV1alpha1QuerySlowRenderingRateMetricSetRequest</code>.
     * Request message for QuerySlowRenderingRateMetricSet.
     * @alias module:model/GooglePlayDeveloperReportingV1alpha1QuerySlowRenderingRateMetricSetRequest
     */
    constructor() { 
        
        GooglePlayDeveloperReportingV1alpha1QuerySlowRenderingRateMetricSetRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GooglePlayDeveloperReportingV1alpha1QuerySlowRenderingRateMetricSetRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GooglePlayDeveloperReportingV1alpha1QuerySlowRenderingRateMetricSetRequest} obj Optional instance to populate.
     * @return {module:model/GooglePlayDeveloperReportingV1alpha1QuerySlowRenderingRateMetricSetRequest} The populated <code>GooglePlayDeveloperReportingV1alpha1QuerySlowRenderingRateMetricSetRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GooglePlayDeveloperReportingV1alpha1QuerySlowRenderingRateMetricSetRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GooglePlayDeveloperReportingV1alpha1QuerySlowRenderingRateMetricSetRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GooglePlayDeveloperReportingV1alpha1QuerySlowRenderingRateMetricSetRequest</code>.
     */
 ...
 */
GooglePlayDeveloperReportingV1alpha1QuerySlowRenderingRateMetricSetRequest.prototype['dimensions'] = undefined;
 ...
 */
GooglePlayDeveloperReportingV1alpha1QuerySlowRenderingRateMetricSetRequest.prototype['filter'] = undefined;
 ...
 */
GooglePlayDeveloperReportingV1alpha1QuerySlowRenderingRateMetricSetRequest.prototype['metrics'] = undefined;
 ...
 */
GooglePlayDeveloperReportingV1alpha1QuerySlowRenderingRateMetricSetRequest.prototype['pageSize'] = undefined;
 ...
 */
GooglePlayDeveloperReportingV1alpha1QuerySlowRenderingRateMetricSetRequest.prototype['pageToken'] = undefined;

/**
 * @member {module:model/GooglePlayDeveloperReportingV1alpha1TimelineSpec} timelineSpec
 */
GooglePlayDeveloperReportingV1alpha1QuerySlowRenderingRateMetricSetRequest.prototype['timelineSpec'] = undefined;
 ...
 * @member {module:model/GooglePlayDeveloperReportingV1alpha1QuerySlowRenderingRateMetricSetRequest.UserCohortEnum} userCohort
 */
GooglePlayDeveloperReportingV1alpha1QuerySlowRenderingRateMetricSetRequest.prototype['userCohort'] = undefined;
 ...
 * @readonly
 */
GooglePlayDeveloperReportingV1alpha1QuerySlowRenderingRateMetricSetRequest['UserCohortEnum'] = {
...
export default GooglePlayDeveloperReportingV1alpha1QuerySlowRenderingRateMetricSetRequest;
