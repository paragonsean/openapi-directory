...
/**
 * The GooglePlayDeveloperReportingV1alpha1StuckBackgroundWakelockRateMetricSet model module.
 * @module model/GooglePlayDeveloperReportingV1alpha1StuckBackgroundWakelockRateMetricSet
 * @version v1alpha1
 */
class GooglePlayDeveloperReportingV1alpha1StuckBackgroundWakelockRateMetricSet {
    /**
     * Constructs a new <code>GooglePlayDeveloperReportingV1alpha1StuckBackgroundWakelockRateMetricSet</code>.
     ...
     * @alias module:model/GooglePlayDeveloperReportingV1alpha1StuckBackgroundWakelockRateMetricSet
     */
    constructor() { 
        
        GooglePlayDeveloperReportingV1alpha1StuckBackgroundWakelockRateMetricSet.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GooglePlayDeveloperReportingV1alpha1StuckBackgroundWakelockRateMetricSet</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GooglePlayDeveloperReportingV1alpha1StuckBackgroundWakelockRateMetricSet} obj Optional instance to populate.
     * @return {module:model/GooglePlayDeveloperReportingV1alpha1StuckBackgroundWakelockRateMetricSet} The populated <code>GooglePlayDeveloperReportingV1alpha1StuckBackgroundWakelockRateMetricSet</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GooglePlayDeveloperReportingV1alpha1StuckBackgroundWakelockRateMetricSet();
    ...
    /**
     * Validates the JSON data with respect to <code>GooglePlayDeveloperReportingV1alpha1StuckBackgroundWakelockRateMetricSet</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GooglePlayDeveloperReportingV1alpha1StuckBackgroundWakelockRateMetricSet</code>.
     */
 ...
 */
GooglePlayDeveloperReportingV1alpha1StuckBackgroundWakelockRateMetricSet.prototype['freshnessInfo'] = undefined;

/**
 * Identifier. The resource name. Format: apps/{app}/stuckBackgroundWakelockRateMetricSet
 * @member {String} name
 */
GooglePlayDeveloperReportingV1alpha1StuckBackgroundWakelockRateMetricSet.prototype['name'] = undefined;
...
export default GooglePlayDeveloperReportingV1alpha1StuckBackgroundWakelockRateMetricSet;
