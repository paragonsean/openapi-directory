...
/**
 * The GooglePlayDeveloperReportingV1alpha1QueryAnrRateMetricSetRequest model module.
 * @module model/GooglePlayDeveloperReportingV1alpha1QueryAnrRateMetricSetRequest
 * @version v1alpha1
 */
class GooglePlayDeveloperReportingV1alpha1QueryAnrRateMetricSetRequest {
    /**
     * Constructs a new <code>GooglePlayDeveloperReportingV1alpha1QueryAnrRateMetricSetRequest</code>.
     * Request message for QueryAnrRateMetricSet.
     * @alias module:model/GooglePlayDeveloperReportingV1alpha1QueryAnrRateMetricSetRequest
     */
    constructor() { 
        
        GooglePlayDeveloperReportingV1alpha1QueryAnrRateMetricSetRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GooglePlayDeveloperReportingV1alpha1QueryAnrRateMetricSetRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GooglePlayDeveloperReportingV1alpha1QueryAnrRateMetricSetRequest} obj Optional instance to populate.
     * @return {module:model/GooglePlayDeveloperReportingV1alpha1QueryAnrRateMetricSetRequest} The populated <code>GooglePlayDeveloperReportingV1alpha1QueryAnrRateMetricSetRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GooglePlayDeveloperReportingV1alpha1QueryAnrRateMetricSetRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GooglePlayDeveloperReportingV1alpha1QueryAnrRateMetricSetRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GooglePlayDeveloperReportingV1alpha1QueryAnrRateMetricSetRequest</code>.
     */
 ...
 */
GooglePlayDeveloperReportingV1alpha1QueryAnrRateMetricSetRequest.prototype['dimensions'] = undefined;
 ...
 */
GooglePlayDeveloperReportingV1alpha1QueryAnrRateMetricSetRequest.prototype['filter'] = undefined;
 ...
 */
GooglePlayDeveloperReportingV1alpha1QueryAnrRateMetricSetRequest.prototype['metrics'] = undefined;
 ...
 */
GooglePlayDeveloperReportingV1alpha1QueryAnrRateMetricSetRequest.prototype['pageSize'] = undefined;
 ...
 */
GooglePlayDeveloperReportingV1alpha1QueryAnrRateMetricSetRequest.prototype['pageToken'] = undefined;

/**
 * @member {module:model/GooglePlayDeveloperReportingV1alpha1TimelineSpec} timelineSpec
 */
GooglePlayDeveloperReportingV1alpha1QueryAnrRateMetricSetRequest.prototype['timelineSpec'] = undefined;
 ...
 * @member {module:model/GooglePlayDeveloperReportingV1alpha1QueryAnrRateMetricSetRequest.UserCohortEnum} userCohort
 */
GooglePlayDeveloperReportingV1alpha1QueryAnrRateMetricSetRequest.prototype['userCohort'] = undefined;
 ...
 * @readonly
 */
GooglePlayDeveloperReportingV1alpha1QueryAnrRateMetricSetRequest['UserCohortEnum'] = {
...
export default GooglePlayDeveloperReportingV1alpha1QueryAnrRateMetricSetRequest;
