...
/**
 * The GooglePlayDeveloperReportingV1alpha1SlowStartRateMetricSet model module.
 * @module model/GooglePlayDeveloperReportingV1alpha1SlowStartRateMetricSet
 * @version v1alpha1
 */
class GooglePlayDeveloperReportingV1alpha1SlowStartRateMetricSet {
    /**
     * Constructs a new <code>GooglePlayDeveloperReportingV1alpha1SlowStartRateMetricSet</code>.
     ...
     * @alias module:model/GooglePlayDeveloperReportingV1alpha1SlowStartRateMetricSet
     */
    constructor() { 
        
        GooglePlayDeveloperReportingV1alpha1SlowStartRateMetricSet.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GooglePlayDeveloperReportingV1alpha1SlowStartRateMetricSet</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GooglePlayDeveloperReportingV1alpha1SlowStartRateMetricSet} obj Optional instance to populate.
     * @return {module:model/GooglePlayDeveloperReportingV1alpha1SlowStartRateMetricSet} The populated <code>GooglePlayDeveloperReportingV1alpha1SlowStartRateMetricSet</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GooglePlayDeveloperReportingV1alpha1SlowStartRateMetricSet();
    ...
    /**
     * Validates the JSON data with respect to <code>GooglePlayDeveloperReportingV1alpha1SlowStartRateMetricSet</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GooglePlayDeveloperReportingV1alpha1SlowStartRateMetricSet</code>.
     */
 ...
 */
GooglePlayDeveloperReportingV1alpha1SlowStartRateMetricSet.prototype['freshnessInfo'] = undefined;

/**
 * Identifier. The resource name. Format: apps/{app}/slowStartRateMetricSet
 * @member {String} name
 */
GooglePlayDeveloperReportingV1alpha1SlowStartRateMetricSet.prototype['name'] = undefined;
...
export default GooglePlayDeveloperReportingV1alpha1SlowStartRateMetricSet;
