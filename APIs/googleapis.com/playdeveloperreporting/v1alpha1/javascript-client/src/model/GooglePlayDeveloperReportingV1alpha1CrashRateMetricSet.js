...
/**
 * The GooglePlayDeveloperReportingV1alpha1CrashRateMetricSet model module.
 * @module model/GooglePlayDeveloperReportingV1alpha1CrashRateMetricSet
 * @version v1alpha1
 */
class GooglePlayDeveloperReportingV1alpha1CrashRateMetricSet {
    /**
     * Constructs a new <code>GooglePlayDeveloperReportingV1alpha1CrashRateMetricSet</code>.
     ...
     * @alias module:model/GooglePlayDeveloperReportingV1alpha1CrashRateMetricSet
     */
    constructor() { 
        
        GooglePlayDeveloperReportingV1alpha1CrashRateMetricSet.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GooglePlayDeveloperReportingV1alpha1CrashRateMetricSet</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GooglePlayDeveloperReportingV1alpha1CrashRateMetricSet} obj Optional instance to populate.
     * @return {module:model/GooglePlayDeveloperReportingV1alpha1CrashRateMetricSet} The populated <code>GooglePlayDeveloperReportingV1alpha1CrashRateMetricSet</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GooglePlayDeveloperReportingV1alpha1CrashRateMetricSet();
    ...
    /**
     * Validates the JSON data with respect to <code>GooglePlayDeveloperReportingV1alpha1CrashRateMetricSet</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GooglePlayDeveloperReportingV1alpha1CrashRateMetricSet</code>.
     */
 ...
 */
GooglePlayDeveloperReportingV1alpha1CrashRateMetricSet.prototype['freshnessInfo'] = undefined;

/**
 * Identifier. The resource name. Format: apps/{app}/crashRateMetricSet
 * @member {String} name
 */
GooglePlayDeveloperReportingV1alpha1CrashRateMetricSet.prototype['name'] = undefined;
...
export default GooglePlayDeveloperReportingV1alpha1CrashRateMetricSet;
