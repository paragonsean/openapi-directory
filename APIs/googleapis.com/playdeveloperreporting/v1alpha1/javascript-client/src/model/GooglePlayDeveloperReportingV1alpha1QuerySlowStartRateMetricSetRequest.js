...
/**
 * The GooglePlayDeveloperReportingV1alpha1QuerySlowStartRateMetricSetRequest model module.
 * @module model/GooglePlayDeveloperReportingV1alpha1QuerySlowStartRateMetricSetRequest
 * @version v1alpha1
 */
class GooglePlayDeveloperReportingV1alpha1QuerySlowStartRateMetricSetRequest {
    /**
     * Constructs a new <code>GooglePlayDeveloperReportingV1alpha1QuerySlowStartRateMetricSetRequest</code>.
     * Request message for QuerySlowStartRateMetricSet.
     * @alias module:model/GooglePlayDeveloperReportingV1alpha1QuerySlowStartRateMetricSetRequest
     */
    constructor() { 
        
        GooglePlayDeveloperReportingV1alpha1QuerySlowStartRateMetricSetRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GooglePlayDeveloperReportingV1alpha1QuerySlowStartRateMetricSetRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GooglePlayDeveloperReportingV1alpha1QuerySlowStartRateMetricSetRequest} obj Optional instance to populate.
     * @return {module:model/GooglePlayDeveloperReportingV1alpha1QuerySlowStartRateMetricSetRequest} The populated <code>GooglePlayDeveloperReportingV1alpha1QuerySlowStartRateMetricSetRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GooglePlayDeveloperReportingV1alpha1QuerySlowStartRateMetricSetRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GooglePlayDeveloperReportingV1alpha1QuerySlowStartRateMetricSetRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GooglePlayDeveloperReportingV1alpha1QuerySlowStartRateMetricSetRequest</code>.
     */
 ...
 */
GooglePlayDeveloperReportingV1alpha1QuerySlowStartRateMetricSetRequest.prototype['dimensions'] = undefined;
 ...
 */
GooglePlayDeveloperReportingV1alpha1QuerySlowStartRateMetricSetRequest.prototype['filter'] = undefined;
 ...
 */
GooglePlayDeveloperReportingV1alpha1QuerySlowStartRateMetricSetRequest.prototype['metrics'] = undefined;
 ...
 */
GooglePlayDeveloperReportingV1alpha1QuerySlowStartRateMetricSetRequest.prototype['pageSize'] = undefined;
 ...
 */
GooglePlayDeveloperReportingV1alpha1QuerySlowStartRateMetricSetRequest.prototype['pageToken'] = undefined;

/**
 * @member {module:model/GooglePlayDeveloperReportingV1alpha1TimelineSpec} timelineSpec
 */
GooglePlayDeveloperReportingV1alpha1QuerySlowStartRateMetricSetRequest.prototype['timelineSpec'] = undefined;
 ...
 * @member {module:model/GooglePlayDeveloperReportingV1alpha1QuerySlowStartRateMetricSetRequest.UserCohortEnum} userCohort
 */
GooglePlayDeveloperReportingV1alpha1QuerySlowStartRateMetricSetRequest.prototype['userCohort'] = undefined;
 ...
 * @readonly
 */
GooglePlayDeveloperReportingV1alpha1QuerySlowStartRateMetricSetRequest['UserCohortEnum'] = {
...
export default GooglePlayDeveloperReportingV1alpha1QuerySlowStartRateMetricSetRequest;
