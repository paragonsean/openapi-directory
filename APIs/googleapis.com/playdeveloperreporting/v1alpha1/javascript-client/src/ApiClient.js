...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://playdeveloperreporting.googleapis.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://playdeveloperreporting.googleapis.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/v1alpha1/Javascript'
        };
