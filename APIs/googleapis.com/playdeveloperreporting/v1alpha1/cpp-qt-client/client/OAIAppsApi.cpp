...
void OAIAppsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("playdeveloperreporting_apps_fetchReleaseFilterOptions", defaultConf);
    _serverIndices.insert("playdeveloperreporting_apps_fetchReleaseFilterOptions", 0);
    _serverConfigs.insert("playdeveloperreporting_apps_search", defaultConf);
    _serverIndices.insert("playdeveloperreporting_apps_search", 0);
}
...
void OAIAppsApi::playdeveloperreporting_apps_fetchReleaseFilterOptions(const QString &name, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type) {
    QString fullPath = QString(_serverConfigs["playdeveloperreporting_apps_fetchReleaseFilterOptions"][_serverIndices.value("playdeveloperreporting_apps_fetchReleaseFilterOptions")].URL()+"/v1alpha1/{name}:fetchReleaseFilterOptions");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAppsApi::playdeveloperreporting_apps_fetchReleaseFilterOptionsCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAppsApi::playdeveloperreporting_apps_fetchReleaseFilterOptionsCallback);
...
void OAIAppsApi::playdeveloperreporting_apps_fetchReleaseFilterOptionsCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIGooglePlayDeveloperReportingV1alpha1ReleaseFilterOptions output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT playdeveloperreporting_apps_fetchReleaseFilterOptionsSignal(output);
        Q_EMIT playdeveloperreporting_apps_fetchReleaseFilterOptionsSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT playdeveloperreporting_apps_fetchReleaseFilterOptionsSignalE(output, error_type, error_str);
        Q_EMIT playdeveloperreporting_apps_fetchReleaseFilterOptionsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT playdeveloperreporting_apps_fetchReleaseFilterOptionsSignalError(output, error_type, error_str);
        Q_EMIT playdeveloperreporting_apps_fetchReleaseFilterOptionsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIAppsApi::playdeveloperreporting_apps_search(const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &page_token) {
    QString fullPath = QString(_serverConfigs["playdeveloperreporting_apps_search"][_serverIndices.value("playdeveloperreporting_apps_search")].URL()+"/v1alpha1/apps:search");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAppsApi::playdeveloperreporting_apps_searchCallback);
    connect(this, &OAIAppsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAppsApi::playdeveloperreporting_apps_searchCallback);
    connect(this, &OAIAppsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIAppsApi::playdeveloperreporting_apps_searchCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIGooglePlayDeveloperReportingV1alpha1SearchAccessibleAppsResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT playdeveloperreporting_apps_searchSignal(output);
        Q_EMIT playdeveloperreporting_apps_searchSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("https://www.googleapis.com/auth/playdeveloperreporting");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT playdeveloperreporting_apps_searchSignalE(output, error_type, error_str);
        Q_EMIT playdeveloperreporting_apps_searchSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT playdeveloperreporting_apps_searchSignalError(output, error_type, error_str);
        Q_EMIT playdeveloperreporting_apps_searchSignalErrorFull(worker, error_type, error_str);
    }
}
