...
/*
 * OAIGooglePlayDeveloperReportingV1alpha1SlowStartRateMetricSet.h
 *
...
#ifndef OAIGooglePlayDeveloperReportingV1alpha1SlowStartRateMetricSet_H
#define OAIGooglePlayDeveloperReportingV1alpha1SlowStartRateMetricSet_H
...
class OAIGooglePlayDeveloperReportingV1alpha1SlowStartRateMetricSet : public OAIObject {
public:
    OAIGooglePlayDeveloperReportingV1alpha1SlowStartRateMetricSet();
    OAIGooglePlayDeveloperReportingV1alpha1SlowStartRateMetricSet(QString json);
    ~OAIGooglePlayDeveloperReportingV1alpha1SlowStartRateMetricSet() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGooglePlayDeveloperReportingV1alpha1SlowStartRateMetricSet)

#endif // OAIGooglePlayDeveloperReportingV1alpha1SlowStartRateMetricSet_H
