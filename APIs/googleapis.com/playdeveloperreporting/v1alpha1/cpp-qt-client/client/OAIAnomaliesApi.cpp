...
OAIAnomaliesApi::OAIAnomaliesApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIAnomaliesApi::~OAIAnomaliesApi() {
}

void OAIAnomaliesApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("playdeveloperreporting_anomalies_list", defaultConf);
    _serverIndices.insert("playdeveloperreporting_anomalies_list", 0);
}
...
*/
int OAIAnomaliesApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIAnomaliesApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIAnomaliesApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIAnomaliesApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIAnomaliesApi::setUsername(const QString &username) {
    _username = username;
}

void OAIAnomaliesApi::setPassword(const QString &password) {
    _password = password;
}


void OAIAnomaliesApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIAnomaliesApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIAnomaliesApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIAnomaliesApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIAnomaliesApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIAnomaliesApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIAnomaliesApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIAnomaliesApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIAnomaliesApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIAnomaliesApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIAnomaliesApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIAnomaliesApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIAnomaliesApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIAnomaliesApi::playdeveloperreporting_anomalies_list(const QString &parent, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<QString> &filter, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &page_token) {
    QString fullPath = QString(_serverConfigs["playdeveloperreporting_anomalies_list"][_serverIndices.value("playdeveloperreporting_anomalies_list")].URL()+"/v1alpha1/{parent}/anomalies");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAnomaliesApi::playdeveloperreporting_anomalies_listCallback);
    connect(this, &OAIAnomaliesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAnomaliesApi::playdeveloperreporting_anomalies_listCallback);
    connect(this, &OAIAnomaliesApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
...
void OAIAnomaliesApi::playdeveloperreporting_anomalies_listCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIGooglePlayDeveloperReportingV1alpha1ListAnomaliesResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT playdeveloperreporting_anomalies_listSignal(output);
        Q_EMIT playdeveloperreporting_anomalies_listSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT playdeveloperreporting_anomalies_listSignalE(output, error_type, error_str);
        Q_EMIT playdeveloperreporting_anomalies_listSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT playdeveloperreporting_anomalies_listSignalError(output, error_type, error_str);
        Q_EMIT playdeveloperreporting_anomalies_listSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIAnomaliesApi::tokenAvailable(){
