...
public class GooglePlayDeveloperReportingV1alpha1SlowStartRateMetricSet {
  ...
  public GooglePlayDeveloperReportingV1alpha1SlowStartRateMetricSet() {
  }

  public GooglePlayDeveloperReportingV1alpha1SlowStartRateMetricSet freshnessInfo(GooglePlayDeveloperReportingV1alpha1FreshnessInfo freshnessInfo) {
  ...
  public GooglePlayDeveloperReportingV1alpha1SlowStartRateMetricSet name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GooglePlayDeveloperReportingV1alpha1SlowStartRateMetricSet googlePlayDeveloperReportingV1alpha1SlowStartRateMetricSet = (GooglePlayDeveloperReportingV1alpha1SlowStartRateMetricSet) o;
    return Objects.equals(this.freshnessInfo, googlePlayDeveloperReportingV1alpha1SlowStartRateMetricSet.freshnessInfo) &&
        Objects.equals(this.name, googlePlayDeveloperReportingV1alpha1SlowStartRateMetricSet.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class GooglePlayDeveloperReportingV1alpha1SlowStartRateMetricSet {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GooglePlayDeveloperReportingV1alpha1SlowStartRateMetricSet
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GooglePlayDeveloperReportingV1alpha1SlowStartRateMetricSet.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GooglePlayDeveloperReportingV1alpha1SlowStartRateMetricSet is not found in the empty JSON string", GooglePlayDeveloperReportingV1alpha1SlowStartRateMetricSet.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GooglePlayDeveloperReportingV1alpha1SlowStartRateMetricSet.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GooglePlayDeveloperReportingV1alpha1SlowStartRateMetricSet` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GooglePlayDeveloperReportingV1alpha1SlowStartRateMetricSet.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GooglePlayDeveloperReportingV1alpha1SlowStartRateMetricSet' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GooglePlayDeveloperReportingV1alpha1SlowStartRateMetricSet> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GooglePlayDeveloperReportingV1alpha1SlowStartRateMetricSet.class));

       return (TypeAdapter<T>) new TypeAdapter<GooglePlayDeveloperReportingV1alpha1SlowStartRateMetricSet>() {
           @Override
           public void write(JsonWriter out, GooglePlayDeveloperReportingV1alpha1SlowStartRateMetricSet value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GooglePlayDeveloperReportingV1alpha1SlowStartRateMetricSet read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GooglePlayDeveloperReportingV1alpha1SlowStartRateMetricSet given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GooglePlayDeveloperReportingV1alpha1SlowStartRateMetricSet
   * @throws IOException if the JSON string is invalid with respect to GooglePlayDeveloperReportingV1alpha1SlowStartRateMetricSet
   */
  public static GooglePlayDeveloperReportingV1alpha1SlowStartRateMetricSet fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GooglePlayDeveloperReportingV1alpha1SlowStartRateMetricSet.class);
  }

  /**
   * Convert an instance of GooglePlayDeveloperReportingV1alpha1SlowStartRateMetricSet to an JSON string
   *
   * @return JSON string
   */
