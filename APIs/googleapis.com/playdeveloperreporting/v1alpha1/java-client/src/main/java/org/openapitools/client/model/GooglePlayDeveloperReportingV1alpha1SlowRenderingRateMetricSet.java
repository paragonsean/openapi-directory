...
public class GooglePlayDeveloperReportingV1alpha1SlowRenderingRateMetricSet {
  ...
  public GooglePlayDeveloperReportingV1alpha1SlowRenderingRateMetricSet() {
  }

  public GooglePlayDeveloperReportingV1alpha1SlowRenderingRateMetricSet freshnessInfo(GooglePlayDeveloperReportingV1alpha1FreshnessInfo freshnessInfo) {
  ...
  public GooglePlayDeveloperReportingV1alpha1SlowRenderingRateMetricSet name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GooglePlayDeveloperReportingV1alpha1SlowRenderingRateMetricSet googlePlayDeveloperReportingV1alpha1SlowRenderingRateMetricSet = (GooglePlayDeveloperReportingV1alpha1SlowRenderingRateMetricSet) o;
    return Objects.equals(this.freshnessInfo, googlePlayDeveloperReportingV1alpha1SlowRenderingRateMetricSet.freshnessInfo) &&
        Objects.equals(this.name, googlePlayDeveloperReportingV1alpha1SlowRenderingRateMetricSet.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class GooglePlayDeveloperReportingV1alpha1SlowRenderingRateMetricSet {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GooglePlayDeveloperReportingV1alpha1SlowRenderingRateMetricSet
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GooglePlayDeveloperReportingV1alpha1SlowRenderingRateMetricSet.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GooglePlayDeveloperReportingV1alpha1SlowRenderingRateMetricSet is not found in the empty JSON string", GooglePlayDeveloperReportingV1alpha1SlowRenderingRateMetricSet.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GooglePlayDeveloperReportingV1alpha1SlowRenderingRateMetricSet.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GooglePlayDeveloperReportingV1alpha1SlowRenderingRateMetricSet` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GooglePlayDeveloperReportingV1alpha1SlowRenderingRateMetricSet.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GooglePlayDeveloperReportingV1alpha1SlowRenderingRateMetricSet' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GooglePlayDeveloperReportingV1alpha1SlowRenderingRateMetricSet> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GooglePlayDeveloperReportingV1alpha1SlowRenderingRateMetricSet.class));

       return (TypeAdapter<T>) new TypeAdapter<GooglePlayDeveloperReportingV1alpha1SlowRenderingRateMetricSet>() {
           @Override
           public void write(JsonWriter out, GooglePlayDeveloperReportingV1alpha1SlowRenderingRateMetricSet value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GooglePlayDeveloperReportingV1alpha1SlowRenderingRateMetricSet read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GooglePlayDeveloperReportingV1alpha1SlowRenderingRateMetricSet given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GooglePlayDeveloperReportingV1alpha1SlowRenderingRateMetricSet
   * @throws IOException if the JSON string is invalid with respect to GooglePlayDeveloperReportingV1alpha1SlowRenderingRateMetricSet
   */
  public static GooglePlayDeveloperReportingV1alpha1SlowRenderingRateMetricSet fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GooglePlayDeveloperReportingV1alpha1SlowRenderingRateMetricSet.class);
  }

  /**
   * Convert an instance of GooglePlayDeveloperReportingV1alpha1SlowRenderingRateMetricSet to an JSON string
   *
   * @return JSON string
   */
