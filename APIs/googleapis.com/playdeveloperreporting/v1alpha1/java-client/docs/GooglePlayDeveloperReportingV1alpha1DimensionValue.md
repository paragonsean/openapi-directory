...
|------------ | ------------- | ------------- | -------------|
|**dimension** | **String** | Name of the dimension. |  [optional] |
|**int64Value** | **String** | Actual value, represented as an int64. |  [optional] |
|**stringValue** | **String** | Actual value, represented as a string. |  [optional] |
