...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MyBusinessBusinessInformationApi.PlaceInfo();
  });
  ...
  describe('PlaceInfo', function() {
    it('should create an instance of PlaceInfo', function() {
      ...
      //var instance = new MyBusinessBusinessInformationApi.PlaceInfo();
      //expect(instance).to.be.a(MyBusinessBusinessInformationApi.PlaceInfo);
    });
