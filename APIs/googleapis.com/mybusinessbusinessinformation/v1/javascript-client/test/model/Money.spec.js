...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MyBusinessBusinessInformationApi.Money();
  });
  ...
  describe('Money', function() {
    it('should create an instance of Money', function() {
      ...
      //var instance = new MyBusinessBusinessInformationApi.Money();
      //expect(instance).to.be.a(MyBusinessBusinessInformationApi.Money);
    });
