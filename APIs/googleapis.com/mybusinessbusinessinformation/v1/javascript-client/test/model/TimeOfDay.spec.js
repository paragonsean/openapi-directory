...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MyBusinessBusinessInformationApi.TimeOfDay();
  });
  ...
  describe('TimeOfDay', function() {
    it('should create an instance of TimeOfDay', function() {
      ...
      //var instance = new MyBusinessBusinessInformationApi.TimeOfDay();
      //expect(instance).to.be.a(MyBusinessBusinessInformationApi.TimeOfDay);
    });
