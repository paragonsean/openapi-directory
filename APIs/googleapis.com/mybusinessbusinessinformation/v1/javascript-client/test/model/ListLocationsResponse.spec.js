...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MyBusinessBusinessInformationApi.ListLocationsResponse();
  });
  ...
  describe('ListLocationsResponse', function() {
    it('should create an instance of ListLocationsResponse', function() {
      ...
      //var instance = new MyBusinessBusinessInformationApi.ListLocationsResponse();
      //expect(instance).to.be.a(MyBusinessBusinessInformationApi.ListLocationsResponse);
    });
