...
class GoogleLocation {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('requestAdminRightsUri')) {
                obj['requestAdminRightsUri'] = ApiClient.convertToType(data['requestAdminRightsUri'], 'String');
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['requestAdminRightsUri'] && !(typeof data['requestAdminRightsUri'] === 'string' || data['requestAdminRightsUri'] instanceof String)) {
            throw new Error("Expected the field `requestAdminRightsUri` to be a primitive type in the JSON string but got " + data['requestAdminRightsUri']);
        }
 ...
 * @member {String} requestAdminRightsUri
 */
GoogleLocation.prototype['requestAdminRightsUri'] = undefined;
