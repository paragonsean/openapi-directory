...
<a id="mybusinessbusinessinformationGoogleLocationsSearch"></a>
# **mybusinessbusinessinformationGoogleLocationsSearch**
> SearchGoogleLocationsResponse mybusinessbusinessinformationGoogleLocationsSearch($xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, searchGoogleLocationsRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      SearchGoogleLocationsResponse result = apiInstance.mybusinessbusinessinformationGoogleLocationsSearch($xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, searchGoogleLocationsRequest);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling GoogleLocationsApi#mybusinessbusinessinformationGoogleLocationsSearch");
