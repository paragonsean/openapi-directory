...
async def mybusinessbusinessinformation_locations_attributes_get_google_updated(request: web.Request, name, xgafv=None, access_token=None, alt=None, param_callback=None, fields=None, key=None, oauth_token=None, pretty_print=None, quota_user=None, upload_protocol=None, upload_type=None, read_mask=None) -> web.Response:
...
async def mybusinessbusinessinformation_locations_delete(request: web.Request, name, xgafv=None, access_token=None, alt=None, param_callback=None, fields=None, key=None, oauth_token=None, pretty_print=None, quota_user=None, upload_protocol=None, upload_type=None) -> web.Response:
...
async def mybusinessbusinessinformation_locations_get_attributes(request: web.Request, name, xgafv=None, access_token=None, alt=None, param_callback=None, fields=None, key=None, oauth_token=None, pretty_print=None, quota_user=None, upload_protocol=None, upload_type=None) -> web.Response:
...
async def mybusinessbusinessinformation_locations_update_attributes(request: web.Request, name, xgafv=None, access_token=None, alt=None, param_callback=None, fields=None, key=None, oauth_token=None, pretty_print=None, quota_user=None, upload_protocol=None, upload_type=None, attribute_mask=None, body=None) -> web.Response:
    ...
    """
    body = Attributes.from_dict(body)
    return web.Response(status=200)
