...
void OAIAccountsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("mybusinessbusinessinformation_accounts_locations_create", defaultConf);
    _serverIndices.insert("mybusinessbusinessinformation_accounts_locations_create", 0);
    _serverConfigs.insert("mybusinessbusinessinformation_accounts_locations_list", defaultConf);
    _serverIndices.insert("mybusinessbusinessinformation_accounts_locations_list", 0);
}
...
void OAIAccountsApi::mybusinessbusinessinformation_accounts_locations_create(const QString &parent, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<QString> &request_id, const ::OpenAPI::OptionalParam<bool> &validate_only, const ::OpenAPI::OptionalParam<OAILocation> &oai_location) {
    QString fullPath = QString(_serverConfigs["mybusinessbusinessinformation_accounts_locations_create"][_serverIndices.value("mybusinessbusinessinformation_accounts_locations_create")].URL()+"/v1/{parent}/locations");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAccountsApi::mybusinessbusinessinformation_accounts_locations_createCallback);
...
void OAIAccountsApi::mybusinessbusinessinformation_accounts_locations_createCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT mybusinessbusinessinformation_accounts_locations_createSignal(output);
        Q_EMIT mybusinessbusinessinformation_accounts_locations_createSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT mybusinessbusinessinformation_accounts_locations_createSignalE(output, error_type, error_str);
        Q_EMIT mybusinessbusinessinformation_accounts_locations_createSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT mybusinessbusinessinformation_accounts_locations_createSignalError(output, error_type, error_str);
        Q_EMIT mybusinessbusinessinformation_accounts_locations_createSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIAccountsApi::mybusinessbusinessinformation_accounts_locations_list(const QString &parent, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<QString> &filter, const ::OpenAPI::OptionalParam<QString> &order_by, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &page_token, const ::OpenAPI::OptionalParam<QString> &read_mask) {
    QString fullPath = QString(_serverConfigs["mybusinessbusinessinformation_accounts_locations_list"][_serverIndices.value("mybusinessbusinessinformation_accounts_locations_list")].URL()+"/v1/{parent}/locations");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAccountsApi::mybusinessbusinessinformation_accounts_locations_listCallback);
    connect(this, &OAIAccountsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIAccountsApi::mybusinessbusinessinformation_accounts_locations_listCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT mybusinessbusinessinformation_accounts_locations_listSignal(output);
        Q_EMIT mybusinessbusinessinformation_accounts_locations_listSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT mybusinessbusinessinformation_accounts_locations_listSignalE(output, error_type, error_str);
        Q_EMIT mybusinessbusinessinformation_accounts_locations_listSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT mybusinessbusinessinformation_accounts_locations_listSignalError(output, error_type, error_str);
        Q_EMIT mybusinessbusinessinformation_accounts_locations_listSignalErrorFull(worker, error_type, error_str);
    }
}
