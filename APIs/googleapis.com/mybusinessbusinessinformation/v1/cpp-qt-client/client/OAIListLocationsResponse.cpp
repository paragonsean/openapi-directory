...
qint32 OAIListLocationsResponse::getTotalSize() const {
    return m_total_size;
}
void OAIListLocationsResponse::setTotalSize(const qint32 &total_size) {
    m_total_size = total_size;
    m_total_size_isSet = true;
}

bool OAIListLocationsResponse::is_total_size_Set() const{
    return m_total_size_isSet;
}

bool OAIListLocationsResponse::is_total_size_Valid() const{
