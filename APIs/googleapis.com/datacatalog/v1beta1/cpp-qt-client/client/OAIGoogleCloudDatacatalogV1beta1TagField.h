...
/*
 * OAIGoogleCloudDatacatalogV1beta1TagField.h
 *
 * Contains the value and supporting information for a field within a Tag.
 */

#ifndef OAIGoogleCloudDatacatalogV1beta1TagField_H
#define OAIGoogleCloudDatacatalogV1beta1TagField_H
...
namespace OpenAPI {
class OAIGoogleCloudDatacatalogV1beta1TagFieldEnumValue;

class OAIGoogleCloudDatacatalogV1beta1TagField : public OAIObject {
public:
    OAIGoogleCloudDatacatalogV1beta1TagField();
    OAIGoogleCloudDatacatalogV1beta1TagField(QString json);
    ~OAIGoogleCloudDatacatalogV1beta1TagField() override;
    ...
    OAIGoogleCloudDatacatalogV1beta1TagFieldEnumValue getEnumValue() const;
    void setEnumValue(const OAIGoogleCloudDatacatalogV1beta1TagFieldEnumValue &enum_value);
...
private:
    ...
    OAIGoogleCloudDatacatalogV1beta1TagFieldEnumValue m_enum_value;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudDatacatalogV1beta1TagField)

#endif // OAIGoogleCloudDatacatalogV1beta1TagField_H
