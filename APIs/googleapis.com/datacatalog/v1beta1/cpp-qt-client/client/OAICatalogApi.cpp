...
void OAICatalogApi::datacatalog_catalog_search(const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<OAIGoogleCloudDatacatalogV1beta1SearchCatalogRequest> &oai_google_cloud_datacatalog_v1beta1_search_catalog_request) {
    ...
    if (oai_google_cloud_datacatalog_v1beta1_search_catalog_request.hasValue()){

        
        QByteArray output = oai_google_cloud_datacatalog_v1beta1_search_catalog_request.value().asJson().toUtf8();
...
void OAICatalogApi::datacatalog_catalog_searchCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIGoogleCloudDatacatalogV1beta1SearchCatalogResponse output(QString(worker->response));
    worker->deleteLater();
