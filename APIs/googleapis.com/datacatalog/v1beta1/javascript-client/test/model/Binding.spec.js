...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleCloudDataCatalogApi.Binding();
  });
  ...
  describe('Binding', function() {
    it('should create an instance of Binding', function() {
      ...
      //var instance = new GoogleCloudDataCatalogApi.Binding();
      //expect(instance).to.be.a(GoogleCloudDataCatalogApi.Binding);
    });
