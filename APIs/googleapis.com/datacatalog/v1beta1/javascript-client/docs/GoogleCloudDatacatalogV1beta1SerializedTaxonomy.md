# GoogleCloudDataCatalogApi.GoogleCloudDatacatalogV1beta1SerializedTaxonomy

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**activatedPolicyTypes** | **[String]** | A list of policy types that are activated for a taxonomy. | [optional] 
...
**policyTags** | [**[GoogleCloudDatacatalogV1beta1SerializedPolicyTag]**](GoogleCloudDatacatalogV1beta1SerializedPolicyTag.md) | Top level policy tags associated with the taxonomy if any. | [optional] 
