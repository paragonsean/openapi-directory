...
> GoogleCloudDatacatalogV1beta1EntryGroup datacatalogProjectsLocationsEntryGroupsCreate(parent, opts)
...
let parent = "parent_example"; // String | Required. The name of the project this entry group is in. Example: * projects/{project_id}/locations/{location} Note that this EntryGroup and its child resources may not actually be stored in the location in this name.
let opts = {
  ...
  'entryGroupId': "entryGroupId_example", // String | Required. The id of the entry group to create. The id must begin with a letter or underscore, contain only English letters, numbers and underscores, and be at most 64 characters.
  'googleCloudDatacatalogV1beta1EntryGroup': new GoogleCloudDataCatalogApi.GoogleCloudDatacatalogV1beta1EntryGroup() // GoogleCloudDatacatalogV1beta1EntryGroup | 
};
...
> GoogleCloudDatacatalogV1beta1Entry datacatalogProjectsLocationsEntryGroupsEntriesCreate(parent, opts)
...
let apiInstance = new GoogleCloudDataCatalogApi.ProjectsApi();
let parent = "parent_example"; // String | Required. The name of the entry group this entry is in. Example: * projects/{project_id}/locations/{location}/entryGroups/{entry_group_id} Note that this Entry and its child resources may not actually be stored in the location in this name.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'entryId': "entryId_example", // String | Required. The id of the entry to create.
  'googleCloudDatacatalogV1beta1Entry': new GoogleCloudDataCatalogApi.GoogleCloudDatacatalogV1beta1Entry() // GoogleCloudDatacatalogV1beta1Entry | 
};
...
> GoogleCloudDatacatalogV1beta1ListEntriesResponse datacatalogProjectsLocationsEntryGroupsEntriesList(parent, opts)
...
let apiInstance = new GoogleCloudDataCatalogApi.ProjectsApi();
let parent = "parent_example"; // String | Required. The name of the entry group that contains the entries, which can be provided in URL format. Example: * projects/{project_id}/locations/{location}/entryGroups/{entry_group_id}
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'pageSize': 56, // Number | The maximum number of items to return. Default is 10. Max limit is 1000. Throws an invalid argument for `page_size > 1000`.
  'pageToken': "pageToken_example", // String | Token that specifies which page is requested. If empty, the first page is returned.
  'readMask': "readMask_example" // String | The fields to return for each Entry. If not set or empty, all fields are returned. For example, setting read_mask to contain only one path \"name\" will cause ListEntries to return a list of Entries with only \"name\" field.
};
 ...
 **uploadProtocol** | **String**| Upload protocol for media (e.g. \&quot;raw\&quot;, \&quot;multipart\&quot;). | [optional] 
 **uploadType** | **String**| Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;). | [optional] 
 **pageSize** | **Number**| The maximum number of items to return. Default is 10. Max limit is 1000. Throws an invalid argument for &#x60;page_size &gt; 1000&#x60;. | [optional] 
...
> GoogleCloudDatacatalogV1beta1ListEntryGroupsResponse datacatalogProjectsLocationsEntryGroupsList(parent, opts)
...
let apiInstance = new GoogleCloudDataCatalogApi.ProjectsApi();
let parent = "parent_example"; // String | Required. The name of the location that contains the entry groups, which can be provided in URL format. Example: * projects/{project_id}/locations/{location}
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'pageSize': 56, // Number | Optional. The maximum number of items to return. Default is 10. Max limit is 1000. Throws an invalid argument for `page_size > 1000`.
  'pageToken': "pageToken_example" // String | Optional. Token that specifies which page is requested. If empty, the first page is returned.
};
 ...
 **uploadProtocol** | **String**| Upload protocol for media (e.g. \&quot;raw\&quot;, \&quot;multipart\&quot;). | [optional] 
 **uploadType** | **String**| Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;). | [optional] 
 **pageSize** | **Number**| Optional. The maximum number of items to return. Default is 10. Max limit is 1000. Throws an invalid argument for &#x60;page_size &gt; 1000&#x60;. | [optional] 
...
> GoogleCloudDatacatalogV1beta1Tag datacatalogProjectsLocationsEntryGroupsTagsCreate(parent, opts)
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'googleCloudDatacatalogV1beta1Tag': new GoogleCloudDataCatalogApi.GoogleCloudDatacatalogV1beta1Tag() // GoogleCloudDatacatalogV1beta1Tag | 
};
...
> GoogleCloudDatacatalogV1beta1ListTagsResponse datacatalogProjectsLocationsEntryGroupsTagsList(parent, opts)
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'pageSize': 56, // Number | The maximum number of tags to return. Default is 10. Max limit is 1000.
  'pageToken': "pageToken_example" // String | Token that specifies which page is requested. If empty, the first page is returned.
};
 ...
 **uploadProtocol** | **String**| Upload protocol for media (e.g. \&quot;raw\&quot;, \&quot;multipart\&quot;). | [optional] 
 **uploadType** | **String**| Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;). | [optional] 
 **pageSize** | **Number**| The maximum number of tags to return. Default is 10. Max limit is 1000. | [optional] 
 **pageToken** | **String**| Token that specifies which page is requested. If empty, the first page is returned. | [optional] 
...
> GoogleCloudDatacatalogV1beta1TagTemplate datacatalogProjectsLocationsTagTemplatesCreate(parent, opts)
...
let apiInstance = new GoogleCloudDataCatalogApi.ProjectsApi();
let parent = "parent_example"; // String | Required. The name of the project and the template location [region](https://cloud.google.com/data-catalog/docs/concepts/regions. Example: * projects/{project_id}/locations/us-central1
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'tagTemplateId': "tagTemplateId_example", // String | Required. The id of the tag template to create.
  'googleCloudDatacatalogV1beta1TagTemplate': new GoogleCloudDataCatalogApi.GoogleCloudDatacatalogV1beta1TagTemplate() // GoogleCloudDatacatalogV1beta1TagTemplate | 
};
...
> GoogleCloudDatacatalogV1beta1TagTemplateField datacatalogProjectsLocationsTagTemplatesFieldsCreate(parent, opts)
...
let apiInstance = new GoogleCloudDataCatalogApi.ProjectsApi();
let parent = "parent_example"; // String | Required. The name of the project and the template location [region](https://cloud.google.com/data-catalog/docs/concepts/regions). Example: * projects/{project_id}/locations/us-central1/tagTemplates/{tag_template_id}
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'tagTemplateFieldId': "tagTemplateFieldId_example", // String | Required. The ID of the tag template field to create. Field ids can contain letters (both uppercase and lowercase), numbers (0-9), underscores (_) and dashes (-). Field IDs must be at least 1 character long and at most 128 characters long. Field IDs must also be unique within their template.
  'googleCloudDatacatalogV1beta1TagTemplateField': new GoogleCloudDataCatalogApi.GoogleCloudDatacatalogV1beta1TagTemplateField() // GoogleCloudDatacatalogV1beta1TagTemplateField | 
};
...
> GoogleCloudDatacatalogV1beta1TagTemplateField datacatalogProjectsLocationsTagTemplatesFieldsEnumValuesRename(name, opts)
...
let apiInstance = new GoogleCloudDataCatalogApi.ProjectsApi();
let name = "name_example"; // String | Required. The name of the enum field value. Example: * projects/{project_id}/locations/{location}/tagTemplates/{tag_template_id}/fields/{tag_template_field_id}/enumValues/{enum_value_display_name}
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'googleCloudDatacatalogV1beta1RenameTagTemplateFieldEnumValueRequest': new GoogleCloudDataCatalogApi.GoogleCloudDatacatalogV1beta1RenameTagTemplateFieldEnumValueRequest() // GoogleCloudDatacatalogV1beta1RenameTagTemplateFieldEnumValueRequest | 
};
...
> GoogleCloudDatacatalogV1beta1Taxonomy datacatalogProjectsLocationsTaxonomiesCreate(parent, opts)
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'googleCloudDatacatalogV1beta1Taxonomy': new GoogleCloudDataCatalogApi.GoogleCloudDatacatalogV1beta1Taxonomy() // GoogleCloudDatacatalogV1beta1Taxonomy | 
};
...
> GoogleCloudDatacatalogV1beta1ExportTaxonomiesResponse datacatalogProjectsLocationsTaxonomiesExport(parent, opts)
...
let apiInstance = new GoogleCloudDataCatalogApi.ProjectsApi();
let parent = "parent_example"; // String | Required. Resource name of the project that taxonomies to be exported will share.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'serializedTaxonomies': true, // Boolean | Export taxonomies as serialized taxonomies.
  'taxonomies': ["null"] // [String] | Required. Resource names of the taxonomies to be exported.
};
 ...
 **taxonomies** | [**[String]**](String.md)| Required. Resource names of the taxonomies to be exported. | [optional] 
...
> GoogleCloudDatacatalogV1beta1ImportTaxonomiesResponse datacatalogProjectsLocationsTaxonomiesImport(parent, opts)
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'googleCloudDatacatalogV1beta1ImportTaxonomiesRequest': new GoogleCloudDataCatalogApi.GoogleCloudDatacatalogV1beta1ImportTaxonomiesRequest() // GoogleCloudDatacatalogV1beta1ImportTaxonomiesRequest | 
};
...
> GoogleCloudDatacatalogV1beta1ListTaxonomiesResponse datacatalogProjectsLocationsTaxonomiesList(parent, opts)
...
let opts = {
  ...
  'pageSize': 56, // Number | The maximum number of items to return. Must be a value between 1 and 1000. If not set, defaults to 50.
  'pageToken': "pageToken_example" // String | The next_page_token value returned from a previous list request, if any. If not set, defaults to an empty string.
};
 ...
 **pageSize** | **Number**| The maximum number of items to return. Must be a value between 1 and 1000. If not set, defaults to 50. | [optional] 
...
> GoogleCloudDatacatalogV1beta1PolicyTag datacatalogProjectsLocationsTaxonomiesPolicyTagsCreate(parent, opts)
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'googleCloudDatacatalogV1beta1PolicyTag': new GoogleCloudDataCatalogApi.GoogleCloudDatacatalogV1beta1PolicyTag() // GoogleCloudDatacatalogV1beta1PolicyTag | 
};
...
let apiInstance = new GoogleCloudDataCatalogApi.ProjectsApi();
let name = "name_example"; // String | Required. Resource name of the policy tag to be deleted. All of its descendant policy tags will also be deleted.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'force': true // Boolean | Required. Currently, this field must always be set to `true`. This confirms the deletion of this field from any tags using this field. `force = false` will be supported in the future.
};
...
> GoogleCloudDatacatalogV1beta1PolicyTag datacatalogProjectsLocationsTaxonomiesPolicyTagsGet(name, opts)
...
let apiInstance = new GoogleCloudDataCatalogApi.ProjectsApi();
let name = "name_example"; // String | Required. Resource name of the requested policy tag.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'readMask': "readMask_example" // String | The fields to return. If not set or empty, all fields are returned.
};
...
> GoogleCloudDatacatalogV1beta1ListPolicyTagsResponse datacatalogProjectsLocationsTaxonomiesPolicyTagsList(parent, opts)
...
> GoogleCloudDatacatalogV1beta1PolicyTag datacatalogProjectsLocationsTaxonomiesPolicyTagsPatch(name, opts)
...
let apiInstance = new GoogleCloudDataCatalogApi.ProjectsApi();
let name = "name_example"; // String | Identifier. Resource name of this policy tag, whose format is: \"projects/{project_number}/locations/{location_id}/taxonomies/{taxonomy_id}/policyTags/{id}\".
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
