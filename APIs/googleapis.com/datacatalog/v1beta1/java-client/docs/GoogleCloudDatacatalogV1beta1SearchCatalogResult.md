...
|**searchResultType** | [**SearchResultTypeEnum**](#SearchResultTypeEnum) | Type of the search result. This field can be used to determine which Get method to call to fetch the full resource. |  [optional] |
