...
public class GoogleCloudDatacatalogV1beta1Taxonomy {
  ...
  public GoogleCloudDatacatalogV1beta1Taxonomy activatedPolicyTypes(List<ActivatedPolicyTypesEnum> activatedPolicyTypes) {
    this.activatedPolicyTypes = activatedPolicyTypes;
    return this;
  }

  public GoogleCloudDatacatalogV1beta1Taxonomy addActivatedPolicyTypesItem(ActivatedPolicyTypesEnum activatedPolicyTypesItem) {
  ...
  public GoogleCloudDatacatalogV1beta1Taxonomy description(String description) {
  ...
  public GoogleCloudDatacatalogV1beta1Taxonomy displayName(String displayName) {
  ...
  public GoogleCloudDatacatalogV1beta1Taxonomy name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GoogleCloudDatacatalogV1beta1Taxonomy service(GoogleCloudDatacatalogV1beta1TaxonomyService service) {
  ...
  public void setService(GoogleCloudDatacatalogV1beta1TaxonomyService service) {
    this.service = service;
  }


  public GoogleCloudDatacatalogV1beta1Taxonomy taxonomyTimestamps(GoogleCloudDatacatalogV1beta1SystemTimestamps taxonomyTimestamps) {
  ...
  public void setTaxonomyTimestamps(GoogleCloudDatacatalogV1beta1SystemTimestamps taxonomyTimestamps) {
    this.taxonomyTimestamps = taxonomyTimestamps;
  }
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudDatacatalogV1beta1Taxonomy googleCloudDatacatalogV1beta1Taxonomy = (GoogleCloudDatacatalogV1beta1Taxonomy) o;
    return Objects.equals(this.activatedPolicyTypes, googleCloudDatacatalogV1beta1Taxonomy.activatedPolicyTypes) &&
        Objects.equals(this.description, googleCloudDatacatalogV1beta1Taxonomy.description) &&
        Objects.equals(this.displayName, googleCloudDatacatalogV1beta1Taxonomy.displayName) &&
        Objects.equals(this.name, googleCloudDatacatalogV1beta1Taxonomy.name) &&
        Objects.equals(this.policyTagCount, googleCloudDatacatalogV1beta1Taxonomy.policyTagCount) &&
        Objects.equals(this.service, googleCloudDatacatalogV1beta1Taxonomy.service) &&
        Objects.equals(this.taxonomyTimestamps, googleCloudDatacatalogV1beta1Taxonomy.taxonomyTimestamps);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudDatacatalogV1beta1Taxonomy {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudDatacatalogV1beta1Taxonomy
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudDatacatalogV1beta1Taxonomy.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudDatacatalogV1beta1Taxonomy is not found in the empty JSON string", GoogleCloudDatacatalogV1beta1Taxonomy.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudDatacatalogV1beta1Taxonomy.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudDatacatalogV1beta1Taxonomy` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("service") != null && !jsonObj.get("service").isJsonNull()) {
        GoogleCloudDatacatalogV1beta1TaxonomyService.validateJsonElement(jsonObj.get("service"));
      }
      ...
      if (jsonObj.get("taxonomyTimestamps") != null && !jsonObj.get("taxonomyTimestamps").isJsonNull()) {
        GoogleCloudDatacatalogV1beta1SystemTimestamps.validateJsonElement(jsonObj.get("taxonomyTimestamps"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudDatacatalogV1beta1Taxonomy.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudDatacatalogV1beta1Taxonomy' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudDatacatalogV1beta1Taxonomy> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudDatacatalogV1beta1Taxonomy.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudDatacatalogV1beta1Taxonomy>() {
           @Override
           public void write(JsonWriter out, GoogleCloudDatacatalogV1beta1Taxonomy value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudDatacatalogV1beta1Taxonomy read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudDatacatalogV1beta1Taxonomy given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudDatacatalogV1beta1Taxonomy
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudDatacatalogV1beta1Taxonomy
   */
  public static GoogleCloudDatacatalogV1beta1Taxonomy fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudDatacatalogV1beta1Taxonomy.class);
  }

  /**
   * Convert an instance of GoogleCloudDatacatalogV1beta1Taxonomy to an JSON string
   *
   * @return JSON string
   */
