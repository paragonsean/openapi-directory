...
void OAICatalogApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("datacatalog_catalog_search", defaultConf);
    _serverIndices.insert("datacatalog_catalog_search", 0);
}
...
void OAICatalogApi::datacatalog_catalog_search(const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<OAIGoogleCloudDatacatalogV1SearchCatalogRequest> &oai_google_cloud_datacatalog_v1_search_catalog_request) {
    QString fullPath = QString(_serverConfigs["datacatalog_catalog_search"][_serverIndices.value("datacatalog_catalog_search")].URL()+"/v1/catalog:search");
    ...
    if (oai_google_cloud_datacatalog_v1_search_catalog_request.hasValue()){

        
        QByteArray output = oai_google_cloud_datacatalog_v1_search_catalog_request.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICatalogApi::datacatalog_catalog_searchCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICatalogApi::datacatalog_catalog_searchCallback);
...
void OAICatalogApi::datacatalog_catalog_searchCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIGoogleCloudDatacatalogV1SearchCatalogResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT datacatalog_catalog_searchSignal(output);
        Q_EMIT datacatalog_catalog_searchSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT datacatalog_catalog_searchSignalE(output, error_type, error_str);
        Q_EMIT datacatalog_catalog_searchSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT datacatalog_catalog_searchSignalError(output, error_type, error_str);
        Q_EMIT datacatalog_catalog_searchSignalErrorFull(worker, error_type, error_str);
    }
}
