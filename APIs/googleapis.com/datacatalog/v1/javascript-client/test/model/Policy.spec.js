...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleCloudDataCatalogApi.Policy();
  });
  ...
  describe('Policy', function() {
    it('should create an instance of Policy', function() {
      ...
      //var instance = new GoogleCloudDataCatalogApi.Policy();
      //expect(instance).to.be.a(GoogleCloudDataCatalogApi.Policy);
    });
