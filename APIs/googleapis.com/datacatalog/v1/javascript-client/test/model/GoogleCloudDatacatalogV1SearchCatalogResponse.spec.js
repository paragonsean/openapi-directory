...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleCloudDataCatalogApi.GoogleCloudDatacatalogV1SearchCatalogResponse();
  });
  ...
  describe('GoogleCloudDatacatalogV1SearchCatalogResponse', function() {
    it('should create an instance of GoogleCloudDatacatalogV1SearchCatalogResponse', function() {
      // uncomment below and update the code to test GoogleCloudDatacatalogV1SearchCatalogResponse
      //var instance = new GoogleCloudDataCatalogApi.GoogleCloudDatacatalogV1SearchCatalogResponse();
      //expect(instance).to.be.a(GoogleCloudDataCatalogApi.GoogleCloudDatacatalogV1SearchCatalogResponse);
    });
