...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleCloudDataCatalogApi.Operation();
  });
  ...
  describe('Operation', function() {
    it('should create an instance of Operation', function() {
      ...
      //var instance = new GoogleCloudDataCatalogApi.Operation();
      //expect(instance).to.be.a(GoogleCloudDataCatalogApi.Operation);
    });
