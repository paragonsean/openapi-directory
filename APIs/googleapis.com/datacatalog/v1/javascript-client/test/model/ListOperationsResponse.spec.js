...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleCloudDataCatalogApi.ListOperationsResponse();
  });
  ...
  describe('ListOperationsResponse', function() {
    it('should create an instance of ListOperationsResponse', function() {
      ...
      //var instance = new GoogleCloudDataCatalogApi.ListOperationsResponse();
      //expect(instance).to.be.a(GoogleCloudDataCatalogApi.ListOperationsResponse);
    });
