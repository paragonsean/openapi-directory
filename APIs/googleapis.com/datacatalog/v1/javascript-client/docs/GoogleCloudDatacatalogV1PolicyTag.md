# GoogleCloudDataCatalogApi.GoogleCloudDatacatalogV1PolicyTag

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**childPolicyTags** | **[String]** | Output only. Resource names of child policy tags of this policy tag. | [optional] [readonly] 
