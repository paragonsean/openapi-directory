# GoogleCloudDataCatalogApi.GoogleCloudDatacatalogV1TagTemplateField
...
**order** | **Number** | The order of this field with respect to other fields in this tag template. For example, a higher value can indicate a more important field. The value can be negative. Multiple fields can have the same order and field orders within a tag don&#39;t have to be sequential. | [optional] 
