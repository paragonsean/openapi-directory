...
public class GoogleCloudDatacatalogV1PolicyTag {
  ...
  public GoogleCloudDatacatalogV1PolicyTag description(String description) {
  ...
  public GoogleCloudDatacatalogV1PolicyTag displayName(String displayName) {
  ...
  public GoogleCloudDatacatalogV1PolicyTag name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GoogleCloudDatacatalogV1PolicyTag parentPolicyTag(String parentPolicyTag) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudDatacatalogV1PolicyTag googleCloudDatacatalogV1PolicyTag = (GoogleCloudDatacatalogV1PolicyTag) o;
    return Objects.equals(this.childPolicyTags, googleCloudDatacatalogV1PolicyTag.childPolicyTags) &&
        Objects.equals(this.description, googleCloudDatacatalogV1PolicyTag.description) &&
        Objects.equals(this.displayName, googleCloudDatacatalogV1PolicyTag.displayName) &&
        Objects.equals(this.name, googleCloudDatacatalogV1PolicyTag.name) &&
        Objects.equals(this.parentPolicyTag, googleCloudDatacatalogV1PolicyTag.parentPolicyTag);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudDatacatalogV1PolicyTag {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudDatacatalogV1PolicyTag
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudDatacatalogV1PolicyTag.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudDatacatalogV1PolicyTag is not found in the empty JSON string", GoogleCloudDatacatalogV1PolicyTag.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudDatacatalogV1PolicyTag.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudDatacatalogV1PolicyTag` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudDatacatalogV1PolicyTag.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudDatacatalogV1PolicyTag' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudDatacatalogV1PolicyTag> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudDatacatalogV1PolicyTag.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudDatacatalogV1PolicyTag>() {
           @Override
           public void write(JsonWriter out, GoogleCloudDatacatalogV1PolicyTag value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudDatacatalogV1PolicyTag read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudDatacatalogV1PolicyTag given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudDatacatalogV1PolicyTag
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudDatacatalogV1PolicyTag
   */
  public static GoogleCloudDatacatalogV1PolicyTag fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudDatacatalogV1PolicyTag.class);
  }

  /**
   * Convert an instance of GoogleCloudDatacatalogV1PolicyTag to an JSON string
   *
   * @return JSON string
   */
