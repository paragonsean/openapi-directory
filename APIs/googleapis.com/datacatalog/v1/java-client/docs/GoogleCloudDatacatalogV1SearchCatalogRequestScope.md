...
|**includeOrgIds** | **List&lt;String&gt;** | The list of organization IDs to search within. To find your organization ID, follow the steps from [Creating and managing organizations] (/resource-manager/docs/creating-managing-organization). |  [optional] |
|**includeProjectIds** | **List&lt;String&gt;** | The list of project IDs to search within. For more information on the distinction between project names, IDs, and numbers, see [Projects](/docs/overview/#projects). |  [optional] |
