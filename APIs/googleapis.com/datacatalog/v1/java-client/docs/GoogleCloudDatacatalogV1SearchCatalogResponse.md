...
|**unreachable** | **List&lt;String&gt;** | Unreachable locations. Search results don&#39;t include data from those locations. To get additional information on an error, repeat the search request and restrict it to specific locations by setting the &#x60;SearchCatalogRequest.scope.restricted_locations&#x60; parameter. |  [optional] |
