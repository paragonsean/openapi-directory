...
/*
 * OAIDimensionOrderBy.h
 *
 * Sorts by dimension values.
 */

#ifndef OAIDimensionOrderBy_H
#define OAIDimensionOrderBy_H
...
class OAIDimensionOrderBy : public OAIObject {
public:
    OAIDimensionOrderBy();
    OAIDimensionOrderBy(QString json);
    ~OAIDimensionOrderBy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDimensionOrderBy)

#endif // OAIDimensionOrderBy_H
