...
#ifndef OAIQuotaStatus_H
#define OAIQuotaStatus_H
...
class OAIQuotaStatus : public OAIObject {
public:
    OAIQuotaStatus();
    OAIQuotaStatus(QString json);
    ~OAIQuotaStatus() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIQuotaStatus)

#endif // OAIQuotaStatus_H
