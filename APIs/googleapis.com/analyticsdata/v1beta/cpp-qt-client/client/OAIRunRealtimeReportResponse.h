...
/*
 * OAIRunRealtimeReportResponse.h
 *
 * The response realtime report table corresponding to a request.
 */

#ifndef OAIRunRealtimeReportResponse_H
#define OAIRunRealtimeReportResponse_H
...
class OAIRunRealtimeReportResponse : public OAIObject {
public:
    OAIRunRealtimeReportResponse();
    OAIRunRealtimeReportResponse(QString json);
    ~OAIRunRealtimeReportResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRunRealtimeReportResponse)

#endif // OAIRunRealtimeReportResponse_H
