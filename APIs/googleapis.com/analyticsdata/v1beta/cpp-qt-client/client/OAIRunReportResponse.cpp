...
OAIRunReportResponse::OAIRunReportResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRunReportResponse::OAIRunReportResponse() {
    this->initializeModel();
}

OAIRunReportResponse::~OAIRunReportResponse() {}

void OAIRunReportResponse::initializeModel() {
...
void OAIRunReportResponse::fromJson(QString jsonString) {
...
void OAIRunReportResponse::fromJsonObject(QJsonObject json) {
...
QString OAIRunReportResponse::asJson() const {
...
QJsonObject OAIRunReportResponse::asJsonObject() const {
    QJsonObject obj;
...
QList<OAIDimensionHeader> OAIRunReportResponse::getDimensionHeaders() const {
    return m_dimension_headers;
}
void OAIRunReportResponse::setDimensionHeaders(const QList<OAIDimensionHeader> &dimension_headers) {
    m_dimension_headers = dimension_headers;
    m_dimension_headers_isSet = true;
}

bool OAIRunReportResponse::is_dimension_headers_Set() const{
    return m_dimension_headers_isSet;
}

bool OAIRunReportResponse::is_dimension_headers_Valid() const{
    return m_dimension_headers_isValid;
}

QString OAIRunReportResponse::getKind() const {
    return m_kind;
}
void OAIRunReportResponse::setKind(const QString &kind) {
    m_kind = kind;
    m_kind_isSet = true;
}

bool OAIRunReportResponse::is_kind_Set() const{
    return m_kind_isSet;
}

bool OAIRunReportResponse::is_kind_Valid() const{
    return m_kind_isValid;
}

QList<OAIRow> OAIRunReportResponse::getMaximums() const {
    return m_maximums;
}
void OAIRunReportResponse::setMaximums(const QList<OAIRow> &maximums) {
    m_maximums = maximums;
    m_maximums_isSet = true;
}

bool OAIRunReportResponse::is_maximums_Set() const{
    return m_maximums_isSet;
}

bool OAIRunReportResponse::is_maximums_Valid() const{
    return m_maximums_isValid;
}

OAIResponseMetaData OAIRunReportResponse::getMetadata() const {
    return m_metadata;
}
void OAIRunReportResponse::setMetadata(const OAIResponseMetaData &metadata) {
    m_metadata = metadata;
    m_metadata_isSet = true;
}

bool OAIRunReportResponse::is_metadata_Set() const{
    return m_metadata_isSet;
}

bool OAIRunReportResponse::is_metadata_Valid() const{
    return m_metadata_isValid;
}

QList<OAIMetricHeader> OAIRunReportResponse::getMetricHeaders() const {
    return m_metric_headers;
}
void OAIRunReportResponse::setMetricHeaders(const QList<OAIMetricHeader> &metric_headers) {
    m_metric_headers = metric_headers;
    m_metric_headers_isSet = true;
}

bool OAIRunReportResponse::is_metric_headers_Set() const{
    return m_metric_headers_isSet;
}

bool OAIRunReportResponse::is_metric_headers_Valid() const{
    return m_metric_headers_isValid;
}

QList<OAIRow> OAIRunReportResponse::getMinimums() const {
    return m_minimums;
}
void OAIRunReportResponse::setMinimums(const QList<OAIRow> &minimums) {
    m_minimums = minimums;
    m_minimums_isSet = true;
}

bool OAIRunReportResponse::is_minimums_Set() const{
    return m_minimums_isSet;
}

bool OAIRunReportResponse::is_minimums_Valid() const{
    return m_minimums_isValid;
}

OAIPropertyQuota OAIRunReportResponse::getPropertyQuota() const {
    return m_property_quota;
}
void OAIRunReportResponse::setPropertyQuota(const OAIPropertyQuota &property_quota) {
    m_property_quota = property_quota;
    m_property_quota_isSet = true;
}

bool OAIRunReportResponse::is_property_quota_Set() const{
    return m_property_quota_isSet;
}

bool OAIRunReportResponse::is_property_quota_Valid() const{
    return m_property_quota_isValid;
}

qint32 OAIRunReportResponse::getRowCount() const {
    return m_row_count;
}
void OAIRunReportResponse::setRowCount(const qint32 &row_count) {
    m_row_count = row_count;
    m_row_count_isSet = true;
}

bool OAIRunReportResponse::is_row_count_Set() const{
    return m_row_count_isSet;
}

bool OAIRunReportResponse::is_row_count_Valid() const{
    return m_row_count_isValid;
}

QList<OAIRow> OAIRunReportResponse::getRows() const {
    return m_rows;
}
void OAIRunReportResponse::setRows(const QList<OAIRow> &rows) {
    m_rows = rows;
    m_rows_isSet = true;
}

bool OAIRunReportResponse::is_rows_Set() const{
    return m_rows_isSet;
}

bool OAIRunReportResponse::is_rows_Valid() const{
    return m_rows_isValid;
}

QList<OAIRow> OAIRunReportResponse::getTotals() const {
    return m_totals;
}
void OAIRunReportResponse::setTotals(const QList<OAIRow> &totals) {
    m_totals = totals;
    m_totals_isSet = true;
}

bool OAIRunReportResponse::is_totals_Set() const{
    return m_totals_isSet;
}

bool OAIRunReportResponse::is_totals_Valid() const{
    return m_totals_isValid;
}

bool OAIRunReportResponse::isSet() const {
...
bool OAIRunReportResponse::isValid() const {
