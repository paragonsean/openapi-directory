...
|------------ | ------------- | ------------- | -------------|
|**dimensionName** | **String** | Must be a dimension name from the request. |  [optional] |
|**dimensionValue** | **String** | Order by only when the named dimension is this value. |  [optional] |
