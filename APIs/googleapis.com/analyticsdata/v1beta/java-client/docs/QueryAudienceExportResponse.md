...
|**audienceRows** | [**List&lt;V1betaAudienceRow&gt;**](V1betaAudienceRow.md) | Rows for each user in an audience export. The number of rows in this response will be less than or equal to request&#39;s page size. |  [optional] |
