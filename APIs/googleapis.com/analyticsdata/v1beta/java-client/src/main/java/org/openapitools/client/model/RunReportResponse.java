...
public class RunReportResponse {
  ...
  public RunReportResponse dimensionHeaders(List<DimensionHeader> dimensionHeaders) {
    this.dimensionHeaders = dimensionHeaders;
    return this;
  }

  public RunReportResponse addDimensionHeadersItem(DimensionHeader dimensionHeadersItem) {
  ...
  public RunReportResponse kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  public RunReportResponse maximums(List<Row> maximums) {
    this.maximums = maximums;
    return this;
  }

  public RunReportResponse addMaximumsItem(Row maximumsItem) {
  ...
  public RunReportResponse metadata(ResponseMetaData metadata) {
  ...
  public RunReportResponse metricHeaders(List<MetricHeader> metricHeaders) {
    this.metricHeaders = metricHeaders;
    return this;
  }

  public RunReportResponse addMetricHeadersItem(MetricHeader metricHeadersItem) {
  ...
  public RunReportResponse minimums(List<Row> minimums) {
    this.minimums = minimums;
    return this;
  }

  public RunReportResponse addMinimumsItem(Row minimumsItem) {
  ...
  public RunReportResponse propertyQuota(PropertyQuota propertyQuota) {
  ...
  public RunReportResponse rowCount(Integer rowCount) {
  ...
  public RunReportResponse rows(List<Row> rows) {
    this.rows = rows;
    return this;
  }

  public RunReportResponse addRowsItem(Row rowsItem) {
    if (this.rows == null) {
  ...
  public RunReportResponse totals(List<Row> totals) {
    this.totals = totals;
    return this;
  }

  public RunReportResponse addTotalsItem(Row totalsItem) {
    if (this.totals == null) {
  ...
  public boolean equals(Object o) {
    ...
    RunReportResponse runReportResponse = (RunReportResponse) o;
    return Objects.equals(this.dimensionHeaders, runReportResponse.dimensionHeaders) &&
        Objects.equals(this.kind, runReportResponse.kind) &&
        Objects.equals(this.maximums, runReportResponse.maximums) &&
        Objects.equals(this.metadata, runReportResponse.metadata) &&
        Objects.equals(this.metricHeaders, runReportResponse.metricHeaders) &&
        Objects.equals(this.minimums, runReportResponse.minimums) &&
        Objects.equals(this.propertyQuota, runReportResponse.propertyQuota) &&
        Objects.equals(this.rowCount, runReportResponse.rowCount) &&
        Objects.equals(this.rows, runReportResponse.rows) &&
        Objects.equals(this.totals, runReportResponse.totals);
  }

  @Override
  public int hashCode() {
    return Objects.hash(dimensionHeaders, kind, maximums, metadata, metricHeaders, minimums, propertyQuota, rowCount, rows, totals);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RunReportResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RunReportResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RunReportResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RunReportResponse is not found in the empty JSON string", RunReportResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RunReportResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RunReportResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RunReportResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RunReportResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RunReportResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RunReportResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<RunReportResponse>() {
           @Override
           public void write(JsonWriter out, RunReportResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RunReportResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RunReportResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RunReportResponse
   * @throws IOException if the JSON string is invalid with respect to RunReportResponse
   */
  public static RunReportResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RunReportResponse.class);
  }

  /**
   * Convert an instance of RunReportResponse to an JSON string
   *
   * @return JSON string
   */
