...
public class DimensionCompatibility {
  ...
  public DimensionCompatibility compatibility(CompatibilityEnum compatibility) {
  ...
  public DimensionCompatibility dimensionMetadata(DimensionMetadata dimensionMetadata) {
    this.dimensionMetadata = dimensionMetadata;
    return this;
  }

  /**
   * Get dimensionMetadata
  ...
  public boolean equals(Object o) {
    ...
    DimensionCompatibility dimensionCompatibility = (DimensionCompatibility) o;
    return Objects.equals(this.compatibility, dimensionCompatibility.compatibility) &&
        Objects.equals(this.dimensionMetadata, dimensionCompatibility.dimensionMetadata);
  }

  @Override
  public int hashCode() {
    return Objects.hash(compatibility, dimensionMetadata);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DimensionCompatibility {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DimensionCompatibility
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DimensionCompatibility.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DimensionCompatibility is not found in the empty JSON string", DimensionCompatibility.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DimensionCompatibility.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DimensionCompatibility` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("dimensionMetadata") != null && !jsonObj.get("dimensionMetadata").isJsonNull()) {
        DimensionMetadata.validateJsonElement(jsonObj.get("dimensionMetadata"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DimensionCompatibility.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DimensionCompatibility' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DimensionCompatibility> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DimensionCompatibility.class));

       return (TypeAdapter<T>) new TypeAdapter<DimensionCompatibility>() {
           @Override
           public void write(JsonWriter out, DimensionCompatibility value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DimensionCompatibility read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DimensionCompatibility given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DimensionCompatibility
   * @throws IOException if the JSON string is invalid with respect to DimensionCompatibility
   */
  public static DimensionCompatibility fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DimensionCompatibility.class);
  }

  /**
   * Convert an instance of DimensionCompatibility to an JSON string
   *
   * @return JSON string
   */
