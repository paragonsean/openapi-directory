...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleAnalyticsDataApi.NumericValue();
  });
  ...
  describe('NumericValue', function() {
    it('should create an instance of NumericValue', function() {
      // uncomment below and update the code to test NumericValue
      //var instance = new GoogleAnalyticsDataApi.NumericValue();
      //expect(instance).to.be.a(GoogleAnalyticsDataApi.NumericValue);
    });
