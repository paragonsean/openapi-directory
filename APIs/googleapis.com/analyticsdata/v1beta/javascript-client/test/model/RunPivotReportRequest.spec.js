...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleAnalyticsDataApi.RunPivotReportRequest();
  });
  ...
  describe('RunPivotReportRequest', function() {
    it('should create an instance of RunPivotReportRequest', function() {
      // uncomment below and update the code to test RunPivotReportRequest
      //var instance = new GoogleAnalyticsDataApi.RunPivotReportRequest();
      //expect(instance).to.be.a(GoogleAnalyticsDataApi.RunPivotReportRequest);
    });
