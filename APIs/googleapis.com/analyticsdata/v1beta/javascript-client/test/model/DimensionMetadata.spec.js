...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleAnalyticsDataApi.DimensionMetadata();
  });
  ...
  describe('DimensionMetadata', function() {
    it('should create an instance of DimensionMetadata', function() {
      // uncomment below and update the code to test DimensionMetadata
      //var instance = new GoogleAnalyticsDataApi.DimensionMetadata();
      //expect(instance).to.be.a(GoogleAnalyticsDataApi.DimensionMetadata);
    });
