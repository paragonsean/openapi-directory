...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleAnalyticsDataApi.StringFilter();
  });
  ...
  describe('StringFilter', function() {
    it('should create an instance of StringFilter', function() {
      ...
      //var instance = new GoogleAnalyticsDataApi.StringFilter();
      //expect(instance).to.be.a(GoogleAnalyticsDataApi.StringFilter);
    });
