...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleAnalyticsDataApi.CohortsRange();
  });
  ...
  describe('CohortsRange', function() {
    it('should create an instance of CohortsRange', function() {
      // uncomment below and update the code to test CohortsRange
      //var instance = new GoogleAnalyticsDataApi.CohortsRange();
      //expect(instance).to.be.a(GoogleAnalyticsDataApi.CohortsRange);
    });
