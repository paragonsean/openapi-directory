...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleAnalyticsDataApi.CheckCompatibilityRequest();
  });
  ...
  describe('CheckCompatibilityRequest', function() {
    it('should create an instance of CheckCompatibilityRequest', function() {
      // uncomment below and update the code to test CheckCompatibilityRequest
      //var instance = new GoogleAnalyticsDataApi.CheckCompatibilityRequest();
      //expect(instance).to.be.a(GoogleAnalyticsDataApi.CheckCompatibilityRequest);
    });

    it('should have the property compatibilityFilter (base name: "compatibilityFilter")', function() {
      // uncomment below and update the code to test the property compatibilityFilter
      //var instance = new GoogleAnalyticsDataApi.CheckCompatibilityRequest();
