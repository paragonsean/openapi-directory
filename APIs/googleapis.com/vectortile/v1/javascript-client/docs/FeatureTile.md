...
**features** | [**[Feature]**](Feature.md) | Features present on this map tile. | [optional] 
...
**providers** | [**[ProviderInfo]**](ProviderInfo.md) | Data providers for the data contained in this tile. | [optional] 
**status** | **String** | Tile response status code to support tile caching. | [optional] 
...
* `OK_DATA_UNCHANGED` (value: `"STATUS_OK_DATA_UNCHANGED"`)
