...
public class Vertex2DList {
  ...
  public Vertex2DList xOffsets(List<Integer> xOffsets) {
    this.xOffsets = xOffsets;
    return this;
  }

  public Vertex2DList addXOffsetsItem(Integer xOffsetsItem) {
  ...
  public Vertex2DList yOffsets(List<Integer> yOffsets) {
    this.yOffsets = yOffsets;
    return this;
  }

  public Vertex2DList addYOffsetsItem(Integer yOffsetsItem) {
  ...
  public boolean equals(Object o) {
    ...
    Vertex2DList vertex2DList = (Vertex2DList) o;
    return Objects.equals(this.xOffsets, vertex2DList.xOffsets) &&
        Objects.equals(this.yOffsets, vertex2DList.yOffsets);
  }

  @Override
  public int hashCode() {
    return Objects.hash(xOffsets, yOffsets);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Vertex2DList {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Vertex2DList
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Vertex2DList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Vertex2DList is not found in the empty JSON string", Vertex2DList.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Vertex2DList.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Vertex2DList` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Vertex2DList.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Vertex2DList' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Vertex2DList> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Vertex2DList.class));

       return (TypeAdapter<T>) new TypeAdapter<Vertex2DList>() {
           @Override
           public void write(JsonWriter out, Vertex2DList value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Vertex2DList read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Vertex2DList given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Vertex2DList
   * @throws IOException if the JSON string is invalid with respect to Vertex2DList
   */
  public static Vertex2DList fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Vertex2DList.class);
  }

  /**
   * Convert an instance of Vertex2DList to an JSON string
   *
   * @return JSON string
   */
