...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudSchedulerApi.ListLocationsResponse();
  });
  ...
  describe('ListLocationsResponse', function() {
    it('should create an instance of ListLocationsResponse', function() {
      ...
      //var instance = new CloudSchedulerApi.ListLocationsResponse();
      //expect(instance).to.be.a(CloudSchedulerApi.ListLocationsResponse);
    });
