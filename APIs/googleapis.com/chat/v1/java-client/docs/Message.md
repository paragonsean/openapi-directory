...
|**attachedGifs** | [**List&lt;AttachedGif&gt;**](AttachedGif.md) | Output only. GIF images that are attached to the message. |  [optional] [readonly] |
...
|**emojiReactionSummaries** | [**List&lt;EmojiReactionSummary&gt;**](EmojiReactionSummary.md) | Output only. The list of emoji reaction summaries on the message. |  [optional] [readonly] |
