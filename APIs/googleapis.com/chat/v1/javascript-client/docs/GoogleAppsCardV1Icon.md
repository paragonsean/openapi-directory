# GoogleChatApi.GoogleAppsCardV1Icon
...
**imageType** | **String** | The crop style applied to the image. In some cases, applying a &#x60;CIRCLE&#x60; crop causes the image to be drawn larger than a built-in icon. | [optional] 
