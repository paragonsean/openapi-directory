# GoogleChatApi.GoogleAppsCardV1TextInput
...
**type** | **String** | How a text input field appears in the user interface. For example, whether the field is single or multi-line. | [optional] 
...
* `MULTIPLE_LINE` (value: `"MULTIPLE_LINE"`)
