...
class CustomEmoji {
    ...
    /**
     * Validates the JSON data with respect to <code>CustomEmoji</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CustomEmoji</code>.
     */
 ...
 * @member {String} uid
 */
CustomEmoji.prototype['uid'] = undefined;
