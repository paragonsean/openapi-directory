...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleChatApi.TimeInput();
  });
  ...
  describe('TimeInput', function() {
    it('should create an instance of TimeInput', function() {
      // uncomment below and update the code to test TimeInput
      //var instance = new GoogleChatApi.TimeInput();
      //expect(instance).to.be.a(GoogleChatApi.TimeInput);
    });
