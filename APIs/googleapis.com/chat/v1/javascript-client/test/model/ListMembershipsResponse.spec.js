...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleChatApi.ListMembershipsResponse();
  });
  ...
  describe('ListMembershipsResponse', function() {
    it('should create an instance of ListMembershipsResponse', function() {
      ...
      //var instance = new GoogleChatApi.ListMembershipsResponse();
      //expect(instance).to.be.a(GoogleChatApi.ListMembershipsResponse);
    });
