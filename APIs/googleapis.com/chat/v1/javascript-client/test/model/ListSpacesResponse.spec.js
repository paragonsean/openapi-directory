...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleChatApi.ListSpacesResponse();
  });
  ...
  describe('ListSpacesResponse', function() {
    it('should create an instance of ListSpacesResponse', function() {
      // uncomment below and update the code to test ListSpacesResponse
      //var instance = new GoogleChatApi.ListSpacesResponse();
      //expect(instance).to.be.a(GoogleChatApi.ListSpacesResponse);
    });
