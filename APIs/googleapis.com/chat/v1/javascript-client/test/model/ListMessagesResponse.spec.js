...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleChatApi.ListMessagesResponse();
  });
  ...
  describe('ListMessagesResponse', function() {
    it('should create an instance of ListMessagesResponse', function() {
      ...
      //var instance = new GoogleChatApi.ListMessagesResponse();
      //expect(instance).to.be.a(GoogleChatApi.ListMessagesResponse);
    });
