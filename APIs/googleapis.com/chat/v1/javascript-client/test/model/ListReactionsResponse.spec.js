...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleChatApi.ListReactionsResponse();
  });
  ...
  describe('ListReactionsResponse', function() {
    it('should create an instance of ListReactionsResponse', function() {
      // uncomment below and update the code to test ListReactionsResponse
      //var instance = new GoogleChatApi.ListReactionsResponse();
      //expect(instance).to.be.a(GoogleChatApi.ListReactionsResponse);
    });
