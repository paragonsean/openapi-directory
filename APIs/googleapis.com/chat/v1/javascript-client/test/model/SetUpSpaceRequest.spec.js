...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleChatApi.SetUpSpaceRequest();
  });
  ...
  describe('SetUpSpaceRequest', function() {
    it('should create an instance of SetUpSpaceRequest', function() {
      // uncomment below and update the code to test SetUpSpaceRequest
      //var instance = new GoogleChatApi.SetUpSpaceRequest();
      //expect(instance).to.be.a(GoogleChatApi.SetUpSpaceRequest);
    });
