...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GmailApi.LabelColor();
  });
  ...
  describe('LabelColor', function() {
    it('should create an instance of LabelColor', function() {
      // uncomment below and update the code to test LabelColor
      //var instance = new GmailApi.LabelColor();
      //expect(instance).to.be.a(GmailApi.LabelColor);
    });
