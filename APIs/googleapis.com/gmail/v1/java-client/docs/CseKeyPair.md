...
|**enablementState** | [**EnablementStateEnum**](#EnablementStateEnum) | Output only. The current state of the key pair. |  [optional] [readonly] |
...
|**privateKeyMetadata** | [**List&lt;CsePrivateKeyMetadata&gt;**](CsePrivateKeyMetadata.md) | Metadata for instances of this key pair&#39;s private key. |  [optional] |
|**subjectEmailAddresses** | **List&lt;String&gt;** | Output only. The email address identities that are specified on the leaf certificate. |  [optional] [readonly] |
