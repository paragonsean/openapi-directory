...
|**expungeBehavior** | [**ExpungeBehaviorEnum**](#ExpungeBehaviorEnum) | The action that will be executed on a message when it is marked as deleted and expunged from the last visible IMAP folder. |  [optional] |
|**maxFolderSize** | **Integer** | An optional limit on the number of messages that an IMAP folder may contain. Legal values are 0, 1000, 2000, 5000 or 10000. A value of zero is interpreted to mean that there is no limit. |  [optional] |
