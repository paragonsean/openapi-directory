...
|**verificationStatus** | [**VerificationStatusEnum**](#VerificationStatusEnum) | Indicates whether this address has been verified for use as a send-as alias. Read-only. This setting only applies to custom \&quot;from\&quot; aliases. |  [optional] |
