...
from openapi_server.models.sharing_environment_config import SharingEnvironmentConfig
...
class DataExchange(Model):
    ...
    def __init__(self, description: str=None, display_name: str=None, documentation: str=None, icon: str=None, listing_count: int=None, name: str=None, primary_contact: str=None, sharing_environment_config: SharingEnvironmentConfig=None):
        ...
        :param sharing_environment_config: The sharing_environment_config of this DataExchange.
        """
        self.openapi_types = {
            'description': str,
            'display_name': str,
        ...
        self._sharing_environment_config = sharing_environment_config
    ...
    @property
    def sharing_environment_config(self):
        """Gets the sharing_environment_config of this DataExchange.


        :return: The sharing_environment_config of this DataExchange.
        :rtype: SharingEnvironmentConfig
        """
        return self._sharing_environment_config

    @sharing_environment_config.setter
    def sharing_environment_config(self, sharing_environment_config):
        """Sets the sharing_environment_config of this DataExchange.


        :param sharing_environment_config: The sharing_environment_config of this DataExchange.
        :type sharing_environment_config: SharingEnvironmentConfig
        """
