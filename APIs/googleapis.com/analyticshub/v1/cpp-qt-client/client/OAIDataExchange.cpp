...
void OAIDataExchange::initializeModel() {
    ...
    m_sharing_environment_config_isSet = false;
    m_sharing_environment_config_isValid = false;
}
...
void OAIDataExchange::fromJsonObject(QJsonObject json) {
    ...
    m_sharing_environment_config_isValid = ::OpenAPI::fromJsonValue(m_sharing_environment_config, json[QString("sharingEnvironmentConfig")]);
    m_sharing_environment_config_isSet = !json[QString("sharingEnvironmentConfig")].isNull() && m_sharing_environment_config_isValid;
}
...
QJsonObject OAIDataExchange::asJsonObject() const {
    ...
    if (m_sharing_environment_config.isSet()) {
        obj.insert(QString("sharingEnvironmentConfig"), ::OpenAPI::toJsonValue(m_sharing_environment_config));
    }
    return obj;
}
...
OAISharingEnvironmentConfig OAIDataExchange::getSharingEnvironmentConfig() const {
    return m_sharing_environment_config;
}
void OAIDataExchange::setSharingEnvironmentConfig(const OAISharingEnvironmentConfig &sharing_environment_config) {
    m_sharing_environment_config = sharing_environment_config;
    m_sharing_environment_config_isSet = true;
}

bool OAIDataExchange::is_sharing_environment_config_Set() const{
    return m_sharing_environment_config_isSet;
}

bool OAIDataExchange::is_sharing_environment_config_Valid() const{
    return m_sharing_environment_config_isValid;
}
