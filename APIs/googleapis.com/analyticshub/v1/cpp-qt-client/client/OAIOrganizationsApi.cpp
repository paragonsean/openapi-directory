...
void OAIOrganizationsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("analyticshub_organizations_locations_dataExchanges_list", defaultConf);
    _serverIndices.insert("analyticshub_organizations_locations_dataExchanges_list", 0);
}
...
void OAIOrganizationsApi::analyticshub_organizations_locations_dataExchanges_list(const QString &organization, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &page_token) {
    QString fullPath = QString(_serverConfigs["analyticshub_organizations_locations_dataExchanges_list"][_serverIndices.value("analyticshub_organizations_locations_dataExchanges_list")].URL()+"/v1/{organization}/dataExchanges");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIOrganizationsApi::analyticshub_organizations_locations_dataExchanges_listCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIOrganizationsApi::analyticshub_organizations_locations_dataExchanges_listCallback);
...
void OAIOrganizationsApi::analyticshub_organizations_locations_dataExchanges_listCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIListOrgDataExchangesResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT analyticshub_organizations_locations_dataExchanges_listSignal(output);
        Q_EMIT analyticshub_organizations_locations_dataExchanges_listSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT analyticshub_organizations_locations_dataExchanges_listSignalE(output, error_type, error_str);
        Q_EMIT analyticshub_organizations_locations_dataExchanges_listSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT analyticshub_organizations_locations_dataExchanges_listSignalError(output, error_type, error_str);
        Q_EMIT analyticshub_organizations_locations_dataExchanges_listSignalErrorFull(worker, error_type, error_str);
    }
}
