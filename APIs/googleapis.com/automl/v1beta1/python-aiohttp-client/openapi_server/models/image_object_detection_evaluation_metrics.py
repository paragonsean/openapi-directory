...
class ImageObjectDetectionEvaluationMetrics(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, bounding_box_mean_average_precision: float=None, bounding_box_metrics_entries: List[BoundingBoxMetricsEntry]=None, evaluated_bounding_box_count: int=None):
        """ImageObjectDetectionEvaluationMetrics - a model defined in OpenAPI

        :param bounding_box_mean_average_precision: The bounding_box_mean_average_precision of this ImageObjectDetectionEvaluationMetrics.
        :param bounding_box_metrics_entries: The bounding_box_metrics_entries of this ImageObjectDetectionEvaluationMetrics.
        :param evaluated_bounding_box_count: The evaluated_bounding_box_count of this ImageObjectDetectionEvaluationMetrics.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ImageObjectDetectionEvaluationMetrics':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ImageObjectDetectionEvaluationMetrics of this ImageObjectDetectionEvaluationMetrics.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def bounding_box_mean_average_precision(self):
        """Gets the bounding_box_mean_average_precision of this ImageObjectDetectionEvaluationMetrics.
        ...
        :return: The bounding_box_mean_average_precision of this ImageObjectDetectionEvaluationMetrics.
        :rtype: float
        """
    ...
    def bounding_box_mean_average_precision(self, bounding_box_mean_average_precision):
        """Sets the bounding_box_mean_average_precision of this ImageObjectDetectionEvaluationMetrics.
    ...
    def bounding_box_metrics_entries(self):
        """Gets the bounding_box_metrics_entries of this ImageObjectDetectionEvaluationMetrics.
        ...
        :return: The bounding_box_metrics_entries of this ImageObjectDetectionEvaluationMetrics.
    ...
    def bounding_box_metrics_entries(self, bounding_box_metrics_entries):
        """Sets the bounding_box_metrics_entries of this ImageObjectDetectionEvaluationMetrics.
    ...
    def evaluated_bounding_box_count(self):
        """Gets the evaluated_bounding_box_count of this ImageObjectDetectionEvaluationMetrics.
        ...
        :return: The evaluated_bounding_box_count of this ImageObjectDetectionEvaluationMetrics.
        :rtype: int
        """
    ...
    def evaluated_bounding_box_count(self, evaluated_bounding_box_count):
        """Sets the evaluated_bounding_box_count of this ImageObjectDetectionEvaluationMetrics.
