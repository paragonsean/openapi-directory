# CloudAutoMlApi.ImageObjectDetectionEvaluationMetrics
...
**evaluatedBoundingBoxCount** | **Number** | Output only. The total number of bounding boxes (i.e. summed over all images) the ground truth used to create this evaluation had. | [optional] 
