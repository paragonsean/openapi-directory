...
**inputConfigs** | [**[InputConfig]**](InputConfig.md) | Output only. Input configs via which data currently residing in the table had been imported. | [optional] 
