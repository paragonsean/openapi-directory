...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudAutoMlApi.ListLocationsResponse();
  });
  ...
  describe('ListLocationsResponse', function() {
    it('should create an instance of ListLocationsResponse', function() {
      ...
      //var instance = new CloudAutoMlApi.ListLocationsResponse();
      //expect(instance).to.be.a(CloudAutoMlApi.ListLocationsResponse);
    });
