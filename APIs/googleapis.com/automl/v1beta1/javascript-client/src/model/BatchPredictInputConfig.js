...
/**
 * The BatchPredictInputConfig model module.
 * @module model/BatchPredictInputConfig
 * @version v1beta1
 */
class BatchPredictInputConfig {
    /**
     * Constructs a new <code>BatchPredictInputConfig</code>.
     ...
     * @alias module:model/BatchPredictInputConfig
     */
    constructor() { 
        
        BatchPredictInputConfig.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BatchPredictInputConfig</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BatchPredictInputConfig} obj Optional instance to populate.
     * @return {module:model/BatchPredictInputConfig} The populated <code>BatchPredictInputConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BatchPredictInputConfig();

            if (data.hasOwnProperty('bigquerySource')) {
                obj['bigquerySource'] = BigQuerySource.constructFromObject(data['bigquerySource']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>BatchPredictInputConfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BatchPredictInputConfig</code>.
     */
    static validateJSON(data) {
        // validate the optional field `bigquerySource`
        if (data['bigquerySource']) { // data not null
          BigQuerySource.validateJSON(data['bigquerySource']);
        }
...
/**
 * @member {module:model/BigQuerySource} bigquerySource
 */
BatchPredictInputConfig.prototype['bigquerySource'] = undefined;

/**
 * @member {module:model/GcsSource} gcsSource
 */
BatchPredictInputConfig.prototype['gcsSource'] = undefined;
...
export default BatchPredictInputConfig;
