...
|**optimizationObjectivePrecisionValue** | **Float** | Required when optimization_objective is \&quot;MAXIMIZE_RECALL_AT_PRECISION\&quot;. Must be between 0 and 1, inclusive. |  [optional] |
|**optimizationObjectiveRecallValue** | **Float** | Required when optimization_objective is \&quot;MAXIMIZE_PRECISION_AT_RECALL\&quot;. Must be between 0 and 1, inclusive. |  [optional] |
|**tablesModelColumnInfo** | [**List&lt;TablesModelColumnInfo&gt;**](TablesModelColumnInfo.md) | Output only. Auxiliary information for each of the input_feature_column_specs with respect to this particular model. |  [optional] |
