...
|**partialFailures** | [**List&lt;Status&gt;**](Status.md) | Output only. Partial failures encountered. E.g. single files that couldn&#39;t be read. This field should never exceed 20 entries. Status details field will contain standard GCP error details. |  [optional] |
|**progressPercent** | **Integer** | Output only. Progress of operation. Range: [0, 100]. Not used currently. |  [optional] |
