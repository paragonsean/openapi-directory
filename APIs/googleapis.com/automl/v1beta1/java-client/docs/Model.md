...
|**deploymentState** | [**DeploymentStateEnum**](#DeploymentStateEnum) | Output only. Deployment state of the model. A model can only serve prediction requests after it gets deployed. |  [optional] |
...
|**trainExampleCount** | **Integer** | Output only. The number of examples in the training set used for the model creation. |  [optional] [readonly] |
...
|**validateExampleCount** | **Integer** | Output only. The number of examples in the validation set used for the model creation. |  [optional] [readonly] |
