...
#ifndef OAIBatchPredictInputConfig_H
#define OAIBatchPredictInputConfig_H
...
class OAIBatchPredictInputConfig : public OAIObject {
public:
    OAIBatchPredictInputConfig();
    OAIBatchPredictInputConfig(QString json);
    ~OAIBatchPredictInputConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchPredictInputConfig)

#endif // OAIBatchPredictInputConfig_H
