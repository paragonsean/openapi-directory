...
(function(root, factory) {
  ...
  describe('ProjectsApi', function() {
    ...
    describe('servicedirectoryProjectsLocationsNamespacesServicesGetIamPolicy', function() {
      it('should call servicedirectoryProjectsLocationsNamespacesServicesGetIamPolicy successfully', function(done) {
        //uncomment below and update the code to test servicedirectoryProjectsLocationsNamespacesServicesGetIamPolicy
        //instance.servicedirectoryProjectsLocationsNamespacesServicesGetIamPolicy(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('servicedirectoryProjectsLocationsNamespacesServicesSetIamPolicy', function() {
      it('should call servicedirectoryProjectsLocationsNamespacesServicesSetIamPolicy successfully', function(done) {
        //uncomment below and update the code to test servicedirectoryProjectsLocationsNamespacesServicesSetIamPolicy
        //instance.servicedirectoryProjectsLocationsNamespacesServicesSetIamPolicy(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('servicedirectoryProjectsLocationsNamespacesServicesTestIamPermissions', function() {
      it('should call servicedirectoryProjectsLocationsNamespacesServicesTestIamPermissions successfully', function(done) {
        //uncomment below and update the code to test servicedirectoryProjectsLocationsNamespacesServicesTestIamPermissions
        //instance.servicedirectoryProjectsLocationsNamespacesServicesTestIamPermissions(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
