...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceDirectoryApi.ListNamespacesResponse();
  });
  ...
  describe('ListNamespacesResponse', function() {
    it('should create an instance of ListNamespacesResponse', function() {
      ...
      //var instance = new ServiceDirectoryApi.ListNamespacesResponse();
      //expect(instance).to.be.a(ServiceDirectoryApi.ListNamespacesResponse);
    });
