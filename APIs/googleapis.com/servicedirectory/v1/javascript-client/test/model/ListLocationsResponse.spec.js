...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceDirectoryApi.ListLocationsResponse();
  });
  ...
  describe('ListLocationsResponse', function() {
    it('should create an instance of ListLocationsResponse', function() {
      ...
      //var instance = new ServiceDirectoryApi.ListLocationsResponse();
      //expect(instance).to.be.a(ServiceDirectoryApi.ListLocationsResponse);
    });
