...
public class Endpoint {
  ...
  public Endpoint annotations(Map<String, String> annotations) {
    this.annotations = annotations;
    return this;
  }

  public Endpoint putAnnotationsItem(String key, String annotationsItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.address, endpoint.address) &&
        Objects.equals(this.annotations, endpoint.annotations) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(address, annotations, name, network, port, uid);
  }
