...
OAIBareMetalAdminCluster::OAIBareMetalAdminCluster(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBareMetalAdminCluster::OAIBareMetalAdminCluster() {
    this->initializeModel();
}

OAIBareMetalAdminCluster::~OAIBareMetalAdminCluster() {}

void OAIBareMetalAdminCluster::initializeModel() {
...
void OAIBareMetalAdminCluster::fromJson(QString jsonString) {
...
void OAIBareMetalAdminCluster::fromJsonObject(QJsonObject json) {
...
QString OAIBareMetalAdminCluster::asJson() const {
...
QJsonObject OAIBareMetalAdminCluster::asJsonObject() const {
    QJsonObject obj;
...
QMap<QString, QString> OAIBareMetalAdminCluster::getAnnotations() const {
    return m_annotations;
}
void OAIBareMetalAdminCluster::setAnnotations(const QMap<QString, QString> &annotations) {
    m_annotations = annotations;
    m_annotations_isSet = true;
}

bool OAIBareMetalAdminCluster::is_annotations_Set() const{
    return m_annotations_isSet;
}

bool OAIBareMetalAdminCluster::is_annotations_Valid() const{
    return m_annotations_isValid;
}

QString OAIBareMetalAdminCluster::getBareMetalVersion() const {
    return m_bare_metal_version;
}
void OAIBareMetalAdminCluster::setBareMetalVersion(const QString &bare_metal_version) {
    m_bare_metal_version = bare_metal_version;
    m_bare_metal_version_isSet = true;
}

bool OAIBareMetalAdminCluster::is_bare_metal_version_Set() const{
    return m_bare_metal_version_isSet;
}

bool OAIBareMetalAdminCluster::is_bare_metal_version_Valid() const{
    return m_bare_metal_version_isValid;
}

OAIBinaryAuthorization OAIBareMetalAdminCluster::getBinaryAuthorization() const {
    return m_binary_authorization;
}
void OAIBareMetalAdminCluster::setBinaryAuthorization(const OAIBinaryAuthorization &binary_authorization) {
    m_binary_authorization = binary_authorization;
    m_binary_authorization_isSet = true;
}

bool OAIBareMetalAdminCluster::is_binary_authorization_Set() const{
    return m_binary_authorization_isSet;
}

bool OAIBareMetalAdminCluster::is_binary_authorization_Valid() const{
    return m_binary_authorization_isValid;
}

OAIBareMetalAdminClusterOperationsConfig OAIBareMetalAdminCluster::getClusterOperations() const {
    return m_cluster_operations;
}
void OAIBareMetalAdminCluster::setClusterOperations(const OAIBareMetalAdminClusterOperationsConfig &cluster_operations) {
    m_cluster_operations = cluster_operations;
    m_cluster_operations_isSet = true;
}

bool OAIBareMetalAdminCluster::is_cluster_operations_Set() const{
    return m_cluster_operations_isSet;
}

bool OAIBareMetalAdminCluster::is_cluster_operations_Valid() const{
    return m_cluster_operations_isValid;
}

OAIBareMetalAdminControlPlaneConfig OAIBareMetalAdminCluster::getControlPlane() const {
    return m_control_plane;
}
void OAIBareMetalAdminCluster::setControlPlane(const OAIBareMetalAdminControlPlaneConfig &control_plane) {
    m_control_plane = control_plane;
    m_control_plane_isSet = true;
}

bool OAIBareMetalAdminCluster::is_control_plane_Set() const{
    return m_control_plane_isSet;
}

bool OAIBareMetalAdminCluster::is_control_plane_Valid() const{
    return m_control_plane_isValid;
}

QString OAIBareMetalAdminCluster::getCreateTime() const {
    return m_create_time;
}
void OAIBareMetalAdminCluster::setCreateTime(const QString &create_time) {
    m_create_time = create_time;
    m_create_time_isSet = true;
}

bool OAIBareMetalAdminCluster::is_create_time_Set() const{
    return m_create_time_isSet;
}

bool OAIBareMetalAdminCluster::is_create_time_Valid() const{
    return m_create_time_isValid;
}

QString OAIBareMetalAdminCluster::getDeleteTime() const {
    return m_delete_time;
}
void OAIBareMetalAdminCluster::setDeleteTime(const QString &delete_time) {
    m_delete_time = delete_time;
    m_delete_time_isSet = true;
}

bool OAIBareMetalAdminCluster::is_delete_time_Set() const{
    return m_delete_time_isSet;
}

bool OAIBareMetalAdminCluster::is_delete_time_Valid() const{
    return m_delete_time_isValid;
}

QString OAIBareMetalAdminCluster::getDescription() const {
    return m_description;
}
void OAIBareMetalAdminCluster::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIBareMetalAdminCluster::is_description_Set() const{
    return m_description_isSet;
}

bool OAIBareMetalAdminCluster::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIBareMetalAdminCluster::getEndpoint() const {
    return m_endpoint;
}
void OAIBareMetalAdminCluster::setEndpoint(const QString &endpoint) {
    m_endpoint = endpoint;
    m_endpoint_isSet = true;
}

bool OAIBareMetalAdminCluster::is_endpoint_Set() const{
    return m_endpoint_isSet;
}

bool OAIBareMetalAdminCluster::is_endpoint_Valid() const{
    return m_endpoint_isValid;
}

QString OAIBareMetalAdminCluster::getEtag() const {
    return m_etag;
}
void OAIBareMetalAdminCluster::setEtag(const QString &etag) {
    m_etag = etag;
    m_etag_isSet = true;
}

bool OAIBareMetalAdminCluster::is_etag_Set() const{
    return m_etag_isSet;
}

bool OAIBareMetalAdminCluster::is_etag_Valid() const{
    return m_etag_isValid;
}

OAIFleet OAIBareMetalAdminCluster::getFleet() const {
    return m_fleet;
}
void OAIBareMetalAdminCluster::setFleet(const OAIFleet &fleet) {
    m_fleet = fleet;
    m_fleet_isSet = true;
}

bool OAIBareMetalAdminCluster::is_fleet_Set() const{
    return m_fleet_isSet;
}

bool OAIBareMetalAdminCluster::is_fleet_Valid() const{
    return m_fleet_isValid;
}

OAIBareMetalAdminLoadBalancerConfig OAIBareMetalAdminCluster::getLoadBalancer() const {
    return m_load_balancer;
}
void OAIBareMetalAdminCluster::setLoadBalancer(const OAIBareMetalAdminLoadBalancerConfig &load_balancer) {
    m_load_balancer = load_balancer;
    m_load_balancer_isSet = true;
}

bool OAIBareMetalAdminCluster::is_load_balancer_Set() const{
    return m_load_balancer_isSet;
}

bool OAIBareMetalAdminCluster::is_load_balancer_Valid() const{
    return m_load_balancer_isValid;
}

QString OAIBareMetalAdminCluster::getLocalName() const {
    return m_local_name;
}
void OAIBareMetalAdminCluster::setLocalName(const QString &local_name) {
    m_local_name = local_name;
    m_local_name_isSet = true;
}

bool OAIBareMetalAdminCluster::is_local_name_Set() const{
    return m_local_name_isSet;
}

bool OAIBareMetalAdminCluster::is_local_name_Valid() const{
    return m_local_name_isValid;
}

OAIBareMetalAdminMaintenanceConfig OAIBareMetalAdminCluster::getMaintenanceConfig() const {
    return m_maintenance_config;
}
void OAIBareMetalAdminCluster::setMaintenanceConfig(const OAIBareMetalAdminMaintenanceConfig &maintenance_config) {
    m_maintenance_config = maintenance_config;
    m_maintenance_config_isSet = true;
}

bool OAIBareMetalAdminCluster::is_maintenance_config_Set() const{
    return m_maintenance_config_isSet;
}

bool OAIBareMetalAdminCluster::is_maintenance_config_Valid() const{
    return m_maintenance_config_isValid;
}

OAIBareMetalAdminMaintenanceStatus OAIBareMetalAdminCluster::getMaintenanceStatus() const {
    return m_maintenance_status;
}
void OAIBareMetalAdminCluster::setMaintenanceStatus(const OAIBareMetalAdminMaintenanceStatus &maintenance_status) {
    m_maintenance_status = maintenance_status;
    m_maintenance_status_isSet = true;
}

bool OAIBareMetalAdminCluster::is_maintenance_status_Set() const{
    return m_maintenance_status_isSet;
}

bool OAIBareMetalAdminCluster::is_maintenance_status_Valid() const{
    return m_maintenance_status_isValid;
}

QString OAIBareMetalAdminCluster::getName() const {
    return m_name;
}
void OAIBareMetalAdminCluster::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIBareMetalAdminCluster::is_name_Set() const{
    return m_name_isSet;
}

bool OAIBareMetalAdminCluster::is_name_Valid() const{
    return m_name_isValid;
}

OAIBareMetalAdminNetworkConfig OAIBareMetalAdminCluster::getNetworkConfig() const {
    return m_network_config;
}
void OAIBareMetalAdminCluster::setNetworkConfig(const OAIBareMetalAdminNetworkConfig &network_config) {
    m_network_config = network_config;
    m_network_config_isSet = true;
}

bool OAIBareMetalAdminCluster::is_network_config_Set() const{
    return m_network_config_isSet;
}

bool OAIBareMetalAdminCluster::is_network_config_Valid() const{
    return m_network_config_isValid;
}

OAIBareMetalAdminNodeAccessConfig OAIBareMetalAdminCluster::getNodeAccessConfig() const {
    return m_node_access_config;
}
void OAIBareMetalAdminCluster::setNodeAccessConfig(const OAIBareMetalAdminNodeAccessConfig &node_access_config) {
    m_node_access_config = node_access_config;
    m_node_access_config_isSet = true;
}

bool OAIBareMetalAdminCluster::is_node_access_config_Set() const{
    return m_node_access_config_isSet;
}

bool OAIBareMetalAdminCluster::is_node_access_config_Valid() const{
    return m_node_access_config_isValid;
}

OAIBareMetalAdminWorkloadNodeConfig OAIBareMetalAdminCluster::getNodeConfig() const {
    return m_node_config;
}
void OAIBareMetalAdminCluster::setNodeConfig(const OAIBareMetalAdminWorkloadNodeConfig &node_config) {
    m_node_config = node_config;
    m_node_config_isSet = true;
}

bool OAIBareMetalAdminCluster::is_node_config_Set() const{
    return m_node_config_isSet;
}

bool OAIBareMetalAdminCluster::is_node_config_Valid() const{
    return m_node_config_isValid;
}

OAIBareMetalAdminOsEnvironmentConfig OAIBareMetalAdminCluster::getOsEnvironmentConfig() const {
    return m_os_environment_config;
}
void OAIBareMetalAdminCluster::setOsEnvironmentConfig(const OAIBareMetalAdminOsEnvironmentConfig &os_environment_config) {
    m_os_environment_config = os_environment_config;
    m_os_environment_config_isSet = true;
}

bool OAIBareMetalAdminCluster::is_os_environment_config_Set() const{
    return m_os_environment_config_isSet;
}

bool OAIBareMetalAdminCluster::is_os_environment_config_Valid() const{
    return m_os_environment_config_isValid;
}

OAIBareMetalAdminProxyConfig OAIBareMetalAdminCluster::getProxy() const {
    return m_proxy;
}
void OAIBareMetalAdminCluster::setProxy(const OAIBareMetalAdminProxyConfig &proxy) {
    m_proxy = proxy;
    m_proxy_isSet = true;
}

bool OAIBareMetalAdminCluster::is_proxy_Set() const{
    return m_proxy_isSet;
}

bool OAIBareMetalAdminCluster::is_proxy_Valid() const{
    return m_proxy_isValid;
}

bool OAIBareMetalAdminCluster::isReconciling() const {
    return m_reconciling;
}
void OAIBareMetalAdminCluster::setReconciling(const bool &reconciling) {
    m_reconciling = reconciling;
    m_reconciling_isSet = true;
}

bool OAIBareMetalAdminCluster::is_reconciling_Set() const{
    return m_reconciling_isSet;
}

bool OAIBareMetalAdminCluster::is_reconciling_Valid() const{
    return m_reconciling_isValid;
}

OAIBareMetalAdminSecurityConfig OAIBareMetalAdminCluster::getSecurityConfig() const {
    return m_security_config;
}
void OAIBareMetalAdminCluster::setSecurityConfig(const OAIBareMetalAdminSecurityConfig &security_config) {
    m_security_config = security_config;
    m_security_config_isSet = true;
}

bool OAIBareMetalAdminCluster::is_security_config_Set() const{
    return m_security_config_isSet;
}

bool OAIBareMetalAdminCluster::is_security_config_Valid() const{
    return m_security_config_isValid;
}

QString OAIBareMetalAdminCluster::getState() const {
    return m_state;
}
void OAIBareMetalAdminCluster::setState(const QString &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIBareMetalAdminCluster::is_state_Set() const{
    return m_state_isSet;
}

bool OAIBareMetalAdminCluster::is_state_Valid() const{
    return m_state_isValid;
}

OAIResourceStatus OAIBareMetalAdminCluster::getStatus() const {
    return m_status;
}
void OAIBareMetalAdminCluster::setStatus(const OAIResourceStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIBareMetalAdminCluster::is_status_Set() const{
    return m_status_isSet;
}

bool OAIBareMetalAdminCluster::is_status_Valid() const{
    return m_status_isValid;
}

OAIBareMetalAdminStorageConfig OAIBareMetalAdminCluster::getStorage() const {
    return m_storage;
}
void OAIBareMetalAdminCluster::setStorage(const OAIBareMetalAdminStorageConfig &storage) {
    m_storage = storage;
    m_storage_isSet = true;
}

bool OAIBareMetalAdminCluster::is_storage_Set() const{
    return m_storage_isSet;
}

bool OAIBareMetalAdminCluster::is_storage_Valid() const{
    return m_storage_isValid;
}

QString OAIBareMetalAdminCluster::getUid() const {
    return m_uid;
}
void OAIBareMetalAdminCluster::setUid(const QString &uid) {
    m_uid = uid;
    m_uid_isSet = true;
}

bool OAIBareMetalAdminCluster::is_uid_Set() const{
    return m_uid_isSet;
}

bool OAIBareMetalAdminCluster::is_uid_Valid() const{
    return m_uid_isValid;
}

QString OAIBareMetalAdminCluster::getUpdateTime() const {
    return m_update_time;
}
void OAIBareMetalAdminCluster::setUpdateTime(const QString &update_time) {
    m_update_time = update_time;
    m_update_time_isSet = true;
}

bool OAIBareMetalAdminCluster::is_update_time_Set() const{
    return m_update_time_isSet;
}

bool OAIBareMetalAdminCluster::is_update_time_Valid() const{
    return m_update_time_isValid;
}

OAIValidationCheck OAIBareMetalAdminCluster::getValidationCheck() const {
    return m_validation_check;
}
void OAIBareMetalAdminCluster::setValidationCheck(const OAIValidationCheck &validation_check) {
    m_validation_check = validation_check;
    m_validation_check_isSet = true;
}

bool OAIBareMetalAdminCluster::is_validation_check_Set() const{
    return m_validation_check_isSet;
}

bool OAIBareMetalAdminCluster::is_validation_check_Valid() const{
    return m_validation_check_isValid;
}

bool OAIBareMetalAdminCluster::isSet() const {
...
bool OAIBareMetalAdminCluster::isValid() const {
