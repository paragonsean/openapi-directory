...
/*
 * OAIBareMetalNodePool.h
 *
 * Resource that represents a bare metal node pool.
 */

#ifndef OAIBareMetalNodePool_H
#define OAIBareMetalNodePool_H
...
class OAIBareMetalNodePoolUpgradePolicy;

class OAIBareMetalNodePool : public OAIObject {
public:
    OAIBareMetalNodePool();
    OAIBareMetalNodePool(QString json);
    ~OAIBareMetalNodePool() override;
    ...
    OAIBareMetalNodePoolUpgradePolicy getUpgradePolicy() const;
    void setUpgradePolicy(const OAIBareMetalNodePoolUpgradePolicy &upgrade_policy);
...
private:
    ...
    OAIBareMetalNodePoolUpgradePolicy m_upgrade_policy;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBareMetalNodePool)

#endif // OAIBareMetalNodePool_H
