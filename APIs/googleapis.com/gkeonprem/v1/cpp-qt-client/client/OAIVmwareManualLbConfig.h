...
#ifndef OAIVmwareManualLbConfig_H
#define OAIVmwareManualLbConfig_H
...
class OAIVmwareManualLbConfig : public OAIObject {
public:
    OAIVmwareManualLbConfig();
    OAIVmwareManualLbConfig(QString json);
    ~OAIVmwareManualLbConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVmwareManualLbConfig)

#endif // OAIVmwareManualLbConfig_H
