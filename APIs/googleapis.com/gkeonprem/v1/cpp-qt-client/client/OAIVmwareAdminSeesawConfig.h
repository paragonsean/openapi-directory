...
#ifndef OAIVmwareAdminSeesawConfig_H
#define OAIVmwareAdminSeesawConfig_H
...
class OAIVmwareAdminSeesawConfig : public OAIObject {
public:
    OAIVmwareAdminSeesawConfig();
    OAIVmwareAdminSeesawConfig(QString json);
    ~OAIVmwareAdminSeesawConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVmwareAdminSeesawConfig)

#endif // OAIVmwareAdminSeesawConfig_H
