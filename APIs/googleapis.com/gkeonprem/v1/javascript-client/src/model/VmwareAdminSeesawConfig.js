...
/**
 * The VmwareAdminSeesawConfig model module.
 * @module model/VmwareAdminSeesawConfig
 * @version v1
 */
class VmwareAdminSeesawConfig {
    /**
     * Constructs a new <code>VmwareAdminSeesawConfig</code>.
     ...
     * @alias module:model/VmwareAdminSeesawConfig
     */
    constructor() { 
        
        VmwareAdminSeesawConfig.initialize(this);
    }
    ...
    /**
     * Constructs a <code>VmwareAdminSeesawConfig</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VmwareAdminSeesawConfig} obj Optional instance to populate.
     * @return {module:model/VmwareAdminSeesawConfig} The populated <code>VmwareAdminSeesawConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VmwareAdminSeesawConfig();
    ...
    /**
     * Validates the JSON data with respect to <code>VmwareAdminSeesawConfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VmwareAdminSeesawConfig</code>.
     */
...
export default VmwareAdminSeesawConfig;
