...
/**
 * The VmwareVCenterConfig model module.
 * @module model/VmwareVCenterConfig
 * @version v1
 */
class VmwareVCenterConfig {
    /**
     * Constructs a new <code>VmwareVCenterConfig</code>.
     * Represents configuration for the VMware VCenter for the user cluster.
     * @alias module:model/VmwareVCenterConfig
     */
    constructor() { 
        
        VmwareVCenterConfig.initialize(this);
    }
    ...
    /**
     * Constructs a <code>VmwareVCenterConfig</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VmwareVCenterConfig} obj Optional instance to populate.
     * @return {module:model/VmwareVCenterConfig} The populated <code>VmwareVCenterConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VmwareVCenterConfig();
    ...
    /**
     * Validates the JSON data with respect to <code>VmwareVCenterConfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VmwareVCenterConfig</code>.
     */
 ...
 */
VmwareVCenterConfig.prototype['address'] = undefined;

/**
 * Contains the vCenter CA certificate public key for SSL verification.
 * @member {String} caCertData
 */
VmwareVCenterConfig.prototype['caCertData'] = undefined;

/**
 * The name of the vCenter cluster for the user cluster.
 * @member {String} cluster
 */
VmwareVCenterConfig.prototype['cluster'] = undefined;

/**
 * The name of the vCenter datacenter for the user cluster.
 * @member {String} datacenter
 */
VmwareVCenterConfig.prototype['datacenter'] = undefined;

/**
 * The name of the vCenter datastore for the user cluster.
 * @member {String} datastore
 */
VmwareVCenterConfig.prototype['datastore'] = undefined;

/**
 * The name of the vCenter folder for the user cluster.
 * @member {String} folder
 */
VmwareVCenterConfig.prototype['folder'] = undefined;

/**
 * The name of the vCenter resource pool for the user cluster.
 * @member {String} resourcePool
 */
VmwareVCenterConfig.prototype['resourcePool'] = undefined;

/**
 * The name of the vCenter storage policy for the user cluster.
 * @member {String} storagePolicyName
 */
VmwareVCenterConfig.prototype['storagePolicyName'] = undefined;
...
export default VmwareVCenterConfig;
