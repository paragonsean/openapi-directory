...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AnthosOnPremApi.VmwareIpBlock();
  });
  ...
  describe('VmwareIpBlock', function() {
    it('should create an instance of VmwareIpBlock', function() {
      // uncomment below and update the code to test VmwareIpBlock
      //var instance = new AnthosOnPremApi.VmwareIpBlock();
      //expect(instance).to.be.a(AnthosOnPremApi.VmwareIpBlock);
    });
