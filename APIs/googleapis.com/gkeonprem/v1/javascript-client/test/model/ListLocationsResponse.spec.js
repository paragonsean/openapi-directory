...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AnthosOnPremApi.ListLocationsResponse();
  });
  ...
  describe('ListLocationsResponse', function() {
    it('should create an instance of ListLocationsResponse', function() {
      ...
      //var instance = new AnthosOnPremApi.ListLocationsResponse();
      //expect(instance).to.be.a(AnthosOnPremApi.ListLocationsResponse);
    });
