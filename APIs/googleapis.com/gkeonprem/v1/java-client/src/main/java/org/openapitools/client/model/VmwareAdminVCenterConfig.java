...
public class VmwareAdminVCenterConfig {
  ...
  public VmwareAdminVCenterConfig address(String address) {
  ...
  public VmwareAdminVCenterConfig caCertData(String caCertData) {
  ...
  public VmwareAdminVCenterConfig cluster(String cluster) {
  ...
  public VmwareAdminVCenterConfig dataDisk(String dataDisk) {
  ...
  public VmwareAdminVCenterConfig datacenter(String datacenter) {
  ...
  public VmwareAdminVCenterConfig datastore(String datastore) {
  ...
  public VmwareAdminVCenterConfig folder(String folder) {
    this.folder = folder;
    return this;
  }
  ...
  public VmwareAdminVCenterConfig resourcePool(String resourcePool) {
  ...
  public VmwareAdminVCenterConfig storagePolicyName(String storagePolicyName) {
  ...
  public boolean equals(Object o) {
    ...
    VmwareAdminVCenterConfig vmwareAdminVCenterConfig = (VmwareAdminVCenterConfig) o;
    return Objects.equals(this.address, vmwareAdminVCenterConfig.address) &&
        Objects.equals(this.caCertData, vmwareAdminVCenterConfig.caCertData) &&
        Objects.equals(this.cluster, vmwareAdminVCenterConfig.cluster) &&
        Objects.equals(this.dataDisk, vmwareAdminVCenterConfig.dataDisk) &&
        Objects.equals(this.datacenter, vmwareAdminVCenterConfig.datacenter) &&
        Objects.equals(this.datastore, vmwareAdminVCenterConfig.datastore) &&
        Objects.equals(this.folder, vmwareAdminVCenterConfig.folder) &&
        Objects.equals(this.resourcePool, vmwareAdminVCenterConfig.resourcePool) &&
        Objects.equals(this.storagePolicyName, vmwareAdminVCenterConfig.storagePolicyName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(address, caCertData, cluster, dataDisk, datacenter, datastore, folder, resourcePool, storagePolicyName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class VmwareAdminVCenterConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to VmwareAdminVCenterConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VmwareAdminVCenterConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VmwareAdminVCenterConfig is not found in the empty JSON string", VmwareAdminVCenterConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VmwareAdminVCenterConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VmwareAdminVCenterConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VmwareAdminVCenterConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VmwareAdminVCenterConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VmwareAdminVCenterConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VmwareAdminVCenterConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<VmwareAdminVCenterConfig>() {
           @Override
           public void write(JsonWriter out, VmwareAdminVCenterConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public VmwareAdminVCenterConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of VmwareAdminVCenterConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of VmwareAdminVCenterConfig
   * @throws IOException if the JSON string is invalid with respect to VmwareAdminVCenterConfig
   */
  public static VmwareAdminVCenterConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VmwareAdminVCenterConfig.class);
  }

  /**
   * Convert an instance of VmwareAdminVCenterConfig to an JSON string
   *
   * @return JSON string
   */
