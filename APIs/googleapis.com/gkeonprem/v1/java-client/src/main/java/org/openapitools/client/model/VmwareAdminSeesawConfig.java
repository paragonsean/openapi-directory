...
public class VmwareAdminSeesawConfig {
  ...
  public VmwareAdminSeesawConfig() {
  }

  public VmwareAdminSeesawConfig enableHa(Boolean enableHa) {
  ...
  public VmwareAdminSeesawConfig group(String group) {
    this.group = group;
    return this;
  }
  ...
  public VmwareAdminSeesawConfig ipBlocks(List<VmwareIpBlock> ipBlocks) {
    this.ipBlocks = ipBlocks;
    return this;
  }

  public VmwareAdminSeesawConfig addIpBlocksItem(VmwareIpBlock ipBlocksItem) {
  ...
  public VmwareAdminSeesawConfig masterIp(String masterIp) {
  ...
  public VmwareAdminSeesawConfig stackdriverName(String stackdriverName) {
  ...
  public VmwareAdminSeesawConfig vms(List<String> vms) {
    this.vms = vms;
    return this;
  }

  public VmwareAdminSeesawConfig addVmsItem(String vmsItem) {
    if (this.vms == null) {
  ...
  public boolean equals(Object o) {
    ...
    VmwareAdminSeesawConfig vmwareAdminSeesawConfig = (VmwareAdminSeesawConfig) o;
    return Objects.equals(this.enableHa, vmwareAdminSeesawConfig.enableHa) &&
        Objects.equals(this.group, vmwareAdminSeesawConfig.group) &&
        Objects.equals(this.ipBlocks, vmwareAdminSeesawConfig.ipBlocks) &&
        Objects.equals(this.masterIp, vmwareAdminSeesawConfig.masterIp) &&
        Objects.equals(this.stackdriverName, vmwareAdminSeesawConfig.stackdriverName) &&
        Objects.equals(this.vms, vmwareAdminSeesawConfig.vms);
  }
  ...
  public String toString() {
    ...
    sb.append("class VmwareAdminSeesawConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to VmwareAdminSeesawConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VmwareAdminSeesawConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VmwareAdminSeesawConfig is not found in the empty JSON string", VmwareAdminSeesawConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VmwareAdminSeesawConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VmwareAdminSeesawConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VmwareAdminSeesawConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VmwareAdminSeesawConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VmwareAdminSeesawConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VmwareAdminSeesawConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<VmwareAdminSeesawConfig>() {
           @Override
           public void write(JsonWriter out, VmwareAdminSeesawConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public VmwareAdminSeesawConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of VmwareAdminSeesawConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of VmwareAdminSeesawConfig
   * @throws IOException if the JSON string is invalid with respect to VmwareAdminSeesawConfig
   */
  public static VmwareAdminSeesawConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VmwareAdminSeesawConfig.class);
  }

  /**
   * Convert an instance of VmwareAdminSeesawConfig to an JSON string
   *
   * @return JSON string
   */
