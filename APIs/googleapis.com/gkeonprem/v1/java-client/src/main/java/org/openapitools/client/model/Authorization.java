...
public class Authorization {
  ...
  private List<ClusterUser> adminUsers = new ArrayList<>();

  public Authorization() {
  }

  public Authorization adminUsers(List<ClusterUser> adminUsers) {
    this.adminUsers = adminUsers;
    return this;
  }

  public Authorization addAdminUsersItem(ClusterUser adminUsersItem) {
  ...
  public List<ClusterUser> getAdminUsers() {
    return adminUsers;
  }

  public void setAdminUsers(List<ClusterUser> adminUsers) {
    this.adminUsers = adminUsers;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.adminUsers, authorization.adminUsers);
  }

  @Override
  public int hashCode() {
    return Objects.hash(adminUsers);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("adminUsers") != null && !jsonObj.get("adminUsers").isJsonNull()) {
        JsonArray jsonArrayadminUsers = jsonObj.getAsJsonArray("adminUsers");
        if (jsonArrayadminUsers != null) {
          // ensure the json data is an array
          if (!jsonObj.get("adminUsers").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `adminUsers` to be an array in the JSON string but got `%s`", jsonObj.get("adminUsers").toString()));
          }

          // validate the optional field `adminUsers` (array)
          for (int i = 0; i < jsonArrayadminUsers.size(); i++) {
            ClusterUser.validateJsonElement(jsonArrayadminUsers.get(i));
          };
        }
      }
  }
