...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudChannelApi.GoogleTypeDateTime();
  });
  ...
  describe('GoogleTypeDateTime', function() {
    it('should create an instance of GoogleTypeDateTime', function() {
      ...
      //var instance = new CloudChannelApi.GoogleTypeDateTime();
      //expect(instance).to.be.a(CloudChannelApi.GoogleTypeDateTime);
    });
