...
/**
 * The GoogleCloudChannelV1ChangeOfferRequest model module.
 * @module model/GoogleCloudChannelV1ChangeOfferRequest
 * @version v1
 */
class GoogleCloudChannelV1ChangeOfferRequest {
    /**
     * Constructs a new <code>GoogleCloudChannelV1ChangeOfferRequest</code>.
     * Request message for CloudChannelService.ChangeOffer.
     * @alias module:model/GoogleCloudChannelV1ChangeOfferRequest
     */
    constructor() { 
        
        GoogleCloudChannelV1ChangeOfferRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudChannelV1ChangeOfferRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudChannelV1ChangeOfferRequest} obj Optional instance to populate.
     * @return {module:model/GoogleCloudChannelV1ChangeOfferRequest} The populated <code>GoogleCloudChannelV1ChangeOfferRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudChannelV1ChangeOfferRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudChannelV1ChangeOfferRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudChannelV1ChangeOfferRequest</code>.
     */
 ...
 */
GoogleCloudChannelV1ChangeOfferRequest.prototype['billingAccount'] = undefined;

/**
 * Required. New Offer. Format: accounts/{account_id}/offers/{offer_id}.
 * @member {String} offer
 */
GoogleCloudChannelV1ChangeOfferRequest.prototype['offer'] = undefined;
 ...
 */
GoogleCloudChannelV1ChangeOfferRequest.prototype['parameters'] = undefined;

/**
 * Optional. Purchase order id provided by the reseller.
 * @member {String} purchaseOrderId
 */
GoogleCloudChannelV1ChangeOfferRequest.prototype['purchaseOrderId'] = undefined;

/**
 * Optional. You can specify an optional unique request ID, and if you need to retry your request, the server will know to ignore the request if it's complete. For example, you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if it received the original operation with the same request ID. If it did, it will ignore the second request. The request ID must be a valid [UUID](https://tools.ietf.org/html/rfc4122) with the exception that zero UUID is not supported (`00000000-0000-0000-0000-000000000000`).
 * @member {String} requestId
 */
GoogleCloudChannelV1ChangeOfferRequest.prototype['requestId'] = undefined;
...
export default GoogleCloudChannelV1ChangeOfferRequest;
