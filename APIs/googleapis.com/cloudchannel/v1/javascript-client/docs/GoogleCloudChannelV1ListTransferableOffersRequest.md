# CloudChannelApi.GoogleCloudChannelV1ListTransferableOffersRequest
...
**pageSize** | **Number** | Requested page size. Server might return fewer results than requested. If unspecified, returns at most 100 offers. The maximum value is 1000; the server will coerce values above 1000. | [optional] 
