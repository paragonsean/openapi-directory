# CloudChannelApi.OperationsApi

All URIs are relative to *https://cloudchannel.googleapis.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**cloudchannelOperationsCancel**](OperationsApi.md#cloudchannelOperationsCancel) | **POST** /v1/{name}:cancel | 
[**cloudchannelOperationsDelete**](OperationsApi.md#cloudchannelOperationsDelete) | **DELETE** /v1/{name} | 
[**cloudchannelOperationsList**](OperationsApi.md#cloudchannelOperationsList) | **GET** /v1/{name} | 



## cloudchannelOperationsCancel

> Object cloudchannelOperationsCancel(name, opts)
...
let apiInstance = new CloudChannelApi.OperationsApi();
...
apiInstance.cloudchannelOperationsCancel(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> Object cloudchannelOperationsDelete(name, opts)
...
apiInstance.cloudchannelOperationsDelete(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> GoogleLongrunningListOperationsResponse cloudchannelOperationsList(name, opts)
...
apiInstance.cloudchannelOperationsList(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
