# CloudChannelApi.GoogleCloudChannelV1CloudIdentityInfo
...
**customerType** | **String** | CustomerType indicates verification type needed for using services. | [optional] 
...
* `CUSTOMER_TYPE_UNSPECIFIED` (value: `"CUSTOMER_TYPE_UNSPECIFIED"`)
