...
public class GoogleCloudChannelV1DateRange {
  ...
  public GoogleCloudChannelV1DateRange invoiceEndDate(GoogleTypeDate invoiceEndDate) {
  ...
  public GoogleCloudChannelV1DateRange invoiceStartDate(GoogleTypeDate invoiceStartDate) {
  ...
  public GoogleCloudChannelV1DateRange usageEndDateTime(GoogleTypeDateTime usageEndDateTime) {
  ...
  public GoogleCloudChannelV1DateRange usageStartDateTime(GoogleTypeDateTime usageStartDateTime) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudChannelV1DateRange googleCloudChannelV1DateRange = (GoogleCloudChannelV1DateRange) o;
    return Objects.equals(this.invoiceEndDate, googleCloudChannelV1DateRange.invoiceEndDate) &&
        Objects.equals(this.invoiceStartDate, googleCloudChannelV1DateRange.invoiceStartDate) &&
        Objects.equals(this.usageEndDateTime, googleCloudChannelV1DateRange.usageEndDateTime) &&
        Objects.equals(this.usageStartDateTime, googleCloudChannelV1DateRange.usageStartDateTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudChannelV1DateRange {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudChannelV1DateRange
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudChannelV1DateRange.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudChannelV1DateRange is not found in the empty JSON string", GoogleCloudChannelV1DateRange.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudChannelV1DateRange.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudChannelV1DateRange` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudChannelV1DateRange.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudChannelV1DateRange' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudChannelV1DateRange> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudChannelV1DateRange.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudChannelV1DateRange>() {
           @Override
           public void write(JsonWriter out, GoogleCloudChannelV1DateRange value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudChannelV1DateRange read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudChannelV1DateRange given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudChannelV1DateRange
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudChannelV1DateRange
   */
  public static GoogleCloudChannelV1DateRange fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudChannelV1DateRange.class);
  }

  /**
   * Convert an instance of GoogleCloudChannelV1DateRange to an JSON string
   *
   * @return JSON string
   */
