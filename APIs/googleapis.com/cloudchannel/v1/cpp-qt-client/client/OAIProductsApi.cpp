...
void OAIProductsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("cloudchannel_products_list", defaultConf);
    _serverIndices.insert("cloudchannel_products_list", 0);
    _serverConfigs.insert("cloudchannel_products_skus_list", defaultConf);
    _serverIndices.insert("cloudchannel_products_skus_list", 0);
}
...
void OAIProductsApi::cloudchannel_products_list(const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<QString> &account, const ::OpenAPI::OptionalParam<QString> &language_code, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &page_token) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProductsApi::cloudchannel_products_listCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProductsApi::cloudchannel_products_listCallback);
...
void OAIProductsApi::cloudchannel_products_listCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIGoogleCloudChannelV1ListProductsResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT cloudchannel_products_listSignal(output);
        Q_EMIT cloudchannel_products_listSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT cloudchannel_products_listSignalE(output, error_type, error_str);
        Q_EMIT cloudchannel_products_listSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT cloudchannel_products_listSignalError(output, error_type, error_str);
        Q_EMIT cloudchannel_products_listSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProductsApi::cloudchannel_products_skus_list(const QString &parent, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<QString> &account, const ::OpenAPI::OptionalParam<QString> &language_code, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &page_token) {
    QString fullPath = QString(_serverConfigs["cloudchannel_products_skus_list"][_serverIndices.value("cloudchannel_products_skus_list")].URL()+"/v1/{parent}/skus");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProductsApi::cloudchannel_products_skus_listCallback);
    connect(this, &OAIProductsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProductsApi::cloudchannel_products_skus_listCallback);
    connect(this, &OAIProductsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProductsApi::cloudchannel_products_skus_listCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIGoogleCloudChannelV1ListSkusResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT cloudchannel_products_skus_listSignal(output);
        Q_EMIT cloudchannel_products_skus_listSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("https://www.googleapis.com/auth/apps.order");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT cloudchannel_products_skus_listSignalE(output, error_type, error_str);
        Q_EMIT cloudchannel_products_skus_listSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT cloudchannel_products_skus_listSignalError(output, error_type, error_str);
        Q_EMIT cloudchannel_products_skus_listSignalErrorFull(worker, error_type, error_str);
    }
}
