...
OAIGoogleCloudChannelV1Value::OAIGoogleCloudChannelV1Value(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGoogleCloudChannelV1Value::OAIGoogleCloudChannelV1Value() {
    this->initializeModel();
}

OAIGoogleCloudChannelV1Value::~OAIGoogleCloudChannelV1Value() {}

void OAIGoogleCloudChannelV1Value::initializeModel() {
...
void OAIGoogleCloudChannelV1Value::fromJson(QString jsonString) {
...
void OAIGoogleCloudChannelV1Value::fromJsonObject(QJsonObject json) {
...
QString OAIGoogleCloudChannelV1Value::asJson() const {
...
QJsonObject OAIGoogleCloudChannelV1Value::asJsonObject() const {
    QJsonObject obj;
...
bool OAIGoogleCloudChannelV1Value::isBoolValue() const {
    return m_bool_value;
}
void OAIGoogleCloudChannelV1Value::setBoolValue(const bool &bool_value) {
    m_bool_value = bool_value;
    m_bool_value_isSet = true;
}

bool OAIGoogleCloudChannelV1Value::is_bool_value_Set() const{
    return m_bool_value_isSet;
}

bool OAIGoogleCloudChannelV1Value::is_bool_value_Valid() const{
    return m_bool_value_isValid;
}

double OAIGoogleCloudChannelV1Value::getDoubleValue() const {
    return m_double_value;
}
void OAIGoogleCloudChannelV1Value::setDoubleValue(const double &double_value) {
    m_double_value = double_value;
    m_double_value_isSet = true;
}

bool OAIGoogleCloudChannelV1Value::is_double_value_Set() const{
    return m_double_value_isSet;
}

bool OAIGoogleCloudChannelV1Value::is_double_value_Valid() const{
    return m_double_value_isValid;
}

QString OAIGoogleCloudChannelV1Value::getInt64Value() const {
    return m_int64_value;
}
void OAIGoogleCloudChannelV1Value::setInt64Value(const QString &int64_value) {
    m_int64_value = int64_value;
    m_int64_value_isSet = true;
}

bool OAIGoogleCloudChannelV1Value::is_int64_value_Set() const{
    return m_int64_value_isSet;
}

bool OAIGoogleCloudChannelV1Value::is_int64_value_Valid() const{
    return m_int64_value_isValid;
}

QMap<QString, QJsonValue> OAIGoogleCloudChannelV1Value::getProtoValue() const {
    return m_proto_value;
}
void OAIGoogleCloudChannelV1Value::setProtoValue(const QMap<QString, QJsonValue> &proto_value) {
    m_proto_value = proto_value;
    m_proto_value_isSet = true;
}

bool OAIGoogleCloudChannelV1Value::is_proto_value_Set() const{
    return m_proto_value_isSet;
}

bool OAIGoogleCloudChannelV1Value::is_proto_value_Valid() const{
    return m_proto_value_isValid;
}

QString OAIGoogleCloudChannelV1Value::getStringValue() const {
    return m_string_value;
}
void OAIGoogleCloudChannelV1Value::setStringValue(const QString &string_value) {
    m_string_value = string_value;
    m_string_value_isSet = true;
}

bool OAIGoogleCloudChannelV1Value::is_string_value_Set() const{
    return m_string_value_isSet;
}

bool OAIGoogleCloudChannelV1Value::is_string_value_Valid() const{
    return m_string_value_isValid;
}

bool OAIGoogleCloudChannelV1Value::isSet() const {
...
bool OAIGoogleCloudChannelV1Value::isValid() const {
