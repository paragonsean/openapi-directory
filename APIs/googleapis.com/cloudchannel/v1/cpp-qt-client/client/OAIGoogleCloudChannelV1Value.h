...
/*
 * OAIGoogleCloudChannelV1Value.h
 *
 * Data type and value of a parameter.
 */

#ifndef OAIGoogleCloudChannelV1Value_H
#define OAIGoogleCloudChannelV1Value_H
...
class OAIGoogleCloudChannelV1Value : public OAIObject {
public:
    OAIGoogleCloudChannelV1Value();
    OAIGoogleCloudChannelV1Value(QString json);
    ~OAIGoogleCloudChannelV1Value() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudChannelV1Value)

#endif // OAIGoogleCloudChannelV1Value_H
