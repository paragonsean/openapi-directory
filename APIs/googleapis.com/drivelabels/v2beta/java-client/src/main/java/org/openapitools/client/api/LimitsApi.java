...
public class LimitsApi {
    ...
    public okhttp3.Call drivelabelsLimitsGetLabelCall(String $xgafv, String accessToken, String alt, String paramCallback, String fields, String key, String oauthToken, Boolean prettyPrint, String quotaUser, String uploadProtocol, String uploadType, String name, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/v2beta/limits/label";
     ...
     */
    public GoogleAppsDriveLabelsV2betaLabelLimits drivelabelsLimitsGetLabel(String $xgafv, String accessToken, String alt, String paramCallback, String fields, String key, String oauthToken, Boolean prettyPrint, String quotaUser, String uploadProtocol, String uploadType, String name) throws ApiException {
        ApiResponse<GoogleAppsDriveLabelsV2betaLabelLimits> localVarResp = drivelabelsLimitsGetLabelWithHttpInfo($xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, name);
     ...
     * @param uploadType Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;). (optional)
     * @param name Required. Label revision resource name Must be: \&quot;limits/label\&quot; (optional)
     * @return ApiResponse&lt;GoogleAppsDriveLabelsV2betaLabelLimits&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<GoogleAppsDriveLabelsV2betaLabelLimits> drivelabelsLimitsGetLabelWithHttpInfo(String $xgafv, String accessToken, String alt, String paramCallback, String fields, String key, String oauthToken, Boolean prettyPrint, String quotaUser, String uploadProtocol, String uploadType, String name) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<GoogleAppsDriveLabelsV2betaLabelLimits>(){}.getType();
