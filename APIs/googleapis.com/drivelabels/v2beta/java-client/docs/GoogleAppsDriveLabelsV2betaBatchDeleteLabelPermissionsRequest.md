...
|------------ | ------------- | ------------- | -------------|
|**requests** | [**List&lt;GoogleAppsDriveLabelsV2betaDeleteLabelPermissionRequest&gt;**](GoogleAppsDriveLabelsV2betaDeleteLabelPermissionRequest.md) | Required. The request message specifying the resources to update. |  [optional] |
