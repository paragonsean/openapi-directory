...
> GoogleAppsDriveLabelsV2betaUserCapabilities drivelabelsUsersGetCapabilities(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, customer, useAdminAccess, view)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      GoogleAppsDriveLabelsV2betaUserCapabilities result = apiInstance.drivelabelsUsersGetCapabilities(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, customer, useAdminAccess, view);
