...
|------------ | ------------- | ------------- | -------------|
|**requests** | [**List&lt;GoogleAppsDriveLabelsV2betaUpdateLabelPermissionRequest&gt;**](GoogleAppsDriveLabelsV2betaUpdateLabelPermissionRequest.md) | Required. The request message specifying the resources to update. |  [optional] |
