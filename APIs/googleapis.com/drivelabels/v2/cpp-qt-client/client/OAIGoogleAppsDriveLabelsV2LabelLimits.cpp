...
OAIGoogleAppsDriveLabelsV2LabelLimits::OAIGoogleAppsDriveLabelsV2LabelLimits(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGoogleAppsDriveLabelsV2LabelLimits::OAIGoogleAppsDriveLabelsV2LabelLimits() {
    this->initializeModel();
}

OAIGoogleAppsDriveLabelsV2LabelLimits::~OAIGoogleAppsDriveLabelsV2LabelLimits() {}

void OAIGoogleAppsDriveLabelsV2LabelLimits::initializeModel() {
...
void OAIGoogleAppsDriveLabelsV2LabelLimits::fromJson(QString jsonString) {
...
void OAIGoogleAppsDriveLabelsV2LabelLimits::fromJsonObject(QJsonObject json) {
...
QString OAIGoogleAppsDriveLabelsV2LabelLimits::asJson() const {
...
QJsonObject OAIGoogleAppsDriveLabelsV2LabelLimits::asJsonObject() const {
    QJsonObject obj;
...
OAIGoogleAppsDriveLabelsV2FieldLimits OAIGoogleAppsDriveLabelsV2LabelLimits::getFieldLimits() const {
    return m_field_limits;
}
void OAIGoogleAppsDriveLabelsV2LabelLimits::setFieldLimits(const OAIGoogleAppsDriveLabelsV2FieldLimits &field_limits) {
    m_field_limits = field_limits;
    m_field_limits_isSet = true;
}

bool OAIGoogleAppsDriveLabelsV2LabelLimits::is_field_limits_Set() const{
    return m_field_limits_isSet;
}

bool OAIGoogleAppsDriveLabelsV2LabelLimits::is_field_limits_Valid() const{
    return m_field_limits_isValid;
}

qint32 OAIGoogleAppsDriveLabelsV2LabelLimits::getMaxDeletedFields() const {
    return m_max_deleted_fields;
}
void OAIGoogleAppsDriveLabelsV2LabelLimits::setMaxDeletedFields(const qint32 &max_deleted_fields) {
    m_max_deleted_fields = max_deleted_fields;
    m_max_deleted_fields_isSet = true;
}

bool OAIGoogleAppsDriveLabelsV2LabelLimits::is_max_deleted_fields_Set() const{
    return m_max_deleted_fields_isSet;
}

bool OAIGoogleAppsDriveLabelsV2LabelLimits::is_max_deleted_fields_Valid() const{
    return m_max_deleted_fields_isValid;
}

qint32 OAIGoogleAppsDriveLabelsV2LabelLimits::getMaxDescriptionLength() const {
    return m_max_description_length;
}
void OAIGoogleAppsDriveLabelsV2LabelLimits::setMaxDescriptionLength(const qint32 &max_description_length) {
    m_max_description_length = max_description_length;
    m_max_description_length_isSet = true;
}

bool OAIGoogleAppsDriveLabelsV2LabelLimits::is_max_description_length_Set() const{
    return m_max_description_length_isSet;
}

bool OAIGoogleAppsDriveLabelsV2LabelLimits::is_max_description_length_Valid() const{
    return m_max_description_length_isValid;
}

qint32 OAIGoogleAppsDriveLabelsV2LabelLimits::getMaxDraftRevisions() const {
    return m_max_draft_revisions;
}
void OAIGoogleAppsDriveLabelsV2LabelLimits::setMaxDraftRevisions(const qint32 &max_draft_revisions) {
    m_max_draft_revisions = max_draft_revisions;
    m_max_draft_revisions_isSet = true;
}

bool OAIGoogleAppsDriveLabelsV2LabelLimits::is_max_draft_revisions_Set() const{
    return m_max_draft_revisions_isSet;
}

bool OAIGoogleAppsDriveLabelsV2LabelLimits::is_max_draft_revisions_Valid() const{
    return m_max_draft_revisions_isValid;
}

qint32 OAIGoogleAppsDriveLabelsV2LabelLimits::getMaxFields() const {
    return m_max_fields;
}
void OAIGoogleAppsDriveLabelsV2LabelLimits::setMaxFields(const qint32 &max_fields) {
    m_max_fields = max_fields;
    m_max_fields_isSet = true;
}

bool OAIGoogleAppsDriveLabelsV2LabelLimits::is_max_fields_Set() const{
    return m_max_fields_isSet;
}

bool OAIGoogleAppsDriveLabelsV2LabelLimits::is_max_fields_Valid() const{
    return m_max_fields_isValid;
}

qint32 OAIGoogleAppsDriveLabelsV2LabelLimits::getMaxTitleLength() const {
    return m_max_title_length;
}
void OAIGoogleAppsDriveLabelsV2LabelLimits::setMaxTitleLength(const qint32 &max_title_length) {
    m_max_title_length = max_title_length;
    m_max_title_length_isSet = true;
}

bool OAIGoogleAppsDriveLabelsV2LabelLimits::is_max_title_length_Set() const{
    return m_max_title_length_isSet;
}

bool OAIGoogleAppsDriveLabelsV2LabelLimits::is_max_title_length_Valid() const{
    return m_max_title_length_isValid;
}

QString OAIGoogleAppsDriveLabelsV2LabelLimits::getName() const {
    return m_name;
}
void OAIGoogleAppsDriveLabelsV2LabelLimits::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIGoogleAppsDriveLabelsV2LabelLimits::is_name_Set() const{
    return m_name_isSet;
}

bool OAIGoogleAppsDriveLabelsV2LabelLimits::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIGoogleAppsDriveLabelsV2LabelLimits::isSet() const {
...
bool OAIGoogleAppsDriveLabelsV2LabelLimits::isValid() const {
