...
OAILimitsApi::OAILimitsApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAILimitsApi::~OAILimitsApi() {
}

void OAILimitsApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("drivelabels_limits_getLabel", defaultConf);
    _serverIndices.insert("drivelabels_limits_getLabel", 0);
}
...
*/
int OAILimitsApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAILimitsApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAILimitsApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAILimitsApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAILimitsApi::setUsername(const QString &username) {
    _username = username;
}

void OAILimitsApi::setPassword(const QString &password) {
    _password = password;
}


void OAILimitsApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAILimitsApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAILimitsApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAILimitsApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAILimitsApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAILimitsApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAILimitsApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAILimitsApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAILimitsApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAILimitsApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAILimitsApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAILimitsApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAILimitsApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAILimitsApi::drivelabels_limits_getLabel(const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<QString> &name) {
    QString fullPath = QString(_serverConfigs["drivelabels_limits_getLabel"][_serverIndices.value("drivelabels_limits_getLabel")].URL()+"/v2/limits/label");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAILimitsApi::drivelabels_limits_getLabelCallback);
    connect(this, &OAILimitsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAILimitsApi::drivelabels_limits_getLabelCallback);
    connect(this, &OAILimitsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
...
void OAILimitsApi::drivelabels_limits_getLabelCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIGoogleAppsDriveLabelsV2LabelLimits output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT drivelabels_limits_getLabelSignal(output);
        Q_EMIT drivelabels_limits_getLabelSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT drivelabels_limits_getLabelSignalE(output, error_type, error_str);
        Q_EMIT drivelabels_limits_getLabelSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT drivelabels_limits_getLabelSignalError(output, error_type, error_str);
        Q_EMIT drivelabels_limits_getLabelSignalErrorFull(worker, error_type, error_str);
    }
}

void OAILimitsApi::tokenAvailable(){
