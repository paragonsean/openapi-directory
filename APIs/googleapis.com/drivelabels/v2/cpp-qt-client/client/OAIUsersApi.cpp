...
void OAIUsersApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("drivelabels_users_getCapabilities", defaultConf);
    _serverIndices.insert("drivelabels_users_getCapabilities", 0);
}
...
void OAIUsersApi::drivelabels_users_getCapabilities(const QString &name, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<QString> &customer, const ::OpenAPI::OptionalParam<bool> &use_admin_access, const ::OpenAPI::OptionalParam<QString> &view) {
    QString fullPath = QString(_serverConfigs["drivelabels_users_getCapabilities"][_serverIndices.value("drivelabels_users_getCapabilities")].URL()+"/v2/{name}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIUsersApi::drivelabels_users_getCapabilitiesCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIUsersApi::drivelabels_users_getCapabilitiesCallback);
...
void OAIUsersApi::drivelabels_users_getCapabilitiesCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIGoogleAppsDriveLabelsV2UserCapabilities output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT drivelabels_users_getCapabilitiesSignal(output);
        Q_EMIT drivelabels_users_getCapabilitiesSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT drivelabels_users_getCapabilitiesSignalE(output, error_type, error_str);
        Q_EMIT drivelabels_users_getCapabilitiesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT drivelabels_users_getCapabilitiesSignalError(output, error_type, error_str);
        Q_EMIT drivelabels_users_getCapabilitiesSignalErrorFull(worker, error_type, error_str);
    }
}
