...
#ifndef OAIGoogleTypeDate_H
#define OAIGoogleTypeDate_H
...
class OAIGoogleTypeDate : public OAIObject {
public:
    OAIGoogleTypeDate();
    OAIGoogleTypeDate(QString json);
    ~OAIGoogleTypeDate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleTypeDate)

#endif // OAIGoogleTypeDate_H
