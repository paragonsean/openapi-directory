...
/**
 * The GoogleAppsDriveLabelsV2DisableLabelRequest model module.
 * @module model/GoogleAppsDriveLabelsV2DisableLabelRequest
 * @version v2
 */
class GoogleAppsDriveLabelsV2DisableLabelRequest {
    /**
     * Constructs a new <code>GoogleAppsDriveLabelsV2DisableLabelRequest</code>.
     * Request to deprecate a published Label.
     * @alias module:model/GoogleAppsDriveLabelsV2DisableLabelRequest
     */
    constructor() { 
        
        GoogleAppsDriveLabelsV2DisableLabelRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleAppsDriveLabelsV2DisableLabelRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleAppsDriveLabelsV2DisableLabelRequest} obj Optional instance to populate.
     * @return {module:model/GoogleAppsDriveLabelsV2DisableLabelRequest} The populated <code>GoogleAppsDriveLabelsV2DisableLabelRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleAppsDriveLabelsV2DisableLabelRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleAppsDriveLabelsV2DisableLabelRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleAppsDriveLabelsV2DisableLabelRequest</code>.
     */
 ...
 */
GoogleAppsDriveLabelsV2DisableLabelRequest.prototype['disabledPolicy'] = undefined;
 ...
 */
GoogleAppsDriveLabelsV2DisableLabelRequest.prototype['languageCode'] = undefined;
 ...
 */
GoogleAppsDriveLabelsV2DisableLabelRequest.prototype['updateMask'] = undefined;

/**
 * Set to `true` in order to use the user's admin credentials. The server will verify the user is an admin for the Label before allowing access.
 * @member {Boolean} useAdminAccess
 */
GoogleAppsDriveLabelsV2DisableLabelRequest.prototype['useAdminAccess'] = undefined;

/**
 * @member {module:model/GoogleAppsDriveLabelsV2WriteControl} writeControl
 */
GoogleAppsDriveLabelsV2DisableLabelRequest.prototype['writeControl'] = undefined;
...
export default GoogleAppsDriveLabelsV2DisableLabelRequest;
