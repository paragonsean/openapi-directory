...
> GoogleAppsDriveLabelsV2LabelLimits drivelabelsLimitsGetLabel(opts)
...
let apiInstance = new DriveLabelsApi.LimitsApi();
let opts = {
  ...
  'name': "name_example" // String | Required. Label revision resource name Must be: \"limits/label\"
};
apiInstance.drivelabelsLimitsGetLabel(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
