# DriveLabelsApi.GoogleAppsDriveLabelsV2Lifecycle
...
**state** | **String** | Output only. The state of the object associated with this lifecycle. | [optional] [readonly] 
...
* `UNPUBLISHED_DRAFT` (value: `"UNPUBLISHED_DRAFT"`)
