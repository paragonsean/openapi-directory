# DriveLabelsApi.GoogleAppsDriveLabelsV2BatchDeleteLabelPermissionsRequest

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**requests** | [**[GoogleAppsDriveLabelsV2DeleteLabelPermissionRequest]**](GoogleAppsDriveLabelsV2DeleteLabelPermissionRequest.md) | Required. The request message specifying the resources to update. | [optional] 
