# DriveLabelsApi.GoogleAppsDriveLabelsV2BatchUpdateLabelPermissionsRequest

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**requests** | [**[GoogleAppsDriveLabelsV2UpdateLabelPermissionRequest]**](GoogleAppsDriveLabelsV2UpdateLabelPermissionRequest.md) | Required. The request message specifying the resources to update. | [optional] 
