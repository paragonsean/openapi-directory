...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DriveLabelsApi.GoogleAppsDriveLabelsV2FieldSelectionOptionsChoice();
  });
  ...
  describe('GoogleAppsDriveLabelsV2FieldSelectionOptionsChoice', function() {
    it('should create an instance of GoogleAppsDriveLabelsV2FieldSelectionOptionsChoice', function() {
      // uncomment below and update the code to test GoogleAppsDriveLabelsV2FieldSelectionOptionsChoice
      //var instance = new DriveLabelsApi.GoogleAppsDriveLabelsV2FieldSelectionOptionsChoice();
      //expect(instance).to.be.a(DriveLabelsApi.GoogleAppsDriveLabelsV2FieldSelectionOptionsChoice);
    });
