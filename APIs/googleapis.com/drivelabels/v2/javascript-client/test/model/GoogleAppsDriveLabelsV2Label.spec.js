...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DriveLabelsApi.GoogleAppsDriveLabelsV2Label();
  });
  ...
  describe('GoogleAppsDriveLabelsV2Label', function() {
    it('should create an instance of GoogleAppsDriveLabelsV2Label', function() {
      // uncomment below and update the code to test GoogleAppsDriveLabelsV2Label
      //var instance = new DriveLabelsApi.GoogleAppsDriveLabelsV2Label();
      //expect(instance).to.be.a(DriveLabelsApi.GoogleAppsDriveLabelsV2Label);
    });
