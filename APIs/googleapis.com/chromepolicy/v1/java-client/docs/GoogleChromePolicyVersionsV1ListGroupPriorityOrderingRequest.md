...
|------------ | ------------- | ------------- | -------------|
|**policyNamespace** | **String** | The namespace of the policy type for the request. |  [optional] |
|**policySchema** | **String** | The schema name of the policy for the request. |  [optional] |
