...
/**
 * The GoogleChromePolicyVersionsV1ListGroupPriorityOrderingResponse model module.
 * @module model/GoogleChromePolicyVersionsV1ListGroupPriorityOrderingResponse
 * @version v1
 */
class GoogleChromePolicyVersionsV1ListGroupPriorityOrderingResponse {
    /**
     * Constructs a new <code>GoogleChromePolicyVersionsV1ListGroupPriorityOrderingResponse</code>.
     * Response message for listing the group priority ordering of an app.
     * @alias module:model/GoogleChromePolicyVersionsV1ListGroupPriorityOrderingResponse
     */
    constructor() { 
        
        GoogleChromePolicyVersionsV1ListGroupPriorityOrderingResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleChromePolicyVersionsV1ListGroupPriorityOrderingResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleChromePolicyVersionsV1ListGroupPriorityOrderingResponse} obj Optional instance to populate.
     * @return {module:model/GoogleChromePolicyVersionsV1ListGroupPriorityOrderingResponse} The populated <code>GoogleChromePolicyVersionsV1ListGroupPriorityOrderingResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleChromePolicyVersionsV1ListGroupPriorityOrderingResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleChromePolicyVersionsV1ListGroupPriorityOrderingResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleChromePolicyVersionsV1ListGroupPriorityOrderingResponse</code>.
     */
 ...
 */
GoogleChromePolicyVersionsV1ListGroupPriorityOrderingResponse.prototype['groupIds'] = undefined;

/**
 * Output only. The namespace of the policy type of the group IDs.
 * @member {String} policyNamespace
 */
GoogleChromePolicyVersionsV1ListGroupPriorityOrderingResponse.prototype['policyNamespace'] = undefined;

/**
 * Output only. The schema name of the policy for the group IDs.
 * @member {String} policySchema
 */
GoogleChromePolicyVersionsV1ListGroupPriorityOrderingResponse.prototype['policySchema'] = undefined;

/**
 * @member {module:model/GoogleChromePolicyVersionsV1PolicyTargetKey} policyTargetKey
 */
GoogleChromePolicyVersionsV1ListGroupPriorityOrderingResponse.prototype['policyTargetKey'] = undefined;
...
export default GoogleChromePolicyVersionsV1ListGroupPriorityOrderingResponse;
