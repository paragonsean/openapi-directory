...
> Object chromepolicyCustomersPoliciesGroupsBatchDelete(customer, opts)
...
let apiInstance = new ChromePolicyApi.CustomersApi();
let customer = "customer_example"; // String | ID of the Google Workspace account or literal \"my_customer\" for the customer associated to the request.
let opts = {
...
apiInstance.chromepolicyCustomersPoliciesGroupsBatchDelete(customer, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> Object chromepolicyCustomersPoliciesGroupsBatchModify(customer, opts)
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'googleChromePolicyVersionsV1BatchModifyGroupPoliciesRequest': new ChromePolicyApi.GoogleChromePolicyVersionsV1BatchModifyGroupPoliciesRequest() // GoogleChromePolicyVersionsV1BatchModifyGroupPoliciesRequest | 
};
apiInstance.chromepolicyCustomersPoliciesGroupsBatchModify(customer, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> GoogleChromePolicyVersionsV1ListGroupPriorityOrderingResponse chromepolicyCustomersPoliciesGroupsListGroupPriorityOrdering(customer, opts)
...
let apiInstance = new ChromePolicyApi.CustomersApi();
let customer = "customer_example"; // String | Required. ID of the Google Workspace account or literal \"my_customer\" for the customer associated to the request.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'googleChromePolicyVersionsV1ListGroupPriorityOrderingRequest': new ChromePolicyApi.GoogleChromePolicyVersionsV1ListGroupPriorityOrderingRequest() // GoogleChromePolicyVersionsV1ListGroupPriorityOrderingRequest | 
};
apiInstance.chromepolicyCustomersPoliciesGroupsListGroupPriorityOrdering(customer, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Object chromepolicyCustomersPoliciesGroupsUpdateGroupPriorityOrdering(customer, opts)
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'googleChromePolicyVersionsV1UpdateGroupPriorityOrderingRequest': new ChromePolicyApi.GoogleChromePolicyVersionsV1UpdateGroupPriorityOrderingRequest() // GoogleChromePolicyVersionsV1UpdateGroupPriorityOrderingRequest | 
};
apiInstance.chromepolicyCustomersPoliciesGroupsUpdateGroupPriorityOrdering(customer, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> GoogleChromePolicyVersionsV1DefineCertificateResponse chromepolicyCustomersPoliciesNetworksDefineCertificate(customer, opts)
...
let apiInstance = new ChromePolicyApi.CustomersApi();
let customer = "customer_example"; // String | Required. The customer for which the certificate will apply.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'googleChromePolicyVersionsV1DefineCertificateRequest': new ChromePolicyApi.GoogleChromePolicyVersionsV1DefineCertificateRequest() // GoogleChromePolicyVersionsV1DefineCertificateRequest | 
};
apiInstance.chromepolicyCustomersPoliciesNetworksDefineCertificate(customer, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> GoogleChromePolicyVersionsV1DefineNetworkResponse chromepolicyCustomersPoliciesNetworksDefineNetwork(customer, opts)
...
let apiInstance = new ChromePolicyApi.CustomersApi();
let customer = "customer_example"; // String | Required. The customer who will own this new network.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'googleChromePolicyVersionsV1DefineNetworkRequest': new ChromePolicyApi.GoogleChromePolicyVersionsV1DefineNetworkRequest() // GoogleChromePolicyVersionsV1DefineNetworkRequest | 
};
apiInstance.chromepolicyCustomersPoliciesNetworksDefineNetwork(customer, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Object chromepolicyCustomersPoliciesNetworksRemoveCertificate(customer, opts)
...
let apiInstance = new ChromePolicyApi.CustomersApi();
let customer = "customer_example"; // String | Required. The customer whose certificate will be removed.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'googleChromePolicyVersionsV1RemoveCertificateRequest': new ChromePolicyApi.GoogleChromePolicyVersionsV1RemoveCertificateRequest() // GoogleChromePolicyVersionsV1RemoveCertificateRequest | 
};
apiInstance.chromepolicyCustomersPoliciesNetworksRemoveCertificate(customer, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Object chromepolicyCustomersPoliciesNetworksRemoveNetwork(customer, opts)
...
let apiInstance = new ChromePolicyApi.CustomersApi();
let customer = "customer_example"; // String | Required. The customer whose network will be removed.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'googleChromePolicyVersionsV1RemoveNetworkRequest': new ChromePolicyApi.GoogleChromePolicyVersionsV1RemoveNetworkRequest() // GoogleChromePolicyVersionsV1RemoveNetworkRequest | 
};
apiInstance.chromepolicyCustomersPoliciesNetworksRemoveNetwork(customer, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Object chromepolicyCustomersPoliciesOrgunitsBatchInherit(customer, opts)
...
let apiInstance = new ChromePolicyApi.CustomersApi();
let customer = "customer_example"; // String | ID of the G Suite account or literal \"my_customer\" for the customer associated to the request.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'googleChromePolicyVersionsV1BatchInheritOrgUnitPoliciesRequest': new ChromePolicyApi.GoogleChromePolicyVersionsV1BatchInheritOrgUnitPoliciesRequest() // GoogleChromePolicyVersionsV1BatchInheritOrgUnitPoliciesRequest | 
};
apiInstance.chromepolicyCustomersPoliciesOrgunitsBatchInherit(customer, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Object chromepolicyCustomersPoliciesOrgunitsBatchModify(customer, opts)
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'googleChromePolicyVersionsV1BatchModifyOrgUnitPoliciesRequest': new ChromePolicyApi.GoogleChromePolicyVersionsV1BatchModifyOrgUnitPoliciesRequest() // GoogleChromePolicyVersionsV1BatchModifyOrgUnitPoliciesRequest | 
};
apiInstance.chromepolicyCustomersPoliciesOrgunitsBatchModify(customer, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> GoogleChromePolicyVersionsV1ResolveResponse chromepolicyCustomersPoliciesResolve(customer, opts)
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'googleChromePolicyVersionsV1ResolveRequest': new ChromePolicyApi.GoogleChromePolicyVersionsV1ResolveRequest() // GoogleChromePolicyVersionsV1ResolveRequest | 
};
apiInstance.chromepolicyCustomersPoliciesResolve(customer, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> GoogleChromePolicyVersionsV1PolicySchema chromepolicyCustomersPolicySchemasGet(name, opts)
...
let apiInstance = new ChromePolicyApi.CustomersApi();
let name = "name_example"; // String | Required. The policy schema resource name to query.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
apiInstance.chromepolicyCustomersPolicySchemasGet(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> GoogleChromePolicyVersionsV1ListPolicySchemasResponse chromepolicyCustomersPolicySchemasList(parent, opts)
...
let apiInstance = new ChromePolicyApi.CustomersApi();
let parent = "parent_example"; // String | Required. The customer for which the listing request will apply.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'filter': "filter_example", // String | The schema filter used to find a particular schema based on fields like its resource name, description and `additionalTargetKeyNames`.
  'pageSize': 56, // Number | The maximum number of policy schemas to return, defaults to 100 and has a maximum of 1000.
  'pageToken': "pageToken_example" // String | The page token used to retrieve a specific page of the listing request.
};
apiInstance.chromepolicyCustomersPolicySchemasList(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **pageSize** | **Number**| The maximum number of policy schemas to return, defaults to 100 and has a maximum of 1000. | [optional] 
