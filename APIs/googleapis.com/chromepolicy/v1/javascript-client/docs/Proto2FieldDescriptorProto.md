# ChromePolicyApi.Proto2FieldDescriptorProto
...
**oneofIndex** | **Number** | If set, gives the index of a oneof in the containing type&#39;s oneof_decl list. This field is a member of that oneof. | [optional] 
...
**type** | **String** | If type_name is set, this need not be set. If both this and type_name are set, this must be one of TYPE_ENUM, TYPE_MESSAGE or TYPE_GROUP. | [optional] 
...
* `OPTIONAL` (value: `"LABEL_OPTIONAL"`)

* `REPEATED` (value: `"LABEL_REPEATED"`)

* `REQUIRED` (value: `"LABEL_REQUIRED"`)
