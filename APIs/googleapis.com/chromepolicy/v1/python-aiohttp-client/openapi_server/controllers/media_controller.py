...
async def chromepolicy_media_upload(request: web.Request, customer, xgafv=None, access_token=None, alt=None, param_callback=None, fields=None, key=None, oauth_token=None, pretty_print=None, quota_user=None, upload_protocol=None, upload_type=None, body=None) -> web.Response:
    """chromepolicy_media_upload
    ...
    """
    body = GoogleChromePolicyVersionsV1UploadPolicyFileRequest.from_dict(body)
