...
/*
 * OAIGoogleChromePolicyVersionsV1UpdateGroupPriorityOrderingRequest.h
 *
 * Request message for updating the group priority ordering of an app.
 */

#ifndef OAIGoogleChromePolicyVersionsV1UpdateGroupPriorityOrderingRequest_H
#define OAIGoogleChromePolicyVersionsV1UpdateGroupPriorityOrderingRequest_H
...
class OAIGoogleChromePolicyVersionsV1UpdateGroupPriorityOrderingRequest : public OAIObject {
public:
    OAIGoogleChromePolicyVersionsV1UpdateGroupPriorityOrderingRequest();
    OAIGoogleChromePolicyVersionsV1UpdateGroupPriorityOrderingRequest(QString json);
    ~OAIGoogleChromePolicyVersionsV1UpdateGroupPriorityOrderingRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleChromePolicyVersionsV1UpdateGroupPriorityOrderingRequest)

#endif // OAIGoogleChromePolicyVersionsV1UpdateGroupPriorityOrderingRequest_H
