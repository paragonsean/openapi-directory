...
void OAIAuthorizationApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("dataportability_authorization_reset", defaultConf);
    _serverIndices.insert("dataportability_authorization_reset", 0);
}
...
void OAIAuthorizationApi::dataportability_authorization_reset(const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<OAIObject> &body) {
    QString fullPath = QString(_serverConfigs["dataportability_authorization_reset"][_serverIndices.value("dataportability_authorization_reset")].URL()+"/v1beta/authorization:reset");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAuthorizationApi::dataportability_authorization_resetCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAuthorizationApi::dataportability_authorization_resetCallback);
...
void OAIAuthorizationApi::dataportability_authorization_resetCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT dataportability_authorization_resetSignal(output);
        Q_EMIT dataportability_authorization_resetSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT dataportability_authorization_resetSignalE(output, error_type, error_str);
        Q_EMIT dataportability_authorization_resetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT dataportability_authorization_resetSignalError(output, error_type, error_str);
        Q_EMIT dataportability_authorization_resetSignalErrorFull(worker, error_type, error_str);
    }
}
