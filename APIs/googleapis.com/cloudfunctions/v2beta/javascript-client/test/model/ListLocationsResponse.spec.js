...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudFunctionsApi.ListLocationsResponse();
  });
  ...
  describe('ListLocationsResponse', function() {
    it('should create an instance of ListLocationsResponse', function() {
      ...
      //var instance = new CloudFunctionsApi.ListLocationsResponse();
      //expect(instance).to.be.a(CloudFunctionsApi.ListLocationsResponse);
    });
