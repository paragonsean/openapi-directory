...
------------- | ------------- | -------------
[**cloudfunctionsProjectsLocationsFunctionsAbortFunctionUpgrade**](ProjectsApi.md#cloudfunctionsProjectsLocationsFunctionsAbortFunctionUpgrade) | **POST** /v2beta/{name}:abortFunctionUpgrade | 
[**cloudfunctionsProjectsLocationsFunctionsCommitFunctionUpgrade**](ProjectsApi.md#cloudfunctionsProjectsLocationsFunctionsCommitFunctionUpgrade) | **POST** /v2beta/{name}:commitFunctionUpgrade | 
[**cloudfunctionsProjectsLocationsFunctionsCreate**](ProjectsApi.md#cloudfunctionsProjectsLocationsFunctionsCreate) | **POST** /v2beta/{parent}/functions | 
[**cloudfunctionsProjectsLocationsFunctionsDelete**](ProjectsApi.md#cloudfunctionsProjectsLocationsFunctionsDelete) | **DELETE** /v2beta/{name} | 
[**cloudfunctionsProjectsLocationsFunctionsGenerateDownloadUrl**](ProjectsApi.md#cloudfunctionsProjectsLocationsFunctionsGenerateDownloadUrl) | **POST** /v2beta/{name}:generateDownloadUrl | 
[**cloudfunctionsProjectsLocationsFunctionsGenerateUploadUrl**](ProjectsApi.md#cloudfunctionsProjectsLocationsFunctionsGenerateUploadUrl) | **POST** /v2beta/{parent}/functions:generateUploadUrl | 
[**cloudfunctionsProjectsLocationsFunctionsGetIamPolicy**](ProjectsApi.md#cloudfunctionsProjectsLocationsFunctionsGetIamPolicy) | **GET** /v2beta/{resource}:getIamPolicy | 
[**cloudfunctionsProjectsLocationsFunctionsList**](ProjectsApi.md#cloudfunctionsProjectsLocationsFunctionsList) | **GET** /v2beta/{parent}/functions | 
[**cloudfunctionsProjectsLocationsFunctionsPatch**](ProjectsApi.md#cloudfunctionsProjectsLocationsFunctionsPatch) | **PATCH** /v2beta/{name} | 
[**cloudfunctionsProjectsLocationsFunctionsRedirectFunctionUpgradeTraffic**](ProjectsApi.md#cloudfunctionsProjectsLocationsFunctionsRedirectFunctionUpgradeTraffic) | **POST** /v2beta/{name}:redirectFunctionUpgradeTraffic | 
[**cloudfunctionsProjectsLocationsFunctionsRollbackFunctionUpgradeTraffic**](ProjectsApi.md#cloudfunctionsProjectsLocationsFunctionsRollbackFunctionUpgradeTraffic) | **POST** /v2beta/{name}:rollbackFunctionUpgradeTraffic | 
[**cloudfunctionsProjectsLocationsFunctionsSetIamPolicy**](ProjectsApi.md#cloudfunctionsProjectsLocationsFunctionsSetIamPolicy) | **POST** /v2beta/{resource}:setIamPolicy | 
[**cloudfunctionsProjectsLocationsFunctionsSetupFunctionUpgradeConfig**](ProjectsApi.md#cloudfunctionsProjectsLocationsFunctionsSetupFunctionUpgradeConfig) | **POST** /v2beta/{name}:setupFunctionUpgradeConfig | 
[**cloudfunctionsProjectsLocationsFunctionsTestIamPermissions**](ProjectsApi.md#cloudfunctionsProjectsLocationsFunctionsTestIamPermissions) | **POST** /v2beta/{resource}:testIamPermissions | 
[**cloudfunctionsProjectsLocationsList**](ProjectsApi.md#cloudfunctionsProjectsLocationsList) | **GET** /v2beta/{name}/locations | 
[**cloudfunctionsProjectsLocationsOperationsGet**](ProjectsApi.md#cloudfunctionsProjectsLocationsOperationsGet) | **GET** /v2beta/{name} | 
[**cloudfunctionsProjectsLocationsOperationsList**](ProjectsApi.md#cloudfunctionsProjectsLocationsOperationsList) | **GET** /v2beta/{name}/operations | 
[**cloudfunctionsProjectsLocationsRuntimesList**](ProjectsApi.md#cloudfunctionsProjectsLocationsRuntimesList) | **GET** /v2beta/{parent}/runtimes | 
