...
import GoogleCloudFunctionsV2Stage from './GoogleCloudFunctionsV2Stage';

/**
 * The GoogleCloudFunctionsV2OperationMetadata model module.
 * @module model/GoogleCloudFunctionsV2OperationMetadata
 * @version v2beta
 */
class GoogleCloudFunctionsV2OperationMetadata {
    /**
     * Constructs a new <code>GoogleCloudFunctionsV2OperationMetadata</code>.
     * Represents the metadata of the long-running operation.
     * @alias module:model/GoogleCloudFunctionsV2OperationMetadata
     */
    constructor() { 
        
        GoogleCloudFunctionsV2OperationMetadata.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudFunctionsV2OperationMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudFunctionsV2OperationMetadata} obj Optional instance to populate.
     * @return {module:model/GoogleCloudFunctionsV2OperationMetadata} The populated <code>GoogleCloudFunctionsV2OperationMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudFunctionsV2OperationMetadata();
            ...
            if (data.hasOwnProperty('stages')) {
                obj['stages'] = ApiClient.convertToType(data['stages'], [GoogleCloudFunctionsV2Stage]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudFunctionsV2OperationMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudFunctionsV2OperationMetadata</code>.
     */
    static validateJSON(data) {
        ...
        if (data['stages']) { // data not null
            ...
            for (const item of data['stages']) {
                GoogleCloudFunctionsV2Stage.validateJSON(item);
            };
        }
        // ensure the json data is a string
 ...
 */
GoogleCloudFunctionsV2OperationMetadata.prototype['apiVersion'] = undefined;
 ...
 */
GoogleCloudFunctionsV2OperationMetadata.prototype['cancelRequested'] = undefined;

/**
 * The time the operation was created.
 * @member {String} createTime
 */
GoogleCloudFunctionsV2OperationMetadata.prototype['createTime'] = undefined;

/**
 * The time the operation finished running.
 * @member {String} endTime
 */
GoogleCloudFunctionsV2OperationMetadata.prototype['endTime'] = undefined;

/**
 * The operation type.
 * @member {module:model/GoogleCloudFunctionsV2OperationMetadata.OperationTypeEnum} operationType
 */
GoogleCloudFunctionsV2OperationMetadata.prototype['operationType'] = undefined;

/**
 * The original request that started the operation.
 * @member {Object.<String, Object>} requestResource
 */
GoogleCloudFunctionsV2OperationMetadata.prototype['requestResource'] = undefined;

/**
 * An identifier for Firebase function sources. Disclaimer: This field is only supported for Firebase function deployments.
 * @member {String} sourceToken
 */
GoogleCloudFunctionsV2OperationMetadata.prototype['sourceToken'] = undefined;

/**
 * Mechanism for reporting in-progress stages
 * @member {Array.<module:model/GoogleCloudFunctionsV2Stage>} stages
 */
GoogleCloudFunctionsV2OperationMetadata.prototype['stages'] = undefined;

/**
 * Human-readable status of the operation, if any.
 * @member {String} statusDetail
 */
GoogleCloudFunctionsV2OperationMetadata.prototype['statusDetail'] = undefined;

/**
 * Server-defined resource path for the target of the operation.
 * @member {String} target
 */
GoogleCloudFunctionsV2OperationMetadata.prototype['target'] = undefined;

/**
 * Name of the verb executed by the operation.
 * @member {String} verb
 */
GoogleCloudFunctionsV2OperationMetadata.prototype['verb'] = undefined;
 ...
 * @readonly
 */
GoogleCloudFunctionsV2OperationMetadata['OperationTypeEnum'] = {
...
export default GoogleCloudFunctionsV2OperationMetadata;
