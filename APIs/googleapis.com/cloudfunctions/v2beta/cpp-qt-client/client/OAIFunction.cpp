...
QList<OAIGoogleCloudFunctionsV2betaStateMessage> OAIFunction::getStateMessages() const {
    return m_state_messages;
}
void OAIFunction::setStateMessages(const QList<OAIGoogleCloudFunctionsV2betaStateMessage> &state_messages) {
