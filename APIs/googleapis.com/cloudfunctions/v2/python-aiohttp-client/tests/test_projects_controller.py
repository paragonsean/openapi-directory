...
async def test_cloudfunctions_projects_locations_functions_abort_function_upgrade(client):
    ...
    response = await client.request(
        method='POST',
        path='/v2/{nameabort_function_upgrad}'.format(name='name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_cloudfunctions_projects_locations_functions_commit_function_upgrade(client):
    ...
    response = await client.request(
        method='POST',
        path='/v2/{namecommit_function_upgrad}'.format(name='name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_cloudfunctions_projects_locations_functions_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v2/{parent}/functions'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_cloudfunctions_projects_locations_functions_generate_download_url(client):
    ...
    response = await client.request(
        method='POST',
        path='/v2/{namegenerate_download_ur}'.format(name='name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_cloudfunctions_projects_locations_functions_generate_upload_url(client):
    ...
    response = await client.request(
        method='POST',
        path='/v2/{parent}/functions:generateUploadUrl'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_cloudfunctions_projects_locations_functions_redirect_function_upgrade_traffic(client):
    ...
    response = await client.request(
        method='POST',
        path='/v2/{nameredirect_function_upgrade_traffi}'.format(name='name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_cloudfunctions_projects_locations_functions_rollback_function_upgrade_traffic(client):
    ...
    response = await client.request(
        method='POST',
        path='/v2/{namerollback_function_upgrade_traffi}'.format(name='name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_cloudfunctions_projects_locations_functions_setup_function_upgrade_config(client):
    ...
    response = await client.request(
        method='POST',
        path='/v2/{namesetup_function_upgrade_confi}'.format(name='name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_cloudfunctions_projects_locations_runtimes_list(client):
    ...
    response = await client.request(
        method='GET',
        path='/v2/{parent}/runtimes'.format(parent='parent_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
