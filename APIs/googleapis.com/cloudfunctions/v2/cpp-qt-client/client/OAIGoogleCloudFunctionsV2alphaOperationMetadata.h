...
/*
 * OAIGoogleCloudFunctionsV2alphaOperationMetadata.h
 *
 * Represents the metadata of the long-running operation.
 */

#ifndef OAIGoogleCloudFunctionsV2alphaOperationMetadata_H
#define OAIGoogleCloudFunctionsV2alphaOperationMetadata_H
...
namespace OpenAPI {
class OAIGoogleCloudFunctionsV2alphaStage;

class OAIGoogleCloudFunctionsV2alphaOperationMetadata : public OAIObject {
public:
    OAIGoogleCloudFunctionsV2alphaOperationMetadata();
    OAIGoogleCloudFunctionsV2alphaOperationMetadata(QString json);
    ~OAIGoogleCloudFunctionsV2alphaOperationMetadata() override;
    ...
    QList<OAIGoogleCloudFunctionsV2alphaStage> getStages() const;
    void setStages(const QList<OAIGoogleCloudFunctionsV2alphaStage> &stages);
...
private:
    ...
    QList<OAIGoogleCloudFunctionsV2alphaStage> m_stages;
    bool m_stages_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudFunctionsV2alphaOperationMetadata)

#endif // OAIGoogleCloudFunctionsV2alphaOperationMetadata_H
