...
QList<OAIGoogleCloudFunctionsV2StateMessage> OAIFunction::getStateMessages() const {
    return m_state_messages;
}
void OAIFunction::setStateMessages(const QList<OAIGoogleCloudFunctionsV2StateMessage> &state_messages) {
