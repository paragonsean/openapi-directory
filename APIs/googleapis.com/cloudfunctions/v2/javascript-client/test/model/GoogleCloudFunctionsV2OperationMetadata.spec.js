...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudFunctionsApi.GoogleCloudFunctionsV2OperationMetadata();
  });
  ...
  describe('GoogleCloudFunctionsV2OperationMetadata', function() {
    it('should create an instance of GoogleCloudFunctionsV2OperationMetadata', function() {
      // uncomment below and update the code to test GoogleCloudFunctionsV2OperationMetadata
      //var instance = new CloudFunctionsApi.GoogleCloudFunctionsV2OperationMetadata();
      //expect(instance).to.be.a(CloudFunctionsApi.GoogleCloudFunctionsV2OperationMetadata);
    });
