...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudFunctionsApi.GoogleCloudFunctionsV2betaOperationMetadata();
  });
  ...
  describe('GoogleCloudFunctionsV2betaOperationMetadata', function() {
    it('should create an instance of GoogleCloudFunctionsV2betaOperationMetadata', function() {
      // uncomment below and update the code to test GoogleCloudFunctionsV2betaOperationMetadata
      //var instance = new CloudFunctionsApi.GoogleCloudFunctionsV2betaOperationMetadata();
      //expect(instance).to.be.a(CloudFunctionsApi.GoogleCloudFunctionsV2betaOperationMetadata);
    });
