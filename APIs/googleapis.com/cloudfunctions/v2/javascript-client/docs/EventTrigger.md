...
**eventFilters** | [**[EventFilter]**](EventFilter.md) | Criteria used to filter events. | [optional] 
...
**retryPolicy** | **String** | Optional. If unset, then defaults to ignoring failures (i.e. not retrying them). | [optional] 
...
* `UNSPECIFIED` (value: `"RETRY_POLICY_UNSPECIFIED"`)

* `DO_NOT_RETRY` (value: `"RETRY_POLICY_DO_NOT_RETRY"`)

* `RETRY` (value: `"RETRY_POLICY_RETRY"`)
