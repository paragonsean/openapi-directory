...
public:
    ...
    QList<OAICloudFunction> getFunctions() const;
    void setFunctions(const QList<OAICloudFunction> &functions);
...
private:
    ...
    QList<OAICloudFunction> m_functions;
