...
|------------- | ------------- | -------------|
| [**cloudfunctionsOperationsList**](OperationsApi.md#cloudfunctionsOperationsList) | **GET** /v1/operations |  |


<a id="cloudfunctionsOperationsList"></a>
# **cloudfunctionsOperationsList**
> ListOperationsResponse cloudfunctionsOperationsList($xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, filter, name, pageSize, pageToken)
