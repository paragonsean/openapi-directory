...
> CallFunctionResponse cloudfunctionsProjectsLocationsFunctionsCall(name, opts)
...
let name = "name_example"; // String | Required. The name of the function to be called.
let opts = {
  ...
  'callFunctionRequest': new CloudFunctionsApi.CallFunctionRequest() // CallFunctionRequest | 
};
apiInstance.cloudfunctionsProjectsLocationsFunctionsCall(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> Operation cloudfunctionsProjectsLocationsFunctionsCreate(location, opts)
...
let apiInstance = new CloudFunctionsApi.ProjectsApi();
let location = "location_example"; // String | Required. The project and location in which the function should be created, specified in the format `projects/_*_/locations/_*`
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'cloudFunction': new CloudFunctionsApi.CloudFunction() // CloudFunction | 
};
apiInstance.cloudfunctionsProjectsLocationsFunctionsCreate(location, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new CloudFunctionsApi.ProjectsApi();
let name = "name_example"; // String | The name of function for which source code Google Cloud Storage signed URL should be generated.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'generateDownloadUrlRequest': new CloudFunctionsApi.GenerateDownloadUrlRequest() // GenerateDownloadUrlRequest | 
};
...
let apiInstance = new CloudFunctionsApi.ProjectsApi();
let parent = "parent_example"; // String | The project and location in which the Google Cloud Storage signed URL should be generated, specified in the format `projects/_*_/locations/_*`.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
> CloudFunction cloudfunctionsProjectsLocationsFunctionsGet(name, opts)
...
let apiInstance = new CloudFunctionsApi.ProjectsApi();
let name = "name_example"; // String | Required. The name of the function which details should be obtained.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'updateMask': "updateMask_example", // String | Required. The list of fields in `CloudFunction` that have to be updated.
  'cloudFunction': new CloudFunctionsApi.CloudFunction() // CloudFunction | 
};
