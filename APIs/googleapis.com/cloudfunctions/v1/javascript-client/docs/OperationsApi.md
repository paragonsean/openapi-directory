# CloudFunctionsApi.OperationsApi
...
> ListOperationsResponse cloudfunctionsOperationsList(opts)
...
let apiInstance = new CloudFunctionsApi.OperationsApi();
let opts = {
...
apiInstance.cloudfunctionsOperationsList(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
