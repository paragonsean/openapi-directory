...
export default class OperationsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the cloudfunctionsOperationsList operation.
     * @callback module:api/OperationsApi~cloudfunctionsOperationsListCallback
     ...
     * @param {module:api/OperationsApi~cloudfunctionsOperationsListCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ListOperationsResponse}
     */
    cloudfunctionsOperationsList(opts, callback) {
      opts = opts || {};
      let postBody = null;
