...
async def test_cloudfunctions_projects_locations_functions_abort_function_upgrade(client):
    ...
    response = await client.request(
        method='POST',
        path='/v2alpha/{nameabort_function_upgrad}'.format(name='name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_cloudfunctions_projects_locations_functions_commit_function_upgrade(client):
    ...
    response = await client.request(
        method='POST',
        path='/v2alpha/{namecommit_function_upgrad}'.format(name='name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_cloudfunctions_projects_locations_functions_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v2alpha/{parent}/functions'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_cloudfunctions_projects_locations_functions_generate_download_url(client):
    ...
    response = await client.request(
        method='POST',
        path='/v2alpha/{namegenerate_download_ur}'.format(name='name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_cloudfunctions_projects_locations_functions_generate_upload_url(client):
    ...
    response = await client.request(
        method='POST',
        path='/v2alpha/{parent}/functions:generateUploadUrl'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_cloudfunctions_projects_locations_functions_get_iam_policy(client):
    ...
    response = await client.request(
        method='GET',
        path='/v2alpha/{resourceget_iam_polic}'.format(resource='resource_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_cloudfunctions_projects_locations_functions_redirect_function_upgrade_traffic(client):
    ...
    response = await client.request(
        method='POST',
        path='/v2alpha/{nameredirect_function_upgrade_traffi}'.format(name='name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_cloudfunctions_projects_locations_functions_rollback_function_upgrade_traffic(client):
    ...
    response = await client.request(
        method='POST',
        path='/v2alpha/{namerollback_function_upgrade_traffi}'.format(name='name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_cloudfunctions_projects_locations_functions_set_iam_policy(client):
    ...
    response = await client.request(
        method='POST',
        path='/v2alpha/{resourceset_iam_polic}'.format(resource='resource_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_cloudfunctions_projects_locations_functions_setup_function_upgrade_config(client):
    ...
    response = await client.request(
        method='POST',
        path='/v2alpha/{namesetup_function_upgrade_confi}'.format(name='name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_cloudfunctions_projects_locations_functions_test_iam_permissions(client):
    ...
    response = await client.request(
        method='POST',
        path='/v2alpha/{resourcetest_iam_permission}'.format(resource='resource_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_cloudfunctions_projects_locations_runtimes_list(client):
    ...
    response = await client.request(
        method='GET',
        path='/v2alpha/{parent}/runtimes'.format(parent='parent_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
