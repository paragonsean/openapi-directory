...
/*
 * OAIGoogleCloudFunctionsV2OperationMetadata.h
 *
 * Represents the metadata of the long-running operation.
 */

#ifndef OAIGoogleCloudFunctionsV2OperationMetadata_H
#define OAIGoogleCloudFunctionsV2OperationMetadata_H
...
namespace OpenAPI {
class OAIGoogleCloudFunctionsV2Stage;

class OAIGoogleCloudFunctionsV2OperationMetadata : public OAIObject {
public:
    OAIGoogleCloudFunctionsV2OperationMetadata();
    OAIGoogleCloudFunctionsV2OperationMetadata(QString json);
    ~OAIGoogleCloudFunctionsV2OperationMetadata() override;
    ...
    QList<OAIGoogleCloudFunctionsV2Stage> getStages() const;
    void setStages(const QList<OAIGoogleCloudFunctionsV2Stage> &stages);
...
private:
    ...
    QList<OAIGoogleCloudFunctionsV2Stage> m_stages;
    bool m_stages_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudFunctionsV2OperationMetadata)

#endif // OAIGoogleCloudFunctionsV2OperationMetadata_H
