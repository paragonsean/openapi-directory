...
/*
 * OAIReportStatusRequest.h
 *
 * Request report the connector status.
 */

#ifndef OAIReportStatusRequest_H
#define OAIReportStatusRequest_H
...
class OAIReportStatusRequest : public OAIObject {
public:
    OAIReportStatusRequest();
    OAIReportStatusRequest(QString json);
    ~OAIReportStatusRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReportStatusRequest)

#endif // OAIReportStatusRequest_H
