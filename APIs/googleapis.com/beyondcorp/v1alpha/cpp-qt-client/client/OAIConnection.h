...
public:
    ...
    OAIApplicationEndpoint getApplicationEndpoint() const;
    void setApplicationEndpoint(const OAIApplicationEndpoint &application_endpoint);
    ...
    OAIGateway getGateway() const;
    void setGateway(const OAIGateway &gateway);
...
private:
    ...
    OAIApplicationEndpoint m_application_endpoint;
