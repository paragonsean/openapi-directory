...
public:
    ...
    OAIPrincipalInfo getPrincipalInfo() const;
    void setPrincipalInfo(const OAIPrincipalInfo &principal_info);
...
private:
    ...
    OAIPrincipalInfo m_principal_info;
