...
public class ResourceInfo {
  ...
  private List<ResourceInfo> sub = new ArrayList<>();
  ...
  public ResourceInfo resource(Map<String, Object> resource) {
    this.resource = resource;
    return this;
  }

  public ResourceInfo putResourceItem(String key, Object resourceItem) {
  ...
  public ResourceInfo status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public ResourceInfo sub(List<ResourceInfo> sub) {
    this.sub = sub;
    return this;
  }

  public ResourceInfo addSubItem(ResourceInfo subItem) {
    if (this.sub == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<ResourceInfo> getSub() {
    return sub;
  }

  public void setSub(List<ResourceInfo> sub) {
    this.sub = sub;
  }


  public ResourceInfo time(String time) {
    this.time = time;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, resourceInfo.id) &&
        Objects.equals(this.resource, resourceInfo.resource) &&
        Objects.equals(this.status, resourceInfo.status) &&
        Objects.equals(this.sub, resourceInfo.sub) &&
        Objects.equals(this.time, resourceInfo.time);
  }
      ...
      if (jsonObj.get("sub") != null && !jsonObj.get("sub").isJsonNull()) {
        ...
        if (jsonArraysub != null) {
          ...
          for (int i = 0; i < jsonArraysub.size(); i++) {
            ResourceInfo.validateJsonElement(jsonArraysub.get(i));
          };
        }
      }
