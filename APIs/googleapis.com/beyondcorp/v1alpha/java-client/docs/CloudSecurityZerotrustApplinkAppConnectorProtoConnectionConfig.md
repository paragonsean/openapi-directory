...
|**tunnelsPerGateway** | **Integer** | tunnels_per_gateway reflects the number of tunnels between a connector and a gateway. |  [optional] |
|**userPort** | **Integer** | user_port specifies the reserved port on gateways for user connections. |  [optional] |
