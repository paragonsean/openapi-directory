# BeyondCorpApi.CloudSecurityZerotrustApplinkAppConnectorProtoGateway
...
**port** | **Number** | port specifies the port of the gateway for tunnel connections from the connectors. | [optional] 
