...
|------------ | ------------- | ------------- | -------------|
|**accountStatus** | [**AccountStatusEnum**](#AccountStatusEnum) | Output only. Account status, for example, Enabled, Paused, Removed, etc. |  [optional] [readonly] |
|**accountType** | [**AccountTypeEnum**](#AccountTypeEnum) | Output only. Engine account type, for example, Google Ads, Microsoft Advertising, Yahoo Japan, Baidu, Facebook, Engine Track, etc. |  [optional] [readonly] |
...
|**status** | [**StatusEnum**](#StatusEnum) | Output only. The status of the customer. |  [optional] [readonly] |
