...
|**callConversionReportingState** | [**CallConversionReportingStateEnum**](#CallConversionReportingStateEnum) | Output only. Indicates whether this CallAsset should use its own call conversion setting, follow the account level setting, or disable call conversion. |  [optional] [readonly] |
