...
|------------ | ------------- | ------------- | -------------|
|**appliedLabels** | **List&lt;String&gt;** | Output only. The resource names of the labels owned by the requesting customer that are applied to the client customer. Label resource names have the form: &#x60;customers/{customer_id}/labels/{label_id}&#x60; |  [optional] [readonly] |
...
|**status** | [**StatusEnum**](#StatusEnum) | Output only. The status of the client customer. Read only. |  [optional] [readonly] |
