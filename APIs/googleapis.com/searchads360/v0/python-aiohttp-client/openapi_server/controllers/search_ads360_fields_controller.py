...
async def searchads360_search_ads360_fields_get(request: web.Request, resource_name, xgafv=None, access_token=None, alt=None, param_callback=None, fields=None, key=None, oauth_token=None, pretty_print=None, quota_user=None, upload_protocol=None, upload_type=None) -> web.Response:
...
async def searchads360_search_ads360_fields_search(request: web.Request, xgafv=None, access_token=None, alt=None, param_callback=None, fields=None, key=None, oauth_token=None, pretty_print=None, quota_user=None, upload_protocol=None, upload_type=None, body=None) -> web.Response:
    ...
    """
    body = GoogleAdsSearchads360V0ServicesSearchSearchAds360FieldsRequest.from_dict(body)
    return web.Response(status=200)
