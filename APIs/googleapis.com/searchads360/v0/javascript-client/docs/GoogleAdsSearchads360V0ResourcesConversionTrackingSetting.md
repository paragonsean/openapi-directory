# SearchAds360ReportingApi.GoogleAdsSearchads360V0ResourcesConversionTrackingSetting
...
* `NOT_CONVERSION_TRACKED` (value: `"NOT_CONVERSION_TRACKED"`)

* `CONVERSION_TRACKING_MANAGED_BY_SELF` (value: `"CONVERSION_TRACKING_MANAGED_BY_SELF"`)

* `CONVERSION_TRACKING_MANAGED_BY_THIS_MANAGER` (value: `"CONVERSION_TRACKING_MANAGED_BY_THIS_MANAGER"`)

* `CONVERSION_TRACKING_MANAGED_BY_ANOTHER_MANAGER` (value: `"CONVERSION_TRACKING_MANAGED_BY_ANOTHER_MANAGER"`)
