# SearchAds360ReportingApi.SearchAds360FieldsApi
...
> GoogleAdsSearchads360V0ResourcesSearchAds360Field searchads360SearchAds360FieldsGet(resourceName, opts)
...
```javascript
import SearchAds360ReportingApi from 'search_ads_360_reporting_api';
let defaultClient = SearchAds360ReportingApi.ApiClient.instance;
...
let apiInstance = new SearchAds360ReportingApi.SearchAds360FieldsApi();
let resourceName = "resourceName_example"; // String | Required. The resource name of the field to get.
let opts = {
...
apiInstance.searchads360SearchAds360FieldsGet(resourceName, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> GoogleAdsSearchads360V0ServicesSearchSearchAds360FieldsResponse searchads360SearchAds360FieldsSearch(opts)
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'googleAdsSearchads360V0ServicesSearchSearchAds360FieldsRequest': new SearchAds360ReportingApi.GoogleAdsSearchads360V0ServicesSearchSearchAds360FieldsRequest() // GoogleAdsSearchads360V0ServicesSearchSearchAds360FieldsRequest | 
};
apiInstance.searchads360SearchAds360FieldsSearch(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
