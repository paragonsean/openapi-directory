...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SearchAds360ReportingApi.GoogleAdsSearchads360V0ResourcesCampaignCriterion();
  });
  ...
  describe('GoogleAdsSearchads360V0ResourcesCampaignCriterion', function() {
    it('should create an instance of GoogleAdsSearchads360V0ResourcesCampaignCriterion', function() {
      // uncomment below and update the code to test GoogleAdsSearchads360V0ResourcesCampaignCriterion
      //var instance = new SearchAds360ReportingApi.GoogleAdsSearchads360V0ResourcesCampaignCriterion();
      //expect(instance).to.be.a(SearchAds360ReportingApi.GoogleAdsSearchads360V0ResourcesCampaignCriterion);
    });
    ...
    it('should have the property locationGroup (base name: "locationGroup")', function() {
      // uncomment below and update the code to test the property locationGroup
      //var instance = new SearchAds360ReportingApi.GoogleAdsSearchads360V0ResourcesCampaignCriterion();
      //expect(instance).to.be();
    });
