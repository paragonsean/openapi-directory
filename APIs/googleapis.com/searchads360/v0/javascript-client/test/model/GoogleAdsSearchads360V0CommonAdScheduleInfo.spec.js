...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SearchAds360ReportingApi.GoogleAdsSearchads360V0CommonAdScheduleInfo();
  });
  ...
  describe('GoogleAdsSearchads360V0CommonAdScheduleInfo', function() {
    it('should create an instance of GoogleAdsSearchads360V0CommonAdScheduleInfo', function() {
      // uncomment below and update the code to test GoogleAdsSearchads360V0CommonAdScheduleInfo
      //var instance = new SearchAds360ReportingApi.GoogleAdsSearchads360V0CommonAdScheduleInfo();
      //expect(instance).to.be.a(SearchAds360ReportingApi.GoogleAdsSearchads360V0CommonAdScheduleInfo);
    });
