...
OAITiersApi::OAITiersApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAITiersApi::~OAITiersApi() {
}

void OAITiersApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("sql_tiers_list", defaultConf);
    _serverIndices.insert("sql_tiers_list", 0);
}
...
*/
int OAITiersApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAITiersApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAITiersApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAITiersApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAITiersApi::setUsername(const QString &username) {
    _username = username;
}

void OAITiersApi::setPassword(const QString &password) {
    _password = password;
}


void OAITiersApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAITiersApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAITiersApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAITiersApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITiersApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAITiersApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAITiersApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAITiersApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAITiersApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAITiersApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAITiersApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAITiersApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAITiersApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAITiersApi::sql_tiers_list(const QString &project, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type) {
    QString fullPath = QString(_serverConfigs["sql_tiers_list"][_serverIndices.value("sql_tiers_list")].URL()+"/sql/v1beta4/projects/{project}/tiers");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITiersApi::sql_tiers_listCallback);
    connect(this, &OAITiersApi::abortRequestsSignal, worker, &QObject::deleteLater);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITiersApi::sql_tiers_listCallback);
    connect(this, &OAITiersApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
...
void OAITiersApi::sql_tiers_listCallback(OAIHttpRequestWorker *worker) {
    ...
    OAITiersListResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT sql_tiers_listSignal(output);
        Q_EMIT sql_tiers_listSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT sql_tiers_listSignalE(output, error_type, error_str);
        Q_EMIT sql_tiers_listSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT sql_tiers_listSignalError(output, error_type, error_str);
        Q_EMIT sql_tiers_listSignalErrorFull(worker, error_type, error_str);
    }
}

void OAITiersApi::tokenAvailable(){
