...
QString OAIOperationError::getKind() const {
    return m_kind;
}
void OAIOperationError::setKind(const QString &kind) {
    m_kind = kind;
    m_kind_isSet = true;
}

bool OAIOperationError::is_kind_Set() const{
    return m_kind_isSet;
}

bool OAIOperationError::is_kind_Valid() const{
