...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudSqlAdminApi.Tier();
  });
  ...
  describe('Tier', function() {
    it('should create an instance of Tier', function() {
      ...
      //var instance = new CloudSqlAdminApi.Tier();
      //expect(instance).to.be.a(CloudSqlAdminApi.Tier);
    });

    it('should have the property diskQuota (base name: "DiskQuota")', function() {
      // uncomment below and update the code to test the property diskQuota
      //var instance = new CloudSqlAdminApi.Tier();
