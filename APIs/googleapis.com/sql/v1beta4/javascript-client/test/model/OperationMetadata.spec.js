...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudSqlAdminApi.OperationMetadata();
  });
  ...
  describe('OperationMetadata', function() {
    it('should create an instance of OperationMetadata', function() {
      ...
      //var instance = new CloudSqlAdminApi.OperationMetadata();
      //expect(instance).to.be.a(CloudSqlAdminApi.OperationMetadata);
    });
