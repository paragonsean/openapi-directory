# CloudSqlAdminApi.BackupRunsListResponse

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**items** | [**[BackupRun]**](BackupRun.md) | A list of backup runs in reverse chronological order of the enqueued time. | [optional] 
