...
public class ApiClient {
    ...
    private String basePath = "https://sqladmin.googleapis.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/v1beta4/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://sqladmin.googleapis.com
