...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ReplicaPool.NewDiskInitializeParams();
  });
  ...
  describe('NewDiskInitializeParams', function() {
    it('should create an instance of NewDiskInitializeParams', function() {
      // uncomment below and update the code to test NewDiskInitializeParams
      //var instance = new ReplicaPool.NewDiskInitializeParams();
      //expect(instance).to.be.a(ReplicaPool.NewDiskInitializeParams);
    });
