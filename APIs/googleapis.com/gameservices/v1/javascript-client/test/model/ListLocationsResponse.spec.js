...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GameServicesApi.ListLocationsResponse();
  });
  ...
  describe('ListLocationsResponse', function() {
    it('should create an instance of ListLocationsResponse', function() {
      ...
      //var instance = new GameServicesApi.ListLocationsResponse();
      //expect(instance).to.be.a(GameServicesApi.ListLocationsResponse);
    });
