...
------------- | ------------- | -------------
[**gameservicesProjectsLocationsGameServerDeploymentsGetIamPolicy**](ProjectsApi.md#gameservicesProjectsLocationsGameServerDeploymentsGetIamPolicy) | **GET** /v1beta/{resource}:getIamPolicy | 
[**gameservicesProjectsLocationsGameServerDeploymentsSetIamPolicy**](ProjectsApi.md#gameservicesProjectsLocationsGameServerDeploymentsSetIamPolicy) | **POST** /v1beta/{resource}:setIamPolicy | 
[**gameservicesProjectsLocationsGameServerDeploymentsTestIamPermissions**](ProjectsApi.md#gameservicesProjectsLocationsGameServerDeploymentsTestIamPermissions) | **POST** /v1beta/{resource}:testIamPermissions | 
[**gameservicesProjectsLocationsList**](ProjectsApi.md#gameservicesProjectsLocationsList) | **GET** /v1beta/{name}/locations | 
[**gameservicesProjectsLocationsOperationsCancel**](ProjectsApi.md#gameservicesProjectsLocationsOperationsCancel) | **POST** /v1beta/{name}:cancel | 
[**gameservicesProjectsLocationsOperationsDelete**](ProjectsApi.md#gameservicesProjectsLocationsOperationsDelete) | **DELETE** /v1beta/{name} | 
[**gameservicesProjectsLocationsOperationsGet**](ProjectsApi.md#gameservicesProjectsLocationsOperationsGet) | **GET** /v1beta/{name} | 
[**gameservicesProjectsLocationsOperationsList**](ProjectsApi.md#gameservicesProjectsLocationsOperationsList) | **GET** /v1beta/{name}/operations | 
