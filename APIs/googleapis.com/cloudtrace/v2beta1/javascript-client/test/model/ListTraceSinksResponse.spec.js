...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudTraceApi.ListTraceSinksResponse();
  });
  ...
  describe('ListTraceSinksResponse', function() {
    it('should create an instance of ListTraceSinksResponse', function() {
      // uncomment below and update the code to test ListTraceSinksResponse
      //var instance = new CloudTraceApi.ListTraceSinksResponse();
      //expect(instance).to.be.a(CloudTraceApi.ListTraceSinksResponse);
    });
