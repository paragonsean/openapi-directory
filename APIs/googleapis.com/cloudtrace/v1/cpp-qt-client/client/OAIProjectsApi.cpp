...
void OAIProjectsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("cloudtrace_projects_patchTraces", defaultConf);
    _serverIndices.insert("cloudtrace_projects_patchTraces", 0);
    _serverConfigs.insert("cloudtrace_projects_traces_get", defaultConf);
    _serverIndices.insert("cloudtrace_projects_traces_get", 0);
    _serverConfigs.insert("cloudtrace_projects_traces_list", defaultConf);
    _serverIndices.insert("cloudtrace_projects_traces_list", 0);
}
...
void OAIProjectsApi::cloudtrace_projects_patchTraces(const QString &project_id, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<OAITraces> &oai_traces) {
    ...
    if (oai_traces.hasValue()){

        
        QByteArray output = oai_traces.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::cloudtrace_projects_patchTracesCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::cloudtrace_projects_patchTracesCallback);
...
void OAIProjectsApi::cloudtrace_projects_patchTracesCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT cloudtrace_projects_patchTracesSignal(output);
        Q_EMIT cloudtrace_projects_patchTracesSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT cloudtrace_projects_patchTracesSignalE(output, error_type, error_str);
        Q_EMIT cloudtrace_projects_patchTracesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT cloudtrace_projects_patchTracesSignalError(output, error_type, error_str);
        Q_EMIT cloudtrace_projects_patchTracesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectsApi::cloudtrace_projects_traces_get(const QString &project_id, const QString &trace_id, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type) {
    QString fullPath = QString(_serverConfigs["cloudtrace_projects_traces_get"][_serverIndices.value("cloudtrace_projects_traces_get")].URL()+"/v1/projects/{projectId}/traces/{traceId}");
    ...
    {
        QString trace_idPathParam("{");
        trace_idPathParam.append("traceId").append("}");
        QString pathPrefix, pathSuffix, pathDelimiter;
        QString pathStyle = "simple";
        if (pathStyle == "")
            pathStyle = "simple";
        pathPrefix = getParamStylePrefix(pathStyle);
        pathSuffix = getParamStyleSuffix(pathStyle);
        pathDelimiter = getParamStyleDelimiter(pathStyle, "traceId", false);
        QString paramString = (pathStyle == "matrix") ? pathPrefix+"traceId"+pathSuffix : pathPrefix;
        fullPath.replace(trace_idPathParam, paramString+QUrl::toPercentEncoding(::OpenAPI::toStringValue(trace_id)));
    }
    QString queryPrefix, querySuffix, queryDelimiter, queryStyle;
    if (_xgafv.hasValue())
    {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::cloudtrace_projects_traces_getCallback);
    connect(this, &OAIProjectsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::cloudtrace_projects_traces_getCallback);
    connect(this, &OAIProjectsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectsApi::cloudtrace_projects_traces_getCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAITrace output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT cloudtrace_projects_traces_getSignal(output);
        Q_EMIT cloudtrace_projects_traces_getSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        QString scopeStr = scope.join(" ");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT cloudtrace_projects_traces_getSignalE(output, error_type, error_str);
        Q_EMIT cloudtrace_projects_traces_getSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT cloudtrace_projects_traces_getSignalError(output, error_type, error_str);
        Q_EMIT cloudtrace_projects_traces_getSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectsApi::cloudtrace_projects_traces_list(const QString &project_id, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<QString> &end_time, const ::OpenAPI::OptionalParam<QString> &filter, const ::OpenAPI::OptionalParam<QString> &order_by, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &page_token, const ::OpenAPI::OptionalParam<QString> &start_time, const ::OpenAPI::OptionalParam<QString> &view) {
    QString fullPath = QString(_serverConfigs["cloudtrace_projects_traces_list"][_serverIndices.value("cloudtrace_projects_traces_list")].URL()+"/v1/projects/{projectId}/traces");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::cloudtrace_projects_traces_listCallback);
    connect(this, &OAIProjectsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::cloudtrace_projects_traces_listCallback);
    connect(this, &OAIProjectsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectsApi::cloudtrace_projects_traces_listCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIListTracesResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT cloudtrace_projects_traces_listSignal(output);
        Q_EMIT cloudtrace_projects_traces_listSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        QString scopeStr = scope.join(" ");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT cloudtrace_projects_traces_listSignalE(output, error_type, error_str);
        Q_EMIT cloudtrace_projects_traces_listSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT cloudtrace_projects_traces_listSignalError(output, error_type, error_str);
        Q_EMIT cloudtrace_projects_traces_listSignalErrorFull(worker, error_type, error_str);
    }
}
