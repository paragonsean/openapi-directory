...
> Object cloudtraceProjectsPatchTraces(projectId, opts)
...
let projectId = "projectId_example"; // String | Required. ID of the Cloud project where the trace data is stored.
let opts = {
...
apiInstance.cloudtraceProjectsPatchTraces(projectId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> Trace cloudtraceProjectsTracesGet(projectId, traceId, opts)
...
let apiInstance = new CloudTraceApi.ProjectsApi();
let projectId = "projectId_example"; // String | Required. ID of the Cloud project where the trace data is stored.
let traceId = "traceId_example"; // String | Required. ID of the trace to return.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
apiInstance.cloudtraceProjectsTracesGet(projectId, traceId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ListTracesResponse cloudtraceProjectsTracesList(projectId, opts)
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'endTime': "endTime_example", // String | End of the time interval (inclusive) during which the trace data was collected from the application.
  ...
  'pageSize': 56, // Number | Optional. Maximum number of traces to return. If not specified or <= 0, the implementation selects a reasonable value. The implementation may return fewer traces than the requested page size.
  'pageToken': "pageToken_example", // String | Token identifying the page of results to return. If provided, use the value of the `next_page_token` field from a previous request.
  'startTime': "startTime_example", // String | Start of the time interval (inclusive) during which the trace data was collected from the application.
  'view': "view_example" // String | Optional. Type of data returned for traces in the list. Default is `MINIMAL`.
};
apiInstance.cloudtraceProjectsTracesList(projectId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **pageSize** | **Number**| Optional. Maximum number of traces to return. If not specified or &lt;&#x3D; 0, the implementation selects a reasonable value. The implementation may return fewer traces than the requested page size. | [optional] 
 ...
 **view** | **String**| Optional. Type of data returned for traces in the list. Default is &#x60;MINIMAL&#x60;. | [optional] 
