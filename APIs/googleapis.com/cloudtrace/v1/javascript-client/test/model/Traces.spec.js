...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudTraceApi.Traces();
  });
  ...
  describe('Traces', function() {
    it('should create an instance of Traces', function() {
      // uncomment below and update the code to test Traces
      //var instance = new CloudTraceApi.Traces();
      //expect(instance).to.be.a(CloudTraceApi.Traces);
    });
