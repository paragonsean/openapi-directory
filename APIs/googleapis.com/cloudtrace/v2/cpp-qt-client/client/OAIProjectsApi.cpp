...
void OAIProjectsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("cloudtrace_projects_traces_batchWrite", defaultConf);
    _serverIndices.insert("cloudtrace_projects_traces_batchWrite", 0);
    _serverConfigs.insert("cloudtrace_projects_traces_spans_createSpan", defaultConf);
    _serverIndices.insert("cloudtrace_projects_traces_spans_createSpan", 0);
}
...
void OAIProjectsApi::cloudtrace_projects_traces_batchWrite(const QString &name, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<OAIBatchWriteSpansRequest> &oai_batch_write_spans_request) {
    QString fullPath = QString(_serverConfigs["cloudtrace_projects_traces_batchWrite"][_serverIndices.value("cloudtrace_projects_traces_batchWrite")].URL()+"/v2/{name}/traces:batchWrite");
    ...
    if (oai_batch_write_spans_request.hasValue()){

        
        QByteArray output = oai_batch_write_spans_request.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::cloudtrace_projects_traces_batchWriteCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::cloudtrace_projects_traces_batchWriteCallback);
...
void OAIProjectsApi::cloudtrace_projects_traces_batchWriteCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT cloudtrace_projects_traces_batchWriteSignal(output);
        Q_EMIT cloudtrace_projects_traces_batchWriteSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT cloudtrace_projects_traces_batchWriteSignalE(output, error_type, error_str);
        Q_EMIT cloudtrace_projects_traces_batchWriteSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT cloudtrace_projects_traces_batchWriteSignalError(output, error_type, error_str);
        Q_EMIT cloudtrace_projects_traces_batchWriteSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectsApi::cloudtrace_projects_traces_spans_createSpan(const QString &name, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<OAISpan> &oai_span) {
    QString fullPath = QString(_serverConfigs["cloudtrace_projects_traces_spans_createSpan"][_serverIndices.value("cloudtrace_projects_traces_spans_createSpan")].URL()+"/v2/{name}");
    ...
    if (oai_span.hasValue()){

        
        QByteArray output = oai_span.value().asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::cloudtrace_projects_traces_spans_createSpanCallback);
    connect(this, &OAIProjectsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::cloudtrace_projects_traces_spans_createSpanCallback);
    connect(this, &OAIProjectsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectsApi::cloudtrace_projects_traces_spans_createSpanCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAISpan output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT cloudtrace_projects_traces_spans_createSpanSignal(output);
        Q_EMIT cloudtrace_projects_traces_spans_createSpanSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        QString scopeStr = scope.join(" ");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT cloudtrace_projects_traces_spans_createSpanSignalE(output, error_type, error_str);
        Q_EMIT cloudtrace_projects_traces_spans_createSpanSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT cloudtrace_projects_traces_spans_createSpanSignalError(output, error_type, error_str);
        Q_EMIT cloudtrace_projects_traces_spans_createSpanSignalErrorFull(worker, error_type, error_str);
    }
}
