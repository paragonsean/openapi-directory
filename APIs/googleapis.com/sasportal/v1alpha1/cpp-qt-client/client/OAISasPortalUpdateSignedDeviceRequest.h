...
/*
 * OAISasPortalUpdateSignedDeviceRequest.h
 *
 * Request for UpdateSignedDevice.
 */

#ifndef OAISasPortalUpdateSignedDeviceRequest_H
#define OAISasPortalUpdateSignedDeviceRequest_H
...
class OAISasPortalUpdateSignedDeviceRequest : public OAIObject {
public:
    OAISasPortalUpdateSignedDeviceRequest();
    OAISasPortalUpdateSignedDeviceRequest(QString json);
    ~OAISasPortalUpdateSignedDeviceRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISasPortalUpdateSignedDeviceRequest)

#endif // OAISasPortalUpdateSignedDeviceRequest_H
