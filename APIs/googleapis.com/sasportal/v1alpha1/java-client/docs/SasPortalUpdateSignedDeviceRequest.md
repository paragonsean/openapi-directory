...
|------------ | ------------- | ------------- | -------------|
|**encodedDevice** | **byte[]** | Required. The JSON Web Token signed using a CPI private key. Payload must be the JSON encoding of the device. The user_id field must be set. |  [optional] |
