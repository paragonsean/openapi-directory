# RecommendationsAiBeta.GoogleCloudRecommendationengineV1beta1UserInfo
...
**ipAddress** | **String** | Optional. IP address of the user. This could be either IPv4 (e.g. 104.133.9.80) or IPv6 (e.g. 2001:0db8:85a3:0000:0000:8a2e:0370:7334). This should *not* be set when using the javascript pixel or if &#x60;direct_user_request&#x60; is set. Used to extract location information for personalization. | [optional] 
**userAgent** | **String** | Optional. User agent as included in the HTTP header. UTF-8 encoded string with a length limit of 1 KiB. This should *not* be set when using the JavaScript pixel or if &#x60;directUserRequest&#x60; is set. | [optional] 
