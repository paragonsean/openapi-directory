# RecommendationsAiBeta.GoogleCloudRecommendationengineV1beta1UserEvent
...
**eventSource** | **String** | Optional. This field should *not* be set when using JavaScript pixel or the Recommendations AI Tag. Defaults to &#x60;EVENT_SOURCE_UNSPECIFIED&#x60;. | [optional] 
...
* `EVENT_SOURCE_UNSPECIFIED` (value: `"EVENT_SOURCE_UNSPECIFIED"`)
