...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RecommendationsAiBeta.GoogleCloudRecommendationengineV1beta1ImportMetadata();
  });
  ...
  describe('GoogleCloudRecommendationengineV1beta1ImportMetadata', function() {
    it('should create an instance of GoogleCloudRecommendationengineV1beta1ImportMetadata', function() {
      // uncomment below and update the code to test GoogleCloudRecommendationengineV1beta1ImportMetadata
      //var instance = new RecommendationsAiBeta.GoogleCloudRecommendationengineV1beta1ImportMetadata();
      //expect(instance).to.be.a(RecommendationsAiBeta.GoogleCloudRecommendationengineV1beta1ImportMetadata);
    });
