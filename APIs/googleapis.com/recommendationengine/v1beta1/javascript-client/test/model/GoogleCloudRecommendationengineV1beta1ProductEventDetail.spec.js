...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RecommendationsAiBeta.GoogleCloudRecommendationengineV1beta1ProductEventDetail();
  });
  ...
  describe('GoogleCloudRecommendationengineV1beta1ProductEventDetail', function() {
    it('should create an instance of GoogleCloudRecommendationengineV1beta1ProductEventDetail', function() {
      // uncomment below and update the code to test GoogleCloudRecommendationengineV1beta1ProductEventDetail
      //var instance = new RecommendationsAiBeta.GoogleCloudRecommendationengineV1beta1ProductEventDetail();
      //expect(instance).to.be.a(RecommendationsAiBeta.GoogleCloudRecommendationengineV1beta1ProductEventDetail);
    });
