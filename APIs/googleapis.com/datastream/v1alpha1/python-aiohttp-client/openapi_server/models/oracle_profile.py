...
class OracleProfile(Model):
    ...
    def __init__(self, connection_attributes: Dict[str, str]=None, database_service: str=None, hostname: str=None, password: str=None, port: int=None, username: str=None):
