...
class Stream(Model):
    ...
    def __init__(self, backfill_all: BackfillAllStrategy=None, backfill_none: object=None, create_time: str=None, customer_managed_encryption_key: str=None, destination_config: DestinationConfig=None, display_name: str=None, errors: List[Error]=None, labels: Dict[str, str]=None, name: str=None, source_config: SourceConfig=None, state: str=None, update_time: str=None):
    ...
    def state(self, state):
        ...
        :type state: str
        """
        allowed_values = ["STATE_UNSPECIFIED", "CREATED", "RUNNING", "PAUSED", "MAINTENANCE", "FAILED", "FAILED_PERMANENTLY", "STARTING", "DRAINING"]  # noqa: E501
