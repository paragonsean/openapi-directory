...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DatastreamApi.ListRoutesResponse();
  });
  ...
  describe('ListRoutesResponse', function() {
    it('should create an instance of ListRoutesResponse', function() {
      ...
      //var instance = new DatastreamApi.ListRoutesResponse();
      //expect(instance).to.be.a(DatastreamApi.ListRoutesResponse);
    });
