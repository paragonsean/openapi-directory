...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DatastreamApi.ListLocationsResponse();
  });
  ...
  describe('ListLocationsResponse', function() {
    it('should create an instance of ListLocationsResponse', function() {
      ...
      //var instance = new DatastreamApi.ListLocationsResponse();
      //expect(instance).to.be.a(DatastreamApi.ListLocationsResponse);
    });
