...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DatastreamApi.ListOperationsResponse();
  });
  ...
  describe('ListOperationsResponse', function() {
    it('should create an instance of ListOperationsResponse', function() {
      ...
      //var instance = new DatastreamApi.ListOperationsResponse();
      //expect(instance).to.be.a(DatastreamApi.ListOperationsResponse);
    });
