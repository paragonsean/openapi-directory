...
class OperationMetadata {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('validationResult')) {
                obj['validationResult'] = ValidationResult.constructFromObject(data['validationResult']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['validationResult']) { // data not null
          ValidationResult.validateJSON(data['validationResult']);
        }
        // ensure the json data is a string
...
/**
 * @member {module:model/ValidationResult} validationResult
 */
OperationMetadata.prototype['validationResult'] = undefined;
