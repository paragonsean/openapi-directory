...
class ConnectionProfile {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('noConnectivity')) {
                obj['noConnectivity'] = ApiClient.convertToType(data['noConnectivity'], Object);
            }
 ...
 * @member {Object} noConnectivity
 */
ConnectionProfile.prototype['noConnectivity'] = undefined;
