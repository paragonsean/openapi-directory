...
OAIValidationResult OAIOperationMetadata::getValidationResult() const {
    return m_validation_result;
}
void OAIOperationMetadata::setValidationResult(const OAIValidationResult &validation_result) {
    m_validation_result = validation_result;
    m_validation_result_isSet = true;
}

bool OAIOperationMetadata::is_validation_result_Set() const{
    return m_validation_result_isSet;
}

bool OAIOperationMetadata::is_validation_result_Valid() const{
