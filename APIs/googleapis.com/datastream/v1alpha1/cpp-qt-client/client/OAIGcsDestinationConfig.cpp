...
void OAIGcsDestinationConfig::initializeModel() {
    ...
    m_gcs_file_format_isSet = false;
    m_gcs_file_format_isValid = false;
...
void OAIGcsDestinationConfig::fromJsonObject(QJsonObject json) {
    ...
    m_gcs_file_format_isValid = ::OpenAPI::fromJsonValue(m_gcs_file_format, json[QString("gcsFileFormat")]);
    m_gcs_file_format_isSet = !json[QString("gcsFileFormat")].isNull() && m_gcs_file_format_isValid;
...
QJsonObject OAIGcsDestinationConfig::asJsonObject() const {
    ...
    if (m_gcs_file_format_isSet) {
        obj.insert(QString("gcsFileFormat"), ::OpenAPI::toJsonValue(m_gcs_file_format));
    }
...
QString OAIGcsDestinationConfig::getGcsFileFormat() const {
    return m_gcs_file_format;
}
void OAIGcsDestinationConfig::setGcsFileFormat(const QString &gcs_file_format) {
    m_gcs_file_format = gcs_file_format;
    m_gcs_file_format_isSet = true;
}

bool OAIGcsDestinationConfig::is_gcs_file_format_Set() const{
    return m_gcs_file_format_isSet;
}

bool OAIGcsDestinationConfig::is_gcs_file_format_Valid() const{
    return m_gcs_file_format_isValid;
}
