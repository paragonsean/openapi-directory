...
public:
    ...
    * @param[in]  upload_protocol QString [optional]
    * @param[in]  upload_type QString [optional]
    * @param[in]  oai_lookup_stream_object_request OAILookupStreamObjectRequest [optional]
    */
    virtual void datastream_projects_locations_streams_objects_lookup(const QString &parent, const ::OpenAPI::OptionalParam<QString> &_xgafv = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &access_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &alt = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &callback = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &fields = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &key = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &oauth_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &pretty_print = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &quota_user = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &upload_protocol = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &upload_type = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAILookupStreamObjectRequest> &oai_lookup_stream_object_request = ::OpenAPI::OptionalParam<OAILookupStreamObjectRequest>());
    ...
    * @param[in]  upload_protocol QString [optional]
    * @param[in]  upload_type QString [optional]
    * @param[in]  oai_run_stream_request OAIRunStreamRequest [optional]
    */
    virtual void datastream_projects_locations_streams_run(const QString &name, const ::OpenAPI::OptionalParam<QString> &_xgafv = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &access_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &alt = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &callback = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &fields = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &key = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &oauth_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &pretty_print = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &quota_user = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &upload_protocol = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &upload_type = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAIRunStreamRequest> &oai_run_stream_request = ::OpenAPI::OptionalParam<OAIRunStreamRequest>());
...
private:
    ...
    void datastream_projects_locations_streams_objects_lookupCallback(OAIHttpRequestWorker *worker);
    ...
    void datastream_projects_locations_streams_runCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void datastream_projects_locations_streams_objects_lookupSignal(OAIStreamObject summary);
    ...
    void datastream_projects_locations_streams_runSignal(OAIOperation summary);
    ...
    void datastream_projects_locations_streams_objects_lookupSignalFull(OAIHttpRequestWorker *worker, OAIStreamObject summary);
    ...
    void datastream_projects_locations_streams_runSignalFull(OAIHttpRequestWorker *worker, OAIOperation summary);
    ...
    Q_DECL_DEPRECATED_X("Use datastream_projects_locations_streams_objects_lookupSignalError() instead")
    void datastream_projects_locations_streams_objects_lookupSignalE(OAIStreamObject summary, QNetworkReply::NetworkError error_type, QString error_str);
    void datastream_projects_locations_streams_objects_lookupSignalError(OAIStreamObject summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use datastream_projects_locations_streams_runSignalError() instead")
    void datastream_projects_locations_streams_runSignalE(OAIOperation summary, QNetworkReply::NetworkError error_type, QString error_str);
    void datastream_projects_locations_streams_runSignalError(OAIOperation summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use datastream_projects_locations_streams_objects_lookupSignalErrorFull() instead")
    void datastream_projects_locations_streams_objects_lookupSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void datastream_projects_locations_streams_objects_lookupSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use datastream_projects_locations_streams_runSignalErrorFull() instead")
    void datastream_projects_locations_streams_runSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void datastream_projects_locations_streams_runSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
