...
void OAIOracleProfile::initializeModel() {
    ...
    m_oracle_ssl_config_isSet = false;
    m_oracle_ssl_config_isValid = false;
...
void OAIOracleProfile::fromJsonObject(QJsonObject json) {
    ...
    m_oracle_ssl_config_isValid = ::OpenAPI::fromJsonValue(m_oracle_ssl_config, json[QString("oracleSslConfig")]);
    m_oracle_ssl_config_isSet = !json[QString("oracleSslConfig")].isNull() && m_oracle_ssl_config_isValid;
...
QJsonObject OAIOracleProfile::asJsonObject() const {
    ...
    if (m_oracle_ssl_config.isSet()) {
        obj.insert(QString("oracleSslConfig"), ::OpenAPI::toJsonValue(m_oracle_ssl_config));
    }
    if (m_password_isSet) {
...
OAIOracleSslConfig OAIOracleProfile::getOracleSslConfig() const {
    return m_oracle_ssl_config;
}
void OAIOracleProfile::setOracleSslConfig(const OAIOracleSslConfig &oracle_ssl_config) {
    m_oracle_ssl_config = oracle_ssl_config;
    m_oracle_ssl_config_isSet = true;
}

bool OAIOracleProfile::is_oracle_ssl_config_Set() const{
    return m_oracle_ssl_config_isSet;
}

bool OAIOracleProfile::is_oracle_ssl_config_Valid() const{
    return m_oracle_ssl_config_isValid;
}
