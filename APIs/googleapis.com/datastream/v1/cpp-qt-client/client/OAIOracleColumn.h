...
#ifndef OAIOracleColumn_H
#define OAIOracleColumn_H
...
class OAIOracleColumn : public OAIObject {
public:
    OAIOracleColumn();
    OAIOracleColumn(QString json);
    ~OAIOracleColumn() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOracleColumn)

#endif // OAIOracleColumn_H
