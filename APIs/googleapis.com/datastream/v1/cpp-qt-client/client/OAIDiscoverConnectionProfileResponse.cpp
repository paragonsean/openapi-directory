...
OAIPostgresqlRdbms OAIDiscoverConnectionProfileResponse::getPostgresqlRdbms() const {
    return m_postgresql_rdbms;
}
void OAIDiscoverConnectionProfileResponse::setPostgresqlRdbms(const OAIPostgresqlRdbms &postgresql_rdbms) {
    m_postgresql_rdbms = postgresql_rdbms;
    m_postgresql_rdbms_isSet = true;
}

bool OAIDiscoverConnectionProfileResponse::is_postgresql_rdbms_Set() const{
    return m_postgresql_rdbms_isSet;
}

bool OAIDiscoverConnectionProfileResponse::is_postgresql_rdbms_Valid() const{
