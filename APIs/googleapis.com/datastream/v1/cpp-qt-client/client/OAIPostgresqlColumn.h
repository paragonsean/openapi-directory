...
/*
 * OAIPostgresqlColumn.h
 *
 * PostgreSQL Column.
 */

#ifndef OAIPostgresqlColumn_H
#define OAIPostgresqlColumn_H
...
class OAIPostgresqlColumn : public OAIObject {
public:
    OAIPostgresqlColumn();
    OAIPostgresqlColumn(QString json);
    ~OAIPostgresqlColumn() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPostgresqlColumn)

#endif // OAIPostgresqlColumn_H
