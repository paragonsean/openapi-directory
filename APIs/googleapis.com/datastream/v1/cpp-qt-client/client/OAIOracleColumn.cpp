...
QString OAIOracleColumn::getColumn() const {
    return m_column;
}
void OAIOracleColumn::setColumn(const QString &column) {
    m_column = column;
    m_column_isSet = true;
}

bool OAIOracleColumn::is_column_Set() const{
    return m_column_isSet;
}

bool OAIOracleColumn::is_column_Valid() const{
