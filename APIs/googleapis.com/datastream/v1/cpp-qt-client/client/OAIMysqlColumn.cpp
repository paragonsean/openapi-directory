...
QString OAIMysqlColumn::getColumn() const {
    return m_column;
}
void OAIMysqlColumn::setColumn(const QString &column) {
    m_column = column;
    m_column_isSet = true;
}

bool OAIMysqlColumn::is_column_Set() const{
    return m_column_isSet;
}

bool OAIMysqlColumn::is_column_Valid() const{
...
qint32 OAIMysqlColumn::getPrecision() const {
    return m_precision;
}
void OAIMysqlColumn::setPrecision(const qint32 &precision) {
    m_precision = precision;
    m_precision_isSet = true;
}

bool OAIMysqlColumn::is_precision_Set() const{
    return m_precision_isSet;
}

bool OAIMysqlColumn::is_precision_Valid() const{
...
qint32 OAIMysqlColumn::getScale() const {
    return m_scale;
}
void OAIMysqlColumn::setScale(const qint32 &scale) {
    m_scale = scale;
    m_scale_isSet = true;
}

bool OAIMysqlColumn::is_scale_Set() const{
    return m_scale_isSet;
}

bool OAIMysqlColumn::is_scale_Valid() const{
