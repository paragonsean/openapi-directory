...
public:
    ...
    OAIValidationResult getValidationResult() const;
    void setValidationResult(const OAIValidationResult &validation_result);
...
private:
    ...
    OAIValidationResult m_validation_result;
