...
OAISqlServerColumn::OAISqlServerColumn(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISqlServerColumn::OAISqlServerColumn() {
    this->initializeModel();
}

OAISqlServerColumn::~OAISqlServerColumn() {}

void OAISqlServerColumn::initializeModel() {
...
void OAISqlServerColumn::fromJson(QString jsonString) {
...
void OAISqlServerColumn::fromJsonObject(QJsonObject json) {
...
QString OAISqlServerColumn::asJson() const {
...
QJsonObject OAISqlServerColumn::asJsonObject() const {
    QJsonObject obj;
    if (m_column_isSet) {
...
QString OAISqlServerColumn::getColumn() const {
    return m_column;
}
void OAISqlServerColumn::setColumn(const QString &column) {
    m_column = column;
    m_column_isSet = true;
}

bool OAISqlServerColumn::is_column_Set() const{
    return m_column_isSet;
}

bool OAISqlServerColumn::is_column_Valid() const{
    return m_column_isValid;
}

QString OAISqlServerColumn::getDataType() const {
    return m_data_type;
}
void OAISqlServerColumn::setDataType(const QString &data_type) {
    m_data_type = data_type;
    m_data_type_isSet = true;
}

bool OAISqlServerColumn::is_data_type_Set() const{
    return m_data_type_isSet;
}

bool OAISqlServerColumn::is_data_type_Valid() const{
    return m_data_type_isValid;
}

qint32 OAISqlServerColumn::getLength() const {
    return m_length;
}
void OAISqlServerColumn::setLength(const qint32 &length) {
    m_length = length;
    m_length_isSet = true;
}

bool OAISqlServerColumn::is_length_Set() const{
    return m_length_isSet;
}

bool OAISqlServerColumn::is_length_Valid() const{
    return m_length_isValid;
}

bool OAISqlServerColumn::isNullable() const {
    return m_nullable;
}
void OAISqlServerColumn::setNullable(const bool &nullable) {
    m_nullable = nullable;
    m_nullable_isSet = true;
}

bool OAISqlServerColumn::is_nullable_Set() const{
    return m_nullable_isSet;
}

bool OAISqlServerColumn::is_nullable_Valid() const{
    return m_nullable_isValid;
}

qint32 OAISqlServerColumn::getOrdinalPosition() const {
    return m_ordinal_position;
}
void OAISqlServerColumn::setOrdinalPosition(const qint32 &ordinal_position) {
    m_ordinal_position = ordinal_position;
    m_ordinal_position_isSet = true;
}

bool OAISqlServerColumn::is_ordinal_position_Set() const{
    return m_ordinal_position_isSet;
}

bool OAISqlServerColumn::is_ordinal_position_Valid() const{
    return m_ordinal_position_isValid;
}

qint32 OAISqlServerColumn::getPrecision() const {
    return m_precision;
}
void OAISqlServerColumn::setPrecision(const qint32 &precision) {
    m_precision = precision;
    m_precision_isSet = true;
}

bool OAISqlServerColumn::is_precision_Set() const{
    return m_precision_isSet;
}

bool OAISqlServerColumn::is_precision_Valid() const{
    return m_precision_isValid;
}

bool OAISqlServerColumn::isPrimaryKey() const {
    return m_primary_key;
}
void OAISqlServerColumn::setPrimaryKey(const bool &primary_key) {
    m_primary_key = primary_key;
    m_primary_key_isSet = true;
}

bool OAISqlServerColumn::is_primary_key_Set() const{
    return m_primary_key_isSet;
}

bool OAISqlServerColumn::is_primary_key_Valid() const{
    return m_primary_key_isValid;
}

qint32 OAISqlServerColumn::getScale() const {
    return m_scale;
}
void OAISqlServerColumn::setScale(const qint32 &scale) {
    m_scale = scale;
    m_scale_isSet = true;
}

bool OAISqlServerColumn::is_scale_Set() const{
    return m_scale_isSet;
}

bool OAISqlServerColumn::is_scale_Valid() const{
    return m_scale_isValid;
}

bool OAISqlServerColumn::isSet() const {
...
bool OAISqlServerColumn::isValid() const {
