...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DatastreamApi.SqlServerTable();
  });
  ...
  describe('SqlServerTable', function() {
    it('should create an instance of SqlServerTable', function() {
      // uncomment below and update the code to test SqlServerTable
      //var instance = new DatastreamApi.SqlServerTable();
      //expect(instance).to.be.a(DatastreamApi.SqlServerTable);
    });
