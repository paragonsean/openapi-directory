...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DatastreamApi.SqlServerColumn();
  });
  ...
  describe('SqlServerColumn', function() {
    it('should create an instance of SqlServerColumn', function() {
      // uncomment below and update the code to test SqlServerColumn
      //var instance = new DatastreamApi.SqlServerColumn();
      //expect(instance).to.be.a(DatastreamApi.SqlServerColumn);
    });
