...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DatastreamApi.OracleColumn();
  });
  ...
  describe('OracleColumn', function() {
    it('should create an instance of OracleColumn', function() {
      // uncomment below and update the code to test OracleColumn
      //var instance = new DatastreamApi.OracleColumn();
      //expect(instance).to.be.a(DatastreamApi.OracleColumn);
    });
