...
import SqlServerObjectIdentifier from './SqlServerObjectIdentifier';
...
class SourceObjectIdentifier {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('postgresqlIdentifier')) {
                obj['postgresqlIdentifier'] = PostgresqlObjectIdentifier.constructFromObject(data['postgresqlIdentifier']);
            }
            if (data.hasOwnProperty('sqlServerIdentifier')) {
                obj['sqlServerIdentifier'] = SqlServerObjectIdentifier.constructFromObject(data['sqlServerIdentifier']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['postgresqlIdentifier']) { // data not null
          PostgresqlObjectIdentifier.validateJSON(data['postgresqlIdentifier']);
        }
        // validate the optional field `sqlServerIdentifier`
        if (data['sqlServerIdentifier']) { // data not null
          SqlServerObjectIdentifier.validateJSON(data['sqlServerIdentifier']);
        }
...
/**
 * @member {module:model/PostgresqlObjectIdentifier} postgresqlIdentifier
 */
SourceObjectIdentifier.prototype['postgresqlIdentifier'] = undefined;

/**
 * @member {module:model/SqlServerObjectIdentifier} sqlServerIdentifier
 */
SourceObjectIdentifier.prototype['sqlServerIdentifier'] = undefined;
