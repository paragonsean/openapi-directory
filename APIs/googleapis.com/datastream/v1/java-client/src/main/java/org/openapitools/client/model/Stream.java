...
public class Stream {
  ...
  public static final String SERIALIZED_NAME_LAST_RECOVERY_TIME = "lastRecoveryTime";
  @SerializedName(SERIALIZED_NAME_LAST_RECOVERY_TIME)
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.backfillAll, stream.backfillAll) &&
        ...
        Objects.equals(this.lastRecoveryTime, stream.lastRecoveryTime) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(backfillAll, backfillNone, createTime, customerManagedEncryptionKey, destinationConfig, displayName, errors, labels, lastRecoveryTime, name, sourceConfig, state, updateTime);
  }
  ...
  public String toString() {
    ...
    sb.append("    lastRecoveryTime: ").append(toIndentedString(lastRecoveryTime)).append("\n");
  ...
  static {
    ...
    openapiFields.add("lastRecoveryTime");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("lastRecoveryTime") != null && !jsonObj.get("lastRecoveryTime").isJsonNull()) && !jsonObj.get("lastRecoveryTime").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `lastRecoveryTime` to be a primitive type in the JSON string but got `%s`", jsonObj.get("lastRecoveryTime").toString()));
      }
