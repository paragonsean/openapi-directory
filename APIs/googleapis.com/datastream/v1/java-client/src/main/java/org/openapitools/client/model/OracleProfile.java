...
public class OracleProfile {
  ...
  public static final String SERIALIZED_NAME_ORACLE_SSL_CONFIG = "oracleSslConfig";
  @SerializedName(SERIALIZED_NAME_ORACLE_SSL_CONFIG)
  ...
  public OracleProfile oracleSslConfig(OracleSslConfig oracleSslConfig) {
  ...
  public void setOracleSslConfig(OracleSslConfig oracleSslConfig) {
    this.oracleSslConfig = oracleSslConfig;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.connectionAttributes, oracleProfile.connectionAttributes) &&
        ...
        Objects.equals(this.oracleSslConfig, oracleProfile.oracleSslConfig) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(connectionAttributes, databaseService, hostname, oracleSslConfig, password, port, username);
  }
  ...
  public String toString() {
    ...
    sb.append("    oracleSslConfig: ").append(toIndentedString(oracleSslConfig)).append("\n");
  ...
  static {
    ...
    openapiFields.add("oracleSslConfig");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("oracleSslConfig") != null && !jsonObj.get("oracleSslConfig").isJsonNull()) {
        OracleSslConfig.validateJsonElement(jsonObj.get("oracleSslConfig"));
      }
