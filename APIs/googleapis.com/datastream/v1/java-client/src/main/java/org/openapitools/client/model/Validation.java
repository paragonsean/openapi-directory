...
public class Validation {
  ...
  private List<ValidationMessage> message = new ArrayList<>();
  ...
  public Validation code(String code) {
    this.code = code;
    return this;
  }
  ...
  public Validation description(String description) {
  ...
  public Validation message(List<ValidationMessage> message) {
    this.message = message;
    return this;
  }

  public Validation addMessageItem(ValidationMessage messageItem) {
  ...
  public void setMessage(List<ValidationMessage> message) {
    this.message = message;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, validation.code) &&
        Objects.equals(this.description, validation.description) &&
        Objects.equals(this.message, validation.message) &&
        Objects.equals(this.state, validation.state);
  }

  @Override
  public int hashCode() {
    return Objects.hash(code, description, message, state);
  }
      ...
      if (jsonObj.get("message") != null && !jsonObj.get("message").isJsonNull()) {
        ...
        if (jsonArraymessage != null) {
          ...
          for (int i = 0; i < jsonArraymessage.size(); i++) {
            ValidationMessage.validateJsonElement(jsonArraymessage.get(i));
          };
        }
      }
