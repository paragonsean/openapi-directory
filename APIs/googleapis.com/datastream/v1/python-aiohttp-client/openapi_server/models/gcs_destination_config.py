...
class GcsDestinationConfig(Model):
    ...
    def __init__(self, avro_file_format: object=None, file_rotation_interval: str=None, file_rotation_mb: int=None, json_file_format: JsonFileFormat=None, path: str=None):
