...
public:
    ...
    * @param[in]  upload_protocol QString [optional]
    * @param[in]  upload_type QString [optional]
    * @param[in]  oai_sign_ssh_public_key_request OAISignSshPublicKeyRequest [optional]
    */
    virtual void oslogin_users_projects_zones_signSshPublicKey(const QString &parent, const ::OpenAPI::OptionalParam<QString> &_xgafv = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &access_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &alt = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &callback = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &fields = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &key = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &oauth_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &pretty_print = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &quota_user = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &upload_protocol = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &upload_type = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAISignSshPublicKeyRequest> &oai_sign_ssh_public_key_request = ::OpenAPI::OptionalParam<OAISignSshPublicKeyRequest>());
...
private:
    ...
    void oslogin_users_projects_zones_signSshPublicKeyCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void oslogin_users_projects_zones_signSshPublicKeySignal(OAISignSshPublicKeyResponse summary);
    ...
    void oslogin_users_projects_zones_signSshPublicKeySignalFull(OAIHttpRequestWorker *worker, OAISignSshPublicKeyResponse summary);
    ...
    Q_DECL_DEPRECATED_X("Use oslogin_users_projects_zones_signSshPublicKeySignalError() instead")
    void oslogin_users_projects_zones_signSshPublicKeySignalE(OAISignSshPublicKeyResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void oslogin_users_projects_zones_signSshPublicKeySignalError(OAISignSshPublicKeyResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use oslogin_users_projects_zones_signSshPublicKeySignalErrorFull() instead")
    void oslogin_users_projects_zones_signSshPublicKeySignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void oslogin_users_projects_zones_signSshPublicKeySignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
