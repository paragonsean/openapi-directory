...
class LoginProfile(Model):
    ...
    def __init__(self, name: str=None, posix_accounts: List[PosixAccount]=None, security_keys: List[SecurityKey]=None, ssh_public_keys: Dict[str, SshPublicKey]=None):
    ...
    def security_keys(self):
        """Gets the security_keys of this LoginProfile.

        The registered security key credentials for a user.

        :return: The security_keys of this LoginProfile.
        :rtype: List[SecurityKey]
        """
        return self._security_keys

    @security_keys.setter
    def security_keys(self, security_keys):
        """Sets the security_keys of this LoginProfile.

        The registered security key credentials for a user.

        :param security_keys: The security_keys of this LoginProfile.
        :type security_keys: List[SecurityKey]
        """
