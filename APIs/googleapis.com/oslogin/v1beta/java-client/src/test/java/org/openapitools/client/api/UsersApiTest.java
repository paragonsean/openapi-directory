...
public class UsersApiTest {
    ...
    public void osloginUsersGetLoginProfileTest() throws ApiException {
        ...
        String view = null;
        LoginProfile response = api.osloginUsersGetLoginProfile(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, projectId, systemId, view);
