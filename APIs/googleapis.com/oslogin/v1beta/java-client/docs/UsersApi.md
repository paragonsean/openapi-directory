...
|------------- | ------------- | -------------|
| [**osloginUsersGetLoginProfile**](UsersApi.md#osloginUsersGetLoginProfile) | **GET** /v1beta/{name}/loginProfile |  |
| [**osloginUsersImportSshPublicKey**](UsersApi.md#osloginUsersImportSshPublicKey) | **POST** /v1beta/{parent}:importSshPublicKey |  |
| [**osloginUsersProjectsZonesSignSshPublicKey**](UsersApi.md#osloginUsersProjectsZonesSignSshPublicKey) | **POST** /v1beta/{parent}:signSshPublicKey |  |
| [**osloginUsersSshPublicKeysCreate**](UsersApi.md#osloginUsersSshPublicKeysCreate) | **POST** /v1beta/{parent}/sshPublicKeys |  |
| [**osloginUsersSshPublicKeysDelete**](UsersApi.md#osloginUsersSshPublicKeysDelete) | **DELETE** /v1beta/{name} |  |
| [**osloginUsersSshPublicKeysGet**](UsersApi.md#osloginUsersSshPublicKeysGet) | **GET** /v1beta/{name} |  |
| [**osloginUsersSshPublicKeysPatch**](UsersApi.md#osloginUsersSshPublicKeysPatch) | **PATCH** /v1beta/{name} |  |


<a id="osloginUsersGetLoginProfile"></a>
# **osloginUsersGetLoginProfile**
> LoginProfile osloginUsersGetLoginProfile(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, projectId, systemId, view)
