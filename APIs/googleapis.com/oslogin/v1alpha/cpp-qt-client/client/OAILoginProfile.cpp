...
QList<OAISecurityKey> OAILoginProfile::getSecurityKeys() const {
    return m_security_keys;
}
void OAILoginProfile::setSecurityKeys(const QList<OAISecurityKey> &security_keys) {
    m_security_keys = security_keys;
    m_security_keys_isSet = true;
}

bool OAILoginProfile::is_security_keys_Set() const{
    return m_security_keys_isSet;
}

bool OAILoginProfile::is_security_keys_Valid() const{
