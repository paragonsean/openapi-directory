...
public class ApiClient {
    ...
    private String basePath = "https://oslogin.googleapis.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/v1alpha/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://oslogin.googleapis.com
