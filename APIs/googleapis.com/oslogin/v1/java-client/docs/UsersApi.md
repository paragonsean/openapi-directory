...
|------------- | ------------- | -------------|
| [**osloginUsersGetLoginProfile**](UsersApi.md#osloginUsersGetLoginProfile) | **GET** /v1/{name}/loginProfile |  |
| [**osloginUsersImportSshPublicKey**](UsersApi.md#osloginUsersImportSshPublicKey) | **POST** /v1/{parent}:importSshPublicKey |  |
| [**osloginUsersSshPublicKeysCreate**](UsersApi.md#osloginUsersSshPublicKeysCreate) | **POST** /v1/{parent}/sshPublicKeys |  |
| [**osloginUsersSshPublicKeysDelete**](UsersApi.md#osloginUsersSshPublicKeysDelete) | **DELETE** /v1/{name} |  |
| [**osloginUsersSshPublicKeysGet**](UsersApi.md#osloginUsersSshPublicKeysGet) | **GET** /v1/{name} |  |
| [**osloginUsersSshPublicKeysPatch**](UsersApi.md#osloginUsersSshPublicKeysPatch) | **PATCH** /v1/{name} |  |


<a id="osloginUsersGetLoginProfile"></a>
# **osloginUsersGetLoginProfile**
> LoginProfile osloginUsersGetLoginProfile(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, projectId, systemId)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      LoginProfile result = apiInstance.osloginUsersGetLoginProfile(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, projectId, systemId);
...
> ImportSshPublicKeyResponse osloginUsersImportSshPublicKey(parent, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, projectId, regions, sshPublicKey)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ImportSshPublicKeyResponse result = apiInstance.osloginUsersImportSshPublicKey(parent, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, projectId, regions, sshPublicKey);
      System.out.println(result);
    } catch (ApiException e) {
...
> Object osloginUsersSshPublicKeysDelete(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType)
...
public class Example {
  public static void main(String[] args) {
    ...
    String uploadType = "uploadType_example"; // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
    try {
      Object result = apiInstance.osloginUsersSshPublicKeysDelete(name, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType);
      System.out.println(result);
    } catch (ApiException e) {
