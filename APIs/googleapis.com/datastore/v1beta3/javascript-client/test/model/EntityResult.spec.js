...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudDatastoreApi.EntityResult();
  });
  ...
  describe('EntityResult', function() {
    it('should create an instance of EntityResult', function() {
      // uncomment below and update the code to test EntityResult
      //var instance = new CloudDatastoreApi.EntityResult();
      //expect(instance).to.be.a(CloudDatastoreApi.EntityResult);
    });
