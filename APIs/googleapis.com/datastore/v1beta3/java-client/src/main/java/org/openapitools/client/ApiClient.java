...
public class ApiClient {
    ...
    private String basePath = "https://datastore.googleapis.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/v1beta3/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://datastore.googleapis.com
