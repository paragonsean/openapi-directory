...
class RunAggregationQueryRequest(Model):
    ...
    def __init__(self, aggregation_query: AggregationQuery=None, database_id: str=None, gql_query: GqlQuery=None, partition_id: PartitionId=None, read_options: ReadOptions=None):
        ...
        :param database_id: The database_id of this RunAggregationQueryRequest.
    ...
    def database_id(self):
        """Gets the database_id of this RunAggregationQueryRequest.

        The ID of the database against which to make the request. '(default)' is not allowed; please use empty string '' to refer the default database.

        :return: The database_id of this RunAggregationQueryRequest.
        :rtype: str
        """
    ...
    def database_id(self, database_id):
        """Sets the database_id of this RunAggregationQueryRequest.
