...
class ReadOptions(Model):
    ...
    def __init__(self, new_transaction: TransactionOptions=None, read_consistency: str=None, read_time: str=None, transaction: str=None):
        """ReadOptions - a model defined in OpenAPI

        :param new_transaction: The new_transaction of this ReadOptions.
    ...
    def new_transaction(self):
        """Gets the new_transaction of this ReadOptions.


        :return: The new_transaction of this ReadOptions.
    ...
    def new_transaction(self, new_transaction):
        """Sets the new_transaction of this ReadOptions.
