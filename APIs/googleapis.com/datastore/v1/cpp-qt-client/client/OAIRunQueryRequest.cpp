...
QString OAIRunQueryRequest::getDatabaseId() const {
    return m_database_id;
}
void OAIRunQueryRequest::setDatabaseId(const QString &database_id) {
    m_database_id = database_id;
    m_database_id_isSet = true;
}

bool OAIRunQueryRequest::is_database_id_Set() const{
    return m_database_id_isSet;
}

bool OAIRunQueryRequest::is_database_id_Valid() const{
