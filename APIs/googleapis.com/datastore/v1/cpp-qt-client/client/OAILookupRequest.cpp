...
QString OAILookupRequest::getDatabaseId() const {
    return m_database_id;
}
void OAILookupRequest::setDatabaseId(const QString &database_id) {
    m_database_id = database_id;
    m_database_id_isSet = true;
}

bool OAILookupRequest::is_database_id_Set() const{
    return m_database_id_isSet;
}

bool OAILookupRequest::is_database_id_Valid() const{
