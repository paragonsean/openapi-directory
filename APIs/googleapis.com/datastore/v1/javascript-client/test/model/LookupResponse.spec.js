...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudDatastoreApi.LookupResponse();
  });
  ...
  describe('LookupResponse', function() {
    it('should create an instance of LookupResponse', function() {
      ...
      //var instance = new CloudDatastoreApi.LookupResponse();
      //expect(instance).to.be.a(CloudDatastoreApi.LookupResponse);
    });
