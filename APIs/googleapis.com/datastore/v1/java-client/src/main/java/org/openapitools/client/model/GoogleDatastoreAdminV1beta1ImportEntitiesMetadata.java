...
public class GoogleDatastoreAdminV1beta1ImportEntitiesMetadata {
  ...
  public GoogleDatastoreAdminV1beta1ImportEntitiesMetadata() {
  }

  public GoogleDatastoreAdminV1beta1ImportEntitiesMetadata common(GoogleDatastoreAdminV1beta1CommonMetadata common) {
    this.common = common;
    return this;
  }
  ...
  public GoogleDatastoreAdminV1beta1ImportEntitiesMetadata entityFilter(GoogleDatastoreAdminV1beta1EntityFilter entityFilter) {
  ...
  public GoogleDatastoreAdminV1beta1ImportEntitiesMetadata inputUrl(String inputUrl) {
  ...
  public GoogleDatastoreAdminV1beta1ImportEntitiesMetadata progressBytes(GoogleDatastoreAdminV1beta1Progress progressBytes) {
  ...
  public GoogleDatastoreAdminV1beta1ImportEntitiesMetadata progressEntities(GoogleDatastoreAdminV1beta1Progress progressEntities) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleDatastoreAdminV1beta1ImportEntitiesMetadata googleDatastoreAdminV1beta1ImportEntitiesMetadata = (GoogleDatastoreAdminV1beta1ImportEntitiesMetadata) o;
    return Objects.equals(this.common, googleDatastoreAdminV1beta1ImportEntitiesMetadata.common) &&
        Objects.equals(this.entityFilter, googleDatastoreAdminV1beta1ImportEntitiesMetadata.entityFilter) &&
        Objects.equals(this.inputUrl, googleDatastoreAdminV1beta1ImportEntitiesMetadata.inputUrl) &&
        Objects.equals(this.progressBytes, googleDatastoreAdminV1beta1ImportEntitiesMetadata.progressBytes) &&
        Objects.equals(this.progressEntities, googleDatastoreAdminV1beta1ImportEntitiesMetadata.progressEntities);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleDatastoreAdminV1beta1ImportEntitiesMetadata {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleDatastoreAdminV1beta1ImportEntitiesMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleDatastoreAdminV1beta1ImportEntitiesMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleDatastoreAdminV1beta1ImportEntitiesMetadata is not found in the empty JSON string", GoogleDatastoreAdminV1beta1ImportEntitiesMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleDatastoreAdminV1beta1ImportEntitiesMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleDatastoreAdminV1beta1ImportEntitiesMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleDatastoreAdminV1beta1ImportEntitiesMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleDatastoreAdminV1beta1ImportEntitiesMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleDatastoreAdminV1beta1ImportEntitiesMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleDatastoreAdminV1beta1ImportEntitiesMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleDatastoreAdminV1beta1ImportEntitiesMetadata>() {
           @Override
           public void write(JsonWriter out, GoogleDatastoreAdminV1beta1ImportEntitiesMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleDatastoreAdminV1beta1ImportEntitiesMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleDatastoreAdminV1beta1ImportEntitiesMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleDatastoreAdminV1beta1ImportEntitiesMetadata
   * @throws IOException if the JSON string is invalid with respect to GoogleDatastoreAdminV1beta1ImportEntitiesMetadata
   */
  public static GoogleDatastoreAdminV1beta1ImportEntitiesMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleDatastoreAdminV1beta1ImportEntitiesMetadata.class);
  }

  /**
   * Convert an instance of GoogleDatastoreAdminV1beta1ImportEntitiesMetadata to an JSON string
   *
   * @return JSON string
   */
