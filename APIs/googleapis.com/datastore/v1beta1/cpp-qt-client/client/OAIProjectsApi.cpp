...
void OAIProjectsApi::datastore_projects_export(const QString &project_id, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<OAIGoogleDatastoreAdminV1beta1ExportEntitiesRequest> &oai_google_datastore_admin_v1beta1_export_entities_request) {
    QString fullPath = QString(_serverConfigs["datastore_projects_export"][_serverIndices.value("datastore_projects_export")].URL()+"/v1beta1/projects/{projectId}:export");
    ...
    if (oai_google_datastore_admin_v1beta1_export_entities_request.hasValue()){

        
        QByteArray output = oai_google_datastore_admin_v1beta1_export_entities_request.value().asJson().toUtf8();
...
void OAIProjectsApi::datastore_projects_import(const QString &project_id, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<OAIGoogleDatastoreAdminV1beta1ImportEntitiesRequest> &oai_google_datastore_admin_v1beta1_import_entities_request) {
    ...
    if (oai_google_datastore_admin_v1beta1_import_entities_request.hasValue()){

        
        QByteArray output = oai_google_datastore_admin_v1beta1_import_entities_request.value().asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
