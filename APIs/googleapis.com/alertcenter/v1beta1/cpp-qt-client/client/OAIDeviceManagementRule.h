...
/*
 * OAIDeviceManagementRule.h
 *
 * Alerts from Device Management Rules configured by Admin.
 */

#ifndef OAIDeviceManagementRule_H
#define OAIDeviceManagementRule_H
...
class OAIDeviceManagementRule : public OAIObject {
public:
    OAIDeviceManagementRule();
    OAIDeviceManagementRule(QString json);
    ~OAIDeviceManagementRule() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeviceManagementRule)

#endif // OAIDeviceManagementRule_H
