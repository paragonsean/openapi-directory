...
#ifndef OAIRuleInfo_H
#define OAIRuleInfo_H
...
class OAIRuleInfo : public OAIObject {
public:
    OAIRuleInfo();
    OAIRuleInfo(QString json);
    ~OAIRuleInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRuleInfo)
