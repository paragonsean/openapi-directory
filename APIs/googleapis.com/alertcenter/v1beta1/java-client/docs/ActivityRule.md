...
|------------ | ------------- | ------------- | -------------|
|**actionNames** | **List&lt;String&gt;** | List of action names associated with the rule threshold. |  [optional] |
...
|**supersededAlerts** | **List&lt;String&gt;** | List of alert IDs superseded by this alert. It is used to indicate that this alert is essentially extension of superseded alerts and we found the relationship after creating these alerts. |  [optional] |
