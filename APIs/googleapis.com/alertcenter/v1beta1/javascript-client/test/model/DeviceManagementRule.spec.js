...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleWorkspaceAlertCenterApi.DeviceManagementRule();
  });
  ...
  describe('DeviceManagementRule', function() {
    it('should create an instance of DeviceManagementRule', function() {
      // uncomment below and update the code to test DeviceManagementRule
      //var instance = new GoogleWorkspaceAlertCenterApi.DeviceManagementRule();
      //expect(instance).to.be.a(GoogleWorkspaceAlertCenterApi.DeviceManagementRule);
    });
