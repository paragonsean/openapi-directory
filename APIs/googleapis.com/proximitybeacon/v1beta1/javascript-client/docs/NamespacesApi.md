# ProximityBeaconApi.NamespacesApi
...
> ListNamespacesResponse proximitybeaconNamespacesList(opts)
...
let apiInstance = new ProximityBeaconApi.NamespacesApi();
let opts = {
  ...
  'projectId': "projectId_example" // String | The project id to list namespaces under. Optional.
};
apiInstance.proximitybeaconNamespacesList(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> Namespace proximitybeaconNamespacesUpdate(namespaceName, opts)
...
let apiInstance = new ProximityBeaconApi.NamespacesApi();
let namespaceName = "namespaceName_example"; // String | Resource name of this namespace. Namespaces names have the format: namespaces/namespace.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'projectId': "projectId_example", // String | The project id of the namespace to update. If the project id is not specified then the project making the request is used. The project id must match the project that owns the beacon. Optional.
  'namespace': new ProximityBeaconApi.Namespace() // Namespace | 
};
apiInstance.proximitybeaconNamespacesUpdate(namespaceName, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
