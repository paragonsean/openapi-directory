...
void OAINamespacesApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("proximitybeacon_namespaces_list", defaultConf);
    _serverIndices.insert("proximitybeacon_namespaces_list", 0);
    _serverConfigs.insert("proximitybeacon_namespaces_update", defaultConf);
    _serverIndices.insert("proximitybeacon_namespaces_update", 0);
}
...
void OAINamespacesApi::proximitybeacon_namespaces_list(const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<QString> &project_id) {
    QString fullPath = QString(_serverConfigs["proximitybeacon_namespaces_list"][_serverIndices.value("proximitybeacon_namespaces_list")].URL()+"/v1beta1/namespaces");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAINamespacesApi::proximitybeacon_namespaces_listCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAINamespacesApi::proximitybeacon_namespaces_listCallback);
...
void OAINamespacesApi::proximitybeacon_namespaces_listCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT proximitybeacon_namespaces_listSignal(output);
        Q_EMIT proximitybeacon_namespaces_listSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT proximitybeacon_namespaces_listSignalE(output, error_type, error_str);
        Q_EMIT proximitybeacon_namespaces_listSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT proximitybeacon_namespaces_listSignalError(output, error_type, error_str);
        Q_EMIT proximitybeacon_namespaces_listSignalErrorFull(worker, error_type, error_str);
    }
}

void OAINamespacesApi::proximitybeacon_namespaces_update(const QString &namespace_name, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<QString> &project_id, const ::OpenAPI::OptionalParam<OAINamespace> &oai_namespace) {
    QString fullPath = QString(_serverConfigs["proximitybeacon_namespaces_update"][_serverIndices.value("proximitybeacon_namespaces_update")].URL()+"/v1beta1/{namespaceName}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAINamespacesApi::proximitybeacon_namespaces_updateCallback);
    connect(this, &OAINamespacesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAINamespacesApi::proximitybeacon_namespaces_updateCallback);
    connect(this, &OAINamespacesApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAINamespacesApi::proximitybeacon_namespaces_updateCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT proximitybeacon_namespaces_updateSignal(output);
        Q_EMIT proximitybeacon_namespaces_updateSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("https://www.googleapis.com/auth/userlocation.beacon.registry");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT proximitybeacon_namespaces_updateSignalE(output, error_type, error_str);
        Q_EMIT proximitybeacon_namespaces_updateSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT proximitybeacon_namespaces_updateSignalError(output, error_type, error_str);
        Q_EMIT proximitybeacon_namespaces_updateSignalErrorFull(worker, error_type, error_str);
    }
}
