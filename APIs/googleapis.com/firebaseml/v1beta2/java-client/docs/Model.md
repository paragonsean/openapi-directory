...
|------------ | ------------- | ------------- | -------------|
|**activeOperations** | [**List&lt;Operation&gt;**](Operation.md) | Output only. Lists operation ids associated with this model whose status is NOT done. |  [optional] [readonly] |
...
|**tags** | **List&lt;String&gt;** | User defined tags which can be used to group/filter models during listing |  [optional] |
