# FirebaseMlApi.DownloadModelResponse
...
**modelFormat** | **String** | Output only. The format of the model being downloaded. | [optional] [readonly] 
...
* `MODEL_FORMAT_UNSPECIFIED` (value: `"MODEL_FORMAT_UNSPECIFIED"`)
