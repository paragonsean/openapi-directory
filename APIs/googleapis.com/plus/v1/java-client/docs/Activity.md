...
|**kind** | **String** | Identifies this resource as an activity. Value: \&quot;plus#activity\&quot;. |  [optional] |
|**location** | [**Place**](Place.md) |  |  [optional] |
|**_object** | [**ActivityObject**](ActivityObject.md) |  |  [optional] |
...
|**published** | **OffsetDateTime** | The time at which this activity was initially published. Formatted as an RFC 3339 timestamp. |  [optional] |
...
|**updated** | **OffsetDateTime** | The time at which this activity was last updated. Formatted as an RFC 3339 timestamp. |  [optional] |
