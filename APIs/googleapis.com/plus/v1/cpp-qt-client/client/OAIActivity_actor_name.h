...
/*
 * OAIActivity_actor_name.h
 *
 * An object representation of the individual components of name.
 */

#ifndef OAIActivity_actor_name_H
#define OAIActivity_actor_name_H
...
class OAIActivity_actor_name : public OAIObject {
public:
    OAIActivity_actor_name();
    OAIActivity_actor_name(QString json);
    ~OAIActivity_actor_name() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActivity_actor_name)

#endif // OAIActivity_actor_name_H
