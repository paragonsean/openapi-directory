...
#ifndef OAIActivityFeed_H
#define OAIActivityFeed_H
...
class OAIActivityFeed : public OAIObject {
public:
    OAIActivityFeed();
    OAIActivityFeed(QString json);
    ~OAIActivityFeed() override;
    ...
    QList<OAIActivity> getItems() const;
    void setItems(const QList<OAIActivity> &items);
...
Q_DECLARE_METATYPE(OpenAPI::OAIActivityFeed)

#endif // OAIActivityFeed_H
