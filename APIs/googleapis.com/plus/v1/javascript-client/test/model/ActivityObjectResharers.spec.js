...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleApi.ActivityObjectResharers();
  });
  ...
  describe('ActivityObjectResharers', function() {
    it('should create an instance of ActivityObjectResharers', function() {
      // uncomment below and update the code to test ActivityObjectResharers
      //var instance = new GoogleApi.ActivityObjectResharers();
      //expect(instance).to.be.a(GoogleApi.ActivityObjectResharers);
    });
