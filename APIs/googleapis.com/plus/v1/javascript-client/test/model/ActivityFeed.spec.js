...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleApi.ActivityFeed();
  });
  ...
  describe('ActivityFeed', function() {
    it('should create an instance of ActivityFeed', function() {
      // uncomment below and update the code to test ActivityFeed
      //var instance = new GoogleApi.ActivityFeed();
      //expect(instance).to.be.a(GoogleApi.ActivityFeed);
    });
