...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleApi.PersonAgeRange();
  });
  ...
  describe('PersonAgeRange', function() {
    it('should create an instance of PersonAgeRange', function() {
      // uncomment below and update the code to test PersonAgeRange
      //var instance = new GoogleApi.PersonAgeRange();
      //expect(instance).to.be.a(GoogleApi.PersonAgeRange);
    });
