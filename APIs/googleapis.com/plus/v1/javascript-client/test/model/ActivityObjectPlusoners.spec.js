...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleApi.ActivityObjectPlusoners();
  });
  ...
  describe('ActivityObjectPlusoners', function() {
    it('should create an instance of ActivityObjectPlusoners', function() {
      // uncomment below and update the code to test ActivityObjectPlusoners
      //var instance = new GoogleApi.ActivityObjectPlusoners();
      //expect(instance).to.be.a(GoogleApi.ActivityObjectPlusoners);
    });
