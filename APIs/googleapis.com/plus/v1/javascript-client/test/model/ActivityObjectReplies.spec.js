...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleApi.ActivityObjectReplies();
  });
  ...
  describe('ActivityObjectReplies', function() {
    it('should create an instance of ActivityObjectReplies', function() {
      // uncomment below and update the code to test ActivityObjectReplies
      //var instance = new GoogleApi.ActivityObjectReplies();
      //expect(instance).to.be.a(GoogleApi.ActivityObjectReplies);
    });
