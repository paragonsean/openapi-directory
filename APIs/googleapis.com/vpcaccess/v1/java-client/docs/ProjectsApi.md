...
public class Example {
  public static void main(String[] args) {
    ...
    String parent = "parent_example"; // String | Required. The project ID and location in which the configuration should be created, specified in the format `projects/_*_/locations/_*`.
