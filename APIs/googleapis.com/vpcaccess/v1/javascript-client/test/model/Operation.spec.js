...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServerlessVpcAccessApi.Operation();
  });
  ...
  describe('Operation', function() {
    it('should create an instance of Operation', function() {
      ...
      //var instance = new ServerlessVpcAccessApi.Operation();
      //expect(instance).to.be.a(ServerlessVpcAccessApi.Operation);
    });
