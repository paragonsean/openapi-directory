...
public:
    ...
    QString getLastRestartTime() const;
    void setLastRestartTime(const QString &last_restart_time);
    bool is_last_restart_time_Set() const;
    bool is_last_restart_time_Valid() const;
...
private:
    ...
    QString m_last_restart_time;
    bool m_last_restart_time_isSet;
    bool m_last_restart_time_isValid;
