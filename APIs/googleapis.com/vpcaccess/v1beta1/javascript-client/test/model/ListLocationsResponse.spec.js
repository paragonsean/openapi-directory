...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServerlessVpcAccessApi.ListLocationsResponse();
  });
  ...
  describe('ListLocationsResponse', function() {
    it('should create an instance of ListLocationsResponse', function() {
      ...
      //var instance = new ServerlessVpcAccessApi.ListLocationsResponse();
      //expect(instance).to.be.a(ServerlessVpcAccessApi.ListLocationsResponse);
    });
