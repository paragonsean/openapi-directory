# ServerlessVpcAccessApi.ProjectsApi
...
> Operation vpcaccessProjectsLocationsConnectorsCreate(parent, opts)
...
```javascript
import ServerlessVpcAccessApi from 'serverless_vpc_access_api';
let defaultClient = ServerlessVpcAccessApi.ApiClient.instance;
...
let apiInstance = new ServerlessVpcAccessApi.ProjectsApi();
let parent = "parent_example"; // String | Required. The project ID and location in which the configuration should be created, specified in the format `projects/_*_/locations/_*`.
let opts = {
...
apiInstance.vpcaccessProjectsLocationsConnectorsCreate(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
------------- | ------------- | ------------- | -------------
 **parent** | **String**| Required. The project ID and location in which the configuration should be created, specified in the format &#x60;projects/_*_/locations/_*&#x60;. | 
...
> Operation vpcaccessProjectsLocationsConnectorsDelete(name, opts)
...
let apiInstance = new ServerlessVpcAccessApi.ProjectsApi();
let name = "name_example"; // String | Required. Name of a Serverless VPC Access connector to delete.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
apiInstance.vpcaccessProjectsLocationsConnectorsDelete(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ListConnectorsResponse vpcaccessProjectsLocationsConnectorsList(parent, opts)
...
let apiInstance = new ServerlessVpcAccessApi.ProjectsApi();
let parent = "parent_example"; // String | Required. The project and location from which the routes should be listed.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'pageSize': 56, // Number | Maximum number of functions to return per call.
  'pageToken': "pageToken_example" // String | Continuation token.
};
apiInstance.vpcaccessProjectsLocationsConnectorsList(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **uploadProtocol** | **String**| Upload protocol for media (e.g. \&quot;raw\&quot;, \&quot;multipart\&quot;). | [optional] 
 **uploadType** | **String**| Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;). | [optional] 
 **pageSize** | **Number**| Maximum number of functions to return per call. | [optional] 
...
> Operation vpcaccessProjectsLocationsConnectorsPatch(name, opts)
...
let apiInstance = new ServerlessVpcAccessApi.ProjectsApi();
let name = "name_example"; // String | The resource name in the format `projects/_*_/locations/_*_/connectors/_*`.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'updateMask': "updateMask_example", // String | The fields to update on the entry group. If absent or empty, all modifiable fields are updated.
  'connector': new ServerlessVpcAccessApi.Connector() // Connector | 
};
apiInstance.vpcaccessProjectsLocationsConnectorsPatch(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ListLocationsResponse vpcaccessProjectsLocationsList(name, opts)
...
apiInstance.vpcaccessProjectsLocationsList(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Operation vpcaccessProjectsLocationsOperationsGet(name, opts)
...
apiInstance.vpcaccessProjectsLocationsOperationsGet(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ListOperationsResponse vpcaccessProjectsLocationsOperationsList(name, opts)
...
apiInstance.vpcaccessProjectsLocationsOperationsList(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
