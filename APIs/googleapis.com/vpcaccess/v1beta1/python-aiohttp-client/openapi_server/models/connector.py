...
class Connector(Model):
    ...
    def __init__(self, connected_projects: List[str]=None, create_time: str=None, ip_cidr_range: str=None, last_restart_time: str=None, machine_type: str=None, max_instances: int=None, max_throughput: int=None, min_instances: int=None, min_throughput: int=None, name: str=None, network: str=None, state: str=None, subnet: Subnet=None):
        ...
        :param last_restart_time: The last_restart_time of this Connector.
        ...
        self._last_restart_time = last_restart_time
    ...
    @property
    def last_restart_time(self):
        """Gets the last_restart_time of this Connector.

        Output only. The last restart time of the connector.

        :return: The last_restart_time of this Connector.
        :rtype: str
        """
        return self._last_restart_time

    @last_restart_time.setter
    def last_restart_time(self, last_restart_time):
        """Sets the last_restart_time of this Connector.

        Output only. The last restart time of the connector.

        :param last_restart_time: The last_restart_time of this Connector.
        :type last_restart_time: str
        """
