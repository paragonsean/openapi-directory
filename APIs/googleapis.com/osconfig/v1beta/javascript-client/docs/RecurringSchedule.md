...
**frequency** | **String** | Required. The frequency unit of this recurring schedule. | [optional] 
...
* `FREQUENCY_UNSPECIFIED` (value: `"FREQUENCY_UNSPECIFIED"`)
