...
/*
 * OAIAssignmentOsType.h
 *
 * Defines the criteria for selecting VM Instances by OS type.
 */

#ifndef OAIAssignmentOsType_H
#define OAIAssignmentOsType_H
...
class OAIAssignmentOsType : public OAIObject {
public:
    OAIAssignmentOsType();
    OAIAssignmentOsType(QString json);
    ~OAIAssignmentOsType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssignmentOsType)

#endif // OAIAssignmentOsType_H
