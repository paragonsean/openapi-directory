...
async def osconfig_projects_guest_policies_create(request: web.Request, parent, xgafv=None, access_token=None, alt=None, param_callback=None, fields=None, key=None, oauth_token=None, pretty_print=None, quota_user=None, upload_protocol=None, upload_type=None, guest_policy_id=None, body=None) -> web.Response:
    """osconfig_projects_guest_policies_create

    Create an OS Config guest policy.

    :param parent: Required. The resource name of the parent using one of the following forms: &#x60;projects/{project_number}&#x60;.
    :type parent: str
    ...
    :param guest_policy_id: Required. The logical name of the guest policy in the project with the following restrictions: * Must contain only lowercase letters, numbers, and hyphens. * Must start with a letter. * Must be between 1-63 characters. * Must end with a number or a letter. * Must be unique within the project.
    :type guest_policy_id: str
    :param body: 
    :type body: dict | bytes

    """
    body = GuestPolicy.from_dict(body)
    return web.Response(status=200)


async def osconfig_projects_guest_policies_list(request: web.Request, parent, xgafv=None, access_token=None, alt=None, param_callback=None, fields=None, key=None, oauth_token=None, pretty_print=None, quota_user=None, upload_protocol=None, upload_type=None, page_size=None, page_token=None) -> web.Response:
    ...
    :param upload_type: Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;).
    :type upload_type: str
    :param page_size: The maximum number of guest policies to return.
    :type page_size: int
    :param page_token: A pagination token returned from a previous call to &#x60;ListGuestPolicies&#x60; that indicates where this listing should continue from.
    :type page_token: str
...
async def osconfig_projects_patch_jobs_get(request: web.Request, name, xgafv=None, access_token=None, alt=None, param_callback=None, fields=None, key=None, oauth_token=None, pretty_print=None, quota_user=None, upload_protocol=None, upload_type=None) -> web.Response:
...
async def osconfig_projects_zones_instances_lookup_effective_guest_policy(request: web.Request, instance, xgafv=None, access_token=None, alt=None, param_callback=None, fields=None, key=None, oauth_token=None, pretty_print=None, quota_user=None, upload_protocol=None, upload_type=None, body=None) -> web.Response:
    ...
    """
    body = LookupEffectiveGuestPolicyRequest.from_dict(body)
    return web.Response(status=200)
