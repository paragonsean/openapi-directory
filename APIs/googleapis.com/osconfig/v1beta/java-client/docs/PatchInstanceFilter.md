...
|**groupLabels** | [**List&lt;PatchInstanceFilterGroupLabel&gt;**](PatchInstanceFilterGroupLabel.md) | Targets VM instances matching at least one of these label sets. This allows targeting of disparate groups, for example \&quot;env&#x3D;prod or env&#x3D;staging\&quot;. |  [optional] |
