...
public class OSPolicyAssignmentOperationMetadata {
  ...
  public OSPolicyAssignmentOperationMetadata apiMethod(ApiMethodEnum apiMethod) {
  ...
  public OSPolicyAssignmentOperationMetadata osPolicyAssignment(String osPolicyAssignment) {
  ...
  public OSPolicyAssignmentOperationMetadata rolloutStartTime(String rolloutStartTime) {
  ...
  public OSPolicyAssignmentOperationMetadata rolloutState(RolloutStateEnum rolloutState) {
  ...
  public OSPolicyAssignmentOperationMetadata rolloutUpdateTime(String rolloutUpdateTime) {
  ...
  public boolean equals(Object o) {
    ...
    OSPolicyAssignmentOperationMetadata osPolicyAssignmentOperationMetadata = (OSPolicyAssignmentOperationMetadata) o;
    return Objects.equals(this.apiMethod, osPolicyAssignmentOperationMetadata.apiMethod) &&
        Objects.equals(this.osPolicyAssignment, osPolicyAssignmentOperationMetadata.osPolicyAssignment) &&
        Objects.equals(this.rolloutStartTime, osPolicyAssignmentOperationMetadata.rolloutStartTime) &&
        Objects.equals(this.rolloutState, osPolicyAssignmentOperationMetadata.rolloutState) &&
        Objects.equals(this.rolloutUpdateTime, osPolicyAssignmentOperationMetadata.rolloutUpdateTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class OSPolicyAssignmentOperationMetadata {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OSPolicyAssignmentOperationMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OSPolicyAssignmentOperationMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OSPolicyAssignmentOperationMetadata is not found in the empty JSON string", OSPolicyAssignmentOperationMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OSPolicyAssignmentOperationMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OSPolicyAssignmentOperationMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OSPolicyAssignmentOperationMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OSPolicyAssignmentOperationMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OSPolicyAssignmentOperationMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OSPolicyAssignmentOperationMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<OSPolicyAssignmentOperationMetadata>() {
           @Override
           public void write(JsonWriter out, OSPolicyAssignmentOperationMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OSPolicyAssignmentOperationMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OSPolicyAssignmentOperationMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OSPolicyAssignmentOperationMetadata
   * @throws IOException if the JSON string is invalid with respect to OSPolicyAssignmentOperationMetadata
   */
  public static OSPolicyAssignmentOperationMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OSPolicyAssignmentOperationMetadata.class);
  }

  /**
   * Convert an instance of OSPolicyAssignmentOperationMetadata to an JSON string
   *
   * @return JSON string
   */
