# OsConfigApi.OSPolicyAssignmentReportOSPolicyComplianceOSPolicyResourceCompliance

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**complianceState** | **String** | The compliance state of the resource. | [optional] 
...
**configSteps** | [**[OSPolicyAssignmentReportOSPolicyComplianceOSPolicyResourceComplianceOSPolicyResourceConfigStep]**](OSPolicyAssignmentReportOSPolicyComplianceOSPolicyResourceComplianceOSPolicyResourceConfigStep.md) | Ordered list of configuration completed by the agent for the OS policy resource. | [optional] 
