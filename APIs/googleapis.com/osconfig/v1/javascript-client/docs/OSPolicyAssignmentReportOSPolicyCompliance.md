# OsConfigApi.OSPolicyAssignmentReportOSPolicyCompliance

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**complianceState** | **String** | The compliance state of the OS policy. | [optional] 
...
**osPolicyResourceCompliances** | [**[OSPolicyAssignmentReportOSPolicyComplianceOSPolicyResourceCompliance]**](OSPolicyAssignmentReportOSPolicyComplianceOSPolicyResourceCompliance.md) | Compliance data for each resource within the policy that is applied to the VM. | [optional] 
