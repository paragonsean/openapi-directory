...
QMap<QString, OAIInventoryItem> OAIInventory::getItems() const {
    return m_items;
}
void OAIInventory::setItems(const QMap<QString, OAIInventoryItem> &items) {
    m_items = items;
    m_items_isSet = true;
}
...
OAIInventoryOsInfo OAIInventory::getOsInfo() const {
    return m_os_info;
}
void OAIInventory::setOsInfo(const OAIInventoryOsInfo &os_info) {
    m_os_info = os_info;
