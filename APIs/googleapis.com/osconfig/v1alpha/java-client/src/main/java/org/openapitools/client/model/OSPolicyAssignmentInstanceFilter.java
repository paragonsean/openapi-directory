...
public class OSPolicyAssignmentInstanceFilter {
  ...
  public static final String SERIALIZED_NAME_OS_SHORT_NAMES = "osShortNames";
  @Deprecated
  @SerializedName(SERIALIZED_NAME_OS_SHORT_NAMES)
  private List<String> osShortNames = new ArrayList<>();
  ...
  @Deprecated
  public OSPolicyAssignmentInstanceFilter osShortNames(List<String> osShortNames) {
    this.osShortNames = osShortNames;
    return this;
  }

  public OSPolicyAssignmentInstanceFilter addOsShortNamesItem(String osShortNamesItem) {
    if (this.osShortNames == null) {
      this.osShortNames = new ArrayList<>();
    }
    this.osShortNames.add(osShortNamesItem);
    return this;
  }
  ...
  @Deprecated
  @javax.annotation.Nullable
  public List<String> getOsShortNames() {
    return osShortNames;
  }

  @Deprecated
  public void setOsShortNames(List<String> osShortNames) {
    this.osShortNames = osShortNames;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.all, osPolicyAssignmentInstanceFilter.all) &&
        ...
        Objects.equals(this.osShortNames, osPolicyAssignmentInstanceFilter.osShortNames);
  }

  @Override
  public int hashCode() {
    return Objects.hash(all, exclusionLabels, inclusionLabels, inventories, osShortNames);
  }
  ...
  public String toString() {
    ...
    sb.append("    osShortNames: ").append(toIndentedString(osShortNames)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("osShortNames");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("osShortNames") != null && !jsonObj.get("osShortNames").isJsonNull() && !jsonObj.get("osShortNames").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `osShortNames` to be an array in the JSON string but got `%s`", jsonObj.get("osShortNames").toString()));
      }
  }
