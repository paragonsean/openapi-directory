...
/*
 * OAIOSPolicyOSFilter.h
 *
 * Filtering criteria to select VMs based on OS details.
 */

#ifndef OAIOSPolicyOSFilter_H
#define OAIOSPolicyOSFilter_H
...
class OAIOSPolicyOSFilter : public OAIObject {
public:
    OAIOSPolicyOSFilter();
    OAIOSPolicyOSFilter(QString json);
    ~OAIOSPolicyOSFilter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOSPolicyOSFilter)

#endif // OAIOSPolicyOSFilter_H
