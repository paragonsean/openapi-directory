...
public:
    ...
    Q_DECL_DEPRECATED QList<QString> getOsShortNames() const;
    Q_DECL_DEPRECATED void setOsShortNames(const QList<QString> &os_short_names);
    Q_DECL_DEPRECATED bool is_os_short_names_Set() const;
    Q_DECL_DEPRECATED bool is_os_short_names_Valid() const;
...
private:
    ...
    QList<QString> m_os_short_names;
    bool m_os_short_names_isSet;
    bool m_os_short_names_isValid;
};
