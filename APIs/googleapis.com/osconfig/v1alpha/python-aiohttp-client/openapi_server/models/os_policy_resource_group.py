...
class OSPolicyResourceGroup(Model):
    ...
    def __init__(self, inventory_filters: List[OSPolicyInventoryFilter]=None, os_filter: OSPolicyOSFilter=None, resources: List[OSPolicyResource]=None):
        ...
        :param os_filter: The os_filter of this OSPolicyResourceGroup.
    ...
    @property
    def os_filter(self):
        """Gets the os_filter of this OSPolicyResourceGroup.


        :return: The os_filter of this OSPolicyResourceGroup.
        :rtype: OSPolicyOSFilter
        """
        return self._os_filter

    @os_filter.setter
    def os_filter(self, os_filter):
        """Sets the os_filter of this OSPolicyResourceGroup.


        :param os_filter: The os_filter of this OSPolicyResourceGroup.
        :type os_filter: OSPolicyOSFilter
        """
