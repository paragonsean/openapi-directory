...
class OSPolicyAssignmentInstanceFilter {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('osShortNames')) {
                obj['osShortNames'] = ApiClient.convertToType(data['osShortNames'], ['String']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is an array
        if (!Array.isArray(data['osShortNames'])) {
            throw new Error("Expected the field `osShortNames` to be an array in the JSON data but got " + data['osShortNames']);
        }
 ...
 * @member {Array.<String>} osShortNames
 */
OSPolicyAssignmentInstanceFilter.prototype['osShortNames'] = undefined;
