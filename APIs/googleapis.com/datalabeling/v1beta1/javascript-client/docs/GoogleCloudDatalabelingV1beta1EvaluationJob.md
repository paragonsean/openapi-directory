# DataLabelingApi.GoogleCloudDatalabelingV1beta1EvaluationJob
...
**attempts** | [**[GoogleCloudDatalabelingV1beta1Attempt]**](GoogleCloudDatalabelingV1beta1Attempt.md) | Output only. Every time the evaluation job runs and an error occurs, the failed attempt is appended to this array. | [optional] 
...
**state** | **String** | Output only. Describes the current state of the job. | [optional] 
