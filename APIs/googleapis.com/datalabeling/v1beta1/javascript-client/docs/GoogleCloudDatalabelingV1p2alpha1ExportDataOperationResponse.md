# DataLabelingApi.GoogleCloudDatalabelingV1p2alpha1ExportDataOperationResponse
...
**exportCount** | **Number** | Output only. Number of examples exported successfully. | [optional] 
...
**totalCount** | **Number** | Output only. Total number of examples requested to export | [optional] 
