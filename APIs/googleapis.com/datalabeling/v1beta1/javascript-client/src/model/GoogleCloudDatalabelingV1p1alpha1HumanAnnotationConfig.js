...
/**
 * The GoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig model module.
 * @module model/GoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig
 * @version v1beta1
 */
class GoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig {
    /**
     * Constructs a new <code>GoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig</code>.
     * Configuration for how human labeling task should be done.
     * @alias module:model/GoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig
     */
    constructor() { 
        
        GoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig} obj Optional instance to populate.
     * @return {module:model/GoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig} The populated <code>GoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig();
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig</code>.
     */
 ...
 */
GoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig.prototype['annotatedDatasetDescription'] = undefined;

/**
 * Required. A human-readable name for AnnotatedDataset defined by users. Maximum of 64 characters .
 * @member {String} annotatedDatasetDisplayName
 */
GoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig.prototype['annotatedDatasetDisplayName'] = undefined;

/**
 * Optional. If you want your own labeling contributors to manage and work on this labeling request, you can set these contributors here. We will give them access to the question types in crowdcompute. Note that these emails must be registered in crowdcompute worker UI: https://crowd-compute.appspot.com/
 * @member {Array.<String>} contributorEmails
 */
GoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig.prototype['contributorEmails'] = undefined;

/**
 * Required. Instruction resource name.
 * @member {String} instruction
 */
GoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig.prototype['instruction'] = undefined;

/**
 * Optional. A human-readable label used to logically group labeling tasks. This string must match the regular expression `[a-zA-Z\\\\d_-]{0,128}`.
 * @member {String} labelGroup
 */
GoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig.prototype['labelGroup'] = undefined;
 ...
 */
GoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig.prototype['languageCode'] = undefined;

/**
 * Optional. Maximum duration for contributors to answer a question. Maximum is 3600 seconds. Default is 3600 seconds.
 * @member {String} questionDuration
 */
GoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig.prototype['questionDuration'] = undefined;

/**
 * Optional. Replication of questions. Each question will be sent to up to this number of contributors to label. Aggregated answers will be returned. Default is set to 1. For image related labeling, valid values are 1, 3, 5.
 * @member {Number} replicaCount
 */
GoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig.prototype['replicaCount'] = undefined;

/**
 * Email of the user who started the labeling task and should be notified by email. If empty no notification will be sent.
 * @member {String} userEmailAddress
 */
GoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig.prototype['userEmailAddress'] = undefined;
...
export default GoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig;
