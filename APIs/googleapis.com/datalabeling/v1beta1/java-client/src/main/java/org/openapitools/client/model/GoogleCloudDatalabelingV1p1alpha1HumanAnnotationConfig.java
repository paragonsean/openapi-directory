...
public class GoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig {
  ...
  public GoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig() {
  }

  public GoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig annotatedDatasetDescription(String annotatedDatasetDescription) {
  ...
  public GoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig annotatedDatasetDisplayName(String annotatedDatasetDisplayName) {
  ...
  public GoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig contributorEmails(List<String> contributorEmails) {
    this.contributorEmails = contributorEmails;
    return this;
  }

  public GoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig addContributorEmailsItem(String contributorEmailsItem) {
  ...
  public GoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig instruction(String instruction) {
  ...
  public GoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig labelGroup(String labelGroup) {
  ...
  public GoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig languageCode(String languageCode) {
  ...
  public GoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig questionDuration(String questionDuration) {
  ...
  public GoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig replicaCount(Integer replicaCount) {
  ...
  public GoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig userEmailAddress(String userEmailAddress) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig googleCloudDatalabelingV1p1alpha1HumanAnnotationConfig = (GoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig) o;
    return Objects.equals(this.annotatedDatasetDescription, googleCloudDatalabelingV1p1alpha1HumanAnnotationConfig.annotatedDatasetDescription) &&
        Objects.equals(this.annotatedDatasetDisplayName, googleCloudDatalabelingV1p1alpha1HumanAnnotationConfig.annotatedDatasetDisplayName) &&
        Objects.equals(this.contributorEmails, googleCloudDatalabelingV1p1alpha1HumanAnnotationConfig.contributorEmails) &&
        Objects.equals(this.instruction, googleCloudDatalabelingV1p1alpha1HumanAnnotationConfig.instruction) &&
        Objects.equals(this.labelGroup, googleCloudDatalabelingV1p1alpha1HumanAnnotationConfig.labelGroup) &&
        Objects.equals(this.languageCode, googleCloudDatalabelingV1p1alpha1HumanAnnotationConfig.languageCode) &&
        Objects.equals(this.questionDuration, googleCloudDatalabelingV1p1alpha1HumanAnnotationConfig.questionDuration) &&
        Objects.equals(this.replicaCount, googleCloudDatalabelingV1p1alpha1HumanAnnotationConfig.replicaCount) &&
        Objects.equals(this.userEmailAddress, googleCloudDatalabelingV1p1alpha1HumanAnnotationConfig.userEmailAddress);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig is not found in the empty JSON string", GoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig>() {
           @Override
           public void write(JsonWriter out, GoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig
   */
  public static GoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig.class);
  }

  /**
   * Convert an instance of GoogleCloudDatalabelingV1p1alpha1HumanAnnotationConfig to an JSON string
   *
   * @return JSON string
   */
