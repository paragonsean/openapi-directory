...
public class GoogleCloudDatalabelingV1beta1HumanAnnotationConfig {
  ...
  public GoogleCloudDatalabelingV1beta1HumanAnnotationConfig annotatedDatasetDescription(String annotatedDatasetDescription) {
  ...
  public GoogleCloudDatalabelingV1beta1HumanAnnotationConfig annotatedDatasetDisplayName(String annotatedDatasetDisplayName) {
  ...
  public GoogleCloudDatalabelingV1beta1HumanAnnotationConfig contributorEmails(List<String> contributorEmails) {
    this.contributorEmails = contributorEmails;
    return this;
  }

  public GoogleCloudDatalabelingV1beta1HumanAnnotationConfig addContributorEmailsItem(String contributorEmailsItem) {
  ...
  public GoogleCloudDatalabelingV1beta1HumanAnnotationConfig instruction(String instruction) {
  ...
  public GoogleCloudDatalabelingV1beta1HumanAnnotationConfig labelGroup(String labelGroup) {
  ...
  public GoogleCloudDatalabelingV1beta1HumanAnnotationConfig languageCode(String languageCode) {
  ...
  public GoogleCloudDatalabelingV1beta1HumanAnnotationConfig questionDuration(String questionDuration) {
  ...
  public GoogleCloudDatalabelingV1beta1HumanAnnotationConfig replicaCount(Integer replicaCount) {
  ...
  public GoogleCloudDatalabelingV1beta1HumanAnnotationConfig userEmailAddress(String userEmailAddress) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudDatalabelingV1beta1HumanAnnotationConfig googleCloudDatalabelingV1beta1HumanAnnotationConfig = (GoogleCloudDatalabelingV1beta1HumanAnnotationConfig) o;
    return Objects.equals(this.annotatedDatasetDescription, googleCloudDatalabelingV1beta1HumanAnnotationConfig.annotatedDatasetDescription) &&
        Objects.equals(this.annotatedDatasetDisplayName, googleCloudDatalabelingV1beta1HumanAnnotationConfig.annotatedDatasetDisplayName) &&
        Objects.equals(this.contributorEmails, googleCloudDatalabelingV1beta1HumanAnnotationConfig.contributorEmails) &&
        Objects.equals(this.instruction, googleCloudDatalabelingV1beta1HumanAnnotationConfig.instruction) &&
        Objects.equals(this.labelGroup, googleCloudDatalabelingV1beta1HumanAnnotationConfig.labelGroup) &&
        Objects.equals(this.languageCode, googleCloudDatalabelingV1beta1HumanAnnotationConfig.languageCode) &&
        Objects.equals(this.questionDuration, googleCloudDatalabelingV1beta1HumanAnnotationConfig.questionDuration) &&
        Objects.equals(this.replicaCount, googleCloudDatalabelingV1beta1HumanAnnotationConfig.replicaCount) &&
        Objects.equals(this.userEmailAddress, googleCloudDatalabelingV1beta1HumanAnnotationConfig.userEmailAddress);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudDatalabelingV1beta1HumanAnnotationConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudDatalabelingV1beta1HumanAnnotationConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudDatalabelingV1beta1HumanAnnotationConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudDatalabelingV1beta1HumanAnnotationConfig is not found in the empty JSON string", GoogleCloudDatalabelingV1beta1HumanAnnotationConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudDatalabelingV1beta1HumanAnnotationConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudDatalabelingV1beta1HumanAnnotationConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudDatalabelingV1beta1HumanAnnotationConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudDatalabelingV1beta1HumanAnnotationConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudDatalabelingV1beta1HumanAnnotationConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudDatalabelingV1beta1HumanAnnotationConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudDatalabelingV1beta1HumanAnnotationConfig>() {
           @Override
           public void write(JsonWriter out, GoogleCloudDatalabelingV1beta1HumanAnnotationConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudDatalabelingV1beta1HumanAnnotationConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudDatalabelingV1beta1HumanAnnotationConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudDatalabelingV1beta1HumanAnnotationConfig
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudDatalabelingV1beta1HumanAnnotationConfig
   */
  public static GoogleCloudDatalabelingV1beta1HumanAnnotationConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudDatalabelingV1beta1HumanAnnotationConfig.class);
  }

  /**
   * Convert an instance of GoogleCloudDatalabelingV1beta1HumanAnnotationConfig to an JSON string
   *
   * @return JSON string
   */
