...
from openapi_server.models.google_cloud_networksecurity_v1_certificate_provider import GoogleCloudNetworksecurityV1CertificateProvider
...
class ClientTlsPolicy(Model):
    ...
    def __init__(self, client_certificate: GoogleCloudNetworksecurityV1CertificateProvider=None, create_time: str=None, description: str=None, labels: Dict[str, str]=None, name: str=None, server_validation_ca: List[ValidationCA]=None, sni: str=None, update_time: str=None):
        ...
        """
        self.openapi_types = {
            'client_certificate': GoogleCloudNetworksecurityV1CertificateProvider,
            'create_time': str,
            'description': str,
            'labels': Dict[str, str],
            'name': str,
    ...
    def client_certificate(self):
        ...
        :rtype: GoogleCloudNetworksecurityV1CertificateProvider
        """
    ...
    def client_certificate(self, client_certificate):
        ...
        :param client_certificate: The client_certificate of this ClientTlsPolicy.
        :type client_certificate: GoogleCloudNetworksecurityV1CertificateProvider
        """
