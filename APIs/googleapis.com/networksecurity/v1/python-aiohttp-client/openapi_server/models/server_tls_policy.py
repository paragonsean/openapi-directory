...
class ServerTlsPolicy(Model):
    ...
    def __init__(self, allow_open: bool=None, create_time: str=None, description: str=None, labels: Dict[str, str]=None, mtls_policy: MTLSPolicy=None, name: str=None, server_certificate: GoogleCloudNetworksecurityV1CertificateProvider=None, update_time: str=None):
        ...
        self.openapi_types = {
            ...
            'name': str,
            'server_certificate': GoogleCloudNetworksecurityV1CertificateProvider,
            'update_time': str
        }
    ...
    def server_certificate(self, server_certificate):
        ...
        :param server_certificate: The server_certificate of this ServerTlsPolicy.
        :type server_certificate: GoogleCloudNetworksecurityV1CertificateProvider
        """
