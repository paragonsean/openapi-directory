...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkSecurityApi.ListLocationsResponse();
  });
  ...
  describe('ListLocationsResponse', function() {
    it('should create an instance of ListLocationsResponse', function() {
      ...
      //var instance = new NetworkSecurityApi.ListLocationsResponse();
      //expect(instance).to.be.a(NetworkSecurityApi.ListLocationsResponse);
    });
