# NetworkSecurityApi.TlsInspectionPolicy
...
* `VERSION_UNSPECIFIED` (value: `"TLS_VERSION_UNSPECIFIED"`)
...
* `UNSPECIFIED` (value: `"PROFILE_UNSPECIFIED"`)

* `COMPATIBLE` (value: `"PROFILE_COMPATIBLE"`)

* `MODERN` (value: `"PROFILE_MODERN"`)

* `RESTRICTED` (value: `"PROFILE_RESTRICTED"`)

* `CUSTOM` (value: `"PROFILE_CUSTOM"`)
