...
public class ClientTlsPolicy {
  ...
  public ClientTlsPolicy clientCertificate(GoogleCloudNetworksecurityV1beta1CertificateProvider clientCertificate) {
  ...
  public void setClientCertificate(GoogleCloudNetworksecurityV1beta1CertificateProvider clientCertificate) {
    this.clientCertificate = clientCertificate;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("clientCertificate") != null && !jsonObj.get("clientCertificate").isJsonNull()) {
        GoogleCloudNetworksecurityV1beta1CertificateProvider.validateJsonElement(jsonObj.get("clientCertificate"));
      }
