...
public class ServerTlsPolicy {
  ...
  public ServerTlsPolicy serverCertificate(GoogleCloudNetworksecurityV1beta1CertificateProvider serverCertificate) {
  ...
  public void setServerCertificate(GoogleCloudNetworksecurityV1beta1CertificateProvider serverCertificate) {
    this.serverCertificate = serverCertificate;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("serverCertificate") != null && !jsonObj.get("serverCertificate").isJsonNull()) {
        GoogleCloudNetworksecurityV1beta1CertificateProvider.validateJsonElement(jsonObj.get("serverCertificate"));
      }
