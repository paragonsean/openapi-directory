...
public:
    ...
    * @param[in]  upload_protocol QString [optional]
    * @param[in]  upload_type QString [optional]
    * @param[in]  firewall_endpoint_association_id QString [optional]
    * @param[in]  request_id QString [optional]
    * @param[in]  oai_firewall_endpoint_association OAIFirewallEndpointAssociation [optional]
    */
    virtual void networksecurity_projects_locations_firewallEndpointAssociations_create(const QString &parent, const ::OpenAPI::OptionalParam<QString> &_xgafv = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &access_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &alt = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &callback = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &fields = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &key = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &oauth_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &pretty_print = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &quota_user = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &upload_protocol = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &upload_type = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &firewall_endpoint_association_id = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &request_id = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAIFirewallEndpointAssociation> &oai_firewall_endpoint_association = ::OpenAPI::OptionalParam<OAIFirewallEndpointAssociation>());
...
private:
    ...
    void networksecurity_projects_locations_firewallEndpointAssociations_createCallback(OAIHttpRequestWorker *worker);
    void networksecurity_projects_locations_firewallEndpointAssociations_listCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void networksecurity_projects_locations_firewallEndpointAssociations_createSignal(OAIOperation summary);
    void networksecurity_projects_locations_firewallEndpointAssociations_listSignal(OAIListFirewallEndpointAssociationsResponse summary);
    ...
    void networksecurity_projects_locations_firewallEndpointAssociations_createSignalFull(OAIHttpRequestWorker *worker, OAIOperation summary);
    void networksecurity_projects_locations_firewallEndpointAssociations_listSignalFull(OAIHttpRequestWorker *worker, OAIListFirewallEndpointAssociationsResponse summary);
    ...
    Q_DECL_DEPRECATED_X("Use networksecurity_projects_locations_firewallEndpointAssociations_createSignalError() instead")
    void networksecurity_projects_locations_firewallEndpointAssociations_createSignalE(OAIOperation summary, QNetworkReply::NetworkError error_type, QString error_str);
    void networksecurity_projects_locations_firewallEndpointAssociations_createSignalError(OAIOperation summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use networksecurity_projects_locations_firewallEndpointAssociations_listSignalError() instead")
    void networksecurity_projects_locations_firewallEndpointAssociations_listSignalE(OAIListFirewallEndpointAssociationsResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void networksecurity_projects_locations_firewallEndpointAssociations_listSignalError(OAIListFirewallEndpointAssociationsResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use networksecurity_projects_locations_firewallEndpointAssociations_createSignalErrorFull() instead")
    void networksecurity_projects_locations_firewallEndpointAssociations_createSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void networksecurity_projects_locations_firewallEndpointAssociations_createSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use networksecurity_projects_locations_firewallEndpointAssociations_listSignalErrorFull() instead")
    void networksecurity_projects_locations_firewallEndpointAssociations_listSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void networksecurity_projects_locations_firewallEndpointAssociations_listSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
