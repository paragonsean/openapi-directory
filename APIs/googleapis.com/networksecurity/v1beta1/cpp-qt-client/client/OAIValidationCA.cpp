...
OAIGoogleCloudNetworksecurityV1beta1GrpcEndpoint OAIValidationCA::getGrpcEndpoint() const {
    return m_grpc_endpoint;
}
void OAIValidationCA::setGrpcEndpoint(const OAIGoogleCloudNetworksecurityV1beta1GrpcEndpoint &grpc_endpoint) {
