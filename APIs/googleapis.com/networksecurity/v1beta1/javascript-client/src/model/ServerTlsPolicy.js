...
class ServerTlsPolicy {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('serverCertificate')) {
                obj['serverCertificate'] = GoogleCloudNetworksecurityV1beta1CertificateProvider.constructFromObject(data['serverCertificate']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['serverCertificate']) { // data not null
          GoogleCloudNetworksecurityV1beta1CertificateProvider.validateJSON(data['serverCertificate']);
        }
        // ensure the json data is a string
...
/**
 * @member {module:model/GoogleCloudNetworksecurityV1beta1CertificateProvider} serverCertificate
 */
