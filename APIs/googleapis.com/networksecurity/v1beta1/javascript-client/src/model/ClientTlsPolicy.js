...
class ClientTlsPolicy {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('clientCertificate')) {
                obj['clientCertificate'] = GoogleCloudNetworksecurityV1beta1CertificateProvider.constructFromObject(data['clientCertificate']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['clientCertificate']) { // data not null
          GoogleCloudNetworksecurityV1beta1CertificateProvider.validateJSON(data['clientCertificate']);
        }
...
/**
 * @member {module:model/GoogleCloudNetworksecurityV1beta1CertificateProvider} clientCertificate
 */
