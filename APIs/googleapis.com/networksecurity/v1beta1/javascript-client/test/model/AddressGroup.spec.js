...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkSecurityApi.AddressGroup();
  });
  ...
  describe('AddressGroup', function() {
    it('should create an instance of AddressGroup', function() {
      // uncomment below and update the code to test AddressGroup
      //var instance = new NetworkSecurityApi.AddressGroup();
      //expect(instance).to.be.a(NetworkSecurityApi.AddressGroup);
    });
