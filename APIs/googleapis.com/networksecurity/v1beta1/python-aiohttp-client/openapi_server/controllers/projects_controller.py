...
async def networksecurity_projects_locations_firewall_endpoint_associations_create(request: web.Request, parent, xgafv=None, access_token=None, alt=None, param_callback=None, fields=None, key=None, oauth_token=None, pretty_print=None, quota_user=None, upload_protocol=None, upload_type=None, firewall_endpoint_association_id=None, request_id=None, body=None) -> web.Response:
    """networksecurity_projects_locations_firewall_endpoint_associations_create
    ...
    :param upload_type: Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;).
    :type upload_type: str
    :param firewall_endpoint_association_id: Optional. Id of the requesting object. If auto-generating Id server-side, remove this field and firewall_endpoint_association_id from the method_signature of Create RPC.
    :type firewall_endpoint_association_id: str
    :param request_id: Optional. An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. The server will guarantee that for at least 60 minutes since the first request. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
    :type request_id: str
    :param body: 
    :type body: dict | bytes
    ...
    """
    body = FirewallEndpointAssociation.from_dict(body)
    return web.Response(status=200)


async def networksecurity_projects_locations_firewall_endpoint_associations_list(request: web.Request, parent, xgafv=None, access_token=None, alt=None, param_callback=None, fields=None, key=None, oauth_token=None, pretty_print=None, quota_user=None, upload_protocol=None, upload_type=None, filter=None, order_by=None, page_size=None, page_token=None) -> web.Response:
    """networksecurity_projects_locations_firewall_endpoint_associations_list
