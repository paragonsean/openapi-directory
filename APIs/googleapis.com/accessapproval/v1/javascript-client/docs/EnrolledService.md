# AccessApprovalApi.EnrolledService
...
**enrollmentLevel** | **String** | The enrollment level of the service. | [optional] 
...
* `ENROLLMENT_LEVEL_UNSPECIFIED` (value: `"ENROLLMENT_LEVEL_UNSPECIFIED"`)
