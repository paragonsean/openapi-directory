...
public class OperationMetadata {
  ...
  public OperationMetadata contactCenter(ContactCenter contactCenter) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.apiVersion, operationMetadata.apiVersion) &&
        Objects.equals(this.contactCenter, operationMetadata.contactCenter) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(apiVersion, contactCenter, createTime, endTime, requestedCancellation, statusMessage, target, verb);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("contactCenter") != null && !jsonObj.get("contactCenter").isJsonNull()) {
        ContactCenter.validateJsonElement(jsonObj.get("contactCenter"));
      }
