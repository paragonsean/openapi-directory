...
/*
 * OAIGoogleCloudCommonOperationMetadata.h
 *
 * Represents the metadata of the long-running operation.
 */

#ifndef OAIGoogleCloudCommonOperationMetadata_H
#define OAIGoogleCloudCommonOperationMetadata_H
...
class OAIGoogleCloudCommonOperationMetadata : public OAIObject {
public:
    OAIGoogleCloudCommonOperationMetadata();
    OAIGoogleCloudCommonOperationMetadata(QString json);
    ~OAIGoogleCloudCommonOperationMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudCommonOperationMetadata)

#endif // OAIGoogleCloudCommonOperationMetadata_H
