...
OAIContactCenter OAIOperationMetadata::getContactCenter() const {
    return m_contact_center;
}
void OAIOperationMetadata::setContactCenter(const OAIContactCenter &contact_center) {
    m_contact_center = contact_center;
    m_contact_center_isSet = true;
}

bool OAIOperationMetadata::is_contact_center_Set() const{
    return m_contact_center_isSet;
}

bool OAIOperationMetadata::is_contact_center_Valid() const{
