...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContactCenterAiPlatformApi.GoogleCloudCommonOperationMetadata();
  });
  ...
  describe('GoogleCloudCommonOperationMetadata', function() {
    it('should create an instance of GoogleCloudCommonOperationMetadata', function() {
      // uncomment below and update the code to test GoogleCloudCommonOperationMetadata
      //var instance = new ContactCenterAiPlatformApi.GoogleCloudCommonOperationMetadata();
      //expect(instance).to.be.a(ContactCenterAiPlatformApi.GoogleCloudCommonOperationMetadata);
    });
