...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContactCenterAiPlatformApi.Location();
  });
  ...
  describe('Location', function() {
    it('should create an instance of Location', function() {
      ...
      //var instance = new ContactCenterAiPlatformApi.Location();
      //expect(instance).to.be.a(ContactCenterAiPlatformApi.Location);
    });
