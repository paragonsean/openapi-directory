...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContactCenterAiPlatformApi.Operation();
  });
  ...
  describe('Operation', function() {
    it('should create an instance of Operation', function() {
      ...
      //var instance = new ContactCenterAiPlatformApi.Operation();
      //expect(instance).to.be.a(ContactCenterAiPlatformApi.Operation);
    });
