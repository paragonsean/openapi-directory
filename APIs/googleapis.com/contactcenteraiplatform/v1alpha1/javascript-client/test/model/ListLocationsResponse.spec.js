...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContactCenterAiPlatformApi.ListLocationsResponse();
  });
  ...
  describe('ListLocationsResponse', function() {
    it('should create an instance of ListLocationsResponse', function() {
      ...
      //var instance = new ContactCenterAiPlatformApi.ListLocationsResponse();
      //expect(instance).to.be.a(ContactCenterAiPlatformApi.ListLocationsResponse);
    });
