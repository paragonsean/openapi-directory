...
class OperationMetadata {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('contactCenter')) {
                obj['contactCenter'] = ContactCenter.constructFromObject(data['contactCenter']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['contactCenter']) { // data not null
          ContactCenter.validateJSON(data['contactCenter']);
        }
        // ensure the json data is a string
...
/**
 * @member {module:model/ContactCenter} contactCenter
 */
OperationMetadata.prototype['contactCenter'] = undefined;
