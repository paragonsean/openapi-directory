...
class OperationMetadata(Model):
    ...
    def __init__(self, api_version: str=None, contact_center: ContactCenter=None, create_time: str=None, end_time: str=None, requested_cancellation: bool=None, status_message: str=None, target: str=None, verb: str=None):
        """OperationMetadata - a model defined in OpenAPI

        :param api_version: The api_version of this OperationMetadata.
        :param contact_center: The contact_center of this OperationMetadata.
    ...
    def contact_center(self):
        """Gets the contact_center of this OperationMetadata.


        :return: The contact_center of this OperationMetadata.
        :rtype: ContactCenter
        """
    ...
    def contact_center(self, contact_center):
        """Sets the contact_center of this OperationMetadata.
