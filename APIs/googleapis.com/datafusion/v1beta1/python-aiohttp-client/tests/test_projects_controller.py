...
async def test_datafusion_projects_locations_instances_dns_peerings_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/{parent}/dnsPeerings'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_datafusion_projects_locations_instances_namespaces_get_iam_policy(client):
...
async def test_datafusion_projects_locations_instances_namespaces_list(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1beta1/{parent}/namespaces'.format(parent='parent_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_datafusion_projects_locations_instances_namespaces_set_iam_policy(client):
...
async def test_datafusion_projects_locations_instances_namespaces_test_iam_permissions(client):
...
async def test_datafusion_projects_locations_instances_restart(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/{namerestar}'.format(name='name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_datafusion_projects_locations_instances_upgrade(client):
...
async def test_datafusion_projects_locations_remove_iam_policy(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/{resourceremove_iam_polic}'.format(resource='resource_example'),
        headers=headers,
        json=body,
        params=params,
        )
