...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudDataFusionApi.ListLocationsResponse();
  });
  ...
  describe('ListLocationsResponse', function() {
    it('should create an instance of ListLocationsResponse', function() {
      ...
      //var instance = new CloudDataFusionApi.ListLocationsResponse();
      //expect(instance).to.be.a(CloudDataFusionApi.ListLocationsResponse);
    });
