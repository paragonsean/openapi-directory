...
(function(root, factory) {
  ...
  describe('ProjectsApi', function() {
    ...
    describe('datafusionProjectsLocationsInstancesGetIamPolicy', function() {
      it('should call datafusionProjectsLocationsInstancesGetIamPolicy successfully', function(done) {
        //uncomment below and update the code to test datafusionProjectsLocationsInstancesGetIamPolicy
        //instance.datafusionProjectsLocationsInstancesGetIamPolicy(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('datafusionProjectsLocationsInstancesSetIamPolicy', function() {
      it('should call datafusionProjectsLocationsInstancesSetIamPolicy successfully', function(done) {
        //uncomment below and update the code to test datafusionProjectsLocationsInstancesSetIamPolicy
        //instance.datafusionProjectsLocationsInstancesSetIamPolicy(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('datafusionProjectsLocationsInstancesTestIamPermissions', function() {
      it('should call datafusionProjectsLocationsInstancesTestIamPermissions successfully', function(done) {
        //uncomment below and update the code to test datafusionProjectsLocationsInstancesTestIamPermissions
        //instance.datafusionProjectsLocationsInstancesTestIamPermissions(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
