    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('additionalStatus')) {
                obj['additionalStatus'] = ApiClient.convertToType(data['additionalStatus'], {'String': 'String'});
            }
 ...
 * @member {Object.<String, String>} additionalStatus
 */
OperationMetadata.prototype['additionalStatus'] = undefined;
