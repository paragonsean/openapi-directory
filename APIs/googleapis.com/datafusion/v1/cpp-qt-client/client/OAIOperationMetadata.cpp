...
QMap<QString, QString> OAIOperationMetadata::getAdditionalStatus() const {
    return m_additional_status;
}
void OAIOperationMetadata::setAdditionalStatus(const QMap<QString, QString> &additional_status) {
    m_additional_status = additional_status;
    m_additional_status_isSet = true;
}

bool OAIOperationMetadata::is_additional_status_Set() const{
    return m_additional_status_isSet;
}

bool OAIOperationMetadata::is_additional_status_Valid() const{
