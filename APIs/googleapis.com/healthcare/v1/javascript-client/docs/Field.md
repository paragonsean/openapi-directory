# CloudHealthcareApi.Field

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**maxOccurs** | **Number** | The maximum number of times this field can be repeated. 0 or -1 means unbounded. | [optional] 
**minOccurs** | **Number** | The minimum number of times this field must be present/repeated. | [optional] 
