    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('policies')) {
                obj['policies'] = ApiClient.convertToType(data['policies'], [GoogleCloudHealthcareV1ConsentPolicy]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['policies']) { // data not null
            ...
            for (const item of data['policies']) {
                GoogleCloudHealthcareV1ConsentPolicy.validateJSON(item);
            };
        }
        // ensure the json data is a string
 ...
 * @member {Array.<module:model/GoogleCloudHealthcareV1ConsentPolicy>} policies
 */
