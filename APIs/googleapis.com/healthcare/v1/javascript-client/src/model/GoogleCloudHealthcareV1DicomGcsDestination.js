...
/**
 * The GoogleCloudHealthcareV1DicomGcsDestination model module.
 * @module model/GoogleCloudHealthcareV1DicomGcsDestination
 * @version v1
 */
class GoogleCloudHealthcareV1DicomGcsDestination {
    /**
     * Constructs a new <code>GoogleCloudHealthcareV1DicomGcsDestination</code>.
     * The Cloud Storage location where the server writes the output and the export configuration.
     * @alias module:model/GoogleCloudHealthcareV1DicomGcsDestination
     */
    constructor() { 
        
        GoogleCloudHealthcareV1DicomGcsDestination.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudHealthcareV1DicomGcsDestination</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudHealthcareV1DicomGcsDestination} obj Optional instance to populate.
     * @return {module:model/GoogleCloudHealthcareV1DicomGcsDestination} The populated <code>GoogleCloudHealthcareV1DicomGcsDestination</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudHealthcareV1DicomGcsDestination();
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudHealthcareV1DicomGcsDestination</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudHealthcareV1DicomGcsDestination</code>.
     */
 ...
 */
GoogleCloudHealthcareV1DicomGcsDestination.prototype['mimeType'] = undefined;
 ...
 */
GoogleCloudHealthcareV1DicomGcsDestination.prototype['uriPrefix'] = undefined;
...
export default GoogleCloudHealthcareV1DicomGcsDestination;
