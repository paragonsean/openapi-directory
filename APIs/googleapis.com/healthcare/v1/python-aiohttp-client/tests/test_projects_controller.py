...
async def test_healthcare_projects_locations_datasets_consent_stores_attribute_definitions_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/attributeDefinitions'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_healthcare_projects_locations_datasets_consent_stores_check_data_access(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{consent_storecheck_data_acces}'.format(consent_store='consent_store_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_healthcare_projects_locations_datasets_consent_stores_consent_artifacts_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/consentArtifacts'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_healthcare_projects_locations_datasets_consent_stores_consents_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/consents'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_healthcare_projects_locations_datasets_consent_stores_consents_reject(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{namerejec}'.format(name='name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_healthcare_projects_locations_datasets_consent_stores_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/consentStores'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_healthcare_projects_locations_datasets_consent_stores_evaluate_user_consents(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{consent_storeevaluate_user_consent}'.format(consent_store='consent_store_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_healthcare_projects_locations_datasets_consent_stores_query_accessible_data(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{consent_storequery_accessible_dat}'.format(consent_store='consent_store_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_healthcare_projects_locations_datasets_consent_stores_user_data_mappings_archive(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{namearchiv}'.format(name='name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_healthcare_projects_locations_datasets_consent_stores_user_data_mappings_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/userDataMappings'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_healthcare_projects_locations_datasets_deidentify(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{source_datasetdeidentif}'.format(source_dataset='source_dataset_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_healthcare_projects_locations_datasets_dicom_stores_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/dicomStores'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_healthcare_projects_locations_datasets_dicom_stores_dicom_web_studies_get_study_metrics(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/{studyget_study_metric}'.format(study='study_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_healthcare_projects_locations_datasets_dicom_stores_dicom_web_studies_series_get_series_metrics(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/{seriesget_series_metric}'.format(series='series_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_healthcare_projects_locations_datasets_dicom_stores_get_dicom_store_metrics(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/{nameget_dicom_store_metric}'.format(name='name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_healthcare_projects_locations_datasets_dicom_stores_studies_series_instances_delete(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/v1/{parent}/dicomWeb/{dicom_web_path}'.format(parent='parent_example', dicom_web_path='dicom_web_path_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_healthcare_projects_locations_datasets_fhir_stores_create(client):
    ...
    """
    body = {"defaultSearchHandlingStrict":True,"streamConfigs":[{"resourceTypes":["resourceTypes","resourceTypes"],"bigqueryDestination":{"datasetUri":"datasetUri","schemaConfig":{"recursiveStructureDepth":"recursiveStructureDepth","schemaType":"SCHEMA_TYPE_UNSPECIFIED","lastUpdatedPartitionConfig":{"expirationMs":"expirationMs","type":"PARTITION_TYPE_UNSPECIFIED"}},"writeDisposition":"WRITE_DISPOSITION_UNSPECIFIED","force":True},"deidentifiedStoreDestination":{"store":"store","config":{"image":{"textRedactionMode":"TEXT_REDACTION_MODE_UNSPECIFIED"},"fhir":{"fieldMetadataList":[{"paths":["paths","paths"],"action":"ACTION_UNSPECIFIED"},{"paths":["paths","paths"],"action":"ACTION_UNSPECIFIED"}],"defaultKeepExtensions":True},"useRegionalDataProcessing":True,"text":{"excludeInfoTypes":["excludeInfoTypes","excludeInfoTypes"],"transformations":[{"redactConfig":"{}","cryptoHashConfig":{"kmsWrapped":{"cryptoKey":"cryptoKey","wrappedKey":"wrappedKey"},"cryptoKey":"cryptoKey"},"dateShiftConfig":{"kmsWrapped":{"cryptoKey":"cryptoKey","wrappedKey":"wrappedKey"},"cryptoKey":"cryptoKey"},"infoTypes":["infoTypes","infoTypes"],"replaceWithInfoTypeConfig":"{}","characterMaskConfig":{"maskingCharacter":"maskingCharacter"}},{"redactConfig":"{}","cryptoHashConfig":{"kmsWrapped":{"cryptoKey":"cryptoKey","wrappedKey":"wrappedKey"},"cryptoKey":"cryptoKey"},"dateShiftConfig":{"kmsWrapped":{"cryptoKey":"cryptoKey","wrappedKey":"wrappedKey"},"cryptoKey":"cryptoKey"},"infoTypes":["infoTypes","infoTypes"],"replaceWithInfoTypeConfig":"{}","characterMaskConfig":{"maskingCharacter":"maskingCharacter"}}],"additionalTransformations":[{"redactConfig":"{}","cryptoHashConfig":{"kmsWrapped":{"cryptoKey":"cryptoKey","wrappedKey":"wrappedKey"},"cryptoKey":"cryptoKey"},"dateShiftConfig":{"kmsWrapped":{"cryptoKey":"cryptoKey","wrappedKey":"wrappedKey"},"cryptoKey":"cryptoKey"},"infoTypes":["infoTypes","infoTypes"],"replaceWithInfoTypeConfig":"{}","characterMaskConfig":{"maskingCharacter":"maskingCharacter"}},{"redactConfig":"{}","cryptoHashConfig":{"kmsWrapped":{"cryptoKey":"cryptoKey","wrappedKey":"wrappedKey"},"cryptoKey":"cryptoKey"},"dateShiftConfig":{"kmsWrapped":{"cryptoKey":"cryptoKey","wrappedKey":"wrappedKey"},"cryptoKey":"cryptoKey"},"infoTypes":["infoTypes","infoTypes"],"replaceWithInfoTypeConfig":"{}","characterMaskConfig":{"maskingCharacter":"maskingCharacter"}}]},"dicom":{"filterProfile":"TAG_FILTER_PROFILE_UNSPECIFIED","removeList":{"tags":["tags","tags"]},"keepList":{"tags":["tags","tags"]},"skipIdRedaction":True}}}},{"resourceTypes":["resourceTypes","resourceTypes"],"bigqueryDestination":{"datasetUri":"datasetUri","schemaConfig":{"recursiveStructureDepth":"recursiveStructureDepth","schemaType":"SCHEMA_TYPE_UNSPECIFIED","lastUpdatedPartitionConfig":{"expirationMs":"expirationMs","type":"PARTITION_TYPE_UNSPECIFIED"}},"writeDisposition":"WRITE_DISPOSITION_UNSPECIFIED","force":True},"deidentifiedStoreDestination":{"store":"store","config":{"image":{"textRedactionMode":"TEXT_REDACTION_MODE_UNSPECIFIED"},"fhir":{"fieldMetadataList":[{"paths":["paths","paths"],"action":"ACTION_UNSPECIFIED"},{"paths":["paths","paths"],"action":"ACTION_UNSPECIFIED"}],"defaultKeepExtensions":True},"useRegionalDataProcessing":True,"text":{"excludeInfoTypes":["excludeInfoTypes","excludeInfoTypes"],"transformations":[{"redactConfig":"{}","cryptoHashConfig":{"kmsWrapped":{"cryptoKey":"cryptoKey","wrappedKey":"wrappedKey"},"cryptoKey":"cryptoKey"},"dateShiftConfig":{"kmsWrapped":{"cryptoKey":"cryptoKey","wrappedKey":"wrappedKey"},"cryptoKey":"cryptoKey"},"infoTypes":["infoTypes","infoTypes"],"replaceWithInfoTypeConfig":"{}","characterMaskConfig":{"maskingCharacter":"maskingCharacter"}},{"redactConfig":"{}","cryptoHashConfig":{"kmsWrapped":{"cryptoKey":"cryptoKey","wrappedKey":"wrappedKey"},"cryptoKey":"cryptoKey"},"dateShiftConfig":{"kmsWrapped":{"cryptoKey":"cryptoKey","wrappedKey":"wrappedKey"},"cryptoKey":"cryptoKey"},"infoTypes":["infoTypes","infoTypes"],"replaceWithInfoTypeConfig":"{}","characterMaskConfig":{"maskingCharacter":"maskingCharacter"}}],"additionalTransformations":[{"redactConfig":"{}","cryptoHashConfig":{"kmsWrapped":{"cryptoKey":"cryptoKey","wrappedKey":"wrappedKey"},"cryptoKey":"cryptoKey"},"dateShiftConfig":{"kmsWrapped":{"cryptoKey":"cryptoKey","wrappedKey":"wrappedKey"},"cryptoKey":"cryptoKey"},"infoTypes":["infoTypes","infoTypes"],"replaceWithInfoTypeConfig":"{}","characterMaskConfig":{"maskingCharacter":"maskingCharacter"}},{"redactConfig":"{}","cryptoHashConfig":{"kmsWrapped":{"cryptoKey":"cryptoKey","wrappedKey":"wrappedKey"},"cryptoKey":"cryptoKey"},"dateShiftConfig":{"kmsWrapped":{"cryptoKey":"cryptoKey","wrappedKey":"wrappedKey"},"cryptoKey":"cryptoKey"},"infoTypes":["infoTypes","infoTypes"],"replaceWithInfoTypeConfig":"{}","characterMaskConfig":{"maskingCharacter":"maskingCharacter"}}]},"dicom":{"filterProfile":"TAG_FILTER_PROFILE_UNSPECIFIED","removeList":{"tags":["tags","tags"]},"keepList":{"tags":["tags","tags"]},"skipIdRedaction":True}}}}],"disableReferentialIntegrity":True,"complexDataTypeReferenceParsing":"COMPLEX_DATA_TYPE_REFERENCE_PARSING_UNSPECIFIED","name":"name","disableResourceVersioning":True,"enableUpdateCreate":True,"notificationConfig":{"sendForBulkImport":True,"pubsubTopic":"pubsubTopic"},"notificationConfigs":[{"sendPreviousResourceOnDelete":True,"sendFullResource":True,"pubsubTopic":"pubsubTopic"},{"sendPreviousResourceOnDelete":True,"sendFullResource":True,"pubsubTopic":"pubsubTopic"}],"validationConfig":{"disableProfileValidation":True,"enabledImplementationGuides":["enabledImplementationGuides","enabledImplementationGuides"],"disableRequiredFieldValidation":True,"disableReferenceTypeValidation":True,"disableFhirpathValidation":True},"version":"VERSION_UNSPECIFIED","labels":{"key":"labels"}}
    params = [('$.xgafv', 'xgafv_example'),
                    ('access_token', 'access_token_example'),
                    ('alt', 'alt_example'),
                    ('callback', 'param_callback_example'),
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/fhirStores'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_healthcare_projects_locations_datasets_fhir_stores_deidentify(client):
    ...
    """
    body = {"skipModifiedResources":True,"destinationStore":"destinationStore","gcsConfigUri":"gcsConfigUri","resourceFilter":{"resources":{"resources":["resources","resources"]}},"config":{"image":{"textRedactionMode":"TEXT_REDACTION_MODE_UNSPECIFIED"},"fhir":{"fieldMetadataList":[{"paths":["paths","paths"],"action":"ACTION_UNSPECIFIED"},{"paths":["paths","paths"],"action":"ACTION_UNSPECIFIED"}],"defaultKeepExtensions":True},"useRegionalDataProcessing":True,"text":{"excludeInfoTypes":["excludeInfoTypes","excludeInfoTypes"],"transformations":[{"redactConfig":"{}","cryptoHashConfig":{"kmsWrapped":{"cryptoKey":"cryptoKey","wrappedKey":"wrappedKey"},"cryptoKey":"cryptoKey"},"dateShiftConfig":{"kmsWrapped":{"cryptoKey":"cryptoKey","wrappedKey":"wrappedKey"},"cryptoKey":"cryptoKey"},"infoTypes":["infoTypes","infoTypes"],"replaceWithInfoTypeConfig":"{}","characterMaskConfig":{"maskingCharacter":"maskingCharacter"}},{"redactConfig":"{}","cryptoHashConfig":{"kmsWrapped":{"cryptoKey":"cryptoKey","wrappedKey":"wrappedKey"},"cryptoKey":"cryptoKey"},"dateShiftConfig":{"kmsWrapped":{"cryptoKey":"cryptoKey","wrappedKey":"wrappedKey"},"cryptoKey":"cryptoKey"},"infoTypes":["infoTypes","infoTypes"],"replaceWithInfoTypeConfig":"{}","characterMaskConfig":{"maskingCharacter":"maskingCharacter"}}],"additionalTransformations":[{"redactConfig":"{}","cryptoHashConfig":{"kmsWrapped":{"cryptoKey":"cryptoKey","wrappedKey":"wrappedKey"},"cryptoKey":"cryptoKey"},"dateShiftConfig":{"kmsWrapped":{"cryptoKey":"cryptoKey","wrappedKey":"wrappedKey"},"cryptoKey":"cryptoKey"},"infoTypes":["infoTypes","infoTypes"],"replaceWithInfoTypeConfig":"{}","characterMaskConfig":{"maskingCharacter":"maskingCharacter"}},{"redactConfig":"{}","cryptoHashConfig":{"kmsWrapped":{"cryptoKey":"cryptoKey","wrappedKey":"wrappedKey"},"cryptoKey":"cryptoKey"},"dateShiftConfig":{"kmsWrapped":{"cryptoKey":"cryptoKey","wrappedKey":"wrappedKey"},"cryptoKey":"cryptoKey"},"infoTypes":["infoTypes","infoTypes"],"replaceWithInfoTypeConfig":"{}","characterMaskConfig":{"maskingCharacter":"maskingCharacter"}}]},"dicom":{"filterProfile":"TAG_FILTER_PROFILE_UNSPECIFIED","removeList":{"tags":["tags","tags"]},"keepList":{"tags":["tags","tags"]},"skipIdRedaction":True}}}
    params = [('$.xgafv', 'xgafv_example'),
                    ('access_token', 'access_token_example'),
                    ('alt', 'alt_example'),
                    ('callback', 'param_callback_example'),
    ...
    response = await client.request(
        method='POST',
        path='/v1/{source_storedeidentif}'.format(source_store='source_store_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_healthcare_projects_locations_datasets_fhir_stores_fhir_capabilities(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/{name}/fhir/metadata'.format(name='name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_healthcare_projects_locations_datasets_fhir_stores_fhir_conditional_delete(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/v1/{parent}/fhir/{type}'.format(parent='parent_example', type='type_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_healthcare_projects_locations_datasets_fhir_stores_fhir_execute_bundle(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/fhir'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_healthcare_projects_locations_datasets_fhir_stores_fhir_history(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/{name}/_history'.format(name='name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_healthcare_projects_locations_datasets_fhir_stores_fhir_patient_everything(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/{name}/$everything'.format(name='name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_healthcare_projects_locations_datasets_fhir_stores_fhir_resource_purge(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/v1/{name}/$purge'.format(name='name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_healthcare_projects_locations_datasets_fhir_stores_fhir_resource_validate(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/fhir/{type}/$validate'.format(parent='parent_example', type='type_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_healthcare_projects_locations_datasets_fhir_stores_fhir_search(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/fhir/_search'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_healthcare_projects_locations_datasets_fhir_stores_fhir_search_type(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/fhir/{resource_type}/_search'.format(parent='parent_example', resource_type='resource_type_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_healthcare_projects_locations_datasets_fhir_stores_get_fhir_store_metrics(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/{nameget_fhir_store_metric}'.format(name='name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_healthcare_projects_locations_datasets_hl7_v2_stores_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/hl7V2Stores'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_healthcare_projects_locations_datasets_hl7_v2_stores_get_hl7v2_store_metrics(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/{nameget_hl7v2_store_metric}'.format(name='name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_healthcare_projects_locations_datasets_hl7_v2_stores_messages_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/messages'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_healthcare_projects_locations_datasets_hl7_v2_stores_messages_ingest(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/messages:ingest'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_healthcare_projects_locations_services_nlp_analyze_entities(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{nlp_serviceanalyze_entitie}'.format(nlp_service='nlp_service_example'),
        headers=headers,
        json=body,
        params=params,
        )
