...
class GoogleCloudHealthcareV1DicomGcsDestination(Model):
    ...
    def __init__(self, mime_type: str=None, uri_prefix: str=None):
        """GoogleCloudHealthcareV1DicomGcsDestination - a model defined in OpenAPI

        :param mime_type: The mime_type of this GoogleCloudHealthcareV1DicomGcsDestination.
        :param uri_prefix: The uri_prefix of this GoogleCloudHealthcareV1DicomGcsDestination.
        """
        self.openapi_types = {
            'mime_type': str,
            'uri_prefix': str
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'GoogleCloudHealthcareV1DicomGcsDestination':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The GoogleCloudHealthcareV1DicomGcsDestination of this GoogleCloudHealthcareV1DicomGcsDestination.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def mime_type(self):
        """Gets the mime_type of this GoogleCloudHealthcareV1DicomGcsDestination.
        ...
        :return: The mime_type of this GoogleCloudHealthcareV1DicomGcsDestination.
        :rtype: str
        """
    ...
    def mime_type(self, mime_type):
        """Sets the mime_type of this GoogleCloudHealthcareV1DicomGcsDestination.
    ...
    @property
    def uri_prefix(self):
        """Gets the uri_prefix of this GoogleCloudHealthcareV1DicomGcsDestination.

        The Cloud Storage destination to export to. URI for a Cloud Storage directory where the server writes the result files, in the format `gs://{bucket-id}/{path/to/destination/dir}`). If there is no trailing slash, the service appends one when composing the object path. The user is responsible for creating the Cloud Storage bucket referenced in `uri_prefix`.

        :return: The uri_prefix of this GoogleCloudHealthcareV1DicomGcsDestination.
        :rtype: str
        """
    ...
    def uri_prefix(self, uri_prefix):
        """Sets the uri_prefix of this GoogleCloudHealthcareV1DicomGcsDestination.
