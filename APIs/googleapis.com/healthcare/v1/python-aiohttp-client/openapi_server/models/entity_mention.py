...
class EntityMention(Model):
    ...
    def __init__(self, certainty_assessment: Feature=None, confidence: float=None, linked_entities: List[LinkedEntity]=None, mention_id: str=None, subject: Feature=None, temporal_assessment: Feature=None, text: TextSpan=None, type: str=None):
