...
class StreamConfig(Model):
    ...
    def __init__(self, bigquery_destination: GoogleCloudHealthcareV1FhirBigQueryDestination=None, deidentified_store_destination: DeidentifiedStoreDestination=None, resource_types: List[str]=None):
