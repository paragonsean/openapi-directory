...
class DicomStore(Model):
    ...
    def __init__(self, labels: Dict[str, str]=None, name: str=None, notification_config: NotificationConfig=None, stream_configs: List[GoogleCloudHealthcareV1DicomStreamConfig]=None):
        ...
        self.openapi_types = {
            ...
            'stream_configs': List[GoogleCloudHealthcareV1DicomStreamConfig]
        }
    ...
    def stream_configs(self):
        ...
        :rtype: List[GoogleCloudHealthcareV1DicomStreamConfig]
        """
    ...
    def stream_configs(self, stream_configs):
        ...
        :param stream_configs: The stream_configs of this DicomStore.
        :type stream_configs: List[GoogleCloudHealthcareV1DicomStreamConfig]
        """
