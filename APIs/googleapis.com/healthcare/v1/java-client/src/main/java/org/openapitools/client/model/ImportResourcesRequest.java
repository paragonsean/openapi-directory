...
public class ImportResourcesRequest {
  ...
  public ImportResourcesRequest gcsSource(GoogleCloudHealthcareV1FhirGcsSource gcsSource) {
  ...
  public void setGcsSource(GoogleCloudHealthcareV1FhirGcsSource gcsSource) {
    this.gcsSource = gcsSource;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("gcsSource") != null && !jsonObj.get("gcsSource").isJsonNull()) {
        GoogleCloudHealthcareV1FhirGcsSource.validateJsonElement(jsonObj.get("gcsSource"));
      }
  }
