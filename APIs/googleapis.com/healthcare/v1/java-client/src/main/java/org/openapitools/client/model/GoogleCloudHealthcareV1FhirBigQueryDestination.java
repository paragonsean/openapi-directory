...
public class GoogleCloudHealthcareV1FhirBigQueryDestination {
  ...
  public GoogleCloudHealthcareV1FhirBigQueryDestination() {
  }

  public GoogleCloudHealthcareV1FhirBigQueryDestination datasetUri(String datasetUri) {
  ...
  public GoogleCloudHealthcareV1FhirBigQueryDestination force(Boolean force) {
    this.force = force;
    return this;
  }
  ...
  public GoogleCloudHealthcareV1FhirBigQueryDestination schemaConfig(SchemaConfig schemaConfig) {
  ...
  public GoogleCloudHealthcareV1FhirBigQueryDestination writeDisposition(WriteDispositionEnum writeDisposition) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudHealthcareV1FhirBigQueryDestination googleCloudHealthcareV1FhirBigQueryDestination = (GoogleCloudHealthcareV1FhirBigQueryDestination) o;
    return Objects.equals(this.datasetUri, googleCloudHealthcareV1FhirBigQueryDestination.datasetUri) &&
        Objects.equals(this.force, googleCloudHealthcareV1FhirBigQueryDestination.force) &&
        Objects.equals(this.schemaConfig, googleCloudHealthcareV1FhirBigQueryDestination.schemaConfig) &&
        Objects.equals(this.writeDisposition, googleCloudHealthcareV1FhirBigQueryDestination.writeDisposition);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudHealthcareV1FhirBigQueryDestination {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudHealthcareV1FhirBigQueryDestination
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudHealthcareV1FhirBigQueryDestination.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudHealthcareV1FhirBigQueryDestination is not found in the empty JSON string", GoogleCloudHealthcareV1FhirBigQueryDestination.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudHealthcareV1FhirBigQueryDestination.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudHealthcareV1FhirBigQueryDestination` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudHealthcareV1FhirBigQueryDestination.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudHealthcareV1FhirBigQueryDestination' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudHealthcareV1FhirBigQueryDestination> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudHealthcareV1FhirBigQueryDestination.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudHealthcareV1FhirBigQueryDestination>() {
           @Override
           public void write(JsonWriter out, GoogleCloudHealthcareV1FhirBigQueryDestination value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudHealthcareV1FhirBigQueryDestination read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudHealthcareV1FhirBigQueryDestination given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudHealthcareV1FhirBigQueryDestination
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudHealthcareV1FhirBigQueryDestination
   */
  public static GoogleCloudHealthcareV1FhirBigQueryDestination fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudHealthcareV1FhirBigQueryDestination.class);
  }

  /**
   * Convert an instance of GoogleCloudHealthcareV1FhirBigQueryDestination to an JSON string
   *
   * @return JSON string
   */
