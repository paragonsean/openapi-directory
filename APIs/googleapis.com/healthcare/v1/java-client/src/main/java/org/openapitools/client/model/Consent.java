...
public class Consent {
  ...
  private List<GoogleCloudHealthcareV1ConsentPolicy> policies = new ArrayList<>();
  ...
  public Consent policies(List<GoogleCloudHealthcareV1ConsentPolicy> policies) {
    this.policies = policies;
    return this;
  }

  public Consent addPoliciesItem(GoogleCloudHealthcareV1ConsentPolicy policiesItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<GoogleCloudHealthcareV1ConsentPolicy> getPolicies() {
    return policies;
  }

  public void setPolicies(List<GoogleCloudHealthcareV1ConsentPolicy> policies) {
    this.policies = policies;
  }
      ...
      if (jsonObj.get("policies") != null && !jsonObj.get("policies").isJsonNull()) {
        ...
        if (jsonArraypolicies != null) {
          ...
          for (int i = 0; i < jsonArraypolicies.size(); i++) {
            GoogleCloudHealthcareV1ConsentPolicy.validateJsonElement(jsonArraypolicies.get(i));
          };
        }
      }
