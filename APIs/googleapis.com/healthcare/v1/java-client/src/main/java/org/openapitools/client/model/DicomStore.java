...
public class DicomStore {
  ...
  private List<GoogleCloudHealthcareV1DicomStreamConfig> streamConfigs = new ArrayList<>();
  ...
  public DicomStore streamConfigs(List<GoogleCloudHealthcareV1DicomStreamConfig> streamConfigs) {
    this.streamConfigs = streamConfigs;
    return this;
  }

  public DicomStore addStreamConfigsItem(GoogleCloudHealthcareV1DicomStreamConfig streamConfigsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<GoogleCloudHealthcareV1DicomStreamConfig> getStreamConfigs() {
    return streamConfigs;
  }

  public void setStreamConfigs(List<GoogleCloudHealthcareV1DicomStreamConfig> streamConfigs) {
    this.streamConfigs = streamConfigs;
  }
      ...
      if (jsonObj.get("streamConfigs") != null && !jsonObj.get("streamConfigs").isJsonNull()) {
        ...
        if (jsonArraystreamConfigs != null) {
          ...
          for (int i = 0; i < jsonArraystreamConfigs.size(); i++) {
            GoogleCloudHealthcareV1DicomStreamConfig.validateJsonElement(jsonArraystreamConfigs.get(i));
          };
        }
      }
  }
