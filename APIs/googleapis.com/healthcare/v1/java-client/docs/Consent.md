...
|**policies** | [**List&lt;GoogleCloudHealthcareV1ConsentPolicy&gt;**](GoogleCloudHealthcareV1ConsentPolicy.md) | Optional. Represents a user&#39;s consent in terms of the resources that can be accessed and under what conditions. |  [optional] |
...
|**state** | [**StateEnum**](#StateEnum) | Required. Indicates the current state of this Consent. |  [optional] |
