...
QList<OAIGoogleCloudHealthcareV1ConsentPolicy> OAIConsent::getPolicies() const {
    return m_policies;
}
void OAIConsent::setPolicies(const QList<OAIGoogleCloudHealthcareV1ConsentPolicy> &policies) {
    m_policies = policies;
