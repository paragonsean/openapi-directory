...
QList<OAIGoogleCloudHealthcareV1DicomStreamConfig> OAIDicomStore::getStreamConfigs() const {
    return m_stream_configs;
}
void OAIDicomStore::setStreamConfigs(const QList<OAIGoogleCloudHealthcareV1DicomStreamConfig> &stream_configs) {
