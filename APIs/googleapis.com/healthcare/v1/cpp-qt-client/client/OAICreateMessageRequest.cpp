...
OAIMessage OAICreateMessageRequest::getMessage() const {
    return m_message;
}
void OAICreateMessageRequest::setMessage(const OAIMessage &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAICreateMessageRequest::is_message_Set() const{
    return m_message_isSet;
}

bool OAICreateMessageRequest::is_message_Valid() const{
