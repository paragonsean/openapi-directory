...
namespace OpenAPI {
class OAIGoogleCloudHealthcareV1ConsentPolicy;
...
public:
    ...
    QList<OAIGoogleCloudHealthcareV1ConsentPolicy> getPolicies() const;
    void setPolicies(const QList<OAIGoogleCloudHealthcareV1ConsentPolicy> &policies);
...
private:
    ...
    QList<OAIGoogleCloudHealthcareV1ConsentPolicy> m_policies;
