    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('streamConfigs')) {
                obj['streamConfigs'] = ApiClient.convertToType(data['streamConfigs'], [GoogleCloudHealthcareV1beta1DicomStreamConfig]);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['streamConfigs']) { // data not null
            ...
            for (const item of data['streamConfigs']) {
                GoogleCloudHealthcareV1beta1DicomStreamConfig.validateJSON(item);
            };
        }
 ...
 * @member {Array.<module:model/GoogleCloudHealthcareV1beta1DicomStreamConfig>} streamConfigs
 */
