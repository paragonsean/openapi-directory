...
import GoogleCloudHealthcareV1beta1FhirGcsSource from './GoogleCloudHealthcareV1beta1FhirGcsSource';
...
class ImportResourcesRequest {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('gcsSource')) {
                obj['gcsSource'] = GoogleCloudHealthcareV1beta1FhirGcsSource.constructFromObject(data['gcsSource']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['gcsSource']) { // data not null
          GoogleCloudHealthcareV1beta1FhirGcsSource.validateJSON(data['gcsSource']);
        }
...
/**
 * @member {module:model/GoogleCloudHealthcareV1beta1FhirGcsSource} gcsSource
 */
