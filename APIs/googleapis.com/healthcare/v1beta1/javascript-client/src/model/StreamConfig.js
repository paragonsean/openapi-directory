...
class StreamConfig {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('bigqueryDestination')) {
                obj['bigqueryDestination'] = GoogleCloudHealthcareV1beta1FhirBigQueryDestination.constructFromObject(data['bigqueryDestination']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['bigqueryDestination']) { // data not null
          GoogleCloudHealthcareV1beta1FhirBigQueryDestination.validateJSON(data['bigqueryDestination']);
        }
...
/**
 * @member {module:model/GoogleCloudHealthcareV1beta1FhirBigQueryDestination} bigqueryDestination
 */
