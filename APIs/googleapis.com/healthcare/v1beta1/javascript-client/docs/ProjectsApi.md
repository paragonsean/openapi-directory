...
------------- | ------------- | -------------
[**healthcareProjectsLocationsDatasetsAnnotationStoresAnnotationsCreate**](ProjectsApi.md#healthcareProjectsLocationsDatasetsAnnotationStoresAnnotationsCreate) | **POST** /v1beta1/{parent}/annotations | 
[**healthcareProjectsLocationsDatasetsAnnotationStoresAnnotationsList**](ProjectsApi.md#healthcareProjectsLocationsDatasetsAnnotationStoresAnnotationsList) | **GET** /v1beta1/{parent}/annotations | 
[**healthcareProjectsLocationsDatasetsAnnotationStoresCreate**](ProjectsApi.md#healthcareProjectsLocationsDatasetsAnnotationStoresCreate) | **POST** /v1beta1/{parent}/annotationStores | 
[**healthcareProjectsLocationsDatasetsAnnotationStoresEvaluate**](ProjectsApi.md#healthcareProjectsLocationsDatasetsAnnotationStoresEvaluate) | **POST** /v1beta1/{name}:evaluate | 
[**healthcareProjectsLocationsDatasetsAnnotationStoresList**](ProjectsApi.md#healthcareProjectsLocationsDatasetsAnnotationStoresList) | **GET** /v1beta1/{parent}/annotationStores | 
[**healthcareProjectsLocationsDatasetsConsentStoresAttributeDefinitionsCreate**](ProjectsApi.md#healthcareProjectsLocationsDatasetsConsentStoresAttributeDefinitionsCreate) | **POST** /v1beta1/{parent}/attributeDefinitions | 
[**healthcareProjectsLocationsDatasetsConsentStoresAttributeDefinitionsList**](ProjectsApi.md#healthcareProjectsLocationsDatasetsConsentStoresAttributeDefinitionsList) | **GET** /v1beta1/{parent}/attributeDefinitions | 
[**healthcareProjectsLocationsDatasetsConsentStoresCheckDataAccess**](ProjectsApi.md#healthcareProjectsLocationsDatasetsConsentStoresCheckDataAccess) | **POST** /v1beta1/{consentStore}:checkDataAccess | 
[**healthcareProjectsLocationsDatasetsConsentStoresConsentArtifactsCreate**](ProjectsApi.md#healthcareProjectsLocationsDatasetsConsentStoresConsentArtifactsCreate) | **POST** /v1beta1/{parent}/consentArtifacts | 
[**healthcareProjectsLocationsDatasetsConsentStoresConsentArtifactsList**](ProjectsApi.md#healthcareProjectsLocationsDatasetsConsentStoresConsentArtifactsList) | **GET** /v1beta1/{parent}/consentArtifacts | 
[**healthcareProjectsLocationsDatasetsConsentStoresConsentsActivate**](ProjectsApi.md#healthcareProjectsLocationsDatasetsConsentStoresConsentsActivate) | **POST** /v1beta1/{name}:activate | 
[**healthcareProjectsLocationsDatasetsConsentStoresConsentsCreate**](ProjectsApi.md#healthcareProjectsLocationsDatasetsConsentStoresConsentsCreate) | **POST** /v1beta1/{parent}/consents | 
[**healthcareProjectsLocationsDatasetsConsentStoresConsentsDeleteRevision**](ProjectsApi.md#healthcareProjectsLocationsDatasetsConsentStoresConsentsDeleteRevision) | **DELETE** /v1beta1/{name}:deleteRevision | 
[**healthcareProjectsLocationsDatasetsConsentStoresConsentsList**](ProjectsApi.md#healthcareProjectsLocationsDatasetsConsentStoresConsentsList) | **GET** /v1beta1/{parent}/consents | 
[**healthcareProjectsLocationsDatasetsConsentStoresConsentsListRevisions**](ProjectsApi.md#healthcareProjectsLocationsDatasetsConsentStoresConsentsListRevisions) | **GET** /v1beta1/{name}:listRevisions | 
[**healthcareProjectsLocationsDatasetsConsentStoresConsentsReject**](ProjectsApi.md#healthcareProjectsLocationsDatasetsConsentStoresConsentsReject) | **POST** /v1beta1/{name}:reject | 
[**healthcareProjectsLocationsDatasetsConsentStoresConsentsRevoke**](ProjectsApi.md#healthcareProjectsLocationsDatasetsConsentStoresConsentsRevoke) | **POST** /v1beta1/{name}:revoke | 
[**healthcareProjectsLocationsDatasetsConsentStoresCreate**](ProjectsApi.md#healthcareProjectsLocationsDatasetsConsentStoresCreate) | **POST** /v1beta1/{parent}/consentStores | 
[**healthcareProjectsLocationsDatasetsConsentStoresEvaluateUserConsents**](ProjectsApi.md#healthcareProjectsLocationsDatasetsConsentStoresEvaluateUserConsents) | **POST** /v1beta1/{consentStore}:evaluateUserConsents | 
[**healthcareProjectsLocationsDatasetsConsentStoresList**](ProjectsApi.md#healthcareProjectsLocationsDatasetsConsentStoresList) | **GET** /v1beta1/{parent}/consentStores | 
[**healthcareProjectsLocationsDatasetsConsentStoresQueryAccessibleData**](ProjectsApi.md#healthcareProjectsLocationsDatasetsConsentStoresQueryAccessibleData) | **POST** /v1beta1/{consentStore}:queryAccessibleData | 
[**healthcareProjectsLocationsDatasetsConsentStoresUserDataMappingsArchive**](ProjectsApi.md#healthcareProjectsLocationsDatasetsConsentStoresUserDataMappingsArchive) | **POST** /v1beta1/{name}:archive | 
[**healthcareProjectsLocationsDatasetsConsentStoresUserDataMappingsCreate**](ProjectsApi.md#healthcareProjectsLocationsDatasetsConsentStoresUserDataMappingsCreate) | **POST** /v1beta1/{parent}/userDataMappings | 
[**healthcareProjectsLocationsDatasetsConsentStoresUserDataMappingsList**](ProjectsApi.md#healthcareProjectsLocationsDatasetsConsentStoresUserDataMappingsList) | **GET** /v1beta1/{parent}/userDataMappings | 
[**healthcareProjectsLocationsDatasetsCreate**](ProjectsApi.md#healthcareProjectsLocationsDatasetsCreate) | **POST** /v1beta1/{parent}/datasets | 
[**healthcareProjectsLocationsDatasetsDeidentify**](ProjectsApi.md#healthcareProjectsLocationsDatasetsDeidentify) | **POST** /v1beta1/{sourceDataset}:deidentify | 
[**healthcareProjectsLocationsDatasetsDicomStoresCreate**](ProjectsApi.md#healthcareProjectsLocationsDatasetsDicomStoresCreate) | **POST** /v1beta1/{parent}/dicomStores | 
[**healthcareProjectsLocationsDatasetsDicomStoresDicomWebStudiesGetStudyMetrics**](ProjectsApi.md#healthcareProjectsLocationsDatasetsDicomStoresDicomWebStudiesGetStudyMetrics) | **GET** /v1beta1/{study}:getStudyMetrics | 
[**healthcareProjectsLocationsDatasetsDicomStoresDicomWebStudiesSeriesGetSeriesMetrics**](ProjectsApi.md#healthcareProjectsLocationsDatasetsDicomStoresDicomWebStudiesSeriesGetSeriesMetrics) | **GET** /v1beta1/{series}:getSeriesMetrics | 
[**healthcareProjectsLocationsDatasetsDicomStoresDicomWebStudiesSeriesInstancesGetStorageInfo**](ProjectsApi.md#healthcareProjectsLocationsDatasetsDicomStoresDicomWebStudiesSeriesInstancesGetStorageInfo) | **GET** /v1beta1/{resource}:getStorageInfo | 
[**healthcareProjectsLocationsDatasetsDicomStoresDicomWebStudiesSetBlobStorageSettings**](ProjectsApi.md#healthcareProjectsLocationsDatasetsDicomStoresDicomWebStudiesSetBlobStorageSettings) | **POST** /v1beta1/{resource}:setBlobStorageSettings | 
[**healthcareProjectsLocationsDatasetsDicomStoresGetDICOMStoreMetrics**](ProjectsApi.md#healthcareProjectsLocationsDatasetsDicomStoresGetDICOMStoreMetrics) | **GET** /v1beta1/{name}:getDICOMStoreMetrics | 
[**healthcareProjectsLocationsDatasetsDicomStoresList**](ProjectsApi.md#healthcareProjectsLocationsDatasetsDicomStoresList) | **GET** /v1beta1/{parent}/dicomStores | 
[**healthcareProjectsLocationsDatasetsDicomStoresStudiesSeriesInstancesDelete**](ProjectsApi.md#healthcareProjectsLocationsDatasetsDicomStoresStudiesSeriesInstancesDelete) | **DELETE** /v1beta1/{parent}/dicomWeb/{dicomWebPath} | 
[**healthcareProjectsLocationsDatasetsDicomStoresStudiesSeriesInstancesFramesRetrieveRendered**](ProjectsApi.md#healthcareProjectsLocationsDatasetsDicomStoresStudiesSeriesInstancesFramesRetrieveRendered) | **GET** /v1beta1/{parent}/dicomWeb/{dicomWebPath} | 
[**healthcareProjectsLocationsDatasetsDicomStoresStudiesStoreInstances**](ProjectsApi.md#healthcareProjectsLocationsDatasetsDicomStoresStudiesStoreInstances) | **POST** /v1beta1/{parent}/dicomWeb/{dicomWebPath} | 
[**healthcareProjectsLocationsDatasetsFhirStoresApplyAdminConsents**](ProjectsApi.md#healthcareProjectsLocationsDatasetsFhirStoresApplyAdminConsents) | **POST** /v1beta1/{name}:applyAdminConsents | 
[**healthcareProjectsLocationsDatasetsFhirStoresApplyConsents**](ProjectsApi.md#healthcareProjectsLocationsDatasetsFhirStoresApplyConsents) | **POST** /v1beta1/{name}:applyConsents | 
[**healthcareProjectsLocationsDatasetsFhirStoresConfigureSearch**](ProjectsApi.md#healthcareProjectsLocationsDatasetsFhirStoresConfigureSearch) | **POST** /v1beta1/{name}:configureSearch | 
[**healthcareProjectsLocationsDatasetsFhirStoresCreate**](ProjectsApi.md#healthcareProjectsLocationsDatasetsFhirStoresCreate) | **POST** /v1beta1/{parent}/fhirStores | 
[**healthcareProjectsLocationsDatasetsFhirStoresDeidentify**](ProjectsApi.md#healthcareProjectsLocationsDatasetsFhirStoresDeidentify) | **POST** /v1beta1/{sourceStore}:deidentify | 
[**healthcareProjectsLocationsDatasetsFhirStoresExplainDataAccess**](ProjectsApi.md#healthcareProjectsLocationsDatasetsFhirStoresExplainDataAccess) | **GET** /v1beta1/{name}:explainDataAccess | 
[**healthcareProjectsLocationsDatasetsFhirStoresFhirCapabilities**](ProjectsApi.md#healthcareProjectsLocationsDatasetsFhirStoresFhirCapabilities) | **GET** /v1beta1/{name}/fhir/metadata | 
[**healthcareProjectsLocationsDatasetsFhirStoresFhirConceptMapSearchTranslate**](ProjectsApi.md#healthcareProjectsLocationsDatasetsFhirStoresFhirConceptMapSearchTranslate) | **GET** /v1beta1/{parent}/fhir/ConceptMap/$translate | 
[**healthcareProjectsLocationsDatasetsFhirStoresFhirConceptMapTranslate**](ProjectsApi.md#healthcareProjectsLocationsDatasetsFhirStoresFhirConceptMapTranslate) | **GET** /v1beta1/{name}/$translate | 
[**healthcareProjectsLocationsDatasetsFhirStoresFhirConditionalDelete**](ProjectsApi.md#healthcareProjectsLocationsDatasetsFhirStoresFhirConditionalDelete) | **DELETE** /v1beta1/{parent}/fhir/{type} | 
[**healthcareProjectsLocationsDatasetsFhirStoresFhirConditionalPatch**](ProjectsApi.md#healthcareProjectsLocationsDatasetsFhirStoresFhirConditionalPatch) | **PATCH** /v1beta1/{parent}/fhir/{type} | 
[**healthcareProjectsLocationsDatasetsFhirStoresFhirConditionalUpdate**](ProjectsApi.md#healthcareProjectsLocationsDatasetsFhirStoresFhirConditionalUpdate) | **PUT** /v1beta1/{parent}/fhir/{type} | 
[**healthcareProjectsLocationsDatasetsFhirStoresFhirCreate**](ProjectsApi.md#healthcareProjectsLocationsDatasetsFhirStoresFhirCreate) | **POST** /v1beta1/{parent}/fhir/{type} | 
[**healthcareProjectsLocationsDatasetsFhirStoresFhirExecuteBundle**](ProjectsApi.md#healthcareProjectsLocationsDatasetsFhirStoresFhirExecuteBundle) | **POST** /v1beta1/{parent}/fhir | 
[**healthcareProjectsLocationsDatasetsFhirStoresFhirHistory**](ProjectsApi.md#healthcareProjectsLocationsDatasetsFhirStoresFhirHistory) | **GET** /v1beta1/{name}/_history | 
[**healthcareProjectsLocationsDatasetsFhirStoresFhirObservationLastn**](ProjectsApi.md#healthcareProjectsLocationsDatasetsFhirStoresFhirObservationLastn) | **GET** /v1beta1/{parent}/fhir/Observation/$lastn | 
[**healthcareProjectsLocationsDatasetsFhirStoresFhirPatientConsentEnforcementStatus**](ProjectsApi.md#healthcareProjectsLocationsDatasetsFhirStoresFhirPatientConsentEnforcementStatus) | **GET** /v1beta1/{name}/$consent-enforcement-status | 
[**healthcareProjectsLocationsDatasetsFhirStoresFhirPatientEverything**](ProjectsApi.md#healthcareProjectsLocationsDatasetsFhirStoresFhirPatientEverything) | **GET** /v1beta1/{name}/$everything | 
[**healthcareProjectsLocationsDatasetsFhirStoresFhirResourceIncomingReferences**](ProjectsApi.md#healthcareProjectsLocationsDatasetsFhirStoresFhirResourceIncomingReferences) | **GET** /v1beta1/{parent}/fhir/$references | 
[**healthcareProjectsLocationsDatasetsFhirStoresFhirResourcePurge**](ProjectsApi.md#healthcareProjectsLocationsDatasetsFhirStoresFhirResourcePurge) | **DELETE** /v1beta1/{name}/$purge | 
[**healthcareProjectsLocationsDatasetsFhirStoresFhirResourceValidate**](ProjectsApi.md#healthcareProjectsLocationsDatasetsFhirStoresFhirResourceValidate) | **POST** /v1beta1/{parent}/fhir/{type}/$validate | 
[**healthcareProjectsLocationsDatasetsFhirStoresFhirSearch**](ProjectsApi.md#healthcareProjectsLocationsDatasetsFhirStoresFhirSearch) | **POST** /v1beta1/{parent}/fhir/_search | 
[**healthcareProjectsLocationsDatasetsFhirStoresFhirSearchType**](ProjectsApi.md#healthcareProjectsLocationsDatasetsFhirStoresFhirSearchType) | **POST** /v1beta1/{parent}/fhir/{resourceType}/_search | 
[**healthcareProjectsLocationsDatasetsFhirStoresFhirUpdate**](ProjectsApi.md#healthcareProjectsLocationsDatasetsFhirStoresFhirUpdate) | **PUT** /v1beta1/{name} | 
[**healthcareProjectsLocationsDatasetsFhirStoresGetFHIRStoreMetrics**](ProjectsApi.md#healthcareProjectsLocationsDatasetsFhirStoresGetFHIRStoreMetrics) | **GET** /v1beta1/{name}:getFHIRStoreMetrics | 
[**healthcareProjectsLocationsDatasetsFhirStoresList**](ProjectsApi.md#healthcareProjectsLocationsDatasetsFhirStoresList) | **GET** /v1beta1/{parent}/fhirStores | 
[**healthcareProjectsLocationsDatasetsFhirStoresRollback**](ProjectsApi.md#healthcareProjectsLocationsDatasetsFhirStoresRollback) | **POST** /v1beta1/{name}:rollback | 
[**healthcareProjectsLocationsDatasetsHl7V2StoresCreate**](ProjectsApi.md#healthcareProjectsLocationsDatasetsHl7V2StoresCreate) | **POST** /v1beta1/{parent}/hl7V2Stores | 
[**healthcareProjectsLocationsDatasetsHl7V2StoresExport**](ProjectsApi.md#healthcareProjectsLocationsDatasetsHl7V2StoresExport) | **POST** /v1beta1/{name}:export | 
[**healthcareProjectsLocationsDatasetsHl7V2StoresGetHL7v2StoreMetrics**](ProjectsApi.md#healthcareProjectsLocationsDatasetsHl7V2StoresGetHL7v2StoreMetrics) | **GET** /v1beta1/{name}:getHL7v2StoreMetrics | 
[**healthcareProjectsLocationsDatasetsHl7V2StoresGetIamPolicy**](ProjectsApi.md#healthcareProjectsLocationsDatasetsHl7V2StoresGetIamPolicy) | **GET** /v1beta1/{resource}:getIamPolicy | 
[**healthcareProjectsLocationsDatasetsHl7V2StoresImport**](ProjectsApi.md#healthcareProjectsLocationsDatasetsHl7V2StoresImport) | **POST** /v1beta1/{name}:import | 
[**healthcareProjectsLocationsDatasetsHl7V2StoresList**](ProjectsApi.md#healthcareProjectsLocationsDatasetsHl7V2StoresList) | **GET** /v1beta1/{parent}/hl7V2Stores | 
[**healthcareProjectsLocationsDatasetsHl7V2StoresMessagesBatchGet**](ProjectsApi.md#healthcareProjectsLocationsDatasetsHl7V2StoresMessagesBatchGet) | **GET** /v1beta1/{parent}/messages:batchGet | 
[**healthcareProjectsLocationsDatasetsHl7V2StoresMessagesCreate**](ProjectsApi.md#healthcareProjectsLocationsDatasetsHl7V2StoresMessagesCreate) | **POST** /v1beta1/{parent}/messages | 
[**healthcareProjectsLocationsDatasetsHl7V2StoresMessagesDelete**](ProjectsApi.md#healthcareProjectsLocationsDatasetsHl7V2StoresMessagesDelete) | **DELETE** /v1beta1/{name} | 
[**healthcareProjectsLocationsDatasetsHl7V2StoresMessagesIngest**](ProjectsApi.md#healthcareProjectsLocationsDatasetsHl7V2StoresMessagesIngest) | **POST** /v1beta1/{parent}/messages:ingest | 
[**healthcareProjectsLocationsDatasetsHl7V2StoresMessagesList**](ProjectsApi.md#healthcareProjectsLocationsDatasetsHl7V2StoresMessagesList) | **GET** /v1beta1/{parent}/messages | 
[**healthcareProjectsLocationsDatasetsHl7V2StoresMessagesPatch**](ProjectsApi.md#healthcareProjectsLocationsDatasetsHl7V2StoresMessagesPatch) | **PATCH** /v1beta1/{name} | 
[**healthcareProjectsLocationsDatasetsHl7V2StoresSetIamPolicy**](ProjectsApi.md#healthcareProjectsLocationsDatasetsHl7V2StoresSetIamPolicy) | **POST** /v1beta1/{resource}:setIamPolicy | 
[**healthcareProjectsLocationsDatasetsHl7V2StoresTestIamPermissions**](ProjectsApi.md#healthcareProjectsLocationsDatasetsHl7V2StoresTestIamPermissions) | **POST** /v1beta1/{resource}:testIamPermissions | 
[**healthcareProjectsLocationsDatasetsList**](ProjectsApi.md#healthcareProjectsLocationsDatasetsList) | **GET** /v1beta1/{parent}/datasets | 
[**healthcareProjectsLocationsDatasetsOperationsCancel**](ProjectsApi.md#healthcareProjectsLocationsDatasetsOperationsCancel) | **POST** /v1beta1/{name}:cancel | 
[**healthcareProjectsLocationsDatasetsOperationsGet**](ProjectsApi.md#healthcareProjectsLocationsDatasetsOperationsGet) | **GET** /v1beta1/{name} | 
[**healthcareProjectsLocationsDatasetsOperationsList**](ProjectsApi.md#healthcareProjectsLocationsDatasetsOperationsList) | **GET** /v1beta1/{name}/operations | 
[**healthcareProjectsLocationsList**](ProjectsApi.md#healthcareProjectsLocationsList) | **GET** /v1beta1/{name}/locations | 
[**healthcareProjectsLocationsServicesNlpAnalyzeEntities**](ProjectsApi.md#healthcareProjectsLocationsServicesNlpAnalyzeEntities) | **POST** /v1beta1/{nlpService}:analyzeEntities | 



## healthcareProjectsLocationsDatasetsAnnotationStoresAnnotationsCreate

> Annotation healthcareProjectsLocationsDatasetsAnnotationStoresAnnotationsCreate(parent, opts)
...
let parent = "parent_example"; // String | Required. The name of the Annotation store this annotation belongs to. For example, `projects/my-project/locations/us-central1/datasets/mydataset/annotationStores/myannotationstore`.
let opts = {
...
apiInstance.healthcareProjectsLocationsDatasetsAnnotationStoresAnnotationsCreate(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
------------- | ------------- | ------------- | -------------
 **parent** | **String**| Required. The name of the Annotation store this annotation belongs to. For example, &#x60;projects/my-project/locations/us-central1/datasets/mydataset/annotationStores/myannotationstore&#x60;. | 
...
> ListAnnotationsResponse healthcareProjectsLocationsDatasetsAnnotationStoresAnnotationsList(parent, opts)
...
let apiInstance = new CloudHealthcareApi.ProjectsApi();
let parent = "parent_example"; // String | Required. Name of the Annotation store to retrieve Annotations from.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **parent** | **String**| Required. Name of the Annotation store to retrieve Annotations from. | 
 **xgafv** | **String**| V1 error format. | [optional] 
 **accessToken** | **String**| OAuth access token. | [optional] 
 **alt** | **String**| Data format for response. | [optional] 
 **callback** | **String**| JSONP | [optional] 
 ...
 **pageSize** | **Number**| Limit on the number of Annotations to return in a single response. If not specified, 100 is used. May not be larger than 1000. | [optional] 
 **pageToken** | **String**| The next_page_token value returned from the previous List request, if any. | [optional] 
 **view** | **String**| Controls which fields are populated in the response. | [optional] 
...
> AnnotationStore healthcareProjectsLocationsDatasetsAnnotationStoresCreate(parent, opts)
...
let apiInstance = new CloudHealthcareApi.ProjectsApi();
let parent = "parent_example"; // String | Required. The name of the dataset this Annotation store belongs to.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'annotationStoreId': "annotationStoreId_example", // String | Required. The ID of the Annotation store that is being created. The string must match the following regex: `[\\p{L}\\p{N}_\\-\\.]{1,256}`.
  'annotationStore': new CloudHealthcareApi.AnnotationStore() // AnnotationStore | 
};
apiInstance.healthcareProjectsLocationsDatasetsAnnotationStoresCreate(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **parent** | **String**| Required. The name of the dataset this Annotation store belongs to. | 
 **xgafv** | **String**| V1 error format. | [optional] 
 **accessToken** | **String**| OAuth access token. | [optional] 
 **alt** | **String**| Data format for response. | [optional] 
 **callback** | **String**| JSONP | [optional] 
 ...
 **uploadProtocol** | **String**| Upload protocol for media (e.g. \&quot;raw\&quot;, \&quot;multipart\&quot;). | [optional] 
 **uploadType** | **String**| Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;). | [optional] 
 **annotationStoreId** | **String**| Required. The ID of the Annotation store that is being created. The string must match the following regex: &#x60;[\\p{L}\\p{N}_\\-\\.]{1,256}&#x60;. | [optional] 
 **annotationStore** | [**AnnotationStore**](AnnotationStore.md)|  | [optional] 
...
> Operation healthcareProjectsLocationsDatasetsAnnotationStoresEvaluate(name, opts)
...
let apiInstance = new CloudHealthcareApi.ProjectsApi();
let name = "name_example"; // String | Required. The Annotation store to compare against `golden_store`, in the format of `projects/{project_id}/locations/{location_id}/datasets/{dataset_id}/annotationStores/{annotation_store_id}`.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'evaluateAnnotationStoreRequest': new CloudHealthcareApi.EvaluateAnnotationStoreRequest() // EvaluateAnnotationStoreRequest | 
};
apiInstance.healthcareProjectsLocationsDatasetsAnnotationStoresEvaluate(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **name** | **String**| Required. The Annotation store to compare against &#x60;golden_store&#x60;, in the format of &#x60;projects/{project_id}/locations/{location_id}/datasets/{dataset_id}/annotationStores/{annotation_store_id}&#x60;. | 
 **xgafv** | **String**| V1 error format. | [optional] 
 **accessToken** | **String**| OAuth access token. | [optional] 
 **alt** | **String**| Data format for response. | [optional] 
 **callback** | **String**| JSONP | [optional] 
 ...
 **uploadProtocol** | **String**| Upload protocol for media (e.g. \&quot;raw\&quot;, \&quot;multipart\&quot;). | [optional] 
 **uploadType** | **String**| Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;). | [optional] 
 **evaluateAnnotationStoreRequest** | [**EvaluateAnnotationStoreRequest**](EvaluateAnnotationStoreRequest.md)|  | [optional] 
...
> ListAnnotationStoresResponse healthcareProjectsLocationsDatasetsAnnotationStoresList(parent, opts)
...
let opts = {
  ...
  'pageSize': 56, // Number | Limit on the number of Annotation stores to return in a single response. If not specified, 100 is used. May not be larger than 1000.
  'pageToken': "pageToken_example" // String | The next_page_token value returned from the previous List request, if any.
};
apiInstance.healthcareProjectsLocationsDatasetsAnnotationStoresList(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **pageSize** | **Number**| Limit on the number of Annotation stores to return in a single response. If not specified, 100 is used. May not be larger than 1000. | [optional] 
 **pageToken** | **String**| The next_page_token value returned from the previous List request, if any. | [optional] 
...
> StorageInfo healthcareProjectsLocationsDatasetsDicomStoresDicomWebStudiesSeriesInstancesGetStorageInfo(resource, opts)
...
let apiInstance = new CloudHealthcareApi.ProjectsApi();
let resource = "resource_example"; // String | Required. The path of the resource for which the storage info is requested (for exaxmple for a DICOM Instance: `projects/{projectid}/datasets/{datasetid}/dicomStores/{dicomStoreId}/dicomWeb/studies/{study_uid}/series/{series_uid}/instances/{instance_uid}`)
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
apiInstance.healthcareProjectsLocationsDatasetsDicomStoresDicomWebStudiesSeriesInstancesGetStorageInfo(resource, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **resource** | **String**| Required. The path of the resource for which the storage info is requested (for exaxmple for a DICOM Instance: &#x60;projects/{projectid}/datasets/{datasetid}/dicomStores/{dicomStoreId}/dicomWeb/studies/{study_uid}/series/{series_uid}/instances/{instance_uid}&#x60;) | 
 **xgafv** | **String**| V1 error format. | [optional] 
 **accessToken** | **String**| OAuth access token. | [optional] 
 **alt** | **String**| Data format for response. | [optional] 
 **callback** | **String**| JSONP | [optional] 
...
> Operation healthcareProjectsLocationsDatasetsDicomStoresDicomWebStudiesSetBlobStorageSettings(resource, opts)
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'setBlobStorageSettingsRequest': new CloudHealthcareApi.SetBlobStorageSettingsRequest() // SetBlobStorageSettingsRequest | 
};
apiInstance.healthcareProjectsLocationsDatasetsDicomStoresDicomWebStudiesSetBlobStorageSettings(resource, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **uploadProtocol** | **String**| Upload protocol for media (e.g. \&quot;raw\&quot;, \&quot;multipart\&quot;). | [optional] 
 **uploadType** | **String**| Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;). | [optional] 
 **setBlobStorageSettingsRequest** | [**SetBlobStorageSettingsRequest**](SetBlobStorageSettingsRequest.md)|  | [optional] 
...
> Operation healthcareProjectsLocationsDatasetsFhirStoresApplyAdminConsents(name, opts)
...
let apiInstance = new CloudHealthcareApi.ProjectsApi();
let name = "name_example"; // String | Required. The name of the FHIR store to enforce, in the format `projects/{project_id}/locations/{location_id}/datasets/{dataset_id}/fhirStores/{fhir_store_id}`.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'applyAdminConsentsRequest': new CloudHealthcareApi.ApplyAdminConsentsRequest() // ApplyAdminConsentsRequest | 
};
apiInstance.healthcareProjectsLocationsDatasetsFhirStoresApplyAdminConsents(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **name** | **String**| Required. The name of the FHIR store to enforce, in the format &#x60;projects/{project_id}/locations/{location_id}/datasets/{dataset_id}/fhirStores/{fhir_store_id}&#x60;. | 
 **xgafv** | **String**| V1 error format. | [optional] 
 **accessToken** | **String**| OAuth access token. | [optional] 
 **alt** | **String**| Data format for response. | [optional] 
 **callback** | **String**| JSONP | [optional] 
 ...
 **uploadProtocol** | **String**| Upload protocol for media (e.g. \&quot;raw\&quot;, \&quot;multipart\&quot;). | [optional] 
 **uploadType** | **String**| Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;). | [optional] 
 **applyAdminConsentsRequest** | [**ApplyAdminConsentsRequest**](ApplyAdminConsentsRequest.md)|  | [optional] 
...
> Operation healthcareProjectsLocationsDatasetsFhirStoresApplyConsents(name, opts)
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'applyConsentsRequest': new CloudHealthcareApi.ApplyConsentsRequest() // ApplyConsentsRequest | 
};
apiInstance.healthcareProjectsLocationsDatasetsFhirStoresApplyConsents(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **uploadProtocol** | **String**| Upload protocol for media (e.g. \&quot;raw\&quot;, \&quot;multipart\&quot;). | [optional] 
 **uploadType** | **String**| Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;). | [optional] 
 **applyConsentsRequest** | [**ApplyConsentsRequest**](ApplyConsentsRequest.md)|  | [optional] 
...
> Operation healthcareProjectsLocationsDatasetsFhirStoresConfigureSearch(name, opts)
...
let apiInstance = new CloudHealthcareApi.ProjectsApi();
let name = "name_example"; // String | Required. The name of the FHIR store to configure, in the format `projects/{project_id}/locations/{location_id}/datasets/{dataset_id}/fhirStores/{fhir_store_id}`.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'configureSearchRequest': new CloudHealthcareApi.ConfigureSearchRequest() // ConfigureSearchRequest | 
};
apiInstance.healthcareProjectsLocationsDatasetsFhirStoresConfigureSearch(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **name** | **String**| Required. The name of the FHIR store to configure, in the format &#x60;projects/{project_id}/locations/{location_id}/datasets/{dataset_id}/fhirStores/{fhir_store_id}&#x60;. | 
 **xgafv** | **String**| V1 error format. | [optional] 
 **accessToken** | **String**| OAuth access token. | [optional] 
 **alt** | **String**| Data format for response. | [optional] 
 **callback** | **String**| JSONP | [optional] 
 ...
 **uploadProtocol** | **String**| Upload protocol for media (e.g. \&quot;raw\&quot;, \&quot;multipart\&quot;). | [optional] 
 **uploadType** | **String**| Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;). | [optional] 
 **configureSearchRequest** | [**ConfigureSearchRequest**](ConfigureSearchRequest.md)|  | [optional] 
...
> ExplainDataAccessResponse healthcareProjectsLocationsDatasetsFhirStoresExplainDataAccess(name, opts)
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'resourceId': "resourceId_example" // String | Required. The ID (`{resourceType}/{id}`) of the resource to explain data access on.
};
apiInstance.healthcareProjectsLocationsDatasetsFhirStoresExplainDataAccess(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **uploadProtocol** | **String**| Upload protocol for media (e.g. \&quot;raw\&quot;, \&quot;multipart\&quot;). | [optional] 
 **uploadType** | **String**| Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;). | [optional] 
 **resourceId** | **String**| Required. The ID (&#x60;{resourceType}/{id}&#x60;) of the resource to explain data access on. | [optional] 
...
> HttpBody healthcareProjectsLocationsDatasetsFhirStoresFhirConceptMapSearchTranslate(parent, opts)
...
let apiInstance = new CloudHealthcareApi.ProjectsApi();
let parent = "parent_example"; // String | Required. The name for the FHIR store containing the concept map(s) to use for the translation.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'code': "code_example", // String | Required. The code to translate.
  'conceptMapVersion': "conceptMapVersion_example", // String | The version of the concept map to use. If unset, the most current version is used.
  'source': "source_example", // String | The source value set of the concept map to be used. If unset, target is used to search for concept maps.
  'system': "system_example", // String | Required. The system for the code to be translated.
  'target': "target_example", // String | The target value set of the concept map to be used. If unset, source is used to search for concept maps.
  'url': "url_example" // String | The canonical url of the concept map to use. If unset, the source and target is used to search for concept maps.
};
apiInstance.healthcareProjectsLocationsDatasetsFhirStoresFhirConceptMapSearchTranslate(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **parent** | **String**| Required. The name for the FHIR store containing the concept map(s) to use for the translation. | 
 **xgafv** | **String**| V1 error format. | [optional] 
 **accessToken** | **String**| OAuth access token. | [optional] 
 **alt** | **String**| Data format for response. | [optional] 
 **callback** | **String**| JSONP | [optional] 
 ...
 **uploadProtocol** | **String**| Upload protocol for media (e.g. \&quot;raw\&quot;, \&quot;multipart\&quot;). | [optional] 
 **uploadType** | **String**| Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;). | [optional] 
 **code** | **String**| Required. The code to translate. | [optional] 
 **conceptMapVersion** | **String**| The version of the concept map to use. If unset, the most current version is used. | [optional] 
 **source** | **String**| The source value set of the concept map to be used. If unset, target is used to search for concept maps. | [optional] 
 **system** | **String**| Required. The system for the code to be translated. | [optional] 
 **target** | **String**| The target value set of the concept map to be used. If unset, source is used to search for concept maps. | [optional] 
 **url** | **String**| The canonical url of the concept map to use. If unset, the source and target is used to search for concept maps. | [optional] 
...
> HttpBody healthcareProjectsLocationsDatasetsFhirStoresFhirConceptMapTranslate(name, opts)
...
let apiInstance = new CloudHealthcareApi.ProjectsApi();
let name = "name_example"; // String | Required. The URL for the concept map to use for the translation.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
apiInstance.healthcareProjectsLocationsDatasetsFhirStoresFhirConceptMapTranslate(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **name** | **String**| Required. The URL for the concept map to use for the translation. | 
 **xgafv** | **String**| V1 error format. | [optional] 
 **accessToken** | **String**| OAuth access token. | [optional] 
 **alt** | **String**| Data format for response. | [optional] 
 **callback** | **String**| JSONP | [optional] 
...
let apiInstance = new CloudHealthcareApi.ProjectsApi();
let parent = "parent_example"; // String | Required. The name of the FHIR store this resource belongs to.
let type = "type_example"; // String | Required. The FHIR resource type to create, such as Patient or Observation. For a complete list, see the FHIR Resource Index ([DSTU2](https://hl7.org/implement/standards/fhir/DSTU2/resourcelist.html), [STU3](https://hl7.org/implement/standards/fhir/STU3/resourcelist.html), [R4](https://hl7.org/implement/standards/fhir/R4/resourcelist.html)). Must match the resource type in the provided content.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
> HttpBody healthcareProjectsLocationsDatasetsFhirStoresFhirObservationLastn(parent, opts)
...
apiInstance.healthcareProjectsLocationsDatasetsFhirStoresFhirObservationLastn(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> HttpBody healthcareProjectsLocationsDatasetsFhirStoresFhirPatientConsentEnforcementStatus(name, opts)
...
let apiInstance = new CloudHealthcareApi.ProjectsApi();
let name = "name_example"; // String | Required. The name of the patient to find enforcement statuses, in the format `projects/{project_id}/locations/{location_id}/datasets/{dataset_id}/fhirStores/{fhir_store_id}/fhir/Patient/{patient_id}`
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'count': 56, // Number | Optional. The maximum number of results on a page. If not specified, 100 is used. May not be larger than 1000.
...
apiInstance.healthcareProjectsLocationsDatasetsFhirStoresFhirPatientConsentEnforcementStatus(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **name** | **String**| Required. The name of the patient to find enforcement statuses, in the format &#x60;projects/{project_id}/locations/{location_id}/datasets/{dataset_id}/fhirStores/{fhir_store_id}/fhir/Patient/{patient_id}&#x60; | 
 **xgafv** | **String**| V1 error format. | [optional] 
 **accessToken** | **String**| OAuth access token. | [optional] 
 **alt** | **String**| Data format for response. | [optional] 
 **callback** | **String**| JSONP | [optional] 
 ...
 **uploadProtocol** | **String**| Upload protocol for media (e.g. \&quot;raw\&quot;, \&quot;multipart\&quot;). | [optional] 
 **uploadType** | **String**| Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;). | [optional] 
 **count** | **Number**| Optional. The maximum number of results on a page. If not specified, 100 is used. May not be larger than 1000. | [optional] 
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'count': 56, // Number | Maximum number of resources in a page. If not specified, 100 is used. May not be larger than 1000.
  ...
  'since': "since_example", // String | If provided, only resources updated after this time are returned. The time uses the format YYYY-MM-DDThh:mm:ss.sss+zz:zz. For example, `2015-02-07T13:28:17.239+02:00` or `2017-01-01T00:00:00Z`. The time must be specified to the second and include a time zone.
  'type': "type_example", // String | String of comma-delimited FHIR resource types. If provided, only resources of the specified resource type(s) are returned. Specifying multiple `_type` parameters isn't supported. For example, the result of `_type=Observation&_type=Encounter` is undefined. Use `_type=Observation,Encounter` instead.
  'end': "end_example", // String | The response includes records prior to the end date. The date uses the format YYYY-MM-DD. If no end date is provided, all records subsequent to the start date are in scope.
  'start': "start_example" // String | The response includes records subsequent to the start date. The date uses the format YYYY-MM-DD. If no start date is provided, all records prior to the end date are in scope.
};
 ...
 **uploadProtocol** | **String**| Upload protocol for media (e.g. \&quot;raw\&quot;, \&quot;multipart\&quot;). | [optional] 
 **uploadType** | **String**| Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;). | [optional] 
 **count** | **Number**| Maximum number of resources in a page. If not specified, 100 is used. May not be larger than 1000. | [optional] 
 ...
 **since** | **String**| If provided, only resources updated after this time are returned. The time uses the format YYYY-MM-DDThh:mm:ss.sss+zz:zz. For example, &#x60;2015-02-07T13:28:17.239+02:00&#x60; or &#x60;2017-01-01T00:00:00Z&#x60;. The time must be specified to the second and include a time zone. | [optional] 
 **type** | **String**| String of comma-delimited FHIR resource types. If provided, only resources of the specified resource type(s) are returned. Specifying multiple &#x60;_type&#x60; parameters isn&#39;t supported. For example, the result of &#x60;_type&#x3D;Observation&amp;_type&#x3D;Encounter&#x60; is undefined. Use &#x60;_type&#x3D;Observation,Encounter&#x60; instead. | [optional] 
 **end** | **String**| The response includes records prior to the end date. The date uses the format YYYY-MM-DD. If no end date is provided, all records subsequent to the start date are in scope. | [optional] 
 **start** | **String**| The response includes records subsequent to the start date. The date uses the format YYYY-MM-DD. If no start date is provided, all records prior to the end date are in scope. | [optional] 
...
## healthcareProjectsLocationsDatasetsFhirStoresFhirResourceIncomingReferences

> HttpBody healthcareProjectsLocationsDatasetsFhirStoresFhirResourceIncomingReferences(parent, opts)
...
let apiInstance = new CloudHealthcareApi.ProjectsApi();
let parent = "parent_example"; // String | Required. The name of the FHIR store that holds the target resource.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'count': 56, // Number | Maximum number of resources in a page. If not specified, 100 is used. May not be larger than 1000.
  'pageToken': "pageToken_example", // String | Used to retrieve the next page of results when using pagination. Set `_page_token` to the value of _page_token set in next page links' url. Next page are returned in the response bundle's links field, where `link.relation` is \"next\". Omit `_page_token` if no previous request has been made.
  'summary': "summary_example", // String | Used to simplify the representation of the returned resources. `_summary=text` returns only the `text`, `id`, and `meta` top-level fields. `_summary=data` removes the `text` field and returns all other fields. `_summary=false` returns all parts of the resource(s). Either not providing this parameter or providing an empty value to this parameter also returns all parts of the resource(s).
  'type': "type_example", // String | String of comma-delimited FHIR resource types. If provided, only resources of the specified resource type(s) are returned. If not provided or an empty value is provided, no filter on the returned resource type(s) is applied.
  'target': "target_example" // String | Required. The target whose incoming references are requested. This param is required and must not be empty. It uses the format \"ResourceType/ResourceID\", for example, target=ResourceType/ResourceID.
};
apiInstance.healthcareProjectsLocationsDatasetsFhirStoresFhirResourceIncomingReferences(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **parent** | **String**| Required. The name of the FHIR store that holds the target resource. | 
 **xgafv** | **String**| V1 error format. | [optional] 
 **accessToken** | **String**| OAuth access token. | [optional] 
 **alt** | **String**| Data format for response. | [optional] 
 **callback** | **String**| JSONP | [optional] 
 ...
 **type** | **String**| String of comma-delimited FHIR resource types. If provided, only resources of the specified resource type(s) are returned. If not provided or an empty value is provided, no filter on the returned resource type(s) is applied. | [optional] 
 **target** | **String**| Required. The target whose incoming references are requested. This param is required and must not be empty. It uses the format \&quot;ResourceType/ResourceID\&quot;, for example, target&#x3D;ResourceType/ResourceID. | [optional] 
...
let apiInstance = new CloudHealthcareApi.ProjectsApi();
let parent = "parent_example"; // String | Required. Name of the FHIR store to retrieve resources from.
let resourceType = "resourceType_example"; // String | Required. The FHIR resource type to search, such as Patient or Observation. For a complete list, see the FHIR Resource Index ([DSTU2](https://hl7.org/implement/standards/fhir/DSTU2/resourcelist.html), [STU3](https://hl7.org/implement/standards/fhir/STU3/resourcelist.html), [R4](https://hl7.org/implement/standards/fhir/R4/resourcelist.html)).
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
------------- | ------------- | ------------- | -------------
 **parent** | **String**| Required. Name of the FHIR store to retrieve resources from. | 
 **resourceType** | **String**| Required. The FHIR resource type to search, such as Patient or Observation. For a complete list, see the FHIR Resource Index ([DSTU2](https://hl7.org/implement/standards/fhir/DSTU2/resourcelist.html), [STU3](https://hl7.org/implement/standards/fhir/STU3/resourcelist.html), [R4](https://hl7.org/implement/standards/fhir/R4/resourcelist.html)). | 
 **xgafv** | **String**| V1 error format. | [optional] 
 **accessToken** | **String**| OAuth access token. | [optional] 
 **alt** | **String**| Data format for response. | [optional] 
 **callback** | **String**| JSONP | [optional] 
...
> BatchGetMessagesResponse healthcareProjectsLocationsDatasetsHl7V2StoresMessagesBatchGet(parent, opts)
...
let apiInstance = new CloudHealthcareApi.ProjectsApi();
let parent = "parent_example"; // String | Required. Name of the HL7v2 store to retrieve messages from, in the format: `projects/{project_id}/locations/{location_id}/datasets/{dataset_id}/hl7v2Stores/{hl7v2_store_id}`.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'ids': ["null"], // [String] | The resource id of the HL7v2 messages to retrieve in the format: `{message_id}`, where the full resource name is `{parent}/messages/{message_id}` A maximum of 100 messages can be retrieved in a batch. All 'ids' have to be under parent.
  'view': "view_example" // String | Specifies the parts of the Messages resource to return in the response. When unspecified, equivalent to BASIC.
};
apiInstance.healthcareProjectsLocationsDatasetsHl7V2StoresMessagesBatchGet(parent, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **parent** | **String**| Required. Name of the HL7v2 store to retrieve messages from, in the format: &#x60;projects/{project_id}/locations/{location_id}/datasets/{dataset_id}/hl7v2Stores/{hl7v2_store_id}&#x60;. | 
 **xgafv** | **String**| V1 error format. | [optional] 
 **accessToken** | **String**| OAuth access token. | [optional] 
 **alt** | **String**| Data format for response. | [optional] 
 **callback** | **String**| JSONP | [optional] 
 ...
 **uploadProtocol** | **String**| Upload protocol for media (e.g. \&quot;raw\&quot;, \&quot;multipart\&quot;). | [optional] 
 **uploadType** | **String**| Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;). | [optional] 
 **ids** | [**[String]**](String.md)| The resource id of the HL7v2 messages to retrieve in the format: &#x60;{message_id}&#x60;, where the full resource name is &#x60;{parent}/messages/{message_id}&#x60; A maximum of 100 messages can be retrieved in a batch. All &#39;ids&#39; have to be under parent. | [optional] 
 **view** | **String**| Specifies the parts of the Messages resource to return in the response. When unspecified, equivalent to BASIC. | [optional] 
