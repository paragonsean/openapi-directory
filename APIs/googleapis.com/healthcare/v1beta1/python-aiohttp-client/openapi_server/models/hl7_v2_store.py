...
class Hl7V2Store(Model):
    ...
    def __init__(self, labels: Dict[str, str]=None, name: str=None, notification_config: NotificationConfig=None, notification_configs: List[Hl7V2NotificationConfig]=None, parser_config: ParserConfig=None, reject_duplicate_message: bool=None):
        """Hl7V2Store - a model defined in OpenAPI

        :param labels: The labels of this Hl7V2Store.
        :param name: The name of this Hl7V2Store.
        :param notification_config: The notification_config of this Hl7V2Store.
    ...
    def notification_config(self):
        """Gets the notification_config of this Hl7V2Store.


        :return: The notification_config of this Hl7V2Store.
    ...
    def notification_config(self, notification_config):
        """Sets the notification_config of this Hl7V2Store.
