...
from openapi_server.models.consent_config import ConsentConfig
...
from openapi_server.models.search_config import SearchConfig
...
class FhirStore(Model):
    ...
    def __init__(self, complex_data_type_reference_parsing: str=None, consent_config: ConsentConfig=None, default_search_handling_strict: bool=None, disable_referential_integrity: bool=None, disable_resource_versioning: bool=None, enable_history_modifications: bool=None, enable_update_create: bool=None, labels: Dict[str, str]=None, name: str=None, notification_config: NotificationConfig=None, notification_configs: List[FhirNotificationConfig]=None, search_config: SearchConfig=None, stream_configs: List[StreamConfig]=None, validation_config: ValidationConfig=None, version: str=None):
        ...
        :param consent_config: The consent_config of this FhirStore.
        ...
        :param enable_history_modifications: The enable_history_modifications of this FhirStore.
        ...
        :param search_config: The search_config of this FhirStore.
        ...
        self._consent_config = consent_config
        ...
        self._enable_history_modifications = enable_history_modifications
    ...
    def consent_config(self):
        """Gets the consent_config of this FhirStore.


        :return: The consent_config of this FhirStore.
        :rtype: ConsentConfig
        """
        return self._consent_config

    @consent_config.setter
    def consent_config(self, consent_config):
        """Sets the consent_config of this FhirStore.


        :param consent_config: The consent_config of this FhirStore.
        :type consent_config: ConsentConfig
        """
    ...
    @property
    def enable_history_modifications(self):
        """Gets the enable_history_modifications of this FhirStore.
        ...
        :return: The enable_history_modifications of this FhirStore.
        :rtype: bool
        """
        return self._enable_history_modifications

    @enable_history_modifications.setter
    def enable_history_modifications(self, enable_history_modifications):
        """Sets the enable_history_modifications of this FhirStore.

        Optional. Whether to allow ExecuteBundle to accept history bundles, and directly insert and overwrite historical resource versions into the FHIR store. If set to false, using history bundles fails with an error.

        :param enable_history_modifications: The enable_history_modifications of this FhirStore.
        :type enable_history_modifications: bool
        """
    ...
    def search_config(self):
        """Gets the search_config of this FhirStore.


        :return: The search_config of this FhirStore.
        :rtype: SearchConfig
        """
    ...
    def search_config(self, search_config):
        """Sets the search_config of this FhirStore.
