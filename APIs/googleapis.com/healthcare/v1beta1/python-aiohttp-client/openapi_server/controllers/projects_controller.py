...
async def healthcare_projects_locations_datasets_annotation_stores_annotations_create(request: web.Request, parent, xgafv=None, access_token=None, alt=None, param_callback=None, fields=None, key=None, oauth_token=None, pretty_print=None, quota_user=None, upload_protocol=None, upload_type=None, body=None) -> web.Response:
    ...
    :param parent: Required. The name of the Annotation store this annotation belongs to. For example, &#x60;projects/my-project/locations/us-central1/datasets/mydataset/annotationStores/myannotationstore&#x60;.
    :type parent: str
...
async def healthcare_projects_locations_datasets_annotation_stores_annotations_list(request: web.Request, parent, xgafv=None, access_token=None, alt=None, param_callback=None, fields=None, key=None, oauth_token=None, pretty_print=None, quota_user=None, upload_protocol=None, upload_type=None, filter=None, page_size=None, page_token=None, view=None) -> web.Response:
    ...
    :type filter: str
    :param page_size: Limit on the number of Annotations to return in a single response. If not specified, 100 is used. May not be larger than 1000.
    :type page_size: int
    :param page_token: The next_page_token value returned from the previous List request, if any.
    :type page_token: str
    :param view: Controls which fields are populated in the response.
    :type view: str
...
async def healthcare_projects_locations_datasets_annotation_stores_create(request: web.Request, parent, xgafv=None, access_token=None, alt=None, param_callback=None, fields=None, key=None, oauth_token=None, pretty_print=None, quota_user=None, upload_protocol=None, upload_type=None, annotation_store_id=None, body=None) -> web.Response:
    ...
    :param upload_type: Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;).
    :type upload_type: str
    :param annotation_store_id: Required. The ID of the Annotation store that is being created. The string must match the following regex: &#x60;[\\p{L}\\p{N}_\\-\\.]{1,256}&#x60;.
    :type annotation_store_id: str
    :param body: 
    :type body: dict | bytes

    """
    body = AnnotationStore.from_dict(body)
    return web.Response(status=200)


async def healthcare_projects_locations_datasets_annotation_stores_evaluate(request: web.Request, name, xgafv=None, access_token=None, alt=None, param_callback=None, fields=None, key=None, oauth_token=None, pretty_print=None, quota_user=None, upload_protocol=None, upload_type=None, body=None) -> web.Response:
    ...
    :param name: Required. The Annotation store to compare against &#x60;golden_store&#x60;, in the format of &#x60;projects/{project_id}/locations/{location_id}/datasets/{dataset_id}/annotationStores/{annotation_store_id}&#x60;.
    :type name: str
    :param xgafv: V1 error format.
    :type xgafv: str
    :param access_token: OAuth access token.
    ...
    """
    body = EvaluateAnnotationStoreRequest.from_dict(body)
    return web.Response(status=200)


async def healthcare_projects_locations_datasets_annotation_stores_list(request: web.Request, parent, xgafv=None, access_token=None, alt=None, param_callback=None, fields=None, key=None, oauth_token=None, pretty_print=None, quota_user=None, upload_protocol=None, upload_type=None, filter=None, page_size=None, page_token=None) -> web.Response:
    ...
    :type filter: str
    :param page_size: Limit on the number of Annotation stores to return in a single response. If not specified, 100 is used. May not be larger than 1000.
    :type page_size: int
    :param page_token: The next_page_token value returned from the previous List request, if any.
    :type page_token: str
...
async def healthcare_projects_locations_datasets_dicom_stores_dicom_web_studies_series_instances_get_storage_info(request: web.Request, resource, xgafv=None, access_token=None, alt=None, param_callback=None, fields=None, key=None, oauth_token=None, pretty_print=None, quota_user=None, upload_protocol=None, upload_type=None) -> web.Response:
    ...
    :param resource: Required. The path of the resource for which the storage info is requested (for exaxmple for a DICOM Instance: &#x60;projects/{projectid}/datasets/{datasetid}/dicomStores/{dicomStoreId}/dicomWeb/studies/{study_uid}/series/{series_uid}/instances/{instance_uid}&#x60;)
    :type resource: str
    :param xgafv: V1 error format.
    :type xgafv: str
    :param access_token: OAuth access token.
...
async def healthcare_projects_locations_datasets_dicom_stores_dicom_web_studies_set_blob_storage_settings(request: web.Request, resource, xgafv=None, access_token=None, alt=None, param_callback=None, fields=None, key=None, oauth_token=None, pretty_print=None, quota_user=None, upload_protocol=None, upload_type=None, body=None) -> web.Response:
    ...
    """
    body = SetBlobStorageSettingsRequest.from_dict(body)
    return web.Response(status=200)
...
async def healthcare_projects_locations_datasets_fhir_stores_apply_admin_consents(request: web.Request, name, xgafv=None, access_token=None, alt=None, param_callback=None, fields=None, key=None, oauth_token=None, pretty_print=None, quota_user=None, upload_protocol=None, upload_type=None, body=None) -> web.Response:
    ...
    :param name: Required. The name of the FHIR store to enforce, in the format &#x60;projects/{project_id}/locations/{location_id}/datasets/{dataset_id}/fhirStores/{fhir_store_id}&#x60;.
    :type name: str
    :param xgafv: V1 error format.
    :type xgafv: str
    :param access_token: OAuth access token.
    ...
    """
    body = ApplyAdminConsentsRequest.from_dict(body)
    return web.Response(status=200)


async def healthcare_projects_locations_datasets_fhir_stores_apply_consents(request: web.Request, name, xgafv=None, access_token=None, alt=None, param_callback=None, fields=None, key=None, oauth_token=None, pretty_print=None, quota_user=None, upload_protocol=None, upload_type=None, body=None) -> web.Response:
    ...
    """
    body = ApplyConsentsRequest.from_dict(body)
    return web.Response(status=200)


async def healthcare_projects_locations_datasets_fhir_stores_configure_search(request: web.Request, name, xgafv=None, access_token=None, alt=None, param_callback=None, fields=None, key=None, oauth_token=None, pretty_print=None, quota_user=None, upload_protocol=None, upload_type=None, body=None) -> web.Response:
    ...
    :param name: Required. The name of the FHIR store to configure, in the format &#x60;projects/{project_id}/locations/{location_id}/datasets/{dataset_id}/fhirStores/{fhir_store_id}&#x60;.
    :type name: str
    :param xgafv: V1 error format.
    :type xgafv: str
    :param access_token: OAuth access token.
    ...
    """
    body = ConfigureSearchRequest.from_dict(body)
    return web.Response(status=200)
...
async def healthcare_projects_locations_datasets_fhir_stores_explain_data_access(request: web.Request, name, xgafv=None, access_token=None, alt=None, param_callback=None, fields=None, key=None, oauth_token=None, pretty_print=None, quota_user=None, upload_protocol=None, upload_type=None, resource_id=None) -> web.Response:
    ...
    :param upload_type: Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;).
    :type upload_type: str
    :param resource_id: Required. The ID (&#x60;{resourceType}/{id}&#x60;) of the resource to explain data access on.
...
async def healthcare_projects_locations_datasets_fhir_stores_fhir_concept_map_search_translate(request: web.Request, parent, xgafv=None, access_token=None, alt=None, param_callback=None, fields=None, key=None, oauth_token=None, pretty_print=None, quota_user=None, upload_protocol=None, upload_type=None, code=None, concept_map_version=None, source=None, system=None, target=None, url=None) -> web.Response:
    """healthcare_projects_locations_datasets_fhir_stores_fhir_concept_map_search_translate
    ...
    :param parent: Required. The name for the FHIR store containing the concept map(s) to use for the translation.
    :type parent: str
    :param xgafv: V1 error format.
    :type xgafv: str
    :param access_token: OAuth access token.
    ...
    :param upload_type: Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;).
    :type upload_type: str
    :param code: Required. The code to translate.
    :type code: str
    :param concept_map_version: The version of the concept map to use. If unset, the most current version is used.
    :type concept_map_version: str
    :param source: The source value set of the concept map to be used. If unset, target is used to search for concept maps.
    :type source: str
    :param system: Required. The system for the code to be translated.
    :type system: str
    :param target: The target value set of the concept map to be used. If unset, source is used to search for concept maps.
    :type target: str
    :param url: The canonical url of the concept map to use. If unset, the source and target is used to search for concept maps.
    :type url: str
...
async def healthcare_projects_locations_datasets_fhir_stores_fhir_concept_map_translate(request: web.Request, name, xgafv=None, access_token=None, alt=None, param_callback=None, fields=None, key=None, oauth_token=None, pretty_print=None, quota_user=None, upload_protocol=None, upload_type=None, code=None, concept_map_version=None, system=None) -> web.Response:
    ...
    :param name: Required. The URL for the concept map to use for the translation.
    :type name: str
    :param xgafv: V1 error format.
    :type xgafv: str
    :param access_token: OAuth access token.
...
async def healthcare_projects_locations_datasets_fhir_stores_fhir_create(request: web.Request, parent, type, xgafv=None, access_token=None, alt=None, param_callback=None, fields=None, key=None, oauth_token=None, pretty_print=None, quota_user=None, upload_protocol=None, upload_type=None, body=None) -> web.Response:
    ...
    :param parent: Required. The name of the FHIR store this resource belongs to.
    :type parent: str
    :param type: Required. The FHIR resource type to create, such as Patient or Observation. For a complete list, see the FHIR Resource Index ([DSTU2](https://hl7.org/implement/standards/fhir/DSTU2/resourcelist.html), [STU3](https://hl7.org/implement/standards/fhir/STU3/resourcelist.html), [R4](https://hl7.org/implement/standards/fhir/R4/resourcelist.html)). Must match the resource type in the provided content.
    :type type: str
    :param xgafv: V1 error format.
    :type xgafv: str
    :param access_token: OAuth access token.
...
async def healthcare_projects_locations_datasets_fhir_stores_fhir_observation_lastn(request: web.Request, parent, xgafv=None, access_token=None, alt=None, param_callback=None, fields=None, key=None, oauth_token=None, pretty_print=None, quota_user=None, upload_protocol=None, upload_type=None) -> web.Response:
...
async def healthcare_projects_locations_datasets_fhir_stores_fhir_patient_consent_enforcement_status(request: web.Request, name, xgafv=None, access_token=None, alt=None, param_callback=None, fields=None, key=None, oauth_token=None, pretty_print=None, quota_user=None, upload_protocol=None, upload_type=None, count=None, page_token=None) -> web.Response:
    ...
    :param name: Required. The name of the patient to find enforcement statuses, in the format &#x60;projects/{project_id}/locations/{location_id}/datasets/{dataset_id}/fhirStores/{fhir_store_id}/fhir/Patient/{patient_id}&#x60;
    :type name: str
    :param xgafv: V1 error format.
    :type xgafv: str
    :param access_token: OAuth access token.
    ...
    :param upload_type: Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;).
    :type upload_type: str
    :param count: Optional. The maximum number of results on a page. If not specified, 100 is used. May not be larger than 1000.
    :type count: int
    :param page_token: Optional. Used to retrieve the first, previous, next, or last page of consent enforcement statuses when using pagination. Value should be set to the value of &#x60;_page_token&#x60; set in next or previous page links&#39; URLs. Next and previous page are returned in the response bundle&#39;s links field, where &#x60;link.relation&#x60; is \&quot;previous\&quot; or \&quot;next\&quot;. Omit &#x60;_page_token&#x60; if no previous request has been made.
    :type page_token: str
...
async def healthcare_projects_locations_datasets_fhir_stores_fhir_patient_everything(request: web.Request, name, xgafv=None, access_token=None, alt=None, param_callback=None, fields=None, key=None, oauth_token=None, pretty_print=None, quota_user=None, upload_protocol=None, upload_type=None, count=None, page_token=None, since=None, type=None, end=None, start=None) -> web.Response:
    ...
    :param upload_type: Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;).
    :type upload_type: str
    :param count: Maximum number of resources in a page. If not specified, 100 is used. May not be larger than 1000.
    :type count: int
    ...
    :type page_token: str
    :param since: If provided, only resources updated after this time are returned. The time uses the format YYYY-MM-DDThh:mm:ss.sss+zz:zz. For example, &#x60;2015-02-07T13:28:17.239+02:00&#x60; or &#x60;2017-01-01T00:00:00Z&#x60;. The time must be specified to the second and include a time zone.
    :type since: str
    :param type: String of comma-delimited FHIR resource types. If provided, only resources of the specified resource type(s) are returned. Specifying multiple &#x60;_type&#x60; parameters isn&#39;t supported. For example, the result of &#x60;_type&#x3D;Observation&amp;_type&#x3D;Encounter&#x60; is undefined. Use &#x60;_type&#x3D;Observation,Encounter&#x60; instead.
    :type type: str
    :param end: The response includes records prior to the end date. The date uses the format YYYY-MM-DD. If no end date is provided, all records subsequent to the start date are in scope.
    :type end: str
    :param start: The response includes records subsequent to the start date. The date uses the format YYYY-MM-DD. If no start date is provided, all records prior to the end date are in scope.
    :type start: str
...
async def healthcare_projects_locations_datasets_fhir_stores_fhir_resource_incoming_references(request: web.Request, parent, xgafv=None, access_token=None, alt=None, param_callback=None, fields=None, key=None, oauth_token=None, pretty_print=None, quota_user=None, upload_protocol=None, upload_type=None, count=None, page_token=None, summary=None, type=None, target=None) -> web.Response:
    ...
    :param count: Maximum number of resources in a page. If not specified, 100 is used. May not be larger than 1000.
    :type count: int
    :param page_token: Used to retrieve the next page of results when using pagination. Set &#x60;_page_token&#x60; to the value of _page_token set in next page links&#39; url. Next page are returned in the response bundle&#39;s links field, where &#x60;link.relation&#x60; is \&quot;next\&quot;. Omit &#x60;_page_token&#x60; if no previous request has been made.
    :type page_token: str
    :param summary: Used to simplify the representation of the returned resources. &#x60;_summary&#x3D;text&#x60; returns only the &#x60;text&#x60;, &#x60;id&#x60;, and &#x60;meta&#x60; top-level fields. &#x60;_summary&#x3D;data&#x60; removes the &#x60;text&#x60; field and returns all other fields. &#x60;_summary&#x3D;false&#x60; returns all parts of the resource(s). Either not providing this parameter or providing an empty value to this parameter also returns all parts of the resource(s).
    :type summary: str
    :param type: String of comma-delimited FHIR resource types. If provided, only resources of the specified resource type(s) are returned. If not provided or an empty value is provided, no filter on the returned resource type(s) is applied.
    :type type: str
    :param target: Required. The target whose incoming references are requested. This param is required and must not be empty. It uses the format \&quot;ResourceType/ResourceID\&quot;, for example, target&#x3D;ResourceType/ResourceID.
    :type target: str
...
async def healthcare_projects_locations_datasets_fhir_stores_fhir_search_type(request: web.Request, parent, resource_type, xgafv=None, access_token=None, alt=None, param_callback=None, fields=None, key=None, oauth_token=None, pretty_print=None, quota_user=None, upload_protocol=None, upload_type=None, body=None) -> web.Response:
    ...
    :param parent: Required. Name of the FHIR store to retrieve resources from.
    :type parent: str
    :param resource_type: Required. The FHIR resource type to search, such as Patient or Observation. For a complete list, see the FHIR Resource Index ([DSTU2](https://hl7.org/implement/standards/fhir/DSTU2/resourcelist.html), [STU3](https://hl7.org/implement/standards/fhir/STU3/resourcelist.html), [R4](https://hl7.org/implement/standards/fhir/R4/resourcelist.html)).
...
async def healthcare_projects_locations_datasets_hl7_v2_stores_messages_batch_get(request: web.Request, parent, xgafv=None, access_token=None, alt=None, param_callback=None, fields=None, key=None, oauth_token=None, pretty_print=None, quota_user=None, upload_protocol=None, upload_type=None, ids=None, view=None) -> web.Response:
    """healthcare_projects_locations_datasets_hl7_v2_stores_messages_batch_get

    Gets multiple messages in the given HL7v2 store.

    :param parent: Required. Name of the HL7v2 store to retrieve messages from, in the format: &#x60;projects/{project_id}/locations/{location_id}/datasets/{dataset_id}/hl7v2Stores/{hl7v2_store_id}&#x60;.
    :type parent: str
    :param xgafv: V1 error format.
    :type xgafv: str
    :param access_token: OAuth access token.
    ...
    :param upload_type: Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;).
    :type upload_type: str
    :param ids: The resource id of the HL7v2 messages to retrieve in the format: &#x60;{message_id}&#x60;, where the full resource name is &#x60;{parent}/messages/{message_id}&#x60; A maximum of 100 messages can be retrieved in a batch. All &#39;ids&#39; have to be under parent.
    :type ids: List[str]
    :param view: Specifies the parts of the Messages resource to return in the response. When unspecified, equivalent to BASIC.
    :type view: str
