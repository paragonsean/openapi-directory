...
OAIGoogleCloudHealthcareV1beta1FhirBigQueryDestination OAIExportResourcesRequest::getBigqueryDestination() const {
    return m_bigquery_destination;
}
void OAIExportResourcesRequest::setBigqueryDestination(const OAIGoogleCloudHealthcareV1beta1FhirBigQueryDestination &bigquery_destination) {
...
OAIGoogleCloudHealthcareV1beta1FhirGcsDestination OAIExportResourcesRequest::getGcsDestination() const {
    return m_gcs_destination;
}
void OAIExportResourcesRequest::setGcsDestination(const OAIGoogleCloudHealthcareV1beta1FhirGcsDestination &gcs_destination) {
