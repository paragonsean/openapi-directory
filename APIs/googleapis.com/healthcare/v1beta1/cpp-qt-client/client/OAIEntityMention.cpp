...
QList<OAIFeature> OAIEntityMention::getAdditionalInfo() const {
    return m_additional_info;
}
void OAIEntityMention::setAdditionalInfo(const QList<OAIFeature> &additional_info) {
    m_additional_info = additional_info;
    m_additional_info_isSet = true;
}

bool OAIEntityMention::is_additional_info_Set() const{
    return m_additional_info_isSet;
}

bool OAIEntityMention::is_additional_info_Valid() const{
