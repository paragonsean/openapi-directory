...
void OAIFhirStore::initializeModel() {
    ...
    m_consent_config_isSet = false;
    m_consent_config_isValid = false;
    ...
    m_enable_history_modifications_isSet = false;
    m_enable_history_modifications_isValid = false;
...
void OAIFhirStore::fromJsonObject(QJsonObject json) {
    ...
    m_consent_config_isValid = ::OpenAPI::fromJsonValue(m_consent_config, json[QString("consentConfig")]);
    m_consent_config_isSet = !json[QString("consentConfig")].isNull() && m_consent_config_isValid;
    ...
    m_enable_history_modifications_isValid = ::OpenAPI::fromJsonValue(m_enable_history_modifications, json[QString("enableHistoryModifications")]);
    m_enable_history_modifications_isSet = !json[QString("enableHistoryModifications")].isNull() && m_enable_history_modifications_isValid;
...
QJsonObject OAIFhirStore::asJsonObject() const {
    ...
    if (m_consent_config.isSet()) {
        obj.insert(QString("consentConfig"), ::OpenAPI::toJsonValue(m_consent_config));
    }
    ...
    if (m_enable_history_modifications_isSet) {
        obj.insert(QString("enableHistoryModifications"), ::OpenAPI::toJsonValue(m_enable_history_modifications));
    }
...
OAIConsentConfig OAIFhirStore::getConsentConfig() const {
    return m_consent_config;
}
void OAIFhirStore::setConsentConfig(const OAIConsentConfig &consent_config) {
    m_consent_config = consent_config;
    m_consent_config_isSet = true;
}

bool OAIFhirStore::is_consent_config_Set() const{
    return m_consent_config_isSet;
}

bool OAIFhirStore::is_consent_config_Valid() const{
    return m_consent_config_isValid;
}
...
bool OAIFhirStore::isEnableHistoryModifications() const {
    return m_enable_history_modifications;
}
void OAIFhirStore::setEnableHistoryModifications(const bool &enable_history_modifications) {
    m_enable_history_modifications = enable_history_modifications;
    m_enable_history_modifications_isSet = true;
}

bool OAIFhirStore::is_enable_history_modifications_Set() const{
    return m_enable_history_modifications_isSet;
}

bool OAIFhirStore::is_enable_history_modifications_Valid() const{
    return m_enable_history_modifications_isValid;
}
...
OAISearchConfig OAIFhirStore::getSearchConfig() const {
    return m_search_config;
}
void OAIFhirStore::setSearchConfig(const OAISearchConfig &search_config) {
    m_search_config = search_config;
    m_search_config_isSet = true;
}

bool OAIFhirStore::is_search_config_Set() const{
    return m_search_config_isSet;
}

bool OAIFhirStore::is_search_config_Valid() const{
