...
OAIGoogleCloudHealthcareV1beta1ConsentGcsDestination OAIQueryAccessibleDataRequest::getGcsDestination() const {
    return m_gcs_destination;
}
void OAIQueryAccessibleDataRequest::setGcsDestination(const OAIGoogleCloudHealthcareV1beta1ConsentGcsDestination &gcs_destination) {
