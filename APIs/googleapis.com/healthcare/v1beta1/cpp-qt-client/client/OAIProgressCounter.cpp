...
void OAIProgressCounter::initializeModel() {
    ...
    m_secondary_failure_isSet = false;
    m_secondary_failure_isValid = false;

    m_secondary_success_isSet = false;
    m_secondary_success_isValid = false;
...
void OAIProgressCounter::fromJsonObject(QJsonObject json) {
    ...
    m_secondary_failure_isValid = ::OpenAPI::fromJsonValue(m_secondary_failure, json[QString("secondaryFailure")]);
    m_secondary_failure_isSet = !json[QString("secondaryFailure")].isNull() && m_secondary_failure_isValid;

    m_secondary_success_isValid = ::OpenAPI::fromJsonValue(m_secondary_success, json[QString("secondarySuccess")]);
    m_secondary_success_isSet = !json[QString("secondarySuccess")].isNull() && m_secondary_success_isValid;
...
QJsonObject OAIProgressCounter::asJsonObject() const {
    ...
    if (m_secondary_failure_isSet) {
        obj.insert(QString("secondaryFailure"), ::OpenAPI::toJsonValue(m_secondary_failure));
    }
    if (m_secondary_success_isSet) {
        obj.insert(QString("secondarySuccess"), ::OpenAPI::toJsonValue(m_secondary_success));
    }
    if (m_success_isSet) {
...
QString OAIProgressCounter::getSecondaryFailure() const {
    return m_secondary_failure;
}
void OAIProgressCounter::setSecondaryFailure(const QString &secondary_failure) {
    m_secondary_failure = secondary_failure;
    m_secondary_failure_isSet = true;
}

bool OAIProgressCounter::is_secondary_failure_Set() const{
    return m_secondary_failure_isSet;
}

bool OAIProgressCounter::is_secondary_failure_Valid() const{
    return m_secondary_failure_isValid;
}

QString OAIProgressCounter::getSecondarySuccess() const {
    return m_secondary_success;
}
void OAIProgressCounter::setSecondarySuccess(const QString &secondary_success) {
    m_secondary_success = secondary_success;
    m_secondary_success_isSet = true;
}

bool OAIProgressCounter::is_secondary_success_Set() const{
    return m_secondary_success_isSet;
}

bool OAIProgressCounter::is_secondary_success_Valid() const{
    return m_secondary_success_isValid;
}
