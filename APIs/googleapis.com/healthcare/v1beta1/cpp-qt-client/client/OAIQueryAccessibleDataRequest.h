...
namespace OpenAPI {
class OAIGoogleCloudHealthcareV1beta1ConsentGcsDestination;
...
public:
    ...
    OAIGoogleCloudHealthcareV1beta1ConsentGcsDestination getGcsDestination() const;
    void setGcsDestination(const OAIGoogleCloudHealthcareV1beta1ConsentGcsDestination &gcs_destination);
...
private:
    ...
    OAIGoogleCloudHealthcareV1beta1ConsentGcsDestination m_gcs_destination;
