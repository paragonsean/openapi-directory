...
OAIGoogleCloudHealthcareV1beta1FhirGcsSource OAIImportResourcesRequest::getGcsSource() const {
    return m_gcs_source;
}
void OAIImportResourcesRequest::setGcsSource(const OAIGoogleCloudHealthcareV1beta1FhirGcsSource &gcs_source) {
