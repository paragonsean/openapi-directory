...
public class EntityMention {
  ...
  private List<Feature> additionalInfo = new ArrayList<>();
  ...
  public EntityMention additionalInfo(List<Feature> additionalInfo) {
    this.additionalInfo = additionalInfo;
    return this;
  }

  public EntityMention addAdditionalInfoItem(Feature additionalInfoItem) {
  ...
  public void setAdditionalInfo(List<Feature> additionalInfo) {
    this.additionalInfo = additionalInfo;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.additionalInfo, entityMention.additionalInfo) &&
        Objects.equals(this.certaintyAssessment, entityMention.certaintyAssessment) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(additionalInfo, certaintyAssessment, confidence, linkedEntities, mentionId, subject, temporalAssessment, text, type);
  }
      ...
      if (jsonObj.get("additionalInfo") != null && !jsonObj.get("additionalInfo").isJsonNull()) {
        ...
        if (jsonArrayadditionalInfo != null) {
          ...
          for (int i = 0; i < jsonArrayadditionalInfo.size(); i++) {
            Feature.validateJsonElement(jsonArrayadditionalInfo.get(i));
          };
        }
      }
