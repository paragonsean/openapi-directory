...
public class ListMessagesResponse {
  public static final String SERIALIZED_NAME_HL7_V2_MESSAGES = "hl7V2Messages";
  @SerializedName(SERIALIZED_NAME_HL7_V2_MESSAGES)
  private List<Message> hl7V2Messages = new ArrayList<>();
  ...
  public ListMessagesResponse hl7V2Messages(List<Message> hl7V2Messages) {
    this.hl7V2Messages = hl7V2Messages;
    return this;
  }

  public ListMessagesResponse addHl7V2MessagesItem(Message hl7V2MessagesItem) {
    if (this.hl7V2Messages == null) {
      this.hl7V2Messages = new ArrayList<>();
    }
    this.hl7V2Messages.add(hl7V2MessagesItem);
    return this;
  }
  ...
  public List<Message> getHl7V2Messages() {
    return hl7V2Messages;
  }

  public void setHl7V2Messages(List<Message> hl7V2Messages) {
    this.hl7V2Messages = hl7V2Messages;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.hl7V2Messages, listMessagesResponse.hl7V2Messages) &&
        Objects.equals(this.nextPageToken, listMessagesResponse.nextPageToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(hl7V2Messages, nextPageToken);
  }
  ...
  public String toString() {
    ...
    sb.append("    hl7V2Messages: ").append(toIndentedString(hl7V2Messages)).append("\n");
  ...
  static {
    ...
    openapiFields.add("hl7V2Messages");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("hl7V2Messages") != null && !jsonObj.get("hl7V2Messages").isJsonNull()) {
        JsonArray jsonArrayhl7V2Messages = jsonObj.getAsJsonArray("hl7V2Messages");
        if (jsonArrayhl7V2Messages != null) {
          // ensure the json data is an array
          if (!jsonObj.get("hl7V2Messages").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `hl7V2Messages` to be an array in the JSON string but got `%s`", jsonObj.get("hl7V2Messages").toString()));
          }

          // validate the optional field `hl7V2Messages` (array)
          for (int i = 0; i < jsonArrayhl7V2Messages.size(); i++) {
            Message.validateJsonElement(jsonArrayhl7V2Messages.get(i));
          };
        }
      }
