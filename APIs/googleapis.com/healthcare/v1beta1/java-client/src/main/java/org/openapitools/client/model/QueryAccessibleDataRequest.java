...
public class QueryAccessibleDataRequest {
  ...
  public QueryAccessibleDataRequest gcsDestination(GoogleCloudHealthcareV1beta1ConsentGcsDestination gcsDestination) {
  ...
  public void setGcsDestination(GoogleCloudHealthcareV1beta1ConsentGcsDestination gcsDestination) {
    this.gcsDestination = gcsDestination;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("gcsDestination") != null && !jsonObj.get("gcsDestination").isJsonNull()) {
        GoogleCloudHealthcareV1beta1ConsentGcsDestination.validateJsonElement(jsonObj.get("gcsDestination"));
      }
  }
