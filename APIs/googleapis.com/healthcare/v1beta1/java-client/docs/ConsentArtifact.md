...
|------------ | ------------- | ------------- | -------------|
|**consentContentScreenshots** | [**List&lt;Image&gt;**](Image.md) | Optional. Screenshots, PDFs, or other binary information documenting the user&#39;s consent. |  [optional] |
...
|**metadata** | **Map&lt;String, String&gt;** | Optional. Metadata associated with the Consent artifact. For example, the consent locale or user agent version. |  [optional] |
