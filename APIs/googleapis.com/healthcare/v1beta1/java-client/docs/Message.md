...
|**data** | **byte[]** | Required. Raw message bytes. |  [optional] |
...
|**patientIds** | [**List&lt;PatientId&gt;**](PatientId.md) | All patient IDs listed in the PID-2, PID-3, and PID-4 segments of this message. |  [optional] |
