...
void OAIIpReputation::initializeModel() {
    ...
    m_num_ips_isSet = false;
    m_num_ips_isValid = false;
...
void OAIIpReputation::fromJsonObject(QJsonObject json) {
    ...
    m_num_ips_isValid = ::OpenAPI::fromJsonValue(m_num_ips, json[QString("numIps")]);
    m_num_ips_isSet = !json[QString("numIps")].isNull() && m_num_ips_isValid;
...
QJsonObject OAIIpReputation::asJsonObject() const {
    ...
    if (m_num_ips_isSet) {
        obj.insert(QString("numIps"), ::OpenAPI::toJsonValue(m_num_ips));
    }
...
QString OAIIpReputation::getNumIps() const {
    return m_num_ips;
}
void OAIIpReputation::setNumIps(const QString &num_ips) {
    m_num_ips = num_ips;
    m_num_ips_isSet = true;
}

bool OAIIpReputation::is_num_ips_Set() const{
    return m_num_ips_isSet;
}

bool OAIIpReputation::is_num_ips_Valid() const{
    return m_num_ips_isValid;
}
