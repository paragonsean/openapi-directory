...
async def test_genomics_projects_operations_cancel(client):
...
async def test_genomics_projects_operations_list(client):
...
async def test_genomics_projects_workers_check_in(client):
    ...
    response = await client.request(
        method='POST',
        path='/v2alpha1/{idcheck_i}'.format(id='id_example'),
        headers=headers,
        json=body,
        params=params,
        )
