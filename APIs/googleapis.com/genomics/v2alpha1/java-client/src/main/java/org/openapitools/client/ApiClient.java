...
public class ApiClient {
    ...
    private String basePath = "https://genomics.googleapis.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/v2alpha1/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://genomics.googleapis.com
