...
class OperationMetadata(Model):
    ...
    def __init__(self, api_version: str=None, cancellation_requested: bool=None, create_time: str=None, end_time: str=None, status_message: str=None, target: str=None, verb: str=None):
        """OperationMetadata - a model defined in OpenAPI

        :param api_version: The api_version of this OperationMetadata.
        :param cancellation_requested: The cancellation_requested of this OperationMetadata.
    ...
    def cancellation_requested(self):
        """Gets the cancellation_requested of this OperationMetadata.

        Identifies whether the user has requested cancellation of the operation. Operations that have successfully been cancelled have Operation.error value with a google.rpc.Status.code of 1, corresponding to `Code.CANCELLED`.

        :return: The cancellation_requested of this OperationMetadata.
        :rtype: bool
        """
    ...
    def cancellation_requested(self, cancellation_requested):
        """Sets the cancellation_requested of this OperationMetadata.
