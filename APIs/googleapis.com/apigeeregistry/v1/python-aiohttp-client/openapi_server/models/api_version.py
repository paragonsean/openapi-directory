...
class ApiVersion(Model):
    ...
    def __init__(self, annotations: Dict[str, str]=None, create_time: str=None, description: str=None, display_name: str=None, labels: Dict[str, str]=None, name: str=None, primary_spec: str=None, state: str=None, update_time: str=None):
        ...
        :param primary_spec: The primary_spec of this ApiVersion.
    ...
    def primary_spec(self):
        """Gets the primary_spec of this ApiVersion.

        The primary spec for this version. Format: projects/{project}/locations/{location}/apis/{api}/versions/{version}/specs/{spec}

        :return: The primary_spec of this ApiVersion.
        :rtype: str
        """
        return self._primary_spec

    @primary_spec.setter
    def primary_spec(self, primary_spec):
        """Sets the primary_spec of this ApiVersion.

        The primary spec for this version. Format: projects/{project}/locations/{location}/apis/{api}/versions/{version}/specs/{spec}

        :param primary_spec: The primary_spec of this ApiVersion.
        :type primary_spec: str
        """
