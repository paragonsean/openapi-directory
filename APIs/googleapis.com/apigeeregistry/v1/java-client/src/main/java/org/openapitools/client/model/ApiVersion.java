...
public class ApiVersion {
  ...
  public static final String SERIALIZED_NAME_PRIMARY_SPEC = "primarySpec";
  @SerializedName(SERIALIZED_NAME_PRIMARY_SPEC)
  ...
  public ApiVersion primarySpec(String primarySpec) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.annotations, apiVersion.annotations) &&
        ...
        Objects.equals(this.primarySpec, apiVersion.primarySpec) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(annotations, createTime, description, displayName, labels, name, primarySpec, state, updateTime);
  }
  ...
  public String toString() {
    ...
    sb.append("    primarySpec: ").append(toIndentedString(primarySpec)).append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("primarySpec") != null && !jsonObj.get("primarySpec").isJsonNull()) && !jsonObj.get("primarySpec").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `primarySpec` to be a primitive type in the JSON string but got `%s`", jsonObj.get("primarySpec").toString()));
      }
