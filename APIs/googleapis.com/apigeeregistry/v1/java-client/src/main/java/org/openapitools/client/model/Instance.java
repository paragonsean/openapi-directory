...
public class Instance {
  ...
  public Instance build(Build build) {
    this.build = build;
    return this;
  }
  ...
  public Instance config(Config config) {
    this.config = config;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.build, instance.build) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(build, config, createTime, name, state, stateMessage, updateTime);
  }
