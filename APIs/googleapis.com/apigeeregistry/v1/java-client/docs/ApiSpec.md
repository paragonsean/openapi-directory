...
|**contents** | **byte[]** | Input only. The contents of the spec. Provided by API callers when specs are created or updated. To access the contents of a spec, use GetApiSpecContents. |  [optional] |
|**createTime** | **String** | Output only. Creation timestamp; when the spec resource was created. |  [optional] [readonly] |
