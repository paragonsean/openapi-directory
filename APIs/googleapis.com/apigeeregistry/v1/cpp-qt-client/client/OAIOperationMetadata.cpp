...
bool OAIOperationMetadata::isCancellationRequested() const {
    return m_cancellation_requested;
}
void OAIOperationMetadata::setCancellationRequested(const bool &cancellation_requested) {
    m_cancellation_requested = cancellation_requested;
    m_cancellation_requested_isSet = true;
}

bool OAIOperationMetadata::is_cancellation_requested_Set() const{
    return m_cancellation_requested_isSet;
}

bool OAIOperationMetadata::is_cancellation_requested_Valid() const{
