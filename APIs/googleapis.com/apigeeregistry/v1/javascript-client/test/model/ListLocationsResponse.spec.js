...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApigeeRegistryApi.ListLocationsResponse();
  });
  ...
  describe('ListLocationsResponse', function() {
    it('should create an instance of ListLocationsResponse', function() {
      ...
      //var instance = new ApigeeRegistryApi.ListLocationsResponse();
      //expect(instance).to.be.a(ApigeeRegistryApi.ListLocationsResponse);
    });
