...
class ApiVersion {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('primarySpec')) {
                obj['primarySpec'] = ApiClient.convertToType(data['primarySpec'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['primarySpec'] && !(typeof data['primarySpec'] === 'string' || data['primarySpec'] instanceof String)) {
            throw new Error("Expected the field `primarySpec` to be a primitive type in the JSON string but got " + data['primarySpec']);
        }
        // ensure the json data is a string
 ...
 * @member {String} primarySpec
 */
ApiVersion.prototype['primarySpec'] = undefined;
