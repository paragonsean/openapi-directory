...
|------------ | ------------- | ------------- | -------------|
|**identities** | **List&lt;String&gt;** | A list of identities that are allowed access through this ingress policy. Should be in the format of email address. The email address should represent individual user or service account only. |  [optional] |
