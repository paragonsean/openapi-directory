...
|**nonCriticalErrors** | [**List&lt;GoogleCloudAssetV1p4beta1AnalysisState&gt;**](GoogleCloudAssetV1p4beta1AnalysisState.md) | A list of non-critical errors happened during the request handling to explain why &#x60;fully_explored&#x60; is false, or empty if no error happened. |  [optional] |
