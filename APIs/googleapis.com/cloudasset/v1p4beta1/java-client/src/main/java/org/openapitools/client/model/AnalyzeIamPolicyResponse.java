...
public class AnalyzeIamPolicyResponse {
  ...
  private List<GoogleCloudAssetV1p4beta1AnalysisState> nonCriticalErrors = new ArrayList<>();
  ...
  public AnalyzeIamPolicyResponse nonCriticalErrors(List<GoogleCloudAssetV1p4beta1AnalysisState> nonCriticalErrors) {
    this.nonCriticalErrors = nonCriticalErrors;
    return this;
  }

  public AnalyzeIamPolicyResponse addNonCriticalErrorsItem(GoogleCloudAssetV1p4beta1AnalysisState nonCriticalErrorsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<GoogleCloudAssetV1p4beta1AnalysisState> getNonCriticalErrors() {
    return nonCriticalErrors;
  }

  public void setNonCriticalErrors(List<GoogleCloudAssetV1p4beta1AnalysisState> nonCriticalErrors) {
    this.nonCriticalErrors = nonCriticalErrors;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.fullyExplored, analyzeIamPolicyResponse.fullyExplored) &&
        ...
        Objects.equals(this.nonCriticalErrors, analyzeIamPolicyResponse.nonCriticalErrors) &&
        Objects.equals(this.serviceAccountImpersonationAnalysis, analyzeIamPolicyResponse.serviceAccountImpersonationAnalysis);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fullyExplored, mainAnalysis, nonCriticalErrors, serviceAccountImpersonationAnalysis);
  }
      ...
      if (jsonObj.get("nonCriticalErrors") != null && !jsonObj.get("nonCriticalErrors").isJsonNull()) {
        ...
        if (jsonArraynonCriticalErrors != null) {
          ...
          for (int i = 0; i < jsonArraynonCriticalErrors.size(); i++) {
            GoogleCloudAssetV1p4beta1AnalysisState.validateJsonElement(jsonArraynonCriticalErrors.get(i));
          };
        }
      }
