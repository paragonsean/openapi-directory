...
QList<OAIGoogleCloudAssetV1p4beta1AnalysisState> OAIAnalyzeIamPolicyResponse::getNonCriticalErrors() const {
    return m_non_critical_errors;
}
void OAIAnalyzeIamPolicyResponse::setNonCriticalErrors(const QList<OAIGoogleCloudAssetV1p4beta1AnalysisState> &non_critical_errors) {
    m_non_critical_errors = non_critical_errors;
    m_non_critical_errors_isSet = true;
}

bool OAIAnalyzeIamPolicyResponse::is_non_critical_errors_Set() const{
    return m_non_critical_errors_isSet;
}

bool OAIAnalyzeIamPolicyResponse::is_non_critical_errors_Valid() const{
