...
QList<OAIGoogleCloudAssetV1p4beta1AccessControlList> OAIIamPolicyAnalysisResult::getAccessControlLists() const {
    return m_access_control_lists;
}
void OAIIamPolicyAnalysisResult::setAccessControlLists(const QList<OAIGoogleCloudAssetV1p4beta1AccessControlList> &access_control_lists) {
...
OAIGoogleCloudAssetV1p4beta1IdentityList OAIIamPolicyAnalysisResult::getIdentityList() const {
    return m_identity_list;
}
void OAIIamPolicyAnalysisResult::setIdentityList(const OAIGoogleCloudAssetV1p4beta1IdentityList &identity_list) {
