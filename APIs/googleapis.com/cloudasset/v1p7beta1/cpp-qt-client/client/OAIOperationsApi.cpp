...
void OAIOperationsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("cloudasset_operations_get", defaultConf);
    _serverIndices.insert("cloudasset_operations_get", 0);
}
...
void OAIOperationsApi::cloudasset_operations_get(const QString &name, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type) {
    QString fullPath = QString(_serverConfigs["cloudasset_operations_get"][_serverIndices.value("cloudasset_operations_get")].URL()+"/v1p7beta1/{name}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIOperationsApi::cloudasset_operations_getCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIOperationsApi::cloudasset_operations_getCallback);
...
void OAIOperationsApi::cloudasset_operations_getCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT cloudasset_operations_getSignal(output);
        Q_EMIT cloudasset_operations_getSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT cloudasset_operations_getSignalE(output, error_type, error_str);
        Q_EMIT cloudasset_operations_getSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT cloudasset_operations_getSignalError(output, error_type, error_str);
        Q_EMIT cloudasset_operations_getSignalErrorFull(worker, error_type, error_str);
    }
}
