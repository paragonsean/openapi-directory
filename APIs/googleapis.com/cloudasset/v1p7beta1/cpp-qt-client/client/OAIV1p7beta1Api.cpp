...
OAIV1p7beta1Api::OAIV1p7beta1Api(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIV1p7beta1Api::~OAIV1p7beta1Api() {
}

void OAIV1p7beta1Api::initializeServerConfigs() {
    //Default server
...
*/
int OAIV1p7beta1Api::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIV1p7beta1Api::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIV1p7beta1Api::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIV1p7beta1Api::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIV1p7beta1Api::setUsername(const QString &username) {
    _username = username;
}

void OAIV1p7beta1Api::setPassword(const QString &password) {
    _password = password;
}


void OAIV1p7beta1Api::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIV1p7beta1Api::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIV1p7beta1Api::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIV1p7beta1Api::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIV1p7beta1Api::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIV1p7beta1Api::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIV1p7beta1Api::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIV1p7beta1Api::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIV1p7beta1Api::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIV1p7beta1Api::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIV1p7beta1Api::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIV1p7beta1Api::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIV1p7beta1Api::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIV1p7beta1Api::cloudasset_exportAssets(const QString &parent, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<OAIGoogleCloudAssetV1p7beta1ExportAssetsRequest> &oai_google_cloud_asset_v1p7beta1_export_assets_request) {
    QString fullPath = QString(_serverConfigs["cloudasset_exportAssets"][_serverIndices.value("cloudasset_exportAssets")].URL()+"/v1p7beta1/{parent}:exportAssets");
    ...
    if (oai_google_cloud_asset_v1p7beta1_export_assets_request.hasValue()){

        
        QByteArray output = oai_google_cloud_asset_v1p7beta1_export_assets_request.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIV1p7beta1Api::cloudasset_exportAssetsCallback);
    connect(this, &OAIV1p7beta1Api::abortRequestsSignal, worker, &QObject::deleteLater);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIV1p7beta1Api::cloudasset_exportAssetsCallback);
    connect(this, &OAIV1p7beta1Api::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
...
void OAIV1p7beta1Api::cloudasset_exportAssetsCallback(OAIHttpRequestWorker *worker) {
...
void OAIV1p7beta1Api::tokenAvailable(){
