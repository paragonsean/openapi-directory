...
#ifndef OAI_OAIV1p7beta1Api_H
#define OAI_OAIV1p7beta1Api_H
...
class OAIV1p7beta1Api : public QObject {
    Q_OBJECT

public:
    OAIV1p7beta1Api(const int timeOut = 0);
    ~OAIV1p7beta1Api();
