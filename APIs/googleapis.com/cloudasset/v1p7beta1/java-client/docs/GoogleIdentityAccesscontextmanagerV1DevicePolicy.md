...
|**osConstraints** | [**List&lt;GoogleIdentityAccesscontextmanagerV1OsConstraint&gt;**](GoogleIdentityAccesscontextmanagerV1OsConstraint.md) | Allowed OS versions, an empty list allows all types and all versions. |  [optional] |
