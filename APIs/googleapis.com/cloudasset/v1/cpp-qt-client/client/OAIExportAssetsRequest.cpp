...
QList<QString> OAIExportAssetsRequest::getRelationshipTypes() const {
    return m_relationship_types;
}
void OAIExportAssetsRequest::setRelationshipTypes(const QList<QString> &relationship_types) {
    m_relationship_types = relationship_types;
    m_relationship_types_isSet = true;
}

bool OAIExportAssetsRequest::is_relationship_types_Set() const{
    return m_relationship_types_isSet;
}

bool OAIExportAssetsRequest::is_relationship_types_Valid() const{
