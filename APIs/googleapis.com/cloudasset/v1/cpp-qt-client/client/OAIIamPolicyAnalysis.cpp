...
void OAIIamPolicyAnalysis::initializeModel() {
    ...
    m_non_critical_errors_isSet = false;
    m_non_critical_errors_isValid = false;
}
...
void OAIIamPolicyAnalysis::fromJsonObject(QJsonObject json) {
    ...
    m_non_critical_errors_isValid = ::OpenAPI::fromJsonValue(m_non_critical_errors, json[QString("nonCriticalErrors")]);
    m_non_critical_errors_isSet = !json[QString("nonCriticalErrors")].isNull() && m_non_critical_errors_isValid;
}
...
QJsonObject OAIIamPolicyAnalysis::asJsonObject() const {
    ...
    if (m_non_critical_errors.size() > 0) {
        obj.insert(QString("nonCriticalErrors"), ::OpenAPI::toJsonValue(m_non_critical_errors));
    }
    return obj;
}
...
QList<OAIIamPolicyAnalysisState> OAIIamPolicyAnalysis::getNonCriticalErrors() const {
    return m_non_critical_errors;
}
void OAIIamPolicyAnalysis::setNonCriticalErrors(const QList<OAIIamPolicyAnalysisState> &non_critical_errors) {
    m_non_critical_errors = non_critical_errors;
    m_non_critical_errors_isSet = true;
}

bool OAIIamPolicyAnalysis::is_non_critical_errors_Set() const{
    return m_non_critical_errors_isSet;
}

bool OAIIamPolicyAnalysis::is_non_critical_errors_Valid() const{
    return m_non_critical_errors_isValid;
}
