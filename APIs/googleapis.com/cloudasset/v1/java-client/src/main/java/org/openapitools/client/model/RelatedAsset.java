...
public class RelatedAsset {
  ...
  public RelatedAsset ancestors(List<String> ancestors) {
    this.ancestors = ancestors;
    return this;
  }

  public RelatedAsset addAncestorsItem(String ancestorsItem) {
  ...
  public RelatedAsset asset(String asset) {
    this.asset = asset;
    return this;
  }
  ...
  public RelatedAsset assetType(String assetType) {
  ...
  public RelatedAsset relationshipType(String relationshipType) {
  ...
  public boolean equals(Object o) {
    ...
    RelatedAsset relatedAsset = (RelatedAsset) o;
    return Objects.equals(this.ancestors, relatedAsset.ancestors) &&
        Objects.equals(this.asset, relatedAsset.asset) &&
        Objects.equals(this.assetType, relatedAsset.assetType) &&
        Objects.equals(this.relationshipType, relatedAsset.relationshipType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ancestors, asset, assetType, relationshipType);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to RelatedAsset
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RelatedAsset.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RelatedAsset is not found in the empty JSON string", RelatedAsset.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RelatedAsset.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RelatedAsset` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RelatedAsset.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RelatedAsset' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RelatedAsset> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RelatedAsset.class));

       return (TypeAdapter<T>) new TypeAdapter<RelatedAsset>() {
           @Override
           public void write(JsonWriter out, RelatedAsset value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RelatedAsset read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RelatedAsset given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RelatedAsset
   * @throws IOException if the JSON string is invalid with respect to RelatedAsset
   */
  public static RelatedAsset fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RelatedAsset.class);
  }

  /**
   * Convert an instance of RelatedAsset to an JSON string
   *
   * @return JSON string
   */
