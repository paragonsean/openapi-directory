...
public class IamPolicyAnalysisResult {
  ...
  private List<GoogleCloudAssetV1AccessControlList> accessControlLists = new ArrayList<>();
  ...
  public IamPolicyAnalysisResult accessControlLists(List<GoogleCloudAssetV1AccessControlList> accessControlLists) {
    this.accessControlLists = accessControlLists;
    return this;
  }

  public IamPolicyAnalysisResult addAccessControlListsItem(GoogleCloudAssetV1AccessControlList accessControlListsItem) {
  ...
  public void setAccessControlLists(List<GoogleCloudAssetV1AccessControlList> accessControlLists) {
    this.accessControlLists = accessControlLists;
  }
  ...
  public IamPolicyAnalysisResult identityList(GoogleCloudAssetV1IdentityList identityList) {
  ...
  public void setIdentityList(GoogleCloudAssetV1IdentityList identityList) {
    this.identityList = identityList;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("accessControlLists") != null && !jsonObj.get("accessControlLists").isJsonNull()) {
        ...
        if (jsonArrayaccessControlLists != null) {
          ...
          for (int i = 0; i < jsonArrayaccessControlLists.size(); i++) {
            GoogleCloudAssetV1AccessControlList.validateJsonElement(jsonArrayaccessControlLists.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("identityList") != null && !jsonObj.get("identityList").isJsonNull()) {
        GoogleCloudAssetV1IdentityList.validateJsonElement(jsonObj.get("identityList"));
      }
  }
