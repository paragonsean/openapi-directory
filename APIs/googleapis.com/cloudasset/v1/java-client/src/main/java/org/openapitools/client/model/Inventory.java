...
public class Inventory {
  ...
  public Inventory items(Map<String, Item> items) {
    this.items = items;
    return this;
  }

  public Inventory putItemsItem(String key, Item itemsItem) {
    if (this.items == null) {
  ...
  public Inventory osInfo(OsInfo osInfo) {
    this.osInfo = osInfo;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("osInfo") != null && !jsonObj.get("osInfo").isJsonNull()) {
        OsInfo.validateJsonElement(jsonObj.get("osInfo"));
      }
