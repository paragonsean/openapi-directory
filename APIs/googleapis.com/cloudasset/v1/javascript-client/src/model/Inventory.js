...
class Inventory {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], {'String': Item});
            }
            if (data.hasOwnProperty('name')) {
                obj['name'] = ApiClient.convertToType(data['name'], 'String');
            }
            if (data.hasOwnProperty('osInfo')) {
                obj['osInfo'] = OsInfo.constructFromObject(data['osInfo']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['osInfo']) { // data not null
          OsInfo.validateJSON(data['osInfo']);
        }
        // ensure the json data is a string
 ...
 * @member {Object.<String, module:model/Item>} items
 */
...
/**
 * @member {module:model/OsInfo} osInfo
 */
