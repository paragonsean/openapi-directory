...
/**
 * The OsInfo model module.
 * @module model/OsInfo
 * @version v1
 */
class OsInfo {
    /**
     * Constructs a new <code>OsInfo</code>.
     * Operating system information for the VM.
     * @alias module:model/OsInfo
     */
    constructor() { 
        
        OsInfo.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OsInfo</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OsInfo} obj Optional instance to populate.
     * @return {module:model/OsInfo} The populated <code>OsInfo</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>OsInfo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OsInfo</code>.
     */
 ...
 */
OsInfo.prototype['architecture'] = undefined;

/**
 * The VM hostname.
 * @member {String} hostname
 */
OsInfo.prototype['hostname'] = undefined;

/**
 * The kernel release of the operating system.
 * @member {String} kernelRelease
 */
OsInfo.prototype['kernelRelease'] = undefined;

/**
 * The kernel version of the operating system.
 * @member {String} kernelVersion
 */
OsInfo.prototype['kernelVersion'] = undefined;

/**
 * The operating system long name. For example 'Debian GNU/Linux 9' or 'Microsoft Window Server 2019 Datacenter'.
 * @member {String} longName
 */
OsInfo.prototype['longName'] = undefined;

/**
 * The current version of the OS Config agent running on the VM.
 * @member {String} osconfigAgentVersion
 */
OsInfo.prototype['osconfigAgentVersion'] = undefined;

/**
 * The operating system short name. For example, 'windows' or 'debian'.
 * @member {String} shortName
 */
OsInfo.prototype['shortName'] = undefined;

/**
 * The version of the operating system.
 * @member {String} version
 */
OsInfo.prototype['version'] = undefined;
