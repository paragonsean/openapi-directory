...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudAssetApi.RelatedAsset();
  });
  ...
  describe('RelatedAsset', function() {
    it('should create an instance of RelatedAsset', function() {
      // uncomment below and update the code to test RelatedAsset
      //var instance = new CloudAssetApi.RelatedAsset();
      //expect(instance).to.be.a(CloudAssetApi.RelatedAsset);
    });
