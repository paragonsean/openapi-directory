# CloudAssetApi.GoogleCloudAssetV1BigQueryDestination
...
**partitionKey** | **String** | The partition key for BigQuery partitioned table. | [optional] 
...
* `PARTITION_KEY_UNSPECIFIED` (value: `"PARTITION_KEY_UNSPECIFIED"`)
