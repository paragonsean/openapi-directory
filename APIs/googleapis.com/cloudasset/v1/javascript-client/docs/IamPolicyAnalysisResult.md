...
------------ | ------------- | ------------- | -------------
**accessControlLists** | [**[GoogleCloudAssetV1AccessControlList]**](GoogleCloudAssetV1AccessControlList.md) | The access control lists derived from the iam_binding that match or potentially match resource and access selectors specified in the request. | [optional] 
