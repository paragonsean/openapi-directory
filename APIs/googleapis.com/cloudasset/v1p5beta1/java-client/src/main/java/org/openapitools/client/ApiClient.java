...
public class ApiClient {
    ...
    private String basePath = "https://cloudasset.googleapis.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/v1p5beta1/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://cloudasset.googleapis.com
