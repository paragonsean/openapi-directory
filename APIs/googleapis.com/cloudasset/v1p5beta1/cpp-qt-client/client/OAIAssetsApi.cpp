...
void OAIAssetsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("cloudasset_assets_list", defaultConf);
    _serverIndices.insert("cloudasset_assets_list", 0);
}
...
void OAIAssetsApi::cloudasset_assets_list(const QString &parent, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<QList<QString>> &asset_types, const ::OpenAPI::OptionalParam<QString> &content_type, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &page_token, const ::OpenAPI::OptionalParam<QString> &read_time) {
    QString fullPath = QString(_serverConfigs["cloudasset_assets_list"][_serverIndices.value("cloudasset_assets_list")].URL()+"/v1p5beta1/{parent}/assets");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAssetsApi::cloudasset_assets_listCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAssetsApi::cloudasset_assets_listCallback);
...
void OAIAssetsApi::cloudasset_assets_listCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT cloudasset_assets_listSignal(output);
        Q_EMIT cloudasset_assets_listSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT cloudasset_assets_listSignalE(output, error_type, error_str);
        Q_EMIT cloudasset_assets_listSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT cloudasset_assets_listSignalError(output, error_type, error_str);
        Q_EMIT cloudasset_assets_listSignalErrorFull(worker, error_type, error_str);
    }
}
