...
|------------ | ------------- | ------------- | -------------|
|**devicePolicy** | [**GoogleIdentityAccesscontextmanagerV1DevicePolicy**](GoogleIdentityAccesscontextmanagerV1DevicePolicy.md) |  |  [optional] |
...
|**vpcNetworkSources** | [**List&lt;GoogleIdentityAccesscontextmanagerV1VpcNetworkSource&gt;**](GoogleIdentityAccesscontextmanagerV1VpcNetworkSource.md) | The request must originate from one of the provided VPC networks in Google Cloud. Cannot specify this field together with &#x60;ip_subnetworks&#x60;. |  [optional] |
