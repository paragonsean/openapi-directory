...
void OAIProjectsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("cloudasset_projects_batchGetAssetsHistory", defaultConf);
    _serverIndices.insert("cloudasset_projects_batchGetAssetsHistory", 0);
    _serverConfigs.insert("cloudasset_projects_exportAssets", defaultConf);
    _serverIndices.insert("cloudasset_projects_exportAssets", 0);
    _serverConfigs.insert("cloudasset_projects_operations_get", defaultConf);
    _serverIndices.insert("cloudasset_projects_operations_get", 0);
}
...
void OAIProjectsApi::cloudasset_projects_batchGetAssetsHistory(const QString &parent, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<QList<QString>> &asset_names, const ::OpenAPI::OptionalParam<QString> &content_type, const ::OpenAPI::OptionalParam<QString> &read_time_window_end_time, const ::OpenAPI::OptionalParam<QString> &read_time_window_start_time) {
    QString fullPath = QString(_serverConfigs["cloudasset_projects_batchGetAssetsHistory"][_serverIndices.value("cloudasset_projects_batchGetAssetsHistory")].URL()+"/v1beta1/{parent}:batchGetAssetsHistory");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::cloudasset_projects_batchGetAssetsHistoryCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::cloudasset_projects_batchGetAssetsHistoryCallback);
...
void OAIProjectsApi::cloudasset_projects_batchGetAssetsHistoryCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT cloudasset_projects_batchGetAssetsHistorySignal(output);
        Q_EMIT cloudasset_projects_batchGetAssetsHistorySignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT cloudasset_projects_batchGetAssetsHistorySignalE(output, error_type, error_str);
        Q_EMIT cloudasset_projects_batchGetAssetsHistorySignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT cloudasset_projects_batchGetAssetsHistorySignalError(output, error_type, error_str);
        Q_EMIT cloudasset_projects_batchGetAssetsHistorySignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectsApi::cloudasset_projects_exportAssets(const QString &parent, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<OAIExportAssetsRequest> &oai_export_assets_request) {
    QString fullPath = QString(_serverConfigs["cloudasset_projects_exportAssets"][_serverIndices.value("cloudasset_projects_exportAssets")].URL()+"/v1beta1/{parent}:exportAssets");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::cloudasset_projects_exportAssetsCallback);
    connect(this, &OAIProjectsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::cloudasset_projects_exportAssetsCallback);
    connect(this, &OAIProjectsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectsApi::cloudasset_projects_exportAssetsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT cloudasset_projects_exportAssetsSignal(output);
        Q_EMIT cloudasset_projects_exportAssetsSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("https://www.googleapis.com/auth/cloud-platform");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT cloudasset_projects_exportAssetsSignalE(output, error_type, error_str);
        Q_EMIT cloudasset_projects_exportAssetsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT cloudasset_projects_exportAssetsSignalError(output, error_type, error_str);
        Q_EMIT cloudasset_projects_exportAssetsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectsApi::cloudasset_projects_operations_get(const QString &name, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type) {
    QString fullPath = QString(_serverConfigs["cloudasset_projects_operations_get"][_serverIndices.value("cloudasset_projects_operations_get")].URL()+"/v1beta1/{name}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::cloudasset_projects_operations_getCallback);
    connect(this, &OAIProjectsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::cloudasset_projects_operations_getCallback);
    connect(this, &OAIProjectsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectsApi::cloudasset_projects_operations_getCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT cloudasset_projects_operations_getSignal(output);
        Q_EMIT cloudasset_projects_operations_getSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("https://www.googleapis.com/auth/cloud-platform");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT cloudasset_projects_operations_getSignalE(output, error_type, error_str);
        Q_EMIT cloudasset_projects_operations_getSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT cloudasset_projects_operations_getSignalError(output, error_type, error_str);
        Q_EMIT cloudasset_projects_operations_getSignalErrorFull(worker, error_type, error_str);
    }
}
