...
export default class ResourcesApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the cloudassetResourcesSearchAll operation.
     * @callback module:api/ResourcesApi~cloudassetResourcesSearchAllCallback
     ...
     * @param {module:api/ResourcesApi~cloudassetResourcesSearchAllCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/SearchAllResourcesResponse}
     */
    cloudassetResourcesSearchAll(scope, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'scope' is set
      if (scope === undefined || scope === null) {
        throw new Error("Missing the required parameter 'scope' when calling cloudassetResourcesSearchAll");
      }
      ...
      return this.apiClient.callApi(
        '/v1p1beta1/{scope}/resources:searchAll', 'GET',
