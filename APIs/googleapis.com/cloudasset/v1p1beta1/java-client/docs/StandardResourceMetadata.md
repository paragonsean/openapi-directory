...
|------------ | ------------- | ------------- | -------------|
|**additionalAttributes** | **List&lt;String&gt;** | Additional searchable attributes of this resource. Informational only. The exact set of attributes is subject to change. For example: project id, DNS name etc. |  [optional] |
...
|**labels** | **Map&lt;String, String&gt;** | Labels associated with this resource. See [Labelling and grouping Google Cloud resources](https://cloud.google.com/blog/products/gcp/labelling-and-grouping-your-google-cloud-platform-resources) for more information. |  [optional] |
