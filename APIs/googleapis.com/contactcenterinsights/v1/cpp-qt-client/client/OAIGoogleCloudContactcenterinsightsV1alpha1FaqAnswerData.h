...
/*
 * OAIGoogleCloudContactcenterinsightsV1alpha1FaqAnswerData.h
 *
 * Agent Assist frequently-asked-question answer data.
 */

#ifndef OAIGoogleCloudContactcenterinsightsV1alpha1FaqAnswerData_H
#define OAIGoogleCloudContactcenterinsightsV1alpha1FaqAnswerData_H
...
class OAIGoogleCloudContactcenterinsightsV1alpha1FaqAnswerData : public OAIObject {
public:
    OAIGoogleCloudContactcenterinsightsV1alpha1FaqAnswerData();
    OAIGoogleCloudContactcenterinsightsV1alpha1FaqAnswerData(QString json);
    ~OAIGoogleCloudContactcenterinsightsV1alpha1FaqAnswerData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudContactcenterinsightsV1alpha1FaqAnswerData)

#endif // OAIGoogleCloudContactcenterinsightsV1alpha1FaqAnswerData_H
