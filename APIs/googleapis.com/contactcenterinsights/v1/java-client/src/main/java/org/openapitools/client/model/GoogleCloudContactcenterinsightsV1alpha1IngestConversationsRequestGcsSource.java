...
public class GoogleCloudContactcenterinsightsV1alpha1IngestConversationsRequestGcsSource {
  ...
  public GoogleCloudContactcenterinsightsV1alpha1IngestConversationsRequestGcsSource() {
  }

  public GoogleCloudContactcenterinsightsV1alpha1IngestConversationsRequestGcsSource bucketObjectType(BucketObjectTypeEnum bucketObjectType) {
  ...
  public GoogleCloudContactcenterinsightsV1alpha1IngestConversationsRequestGcsSource bucketUri(String bucketUri) {
  ...
  public GoogleCloudContactcenterinsightsV1alpha1IngestConversationsRequestGcsSource customMetadataKeys(List<String> customMetadataKeys) {
    this.customMetadataKeys = customMetadataKeys;
    return this;
  }

  public GoogleCloudContactcenterinsightsV1alpha1IngestConversationsRequestGcsSource addCustomMetadataKeysItem(String customMetadataKeysItem) {
  ...
  public GoogleCloudContactcenterinsightsV1alpha1IngestConversationsRequestGcsSource metadataBucketUri(String metadataBucketUri) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudContactcenterinsightsV1alpha1IngestConversationsRequestGcsSource googleCloudContactcenterinsightsV1alpha1IngestConversationsRequestGcsSource = (GoogleCloudContactcenterinsightsV1alpha1IngestConversationsRequestGcsSource) o;
    return Objects.equals(this.bucketObjectType, googleCloudContactcenterinsightsV1alpha1IngestConversationsRequestGcsSource.bucketObjectType) &&
        Objects.equals(this.bucketUri, googleCloudContactcenterinsightsV1alpha1IngestConversationsRequestGcsSource.bucketUri) &&
        Objects.equals(this.customMetadataKeys, googleCloudContactcenterinsightsV1alpha1IngestConversationsRequestGcsSource.customMetadataKeys) &&
        Objects.equals(this.metadataBucketUri, googleCloudContactcenterinsightsV1alpha1IngestConversationsRequestGcsSource.metadataBucketUri);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudContactcenterinsightsV1alpha1IngestConversationsRequestGcsSource {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudContactcenterinsightsV1alpha1IngestConversationsRequestGcsSource
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudContactcenterinsightsV1alpha1IngestConversationsRequestGcsSource.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudContactcenterinsightsV1alpha1IngestConversationsRequestGcsSource is not found in the empty JSON string", GoogleCloudContactcenterinsightsV1alpha1IngestConversationsRequestGcsSource.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudContactcenterinsightsV1alpha1IngestConversationsRequestGcsSource.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudContactcenterinsightsV1alpha1IngestConversationsRequestGcsSource` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudContactcenterinsightsV1alpha1IngestConversationsRequestGcsSource.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudContactcenterinsightsV1alpha1IngestConversationsRequestGcsSource' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudContactcenterinsightsV1alpha1IngestConversationsRequestGcsSource> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudContactcenterinsightsV1alpha1IngestConversationsRequestGcsSource.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudContactcenterinsightsV1alpha1IngestConversationsRequestGcsSource>() {
           @Override
           public void write(JsonWriter out, GoogleCloudContactcenterinsightsV1alpha1IngestConversationsRequestGcsSource value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudContactcenterinsightsV1alpha1IngestConversationsRequestGcsSource read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudContactcenterinsightsV1alpha1IngestConversationsRequestGcsSource given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudContactcenterinsightsV1alpha1IngestConversationsRequestGcsSource
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudContactcenterinsightsV1alpha1IngestConversationsRequestGcsSource
   */
  public static GoogleCloudContactcenterinsightsV1alpha1IngestConversationsRequestGcsSource fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudContactcenterinsightsV1alpha1IngestConversationsRequestGcsSource.class);
  }

  /**
   * Convert an instance of GoogleCloudContactcenterinsightsV1alpha1IngestConversationsRequestGcsSource to an JSON string
   *
   * @return JSON string
   */
