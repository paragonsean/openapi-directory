...
public class GoogleCloudContactcenterinsightsV1AnnotatorSelector {
  ...
  public GoogleCloudContactcenterinsightsV1AnnotatorSelector issueModels(List<String> issueModels) {
    this.issueModels = issueModels;
    return this;
  }

  public GoogleCloudContactcenterinsightsV1AnnotatorSelector addIssueModelsItem(String issueModelsItem) {
  ...
  public GoogleCloudContactcenterinsightsV1AnnotatorSelector phraseMatchers(List<String> phraseMatchers) {
    this.phraseMatchers = phraseMatchers;
    return this;
  }

  public GoogleCloudContactcenterinsightsV1AnnotatorSelector addPhraseMatchersItem(String phraseMatchersItem) {
  ...
  public GoogleCloudContactcenterinsightsV1AnnotatorSelector runEntityAnnotator(Boolean runEntityAnnotator) {
  ...
  public GoogleCloudContactcenterinsightsV1AnnotatorSelector runIntentAnnotator(Boolean runIntentAnnotator) {
  ...
  public GoogleCloudContactcenterinsightsV1AnnotatorSelector runInterruptionAnnotator(Boolean runInterruptionAnnotator) {
  ...
  public GoogleCloudContactcenterinsightsV1AnnotatorSelector runIssueModelAnnotator(Boolean runIssueModelAnnotator) {
  ...
  public GoogleCloudContactcenterinsightsV1AnnotatorSelector runPhraseMatcherAnnotator(Boolean runPhraseMatcherAnnotator) {
  ...
  public GoogleCloudContactcenterinsightsV1AnnotatorSelector runSentimentAnnotator(Boolean runSentimentAnnotator) {
  ...
  public GoogleCloudContactcenterinsightsV1AnnotatorSelector runSilenceAnnotator(Boolean runSilenceAnnotator) {
  ...
  public GoogleCloudContactcenterinsightsV1AnnotatorSelector runSummarizationAnnotator(Boolean runSummarizationAnnotator) {
  ...
  public GoogleCloudContactcenterinsightsV1AnnotatorSelector summarizationConfig(GoogleCloudContactcenterinsightsV1AnnotatorSelectorSummarizationConfig summarizationConfig) {
  ...
  public void setSummarizationConfig(GoogleCloudContactcenterinsightsV1AnnotatorSelectorSummarizationConfig summarizationConfig) {
    this.summarizationConfig = summarizationConfig;
  }
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudContactcenterinsightsV1AnnotatorSelector googleCloudContactcenterinsightsV1AnnotatorSelector = (GoogleCloudContactcenterinsightsV1AnnotatorSelector) o;
    return Objects.equals(this.issueModels, googleCloudContactcenterinsightsV1AnnotatorSelector.issueModels) &&
        Objects.equals(this.phraseMatchers, googleCloudContactcenterinsightsV1AnnotatorSelector.phraseMatchers) &&
        Objects.equals(this.runEntityAnnotator, googleCloudContactcenterinsightsV1AnnotatorSelector.runEntityAnnotator) &&
        Objects.equals(this.runIntentAnnotator, googleCloudContactcenterinsightsV1AnnotatorSelector.runIntentAnnotator) &&
        Objects.equals(this.runInterruptionAnnotator, googleCloudContactcenterinsightsV1AnnotatorSelector.runInterruptionAnnotator) &&
        Objects.equals(this.runIssueModelAnnotator, googleCloudContactcenterinsightsV1AnnotatorSelector.runIssueModelAnnotator) &&
        Objects.equals(this.runPhraseMatcherAnnotator, googleCloudContactcenterinsightsV1AnnotatorSelector.runPhraseMatcherAnnotator) &&
        Objects.equals(this.runSentimentAnnotator, googleCloudContactcenterinsightsV1AnnotatorSelector.runSentimentAnnotator) &&
        Objects.equals(this.runSilenceAnnotator, googleCloudContactcenterinsightsV1AnnotatorSelector.runSilenceAnnotator) &&
        Objects.equals(this.runSummarizationAnnotator, googleCloudContactcenterinsightsV1AnnotatorSelector.runSummarizationAnnotator) &&
        Objects.equals(this.summarizationConfig, googleCloudContactcenterinsightsV1AnnotatorSelector.summarizationConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudContactcenterinsightsV1AnnotatorSelector {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudContactcenterinsightsV1AnnotatorSelector
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudContactcenterinsightsV1AnnotatorSelector.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudContactcenterinsightsV1AnnotatorSelector is not found in the empty JSON string", GoogleCloudContactcenterinsightsV1AnnotatorSelector.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudContactcenterinsightsV1AnnotatorSelector.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudContactcenterinsightsV1AnnotatorSelector` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("summarizationConfig") != null && !jsonObj.get("summarizationConfig").isJsonNull()) {
        GoogleCloudContactcenterinsightsV1AnnotatorSelectorSummarizationConfig.validateJsonElement(jsonObj.get("summarizationConfig"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudContactcenterinsightsV1AnnotatorSelector.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudContactcenterinsightsV1AnnotatorSelector' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudContactcenterinsightsV1AnnotatorSelector> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudContactcenterinsightsV1AnnotatorSelector.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudContactcenterinsightsV1AnnotatorSelector>() {
           @Override
           public void write(JsonWriter out, GoogleCloudContactcenterinsightsV1AnnotatorSelector value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudContactcenterinsightsV1AnnotatorSelector read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudContactcenterinsightsV1AnnotatorSelector given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudContactcenterinsightsV1AnnotatorSelector
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudContactcenterinsightsV1AnnotatorSelector
   */
  public static GoogleCloudContactcenterinsightsV1AnnotatorSelector fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudContactcenterinsightsV1AnnotatorSelector.class);
  }

  /**
   * Convert an instance of GoogleCloudContactcenterinsightsV1AnnotatorSelector to an JSON string
   *
   * @return JSON string
   */
