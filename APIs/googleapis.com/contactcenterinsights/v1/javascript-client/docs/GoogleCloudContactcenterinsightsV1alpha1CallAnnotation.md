# ContactCenterAiInsightsApi.GoogleCloudContactcenterinsightsV1alpha1CallAnnotation
...
**channelTag** | **Number** | The channel of the audio where the annotation occurs. For single-channel audio, this field is not populated. | [optional] 
