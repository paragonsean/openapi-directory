# ContactCenterAiInsightsApi.GoogleCloudContactcenterinsightsV1FaqAnswerData
...
**confidenceScore** | **Number** | The system&#39;s confidence score that this answer is a good match for this conversation, ranging from 0.0 (completely uncertain) to 1.0 (completely certain). | [optional] 
**metadata** | **{String: String}** | Map that contains metadata about the FAQ answer and the document that it originates from. | [optional] 
