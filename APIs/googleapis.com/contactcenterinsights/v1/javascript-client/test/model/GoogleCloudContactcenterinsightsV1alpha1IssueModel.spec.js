...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContactCenterAiInsightsApi.GoogleCloudContactcenterinsightsV1alpha1IssueModel();
  });
  ...
  describe('GoogleCloudContactcenterinsightsV1alpha1IssueModel', function() {
    it('should create an instance of GoogleCloudContactcenterinsightsV1alpha1IssueModel', function() {
      // uncomment below and update the code to test GoogleCloudContactcenterinsightsV1alpha1IssueModel
      //var instance = new ContactCenterAiInsightsApi.GoogleCloudContactcenterinsightsV1alpha1IssueModel();
      //expect(instance).to.be.a(ContactCenterAiInsightsApi.GoogleCloudContactcenterinsightsV1alpha1IssueModel);
    });
