...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContactCenterAiInsightsApi.GoogleCloudContactcenterinsightsV1alpha1CallAnnotation();
  });
  ...
  describe('GoogleCloudContactcenterinsightsV1alpha1CallAnnotation', function() {
    it('should create an instance of GoogleCloudContactcenterinsightsV1alpha1CallAnnotation', function() {
      // uncomment below and update the code to test GoogleCloudContactcenterinsightsV1alpha1CallAnnotation
      //var instance = new ContactCenterAiInsightsApi.GoogleCloudContactcenterinsightsV1alpha1CallAnnotation();
      //expect(instance).to.be.a(ContactCenterAiInsightsApi.GoogleCloudContactcenterinsightsV1alpha1CallAnnotation);
    });
