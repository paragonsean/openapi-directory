...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ContactCenterAiInsightsApi.GoogleCloudContactcenterinsightsV1AnnotatorSelector();
  });
  ...
  describe('GoogleCloudContactcenterinsightsV1AnnotatorSelector', function() {
    it('should create an instance of GoogleCloudContactcenterinsightsV1AnnotatorSelector', function() {
      // uncomment below and update the code to test GoogleCloudContactcenterinsightsV1AnnotatorSelector
      //var instance = new ContactCenterAiInsightsApi.GoogleCloudContactcenterinsightsV1AnnotatorSelector();
      //expect(instance).to.be.a(ContactCenterAiInsightsApi.GoogleCloudContactcenterinsightsV1AnnotatorSelector);
    });
