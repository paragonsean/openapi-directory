...
|**infrastructure** | [**InfrastructureEnum**](#InfrastructureEnum) | Output only. The type of underlying resources used to create the connection. |  [optional] [readonly] |
...
|**pscConnections** | [**List&lt;PscConnection&gt;**](PscConnection.md) | Output only. [Output only] Information about each Private Service Connect connection. |  [optional] [readonly] |
