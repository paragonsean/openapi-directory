# NetworkConnectivityApi.PolicyBasedRoute
...
**nextHopOtherRoutes** | **String** | Optional. Other routes that will be referenced to determine the next hop of the packet. | [optional] 
...
**warnings** | [**[Warnings]**](Warnings.md) | Output only. If potential misconfigurations are detected for this route, this field will be populated with warning messages. | [optional] [readonly] 
...
* `OTHER_ROUTES_UNSPECIFIED` (value: `"OTHER_ROUTES_UNSPECIFIED"`)

* `DEFAULT_ROUTING` (value: `"DEFAULT_ROUTING"`)
