...
/**
 * The ListSpokesResponse model module.
 * @module model/ListSpokesResponse
 * @version v1
 */
class ListSpokesResponse {
    /**
     * Constructs a new <code>ListSpokesResponse</code>.
     * The response for HubService.ListSpokes.
     * @alias module:model/ListSpokesResponse
     */
    constructor() { 
        
        ListSpokesResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListSpokesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListSpokesResponse} obj Optional instance to populate.
     * @return {module:model/ListSpokesResponse} The populated <code>ListSpokesResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListSpokesResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>ListSpokesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListSpokesResponse</code>.
     */
 ...
 */
ListSpokesResponse.prototype['nextPageToken'] = undefined;

/**
 * The requested spokes.
 * @member {Array.<module:model/Spoke>} spokes
 */
ListSpokesResponse.prototype['spokes'] = undefined;

/**
 * Locations that could not be reached.
 * @member {Array.<String>} unreachable
 */
ListSpokesResponse.prototype['unreachable'] = undefined;
...
export default ListSpokesResponse;
