...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkConnectivityApi.ListServiceClassesResponse();
  });
  ...
  describe('ListServiceClassesResponse', function() {
    it('should create an instance of ListServiceClassesResponse', function() {
      // uncomment below and update the code to test ListServiceClassesResponse
      //var instance = new NetworkConnectivityApi.ListServiceClassesResponse();
      //expect(instance).to.be.a(NetworkConnectivityApi.ListServiceClassesResponse);
    });
