...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkConnectivityApi.VirtualMachine();
  });
  ...
  describe('VirtualMachine', function() {
    it('should create an instance of VirtualMachine', function() {
      ...
      //var instance = new NetworkConnectivityApi.VirtualMachine();
      //expect(instance).to.be.a(NetworkConnectivityApi.VirtualMachine);
    });
