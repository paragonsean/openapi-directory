...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkConnectivityApi.ServiceClass();
  });
  ...
  describe('ServiceClass', function() {
    it('should create an instance of ServiceClass', function() {
      // uncomment below and update the code to test ServiceClass
      //var instance = new NetworkConnectivityApi.ServiceClass();
      //expect(instance).to.be.a(NetworkConnectivityApi.ServiceClass);
    });
