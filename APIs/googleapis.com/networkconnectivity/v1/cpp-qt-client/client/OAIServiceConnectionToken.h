...
/*
 * OAIServiceConnectionToken.h
 *
 * The ServiceConnectionToken resource. Next id: 10
 */

#ifndef OAIServiceConnectionToken_H
#define OAIServiceConnectionToken_H
...
class OAIServiceConnectionToken : public OAIObject {
public:
    OAIServiceConnectionToken();
    OAIServiceConnectionToken(QString json);
    ~OAIServiceConnectionToken() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIServiceConnectionToken)

#endif // OAIServiceConnectionToken_H
