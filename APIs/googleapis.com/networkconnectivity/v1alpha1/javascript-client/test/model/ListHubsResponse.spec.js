...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkConnectivityApi.ListHubsResponse();
  });
  ...
  describe('ListHubsResponse', function() {
    it('should create an instance of ListHubsResponse', function() {
      // uncomment below and update the code to test ListHubsResponse
      //var instance = new NetworkConnectivityApi.ListHubsResponse();
      //expect(instance).to.be.a(NetworkConnectivityApi.ListHubsResponse);
    });
