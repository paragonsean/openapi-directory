...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkConnectivityApi.ListLocationsResponse();
  });
  ...
  describe('ListLocationsResponse', function() {
    it('should create an instance of ListLocationsResponse', function() {
      ...
      //var instance = new NetworkConnectivityApi.ListLocationsResponse();
      //expect(instance).to.be.a(NetworkConnectivityApi.ListLocationsResponse);
    });
