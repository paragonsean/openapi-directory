...
public:
    ...
    Q_DECL_DEPRECATED QList<QString> getSpokes() const;
    Q_DECL_DEPRECATED void setSpokes(const QList<QString> &spokes);
    Q_DECL_DEPRECATED bool is_spokes_Set() const;
    Q_DECL_DEPRECATED bool is_spokes_Valid() const;
