...
public class Hub {
  ...
  private List<String> spokes = new ArrayList<>();
  ...
  public Hub createTime(String createTime) {
  ...
  public Hub updateTime(String updateTime) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.createTime, hub.createTime) &&
        ...
        Objects.equals(this.spokes, hub.spokes) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(createTime, description, labels, name, spokes, state, uniqueId, updateTime);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("spokes") != null && !jsonObj.get("spokes").isJsonNull() && !jsonObj.get("spokes").isJsonArray()) {
