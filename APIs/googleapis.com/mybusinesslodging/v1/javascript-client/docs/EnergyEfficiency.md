# MyBusinessLodgingApi.EnergyEfficiency
...
**carbonFreeEnergySourcesException** | **String** | Carbon free energy sources exception. | [optional] 
...
**energyConservationProgramException** | **String** | Energy conservation program exception. | [optional] 
...
**energyEfficientHeatingAndCoolingSystemsException** | **String** | Energy efficient heating and cooling systems exception. | [optional] 
...
**energyEfficientLightingException** | **String** | Energy efficient lighting exception. | [optional] 
...
**energySavingThermostatsException** | **String** | Energy saving thermostats exception. | [optional] 
...
**greenBuildingDesignException** | **String** | Output only. Green building design exception. | [optional] [readonly] 
...
**independentOrganizationAuditsEnergyUseException** | **String** | Independent organization audits energy use exception. | [optional] 
