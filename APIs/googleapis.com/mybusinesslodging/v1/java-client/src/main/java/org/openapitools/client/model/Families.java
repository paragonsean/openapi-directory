...
public class Families {
  ...
  public static final String SERIALIZED_NAME_KIDS_FRIENDLY = "kidsFriendly";
  @SerializedName(SERIALIZED_NAME_KIDS_FRIENDLY)
  private Boolean kidsFriendly;

  /**
   * Kids friendly exception.
   */
  @JsonAdapter(KidsFriendlyExceptionEnum.Adapter.class)
  public enum KidsFriendlyExceptionEnum {
    EXCEPTION_UNSPECIFIED("EXCEPTION_UNSPECIFIED"),
    ...
    KidsFriendlyExceptionEnum(String value) {
      this.value = value;
    }
    ...
    public static KidsFriendlyExceptionEnum fromValue(String value) {
      for (KidsFriendlyExceptionEnum b : KidsFriendlyExceptionEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
    ...
    public static class Adapter extends TypeAdapter<KidsFriendlyExceptionEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final KidsFriendlyExceptionEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public KidsFriendlyExceptionEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return KidsFriendlyExceptionEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      KidsFriendlyExceptionEnum.fromValue(value);
    }
  }

  public static final String SERIALIZED_NAME_KIDS_FRIENDLY_EXCEPTION = "kidsFriendlyException";
  @SerializedName(SERIALIZED_NAME_KIDS_FRIENDLY_EXCEPTION)
  private KidsFriendlyExceptionEnum kidsFriendlyException;
  ...
  public Families kidsFriendly(Boolean kidsFriendly) {
  ...
  public Families kidsFriendlyException(KidsFriendlyExceptionEnum kidsFriendlyException) {
   ...
   */
  @javax.annotation.Nullable
  public KidsFriendlyExceptionEnum getKidsFriendlyException() {
    return kidsFriendlyException;
  }

  public void setKidsFriendlyException(KidsFriendlyExceptionEnum kidsFriendlyException) {
    this.kidsFriendlyException = kidsFriendlyException;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.babysitting, families.babysitting) &&
        ...
        Objects.equals(this.kidsFriendly, families.kidsFriendly) &&
        Objects.equals(this.kidsFriendlyException, families.kidsFriendlyException);
  }

  @Override
  public int hashCode() {
    return Objects.hash(babysitting, babysittingException, kidsActivities, kidsActivitiesException, kidsClub, kidsClubException, kidsFriendly, kidsFriendlyException);
  }
  ...
  public String toString() {
    ...
    sb.append("    kidsFriendly: ").append(toIndentedString(kidsFriendly)).append("\n");
    sb.append("    kidsFriendlyException: ").append(toIndentedString(kidsFriendlyException)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("kidsFriendly");
    openapiFields.add("kidsFriendlyException");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("kidsFriendlyException") != null && !jsonObj.get("kidsFriendlyException").isJsonNull()) && !jsonObj.get("kidsFriendlyException").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `kidsFriendlyException` to be a primitive type in the JSON string but got `%s`", jsonObj.get("kidsFriendlyException").toString()));
      }
      // validate the optional field `kidsFriendlyException`
      if (jsonObj.get("kidsFriendlyException") != null && !jsonObj.get("kidsFriendlyException").isJsonNull()) {
        KidsFriendlyExceptionEnum.validateJsonElement(jsonObj.get("kidsFriendlyException"));
      }
  }
