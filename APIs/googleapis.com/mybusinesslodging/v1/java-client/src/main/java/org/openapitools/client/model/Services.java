...
public class Services {
  ...
  private List<LanguageSpoken> languagesSpoken = new ArrayList<>();
  ...
  public Services languagesSpoken(List<LanguageSpoken> languagesSpoken) {
    this.languagesSpoken = languagesSpoken;
    return this;
  }

  public Services addLanguagesSpokenItem(LanguageSpoken languagesSpokenItem) {
    if (this.languagesSpoken == null) {
      this.languagesSpoken = new ArrayList<>();
    }
    this.languagesSpoken.add(languagesSpokenItem);
    return this;
  }
  ...
  public void setLanguagesSpoken(List<LanguageSpoken> languagesSpoken) {
    this.languagesSpoken = languagesSpoken;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("languagesSpoken") != null && !jsonObj.get("languagesSpoken").isJsonNull()) {
        JsonArray jsonArraylanguagesSpoken = jsonObj.getAsJsonArray("languagesSpoken");
        if (jsonArraylanguagesSpoken != null) {
          // ensure the json data is an array
          if (!jsonObj.get("languagesSpoken").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `languagesSpoken` to be an array in the JSON string but got `%s`", jsonObj.get("languagesSpoken").toString()));
          }

          // validate the optional field `languagesSpoken` (array)
          for (int i = 0; i < jsonArraylanguagesSpoken.size(); i++) {
            LanguageSpoken.validateJsonElement(jsonArraylanguagesSpoken.get(i));
          };
        }
      }
