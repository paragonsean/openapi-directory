...
void OAIFamilies::initializeModel() {
    ...
    m_kids_friendly_isSet = false;
    m_kids_friendly_isValid = false;

    m_kids_friendly_exception_isSet = false;
    m_kids_friendly_exception_isValid = false;
}
...
void OAIFamilies::fromJsonObject(QJsonObject json) {
    ...
    m_kids_friendly_isValid = ::OpenAPI::fromJsonValue(m_kids_friendly, json[QString("kidsFriendly")]);
    m_kids_friendly_isSet = !json[QString("kidsFriendly")].isNull() && m_kids_friendly_isValid;

    m_kids_friendly_exception_isValid = ::OpenAPI::fromJsonValue(m_kids_friendly_exception, json[QString("kidsFriendlyException")]);
    m_kids_friendly_exception_isSet = !json[QString("kidsFriendlyException")].isNull() && m_kids_friendly_exception_isValid;
}
...
QJsonObject OAIFamilies::asJsonObject() const {
    ...
    if (m_kids_friendly_isSet) {
        obj.insert(QString("kidsFriendly"), ::OpenAPI::toJsonValue(m_kids_friendly));
    }
    if (m_kids_friendly_exception_isSet) {
        obj.insert(QString("kidsFriendlyException"), ::OpenAPI::toJsonValue(m_kids_friendly_exception));
    }
    return obj;
}
...
bool OAIFamilies::isKidsFriendly() const {
    return m_kids_friendly;
}
void OAIFamilies::setKidsFriendly(const bool &kids_friendly) {
    m_kids_friendly = kids_friendly;
    m_kids_friendly_isSet = true;
}

bool OAIFamilies::is_kids_friendly_Set() const{
    return m_kids_friendly_isSet;
}

bool OAIFamilies::is_kids_friendly_Valid() const{
    return m_kids_friendly_isValid;
}

QString OAIFamilies::getKidsFriendlyException() const {
    return m_kids_friendly_exception;
}
void OAIFamilies::setKidsFriendlyException(const QString &kids_friendly_exception) {
    m_kids_friendly_exception = kids_friendly_exception;
    m_kids_friendly_exception_isSet = true;
}

bool OAIFamilies::is_kids_friendly_exception_Set() const{
    return m_kids_friendly_exception_isSet;
}

bool OAIFamilies::is_kids_friendly_exception_Valid() const{
    return m_kids_friendly_exception_isValid;
}
