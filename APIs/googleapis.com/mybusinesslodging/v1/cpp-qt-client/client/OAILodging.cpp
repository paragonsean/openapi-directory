...
void OAILodging::initializeModel() {
    ...
    m_sustainability_isSet = false;
    m_sustainability_isValid = false;
...
void OAILodging::fromJsonObject(QJsonObject json) {
    ...
    m_sustainability_isValid = ::OpenAPI::fromJsonValue(m_sustainability, json[QString("sustainability")]);
    m_sustainability_isSet = !json[QString("sustainability")].isNull() && m_sustainability_isValid;
...
QJsonObject OAILodging::asJsonObject() const {
    ...
    if (m_sustainability.isSet()) {
        obj.insert(QString("sustainability"), ::OpenAPI::toJsonValue(m_sustainability));
    }
...
OAISustainability OAILodging::getSustainability() const {
    return m_sustainability;
}
void OAILodging::setSustainability(const OAISustainability &sustainability) {
    m_sustainability = sustainability;
    m_sustainability_isSet = true;
}

bool OAILodging::is_sustainability_Set() const{
    return m_sustainability_isSet;
}

bool OAILodging::is_sustainability_Valid() const{
    return m_sustainability_isValid;
}
