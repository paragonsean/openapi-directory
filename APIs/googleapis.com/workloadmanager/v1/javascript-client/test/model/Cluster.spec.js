...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WorkloadManagerApi.Cluster();
  });
  ...
  describe('Cluster', function() {
    it('should create an instance of Cluster', function() {
      ...
      //var instance = new WorkloadManagerApi.Cluster();
      //expect(instance).to.be.a(WorkloadManagerApi.Cluster);
    });
    ...
    it('should have the property witnessServer (base name: "witnessServer")', function() {
      // uncomment below and update the code to test the property witnessServer
      //var instance = new WorkloadManagerApi.Cluster();
      //expect(instance).to.be();
    });
