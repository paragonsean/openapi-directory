...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WorkloadManagerApi.BackendServer();
  });
  ...
  describe('BackendServer', function() {
    it('should create an instance of BackendServer', function() {
      // uncomment below and update the code to test BackendServer
      //var instance = new WorkloadManagerApi.BackendServer();
      //expect(instance).to.be.a(WorkloadManagerApi.BackendServer);
    });
