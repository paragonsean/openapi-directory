...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WorkloadManagerApi.ListLocationsResponse();
  });
  ...
  describe('ListLocationsResponse', function() {
    it('should create an instance of ListLocationsResponse', function() {
      ...
      //var instance = new WorkloadManagerApi.ListLocationsResponse();
      //expect(instance).to.be.a(WorkloadManagerApi.ListLocationsResponse);
    });
