...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WorkloadManagerApi.RunEvaluationRequest();
  });
  ...
  describe('RunEvaluationRequest', function() {
    it('should create an instance of RunEvaluationRequest', function() {
      // uncomment below and update the code to test RunEvaluationRequest
      //var instance = new WorkloadManagerApi.RunEvaluationRequest();
      //expect(instance).to.be.a(WorkloadManagerApi.RunEvaluationRequest);
    });
