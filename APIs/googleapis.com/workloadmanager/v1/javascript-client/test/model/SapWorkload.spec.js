...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WorkloadManagerApi.SapWorkload();
  });
  ...
  describe('SapWorkload', function() {
    it('should create an instance of SapWorkload', function() {
      // uncomment below and update the code to test SapWorkload
      //var instance = new WorkloadManagerApi.SapWorkload();
      //expect(instance).to.be.a(WorkloadManagerApi.SapWorkload);
    });
