...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WorkloadManagerApi.ListRulesResponse();
  });
  ...
  describe('ListRulesResponse', function() {
    it('should create an instance of ListRulesResponse', function() {
      ...
      //var instance = new WorkloadManagerApi.ListRulesResponse();
      //expect(instance).to.be.a(WorkloadManagerApi.ListRulesResponse);
    });
