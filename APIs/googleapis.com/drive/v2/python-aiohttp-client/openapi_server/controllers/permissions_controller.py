...
async def drive_permissions_delete(request: web.Request, file_id, permission_id, xgafv=None, access_token=None, alt=None, param_callback=None, fields=None, key=None, oauth_token=None, pretty_print=None, quota_user=None, upload_protocol=None, upload_type=None, supports_all_drives=None, supports_team_drives=None, use_domain_admin_access=None) -> web.Response:
    ...
    :param file_id: The ID for the file or shared drive.
    :type file_id: str
    :param permission_id: The ID for the permission.
...
async def drive_permissions_get_id_for_email(request: web.Request, email, xgafv=None, access_token=None, alt=None, param_callback=None, fields=None, key=None, oauth_token=None, pretty_print=None, quota_user=None, upload_protocol=None, upload_type=None) -> web.Response:
...
async def drive_permissions_insert(request: web.Request, file_id, xgafv=None, access_token=None, alt=None, param_callback=None, fields=None, key=None, oauth_token=None, pretty_print=None, quota_user=None, upload_protocol=None, upload_type=None, email_message=None, enforce_single_parent=None, move_to_new_owners_root=None, send_notification_emails=None, supports_all_drives=None, supports_team_drives=None, use_domain_admin_access=None, body=None) -> web.Response:
    ...
    :param upload_type: Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;).
    :type upload_type: str
    :param email_message: A plain text custom message to include in notification emails.
    ...
    :param send_notification_emails: Whether to send notification emails when sharing to users or groups. This parameter is ignored and an email is sent if the &#x60;role&#x60; is &#x60;owner&#x60;.
    :type send_notification_emails: bool
    :param supports_all_drives: Whether the requesting application supports both My Drives and shared drives.
    :type supports_all_drives: bool
    :param supports_team_drives: Deprecated: Use &#x60;supportsAllDrives&#x60; instead.
    :type supports_team_drives: bool
...
async def drive_permissions_list(request: web.Request, file_id, xgafv=None, access_token=None, alt=None, param_callback=None, fields=None, key=None, oauth_token=None, pretty_print=None, quota_user=None, upload_protocol=None, upload_type=None, include_permissions_for_view=None, max_results=None, page_token=None, supports_all_drives=None, supports_team_drives=None, use_domain_admin_access=None) -> web.Response:
    ...
    :param max_results: The maximum number of permissions to return per page. When not set for files in a shared drive, at most 100 results will be returned. When not set for files that are not in a shared drive, the entire list will be returned.
...
async def drive_permissions_patch(request: web.Request, file_id, permission_id, xgafv=None, access_token=None, alt=None, param_callback=None, fields=None, key=None, oauth_token=None, pretty_print=None, quota_user=None, upload_protocol=None, upload_type=None, remove_expiration=None, supports_all_drives=None, supports_team_drives=None, transfer_ownership=None, use_domain_admin_access=None, body=None) -> web.Response:
    ...
    :param supports_team_drives: Deprecated: Use &#x60;supportsAllDrives&#x60; instead.
    :type supports_team_drives: bool
    :param transfer_ownership: Whether changing a role to &#x60;owner&#x60; downgrades the current owners to writers. Does nothing if the specified role is not &#x60;owner&#x60;.
