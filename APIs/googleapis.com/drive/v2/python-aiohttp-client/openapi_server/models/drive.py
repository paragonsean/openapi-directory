...
class Drive(Model):
    ...
    def __init__(self, background_image_file: DriveBackgroundImageFile=None, background_image_link: str=None, capabilities: DriveCapabilities=None, color_rgb: str=None, created_date: datetime=None, hidden: bool=None, id: str=None, kind: str='drive#drive', name: str=None, org_unit_id: str=None, restrictions: DriveRestrictions=None, theme_id: str=None):
        ...
        :param created_date: The created_date of this Drive.
    ...
    def created_date(self):
        """Gets the created_date of this Drive.

        The time at which the shared drive was created (RFC 3339 date-time).

        :return: The created_date of this Drive.
        :rtype: datetime
        """
    ...
    def created_date(self, created_date):
        """Sets the created_date of this Drive.
