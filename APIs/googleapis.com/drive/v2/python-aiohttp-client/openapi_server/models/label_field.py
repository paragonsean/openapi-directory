...
class LabelField(Model):
    ...
    def __init__(self, date_string: List[date]=None, id: str=None, integer: List[str]=None, kind: str='drive#labelField', selection: List[str]=None, text: List[str]=None, user: List[User]=None, value_type: str=None):
