...
bool OAIChange::isDeleted() const {
    return m_deleted;
}
void OAIChange::setDeleted(const bool &deleted) {
    m_deleted = deleted;
    m_deleted_isSet = true;
}

bool OAIChange::is_deleted_Set() const{
    return m_deleted_isSet;
}

bool OAIChange::is_deleted_Valid() const{
...
QDateTime OAIChange::getModificationDate() const {
    return m_modification_date;
}
void OAIChange::setModificationDate(const QDateTime &modification_date) {
    m_modification_date = modification_date;
    m_modification_date_isSet = true;
}

bool OAIChange::is_modification_date_Set() const{
    return m_modification_date_isSet;
}

bool OAIChange::is_modification_date_Valid() const{
    return m_modification_date_isValid;
}

QString OAIChange::getSelfLink() const {
    return m_self_link;
}
void OAIChange::setSelfLink(const QString &self_link) {
    m_self_link = self_link;
    m_self_link_isSet = true;
}

bool OAIChange::is_self_link_Set() const{
    return m_self_link_isSet;
}

bool OAIChange::is_self_link_Valid() const{
