...
QDateTime OAITeamDrive::getCreatedDate() const {
    return m_created_date;
}
void OAITeamDrive::setCreatedDate(const QDateTime &created_date) {
    m_created_date = created_date;
    m_created_date_isSet = true;
}

bool OAITeamDrive::is_created_date_Set() const{
    return m_created_date_isSet;
}

bool OAITeamDrive::is_created_date_Valid() const{
