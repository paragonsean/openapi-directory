...
void OAIFile_capabilities::initializeModel() {
    ...
    m_can_change_restricted_download_isSet = false;
    m_can_change_restricted_download_isValid = false;
...
void OAIFile_capabilities::fromJsonObject(QJsonObject json) {
    ...
    m_can_change_restricted_download_isValid = ::OpenAPI::fromJsonValue(m_can_change_restricted_download, json[QString("canChangeRestrictedDownload")]);
    m_can_change_restricted_download_isSet = !json[QString("canChangeRestrictedDownload")].isNull() && m_can_change_restricted_download_isValid;
...
QJsonObject OAIFile_capabilities::asJsonObject() const {
    ...
    if (m_can_change_restricted_download_isSet) {
        obj.insert(QString("canChangeRestrictedDownload"), ::OpenAPI::toJsonValue(m_can_change_restricted_download));
    }
...
bool OAIFile_capabilities::isCanChangeRestrictedDownload() const {
    return m_can_change_restricted_download;
}
void OAIFile_capabilities::setCanChangeRestrictedDownload(const bool &can_change_restricted_download) {
    m_can_change_restricted_download = can_change_restricted_download;
    m_can_change_restricted_download_isSet = true;
}

bool OAIFile_capabilities::is_can_change_restricted_download_Set() const{
    return m_can_change_restricted_download_isSet;
}

bool OAIFile_capabilities::is_can_change_restricted_download_Valid() const{
    return m_can_change_restricted_download_isValid;
}
