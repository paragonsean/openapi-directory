...
/*
 * OAICommentReplyList.h
 *
 * A list of replies to a comment on a file in Google Drive.
 */

#ifndef OAICommentReplyList_H
#define OAICommentReplyList_H
...
class OAICommentReplyList : public OAIObject {
public:
    OAICommentReplyList();
    OAICommentReplyList(QString json);
    ~OAICommentReplyList() override;
    ...
    QList<OAICommentReply> getItems() const;
    void setItems(const QList<OAICommentReply> &items);
...
Q_DECLARE_METATYPE(OpenAPI::OAICommentReplyList)

#endif // OAICommentReplyList_H
