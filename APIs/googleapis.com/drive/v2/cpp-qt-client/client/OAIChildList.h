...
#ifndef OAIChildList_H
#define OAIChildList_H
...
namespace OpenAPI {
class OAIChildReference;

class OAIChildList : public OAIObject {
public:
    OAIChildList();
    OAIChildList(QString json);
    ~OAIChildList() override;
    ...
    QList<OAIChildReference> getItems() const;
    void setItems(const QList<OAIChildReference> &items);
...
private:
    ...
    QList<OAIChildReference> m_items;
    bool m_items_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChildList)

#endif // OAIChildList_H
