...
void OAIContentRestriction::initializeModel() {
    ...
    m_restriction_date_isSet = false;
    m_restriction_date_isValid = false;
...
void OAIContentRestriction::fromJsonObject(QJsonObject json) {
    ...
    m_restriction_date_isValid = ::OpenAPI::fromJsonValue(m_restriction_date, json[QString("restrictionDate")]);
    m_restriction_date_isSet = !json[QString("restrictionDate")].isNull() && m_restriction_date_isValid;
...
QJsonObject OAIContentRestriction::asJsonObject() const {
    ...
    if (m_restriction_date_isSet) {
        obj.insert(QString("restrictionDate"), ::OpenAPI::toJsonValue(m_restriction_date));
    }
...
QDateTime OAIContentRestriction::getRestrictionDate() const {
    return m_restriction_date;
}
void OAIContentRestriction::setRestrictionDate(const QDateTime &restriction_date) {
    m_restriction_date = restriction_date;
    m_restriction_date_isSet = true;
}

bool OAIContentRestriction::is_restriction_date_Set() const{
    return m_restriction_date_isSet;
}

bool OAIContentRestriction::is_restriction_date_Valid() const{
    return m_restriction_date_isValid;
}
