...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleDriveApi.ChildList();
  });
  ...
  describe('ChildList', function() {
    it('should create an instance of ChildList', function() {
      // uncomment below and update the code to test ChildList
      //var instance = new GoogleDriveApi.ChildList();
      //expect(instance).to.be.a(GoogleDriveApi.ChildList);
    });
