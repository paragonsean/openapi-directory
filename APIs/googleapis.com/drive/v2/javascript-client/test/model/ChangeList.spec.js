...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleDriveApi.ChangeList();
  });
  ...
  describe('ChangeList', function() {
    it('should create an instance of ChangeList', function() {
      // uncomment below and update the code to test ChangeList
      //var instance = new GoogleDriveApi.ChangeList();
      //expect(instance).to.be.a(GoogleDriveApi.ChangeList);
    });
    ...
    it('should have the property newStartPageToken (base name: "newStartPageToken")', function() {
      // uncomment below and update the code to test the property newStartPageToken
      //var instance = new GoogleDriveApi.ChangeList();
      //expect(instance).to.be();
    });
