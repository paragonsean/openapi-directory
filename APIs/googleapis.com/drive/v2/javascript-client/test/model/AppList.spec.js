...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleDriveApi.AppList();
  });
  ...
  describe('AppList', function() {
    it('should create an instance of AppList', function() {
      ...
      //var instance = new GoogleDriveApi.AppList();
      //expect(instance).to.be.a(GoogleDriveApi.AppList);
    });

    it('should have the property defaultAppIds (base name: "defaultAppIds")', function() {
      // uncomment below and update the code to test the property defaultAppIds
      //var instance = new GoogleDriveApi.AppList();
