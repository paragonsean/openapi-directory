...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleDriveApi.CommentReplyList();
  });
  ...
  describe('CommentReplyList', function() {
    it('should create an instance of CommentReplyList', function() {
      // uncomment below and update the code to test CommentReplyList
      //var instance = new GoogleDriveApi.CommentReplyList();
      //expect(instance).to.be.a(GoogleDriveApi.CommentReplyList);
    });
