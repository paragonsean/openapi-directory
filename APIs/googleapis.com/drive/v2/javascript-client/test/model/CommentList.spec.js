...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleDriveApi.CommentList();
  });
  ...
  describe('CommentList', function() {
    it('should create an instance of CommentList', function() {
      // uncomment below and update the code to test CommentList
      //var instance = new GoogleDriveApi.CommentList();
      //expect(instance).to.be.a(GoogleDriveApi.CommentList);
    });
