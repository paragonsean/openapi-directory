...
**items** | [**[Change]**](Change.md) | The list of changes. If nextPageToken is populated, then this list may be incomplete and an additional page of results should be fetched. | [optional] 
**kind** | **String** | This is always &#x60;drive#changeList&#x60;. | [optional] [default to &#39;drive#changeList&#39;]
