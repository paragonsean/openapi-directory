...
------------ | ------------- | ------------- | -------------
**items** | [**[Comment]**](Comment.md) | The list of comments. If nextPageToken is populated, then this list may be incomplete and an additional page of results should be fetched. | [optional] 
**kind** | **String** | This is always &#x60;drive#commentList&#x60;. | [optional] [default to &#39;drive#commentList&#39;]
