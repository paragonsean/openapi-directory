...
export default class PermissionsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the drivePermissionsGetIdForEmail operation.
     * @callback module:api/PermissionsApi~drivePermissionsGetIdForEmailCallback
     * @param {String} error Error message, if any.
     * @param {module:model/PermissionId} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} [uploadProtocol] Upload protocol for media (e.g. \"raw\", \"multipart\").
     * @param {String} [uploadType] Legacy upload protocol for media (e.g. \"media\", \"multipart\").
     * @param {module:api/PermissionsApi~drivePermissionsGetIdForEmailCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/PermissionId}
     */
    drivePermissionsGetIdForEmail(email, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'email' is set
      if (email === undefined || email === null) {
        throw new Error("Missing the required parameter 'email' when calling drivePermissionsGetIdForEmail");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = PermissionId;
      return this.apiClient.callApi(
        '/permissionIds/{email}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the drivePermissionsInsert operation.
     * @callback module:api/PermissionsApi~drivePermissionsInsertCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Permission} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/PermissionsApi~drivePermissionsInsertCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Permission}
     */
    drivePermissionsInsert(fileId, opts, callback) {
      opts = opts || {};
      let postBody = opts['permission'];
      // verify the required parameter 'fileId' is set
      if (fileId === undefined || fileId === null) {
        throw new Error("Missing the required parameter 'fileId' when calling drivePermissionsInsert");
      }
      ...
      let queryParams = {
        ...
        'sendNotificationEmails': opts['sendNotificationEmails'],
        'supportsAllDrives': opts['supportsAllDrives'],
        'supportsTeamDrives': opts['supportsTeamDrives'],
        'useDomainAdminAccess': opts['useDomainAdminAccess']
      };
    ...
    /**
     * Callback function to receive the result of the drivePermissionsPatch operation.
     * @callback module:api/PermissionsApi~drivePermissionsPatchCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Permission} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Boolean} [useDomainAdminAccess] Issue the request as a domain administrator; if set to true, then the requester will be granted access if the file ID parameter refers to a shared drive and the requester is an administrator of the domain to which the shared drive belongs.
     * @param {module:model/Permission} [permission] 
     * @param {module:api/PermissionsApi~drivePermissionsPatchCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Permission}
     */
    drivePermissionsPatch(fileId, permissionId, opts, callback) {
      opts = opts || {};
      let postBody = opts['permission'];
      // verify the required parameter 'fileId' is set
      if (fileId === undefined || fileId === null) {
        throw new Error("Missing the required parameter 'fileId' when calling drivePermissionsPatch");
      }
      // verify the required parameter 'permissionId' is set
      if (permissionId === undefined || permissionId === null) {
        throw new Error("Missing the required parameter 'permissionId' when calling drivePermissionsPatch");
      }
    ...
    drivePermissionsUpdate(fileId, permissionId, opts, callback) {
      ...
      let returnType = Permission;
      return this.apiClient.callApi(
        '/files/{fileId}/permissions/{permissionId}', 'PUT',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
