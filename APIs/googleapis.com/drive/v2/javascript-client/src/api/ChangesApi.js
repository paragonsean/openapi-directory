...
export default class ChangesApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the driveChangesGet operation.
     * @callback module:api/ChangesApi~driveChangesGetCallback
     ...
     * @param {module:api/ChangesApi~driveChangesGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Change}
     */
    driveChangesGet(changeId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'changeId' is set
      if (changeId === undefined || changeId === null) {
        throw new Error("Missing the required parameter 'changeId' when calling driveChangesGet");
      }
     ...
     */
    driveChangesList(opts, callback) {
      opts = opts || {};
      let postBody = null;
     ...
     */
    driveChangesWatch(opts, callback) {
      opts = opts || {};
