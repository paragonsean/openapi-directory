...
class ContentRestriction {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('restrictionDate')) {
                obj['restrictionDate'] = ApiClient.convertToType(data['restrictionDate'], 'Date');
            }
 ...
 * @member {Date} restrictionDate
 */
ContentRestriction.prototype['restrictionDate'] = undefined;
