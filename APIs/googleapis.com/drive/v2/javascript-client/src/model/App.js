...
import AppIconsInner from './AppIconsInner';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('icons')) {
                obj['icons'] = ApiClient.convertToType(data['icons'], [AppIconsInner]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['icons']) { // data not null
            ...
            for (const item of data['icons']) {
                AppIconsInner.validateJSON(item);
            };
        }
        // ensure the json data is a string
 ...
 * @member {Array.<module:model/AppIconsInner>} icons
 */
