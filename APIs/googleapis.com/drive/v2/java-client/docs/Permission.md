...
|------------ | ------------- | ------------- | -------------|
|**additionalRoles** | **List&lt;String&gt;** | Additional roles for this user. Only &#x60;commenter&#x60; is currently allowed, though more may be supported in the future. |  [optional] |
...
|**kind** | **String** | Output only. This is always &#x60;drive#permission&#x60;. |  [optional] |
...
|**permissionDetails** | [**List&lt;PermissionPermissionDetailsInner&gt;**](PermissionPermissionDetailsInner.md) | Output only. Details of whether the permissions on this shared drive item are inherited or directly on this item. This is an output-only field which is present only for shared drive items. |  [optional] [readonly] |
...
|**teamDrivePermissionDetails** | [**List&lt;PermissionTeamDrivePermissionDetailsInner&gt;**](PermissionTeamDrivePermissionDetailsInner.md) | Output only. Deprecated: Use &#x60;permissionDetails&#x60; instead. |  [optional] [readonly] |
