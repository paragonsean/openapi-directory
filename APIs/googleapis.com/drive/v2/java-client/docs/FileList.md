...
|**items** | [**List&lt;ModelFile&gt;**](ModelFile.md) | The list of files. If nextPageToken is populated, then this list may be incomplete and an additional page of results should be fetched. |  [optional] |
|**kind** | **String** | This is always &#x60;drive#fileList&#x60;. |  [optional] |
