...
public class FileImageMediaMetadata {
  ...
  public FileImageMediaMetadata date(String date) {
    this.date = date;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.aperture, fileImageMediaMetadata.aperture) &&
        ...
        Objects.equals(this.date, fileImageMediaMetadata.date) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(aperture, cameraMake, cameraModel, colorSpace, date, exposureBias, exposureMode, exposureTime, flashUsed, focalLength, height, isoSpeed, lens, location, maxApertureValue, meteringMode, rotation, sensor, subjectDistance, whiteBalance, width);
  }
