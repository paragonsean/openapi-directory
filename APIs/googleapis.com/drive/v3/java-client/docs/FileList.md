...
|------------ | ------------- | ------------- | -------------|
|**files** | [**List&lt;ModelFile&gt;**](ModelFile.md) | The list of files. If nextPageToken is populated, then this list may be incomplete and an additional page of results should be fetched. |  [optional] |
...
|**kind** | **String** | Identifies what kind of resource this is. Value: the fixed string &#x60;\&quot;drive#fileList\&quot;&#x60;. |  [optional] |
