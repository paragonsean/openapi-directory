...
|**createdTime** | **OffsetDateTime** | The time at which the comment was created (RFC 3339 date-time). |  [optional] |
...
|**kind** | **String** | Output only. Identifies what kind of resource this is. Value: the fixed string &#x60;\&quot;drive#comment\&quot;&#x60;. |  [optional] |
|**modifiedTime** | **OffsetDateTime** | The last time the comment or any of its replies was modified (RFC 3339 date-time). |  [optional] |
