...
|**createdTime** | **OffsetDateTime** | The time at which the shared drive was created (RFC 3339 date-time). |  [optional] |
...
|**kind** | **String** | Output only. Identifies what kind of resource this is. Value: the fixed string &#x60;\&quot;drive#drive\&quot;&#x60;. |  [optional] |
