...
public class PermissionsApi {
    ...
    /**
     * Build call for drivePermissionsCreate
     * @param fileId The ID of the file or shared drive. (required)
     ...
     * @param emailMessage A plain text custom message to include in the notification email. (optional)
     ...
     * @param sendNotificationEmail Whether to send a notification email when sharing to users or groups. This defaults to true for users and groups, and is not allowed for other requests. It must not be disabled for ownership transfers. (optional)
     ...
     * @param transferOwnership Whether to transfer ownership to the specified user and downgrade the current owner to a writer. This parameter is required as an acknowledgement of the side effect. (optional)
     ...
     */
    public okhttp3.Call drivePermissionsCreateCall(String fileId, String $xgafv, String accessToken, String alt, String paramCallback, String fields, String key, String oauthToken, Boolean prettyPrint, String quotaUser, String uploadProtocol, String uploadType, String emailMessage, Boolean enforceSingleParent, Boolean moveToNewOwnersRoot, Boolean sendNotificationEmail, Boolean supportsAllDrives, Boolean supportsTeamDrives, Boolean transferOwnership, Boolean useDomainAdminAccess, Permission permission, final ApiCallback _callback) throws ApiException {
        ...
        if (sendNotificationEmail != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("sendNotificationEmail", sendNotificationEmail));
        }
    ...
    private okhttp3.Call drivePermissionsCreateValidateBeforeCall(String fileId, String $xgafv, String accessToken, String alt, String paramCallback, String fields, String key, String oauthToken, Boolean prettyPrint, String quotaUser, String uploadProtocol, String uploadType, String emailMessage, Boolean enforceSingleParent, Boolean moveToNewOwnersRoot, Boolean sendNotificationEmail, Boolean supportsAllDrives, Boolean supportsTeamDrives, Boolean transferOwnership, Boolean useDomainAdminAccess, Permission permission, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'fileId' is set
        if (fileId == null) {
            throw new ApiException("Missing the required parameter 'fileId' when calling drivePermissionsCreate(Async)");
        }

        return drivePermissionsCreateCall(fileId, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, emailMessage, enforceSingleParent, moveToNewOwnersRoot, sendNotificationEmail, supportsAllDrives, supportsTeamDrives, transferOwnership, useDomainAdminAccess, permission, _callback);
     ...
     */
    public Permission drivePermissionsCreate(String fileId, String $xgafv, String accessToken, String alt, String paramCallback, String fields, String key, String oauthToken, Boolean prettyPrint, String quotaUser, String uploadProtocol, String uploadType, String emailMessage, Boolean enforceSingleParent, Boolean moveToNewOwnersRoot, Boolean sendNotificationEmail, Boolean supportsAllDrives, Boolean supportsTeamDrives, Boolean transferOwnership, Boolean useDomainAdminAccess, Permission permission) throws ApiException {
        ApiResponse<Permission> localVarResp = drivePermissionsCreateWithHttpInfo(fileId, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, emailMessage, enforceSingleParent, moveToNewOwnersRoot, sendNotificationEmail, supportsAllDrives, supportsTeamDrives, transferOwnership, useDomainAdminAccess, permission);
     ...
     */
    public ApiResponse<Permission> drivePermissionsCreateWithHttpInfo(String fileId, String $xgafv, String accessToken, String alt, String paramCallback, String fields, String key, String oauthToken, Boolean prettyPrint, String quotaUser, String uploadProtocol, String uploadType, String emailMessage, Boolean enforceSingleParent, Boolean moveToNewOwnersRoot, Boolean sendNotificationEmail, Boolean supportsAllDrives, Boolean supportsTeamDrives, Boolean transferOwnership, Boolean useDomainAdminAccess, Permission permission) throws ApiException {
        okhttp3.Call localVarCall = drivePermissionsCreateValidateBeforeCall(fileId, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, emailMessage, enforceSingleParent, moveToNewOwnersRoot, sendNotificationEmail, supportsAllDrives, supportsTeamDrives, transferOwnership, useDomainAdminAccess, permission, null);
     ...
     */
    public okhttp3.Call drivePermissionsCreateAsync(String fileId, String $xgafv, String accessToken, String alt, String paramCallback, String fields, String key, String oauthToken, Boolean prettyPrint, String quotaUser, String uploadProtocol, String uploadType, String emailMessage, Boolean enforceSingleParent, Boolean moveToNewOwnersRoot, Boolean sendNotificationEmail, Boolean supportsAllDrives, Boolean supportsTeamDrives, Boolean transferOwnership, Boolean useDomainAdminAccess, Permission permission, final ApiCallback<Permission> _callback) throws ApiException {
     ...
     * @param pageSize The maximum number of permissions to return per page. When not set for files in a shared drive, at most 100 results will be returned. When not set for files that are not in a shared drive, the entire list will be returned. (optional)
     ...
     */
    public okhttp3.Call drivePermissionsListCall(String fileId, String $xgafv, String accessToken, String alt, String paramCallback, String fields, String key, String oauthToken, Boolean prettyPrint, String quotaUser, String uploadProtocol, String uploadType, String includePermissionsForView, Integer pageSize, String pageToken, Boolean supportsAllDrives, Boolean supportsTeamDrives, Boolean useDomainAdminAccess, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    private okhttp3.Call drivePermissionsListValidateBeforeCall(String fileId, String $xgafv, String accessToken, String alt, String paramCallback, String fields, String key, String oauthToken, Boolean prettyPrint, String quotaUser, String uploadProtocol, String uploadType, String includePermissionsForView, Integer pageSize, String pageToken, Boolean supportsAllDrives, Boolean supportsTeamDrives, Boolean useDomainAdminAccess, final ApiCallback _callback) throws ApiException {
        ...
        return drivePermissionsListCall(fileId, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, includePermissionsForView, pageSize, pageToken, supportsAllDrives, supportsTeamDrives, useDomainAdminAccess, _callback);
     ...
     */
    public PermissionList drivePermissionsList(String fileId, String $xgafv, String accessToken, String alt, String paramCallback, String fields, String key, String oauthToken, Boolean prettyPrint, String quotaUser, String uploadProtocol, String uploadType, String includePermissionsForView, Integer pageSize, String pageToken, Boolean supportsAllDrives, Boolean supportsTeamDrives, Boolean useDomainAdminAccess) throws ApiException {
        ApiResponse<PermissionList> localVarResp = drivePermissionsListWithHttpInfo(fileId, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, includePermissionsForView, pageSize, pageToken, supportsAllDrives, supportsTeamDrives, useDomainAdminAccess);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<PermissionList> drivePermissionsListWithHttpInfo(String fileId, String $xgafv, String accessToken, String alt, String paramCallback, String fields, String key, String oauthToken, Boolean prettyPrint, String quotaUser, String uploadProtocol, String uploadType, String includePermissionsForView, Integer pageSize, String pageToken, Boolean supportsAllDrives, Boolean supportsTeamDrives, Boolean useDomainAdminAccess) throws ApiException {
        okhttp3.Call localVarCall = drivePermissionsListValidateBeforeCall(fileId, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, includePermissionsForView, pageSize, pageToken, supportsAllDrives, supportsTeamDrives, useDomainAdminAccess, null);
     ...
     */
    public okhttp3.Call drivePermissionsListAsync(String fileId, String $xgafv, String accessToken, String alt, String paramCallback, String fields, String key, String oauthToken, Boolean prettyPrint, String quotaUser, String uploadProtocol, String uploadType, String includePermissionsForView, Integer pageSize, String pageToken, Boolean supportsAllDrives, Boolean supportsTeamDrives, Boolean useDomainAdminAccess, final ApiCallback<PermissionList> _callback) throws ApiException {

        okhttp3.Call localVarCall = drivePermissionsListValidateBeforeCall(fileId, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, includePermissionsForView, pageSize, pageToken, supportsAllDrives, supportsTeamDrives, useDomainAdminAccess, _callback);
        Type localVarReturnType = new TypeToken<PermissionList>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
