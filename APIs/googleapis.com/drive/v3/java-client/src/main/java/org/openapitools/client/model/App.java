...
public class App {
  ...
  private List<AppIcons> icons = new ArrayList<>();
  ...
  public App icons(List<AppIcons> icons) {
    this.icons = icons;
    return this;
  }

  public App addIconsItem(AppIcons iconsItem) {
    if (this.icons == null) {
  ...
  public void setIcons(List<AppIcons> icons) {
    this.icons = icons;
  }
      ...
      if (jsonObj.get("icons") != null && !jsonObj.get("icons").isJsonNull()) {
        ...
        if (jsonArrayicons != null) {
          ...
          for (int i = 0; i < jsonArrayicons.size(); i++) {
            AppIcons.validateJsonElement(jsonArrayicons.get(i));
          };
        }
      }
