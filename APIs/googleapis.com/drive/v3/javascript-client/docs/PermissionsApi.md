...
> Permission drivePermissionsCreate(fileId, opts)
...
let fileId = "fileId_example"; // String | The ID of the file or shared drive.
let opts = {
  ...
  'emailMessage': "emailMessage_example", // String | A plain text custom message to include in the notification email.
  ...
  'sendNotificationEmail': true, // Boolean | Whether to send a notification email when sharing to users or groups. This defaults to true for users and groups, and is not allowed for other requests. It must not be disabled for ownership transfers.
  ...
  'transferOwnership': true, // Boolean | Whether to transfer ownership to the specified user and downgrade the current owner to a writer. This parameter is required as an acknowledgement of the side effect.
...
apiInstance.drivePermissionsCreate(fileId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let apiInstance = new GoogleDriveApi.PermissionsApi();
let fileId = "fileId_example"; // String | The ID of the file or shared drive.
let permissionId = "permissionId_example"; // String | The ID of the permission.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
let opts = {
  ...
  'pageSize': 56, // Number | The maximum number of permissions to return per page. When not set for files in a shared drive, at most 100 results will be returned. When not set for files that are not in a shared drive, the entire list will be returned.
 ...
 **pageSize** | **Number**| The maximum number of permissions to return per page. When not set for files in a shared drive, at most 100 results will be returned. When not set for files that are not in a shared drive, the entire list will be returned. | [optional] 
