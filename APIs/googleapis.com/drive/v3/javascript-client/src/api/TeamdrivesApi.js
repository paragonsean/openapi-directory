...
export default class TeamdrivesApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the driveTeamdrivesCreate operation.
     * @callback module:api/TeamdrivesApi~driveTeamdrivesCreateCallback
     ...
     * @param {module:api/TeamdrivesApi~driveTeamdrivesCreateCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/TeamDrive}
     */
    driveTeamdrivesCreate(requestId, opts, callback) {
      opts = opts || {};
      let postBody = opts['teamDrive'];
      // verify the required parameter 'requestId' is set
      if (requestId === undefined || requestId === null) {
        throw new Error("Missing the required parameter 'requestId' when calling driveTeamdrivesCreate");
      }
