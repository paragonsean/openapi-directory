...
class FileCapabilities {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('canChangeViewersCanCopyContent')) {
                obj['canChangeViewersCanCopyContent'] = ApiClient.convertToType(data['canChangeViewersCanCopyContent'], 'Boolean');
            }
 ...
 * @member {Boolean} canChangeViewersCanCopyContent
 */
FileCapabilities.prototype['canChangeViewersCanCopyContent'] = undefined;
