...
(function(root, factory) {
  ...
  describe('Comment', function() {
    ...
    it('should have the property quotedFileContent (base name: "quotedFileContent")', function() {
      // uncomment below and update the code to test the property quotedFileContent
      //var instance = new GoogleDriveApi.Comment();
      //expect(instance).to.be();
    });
