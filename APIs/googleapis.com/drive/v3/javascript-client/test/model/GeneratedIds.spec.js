...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleDriveApi.GeneratedIds();
  });
  ...
  describe('GeneratedIds', function() {
    it('should create an instance of GeneratedIds', function() {
      // uncomment below and update the code to test GeneratedIds
      //var instance = new GoogleDriveApi.GeneratedIds();
      //expect(instance).to.be.a(GoogleDriveApi.GeneratedIds);
    });
