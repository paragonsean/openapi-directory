...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleDriveApi.DriveList();
  });
  ...
  describe('DriveList', function() {
    it('should create an instance of DriveList', function() {
      // uncomment below and update the code to test DriveList
      //var instance = new GoogleDriveApi.DriveList();
      //expect(instance).to.be.a(GoogleDriveApi.DriveList);
    });
