...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleDriveApi.FileContentHints();
  });
  ...
  describe('FileContentHints', function() {
    it('should create an instance of FileContentHints', function() {
      // uncomment below and update the code to test FileContentHints
      //var instance = new GoogleDriveApi.FileContentHints();
      //expect(instance).to.be.a(GoogleDriveApi.FileContentHints);
    });
