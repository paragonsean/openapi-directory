...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleDriveApi.ReplyList();
  });
  ...
  describe('ReplyList', function() {
    it('should create an instance of ReplyList', function() {
      // uncomment below and update the code to test ReplyList
      //var instance = new GoogleDriveApi.ReplyList();
      //expect(instance).to.be.a(GoogleDriveApi.ReplyList);
    });
