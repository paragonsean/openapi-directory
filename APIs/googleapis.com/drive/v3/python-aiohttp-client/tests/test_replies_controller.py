...
async def test_drive_replies_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/drive/v3/files/{file_id}/comments/{comment_id}/replies'.format(file_id='file_id_example', comment_id='comment_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_drive_replies_delete(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/drive/v3/files/{file_id}/comments/{comment_id}/replies/{reply_id}'.format(file_id='file_id_example', comment_id='comment_id_example', reply_id='reply_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
