...
class LabelFieldModification(Model):
    ...
    def __init__(self, field_id: str=None, kind: str=None, set_date_values: List[date]=None, set_integer_values: List[str]=None, set_selection_values: List[str]=None, set_text_values: List[str]=None, set_user_values: List[str]=None, unset_values: bool=None):
