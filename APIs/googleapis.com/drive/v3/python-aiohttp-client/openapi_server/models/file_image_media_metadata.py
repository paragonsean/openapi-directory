...
class FileImageMediaMetadata(Model):
    ...
    def __init__(self, aperture: float=None, camera_make: str=None, camera_model: str=None, color_space: str=None, exposure_bias: float=None, exposure_mode: str=None, exposure_time: float=None, flash_used: bool=None, focal_length: float=None, height: int=None, iso_speed: int=None, lens: str=None, location: FileImageMediaMetadataLocation=None, max_aperture_value: float=None, metering_mode: str=None, rotation: int=None, sensor: str=None, subject_distance: int=None, time: str=None, white_balance: str=None, width: int=None):
        ...
        :param time: The time of this FileImageMediaMetadata.
    ...
    @property
    def time(self):
        """Gets the time of this FileImageMediaMetadata.

        Output only. The date and time the photo was taken (EXIF DateTime).

        :return: The time of this FileImageMediaMetadata.
        :rtype: str
        """
        return self._time
    ...
    @time.setter
    def time(self, time):
        """Sets the time of this FileImageMediaMetadata.
