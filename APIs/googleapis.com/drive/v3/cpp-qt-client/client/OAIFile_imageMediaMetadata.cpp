...
QString OAIFile_imageMediaMetadata::getTime() const {
    return m_time;
}
void OAIFile_imageMediaMetadata::setTime(const QString &time) {
    m_time = time;
    m_time_isSet = true;
}

bool OAIFile_imageMediaMetadata::is_time_Set() const{
    return m_time_isSet;
}

bool OAIFile_imageMediaMetadata::is_time_Valid() const{
