...
QDateTime OAIDrive::getCreatedTime() const {
    return m_created_time;
}
void OAIDrive::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIDrive::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIDrive::is_created_time_Valid() const{
