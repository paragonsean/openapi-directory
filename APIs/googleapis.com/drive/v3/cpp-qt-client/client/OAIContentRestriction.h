...
public:
    ...
    QDateTime getRestrictionTime() const;
    void setRestrictionTime(const QDateTime &restriction_time);
    bool is_restriction_time_Set() const;
    bool is_restriction_time_Valid() const;
...
private:
    ...
    QDateTime m_restriction_time;
    bool m_restriction_time_isSet;
    bool m_restriction_time_isValid;
