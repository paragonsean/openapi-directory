...
void OAIAppsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("drive_apps_get", defaultConf);
    _serverIndices.insert("drive_apps_get", 0);
    _serverConfigs.insert("drive_apps_list", defaultConf);
    _serverIndices.insert("drive_apps_list", 0);
}
...
void OAIAppsApi::drive_apps_get(const QString &app_id, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAppsApi::drive_apps_getCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAppsApi::drive_apps_getCallback);
...
void OAIAppsApi::drive_apps_getCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT drive_apps_getSignal(output);
        Q_EMIT drive_apps_getSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT drive_apps_getSignalE(output, error_type, error_str);
        Q_EMIT drive_apps_getSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT drive_apps_getSignalError(output, error_type, error_str);
        Q_EMIT drive_apps_getSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIAppsApi::drive_apps_list(const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<QString> &app_filter_extensions, const ::OpenAPI::OptionalParam<QString> &app_filter_mime_types, const ::OpenAPI::OptionalParam<QString> &language_code) {
    QString fullPath = QString(_serverConfigs["drive_apps_list"][_serverIndices.value("drive_apps_list")].URL()+"/apps");
    ...
    if (app_filter_extensions.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "appFilterExtensions", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("appFilterExtensions")).append(querySuffix).append(QUrl::toPercentEncoding(app_filter_extensions.stringValue()));
    }
    if (app_filter_mime_types.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "appFilterMimeTypes", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("appFilterMimeTypes")).append(querySuffix).append(QUrl::toPercentEncoding(app_filter_mime_types.stringValue()));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAppsApi::drive_apps_listCallback);
    connect(this, &OAIAppsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    _authFlow.link();
    QStringList scope;
    scope.append("https://www.googleapis.com/auth/drive.apps.readonly");
    auto token = _authFlow.getToken(scope.join(" "));
    if(token.isValid())
        input.headers.insert("Authorization", "Bearer " + token.getToken());
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAppsApi::drive_apps_listCallback);
    connect(this, &OAIAppsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIAppsApi::drive_apps_listCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIAppList output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT drive_apps_listSignal(output);
        Q_EMIT drive_apps_listSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("https://www.googleapis.com/auth/drive.apps.readonly");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT drive_apps_listSignalE(output, error_type, error_str);
        Q_EMIT drive_apps_listSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT drive_apps_listSignalError(output, error_type, error_str);
        Q_EMIT drive_apps_listSignalErrorFull(worker, error_type, error_str);
    }
}
