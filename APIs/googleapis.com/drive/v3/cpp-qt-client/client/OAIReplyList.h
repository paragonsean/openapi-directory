...
#ifndef OAIReplyList_H
#define OAIReplyList_H
...
class OAIReplyList : public OAIObject {
public:
    OAIReplyList();
    OAIReplyList(QString json);
    ~OAIReplyList() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReplyList)

#endif // OAIReplyList_H
