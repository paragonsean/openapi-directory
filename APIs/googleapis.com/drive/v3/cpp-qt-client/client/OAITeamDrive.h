...
namespace OpenAPI {
class OAITeamDrive_backgroundImageFile;
class OAITeamDrive_capabilities;
class OAITeamDrive_restrictions;
...
public:
    ...
    OAITeamDrive_backgroundImageFile getBackgroundImageFile() const;
    void setBackgroundImageFile(const OAITeamDrive_backgroundImageFile &background_image_file);
    ...
    OAITeamDrive_capabilities getCapabilities() const;
    void setCapabilities(const OAITeamDrive_capabilities &capabilities);
    ...
    OAITeamDrive_restrictions getRestrictions() const;
    void setRestrictions(const OAITeamDrive_restrictions &restrictions);
...
private:
    ...
    OAITeamDrive_backgroundImageFile m_background_image_file;
    ...
    OAITeamDrive_capabilities m_capabilities;
    ...
    OAITeamDrive_restrictions m_restrictions;
