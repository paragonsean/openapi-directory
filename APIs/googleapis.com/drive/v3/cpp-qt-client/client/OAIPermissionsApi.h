...
public:
    ...
    * @param[in]  send_notification_email bool [optional]
    ...
    */
    virtual void drive_permissions_create(const QString &file_id, const ::OpenAPI::OptionalParam<QString> &_xgafv = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &access_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &alt = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &callback = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &fields = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &key = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &oauth_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &pretty_print = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &quota_user = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &upload_protocol = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &upload_type = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &email_message = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &enforce_single_parent = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<bool> &move_to_new_owners_root = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<bool> &send_notification_email = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<bool> &supports_all_drives = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<bool> &supports_team_drives = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<bool> &transfer_ownership = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<bool> &use_domain_admin_access = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<OAIPermission> &oai_permission = ::OpenAPI::OptionalParam<OAIPermission>());
    ...
    * @param[in]  use_domain_admin_access bool [optional]
    */
    virtual void drive_permissions_list(const QString &file_id, const ::OpenAPI::OptionalParam<QString> &_xgafv = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &access_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &alt = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &callback = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &fields = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &key = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &oauth_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &pretty_print = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &quota_user = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &upload_protocol = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &upload_type = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &include_permissions_for_view = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &page_size = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &page_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &supports_all_drives = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<bool> &supports_team_drives = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<bool> &use_domain_admin_access = ::OpenAPI::OptionalParam<bool>());
...
private:
    ...
    void drive_permissions_createCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void drive_permissions_createSignal(OAIPermission summary);
    ...
    void drive_permissions_createSignalFull(OAIHttpRequestWorker *worker, OAIPermission summary);
    ...
    Q_DECL_DEPRECATED_X("Use drive_permissions_createSignalError() instead")
    void drive_permissions_createSignalE(OAIPermission summary, QNetworkReply::NetworkError error_type, QString error_str);
    void drive_permissions_createSignalError(OAIPermission summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use drive_permissions_createSignalErrorFull() instead")
    void drive_permissions_createSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void drive_permissions_createSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
