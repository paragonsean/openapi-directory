...
QString OAIVerification::getAnnouncement() const {
    return m_announcement;
}
void OAIVerification::setAnnouncement(const QString &announcement) {
    m_announcement = announcement;
    m_announcement_isSet = true;
}

bool OAIVerification::is_announcement_Set() const{
    return m_announcement_isSet;
}

bool OAIVerification::is_announcement_Valid() const{
