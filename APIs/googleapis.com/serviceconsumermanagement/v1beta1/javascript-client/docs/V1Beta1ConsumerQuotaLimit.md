# ServiceConsumerManagementApi.V1Beta1ConsumerQuotaLimit
...
**quotaBuckets** | [**[V1Beta1QuotaBucket]**](V1Beta1QuotaBucket.md) | Summary of the enforced quota buckets, organized by quota dimension, ordered from least specific to most specific (for example, the global default bucket, with no quota dimensions, will always appear first). | [optional] 
**supportedLocations** | **[String]** | List of all supported locations. This field is present only if the limit has a {region} or {zone} dimension. | [optional] 
