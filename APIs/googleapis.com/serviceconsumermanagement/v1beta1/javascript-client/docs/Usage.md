# ServiceConsumerManagementApi.Usage
...
**rules** | [**[UsageRule]**](UsageRule.md) | A list of usage rules that apply to individual API methods. **NOTE:** All service configuration rules follow \&quot;last one wins\&quot; order. | [optional] 
