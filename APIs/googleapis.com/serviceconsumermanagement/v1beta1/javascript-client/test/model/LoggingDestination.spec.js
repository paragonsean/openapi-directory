...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceConsumerManagementApi.LoggingDestination();
  });
  ...
  describe('LoggingDestination', function() {
    it('should create an instance of LoggingDestination', function() {
      ...
      //var instance = new ServiceConsumerManagementApi.LoggingDestination();
      //expect(instance).to.be.a(ServiceConsumerManagementApi.LoggingDestination);
    });
