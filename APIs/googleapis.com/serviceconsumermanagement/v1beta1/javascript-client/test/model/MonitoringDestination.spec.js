...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceConsumerManagementApi.MonitoringDestination();
  });
  ...
  describe('MonitoringDestination', function() {
    it('should create an instance of MonitoringDestination', function() {
      ...
      //var instance = new ServiceConsumerManagementApi.MonitoringDestination();
      //expect(instance).to.be.a(ServiceConsumerManagementApi.MonitoringDestination);
    });
