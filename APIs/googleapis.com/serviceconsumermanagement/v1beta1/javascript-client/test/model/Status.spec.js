...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceConsumerManagementApi.Status();
  });
  ...
  describe('Status', function() {
    it('should create an instance of Status', function() {
      ...
      //var instance = new ServiceConsumerManagementApi.Status();
      //expect(instance).to.be.a(ServiceConsumerManagementApi.Status);
    });
