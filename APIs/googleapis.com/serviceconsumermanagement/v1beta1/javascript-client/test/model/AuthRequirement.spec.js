...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceConsumerManagementApi.AuthRequirement();
  });
  ...
  describe('AuthRequirement', function() {
    it('should create an instance of AuthRequirement', function() {
      ...
      //var instance = new ServiceConsumerManagementApi.AuthRequirement();
      //expect(instance).to.be.a(ServiceConsumerManagementApi.AuthRequirement);
    });
