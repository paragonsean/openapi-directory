...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceConsumerManagementApi.Quota();
  });
  ...
  describe('Quota', function() {
    it('should create an instance of Quota', function() {
      ...
      //var instance = new ServiceConsumerManagementApi.Quota();
      //expect(instance).to.be.a(ServiceConsumerManagementApi.Quota);
    });
