...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceConsumerManagementApi.V1Beta1QuotaBucket();
  });
  ...
  describe('V1Beta1QuotaBucket', function() {
    it('should create an instance of V1Beta1QuotaBucket', function() {
      // uncomment below and update the code to test V1Beta1QuotaBucket
      //var instance = new ServiceConsumerManagementApi.V1Beta1QuotaBucket();
      //expect(instance).to.be.a(ServiceConsumerManagementApi.V1Beta1QuotaBucket);
    });
