...
|**deadline** | **Double** | The number of seconds to wait for a response from a request. The default varies based on the request protocol and deployment environment. |  [optional] |
...
|**minDeadline** | **Double** | Deprecated, do not use. |  [optional] |
|**operationDeadline** | **Double** | The number of seconds to wait for the completion of a long running operation. The default is no deadline. |  [optional] |
|**overridesByRequestProtocol** | [**Map&lt;String, BackendRule&gt;**](BackendRule.md) | The map between request protocol and the backend address. |  [optional] |
|**pathTranslation** | [**PathTranslationEnum**](#PathTranslationEnum) |  |  [optional] |
