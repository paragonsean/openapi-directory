...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceConsumerManagementApi.Type();
  });
  ...
  describe('Type', function() {
    it('should create an instance of Type', function() {
      ...
      //var instance = new ServiceConsumerManagementApi.Type();
      //expect(instance).to.be.a(ServiceConsumerManagementApi.Type);
    });
