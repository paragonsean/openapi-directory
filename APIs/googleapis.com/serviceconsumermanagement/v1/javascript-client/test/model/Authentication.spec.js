...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceConsumerManagementApi.Authentication();
  });
  ...
  describe('Authentication', function() {
    it('should create an instance of Authentication', function() {
      ...
      //var instance = new ServiceConsumerManagementApi.Authentication();
      //expect(instance).to.be.a(ServiceConsumerManagementApi.Authentication);
    });
