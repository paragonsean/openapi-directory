...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceConsumerManagementApi.Operation();
  });
  ...
  describe('Operation', function() {
    it('should create an instance of Operation', function() {
      ...
      //var instance = new ServiceConsumerManagementApi.Operation();
      //expect(instance).to.be.a(ServiceConsumerManagementApi.Operation);
    });
