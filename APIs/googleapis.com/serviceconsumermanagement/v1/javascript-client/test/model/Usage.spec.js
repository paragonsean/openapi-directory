...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceConsumerManagementApi.Usage();
  });
  ...
  describe('Usage', function() {
    it('should create an instance of Usage', function() {
      ...
      //var instance = new ServiceConsumerManagementApi.Usage();
      //expect(instance).to.be.a(ServiceConsumerManagementApi.Usage);
    });
