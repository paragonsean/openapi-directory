...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceConsumerManagementApi.AuthProvider();
  });
  ...
  describe('AuthProvider', function() {
    it('should create an instance of AuthProvider', function() {
      ...
      //var instance = new ServiceConsumerManagementApi.AuthProvider();
      //expect(instance).to.be.a(ServiceConsumerManagementApi.AuthProvider);
    });
