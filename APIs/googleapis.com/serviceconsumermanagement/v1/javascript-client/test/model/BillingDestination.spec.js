...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceConsumerManagementApi.BillingDestination();
  });
  ...
  describe('BillingDestination', function() {
    it('should create an instance of BillingDestination', function() {
      // uncomment below and update the code to test BillingDestination
      //var instance = new ServiceConsumerManagementApi.BillingDestination();
      //expect(instance).to.be.a(ServiceConsumerManagementApi.BillingDestination);
    });
