...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceConsumerManagementApi.FieldPolicy();
  });
  ...
  describe('FieldPolicy', function() {
    it('should create an instance of FieldPolicy', function() {
      ...
      //var instance = new ServiceConsumerManagementApi.FieldPolicy();
      //expect(instance).to.be.a(ServiceConsumerManagementApi.FieldPolicy);
    });
