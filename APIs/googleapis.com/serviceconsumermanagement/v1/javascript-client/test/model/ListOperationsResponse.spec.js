...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceConsumerManagementApi.ListOperationsResponse();
  });
  ...
  describe('ListOperationsResponse', function() {
    it('should create an instance of ListOperationsResponse', function() {
      ...
      //var instance = new ServiceConsumerManagementApi.ListOperationsResponse();
      //expect(instance).to.be.a(ServiceConsumerManagementApi.ListOperationsResponse);
    });
