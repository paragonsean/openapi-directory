...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ServiceConsumerManagementApi.Context();
  });
  ...
  describe('Context', function() {
    it('should create an instance of Context', function() {
      ...
      //var instance = new ServiceConsumerManagementApi.Context();
      //expect(instance).to.be.a(ServiceConsumerManagementApi.Context);
    });
