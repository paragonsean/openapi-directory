# ServiceConsumerManagementApi.OperationsApi
...
> Object serviceconsumermanagementOperationsCancel(name, opts)
...
let apiInstance = new ServiceConsumerManagementApi.OperationsApi();
...
apiInstance.serviceconsumermanagementOperationsCancel(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> ListOperationsResponse serviceconsumermanagementOperationsList(name, opts)
...
apiInstance.serviceconsumermanagementOperationsList(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
