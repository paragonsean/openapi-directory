...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PolyApi.ListLikedAssetsResponse();
  });
  ...
  describe('ListLikedAssetsResponse', function() {
    it('should create an instance of ListLikedAssetsResponse', function() {
      // uncomment below and update the code to test ListLikedAssetsResponse
      //var instance = new PolyApi.ListLikedAssetsResponse();
      //expect(instance).to.be.a(PolyApi.ListLikedAssetsResponse);
    });
