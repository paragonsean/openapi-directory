...
class ListAssetsResponse(Model):
    ...
    def __init__(self, assets: List[Asset]=None, next_page_token: str=None, total_size: int=None):
        ...
        :param total_size: The total_size of this ListAssetsResponse.
        """
        self.openapi_types = {
            'assets': List[Asset],
            'next_page_token': str,
    ...
    @property
    def total_size(self):
        """Gets the total_size of this ListAssetsResponse.

        The total number of assets in the list, without pagination.

        :return: The total_size of this ListAssetsResponse.
        :rtype: int
        """
    ...
    def total_size(self, total_size):
        """Sets the total_size of this ListAssetsResponse.
