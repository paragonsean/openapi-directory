...
void OAIUsersApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("poly_users_assets_list", defaultConf);
    _serverIndices.insert("poly_users_assets_list", 0);
    _serverConfigs.insert("poly_users_likedassets_list", defaultConf);
    _serverIndices.insert("poly_users_likedassets_list", 0);
}
...
void OAIUsersApi::poly_users_assets_list(const QString &name, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<QString> &format, const ::OpenAPI::OptionalParam<QString> &order_by, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &page_token, const ::OpenAPI::OptionalParam<QString> &visibility) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIUsersApi::poly_users_assets_listCallback);
...
void OAIUsersApi::poly_users_assets_listCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIListUserAssetsResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT poly_users_assets_listSignal(output);
        Q_EMIT poly_users_assets_listSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT poly_users_assets_listSignalE(output, error_type, error_str);
        Q_EMIT poly_users_assets_listSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT poly_users_assets_listSignalError(output, error_type, error_str);
        Q_EMIT poly_users_assets_listSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIUsersApi::poly_users_likedassets_list(const QString &name, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<QString> &format, const ::OpenAPI::OptionalParam<QString> &order_by, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &page_token) {
    QString fullPath = QString(_serverConfigs["poly_users_likedassets_list"][_serverIndices.value("poly_users_likedassets_list")].URL()+"/v1/{name}/likedassets");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIUsersApi::poly_users_likedassets_listCallback);
    connect(this, &OAIUsersApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIUsersApi::poly_users_likedassets_listCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIListLikedAssetsResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT poly_users_likedassets_listSignal(output);
        Q_EMIT poly_users_likedassets_listSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT poly_users_likedassets_listSignalE(output, error_type, error_str);
        Q_EMIT poly_users_likedassets_listSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT poly_users_likedassets_listSignalError(output, error_type, error_str);
        Q_EMIT poly_users_likedassets_listSignalErrorFull(worker, error_type, error_str);
    }
}
