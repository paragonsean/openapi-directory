...
/*
 * OAIListLikedAssetsResponse.h
 *
 * A response message from a request to list.
 */

#ifndef OAIListLikedAssetsResponse_H
#define OAIListLikedAssetsResponse_H
...
class OAIListLikedAssetsResponse : public OAIObject {
public:
    OAIListLikedAssetsResponse();
    OAIListLikedAssetsResponse(QString json);
    ~OAIListLikedAssetsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListLikedAssetsResponse)

#endif // OAIListLikedAssetsResponse_H
