...
------------ | ------------- | ------------- | -------------
**attachments** | [**[Attachment]**](Attachment.md) | Output only. The attachments attached to this note. | [optional] [readonly] 
...
**permissions** | [**[Permission]**](Permission.md) | Output only. The list of permissions set on the note. Contains at least one entry for the note owner. | [optional] [readonly] 
