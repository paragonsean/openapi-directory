...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleKeepApi.CreatePermissionRequest();
  });
  ...
  describe('CreatePermissionRequest', function() {
    it('should create an instance of CreatePermissionRequest', function() {
      ...
      //var instance = new GoogleKeepApi.CreatePermissionRequest();
      //expect(instance).to.be.a(GoogleKeepApi.CreatePermissionRequest);
    });
