...
public class Section {
  ...
  public Section _list(ListContent _list) {
    this._list = _list;
    return this;
  }
  ...
  public void setList(ListContent _list) {
    this._list = _list;
  }


  public Section text(TextContent text) {
    this.text = text;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this._list, section._list) &&
        Objects.equals(this.text, section.text);
  }

  @Override
  public int hashCode() {
    return Objects.hash(_list, text);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("list") != null && !jsonObj.get("list").isJsonNull()) {
        ListContent.validateJsonElement(jsonObj.get("list"));
      }
