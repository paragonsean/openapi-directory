...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleWorkspaceResellerApi.Subscriptions();
  });
  ...
  describe('Subscriptions', function() {
    it('should create an instance of Subscriptions', function() {
      ...
      //var instance = new GoogleWorkspaceResellerApi.Subscriptions();
      //expect(instance).to.be.a(GoogleWorkspaceResellerApi.Subscriptions);
    });
