...
/*
 * OAIGoogleCloudAiplatformV1DataLabelingJob.h
 *
 * DataLabelingJob is used to trigger a human labeling job on unlabeled data from the following Dataset:
 */

#ifndef OAIGoogleCloudAiplatformV1DataLabelingJob_H
#define OAIGoogleCloudAiplatformV1DataLabelingJob_H

#include <QJsonObject>

#include "OAIGoogleCloudAiplatformV1ActiveLearningConfig.h"
...
namespace OpenAPI {
class OAIGoogleCloudAiplatformV1ActiveLearningConfig;
class OAIGoogleTypeMoney;
class OAIGoogleCloudAiplatformV1EncryptionSpec;
class OAIGoogleRpcStatus;

class OAIGoogleCloudAiplatformV1DataLabelingJob : public OAIObject {
public:
    OAIGoogleCloudAiplatformV1DataLabelingJob();
    OAIGoogleCloudAiplatformV1DataLabelingJob(QString json);
    ~OAIGoogleCloudAiplatformV1DataLabelingJob() override;
    ...
    OAIGoogleCloudAiplatformV1ActiveLearningConfig getActiveLearningConfig() const;
    void setActiveLearningConfig(const OAIGoogleCloudAiplatformV1ActiveLearningConfig &active_learning_config);
...
private:
    ...
    OAIGoogleCloudAiplatformV1ActiveLearningConfig m_active_learning_config;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudAiplatformV1DataLabelingJob)

#endif // OAIGoogleCloudAiplatformV1DataLabelingJob_H
