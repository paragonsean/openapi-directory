...
OAIGoogleCloudAiplatformV1Tensor::OAIGoogleCloudAiplatformV1Tensor(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGoogleCloudAiplatformV1Tensor::OAIGoogleCloudAiplatformV1Tensor() {
    this->initializeModel();
}

OAIGoogleCloudAiplatformV1Tensor::~OAIGoogleCloudAiplatformV1Tensor() {}

void OAIGoogleCloudAiplatformV1Tensor::initializeModel() {
...
void OAIGoogleCloudAiplatformV1Tensor::fromJson(QString jsonString) {
...
void OAIGoogleCloudAiplatformV1Tensor::fromJsonObject(QJsonObject json) {
...
QString OAIGoogleCloudAiplatformV1Tensor::asJson() const {
...
QJsonObject OAIGoogleCloudAiplatformV1Tensor::asJsonObject() const {
    QJsonObject obj;
...
QList<bool> OAIGoogleCloudAiplatformV1Tensor::getBoolVal() const {
    return m_bool_val;
}
void OAIGoogleCloudAiplatformV1Tensor::setBoolVal(const QList<bool> &bool_val) {
    m_bool_val = bool_val;
    m_bool_val_isSet = true;
}

bool OAIGoogleCloudAiplatformV1Tensor::is_bool_val_Set() const{
    return m_bool_val_isSet;
}

bool OAIGoogleCloudAiplatformV1Tensor::is_bool_val_Valid() const{
    return m_bool_val_isValid;
}

QList<QByteArray> OAIGoogleCloudAiplatformV1Tensor::getBytesVal() const {
    return m_bytes_val;
}
void OAIGoogleCloudAiplatformV1Tensor::setBytesVal(const QList<QByteArray> &bytes_val) {
    m_bytes_val = bytes_val;
    m_bytes_val_isSet = true;
}

bool OAIGoogleCloudAiplatformV1Tensor::is_bytes_val_Set() const{
    return m_bytes_val_isSet;
}

bool OAIGoogleCloudAiplatformV1Tensor::is_bytes_val_Valid() const{
    return m_bytes_val_isValid;
}

QList<double> OAIGoogleCloudAiplatformV1Tensor::getDoubleVal() const {
    return m_double_val;
}
void OAIGoogleCloudAiplatformV1Tensor::setDoubleVal(const QList<double> &double_val) {
    m_double_val = double_val;
    m_double_val_isSet = true;
}

bool OAIGoogleCloudAiplatformV1Tensor::is_double_val_Set() const{
    return m_double_val_isSet;
}

bool OAIGoogleCloudAiplatformV1Tensor::is_double_val_Valid() const{
    return m_double_val_isValid;
}

QString OAIGoogleCloudAiplatformV1Tensor::getDtype() const {
    return m_dtype;
}
void OAIGoogleCloudAiplatformV1Tensor::setDtype(const QString &dtype) {
    m_dtype = dtype;
    m_dtype_isSet = true;
}

bool OAIGoogleCloudAiplatformV1Tensor::is_dtype_Set() const{
    return m_dtype_isSet;
}

bool OAIGoogleCloudAiplatformV1Tensor::is_dtype_Valid() const{
    return m_dtype_isValid;
}

QList<float> OAIGoogleCloudAiplatformV1Tensor::getFloatVal() const {
    return m_float_val;
}
void OAIGoogleCloudAiplatformV1Tensor::setFloatVal(const QList<float> &float_val) {
    m_float_val = float_val;
    m_float_val_isSet = true;
}

bool OAIGoogleCloudAiplatformV1Tensor::is_float_val_Set() const{
    return m_float_val_isSet;
}

bool OAIGoogleCloudAiplatformV1Tensor::is_float_val_Valid() const{
    return m_float_val_isValid;
}

QList<QString> OAIGoogleCloudAiplatformV1Tensor::getInt64Val() const {
    return m_int64_val;
}
void OAIGoogleCloudAiplatformV1Tensor::setInt64Val(const QList<QString> &int64_val) {
    m_int64_val = int64_val;
    m_int64_val_isSet = true;
}

bool OAIGoogleCloudAiplatformV1Tensor::is_int64_val_Set() const{
    return m_int64_val_isSet;
}

bool OAIGoogleCloudAiplatformV1Tensor::is_int64_val_Valid() const{
    return m_int64_val_isValid;
}

QList<qint32> OAIGoogleCloudAiplatformV1Tensor::getIntVal() const {
    return m_int_val;
}
void OAIGoogleCloudAiplatformV1Tensor::setIntVal(const QList<qint32> &int_val) {
    m_int_val = int_val;
    m_int_val_isSet = true;
}

bool OAIGoogleCloudAiplatformV1Tensor::is_int_val_Set() const{
    return m_int_val_isSet;
}

bool OAIGoogleCloudAiplatformV1Tensor::is_int_val_Valid() const{
    return m_int_val_isValid;
}

QList<OAIGoogleCloudAiplatformV1Tensor> OAIGoogleCloudAiplatformV1Tensor::getListVal() const {
    return m_list_val;
}
void OAIGoogleCloudAiplatformV1Tensor::setListVal(const QList<OAIGoogleCloudAiplatformV1Tensor> &list_val) {
    m_list_val = list_val;
    m_list_val_isSet = true;
}

bool OAIGoogleCloudAiplatformV1Tensor::is_list_val_Set() const{
    return m_list_val_isSet;
}

bool OAIGoogleCloudAiplatformV1Tensor::is_list_val_Valid() const{
    return m_list_val_isValid;
}

QList<QString> OAIGoogleCloudAiplatformV1Tensor::getShape() const {
    return m_shape;
}
void OAIGoogleCloudAiplatformV1Tensor::setShape(const QList<QString> &shape) {
    m_shape = shape;
    m_shape_isSet = true;
}

bool OAIGoogleCloudAiplatformV1Tensor::is_shape_Set() const{
    return m_shape_isSet;
}

bool OAIGoogleCloudAiplatformV1Tensor::is_shape_Valid() const{
    return m_shape_isValid;
}

QList<QString> OAIGoogleCloudAiplatformV1Tensor::getStringVal() const {
    return m_string_val;
}
void OAIGoogleCloudAiplatformV1Tensor::setStringVal(const QList<QString> &string_val) {
    m_string_val = string_val;
    m_string_val_isSet = true;
}

bool OAIGoogleCloudAiplatformV1Tensor::is_string_val_Set() const{
    return m_string_val_isSet;
}

bool OAIGoogleCloudAiplatformV1Tensor::is_string_val_Valid() const{
    return m_string_val_isValid;
}

QMap<QString, OAIGoogleCloudAiplatformV1Tensor> OAIGoogleCloudAiplatformV1Tensor::getStructVal() const {
    return m_struct_val;
}
void OAIGoogleCloudAiplatformV1Tensor::setStructVal(const QMap<QString, OAIGoogleCloudAiplatformV1Tensor> &struct_val) {
    m_struct_val = struct_val;
    m_struct_val_isSet = true;
}

bool OAIGoogleCloudAiplatformV1Tensor::is_struct_val_Set() const{
    return m_struct_val_isSet;
}

bool OAIGoogleCloudAiplatformV1Tensor::is_struct_val_Valid() const{
    return m_struct_val_isValid;
}

QByteArray OAIGoogleCloudAiplatformV1Tensor::getTensorVal() const {
    return m_tensor_val;
}
void OAIGoogleCloudAiplatformV1Tensor::setTensorVal(const QByteArray &tensor_val) {
    m_tensor_val = tensor_val;
    m_tensor_val_isSet = true;
}

bool OAIGoogleCloudAiplatformV1Tensor::is_tensor_val_Set() const{
    return m_tensor_val_isSet;
}

bool OAIGoogleCloudAiplatformV1Tensor::is_tensor_val_Valid() const{
    return m_tensor_val_isValid;
}

QList<QString> OAIGoogleCloudAiplatformV1Tensor::getUint64Val() const {
    return m_uint64_val;
}
void OAIGoogleCloudAiplatformV1Tensor::setUint64Val(const QList<QString> &uint64_val) {
    m_uint64_val = uint64_val;
    m_uint64_val_isSet = true;
}

bool OAIGoogleCloudAiplatformV1Tensor::is_uint64_val_Set() const{
    return m_uint64_val_isSet;
}

bool OAIGoogleCloudAiplatformV1Tensor::is_uint64_val_Valid() const{
    return m_uint64_val_isValid;
}

QList<qint32> OAIGoogleCloudAiplatformV1Tensor::getUintVal() const {
    return m_uint_val;
}
void OAIGoogleCloudAiplatformV1Tensor::setUintVal(const QList<qint32> &uint_val) {
    m_uint_val = uint_val;
    m_uint_val_isSet = true;
}

bool OAIGoogleCloudAiplatformV1Tensor::is_uint_val_Set() const{
    return m_uint_val_isSet;
}

bool OAIGoogleCloudAiplatformV1Tensor::is_uint_val_Valid() const{
    return m_uint_val_isValid;
}

bool OAIGoogleCloudAiplatformV1Tensor::isSet() const {
...
bool OAIGoogleCloudAiplatformV1Tensor::isValid() const {
