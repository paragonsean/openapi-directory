...
OAIGoogleCloudAiplatformV1Attribution::OAIGoogleCloudAiplatformV1Attribution(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGoogleCloudAiplatformV1Attribution::OAIGoogleCloudAiplatformV1Attribution() {
    this->initializeModel();
}

OAIGoogleCloudAiplatformV1Attribution::~OAIGoogleCloudAiplatformV1Attribution() {}

void OAIGoogleCloudAiplatformV1Attribution::initializeModel() {
...
void OAIGoogleCloudAiplatformV1Attribution::fromJson(QString jsonString) {
...
void OAIGoogleCloudAiplatformV1Attribution::fromJsonObject(QJsonObject json) {
...
QString OAIGoogleCloudAiplatformV1Attribution::asJson() const {
...
QJsonObject OAIGoogleCloudAiplatformV1Attribution::asJsonObject() const {
    QJsonObject obj;
...
double OAIGoogleCloudAiplatformV1Attribution::getApproximationError() const {
    return m_approximation_error;
}
void OAIGoogleCloudAiplatformV1Attribution::setApproximationError(const double &approximation_error) {
    m_approximation_error = approximation_error;
    m_approximation_error_isSet = true;
}

bool OAIGoogleCloudAiplatformV1Attribution::is_approximation_error_Set() const{
    return m_approximation_error_isSet;
}

bool OAIGoogleCloudAiplatformV1Attribution::is_approximation_error_Valid() const{
    return m_approximation_error_isValid;
}

double OAIGoogleCloudAiplatformV1Attribution::getBaselineOutputValue() const {
    return m_baseline_output_value;
}
void OAIGoogleCloudAiplatformV1Attribution::setBaselineOutputValue(const double &baseline_output_value) {
    m_baseline_output_value = baseline_output_value;
    m_baseline_output_value_isSet = true;
}

bool OAIGoogleCloudAiplatformV1Attribution::is_baseline_output_value_Set() const{
    return m_baseline_output_value_isSet;
}

bool OAIGoogleCloudAiplatformV1Attribution::is_baseline_output_value_Valid() const{
    return m_baseline_output_value_isValid;
}

QJsonValue OAIGoogleCloudAiplatformV1Attribution::getFeatureAttributions() const {
    return m_feature_attributions;
}
void OAIGoogleCloudAiplatformV1Attribution::setFeatureAttributions(const QJsonValue &feature_attributions) {
    m_feature_attributions = feature_attributions;
    m_feature_attributions_isSet = true;
}

bool OAIGoogleCloudAiplatformV1Attribution::is_feature_attributions_Set() const{
    return m_feature_attributions_isSet;
}

bool OAIGoogleCloudAiplatformV1Attribution::is_feature_attributions_Valid() const{
    return m_feature_attributions_isValid;
}

double OAIGoogleCloudAiplatformV1Attribution::getInstanceOutputValue() const {
    return m_instance_output_value;
}
void OAIGoogleCloudAiplatformV1Attribution::setInstanceOutputValue(const double &instance_output_value) {
    m_instance_output_value = instance_output_value;
    m_instance_output_value_isSet = true;
}

bool OAIGoogleCloudAiplatformV1Attribution::is_instance_output_value_Set() const{
    return m_instance_output_value_isSet;
}

bool OAIGoogleCloudAiplatformV1Attribution::is_instance_output_value_Valid() const{
    return m_instance_output_value_isValid;
}

QString OAIGoogleCloudAiplatformV1Attribution::getOutputDisplayName() const {
    return m_output_display_name;
}
void OAIGoogleCloudAiplatformV1Attribution::setOutputDisplayName(const QString &output_display_name) {
    m_output_display_name = output_display_name;
    m_output_display_name_isSet = true;
}

bool OAIGoogleCloudAiplatformV1Attribution::is_output_display_name_Set() const{
    return m_output_display_name_isSet;
}

bool OAIGoogleCloudAiplatformV1Attribution::is_output_display_name_Valid() const{
    return m_output_display_name_isValid;
}

QList<qint32> OAIGoogleCloudAiplatformV1Attribution::getOutputIndex() const {
    return m_output_index;
}
void OAIGoogleCloudAiplatformV1Attribution::setOutputIndex(const QList<qint32> &output_index) {
    m_output_index = output_index;
    m_output_index_isSet = true;
}

bool OAIGoogleCloudAiplatformV1Attribution::is_output_index_Set() const{
    return m_output_index_isSet;
}

bool OAIGoogleCloudAiplatformV1Attribution::is_output_index_Valid() const{
    return m_output_index_isValid;
}

QString OAIGoogleCloudAiplatformV1Attribution::getOutputName() const {
    return m_output_name;
}
void OAIGoogleCloudAiplatformV1Attribution::setOutputName(const QString &output_name) {
    m_output_name = output_name;
    m_output_name_isSet = true;
}

bool OAIGoogleCloudAiplatformV1Attribution::is_output_name_Set() const{
    return m_output_name_isSet;
}

bool OAIGoogleCloudAiplatformV1Attribution::is_output_name_Valid() const{
    return m_output_name_isValid;
}

bool OAIGoogleCloudAiplatformV1Attribution::isSet() const {
...
bool OAIGoogleCloudAiplatformV1Attribution::isValid() const {
