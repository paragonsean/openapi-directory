...
OAIPublishersApi::OAIPublishersApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIPublishersApi::~OAIPublishersApi() {
}

void OAIPublishersApi::initializeServerConfigs() {
    //Default server
    QList<OAIServerConfiguration> defaultConf = QList<OAIServerConfiguration>();
    //varying endpoint server
    defaultConf.append(OAIServerConfiguration(
    QUrl("https://aiplatform.googleapis.com/"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("aiplatform_publishers_models_get", defaultConf);
    _serverIndices.insert("aiplatform_publishers_models_get", 0);
}
...
*/
int OAIPublishersApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIPublishersApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIPublishersApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIPublishersApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIPublishersApi::setUsername(const QString &username) {
    _username = username;
}

void OAIPublishersApi::setPassword(const QString &password) {
    _password = password;
}


void OAIPublishersApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIPublishersApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIPublishersApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIPublishersApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIPublishersApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIPublishersApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIPublishersApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIPublishersApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIPublishersApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIPublishersApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIPublishersApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIPublishersApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIPublishersApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIPublishersApi::aiplatform_publishers_models_get(const QString &name, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<QString> &language_code, const ::OpenAPI::OptionalParam<QString> &view) {
    QString fullPath = QString(_serverConfigs["aiplatform_publishers_models_get"][_serverIndices.value("aiplatform_publishers_models_get")].URL()+"/v1/{name}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIPublishersApi::aiplatform_publishers_models_getCallback);
    connect(this, &OAIPublishersApi::abortRequestsSignal, worker, &QObject::deleteLater);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIPublishersApi::aiplatform_publishers_models_getCallback);
    connect(this, &OAIPublishersApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
...
void OAIPublishersApi::aiplatform_publishers_models_getCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIGoogleCloudAiplatformV1PublisherModel output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT aiplatform_publishers_models_getSignal(output);
        Q_EMIT aiplatform_publishers_models_getSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT aiplatform_publishers_models_getSignalE(output, error_type, error_str);
        Q_EMIT aiplatform_publishers_models_getSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT aiplatform_publishers_models_getSignalError(output, error_type, error_str);
        Q_EMIT aiplatform_publishers_models_getSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIPublishersApi::tokenAvailable(){
