...
/*
 * OAIGoogleCloudAiplatformV1ImportDataConfig.h
 *
 * Describes the location from where we import data into a Dataset, together with the labels that will be applied to the DataItems and the Annotations.
 */

#ifndef OAIGoogleCloudAiplatformV1ImportDataConfig_H
#define OAIGoogleCloudAiplatformV1ImportDataConfig_H
...
class OAIGoogleCloudAiplatformV1ImportDataConfig : public OAIObject {
public:
    OAIGoogleCloudAiplatformV1ImportDataConfig();
    OAIGoogleCloudAiplatformV1ImportDataConfig(QString json);
    ~OAIGoogleCloudAiplatformV1ImportDataConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudAiplatformV1ImportDataConfig)

#endif // OAIGoogleCloudAiplatformV1ImportDataConfig_H
