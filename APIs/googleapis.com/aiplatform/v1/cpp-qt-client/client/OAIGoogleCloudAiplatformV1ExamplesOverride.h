...
/*
 * OAIGoogleCloudAiplatformV1ExamplesOverride.h
 *
 * Overrides for example-based explanations.
 */

#ifndef OAIGoogleCloudAiplatformV1ExamplesOverride_H
#define OAIGoogleCloudAiplatformV1ExamplesOverride_H

#include <QJsonObject>

#include "OAIGoogleCloudAiplatformV1ExamplesRestrictionsNamespace.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAIGoogleCloudAiplatformV1ExamplesRestrictionsNamespace;

class OAIGoogleCloudAiplatformV1ExamplesOverride : public OAIObject {
public:
    OAIGoogleCloudAiplatformV1ExamplesOverride();
    OAIGoogleCloudAiplatformV1ExamplesOverride(QString json);
    ~OAIGoogleCloudAiplatformV1ExamplesOverride() override;
    ...
    QList<OAIGoogleCloudAiplatformV1ExamplesRestrictionsNamespace> getRestrictions() const;
    void setRestrictions(const QList<OAIGoogleCloudAiplatformV1ExamplesRestrictionsNamespace> &restrictions);
...
private:
    ...
    QList<OAIGoogleCloudAiplatformV1ExamplesRestrictionsNamespace> m_restrictions;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudAiplatformV1ExamplesOverride)

#endif // OAIGoogleCloudAiplatformV1ExamplesOverride_H
