...
OAIGoogleCloudAiplatformV1MachineSpec::OAIGoogleCloudAiplatformV1MachineSpec(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGoogleCloudAiplatformV1MachineSpec::OAIGoogleCloudAiplatformV1MachineSpec() {
    this->initializeModel();
}

OAIGoogleCloudAiplatformV1MachineSpec::~OAIGoogleCloudAiplatformV1MachineSpec() {}

void OAIGoogleCloudAiplatformV1MachineSpec::initializeModel() {
...
void OAIGoogleCloudAiplatformV1MachineSpec::fromJson(QString jsonString) {
...
void OAIGoogleCloudAiplatformV1MachineSpec::fromJsonObject(QJsonObject json) {
...
QString OAIGoogleCloudAiplatformV1MachineSpec::asJson() const {
...
QJsonObject OAIGoogleCloudAiplatformV1MachineSpec::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIGoogleCloudAiplatformV1MachineSpec::getAcceleratorCount() const {
    return m_accelerator_count;
}
void OAIGoogleCloudAiplatformV1MachineSpec::setAcceleratorCount(const qint32 &accelerator_count) {
    m_accelerator_count = accelerator_count;
    m_accelerator_count_isSet = true;
}

bool OAIGoogleCloudAiplatformV1MachineSpec::is_accelerator_count_Set() const{
    return m_accelerator_count_isSet;
}

bool OAIGoogleCloudAiplatformV1MachineSpec::is_accelerator_count_Valid() const{
    return m_accelerator_count_isValid;
}

QString OAIGoogleCloudAiplatformV1MachineSpec::getAcceleratorType() const {
    return m_accelerator_type;
}
void OAIGoogleCloudAiplatformV1MachineSpec::setAcceleratorType(const QString &accelerator_type) {
    m_accelerator_type = accelerator_type;
    m_accelerator_type_isSet = true;
}

bool OAIGoogleCloudAiplatformV1MachineSpec::is_accelerator_type_Set() const{
    return m_accelerator_type_isSet;
}

bool OAIGoogleCloudAiplatformV1MachineSpec::is_accelerator_type_Valid() const{
    return m_accelerator_type_isValid;
}

QString OAIGoogleCloudAiplatformV1MachineSpec::getMachineType() const {
    return m_machine_type;
}
void OAIGoogleCloudAiplatformV1MachineSpec::setMachineType(const QString &machine_type) {
    m_machine_type = machine_type;
    m_machine_type_isSet = true;
}

bool OAIGoogleCloudAiplatformV1MachineSpec::is_machine_type_Set() const{
    return m_machine_type_isSet;
}

bool OAIGoogleCloudAiplatformV1MachineSpec::is_machine_type_Valid() const{
    return m_machine_type_isValid;
}

QString OAIGoogleCloudAiplatformV1MachineSpec::getTpuTopology() const {
    return m_tpu_topology;
}
void OAIGoogleCloudAiplatformV1MachineSpec::setTpuTopology(const QString &tpu_topology) {
    m_tpu_topology = tpu_topology;
    m_tpu_topology_isSet = true;
}

bool OAIGoogleCloudAiplatformV1MachineSpec::is_tpu_topology_Set() const{
    return m_tpu_topology_isSet;
}

bool OAIGoogleCloudAiplatformV1MachineSpec::is_tpu_topology_Valid() const{
    return m_tpu_topology_isValid;
}

bool OAIGoogleCloudAiplatformV1MachineSpec::isSet() const {
...
bool OAIGoogleCloudAiplatformV1MachineSpec::isValid() const {
