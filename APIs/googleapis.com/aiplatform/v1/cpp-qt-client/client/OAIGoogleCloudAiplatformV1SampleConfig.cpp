...
OAIGoogleCloudAiplatformV1SampleConfig::OAIGoogleCloudAiplatformV1SampleConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGoogleCloudAiplatformV1SampleConfig::OAIGoogleCloudAiplatformV1SampleConfig() {
    this->initializeModel();
}

OAIGoogleCloudAiplatformV1SampleConfig::~OAIGoogleCloudAiplatformV1SampleConfig() {}

void OAIGoogleCloudAiplatformV1SampleConfig::initializeModel() {
...
void OAIGoogleCloudAiplatformV1SampleConfig::fromJson(QString jsonString) {
...
void OAIGoogleCloudAiplatformV1SampleConfig::fromJsonObject(QJsonObject json) {
...
QString OAIGoogleCloudAiplatformV1SampleConfig::asJson() const {
...
QJsonObject OAIGoogleCloudAiplatformV1SampleConfig::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIGoogleCloudAiplatformV1SampleConfig::getFollowingBatchSamplePercentage() const {
    return m_following_batch_sample_percentage;
}
void OAIGoogleCloudAiplatformV1SampleConfig::setFollowingBatchSamplePercentage(const qint32 &following_batch_sample_percentage) {
    m_following_batch_sample_percentage = following_batch_sample_percentage;
    m_following_batch_sample_percentage_isSet = true;
}

bool OAIGoogleCloudAiplatformV1SampleConfig::is_following_batch_sample_percentage_Set() const{
    return m_following_batch_sample_percentage_isSet;
}

bool OAIGoogleCloudAiplatformV1SampleConfig::is_following_batch_sample_percentage_Valid() const{
    return m_following_batch_sample_percentage_isValid;
}

qint32 OAIGoogleCloudAiplatformV1SampleConfig::getInitialBatchSamplePercentage() const {
    return m_initial_batch_sample_percentage;
}
void OAIGoogleCloudAiplatformV1SampleConfig::setInitialBatchSamplePercentage(const qint32 &initial_batch_sample_percentage) {
    m_initial_batch_sample_percentage = initial_batch_sample_percentage;
    m_initial_batch_sample_percentage_isSet = true;
}

bool OAIGoogleCloudAiplatformV1SampleConfig::is_initial_batch_sample_percentage_Set() const{
    return m_initial_batch_sample_percentage_isSet;
}

bool OAIGoogleCloudAiplatformV1SampleConfig::is_initial_batch_sample_percentage_Valid() const{
    return m_initial_batch_sample_percentage_isValid;
}

QString OAIGoogleCloudAiplatformV1SampleConfig::getSampleStrategy() const {
    return m_sample_strategy;
}
void OAIGoogleCloudAiplatformV1SampleConfig::setSampleStrategy(const QString &sample_strategy) {
    m_sample_strategy = sample_strategy;
    m_sample_strategy_isSet = true;
}

bool OAIGoogleCloudAiplatformV1SampleConfig::is_sample_strategy_Set() const{
    return m_sample_strategy_isSet;
}

bool OAIGoogleCloudAiplatformV1SampleConfig::is_sample_strategy_Valid() const{
    return m_sample_strategy_isValid;
}

bool OAIGoogleCloudAiplatformV1SampleConfig::isSet() const {
...
bool OAIGoogleCloudAiplatformV1SampleConfig::isValid() const {
