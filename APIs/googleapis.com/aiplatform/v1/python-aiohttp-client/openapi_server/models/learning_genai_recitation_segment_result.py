...
class LearningGenaiRecitationSegmentResult(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, attribution_dataset: str=None, display_attribution_message: str=None, doc_attribution: LearningGenaiRecitationDocAttribution=None, doc_occurrences: int=None, end_index: int=None, raw_text: str=None, segment_recitation_action: str=None, start_index: int=None):
        """LearningGenaiRecitationSegmentResult - a model defined in OpenAPI

        :param attribution_dataset: The attribution_dataset of this LearningGenaiRecitationSegmentResult.
        :param display_attribution_message: The display_attribution_message of this LearningGenaiRecitationSegmentResult.
        :param doc_attribution: The doc_attribution of this LearningGenaiRecitationSegmentResult.
        :param doc_occurrences: The doc_occurrences of this LearningGenaiRecitationSegmentResult.
        :param end_index: The end_index of this LearningGenaiRecitationSegmentResult.
        :param raw_text: The raw_text of this LearningGenaiRecitationSegmentResult.
        :param segment_recitation_action: The segment_recitation_action of this LearningGenaiRecitationSegmentResult.
        :param start_index: The start_index of this LearningGenaiRecitationSegmentResult.
        """
        self.openapi_types = {
            'attribution_dataset': str,
            'display_attribution_message': str,
            'doc_attribution': LearningGenaiRecitationDocAttribution,
            'doc_occurrences': int,
            'end_index': int,
            'raw_text': str,
            'segment_recitation_action': str,
            'start_index': int
        }

        self.attribute_map = {
            'attribution_dataset': 'attributionDataset',
            'display_attribution_message': 'displayAttributionMessage',
            'doc_attribution': 'docAttribution',
            'doc_occurrences': 'docOccurrences',
            'end_index': 'endIndex',
            'raw_text': 'rawText',
            'segment_recitation_action': 'segmentRecitationAction',
            'start_index': 'startIndex'
        }

        self._attribution_dataset = attribution_dataset
        self._display_attribution_message = display_attribution_message
        self._doc_attribution = doc_attribution
        self._doc_occurrences = doc_occurrences
        self._end_index = end_index
        self._raw_text = raw_text
        self._segment_recitation_action = segment_recitation_action
        self._start_index = start_index

    @classmethod
    def from_dict(cls, dikt: dict) -> 'LearningGenaiRecitationSegmentResult':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The LearningGenaiRecitationSegmentResult of this LearningGenaiRecitationSegmentResult.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def attribution_dataset(self):
        """Gets the attribution_dataset of this LearningGenaiRecitationSegmentResult.

        The dataset the segment came from.

        :return: The attribution_dataset of this LearningGenaiRecitationSegmentResult.
        :rtype: str
        """
        return self._attribution_dataset

    @attribution_dataset.setter
    def attribution_dataset(self, attribution_dataset):
        """Sets the attribution_dataset of this LearningGenaiRecitationSegmentResult.

        The dataset the segment came from.

        :param attribution_dataset: The attribution_dataset of this LearningGenaiRecitationSegmentResult.
        :type attribution_dataset: str
        """
        ...
        if attribution_dataset not in allowed_values:
            raise ValueError(
                "Invalid value for `attribution_dataset` ({0}), must be one of {1}"
                .format(attribution_dataset, allowed_values)
            )

        self._attribution_dataset = attribution_dataset

    @property
    def display_attribution_message(self):
        """Gets the display_attribution_message of this LearningGenaiRecitationSegmentResult.

        human-friendly string that contains information from doc_attribution which could be shown by clients

        :return: The display_attribution_message of this LearningGenaiRecitationSegmentResult.
        :rtype: str
        """
        return self._display_attribution_message

    @display_attribution_message.setter
    def display_attribution_message(self, display_attribution_message):
        """Sets the display_attribution_message of this LearningGenaiRecitationSegmentResult.

        human-friendly string that contains information from doc_attribution which could be shown by clients

        :param display_attribution_message: The display_attribution_message of this LearningGenaiRecitationSegmentResult.
        :type display_attribution_message: str
        """

        self._display_attribution_message = display_attribution_message

    @property
    def doc_attribution(self):
        """Gets the doc_attribution of this LearningGenaiRecitationSegmentResult.


        :return: The doc_attribution of this LearningGenaiRecitationSegmentResult.
        :rtype: LearningGenaiRecitationDocAttribution
        """
        return self._doc_attribution

    @doc_attribution.setter
    def doc_attribution(self, doc_attribution):
        """Sets the doc_attribution of this LearningGenaiRecitationSegmentResult.


        :param doc_attribution: The doc_attribution of this LearningGenaiRecitationSegmentResult.
        :type doc_attribution: LearningGenaiRecitationDocAttribution
        """

        self._doc_attribution = doc_attribution

    @property
    def doc_occurrences(self):
        """Gets the doc_occurrences of this LearningGenaiRecitationSegmentResult.

        number of documents that contained this segment

        :return: The doc_occurrences of this LearningGenaiRecitationSegmentResult.
        :rtype: int
        """
        return self._doc_occurrences

    @doc_occurrences.setter
    def doc_occurrences(self, doc_occurrences):
        """Sets the doc_occurrences of this LearningGenaiRecitationSegmentResult.

        number of documents that contained this segment

        :param doc_occurrences: The doc_occurrences of this LearningGenaiRecitationSegmentResult.
        :type doc_occurrences: int
        """
    ...
    @property
    def end_index(self):
        """Gets the end_index of this LearningGenaiRecitationSegmentResult.


        :return: The end_index of this LearningGenaiRecitationSegmentResult.
        :rtype: int
        """
    ...
    def end_index(self, end_index):
        """Sets the end_index of this LearningGenaiRecitationSegmentResult.
    ...
    @property
    def raw_text(self):
        """Gets the raw_text of this LearningGenaiRecitationSegmentResult.
        ...
        :return: The raw_text of this LearningGenaiRecitationSegmentResult.
        :rtype: str
        """
    ...
    def raw_text(self, raw_text):
        """Sets the raw_text of this LearningGenaiRecitationSegmentResult.
    ...
    @property
    def segment_recitation_action(self):
        """Gets the segment_recitation_action of this LearningGenaiRecitationSegmentResult.


        :return: The segment_recitation_action of this LearningGenaiRecitationSegmentResult.
        :rtype: str
        """
        return self._segment_recitation_action

    @segment_recitation_action.setter
    def segment_recitation_action(self, segment_recitation_action):
        """Sets the segment_recitation_action of this LearningGenaiRecitationSegmentResult.


        :param segment_recitation_action: The segment_recitation_action of this LearningGenaiRecitationSegmentResult.
        :type segment_recitation_action: str
        """
        allowed_values = ["ACTION_UNSPECIFIED", "CITE", "BLOCK", "NO_ACTION", "EXEMPT_FOUND_IN_PROMPT"]  # noqa: E501
        if segment_recitation_action not in allowed_values:
            raise ValueError(
                "Invalid value for `segment_recitation_action` ({0}), must be one of {1}"
                .format(segment_recitation_action, allowed_values)
            )
    ...
    def start_index(self):
        """Gets the start_index of this LearningGenaiRecitationSegmentResult.
        ...
        :return: The start_index of this LearningGenaiRecitationSegmentResult.
        :rtype: int
        """
    ...
    def start_index(self, start_index):
        """Sets the start_index of this LearningGenaiRecitationSegmentResult.
