...
async def test_aiplatform_projects_locations_batch_prediction_jobs_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/batchPredictionJobs'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_custom_jobs_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/customJobs'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_data_labeling_jobs_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/dataLabelingJobs'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_datasets_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/datasets'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_datasets_data_items_annotations_list(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/{parent}/annotations'.format(parent='parent_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_aiplatform_projects_locations_datasets_data_items_list(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/{parent}/dataItems'.format(parent='parent_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_aiplatform_projects_locations_datasets_dataset_versions_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/datasetVersions'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_datasets_dataset_versions_restore(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/{namerestor}'.format(name='name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_aiplatform_projects_locations_datasets_saved_queries_list(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/{parent}/savedQueries'.format(parent='parent_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_aiplatform_projects_locations_datasets_search_data_items(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/{datasetsearch_data_item}'.format(dataset='dataset_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_aiplatform_projects_locations_deployment_resource_pools_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/deploymentResourcePools'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_deployment_resource_pools_query_deployed_models(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/{deployment_resource_poolquery_deployed_model}'.format(deployment_resource_pool='deployment_resource_pool_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_aiplatform_projects_locations_endpoints_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/endpoints'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_endpoints_deploy_model(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{endpointdeploy_mode}'.format(endpoint='endpoint_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_endpoints_direct_predict(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{endpointdirect_predic}'.format(endpoint='endpoint_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_endpoints_direct_raw_predict(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{endpointdirect_raw_predic}'.format(endpoint='endpoint_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_endpoints_explain(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{endpointexplai}'.format(endpoint='endpoint_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_endpoints_mutate_deployed_model(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{endpointmutate_deployed_mode}'.format(endpoint='endpoint_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_endpoints_undeploy_model(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{endpointundeploy_mode}'.format(endpoint='endpoint_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_feature_groups_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/featureGroups'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_feature_online_stores_create(client):
    ...
    """
    body = {"createTime":"createTime","name":"name","bigtable":{"autoScaling":{"minNodeCount":1,"maxNodeCount":6,"cpuUtilizationTarget":0}},"etag":"etag","updateTime":"updateTime","state":"STATE_UNSPECIFIED","labels":{"key":"labels"}}
    params = [('$.xgafv', 'xgafv_example'),
                    ('access_token', 'access_token_example'),
                    ('alt', 'alt_example'),
                    ('callback', 'param_callback_example'),
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/featureOnlineStores'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_feature_online_stores_feature_views_create(client):
    ...
    """
    body = {"featureRegistrySource":{"featureGroups":[{"featureGroupId":"featureGroupId","featureIds":["featureIds","featureIds"]},{"featureGroupId":"featureGroupId","featureIds":["featureIds","featureIds"]}],"projectNumber":"projectNumber"},"createTime":"createTime","name":"name","syncConfig":{"cron":"cron"},"etag":"etag","updateTime":"updateTime","bigQuerySource":{"entityIdColumns":["entityIdColumns","entityIdColumns"],"uri":"uri"},"labels":{"key":"labels"}}
    params = [('$.xgafv', 'xgafv_example'),
                    ('access_token', 'access_token_example'),
                    ('alt', 'alt_example'),
                    ('callback', 'param_callback_example'),
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/featureViews'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_feature_online_stores_feature_views_feature_view_syncs_list(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/{parent}/featureViewSyncs'.format(parent='parent_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_aiplatform_projects_locations_feature_online_stores_feature_views_fetch_feature_values(client):
    ...
    """
    body = {"dataKey":{"compositeKey":{"parts":["parts","parts"]},"key":"key"},"dataFormat":"FEATURE_VIEW_DATA_FORMAT_UNSPECIFIED"}
    params = [('$.xgafv', 'xgafv_example'),
                    ('access_token', 'access_token_example'),
                    ('alt', 'alt_example'),
                    ('callback', 'param_callback_example'),
    ...
    response = await client.request(
        method='POST',
        path='/v1/{feature_viewfetch_feature_value}'.format(feature_view='feature_view_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_feature_online_stores_feature_views_search_nearest_entities(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{feature_viewsearch_nearest_entitie}'.format(feature_view='feature_view_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_feature_online_stores_feature_views_sync(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{feature_viewsyn}'.format(feature_view='feature_view_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_feature_online_stores_operations_list_wait(client):
...
async def test_aiplatform_projects_locations_featurestores_batch_read_feature_values(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{featurestorebatch_read_feature_value}'.format(featurestore='featurestore_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_featurestores_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/featurestores'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_featurestores_entity_types_create(client):
    ...
    """
    body = {"monitoringConfig":{"categoricalThresholdConfig":{"value":0.8008281904610115},"importFeaturesAnalysis":{"anomalyDetectionBaseline":"BASELINE_UNSPECIFIED","state":"STATE_UNSPECIFIED"},"snapshotAnalysis":{"stalenessDays":1,"disabled":True,"monitoringIntervalDays":6},"numericalThresholdConfig":{"value":0.8008281904610115}},"offlineStorageTtlDays":5,"createTime":"createTime","name":"name","description":"description","etag":"etag","updateTime":"updateTime","labels":{"key":"labels"}}
    params = [('$.xgafv', 'xgafv_example'),
                    ('access_token', 'access_token_example'),
                    ('alt', 'alt_example'),
                    ('callback', 'param_callback_example'),
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/entityTypes'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_featurestores_entity_types_delete_feature_values(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{entity_typedelete_feature_value}'.format(entity_type='entity_type_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_featurestores_entity_types_export_feature_values(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{entity_typeexport_feature_value}'.format(entity_type='entity_type_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_featurestores_entity_types_features_batch_create(client):
    ...
    """
    body = {"requests":[{"parent":"parent","feature":{"versionColumnName":"versionColumnName","disableMonitoring":True,"createTime":"createTime","valueType":"VALUE_TYPE_UNSPECIFIED","name":"name","description":"description","etag":"etag","monitoringStatsAnomalies":[{"featureStatsAnomaly":{"anomalyDetectionThreshold":0.8008281904610115,"score":1.4658129805029452,"statsUri":"statsUri","distributionDeviation":6.027456183070403,"startTime":"startTime","endTime":"endTime","anomalyUri":"anomalyUri"},"objective":"OBJECTIVE_UNSPECIFIED"},{"featureStatsAnomaly":{"anomalyDetectionThreshold":0.8008281904610115,"score":1.4658129805029452,"statsUri":"statsUri","distributionDeviation":6.027456183070403,"startTime":"startTime","endTime":"endTime","anomalyUri":"anomalyUri"},"objective":"OBJECTIVE_UNSPECIFIED"}],"updateTime":"updateTime","labels":{"key":"labels"},"pointOfContact":"pointOfContact"},"featureId":"featureId"},{"parent":"parent","feature":{"versionColumnName":"versionColumnName","disableMonitoring":True,"createTime":"createTime","valueType":"VALUE_TYPE_UNSPECIFIED","name":"name","description":"description","etag":"etag","monitoringStatsAnomalies":[{"featureStatsAnomaly":{"anomalyDetectionThreshold":0.8008281904610115,"score":1.4658129805029452,"statsUri":"statsUri","distributionDeviation":6.027456183070403,"startTime":"startTime","endTime":"endTime","anomalyUri":"anomalyUri"},"objective":"OBJECTIVE_UNSPECIFIED"},{"featureStatsAnomaly":{"anomalyDetectionThreshold":0.8008281904610115,"score":1.4658129805029452,"statsUri":"statsUri","distributionDeviation":6.027456183070403,"startTime":"startTime","endTime":"endTime","anomalyUri":"anomalyUri"},"objective":"OBJECTIVE_UNSPECIFIED"}],"updateTime":"updateTime","labels":{"key":"labels"},"pointOfContact":"pointOfContact"},"featureId":"featureId"}]}
    params = [('$.xgafv', 'xgafv_example'),
                    ('access_token', 'access_token_example'),
                    ('alt', 'alt_example'),
                    ('callback', 'param_callback_example'),
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/features:batchCreate'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_featurestores_entity_types_features_create(client):
    ...
    """
    body = {"versionColumnName":"versionColumnName","disableMonitoring":True,"createTime":"createTime","valueType":"VALUE_TYPE_UNSPECIFIED","name":"name","description":"description","etag":"etag","monitoringStatsAnomalies":[{"featureStatsAnomaly":{"anomalyDetectionThreshold":0.8008281904610115,"score":1.4658129805029452,"statsUri":"statsUri","distributionDeviation":6.027456183070403,"startTime":"startTime","endTime":"endTime","anomalyUri":"anomalyUri"},"objective":"OBJECTIVE_UNSPECIFIED"},{"featureStatsAnomaly":{"anomalyDetectionThreshold":0.8008281904610115,"score":1.4658129805029452,"statsUri":"statsUri","distributionDeviation":6.027456183070403,"startTime":"startTime","endTime":"endTime","anomalyUri":"anomalyUri"},"objective":"OBJECTIVE_UNSPECIFIED"}],"updateTime":"updateTime","labels":{"key":"labels"},"pointOfContact":"pointOfContact"}
    params = [('$.xgafv', 'xgafv_example'),
                    ('access_token', 'access_token_example'),
                    ('alt', 'alt_example'),
                    ('callback', 'param_callback_example'),
...
async def test_aiplatform_projects_locations_featurestores_entity_types_import_feature_values(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{entity_typeimport_feature_value}'.format(entity_type='entity_type_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_featurestores_entity_types_read_feature_values(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{entity_typeread_feature_value}'.format(entity_type='entity_type_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_featurestores_entity_types_streaming_read_feature_values(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{entity_typestreaming_read_feature_value}'.format(entity_type='entity_type_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_featurestores_entity_types_write_feature_values(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{entity_typewrite_feature_value}'.format(entity_type='entity_type_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_featurestores_search_features(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/{location}/featurestores:searchFeatures'.format(location='location_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_aiplatform_projects_locations_hyperparameter_tuning_jobs_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/hyperparameterTuningJobs'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_index_endpoints_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/indexEndpoints'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_index_endpoints_deploy_index(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{index_endpointdeploy_inde}'.format(index_endpoint='index_endpoint_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_index_endpoints_find_neighbors(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{index_endpointfind_neighbor}'.format(index_endpoint='index_endpoint_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_index_endpoints_mutate_deployed_index(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{index_endpointmutate_deployed_inde}'.format(index_endpoint='index_endpoint_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_index_endpoints_read_index_datapoints(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{index_endpointread_index_datapoint}'.format(index_endpoint='index_endpoint_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_index_endpoints_undeploy_index(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{index_endpointundeploy_inde}'.format(index_endpoint='index_endpoint_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_indexes_remove_datapoints(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{indexremove_datapoint}'.format(index='index_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_indexes_upsert_datapoints(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{indexupsert_datapoint}'.format(index='index_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_metadata_stores_artifacts_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/artifacts'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_metadata_stores_artifacts_purge(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/artifacts:purge'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_metadata_stores_artifacts_query_artifact_lineage_subgraph(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/{artifactquery_artifact_lineage_subgrap}'.format(artifact='artifact_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_aiplatform_projects_locations_metadata_stores_contexts_add_context_artifacts_and_executions(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{contextadd_context_artifacts_and_execution}'.format(context='context_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_metadata_stores_contexts_add_context_children(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{contextadd_context_childre}'.format(context='context_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_metadata_stores_contexts_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/contexts'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_metadata_stores_contexts_purge(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/contexts:purge'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_metadata_stores_contexts_query_context_lineage_subgraph(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/{contextquery_context_lineage_subgrap}'.format(context='context_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_aiplatform_projects_locations_metadata_stores_contexts_remove_context_children(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{contextremove_context_childre}'.format(context='context_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_metadata_stores_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/metadataStores'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_metadata_stores_executions_add_execution_events(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{executionadd_execution_event}'.format(execution='execution_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_metadata_stores_executions_purge(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/executions:purge'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_metadata_stores_executions_query_execution_inputs_and_outputs(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/{executionquery_execution_inputs_and_output}'.format(execution='execution_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_aiplatform_projects_locations_metadata_stores_metadata_schemas_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/metadataSchemas'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_migratable_resources_batch_migrate(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/migratableResources:batchMigrate'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_migratable_resources_search(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/migratableResources:search'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_model_deployment_monitoring_jobs_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/modelDeploymentMonitoringJobs'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_model_deployment_monitoring_jobs_search_model_deployment_monitoring_stats_anomalies(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{model_deployment_monitoring_jobsearch_model_deployment_monitoring_stats_anomalie}'.format(model_deployment_monitoring_job='model_deployment_monitoring_job_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_models_copy(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/models:copy'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_models_delete_version(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/v1/{namedelete_versio}'.format(name='name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_aiplatform_projects_locations_models_evaluations_import(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/evaluations:import'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_models_evaluations_slices_batch_import(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parentbatch_impor}'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_models_evaluations_slices_list(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/{parent}/slices'.format(parent='parent_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_aiplatform_projects_locations_models_list(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/{parent}/models'.format(parent='parent_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_aiplatform_projects_locations_models_list_versions(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/{namelist_version}'.format(name='name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_aiplatform_projects_locations_models_merge_version_aliases(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{namemerge_version_aliase}'.format(name='name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_models_update_explanation_dataset(client):
    ...
    """
    body = {"examples":{"neighborCount":1,"presets":{"modality":"MODALITY_UNSPECIFIED","query":"PRECISE"},"nearestNeighborSearchConfig":"","exampleGcsSource":{"dataFormat":"DATA_FORMAT_UNSPECIFIED","gcsSource":{"uris":["uris","uris"]}}}}
    params = [('$.xgafv', 'xgafv_example'),
                    ('access_token', 'access_token_example'),
                    ('alt', 'alt_example'),
                    ('callback', 'param_callback_example'),
    ...
    response = await client.request(
        method='POST',
        path='/v1/{modelupdate_explanation_datase}'.format(model='model_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_models_upload(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/models:upload'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_nas_jobs_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/nasJobs'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_nas_jobs_nas_trial_details_list(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/{parent}/nasTrialDetails'.format(parent='parent_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_aiplatform_projects_locations_notebook_runtime_templates_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/notebookRuntimeTemplates'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_notebook_runtime_templates_get_iam_policy(client):
...
async def test_aiplatform_projects_locations_notebook_runtimes_assign(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/notebookRuntimes:assign'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_notebook_runtimes_list(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/{parent}/notebookRuntimes'.format(parent='parent_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_aiplatform_projects_locations_pipeline_jobs_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/pipelineJobs'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_publishers_models_compute_tokens(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{endpointcompute_token}'.format(endpoint='endpoint_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_publishers_models_count_tokens(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{endpointcount_token}'.format(endpoint='endpoint_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_publishers_models_generate_content(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{modelgenerate_conten}'.format(model='model_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_publishers_models_predict(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{endpointpredic}'.format(endpoint='endpoint_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_publishers_models_raw_predict(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{endpointraw_predic}'.format(endpoint='endpoint_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_publishers_models_server_streaming_predict(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{endpointserver_streaming_predic}'.format(endpoint='endpoint_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_publishers_models_stream_generate_content(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{modelstream_generate_conten}'.format(model='model_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_publishers_models_stream_raw_predict(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{endpointstream_raw_predic}'.format(endpoint='endpoint_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_schedules_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/schedules'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_specialist_pools_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/specialistPools'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_studies_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/studies'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_studies_lookup(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/studies:lookup'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_studies_trials_add_trial_measurement(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{trial_nameadd_trial_measuremen}'.format(trial_name='trial_name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_studies_trials_check_trial_early_stopping_state(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{trial_namecheck_trial_early_stopping_stat}'.format(trial_name='trial_name_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_studies_trials_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/trials'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_studies_trials_list_optimal_trials(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/trials:listOptimalTrials'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_studies_trials_suggest(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/trials:suggest'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_tensorboards_batch_read(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/{tensorboardbatch_rea}'.format(tensorboard='tensorboard_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_aiplatform_projects_locations_tensorboards_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/tensorboards'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_tensorboards_experiments_batch_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parentbatch_creat}'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_tensorboards_experiments_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/experiments'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_tensorboards_experiments_runs_batch_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/runs:batchCreate'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_tensorboards_experiments_runs_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/runs'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_tensorboards_experiments_runs_time_series_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/timeSeries'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_tensorboards_experiments_runs_time_series_export_tensorboard_time_series(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{tensorboard_time_seriesexport_tensorboard_time_serie}'.format(tensorboard_time_series='tensorboard_time_series_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_tensorboards_experiments_runs_time_series_read(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/{tensorboard_time_seriesrea}'.format(tensorboard_time_series='tensorboard_time_series_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_aiplatform_projects_locations_tensorboards_experiments_runs_time_series_read_blob_data(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/{time_seriesread_blob_dat}'.format(time_series='time_series_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_aiplatform_projects_locations_tensorboards_experiments_runs_write(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{tensorboard_runwrit}'.format(tensorboard_run='tensorboard_run_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_tensorboards_experiments_write(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{tensorboard_experimentwrit}'.format(tensorboard_experiment='tensorboard_experiment_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_aiplatform_projects_locations_tensorboards_read_size(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/{tensorboardread_siz}'.format(tensorboard='tensorboard_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_aiplatform_projects_locations_tensorboards_read_usage(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/{tensorboardread_usag}'.format(tensorboard='tensorboard_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_aiplatform_projects_locations_training_pipelines_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/{parent}/trainingPipelines'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
