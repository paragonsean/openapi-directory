...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VertexAiApi.GoogleCloudAiplatformV1UnmanagedContainerModel();
  });
  ...
  describe('GoogleCloudAiplatformV1UnmanagedContainerModel', function() {
    it('should create an instance of GoogleCloudAiplatformV1UnmanagedContainerModel', function() {
      // uncomment below and update the code to test GoogleCloudAiplatformV1UnmanagedContainerModel
      //var instance = new VertexAiApi.GoogleCloudAiplatformV1UnmanagedContainerModel();
      //expect(instance).to.be.a(VertexAiApi.GoogleCloudAiplatformV1UnmanagedContainerModel);
    });
