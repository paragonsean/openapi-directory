...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VertexAiApi.GoogleCloudAiplatformV1PipelineTaskDetail();
  });
  ...
  describe('GoogleCloudAiplatformV1PipelineTaskDetail', function() {
    it('should create an instance of GoogleCloudAiplatformV1PipelineTaskDetail', function() {
      // uncomment below and update the code to test GoogleCloudAiplatformV1PipelineTaskDetail
      //var instance = new VertexAiApi.GoogleCloudAiplatformV1PipelineTaskDetail();
      //expect(instance).to.be.a(VertexAiApi.GoogleCloudAiplatformV1PipelineTaskDetail);
    });
