...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VertexAiApi.GoogleCloudAiplatformV1Event();
  });
  ...
  describe('GoogleCloudAiplatformV1Event', function() {
    it('should create an instance of GoogleCloudAiplatformV1Event', function() {
      // uncomment below and update the code to test GoogleCloudAiplatformV1Event
      //var instance = new VertexAiApi.GoogleCloudAiplatformV1Event();
      //expect(instance).to.be.a(VertexAiApi.GoogleCloudAiplatformV1Event);
    });
