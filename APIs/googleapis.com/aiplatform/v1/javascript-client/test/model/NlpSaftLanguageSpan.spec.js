...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VertexAiApi.NlpSaftLanguageSpan();
  });
  ...
  describe('NlpSaftLanguageSpan', function() {
    it('should create an instance of NlpSaftLanguageSpan', function() {
      // uncomment below and update the code to test NlpSaftLanguageSpan
      //var instance = new VertexAiApi.NlpSaftLanguageSpan();
      //expect(instance).to.be.a(VertexAiApi.NlpSaftLanguageSpan);
    });
