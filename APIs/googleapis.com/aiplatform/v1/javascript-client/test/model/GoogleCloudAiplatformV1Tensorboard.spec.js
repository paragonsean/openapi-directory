...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VertexAiApi.GoogleCloudAiplatformV1Tensorboard();
  });
  ...
  describe('GoogleCloudAiplatformV1Tensorboard', function() {
    it('should create an instance of GoogleCloudAiplatformV1Tensorboard', function() {
      // uncomment below and update the code to test GoogleCloudAiplatformV1Tensorboard
      //var instance = new VertexAiApi.GoogleCloudAiplatformV1Tensorboard();
      //expect(instance).to.be.a(VertexAiApi.GoogleCloudAiplatformV1Tensorboard);
    });
