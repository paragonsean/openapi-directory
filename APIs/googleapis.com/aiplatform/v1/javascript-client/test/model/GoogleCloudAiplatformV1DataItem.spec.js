...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VertexAiApi.GoogleCloudAiplatformV1DataItem();
  });
  ...
  describe('GoogleCloudAiplatformV1DataItem', function() {
    it('should create an instance of GoogleCloudAiplatformV1DataItem', function() {
      // uncomment below and update the code to test GoogleCloudAiplatformV1DataItem
      //var instance = new VertexAiApi.GoogleCloudAiplatformV1DataItem();
      //expect(instance).to.be.a(VertexAiApi.GoogleCloudAiplatformV1DataItem);
    });
