...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VertexAiApi.GoogleCloudAiplatformV1Artifact();
  });
  ...
  describe('GoogleCloudAiplatformV1Artifact', function() {
    it('should create an instance of GoogleCloudAiplatformV1Artifact', function() {
      // uncomment below and update the code to test GoogleCloudAiplatformV1Artifact
      //var instance = new VertexAiApi.GoogleCloudAiplatformV1Artifact();
      //expect(instance).to.be.a(VertexAiApi.GoogleCloudAiplatformV1Artifact);
    });
