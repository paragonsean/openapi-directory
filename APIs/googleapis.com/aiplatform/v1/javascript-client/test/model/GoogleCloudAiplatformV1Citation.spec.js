...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VertexAiApi.GoogleCloudAiplatformV1Citation();
  });
  ...
  describe('GoogleCloudAiplatformV1Citation', function() {
    it('should create an instance of GoogleCloudAiplatformV1Citation', function() {
      // uncomment below and update the code to test GoogleCloudAiplatformV1Citation
      //var instance = new VertexAiApi.GoogleCloudAiplatformV1Citation();
      //expect(instance).to.be.a(VertexAiApi.GoogleCloudAiplatformV1Citation);
    });
