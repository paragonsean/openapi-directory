...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VertexAiApi.GoogleCloudAiplatformV1Dataset();
  });
  ...
  describe('GoogleCloudAiplatformV1Dataset', function() {
    it('should create an instance of GoogleCloudAiplatformV1Dataset', function() {
      // uncomment below and update the code to test GoogleCloudAiplatformV1Dataset
      //var instance = new VertexAiApi.GoogleCloudAiplatformV1Dataset();
      //expect(instance).to.be.a(VertexAiApi.GoogleCloudAiplatformV1Dataset);
    });
