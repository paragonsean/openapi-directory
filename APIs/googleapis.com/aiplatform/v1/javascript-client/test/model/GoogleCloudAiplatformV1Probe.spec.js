...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VertexAiApi.GoogleCloudAiplatformV1Probe();
  });
  ...
  describe('GoogleCloudAiplatformV1Probe', function() {
    it('should create an instance of GoogleCloudAiplatformV1Probe', function() {
      // uncomment below and update the code to test GoogleCloudAiplatformV1Probe
      //var instance = new VertexAiApi.GoogleCloudAiplatformV1Probe();
      //expect(instance).to.be.a(VertexAiApi.GoogleCloudAiplatformV1Probe);
    });
