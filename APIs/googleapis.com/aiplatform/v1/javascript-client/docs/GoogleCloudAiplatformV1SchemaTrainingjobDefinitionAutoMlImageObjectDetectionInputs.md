# VertexAiApi.GoogleCloudAiplatformV1SchemaTrainingjobDefinitionAutoMlImageObjectDetectionInputs
...
* `CLOUD_HIGH_ACCURACY_1` (value: `"CLOUD_HIGH_ACCURACY_1"`)

* `CLOUD_LOW_LATENCY_1` (value: `"CLOUD_LOW_LATENCY_1"`)

* `CLOUD_1` (value: `"CLOUD_1"`)

* `MOBILE_TF_LOW_LATENCY_1` (value: `"MOBILE_TF_LOW_LATENCY_1"`)

* `MOBILE_TF_VERSATILE_1` (value: `"MOBILE_TF_VERSATILE_1"`)

* `MOBILE_TF_HIGH_ACCURACY_1` (value: `"MOBILE_TF_HIGH_ACCURACY_1"`)

* `CLOUD_STREAMING_1` (value: `"CLOUD_STREAMING_1"`)

* `SPINENET` (value: `"SPINENET"`)
