# VertexAiApi.GoogleCloudAiplatformV1ExportDataConfig
...
**exportUse** | **String** | Indicates the usage of the exported files. | [optional] 
...
* `EXPORT_USE_UNSPECIFIED` (value: `"EXPORT_USE_UNSPECIFIED"`)

* `CUSTOM_CODE_TRAINING` (value: `"CUSTOM_CODE_TRAINING"`)
