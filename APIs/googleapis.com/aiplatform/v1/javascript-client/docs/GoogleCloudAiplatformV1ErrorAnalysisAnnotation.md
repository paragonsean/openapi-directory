# VertexAiApi.GoogleCloudAiplatformV1ErrorAnalysisAnnotation

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**attributedItems** | [**[GoogleCloudAiplatformV1ErrorAnalysisAnnotationAttributedItem]**](GoogleCloudAiplatformV1ErrorAnalysisAnnotationAttributedItem.md) | Attributed items for a given annotation, typically representing neighbors from the training sets constrained by the query type. | [optional] 
