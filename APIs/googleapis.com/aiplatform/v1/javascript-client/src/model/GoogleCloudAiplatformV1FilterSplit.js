...
/**
 * The GoogleCloudAiplatformV1FilterSplit model module.
 * @module model/GoogleCloudAiplatformV1FilterSplit
 * @version v1
 */
class GoogleCloudAiplatformV1FilterSplit {
    /**
     * Constructs a new <code>GoogleCloudAiplatformV1FilterSplit</code>.
     ...
     * @alias module:model/GoogleCloudAiplatformV1FilterSplit
     */
    constructor() { 
        
        GoogleCloudAiplatformV1FilterSplit.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudAiplatformV1FilterSplit</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudAiplatformV1FilterSplit} obj Optional instance to populate.
     * @return {module:model/GoogleCloudAiplatformV1FilterSplit} The populated <code>GoogleCloudAiplatformV1FilterSplit</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudAiplatformV1FilterSplit();
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudAiplatformV1FilterSplit</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudAiplatformV1FilterSplit</code>.
     */
 ...
 */
GoogleCloudAiplatformV1FilterSplit.prototype['testFilter'] = undefined;

/**
 * Required. A filter on DataItems of the Dataset. DataItems that match this filter are used to train the Model. A filter with same syntax as the one used in DatasetService.ListDataItems may be used. If a single DataItem is matched by more than one of the FilterSplit filters, then it is assigned to the first set that applies to it in the training, validation, test order.
 * @member {String} trainingFilter
 */
GoogleCloudAiplatformV1FilterSplit.prototype['trainingFilter'] = undefined;

/**
 * Required. A filter on DataItems of the Dataset. DataItems that match this filter are used to validate the Model. A filter with same syntax as the one used in DatasetService.ListDataItems may be used. If a single DataItem is matched by more than one of the FilterSplit filters, then it is assigned to the first set that applies to it in the training, validation, test order.
 * @member {String} validationFilter
 */
GoogleCloudAiplatformV1FilterSplit.prototype['validationFilter'] = undefined;
...
export default GoogleCloudAiplatformV1FilterSplit;
