...
/**
 * The GoogleCloudAiplatformV1ModelExplanation model module.
 * @module model/GoogleCloudAiplatformV1ModelExplanation
 * @version v1
 */
class GoogleCloudAiplatformV1ModelExplanation {
    /**
     * Constructs a new <code>GoogleCloudAiplatformV1ModelExplanation</code>.
     * Aggregated explanation metrics for a Model over a set of instances.
     * @alias module:model/GoogleCloudAiplatformV1ModelExplanation
     */
    constructor() { 
        
        GoogleCloudAiplatformV1ModelExplanation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudAiplatformV1ModelExplanation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudAiplatformV1ModelExplanation} obj Optional instance to populate.
     * @return {module:model/GoogleCloudAiplatformV1ModelExplanation} The populated <code>GoogleCloudAiplatformV1ModelExplanation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudAiplatformV1ModelExplanation();

            if (data.hasOwnProperty('meanAttributions')) {
                obj['meanAttributions'] = ApiClient.convertToType(data['meanAttributions'], [GoogleCloudAiplatformV1Attribution]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudAiplatformV1ModelExplanation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudAiplatformV1ModelExplanation</code>.
     */
 ...
 * @member {Array.<module:model/GoogleCloudAiplatformV1Attribution>} meanAttributions
 */
GoogleCloudAiplatformV1ModelExplanation.prototype['meanAttributions'] = undefined;
...
export default GoogleCloudAiplatformV1ModelExplanation;
