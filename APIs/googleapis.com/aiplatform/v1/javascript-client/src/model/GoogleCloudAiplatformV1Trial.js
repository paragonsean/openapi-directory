...
/**
 * The GoogleCloudAiplatformV1Trial model module.
 * @module model/GoogleCloudAiplatformV1Trial
 * @version v1
 */
class GoogleCloudAiplatformV1Trial {
    /**
     * Constructs a new <code>GoogleCloudAiplatformV1Trial</code>.
     * A message representing a Trial. A Trial contains a unique set of Parameters that has been or will be evaluated, along with the objective metrics got by running the Trial.
     * @alias module:model/GoogleCloudAiplatformV1Trial
     */
    constructor() { 
        
        GoogleCloudAiplatformV1Trial.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudAiplatformV1Trial</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudAiplatformV1Trial} obj Optional instance to populate.
     * @return {module:model/GoogleCloudAiplatformV1Trial} The populated <code>GoogleCloudAiplatformV1Trial</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudAiplatformV1Trial();
            ...
            if (data.hasOwnProperty('measurements')) {
                obj['measurements'] = ApiClient.convertToType(data['measurements'], [GoogleCloudAiplatformV1Measurement]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudAiplatformV1Trial</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudAiplatformV1Trial</code>.
     */
    static validateJSON(data) {
        ...
        if (data['measurements']) { // data not null
            ...
            for (const item of data['measurements']) {
                GoogleCloudAiplatformV1Measurement.validateJSON(item);
            };
        }
        // ensure the json data is a string
 ...
 */
GoogleCloudAiplatformV1Trial.prototype['clientId'] = undefined;

/**
 * Output only. The CustomJob name linked to the Trial. It's set for a HyperparameterTuningJob's Trial.
 * @member {String} customJob
 */
GoogleCloudAiplatformV1Trial.prototype['customJob'] = undefined;

/**
 * Output only. Time when the Trial's status changed to `SUCCEEDED` or `INFEASIBLE`.
 * @member {String} endTime
 */
GoogleCloudAiplatformV1Trial.prototype['endTime'] = undefined;

/**
 * @member {module:model/GoogleCloudAiplatformV1Measurement} finalMeasurement
 */
GoogleCloudAiplatformV1Trial.prototype['finalMeasurement'] = undefined;

/**
 * Output only. The identifier of the Trial assigned by the service.
 * @member {String} id
 */
GoogleCloudAiplatformV1Trial.prototype['id'] = undefined;
 ...
 */
GoogleCloudAiplatformV1Trial.prototype['infeasibleReason'] = undefined;
 ...
 * @member {Array.<module:model/GoogleCloudAiplatformV1Measurement>} measurements
 */
GoogleCloudAiplatformV1Trial.prototype['measurements'] = undefined;

/**
 * Output only. Resource name of the Trial assigned by the service.
 * @member {String} name
 */
GoogleCloudAiplatformV1Trial.prototype['name'] = undefined;

/**
 * Output only. The parameters of the Trial.
 * @member {Array.<module:model/GoogleCloudAiplatformV1TrialParameter>} parameters
 */
GoogleCloudAiplatformV1Trial.prototype['parameters'] = undefined;

/**
 * Output only. Time when the Trial was started.
 * @member {String} startTime
 */
GoogleCloudAiplatformV1Trial.prototype['startTime'] = undefined;

/**
 * Output only. The detailed state of the Trial.
 * @member {module:model/GoogleCloudAiplatformV1Trial.StateEnum} state
 */
GoogleCloudAiplatformV1Trial.prototype['state'] = undefined;
 ...
 */
GoogleCloudAiplatformV1Trial.prototype['webAccessUris'] = undefined;
 ...
 * @readonly
 */
GoogleCloudAiplatformV1Trial['StateEnum'] = {
...
export default GoogleCloudAiplatformV1Trial;
