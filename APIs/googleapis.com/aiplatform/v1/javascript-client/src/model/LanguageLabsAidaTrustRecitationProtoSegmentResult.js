...
import LanguageLabsAidaTrustRecitationProtoDocAttribution from './LanguageLabsAidaTrustRecitationProtoDocAttribution';

/**
 * The LanguageLabsAidaTrustRecitationProtoSegmentResult model module.
 * @module model/LanguageLabsAidaTrustRecitationProtoSegmentResult
 * @version v1
 */
class LanguageLabsAidaTrustRecitationProtoSegmentResult {
    /**
     * Constructs a new <code>LanguageLabsAidaTrustRecitationProtoSegmentResult</code>.
     * The recitation result for each segment in a given input.
     * @alias module:model/LanguageLabsAidaTrustRecitationProtoSegmentResult
     */
    constructor() { 
        
        LanguageLabsAidaTrustRecitationProtoSegmentResult.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LanguageLabsAidaTrustRecitationProtoSegmentResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LanguageLabsAidaTrustRecitationProtoSegmentResult} obj Optional instance to populate.
     * @return {module:model/LanguageLabsAidaTrustRecitationProtoSegmentResult} The populated <code>LanguageLabsAidaTrustRecitationProtoSegmentResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LanguageLabsAidaTrustRecitationProtoSegmentResult();

            if (data.hasOwnProperty('attributionDataset')) {
                obj['attributionDataset'] = ApiClient.convertToType(data['attributionDataset'], 'String');
            }
            if (data.hasOwnProperty('displayAttributionMessage')) {
                obj['displayAttributionMessage'] = ApiClient.convertToType(data['displayAttributionMessage'], 'String');
            }
            if (data.hasOwnProperty('docAttribution')) {
                obj['docAttribution'] = LanguageLabsAidaTrustRecitationProtoDocAttribution.constructFromObject(data['docAttribution']);
            }
            if (data.hasOwnProperty('docOccurrences')) {
                obj['docOccurrences'] = ApiClient.convertToType(data['docOccurrences'], 'Number');
            }
            ...
            if (data.hasOwnProperty('segmentRecitationAction')) {
                obj['segmentRecitationAction'] = ApiClient.convertToType(data['segmentRecitationAction'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>LanguageLabsAidaTrustRecitationProtoSegmentResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LanguageLabsAidaTrustRecitationProtoSegmentResult</code>.
     */
    static validateJSON(data) {
        // ensure the json data is a string
        if (data['attributionDataset'] && !(typeof data['attributionDataset'] === 'string' || data['attributionDataset'] instanceof String)) {
            throw new Error("Expected the field `attributionDataset` to be a primitive type in the JSON string but got " + data['attributionDataset']);
        }
        // ensure the json data is a string
        if (data['displayAttributionMessage'] && !(typeof data['displayAttributionMessage'] === 'string' || data['displayAttributionMessage'] instanceof String)) {
            throw new Error("Expected the field `displayAttributionMessage` to be a primitive type in the JSON string but got " + data['displayAttributionMessage']);
        }
        // validate the optional field `docAttribution`
        if (data['docAttribution']) { // data not null
          LanguageLabsAidaTrustRecitationProtoDocAttribution.validateJSON(data['docAttribution']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['segmentRecitationAction'] && !(typeof data['segmentRecitationAction'] === 'string' || data['segmentRecitationAction'] instanceof String)) {
            throw new Error("Expected the field `segmentRecitationAction` to be a primitive type in the JSON string but got " + data['segmentRecitationAction']);
        }
 ...
 * @member {module:model/LanguageLabsAidaTrustRecitationProtoSegmentResult.AttributionDatasetEnum} attributionDataset
 */
LanguageLabsAidaTrustRecitationProtoSegmentResult.prototype['attributionDataset'] = undefined;

/**
 * human-friendly string that contains information from doc_attribution which could be shown by clients
 * @member {String} displayAttributionMessage
 */
LanguageLabsAidaTrustRecitationProtoSegmentResult.prototype['displayAttributionMessage'] = undefined;

/**
 * @member {module:model/LanguageLabsAidaTrustRecitationProtoDocAttribution} docAttribution
 */
LanguageLabsAidaTrustRecitationProtoSegmentResult.prototype['docAttribution'] = undefined;

/**
 * number of documents that contained this segment
 * @member {Number} docOccurrences
 */
LanguageLabsAidaTrustRecitationProtoSegmentResult.prototype['docOccurrences'] = undefined;

/**
 * @member {Number} endIndex
 */
LanguageLabsAidaTrustRecitationProtoSegmentResult.prototype['endIndex'] = undefined;
 ...
 */
LanguageLabsAidaTrustRecitationProtoSegmentResult.prototype['rawText'] = undefined;

/**
 * @member {module:model/LanguageLabsAidaTrustRecitationProtoSegmentResult.SegmentRecitationActionEnum} segmentRecitationAction
 */
LanguageLabsAidaTrustRecitationProtoSegmentResult.prototype['segmentRecitationAction'] = undefined;
 ...
 */
LanguageLabsAidaTrustRecitationProtoSegmentResult.prototype['startIndex'] = undefined;
...
/**
 * Allowed values for the <code>attributionDataset</code> property.
 * @enum {String}
 * @readonly
 */
LanguageLabsAidaTrustRecitationProtoSegmentResult['AttributionDatasetEnum'] = {
...
/**
 * Allowed values for the <code>segmentRecitationAction</code> property.
 * @enum {String}
 * @readonly
 */
LanguageLabsAidaTrustRecitationProtoSegmentResult['SegmentRecitationActionEnum'] = {
...
export default LanguageLabsAidaTrustRecitationProtoSegmentResult;
