...
import GoogleCloudAiplatformV1ModelEvaluationModelEvaluationExplanationSpec from './GoogleCloudAiplatformV1ModelEvaluationModelEvaluationExplanationSpec';
import GoogleCloudAiplatformV1ModelExplanation from './GoogleCloudAiplatformV1ModelExplanation';

/**
 * The GoogleCloudAiplatformV1ModelEvaluation model module.
 * @module model/GoogleCloudAiplatformV1ModelEvaluation
 * @version v1
 */
class GoogleCloudAiplatformV1ModelEvaluation {
    /**
     * Constructs a new <code>GoogleCloudAiplatformV1ModelEvaluation</code>.
     * A collection of metrics calculated by comparing Model&#39;s predictions on all of the test data against annotations from the test data.
     * @alias module:model/GoogleCloudAiplatformV1ModelEvaluation
     */
    constructor() { 
        
        GoogleCloudAiplatformV1ModelEvaluation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudAiplatformV1ModelEvaluation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudAiplatformV1ModelEvaluation} obj Optional instance to populate.
     * @return {module:model/GoogleCloudAiplatformV1ModelEvaluation} The populated <code>GoogleCloudAiplatformV1ModelEvaluation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudAiplatformV1ModelEvaluation();
            ...
            if (data.hasOwnProperty('explanationSpecs')) {
                obj['explanationSpecs'] = ApiClient.convertToType(data['explanationSpecs'], [GoogleCloudAiplatformV1ModelEvaluationModelEvaluationExplanationSpec]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudAiplatformV1ModelEvaluation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudAiplatformV1ModelEvaluation</code>.
     */
    static validateJSON(data) {
        ...
        if (data['explanationSpecs']) { // data not null
            ...
            for (const item of data['explanationSpecs']) {
                GoogleCloudAiplatformV1ModelEvaluationModelEvaluationExplanationSpec.validateJSON(item);
            };
        }
        // ensure the json data is a string
 ...
 */
GoogleCloudAiplatformV1ModelEvaluation.prototype['annotationSchemaUri'] = undefined;

/**
 * Output only. Timestamp when this ModelEvaluation was created.
 * @member {String} createTime
 */
GoogleCloudAiplatformV1ModelEvaluation.prototype['createTime'] = undefined;
 ...
 */
GoogleCloudAiplatformV1ModelEvaluation.prototype['dataItemSchemaUri'] = undefined;

/**
 * The display name of the ModelEvaluation.
 * @member {String} displayName
 */
GoogleCloudAiplatformV1ModelEvaluation.prototype['displayName'] = undefined;

/**
 * Describes the values of ExplanationSpec that are used for explaining the predicted values on the evaluated data.
 * @member {Array.<module:model/GoogleCloudAiplatformV1ModelEvaluationModelEvaluationExplanationSpec>} explanationSpecs
 */
GoogleCloudAiplatformV1ModelEvaluation.prototype['explanationSpecs'] = undefined;
 ...
 */
GoogleCloudAiplatformV1ModelEvaluation.prototype['metadata'] = undefined;

/**
 * Evaluation metrics of the Model. The schema of the metrics is stored in metrics_schema_uri
 * @member {Object} metrics
 */
GoogleCloudAiplatformV1ModelEvaluation.prototype['metrics'] = undefined;
 ...
 */
GoogleCloudAiplatformV1ModelEvaluation.prototype['metricsSchemaUri'] = undefined;

/**
 * @member {module:model/GoogleCloudAiplatformV1ModelExplanation} modelExplanation
 */
GoogleCloudAiplatformV1ModelEvaluation.prototype['modelExplanation'] = undefined;

/**
 * Output only. The resource name of the ModelEvaluation.
 * @member {String} name
 */
GoogleCloudAiplatformV1ModelEvaluation.prototype['name'] = undefined;
 ...
 */
GoogleCloudAiplatformV1ModelEvaluation.prototype['sliceDimensions'] = undefined;
...
export default GoogleCloudAiplatformV1ModelEvaluation;
