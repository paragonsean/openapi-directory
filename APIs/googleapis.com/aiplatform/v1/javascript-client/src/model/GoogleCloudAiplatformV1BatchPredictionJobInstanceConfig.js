...
/**
 * The GoogleCloudAiplatformV1BatchPredictionJobInstanceConfig model module.
 * @module model/GoogleCloudAiplatformV1BatchPredictionJobInstanceConfig
 * @version v1
 */
class GoogleCloudAiplatformV1BatchPredictionJobInstanceConfig {
    /**
     * Constructs a new <code>GoogleCloudAiplatformV1BatchPredictionJobInstanceConfig</code>.
     * Configuration defining how to transform batch prediction input instances to the instances that the Model accepts.
     * @alias module:model/GoogleCloudAiplatformV1BatchPredictionJobInstanceConfig
     */
    constructor() { 
        
        GoogleCloudAiplatformV1BatchPredictionJobInstanceConfig.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudAiplatformV1BatchPredictionJobInstanceConfig</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudAiplatformV1BatchPredictionJobInstanceConfig} obj Optional instance to populate.
     * @return {module:model/GoogleCloudAiplatformV1BatchPredictionJobInstanceConfig} The populated <code>GoogleCloudAiplatformV1BatchPredictionJobInstanceConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudAiplatformV1BatchPredictionJobInstanceConfig();
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudAiplatformV1BatchPredictionJobInstanceConfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudAiplatformV1BatchPredictionJobInstanceConfig</code>.
     */
 ...
 */
GoogleCloudAiplatformV1BatchPredictionJobInstanceConfig.prototype['excludedFields'] = undefined;
 ...
 */
GoogleCloudAiplatformV1BatchPredictionJobInstanceConfig.prototype['includedFields'] = undefined;
 ...
 */
GoogleCloudAiplatformV1BatchPredictionJobInstanceConfig.prototype['instanceType'] = undefined;
 ...
 */
GoogleCloudAiplatformV1BatchPredictionJobInstanceConfig.prototype['keyField'] = undefined;
...
export default GoogleCloudAiplatformV1BatchPredictionJobInstanceConfig;
