...
import GoogleCloudAiplatformV1Scheduling from './GoogleCloudAiplatformV1Scheduling';
import GoogleCloudAiplatformV1WorkerPoolSpec from './GoogleCloudAiplatformV1WorkerPoolSpec';

/**
 * The GoogleCloudAiplatformV1CustomJobSpec model module.
 * @module model/GoogleCloudAiplatformV1CustomJobSpec
 * @version v1
 */
class GoogleCloudAiplatformV1CustomJobSpec {
    /**
     * Constructs a new <code>GoogleCloudAiplatformV1CustomJobSpec</code>.
     * Represents the spec of a CustomJob.
     * @alias module:model/GoogleCloudAiplatformV1CustomJobSpec
     */
    constructor() { 
        
        GoogleCloudAiplatformV1CustomJobSpec.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudAiplatformV1CustomJobSpec</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudAiplatformV1CustomJobSpec} obj Optional instance to populate.
     * @return {module:model/GoogleCloudAiplatformV1CustomJobSpec} The populated <code>GoogleCloudAiplatformV1CustomJobSpec</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudAiplatformV1CustomJobSpec();

            if (data.hasOwnProperty('baseOutputDirectory')) {
                obj['baseOutputDirectory'] = GoogleCloudAiplatformV1GcsDestination.constructFromObject(data['baseOutputDirectory']);
            }
            ...
            if (data.hasOwnProperty('scheduling')) {
                obj['scheduling'] = GoogleCloudAiplatformV1Scheduling.constructFromObject(data['scheduling']);
            }
            ...
            if (data.hasOwnProperty('workerPoolSpecs')) {
                obj['workerPoolSpecs'] = ApiClient.convertToType(data['workerPoolSpecs'], [GoogleCloudAiplatformV1WorkerPoolSpec]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudAiplatformV1CustomJobSpec</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudAiplatformV1CustomJobSpec</code>.
     */
    static validateJSON(data) {
        // validate the optional field `baseOutputDirectory`
        if (data['baseOutputDirectory']) { // data not null
          GoogleCloudAiplatformV1GcsDestination.validateJSON(data['baseOutputDirectory']);
        }
        ...
        if (data['scheduling']) { // data not null
          GoogleCloudAiplatformV1Scheduling.validateJSON(data['scheduling']);
        }
        // ensure the json data is a string
        ...
        if (data['workerPoolSpecs']) { // data not null
            ...
            for (const item of data['workerPoolSpecs']) {
                GoogleCloudAiplatformV1WorkerPoolSpec.validateJSON(item);
            };
        }
...
/**
 * @member {module:model/GoogleCloudAiplatformV1GcsDestination} baseOutputDirectory
 */
GoogleCloudAiplatformV1CustomJobSpec.prototype['baseOutputDirectory'] = undefined;
 ...
 */
GoogleCloudAiplatformV1CustomJobSpec.prototype['enableDashboardAccess'] = undefined;
 ...
 */
GoogleCloudAiplatformV1CustomJobSpec.prototype['enableWebAccess'] = undefined;

/**
 * Optional. The Experiment associated with this job. Format: `projects/{project}/locations/{location}/metadataStores/{metadataStores}/contexts/{experiment-name}`
 * @member {String} experiment
 */
GoogleCloudAiplatformV1CustomJobSpec.prototype['experiment'] = undefined;

/**
 * Optional. The Experiment Run associated with this job. Format: `projects/{project}/locations/{location}/metadataStores/{metadataStores}/contexts/{experiment-name}-{experiment-run-name}`
 * @member {String} experimentRun
 */
GoogleCloudAiplatformV1CustomJobSpec.prototype['experimentRun'] = undefined;
 ...
 */
GoogleCloudAiplatformV1CustomJobSpec.prototype['models'] = undefined;
 ...
 */
GoogleCloudAiplatformV1CustomJobSpec.prototype['network'] = undefined;

/**
 * The ID of the location to store protected artifacts. e.g. us-central1. Populate only when the location is different than CustomJob location. List of supported locations: https://cloud.google.com/vertex-ai/docs/general/locations
 * @member {String} protectedArtifactLocationId
 */
GoogleCloudAiplatformV1CustomJobSpec.prototype['protectedArtifactLocationId'] = undefined;

/**
 * Optional. A list of names for the reserved ip ranges under the VPC network that can be used for this job. If set, we will deploy the job within the provided ip ranges. Otherwise, the job will be deployed to any ip ranges under the provided VPC network. Example: ['vertex-ai-ip-range'].
 * @member {Array.<String>} reservedIpRanges
 */
GoogleCloudAiplatformV1CustomJobSpec.prototype['reservedIpRanges'] = undefined;

/**
 * @member {module:model/GoogleCloudAiplatformV1Scheduling} scheduling
 */
GoogleCloudAiplatformV1CustomJobSpec.prototype['scheduling'] = undefined;
 ...
 */
GoogleCloudAiplatformV1CustomJobSpec.prototype['serviceAccount'] = undefined;
 ...
 */
GoogleCloudAiplatformV1CustomJobSpec.prototype['tensorboard'] = undefined;

/**
 * Required. The spec of the worker pools including machine type and Docker image. All worker pools except the first one are optional and can be skipped by providing an empty value.
 * @member {Array.<module:model/GoogleCloudAiplatformV1WorkerPoolSpec>} workerPoolSpecs
 */
GoogleCloudAiplatformV1CustomJobSpec.prototype['workerPoolSpecs'] = undefined;
...
export default GoogleCloudAiplatformV1CustomJobSpec;
