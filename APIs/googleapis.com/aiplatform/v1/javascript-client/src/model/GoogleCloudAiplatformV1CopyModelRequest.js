...
/**
 * The GoogleCloudAiplatformV1CopyModelRequest model module.
 * @module model/GoogleCloudAiplatformV1CopyModelRequest
 * @version v1
 */
class GoogleCloudAiplatformV1CopyModelRequest {
    /**
     * Constructs a new <code>GoogleCloudAiplatformV1CopyModelRequest</code>.
     * Request message for ModelService.CopyModel.
     * @alias module:model/GoogleCloudAiplatformV1CopyModelRequest
     */
    constructor() { 
        
        GoogleCloudAiplatformV1CopyModelRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudAiplatformV1CopyModelRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudAiplatformV1CopyModelRequest} obj Optional instance to populate.
     * @return {module:model/GoogleCloudAiplatformV1CopyModelRequest} The populated <code>GoogleCloudAiplatformV1CopyModelRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudAiplatformV1CopyModelRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudAiplatformV1CopyModelRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudAiplatformV1CopyModelRequest</code>.
     */
 ...
 */
GoogleCloudAiplatformV1CopyModelRequest.prototype['encryptionSpec'] = undefined;
 ...
 */
GoogleCloudAiplatformV1CopyModelRequest.prototype['modelId'] = undefined;
 ...
 */
GoogleCloudAiplatformV1CopyModelRequest.prototype['parentModel'] = undefined;
 ...
 */
GoogleCloudAiplatformV1CopyModelRequest.prototype['sourceModel'] = undefined;
...
export default GoogleCloudAiplatformV1CopyModelRequest;
