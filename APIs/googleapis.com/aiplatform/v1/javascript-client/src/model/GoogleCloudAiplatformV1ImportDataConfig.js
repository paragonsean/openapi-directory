...
/**
 * The GoogleCloudAiplatformV1ImportDataConfig model module.
 * @module model/GoogleCloudAiplatformV1ImportDataConfig
 * @version v1
 */
class GoogleCloudAiplatformV1ImportDataConfig {
    /**
     * Constructs a new <code>GoogleCloudAiplatformV1ImportDataConfig</code>.
     * Describes the location from where we import data into a Dataset, together with the labels that will be applied to the DataItems and the Annotations.
     * @alias module:model/GoogleCloudAiplatformV1ImportDataConfig
     */
    constructor() { 
        
        GoogleCloudAiplatformV1ImportDataConfig.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudAiplatformV1ImportDataConfig</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudAiplatformV1ImportDataConfig} obj Optional instance to populate.
     * @return {module:model/GoogleCloudAiplatformV1ImportDataConfig} The populated <code>GoogleCloudAiplatformV1ImportDataConfig</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudAiplatformV1ImportDataConfig();
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudAiplatformV1ImportDataConfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudAiplatformV1ImportDataConfig</code>.
     */
 ...
 */
GoogleCloudAiplatformV1ImportDataConfig.prototype['annotationLabels'] = undefined;
 ...
 */
GoogleCloudAiplatformV1ImportDataConfig.prototype['dataItemLabels'] = undefined;

/**
 * @member {module:model/GoogleCloudAiplatformV1GcsSource} gcsSource
 */
GoogleCloudAiplatformV1ImportDataConfig.prototype['gcsSource'] = undefined;
 ...
 */
GoogleCloudAiplatformV1ImportDataConfig.prototype['importSchemaUri'] = undefined;
...
export default GoogleCloudAiplatformV1ImportDataConfig;
