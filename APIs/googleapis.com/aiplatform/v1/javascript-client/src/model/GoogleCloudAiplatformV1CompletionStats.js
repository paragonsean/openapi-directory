...
/**
 * The GoogleCloudAiplatformV1CompletionStats model module.
 * @module model/GoogleCloudAiplatformV1CompletionStats
 * @version v1
 */
class GoogleCloudAiplatformV1CompletionStats {
    /**
     * Constructs a new <code>GoogleCloudAiplatformV1CompletionStats</code>.
     * Success and error statistics of processing multiple entities (for example, DataItems or structured data rows) in batch.
     * @alias module:model/GoogleCloudAiplatformV1CompletionStats
     */
    constructor() { 
        
        GoogleCloudAiplatformV1CompletionStats.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudAiplatformV1CompletionStats</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudAiplatformV1CompletionStats} obj Optional instance to populate.
     * @return {module:model/GoogleCloudAiplatformV1CompletionStats} The populated <code>GoogleCloudAiplatformV1CompletionStats</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudAiplatformV1CompletionStats();
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudAiplatformV1CompletionStats</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudAiplatformV1CompletionStats</code>.
     */
 ...
 */
GoogleCloudAiplatformV1CompletionStats.prototype['failedCount'] = undefined;

/**
 * Output only. In cases when enough errors are encountered a job, pipeline, or operation may be failed as a whole. Below is the number of entities for which the processing had not been finished (either in successful or failed state). Set to -1 if the number is unknown (for example, the operation failed before the total entity number could be collected).
 * @member {String} incompleteCount
 */
GoogleCloudAiplatformV1CompletionStats.prototype['incompleteCount'] = undefined;

/**
 * Output only. The number of entities that had been processed successfully.
 * @member {String} successfulCount
 */
GoogleCloudAiplatformV1CompletionStats.prototype['successfulCount'] = undefined;
 ...
 */
GoogleCloudAiplatformV1CompletionStats.prototype['successfulForecastPointCount'] = undefined;
...
export default GoogleCloudAiplatformV1CompletionStats;
