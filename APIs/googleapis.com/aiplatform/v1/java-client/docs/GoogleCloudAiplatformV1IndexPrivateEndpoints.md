...
|**pscAutomatedEndpoints** | [**List&lt;GoogleCloudAiplatformV1PscAutomatedEndpoints&gt;**](GoogleCloudAiplatformV1PscAutomatedEndpoints.md) | Output only. PscAutomatedEndpoints is populated if private service connect is enabled if PscAutomatedConfig is set. |  [optional] [readonly] |
