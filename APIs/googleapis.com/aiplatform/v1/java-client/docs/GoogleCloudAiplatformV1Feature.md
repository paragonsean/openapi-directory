...
|**monitoringStatsAnomalies** | [**List&lt;GoogleCloudAiplatformV1FeatureMonitoringStatsAnomaly&gt;**](GoogleCloudAiplatformV1FeatureMonitoringStatsAnomaly.md) | Output only. Only applicable for Vertex AI Feature Store (Legacy). The list of historical stats and anomalies with specified objectives. |  [optional] [readonly] |
