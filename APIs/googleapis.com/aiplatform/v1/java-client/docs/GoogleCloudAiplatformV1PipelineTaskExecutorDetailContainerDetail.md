...
|------------ | ------------- | ------------- | -------------|
|**failedMainJobs** | **List&lt;String&gt;** | Output only. The names of the previously failed CustomJob for the main container executions. The list includes the all attempts in chronological order. |  [optional] [readonly] |
