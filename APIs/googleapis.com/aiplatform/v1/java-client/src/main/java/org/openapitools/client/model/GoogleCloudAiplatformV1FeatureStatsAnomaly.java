...
public class GoogleCloudAiplatformV1FeatureStatsAnomaly {
  ...
  public GoogleCloudAiplatformV1FeatureStatsAnomaly() {
  }

  public GoogleCloudAiplatformV1FeatureStatsAnomaly anomalyDetectionThreshold(Double anomalyDetectionThreshold) {
  ...
  public GoogleCloudAiplatformV1FeatureStatsAnomaly anomalyUri(String anomalyUri) {
  ...
  public GoogleCloudAiplatformV1FeatureStatsAnomaly distributionDeviation(Double distributionDeviation) {
  ...
  public GoogleCloudAiplatformV1FeatureStatsAnomaly endTime(String endTime) {
  ...
  public GoogleCloudAiplatformV1FeatureStatsAnomaly score(Double score) {
    this.score = score;
    return this;
  }
  ...
  public GoogleCloudAiplatformV1FeatureStatsAnomaly startTime(String startTime) {
  ...
  public GoogleCloudAiplatformV1FeatureStatsAnomaly statsUri(String statsUri) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudAiplatformV1FeatureStatsAnomaly googleCloudAiplatformV1FeatureStatsAnomaly = (GoogleCloudAiplatformV1FeatureStatsAnomaly) o;
    return Objects.equals(this.anomalyDetectionThreshold, googleCloudAiplatformV1FeatureStatsAnomaly.anomalyDetectionThreshold) &&
        Objects.equals(this.anomalyUri, googleCloudAiplatformV1FeatureStatsAnomaly.anomalyUri) &&
        Objects.equals(this.distributionDeviation, googleCloudAiplatformV1FeatureStatsAnomaly.distributionDeviation) &&
        Objects.equals(this.endTime, googleCloudAiplatformV1FeatureStatsAnomaly.endTime) &&
        Objects.equals(this.score, googleCloudAiplatformV1FeatureStatsAnomaly.score) &&
        Objects.equals(this.startTime, googleCloudAiplatformV1FeatureStatsAnomaly.startTime) &&
        Objects.equals(this.statsUri, googleCloudAiplatformV1FeatureStatsAnomaly.statsUri);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudAiplatformV1FeatureStatsAnomaly {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudAiplatformV1FeatureStatsAnomaly
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudAiplatformV1FeatureStatsAnomaly.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudAiplatformV1FeatureStatsAnomaly is not found in the empty JSON string", GoogleCloudAiplatformV1FeatureStatsAnomaly.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudAiplatformV1FeatureStatsAnomaly.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudAiplatformV1FeatureStatsAnomaly` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudAiplatformV1FeatureStatsAnomaly.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudAiplatformV1FeatureStatsAnomaly' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudAiplatformV1FeatureStatsAnomaly> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudAiplatformV1FeatureStatsAnomaly.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudAiplatformV1FeatureStatsAnomaly>() {
           @Override
           public void write(JsonWriter out, GoogleCloudAiplatformV1FeatureStatsAnomaly value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudAiplatformV1FeatureStatsAnomaly read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudAiplatformV1FeatureStatsAnomaly given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudAiplatformV1FeatureStatsAnomaly
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudAiplatformV1FeatureStatsAnomaly
   */
  public static GoogleCloudAiplatformV1FeatureStatsAnomaly fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudAiplatformV1FeatureStatsAnomaly.class);
  }

  /**
   * Convert an instance of GoogleCloudAiplatformV1FeatureStatsAnomaly to an JSON string
   *
   * @return JSON string
   */
