...
public class GoogleCloudAiplatformV1CompletionStats {
  ...
  public GoogleCloudAiplatformV1CompletionStats() {
  }
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudAiplatformV1CompletionStats googleCloudAiplatformV1CompletionStats = (GoogleCloudAiplatformV1CompletionStats) o;
    return Objects.equals(this.failedCount, googleCloudAiplatformV1CompletionStats.failedCount) &&
        Objects.equals(this.incompleteCount, googleCloudAiplatformV1CompletionStats.incompleteCount) &&
        Objects.equals(this.successfulCount, googleCloudAiplatformV1CompletionStats.successfulCount) &&
        Objects.equals(this.successfulForecastPointCount, googleCloudAiplatformV1CompletionStats.successfulForecastPointCount);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudAiplatformV1CompletionStats {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudAiplatformV1CompletionStats
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudAiplatformV1CompletionStats.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudAiplatformV1CompletionStats is not found in the empty JSON string", GoogleCloudAiplatformV1CompletionStats.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudAiplatformV1CompletionStats.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudAiplatformV1CompletionStats` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudAiplatformV1CompletionStats.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudAiplatformV1CompletionStats' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudAiplatformV1CompletionStats> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudAiplatformV1CompletionStats.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudAiplatformV1CompletionStats>() {
           @Override
           public void write(JsonWriter out, GoogleCloudAiplatformV1CompletionStats value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudAiplatformV1CompletionStats read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudAiplatformV1CompletionStats given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudAiplatformV1CompletionStats
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudAiplatformV1CompletionStats
   */
  public static GoogleCloudAiplatformV1CompletionStats fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudAiplatformV1CompletionStats.class);
  }

  /**
   * Convert an instance of GoogleCloudAiplatformV1CompletionStats to an JSON string
   *
   * @return JSON string
   */
