...
public class GoogleCloudAiplatformV1ModelDeploymentMonitoringJob {
  ...
  private List<GoogleCloudAiplatformV1ModelDeploymentMonitoringBigQueryTable> bigqueryTables = new ArrayList<>();
  ...
  private List<GoogleCloudAiplatformV1ModelDeploymentMonitoringObjectiveConfig> modelDeploymentMonitoringObjectiveConfigs = new ArrayList<>();
  ...
  public GoogleCloudAiplatformV1ModelDeploymentMonitoringJob() {
  }

  public GoogleCloudAiplatformV1ModelDeploymentMonitoringJob(
     List<GoogleCloudAiplatformV1ModelDeploymentMonitoringBigQueryTable> bigqueryTables, 
     String createTime, 
     String name, 
  ...
  public GoogleCloudAiplatformV1ModelDeploymentMonitoringJob analysisInstanceSchemaUri(String analysisInstanceSchemaUri) {
  ...
  public GoogleCloudAiplatformV1ModelDeploymentMonitoringJob displayName(String displayName) {
  ...
  public GoogleCloudAiplatformV1ModelDeploymentMonitoringJob enableMonitoringPipelineLogs(Boolean enableMonitoringPipelineLogs) {
  ...
  public GoogleCloudAiplatformV1ModelDeploymentMonitoringJob encryptionSpec(GoogleCloudAiplatformV1EncryptionSpec encryptionSpec) {
  ...
  public GoogleCloudAiplatformV1ModelDeploymentMonitoringJob endpoint(String endpoint) {
  ...
  public GoogleCloudAiplatformV1ModelDeploymentMonitoringJob error(GoogleRpcStatus error) {
    this.error = error;
    return this;
  }
  ...
  public GoogleCloudAiplatformV1ModelDeploymentMonitoringJob labels(Map<String, String> labels) {
    this.labels = labels;
    return this;
  }

  public GoogleCloudAiplatformV1ModelDeploymentMonitoringJob putLabelsItem(String key, String labelsItem) {
    if (this.labels == null) {
  ...
  public GoogleCloudAiplatformV1ModelDeploymentMonitoringJob latestMonitoringPipelineMetadata(GoogleCloudAiplatformV1ModelDeploymentMonitoringJobLatestMonitoringPipelineMetadata latestMonitoringPipelineMetadata) {
  ...
  public void setLatestMonitoringPipelineMetadata(GoogleCloudAiplatformV1ModelDeploymentMonitoringJobLatestMonitoringPipelineMetadata latestMonitoringPipelineMetadata) {
    this.latestMonitoringPipelineMetadata = latestMonitoringPipelineMetadata;
  }


  public GoogleCloudAiplatformV1ModelDeploymentMonitoringJob logTtl(String logTtl) {
    this.logTtl = logTtl;
    return this;
  }
  ...
  public GoogleCloudAiplatformV1ModelDeploymentMonitoringJob loggingSamplingStrategy(GoogleCloudAiplatformV1SamplingStrategy loggingSamplingStrategy) {
  ...
  public GoogleCloudAiplatformV1ModelDeploymentMonitoringJob modelDeploymentMonitoringObjectiveConfigs(List<GoogleCloudAiplatformV1ModelDeploymentMonitoringObjectiveConfig> modelDeploymentMonitoringObjectiveConfigs) {
    this.modelDeploymentMonitoringObjectiveConfigs = modelDeploymentMonitoringObjectiveConfigs;
    return this;
  }

  public GoogleCloudAiplatformV1ModelDeploymentMonitoringJob addModelDeploymentMonitoringObjectiveConfigsItem(GoogleCloudAiplatformV1ModelDeploymentMonitoringObjectiveConfig modelDeploymentMonitoringObjectiveConfigsItem) {
  ...
  public void setModelDeploymentMonitoringObjectiveConfigs(List<GoogleCloudAiplatformV1ModelDeploymentMonitoringObjectiveConfig> modelDeploymentMonitoringObjectiveConfigs) {
    this.modelDeploymentMonitoringObjectiveConfigs = modelDeploymentMonitoringObjectiveConfigs;
  }


  public GoogleCloudAiplatformV1ModelDeploymentMonitoringJob modelDeploymentMonitoringScheduleConfig(GoogleCloudAiplatformV1ModelDeploymentMonitoringScheduleConfig modelDeploymentMonitoringScheduleConfig) {
  ...
  public void setModelDeploymentMonitoringScheduleConfig(GoogleCloudAiplatformV1ModelDeploymentMonitoringScheduleConfig modelDeploymentMonitoringScheduleConfig) {
    this.modelDeploymentMonitoringScheduleConfig = modelDeploymentMonitoringScheduleConfig;
  }


  public GoogleCloudAiplatformV1ModelDeploymentMonitoringJob modelMonitoringAlertConfig(GoogleCloudAiplatformV1ModelMonitoringAlertConfig modelMonitoringAlertConfig) {
  ...
  public void setModelMonitoringAlertConfig(GoogleCloudAiplatformV1ModelMonitoringAlertConfig modelMonitoringAlertConfig) {
    this.modelMonitoringAlertConfig = modelMonitoringAlertConfig;
  }
  ...
  public GoogleCloudAiplatformV1ModelDeploymentMonitoringJob predictInstanceSchemaUri(String predictInstanceSchemaUri) {
  ...
  public GoogleCloudAiplatformV1ModelDeploymentMonitoringJob samplePredictInstance(Object samplePredictInstance) {
  ...
  public GoogleCloudAiplatformV1ModelDeploymentMonitoringJob statsAnomaliesBaseDirectory(GoogleCloudAiplatformV1GcsDestination statsAnomaliesBaseDirectory) {
  ...
  public void setStatsAnomaliesBaseDirectory(GoogleCloudAiplatformV1GcsDestination statsAnomaliesBaseDirectory) {
    this.statsAnomaliesBaseDirectory = statsAnomaliesBaseDirectory;
  }
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudAiplatformV1ModelDeploymentMonitoringJob googleCloudAiplatformV1ModelDeploymentMonitoringJob = (GoogleCloudAiplatformV1ModelDeploymentMonitoringJob) o;
    return Objects.equals(this.analysisInstanceSchemaUri, googleCloudAiplatformV1ModelDeploymentMonitoringJob.analysisInstanceSchemaUri) &&
        Objects.equals(this.bigqueryTables, googleCloudAiplatformV1ModelDeploymentMonitoringJob.bigqueryTables) &&
        Objects.equals(this.createTime, googleCloudAiplatformV1ModelDeploymentMonitoringJob.createTime) &&
        Objects.equals(this.displayName, googleCloudAiplatformV1ModelDeploymentMonitoringJob.displayName) &&
        Objects.equals(this.enableMonitoringPipelineLogs, googleCloudAiplatformV1ModelDeploymentMonitoringJob.enableMonitoringPipelineLogs) &&
        Objects.equals(this.encryptionSpec, googleCloudAiplatformV1ModelDeploymentMonitoringJob.encryptionSpec) &&
        Objects.equals(this.endpoint, googleCloudAiplatformV1ModelDeploymentMonitoringJob.endpoint) &&
        Objects.equals(this.error, googleCloudAiplatformV1ModelDeploymentMonitoringJob.error) &&
        Objects.equals(this.labels, googleCloudAiplatformV1ModelDeploymentMonitoringJob.labels) &&
        Objects.equals(this.latestMonitoringPipelineMetadata, googleCloudAiplatformV1ModelDeploymentMonitoringJob.latestMonitoringPipelineMetadata) &&
        Objects.equals(this.logTtl, googleCloudAiplatformV1ModelDeploymentMonitoringJob.logTtl) &&
        Objects.equals(this.loggingSamplingStrategy, googleCloudAiplatformV1ModelDeploymentMonitoringJob.loggingSamplingStrategy) &&
        Objects.equals(this.modelDeploymentMonitoringObjectiveConfigs, googleCloudAiplatformV1ModelDeploymentMonitoringJob.modelDeploymentMonitoringObjectiveConfigs) &&
        Objects.equals(this.modelDeploymentMonitoringScheduleConfig, googleCloudAiplatformV1ModelDeploymentMonitoringJob.modelDeploymentMonitoringScheduleConfig) &&
        Objects.equals(this.modelMonitoringAlertConfig, googleCloudAiplatformV1ModelDeploymentMonitoringJob.modelMonitoringAlertConfig) &&
        Objects.equals(this.name, googleCloudAiplatformV1ModelDeploymentMonitoringJob.name) &&
        Objects.equals(this.nextScheduleTime, googleCloudAiplatformV1ModelDeploymentMonitoringJob.nextScheduleTime) &&
        Objects.equals(this.predictInstanceSchemaUri, googleCloudAiplatformV1ModelDeploymentMonitoringJob.predictInstanceSchemaUri) &&
        Objects.equals(this.samplePredictInstance, googleCloudAiplatformV1ModelDeploymentMonitoringJob.samplePredictInstance) &&
        Objects.equals(this.scheduleState, googleCloudAiplatformV1ModelDeploymentMonitoringJob.scheduleState) &&
        Objects.equals(this.state, googleCloudAiplatformV1ModelDeploymentMonitoringJob.state) &&
        Objects.equals(this.statsAnomaliesBaseDirectory, googleCloudAiplatformV1ModelDeploymentMonitoringJob.statsAnomaliesBaseDirectory) &&
        Objects.equals(this.updateTime, googleCloudAiplatformV1ModelDeploymentMonitoringJob.updateTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudAiplatformV1ModelDeploymentMonitoringJob {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudAiplatformV1ModelDeploymentMonitoringJob
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudAiplatformV1ModelDeploymentMonitoringJob.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudAiplatformV1ModelDeploymentMonitoringJob is not found in the empty JSON string", GoogleCloudAiplatformV1ModelDeploymentMonitoringJob.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudAiplatformV1ModelDeploymentMonitoringJob.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudAiplatformV1ModelDeploymentMonitoringJob` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("bigqueryTables") != null && !jsonObj.get("bigqueryTables").isJsonNull()) {
        ...
        if (jsonArraybigqueryTables != null) {
          ...
          for (int i = 0; i < jsonArraybigqueryTables.size(); i++) {
            GoogleCloudAiplatformV1ModelDeploymentMonitoringBigQueryTable.validateJsonElement(jsonArraybigqueryTables.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("latestMonitoringPipelineMetadata") != null && !jsonObj.get("latestMonitoringPipelineMetadata").isJsonNull()) {
        GoogleCloudAiplatformV1ModelDeploymentMonitoringJobLatestMonitoringPipelineMetadata.validateJsonElement(jsonObj.get("latestMonitoringPipelineMetadata"));
      }
      ...
      if (jsonObj.get("modelDeploymentMonitoringObjectiveConfigs") != null && !jsonObj.get("modelDeploymentMonitoringObjectiveConfigs").isJsonNull()) {
        ...
        if (jsonArraymodelDeploymentMonitoringObjectiveConfigs != null) {
          ...
          for (int i = 0; i < jsonArraymodelDeploymentMonitoringObjectiveConfigs.size(); i++) {
            GoogleCloudAiplatformV1ModelDeploymentMonitoringObjectiveConfig.validateJsonElement(jsonArraymodelDeploymentMonitoringObjectiveConfigs.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("modelDeploymentMonitoringScheduleConfig") != null && !jsonObj.get("modelDeploymentMonitoringScheduleConfig").isJsonNull()) {
        GoogleCloudAiplatformV1ModelDeploymentMonitoringScheduleConfig.validateJsonElement(jsonObj.get("modelDeploymentMonitoringScheduleConfig"));
      }
      ...
      if (jsonObj.get("modelMonitoringAlertConfig") != null && !jsonObj.get("modelMonitoringAlertConfig").isJsonNull()) {
        GoogleCloudAiplatformV1ModelMonitoringAlertConfig.validateJsonElement(jsonObj.get("modelMonitoringAlertConfig"));
      }
      ...
      if (jsonObj.get("statsAnomaliesBaseDirectory") != null && !jsonObj.get("statsAnomaliesBaseDirectory").isJsonNull()) {
        GoogleCloudAiplatformV1GcsDestination.validateJsonElement(jsonObj.get("statsAnomaliesBaseDirectory"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudAiplatformV1ModelDeploymentMonitoringJob.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudAiplatformV1ModelDeploymentMonitoringJob' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudAiplatformV1ModelDeploymentMonitoringJob> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudAiplatformV1ModelDeploymentMonitoringJob.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudAiplatformV1ModelDeploymentMonitoringJob>() {
           @Override
           public void write(JsonWriter out, GoogleCloudAiplatformV1ModelDeploymentMonitoringJob value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudAiplatformV1ModelDeploymentMonitoringJob read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudAiplatformV1ModelDeploymentMonitoringJob given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudAiplatformV1ModelDeploymentMonitoringJob
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudAiplatformV1ModelDeploymentMonitoringJob
   */
  public static GoogleCloudAiplatformV1ModelDeploymentMonitoringJob fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudAiplatformV1ModelDeploymentMonitoringJob.class);
  }

  /**
   * Convert an instance of GoogleCloudAiplatformV1ModelDeploymentMonitoringJob to an JSON string
   *
   * @return JSON string
   */
