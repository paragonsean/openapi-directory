...
public class GoogleCloudAiplatformV1Explanation {
  ...
  private List<GoogleCloudAiplatformV1Attribution> attributions = new ArrayList<>();

  public static final String SERIALIZED_NAME_NEIGHBORS = "neighbors";
  @SerializedName(SERIALIZED_NAME_NEIGHBORS)
  private List<GoogleCloudAiplatformV1Neighbor> neighbors = new ArrayList<>();

  public GoogleCloudAiplatformV1Explanation() {
  }

  public GoogleCloudAiplatformV1Explanation(
     List<GoogleCloudAiplatformV1Attribution> attributions, 
  ...
  public List<GoogleCloudAiplatformV1Attribution> getAttributions() {
    return attributions;
  }
   ...
   */
  @javax.annotation.Nullable
  public List<GoogleCloudAiplatformV1Neighbor> getNeighbors() {
    return neighbors;
  }
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudAiplatformV1Explanation googleCloudAiplatformV1Explanation = (GoogleCloudAiplatformV1Explanation) o;
    return Objects.equals(this.attributions, googleCloudAiplatformV1Explanation.attributions) &&
        Objects.equals(this.neighbors, googleCloudAiplatformV1Explanation.neighbors);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudAiplatformV1Explanation {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudAiplatformV1Explanation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudAiplatformV1Explanation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudAiplatformV1Explanation is not found in the empty JSON string", GoogleCloudAiplatformV1Explanation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudAiplatformV1Explanation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudAiplatformV1Explanation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("attributions") != null && !jsonObj.get("attributions").isJsonNull()) {
        ...
        if (jsonArrayattributions != null) {
          ...
          for (int i = 0; i < jsonArrayattributions.size(); i++) {
            GoogleCloudAiplatformV1Attribution.validateJsonElement(jsonArrayattributions.get(i));
          };
        }
      }
      if (jsonObj.get("neighbors") != null && !jsonObj.get("neighbors").isJsonNull()) {
        ...
        if (jsonArrayneighbors != null) {
          ...
          for (int i = 0; i < jsonArrayneighbors.size(); i++) {
            GoogleCloudAiplatformV1Neighbor.validateJsonElement(jsonArrayneighbors.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudAiplatformV1Explanation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudAiplatformV1Explanation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudAiplatformV1Explanation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudAiplatformV1Explanation.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudAiplatformV1Explanation>() {
           @Override
           public void write(JsonWriter out, GoogleCloudAiplatformV1Explanation value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudAiplatformV1Explanation read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudAiplatformV1Explanation given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudAiplatformV1Explanation
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudAiplatformV1Explanation
   */
  public static GoogleCloudAiplatformV1Explanation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudAiplatformV1Explanation.class);
  }

  /**
   * Convert an instance of GoogleCloudAiplatformV1Explanation to an JSON string
   *
   * @return JSON string
   */
