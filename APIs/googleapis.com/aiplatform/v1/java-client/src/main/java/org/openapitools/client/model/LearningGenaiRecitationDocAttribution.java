...
public class LearningGenaiRecitationDocAttribution {
  ...
  public LearningGenaiRecitationDocAttribution() {
  }

  public LearningGenaiRecitationDocAttribution amarnaId(String amarnaId) {
  ...
  public LearningGenaiRecitationDocAttribution arxivId(String arxivId) {
  ...
  public LearningGenaiRecitationDocAttribution author(String author) {
    this.author = author;
    return this;
  }
  ...
  public LearningGenaiRecitationDocAttribution bibkey(String bibkey) {
    this.bibkey = bibkey;
    return this;
  }
  ...
  public LearningGenaiRecitationDocAttribution biorxivId(String biorxivId) {
  ...
  public LearningGenaiRecitationDocAttribution bookTitle(String bookTitle) {
  ...
  public LearningGenaiRecitationDocAttribution bookVolumeId(String bookVolumeId) {
  ...
  public LearningGenaiRecitationDocAttribution conversationId(String conversationId) {
  ...
  public LearningGenaiRecitationDocAttribution dataset(DatasetEnum dataset) {
  ...
  public LearningGenaiRecitationDocAttribution filepath(String filepath) {
  ...
  public LearningGenaiRecitationDocAttribution geminiId(String geminiId) {
  ...
  public LearningGenaiRecitationDocAttribution gnewsArticleTitle(String gnewsArticleTitle) {
  ...
  public LearningGenaiRecitationDocAttribution goodallExampleId(String goodallExampleId) {
  ...
  public LearningGenaiRecitationDocAttribution isOptOut(Boolean isOptOut) {
  ...
  public LearningGenaiRecitationDocAttribution isPrompt(Boolean isPrompt) {
  ...
  public LearningGenaiRecitationDocAttribution lamdaExampleId(String lamdaExampleId) {
  ...
  public LearningGenaiRecitationDocAttribution license(String license) {
  ...
  public LearningGenaiRecitationDocAttribution meenaConversationId(String meenaConversationId) {
  ...
  public LearningGenaiRecitationDocAttribution naturalLanguageCode(String naturalLanguageCode) {
  ...
  public LearningGenaiRecitationDocAttribution noAttribution(Boolean noAttribution) {
  ...
  public LearningGenaiRecitationDocAttribution podcastUtteranceId(String podcastUtteranceId) {
  ...
  public LearningGenaiRecitationDocAttribution publicationDate(GoogleTypeDate publicationDate) {
  ...
  public LearningGenaiRecitationDocAttribution qualityScoreExperimentOnly(Double qualityScoreExperimentOnly) {
  ...
  public LearningGenaiRecitationDocAttribution repo(String repo) {
    this.repo = repo;
    return this;
  }
  ...
  public LearningGenaiRecitationDocAttribution url(String url) {
    this.url = url;
    return this;
  }
  ...
  public LearningGenaiRecitationDocAttribution volumeId(String volumeId) {
  ...
  public LearningGenaiRecitationDocAttribution wikipediaArticleTitle(String wikipediaArticleTitle) {
  ...
  public LearningGenaiRecitationDocAttribution youtubeVideoId(String youtubeVideoId) {
  ...
  public boolean equals(Object o) {
    ...
    LearningGenaiRecitationDocAttribution learningGenaiRecitationDocAttribution = (LearningGenaiRecitationDocAttribution) o;
    return Objects.equals(this.amarnaId, learningGenaiRecitationDocAttribution.amarnaId) &&
        Objects.equals(this.arxivId, learningGenaiRecitationDocAttribution.arxivId) &&
        Objects.equals(this.author, learningGenaiRecitationDocAttribution.author) &&
        Objects.equals(this.bibkey, learningGenaiRecitationDocAttribution.bibkey) &&
        Objects.equals(this.biorxivId, learningGenaiRecitationDocAttribution.biorxivId) &&
        Objects.equals(this.bookTitle, learningGenaiRecitationDocAttribution.bookTitle) &&
        Objects.equals(this.bookVolumeId, learningGenaiRecitationDocAttribution.bookVolumeId) &&
        Objects.equals(this.conversationId, learningGenaiRecitationDocAttribution.conversationId) &&
        Objects.equals(this.dataset, learningGenaiRecitationDocAttribution.dataset) &&
        Objects.equals(this.filepath, learningGenaiRecitationDocAttribution.filepath) &&
        Objects.equals(this.geminiId, learningGenaiRecitationDocAttribution.geminiId) &&
        Objects.equals(this.gnewsArticleTitle, learningGenaiRecitationDocAttribution.gnewsArticleTitle) &&
        Objects.equals(this.goodallExampleId, learningGenaiRecitationDocAttribution.goodallExampleId) &&
        Objects.equals(this.isOptOut, learningGenaiRecitationDocAttribution.isOptOut) &&
        Objects.equals(this.isPrompt, learningGenaiRecitationDocAttribution.isPrompt) &&
        Objects.equals(this.lamdaExampleId, learningGenaiRecitationDocAttribution.lamdaExampleId) &&
        Objects.equals(this.license, learningGenaiRecitationDocAttribution.license) &&
        Objects.equals(this.meenaConversationId, learningGenaiRecitationDocAttribution.meenaConversationId) &&
        Objects.equals(this.naturalLanguageCode, learningGenaiRecitationDocAttribution.naturalLanguageCode) &&
        Objects.equals(this.noAttribution, learningGenaiRecitationDocAttribution.noAttribution) &&
        Objects.equals(this.podcastUtteranceId, learningGenaiRecitationDocAttribution.podcastUtteranceId) &&
        Objects.equals(this.publicationDate, learningGenaiRecitationDocAttribution.publicationDate) &&
        Objects.equals(this.qualityScoreExperimentOnly, learningGenaiRecitationDocAttribution.qualityScoreExperimentOnly) &&
        Objects.equals(this.repo, learningGenaiRecitationDocAttribution.repo) &&
        Objects.equals(this.url, learningGenaiRecitationDocAttribution.url) &&
        Objects.equals(this.volumeId, learningGenaiRecitationDocAttribution.volumeId) &&
        Objects.equals(this.wikipediaArticleTitle, learningGenaiRecitationDocAttribution.wikipediaArticleTitle) &&
        Objects.equals(this.youtubeVideoId, learningGenaiRecitationDocAttribution.youtubeVideoId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(amarnaId, arxivId, author, bibkey, biorxivId, bookTitle, bookVolumeId, conversationId, dataset, filepath, geminiId, gnewsArticleTitle, goodallExampleId, isOptOut, isPrompt, lamdaExampleId, license, meenaConversationId, naturalLanguageCode, noAttribution, podcastUtteranceId, publicationDate, qualityScoreExperimentOnly, repo, url, volumeId, wikipediaArticleTitle, youtubeVideoId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LearningGenaiRecitationDocAttribution {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LearningGenaiRecitationDocAttribution
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LearningGenaiRecitationDocAttribution.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LearningGenaiRecitationDocAttribution is not found in the empty JSON string", LearningGenaiRecitationDocAttribution.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LearningGenaiRecitationDocAttribution.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LearningGenaiRecitationDocAttribution` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LearningGenaiRecitationDocAttribution.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LearningGenaiRecitationDocAttribution' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LearningGenaiRecitationDocAttribution> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LearningGenaiRecitationDocAttribution.class));

       return (TypeAdapter<T>) new TypeAdapter<LearningGenaiRecitationDocAttribution>() {
           @Override
           public void write(JsonWriter out, LearningGenaiRecitationDocAttribution value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LearningGenaiRecitationDocAttribution read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LearningGenaiRecitationDocAttribution given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LearningGenaiRecitationDocAttribution
   * @throws IOException if the JSON string is invalid with respect to LearningGenaiRecitationDocAttribution
   */
  public static LearningGenaiRecitationDocAttribution fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LearningGenaiRecitationDocAttribution.class);
  }

  /**
   * Convert an instance of LearningGenaiRecitationDocAttribution to an JSON string
   *
   * @return JSON string
   */
