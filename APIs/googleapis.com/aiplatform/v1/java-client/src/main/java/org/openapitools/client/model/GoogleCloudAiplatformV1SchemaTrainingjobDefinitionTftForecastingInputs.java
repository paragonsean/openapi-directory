...
public class GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs {
  ...
  private List<GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputsTransformation> transformations = new ArrayList<>();
  ...
  public GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs() {
  }

  public GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs additionalExperiments(List<String> additionalExperiments) {
    this.additionalExperiments = additionalExperiments;
    return this;
  }

  public GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs addAdditionalExperimentsItem(String additionalExperimentsItem) {
  ...
  public GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs availableAtForecastColumns(List<String> availableAtForecastColumns) {
    this.availableAtForecastColumns = availableAtForecastColumns;
    return this;
  }

  public GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs addAvailableAtForecastColumnsItem(String availableAtForecastColumnsItem) {
  ...
  public GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs contextWindow(String contextWindow) {
  ...
  public GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs dataGranularity(GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputsGranularity dataGranularity) {
  ...
  public void setDataGranularity(GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputsGranularity dataGranularity) {
    this.dataGranularity = dataGranularity;
  }


  public GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs exportEvaluatedDataItemsConfig(GoogleCloudAiplatformV1SchemaTrainingjobDefinitionExportEvaluatedDataItemsConfig exportEvaluatedDataItemsConfig) {
  ...
  public GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs forecastHorizon(String forecastHorizon) {
  ...
  public GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs hierarchyConfig(GoogleCloudAiplatformV1SchemaTrainingjobDefinitionHierarchyConfig hierarchyConfig) {
  ...
  public GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs holidayRegions(List<String> holidayRegions) {
    this.holidayRegions = holidayRegions;
    return this;
  }

  public GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs addHolidayRegionsItem(String holidayRegionsItem) {
  ...
  public GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs optimizationObjective(String optimizationObjective) {
  ...
  public GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs quantiles(List<Double> quantiles) {
    this.quantiles = quantiles;
    return this;
  }

  public GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs addQuantilesItem(Double quantilesItem) {
  ...
  public GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs targetColumn(String targetColumn) {
  ...
  public GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs timeColumn(String timeColumn) {
  ...
  public GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs timeSeriesAttributeColumns(List<String> timeSeriesAttributeColumns) {
    this.timeSeriesAttributeColumns = timeSeriesAttributeColumns;
    return this;
  }

  public GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs addTimeSeriesAttributeColumnsItem(String timeSeriesAttributeColumnsItem) {
  ...
  public GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs timeSeriesIdentifierColumn(String timeSeriesIdentifierColumn) {
  ...
  public GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs trainBudgetMilliNodeHours(String trainBudgetMilliNodeHours) {
  ...
  public GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs transformations(List<GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputsTransformation> transformations) {
    this.transformations = transformations;
    return this;
  }

  public GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs addTransformationsItem(GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputsTransformation transformationsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputsTransformation> getTransformations() {
    return transformations;
  }

  public void setTransformations(List<GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputsTransformation> transformations) {
    this.transformations = transformations;
  }


  public GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs unavailableAtForecastColumns(List<String> unavailableAtForecastColumns) {
    this.unavailableAtForecastColumns = unavailableAtForecastColumns;
    return this;
  }

  public GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs addUnavailableAtForecastColumnsItem(String unavailableAtForecastColumnsItem) {
  ...
  public GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs validationOptions(String validationOptions) {
  ...
  public GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs weightColumn(String weightColumn) {
  ...
  public GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs windowConfig(GoogleCloudAiplatformV1SchemaTrainingjobDefinitionWindowConfig windowConfig) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs googleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs = (GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs) o;
    return Objects.equals(this.additionalExperiments, googleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs.additionalExperiments) &&
        Objects.equals(this.availableAtForecastColumns, googleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs.availableAtForecastColumns) &&
        Objects.equals(this.contextWindow, googleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs.contextWindow) &&
        Objects.equals(this.dataGranularity, googleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs.dataGranularity) &&
        Objects.equals(this.exportEvaluatedDataItemsConfig, googleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs.exportEvaluatedDataItemsConfig) &&
        Objects.equals(this.forecastHorizon, googleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs.forecastHorizon) &&
        Objects.equals(this.hierarchyConfig, googleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs.hierarchyConfig) &&
        Objects.equals(this.holidayRegions, googleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs.holidayRegions) &&
        Objects.equals(this.optimizationObjective, googleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs.optimizationObjective) &&
        Objects.equals(this.quantiles, googleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs.quantiles) &&
        Objects.equals(this.targetColumn, googleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs.targetColumn) &&
        Objects.equals(this.timeColumn, googleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs.timeColumn) &&
        Objects.equals(this.timeSeriesAttributeColumns, googleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs.timeSeriesAttributeColumns) &&
        Objects.equals(this.timeSeriesIdentifierColumn, googleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs.timeSeriesIdentifierColumn) &&
        Objects.equals(this.trainBudgetMilliNodeHours, googleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs.trainBudgetMilliNodeHours) &&
        Objects.equals(this.transformations, googleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs.transformations) &&
        Objects.equals(this.unavailableAtForecastColumns, googleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs.unavailableAtForecastColumns) &&
        Objects.equals(this.validationOptions, googleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs.validationOptions) &&
        Objects.equals(this.weightColumn, googleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs.weightColumn) &&
        Objects.equals(this.windowConfig, googleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs.windowConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs is not found in the empty JSON string", GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("dataGranularity") != null && !jsonObj.get("dataGranularity").isJsonNull()) {
        GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputsGranularity.validateJsonElement(jsonObj.get("dataGranularity"));
      }
      ...
      if (jsonObj.get("transformations") != null && !jsonObj.get("transformations").isJsonNull()) {
        ...
        if (jsonArraytransformations != null) {
          ...
          for (int i = 0; i < jsonArraytransformations.size(); i++) {
            GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputsTransformation.validateJsonElement(jsonArraytransformations.get(i));
          };
        }
      }
      // ensure the optional json data is an array if present
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs>() {
           @Override
           public void write(JsonWriter out, GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs
   */
  public static GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs.class);
  }

  /**
   * Convert an instance of GoogleCloudAiplatformV1SchemaTrainingjobDefinitionTftForecastingInputs to an JSON string
   *
   * @return JSON string
   */
