# VertexAiApi.GoogleCloudAiplatformV1beta1Trial
...
**measurements** | [**[GoogleCloudAiplatformV1beta1Measurement]**](GoogleCloudAiplatformV1beta1Measurement.md) | Output only. A list of measurements that are strictly lexicographically ordered by their induced tuples (steps, elapsed_duration). These are used for early stopping computations. | [optional] [readonly] 
**name** | **String** | Output only. Resource name of the Trial assigned by the service. | [optional] [readonly] 
**parameters** | [**[GoogleCloudAiplatformV1beta1TrialParameter]**](GoogleCloudAiplatformV1beta1TrialParameter.md) | Output only. The parameters of the Trial. | [optional] [readonly] 
