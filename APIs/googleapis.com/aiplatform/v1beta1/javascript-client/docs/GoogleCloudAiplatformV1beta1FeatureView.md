# VertexAiApi.GoogleCloudAiplatformV1beta1FeatureView
...
* `UNSPECIFIED` (value: `"SERVICE_AGENT_TYPE_UNSPECIFIED"`)

* `PROJECT` (value: `"SERVICE_AGENT_TYPE_PROJECT"`)

* `FEATURE_VIEW` (value: `"SERVICE_AGENT_TYPE_FEATURE_VIEW"`)
