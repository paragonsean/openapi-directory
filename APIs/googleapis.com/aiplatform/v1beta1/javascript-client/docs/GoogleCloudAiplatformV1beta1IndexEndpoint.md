# VertexAiApi.GoogleCloudAiplatformV1beta1IndexEndpoint
...
**deployedIndexes** | [**[GoogleCloudAiplatformV1beta1DeployedIndex]**](GoogleCloudAiplatformV1beta1DeployedIndex.md) | Output only. The indexes deployed in this endpoint. | [optional] [readonly] 
...
**labels** | **{String: String}** | The labels with user-defined metadata to organize your IndexEndpoints. Label keys and values can be no longer than 64 characters (Unicode codepoints), can only contain lowercase letters, numeric characters, underscores and dashes. International characters are allowed. See https://goo.gl/xmQnxf for more information and examples of labels. | [optional] 
