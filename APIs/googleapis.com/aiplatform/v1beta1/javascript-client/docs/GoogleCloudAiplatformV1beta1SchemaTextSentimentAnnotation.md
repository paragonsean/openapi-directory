# VertexAiApi.GoogleCloudAiplatformV1beta1SchemaTextSentimentAnnotation
...
**sentiment** | **Number** | The sentiment score for text. | [optional] 
**sentimentMax** | **Number** | The sentiment max score for text. | [optional] 
