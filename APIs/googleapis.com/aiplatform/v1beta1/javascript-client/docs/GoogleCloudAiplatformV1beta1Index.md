# VertexAiApi.GoogleCloudAiplatformV1beta1Index
...
**deployedIndexes** | [**[GoogleCloudAiplatformV1beta1DeployedIndexRef]**](GoogleCloudAiplatformV1beta1DeployedIndexRef.md) | Output only. The pointers to DeployedIndexes created from this Index. An Index can be only deleted if all its DeployedIndexes had been undeployed first. | [optional] [readonly] 
