# VertexAiApi.GoogleCloudAiplatformV1beta1Model
...
**deployedModels** | [**[GoogleCloudAiplatformV1beta1DeployedModelRef]**](GoogleCloudAiplatformV1beta1DeployedModelRef.md) | Output only. The pointers to DeployedModels created from this Model. Note that Model could have been deployed to Endpoints in different Locations. | [optional] [readonly] 
...
**supportedExportFormats** | [**[GoogleCloudAiplatformV1beta1ModelExportFormat]**](GoogleCloudAiplatformV1beta1ModelExportFormat.md) | Output only. The formats in which this Model may be exported. If empty, this Model is not available for export. | [optional] [readonly] 
