...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VertexAiApi.GoogleCloudAiplatformV1beta1Tensorboard();
  });
  ...
  describe('GoogleCloudAiplatformV1beta1Tensorboard', function() {
    it('should create an instance of GoogleCloudAiplatformV1beta1Tensorboard', function() {
      // uncomment below and update the code to test GoogleCloudAiplatformV1beta1Tensorboard
      //var instance = new VertexAiApi.GoogleCloudAiplatformV1beta1Tensorboard();
      //expect(instance).to.be.a(VertexAiApi.GoogleCloudAiplatformV1beta1Tensorboard);
    });

    it('should have the property blobStoragePathPrefix (base name: "blobStoragePathPrefix")', function() {
      // uncomment below and update the code to test the property blobStoragePathPrefix
      //var instance = new VertexAiApi.GoogleCloudAiplatformV1beta1Tensorboard();
