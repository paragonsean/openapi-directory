...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VertexAiApi.GoogleCloudAiplatformV1beta1Schema();
  });
  ...
  describe('GoogleCloudAiplatformV1beta1Schema', function() {
    it('should create an instance of GoogleCloudAiplatformV1beta1Schema', function() {
      // uncomment below and update the code to test GoogleCloudAiplatformV1beta1Schema
      //var instance = new VertexAiApi.GoogleCloudAiplatformV1beta1Schema();
      //expect(instance).to.be.a(VertexAiApi.GoogleCloudAiplatformV1beta1Schema);
    });
