...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VertexAiApi.GoogleCloudAiplatformV1beta1Probe();
  });
  ...
  describe('GoogleCloudAiplatformV1beta1Probe', function() {
    it('should create an instance of GoogleCloudAiplatformV1beta1Probe', function() {
      // uncomment below and update the code to test GoogleCloudAiplatformV1beta1Probe
      //var instance = new VertexAiApi.GoogleCloudAiplatformV1beta1Probe();
      //expect(instance).to.be.a(VertexAiApi.GoogleCloudAiplatformV1beta1Probe);
    });
