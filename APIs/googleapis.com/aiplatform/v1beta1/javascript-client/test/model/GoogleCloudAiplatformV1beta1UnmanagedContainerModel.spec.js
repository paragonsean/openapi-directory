...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VertexAiApi.GoogleCloudAiplatformV1beta1UnmanagedContainerModel();
  });
  ...
  describe('GoogleCloudAiplatformV1beta1UnmanagedContainerModel', function() {
    it('should create an instance of GoogleCloudAiplatformV1beta1UnmanagedContainerModel', function() {
      // uncomment below and update the code to test GoogleCloudAiplatformV1beta1UnmanagedContainerModel
      //var instance = new VertexAiApi.GoogleCloudAiplatformV1beta1UnmanagedContainerModel();
      //expect(instance).to.be.a(VertexAiApi.GoogleCloudAiplatformV1beta1UnmanagedContainerModel);
    });
