...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VertexAiApi.GoogleCloudAiplatformV1beta1Model();
  });
  ...
  describe('GoogleCloudAiplatformV1beta1Model', function() {
    it('should create an instance of GoogleCloudAiplatformV1beta1Model', function() {
      // uncomment below and update the code to test GoogleCloudAiplatformV1beta1Model
      //var instance = new VertexAiApi.GoogleCloudAiplatformV1beta1Model();
      //expect(instance).to.be.a(VertexAiApi.GoogleCloudAiplatformV1beta1Model);
    });
    ...
    it('should have the property baseModelSource (base name: "baseModelSource")', function() {
      // uncomment below and update the code to test the property baseModelSource
      //var instance = new VertexAiApi.GoogleCloudAiplatformV1beta1Model();
      //expect(instance).to.be();
    });
