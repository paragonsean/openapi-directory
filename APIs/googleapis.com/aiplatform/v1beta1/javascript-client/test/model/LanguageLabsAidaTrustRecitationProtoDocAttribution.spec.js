...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VertexAiApi.LanguageLabsAidaTrustRecitationProtoDocAttribution();
  });
  ...
  describe('LanguageLabsAidaTrustRecitationProtoDocAttribution', function() {
    it('should create an instance of LanguageLabsAidaTrustRecitationProtoDocAttribution', function() {
      // uncomment below and update the code to test LanguageLabsAidaTrustRecitationProtoDocAttribution
      //var instance = new VertexAiApi.LanguageLabsAidaTrustRecitationProtoDocAttribution();
      //expect(instance).to.be.a(VertexAiApi.LanguageLabsAidaTrustRecitationProtoDocAttribution);
    });
