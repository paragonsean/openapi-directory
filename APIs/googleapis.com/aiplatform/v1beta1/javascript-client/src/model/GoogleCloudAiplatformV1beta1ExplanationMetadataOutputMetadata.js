...
/**
 * The GoogleCloudAiplatformV1beta1ExplanationMetadataOutputMetadata model module.
 * @module model/GoogleCloudAiplatformV1beta1ExplanationMetadataOutputMetadata
 * @version v1beta1
 */
class GoogleCloudAiplatformV1beta1ExplanationMetadataOutputMetadata {
    /**
     * Constructs a new <code>GoogleCloudAiplatformV1beta1ExplanationMetadataOutputMetadata</code>.
     * Metadata of the prediction output to be explained.
     * @alias module:model/GoogleCloudAiplatformV1beta1ExplanationMetadataOutputMetadata
     */
    constructor() { 
        
        GoogleCloudAiplatformV1beta1ExplanationMetadataOutputMetadata.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudAiplatformV1beta1ExplanationMetadataOutputMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudAiplatformV1beta1ExplanationMetadataOutputMetadata} obj Optional instance to populate.
     * @return {module:model/GoogleCloudAiplatformV1beta1ExplanationMetadataOutputMetadata} The populated <code>GoogleCloudAiplatformV1beta1ExplanationMetadataOutputMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudAiplatformV1beta1ExplanationMetadataOutputMetadata();
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudAiplatformV1beta1ExplanationMetadataOutputMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudAiplatformV1beta1ExplanationMetadataOutputMetadata</code>.
     */
 ...
 */
GoogleCloudAiplatformV1beta1ExplanationMetadataOutputMetadata.prototype['displayNameMappingKey'] = undefined;
 ...
 */
GoogleCloudAiplatformV1beta1ExplanationMetadataOutputMetadata.prototype['indexDisplayNameMapping'] = undefined;
 ...
 */
GoogleCloudAiplatformV1beta1ExplanationMetadataOutputMetadata.prototype['outputTensorName'] = undefined;
...
export default GoogleCloudAiplatformV1beta1ExplanationMetadataOutputMetadata;
