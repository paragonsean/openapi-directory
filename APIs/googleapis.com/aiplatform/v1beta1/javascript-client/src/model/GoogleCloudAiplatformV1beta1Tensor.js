...
/**
 * The GoogleCloudAiplatformV1beta1Tensor model module.
 * @module model/GoogleCloudAiplatformV1beta1Tensor
 * @version v1beta1
 */
class GoogleCloudAiplatformV1beta1Tensor {
    /**
     * Constructs a new <code>GoogleCloudAiplatformV1beta1Tensor</code>.
     * A tensor value type.
     * @alias module:model/GoogleCloudAiplatformV1beta1Tensor
     */
    constructor() { 
        
        GoogleCloudAiplatformV1beta1Tensor.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudAiplatformV1beta1Tensor</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudAiplatformV1beta1Tensor} obj Optional instance to populate.
     * @return {module:model/GoogleCloudAiplatformV1beta1Tensor} The populated <code>GoogleCloudAiplatformV1beta1Tensor</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudAiplatformV1beta1Tensor();
            ...
            if (data.hasOwnProperty('listVal')) {
                obj['listVal'] = ApiClient.convertToType(data['listVal'], [GoogleCloudAiplatformV1beta1Tensor]);
            }
            ...
            if (data.hasOwnProperty('structVal')) {
                obj['structVal'] = ApiClient.convertToType(data['structVal'], {'String': GoogleCloudAiplatformV1beta1Tensor});
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudAiplatformV1beta1Tensor</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudAiplatformV1beta1Tensor</code>.
     */
 ...
 */
GoogleCloudAiplatformV1beta1Tensor.prototype['boolVal'] = undefined;

/**
 * STRING
 * @member {Array.<Blob>} bytesVal
 */
GoogleCloudAiplatformV1beta1Tensor.prototype['bytesVal'] = undefined;

/**
 * DOUBLE
 * @member {Array.<Number>} doubleVal
 */
GoogleCloudAiplatformV1beta1Tensor.prototype['doubleVal'] = undefined;

/**
 * The data type of tensor.
 * @member {module:model/GoogleCloudAiplatformV1beta1Tensor.DtypeEnum} dtype
 */
GoogleCloudAiplatformV1beta1Tensor.prototype['dtype'] = undefined;

/**
 * FLOAT
 * @member {Array.<Number>} floatVal
 */
GoogleCloudAiplatformV1beta1Tensor.prototype['floatVal'] = undefined;

/**
 * INT64
 * @member {Array.<String>} int64Val
 */
GoogleCloudAiplatformV1beta1Tensor.prototype['int64Val'] = undefined;

/**
 * INT_8 INT_16 INT_32
 * @member {Array.<Number>} intVal
 */
GoogleCloudAiplatformV1beta1Tensor.prototype['intVal'] = undefined;

/**
 * A list of tensor values.
 * @member {Array.<module:model/GoogleCloudAiplatformV1beta1Tensor>} listVal
 */
GoogleCloudAiplatformV1beta1Tensor.prototype['listVal'] = undefined;

/**
 * Shape of the tensor.
 * @member {Array.<String>} shape
 */
GoogleCloudAiplatformV1beta1Tensor.prototype['shape'] = undefined;

/**
 * STRING
 * @member {Array.<String>} stringVal
 */
GoogleCloudAiplatformV1beta1Tensor.prototype['stringVal'] = undefined;

/**
 * A map of string to tensor.
 * @member {Object.<String, module:model/GoogleCloudAiplatformV1beta1Tensor>} structVal
 */
GoogleCloudAiplatformV1beta1Tensor.prototype['structVal'] = undefined;

/**
 * Serialized raw tensor content.
 * @member {Blob} tensorVal
 */
GoogleCloudAiplatformV1beta1Tensor.prototype['tensorVal'] = undefined;

/**
 * UINT64
 * @member {Array.<String>} uint64Val
 */
GoogleCloudAiplatformV1beta1Tensor.prototype['uint64Val'] = undefined;

/**
 * UINT8 UINT16 UINT32
 * @member {Array.<Number>} uintVal
 */
GoogleCloudAiplatformV1beta1Tensor.prototype['uintVal'] = undefined;
 ...
 * @readonly
 */
GoogleCloudAiplatformV1beta1Tensor['DtypeEnum'] = {
...
export default GoogleCloudAiplatformV1beta1Tensor;
