...
import GoogleCloudAiplatformV1beta1ErrorAnalysisAnnotation from './GoogleCloudAiplatformV1beta1ErrorAnalysisAnnotation';
import GoogleCloudAiplatformV1beta1EvaluatedAnnotationExplanation from './GoogleCloudAiplatformV1beta1EvaluatedAnnotationExplanation';

/**
 * The GoogleCloudAiplatformV1beta1EvaluatedAnnotation model module.
 * @module model/GoogleCloudAiplatformV1beta1EvaluatedAnnotation
 * @version v1beta1
 */
class GoogleCloudAiplatformV1beta1EvaluatedAnnotation {
    /**
     * Constructs a new <code>GoogleCloudAiplatformV1beta1EvaluatedAnnotation</code>.
     ...
     * @alias module:model/GoogleCloudAiplatformV1beta1EvaluatedAnnotation
     */
    constructor() { 
        
        GoogleCloudAiplatformV1beta1EvaluatedAnnotation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudAiplatformV1beta1EvaluatedAnnotation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudAiplatformV1beta1EvaluatedAnnotation} obj Optional instance to populate.
     * @return {module:model/GoogleCloudAiplatformV1beta1EvaluatedAnnotation} The populated <code>GoogleCloudAiplatformV1beta1EvaluatedAnnotation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudAiplatformV1beta1EvaluatedAnnotation();
            ...
            if (data.hasOwnProperty('errorAnalysisAnnotations')) {
                obj['errorAnalysisAnnotations'] = ApiClient.convertToType(data['errorAnalysisAnnotations'], [GoogleCloudAiplatformV1beta1ErrorAnalysisAnnotation]);
            }
            ...
            if (data.hasOwnProperty('explanations')) {
                obj['explanations'] = ApiClient.convertToType(data['explanations'], [GoogleCloudAiplatformV1beta1EvaluatedAnnotationExplanation]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudAiplatformV1beta1EvaluatedAnnotation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudAiplatformV1beta1EvaluatedAnnotation</code>.
     */
    static validateJSON(data) {
        if (data['errorAnalysisAnnotations']) { // data not null
            ...
            for (const item of data['errorAnalysisAnnotations']) {
                GoogleCloudAiplatformV1beta1ErrorAnalysisAnnotation.validateJSON(item);
            };
        }
        ...
        if (data['explanations']) { // data not null
            ...
            for (const item of data['explanations']) {
                GoogleCloudAiplatformV1beta1EvaluatedAnnotationExplanation.validateJSON(item);
            };
        }
        // ensure the json data is an array
 ...
 */
GoogleCloudAiplatformV1beta1EvaluatedAnnotation.prototype['dataItemPayload'] = undefined;

/**
 * Annotations of model error analysis results.
 * @member {Array.<module:model/GoogleCloudAiplatformV1beta1ErrorAnalysisAnnotation>} errorAnalysisAnnotations
 */
GoogleCloudAiplatformV1beta1EvaluatedAnnotation.prototype['errorAnalysisAnnotations'] = undefined;
 ...
 */
GoogleCloudAiplatformV1beta1EvaluatedAnnotation.prototype['evaluatedDataItemViewId'] = undefined;
 ...
 * @member {Array.<module:model/GoogleCloudAiplatformV1beta1EvaluatedAnnotationExplanation>} explanations
 */
GoogleCloudAiplatformV1beta1EvaluatedAnnotation.prototype['explanations'] = undefined;
 ...
 */
GoogleCloudAiplatformV1beta1EvaluatedAnnotation.prototype['groundTruths'] = undefined;
 ...
 */
GoogleCloudAiplatformV1beta1EvaluatedAnnotation.prototype['predictions'] = undefined;

/**
 * Output only. Type of the EvaluatedAnnotation.
 * @member {module:model/GoogleCloudAiplatformV1beta1EvaluatedAnnotation.TypeEnum} type
 */
GoogleCloudAiplatformV1beta1EvaluatedAnnotation.prototype['type'] = undefined;
 ...
 * @readonly
 */
GoogleCloudAiplatformV1beta1EvaluatedAnnotation['TypeEnum'] = {
...
export default GoogleCloudAiplatformV1beta1EvaluatedAnnotation;
