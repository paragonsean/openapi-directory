...
import GoogleCloudAiplatformV1beta1ModelBaseModelSource from './GoogleCloudAiplatformV1beta1ModelBaseModelSource';
import GoogleCloudAiplatformV1beta1ModelContainerSpec from './GoogleCloudAiplatformV1beta1ModelContainerSpec';
import GoogleCloudAiplatformV1beta1ModelExportFormat from './GoogleCloudAiplatformV1beta1ModelExportFormat';
import GoogleCloudAiplatformV1beta1ModelOriginalModelInfo from './GoogleCloudAiplatformV1beta1ModelOriginalModelInfo';
import GoogleCloudAiplatformV1beta1ModelSourceInfo from './GoogleCloudAiplatformV1beta1ModelSourceInfo';
import GoogleCloudAiplatformV1beta1PredictSchemata from './GoogleCloudAiplatformV1beta1PredictSchemata';

/**
 * The GoogleCloudAiplatformV1beta1Model model module.
 * @module model/GoogleCloudAiplatformV1beta1Model
 * @version v1beta1
 */
class GoogleCloudAiplatformV1beta1Model {
    /**
     * Constructs a new <code>GoogleCloudAiplatformV1beta1Model</code>.
     * A trained machine learning Model.
     * @alias module:model/GoogleCloudAiplatformV1beta1Model
     */
    constructor() { 
        
        GoogleCloudAiplatformV1beta1Model.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudAiplatformV1beta1Model</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudAiplatformV1beta1Model} obj Optional instance to populate.
     * @return {module:model/GoogleCloudAiplatformV1beta1Model} The populated <code>GoogleCloudAiplatformV1beta1Model</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudAiplatformV1beta1Model();

            if (data.hasOwnProperty('artifactUri')) {
                obj['artifactUri'] = ApiClient.convertToType(data['artifactUri'], 'String');
            }
            if (data.hasOwnProperty('baseModelSource')) {
                obj['baseModelSource'] = GoogleCloudAiplatformV1beta1ModelBaseModelSource.constructFromObject(data['baseModelSource']);
            }
            ...
            if (data.hasOwnProperty('deployedModels')) {
                obj['deployedModels'] = ApiClient.convertToType(data['deployedModels'], [GoogleCloudAiplatformV1beta1DeployedModelRef]);
            }
            ...
            if (data.hasOwnProperty('modelSourceInfo')) {
                obj['modelSourceInfo'] = GoogleCloudAiplatformV1beta1ModelSourceInfo.constructFromObject(data['modelSourceInfo']);
            }
            if (data.hasOwnProperty('name')) {
                obj['name'] = ApiClient.convertToType(data['name'], 'String');
            }
            if (data.hasOwnProperty('originalModelInfo')) {
                obj['originalModelInfo'] = GoogleCloudAiplatformV1beta1ModelOriginalModelInfo.constructFromObject(data['originalModelInfo']);
            }
            ...
            if (data.hasOwnProperty('supportedExportFormats')) {
                obj['supportedExportFormats'] = ApiClient.convertToType(data['supportedExportFormats'], [GoogleCloudAiplatformV1beta1ModelExportFormat]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudAiplatformV1beta1Model</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudAiplatformV1beta1Model</code>.
     */
    static validateJSON(data) {
        ...
        if (data['baseModelSource']) { // data not null
          GoogleCloudAiplatformV1beta1ModelBaseModelSource.validateJSON(data['baseModelSource']);
        }
        ...
        if (data['modelSourceInfo']) { // data not null
          GoogleCloudAiplatformV1beta1ModelSourceInfo.validateJSON(data['modelSourceInfo']);
        }
        // ensure the json data is a string
        ...
        if (data['originalModelInfo']) { // data not null
          GoogleCloudAiplatformV1beta1ModelOriginalModelInfo.validateJSON(data['originalModelInfo']);
        }
        ...
        if (data['supportedExportFormats']) { // data not null
            ...
            for (const item of data['supportedExportFormats']) {
                GoogleCloudAiplatformV1beta1ModelExportFormat.validateJSON(item);
            };
        }
        // ensure the json data is an array
 ...
 */
GoogleCloudAiplatformV1beta1Model.prototype['artifactUri'] = undefined;

/**
 * @member {module:model/GoogleCloudAiplatformV1beta1ModelBaseModelSource} baseModelSource
 */
GoogleCloudAiplatformV1beta1Model.prototype['baseModelSource'] = undefined;

/**
 * @member {module:model/GoogleCloudAiplatformV1beta1ModelContainerSpec} containerSpec
 */
GoogleCloudAiplatformV1beta1Model.prototype['containerSpec'] = undefined;

/**
 * Output only. Timestamp when this Model was uploaded into Vertex AI.
 * @member {String} createTime
 */
GoogleCloudAiplatformV1beta1Model.prototype['createTime'] = undefined;

/**
 * Output only. The pointers to DeployedModels created from this Model. Note that Model could have been deployed to Endpoints in different Locations.
 * @member {Array.<module:model/GoogleCloudAiplatformV1beta1DeployedModelRef>} deployedModels
 */
GoogleCloudAiplatformV1beta1Model.prototype['deployedModels'] = undefined;

/**
 * The description of the Model.
 * @member {String} description
 */
GoogleCloudAiplatformV1beta1Model.prototype['description'] = undefined;
 ...
 */
GoogleCloudAiplatformV1beta1Model.prototype['displayName'] = undefined;

/**
 * @member {module:model/GoogleCloudAiplatformV1beta1EncryptionSpec} encryptionSpec
 */
GoogleCloudAiplatformV1beta1Model.prototype['encryptionSpec'] = undefined;

/**
 * Used to perform consistent read-modify-write updates. If not set, a blind \"overwrite\" update happens.
 * @member {String} etag
 */
GoogleCloudAiplatformV1beta1Model.prototype['etag'] = undefined;

/**
 * @member {module:model/GoogleCloudAiplatformV1beta1ExplanationSpec} explanationSpec
 */
GoogleCloudAiplatformV1beta1Model.prototype['explanationSpec'] = undefined;

/**
 * The labels with user-defined metadata to organize your Models. Label keys and values can be no longer than 64 characters (Unicode codepoints), can only contain lowercase letters, numeric characters, underscores and dashes. International characters are allowed. See https://goo.gl/xmQnxf for more information and examples of labels.
 * @member {Object.<String, String>} labels
 */
GoogleCloudAiplatformV1beta1Model.prototype['labels'] = undefined;
 ...
 */
GoogleCloudAiplatformV1beta1Model.prototype['metadata'] = undefined;
 ...
 */
GoogleCloudAiplatformV1beta1Model.prototype['metadataArtifact'] = undefined;
 ...
 */
GoogleCloudAiplatformV1beta1Model.prototype['metadataSchemaUri'] = undefined;

/**
 * @member {module:model/GoogleCloudAiplatformV1beta1ModelSourceInfo} modelSourceInfo
 */
GoogleCloudAiplatformV1beta1Model.prototype['modelSourceInfo'] = undefined;

/**
 * The resource name of the Model.
 * @member {String} name
 */
GoogleCloudAiplatformV1beta1Model.prototype['name'] = undefined;

/**
 * @member {module:model/GoogleCloudAiplatformV1beta1ModelOriginalModelInfo} originalModelInfo
 */
GoogleCloudAiplatformV1beta1Model.prototype['originalModelInfo'] = undefined;

/**
 * @member {module:model/GoogleCloudAiplatformV1beta1PredictSchemata} predictSchemata
 */
GoogleCloudAiplatformV1beta1Model.prototype['predictSchemata'] = undefined;
 ...
 * @member {Array.<module:model/GoogleCloudAiplatformV1beta1Model.SupportedDeploymentResourcesTypesEnum>} supportedDeploymentResourcesTypes
 */
GoogleCloudAiplatformV1beta1Model.prototype['supportedDeploymentResourcesTypes'] = undefined;

/**
 * Output only. The formats in which this Model may be exported. If empty, this Model is not available for export.
 * @member {Array.<module:model/GoogleCloudAiplatformV1beta1ModelExportFormat>} supportedExportFormats
 */
GoogleCloudAiplatformV1beta1Model.prototype['supportedExportFormats'] = undefined;
 ...
 */
GoogleCloudAiplatformV1beta1Model.prototype['supportedInputStorageFormats'] = undefined;
 ...
 */
GoogleCloudAiplatformV1beta1Model.prototype['supportedOutputStorageFormats'] = undefined;

/**
 * Output only. The resource name of the TrainingPipeline that uploaded this Model, if any.
 * @member {String} trainingPipeline
 */
GoogleCloudAiplatformV1beta1Model.prototype['trainingPipeline'] = undefined;

/**
 * Output only. Timestamp when this Model was most recently updated.
 * @member {String} updateTime
 */
GoogleCloudAiplatformV1beta1Model.prototype['updateTime'] = undefined;
 ...
 */
GoogleCloudAiplatformV1beta1Model.prototype['versionAliases'] = undefined;

/**
 * Output only. Timestamp when this version was created.
 * @member {String} versionCreateTime
 */
GoogleCloudAiplatformV1beta1Model.prototype['versionCreateTime'] = undefined;

/**
 * The description of this version.
 * @member {String} versionDescription
 */
GoogleCloudAiplatformV1beta1Model.prototype['versionDescription'] = undefined;

/**
 * Output only. Immutable. The version ID of the model. A new version is committed when a new model version is uploaded or trained under an existing model id. It is an auto-incrementing decimal number in string representation.
 * @member {String} versionId
 */
GoogleCloudAiplatformV1beta1Model.prototype['versionId'] = undefined;

/**
 * Output only. Timestamp when this version was most recently updated.
 * @member {String} versionUpdateTime
 */
GoogleCloudAiplatformV1beta1Model.prototype['versionUpdateTime'] = undefined;
 ...
 * @readonly
 */
GoogleCloudAiplatformV1beta1Model['SupportedDeploymentResourcesTypesEnum'] = {
...
export default GoogleCloudAiplatformV1beta1Model;
