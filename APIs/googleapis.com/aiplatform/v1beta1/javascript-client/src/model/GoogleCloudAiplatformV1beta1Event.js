...
/**
 * The GoogleCloudAiplatformV1beta1Event model module.
 * @module model/GoogleCloudAiplatformV1beta1Event
 * @version v1beta1
 */
class GoogleCloudAiplatformV1beta1Event {
    /**
     * Constructs a new <code>GoogleCloudAiplatformV1beta1Event</code>.
     * An edge describing the relationship between an Artifact and an Execution in a lineage graph.
     * @alias module:model/GoogleCloudAiplatformV1beta1Event
     */
    constructor() { 
        
        GoogleCloudAiplatformV1beta1Event.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudAiplatformV1beta1Event</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudAiplatformV1beta1Event} obj Optional instance to populate.
     * @return {module:model/GoogleCloudAiplatformV1beta1Event} The populated <code>GoogleCloudAiplatformV1beta1Event</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudAiplatformV1beta1Event();
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudAiplatformV1beta1Event</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudAiplatformV1beta1Event</code>.
     */
 ...
 */
GoogleCloudAiplatformV1beta1Event.prototype['artifact'] = undefined;

/**
 * Output only. Time the Event occurred.
 * @member {String} eventTime
 */
GoogleCloudAiplatformV1beta1Event.prototype['eventTime'] = undefined;

/**
 * Output only. The relative resource name of the Execution in the Event.
 * @member {String} execution
 */
GoogleCloudAiplatformV1beta1Event.prototype['execution'] = undefined;
 ...
 */
GoogleCloudAiplatformV1beta1Event.prototype['labels'] = undefined;

/**
 * Required. The type of the Event.
 * @member {module:model/GoogleCloudAiplatformV1beta1Event.TypeEnum} type
 */
GoogleCloudAiplatformV1beta1Event.prototype['type'] = undefined;
 ...
 * @readonly
 */
GoogleCloudAiplatformV1beta1Event['TypeEnum'] = {
...
export default GoogleCloudAiplatformV1beta1Event;
