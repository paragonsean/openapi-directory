...
/**
 * The GoogleCloudAiplatformV1beta1Attribution model module.
 * @module model/GoogleCloudAiplatformV1beta1Attribution
 * @version v1beta1
 */
class GoogleCloudAiplatformV1beta1Attribution {
    /**
     * Constructs a new <code>GoogleCloudAiplatformV1beta1Attribution</code>.
     * Attribution that explains a particular prediction output.
     * @alias module:model/GoogleCloudAiplatformV1beta1Attribution
     */
    constructor() { 
        
        GoogleCloudAiplatformV1beta1Attribution.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudAiplatformV1beta1Attribution</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudAiplatformV1beta1Attribution} obj Optional instance to populate.
     * @return {module:model/GoogleCloudAiplatformV1beta1Attribution} The populated <code>GoogleCloudAiplatformV1beta1Attribution</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudAiplatformV1beta1Attribution();
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudAiplatformV1beta1Attribution</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudAiplatformV1beta1Attribution</code>.
     */
 ...
 */
GoogleCloudAiplatformV1beta1Attribution.prototype['approximationError'] = undefined;
 ...
 */
GoogleCloudAiplatformV1beta1Attribution.prototype['baselineOutputValue'] = undefined;
 ...
 */
GoogleCloudAiplatformV1beta1Attribution.prototype['featureAttributions'] = undefined;
 ...
 */
GoogleCloudAiplatformV1beta1Attribution.prototype['instanceOutputValue'] = undefined;
 ...
 */
GoogleCloudAiplatformV1beta1Attribution.prototype['outputDisplayName'] = undefined;
 ...
 */
GoogleCloudAiplatformV1beta1Attribution.prototype['outputIndex'] = undefined;

/**
 * Output only. Name of the explain output. Specified as the key in ExplanationMetadata.outputs.
 * @member {String} outputName
 */
GoogleCloudAiplatformV1beta1Attribution.prototype['outputName'] = undefined;
...
export default GoogleCloudAiplatformV1beta1Attribution;
