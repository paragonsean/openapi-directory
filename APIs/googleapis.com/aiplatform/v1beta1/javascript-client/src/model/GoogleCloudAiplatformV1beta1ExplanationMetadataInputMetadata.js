...
import GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataFeatureValueDomain from './GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataFeatureValueDomain';
import GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataVisualization from './GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataVisualization';

/**
 * The GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata model module.
 * @module model/GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata
 * @version v1beta1
 */
class GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata {
    /**
     * Constructs a new <code>GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata</code>.
     ...
     * @alias module:model/GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata
     */
    constructor() { 
        
        GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata} obj Optional instance to populate.
     * @return {module:model/GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata} The populated <code>GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata();
            ...
            if (data.hasOwnProperty('featureValueDomain')) {
                obj['featureValueDomain'] = GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataFeatureValueDomain.constructFromObject(data['featureValueDomain']);
            }
            ...
            if (data.hasOwnProperty('visualization')) {
                obj['visualization'] = GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataVisualization.constructFromObject(data['visualization']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata</code>.
     */
    static validateJSON(data) {
        ...
        if (data['featureValueDomain']) { // data not null
          GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataFeatureValueDomain.validateJSON(data['featureValueDomain']);
        }
        // ensure the json data is a string
        ...
        if (data['visualization']) { // data not null
          GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataVisualization.validateJSON(data['visualization']);
        }
 ...
 */
GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata.prototype['denseShapeTensorName'] = undefined;
 ...
 */
GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata.prototype['encodedBaselines'] = undefined;
 ...
 */
GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata.prototype['encodedTensorName'] = undefined;

/**
 * Defines how the feature is encoded into the input tensor. Defaults to IDENTITY.
 * @member {module:model/GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata.EncodingEnum} encoding
 */
GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata.prototype['encoding'] = undefined;

/**
 * @member {module:model/GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataFeatureValueDomain} featureValueDomain
 */
GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata.prototype['featureValueDomain'] = undefined;

/**
 * Name of the group that the input belongs to. Features with the same group name will be treated as one feature when computing attributions. Features grouped together can have different shapes in value. If provided, there will be one single attribution generated in Attribution.feature_attributions, keyed by the group name.
 * @member {String} groupName
 */
GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata.prototype['groupName'] = undefined;
 ...
 */
GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata.prototype['indexFeatureMapping'] = undefined;

/**
 * Specifies the index of the values of the input tensor. Required when the input tensor is a sparse representation. Refer to Tensorflow documentation for more details: https://www.tensorflow.org/api_docs/python/tf/sparse/SparseTensor.
 * @member {String} indicesTensorName
 */
GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata.prototype['indicesTensorName'] = undefined;
 ...
 */
GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata.prototype['inputBaselines'] = undefined;

/**
 * Name of the input tensor for this feature. Required and is only applicable to Vertex AI-provided images for Tensorflow.
 * @member {String} inputTensorName
 */
GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata.prototype['inputTensorName'] = undefined;

/**
 * Modality of the feature. Valid values are: numeric, image. Defaults to numeric.
 * @member {String} modality
 */
GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata.prototype['modality'] = undefined;

/**
 * @member {module:model/GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataVisualization} visualization
 */
GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata.prototype['visualization'] = undefined;
 ...
 * @readonly
 */
GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata['EncodingEnum'] = {
...
export default GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata;
