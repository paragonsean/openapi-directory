...
import GoogleCloudAiplatformV1beta1ActiveLearningConfig from './GoogleCloudAiplatformV1beta1ActiveLearningConfig';
...
/**
 * The GoogleCloudAiplatformV1beta1DataLabelingJob model module.
 * @module model/GoogleCloudAiplatformV1beta1DataLabelingJob
 * @version v1beta1
 */
class GoogleCloudAiplatformV1beta1DataLabelingJob {
    /**
     * Constructs a new <code>GoogleCloudAiplatformV1beta1DataLabelingJob</code>.
     * DataLabelingJob is used to trigger a human labeling job on unlabeled data from the following Dataset:
     * @alias module:model/GoogleCloudAiplatformV1beta1DataLabelingJob
     */
    constructor() { 
        
        GoogleCloudAiplatformV1beta1DataLabelingJob.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoogleCloudAiplatformV1beta1DataLabelingJob</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoogleCloudAiplatformV1beta1DataLabelingJob} obj Optional instance to populate.
     * @return {module:model/GoogleCloudAiplatformV1beta1DataLabelingJob} The populated <code>GoogleCloudAiplatformV1beta1DataLabelingJob</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoogleCloudAiplatformV1beta1DataLabelingJob();

            if (data.hasOwnProperty('activeLearningConfig')) {
                obj['activeLearningConfig'] = GoogleCloudAiplatformV1beta1ActiveLearningConfig.constructFromObject(data['activeLearningConfig']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GoogleCloudAiplatformV1beta1DataLabelingJob</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoogleCloudAiplatformV1beta1DataLabelingJob</code>.
     */
    static validateJSON(data) {
        // validate the optional field `activeLearningConfig`
        if (data['activeLearningConfig']) { // data not null
          GoogleCloudAiplatformV1beta1ActiveLearningConfig.validateJSON(data['activeLearningConfig']);
        }
...
/**
 * @member {module:model/GoogleCloudAiplatformV1beta1ActiveLearningConfig} activeLearningConfig
 */
GoogleCloudAiplatformV1beta1DataLabelingJob.prototype['activeLearningConfig'] = undefined;
 ...
 */
GoogleCloudAiplatformV1beta1DataLabelingJob.prototype['annotationLabels'] = undefined;

/**
 * Output only. Timestamp when this DataLabelingJob was created.
 * @member {String} createTime
 */
GoogleCloudAiplatformV1beta1DataLabelingJob.prototype['createTime'] = undefined;

/**
 * @member {module:model/GoogleTypeMoney} currentSpend
 */
GoogleCloudAiplatformV1beta1DataLabelingJob.prototype['currentSpend'] = undefined;
 ...
 */
GoogleCloudAiplatformV1beta1DataLabelingJob.prototype['datasets'] = undefined;
 ...
 */
GoogleCloudAiplatformV1beta1DataLabelingJob.prototype['displayName'] = undefined;

/**
 * @member {module:model/GoogleCloudAiplatformV1beta1EncryptionSpec} encryptionSpec
 */
GoogleCloudAiplatformV1beta1DataLabelingJob.prototype['encryptionSpec'] = undefined;

/**
 * @member {module:model/GoogleRpcStatus} error
 */
GoogleCloudAiplatformV1beta1DataLabelingJob.prototype['error'] = undefined;

/**
 * Required. Input config parameters for the DataLabelingJob.
 * @member {Object} inputs
 */
GoogleCloudAiplatformV1beta1DataLabelingJob.prototype['inputs'] = undefined;
 ...
 */
GoogleCloudAiplatformV1beta1DataLabelingJob.prototype['inputsSchemaUri'] = undefined;
 ...
 */
GoogleCloudAiplatformV1beta1DataLabelingJob.prototype['instructionUri'] = undefined;

/**
 * Required. Number of labelers to work on each DataItem.
 * @member {Number} labelerCount
 */
GoogleCloudAiplatformV1beta1DataLabelingJob.prototype['labelerCount'] = undefined;
 ...
 */
GoogleCloudAiplatformV1beta1DataLabelingJob.prototype['labelingProgress'] = undefined;

/**
 * The labels with user-defined metadata to organize your DataLabelingJobs. Label keys and values can be no longer than 64 characters (Unicode codepoints), can only contain lowercase letters, numeric characters, underscores and dashes. International characters are allowed. See https://goo.gl/xmQnxf for more information and examples of labels. System reserved label keys are prefixed with \"aiplatform.googleapis.com/\" and are immutable. Following system labels exist for each DataLabelingJob: * \"aiplatform.googleapis.com/schema\": output only, its value is the inputs_schema's title.
 * @member {Object.<String, String>} labels
 */
GoogleCloudAiplatformV1beta1DataLabelingJob.prototype['labels'] = undefined;

/**
 * Output only. Resource name of the DataLabelingJob.
 * @member {String} name
 */
GoogleCloudAiplatformV1beta1DataLabelingJob.prototype['name'] = undefined;

/**
 * The SpecialistPools' resource names associated with this job.
 * @member {Array.<String>} specialistPools
 */
GoogleCloudAiplatformV1beta1DataLabelingJob.prototype['specialistPools'] = undefined;

/**
 * Output only. The detailed state of the job.
 * @member {module:model/GoogleCloudAiplatformV1beta1DataLabelingJob.StateEnum} state
 */
GoogleCloudAiplatformV1beta1DataLabelingJob.prototype['state'] = undefined;

/**
 * Output only. Timestamp when this DataLabelingJob was updated most recently.
 * @member {String} updateTime
 */
GoogleCloudAiplatformV1beta1DataLabelingJob.prototype['updateTime'] = undefined;
 ...
 * @readonly
 */
GoogleCloudAiplatformV1beta1DataLabelingJob['StateEnum'] = {
...
export default GoogleCloudAiplatformV1beta1DataLabelingJob;
