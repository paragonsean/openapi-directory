...
void OAIPublishersApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("aiplatform_publishers_models_list", defaultConf);
    _serverIndices.insert("aiplatform_publishers_models_list", 0);
}
...
void OAIPublishersApi::aiplatform_publishers_models_get(const QString &name, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<QString> &language_code, const ::OpenAPI::OptionalParam<QString> &view) {
    QString fullPath = QString(_serverConfigs["aiplatform_publishers_models_get"][_serverIndices.value("aiplatform_publishers_models_get")].URL()+"/v1beta1/{name}");
...
void OAIPublishersApi::aiplatform_publishers_models_getCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIGoogleCloudAiplatformV1beta1PublisherModel output(QString(worker->response));
    worker->deleteLater();
...
void OAIPublishersApi::aiplatform_publishers_models_list(const QString &parent, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<QString> &filter, const ::OpenAPI::OptionalParam<QString> &language_code, const ::OpenAPI::OptionalParam<QString> &order_by, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &page_token, const ::OpenAPI::OptionalParam<QString> &view) {
    QString fullPath = QString(_serverConfigs["aiplatform_publishers_models_list"][_serverIndices.value("aiplatform_publishers_models_list")].URL()+"/v1beta1/{parent}/models");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIPublishersApi::aiplatform_publishers_models_listCallback);
    connect(this, &OAIPublishersApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIPublishersApi::aiplatform_publishers_models_listCallback);
    connect(this, &OAIPublishersApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIPublishersApi::aiplatform_publishers_models_listCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIGoogleCloudAiplatformV1beta1ListPublisherModelsResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT aiplatform_publishers_models_listSignal(output);
        Q_EMIT aiplatform_publishers_models_listSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("https://www.googleapis.com/auth/cloud-platform");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT aiplatform_publishers_models_listSignalE(output, error_type, error_str);
        Q_EMIT aiplatform_publishers_models_listSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT aiplatform_publishers_models_listSignalError(output, error_type, error_str);
        Q_EMIT aiplatform_publishers_models_listSignalErrorFull(worker, error_type, error_str);
    }
}
