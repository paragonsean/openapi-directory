...
/*
 * OAIGoogleCloudAiplatformV1beta1SchemaTimeSegment.h
 *
 * A time period inside of a DataItem that has a time dimension (e.g. video).
 */

#ifndef OAIGoogleCloudAiplatformV1beta1SchemaTimeSegment_H
#define OAIGoogleCloudAiplatformV1beta1SchemaTimeSegment_H
...
class OAIGoogleCloudAiplatformV1beta1SchemaTimeSegment : public OAIObject {
public:
    OAIGoogleCloudAiplatformV1beta1SchemaTimeSegment();
    OAIGoogleCloudAiplatformV1beta1SchemaTimeSegment(QString json);
    ~OAIGoogleCloudAiplatformV1beta1SchemaTimeSegment() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudAiplatformV1beta1SchemaTimeSegment)

#endif // OAIGoogleCloudAiplatformV1beta1SchemaTimeSegment_H
