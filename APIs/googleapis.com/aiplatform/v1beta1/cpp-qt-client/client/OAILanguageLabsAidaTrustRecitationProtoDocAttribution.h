...
/*
 * OAILanguageLabsAidaTrustRecitationProtoDocAttribution.h
 *
...
#ifndef OAILanguageLabsAidaTrustRecitationProtoDocAttribution_H
#define OAILanguageLabsAidaTrustRecitationProtoDocAttribution_H
...
class OAILanguageLabsAidaTrustRecitationProtoDocAttribution : public OAIObject {
public:
    OAILanguageLabsAidaTrustRecitationProtoDocAttribution();
    OAILanguageLabsAidaTrustRecitationProtoDocAttribution(QString json);
    ~OAILanguageLabsAidaTrustRecitationProtoDocAttribution() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILanguageLabsAidaTrustRecitationProtoDocAttribution)

#endif // OAILanguageLabsAidaTrustRecitationProtoDocAttribution_H
