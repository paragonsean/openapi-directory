...
/*
 * OAIGoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata.h
 *
...
#ifndef OAIGoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata_H
#define OAIGoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata_H

#include <QJsonObject>

#include "OAIGoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataFeatureValueDomain.h"
...
namespace OpenAPI {
class OAIGoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataFeatureValueDomain;
class OAIGoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataVisualization;

class OAIGoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata : public OAIObject {
public:
    OAIGoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata();
    OAIGoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata(QString json);
    ~OAIGoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata() override;
    ...
    OAIGoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataFeatureValueDomain getFeatureValueDomain() const;
    void setFeatureValueDomain(const OAIGoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataFeatureValueDomain &feature_value_domain);
    ...
    OAIGoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataVisualization getVisualization() const;
    void setVisualization(const OAIGoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataVisualization &visualization);
...
private:
    ...
    OAIGoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataFeatureValueDomain m_feature_value_domain;
    ...
    OAIGoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataVisualization m_visualization;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata)

#endif // OAIGoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata_H
