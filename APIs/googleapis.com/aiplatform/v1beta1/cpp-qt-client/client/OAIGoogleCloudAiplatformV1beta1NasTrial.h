...
/*
 * OAIGoogleCloudAiplatformV1beta1NasTrial.h
 *
 * Represents a uCAIP NasJob trial.
 */

#ifndef OAIGoogleCloudAiplatformV1beta1NasTrial_H
#define OAIGoogleCloudAiplatformV1beta1NasTrial_H
...
class OAIGoogleCloudAiplatformV1beta1NasTrial : public OAIObject {
public:
    OAIGoogleCloudAiplatformV1beta1NasTrial();
    OAIGoogleCloudAiplatformV1beta1NasTrial(QString json);
    ~OAIGoogleCloudAiplatformV1beta1NasTrial() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudAiplatformV1beta1NasTrial)

#endif // OAIGoogleCloudAiplatformV1beta1NasTrial_H
