...
/*
 * OAIGoogleCloudAiplatformV1beta1CopyModelRequest.h
 *
 * Request message for ModelService.CopyModel.
 */

#ifndef OAIGoogleCloudAiplatformV1beta1CopyModelRequest_H
#define OAIGoogleCloudAiplatformV1beta1CopyModelRequest_H
...
class OAIGoogleCloudAiplatformV1beta1CopyModelRequest : public OAIObject {
public:
    OAIGoogleCloudAiplatformV1beta1CopyModelRequest();
    OAIGoogleCloudAiplatformV1beta1CopyModelRequest(QString json);
    ~OAIGoogleCloudAiplatformV1beta1CopyModelRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudAiplatformV1beta1CopyModelRequest)

#endif // OAIGoogleCloudAiplatformV1beta1CopyModelRequest_H
