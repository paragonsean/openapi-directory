...
/*
 * OAIGoogleCloudAiplatformV1beta1Citation.h
 *
 * Source attributions for content.
 */

#ifndef OAIGoogleCloudAiplatformV1beta1Citation_H
#define OAIGoogleCloudAiplatformV1beta1Citation_H
...
class OAIGoogleCloudAiplatformV1beta1Citation : public OAIObject {
public:
    OAIGoogleCloudAiplatformV1beta1Citation();
    OAIGoogleCloudAiplatformV1beta1Citation(QString json);
    ~OAIGoogleCloudAiplatformV1beta1Citation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudAiplatformV1beta1Citation)

#endif // OAIGoogleCloudAiplatformV1beta1Citation_H
