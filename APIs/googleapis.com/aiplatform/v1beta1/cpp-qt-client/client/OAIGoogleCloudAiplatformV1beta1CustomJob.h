...
/*
 * OAIGoogleCloudAiplatformV1beta1CustomJob.h
 *
 * Represents a job that runs custom workloads such as a Docker container or a Python package. A CustomJob can have multiple worker pools and each worker pool can have its own machine and input spec. A CustomJob will be cleaned up once the job enters terminal state (failed or succeeded).
 */

#ifndef OAIGoogleCloudAiplatformV1beta1CustomJob_H
#define OAIGoogleCloudAiplatformV1beta1CustomJob_H
...
class OAIGoogleCloudAiplatformV1beta1CustomJob : public OAIObject {
public:
    OAIGoogleCloudAiplatformV1beta1CustomJob();
    OAIGoogleCloudAiplatformV1beta1CustomJob(QString json);
    ~OAIGoogleCloudAiplatformV1beta1CustomJob() override;
    ...
    OAIGoogleCloudAiplatformV1beta1CustomJobSpec getJobSpec() const;
    void setJobSpec(const OAIGoogleCloudAiplatformV1beta1CustomJobSpec &job_spec);
...
private:
    ...
    OAIGoogleCloudAiplatformV1beta1CustomJobSpec m_job_spec;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoogleCloudAiplatformV1beta1CustomJob)

#endif // OAIGoogleCloudAiplatformV1beta1CustomJob_H
