...
|**inputArtifacts** | [**Map&lt;String, GoogleCloudAiplatformV1beta1PipelineJobRuntimeConfigInputArtifact&gt;**](GoogleCloudAiplatformV1beta1PipelineJobRuntimeConfigInputArtifact.md) | The runtime artifacts of the PipelineJob. The key will be the input artifact name and the value would be one of the InputArtifact. |  [optional] |
