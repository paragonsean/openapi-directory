...
|**workerPoolSpecs** | [**List&lt;GoogleCloudAiplatformV1beta1WorkerPoolSpec&gt;**](GoogleCloudAiplatformV1beta1WorkerPoolSpec.md) | Required. The spec of the worker pools including machine type and Docker image. All worker pools except the first one are optional and can be skipped by providing an empty value. |  [optional] |
