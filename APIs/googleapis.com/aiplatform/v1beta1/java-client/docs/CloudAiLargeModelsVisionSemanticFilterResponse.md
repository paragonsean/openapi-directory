...
|------------ | ------------- | ------------- | -------------|
|**namedBoundingBoxes** | [**List&lt;CloudAiLargeModelsVisionNamedBoundingBox&gt;**](CloudAiLargeModelsVisionNamedBoundingBox.md) | Class labels of the bounding boxes that failed the semantic filtering. Bounding box coordinates. |  [optional] |
