...
|**metadata** | **Map&lt;String, Object&gt;** | Properties of the Context. Top level metadata keys&#39; heading and trailing spaces will be trimmed. The size of this field should not exceed 200KB. |  [optional] |
|**name** | **String** | Immutable. The resource name of the Context. |  [optional] |
|**parentContexts** | **List&lt;String&gt;** | Output only. A list of resource names of Contexts that are parents of this Context. A Context may have at most 10 parent_contexts. |  [optional] [readonly] |
