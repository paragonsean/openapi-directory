...
|------------ | ------------- | ------------- | -------------|
|**migratableResources** | [**List&lt;GoogleCloudAiplatformV1beta1MigratableResource&gt;**](GoogleCloudAiplatformV1beta1MigratableResource.md) | All migratable resources that can be migrated to the location specified in the request. |  [optional] |
