...
|------------ | ------------- | ------------- | -------------|
|**attributedItems** | [**List&lt;GoogleCloudAiplatformV1beta1ErrorAnalysisAnnotationAttributedItem&gt;**](GoogleCloudAiplatformV1beta1ErrorAnalysisAnnotationAttributedItem.md) | Attributed items for a given annotation, typically representing neighbors from the training sets constrained by the query type. |  [optional] |
