...
|**deployedIndexes** | [**List&lt;GoogleCloudAiplatformV1beta1DeployedIndexRef&gt;**](GoogleCloudAiplatformV1beta1DeployedIndexRef.md) | Output only. The pointers to DeployedIndexes created from this Index. An Index can be only deleted if all its DeployedIndexes had been undeployed first. |  [optional] [readonly] |
...
|**indexStats** | [**GoogleCloudAiplatformV1beta1IndexStats**](GoogleCloudAiplatformV1beta1IndexStats.md) |  |  [optional] |
