...
public class GoogleCloudAiplatformV1beta1PredictResponse {
  ...
  public GoogleCloudAiplatformV1beta1PredictResponse() {
  }
  ...
  public GoogleCloudAiplatformV1beta1PredictResponse deployedModelId(String deployedModelId) {
  ...
  public GoogleCloudAiplatformV1beta1PredictResponse predictions(List<Object> predictions) {
    this.predictions = predictions;
    return this;
  }

  public GoogleCloudAiplatformV1beta1PredictResponse addPredictionsItem(Object predictionsItem) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudAiplatformV1beta1PredictResponse googleCloudAiplatformV1beta1PredictResponse = (GoogleCloudAiplatformV1beta1PredictResponse) o;
    return Objects.equals(this.deployedModelId, googleCloudAiplatformV1beta1PredictResponse.deployedModelId) &&
        Objects.equals(this.metadata, googleCloudAiplatformV1beta1PredictResponse.metadata) &&
        Objects.equals(this.model, googleCloudAiplatformV1beta1PredictResponse.model) &&
        Objects.equals(this.modelDisplayName, googleCloudAiplatformV1beta1PredictResponse.modelDisplayName) &&
        Objects.equals(this.modelVersionId, googleCloudAiplatformV1beta1PredictResponse.modelVersionId) &&
        Objects.equals(this.predictions, googleCloudAiplatformV1beta1PredictResponse.predictions);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudAiplatformV1beta1PredictResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudAiplatformV1beta1PredictResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudAiplatformV1beta1PredictResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudAiplatformV1beta1PredictResponse is not found in the empty JSON string", GoogleCloudAiplatformV1beta1PredictResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudAiplatformV1beta1PredictResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudAiplatformV1beta1PredictResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudAiplatformV1beta1PredictResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudAiplatformV1beta1PredictResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudAiplatformV1beta1PredictResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudAiplatformV1beta1PredictResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudAiplatformV1beta1PredictResponse>() {
           @Override
           public void write(JsonWriter out, GoogleCloudAiplatformV1beta1PredictResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudAiplatformV1beta1PredictResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudAiplatformV1beta1PredictResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudAiplatformV1beta1PredictResponse
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudAiplatformV1beta1PredictResponse
   */
  public static GoogleCloudAiplatformV1beta1PredictResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudAiplatformV1beta1PredictResponse.class);
  }

  /**
   * Convert an instance of GoogleCloudAiplatformV1beta1PredictResponse to an JSON string
   *
   * @return JSON string
   */
