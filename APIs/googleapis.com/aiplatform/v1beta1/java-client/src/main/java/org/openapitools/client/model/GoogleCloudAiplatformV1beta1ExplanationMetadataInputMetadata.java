...
public class GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata {
  ...
  public GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata() {
  }

  public GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata denseShapeTensorName(String denseShapeTensorName) {
  ...
  public GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata encodedBaselines(List<Object> encodedBaselines) {
    this.encodedBaselines = encodedBaselines;
    return this;
  }

  public GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata addEncodedBaselinesItem(Object encodedBaselinesItem) {
  ...
  public GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata encodedTensorName(String encodedTensorName) {
  ...
  public GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata encoding(EncodingEnum encoding) {
  ...
  public GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata featureValueDomain(GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataFeatureValueDomain featureValueDomain) {
  ...
  public void setFeatureValueDomain(GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataFeatureValueDomain featureValueDomain) {
    this.featureValueDomain = featureValueDomain;
  }


  public GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata groupName(String groupName) {
  ...
  public GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata indexFeatureMapping(List<String> indexFeatureMapping) {
    this.indexFeatureMapping = indexFeatureMapping;
    return this;
  }

  public GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata addIndexFeatureMappingItem(String indexFeatureMappingItem) {
  ...
  public GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata indicesTensorName(String indicesTensorName) {
  ...
  public GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata inputBaselines(List<Object> inputBaselines) {
    this.inputBaselines = inputBaselines;
    return this;
  }

  public GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata addInputBaselinesItem(Object inputBaselinesItem) {
  ...
  public GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata inputTensorName(String inputTensorName) {
  ...
  public GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata modality(String modality) {
  ...
  public GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata visualization(GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataVisualization visualization) {
  ...
  public void setVisualization(GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataVisualization visualization) {
    this.visualization = visualization;
  }
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata googleCloudAiplatformV1beta1ExplanationMetadataInputMetadata = (GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata) o;
    return Objects.equals(this.denseShapeTensorName, googleCloudAiplatformV1beta1ExplanationMetadataInputMetadata.denseShapeTensorName) &&
        Objects.equals(this.encodedBaselines, googleCloudAiplatformV1beta1ExplanationMetadataInputMetadata.encodedBaselines) &&
        Objects.equals(this.encodedTensorName, googleCloudAiplatformV1beta1ExplanationMetadataInputMetadata.encodedTensorName) &&
        Objects.equals(this.encoding, googleCloudAiplatformV1beta1ExplanationMetadataInputMetadata.encoding) &&
        Objects.equals(this.featureValueDomain, googleCloudAiplatformV1beta1ExplanationMetadataInputMetadata.featureValueDomain) &&
        Objects.equals(this.groupName, googleCloudAiplatformV1beta1ExplanationMetadataInputMetadata.groupName) &&
        Objects.equals(this.indexFeatureMapping, googleCloudAiplatformV1beta1ExplanationMetadataInputMetadata.indexFeatureMapping) &&
        Objects.equals(this.indicesTensorName, googleCloudAiplatformV1beta1ExplanationMetadataInputMetadata.indicesTensorName) &&
        Objects.equals(this.inputBaselines, googleCloudAiplatformV1beta1ExplanationMetadataInputMetadata.inputBaselines) &&
        Objects.equals(this.inputTensorName, googleCloudAiplatformV1beta1ExplanationMetadataInputMetadata.inputTensorName) &&
        Objects.equals(this.modality, googleCloudAiplatformV1beta1ExplanationMetadataInputMetadata.modality) &&
        Objects.equals(this.visualization, googleCloudAiplatformV1beta1ExplanationMetadataInputMetadata.visualization);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata is not found in the empty JSON string", GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("featureValueDomain") != null && !jsonObj.get("featureValueDomain").isJsonNull()) {
        GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataFeatureValueDomain.validateJsonElement(jsonObj.get("featureValueDomain"));
      }
      ...
      if (jsonObj.get("visualization") != null && !jsonObj.get("visualization").isJsonNull()) {
        GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataVisualization.validateJsonElement(jsonObj.get("visualization"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata>() {
           @Override
           public void write(JsonWriter out, GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata
   */
  public static GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata.class);
  }

  /**
   * Convert an instance of GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadata to an JSON string
   *
   * @return JSON string
   */
