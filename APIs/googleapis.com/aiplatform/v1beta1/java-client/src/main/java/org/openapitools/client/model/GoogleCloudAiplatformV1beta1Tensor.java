...
public class GoogleCloudAiplatformV1beta1Tensor {
  ...
  private List<GoogleCloudAiplatformV1beta1Tensor> listVal = new ArrayList<>();
  ...
  private Map<String, GoogleCloudAiplatformV1beta1Tensor> structVal = new HashMap<>();
  ...
  public GoogleCloudAiplatformV1beta1Tensor() {
  }

  public GoogleCloudAiplatformV1beta1Tensor boolVal(List<Boolean> boolVal) {
    this.boolVal = boolVal;
    return this;
  }

  public GoogleCloudAiplatformV1beta1Tensor addBoolValItem(Boolean boolValItem) {
  ...
  public GoogleCloudAiplatformV1beta1Tensor bytesVal(List<byte[]> bytesVal) {
    this.bytesVal = bytesVal;
    return this;
  }

  public GoogleCloudAiplatformV1beta1Tensor addBytesValItem(byte[] bytesValItem) {
  ...
  public GoogleCloudAiplatformV1beta1Tensor doubleVal(List<Double> doubleVal) {
    this.doubleVal = doubleVal;
    return this;
  }

  public GoogleCloudAiplatformV1beta1Tensor addDoubleValItem(Double doubleValItem) {
  ...
  public GoogleCloudAiplatformV1beta1Tensor dtype(DtypeEnum dtype) {
    this.dtype = dtype;
    return this;
  }
  ...
  public GoogleCloudAiplatformV1beta1Tensor floatVal(List<Float> floatVal) {
    this.floatVal = floatVal;
    return this;
  }

  public GoogleCloudAiplatformV1beta1Tensor addFloatValItem(Float floatValItem) {
  ...
  public GoogleCloudAiplatformV1beta1Tensor int64Val(List<String> int64Val) {
    this.int64Val = int64Val;
    return this;
  }

  public GoogleCloudAiplatformV1beta1Tensor addInt64ValItem(String int64ValItem) {
  ...
  public GoogleCloudAiplatformV1beta1Tensor intVal(List<Integer> intVal) {
    this.intVal = intVal;
    return this;
  }

  public GoogleCloudAiplatformV1beta1Tensor addIntValItem(Integer intValItem) {
    if (this.intVal == null) {
  ...
  public GoogleCloudAiplatformV1beta1Tensor listVal(List<GoogleCloudAiplatformV1beta1Tensor> listVal) {
    this.listVal = listVal;
    return this;
  }

  public GoogleCloudAiplatformV1beta1Tensor addListValItem(GoogleCloudAiplatformV1beta1Tensor listValItem) {
  ...
  public void setListVal(List<GoogleCloudAiplatformV1beta1Tensor> listVal) {
    this.listVal = listVal;
  }


  public GoogleCloudAiplatformV1beta1Tensor shape(List<String> shape) {
    this.shape = shape;
    return this;
  }

  public GoogleCloudAiplatformV1beta1Tensor addShapeItem(String shapeItem) {
    if (this.shape == null) {
  ...
  public GoogleCloudAiplatformV1beta1Tensor stringVal(List<String> stringVal) {
    this.stringVal = stringVal;
    return this;
  }

  public GoogleCloudAiplatformV1beta1Tensor addStringValItem(String stringValItem) {
  ...
  public GoogleCloudAiplatformV1beta1Tensor structVal(Map<String, GoogleCloudAiplatformV1beta1Tensor> structVal) {
    this.structVal = structVal;
    return this;
  }

  public GoogleCloudAiplatformV1beta1Tensor putStructValItem(String key, GoogleCloudAiplatformV1beta1Tensor structValItem) {
  ...
  public void setStructVal(Map<String, GoogleCloudAiplatformV1beta1Tensor> structVal) {
    this.structVal = structVal;
  }


  public GoogleCloudAiplatformV1beta1Tensor tensorVal(byte[] tensorVal) {
  ...
  public GoogleCloudAiplatformV1beta1Tensor uint64Val(List<String> uint64Val) {
    this.uint64Val = uint64Val;
    return this;
  }

  public GoogleCloudAiplatformV1beta1Tensor addUint64ValItem(String uint64ValItem) {
  ...
  public GoogleCloudAiplatformV1beta1Tensor uintVal(List<Integer> uintVal) {
    this.uintVal = uintVal;
    return this;
  }

  public GoogleCloudAiplatformV1beta1Tensor addUintValItem(Integer uintValItem) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudAiplatformV1beta1Tensor googleCloudAiplatformV1beta1Tensor = (GoogleCloudAiplatformV1beta1Tensor) o;
    return Objects.equals(this.boolVal, googleCloudAiplatformV1beta1Tensor.boolVal) &&
        Objects.equals(this.bytesVal, googleCloudAiplatformV1beta1Tensor.bytesVal) &&
        Objects.equals(this.doubleVal, googleCloudAiplatformV1beta1Tensor.doubleVal) &&
        Objects.equals(this.dtype, googleCloudAiplatformV1beta1Tensor.dtype) &&
        Objects.equals(this.floatVal, googleCloudAiplatformV1beta1Tensor.floatVal) &&
        Objects.equals(this.int64Val, googleCloudAiplatformV1beta1Tensor.int64Val) &&
        Objects.equals(this.intVal, googleCloudAiplatformV1beta1Tensor.intVal) &&
        Objects.equals(this.listVal, googleCloudAiplatformV1beta1Tensor.listVal) &&
        Objects.equals(this.shape, googleCloudAiplatformV1beta1Tensor.shape) &&
        Objects.equals(this.stringVal, googleCloudAiplatformV1beta1Tensor.stringVal) &&
        Objects.equals(this.structVal, googleCloudAiplatformV1beta1Tensor.structVal) &&
        Arrays.equals(this.tensorVal, googleCloudAiplatformV1beta1Tensor.tensorVal) &&
        Objects.equals(this.uint64Val, googleCloudAiplatformV1beta1Tensor.uint64Val) &&
        Objects.equals(this.uintVal, googleCloudAiplatformV1beta1Tensor.uintVal);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudAiplatformV1beta1Tensor {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudAiplatformV1beta1Tensor
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudAiplatformV1beta1Tensor.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudAiplatformV1beta1Tensor is not found in the empty JSON string", GoogleCloudAiplatformV1beta1Tensor.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudAiplatformV1beta1Tensor.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudAiplatformV1beta1Tensor` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("listVal") != null && !jsonObj.get("listVal").isJsonNull()) {
        ...
        if (jsonArraylistVal != null) {
          ...
          for (int i = 0; i < jsonArraylistVal.size(); i++) {
            GoogleCloudAiplatformV1beta1Tensor.validateJsonElement(jsonArraylistVal.get(i));
          };
        }
      }
      // ensure the optional json data is an array if present
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudAiplatformV1beta1Tensor.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudAiplatformV1beta1Tensor' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudAiplatformV1beta1Tensor> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudAiplatformV1beta1Tensor.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudAiplatformV1beta1Tensor>() {
           @Override
           public void write(JsonWriter out, GoogleCloudAiplatformV1beta1Tensor value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudAiplatformV1beta1Tensor read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudAiplatformV1beta1Tensor given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudAiplatformV1beta1Tensor
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudAiplatformV1beta1Tensor
   */
  public static GoogleCloudAiplatformV1beta1Tensor fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudAiplatformV1beta1Tensor.class);
  }

  /**
   * Convert an instance of GoogleCloudAiplatformV1beta1Tensor to an JSON string
   *
   * @return JSON string
   */
