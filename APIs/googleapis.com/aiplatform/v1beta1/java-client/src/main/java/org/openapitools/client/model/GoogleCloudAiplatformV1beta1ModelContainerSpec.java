...
public class GoogleCloudAiplatformV1beta1ModelContainerSpec {
  ...
  private List<GoogleCloudAiplatformV1beta1Port> grpcPorts = new ArrayList<>();
  ...
  private List<GoogleCloudAiplatformV1beta1Port> ports = new ArrayList<>();
  ...
  public GoogleCloudAiplatformV1beta1ModelContainerSpec() {
  }

  public GoogleCloudAiplatformV1beta1ModelContainerSpec args(List<String> args) {
    this.args = args;
    return this;
  }

  public GoogleCloudAiplatformV1beta1ModelContainerSpec addArgsItem(String argsItem) {
    if (this.args == null) {
  ...
  public GoogleCloudAiplatformV1beta1ModelContainerSpec command(List<String> command) {
    this.command = command;
    return this;
  }

  public GoogleCloudAiplatformV1beta1ModelContainerSpec addCommandItem(String commandItem) {
  ...
  public GoogleCloudAiplatformV1beta1ModelContainerSpec deploymentTimeout(String deploymentTimeout) {
  ...
  public GoogleCloudAiplatformV1beta1ModelContainerSpec env(List<GoogleCloudAiplatformV1beta1EnvVar> env) {
    this.env = env;
    return this;
  }

  public GoogleCloudAiplatformV1beta1ModelContainerSpec addEnvItem(GoogleCloudAiplatformV1beta1EnvVar envItem) {
    if (this.env == null) {
  ...
  public GoogleCloudAiplatformV1beta1ModelContainerSpec grpcPorts(List<GoogleCloudAiplatformV1beta1Port> grpcPorts) {
    this.grpcPorts = grpcPorts;
    return this;
  }

  public GoogleCloudAiplatformV1beta1ModelContainerSpec addGrpcPortsItem(GoogleCloudAiplatformV1beta1Port grpcPortsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<GoogleCloudAiplatformV1beta1Port> getGrpcPorts() {
    return grpcPorts;
  }

  public void setGrpcPorts(List<GoogleCloudAiplatformV1beta1Port> grpcPorts) {
    this.grpcPorts = grpcPorts;
  }


  public GoogleCloudAiplatformV1beta1ModelContainerSpec healthProbe(GoogleCloudAiplatformV1beta1Probe healthProbe) {
  ...
  public void setHealthProbe(GoogleCloudAiplatformV1beta1Probe healthProbe) {
    this.healthProbe = healthProbe;
  }


  public GoogleCloudAiplatformV1beta1ModelContainerSpec healthRoute(String healthRoute) {
  ...
  public GoogleCloudAiplatformV1beta1ModelContainerSpec imageUri(String imageUri) {
  ...
  public GoogleCloudAiplatformV1beta1ModelContainerSpec ports(List<GoogleCloudAiplatformV1beta1Port> ports) {
    this.ports = ports;
    return this;
  }

  public GoogleCloudAiplatformV1beta1ModelContainerSpec addPortsItem(GoogleCloudAiplatformV1beta1Port portsItem) {
    if (this.ports == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<GoogleCloudAiplatformV1beta1Port> getPorts() {
    return ports;
  }

  public void setPorts(List<GoogleCloudAiplatformV1beta1Port> ports) {
    this.ports = ports;
  }


  public GoogleCloudAiplatformV1beta1ModelContainerSpec predictRoute(String predictRoute) {
  ...
  public GoogleCloudAiplatformV1beta1ModelContainerSpec sharedMemorySizeMb(String sharedMemorySizeMb) {
  ...
  public GoogleCloudAiplatformV1beta1ModelContainerSpec startupProbe(GoogleCloudAiplatformV1beta1Probe startupProbe) {
  ...
  public void setStartupProbe(GoogleCloudAiplatformV1beta1Probe startupProbe) {
    this.startupProbe = startupProbe;
  }
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudAiplatformV1beta1ModelContainerSpec googleCloudAiplatformV1beta1ModelContainerSpec = (GoogleCloudAiplatformV1beta1ModelContainerSpec) o;
    return Objects.equals(this.args, googleCloudAiplatformV1beta1ModelContainerSpec.args) &&
        Objects.equals(this.command, googleCloudAiplatformV1beta1ModelContainerSpec.command) &&
        Objects.equals(this.deploymentTimeout, googleCloudAiplatformV1beta1ModelContainerSpec.deploymentTimeout) &&
        Objects.equals(this.env, googleCloudAiplatformV1beta1ModelContainerSpec.env) &&
        Objects.equals(this.grpcPorts, googleCloudAiplatformV1beta1ModelContainerSpec.grpcPorts) &&
        Objects.equals(this.healthProbe, googleCloudAiplatformV1beta1ModelContainerSpec.healthProbe) &&
        Objects.equals(this.healthRoute, googleCloudAiplatformV1beta1ModelContainerSpec.healthRoute) &&
        Objects.equals(this.imageUri, googleCloudAiplatformV1beta1ModelContainerSpec.imageUri) &&
        Objects.equals(this.ports, googleCloudAiplatformV1beta1ModelContainerSpec.ports) &&
        Objects.equals(this.predictRoute, googleCloudAiplatformV1beta1ModelContainerSpec.predictRoute) &&
        Objects.equals(this.sharedMemorySizeMb, googleCloudAiplatformV1beta1ModelContainerSpec.sharedMemorySizeMb) &&
        Objects.equals(this.startupProbe, googleCloudAiplatformV1beta1ModelContainerSpec.startupProbe);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudAiplatformV1beta1ModelContainerSpec {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudAiplatformV1beta1ModelContainerSpec
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudAiplatformV1beta1ModelContainerSpec.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudAiplatformV1beta1ModelContainerSpec is not found in the empty JSON string", GoogleCloudAiplatformV1beta1ModelContainerSpec.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudAiplatformV1beta1ModelContainerSpec.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudAiplatformV1beta1ModelContainerSpec` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("grpcPorts") != null && !jsonObj.get("grpcPorts").isJsonNull()) {
        ...
        if (jsonArraygrpcPorts != null) {
          ...
          for (int i = 0; i < jsonArraygrpcPorts.size(); i++) {
            GoogleCloudAiplatformV1beta1Port.validateJsonElement(jsonArraygrpcPorts.get(i));
          };
        }
      }
      // validate the optional field `healthProbe`
      if (jsonObj.get("healthProbe") != null && !jsonObj.get("healthProbe").isJsonNull()) {
        GoogleCloudAiplatformV1beta1Probe.validateJsonElement(jsonObj.get("healthProbe"));
      }
      ...
      if (jsonObj.get("ports") != null && !jsonObj.get("ports").isJsonNull()) {
        ...
        if (jsonArrayports != null) {
          ...
          for (int i = 0; i < jsonArrayports.size(); i++) {
            GoogleCloudAiplatformV1beta1Port.validateJsonElement(jsonArrayports.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("startupProbe") != null && !jsonObj.get("startupProbe").isJsonNull()) {
        GoogleCloudAiplatformV1beta1Probe.validateJsonElement(jsonObj.get("startupProbe"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudAiplatformV1beta1ModelContainerSpec.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudAiplatformV1beta1ModelContainerSpec' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudAiplatformV1beta1ModelContainerSpec> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudAiplatformV1beta1ModelContainerSpec.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudAiplatformV1beta1ModelContainerSpec>() {
           @Override
           public void write(JsonWriter out, GoogleCloudAiplatformV1beta1ModelContainerSpec value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudAiplatformV1beta1ModelContainerSpec read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudAiplatformV1beta1ModelContainerSpec given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudAiplatformV1beta1ModelContainerSpec
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudAiplatformV1beta1ModelContainerSpec
   */
  public static GoogleCloudAiplatformV1beta1ModelContainerSpec fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudAiplatformV1beta1ModelContainerSpec.class);
  }

  /**
   * Convert an instance of GoogleCloudAiplatformV1beta1ModelContainerSpec to an JSON string
   *
   * @return JSON string
   */
