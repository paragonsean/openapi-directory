...
public class GoogleCloudAiplatformV1beta1EvaluatedAnnotation {
  ...
  private List<GoogleCloudAiplatformV1beta1ErrorAnalysisAnnotation> errorAnalysisAnnotations = new ArrayList<>();
  ...
  private List<GoogleCloudAiplatformV1beta1EvaluatedAnnotationExplanation> explanations = new ArrayList<>();
  ...
  public GoogleCloudAiplatformV1beta1EvaluatedAnnotation() {
  }
  ...
  public GoogleCloudAiplatformV1beta1EvaluatedAnnotation errorAnalysisAnnotations(List<GoogleCloudAiplatformV1beta1ErrorAnalysisAnnotation> errorAnalysisAnnotations) {
    this.errorAnalysisAnnotations = errorAnalysisAnnotations;
    return this;
  }

  public GoogleCloudAiplatformV1beta1EvaluatedAnnotation addErrorAnalysisAnnotationsItem(GoogleCloudAiplatformV1beta1ErrorAnalysisAnnotation errorAnalysisAnnotationsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<GoogleCloudAiplatformV1beta1ErrorAnalysisAnnotation> getErrorAnalysisAnnotations() {
    return errorAnalysisAnnotations;
  }

  public void setErrorAnalysisAnnotations(List<GoogleCloudAiplatformV1beta1ErrorAnalysisAnnotation> errorAnalysisAnnotations) {
    this.errorAnalysisAnnotations = errorAnalysisAnnotations;
  }
  ...
  public GoogleCloudAiplatformV1beta1EvaluatedAnnotation explanations(List<GoogleCloudAiplatformV1beta1EvaluatedAnnotationExplanation> explanations) {
    this.explanations = explanations;
    return this;
  }

  public GoogleCloudAiplatformV1beta1EvaluatedAnnotation addExplanationsItem(GoogleCloudAiplatformV1beta1EvaluatedAnnotationExplanation explanationsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<GoogleCloudAiplatformV1beta1EvaluatedAnnotationExplanation> getExplanations() {
    return explanations;
  }

  public void setExplanations(List<GoogleCloudAiplatformV1beta1EvaluatedAnnotationExplanation> explanations) {
    this.explanations = explanations;
  }
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudAiplatformV1beta1EvaluatedAnnotation googleCloudAiplatformV1beta1EvaluatedAnnotation = (GoogleCloudAiplatformV1beta1EvaluatedAnnotation) o;
    return Objects.equals(this.dataItemPayload, googleCloudAiplatformV1beta1EvaluatedAnnotation.dataItemPayload) &&
        Objects.equals(this.errorAnalysisAnnotations, googleCloudAiplatformV1beta1EvaluatedAnnotation.errorAnalysisAnnotations) &&
        Objects.equals(this.evaluatedDataItemViewId, googleCloudAiplatformV1beta1EvaluatedAnnotation.evaluatedDataItemViewId) &&
        Objects.equals(this.explanations, googleCloudAiplatformV1beta1EvaluatedAnnotation.explanations) &&
        Objects.equals(this.groundTruths, googleCloudAiplatformV1beta1EvaluatedAnnotation.groundTruths) &&
        Objects.equals(this.predictions, googleCloudAiplatformV1beta1EvaluatedAnnotation.predictions) &&
        Objects.equals(this.type, googleCloudAiplatformV1beta1EvaluatedAnnotation.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudAiplatformV1beta1EvaluatedAnnotation {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudAiplatformV1beta1EvaluatedAnnotation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudAiplatformV1beta1EvaluatedAnnotation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudAiplatformV1beta1EvaluatedAnnotation is not found in the empty JSON string", GoogleCloudAiplatformV1beta1EvaluatedAnnotation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudAiplatformV1beta1EvaluatedAnnotation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudAiplatformV1beta1EvaluatedAnnotation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("errorAnalysisAnnotations") != null && !jsonObj.get("errorAnalysisAnnotations").isJsonNull()) {
        ...
        if (jsonArrayerrorAnalysisAnnotations != null) {
          ...
          for (int i = 0; i < jsonArrayerrorAnalysisAnnotations.size(); i++) {
            GoogleCloudAiplatformV1beta1ErrorAnalysisAnnotation.validateJsonElement(jsonArrayerrorAnalysisAnnotations.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("explanations") != null && !jsonObj.get("explanations").isJsonNull()) {
        ...
        if (jsonArrayexplanations != null) {
          ...
          for (int i = 0; i < jsonArrayexplanations.size(); i++) {
            GoogleCloudAiplatformV1beta1EvaluatedAnnotationExplanation.validateJsonElement(jsonArrayexplanations.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudAiplatformV1beta1EvaluatedAnnotation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudAiplatformV1beta1EvaluatedAnnotation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudAiplatformV1beta1EvaluatedAnnotation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudAiplatformV1beta1EvaluatedAnnotation.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudAiplatformV1beta1EvaluatedAnnotation>() {
           @Override
           public void write(JsonWriter out, GoogleCloudAiplatformV1beta1EvaluatedAnnotation value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudAiplatformV1beta1EvaluatedAnnotation read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudAiplatformV1beta1EvaluatedAnnotation given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudAiplatformV1beta1EvaluatedAnnotation
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudAiplatformV1beta1EvaluatedAnnotation
   */
  public static GoogleCloudAiplatformV1beta1EvaluatedAnnotation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudAiplatformV1beta1EvaluatedAnnotation.class);
  }

  /**
   * Convert an instance of GoogleCloudAiplatformV1beta1EvaluatedAnnotation to an JSON string
   *
   * @return JSON string
   */
