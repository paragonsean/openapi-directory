...
public class GoogleCloudAiplatformV1beta1InputDataConfig {
  ...
  public GoogleCloudAiplatformV1beta1InputDataConfig() {
  }

  public GoogleCloudAiplatformV1beta1InputDataConfig annotationSchemaUri(String annotationSchemaUri) {
  ...
  public GoogleCloudAiplatformV1beta1InputDataConfig annotationsFilter(String annotationsFilter) {
  ...
  public GoogleCloudAiplatformV1beta1InputDataConfig bigqueryDestination(GoogleCloudAiplatformV1beta1BigQueryDestination bigqueryDestination) {
  ...
  public GoogleCloudAiplatformV1beta1InputDataConfig datasetId(String datasetId) {
  ...
  public GoogleCloudAiplatformV1beta1InputDataConfig filterSplit(GoogleCloudAiplatformV1beta1FilterSplit filterSplit) {
  ...
  public void setFilterSplit(GoogleCloudAiplatformV1beta1FilterSplit filterSplit) {
    this.filterSplit = filterSplit;
  }


  public GoogleCloudAiplatformV1beta1InputDataConfig fractionSplit(GoogleCloudAiplatformV1beta1FractionSplit fractionSplit) {
  ...
  public void setFractionSplit(GoogleCloudAiplatformV1beta1FractionSplit fractionSplit) {
    this.fractionSplit = fractionSplit;
  }


  public GoogleCloudAiplatformV1beta1InputDataConfig gcsDestination(GoogleCloudAiplatformV1beta1GcsDestination gcsDestination) {
  ...
  public GoogleCloudAiplatformV1beta1InputDataConfig persistMlUseAssignment(Boolean persistMlUseAssignment) {
  ...
  public GoogleCloudAiplatformV1beta1InputDataConfig predefinedSplit(GoogleCloudAiplatformV1beta1PredefinedSplit predefinedSplit) {
  ...
  public void setPredefinedSplit(GoogleCloudAiplatformV1beta1PredefinedSplit predefinedSplit) {
    this.predefinedSplit = predefinedSplit;
  }


  public GoogleCloudAiplatformV1beta1InputDataConfig savedQueryId(String savedQueryId) {
  ...
  public GoogleCloudAiplatformV1beta1InputDataConfig stratifiedSplit(GoogleCloudAiplatformV1beta1StratifiedSplit stratifiedSplit) {
  ...
  public void setStratifiedSplit(GoogleCloudAiplatformV1beta1StratifiedSplit stratifiedSplit) {
    this.stratifiedSplit = stratifiedSplit;
  }


  public GoogleCloudAiplatformV1beta1InputDataConfig timestampSplit(GoogleCloudAiplatformV1beta1TimestampSplit timestampSplit) {
  ...
  public void setTimestampSplit(GoogleCloudAiplatformV1beta1TimestampSplit timestampSplit) {
    this.timestampSplit = timestampSplit;
  }
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudAiplatformV1beta1InputDataConfig googleCloudAiplatformV1beta1InputDataConfig = (GoogleCloudAiplatformV1beta1InputDataConfig) o;
    return Objects.equals(this.annotationSchemaUri, googleCloudAiplatformV1beta1InputDataConfig.annotationSchemaUri) &&
        Objects.equals(this.annotationsFilter, googleCloudAiplatformV1beta1InputDataConfig.annotationsFilter) &&
        Objects.equals(this.bigqueryDestination, googleCloudAiplatformV1beta1InputDataConfig.bigqueryDestination) &&
        Objects.equals(this.datasetId, googleCloudAiplatformV1beta1InputDataConfig.datasetId) &&
        Objects.equals(this.filterSplit, googleCloudAiplatformV1beta1InputDataConfig.filterSplit) &&
        Objects.equals(this.fractionSplit, googleCloudAiplatformV1beta1InputDataConfig.fractionSplit) &&
        Objects.equals(this.gcsDestination, googleCloudAiplatformV1beta1InputDataConfig.gcsDestination) &&
        Objects.equals(this.persistMlUseAssignment, googleCloudAiplatformV1beta1InputDataConfig.persistMlUseAssignment) &&
        Objects.equals(this.predefinedSplit, googleCloudAiplatformV1beta1InputDataConfig.predefinedSplit) &&
        Objects.equals(this.savedQueryId, googleCloudAiplatformV1beta1InputDataConfig.savedQueryId) &&
        Objects.equals(this.stratifiedSplit, googleCloudAiplatformV1beta1InputDataConfig.stratifiedSplit) &&
        Objects.equals(this.timestampSplit, googleCloudAiplatformV1beta1InputDataConfig.timestampSplit);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudAiplatformV1beta1InputDataConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudAiplatformV1beta1InputDataConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudAiplatformV1beta1InputDataConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudAiplatformV1beta1InputDataConfig is not found in the empty JSON string", GoogleCloudAiplatformV1beta1InputDataConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudAiplatformV1beta1InputDataConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudAiplatformV1beta1InputDataConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("filterSplit") != null && !jsonObj.get("filterSplit").isJsonNull()) {
        GoogleCloudAiplatformV1beta1FilterSplit.validateJsonElement(jsonObj.get("filterSplit"));
      }
      // validate the optional field `fractionSplit`
      if (jsonObj.get("fractionSplit") != null && !jsonObj.get("fractionSplit").isJsonNull()) {
        GoogleCloudAiplatformV1beta1FractionSplit.validateJsonElement(jsonObj.get("fractionSplit"));
      }
      ...
      if (jsonObj.get("predefinedSplit") != null && !jsonObj.get("predefinedSplit").isJsonNull()) {
        GoogleCloudAiplatformV1beta1PredefinedSplit.validateJsonElement(jsonObj.get("predefinedSplit"));
      }
      ...
      if (jsonObj.get("stratifiedSplit") != null && !jsonObj.get("stratifiedSplit").isJsonNull()) {
        GoogleCloudAiplatformV1beta1StratifiedSplit.validateJsonElement(jsonObj.get("stratifiedSplit"));
      }
      // validate the optional field `timestampSplit`
      if (jsonObj.get("timestampSplit") != null && !jsonObj.get("timestampSplit").isJsonNull()) {
        GoogleCloudAiplatformV1beta1TimestampSplit.validateJsonElement(jsonObj.get("timestampSplit"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudAiplatformV1beta1InputDataConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudAiplatformV1beta1InputDataConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudAiplatformV1beta1InputDataConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudAiplatformV1beta1InputDataConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudAiplatformV1beta1InputDataConfig>() {
           @Override
           public void write(JsonWriter out, GoogleCloudAiplatformV1beta1InputDataConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudAiplatformV1beta1InputDataConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudAiplatformV1beta1InputDataConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudAiplatformV1beta1InputDataConfig
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudAiplatformV1beta1InputDataConfig
   */
  public static GoogleCloudAiplatformV1beta1InputDataConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudAiplatformV1beta1InputDataConfig.class);
  }

  /**
   * Convert an instance of GoogleCloudAiplatformV1beta1InputDataConfig to an JSON string
   *
   * @return JSON string
   */
