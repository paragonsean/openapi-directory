...
import org.openapitools.client.model.GoogleCloudAiplatformV1beta1NotebookRuntimeTemplateRef;
...
public class GoogleCloudAiplatformV1beta1NotebookRuntime {
  ...
  public GoogleCloudAiplatformV1beta1NotebookRuntime() {
  }
  ...
  public GoogleCloudAiplatformV1beta1NotebookRuntime description(String description) {
  ...
  public GoogleCloudAiplatformV1beta1NotebookRuntime displayName(String displayName) {
  ...
  public GoogleCloudAiplatformV1beta1NotebookRuntime labels(Map<String, String> labels) {
    this.labels = labels;
    return this;
  }

  public GoogleCloudAiplatformV1beta1NotebookRuntime putLabelsItem(String key, String labelsItem) {
    if (this.labels == null) {
  ...
  public GoogleCloudAiplatformV1beta1NotebookRuntime networkTags(List<String> networkTags) {
    this.networkTags = networkTags;
    return this;
  }

  public GoogleCloudAiplatformV1beta1NotebookRuntime addNetworkTagsItem(String networkTagsItem) {
  ...
  public GoogleCloudAiplatformV1beta1NotebookRuntime notebookRuntimeTemplateRef(GoogleCloudAiplatformV1beta1NotebookRuntimeTemplateRef notebookRuntimeTemplateRef) {
  ...
  public void setNotebookRuntimeTemplateRef(GoogleCloudAiplatformV1beta1NotebookRuntimeTemplateRef notebookRuntimeTemplateRef) {
    this.notebookRuntimeTemplateRef = notebookRuntimeTemplateRef;
  }
  ...
  public GoogleCloudAiplatformV1beta1NotebookRuntime reservationAffinity(GoogleCloudAiplatformV1beta1NotebookReservationAffinity reservationAffinity) {
  ...
  public GoogleCloudAiplatformV1beta1NotebookRuntime runtimeUser(String runtimeUser) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudAiplatformV1beta1NotebookRuntime googleCloudAiplatformV1beta1NotebookRuntime = (GoogleCloudAiplatformV1beta1NotebookRuntime) o;
    return Objects.equals(this.createTime, googleCloudAiplatformV1beta1NotebookRuntime.createTime) &&
        Objects.equals(this.description, googleCloudAiplatformV1beta1NotebookRuntime.description) &&
        Objects.equals(this.displayName, googleCloudAiplatformV1beta1NotebookRuntime.displayName) &&
        Objects.equals(this.expirationTime, googleCloudAiplatformV1beta1NotebookRuntime.expirationTime) &&
        Objects.equals(this.healthState, googleCloudAiplatformV1beta1NotebookRuntime.healthState) &&
        Objects.equals(this.isUpgradable, googleCloudAiplatformV1beta1NotebookRuntime.isUpgradable) &&
        Objects.equals(this.labels, googleCloudAiplatformV1beta1NotebookRuntime.labels) &&
        Objects.equals(this.name, googleCloudAiplatformV1beta1NotebookRuntime.name) &&
        Objects.equals(this.networkTags, googleCloudAiplatformV1beta1NotebookRuntime.networkTags) &&
        Objects.equals(this.notebookRuntimeTemplateRef, googleCloudAiplatformV1beta1NotebookRuntime.notebookRuntimeTemplateRef) &&
        Objects.equals(this.notebookRuntimeType, googleCloudAiplatformV1beta1NotebookRuntime.notebookRuntimeType) &&
        Objects.equals(this.proxyUri, googleCloudAiplatformV1beta1NotebookRuntime.proxyUri) &&
        Objects.equals(this.reservationAffinity, googleCloudAiplatformV1beta1NotebookRuntime.reservationAffinity) &&
        Objects.equals(this.runtimeState, googleCloudAiplatformV1beta1NotebookRuntime.runtimeState) &&
        Objects.equals(this.runtimeUser, googleCloudAiplatformV1beta1NotebookRuntime.runtimeUser) &&
        Objects.equals(this.serviceAccount, googleCloudAiplatformV1beta1NotebookRuntime.serviceAccount) &&
        Objects.equals(this.updateTime, googleCloudAiplatformV1beta1NotebookRuntime.updateTime) &&
        Objects.equals(this.version, googleCloudAiplatformV1beta1NotebookRuntime.version);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudAiplatformV1beta1NotebookRuntime {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudAiplatformV1beta1NotebookRuntime
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudAiplatformV1beta1NotebookRuntime.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudAiplatformV1beta1NotebookRuntime is not found in the empty JSON string", GoogleCloudAiplatformV1beta1NotebookRuntime.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudAiplatformV1beta1NotebookRuntime.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudAiplatformV1beta1NotebookRuntime` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("notebookRuntimeTemplateRef") != null && !jsonObj.get("notebookRuntimeTemplateRef").isJsonNull()) {
        GoogleCloudAiplatformV1beta1NotebookRuntimeTemplateRef.validateJsonElement(jsonObj.get("notebookRuntimeTemplateRef"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudAiplatformV1beta1NotebookRuntime.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudAiplatformV1beta1NotebookRuntime' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudAiplatformV1beta1NotebookRuntime> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudAiplatformV1beta1NotebookRuntime.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudAiplatformV1beta1NotebookRuntime>() {
           @Override
           public void write(JsonWriter out, GoogleCloudAiplatformV1beta1NotebookRuntime value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudAiplatformV1beta1NotebookRuntime read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudAiplatformV1beta1NotebookRuntime given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudAiplatformV1beta1NotebookRuntime
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudAiplatformV1beta1NotebookRuntime
   */
  public static GoogleCloudAiplatformV1beta1NotebookRuntime fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudAiplatformV1beta1NotebookRuntime.class);
  }

  /**
   * Convert an instance of GoogleCloudAiplatformV1beta1NotebookRuntime to an JSON string
   *
   * @return JSON string
   */
