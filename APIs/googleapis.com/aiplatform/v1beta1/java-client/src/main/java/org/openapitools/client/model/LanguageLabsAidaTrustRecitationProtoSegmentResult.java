...
public class LanguageLabsAidaTrustRecitationProtoSegmentResult {
  ...
  public LanguageLabsAidaTrustRecitationProtoSegmentResult() {
  }

  public LanguageLabsAidaTrustRecitationProtoSegmentResult attributionDataset(AttributionDatasetEnum attributionDataset) {
  ...
  public LanguageLabsAidaTrustRecitationProtoSegmentResult displayAttributionMessage(String displayAttributionMessage) {
  ...
  public LanguageLabsAidaTrustRecitationProtoSegmentResult docAttribution(LanguageLabsAidaTrustRecitationProtoDocAttribution docAttribution) {
  ...
  public void setDocAttribution(LanguageLabsAidaTrustRecitationProtoDocAttribution docAttribution) {
    this.docAttribution = docAttribution;
  }


  public LanguageLabsAidaTrustRecitationProtoSegmentResult docOccurrences(Integer docOccurrences) {
  ...
  public LanguageLabsAidaTrustRecitationProtoSegmentResult endIndex(Integer endIndex) {
  ...
  public LanguageLabsAidaTrustRecitationProtoSegmentResult rawText(String rawText) {
  ...
  public LanguageLabsAidaTrustRecitationProtoSegmentResult segmentRecitationAction(SegmentRecitationActionEnum segmentRecitationAction) {
  ...
  public LanguageLabsAidaTrustRecitationProtoSegmentResult startIndex(Integer startIndex) {
  ...
  public boolean equals(Object o) {
    ...
    LanguageLabsAidaTrustRecitationProtoSegmentResult languageLabsAidaTrustRecitationProtoSegmentResult = (LanguageLabsAidaTrustRecitationProtoSegmentResult) o;
    return Objects.equals(this.attributionDataset, languageLabsAidaTrustRecitationProtoSegmentResult.attributionDataset) &&
        Objects.equals(this.displayAttributionMessage, languageLabsAidaTrustRecitationProtoSegmentResult.displayAttributionMessage) &&
        Objects.equals(this.docAttribution, languageLabsAidaTrustRecitationProtoSegmentResult.docAttribution) &&
        Objects.equals(this.docOccurrences, languageLabsAidaTrustRecitationProtoSegmentResult.docOccurrences) &&
        Objects.equals(this.endIndex, languageLabsAidaTrustRecitationProtoSegmentResult.endIndex) &&
        Objects.equals(this.rawText, languageLabsAidaTrustRecitationProtoSegmentResult.rawText) &&
        Objects.equals(this.segmentRecitationAction, languageLabsAidaTrustRecitationProtoSegmentResult.segmentRecitationAction) &&
        Objects.equals(this.startIndex, languageLabsAidaTrustRecitationProtoSegmentResult.startIndex);
  }
  ...
  public String toString() {
    ...
    sb.append("class LanguageLabsAidaTrustRecitationProtoSegmentResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LanguageLabsAidaTrustRecitationProtoSegmentResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LanguageLabsAidaTrustRecitationProtoSegmentResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LanguageLabsAidaTrustRecitationProtoSegmentResult is not found in the empty JSON string", LanguageLabsAidaTrustRecitationProtoSegmentResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LanguageLabsAidaTrustRecitationProtoSegmentResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LanguageLabsAidaTrustRecitationProtoSegmentResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("docAttribution") != null && !jsonObj.get("docAttribution").isJsonNull()) {
        LanguageLabsAidaTrustRecitationProtoDocAttribution.validateJsonElement(jsonObj.get("docAttribution"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LanguageLabsAidaTrustRecitationProtoSegmentResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LanguageLabsAidaTrustRecitationProtoSegmentResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LanguageLabsAidaTrustRecitationProtoSegmentResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LanguageLabsAidaTrustRecitationProtoSegmentResult.class));

       return (TypeAdapter<T>) new TypeAdapter<LanguageLabsAidaTrustRecitationProtoSegmentResult>() {
           @Override
           public void write(JsonWriter out, LanguageLabsAidaTrustRecitationProtoSegmentResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LanguageLabsAidaTrustRecitationProtoSegmentResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LanguageLabsAidaTrustRecitationProtoSegmentResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LanguageLabsAidaTrustRecitationProtoSegmentResult
   * @throws IOException if the JSON string is invalid with respect to LanguageLabsAidaTrustRecitationProtoSegmentResult
   */
  public static LanguageLabsAidaTrustRecitationProtoSegmentResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LanguageLabsAidaTrustRecitationProtoSegmentResult.class);
  }

  /**
   * Convert an instance of LanguageLabsAidaTrustRecitationProtoSegmentResult to an JSON string
   *
   * @return JSON string
   */
