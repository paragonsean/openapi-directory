...
public class GoogleCloudAiplatformV1beta1ImportDataConfig {
  ...
  public GoogleCloudAiplatformV1beta1ImportDataConfig() {
  }

  public GoogleCloudAiplatformV1beta1ImportDataConfig annotationLabels(Map<String, String> annotationLabels) {
    this.annotationLabels = annotationLabels;
    return this;
  }

  public GoogleCloudAiplatformV1beta1ImportDataConfig putAnnotationLabelsItem(String key, String annotationLabelsItem) {
  ...
  public GoogleCloudAiplatformV1beta1ImportDataConfig dataItemLabels(Map<String, String> dataItemLabels) {
    this.dataItemLabels = dataItemLabels;
    return this;
  }

  public GoogleCloudAiplatformV1beta1ImportDataConfig putDataItemLabelsItem(String key, String dataItemLabelsItem) {
  ...
  public GoogleCloudAiplatformV1beta1ImportDataConfig gcsSource(GoogleCloudAiplatformV1beta1GcsSource gcsSource) {
  ...
  public GoogleCloudAiplatformV1beta1ImportDataConfig importSchemaUri(String importSchemaUri) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudAiplatformV1beta1ImportDataConfig googleCloudAiplatformV1beta1ImportDataConfig = (GoogleCloudAiplatformV1beta1ImportDataConfig) o;
    return Objects.equals(this.annotationLabels, googleCloudAiplatformV1beta1ImportDataConfig.annotationLabels) &&
        Objects.equals(this.dataItemLabels, googleCloudAiplatformV1beta1ImportDataConfig.dataItemLabels) &&
        Objects.equals(this.gcsSource, googleCloudAiplatformV1beta1ImportDataConfig.gcsSource) &&
        Objects.equals(this.importSchemaUri, googleCloudAiplatformV1beta1ImportDataConfig.importSchemaUri);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudAiplatformV1beta1ImportDataConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudAiplatformV1beta1ImportDataConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudAiplatformV1beta1ImportDataConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudAiplatformV1beta1ImportDataConfig is not found in the empty JSON string", GoogleCloudAiplatformV1beta1ImportDataConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudAiplatformV1beta1ImportDataConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudAiplatformV1beta1ImportDataConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudAiplatformV1beta1ImportDataConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudAiplatformV1beta1ImportDataConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudAiplatformV1beta1ImportDataConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudAiplatformV1beta1ImportDataConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudAiplatformV1beta1ImportDataConfig>() {
           @Override
           public void write(JsonWriter out, GoogleCloudAiplatformV1beta1ImportDataConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudAiplatformV1beta1ImportDataConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudAiplatformV1beta1ImportDataConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudAiplatformV1beta1ImportDataConfig
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudAiplatformV1beta1ImportDataConfig
   */
  public static GoogleCloudAiplatformV1beta1ImportDataConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudAiplatformV1beta1ImportDataConfig.class);
  }

  /**
   * Convert an instance of GoogleCloudAiplatformV1beta1ImportDataConfig to an JSON string
   *
   * @return JSON string
   */
