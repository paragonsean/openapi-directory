...
public class GoogleCloudAiplatformV1beta1Attribution {
  ...
  public GoogleCloudAiplatformV1beta1Attribution() {
  }
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudAiplatformV1beta1Attribution googleCloudAiplatformV1beta1Attribution = (GoogleCloudAiplatformV1beta1Attribution) o;
    return Objects.equals(this.approximationError, googleCloudAiplatformV1beta1Attribution.approximationError) &&
        Objects.equals(this.baselineOutputValue, googleCloudAiplatformV1beta1Attribution.baselineOutputValue) &&
        Objects.equals(this.featureAttributions, googleCloudAiplatformV1beta1Attribution.featureAttributions) &&
        Objects.equals(this.instanceOutputValue, googleCloudAiplatformV1beta1Attribution.instanceOutputValue) &&
        Objects.equals(this.outputDisplayName, googleCloudAiplatformV1beta1Attribution.outputDisplayName) &&
        Objects.equals(this.outputIndex, googleCloudAiplatformV1beta1Attribution.outputIndex) &&
        Objects.equals(this.outputName, googleCloudAiplatformV1beta1Attribution.outputName);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudAiplatformV1beta1Attribution {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudAiplatformV1beta1Attribution
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudAiplatformV1beta1Attribution.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudAiplatformV1beta1Attribution is not found in the empty JSON string", GoogleCloudAiplatformV1beta1Attribution.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudAiplatformV1beta1Attribution.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudAiplatformV1beta1Attribution` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudAiplatformV1beta1Attribution.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudAiplatformV1beta1Attribution' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudAiplatformV1beta1Attribution> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudAiplatformV1beta1Attribution.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudAiplatformV1beta1Attribution>() {
           @Override
           public void write(JsonWriter out, GoogleCloudAiplatformV1beta1Attribution value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudAiplatformV1beta1Attribution read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudAiplatformV1beta1Attribution given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudAiplatformV1beta1Attribution
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudAiplatformV1beta1Attribution
   */
  public static GoogleCloudAiplatformV1beta1Attribution fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudAiplatformV1beta1Attribution.class);
  }

  /**
   * Convert an instance of GoogleCloudAiplatformV1beta1Attribution to an JSON string
   *
   * @return JSON string
   */
