...
public class GoogleCloudAiplatformV1beta1TrainingPipeline {
  ...
  public GoogleCloudAiplatformV1beta1TrainingPipeline() {
  }
  ...
  public GoogleCloudAiplatformV1beta1TrainingPipeline displayName(String displayName) {
  ...
  public GoogleCloudAiplatformV1beta1TrainingPipeline encryptionSpec(GoogleCloudAiplatformV1beta1EncryptionSpec encryptionSpec) {
  ...
  public GoogleCloudAiplatformV1beta1TrainingPipeline error(GoogleRpcStatus error) {
    this.error = error;
    return this;
  }
  ...
  public GoogleCloudAiplatformV1beta1TrainingPipeline inputDataConfig(GoogleCloudAiplatformV1beta1InputDataConfig inputDataConfig) {
  ...
  public void setInputDataConfig(GoogleCloudAiplatformV1beta1InputDataConfig inputDataConfig) {
    this.inputDataConfig = inputDataConfig;
  }


  public GoogleCloudAiplatformV1beta1TrainingPipeline labels(Map<String, String> labels) {
    this.labels = labels;
    return this;
  }

  public GoogleCloudAiplatformV1beta1TrainingPipeline putLabelsItem(String key, String labelsItem) {
    if (this.labels == null) {
  ...
  public GoogleCloudAiplatformV1beta1TrainingPipeline modelId(String modelId) {
  ...
  public GoogleCloudAiplatformV1beta1TrainingPipeline modelToUpload(GoogleCloudAiplatformV1beta1Model modelToUpload) {
  ...
  public void setModelToUpload(GoogleCloudAiplatformV1beta1Model modelToUpload) {
    this.modelToUpload = modelToUpload;
  }
  ...
  public GoogleCloudAiplatformV1beta1TrainingPipeline parentModel(String parentModel) {
  ...
  public GoogleCloudAiplatformV1beta1TrainingPipeline trainingTaskDefinition(String trainingTaskDefinition) {
  ...
  public GoogleCloudAiplatformV1beta1TrainingPipeline trainingTaskInputs(Object trainingTaskInputs) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudAiplatformV1beta1TrainingPipeline googleCloudAiplatformV1beta1TrainingPipeline = (GoogleCloudAiplatformV1beta1TrainingPipeline) o;
    return Objects.equals(this.createTime, googleCloudAiplatformV1beta1TrainingPipeline.createTime) &&
        Objects.equals(this.displayName, googleCloudAiplatformV1beta1TrainingPipeline.displayName) &&
        Objects.equals(this.encryptionSpec, googleCloudAiplatformV1beta1TrainingPipeline.encryptionSpec) &&
        Objects.equals(this.endTime, googleCloudAiplatformV1beta1TrainingPipeline.endTime) &&
        Objects.equals(this.error, googleCloudAiplatformV1beta1TrainingPipeline.error) &&
        Objects.equals(this.inputDataConfig, googleCloudAiplatformV1beta1TrainingPipeline.inputDataConfig) &&
        Objects.equals(this.labels, googleCloudAiplatformV1beta1TrainingPipeline.labels) &&
        Objects.equals(this.modelId, googleCloudAiplatformV1beta1TrainingPipeline.modelId) &&
        Objects.equals(this.modelToUpload, googleCloudAiplatformV1beta1TrainingPipeline.modelToUpload) &&
        Objects.equals(this.name, googleCloudAiplatformV1beta1TrainingPipeline.name) &&
        Objects.equals(this.parentModel, googleCloudAiplatformV1beta1TrainingPipeline.parentModel) &&
        Objects.equals(this.startTime, googleCloudAiplatformV1beta1TrainingPipeline.startTime) &&
        Objects.equals(this.state, googleCloudAiplatformV1beta1TrainingPipeline.state) &&
        Objects.equals(this.trainingTaskDefinition, googleCloudAiplatformV1beta1TrainingPipeline.trainingTaskDefinition) &&
        Objects.equals(this.trainingTaskInputs, googleCloudAiplatformV1beta1TrainingPipeline.trainingTaskInputs) &&
        Objects.equals(this.trainingTaskMetadata, googleCloudAiplatformV1beta1TrainingPipeline.trainingTaskMetadata) &&
        Objects.equals(this.updateTime, googleCloudAiplatformV1beta1TrainingPipeline.updateTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudAiplatformV1beta1TrainingPipeline {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudAiplatformV1beta1TrainingPipeline
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudAiplatformV1beta1TrainingPipeline.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudAiplatformV1beta1TrainingPipeline is not found in the empty JSON string", GoogleCloudAiplatformV1beta1TrainingPipeline.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudAiplatformV1beta1TrainingPipeline.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudAiplatformV1beta1TrainingPipeline` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("inputDataConfig") != null && !jsonObj.get("inputDataConfig").isJsonNull()) {
        GoogleCloudAiplatformV1beta1InputDataConfig.validateJsonElement(jsonObj.get("inputDataConfig"));
      }
      ...
      if (jsonObj.get("modelToUpload") != null && !jsonObj.get("modelToUpload").isJsonNull()) {
        GoogleCloudAiplatformV1beta1Model.validateJsonElement(jsonObj.get("modelToUpload"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudAiplatformV1beta1TrainingPipeline.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudAiplatformV1beta1TrainingPipeline' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudAiplatformV1beta1TrainingPipeline> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudAiplatformV1beta1TrainingPipeline.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudAiplatformV1beta1TrainingPipeline>() {
           @Override
           public void write(JsonWriter out, GoogleCloudAiplatformV1beta1TrainingPipeline value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudAiplatformV1beta1TrainingPipeline read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudAiplatformV1beta1TrainingPipeline given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudAiplatformV1beta1TrainingPipeline
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudAiplatformV1beta1TrainingPipeline
   */
  public static GoogleCloudAiplatformV1beta1TrainingPipeline fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudAiplatformV1beta1TrainingPipeline.class);
  }

  /**
   * Convert an instance of GoogleCloudAiplatformV1beta1TrainingPipeline to an JSON string
   *
   * @return JSON string
   */
