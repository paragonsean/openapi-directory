...
public class GoogleCloudAiplatformV1beta1PublisherModel {
  ...
  public GoogleCloudAiplatformV1beta1PublisherModel() {
  }
  ...
  public GoogleCloudAiplatformV1beta1PublisherModel frameworks(List<String> frameworks) {
    this.frameworks = frameworks;
    return this;
  }

  public GoogleCloudAiplatformV1beta1PublisherModel addFrameworksItem(String frameworksItem) {
  ...
  public GoogleCloudAiplatformV1beta1PublisherModel launchStage(LaunchStageEnum launchStage) {
  ...
  public GoogleCloudAiplatformV1beta1PublisherModel openSourceCategory(OpenSourceCategoryEnum openSourceCategory) {
  ...
  public GoogleCloudAiplatformV1beta1PublisherModel parent(GoogleCloudAiplatformV1beta1PublisherModelParent parent) {
    this.parent = parent;
    return this;
  }
  ...
  public void setParent(GoogleCloudAiplatformV1beta1PublisherModelParent parent) {
    this.parent = parent;
  }


  public GoogleCloudAiplatformV1beta1PublisherModel predictSchemata(GoogleCloudAiplatformV1beta1PredictSchemata predictSchemata) {
  ...
  public GoogleCloudAiplatformV1beta1PublisherModel supportedActions(GoogleCloudAiplatformV1beta1PublisherModelCallToAction supportedActions) {
  ...
  public void setSupportedActions(GoogleCloudAiplatformV1beta1PublisherModelCallToAction supportedActions) {
    this.supportedActions = supportedActions;
  }
  ...
  public GoogleCloudAiplatformV1beta1PublisherModel versionState(VersionStateEnum versionState) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudAiplatformV1beta1PublisherModel googleCloudAiplatformV1beta1PublisherModel = (GoogleCloudAiplatformV1beta1PublisherModel) o;
    return Objects.equals(this.frameworks, googleCloudAiplatformV1beta1PublisherModel.frameworks) &&
        Objects.equals(this.launchStage, googleCloudAiplatformV1beta1PublisherModel.launchStage) &&
        Objects.equals(this.name, googleCloudAiplatformV1beta1PublisherModel.name) &&
        Objects.equals(this.openSourceCategory, googleCloudAiplatformV1beta1PublisherModel.openSourceCategory) &&
        Objects.equals(this.parent, googleCloudAiplatformV1beta1PublisherModel.parent) &&
        Objects.equals(this.predictSchemata, googleCloudAiplatformV1beta1PublisherModel.predictSchemata) &&
        Objects.equals(this.publisherModelTemplate, googleCloudAiplatformV1beta1PublisherModel.publisherModelTemplate) &&
        Objects.equals(this.supportedActions, googleCloudAiplatformV1beta1PublisherModel.supportedActions) &&
        Objects.equals(this.versionId, googleCloudAiplatformV1beta1PublisherModel.versionId) &&
        Objects.equals(this.versionState, googleCloudAiplatformV1beta1PublisherModel.versionState);
  }

  @Override
  public int hashCode() {
    return Objects.hash(frameworks, launchStage, name, openSourceCategory, parent, predictSchemata, publisherModelTemplate, supportedActions, versionId, versionState);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GoogleCloudAiplatformV1beta1PublisherModel {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudAiplatformV1beta1PublisherModel
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudAiplatformV1beta1PublisherModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudAiplatformV1beta1PublisherModel is not found in the empty JSON string", GoogleCloudAiplatformV1beta1PublisherModel.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudAiplatformV1beta1PublisherModel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudAiplatformV1beta1PublisherModel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("parent") != null && !jsonObj.get("parent").isJsonNull()) {
        GoogleCloudAiplatformV1beta1PublisherModelParent.validateJsonElement(jsonObj.get("parent"));
      }
      ...
      if (jsonObj.get("supportedActions") != null && !jsonObj.get("supportedActions").isJsonNull()) {
        GoogleCloudAiplatformV1beta1PublisherModelCallToAction.validateJsonElement(jsonObj.get("supportedActions"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudAiplatformV1beta1PublisherModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudAiplatformV1beta1PublisherModel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudAiplatformV1beta1PublisherModel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudAiplatformV1beta1PublisherModel.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudAiplatformV1beta1PublisherModel>() {
           @Override
           public void write(JsonWriter out, GoogleCloudAiplatformV1beta1PublisherModel value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudAiplatformV1beta1PublisherModel read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudAiplatformV1beta1PublisherModel given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudAiplatformV1beta1PublisherModel
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudAiplatformV1beta1PublisherModel
   */
  public static GoogleCloudAiplatformV1beta1PublisherModel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudAiplatformV1beta1PublisherModel.class);
  }

  /**
   * Convert an instance of GoogleCloudAiplatformV1beta1PublisherModel to an JSON string
   *
   * @return JSON string
   */
