...
public class GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataVisualization {
  ...
  public GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataVisualization() {
  }

  public GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataVisualization clipPercentLowerbound(Float clipPercentLowerbound) {
  ...
  public GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataVisualization clipPercentUpperbound(Float clipPercentUpperbound) {
  ...
  public GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataVisualization colorMap(ColorMapEnum colorMap) {
  ...
  public GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataVisualization overlayType(OverlayTypeEnum overlayType) {
  ...
  public GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataVisualization polarity(PolarityEnum polarity) {
  ...
  public GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataVisualization type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataVisualization googleCloudAiplatformV1beta1ExplanationMetadataInputMetadataVisualization = (GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataVisualization) o;
    return Objects.equals(this.clipPercentLowerbound, googleCloudAiplatformV1beta1ExplanationMetadataInputMetadataVisualization.clipPercentLowerbound) &&
        Objects.equals(this.clipPercentUpperbound, googleCloudAiplatformV1beta1ExplanationMetadataInputMetadataVisualization.clipPercentUpperbound) &&
        Objects.equals(this.colorMap, googleCloudAiplatformV1beta1ExplanationMetadataInputMetadataVisualization.colorMap) &&
        Objects.equals(this.overlayType, googleCloudAiplatformV1beta1ExplanationMetadataInputMetadataVisualization.overlayType) &&
        Objects.equals(this.polarity, googleCloudAiplatformV1beta1ExplanationMetadataInputMetadataVisualization.polarity) &&
        Objects.equals(this.type, googleCloudAiplatformV1beta1ExplanationMetadataInputMetadataVisualization.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataVisualization {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataVisualization
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataVisualization.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataVisualization is not found in the empty JSON string", GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataVisualization.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataVisualization.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataVisualization` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataVisualization.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataVisualization' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataVisualization> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataVisualization.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataVisualization>() {
           @Override
           public void write(JsonWriter out, GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataVisualization value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataVisualization read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataVisualization given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataVisualization
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataVisualization
   */
  public static GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataVisualization fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataVisualization.class);
  }

  /**
   * Convert an instance of GoogleCloudAiplatformV1beta1ExplanationMetadataInputMetadataVisualization to an JSON string
   *
   * @return JSON string
   */
