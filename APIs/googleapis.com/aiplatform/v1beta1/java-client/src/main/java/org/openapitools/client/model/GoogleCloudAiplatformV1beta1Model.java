...
public class GoogleCloudAiplatformV1beta1Model {
  public static final String SERIALIZED_NAME_ARTIFACT_URI = "artifactUri";
  @SerializedName(SERIALIZED_NAME_ARTIFACT_URI)
  private String artifactUri;

  public static final String SERIALIZED_NAME_BASE_MODEL_SOURCE = "baseModelSource";
  @SerializedName(SERIALIZED_NAME_BASE_MODEL_SOURCE)
  ...
  private List<GoogleCloudAiplatformV1beta1DeployedModelRef> deployedModels = new ArrayList<>();
  ...
  private List<GoogleCloudAiplatformV1beta1ModelExportFormat> supportedExportFormats = new ArrayList<>();
  ...
  public GoogleCloudAiplatformV1beta1Model() {
  }

  public GoogleCloudAiplatformV1beta1Model(
     String createTime, 
     List<GoogleCloudAiplatformV1beta1DeployedModelRef> deployedModels, 
     String metadataArtifact, 
     List<SupportedDeploymentResourcesTypesEnum> supportedDeploymentResourcesTypes, 
     List<GoogleCloudAiplatformV1beta1ModelExportFormat> supportedExportFormats, 
  ...
  public GoogleCloudAiplatformV1beta1Model artifactUri(String artifactUri) {
  ...
  public GoogleCloudAiplatformV1beta1Model baseModelSource(GoogleCloudAiplatformV1beta1ModelBaseModelSource baseModelSource) {
  ...
  public void setBaseModelSource(GoogleCloudAiplatformV1beta1ModelBaseModelSource baseModelSource) {
    this.baseModelSource = baseModelSource;
  }


  public GoogleCloudAiplatformV1beta1Model containerSpec(GoogleCloudAiplatformV1beta1ModelContainerSpec containerSpec) {
  ...
  public GoogleCloudAiplatformV1beta1Model description(String description) {
  ...
  public GoogleCloudAiplatformV1beta1Model displayName(String displayName) {
  ...
  public GoogleCloudAiplatformV1beta1Model encryptionSpec(GoogleCloudAiplatformV1beta1EncryptionSpec encryptionSpec) {
  ...
  public GoogleCloudAiplatformV1beta1Model etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  public GoogleCloudAiplatformV1beta1Model explanationSpec(GoogleCloudAiplatformV1beta1ExplanationSpec explanationSpec) {
  ...
  public GoogleCloudAiplatformV1beta1Model labels(Map<String, String> labels) {
    this.labels = labels;
    return this;
  }

  public GoogleCloudAiplatformV1beta1Model putLabelsItem(String key, String labelsItem) {
    if (this.labels == null) {
  ...
  public GoogleCloudAiplatformV1beta1Model metadata(Object metadata) {
  ...
  public GoogleCloudAiplatformV1beta1Model metadataSchemaUri(String metadataSchemaUri) {
  ...
  public GoogleCloudAiplatformV1beta1Model modelSourceInfo(GoogleCloudAiplatformV1beta1ModelSourceInfo modelSourceInfo) {
  ...
  public void setModelSourceInfo(GoogleCloudAiplatformV1beta1ModelSourceInfo modelSourceInfo) {
    this.modelSourceInfo = modelSourceInfo;
  }


  public GoogleCloudAiplatformV1beta1Model name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GoogleCloudAiplatformV1beta1Model originalModelInfo(GoogleCloudAiplatformV1beta1ModelOriginalModelInfo originalModelInfo) {
  ...
  public void setOriginalModelInfo(GoogleCloudAiplatformV1beta1ModelOriginalModelInfo originalModelInfo) {
    this.originalModelInfo = originalModelInfo;
  }


  public GoogleCloudAiplatformV1beta1Model predictSchemata(GoogleCloudAiplatformV1beta1PredictSchemata predictSchemata) {
  ...
  public GoogleCloudAiplatformV1beta1Model versionAliases(List<String> versionAliases) {
    this.versionAliases = versionAliases;
    return this;
  }

  public GoogleCloudAiplatformV1beta1Model addVersionAliasesItem(String versionAliasesItem) {
  ...
  public GoogleCloudAiplatformV1beta1Model versionDescription(String versionDescription) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudAiplatformV1beta1Model googleCloudAiplatformV1beta1Model = (GoogleCloudAiplatformV1beta1Model) o;
    return Objects.equals(this.artifactUri, googleCloudAiplatformV1beta1Model.artifactUri) &&
        Objects.equals(this.baseModelSource, googleCloudAiplatformV1beta1Model.baseModelSource) &&
        Objects.equals(this.containerSpec, googleCloudAiplatformV1beta1Model.containerSpec) &&
        Objects.equals(this.createTime, googleCloudAiplatformV1beta1Model.createTime) &&
        Objects.equals(this.deployedModels, googleCloudAiplatformV1beta1Model.deployedModels) &&
        Objects.equals(this.description, googleCloudAiplatformV1beta1Model.description) &&
        Objects.equals(this.displayName, googleCloudAiplatformV1beta1Model.displayName) &&
        Objects.equals(this.encryptionSpec, googleCloudAiplatformV1beta1Model.encryptionSpec) &&
        Objects.equals(this.etag, googleCloudAiplatformV1beta1Model.etag) &&
        Objects.equals(this.explanationSpec, googleCloudAiplatformV1beta1Model.explanationSpec) &&
        Objects.equals(this.labels, googleCloudAiplatformV1beta1Model.labels) &&
        Objects.equals(this.metadata, googleCloudAiplatformV1beta1Model.metadata) &&
        Objects.equals(this.metadataArtifact, googleCloudAiplatformV1beta1Model.metadataArtifact) &&
        Objects.equals(this.metadataSchemaUri, googleCloudAiplatformV1beta1Model.metadataSchemaUri) &&
        Objects.equals(this.modelSourceInfo, googleCloudAiplatformV1beta1Model.modelSourceInfo) &&
        Objects.equals(this.name, googleCloudAiplatformV1beta1Model.name) &&
        Objects.equals(this.originalModelInfo, googleCloudAiplatformV1beta1Model.originalModelInfo) &&
        Objects.equals(this.predictSchemata, googleCloudAiplatformV1beta1Model.predictSchemata) &&
        Objects.equals(this.supportedDeploymentResourcesTypes, googleCloudAiplatformV1beta1Model.supportedDeploymentResourcesTypes) &&
        Objects.equals(this.supportedExportFormats, googleCloudAiplatformV1beta1Model.supportedExportFormats) &&
        Objects.equals(this.supportedInputStorageFormats, googleCloudAiplatformV1beta1Model.supportedInputStorageFormats) &&
        Objects.equals(this.supportedOutputStorageFormats, googleCloudAiplatformV1beta1Model.supportedOutputStorageFormats) &&
        Objects.equals(this.trainingPipeline, googleCloudAiplatformV1beta1Model.trainingPipeline) &&
        Objects.equals(this.updateTime, googleCloudAiplatformV1beta1Model.updateTime) &&
        Objects.equals(this.versionAliases, googleCloudAiplatformV1beta1Model.versionAliases) &&
        Objects.equals(this.versionCreateTime, googleCloudAiplatformV1beta1Model.versionCreateTime) &&
        Objects.equals(this.versionDescription, googleCloudAiplatformV1beta1Model.versionDescription) &&
        Objects.equals(this.versionId, googleCloudAiplatformV1beta1Model.versionId) &&
        Objects.equals(this.versionUpdateTime, googleCloudAiplatformV1beta1Model.versionUpdateTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudAiplatformV1beta1Model {\n");
    sb.append("    artifactUri: ").append(toIndentedString(artifactUri)).append("\n");
    sb.append("    baseModelSource: ").append(toIndentedString(baseModelSource)).append("\n");
  ...
  static {
    ...
    openapiFields.add("baseModelSource");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudAiplatformV1beta1Model
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudAiplatformV1beta1Model.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudAiplatformV1beta1Model is not found in the empty JSON string", GoogleCloudAiplatformV1beta1Model.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudAiplatformV1beta1Model.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudAiplatformV1beta1Model` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // validate the optional field `baseModelSource`
      if (jsonObj.get("baseModelSource") != null && !jsonObj.get("baseModelSource").isJsonNull()) {
        GoogleCloudAiplatformV1beta1ModelBaseModelSource.validateJsonElement(jsonObj.get("baseModelSource"));
      }
      ...
      if (jsonObj.get("deployedModels") != null && !jsonObj.get("deployedModels").isJsonNull()) {
        ...
        if (jsonArraydeployedModels != null) {
          ...
          for (int i = 0; i < jsonArraydeployedModels.size(); i++) {
            GoogleCloudAiplatformV1beta1DeployedModelRef.validateJsonElement(jsonArraydeployedModels.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("modelSourceInfo") != null && !jsonObj.get("modelSourceInfo").isJsonNull()) {
        GoogleCloudAiplatformV1beta1ModelSourceInfo.validateJsonElement(jsonObj.get("modelSourceInfo"));
      }
      ...
      if (jsonObj.get("originalModelInfo") != null && !jsonObj.get("originalModelInfo").isJsonNull()) {
        GoogleCloudAiplatformV1beta1ModelOriginalModelInfo.validateJsonElement(jsonObj.get("originalModelInfo"));
      }
      ...
      if (jsonObj.get("supportedExportFormats") != null && !jsonObj.get("supportedExportFormats").isJsonNull()) {
        ...
        if (jsonArraysupportedExportFormats != null) {
          ...
          for (int i = 0; i < jsonArraysupportedExportFormats.size(); i++) {
            GoogleCloudAiplatformV1beta1ModelExportFormat.validateJsonElement(jsonArraysupportedExportFormats.get(i));
          };
        }
      }
      // ensure the optional json data is an array if present
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudAiplatformV1beta1Model.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudAiplatformV1beta1Model' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudAiplatformV1beta1Model> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudAiplatformV1beta1Model.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudAiplatformV1beta1Model>() {
           @Override
           public void write(JsonWriter out, GoogleCloudAiplatformV1beta1Model value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudAiplatformV1beta1Model read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudAiplatformV1beta1Model given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudAiplatformV1beta1Model
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudAiplatformV1beta1Model
   */
  public static GoogleCloudAiplatformV1beta1Model fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudAiplatformV1beta1Model.class);
  }

  /**
   * Convert an instance of GoogleCloudAiplatformV1beta1Model to an JSON string
   *
   * @return JSON string
   */
