...
public class GoogleCloudAiplatformV1beta1StudySpecConvexAutomatedStoppingSpec {
  ...
  public GoogleCloudAiplatformV1beta1StudySpecConvexAutomatedStoppingSpec() {
  }

  public GoogleCloudAiplatformV1beta1StudySpecConvexAutomatedStoppingSpec learningRateParameterName(String learningRateParameterName) {
  ...
  public GoogleCloudAiplatformV1beta1StudySpecConvexAutomatedStoppingSpec maxStepCount(String maxStepCount) {
  ...
  public GoogleCloudAiplatformV1beta1StudySpecConvexAutomatedStoppingSpec minMeasurementCount(String minMeasurementCount) {
  ...
  public GoogleCloudAiplatformV1beta1StudySpecConvexAutomatedStoppingSpec minStepCount(String minStepCount) {
  ...
  public GoogleCloudAiplatformV1beta1StudySpecConvexAutomatedStoppingSpec updateAllStoppedTrials(Boolean updateAllStoppedTrials) {
  ...
  public GoogleCloudAiplatformV1beta1StudySpecConvexAutomatedStoppingSpec useElapsedDuration(Boolean useElapsedDuration) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudAiplatformV1beta1StudySpecConvexAutomatedStoppingSpec googleCloudAiplatformV1beta1StudySpecConvexAutomatedStoppingSpec = (GoogleCloudAiplatformV1beta1StudySpecConvexAutomatedStoppingSpec) o;
    return Objects.equals(this.learningRateParameterName, googleCloudAiplatformV1beta1StudySpecConvexAutomatedStoppingSpec.learningRateParameterName) &&
        Objects.equals(this.maxStepCount, googleCloudAiplatformV1beta1StudySpecConvexAutomatedStoppingSpec.maxStepCount) &&
        Objects.equals(this.minMeasurementCount, googleCloudAiplatformV1beta1StudySpecConvexAutomatedStoppingSpec.minMeasurementCount) &&
        Objects.equals(this.minStepCount, googleCloudAiplatformV1beta1StudySpecConvexAutomatedStoppingSpec.minStepCount) &&
        Objects.equals(this.updateAllStoppedTrials, googleCloudAiplatformV1beta1StudySpecConvexAutomatedStoppingSpec.updateAllStoppedTrials) &&
        Objects.equals(this.useElapsedDuration, googleCloudAiplatformV1beta1StudySpecConvexAutomatedStoppingSpec.useElapsedDuration);
  }
  ...
  public String toString() {
    ...
    sb.append("class GoogleCloudAiplatformV1beta1StudySpecConvexAutomatedStoppingSpec {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudAiplatformV1beta1StudySpecConvexAutomatedStoppingSpec
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudAiplatformV1beta1StudySpecConvexAutomatedStoppingSpec.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudAiplatformV1beta1StudySpecConvexAutomatedStoppingSpec is not found in the empty JSON string", GoogleCloudAiplatformV1beta1StudySpecConvexAutomatedStoppingSpec.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudAiplatformV1beta1StudySpecConvexAutomatedStoppingSpec.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudAiplatformV1beta1StudySpecConvexAutomatedStoppingSpec` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudAiplatformV1beta1StudySpecConvexAutomatedStoppingSpec.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudAiplatformV1beta1StudySpecConvexAutomatedStoppingSpec' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudAiplatformV1beta1StudySpecConvexAutomatedStoppingSpec> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudAiplatformV1beta1StudySpecConvexAutomatedStoppingSpec.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudAiplatformV1beta1StudySpecConvexAutomatedStoppingSpec>() {
           @Override
           public void write(JsonWriter out, GoogleCloudAiplatformV1beta1StudySpecConvexAutomatedStoppingSpec value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudAiplatformV1beta1StudySpecConvexAutomatedStoppingSpec read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudAiplatformV1beta1StudySpecConvexAutomatedStoppingSpec given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudAiplatformV1beta1StudySpecConvexAutomatedStoppingSpec
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudAiplatformV1beta1StudySpecConvexAutomatedStoppingSpec
   */
  public static GoogleCloudAiplatformV1beta1StudySpecConvexAutomatedStoppingSpec fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudAiplatformV1beta1StudySpecConvexAutomatedStoppingSpec.class);
  }

  /**
   * Convert an instance of GoogleCloudAiplatformV1beta1StudySpecConvexAutomatedStoppingSpec to an JSON string
   *
   * @return JSON string
   */
