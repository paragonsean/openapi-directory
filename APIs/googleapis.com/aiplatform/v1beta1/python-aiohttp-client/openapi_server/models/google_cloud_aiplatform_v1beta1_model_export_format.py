...
class GoogleCloudAiplatformV1beta1ModelExportFormat(Model):
    ...
    def __init__(self, exportable_contents: List[str]=None, id: str=None):
        """GoogleCloudAiplatformV1beta1ModelExportFormat - a model defined in OpenAPI

        :param exportable_contents: The exportable_contents of this GoogleCloudAiplatformV1beta1ModelExportFormat.
        :param id: The id of this GoogleCloudAiplatformV1beta1ModelExportFormat.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'GoogleCloudAiplatformV1beta1ModelExportFormat':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The GoogleCloudAiplatformV1beta1ModelExportFormat of this GoogleCloudAiplatformV1beta1ModelExportFormat.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def exportable_contents(self):
        """Gets the exportable_contents of this GoogleCloudAiplatformV1beta1ModelExportFormat.

        Output only. The content of this Model that may be exported.

        :return: The exportable_contents of this GoogleCloudAiplatformV1beta1ModelExportFormat.
        :rtype: List[str]
        """
    ...
    def exportable_contents(self, exportable_contents):
        """Sets the exportable_contents of this GoogleCloudAiplatformV1beta1ModelExportFormat.
    ...
    @property
    def id(self):
        """Gets the id of this GoogleCloudAiplatformV1beta1ModelExportFormat.
        ...
        :return: The id of this GoogleCloudAiplatformV1beta1ModelExportFormat.
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this GoogleCloudAiplatformV1beta1ModelExportFormat.
