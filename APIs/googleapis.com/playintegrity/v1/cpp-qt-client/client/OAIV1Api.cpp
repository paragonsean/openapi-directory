...
void OAIV1Api::initializeServerConfigs() {
    ...
    QUrl("https://playintegrity.googleapis.com/"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("playintegrity_decodeIntegrityToken", defaultConf);
    _serverIndices.insert("playintegrity_decodeIntegrityToken", 0);
}
...
void OAIV1Api::playintegrity_decodeIntegrityToken(const QString &package_name, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<OAIDecodeIntegrityTokenRequest> &oai_decode_integrity_token_request) {
    QString fullPath = QString(_serverConfigs["playintegrity_decodeIntegrityToken"][_serverIndices.value("playintegrity_decodeIntegrityToken")].URL()+"/v1/{packageName}:decodeIntegrityToken");
    ...
    if (oai_decode_integrity_token_request.hasValue()){

        
        QByteArray output = oai_decode_integrity_token_request.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIV1Api::playintegrity_decodeIntegrityTokenCallback);
    ...
    _authFlow.link();
    QStringList scope;
    scope.append("https://www.googleapis.com/auth/playintegrity");
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIV1Api::playintegrity_decodeIntegrityTokenCallback);
...
void OAIV1Api::playintegrity_decodeIntegrityTokenCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIDecodeIntegrityTokenResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT playintegrity_decodeIntegrityTokenSignal(output);
        Q_EMIT playintegrity_decodeIntegrityTokenSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT playintegrity_decodeIntegrityTokenSignalE(output, error_type, error_str);
        Q_EMIT playintegrity_decodeIntegrityTokenSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT playintegrity_decodeIntegrityTokenSignalError(output, error_type, error_str);
        Q_EMIT playintegrity_decodeIntegrityTokenSignalErrorFull(worker, error_type, error_str);
    }
}
