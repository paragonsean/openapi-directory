...
public class Advertiser {
  ...
  public Advertiser measurementPartnerLink(MeasurementPartnerAdvertiserLink measurementPartnerLink) {
  ...
  public void setMeasurementPartnerLink(MeasurementPartnerAdvertiserLink measurementPartnerLink) {
    this.measurementPartnerLink = measurementPartnerLink;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountId, advertiser.accountId) &&
        ...
        Objects.equals(this.measurementPartnerLink, advertiser.measurementPartnerLink) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, advertiserGroupId, clickThroughUrlSuffix, defaultClickThroughEventTagId, defaultEmail, floodlightConfigurationId, floodlightConfigurationIdDimensionValue, id, idDimensionValue, kind, measurementPartnerLink, name, originalFloodlightConfigurationId, status, subaccountId, suspended);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("measurementPartnerLink") != null && !jsonObj.get("measurementPartnerLink").isJsonNull()) {
        MeasurementPartnerAdvertiserLink.validateJsonElement(jsonObj.get("measurementPartnerLink"));
      }
