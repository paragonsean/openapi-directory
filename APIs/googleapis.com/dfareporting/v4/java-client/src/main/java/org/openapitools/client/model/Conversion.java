...
public class Conversion {
  ...
  public static final String SERIALIZED_NAME_USER_IDENTIFIERS = "userIdentifiers";
  @SerializedName(SERIALIZED_NAME_USER_IDENTIFIERS)
  private List<UserIdentifier> userIdentifiers = new ArrayList<>();
  ...
  public Conversion impressionId(String impressionId) {
  ...
  public Conversion userIdentifiers(List<UserIdentifier> userIdentifiers) {
    this.userIdentifiers = userIdentifiers;
    return this;
  }

  public Conversion addUserIdentifiersItem(UserIdentifier userIdentifiersItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.adUserDataConsent, conversion.adUserDataConsent) &&
        Objects.equals(this.childDirectedTreatment, conversion.childDirectedTreatment) &&
        ...
        Objects.equals(this.impressionId, conversion.impressionId) &&
  ...
  static {
    ...
    openapiFields.add("userIdentifiers");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("userIdentifiers") != null && !jsonObj.get("userIdentifiers").isJsonNull()) {
        JsonArray jsonArrayuserIdentifiers = jsonObj.getAsJsonArray("userIdentifiers");
        if (jsonArrayuserIdentifiers != null) {
          // ensure the json data is an array
          if (!jsonObj.get("userIdentifiers").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `userIdentifiers` to be an array in the JSON string but got `%s`", jsonObj.get("userIdentifiers").toString()));
          }

          // validate the optional field `userIdentifiers` (array)
          for (int i = 0; i < jsonArrayuserIdentifiers.size(); i++) {
            UserIdentifier.validateJsonElement(jsonArrayuserIdentifiers.get(i));
          };
        }
      }
  }
