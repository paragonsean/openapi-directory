...
|------------ | ------------- | ------------- | -------------|
|**adUserDataConsent** | [**AdUserDataConsentEnum**](#AdUserDataConsentEnum) | This represents consent for ad user data. |  [optional] |
...
|**dclid** | **String** | The display click ID. This field is mutually exclusive with encryptedUserId, encryptedUserIdCandidates[], matchId, mobileDeviceId, gclid, and impressionId. This or encryptedUserId or encryptedUserIdCandidates[] or matchId or mobileDeviceId or gclid or impressionId is a required field. |  [optional] |
...
|**gclid** | **String** | The Google click ID. This field is mutually exclusive with encryptedUserId, encryptedUserIdCandidates[], matchId, mobileDeviceId, dclid, and impressionId. This or encryptedUserId or encryptedUserIdCandidates[] or matchId or mobileDeviceId or dclid or impressionId is a required field. |  [optional] |
|**impressionId** | **String** | The impression ID. This field is mutually exclusive with encryptedUserId, encryptedUserIdCandidates[], matchId, mobileDeviceId, and gclid. One of these identifiers must be set. |  [optional] |
...
|**mobileDeviceId** | **String** | The mobile device ID. This field is mutually exclusive with encryptedUserId, encryptedUserIdCandidates[], matchId, gclid, dclid, and impressionId. This or encryptedUserId or encryptedUserIdCandidates[] or matchId or gclid or dclid or impressionId is a required field. |  [optional] |
...
|**quantity** | **String** | The quantity of the conversion. This is a required field. |  [optional] |
...
|**userIdentifiers** | [**List&lt;UserIdentifier&gt;**](UserIdentifier.md) | The user identifiers to enhance the conversion. The maximum number of user identifiers for each conversion is 5. |  [optional] |
|**value** | **Double** | The value of the conversion. This is a required field. |  [optional] |
