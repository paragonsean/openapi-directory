...
class Conversion {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('dclid')) {
                obj['dclid'] = ApiClient.convertToType(data['dclid'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        if (data['dclid'] && !(typeof data['dclid'] === 'string' || data['dclid'] instanceof String)) {
            throw new Error("Expected the field `dclid` to be a primitive type in the JSON string but got " + data['dclid']);
        }
        // ensure the json data is a string
 ...
 * @member {String} dclid
 */
Conversion.prototype['dclid'] = undefined;
