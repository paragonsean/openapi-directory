...
class FloodlightActivity {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('attributionEnabled')) {
                obj['attributionEnabled'] = ApiClient.convertToType(data['attributionEnabled'], 'Boolean');
            }
 ...
 * @member {Boolean} attributionEnabled
 */
FloodlightActivity.prototype['attributionEnabled'] = undefined;
 ...
 * @member {module:model/FloodlightActivity.StatusEnum} status
 */
FloodlightActivity.prototype['status'] = undefined;
