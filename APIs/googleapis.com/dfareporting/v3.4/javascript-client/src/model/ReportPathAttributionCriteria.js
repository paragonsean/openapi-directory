...
/**
 * The ReportPathAttributionCriteria model module.
 * @module model/ReportPathAttributionCriteria
 * @version v3.4
 */
class ReportPathAttributionCriteria {
    /**
     * Constructs a new <code>ReportPathAttributionCriteria</code>.
     * The report criteria for a report of type \&quot;PATH_ATTRIBUTION\&quot;.
     * @alias module:model/ReportPathAttributionCriteria
     */
    constructor() { 
        
        ReportPathAttributionCriteria.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ReportPathAttributionCriteria</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ReportPathAttributionCriteria} obj Optional instance to populate.
     * @return {module:model/ReportPathAttributionCriteria} The populated <code>ReportPathAttributionCriteria</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ReportPathAttributionCriteria();
    ...
    /**
     * Validates the JSON data with respect to <code>ReportPathAttributionCriteria</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ReportPathAttributionCriteria</code>.
     */
 ...
 */
ReportPathAttributionCriteria.prototype['activityFilters'] = undefined;

/**
 * @member {module:model/ChannelGrouping} customChannelGrouping
 */
ReportPathAttributionCriteria.prototype['customChannelGrouping'] = undefined;

/**
 * @member {module:model/DateRange} dateRange
 */
ReportPathAttributionCriteria.prototype['dateRange'] = undefined;

/**
 * The list of dimensions the report should include.
 * @member {Array.<module:model/SortedDimension>} dimensions
 */
ReportPathAttributionCriteria.prototype['dimensions'] = undefined;

/**
 * @member {module:model/DimensionValue} floodlightConfigId
 */
ReportPathAttributionCriteria.prototype['floodlightConfigId'] = undefined;

/**
 * The list of names of metrics the report should include.
 * @member {Array.<String>} metricNames
 */
ReportPathAttributionCriteria.prototype['metricNames'] = undefined;

/**
 * Path Filters.
 * @member {Array.<module:model/PathFilter>} pathFilters
 */
ReportPathAttributionCriteria.prototype['pathFilters'] = undefined;
...
export default ReportPathAttributionCriteria;
