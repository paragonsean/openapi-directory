...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CampaignManager360Api.AccountsListResponse();
  });
  ...
  describe('AccountsListResponse', function() {
    it('should create an instance of AccountsListResponse', function() {
      // uncomment below and update the code to test AccountsListResponse
      //var instance = new CampaignManager360Api.AccountsListResponse();
      //expect(instance).to.be.a(CampaignManager360Api.AccountsListResponse);
    });
