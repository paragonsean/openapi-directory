...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CampaignManager360Api.OffsetPosition();
  });
  ...
  describe('OffsetPosition', function() {
    it('should create an instance of OffsetPosition', function() {
      // uncomment below and update the code to test OffsetPosition
      //var instance = new CampaignManager360Api.OffsetPosition();
      //expect(instance).to.be.a(CampaignManager360Api.OffsetPosition);
    });
