...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CampaignManager360Api.UserProfileList();
  });
  ...
  describe('UserProfileList', function() {
    it('should create an instance of UserProfileList', function() {
      // uncomment below and update the code to test UserProfileList
      //var instance = new CampaignManager360Api.UserProfileList();
      //expect(instance).to.be.a(CampaignManager360Api.UserProfileList);
    });
