...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CampaignManager360Api.UserRole();
  });
  ...
  describe('UserRole', function() {
    it('should create an instance of UserRole', function() {
      ...
      //var instance = new CampaignManager360Api.UserRole();
      //expect(instance).to.be.a(CampaignManager360Api.UserRole);
    });
    ...
    it('should have the property defaultUserRole (base name: "defaultUserRole")', function() {
      // uncomment below and update the code to test the property defaultUserRole
      //var instance = new CampaignManager360Api.UserRole();
      //expect(instance).to.be();
    });
    ...
    it('should have the property parentUserRoleId (base name: "parentUserRoleId")', function() {
      // uncomment below and update the code to test the property parentUserRoleId
      //var instance = new CampaignManager360Api.UserRole();
      //expect(instance).to.be();
    });
