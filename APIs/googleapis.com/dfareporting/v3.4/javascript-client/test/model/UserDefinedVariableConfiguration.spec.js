...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CampaignManager360Api.UserDefinedVariableConfiguration();
  });
  ...
  describe('UserDefinedVariableConfiguration', function() {
    it('should create an instance of UserDefinedVariableConfiguration', function() {
      // uncomment below and update the code to test UserDefinedVariableConfiguration
      //var instance = new CampaignManager360Api.UserDefinedVariableConfiguration();
      //expect(instance).to.be.a(CampaignManager360Api.UserDefinedVariableConfiguration);
    });
