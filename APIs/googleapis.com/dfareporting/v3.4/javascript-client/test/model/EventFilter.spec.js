...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CampaignManager360Api.EventFilter();
  });
  ...
  describe('EventFilter', function() {
    it('should create an instance of EventFilter', function() {
      ...
      //var instance = new CampaignManager360Api.EventFilter();
      //expect(instance).to.be.a(CampaignManager360Api.EventFilter);
    });
