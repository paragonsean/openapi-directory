...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CampaignManager360Api.Flight();
  });
  ...
  describe('Flight', function() {
    it('should create an instance of Flight', function() {
      ...
      //var instance = new CampaignManager360Api.Flight();
      //expect(instance).to.be.a(CampaignManager360Api.Flight);
    });
    ...
    it('should have the property rateOrCost (base name: "rateOrCost")', function() {
      // uncomment below and update the code to test the property rateOrCost
      //var instance = new CampaignManager360Api.Flight();
      //expect(instance).to.be();
    });
