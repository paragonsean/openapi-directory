...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CampaignManager360Api.SiteSkippableSetting();
  });
  ...
  describe('SiteSkippableSetting', function() {
    it('should create an instance of SiteSkippableSetting', function() {
      // uncomment below and update the code to test SiteSkippableSetting
      //var instance = new CampaignManager360Api.SiteSkippableSetting();
      //expect(instance).to.be.a(CampaignManager360Api.SiteSkippableSetting);
    });
