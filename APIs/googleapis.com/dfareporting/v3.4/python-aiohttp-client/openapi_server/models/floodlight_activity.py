...
class FloodlightActivity(Model):
    ...
    def __init__(self, account_id: str=None, advertiser_id: str=None, advertiser_id_dimension_value: DimensionValue=None, attribution_enabled: bool=None, cache_busting_type: str=None, counting_method: str=None, default_tags: List[FloodlightActivityDynamicTag]=None, expected_url: str=None, floodlight_activity_group_id: str=None, floodlight_activity_group_name: str=None, floodlight_activity_group_tag_string: str=None, floodlight_activity_group_type: str=None, floodlight_configuration_id: str=None, floodlight_configuration_id_dimension_value: DimensionValue=None, floodlight_tag_type: str=None, id: str=None, id_dimension_value: DimensionValue=None, kind: str=None, name: str=None, notes: str=None, publisher_tags: List[FloodlightActivityPublisherDynamicTag]=None, secure: bool=None, ssl_compliant: bool=None, ssl_required: bool=None, status: str=None, subaccount_id: str=None, tag_format: str=None, tag_string: str=None, user_defined_variable_types: List[str]=None):
        ...
        :param attribution_enabled: The attribution_enabled of this FloodlightActivity.
        ...
        :param status: The status of this FloodlightActivity.
    ...
    @property
    def attribution_enabled(self):
        """Gets the attribution_enabled of this FloodlightActivity.

        Whether the activity is enabled for attribution.

        :return: The attribution_enabled of this FloodlightActivity.
        :rtype: bool
        """
        return self._attribution_enabled

    @attribution_enabled.setter
    def attribution_enabled(self, attribution_enabled):
        """Sets the attribution_enabled of this FloodlightActivity.

        Whether the activity is enabled for attribution.

        :param attribution_enabled: The attribution_enabled of this FloodlightActivity.
        :type attribution_enabled: bool
        """
    ...
    @property
    def status(self):
        """Gets the status of this FloodlightActivity.
        ...
        :return: The status of this FloodlightActivity.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this FloodlightActivity.
        ...
        :type status: str
        """
        allowed_values = ["ACTIVE", "ARCHIVED_AND_DISABLED", "ARCHIVED", "DISABLED_POLICY"]  # noqa: E501
