...
class VideoSettings(Model):
    ...
    def __init__(self, companion_settings: CompanionSetting=None, kind: str=None, oba_enabled: bool=None, oba_settings: ObaIcon=None, orientation: str=None, skippable_settings: SkippableSetting=None, transcode_settings: TranscodeSetting=None):
        ...
        :param oba_enabled: The oba_enabled of this VideoSettings.
        :param oba_settings: The oba_settings of this VideoSettings.
        ...
        self.attribute_map = {
            ...
            'kind': 'kind',
            'oba_enabled': 'obaEnabled',
            'oba_settings': 'obaSettings',
        ...
        self._kind = kind
        self._oba_enabled = oba_enabled
        self._oba_settings = oba_settings
    ...
    @property
    def oba_enabled(self):
        """Gets the oba_enabled of this VideoSettings.

        Whether OBA icons are enabled for this placement.

        :return: The oba_enabled of this VideoSettings.
        :rtype: bool
        """
        return self._oba_enabled

    @oba_enabled.setter
    def oba_enabled(self, oba_enabled):
        """Sets the oba_enabled of this VideoSettings.

        Whether OBA icons are enabled for this placement.

        :param oba_enabled: The oba_enabled of this VideoSettings.
        :type oba_enabled: bool
        """

        self._oba_enabled = oba_enabled

    @property
    def oba_settings(self):
        """Gets the oba_settings of this VideoSettings.


        :return: The oba_settings of this VideoSettings.
        :rtype: ObaIcon
        """
        return self._oba_settings

    @oba_settings.setter
    def oba_settings(self, oba_settings):
        """Sets the oba_settings of this VideoSettings.


        :param oba_settings: The oba_settings of this VideoSettings.
        :type oba_settings: ObaIcon
        """
