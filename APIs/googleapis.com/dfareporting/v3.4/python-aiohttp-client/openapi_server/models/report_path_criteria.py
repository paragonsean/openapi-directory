...
class ReportPathCriteria(Model):
    ...
    def __init__(self, activity_filters: List[DimensionValue]=None, custom_channel_grouping: ChannelGrouping=None, date_range: DateRange=None, dimensions: List[SortedDimension]=None, floodlight_config_id: DimensionValue=None, metric_names: List[str]=None, path_filters: List[PathFilter]=None):
        """ReportPathCriteria - a model defined in OpenAPI

        :param activity_filters: The activity_filters of this ReportPathCriteria.
        :param custom_channel_grouping: The custom_channel_grouping of this ReportPathCriteria.
        :param date_range: The date_range of this ReportPathCriteria.
        :param dimensions: The dimensions of this ReportPathCriteria.
        :param floodlight_config_id: The floodlight_config_id of this ReportPathCriteria.
        :param metric_names: The metric_names of this ReportPathCriteria.
        :param path_filters: The path_filters of this ReportPathCriteria.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ReportPathCriteria':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The Report_pathCriteria of this ReportPathCriteria.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def activity_filters(self):
        """Gets the activity_filters of this ReportPathCriteria.

        The list of 'dfa:activity' values to filter on.

        :return: The activity_filters of this ReportPathCriteria.
    ...
    def activity_filters(self, activity_filters):
        """Sets the activity_filters of this ReportPathCriteria.
    ...
    def custom_channel_grouping(self):
        """Gets the custom_channel_grouping of this ReportPathCriteria.


        :return: The custom_channel_grouping of this ReportPathCriteria.
    ...
    def custom_channel_grouping(self, custom_channel_grouping):
        """Sets the custom_channel_grouping of this ReportPathCriteria.
    ...
    @property
    def date_range(self):
        """Gets the date_range of this ReportPathCriteria.


        :return: The date_range of this ReportPathCriteria.
        :rtype: DateRange
        """
    ...
    def date_range(self, date_range):
        """Sets the date_range of this ReportPathCriteria.
    ...
    @property
    def dimensions(self):
        """Gets the dimensions of this ReportPathCriteria.

        The list of dimensions the report should include.

        :return: The dimensions of this ReportPathCriteria.
    ...
    def dimensions(self, dimensions):
        """Sets the dimensions of this ReportPathCriteria.
    ...
    def floodlight_config_id(self):
        """Gets the floodlight_config_id of this ReportPathCriteria.


        :return: The floodlight_config_id of this ReportPathCriteria.
    ...
    def floodlight_config_id(self, floodlight_config_id):
        """Sets the floodlight_config_id of this ReportPathCriteria.
    ...
    def metric_names(self):
        """Gets the metric_names of this ReportPathCriteria.

        The list of names of metrics the report should include.

        :return: The metric_names of this ReportPathCriteria.
        :rtype: List[str]
        """
    ...
    def metric_names(self, metric_names):
        """Sets the metric_names of this ReportPathCriteria.
    ...
    def path_filters(self):
        """Gets the path_filters of this ReportPathCriteria.

        Path Filters.

        :return: The path_filters of this ReportPathCriteria.
    ...
    def path_filters(self, path_filters):
        """Sets the path_filters of this ReportPathCriteria.
