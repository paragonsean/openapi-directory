...
class PricingSchedule(Model):
    ...
    def __init__(self, cap_cost_option: str=None, end_date: date=None, flighted: bool=None, floodlight_activity_id: str=None, pricing_periods: List[PricingSchedulePricingPeriod]=None, pricing_type: str=None, start_date: date=None, testing_start_date: date=None):
