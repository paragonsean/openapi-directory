...
|**listPopulationClauses** | [**List&lt;ListPopulationClause&gt;**](ListPopulationClause.md) | Clauses that make up this list population rule. Clauses are joined by ANDs, and the clauses themselves are made up of list population terms which are joined by ORs. |  [optional] |
