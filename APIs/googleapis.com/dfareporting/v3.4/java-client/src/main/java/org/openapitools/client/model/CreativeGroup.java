...
public class CreativeGroup {
  ...
  public CreativeGroup accountId(String accountId) {
  ...
  public CreativeGroup advertiserId(String advertiserId) {
  ...
  public CreativeGroup advertiserIdDimensionValue(DimensionValue advertiserIdDimensionValue) {
  ...
  public CreativeGroup groupNumber(Integer groupNumber) {
  ...
  public CreativeGroup id(String id) {
    this.id = id;
    return this;
  }
  ...
  public CreativeGroup kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  public CreativeGroup name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CreativeGroup subaccountId(String subaccountId) {
  ...
  public boolean equals(Object o) {
    ...
    CreativeGroup creativeGroup = (CreativeGroup) o;
    return Objects.equals(this.accountId, creativeGroup.accountId) &&
        Objects.equals(this.advertiserId, creativeGroup.advertiserId) &&
        Objects.equals(this.advertiserIdDimensionValue, creativeGroup.advertiserIdDimensionValue) &&
        Objects.equals(this.groupNumber, creativeGroup.groupNumber) &&
        Objects.equals(this.id, creativeGroup.id) &&
        Objects.equals(this.kind, creativeGroup.kind) &&
        Objects.equals(this.name, creativeGroup.name) &&
        Objects.equals(this.subaccountId, creativeGroup.subaccountId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountId, advertiserId, advertiserIdDimensionValue, groupNumber, id, kind, name, subaccountId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreativeGroup {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreativeGroup
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreativeGroup.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreativeGroup is not found in the empty JSON string", CreativeGroup.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreativeGroup.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreativeGroup` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreativeGroup.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreativeGroup' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreativeGroup> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreativeGroup.class));

       return (TypeAdapter<T>) new TypeAdapter<CreativeGroup>() {
           @Override
           public void write(JsonWriter out, CreativeGroup value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreativeGroup read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreativeGroup given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreativeGroup
   * @throws IOException if the JSON string is invalid with respect to CreativeGroup
   */
  public static CreativeGroup fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreativeGroup.class);
  }

  /**
   * Convert an instance of CreativeGroup to an JSON string
   *
   * @return JSON string
   */
