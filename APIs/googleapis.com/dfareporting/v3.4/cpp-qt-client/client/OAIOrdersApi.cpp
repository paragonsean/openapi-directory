...
void OAIOrdersApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("dfareporting_orders_get", defaultConf);
    _serverIndices.insert("dfareporting_orders_get", 0);
    _serverConfigs.insert("dfareporting_orders_list", defaultConf);
    _serverIndices.insert("dfareporting_orders_list", 0);
}
...
void OAIOrdersApi::dfareporting_orders_get(const QString &profile_id, const QString &project_id, const QString &id, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type) {
    QString fullPath = QString(_serverConfigs["dfareporting_orders_get"][_serverIndices.value("dfareporting_orders_get")].URL()+"/userprofiles/{profileId}/projects/{projectId}/orders/{id}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIOrdersApi::dfareporting_orders_getCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIOrdersApi::dfareporting_orders_getCallback);
...
void OAIOrdersApi::dfareporting_orders_getCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT dfareporting_orders_getSignal(output);
        Q_EMIT dfareporting_orders_getSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT dfareporting_orders_getSignalE(output, error_type, error_str);
        Q_EMIT dfareporting_orders_getSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT dfareporting_orders_getSignalError(output, error_type, error_str);
        Q_EMIT dfareporting_orders_getSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIOrdersApi::dfareporting_orders_list(const QString &profile_id, const QString &project_id, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<QList<QString>> &ids, const ::OpenAPI::OptionalParam<qint32> &max_results, const ::OpenAPI::OptionalParam<QString> &page_token, const ::OpenAPI::OptionalParam<QString> &search_string, const ::OpenAPI::OptionalParam<QList<QString>> &site_id, const ::OpenAPI::OptionalParam<QString> &sort_field, const ::OpenAPI::OptionalParam<QString> &sort_order) {
    QString fullPath = QString(_serverConfigs["dfareporting_orders_list"][_serverIndices.value("dfareporting_orders_list")].URL()+"/userprofiles/{profileId}/projects/{projectId}/orders");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIOrdersApi::dfareporting_orders_listCallback);
    connect(this, &OAIOrdersApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIOrdersApi::dfareporting_orders_listCallback);
    connect(this, &OAIOrdersApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIOrdersApi::dfareporting_orders_listCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT dfareporting_orders_listSignal(output);
        Q_EMIT dfareporting_orders_listSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("https://www.googleapis.com/auth/dfatrafficking");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT dfareporting_orders_listSignalE(output, error_type, error_str);
        Q_EMIT dfareporting_orders_listSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT dfareporting_orders_listSignalError(output, error_type, error_str);
        Q_EMIT dfareporting_orders_listSignalErrorFull(worker, error_type, error_str);
    }
}
