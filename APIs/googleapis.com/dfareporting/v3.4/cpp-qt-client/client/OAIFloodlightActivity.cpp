...
void OAIFloodlightActivity::initializeModel() {
    ...
    m_attribution_enabled_isSet = false;
    m_attribution_enabled_isValid = false;
...
void OAIFloodlightActivity::fromJsonObject(QJsonObject json) {
    ...
    m_attribution_enabled_isValid = ::OpenAPI::fromJsonValue(m_attribution_enabled, json[QString("attributionEnabled")]);
    m_attribution_enabled_isSet = !json[QString("attributionEnabled")].isNull() && m_attribution_enabled_isValid;
...
QJsonObject OAIFloodlightActivity::asJsonObject() const {
    ...
    if (m_attribution_enabled_isSet) {
        obj.insert(QString("attributionEnabled"), ::OpenAPI::toJsonValue(m_attribution_enabled));
    }
...
bool OAIFloodlightActivity::isAttributionEnabled() const {
    return m_attribution_enabled;
}
void OAIFloodlightActivity::setAttributionEnabled(const bool &attribution_enabled) {
    m_attribution_enabled = attribution_enabled;
    m_attribution_enabled_isSet = true;
}

bool OAIFloodlightActivity::is_attribution_enabled_Set() const{
    return m_attribution_enabled_isSet;
}

bool OAIFloodlightActivity::is_attribution_enabled_Valid() const{
    return m_attribution_enabled_isValid;
}
...
QString OAIFloodlightActivity::getStatus() const {
    return m_status;
}
void OAIFloodlightActivity::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIFloodlightActivity::is_status_Set() const{
    return m_status_isSet;
}

bool OAIFloodlightActivity::is_status_Valid() const{
