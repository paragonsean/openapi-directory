...
void OAIFilesApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("dfareporting_files_get", defaultConf);
    _serverIndices.insert("dfareporting_files_get", 0);
    _serverConfigs.insert("dfareporting_files_list", defaultConf);
    _serverIndices.insert("dfareporting_files_list", 0);
}
...
void OAIFilesApi::dfareporting_files_get(const QString &report_id, const QString &file_id, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type) {
    QString fullPath = QString(_serverConfigs["dfareporting_files_get"][_serverIndices.value("dfareporting_files_get")].URL()+"/reports/{reportId}/files/{fileId}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIFilesApi::dfareporting_files_getCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIFilesApi::dfareporting_files_getCallback);
...
void OAIFilesApi::dfareporting_files_getCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT dfareporting_files_getSignal(output);
        Q_EMIT dfareporting_files_getSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT dfareporting_files_getSignalE(output, error_type, error_str);
        Q_EMIT dfareporting_files_getSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT dfareporting_files_getSignalError(output, error_type, error_str);
        Q_EMIT dfareporting_files_getSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIFilesApi::dfareporting_files_list(const QString &profile_id, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<qint32> &max_results, const ::OpenAPI::OptionalParam<QString> &page_token, const ::OpenAPI::OptionalParam<QString> &scope, const ::OpenAPI::OptionalParam<QString> &sort_field, const ::OpenAPI::OptionalParam<QString> &sort_order) {
    QString fullPath = QString(_serverConfigs["dfareporting_files_list"][_serverIndices.value("dfareporting_files_list")].URL()+"/userprofiles/{profileId}/files");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIFilesApi::dfareporting_files_listCallback);
    connect(this, &OAIFilesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIFilesApi::dfareporting_files_listCallback);
    connect(this, &OAIFilesApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIFilesApi::dfareporting_files_listCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT dfareporting_files_listSignal(output);
        Q_EMIT dfareporting_files_listSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("https://www.googleapis.com/auth/dfareporting");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT dfareporting_files_listSignalE(output, error_type, error_str);
        Q_EMIT dfareporting_files_listSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT dfareporting_files_listSignalError(output, error_type, error_str);
        Q_EMIT dfareporting_files_listSignalErrorFull(worker, error_type, error_str);
    }
}
