...
void OAIReport::initializeModel() {
    ...
    m_path_attribution_criteria_isSet = false;
    m_path_attribution_criteria_isValid = false;

    m_path_criteria_isSet = false;
    m_path_criteria_isValid = false;
...
void OAIReport::fromJsonObject(QJsonObject json) {
    ...
    m_path_attribution_criteria_isValid = ::OpenAPI::fromJsonValue(m_path_attribution_criteria, json[QString("pathAttributionCriteria")]);
    m_path_attribution_criteria_isSet = !json[QString("pathAttributionCriteria")].isNull() && m_path_attribution_criteria_isValid;

    m_path_criteria_isValid = ::OpenAPI::fromJsonValue(m_path_criteria, json[QString("pathCriteria")]);
    m_path_criteria_isSet = !json[QString("pathCriteria")].isNull() && m_path_criteria_isValid;
...
QJsonObject OAIReport::asJsonObject() const {
    ...
    if (m_path_attribution_criteria.isSet()) {
        obj.insert(QString("pathAttributionCriteria"), ::OpenAPI::toJsonValue(m_path_attribution_criteria));
    }
    if (m_path_criteria.isSet()) {
        obj.insert(QString("pathCriteria"), ::OpenAPI::toJsonValue(m_path_criteria));
    }
...
OAIReport_pathAttributionCriteria OAIReport::getPathAttributionCriteria() const {
    return m_path_attribution_criteria;
}
void OAIReport::setPathAttributionCriteria(const OAIReport_pathAttributionCriteria &path_attribution_criteria) {
    m_path_attribution_criteria = path_attribution_criteria;
    m_path_attribution_criteria_isSet = true;
}

bool OAIReport::is_path_attribution_criteria_Set() const{
    return m_path_attribution_criteria_isSet;
}

bool OAIReport::is_path_attribution_criteria_Valid() const{
    return m_path_attribution_criteria_isValid;
}

OAIReport_pathCriteria OAIReport::getPathCriteria() const {
    return m_path_criteria;
}
void OAIReport::setPathCriteria(const OAIReport_pathCriteria &path_criteria) {
    m_path_criteria = path_criteria;
    m_path_criteria_isSet = true;
}

bool OAIReport::is_path_criteria_Set() const{
    return m_path_criteria_isSet;
}

bool OAIReport::is_path_criteria_Valid() const{
    return m_path_criteria_isValid;
}
