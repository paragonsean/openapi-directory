...
namespace OpenAPI {
class OAIPathReportDimensionValue;
...
public:
    ...
    OAIPathReportDimensionValue getDimensionFilter() const;
    void setDimensionFilter(const OAIPathReportDimensionValue &dimension_filter);
...
private:
    ...
    OAIPathReportDimensionValue m_dimension_filter;
