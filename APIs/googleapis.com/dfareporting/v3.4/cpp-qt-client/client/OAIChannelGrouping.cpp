...
QString OAIChannelGrouping::getKind() const {
    return m_kind;
}
void OAIChannelGrouping::setKind(const QString &kind) {
    m_kind = kind;
    m_kind_isSet = true;
}

bool OAIChannelGrouping::is_kind_Set() const{
    return m_kind_isSet;
}

bool OAIChannelGrouping::is_kind_Valid() const{
...
QList<OAIChannelGroupingRule> OAIChannelGrouping::getRules() const {
    return m_rules;
}
void OAIChannelGrouping::setRules(const QList<OAIChannelGroupingRule> &rules) {
    m_rules = rules;
    m_rules_isSet = true;
}
