...
/*
 * OAIFloodlightReportCompatibleFields.h
 *
 * Represents fields that are compatible to be selected for a report of type \&quot;FlOODLIGHT\&quot;.
 */

#ifndef OAIFloodlightReportCompatibleFields_H
#define OAIFloodlightReportCompatibleFields_H
...
class OAIFloodlightReportCompatibleFields : public OAIObject {
public:
    OAIFloodlightReportCompatibleFields();
    OAIFloodlightReportCompatibleFields(QString json);
    ~OAIFloodlightReportCompatibleFields() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFloodlightReportCompatibleFields)

#endif // OAIFloodlightReportCompatibleFields_H
