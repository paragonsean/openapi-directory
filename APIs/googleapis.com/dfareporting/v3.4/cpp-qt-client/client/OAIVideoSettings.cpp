...
bool OAIVideoSettings::isObaEnabled() const {
    return m_oba_enabled;
}
void OAIVideoSettings::setObaEnabled(const bool &oba_enabled) {
    m_oba_enabled = oba_enabled;
    m_oba_enabled_isSet = true;
}

bool OAIVideoSettings::is_oba_enabled_Set() const{
    return m_oba_enabled_isSet;
}

bool OAIVideoSettings::is_oba_enabled_Valid() const{
    return m_oba_enabled_isValid;
}

OAIObaIcon OAIVideoSettings::getObaSettings() const {
    return m_oba_settings;
}
void OAIVideoSettings::setObaSettings(const OAIObaIcon &oba_settings) {
    m_oba_settings = oba_settings;
    m_oba_settings_isSet = true;
}

bool OAIVideoSettings::is_oba_settings_Set() const{
    return m_oba_settings_isSet;
}

bool OAIVideoSettings::is_oba_settings_Valid() const{
