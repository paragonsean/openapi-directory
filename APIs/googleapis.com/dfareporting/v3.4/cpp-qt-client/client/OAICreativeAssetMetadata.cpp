...
void OAICreativeAssetMetadata::initializeModel() {
    ...
    m_rich_media_isSet = false;
    m_rich_media_isValid = false;
...
void OAICreativeAssetMetadata::fromJsonObject(QJsonObject json) {
    ...
    m_rich_media_isValid = ::OpenAPI::fromJsonValue(m_rich_media, json[QString("richMedia")]);
    m_rich_media_isSet = !json[QString("richMedia")].isNull() && m_rich_media_isValid;
...
QJsonObject OAICreativeAssetMetadata::asJsonObject() const {
    ...
    if (m_rich_media_isSet) {
        obj.insert(QString("richMedia"), ::OpenAPI::toJsonValue(m_rich_media));
    }
...
QList<OAICreativeCustomEvent> OAICreativeAssetMetadata::getCounterCustomEvents() const {
    return m_counter_custom_events;
}
void OAICreativeAssetMetadata::setCounterCustomEvents(const QList<OAICreativeCustomEvent> &counter_custom_events) {
    m_counter_custom_events = counter_custom_events;
    m_counter_custom_events_isSet = true;
}

bool OAICreativeAssetMetadata::is_counter_custom_events_Set() const{
    return m_counter_custom_events_isSet;
}

bool OAICreativeAssetMetadata::is_counter_custom_events_Valid() const{
...
QList<OAICreativeCustomEvent> OAICreativeAssetMetadata::getExitCustomEvents() const {
    return m_exit_custom_events;
}
void OAICreativeAssetMetadata::setExitCustomEvents(const QList<OAICreativeCustomEvent> &exit_custom_events) {
    m_exit_custom_events = exit_custom_events;
    m_exit_custom_events_isSet = true;
}

bool OAICreativeAssetMetadata::is_exit_custom_events_Set() const{
    return m_exit_custom_events_isSet;
}

bool OAICreativeAssetMetadata::is_exit_custom_events_Valid() const{
...
bool OAICreativeAssetMetadata::isRichMedia() const {
    return m_rich_media;
}
void OAICreativeAssetMetadata::setRichMedia(const bool &rich_media) {
    m_rich_media = rich_media;
    m_rich_media_isSet = true;
}

bool OAICreativeAssetMetadata::is_rich_media_Set() const{
    return m_rich_media_isSet;
}

bool OAICreativeAssetMetadata::is_rich_media_Valid() const{
    return m_rich_media_isValid;
}

QList<OAICreativeCustomEvent> OAICreativeAssetMetadata::getTimerCustomEvents() const {
    return m_timer_custom_events;
}
void OAICreativeAssetMetadata::setTimerCustomEvents(const QList<OAICreativeCustomEvent> &timer_custom_events) {
    m_timer_custom_events = timer_custom_events;
    m_timer_custom_events_isSet = true;
}

bool OAICreativeAssetMetadata::is_timer_custom_events_Set() const{
    return m_timer_custom_events_isSet;
}

bool OAICreativeAssetMetadata::is_timer_custom_events_Valid() const{
