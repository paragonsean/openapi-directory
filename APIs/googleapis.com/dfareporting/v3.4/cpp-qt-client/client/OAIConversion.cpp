...
void OAIConversion::fromJsonObject(QJsonObject json) {
    ...
    m_dclid_isValid = ::OpenAPI::fromJsonValue(m_dclid, json[QString("dclid")]);
    m_dclid_isSet = !json[QString("dclid")].isNull() && m_dclid_isValid;
...
QJsonObject OAIConversion::asJsonObject() const {
    ...
    if (m_dclid_isSet) {
        obj.insert(QString("dclid"), ::OpenAPI::toJsonValue(m_dclid));
    }
...
QString OAIConversion::getDclid() const {
    return m_dclid;
}
void OAIConversion::setDclid(const QString &dclid) {
    m_dclid = dclid;
    m_dclid_isSet = true;
}

bool OAIConversion::is_dclid_Set() const{
    return m_dclid_isSet;
}

bool OAIConversion::is_dclid_Valid() const{
    return m_dclid_isValid;
}
