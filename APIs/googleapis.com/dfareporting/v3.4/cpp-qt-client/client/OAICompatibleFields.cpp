...
void OAICompatibleFields::initializeModel() {
    ...
    m_path_attribution_report_compatible_fields_isSet = false;
    m_path_attribution_report_compatible_fields_isValid = false;

    m_path_report_compatible_fields_isSet = false;
    m_path_report_compatible_fields_isValid = false;
...
void OAICompatibleFields::fromJsonObject(QJsonObject json) {
    ...
    m_path_attribution_report_compatible_fields_isValid = ::OpenAPI::fromJsonValue(m_path_attribution_report_compatible_fields, json[QString("pathAttributionReportCompatibleFields")]);
    m_path_attribution_report_compatible_fields_isSet = !json[QString("pathAttributionReportCompatibleFields")].isNull() && m_path_attribution_report_compatible_fields_isValid;

    m_path_report_compatible_fields_isValid = ::OpenAPI::fromJsonValue(m_path_report_compatible_fields, json[QString("pathReportCompatibleFields")]);
    m_path_report_compatible_fields_isSet = !json[QString("pathReportCompatibleFields")].isNull() && m_path_report_compatible_fields_isValid;
...
QJsonObject OAICompatibleFields::asJsonObject() const {
    ...
    if (m_path_attribution_report_compatible_fields.isSet()) {
        obj.insert(QString("pathAttributionReportCompatibleFields"), ::OpenAPI::toJsonValue(m_path_attribution_report_compatible_fields));
    }
    if (m_path_report_compatible_fields.isSet()) {
        obj.insert(QString("pathReportCompatibleFields"), ::OpenAPI::toJsonValue(m_path_report_compatible_fields));
    }
...
OAIPathReportCompatibleFields OAICompatibleFields::getPathAttributionReportCompatibleFields() const {
    return m_path_attribution_report_compatible_fields;
}
void OAICompatibleFields::setPathAttributionReportCompatibleFields(const OAIPathReportCompatibleFields &path_attribution_report_compatible_fields) {
    m_path_attribution_report_compatible_fields = path_attribution_report_compatible_fields;
    m_path_attribution_report_compatible_fields_isSet = true;
}

bool OAICompatibleFields::is_path_attribution_report_compatible_fields_Set() const{
    return m_path_attribution_report_compatible_fields_isSet;
}

bool OAICompatibleFields::is_path_attribution_report_compatible_fields_Valid() const{
    return m_path_attribution_report_compatible_fields_isValid;
}

OAIPathReportCompatibleFields OAICompatibleFields::getPathReportCompatibleFields() const {
    return m_path_report_compatible_fields;
}
void OAICompatibleFields::setPathReportCompatibleFields(const OAIPathReportCompatibleFields &path_report_compatible_fields) {
    m_path_report_compatible_fields = path_report_compatible_fields;
    m_path_report_compatible_fields_isSet = true;
}

bool OAICompatibleFields::is_path_report_compatible_fields_Set() const{
    return m_path_report_compatible_fields_isSet;
}

bool OAICompatibleFields::is_path_report_compatible_fields_Valid() const{
    return m_path_report_compatible_fields_isValid;
}
