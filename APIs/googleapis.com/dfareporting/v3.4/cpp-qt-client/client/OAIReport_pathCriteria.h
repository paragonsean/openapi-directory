...
/*
 * OAIReport_pathCriteria.h
 *
 * The report criteria for a report of type \&quot;PATH\&quot;.
 */

#ifndef OAIReport_pathCriteria_H
#define OAIReport_pathCriteria_H
...
class OAIReport_pathCriteria : public OAIObject {
public:
    OAIReport_pathCriteria();
    OAIReport_pathCriteria(QString json);
    ~OAIReport_pathCriteria() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReport_pathCriteria)

#endif // OAIReport_pathCriteria_H
