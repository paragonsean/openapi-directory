...
void OAIProjectsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("dfareporting_projects_get", defaultConf);
    _serverIndices.insert("dfareporting_projects_get", 0);
    _serverConfigs.insert("dfareporting_projects_list", defaultConf);
    _serverIndices.insert("dfareporting_projects_list", 0);
}
...
void OAIProjectsApi::dfareporting_projects_get(const QString &profile_id, const QString &id, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type) {
    QString fullPath = QString(_serverConfigs["dfareporting_projects_get"][_serverIndices.value("dfareporting_projects_get")].URL()+"/userprofiles/{profileId}/projects/{id}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::dfareporting_projects_getCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::dfareporting_projects_getCallback);
...
void OAIProjectsApi::dfareporting_projects_getCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT dfareporting_projects_getSignal(output);
        Q_EMIT dfareporting_projects_getSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT dfareporting_projects_getSignalE(output, error_type, error_str);
        Q_EMIT dfareporting_projects_getSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT dfareporting_projects_getSignalError(output, error_type, error_str);
        Q_EMIT dfareporting_projects_getSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectsApi::dfareporting_projects_list(const QString &profile_id, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<QList<QString>> &advertiser_ids, const ::OpenAPI::OptionalParam<QList<QString>> &ids, const ::OpenAPI::OptionalParam<qint32> &max_results, const ::OpenAPI::OptionalParam<QString> &page_token, const ::OpenAPI::OptionalParam<QString> &search_string, const ::OpenAPI::OptionalParam<QString> &sort_field, const ::OpenAPI::OptionalParam<QString> &sort_order) {
    QString fullPath = QString(_serverConfigs["dfareporting_projects_list"][_serverIndices.value("dfareporting_projects_list")].URL()+"/userprofiles/{profileId}/projects");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::dfareporting_projects_listCallback);
    connect(this, &OAIProjectsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::dfareporting_projects_listCallback);
    connect(this, &OAIProjectsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectsApi::dfareporting_projects_listCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIProjectsListResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT dfareporting_projects_listSignal(output);
        Q_EMIT dfareporting_projects_listSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("https://www.googleapis.com/auth/dfatrafficking");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT dfareporting_projects_listSignalE(output, error_type, error_str);
        Q_EMIT dfareporting_projects_listSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT dfareporting_projects_listSignalError(output, error_type, error_str);
        Q_EMIT dfareporting_projects_listSignalErrorFull(worker, error_type, error_str);
    }
}
