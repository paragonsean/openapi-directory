...
public class Report {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, criteria, crossDimensionReachCriteria, delivery, etag, fileName, floodlightCriteria, format, id, kind, lastModifiedTime, name, ownerProfileId, pathToConversionCriteria, reachCriteria, schedule, subAccountId, type);
  }
