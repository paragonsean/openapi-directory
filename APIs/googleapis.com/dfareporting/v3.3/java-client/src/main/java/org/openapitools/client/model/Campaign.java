...
public class Campaign {
  ...
  public static final String SERIALIZED_NAME_TRAFFICKER_EMAILS = "traffickerEmails";
  @SerializedName(SERIALIZED_NAME_TRAFFICKER_EMAILS)
  private List<String> traffickerEmails = new ArrayList<>();
  ...
  public Campaign nielsenOcrEnabled(Boolean nielsenOcrEnabled) {
  ...
  public Campaign traffickerEmails(List<String> traffickerEmails) {
    this.traffickerEmails = traffickerEmails;
    return this;
  }

  public Campaign addTraffickerEmailsItem(String traffickerEmailsItem) {
    if (this.traffickerEmails == null) {
      this.traffickerEmails = new ArrayList<>();
    }
    this.traffickerEmails.add(traffickerEmailsItem);
    return this;
  }
  ...
  public void setTraffickerEmails(List<String> traffickerEmails) {
    this.traffickerEmails = traffickerEmails;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountId, campaign.accountId) &&
        ...
        Objects.equals(this.nielsenOcrEnabled, campaign.nielsenOcrEnabled) &&
        Objects.equals(this.startDate, campaign.startDate) &&
        Objects.equals(this.subaccountId, campaign.subaccountId) &&
        Objects.equals(this.traffickerEmails, campaign.traffickerEmails);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountId, adBlockingConfiguration, additionalCreativeOptimizationConfigurations, advertiserGroupId, advertiserId, advertiserIdDimensionValue, archived, audienceSegmentGroups, billingInvoiceCode, clickThroughUrlSuffixProperties, comment, createInfo, creativeGroupIds, creativeOptimizationConfiguration, defaultClickThroughEventTagProperties, defaultLandingPageId, endDate, eventTagOverrides, externalId, id, idDimensionValue, kind, lastModifiedInfo, name, nielsenOcrEnabled, startDate, subaccountId, traffickerEmails);
  }
  ...
  public String toString() {
    ...
    sb.append("    traffickerEmails: ").append(toIndentedString(traffickerEmails)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("traffickerEmails");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // ensure the optional json data is an array if present
      if (jsonObj.get("traffickerEmails") != null && !jsonObj.get("traffickerEmails").isJsonNull() && !jsonObj.get("traffickerEmails").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `traffickerEmails` to be an array in the JSON string but got `%s`", jsonObj.get("traffickerEmails").toString()));
      }
  }
