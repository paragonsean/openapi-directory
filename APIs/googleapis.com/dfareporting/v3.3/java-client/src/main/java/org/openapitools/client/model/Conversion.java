...
public class Conversion {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(childDirectedTreatment, customVariables, encryptedUserId, encryptedUserIdCandidates, floodlightActivityId, floodlightConfigurationId, gclid, kind, limitAdTracking, matchId, mobileDeviceId, nonPersonalizedAd, ordinal, quantity, timestampMicros, treatmentForUnderage, value);
  }
