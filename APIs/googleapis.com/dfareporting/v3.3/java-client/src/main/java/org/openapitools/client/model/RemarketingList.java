...
public class RemarketingList {
  ...
  public static final String SERIALIZED_NAME_LIST_POPULATION_RULE = "listPopulationRule";
  @SerializedName(SERIALIZED_NAME_LIST_POPULATION_RULE)
  ...
  public RemarketingList accountId(String accountId) {
  ...
  public RemarketingList active(Boolean active) {
    this.active = active;
    return this;
  }
  ...
  public RemarketingList advertiserId(String advertiserId) {
  ...
  public RemarketingList advertiserIdDimensionValue(DimensionValue advertiserIdDimensionValue) {
  ...
  public RemarketingList description(String description) {
  ...
  public RemarketingList id(String id) {
    this.id = id;
    return this;
  }
  ...
  public RemarketingList kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  public RemarketingList lifeSpan(String lifeSpan) {
  ...
  public RemarketingList listPopulationRule(ListPopulationRule listPopulationRule) {
    this.listPopulationRule = listPopulationRule;
    return this;
  }

  /**
   * Get listPopulationRule
  ...
  public void setListPopulationRule(ListPopulationRule listPopulationRule) {
    this.listPopulationRule = listPopulationRule;
  }


  public RemarketingList listSize(String listSize) {
  ...
  public RemarketingList listSource(ListSourceEnum listSource) {
  ...
  public RemarketingList name(String name) {
    this.name = name;
    return this;
  }
  ...
  public RemarketingList subaccountId(String subaccountId) {
  ...
  public boolean equals(Object o) {
    ...
    RemarketingList remarketingList = (RemarketingList) o;
    return Objects.equals(this.accountId, remarketingList.accountId) &&
        Objects.equals(this.active, remarketingList.active) &&
        Objects.equals(this.advertiserId, remarketingList.advertiserId) &&
        Objects.equals(this.advertiserIdDimensionValue, remarketingList.advertiserIdDimensionValue) &&
        Objects.equals(this.description, remarketingList.description) &&
        Objects.equals(this.id, remarketingList.id) &&
        Objects.equals(this.kind, remarketingList.kind) &&
        Objects.equals(this.lifeSpan, remarketingList.lifeSpan) &&
        Objects.equals(this.listPopulationRule, remarketingList.listPopulationRule) &&
        Objects.equals(this.listSize, remarketingList.listSize) &&
        Objects.equals(this.listSource, remarketingList.listSource) &&
        Objects.equals(this.name, remarketingList.name) &&
        Objects.equals(this.subaccountId, remarketingList.subaccountId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountId, active, advertiserId, advertiserIdDimensionValue, description, id, kind, lifeSpan, listPopulationRule, listSize, listSource, name, subaccountId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RemarketingList {\n");
    ...
    sb.append("    listPopulationRule: ").append(toIndentedString(listPopulationRule)).append("\n");
  ...
  static {
    ...
    openapiFields.add("listPopulationRule");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RemarketingList
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RemarketingList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RemarketingList is not found in the empty JSON string", RemarketingList.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RemarketingList.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RemarketingList` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("listPopulationRule") != null && !jsonObj.get("listPopulationRule").isJsonNull()) {
        ListPopulationRule.validateJsonElement(jsonObj.get("listPopulationRule"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RemarketingList.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RemarketingList' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RemarketingList> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RemarketingList.class));

       return (TypeAdapter<T>) new TypeAdapter<RemarketingList>() {
           @Override
           public void write(JsonWriter out, RemarketingList value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RemarketingList read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RemarketingList given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RemarketingList
   * @throws IOException if the JSON string is invalid with respect to RemarketingList
   */
  public static RemarketingList fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RemarketingList.class);
  }

  /**
   * Convert an instance of RemarketingList to an JSON string
   *
   * @return JSON string
   */
