...
public class PricingSchedule {
  ...
  public static final String SERIALIZED_NAME_DISREGARD_OVERDELIVERY = "disregardOverdelivery";
  @SerializedName(SERIALIZED_NAME_DISREGARD_OVERDELIVERY)
  private Boolean disregardOverdelivery;
  ...
  public PricingSchedule disregardOverdelivery(Boolean disregardOverdelivery) {
   ...
   */
  @javax.annotation.Nullable
  public Boolean getDisregardOverdelivery() {
    return disregardOverdelivery;
  }

  public void setDisregardOverdelivery(Boolean disregardOverdelivery) {
    this.disregardOverdelivery = disregardOverdelivery;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.capCostOption, pricingSchedule.capCostOption) &&
        Objects.equals(this.disregardOverdelivery, pricingSchedule.disregardOverdelivery) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(capCostOption, disregardOverdelivery, endDate, flighted, floodlightActivityId, pricingPeriods, pricingType, startDate, testingStartDate);
  }
  ...
  public String toString() {
    ...
    sb.append("    disregardOverdelivery: ").append(toIndentedString(disregardOverdelivery)).append("\n");
  ...
  static {
    ...
    openapiFields.add("disregardOverdelivery");
