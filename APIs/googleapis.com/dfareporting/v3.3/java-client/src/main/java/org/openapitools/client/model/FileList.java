...
public class FileList {
  ...
  private List<ModelFile> items = new ArrayList<>();
  ...
  public FileList etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  public FileList items(List<ModelFile> items) {
    this.items = items;
    return this;
  }

  public FileList addItemsItem(ModelFile itemsItem) {
    if (this.items == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<ModelFile> getItems() {
    return items;
  }

  public void setItems(List<ModelFile> items) {
    this.items = items;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.etag, fileList.etag) &&
        Objects.equals(this.items, fileList.items) &&
      ...
      if (jsonObj.get("items") != null && !jsonObj.get("items").isJsonNull()) {
        ...
        if (jsonArrayitems != null) {
          ...
          for (int i = 0; i < jsonArrayitems.size(); i++) {
            ModelFile.validateJsonElement(jsonArrayitems.get(i));
          };
        }
      }
