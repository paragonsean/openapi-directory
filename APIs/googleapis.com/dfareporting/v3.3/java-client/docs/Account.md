...
|------------ | ------------- | ------------- | -------------|
|**accountPermissionIds** | **List&lt;String&gt;** | Account permissions assigned to this account. |  [optional] |
|**accountProfile** | [**AccountProfileEnum**](#AccountProfileEnum) | Profile for this account. This is a read-only field that can be left blank. |  [optional] |
|**active** | **Boolean** | Whether this account is active. |  [optional] |
|**activeAdsLimitTier** | [**ActiveAdsLimitTierEnum**](#ActiveAdsLimitTierEnum) | Maximum number of active ads allowed for this account. |  [optional] |
...
|**availablePermissionIds** | **List&lt;String&gt;** | User role permissions available to the user roles of this account. |  [optional] |
