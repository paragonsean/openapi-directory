...
#ifndef OAIDimensionValue_H
#define OAIDimensionValue_H
...
class OAIDimensionValue : public OAIObject {
public:
    OAIDimensionValue();
    OAIDimensionValue(QString json);
    ~OAIDimensionValue() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDimensionValue)

#endif // OAIDimensionValue_H
