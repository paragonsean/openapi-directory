...
public:
    ...
    bool isDisregardOverdelivery() const;
    void setDisregardOverdelivery(const bool &disregard_overdelivery);
    bool is_disregard_overdelivery_Set() const;
    bool is_disregard_overdelivery_Valid() const;
...
private:
    ...
    bool m_disregard_overdelivery;
    bool m_disregard_overdelivery_isSet;
    bool m_disregard_overdelivery_isValid;
