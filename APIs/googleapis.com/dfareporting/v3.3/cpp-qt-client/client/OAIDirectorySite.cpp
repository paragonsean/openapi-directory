...
bool OAIDirectorySite::isActive() const {
    return m_active;
}
void OAIDirectorySite::setActive(const bool &active) {
    m_active = active;
    m_active_isSet = true;
}

bool OAIDirectorySite::is_active_Set() const{
    return m_active_isSet;
}

bool OAIDirectorySite::is_active_Valid() const{
