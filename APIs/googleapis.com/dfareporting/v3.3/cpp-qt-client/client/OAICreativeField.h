...
#ifndef OAICreativeField_H
#define OAICreativeField_H
...
class OAICreativeField : public OAIObject {
public:
    OAICreativeField();
    OAICreativeField(QString json);
    ~OAICreativeField() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreativeField)

#endif // OAICreativeField_H
