...
QString OAIDimensionFilter::getKind() const {
    return m_kind;
}
void OAIDimensionFilter::setKind(const QString &kind) {
    m_kind = kind;
    m_kind_isSet = true;
}

bool OAIDimensionFilter::is_kind_Set() const{
    return m_kind_isSet;
}

bool OAIDimensionFilter::is_kind_Valid() const{
