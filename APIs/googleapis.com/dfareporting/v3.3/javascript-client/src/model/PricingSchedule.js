...
class PricingSchedule {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('disregardOverdelivery')) {
                obj['disregardOverdelivery'] = ApiClient.convertToType(data['disregardOverdelivery'], 'Boolean');
            }
 ...
 * @member {Boolean} disregardOverdelivery
 */
PricingSchedule.prototype['disregardOverdelivery'] = undefined;
