# CampaignManager360Api.PlacementGroup
...
**childPlacementIds** | **[String]** | IDs of placements which are assigned to this placement group. This is a read-only, auto-generated field. | [optional] 
...
* `PACKAGE` (value: `"PLACEMENT_PACKAGE"`)

* `ROADBLOCK` (value: `"PLACEMENT_ROADBLOCK"`)
