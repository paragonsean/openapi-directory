# CampaignManager360Api.FloodlightActivityGroup
...
**type** | **String** | Type of the floodlight activity group. This is a required field that is read-only after insertion. | [optional] 
