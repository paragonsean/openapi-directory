# CampaignManager360Api.Campaign
...
**additionalCreativeOptimizationConfigurations** | [**[CreativeOptimizationConfiguration]**](CreativeOptimizationConfiguration.md) | Additional creative optimization configurations for the campaign. | [optional] 
...
**audienceSegmentGroups** | [**[AudienceSegmentGroup]**](AudienceSegmentGroup.md) | Audience segment groups assigned to this campaign. Cannot have more than 300 segment groups. | [optional] 
...
**creativeGroupIds** | **[String]** | List of creative group IDs that are assigned to the campaign. | [optional] 
...
**eventTagOverrides** | [**[EventTagOverride]**](EventTagOverride.md) | Overrides that can be used to activate or deactivate advertiser event tags. | [optional] 
...
**name** | **String** | Name of this campaign. This is a required field and must be less than 256 characters long and unique among campaigns of the same advertiser. | [optional] 
...
**traffickerEmails** | **[String]** | Campaign trafficker contact emails. | [optional] 
