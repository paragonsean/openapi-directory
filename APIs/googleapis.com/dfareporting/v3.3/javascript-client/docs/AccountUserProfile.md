# CampaignManager360Api.AccountUserProfile
...
**traffickerType** | **String** | Trafficker type of this user profile. This is a read-only field. | [optional] 
**userAccessType** | **String** | User type of the user profile. This is a read-only field that can be left blank. | [optional] 
...
* `INTERNAL_NON_TRAFFICKER` (value: `"INTERNAL_NON_TRAFFICKER"`)

* `INTERNAL_TRAFFICKER` (value: `"INTERNAL_TRAFFICKER"`)

* `EXTERNAL_TRAFFICKER` (value: `"EXTERNAL_TRAFFICKER"`)
...
* `INTERNAL_ADMINISTRATOR` (value: `"INTERNAL_ADMINISTRATOR"`)

* `READ_ONLY_SUPER_USER` (value: `"READ_ONLY_SUPER_USER"`)
