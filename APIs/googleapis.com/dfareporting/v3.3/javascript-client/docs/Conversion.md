# CampaignManager360Api.Conversion
...
**customVariables** | [**[CustomFloodlightVariable]**](CustomFloodlightVariable.md) | Custom floodlight variables. This field may only be used when calling batchinsert; it is not supported by batchupdate. | [optional] 
...
**value** | **Number** | The value of the conversion. | [optional] 
