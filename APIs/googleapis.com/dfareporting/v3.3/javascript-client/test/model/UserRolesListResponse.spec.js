...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CampaignManager360Api.UserRolesListResponse();
  });
  ...
  describe('UserRolesListResponse', function() {
    it('should create an instance of UserRolesListResponse', function() {
      // uncomment below and update the code to test UserRolesListResponse
      //var instance = new CampaignManager360Api.UserRolesListResponse();
      //expect(instance).to.be.a(CampaignManager360Api.UserRolesListResponse);
    });
