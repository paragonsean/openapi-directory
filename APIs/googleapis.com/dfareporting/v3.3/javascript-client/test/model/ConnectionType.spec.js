...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CampaignManager360Api.ConnectionType();
  });
  ...
  describe('ConnectionType', function() {
    it('should create an instance of ConnectionType', function() {
      ...
      //var instance = new CampaignManager360Api.ConnectionType();
      //expect(instance).to.be.a(CampaignManager360Api.ConnectionType);
    });
