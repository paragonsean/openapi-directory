...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CampaignManager360Api.ReportList();
  });
  ...
  describe('ReportList', function() {
    it('should create an instance of ReportList', function() {
      ...
      //var instance = new CampaignManager360Api.ReportList();
      //expect(instance).to.be.a(CampaignManager360Api.ReportList);
    });
