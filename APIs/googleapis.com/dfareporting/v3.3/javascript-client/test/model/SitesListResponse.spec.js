...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CampaignManager360Api.SitesListResponse();
  });
  ...
  describe('SitesListResponse', function() {
    it('should create an instance of SitesListResponse', function() {
      // uncomment below and update the code to test SitesListResponse
      //var instance = new CampaignManager360Api.SitesListResponse();
      //expect(instance).to.be.a(CampaignManager360Api.SitesListResponse);
    });
