...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CampaignManager360Api.CampaignsListResponse();
  });
  ...
  describe('CampaignsListResponse', function() {
    it('should create an instance of CampaignsListResponse', function() {
      // uncomment below and update the code to test CampaignsListResponse
      //var instance = new CampaignManager360Api.CampaignsListResponse();
      //expect(instance).to.be.a(CampaignManager360Api.CampaignsListResponse);
    });
