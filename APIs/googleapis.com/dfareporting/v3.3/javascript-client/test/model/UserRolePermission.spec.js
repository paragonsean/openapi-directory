...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CampaignManager360Api.UserRolePermission();
  });
  ...
  describe('UserRolePermission', function() {
    it('should create an instance of UserRolePermission', function() {
      // uncomment below and update the code to test UserRolePermission
      //var instance = new CampaignManager360Api.UserRolePermission();
      //expect(instance).to.be.a(CampaignManager360Api.UserRolePermission);
    });
