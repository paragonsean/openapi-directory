...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CampaignManager360Api.DimensionValueList();
  });
  ...
  describe('DimensionValueList', function() {
    it('should create an instance of DimensionValueList', function() {
      // uncomment below and update the code to test DimensionValueList
      //var instance = new CampaignManager360Api.DimensionValueList();
      //expect(instance).to.be.a(CampaignManager360Api.DimensionValueList);
    });
