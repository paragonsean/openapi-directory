...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CampaignManager360Api.OrderContact();
  });
  ...
  describe('OrderContact', function() {
    it('should create an instance of OrderContact', function() {
      // uncomment below and update the code to test OrderContact
      //var instance = new CampaignManager360Api.OrderContact();
      //expect(instance).to.be.a(CampaignManager360Api.OrderContact);
    });
    ...
    it('should have the property signatureUserProfileId (base name: "signatureUserProfileId")', function() {
      // uncomment below and update the code to test the property signatureUserProfileId
      //var instance = new CampaignManager360Api.OrderContact();
      //expect(instance).to.be();
    });
