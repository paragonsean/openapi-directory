...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CampaignManager360Api.PlacementsListResponse();
  });
  ...
  describe('PlacementsListResponse', function() {
    it('should create an instance of PlacementsListResponse', function() {
      // uncomment below and update the code to test PlacementsListResponse
      //var instance = new CampaignManager360Api.PlacementsListResponse();
      //expect(instance).to.be.a(CampaignManager360Api.PlacementsListResponse);
    });
