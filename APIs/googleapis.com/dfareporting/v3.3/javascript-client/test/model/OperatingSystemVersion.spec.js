...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CampaignManager360Api.OperatingSystemVersion();
  });
  ...
  describe('OperatingSystemVersion', function() {
    it('should create an instance of OperatingSystemVersion', function() {
      // uncomment below and update the code to test OperatingSystemVersion
      //var instance = new CampaignManager360Api.OperatingSystemVersion();
      //expect(instance).to.be.a(CampaignManager360Api.OperatingSystemVersion);
    });
