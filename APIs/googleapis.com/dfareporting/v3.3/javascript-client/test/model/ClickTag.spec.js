...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CampaignManager360Api.ClickTag();
  });
  ...
  describe('ClickTag', function() {
    it('should create an instance of ClickTag', function() {
      // uncomment below and update the code to test ClickTag
      //var instance = new CampaignManager360Api.ClickTag();
      //expect(instance).to.be.a(CampaignManager360Api.ClickTag);
    });
