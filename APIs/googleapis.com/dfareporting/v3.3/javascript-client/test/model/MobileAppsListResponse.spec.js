...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CampaignManager360Api.MobileAppsListResponse();
  });
  ...
  describe('MobileAppsListResponse', function() {
    it('should create an instance of MobileAppsListResponse', function() {
      // uncomment below and update the code to test MobileAppsListResponse
      //var instance = new CampaignManager360Api.MobileAppsListResponse();
      //expect(instance).to.be.a(CampaignManager360Api.MobileAppsListResponse);
    });
