...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CampaignManager360Api.CreativeGroup();
  });
  ...
  describe('CreativeGroup', function() {
    it('should create an instance of CreativeGroup', function() {
      // uncomment below and update the code to test CreativeGroup
      //var instance = new CampaignManager360Api.CreativeGroup();
      //expect(instance).to.be.a(CampaignManager360Api.CreativeGroup);
    });
