...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CampaignManager360Api.DynamicTargetingKey();
  });
  ...
  describe('DynamicTargetingKey', function() {
    it('should create an instance of DynamicTargetingKey', function() {
      // uncomment below and update the code to test DynamicTargetingKey
      //var instance = new CampaignManager360Api.DynamicTargetingKey();
      //expect(instance).to.be.a(CampaignManager360Api.DynamicTargetingKey);
    });
