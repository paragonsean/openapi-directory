...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CampaignManager360Api.SkippableSetting();
  });
  ...
  describe('SkippableSetting', function() {
    it('should create an instance of SkippableSetting', function() {
      // uncomment below and update the code to test SkippableSetting
      //var instance = new CampaignManager360Api.SkippableSetting();
      //expect(instance).to.be.a(CampaignManager360Api.SkippableSetting);
    });
