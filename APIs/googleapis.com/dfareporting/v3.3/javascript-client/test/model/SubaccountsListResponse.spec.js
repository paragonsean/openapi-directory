...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CampaignManager360Api.SubaccountsListResponse();
  });
  ...
  describe('SubaccountsListResponse', function() {
    it('should create an instance of SubaccountsListResponse', function() {
      // uncomment below and update the code to test SubaccountsListResponse
      //var instance = new CampaignManager360Api.SubaccountsListResponse();
      //expect(instance).to.be.a(CampaignManager360Api.SubaccountsListResponse);
    });
