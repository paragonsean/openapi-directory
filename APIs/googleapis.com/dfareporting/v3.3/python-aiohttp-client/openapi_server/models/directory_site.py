...
class DirectorySite(Model):
    ...
    def __init__(self, active: bool=None, id: str=None, id_dimension_value: DimensionValue=None, inpage_tag_formats: List[str]=None, interstitial_tag_formats: List[str]=None, kind: str=None, name: str=None, settings: DirectorySiteSettings=None, url: str=None):
        """DirectorySite - a model defined in OpenAPI

        :param active: The active of this DirectorySite.
    ...
    @property
    def active(self):
        """Gets the active of this DirectorySite.

        Whether this directory site is active.

        :return: The active of this DirectorySite.
        :rtype: bool
        """
        return self._active
    ...
    def active(self, active):
        """Sets the active of this DirectorySite.
