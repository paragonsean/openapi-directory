...
class Report(Model):
    ...
    def type(self, type):
        ...
        :type type: str
        """
        allowed_values = ["STANDARD", "REACH", "PATH_TO_CONVERSION", "CROSS_DIMENSION_REACH", "FLOODLIGHT"]  # noqa: E501
