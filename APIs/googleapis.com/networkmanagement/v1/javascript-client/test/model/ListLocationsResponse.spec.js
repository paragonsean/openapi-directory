...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkManagementApi.ListLocationsResponse();
  });
  ...
  describe('ListLocationsResponse', function() {
    it('should create an instance of ListLocationsResponse', function() {
      ...
      //var instance = new NetworkManagementApi.ListLocationsResponse();
      //expect(instance).to.be.a(NetworkManagementApi.ListLocationsResponse);
    });
