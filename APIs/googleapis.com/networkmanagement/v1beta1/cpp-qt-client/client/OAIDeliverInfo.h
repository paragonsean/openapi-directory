...
#ifndef OAIDeliverInfo_H
#define OAIDeliverInfo_H
...
class OAIDeliverInfo : public OAIObject {
public:
    OAIDeliverInfo();
    OAIDeliverInfo(QString json);
    ~OAIDeliverInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeliverInfo)

#endif // OAIDeliverInfo_H
