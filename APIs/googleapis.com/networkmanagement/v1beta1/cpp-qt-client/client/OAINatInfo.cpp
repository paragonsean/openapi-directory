...
OAINatInfo::OAINatInfo(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINatInfo::OAINatInfo() {
    this->initializeModel();
}

OAINatInfo::~OAINatInfo() {}

void OAINatInfo::initializeModel() {

    m_nat_gateway_name_isSet = false;
    m_nat_gateway_name_isValid = false;
    ...
    m_router_uri_isSet = false;
    m_router_uri_isValid = false;

    m_type_isSet = false;
    m_type_isValid = false;
}

void OAINatInfo::fromJson(QString jsonString) {
...
void OAINatInfo::fromJsonObject(QJsonObject json) {

    m_nat_gateway_name_isValid = ::OpenAPI::fromJsonValue(m_nat_gateway_name, json[QString("natGatewayName")]);
    m_nat_gateway_name_isSet = !json[QString("natGatewayName")].isNull() && m_nat_gateway_name_isValid;
    ...
    m_router_uri_isValid = ::OpenAPI::fromJsonValue(m_router_uri, json[QString("routerUri")]);
    m_router_uri_isSet = !json[QString("routerUri")].isNull() && m_router_uri_isValid;

    m_type_isValid = ::OpenAPI::fromJsonValue(m_type, json[QString("type")]);
    m_type_isSet = !json[QString("type")].isNull() && m_type_isValid;
}

QString OAINatInfo::asJson() const {
...
QJsonObject OAINatInfo::asJsonObject() const {
    QJsonObject obj;
    if (m_nat_gateway_name_isSet) {
        obj.insert(QString("natGatewayName"), ::OpenAPI::toJsonValue(m_nat_gateway_name));
    }
    ...
    if (m_router_uri_isSet) {
        obj.insert(QString("routerUri"), ::OpenAPI::toJsonValue(m_router_uri));
    }
    if (m_type_isSet) {
...
QString OAINatInfo::getNatGatewayName() const {
    return m_nat_gateway_name;
}
void OAINatInfo::setNatGatewayName(const QString &nat_gateway_name) {
    m_nat_gateway_name = nat_gateway_name;
    m_nat_gateway_name_isSet = true;
}

bool OAINatInfo::is_nat_gateway_name_Set() const{
    return m_nat_gateway_name_isSet;
}

bool OAINatInfo::is_nat_gateway_name_Valid() const{
    return m_nat_gateway_name_isValid;
}

QString OAINatInfo::getNetworkUri() const {
    return m_network_uri;
}
void OAINatInfo::setNetworkUri(const QString &network_uri) {
    m_network_uri = network_uri;
    m_network_uri_isSet = true;
}

bool OAINatInfo::is_network_uri_Set() const{
    return m_network_uri_isSet;
}

bool OAINatInfo::is_network_uri_Valid() const{
    return m_network_uri_isValid;
}

QString OAINatInfo::getNewDestinationIp() const {
    return m_new_destination_ip;
}
void OAINatInfo::setNewDestinationIp(const QString &new_destination_ip) {
    m_new_destination_ip = new_destination_ip;
    m_new_destination_ip_isSet = true;
}

bool OAINatInfo::is_new_destination_ip_Set() const{
    return m_new_destination_ip_isSet;
}

bool OAINatInfo::is_new_destination_ip_Valid() const{
    return m_new_destination_ip_isValid;
}

qint32 OAINatInfo::getNewDestinationPort() const {
    return m_new_destination_port;
}
void OAINatInfo::setNewDestinationPort(const qint32 &new_destination_port) {
    m_new_destination_port = new_destination_port;
    m_new_destination_port_isSet = true;
}

bool OAINatInfo::is_new_destination_port_Set() const{
    return m_new_destination_port_isSet;
}

bool OAINatInfo::is_new_destination_port_Valid() const{
    return m_new_destination_port_isValid;
}

QString OAINatInfo::getNewSourceIp() const {
    return m_new_source_ip;
}
void OAINatInfo::setNewSourceIp(const QString &new_source_ip) {
    m_new_source_ip = new_source_ip;
    m_new_source_ip_isSet = true;
}

bool OAINatInfo::is_new_source_ip_Set() const{
    return m_new_source_ip_isSet;
}

bool OAINatInfo::is_new_source_ip_Valid() const{
    return m_new_source_ip_isValid;
}

qint32 OAINatInfo::getNewSourcePort() const {
    return m_new_source_port;
}
void OAINatInfo::setNewSourcePort(const qint32 &new_source_port) {
    m_new_source_port = new_source_port;
    m_new_source_port_isSet = true;
}

bool OAINatInfo::is_new_source_port_Set() const{
    return m_new_source_port_isSet;
}

bool OAINatInfo::is_new_source_port_Valid() const{
    return m_new_source_port_isValid;
}

QString OAINatInfo::getOldDestinationIp() const {
    return m_old_destination_ip;
}
void OAINatInfo::setOldDestinationIp(const QString &old_destination_ip) {
    m_old_destination_ip = old_destination_ip;
    m_old_destination_ip_isSet = true;
}

bool OAINatInfo::is_old_destination_ip_Set() const{
    return m_old_destination_ip_isSet;
}

bool OAINatInfo::is_old_destination_ip_Valid() const{
    return m_old_destination_ip_isValid;
}

qint32 OAINatInfo::getOldDestinationPort() const {
    return m_old_destination_port;
}
void OAINatInfo::setOldDestinationPort(const qint32 &old_destination_port) {
    m_old_destination_port = old_destination_port;
    m_old_destination_port_isSet = true;
}

bool OAINatInfo::is_old_destination_port_Set() const{
    return m_old_destination_port_isSet;
}

bool OAINatInfo::is_old_destination_port_Valid() const{
    return m_old_destination_port_isValid;
}

QString OAINatInfo::getOldSourceIp() const {
    return m_old_source_ip;
}
void OAINatInfo::setOldSourceIp(const QString &old_source_ip) {
    m_old_source_ip = old_source_ip;
    m_old_source_ip_isSet = true;
}

bool OAINatInfo::is_old_source_ip_Set() const{
    return m_old_source_ip_isSet;
}

bool OAINatInfo::is_old_source_ip_Valid() const{
    return m_old_source_ip_isValid;
}

qint32 OAINatInfo::getOldSourcePort() const {
    return m_old_source_port;
}
void OAINatInfo::setOldSourcePort(const qint32 &old_source_port) {
    m_old_source_port = old_source_port;
    m_old_source_port_isSet = true;
}

bool OAINatInfo::is_old_source_port_Set() const{
    return m_old_source_port_isSet;
}

bool OAINatInfo::is_old_source_port_Valid() const{
    return m_old_source_port_isValid;
}

QString OAINatInfo::getProtocol() const {
    return m_protocol;
}
void OAINatInfo::setProtocol(const QString &protocol) {
    m_protocol = protocol;
    m_protocol_isSet = true;
}

bool OAINatInfo::is_protocol_Set() const{
    return m_protocol_isSet;
}

bool OAINatInfo::is_protocol_Valid() const{
    return m_protocol_isValid;
}

QString OAINatInfo::getRouterUri() const {
    return m_router_uri;
}
void OAINatInfo::setRouterUri(const QString &router_uri) {
    m_router_uri = router_uri;
    m_router_uri_isSet = true;
}

bool OAINatInfo::is_router_uri_Set() const{
    return m_router_uri_isSet;
}

bool OAINatInfo::is_router_uri_Valid() const{
    return m_router_uri_isValid;
}

QString OAINatInfo::getType() const {
    return m_type;
}
void OAINatInfo::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAINatInfo::is_type_Set() const{
    return m_type_isSet;
}

bool OAINatInfo::is_type_Valid() const{
    return m_type_isValid;
}

bool OAINatInfo::isSet() const {
