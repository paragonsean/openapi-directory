...
/*
 * OAIProxyConnectionInfo.h
 *
 * For display only. Metadata associated with ProxyConnection.
 */

#ifndef OAIProxyConnectionInfo_H
#define OAIProxyConnectionInfo_H
...
class OAIProxyConnectionInfo : public OAIObject {
public:
    OAIProxyConnectionInfo();
    OAIProxyConnectionInfo(QString json);
    ~OAIProxyConnectionInfo() override;
    ...
    QString getSubnetUri() const;
    void setSubnetUri(const QString &subnet_uri);
    bool is_subnet_uri_Set() const;
    bool is_subnet_uri_Valid() const;
...
private:
    ...
    QString m_subnet_uri;
    bool m_subnet_uri_isSet;
    bool m_subnet_uri_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIProxyConnectionInfo)

#endif // OAIProxyConnectionInfo_H
