...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkManagementApi.InstanceInfo();
  });
  ...
  describe('InstanceInfo', function() {
    it('should create an instance of InstanceInfo', function() {
      // uncomment below and update the code to test InstanceInfo
      //var instance = new NetworkManagementApi.InstanceInfo();
      //expect(instance).to.be.a(NetworkManagementApi.InstanceInfo);
    });
