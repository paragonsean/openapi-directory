...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetworkManagementApi.ListOperationsResponse();
  });
  ...
  describe('ListOperationsResponse', function() {
    it('should create an instance of ListOperationsResponse', function() {
      ...
      //var instance = new NetworkManagementApi.ListOperationsResponse();
      //expect(instance).to.be.a(NetworkManagementApi.ListOperationsResponse);
    });
