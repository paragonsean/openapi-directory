...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://networkmanagement.googleapis.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://networkmanagement.googleapis.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/v1beta1/Javascript'
        };
