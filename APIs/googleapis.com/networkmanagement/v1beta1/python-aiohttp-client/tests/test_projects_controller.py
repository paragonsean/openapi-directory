...
async def test_networkmanagement_projects_locations_global_connectivity_tests_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/{parent}/connectivityTests'.format(parent='parent_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_networkmanagement_projects_locations_global_connectivity_tests_rerun(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1beta1/{namereru}'.format(name='name_example'),
        headers=headers,
        json=body,
        params=params,
        )
