...
public class Errors {
  ...
  private List<ErrorProto> error = new ArrayList<>();
  ...
  @Deprecated
  public Errors code(CodeEnum code) {
    this.code = code;
    return this;
  }
  ...
  public Errors error(List<ErrorProto> error) {
    this.error = error;
    return this;
  }

  public Errors addErrorItem(ErrorProto errorItem) {
    if (this.error == null) {
  ...
  public void setError(List<ErrorProto> error) {
    this.error = error;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, errors.code) &&
        Objects.equals(this.error, errors.error) &&
        Objects.equals(this.requestId, errors.requestId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(code, error, requestId);
  }
      ...
      if (jsonObj.get("error") != null && !jsonObj.get("error").isJsonNull()) {
        ...
        if (jsonArrayerror != null) {
          ...
          for (int i = 0; i < jsonArrayerror.size(); i++) {
            ErrorProto.validateJsonElement(jsonArrayerror.get(i));
          };
        }
      }
