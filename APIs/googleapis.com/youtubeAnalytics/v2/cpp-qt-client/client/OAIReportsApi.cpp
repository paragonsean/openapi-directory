...
void OAIReportsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("youtubeAnalytics_reports_query", defaultConf);
    _serverIndices.insert("youtubeAnalytics_reports_query", 0);
}
...
void OAIReportsApi::youtubeAnalytics_reports_query(const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<QString> &currency, const ::OpenAPI::OptionalParam<QString> &dimensions, const ::OpenAPI::OptionalParam<QString> &end_date, const ::OpenAPI::OptionalParam<QString> &filters, const ::OpenAPI::OptionalParam<QString> &ids, const ::OpenAPI::OptionalParam<bool> &include_historical_channel_data, const ::OpenAPI::OptionalParam<qint32> &max_results, const ::OpenAPI::OptionalParam<QString> &metrics, const ::OpenAPI::OptionalParam<QString> &sort, const ::OpenAPI::OptionalParam<QString> &start_date, const ::OpenAPI::OptionalParam<qint32> &start_index) {
    QString fullPath = QString(_serverConfigs["youtubeAnalytics_reports_query"][_serverIndices.value("youtubeAnalytics_reports_query")].URL()+"/v2/reports");
    ...
    if (dimensions.hasValue())
    {
        ...
        fullPath.append(QUrl::toPercentEncoding("dimensions")).append(querySuffix).append(QUrl::toPercentEncoding(dimensions.stringValue()));
    }
    ...
    if (include_historical_channel_data.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "includeHistoricalChannelData", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("includeHistoricalChannelData")).append(querySuffix).append(QUrl::toPercentEncoding(include_historical_channel_data.stringValue()));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIReportsApi::youtubeAnalytics_reports_queryCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIReportsApi::youtubeAnalytics_reports_queryCallback);
...
void OAIReportsApi::youtubeAnalytics_reports_queryCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT youtubeAnalytics_reports_querySignal(output);
        Q_EMIT youtubeAnalytics_reports_querySignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT youtubeAnalytics_reports_querySignalE(output, error_type, error_str);
        Q_EMIT youtubeAnalytics_reports_querySignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT youtubeAnalytics_reports_querySignalError(output, error_type, error_str);
        Q_EMIT youtubeAnalytics_reports_querySignalErrorFull(worker, error_type, error_str);
    }
}
