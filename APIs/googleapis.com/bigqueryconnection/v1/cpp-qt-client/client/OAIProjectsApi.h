...
public:
    ...
    * @param[in]  oai_connection OAIConnection [optional]
    */
    virtual void bigqueryconnection_projects_locations_connections_patch(const QString &name, const ::OpenAPI::OptionalParam<QString> &_xgafv = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &access_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &alt = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &callback = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &fields = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &key = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &oauth_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &pretty_print = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &quota_user = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &upload_protocol = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &upload_type = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &update_mask = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAIConnection> &oai_connection = ::OpenAPI::OptionalParam<OAIConnection>());
...
private:
    ...
    void bigqueryconnection_projects_locations_connections_patchCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void bigqueryconnection_projects_locations_connections_patchSignal(OAIConnection summary);
    ...
    void bigqueryconnection_projects_locations_connections_patchSignalFull(OAIHttpRequestWorker *worker, OAIConnection summary);
    ...
    Q_DECL_DEPRECATED_X("Use bigqueryconnection_projects_locations_connections_patchSignalError() instead")
    void bigqueryconnection_projects_locations_connections_patchSignalE(OAIConnection summary, QNetworkReply::NetworkError error_type, QString error_str);
    void bigqueryconnection_projects_locations_connections_patchSignalError(OAIConnection summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use bigqueryconnection_projects_locations_connections_patchSignalErrorFull() instead")
    void bigqueryconnection_projects_locations_connections_patchSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void bigqueryconnection_projects_locations_connections_patchSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
