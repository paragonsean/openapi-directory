...
|**maxConcurrentDevices** | **Integer** | The maximum number of concurrent access licenses for this volume. |  [optional] |
...
|**timeWindowSeconds** | **Integer** | Time in seconds for license auto-expiration. |  [optional] |
