...
public class AnnotationCurrentVersionRanges {
  ...
  public AnnotationCurrentVersionRanges cfiRange(BooksAnnotationsRange cfiRange) {
  ...
  public AnnotationCurrentVersionRanges contentVersion(String contentVersion) {
  ...
  public AnnotationCurrentVersionRanges gbImageRange(BooksAnnotationsRange gbImageRange) {
  ...
  public AnnotationCurrentVersionRanges gbTextRange(BooksAnnotationsRange gbTextRange) {
  ...
  public AnnotationCurrentVersionRanges imageCfiRange(BooksAnnotationsRange imageCfiRange) {
  ...
  public boolean equals(Object o) {
    ...
    AnnotationCurrentVersionRanges annotationCurrentVersionRanges = (AnnotationCurrentVersionRanges) o;
    return Objects.equals(this.cfiRange, annotationCurrentVersionRanges.cfiRange) &&
        Objects.equals(this.contentVersion, annotationCurrentVersionRanges.contentVersion) &&
        Objects.equals(this.gbImageRange, annotationCurrentVersionRanges.gbImageRange) &&
        Objects.equals(this.gbTextRange, annotationCurrentVersionRanges.gbTextRange) &&
        Objects.equals(this.imageCfiRange, annotationCurrentVersionRanges.imageCfiRange);
  }
  ...
  public String toString() {
    ...
    sb.append("class AnnotationCurrentVersionRanges {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AnnotationCurrentVersionRanges
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AnnotationCurrentVersionRanges.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AnnotationCurrentVersionRanges is not found in the empty JSON string", AnnotationCurrentVersionRanges.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AnnotationCurrentVersionRanges.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AnnotationCurrentVersionRanges` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AnnotationCurrentVersionRanges.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AnnotationCurrentVersionRanges' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AnnotationCurrentVersionRanges> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AnnotationCurrentVersionRanges.class));

       return (TypeAdapter<T>) new TypeAdapter<AnnotationCurrentVersionRanges>() {
           @Override
           public void write(JsonWriter out, AnnotationCurrentVersionRanges value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AnnotationCurrentVersionRanges read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AnnotationCurrentVersionRanges given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AnnotationCurrentVersionRanges
   * @throws IOException if the JSON string is invalid with respect to AnnotationCurrentVersionRanges
   */
  public static AnnotationCurrentVersionRanges fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AnnotationCurrentVersionRanges.class);
  }

  /**
   * Convert an instance of AnnotationCurrentVersionRanges to an JSON string
   *
   * @return JSON string
   */
