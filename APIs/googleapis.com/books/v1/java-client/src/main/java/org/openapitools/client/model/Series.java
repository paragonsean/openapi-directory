...
public class Series {
  ...
  private List<SeriesSeriesInner> series = new ArrayList<>();

  public Series() {
  }

  public Series kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  public Series series(List<SeriesSeriesInner> series) {
    this.series = series;
    return this;
  }

  public Series addSeriesItem(SeriesSeriesInner seriesItem) {
    if (this.series == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<SeriesSeriesInner> getSeries() {
    return series;
  }

  public void setSeries(List<SeriesSeriesInner> series) {
    this.series = series;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.kind, series.kind) &&
        Objects.equals(this.series, series.series);
  }

  @Override
  public int hashCode() {
    return Objects.hash(kind, series);
  }
      ...
      if (jsonObj.get("series") != null && !jsonObj.get("series").isJsonNull()) {
        ...
        if (jsonArrayseries != null) {
          ...
          for (int i = 0; i < jsonArrayseries.size(); i++) {
            SeriesSeriesInner.validateJsonElement(jsonArrayseries.get(i));
          };
        }
      }
  }
