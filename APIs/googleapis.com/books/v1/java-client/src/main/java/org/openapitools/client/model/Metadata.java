...
import org.openapitools.client.model.MetadataItemsInner;
...
public class Metadata {
  ...
  private List<MetadataItemsInner> items = new ArrayList<>();
  ...
  public Metadata items(List<MetadataItemsInner> items) {
    this.items = items;
    return this;
  }

  public Metadata addItemsItem(MetadataItemsInner itemsItem) {
    if (this.items == null) {
  ...
  public List<MetadataItemsInner> getItems() {
    return items;
  }

  public void setItems(List<MetadataItemsInner> items) {
    this.items = items;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.items, metadata.items) &&
      ...
      if (jsonObj.get("items") != null && !jsonObj.get("items").isJsonNull()) {
        ...
        if (jsonArrayitems != null) {
          ...
          for (int i = 0; i < jsonArrayitems.size(); i++) {
            MetadataItemsInner.validateJsonElement(jsonArrayitems.get(i));
          };
        }
      }
