...
public class Category {
  ...
  private List<CategoryItemsInner> items = new ArrayList<>();
  ...
  public Category items(List<CategoryItemsInner> items) {
    this.items = items;
    return this;
  }

  public Category addItemsItem(CategoryItemsInner itemsItem) {
    if (this.items == null) {
  ...
  public List<CategoryItemsInner> getItems() {
    return items;
  }

  public void setItems(List<CategoryItemsInner> items) {
    this.items = items;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.items, category.items) &&
      ...
      if (jsonObj.get("items") != null && !jsonObj.get("items").isJsonNull()) {
        ...
        if (jsonArrayitems != null) {
          ...
          for (int i = 0; i < jsonArrayitems.size(); i++) {
            CategoryItemsInner.validateJsonElement(jsonArrayitems.get(i));
          };
        }
      }
