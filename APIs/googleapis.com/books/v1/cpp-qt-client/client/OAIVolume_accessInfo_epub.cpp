...
OAIVolume_accessInfo_epub::OAIVolume_accessInfo_epub(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIVolume_accessInfo_epub::OAIVolume_accessInfo_epub() {
    this->initializeModel();
}

OAIVolume_accessInfo_epub::~OAIVolume_accessInfo_epub() {}

void OAIVolume_accessInfo_epub::initializeModel() {
...
void OAIVolume_accessInfo_epub::fromJson(QString jsonString) {
...
void OAIVolume_accessInfo_epub::fromJsonObject(QJsonObject json) {
...
QString OAIVolume_accessInfo_epub::asJson() const {
...
QJsonObject OAIVolume_accessInfo_epub::asJsonObject() const {
    QJsonObject obj;
...
QString OAIVolume_accessInfo_epub::getAcsTokenLink() const {
    return m_acs_token_link;
}
void OAIVolume_accessInfo_epub::setAcsTokenLink(const QString &acs_token_link) {
    m_acs_token_link = acs_token_link;
    m_acs_token_link_isSet = true;
}

bool OAIVolume_accessInfo_epub::is_acs_token_link_Set() const{
    return m_acs_token_link_isSet;
}

bool OAIVolume_accessInfo_epub::is_acs_token_link_Valid() const{
    return m_acs_token_link_isValid;
}

QString OAIVolume_accessInfo_epub::getDownloadLink() const {
    return m_download_link;
}
void OAIVolume_accessInfo_epub::setDownloadLink(const QString &download_link) {
    m_download_link = download_link;
    m_download_link_isSet = true;
}

bool OAIVolume_accessInfo_epub::is_download_link_Set() const{
    return m_download_link_isSet;
}

bool OAIVolume_accessInfo_epub::is_download_link_Valid() const{
    return m_download_link_isValid;
}

bool OAIVolume_accessInfo_epub::isIsAvailable() const {
    return m_is_available;
}
void OAIVolume_accessInfo_epub::setIsAvailable(const bool &is_available) {
    m_is_available = is_available;
    m_is_available_isSet = true;
}

bool OAIVolume_accessInfo_epub::is_is_available_Set() const{
    return m_is_available_isSet;
}

bool OAIVolume_accessInfo_epub::is_is_available_Valid() const{
    return m_is_available_isValid;
}

bool OAIVolume_accessInfo_epub::isSet() const {
...
bool OAIVolume_accessInfo_epub::isValid() const {
