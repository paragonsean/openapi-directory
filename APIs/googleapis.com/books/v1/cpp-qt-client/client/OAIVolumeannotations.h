...
/*
 * OAIVolumeannotations.h
 *
 * 
 */

#ifndef OAIVolumeannotations_H
#define OAIVolumeannotations_H
...
namespace OpenAPI {
class OAIVolumeannotation;

class OAIVolumeannotations : public OAIObject {
public:
    OAIVolumeannotations();
    OAIVolumeannotations(QString json);
    ~OAIVolumeannotations() override;
    ...
    QList<OAIVolumeannotation> getItems() const;
    void setItems(const QList<OAIVolumeannotation> &items);
...
private:
    ...
    QList<OAIVolumeannotation> m_items;
    bool m_items_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVolumeannotations)

#endif // OAIVolumeannotations_H
