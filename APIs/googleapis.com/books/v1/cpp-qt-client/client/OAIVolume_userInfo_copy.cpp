...
OAIVolume_userInfo_copy::OAIVolume_userInfo_copy(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIVolume_userInfo_copy::OAIVolume_userInfo_copy() {
    this->initializeModel();
}

OAIVolume_userInfo_copy::~OAIVolume_userInfo_copy() {}

void OAIVolume_userInfo_copy::initializeModel() {
...
void OAIVolume_userInfo_copy::fromJson(QString jsonString) {
...
void OAIVolume_userInfo_copy::fromJsonObject(QJsonObject json) {
...
QString OAIVolume_userInfo_copy::asJson() const {
...
QJsonObject OAIVolume_userInfo_copy::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIVolume_userInfo_copy::getAllowedCharacterCount() const {
    return m_allowed_character_count;
}
void OAIVolume_userInfo_copy::setAllowedCharacterCount(const qint32 &allowed_character_count) {
    m_allowed_character_count = allowed_character_count;
    m_allowed_character_count_isSet = true;
}

bool OAIVolume_userInfo_copy::is_allowed_character_count_Set() const{
    return m_allowed_character_count_isSet;
}

bool OAIVolume_userInfo_copy::is_allowed_character_count_Valid() const{
    return m_allowed_character_count_isValid;
}

QString OAIVolume_userInfo_copy::getLimitType() const {
    return m_limit_type;
}
void OAIVolume_userInfo_copy::setLimitType(const QString &limit_type) {
    m_limit_type = limit_type;
    m_limit_type_isSet = true;
}

bool OAIVolume_userInfo_copy::is_limit_type_Set() const{
    return m_limit_type_isSet;
}

bool OAIVolume_userInfo_copy::is_limit_type_Valid() const{
    return m_limit_type_isValid;
}

qint32 OAIVolume_userInfo_copy::getRemainingCharacterCount() const {
    return m_remaining_character_count;
}
void OAIVolume_userInfo_copy::setRemainingCharacterCount(const qint32 &remaining_character_count) {
    m_remaining_character_count = remaining_character_count;
    m_remaining_character_count_isSet = true;
}

bool OAIVolume_userInfo_copy::is_remaining_character_count_Set() const{
    return m_remaining_character_count_isSet;
}

bool OAIVolume_userInfo_copy::is_remaining_character_count_Valid() const{
    return m_remaining_character_count_isValid;
}

QString OAIVolume_userInfo_copy::getUpdated() const {
    return m_updated;
}
void OAIVolume_userInfo_copy::setUpdated(const QString &updated) {
    m_updated = updated;
    m_updated_isSet = true;
}

bool OAIVolume_userInfo_copy::is_updated_Set() const{
    return m_updated_isSet;
}

bool OAIVolume_userInfo_copy::is_updated_Valid() const{
    return m_updated_isValid;
}

bool OAIVolume_userInfo_copy::isSet() const {
...
bool OAIVolume_userInfo_copy::isValid() const {
