...
#ifndef OAIAnnotations_H
#define OAIAnnotations_H
...
class OAIAnnotations : public OAIObject {
public:
    OAIAnnotations();
    OAIAnnotations(QString json);
    ~OAIAnnotations() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAnnotations)

#endif // OAIAnnotations_H
