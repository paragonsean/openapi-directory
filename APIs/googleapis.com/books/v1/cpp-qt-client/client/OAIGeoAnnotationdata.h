...
/*
 * OAIGeoAnnotationdata.h
 *
 * 
 */

#ifndef OAIGeoAnnotationdata_H
#define OAIGeoAnnotationdata_H
...
namespace OpenAPI {
class OAIGeolayerdata;

class OAIGeoAnnotationdata : public OAIObject {
public:
    OAIGeoAnnotationdata();
    OAIGeoAnnotationdata(QString json);
    ~OAIGeoAnnotationdata() override;
    ...
    OAIGeolayerdata getData() const;
    void setData(const OAIGeolayerdata &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGeoAnnotationdata)

#endif // OAIGeoAnnotationdata_H
