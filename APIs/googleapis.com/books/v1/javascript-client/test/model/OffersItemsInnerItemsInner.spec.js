...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BooksApi.OffersItemsInnerItemsInner();
  });
  ...
  describe('OffersItemsInnerItemsInner', function() {
    it('should create an instance of OffersItemsInnerItemsInner', function() {
      // uncomment below and update the code to test OffersItemsInnerItemsInner
      //var instance = new BooksApi.OffersItemsInnerItemsInner();
      //expect(instance).to.be.a(BooksApi.OffersItemsInnerItemsInner);
    });
