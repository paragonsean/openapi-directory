...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BooksApi.GeoAnnotationdata();
  });
  ...
  describe('GeoAnnotationdata', function() {
    it('should create an instance of GeoAnnotationdata', function() {
      // uncomment below and update the code to test GeoAnnotationdata
      //var instance = new BooksApi.GeoAnnotationdata();
      //expect(instance).to.be.a(BooksApi.GeoAnnotationdata);
    });
