...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BooksApi.BooksCloudloadingResource();
  });
  ...
  describe('BooksCloudloadingResource', function() {
    it('should create an instance of BooksCloudloadingResource', function() {
      // uncomment below and update the code to test BooksCloudloadingResource
      //var instance = new BooksApi.BooksCloudloadingResource();
      //expect(instance).to.be.a(BooksApi.BooksCloudloadingResource);
    });
