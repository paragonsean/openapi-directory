...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BooksApi.Annotations();
  });
  ...
  describe('Annotations', function() {
    it('should create an instance of Annotations', function() {
      // uncomment below and update the code to test Annotations
      //var instance = new BooksApi.Annotations();
      //expect(instance).to.be.a(BooksApi.Annotations);
    });
