...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BooksApi.Usersettings();
  });
  ...
  describe('Usersettings', function() {
    it('should create an instance of Usersettings', function() {
      ...
      //var instance = new BooksApi.Usersettings();
      //expect(instance).to.be.a(BooksApi.Usersettings);
    });
    ...
    it('should have the property notesExport (base name: "notesExport")', function() {
      // uncomment below and update the code to test the property notesExport
      //var instance = new BooksApi.Usersettings();
      //expect(instance).to.be();
    });
