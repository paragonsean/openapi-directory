...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BooksApi.Volumeannotations();
  });
  ...
  describe('Volumeannotations', function() {
    it('should create an instance of Volumeannotations', function() {
      // uncomment below and update the code to test Volumeannotations
      //var instance = new BooksApi.Volumeannotations();
      //expect(instance).to.be.a(BooksApi.Volumeannotations);
    });
