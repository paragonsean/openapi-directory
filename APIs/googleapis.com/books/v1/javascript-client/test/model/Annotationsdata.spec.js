...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BooksApi.Annotationsdata();
  });
  ...
  describe('Annotationsdata', function() {
    it('should create an instance of Annotationsdata', function() {
      // uncomment below and update the code to test Annotationsdata
      //var instance = new BooksApi.Annotationsdata();
      //expect(instance).to.be.a(BooksApi.Annotationsdata);
    });
