...
> Object booksPromoofferAccept(opts)
...
let apiInstance = new BooksApi.PromoofferApi();
let opts = {
  ...
  'androidId': "androidId_example", // String | device android_id
  'device': "device_example", // String | device device
  'manufacturer': "manufacturer_example", // String | device manufacturer
  'model': "model_example", // String | device model
  'offerId': "offerId_example", // String | 
  'product': "product_example", // String | device product
  'serial': "serial_example", // String | device serial
  'volumeId': "volumeId_example" // String | Volume id to exercise the offer
};
apiInstance.booksPromoofferAccept(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> Object booksPromoofferDismiss(opts)
...
let opts = {
  ...
  'manufacturer': "manufacturer_example", // String | device manufacturer
  'model': "model_example", // String | device model
  'offerId': "offerId_example", // String | Offer to dimiss
  'product': "product_example", // String | device product
  'serial': "serial_example" // String | device serial
};
apiInstance.booksPromoofferDismiss(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Offers booksPromoofferGet(opts)
...
apiInstance.booksPromoofferGet(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
