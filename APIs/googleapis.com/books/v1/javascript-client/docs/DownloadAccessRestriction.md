# BooksApi.DownloadAccessRestriction
...
**downloadsAcquired** | **Number** | If restricted, the number of content download licenses already acquired (including the requesting client, if licensed). | [optional] 
...
**maxDownloadDevices** | **Number** | If restricted, the maximum number of content download licenses for this volume. | [optional] 
