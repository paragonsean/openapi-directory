...
> Object booksMylibraryAnnotationsDelete(annotationId, opts)
...
let apiInstance = new BooksApi.MylibraryApi();
let annotationId = "annotationId_example"; // String | The ID for the annotation to delete.
let opts = {
...
apiInstance.booksMylibraryAnnotationsDelete(annotationId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> Annotation booksMylibraryAnnotationsInsert(opts)
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'annotationId': "annotationId_example", // String | The ID for the annotation to insert.
  'country': "country_example", // String | ISO-3166-1 code to override the IP-based location.
  'showOnlySummaryInResponse': true, // Boolean | Requests that only the summary of the specified layer be provided in the response.
  'source': "source_example", // String | String to identify the originator of this request.
  'annotation': new BooksApi.Annotation() // Annotation | 
};
apiInstance.booksMylibraryAnnotationsInsert(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Annotations booksMylibraryAnnotationsList(opts)
...
let opts = {
  ...
  'layerId': "layerId_example", // String | The layer ID to limit annotation by.
  'layerIds': ["null"], // [String] | The layer ID(s) to limit annotation by.
  ...
  'volumeId': "volumeId_example" // String | The volume to restrict annotations to.
};
apiInstance.booksMylibraryAnnotationsList(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **layerIds** | [**[String]**](String.md)| The layer ID(s) to limit annotation by. | [optional] 
...
> AnnotationsSummary booksMylibraryAnnotationsSummary(layerIds, volumeId, opts)
...
let apiInstance = new BooksApi.MylibraryApi();
let layerIds = ["null"]; // [String] | Array of layer IDs to get the summary for.
let volumeId = "volumeId_example"; // String | Volume id to get the summary for.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'source': "source_example" // String | Optional. String to identify the originator of this request.
};
apiInstance.booksMylibraryAnnotationsSummary(layerIds, volumeId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **layerIds** | [**[String]**](String.md)| Array of layer IDs to get the summary for. | 
...
> Annotation booksMylibraryAnnotationsUpdate(annotationId, opts)
...
let apiInstance = new BooksApi.MylibraryApi();
let annotationId = "annotationId_example"; // String | The ID for the annotation to update.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
apiInstance.booksMylibraryAnnotationsUpdate(annotationId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Object booksMylibraryBookshelvesAddVolume(shelf, volumeId, opts)
...
let apiInstance = new BooksApi.MylibraryApi();
let shelf = "shelf_example"; // String | ID of bookshelf to which to add a volume.
let volumeId = "volumeId_example"; // String | ID of volume to add.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'reason': "reason_example", // String | The reason for which the book is added to the library.
  'source': "source_example" // String | String to identify the originator of this request.
};
apiInstance.booksMylibraryBookshelvesAddVolume(shelf, volumeId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **uploadProtocol** | **String**| Upload protocol for media (e.g. \&quot;raw\&quot;, \&quot;multipart\&quot;). | [optional] 
 **uploadType** | **String**| Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;). | [optional] 
 **reason** | **String**| The reason for which the book is added to the library. | [optional] 
 **source** | **String**| String to identify the originator of this request. | [optional] 
...
> Object booksMylibraryBookshelvesClearVolumes(shelf, opts)
...
let apiInstance = new BooksApi.MylibraryApi();
let shelf = "shelf_example"; // String | ID of bookshelf from which to remove a volume.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
apiInstance.booksMylibraryBookshelvesClearVolumes(shelf, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Bookshelf booksMylibraryBookshelvesGet(shelf, opts)
...
let apiInstance = new BooksApi.MylibraryApi();
let shelf = "shelf_example"; // String | ID of bookshelf to retrieve.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
apiInstance.booksMylibraryBookshelvesGet(shelf, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Bookshelves booksMylibraryBookshelvesList(opts)
...
apiInstance.booksMylibraryBookshelvesList(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Object booksMylibraryBookshelvesMoveVolume(shelf, volumeId, volumePosition, opts)
...
let apiInstance = new BooksApi.MylibraryApi();
let shelf = "shelf_example"; // String | ID of bookshelf with the volume.
let volumeId = "volumeId_example"; // String | ID of volume to move.
let volumePosition = 56; // Number | Position on shelf to move the item (0 puts the item before the current first item, 1 puts it between the first and the second and so on.)
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
apiInstance.booksMylibraryBookshelvesMoveVolume(shelf, volumeId, volumePosition, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **volumePosition** | **Number**| Position on shelf to move the item (0 puts the item before the current first item, 1 puts it between the first and the second and so on.) | 
 **xgafv** | **String**| V1 error format. | [optional] 
 **accessToken** | **String**| OAuth access token. | [optional] 
 **alt** | **String**| Data format for response. | [optional] 
 **callback** | **String**| JSONP | [optional] 
...
> Object booksMylibraryBookshelvesRemoveVolume(shelf, volumeId, opts)
...
let apiInstance = new BooksApi.MylibraryApi();
let shelf = "shelf_example"; // String | ID of bookshelf from which to remove a volume.
let volumeId = "volumeId_example"; // String | ID of volume to remove.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'reason': "reason_example", // String | The reason for which the book is removed from the library.
  'source': "source_example" // String | String to identify the originator of this request.
};
apiInstance.booksMylibraryBookshelvesRemoveVolume(shelf, volumeId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **uploadProtocol** | **String**| Upload protocol for media (e.g. \&quot;raw\&quot;, \&quot;multipart\&quot;). | [optional] 
 **uploadType** | **String**| Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;). | [optional] 
 **reason** | **String**| The reason for which the book is removed from the library. | [optional] 
 **source** | **String**| String to identify the originator of this request. | [optional] 
...
> Volumes booksMylibraryBookshelvesVolumesList(shelf, opts)
...
let apiInstance = new BooksApi.MylibraryApi();
let shelf = "shelf_example"; // String | The bookshelf ID or name retrieve volumes for.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'q': "q_example", // String | Full-text search query string in this bookshelf.
  'showPreorders': true, // Boolean | Set to true to show pre-ordered books. Defaults to false.
  'source': "source_example", // String | String to identify the originator of this request.
  'startIndex': 56 // Number | Index of the first element to return (starts at 0)
};
apiInstance.booksMylibraryBookshelvesVolumesList(shelf, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **source** | **String**| String to identify the originator of this request. | [optional] 
 **startIndex** | **Number**| Index of the first element to return (starts at 0) | [optional] 
...
> ReadingPosition booksMylibraryReadingpositionsGet(volumeId, opts)
...
let apiInstance = new BooksApi.MylibraryApi();
let volumeId = "volumeId_example"; // String | ID of volume for which to retrieve a reading position.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'contentVersion': "contentVersion_example", // String | Volume content version for which this reading position is requested.
  'source': "source_example" // String | String to identify the originator of this request.
};
apiInstance.booksMylibraryReadingpositionsGet(volumeId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Object booksMylibraryReadingpositionsSetPosition(volumeId, position, timestamp, opts)
...
let apiInstance = new BooksApi.MylibraryApi();
let volumeId = "volumeId_example"; // String | ID of volume for which to update the reading position.
let position = "position_example"; // String | Position string for the new volume reading position.
let timestamp = "timestamp_example"; // String | RFC 3339 UTC format timestamp associated with this reading position.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'action': "action_example", // String | Action that caused this reading position to be set.
  'contentVersion': "contentVersion_example", // String | Volume content version for which this reading position applies.
  'deviceCookie': "deviceCookie_example", // String | Random persistent device cookie optional on set position.
  'source': "source_example" // String | String to identify the originator of this request.
};
apiInstance.booksMylibraryReadingpositionsSetPosition(volumeId, position, timestamp, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **uploadProtocol** | **String**| Upload protocol for media (e.g. \&quot;raw\&quot;, \&quot;multipart\&quot;). | [optional] 
 **uploadType** | **String**| Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;). | [optional] 
 **action** | **String**| Action that caused this reading position to be set. | [optional] 
