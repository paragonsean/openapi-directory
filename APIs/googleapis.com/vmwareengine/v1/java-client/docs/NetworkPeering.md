...
|**peerMtu** | **Integer** | Optional. Maximum transmission unit (MTU) in bytes. The default value is &#x60;1500&#x60;. If a value of &#x60;0&#x60; is provided for this field, VMware Engine uses the default value instead. |  [optional] |
...
|**peerNetworkType** | [**PeerNetworkTypeEnum**](#PeerNetworkTypeEnum) | Required. The type of the network to peer with the VMware Engine network. |  [optional] |
|**state** | [**StateEnum**](#StateEnum) | Output only. State of the network peering. This field has a value of &#39;ACTIVE&#39; when there&#39;s a matching configuration in the peer network. New values may be added to this enum when appropriate. |  [optional] [readonly] |
