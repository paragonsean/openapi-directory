...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VMwareEngineApi.ListLocationsResponse();
  });
  ...
  describe('ListLocationsResponse', function() {
    it('should create an instance of ListLocationsResponse', function() {
      ...
      //var instance = new VMwareEngineApi.ListLocationsResponse();
      //expect(instance).to.be.a(VMwareEngineApi.ListLocationsResponse);
    });
