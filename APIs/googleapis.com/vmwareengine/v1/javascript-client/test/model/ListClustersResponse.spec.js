...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VMwareEngineApi.ListClustersResponse();
  });
  ...
  describe('ListClustersResponse', function() {
    it('should create an instance of ListClustersResponse', function() {
      ...
      //var instance = new VMwareEngineApi.ListClustersResponse();
      //expect(instance).to.be.a(VMwareEngineApi.ListClustersResponse);
    });
