# VMwareEngineApi.DnsBindPermission
...
**principals** | [**[Principal]**](Principal.md) | Output only. Users/Service accounts which have access for binding on the intranet VPC project corresponding to the consumer project. | [optional] [readonly] 
