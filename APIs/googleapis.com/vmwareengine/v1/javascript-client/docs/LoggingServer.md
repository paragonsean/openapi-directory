...
**port** | **Number** | Required. Port number at which the logging server receives logs. | [optional] 
**protocol** | **String** | Required. Protocol used by vCenter to send logs to a logging server. | [optional] 
**sourceType** | **String** | Required. The type of component that produces logs that will be forwarded to this logging server. | [optional] 
