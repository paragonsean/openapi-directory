...
/**
 * The CreateAssignedTargetingOptionsRequest model module.
 * @module model/CreateAssignedTargetingOptionsRequest
 * @version v3
 */
class CreateAssignedTargetingOptionsRequest {
    /**
     * Constructs a new <code>CreateAssignedTargetingOptionsRequest</code>.
     * A request listing which assigned targeting options of a given targeting type should be created and added.
     * @alias module:model/CreateAssignedTargetingOptionsRequest
     */
    constructor() { 
        
        CreateAssignedTargetingOptionsRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateAssignedTargetingOptionsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateAssignedTargetingOptionsRequest} obj Optional instance to populate.
     * @return {module:model/CreateAssignedTargetingOptionsRequest} The populated <code>CreateAssignedTargetingOptionsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateAssignedTargetingOptionsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateAssignedTargetingOptionsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateAssignedTargetingOptionsRequest</code>.
     */
 ...
 */
CreateAssignedTargetingOptionsRequest.prototype['assignedTargetingOptions'] = undefined;

/**
 * Required. Identifies the type of this assigned targeting option.
 * @member {module:model/CreateAssignedTargetingOptionsRequest.TargetingTypeEnum} targetingType
 */
CreateAssignedTargetingOptionsRequest.prototype['targetingType'] = undefined;
 ...
 * @readonly
 */
CreateAssignedTargetingOptionsRequest['TargetingTypeEnum'] = {
...
export default CreateAssignedTargetingOptionsRequest;
