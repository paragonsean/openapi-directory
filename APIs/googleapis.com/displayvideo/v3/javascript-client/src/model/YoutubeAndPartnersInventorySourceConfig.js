...
class YoutubeAndPartnersInventorySourceConfig {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('includeYoutube')) {
                obj['includeYoutube'] = ApiClient.convertToType(data['includeYoutube'], 'Boolean');
            }
 ...
 * @member {Boolean} includeYoutube
 */
YoutubeAndPartnersInventorySourceConfig.prototype['includeYoutube'] = undefined;
