...
class FrequencyCap {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('maxViews')) {
                obj['maxViews'] = ApiClient.convertToType(data['maxViews'], 'Number');
            }
 ...
 * @member {Number} maxViews
 */
FrequencyCap.prototype['maxViews'] = undefined;
