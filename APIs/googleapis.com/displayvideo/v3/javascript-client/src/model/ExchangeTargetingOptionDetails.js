...
/**
 * The ExchangeTargetingOptionDetails model module.
 * @module model/ExchangeTargetingOptionDetails
 * @version v3
 */
class ExchangeTargetingOptionDetails {
    /**
     * Constructs a new <code>ExchangeTargetingOptionDetails</code>.
     ...
     * @alias module:model/ExchangeTargetingOptionDetails
     */
    constructor() { 
        
        ExchangeTargetingOptionDetails.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ExchangeTargetingOptionDetails</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ExchangeTargetingOptionDetails} obj Optional instance to populate.
     * @return {module:model/ExchangeTargetingOptionDetails} The populated <code>ExchangeTargetingOptionDetails</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ExchangeTargetingOptionDetails();
    ...
    /**
     * Validates the JSON data with respect to <code>ExchangeTargetingOptionDetails</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ExchangeTargetingOptionDetails</code>.
     */
 ...
 * @member {module:model/ExchangeTargetingOptionDetails.ExchangeEnum} exchange
 */
ExchangeTargetingOptionDetails.prototype['exchange'] = undefined;
 ...
 * @readonly
 */
ExchangeTargetingOptionDetails['ExchangeEnum'] = {
...
export default ExchangeTargetingOptionDetails;
