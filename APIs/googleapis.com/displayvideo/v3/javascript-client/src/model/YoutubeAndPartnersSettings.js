...
import ThirdPartyMeasurementConfigs from './ThirdPartyMeasurementConfigs';
...
class YoutubeAndPartnersSettings {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('thirdPartyMeasurementConfigs')) {
                obj['thirdPartyMeasurementConfigs'] = ThirdPartyMeasurementConfigs.constructFromObject(data['thirdPartyMeasurementConfigs']);
            }
    ...
    static validateJSON(data) {
        ...
        // validate the optional field `thirdPartyMeasurementConfigs`
        if (data['thirdPartyMeasurementConfigs']) { // data not null
          ThirdPartyMeasurementConfigs.validateJSON(data['thirdPartyMeasurementConfigs']);
        }
...
/**
 * @member {module:model/ThirdPartyMeasurementConfigs} thirdPartyMeasurementConfigs
 */
YoutubeAndPartnersSettings.prototype['thirdPartyMeasurementConfigs'] = undefined;
