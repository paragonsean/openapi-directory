# DisplayVideo360Api.SdfConfig

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**adminEmail** | **String** | An administrator email address to which the SDF processing status reports will be sent. | [optional] 
**version** | **String** | Required. The version of SDF being used. | [optional] 
