...
> CustomBiddingAlgorithmRules displayvideoCustomBiddingAlgorithmsRulesCreate(customBiddingAlgorithmId, opts)
...
let apiInstance = new DisplayVideo360Api.CustomBiddingAlgorithmsApi();
let customBiddingAlgorithmId = "customBiddingAlgorithmId_example"; // String | Required. The ID of the custom bidding algorithm that owns the rules resource.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'partnerId': "partnerId_example", // String | The ID of the partner that owns the parent custom bidding algorithm. Only this partner will have write access to this rules resource.
  'customBiddingAlgorithmRules': new DisplayVideo360Api.CustomBiddingAlgorithmRules() // CustomBiddingAlgorithmRules | 
};
apiInstance.displayvideoCustomBiddingAlgorithmsRulesCreate(customBiddingAlgorithmId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> CustomBiddingAlgorithmRules displayvideoCustomBiddingAlgorithmsRulesGet(customBiddingAlgorithmId, customBiddingAlgorithmRulesId, opts)
...
let apiInstance = new DisplayVideo360Api.CustomBiddingAlgorithmsApi();
let customBiddingAlgorithmId = "customBiddingAlgorithmId_example"; // String | Required. The ID of the custom bidding algorithm that owns the rules resource.
let customBiddingAlgorithmRulesId = "customBiddingAlgorithmRulesId_example"; // String | Required. The ID of the rules resource to fetch.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'advertiserId': "advertiserId_example", // String | The ID of the advertiser that owns the parent custom bidding algorithm.
  'partnerId': "partnerId_example" // String | The ID of the partner that owns the parent custom bidding algorithm.
};
apiInstance.displayvideoCustomBiddingAlgorithmsRulesGet(customBiddingAlgorithmId, customBiddingAlgorithmRulesId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ListCustomBiddingAlgorithmRulesResponse displayvideoCustomBiddingAlgorithmsRulesList(customBiddingAlgorithmId, opts)
...
let opts = {
  ...
  'pageSize': 56, // Number | Requested page size. Must be between `1` and `200`. If unspecified will default to `100`. Returns error code `INVALID_ARGUMENT` if an invalid value is specified.
  'pageToken': "pageToken_example", // String | A token identifying a page of results the server should return. Typically, this is the value of next_page_token returned from the previous call to `ListCustomBiddingAlgorithmRules` method. If not specified, the first page of results will be returned.
  'partnerId': "partnerId_example" // String | The ID of the partner that owns the parent custom bidding algorithm.
};
apiInstance.displayvideoCustomBiddingAlgorithmsRulesList(customBiddingAlgorithmId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> CustomBiddingAlgorithmRulesRef displayvideoCustomBiddingAlgorithmsUploadRules(customBiddingAlgorithmId, opts)
...
apiInstance.displayvideoCustomBiddingAlgorithmsUploadRules(customBiddingAlgorithmId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
