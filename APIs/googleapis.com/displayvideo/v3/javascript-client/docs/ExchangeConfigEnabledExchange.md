# DisplayVideo360Api.ExchangeConfigEnabledExchange

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**exchange** | **String** | The enabled exchange. | [optional] 
**googleAdManagerAgencyId** | **String** | Output only. Agency ID of Google Ad Manager. The field is only relevant when Google Ad Manager is the enabled exchange. | [optional] [readonly] 
**googleAdManagerBuyerNetworkId** | **String** | Output only. Network ID of Google Ad Manager. The field is only relevant when Google Ad Manager is the enabled exchange. | [optional] [readonly] 
**seatId** | **String** | Output only. Seat ID of the enabled exchange. | [optional] [readonly] 
