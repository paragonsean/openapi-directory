# DisplayVideo360Api.AssignedTargetingOption
...
**inheritance** | **String** | Output only. The inheritance status of the assigned targeting option. | [optional] [readonly] 
...
**targetingType** | **String** | Output only. Identifies the type of this assigned targeting option. | [optional] [readonly] 
...
* `INHERITANCE_UNSPECIFIED` (value: `"INHERITANCE_UNSPECIFIED"`)

* `NOT_INHERITED` (value: `"NOT_INHERITED"`)

* `INHERITED_FROM_PARTNER` (value: `"INHERITED_FROM_PARTNER"`)

* `INHERITED_FROM_ADVERTISER` (value: `"INHERITED_FROM_ADVERTISER"`)
