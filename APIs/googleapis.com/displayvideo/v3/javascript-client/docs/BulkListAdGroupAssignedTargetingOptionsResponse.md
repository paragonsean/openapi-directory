...
------------ | ------------- | ------------- | -------------
**adGroupAssignedTargetingOptions** | [**[AdGroupAssignedTargetingOption]**](AdGroupAssignedTargetingOption.md) | The list of wrapper objects, each providing an assigned targeting option and the ad group it is assigned to. This list will be absent if empty. | [optional] 
