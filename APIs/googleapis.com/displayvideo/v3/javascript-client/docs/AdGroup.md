...
* `UNSPECIFIED` (value: `"AD_GROUP_FORMAT_UNSPECIFIED"`)

* `IN_STREAM` (value: `"AD_GROUP_FORMAT_IN_STREAM"`)

* `VIDEO_DISCOVERY` (value: `"AD_GROUP_FORMAT_VIDEO_DISCOVERY"`)

* `BUMPER` (value: `"AD_GROUP_FORMAT_BUMPER"`)

* `NON_SKIPPABLE_IN_STREAM` (value: `"AD_GROUP_FORMAT_NON_SKIPPABLE_IN_STREAM"`)

* `AUDIO` (value: `"AD_GROUP_FORMAT_AUDIO"`)

* `RESPONSIVE` (value: `"AD_GROUP_FORMAT_RESPONSIVE"`)

* `REACH` (value: `"AD_GROUP_FORMAT_REACH"`)

* `MASTHEAD` (value: `"AD_GROUP_FORMAT_MASTHEAD"`)
