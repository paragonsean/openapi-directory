...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DisplayVideo360Api.AudioAd();
  });
  ...
  describe('AudioAd', function() {
    it('should create an instance of AudioAd', function() {
      // uncomment below and update the code to test AudioAd
      //var instance = new DisplayVideo360Api.AudioAd();
      //expect(instance).to.be.a(DisplayVideo360Api.AudioAd);
    });
