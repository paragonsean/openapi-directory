...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DisplayVideo360Api.ListAdGroupsResponse();
  });
  ...
  describe('ListAdGroupsResponse', function() {
    it('should create an instance of ListAdGroupsResponse', function() {
      // uncomment below and update the code to test ListAdGroupsResponse
      //var instance = new DisplayVideo360Api.ListAdGroupsResponse();
      //expect(instance).to.be.a(DisplayVideo360Api.ListAdGroupsResponse);
    });
