...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DisplayVideo360Api.AlgorithmRulesRuleset();
  });
  ...
  describe('AlgorithmRulesRuleset', function() {
    it('should create an instance of AlgorithmRulesRuleset', function() {
      // uncomment below and update the code to test AlgorithmRulesRuleset
      //var instance = new DisplayVideo360Api.AlgorithmRulesRuleset();
      //expect(instance).to.be.a(DisplayVideo360Api.AlgorithmRulesRuleset);
    });
