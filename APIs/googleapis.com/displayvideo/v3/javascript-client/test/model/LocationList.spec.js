...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DisplayVideo360Api.LocationList();
  });
  ...
  describe('LocationList', function() {
    it('should create an instance of LocationList', function() {
      ...
      //var instance = new DisplayVideo360Api.LocationList();
      //expect(instance).to.be.a(DisplayVideo360Api.LocationList);
    });
    ...
    it('should have the property locationListId (base name: "locationListId")', function() {
      // uncomment below and update the code to test the property locationListId
      //var instance = new DisplayVideo360Api.LocationList();
      //expect(instance).to.be();
    });
