...
(function(root, factory) {
  ...
  describe('YoutubeAndPartnersSettings', function() {
    ...
    it('should have the property thirdPartyMeasurementConfigs (base name: "thirdPartyMeasurementConfigs")', function() {
      // uncomment below and update the code to test the property thirdPartyMeasurementConfigs
      //var instance = new DisplayVideo360Api.YoutubeAndPartnersSettings();
      //expect(instance).to.be();
    });
