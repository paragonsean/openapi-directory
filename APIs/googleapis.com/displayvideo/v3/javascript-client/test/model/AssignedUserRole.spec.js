...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DisplayVideo360Api.AssignedUserRole();
  });
  ...
  describe('AssignedUserRole', function() {
    it('should create an instance of AssignedUserRole', function() {
      // uncomment below and update the code to test AssignedUserRole
      //var instance = new DisplayVideo360Api.AssignedUserRole();
      //expect(instance).to.be.a(DisplayVideo360Api.AssignedUserRole);
    });
    ...
    it('should have the property assignedUserRoleId (base name: "assignedUserRoleId")', function() {
      // uncomment below and update the code to test the property assignedUserRoleId
      //var instance = new DisplayVideo360Api.AssignedUserRole();
      //expect(instance).to.be();
    });
