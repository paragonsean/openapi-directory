...
void OAIInsertionOrder::fromJsonObject(QJsonObject json) {
    ...
    m_kpi_isValid = ::OpenAPI::fromJsonValue(m_kpi, json[QString("kpi")]);
...
QJsonObject OAIInsertionOrder::asJsonObject() const {
    ...
    if (m_kpi.isSet()) {
        obj.insert(QString("kpi"), ::OpenAPI::toJsonValue(m_kpi));
    }
    if (m_name_isSet) {
...
OAIKpi OAIInsertionOrder::getKpi() const {
    return m_kpi;
}
void OAIInsertionOrder::setKpi(const OAIKpi &kpi) {
    m_kpi = kpi;
    m_kpi_isSet = true;
}

bool OAIInsertionOrder::is_kpi_Set() const{
    return m_kpi_isSet;
}

bool OAIInsertionOrder::is_kpi_Valid() const{
    return m_kpi_isValid;
}
