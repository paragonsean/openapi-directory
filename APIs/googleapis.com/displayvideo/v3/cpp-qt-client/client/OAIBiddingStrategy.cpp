...
void OAIBiddingStrategy::initializeModel() {
    ...
    m_youtube_and_partners_bid_isSet = false;
    m_youtube_and_partners_bid_isValid = false;
}
...
void OAIBiddingStrategy::fromJsonObject(QJsonObject json) {
    ...
    m_youtube_and_partners_bid_isValid = ::OpenAPI::fromJsonValue(m_youtube_and_partners_bid, json[QString("youtubeAndPartnersBid")]);
    m_youtube_and_partners_bid_isSet = !json[QString("youtubeAndPartnersBid")].isNull() && m_youtube_and_partners_bid_isValid;
}
...
QJsonObject OAIBiddingStrategy::asJsonObject() const {
    ...
    if (m_youtube_and_partners_bid.isSet()) {
        obj.insert(QString("youtubeAndPartnersBid"), ::OpenAPI::toJsonValue(m_youtube_and_partners_bid));
    }
    return obj;
}
...
OAIYoutubeAndPartnersBiddingStrategy OAIBiddingStrategy::getYoutubeAndPartnersBid() const {
    return m_youtube_and_partners_bid;
}
void OAIBiddingStrategy::setYoutubeAndPartnersBid(const OAIYoutubeAndPartnersBiddingStrategy &youtube_and_partners_bid) {
    m_youtube_and_partners_bid = youtube_and_partners_bid;
    m_youtube_and_partners_bid_isSet = true;
}

bool OAIBiddingStrategy::is_youtube_and_partners_bid_Set() const{
    return m_youtube_and_partners_bid_isSet;
}

bool OAIBiddingStrategy::is_youtube_and_partners_bid_Valid() const{
    return m_youtube_and_partners_bid_isValid;
}
