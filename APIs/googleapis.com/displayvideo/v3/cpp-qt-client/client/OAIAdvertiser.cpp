...
OAIAdvertiserBillingConfig OAIAdvertiser::getBillingConfig() const {
    return m_billing_config;
}
void OAIAdvertiser::setBillingConfig(const OAIAdvertiserBillingConfig &billing_config) {
    m_billing_config = billing_config;
    m_billing_config_isSet = true;
}

bool OAIAdvertiser::is_billing_config_Set() const{
    return m_billing_config_isSet;
}

bool OAIAdvertiser::is_billing_config_Valid() const{
