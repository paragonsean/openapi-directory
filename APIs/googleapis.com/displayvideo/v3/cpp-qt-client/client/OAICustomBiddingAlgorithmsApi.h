...
public:
    ...
    * @param[in]  advertiser_id QString [optional]
    * @param[in]  partner_id QString [optional]
    * @param[in]  oai_custom_bidding_algorithm_rules OAICustomBiddingAlgorithmRules [optional]
    */
    virtual void displayvideo_customBiddingAlgorithms_rules_create(const QString &custom_bidding_algorithm_id, const ::OpenAPI::OptionalParam<QString> &_xgafv = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &access_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &alt = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &callback = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &fields = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &key = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &oauth_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &pretty_print = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &quota_user = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &upload_protocol = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &upload_type = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &advertiser_id = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &partner_id = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAICustomBiddingAlgorithmRules> &oai_custom_bidding_algorithm_rules = ::OpenAPI::OptionalParam<OAICustomBiddingAlgorithmRules>());

    /**
    * @param[in]  custom_bidding_algorithm_id QString [required]
    * @param[in]  custom_bidding_algorithm_rules_id QString [required]
    * @param[in]  _xgafv QString [optional]
    * @param[in]  access_token QString [optional]
    * @param[in]  alt QString [optional]
    * @param[in]  callback QString [optional]
    ...
    * @param[in]  partner_id QString [optional]
    */
    virtual void displayvideo_customBiddingAlgorithms_rules_get(const QString &custom_bidding_algorithm_id, const QString &custom_bidding_algorithm_rules_id, const ::OpenAPI::OptionalParam<QString> &_xgafv = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &access_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &alt = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &callback = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &fields = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &key = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &oauth_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &pretty_print = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &quota_user = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &upload_protocol = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &upload_type = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &advertiser_id = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &partner_id = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  partner_id QString [optional]
    */
    virtual void displayvideo_customBiddingAlgorithms_uploadRules(const QString &custom_bidding_algorithm_id, const ::OpenAPI::OptionalParam<QString> &_xgafv = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &access_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &alt = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &callback = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &fields = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &key = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &oauth_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &pretty_print = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &quota_user = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &upload_protocol = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &upload_type = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &advertiser_id = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &partner_id = ::OpenAPI::OptionalParam<QString>());
...
private:
    ...
    void displayvideo_customBiddingAlgorithms_rules_createCallback(OAIHttpRequestWorker *worker);
    void displayvideo_customBiddingAlgorithms_rules_getCallback(OAIHttpRequestWorker *worker);
    void displayvideo_customBiddingAlgorithms_rules_listCallback(OAIHttpRequestWorker *worker);
    ...
    void displayvideo_customBiddingAlgorithms_uploadRulesCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void displayvideo_customBiddingAlgorithms_rules_createSignal(OAICustomBiddingAlgorithmRules summary);
    void displayvideo_customBiddingAlgorithms_rules_getSignal(OAICustomBiddingAlgorithmRules summary);
    void displayvideo_customBiddingAlgorithms_rules_listSignal(OAIListCustomBiddingAlgorithmRulesResponse summary);
    ...
    void displayvideo_customBiddingAlgorithms_uploadRulesSignal(OAICustomBiddingAlgorithmRulesRef summary);
    ...
    void displayvideo_customBiddingAlgorithms_rules_createSignalFull(OAIHttpRequestWorker *worker, OAICustomBiddingAlgorithmRules summary);
    void displayvideo_customBiddingAlgorithms_rules_getSignalFull(OAIHttpRequestWorker *worker, OAICustomBiddingAlgorithmRules summary);
    void displayvideo_customBiddingAlgorithms_rules_listSignalFull(OAIHttpRequestWorker *worker, OAIListCustomBiddingAlgorithmRulesResponse summary);
    ...
    void displayvideo_customBiddingAlgorithms_uploadRulesSignalFull(OAIHttpRequestWorker *worker, OAICustomBiddingAlgorithmRulesRef summary);
    ...
    Q_DECL_DEPRECATED_X("Use displayvideo_customBiddingAlgorithms_rules_createSignalError() instead")
    void displayvideo_customBiddingAlgorithms_rules_createSignalE(OAICustomBiddingAlgorithmRules summary, QNetworkReply::NetworkError error_type, QString error_str);
    void displayvideo_customBiddingAlgorithms_rules_createSignalError(OAICustomBiddingAlgorithmRules summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use displayvideo_customBiddingAlgorithms_rules_getSignalError() instead")
    void displayvideo_customBiddingAlgorithms_rules_getSignalE(OAICustomBiddingAlgorithmRules summary, QNetworkReply::NetworkError error_type, QString error_str);
    void displayvideo_customBiddingAlgorithms_rules_getSignalError(OAICustomBiddingAlgorithmRules summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use displayvideo_customBiddingAlgorithms_rules_listSignalError() instead")
    void displayvideo_customBiddingAlgorithms_rules_listSignalE(OAIListCustomBiddingAlgorithmRulesResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void displayvideo_customBiddingAlgorithms_rules_listSignalError(OAIListCustomBiddingAlgorithmRulesResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use displayvideo_customBiddingAlgorithms_uploadRulesSignalError() instead")
    void displayvideo_customBiddingAlgorithms_uploadRulesSignalE(OAICustomBiddingAlgorithmRulesRef summary, QNetworkReply::NetworkError error_type, QString error_str);
    void displayvideo_customBiddingAlgorithms_uploadRulesSignalError(OAICustomBiddingAlgorithmRulesRef summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use displayvideo_customBiddingAlgorithms_rules_createSignalErrorFull() instead")
    void displayvideo_customBiddingAlgorithms_rules_createSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void displayvideo_customBiddingAlgorithms_rules_createSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use displayvideo_customBiddingAlgorithms_rules_getSignalErrorFull() instead")
    void displayvideo_customBiddingAlgorithms_rules_getSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void displayvideo_customBiddingAlgorithms_rules_getSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use displayvideo_customBiddingAlgorithms_rules_listSignalErrorFull() instead")
    void displayvideo_customBiddingAlgorithms_rules_listSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void displayvideo_customBiddingAlgorithms_rules_listSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use displayvideo_customBiddingAlgorithms_uploadRulesSignalErrorFull() instead")
    void displayvideo_customBiddingAlgorithms_uploadRulesSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void displayvideo_customBiddingAlgorithms_uploadRulesSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
