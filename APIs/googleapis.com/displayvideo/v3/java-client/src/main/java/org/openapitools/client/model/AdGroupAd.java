...
public class AdGroupAd {
  ...
  public AdGroupAd adGroupAdId(String adGroupAdId) {
  ...
  public AdGroupAd adGroupId(String adGroupId) {
  ...
  public AdGroupAd adUrls(List<AdUrl> adUrls) {
    this.adUrls = adUrls;
    return this;
  }

  public AdGroupAd addAdUrlsItem(AdUrl adUrlsItem) {
    if (this.adUrls == null) {
  ...
  public AdGroupAd advertiserId(String advertiserId) {
  ...
  public AdGroupAd audioAd(AudioAd audioAd) {
  ...
  public AdGroupAd bumperAd(BumperAd bumperAd) {
  ...
  public AdGroupAd displayName(String displayName) {
  ...
  public AdGroupAd displayVideoSourceAd(DisplayVideoSourceAd displayVideoSourceAd) {
  ...
  public AdGroupAd entityStatus(EntityStatusEnum entityStatus) {
  ...
  public AdGroupAd inStreamAd(InStreamAd inStreamAd) {
  ...
  public AdGroupAd mastheadAd(MastheadAd mastheadAd) {
  ...
  public AdGroupAd name(String name) {
    this.name = name;
    return this;
  }
  ...
  public AdGroupAd nonSkippableAd(NonSkippableAd nonSkippableAd) {
  ...
  public AdGroupAd videoDiscoverAd(VideoDiscoveryAd videoDiscoverAd) {
  ...
  public AdGroupAd videoPerformanceAd(VideoPerformanceAd videoPerformanceAd) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.adGroupAdId, adGroupAd.adGroupAdId) &&
        Objects.equals(this.adGroupId, adGroupAd.adGroupId) &&
        Objects.equals(this.adUrls, adGroupAd.adUrls) &&
        Objects.equals(this.advertiserId, adGroupAd.advertiserId) &&
        Objects.equals(this.audioAd, adGroupAd.audioAd) &&
        Objects.equals(this.bumperAd, adGroupAd.bumperAd) &&
        Objects.equals(this.displayName, adGroupAd.displayName) &&
        Objects.equals(this.displayVideoSourceAd, adGroupAd.displayVideoSourceAd) &&
        Objects.equals(this.entityStatus, adGroupAd.entityStatus) &&
        Objects.equals(this.inStreamAd, adGroupAd.inStreamAd) &&
        Objects.equals(this.mastheadAd, adGroupAd.mastheadAd) &&
        Objects.equals(this.name, adGroupAd.name) &&
        Objects.equals(this.nonSkippableAd, adGroupAd.nonSkippableAd) &&
        Objects.equals(this.videoDiscoverAd, adGroupAd.videoDiscoverAd) &&
        Objects.equals(this.videoPerformanceAd, adGroupAd.videoPerformanceAd);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AdGroupAd
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdGroupAd.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AdGroupAd is not found in the empty JSON string", AdGroupAd.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AdGroupAd.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AdGroupAd` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AdGroupAd.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AdGroupAd' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AdGroupAd> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AdGroupAd.class));

       return (TypeAdapter<T>) new TypeAdapter<AdGroupAd>() {
           @Override
           public void write(JsonWriter out, AdGroupAd value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AdGroupAd read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AdGroupAd given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AdGroupAd
   * @throws IOException if the JSON string is invalid with respect to AdGroupAd
   */
  public static AdGroupAd fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AdGroupAd.class);
  }

  /**
   * Convert an instance of AdGroupAd to an JSON string
   *
   * @return JSON string
   */
