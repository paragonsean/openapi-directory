...
public class YoutubeAndPartnersSettings {
  ...
  public static final String SERIALIZED_NAME_THIRD_PARTY_MEASUREMENT_CONFIGS = "thirdPartyMeasurementConfigs";
  @SerializedName(SERIALIZED_NAME_THIRD_PARTY_MEASUREMENT_CONFIGS)
  ...
  public YoutubeAndPartnersSettings thirdPartyMeasurementConfigs(ThirdPartyMeasurementConfigs thirdPartyMeasurementConfigs) {
    this.thirdPartyMeasurementConfigs = thirdPartyMeasurementConfigs;
    return this;
  }

  /**
   * Get thirdPartyMeasurementConfigs
  ...
  public void setThirdPartyMeasurementConfigs(ThirdPartyMeasurementConfigs thirdPartyMeasurementConfigs) {
    this.thirdPartyMeasurementConfigs = thirdPartyMeasurementConfigs;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.contentCategory, youtubeAndPartnersSettings.contentCategory) &&
        ...
        Objects.equals(this.thirdPartyMeasurementConfigs, youtubeAndPartnersSettings.thirdPartyMeasurementConfigs) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(contentCategory, effectiveContentCategory, inventorySourceSettings, leadFormId, linkedMerchantId, relatedVideoIds, targetFrequency, thirdPartyMeasurementConfigs, videoAdSequenceSettings, viewFrequencyCap);
  }
  ...
  public String toString() {
    ...
    sb.append("    thirdPartyMeasurementConfigs: ").append(toIndentedString(thirdPartyMeasurementConfigs)).append("\n");
  ...
  static {
    ...
    openapiFields.add("thirdPartyMeasurementConfigs");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("thirdPartyMeasurementConfigs") != null && !jsonObj.get("thirdPartyMeasurementConfigs").isJsonNull()) {
        ThirdPartyMeasurementConfigs.validateJsonElement(jsonObj.get("thirdPartyMeasurementConfigs"));
      }
