...
public class BusinessChainAssignedTargetingOptionDetails {
  ...
  public BusinessChainAssignedTargetingOptionDetails() {
  }
  ...
  public BusinessChainAssignedTargetingOptionDetails proximityRadiusAmount(Double proximityRadiusAmount) {
  ...
  public BusinessChainAssignedTargetingOptionDetails proximityRadiusUnit(ProximityRadiusUnitEnum proximityRadiusUnit) {
  ...
  public BusinessChainAssignedTargetingOptionDetails targetingOptionId(String targetingOptionId) {
  ...
  public boolean equals(Object o) {
    ...
    BusinessChainAssignedTargetingOptionDetails businessChainAssignedTargetingOptionDetails = (BusinessChainAssignedTargetingOptionDetails) o;
    return Objects.equals(this.displayName, businessChainAssignedTargetingOptionDetails.displayName) &&
        Objects.equals(this.proximityRadiusAmount, businessChainAssignedTargetingOptionDetails.proximityRadiusAmount) &&
        Objects.equals(this.proximityRadiusUnit, businessChainAssignedTargetingOptionDetails.proximityRadiusUnit) &&
        Objects.equals(this.targetingOptionId, businessChainAssignedTargetingOptionDetails.targetingOptionId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(displayName, proximityRadiusAmount, proximityRadiusUnit, targetingOptionId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BusinessChainAssignedTargetingOptionDetails {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BusinessChainAssignedTargetingOptionDetails
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BusinessChainAssignedTargetingOptionDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BusinessChainAssignedTargetingOptionDetails is not found in the empty JSON string", BusinessChainAssignedTargetingOptionDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BusinessChainAssignedTargetingOptionDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BusinessChainAssignedTargetingOptionDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BusinessChainAssignedTargetingOptionDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BusinessChainAssignedTargetingOptionDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BusinessChainAssignedTargetingOptionDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BusinessChainAssignedTargetingOptionDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<BusinessChainAssignedTargetingOptionDetails>() {
           @Override
           public void write(JsonWriter out, BusinessChainAssignedTargetingOptionDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BusinessChainAssignedTargetingOptionDetails read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BusinessChainAssignedTargetingOptionDetails given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BusinessChainAssignedTargetingOptionDetails
   * @throws IOException if the JSON string is invalid with respect to BusinessChainAssignedTargetingOptionDetails
   */
  public static BusinessChainAssignedTargetingOptionDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BusinessChainAssignedTargetingOptionDetails.class);
  }

  /**
   * Convert an instance of BusinessChainAssignedTargetingOptionDetails to an JSON string
   *
   * @return JSON string
   */
