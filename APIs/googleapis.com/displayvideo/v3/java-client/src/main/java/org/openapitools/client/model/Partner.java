...
public class Partner {
  ...
  public Partner billingConfig(PartnerBillingConfig billingConfig) {
  ...
  public void setBillingConfig(PartnerBillingConfig billingConfig) {
    this.billingConfig = billingConfig;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.adServerConfig, partner.adServerConfig) &&
        Objects.equals(this.billingConfig, partner.billingConfig) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(adServerConfig, billingConfig, dataAccessConfig, displayName, entityStatus, exchangeConfig, generalConfig, name, partnerId, updateTime);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("billingConfig") != null && !jsonObj.get("billingConfig").isJsonNull()) {
        PartnerBillingConfig.validateJsonElement(jsonObj.get("billingConfig"));
      }
