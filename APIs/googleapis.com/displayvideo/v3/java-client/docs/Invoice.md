...
|**budgetSummaries** | [**List&lt;BudgetSummary&gt;**](BudgetSummary.md) | The list of summarized information for each budget associated with this invoice. This field will only be set if the invoice detail level of the corresponding billing profile was set to \&quot;Budget level PO\&quot;. |  [optional] |
...
|**invoiceType** | [**InvoiceTypeEnum**](#InvoiceTypeEnum) | The type of invoice document. |  [optional] |
...
|**replacedInvoiceIds** | **List&lt;String&gt;** | The ID(s) of any originally issued invoice that is being cancelled by this invoice, if applicable. Multiple invoices may be listed if those invoices are being consolidated into a single invoice. May appear on invoice PDF as &#x60;Replaced invoice numbers&#x60;. If corrected_invoice_id is set, this field will be empty. |  [optional] |
