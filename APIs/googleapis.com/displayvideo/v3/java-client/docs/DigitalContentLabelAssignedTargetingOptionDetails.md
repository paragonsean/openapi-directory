...
|------------ | ------------- | ------------- | -------------|
|**excludedContentRatingTier** | [**ExcludedContentRatingTierEnum**](#ExcludedContentRatingTierEnum) | Required. The display name of the digital content label rating tier to be EXCLUDED. |  [optional] |



## Enum: ExcludedContentRatingTierEnum
