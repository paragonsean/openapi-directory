...
|------------ | ------------- | ------------- | -------------|
|**inventorySourceGroupId** | **String** | Required. ID of the inventory source group. Should refer to the inventory_source_group_id field of an InventorySourceGroup resource. |  [optional] |
