...
class InsertionOrder(Model):
    ...
    def __init__(self, advertiser_id: str=None, bid_strategy: BiddingStrategy=None, budget: InsertionOrderBudget=None, campaign_id: str=None, display_name: str=None, entity_status: str=None, frequency_cap: FrequencyCap=None, insertion_order_id: str=None, insertion_order_type: str=None, integration_details: IntegrationDetails=None, kpi: Kpi=None, name: str=None, pacing: Pacing=None, partner_costs: List[PartnerCost]=None, reservation_type: str=None, update_time: str=None):
        ...
        :param kpi: The kpi of this InsertionOrder.
    ...
    @property
    def kpi(self):
        """Gets the kpi of this InsertionOrder.


        :return: The kpi of this InsertionOrder.
        :rtype: Kpi
        """
        return self._kpi
    ...
    @kpi.setter
    def kpi(self, kpi):
        """Sets the kpi of this InsertionOrder.
