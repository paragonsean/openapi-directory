...
class CustomBiddingModelDetails(Model):
    ...
    def readiness_state(self, readiness_state):
        ...
        """
        allowed_values = ["READINESS_STATE_UNSPECIFIED", "READINESS_STATE_ACTIVE", "READINESS_STATE_INSUFFICIENT_DATA", "READINESS_STATE_TRAINING", "READINESS_STATE_NO_VALID_SCRIPT", "READINESS_STATE_EVALUATION_FAILURE"]  # noqa: E501
