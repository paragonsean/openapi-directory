...
class ExchangeAssignedTargetingOptionDetails(Model):
    ...
    def __init__(self, exchange: str=None):
        ...
        :param exchange: The exchange of this ExchangeAssignedTargetingOptionDetails.
        """
        self.openapi_types = {
            'exchange': str
        }
    ...
    @property
    def exchange(self):
        """Gets the exchange of this ExchangeAssignedTargetingOptionDetails.

        Required. The enum value for the exchange.

        :return: The exchange of this ExchangeAssignedTargetingOptionDetails.
        :rtype: str
        """
    ...
    def exchange(self, exchange):
        """Sets the exchange of this ExchangeAssignedTargetingOptionDetails.
