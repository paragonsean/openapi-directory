...
class CreateAssetResponse(Model):
    ...
    def __init__(self, asset: Asset=None):
        ...
        :param asset: The asset of this CreateAssetResponse.
        """
        self.openapi_types = {
            'asset': Asset
        }
    ...
    @property
    def asset(self):
        """Gets the asset of this CreateAssetResponse.


        :return: The asset of this CreateAssetResponse.
        :rtype: Asset
        """
        return self._asset
    ...
    def asset(self, asset):
        """Sets the asset of this CreateAssetResponse.
