...
async def test_displayvideo_inventory_source_groups_assigned_inventory_sources_bulk_edit(client):
    ...
    response = await client.request(
        method='POST',
        path='/v3/inventorySourceGroups/{inventory_source_group_id}/assignedInventorySources:bulkEdit'.format(inventory_source_group_id='inventory_source_group_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_displayvideo_inventory_source_groups_assigned_inventory_sources_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v3/inventorySourceGroups/{inventory_source_group_id}/assignedInventorySources'.format(inventory_source_group_id='inventory_source_group_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_displayvideo_inventory_source_groups_assigned_inventory_sources_delete(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/v3/inventorySourceGroups/{inventory_source_group_id}/assignedInventorySources/{assigned_inventory_source_id}'.format(inventory_source_group_id='inventory_source_group_id_example', assigned_inventory_source_id='assigned_inventory_source_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_displayvideo_inventory_source_groups_delete(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/v3/inventorySourceGroups/{inventory_source_group_id}'.format(inventory_source_group_id='inventory_source_group_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
