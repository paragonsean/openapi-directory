...
async def test_displayvideo_custom_bidding_algorithms_get(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/customBiddingAlgorithms/{custom_bidding_algorithm_id}'.format(custom_bidding_algorithm_id='custom_bidding_algorithm_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_displayvideo_custom_bidding_algorithms_rules_create(client):
    """Test case for displayvideo_custom_bidding_algorithms_rules_create

    
    """
    body = {"customBiddingAlgorithmRulesId":"customBiddingAlgorithmRulesId","customBiddingAlgorithmId":"customBiddingAlgorithmId","createTime":"createTime","name":"name","active":True,"rules":{"resourceName":"resourceName"},"state":"STATE_UNSPECIFIED","error":{"errorCode":"ERROR_CODE_UNSPECIFIED"}}
    params = [('$.xgafv', 'xgafv_example'),
                    ('access_token', 'access_token_example'),
                    ('alt', 'alt_example'),
                    ('callback', 'param_callback_example'),
    ...
    response = await client.request(
        method='POST',
        path='/v3/customBiddingAlgorithms/{custom_bidding_algorithm_id}/rules'.format(custom_bidding_algorithm_id='custom_bidding_algorithm_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_displayvideo_custom_bidding_algorithms_rules_get(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/customBiddingAlgorithms/{custom_bidding_algorithm_id}/rules/{custom_bidding_algorithm_rules_id}'.format(custom_bidding_algorithm_id='custom_bidding_algorithm_id_example', custom_bidding_algorithm_rules_id='custom_bidding_algorithm_rules_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_displayvideo_custom_bidding_algorithms_rules_list(client):
...
async def test_displayvideo_custom_bidding_algorithms_scripts_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v3/customBiddingAlgorithms/{custom_bidding_algorithm_id}/scripts'.format(custom_bidding_algorithm_id='custom_bidding_algorithm_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_displayvideo_custom_bidding_algorithms_scripts_get(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/customBiddingAlgorithms/{custom_bidding_algorithm_id}/scripts/{custom_bidding_script_id}'.format(custom_bidding_algorithm_id='custom_bidding_algorithm_id_example', custom_bidding_script_id='custom_bidding_script_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_displayvideo_custom_bidding_algorithms_upload_rules(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/customBiddingAlgorithms/{custom_bidding_algorithm_idupload_rule}'.format(custom_bidding_algorithm_id='custom_bidding_algorithm_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_displayvideo_custom_bidding_algorithms_upload_script(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/customBiddingAlgorithms/{custom_bidding_algorithm_idupload_scrip}'.format(custom_bidding_algorithm_id='custom_bidding_algorithm_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
