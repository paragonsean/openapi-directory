...
async def test_displayvideo_advertisers_ad_group_ads_get(client):
    """Test case for displayvideo_advertisers_ad_group_ads_get
    ...
    response = await client.request(
        method='GET',
        path='/v3/advertisers/{advertiser_id}/adGroupAds/{ad_group_ad_id}'.format(advertiser_id='advertiser_id_example', ad_group_ad_id='ad_group_ad_id_example'),
        headers=headers,
        params=params,
        )
...
async def test_displayvideo_advertisers_ad_group_ads_list(client):
    """Test case for displayvideo_advertisers_ad_group_ads_list
    ...
    response = await client.request(
        method='GET',
        path='/v3/advertisers/{advertiser_id}/adGroupAds'.format(advertiser_id='advertiser_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_displayvideo_advertisers_ad_groups_bulk_list_ad_group_assigned_targeting_options(client):
    """Test case for displayvideo_advertisers_ad_groups_bulk_list_ad_group_assigned_targeting_options
    ...
    params = [('$.xgafv', 'xgafv_example'),
                    ...
                    ('upload_protocol', 'upload_protocol_example'),
                    ('uploadType', 'upload_type_example'),
                    ('adGroupIds', ['ad_group_ids_example']),
                    ('filter', 'filter_example'),
                    ('orderBy', 'order_by_example'),
                    ('pageSize', 56),
                    ('pageToken', 'page_token_example')]
    ...
    response = await client.request(
        method='GET',
        path='/v3/advertisers/{advertiser_id}/adGroups:bulkListAdGroupAssignedTargetingOptions'.format(advertiser_id='advertiser_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_displayvideo_advertisers_ad_groups_get(client):
    """Test case for displayvideo_advertisers_ad_groups_get
    ...
    response = await client.request(
        method='GET',
        path='/v3/advertisers/{advertiser_id}/adGroups/{ad_group_id}'.format(advertiser_id='advertiser_id_example', ad_group_id='ad_group_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_displayvideo_advertisers_ad_groups_list(client):
    """Test case for displayvideo_advertisers_ad_groups_list
    ...
    response = await client.request(
        method='GET',
        path='/v3/advertisers/{advertiser_id}/adGroups'.format(advertiser_id='advertiser_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_displayvideo_advertisers_ad_groups_targeting_types_assigned_targeting_options_get(client):
    """Test case for displayvideo_advertisers_ad_groups_targeting_types_assigned_targeting_options_get
    ...
    response = await client.request(
        method='GET',
        path='/v3/advertisers/{advertiser_id}/adGroups/{ad_group_id}/targetingTypes/{targeting_type}/assignedTargetingOptions/{assigned_targeting_option_id}'.format(advertiser_id='advertiser_id_example', ad_group_id='ad_group_id_example', targeting_type='targeting_type_example', assigned_targeting_option_id='assigned_targeting_option_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_displayvideo_advertisers_ad_groups_targeting_types_assigned_targeting_options_list(client):
    """Test case for displayvideo_advertisers_ad_groups_targeting_types_assigned_targeting_options_list
    ...
    response = await client.request(
        method='GET',
        path='/v3/advertisers/{advertiser_id}/adGroups/{ad_group_id}/targetingTypes/{targeting_type}/assignedTargetingOptions'.format(advertiser_id='advertiser_id_example', ad_group_id='ad_group_id_example', targeting_type='targeting_type_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_displayvideo_advertisers_assets_upload(client):
    ...
    response = await client.request(
        method='POST',
        path='/v3/advertisers/{advertiser_id}/assets'.format(advertiser_id='advertiser_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_displayvideo_advertisers_audit(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/advertisers/{advertiser_idaudi}'.format(advertiser_id='advertiser_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_displayvideo_advertisers_campaigns_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v3/advertisers/{advertiser_id}/campaigns'.format(advertiser_id='advertiser_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_displayvideo_advertisers_campaigns_delete(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/v3/advertisers/{advertiser_id}/campaigns/{campaign_id}'.format(advertiser_id='advertiser_id_example', campaign_id='campaign_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_displayvideo_advertisers_campaigns_list_assigned_targeting_options(client):
    """Test case for displayvideo_advertisers_campaigns_list_assigned_targeting_options
    ...
    response = await client.request(
        method='GET',
        path='/v3/advertisers/{advertiser_id}/campaigns/{campaign_idlist_assigned_targeting_option}'.format(advertiser_id='advertiser_id_example', campaign_id='campaign_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_displayvideo_advertisers_campaigns_targeting_types_assigned_targeting_options_list(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/advertisers/{advertiser_id}/campaigns/{campaign_id}/targetingTypes/{targeting_type}/assignedTargetingOptions'.format(advertiser_id='advertiser_id_example', campaign_id='campaign_id_example', targeting_type='targeting_type_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_displayvideo_advertisers_channels_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v3/advertisers/{advertiser_id}/channels'.format(advertiser_id='advertiser_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_displayvideo_advertisers_channels_patch(client):
    ...
    response = await client.request(
        method='PATCH',
        path='/v3/advertisers/{advertiser_id}/channels/{channel_id}'.format(advertiser_id='advertiser_id_example', channel_id='channel_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_displayvideo_advertisers_channels_sites_bulk_edit(client):
    ...
    response = await client.request(
        method='POST',
        path='/v3/advertisers/{advertiser_id}/channels/{channel_id}/sites:bulkEdit'.format(advertiser_id='advertiser_id_example', channel_id='channel_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_displayvideo_advertisers_channels_sites_delete(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/v3/advertisers/{advertiser_id}/channels/{channel_id}/sites/{url_or_app_id}'.format(advertiser_id='advertiser_id_example', channel_id='channel_id_example', url_or_app_id='url_or_app_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_displayvideo_advertisers_channels_sites_list(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/advertisers/{advertiser_id}/channels/{channel_id}/sites'.format(advertiser_id='advertiser_id_example', channel_id='channel_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_displayvideo_advertisers_channels_sites_replace(client):
    ...
    response = await client.request(
        method='POST',
        path='/v3/advertisers/{advertiser_id}/channels/{channel_id}/sites:replace'.format(advertiser_id='advertiser_id_example', channel_id='channel_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_displayvideo_advertisers_create(client):
    ...
    """
    body = {"adServerConfig":{"thirdPartyOnlyConfig":{"pixelOrderIdReportingEnabled":True},"cmHybridConfig":{"cmSyncableSiteIds":["cmSyncableSiteIds","cmSyncableSiteIds"],"dv360ToCmDataSharingEnabled":True,"dv360ToCmCostReportingEnabled":True,"cmAdvertiserIds":["cmAdvertiserIds","cmAdvertiserIds"],"cmFloodlightConfigId":"cmFloodlightConfigId","cmFloodlightLinkingAuthorized":True,"cmAccountId":"cmAccountId"}},"displayName":"displayName","billingConfig":{"billingProfileId":"billingProfileId"},"creativeConfig":{"dynamicCreativeEnabled":True,"videoCreativeDataSharingAuthorized":True,"obaComplianceDisabled":True,"iasClientId":"iasClientId"},"updateTime":"updateTime","integrationDetails":{"integrationCode":"integrationCode","details":"details"},"advertiserId":"advertiserId","servingConfig":{"exemptTvFromViewabilityTargeting":True},"entityStatus":"ENTITY_STATUS_UNSPECIFIED","prismaEnabled":True,"generalConfig":{"timeZone":"timeZone","currencyCode":"currencyCode","domainUrl":"domainUrl"},"name":"name","partnerId":"partnerId","dataAccessConfig":{"sdfConfig":{"sdfConfig":{"version":"SDF_VERSION_UNSPECIFIED","adminEmail":"adminEmail"},"overridePartnerSdfConfig":True}}}
    params = [('$.xgafv', 'xgafv_example'),
                    ('access_token', 'access_token_example'),
                    ('alt', 'alt_example'),
                    ('callback', 'param_callback_example'),
...
async def test_displayvideo_advertisers_creatives_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v3/advertisers/{advertiser_id}/creatives'.format(advertiser_id='advertiser_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_displayvideo_advertisers_creatives_delete(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/v3/advertisers/{advertiser_id}/creatives/{creative_id}'.format(advertiser_id='advertiser_id_example', creative_id='creative_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_displayvideo_advertisers_delete(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/v3/advertisers/{advertiser_id}'.format(advertiser_id='advertiser_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_displayvideo_advertisers_edit_assigned_targeting_options(client):
    """Test case for displayvideo_advertisers_edit_assigned_targeting_options
    ...
    response = await client.request(
        method='POST',
        path='/v3/advertisers/{advertiser_idedit_assigned_targeting_option}'.format(advertiser_id='advertiser_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_displayvideo_advertisers_insertion_orders_create(client):
    ...
    """
    body = {"bidStrategy":{"fixedBid":{"bidAmountMicros":"bidAmountMicros"},"youtubeAndPartnersBid":{"adGroupEffectiveTargetCpaSource":"BIDDING_SOURCE_UNSPECIFIED","adGroupEffectiveTargetCpaValue":"adGroupEffectiveTargetCpaValue","type":"YOUTUBE_AND_PARTNERS_BIDDING_STRATEGY_TYPE_UNSPECIFIED","value":"value"},"performanceGoalAutoBid":{"performanceGoalType":"BIDDING_STRATEGY_PERFORMANCE_GOAL_TYPE_UNSPECIFIED","customBiddingAlgorithmId":"customBiddingAlgorithmId","performanceGoalAmountMicros":"performanceGoalAmountMicros","maxAverageCpmBidAmountMicros":"maxAverageCpmBidAmountMicros"},"maximizeSpendAutoBid":{"raiseBidForDeals":True,"performanceGoalType":"BIDDING_STRATEGY_PERFORMANCE_GOAL_TYPE_UNSPECIFIED","customBiddingAlgorithmId":"customBiddingAlgorithmId","maxAverageCpmBidAmountMicros":"maxAverageCpmBidAmountMicros"}},"insertionOrderType":"INSERTION_ORDER_TYPE_UNSPECIFIED","partnerCosts":[{"feeAmount":"feeAmount","costType":"PARTNER_COST_TYPE_UNSPECIFIED","invoiceType":"PARTNER_COST_INVOICE_TYPE_UNSPECIFIED","feeType":"PARTNER_COST_FEE_TYPE_UNSPECIFIED","feePercentageMillis":"feePercentageMillis"},{"feeAmount":"feeAmount","costType":"PARTNER_COST_TYPE_UNSPECIFIED","invoiceType":"PARTNER_COST_INVOICE_TYPE_UNSPECIFIED","feeType":"PARTNER_COST_FEE_TYPE_UNSPECIFIED","feePercentageMillis":"feePercentageMillis"}],"kpi":{"kpiString":"kpiString","kpiType":"KPI_TYPE_UNSPECIFIED","kpiPercentageMicros":"kpiPercentageMicros","kpiAmountMicros":"kpiAmountMicros"},"campaignId":"campaignId","displayName":"displayName","insertionOrderId":"insertionOrderId","updateTime":"updateTime","integrationDetails":{"integrationCode":"integrationCode","details":"details"},"advertiserId":"advertiserId","pacing":{"pacingType":"PACING_TYPE_UNSPECIFIED","pacingPeriod":"PACING_PERIOD_UNSPECIFIED","dailyMaxImpressions":"dailyMaxImpressions","dailyMaxMicros":"dailyMaxMicros"},"entityStatus":"ENTITY_STATUS_UNSPECIFIED","name":"name","reservationType":"RESERVATION_TYPE_UNSPECIFIED","frequencyCap":{"maxImpressions":5,"maxViews":5,"unlimited":True,"timeUnitCount":2,"timeUnit":"TIME_UNIT_UNSPECIFIED"},"budget":{"budgetSegments":[{"campaignBudgetId":"campaignBudgetId","dateRange":{"endDate":{"month":6,"year":1,"day":0},"startDate":{"month":6,"year":1,"day":0}},"description":"description","budgetAmountMicros":"budgetAmountMicros"},{"campaignBudgetId":"campaignBudgetId","dateRange":{"endDate":{"month":6,"year":1,"day":0},"startDate":{"month":6,"year":1,"day":0}},"description":"description","budgetAmountMicros":"budgetAmountMicros"}],"budgetUnit":"BUDGET_UNIT_UNSPECIFIED","automationType":"INSERTION_ORDER_AUTOMATION_TYPE_UNSPECIFIED"}}
    params = [('$.xgafv', 'xgafv_example'),
                    ('access_token', 'access_token_example'),
                    ('alt', 'alt_example'),
                    ('callback', 'param_callback_example'),
    ...
    response = await client.request(
        method='POST',
        path='/v3/advertisers/{advertiser_id}/insertionOrders'.format(advertiser_id='advertiser_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_displayvideo_advertisers_insertion_orders_delete(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/v3/advertisers/{advertiser_id}/insertionOrders/{insertion_order_id}'.format(advertiser_id='advertiser_id_example', insertion_order_id='insertion_order_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_displayvideo_advertisers_insertion_orders_list_assigned_targeting_options(client):
    """Test case for displayvideo_advertisers_insertion_orders_list_assigned_targeting_options
    ...
    response = await client.request(
        method='GET',
        path='/v3/advertisers/{advertiser_id}/insertionOrders/{insertion_order_idlist_assigned_targeting_option}'.format(advertiser_id='advertiser_id_example', insertion_order_id='insertion_order_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_displayvideo_advertisers_insertion_orders_targeting_types_assigned_targeting_options_create(client):
    """Test case for displayvideo_advertisers_insertion_orders_targeting_types_assigned_targeting_options_create
    ...
    response = await client.request(
        method='POST',
        path='/v3/advertisers/{advertiser_id}/insertionOrders/{insertion_order_id}/targetingTypes/{targeting_type}/assignedTargetingOptions'.format(advertiser_id='advertiser_id_example', insertion_order_id='insertion_order_id_example', targeting_type='targeting_type_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_displayvideo_advertisers_insertion_orders_targeting_types_assigned_targeting_options_delete(client):
    """Test case for displayvideo_advertisers_insertion_orders_targeting_types_assigned_targeting_options_delete
...
async def test_displayvideo_advertisers_invoices_list(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/advertisers/{advertiser_id}/invoices'.format(advertiser_id='advertiser_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_displayvideo_advertisers_invoices_lookup_invoice_currency(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/advertisers/{advertiser_id}/invoices:lookupInvoiceCurrency'.format(advertiser_id='advertiser_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_displayvideo_advertisers_line_items_bulk_edit_assigned_targeting_options(client):
    """Test case for displayvideo_advertisers_line_items_bulk_edit_assigned_targeting_options

    
    """
    body = {"lineItemIds":["lineItemIds","lineItemIds"],"createRequests":[{"assignedTargetingOptions":[{"inheritance":"INHERITANCE_UNSPECIFIED","householdIncomeDetails":{"householdIncome":"HOUSEHOLD_INCOME_UNSPECIFIED"},"assignedTargetingOptionId":"assignedTargetingOptionId","inventorySourceGroupDetails":{"inventorySourceGroupId":"inventorySourceGroupId"},"channelDetails":{"negative":True,"channelId":"channelId"},"omidDetails":{"omid":"OMID_UNSPECIFIED"},"contentInstreamPositionDetails":{"adType":"AD_TYPE_UNSPECIFIED","contentInstreamPosition":"CONTENT_INSTREAM_POSITION_UNSPECIFIED"},"browserDetails":{"negative":True,"displayName":"displayName","targetingOptionId":"targetingOptionId"},"audienceGroupDetails":{"includedGoogleAudienceGroup":{"settings":[{"googleAudienceId":"googleAudienceId"},{"googleAudienceId":"googleAudienceId"}]},"includedCustomListGroup":{"settings":[{"customListId":"customListId"},{"customListId":"customListId"}]},"includedCombinedAudienceGroup":{"settings":[{"combinedAudienceId":"combinedAudienceId"},{"combinedAudienceId":"combinedAudienceId"}]},"excludedGoogleAudienceGroup":{"settings":[{"googleAudienceId":"googleAudienceId"},{"googleAudienceId":"googleAudienceId"}]},"excludedFirstAndThirdPartyAudienceGroup":{"settings":[{"firstAndThirdPartyAudienceId":"firstAndThirdPartyAudienceId","recency":"RECENCY_NO_LIMIT"},{"firstAndThirdPartyAudienceId":"firstAndThirdPartyAudienceId","recency":"RECENCY_NO_LIMIT"}]},"includedFirstAndThirdPartyAudienceGroups":[{"settings":[{"firstAndThirdPartyAudienceId":"firstAndThirdPartyAudienceId","recency":"RECENCY_NO_LIMIT"},{"firstAndThirdPartyAudienceId":"firstAndThirdPartyAudienceId","recency":"RECENCY_NO_LIMIT"}]},{"settings":[{"firstAndThirdPartyAudienceId":"firstAndThirdPartyAudienceId","recency":"RECENCY_NO_LIMIT"},{"firstAndThirdPartyAudienceId":"firstAndThirdPartyAudienceId","recency":"RECENCY_NO_LIMIT"}]}]},"nativeContentPositionDetails":{"contentPosition":"NATIVE_CONTENT_POSITION_UNSPECIFIED"},"dayAndTimeDetails":{"endHour":6,"dayOfWeek":"DAY_OF_WEEK_UNSPECIFIED","startHour":1,"timeZoneResolution":"TIME_ZONE_RESOLUTION_UNSPECIFIED"},"exchangeDetails":{"exchange":"EXCHANGE_UNSPECIFIED"},"keywordDetails":{"negative":True,"keyword":"keyword"},"targetingType":"TARGETING_TYPE_UNSPECIFIED","assignedTargetingOptionIdAlias":"assignedTargetingOptionIdAlias","deviceMakeModelDetails":{"negative":True,"displayName":"displayName","targetingOptionId":"targetingOptionId"},"digitalContentLabelExclusionDetails":{"excludedContentRatingTier":"CONTENT_RATING_TIER_UNSPECIFIED"},"poiDetails":{"proximityRadiusAmount":7.061401241503109,"proximityRadiusUnit":"DISTANCE_UNIT_UNSPECIFIED","displayName":"displayName","latitude":5.637376656633329,"targetingOptionId":"targetingOptionId","longitude":2.3021358869347655},"environmentDetails":{"environment":"ENVIRONMENT_UNSPECIFIED"},"subExchangeDetails":{"targetingOptionId":"targetingOptionId"},"appCategoryDetails":{"negative":True,"displayName":"displayName","targetingOptionId":"targetingOptionId"},"contentDurationDetails":{"contentDuration":"CONTENT_DURATION_UNSPECIFIED","targetingOptionId":"targetingOptionId"},"deviceTypeDetails":{"deviceType":"DEVICE_TYPE_UNSPECIFIED","youtubeAndPartnersBidMultiplier":5.962133916683182},"youtubeChannelDetails":{"negative":True,"channelId":"channelId"},"appDetails":{"negative":True,"appPlatform":"APP_PLATFORM_UNSPECIFIED","displayName":"displayName","appId":"appId"},"name":"name","viewabilityDetails":{"viewability":"VIEWABILITY_UNSPECIFIED"},"contentGenreDetails":{"negative":True,"displayName":"displayName","targetingOptionId":"targetingOptionId"},"authorizedSellerStatusDetails":{"targetingOptionId":"targetingOptionId","authorizedSellerStatus":"AUTHORIZED_SELLER_STATUS_UNSPECIFIED"},"contentStreamTypeDetails":{"contentStreamType":"CONTENT_STREAM_TYPE_UNSPECIFIED","targetingOptionId":"targetingOptionId"},"geoRegionDetails":{"negative":True,"displayName":"displayName","targetingOptionId":"targetingOptionId","geoRegionType":"GEO_REGION_TYPE_UNKNOWN"},"businessChainDetails":{"proximityRadiusAmount":0.8008281904610115,"proximityRadiusUnit":"DISTANCE_UNIT_UNSPECIFIED","displayName":"displayName","targetingOptionId":"targetingOptionId"},"parentalStatusDetails":{"parentalStatus":"PARENTAL_STATUS_UNSPECIFIED"},"negativeKeywordListDetails":{"negativeKeywordListId":"negativeKeywordListId"},"categoryDetails":{"negative":True,"displayName":"displayName","targetingOptionId":"targetingOptionId"},"urlDetails":{"negative":True,"url":"url"},"youtubeVideoDetails":{"negative":True,"videoId":"videoId"},"operatingSystemDetails":{"negative":True,"displayName":"displayName","targetingOptionId":"targetingOptionId"},"sensitiveCategoryExclusionDetails":{"excludedSensitiveCategory":"SENSITIVE_CATEGORY_UNSPECIFIED"},"proximityLocationListDetails":{"proximityRadiusUnit":"PROXIMITY_RADIUS_UNIT_UNSPECIFIED","proximityRadius":9.301444243932576,"proximityLocationListId":"proximityLocationListId"},"onScreenPositionDetails":{"adType":"AD_TYPE_UNSPECIFIED","targetingOptionId":"targetingOptionId","onScreenPosition":"ON_SCREEN_POSITION_UNSPECIFIED"},"contentOutstreamPositionDetails":{"adType":"AD_TYPE_UNSPECIFIED","contentOutstreamPosition":"CONTENT_OUTSTREAM_POSITION_UNSPECIFIED"},"audioContentTypeDetails":{"audioContentType":"AUDIO_CONTENT_TYPE_UNSPECIFIED"},"genderDetails":{"gender":"GENDER_UNSPECIFIED"},"inventorySourceDetails":{"inventorySourceId":"inventorySourceId"},"languageDetails":{"negative":True,"displayName":"displayName","targetingOptionId":"targetingOptionId"},"thirdPartyVerifierDetails":{"doubleVerify":{"appStarRating":{"avoidInsufficientStarRating":True,"avoidedStarRating":"APP_STAR_RATE_UNSPECIFIED"},"customSegmentId":"customSegmentId","brandSafetyCategories":{"avoidUnknownBrandSafetyCategory":True,"avoidedMediumSeverityCategories":["MEDIUM_SEVERITY_UNSPECIFIED","MEDIUM_SEVERITY_UNSPECIFIED"],"avoidedHighSeverityCategories":["HIGHER_SEVERITY_UNSPECIFIED","HIGHER_SEVERITY_UNSPECIFIED"]},"fraudInvalidTraffic":{"avoidInsufficientOption":True,"avoidedFraudOption":"FRAUD_UNSPECIFIED"},"avoidedAgeRatings":["AGE_RATING_UNSPECIFIED","AGE_RATING_UNSPECIFIED"],"videoViewability":{"videoViewableRate":"VIDEO_VIEWABLE_RATE_UNSPECIFIED","playerImpressionRate":"PLAYER_SIZE_400X300_UNSPECIFIED","videoIab":"VIDEO_IAB_UNSPECIFIED"},"displayViewability":{"viewableDuring":"AVERAGE_VIEW_DURATION_UNSPECIFIED","iab":"IAB_VIEWED_RATE_UNSPECIFIED"}},"adloox":{"excludedAdlooxCategories":["ADLOOX_UNSPECIFIED","ADLOOX_UNSPECIFIED"]},"integralAdScience":{"excludeUnrateable":True,"excludedViolenceRisk":"VIOLENCE_UNSPECIFIED","excludedIllegalDownloadsRisk":"ILLEGAL_DOWNLOADS_UNSPECIFIED","excludedOffensiveLanguageRisk":"OFFENSIVE_LANGUAGE_UNSPECIFIED","videoViewability":"VIDEO_VIEWABILITY_UNSPECIFIED","excludedGamblingRisk":"GAMBLING_UNSPECIFIED","displayViewability":"PERFORMANCE_VIEWABILITY_UNSPECIFIED","customSegmentId":["customSegmentId","customSegmentId"],"excludedDrugsRisk":"DRUGS_UNSPECIFIED","excludedAlcoholRisk":"ALCOHOL_UNSPECIFIED","excludedHateSpeechRisk":"HATE_SPEECH_UNSPECIFIED","excludedAdFraudRisk":"SUSPICIOUS_ACTIVITY_UNSPECIFIED","traqScoreOption":"TRAQ_UNSPECIFIED","excludedAdultRisk":"ADULT_UNSPECIFIED"}},"sessionPositionDetails":{"sessionPosition":"SESSION_POSITION_UNSPECIFIED"},"videoPlayerSizeDetails":{"videoPlayerSize":"VIDEO_PLAYER_SIZE_UNSPECIFIED"},"carrierAndIspDetails":{"negative":True,"displayName":"displayName","targetingOptionId":"targetingOptionId"},"userRewardedContentDetails":{"targetingOptionId":"targetingOptionId","userRewardedContent":"USER_REWARDED_CONTENT_UNSPECIFIED"},"ageRangeDetails":{"ageRange":"AGE_RANGE_UNSPECIFIED"},"regionalLocationListDetails":{"negative":True,"regionalLocationListId":"regionalLocationListId"}},{"inheritance":"INHERITANCE_UNSPECIFIED","householdIncomeDetails":{"householdIncome":"HOUSEHOLD_INCOME_UNSPECIFIED"},"assignedTargetingOptionId":"assignedTargetingOptionId","inventorySourceGroupDetails":{"inventorySourceGroupId":"inventorySourceGroupId"},"channelDetails":{"negative":True,"channelId":"channelId"},"omidDetails":{"omid":"OMID_UNSPECIFIED"},"contentInstreamPositionDetails":{"adType":"AD_TYPE_UNSPECIFIED","contentInstreamPosition":"CONTENT_INSTREAM_POSITION_UNSPECIFIED"},"browserDetails":{"negative":True,"displayName":"displayName","targetingOptionId":"targetingOptionId"},"audienceGroupDetails":{"includedGoogleAudienceGroup":{"settings":[{"googleAudienceId":"googleAudienceId"},{"googleAudienceId":"googleAudienceId"}]},"includedCustomListGroup":{"settings":[{"customListId":"customListId"},{"customListId":"customListId"}]},"includedCombinedAudienceGroup":{"settings":[{"combinedAudienceId":"combinedAudienceId"},{"combinedAudienceId":"combinedAudienceId"}]},"excludedGoogleAudienceGroup":{"settings":[{"googleAudienceId":"googleAudienceId"},{"googleAudienceId":"googleAudienceId"}]},"excludedFirstAndThirdPartyAudienceGroup":{"settings":[{"firstAndThirdPartyAudienceId":"firstAndThirdPartyAudienceId","recency":"RECENCY_NO_LIMIT"},{"firstAndThirdPartyAudienceId":"firstAndThirdPartyAudienceId","recency":"RECENCY_NO_LIMIT"}]},"includedFirstAndThirdPartyAudienceGroups":[{"settings":[{"firstAndThirdPartyAudienceId":"firstAndThirdPartyAudienceId","recency":"RECENCY_NO_LIMIT"},{"firstAndThirdPartyAudienceId":"firstAndThirdPartyAudienceId","recency":"RECENCY_NO_LIMIT"}]},{"settings":[{"firstAndThirdPartyAudienceId":"firstAndThirdPartyAudienceId","recency":"RECENCY_NO_LIMIT"},{"firstAndThirdPartyAudienceId":"firstAndThirdPartyAudienceId","recency":"RECENCY_NO_LIMIT"}]}]},"nativeContentPositionDetails":{"contentPosition":"NATIVE_CONTENT_POSITION_UNSPECIFIED"},"dayAndTimeDetails":{"endHour":6,"dayOfWeek":"DAY_OF_WEEK_UNSPECIFIED","startHour":1,"timeZoneResolution":"TIME_ZONE_RESOLUTION_UNSPECIFIED"},"exchangeDetails":{"exchange":"EXCHANGE_UNSPECIFIED"},"keywordDetails":{"negative":True,"keyword":"keyword"},"targetingType":"TARGETING_TYPE_UNSPECIFIED","assignedTargetingOptionIdAlias":"assignedTargetingOptionIdAlias","deviceMakeModelDetails":{"negative":True,"displayName":"displayName","targetingOptionId":"targetingOptionId"},"digitalContentLabelExclusionDetails":{"excludedContentRatingTier":"CONTENT_RATING_TIER_UNSPECIFIED"},"poiDetails":{"proximityRadiusAmount":7.061401241503109,"proximityRadiusUnit":"DISTANCE_UNIT_UNSPECIFIED","displayName":"displayName","latitude":5.637376656633329,"targetingOptionId":"targetingOptionId","longitude":2.3021358869347655},"environmentDetails":{"environment":"ENVIRONMENT_UNSPECIFIED"},"subExchangeDetails":{"targetingOptionId":"targetingOptionId"},"appCategoryDetails":{"negative":True,"displayName":"displayName","targetingOptionId":"targetingOptionId"},"contentDurationDetails":{"contentDuration":"CONTENT_DURATION_UNSPECIFIED","targetingOptionId":"targetingOptionId"},"deviceTypeDetails":{"deviceType":"DEVICE_TYPE_UNSPECIFIED","youtubeAndPartnersBidMultiplier":5.962133916683182},"youtubeChannelDetails":{"negative":True,"channelId":"channelId"},"appDetails":{"negative":True,"appPlatform":"APP_PLATFORM_UNSPECIFIED","displayName":"displayName","appId":"appId"},"name":"name","viewabilityDetails":{"viewability":"VIEWABILITY_UNSPECIFIED"},"contentGenreDetails":{"negative":True,"displayName":"displayName","targetingOptionId":"targetingOptionId"},"authorizedSellerStatusDetails":{"targetingOptionId":"targetingOptionId","authorizedSellerStatus":"AUTHORIZED_SELLER_STATUS_UNSPECIFIED"},"contentStreamTypeDetails":{"contentStreamType":"CONTENT_STREAM_TYPE_UNSPECIFIED","targetingOptionId":"targetingOptionId"},"geoRegionDetails":{"negative":True,"displayName":"displayName","targetingOptionId":"targetingOptionId","geoRegionType":"GEO_REGION_TYPE_UNKNOWN"},"businessChainDetails":{"proximityRadiusAmount":0.8008281904610115,"proximityRadiusUnit":"DISTANCE_UNIT_UNSPECIFIED","displayName":"displayName","targetingOptionId":"targetingOptionId"},"parentalStatusDetails":{"parentalStatus":"PARENTAL_STATUS_UNSPECIFIED"},"negativeKeywordListDetails":{"negativeKeywordListId":"negativeKeywordListId"},"categoryDetails":{"negative":True,"displayName":"displayName","targetingOptionId":"targetingOptionId"},"urlDetails":{"negative":True,"url":"url"},"youtubeVideoDetails":{"negative":True,"videoId":"videoId"},"operatingSystemDetails":{"negative":True,"displayName":"displayName","targetingOptionId":"targetingOptionId"},"sensitiveCategoryExclusionDetails":{"excludedSensitiveCategory":"SENSITIVE_CATEGORY_UNSPECIFIED"},"proximityLocationListDetails":{"proximityRadiusUnit":"PROXIMITY_RADIUS_UNIT_UNSPECIFIED","proximityRadius":9.301444243932576,"proximityLocationListId":"proximityLocationListId"},"onScreenPositionDetails":{"adType":"AD_TYPE_UNSPECIFIED","targetingOptionId":"targetingOptionId","onScreenPosition":"ON_SCREEN_POSITION_UNSPECIFIED"},"contentOutstreamPositionDetails":{"adType":"AD_TYPE_UNSPECIFIED","contentOutstreamPosition":"CONTENT_OUTSTREAM_POSITION_UNSPECIFIED"},"audioContentTypeDetails":{"audioContentType":"AUDIO_CONTENT_TYPE_UNSPECIFIED"},"genderDetails":{"gender":"GENDER_UNSPECIFIED"},"inventorySourceDetails":{"inventorySourceId":"inventorySourceId"},"languageDetails":{"negative":True,"displayName":"displayName","targetingOptionId":"targetingOptionId"},"thirdPartyVerifierDetails":{"doubleVerify":{"appStarRating":{"avoidInsufficientStarRating":True,"avoidedStarRating":"APP_STAR_RATE_UNSPECIFIED"},"customSegmentId":"customSegmentId","brandSafetyCategories":{"avoidUnknownBrandSafetyCategory":True,"avoidedMediumSeverityCategories":["MEDIUM_SEVERITY_UNSPECIFIED","MEDIUM_SEVERITY_UNSPECIFIED"],"avoidedHighSeverityCategories":["HIGHER_SEVERITY_UNSPECIFIED","HIGHER_SEVERITY_UNSPECIFIED"]},"fraudInvalidTraffic":{"avoidInsufficientOption":True,"avoidedFraudOption":"FRAUD_UNSPECIFIED"},"avoidedAgeRatings":["AGE_RATING_UNSPECIFIED","AGE_RATING_UNSPECIFIED"],"videoViewability":{"videoViewableRate":"VIDEO_VIEWABLE_RATE_UNSPECIFIED","playerImpressionRate":"PLAYER_SIZE_400X300_UNSPECIFIED","videoIab":"VIDEO_IAB_UNSPECIFIED"},"displayViewability":{"viewableDuring":"AVERAGE_VIEW_DURATION_UNSPECIFIED","iab":"IAB_VIEWED_RATE_UNSPECIFIED"}},"adloox":{"excludedAdlooxCategories":["ADLOOX_UNSPECIFIED","ADLOOX_UNSPECIFIED"]},"integralAdScience":{"excludeUnrateable":True,"excludedViolenceRisk":"VIOLENCE_UNSPECIFIED","excludedIllegalDownloadsRisk":"ILLEGAL_DOWNLOADS_UNSPECIFIED","excludedOffensiveLanguageRisk":"OFFENSIVE_LANGUAGE_UNSPECIFIED","videoViewability":"VIDEO_VIEWABILITY_UNSPECIFIED","excludedGamblingRisk":"GAMBLING_UNSPECIFIED","displayViewability":"PERFORMANCE_VIEWABILITY_UNSPECIFIED","customSegmentId":["customSegmentId","customSegmentId"],"excludedDrugsRisk":"DRUGS_UNSPECIFIED","excludedAlcoholRisk":"ALCOHOL_UNSPECIFIED","excludedHateSpeechRisk":"HATE_SPEECH_UNSPECIFIED","excludedAdFraudRisk":"SUSPICIOUS_ACTIVITY_UNSPECIFIED","traqScoreOption":"TRAQ_UNSPECIFIED","excludedAdultRisk":"ADULT_UNSPECIFIED"}},"sessionPositionDetails":{"sessionPosition":"SESSION_POSITION_UNSPECIFIED"},"videoPlayerSizeDetails":{"videoPlayerSize":"VIDEO_PLAYER_SIZE_UNSPECIFIED"},"carrierAndIspDetails":{"negative":True,"displayName":"displayName","targetingOptionId":"targetingOptionId"},"userRewardedContentDetails":{"targetingOptionId":"targetingOptionId","userRewardedContent":"USER_REWARDED_CONTENT_UNSPECIFIED"},"ageRangeDetails":{"ageRange":"AGE_RANGE_UNSPECIFIED"},"regionalLocationListDetails":{"negative":True,"regionalLocationListId":"regionalLocationListId"}}],"targetingType":"TARGETING_TYPE_UNSPECIFIED"},{"assignedTargetingOptions":[{"inheritance":"INHERITANCE_UNSPECIFIED","householdIncomeDetails":{"householdIncome":"HOUSEHOLD_INCOME_UNSPECIFIED"},"assignedTargetingOptionId":"assignedTargetingOptionId","inventorySourceGroupDetails":{"inventorySourceGroupId":"inventorySourceGroupId"},"channelDetails":{"negative":True,"channelId":"channelId"},"omidDetails":{"omid":"OMID_UNSPECIFIED"},"contentInstreamPositionDetails":{"adType":"AD_TYPE_UNSPECIFIED","contentInstreamPosition":"CONTENT_INSTREAM_POSITION_UNSPECIFIED"},"browserDetails":{"negative":True,"displayName":"displayName","targetingOptionId":"targetingOptionId"},"audienceGroupDetails":{"includedGoogleAudienceGroup":{"settings":[{"googleAudienceId":"googleAudienceId"},{"googleAudienceId":"googleAudienceId"}]},"includedCustomListGroup":{"settings":[{"customListId":"customListId"},{"customListId":"customListId"}]},"includedCombinedAudienceGroup":{"settings":[{"combinedAudienceId":"combinedAudienceId"},{"combinedAudienceId":"combinedAudienceId"}]},"excludedGoogleAudienceGroup":{"settings":[{"googleAudienceId":"googleAudienceId"},{"googleAudienceId":"googleAudienceId"}]},"excludedFirstAndThirdPartyAudienceGroup":{"settings":[{"firstAndThirdPartyAudienceId":"firstAndThirdPartyAudienceId","recency":"RECENCY_NO_LIMIT"},{"firstAndThirdPartyAudienceId":"firstAndThirdPartyAudienceId","recency":"RECENCY_NO_LIMIT"}]},"includedFirstAndThirdPartyAudienceGroups":[{"settings":[{"firstAndThirdPartyAudienceId":"firstAndThirdPartyAudienceId","recency":"RECENCY_NO_LIMIT"},{"firstAndThirdPartyAudienceId":"firstAndThirdPartyAudienceId","recency":"RECENCY_NO_LIMIT"}]},{"settings":[{"firstAndThirdPartyAudienceId":"firstAndThirdPartyAudienceId","recency":"RECENCY_NO_LIMIT"},{"firstAndThirdPartyAudienceId":"firstAndThirdPartyAudienceId","recency":"RECENCY_NO_LIMIT"}]}]},"nativeContentPositionDetails":{"contentPosition":"NATIVE_CONTENT_POSITION_UNSPECIFIED"},"dayAndTimeDetails":{"endHour":6,"dayOfWeek":"DAY_OF_WEEK_UNSPECIFIED","startHour":1,"timeZoneResolution":"TIME_ZONE_RESOLUTION_UNSPECIFIED"},"exchangeDetails":{"exchange":"EXCHANGE_UNSPECIFIED"},"keywordDetails":{"negative":True,"keyword":"keyword"},"targetingType":"TARGETING_TYPE_UNSPECIFIED","assignedTargetingOptionIdAlias":"assignedTargetingOptionIdAlias","deviceMakeModelDetails":{"negative":True,"displayName":"displayName","targetingOptionId":"targetingOptionId"},"digitalContentLabelExclusionDetails":{"excludedContentRatingTier":"CONTENT_RATING_TIER_UNSPECIFIED"},"poiDetails":{"proximityRadiusAmount":7.061401241503109,"proximityRadiusUnit":"DISTANCE_UNIT_UNSPECIFIED","displayName":"displayName","latitude":5.637376656633329,"targetingOptionId":"targetingOptionId","longitude":2.3021358869347655},"environmentDetails":{"environment":"ENVIRONMENT_UNSPECIFIED"},"subExchangeDetails":{"targetingOptionId":"targetingOptionId"},"appCategoryDetails":{"negative":True,"displayName":"displayName","targetingOptionId":"targetingOptionId"},"contentDurationDetails":{"contentDuration":"CONTENT_DURATION_UNSPECIFIED","targetingOptionId":"targetingOptionId"},"deviceTypeDetails":{"deviceType":"DEVICE_TYPE_UNSPECIFIED","youtubeAndPartnersBidMultiplier":5.962133916683182},"youtubeChannelDetails":{"negative":True,"channelId":"channelId"},"appDetails":{"negative":True,"appPlatform":"APP_PLATFORM_UNSPECIFIED","displayName":"displayName","appId":"appId"},"name":"name","viewabilityDetails":{"viewability":"VIEWABILITY_UNSPECIFIED"},"contentGenreDetails":{"negative":True,"displayName":"displayName","targetingOptionId":"targetingOptionId"},"authorizedSellerStatusDetails":{"targetingOptionId":"targetingOptionId","authorizedSellerStatus":"AUTHORIZED_SELLER_STATUS_UNSPECIFIED"},"contentStreamTypeDetails":{"contentStreamType":"CONTENT_STREAM_TYPE_UNSPECIFIED","targetingOptionId":"targetingOptionId"},"geoRegionDetails":{"negative":True,"displayName":"displayName","targetingOptionId":"targetingOptionId","geoRegionType":"GEO_REGION_TYPE_UNKNOWN"},"businessChainDetails":{"proximityRadiusAmount":0.8008281904610115,"proximityRadiusUnit":"DISTANCE_UNIT_UNSPECIFIED","displayName":"displayName","targetingOptionId":"targetingOptionId"},"parentalStatusDetails":{"parentalStatus":"PARENTAL_STATUS_UNSPECIFIED"},"negativeKeywordListDetails":{"negativeKeywordListId":"negativeKeywordListId"},"categoryDetails":{"negative":True,"displayName":"displayName","targetingOptionId":"targetingOptionId"},"urlDetails":{"negative":True,"url":"url"},"youtubeVideoDetails":{"negative":True,"videoId":"videoId"},"operatingSystemDetails":{"negative":True,"displayName":"displayName","targetingOptionId":"targetingOptionId"},"sensitiveCategoryExclusionDetails":{"excludedSensitiveCategory":"SENSITIVE_CATEGORY_UNSPECIFIED"},"proximityLocationListDetails":{"proximityRadiusUnit":"PROXIMITY_RADIUS_UNIT_UNSPECIFIED","proximityRadius":9.301444243932576,"proximityLocationListId":"proximityLocationListId"},"onScreenPositionDetails":{"adType":"AD_TYPE_UNSPECIFIED","targetingOptionId":"targetingOptionId","onScreenPosition":"ON_SCREEN_POSITION_UNSPECIFIED"},"contentOutstreamPositionDetails":{"adType":"AD_TYPE_UNSPECIFIED","contentOutstreamPosition":"CONTENT_OUTSTREAM_POSITION_UNSPECIFIED"},"audioContentTypeDetails":{"audioContentType":"AUDIO_CONTENT_TYPE_UNSPECIFIED"},"genderDetails":{"gender":"GENDER_UNSPECIFIED"},"inventorySourceDetails":{"inventorySourceId":"inventorySourceId"},"languageDetails":{"negative":True,"displayName":"displayName","targetingOptionId":"targetingOptionId"},"thirdPartyVerifierDetails":{"doubleVerify":{"appStarRating":{"avoidInsufficientStarRating":True,"avoidedStarRating":"APP_STAR_RATE_UNSPECIFIED"},"customSegmentId":"customSegmentId","brandSafetyCategories":{"avoidUnknownBrandSafetyCategory":True,"avoidedMediumSeverityCategories":["MEDIUM_SEVERITY_UNSPECIFIED","MEDIUM_SEVERITY_UNSPECIFIED"],"avoidedHighSeverityCategories":["HIGHER_SEVERITY_UNSPECIFIED","HIGHER_SEVERITY_UNSPECIFIED"]},"fraudInvalidTraffic":{"avoidInsufficientOption":True,"avoidedFraudOption":"FRAUD_UNSPECIFIED"},"avoidedAgeRatings":["AGE_RATING_UNSPECIFIED","AGE_RATING_UNSPECIFIED"],"videoViewability":{"videoViewableRate":"VIDEO_VIEWABLE_RATE_UNSPECIFIED","playerImpressionRate":"PLAYER_SIZE_400X300_UNSPECIFIED","videoIab":"VIDEO_IAB_UNSPECIFIED"},"displayViewability":{"viewableDuring":"AVERAGE_VIEW_DURATION_UNSPECIFIED","iab":"IAB_VIEWED_RATE_UNSPECIFIED"}},"adloox":{"excludedAdlooxCategories":["ADLOOX_UNSPECIFIED","ADLOOX_UNSPECIFIED"]},"integralAdScience":{"excludeUnrateable":True,"excludedViolenceRisk":"VIOLENCE_UNSPECIFIED","excludedIllegalDownloadsRisk":"ILLEGAL_DOWNLOADS_UNSPECIFIED","excludedOffensiveLanguageRisk":"OFFENSIVE_LANGUAGE_UNSPECIFIED","videoViewability":"VIDEO_VIEWABILITY_UNSPECIFIED","excludedGamblingRisk":"GAMBLING_UNSPECIFIED","displayViewability":"PERFORMANCE_VIEWABILITY_UNSPECIFIED","customSegmentId":["customSegmentId","customSegmentId"],"excludedDrugsRisk":"DRUGS_UNSPECIFIED","excludedAlcoholRisk":"ALCOHOL_UNSPECIFIED","excludedHateSpeechRisk":"HATE_SPEECH_UNSPECIFIED","excludedAdFraudRisk":"SUSPICIOUS_ACTIVITY_UNSPECIFIED","traqScoreOption":"TRAQ_UNSPECIFIED","excludedAdultRisk":"ADULT_UNSPECIFIED"}},"sessionPositionDetails":{"sessionPosition":"SESSION_POSITION_UNSPECIFIED"},"videoPlayerSizeDetails":{"videoPlayerSize":"VIDEO_PLAYER_SIZE_UNSPECIFIED"},"carrierAndIspDetails":{"negative":True,"displayName":"displayName","targetingOptionId":"targetingOptionId"},"userRewardedContentDetails":{"targetingOptionId":"targetingOptionId","userRewardedContent":"USER_REWARDED_CONTENT_UNSPECIFIED"},"ageRangeDetails":{"ageRange":"AGE_RANGE_UNSPECIFIED"},"regionalLocationListDetails":{"negative":True,"regionalLocationListId":"regionalLocationListId"}},{"inheritance":"INHERITANCE_UNSPECIFIED","householdIncomeDetails":{"householdIncome":"HOUSEHOLD_INCOME_UNSPECIFIED"},"assignedTargetingOptionId":"assignedTargetingOptionId","inventorySourceGroupDetails":{"inventorySourceGroupId":"inventorySourceGroupId"},"channelDetails":{"negative":True,"channelId":"channelId"},"omidDetails":{"omid":"OMID_UNSPECIFIED"},"contentInstreamPositionDetails":{"adType":"AD_TYPE_UNSPECIFIED","contentInstreamPosition":"CONTENT_INSTREAM_POSITION_UNSPECIFIED"},"browserDetails":{"negative":True,"displayName":"displayName","targetingOptionId":"targetingOptionId"},"audienceGroupDetails":{"includedGoogleAudienceGroup":{"settings":[{"googleAudienceId":"googleAudienceId"},{"googleAudienceId":"googleAudienceId"}]},"includedCustomListGroup":{"settings":[{"customListId":"customListId"},{"customListId":"customListId"}]},"includedCombinedAudienceGroup":{"settings":[{"combinedAudienceId":"combinedAudienceId"},{"combinedAudienceId":"combinedAudienceId"}]},"excludedGoogleAudienceGroup":{"settings":[{"googleAudienceId":"googleAudienceId"},{"googleAudienceId":"googleAudienceId"}]},"excludedFirstAndThirdPartyAudienceGroup":{"settings":[{"firstAndThirdPartyAudienceId":"firstAndThirdPartyAudienceId","recency":"RECENCY_NO_LIMIT"},{"firstAndThirdPartyAudienceId":"firstAndThirdPartyAudienceId","recency":"RECENCY_NO_LIMIT"}]},"includedFirstAndThirdPartyAudienceGroups":[{"settings":[{"firstAndThirdPartyAudienceId":"firstAndThirdPartyAudienceId","recency":"RECENCY_NO_LIMIT"},{"firstAndThirdPartyAudienceId":"firstAndThirdPartyAudienceId","recency":"RECENCY_NO_LIMIT"}]},{"settings":[{"firstAndThirdPartyAudienceId":"firstAndThirdPartyAudienceId","recency":"RECENCY_NO_LIMIT"},{"firstAndThirdPartyAudienceId":"firstAndThirdPartyAudienceId","recency":"RECENCY_NO_LIMIT"}]}]},"nativeContentPositionDetails":{"contentPosition":"NATIVE_CONTENT_POSITION_UNSPECIFIED"},"dayAndTimeDetails":{"endHour":6,"dayOfWeek":"DAY_OF_WEEK_UNSPECIFIED","startHour":1,"timeZoneResolution":"TIME_ZONE_RESOLUTION_UNSPECIFIED"},"exchangeDetails":{"exchange":"EXCHANGE_UNSPECIFIED"},"keywordDetails":{"negative":True,"keyword":"keyword"},"targetingType":"TARGETING_TYPE_UNSPECIFIED","assignedTargetingOptionIdAlias":"assignedTargetingOptionIdAlias","deviceMakeModelDetails":{"negative":True,"displayName":"displayName","targetingOptionId":"targetingOptionId"},"digitalContentLabelExclusionDetails":{"excludedContentRatingTier":"CONTENT_RATING_TIER_UNSPECIFIED"},"poiDetails":{"proximityRadiusAmount":7.061401241503109,"proximityRadiusUnit":"DISTANCE_UNIT_UNSPECIFIED","displayName":"displayName","latitude":5.637376656633329,"targetingOptionId":"targetingOptionId","longitude":2.3021358869347655},"environmentDetails":{"environment":"ENVIRONMENT_UNSPECIFIED"},"subExchangeDetails":{"targetingOptionId":"targetingOptionId"},"appCategoryDetails":{"negative":True,"displayName":"displayName","targetingOptionId":"targetingOptionId"},"contentDurationDetails":{"contentDuration":"CONTENT_DURATION_UNSPECIFIED","targetingOptionId":"targetingOptionId"},"deviceTypeDetails":{"deviceType":"DEVICE_TYPE_UNSPECIFIED","youtubeAndPartnersBidMultiplier":5.962133916683182},"youtubeChannelDetails":{"negative":True,"channelId":"channelId"},"appDetails":{"negative":True,"appPlatform":"APP_PLATFORM_UNSPECIFIED","displayName":"displayName","appId":"appId"},"name":"name","viewabilityDetails":{"viewability":"VIEWABILITY_UNSPECIFIED"},"contentGenreDetails":{"negative":True,"displayName":"displayName","targetingOptionId":"targetingOptionId"},"authorizedSellerStatusDetails":{"targetingOptionId":"targetingOptionId","authorizedSellerStatus":"AUTHORIZED_SELLER_STATUS_UNSPECIFIED"},"contentStreamTypeDetails":{"contentStreamType":"CONTENT_STREAM_TYPE_UNSPECIFIED","targetingOptionId":"targetingOptionId"},"geoRegionDetails":{"negative":True,"displayName":"displayName","targetingOptionId":"targetingOptionId","geoRegionType":"GEO_REGION_TYPE_UNKNOWN"},"businessChainDetails":{"proximityRadiusAmount":0.8008281904610115,"proximityRadiusUnit":"DISTANCE_UNIT_UNSPECIFIED","displayName":"displayName","targetingOptionId":"targetingOptionId"},"parentalStatusDetails":{"parentalStatus":"PARENTAL_STATUS_UNSPECIFIED"},"negativeKeywordListDetails":{"negativeKeywordListId":"negativeKeywordListId"},"categoryDetails":{"negative":True,"displayName":"displayName","targetingOptionId":"targetingOptionId"},"urlDetails":{"negative":True,"url":"url"},"youtubeVideoDetails":{"negative":True,"videoId":"videoId"},"operatingSystemDetails":{"negative":True,"displayName":"displayName","targetingOptionId":"targetingOptionId"},"sensitiveCategoryExclusionDetails":{"excludedSensitiveCategory":"SENSITIVE_CATEGORY_UNSPECIFIED"},"proximityLocationListDetails":{"proximityRadiusUnit":"PROXIMITY_RADIUS_UNIT_UNSPECIFIED","proximityRadius":9.301444243932576,"proximityLocationListId":"proximityLocationListId"},"onScreenPositionDetails":{"adType":"AD_TYPE_UNSPECIFIED","targetingOptionId":"targetingOptionId","onScreenPosition":"ON_SCREEN_POSITION_UNSPECIFIED"},"contentOutstreamPositionDetails":{"adType":"AD_TYPE_UNSPECIFIED","contentOutstreamPosition":"CONTENT_OUTSTREAM_POSITION_UNSPECIFIED"},"audioContentTypeDetails":{"audioContentType":"AUDIO_CONTENT_TYPE_UNSPECIFIED"},"genderDetails":{"gender":"GENDER_UNSPECIFIED"},"inventorySourceDetails":{"inventorySourceId":"inventorySourceId"},"languageDetails":{"negative":True,"displayName":"displayName","targetingOptionId":"targetingOptionId"},"thirdPartyVerifierDetails":{"doubleVerify":{"appStarRating":{"avoidInsufficientStarRating":True,"avoidedStarRating":"APP_STAR_RATE_UNSPECIFIED"},"customSegmentId":"customSegmentId","brandSafetyCategories":{"avoidUnknownBrandSafetyCategory":True,"avoidedMediumSeverityCategories":["MEDIUM_SEVERITY_UNSPECIFIED","MEDIUM_SEVERITY_UNSPECIFIED"],"avoidedHighSeverityCategories":["HIGHER_SEVERITY_UNSPECIFIED","HIGHER_SEVERITY_UNSPECIFIED"]},"fraudInvalidTraffic":{"avoidInsufficientOption":True,"avoidedFraudOption":"FRAUD_UNSPECIFIED"},"avoidedAgeRatings":["AGE_RATING_UNSPECIFIED","AGE_RATING_UNSPECIFIED"],"videoViewability":{"videoViewableRate":"VIDEO_VIEWABLE_RATE_UNSPECIFIED","playerImpressionRate":"PLAYER_SIZE_400X300_UNSPECIFIED","videoIab":"VIDEO_IAB_UNSPECIFIED"},"displayViewability":{"viewableDuring":"AVERAGE_VIEW_DURATION_UNSPECIFIED","iab":"IAB_VIEWED_RATE_UNSPECIFIED"}},"adloox":{"excludedAdlooxCategories":["ADLOOX_UNSPECIFIED","ADLOOX_UNSPECIFIED"]},"integralAdScience":{"excludeUnrateable":True,"excludedViolenceRisk":"VIOLENCE_UNSPECIFIED","excludedIllegalDownloadsRisk":"ILLEGAL_DOWNLOADS_UNSPECIFIED","excludedOffensiveLanguageRisk":"OFFENSIVE_LANGUAGE_UNSPECIFIED","videoViewability":"VIDEO_VIEWABILITY_UNSPECIFIED","excludedGamblingRisk":"GAMBLING_UNSPECIFIED","displayViewability":"PERFORMANCE_VIEWABILITY_UNSPECIFIED","customSegmentId":["customSegmentId","customSegmentId"],"excludedDrugsRisk":"DRUGS_UNSPECIFIED","excludedAlcoholRisk":"ALCOHOL_UNSPECIFIED","excludedHateSpeechRisk":"HATE_SPEECH_UNSPECIFIED","excludedAdFraudRisk":"SUSPICIOUS_ACTIVITY_UNSPECIFIED","traqScoreOption":"TRAQ_UNSPECIFIED","excludedAdultRisk":"ADULT_UNSPECIFIED"}},"sessionPositionDetails":{"sessionPosition":"SESSION_POSITION_UNSPECIFIED"},"videoPlayerSizeDetails":{"videoPlayerSize":"VIDEO_PLAYER_SIZE_UNSPECIFIED"},"carrierAndIspDetails":{"negative":True,"displayName":"displayName","targetingOptionId":"targetingOptionId"},"userRewardedContentDetails":{"targetingOptionId":"targetingOptionId","userRewardedContent":"USER_REWARDED_CONTENT_UNSPECIFIED"},"ageRangeDetails":{"ageRange":"AGE_RANGE_UNSPECIFIED"},"regionalLocationListDetails":{"negative":True,"regionalLocationListId":"regionalLocationListId"}}],"targetingType":"TARGETING_TYPE_UNSPECIFIED"}],"deleteRequests":[{"targetingType":"TARGETING_TYPE_UNSPECIFIED","assignedTargetingOptionIds":["assignedTargetingOptionIds","assignedTargetingOptionIds"]},{"targetingType":"TARGETING_TYPE_UNSPECIFIED","assignedTargetingOptionIds":["assignedTargetingOptionIds","assignedTargetingOptionIds"]}]}
    params = [('$.xgafv', 'xgafv_example'),
                    ('access_token', 'access_token_example'),
                    ('alt', 'alt_example'),
                    ('callback', 'param_callback_example'),
    ...
    response = await client.request(
        method='POST',
        path='/v3/advertisers/{advertiser_id}/lineItems:bulkEditAssignedTargetingOptions'.format(advertiser_id='advertiser_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_displayvideo_advertisers_line_items_bulk_list_assigned_targeting_options(client):
    """Test case for displayvideo_advertisers_line_items_bulk_list_assigned_targeting_options
    ...
    params = [('$.xgafv', 'xgafv_example'),
                    ...
                    ('uploadType', 'upload_type_example'),
                    ('filter', 'filter_example'),
                    ('lineItemIds', ['line_item_ids_example']),
                    ('orderBy', 'order_by_example'),
                    ('pageSize', 56),
                    ('pageToken', 'page_token_example')]
    headers = { 
    ...
    response = await client.request(
        method='GET',
        path='/v3/advertisers/{advertiser_id}/lineItems:bulkListAssignedTargetingOptions'.format(advertiser_id='advertiser_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_displayvideo_advertisers_line_items_bulk_update(client):
    """Test case for displayvideo_advertisers_line_items_bulk_update

    
    """
    body = {"lineItemIds":["lineItemIds","lineItemIds"],"targetLineItem":{"bidStrategy":{"fixedBid":{"bidAmountMicros":"bidAmountMicros"},"youtubeAndPartnersBid":{"adGroupEffectiveTargetCpaSource":"BIDDING_SOURCE_UNSPECIFIED","adGroupEffectiveTargetCpaValue":"adGroupEffectiveTargetCpaValue","type":"YOUTUBE_AND_PARTNERS_BIDDING_STRATEGY_TYPE_UNSPECIFIED","value":"value"},"performanceGoalAutoBid":{"performanceGoalType":"BIDDING_STRATEGY_PERFORMANCE_GOAL_TYPE_UNSPECIFIED","customBiddingAlgorithmId":"customBiddingAlgorithmId","performanceGoalAmountMicros":"performanceGoalAmountMicros","maxAverageCpmBidAmountMicros":"maxAverageCpmBidAmountMicros"},"maximizeSpendAutoBid":{"raiseBidForDeals":True,"performanceGoalType":"BIDDING_STRATEGY_PERFORMANCE_GOAL_TYPE_UNSPECIFIED","customBiddingAlgorithmId":"customBiddingAlgorithmId","maxAverageCpmBidAmountMicros":"maxAverageCpmBidAmountMicros"}},"flight":{"dateRange":{"endDate":{"month":6,"year":1,"day":0},"startDate":{"month":6,"year":1,"day":0}},"flightDateType":"LINE_ITEM_FLIGHT_DATE_TYPE_UNSPECIFIED"},"partnerCosts":[{"feeAmount":"feeAmount","costType":"PARTNER_COST_TYPE_UNSPECIFIED","invoiceType":"PARTNER_COST_INVOICE_TYPE_UNSPECIFIED","feeType":"PARTNER_COST_FEE_TYPE_UNSPECIFIED","feePercentageMillis":"feePercentageMillis"},{"feeAmount":"feeAmount","costType":"PARTNER_COST_TYPE_UNSPECIFIED","invoiceType":"PARTNER_COST_INVOICE_TYPE_UNSPECIFIED","feeType":"PARTNER_COST_FEE_TYPE_UNSPECIFIED","feePercentageMillis":"feePercentageMillis"}],"displayName":"displayName","targetingExpansion":{"audienceExpansionSeedListExcluded":True,"enableOptimizedTargeting":True,"audienceExpansionLevel":"UNKNOWN"},"excludeNewExchanges":True,"lineItemType":"LINE_ITEM_TYPE_UNSPECIFIED","budget":{"budgetAllocationType":"LINE_ITEM_BUDGET_ALLOCATION_TYPE_UNSPECIFIED","budgetUnit":"BUDGET_UNIT_UNSPECIFIED","maxAmount":"maxAmount"},"warningMessages":["LINE_ITEM_WARNING_MESSAGE_UNSPECIFIED","LINE_ITEM_WARNING_MESSAGE_UNSPECIFIED"],"youtubeAndPartnersSettings":{"linkedMerchantId":"linkedMerchantId","viewFrequencyCap":{"maxImpressions":5,"maxViews":5,"unlimited":True,"timeUnitCount":2,"timeUnit":"TIME_UNIT_UNSPECIFIED"},"inventorySourceSettings":{"includeYoutube":True,"includeYoutubeVideoPartners":True,"includeGoogleTv":True},"targetFrequency":{"timeUnitCount":1,"targetCount":"targetCount","timeUnit":"TIME_UNIT_UNSPECIFIED"},"effectiveContentCategory":"YOUTUBE_AND_PARTNERS_CONTENT_CATEGORY_UNSPECIFIED","relatedVideoIds":["relatedVideoIds","relatedVideoIds"],"videoAdSequenceSettings":{"minimumDuration":"VIDEO_AD_SEQUENCE_MINIMUM_DURATION_UNSPECIFIED","steps":[{"interactionType":"INTERACTION_TYPE_UNSPECIFIED","stepId":"stepId","previousStepId":"previousStepId","adGroupId":"adGroupId"},{"interactionType":"INTERACTION_TYPE_UNSPECIFIED","stepId":"stepId","previousStepId":"previousStepId","adGroupId":"adGroupId"}]},"leadFormId":"leadFormId","thirdPartyMeasurementConfigs":{"viewabilityVendorConfigs":[{"placementId":"placementId","vendor":"THIRD_PARTY_VENDOR_UNSPECIFIED"},{"placementId":"placementId","vendor":"THIRD_PARTY_VENDOR_UNSPECIFIED"}],"brandSafetyVendorConfigs":[{"placementId":"placementId","vendor":"THIRD_PARTY_VENDOR_UNSPECIFIED"},{"placementId":"placementId","vendor":"THIRD_PARTY_VENDOR_UNSPECIFIED"}],"reachVendorConfigs":[{"placementId":"placementId","vendor":"THIRD_PARTY_VENDOR_UNSPECIFIED"},{"placementId":"placementId","vendor":"THIRD_PARTY_VENDOR_UNSPECIFIED"}],"brandLiftVendorConfigs":[{"placementId":"placementId","vendor":"THIRD_PARTY_VENDOR_UNSPECIFIED"},{"placementId":"placementId","vendor":"THIRD_PARTY_VENDOR_UNSPECIFIED"}]},"contentCategory":"YOUTUBE_AND_PARTNERS_CONTENT_CATEGORY_UNSPECIFIED"},"lineItemId":"lineItemId","partnerRevenueModel":{"markupAmount":"markupAmount","markupType":"PARTNER_REVENUE_MODEL_MARKUP_TYPE_UNSPECIFIED"},"campaignId":"campaignId","insertionOrderId":"insertionOrderId","mobileApp":{"displayName":"displayName","appId":"appId","publisher":"publisher","platform":"PLATFORM_UNSPECIFIED"},"conversionCounting":{"floodlightActivityConfigs":[{"postViewLookbackWindowDays":6,"floodlightActivityId":"floodlightActivityId","postClickLookbackWindowDays":0},{"postViewLookbackWindowDays":6,"floodlightActivityId":"floodlightActivityId","postClickLookbackWindowDays":0}],"postViewCountPercentageMillis":"postViewCountPercentageMillis"},"updateTime":"updateTime","creativeIds":["creativeIds","creativeIds"],"integrationDetails":{"integrationCode":"integrationCode","details":"details"},"advertiserId":"advertiserId","pacing":{"pacingType":"PACING_TYPE_UNSPECIFIED","pacingPeriod":"PACING_PERIOD_UNSPECIFIED","dailyMaxImpressions":"dailyMaxImpressions","dailyMaxMicros":"dailyMaxMicros"},"entityStatus":"ENTITY_STATUS_UNSPECIFIED","name":"name","reservationType":"RESERVATION_TYPE_UNSPECIFIED","frequencyCap":{"maxImpressions":5,"maxViews":5,"unlimited":True,"timeUnitCount":2,"timeUnit":"TIME_UNIT_UNSPECIFIED"}},"updateMask":"updateMask"}
    params = [('$.xgafv', 'xgafv_example'),
                    ('access_token', 'access_token_example'),
                    ('alt', 'alt_example'),
                    ('callback', 'param_callback_example'),
    ...
    response = await client.request(
        method='POST',
        path='/v3/advertisers/{advertiser_id}/lineItems:bulkUpdate'.format(advertiser_id='advertiser_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_displayvideo_advertisers_line_items_create(client):
    ...
    """
    body = {"bidStrategy":{"fixedBid":{"bidAmountMicros":"bidAmountMicros"},"youtubeAndPartnersBid":{"adGroupEffectiveTargetCpaSource":"BIDDING_SOURCE_UNSPECIFIED","adGroupEffectiveTargetCpaValue":"adGroupEffectiveTargetCpaValue","type":"YOUTUBE_AND_PARTNERS_BIDDING_STRATEGY_TYPE_UNSPECIFIED","value":"value"},"performanceGoalAutoBid":{"performanceGoalType":"BIDDING_STRATEGY_PERFORMANCE_GOAL_TYPE_UNSPECIFIED","customBiddingAlgorithmId":"customBiddingAlgorithmId","performanceGoalAmountMicros":"performanceGoalAmountMicros","maxAverageCpmBidAmountMicros":"maxAverageCpmBidAmountMicros"},"maximizeSpendAutoBid":{"raiseBidForDeals":True,"performanceGoalType":"BIDDING_STRATEGY_PERFORMANCE_GOAL_TYPE_UNSPECIFIED","customBiddingAlgorithmId":"customBiddingAlgorithmId","maxAverageCpmBidAmountMicros":"maxAverageCpmBidAmountMicros"}},"flight":{"dateRange":{"endDate":{"month":6,"year":1,"day":0},"startDate":{"month":6,"year":1,"day":0}},"flightDateType":"LINE_ITEM_FLIGHT_DATE_TYPE_UNSPECIFIED"},"partnerCosts":[{"feeAmount":"feeAmount","costType":"PARTNER_COST_TYPE_UNSPECIFIED","invoiceType":"PARTNER_COST_INVOICE_TYPE_UNSPECIFIED","feeType":"PARTNER_COST_FEE_TYPE_UNSPECIFIED","feePercentageMillis":"feePercentageMillis"},{"feeAmount":"feeAmount","costType":"PARTNER_COST_TYPE_UNSPECIFIED","invoiceType":"PARTNER_COST_INVOICE_TYPE_UNSPECIFIED","feeType":"PARTNER_COST_FEE_TYPE_UNSPECIFIED","feePercentageMillis":"feePercentageMillis"}],"displayName":"displayName","targetingExpansion":{"audienceExpansionSeedListExcluded":True,"enableOptimizedTargeting":True,"audienceExpansionLevel":"UNKNOWN"},"excludeNewExchanges":True,"lineItemType":"LINE_ITEM_TYPE_UNSPECIFIED","budget":{"budgetAllocationType":"LINE_ITEM_BUDGET_ALLOCATION_TYPE_UNSPECIFIED","budgetUnit":"BUDGET_UNIT_UNSPECIFIED","maxAmount":"maxAmount"},"warningMessages":["LINE_ITEM_WARNING_MESSAGE_UNSPECIFIED","LINE_ITEM_WARNING_MESSAGE_UNSPECIFIED"],"youtubeAndPartnersSettings":{"linkedMerchantId":"linkedMerchantId","viewFrequencyCap":{"maxImpressions":5,"maxViews":5,"unlimited":True,"timeUnitCount":2,"timeUnit":"TIME_UNIT_UNSPECIFIED"},"inventorySourceSettings":{"includeYoutube":True,"includeYoutubeVideoPartners":True,"includeGoogleTv":True},"targetFrequency":{"timeUnitCount":1,"targetCount":"targetCount","timeUnit":"TIME_UNIT_UNSPECIFIED"},"effectiveContentCategory":"YOUTUBE_AND_PARTNERS_CONTENT_CATEGORY_UNSPECIFIED","relatedVideoIds":["relatedVideoIds","relatedVideoIds"],"videoAdSequenceSettings":{"minimumDuration":"VIDEO_AD_SEQUENCE_MINIMUM_DURATION_UNSPECIFIED","steps":[{"interactionType":"INTERACTION_TYPE_UNSPECIFIED","stepId":"stepId","previousStepId":"previousStepId","adGroupId":"adGroupId"},{"interactionType":"INTERACTION_TYPE_UNSPECIFIED","stepId":"stepId","previousStepId":"previousStepId","adGroupId":"adGroupId"}]},"leadFormId":"leadFormId","thirdPartyMeasurementConfigs":{"viewabilityVendorConfigs":[{"placementId":"placementId","vendor":"THIRD_PARTY_VENDOR_UNSPECIFIED"},{"placementId":"placementId","vendor":"THIRD_PARTY_VENDOR_UNSPECIFIED"}],"brandSafetyVendorConfigs":[{"placementId":"placementId","vendor":"THIRD_PARTY_VENDOR_UNSPECIFIED"},{"placementId":"placementId","vendor":"THIRD_PARTY_VENDOR_UNSPECIFIED"}],"reachVendorConfigs":[{"placementId":"placementId","vendor":"THIRD_PARTY_VENDOR_UNSPECIFIED"},{"placementId":"placementId","vendor":"THIRD_PARTY_VENDOR_UNSPECIFIED"}],"brandLiftVendorConfigs":[{"placementId":"placementId","vendor":"THIRD_PARTY_VENDOR_UNSPECIFIED"},{"placementId":"placementId","vendor":"THIRD_PARTY_VENDOR_UNSPECIFIED"}]},"contentCategory":"YOUTUBE_AND_PARTNERS_CONTENT_CATEGORY_UNSPECIFIED"},"lineItemId":"lineItemId","partnerRevenueModel":{"markupAmount":"markupAmount","markupType":"PARTNER_REVENUE_MODEL_MARKUP_TYPE_UNSPECIFIED"},"campaignId":"campaignId","insertionOrderId":"insertionOrderId","mobileApp":{"displayName":"displayName","appId":"appId","publisher":"publisher","platform":"PLATFORM_UNSPECIFIED"},"conversionCounting":{"floodlightActivityConfigs":[{"postViewLookbackWindowDays":6,"floodlightActivityId":"floodlightActivityId","postClickLookbackWindowDays":0},{"postViewLookbackWindowDays":6,"floodlightActivityId":"floodlightActivityId","postClickLookbackWindowDays":0}],"postViewCountPercentageMillis":"postViewCountPercentageMillis"},"updateTime":"updateTime","creativeIds":["creativeIds","creativeIds"],"integrationDetails":{"integrationCode":"integrationCode","details":"details"},"advertiserId":"advertiserId","pacing":{"pacingType":"PACING_TYPE_UNSPECIFIED","pacingPeriod":"PACING_PERIOD_UNSPECIFIED","dailyMaxImpressions":"dailyMaxImpressions","dailyMaxMicros":"dailyMaxMicros"},"entityStatus":"ENTITY_STATUS_UNSPECIFIED","name":"name","reservationType":"RESERVATION_TYPE_UNSPECIFIED","frequencyCap":{"maxImpressions":5,"maxViews":5,"unlimited":True,"timeUnitCount":2,"timeUnit":"TIME_UNIT_UNSPECIFIED"}}
    params = [('$.xgafv', 'xgafv_example'),
                    ('access_token', 'access_token_example'),
                    ('alt', 'alt_example'),
                    ('callback', 'param_callback_example'),
    ...
    response = await client.request(
        method='POST',
        path='/v3/advertisers/{advertiser_id}/lineItems'.format(advertiser_id='advertiser_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_displayvideo_advertisers_line_items_delete(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/v3/advertisers/{advertiser_id}/lineItems/{line_item_id}'.format(advertiser_id='advertiser_id_example', line_item_id='line_item_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_displayvideo_advertisers_line_items_duplicate(client):
    """Test case for displayvideo_advertisers_line_items_duplicate

    
    """
    body = {"targetDisplayName":"targetDisplayName"}
    params = [('$.xgafv', 'xgafv_example'),
                    ('access_token', 'access_token_example'),
                    ('alt', 'alt_example'),
                    ('callback', 'param_callback_example'),
    ...
    response = await client.request(
        method='POST',
        path='/v3/advertisers/{advertiser_id}/lineItems/{line_item_idduplicat}'.format(advertiser_id='advertiser_id_example', line_item_id='line_item_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_displayvideo_advertisers_line_items_generate_default(client):
    ...
    response = await client.request(
        method='POST',
        path='/v3/advertisers/{advertiser_id}/lineItems:generateDefault'.format(advertiser_id='advertiser_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_displayvideo_advertisers_line_items_targeting_types_assigned_targeting_options_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v3/advertisers/{advertiser_id}/lineItems/{line_item_id}/targetingTypes/{targeting_type}/assignedTargetingOptions'.format(advertiser_id='advertiser_id_example', line_item_id='line_item_id_example', targeting_type='targeting_type_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_displayvideo_advertisers_list_assigned_targeting_options(client):
    """Test case for displayvideo_advertisers_list_assigned_targeting_options
    ...
    response = await client.request(
        method='GET',
        path='/v3/advertisers/{advertiser_idlist_assigned_targeting_option}'.format(advertiser_id='advertiser_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_displayvideo_advertisers_location_lists_assigned_locations_bulk_edit(client):
    ...
    response = await client.request(
        method='POST',
        path='/v3/advertisers/{advertiser_id}/locationLists/{location_list_id}/assignedLocations:bulkEdit'.format(advertiser_id='advertiser_id_example', location_list_id='location_list_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_displayvideo_advertisers_location_lists_assigned_locations_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v3/advertisers/{advertiser_id}/locationLists/{location_list_id}/assignedLocations'.format(advertiser_id='advertiser_id_example', location_list_id='location_list_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_displayvideo_advertisers_location_lists_assigned_locations_delete(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/v3/advertisers/{advertiser_id}/locationLists/{location_list_id}/assignedLocations/{assigned_location_id}'.format(advertiser_id='advertiser_id_example', location_list_id='location_list_id_example', assigned_location_id='assigned_location_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_displayvideo_advertisers_location_lists_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v3/advertisers/{advertiser_id}/locationLists'.format(advertiser_id='advertiser_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_displayvideo_advertisers_location_lists_patch(client):
    ...
    response = await client.request(
        method='PATCH',
        path='/v3/advertisers/{advertiser_id}/locationLists/{location_list_id}'.format(advertiser_id='advertiser_id_example', location_list_id='location_list_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_displayvideo_advertisers_negative_keyword_lists_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v3/advertisers/{advertiser_id}/negativeKeywordLists'.format(advertiser_id='advertiser_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_displayvideo_advertisers_negative_keyword_lists_negative_keywords_bulk_edit(client):
    ...
    response = await client.request(
        method='POST',
        path='/v3/advertisers/{advertiser_id}/negativeKeywordLists/{negative_keyword_list_id}/negativeKeywords:bulkEdit'.format(advertiser_id='advertiser_id_example', negative_keyword_list_id='negative_keyword_list_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_displayvideo_advertisers_negative_keyword_lists_negative_keywords_delete(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/v3/advertisers/{advertiser_id}/negativeKeywordLists/{negative_keyword_list_id}/negativeKeywords/{keyword_value}'.format(advertiser_id='advertiser_id_example', negative_keyword_list_id='negative_keyword_list_id_example', keyword_value='keyword_value_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_displayvideo_advertisers_negative_keyword_lists_negative_keywords_list(client):
    ...
    response = await client.request(
        method='GET',
        path='/v3/advertisers/{advertiser_id}/negativeKeywordLists/{negative_keyword_list_id}/negativeKeywords'.format(advertiser_id='advertiser_id_example', negative_keyword_list_id='negative_keyword_list_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_displayvideo_advertisers_negative_keyword_lists_negative_keywords_replace(client):
    ...
    response = await client.request(
        method='POST',
        path='/v3/advertisers/{advertiser_id}/negativeKeywordLists/{negative_keyword_list_id}/negativeKeywords:replace'.format(advertiser_id='advertiser_id_example', negative_keyword_list_id='negative_keyword_list_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_displayvideo_advertisers_negative_keyword_lists_patch(client):
    ...
    response = await client.request(
        method='PATCH',
        path='/v3/advertisers/{advertiser_id}/negativeKeywordLists/{negative_keyword_list_id}'.format(advertiser_id='advertiser_id_example', negative_keyword_list_id='negative_keyword_list_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_displayvideo_advertisers_targeting_types_assigned_targeting_options_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v3/advertisers/{advertiser_id}/targetingTypes/{targeting_type}/assignedTargetingOptions'.format(advertiser_id='advertiser_id_example', targeting_type='targeting_type_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_displayvideo_advertisers_targeting_types_assigned_targeting_options_delete(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/v3/advertisers/{advertiser_id}/targetingTypes/{targeting_type}/assignedTargetingOptions/{assigned_targeting_option_id}'.format(advertiser_id='advertiser_id_example', targeting_type='targeting_type_example', assigned_targeting_option_id='assigned_targeting_option_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
