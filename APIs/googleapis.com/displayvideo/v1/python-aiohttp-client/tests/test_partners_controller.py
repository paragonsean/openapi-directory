...
async def test_displayvideo_partners_bulk_edit_partner_assigned_targeting_options(client):
    """Test case for displayvideo_partners_bulk_edit_partner_assigned_targeting_options
    ...
    response = await client.request(
        method='POST',
        path='/v1/partners/{partner_idbulk_edit_partner_assigned_targeting_option}'.format(partner_id='partner_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_displayvideo_partners_channels_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/partners/{partner_id}/channels'.format(partner_id='partner_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_displayvideo_partners_channels_patch(client):
    ...
    response = await client.request(
        method='PATCH',
        path='/v1/partners/{partner_id}/channels/{channel_id}'.format(partner_id='partner_id_example', channel_id='channel_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_displayvideo_partners_channels_sites_bulk_edit(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/partners/{partner_id}/channels/{channel_id}/sites:bulkEdit'.format(partner_id='partner_id_example', channel_id='channel_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_displayvideo_partners_channels_sites_delete(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/v1/partners/{partner_id}/channels/{channel_id}/sites/{url_or_app_id}'.format(partner_id='partner_id_example', channel_id='channel_id_example', url_or_app_id='url_or_app_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_displayvideo_partners_channels_sites_list(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/partners/{partner_id}/channels/{channel_id}/sites'.format(partner_id='partner_id_example', channel_id='channel_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_displayvideo_partners_channels_sites_replace(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/partners/{partner_id}/channels/{channel_id}/sites:replace'.format(partner_id='partner_id_example', channel_id='channel_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_displayvideo_partners_get(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/partners/{partner_id}'.format(partner_id='partner_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_displayvideo_partners_targeting_types_assigned_targeting_options_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/partners/{partner_id}/targetingTypes/{targeting_type}/assignedTargetingOptions'.format(partner_id='partner_id_example', targeting_type='targeting_type_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_displayvideo_partners_targeting_types_assigned_targeting_options_delete(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/v1/partners/{partner_id}/targetingTypes/{targeting_type}/assignedTargetingOptions/{assigned_targeting_option_id}'.format(partner_id='partner_id_example', targeting_type='targeting_type_example', assigned_targeting_option_id='assigned_targeting_option_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
