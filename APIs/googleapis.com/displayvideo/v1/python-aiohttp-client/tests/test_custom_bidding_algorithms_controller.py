...
async def test_displayvideo_custom_bidding_algorithms_create(client):
    ...
    """
    body = {"customBiddingAlgorithmId":"customBiddingAlgorithmId","customBiddingAlgorithmType":"CUSTOM_BIDDING_ALGORITHM_TYPE_UNSPECIFIED","customBiddingAlgorithmState":"STATE_UNSPECIFIED","entityStatus":"ENTITY_STATUS_UNSPECIFIED","displayName":"displayName","name":"name","modelReadiness":[{"readinessState":"READINESS_STATE_UNSPECIFIED","advertiserId":"advertiserId"},{"readinessState":"READINESS_STATE_UNSPECIFIED","advertiserId":"advertiserId"}],"sharedAdvertiserIds":["sharedAdvertiserIds","sharedAdvertiserIds"],"partnerId":"partnerId","advertiserId":"advertiserId"}
...
async def test_displayvideo_custom_bidding_algorithms_get(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/customBiddingAlgorithms/{custom_bidding_algorithm_id}'.format(custom_bidding_algorithm_id='custom_bidding_algorithm_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_displayvideo_custom_bidding_algorithms_scripts_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/v1/customBiddingAlgorithms/{custom_bidding_algorithm_id}/scripts'.format(custom_bidding_algorithm_id='custom_bidding_algorithm_id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_displayvideo_custom_bidding_algorithms_scripts_get(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/customBiddingAlgorithms/{custom_bidding_algorithm_id}/scripts/{custom_bidding_script_id}'.format(custom_bidding_algorithm_id='custom_bidding_algorithm_id_example', custom_bidding_script_id='custom_bidding_script_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_displayvideo_custom_bidding_algorithms_upload_script(client):
    ...
    response = await client.request(
        method='GET',
        path='/v1/customBiddingAlgorithms/{custom_bidding_algorithm_idupload_scrip}'.format(custom_bidding_algorithm_id='custom_bidding_algorithm_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
