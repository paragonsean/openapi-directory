...
class Advertiser(Model):
    ...
    def __init__(self, ad_server_config: AdvertiserAdServerConfig=None, advertiser_id: str=None, creative_config: AdvertiserCreativeConfig=None, data_access_config: AdvertiserDataAccessConfig=None, display_name: str=None, entity_status: str=None, general_config: AdvertiserGeneralConfig=None, integration_details: IntegrationDetails=None, name: str=None, partner_id: str=None, prisma_enabled: bool=None, serving_config: AdvertiserTargetingConfig=None, update_time: str=None):
