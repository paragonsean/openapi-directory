...
class LineItem(Model):
    ...
    def __init__(self, advertiser_id: str=None, bid_strategy: BiddingStrategy=None, budget: LineItemBudget=None, campaign_id: str=None, conversion_counting: ConversionCountingConfig=None, creative_ids: List[str]=None, display_name: str=None, entity_status: str=None, exclude_new_exchanges: bool=None, flight: LineItemFlight=None, frequency_cap: FrequencyCap=None, insertion_order_id: str=None, integration_details: IntegrationDetails=None, inventory_source_ids: List[str]=None, line_item_id: str=None, line_item_type: str=None, mobile_app: MobileApp=None, name: str=None, pacing: Pacing=None, partner_costs: List[PartnerCost]=None, partner_revenue_model: PartnerRevenueModel=None, reservation_type: str=None, targeting_expansion: TargetingExpansionConfig=None, update_time: str=None, warning_messages: List[str]=None):
        ...
        :param inventory_source_ids: The inventory_source_ids of this LineItem.
    ...
    def inventory_source_ids(self):
        """Gets the inventory_source_ids of this LineItem.

        The IDs of the private inventory sources assigned to the line item.

        :return: The inventory_source_ids of this LineItem.
        :rtype: List[str]
        """
    ...
    def inventory_source_ids(self, inventory_source_ids):
        """Sets the inventory_source_ids of this LineItem.
