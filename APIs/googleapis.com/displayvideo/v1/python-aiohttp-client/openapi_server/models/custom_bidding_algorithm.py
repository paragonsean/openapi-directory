...
from openapi_server.models.custom_bidding_model_readiness_state import CustomBiddingModelReadinessState
...
class CustomBiddingAlgorithm(Model):
    ...
    def __init__(self, advertiser_id: str=None, custom_bidding_algorithm_id: str=None, custom_bidding_algorithm_state: str=None, custom_bidding_algorithm_type: str=None, display_name: str=None, entity_status: str=None, model_readiness: List[CustomBiddingModelReadinessState]=None, name: str=None, partner_id: str=None, shared_advertiser_ids: List[str]=None):
        ...
        :param custom_bidding_algorithm_state: The custom_bidding_algorithm_state of this CustomBiddingAlgorithm.
        ...
        :param model_readiness: The model_readiness of this CustomBiddingAlgorithm.
        ...
        self.openapi_types = {
            ...
            'custom_bidding_algorithm_state': str,
            'custom_bidding_algorithm_type': str,
            'display_name': str,
            'entity_status': str,
            'model_readiness': List[CustomBiddingModelReadinessState],
            'name': str,
            'partner_id': str,
        ...
        self.attribute_map = {
            ...
            'custom_bidding_algorithm_state': 'customBiddingAlgorithmState',
        ...
        self._custom_bidding_algorithm_state = custom_bidding_algorithm_state
    ...
    @property
    def custom_bidding_algorithm_state(self):
        """Gets the custom_bidding_algorithm_state of this CustomBiddingAlgorithm.

        Output only. The status of custom bidding algorithm.

        :return: The custom_bidding_algorithm_state of this CustomBiddingAlgorithm.
        :rtype: str
        """
        return self._custom_bidding_algorithm_state

    @custom_bidding_algorithm_state.setter
    def custom_bidding_algorithm_state(self, custom_bidding_algorithm_state):
        """Sets the custom_bidding_algorithm_state of this CustomBiddingAlgorithm.

        Output only. The status of custom bidding algorithm.

        :param custom_bidding_algorithm_state: The custom_bidding_algorithm_state of this CustomBiddingAlgorithm.
        :type custom_bidding_algorithm_state: str
        """
        allowed_values = ["STATE_UNSPECIFIED", "ENABLED", "DORMANT", "SUSPENDED"]  # noqa: E501
        if custom_bidding_algorithm_state not in allowed_values:
            raise ValueError(
                "Invalid value for `custom_bidding_algorithm_state` ({0}), must be one of {1}"
                .format(custom_bidding_algorithm_state, allowed_values)
            )
    ...
    def model_readiness(self):
        """Gets the model_readiness of this CustomBiddingAlgorithm.
        ...
        :return: The model_readiness of this CustomBiddingAlgorithm.
        :rtype: List[CustomBiddingModelReadinessState]
        """
        return self._model_readiness

    @model_readiness.setter
    def model_readiness(self, model_readiness):
        """Sets the model_readiness of this CustomBiddingAlgorithm.

        Output only. The state of custom bidding model readiness for each advertiser who has access. This field may only include the state of the queried advertiser if the algorithm [`owner`](/display-video/api/reference/rest/v1/customBiddingAlgorithms#CustomBiddingAlgorithm.FIELDS.oneof_owner) is a partner and is being retrieved using an advertiser [`accessor`](/display-video/api/reference/rest/v1/customBiddingAlgorithms/list#body.QUERY_PARAMETERS.oneof_accessor).

        :param model_readiness: The model_readiness of this CustomBiddingAlgorithm.
        :type model_readiness: List[CustomBiddingModelReadinessState]
        """
