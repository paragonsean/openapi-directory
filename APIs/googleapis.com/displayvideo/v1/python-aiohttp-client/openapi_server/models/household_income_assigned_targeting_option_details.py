...
class HouseholdIncomeAssignedTargetingOptionDetails(Model):
    ...
    def __init__(self, household_income: str=None, targeting_option_id: str=None):
        ...
        :param targeting_option_id: The targeting_option_id of this HouseholdIncomeAssignedTargetingOptionDetails.
        """
        self.openapi_types = {
    ...
    def targeting_option_id(self):
        """Gets the targeting_option_id of this HouseholdIncomeAssignedTargetingOptionDetails.

        Required. The targeting_option_id of a TargetingOption of type `TARGETING_TYPE_HOUSEHOLD_INCOME`.

        :return: The targeting_option_id of this HouseholdIncomeAssignedTargetingOptionDetails.
        :rtype: str
        """
    ...
    def targeting_option_id(self, targeting_option_id):
        """Sets the targeting_option_id of this HouseholdIncomeAssignedTargetingOptionDetails.
