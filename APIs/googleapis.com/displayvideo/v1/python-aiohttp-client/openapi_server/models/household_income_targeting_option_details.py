...
class HouseholdIncomeTargetingOptionDetails(Model):
    ...
    def __init__(self, household_income: str=None):
        """HouseholdIncomeTargetingOptionDetails - a model defined in OpenAPI

        :param household_income: The household_income of this HouseholdIncomeTargetingOptionDetails.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'HouseholdIncomeTargetingOptionDetails':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The HouseholdIncomeTargetingOptionDetails of this HouseholdIncomeTargetingOptionDetails.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def household_income(self):
        """Gets the household_income of this HouseholdIncomeTargetingOptionDetails.

        Output only. The household income of an audience.

        :return: The household_income of this HouseholdIncomeTargetingOptionDetails.
        :rtype: str
        """
    ...
    def household_income(self, household_income):
        """Sets the household_income of this HouseholdIncomeTargetingOptionDetails.
