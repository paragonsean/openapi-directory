...
export default class PartnersApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the displayvideoPartnersBulkEditPartnerAssignedTargetingOptions operation.
     * @callback module:api/PartnersApi~displayvideoPartnersBulkEditPartnerAssignedTargetingOptionsCallback
     ...
     * @param {module:api/PartnersApi~displayvideoPartnersBulkEditPartnerAssignedTargetingOptionsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/BulkEditPartnerAssignedTargetingOptionsResponse}
     */
    displayvideoPartnersBulkEditPartnerAssignedTargetingOptions(partnerId, opts, callback) {
      opts = opts || {};
      let postBody = opts['bulkEditPartnerAssignedTargetingOptionsRequest'];
      // verify the required parameter 'partnerId' is set
      if (partnerId === undefined || partnerId === null) {
        throw new Error("Missing the required parameter 'partnerId' when calling displayvideoPartnersBulkEditPartnerAssignedTargetingOptions");
      }
      ...
      return this.apiClient.callApi(
        '/v1/partners/{partnerId}:bulkEditPartnerAssignedTargetingOptions', 'POST',
    ...
    displayvideoPartnersChannelsCreate(partnerId, opts, callback) {
      ...
      return this.apiClient.callApi(
        '/v1/partners/{partnerId}/channels', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    displayvideoPartnersChannelsList(partnerId, opts, callback) {
      ...
      return this.apiClient.callApi(
        '/v1/partners/{partnerId}/channels', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    displayvideoPartnersChannelsPatch(partnerId, channelId, opts, callback) {
      ...
      let returnType = Channel;
      return this.apiClient.callApi(
        '/v1/partners/{partnerId}/channels/{channelId}', 'PATCH',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    displayvideoPartnersChannelsSitesBulkEdit(partnerId, channelId, opts, callback) {
      ...
      return this.apiClient.callApi(
        '/v1/partners/{partnerId}/channels/{channelId}/sites:bulkEdit', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    displayvideoPartnersChannelsSitesDelete(partnerId, channelId, urlOrAppId, opts, callback) {
      ...
      return this.apiClient.callApi(
        '/v1/partners/{partnerId}/channels/{channelId}/sites/{urlOrAppId}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    displayvideoPartnersChannelsSitesList(partnerId, channelId, opts, callback) {
      ...
      return this.apiClient.callApi(
        '/v1/partners/{partnerId}/channels/{channelId}/sites', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    displayvideoPartnersChannelsSitesReplace(partnerId, channelId, opts, callback) {
      ...
      return this.apiClient.callApi(
        '/v1/partners/{partnerId}/channels/{channelId}/sites:replace', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    displayvideoPartnersTargetingTypesAssignedTargetingOptionsCreate(partnerId, targetingType, opts, callback) {
      ...
      return this.apiClient.callApi(
        '/v1/partners/{partnerId}/targetingTypes/{targetingType}/assignedTargetingOptions', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    displayvideoPartnersTargetingTypesAssignedTargetingOptionsDelete(partnerId, targetingType, assignedTargetingOptionId, opts, callback) {
      ...
      let returnType = Object;
      return this.apiClient.callApi(
        '/v1/partners/{partnerId}/targetingTypes/{targetingType}/assignedTargetingOptions/{assignedTargetingOptionId}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    displayvideoPartnersTargetingTypesAssignedTargetingOptionsGet(partnerId, targetingType, assignedTargetingOptionId, opts, callback) {
      ...
      let returnType = AssignedTargetingOption;
      return this.apiClient.callApi(
        '/v1/partners/{partnerId}/targetingTypes/{targetingType}/assignedTargetingOptions/{assignedTargetingOptionId}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    displayvideoPartnersTargetingTypesAssignedTargetingOptionsList(partnerId, targetingType, opts, callback) {
      ...
      return this.apiClient.callApi(
        '/v1/partners/{partnerId}/targetingTypes/{targetingType}/assignedTargetingOptions', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
