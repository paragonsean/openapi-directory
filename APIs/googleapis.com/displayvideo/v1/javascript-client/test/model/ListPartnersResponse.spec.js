...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DisplayVideo360Api.ListPartnersResponse();
  });
  ...
  describe('ListPartnersResponse', function() {
    it('should create an instance of ListPartnersResponse', function() {
      // uncomment below and update the code to test ListPartnersResponse
      //var instance = new DisplayVideo360Api.ListPartnersResponse();
      //expect(instance).to.be.a(DisplayVideo360Api.ListPartnersResponse);
    });
