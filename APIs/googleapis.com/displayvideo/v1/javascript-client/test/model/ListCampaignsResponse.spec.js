...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DisplayVideo360Api.ListCampaignsResponse();
  });
  ...
  describe('ListCampaignsResponse', function() {
    it('should create an instance of ListCampaignsResponse', function() {
      ...
      //var instance = new DisplayVideo360Api.ListCampaignsResponse();
      //expect(instance).to.be.a(DisplayVideo360Api.ListCampaignsResponse);
    });
