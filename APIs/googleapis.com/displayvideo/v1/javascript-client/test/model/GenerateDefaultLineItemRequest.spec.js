...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DisplayVideo360Api.GenerateDefaultLineItemRequest();
  });
  ...
  describe('GenerateDefaultLineItemRequest', function() {
    it('should create an instance of GenerateDefaultLineItemRequest', function() {
      // uncomment below and update the code to test GenerateDefaultLineItemRequest
      //var instance = new DisplayVideo360Api.GenerateDefaultLineItemRequest();
      //expect(instance).to.be.a(DisplayVideo360Api.GenerateDefaultLineItemRequest);
    });
