...
(function(root, factory) {
  ...
  describe('PartnersApi', function() {
    describe('displayvideoPartnersBulkEditPartnerAssignedTargetingOptions', function() {
      it('should call displayvideoPartnersBulkEditPartnerAssignedTargetingOptions successfully', function(done) {
        //uncomment below and update the code to test displayvideoPartnersBulkEditPartnerAssignedTargetingOptions
        //instance.displayvideoPartnersBulkEditPartnerAssignedTargetingOptions(function(error) {
