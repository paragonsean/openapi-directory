...
> BulkEditPartnerAssignedTargetingOptionsResponse displayvideoPartnersBulkEditPartnerAssignedTargetingOptions(partnerId, opts)
...
apiInstance.displayvideoPartnersBulkEditPartnerAssignedTargetingOptions(partnerId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
