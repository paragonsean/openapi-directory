# DisplayVideo360Api.CampaignBudget
...
**budgetUnit** | **String** | Required. Immutable. Specifies whether the budget is measured in currency or impressions. | [optional] 
...
**externalBudgetSource** | **String** | Required. The external source of the budget. | [optional] 
...
* `UNSPECIFIED` (value: `"EXTERNAL_BUDGET_SOURCE_UNSPECIFIED"`)

* `NONE` (value: `"EXTERNAL_BUDGET_SOURCE_NONE"`)

* `MEDIA_OCEAN` (value: `"EXTERNAL_BUDGET_SOURCE_MEDIA_OCEAN"`)
