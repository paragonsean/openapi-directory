# DisplayVideo360Api.LineItemFlight
...
**flightDateType** | **String** | Required. The type of the line item&#39;s flight dates. | [optional] 
...
* `UNSPECIFIED` (value: `"LINE_ITEM_FLIGHT_DATE_TYPE_UNSPECIFIED"`)

* `INHERITED` (value: `"LINE_ITEM_FLIGHT_DATE_TYPE_INHERITED"`)

* `CUSTOM` (value: `"LINE_ITEM_FLIGHT_DATE_TYPE_CUSTOM"`)

* `TRIGGER` (value: `"LINE_ITEM_FLIGHT_DATE_TYPE_TRIGGER"`)
