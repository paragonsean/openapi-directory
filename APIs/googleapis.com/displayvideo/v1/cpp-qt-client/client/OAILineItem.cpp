...
QList<QString> OAILineItem::getInventorySourceIds() const {
    return m_inventory_source_ids;
}
void OAILineItem::setInventorySourceIds(const QList<QString> &inventory_source_ids) {
    m_inventory_source_ids = inventory_source_ids;
    m_inventory_source_ids_isSet = true;
}

bool OAILineItem::is_inventory_source_ids_Set() const{
    return m_inventory_source_ids_isSet;
}

bool OAILineItem::is_inventory_source_ids_Valid() const{
