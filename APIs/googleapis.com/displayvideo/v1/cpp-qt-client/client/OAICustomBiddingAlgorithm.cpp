...
void OAICustomBiddingAlgorithm::initializeModel() {
    ...
    m_custom_bidding_algorithm_state_isSet = false;
    m_custom_bidding_algorithm_state_isValid = false;
    ...
    m_model_readiness_isSet = false;
    m_model_readiness_isValid = false;
...
void OAICustomBiddingAlgorithm::fromJsonObject(QJsonObject json) {
    ...
    m_custom_bidding_algorithm_state_isValid = ::OpenAPI::fromJsonValue(m_custom_bidding_algorithm_state, json[QString("customBiddingAlgorithmState")]);
    m_custom_bidding_algorithm_state_isSet = !json[QString("customBiddingAlgorithmState")].isNull() && m_custom_bidding_algorithm_state_isValid;
    ...
    m_model_readiness_isValid = ::OpenAPI::fromJsonValue(m_model_readiness, json[QString("modelReadiness")]);
    m_model_readiness_isSet = !json[QString("modelReadiness")].isNull() && m_model_readiness_isValid;
...
QJsonObject OAICustomBiddingAlgorithm::asJsonObject() const {
    ...
    if (m_custom_bidding_algorithm_state_isSet) {
        obj.insert(QString("customBiddingAlgorithmState"), ::OpenAPI::toJsonValue(m_custom_bidding_algorithm_state));
    }
    ...
    if (m_model_readiness.size() > 0) {
        obj.insert(QString("modelReadiness"), ::OpenAPI::toJsonValue(m_model_readiness));
    }
    if (m_name_isSet) {
...
QString OAICustomBiddingAlgorithm::getCustomBiddingAlgorithmState() const {
    return m_custom_bidding_algorithm_state;
}
void OAICustomBiddingAlgorithm::setCustomBiddingAlgorithmState(const QString &custom_bidding_algorithm_state) {
    m_custom_bidding_algorithm_state = custom_bidding_algorithm_state;
    m_custom_bidding_algorithm_state_isSet = true;
}

bool OAICustomBiddingAlgorithm::is_custom_bidding_algorithm_state_Set() const{
    return m_custom_bidding_algorithm_state_isSet;
}

bool OAICustomBiddingAlgorithm::is_custom_bidding_algorithm_state_Valid() const{
    return m_custom_bidding_algorithm_state_isValid;
}
...
QList<OAICustomBiddingModelReadinessState> OAICustomBiddingAlgorithm::getModelReadiness() const {
    return m_model_readiness;
}
void OAICustomBiddingAlgorithm::setModelReadiness(const QList<OAICustomBiddingModelReadinessState> &model_readiness) {
    m_model_readiness = model_readiness;
    m_model_readiness_isSet = true;
}

bool OAICustomBiddingAlgorithm::is_model_readiness_Set() const{
    return m_model_readiness_isSet;
}

bool OAICustomBiddingAlgorithm::is_model_readiness_Valid() const{
    return m_model_readiness_isValid;
}
