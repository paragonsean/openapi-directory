...
QString OAILineItemFlight::getTriggerId() const {
    return m_trigger_id;
}
void OAILineItemFlight::setTriggerId(const QString &trigger_id) {
    m_trigger_id = trigger_id;
    m_trigger_id_isSet = true;
}

bool OAILineItemFlight::is_trigger_id_Set() const{
    return m_trigger_id_isSet;
}

bool OAILineItemFlight::is_trigger_id_Valid() const{
