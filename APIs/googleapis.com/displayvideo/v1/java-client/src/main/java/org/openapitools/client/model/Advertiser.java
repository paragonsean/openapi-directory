...
public class Advertiser {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(adServerConfig, advertiserId, creativeConfig, dataAccessConfig, displayName, entityStatus, generalConfig, integrationDetails, name, partnerId, prismaEnabled, servingConfig, updateTime);
  }
