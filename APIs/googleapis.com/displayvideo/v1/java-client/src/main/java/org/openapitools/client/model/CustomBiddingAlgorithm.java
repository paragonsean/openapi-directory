...
import org.openapitools.client.model.CustomBiddingModelReadinessState;
...
public class CustomBiddingAlgorithm {
   ...
   */
  @JsonAdapter(CustomBiddingAlgorithmStateEnum.Adapter.class)
  public enum CustomBiddingAlgorithmStateEnum {
    ...
    CustomBiddingAlgorithmStateEnum(String value) {
      this.value = value;
    }
    ...
    public static CustomBiddingAlgorithmStateEnum fromValue(String value) {
      for (CustomBiddingAlgorithmStateEnum b : CustomBiddingAlgorithmStateEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<CustomBiddingAlgorithmStateEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final CustomBiddingAlgorithmStateEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public CustomBiddingAlgorithmStateEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return CustomBiddingAlgorithmStateEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      CustomBiddingAlgorithmStateEnum.fromValue(value);
    }
  }

  public static final String SERIALIZED_NAME_CUSTOM_BIDDING_ALGORITHM_STATE = "customBiddingAlgorithmState";
  @Deprecated
  @SerializedName(SERIALIZED_NAME_CUSTOM_BIDDING_ALGORITHM_STATE)
  private CustomBiddingAlgorithmStateEnum customBiddingAlgorithmState;
  ...
  public static final String SERIALIZED_NAME_MODEL_READINESS = "modelReadiness";
  @SerializedName(SERIALIZED_NAME_MODEL_READINESS)
  private List<CustomBiddingModelReadinessState> modelReadiness = new ArrayList<>();
  ...
  public CustomBiddingAlgorithm(
     ...
     CustomBiddingAlgorithmStateEnum customBiddingAlgorithmState, 
     List<CustomBiddingModelReadinessState> modelReadiness, 
     String name
  ) {
    this();
  ...
  @Deprecated
  @javax.annotation.Nullable
  public CustomBiddingAlgorithmStateEnum getCustomBiddingAlgorithmState() {
    return customBiddingAlgorithmState;
  }
   ...
   */
  @javax.annotation.Nullable
  public List<CustomBiddingModelReadinessState> getModelReadiness() {
    return modelReadiness;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.advertiserId, customBiddingAlgorithm.advertiserId) &&
        ...
        Objects.equals(this.customBiddingAlgorithmState, customBiddingAlgorithm.customBiddingAlgorithmState) &&
        ...
        Objects.equals(this.modelReadiness, customBiddingAlgorithm.modelReadiness) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(advertiserId, customBiddingAlgorithmId, customBiddingAlgorithmState, customBiddingAlgorithmType, displayName, entityStatus, modelReadiness, name, partnerId, sharedAdvertiserIds);
  }
  ...
  public String toString() {
    ...
    sb.append("    customBiddingAlgorithmState: ").append(toIndentedString(customBiddingAlgorithmState)).append("\n");
    ...
    sb.append("    modelReadiness: ").append(toIndentedString(modelReadiness)).append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("customBiddingAlgorithmState") != null && !jsonObj.get("customBiddingAlgorithmState").isJsonNull()) && !jsonObj.get("customBiddingAlgorithmState").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `customBiddingAlgorithmState` to be a primitive type in the JSON string but got `%s`", jsonObj.get("customBiddingAlgorithmState").toString()));
      }
      // validate the optional field `customBiddingAlgorithmState`
      if (jsonObj.get("customBiddingAlgorithmState") != null && !jsonObj.get("customBiddingAlgorithmState").isJsonNull()) {
        CustomBiddingAlgorithmStateEnum.validateJsonElement(jsonObj.get("customBiddingAlgorithmState"));
      }
      ...
      if (jsonObj.get("modelReadiness") != null && !jsonObj.get("modelReadiness").isJsonNull()) {
        JsonArray jsonArraymodelReadiness = jsonObj.getAsJsonArray("modelReadiness");
        if (jsonArraymodelReadiness != null) {
          // ensure the json data is an array
          if (!jsonObj.get("modelReadiness").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `modelReadiness` to be an array in the JSON string but got `%s`", jsonObj.get("modelReadiness").toString()));
          }

          // validate the optional field `modelReadiness` (array)
          for (int i = 0; i < jsonArraymodelReadiness.size(); i++) {
            CustomBiddingModelReadinessState.validateJsonElement(jsonArraymodelReadiness.get(i));
          };
        }
      }
