...
public class PartnersApiTest {
     ...
     */
    @Test
    public void displayvideoPartnersBulkEditPartnerAssignedTargetingOptionsTest() throws ApiException {
        ...
        BulkEditPartnerAssignedTargetingOptionsResponse response = api.displayvideoPartnersBulkEditPartnerAssignedTargetingOptions(partnerId, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, bulkEditPartnerAssignedTargetingOptionsRequest);
