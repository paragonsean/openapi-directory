...
> InventorySource displayvideoInventorySourcesGet(inventorySourceId, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, partnerId)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      InventorySource result = apiInstance.displayvideoInventorySourcesGet(inventorySourceId, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, partnerId);
      System.out.println(result);
    } catch (ApiException e) {
