...
|------------ | ------------- | ------------- | -------------|
|**negativeKeywordListId** | **String** | Required. ID of the negative keyword list. Should refer to the negative_keyword_list_id field of a NegativeKeywordList resource. |  [optional] |
