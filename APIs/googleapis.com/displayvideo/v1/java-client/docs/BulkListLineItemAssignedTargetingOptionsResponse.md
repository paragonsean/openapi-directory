...
|------------ | ------------- | ------------- | -------------|
|**assignedTargetingOptions** | [**List&lt;AssignedTargetingOption&gt;**](AssignedTargetingOption.md) | The list of assigned targeting options. This list will be absent if empty. |  [optional] |
