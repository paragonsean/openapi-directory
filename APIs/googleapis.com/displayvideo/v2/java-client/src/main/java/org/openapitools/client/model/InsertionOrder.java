...
public class InsertionOrder {
   ...
   */
  @JsonAdapter(BillableOutcomeEnum.Adapter.class)
  public enum BillableOutcomeEnum {
    ...
    BillableOutcomeEnum(String value) {
      this.value = value;
    }
    ...
    public static BillableOutcomeEnum fromValue(String value) {
      for (BillableOutcomeEnum b : BillableOutcomeEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<BillableOutcomeEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final BillableOutcomeEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public BillableOutcomeEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return BillableOutcomeEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      BillableOutcomeEnum.fromValue(value);
    }
  }

  public static final String SERIALIZED_NAME_BILLABLE_OUTCOME = "billableOutcome";
  @SerializedName(SERIALIZED_NAME_BILLABLE_OUTCOME)
  private BillableOutcomeEnum billableOutcome;
  ...
  public InsertionOrder billableOutcome(BillableOutcomeEnum billableOutcome) {
   ...
   */
  @javax.annotation.Nullable
  public BillableOutcomeEnum getBillableOutcome() {
    return billableOutcome;
  }

  public void setBillableOutcome(BillableOutcomeEnum billableOutcome) {
    this.billableOutcome = billableOutcome;
  }
  ...
  public InsertionOrder performanceGoal(PerformanceGoal performanceGoal) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.advertiserId, insertionOrder.advertiserId) &&
        ...
        Objects.equals(this.billableOutcome, insertionOrder.billableOutcome) &&
        ...
        Objects.equals(this.performanceGoal, insertionOrder.performanceGoal) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(advertiserId, bidStrategy, billableOutcome, budget, campaignId, displayName, entityStatus, frequencyCap, insertionOrderId, insertionOrderType, integrationDetails, name, pacing, partnerCosts, performanceGoal, reservationType, updateTime);
  }
  ...
  public String toString() {
    ...
    sb.append("    billableOutcome: ").append(toIndentedString(billableOutcome)).append("\n");
  ...
  static {
    ...
    openapiFields.add("billableOutcome");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("billableOutcome") != null && !jsonObj.get("billableOutcome").isJsonNull()) && !jsonObj.get("billableOutcome").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `billableOutcome` to be a primitive type in the JSON string but got `%s`", jsonObj.get("billableOutcome").toString()));
      }
      // validate the optional field `billableOutcome`
      if (jsonObj.get("billableOutcome") != null && !jsonObj.get("billableOutcome").isJsonNull()) {
        BillableOutcomeEnum.validateJsonElement(jsonObj.get("billableOutcome"));
      }
