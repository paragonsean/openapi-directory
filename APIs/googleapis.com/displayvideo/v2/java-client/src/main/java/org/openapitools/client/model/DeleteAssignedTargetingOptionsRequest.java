...
public class DeleteAssignedTargetingOptionsRequest {
  public static final String SERIALIZED_NAME_ASSIGNED_TARGETING_OPTION_IDS = "assignedTargetingOptionIds";
  @SerializedName(SERIALIZED_NAME_ASSIGNED_TARGETING_OPTION_IDS)
  private List<String> assignedTargetingOptionIds = new ArrayList<>();
  ...
  public DeleteAssignedTargetingOptionsRequest assignedTargetingOptionIds(List<String> assignedTargetingOptionIds) {
    this.assignedTargetingOptionIds = assignedTargetingOptionIds;
    return this;
  }

  public DeleteAssignedTargetingOptionsRequest addAssignedTargetingOptionIdsItem(String assignedTargetingOptionIdsItem) {
    if (this.assignedTargetingOptionIds == null) {
      this.assignedTargetingOptionIds = new ArrayList<>();
    }
    this.assignedTargetingOptionIds.add(assignedTargetingOptionIdsItem);
    return this;
  }
  ...
  public List<String> getAssignedTargetingOptionIds() {
    return assignedTargetingOptionIds;
  }

  public void setAssignedTargetingOptionIds(List<String> assignedTargetingOptionIds) {
    this.assignedTargetingOptionIds = assignedTargetingOptionIds;
  }


  public DeleteAssignedTargetingOptionsRequest targetingType(TargetingTypeEnum targetingType) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteAssignedTargetingOptionsRequest deleteAssignedTargetingOptionsRequest = (DeleteAssignedTargetingOptionsRequest) o;
    return Objects.equals(this.assignedTargetingOptionIds, deleteAssignedTargetingOptionsRequest.assignedTargetingOptionIds) &&
        Objects.equals(this.targetingType, deleteAssignedTargetingOptionsRequest.targetingType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(assignedTargetingOptionIds, targetingType);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DeleteAssignedTargetingOptionsRequest {\n");
    sb.append("    assignedTargetingOptionIds: ").append(toIndentedString(assignedTargetingOptionIds)).append("\n");
  ...
  static {
    ...
    openapiFields.add("assignedTargetingOptionIds");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteAssignedTargetingOptionsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteAssignedTargetingOptionsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteAssignedTargetingOptionsRequest is not found in the empty JSON string", DeleteAssignedTargetingOptionsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteAssignedTargetingOptionsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteAssignedTargetingOptionsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // ensure the optional json data is an array if present
      if (jsonObj.get("assignedTargetingOptionIds") != null && !jsonObj.get("assignedTargetingOptionIds").isJsonNull() && !jsonObj.get("assignedTargetingOptionIds").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `assignedTargetingOptionIds` to be an array in the JSON string but got `%s`", jsonObj.get("assignedTargetingOptionIds").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteAssignedTargetingOptionsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteAssignedTargetingOptionsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteAssignedTargetingOptionsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteAssignedTargetingOptionsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteAssignedTargetingOptionsRequest>() {
           @Override
           public void write(JsonWriter out, DeleteAssignedTargetingOptionsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteAssignedTargetingOptionsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteAssignedTargetingOptionsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteAssignedTargetingOptionsRequest
   * @throws IOException if the JSON string is invalid with respect to DeleteAssignedTargetingOptionsRequest
   */
  public static DeleteAssignedTargetingOptionsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteAssignedTargetingOptionsRequest.class);
  }

  /**
   * Convert an instance of DeleteAssignedTargetingOptionsRequest to an JSON string
   *
   * @return JSON string
   */
