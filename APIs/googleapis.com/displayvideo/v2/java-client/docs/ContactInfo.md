...
|**hashedEmails** | **List&lt;String&gt;** | A list of SHA256 hashed email of the member. Before hashing, remove all whitespace and make sure the string is all lowercase. |  [optional] |
...
|**hashedPhoneNumbers** | **List&lt;String&gt;** | A list of SHA256 hashed phone numbers of the member. Before hashing, all phone numbers must be formatted using the [E.164 format](//en.wikipedia.org/wiki/E.164) and include the country calling code. |  [optional] |
|**zipCodes** | **List&lt;String&gt;** | A list of zip codes of the member. Must also be set with the following fields: * country_code * hashed_first_name * hashed_last_name |  [optional] |
