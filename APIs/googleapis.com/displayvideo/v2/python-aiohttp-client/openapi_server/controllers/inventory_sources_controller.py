...
async def displayvideo_inventory_sources_get(request: web.Request, inventory_source_id, xgafv=None, access_token=None, alt=None, param_callback=None, fields=None, key=None, oauth_token=None, pretty_print=None, quota_user=None, upload_protocol=None, upload_type=None, partner_id=None) -> web.Response:
