...
class YoutubeAndPartnersSettings(Model):
    ...
    def __init__(self, bidding_strategy: YoutubeAndPartnersBiddingStrategy=None, content_category: str=None, effective_content_category: str=None, inventory_source_settings: YoutubeAndPartnersInventorySourceConfig=None, lead_form_id: str=None, linked_merchant_id: str=None, related_video_ids: List[str]=None, target_frequency: TargetFrequency=None, third_party_measurement_settings: YoutubeAndPartnersThirdPartyMeasurementSettings=None, video_ad_sequence_settings: VideoAdSequenceSettings=None, view_frequency_cap: FrequencyCap=None):
        """YoutubeAndPartnersSettings - a model defined in OpenAPI

        :param bidding_strategy: The bidding_strategy of this YoutubeAndPartnersSettings.
        ...
        :param third_party_measurement_settings: The third_party_measurement_settings of this YoutubeAndPartnersSettings.
        ...
        self.openapi_types = {
            ...
            'third_party_measurement_settings': YoutubeAndPartnersThirdPartyMeasurementSettings,
        ...
        self.attribute_map = {
            ...
            'target_frequency': 'targetFrequency',
            'third_party_measurement_settings': 'thirdPartyMeasurementSettings',
            'video_ad_sequence_settings': 'videoAdSequenceSettings',
        ...
        self._third_party_measurement_settings = third_party_measurement_settings
    ...
    def bidding_strategy(self):
        """Gets the bidding_strategy of this YoutubeAndPartnersSettings.


        :return: The bidding_strategy of this YoutubeAndPartnersSettings.
    ...
    def bidding_strategy(self, bidding_strategy):
        """Sets the bidding_strategy of this YoutubeAndPartnersSettings.
    ...
    @property
    def third_party_measurement_settings(self):
        """Gets the third_party_measurement_settings of this YoutubeAndPartnersSettings.


        :return: The third_party_measurement_settings of this YoutubeAndPartnersSettings.
        :rtype: YoutubeAndPartnersThirdPartyMeasurementSettings
        """
        return self._third_party_measurement_settings

    @third_party_measurement_settings.setter
    def third_party_measurement_settings(self, third_party_measurement_settings):
        """Sets the third_party_measurement_settings of this YoutubeAndPartnersSettings.


        :param third_party_measurement_settings: The third_party_measurement_settings of this YoutubeAndPartnersSettings.
        :type third_party_measurement_settings: YoutubeAndPartnersThirdPartyMeasurementSettings
        """
