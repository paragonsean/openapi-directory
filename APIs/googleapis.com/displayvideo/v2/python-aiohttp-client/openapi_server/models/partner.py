...
class Partner(Model):
    ...
    def __init__(self, ad_server_config: PartnerAdServerConfig=None, data_access_config: PartnerDataAccessConfig=None, display_name: str=None, entity_status: str=None, exchange_config: ExchangeConfig=None, general_config: PartnerGeneralConfig=None, name: str=None, partner_id: str=None, update_time: str=None):
