...
class FrequencyCap(Model):
    ...
    def __init__(self, max_impressions: int=None, max_views: int=None, time_unit: str=None, time_unit_count: int=None, unlimited: bool=None):
        """FrequencyCap - a model defined in OpenAPI

        :param max_impressions: The max_impressions of this FrequencyCap.
        :param max_views: The max_views of this FrequencyCap.
    ...
    @property
    def max_views(self):
        """Gets the max_views of this FrequencyCap.
        ...
        :return: The max_views of this FrequencyCap.
        :rtype: int
        """
    ...
    def max_views(self, max_views):
        """Sets the max_views of this FrequencyCap.
