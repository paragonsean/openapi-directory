...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DisplayVideo360Api.ListLineItemsResponse();
  });
  ...
  describe('ListLineItemsResponse', function() {
    it('should create an instance of ListLineItemsResponse', function() {
      // uncomment below and update the code to test ListLineItemsResponse
      //var instance = new DisplayVideo360Api.ListLineItemsResponse();
      //expect(instance).to.be.a(DisplayVideo360Api.ListLineItemsResponse);
    });
