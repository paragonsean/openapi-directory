...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DisplayVideo360Api.Campaign();
  });
  ...
  describe('Campaign', function() {
    it('should create an instance of Campaign', function() {
      ...
      //var instance = new DisplayVideo360Api.Campaign();
      //expect(instance).to.be.a(DisplayVideo360Api.Campaign);
    });
    ...
    it('should have the property campaignBudgets (base name: "campaignBudgets")', function() {
      // uncomment below and update the code to test the property campaignBudgets
      //var instance = new DisplayVideo360Api.Campaign();
      //expect(instance).to.be();
    });

    it('should have the property campaignFlight (base name: "campaignFlight")', function() {
      // uncomment below and update the code to test the property campaignFlight
      //var instance = new DisplayVideo360Api.Campaign();
      //expect(instance).to.be();
    });

    it('should have the property campaignGoal (base name: "campaignGoal")', function() {
      // uncomment below and update the code to test the property campaignGoal
      //var instance = new DisplayVideo360Api.Campaign();
      //expect(instance).to.be();
    });
