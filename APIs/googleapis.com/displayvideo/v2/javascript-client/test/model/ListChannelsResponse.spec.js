...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DisplayVideo360Api.ListChannelsResponse();
  });
  ...
  describe('ListChannelsResponse', function() {
    it('should create an instance of ListChannelsResponse', function() {
      ...
      //var instance = new DisplayVideo360Api.ListChannelsResponse();
      //expect(instance).to.be.a(DisplayVideo360Api.ListChannelsResponse);
    });
