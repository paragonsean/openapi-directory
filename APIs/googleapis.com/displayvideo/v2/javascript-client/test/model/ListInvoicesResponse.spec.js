...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DisplayVideo360Api.ListInvoicesResponse();
  });
  ...
  describe('ListInvoicesResponse', function() {
    it('should create an instance of ListInvoicesResponse', function() {
      ...
      //var instance = new DisplayVideo360Api.ListInvoicesResponse();
      //expect(instance).to.be.a(DisplayVideo360Api.ListInvoicesResponse);
    });
