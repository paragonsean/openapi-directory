...
(function(root, factory) {
  ...
  describe('LineItem', function() {
    ...
    it('should have the property youtubeAndPartnersSettings (base name: "youtubeAndPartnersSettings")', function() {
      // uncomment below and update the code to test the property youtubeAndPartnersSettings
      //var instance = new DisplayVideo360Api.LineItem();
      //expect(instance).to.be();
    });
