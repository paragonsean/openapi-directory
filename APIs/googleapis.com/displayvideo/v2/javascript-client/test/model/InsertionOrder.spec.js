...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DisplayVideo360Api.InsertionOrder();
  });
  ...
  describe('InsertionOrder', function() {
    it('should create an instance of InsertionOrder', function() {
      // uncomment below and update the code to test InsertionOrder
      //var instance = new DisplayVideo360Api.InsertionOrder();
      //expect(instance).to.be.a(DisplayVideo360Api.InsertionOrder);
    });
    ...
    it('should have the property billableOutcome (base name: "billableOutcome")', function() {
      // uncomment below and update the code to test the property billableOutcome
      //var instance = new DisplayVideo360Api.InsertionOrder();
      //expect(instance).to.be();
    });
    ...
    it('should have the property insertionOrderType (base name: "insertionOrderType")', function() {
      // uncomment below and update the code to test the property insertionOrderType
      //var instance = new DisplayVideo360Api.InsertionOrder();
      //expect(instance).to.be();
    });
