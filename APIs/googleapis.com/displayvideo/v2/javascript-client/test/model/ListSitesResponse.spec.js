...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DisplayVideo360Api.ListSitesResponse();
  });
  ...
  describe('ListSitesResponse', function() {
    it('should create an instance of ListSitesResponse', function() {
      ...
      //var instance = new DisplayVideo360Api.ListSitesResponse();
      //expect(instance).to.be.a(DisplayVideo360Api.ListSitesResponse);
    });
