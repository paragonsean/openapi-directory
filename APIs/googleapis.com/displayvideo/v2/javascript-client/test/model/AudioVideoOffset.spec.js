...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DisplayVideo360Api.AudioVideoOffset();
  });
  ...
  describe('AudioVideoOffset', function() {
    it('should create an instance of AudioVideoOffset', function() {
      // uncomment below and update the code to test AudioVideoOffset
      //var instance = new DisplayVideo360Api.AudioVideoOffset();
      //expect(instance).to.be.a(DisplayVideo360Api.AudioVideoOffset);
    });
