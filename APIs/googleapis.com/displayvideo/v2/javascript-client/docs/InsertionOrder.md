...
**billableOutcome** | **String** | Immutable. The billable outcome of the insertion order. Outcome based buying is deprecated. &#x60;BILLABLE_OUTCOME_PAY_PER_IMPRESSION&#x60; is the only valid value. | [optional] 
...
* `UNSPECIFIED` (value: `"BILLABLE_OUTCOME_UNSPECIFIED"`)

* `PAY_PER_IMPRESSION` (value: `"BILLABLE_OUTCOME_PAY_PER_IMPRESSION"`)

* `PAY_PER_CLICK` (value: `"BILLABLE_OUTCOME_PAY_PER_CLICK"`)

* `PAY_PER_VIEWABLE_IMPRESSION` (value: `"BILLABLE_OUTCOME_PAY_PER_VIEWABLE_IMPRESSION"`)
