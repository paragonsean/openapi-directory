...
------------- | ------------- | -------------
[**displayvideoUsersBulkEditAssignedUserRoles**](UsersApi.md#displayvideoUsersBulkEditAssignedUserRoles) | **POST** /v2/users/{userId}:bulkEditAssignedUserRoles | 
[**displayvideoUsersCreate**](UsersApi.md#displayvideoUsersCreate) | **POST** /v2/users | 
[**displayvideoUsersDelete**](UsersApi.md#displayvideoUsersDelete) | **DELETE** /v2/users/{userId} | 
[**displayvideoUsersGet**](UsersApi.md#displayvideoUsersGet) | **GET** /v2/users/{userId} | 
[**displayvideoUsersList**](UsersApi.md#displayvideoUsersList) | **GET** /v2/users | 
[**displayvideoUsersPatch**](UsersApi.md#displayvideoUsersPatch) | **PATCH** /v2/users/{userId} | 
