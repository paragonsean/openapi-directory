...
class LineItem {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('youtubeAndPartnersSettings')) {
                obj['youtubeAndPartnersSettings'] = YoutubeAndPartnersSettings.constructFromObject(data['youtubeAndPartnersSettings']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['youtubeAndPartnersSettings']) { // data not null
          YoutubeAndPartnersSettings.validateJSON(data['youtubeAndPartnersSettings']);
        }
...
/**
 * @member {module:model/YoutubeAndPartnersSettings} youtubeAndPartnersSettings
 */
LineItem.prototype['youtubeAndPartnersSettings'] = undefined;
