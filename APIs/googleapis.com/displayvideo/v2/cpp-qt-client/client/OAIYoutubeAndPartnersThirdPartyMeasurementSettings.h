...
/*
 * OAIYoutubeAndPartnersThirdPartyMeasurementSettings.h
 *
 * Settings that control what third-party vendors are measuring specific line item metrics.
 */

#ifndef OAIYoutubeAndPartnersThirdPartyMeasurementSettings_H
#define OAIYoutubeAndPartnersThirdPartyMeasurementSettings_H
...
class OAIYoutubeAndPartnersThirdPartyMeasurementSettings : public OAIObject {
public:
    OAIYoutubeAndPartnersThirdPartyMeasurementSettings();
    OAIYoutubeAndPartnersThirdPartyMeasurementSettings(QString json);
    ~OAIYoutubeAndPartnersThirdPartyMeasurementSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIYoutubeAndPartnersThirdPartyMeasurementSettings)

#endif // OAIYoutubeAndPartnersThirdPartyMeasurementSettings_H
