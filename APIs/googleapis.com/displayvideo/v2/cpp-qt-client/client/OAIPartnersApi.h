...
public:
    ...
    */
    virtual void displayvideo_partners_editAssignedTargetingOptions(const QString &partner_id, const ::OpenAPI::OptionalParam<QString> &_xgafv = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &access_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &alt = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &callback = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &fields = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &key = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &oauth_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &pretty_print = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &quota_user = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &upload_protocol = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &upload_type = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAIBulkEditPartnerAssignedTargetingOptionsRequest> &oai_bulk_edit_partner_assigned_targeting_options_request = ::OpenAPI::OptionalParam<OAIBulkEditPartnerAssignedTargetingOptionsRequest>());
...
private:
    ...
    void displayvideo_partners_editAssignedTargetingOptionsCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void displayvideo_partners_editAssignedTargetingOptionsSignal(OAIBulkEditPartnerAssignedTargetingOptionsResponse summary);
    ...
    void displayvideo_partners_editAssignedTargetingOptionsSignalFull(OAIHttpRequestWorker *worker, OAIBulkEditPartnerAssignedTargetingOptionsResponse summary);
    ...
    Q_DECL_DEPRECATED_X("Use displayvideo_partners_editAssignedTargetingOptionsSignalError() instead")
    void displayvideo_partners_editAssignedTargetingOptionsSignalE(OAIBulkEditPartnerAssignedTargetingOptionsResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void displayvideo_partners_editAssignedTargetingOptionsSignalError(OAIBulkEditPartnerAssignedTargetingOptionsResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use displayvideo_partners_editAssignedTargetingOptionsSignalErrorFull() instead")
    void displayvideo_partners_editAssignedTargetingOptionsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void displayvideo_partners_editAssignedTargetingOptionsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
