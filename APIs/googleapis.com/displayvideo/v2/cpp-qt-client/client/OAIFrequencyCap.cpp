...
void OAIFrequencyCap::initializeModel() {
    ...
    m_max_views_isSet = false;
    m_max_views_isValid = false;
...
void OAIFrequencyCap::fromJsonObject(QJsonObject json) {
    ...
    m_max_views_isValid = ::OpenAPI::fromJsonValue(m_max_views, json[QString("maxViews")]);
    m_max_views_isSet = !json[QString("maxViews")].isNull() && m_max_views_isValid;
...
QJsonObject OAIFrequencyCap::asJsonObject() const {
    ...
    if (m_max_views_isSet) {
        obj.insert(QString("maxViews"), ::OpenAPI::toJsonValue(m_max_views));
    }
...
qint32 OAIFrequencyCap::getMaxViews() const {
    return m_max_views;
}
void OAIFrequencyCap::setMaxViews(const qint32 &max_views) {
    m_max_views = max_views;
    m_max_views_isSet = true;
}

bool OAIFrequencyCap::is_max_views_Set() const{
    return m_max_views_isSet;
}

bool OAIFrequencyCap::is_max_views_Valid() const{
    return m_max_views_isValid;
}
