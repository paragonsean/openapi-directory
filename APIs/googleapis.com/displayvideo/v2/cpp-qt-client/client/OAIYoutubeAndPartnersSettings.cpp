...
void OAIYoutubeAndPartnersSettings::initializeModel() {
    ...
    m_third_party_measurement_settings_isSet = false;
    m_third_party_measurement_settings_isValid = false;
...
void OAIYoutubeAndPartnersSettings::fromJsonObject(QJsonObject json) {
    ...
    m_third_party_measurement_settings_isValid = ::OpenAPI::fromJsonValue(m_third_party_measurement_settings, json[QString("thirdPartyMeasurementSettings")]);
    m_third_party_measurement_settings_isSet = !json[QString("thirdPartyMeasurementSettings")].isNull() && m_third_party_measurement_settings_isValid;
...
QJsonObject OAIYoutubeAndPartnersSettings::asJsonObject() const {
    ...
    if (m_third_party_measurement_settings.isSet()) {
        obj.insert(QString("thirdPartyMeasurementSettings"), ::OpenAPI::toJsonValue(m_third_party_measurement_settings));
    }
...
OAIYoutubeAndPartnersBiddingStrategy OAIYoutubeAndPartnersSettings::getBiddingStrategy() const {
    return m_bidding_strategy;
}
void OAIYoutubeAndPartnersSettings::setBiddingStrategy(const OAIYoutubeAndPartnersBiddingStrategy &bidding_strategy) {
    m_bidding_strategy = bidding_strategy;
    m_bidding_strategy_isSet = true;
}

bool OAIYoutubeAndPartnersSettings::is_bidding_strategy_Set() const{
    return m_bidding_strategy_isSet;
}

bool OAIYoutubeAndPartnersSettings::is_bidding_strategy_Valid() const{
...
OAIYoutubeAndPartnersThirdPartyMeasurementSettings OAIYoutubeAndPartnersSettings::getThirdPartyMeasurementSettings() const {
    return m_third_party_measurement_settings;
}
void OAIYoutubeAndPartnersSettings::setThirdPartyMeasurementSettings(const OAIYoutubeAndPartnersThirdPartyMeasurementSettings &third_party_measurement_settings) {
    m_third_party_measurement_settings = third_party_measurement_settings;
    m_third_party_measurement_settings_isSet = true;
}

bool OAIYoutubeAndPartnersSettings::is_third_party_measurement_settings_Set() const{
    return m_third_party_measurement_settings_isSet;
}

bool OAIYoutubeAndPartnersSettings::is_third_party_measurement_settings_Valid() const{
    return m_third_party_measurement_settings_isValid;
}
