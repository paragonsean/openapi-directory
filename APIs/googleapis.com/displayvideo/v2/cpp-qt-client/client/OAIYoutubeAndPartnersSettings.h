...
class OAIYoutubeAndPartnersThirdPartyMeasurementSettings;
...
public:
    ...
    OAIYoutubeAndPartnersThirdPartyMeasurementSettings getThirdPartyMeasurementSettings() const;
    void setThirdPartyMeasurementSettings(const OAIYoutubeAndPartnersThirdPartyMeasurementSettings &third_party_measurement_settings);
    bool is_third_party_measurement_settings_Set() const;
    bool is_third_party_measurement_settings_Valid() const;
...
private:
    ...
    OAIYoutubeAndPartnersThirdPartyMeasurementSettings m_third_party_measurement_settings;
    bool m_third_party_measurement_settings_isSet;
    bool m_third_party_measurement_settings_isValid;
