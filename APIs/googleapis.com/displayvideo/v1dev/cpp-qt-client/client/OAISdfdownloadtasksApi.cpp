...
#include "OAISdfdownloadtasksApi.h"
...
OAISdfdownloadtasksApi::OAISdfdownloadtasksApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAISdfdownloadtasksApi::~OAISdfdownloadtasksApi() {
}

void OAISdfdownloadtasksApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("displayvideo_sdfdownloadtasks_operations_get", defaultConf);
    _serverIndices.insert("displayvideo_sdfdownloadtasks_operations_get", 0);
}
...
*/
int OAISdfdownloadtasksApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAISdfdownloadtasksApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAISdfdownloadtasksApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAISdfdownloadtasksApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAISdfdownloadtasksApi::setUsername(const QString &username) {
    _username = username;
}

void OAISdfdownloadtasksApi::setPassword(const QString &password) {
    _password = password;
}


void OAISdfdownloadtasksApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAISdfdownloadtasksApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAISdfdownloadtasksApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAISdfdownloadtasksApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAISdfdownloadtasksApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAISdfdownloadtasksApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAISdfdownloadtasksApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAISdfdownloadtasksApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAISdfdownloadtasksApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAISdfdownloadtasksApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAISdfdownloadtasksApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAISdfdownloadtasksApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAISdfdownloadtasksApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAISdfdownloadtasksApi::displayvideo_sdfdownloadtasks_operations_get(const QString &name, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type) {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISdfdownloadtasksApi::displayvideo_sdfdownloadtasks_operations_getCallback);
    connect(this, &OAISdfdownloadtasksApi::abortRequestsSignal, worker, &QObject::deleteLater);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISdfdownloadtasksApi::displayvideo_sdfdownloadtasks_operations_getCallback);
    connect(this, &OAISdfdownloadtasksApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
...
void OAISdfdownloadtasksApi::displayvideo_sdfdownloadtasks_operations_getCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT displayvideo_sdfdownloadtasks_operations_getSignal(output);
        Q_EMIT displayvideo_sdfdownloadtasks_operations_getSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT displayvideo_sdfdownloadtasks_operations_getSignalE(output, error_type, error_str);
        Q_EMIT displayvideo_sdfdownloadtasks_operations_getSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT displayvideo_sdfdownloadtasks_operations_getSignalError(output, error_type, error_str);
        Q_EMIT displayvideo_sdfdownloadtasks_operations_getSignalErrorFull(worker, error_type, error_str);
    }
}

void OAISdfdownloadtasksApi::tokenAvailable(){
