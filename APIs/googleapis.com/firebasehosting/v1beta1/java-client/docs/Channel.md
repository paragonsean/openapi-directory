...
|**labels** | **Map&lt;String, String&gt;** | Text labels used for extra metadata and/or filtering. |  [optional] |
...
|**retainedReleaseCount** | **Integer** | The number of previous releases to retain on the channel for rollback or other purposes. Must be a number between 1-100. Defaults to 10 for new channels. |  [optional] |
