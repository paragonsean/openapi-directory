...
void OAIOperationsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("firebasehosting_operations_list", defaultConf);
    _serverIndices.insert("firebasehosting_operations_list", 0);
}
...
void OAIOperationsApi::firebasehosting_operations_list(const QString &name, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<QString> &filter, const ::OpenAPI::OptionalParam<qint32> &page_size, const ::OpenAPI::OptionalParam<QString> &page_token) {
    QString fullPath = QString(_serverConfigs["firebasehosting_operations_list"][_serverIndices.value("firebasehosting_operations_list")].URL()+"/v1/{name}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIOperationsApi::firebasehosting_operations_listCallback);
...
void OAIOperationsApi::firebasehosting_operations_listCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT firebasehosting_operations_listSignal(output);
        Q_EMIT firebasehosting_operations_listSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT firebasehosting_operations_listSignalE(output, error_type, error_str);
        Q_EMIT firebasehosting_operations_listSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT firebasehosting_operations_listSignalError(output, error_type, error_str);
        Q_EMIT firebasehosting_operations_listSignalErrorFull(worker, error_type, error_str);
    }
}
