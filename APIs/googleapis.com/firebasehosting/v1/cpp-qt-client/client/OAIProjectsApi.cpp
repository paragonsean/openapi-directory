...
void OAIProjectsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("firebasehosting_projects_sites_customDomains_operations_cancel", defaultConf);
    _serverIndices.insert("firebasehosting_projects_sites_customDomains_operations_cancel", 0);
    _serverConfigs.insert("firebasehosting_projects_sites_customDomains_operations_delete", defaultConf);
    _serverIndices.insert("firebasehosting_projects_sites_customDomains_operations_delete", 0);
}
...
void OAIProjectsApi::firebasehosting_projects_sites_customDomains_operations_cancel(const QString &name, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<OAIObject> &body) {
    QString fullPath = QString(_serverConfigs["firebasehosting_projects_sites_customDomains_operations_cancel"][_serverIndices.value("firebasehosting_projects_sites_customDomains_operations_cancel")].URL()+"/v1/{name}:cancel");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::firebasehosting_projects_sites_customDomains_operations_cancelCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::firebasehosting_projects_sites_customDomains_operations_cancelCallback);
...
void OAIProjectsApi::firebasehosting_projects_sites_customDomains_operations_cancelCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT firebasehosting_projects_sites_customDomains_operations_cancelSignal(output);
        Q_EMIT firebasehosting_projects_sites_customDomains_operations_cancelSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT firebasehosting_projects_sites_customDomains_operations_cancelSignalE(output, error_type, error_str);
        Q_EMIT firebasehosting_projects_sites_customDomains_operations_cancelSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT firebasehosting_projects_sites_customDomains_operations_cancelSignalError(output, error_type, error_str);
        Q_EMIT firebasehosting_projects_sites_customDomains_operations_cancelSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIProjectsApi::firebasehosting_projects_sites_customDomains_operations_delete(const QString &name, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type) {
    QString fullPath = QString(_serverConfigs["firebasehosting_projects_sites_customDomains_operations_delete"][_serverIndices.value("firebasehosting_projects_sites_customDomains_operations_delete")].URL()+"/v1/{name}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::firebasehosting_projects_sites_customDomains_operations_deleteCallback);
    connect(this, &OAIProjectsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIProjectsApi::firebasehosting_projects_sites_customDomains_operations_deleteCallback);
    connect(this, &OAIProjectsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIProjectsApi::firebasehosting_projects_sites_customDomains_operations_deleteCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT firebasehosting_projects_sites_customDomains_operations_deleteSignal(output);
        Q_EMIT firebasehosting_projects_sites_customDomains_operations_deleteSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        QString scopeStr = scope.join(" ");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT firebasehosting_projects_sites_customDomains_operations_deleteSignalE(output, error_type, error_str);
        Q_EMIT firebasehosting_projects_sites_customDomains_operations_deleteSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT firebasehosting_projects_sites_customDomains_operations_deleteSignalError(output, error_type, error_str);
        Q_EMIT firebasehosting_projects_sites_customDomains_operations_deleteSignalErrorFull(worker, error_type, error_str);
    }
}
