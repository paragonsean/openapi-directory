# FirebaseHostingApi.OperationsApi

All URIs are relative to *https://firebasehosting.googleapis.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**firebasehostingOperationsList**](OperationsApi.md#firebasehostingOperationsList) | **GET** /v1/{name} | 



## firebasehostingOperationsList

> ListOperationsResponse firebasehostingOperationsList(name, opts)
...
let apiInstance = new FirebaseHostingApi.OperationsApi();
...
apiInstance.firebasehostingOperationsList(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
