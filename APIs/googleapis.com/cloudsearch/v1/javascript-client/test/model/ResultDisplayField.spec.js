...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudSearchApi.ResultDisplayField();
  });
  ...
  describe('ResultDisplayField', function() {
    it('should create an instance of ResultDisplayField', function() {
      // uncomment below and update the code to test ResultDisplayField
      //var instance = new CloudSearchApi.ResultDisplayField();
      //expect(instance).to.be.a(CloudSearchApi.ResultDisplayField);
    });
