...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudSearchApi.PushItemRequest();
  });
  ...
  describe('PushItemRequest', function() {
    it('should create an instance of PushItemRequest', function() {
      // uncomment below and update the code to test PushItemRequest
      //var instance = new CloudSearchApi.PushItemRequest();
      //expect(instance).to.be.a(CloudSearchApi.PushItemRequest);
    });
