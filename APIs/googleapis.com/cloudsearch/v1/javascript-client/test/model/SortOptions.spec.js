...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudSearchApi.SortOptions();
  });
  ...
  describe('SortOptions', function() {
    it('should create an instance of SortOptions', function() {
      // uncomment below and update the code to test SortOptions
      //var instance = new CloudSearchApi.SortOptions();
      //expect(instance).to.be.a(CloudSearchApi.SortOptions);
    });
