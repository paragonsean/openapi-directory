...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudSearchApi.ListDataSourceResponse();
  });
  ...
  describe('ListDataSourceResponse', function() {
    it('should create an instance of ListDataSourceResponse', function() {
      // uncomment below and update the code to test ListDataSourceResponse
      //var instance = new CloudSearchApi.ListDataSourceResponse();
      //expect(instance).to.be.a(CloudSearchApi.ListDataSourceResponse);
    });
