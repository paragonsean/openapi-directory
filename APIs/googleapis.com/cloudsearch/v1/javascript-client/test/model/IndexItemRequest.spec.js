...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudSearchApi.IndexItemRequest();
  });
  ...
  describe('IndexItemRequest', function() {
    it('should create an instance of IndexItemRequest', function() {
      // uncomment below and update the code to test IndexItemRequest
      //var instance = new CloudSearchApi.IndexItemRequest();
      //expect(instance).to.be.a(CloudSearchApi.IndexItemRequest);
    });
    ...
    it('should have the property indexItemOptions (base name: "indexItemOptions")', function() {
      // uncomment below and update the code to test the property indexItemOptions
      //var instance = new CloudSearchApi.IndexItemRequest();
      //expect(instance).to.be();
    });
