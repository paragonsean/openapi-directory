...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudSearchApi.QuerySource();
  });
  ...
  describe('QuerySource', function() {
    it('should create an instance of QuerySource', function() {
      // uncomment below and update the code to test QuerySource
      //var instance = new CloudSearchApi.QuerySource();
      //expect(instance).to.be.a(CloudSearchApi.QuerySource);
    });
