...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudSearchApi.SearchItemsByViewUrlRequest();
  });
  ...
  describe('SearchItemsByViewUrlRequest', function() {
    it('should create an instance of SearchItemsByViewUrlRequest', function() {
      // uncomment below and update the code to test SearchItemsByViewUrlRequest
      //var instance = new CloudSearchApi.SearchItemsByViewUrlRequest();
      //expect(instance).to.be.a(CloudSearchApi.SearchItemsByViewUrlRequest);
    });
