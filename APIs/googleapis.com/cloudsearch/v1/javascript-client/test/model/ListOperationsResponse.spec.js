...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudSearchApi.ListOperationsResponse();
  });
  ...
  describe('ListOperationsResponse', function() {
    it('should create an instance of ListOperationsResponse', function() {
      ...
      //var instance = new CloudSearchApi.ListOperationsResponse();
      //expect(instance).to.be.a(CloudSearchApi.ListOperationsResponse);
    });
