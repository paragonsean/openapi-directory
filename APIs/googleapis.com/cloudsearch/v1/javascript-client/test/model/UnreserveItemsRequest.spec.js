...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudSearchApi.UnreserveItemsRequest();
  });
  ...
  describe('UnreserveItemsRequest', function() {
    it('should create an instance of UnreserveItemsRequest', function() {
      // uncomment below and update the code to test UnreserveItemsRequest
      //var instance = new CloudSearchApi.UnreserveItemsRequest();
      //expect(instance).to.be.a(CloudSearchApi.UnreserveItemsRequest);
    });
