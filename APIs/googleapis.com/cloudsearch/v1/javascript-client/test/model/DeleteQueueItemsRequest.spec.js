...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudSearchApi.DeleteQueueItemsRequest();
  });
  ...
  describe('DeleteQueueItemsRequest', function() {
    it('should create an instance of DeleteQueueItemsRequest', function() {
      // uncomment below and update the code to test DeleteQueueItemsRequest
      //var instance = new CloudSearchApi.DeleteQueueItemsRequest();
      //expect(instance).to.be.a(CloudSearchApi.DeleteQueueItemsRequest);
    });
