...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudSearchApi.Schema();
  });
  ...
  describe('Schema', function() {
    it('should create an instance of Schema', function() {
      ...
      //var instance = new CloudSearchApi.Schema();
      //expect(instance).to.be.a(CloudSearchApi.Schema);
    });

    it('should have the property objectDefinitions (base name: "objectDefinitions")', function() {
      // uncomment below and update the code to test the property objectDefinitions
      //var instance = new CloudSearchApi.Schema();
