...
> Operation cloudsearchInitializeCustomer(opts)
...
let apiInstance = new CloudSearchApi.V1Api();
let opts = {
...
apiInstance.cloudsearchInitializeCustomer(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
