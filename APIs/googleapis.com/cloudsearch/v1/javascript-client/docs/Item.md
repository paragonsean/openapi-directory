...
**itemType** | **String** | The type for this item. | [optional] 
...
**payload** | **Blob** | Additional state connector can store for this item. The maximum length is 10000 bytes. | [optional] 
...
* `CONTENT_ITEM` (value: `"CONTENT_ITEM"`)

* `CONTAINER_ITEM` (value: `"CONTAINER_ITEM"`)

* `VIRTUAL_CONTAINER_ITEM` (value: `"VIRTUAL_CONTAINER_ITEM"`)
