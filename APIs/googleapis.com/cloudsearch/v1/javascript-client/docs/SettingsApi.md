...
> Operation cloudsearchSettingsDatasourcesCreate(opts)
...
let apiInstance = new CloudSearchApi.SettingsApi();
let opts = {
  ...
  'dataSource': new CloudSearchApi.DataSource() // DataSource | 
};
apiInstance.cloudsearchSettingsDatasourcesCreate(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> ListDataSourceResponse cloudsearchSettingsDatasourcesList(opts)
...
let opts = {
  ...
  'pageSize': 56, // Number | Maximum number of datasources to fetch in a request. The max value is 1000. The default value is 1000.
  'pageToken': "pageToken_example" // String | Starting index of the results.
};
apiInstance.cloudsearchSettingsDatasourcesList(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **pageSize** | **Number**| Maximum number of datasources to fetch in a request. The max value is 1000. The default value is 1000. | [optional] 
...
> CustomerSettings cloudsearchSettingsGetCustomer(opts)
...
apiInstance.cloudsearchSettingsGetCustomer(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Operation cloudsearchSettingsSearchapplicationsCreate(opts)
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'searchApplication': new CloudSearchApi.SearchApplication() // SearchApplication | 
};
apiInstance.cloudsearchSettingsSearchapplicationsCreate(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Operation cloudsearchSettingsSearchapplicationsDelete(name, opts)
...
let apiInstance = new CloudSearchApi.SettingsApi();
let name = "name_example"; // String | The name of the search application to be deleted. Format: applications/{application_id}.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
apiInstance.cloudsearchSettingsSearchapplicationsDelete(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> SearchApplication cloudsearchSettingsSearchapplicationsGet(name, opts)
...
let apiInstance = new CloudSearchApi.SettingsApi();
let name = "name_example"; // String | The name of the search application. Format: searchapplications/{application_id}.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
apiInstance.cloudsearchSettingsSearchapplicationsGet(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ListSearchApplicationsResponse cloudsearchSettingsSearchapplicationsList(opts)
...
let opts = {
  ...
  'pageToken': "pageToken_example" // String | The next_page_token value returned from a previous List request, if any. The default value is 10
};
apiInstance.cloudsearchSettingsSearchapplicationsList(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Operation cloudsearchSettingsSearchapplicationsPatch(name, opts)
...
> Operation cloudsearchSettingsSearchapplicationsReset(name, opts)
...
let apiInstance = new CloudSearchApi.SettingsApi();
let name = "name_example"; // String | The name of the search application to be reset. Format: applications/{application_id}.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'resetSearchApplicationRequest': new CloudSearchApi.ResetSearchApplicationRequest() // ResetSearchApplicationRequest | 
};
apiInstance.cloudsearchSettingsSearchapplicationsReset(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Operation cloudsearchSettingsSearchapplicationsUpdate(name, opts)
...
apiInstance.cloudsearchSettingsSearchapplicationsUpdate(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Operation cloudsearchSettingsUpdateCustomer(opts)
...
let opts = {
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'updateMask': "updateMask_example", // String | Update mask to control which fields get updated. If you specify a field in the update_mask but don't specify its value here, that field will be cleared. If the mask is not present or empty, all fields will be updated. Currently supported field paths: vpc_settings and audit_logging_settings
  'customerSettings': new CloudSearchApi.CustomerSettings() // CustomerSettings | 
};
apiInstance.cloudsearchSettingsUpdateCustomer(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
