...
> Operation cloudsearchIndexingDatasourcesDeleteSchema(name, opts)
...
let apiInstance = new CloudSearchApi.IndexingApi();
let name = "name_example"; // String | The name of the data source to delete Schema. Format: datasources/{source_id}
let opts = {
...
apiInstance.cloudsearchIndexingDatasourcesDeleteSchema(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> Schema cloudsearchIndexingDatasourcesGetSchema(name, opts)
...
let apiInstance = new CloudSearchApi.IndexingApi();
let name = "name_example"; // String | The name of the data source to get Schema. Format: datasources/{source_id}
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
apiInstance.cloudsearchIndexingDatasourcesGetSchema(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Operation cloudsearchIndexingDatasourcesItemsDelete(name, opts)
...
let apiInstance = new CloudSearchApi.IndexingApi();
let name = "name_example"; // String | Required. The name of the item to delete. Format: datasources/{source_id}/items/{item_id}
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
> Operation cloudsearchIndexingDatasourcesItemsDeleteQueueItems(name, opts)
...
let apiInstance = new CloudSearchApi.IndexingApi();
let name = "name_example"; // String | The name of the Data Source to delete items in a queue. Format: datasources/{source_id}
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'deleteQueueItemsRequest': new CloudSearchApi.DeleteQueueItemsRequest() // DeleteQueueItemsRequest | 
};
apiInstance.cloudsearchIndexingDatasourcesItemsDeleteQueueItems(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Item cloudsearchIndexingDatasourcesItemsGet(name, opts)
...
let apiInstance = new CloudSearchApi.IndexingApi();
let name = "name_example"; // String | The name of the item to get info. Format: datasources/{source_id}/items/{item_id}
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
...
apiInstance.cloudsearchIndexingDatasourcesItemsGet(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Operation cloudsearchIndexingDatasourcesItemsIndex(name, opts)
...
let apiInstance = new CloudSearchApi.IndexingApi();
let name = "name_example"; // String | The name of the Item. Format: datasources/{source_id}/items/{item_id} This is a required field. The maximum length is 1536 characters.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'indexItemRequest': new CloudSearchApi.IndexItemRequest() // IndexItemRequest | 
};
apiInstance.cloudsearchIndexingDatasourcesItemsIndex(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ListItemsResponse cloudsearchIndexingDatasourcesItemsList(name, opts)
...
let apiInstance = new CloudSearchApi.IndexingApi();
let name = "name_example"; // String | The name of the Data Source to list Items. Format: datasources/{source_id}
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'brief': true, // Boolean | When set to true, the indexing system only populates the following fields: name, version, queue. metadata.hash, metadata.title, metadata.sourceRepositoryURL, metadata.objectType, metadata.createTime, metadata.updateTime, metadata.contentLanguage, metadata.mimeType, structured_data.hash, content.hash, itemType, itemStatus.code, itemStatus.processingError.code, itemStatus.repositoryError.type, If this value is false, then all the fields are populated in Item.
  'connectorName': "connectorName_example", // String | The name of connector making this call. Format: datasources/{source_id}/connectors/{ID}
  'debugOptionsEnableDebugging': true, // Boolean | If you are asked by Google to help with debugging, set this field. Otherwise, ignore this field.
  'pageSize': 56, // Number | Maximum number of items to fetch in a request. The max value is 1000 when brief is true. The max value is 10 if brief is false. The default value is 10
  'pageToken': "pageToken_example" // String | The next_page_token value returned from a previous List request, if any.
};
apiInstance.cloudsearchIndexingDatasourcesItemsList(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **connectorName** | **String**| The name of connector making this call. Format: datasources/{source_id}/connectors/{ID} | [optional] 
 **debugOptionsEnableDebugging** | **Boolean**| If you are asked by Google to help with debugging, set this field. Otherwise, ignore this field. | [optional] 
 **pageSize** | **Number**| Maximum number of items to fetch in a request. The max value is 1000 when brief is true. The max value is 10 if brief is false. The default value is 10 | [optional] 
...
> PollItemsResponse cloudsearchIndexingDatasourcesItemsPoll(name, opts)
...
let apiInstance = new CloudSearchApi.IndexingApi();
let name = "name_example"; // String | The name of the Data Source to poll items. Format: datasources/{source_id}
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'pollItemsRequest': new CloudSearchApi.PollItemsRequest() // PollItemsRequest | 
};
apiInstance.cloudsearchIndexingDatasourcesItemsPoll(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Item cloudsearchIndexingDatasourcesItemsPush(name, opts)
...
let apiInstance = new CloudSearchApi.IndexingApi();
let name = "name_example"; // String | The name of the item to push into the indexing queue. Format: datasources/{source_id}/items/{ID} This is a required field. The maximum length is 1536 characters.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'pushItemRequest': new CloudSearchApi.PushItemRequest() // PushItemRequest | 
};
apiInstance.cloudsearchIndexingDatasourcesItemsPush(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Operation cloudsearchIndexingDatasourcesItemsUnreserve(name, opts)
...
let apiInstance = new CloudSearchApi.IndexingApi();
let name = "name_example"; // String | The name of the Data Source to unreserve all items. Format: datasources/{source_id}
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'unreserveItemsRequest': new CloudSearchApi.UnreserveItemsRequest() // UnreserveItemsRequest | 
};
apiInstance.cloudsearchIndexingDatasourcesItemsUnreserve(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> UploadItemRef cloudsearchIndexingDatasourcesItemsUpload(name, opts)
...
let apiInstance = new CloudSearchApi.IndexingApi();
let name = "name_example"; // String | The name of the Item to start a resumable upload. Format: datasources/{source_id}/items/{item_id}. The maximum length is 1536 bytes.
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'startUploadItemRequest': new CloudSearchApi.StartUploadItemRequest() // StartUploadItemRequest | 
};
apiInstance.cloudsearchIndexingDatasourcesItemsUpload(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Operation cloudsearchIndexingDatasourcesUpdateSchema(name, opts)
...
let apiInstance = new CloudSearchApi.IndexingApi();
let name = "name_example"; // String | The name of the data source to update Schema. Format: datasources/{source_id}
let opts = {
  'xgafv': "xgafv_example", // String | V1 error format.
  'accessToken': "accessToken_example", // String | OAuth access token.
  'alt': "alt_example", // String | Data format for response.
  ...
  'uploadProtocol': "uploadProtocol_example", // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
  'uploadType': "uploadType_example", // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
  'updateSchemaRequest': new CloudSearchApi.UpdateSchemaRequest() // UpdateSchemaRequest | 
};
apiInstance.cloudsearchIndexingDatasourcesUpdateSchema(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
