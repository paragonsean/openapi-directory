# CloudSearchApi.SearchApplication

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**dataSourceRestrictions** | [**[DataSourceRestriction]**](DataSourceRestriction.md) | Retrictions applied to the configurations. The maximum number of elements is 10. | [optional] 
**defaultFacetOptions** | [**[FacetOptions]**](FacetOptions.md) | The default fields for returning facet results. The sources specified here also have been included in data_source_restrictions above. | [optional] 
...
**operationIds** | **[String]** | Output only. IDs of the Long Running Operations (LROs) currently running for this schema. Output only field. | [optional] [readonly] 
...
**sourceConfig** | [**[SourceConfig]**](SourceConfig.md) | Configuration for a sources specified in data_source_restrictions. | [optional] 
