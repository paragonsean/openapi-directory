...
void OAIV1Api::initializeServerConfigs() {
    ...
    _serverConfigs.insert("cloudsearch_initializeCustomer", defaultConf);
    _serverIndices.insert("cloudsearch_initializeCustomer", 0);
}
...
void OAIV1Api::cloudsearch_initializeCustomer(const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<OAIObject> &body) {
    QString fullPath = QString(_serverConfigs["cloudsearch_initializeCustomer"][_serverIndices.value("cloudsearch_initializeCustomer")].URL()+"/v1:initializeCustomer");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIV1Api::cloudsearch_initializeCustomerCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIV1Api::cloudsearch_initializeCustomerCallback);
...
void OAIV1Api::cloudsearch_initializeCustomerCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT cloudsearch_initializeCustomerSignal(output);
        Q_EMIT cloudsearch_initializeCustomerSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT cloudsearch_initializeCustomerSignalE(output, error_type, error_str);
        Q_EMIT cloudsearch_initializeCustomerSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT cloudsearch_initializeCustomerSignalError(output, error_type, error_str);
        Q_EMIT cloudsearch_initializeCustomerSignalErrorFull(worker, error_type, error_str);
    }
}
