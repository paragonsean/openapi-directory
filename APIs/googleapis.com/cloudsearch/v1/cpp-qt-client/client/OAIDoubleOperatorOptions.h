...
#ifndef OAIDoubleOperatorOptions_H
#define OAIDoubleOperatorOptions_H
...
class OAIDoubleOperatorOptions : public OAIObject {
public:
    OAIDoubleOperatorOptions();
    OAIDoubleOperatorOptions(QString json);
    ~OAIDoubleOperatorOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDoubleOperatorOptions)

#endif // OAIDoubleOperatorOptions_H
