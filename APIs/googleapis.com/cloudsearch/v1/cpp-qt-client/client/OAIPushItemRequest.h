...
/*
 * OAIPushItemRequest.h
 *
 * 
 */

#ifndef OAIPushItemRequest_H
#define OAIPushItemRequest_H
...
class OAIPushItemRequest : public OAIObject {
public:
    OAIPushItemRequest();
    OAIPushItemRequest(QString json);
    ~OAIPushItemRequest() override;
    ...
    OAIPushItem getItem() const;
    void setItem(const OAIPushItem &item);
...
Q_DECLARE_METATYPE(OpenAPI::OAIPushItemRequest)

#endif // OAIPushItemRequest_H
