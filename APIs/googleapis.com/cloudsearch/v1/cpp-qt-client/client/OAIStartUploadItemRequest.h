...
/*
 * OAIStartUploadItemRequest.h
 *
 * Start upload file request.
 */

#ifndef OAIStartUploadItemRequest_H
#define OAIStartUploadItemRequest_H
...
class OAIStartUploadItemRequest : public OAIObject {
public:
    OAIStartUploadItemRequest();
    OAIStartUploadItemRequest(QString json);
    ~OAIStartUploadItemRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartUploadItemRequest)

#endif // OAIStartUploadItemRequest_H
