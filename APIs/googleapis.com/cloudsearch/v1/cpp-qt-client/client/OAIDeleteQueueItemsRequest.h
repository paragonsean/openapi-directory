...
/*
 * OAIDeleteQueueItemsRequest.h
 *
 * 
 */

#ifndef OAIDeleteQueueItemsRequest_H
#define OAIDeleteQueueItemsRequest_H
...
class OAIDeleteQueueItemsRequest : public OAIObject {
public:
    OAIDeleteQueueItemsRequest();
    OAIDeleteQueueItemsRequest(QString json);
    ~OAIDeleteQueueItemsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteQueueItemsRequest)

#endif // OAIDeleteQueueItemsRequest_H
