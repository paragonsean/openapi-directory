...
OAIIntegerOperatorOptions::OAIIntegerOperatorOptions(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIntegerOperatorOptions::OAIIntegerOperatorOptions() {
    this->initializeModel();
}

OAIIntegerOperatorOptions::~OAIIntegerOperatorOptions() {}

void OAIIntegerOperatorOptions::initializeModel() {
...
void OAIIntegerOperatorOptions::fromJson(QString jsonString) {
...
void OAIIntegerOperatorOptions::fromJsonObject(QJsonObject json) {
...
QString OAIIntegerOperatorOptions::asJson() const {
...
QJsonObject OAIIntegerOperatorOptions::asJsonObject() const {
    QJsonObject obj;
...
QString OAIIntegerOperatorOptions::getGreaterThanOperatorName() const {
    return m_greater_than_operator_name;
}
void OAIIntegerOperatorOptions::setGreaterThanOperatorName(const QString &greater_than_operator_name) {
    m_greater_than_operator_name = greater_than_operator_name;
    m_greater_than_operator_name_isSet = true;
}

bool OAIIntegerOperatorOptions::is_greater_than_operator_name_Set() const{
    return m_greater_than_operator_name_isSet;
}

bool OAIIntegerOperatorOptions::is_greater_than_operator_name_Valid() const{
    return m_greater_than_operator_name_isValid;
}

QString OAIIntegerOperatorOptions::getLessThanOperatorName() const {
    return m_less_than_operator_name;
}
void OAIIntegerOperatorOptions::setLessThanOperatorName(const QString &less_than_operator_name) {
    m_less_than_operator_name = less_than_operator_name;
    m_less_than_operator_name_isSet = true;
}

bool OAIIntegerOperatorOptions::is_less_than_operator_name_Set() const{
    return m_less_than_operator_name_isSet;
}

bool OAIIntegerOperatorOptions::is_less_than_operator_name_Valid() const{
    return m_less_than_operator_name_isValid;
}

QString OAIIntegerOperatorOptions::getOperatorName() const {
    return m_operator_name;
}
void OAIIntegerOperatorOptions::setOperatorName(const QString &operator_name) {
    m_operator_name = operator_name;
    m_operator_name_isSet = true;
}

bool OAIIntegerOperatorOptions::is_operator_name_Set() const{
    return m_operator_name_isSet;
}

bool OAIIntegerOperatorOptions::is_operator_name_Valid() const{
    return m_operator_name_isValid;
}

bool OAIIntegerOperatorOptions::isSet() const {
...
bool OAIIntegerOperatorOptions::isValid() const {
