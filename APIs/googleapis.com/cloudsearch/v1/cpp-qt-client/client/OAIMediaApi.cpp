...
void OAIMediaApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("cloudsearch_media_upload", defaultConf);
    _serverIndices.insert("cloudsearch_media_upload", 0);
}
...
void OAIMediaApi::cloudsearch_media_upload(const QString &resource_name, const ::OpenAPI::OptionalParam<QString> &_xgafv, const ::OpenAPI::OptionalParam<QString> &access_token, const ::OpenAPI::OptionalParam<QString> &alt, const ::OpenAPI::OptionalParam<QString> &callback, const ::OpenAPI::OptionalParam<QString> &fields, const ::OpenAPI::OptionalParam<QString> &key, const ::OpenAPI::OptionalParam<QString> &oauth_token, const ::OpenAPI::OptionalParam<bool> &pretty_print, const ::OpenAPI::OptionalParam<QString> &quota_user, const ::OpenAPI::OptionalParam<QString> &upload_protocol, const ::OpenAPI::OptionalParam<QString> &upload_type, const ::OpenAPI::OptionalParam<OAIMedia> &oai_media) {
    QString fullPath = QString(_serverConfigs["cloudsearch_media_upload"][_serverIndices.value("cloudsearch_media_upload")].URL()+"/v1/media/{resourceName}");
    ...
    if (oai_media.hasValue()){

        
        QByteArray output = oai_media.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMediaApi::cloudsearch_media_uploadCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMediaApi::cloudsearch_media_uploadCallback);
...
void OAIMediaApi::cloudsearch_media_uploadCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT cloudsearch_media_uploadSignal(output);
        Q_EMIT cloudsearch_media_uploadSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT cloudsearch_media_uploadSignalE(output, error_type, error_str);
        Q_EMIT cloudsearch_media_uploadSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT cloudsearch_media_uploadSignalError(output, error_type, error_str);
        Q_EMIT cloudsearch_media_uploadSignalErrorFull(worker, error_type, error_str);
    }
}
