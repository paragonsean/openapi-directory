...
#ifndef OAITimestampOperatorOptions_H
#define OAITimestampOperatorOptions_H
...
class OAITimestampOperatorOptions : public OAIObject {
public:
    OAITimestampOperatorOptions();
    OAITimestampOperatorOptions(QString json);
    ~OAITimestampOperatorOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITimestampOperatorOptions)

#endif // OAITimestampOperatorOptions_H
