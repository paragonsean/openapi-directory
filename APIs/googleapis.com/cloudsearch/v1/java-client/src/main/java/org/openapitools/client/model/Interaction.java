...
public class Interaction {
  public static final String SERIALIZED_NAME_INTERACTION_TIME = "interactionTime";
  @SerializedName(SERIALIZED_NAME_INTERACTION_TIME)
  ...
  public Interaction interactionTime(String interactionTime) {
  ...
  public Interaction principal(Principal principal) {
  ...
  public Interaction type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.interactionTime, interaction.interactionTime) &&
        Objects.equals(this.principal, interaction.principal) &&
        Objects.equals(this.type, interaction.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(interactionTime, principal, type);
  }
  ...
  public String toString() {
    ...
    sb.append("    interactionTime: ").append(toIndentedString(interactionTime)).append("\n");
  ...
  static {
    ...
    openapiFields.add("interactionTime");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("interactionTime") != null && !jsonObj.get("interactionTime").isJsonNull()) && !jsonObj.get("interactionTime").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `interactionTime` to be a primitive type in the JSON string but got `%s`", jsonObj.get("interactionTime").toString()));
      }
