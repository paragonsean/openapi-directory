...
public class TimestampOperatorOptions {
  ...
  public TimestampOperatorOptions greaterThanOperatorName(String greaterThanOperatorName) {
  ...
  public TimestampOperatorOptions lessThanOperatorName(String lessThanOperatorName) {
  ...
  public TimestampOperatorOptions operatorName(String operatorName) {
  ...
  public boolean equals(Object o) {
    ...
    TimestampOperatorOptions timestampOperatorOptions = (TimestampOperatorOptions) o;
    return Objects.equals(this.greaterThanOperatorName, timestampOperatorOptions.greaterThanOperatorName) &&
        Objects.equals(this.lessThanOperatorName, timestampOperatorOptions.lessThanOperatorName) &&
        Objects.equals(this.operatorName, timestampOperatorOptions.operatorName);
  }
  ...
  public String toString() {
    ...
    sb.append("class TimestampOperatorOptions {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TimestampOperatorOptions
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TimestampOperatorOptions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TimestampOperatorOptions is not found in the empty JSON string", TimestampOperatorOptions.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TimestampOperatorOptions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TimestampOperatorOptions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TimestampOperatorOptions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TimestampOperatorOptions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TimestampOperatorOptions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TimestampOperatorOptions.class));

       return (TypeAdapter<T>) new TypeAdapter<TimestampOperatorOptions>() {
           @Override
           public void write(JsonWriter out, TimestampOperatorOptions value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TimestampOperatorOptions read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TimestampOperatorOptions given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TimestampOperatorOptions
   * @throws IOException if the JSON string is invalid with respect to TimestampOperatorOptions
   */
  public static TimestampOperatorOptions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TimestampOperatorOptions.class);
  }

  /**
   * Convert an instance of TimestampOperatorOptions to an JSON string
   *
   * @return JSON string
   */
