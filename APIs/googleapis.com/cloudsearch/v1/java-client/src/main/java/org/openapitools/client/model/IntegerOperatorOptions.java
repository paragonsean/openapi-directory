...
public class IntegerOperatorOptions {
  ...
  public IntegerOperatorOptions greaterThanOperatorName(String greaterThanOperatorName) {
  ...
  public IntegerOperatorOptions lessThanOperatorName(String lessThanOperatorName) {
  ...
  public IntegerOperatorOptions operatorName(String operatorName) {
  ...
  public boolean equals(Object o) {
    ...
    IntegerOperatorOptions integerOperatorOptions = (IntegerOperatorOptions) o;
    return Objects.equals(this.greaterThanOperatorName, integerOperatorOptions.greaterThanOperatorName) &&
        Objects.equals(this.lessThanOperatorName, integerOperatorOptions.lessThanOperatorName) &&
        Objects.equals(this.operatorName, integerOperatorOptions.operatorName);
  }
  ...
  public String toString() {
    ...
    sb.append("class IntegerOperatorOptions {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IntegerOperatorOptions
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IntegerOperatorOptions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IntegerOperatorOptions is not found in the empty JSON string", IntegerOperatorOptions.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IntegerOperatorOptions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IntegerOperatorOptions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IntegerOperatorOptions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IntegerOperatorOptions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IntegerOperatorOptions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IntegerOperatorOptions.class));

       return (TypeAdapter<T>) new TypeAdapter<IntegerOperatorOptions>() {
           @Override
           public void write(JsonWriter out, IntegerOperatorOptions value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IntegerOperatorOptions read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IntegerOperatorOptions given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IntegerOperatorOptions
   * @throws IOException if the JSON string is invalid with respect to IntegerOperatorOptions
   */
  public static IntegerOperatorOptions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IntegerOperatorOptions.class);
  }

  /**
   * Convert an instance of IntegerOperatorOptions to an JSON string
   *
   * @return JSON string
   */
