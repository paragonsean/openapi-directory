...
|------------ | ------------- | ------------- | -------------|
|**clusteredResults** | [**List&lt;SearchResult&gt;**](SearchResult.md) | If source is clustered, provide list of clustered results. There will only be one level of clustered results. If current source is not enabled for clustering, this field will be empty. |  [optional] |
