...
|**orderedRanking** | [**OrderedRankingEnum**](#OrderedRankingEnum) | Used to specify the ordered ranking for the integer. Can only be used if isRepeatable is false. |  [optional] |
