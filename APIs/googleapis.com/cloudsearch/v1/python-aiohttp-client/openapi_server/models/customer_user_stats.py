...
class CustomerUserStats(Model):
    ...
    def __init__(self, _date: ModelDate=None, one_day_active_users_count: str=None, seven_days_active_users_count: str=None, thirty_days_active_users_count: str=None):
        """CustomerUserStats - a model defined in OpenAPI

        :param _date: The _date of this CustomerUserStats.
        :param one_day_active_users_count: The one_day_active_users_count of this CustomerUserStats.
        :param seven_days_active_users_count: The seven_days_active_users_count of this CustomerUserStats.
        :param thirty_days_active_users_count: The thirty_days_active_users_count of this CustomerUserStats.
        """
        self.openapi_types = {
            '_date': ModelDate,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CustomerUserStats':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The CustomerUserStats of this CustomerUserStats.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def _date(self):
        """Gets the _date of this CustomerUserStats.


        :return: The _date of this CustomerUserStats.
        :rtype: ModelDate
        """
        return self.__date
    ...
    def _date(self, _date):
        """Sets the _date of this CustomerUserStats.
    ...
    def one_day_active_users_count(self):
        """Gets the one_day_active_users_count of this CustomerUserStats.

        The count of unique active users in the past one day

        :return: The one_day_active_users_count of this CustomerUserStats.
        :rtype: str
        """
    ...
    def one_day_active_users_count(self, one_day_active_users_count):
        """Sets the one_day_active_users_count of this CustomerUserStats.
    ...
    def seven_days_active_users_count(self):
        """Gets the seven_days_active_users_count of this CustomerUserStats.

        The count of unique active users in the past seven days

        :return: The seven_days_active_users_count of this CustomerUserStats.
        :rtype: str
        """
    ...
    def seven_days_active_users_count(self, seven_days_active_users_count):
        """Sets the seven_days_active_users_count of this CustomerUserStats.
    ...
    def thirty_days_active_users_count(self):
        """Gets the thirty_days_active_users_count of this CustomerUserStats.

        The count of unique active users in the past thirty days

        :return: The thirty_days_active_users_count of this CustomerUserStats.
        :rtype: str
        """
    ...
    def thirty_days_active_users_count(self, thirty_days_active_users_count):
        """Sets the thirty_days_active_users_count of this CustomerUserStats.
