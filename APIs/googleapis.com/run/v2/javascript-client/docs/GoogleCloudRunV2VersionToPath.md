# CloudRunAdminApi.GoogleCloudRunV2VersionToPath
...
**path** | **String** | Required. The relative path of the secret in the container. | [optional] 
**version** | **String** | The Cloud Secret Manager secret version. Can be &#39;latest&#39; for the latest value, or an integer or a secret alias for a specific version. | [optional] 
