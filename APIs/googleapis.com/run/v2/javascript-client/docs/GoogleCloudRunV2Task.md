# CloudRunAdminApi.GoogleCloudRunV2Task
...
**conditions** | [**[GoogleCloudRunV2Condition]**](GoogleCloudRunV2Condition.md) | Output only. The Condition of this Task, containing its readiness status, and detailed error information in case it did not reach the desired state. | [optional] [readonly] 
...
**index** | **Number** | Output only. Index of the Task, unique per execution, and beginning at 0. | [optional] [readonly] 
...
**maxRetries** | **Number** | Number of retries allowed per Task, before marking this Task failed. | [optional] 
...
**retried** | **Number** | Output only. The number of times this Task was retried. Tasks are retried when they fail up to the maxRetries limit. | [optional] [readonly] 
