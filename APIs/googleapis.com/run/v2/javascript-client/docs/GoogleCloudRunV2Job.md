# CloudRunAdminApi.GoogleCloudRunV2Job
...
**conditions** | [**[GoogleCloudRunV2Condition]**](GoogleCloudRunV2Condition.md) | Output only. The Conditions of all other associated sub-resources. They contain additional diagnostics information in case the Job does not reach its desired state. See comments in &#x60;reconciling&#x60; for additional information on reconciliation process in Cloud Run. | [optional] [readonly] 
...
**executionCount** | **Number** | Output only. Number of executions created for this job. | [optional] [readonly] 
