...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudRunAdminApi.GoogleCloudRunV2Container();
  });
  ...
  describe('GoogleCloudRunV2Container', function() {
    it('should create an instance of GoogleCloudRunV2Container', function() {
      // uncomment below and update the code to test GoogleCloudRunV2Container
      //var instance = new CloudRunAdminApi.GoogleCloudRunV2Container();
      //expect(instance).to.be.a(CloudRunAdminApi.GoogleCloudRunV2Container);
    });
