...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudRunAdminApi.GoogleCloudRunV2Probe();
  });
  ...
  describe('GoogleCloudRunV2Probe', function() {
    it('should create an instance of GoogleCloudRunV2Probe', function() {
      // uncomment below and update the code to test GoogleCloudRunV2Probe
      //var instance = new CloudRunAdminApi.GoogleCloudRunV2Probe();
      //expect(instance).to.be.a(CloudRunAdminApi.GoogleCloudRunV2Probe);
    });
