...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudRunAdminApi.GoogleIamV1Binding();
  });
  ...
  describe('GoogleIamV1Binding', function() {
    it('should create an instance of GoogleIamV1Binding', function() {
      ...
      //var instance = new CloudRunAdminApi.GoogleIamV1Binding();
      //expect(instance).to.be.a(CloudRunAdminApi.GoogleIamV1Binding);
    });
