...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudRunAdminApi.GoogleCloudRunV2TaskTemplate();
  });
  ...
  describe('GoogleCloudRunV2TaskTemplate', function() {
    it('should create an instance of GoogleCloudRunV2TaskTemplate', function() {
      // uncomment below and update the code to test GoogleCloudRunV2TaskTemplate
      //var instance = new CloudRunAdminApi.GoogleCloudRunV2TaskTemplate();
      //expect(instance).to.be.a(CloudRunAdminApi.GoogleCloudRunV2TaskTemplate);
    });
