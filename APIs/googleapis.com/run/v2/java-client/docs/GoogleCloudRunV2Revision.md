...
|**encryptionKeyRevocationAction** | [**EncryptionKeyRevocationActionEnum**](#EncryptionKeyRevocationActionEnum) | The action to take if the encryption key is revoked. |  [optional] |
...
|**executionEnvironment** | [**ExecutionEnvironmentEnum**](#ExecutionEnvironmentEnum) | The execution environment being used to host this Revision. |  [optional] |
