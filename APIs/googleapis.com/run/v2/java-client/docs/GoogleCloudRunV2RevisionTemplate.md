...
|**executionEnvironment** | [**ExecutionEnvironmentEnum**](#ExecutionEnvironmentEnum) | The sandbox environment to host this Revision. |  [optional] |
...
|**maxInstanceRequestConcurrency** | **Integer** | Sets the maximum number of requests that each serving instance can receive. |  [optional] |
