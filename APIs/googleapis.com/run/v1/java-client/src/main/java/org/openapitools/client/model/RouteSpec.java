...
public class RouteSpec {
  ...
  public RouteSpec traffic(List<TrafficTarget> traffic) {
    this.traffic = traffic;
    return this;
  }

  public RouteSpec addTrafficItem(TrafficTarget trafficItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.traffic, routeSpec.traffic);
  }

  @Override
  public int hashCode() {
    return Objects.hash(traffic);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to RouteSpec
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RouteSpec.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RouteSpec.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RouteSpec` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
