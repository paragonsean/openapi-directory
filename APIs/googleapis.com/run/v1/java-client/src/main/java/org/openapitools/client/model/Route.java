...
public class Route {
  ...
  public Route apiVersion(String apiVersion) {
  ...
  public Route metadata(ObjectMeta metadata) {
  ...
  public Route spec(RouteSpec spec) {
    this.spec = spec;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    Route route = (Route) o;
    return Objects.equals(this.apiVersion, route.apiVersion) &&
        Objects.equals(this.kind, route.kind) &&
        Objects.equals(this.metadata, route.metadata) &&
        Objects.equals(this.spec, route.spec) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("spec") != null && !jsonObj.get("spec").isJsonNull()) {
        RouteSpec.validateJsonElement(jsonObj.get("spec"));
      }
      // validate the optional field `status`
      if (jsonObj.get("status") != null && !jsonObj.get("status").isJsonNull()) {
        RouteStatus.validateJsonElement(jsonObj.get("status"));
      }
  }
