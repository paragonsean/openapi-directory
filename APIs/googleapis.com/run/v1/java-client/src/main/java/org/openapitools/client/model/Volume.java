...
public class Volume {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.configMap, volume.configMap) &&
        Objects.equals(this.csi, volume.csi) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(configMap, csi, emptyDir, name, nfs, secret);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("csi") != null && !jsonObj.get("csi").isJsonNull()) {
        CSIVolumeSource.validateJsonElement(jsonObj.get("csi"));
      }
      // validate the optional field `emptyDir`
      if (jsonObj.get("emptyDir") != null && !jsonObj.get("emptyDir").isJsonNull()) {
        EmptyDirVolumeSource.validateJsonElement(jsonObj.get("emptyDir"));
      }
      ...
      if (jsonObj.get("nfs") != null && !jsonObj.get("nfs").isJsonNull()) {
        NFSVolumeSource.validateJsonElement(jsonObj.get("nfs"));
      }
