...
public class JobSpec {
  ...
  public JobSpec template(ExecutionTemplateSpec template) {
  ...
  public void setTemplate(ExecutionTemplateSpec template) {
    this.template = template;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.template, jobSpec.template);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("template") != null && !jsonObj.get("template").isJsonNull()) {
        ExecutionTemplateSpec.validateJsonElement(jsonObj.get("template"));
      }
  }
