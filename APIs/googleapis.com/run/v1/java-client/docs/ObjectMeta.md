...
|**deletionGracePeriodSeconds** | **Integer** | Not supported by Cloud Run |  [optional] |
...
|**finalizers** | **List&lt;String&gt;** | Not supported by Cloud Run |  [optional] |
|**generateName** | **String** | Not supported by Cloud Run |  [optional] |
|**generation** | **Integer** | A system-provided sequence number representing a specific generation of the desired state. |  [optional] |
|**labels** | **Map&lt;String, String&gt;** | Map of string keys and values that can be used to organize and categorize (scope and select) objects. May match selectors of replication controllers and routes. |  [optional] |
...
|**ownerReferences** | [**List&lt;OwnerReference&gt;**](OwnerReference.md) | Not supported by Cloud Run |  [optional] |
