...
|------------ | ------------- | ------------- | -------------|
|**key** | **String** | Required. A Cloud Secret Manager secret version. Must be &#39;latest&#39; for the latest version, an integer for a specific version, or a version alias. The key of the secret to select from. Must be a valid secret key. |  [optional] |
