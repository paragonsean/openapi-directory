...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudRunAdminApi.ListLocationsResponse();
  });
  ...
  describe('ListLocationsResponse', function() {
    it('should create an instance of ListLocationsResponse', function() {
      ...
      //var instance = new CloudRunAdminApi.ListLocationsResponse();
      //expect(instance).to.be.a(CloudRunAdminApi.ListLocationsResponse);
    });
