...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudRunAdminApi.ExecutionSpec();
  });
  ...
  describe('ExecutionSpec', function() {
    it('should create an instance of ExecutionSpec', function() {
      // uncomment below and update the code to test ExecutionSpec
      //var instance = new CloudRunAdminApi.ExecutionSpec();
      //expect(instance).to.be.a(CloudRunAdminApi.ExecutionSpec);
    });
