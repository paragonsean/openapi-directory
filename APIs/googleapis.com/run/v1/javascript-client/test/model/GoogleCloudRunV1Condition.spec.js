...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudRunAdminApi.GoogleCloudRunV1Condition();
  });
  ...
  describe('GoogleCloudRunV1Condition', function() {
    it('should create an instance of GoogleCloudRunV1Condition', function() {
      // uncomment below and update the code to test GoogleCloudRunV1Condition
      //var instance = new CloudRunAdminApi.GoogleCloudRunV1Condition();
      //expect(instance).to.be.a(CloudRunAdminApi.GoogleCloudRunV1Condition);
    });
