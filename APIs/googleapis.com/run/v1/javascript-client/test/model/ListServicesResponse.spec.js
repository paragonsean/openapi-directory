...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudRunAdminApi.ListServicesResponse();
  });
  ...
  describe('ListServicesResponse', function() {
    it('should create an instance of ListServicesResponse', function() {
      ...
      //var instance = new CloudRunAdminApi.ListServicesResponse();
      //expect(instance).to.be.a(CloudRunAdminApi.ListServicesResponse);
    });
