...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudRunAdminApi.HTTPGetAction();
  });
  ...
  describe('HTTPGetAction', function() {
    it('should create an instance of HTTPGetAction', function() {
      // uncomment below and update the code to test HTTPGetAction
      //var instance = new CloudRunAdminApi.HTTPGetAction();
      //expect(instance).to.be.a(CloudRunAdminApi.HTTPGetAction);
    });
