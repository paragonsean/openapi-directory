...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudRunAdminApi.ExecutionStatus();
  });
  ...
  describe('ExecutionStatus', function() {
    it('should create an instance of ExecutionStatus', function() {
      ...
      //var instance = new CloudRunAdminApi.ExecutionStatus();
      //expect(instance).to.be.a(CloudRunAdminApi.ExecutionStatus);
    });
