...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudRunAdminApi.DomainMapping();
  });
  ...
  describe('DomainMapping', function() {
    it('should create an instance of DomainMapping', function() {
      // uncomment below and update the code to test DomainMapping
      //var instance = new CloudRunAdminApi.DomainMapping();
      //expect(instance).to.be.a(CloudRunAdminApi.DomainMapping);
    });
