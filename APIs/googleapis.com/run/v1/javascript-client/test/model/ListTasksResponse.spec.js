...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudRunAdminApi.ListTasksResponse();
  });
  ...
  describe('ListTasksResponse', function() {
    it('should create an instance of ListTasksResponse', function() {
      ...
      //var instance = new CloudRunAdminApi.ListTasksResponse();
      //expect(instance).to.be.a(CloudRunAdminApi.ListTasksResponse);
    });
