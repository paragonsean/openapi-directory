...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudRunAdminApi.ListRevisionsResponse();
  });
  ...
  describe('ListRevisionsResponse', function() {
    it('should create an instance of ListRevisionsResponse', function() {
      // uncomment below and update the code to test ListRevisionsResponse
      //var instance = new CloudRunAdminApi.ListRevisionsResponse();
      //expect(instance).to.be.a(CloudRunAdminApi.ListRevisionsResponse);
    });
