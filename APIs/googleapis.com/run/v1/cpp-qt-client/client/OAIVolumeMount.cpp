...
void OAIVolumeMount::initializeModel() {
    ...
    m_sub_path_isSet = false;
    m_sub_path_isValid = false;
}
...
void OAIVolumeMount::fromJsonObject(QJsonObject json) {
    ...
    m_sub_path_isValid = ::OpenAPI::fromJsonValue(m_sub_path, json[QString("subPath")]);
    m_sub_path_isSet = !json[QString("subPath")].isNull() && m_sub_path_isValid;
}
...
QJsonObject OAIVolumeMount::asJsonObject() const {
    ...
    if (m_sub_path_isSet) {
        obj.insert(QString("subPath"), ::OpenAPI::toJsonValue(m_sub_path));
    }
    return obj;
}
...
QString OAIVolumeMount::getSubPath() const {
    return m_sub_path;
}
void OAIVolumeMount::setSubPath(const QString &sub_path) {
    m_sub_path = sub_path;
    m_sub_path_isSet = true;
}

bool OAIVolumeMount::is_sub_path_Set() const{
    return m_sub_path_isSet;
}

bool OAIVolumeMount::is_sub_path_Valid() const{
    return m_sub_path_isValid;
}
