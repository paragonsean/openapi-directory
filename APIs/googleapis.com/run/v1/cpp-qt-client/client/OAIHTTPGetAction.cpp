...
qint32 OAIHTTPGetAction::getPort() const {
    return m_port;
}
void OAIHTTPGetAction::setPort(const qint32 &port) {
    m_port = port;
    m_port_isSet = true;
}

bool OAIHTTPGetAction::is_port_Set() const{
    return m_port_isSet;
}

bool OAIHTTPGetAction::is_port_Valid() const{
