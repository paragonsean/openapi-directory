...
QString OAITask::getApiVersion() const {
    return m_api_version;
}
void OAITask::setApiVersion(const QString &api_version) {
    m_api_version = api_version;
    m_api_version_isSet = true;
}

bool OAITask::is_api_version_Set() const{
    return m_api_version_isSet;
}

bool OAITask::is_api_version_Valid() const{
...
OAIObjectMeta OAITask::getMetadata() const {
    return m_metadata;
}
void OAITask::setMetadata(const OAIObjectMeta &metadata) {
    m_metadata = metadata;
    m_metadata_isSet = true;
}

bool OAITask::is_metadata_Set() const{
    return m_metadata_isSet;
}

bool OAITask::is_metadata_Valid() const{
    return m_metadata_isValid;
}

OAITaskSpec OAITask::getSpec() const {
    return m_spec;
}
void OAITask::setSpec(const OAITaskSpec &spec) {
    m_spec = spec;
    m_spec_isSet = true;
}

bool OAITask::is_spec_Set() const{
    return m_spec_isSet;
}

bool OAITask::is_spec_Valid() const{
