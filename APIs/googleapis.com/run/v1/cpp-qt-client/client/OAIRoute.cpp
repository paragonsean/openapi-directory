...
QString OAIRoute::getApiVersion() const {
    return m_api_version;
}
void OAIRoute::setApiVersion(const QString &api_version) {
    m_api_version = api_version;
    m_api_version_isSet = true;
}

bool OAIRoute::is_api_version_Set() const{
    return m_api_version_isSet;
}

bool OAIRoute::is_api_version_Valid() const{
    return m_api_version_isValid;
}

QString OAIRoute::getKind() const {
    return m_kind;
}
void OAIRoute::setKind(const QString &kind) {
    m_kind = kind;
    m_kind_isSet = true;
}

bool OAIRoute::is_kind_Set() const{
    return m_kind_isSet;
}

bool OAIRoute::is_kind_Valid() const{
    return m_kind_isValid;
}

OAIObjectMeta OAIRoute::getMetadata() const {
    return m_metadata;
}
void OAIRoute::setMetadata(const OAIObjectMeta &metadata) {
    m_metadata = metadata;
    m_metadata_isSet = true;
}

bool OAIRoute::is_metadata_Set() const{
    return m_metadata_isSet;
}

bool OAIRoute::is_metadata_Valid() const{
    return m_metadata_isValid;
}

OAIRouteSpec OAIRoute::getSpec() const {
    return m_spec;
}
void OAIRoute::setSpec(const OAIRouteSpec &spec) {
    m_spec = spec;
    m_spec_isSet = true;
}

bool OAIRoute::is_spec_Set() const{
    return m_spec_isSet;
}

bool OAIRoute::is_spec_Valid() const{
    return m_spec_isValid;
}

OAIRouteStatus OAIRoute::getStatus() const {
    return m_status;
}
void OAIRoute::setStatus(const OAIRouteStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIRoute::is_status_Set() const{
    return m_status_isSet;
}

bool OAIRoute::is_status_Valid() const{
