...
QString OAIListTasksResponse::getApiVersion() const {
    return m_api_version;
}
void OAIListTasksResponse::setApiVersion(const QString &api_version) {
    m_api_version = api_version;
    m_api_version_isSet = true;
}

bool OAIListTasksResponse::is_api_version_Set() const{
    return m_api_version_isSet;
}

bool OAIListTasksResponse::is_api_version_Valid() const{
    return m_api_version_isValid;
}

QList<OAITask> OAIListTasksResponse::getItems() const {
    return m_items;
}
void OAIListTasksResponse::setItems(const QList<OAITask> &items) {
    m_items = items;
    m_items_isSet = true;
}

bool OAIListTasksResponse::is_items_Set() const{
    return m_items_isSet;
}

bool OAIListTasksResponse::is_items_Valid() const{
    return m_items_isValid;
}

QString OAIListTasksResponse::getKind() const {
    return m_kind;
}
void OAIListTasksResponse::setKind(const QString &kind) {
    m_kind = kind;
    m_kind_isSet = true;
}

bool OAIListTasksResponse::is_kind_Set() const{
    return m_kind_isSet;
}

bool OAIListTasksResponse::is_kind_Valid() const{
    return m_kind_isValid;
}

OAIListMeta OAIListTasksResponse::getMetadata() const {
    return m_metadata;
}
void OAIListTasksResponse::setMetadata(const OAIListMeta &metadata) {
    m_metadata = metadata;
    m_metadata_isSet = true;
}

bool OAIListTasksResponse::is_metadata_Set() const{
    return m_metadata_isSet;
}

bool OAIListTasksResponse::is_metadata_Valid() const{
    return m_metadata_isValid;
}

QList<QString> OAIListTasksResponse::getUnreachable() const {
    return m_unreachable;
}
void OAIListTasksResponse::setUnreachable(const QList<QString> &unreachable) {
    m_unreachable = unreachable;
    m_unreachable_isSet = true;
}

bool OAIListTasksResponse::is_unreachable_Set() const{
    return m_unreachable_isSet;
}

bool OAIListTasksResponse::is_unreachable_Valid() const{
