...
QString OAIExecution::getApiVersion() const {
    return m_api_version;
}
void OAIExecution::setApiVersion(const QString &api_version) {
    m_api_version = api_version;
    m_api_version_isSet = true;
}

bool OAIExecution::is_api_version_Set() const{
    return m_api_version_isSet;
}

bool OAIExecution::is_api_version_Valid() const{
    return m_api_version_isValid;
}

QString OAIExecution::getKind() const {
    return m_kind;
}
void OAIExecution::setKind(const QString &kind) {
    m_kind = kind;
    m_kind_isSet = true;
}

bool OAIExecution::is_kind_Set() const{
    return m_kind_isSet;
}

bool OAIExecution::is_kind_Valid() const{
    return m_kind_isValid;
}

OAIObjectMeta OAIExecution::getMetadata() const {
    return m_metadata;
}
void OAIExecution::setMetadata(const OAIObjectMeta &metadata) {
    m_metadata = metadata;
    m_metadata_isSet = true;
}

bool OAIExecution::is_metadata_Set() const{
    return m_metadata_isSet;
}

bool OAIExecution::is_metadata_Valid() const{
    return m_metadata_isValid;
}

OAIExecutionSpec OAIExecution::getSpec() const {
    return m_spec;
}
void OAIExecution::setSpec(const OAIExecutionSpec &spec) {
    m_spec = spec;
    m_spec_isSet = true;
}

bool OAIExecution::is_spec_Set() const{
    return m_spec_isSet;
}

bool OAIExecution::is_spec_Valid() const{
    return m_spec_isValid;
}

OAIExecutionStatus OAIExecution::getStatus() const {
    return m_status;
}
void OAIExecution::setStatus(const OAIExecutionStatus &status) {
    m_status = status;
    m_status_isSet = true;
}
