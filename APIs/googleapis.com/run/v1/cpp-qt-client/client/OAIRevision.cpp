...
QString OAIRevision::getApiVersion() const {
    return m_api_version;
}
void OAIRevision::setApiVersion(const QString &api_version) {
    m_api_version = api_version;
    m_api_version_isSet = true;
}

bool OAIRevision::is_api_version_Set() const{
    return m_api_version_isSet;
}

bool OAIRevision::is_api_version_Valid() const{
...
OAIObjectMeta OAIRevision::getMetadata() const {
    return m_metadata;
}
void OAIRevision::setMetadata(const OAIObjectMeta &metadata) {
    m_metadata = metadata;
    m_metadata_isSet = true;
}

bool OAIRevision::is_metadata_Set() const{
    return m_metadata_isSet;
}

bool OAIRevision::is_metadata_Valid() const{
    return m_metadata_isValid;
}

OAIRevisionSpec OAIRevision::getSpec() const {
    return m_spec;
}
void OAIRevision::setSpec(const OAIRevisionSpec &spec) {
    m_spec = spec;
    m_spec_isSet = true;
}

bool OAIRevision::is_spec_Set() const{
    return m_spec_isSet;
}

bool OAIRevision::is_spec_Valid() const{
    return m_spec_isValid;
}

OAIRevisionStatus OAIRevision::getStatus() const {
    return m_status;
}
void OAIRevision::setStatus(const OAIRevisionStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIRevision::is_status_Set() const{
    return m_status_isSet;
}

bool OAIRevision::is_status_Valid() const{
