...
QString OAIListRoutesResponse::getApiVersion() const {
    return m_api_version;
}
void OAIListRoutesResponse::setApiVersion(const QString &api_version) {
    m_api_version = api_version;
    m_api_version_isSet = true;
}

bool OAIListRoutesResponse::is_api_version_Set() const{
    return m_api_version_isSet;
}

bool OAIListRoutesResponse::is_api_version_Valid() const{
    return m_api_version_isValid;
}

QList<OAIRoute> OAIListRoutesResponse::getItems() const {
    return m_items;
}
void OAIListRoutesResponse::setItems(const QList<OAIRoute> &items) {
    m_items = items;
    m_items_isSet = true;
}

bool OAIListRoutesResponse::is_items_Set() const{
    return m_items_isSet;
}

bool OAIListRoutesResponse::is_items_Valid() const{
    return m_items_isValid;
}

QString OAIListRoutesResponse::getKind() const {
    return m_kind;
}
void OAIListRoutesResponse::setKind(const QString &kind) {
    m_kind = kind;
    m_kind_isSet = true;
}

bool OAIListRoutesResponse::is_kind_Set() const{
    return m_kind_isSet;
}

bool OAIListRoutesResponse::is_kind_Valid() const{
    return m_kind_isValid;
}

OAIListMeta OAIListRoutesResponse::getMetadata() const {
    return m_metadata;
}
void OAIListRoutesResponse::setMetadata(const OAIListMeta &metadata) {
    m_metadata = metadata;
    m_metadata_isSet = true;
}

bool OAIListRoutesResponse::is_metadata_Set() const{
    return m_metadata_isSet;
}

bool OAIListRoutesResponse::is_metadata_Valid() const{
