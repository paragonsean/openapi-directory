...
QString OAIConfiguration::getApiVersion() const {
    return m_api_version;
}
void OAIConfiguration::setApiVersion(const QString &api_version) {
    m_api_version = api_version;
    m_api_version_isSet = true;
}

bool OAIConfiguration::is_api_version_Set() const{
    return m_api_version_isSet;
}

bool OAIConfiguration::is_api_version_Valid() const{
    return m_api_version_isValid;
}

QString OAIConfiguration::getKind() const {
    return m_kind;
}
void OAIConfiguration::setKind(const QString &kind) {
    m_kind = kind;
    m_kind_isSet = true;
}

bool OAIConfiguration::is_kind_Set() const{
    return m_kind_isSet;
}

bool OAIConfiguration::is_kind_Valid() const{
    return m_kind_isValid;
}

OAIObjectMeta OAIConfiguration::getMetadata() const {
    return m_metadata;
}
void OAIConfiguration::setMetadata(const OAIObjectMeta &metadata) {
    m_metadata = metadata;
    m_metadata_isSet = true;
}

bool OAIConfiguration::is_metadata_Set() const{
    return m_metadata_isSet;
}

bool OAIConfiguration::is_metadata_Valid() const{
    return m_metadata_isValid;
}

OAIConfigurationSpec OAIConfiguration::getSpec() const {
    return m_spec;
}
void OAIConfiguration::setSpec(const OAIConfigurationSpec &spec) {
    m_spec = spec;
    m_spec_isSet = true;
}

bool OAIConfiguration::is_spec_Set() const{
    return m_spec_isSet;
}

bool OAIConfiguration::is_spec_Valid() const{
    return m_spec_isValid;
}

OAIConfigurationStatus OAIConfiguration::getStatus() const {
    return m_status;
}
void OAIConfiguration::setStatus(const OAIConfigurationStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIConfiguration::is_status_Set() const{
    return m_status_isSet;
}

bool OAIConfiguration::is_status_Valid() const{
