...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudRunAdminApi.SecretVolumeSource();
  });
  ...
  describe('SecretVolumeSource', function() {
    it('should create an instance of SecretVolumeSource', function() {
      // uncomment below and update the code to test SecretVolumeSource
      //var instance = new CloudRunAdminApi.SecretVolumeSource();
      //expect(instance).to.be.a(CloudRunAdminApi.SecretVolumeSource);
    });
