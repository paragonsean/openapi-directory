...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudRunAdminApi.ResourceRequirements();
  });
  ...
  describe('ResourceRequirements', function() {
    it('should create an instance of ResourceRequirements', function() {
      ...
      //var instance = new CloudRunAdminApi.ResourceRequirements();
      //expect(instance).to.be.a(CloudRunAdminApi.ResourceRequirements);
    });
