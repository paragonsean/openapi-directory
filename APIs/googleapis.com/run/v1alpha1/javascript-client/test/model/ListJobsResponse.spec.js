...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudRunAdminApi.ListJobsResponse();
  });
  ...
  describe('ListJobsResponse', function() {
    it('should create an instance of ListJobsResponse', function() {
      ...
      //var instance = new CloudRunAdminApi.ListJobsResponse();
      //expect(instance).to.be.a(CloudRunAdminApi.ListJobsResponse);
    });
