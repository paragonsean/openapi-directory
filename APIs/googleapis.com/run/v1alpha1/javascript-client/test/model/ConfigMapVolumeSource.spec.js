...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudRunAdminApi.ConfigMapVolumeSource();
  });
  ...
  describe('ConfigMapVolumeSource', function() {
    it('should create an instance of ConfigMapVolumeSource', function() {
      // uncomment below and update the code to test ConfigMapVolumeSource
      //var instance = new CloudRunAdminApi.ConfigMapVolumeSource();
      //expect(instance).to.be.a(CloudRunAdminApi.ConfigMapVolumeSource);
    });
