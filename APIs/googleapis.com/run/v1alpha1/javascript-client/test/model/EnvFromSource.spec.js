...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudRunAdminApi.EnvFromSource();
  });
  ...
  describe('EnvFromSource', function() {
    it('should create an instance of EnvFromSource', function() {
      // uncomment below and update the code to test EnvFromSource
      //var instance = new CloudRunAdminApi.EnvFromSource();
      //expect(instance).to.be.a(CloudRunAdminApi.EnvFromSource);
    });
