...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudRunAdminApi.JobCondition();
  });
  ...
  describe('JobCondition', function() {
    it('should create an instance of JobCondition', function() {
      // uncomment below and update the code to test JobCondition
      //var instance = new CloudRunAdminApi.JobCondition();
      //expect(instance).to.be.a(CloudRunAdminApi.JobCondition);
    });
