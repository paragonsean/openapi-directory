...
|------------ | ------------- | ------------- | -------------|
|**active** | **Integer** | Optional. The number of actively running instances. +optional |  [optional] |
...
|**failed** | **Integer** | Optional. The number of instances which reached phase Failed. +optional |  [optional] |
...
|**observedGeneration** | **Integer** | Optional. The &#39;generation&#39; of the job that was last processed by the controller. |  [optional] |
...
|**succeeded** | **Integer** | Optional. The number of instances which reached phase Succeeded. +optional |  [optional] |
