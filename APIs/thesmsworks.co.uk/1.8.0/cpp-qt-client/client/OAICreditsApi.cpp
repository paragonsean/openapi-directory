...
void OAICreditsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("creditsBalanceGet", defaultConf);
    _serverIndices.insert("creditsBalanceGet", 0);
}
...
void OAICreditsApi::creditsBalanceGet() {
    QString fullPath = QString(_serverConfigs["creditsBalanceGet"][_serverIndices.value("creditsBalanceGet")].URL()+"/credits/balance");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICreditsApi::creditsBalanceGetCallback);
...
void OAICreditsApi::creditsBalanceGetCallback(OAIHttpRequestWorker *worker) {
    ...
    OAICreditsResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT creditsBalanceGetSignal(output);
        Q_EMIT creditsBalanceGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT creditsBalanceGetSignalE(output, error_type, error_str);
        Q_EMIT creditsBalanceGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT creditsBalanceGetSignalError(output, error_type, error_str);
        Q_EMIT creditsBalanceGetSignalErrorFull(worker, error_type, error_str);
    }
}
