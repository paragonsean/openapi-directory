...
public class ScheduledBatchResponse {
  ...
  public ScheduledBatchResponse() {
  }

  public ScheduledBatchResponse batchid(String batchid) {
  ...
  public ScheduledBatchResponse status(String status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ScheduledBatchResponse scheduledBatchResponse = (ScheduledBatchResponse) o;
    return Objects.equals(this.batchid, scheduledBatchResponse.batchid) &&
        Objects.equals(this.status, scheduledBatchResponse.status);
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ScheduledBatchResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ScheduledBatchResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ScheduledBatchResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ScheduledBatchResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ScheduledBatchResponse>() {
           @Override
           public void write(JsonWriter out, ScheduledBatchResponse value) throws IOException {
  ...
  /**
   * Create an instance of ScheduledBatchResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ScheduledBatchResponse
   * @throws IOException if the JSON string is invalid with respect to ScheduledBatchResponse
   */
  public static ScheduledBatchResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ScheduledBatchResponse.class);
  }

  /**
   * Convert an instance of ScheduledBatchResponse to an JSON string
   *
   * @return JSON string
   */
