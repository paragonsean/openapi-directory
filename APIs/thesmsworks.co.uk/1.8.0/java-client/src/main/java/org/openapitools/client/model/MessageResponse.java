...
public class MessageResponse {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(batchid, content, created, customerid, deliveryreporturl, destination, failurereason, id, identifier, keyword, messageid, modified, schedule, sender, status, tag);
  }
