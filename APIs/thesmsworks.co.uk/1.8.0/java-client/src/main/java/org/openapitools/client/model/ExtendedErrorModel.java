...
public class ExtendedErrorModel {
  ...
  public ExtendedErrorModel permanent(Boolean permanent) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.message, extendedErrorModel.message) &&
        ...
        Objects.equals(this.permanent, extendedErrorModel.permanent) &&
        Objects.equals(this.status, extendedErrorModel.status);
  }

  @Override
  public int hashCode() {
    return Objects.hash(message, errorCode, permanent, status);
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExtendedErrorModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExtendedErrorModel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExtendedErrorModel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExtendedErrorModel.class));

       return (TypeAdapter<T>) new TypeAdapter<ExtendedErrorModel>() {
           @Override
           public void write(JsonWriter out, ExtendedErrorModel value) throws IOException {
  ...
  /**
   * Create an instance of ExtendedErrorModel given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExtendedErrorModel
   * @throws IOException if the JSON string is invalid with respect to ExtendedErrorModel
   */
  public static ExtendedErrorModel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExtendedErrorModel.class);
  }

  /**
   * Convert an instance of ExtendedErrorModel to an JSON string
   *
   * @return JSON string
   */
