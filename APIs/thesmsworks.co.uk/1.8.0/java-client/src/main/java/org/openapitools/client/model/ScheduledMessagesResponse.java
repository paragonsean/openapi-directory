...
public class ScheduledMessagesResponse {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.batch, scheduledMessagesResponse.batch) &&
        Objects.equals(this.id, scheduledMessagesResponse.id) &&
        Objects.equals(this.message, scheduledMessagesResponse.message) &&
        Objects.equals(this.status, scheduledMessagesResponse.status);
  }

  @Override
  public int hashCode() {
    return Objects.hash(batch, id, message, status);
  }
