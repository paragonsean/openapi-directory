...
public class BatchMessageResponse {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BatchMessageResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BatchMessageResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BatchMessageResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BatchMessageResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<BatchMessageResponse>() {
           @Override
           public void write(JsonWriter out, BatchMessageResponse value) throws IOException {
  ...
  /**
   * Create an instance of BatchMessageResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BatchMessageResponse
   * @throws IOException if the JSON string is invalid with respect to BatchMessageResponse
   */
  public static BatchMessageResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BatchMessageResponse.class);
  }

  /**
   * Convert an instance of BatchMessageResponse to an JSON string
   *
   * @return JSON string
   */
