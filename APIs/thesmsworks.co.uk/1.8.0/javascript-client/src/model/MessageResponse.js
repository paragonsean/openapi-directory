...
class MessageResponse {
     ...
     * @param tag {String} 
     */
    constructor(content, created, customerid, destination, messageid, modified, schedule, sender, status, tag) { 
        
        MessageResponse.initialize(this, content, created, customerid, destination, messageid, modified, schedule, sender, status, tag);
    }
     ...
     */
    static initialize(obj, content, created, customerid, destination, messageid, modified, schedule, sender, status, tag) { 
        obj['content'] = content;
        obj['created'] = created;
...
MessageResponse.RequiredProperties = ["content", "created", "customerid", "destination", "messageid", "modified", "schedule", "sender", "status", "tag"];
