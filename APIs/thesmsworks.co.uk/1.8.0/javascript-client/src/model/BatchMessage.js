...
class BatchMessage {
     ...
     */
    constructor(content, destinations, sender) { 
        
        BatchMessage.initialize(this, content, destinations, sender);
    }
     ...
     */
    static initialize(obj, content, destinations, sender) { 
        obj['content'] = content;
...
BatchMessage.RequiredProperties = ["content", "destinations", "sender"];
