...
class Message {
     ...
     */
    constructor(content, destination, sender) { 
        
        Message.initialize(this, content, destination, sender);
    }
     ...
     */
    static initialize(obj, content, destination, sender) { 
        obj['content'] = content;
...
Message.RequiredProperties = ["content", "destination", "sender"];
