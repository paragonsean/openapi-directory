...
class SendMessageResponse {
     ...
     * @param status {String} 
     */
    constructor(credits, creditsUsed, messageid, status) { 
        
        SendMessageResponse.initialize(this, credits, creditsUsed, messageid, status);
    }
     ...
     */
    static initialize(obj, credits, creditsUsed, messageid, status) { 
        obj['credits'] = credits;
...
SendMessageResponse.RequiredProperties = ["credits", "creditsUsed", "messageid", "status"];
