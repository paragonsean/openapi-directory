...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheSmsWorksApi.ExtendedErrorModel();
  });
  ...
  describe('ExtendedErrorModel', function() {
    it('should create an instance of ExtendedErrorModel', function() {
      // uncomment below and update the code to test ExtendedErrorModel
      //var instance = new TheSmsWorksApi.ExtendedErrorModel();
      //expect(instance).to.be.a(TheSmsWorksApi.ExtendedErrorModel);
    });
