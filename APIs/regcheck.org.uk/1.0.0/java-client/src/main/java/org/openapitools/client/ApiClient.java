...
public class ApiClient {
    ...
    private String basePath = "https://regcheck.local/infiniteloopltd/CarRegistration/1.0.0";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://regcheck.local/infiniteloopltd/CarRegistration/1.0.0",
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://regcheck.local/infiniteloopltd/CarRegistration/1.0.0
