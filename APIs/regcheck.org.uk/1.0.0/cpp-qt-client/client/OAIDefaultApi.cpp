...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("https://regcheck.local/infiniteloopltd/CarRegistration/1.0.0"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("check", defaultConf);
    _serverIndices.insert("check", 0);
}
...
void OAIDefaultApi::check(const QString &search_string) {
    QString fullPath = QString(_serverConfigs["check"][_serverIndices.value("check")].URL()+"/Check");
    ...
    
    {
        ...
        fullPath.append(QUrl::toPercentEncoding("searchString")).append(querySuffix).append(QUrl::toPercentEncoding(search_string));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::checkCallback);
...
void OAIDefaultApi::checkCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT checkSignal(output);
        Q_EMIT checkSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT checkSignalE(output, error_type, error_str);
        Q_EMIT checkSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT checkSignalError(output, error_type, error_str);
        Q_EMIT checkSignalErrorFull(worker, error_type, error_str);
    }
}
