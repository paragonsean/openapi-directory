...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::checkSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::checkSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      QString search_string = create(); // QString | A registration number
      apiInstance.check(search_string);
