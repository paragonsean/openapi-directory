...
/**
* Car Registration API, An API that retrieves car information from its numberplate in many countries worldwide, uncluding the USA, UK, India, Australia and most of Europe. A username and password is required to access the API, which can be obtained from www.carregistrationapi.com - Use https://www.regcheck.org.uk/api/json.aspx/ as the root of all API calls..<br>
* The <code>index</code> module provides access to constructors for all the classes which comprise the public API.
* <p>
* An AMD (recommended!) or CommonJS application will generally do something equivalent to the following:
* <pre>
* var CarRegistrationApi = require('index'); // See note below*.
* var xxxSvc = new CarRegistrationApi.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new CarRegistrationApi.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new CarRegistrationApi.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new CarRegistrationApi.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
