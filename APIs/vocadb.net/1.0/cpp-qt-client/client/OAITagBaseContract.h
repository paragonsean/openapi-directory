...
/*
 * OAITagBaseContract.h
 *
 * 
 */

#ifndef OAITagBaseContract_H
#define OAITagBaseContract_H
...
class OAITagBaseContract : public OAIObject {
public:
    OAITagBaseContract();
    OAITagBaseContract(QString json);
    ~OAITagBaseContract() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITagBaseContract)

#endif // OAITagBaseContract_H
