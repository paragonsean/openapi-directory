...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VocaDbWeb.ArtistContract();
  });
  ...
  describe('ArtistContract', function() {
    it('should create an instance of ArtistContract', function() {
      // uncomment below and update the code to test ArtistContract
      //var instance = new VocaDbWeb.ArtistContract();
      //expect(instance).to.be.a(VocaDbWeb.ArtistContract);
    });
