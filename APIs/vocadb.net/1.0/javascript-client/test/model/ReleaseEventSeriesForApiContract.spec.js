...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VocaDbWeb.ReleaseEventSeriesForApiContract();
  });
  ...
  describe('ReleaseEventSeriesForApiContract', function() {
    it('should create an instance of ReleaseEventSeriesForApiContract', function() {
      // uncomment below and update the code to test ReleaseEventSeriesForApiContract
      //var instance = new VocaDbWeb.ReleaseEventSeriesForApiContract();
      //expect(instance).to.be.a(VocaDbWeb.ReleaseEventSeriesForApiContract);
    });
