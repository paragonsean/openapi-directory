...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VocaDbWeb.OptionalDateTimeContract();
  });
  ...
  describe('OptionalDateTimeContract', function() {
    it('should create an instance of OptionalDateTimeContract', function() {
      // uncomment below and update the code to test OptionalDateTimeContract
      //var instance = new VocaDbWeb.OptionalDateTimeContract();
      //expect(instance).to.be.a(VocaDbWeb.OptionalDateTimeContract);
    });
