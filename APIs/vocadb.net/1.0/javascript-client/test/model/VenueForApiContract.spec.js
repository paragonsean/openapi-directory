...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VocaDbWeb.VenueForApiContract();
  });
  ...
  describe('VenueForApiContract', function() {
    it('should create an instance of VenueForApiContract', function() {
      // uncomment below and update the code to test VenueForApiContract
      //var instance = new VocaDbWeb.VenueForApiContract();
      //expect(instance).to.be.a(VocaDbWeb.VenueForApiContract);
    });
