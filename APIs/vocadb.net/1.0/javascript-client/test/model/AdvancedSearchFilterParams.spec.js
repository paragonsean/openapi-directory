...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VocaDbWeb.AdvancedSearchFilterParams();
  });
  ...
  describe('AdvancedSearchFilterParams', function() {
    it('should create an instance of AdvancedSearchFilterParams', function() {
      // uncomment below and update the code to test AdvancedSearchFilterParams
      //var instance = new VocaDbWeb.AdvancedSearchFilterParams();
      //expect(instance).to.be.a(VocaDbWeb.AdvancedSearchFilterParams);
    });
