...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VocaDbWeb.VenueContract();
  });
  ...
  describe('VenueContract', function() {
    it('should create an instance of VenueContract', function() {
      // uncomment below and update the code to test VenueContract
      //var instance = new VocaDbWeb.VenueContract();
      //expect(instance).to.be.a(VocaDbWeb.VenueContract);
    });
    ...
    it('should have the property addressCountryCode (base name: "addressCountryCode")', function() {
      // uncomment below and update the code to test the property addressCountryCode
      //var instance = new VocaDbWeb.VenueContract();
      //expect(instance).to.be();
    });
