...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VocaDbWeb.AlbumReviewContract();
  });
  ...
  describe('AlbumReviewContract', function() {
    it('should create an instance of AlbumReviewContract', function() {
      // uncomment below and update the code to test AlbumReviewContract
      //var instance = new VocaDbWeb.AlbumReviewContract();
      //expect(instance).to.be.a(VocaDbWeb.AlbumReviewContract);
    });
