...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VocaDbWeb.ArtistForEventContract();
  });
  ...
  describe('ArtistForEventContract', function() {
    it('should create an instance of ArtistForEventContract', function() {
      // uncomment below and update the code to test ArtistForEventContract
      //var instance = new VocaDbWeb.ArtistForEventContract();
      //expect(instance).to.be.a(VocaDbWeb.ArtistForEventContract);
    });
