...
|**exchangeRate** | **Integer** | **exchange rate** applied to the pricing |  [optional] |
|**hasVoucher** | **Boolean** | **indicator**: &#x60;true&#x60; if a voucher exists |  [optional] |
|**itemSummaries** | [**List&lt;BookingMybookings200ResponseAllOfDataItemSummariesInner&gt;**](BookingMybookings200ResponseAllOfDataItemSummariesInner.md) | **array** of item summary objects |  [optional] |
|**itineraryId** | **Integer** | ignore (Viator only) |  [optional] |
|**rulesApplied** | **String** | ignore (Viator only) |  [optional] |
|**sortOrder** | **Integer** | **sort order** for the booking object |  [optional] |
