...
|**lastRetailPrice** | **BigDecimal** | **numeric last retail price** of *this* item |  [optional] |
...
|**price** | **BigDecimal** | **numeric merchant total price** for the booked product - For more information, see: [Merchant pricing](#section/Merchant-APIs/Merchant-pricing)  |  [optional] |
...
|**priceUSD** | **BigDecimal** | **numeric merchant total price** of the item in USD |  [optional] |
