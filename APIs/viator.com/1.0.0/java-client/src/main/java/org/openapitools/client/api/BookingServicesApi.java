...
import org.openapitools.client.model.BookingAvailability200Response;
import org.openapitools.client.model.BookingAvailabilityDates200Response;
import org.openapitools.client.model.BookingAvailabilityRequest;
import org.openapitools.client.model.BookingAvailabilityTourgrades200Response;
import org.openapitools.client.model.BookingAvailabilityTourgradesPricingmatrix200Response;
import org.openapitools.client.model.BookingAvailabilityTourgradesPricingmatrixRequest;
import org.openapitools.client.model.BookingAvailabilityTourgradesRequest;
import org.openapitools.client.model.BookingBook200Response;
import org.openapitools.client.model.BookingBookRequest;
import org.openapitools.client.model.BookingCalculateprice200Response;
import org.openapitools.client.model.BookingCalculatepriceRequest;
import org.openapitools.client.model.BookingHotels200Response;
import org.openapitools.client.model.BookingMybookings200Response;
import org.openapitools.client.model.BookingPastbooking200Response;
import org.openapitools.client.model.BookingPricingmatrix200Response;
import org.openapitools.client.model.BookingPricingmatrixRequest;
import org.openapitools.client.model.BookingStatus200Response;
import org.openapitools.client.model.BookingStatusItems200Response;
import org.openapitools.client.model.BookingStatusItemsRequest;
import org.openapitools.client.model.BookingStatusRequest;
import org.openapitools.client.model.BookingVoucher200Response;
import org.openapitools.client.model.CancelBooking400Response;
import org.openapitools.client.model.CancelBooking404Response;
import org.openapitools.client.model.CancelBookingQuoteResponse;
import org.openapitools.client.model.CancelBookingResponse;
import org.openapitools.client.model.CancellationReasonsResponse;
import org.openapitools.client.model.CancellationRequest;
import org.openapitools.client.model.Model401UNAUTHORIZED;
import org.openapitools.client.model.Model406NOTACCEPTABLE;
import org.openapitools.client.model.Model500INTERNALSERVERERROR;
import org.openapitools.client.model.Model503SERVICEUNAVAILABLE;
...
public class BookingServicesApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public BookingServicesApi() {
        this(Configuration.getDefaultApiClient());
    }

    public BookingServicesApi(ApiClient apiClient) {
    ...
    /**
     * Build call for bookingAvailability
     * @param acceptLanguage Specifies the language into which the natural-language fields in the response from this service will be translated (see [Accept-Language header](#section/Appendices/Accept-Language-header) for available langage codes)  (required)
     * @param bookingAvailabilityRequest  (optional)
     ...
     */
    public okhttp3.Call bookingAvailabilityCall(String acceptLanguage, BookingAvailabilityRequest bookingAvailabilityRequest, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = bookingAvailabilityRequest;

        // create path and map variables
        String localVarPath = "/booking/availability";
        ...
        String[] localVarAuthNames = new String[] { "Legacy-API-key", "API-key" };
        return localVarApiClient.buildCall(basePath, localVarPath, "POST", localVarQueryParams, localVarCollectionQueryParams, localVarPostBody, localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAuthNames, _callback);
    }

    @SuppressWarnings("rawtypes")
    private okhttp3.Call bookingAvailabilityValidateBeforeCall(String acceptLanguage, BookingAvailabilityRequest bookingAvailabilityRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'acceptLanguage' is set
        if (acceptLanguage == null) {
            throw new ApiException("Missing the required parameter 'acceptLanguage' when calling bookingAvailability(Async)");
        }

        return bookingAvailabilityCall(acceptLanguage, bookingAvailabilityRequest, _callback);
     ...
     * @param acceptLanguage Specifies the language into which the natural-language fields in the response from this service will be translated (see [Accept-Language header](#section/Appendices/Accept-Language-header) for available langage codes)  (required)
     * @param bookingAvailabilityRequest  (optional)
     * @return BookingAvailability200Response
     ...
     */
    public BookingAvailability200Response bookingAvailability(String acceptLanguage, BookingAvailabilityRequest bookingAvailabilityRequest) throws ApiException {
        ApiResponse<BookingAvailability200Response> localVarResp = bookingAvailabilityWithHttpInfo(acceptLanguage, bookingAvailabilityRequest);
     ...
     * @param acceptLanguage Specifies the language into which the natural-language fields in the response from this service will be translated (see [Accept-Language header](#section/Appendices/Accept-Language-header) for available langage codes)  (required)
     * @param bookingAvailabilityRequest  (optional)
     * @return ApiResponse&lt;BookingAvailability200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<BookingAvailability200Response> bookingAvailabilityWithHttpInfo(String acceptLanguage, BookingAvailabilityRequest bookingAvailabilityRequest) throws ApiException {
        okhttp3.Call localVarCall = bookingAvailabilityValidateBeforeCall(acceptLanguage, bookingAvailabilityRequest, null);
        Type localVarReturnType = new TypeToken<BookingAvailability200Response>(){}.getType();
     ...
     */
    public okhttp3.Call bookingAvailabilityAsync(String acceptLanguage, BookingAvailabilityRequest bookingAvailabilityRequest, final ApiCallback<BookingAvailability200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = bookingAvailabilityValidateBeforeCall(acceptLanguage, bookingAvailabilityRequest, _callback);
        Type localVarReturnType = new TypeToken<BookingAvailability200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for bookingAvailabilityDates
     * @param acceptLanguage Specifies the language into which the natural-language fields in the response from this service will be translated (see [Accept-Language header](#section/Appendices/Accept-Language-header) for available langage codes)  (required)
     * @param productCode **unique alphanumeric identifier** of the product (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call bookingAvailabilityDatesCall(String acceptLanguage, String productCode, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/booking/availability/dates";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call bookingAvailabilityDatesValidateBeforeCall(String acceptLanguage, String productCode, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'acceptLanguage' is set
        if (acceptLanguage == null) {
            throw new ApiException("Missing the required parameter 'acceptLanguage' when calling bookingAvailabilityDates(Async)");
        }

        return bookingAvailabilityDatesCall(acceptLanguage, productCode, _callback);
     ...
     * @param acceptLanguage Specifies the language into which the natural-language fields in the response from this service will be translated (see [Accept-Language header](#section/Appendices/Accept-Language-header) for available langage codes)  (required)
     * @param productCode **unique alphanumeric identifier** of the product (optional)
     * @return BookingAvailabilityDates200Response
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public BookingAvailabilityDates200Response bookingAvailabilityDates(String acceptLanguage, String productCode) throws ApiException {
        ApiResponse<BookingAvailabilityDates200Response> localVarResp = bookingAvailabilityDatesWithHttpInfo(acceptLanguage, productCode);
        return localVarResp.getData();
    }
     ...
     * @param acceptLanguage Specifies the language into which the natural-language fields in the response from this service will be translated (see [Accept-Language header](#section/Appendices/Accept-Language-header) for available langage codes)  (required)
     * @param productCode **unique alphanumeric identifier** of the product (optional)
     * @return ApiResponse&lt;BookingAvailabilityDates200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<BookingAvailabilityDates200Response> bookingAvailabilityDatesWithHttpInfo(String acceptLanguage, String productCode) throws ApiException {
        okhttp3.Call localVarCall = bookingAvailabilityDatesValidateBeforeCall(acceptLanguage, productCode, null);
        Type localVarReturnType = new TypeToken<BookingAvailabilityDates200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * /booking/availability/dates (asynchronously)
     * Get dates on which a product is available  This service: - retrieves all available dates for a product, excluding days it does not operate and blocked-out dates - returns a multi-dimensional array of year-month -&amp;gt; days that have any availabile tour grade or traveler mix - useful to present the user with a list of dates for selection on which *this* product is available for booking - **Notes**:     - The user&#39;s desired traveler mix may not be eligible for booking; these details can be displayed when you retrieve its list of tour grades   - Availability data is limited to a period of **12 months** into the future from the present time on the production server and **6 months** on the sandbox server.  
     * @param acceptLanguage Specifies the language into which the natural-language fields in the response from this service will be translated (see [Accept-Language header](#section/Appendices/Accept-Language-header) for available langage codes)  (required)
     * @param productCode **unique alphanumeric identifier** of the product (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call bookingAvailabilityDatesAsync(String acceptLanguage, String productCode, final ApiCallback<BookingAvailabilityDates200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = bookingAvailabilityDatesValidateBeforeCall(acceptLanguage, productCode, _callback);
        Type localVarReturnType = new TypeToken<BookingAvailabilityDates200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for bookingAvailabilityTourgrades
     * @param acceptLanguage Specifies the language into which the natural-language fields in the response from this service will be translated (see [Accept-Language header](#section/Appendices/Accept-Language-header) for available langage codes)  (required)
     * @param bookingAvailabilityTourgradesRequest  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call bookingAvailabilityTourgradesCall(String acceptLanguage, BookingAvailabilityTourgradesRequest bookingAvailabilityTourgradesRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = bookingAvailabilityTourgradesRequest;

        // create path and map variables
        String localVarPath = "/booking/availability/tourgrades";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call bookingAvailabilityTourgradesValidateBeforeCall(String acceptLanguage, BookingAvailabilityTourgradesRequest bookingAvailabilityTourgradesRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'acceptLanguage' is set
        if (acceptLanguage == null) {
            throw new ApiException("Missing the required parameter 'acceptLanguage' when calling bookingAvailabilityTourgrades(Async)");
        }

        return bookingAvailabilityTourgradesCall(acceptLanguage, bookingAvailabilityTourgradesRequest, _callback);
     ...
     * @param acceptLanguage Specifies the language into which the natural-language fields in the response from this service will be translated (see [Accept-Language header](#section/Appendices/Accept-Language-header) for available langage codes)  (required)
     * @param bookingAvailabilityTourgradesRequest  (optional)
     * @return BookingAvailabilityTourgrades200Response
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public BookingAvailabilityTourgrades200Response bookingAvailabilityTourgrades(String acceptLanguage, BookingAvailabilityTourgradesRequest bookingAvailabilityTourgradesRequest) throws ApiException {
        ApiResponse<BookingAvailabilityTourgrades200Response> localVarResp = bookingAvailabilityTourgradesWithHttpInfo(acceptLanguage, bookingAvailabilityTourgradesRequest);
        return localVarResp.getData();
    }
     ...
     * @param acceptLanguage Specifies the language into which the natural-language fields in the response from this service will be translated (see [Accept-Language header](#section/Appendices/Accept-Language-header) for available langage codes)  (required)
     * @param bookingAvailabilityTourgradesRequest  (optional)
     * @return ApiResponse&lt;BookingAvailabilityTourgrades200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<BookingAvailabilityTourgrades200Response> bookingAvailabilityTourgradesWithHttpInfo(String acceptLanguage, BookingAvailabilityTourgradesRequest bookingAvailabilityTourgradesRequest) throws ApiException {
        okhttp3.Call localVarCall = bookingAvailabilityTourgradesValidateBeforeCall(acceptLanguage, bookingAvailabilityTourgradesRequest, null);
        Type localVarReturnType = new TypeToken<BookingAvailabilityTourgrades200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * /booking/availability/tourgrades (asynchronously)
     * Get the tour grades of a product that are currently available  This service reports: - all tour grades for the specified product, on the specified day, that are available for the specified age bands - the pricing breakdown and the total depending on the travel date and traveler mix  **Note**: Availability data is limited to a period of **12 months** into the future from the present time on the production server and **6 months** on the sandbox server.  
     * @param acceptLanguage Specifies the language into which the natural-language fields in the response from this service will be translated (see [Accept-Language header](#section/Appendices/Accept-Language-header) for available langage codes)  (required)
     * @param bookingAvailabilityTourgradesRequest  (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call bookingAvailabilityTourgradesAsync(String acceptLanguage, BookingAvailabilityTourgradesRequest bookingAvailabilityTourgradesRequest, final ApiCallback<BookingAvailabilityTourgrades200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = bookingAvailabilityTourgradesValidateBeforeCall(acceptLanguage, bookingAvailabilityTourgradesRequest, _callback);
        Type localVarReturnType = new TypeToken<BookingAvailabilityTourgrades200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for bookingAvailabilityTourgradesPricingmatrix
     * @param acceptLanguage Specifies the language into which the natural-language fields in the response from this service will be translated (see [Accept-Language header](#section/Appendices/Accept-Language-header) for available langage codes)  (required)
     * @param bookingAvailabilityTourgradesPricingmatrixRequest  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call bookingAvailabilityTourgradesPricingmatrixCall(String acceptLanguage, BookingAvailabilityTourgradesPricingmatrixRequest bookingAvailabilityTourgradesPricingmatrixRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = bookingAvailabilityTourgradesPricingmatrixRequest;

        // create path and map variables
        String localVarPath = "/booking/availability/tourgrades/pricingmatrix";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call bookingAvailabilityTourgradesPricingmatrixValidateBeforeCall(String acceptLanguage, BookingAvailabilityTourgradesPricingmatrixRequest bookingAvailabilityTourgradesPricingmatrixRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'acceptLanguage' is set
        if (acceptLanguage == null) {
            throw new ApiException("Missing the required parameter 'acceptLanguage' when calling bookingAvailabilityTourgradesPricingmatrix(Async)");
        }

        return bookingAvailabilityTourgradesPricingmatrixCall(acceptLanguage, bookingAvailabilityTourgradesPricingmatrixRequest, _callback);
     ...
     * @param acceptLanguage Specifies the language into which the natural-language fields in the response from this service will be translated (see [Accept-Language header](#section/Appendices/Accept-Language-header) for available langage codes)  (required)
     * @param bookingAvailabilityTourgradesPricingmatrixRequest  (optional)
     * @return BookingAvailabilityTourgradesPricingmatrix200Response
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public BookingAvailabilityTourgradesPricingmatrix200Response bookingAvailabilityTourgradesPricingmatrix(String acceptLanguage, BookingAvailabilityTourgradesPricingmatrixRequest bookingAvailabilityTourgradesPricingmatrixRequest) throws ApiException {
        ApiResponse<BookingAvailabilityTourgradesPricingmatrix200Response> localVarResp = bookingAvailabilityTourgradesPricingmatrixWithHttpInfo(acceptLanguage, bookingAvailabilityTourgradesPricingmatrixRequest);
        return localVarResp.getData();
    }
     ...
     * @param acceptLanguage Specifies the language into which the natural-language fields in the response from this service will be translated (see [Accept-Language header](#section/Appendices/Accept-Language-header) for available langage codes)  (required)
     * @param bookingAvailabilityTourgradesPricingmatrixRequest  (optional)
     * @return ApiResponse&lt;BookingAvailabilityTourgradesPricingmatrix200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<BookingAvailabilityTourgradesPricingmatrix200Response> bookingAvailabilityTourgradesPricingmatrixWithHttpInfo(String acceptLanguage, BookingAvailabilityTourgradesPricingmatrixRequest bookingAvailabilityTourgradesPricingmatrixRequest) throws ApiException {
        okhttp3.Call localVarCall = bookingAvailabilityTourgradesPricingmatrixValidateBeforeCall(acceptLanguage, bookingAvailabilityTourgradesPricingmatrixRequest, null);
        Type localVarReturnType = new TypeToken<BookingAvailabilityTourgradesPricingmatrix200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * /booking/availability/tourgrades/pricingmatrix (asynchronously)
     * Get a pricing matrix that includes availability and tour-grades for a product  Given a month, this service returns days with available tour grades only (i.e., days which have at least one tourgrade available), and the pricing matrix for that tour grade for that day.  - **Note**: Availability data is limited to a period of **12 months** into the future from the present time on the production server and **6 months** on the sandbox server.  
     * @param acceptLanguage Specifies the language into which the natural-language fields in the response from this service will be translated (see [Accept-Language header](#section/Appendices/Accept-Language-header) for available langage codes)  (required)
     * @param bookingAvailabilityTourgradesPricingmatrixRequest  (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call bookingAvailabilityTourgradesPricingmatrixAsync(String acceptLanguage, BookingAvailabilityTourgradesPricingmatrixRequest bookingAvailabilityTourgradesPricingmatrixRequest, final ApiCallback<BookingAvailabilityTourgradesPricingmatrix200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = bookingAvailabilityTourgradesPricingmatrixValidateBeforeCall(acceptLanguage, bookingAvailabilityTourgradesPricingmatrixRequest, _callback);
        Type localVarReturnType = new TypeToken<BookingAvailabilityTourgradesPricingmatrix200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for bookingBook
     * @param acceptLanguage Specifies the language into which the natural-language fields in the response from this service will be translated (see [Accept-Language header](#section/Appendices/Accept-Language-header) for available langage codes)  (required)
     * @param bookingBookRequest  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call bookingBookCall(String acceptLanguage, BookingBookRequest bookingBookRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = bookingBookRequest;

        // create path and map variables
        String localVarPath = "/booking/book";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call bookingBookValidateBeforeCall(String acceptLanguage, BookingBookRequest bookingBookRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'acceptLanguage' is set
        if (acceptLanguage == null) {
            throw new ApiException("Missing the required parameter 'acceptLanguage' when calling bookingBook(Async)");
        }

        return bookingBookCall(acceptLanguage, bookingBookRequest, _callback);
     ...
     */
    public BookingBook200Response bookingBook(String acceptLanguage, BookingBookRequest bookingBookRequest) throws ApiException {
        ApiResponse<BookingBook200Response> localVarResp = bookingBookWithHttpInfo(acceptLanguage, bookingBookRequest);
        return localVarResp.getData();
    }
     ...
     * @param acceptLanguage Specifies the language into which the natural-language fields in the response from this service will be translated (see [Accept-Language header](#section/Appendices/Accept-Language-header) for available langage codes)  (required)
     * @param bookingBookRequest  (optional)
     * @return ApiResponse&lt;BookingBook200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<BookingBook200Response> bookingBookWithHttpInfo(String acceptLanguage, BookingBookRequest bookingBookRequest) throws ApiException {
        okhttp3.Call localVarCall = bookingBookValidateBeforeCall(acceptLanguage, bookingBookRequest, null);
        Type localVarReturnType = new TypeToken<BookingBook200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * /booking/book (asynchronously)
     * Make a booking  For more information, see:     - [Cancellation policy](#section/Key-concepts/Cancellation-policy)   - [Booking concepts](#section/Key-concepts/Booking-concepts)   - [Booking process flow](#section/Common-workflows-and-data-validation/Booking-process-flow)   - [Making a booking](#section/Common-workflows-and-data-validation/Making-a-booking)   - [Supplier communications](#section/Key-concepts/Supplier-communications) 
     * @param acceptLanguage Specifies the language into which the natural-language fields in the response from this service will be translated (see [Accept-Language header](#section/Appendices/Accept-Language-header) for available langage codes)  (required)
     * @param bookingBookRequest  (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call bookingBookAsync(String acceptLanguage, BookingBookRequest bookingBookRequest, final ApiCallback<BookingBook200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = bookingBookValidateBeforeCall(acceptLanguage, bookingBookRequest, _callback);
        Type localVarReturnType = new TypeToken<BookingBook200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for bookingCalculateprice
     * @param acceptLanguage Specifies the language into which the natural-language fields in the response from this service will be translated (see [Accept-Language header](#section/Appendices/Accept-Language-header) for available langage codes)  (required)
     * @param bookingCalculatepriceRequest  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call bookingCalculatepriceCall(String acceptLanguage, BookingCalculatepriceRequest bookingCalculatepriceRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = bookingCalculatepriceRequest;

        // create path and map variables
        String localVarPath = "/booking/calculateprice";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call bookingCalculatepriceValidateBeforeCall(String acceptLanguage, BookingCalculatepriceRequest bookingCalculatepriceRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'acceptLanguage' is set
        if (acceptLanguage == null) {
            throw new ApiException("Missing the required parameter 'acceptLanguage' when calling bookingCalculateprice(Async)");
        }

        return bookingCalculatepriceCall(acceptLanguage, bookingCalculatepriceRequest, _callback);
     ...
     * @param acceptLanguage Specifies the language into which the natural-language fields in the response from this service will be translated (see [Accept-Language header](#section/Appendices/Accept-Language-header) for available langage codes)  (required)
     * @param bookingCalculatepriceRequest  (optional)
     * @return BookingCalculateprice200Response
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public BookingCalculateprice200Response bookingCalculateprice(String acceptLanguage, BookingCalculatepriceRequest bookingCalculatepriceRequest) throws ApiException {
        ApiResponse<BookingCalculateprice200Response> localVarResp = bookingCalculatepriceWithHttpInfo(acceptLanguage, bookingCalculatepriceRequest);
        return localVarResp.getData();
    }
     ...
     * @param acceptLanguage Specifies the language into which the natural-language fields in the response from this service will be translated (see [Accept-Language header](#section/Appendices/Accept-Language-header) for available langage codes)  (required)
     * @param bookingCalculatepriceRequest  (optional)
     * @return ApiResponse&lt;BookingCalculateprice200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<BookingCalculateprice200Response> bookingCalculatepriceWithHttpInfo(String acceptLanguage, BookingCalculatepriceRequest bookingCalculatepriceRequest) throws ApiException {
        okhttp3.Call localVarCall = bookingCalculatepriceValidateBeforeCall(acceptLanguage, bookingCalculatepriceRequest, null);
        Type localVarReturnType = new TypeToken<BookingCalculateprice200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * /booking/calculateprice (asynchronously)
     * Confirm the price of a tour / activity prior to booking  For more information, see: [Calculating prices](#section/Common-workflows-and-data-validation/Calculating-prices)    - **Note**: Availability and pricing data is limited to a period of **six months** into the future from the present time 
     * @param acceptLanguage Specifies the language into which the natural-language fields in the response from this service will be translated (see [Accept-Language header](#section/Appendices/Accept-Language-header) for available langage codes)  (required)
     * @param bookingCalculatepriceRequest  (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call bookingCalculatepriceAsync(String acceptLanguage, BookingCalculatepriceRequest bookingCalculatepriceRequest, final ApiCallback<BookingCalculateprice200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = bookingCalculatepriceValidateBeforeCall(acceptLanguage, bookingCalculatepriceRequest, _callback);
        Type localVarReturnType = new TypeToken<BookingCalculateprice200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for bookingHotels
     * @param acceptLanguage Specifies the language into which the natural-language fields in the response from this service will be translated (see [Accept-Language header](#section/Appendices/Accept-Language-header) for available langage codes)  (required)
     * @param productCode **unique alphanumeric identifier** of the product (optional)
     * @param destId **unique numeric identifier** of the destination (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call bookingHotelsCall(String acceptLanguage, String productCode, Integer destId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/booking/hotels";
        ...
        if (destId != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("destId", destId));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call bookingHotelsValidateBeforeCall(String acceptLanguage, String productCode, Integer destId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'acceptLanguage' is set
        if (acceptLanguage == null) {
            throw new ApiException("Missing the required parameter 'acceptLanguage' when calling bookingHotels(Async)");
        }

        return bookingHotelsCall(acceptLanguage, productCode, destId, _callback);
     ...
     * @param productCode **unique alphanumeric identifier** of the product (optional)
     * @param destId **unique numeric identifier** of the destination (optional)
     * @return BookingHotels200Response
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public BookingHotels200Response bookingHotels(String acceptLanguage, String productCode, Integer destId) throws ApiException {
        ApiResponse<BookingHotels200Response> localVarResp = bookingHotelsWithHttpInfo(acceptLanguage, productCode, destId);
        return localVarResp.getData();
    }
     ...
     * @param productCode **unique alphanumeric identifier** of the product (optional)
     * @param destId **unique numeric identifier** of the destination (optional)
     * @return ApiResponse&lt;BookingHotels200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<BookingHotels200Response> bookingHotelsWithHttpInfo(String acceptLanguage, String productCode, Integer destId) throws ApiException {
        okhttp3.Call localVarCall = bookingHotelsValidateBeforeCall(acceptLanguage, productCode, destId, null);
        Type localVarReturnType = new TypeToken<BookingHotels200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * /booking/hotels (asynchronously)
     * Get hotel pick-ups Lists the hotel pickups available for either a product or a destination 
     * @param acceptLanguage Specifies the language into which the natural-language fields in the response from this service will be translated (see [Accept-Language header](#section/Appendices/Accept-Language-header) for available langage codes)  (required)
     * @param productCode **unique alphanumeric identifier** of the product (optional)
     * @param destId **unique numeric identifier** of the destination (optional)
     ...
     */
    public okhttp3.Call bookingHotelsAsync(String acceptLanguage, String productCode, Integer destId, final ApiCallback<BookingHotels200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = bookingHotelsValidateBeforeCall(acceptLanguage, productCode, destId, _callback);
        Type localVarReturnType = new TypeToken<BookingHotels200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for bookingMybookings
     * @param acceptLanguage Specifies the language into which the natural-language fields in the response from this service will be translated (see [Accept-Language header](#section/Appendices/Accept-Language-header) for available langage codes)  (required)
     * @param voucherKey **voucher key** for the booking (optional)
     * @param email **email address** of the booker for the booking (optional)
     * @param itineraryOrItemId The booking reference number of the item - **Note**: For more information, see [Booking references](#section/Key-concepts/Booking-references)  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call bookingMybookingsCall(String acceptLanguage, String voucherKey, String email, String itineraryOrItemId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/booking/mybookings";
        ...
        if (voucherKey != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("voucherKey", voucherKey));
        }
        ...
        if (itineraryOrItemId != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("itineraryOrItemId", itineraryOrItemId));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call bookingMybookingsValidateBeforeCall(String acceptLanguage, String voucherKey, String email, String itineraryOrItemId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'acceptLanguage' is set
        if (acceptLanguage == null) {
            throw new ApiException("Missing the required parameter 'acceptLanguage' when calling bookingMybookings(Async)");
        }

        return bookingMybookingsCall(acceptLanguage, voucherKey, email, itineraryOrItemId, _callback);
     ...
     * @param email **email address** of the booker for the booking (optional)
     * @param itineraryOrItemId The booking reference number of the item - **Note**: For more information, see [Booking references](#section/Key-concepts/Booking-references)  (optional)
     * @return BookingMybookings200Response
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public BookingMybookings200Response bookingMybookings(String acceptLanguage, String voucherKey, String email, String itineraryOrItemId) throws ApiException {
        ApiResponse<BookingMybookings200Response> localVarResp = bookingMybookingsWithHttpInfo(acceptLanguage, voucherKey, email, itineraryOrItemId);
        return localVarResp.getData();
    }
     ...
     * @param email **email address** of the booker for the booking (optional)
     * @param itineraryOrItemId The booking reference number of the item - **Note**: For more information, see [Booking references](#section/Key-concepts/Booking-references)  (optional)
     * @return ApiResponse&lt;BookingMybookings200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<BookingMybookings200Response> bookingMybookingsWithHttpInfo(String acceptLanguage, String voucherKey, String email, String itineraryOrItemId) throws ApiException {
        okhttp3.Call localVarCall = bookingMybookingsValidateBeforeCall(acceptLanguage, voucherKey, email, itineraryOrItemId, null);
        Type localVarReturnType = new TypeToken<BookingMybookings200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * /booking/mybookings (asynchronously)
     * Get a user&#39;s bookings with travel dates in the future.   This service can also be used to check the status of a booking.   **Provide either:**  - A &#x60;voucherKey&#x60;, **or...**  - An email address (&#x60;email&#x60;) and a booking reference (&#x60;itineraryOrItemId&#x60;) ([Booking Reference](#section/Key-concepts/Booking-references)) 
     * @param acceptLanguage Specifies the language into which the natural-language fields in the response from this service will be translated (see [Accept-Language header](#section/Appendices/Accept-Language-header) for available langage codes)  (required)
     * @param voucherKey **voucher key** for the booking (optional)
     * @param email **email address** of the booker for the booking (optional)
     ...
     */
    public okhttp3.Call bookingMybookingsAsync(String acceptLanguage, String voucherKey, String email, String itineraryOrItemId, final ApiCallback<BookingMybookings200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = bookingMybookingsValidateBeforeCall(acceptLanguage, voucherKey, email, itineraryOrItemId, _callback);
        Type localVarReturnType = new TypeToken<BookingMybookings200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for bookingPastbooking
     * @param acceptLanguage Specifies the language into which the natural-language fields in the response from this service will be translated (see [Accept-Language header](#section/Appendices/Accept-Language-header) for available langage codes)  (required)
     * @param voucherKey **specifier** of past booking type (use *one* of: &#x60;itemId&#x60; (booking reference) *and* &#x60;&#39;voucherKey&#39;&#x60; *or* &#x60;&#39;email&#39;&#x60;) (optional)
     * @param email **email address** by which to search for past bookings (optional)
     * @param itemId Search for a booking with this **unique booking-reference number**. See [Booking references](#section/Key-concepts/Booking-references) for more information.  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call bookingPastbookingCall(String acceptLanguage, String voucherKey, String email, String itemId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/booking/pastbooking";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call bookingPastbookingValidateBeforeCall(String acceptLanguage, String voucherKey, String email, String itemId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'acceptLanguage' is set
        if (acceptLanguage == null) {
            throw new ApiException("Missing the required parameter 'acceptLanguage' when calling bookingPastbooking(Async)");
        }

        return bookingPastbookingCall(acceptLanguage, voucherKey, email, itemId, _callback);
     ...
     * @param email **email address** by which to search for past bookings (optional)
     * @param itemId Search for a booking with this **unique booking-reference number**. See [Booking references](#section/Key-concepts/Booking-references) for more information.  (optional)
     * @return BookingPastbooking200Response
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public BookingPastbooking200Response bookingPastbooking(String acceptLanguage, String voucherKey, String email, String itemId) throws ApiException {
        ApiResponse<BookingPastbooking200Response> localVarResp = bookingPastbookingWithHttpInfo(acceptLanguage, voucherKey, email, itemId);
        return localVarResp.getData();
    }
     ...
     * @param email **email address** by which to search for past bookings (optional)
     * @param itemId Search for a booking with this **unique booking-reference number**. See [Booking references](#section/Key-concepts/Booking-references) for more information.  (optional)
     * @return ApiResponse&lt;BookingPastbooking200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<BookingPastbooking200Response> bookingPastbookingWithHttpInfo(String acceptLanguage, String voucherKey, String email, String itemId) throws ApiException {
        okhttp3.Call localVarCall = bookingPastbookingValidateBeforeCall(acceptLanguage, voucherKey, email, itemId, null);
        Type localVarReturnType = new TypeToken<BookingPastbooking200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * /booking/pastbooking (asynchronously)
     * Get the details of a single specific past booking based on the &#x60;voucherKey&#x60; or &#x60;itemId&#x60; and email address sent in the request.  **Note**: this service will only return past bookings that were made with the same API key that was used to make the booking  **Sample query parameters**: - email&#x3D;apitest@viator.com&amp;amp;itemId&#x3D;580669678  **or** - voucherKey&#x3D;1005851866:4af44c13ecf3f1a7d3f9ef2fc00c2257e08fa42ae20f877f3039ff9b52aba24e:580669678  **email** - The email address passed must match the email address associated with the booking  **Departure details**  - Departure details such as the &#x60;departurePoint&#x60;, &#x60;departurePointAddress&#x60; and &#x60;departurePointDirections&#x60; is included in the response.  - These fields may contain HTML escape characters such as &amp;amp;amp; and special characters that are escaped by a backslash. Ensure that these fields are parsed after receiving the response as it will cause your JSON to be invalid.  For more information, see: [Reviewing bookings](#section/Common-workflows-and-data-validation/Reviewing-bookings) 
     * @param acceptLanguage Specifies the language into which the natural-language fields in the response from this service will be translated (see [Accept-Language header](#section/Appendices/Accept-Language-header) for available langage codes)  (required)
     * @param voucherKey **specifier** of past booking type (use *one* of: &#x60;itemId&#x60; (booking reference) *and* &#x60;&#39;voucherKey&#39;&#x60; *or* &#x60;&#39;email&#39;&#x60;) (optional)
     * @param email **email address** by which to search for past bookings (optional)
     ...
     */
    public okhttp3.Call bookingPastbookingAsync(String acceptLanguage, String voucherKey, String email, String itemId, final ApiCallback<BookingPastbooking200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = bookingPastbookingValidateBeforeCall(acceptLanguage, voucherKey, email, itemId, _callback);
        Type localVarReturnType = new TypeToken<BookingPastbooking200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for bookingPricingmatrix
     * @param acceptLanguage Specifies the language into which the natural-language fields in the response from this service will be translated (see [Accept-Language header](#section/Appendices/Accept-Language-header) for available langage codes)  (required)
     * @param bookingPricingmatrixRequest  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call bookingPricingmatrixCall(String acceptLanguage, BookingPricingmatrixRequest bookingPricingmatrixRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = bookingPricingmatrixRequest;

        // create path and map variables
        String localVarPath = "/booking/pricingmatrix";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call bookingPricingmatrixValidateBeforeCall(String acceptLanguage, BookingPricingmatrixRequest bookingPricingmatrixRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'acceptLanguage' is set
        if (acceptLanguage == null) {
            throw new ApiException("Missing the required parameter 'acceptLanguage' when calling bookingPricingmatrix(Async)");
        }

        return bookingPricingmatrixCall(acceptLanguage, bookingPricingmatrixRequest, _callback);
     ...
     * @param acceptLanguage Specifies the language into which the natural-language fields in the response from this service will be translated (see [Accept-Language header](#section/Appendices/Accept-Language-header) for available langage codes)  (required)
     * @param bookingPricingmatrixRequest  (optional)
     * @return BookingPricingmatrix200Response
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public BookingPricingmatrix200Response bookingPricingmatrix(String acceptLanguage, BookingPricingmatrixRequest bookingPricingmatrixRequest) throws ApiException {
        ApiResponse<BookingPricingmatrix200Response> localVarResp = bookingPricingmatrixWithHttpInfo(acceptLanguage, bookingPricingmatrixRequest);
        return localVarResp.getData();
    }
     ...
     * @param acceptLanguage Specifies the language into which the natural-language fields in the response from this service will be translated (see [Accept-Language header](#section/Appendices/Accept-Language-header) for available langage codes)  (required)
     * @param bookingPricingmatrixRequest  (optional)
     * @return ApiResponse&lt;BookingPricingmatrix200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<BookingPricingmatrix200Response> bookingPricingmatrixWithHttpInfo(String acceptLanguage, BookingPricingmatrixRequest bookingPricingmatrixRequest) throws ApiException {
        okhttp3.Call localVarCall = bookingPricingmatrixValidateBeforeCall(acceptLanguage, bookingPricingmatrixRequest, null);
        Type localVarReturnType = new TypeToken<BookingPricingmatrix200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * /booking/pricingmatrix (asynchronously)
     * Get the pricing matrix for tour-grades, product age bands and pax mixes  For more information, see: [Get the tour-grade pricing matrix](#section/Common-workflows-and-data-validation/Get-the-tour-grade-pricing-matrix) 
     * @param acceptLanguage Specifies the language into which the natural-language fields in the response from this service will be translated (see [Accept-Language header](#section/Appendices/Accept-Language-header) for available langage codes)  (required)
     * @param bookingPricingmatrixRequest  (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call bookingPricingmatrixAsync(String acceptLanguage, BookingPricingmatrixRequest bookingPricingmatrixRequest, final ApiCallback<BookingPricingmatrix200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = bookingPricingmatrixValidateBeforeCall(acceptLanguage, bookingPricingmatrixRequest, _callback);
        Type localVarReturnType = new TypeToken<BookingPricingmatrix200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for bookingStatus
     * @param acceptLanguage Specifies the language into which the natural-language fields in the response from this service will be translated (see [Accept-Language header](#section/Appendices/Accept-Language-header) for available langage codes)  (required)
     * @param bookingStatusRequest  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call bookingStatusCall(String acceptLanguage, BookingStatusRequest bookingStatusRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = bookingStatusRequest;

        // create path and map variables
        String localVarPath = "/booking/status";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call bookingStatusValidateBeforeCall(String acceptLanguage, BookingStatusRequest bookingStatusRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'acceptLanguage' is set
        if (acceptLanguage == null) {
            throw new ApiException("Missing the required parameter 'acceptLanguage' when calling bookingStatus(Async)");
        }

        return bookingStatusCall(acceptLanguage, bookingStatusRequest, _callback);
     ...
     * @param acceptLanguage Specifies the language into which the natural-language fields in the response from this service will be translated (see [Accept-Language header](#section/Appendices/Accept-Language-header) for available langage codes)  (required)
     * @param bookingStatusRequest  (optional)
     * @return BookingStatus200Response
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public BookingStatus200Response bookingStatus(String acceptLanguage, BookingStatusRequest bookingStatusRequest) throws ApiException {
        ApiResponse<BookingStatus200Response> localVarResp = bookingStatusWithHttpInfo(acceptLanguage, bookingStatusRequest);
        return localVarResp.getData();
    }
     ...
     * @param acceptLanguage Specifies the language into which the natural-language fields in the response from this service will be translated (see [Accept-Language header](#section/Appendices/Accept-Language-header) for available langage codes)  (required)
     * @param bookingStatusRequest  (optional)
     * @return ApiResponse&lt;BookingStatus200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<BookingStatus200Response> bookingStatusWithHttpInfo(String acceptLanguage, BookingStatusRequest bookingStatusRequest) throws ApiException {
        okhttp3.Call localVarCall = bookingStatusValidateBeforeCall(acceptLanguage, bookingStatusRequest, null);
        Type localVarReturnType = new TypeToken<BookingStatus200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * /booking/status (asynchronously)
     * Get the booking status for multiple items based on different criteria  This service:  - is ideally be used in software for bulk updates of pending bookings - returns a maximum of 1000 bookings (narrow your search if you expect a greater number of results) - will return &amp;lt;u&amp;gt;both&amp;lt;/u&amp;gt; live &amp;lt;u&amp;gt;and&amp;lt;/u&amp;gt; test bookings - rate limited to &amp;lt;u&amp;gt;one request every 30 minutes&amp;lt;/u&amp;gt; - For more information, see: [Get the bookiing status for multiple items](#section/Common-workflows-and-data-validation/Get-the-booking-status-for-multiple-items)  **Exceeding the rate limit** - You will receive the following error message if you exceed the rate limit allowed for this service. Set &#x60;test&#x60; to &#x60;true&#x60; to bypass this limit: &#x60;&#x60;&#x60;javascript {     \&quot;data\&quot;: null     \&quot;vmid\&quot;: 221002     \&quot;errorMessage\&quot;: [\&quot;Access allowed every 30 minutes\&quot;]     \&quot;errorType\&quot;: \&quot;EXCEPTION\&quot;     \&quot;dateStamp\&quot;: \&quot;2013-03-26T10:28:51+0000\&quot;     \&quot;errorReference\&quot;: 55315512721712161381352771     \&quot;errorMessageText\&quot;: [\&quot;Access allowed every 30 minutes\&quot;]     \&quot;success\&quot;: false     \&quot;totalCount\&quot;: 1     \&quot;errorName\&quot;: \&quot;PollingDeniedException\&quot;   } &#x60;&#x60;&#x60; 
     * @param acceptLanguage Specifies the language into which the natural-language fields in the response from this service will be translated (see [Accept-Language header](#section/Appendices/Accept-Language-header) for available langage codes)  (required)
     * @param bookingStatusRequest  (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call bookingStatusAsync(String acceptLanguage, BookingStatusRequest bookingStatusRequest, final ApiCallback<BookingStatus200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = bookingStatusValidateBeforeCall(acceptLanguage, bookingStatusRequest, _callback);
        Type localVarReturnType = new TypeToken<BookingStatus200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for bookingStatusItems
     * @param acceptLanguage Specifies the language into which the natural-language fields in the response from this service will be translated (see [Accept-Language header](#section/Appendices/Accept-Language-header) for available langage codes)  (required)
     * @param bookingStatusItemsRequest  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call bookingStatusItemsCall(String acceptLanguage, BookingStatusItemsRequest bookingStatusItemsRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = bookingStatusItemsRequest;

        // create path and map variables
        String localVarPath = "/booking/status/items";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call bookingStatusItemsValidateBeforeCall(String acceptLanguage, BookingStatusItemsRequest bookingStatusItemsRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'acceptLanguage' is set
        if (acceptLanguage == null) {
            throw new ApiException("Missing the required parameter 'acceptLanguage' when calling bookingStatusItems(Async)");
        }

        return bookingStatusItemsCall(acceptLanguage, bookingStatusItemsRequest, _callback);
     ...
     * @param acceptLanguage Specifies the language into which the natural-language fields in the response from this service will be translated (see [Accept-Language header](#section/Appendices/Accept-Language-header) for available langage codes)  (required)
     * @param bookingStatusItemsRequest  (optional)
     * @return BookingStatusItems200Response
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public BookingStatusItems200Response bookingStatusItems(String acceptLanguage, BookingStatusItemsRequest bookingStatusItemsRequest) throws ApiException {
        ApiResponse<BookingStatusItems200Response> localVarResp = bookingStatusItemsWithHttpInfo(acceptLanguage, bookingStatusItemsRequest);
        return localVarResp.getData();
    }
     ...
     * @param acceptLanguage Specifies the language into which the natural-language fields in the response from this service will be translated (see [Accept-Language header](#section/Appendices/Accept-Language-header) for available langage codes)  (required)
     * @param bookingStatusItemsRequest  (optional)
     * @return ApiResponse&lt;BookingStatusItems200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<BookingStatusItems200Response> bookingStatusItemsWithHttpInfo(String acceptLanguage, BookingStatusItemsRequest bookingStatusItemsRequest) throws ApiException {
        okhttp3.Call localVarCall = bookingStatusItemsValidateBeforeCall(acceptLanguage, bookingStatusItemsRequest, null);
        Type localVarReturnType = new TypeToken<BookingStatusItems200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * /booking/status/items (asynchronously)
     * Get brief booking statuses  This service is similar to [/booking/status](#operation/bookingStatus) in that it: - retrieves the booking status for multiple items based on different criteria - has the same request parameters as [/booking/status](#operation/bookingStatus)  However, it differs in that it returns a multi-item array of booking items with less detail than what would be received from [/booking/status](#operation/bookingStatus). 
     * @param acceptLanguage Specifies the language into which the natural-language fields in the response from this service will be translated (see [Accept-Language header](#section/Appendices/Accept-Language-header) for available langage codes)  (required)
     * @param bookingStatusItemsRequest  (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call bookingStatusItemsAsync(String acceptLanguage, BookingStatusItemsRequest bookingStatusItemsRequest, final ApiCallback<BookingStatusItems200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = bookingStatusItemsValidateBeforeCall(acceptLanguage, bookingStatusItemsRequest, _callback);
        Type localVarReturnType = new TypeToken<BookingStatusItems200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for bookingVoucher
     * @param acceptLanguage Specifies the language into which the natural-language fields in the response from this service will be translated (see [Accept-Language header](#section/Appendices/Accept-Language-header) for available langage codes)  (required)
     * @param leadLastName **surname** of *this* lead traveler (optional)
     * @param itemId Booking-reference number generated by Viator    - **Note**: For more information, see: [Booking references](#section/Key-concepts/Booking-references)  (optional)
     * @param embeddedResources ignore (Viator only) (optional)
     * @param voucherKey **identifier** for the voucher - **note**: use &amp;lt;u&amp;gt;either&amp;lt;/u&amp;gt; &#x60;voucherKey&#x60; &amp;lt;u&amp;gt;or&amp;lt;/u&amp;gt; the three separate parameters - if &#x60;voucherKey&#x60; is provided as well as the other parameters, then &#x60;voucherKey&#x60; overrides the other paramaters - &#x60;voucherKey&#x60; is obtained from [/booking/mybookings](#operation/bookingMybookings) or in the response from [/booking/book](#operation/bookingBook) when you make a booking  (optional)
     * @param fullHTML **specifier**: - set to &#x60;true&#x60; if you wish to retrieve the full HTML-formatted voucher - set to &#x60;false&#x60; if you want the div fragment (optional)  (optional)
     * @param mobileVoucher **specifier**:  - if set to &#x60;true&#x60;, the service returns the mobile (cut down) HTML-formatted voucher - if &#x60;false&#x60; the full voucher HTML is returned (ignoring &#x60;fullHTML&#x60;) - default: &#x60;true&#x60;  - this field should only be enabled for products that have a &#x60;voucherOption&#x60; of &#x60;&#39;VOUCHER_E&#39;&#x60; - do not enable &#x60;mobileVouchers&#x60; for paper vouchers (&#x60;voucherOption&#x60; of &#x60;&#39;VOUCHER_PAPER_ONLY&#39;&#x60;) as no barcode is returned - the voucher information is available in the response from [/product](#operation/product), [/booking/book](#operation/bookingBook), [/booking/pastbooking](#operation/bookingPastbooking), [/booking/mybookings](#operation/bookingMybookings) (it is also displayed under the &#39;Redemption Info&#39; heading in this service)  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call bookingVoucherCall(String acceptLanguage, String leadLastName, Integer itemId, Boolean embeddedResources, String voucherKey, Boolean fullHTML, Boolean mobileVoucher, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/booking/voucher";
        ...
        if (leadLastName != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("leadLastName", leadLastName));
        }
        ...
        if (embeddedResources != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("embeddedResources", embeddedResources));
        }
        ...
        if (fullHTML != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("fullHTML", fullHTML));
        }

        if (mobileVoucher != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("mobileVoucher", mobileVoucher));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call bookingVoucherValidateBeforeCall(String acceptLanguage, String leadLastName, Integer itemId, Boolean embeddedResources, String voucherKey, Boolean fullHTML, Boolean mobileVoucher, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'acceptLanguage' is set
        if (acceptLanguage == null) {
            throw new ApiException("Missing the required parameter 'acceptLanguage' when calling bookingVoucher(Async)");
        }

        return bookingVoucherCall(acceptLanguage, leadLastName, itemId, embeddedResources, voucherKey, fullHTML, mobileVoucher, _callback);
     ...
     * @param fullHTML **specifier**: - set to &#x60;true&#x60; if you wish to retrieve the full HTML-formatted voucher - set to &#x60;false&#x60; if you want the div fragment (optional)  (optional)
     * @param mobileVoucher **specifier**:  - if set to &#x60;true&#x60;, the service returns the mobile (cut down) HTML-formatted voucher - if &#x60;false&#x60; the full voucher HTML is returned (ignoring &#x60;fullHTML&#x60;) - default: &#x60;true&#x60;  - this field should only be enabled for products that have a &#x60;voucherOption&#x60; of &#x60;&#39;VOUCHER_E&#39;&#x60; - do not enable &#x60;mobileVouchers&#x60; for paper vouchers (&#x60;voucherOption&#x60; of &#x60;&#39;VOUCHER_PAPER_ONLY&#39;&#x60;) as no barcode is returned - the voucher information is available in the response from [/product](#operation/product), [/booking/book](#operation/bookingBook), [/booking/pastbooking](#operation/bookingPastbooking), [/booking/mybookings](#operation/bookingMybookings) (it is also displayed under the &#39;Redemption Info&#39; heading in this service)  (optional)
     * @return BookingVoucher200Response
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public BookingVoucher200Response bookingVoucher(String acceptLanguage, String leadLastName, Integer itemId, Boolean embeddedResources, String voucherKey, Boolean fullHTML, Boolean mobileVoucher) throws ApiException {
        ApiResponse<BookingVoucher200Response> localVarResp = bookingVoucherWithHttpInfo(acceptLanguage, leadLastName, itemId, embeddedResources, voucherKey, fullHTML, mobileVoucher);
        return localVarResp.getData();
    }
     ...
     * @param fullHTML **specifier**: - set to &#x60;true&#x60; if you wish to retrieve the full HTML-formatted voucher - set to &#x60;false&#x60; if you want the div fragment (optional)  (optional)
     * @param mobileVoucher **specifier**:  - if set to &#x60;true&#x60;, the service returns the mobile (cut down) HTML-formatted voucher - if &#x60;false&#x60; the full voucher HTML is returned (ignoring &#x60;fullHTML&#x60;) - default: &#x60;true&#x60;  - this field should only be enabled for products that have a &#x60;voucherOption&#x60; of &#x60;&#39;VOUCHER_E&#39;&#x60; - do not enable &#x60;mobileVouchers&#x60; for paper vouchers (&#x60;voucherOption&#x60; of &#x60;&#39;VOUCHER_PAPER_ONLY&#39;&#x60;) as no barcode is returned - the voucher information is available in the response from [/product](#operation/product), [/booking/book](#operation/bookingBook), [/booking/pastbooking](#operation/bookingPastbooking), [/booking/mybookings](#operation/bookingMybookings) (it is also displayed under the &#39;Redemption Info&#39; heading in this service)  (optional)
     * @return ApiResponse&lt;BookingVoucher200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<BookingVoucher200Response> bookingVoucherWithHttpInfo(String acceptLanguage, String leadLastName, Integer itemId, Boolean embeddedResources, String voucherKey, Boolean fullHTML, Boolean mobileVoucher) throws ApiException {
        okhttp3.Call localVarCall = bookingVoucherValidateBeforeCall(acceptLanguage, leadLastName, itemId, embeddedResources, voucherKey, fullHTML, mobileVoucher, null);
        Type localVarReturnType = new TypeToken<BookingVoucher200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * /booking/voucher (asynchronously)
     * Get voucher details - Use this service to retrieve the voucher details of a booked item. - The data returned is HTML-formatted and can be wrapped in a header and/or footer.  **Sample query parameters** - leadLastName&#x3D;Simpson test&amp;amp;itemId&#x3D;580669678  **or**  - voucherKey&#x3D;1005851866:4af44c13ecf3f1a7d3f9ef2fc00c2257e08fa42ae20f877f3039ff9b52aba24e:580669678&amp;amp;fullHTML&#x3D;true&amp;amp;mobileVoucher&#x3D;true 
     * @param acceptLanguage Specifies the language into which the natural-language fields in the response from this service will be translated (see [Accept-Language header](#section/Appendices/Accept-Language-header) for available langage codes)  (required)
     * @param leadLastName **surname** of *this* lead traveler (optional)
     * @param itemId Booking-reference number generated by Viator    - **Note**: For more information, see: [Booking references](#section/Key-concepts/Booking-references)  (optional)
     ...
     */
    public okhttp3.Call bookingVoucherAsync(String acceptLanguage, String leadLastName, Integer itemId, Boolean embeddedResources, String voucherKey, Boolean fullHTML, Boolean mobileVoucher, final ApiCallback<BookingVoucher200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = bookingVoucherValidateBeforeCall(acceptLanguage, leadLastName, itemId, embeddedResources, voucherKey, fullHTML, mobileVoucher, _callback);
        Type localVarReturnType = new TypeToken<BookingVoucher200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param bookingReference The ID of the booking (required)
     * @param acceptLanguage Specifies the language into which the natural-language fields in the response from this service will be translated (see [Accept-Language header](#section/Appendices/Accept-Language-header) for available langage codes)  (required)
     * @param cancellationRequest  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call cancelBookingCall(String bookingReference, String acceptLanguage, CancellationRequest cancellationRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] { "https://api.sandbox.viator.com/partner" };
        ...
        // create path and map variables
        String localVarPath = "/bookings/{booking-reference}/cancel"
            .replace("{" + "booking-reference" + "}", localVarApiClient.escapeString(bookingReference.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call cancelBookingValidateBeforeCall(String bookingReference, String acceptLanguage, CancellationRequest cancellationRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'bookingReference' is set
        if (bookingReference == null) {
            throw new ApiException("Missing the required parameter 'bookingReference' when calling cancelBooking(Async)");
        }

        // verify the required parameter 'acceptLanguage' is set
        if (acceptLanguage == null) {
            throw new ApiException("Missing the required parameter 'acceptLanguage' when calling cancelBooking(Async)");
        }

        return cancelBookingCall(bookingReference, acceptLanguage, cancellationRequest, _callback);
     ...
     */
    public CancelBookingResponse cancelBooking(String bookingReference, String acceptLanguage, CancellationRequest cancellationRequest) throws ApiException {
        ApiResponse<CancelBookingResponse> localVarResp = cancelBookingWithHttpInfo(bookingReference, acceptLanguage, cancellationRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<CancelBookingResponse> cancelBookingWithHttpInfo(String bookingReference, String acceptLanguage, CancellationRequest cancellationRequest) throws ApiException {
        okhttp3.Call localVarCall = cancelBookingValidateBeforeCall(bookingReference, acceptLanguage, cancellationRequest, null);
        Type localVarReturnType = new TypeToken<CancelBookingResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * /bookings/{booking-reference}/cancel (asynchronously)
     * Submits a cancellation request for the specified booking  For information on how to use this service, see: [Cancellation API workflow](#section/Common-workflows-and-data-validation/Cancellation-API-workflow)  **Note**:     * This service &amp;lt;u&amp;gt;requires&amp;lt;/u&amp;gt; [exp-api-key](#section/Authentication/exp-api-key) to be included as a header parameter. Please speak to your account manager if you have not yet been issued an exp-api-key.   * The base URL for the server for this endpoint is different from the older endpoints described in this document. Use &#x60;https://api.sandbox.viator.com/partner/bookings/{booking-reference}/cancel&#x60; 
     * @param bookingReference The ID of the booking (required)
     * @param acceptLanguage Specifies the language into which the natural-language fields in the response from this service will be translated (see [Accept-Language header](#section/Appendices/Accept-Language-header) for available langage codes)  (required)
     * @param cancellationRequest  (optional)
     ...
     */
    public okhttp3.Call cancelBookingAsync(String bookingReference, String acceptLanguage, CancellationRequest cancellationRequest, final ApiCallback<CancelBookingResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = cancelBookingValidateBeforeCall(bookingReference, acceptLanguage, cancellationRequest, _callback);
        Type localVarReturnType = new TypeToken<CancelBookingResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for cancelBookingQuote
     * @param bookingReference Unique numeric identifier of the booking for which to retrieve a cancellation quote (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call cancelBookingQuoteCall(String bookingReference, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] { "https://api.sandbox.viator.com/partner" };
        ...
        // create path and map variables
        String localVarPath = "/bookings/{booking-reference}/cancel-quote"
            .replace("{" + "booking-reference" + "}", localVarApiClient.escapeString(bookingReference.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call cancelBookingQuoteValidateBeforeCall(String bookingReference, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'bookingReference' is set
        if (bookingReference == null) {
            throw new ApiException("Missing the required parameter 'bookingReference' when calling cancelBookingQuote(Async)");
        }

        return cancelBookingQuoteCall(bookingReference, _callback);
     ...
     */
    public CancelBookingQuoteResponse cancelBookingQuote(String bookingReference) throws ApiException {
        ApiResponse<CancelBookingQuoteResponse> localVarResp = cancelBookingQuoteWithHttpInfo(bookingReference);
        return localVarResp.getData();
    }
     ...
     * Retrieves a quote for the cancellation of a booking  For information on how to use this service, see: [Cancellation API workflow](#section/Common-workflows-and-data-validation/Cancellation-API-workflow)  **Note**:     * This service &amp;lt;u&amp;gt;requires&amp;lt;/u&amp;gt; [exp-api-key](#section/Authentication/exp-api-key) to be included as a header parameter. Please speak to your account manager if you have not yet been issued an exp-api-key.   * The base URL for the server for this endpoint is different from the older endpoints described in this document. Use &#x60;https://api.sandbox.viator.com/partner/bookings/{booking-reference}/cancel-quote&#x60; 
     * @param bookingReference Unique numeric identifier of the booking for which to retrieve a cancellation quote (required)
     * @return ApiResponse&lt;CancelBookingQuoteResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<CancelBookingQuoteResponse> cancelBookingQuoteWithHttpInfo(String bookingReference) throws ApiException {
        okhttp3.Call localVarCall = cancelBookingQuoteValidateBeforeCall(bookingReference, null);
        Type localVarReturnType = new TypeToken<CancelBookingQuoteResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * /bookings/{booking-reference}/cancel-quote (asynchronously)
     * Retrieves a quote for the cancellation of a booking  For information on how to use this service, see: [Cancellation API workflow](#section/Common-workflows-and-data-validation/Cancellation-API-workflow)  **Note**:     * This service &amp;lt;u&amp;gt;requires&amp;lt;/u&amp;gt; [exp-api-key](#section/Authentication/exp-api-key) to be included as a header parameter. Please speak to your account manager if you have not yet been issued an exp-api-key.   * The base URL for the server for this endpoint is different from the older endpoints described in this document. Use &#x60;https://api.sandbox.viator.com/partner/bookings/{booking-reference}/cancel-quote&#x60; 
     * @param bookingReference Unique numeric identifier of the booking for which to retrieve a cancellation quote (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call cancelBookingQuoteAsync(String bookingReference, final ApiCallback<CancelBookingQuoteResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = cancelBookingQuoteValidateBeforeCall(bookingReference, _callback);
        Type localVarReturnType = new TypeToken<CancelBookingQuoteResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for cancellationReasons
     * @param acceptLanguage Specifies the language into which the natural-language fields in the response from this service will be translated (see [Accept-Language header](#section/Appendices/Accept-Language-header) for available langage codes)  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call cancellationReasonsCall(String acceptLanguage, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] { "https://api.sandbox.viator.com/partner" };
        ...
        // create path and map variables
        String localVarPath = "/bookings/cancel-reasons";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call cancellationReasonsValidateBeforeCall(String acceptLanguage, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'acceptLanguage' is set
        if (acceptLanguage == null) {
            throw new ApiException("Missing the required parameter 'acceptLanguage' when calling cancellationReasons(Async)");
        }

        return cancellationReasonsCall(acceptLanguage, _callback);
     ...
     * @param acceptLanguage Specifies the language into which the natural-language fields in the response from this service will be translated (see [Accept-Language header](#section/Appendices/Accept-Language-header) for available langage codes)  (required)
     * @return List&lt;CancellationReasonsResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public List<CancellationReasonsResponse> cancellationReasons(String acceptLanguage) throws ApiException {
        ApiResponse<List<CancellationReasonsResponse>> localVarResp = cancellationReasonsWithHttpInfo(acceptLanguage);
        return localVarResp.getData();
    }
     ...
     * Retrieves a dictionary of unique identification codes (&#x60;cancellationReasonCode&#x60;) and their associated natural-language descriptions (&#x60;cancellationReasonText&#x60;).  For information on how to use this service, see: [Cancellation API workflow](#section/Common-workflows-and-data-validation/Cancellation-API-workflow)  **Note**:     * This service &amp;lt;u&amp;gt;requires&amp;lt;/u&amp;gt; [exp-api-key](#section/Authentication/exp-api-key) to be included as a header parameter. Please speak to your account manager if you have not yet been issued an exp-api-key.   * The base URL for the server for this endpoint is different from the older endpoints described in this document. Use &#x60;https://api.sandbox.viator.com/partner/cancel-reasons&#x60; 
     * @param acceptLanguage Specifies the language into which the natural-language fields in the response from this service will be translated (see [Accept-Language header](#section/Appendices/Accept-Language-header) for available langage codes)  (required)
     * @return ApiResponse&lt;List&lt;CancellationReasonsResponse&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<List<CancellationReasonsResponse>> cancellationReasonsWithHttpInfo(String acceptLanguage) throws ApiException {
        okhttp3.Call localVarCall = cancellationReasonsValidateBeforeCall(acceptLanguage, null);
        Type localVarReturnType = new TypeToken<List<CancellationReasonsResponse>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * /bookings/cancel-reasons (asynchronously)
     * Retrieves a dictionary of unique identification codes (&#x60;cancellationReasonCode&#x60;) and their associated natural-language descriptions (&#x60;cancellationReasonText&#x60;).  For information on how to use this service, see: [Cancellation API workflow](#section/Common-workflows-and-data-validation/Cancellation-API-workflow)  **Note**:     * This service &amp;lt;u&amp;gt;requires&amp;lt;/u&amp;gt; [exp-api-key](#section/Authentication/exp-api-key) to be included as a header parameter. Please speak to your account manager if you have not yet been issued an exp-api-key.   * The base URL for the server for this endpoint is different from the older endpoints described in this document. Use &#x60;https://api.sandbox.viator.com/partner/cancel-reasons&#x60; 
     * @param acceptLanguage Specifies the language into which the natural-language fields in the response from this service will be translated (see [Accept-Language header](#section/Appendices/Accept-Language-header) for available langage codes)  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call cancellationReasonsAsync(String acceptLanguage, final ApiCallback<List<CancellationReasonsResponse>> _callback) throws ApiException {

        okhttp3.Call localVarCall = cancellationReasonsValidateBeforeCall(acceptLanguage, _callback);
        Type localVarReturnType = new TypeToken<List<CancellationReasonsResponse>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
