...
public class ApiClient {
    ...
    private String basePath = "https://viatorapi.viator.com/service";
    ...
    public ApiClient() {
        ...
        authentications.put("API-key", new ApiKeyAuth("header", "exp-api-key"));
        authentications.put("Legacy-API-key", new ApiKeyAuth("query", "apiKey"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://viatorapi.viator.com/service
