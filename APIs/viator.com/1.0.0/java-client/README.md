...
- API version: 1.0.0
  - Build date: 2024-10-12T12:41:31.081359-04:00[America/New_York]
...
In this example, four age bands (1, 2, 3 and 5) have pricing information available. These numerically-identified age bands are the age bands allowed to book the product. Details of the age ranges that the product operator has defined are available from the **_/product** service.

A call to **_/product** regarding `10040WORLD` yields the following information:
...
This fact, as well as other pertinent tidbits, can be found in the `additionalInfo` array in the response from **_/product**. It is mandatory that all clauses in the `additionalInfo` array are clearly displayed on your product detail page.
...
If the same cancellation request is sent more than once, Viator will respond with the last known response.
  ...
  For more information, please visit [https://docs.viator.com/partner-api/merchant/#support-procedures-merchant/](https://docs.viator.com/partner-api/merchant/#support-procedures-merchant/)
...
------------ | ------------- | ------------- | -------------
*BookingServicesApi* | [**bookingAvailability**](docs/BookingServicesApi.md#bookingAvailability) | **POST** /booking/availability | /booking/availability
*BookingServicesApi* | [**bookingAvailabilityDates**](docs/BookingServicesApi.md#bookingAvailabilityDates) | **GET** /booking/availability/dates | /booking/availability/dates
*BookingServicesApi* | [**bookingAvailabilityTourgrades**](docs/BookingServicesApi.md#bookingAvailabilityTourgrades) | **POST** /booking/availability/tourgrades | /booking/availability/tourgrades
*BookingServicesApi* | [**bookingAvailabilityTourgradesPricingmatrix**](docs/BookingServicesApi.md#bookingAvailabilityTourgradesPricingmatrix) | **POST** /booking/availability/tourgrades/pricingmatrix | /booking/availability/tourgrades/pricingmatrix
*BookingServicesApi* | [**bookingBook**](docs/BookingServicesApi.md#bookingBook) | **POST** /booking/book | /booking/book
*BookingServicesApi* | [**bookingCalculateprice**](docs/BookingServicesApi.md#bookingCalculateprice) | **POST** /booking/calculateprice | /booking/calculateprice
*BookingServicesApi* | [**bookingHotels**](docs/BookingServicesApi.md#bookingHotels) | **GET** /booking/hotels | /booking/hotels
*BookingServicesApi* | [**bookingMybookings**](docs/BookingServicesApi.md#bookingMybookings) | **GET** /booking/mybookings | /booking/mybookings
*BookingServicesApi* | [**bookingPastbooking**](docs/BookingServicesApi.md#bookingPastbooking) | **GET** /booking/pastbooking | /booking/pastbooking
*BookingServicesApi* | [**bookingPricingmatrix**](docs/BookingServicesApi.md#bookingPricingmatrix) | **POST** /booking/pricingmatrix | /booking/pricingmatrix
*BookingServicesApi* | [**bookingStatus**](docs/BookingServicesApi.md#bookingStatus) | **POST** /booking/status | /booking/status
*BookingServicesApi* | [**bookingStatusItems**](docs/BookingServicesApi.md#bookingStatusItems) | **POST** /booking/status/items | /booking/status/items
*BookingServicesApi* | [**bookingVoucher**](docs/BookingServicesApi.md#bookingVoucher) | **GET** /booking/voucher | /booking/voucher
*BookingServicesApi* | [**cancelBooking**](docs/BookingServicesApi.md#cancelBooking) | **POST** /bookings/{booking-reference}/cancel | /bookings/{booking-reference}/cancel
*BookingServicesApi* | [**cancelBookingQuote**](docs/BookingServicesApi.md#cancelBookingQuote) | **GET** /bookings/{booking-reference}/cancel-quote | /bookings/{booking-reference}/cancel-quote
*BookingServicesApi* | [**cancellationReasons**](docs/BookingServicesApi.md#cancellationReasons) | **GET** /bookings/cancel-reasons | /bookings/cancel-reasons
*DeprecatedServicesApi* | [**merchantCancellation**](docs/DeprecatedServicesApi.md#merchantCancellation) | **POST** /merchant/cancellation | /merchant/cancellation
*GeneralServicesApi* | [**healthCheck**](docs/GeneralServicesApi.md#healthCheck) | **GET** /health/check | /health/check
*ProductServicesApi* | [**availableProducts**](docs/ProductServicesApi.md#availableProducts) | **POST** /available/products | /available/products
*ProductServicesApi* | [**product**](docs/ProductServicesApi.md#product) | **GET** /product | /product
*ProductServicesApi* | [**productPhotos**](docs/ProductServicesApi.md#productPhotos) | **GET** /product/photos | /product/photos
*ProductServicesApi* | [**productReviews**](docs/ProductServicesApi.md#productReviews) | **GET** /product/reviews | /product/reviews
*ProductServicesApi* | [**searchFreetext**](docs/ProductServicesApi.md#searchFreetext) | **POST** /search/freetext | /search/freetext
*ProductServicesApi* | [**searchProducts**](docs/ProductServicesApi.md#searchProducts) | **POST** /search/products | /search/products
*ProductServicesApi* | [**searchProductsCodes**](docs/ProductServicesApi.md#searchProductsCodes) | **POST** /search/products/codes | /search/products/codes
*TaxonomyServicesApi* | [**taxonomyAttractions**](docs/TaxonomyServicesApi.md#taxonomyAttractions) | **POST** /taxonomy/attractions | /taxonomy/attractions
*TaxonomyServicesApi* | [**taxonomyCategories**](docs/TaxonomyServicesApi.md#taxonomyCategories) | **GET** /taxonomy/categories | /taxonomy/categories
*TaxonomyServicesApi* | [**taxonomyDestinations**](docs/TaxonomyServicesApi.md#taxonomyDestinations) | **GET** /taxonomy/destinations | /taxonomy/destinations


## Documentation for Models

 - [AvailableProducts200Response](docs/AvailableProducts200Response.md)
 - [AvailableProducts200ResponseAllOfDataInner](docs/AvailableProducts200ResponseAllOfDataInner.md)
 - [AvailableProducts200ResponseAllOfDataInnerPas](docs/AvailableProducts200ResponseAllOfDataInnerPas.md)
 - [AvailableProducts200ResponseAllOfDataInnerPasTourGradesValue](docs/AvailableProducts200ResponseAllOfDataInnerPasTourGradesValue.md)
 - [AvailableProducts200ResponseAllOfDataInnerPasTourGradesValueAvailDatesInner](docs/AvailableProducts200ResponseAllOfDataInnerPasTourGradesValueAvailDatesInner.md)
 - [AvailableProducts200ResponseAllOfDataInnerPasTourGradesValueAvailDatesInnerPriceQuote](docs/AvailableProducts200ResponseAllOfDataInnerPasTourGradesValueAvailDatesInnerPriceQuote.md)
 - [AvailableProductsRequest](docs/AvailableProductsRequest.md)
 - [BasicErrorModel](docs/BasicErrorModel.md)
 - [BookingAvailability200Response](docs/BookingAvailability200Response.md)
 - [BookingAvailability200ResponseAllOfData](docs/BookingAvailability200ResponseAllOfData.md)
 - [BookingAvailability200ResponseAllOfDataAvailabilityInner](docs/BookingAvailability200ResponseAllOfDataAvailabilityInner.md)
 - [BookingAvailabilityDates200Response](docs/BookingAvailabilityDates200Response.md)
 - [BookingAvailabilityRequest](docs/BookingAvailabilityRequest.md)
 - [BookingAvailabilityRequestAgeBandsInner](docs/BookingAvailabilityRequestAgeBandsInner.md)
 - [BookingAvailabilityTourgrades200Response](docs/BookingAvailabilityTourgrades200Response.md)
 - [BookingAvailabilityTourgrades200ResponseAllOfDataInner](docs/BookingAvailabilityTourgrades200ResponseAllOfDataInner.md)
 - [BookingAvailabilityTourgrades200ResponseAllOfDataInnerAgeBandsRequiredInnerInner](docs/BookingAvailabilityTourgrades200ResponseAllOfDataInnerAgeBandsRequiredInnerInner.md)
 - [BookingAvailabilityTourgradesPricingmatrix200Response](docs/BookingAvailabilityTourgradesPricingmatrix200Response.md)
 - [BookingAvailabilityTourgradesPricingmatrix200ResponseAllOfData](docs/BookingAvailabilityTourgradesPricingmatrix200ResponseAllOfData.md)
 - [BookingAvailabilityTourgradesPricingmatrix200ResponseAllOfDataDatesInner](docs/BookingAvailabilityTourgradesPricingmatrix200ResponseAllOfDataDatesInner.md)
 - [BookingAvailabilityTourgradesPricingmatrix200ResponseAllOfDataDatesInnerTourGradesInner](docs/BookingAvailabilityTourgradesPricingmatrix200ResponseAllOfDataDatesInnerTourGradesInner.md)
 - [BookingAvailabilityTourgradesPricingmatrix200ResponseAllOfDataDatesInnerTourGradesInnerPricingMatrixInner](docs/BookingAvailabilityTourgradesPricingmatrix200ResponseAllOfDataDatesInnerTourGradesInnerPricingMatrixInner.md)
 - [BookingAvailabilityTourgradesPricingmatrix200ResponseAllOfDataDatesInnerTourGradesInnerPricingMatrixInnerAgeBandPricesInner](docs/BookingAvailabilityTourgradesPricingmatrix200ResponseAllOfDataDatesInnerTourGradesInnerPricingMatrixInnerAgeBandPricesInner.md)
 - [BookingAvailabilityTourgradesPricingmatrix200ResponseAllOfDataDatesInnerTourGradesInnerPricingMatrixInnerAgeBandPricesInnerPricesInner](docs/BookingAvailabilityTourgradesPricingmatrix200ResponseAllOfDataDatesInnerTourGradesInnerPricingMatrixInnerAgeBandPricesInnerPricesInner.md)
 - [BookingAvailabilityTourgradesPricingmatrixRequest](docs/BookingAvailabilityTourgradesPricingmatrixRequest.md)
 - [BookingAvailabilityTourgradesRequest](docs/BookingAvailabilityTourgradesRequest.md)
 - [BookingAvailabilityTourgradesRequestAgeBandsInner](docs/BookingAvailabilityTourgradesRequestAgeBandsInner.md)
 - [BookingBook200Response](docs/BookingBook200Response.md)
 - [BookingBook200ResponseAllOfData](docs/BookingBook200ResponseAllOfData.md)
 - [BookingBook200ResponseAllOfDataItemSummariesInner](docs/BookingBook200ResponseAllOfDataItemSummariesInner.md)
 - [BookingBook200ResponseAllOfDataItemSummariesInnerMerchantTermsAndConditions](docs/BookingBook200ResponseAllOfDataItemSummariesInnerMerchantTermsAndConditions.md)
 - [BookingBook200ResponseAllOfDataItemSummariesInnerMerchantTermsAndConditionsCancellationFromTourDateInner](docs/BookingBook200ResponseAllOfDataItemSummariesInnerMerchantTermsAndConditionsCancellationFromTourDateInner.md)
 - [BookingBook200ResponseAllOfDataItemSummariesInnerTravellerAgeBandsInner](docs/BookingBook200ResponseAllOfDataItemSummariesInnerTravellerAgeBandsInner.md)
 - [BookingBookRequest](docs/BookingBookRequest.md)
 - [BookingBookRequestBooker](docs/BookingBookRequestBooker.md)
 - [BookingBookRequestItemsInner](docs/BookingBookRequestItemsInner.md)
 - [BookingBookRequestItemsInnerBookingQuestionAnswersInner](docs/BookingBookRequestItemsInnerBookingQuestionAnswersInner.md)
 - [BookingBookRequestItemsInnerPartnerItemDetail](docs/BookingBookRequestItemsInnerPartnerItemDetail.md)
 - [BookingBookRequestItemsInnerTravellersInner](docs/BookingBookRequestItemsInnerTravellersInner.md)
 - [BookingBookRequestPartnerDetail](docs/BookingBookRequestPartnerDetail.md)
 - [BookingCalculateprice200Response](docs/BookingCalculateprice200Response.md)
 - [BookingCalculateprice200ResponseAllOfData](docs/BookingCalculateprice200ResponseAllOfData.md)
 - [BookingCalculateprice200ResponseAllOfDataItinerary](docs/BookingCalculateprice200ResponseAllOfDataItinerary.md)
 - [BookingCalculateprice200ResponseAllOfDataItineraryItemSummariesInner](docs/BookingCalculateprice200ResponseAllOfDataItineraryItemSummariesInner.md)
 - [BookingCalculateprice200ResponseAllOfDataItineraryItemSummariesInnerTravellerAgeBandsInner](docs/BookingCalculateprice200ResponseAllOfDataItineraryItemSummariesInnerTravellerAgeBandsInner.md)
 - [BookingCalculatepriceRequest](docs/BookingCalculatepriceRequest.md)
 - [BookingCalculatepriceRequestItemsInner](docs/BookingCalculatepriceRequestItemsInner.md)
 - [BookingCalculatepriceRequestItemsInnerTravellersInner](docs/BookingCalculatepriceRequestItemsInnerTravellersInner.md)
 - [BookingEngineId](docs/BookingEngineId.md)
 - [BookingEngineIdResponse](docs/BookingEngineIdResponse.md)
 - [BookingHotels200Response](docs/BookingHotels200Response.md)
 - [BookingHotels200ResponseAllOfDataInner](docs/BookingHotels200ResponseAllOfDataInner.md)
 - [BookingMybookings200Response](docs/BookingMybookings200Response.md)
 - [BookingMybookings200ResponseAllOfData](docs/BookingMybookings200ResponseAllOfData.md)
 - [BookingMybookings200ResponseAllOfDataItemSummariesInner](docs/BookingMybookings200ResponseAllOfDataItemSummariesInner.md)
 - [BookingMybookings200ResponseAllOfDataItemSummariesInnerTravellerAgeBandsInner](docs/BookingMybookings200ResponseAllOfDataItemSummariesInnerTravellerAgeBandsInner.md)
 - [BookingPastbooking200Response](docs/BookingPastbooking200Response.md)
 - [BookingPastbooking200ResponseAllOfData](docs/BookingPastbooking200ResponseAllOfData.md)
 - [BookingPastbooking200ResponseAllOfDataItemSummariesInner](docs/BookingPastbooking200ResponseAllOfDataItemSummariesInner.md)
 - [BookingPricingmatrix200Response](docs/BookingPricingmatrix200Response.md)
 - [BookingPricingmatrix200ResponseAllOfDataInner](docs/BookingPricingmatrix200ResponseAllOfDataInner.md)
 - [BookingPricingmatrix200ResponseAllOfDataInnerAgeBandPricesInner](docs/BookingPricingmatrix200ResponseAllOfDataInnerAgeBandPricesInner.md)
 - [BookingPricingmatrix200ResponseAllOfDataInnerAgeBandPricesInnerPricesInner](docs/BookingPricingmatrix200ResponseAllOfDataInnerAgeBandPricesInnerPricesInner.md)
 - [BookingPricingmatrixRequest](docs/BookingPricingmatrixRequest.md)
 - [BookingStatus200Response](docs/BookingStatus200Response.md)
 - [BookingStatus200ResponseAllOfData](docs/BookingStatus200ResponseAllOfData.md)
 - [BookingStatus200ResponseAllOfDataItemSummariesInner](docs/BookingStatus200ResponseAllOfDataItemSummariesInner.md)
 - [BookingStatusItem](docs/BookingStatusItem.md)
 - [BookingStatusItems200Response](docs/BookingStatusItems200Response.md)
 - [BookingStatusItems200ResponseAllOfDataInner](docs/BookingStatusItems200ResponseAllOfDataInner.md)
 - [BookingStatusItemsRequest](docs/BookingStatusItemsRequest.md)
 - [BookingStatusItinerary](docs/BookingStatusItinerary.md)
 - [BookingStatusRequest](docs/BookingStatusRequest.md)
 - [BookingVoucher200Response](docs/BookingVoucher200Response.md)
 - [CancelBooking400Response](docs/CancelBooking400Response.md)
 - [CancelBooking404Response](docs/CancelBooking404Response.md)
 - [CancelBookingQuoteResponse](docs/CancelBookingQuoteResponse.md)
 - [CancelBookingResponse](docs/CancelBookingResponse.md)
 - [CancellationReason](docs/CancellationReason.md)
 - [CancellationReasonsResponse](docs/CancellationReasonsResponse.md)
 ...
 - [MerchantCancellation200Response](docs/MerchantCancellation200Response.md)
 - [MerchantCancellation200ResponseAllOfData](docs/MerchantCancellation200ResponseAllOfData.md)
 - [MerchantCancellation200ResponseAllOfDataCancelItemsInner](docs/MerchantCancellation200ResponseAllOfDataCancelItemsInner.md)
 - [MerchantCancellation400Response](docs/MerchantCancellation400Response.md)
 - [MerchantCancellation400ResponseAllOfData](docs/MerchantCancellation400ResponseAllOfData.md)
 - [MerchantCancellationRequest](docs/MerchantCancellationRequest.md)
 - [MerchantCancellationRequestCancelItemsInner](docs/MerchantCancellationRequestCancelItemsInner.md)
 - [Model401UNAUTHORIZED](docs/Model401UNAUTHORIZED.md)
 - [Model406NOTACCEPTABLE](docs/Model406NOTACCEPTABLE.md)
 - [Model500INTERNALSERVERERROR](docs/Model500INTERNALSERVERERROR.md)
 - [Model503SERVICEUNAVAILABLE](docs/Model503SERVICEUNAVAILABLE.md)
 - [PhotoObject](docs/PhotoObject.md)
 - [Product200Response](docs/Product200Response.md)
 - [Product200ResponseAllOfData](docs/Product200ResponseAllOfData.md)
 - [Product200ResponseAllOfDataAgeBandsInner](docs/Product200ResponseAllOfDataAgeBandsInner.md)
 - [Product200ResponseAllOfDataBookingQuestionsInner](docs/Product200ResponseAllOfDataBookingQuestionsInner.md)
 - [Product200ResponseAllOfDataMerchantTermsAndConditions](docs/Product200ResponseAllOfDataMerchantTermsAndConditions.md)
 - [Product200ResponseAllOfDataMerchantTermsAndConditionsCancellationFromTourDateInner](docs/Product200ResponseAllOfDataMerchantTermsAndConditionsCancellationFromTourDateInner.md)
 - [Product200ResponseAllOfDataPassengerAttributesInner](docs/Product200ResponseAllOfDataPassengerAttributesInner.md)
 - [Product200ResponseAllOfDataProductPhotosInner](docs/Product200ResponseAllOfDataProductPhotosInner.md)
 - [Product200ResponseAllOfDataTourGradesInner](docs/Product200ResponseAllOfDataTourGradesInner.md)
 - [ProductPhotos200Response](docs/ProductPhotos200Response.md)
 - [ProductReviews200Response](docs/ProductReviews200Response.md)
 - [RatingCounts](docs/RatingCounts.md)
 - [RefundDetails](docs/RefundDetails.md)
 - [ReviewObject](docs/ReviewObject.md)
 - [SearchFreetext200Response](docs/SearchFreetext200Response.md)
 - [SearchFreetextRequest](docs/SearchFreetextRequest.md)
 - [SearchFreetextResponse](docs/SearchFreetextResponse.md)
 - [SearchFreetextResponseAttraction](docs/SearchFreetextResponseAttraction.md)
 - [SearchFreetextResponseAttractionAllOfData](docs/SearchFreetextResponseAttractionAllOfData.md)
 - [SearchFreetextResponseDestination](docs/SearchFreetextResponseDestination.md)
 - [SearchFreetextResponseDestinationAllOfData](docs/SearchFreetextResponseDestinationAllOfData.md)
 - [SearchFreetextResponseProduct](docs/SearchFreetextResponseProduct.md)
 - [SearchFreetextResponseProductAllOfData](docs/SearchFreetextResponseProductAllOfData.md)
 - [SearchFreetextResponseRecommendation](docs/SearchFreetextResponseRecommendation.md)
 - [SearchFreetextResponseRecommendationAllOfData](docs/SearchFreetextResponseRecommendationAllOfData.md)
 - [SearchProducts200Response](docs/SearchProducts200Response.md)
 - [SearchProducts200ResponseAllOfDataInner](docs/SearchProducts200ResponseAllOfDataInner.md)
 - [SearchProductsCodes200Response](docs/SearchProductsCodes200Response.md)
 - [SearchProductsCodes200ResponseAllOfDataInner](docs/SearchProductsCodes200ResponseAllOfDataInner.md)
 - [SearchProductsCodesRequest](docs/SearchProductsCodesRequest.md)
 - [SearchProductsRequest](docs/SearchProductsRequest.md)
 - [SortOrder](docs/SortOrder.md)
 - [TaxonomyAttractions200Response](docs/TaxonomyAttractions200Response.md)
 - [TaxonomyAttractions200ResponseAllOfDataInner](docs/TaxonomyAttractions200ResponseAllOfDataInner.md)
 - [TaxonomyAttractionsRequest](docs/TaxonomyAttractionsRequest.md)
 - [TaxonomyCategories200Response](docs/TaxonomyCategories200Response.md)
 - [TaxonomyCategories200ResponseAllOfDataInner](docs/TaxonomyCategories200ResponseAllOfDataInner.md)
 - [TaxonomyCategories200ResponseAllOfDataInnerSubcategoriesInner](docs/TaxonomyCategories200ResponseAllOfDataInnerSubcategoriesInner.md)
 - [TaxonomyDestinations200Response](docs/TaxonomyDestinations200Response.md)
 - [TaxonomyDestinations200ResponseAllOfDataInner](docs/TaxonomyDestinations200ResponseAllOfDataInner.md)
 - [TranslationLevel](docs/TranslationLevel.md)
...
- **Type**: API key
- **API key parameter name**: exp-api-key
- **Location**: HTTP header

<a id="Legacy-API-key"></a>
### Legacy-API-key
