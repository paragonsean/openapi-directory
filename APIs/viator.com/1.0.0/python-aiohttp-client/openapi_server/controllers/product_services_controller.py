...
async def available_products(request: web.Request, accept_language, body=None) -> web.Response:
    """/available/products
    ...
    """
    body = AvailableProductsRequest.from_dict(body)
    return web.Response(status=200)


async def product(request: web.Request, accept_language, currency_code=None, sort_order=None, voucher_option=None, code=None, show_unavailable=None, exclude_tour_grade_availability=None) -> web.Response:
    """/product
    ...
    :param accept_language: Specifies the language into which the natural-language fields in the response from this service will be translated (see [Accept-Language header](#section/Appendices/Accept-Language-header) for available langage codes) 
    :type accept_language: str
    :param currency_code: **currency code** for the currency in which pricing is displayed - default&#x3D;&#x60;&#39;USD&#39;&#x60; 
    :type currency_code: str
    :param sort_order: **specifier** of the order in which to return reviews  Sort order options:    - &#x60;\&quot;REVIEW_RATING_A\&quot;&#x60;: Traveler Rating (low→high) Average   - &#x60;\&quot;REVIEW_RATING_D\&quot;&#x60;: Traveler Rating (high→low) Average   - &#x60;\&quot;REVIEW_RATING_SUBMISSION_DATE_D\&quot;&#x60;: Most recent review 
    :type sort_order: str
    :param voucher_option: - &#x60;\&quot;VOUCHER_PAPER_ONLY\&quot;&#x60;: Paper Vouchers only accepted - &#x60;\&quot;VOUCHER_E\&quot;&#x60;: EVouchers + Paper Vouchers accepted 
    :type voucher_option: str
    :param code: **unique alphanumeric identifier** of the product
    :type code: str
    :param show_unavailable: **specifier** as to whether or not to show &#39;unavailable&#39; products:    - &#x60;true&#x60;: return *both* available and unavailable products   - &#x60;false&#x60;: return *only* available products (default) 
    :type show_unavailable: bool
    :param exclude_tour_grade_availability: **specifier:**  - &#x60;true&#x60;: return **all** tour grades, including those that are not available - &#x60;false&#x60;: only display tour grades that *are* available 
    :type exclude_tour_grade_availability: bool

    """
    return web.Response(status=200)


async def product_photos(request: web.Request, accept_language, top_x=None, code=None, show_unavailable=None) -> web.Response:
    """/product/photos
    ...
    :param accept_language: Specifies the language into which the natural-language fields in the response from this service will be translated (see [Accept-Language header](#section/Appendices/Accept-Language-header) for available langage codes) 
    :type accept_language: str
    :param top_x: **start and end rows** to return in the format {start}-{end} - e.g. &#x60;&#39;1-10&#39;&#x60;, &#x60;&#39;11-20&#39;&#x60;  **Note**:  - the maximum number of rows per request is 100; therefore, &#x60;&#39;100-400&#39;&#x60; will return the same as &#x60;&#39;100-200&#39;&#x60; - if &#x60;topX&#x60; is not specified, the default is &#x60;&#39;1-100&#39;&#x60; 
    :type top_x: str
    :param code: **unique alphanumeric identifier** of the product
    :type code: str
    :param show_unavailable: **specifier** as to whether or not to show &#39;unavailable&#39; products:    - &#x60;true&#x60;: return *both* available and unavailable products   - &#x60;false&#x60;: return *only* available products (default) 
...
async def product_reviews(request: web.Request, accept_language, sort_order=None, top_x=None, code=None, show_unavailable=None) -> web.Response:
    """/product/reviews
...
async def search_freetext(request: web.Request, accept_language, body=None) -> web.Response:
    """/search/freetext
    ...
    """
    body = SearchFreetextRequest.from_dict(body)
    return web.Response(status=200)


async def search_products(request: web.Request, accept_language, body=None) -> web.Response:
    """/search/products
    ...
    """
    body = SearchProductsRequest.from_dict(body)
    return web.Response(status=200)


async def search_products_codes(request: web.Request, accept_language, body=None) -> web.Response:
    ...
    """
    body = SearchProductsCodesRequest.from_dict(body)
    return web.Response(status=200)
