...
#include "OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner.h"
...
OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner() {
    this->initializeModel();
}

OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::~OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner() {}

void OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::initializeModel() {

    m_apple_pass_supported_isSet = false;
    m_apple_pass_supported_isValid = false;

    m_barcode_option_isSet = false;
    m_barcode_option_isValid = false;

    m_barcode_type_isSet = false;
    m_barcode_type_isValid = false;

    m_booking_engine_id_isSet = false;
    m_booking_engine_id_isValid = false;
    ...
    m_departs_from_isSet = false;
    m_departs_from_isValid = false;

    m_departure_point_isSet = false;
    m_departure_point_isValid = false;

    m_departure_point_address_isSet = false;
    m_departure_point_address_isValid = false;

    m_departure_point_directions_isSet = false;
    m_departure_point_directions_isValid = false;

    m_dest_id_isSet = false;
    m_dest_id_isValid = false;

    m_distributor_item_ref_isSet = false;
    m_distributor_item_ref_isValid = false;

    m_hours_confirmed_isSet = false;
    m_hours_confirmed_isValid = false;

    m_item_id_isSet = false;
    m_item_id_isValid = false;

    m_itinerary_id_isSet = false;
    m_itinerary_id_isValid = false;

    m_language_services_language_code_isSet = false;
    m_language_services_language_code_isValid = false;

    m_last_retail_price_isSet = false;
    m_last_retail_price_isValid = false;

    m_last_retail_price_formatted_isSet = false;
    m_last_retail_price_formatted_isValid = false;

    m_lead_traveller_firstname_isSet = false;
    m_lead_traveller_firstname_isValid = false;

    m_lead_traveller_surname_isSet = false;
    m_lead_traveller_surname_isValid = false;

    m_lead_traveller_title_isSet = false;
    m_lead_traveller_title_isValid = false;

    m_merchant_cancellable_isSet = false;
    m_merchant_cancellable_isValid = false;

    m_merchant_net_price_isSet = false;
    m_merchant_net_price_isValid = false;

    m_merchant_net_price_formatted_isSet = false;
    m_merchant_net_price_formatted_isValid = false;

    m_obfs_id_isSet = false;
    m_obfs_id_isValid = false;

    m_passbooks_isSet = false;
    m_passbooks_isValid = false;

    m_pickup_hotel_id_isSet = false;
    m_pickup_hotel_id_isValid = false;

    m_pickup_hotel_name_isSet = false;
    m_pickup_hotel_name_isValid = false;
    ...
    m_product_pulled_down_isSet = false;
    m_product_pulled_down_isValid = false;

    m_product_title_isSet = false;
    m_product_title_isValid = false;

    m_product_widget_list_isSet = false;
    m_product_widget_list_isValid = false;

    m_rules_applied_isSet = false;
    m_rules_applied_isValid = false;

    m_saving_amount_isSet = false;
    m_saving_amount_isValid = false;

    m_saving_amount_formated_isSet = false;
    m_saving_amount_formated_isValid = false;

    m_sort_order_isSet = false;
    m_sort_order_isValid = false;

    m_starting_time_isSet = false;
    m_starting_time_isValid = false;

    m_supplier_name_isSet = false;
    m_supplier_name_isValid = false;

    m_supplier_phone_number_isSet = false;
    m_supplier_phone_number_isValid = false;

    m_terms_and_conditions_isSet = false;
    m_terms_and_conditions_isValid = false;

    m_tour_grade_code_isSet = false;
    m_tour_grade_code_isValid = false;

    m_tour_grade_description_isSet = false;
    m_tour_grade_description_isValid = false;

    m_travel_date_isSet = false;
    m_travel_date_isValid = false;

    m_traveller_age_bands_isSet = false;
    m_traveller_age_bands_isValid = false;

    m_voucher_key_isSet = false;
    m_voucher_key_isValid = false;

    m_voucher_option_isSet = false;
    m_voucher_option_isValid = false;

    m_voucher_requirements_isSet = false;
    m_voucher_requirements_isValid = false;

    m_voucher_url_isSet = false;
    m_voucher_url_isValid = false;

    m_vouchers_isSet = false;
    m_vouchers_isValid = false;
}

void OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::fromJson(QString jsonString) {
...
void OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::fromJsonObject(QJsonObject json) {

    m_apple_pass_supported_isValid = ::OpenAPI::fromJsonValue(m_apple_pass_supported, json[QString("applePassSupported")]);
    m_apple_pass_supported_isSet = !json[QString("applePassSupported")].isNull() && m_apple_pass_supported_isValid;

    m_barcode_option_isValid = ::OpenAPI::fromJsonValue(m_barcode_option, json[QString("barcodeOption")]);
    m_barcode_option_isSet = !json[QString("barcodeOption")].isNull() && m_barcode_option_isValid;
    ...
    m_booking_engine_id_isValid = ::OpenAPI::fromJsonValue(m_booking_engine_id, json[QString("bookingEngineId")]);
    m_booking_engine_id_isSet = !json[QString("bookingEngineId")].isNull() && m_booking_engine_id_isValid;
    ...
    m_departs_from_isValid = ::OpenAPI::fromJsonValue(m_departs_from, json[QString("departsFrom")]);
    m_departs_from_isSet = !json[QString("departsFrom")].isNull() && m_departs_from_isValid;
    ...
    m_departure_point_address_isValid = ::OpenAPI::fromJsonValue(m_departure_point_address, json[QString("departurePointAddress")]);
    m_departure_point_address_isSet = !json[QString("departurePointAddress")].isNull() && m_departure_point_address_isValid;

    m_departure_point_directions_isValid = ::OpenAPI::fromJsonValue(m_departure_point_directions, json[QString("departurePointDirections")]);
    m_departure_point_directions_isSet = !json[QString("departurePointDirections")].isNull() && m_departure_point_directions_isValid;

    m_dest_id_isValid = ::OpenAPI::fromJsonValue(m_dest_id, json[QString("destId")]);
    m_dest_id_isSet = !json[QString("destId")].isNull() && m_dest_id_isValid;

    m_distributor_item_ref_isValid = ::OpenAPI::fromJsonValue(m_distributor_item_ref, json[QString("distributorItemRef")]);
    m_distributor_item_ref_isSet = !json[QString("distributorItemRef")].isNull() && m_distributor_item_ref_isValid;

    m_hours_confirmed_isValid = ::OpenAPI::fromJsonValue(m_hours_confirmed, json[QString("hoursConfirmed")]);
    m_hours_confirmed_isSet = !json[QString("hoursConfirmed")].isNull() && m_hours_confirmed_isValid;
    ...
    m_itinerary_id_isValid = ::OpenAPI::fromJsonValue(m_itinerary_id, json[QString("itineraryId")]);
    m_itinerary_id_isSet = !json[QString("itineraryId")].isNull() && m_itinerary_id_isValid;

    m_language_services_language_code_isValid = ::OpenAPI::fromJsonValue(m_language_services_language_code, json[QString("languageServicesLanguageCode")]);
    m_language_services_language_code_isSet = !json[QString("languageServicesLanguageCode")].isNull() && m_language_services_language_code_isValid;

    m_last_retail_price_isValid = ::OpenAPI::fromJsonValue(m_last_retail_price, json[QString("lastRetailPrice")]);
    m_last_retail_price_isSet = !json[QString("lastRetailPrice")].isNull() && m_last_retail_price_isValid;

    m_last_retail_price_formatted_isValid = ::OpenAPI::fromJsonValue(m_last_retail_price_formatted, json[QString("lastRetailPriceFormatted")]);
    m_last_retail_price_formatted_isSet = !json[QString("lastRetailPriceFormatted")].isNull() && m_last_retail_price_formatted_isValid;

    m_lead_traveller_firstname_isValid = ::OpenAPI::fromJsonValue(m_lead_traveller_firstname, json[QString("leadTravellerFirstname")]);
    m_lead_traveller_firstname_isSet = !json[QString("leadTravellerFirstname")].isNull() && m_lead_traveller_firstname_isValid;

    m_lead_traveller_surname_isValid = ::OpenAPI::fromJsonValue(m_lead_traveller_surname, json[QString("leadTravellerSurname")]);
    m_lead_traveller_surname_isSet = !json[QString("leadTravellerSurname")].isNull() && m_lead_traveller_surname_isValid;

    m_lead_traveller_title_isValid = ::OpenAPI::fromJsonValue(m_lead_traveller_title, json[QString("leadTravellerTitle")]);
    m_lead_traveller_title_isSet = !json[QString("leadTravellerTitle")].isNull() && m_lead_traveller_title_isValid;

    m_merchant_cancellable_isValid = ::OpenAPI::fromJsonValue(m_merchant_cancellable, json[QString("merchantCancellable")]);
    m_merchant_cancellable_isSet = !json[QString("merchantCancellable")].isNull() && m_merchant_cancellable_isValid;

    m_merchant_net_price_isValid = ::OpenAPI::fromJsonValue(m_merchant_net_price, json[QString("merchantNetPrice")]);
    m_merchant_net_price_isSet = !json[QString("merchantNetPrice")].isNull() && m_merchant_net_price_isValid;

    m_merchant_net_price_formatted_isValid = ::OpenAPI::fromJsonValue(m_merchant_net_price_formatted, json[QString("merchantNetPriceFormatted")]);
    m_merchant_net_price_formatted_isSet = !json[QString("merchantNetPriceFormatted")].isNull() && m_merchant_net_price_formatted_isValid;

    m_obfs_id_isValid = ::OpenAPI::fromJsonValue(m_obfs_id, json[QString("obfsId")]);
    m_obfs_id_isSet = !json[QString("obfsId")].isNull() && m_obfs_id_isValid;

    m_passbooks_isValid = ::OpenAPI::fromJsonValue(m_passbooks, json[QString("passbooks")]);
    m_passbooks_isSet = !json[QString("passbooks")].isNull() && m_passbooks_isValid;

    m_pickup_hotel_id_isValid = ::OpenAPI::fromJsonValue(m_pickup_hotel_id, json[QString("pickupHotelId")]);
    m_pickup_hotel_id_isSet = !json[QString("pickupHotelId")].isNull() && m_pickup_hotel_id_isValid;

    m_pickup_hotel_name_isValid = ::OpenAPI::fromJsonValue(m_pickup_hotel_name, json[QString("pickupHotelName")]);
    m_pickup_hotel_name_isSet = !json[QString("pickupHotelName")].isNull() && m_pickup_hotel_name_isValid;
    ...
    m_product_pulled_down_isValid = ::OpenAPI::fromJsonValue(m_product_pulled_down, json[QString("productPulledDown")]);
    m_product_pulled_down_isSet = !json[QString("productPulledDown")].isNull() && m_product_pulled_down_isValid;
    ...
    m_product_widget_list_isValid = ::OpenAPI::fromJsonValue(m_product_widget_list, json[QString("productWidgetList")]);
    m_product_widget_list_isSet = !json[QString("productWidgetList")].isNull() && m_product_widget_list_isValid;

    m_rules_applied_isValid = ::OpenAPI::fromJsonValue(m_rules_applied, json[QString("rulesApplied")]);
    m_rules_applied_isSet = !json[QString("rulesApplied")].isNull() && m_rules_applied_isValid;

    m_saving_amount_isValid = ::OpenAPI::fromJsonValue(m_saving_amount, json[QString("savingAmount")]);
    m_saving_amount_isSet = !json[QString("savingAmount")].isNull() && m_saving_amount_isValid;

    m_saving_amount_formated_isValid = ::OpenAPI::fromJsonValue(m_saving_amount_formated, json[QString("savingAmountFormated")]);
    m_saving_amount_formated_isSet = !json[QString("savingAmountFormated")].isNull() && m_saving_amount_formated_isValid;
    ...
    m_starting_time_isValid = ::OpenAPI::fromJsonValue(m_starting_time, json[QString("startingTime")]);
    m_starting_time_isSet = !json[QString("startingTime")].isNull() && m_starting_time_isValid;
    ...
    m_supplier_phone_number_isValid = ::OpenAPI::fromJsonValue(m_supplier_phone_number, json[QString("supplierPhoneNumber")]);
    m_supplier_phone_number_isSet = !json[QString("supplierPhoneNumber")].isNull() && m_supplier_phone_number_isValid;
    ...
    m_tour_grade_code_isValid = ::OpenAPI::fromJsonValue(m_tour_grade_code, json[QString("tourGradeCode")]);
    m_tour_grade_code_isSet = !json[QString("tourGradeCode")].isNull() && m_tour_grade_code_isValid;

    m_tour_grade_description_isValid = ::OpenAPI::fromJsonValue(m_tour_grade_description, json[QString("tourGradeDescription")]);
    m_tour_grade_description_isSet = !json[QString("tourGradeDescription")].isNull() && m_tour_grade_description_isValid;

    m_travel_date_isValid = ::OpenAPI::fromJsonValue(m_travel_date, json[QString("travelDate")]);
    m_travel_date_isSet = !json[QString("travelDate")].isNull() && m_travel_date_isValid;

    m_traveller_age_bands_isValid = ::OpenAPI::fromJsonValue(m_traveller_age_bands, json[QString("travellerAgeBands")]);
    m_traveller_age_bands_isSet = !json[QString("travellerAgeBands")].isNull() && m_traveller_age_bands_isValid;

    m_voucher_key_isValid = ::OpenAPI::fromJsonValue(m_voucher_key, json[QString("voucherKey")]);
    m_voucher_key_isSet = !json[QString("voucherKey")].isNull() && m_voucher_key_isValid;

    m_voucher_option_isValid = ::OpenAPI::fromJsonValue(m_voucher_option, json[QString("voucherOption")]);
    m_voucher_option_isSet = !json[QString("voucherOption")].isNull() && m_voucher_option_isValid;

    m_voucher_requirements_isValid = ::OpenAPI::fromJsonValue(m_voucher_requirements, json[QString("voucherRequirements")]);
    m_voucher_requirements_isSet = !json[QString("voucherRequirements")].isNull() && m_voucher_requirements_isValid;

    m_voucher_url_isValid = ::OpenAPI::fromJsonValue(m_voucher_url, json[QString("voucherURL")]);
    m_voucher_url_isSet = !json[QString("voucherURL")].isNull() && m_voucher_url_isValid;

    m_vouchers_isValid = ::OpenAPI::fromJsonValue(m_vouchers, json[QString("vouchers")]);
    m_vouchers_isSet = !json[QString("vouchers")].isNull() && m_vouchers_isValid;
}

QString OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::asJson() const {
...
QJsonObject OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_apple_pass_supported_isSet) {
        obj.insert(QString("applePassSupported"), ::OpenAPI::toJsonValue(m_apple_pass_supported));
    }
    if (m_barcode_option_isSet) {
        obj.insert(QString("barcodeOption"), ::OpenAPI::toJsonValue(m_barcode_option));
    }
    if (m_barcode_type_isSet) {
        obj.insert(QString("barcodeType"), ::OpenAPI::toJsonValue(m_barcode_type));
    }
    if (m_booking_engine_id.isSet()) {
        obj.insert(QString("bookingEngineId"), ::OpenAPI::toJsonValue(m_booking_engine_id));
    }
    if (m_booking_status.isSet()) {
        obj.insert(QString("bookingStatus"), ::OpenAPI::toJsonValue(m_booking_status));
    }
    if (m_currency_code_isSet) {
        obj.insert(QString("currencyCode"), ::OpenAPI::toJsonValue(m_currency_code));
    }
    if (m_departs_from_isSet) {
        obj.insert(QString("departsFrom"), ::OpenAPI::toJsonValue(m_departs_from));
    }
    if (m_departure_point_isSet) {
        obj.insert(QString("departurePoint"), ::OpenAPI::toJsonValue(m_departure_point));
    }
    if (m_departure_point_address_isSet) {
        obj.insert(QString("departurePointAddress"), ::OpenAPI::toJsonValue(m_departure_point_address));
    }
    if (m_departure_point_directions_isSet) {
        obj.insert(QString("departurePointDirections"), ::OpenAPI::toJsonValue(m_departure_point_directions));
    }
    if (m_dest_id_isSet) {
        obj.insert(QString("destId"), ::OpenAPI::toJsonValue(m_dest_id));
    }
    if (m_distributor_item_ref_isSet) {
        obj.insert(QString("distributorItemRef"), ::OpenAPI::toJsonValue(m_distributor_item_ref));
    }
    if (m_hours_confirmed_isSet) {
        obj.insert(QString("hoursConfirmed"), ::OpenAPI::toJsonValue(m_hours_confirmed));
    }
    if (m_item_id_isSet) {
        obj.insert(QString("itemId"), ::OpenAPI::toJsonValue(m_item_id));
    }
    if (m_itinerary_id_isSet) {
        obj.insert(QString("itineraryId"), ::OpenAPI::toJsonValue(m_itinerary_id));
    }
    if (m_language_services_language_code_isSet) {
        obj.insert(QString("languageServicesLanguageCode"), ::OpenAPI::toJsonValue(m_language_services_language_code));
    }
    if (m_last_retail_price_isSet) {
        obj.insert(QString("lastRetailPrice"), ::OpenAPI::toJsonValue(m_last_retail_price));
    }
    if (m_last_retail_price_formatted_isSet) {
        obj.insert(QString("lastRetailPriceFormatted"), ::OpenAPI::toJsonValue(m_last_retail_price_formatted));
    }
    if (m_lead_traveller_firstname_isSet) {
        obj.insert(QString("leadTravellerFirstname"), ::OpenAPI::toJsonValue(m_lead_traveller_firstname));
    }
    if (m_lead_traveller_surname_isSet) {
        obj.insert(QString("leadTravellerSurname"), ::OpenAPI::toJsonValue(m_lead_traveller_surname));
    }
    if (m_lead_traveller_title_isSet) {
        obj.insert(QString("leadTravellerTitle"), ::OpenAPI::toJsonValue(m_lead_traveller_title));
    }
    if (m_merchant_cancellable_isSet) {
        obj.insert(QString("merchantCancellable"), ::OpenAPI::toJsonValue(m_merchant_cancellable));
    }
    if (m_merchant_net_price_isSet) {
        obj.insert(QString("merchantNetPrice"), ::OpenAPI::toJsonValue(m_merchant_net_price));
    }
    if (m_merchant_net_price_formatted_isSet) {
        obj.insert(QString("merchantNetPriceFormatted"), ::OpenAPI::toJsonValue(m_merchant_net_price_formatted));
    }
    if (m_obfs_id_isSet) {
        obj.insert(QString("obfsId"), ::OpenAPI::toJsonValue(m_obfs_id));
    }
    if (m_passbooks_isSet) {
        obj.insert(QString("passbooks"), ::OpenAPI::toJsonValue(m_passbooks));
    }
    if (m_pickup_hotel_id_isSet) {
        obj.insert(QString("pickupHotelId"), ::OpenAPI::toJsonValue(m_pickup_hotel_id));
    }
    if (m_pickup_hotel_name_isSet) {
        obj.insert(QString("pickupHotelName"), ::OpenAPI::toJsonValue(m_pickup_hotel_name));
    }
    if (m_price_isSet) {
        obj.insert(QString("price"), ::OpenAPI::toJsonValue(m_price));
    }
    if (m_price_formatted_isSet) {
    ...
    if (m_product_pulled_down_isSet) {
        obj.insert(QString("productPulledDown"), ::OpenAPI::toJsonValue(m_product_pulled_down));
    }
    if (m_product_title_isSet) {
        obj.insert(QString("productTitle"), ::OpenAPI::toJsonValue(m_product_title));
    }
    if (m_product_widget_list_isSet) {
        obj.insert(QString("productWidgetList"), ::OpenAPI::toJsonValue(m_product_widget_list));
    }
    if (m_rules_applied.size() > 0) {
        obj.insert(QString("rulesApplied"), ::OpenAPI::toJsonValue(m_rules_applied));
    }
    if (m_saving_amount_isSet) {
        obj.insert(QString("savingAmount"), ::OpenAPI::toJsonValue(m_saving_amount));
    }
    if (m_saving_amount_formated_isSet) {
        obj.insert(QString("savingAmountFormated"), ::OpenAPI::toJsonValue(m_saving_amount_formated));
    }
    if (m_sort_order_isSet) {
        obj.insert(QString("sortOrder"), ::OpenAPI::toJsonValue(m_sort_order));
    }
    if (m_starting_time_isSet) {
        obj.insert(QString("startingTime"), ::OpenAPI::toJsonValue(m_starting_time));
    }
    if (m_supplier_name_isSet) {
        obj.insert(QString("supplierName"), ::OpenAPI::toJsonValue(m_supplier_name));
    }
    if (m_supplier_phone_number_isSet) {
        obj.insert(QString("supplierPhoneNumber"), ::OpenAPI::toJsonValue(m_supplier_phone_number));
    }
    if (m_terms_and_conditions_isSet) {
        obj.insert(QString("termsAndConditions"), ::OpenAPI::toJsonValue(m_terms_and_conditions));
    }
    if (m_tour_grade_code_isSet) {
        obj.insert(QString("tourGradeCode"), ::OpenAPI::toJsonValue(m_tour_grade_code));
    }
    if (m_tour_grade_description_isSet) {
        obj.insert(QString("tourGradeDescription"), ::OpenAPI::toJsonValue(m_tour_grade_description));
    }
    if (m_travel_date_isSet) {
        obj.insert(QString("travelDate"), ::OpenAPI::toJsonValue(m_travel_date));
    }
    if (m_traveller_age_bands.size() > 0) {
        obj.insert(QString("travellerAgeBands"), ::OpenAPI::toJsonValue(m_traveller_age_bands));
    }
    if (m_voucher_key_isSet) {
        obj.insert(QString("voucherKey"), ::OpenAPI::toJsonValue(m_voucher_key));
    }
    if (m_voucher_option_isSet) {
        obj.insert(QString("voucherOption"), ::OpenAPI::toJsonValue(m_voucher_option));
    }
    if (m_voucher_requirements_isSet) {
        obj.insert(QString("voucherRequirements"), ::OpenAPI::toJsonValue(m_voucher_requirements));
    }
    if (m_voucher_url_isSet) {
        obj.insert(QString("voucherURL"), ::OpenAPI::toJsonValue(m_voucher_url));
    }
    if (m_vouchers_isSet) {
        obj.insert(QString("vouchers"), ::OpenAPI::toJsonValue(m_vouchers));
    }
    return obj;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::isApplePassSupported() const {
    return m_apple_pass_supported;
}
void OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::setApplePassSupported(const bool &apple_pass_supported) {
    m_apple_pass_supported = apple_pass_supported;
    m_apple_pass_supported_isSet = true;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_apple_pass_supported_Set() const{
    return m_apple_pass_supported_isSet;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_apple_pass_supported_Valid() const{
    return m_apple_pass_supported_isValid;
}

QString OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::getBarcodeOption() const {
    return m_barcode_option;
}
void OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::setBarcodeOption(const QString &barcode_option) {
    m_barcode_option = barcode_option;
    m_barcode_option_isSet = true;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_barcode_option_Set() const{
    return m_barcode_option_isSet;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_barcode_option_Valid() const{
    return m_barcode_option_isValid;
}

QString OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::getBarcodeType() const {
    return m_barcode_type;
}
void OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::setBarcodeType(const QString &barcode_type) {
    m_barcode_type = barcode_type;
    m_barcode_type_isSet = true;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_barcode_type_Set() const{
    return m_barcode_type_isSet;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_barcode_type_Valid() const{
    return m_barcode_type_isValid;
}

OAIBookingEngineId_response OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::getBookingEngineId() const {
    return m_booking_engine_id;
}
void OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::setBookingEngineId(const OAIBookingEngineId_response &booking_engine_id) {
    m_booking_engine_id = booking_engine_id;
    m_booking_engine_id_isSet = true;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_booking_engine_id_Set() const{
    return m_booking_engine_id_isSet;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_booking_engine_id_Valid() const{
    return m_booking_engine_id_isValid;
}

OAIBookingStatus_item OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::getBookingStatus() const {
    return m_booking_status;
}
void OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::setBookingStatus(const OAIBookingStatus_item &booking_status) {
    m_booking_status = booking_status;
    m_booking_status_isSet = true;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_booking_status_Set() const{
    return m_booking_status_isSet;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_booking_status_Valid() const{
    return m_booking_status_isValid;
}

QString OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::getCurrencyCode() const {
    return m_currency_code;
}
void OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::setCurrencyCode(const QString &currency_code) {
    m_currency_code = currency_code;
    m_currency_code_isSet = true;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_currency_code_Set() const{
    return m_currency_code_isSet;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_currency_code_Valid() const{
    return m_currency_code_isValid;
}

QString OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::getDepartsFrom() const {
    return m_departs_from;
}
void OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::setDepartsFrom(const QString &departs_from) {
    m_departs_from = departs_from;
    m_departs_from_isSet = true;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_departs_from_Set() const{
    return m_departs_from_isSet;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_departs_from_Valid() const{
    return m_departs_from_isValid;
}

QString OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::getDeparturePoint() const {
    return m_departure_point;
}
void OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::setDeparturePoint(const QString &departure_point) {
    m_departure_point = departure_point;
    m_departure_point_isSet = true;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_departure_point_Set() const{
    return m_departure_point_isSet;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_departure_point_Valid() const{
    return m_departure_point_isValid;
}

QString OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::getDeparturePointAddress() const {
    return m_departure_point_address;
}
void OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::setDeparturePointAddress(const QString &departure_point_address) {
    m_departure_point_address = departure_point_address;
    m_departure_point_address_isSet = true;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_departure_point_address_Set() const{
    return m_departure_point_address_isSet;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_departure_point_address_Valid() const{
    return m_departure_point_address_isValid;
}

QString OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::getDeparturePointDirections() const {
    return m_departure_point_directions;
}
void OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::setDeparturePointDirections(const QString &departure_point_directions) {
    m_departure_point_directions = departure_point_directions;
    m_departure_point_directions_isSet = true;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_departure_point_directions_Set() const{
    return m_departure_point_directions_isSet;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_departure_point_directions_Valid() const{
    return m_departure_point_directions_isValid;
}

qint32 OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::getDestId() const {
    return m_dest_id;
}
void OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::setDestId(const qint32 &dest_id) {
    m_dest_id = dest_id;
    m_dest_id_isSet = true;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_dest_id_Set() const{
    return m_dest_id_isSet;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_dest_id_Valid() const{
    return m_dest_id_isValid;
}

QString OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::getDistributorItemRef() const {
    return m_distributor_item_ref;
}
void OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::setDistributorItemRef(const QString &distributor_item_ref) {
    m_distributor_item_ref = distributor_item_ref;
    m_distributor_item_ref_isSet = true;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_distributor_item_ref_Set() const{
    return m_distributor_item_ref_isSet;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_distributor_item_ref_Valid() const{
    return m_distributor_item_ref_isValid;
}

qint32 OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::getHoursConfirmed() const {
    return m_hours_confirmed;
}
void OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::setHoursConfirmed(const qint32 &hours_confirmed) {
    m_hours_confirmed = hours_confirmed;
    m_hours_confirmed_isSet = true;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_hours_confirmed_Set() const{
    return m_hours_confirmed_isSet;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_hours_confirmed_Valid() const{
    return m_hours_confirmed_isValid;
}

qint32 OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::getItemId() const {
    return m_item_id;
}
void OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::setItemId(const qint32 &item_id) {
    m_item_id = item_id;
    m_item_id_isSet = true;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_item_id_Set() const{
    return m_item_id_isSet;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_item_id_Valid() const{
    return m_item_id_isValid;
}

qint32 OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::getItineraryId() const {
    return m_itinerary_id;
}
void OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::setItineraryId(const qint32 &itinerary_id) {
    m_itinerary_id = itinerary_id;
    m_itinerary_id_isSet = true;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_itinerary_id_Set() const{
    return m_itinerary_id_isSet;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_itinerary_id_Valid() const{
    return m_itinerary_id_isValid;
}

QString OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::getLanguageServicesLanguageCode() const {
    return m_language_services_language_code;
}
void OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::setLanguageServicesLanguageCode(const QString &language_services_language_code) {
    m_language_services_language_code = language_services_language_code;
    m_language_services_language_code_isSet = true;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_language_services_language_code_Set() const{
    return m_language_services_language_code_isSet;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_language_services_language_code_Valid() const{
    return m_language_services_language_code_isValid;
}

double OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::getLastRetailPrice() const {
    return m_last_retail_price;
}
void OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::setLastRetailPrice(const double &last_retail_price) {
    m_last_retail_price = last_retail_price;
    m_last_retail_price_isSet = true;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_last_retail_price_Set() const{
    return m_last_retail_price_isSet;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_last_retail_price_Valid() const{
    return m_last_retail_price_isValid;
}

QString OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::getLastRetailPriceFormatted() const {
    return m_last_retail_price_formatted;
}
void OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::setLastRetailPriceFormatted(const QString &last_retail_price_formatted) {
    m_last_retail_price_formatted = last_retail_price_formatted;
    m_last_retail_price_formatted_isSet = true;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_last_retail_price_formatted_Set() const{
    return m_last_retail_price_formatted_isSet;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_last_retail_price_formatted_Valid() const{
    return m_last_retail_price_formatted_isValid;
}

QString OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::getLeadTravellerFirstname() const {
    return m_lead_traveller_firstname;
}
void OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::setLeadTravellerFirstname(const QString &lead_traveller_firstname) {
    m_lead_traveller_firstname = lead_traveller_firstname;
    m_lead_traveller_firstname_isSet = true;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_lead_traveller_firstname_Set() const{
    return m_lead_traveller_firstname_isSet;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_lead_traveller_firstname_Valid() const{
    return m_lead_traveller_firstname_isValid;
}

QString OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::getLeadTravellerSurname() const {
    return m_lead_traveller_surname;
}
void OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::setLeadTravellerSurname(const QString &lead_traveller_surname) {
    m_lead_traveller_surname = lead_traveller_surname;
    m_lead_traveller_surname_isSet = true;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_lead_traveller_surname_Set() const{
    return m_lead_traveller_surname_isSet;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_lead_traveller_surname_Valid() const{
    return m_lead_traveller_surname_isValid;
}

QString OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::getLeadTravellerTitle() const {
    return m_lead_traveller_title;
}
void OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::setLeadTravellerTitle(const QString &lead_traveller_title) {
    m_lead_traveller_title = lead_traveller_title;
    m_lead_traveller_title_isSet = true;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_lead_traveller_title_Set() const{
    return m_lead_traveller_title_isSet;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_lead_traveller_title_Valid() const{
    return m_lead_traveller_title_isValid;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::isMerchantCancellable() const {
    return m_merchant_cancellable;
}
void OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::setMerchantCancellable(const bool &merchant_cancellable) {
    m_merchant_cancellable = merchant_cancellable;
    m_merchant_cancellable_isSet = true;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_merchant_cancellable_Set() const{
    return m_merchant_cancellable_isSet;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_merchant_cancellable_Valid() const{
    return m_merchant_cancellable_isValid;
}

double OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::getMerchantNetPrice() const {
    return m_merchant_net_price;
}
void OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::setMerchantNetPrice(const double &merchant_net_price) {
    m_merchant_net_price = merchant_net_price;
    m_merchant_net_price_isSet = true;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_merchant_net_price_Set() const{
    return m_merchant_net_price_isSet;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_merchant_net_price_Valid() const{
    return m_merchant_net_price_isValid;
}

QString OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::getMerchantNetPriceFormatted() const {
    return m_merchant_net_price_formatted;
}
void OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::setMerchantNetPriceFormatted(const QString &merchant_net_price_formatted) {
    m_merchant_net_price_formatted = merchant_net_price_formatted;
    m_merchant_net_price_formatted_isSet = true;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_merchant_net_price_formatted_Set() const{
    return m_merchant_net_price_formatted_isSet;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_merchant_net_price_formatted_Valid() const{
    return m_merchant_net_price_formatted_isValid;
}

qint32 OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::getObfsId() const {
    return m_obfs_id;
}
void OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::setObfsId(const qint32 &obfs_id) {
    m_obfs_id = obfs_id;
    m_obfs_id_isSet = true;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_obfs_id_Set() const{
    return m_obfs_id_isSet;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_obfs_id_Valid() const{
    return m_obfs_id_isValid;
}

QString OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::getPassbooks() const {
    return m_passbooks;
}
void OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::setPassbooks(const QString &passbooks) {
    m_passbooks = passbooks;
    m_passbooks_isSet = true;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_passbooks_Set() const{
    return m_passbooks_isSet;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_passbooks_Valid() const{
    return m_passbooks_isValid;
}

qint32 OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::getPickupHotelId() const {
    return m_pickup_hotel_id;
}
void OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::setPickupHotelId(const qint32 &pickup_hotel_id) {
    m_pickup_hotel_id = pickup_hotel_id;
    m_pickup_hotel_id_isSet = true;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_pickup_hotel_id_Set() const{
    return m_pickup_hotel_id_isSet;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_pickup_hotel_id_Valid() const{
    return m_pickup_hotel_id_isValid;
}

QString OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::getPickupHotelName() const {
    return m_pickup_hotel_name;
}
void OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::setPickupHotelName(const QString &pickup_hotel_name) {
    m_pickup_hotel_name = pickup_hotel_name;
    m_pickup_hotel_name_isSet = true;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_pickup_hotel_name_Set() const{
    return m_pickup_hotel_name_isSet;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_pickup_hotel_name_Valid() const{
    return m_pickup_hotel_name_isValid;
}

double OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::getPrice() const {
    return m_price;
}
void OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::setPrice(const double &price) {
    m_price = price;
    m_price_isSet = true;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_price_Set() const{
    return m_price_isSet;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_price_Valid() const{
    return m_price_isValid;
}

QString OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::getPriceFormatted() const {
    return m_price_formatted;
}
void OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::setPriceFormatted(const QString &price_formatted) {
    m_price_formatted = price_formatted;
    m_price_formatted_isSet = true;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_price_formatted_Set() const{
    return m_price_formatted_isSet;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_price_formatted_Valid() const{
    return m_price_formatted_isValid;
}

double OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::getPriceUsd() const {
    return m_price_usd;
}
void OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::setPriceUsd(const double &price_usd) {
    m_price_usd = price_usd;
    m_price_usd_isSet = true;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_price_usd_Set() const{
    return m_price_usd_isSet;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_price_usd_Valid() const{
    return m_price_usd_isValid;
}

QString OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::getProductCode() const {
    return m_product_code;
}
void OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::setProductCode(const QString &product_code) {
    m_product_code = product_code;
    m_product_code_isSet = true;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_product_code_Set() const{
    return m_product_code_isSet;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_product_code_Valid() const{
    return m_product_code_isValid;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::isProductPulledDown() const {
    return m_product_pulled_down;
}
void OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::setProductPulledDown(const bool &product_pulled_down) {
    m_product_pulled_down = product_pulled_down;
    m_product_pulled_down_isSet = true;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_product_pulled_down_Set() const{
    return m_product_pulled_down_isSet;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_product_pulled_down_Valid() const{
    return m_product_pulled_down_isValid;
}

QString OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::getProductTitle() const {
    return m_product_title;
}
void OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::setProductTitle(const QString &product_title) {
    m_product_title = product_title;
    m_product_title_isSet = true;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_product_title_Set() const{
    return m_product_title_isSet;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_product_title_Valid() const{
    return m_product_title_isValid;
}

QString OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::getProductWidgetList() const {
    return m_product_widget_list;
}
void OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::setProductWidgetList(const QString &product_widget_list) {
    m_product_widget_list = product_widget_list;
    m_product_widget_list_isSet = true;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_product_widget_list_Set() const{
    return m_product_widget_list_isSet;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_product_widget_list_Valid() const{
    return m_product_widget_list_isValid;
}

QList<QString> OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::getRulesApplied() const {
    return m_rules_applied;
}
void OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::setRulesApplied(const QList<QString> &rules_applied) {
    m_rules_applied = rules_applied;
    m_rules_applied_isSet = true;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_rules_applied_Set() const{
    return m_rules_applied_isSet;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_rules_applied_Valid() const{
    return m_rules_applied_isValid;
}

QString OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::getSavingAmount() const {
    return m_saving_amount;
}
void OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::setSavingAmount(const QString &saving_amount) {
    m_saving_amount = saving_amount;
    m_saving_amount_isSet = true;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_saving_amount_Set() const{
    return m_saving_amount_isSet;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_saving_amount_Valid() const{
    return m_saving_amount_isValid;
}

QString OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::getSavingAmountFormated() const {
    return m_saving_amount_formated;
}
void OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::setSavingAmountFormated(const QString &saving_amount_formated) {
    m_saving_amount_formated = saving_amount_formated;
    m_saving_amount_formated_isSet = true;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_saving_amount_formated_Set() const{
    return m_saving_amount_formated_isSet;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_saving_amount_formated_Valid() const{
    return m_saving_amount_formated_isValid;
}

qint32 OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::getSortOrder() const {
    return m_sort_order;
}
void OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::setSortOrder(const qint32 &sort_order) {
    m_sort_order = sort_order;
    m_sort_order_isSet = true;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_sort_order_Set() const{
    return m_sort_order_isSet;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_sort_order_Valid() const{
    return m_sort_order_isValid;
}

QString OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::getStartingTime() const {
    return m_starting_time;
}
void OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::setStartingTime(const QString &starting_time) {
    m_starting_time = starting_time;
    m_starting_time_isSet = true;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_starting_time_Set() const{
    return m_starting_time_isSet;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_starting_time_Valid() const{
    return m_starting_time_isValid;
}

QString OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::getSupplierName() const {
    return m_supplier_name;
}
void OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::setSupplierName(const QString &supplier_name) {
    m_supplier_name = supplier_name;
    m_supplier_name_isSet = true;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_supplier_name_Set() const{
    return m_supplier_name_isSet;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_supplier_name_Valid() const{
    return m_supplier_name_isValid;
}

QString OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::getSupplierPhoneNumber() const {
    return m_supplier_phone_number;
}
void OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::setSupplierPhoneNumber(const QString &supplier_phone_number) {
    m_supplier_phone_number = supplier_phone_number;
    m_supplier_phone_number_isSet = true;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_supplier_phone_number_Set() const{
    return m_supplier_phone_number_isSet;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_supplier_phone_number_Valid() const{
    return m_supplier_phone_number_isValid;
}

QString OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::getTermsAndConditions() const {
    return m_terms_and_conditions;
}
void OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::setTermsAndConditions(const QString &terms_and_conditions) {
    m_terms_and_conditions = terms_and_conditions;
    m_terms_and_conditions_isSet = true;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_terms_and_conditions_Set() const{
    return m_terms_and_conditions_isSet;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_terms_and_conditions_Valid() const{
    return m_terms_and_conditions_isValid;
}

QString OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::getTourGradeCode() const {
    return m_tour_grade_code;
}
void OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::setTourGradeCode(const QString &tour_grade_code) {
    m_tour_grade_code = tour_grade_code;
    m_tour_grade_code_isSet = true;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_tour_grade_code_Set() const{
    return m_tour_grade_code_isSet;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_tour_grade_code_Valid() const{
    return m_tour_grade_code_isValid;
}

QString OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::getTourGradeDescription() const {
    return m_tour_grade_description;
}
void OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::setTourGradeDescription(const QString &tour_grade_description) {
    m_tour_grade_description = tour_grade_description;
    m_tour_grade_description_isSet = true;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_tour_grade_description_Set() const{
    return m_tour_grade_description_isSet;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_tour_grade_description_Valid() const{
    return m_tour_grade_description_isValid;
}

QString OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::getTravelDate() const {
    return m_travel_date;
}
void OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::setTravelDate(const QString &travel_date) {
    m_travel_date = travel_date;
    m_travel_date_isSet = true;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_travel_date_Set() const{
    return m_travel_date_isSet;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_travel_date_Valid() const{
    return m_travel_date_isValid;
}

QList<OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner_travellerAgeBands_inner> OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::getTravellerAgeBands() const {
    return m_traveller_age_bands;
}
void OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::setTravellerAgeBands(const QList<OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner_travellerAgeBands_inner> &traveller_age_bands) {
    m_traveller_age_bands = traveller_age_bands;
    m_traveller_age_bands_isSet = true;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_traveller_age_bands_Set() const{
    return m_traveller_age_bands_isSet;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_traveller_age_bands_Valid() const{
    return m_traveller_age_bands_isValid;
}

QString OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::getVoucherKey() const {
    return m_voucher_key;
}
void OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::setVoucherKey(const QString &voucher_key) {
    m_voucher_key = voucher_key;
    m_voucher_key_isSet = true;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_voucher_key_Set() const{
    return m_voucher_key_isSet;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_voucher_key_Valid() const{
    return m_voucher_key_isValid;
}

QString OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::getVoucherOption() const {
    return m_voucher_option;
}
void OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::setVoucherOption(const QString &voucher_option) {
    m_voucher_option = voucher_option;
    m_voucher_option_isSet = true;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_voucher_option_Set() const{
    return m_voucher_option_isSet;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_voucher_option_Valid() const{
    return m_voucher_option_isValid;
}

QString OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::getVoucherRequirements() const {
    return m_voucher_requirements;
}
void OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::setVoucherRequirements(const QString &voucher_requirements) {
    m_voucher_requirements = voucher_requirements;
    m_voucher_requirements_isSet = true;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_voucher_requirements_Set() const{
    return m_voucher_requirements_isSet;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_voucher_requirements_Valid() const{
    return m_voucher_requirements_isValid;
}

QString OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::getVoucherUrl() const {
    return m_voucher_url;
}
void OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::setVoucherUrl(const QString &voucher_url) {
    m_voucher_url = voucher_url;
    m_voucher_url_isSet = true;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_voucher_url_Set() const{
    return m_voucher_url_isSet;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_voucher_url_Valid() const{
    return m_voucher_url_isValid;
}

QString OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::getVouchers() const {
    return m_vouchers;
}
void OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::setVouchers(const QString &vouchers) {
    m_vouchers = vouchers;
    m_vouchers_isSet = true;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_vouchers_Set() const{
    return m_vouchers_isSet;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::is_vouchers_Valid() const{
    return m_vouchers_isValid;
}

bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::isSet() const {
...
bool OAIBookingCalculateprice_200_response_allOf_data_itinerary_itemSummaries_inner::isValid() const {
