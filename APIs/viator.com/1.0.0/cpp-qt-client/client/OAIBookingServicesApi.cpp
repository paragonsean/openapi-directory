...
#include "OAIBookingServicesApi.h"
...
OAIBookingServicesApi::OAIBookingServicesApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIBookingServicesApi::~OAIBookingServicesApi() {
}

void OAIBookingServicesApi::initializeServerConfigs() {
    //Default server
    QList<OAIServerConfiguration> defaultConf = QList<OAIServerConfiguration>();
    //varying endpoint server
    defaultConf.append(OAIServerConfiguration(
    QUrl("https://viatorapi.viator.com/service"),
    "Production server (uses live data)",
    QMap<QString, OAIServerVariable>()));
    defaultConf.append(OAIServerConfiguration(
    QUrl("https://viatorapi.sandbox.viator.com/service"),
    "Sandbox server (uses test data)",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("bookingAvailability", defaultConf);
    _serverIndices.insert("bookingAvailability", 0);
    _serverConfigs.insert("bookingAvailabilityDates", defaultConf);
    _serverIndices.insert("bookingAvailabilityDates", 0);
    _serverConfigs.insert("bookingAvailabilityTourgrades", defaultConf);
    _serverIndices.insert("bookingAvailabilityTourgrades", 0);
    _serverConfigs.insert("bookingAvailabilityTourgradesPricingmatrix", defaultConf);
    _serverIndices.insert("bookingAvailabilityTourgradesPricingmatrix", 0);
    _serverConfigs.insert("bookingBook", defaultConf);
    _serverIndices.insert("bookingBook", 0);
    _serverConfigs.insert("bookingCalculateprice", defaultConf);
    _serverIndices.insert("bookingCalculateprice", 0);
    _serverConfigs.insert("bookingHotels", defaultConf);
    _serverIndices.insert("bookingHotels", 0);
    _serverConfigs.insert("bookingMybookings", defaultConf);
    _serverIndices.insert("bookingMybookings", 0);
    _serverConfigs.insert("bookingPastbooking", defaultConf);
    _serverIndices.insert("bookingPastbooking", 0);
    _serverConfigs.insert("bookingPricingmatrix", defaultConf);
    _serverIndices.insert("bookingPricingmatrix", 0);
    _serverConfigs.insert("bookingStatus", defaultConf);
    _serverIndices.insert("bookingStatus", 0);
    _serverConfigs.insert("bookingStatusItems", defaultConf);
    _serverIndices.insert("bookingStatusItems", 0);
    _serverConfigs.insert("bookingVoucher", defaultConf);
    _serverIndices.insert("bookingVoucher", 0);
    serverConf.append(OAIServerConfiguration(
    QUrl("https://api.sandbox.viator.com/partner"),
    "Sandbox server (uses test data)",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("cancelBooking", serverConf);
    _serverIndices.insert("cancelBooking", 0);
    serverConf.append(OAIServerConfiguration(
    QUrl("https://api.sandbox.viator.com/partner"),
    "Sandbox server (uses test data)",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("cancelBookingQuote", serverConf);
    _serverIndices.insert("cancelBookingQuote", 0);
    serverConf.append(OAIServerConfiguration(
    QUrl("https://api.sandbox.viator.com/partner"),
    "Sandbox server (uses test data)",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("cancellationReasons", serverConf);
    _serverIndices.insert("cancellationReasons", 0);
}
...
*/
int OAIBookingServicesApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIBookingServicesApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIBookingServicesApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIBookingServicesApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIBookingServicesApi::setUsername(const QString &username) {
    _username = username;
}

void OAIBookingServicesApi::setPassword(const QString &password) {
    _password = password;
}


void OAIBookingServicesApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIBookingServicesApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIBookingServicesApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIBookingServicesApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIBookingServicesApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIBookingServicesApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIBookingServicesApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIBookingServicesApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIBookingServicesApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIBookingServicesApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIBookingServicesApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIBookingServicesApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIBookingServicesApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIBookingServicesApi::bookingAvailability(const QString &accept_language, const ::OpenAPI::OptionalParam<OAIBookingAvailability_request> &oai_booking_availability_request) {
    QString fullPath = QString(_serverConfigs["bookingAvailability"][_serverIndices.value("bookingAvailability")].URL()+"/booking/availability");
    
    if (_apiKeys.contains("Legacy-API-key")) {
        if (fullPath.indexOf("?") > 0)
            fullPath.append("&");
        else
            fullPath.append("?");
        fullPath.append("Legacy-API-key=").append(_apiKeys.find("Legacy-API-key").value());
    }
    ...
    if (oai_booking_availability_request.hasValue()){

        
        QByteArray output = oai_booking_availability_request.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIBookingServicesApi::bookingAvailabilityCallback);
    connect(this, &OAIBookingServicesApi::abortRequestsSignal, worker, &QObject::deleteLater);
...
void OAIBookingServicesApi::bookingAvailabilityCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIBookingAvailability_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT bookingAvailabilitySignal(output);
        Q_EMIT bookingAvailabilitySignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT bookingAvailabilitySignalE(output, error_type, error_str);
        Q_EMIT bookingAvailabilitySignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT bookingAvailabilitySignalError(output, error_type, error_str);
        Q_EMIT bookingAvailabilitySignalErrorFull(worker, error_type, error_str);
    }
}

void OAIBookingServicesApi::bookingAvailabilityDates(const QString &accept_language, const ::OpenAPI::OptionalParam<QString> &product_code) {
    QString fullPath = QString(_serverConfigs["bookingAvailabilityDates"][_serverIndices.value("bookingAvailabilityDates")].URL()+"/booking/availability/dates");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIBookingServicesApi::bookingAvailabilityDatesCallback);
    connect(this, &OAIBookingServicesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIBookingServicesApi::bookingAvailabilityDatesCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIBookingAvailabilityDates_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT bookingAvailabilityDatesSignal(output);
        Q_EMIT bookingAvailabilityDatesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT bookingAvailabilityDatesSignalE(output, error_type, error_str);
        Q_EMIT bookingAvailabilityDatesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT bookingAvailabilityDatesSignalError(output, error_type, error_str);
        Q_EMIT bookingAvailabilityDatesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIBookingServicesApi::bookingAvailabilityTourgrades(const QString &accept_language, const ::OpenAPI::OptionalParam<OAIBookingAvailabilityTourgrades_request> &oai_booking_availability_tourgrades_request) {
    QString fullPath = QString(_serverConfigs["bookingAvailabilityTourgrades"][_serverIndices.value("bookingAvailabilityTourgrades")].URL()+"/booking/availability/tourgrades");
    ...
    if (oai_booking_availability_tourgrades_request.hasValue()){

        
        QByteArray output = oai_booking_availability_tourgrades_request.value().asJson().toUtf8();
        input.request_body.append(output);
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIBookingServicesApi::bookingAvailabilityTourgradesCallback);
    connect(this, &OAIBookingServicesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIBookingServicesApi::bookingAvailabilityTourgradesCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIBookingAvailabilityTourgrades_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT bookingAvailabilityTourgradesSignal(output);
        Q_EMIT bookingAvailabilityTourgradesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT bookingAvailabilityTourgradesSignalE(output, error_type, error_str);
        Q_EMIT bookingAvailabilityTourgradesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT bookingAvailabilityTourgradesSignalError(output, error_type, error_str);
        Q_EMIT bookingAvailabilityTourgradesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIBookingServicesApi::bookingAvailabilityTourgradesPricingmatrix(const QString &accept_language, const ::OpenAPI::OptionalParam<OAIBookingAvailabilityTourgradesPricingmatrix_request> &oai_booking_availability_tourgrades_pricingmatrix_request) {
    QString fullPath = QString(_serverConfigs["bookingAvailabilityTourgradesPricingmatrix"][_serverIndices.value("bookingAvailabilityTourgradesPricingmatrix")].URL()+"/booking/availability/tourgrades/pricingmatrix");
    ...
    if (oai_booking_availability_tourgrades_pricingmatrix_request.hasValue()){

        
        QByteArray output = oai_booking_availability_tourgrades_pricingmatrix_request.value().asJson().toUtf8();
        input.request_body.append(output);
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIBookingServicesApi::bookingAvailabilityTourgradesPricingmatrixCallback);
    connect(this, &OAIBookingServicesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIBookingServicesApi::bookingAvailabilityTourgradesPricingmatrixCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIBookingAvailabilityTourgradesPricingmatrix_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT bookingAvailabilityTourgradesPricingmatrixSignal(output);
        Q_EMIT bookingAvailabilityTourgradesPricingmatrixSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT bookingAvailabilityTourgradesPricingmatrixSignalE(output, error_type, error_str);
        Q_EMIT bookingAvailabilityTourgradesPricingmatrixSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT bookingAvailabilityTourgradesPricingmatrixSignalError(output, error_type, error_str);
        Q_EMIT bookingAvailabilityTourgradesPricingmatrixSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIBookingServicesApi::bookingBook(const QString &accept_language, const ::OpenAPI::OptionalParam<OAIBookingBook_request> &oai_booking_book_request) {
    QString fullPath = QString(_serverConfigs["bookingBook"][_serverIndices.value("bookingBook")].URL()+"/booking/book");
    ...
    if (oai_booking_book_request.hasValue()){

        
        QByteArray output = oai_booking_book_request.value().asJson().toUtf8();
        input.request_body.append(output);
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIBookingServicesApi::bookingBookCallback);
    connect(this, &OAIBookingServicesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIBookingServicesApi::bookingBookCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIBookingBook_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT bookingBookSignal(output);
        Q_EMIT bookingBookSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT bookingBookSignalE(output, error_type, error_str);
        Q_EMIT bookingBookSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT bookingBookSignalError(output, error_type, error_str);
        Q_EMIT bookingBookSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIBookingServicesApi::bookingCalculateprice(const QString &accept_language, const ::OpenAPI::OptionalParam<OAIBookingCalculateprice_request> &oai_booking_calculateprice_request) {
    QString fullPath = QString(_serverConfigs["bookingCalculateprice"][_serverIndices.value("bookingCalculateprice")].URL()+"/booking/calculateprice");
    ...
    if (oai_booking_calculateprice_request.hasValue()){

        
        QByteArray output = oai_booking_calculateprice_request.value().asJson().toUtf8();
        input.request_body.append(output);
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIBookingServicesApi::bookingCalculatepriceCallback);
    connect(this, &OAIBookingServicesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIBookingServicesApi::bookingCalculatepriceCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIBookingCalculateprice_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT bookingCalculatepriceSignal(output);
        Q_EMIT bookingCalculatepriceSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT bookingCalculatepriceSignalE(output, error_type, error_str);
        Q_EMIT bookingCalculatepriceSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT bookingCalculatepriceSignalError(output, error_type, error_str);
        Q_EMIT bookingCalculatepriceSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIBookingServicesApi::bookingHotels(const QString &accept_language, const ::OpenAPI::OptionalParam<QString> &product_code, const ::OpenAPI::OptionalParam<qint32> &dest_id) {
    QString fullPath = QString(_serverConfigs["bookingHotels"][_serverIndices.value("bookingHotels")].URL()+"/booking/hotels");
    ...
    if (dest_id.hasValue())
    {
        ...
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "destId", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("destId")).append(querySuffix).append(QUrl::toPercentEncoding(dest_id.stringValue()));
    }
    OAIHttpRequestWorker *worker = new OAIHttpRequestWorker(this, _manager);
    worker->setTimeOut(_timeOut);
    worker->setWorkingDirectory(_workingDirectory);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIBookingServicesApi::bookingHotelsCallback);
    connect(this, &OAIBookingServicesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIBookingServicesApi::bookingHotelsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIBookingHotels_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT bookingHotelsSignal(output);
        Q_EMIT bookingHotelsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT bookingHotelsSignalE(output, error_type, error_str);
        Q_EMIT bookingHotelsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT bookingHotelsSignalError(output, error_type, error_str);
        Q_EMIT bookingHotelsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIBookingServicesApi::bookingMybookings(const QString &accept_language, const ::OpenAPI::OptionalParam<QString> &voucher_key, const ::OpenAPI::OptionalParam<QString> &email, const ::OpenAPI::OptionalParam<QString> &itinerary_or_item_id) {
    QString fullPath = QString(_serverConfigs["bookingMybookings"][_serverIndices.value("bookingMybookings")].URL()+"/booking/mybookings");
    ...
    if (voucher_key.hasValue())
    {
        ...
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "voucherKey", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("voucherKey")).append(querySuffix).append(QUrl::toPercentEncoding(voucher_key.stringValue()));
    }
    if (email.hasValue())
    {
        queryStyle = "form";
    ...
    if (itinerary_or_item_id.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "itineraryOrItemId", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("itineraryOrItemId")).append(querySuffix).append(QUrl::toPercentEncoding(itinerary_or_item_id.stringValue()));
    }
    OAIHttpRequestWorker *worker = new OAIHttpRequestWorker(this, _manager);
    worker->setTimeOut(_timeOut);
    worker->setWorkingDirectory(_workingDirectory);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIBookingServicesApi::bookingMybookingsCallback);
    connect(this, &OAIBookingServicesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIBookingServicesApi::bookingMybookingsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIBookingMybookings_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT bookingMybookingsSignal(output);
        Q_EMIT bookingMybookingsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT bookingMybookingsSignalE(output, error_type, error_str);
        Q_EMIT bookingMybookingsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT bookingMybookingsSignalError(output, error_type, error_str);
        Q_EMIT bookingMybookingsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIBookingServicesApi::bookingPastbooking(const QString &accept_language, const ::OpenAPI::OptionalParam<QString> &voucher_key, const ::OpenAPI::OptionalParam<QString> &email, const ::OpenAPI::OptionalParam<QString> &item_id) {
    QString fullPath = QString(_serverConfigs["bookingPastbooking"][_serverIndices.value("bookingPastbooking")].URL()+"/booking/pastbooking");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIBookingServicesApi::bookingPastbookingCallback);
    connect(this, &OAIBookingServicesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIBookingServicesApi::bookingPastbookingCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIBookingPastbooking_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT bookingPastbookingSignal(output);
        Q_EMIT bookingPastbookingSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT bookingPastbookingSignalE(output, error_type, error_str);
        Q_EMIT bookingPastbookingSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT bookingPastbookingSignalError(output, error_type, error_str);
        Q_EMIT bookingPastbookingSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIBookingServicesApi::bookingPricingmatrix(const QString &accept_language, const ::OpenAPI::OptionalParam<OAIBookingPricingmatrix_request> &oai_booking_pricingmatrix_request) {
    QString fullPath = QString(_serverConfigs["bookingPricingmatrix"][_serverIndices.value("bookingPricingmatrix")].URL()+"/booking/pricingmatrix");
    ...
    if (oai_booking_pricingmatrix_request.hasValue()){

        
        QByteArray output = oai_booking_pricingmatrix_request.value().asJson().toUtf8();
        input.request_body.append(output);
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIBookingServicesApi::bookingPricingmatrixCallback);
    connect(this, &OAIBookingServicesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIBookingServicesApi::bookingPricingmatrixCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIBookingPricingmatrix_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT bookingPricingmatrixSignal(output);
        Q_EMIT bookingPricingmatrixSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT bookingPricingmatrixSignalE(output, error_type, error_str);
        Q_EMIT bookingPricingmatrixSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT bookingPricingmatrixSignalError(output, error_type, error_str);
        Q_EMIT bookingPricingmatrixSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIBookingServicesApi::bookingStatus(const QString &accept_language, const ::OpenAPI::OptionalParam<OAIBookingStatus_request> &oai_booking_status_request) {
    QString fullPath = QString(_serverConfigs["bookingStatus"][_serverIndices.value("bookingStatus")].URL()+"/booking/status");
    ...
    if (oai_booking_status_request.hasValue()){

        
        QByteArray output = oai_booking_status_request.value().asJson().toUtf8();
        input.request_body.append(output);
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIBookingServicesApi::bookingStatusCallback);
    connect(this, &OAIBookingServicesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIBookingServicesApi::bookingStatusCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIBookingStatus_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT bookingStatusSignal(output);
        Q_EMIT bookingStatusSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT bookingStatusSignalE(output, error_type, error_str);
        Q_EMIT bookingStatusSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT bookingStatusSignalError(output, error_type, error_str);
        Q_EMIT bookingStatusSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIBookingServicesApi::bookingStatusItems(const QString &accept_language, const ::OpenAPI::OptionalParam<OAIBookingStatusItems_request> &oai_booking_status_items_request) {
    QString fullPath = QString(_serverConfigs["bookingStatusItems"][_serverIndices.value("bookingStatusItems")].URL()+"/booking/status/items");
    ...
    if (oai_booking_status_items_request.hasValue()){

        
        QByteArray output = oai_booking_status_items_request.value().asJson().toUtf8();
        input.request_body.append(output);
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIBookingServicesApi::bookingStatusItemsCallback);
    connect(this, &OAIBookingServicesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIBookingServicesApi::bookingStatusItemsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIBookingStatusItems_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT bookingStatusItemsSignal(output);
        Q_EMIT bookingStatusItemsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT bookingStatusItemsSignalE(output, error_type, error_str);
        Q_EMIT bookingStatusItemsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT bookingStatusItemsSignalError(output, error_type, error_str);
        Q_EMIT bookingStatusItemsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIBookingServicesApi::bookingVoucher(const QString &accept_language, const ::OpenAPI::OptionalParam<QString> &lead_last_name, const ::OpenAPI::OptionalParam<qint32> &item_id, const ::OpenAPI::OptionalParam<bool> &embedded_resources, const ::OpenAPI::OptionalParam<QString> &voucher_key, const ::OpenAPI::OptionalParam<bool> &full_html, const ::OpenAPI::OptionalParam<bool> &mobile_voucher) {
    QString fullPath = QString(_serverConfigs["bookingVoucher"][_serverIndices.value("bookingVoucher")].URL()+"/booking/voucher");
    ...
    if (lead_last_name.hasValue())
    {
        ...
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "leadLastName", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("leadLastName")).append(querySuffix).append(QUrl::toPercentEncoding(lead_last_name.stringValue()));
    }
    if (item_id.hasValue())
    {
        queryStyle = "form";
    ...
    if (embedded_resources.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "embeddedResources", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("embeddedResources")).append(querySuffix).append(QUrl::toPercentEncoding(embedded_resources.stringValue()));
    }
    if (voucher_key.hasValue())
    {
        queryStyle = "form";
    ...
    if (full_html.hasValue())
    {
        ...
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "fullHTML", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("fullHTML")).append(querySuffix).append(QUrl::toPercentEncoding(full_html.stringValue()));
    }
    if (mobile_voucher.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        queryPrefix = getParamStylePrefix(queryStyle);
        querySuffix = getParamStyleSuffix(queryStyle);
        queryDelimiter = getParamStyleDelimiter(queryStyle, "mobileVoucher", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("mobileVoucher")).append(querySuffix).append(QUrl::toPercentEncoding(mobile_voucher.stringValue()));
    }
    OAIHttpRequestWorker *worker = new OAIHttpRequestWorker(this, _manager);
    worker->setTimeOut(_timeOut);
    worker->setWorkingDirectory(_workingDirectory);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIBookingServicesApi::bookingVoucherCallback);
    connect(this, &OAIBookingServicesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIBookingServicesApi::bookingVoucherCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIBookingVoucher_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT bookingVoucherSignal(output);
        Q_EMIT bookingVoucherSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT bookingVoucherSignalE(output, error_type, error_str);
        Q_EMIT bookingVoucherSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT bookingVoucherSignalError(output, error_type, error_str);
        Q_EMIT bookingVoucherSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIBookingServicesApi::cancelBooking(const QString &booking_reference, const QString &accept_language, const ::OpenAPI::OptionalParam<OAICancellationRequest> &oai_cancellation_request) {
    QString fullPath = QString(_serverConfigs["cancelBooking"][_serverIndices.value("cancelBooking")].URL()+"/bookings/{booking-reference}/cancel");
    ...
    {
        QString booking_referencePathParam("{");
        booking_referencePathParam.append("booking-reference").append("}");
        ...
        pathDelimiter = getParamStyleDelimiter(pathStyle, "booking-reference", false);
        QString paramString = (pathStyle == "matrix") ? pathPrefix+"booking-reference"+pathSuffix : pathPrefix;
        fullPath.replace(booking_referencePathParam, paramString+QUrl::toPercentEncoding(::OpenAPI::toStringValue(booking_reference)));
    }
    OAIHttpRequestWorker *worker = new OAIHttpRequestWorker(this, _manager);
    worker->setTimeOut(_timeOut);
    worker->setWorkingDirectory(_workingDirectory);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIBookingServicesApi::cancelBookingCallback);
    connect(this, &OAIBookingServicesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIBookingServicesApi::cancelBookingCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void OAIBookingServicesApi::cancelBookingQuote(const QString &booking_reference) {
    QString fullPath = QString(_serverConfigs["cancelBookingQuote"][_serverIndices.value("cancelBookingQuote")].URL()+"/bookings/{booking-reference}/cancel-quote");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIBookingServicesApi::cancelBookingQuoteCallback);
    connect(this, &OAIBookingServicesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIBookingServicesApi::cancelBookingQuoteCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAICancelBookingQuoteResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT cancelBookingQuoteSignal(output);
        Q_EMIT cancelBookingQuoteSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT cancelBookingQuoteSignalE(output, error_type, error_str);
        Q_EMIT cancelBookingQuoteSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT cancelBookingQuoteSignalError(output, error_type, error_str);
        Q_EMIT cancelBookingQuoteSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIBookingServicesApi::cancellationReasons(const QString &accept_language) {
    QString fullPath = QString(_serverConfigs["cancellationReasons"][_serverIndices.value("cancellationReasons")].URL()+"/bookings/cancel-reasons");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIBookingServicesApi::cancellationReasonsCallback);
    connect(this, &OAIBookingServicesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIBookingServicesApi::cancellationReasonsCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    QList<OAICancellationReasonsResponse> output;
    QString json(worker->response);
    QByteArray array(json.toStdString().c_str());
    QJsonDocument doc = QJsonDocument::fromJson(array);
    QJsonArray jsonArray = doc.array();
    for (QJsonValue obj : jsonArray) {
        OAICancellationReasonsResponse val;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT cancellationReasonsSignal(output);
        Q_EMIT cancellationReasonsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT cancellationReasonsSignalE(output, error_type, error_str);
        Q_EMIT cancellationReasonsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT cancellationReasonsSignalError(output, error_type, error_str);
        Q_EMIT cancellationReasonsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIBookingServicesApi::tokenAvailable(){
