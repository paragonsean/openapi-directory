...
#include "OAIProduct_200_response_allOf_data.h"
...
OAIProduct_200_response_allOf_data::OAIProduct_200_response_allOf_data(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIProduct_200_response_allOf_data::OAIProduct_200_response_allOf_data() {
    this->initializeModel();
}

OAIProduct_200_response_allOf_data::~OAIProduct_200_response_allOf_data() {}

void OAIProduct_200_response_allOf_data::initializeModel() {

    m_additional_info_isSet = false;
    m_additional_info_isValid = false;

    m_admission_isSet = false;
    m_admission_isValid = false;

    m_age_bands_isSet = false;
    m_age_bands_isValid = false;

    m_all_traveller_names_required_isSet = false;
    m_all_traveller_names_required_isValid = false;
    ...
    m_booking_questions_isSet = false;
    m_booking_questions_isValid = false;

    m_cat_ids_isSet = false;
    m_cat_ids_isValid = false;
    ...
    m_departure_time_comments_isSet = false;
    m_departure_time_comments_isValid = false;
    ...
    m_hotel_pickup_isSet = false;
    m_hotel_pickup_isValid = false;

    m_inclusions_isSet = false;
    m_inclusions_isValid = false;

    m_itinerary_isSet = false;
    m_itinerary_isValid = false;
    ...
    m_max_traveller_count_isSet = false;
    m_max_traveller_count_isValid = false;

    m_merchant_cancellable_isSet = false;
    m_merchant_cancellable_isValid = false;

    m_merchant_net_price_from_isSet = false;
    m_merchant_net_price_from_isValid = false;

    m_merchant_net_price_from_formatted_isSet = false;
    m_merchant_net_price_from_formatted_isValid = false;

    m_merchant_terms_and_conditions_isSet = false;
    m_merchant_terms_and_conditions_isValid = false;

    m_on_request_period_isSet = false;
    m_on_request_period_isValid = false;

    m_on_sale_isSet = false;
    m_on_sale_isValid = false;

    m_operates_isSet = false;
    m_operates_isValid = false;

    m_panorama_count_isSet = false;
    m_panorama_count_isValid = false;

    m_pas_isSet = false;
    m_pas_isValid = false;

    m_passenger_attributes_isSet = false;
    m_passenger_attributes_isValid = false;

    m_photo_count_isSet = false;
    m_photo_count_isValid = false;
    ...
    m_primary_destination_id_isSet = false;
    m_primary_destination_id_isValid = false;

    m_primary_destination_name_isSet = false;
    m_primary_destination_name_isValid = false;

    m_primary_destination_url_name_isSet = false;
    m_primary_destination_url_name_isValid = false;

    m_primary_group_id_isSet = false;
    m_primary_group_id_isValid = false;

    m_product_photos_isSet = false;
    m_product_photos_isValid = false;

    m_product_url_name_isSet = false;
    m_product_url_name_isValid = false;

    m_rating_isSet = false;
    m_rating_isValid = false;

    m_rating_counts_isSet = false;
    m_rating_counts_isValid = false;
    ...
    m_rrp_formatted_isSet = false;
    m_rrp_formatted_isValid = false;

    m_sales_points_isSet = false;
    m_sales_points_isValid = false;
    ...
    m_special_offer_isSet = false;
    m_special_offer_isValid = false;

    m_special_offer_available_isSet = false;
    m_special_offer_available_isValid = false;

    m_special_reservation_isSet = false;
    m_special_reservation_isValid = false;

    m_special_reservation_details_isSet = false;
    m_special_reservation_details_isValid = false;

    m_ssl_supported_isSet = false;
    m_ssl_supported_isValid = false;

    m_sub_cat_ids_isSet = false;
    m_sub_cat_ids_isValid = false;
    ...
    m_thumbnail_hi_res_url_isSet = false;
    m_thumbnail_hi_res_url_isValid = false;
    ...
    m_tour_grades_isSet = false;
    m_tour_grades_isValid = false;

    m_tour_grades_available_isSet = false;
    m_tour_grades_available_isValid = false;

    m_translation_level_isSet = false;
    m_translation_level_isValid = false;

    m_user_photos_isSet = false;
    m_user_photos_isValid = false;
...
void OAIProduct_200_response_allOf_data::fromJson(QString jsonString) {
...
void OAIProduct_200_response_allOf_data::fromJsonObject(QJsonObject json) {
    ...
    m_admission_isValid = ::OpenAPI::fromJsonValue(m_admission, json[QString("admission")]);
    m_admission_isSet = !json[QString("admission")].isNull() && m_admission_isValid;

    m_age_bands_isValid = ::OpenAPI::fromJsonValue(m_age_bands, json[QString("ageBands")]);
    m_age_bands_isSet = !json[QString("ageBands")].isNull() && m_age_bands_isValid;

    m_all_traveller_names_required_isValid = ::OpenAPI::fromJsonValue(m_all_traveller_names_required, json[QString("allTravellerNamesRequired")]);
    m_all_traveller_names_required_isSet = !json[QString("allTravellerNamesRequired")].isNull() && m_all_traveller_names_required_isValid;
    ...
    m_booking_questions_isValid = ::OpenAPI::fromJsonValue(m_booking_questions, json[QString("bookingQuestions")]);
    m_booking_questions_isSet = !json[QString("bookingQuestions")].isNull() && m_booking_questions_isValid;

    m_cat_ids_isValid = ::OpenAPI::fromJsonValue(m_cat_ids, json[QString("catIds")]);
    m_cat_ids_isSet = !json[QString("catIds")].isNull() && m_cat_ids_isValid;
    ...
    m_departure_time_comments_isValid = ::OpenAPI::fromJsonValue(m_departure_time_comments, json[QString("departureTimeComments")]);
    m_departure_time_comments_isSet = !json[QString("departureTimeComments")].isNull() && m_departure_time_comments_isValid;
    ...
    m_hotel_pickup_isValid = ::OpenAPI::fromJsonValue(m_hotel_pickup, json[QString("hotelPickup")]);
    m_hotel_pickup_isSet = !json[QString("hotelPickup")].isNull() && m_hotel_pickup_isValid;
    ...
    m_itinerary_isValid = ::OpenAPI::fromJsonValue(m_itinerary, json[QString("itinerary")]);
    m_itinerary_isSet = !json[QString("itinerary")].isNull() && m_itinerary_isValid;
    ...
    m_max_traveller_count_isValid = ::OpenAPI::fromJsonValue(m_max_traveller_count, json[QString("maxTravellerCount")]);
    m_max_traveller_count_isSet = !json[QString("maxTravellerCount")].isNull() && m_max_traveller_count_isValid;
    ...
    m_merchant_net_price_from_isValid = ::OpenAPI::fromJsonValue(m_merchant_net_price_from, json[QString("merchantNetPriceFrom")]);
    m_merchant_net_price_from_isSet = !json[QString("merchantNetPriceFrom")].isNull() && m_merchant_net_price_from_isValid;

    m_merchant_net_price_from_formatted_isValid = ::OpenAPI::fromJsonValue(m_merchant_net_price_from_formatted, json[QString("merchantNetPriceFromFormatted")]);
    m_merchant_net_price_from_formatted_isSet = !json[QString("merchantNetPriceFromFormatted")].isNull() && m_merchant_net_price_from_formatted_isValid;
    ...
    m_on_request_period_isValid = ::OpenAPI::fromJsonValue(m_on_request_period, json[QString("onRequestPeriod")]);
    m_on_request_period_isSet = !json[QString("onRequestPeriod")].isNull() && m_on_request_period_isValid;

    m_on_sale_isValid = ::OpenAPI::fromJsonValue(m_on_sale, json[QString("onSale")]);
    m_on_sale_isSet = !json[QString("onSale")].isNull() && m_on_sale_isValid;

    m_operates_isValid = ::OpenAPI::fromJsonValue(m_operates, json[QString("operates")]);
    m_operates_isSet = !json[QString("operates")].isNull() && m_operates_isValid;

    m_panorama_count_isValid = ::OpenAPI::fromJsonValue(m_panorama_count, json[QString("panoramaCount")]);
    m_panorama_count_isSet = !json[QString("panoramaCount")].isNull() && m_panorama_count_isValid;

    m_pas_isValid = ::OpenAPI::fromJsonValue(m_pas, json[QString("pas")]);
    m_pas_isSet = !json[QString("pas")].isNull() && m_pas_isValid;

    m_passenger_attributes_isValid = ::OpenAPI::fromJsonValue(m_passenger_attributes, json[QString("passengerAttributes")]);
    m_passenger_attributes_isSet = !json[QString("passengerAttributes")].isNull() && m_passenger_attributes_isValid;

    m_photo_count_isValid = ::OpenAPI::fromJsonValue(m_photo_count, json[QString("photoCount")]);
    m_photo_count_isSet = !json[QString("photoCount")].isNull() && m_photo_count_isValid;
    ...
    m_primary_destination_id_isValid = ::OpenAPI::fromJsonValue(m_primary_destination_id, json[QString("primaryDestinationId")]);
    m_primary_destination_id_isSet = !json[QString("primaryDestinationId")].isNull() && m_primary_destination_id_isValid;

    m_primary_destination_name_isValid = ::OpenAPI::fromJsonValue(m_primary_destination_name, json[QString("primaryDestinationName")]);
    m_primary_destination_name_isSet = !json[QString("primaryDestinationName")].isNull() && m_primary_destination_name_isValid;

    m_primary_destination_url_name_isValid = ::OpenAPI::fromJsonValue(m_primary_destination_url_name, json[QString("primaryDestinationUrlName")]);
    m_primary_destination_url_name_isSet = !json[QString("primaryDestinationUrlName")].isNull() && m_primary_destination_url_name_isValid;

    m_primary_group_id_isValid = ::OpenAPI::fromJsonValue(m_primary_group_id, json[QString("primaryGroupId")]);
    m_primary_group_id_isSet = !json[QString("primaryGroupId")].isNull() && m_primary_group_id_isValid;

    m_product_photos_isValid = ::OpenAPI::fromJsonValue(m_product_photos, json[QString("productPhotos")]);
    m_product_photos_isSet = !json[QString("productPhotos")].isNull() && m_product_photos_isValid;

    m_product_url_name_isValid = ::OpenAPI::fromJsonValue(m_product_url_name, json[QString("productUrlName")]);
    m_product_url_name_isSet = !json[QString("productUrlName")].isNull() && m_product_url_name_isValid;
    ...
    m_rating_counts_isValid = ::OpenAPI::fromJsonValue(m_rating_counts, json[QString("ratingCounts")]);
    m_rating_counts_isSet = !json[QString("ratingCounts")].isNull() && m_rating_counts_isValid;

    m_region_isValid = ::OpenAPI::fromJsonValue(m_region, json[QString("region")]);
    m_region_isSet = !json[QString("region")].isNull() && m_region_isValid;

    m_return_details_isValid = ::OpenAPI::fromJsonValue(m_return_details, json[QString("returnDetails")]);
    m_return_details_isSet = !json[QString("returnDetails")].isNull() && m_return_details_isValid;
    ...
    m_rrp_isValid = ::OpenAPI::fromJsonValue(m_rrp, json[QString("rrp")]);
    m_rrp_isSet = !json[QString("rrp")].isNull() && m_rrp_isValid;

    m_rrp_formatted_isValid = ::OpenAPI::fromJsonValue(m_rrp_formatted, json[QString("rrpFormatted")]);
    m_rrp_formatted_isSet = !json[QString("rrpFormatted")].isNull() && m_rrp_formatted_isValid;

    m_sales_points_isValid = ::OpenAPI::fromJsonValue(m_sales_points, json[QString("salesPoints")]);
    m_sales_points_isSet = !json[QString("salesPoints")].isNull() && m_sales_points_isValid;
    ...
    m_special_offer_isValid = ::OpenAPI::fromJsonValue(m_special_offer, json[QString("specialOffer")]);
    m_special_offer_isSet = !json[QString("specialOffer")].isNull() && m_special_offer_isValid;

    m_special_offer_available_isValid = ::OpenAPI::fromJsonValue(m_special_offer_available, json[QString("specialOfferAvailable")]);
    m_special_offer_available_isSet = !json[QString("specialOfferAvailable")].isNull() && m_special_offer_available_isValid;

    m_special_reservation_isValid = ::OpenAPI::fromJsonValue(m_special_reservation, json[QString("specialReservation")]);
    m_special_reservation_isSet = !json[QString("specialReservation")].isNull() && m_special_reservation_isValid;

    m_special_reservation_details_isValid = ::OpenAPI::fromJsonValue(m_special_reservation_details, json[QString("specialReservationDetails")]);
    m_special_reservation_details_isSet = !json[QString("specialReservationDetails")].isNull() && m_special_reservation_details_isValid;

    m_ssl_supported_isValid = ::OpenAPI::fromJsonValue(m_ssl_supported, json[QString("sslSupported")]);
    m_ssl_supported_isSet = !json[QString("sslSupported")].isNull() && m_ssl_supported_isValid;

    m_sub_cat_ids_isValid = ::OpenAPI::fromJsonValue(m_sub_cat_ids, json[QString("subCatIds")]);
    m_sub_cat_ids_isSet = !json[QString("subCatIds")].isNull() && m_sub_cat_ids_isValid;

    m_supplier_code_isValid = ::OpenAPI::fromJsonValue(m_supplier_code, json[QString("supplierCode")]);
    m_supplier_code_isSet = !json[QString("supplierCode")].isNull() && m_supplier_code_isValid;
    ...
    m_thumbnail_hi_res_url_isValid = ::OpenAPI::fromJsonValue(m_thumbnail_hi_res_url, json[QString("thumbnailHiResURL")]);
    m_thumbnail_hi_res_url_isSet = !json[QString("thumbnailHiResURL")].isNull() && m_thumbnail_hi_res_url_isValid;
    ...
    m_tour_grades_isValid = ::OpenAPI::fromJsonValue(m_tour_grades, json[QString("tourGrades")]);
    m_tour_grades_isSet = !json[QString("tourGrades")].isNull() && m_tour_grades_isValid;

    m_tour_grades_available_isValid = ::OpenAPI::fromJsonValue(m_tour_grades_available, json[QString("tourGradesAvailable")]);
    m_tour_grades_available_isSet = !json[QString("tourGradesAvailable")].isNull() && m_tour_grades_available_isValid;

    m_translation_level_isValid = ::OpenAPI::fromJsonValue(m_translation_level, json[QString("translationLevel")]);
    m_translation_level_isSet = !json[QString("translationLevel")].isNull() && m_translation_level_isValid;

    m_user_photos_isValid = ::OpenAPI::fromJsonValue(m_user_photos, json[QString("userPhotos")]);
    m_user_photos_isSet = !json[QString("userPhotos")].isNull() && m_user_photos_isValid;
...
QString OAIProduct_200_response_allOf_data::asJson() const {
...
QJsonObject OAIProduct_200_response_allOf_data::asJsonObject() const {
    QJsonObject obj;
    if (m_additional_info.size() > 0) {
        obj.insert(QString("additionalInfo"), ::OpenAPI::toJsonValue(m_additional_info));
    }
    if (m_admission_isSet) {
        obj.insert(QString("admission"), ::OpenAPI::toJsonValue(m_admission));
    }
    if (m_age_bands.size() > 0) {
        obj.insert(QString("ageBands"), ::OpenAPI::toJsonValue(m_age_bands));
    }
    if (m_all_traveller_names_required_isSet) {
        obj.insert(QString("allTravellerNamesRequired"), ::OpenAPI::toJsonValue(m_all_traveller_names_required));
    }
    ...
    if (m_booking_questions.size() > 0) {
        obj.insert(QString("bookingQuestions"), ::OpenAPI::toJsonValue(m_booking_questions));
    }
    if (m_cat_ids.size() > 0) {
        obj.insert(QString("catIds"), ::OpenAPI::toJsonValue(m_cat_ids));
    }
    if (m_city_isSet) {
    ...
    if (m_departure_time_comments_isSet) {
        obj.insert(QString("departureTimeComments"), ::OpenAPI::toJsonValue(m_departure_time_comments));
    }
    ...
    if (m_hotel_pickup_isSet) {
        obj.insert(QString("hotelPickup"), ::OpenAPI::toJsonValue(m_hotel_pickup));
    }
    if (m_inclusions.size() > 0) {
        obj.insert(QString("inclusions"), ::OpenAPI::toJsonValue(m_inclusions));
    }
    if (m_itinerary_isSet) {
        obj.insert(QString("itinerary"), ::OpenAPI::toJsonValue(m_itinerary));
    }
    if (m_location_isSet) {
    ...
    if (m_max_traveller_count_isSet) {
        obj.insert(QString("maxTravellerCount"), ::OpenAPI::toJsonValue(m_max_traveller_count));
    }
    if (m_merchant_cancellable_isSet) {
        obj.insert(QString("merchantCancellable"), ::OpenAPI::toJsonValue(m_merchant_cancellable));
    }
    if (m_merchant_net_price_from_isSet) {
        obj.insert(QString("merchantNetPriceFrom"), ::OpenAPI::toJsonValue(m_merchant_net_price_from));
    }
    if (m_merchant_net_price_from_formatted_isSet) {
        obj.insert(QString("merchantNetPriceFromFormatted"), ::OpenAPI::toJsonValue(m_merchant_net_price_from_formatted));
    }
    ...
    if (m_on_request_period_isSet) {
        obj.insert(QString("onRequestPeriod"), ::OpenAPI::toJsonValue(m_on_request_period));
    }
    if (m_on_sale_isSet) {
        obj.insert(QString("onSale"), ::OpenAPI::toJsonValue(m_on_sale));
    }
    if (m_operates_isSet) {
        obj.insert(QString("operates"), ::OpenAPI::toJsonValue(m_operates));
    }
    if (m_panorama_count_isSet) {
        obj.insert(QString("panoramaCount"), ::OpenAPI::toJsonValue(m_panorama_count));
    }
    if (m_pas_isSet) {
        obj.insert(QString("pas"), ::OpenAPI::toJsonValue(m_pas));
    }
    if (m_passenger_attributes.size() > 0) {
        obj.insert(QString("passengerAttributes"), ::OpenAPI::toJsonValue(m_passenger_attributes));
    }
    if (m_photo_count_isSet) {
        obj.insert(QString("photoCount"), ::OpenAPI::toJsonValue(m_photo_count));
    }
    if (m_price_isSet) {
    ...
    if (m_primary_destination_id_isSet) {
        obj.insert(QString("primaryDestinationId"), ::OpenAPI::toJsonValue(m_primary_destination_id));
    }
    if (m_primary_destination_name_isSet) {
        obj.insert(QString("primaryDestinationName"), ::OpenAPI::toJsonValue(m_primary_destination_name));
    }
    if (m_primary_destination_url_name_isSet) {
        obj.insert(QString("primaryDestinationUrlName"), ::OpenAPI::toJsonValue(m_primary_destination_url_name));
    }
    if (m_primary_group_id_isSet) {
        obj.insert(QString("primaryGroupId"), ::OpenAPI::toJsonValue(m_primary_group_id));
    }
    if (m_product_photos.size() > 0) {
        obj.insert(QString("productPhotos"), ::OpenAPI::toJsonValue(m_product_photos));
    }
    if (m_product_url_name_isSet) {
        obj.insert(QString("productUrlName"), ::OpenAPI::toJsonValue(m_product_url_name));
    }
    if (m_rating_isSet) {
        obj.insert(QString("rating"), ::OpenAPI::toJsonValue(m_rating));
    }
    if (m_rating_counts.isSet()) {
        obj.insert(QString("ratingCounts"), ::OpenAPI::toJsonValue(m_rating_counts));
    }
    if (m_region_isSet) {
        obj.insert(QString("region"), ::OpenAPI::toJsonValue(m_region));
    }
    if (m_return_details_isSet) {
        obj.insert(QString("returnDetails"), ::OpenAPI::toJsonValue(m_return_details));
    }
    ...
    if (m_rrp_isSet) {
        obj.insert(QString("rrp"), ::OpenAPI::toJsonValue(m_rrp));
    }
    if (m_rrp_formatted_isSet) {
        obj.insert(QString("rrpFormatted"), ::OpenAPI::toJsonValue(m_rrp_formatted));
    }
    if (m_sales_points.size() > 0) {
        obj.insert(QString("salesPoints"), ::OpenAPI::toJsonValue(m_sales_points));
    }
    ...
    if (m_special_offer_isSet) {
        obj.insert(QString("specialOffer"), ::OpenAPI::toJsonValue(m_special_offer));
    }
    if (m_special_offer_available_isSet) {
        obj.insert(QString("specialOfferAvailable"), ::OpenAPI::toJsonValue(m_special_offer_available));
    }
    if (m_special_reservation_isSet) {
        obj.insert(QString("specialReservation"), ::OpenAPI::toJsonValue(m_special_reservation));
    }
    if (m_special_reservation_details_isSet) {
        obj.insert(QString("specialReservationDetails"), ::OpenAPI::toJsonValue(m_special_reservation_details));
    }
    if (m_ssl_supported_isSet) {
        obj.insert(QString("sslSupported"), ::OpenAPI::toJsonValue(m_ssl_supported));
    }
    if (m_sub_cat_ids.size() > 0) {
        obj.insert(QString("subCatIds"), ::OpenAPI::toJsonValue(m_sub_cat_ids));
    }
    if (m_supplier_code_isSet) {
        obj.insert(QString("supplierCode"), ::OpenAPI::toJsonValue(m_supplier_code));
    }
    if (m_supplier_name_isSet) {
        obj.insert(QString("supplierName"), ::OpenAPI::toJsonValue(m_supplier_name));
    }
    if (m_thumbnail_hi_res_url_isSet) {
        obj.insert(QString("thumbnailHiResURL"), ::OpenAPI::toJsonValue(m_thumbnail_hi_res_url));
    }
    ...
    if (m_tour_grades.size() > 0) {
        obj.insert(QString("tourGrades"), ::OpenAPI::toJsonValue(m_tour_grades));
    }
    if (m_tour_grades_available_isSet) {
        obj.insert(QString("tourGradesAvailable"), ::OpenAPI::toJsonValue(m_tour_grades_available));
    }
    if (m_translation_level.isSet()) {
        obj.insert(QString("translationLevel"), ::OpenAPI::toJsonValue(m_translation_level));
    }
    if (m_user_photos.size() > 0) {
        obj.insert(QString("userPhotos"), ::OpenAPI::toJsonValue(m_user_photos));
    }
...
QList<QString> OAIProduct_200_response_allOf_data::getAdditionalInfo() const {
    return m_additional_info;
}
void OAIProduct_200_response_allOf_data::setAdditionalInfo(const QList<QString> &additional_info) {
    m_additional_info = additional_info;
    m_additional_info_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_additional_info_Set() const{
    return m_additional_info_isSet;
}

bool OAIProduct_200_response_allOf_data::is_additional_info_Valid() const{
    return m_additional_info_isValid;
}

QString OAIProduct_200_response_allOf_data::getAdmission() const {
    return m_admission;
}
void OAIProduct_200_response_allOf_data::setAdmission(const QString &admission) {
    m_admission = admission;
    m_admission_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_admission_Set() const{
    return m_admission_isSet;
}

bool OAIProduct_200_response_allOf_data::is_admission_Valid() const{
    return m_admission_isValid;
}

QList<OAIProduct_200_response_allOf_data_ageBands_inner> OAIProduct_200_response_allOf_data::getAgeBands() const {
    return m_age_bands;
}
void OAIProduct_200_response_allOf_data::setAgeBands(const QList<OAIProduct_200_response_allOf_data_ageBands_inner> &age_bands) {
    m_age_bands = age_bands;
    m_age_bands_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_age_bands_Set() const{
    return m_age_bands_isSet;
}

bool OAIProduct_200_response_allOf_data::is_age_bands_Valid() const{
    return m_age_bands_isValid;
}

bool OAIProduct_200_response_allOf_data::isAllTravellerNamesRequired() const {
    return m_all_traveller_names_required;
}
void OAIProduct_200_response_allOf_data::setAllTravellerNamesRequired(const bool &all_traveller_names_required) {
    m_all_traveller_names_required = all_traveller_names_required;
    m_all_traveller_names_required_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_all_traveller_names_required_Set() const{
    return m_all_traveller_names_required_isSet;
}

bool OAIProduct_200_response_allOf_data::is_all_traveller_names_required_Valid() const{
    return m_all_traveller_names_required_isValid;
}

bool OAIProduct_200_response_allOf_data::isApplePassSupported() const {
    return m_apple_pass_supported;
}
void OAIProduct_200_response_allOf_data::setApplePassSupported(const bool &apple_pass_supported) {
    m_apple_pass_supported = apple_pass_supported;
    m_apple_pass_supported_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_apple_pass_supported_Set() const{
    return m_apple_pass_supported_isSet;
}

bool OAIProduct_200_response_allOf_data::is_apple_pass_supported_Valid() const{
    return m_apple_pass_supported_isValid;
}

bool OAIProduct_200_response_allOf_data::isAvailable() const {
    return m_available;
}
void OAIProduct_200_response_allOf_data::setAvailable(const bool &available) {
    m_available = available;
    m_available_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_available_Set() const{
    return m_available_isSet;
}

bool OAIProduct_200_response_allOf_data::is_available_Valid() const{
    return m_available_isValid;
}

OAIBookingEngineId OAIProduct_200_response_allOf_data::getBookingEngineId() const {
    return m_booking_engine_id;
}
void OAIProduct_200_response_allOf_data::setBookingEngineId(const OAIBookingEngineId &booking_engine_id) {
    m_booking_engine_id = booking_engine_id;
    m_booking_engine_id_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_booking_engine_id_Set() const{
    return m_booking_engine_id_isSet;
}

bool OAIProduct_200_response_allOf_data::is_booking_engine_id_Valid() const{
    return m_booking_engine_id_isValid;
}

QList<OAIProduct_200_response_allOf_data_bookingQuestions_inner> OAIProduct_200_response_allOf_data::getBookingQuestions() const {
    return m_booking_questions;
}
void OAIProduct_200_response_allOf_data::setBookingQuestions(const QList<OAIProduct_200_response_allOf_data_bookingQuestions_inner> &booking_questions) {
    m_booking_questions = booking_questions;
    m_booking_questions_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_booking_questions_Set() const{
    return m_booking_questions_isSet;
}

bool OAIProduct_200_response_allOf_data::is_booking_questions_Valid() const{
    return m_booking_questions_isValid;
}

QList<qint32> OAIProduct_200_response_allOf_data::getCatIds() const {
    return m_cat_ids;
}
void OAIProduct_200_response_allOf_data::setCatIds(const QList<qint32> &cat_ids) {
    m_cat_ids = cat_ids;
    m_cat_ids_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_cat_ids_Set() const{
    return m_cat_ids_isSet;
}

bool OAIProduct_200_response_allOf_data::is_cat_ids_Valid() const{
    return m_cat_ids_isValid;
}

QString OAIProduct_200_response_allOf_data::getCity() const {
    return m_city;
}
void OAIProduct_200_response_allOf_data::setCity(const QString &city) {
    m_city = city;
    m_city_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_city_Set() const{
    return m_city_isSet;
}

bool OAIProduct_200_response_allOf_data::is_city_Valid() const{
    return m_city_isValid;
}

QString OAIProduct_200_response_allOf_data::getCode() const {
    return m_code;
}
void OAIProduct_200_response_allOf_data::setCode(const QString &code) {
    m_code = code;
    m_code_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_code_Set() const{
    return m_code_isSet;
}

bool OAIProduct_200_response_allOf_data::is_code_Valid() const{
    return m_code_isValid;
}

QString OAIProduct_200_response_allOf_data::getCountry() const {
    return m_country;
}
void OAIProduct_200_response_allOf_data::setCountry(const QString &country) {
    m_country = country;
    m_country_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_country_Set() const{
    return m_country_isSet;
}

bool OAIProduct_200_response_allOf_data::is_country_Valid() const{
    return m_country_isValid;
}

QString OAIProduct_200_response_allOf_data::getCurrencyCode() const {
    return m_currency_code;
}
void OAIProduct_200_response_allOf_data::setCurrencyCode(const QString &currency_code) {
    m_currency_code = currency_code;
    m_currency_code_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_currency_code_Set() const{
    return m_currency_code_isSet;
}

bool OAIProduct_200_response_allOf_data::is_currency_code_Valid() const{
    return m_currency_code_isValid;
}

QString OAIProduct_200_response_allOf_data::getDeparturePoint() const {
    return m_departure_point;
}
void OAIProduct_200_response_allOf_data::setDeparturePoint(const QString &departure_point) {
    m_departure_point = departure_point;
    m_departure_point_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_departure_point_Set() const{
    return m_departure_point_isSet;
}

bool OAIProduct_200_response_allOf_data::is_departure_point_Valid() const{
    return m_departure_point_isValid;
}

QString OAIProduct_200_response_allOf_data::getDepartureTime() const {
    return m_departure_time;
}
void OAIProduct_200_response_allOf_data::setDepartureTime(const QString &departure_time) {
    m_departure_time = departure_time;
    m_departure_time_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_departure_time_Set() const{
    return m_departure_time_isSet;
}

bool OAIProduct_200_response_allOf_data::is_departure_time_Valid() const{
    return m_departure_time_isValid;
}

QString OAIProduct_200_response_allOf_data::getDepartureTimeComments() const {
    return m_departure_time_comments;
}
void OAIProduct_200_response_allOf_data::setDepartureTimeComments(const QString &departure_time_comments) {
    m_departure_time_comments = departure_time_comments;
    m_departure_time_comments_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_departure_time_comments_Set() const{
    return m_departure_time_comments_isSet;
}

bool OAIProduct_200_response_allOf_data::is_departure_time_comments_Valid() const{
    return m_departure_time_comments_isValid;
}

QString OAIProduct_200_response_allOf_data::getDescription() const {
    return m_description;
}
void OAIProduct_200_response_allOf_data::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_description_Set() const{
    return m_description_isSet;
}

bool OAIProduct_200_response_allOf_data::is_description_Valid() const{
    return m_description_isValid;
}

qint32 OAIProduct_200_response_allOf_data::getDestinationId() const {
    return m_destination_id;
}
void OAIProduct_200_response_allOf_data::setDestinationId(const qint32 &destination_id) {
    m_destination_id = destination_id;
    m_destination_id_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_destination_id_Set() const{
    return m_destination_id_isSet;
}

bool OAIProduct_200_response_allOf_data::is_destination_id_Valid() const{
    return m_destination_id_isValid;
}

QString OAIProduct_200_response_allOf_data::getDuration() const {
    return m_duration;
}
void OAIProduct_200_response_allOf_data::setDuration(const QString &duration) {
    m_duration = duration;
    m_duration_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_duration_Set() const{
    return m_duration_isSet;
}

bool OAIProduct_200_response_allOf_data::is_duration_Valid() const{
    return m_duration_isValid;
}

QString OAIProduct_200_response_allOf_data::getEssential() const {
    return m_essential;
}
void OAIProduct_200_response_allOf_data::setEssential(const QString &essential) {
    m_essential = essential;
    m_essential_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_essential_Set() const{
    return m_essential_isSet;
}

bool OAIProduct_200_response_allOf_data::is_essential_Valid() const{
    return m_essential_isValid;
}

QList<QString> OAIProduct_200_response_allOf_data::getExclusions() const {
    return m_exclusions;
}
void OAIProduct_200_response_allOf_data::setExclusions(const QList<QString> &exclusions) {
    m_exclusions = exclusions;
    m_exclusions_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_exclusions_Set() const{
    return m_exclusions_isSet;
}

bool OAIProduct_200_response_allOf_data::is_exclusions_Valid() const{
    return m_exclusions_isValid;
}

qint32 OAIProduct_200_response_allOf_data::getHighlights() const {
    return m_highlights;
}
void OAIProduct_200_response_allOf_data::setHighlights(const qint32 &highlights) {
    m_highlights = highlights;
    m_highlights_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_highlights_Set() const{
    return m_highlights_isSet;
}

bool OAIProduct_200_response_allOf_data::is_highlights_Valid() const{
    return m_highlights_isValid;
}

bool OAIProduct_200_response_allOf_data::isHotelPickup() const {
    return m_hotel_pickup;
}
void OAIProduct_200_response_allOf_data::setHotelPickup(const bool &hotel_pickup) {
    m_hotel_pickup = hotel_pickup;
    m_hotel_pickup_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_hotel_pickup_Set() const{
    return m_hotel_pickup_isSet;
}

bool OAIProduct_200_response_allOf_data::is_hotel_pickup_Valid() const{
    return m_hotel_pickup_isValid;
}

QList<QString> OAIProduct_200_response_allOf_data::getInclusions() const {
    return m_inclusions;
}
void OAIProduct_200_response_allOf_data::setInclusions(const QList<QString> &inclusions) {
    m_inclusions = inclusions;
    m_inclusions_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_inclusions_Set() const{
    return m_inclusions_isSet;
}

bool OAIProduct_200_response_allOf_data::is_inclusions_Valid() const{
    return m_inclusions_isValid;
}

QString OAIProduct_200_response_allOf_data::getItinerary() const {
    return m_itinerary;
}
void OAIProduct_200_response_allOf_data::setItinerary(const QString &itinerary) {
    m_itinerary = itinerary;
    m_itinerary_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_itinerary_Set() const{
    return m_itinerary_isSet;
}

bool OAIProduct_200_response_allOf_data::is_itinerary_Valid() const{
    return m_itinerary_isValid;
}

QString OAIProduct_200_response_allOf_data::getLocation() const {
    return m_location;
}
void OAIProduct_200_response_allOf_data::setLocation(const QString &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_location_Set() const{
    return m_location_isSet;
}

bool OAIProduct_200_response_allOf_data::is_location_Valid() const{
    return m_location_isValid;
}

QString OAIProduct_200_response_allOf_data::getMapUrl() const {
    return m_map_url;
}
void OAIProduct_200_response_allOf_data::setMapUrl(const QString &map_url) {
    m_map_url = map_url;
    m_map_url_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_map_url_Set() const{
    return m_map_url_isSet;
}

bool OAIProduct_200_response_allOf_data::is_map_url_Valid() const{
    return m_map_url_isValid;
}

qint32 OAIProduct_200_response_allOf_data::getMaxTravellerCount() const {
    return m_max_traveller_count;
}
void OAIProduct_200_response_allOf_data::setMaxTravellerCount(const qint32 &max_traveller_count) {
    m_max_traveller_count = max_traveller_count;
    m_max_traveller_count_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_max_traveller_count_Set() const{
    return m_max_traveller_count_isSet;
}

bool OAIProduct_200_response_allOf_data::is_max_traveller_count_Valid() const{
    return m_max_traveller_count_isValid;
}

bool OAIProduct_200_response_allOf_data::isMerchantCancellable() const {
    return m_merchant_cancellable;
}
void OAIProduct_200_response_allOf_data::setMerchantCancellable(const bool &merchant_cancellable) {
    m_merchant_cancellable = merchant_cancellable;
    m_merchant_cancellable_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_merchant_cancellable_Set() const{
    return m_merchant_cancellable_isSet;
}

bool OAIProduct_200_response_allOf_data::is_merchant_cancellable_Valid() const{
    return m_merchant_cancellable_isValid;
}

double OAIProduct_200_response_allOf_data::getMerchantNetPriceFrom() const {
    return m_merchant_net_price_from;
}
void OAIProduct_200_response_allOf_data::setMerchantNetPriceFrom(const double &merchant_net_price_from) {
    m_merchant_net_price_from = merchant_net_price_from;
    m_merchant_net_price_from_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_merchant_net_price_from_Set() const{
    return m_merchant_net_price_from_isSet;
}

bool OAIProduct_200_response_allOf_data::is_merchant_net_price_from_Valid() const{
    return m_merchant_net_price_from_isValid;
}

QString OAIProduct_200_response_allOf_data::getMerchantNetPriceFromFormatted() const {
    return m_merchant_net_price_from_formatted;
}
void OAIProduct_200_response_allOf_data::setMerchantNetPriceFromFormatted(const QString &merchant_net_price_from_formatted) {
    m_merchant_net_price_from_formatted = merchant_net_price_from_formatted;
    m_merchant_net_price_from_formatted_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_merchant_net_price_from_formatted_Set() const{
    return m_merchant_net_price_from_formatted_isSet;
}

bool OAIProduct_200_response_allOf_data::is_merchant_net_price_from_formatted_Valid() const{
    return m_merchant_net_price_from_formatted_isValid;
}

OAIProduct_200_response_allOf_data_merchantTermsAndConditions OAIProduct_200_response_allOf_data::getMerchantTermsAndConditions() const {
    return m_merchant_terms_and_conditions;
}
void OAIProduct_200_response_allOf_data::setMerchantTermsAndConditions(const OAIProduct_200_response_allOf_data_merchantTermsAndConditions &merchant_terms_and_conditions) {
    m_merchant_terms_and_conditions = merchant_terms_and_conditions;
    m_merchant_terms_and_conditions_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_merchant_terms_and_conditions_Set() const{
    return m_merchant_terms_and_conditions_isSet;
}

bool OAIProduct_200_response_allOf_data::is_merchant_terms_and_conditions_Valid() const{
    return m_merchant_terms_and_conditions_isValid;
}

qint32 OAIProduct_200_response_allOf_data::getOnRequestPeriod() const {
    return m_on_request_period;
}
void OAIProduct_200_response_allOf_data::setOnRequestPeriod(const qint32 &on_request_period) {
    m_on_request_period = on_request_period;
    m_on_request_period_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_on_request_period_Set() const{
    return m_on_request_period_isSet;
}

bool OAIProduct_200_response_allOf_data::is_on_request_period_Valid() const{
    return m_on_request_period_isValid;
}

bool OAIProduct_200_response_allOf_data::isOnSale() const {
    return m_on_sale;
}
void OAIProduct_200_response_allOf_data::setOnSale(const bool &on_sale) {
    m_on_sale = on_sale;
    m_on_sale_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_on_sale_Set() const{
    return m_on_sale_isSet;
}

bool OAIProduct_200_response_allOf_data::is_on_sale_Valid() const{
    return m_on_sale_isValid;
}

QString OAIProduct_200_response_allOf_data::getOperates() const {
    return m_operates;
}
void OAIProduct_200_response_allOf_data::setOperates(const QString &operates) {
    m_operates = operates;
    m_operates_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_operates_Set() const{
    return m_operates_isSet;
}

bool OAIProduct_200_response_allOf_data::is_operates_Valid() const{
    return m_operates_isValid;
}

qint32 OAIProduct_200_response_allOf_data::getPanoramaCount() const {
    return m_panorama_count;
}
void OAIProduct_200_response_allOf_data::setPanoramaCount(const qint32 &panorama_count) {
    m_panorama_count = panorama_count;
    m_panorama_count_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_panorama_count_Set() const{
    return m_panorama_count_isSet;
}

bool OAIProduct_200_response_allOf_data::is_panorama_count_Valid() const{
    return m_panorama_count_isValid;
}

OAIObject OAIProduct_200_response_allOf_data::getPas() const {
    return m_pas;
}
void OAIProduct_200_response_allOf_data::setPas(const OAIObject &pas) {
    m_pas = pas;
    m_pas_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_pas_Set() const{
    return m_pas_isSet;
}

bool OAIProduct_200_response_allOf_data::is_pas_Valid() const{
    return m_pas_isValid;
}

QList<OAIProduct_200_response_allOf_data_passengerAttributes_inner> OAIProduct_200_response_allOf_data::getPassengerAttributes() const {
    return m_passenger_attributes;
}
void OAIProduct_200_response_allOf_data::setPassengerAttributes(const QList<OAIProduct_200_response_allOf_data_passengerAttributes_inner> &passenger_attributes) {
    m_passenger_attributes = passenger_attributes;
    m_passenger_attributes_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_passenger_attributes_Set() const{
    return m_passenger_attributes_isSet;
}

bool OAIProduct_200_response_allOf_data::is_passenger_attributes_Valid() const{
    return m_passenger_attributes_isValid;
}

qint32 OAIProduct_200_response_allOf_data::getPhotoCount() const {
    return m_photo_count;
}
void OAIProduct_200_response_allOf_data::setPhotoCount(const qint32 &photo_count) {
    m_photo_count = photo_count;
    m_photo_count_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_photo_count_Set() const{
    return m_photo_count_isSet;
}

bool OAIProduct_200_response_allOf_data::is_photo_count_Valid() const{
    return m_photo_count_isValid;
}

double OAIProduct_200_response_allOf_data::getPrice() const {
    return m_price;
}
void OAIProduct_200_response_allOf_data::setPrice(const double &price) {
    m_price = price;
    m_price_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_price_Set() const{
    return m_price_isSet;
}

bool OAIProduct_200_response_allOf_data::is_price_Valid() const{
    return m_price_isValid;
}

QString OAIProduct_200_response_allOf_data::getPriceFormatted() const {
    return m_price_formatted;
}
void OAIProduct_200_response_allOf_data::setPriceFormatted(const QString &price_formatted) {
    m_price_formatted = price_formatted;
    m_price_formatted_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_price_formatted_Set() const{
    return m_price_formatted_isSet;
}

bool OAIProduct_200_response_allOf_data::is_price_formatted_Valid() const{
    return m_price_formatted_isValid;
}

qint32 OAIProduct_200_response_allOf_data::getPrimaryDestinationId() const {
    return m_primary_destination_id;
}
void OAIProduct_200_response_allOf_data::setPrimaryDestinationId(const qint32 &primary_destination_id) {
    m_primary_destination_id = primary_destination_id;
    m_primary_destination_id_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_primary_destination_id_Set() const{
    return m_primary_destination_id_isSet;
}

bool OAIProduct_200_response_allOf_data::is_primary_destination_id_Valid() const{
    return m_primary_destination_id_isValid;
}

QString OAIProduct_200_response_allOf_data::getPrimaryDestinationName() const {
    return m_primary_destination_name;
}
void OAIProduct_200_response_allOf_data::setPrimaryDestinationName(const QString &primary_destination_name) {
    m_primary_destination_name = primary_destination_name;
    m_primary_destination_name_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_primary_destination_name_Set() const{
    return m_primary_destination_name_isSet;
}

bool OAIProduct_200_response_allOf_data::is_primary_destination_name_Valid() const{
    return m_primary_destination_name_isValid;
}

QString OAIProduct_200_response_allOf_data::getPrimaryDestinationUrlName() const {
    return m_primary_destination_url_name;
}
void OAIProduct_200_response_allOf_data::setPrimaryDestinationUrlName(const QString &primary_destination_url_name) {
    m_primary_destination_url_name = primary_destination_url_name;
    m_primary_destination_url_name_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_primary_destination_url_name_Set() const{
    return m_primary_destination_url_name_isSet;
}

bool OAIProduct_200_response_allOf_data::is_primary_destination_url_name_Valid() const{
    return m_primary_destination_url_name_isValid;
}

QString OAIProduct_200_response_allOf_data::getPrimaryGroupId() const {
    return m_primary_group_id;
}
void OAIProduct_200_response_allOf_data::setPrimaryGroupId(const QString &primary_group_id) {
    m_primary_group_id = primary_group_id;
    m_primary_group_id_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_primary_group_id_Set() const{
    return m_primary_group_id_isSet;
}

bool OAIProduct_200_response_allOf_data::is_primary_group_id_Valid() const{
    return m_primary_group_id_isValid;
}

QList<OAIProduct_200_response_allOf_data_productPhotos_inner> OAIProduct_200_response_allOf_data::getProductPhotos() const {
    return m_product_photos;
}
void OAIProduct_200_response_allOf_data::setProductPhotos(const QList<OAIProduct_200_response_allOf_data_productPhotos_inner> &product_photos) {
    m_product_photos = product_photos;
    m_product_photos_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_product_photos_Set() const{
    return m_product_photos_isSet;
}

bool OAIProduct_200_response_allOf_data::is_product_photos_Valid() const{
    return m_product_photos_isValid;
}

QString OAIProduct_200_response_allOf_data::getProductUrlName() const {
    return m_product_url_name;
}
void OAIProduct_200_response_allOf_data::setProductUrlName(const QString &product_url_name) {
    m_product_url_name = product_url_name;
    m_product_url_name_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_product_url_name_Set() const{
    return m_product_url_name_isSet;
}

bool OAIProduct_200_response_allOf_data::is_product_url_name_Valid() const{
    return m_product_url_name_isValid;
}

double OAIProduct_200_response_allOf_data::getRating() const {
    return m_rating;
}
void OAIProduct_200_response_allOf_data::setRating(const double &rating) {
    m_rating = rating;
    m_rating_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_rating_Set() const{
    return m_rating_isSet;
}

bool OAIProduct_200_response_allOf_data::is_rating_Valid() const{
    return m_rating_isValid;
}

OAIRatingCounts OAIProduct_200_response_allOf_data::getRatingCounts() const {
    return m_rating_counts;
}
void OAIProduct_200_response_allOf_data::setRatingCounts(const OAIRatingCounts &rating_counts) {
    m_rating_counts = rating_counts;
    m_rating_counts_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_rating_counts_Set() const{
    return m_rating_counts_isSet;
}

bool OAIProduct_200_response_allOf_data::is_rating_counts_Valid() const{
    return m_rating_counts_isValid;
}

QString OAIProduct_200_response_allOf_data::getRegion() const {
    return m_region;
}
void OAIProduct_200_response_allOf_data::setRegion(const QString &region) {
    m_region = region;
    m_region_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_region_Set() const{
    return m_region_isSet;
}

bool OAIProduct_200_response_allOf_data::is_region_Valid() const{
    return m_region_isValid;
}

QString OAIProduct_200_response_allOf_data::getReturnDetails() const {
    return m_return_details;
}
void OAIProduct_200_response_allOf_data::setReturnDetails(const QString &return_details) {
    m_return_details = return_details;
    m_return_details_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_return_details_Set() const{
    return m_return_details_isSet;
}

bool OAIProduct_200_response_allOf_data::is_return_details_Valid() const{
    return m_return_details_isValid;
}

qint32 OAIProduct_200_response_allOf_data::getReviewCount() const {
    return m_review_count;
}
void OAIProduct_200_response_allOf_data::setReviewCount(const qint32 &review_count) {
    m_review_count = review_count;
    m_review_count_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_review_count_Set() const{
    return m_review_count_isSet;
}

bool OAIProduct_200_response_allOf_data::is_review_count_Valid() const{
    return m_review_count_isValid;
}

QList<OAIReviewObject> OAIProduct_200_response_allOf_data::getReviews() const {
    return m_reviews;
}
void OAIProduct_200_response_allOf_data::setReviews(const QList<OAIReviewObject> &reviews) {
    m_reviews = reviews;
    m_reviews_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_reviews_Set() const{
    return m_reviews_isSet;
}

bool OAIProduct_200_response_allOf_data::is_reviews_Valid() const{
    return m_reviews_isValid;
}

qint32 OAIProduct_200_response_allOf_data::getRrp() const {
    return m_rrp;
}
void OAIProduct_200_response_allOf_data::setRrp(const qint32 &rrp) {
    m_rrp = rrp;
    m_rrp_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_rrp_Set() const{
    return m_rrp_isSet;
}

bool OAIProduct_200_response_allOf_data::is_rrp_Valid() const{
    return m_rrp_isValid;
}

QString OAIProduct_200_response_allOf_data::getRrpFormatted() const {
    return m_rrp_formatted;
}
void OAIProduct_200_response_allOf_data::setRrpFormatted(const QString &rrp_formatted) {
    m_rrp_formatted = rrp_formatted;
    m_rrp_formatted_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_rrp_formatted_Set() const{
    return m_rrp_formatted_isSet;
}

bool OAIProduct_200_response_allOf_data::is_rrp_formatted_Valid() const{
    return m_rrp_formatted_isValid;
}

QList<QString> OAIProduct_200_response_allOf_data::getSalesPoints() const {
    return m_sales_points;
}
void OAIProduct_200_response_allOf_data::setSalesPoints(const QList<QString> &sales_points) {
    m_sales_points = sales_points;
    m_sales_points_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_sales_points_Set() const{
    return m_sales_points_isSet;
}

bool OAIProduct_200_response_allOf_data::is_sales_points_Valid() const{
    return m_sales_points_isValid;
}

QString OAIProduct_200_response_allOf_data::getSavingAmount() const {
    return m_saving_amount;
}
void OAIProduct_200_response_allOf_data::setSavingAmount(const QString &saving_amount) {
    m_saving_amount = saving_amount;
    m_saving_amount_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_saving_amount_Set() const{
    return m_saving_amount_isSet;
}

bool OAIProduct_200_response_allOf_data::is_saving_amount_Valid() const{
    return m_saving_amount_isValid;
}

QString OAIProduct_200_response_allOf_data::getSavingAmountFormated() const {
    return m_saving_amount_formated;
}
void OAIProduct_200_response_allOf_data::setSavingAmountFormated(const QString &saving_amount_formated) {
    m_saving_amount_formated = saving_amount_formated;
    m_saving_amount_formated_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_saving_amount_formated_Set() const{
    return m_saving_amount_formated_isSet;
}

bool OAIProduct_200_response_allOf_data::is_saving_amount_formated_Valid() const{
    return m_saving_amount_formated_isValid;
}

QString OAIProduct_200_response_allOf_data::getShortDescription() const {
    return m_short_description;
}
void OAIProduct_200_response_allOf_data::setShortDescription(const QString &short_description) {
    m_short_description = short_description;
    m_short_description_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_short_description_Set() const{
    return m_short_description_isSet;
}

bool OAIProduct_200_response_allOf_data::is_short_description_Valid() const{
    return m_short_description_isValid;
}

QString OAIProduct_200_response_allOf_data::getShortTitle() const {
    return m_short_title;
}
void OAIProduct_200_response_allOf_data::setShortTitle(const QString &short_title) {
    m_short_title = short_title;
    m_short_title_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_short_title_Set() const{
    return m_short_title_isSet;
}

bool OAIProduct_200_response_allOf_data::is_short_title_Valid() const{
    return m_short_title_isValid;
}

QString OAIProduct_200_response_allOf_data::getSpecialOffer() const {
    return m_special_offer;
}
void OAIProduct_200_response_allOf_data::setSpecialOffer(const QString &special_offer) {
    m_special_offer = special_offer;
    m_special_offer_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_special_offer_Set() const{
    return m_special_offer_isSet;
}

bool OAIProduct_200_response_allOf_data::is_special_offer_Valid() const{
    return m_special_offer_isValid;
}

bool OAIProduct_200_response_allOf_data::isSpecialOfferAvailable() const {
    return m_special_offer_available;
}
void OAIProduct_200_response_allOf_data::setSpecialOfferAvailable(const bool &special_offer_available) {
    m_special_offer_available = special_offer_available;
    m_special_offer_available_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_special_offer_available_Set() const{
    return m_special_offer_available_isSet;
}

bool OAIProduct_200_response_allOf_data::is_special_offer_available_Valid() const{
    return m_special_offer_available_isValid;
}

bool OAIProduct_200_response_allOf_data::isSpecialReservation() const {
    return m_special_reservation;
}
void OAIProduct_200_response_allOf_data::setSpecialReservation(const bool &special_reservation) {
    m_special_reservation = special_reservation;
    m_special_reservation_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_special_reservation_Set() const{
    return m_special_reservation_isSet;
}

bool OAIProduct_200_response_allOf_data::is_special_reservation_Valid() const{
    return m_special_reservation_isValid;
}

QString OAIProduct_200_response_allOf_data::getSpecialReservationDetails() const {
    return m_special_reservation_details;
}
void OAIProduct_200_response_allOf_data::setSpecialReservationDetails(const QString &special_reservation_details) {
    m_special_reservation_details = special_reservation_details;
    m_special_reservation_details_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_special_reservation_details_Set() const{
    return m_special_reservation_details_isSet;
}

bool OAIProduct_200_response_allOf_data::is_special_reservation_details_Valid() const{
    return m_special_reservation_details_isValid;
}

bool OAIProduct_200_response_allOf_data::isSslSupported() const {
    return m_ssl_supported;
}
void OAIProduct_200_response_allOf_data::setSslSupported(const bool &ssl_supported) {
    m_ssl_supported = ssl_supported;
    m_ssl_supported_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_ssl_supported_Set() const{
    return m_ssl_supported_isSet;
}

bool OAIProduct_200_response_allOf_data::is_ssl_supported_Valid() const{
    return m_ssl_supported_isValid;
}

QList<qint32> OAIProduct_200_response_allOf_data::getSubCatIds() const {
    return m_sub_cat_ids;
}
void OAIProduct_200_response_allOf_data::setSubCatIds(const QList<qint32> &sub_cat_ids) {
    m_sub_cat_ids = sub_cat_ids;
    m_sub_cat_ids_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_sub_cat_ids_Set() const{
    return m_sub_cat_ids_isSet;
}

bool OAIProduct_200_response_allOf_data::is_sub_cat_ids_Valid() const{
    return m_sub_cat_ids_isValid;
}

QString OAIProduct_200_response_allOf_data::getSupplierCode() const {
    return m_supplier_code;
}
void OAIProduct_200_response_allOf_data::setSupplierCode(const QString &supplier_code) {
    m_supplier_code = supplier_code;
    m_supplier_code_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_supplier_code_Set() const{
    return m_supplier_code_isSet;
}

bool OAIProduct_200_response_allOf_data::is_supplier_code_Valid() const{
    return m_supplier_code_isValid;
}

QString OAIProduct_200_response_allOf_data::getSupplierName() const {
    return m_supplier_name;
}
void OAIProduct_200_response_allOf_data::setSupplierName(const QString &supplier_name) {
    m_supplier_name = supplier_name;
    m_supplier_name_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_supplier_name_Set() const{
    return m_supplier_name_isSet;
}

bool OAIProduct_200_response_allOf_data::is_supplier_name_Valid() const{
    return m_supplier_name_isValid;
}

QString OAIProduct_200_response_allOf_data::getThumbnailHiResUrl() const {
    return m_thumbnail_hi_res_url;
}
void OAIProduct_200_response_allOf_data::setThumbnailHiResUrl(const QString &thumbnail_hi_res_url) {
    m_thumbnail_hi_res_url = thumbnail_hi_res_url;
    m_thumbnail_hi_res_url_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_thumbnail_hi_res_url_Set() const{
    return m_thumbnail_hi_res_url_isSet;
}

bool OAIProduct_200_response_allOf_data::is_thumbnail_hi_res_url_Valid() const{
    return m_thumbnail_hi_res_url_isValid;
}

QString OAIProduct_200_response_allOf_data::getThumbnailUrl() const {
    return m_thumbnail_url;
}
void OAIProduct_200_response_allOf_data::setThumbnailUrl(const QString &thumbnail_url) {
    m_thumbnail_url = thumbnail_url;
    m_thumbnail_url_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_thumbnail_url_Set() const{
    return m_thumbnail_url_isSet;
}

bool OAIProduct_200_response_allOf_data::is_thumbnail_url_Valid() const{
    return m_thumbnail_url_isValid;
}

QString OAIProduct_200_response_allOf_data::getTitle() const {
    return m_title;
}
void OAIProduct_200_response_allOf_data::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_title_Set() const{
    return m_title_isSet;
}

bool OAIProduct_200_response_allOf_data::is_title_Valid() const{
    return m_title_isValid;
}

QList<OAIProduct_200_response_allOf_data_tourGrades_inner> OAIProduct_200_response_allOf_data::getTourGrades() const {
    return m_tour_grades;
}
void OAIProduct_200_response_allOf_data::setTourGrades(const QList<OAIProduct_200_response_allOf_data_tourGrades_inner> &tour_grades) {
    m_tour_grades = tour_grades;
    m_tour_grades_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_tour_grades_Set() const{
    return m_tour_grades_isSet;
}

bool OAIProduct_200_response_allOf_data::is_tour_grades_Valid() const{
    return m_tour_grades_isValid;
}

bool OAIProduct_200_response_allOf_data::isTourGradesAvailable() const {
    return m_tour_grades_available;
}
void OAIProduct_200_response_allOf_data::setTourGradesAvailable(const bool &tour_grades_available) {
    m_tour_grades_available = tour_grades_available;
    m_tour_grades_available_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_tour_grades_available_Set() const{
    return m_tour_grades_available_isSet;
}

bool OAIProduct_200_response_allOf_data::is_tour_grades_available_Valid() const{
    return m_tour_grades_available_isValid;
}

OAITranslationLevel OAIProduct_200_response_allOf_data::getTranslationLevel() const {
    return m_translation_level;
}
void OAIProduct_200_response_allOf_data::setTranslationLevel(const OAITranslationLevel &translation_level) {
    m_translation_level = translation_level;
    m_translation_level_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_translation_level_Set() const{
    return m_translation_level_isSet;
}

bool OAIProduct_200_response_allOf_data::is_translation_level_Valid() const{
    return m_translation_level_isValid;
}

QList<OAIPhotoObject> OAIProduct_200_response_allOf_data::getUserPhotos() const {
    return m_user_photos;
}
void OAIProduct_200_response_allOf_data::setUserPhotos(const QList<OAIPhotoObject> &user_photos) {
    m_user_photos = user_photos;
    m_user_photos_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_user_photos_Set() const{
    return m_user_photos_isSet;
}

bool OAIProduct_200_response_allOf_data::is_user_photos_Valid() const{
    return m_user_photos_isValid;
}

qint32 OAIProduct_200_response_allOf_data::getVideoCount() const {
    return m_video_count;
}
void OAIProduct_200_response_allOf_data::setVideoCount(const qint32 &video_count) {
    m_video_count = video_count;
    m_video_count_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_video_count_Set() const{
    return m_video_count_isSet;
}

bool OAIProduct_200_response_allOf_data::is_video_count_Valid() const{
    return m_video_count_isValid;
}

QString OAIProduct_200_response_allOf_data::getVideos() const {
    return m_videos;
}
void OAIProduct_200_response_allOf_data::setVideos(const QString &videos) {
    m_videos = videos;
    m_videos_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_videos_Set() const{
    return m_videos_isSet;
}

bool OAIProduct_200_response_allOf_data::is_videos_Valid() const{
    return m_videos_isValid;
}

QString OAIProduct_200_response_allOf_data::getVoucherOption() const {
    return m_voucher_option;
}
void OAIProduct_200_response_allOf_data::setVoucherOption(const QString &voucher_option) {
    m_voucher_option = voucher_option;
    m_voucher_option_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_voucher_option_Set() const{
    return m_voucher_option_isSet;
}

bool OAIProduct_200_response_allOf_data::is_voucher_option_Valid() const{
    return m_voucher_option_isValid;
}

QJsonValue OAIProduct_200_response_allOf_data::getVoucherRequirements() const {
    return m_voucher_requirements;
}
void OAIProduct_200_response_allOf_data::setVoucherRequirements(const QJsonValue &voucher_requirements) {
    m_voucher_requirements = voucher_requirements;
    m_voucher_requirements_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_voucher_requirements_Set() const{
    return m_voucher_requirements_isSet;
}

bool OAIProduct_200_response_allOf_data::is_voucher_requirements_Valid() const{
    return m_voucher_requirements_isValid;
}

QString OAIProduct_200_response_allOf_data::getWebUrl() const {
    return m_web_url;
}
void OAIProduct_200_response_allOf_data::setWebUrl(const QString &web_url) {
    m_web_url = web_url;
    m_web_url_isSet = true;
}

bool OAIProduct_200_response_allOf_data::is_web_url_Set() const{
    return m_web_url_isSet;
}

bool OAIProduct_200_response_allOf_data::is_web_url_Valid() const{
    return m_web_url_isValid;
}

bool OAIProduct_200_response_allOf_data::isSet() const {
...
bool OAIProduct_200_response_allOf_data::isValid() const {
