# viator_api_documentation_amp_specification__merchant_partners

ViatorApiDocumentationAmpSpecificationMerchantPartners - JavaScript client for viator_api_documentation_amp_specification__merchant_partners
&lt;style type='text/css'&gt;
...
```shell
npm install viator_api_documentation_amp_specification__merchant_partners --save
```
...
To use the link you just defined in your project, switch to the directory you want to use your viator_api_documentation_amp_specification__merchant_partners from, and run:
...
```javascript
var ViatorApiDocumentationAmpSpecificationMerchantPartners = require('viator_api_documentation_amp_specification__merchant_partners');

var defaultClient = ViatorApiDocumentationAmpSpecificationMerchantPartners.ApiClient.instance;
// Configure API key authorization: Legacy-API-key
var Legacy-API-key = defaultClient.authentications['Legacy-API-key'];
Legacy-API-key.apiKey = "YOUR API KEY"
// Uncomment the following line to set a prefix for the API key, e.g. "Token" (defaults to null)
//Legacy-API-key.apiKeyPrefix['apiKey'] = "Token"
// Configure API key authorization: API-key
var API-key = defaultClient.authentications['API-key'];
API-key.apiKey = "YOUR API KEY"
// Uncomment the following line to set a prefix for the API key, e.g. "Token" (defaults to null)
//API-key.apiKeyPrefix['exp-api-key'] = "Token"

var api = new ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingServicesApi()
var acceptLanguage = "en-US"; // {String} Specifies the language into which the natural-language fields in the response from this service will be translated (see [Accept-Language header](#section/Appendices/Accept-Language-header) for available langage codes) 
var opts = {
...
api.bookingAvailability(acceptLanguage, opts, callback);
...
------------ | ------------- | ------------- | -------------
*ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingServicesApi* | [**bookingAvailability**](docs/BookingServicesApi.md#bookingAvailability) | **POST** /booking/availability | /booking/availability
*ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingServicesApi* | [**bookingAvailabilityDates**](docs/BookingServicesApi.md#bookingAvailabilityDates) | **GET** /booking/availability/dates | /booking/availability/dates
*ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingServicesApi* | [**bookingAvailabilityTourgrades**](docs/BookingServicesApi.md#bookingAvailabilityTourgrades) | **POST** /booking/availability/tourgrades | /booking/availability/tourgrades
*ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingServicesApi* | [**bookingAvailabilityTourgradesPricingmatrix**](docs/BookingServicesApi.md#bookingAvailabilityTourgradesPricingmatrix) | **POST** /booking/availability/tourgrades/pricingmatrix | /booking/availability/tourgrades/pricingmatrix
*ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingServicesApi* | [**bookingBook**](docs/BookingServicesApi.md#bookingBook) | **POST** /booking/book | /booking/book
*ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingServicesApi* | [**bookingCalculateprice**](docs/BookingServicesApi.md#bookingCalculateprice) | **POST** /booking/calculateprice | /booking/calculateprice
*ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingServicesApi* | [**bookingHotels**](docs/BookingServicesApi.md#bookingHotels) | **GET** /booking/hotels | /booking/hotels
*ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingServicesApi* | [**bookingMybookings**](docs/BookingServicesApi.md#bookingMybookings) | **GET** /booking/mybookings | /booking/mybookings
*ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingServicesApi* | [**bookingPastbooking**](docs/BookingServicesApi.md#bookingPastbooking) | **GET** /booking/pastbooking | /booking/pastbooking
*ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingServicesApi* | [**bookingPricingmatrix**](docs/BookingServicesApi.md#bookingPricingmatrix) | **POST** /booking/pricingmatrix | /booking/pricingmatrix
*ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingServicesApi* | [**bookingStatus**](docs/BookingServicesApi.md#bookingStatus) | **POST** /booking/status | /booking/status
*ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingServicesApi* | [**bookingStatusItems**](docs/BookingServicesApi.md#bookingStatusItems) | **POST** /booking/status/items | /booking/status/items
*ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingServicesApi* | [**bookingVoucher**](docs/BookingServicesApi.md#bookingVoucher) | **GET** /booking/voucher | /booking/voucher
*ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingServicesApi* | [**cancelBooking**](docs/BookingServicesApi.md#cancelBooking) | **POST** /bookings/{booking-reference}/cancel | /bookings/{booking-reference}/cancel
*ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingServicesApi* | [**cancelBookingQuote**](docs/BookingServicesApi.md#cancelBookingQuote) | **GET** /bookings/{booking-reference}/cancel-quote | /bookings/{booking-reference}/cancel-quote
*ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingServicesApi* | [**cancellationReasons**](docs/BookingServicesApi.md#cancellationReasons) | **GET** /bookings/cancel-reasons | /bookings/cancel-reasons
*ViatorApiDocumentationAmpSpecificationMerchantPartners.DeprecatedServicesApi* | [**merchantCancellation**](docs/DeprecatedServicesApi.md#merchantCancellation) | **POST** /merchant/cancellation | /merchant/cancellation
*ViatorApiDocumentationAmpSpecificationMerchantPartners.GeneralServicesApi* | [**healthCheck**](docs/GeneralServicesApi.md#healthCheck) | **GET** /health/check | /health/check
*ViatorApiDocumentationAmpSpecificationMerchantPartners.ProductServicesApi* | [**availableProducts**](docs/ProductServicesApi.md#availableProducts) | **POST** /available/products | /available/products
*ViatorApiDocumentationAmpSpecificationMerchantPartners.ProductServicesApi* | [**product**](docs/ProductServicesApi.md#product) | **GET** /product | /product
*ViatorApiDocumentationAmpSpecificationMerchantPartners.ProductServicesApi* | [**productPhotos**](docs/ProductServicesApi.md#productPhotos) | **GET** /product/photos | /product/photos
*ViatorApiDocumentationAmpSpecificationMerchantPartners.ProductServicesApi* | [**productReviews**](docs/ProductServicesApi.md#productReviews) | **GET** /product/reviews | /product/reviews
*ViatorApiDocumentationAmpSpecificationMerchantPartners.ProductServicesApi* | [**searchFreetext**](docs/ProductServicesApi.md#searchFreetext) | **POST** /search/freetext | /search/freetext
*ViatorApiDocumentationAmpSpecificationMerchantPartners.ProductServicesApi* | [**searchProducts**](docs/ProductServicesApi.md#searchProducts) | **POST** /search/products | /search/products
*ViatorApiDocumentationAmpSpecificationMerchantPartners.ProductServicesApi* | [**searchProductsCodes**](docs/ProductServicesApi.md#searchProductsCodes) | **POST** /search/products/codes | /search/products/codes
*ViatorApiDocumentationAmpSpecificationMerchantPartners.TaxonomyServicesApi* | [**taxonomyAttractions**](docs/TaxonomyServicesApi.md#taxonomyAttractions) | **POST** /taxonomy/attractions | /taxonomy/attractions
*ViatorApiDocumentationAmpSpecificationMerchantPartners.TaxonomyServicesApi* | [**taxonomyCategories**](docs/TaxonomyServicesApi.md#taxonomyCategories) | **GET** /taxonomy/categories | /taxonomy/categories
*ViatorApiDocumentationAmpSpecificationMerchantPartners.TaxonomyServicesApi* | [**taxonomyDestinations**](docs/TaxonomyServicesApi.md#taxonomyDestinations) | **GET** /taxonomy/destinations | /taxonomy/destinations


## Documentation for Models

 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.AvailableProducts200Response](docs/AvailableProducts200Response.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.AvailableProducts200ResponseAllOfDataInner](docs/AvailableProducts200ResponseAllOfDataInner.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.AvailableProducts200ResponseAllOfDataInnerPas](docs/AvailableProducts200ResponseAllOfDataInnerPas.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.AvailableProducts200ResponseAllOfDataInnerPasTourGradesValue](docs/AvailableProducts200ResponseAllOfDataInnerPasTourGradesValue.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.AvailableProducts200ResponseAllOfDataInnerPasTourGradesValueAvailDatesInner](docs/AvailableProducts200ResponseAllOfDataInnerPasTourGradesValueAvailDatesInner.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.AvailableProducts200ResponseAllOfDataInnerPasTourGradesValueAvailDatesInnerPriceQuote](docs/AvailableProducts200ResponseAllOfDataInnerPasTourGradesValueAvailDatesInnerPriceQuote.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.AvailableProductsRequest](docs/AvailableProductsRequest.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BasicErrorModel](docs/BasicErrorModel.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingAvailability200Response](docs/BookingAvailability200Response.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingAvailability200ResponseAllOfData](docs/BookingAvailability200ResponseAllOfData.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingAvailability200ResponseAllOfDataAvailabilityInner](docs/BookingAvailability200ResponseAllOfDataAvailabilityInner.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingAvailabilityDates200Response](docs/BookingAvailabilityDates200Response.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingAvailabilityRequest](docs/BookingAvailabilityRequest.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingAvailabilityRequestAgeBandsInner](docs/BookingAvailabilityRequestAgeBandsInner.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingAvailabilityTourgrades200Response](docs/BookingAvailabilityTourgrades200Response.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingAvailabilityTourgrades200ResponseAllOfDataInner](docs/BookingAvailabilityTourgrades200ResponseAllOfDataInner.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingAvailabilityTourgrades200ResponseAllOfDataInnerAgeBandsRequiredInnerInner](docs/BookingAvailabilityTourgrades200ResponseAllOfDataInnerAgeBandsRequiredInnerInner.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingAvailabilityTourgradesPricingmatrix200Response](docs/BookingAvailabilityTourgradesPricingmatrix200Response.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingAvailabilityTourgradesPricingmatrix200ResponseAllOfData](docs/BookingAvailabilityTourgradesPricingmatrix200ResponseAllOfData.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingAvailabilityTourgradesPricingmatrix200ResponseAllOfDataDatesInner](docs/BookingAvailabilityTourgradesPricingmatrix200ResponseAllOfDataDatesInner.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingAvailabilityTourgradesPricingmatrix200ResponseAllOfDataDatesInnerTourGradesInner](docs/BookingAvailabilityTourgradesPricingmatrix200ResponseAllOfDataDatesInnerTourGradesInner.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingAvailabilityTourgradesPricingmatrix200ResponseAllOfDataDatesInnerTourGradesInnerPricingMatrixInner](docs/BookingAvailabilityTourgradesPricingmatrix200ResponseAllOfDataDatesInnerTourGradesInnerPricingMatrixInner.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingAvailabilityTourgradesPricingmatrix200ResponseAllOfDataDatesInnerTourGradesInnerPricingMatrixInnerAgeBandPricesInner](docs/BookingAvailabilityTourgradesPricingmatrix200ResponseAllOfDataDatesInnerTourGradesInnerPricingMatrixInnerAgeBandPricesInner.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingAvailabilityTourgradesPricingmatrix200ResponseAllOfDataDatesInnerTourGradesInnerPricingMatrixInnerAgeBandPricesInnerPricesInner](docs/BookingAvailabilityTourgradesPricingmatrix200ResponseAllOfDataDatesInnerTourGradesInnerPricingMatrixInnerAgeBandPricesInnerPricesInner.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingAvailabilityTourgradesPricingmatrixRequest](docs/BookingAvailabilityTourgradesPricingmatrixRequest.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingAvailabilityTourgradesRequest](docs/BookingAvailabilityTourgradesRequest.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingAvailabilityTourgradesRequestAgeBandsInner](docs/BookingAvailabilityTourgradesRequestAgeBandsInner.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingBook200Response](docs/BookingBook200Response.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingBook200ResponseAllOfData](docs/BookingBook200ResponseAllOfData.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingBook200ResponseAllOfDataItemSummariesInner](docs/BookingBook200ResponseAllOfDataItemSummariesInner.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingBook200ResponseAllOfDataItemSummariesInnerMerchantTermsAndConditions](docs/BookingBook200ResponseAllOfDataItemSummariesInnerMerchantTermsAndConditions.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingBook200ResponseAllOfDataItemSummariesInnerMerchantTermsAndConditionsCancellationFromTourDateInner](docs/BookingBook200ResponseAllOfDataItemSummariesInnerMerchantTermsAndConditionsCancellationFromTourDateInner.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingBook200ResponseAllOfDataItemSummariesInnerTravellerAgeBandsInner](docs/BookingBook200ResponseAllOfDataItemSummariesInnerTravellerAgeBandsInner.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingBookRequest](docs/BookingBookRequest.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingBookRequestBooker](docs/BookingBookRequestBooker.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingBookRequestItemsInner](docs/BookingBookRequestItemsInner.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingBookRequestItemsInnerBookingQuestionAnswersInner](docs/BookingBookRequestItemsInnerBookingQuestionAnswersInner.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingBookRequestItemsInnerPartnerItemDetail](docs/BookingBookRequestItemsInnerPartnerItemDetail.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingBookRequestItemsInnerTravellersInner](docs/BookingBookRequestItemsInnerTravellersInner.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingBookRequestPartnerDetail](docs/BookingBookRequestPartnerDetail.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingCalculateprice200Response](docs/BookingCalculateprice200Response.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingCalculateprice200ResponseAllOfData](docs/BookingCalculateprice200ResponseAllOfData.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingCalculateprice200ResponseAllOfDataItinerary](docs/BookingCalculateprice200ResponseAllOfDataItinerary.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingCalculateprice200ResponseAllOfDataItineraryItemSummariesInner](docs/BookingCalculateprice200ResponseAllOfDataItineraryItemSummariesInner.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingCalculateprice200ResponseAllOfDataItineraryItemSummariesInnerTravellerAgeBandsInner](docs/BookingCalculateprice200ResponseAllOfDataItineraryItemSummariesInnerTravellerAgeBandsInner.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingCalculatepriceRequest](docs/BookingCalculatepriceRequest.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingCalculatepriceRequestItemsInner](docs/BookingCalculatepriceRequestItemsInner.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingCalculatepriceRequestItemsInnerTravellersInner](docs/BookingCalculatepriceRequestItemsInnerTravellersInner.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingEngineId](docs/BookingEngineId.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingEngineIdResponse](docs/BookingEngineIdResponse.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingHotels200Response](docs/BookingHotels200Response.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingHotels200ResponseAllOfDataInner](docs/BookingHotels200ResponseAllOfDataInner.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingMybookings200Response](docs/BookingMybookings200Response.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingMybookings200ResponseAllOfData](docs/BookingMybookings200ResponseAllOfData.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingMybookings200ResponseAllOfDataItemSummariesInner](docs/BookingMybookings200ResponseAllOfDataItemSummariesInner.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingMybookings200ResponseAllOfDataItemSummariesInnerTravellerAgeBandsInner](docs/BookingMybookings200ResponseAllOfDataItemSummariesInnerTravellerAgeBandsInner.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingPastbooking200Response](docs/BookingPastbooking200Response.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingPastbooking200ResponseAllOfData](docs/BookingPastbooking200ResponseAllOfData.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingPastbooking200ResponseAllOfDataItemSummariesInner](docs/BookingPastbooking200ResponseAllOfDataItemSummariesInner.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingPricingmatrix200Response](docs/BookingPricingmatrix200Response.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingPricingmatrix200ResponseAllOfDataInner](docs/BookingPricingmatrix200ResponseAllOfDataInner.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingPricingmatrix200ResponseAllOfDataInnerAgeBandPricesInner](docs/BookingPricingmatrix200ResponseAllOfDataInnerAgeBandPricesInner.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingPricingmatrix200ResponseAllOfDataInnerAgeBandPricesInnerPricesInner](docs/BookingPricingmatrix200ResponseAllOfDataInnerAgeBandPricesInnerPricesInner.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingPricingmatrixRequest](docs/BookingPricingmatrixRequest.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingStatus200Response](docs/BookingStatus200Response.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingStatus200ResponseAllOfData](docs/BookingStatus200ResponseAllOfData.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingStatus200ResponseAllOfDataItemSummariesInner](docs/BookingStatus200ResponseAllOfDataItemSummariesInner.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingStatusItem](docs/BookingStatusItem.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingStatusItems200Response](docs/BookingStatusItems200Response.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingStatusItems200ResponseAllOfDataInner](docs/BookingStatusItems200ResponseAllOfDataInner.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingStatusItemsRequest](docs/BookingStatusItemsRequest.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingStatusItinerary](docs/BookingStatusItinerary.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingStatusRequest](docs/BookingStatusRequest.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingVoucher200Response](docs/BookingVoucher200Response.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.CancelBooking400Response](docs/CancelBooking400Response.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.CancelBooking404Response](docs/CancelBooking404Response.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.CancelBookingQuoteResponse](docs/CancelBookingQuoteResponse.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.CancelBookingResponse](docs/CancelBookingResponse.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.CancellationReason](docs/CancellationReason.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.CancellationReasonsResponse](docs/CancellationReasonsResponse.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.CancellationRequest](docs/CancellationRequest.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.DestinationType](docs/DestinationType.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.HealthCheck200Response](docs/HealthCheck200Response.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.MerchantCancellation200Response](docs/MerchantCancellation200Response.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.MerchantCancellation200ResponseAllOfData](docs/MerchantCancellation200ResponseAllOfData.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.MerchantCancellation200ResponseAllOfDataCancelItemsInner](docs/MerchantCancellation200ResponseAllOfDataCancelItemsInner.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.MerchantCancellation400Response](docs/MerchantCancellation400Response.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.MerchantCancellation400ResponseAllOfData](docs/MerchantCancellation400ResponseAllOfData.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.MerchantCancellationRequest](docs/MerchantCancellationRequest.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.MerchantCancellationRequestCancelItemsInner](docs/MerchantCancellationRequestCancelItemsInner.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.Model401UNAUTHORIZED](docs/Model401UNAUTHORIZED.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.Model406NOTACCEPTABLE](docs/Model406NOTACCEPTABLE.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.Model500INTERNALSERVERERROR](docs/Model500INTERNALSERVERERROR.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.Model503SERVICEUNAVAILABLE](docs/Model503SERVICEUNAVAILABLE.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.PhotoObject](docs/PhotoObject.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.Product200Response](docs/Product200Response.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.Product200ResponseAllOfData](docs/Product200ResponseAllOfData.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.Product200ResponseAllOfDataAgeBandsInner](docs/Product200ResponseAllOfDataAgeBandsInner.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.Product200ResponseAllOfDataBookingQuestionsInner](docs/Product200ResponseAllOfDataBookingQuestionsInner.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.Product200ResponseAllOfDataMerchantTermsAndConditions](docs/Product200ResponseAllOfDataMerchantTermsAndConditions.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.Product200ResponseAllOfDataMerchantTermsAndConditionsCancellationFromTourDateInner](docs/Product200ResponseAllOfDataMerchantTermsAndConditionsCancellationFromTourDateInner.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.Product200ResponseAllOfDataPassengerAttributesInner](docs/Product200ResponseAllOfDataPassengerAttributesInner.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.Product200ResponseAllOfDataProductPhotosInner](docs/Product200ResponseAllOfDataProductPhotosInner.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.Product200ResponseAllOfDataTourGradesInner](docs/Product200ResponseAllOfDataTourGradesInner.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.ProductPhotos200Response](docs/ProductPhotos200Response.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.ProductReviews200Response](docs/ProductReviews200Response.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.RatingCounts](docs/RatingCounts.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.RefundDetails](docs/RefundDetails.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.ReviewObject](docs/ReviewObject.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.SearchFreetext200Response](docs/SearchFreetext200Response.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.SearchFreetextRequest](docs/SearchFreetextRequest.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.SearchFreetextResponse](docs/SearchFreetextResponse.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.SearchFreetextResponseAttraction](docs/SearchFreetextResponseAttraction.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.SearchFreetextResponseAttractionAllOfData](docs/SearchFreetextResponseAttractionAllOfData.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.SearchFreetextResponseDestination](docs/SearchFreetextResponseDestination.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.SearchFreetextResponseDestinationAllOfData](docs/SearchFreetextResponseDestinationAllOfData.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.SearchFreetextResponseProduct](docs/SearchFreetextResponseProduct.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.SearchFreetextResponseProductAllOfData](docs/SearchFreetextResponseProductAllOfData.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.SearchFreetextResponseRecommendation](docs/SearchFreetextResponseRecommendation.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.SearchFreetextResponseRecommendationAllOfData](docs/SearchFreetextResponseRecommendationAllOfData.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.SearchProducts200Response](docs/SearchProducts200Response.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.SearchProducts200ResponseAllOfDataInner](docs/SearchProducts200ResponseAllOfDataInner.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.SearchProductsCodes200Response](docs/SearchProductsCodes200Response.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.SearchProductsCodes200ResponseAllOfDataInner](docs/SearchProductsCodes200ResponseAllOfDataInner.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.SearchProductsCodesRequest](docs/SearchProductsCodesRequest.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.SearchProductsRequest](docs/SearchProductsRequest.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.SortOrder](docs/SortOrder.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.TaxonomyAttractions200Response](docs/TaxonomyAttractions200Response.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.TaxonomyAttractions200ResponseAllOfDataInner](docs/TaxonomyAttractions200ResponseAllOfDataInner.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.TaxonomyAttractionsRequest](docs/TaxonomyAttractionsRequest.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.TaxonomyCategories200Response](docs/TaxonomyCategories200Response.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.TaxonomyCategories200ResponseAllOfDataInner](docs/TaxonomyCategories200ResponseAllOfDataInner.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.TaxonomyCategories200ResponseAllOfDataInnerSubcategoriesInner](docs/TaxonomyCategories200ResponseAllOfDataInnerSubcategoriesInner.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.TaxonomyDestinations200Response](docs/TaxonomyDestinations200Response.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.TaxonomyDestinations200ResponseAllOfDataInner](docs/TaxonomyDestinations200ResponseAllOfDataInner.md)
 - [ViatorApiDocumentationAmpSpecificationMerchantPartners.TranslationLevel](docs/TranslationLevel.md)
