# ViatorApiDocumentationAmpSpecificationMerchantPartners.SearchProducts200ResponseAllOfDataInner
...
**catIds** | **[Number]** | **list** of unique numeric category identifiers for *this* product - the &#x60;categoryId&#x60; for the destination is available from the [/taxonomy/categories](#operation/taxonomyCategories) service  | [optional] 
...
**primaryGroupId** | **Number** | ignore (Viator only) | [optional] 
...
**sortOrder** | **Number** | **sort order** for *this* product | [optional] 
...
**subCatIds** | **[Number]** | **list** of unique numeric subcategory identifiers for *this* product - the &#x60;subcategoryId&#x60; for the destination is available from the [/taxonomy/categories](#operation/taxonomyCategories) service  | [optional] 
