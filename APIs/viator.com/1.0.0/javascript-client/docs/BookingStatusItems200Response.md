# ViatorApiDocumentationAmpSpecificationMerchantPartners.BookingStatusItems200Response
...
**errorCodes** | **[String]** | **array** of error codes pertaining to *this* error - See: [Viator API error codes](#section/Appendices/Viator-API-error-codes) for a list of possible error codes  | [optional] 
**errorMessage** | **[Object]** | **array** of error message strings | [optional] 
...
**totalCount** | **Number** | **number** of results available for *this* service  | [optional] 
**vmid** | **String** | **unique numeric id** of the server that processed *this* request | [optional] 
**data** | [**[BookingStatusItems200ResponseAllOfDataInner]**](BookingStatusItems200ResponseAllOfDataInner.md) | **array** containing item ids and their associated booking status object | [optional] 
