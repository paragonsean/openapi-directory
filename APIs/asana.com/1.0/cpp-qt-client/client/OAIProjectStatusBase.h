...
/*
 * OAIProjectStatusBase.h
 *
 * 
 */

#ifndef OAIProjectStatusBase_H
#define OAIProjectStatusBase_H
...
class OAIProjectStatusBase : public OAIObject {
public:
    OAIProjectStatusBase();
    OAIProjectStatusBase(QString json);
    ~OAIProjectStatusBase() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProjectStatusBase)

#endif // OAIProjectStatusBase_H
