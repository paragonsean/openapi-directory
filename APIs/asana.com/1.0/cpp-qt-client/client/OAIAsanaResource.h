...
#ifndef OAIAsanaResource_H
#define OAIAsanaResource_H
...
class OAIAsanaResource : public OAIObject {
public:
    OAIAsanaResource();
    OAIAsanaResource(QString json);
    ~OAIAsanaResource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAsanaResource)

#endif // OAIAsanaResource_H
