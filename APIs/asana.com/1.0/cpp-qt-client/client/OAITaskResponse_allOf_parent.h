...
/*
 * OAITaskResponse_allOf_parent.h
 *
 * 
 */

#ifndef OAITaskResponse_allOf_parent_H
#define OAITaskResponse_allOf_parent_H
...
class OAITaskResponse_allOf_parent : public OAIObject {
public:
    OAITaskResponse_allOf_parent();
    OAITaskResponse_allOf_parent(QString json);
    ~OAITaskResponse_allOf_parent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITaskResponse_allOf_parent)

#endif // OAITaskResponse_allOf_parent_H
