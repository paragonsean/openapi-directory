...
void OAIJobsApi::getJob(const QString &job_gid, const ::OpenAPI::OptionalParam<bool> &opt_pretty, const ::OpenAPI::OptionalParam<QList<QString>> &opt_fields) {
    QString fullPath = QString(_serverConfigs["getJob"][_serverIndices.value("getJob")].URL()+"/jobs/{job_gid}");
    ...
    {
        QString job_gidPathParam("{");
        job_gidPathParam.append("job_gid").append("}");
        ...
        pathDelimiter = getParamStyleDelimiter(pathStyle, "job_gid", false);
        QString paramString = (pathStyle == "matrix") ? pathPrefix+"job_gid"+pathSuffix : pathPrefix;
        fullPath.replace(job_gidPathParam, paramString+QUrl::toPercentEncoding(::OpenAPI::toStringValue(job_gid)));
    }
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIJobsApi::getJobCallback);
