...
/*
 * OAITimePeriodCompact.h
 *
 * 
 */

#ifndef OAITimePeriodCompact_H
#define OAITimePeriodCompact_H
...
class OAITimePeriodCompact : public OAIObject {
public:
    OAITimePeriodCompact();
    OAITimePeriodCompact(QString json);
    ~OAITimePeriodCompact() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITimePeriodCompact)

#endif // OAITimePeriodCompact_H
