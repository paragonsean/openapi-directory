...
namespace OpenAPI {
class OAITeamResponse_allOf_organization;
...
public:
    ...
    OAITeamResponse_allOf_organization getOrganization() const;
    void setOrganization(const OAITeamResponse_allOf_organization &organization);
...
private:
    ...
    OAITeamResponse_allOf_organization m_organization;
