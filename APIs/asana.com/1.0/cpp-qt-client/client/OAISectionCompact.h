...
#ifndef OAISectionCompact_H
#define OAISectionCompact_H
...
class OAISectionCompact : public OAIObject {
public:
    OAISectionCompact();
    OAISectionCompact(QString json);
    ~OAISectionCompact() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISectionCompact)

#endif // OAISectionCompact_H
