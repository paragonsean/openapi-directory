...
#ifndef OAITagCompact_H
#define OAITagCompact_H
...
class OAITagCompact : public OAIObject {
public:
    OAITagCompact();
    OAITagCompact(QString json);
    ~OAITagCompact() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITagCompact)

#endif // OAITagCompact_H
