...
/*
 * OAICustomFieldBase.h
 *
 * 
 */

#ifndef OAICustomFieldBase_H
#define OAICustomFieldBase_H
...
class OAICustomFieldBase : public OAIObject {
public:
    OAICustomFieldBase();
    OAICustomFieldBase(QString json);
    ~OAICustomFieldBase() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomFieldBase)

#endif // OAICustomFieldBase_H
