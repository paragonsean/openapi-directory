...
#ifndef OAITaskRequest_H
#define OAITaskRequest_H
...
class OAITaskRequest : public OAIObject {
public:
    OAITaskRequest();
    OAITaskRequest(QString json);
    ~OAITaskRequest() override;
    ...
    QString getAssigneeSection() const;
    void setAssigneeSection(const QString &assignee_section);
    ...
    QList<QString> getProjects() const;
    void setProjects(const QList<QString> &projects);
...
Q_DECLARE_METATYPE(OpenAPI::OAITaskRequest)

#endif // OAITaskRequest_H
