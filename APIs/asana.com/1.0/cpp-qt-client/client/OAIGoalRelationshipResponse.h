...
/*
 * OAIGoalRelationshipResponse.h
 *
 * 
 */

#ifndef OAIGoalRelationshipResponse_H
#define OAIGoalRelationshipResponse_H
...
class OAIGoalRelationshipBase_allOf_supported_goal;

class OAIGoalRelationshipResponse : public OAIObject {
public:
    OAIGoalRelationshipResponse();
    OAIGoalRelationshipResponse(QString json);
    ~OAIGoalRelationshipResponse() override;
    ...
    OAIGoalRelationshipBase_allOf_supported_goal getSupportedGoal() const;
    void setSupportedGoal(const OAIGoalRelationshipBase_allOf_supported_goal &supported_goal);
    bool is_supported_goal_Set() const;
    bool is_supported_goal_Valid() const;
...
private:
    ...
    OAIGoalRelationshipBase_allOf_supported_goal m_supported_goal;
    bool m_supported_goal_isSet;
    bool m_supported_goal_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIGoalRelationshipResponse)

#endif // OAIGoalRelationshipResponse_H
