...
#ifndef OAITaskCompact_H
#define OAITaskCompact_H
...
class OAITaskCompact : public OAIObject {
public:
    OAITaskCompact();
    OAITaskCompact(QString json);
    ~OAITaskCompact() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITaskCompact)

#endif // OAITaskCompact_H
