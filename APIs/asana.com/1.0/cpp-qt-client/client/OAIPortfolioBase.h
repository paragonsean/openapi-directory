...
#ifndef OAIPortfolioBase_H
#define OAIPortfolioBase_H
...
class OAIPortfolioBase : public OAIObject {
public:
    OAIPortfolioBase();
    OAIPortfolioBase(QString json);
    ~OAIPortfolioBase() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPortfolioBase)

#endif // OAIPortfolioBase_H
