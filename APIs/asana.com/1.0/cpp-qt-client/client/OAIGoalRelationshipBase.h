...
/*
 * OAIGoalRelationshipBase.h
 *
 * 
 */

#ifndef OAIGoalRelationshipBase_H
#define OAIGoalRelationshipBase_H
...
class OAIGoalRelationshipBase : public OAIObject {
public:
    OAIGoalRelationshipBase();
    OAIGoalRelationshipBase(QString json);
    ~OAIGoalRelationshipBase() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoalRelationshipBase)

#endif // OAIGoalRelationshipBase_H
