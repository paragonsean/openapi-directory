...
/*
 * OAIWorkspaceCompact.h
 *
 * 
 */

#ifndef OAIWorkspaceCompact_H
#define OAIWorkspaceCompact_H
...
class OAIWorkspaceCompact : public OAIObject {
public:
    OAIWorkspaceCompact();
    OAIWorkspaceCompact(QString json);
    ~OAIWorkspaceCompact() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWorkspaceCompact)

#endif // OAIWorkspaceCompact_H
