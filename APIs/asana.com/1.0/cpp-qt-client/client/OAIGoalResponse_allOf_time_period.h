...
/*
 * OAIGoalResponse_allOf_time_period.h
 *
 * 
 */

#ifndef OAIGoalResponse_allOf_time_period_H
#define OAIGoalResponse_allOf_time_period_H
...
class OAIGoalResponse_allOf_time_period : public OAIObject {
public:
    OAIGoalResponse_allOf_time_period();
    OAIGoalResponse_allOf_time_period(QString json);
    ~OAIGoalResponse_allOf_time_period() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoalResponse_allOf_time_period)

#endif // OAIGoalResponse_allOf_time_period_H
