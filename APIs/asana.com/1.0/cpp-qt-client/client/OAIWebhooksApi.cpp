...
void OAIWebhooksApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("getWebhooks", defaultConf);
    _serverIndices.insert("getWebhooks", 0);
...
void OAIWebhooksApi::createWebhook(const OAICreateWebhook_request &oai_create_webhook_request, const ::OpenAPI::OptionalParam<bool> &opt_pretty, const ::OpenAPI::OptionalParam<QList<QString>> &opt_fields) {
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIWebhooksApi::createWebhookCallback);
...
void OAIWebhooksApi::createWebhookCallback(OAIHttpRequestWorker *worker) {
    ...
    OAICreateWebhook_201_response output(QString(worker->response));
    worker->deleteLater();
...
void OAIWebhooksApi::deleteWebhook(const QString &webhook_gid, const ::OpenAPI::OptionalParam<bool> &opt_pretty, const ::OpenAPI::OptionalParam<QList<QString>> &opt_fields) {
    QString fullPath = QString(_serverConfigs["deleteWebhook"][_serverIndices.value("deleteWebhook")].URL()+"/webhooks/{webhook_gid}");
    ...
    {
        QString webhook_gidPathParam("{");
        webhook_gidPathParam.append("webhook_gid").append("}");
        ...
        pathDelimiter = getParamStyleDelimiter(pathStyle, "webhook_gid", false);
        QString paramString = (pathStyle == "matrix") ? pathPrefix+"webhook_gid"+pathSuffix : pathPrefix;
        fullPath.replace(webhook_gidPathParam, paramString+QUrl::toPercentEncoding(::OpenAPI::toStringValue(webhook_gid)));
    }
    QString queryPrefix, querySuffix, queryDelimiter, queryStyle;
    if (opt_pretty.hasValue())
    {
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIWebhooksApi::deleteWebhookCallback);
    connect(this, &OAIWebhooksApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIWebhooksApi::getWebhook(const QString &webhook_gid, const ::OpenAPI::OptionalParam<bool> &opt_pretty, const ::OpenAPI::OptionalParam<QList<QString>> &opt_fields) {
    QString fullPath = QString(_serverConfigs["getWebhook"][_serverIndices.value("getWebhook")].URL()+"/webhooks/{webhook_gid}");
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIWebhooksApi::getWebhookCallback);
    connect(this, &OAIWebhooksApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIWebhooksApi::getWebhooks(const QString &workspace, const ::OpenAPI::OptionalParam<bool> &opt_pretty, const ::OpenAPI::OptionalParam<QList<QString>> &opt_fields, const ::OpenAPI::OptionalParam<qint32> &limit, const ::OpenAPI::OptionalParam<QString> &offset, const ::OpenAPI::OptionalParam<QString> &resource) {
    QString fullPath = QString(_serverConfigs["getWebhooks"][_serverIndices.value("getWebhooks")].URL()+"/webhooks");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIWebhooksApi::getWebhooksCallback);
    connect(this, &OAIWebhooksApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIWebhooksApi::getWebhooksCallback);
    connect(this, &OAIWebhooksApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIWebhooksApi::getWebhooksCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIGetWebhooks_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getWebhooksSignal(output);
        Q_EMIT getWebhooksSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        QString scopeStr = scope.join(" ");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getWebhooksSignalE(output, error_type, error_str);
        Q_EMIT getWebhooksSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getWebhooksSignalError(output, error_type, error_str);
        Q_EMIT getWebhooksSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIWebhooksApi::updateWebhook(const QString &webhook_gid, const OAIUpdateWebhook_request &oai_update_webhook_request, const ::OpenAPI::OptionalParam<bool> &opt_pretty, const ::OpenAPI::OptionalParam<QList<QString>> &opt_fields) {
    QString fullPath = QString(_serverConfigs["updateWebhook"][_serverIndices.value("updateWebhook")].URL()+"/webhooks/{webhook_gid}");
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIWebhooksApi::updateWebhookCallback);
    connect(this, &OAIWebhooksApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
