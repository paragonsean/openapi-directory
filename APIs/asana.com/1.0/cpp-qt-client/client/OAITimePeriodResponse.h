...
/*
 * OAITimePeriodResponse.h
 *
 * 
 */

#ifndef OAITimePeriodResponse_H
#define OAITimePeriodResponse_H
...
class OAITimePeriodResponse : public OAIObject {
public:
    OAITimePeriodResponse();
    OAITimePeriodResponse(QString json);
    ~OAITimePeriodResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITimePeriodResponse)

#endif // OAITimePeriodResponse_H
