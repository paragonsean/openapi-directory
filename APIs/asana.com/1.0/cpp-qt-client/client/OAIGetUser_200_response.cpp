...
OAIUserResponse OAIGetUser_200_response::getData() const {
    return m_data;
}
void OAIGetUser_200_response::setData(const OAIUserResponse &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIGetUser_200_response::is_data_Set() const{
    return m_data_isSet;
}

bool OAIGetUser_200_response::is_data_Valid() const{
