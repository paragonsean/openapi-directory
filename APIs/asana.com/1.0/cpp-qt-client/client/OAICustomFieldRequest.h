...
/*
 * OAICustomFieldRequest.h
 *
 * 
 */

#ifndef OAICustomFieldRequest_H
#define OAICustomFieldRequest_H
...
class OAICustomFieldRequest : public OAIObject {
public:
    OAICustomFieldRequest();
    OAICustomFieldRequest(QString json);
    ~OAICustomFieldRequest() override;
    ...
    QList<QString> getPeopleValue() const;
    void setPeopleValue(const QList<QString> &people_value);
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomFieldRequest)

#endif // OAICustomFieldRequest_H
