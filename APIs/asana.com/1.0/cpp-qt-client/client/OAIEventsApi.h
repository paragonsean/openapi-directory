...
public:
    ...
    * @param[in]  sync QString [optional]
    * @param[in]  opt_pretty bool [optional]
    * @param[in]  opt_fields QList<QString> [optional]
    */
    virtual void getEvents(const QString &resource, const ::OpenAPI::OptionalParam<QString> &sync = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &opt_pretty = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QList<QString>> &opt_fields = ::OpenAPI::OptionalParam<QList<QString>>());
