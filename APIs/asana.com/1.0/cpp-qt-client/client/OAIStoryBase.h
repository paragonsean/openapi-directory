...
#ifndef OAIStoryBase_H
#define OAIStoryBase_H
...
class OAIStoryBase : public OAIObject {
public:
    OAIStoryBase();
    OAIStoryBase(QString json);
    ~OAIStoryBase() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStoryBase)

#endif // OAIStoryBase_H
