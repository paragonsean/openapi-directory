...
/*
 * OAICustomFieldSettingResponse_allOf_custom_field.h
 *
 * 
 */

#ifndef OAICustomFieldSettingResponse_allOf_custom_field_H
#define OAICustomFieldSettingResponse_allOf_custom_field_H
...
class OAICustomFieldSettingResponse_allOf_custom_field : public OAIObject {
public:
    OAICustomFieldSettingResponse_allOf_custom_field();
    OAICustomFieldSettingResponse_allOf_custom_field(QString json);
    ~OAICustomFieldSettingResponse_allOf_custom_field() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomFieldSettingResponse_allOf_custom_field)

#endif // OAICustomFieldSettingResponse_allOf_custom_field_H
