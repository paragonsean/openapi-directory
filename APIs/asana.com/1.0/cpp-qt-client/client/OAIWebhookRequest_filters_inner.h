...
/*
 * OAIWebhookRequest_filters_inner.h
 *
 * 
 */

#ifndef OAIWebhookRequest_filters_inner_H
#define OAIWebhookRequest_filters_inner_H
...
class OAIWebhookRequest_filters_inner : public OAIObject {
public:
    OAIWebhookRequest_filters_inner();
    OAIWebhookRequest_filters_inner(QString json);
    ~OAIWebhookRequest_filters_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWebhookRequest_filters_inner)

#endif // OAIWebhookRequest_filters_inner_H
