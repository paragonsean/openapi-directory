...
OAIProjectRequest OAICreateProject_request::getData() const {
    return m_data;
}
void OAICreateProject_request::setData(const OAIProjectRequest &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAICreateProject_request::is_data_Set() const{
    return m_data_isSet;
}

bool OAICreateProject_request::is_data_Valid() const{
