...
#ifndef OAIGoalMetricBase_H
#define OAIGoalMetricBase_H
...
class OAIGoalMetricBase : public OAIObject {
public:
    OAIGoalMetricBase();
    OAIGoalMetricBase(QString json);
    ~OAIGoalMetricBase() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoalMetricBase)

#endif // OAIGoalMetricBase_H
