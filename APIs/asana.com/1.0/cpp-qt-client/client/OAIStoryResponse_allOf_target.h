...
/*
 * OAIStoryResponse_allOf_target.h
 *
 * 
 */

#ifndef OAIStoryResponse_allOf_target_H
#define OAIStoryResponse_allOf_target_H
...
class OAIStoryResponse_allOf_target : public OAIObject {
public:
    OAIStoryResponse_allOf_target();
    OAIStoryResponse_allOf_target(QString json);
    ~OAIStoryResponse_allOf_target() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStoryResponse_allOf_target)

#endif // OAIStoryResponse_allOf_target_H
