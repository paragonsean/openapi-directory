...
OAICustomFieldRequest::OAICustomFieldRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICustomFieldRequest::OAICustomFieldRequest() {
    this->initializeModel();
}

OAICustomFieldRequest::~OAICustomFieldRequest() {}

void OAICustomFieldRequest::initializeModel() {
...
void OAICustomFieldRequest::fromJson(QString jsonString) {
...
void OAICustomFieldRequest::fromJsonObject(QJsonObject json) {
...
QString OAICustomFieldRequest::asJson() const {
...
QJsonObject OAICustomFieldRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_gid_isSet) {
...
QString OAICustomFieldRequest::getGid() const {
    return m_gid;
}
void OAICustomFieldRequest::setGid(const QString &gid) {
    m_gid = gid;
    m_gid_isSet = true;
}

bool OAICustomFieldRequest::is_gid_Set() const{
    return m_gid_isSet;
}

bool OAICustomFieldRequest::is_gid_Valid() const{
    return m_gid_isValid;
}

QString OAICustomFieldRequest::getResourceType() const {
    return m_resource_type;
}
void OAICustomFieldRequest::setResourceType(const QString &resource_type) {
    m_resource_type = resource_type;
    m_resource_type_isSet = true;
}

bool OAICustomFieldRequest::is_resource_type_Set() const{
    return m_resource_type_isSet;
}

bool OAICustomFieldRequest::is_resource_type_Valid() const{
    return m_resource_type_isValid;
}

OAICustomFieldCompact_allOf_date_value OAICustomFieldRequest::getDateValue() const {
    return m_date_value;
}
void OAICustomFieldRequest::setDateValue(const OAICustomFieldCompact_allOf_date_value &date_value) {
    m_date_value = date_value;
    m_date_value_isSet = true;
}

bool OAICustomFieldRequest::is_date_value_Set() const{
    return m_date_value_isSet;
}

bool OAICustomFieldRequest::is_date_value_Valid() const{
    return m_date_value_isValid;
}

QString OAICustomFieldRequest::getDisplayValue() const {
    return m_display_value;
}
void OAICustomFieldRequest::setDisplayValue(const QString &display_value) {
    m_display_value = display_value;
    m_display_value_isSet = true;
}

bool OAICustomFieldRequest::is_display_value_Set() const{
    return m_display_value_isSet;
}

bool OAICustomFieldRequest::is_display_value_Valid() const{
    return m_display_value_isValid;
}

bool OAICustomFieldRequest::isEnabled() const {
    return m_enabled;
}
void OAICustomFieldRequest::setEnabled(const bool &enabled) {
    m_enabled = enabled;
    m_enabled_isSet = true;
}

bool OAICustomFieldRequest::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAICustomFieldRequest::is_enabled_Valid() const{
    return m_enabled_isValid;
}

QList<OAIEnumOption> OAICustomFieldRequest::getEnumOptions() const {
    return m_enum_options;
}
void OAICustomFieldRequest::setEnumOptions(const QList<OAIEnumOption> &enum_options) {
    m_enum_options = enum_options;
    m_enum_options_isSet = true;
}

bool OAICustomFieldRequest::is_enum_options_Set() const{
    return m_enum_options_isSet;
}

bool OAICustomFieldRequest::is_enum_options_Valid() const{
    return m_enum_options_isValid;
}

OAICustomFieldCompact_allOf_enum_value OAICustomFieldRequest::getEnumValue() const {
    return m_enum_value;
}
void OAICustomFieldRequest::setEnumValue(const OAICustomFieldCompact_allOf_enum_value &enum_value) {
    m_enum_value = enum_value;
    m_enum_value_isSet = true;
}

bool OAICustomFieldRequest::is_enum_value_Set() const{
    return m_enum_value_isSet;
}

bool OAICustomFieldRequest::is_enum_value_Valid() const{
    return m_enum_value_isValid;
}

QList<OAIEnumOption> OAICustomFieldRequest::getMultiEnumValues() const {
    return m_multi_enum_values;
}
void OAICustomFieldRequest::setMultiEnumValues(const QList<OAIEnumOption> &multi_enum_values) {
    m_multi_enum_values = multi_enum_values;
    m_multi_enum_values_isSet = true;
}

bool OAICustomFieldRequest::is_multi_enum_values_Set() const{
    return m_multi_enum_values_isSet;
}

bool OAICustomFieldRequest::is_multi_enum_values_Valid() const{
    return m_multi_enum_values_isValid;
}

QString OAICustomFieldRequest::getName() const {
    return m_name;
}
void OAICustomFieldRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICustomFieldRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAICustomFieldRequest::is_name_Valid() const{
    return m_name_isValid;
}

double OAICustomFieldRequest::getNumberValue() const {
    return m_number_value;
}
void OAICustomFieldRequest::setNumberValue(const double &number_value) {
    m_number_value = number_value;
    m_number_value_isSet = true;
}

bool OAICustomFieldRequest::is_number_value_Set() const{
    return m_number_value_isSet;
}

bool OAICustomFieldRequest::is_number_value_Valid() const{
    return m_number_value_isValid;
}

QString OAICustomFieldRequest::getResourceSubtype() const {
    return m_resource_subtype;
}
void OAICustomFieldRequest::setResourceSubtype(const QString &resource_subtype) {
    m_resource_subtype = resource_subtype;
    m_resource_subtype_isSet = true;
}

bool OAICustomFieldRequest::is_resource_subtype_Set() const{
    return m_resource_subtype_isSet;
}

bool OAICustomFieldRequest::is_resource_subtype_Valid() const{
    return m_resource_subtype_isValid;
}

QString OAICustomFieldRequest::getTextValue() const {
    return m_text_value;
}
void OAICustomFieldRequest::setTextValue(const QString &text_value) {
    m_text_value = text_value;
    m_text_value_isSet = true;
}

bool OAICustomFieldRequest::is_text_value_Set() const{
    return m_text_value_isSet;
}

bool OAICustomFieldRequest::is_text_value_Valid() const{
    return m_text_value_isValid;
}

QString OAICustomFieldRequest::getType() const {
    return m_type;
}
void OAICustomFieldRequest::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAICustomFieldRequest::is_type_Set() const{
    return m_type_isSet;
}

bool OAICustomFieldRequest::is_type_Valid() const{
    return m_type_isValid;
}

QString OAICustomFieldRequest::getAsanaCreatedField() const {
    return m_asana_created_field;
}
void OAICustomFieldRequest::setAsanaCreatedField(const QString &asana_created_field) {
    m_asana_created_field = asana_created_field;
    m_asana_created_field_isSet = true;
}

bool OAICustomFieldRequest::is_asana_created_field_Set() const{
    return m_asana_created_field_isSet;
}

bool OAICustomFieldRequest::is_asana_created_field_Valid() const{
    return m_asana_created_field_isValid;
}

QString OAICustomFieldRequest::getCurrencyCode() const {
    return m_currency_code;
}
void OAICustomFieldRequest::setCurrencyCode(const QString &currency_code) {
    m_currency_code = currency_code;
    m_currency_code_isSet = true;
}

bool OAICustomFieldRequest::is_currency_code_Set() const{
    return m_currency_code_isSet;
}

bool OAICustomFieldRequest::is_currency_code_Valid() const{
    return m_currency_code_isValid;
}

QString OAICustomFieldRequest::getCustomLabel() const {
    return m_custom_label;
}
void OAICustomFieldRequest::setCustomLabel(const QString &custom_label) {
    m_custom_label = custom_label;
    m_custom_label_isSet = true;
}

bool OAICustomFieldRequest::is_custom_label_Set() const{
    return m_custom_label_isSet;
}

bool OAICustomFieldRequest::is_custom_label_Valid() const{
    return m_custom_label_isValid;
}

QString OAICustomFieldRequest::getCustomLabelPosition() const {
    return m_custom_label_position;
}
void OAICustomFieldRequest::setCustomLabelPosition(const QString &custom_label_position) {
    m_custom_label_position = custom_label_position;
    m_custom_label_position_isSet = true;
}

bool OAICustomFieldRequest::is_custom_label_position_Set() const{
    return m_custom_label_position_isSet;
}

bool OAICustomFieldRequest::is_custom_label_position_Valid() const{
    return m_custom_label_position_isValid;
}

QString OAICustomFieldRequest::getDescription() const {
    return m_description;
}
void OAICustomFieldRequest::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAICustomFieldRequest::is_description_Set() const{
    return m_description_isSet;
}

bool OAICustomFieldRequest::is_description_Valid() const{
    return m_description_isValid;
}

QString OAICustomFieldRequest::getFormat() const {
    return m_format;
}
void OAICustomFieldRequest::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAICustomFieldRequest::is_format_Set() const{
    return m_format_isSet;
}

bool OAICustomFieldRequest::is_format_Valid() const{
    return m_format_isValid;
}

bool OAICustomFieldRequest::isHasNotificationsEnabled() const {
    return m_has_notifications_enabled;
}
void OAICustomFieldRequest::setHasNotificationsEnabled(const bool &has_notifications_enabled) {
    m_has_notifications_enabled = has_notifications_enabled;
    m_has_notifications_enabled_isSet = true;
}

bool OAICustomFieldRequest::is_has_notifications_enabled_Set() const{
    return m_has_notifications_enabled_isSet;
}

bool OAICustomFieldRequest::is_has_notifications_enabled_Valid() const{
    return m_has_notifications_enabled_isValid;
}

bool OAICustomFieldRequest::isIsGlobalToWorkspace() const {
    return m_is_global_to_workspace;
}
void OAICustomFieldRequest::setIsGlobalToWorkspace(const bool &is_global_to_workspace) {
    m_is_global_to_workspace = is_global_to_workspace;
    m_is_global_to_workspace_isSet = true;
}

bool OAICustomFieldRequest::is_is_global_to_workspace_Set() const{
    return m_is_global_to_workspace_isSet;
}

bool OAICustomFieldRequest::is_is_global_to_workspace_Valid() const{
    return m_is_global_to_workspace_isValid;
}

qint32 OAICustomFieldRequest::getPrecision() const {
    return m_precision;
}
void OAICustomFieldRequest::setPrecision(const qint32 &precision) {
    m_precision = precision;
    m_precision_isSet = true;
}

bool OAICustomFieldRequest::is_precision_Set() const{
    return m_precision_isSet;
}

bool OAICustomFieldRequest::is_precision_Valid() const{
    return m_precision_isValid;
}

QList<QString> OAICustomFieldRequest::getPeopleValue() const {
    return m_people_value;
}
void OAICustomFieldRequest::setPeopleValue(const QList<QString> &people_value) {
    m_people_value = people_value;
    m_people_value_isSet = true;
}

bool OAICustomFieldRequest::is_people_value_Set() const{
    return m_people_value_isSet;
}

bool OAICustomFieldRequest::is_people_value_Valid() const{
    return m_people_value_isValid;
}

QString OAICustomFieldRequest::getWorkspace() const {
    return m_workspace;
}
void OAICustomFieldRequest::setWorkspace(const QString &workspace) {
    m_workspace = workspace;
    m_workspace_isSet = true;
}

bool OAICustomFieldRequest::is_workspace_Set() const{
    return m_workspace_isSet;
}

bool OAICustomFieldRequest::is_workspace_Valid() const{
    return m_workspace_isValid;
}

bool OAICustomFieldRequest::isSet() const {
...
bool OAICustomFieldRequest::isValid() const {
