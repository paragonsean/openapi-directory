...
/*
 * OAIGoalRelationshipRequest.h
 *
 * 
 */

#ifndef OAIGoalRelationshipRequest_H
#define OAIGoalRelationshipRequest_H
...
class OAIGoalRelationshipRequest : public OAIObject {
public:
    OAIGoalRelationshipRequest();
    OAIGoalRelationshipRequest(QString json);
    ~OAIGoalRelationshipRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGoalRelationshipRequest)

#endif // OAIGoalRelationshipRequest_H
