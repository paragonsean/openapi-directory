...
#ifndef OAIProjectCompact_H
#define OAIProjectCompact_H
...
class OAIProjectCompact : public OAIObject {
public:
    OAIProjectCompact();
    OAIProjectCompact(QString json);
    ~OAIProjectCompact() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProjectCompact)

#endif // OAIProjectCompact_H
