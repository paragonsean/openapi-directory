...
/*
 * OAIProjectStatusResponse.h
 *
 * 
 */

#ifndef OAIProjectStatusResponse_H
#define OAIProjectStatusResponse_H
...
class OAIProjectStatusResponse : public OAIObject {
public:
    OAIProjectStatusResponse();
    OAIProjectStatusResponse(QString json);
    ~OAIProjectStatusResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProjectStatusResponse)

#endif // OAIProjectStatusResponse_H
