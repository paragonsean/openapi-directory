...
/*
 * OAIProjectBriefBase.h
 *
 * 
 */

#ifndef OAIProjectBriefBase_H
#define OAIProjectBriefBase_H
...
class OAIProjectBriefBase : public OAIObject {
public:
    OAIProjectBriefBase();
    OAIProjectBriefBase(QString json);
    ~OAIProjectBriefBase() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProjectBriefBase)

#endif // OAIProjectBriefBase_H
