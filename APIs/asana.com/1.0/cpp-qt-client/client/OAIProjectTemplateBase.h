...
/*
 * OAIProjectTemplateBase.h
 *
 * 
 */

#ifndef OAIProjectTemplateBase_H
#define OAIProjectTemplateBase_H
...
class OAIProjectTemplateBase : public OAIObject {
public:
    OAIProjectTemplateBase();
    OAIProjectTemplateBase(QString json);
    ~OAIProjectTemplateBase() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProjectTemplateBase)

#endif // OAIProjectTemplateBase_H
