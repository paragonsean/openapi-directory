...
#ifndef OAITeamCompact_H
#define OAITeamCompact_H
...
class OAITeamCompact : public OAIObject {
public:
    OAITeamCompact();
    OAITeamCompact(QString json);
    ~OAITeamCompact() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITeamCompact)

#endif // OAITeamCompact_H
