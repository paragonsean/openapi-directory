...
/*
 * OAIStatusUpdateBase.h
 *
 * 
 */

#ifndef OAIStatusUpdateBase_H
#define OAIStatusUpdateBase_H
...
class OAIStatusUpdateBase : public OAIObject {
public:
    OAIStatusUpdateBase();
    OAIStatusUpdateBase(QString json);
    ~OAIStatusUpdateBase() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStatusUpdateBase)

#endif // OAIStatusUpdateBase_H
