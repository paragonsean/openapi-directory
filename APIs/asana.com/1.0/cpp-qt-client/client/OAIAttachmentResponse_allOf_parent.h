...
/*
 * OAIAttachmentResponse_allOf_parent.h
 *
 * 
 */

#ifndef OAIAttachmentResponse_allOf_parent_H
#define OAIAttachmentResponse_allOf_parent_H
...
class OAIAttachmentResponse_allOf_parent : public OAIObject {
public:
    OAIAttachmentResponse_allOf_parent();
    OAIAttachmentResponse_allOf_parent(QString json);
    ~OAIAttachmentResponse_allOf_parent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAttachmentResponse_allOf_parent)

#endif // OAIAttachmentResponse_allOf_parent_H
