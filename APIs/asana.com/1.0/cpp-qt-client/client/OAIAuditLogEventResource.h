...
/*
 * OAIAuditLogEventResource.h
 *
 * The primary object that was affected by this event.
 */

#ifndef OAIAuditLogEventResource_H
#define OAIAuditLogEventResource_H
...
class OAIAuditLogEventResource : public OAIObject {
public:
    OAIAuditLogEventResource();
    OAIAuditLogEventResource(QString json);
    ~OAIAuditLogEventResource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAuditLogEventResource)

#endif // OAIAuditLogEventResource_H
