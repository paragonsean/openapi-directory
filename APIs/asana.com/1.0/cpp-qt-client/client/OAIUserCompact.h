...
#ifndef OAIUserCompact_H
#define OAIUserCompact_H
...
class OAIUserCompact : public OAIObject {
public:
    OAIUserCompact();
    OAIUserCompact(QString json);
    ~OAIUserCompact() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserCompact)

#endif // OAIUserCompact_H
