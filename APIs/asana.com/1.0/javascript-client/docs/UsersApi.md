...
> GetUsersForTeam200Response getUsers(opts)
...
> GetUsersForTeam200Response getUsersForTeam(teamGid, opts)
...
> GetUsersForTeam200Response getUsersForWorkspace(workspaceGid, opts)
