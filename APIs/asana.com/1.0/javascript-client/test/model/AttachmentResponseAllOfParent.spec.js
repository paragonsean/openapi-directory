...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Asana.AttachmentResponseAllOfParent();
  });
  ...
  describe('AttachmentResponseAllOfParent', function() {
    it('should create an instance of AttachmentResponseAllOfParent', function() {
      // uncomment below and update the code to test AttachmentResponseAllOfParent
      //var instance = new Asana.AttachmentResponseAllOfParent();
      //expect(instance).to.be.a(Asana.AttachmentResponseAllOfParent);
    });
