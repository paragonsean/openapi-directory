...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Asana.StoryResponseAllOfOldDateValue();
  });
  ...
  describe('StoryResponseAllOfOldDateValue', function() {
    it('should create an instance of StoryResponseAllOfOldDateValue', function() {
      // uncomment below and update the code to test StoryResponseAllOfOldDateValue
      //var instance = new Asana.StoryResponseAllOfOldDateValue();
      //expect(instance).to.be.a(Asana.StoryResponseAllOfOldDateValue);
    });
