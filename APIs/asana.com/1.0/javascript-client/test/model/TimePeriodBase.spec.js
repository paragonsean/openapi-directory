...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Asana.TimePeriodBase();
  });
  ...
  describe('TimePeriodBase', function() {
    it('should create an instance of TimePeriodBase', function() {
      // uncomment below and update the code to test TimePeriodBase
      //var instance = new Asana.TimePeriodBase();
      //expect(instance).to.be.a(Asana.TimePeriodBase);
    });
