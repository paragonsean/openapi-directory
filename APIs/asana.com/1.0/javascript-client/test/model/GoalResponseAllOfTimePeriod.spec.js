...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Asana.GoalResponseAllOfTimePeriod();
  });
  ...
  describe('GoalResponseAllOfTimePeriod', function() {
    it('should create an instance of GoalResponseAllOfTimePeriod', function() {
      // uncomment below and update the code to test GoalResponseAllOfTimePeriod
      //var instance = new Asana.GoalResponseAllOfTimePeriod();
      //expect(instance).to.be.a(Asana.GoalResponseAllOfTimePeriod);
    });
