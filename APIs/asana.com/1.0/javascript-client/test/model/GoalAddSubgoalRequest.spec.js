...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Asana.GoalAddSubgoalRequest();
  });
  ...
  describe('GoalAddSubgoalRequest', function() {
    it('should create an instance of GoalAddSubgoalRequest', function() {
      // uncomment below and update the code to test GoalAddSubgoalRequest
      //var instance = new Asana.GoalAddSubgoalRequest();
      //expect(instance).to.be.a(Asana.GoalAddSubgoalRequest);
    });
    ...
    it('should have the property subgoal (base name: "subgoal")', function() {
      // uncomment below and update the code to test the property subgoal
      //var instance = new Asana.GoalAddSubgoalRequest();
      //expect(instance).to.be();
    });
