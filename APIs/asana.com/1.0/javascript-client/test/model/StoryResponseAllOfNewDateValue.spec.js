...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Asana.StoryResponseAllOfNewDateValue();
  });
  ...
  describe('StoryResponseAllOfNewDateValue', function() {
    it('should create an instance of StoryResponseAllOfNewDateValue', function() {
      // uncomment below and update the code to test StoryResponseAllOfNewDateValue
      //var instance = new Asana.StoryResponseAllOfNewDateValue();
      //expect(instance).to.be.a(Asana.StoryResponseAllOfNewDateValue);
    });
