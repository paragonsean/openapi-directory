...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Asana.TaskResponseAllOfParent();
  });
  ...
  describe('TaskResponseAllOfParent', function() {
    it('should create an instance of TaskResponseAllOfParent', function() {
      // uncomment below and update the code to test TaskResponseAllOfParent
      //var instance = new Asana.TaskResponseAllOfParent();
      //expect(instance).to.be.a(Asana.TaskResponseAllOfParent);
    });
