...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Asana.UserBaseResponse();
  });
  ...
  describe('UserBaseResponse', function() {
    it('should create an instance of UserBaseResponse', function() {
      // uncomment below and update the code to test UserBaseResponse
      //var instance = new Asana.UserBaseResponse();
      //expect(instance).to.be.a(Asana.UserBaseResponse);
    });
