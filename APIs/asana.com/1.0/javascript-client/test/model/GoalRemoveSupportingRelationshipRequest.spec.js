...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Asana.GoalRemoveSupportingRelationshipRequest();
  });
  ...
  describe('GoalRemoveSupportingRelationshipRequest', function() {
    it('should create an instance of GoalRemoveSupportingRelationshipRequest', function() {
      // uncomment below and update the code to test GoalRemoveSupportingRelationshipRequest
      //var instance = new Asana.GoalRemoveSupportingRelationshipRequest();
      //expect(instance).to.be.a(Asana.GoalRemoveSupportingRelationshipRequest);
    });
