...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Asana.TimePeriodResponse();
  });
  ...
  describe('TimePeriodResponse', function() {
    it('should create an instance of TimePeriodResponse', function() {
      // uncomment below and update the code to test TimePeriodResponse
      //var instance = new Asana.TimePeriodResponse();
      //expect(instance).to.be.a(Asana.TimePeriodResponse);
    });
