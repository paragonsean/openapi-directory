...
(function(root, factory) {
  ...
  describe('TagBase', function() {
    it('should create an instance of TagBase', function() {
      // uncomment below and update the code to test TagBase
      //var instance = new Asana.TagBase();
      //expect(instance).to.be.a(Asana.TagBase);
    });
