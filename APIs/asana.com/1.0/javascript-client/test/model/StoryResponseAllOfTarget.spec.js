...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Asana.StoryResponseAllOfTarget();
  });
  ...
  describe('StoryResponseAllOfTarget', function() {
    it('should create an instance of StoryResponseAllOfTarget', function() {
      // uncomment below and update the code to test StoryResponseAllOfTarget
      //var instance = new Asana.StoryResponseAllOfTarget();
      //expect(instance).to.be.a(Asana.StoryResponseAllOfTarget);
    });
