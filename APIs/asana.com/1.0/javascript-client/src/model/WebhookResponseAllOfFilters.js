...
/**
 * The WebhookResponseAllOfFilters model module.
 * @module model/WebhookResponseAllOfFilters
 * @version 1.0
 */
class WebhookResponseAllOfFilters {
    /**
     * Constructs a new <code>WebhookResponseAllOfFilters</code>.
     * @alias module:model/WebhookResponseAllOfFilters
     * @implements module:model/WebhookFilter
     */
    constructor() { 
        WebhookFilter.initialize(this);
        WebhookResponseAllOfFilters.initialize(this);
    }
    ...
    /**
     * Constructs a <code>WebhookResponseAllOfFilters</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhookResponseAllOfFilters} obj Optional instance to populate.
     * @return {module:model/WebhookResponseAllOfFilters} The populated <code>WebhookResponseAllOfFilters</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhookResponseAllOfFilters();
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookResponseAllOfFilters</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookResponseAllOfFilters</code>.
     */
 ...
 */
WebhookResponseAllOfFilters.prototype['action'] = undefined;
 ...
 */
WebhookResponseAllOfFilters.prototype['fields'] = undefined;
 ...
 */
WebhookResponseAllOfFilters.prototype['resource_subtype'] = undefined;
 ...
 */
WebhookResponseAllOfFilters.prototype['resource_type'] = undefined;
...
export default WebhookResponseAllOfFilters;
