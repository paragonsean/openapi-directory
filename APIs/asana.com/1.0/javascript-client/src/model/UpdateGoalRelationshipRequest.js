...
class UpdateGoalRelationshipRequest {
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateGoalRelationshipRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateGoalRelationshipRequest</code>.
     */
    static validateJSON(data) {
        // validate the optional field `data`
        if (data['data']) { // data not null
          GoalRelationshipRequest.validateJSON(data['data']);
        }
