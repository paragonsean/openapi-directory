...
class CustomFieldRequest {
    ...
    /**
     * Validates the JSON data with respect to <code>CustomFieldRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CustomFieldRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CustomFieldRequest.RequiredProperties) {
        ...
        // ensure the json data is an array
        if (!Array.isArray(data['people_value'])) {
            throw new Error("Expected the field `people_value` to be an array in the JSON data but got " + data['people_value']);
        }
        // ensure the json data is a string
...
CustomFieldRequest.RequiredProperties = ["workspace"];
 ...
 * @member {module:model/CustomFieldRequest.AsanaCreatedFieldEnum} asana_created_field
 */
