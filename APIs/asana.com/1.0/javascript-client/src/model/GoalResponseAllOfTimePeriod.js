...
/**
 * The GoalResponseAllOfTimePeriod model module.
 * @module model/GoalResponseAllOfTimePeriod
 * @version 1.0
 */
class GoalResponseAllOfTimePeriod {
    /**
     * Constructs a new <code>GoalResponseAllOfTimePeriod</code>.
     * @alias module:model/GoalResponseAllOfTimePeriod
     * @implements module:model/TimePeriodCompact
     */
    constructor() { 
        TimePeriodCompact.initialize(this);
        GoalResponseAllOfTimePeriod.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GoalResponseAllOfTimePeriod</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GoalResponseAllOfTimePeriod} obj Optional instance to populate.
     * @return {module:model/GoalResponseAllOfTimePeriod} The populated <code>GoalResponseAllOfTimePeriod</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GoalResponseAllOfTimePeriod();
    ...
    /**
     * Validates the JSON data with respect to <code>GoalResponseAllOfTimePeriod</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GoalResponseAllOfTimePeriod</code>.
     */
 ...
 * @member {String} gid
 */
GoalResponseAllOfTimePeriod.prototype['gid'] = undefined;

/**
 * The base type of this resource.
 * @member {String} resource_type
 */
GoalResponseAllOfTimePeriod.prototype['resource_type'] = undefined;

/**
 * A string representing the cadence code and the fiscal year.
 * @member {String} display_name
 */
GoalResponseAllOfTimePeriod.prototype['display_name'] = undefined;

/**
 * The localized end date of the time period in `YYYY-MM-DD` format.
 * @member {String} end_on
 */
GoalResponseAllOfTimePeriod.prototype['end_on'] = undefined;

/**
 * The cadence and index of the time period. The value is one of: `FY`, `H1`, `H2`, `Q1`, `Q2`, `Q3`, or `Q4`.
 * @member {module:model/GoalResponseAllOfTimePeriod.PeriodEnum} period
 */
GoalResponseAllOfTimePeriod.prototype['period'] = undefined;

/**
 * The localized start date of the time period in `YYYY-MM-DD` format.
 * @member {String} start_on
 */
GoalResponseAllOfTimePeriod.prototype['start_on'] = undefined;
 ...
 * @readonly
 */
GoalResponseAllOfTimePeriod['PeriodEnum'] = {
...
export default GoalResponseAllOfTimePeriod;
