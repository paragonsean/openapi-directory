...
class CustomFieldResponse {
    ...
    /**
     * Validates the JSON data with respect to <code>CustomFieldResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CustomFieldResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['people_value']) { // data not null
            // ensure the json data is an array
            ...
            for (const item of data['people_value']) {
 ...
 * @member {module:model/CustomFieldResponse.AsanaCreatedFieldEnum} asana_created_field
 */
