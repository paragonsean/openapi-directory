...
class TimePeriodResponse {
    ...
    /**
     * Validates the JSON data with respect to <code>TimePeriodResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TimePeriodResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['parent']) { // data not null
          TimePeriodCompact.validateJSON(data['parent']);
        }
...
export default TimePeriodResponse;
