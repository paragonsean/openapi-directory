...
class WorkspaceResponse {
    ...
    /**
     * Validates the JSON data with respect to <code>WorkspaceResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WorkspaceResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (!Array.isArray(data['email_domains'])) {
            throw new Error("Expected the field `email_domains` to be an array in the JSON data but got " + data['email_domains']);
        }
