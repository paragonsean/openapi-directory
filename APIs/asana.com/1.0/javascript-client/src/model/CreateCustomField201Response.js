...
class CreateCustomField201Response {
    ...
    /**
     * Validates the JSON data with respect to <code>CreateCustomField201Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateCustomField201Response</code>.
     */
    static validateJSON(data) {
        // validate the optional field `data`
        if (data['data']) { // data not null
          CustomFieldResponse.validateJSON(data['data']);
        }
