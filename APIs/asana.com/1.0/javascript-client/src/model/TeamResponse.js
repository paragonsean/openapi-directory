...
import TeamResponseAllOfOrganization from './TeamResponseAllOfOrganization';
...
class TeamResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('organization')) {
                obj['organization'] = TeamResponseAllOfOrganization.constructFromObject(data['organization']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['organization']) { // data not null
          TeamResponseAllOfOrganization.validateJSON(data['organization']);
        }
        // ensure the json data is a string
...
/**
 * @member {module:model/TeamResponseAllOfOrganization} organization
 */
