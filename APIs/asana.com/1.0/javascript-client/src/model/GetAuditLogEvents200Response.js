...
class GetAuditLogEvents200Response {
    ...
    /**
     * Validates the JSON data with respect to <code>GetAuditLogEvents200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetAuditLogEvents200Response</code>.
     */
    static validateJSON(data) {
        if (data['data']) { // data not null
            ...
            for (const item of data['data']) {
                AuditLogEvent.validateJSON(item);
            };
        }
