...
class DuplicateTaskRequest(Model):
    ...
    def __init__(self, data: TaskDuplicateRequest=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DuplicateTaskRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The duplicateTask_request of this DuplicateTaskRequest.
        """
