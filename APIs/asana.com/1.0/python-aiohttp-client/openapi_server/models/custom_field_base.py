...
class CustomFieldBase(Model):
    ...
    def __init__(self, gid: str=None, resource_type: str=None, date_value: CustomFieldCompactAllOfDateValue=None, display_value: str=None, enabled: bool=None, enum_options: List[EnumOption]=None, enum_value: CustomFieldCompactAllOfEnumValue=None, multi_enum_values: List[EnumOption]=None, name: str=None, number_value: float=None, resource_subtype: str=None, text_value: str=None, type: str=None, asana_created_field: str=None, currency_code: str=None, custom_label: str=None, custom_label_position: str=None, description: str=None, format: str=None, has_notifications_enabled: bool=None, is_global_to_workspace: bool=None, precision: int=None):
        """CustomFieldBase - a model defined in OpenAPI

        :param gid: The gid of this CustomFieldBase.
        :param resource_type: The resource_type of this CustomFieldBase.
        :param date_value: The date_value of this CustomFieldBase.
        :param display_value: The display_value of this CustomFieldBase.
        :param enabled: The enabled of this CustomFieldBase.
        :param enum_options: The enum_options of this CustomFieldBase.
        :param enum_value: The enum_value of this CustomFieldBase.
        :param multi_enum_values: The multi_enum_values of this CustomFieldBase.
        :param name: The name of this CustomFieldBase.
        :param number_value: The number_value of this CustomFieldBase.
        :param resource_subtype: The resource_subtype of this CustomFieldBase.
        :param text_value: The text_value of this CustomFieldBase.
        :param type: The type of this CustomFieldBase.
        :param asana_created_field: The asana_created_field of this CustomFieldBase.
        :param currency_code: The currency_code of this CustomFieldBase.
        :param custom_label: The custom_label of this CustomFieldBase.
        :param custom_label_position: The custom_label_position of this CustomFieldBase.
        :param description: The description of this CustomFieldBase.
        :param format: The format of this CustomFieldBase.
        :param has_notifications_enabled: The has_notifications_enabled of this CustomFieldBase.
        :param is_global_to_workspace: The is_global_to_workspace of this CustomFieldBase.
        :param precision: The precision of this CustomFieldBase.
        """
        self.openapi_types = {
            'gid': str,
            'resource_type': str,
    ...
    def from_dict(cls, dikt: dict) -> 'CustomFieldBase':
        ...
        :param dikt: A dict.
        :return: The CustomFieldBase of this CustomFieldBase.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def gid(self):
        """Gets the gid of this CustomFieldBase.

        Globally unique identifier of the resource, as a string.

        :return: The gid of this CustomFieldBase.
        :rtype: str
        """
        return self._gid
    ...
    @gid.setter
    def gid(self, gid):
        """Sets the gid of this CustomFieldBase.
    ...
    def resource_type(self):
        """Gets the resource_type of this CustomFieldBase.

        The base type of this resource.

        :return: The resource_type of this CustomFieldBase.
        :rtype: str
        """
    ...
    def resource_type(self, resource_type):
        """Sets the resource_type of this CustomFieldBase.
    ...
    @property
    def date_value(self):
        """Gets the date_value of this CustomFieldBase.


        :return: The date_value of this CustomFieldBase.
    ...
    def date_value(self, date_value):
        """Sets the date_value of this CustomFieldBase.
    ...
    def display_value(self):
        """Gets the display_value of this CustomFieldBase.

        A string representation for the value of the custom field. Integrations that don't require the underlying type should use this field to read values. Using this field will future-proof an app against new custom field types.

        :return: The display_value of this CustomFieldBase.
        :rtype: str
        """
    ...
    def display_value(self, display_value):
        """Sets the display_value of this CustomFieldBase.
    ...
    @property
    def enabled(self):
        """Gets the enabled of this CustomFieldBase.

        *Conditional*. Determines if the custom field is enabled or not.

        :return: The enabled of this CustomFieldBase.
        :rtype: bool
        """
    ...
    def enabled(self, enabled):
        """Sets the enabled of this CustomFieldBase.
    ...
    def enum_options(self):
        """Gets the enum_options of this CustomFieldBase.
        ...
        *Conditional*. Only relevant for custom fields of type `enum`. This array specifies the possible values which an `enum` custom field can adopt. To modify the enum options, refer to [working with enum options](/docs/create-an-enum-option).
        ...
        :return: The enum_options of this CustomFieldBase.
    ...
    def enum_options(self, enum_options):
        """Sets the enum_options of this CustomFieldBase.
    ...
    @property
    def enum_value(self):
        """Gets the enum_value of this CustomFieldBase.


        :return: The enum_value of this CustomFieldBase.
    ...
    def enum_value(self, enum_value):
        """Sets the enum_value of this CustomFieldBase.
    ...
    def multi_enum_values(self):
        """Gets the multi_enum_values of this CustomFieldBase.

        *Conditional*. Only relevant for custom fields of type `multi_enum`. This object is the chosen values of a `multi_enum` custom field.

        :return: The multi_enum_values of this CustomFieldBase.
        :rtype: List[EnumOption]
        """
    ...
    def multi_enum_values(self, multi_enum_values):
        """Sets the multi_enum_values of this CustomFieldBase.
    ...
    def number_value(self):
        """Gets the number_value of this CustomFieldBase.

        *Conditional*. This number is the value of a `number` custom field.

        :return: The number_value of this CustomFieldBase.
        :rtype: float
        """
    ...
    def number_value(self, number_value):
        """Sets the number_value of this CustomFieldBase.
    ...
    def resource_subtype(self):
        """Gets the resource_subtype of this CustomFieldBase.

        The type of the custom field. Must be one of the given values. 

        :return: The resource_subtype of this CustomFieldBase.
        :rtype: str
        """
    ...
    def resource_subtype(self, resource_subtype):
        """Sets the resource_subtype of this CustomFieldBase.
    ...
    @property
    def text_value(self):
        """Gets the text_value of this CustomFieldBase.

        *Conditional*. This string is the value of a `text` custom field.

        :return: The text_value of this CustomFieldBase.
        :rtype: str
        """
    ...
    def text_value(self, text_value):
        """Sets the text_value of this CustomFieldBase.
    ...
    @property
    def type(self):
        """Gets the type of this CustomFieldBase.

        *Deprecated: new integrations should prefer the resource_subtype field.* The type of the custom field. Must be one of the given values. 

        :return: The type of this CustomFieldBase.
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this CustomFieldBase.
    ...
    def asana_created_field(self):
        """Gets the asana_created_field of this CustomFieldBase.

        *Conditional*. A unique identifier to associate this field with the template source of truth.

        :return: The asana_created_field of this CustomFieldBase.
        :rtype: str
        """
    ...
    def asana_created_field(self, asana_created_field):
        """Sets the asana_created_field of this CustomFieldBase.
    ...
    def currency_code(self, currency_code):
        """Sets the currency_code of this CustomFieldBase.
    ...
    def custom_label(self, custom_label):
        """Sets the custom_label of this CustomFieldBase.
    ...
    def custom_label_position(self):
        """Gets the custom_label_position of this CustomFieldBase.
        ...
        :return: The custom_label_position of this CustomFieldBase.
        :rtype: str
        """
    ...
    def custom_label_position(self, custom_label_position):
        """Sets the custom_label_position of this CustomFieldBase.
    ...
    def description(self):
        """Gets the description of this CustomFieldBase.

        [Opt In](/docs/input-output-options). The description of the custom field.

        :return: The description of this CustomFieldBase.
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this CustomFieldBase.
    ...
    @property
    def format(self):
        """Gets the format of this CustomFieldBase.

        The format of this custom field.

        :return: The format of this CustomFieldBase.
        :rtype: str
        """
        return self._format
    ...
    def format(self, format):
        """Sets the format of this CustomFieldBase.
    ...
    def has_notifications_enabled(self):
        """Gets the has_notifications_enabled of this CustomFieldBase.
        ...
        *Conditional*. This flag describes whether a follower of a task with this field should receive inbox notifications from changes to this field.
        ...
        :return: The has_notifications_enabled of this CustomFieldBase.
        :rtype: bool
        """
    ...
    def has_notifications_enabled(self, has_notifications_enabled):
        """Sets the has_notifications_enabled of this CustomFieldBase.
    ...
    def is_global_to_workspace(self):
        """Gets the is_global_to_workspace of this CustomFieldBase.
        ...
        :return: The is_global_to_workspace of this CustomFieldBase.
        :rtype: bool
        """
    ...
    def is_global_to_workspace(self, is_global_to_workspace):
        """Sets the is_global_to_workspace of this CustomFieldBase.
    ...
    @property
    def precision(self):
        """Gets the precision of this CustomFieldBase.
        ...
        :return: The precision of this CustomFieldBase.
        :rtype: int
        """
    ...
    def precision(self, precision):
        """Sets the precision of this CustomFieldBase.
