...
class TaskRequest(Model):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TaskRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TaskRequest of this TaskRequest.
        """
