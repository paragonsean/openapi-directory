...
async def get_workspace_membership(request: web.Request, workspace_membership_gid, opt_pretty=None, opt_fields=None) -> web.Response:
...
async def get_workspace_memberships_for_user(request: web.Request, user_gid, opt_pretty=None, opt_fields=None, limit=None, offset=None) -> web.Response:
...
async def get_workspace_memberships_for_workspace(request: web.Request, workspace_gid, user=None, opt_pretty=None, opt_fields=None, limit=None, offset=None) -> web.Response:
