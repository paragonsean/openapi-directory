...
async def typeahead_for_workspace(request: web.Request, workspace_gid, resource_type, type=None, query=None, count=None, opt_pretty=None, opt_fields=None) -> web.Response:
