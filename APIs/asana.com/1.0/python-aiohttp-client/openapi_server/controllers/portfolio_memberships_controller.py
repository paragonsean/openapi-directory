...
async def get_portfolio_membership(request: web.Request, portfolio_membership_gid, opt_pretty=None, opt_fields=None) -> web.Response:
...
async def get_portfolio_memberships(request: web.Request, portfolio=None, workspace=None, user=None, opt_pretty=None, opt_fields=None, limit=None, offset=None) -> web.Response:
...
async def get_portfolio_memberships_for_portfolio(request: web.Request, portfolio_gid, user=None, opt_pretty=None, opt_fields=None, limit=None, offset=None) -> web.Response:
