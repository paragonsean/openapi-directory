...
async def test_add_followers(client):
    ...
    response = await client.request(
        method='POST',
        path='/api/1.0/goals/{goal_gid}/addFollowers'.format(goal_gid='12345'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_create_goal(client):
    ...
    Create a goal
    """
    body = openapi_server.CreateGoalRequest()
    params = [('opt_pretty', true),
                    ('opt_fields', ['[\"followers\",\"assignee\"]']),
                    ('limit', 50),
...
async def test_create_goal_metric(client):
    """Test case for create_goal_metric

    Create a goal metric
    """
    body = openapi_server.CreateGoalMetricRequest()
    params = [('opt_pretty', true),
                    ('opt_fields', ['[\"followers\",\"assignee\"]'])]
    headers = { 
        'Accept': 'application/json',
    ...
    response = await client.request(
        method='POST',
        path='/api/1.0/goals/{goal_gid}/setMetric'.format(goal_gid='12345'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_delete_goal(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/api/1.0/goals/{goal_gid}'.format(goal_gid='12345'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_parent_goals_for_goal(client):
    ...
    response = await client.request(
        method='GET',
        path='/api/1.0/goals/{goal_gid}/parentGoals'.format(goal_gid='12345'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_remove_followers(client):
    ...
    response = await client.request(
        method='POST',
        path='/api/1.0/goals/{goal_gid}/removeFollowers'.format(goal_gid='12345'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_update_goal_metric(client):
    """Test case for update_goal_metric

    Update a goal metric
    """
    body = openapi_server.UpdateGoalMetricRequest()
    params = [('opt_pretty', true),
                    ('opt_fields', ['[\"followers\",\"assignee\"]'])]
    headers = { 
        'Accept': 'application/json',
    ...
    response = await client.request(
        method='POST',
        path='/api/1.0/goals/{goal_gid}/setMetricCurrentValue'.format(goal_gid='12345'),
        headers=headers,
        json=body,
        params=params,
        )
