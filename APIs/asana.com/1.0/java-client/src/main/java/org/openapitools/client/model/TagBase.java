...
public class TagBase {
  ...
  public TagBase notes(String notes) {
    this.notes = notes;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.gid, tagBase.gid) &&
        Objects.equals(this.resourceType, tagBase.resourceType) &&
        Objects.equals(this.name, tagBase.name) &&
        Objects.equals(this.color, tagBase.color) &&
        Objects.equals(this.notes, tagBase.notes);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(gid, resourceType, name, color, notes);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to TagBase
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TagBase.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TagBase.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TagBase` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
