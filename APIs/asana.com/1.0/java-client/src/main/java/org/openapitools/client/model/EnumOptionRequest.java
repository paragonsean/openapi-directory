...
public class EnumOptionRequest {
   ...
   * @throws IOException if the JSON Element is invalid with respect to EnumOptionRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EnumOptionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EnumOptionRequest is not found in the empty JSON string", EnumOptionRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EnumOptionRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EnumOptionRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EnumOptionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EnumOptionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EnumOptionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EnumOptionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<EnumOptionRequest>() {
           @Override
           public void write(JsonWriter out, EnumOptionRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EnumOptionRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EnumOptionRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EnumOptionRequest
   * @throws IOException if the JSON string is invalid with respect to EnumOptionRequest
   */
  public static EnumOptionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EnumOptionRequest.class);
  }

  /**
   * Convert an instance of EnumOptionRequest to an JSON string
   *
   * @return JSON string
   */
