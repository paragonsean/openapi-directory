...
public class ApiClient {
    ...
    private String basePath = "https://app.asana.com/api/1.0";
    ...
    public ApiClient() {
        ...
        authentications.put("personalAccessToken", new HttpBearerAuth("bearer"));
    ...
    public ApiClient(String basePath, String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        String tokenUrl = "https://app.asana.com/-/oauth_token";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://app.asana.com/api/1.0
