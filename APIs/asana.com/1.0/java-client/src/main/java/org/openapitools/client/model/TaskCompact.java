...
public class TaskCompact {
  ...
  public TaskCompact resourceSubtype(ResourceSubtypeEnum resourceSubtype) {
  ...
  public boolean equals(Object o) {
    ...
    TaskCompact taskCompact = (TaskCompact) o;
    return Objects.equals(this.gid, taskCompact.gid) &&
        Objects.equals(this.resourceType, taskCompact.resourceType) &&
        Objects.equals(this.name, taskCompact.name) &&
        Objects.equals(this.resourceSubtype, taskCompact.resourceSubtype);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to TaskCompact
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TaskCompact.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TaskCompact is not found in the empty JSON string", TaskCompact.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TaskCompact.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TaskCompact` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TaskCompact.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TaskCompact' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TaskCompact> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TaskCompact.class));

       return (TypeAdapter<T>) new TypeAdapter<TaskCompact>() {
           @Override
           public void write(JsonWriter out, TaskCompact value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TaskCompact read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TaskCompact given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TaskCompact
   * @throws IOException if the JSON string is invalid with respect to TaskCompact
   */
  public static TaskCompact fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TaskCompact.class);
  }

  /**
   * Convert an instance of TaskCompact to an JSON string
   *
   * @return JSON string
   */
