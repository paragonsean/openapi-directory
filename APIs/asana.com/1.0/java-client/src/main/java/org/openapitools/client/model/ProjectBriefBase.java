...
public class ProjectBriefBase {
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProjectBriefBase
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectBriefBase.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProjectBriefBase.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProjectBriefBase` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
