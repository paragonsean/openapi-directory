...
public class TimePeriodResponse {
   ...
   * @throws IOException if the JSON Element is invalid with respect to TimePeriodResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TimePeriodResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TimePeriodResponse is not found in the empty JSON string", TimePeriodResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TimePeriodResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TimePeriodResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TimePeriodResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TimePeriodResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TimePeriodResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TimePeriodResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<TimePeriodResponse>() {
           @Override
           public void write(JsonWriter out, TimePeriodResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TimePeriodResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TimePeriodResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TimePeriodResponse
   * @throws IOException if the JSON string is invalid with respect to TimePeriodResponse
   */
  public static TimePeriodResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TimePeriodResponse.class);
  }

  /**
   * Convert an instance of TimePeriodResponse to an JSON string
   *
   * @return JSON string
   */
