...
public class GoalRelationshipBase {
  ...
  public GoalRelationshipBase contributionWeight(BigDecimal contributionWeight) {
  ...
  public GoalRelationshipBase supportingResource(GoalRelationshipCompactAllOfSupportingResource supportingResource) {
  ...
  public GoalRelationshipBase supportedGoal(GoalRelationshipBaseAllOfSupportedGoal supportedGoal) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoalRelationshipBase
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoalRelationshipBase.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoalRelationshipBase.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoalRelationshipBase` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
