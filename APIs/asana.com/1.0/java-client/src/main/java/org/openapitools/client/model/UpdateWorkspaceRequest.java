...
public class UpdateWorkspaceRequest {
  ...
  public UpdateWorkspaceRequest data(WorkspaceCompact data) {
    this.data = data;
    return this;
  }
  ...
  public WorkspaceCompact getData() {
    return data;
  }

  public void setData(WorkspaceCompact data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, updateWorkspaceRequest.data);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        WorkspaceCompact.validateJsonElement(jsonObj.get("data"));
      }
  }
