...
public class GoalRelationshipCompact {
  ...
  public GoalRelationshipCompact() {
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoalRelationshipCompact
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoalRelationshipCompact.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoalRelationshipCompact is not found in the empty JSON string", GoalRelationshipCompact.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoalRelationshipCompact.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoalRelationshipCompact` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoalRelationshipCompact.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoalRelationshipCompact' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoalRelationshipCompact> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoalRelationshipCompact.class));

       return (TypeAdapter<T>) new TypeAdapter<GoalRelationshipCompact>() {
           @Override
           public void write(JsonWriter out, GoalRelationshipCompact value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoalRelationshipCompact read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoalRelationshipCompact given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoalRelationshipCompact
   * @throws IOException if the JSON string is invalid with respect to GoalRelationshipCompact
   */
  public static GoalRelationshipCompact fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoalRelationshipCompact.class);
  }

  /**
   * Convert an instance of GoalRelationshipCompact to an JSON string
   *
   * @return JSON string
   */
