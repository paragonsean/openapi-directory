...
public class GoalRelationshipResponse {
  ...
  public GoalRelationshipResponse contributionWeight(BigDecimal contributionWeight) {
  ...
  public GoalRelationshipResponse supportingResource(GoalRelationshipCompactAllOfSupportingResource supportingResource) {
  ...
  public GoalRelationshipResponse supportedGoal(GoalRelationshipBaseAllOfSupportedGoal supportedGoal) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoalRelationshipResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoalRelationshipResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoalRelationshipResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoalRelationshipResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
