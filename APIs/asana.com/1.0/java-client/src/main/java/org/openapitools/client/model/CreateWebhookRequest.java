...
public class CreateWebhookRequest {
  ...
  public CreateWebhookRequest data(WebhookRequest data) {
    this.data = data;
    return this;
  }
  ...
  public WebhookRequest getData() {
    return data;
  }

  public void setData(WebhookRequest data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, createWebhookRequest.data);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        WebhookRequest.validateJsonElement(jsonObj.get("data"));
      }
  }
