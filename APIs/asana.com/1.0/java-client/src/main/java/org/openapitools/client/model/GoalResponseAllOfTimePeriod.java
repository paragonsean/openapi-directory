...
public class GoalResponseAllOfTimePeriod {
  ...
  public GoalResponseAllOfTimePeriod() {
  }
  ...
  public GoalResponseAllOfTimePeriod displayName(String displayName) {
  ...
  public GoalResponseAllOfTimePeriod endOn(String endOn) {
    this.endOn = endOn;
    return this;
  }
  ...
  public GoalResponseAllOfTimePeriod period(PeriodEnum period) {
    this.period = period;
    return this;
  }
  ...
  public GoalResponseAllOfTimePeriod startOn(String startOn) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoalResponseAllOfTimePeriod
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoalResponseAllOfTimePeriod.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoalResponseAllOfTimePeriod is not found in the empty JSON string", GoalResponseAllOfTimePeriod.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoalResponseAllOfTimePeriod.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoalResponseAllOfTimePeriod` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoalResponseAllOfTimePeriod.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoalResponseAllOfTimePeriod' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoalResponseAllOfTimePeriod> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoalResponseAllOfTimePeriod.class));

       return (TypeAdapter<T>) new TypeAdapter<GoalResponseAllOfTimePeriod>() {
           @Override
           public void write(JsonWriter out, GoalResponseAllOfTimePeriod value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoalResponseAllOfTimePeriod read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoalResponseAllOfTimePeriod given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoalResponseAllOfTimePeriod
   * @throws IOException if the JSON string is invalid with respect to GoalResponseAllOfTimePeriod
   */
  public static GoalResponseAllOfTimePeriod fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoalResponseAllOfTimePeriod.class);
  }

  /**
   * Convert an instance of GoalResponseAllOfTimePeriod to an JSON string
   *
   * @return JSON string
   */
