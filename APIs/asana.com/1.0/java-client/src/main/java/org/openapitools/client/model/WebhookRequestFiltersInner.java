...
public class WebhookRequestFiltersInner {
   ...
   * @throws IOException if the JSON Element is invalid with respect to WebhookRequestFiltersInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebhookRequestFiltersInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebhookRequestFiltersInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookRequestFiltersInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
