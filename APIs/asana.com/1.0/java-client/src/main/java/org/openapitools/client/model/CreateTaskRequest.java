...
public class CreateTaskRequest {
  ...
  public CreateTaskRequest data(TaskRequest data) {
    this.data = data;
    return this;
  }
  ...
  public TaskRequest getData() {
    return data;
  }

  public void setData(TaskRequest data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, createTaskRequest.data);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        TaskRequest.validateJsonElement(jsonObj.get("data"));
      }
  }
