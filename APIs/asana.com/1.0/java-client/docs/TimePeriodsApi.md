...
# **getTimePeriod**
> GetTimePeriod200Response getTimePeriod(timePeriodGid, optPretty, optFields)
...
import org.openapitools.client.api.TimePeriodsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TimePeriodsApi apiInstance = new TimePeriodsApi(defaultClient);
    String timePeriodGid = "917392"; // String | Globally unique identifier for the time period.
...
# **getTimePeriods**
> GetTimePeriods200Response getTimePeriods(workspace, optPretty, optFields, limit, offset, startOn, endOn)
...
public class Example {
  public static void main(String[] args) {
    ...
    TimePeriodsApi apiInstance = new TimePeriodsApi(defaultClient);
    String workspace = "31326"; // String | Globally unique identifier for the workspace.
    Boolean optPretty = true; // Boolean | Provides “pretty” output. Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging.
    List<String> optFields = Arrays.asList(); // List<String> | Defines fields to return. Some requests return *compact* representations of objects in order to conserve resources and complete the request more efficiently. Other times requests return more information than you may need. This option allows you to list the exact set of fields that the API should be sure to return for the objects. The field names should be provided as paths, described below. The id of included objects will always be returned, regardless of the field options.
    ...
    LocalDate startOn = LocalDate.parse("2019-09-15"); // LocalDate | ISO 8601 date string
    LocalDate endOn = LocalDate.parse("2019-09-15"); // LocalDate | ISO 8601 date string
    try {
