...
# **getTeamMembership**
> GetTeamMembership200Response getTeamMembership(teamMembershipGid, optPretty, optFields)
...
import org.openapitools.client.api.TeamMembershipsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TeamMembershipsApi apiInstance = new TeamMembershipsApi(defaultClient);
    String teamMembershipGid = "724362"; // String | 
...
# **getTeamMemberships**
> GetTeamMemberships200Response getTeamMemberships(optPretty, optFields, limit, offset, team, user, workspace)
...
public class Example {
  public static void main(String[] args) {
    ...
    String team = "159874"; // String | Globally unique identifier for the team.
    String user = "512241"; // String | A string identifying a user. This can either be the string \"me\", an email, or the gid of a user. This parameter must be used with the workspace parameter.
    String workspace = "31326"; // String | Globally unique identifier for the workspace. This parameter must be used with the user parameter.
    try {
...
> GetTeamMemberships200Response getTeamMembershipsForTeam(teamGid, optPretty, optFields, limit, offset)
...
> GetTeamMemberships200Response getTeamMembershipsForUser(userGid, workspace, optPretty, optFields, limit, offset)
