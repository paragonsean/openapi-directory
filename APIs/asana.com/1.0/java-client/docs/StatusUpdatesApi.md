...
> CreateStatusForObject201Response createStatusForObject(createStatusForObjectRequest, optPretty, optFields, limit, offset)
...
import org.openapitools.client.api.StatusUpdatesApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    StatusUpdatesApi apiInstance = new StatusUpdatesApi(defaultClient);
    CreateStatusForObjectRequest createStatusForObjectRequest = new CreateStatusForObjectRequest(); // CreateStatusForObjectRequest | The status update to create.
    ...
    try {
      CreateStatusForObject201Response result = apiInstance.createStatusForObject(createStatusForObjectRequest, optPretty, optFields, limit, offset);
...
<a id="deleteStatus"></a>
# **deleteStatus**
> DeleteAttachment200Response deleteStatus(statusGid, optPretty, optFields)
...
public class Example {
  public static void main(String[] args) {
    ...
    StatusUpdatesApi apiInstance = new StatusUpdatesApi(defaultClient);
    String statusGid = "321654"; // String | The status update to get.
    Boolean optPretty = true; // Boolean | Provides “pretty” output. Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging.
    List<String> optFields = Arrays.asList(); // List<String> | Defines fields to return. Some requests return *compact* representations of objects in order to conserve resources and complete the request more efficiently. Other times requests return more information than you may need. This option allows you to list the exact set of fields that the API should be sure to return for the objects. The field names should be provided as paths, described below. The id of included objects will always be returned, regardless of the field options.
    try {
...
<a id="getStatus"></a>
# **getStatus**
> CreateStatusForObject201Response getStatus(statusGid, optPretty, optFields)
...
public class Example {
  public static void main(String[] args) {
    ...
    List<String> optFields = Arrays.asList(); // List<String> | Defines fields to return. Some requests return *compact* representations of objects in order to conserve resources and complete the request more efficiently. Other times requests return more information than you may need. This option allows you to list the exact set of fields that the API should be sure to return for the objects. The field names should be provided as paths, described below. The id of included objects will always be returned, regardless of the field options.
    try {
      CreateStatusForObject201Response result = apiInstance.getStatus(statusGid, optPretty, optFields);
      System.out.println(result);
    } catch (ApiException e) {
...
> GetStatusesForObject200Response getStatusesForObject(parent, optPretty, optFields, limit, offset, createdSince)
...
public class Example {
  public static void main(String[] args) {
    ...
    StatusUpdatesApi apiInstance = new StatusUpdatesApi(defaultClient);
    String parent = "159874"; // String | Globally unique identifier for object to fetch statuses from. Must be a GID for a project, portfolio, or goal.
    Boolean optPretty = true; // Boolean | Provides “pretty” output. Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging.
    List<String> optFields = Arrays.asList(); // List<String> | Defines fields to return. Some requests return *compact* representations of objects in order to conserve resources and complete the request more efficiently. Other times requests return more information than you may need. This option allows you to list the exact set of fields that the API should be sure to return for the objects. The field names should be provided as paths, described below. The id of included objects will always be returned, regardless of the field options.
    Integer limit = 50; // Integer | Results per page. The number of objects to return per page. The value must be between 1 and 100.
    String offset = "eyJ0eXAiOJiKV1iQLCJhbGciOiJIUzI1NiJ9"; // String | Offset token. An offset to the next page returned by the API. A pagination request will return an offset token, which can be used as an input parameter to the next request. If an offset is not passed in, the API will return the first page of results. 'Note: You can only pass in an offset that was returned to you via a previously paginated request.'
    OffsetDateTime createdSince = OffsetDateTime.parse("2012-02-22T02:06:58.158Z"); // OffsetDateTime | Only return statuses that have been created since the given time.
    try {
