...
# **createBatchRequest**
> CreateBatchRequest200Response createBatchRequest(createBatchRequestRequest, optPretty, optFields)
...
import org.openapitools.client.api.BatchApiApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    CreateBatchRequestRequest createBatchRequestRequest = new CreateBatchRequestRequest(); // CreateBatchRequestRequest | The requests to batch together via the Batch API.
