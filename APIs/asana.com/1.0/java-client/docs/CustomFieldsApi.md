...
# **createCustomField**
> CreateCustomField201Response createCustomField(optPretty, optFields, limit, offset, createCustomFieldRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    CreateCustomFieldRequest createCustomFieldRequest = new CreateCustomFieldRequest(); // CreateCustomFieldRequest | The custom field object to create.
    try {
...
> CreateEnumOptionForCustomField201Response createEnumOptionForCustomField(customFieldGid, optPretty, optFields, limit, offset, createEnumOptionForCustomFieldRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    CustomFieldsApi apiInstance = new CustomFieldsApi(defaultClient);
    String customFieldGid = "12345"; // String | Globally unique identifier for the custom field.
    Boolean optPretty = true; // Boolean | Provides “pretty” output. Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging.
    List<String> optFields = Arrays.asList(); // List<String> | Defines fields to return. Some requests return *compact* representations of objects in order to conserve resources and complete the request more efficiently. Other times requests return more information than you may need. This option allows you to list the exact set of fields that the API should be sure to return for the objects. The field names should be provided as paths, described below. The id of included objects will always be returned, regardless of the field options.
    Integer limit = 50; // Integer | Results per page. The number of objects to return per page. The value must be between 1 and 100.
    String offset = "eyJ0eXAiOJiKV1iQLCJhbGciOiJIUzI1NiJ9"; // String | Offset token. An offset to the next page returned by the API. A pagination request will return an offset token, which can be used as an input parameter to the next request. If an offset is not passed in, the API will return the first page of results. 'Note: You can only pass in an offset that was returned to you via a previously paginated request.'
    CreateEnumOptionForCustomFieldRequest createEnumOptionForCustomFieldRequest = new CreateEnumOptionForCustomFieldRequest(); // CreateEnumOptionForCustomFieldRequest | The enum option object to create.
    try {
...
# **deleteCustomField**
> DeleteAttachment200Response deleteCustomField(customFieldGid, optPretty, optFields)
...
# **getCustomField**
> CreateCustomField201Response getCustomField(customFieldGid, optPretty, optFields)
...
> GetCustomFieldsForWorkspace200Response getCustomFieldsForWorkspace(workspaceGid, optPretty, optFields, limit, offset)
...
> CreateEnumOptionForCustomField201Response insertEnumOptionForCustomField(customFieldGid, optPretty, optFields, insertEnumOptionForCustomFieldRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    Boolean optPretty = true; // Boolean | Provides “pretty” output. Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging.
    List<String> optFields = Arrays.asList(); // List<String> | Defines fields to return. Some requests return *compact* representations of objects in order to conserve resources and complete the request more efficiently. Other times requests return more information than you may need. This option allows you to list the exact set of fields that the API should be sure to return for the objects. The field names should be provided as paths, described below. The id of included objects will always be returned, regardless of the field options.
    InsertEnumOptionForCustomFieldRequest insertEnumOptionForCustomFieldRequest = new InsertEnumOptionForCustomFieldRequest(); // InsertEnumOptionForCustomFieldRequest | The enum option object to create.
    try {
...
# **updateCustomField**
> CreateCustomField201Response updateCustomField(customFieldGid, optPretty, optFields, createCustomFieldRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    Boolean optPretty = true; // Boolean | Provides “pretty” output. Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging.
    List<String> optFields = Arrays.asList(); // List<String> | Defines fields to return. Some requests return *compact* representations of objects in order to conserve resources and complete the request more efficiently. Other times requests return more information than you may need. This option allows you to list the exact set of fields that the API should be sure to return for the objects. The field names should be provided as paths, described below. The id of included objects will always be returned, regardless of the field options.
    CreateCustomFieldRequest createCustomFieldRequest = new CreateCustomFieldRequest(); // CreateCustomFieldRequest | The custom field object with all updated properties.
    try {
...
# **updateEnumOption**
> CreateEnumOptionForCustomField201Response updateEnumOption(enumOptionGid, optPretty, optFields, createEnumOptionForCustomFieldRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    CustomFieldsApi apiInstance = new CustomFieldsApi(defaultClient);
    String enumOptionGid = "124578"; // String | Globally unique identifier for the enum option.
    Boolean optPretty = true; // Boolean | Provides “pretty” output. Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging.
    List<String> optFields = Arrays.asList(); // List<String> | Defines fields to return. Some requests return *compact* representations of objects in order to conserve resources and complete the request more efficiently. Other times requests return more information than you may need. This option allows you to list the exact set of fields that the API should be sure to return for the objects. The field names should be provided as paths, described below. The id of included objects will always be returned, regardless of the field options.
    CreateEnumOptionForCustomFieldRequest createEnumOptionForCustomFieldRequest = new CreateEnumOptionForCustomFieldRequest(); // CreateEnumOptionForCustomFieldRequest | The enum option object to update
    try {
