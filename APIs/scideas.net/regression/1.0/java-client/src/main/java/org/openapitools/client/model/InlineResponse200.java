...
public class InlineResponse200 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(InlineResponse200.class.getName());
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>) new TypeAdapter<InlineResponse200>() {
                ...
                public void write(JsonWriter out, InlineResponse200 value) throws IOException {
                    ...
                    throw new IOException("Failed to serialize as the type doesn't match oneOf schemas: Error, Result");
                }
                ...
                public InlineResponse200 read(JsonReader in) throws IOException {
                    ...
                    throw new IOException(String.format("Failed deserialization for InlineResponse200: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public InlineResponse200(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return InlineResponse200.schemas;
    }
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be Error, Result");
    }
     ...
     * Error, Result
     *
     * @return The actual instance (Error, Result)
     */
    @SuppressWarnings("unchecked")
    @Override
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for InlineResponse200 with oneOf schemas: Error, Result. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }
