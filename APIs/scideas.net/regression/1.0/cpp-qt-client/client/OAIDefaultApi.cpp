...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("regressionApiPost", defaultConf);
    _serverIndices.insert("regressionApiPost", 0);
}
...
void OAIDefaultApi::regressionApiPost(const OAIRegression_api_body &oai_regression_api_body) {
    QString fullPath = QString(_serverConfigs["regressionApiPost"][_serverIndices.value("regressionApiPost")].URL()+"/regression/api");
...

    {
        ...
        QByteArray output = oai_regression_api_body.asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::regressionApiPostCallback);
...
void OAIDefaultApi::regressionApiPostCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT regressionApiPostSignal(output);
        Q_EMIT regressionApiPostSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT regressionApiPostSignalE(output, error_type, error_str);
        Q_EMIT regressionApiPostSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT regressionApiPostSignalError(output, error_type, error_str);
        Q_EMIT regressionApiPostSignalErrorFull(worker, error_type, error_str);
    }
}
