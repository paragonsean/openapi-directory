...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("https://services.scideas.net"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("perfectpdfApiPost", defaultConf);
    _serverIndices.insert("perfectpdfApiPost", 0);
}
...
void OAIDefaultApi::perfectpdfApiPost(const OAIPerfectpdf_api_body &oai_perfectpdf_api_body) {
    QString fullPath = QString(_serverConfigs["perfectpdfApiPost"][_serverIndices.value("perfectpdfApiPost")].URL()+"/perfectpdf/api");
...

    {
        ...
        QByteArray output = oai_perfectpdf_api_body.asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::perfectpdfApiPostCallback);
...
void OAIDefaultApi::perfectpdfApiPostCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT perfectpdfApiPostSignal(output);
        Q_EMIT perfectpdfApiPostSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT perfectpdfApiPostSignalE(output, error_type, error_str);
        Q_EMIT perfectpdfApiPostSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT perfectpdfApiPostSignalError(output, error_type, error_str);
        Q_EMIT perfectpdfApiPostSignalErrorFull(worker, error_type, error_str);
    }
}
