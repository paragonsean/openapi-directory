...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.expect, root.PerfectpdfApi);
  }
}(this, function(expect, PerfectpdfApi) {
  'use strict';

  var instance;

  beforeEach(function() {
    instance = new PerfectpdfApi.InlineResponse200();
  });
  ...
  describe('InlineResponse200', function() {
    it('should create an instance of InlineResponse200', function() {
      ...
      //var instance = new PerfectpdfApi.InlineResponse200();
      //expect(instance).to.be.a(PerfectpdfApi.InlineResponse200);
    });
