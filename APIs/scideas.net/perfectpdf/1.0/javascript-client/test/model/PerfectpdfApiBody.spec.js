...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PerfectpdfApi.PerfectpdfApiBody();
  });
  ...
  describe('PerfectpdfApiBody', function() {
    it('should create an instance of PerfectpdfApiBody', function() {
      // uncomment below and update the code to test PerfectpdfApiBody
      //var instance = new PerfectpdfApi.PerfectpdfApiBody();
      //expect(instance).to.be.a(PerfectpdfApi.PerfectpdfApiBody);
    });
