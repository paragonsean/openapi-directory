...
perfectpdf api
- API version: 1.0
  - Build date: 2024-10-12T11:25:47.217172-04:00[America/New_York]
...
------------ | ------------- | ------------- | -------------
*DefaultApi* | [**perfectpdfApiPost**](docs/DefaultApi.md#perfectpdfApiPost) | **POST** /perfectpdf/api | Returns PDF document.


## Documentation for Models

 - [InlineResponse200](docs/InlineResponse200.md)
 - [PerfectpdfApiBody](docs/PerfectpdfApiBody.md)
