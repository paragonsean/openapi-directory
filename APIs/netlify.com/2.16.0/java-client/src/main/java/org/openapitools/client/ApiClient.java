...
public class ApiClient {
    ...
    private String basePath = "https://api.netlify.com/api/v1";
    ...
    public ApiClient() {
        ...
        authentications.put("netlifyAuth", new OAuth());
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2.16.0/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.netlify.com/api/v1
