...
#ifndef OAIPluginRunData_H
#define OAIPluginRunData_H
...
class OAIPluginRunData : public OAIObject {
public:
    OAIPluginRunData();
    OAIPluginRunData(QString json);
    ~OAIPluginRunData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPluginRunData)

#endif // OAIPluginRunData_H
