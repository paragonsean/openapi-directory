...
Q_SIGNALS:
    ...
    void getCurrentUserSignal(QList<OAIUser> summary);


    void getCurrentUserSignalFull(OAIHttpRequestWorker *worker, QList<OAIUser> summary);

    Q_DECL_DEPRECATED_X("Use getCurrentUserSignalError() instead")
    void getCurrentUserSignalE(QList<OAIUser> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getCurrentUserSignalError(QList<OAIUser> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
