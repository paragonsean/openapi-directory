...
void Example::exampleFunction1(){
     OAIAccessTokenApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIAccessTokenApi::exchangeTicketSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIAccessTokenApi::exchangeTicketSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      QString ticket_id = create(); // QString | 
      apiInstance.exchangeTicket(ticket_id);
