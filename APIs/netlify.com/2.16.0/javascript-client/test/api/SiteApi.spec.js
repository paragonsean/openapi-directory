...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetlifysApiDocumentation.SiteApi();
  });
  ...
  describe('SiteApi', function() {
    ...
    describe('unlinkSiteRepo', function() {
      it('should call unlinkSiteRepo successfully', function(done) {
        //uncomment below and update the code to test unlinkSiteRepo
        //instance.unlinkSiteRepo(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
