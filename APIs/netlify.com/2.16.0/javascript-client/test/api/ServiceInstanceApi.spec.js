...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetlifysApiDocumentation.ServiceInstanceApi();
  });
  ...
  describe('ServiceInstanceApi', function() {
    ...
    describe('deleteServiceInstance', function() {
      it('should call deleteServiceInstance successfully', function(done) {
        //uncomment below and update the code to test deleteServiceInstance
        //instance.deleteServiceInstance(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('listServiceInstancesForSite', function() {
      it('should call listServiceInstancesForSite successfully', function(done) {
        //uncomment below and update the code to test listServiceInstancesForSite
        //instance.listServiceInstancesForSite(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
