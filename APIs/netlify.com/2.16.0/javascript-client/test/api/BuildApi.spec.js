...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetlifysApiDocumentation.BuildApi();
  });
  ...
  describe('BuildApi', function() {
    describe('createSiteBuild', function() {
      it('should call createSiteBuild successfully', function(done) {
        //uncomment below and update the code to test createSiteBuild
        //instance.createSiteBuild(function(error) {
    ...
    describe('getAccountBuildStatus', function() {
      it('should call getAccountBuildStatus successfully', function(done) {
        //uncomment below and update the code to test getAccountBuildStatus
        //instance.getAccountBuildStatus(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
