...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetlifysApiDocumentation.FormApi();
  });
  ...
  describe('FormApi', function() {
    describe('deleteSiteForm', function() {
      it('should call deleteSiteForm successfully', function(done) {
        //uncomment below and update the code to test deleteSiteForm
        //instance.deleteSiteForm(function(error) {
