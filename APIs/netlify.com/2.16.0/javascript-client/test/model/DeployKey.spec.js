...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetlifysApiDocumentation.DeployKey();
  });
  ...
  describe('DeployKey', function() {
    it('should create an instance of DeployKey', function() {
      ...
      //var instance = new NetlifysApiDocumentation.DeployKey();
      //expect(instance).to.be.a(NetlifysApiDocumentation.DeployKey);
    });
