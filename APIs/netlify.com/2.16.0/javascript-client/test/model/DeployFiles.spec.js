...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetlifysApiDocumentation.DeployFiles();
  });
  ...
  describe('DeployFiles', function() {
    it('should create an instance of DeployFiles', function() {
      // uncomment below and update the code to test DeployFiles
      //var instance = new NetlifysApiDocumentation.DeployFiles();
      //expect(instance).to.be.a(NetlifysApiDocumentation.DeployFiles);
    });
    ...
    it('should have the property functionsConfig (base name: "functions_config")', function() {
      // uncomment below and update the code to test the property functionsConfig
      //var instance = new NetlifysApiDocumentation.DeployFiles();
      //expect(instance).to.be();
    });
