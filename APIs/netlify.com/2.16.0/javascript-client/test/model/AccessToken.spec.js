...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetlifysApiDocumentation.AccessToken();
  });
  ...
  describe('AccessToken', function() {
    it('should create an instance of AccessToken', function() {
      ...
      //var instance = new NetlifysApiDocumentation.AccessToken();
      //expect(instance).to.be.a(NetlifysApiDocumentation.AccessToken);
    });
