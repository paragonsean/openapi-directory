...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetlifysApiDocumentation.AuditLog();
  });
  ...
  describe('AuditLog', function() {
    it('should create an instance of AuditLog', function() {
      ...
      //var instance = new NetlifysApiDocumentation.AuditLog();
      //expect(instance).to.be.a(NetlifysApiDocumentation.AuditLog);
    });
