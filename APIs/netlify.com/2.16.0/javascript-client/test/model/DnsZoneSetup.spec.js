...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetlifysApiDocumentation.DnsZoneSetup();
  });
  ...
  describe('DnsZoneSetup', function() {
    it('should create an instance of DnsZoneSetup', function() {
      // uncomment below and update the code to test DnsZoneSetup
      //var instance = new NetlifysApiDocumentation.DnsZoneSetup();
      //expect(instance).to.be.a(NetlifysApiDocumentation.DnsZoneSetup);
    });
