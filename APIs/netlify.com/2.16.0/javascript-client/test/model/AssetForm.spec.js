...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetlifysApiDocumentation.AssetForm();
  });
  ...
  describe('AssetForm', function() {
    it('should create an instance of AssetForm', function() {
      ...
      //var instance = new NetlifysApiDocumentation.AssetForm();
      //expect(instance).to.be.a(NetlifysApiDocumentation.AssetForm);
    });
