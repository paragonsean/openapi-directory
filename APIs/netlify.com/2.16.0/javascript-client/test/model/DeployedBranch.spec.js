...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetlifysApiDocumentation.DeployedBranch();
  });
  ...
  describe('DeployedBranch', function() {
    it('should create an instance of DeployedBranch', function() {
      ...
      //var instance = new NetlifysApiDocumentation.DeployedBranch();
      //expect(instance).to.be.a(NetlifysApiDocumentation.DeployedBranch);
    });
