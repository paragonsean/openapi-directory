...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetlifysApiDocumentation.DnsRecordCreate();
  });
  ...
  describe('DnsRecordCreate', function() {
    it('should create an instance of DnsRecordCreate', function() {
      // uncomment below and update the code to test DnsRecordCreate
      //var instance = new NetlifysApiDocumentation.DnsRecordCreate();
      //expect(instance).to.be.a(NetlifysApiDocumentation.DnsRecordCreate);
    });
