...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetlifysApiDocumentation.AssetSignature();
  });
  ...
  describe('AssetSignature', function() {
    it('should create an instance of AssetSignature', function() {
      ...
      //var instance = new NetlifysApiDocumentation.AssetSignature();
      //expect(instance).to.be.a(NetlifysApiDocumentation.AssetSignature);
    });
