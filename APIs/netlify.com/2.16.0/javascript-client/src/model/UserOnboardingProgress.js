...
class UserOnboardingProgress {
    ...
    constructor() { 
        ...
        UserOnboardingProgress.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UserOnboardingProgress();
    ...
    /**
     * Validates the JSON data with respect to <code>UserOnboardingProgress</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UserOnboardingProgress</code>.
     */
    static validateJSON(data) {
        // ensure the json data is a string
        if (data['slides'] && !(typeof data['slides'] === 'string' || data['slides'] instanceof String)) {
            throw new Error("Expected the field `slides` to be a primitive type in the JSON string but got " + data['slides']);
        }
 ...
 */
UserOnboardingProgress.prototype['slides'] = undefined;
...
export default UserOnboardingProgress;
