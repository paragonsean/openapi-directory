...
class SiteProcessingSettingsImages {
    ...
    constructor() { 
        ...
        SiteProcessingSettingsImages.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SiteProcessingSettingsImages();
    ...
    /**
     * Validates the JSON data with respect to <code>SiteProcessingSettingsImages</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SiteProcessingSettingsImages</code>.
     */
 ...
 */
SiteProcessingSettingsImages.prototype['optimize'] = undefined;
...
export default SiteProcessingSettingsImages;
