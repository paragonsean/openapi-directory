...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MineSkinApi.UserValidation();
  });
  ...
  describe('UserValidation', function() {
    it('should create an instance of UserValidation', function() {
      // uncomment below and update the code to test UserValidation
      //var instance = new MineSkinApi.UserValidation();
      //expect(instance).to.be.a(MineSkinApi.UserValidation);
    });
