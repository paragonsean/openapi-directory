...
/*
 * OAIPartialSkinInfo.h
 *
 * 
 */

#ifndef OAIPartialSkinInfo_H
#define OAIPartialSkinInfo_H
...
class OAIPartialSkinInfo : public OAIObject {
public:
    OAIPartialSkinInfo();
    OAIPartialSkinInfo(QString json);
    ~OAIPartialSkinInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPartialSkinInfo)

#endif // OAIPartialSkinInfo_H
