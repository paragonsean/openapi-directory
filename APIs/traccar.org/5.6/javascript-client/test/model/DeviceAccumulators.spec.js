...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Traccar.DeviceAccumulators();
  });
  ...
  describe('DeviceAccumulators', function() {
    it('should create an instance of DeviceAccumulators', function() {
      // uncomment below and update the code to test DeviceAccumulators
      //var instance = new Traccar.DeviceAccumulators();
      //expect(instance).to.be.a(Traccar.DeviceAccumulators);
    });
