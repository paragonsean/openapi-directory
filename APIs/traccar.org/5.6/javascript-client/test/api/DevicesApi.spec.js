...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Traccar.DevicesApi();
  });
  ...
  describe('DevicesApi', function() {
    ...
    describe('devicesIdAccumulatorsPut', function() {
      it('should call devicesIdAccumulatorsPut successfully', function(done) {
        //uncomment below and update the code to test devicesIdAccumulatorsPut
        //instance.devicesIdAccumulatorsPut(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
