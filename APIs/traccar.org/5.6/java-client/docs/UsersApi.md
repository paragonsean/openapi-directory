...
public class Example {
  public static void main(String[] args) {
    ...
    String userId = "userId_example"; // String | Can only be used by admin or manager users
    try {
      List<User> result = apiInstance.usersGet(userId);
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      User result = apiInstance.usersIdPut(id, body);
      System.out.println(result);
    } catch (ApiException e) {
