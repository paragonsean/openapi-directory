...
public class ApiClient {
    ...
    private String basePath = "https://demo.traccar.org/api";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/5.6/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://demo.traccar.org/api
