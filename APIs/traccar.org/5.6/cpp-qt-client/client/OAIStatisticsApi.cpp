...
void OAIStatisticsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("statisticsGet", defaultConf);
    _serverIndices.insert("statisticsGet", 0);
}
...
void OAIStatisticsApi::statisticsGet(const QDateTime &from, const QDateTime &to) {
    QString fullPath = QString(_serverConfigs["statisticsGet"][_serverIndices.value("statisticsGet")].URL()+"/statistics");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIStatisticsApi::statisticsGetCallback);
...
void OAIStatisticsApi::statisticsGetCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT statisticsGetSignal(output);
        Q_EMIT statisticsGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT statisticsGetSignalE(output, error_type, error_str);
        Q_EMIT statisticsGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT statisticsGetSignalError(output, error_type, error_str);
        Q_EMIT statisticsGetSignalErrorFull(worker, error_type, error_str);
    }
}
