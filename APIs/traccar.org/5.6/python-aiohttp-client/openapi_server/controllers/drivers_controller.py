...
async def drivers_get(request: web.Request, all=None, user_id=None, device_id=None, group_id=None, refresh=None) -> web.Response:
...
async def drivers_id_delete(request: web.Request, id) -> web.Response:
    """Delete a Driver
...
async def drivers_id_put(request: web.Request, id, body) -> web.Response:
    """Update a Driver
    ...
    """
    body = Driver.from_dict(body)
    return web.Response(status=200)


async def drivers_post(request: web.Request, body) -> web.Response:
    """Create a Driver
