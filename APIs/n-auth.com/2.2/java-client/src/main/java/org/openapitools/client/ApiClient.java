...
public class ApiClient {
    ...
    private String basePath = "https://api.nextauth.com";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api.nextauth.com",
    ...
    public ApiClient() {
        ...
        authentications.put("api_key", new ApiKeyAuth("header", "X-apikey"));
        authentications.put("role_id", new ApiKeyAuth("header", "X-su"));
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2.2/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.nextauth.com
