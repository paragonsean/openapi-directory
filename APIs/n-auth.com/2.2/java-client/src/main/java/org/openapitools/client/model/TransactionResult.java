...
public class TransactionResult {
  public static final String SERIALIZED_NAME_TSTATUS = "tstatus";
  @SerializedName(SERIALIZED_NAME_TSTATUS)
  private String tstatus;

  public TransactionResult() {
  }

  public TransactionResult tstatus(String tstatus) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tstatus, transactionResult.tstatus);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tstatus);
  }
  ...
  public String toString() {
    ...
    sb.append("    tstatus: ").append(toIndentedString(tstatus)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TransactionResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TransactionResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TransactionResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("tstatus") != null && !jsonObj.get("tstatus").isJsonNull()) && !jsonObj.get("tstatus").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `tstatus` to be a primitive type in the JSON string but got `%s`", jsonObj.get("tstatus").toString()));
      }
  }
