...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NextAuthApi.TransactionsApi();
  });
  ...
  describe('TransactionsApi', function() {
    ...
    describe('getTransactionResult', function() {
      it('should call getTransactionResult successfully', function(done) {
        //uncomment below and update the code to test getTransactionResult
        //instance.getTransactionResult(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
