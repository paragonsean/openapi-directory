...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.nextauth.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.nextauth.com
         */
        ...
        this.authentications = {
            'api_key': {type: 'apiKey', 'in': 'header', name: 'X-apikey'},
            'role_id': {type: 'apiKey', 'in': 'header', name: 'X-su'}
        }
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2.2/Javascript'
        };
