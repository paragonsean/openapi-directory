...
public class Example {
  public static void main(String[] args) {
    ...
    PartnerUpsert partnerUpsert = new PartnerUpsert(); // PartnerUpsert | PartnerUpsert object that you would like to store.
    try {
      Partner result = apiInstance.createPartner(partnerUpsert);
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      PartnerList result = apiInstance.listPartner(page, perPage);
      System.out.println(result);
    } catch (ApiException e) {
...
public class Example {
  public static void main(String[] args) {
    ...
    PartnerApi apiInstance = new PartnerApi(defaultClient);
    Integer id = 56; // Integer | 
    PartnerUpsert partnerUpsert = new PartnerUpsert(); // PartnerUpsert | Partner object that you would like to update.
    try {
      Partner result = apiInstance.updatePartner(id, partnerUpsert);
      System.out.println(result);
    } catch (ApiException e) {
