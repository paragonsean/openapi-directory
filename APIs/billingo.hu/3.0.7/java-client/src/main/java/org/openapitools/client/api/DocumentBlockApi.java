...
public class DocumentBlockApi {
     ...
     */
    public okhttp3.Call listDocumentBlockCall(Integer page, Integer perPage, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call listDocumentBlockValidateBeforeCall(Integer page, Integer perPage, final ApiCallback _callback) throws ApiException {
        return listDocumentBlockCall(page, perPage, _callback);
     ...
     */
    public DocumentBlockList listDocumentBlock(Integer page, Integer perPage) throws ApiException {
        ApiResponse<DocumentBlockList> localVarResp = listDocumentBlockWithHttpInfo(page, perPage);
     ...
     */
    public ApiResponse<DocumentBlockList> listDocumentBlockWithHttpInfo(Integer page, Integer perPage) throws ApiException {
        okhttp3.Call localVarCall = listDocumentBlockValidateBeforeCall(page, perPage, null);
     ...
     */
    public okhttp3.Call listDocumentBlockAsync(Integer page, Integer perPage, final ApiCallback<DocumentBlockList> _callback) throws ApiException {

        okhttp3.Call localVarCall = listDocumentBlockValidateBeforeCall(page, perPage, _callback);
        Type localVarReturnType = new TypeToken<DocumentBlockList>(){}.getType();
