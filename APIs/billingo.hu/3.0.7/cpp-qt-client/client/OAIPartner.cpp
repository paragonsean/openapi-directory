...
QString OAIPartner::getAccountNumber() const {
    return m_account_number;
}
void OAIPartner::setAccountNumber(const QString &account_number) {
    m_account_number = account_number;
    m_account_number_isSet = true;
}

bool OAIPartner::is_account_number_Set() const{
    return m_account_number_isSet;
}

bool OAIPartner::is_account_number_Valid() const{
    return m_account_number_isValid;
}

OAIAddress OAIPartner::getAddress() const {
    return m_address;
}
void OAIPartner::setAddress(const OAIAddress &address) {
    m_address = address;
    m_address_isSet = true;
}

bool OAIPartner::is_address_Set() const{
    return m_address_isSet;
}

bool OAIPartner::is_address_Valid() const{
    return m_address_isValid;
}

QList<QString> OAIPartner::getEmails() const {
    return m_emails;
}
void OAIPartner::setEmails(const QList<QString> &emails) {
    m_emails = emails;
    m_emails_isSet = true;
}

bool OAIPartner::is_emails_Set() const{
    return m_emails_isSet;
}

bool OAIPartner::is_emails_Valid() const{
    return m_emails_isValid;
}

QString OAIPartner::getGeneralLedgerNumber() const {
    return m_general_ledger_number;
}
void OAIPartner::setGeneralLedgerNumber(const QString &general_ledger_number) {
    m_general_ledger_number = general_ledger_number;
    m_general_ledger_number_isSet = true;
}

bool OAIPartner::is_general_ledger_number_Set() const{
    return m_general_ledger_number_isSet;
}

bool OAIPartner::is_general_ledger_number_Valid() const{
    return m_general_ledger_number_isValid;
}

QString OAIPartner::getIban() const {
    return m_iban;
}
void OAIPartner::setIban(const QString &iban) {
    m_iban = iban;
    m_iban_isSet = true;
}

bool OAIPartner::is_iban_Set() const{
    return m_iban_isSet;
}

bool OAIPartner::is_iban_Valid() const{
...
QString OAIPartner::getPhone() const {
    return m_phone;
}
void OAIPartner::setPhone(const QString &phone) {
    m_phone = phone;
    m_phone_isSet = true;
}

bool OAIPartner::is_phone_Set() const{
    return m_phone_isSet;
}

bool OAIPartner::is_phone_Valid() const{
    return m_phone_isValid;
}

QString OAIPartner::getSwift() const {
    return m_swift;
}
void OAIPartner::setSwift(const QString &swift) {
    m_swift = swift;
    m_swift_isSet = true;
}

bool OAIPartner::is_swift_Set() const{
    return m_swift_isSet;
}

bool OAIPartner::is_swift_Valid() const{
    return m_swift_isValid;
}

QString OAIPartner::getTaxcode() const {
    return m_taxcode;
}
void OAIPartner::setTaxcode(const QString &taxcode) {
    m_taxcode = taxcode;
    m_taxcode_isSet = true;
}

bool OAIPartner::is_taxcode_Set() const{
    return m_taxcode_isSet;
}

bool OAIPartner::is_taxcode_Valid() const{
    return m_taxcode_isValid;
}

qint32 OAIPartner::getId() const {
    return m_id;
}
void OAIPartner::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}
