...
#ifndef OAIBankAccountList_H
#define OAIBankAccountList_H
...
class OAIBankAccountList : public OAIObject {
public:
    OAIBankAccountList();
    OAIBankAccountList(QString json);
    ~OAIBankAccountList() override;
    ...
    QList<OAIBankAccount> getData() const;
    void setData(const QList<OAIBankAccount> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIBankAccountList)

#endif // OAIBankAccountList_H
