...
public:
    ...
    */
    virtual void getId(const qint32 &id);
...
Q_SIGNALS:
    ...
    void getIdSignal(OAIId summary);


    void getIdSignalFull(OAIHttpRequestWorker *worker, OAIId summary);

    Q_DECL_DEPRECATED_X("Use getIdSignalError() instead")
    void getIdSignalE(OAIId summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getIdSignalError(OAIId summary, QNetworkReply::NetworkError error_type, const QString &error_str);
