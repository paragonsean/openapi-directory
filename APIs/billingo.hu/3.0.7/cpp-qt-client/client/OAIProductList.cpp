...
qint32 OAIProductList::getCurrentPage() const {
    return m_current_page;
}
void OAIProductList::setCurrentPage(const qint32 &current_page) {
    m_current_page = current_page;
    m_current_page_isSet = true;
}

bool OAIProductList::is_current_page_Set() const{
    return m_current_page_isSet;
}

bool OAIProductList::is_current_page_Valid() const{
    return m_current_page_isValid;
}

QList<OAIProduct> OAIProductList::getData() const {
    return m_data;
}
void OAIProductList::setData(const QList<OAIProduct> &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIProductList::is_data_Set() const{
    return m_data_isSet;
}

bool OAIProductList::is_data_Valid() const{
    return m_data_isValid;
}

qint32 OAIProductList::getLastPage() const {
    return m_last_page;
}
void OAIProductList::setLastPage(const qint32 &last_page) {
    m_last_page = last_page;
    m_last_page_isSet = true;
}

bool OAIProductList::is_last_page_Set() const{
    return m_last_page_isSet;
}

bool OAIProductList::is_last_page_Valid() const{
    return m_last_page_isValid;
}

QString OAIProductList::getNextPageUrl() const {
    return m_next_page_url;
}
void OAIProductList::setNextPageUrl(const QString &next_page_url) {
    m_next_page_url = next_page_url;
    m_next_page_url_isSet = true;
}

bool OAIProductList::is_next_page_url_Set() const{
    return m_next_page_url_isSet;
}

bool OAIProductList::is_next_page_url_Valid() const{
    return m_next_page_url_isValid;
}

qint32 OAIProductList::getPerPage() const {
    return m_per_page;
}
void OAIProductList::setPerPage(const qint32 &per_page) {
    m_per_page = per_page;
    m_per_page_isSet = true;
}

bool OAIProductList::is_per_page_Set() const{
    return m_per_page_isSet;
}

bool OAIProductList::is_per_page_Valid() const{
    return m_per_page_isValid;
}

QString OAIProductList::getPrevPageUrl() const {
    return m_prev_page_url;
}
void OAIProductList::setPrevPageUrl(const QString &prev_page_url) {
    m_prev_page_url = prev_page_url;
    m_prev_page_url_isSet = true;
}

bool OAIProductList::is_prev_page_url_Set() const{
    return m_prev_page_url_isSet;
}

bool OAIProductList::is_prev_page_url_Valid() const{
    return m_prev_page_url_isValid;
}

qint32 OAIProductList::getTotal() const {
    return m_total;
}
void OAIProductList::setTotal(const qint32 &total) {
    m_total = total;
    m_total_isSet = true;
}

bool OAIProductList::is_total_Set() const{
    return m_total_isSet;
}

bool OAIProductList::is_total_Valid() const{
