...
OAIPartnerList::OAIPartnerList(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPartnerList::OAIPartnerList() {
    this->initializeModel();
}

OAIPartnerList::~OAIPartnerList() {}

void OAIPartnerList::initializeModel() {
...
void OAIPartnerList::fromJson(QString jsonString) {
...
void OAIPartnerList::fromJsonObject(QJsonObject json) {
...
QString OAIPartnerList::asJson() const {
...
QJsonObject OAIPartnerList::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIPartnerList::getCurrentPage() const {
    return m_current_page;
}
void OAIPartnerList::setCurrentPage(const qint32 &current_page) {
    m_current_page = current_page;
    m_current_page_isSet = true;
}

bool OAIPartnerList::is_current_page_Set() const{
    return m_current_page_isSet;
}

bool OAIPartnerList::is_current_page_Valid() const{
    return m_current_page_isValid;
}

QList<OAIPartner> OAIPartnerList::getData() const {
    return m_data;
}
void OAIPartnerList::setData(const QList<OAIPartner> &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIPartnerList::is_data_Set() const{
    return m_data_isSet;
}

bool OAIPartnerList::is_data_Valid() const{
    return m_data_isValid;
}

qint32 OAIPartnerList::getLastPage() const {
    return m_last_page;
}
void OAIPartnerList::setLastPage(const qint32 &last_page) {
    m_last_page = last_page;
    m_last_page_isSet = true;
}

bool OAIPartnerList::is_last_page_Set() const{
    return m_last_page_isSet;
}

bool OAIPartnerList::is_last_page_Valid() const{
    return m_last_page_isValid;
}

QString OAIPartnerList::getNextPageUrl() const {
    return m_next_page_url;
}
void OAIPartnerList::setNextPageUrl(const QString &next_page_url) {
    m_next_page_url = next_page_url;
    m_next_page_url_isSet = true;
}

bool OAIPartnerList::is_next_page_url_Set() const{
    return m_next_page_url_isSet;
}

bool OAIPartnerList::is_next_page_url_Valid() const{
    return m_next_page_url_isValid;
}

qint32 OAIPartnerList::getPerPage() const {
    return m_per_page;
}
void OAIPartnerList::setPerPage(const qint32 &per_page) {
    m_per_page = per_page;
    m_per_page_isSet = true;
}

bool OAIPartnerList::is_per_page_Set() const{
    return m_per_page_isSet;
}

bool OAIPartnerList::is_per_page_Valid() const{
    return m_per_page_isValid;
}

QString OAIPartnerList::getPrevPageUrl() const {
    return m_prev_page_url;
}
void OAIPartnerList::setPrevPageUrl(const QString &prev_page_url) {
    m_prev_page_url = prev_page_url;
    m_prev_page_url_isSet = true;
}

bool OAIPartnerList::is_prev_page_url_Set() const{
    return m_prev_page_url_isSet;
}

bool OAIPartnerList::is_prev_page_url_Valid() const{
    return m_prev_page_url_isValid;
}

qint32 OAIPartnerList::getTotal() const {
    return m_total;
}
void OAIPartnerList::setTotal(const qint32 &total) {
    m_total = total;
    m_total_isSet = true;
}

bool OAIPartnerList::is_total_Set() const{
    return m_total_isSet;
}

bool OAIPartnerList::is_total_Valid() const{
    return m_total_isValid;
}

bool OAIPartnerList::isSet() const {
...
bool OAIPartnerList::isValid() const {
