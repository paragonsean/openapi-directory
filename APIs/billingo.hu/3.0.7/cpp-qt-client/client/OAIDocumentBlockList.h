...
#ifndef OAIDocumentBlockList_H
#define OAIDocumentBlockList_H
...
namespace OpenAPI {
class OAIDocumentBlock;

class OAIDocumentBlockList : public OAIObject {
public:
    OAIDocumentBlockList();
    OAIDocumentBlockList(QString json);
    ~OAIDocumentBlockList() override;
    ...
    QList<OAIDocumentBlock> getData() const;
    void setData(const QList<OAIDocumentBlock> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIDocumentBlockList)

#endif // OAIDocumentBlockList_H
