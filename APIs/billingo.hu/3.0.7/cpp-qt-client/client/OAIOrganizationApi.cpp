...
void OAIOrganizationApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("getOrganizationData", defaultConf);
    _serverIndices.insert("getOrganizationData", 0);
}
...
void OAIOrganizationApi::getOrganizationData() {
    QString fullPath = QString(_serverConfigs["getOrganizationData"][_serverIndices.value("getOrganizationData")].URL()+"/organization");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIOrganizationApi::getOrganizationDataCallback);
...
void OAIOrganizationApi::getOrganizationDataCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIOrganizationData output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getOrganizationDataSignal(output);
        Q_EMIT getOrganizationDataSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getOrganizationDataSignalE(output, error_type, error_str);
        Q_EMIT getOrganizationDataSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getOrganizationDataSignalError(output, error_type, error_str);
        Q_EMIT getOrganizationDataSignalErrorFull(worker, error_type, error_str);
    }
}
