...
* @version 3.0.7
*/
export default class DocumentBlockApi {
    ...
    */
     ...
     * @callback module:api/DocumentBlockApi~listDocumentBlockCallback
     ...
     * data is of type: {@link module:model/DocumentBlockList}
     */
