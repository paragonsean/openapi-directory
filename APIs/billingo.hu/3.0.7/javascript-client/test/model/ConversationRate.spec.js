...
(function(root, factory) {
  ...
  describe('ConversationRate', function() {
    it('should create an instance of ConversationRate', function() {
      // uncomment below and update the code to test ConversationRate
      //var instance = new BillingoApiV3.ConversationRate();
    ...
    it('should have the property conversationRate (base name: "conversation_rate")', function() {
      // uncomment below and update the code to test the property conversationRate
      //var instance = new BillingoApiV3.ConversationRate();
      //expect(instance).to.be();
    });

    it('should have the property fromCurrency (base name: "from_currency")', function() {
      // uncomment below and update the code to test the property fromCurrency
      //var instance = new BillingoApiV3.ConversationRate();
      //expect(instance).to.be();
    });

    it('should have the property toCurrency (base name: "to_currency")', function() {
      // uncomment below and update the code to test the property toCurrency
      //var instance = new BillingoApiV3.ConversationRate();
      //expect(instance).to.be();
    });
