...
(function(root, factory) {
  ...
  describe('DocumentInsertType', function() {
    it('should create an instance of DocumentInsertType', function() {
      // uncomment below and update the code to test DocumentInsertType
      //var instance = new BillingoApiV3.DocumentInsertType();
      //expect(instance).to.be.a(BillingoApiV3.DocumentInsertType);
    });
