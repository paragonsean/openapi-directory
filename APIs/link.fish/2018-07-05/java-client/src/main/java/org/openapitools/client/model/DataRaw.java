...
public class DataRaw {
  ...
  public DataRaw data(Object data) {
    this.data = data;
    return this;
  }
  ...
  public DataRaw sourceFormat(String sourceFormat) {
  ...
  public DataRaw statusCode(String statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    DataRaw dataRaw = (DataRaw) o;
    return Objects.equals(this.data, dataRaw.data) &&
        Objects.equals(this.sourceFormat, dataRaw.sourceFormat) &&
        Objects.equals(this.statusCode, dataRaw.statusCode) &&
        Objects.equals(this.url, dataRaw.url);
  }

  @Override
  public int hashCode() {
    return Objects.hash(data, sourceFormat, statusCode, url);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DataRaw {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DataRaw
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DataRaw.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DataRaw is not found in the empty JSON string", DataRaw.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DataRaw.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DataRaw` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DataRaw.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DataRaw.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DataRaw' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DataRaw> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DataRaw.class));

       return (TypeAdapter<T>) new TypeAdapter<DataRaw>() {
           @Override
           public void write(JsonWriter out, DataRaw value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DataRaw read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DataRaw given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DataRaw
   * @throws IOException if the JSON string is invalid with respect to DataRaw
   */
  public static DataRaw fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DataRaw.class);
  }

  /**
   * Convert an instance of DataRaw to an JSON string
   *
   * @return JSON string
   */
