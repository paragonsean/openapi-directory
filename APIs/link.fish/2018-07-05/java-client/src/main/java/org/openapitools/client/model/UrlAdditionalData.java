...
import org.openapitools.client.model.UrlAdditionalDataLocality;
...
public class UrlAdditionalData {
  public static final String SERIALIZED_NAME_LOCALITY = "locality";
  @SerializedName(SERIALIZED_NAME_LOCALITY)
  private UrlAdditionalDataLocality locality;

  public UrlAdditionalData() {
  }

  public UrlAdditionalData locality(UrlAdditionalDataLocality locality) {
  ...
  public UrlAdditionalDataLocality getLocality() {
    return locality;
  }

  public void setLocality(UrlAdditionalDataLocality locality) {
    this.locality = locality;
  }
  ...
  public boolean equals(Object o) {
    ...
    UrlAdditionalData urlAdditionalData = (UrlAdditionalData) o;
    return Objects.equals(this.locality, urlAdditionalData.locality);
  }
  ...
  public String toString() {
    ...
    sb.append("class UrlAdditionalData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UrlAdditionalData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UrlAdditionalData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UrlAdditionalData is not found in the empty JSON string", UrlAdditionalData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UrlAdditionalData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UrlAdditionalData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `locality`
      if (jsonObj.get("locality") != null && !jsonObj.get("locality").isJsonNull()) {
        UrlAdditionalDataLocality.validateJsonElement(jsonObj.get("locality"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UrlAdditionalData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UrlAdditionalData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UrlAdditionalData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UrlAdditionalData.class));

       return (TypeAdapter<T>) new TypeAdapter<UrlAdditionalData>() {
           @Override
           public void write(JsonWriter out, UrlAdditionalData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UrlAdditionalData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UrlAdditionalData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UrlAdditionalData
   * @throws IOException if the JSON string is invalid with respect to UrlAdditionalData
   */
  public static UrlAdditionalData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UrlAdditionalData.class);
  }

  /**
   * Convert an instance of UrlAdditionalData to an JSON string
   *
   * @return JSON string
   */
