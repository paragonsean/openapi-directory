...
public class Apps {
  ...
  public Apps android(String android) {
  ...
  public boolean equals(Object o) {
    ...
    Apps apps = (Apps) o;
    return Objects.equals(this.android, apps.android) &&
        Objects.equals(this.ios, apps.ios) &&
        Objects.equals(this.url, apps.url);
  }

  @Override
  public int hashCode() {
    return Objects.hash(android, ios, url);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Apps.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Apps is not found in the empty JSON string", Apps.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Apps.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Apps` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Apps.openapiRequiredFields) {
