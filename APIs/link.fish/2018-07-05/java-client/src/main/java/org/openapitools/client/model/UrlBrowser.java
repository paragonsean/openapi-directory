...
public class UrlBrowser {
  ...
  public UrlBrowser additionalData(UrlAdditionalData additionalData) {
  ...
  public UrlBrowser favicon(String favicon) {
  ...
  public UrlBrowser items(List<UrlItemsInner> items) {
    this.items = items;
    return this;
  }

  public UrlBrowser addItemsItem(UrlItemsInner itemsItem) {
    if (this.items == null) {
  ...
  public UrlBrowser screenshot(byte[] screenshot) {
  ...
  public UrlBrowser statusCode(String statusCode) {
  ...
  public UrlBrowser title(String title) {
    this.title = title;
    return this;
  }
  ...
  public UrlBrowser url(String url) {
    this.url = url;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    UrlBrowser urlBrowser = (UrlBrowser) o;
    return Objects.equals(this.additionalData, urlBrowser.additionalData) &&
        Objects.equals(this.favicon, urlBrowser.favicon) &&
        Objects.equals(this.items, urlBrowser.items) &&
        Arrays.equals(this.screenshot, urlBrowser.screenshot) &&
        Objects.equals(this.statusCode, urlBrowser.statusCode) &&
        Objects.equals(this.title, urlBrowser.title) &&
        Objects.equals(this.url, urlBrowser.url);
  }

  @Override
  public int hashCode() {
    return Objects.hash(additionalData, favicon, items, Arrays.hashCode(screenshot), statusCode, title, url);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UrlBrowser {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UrlBrowser
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UrlBrowser.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UrlBrowser is not found in the empty JSON string", UrlBrowser.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UrlBrowser.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UrlBrowser` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UrlBrowser.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UrlBrowser.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UrlBrowser' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UrlBrowser> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UrlBrowser.class));

       return (TypeAdapter<T>) new TypeAdapter<UrlBrowser>() {
           @Override
           public void write(JsonWriter out, UrlBrowser value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UrlBrowser read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UrlBrowser given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UrlBrowser
   * @throws IOException if the JSON string is invalid with respect to UrlBrowser
   */
  public static UrlBrowser fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UrlBrowser.class);
  }

  /**
   * Convert an instance of UrlBrowser to an JSON string
   *
   * @return JSON string
   */
