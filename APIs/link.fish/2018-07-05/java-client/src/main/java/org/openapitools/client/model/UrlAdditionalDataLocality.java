...
public class UrlAdditionalDataLocality {
  ...
  public UrlAdditionalDataLocality() {
  }

  public UrlAdditionalDataLocality country(String country) {
  ...
  public UrlAdditionalDataLocality language(String language) {
  ...
  public boolean equals(Object o) {
    ...
    UrlAdditionalDataLocality urlAdditionalDataLocality = (UrlAdditionalDataLocality) o;
    return Objects.equals(this.country, urlAdditionalDataLocality.country) &&
        Objects.equals(this.language, urlAdditionalDataLocality.language);
  }
  ...
  public String toString() {
    ...
    sb.append("class UrlAdditionalDataLocality {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UrlAdditionalDataLocality
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UrlAdditionalDataLocality.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UrlAdditionalDataLocality is not found in the empty JSON string", UrlAdditionalDataLocality.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UrlAdditionalDataLocality.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UrlAdditionalDataLocality` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UrlAdditionalDataLocality.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UrlAdditionalDataLocality' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UrlAdditionalDataLocality> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UrlAdditionalDataLocality.class));

       return (TypeAdapter<T>) new TypeAdapter<UrlAdditionalDataLocality>() {
           @Override
           public void write(JsonWriter out, UrlAdditionalDataLocality value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UrlAdditionalDataLocality read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UrlAdditionalDataLocality given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UrlAdditionalDataLocality
   * @throws IOException if the JSON string is invalid with respect to UrlAdditionalDataLocality
   */
  public static UrlAdditionalDataLocality fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UrlAdditionalDataLocality.class);
  }

  /**
   * Convert an instance of UrlAdditionalDataLocality to an JSON string
   *
   * @return JSON string
   */
