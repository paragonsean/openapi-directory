...
OAIUrl_items_inner::OAIUrl_items_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUrl_items_inner::OAIUrl_items_inner() {
    this->initializeModel();
}

OAIUrl_items_inner::~OAIUrl_items_inner() {}

void OAIUrl_items_inner::initializeModel() {

    m_type_isSet = false;
    m_type_isValid = false;
}

void OAIUrl_items_inner::fromJson(QString jsonString) {
...
void OAIUrl_items_inner::fromJsonObject(QJsonObject json) {

    m_type_isValid = ::OpenAPI::fromJsonValue(m_type, json[QString("@type")]);
    m_type_isSet = !json[QString("@type")].isNull() && m_type_isValid;
}

QString OAIUrl_items_inner::asJson() const {
...
QJsonObject OAIUrl_items_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_type_isSet) {
...
QString OAIUrl_items_inner::getType() const {
    return m_type;
}
void OAIUrl_items_inner::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIUrl_items_inner::is_type_Set() const{
    return m_type_isSet;
}

bool OAIUrl_items_inner::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIUrl_items_inner::isSet() const {
...
bool OAIUrl_items_inner::isValid() const {
