...
/*
 * OAIUrl_additionalData.h
 *
 * 
 */

#ifndef OAIUrl_additionalData_H
#define OAIUrl_additionalData_H
...
namespace OpenAPI {
class OAIUrl_additionalData_locality;

class OAIUrl_additionalData : public OAIObject {
public:
    OAIUrl_additionalData();
    OAIUrl_additionalData(QString json);
    ~OAIUrl_additionalData() override;
    ...
    OAIUrl_additionalData_locality getLocality() const;
    void setLocality(const OAIUrl_additionalData_locality &locality);
...
private:
    ...
    OAIUrl_additionalData_locality m_locality;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUrl_additionalData)

#endif // OAIUrl_additionalData_H
