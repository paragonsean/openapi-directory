...
/*
 * OAIDataTabular_data.h
 *
 * 
 */

#ifndef OAIDataTabular_data_H
#define OAIDataTabular_data_H
...
class OAIDataTabular_data : public OAIObject {
public:
    OAIDataTabular_data();
    OAIDataTabular_data(QString json);
    ~OAIDataTabular_data() override;
    ...
    QList<QList<QList<QString>>> getData() const;
    void setData(const QList<QList<QList<QString>>> &data);
...
private:
    ...
    QList<QList<QList<QString>>> m_data;
    bool m_data_isSet;
    bool m_data_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDataTabular_data)

#endif // OAIDataTabular_data_H
