...
#ifndef OAIDataTabular_H
#define OAIDataTabular_H
...
namespace OpenAPI {
class OAIDataTabular_data;

class OAIDataTabular : public OAIObject {
public:
    OAIDataTabular();
    OAIDataTabular(QString json);
    ~OAIDataTabular() override;
    ...
    OAIDataTabular_data getData() const;
    void setData(const OAIDataTabular_data &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIDataTabular)

#endif // OAIDataTabular_H
