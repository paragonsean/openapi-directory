...
/*
 * OAIApiResponsError.h
 *
 * 
 */

#ifndef OAIApiResponsError_H
#define OAIApiResponsError_H
...
class OAIApiResponsError : public OAIObject {
public:
    OAIApiResponsError();
    OAIApiResponsError(QString json);
    ~OAIApiResponsError() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApiResponsError)

#endif // OAIApiResponsError_H
