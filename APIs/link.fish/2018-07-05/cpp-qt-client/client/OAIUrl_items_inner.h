...
class OAIUrl_items_inner : public OAIObject {
public:
    OAIUrl_items_inner();
    OAIUrl_items_inner(QString json);
    ~OAIUrl_items_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUrl_items_inner)

#endif // OAIUrl_items_inner_H
