...
class OAIApps : public OAIObject {
public:
    OAIApps();
    OAIApps(QString json);
    ~OAIApps() override;
    ...
    QString getAndroid() const;
    void setAndroid(const QString &android);
    bool is_android_Set() const;
    bool is_android_Valid() const;

    QString getIos() const;
    void setIos(const QString &ios);
...
Q_DECLARE_METATYPE(OpenAPI::OAIApps)
