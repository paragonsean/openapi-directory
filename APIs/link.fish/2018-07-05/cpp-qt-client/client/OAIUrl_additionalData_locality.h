...
/*
 * OAIUrl_additionalData_locality.h
 *
 * 
 */

#ifndef OAIUrl_additionalData_locality_H
#define OAIUrl_additionalData_locality_H
...
class OAIUrl_additionalData_locality : public OAIObject {
public:
    OAIUrl_additionalData_locality();
    OAIUrl_additionalData_locality(QString json);
    ~OAIUrl_additionalData_locality() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUrl_additionalData_locality)

#endif // OAIUrl_additionalData_locality_H
