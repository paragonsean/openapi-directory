...
QString OAIGeoCoordinates::getUrl() const {
    return m_url;
}
void OAIGeoCoordinates::setUrl(const QString &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAIGeoCoordinates::is_url_Set() const{
    return m_url_isSet;
}

bool OAIGeoCoordinates::is_url_Valid() const{
...
bool OAIGeoCoordinates::isValid() const {
    ...
    return m_latitude_isValid && m_longitude_isValid && m_url_isValid && true;
}
