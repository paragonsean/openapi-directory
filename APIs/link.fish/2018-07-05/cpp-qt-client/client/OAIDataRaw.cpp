...
OAIDataRaw::OAIDataRaw(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDataRaw::OAIDataRaw() {
    this->initializeModel();
}

OAIDataRaw::~OAIDataRaw() {}

void OAIDataRaw::initializeModel() {
...
void OAIDataRaw::fromJson(QString jsonString) {
...
void OAIDataRaw::fromJsonObject(QJsonObject json) {
...
QString OAIDataRaw::asJson() const {
...
QJsonObject OAIDataRaw::asJsonObject() const {
    QJsonObject obj;
    if (m_data_isSet) {
...
OAIObject OAIDataRaw::getData() const {
    return m_data;
}
void OAIDataRaw::setData(const OAIObject &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIDataRaw::is_data_Set() const{
    return m_data_isSet;
}

bool OAIDataRaw::is_data_Valid() const{
    return m_data_isValid;
}

QString OAIDataRaw::getSourceFormat() const {
    return m_source_format;
}
void OAIDataRaw::setSourceFormat(const QString &source_format) {
    m_source_format = source_format;
    m_source_format_isSet = true;
}

bool OAIDataRaw::is_source_format_Set() const{
    return m_source_format_isSet;
}

bool OAIDataRaw::is_source_format_Valid() const{
    return m_source_format_isValid;
}

QString OAIDataRaw::getStatusCode() const {
    return m_status_code;
}
void OAIDataRaw::setStatusCode(const QString &status_code) {
    m_status_code = status_code;
    m_status_code_isSet = true;
}

bool OAIDataRaw::is_status_code_Set() const{
    return m_status_code_isSet;
}

bool OAIDataRaw::is_status_code_Valid() const{
    return m_status_code_isValid;
}

QString OAIDataRaw::getUrl() const {
    return m_url;
}
void OAIDataRaw::setUrl(const QString &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAIDataRaw::is_url_Set() const{
    return m_url_isSet;
}

bool OAIDataRaw::is_url_Valid() const{
    return m_url_isValid;
}

bool OAIDataRaw::isSet() const {
