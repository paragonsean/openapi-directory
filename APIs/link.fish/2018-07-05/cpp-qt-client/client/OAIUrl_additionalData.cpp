...
OAIUrl_additionalData::OAIUrl_additionalData(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUrl_additionalData::OAIUrl_additionalData() {
    this->initializeModel();
}

OAIUrl_additionalData::~OAIUrl_additionalData() {}

void OAIUrl_additionalData::initializeModel() {

    m_locality_isSet = false;
    m_locality_isValid = false;
}

void OAIUrl_additionalData::fromJson(QString jsonString) {
...
void OAIUrl_additionalData::fromJsonObject(QJsonObject json) {
...
QString OAIUrl_additionalData::asJson() const {
...
QJsonObject OAIUrl_additionalData::asJsonObject() const {
    QJsonObject obj;
    if (m_locality.isSet()) {
...
OAIUrl_additionalData_locality OAIUrl_additionalData::getLocality() const {
    return m_locality;
}
void OAIUrl_additionalData::setLocality(const OAIUrl_additionalData_locality &locality) {
    m_locality = locality;
    m_locality_isSet = true;
}

bool OAIUrl_additionalData::is_locality_Set() const{
    return m_locality_isSet;
}

bool OAIUrl_additionalData::is_locality_Valid() const{
    return m_locality_isValid;
}

bool OAIUrl_additionalData::isSet() const {
...
bool OAIUrl_additionalData::isValid() const {
