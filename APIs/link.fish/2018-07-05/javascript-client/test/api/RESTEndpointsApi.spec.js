...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LinkFishApi.RESTEndpointsApi();
  });
  ...
  describe('RESTEndpointsApi', function() {
    describe('urlsAppsGet', function() {
      it('should call urlsAppsGet successfully', function(done) {
        //uncomment below and update the code to test urlsAppsGet
        //instance.urlsAppsGet(function(error) {
    ...
    describe('urlsBrowserDataGet', function() {
      it('should call urlsBrowserDataGet successfully', function(done) {
        //uncomment below and update the code to test urlsBrowserDataGet
        //instance.urlsBrowserDataGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('urlsBrowserScreenshotGet', function() {
      it('should call urlsBrowserScreenshotGet successfully', function(done) {
        //uncomment below and update the code to test urlsBrowserScreenshotGet
        //instance.urlsBrowserScreenshotGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('urlsDataGet', function() {
      it('should call urlsDataGet successfully', function(done) {
        //uncomment below and update the code to test urlsDataGet
        //instance.urlsDataGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('urlsDataRawGet', function() {
      it('should call urlsDataRawGet successfully', function(done) {
        //uncomment below and update the code to test urlsDataRawGet
        //instance.urlsDataRawGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('urlsDataTabularGet', function() {
      it('should call urlsDataTabularGet successfully', function(done) {
        //uncomment below and update the code to test urlsDataTabularGet
        //instance.urlsDataTabularGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('urlsGeoCoordinatesGet', function() {
      it('should call urlsGeoCoordinatesGet successfully', function(done) {
        //uncomment below and update the code to test urlsGeoCoordinatesGet
        //instance.urlsGeoCoordinatesGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('urlsSocialMediaGet', function() {
      it('should call urlsSocialMediaGet successfully', function(done) {
        //uncomment below and update the code to test urlsSocialMediaGet
        //instance.urlsSocialMediaGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
