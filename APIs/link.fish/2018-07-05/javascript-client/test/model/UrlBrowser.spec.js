...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LinkFishApi.UrlBrowser();
  });
  ...
  describe('UrlBrowser', function() {
    it('should create an instance of UrlBrowser', function() {
      // uncomment below and update the code to test UrlBrowser
      //var instance = new LinkFishApi.UrlBrowser();
      //expect(instance).to.be.a(LinkFishApi.UrlBrowser);
    });
