...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LinkFishApi.UrlAdditionalData();
  });
  ...
  describe('UrlAdditionalData', function() {
    it('should create an instance of UrlAdditionalData', function() {
      // uncomment below and update the code to test UrlAdditionalData
      //var instance = new LinkFishApi.UrlAdditionalData();
      //expect(instance).to.be.a(LinkFishApi.UrlAdditionalData);
    });
