...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LinkFishApi.SocialMedia();
  });
  ...
  describe('SocialMedia', function() {
    it('should create an instance of SocialMedia', function() {
      ...
      //var instance = new LinkFishApi.SocialMedia();
      //expect(instance).to.be.a(LinkFishApi.SocialMedia);
    });

    it('should have the property facebookPage (base name: "facebookPage")', function() {
      // uncomment below and update the code to test the property facebookPage
      //var instance = new LinkFishApi.SocialMedia();
      //expect(instance).to.be();
    });

    it('should have the property githubUser (base name: "githubUser")', function() {
      // uncomment below and update the code to test the property githubUser
      //var instance = new LinkFishApi.SocialMedia();
      //expect(instance).to.be();
    });

    it('should have the property linkedInCompany (base name: "linkedInCompany")', function() {
      // uncomment below and update the code to test the property linkedInCompany
      //var instance = new LinkFishApi.SocialMedia();
      //expect(instance).to.be();
    });
