...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LinkFishApi.DataTabular();
  });
  ...
  describe('DataTabular', function() {
    it('should create an instance of DataTabular', function() {
      // uncomment below and update the code to test DataTabular
      //var instance = new LinkFishApi.DataTabular();
      //expect(instance).to.be.a(LinkFishApi.DataTabular);
    });
