...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LinkFishApi.DataRaw();
  });
  ...
  describe('DataRaw', function() {
    it('should create an instance of DataRaw', function() {
      // uncomment below and update the code to test DataRaw
      //var instance = new LinkFishApi.DataRaw();
      //expect(instance).to.be.a(LinkFishApi.DataRaw);
    });
