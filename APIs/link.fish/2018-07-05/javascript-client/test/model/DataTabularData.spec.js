...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LinkFishApi.DataTabularData();
  });
  ...
  describe('DataTabularData', function() {
    it('should create an instance of DataTabularData', function() {
      // uncomment below and update the code to test DataTabularData
      //var instance = new LinkFishApi.DataTabularData();
      //expect(instance).to.be.a(LinkFishApi.DataTabularData);
    });
