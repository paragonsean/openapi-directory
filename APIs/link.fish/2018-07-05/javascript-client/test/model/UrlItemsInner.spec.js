...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.expect, root.LinkFishApi);
  }
}(this, function(expect, LinkFishApi) {
  'use strict';

  var instance;

  beforeEach(function() {
    instance = new LinkFishApi.UrlItemsInner();
  });
  ...
  describe('UrlItemsInner', function() {
    it('should create an instance of UrlItemsInner', function() {
      // uncomment below and update the code to test UrlItemsInner
      //var instance = new LinkFishApi.UrlItemsInner();
      //expect(instance).to.be.a(LinkFishApi.UrlItemsInner);
    });
