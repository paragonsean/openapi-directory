...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LinkFishApi.UrlAdditionalDataLocality();
  });
  ...
  describe('UrlAdditionalDataLocality', function() {
    it('should create an instance of UrlAdditionalDataLocality', function() {
      // uncomment below and update the code to test UrlAdditionalDataLocality
      //var instance = new LinkFishApi.UrlAdditionalDataLocality();
      //expect(instance).to.be.a(LinkFishApi.UrlAdditionalDataLocality);
    });
