...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LinkFishApi.ApiResponsError();
  });
  ...
  describe('ApiResponsError', function() {
    it('should create an instance of ApiResponsError', function() {
      // uncomment below and update the code to test ApiResponsError
      //var instance = new LinkFishApi.ApiResponsError();
      //expect(instance).to.be.a(LinkFishApi.ApiResponsError);
    });
