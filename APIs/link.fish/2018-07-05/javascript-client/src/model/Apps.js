...
/**
 * The Apps model module.
 * @module model/Apps
 * @version 2018-07-05
 */
class Apps {
    /**
     * Constructs a new <code>Apps</code>.
     * @alias module:model/Apps
     * @param android {String} Android app
     * @param ios {String} iOS app
     * @param url {String} The url of the website. Can be different to requested one if there were redirects
     */
    constructor(android, ios, url) { 
        
        Apps.initialize(this, android, ios, url);
    }
     ...
     */
    static initialize(obj, android, ios, url) { 
        obj['android'] = android;
        obj['ios'] = ios;
        obj['url'] = url;
    }
    ...
    /**
     * Constructs a <code>Apps</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Apps} obj Optional instance to populate.
     * @return {module:model/Apps} The populated <code>Apps</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>Apps</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Apps</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Apps.RequiredProperties) {
...
Apps.RequiredProperties = ["android", "ios", "url"];

/**
 * Android app
 * @member {String} android
 */
Apps.prototype['android'] = undefined;

/**
 * iOS app
 * @member {String} ios
 */
Apps.prototype['ios'] = undefined;

/**
 * The url of the website. Can be different to requested one if there were redirects
 * @member {String} url
 */
Apps.prototype['url'] = undefined;
