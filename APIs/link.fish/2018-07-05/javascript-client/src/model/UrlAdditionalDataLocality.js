...
/**
 * The UrlAdditionalDataLocality model module.
 * @module model/UrlAdditionalDataLocality
 * @version 2018-07-05
 */
class UrlAdditionalDataLocality {
    /**
     * Constructs a new <code>UrlAdditionalDataLocality</code>.
     * @alias module:model/UrlAdditionalDataLocality
     */
    constructor() { 
        
        UrlAdditionalDataLocality.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UrlAdditionalDataLocality</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UrlAdditionalDataLocality} obj Optional instance to populate.
     * @return {module:model/UrlAdditionalDataLocality} The populated <code>UrlAdditionalDataLocality</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UrlAdditionalDataLocality();
    ...
    /**
     * Validates the JSON data with respect to <code>UrlAdditionalDataLocality</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UrlAdditionalDataLocality</code>.
     */
 ...
 */
UrlAdditionalDataLocality.prototype['country'] = undefined;

/**
 * The language of website. Recognized by header information if supplied or text analysis.
 * @member {String} language
 */
UrlAdditionalDataLocality.prototype['language'] = undefined;
...
export default UrlAdditionalDataLocality;
