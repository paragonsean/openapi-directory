...
/**
 * The UrlItemsInner model module.
 * @module model/UrlItemsInner
 * @version 2018-07-05
 */
class UrlItemsInner {
    /**
     * Constructs a new <code>UrlItemsInner</code>.
     * The properties depend on the type of the item. The field \&quot;@type\&quot; exists for all.
     * @alias module:model/UrlItemsInner
     */
    constructor() { 
        
        UrlItemsInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UrlItemsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UrlItemsInner} obj Optional instance to populate.
     * @return {module:model/UrlItemsInner} The populated <code>UrlItemsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UrlItemsInner();
    ...
    /**
     * Validates the JSON data with respect to <code>UrlItemsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UrlItemsInner</code>.
     */
 ...
 * @member {String} @type
 */
UrlItemsInner.prototype['@type'] = undefined;
