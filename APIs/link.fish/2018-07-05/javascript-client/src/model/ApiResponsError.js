...
/**
 * The ApiResponsError model module.
 * @module model/ApiResponsError
 * @version 2018-07-05
 */
class ApiResponsError {
    /**
     * Constructs a new <code>ApiResponsError</code>.
     * @alias module:model/ApiResponsError
     * @param message {String} The error message.
     * @param status {String} The HTTP status code for the error.
     */
    constructor(message, status) { 
        
        ApiResponsError.initialize(this, message, status);
    }
    ...
    /**
     * Constructs a <code>ApiResponsError</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiResponsError} obj Optional instance to populate.
     * @return {module:model/ApiResponsError} The populated <code>ApiResponsError</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiResponsError();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiResponsError</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiResponsError</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ApiResponsError.RequiredProperties) {
...
ApiResponsError.RequiredProperties = ["message", "status"];

/**
 * The error message.
 * @member {String} message
 */
ApiResponsError.prototype['message'] = undefined;

/**
 * The HTTP status code for the error.
 * @member {String} status
 */
ApiResponsError.prototype['status'] = undefined;
...
export default ApiResponsError;
