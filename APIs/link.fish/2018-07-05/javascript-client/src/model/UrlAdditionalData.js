...
import UrlAdditionalDataLocality from './UrlAdditionalDataLocality';

/**
 * The UrlAdditionalData model module.
 * @module model/UrlAdditionalData
 * @version 2018-07-05
 */
class UrlAdditionalData {
    /**
     * Constructs a new <code>UrlAdditionalData</code>.
     * @alias module:model/UrlAdditionalData
     */
    constructor() { 
        
        UrlAdditionalData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UrlAdditionalData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UrlAdditionalData} obj Optional instance to populate.
     * @return {module:model/UrlAdditionalData} The populated <code>UrlAdditionalData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UrlAdditionalData();

            if (data.hasOwnProperty('locality')) {
                obj['locality'] = UrlAdditionalDataLocality.constructFromObject(data['locality']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UrlAdditionalData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UrlAdditionalData</code>.
     */
    static validateJSON(data) {
        // validate the optional field `locality`
        if (data['locality']) { // data not null
          UrlAdditionalDataLocality.validateJSON(data['locality']);
        }
...
/**
 * @member {module:model/UrlAdditionalDataLocality} locality
 */
UrlAdditionalData.prototype['locality'] = undefined;
...
export default UrlAdditionalData;
