...
/**
 * The DataTabularData model module.
 * @module model/DataTabularData
 * @version 2018-07-05
 */
class DataTabularData {
    /**
     * Constructs a new <code>DataTabularData</code>.
     * @alias module:model/DataTabularData
     */
    constructor() { 
        
        DataTabularData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DataTabularData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DataTabularData} obj Optional instance to populate.
     * @return {module:model/DataTabularData} The populated <code>DataTabularData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DataTabularData();
    ...
    /**
     * Validates the JSON data with respect to <code>DataTabularData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DataTabularData</code>.
     */
 ...
 * @member {Array.<Array.<Array.<String>>>} data
 */
DataTabularData.prototype['data'] = undefined;

/**
 * @member {Object} metadata
 */
DataTabularData.prototype['metadata'] = undefined;
...
export default DataTabularData;
