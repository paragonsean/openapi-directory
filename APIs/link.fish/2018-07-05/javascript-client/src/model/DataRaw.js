...
/**
 * The DataRaw model module.
 * @module model/DataRaw
 * @version 2018-07-05
 */
class DataRaw {
    /**
     * Constructs a new <code>DataRaw</code>.
     * @alias module:model/DataRaw
     * @param data {Object} The found data (can be an object or array)
    ...
    constructor(data, statusCode, url) { 
        ...
        DataRaw.initialize(this, data, statusCode, url);
    }
    ...
    /**
     * Constructs a <code>DataRaw</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DataRaw} obj Optional instance to populate.
     * @return {module:model/DataRaw} The populated <code>DataRaw</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>DataRaw</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DataRaw</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DataRaw.RequiredProperties) {
