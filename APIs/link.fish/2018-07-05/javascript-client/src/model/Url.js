...
class Url {
    ...
    constructor(additionalData, items, statusCode, title, url) { 
        ...
        Url.initialize(this, additionalData, items, statusCode, title, url);
    }
...
Url.RequiredProperties = ["additionalData", "items", "statusCode", "title", "url"];

/**
 * @member {module:model/UrlAdditionalData} additionalData
 */
Url.prototype['additionalData'] = undefined;

/**
 * Url of website favicon
 * @member {String} favicon
 */
Url.prototype['favicon'] = undefined;

/**
 * The found data items on the website.
 * @member {Array.<module:model/UrlItemsInner>} items
 */
Url.prototype['items'] = undefined;

/**
 * The HTTP status code the URL returned
 * @member {String} statusCode
 */
Url.prototype['statusCode'] = undefined;

/**
 * The title of the page
 * @member {String} title
 */
Url.prototype['title'] = undefined;
