...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NFusionSolutionsMarketDataApi.RateResponse();
  });
  ...
  describe('RateResponse', function() {
    it('should create an instance of RateResponse', function() {
      ...
      //var instance = new NFusionSolutionsMarketDataApi.RateResponse();
      //expect(instance).to.be.a(NFusionSolutionsMarketDataApi.RateResponse);
    });
