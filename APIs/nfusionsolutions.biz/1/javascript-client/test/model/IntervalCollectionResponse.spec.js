...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NFusionSolutionsMarketDataApi.IntervalCollectionResponse();
  });
  ...
  describe('IntervalCollectionResponse', function() {
    it('should create an instance of IntervalCollectionResponse', function() {
      // uncomment below and update the code to test IntervalCollectionResponse
      //var instance = new NFusionSolutionsMarketDataApi.IntervalCollectionResponse();
      //expect(instance).to.be.a(NFusionSolutionsMarketDataApi.IntervalCollectionResponse);
    });
