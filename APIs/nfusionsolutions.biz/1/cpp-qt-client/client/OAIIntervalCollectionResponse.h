...
/*
 * OAIIntervalCollectionResponse.h
 *
 * 
 */

#ifndef OAIIntervalCollectionResponse_H
#define OAIIntervalCollectionResponse_H
...
namespace OpenAPI {
class OAIIntervalCollection;

class OAIIntervalCollectionResponse : public OAIObject {
public:
    OAIIntervalCollectionResponse();
    OAIIntervalCollectionResponse(QString json);
    ~OAIIntervalCollectionResponse() override;
    ...
    OAIIntervalCollection getData() const;
    void setData(const OAIIntervalCollection &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIIntervalCollectionResponse)

#endif // OAIIntervalCollectionResponse_H
