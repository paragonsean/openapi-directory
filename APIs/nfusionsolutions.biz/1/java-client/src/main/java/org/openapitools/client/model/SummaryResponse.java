...
public class SummaryResponse {
  ...
  public SummaryResponse data(Summary data) {
    this.data = data;
    return this;
  }
  ...
  public SummaryResponse error(String error) {
    this.error = error;
    return this;
  }
  ...
  public SummaryResponse requestedCurrency(String requestedCurrency) {
  ...
  public SummaryResponse requestedSymbol(String requestedSymbol) {
  ...
  public SummaryResponse requestedUnitOfMeasure(String requestedUnitOfMeasure) {
  ...
  public SummaryResponse success(Boolean success) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, summaryResponse.data) &&
        Objects.equals(this.error, summaryResponse.error) &&
        Objects.equals(this.requestedCurrency, summaryResponse.requestedCurrency) &&
        Objects.equals(this.requestedSymbol, summaryResponse.requestedSymbol) &&
        Objects.equals(this.requestedUnitOfMeasure, summaryResponse.requestedUnitOfMeasure) &&
        Objects.equals(this.success, summaryResponse.success);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SummaryResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SummaryResponse is not found in the empty JSON string", SummaryResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SummaryResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SummaryResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `data`
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        Summary.validateJsonElement(jsonObj.get("data"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SummaryResponse>() {
           @Override
