...
void OAIFareDetailsBySegment::initializeModel() {
    ...
    m_meal_services_isSet = false;
    m_meal_services_isValid = false;
...
void OAIFareDetailsBySegment::fromJsonObject(QJsonObject json) {
    ...
    m_meal_services_isValid = ::OpenAPI::fromJsonValue(m_meal_services, json[QString("mealServices")]);
    m_meal_services_isSet = !json[QString("mealServices")].isNull() && m_meal_services_isValid;
...
QJsonObject OAIFareDetailsBySegment::asJsonObject() const {
    ...
    if (m_meal_services.size() > 0) {
        obj.insert(QString("mealServices"), ::OpenAPI::toJsonValue(m_meal_services));
    }
...
QList<OAIMealServices> OAIFareDetailsBySegment::getMealServices() const {
    return m_meal_services;
}
void OAIFareDetailsBySegment::setMealServices(const QList<OAIMealServices> &meal_services) {
    m_meal_services = meal_services;
    m_meal_services_isSet = true;
}

bool OAIFareDetailsBySegment::is_meal_services_Set() const{
    return m_meal_services_isSet;
}

bool OAIFareDetailsBySegment::is_meal_services_Valid() const{
    return m_meal_services_isValid;
}
