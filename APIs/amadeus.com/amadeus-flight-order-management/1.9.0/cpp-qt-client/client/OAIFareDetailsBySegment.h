...
public:
    ...
    QList<OAIMealServices> getMealServices() const;
    void setMealServices(const QList<OAIMealServices> &meal_services);
    bool is_meal_services_Set() const;
    bool is_meal_services_Valid() const;
...
private:
    ...
    QList<OAIMealServices> m_meal_services;
    bool m_meal_services_isSet;
    bool m_meal_services_isValid;
