...
void OAIFlightSegment::initializeModel() {
    ...
    m_booking_status_isSet = false;
    m_booking_status_isValid = false;
    ...
    m_is_flown_isSet = false;
    m_is_flown_isValid = false;
...
void OAIFlightSegment::fromJsonObject(QJsonObject json) {
    ...
    m_booking_status_isValid = ::OpenAPI::fromJsonValue(m_booking_status, json[QString("bookingStatus")]);
    m_booking_status_isSet = !json[QString("bookingStatus")].isNull() && m_booking_status_isValid;
    ...
    m_is_flown_isValid = ::OpenAPI::fromJsonValue(m_is_flown, json[QString("isFlown")]);
    m_is_flown_isSet = !json[QString("isFlown")].isNull() && m_is_flown_isValid;
...
QJsonObject OAIFlightSegment::asJsonObject() const {
    ...
    if (m_booking_status_isSet) {
        obj.insert(QString("bookingStatus"), ::OpenAPI::toJsonValue(m_booking_status));
    }
    ...
    if (m_is_flown_isSet) {
        obj.insert(QString("isFlown"), ::OpenAPI::toJsonValue(m_is_flown));
    }
    if (m_number_isSet) {
...
QString OAIFlightSegment::getBookingStatus() const {
    return m_booking_status;
}
void OAIFlightSegment::setBookingStatus(const QString &booking_status) {
    m_booking_status = booking_status;
    m_booking_status_isSet = true;
}

bool OAIFlightSegment::is_booking_status_Set() const{
    return m_booking_status_isSet;
}

bool OAIFlightSegment::is_booking_status_Valid() const{
    return m_booking_status_isValid;
}
...
bool OAIFlightSegment::isIsFlown() const {
    return m_is_flown;
}
void OAIFlightSegment::setIsFlown(const bool &is_flown) {
    m_is_flown = is_flown;
    m_is_flown_isSet = true;
}

bool OAIFlightSegment::is_is_flown_Set() const{
    return m_is_flown_isSet;
}

bool OAIFlightSegment::is_is_flown_Valid() const{
    return m_is_flown_isValid;
}
...
QString OAIFlightSegment::getSegmentType() const {
    return m_segment_type;
}
void OAIFlightSegment::setSegmentType(const QString &segment_type) {
    m_segment_type = segment_type;
    m_segment_type_isSet = true;
}

bool OAIFlightSegment::is_segment_type_Set() const{
    return m_segment_type_isSet;
}

bool OAIFlightSegment::is_segment_type_Valid() const{
