...
QString OAISegment::getBookingStatus() const {
    return m_booking_status;
}
void OAISegment::setBookingStatus(const QString &booking_status) {
    m_booking_status = booking_status;
    m_booking_status_isSet = true;
}

bool OAISegment::is_booking_status_Set() const{
    return m_booking_status_isSet;
}

bool OAISegment::is_booking_status_Valid() const{
...
bool OAISegment::isIsFlown() const {
    return m_is_flown;
}
void OAISegment::setIsFlown(const bool &is_flown) {
    m_is_flown = is_flown;
    m_is_flown_isSet = true;
}

bool OAISegment::is_is_flown_Set() const{
    return m_is_flown_isSet;
}

bool OAISegment::is_is_flown_Valid() const{
...
QString OAISegment::getSegmentType() const {
    return m_segment_type;
}
void OAISegment::setSegmentType(const QString &segment_type) {
    m_segment_type = segment_type;
    m_segment_type_isSet = true;
}

bool OAISegment::is_segment_type_Set() const{
    return m_segment_type_isSet;
}

bool OAISegment::is_segment_type_Valid() const{
