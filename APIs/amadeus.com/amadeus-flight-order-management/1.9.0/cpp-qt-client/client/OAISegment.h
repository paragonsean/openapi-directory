...
public:
    ...
    QString getBookingStatus() const;
    void setBookingStatus(const QString &booking_status);
    bool is_booking_status_Set() const;
    bool is_booking_status_Valid() const;
    ...
    bool isIsFlown() const;
    void setIsFlown(const bool &is_flown);
    bool is_is_flown_Set() const;
    bool is_is_flown_Valid() const;
...
private:
    ...
    QString m_booking_status;
    bool m_booking_status_isSet;
    bool m_booking_status_isValid;
    ...
    bool m_is_flown;
    bool m_is_flown_isSet;
    bool m_is_flown_isValid;
