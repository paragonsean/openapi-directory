...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightOrderManagement.AllotmentDetails();
  });
  ...
  describe('AllotmentDetails', function() {
    it('should create an instance of AllotmentDetails', function() {
      ...
      //var instance = new FlightOrderManagement.AllotmentDetails();
      //expect(instance).to.be.a(FlightOrderManagement.AllotmentDetails);
    });
