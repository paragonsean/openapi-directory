...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightOrderManagement.Remarks();
  });
  ...
  describe('Remarks', function() {
    it('should create an instance of Remarks', function() {
      // uncomment below and update the code to test Remarks
      //var instance = new FlightOrderManagement.Remarks();
      //expect(instance).to.be.a(FlightOrderManagement.Remarks);
    });
