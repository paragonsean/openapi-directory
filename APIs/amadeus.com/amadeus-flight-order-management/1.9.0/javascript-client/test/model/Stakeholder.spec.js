...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightOrderManagement.Stakeholder();
  });
  ...
  describe('Stakeholder', function() {
    it('should create an instance of Stakeholder', function() {
      ...
      //var instance = new FlightOrderManagement.Stakeholder();
      //expect(instance).to.be.a(FlightOrderManagement.Stakeholder);
    });
