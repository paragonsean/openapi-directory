...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightOrderManagement.CreditCardCommon();
  });
  ...
  describe('CreditCardCommon', function() {
    it('should create an instance of CreditCardCommon', function() {
      ...
      //var instance = new FlightOrderManagement.CreditCardCommon();
      //expect(instance).to.be.a(FlightOrderManagement.CreditCardCommon);
    });
