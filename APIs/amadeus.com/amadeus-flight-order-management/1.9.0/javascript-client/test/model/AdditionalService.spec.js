...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightOrderManagement.AdditionalService();
  });
  ...
  describe('AdditionalService', function() {
    it('should create an instance of AdditionalService', function() {
      ...
      //var instance = new FlightOrderManagement.AdditionalService();
      //expect(instance).to.be.a(FlightOrderManagement.AdditionalService);
    });
