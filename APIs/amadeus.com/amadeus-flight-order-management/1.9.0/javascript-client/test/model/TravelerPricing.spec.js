...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightOrderManagement.TravelerPricing();
  });
  ...
  describe('TravelerPricing', function() {
    it('should create an instance of TravelerPricing', function() {
      ...
      //var instance = new FlightOrderManagement.TravelerPricing();
      //expect(instance).to.be.a(FlightOrderManagement.TravelerPricing);
    });
