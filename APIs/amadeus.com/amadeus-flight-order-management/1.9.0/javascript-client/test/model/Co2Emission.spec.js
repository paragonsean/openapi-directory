...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightOrderManagement.Co2Emission();
  });
  ...
  describe('Co2Emission', function() {
    it('should create an instance of Co2Emission', function() {
      ...
      //var instance = new FlightOrderManagement.Co2Emission();
      //expect(instance).to.be.a(FlightOrderManagement.Co2Emission);
    });
