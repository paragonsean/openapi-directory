...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightOrderManagement.FlightEndPoint();
  });
  ...
  describe('FlightEndPoint', function() {
    it('should create an instance of FlightEndPoint', function() {
      ...
      //var instance = new FlightOrderManagement.FlightEndPoint();
      //expect(instance).to.be.a(FlightOrderManagement.FlightEndPoint);
    });
