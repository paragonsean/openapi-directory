...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightOrderManagement.VirtualCreditCardDetails();
  });
  ...
  describe('VirtualCreditCardDetails', function() {
    it('should create an instance of VirtualCreditCardDetails', function() {
      // uncomment below and update the code to test VirtualCreditCardDetails
      //var instance = new FlightOrderManagement.VirtualCreditCardDetails();
      //expect(instance).to.be.a(FlightOrderManagement.VirtualCreditCardDetails);
    });
