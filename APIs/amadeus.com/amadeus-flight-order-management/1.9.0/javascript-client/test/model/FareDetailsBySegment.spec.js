...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightOrderManagement.FareDetailsBySegment();
  });
  ...
  describe('FareDetailsBySegment', function() {
    it('should create an instance of FareDetailsBySegment', function() {
      ...
      //var instance = new FlightOrderManagement.FareDetailsBySegment();
      //expect(instance).to.be.a(FlightOrderManagement.FareDetailsBySegment);
    });
    ...
    it('should have the property mealServices (base name: "mealServices")', function() {
      // uncomment below and update the code to test the property mealServices
      //var instance = new FlightOrderManagement.FareDetailsBySegment();
      //expect(instance).to.be();
    });
