...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightOrderManagement.GeneralRemark();
  });
  ...
  describe('GeneralRemark', function() {
    it('should create an instance of GeneralRemark', function() {
      ...
      //var instance = new FlightOrderManagement.GeneralRemark();
      //expect(instance).to.be.a(FlightOrderManagement.GeneralRemark);
    });
