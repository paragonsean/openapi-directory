...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightOrderManagement.CollectionLinks();
  });
  ...
  describe('CollectionLinks', function() {
    it('should create an instance of CollectionLinks', function() {
      ...
      //var instance = new FlightOrderManagement.CollectionLinks();
      //expect(instance).to.be.a(FlightOrderManagement.CollectionLinks);
    });
