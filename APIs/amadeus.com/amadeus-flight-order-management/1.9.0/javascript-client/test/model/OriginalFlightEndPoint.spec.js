...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightOrderManagement.OriginalFlightEndPoint();
  });
  ...
  describe('OriginalFlightEndPoint', function() {
    it('should create an instance of OriginalFlightEndPoint', function() {
      ...
      //var instance = new FlightOrderManagement.OriginalFlightEndPoint();
      //expect(instance).to.be.a(FlightOrderManagement.OriginalFlightEndPoint);
    });
