...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightOrderManagement.ExtendedPrice();
  });
  ...
  describe('ExtendedPrice', function() {
    it('should create an instance of ExtendedPrice', function() {
      ...
      //var instance = new FlightOrderManagement.ExtendedPrice();
      //expect(instance).to.be.a(FlightOrderManagement.ExtendedPrice);
    });
