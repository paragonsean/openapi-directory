...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightOrderManagement.CreditCard();
  });
  ...
  describe('CreditCard', function() {
    it('should create an instance of CreditCard', function() {
      ...
      //var instance = new FlightOrderManagement.CreditCard();
      //expect(instance).to.be.a(FlightOrderManagement.CreditCard);
    });
