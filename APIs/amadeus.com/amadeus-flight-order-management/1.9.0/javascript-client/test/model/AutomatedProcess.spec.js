...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightOrderManagement.AutomatedProcess();
  });
  ...
  describe('AutomatedProcess', function() {
    it('should create an instance of AutomatedProcess', function() {
      ...
      //var instance = new FlightOrderManagement.AutomatedProcess();
      //expect(instance).to.be.a(FlightOrderManagement.AutomatedProcess);
    });
