...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightOrderManagement.FormOfIdentification();
  });
  ...
  describe('FormOfIdentification', function() {
    it('should create an instance of FormOfIdentification', function() {
      ...
      //var instance = new FlightOrderManagement.FormOfIdentification();
      //expect(instance).to.be.a(FlightOrderManagement.FormOfIdentification);
    });
