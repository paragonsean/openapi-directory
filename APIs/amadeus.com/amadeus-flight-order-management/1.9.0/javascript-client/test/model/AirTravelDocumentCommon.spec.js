...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightOrderManagement.AirTravelDocumentCommon();
  });
  ...
  describe('AirTravelDocumentCommon', function() {
    it('should create an instance of AirTravelDocumentCommon', function() {
      ...
      //var instance = new FlightOrderManagement.AirTravelDocumentCommon();
      //expect(instance).to.be.a(FlightOrderManagement.AirTravelDocumentCommon);
    });
