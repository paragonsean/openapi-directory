...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightOrderManagement.IssueSource();
  });
  ...
  describe('IssueSource', function() {
    it('should create an instance of IssueSource', function() {
      ...
      //var instance = new FlightOrderManagement.IssueSource();
      //expect(instance).to.be.a(FlightOrderManagement.IssueSource);
    });
