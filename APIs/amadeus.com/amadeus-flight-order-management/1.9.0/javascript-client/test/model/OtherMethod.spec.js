...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightOrderManagement.OtherMethod();
  });
  ...
  describe('OtherMethod', function() {
    it('should create an instance of OtherMethod', function() {
      // uncomment below and update the code to test OtherMethod
      //var instance = new FlightOrderManagement.OtherMethod();
      //expect(instance).to.be.a(FlightOrderManagement.OtherMethod);
    });
