...
class FareDetailsBySegment {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('mealServices')) {
                obj['mealServices'] = ApiClient.convertToType(data['mealServices'], [MealServices]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['mealServices']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['mealServices'])) {
                throw new Error("Expected the field `mealServices` to be an array in the JSON data but got " + data['mealServices']);
            }
            // validate the optional field `mealServices` (array)
            for (const item of data['mealServices']) {
                MealServices.validateJSON(item);
            };
        }
        // ensure the json data is a string
 ...
 * @member {Array.<module:model/MealServices>} mealServices
 */
FareDetailsBySegment.prototype['mealServices'] = undefined;
