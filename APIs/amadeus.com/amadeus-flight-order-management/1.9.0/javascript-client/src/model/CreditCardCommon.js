...
/**
 * The CreditCardCommon model module.
 * @module model/CreditCardCommon
 * @version 1.9.0
 */
class CreditCardCommon {
    /**
     * Constructs a new <code>CreditCardCommon</code>.
     * credit card common attribute
     * @alias module:model/CreditCardCommon
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>CreditCardCommon</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreditCardCommon} obj Optional instance to populate.
     * @return {module:model/CreditCardCommon} The populated <code>CreditCardCommon</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreditCardCommon();
    ...
    /**
     * Validates the JSON data with respect to <code>CreditCardCommon</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreditCardCommon</code>.
     */
...
export default CreditCardCommon;
