...
class Segment(Model):
    ...
    def __init__(self, aircraft: AircraftEquipment=None, arrival: FlightEndPoint=None, booking_status: str=None, carrier_code: str=None, departure: FlightEndPoint=None, duration: str=None, is_flown: bool=None, number: str=None, operating: OperatingFlight=None, segment_type: str=None, stops: List[FlightStop]=None, blacklisted_in_eu: bool=None, co2_emissions: List[Co2Emission]=None, id: str=None, number_of_stops: int=None):
        """Segment - a model defined in OpenAPI

        :param aircraft: The aircraft of this Segment.
        :param arrival: The arrival of this Segment.
        :param booking_status: The booking_status of this Segment.
        ...
        :param is_flown: The is_flown of this Segment.
        :param number: The number of this Segment.
        :param operating: The operating of this Segment.
        :param segment_type: The segment_type of this Segment.
    ...
    def booking_status(self):
        """Gets the booking_status of this Segment.

        booking status of the segment

        :return: The booking_status of this Segment.
        :rtype: str
        """
    ...
    def booking_status(self, booking_status):
        """Sets the booking_status of this Segment.
        ...
        """
        allowed_values = ["CONFIRMED", "WAITLISTED", "CANCELLED", "PENDING", "DENIED"]  # noqa: E501
    ...
    @property
    def is_flown(self):
        """Gets the is_flown of this Segment.

        indicator set to true if segment is flown

        :return: The is_flown of this Segment.
        :rtype: bool
        """
        return self._is_flown

    @is_flown.setter
    def is_flown(self, is_flown):
        """Sets the is_flown of this Segment.
    ...
    def segment_type(self):
        """Gets the segment_type of this Segment.

        type of the segment

        :return: The segment_type of this Segment.
        :rtype: str
        """
    ...
    def segment_type(self, segment_type):
        """Sets the segment_type of this Segment.
        ...
        """
        allowed_values = ["ACTIVE", "PASSIVE", "GHOST", "STAFF"]  # noqa: E501
