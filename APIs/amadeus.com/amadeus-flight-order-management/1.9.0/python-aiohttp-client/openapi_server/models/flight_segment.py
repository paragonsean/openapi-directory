...
class FlightSegment(Model):
    ...
    def __init__(self, aircraft: AircraftEquipment=None, arrival: FlightEndPoint=None, booking_status: str=None, carrier_code: str=None, departure: FlightEndPoint=None, duration: str=None, is_flown: bool=None, number: str=None, operating: OperatingFlight=None, segment_type: str=None, stops: List[FlightStop]=None):
        ...
        :param booking_status: The booking_status of this FlightSegment.
        ...
        :param is_flown: The is_flown of this FlightSegment.
        :param number: The number of this FlightSegment.
        :param operating: The operating of this FlightSegment.
        :param segment_type: The segment_type of this FlightSegment.
    ...
    def booking_status(self):
        """Gets the booking_status of this FlightSegment.

        booking status of the segment

        :return: The booking_status of this FlightSegment.
        :rtype: str
        """
    ...
    def booking_status(self, booking_status):
        """Sets the booking_status of this FlightSegment.
    ...
    @property
    def is_flown(self):
        """Gets the is_flown of this FlightSegment.

        indicator set to true if segment is flown

        :return: The is_flown of this FlightSegment.
        :rtype: bool
        """
    ...
    def is_flown(self, is_flown):
        """Sets the is_flown of this FlightSegment.
    ...
    def segment_type(self):
        """Gets the segment_type of this FlightSegment.

        type of the segment

        :return: The segment_type of this FlightSegment.
        :rtype: str
        """
    ...
    def segment_type(self, segment_type):
        """Sets the segment_type of this FlightSegment.
