...
|**mealServices** | [**List&lt;MealServices&gt;**](MealServices.md) | meal services proposed for the booked segment, there can be several, for example D DINNER + B BREAKFAST |  [optional] |
