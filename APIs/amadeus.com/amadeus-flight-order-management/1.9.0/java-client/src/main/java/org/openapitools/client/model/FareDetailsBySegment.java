...
import org.openapitools.client.model.MealServices;
...
public class FareDetailsBySegment {
  ...
  public static final String SERIALIZED_NAME_MEAL_SERVICES = "mealServices";
  @SerializedName(SERIALIZED_NAME_MEAL_SERVICES)
  private List<MealServices> mealServices = new ArrayList<>();
  ...
  public FareDetailsBySegment mealServices(List<MealServices> mealServices) {
    this.mealServices = mealServices;
    return this;
  }

  public FareDetailsBySegment addMealServicesItem(MealServices mealServicesItem) {
    if (this.mealServices == null) {
      this.mealServices = new ArrayList<>();
    }
    this.mealServices.add(mealServicesItem);
    return this;
  }
  ...
  public void setMealServices(List<MealServices> mealServices) {
    this.mealServices = mealServices;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.additionalServices, fareDetailsBySegment.additionalServices) &&
        ...
        Objects.equals(this.mealServices, fareDetailsBySegment.mealServices) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(additionalServices, allotmentDetails, brandedFare, cabin, propertyClass, fareBasis, includedCheckedBags, isAllotment, mealServices, segmentId, sliceDiceIndicator);
  }
  ...
  public String toString() {
    ...
    sb.append("    mealServices: ").append(toIndentedString(mealServices)).append("\n");
  ...
  static {
    ...
    openapiFields.add("mealServices");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("mealServices") != null && !jsonObj.get("mealServices").isJsonNull()) {
        JsonArray jsonArraymealServices = jsonObj.getAsJsonArray("mealServices");
        if (jsonArraymealServices != null) {
          // ensure the json data is an array
          if (!jsonObj.get("mealServices").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `mealServices` to be an array in the JSON string but got `%s`", jsonObj.get("mealServices").toString()));
          }

          // validate the optional field `mealServices` (array)
          for (int i = 0; i < jsonArraymealServices.size(); i++) {
            MealServices.validateJsonElement(jsonArraymealServices.get(i));
          };
        }
      }
