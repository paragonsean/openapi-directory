...
public class AirTravelDocumentCommon {
  ...
  public AirTravelDocumentCommon() {
  }

  public AirTravelDocumentCommon documentNumber(String documentNumber) {
  ...
  public AirTravelDocumentCommon documentStatus(DocumentStatusEnum documentStatus) {
  ...
  public AirTravelDocumentCommon documentType(DocumentTypeEnum documentType) {
  ...
  public boolean equals(Object o) {
    ...
    AirTravelDocumentCommon airTravelDocumentCommon = (AirTravelDocumentCommon) o;
    return Objects.equals(this.documentNumber, airTravelDocumentCommon.documentNumber) &&
        Objects.equals(this.documentStatus, airTravelDocumentCommon.documentStatus) &&
        Objects.equals(this.documentType, airTravelDocumentCommon.documentType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(documentNumber, documentStatus, documentType);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AirTravelDocumentCommon {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AirTravelDocumentCommon
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AirTravelDocumentCommon.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AirTravelDocumentCommon is not found in the empty JSON string", AirTravelDocumentCommon.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AirTravelDocumentCommon.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AirTravelDocumentCommon` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AirTravelDocumentCommon.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AirTravelDocumentCommon' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AirTravelDocumentCommon> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AirTravelDocumentCommon.class));

       return (TypeAdapter<T>) new TypeAdapter<AirTravelDocumentCommon>() {
           @Override
           public void write(JsonWriter out, AirTravelDocumentCommon value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AirTravelDocumentCommon read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AirTravelDocumentCommon given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AirTravelDocumentCommon
   * @throws IOException if the JSON string is invalid with respect to AirTravelDocumentCommon
   */
  public static AirTravelDocumentCommon fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AirTravelDocumentCommon.class);
  }

  /**
   * Convert an instance of AirTravelDocumentCommon to an JSON string
   *
   * @return JSON string
   */
