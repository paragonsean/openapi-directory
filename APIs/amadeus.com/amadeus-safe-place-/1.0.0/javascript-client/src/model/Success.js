...
class Success {
     ...
     * @param data {Array.<module:model/SafetyRatedLocation>} 
     */
    constructor(data) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [SafetyRatedLocation]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['data']) { // data not null
            ...
            for (const item of data['data']) {
                SafetyRatedLocation.validateJSON(item);
            };
        }
...
/**
 * @member {Array.<module:model/SafetyRatedLocation>} data
 */
