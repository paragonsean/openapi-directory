...
/*
 * OAISafetyRatedLocation.h
 *
 * 
 */

#ifndef OAISafetyRatedLocation_H
#define OAISafetyRatedLocation_H
...
class OAIGeoCode;
class OAILinks;
class OAISafetyScore;

class OAISafetyRatedLocation : public OAIObject {
public:
    OAISafetyRatedLocation();
    OAISafetyRatedLocation(QString json);
    ~OAISafetyRatedLocation() override;
    ...
    OAISafetyScore getSafetyScore() const;
    void setSafetyScore(const OAISafetyScore &safety_score);
    bool is_safety_score_Set() const;
    bool is_safety_score_Valid() const;
...
Q_DECLARE_METATYPE(OpenAPI::OAISafetyRatedLocation)

#endif // OAISafetyRatedLocation_H
