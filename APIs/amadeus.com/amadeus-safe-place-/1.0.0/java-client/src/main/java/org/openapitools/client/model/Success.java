...
public class Success {
  ...
  private List<SafetyRatedLocation> data = new ArrayList<>();
  ...
  public Success data(List<SafetyRatedLocation> data) {
    this.data = data;
    return this;
  }

  public Success addDataItem(SafetyRatedLocation dataItem) {
    if (this.data == null) {
  ...
  public List<SafetyRatedLocation> getData() {
    return data;
  }

  public void setData(List<SafetyRatedLocation> data) {
    this.data = data;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (int i = 0; i < jsonArraydata.size(); i++) {
        SafetyRatedLocation.validateJsonElement(jsonArraydata.get(i));
      };
