...
public class RetrieveApiTest {
     ...
     */
    @Test
    public void getLocationSafetyRankingTest() throws ApiException {
        String safetyRatedLocationId = null;
        Success1 response = api.getLocationSafetyRanking(safetyRatedLocationId);
