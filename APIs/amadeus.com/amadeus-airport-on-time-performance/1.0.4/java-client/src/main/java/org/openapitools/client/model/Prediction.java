...
import org.openapitools.client.model.OnTimePrediction;
...
public class Prediction {
  ...
  public Prediction data(OnTimePrediction data) {
    this.data = data;
    return this;
  }
  ...
  public OnTimePrediction getData() {
    return data;
  }

  public void setData(OnTimePrediction data) {
    this.data = data;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        OnTimePrediction.validateJsonElement(jsonObj.get("data"));
      }
