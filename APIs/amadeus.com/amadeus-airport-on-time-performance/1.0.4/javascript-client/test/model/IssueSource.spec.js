...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AirportOnTimePerformance.IssueSource();
  });
  ...
  describe('IssueSource', function() {
    it('should create an instance of IssueSource', function() {
      ...
      //var instance = new AirportOnTimePerformance.IssueSource();
      //expect(instance).to.be.a(AirportOnTimePerformance.IssueSource);
    });
