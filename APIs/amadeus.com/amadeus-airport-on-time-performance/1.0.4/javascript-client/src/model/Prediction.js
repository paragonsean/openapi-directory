...
import OnTimePrediction from './OnTimePrediction';
...
class Prediction {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = OnTimePrediction.constructFromObject(data['data']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['data']) { // data not null
          OnTimePrediction.validateJSON(data['data']);
        }
...
/**
 * @member {module:model/OnTimePrediction} data
 */
