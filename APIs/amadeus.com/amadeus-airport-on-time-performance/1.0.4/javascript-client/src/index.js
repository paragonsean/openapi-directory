...
import OnTimePrediction from './model/OnTimePrediction';
import Prediction from './model/Prediction';
import AirportOntimePredictionApi from './api/AirportOntimePredictionApi';
...
* <pre>
* var AirportOnTimePerformance = require('index'); // See note below*.
* var xxxSvc = new AirportOnTimePerformance.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new AirportOnTimePerformance.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new AirportOnTimePerformance.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new AirportOnTimePerformance.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
...
export {
    ...
    /**
     * The OnTimePrediction model constructor.
     * @property {module:model/OnTimePrediction}
     */
    OnTimePrediction,
    ...
    /**
    * The AirportOntimePredictionApi service constructor.
    * @property {module:api/AirportOntimePredictionApi}
    */
