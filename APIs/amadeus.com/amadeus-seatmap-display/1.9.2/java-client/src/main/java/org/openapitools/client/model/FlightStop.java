...
public class FlightStop {
  ...
  public static final String SERIALIZED_NAME_NEW_AIRCRAFT = "newAircraft";
  @SerializedName(SERIALIZED_NAME_NEW_AIRCRAFT)
  ...
  @Override
  public int hashCode() {
    return Objects.hash(arrivalAt, departureAt, duration, iataCode, newAircraft);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("newAircraft") != null && !jsonObj.get("newAircraft").isJsonNull()) {
        AircraftEquipment.validateJsonElement(jsonObj.get("newAircraft"));
      }
  }
