...
|------------ | ------------- | ------------- | -------------|
|**arrivalAt** | **OffsetDateTime** | arrival at the stop in [ISO8601](https://en.wikipedia.org/wiki/ISO_8601) YYYY-MM-ddThh:mm±hh:mm format, e.g. 2017-02-10T20:40:00+02:00 |  [optional] |
|**departureAt** | **OffsetDateTime** | departure from the stop in [ISO8601](https://en.wikipedia.org/wiki/ISO_8601) YYYY-MM-ddThh:mm±hh:mm format, e.g. 2017-02-10T20:40:00+02:00 |  [optional] |
