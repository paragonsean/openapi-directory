...
class BaggageAllowance {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('excessRate')) {
                obj['excessRate'] = ElementaryPrice.constructFromObject(data['excessRate']);
            }
    ...
    static validateJSON(data) {
        // validate the optional field `excessRate`
        if (data['excessRate']) { // data not null
          ElementaryPrice.validateJSON(data['excessRate']);
        }
...
/**
 * @member {module:model/ElementaryPrice} excessRate
 */
BaggageAllowance.prototype['excessRate'] = undefined;
