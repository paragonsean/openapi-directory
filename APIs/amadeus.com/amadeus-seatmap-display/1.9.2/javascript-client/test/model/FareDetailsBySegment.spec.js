...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeatmapDisplay.FareDetailsBySegment();
  });
  ...
  describe('FareDetailsBySegment', function() {
    it('should create an instance of FareDetailsBySegment', function() {
      ...
      //var instance = new SeatmapDisplay.FareDetailsBySegment();
      //expect(instance).to.be.a(SeatmapDisplay.FareDetailsBySegment);
    });
