...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeatmapDisplay.IdentityDocument();
  });
  ...
  describe('IdentityDocument', function() {
    it('should create an instance of IdentityDocument', function() {
      ...
      //var instance = new SeatmapDisplay.IdentityDocument();
      //expect(instance).to.be.a(SeatmapDisplay.IdentityDocument);
    });
    ...
    it('should have the property issuanceCountry (base name: "issuanceCountry")', function() {
      // uncomment below and update the code to test the property issuanceCountry
      //var instance = new SeatmapDisplay.IdentityDocument();
      //expect(instance).to.be();
    });
    ...
    it('should have the property issuanceLocation (base name: "issuanceLocation")', function() {
      // uncomment below and update the code to test the property issuanceLocation
      //var instance = new SeatmapDisplay.IdentityDocument();
      //expect(instance).to.be();
    });
    ...
    it('should have the property validityCountry (base name: "validityCountry")', function() {
      // uncomment below and update the code to test the property validityCountry
      //var instance = new SeatmapDisplay.IdentityDocument();
      //expect(instance).to.be();
    });
