...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeatmapDisplay.OperatingFlight();
  });
  ...
  describe('OperatingFlight', function() {
    it('should create an instance of OperatingFlight', function() {
      // uncomment below and update the code to test OperatingFlight
      //var instance = new SeatmapDisplay.OperatingFlight();
      //expect(instance).to.be.a(SeatmapDisplay.OperatingFlight);
    });
