...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeatmapDisplay.SeatMapReply();
  });
  ...
  describe('SeatMapReply', function() {
    it('should create an instance of SeatMapReply', function() {
      // uncomment below and update the code to test SeatMapReply
      //var instance = new SeatmapDisplay.SeatMapReply();
      //expect(instance).to.be.a(SeatmapDisplay.SeatMapReply);
    });
