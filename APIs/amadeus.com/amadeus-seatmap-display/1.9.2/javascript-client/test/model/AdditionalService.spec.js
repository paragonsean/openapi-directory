...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeatmapDisplay.AdditionalService();
  });
  ...
  describe('AdditionalService', function() {
    it('should create an instance of AdditionalService', function() {
      ...
      //var instance = new SeatmapDisplay.AdditionalService();
      //expect(instance).to.be.a(SeatmapDisplay.AdditionalService);
    });
