...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeatmapDisplay.BaggageAllowance();
  });
  ...
  describe('BaggageAllowance', function() {
    it('should create an instance of BaggageAllowance', function() {
      ...
      //var instance = new SeatmapDisplay.BaggageAllowance();
      //expect(instance).to.be.a(SeatmapDisplay.BaggageAllowance);
    });

    it('should have the property excessRate (base name: "excessRate")', function() {
      // uncomment below and update the code to test the property excessRate
      //var instance = new SeatmapDisplay.BaggageAllowance();
