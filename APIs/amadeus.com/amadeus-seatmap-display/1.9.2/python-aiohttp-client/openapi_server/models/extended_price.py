...
class ExtendedPrice(Model):
    ...
    def __init__(self, base: str=None, currency: str=None, fees: List[Fee]=None, taxes: List[Tax]=None, total: str=None, additional_services: List[AdditionalService]=None, billing_currency: str=None, grand_total: str=None, margin: str=None):
