...
#ifndef OAIBaseName_H
#define OAIBaseName_H
...
class OAIBaseName : public OAIObject {
public:
    OAIBaseName();
    OAIBaseName(QString json);
    ~OAIBaseName() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBaseName)
