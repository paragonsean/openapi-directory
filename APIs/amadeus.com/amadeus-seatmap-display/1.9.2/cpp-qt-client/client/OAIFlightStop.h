...
public:
    ...
    OAIAircraftEquipment getNewAircraft() const;
    void setNewAircraft(const OAIAircraftEquipment &new_aircraft);
    bool is_new_aircraft_Set() const;
    bool is_new_aircraft_Valid() const;
...
private:
    ...
    OAIAircraftEquipment m_new_aircraft;
    bool m_new_aircraft_isSet;
    bool m_new_aircraft_isValid;
};
