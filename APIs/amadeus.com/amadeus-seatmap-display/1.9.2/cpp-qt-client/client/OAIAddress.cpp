...
QString OAIAddress::getCategory() const {
    return m_category;
}
void OAIAddress::setCategory(const QString &category) {
    m_category = category;
    m_category_isSet = true;
}

bool OAIAddress::is_category_Set() const{
    return m_category_isSet;
}

bool OAIAddress::is_category_Valid() const{
