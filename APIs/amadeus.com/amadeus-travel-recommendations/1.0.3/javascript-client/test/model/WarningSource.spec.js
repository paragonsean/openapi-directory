...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TravelRecommendationsApi.WarningSource();
  });
  ...
  describe('WarningSource', function() {
    it('should create an instance of WarningSource', function() {
      // uncomment below and update the code to test WarningSource
      //var instance = new TravelRecommendationsApi.WarningSource();
      //expect(instance).to.be.a(TravelRecommendationsApi.WarningSource);
    });
