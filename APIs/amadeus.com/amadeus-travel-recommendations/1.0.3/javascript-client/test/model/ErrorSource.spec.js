...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TravelRecommendationsApi.ErrorSource();
  });
  ...
  describe('ErrorSource', function() {
    it('should create an instance of ErrorSource', function() {
      ...
      //var instance = new TravelRecommendationsApi.ErrorSource();
      //expect(instance).to.be.a(TravelRecommendationsApi.ErrorSource);
    });
