...
- API version: 1.1.1
  - Build date: 2024-10-12T10:02:52.907592-04:00[America/New_York]
...
------------ | ------------- | ------------- | -------------
*AirTrafficApi* | [**getAirTraffic**](docs/AirTrafficApi.md#getAirTraffic) | **GET** /travel/analytics/air-traffic/traveled | Returns a list of air traffic reports.
