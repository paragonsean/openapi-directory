...
* <pre>
* var FlightMostTraveledDestinations = require('index'); // See note below*.
* var xxxSvc = new FlightMostTraveledDestinations.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new FlightMostTraveledDestinations.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new FlightMostTraveledDestinations.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new FlightMostTraveledDestinations.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
...
export {
    ...
    /**
     * The Flights model constructor.
     * @property {module:model/Flights}
     */
    Flights,
