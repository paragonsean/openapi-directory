...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightMostTraveledDestinations.IssueSource();
  });
  ...
  describe('IssueSource', function() {
    it('should create an instance of IssueSource', function() {
      ...
      //var instance = new FlightMostTraveledDestinations.IssueSource();
      //expect(instance).to.be.a(FlightMostTraveledDestinations.IssueSource);
    });
