...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightMostTraveledDestinations.CollectionLinks();
  });
  ...
  describe('CollectionLinks', function() {
    it('should create an instance of CollectionLinks', function() {
      ...
      //var instance = new FlightMostTraveledDestinations.CollectionLinks();
      //expect(instance).to.be.a(FlightMostTraveledDestinations.CollectionLinks);
    });
