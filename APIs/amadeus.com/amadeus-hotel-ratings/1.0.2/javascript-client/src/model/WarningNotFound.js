...
/**
 * The WarningNotFound model module.
 * @module model/WarningNotFound
 * @version 1.0.2
 */
class WarningNotFound {
    /**
     * Constructs a new <code>WarningNotFound</code>.
     * @alias module:model/WarningNotFound
     * @implements module:model/Warning
    ...
    constructor(code, title) { 
        ...
        WarningNotFound.initialize(this, code, title);
    }
    ...
    /**
     * Constructs a <code>WarningNotFound</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WarningNotFound} obj Optional instance to populate.
     * @return {module:model/WarningNotFound} The populated <code>WarningNotFound</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WarningNotFound();
            Warning.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>WarningNotFound</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WarningNotFound</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WarningNotFound.RequiredProperties) {
...
WarningNotFound.RequiredProperties = ["code", "title"];
 ...
 * @member {Number} code
 */
WarningNotFound.prototype['code'] = undefined;
 ...
 */
WarningNotFound.prototype['detail'] = undefined;
 ...
 */
WarningNotFound.prototype['documentation'] = undefined;

/**
 * @member {module:model/ErrorSource} source
 */
WarningNotFound.prototype['source'] = undefined;

/**
 * An error title from the Canned Messages table with a 1:1 correspondence to the error code. This may be localized
 * @member {String} title
 */
WarningNotFound.prototype['title'] = undefined;


// Implement Warning interface:
/**
 * A machine-readable error code from the Canned Messages table, that will enable the API Consumers code to handle this type of error
 * @member {Number} code
 */
