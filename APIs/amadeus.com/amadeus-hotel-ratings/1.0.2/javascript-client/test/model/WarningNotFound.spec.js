...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HotelRatings.WarningNotFound();
  });
  ...
  describe('WarningNotFound', function() {
    it('should create an instance of WarningNotFound', function() {
      // uncomment below and update the code to test WarningNotFound
      //var instance = new HotelRatings.WarningNotFound();
      //expect(instance).to.be.a(HotelRatings.WarningNotFound);
    });
