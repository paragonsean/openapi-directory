...
class Warning(Model):
    ...
    def __init__(self, code: int=None, detail: str=None, documentation: str=None, source: ErrorSource=None, title: str=None):
        ...
        :param documentation: The documentation of this Warning.
        :param source: The source of this Warning.
    ...
    def documentation(self, documentation):
        """Sets the documentation of this Warning.
    ...
    @property
    def source(self):
        """Gets the source of this Warning.


        :return: The source of this Warning.
        :rtype: ErrorSource
        """
        return self._source
    ...
    def source(self, source):
        """Sets the source of this Warning.
