...
#ifndef OAICollectionMeta_H
#define OAICollectionMeta_H
...
class OAICollectionMeta : public OAIObject {
public:
    OAICollectionMeta();
    OAICollectionMeta(QString json);
    ~OAICollectionMeta() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICollectionMeta)

#endif // OAICollectionMeta_H
