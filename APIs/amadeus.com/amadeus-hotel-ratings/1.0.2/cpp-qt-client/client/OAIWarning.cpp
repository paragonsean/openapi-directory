...
QString OAIWarning::getDocumentation() const {
    return m_documentation;
}
void OAIWarning::setDocumentation(const QString &documentation) {
    m_documentation = documentation;
    m_documentation_isSet = true;
}

bool OAIWarning::is_documentation_Set() const{
    return m_documentation_isSet;
}

bool OAIWarning::is_documentation_Valid() const{
    return m_documentation_isValid;
}

OAIErrorSource OAIWarning::getSource() const {
    return m_source;
}
void OAIWarning::setSource(const OAIErrorSource &source) {
    m_source = source;
    m_source_isSet = true;
}
