...
QString OAIError::getDocumentation() const {
    return m_documentation;
}
void OAIError::setDocumentation(const QString &documentation) {
    m_documentation = documentation;
    m_documentation_isSet = true;
}

bool OAIError::is_documentation_Set() const{
    return m_documentation_isSet;
}

bool OAIError::is_documentation_Valid() const{
