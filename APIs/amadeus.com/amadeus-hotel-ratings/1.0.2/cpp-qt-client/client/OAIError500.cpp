...
QList<OAIError> OAIError500::getErrors() const {
    return m_errors;
}
void OAIError500::setErrors(const QList<OAIError> &errors) {
    m_errors = errors;
    m_errors_isSet = true;
}

bool OAIError500::is_errors_Set() const{
    return m_errors_isSet;
}

bool OAIError500::is_errors_Valid() const{
