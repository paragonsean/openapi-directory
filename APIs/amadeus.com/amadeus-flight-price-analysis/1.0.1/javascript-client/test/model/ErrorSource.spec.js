...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightPriceAnalysisApi.ErrorSource();
  });
  ...
  describe('ErrorSource', function() {
    it('should create an instance of ErrorSource', function() {
      ...
      //var instance = new FlightPriceAnalysisApi.ErrorSource();
      //expect(instance).to.be.a(FlightPriceAnalysisApi.ErrorSource);
    });
