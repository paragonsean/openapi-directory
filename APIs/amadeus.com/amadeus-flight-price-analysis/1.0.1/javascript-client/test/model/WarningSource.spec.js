...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightPriceAnalysisApi.WarningSource();
  });
  ...
  describe('WarningSource', function() {
    it('should create an instance of WarningSource', function() {
      ...
      //var instance = new FlightPriceAnalysisApi.WarningSource();
      //expect(instance).to.be.a(FlightPriceAnalysisApi.WarningSource);
    });
