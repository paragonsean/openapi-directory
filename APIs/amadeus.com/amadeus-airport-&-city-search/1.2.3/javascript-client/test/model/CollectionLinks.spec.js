...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AirportCitySearch.CollectionLinks();
  });
  ...
  describe('CollectionLinks', function() {
    it('should create an instance of CollectionLinks', function() {
      ...
      //var instance = new AirportCitySearch.CollectionLinks();
      //expect(instance).to.be.a(AirportCitySearch.CollectionLinks);
    });
