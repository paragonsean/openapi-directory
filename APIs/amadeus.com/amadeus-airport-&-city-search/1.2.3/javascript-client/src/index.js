...
* <pre>
* var AirportCitySearch = require('index'); // See note below*.
* var xxxSvc = new AirportCitySearch.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new AirportCitySearch.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new AirportCitySearch.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new AirportCitySearch.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
