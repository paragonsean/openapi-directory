...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HotelBooking.Room();
  });
  ...
  describe('Room', function() {
    it('should create an instance of Room', function() {
      ...
      //var instance = new HotelBooking.Room();
      //expect(instance).to.be.a(HotelBooking.Room);
    });

    it('should have the property guestIds (base name: "guestIds")', function() {
      // uncomment below and update the code to test the property guestIds
      //var instance = new HotelBooking.Room();
    ...
    it('should have the property specialRequest (base name: "specialRequest")', function() {
      // uncomment below and update the code to test the property specialRequest
      //var instance = new HotelBooking.Room();
      //expect(instance).to.be();
    });
