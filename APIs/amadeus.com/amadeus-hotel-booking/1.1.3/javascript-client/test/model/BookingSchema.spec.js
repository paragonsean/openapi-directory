...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HotelBooking.BookingSchema();
  });
  ...
  describe('BookingSchema', function() {
    it('should create an instance of BookingSchema', function() {
      // uncomment below and update the code to test BookingSchema
      //var instance = new HotelBooking.BookingSchema();
      //expect(instance).to.be.a(HotelBooking.BookingSchema);
    });
