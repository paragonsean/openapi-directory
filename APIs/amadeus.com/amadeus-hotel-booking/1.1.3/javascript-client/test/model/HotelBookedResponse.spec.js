...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HotelBooking.HotelBookedResponse();
  });
  ...
  describe('HotelBookedResponse', function() {
    it('should create an instance of HotelBookedResponse', function() {
      // uncomment below and update the code to test HotelBookedResponse
      //var instance = new HotelBooking.HotelBookedResponse();
      //expect(instance).to.be.a(HotelBooking.HotelBookedResponse);
    });
