...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HotelBooking.Stakeholder();
  });
  ...
  describe('Stakeholder', function() {
    it('should create an instance of Stakeholder', function() {
      ...
      //var instance = new HotelBooking.Stakeholder();
      //expect(instance).to.be.a(HotelBooking.Stakeholder);
    });
    ...
    it('should have the property hotelRewardsMember (base name: "hotelRewardsMember")', function() {
      // uncomment below and update the code to test the property hotelRewardsMember
      //var instance = new HotelBooking.Stakeholder();
      //expect(instance).to.be();
    });
