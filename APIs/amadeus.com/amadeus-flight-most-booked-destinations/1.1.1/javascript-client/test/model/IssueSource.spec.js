...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightMostBookedDestinations.IssueSource();
  });
  ...
  describe('IssueSource', function() {
    it('should create an instance of IssueSource', function() {
      ...
      //var instance = new FlightMostBookedDestinations.IssueSource();
      //expect(instance).to.be.a(FlightMostBookedDestinations.IssueSource);
    });
