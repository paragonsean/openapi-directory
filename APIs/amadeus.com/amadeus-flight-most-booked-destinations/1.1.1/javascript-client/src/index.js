...
* <pre>
* var FlightMostBookedDestinations = require('index'); // See note below*.
* var xxxSvc = new FlightMostBookedDestinations.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new FlightMostBookedDestinations.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new FlightMostBookedDestinations.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new FlightMostBookedDestinations.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
