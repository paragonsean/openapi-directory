...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AirlineCodeLookupApi.CollectionLinks();
  });
  ...
  describe('CollectionLinks', function() {
    it('should create an instance of CollectionLinks', function() {
      ...
      //var instance = new AirlineCodeLookupApi.CollectionLinks();
      //expect(instance).to.be.a(AirlineCodeLookupApi.CollectionLinks);
    });
