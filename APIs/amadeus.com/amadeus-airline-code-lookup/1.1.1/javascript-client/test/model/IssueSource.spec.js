...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AirlineCodeLookupApi.IssueSource();
  });
  ...
  describe('IssueSource', function() {
    it('should create an instance of IssueSource', function() {
      ...
      //var instance = new AirlineCodeLookupApi.IssueSource();
      //expect(instance).to.be.a(AirlineCodeLookupApi.IssueSource);
    });
