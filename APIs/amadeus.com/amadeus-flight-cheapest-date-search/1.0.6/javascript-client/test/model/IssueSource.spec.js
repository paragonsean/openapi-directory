...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightCheapestDateSearch.IssueSource();
  });
  ...
  describe('IssueSource', function() {
    it('should create an instance of IssueSource', function() {
      ...
      //var instance = new FlightCheapestDateSearch.IssueSource();
      //expect(instance).to.be.a(FlightCheapestDateSearch.IssueSource);
    });
