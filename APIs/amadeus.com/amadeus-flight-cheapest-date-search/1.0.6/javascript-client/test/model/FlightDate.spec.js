...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightCheapestDateSearch.FlightDate();
  });
  ...
  describe('FlightDate', function() {
    it('should create an instance of FlightDate', function() {
      // uncomment below and update the code to test FlightDate
      //var instance = new FlightCheapestDateSearch.FlightDate();
      //expect(instance).to.be.a(FlightCheapestDateSearch.FlightDate);
    });
