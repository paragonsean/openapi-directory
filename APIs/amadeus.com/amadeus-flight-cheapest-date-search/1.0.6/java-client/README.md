...
- API version: 1.0.6
  - Build date: 2024-10-12T10:03:20.773098-04:00[America/New_York]
...
------------ | ------------- | ------------- | -------------
*FlightDatesApi* | [**getFlightDates**](docs/FlightDatesApi.md#getFlightDates) | **GET** /shopping/flight-dates | Find the cheapest flight dates from an origin to a destination.
...
## Documentation for Models
 ...
 - [FlightDate](docs/FlightDate.md)
 - [FlightDateLinks](docs/FlightDateLinks.md)
