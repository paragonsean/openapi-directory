...
FlightInspirationSearch - JavaScript client for flight_inspiration_search
...
```shell
npm install flight_inspiration_search --save
```
...
To use the link you just defined in your project, switch to the directory you want to use your flight_inspiration_search from, and run:
...
```javascript
var FlightInspirationSearch = require('flight_inspiration_search');


var api = new FlightInspirationSearch.FlightDestinationsApi()
...
api.getFlightDestinations(origin, opts, callback);
...
------------ | ------------- | ------------- | -------------
*FlightInspirationSearch.FlightDestinationsApi* | [**getFlightDestinations**](docs/FlightDestinationsApi.md#getFlightDestinations) | **GET** /shopping/flight-destinations | Find the cheapest destinations where you can fly to.


## Documentation for Models

 - [FlightInspirationSearch.Defaults](docs/Defaults.md)
 - [FlightInspirationSearch.Dictionaries](docs/Dictionaries.md)
 - [FlightInspirationSearch.Error400](docs/Error400.md)
 - [FlightInspirationSearch.Error404](docs/Error404.md)
 - [FlightInspirationSearch.Error500](docs/Error500.md)
 - [FlightInspirationSearch.FlightDestination](docs/FlightDestination.md)
 - [FlightInspirationSearch.FlightDestinationLinks](docs/FlightDestinationLinks.md)
 - [FlightInspirationSearch.FlightDestinations](docs/FlightDestinations.md)
 - [FlightInspirationSearch.Issue](docs/Issue.md)
 - [FlightInspirationSearch.IssueSource](docs/IssueSource.md)
 - [FlightInspirationSearch.Links](docs/Links.md)
 - [FlightInspirationSearch.LocationValue](docs/LocationValue.md)
 - [FlightInspirationSearch.Meta](docs/Meta.md)
 - [FlightInspirationSearch.Price](docs/Price.md)
