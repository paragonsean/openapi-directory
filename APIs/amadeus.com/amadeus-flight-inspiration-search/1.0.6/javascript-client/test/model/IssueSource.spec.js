...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightInspirationSearch.IssueSource();
  });
  ...
  describe('IssueSource', function() {
    it('should create an instance of IssueSource', function() {
      ...
      //var instance = new FlightInspirationSearch.IssueSource();
      //expect(instance).to.be.a(FlightInspirationSearch.IssueSource);
    });
