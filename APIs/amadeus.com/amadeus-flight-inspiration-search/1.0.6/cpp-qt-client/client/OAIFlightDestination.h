...
/*
 * OAIFlightDestination.h
 *
 * 
 */

#ifndef OAIFlightDestination_H
#define OAIFlightDestination_H
...
namespace OpenAPI {
class OAIFlightDestination_links;
class OAIPrice;

class OAIFlightDestination : public OAIObject {
public:
    OAIFlightDestination();
    OAIFlightDestination(QString json);
    ~OAIFlightDestination() override;
    ...
    OAIFlightDestination_links getLinks() const;
    void setLinks(const OAIFlightDestination_links &links);
...
private:
    ...
    OAIFlightDestination_links m_links;
    bool m_links_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFlightDestination)

#endif // OAIFlightDestination_H
