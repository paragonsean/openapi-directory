...
/*
 * OAIFlightDestinations.h
 *
 * 
 */

#ifndef OAIFlightDestinations_H
#define OAIFlightDestinations_H
...
namespace OpenAPI {
class OAIFlightDestination;
class OAIDictionaries;
class OAIMeta;
class OAIIssue;

class OAIFlightDestinations : public OAIObject {
public:
    OAIFlightDestinations();
    OAIFlightDestinations(QString json);
    ~OAIFlightDestinations() override;
    ...
    QList<OAIFlightDestination> getData() const;
    void setData(const QList<OAIFlightDestination> &data);
...
private:
    ...
    QList<OAIFlightDestination> m_data;
    bool m_data_isSet;
    bool m_data_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFlightDestinations)

#endif // OAIFlightDestinations_H
