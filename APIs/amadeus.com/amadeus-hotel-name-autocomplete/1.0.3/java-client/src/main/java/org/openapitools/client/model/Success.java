...
public class Success {
  ...
  private List<SuccessDataInner> data = new ArrayList<>();

  public Success() {
  }

  public Success data(List<SuccessDataInner> data) {
    this.data = data;
    return this;
  }

  public Success addDataItem(SuccessDataInner dataItem) {
    if (this.data == null) {
  ...
  public List<SuccessDataInner> getData() {
    return data;
  }

  public void setData(List<SuccessDataInner> data) {
    this.data = data;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (int i = 0; i < jsonArraydata.size(); i++) {
        SuccessDataInner.validateJsonElement(jsonArraydata.get(i));
      };
  }
