...
void OAISearchApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("gethotels", defaultConf);
    _serverIndices.insert("gethotels", 0);
}
...
void OAISearchApi::gethotels(const QString &keyword, const QList<QString> &sub_type, const ::OpenAPI::OptionalParam<QString> &country_code, const ::OpenAPI::OptionalParam<QString> &lang, const ::OpenAPI::OptionalParam<qint32> &max) {
    QString fullPath = QString(_serverConfigs["gethotels"][_serverIndices.value("gethotels")].URL()+"/reference-data/locations/hotel");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISearchApi::gethotelsCallback);
...
void OAISearchApi::gethotelsCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT gethotelsSignal(output);
        Q_EMIT gethotelsSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT gethotelsSignalE(output, error_type, error_str);
        Q_EMIT gethotelsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT gethotelsSignalError(output, error_type, error_str);
        Q_EMIT gethotelsSignalErrorFull(worker, error_type, error_str);
    }
}
