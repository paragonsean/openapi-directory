...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightBusiestTravelingPeriod.Analytics();
  });
  ...
  describe('Analytics', function() {
    it('should create an instance of Analytics', function() {
      ...
      //var instance = new FlightBusiestTravelingPeriod.Analytics();
      //expect(instance).to.be.a(FlightBusiestTravelingPeriod.Analytics);
    });
