...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightBusiestTravelingPeriod.IssueSource();
  });
  ...
  describe('IssueSource', function() {
    it('should create an instance of IssueSource', function() {
      ...
      //var instance = new FlightBusiestTravelingPeriod.IssueSource();
      //expect(instance).to.be.a(FlightBusiestTravelingPeriod.IssueSource);
    });
