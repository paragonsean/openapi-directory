...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightBusiestTravelingPeriod.Success();
  });
  ...
  describe('Success', function() {
    it('should create an instance of Success', function() {
      ...
      //var instance = new FlightBusiestTravelingPeriod.Success();
      //expect(instance).to.be.a(FlightBusiestTravelingPeriod.Success);
    });
