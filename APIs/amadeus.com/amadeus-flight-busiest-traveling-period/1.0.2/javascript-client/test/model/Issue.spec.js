...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightBusiestTravelingPeriod.Issue();
  });
  ...
  describe('Issue', function() {
    it('should create an instance of Issue', function() {
      ...
      //var instance = new FlightBusiestTravelingPeriod.Issue();
      //expect(instance).to.be.a(FlightBusiestTravelingPeriod.Issue);
    });
