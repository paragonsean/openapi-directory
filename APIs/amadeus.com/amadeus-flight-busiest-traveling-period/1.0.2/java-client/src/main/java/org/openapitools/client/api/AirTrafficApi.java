...
public class AirTrafficApi {
     ...
     */
    public okhttp3.Call getAirTrafficCall(String cityCode, String period, String direction, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/travel/analytics/air-traffic/busiest-period";
        ...
        if (cityCode != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("cityCode", cityCode));
        }
    ...
    private okhttp3.Call getAirTrafficValidateBeforeCall(String cityCode, String period, String direction, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'cityCode' is set
        if (cityCode == null) {
            throw new ApiException("Missing the required parameter 'cityCode' when calling getAirTraffic(Async)");
        }
        ...
        return getAirTrafficCall(cityCode, period, direction, _callback);
     ...
     */
    public Success getAirTraffic(String cityCode, String period, String direction) throws ApiException {
        ApiResponse<Success> localVarResp = getAirTrafficWithHttpInfo(cityCode, period, direction);
     ...
     */
    public ApiResponse<Success> getAirTrafficWithHttpInfo(String cityCode, String period, String direction) throws ApiException {
        okhttp3.Call localVarCall = getAirTrafficValidateBeforeCall(cityCode, period, direction, null);
     ...
     */
    public okhttp3.Call getAirTrafficAsync(String cityCode, String period, String direction, final ApiCallback<Success> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAirTrafficValidateBeforeCall(cityCode, period, direction, _callback);
        Type localVarReturnType = new TypeToken<Success>(){}.getType();
