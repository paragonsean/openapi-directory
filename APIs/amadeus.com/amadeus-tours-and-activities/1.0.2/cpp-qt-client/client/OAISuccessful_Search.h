...
/*
 * OAISuccessful_Search.h
 *
 * 
 */

#ifndef OAISuccessful_Search_H
#define OAISuccessful_Search_H
...
class OAISuccessful_Search : public OAIObject {
public:
    OAISuccessful_Search();
    OAISuccessful_Search(QString json);
    ~OAISuccessful_Search() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISuccessful_Search)

#endif // OAISuccessful_Search_H
