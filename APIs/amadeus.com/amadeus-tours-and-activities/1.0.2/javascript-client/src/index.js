...
* <pre>
* var ToursAndActivities = require('index'); // See note below*.
* var xxxSvc = new ToursAndActivities.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new ToursAndActivities.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new ToursAndActivities.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new ToursAndActivities.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
...
export {
    ...
    /**
     * The SuccessfulSearch model constructor.
     * @property {module:model/SuccessfulSearch}
     */
    SuccessfulSearch,

    /**
     * The SuccessfulSearch1 model constructor.
     * @property {module:model/SuccessfulSearch1}
     */
    SuccessfulSearch1,
