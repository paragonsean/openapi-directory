...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ToursAndActivities.SearchApi();
  });
  ...
  describe('SearchApi', function() {
    ...
    describe('listActivitiesBySquare', function() {
      it('should call listActivitiesBySquare successfully', function(done) {
        //uncomment below and update the code to test listActivitiesBySquare
        //instance.listActivitiesBySquare(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
