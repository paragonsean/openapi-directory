...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ToursAndActivities.CollectionLinks();
  });
  ...
  describe('CollectionLinks', function() {
    it('should create an instance of CollectionLinks', function() {
      ...
      //var instance = new ToursAndActivities.CollectionLinks();
      //expect(instance).to.be.a(ToursAndActivities.CollectionLinks);
    });
