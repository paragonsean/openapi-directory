...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TripPurposePrediction.IssueSource();
  });
  ...
  describe('IssueSource', function() {
    it('should create an instance of IssueSource', function() {
      ...
      //var instance = new TripPurposePrediction.IssueSource();
      //expect(instance).to.be.a(TripPurposePrediction.IssueSource);
    });
