...
from openapi_server.models.purpose_prediction import PurposePrediction
...
class Prediction(Model):
    ...
    def __init__(self, data: PurposePrediction=None, meta: Meta=None):
