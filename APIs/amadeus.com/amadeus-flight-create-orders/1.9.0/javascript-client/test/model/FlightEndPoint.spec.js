...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightCreateOrders.FlightEndPoint();
  });
  ...
  describe('FlightEndPoint', function() {
    it('should create an instance of FlightEndPoint', function() {
      ...
      //var instance = new FlightCreateOrders.FlightEndPoint();
      //expect(instance).to.be.a(FlightCreateOrders.FlightEndPoint);
    });
