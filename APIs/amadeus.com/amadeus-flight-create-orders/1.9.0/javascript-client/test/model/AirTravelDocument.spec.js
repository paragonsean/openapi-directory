...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightCreateOrders.AirTravelDocument();
  });
  ...
  describe('AirTravelDocument', function() {
    it('should create an instance of AirTravelDocument', function() {
      ...
      //var instance = new FlightCreateOrders.AirTravelDocument();
      //expect(instance).to.be.a(FlightCreateOrders.AirTravelDocument);
    });
