...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightCreateOrders.AdditionalService();
  });
  ...
  describe('AdditionalService', function() {
    it('should create an instance of AdditionalService', function() {
      ...
      //var instance = new FlightCreateOrders.AdditionalService();
      //expect(instance).to.be.a(FlightCreateOrders.AdditionalService);
    });
