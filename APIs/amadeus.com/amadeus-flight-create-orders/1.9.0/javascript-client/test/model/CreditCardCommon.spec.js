...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightCreateOrders.CreditCardCommon();
  });
  ...
  describe('CreditCardCommon', function() {
    it('should create an instance of CreditCardCommon', function() {
      // uncomment below and update the code to test CreditCardCommon
      //var instance = new FlightCreateOrders.CreditCardCommon();
      //expect(instance).to.be.a(FlightCreateOrders.CreditCardCommon);
    });
