...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightCreateOrders.AutomatedProcess();
  });
  ...
  describe('AutomatedProcess', function() {
    it('should create an instance of AutomatedProcess', function() {
      // uncomment below and update the code to test AutomatedProcess
      //var instance = new FlightCreateOrders.AutomatedProcess();
      //expect(instance).to.be.a(FlightCreateOrders.AutomatedProcess);
    });
