...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightCreateOrders.TravelerPricing();
  });
  ...
  describe('TravelerPricing', function() {
    it('should create an instance of TravelerPricing', function() {
      ...
      //var instance = new FlightCreateOrders.TravelerPricing();
      //expect(instance).to.be.a(FlightCreateOrders.TravelerPricing);
    });
