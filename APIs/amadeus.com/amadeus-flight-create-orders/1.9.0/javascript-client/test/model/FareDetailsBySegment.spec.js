...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightCreateOrders.FareDetailsBySegment();
  });
  ...
  describe('FareDetailsBySegment', function() {
    it('should create an instance of FareDetailsBySegment', function() {
      ...
      //var instance = new FlightCreateOrders.FareDetailsBySegment();
      //expect(instance).to.be.a(FlightCreateOrders.FareDetailsBySegment);
    });
