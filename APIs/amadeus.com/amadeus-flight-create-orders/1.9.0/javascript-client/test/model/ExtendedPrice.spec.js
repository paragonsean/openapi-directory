...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightCreateOrders.ExtendedPrice();
  });
  ...
  describe('ExtendedPrice', function() {
    it('should create an instance of ExtendedPrice', function() {
      ...
      //var instance = new FlightCreateOrders.ExtendedPrice();
      //expect(instance).to.be.a(FlightCreateOrders.ExtendedPrice);
    });
