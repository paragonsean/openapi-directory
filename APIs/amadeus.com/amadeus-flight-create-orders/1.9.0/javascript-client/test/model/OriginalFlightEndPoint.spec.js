...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightCreateOrders.OriginalFlightEndPoint();
  });
  ...
  describe('OriginalFlightEndPoint', function() {
    it('should create an instance of OriginalFlightEndPoint', function() {
      ...
      //var instance = new FlightCreateOrders.OriginalFlightEndPoint();
      //expect(instance).to.be.a(FlightCreateOrders.OriginalFlightEndPoint);
    });
