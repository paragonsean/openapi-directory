...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightCreateOrders.BaggageAllowance();
  });
  ...
  describe('BaggageAllowance', function() {
    it('should create an instance of BaggageAllowance', function() {
      ...
      //var instance = new FlightCreateOrders.BaggageAllowance();
      //expect(instance).to.be.a(FlightCreateOrders.BaggageAllowance);
    });
