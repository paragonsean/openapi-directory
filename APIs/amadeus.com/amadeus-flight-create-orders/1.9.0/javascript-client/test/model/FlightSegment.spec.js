...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightCreateOrders.FlightSegment();
  });
  ...
  describe('FlightSegment', function() {
    it('should create an instance of FlightSegment', function() {
      ...
      //var instance = new FlightCreateOrders.FlightSegment();
      //expect(instance).to.be.a(FlightCreateOrders.FlightSegment);
    });
