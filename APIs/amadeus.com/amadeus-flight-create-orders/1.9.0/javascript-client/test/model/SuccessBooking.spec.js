...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightCreateOrders.SuccessBooking();
  });
  ...
  describe('SuccessBooking', function() {
    it('should create an instance of SuccessBooking', function() {
      ...
      //var instance = new FlightCreateOrders.SuccessBooking();
      //expect(instance).to.be.a(FlightCreateOrders.SuccessBooking);
    });
