...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightCreateOrders.GeneralRemark();
  });
  ...
  describe('GeneralRemark', function() {
    it('should create an instance of GeneralRemark', function() {
      // uncomment below and update the code to test GeneralRemark
      //var instance = new FlightCreateOrders.GeneralRemark();
      //expect(instance).to.be.a(FlightCreateOrders.GeneralRemark);
    });
