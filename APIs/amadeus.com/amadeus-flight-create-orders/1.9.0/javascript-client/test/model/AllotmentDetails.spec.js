...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightCreateOrders.AllotmentDetails();
  });
  ...
  describe('AllotmentDetails', function() {
    it('should create an instance of AllotmentDetails', function() {
      ...
      //var instance = new FlightCreateOrders.AllotmentDetails();
      //expect(instance).to.be.a(FlightCreateOrders.AllotmentDetails);
    });
