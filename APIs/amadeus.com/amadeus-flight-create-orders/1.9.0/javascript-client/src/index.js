...
* <pre>
* var FlightCreateOrders = require('index'); // See note below*.
* var xxxSvc = new FlightCreateOrders.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new FlightCreateOrders.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new FlightCreateOrders.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new FlightCreateOrders.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
...
export {
    ...
    /**
     * The FlightOrderQuery model constructor.
     * @property {module:model/FlightOrderQuery}
     */
    FlightOrderQuery,
