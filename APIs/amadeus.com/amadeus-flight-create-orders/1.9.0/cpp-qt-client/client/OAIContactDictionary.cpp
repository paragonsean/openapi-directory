...
QString OAIContactDictionary::getLanguage() const {
    return m_language;
}
void OAIContactDictionary::setLanguage(const QString &language) {
    m_language = language;
    m_language_isSet = true;
}

bool OAIContactDictionary::is_language_Set() const{
    return m_language_isSet;
}

bool OAIContactDictionary::is_language_Valid() const{
