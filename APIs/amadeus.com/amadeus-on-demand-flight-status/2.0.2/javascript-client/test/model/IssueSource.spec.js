...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnDemandFlightStatus.IssueSource();
  });
  ...
  describe('IssueSource', function() {
    it('should create an instance of IssueSource', function() {
      ...
      //var instance = new OnDemandFlightStatus.IssueSource();
      //expect(instance).to.be.a(OnDemandFlightStatus.IssueSource);
    });
