...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnDemandFlightStatus.CollectionLinks();
  });
  ...
  describe('CollectionLinks', function() {
    it('should create an instance of CollectionLinks', function() {
      ...
      //var instance = new OnDemandFlightStatus.CollectionLinks();
      //expect(instance).to.be.a(OnDemandFlightStatus.CollectionLinks);
    });
