...
* <pre>
* var PointsOfInterest = require('index'); // See note below*.
* var xxxSvc = new PointsOfInterest.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new PointsOfInterest.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new PointsOfInterest.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new PointsOfInterest.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
