...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PointsOfInterest.CollectionLinks();
  });
  ...
  describe('CollectionLinks', function() {
    it('should create an instance of CollectionLinks', function() {
      ...
      //var instance = new PointsOfInterest.CollectionLinks();
      //expect(instance).to.be.a(PointsOfInterest.CollectionLinks);
    });
