...
Points of Interest
- API version: 1.1.1
  - Build date: 2024-10-12T10:03:31.062296-04:00[America/New_York]
...
------------ | ------------- | ------------- | -------------
*RetrieveApi* | [**getPointOfInterest**](docs/RetrieveApi.md#getPointOfInterest) | **GET** /reference-data/locations/pois/{poisId} | Retieve one point of interest by its Id.
*SearchApi* | [**getPointsOfInterest**](docs/SearchApi.md#getPointsOfInterest) | **GET** /reference-data/locations/pois | Returns points of interest for a given location and radius.
*SearchApi* | [**getPointsOfInterestBySquare**](docs/SearchApi.md#getPointsOfInterestBySquare) | **GET** /reference-data/locations/pois/by-square | Returns points of interest for a given area
