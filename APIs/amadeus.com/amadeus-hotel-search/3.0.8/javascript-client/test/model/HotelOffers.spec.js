...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HotelSearchApi.HotelOffers();
  });
  ...
  describe('HotelOffers', function() {
    it('should create an instance of HotelOffers', function() {
      // uncomment below and update the code to test HotelOffers
      //var instance = new HotelSearchApi.HotelOffers();
      //expect(instance).to.be.a(HotelSearchApi.HotelOffers);
    });
