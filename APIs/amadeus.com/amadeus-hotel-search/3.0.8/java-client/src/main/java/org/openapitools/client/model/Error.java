...
public class Error {
  ...
  public Error documentation(String documentation) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, error.code) &&
        ...
        Objects.equals(this.documentation, error.documentation) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(code, detail, documentation, source, status, title);
  }
