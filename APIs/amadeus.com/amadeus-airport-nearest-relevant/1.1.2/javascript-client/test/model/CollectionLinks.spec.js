...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AirportNearestRelevant.CollectionLinks();
  });
  ...
  describe('CollectionLinks', function() {
    it('should create an instance of CollectionLinks', function() {
      ...
      //var instance = new AirportNearestRelevant.CollectionLinks();
      //expect(instance).to.be.a(AirportNearestRelevant.CollectionLinks);
    });
