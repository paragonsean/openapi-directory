...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AirportNearestRelevant.IssueSource();
  });
  ...
  describe('IssueSource', function() {
    it('should create an instance of IssueSource', function() {
      ...
      //var instance = new AirportNearestRelevant.IssueSource();
      //expect(instance).to.be.a(AirportNearestRelevant.IssueSource);
    });
