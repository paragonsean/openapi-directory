...
* <pre>
* var AirportNearestRelevant = require('index'); // See note below*.
* var xxxSvc = new AirportNearestRelevant.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new AirportNearestRelevant.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new AirportNearestRelevant.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new AirportNearestRelevant.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
