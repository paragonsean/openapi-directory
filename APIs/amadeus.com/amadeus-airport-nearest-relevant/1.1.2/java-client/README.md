...
- API version: 1.1.2
  - Build date: 2024-10-12T10:03:32.150851-04:00[America/New_York]
...
------------ | ------------- | ------------- | -------------
*LocationApi* | [**getNearestRelevantAirports**](docs/LocationApi.md#getNearestRelevantAirports) | **GET** /reference-data/locations/airports | Returns a list of relevant airports near to a given point.
