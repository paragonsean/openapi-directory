...
public class LocationApiTest {
     ...
     */
    @Test
    public void getNearestRelevantAirportsTest() throws ApiException {
        ...
        String sort = null;
        Success response = api.getNearestRelevantAirports(latitude, longitude, radius, pageLimit, pageOffset, sort);
