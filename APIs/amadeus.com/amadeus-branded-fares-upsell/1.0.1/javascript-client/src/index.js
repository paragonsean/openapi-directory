...
import CollectionMetaUpsell from './model/CollectionMetaUpsell';
...
import FlightOfferUpsellIn from './model/FlightOfferUpsellIn';
...
import OneWayUpselledCombinations from './model/OneWayUpselledCombinations';
...
* <pre>
* var BrandedFaresUpsell = require('index'); // See note below*.
* var xxxSvc = new BrandedFaresUpsell.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new BrandedFaresUpsell.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new BrandedFaresUpsell.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new BrandedFaresUpsell.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
...
export {
    ...
    /**
     * The AmenityType model constructor.
     * @property {module:model/AmenityType}
     */
    AmenityType,
    ...
    /**
     * The CollectionMetaUpsell model constructor.
     * @property {module:model/CollectionMetaUpsell}
     */
    ...
    /**
     * The FlightOfferUpsellIn model constructor.
     * @property {module:model/FlightOfferUpsellIn}
     */
    FlightOfferUpsellIn,
    ...
    /**
     * The GetUpsellQuery model constructor.
     * @property {module:model/GetUpsellQuery}
     */
    GetUpsellQuery,
    ...
    /**
     * The OneWayUpselledCombinations model constructor.
     * @property {module:model/OneWayUpselledCombinations}
     */
    ...
    /**
     * The SuccessUpsell model constructor.
     * @property {module:model/SuccessUpsell}
     */
    SuccessUpsell,
