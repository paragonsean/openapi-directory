...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrandedFaresUpsell.AdditionalService();
  });
  ...
  describe('AdditionalService', function() {
    it('should create an instance of AdditionalService', function() {
      ...
      //var instance = new BrandedFaresUpsell.AdditionalService();
      //expect(instance).to.be.a(BrandedFaresUpsell.AdditionalService);
    });
