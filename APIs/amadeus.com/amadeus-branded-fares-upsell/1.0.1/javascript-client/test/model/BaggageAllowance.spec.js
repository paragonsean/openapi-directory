...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrandedFaresUpsell.BaggageAllowance();
  });
  ...
  describe('BaggageAllowance', function() {
    it('should create an instance of BaggageAllowance', function() {
      ...
      //var instance = new BrandedFaresUpsell.BaggageAllowance();
      //expect(instance).to.be.a(BrandedFaresUpsell.BaggageAllowance);
    });
