...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrandedFaresUpsell.FlightOfferUpsellIn();
  });
  ...
  describe('FlightOfferUpsellIn', function() {
    it('should create an instance of FlightOfferUpsellIn', function() {
      // uncomment below and update the code to test FlightOfferUpsellIn
      //var instance = new BrandedFaresUpsell.FlightOfferUpsellIn();
      //expect(instance).to.be.a(BrandedFaresUpsell.FlightOfferUpsellIn);
    });
