...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrandedFaresUpsell.TravelerPricing();
  });
  ...
  describe('TravelerPricing', function() {
    it('should create an instance of TravelerPricing', function() {
      ...
      //var instance = new BrandedFaresUpsell.TravelerPricing();
      //expect(instance).to.be.a(BrandedFaresUpsell.TravelerPricing);
    });
