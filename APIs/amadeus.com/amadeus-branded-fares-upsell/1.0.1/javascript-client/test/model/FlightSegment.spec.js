...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrandedFaresUpsell.FlightSegment();
  });
  ...
  describe('FlightSegment', function() {
    it('should create an instance of FlightSegment', function() {
      ...
      //var instance = new BrandedFaresUpsell.FlightSegment();
      //expect(instance).to.be.a(BrandedFaresUpsell.FlightSegment);
    });
