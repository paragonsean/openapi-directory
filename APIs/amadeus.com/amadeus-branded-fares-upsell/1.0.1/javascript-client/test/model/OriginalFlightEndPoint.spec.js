...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrandedFaresUpsell.OriginalFlightEndPoint();
  });
  ...
  describe('OriginalFlightEndPoint', function() {
    it('should create an instance of OriginalFlightEndPoint', function() {
      ...
      //var instance = new BrandedFaresUpsell.OriginalFlightEndPoint();
      //expect(instance).to.be.a(BrandedFaresUpsell.OriginalFlightEndPoint);
    });
