...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrandedFaresUpsell.SuccessUpsell();
  });
  ...
  describe('SuccessUpsell', function() {
    it('should create an instance of SuccessUpsell', function() {
      // uncomment below and update the code to test SuccessUpsell
      //var instance = new BrandedFaresUpsell.SuccessUpsell();
      //expect(instance).to.be.a(BrandedFaresUpsell.SuccessUpsell);
    });
