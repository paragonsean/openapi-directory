...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrandedFaresUpsell.ExtendedPrice();
  });
  ...
  describe('ExtendedPrice', function() {
    it('should create an instance of ExtendedPrice', function() {
      ...
      //var instance = new BrandedFaresUpsell.ExtendedPrice();
      //expect(instance).to.be.a(BrandedFaresUpsell.ExtendedPrice);
    });
