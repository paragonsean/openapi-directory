...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrandedFaresUpsell.FlightEndPoint();
  });
  ...
  describe('FlightEndPoint', function() {
    it('should create an instance of FlightEndPoint', function() {
      ...
      //var instance = new BrandedFaresUpsell.FlightEndPoint();
      //expect(instance).to.be.a(BrandedFaresUpsell.FlightEndPoint);
    });
