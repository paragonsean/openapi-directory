...
- API version: 1.0.1
  - Build date: 2024-10-12T10:02:43.649656-04:00[America/New_York]
...
------------ | ------------- | ------------- | -------------
*ShoppingApi* | [**upsellAirOffers**](docs/ShoppingApi.md#upsellAirOffers) | **POST** /shopping/flight-offers/upselling | Return a list of upsell Flight Offers based on given Flight Offers
...
## Documentation for Models
 ...
 - [CollectionMetaUpsell](docs/CollectionMetaUpsell.md)
 ...
 - [SuccessUpsell](docs/SuccessUpsell.md)
 - [Tax](docs/Tax.md)
