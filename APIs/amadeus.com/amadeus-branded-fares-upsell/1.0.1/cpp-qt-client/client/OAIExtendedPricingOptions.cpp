...
void OAIExtendedPricingOptions::initializeModel() {
    ...
    m_minimum_delay_before_ticketing_isSet = false;
    m_minimum_delay_before_ticketing_isValid = false;
...
void OAIExtendedPricingOptions::fromJsonObject(QJsonObject json) {
    ...
    m_minimum_delay_before_ticketing_isValid = ::OpenAPI::fromJsonValue(m_minimum_delay_before_ticketing, json[QString("minimumDelayBeforeTicketing")]);
    m_minimum_delay_before_ticketing_isSet = !json[QString("minimumDelayBeforeTicketing")].isNull() && m_minimum_delay_before_ticketing_isValid;
...
QJsonObject OAIExtendedPricingOptions::asJsonObject() const {
    ...
    if (m_minimum_delay_before_ticketing_isSet) {
        obj.insert(QString("minimumDelayBeforeTicketing"), ::OpenAPI::toJsonValue(m_minimum_delay_before_ticketing));
    }
...
QList<QString> OAIExtendedPricingOptions::getCorporateCodes() const {
    return m_corporate_codes;
}
void OAIExtendedPricingOptions::setCorporateCodes(const QList<QString> &corporate_codes) {
    m_corporate_codes = corporate_codes;
    m_corporate_codes_isSet = true;
}

bool OAIExtendedPricingOptions::is_corporate_codes_Set() const{
    return m_corporate_codes_isSet;
}

bool OAIExtendedPricingOptions::is_corporate_codes_Valid() const{
    return m_corporate_codes_isValid;
}

QList<QString> OAIExtendedPricingOptions::getFareType() const {
    return m_fare_type;
}
void OAIExtendedPricingOptions::setFareType(const QList<QString> &fare_type) {
    m_fare_type = fare_type;
    m_fare_type_isSet = true;
}

bool OAIExtendedPricingOptions::is_fare_type_Set() const{
    return m_fare_type_isSet;
}

bool OAIExtendedPricingOptions::is_fare_type_Valid() const{
...
QString OAIExtendedPricingOptions::getMinimumDelayBeforeTicketing() const {
    return m_minimum_delay_before_ticketing;
}
void OAIExtendedPricingOptions::setMinimumDelayBeforeTicketing(const QString &minimum_delay_before_ticketing) {
    m_minimum_delay_before_ticketing = minimum_delay_before_ticketing;
    m_minimum_delay_before_ticketing_isSet = true;
}

bool OAIExtendedPricingOptions::is_minimum_delay_before_ticketing_Set() const{
    return m_minimum_delay_before_ticketing_isSet;
}

bool OAIExtendedPricingOptions::is_minimum_delay_before_ticketing_Valid() const{
    return m_minimum_delay_before_ticketing_isValid;
}

bool OAIExtendedPricingOptions::isNoPenaltyFare() const {
    return m_no_penalty_fare;
}
void OAIExtendedPricingOptions::setNoPenaltyFare(const bool &no_penalty_fare) {
    m_no_penalty_fare = no_penalty_fare;
    m_no_penalty_fare_isSet = true;
}

bool OAIExtendedPricingOptions::is_no_penalty_fare_Set() const{
    return m_no_penalty_fare_isSet;
}

bool OAIExtendedPricingOptions::is_no_penalty_fare_Valid() const{
    return m_no_penalty_fare_isValid;
}

bool OAIExtendedPricingOptions::isNoRestrictionFare() const {
    return m_no_restriction_fare;
}
void OAIExtendedPricingOptions::setNoRestrictionFare(const bool &no_restriction_fare) {
    m_no_restriction_fare = no_restriction_fare;
    m_no_restriction_fare_isSet = true;
}

bool OAIExtendedPricingOptions::is_no_restriction_fare_Set() const{
    return m_no_restriction_fare_isSet;
}

bool OAIExtendedPricingOptions::is_no_restriction_fare_Valid() const{
    return m_no_restriction_fare_isValid;
}

bool OAIExtendedPricingOptions::isRefundableFare() const {
    return m_refundable_fare;
}
void OAIExtendedPricingOptions::setRefundableFare(const bool &refundable_fare) {
    m_refundable_fare = refundable_fare;
    m_refundable_fare_isSet = true;
}

bool OAIExtendedPricingOptions::is_refundable_fare_Set() const{
    return m_refundable_fare_isSet;
}

bool OAIExtendedPricingOptions::is_refundable_fare_Valid() const{
