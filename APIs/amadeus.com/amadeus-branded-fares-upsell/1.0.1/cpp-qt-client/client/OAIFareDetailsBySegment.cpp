...
QList<OAIAmenity> OAIFareDetailsBySegment::getAmenities() const {
    return m_amenities;
}
void OAIFareDetailsBySegment::setAmenities(const QList<OAIAmenity> &amenities) {
    m_amenities = amenities;
    m_amenities_isSet = true;
}

bool OAIFareDetailsBySegment::is_amenities_Set() const{
    return m_amenities_isSet;
}

bool OAIFareDetailsBySegment::is_amenities_Valid() const{
