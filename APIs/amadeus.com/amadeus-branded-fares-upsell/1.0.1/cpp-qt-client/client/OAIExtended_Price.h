...
#ifndef OAIExtended_Price_H
#define OAIExtended_Price_H
...
class OAIFee;
class OAITax;
class OAIAdditionalService;

class OAIExtended_Price : public OAIObject {
public:
    OAIExtended_Price();
    OAIExtended_Price(QString json);
    ~OAIExtended_Price() override;
    ...
    QList<OAIAdditionalService> getAdditionalServices() const;
    void setAdditionalServices(const QList<OAIAdditionalService> &additional_services);
    ...
    QString getGrandTotal() const;
    void setGrandTotal(const QString &grand_total);
...
private:
    ...
    QList<OAIAdditionalService> m_additional_services;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExtended_Price)

#endif // OAIExtended_Price_H
