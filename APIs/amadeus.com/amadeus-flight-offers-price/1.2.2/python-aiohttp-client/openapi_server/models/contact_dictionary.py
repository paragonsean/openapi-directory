...
class ContactDictionary(Model):
    ...
    def __init__(self, address: Address=None, addressee_name: Name=None, language: str=None, purpose: ContactPurpose=None):
        ...
        :param language: The language of this ContactDictionary.
    ...
    @property
    def language(self):
        """Gets the language of this ContactDictionary.

        the preferred language of communication with this Contact

        :return: The language of this ContactDictionary.
        :rtype: str
        """
    ...
    def language(self, language):
        """Sets the language of this ContactDictionary.
