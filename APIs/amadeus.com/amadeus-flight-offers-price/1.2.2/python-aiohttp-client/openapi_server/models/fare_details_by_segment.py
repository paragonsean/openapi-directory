...
class FareDetailsBySegment(Model):
    ...
    def __init__(self, additional_services: AdditionalServicesRequest=None, allotment_details: AllotmentDetails=None, branded_fare: str=None, cabin: TravelClass=None, _class: str=None, fare_basis: str=None, included_checked_bags: BaggageAllowance=None, is_allotment: bool=None, segment_id: str=None, slice_dice_indicator: SliceDiceIndicator=None):
