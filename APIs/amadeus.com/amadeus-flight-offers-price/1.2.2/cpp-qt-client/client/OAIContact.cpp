...
OAIName OAIContact::getAddresseeName() const {
    return m_addressee_name;
}
void OAIContact::setAddresseeName(const OAIName &addressee_name) {
    m_addressee_name = addressee_name;
    m_addressee_name_isSet = true;
}

bool OAIContact::is_addressee_name_Set() const{
    return m_addressee_name_isSet;
}

bool OAIContact::is_addressee_name_Valid() const{
...
OAIContactPurpose OAIContact::getPurpose() const {
    return m_purpose;
}
void OAIContact::setPurpose(const OAIContactPurpose &purpose) {
    m_purpose = purpose;
    m_purpose_isSet = true;
}

bool OAIContact::is_purpose_Set() const{
    return m_purpose_isSet;
}

bool OAIContact::is_purpose_Valid() const{
