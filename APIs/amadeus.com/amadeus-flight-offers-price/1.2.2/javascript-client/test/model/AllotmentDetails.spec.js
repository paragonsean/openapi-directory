...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightOffersPrice.AllotmentDetails();
  });
  ...
  describe('AllotmentDetails', function() {
    it('should create an instance of AllotmentDetails', function() {
      ...
      //var instance = new FlightOffersPrice.AllotmentDetails();
      //expect(instance).to.be.a(FlightOffersPrice.AllotmentDetails);
    });
