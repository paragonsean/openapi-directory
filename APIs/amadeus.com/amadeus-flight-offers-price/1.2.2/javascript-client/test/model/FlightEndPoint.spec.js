...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightOffersPrice.FlightEndPoint();
  });
  ...
  describe('FlightEndPoint', function() {
    it('should create an instance of FlightEndPoint', function() {
      ...
      //var instance = new FlightOffersPrice.FlightEndPoint();
      //expect(instance).to.be.a(FlightOffersPrice.FlightEndPoint);
    });
