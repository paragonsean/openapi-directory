...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightOffersPrice.BaggageAllowance();
  });
  ...
  describe('BaggageAllowance', function() {
    it('should create an instance of BaggageAllowance', function() {
      ...
      //var instance = new FlightOffersPrice.BaggageAllowance();
      //expect(instance).to.be.a(FlightOffersPrice.BaggageAllowance);
    });
