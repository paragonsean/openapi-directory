...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightOffersPrice.AdditionalService();
  });
  ...
  describe('AdditionalService', function() {
    it('should create an instance of AdditionalService', function() {
      ...
      //var instance = new FlightOffersPrice.AdditionalService();
      //expect(instance).to.be.a(FlightOffersPrice.AdditionalService);
    });
