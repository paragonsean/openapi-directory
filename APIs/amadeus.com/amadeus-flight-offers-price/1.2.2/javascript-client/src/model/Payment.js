    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('binNumber')) {
                obj['binNumber'] = ApiClient.convertToType(data['binNumber'], 'Number');
            }
 ...
 * @member {Number} binNumber
 */
Payment.prototype['binNumber'] = undefined;

/**
 * @member {module:model/PaymentBrand} brand
 */
Payment.prototype['brand'] = undefined;

/**
 * Id of the flightOffers to pay
 * @member {Array.<String>} flightOfferIds
 */
Payment.prototype['flightOfferIds'] = undefined;
