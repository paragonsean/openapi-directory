...
class Success {
     ...
     * @param data {Array.<module:model/CheckinLink>} 
     */
    constructor(data) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [CheckinLink]);
            }
...
/**
 * @member {Array.<module:model/CheckinLink>} data
 */
