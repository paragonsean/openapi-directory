...
import CheckinLink from './model/CheckinLink';
...
import CheckinLinksApi from './api/CheckinLinksApi';
...
* <pre>
* var FlightCheckInLinks = require('index'); // See note below*.
* var xxxSvc = new FlightCheckInLinks.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new FlightCheckInLinks.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new FlightCheckInLinks.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new FlightCheckInLinks.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
...
export {
    ...
    /**
     * The CheckinLink model constructor.
     * @property {module:model/CheckinLink}
     */
    CheckinLink,
    ...
    /**
    * The CheckinLinksApi service constructor.
    * @property {module:api/CheckinLinksApi}
    */
    CheckinLinksApi
};
