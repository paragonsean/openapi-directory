...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightCheckInLinks.CollectionLinks();
  });
  ...
  describe('CollectionLinks', function() {
    it('should create an instance of CollectionLinks', function() {
      ...
      //var instance = new FlightCheckInLinks.CollectionLinks();
      //expect(instance).to.be.a(FlightCheckInLinks.CollectionLinks);
    });
