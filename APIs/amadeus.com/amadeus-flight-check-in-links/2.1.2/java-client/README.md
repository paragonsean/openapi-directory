...
- API version: 2.1.2
  - Build date: 2024-10-12T10:03:25.259971-04:00[America/New_York]
...
------------ | ------------- | ------------- | -------------
*CheckinLinksApi* | [**getCheckinURLs**](docs/CheckinLinksApi.md#getCheckinURLs) | **GET** /reference-data/urls/checkin-links | Lists Check-in URLs.


## Documentation for Models

 - [CheckinLink](docs/CheckinLink.md)
