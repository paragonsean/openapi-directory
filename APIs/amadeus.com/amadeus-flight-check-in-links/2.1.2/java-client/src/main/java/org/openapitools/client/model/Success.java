...
public class Success {
  ...
  private List<CheckinLink> data = new ArrayList<>();
  ...
  public Success data(List<CheckinLink> data) {
    this.data = data;
    return this;
  }

  public Success addDataItem(CheckinLink dataItem) {
    if (this.data == null) {
  ...
  public List<CheckinLink> getData() {
    return data;
  }

  public void setData(List<CheckinLink> data) {
    this.data = data;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (int i = 0; i < jsonArraydata.size(); i++) {
        CheckinLink.validateJsonElement(jsonArraydata.get(i));
      };
