...
float OAIGeoCode::getLatitude() const {
    return m_latitude;
}
void OAIGeoCode::setLatitude(const float &latitude) {
    m_latitude = latitude;
...
float OAIGeoCode::getLongitude() const {
    return m_longitude;
}
void OAIGeoCode::setLongitude(const float &longitude) {
