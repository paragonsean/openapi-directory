...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LocationScore.CategoryRatedAreas();
  });
  ...
  describe('CategoryRatedAreas', function() {
    it('should create an instance of CategoryRatedAreas', function() {
      // uncomment below and update the code to test CategoryRatedAreas
      //var instance = new LocationScore.CategoryRatedAreas();
      //expect(instance).to.be.a(LocationScore.CategoryRatedAreas);
    });

    it('should have the property categoryScores (base name: "categoryScores")', function() {
