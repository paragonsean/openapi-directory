...
QList<OAIDelay_Prediction> OAIPrediction::getData() const {
    return m_data;
}
void OAIPrediction::setData(const QList<OAIDelay_Prediction> &data) {
    m_data = data;
    m_data_isSet = true;
}
...
OAICollection_Meta_Link OAIPrediction::getMeta() const {
    return m_meta;
}
void OAIPrediction::setMeta(const OAICollection_Meta_Link &meta) {
    m_meta = meta;
    m_meta_isSet = true;
}
