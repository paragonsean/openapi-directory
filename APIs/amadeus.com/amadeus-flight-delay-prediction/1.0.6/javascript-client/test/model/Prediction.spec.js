...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightDelayPrediction.Prediction();
  });
  ...
  describe('Prediction', function() {
    it('should create an instance of Prediction', function() {
      ...
      //var instance = new FlightDelayPrediction.Prediction();
      //expect(instance).to.be.a(FlightDelayPrediction.Prediction);
    });
