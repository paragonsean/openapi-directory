...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightDelayPrediction.IssueSource();
  });
  ...
  describe('IssueSource', function() {
    it('should create an instance of IssueSource', function() {
      ...
      //var instance = new FlightDelayPrediction.IssueSource();
      //expect(instance).to.be.a(FlightDelayPrediction.IssueSource);
    });
