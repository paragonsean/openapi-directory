...
/*
 * OAIWarnings_source.h
 *
 * The Warning Source Definition
 */

#ifndef OAIWarnings_source_H
#define OAIWarnings_source_H
...
class OAIWarnings_source : public OAIObject {
public:
    OAIWarnings_source();
    OAIWarnings_source(QString json);
    ~OAIWarnings_source() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWarnings_source)

#endif // OAIWarnings_source_H
