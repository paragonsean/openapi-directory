...
#ifndef OAIMarketing_H
#define OAIMarketing_H
...
class OAIMarketing : public OAIObject {
public:
    OAIMarketing();
    OAIMarketing(QString json);
    ~OAIMarketing() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMarketing)

#endif // OAIMarketing_H
