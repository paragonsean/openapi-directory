...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TripParser.WarningsSource();
  });
  ...
  describe('WarningsSource', function() {
    it('should create an instance of WarningsSource', function() {
      // uncomment below and update the code to test WarningsSource
      //var instance = new TripParser.WarningsSource();
      //expect(instance).to.be.a(TripParser.WarningsSource);
    });
