...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TripParser.Marketing();
  });
  ...
  describe('Marketing', function() {
    it('should create an instance of Marketing', function() {
      // uncomment below and update the code to test Marketing
      //var instance = new TripParser.Marketing();
      //expect(instance).to.be.a(TripParser.Marketing);
    });
