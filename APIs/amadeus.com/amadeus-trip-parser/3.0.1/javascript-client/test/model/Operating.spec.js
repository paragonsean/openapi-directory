...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TripParser.Operating();
  });
  ...
  describe('Operating', function() {
    it('should create an instance of Operating', function() {
      // uncomment below and update the code to test Operating
      //var instance = new TripParser.Operating();
      //expect(instance).to.be.a(TripParser.Operating);
    });
