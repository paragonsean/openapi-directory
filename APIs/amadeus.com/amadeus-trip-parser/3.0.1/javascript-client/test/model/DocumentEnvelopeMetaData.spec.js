...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TripParser.DocumentEnvelopeMetaData();
  });
  ...
  describe('DocumentEnvelopeMetaData', function() {
    it('should create an instance of DocumentEnvelopeMetaData', function() {
      // uncomment below and update the code to test DocumentEnvelopeMetaData
      //var instance = new TripParser.DocumentEnvelopeMetaData();
      //expect(instance).to.be.a(TripParser.DocumentEnvelopeMetaData);
    });
