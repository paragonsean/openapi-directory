...
public class Train {
  ...
  public Train train(TrainData train) {
    this.train = train;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    Train train = (Train) o;
    return Objects.equals(this.train, train.train);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("train") != null && !jsonObj.get("train").isJsonNull()) {
        TrainData.validateJsonElement(jsonObj.get("train"));
      }
  }
