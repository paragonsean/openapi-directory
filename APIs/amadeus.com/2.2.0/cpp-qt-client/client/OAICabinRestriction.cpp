...
OAICoverage OAICabinRestriction::getCoverage() const {
    return m_coverage;
}
void OAICabinRestriction::setCoverage(const OAICoverage &coverage) {
    m_coverage = coverage;
    m_coverage_isSet = true;
}

bool OAICabinRestriction::is_coverage_Set() const{
    return m_coverage_isSet;
}

bool OAICabinRestriction::is_coverage_Valid() const{
