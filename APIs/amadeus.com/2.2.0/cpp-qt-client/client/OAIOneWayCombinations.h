...
/*
 * OAIOneWayCombinations.h
 *
 * 
 */

#ifndef OAIOneWayCombinations_H
#define OAIOneWayCombinations_H
...
class OAIOneWayCombinations : public OAIObject {
public:
    OAIOneWayCombinations();
    OAIOneWayCombinations(QString json);
    ~OAIOneWayCombinations() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOneWayCombinations)

#endif // OAIOneWayCombinations_H
