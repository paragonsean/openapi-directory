...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightOffersSearch.TravelerPricing();
  });
  ...
  describe('TravelerPricing', function() {
    it('should create an instance of TravelerPricing', function() {
      ...
      //var instance = new FlightOffersSearch.TravelerPricing();
      //expect(instance).to.be.a(FlightOffersSearch.TravelerPricing);
    });
