...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightOffersSearch.FareDetailsBySegment();
  });
  ...
  describe('FareDetailsBySegment', function() {
    it('should create an instance of FareDetailsBySegment', function() {
      ...
      //var instance = new FlightOffersSearch.FareDetailsBySegment();
      //expect(instance).to.be.a(FlightOffersSearch.FareDetailsBySegment);
    });
