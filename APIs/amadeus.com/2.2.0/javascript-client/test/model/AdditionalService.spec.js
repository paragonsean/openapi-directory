...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightOffersSearch.AdditionalService();
  });
  ...
  describe('AdditionalService', function() {
    it('should create an instance of AdditionalService', function() {
      ...
      //var instance = new FlightOffersSearch.AdditionalService();
      //expect(instance).to.be.a(FlightOffersSearch.AdditionalService);
    });
