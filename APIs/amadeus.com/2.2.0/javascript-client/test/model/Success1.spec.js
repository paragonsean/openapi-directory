...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightOffersSearch.Success1();
  });
  ...
  describe('Success1', function() {
    it('should create an instance of Success1', function() {
      // uncomment below and update the code to test Success1
      //var instance = new FlightOffersSearch.Success1();
      //expect(instance).to.be.a(FlightOffersSearch.Success1);
    });
