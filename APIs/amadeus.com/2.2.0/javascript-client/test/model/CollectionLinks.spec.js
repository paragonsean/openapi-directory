...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightOffersSearch.CollectionLinks();
  });
  ...
  describe('CollectionLinks', function() {
    it('should create an instance of CollectionLinks', function() {
      ...
      //var instance = new FlightOffersSearch.CollectionLinks();
      //expect(instance).to.be.a(FlightOffersSearch.CollectionLinks);
    });
