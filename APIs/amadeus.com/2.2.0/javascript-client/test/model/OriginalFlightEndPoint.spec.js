...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightOffersSearch.OriginalFlightEndPoint();
  });
  ...
  describe('OriginalFlightEndPoint', function() {
    it('should create an instance of OriginalFlightEndPoint', function() {
      ...
      //var instance = new FlightOffersSearch.OriginalFlightEndPoint();
      //expect(instance).to.be.a(FlightOffersSearch.OriginalFlightEndPoint);
    });
