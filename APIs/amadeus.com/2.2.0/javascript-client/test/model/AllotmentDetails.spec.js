...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightOffersSearch.AllotmentDetails();
  });
  ...
  describe('AllotmentDetails', function() {
    it('should create an instance of AllotmentDetails', function() {
      ...
      //var instance = new FlightOffersSearch.AllotmentDetails();
      //expect(instance).to.be.a(FlightOffersSearch.AllotmentDetails);
    });
