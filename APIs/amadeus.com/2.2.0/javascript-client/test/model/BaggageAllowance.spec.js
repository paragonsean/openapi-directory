...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightOffersSearch.BaggageAllowance();
  });
  ...
  describe('BaggageAllowance', function() {
    it('should create an instance of BaggageAllowance', function() {
      ...
      //var instance = new FlightOffersSearch.BaggageAllowance();
      //expect(instance).to.be.a(FlightOffersSearch.BaggageAllowance);
    });
