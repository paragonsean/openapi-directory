...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightOffersSearch.ExtendedPrice();
  });
  ...
  describe('ExtendedPrice', function() {
    it('should create an instance of ExtendedPrice', function() {
      ...
      //var instance = new FlightOffersSearch.ExtendedPrice();
      //expect(instance).to.be.a(FlightOffersSearch.ExtendedPrice);
    });
