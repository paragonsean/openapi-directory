...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightOffersSearch.FlightSegment();
  });
  ...
  describe('FlightSegment', function() {
    it('should create an instance of FlightSegment', function() {
      ...
      //var instance = new FlightOffersSearch.FlightSegment();
      //expect(instance).to.be.a(FlightOffersSearch.FlightSegment);
    });
