...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightOffersSearch.FlightEndPoint();
  });
  ...
  describe('FlightEndPoint', function() {
    it('should create an instance of FlightEndPoint', function() {
      ...
      //var instance = new FlightOffersSearch.FlightEndPoint();
      //expect(instance).to.be.a(FlightOffersSearch.FlightEndPoint);
    });
