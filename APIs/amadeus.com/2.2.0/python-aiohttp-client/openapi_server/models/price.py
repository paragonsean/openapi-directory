...
class Price(Model):
    ...
    def __init__(self, base: str=None, currency: str=None, fees: List[Fee]=None, refundable_taxes: str=None, taxes: List[Tax]=None, total: str=None):
        ...
        :param refundable_taxes: The refundable_taxes of this Price.
    ...
    def refundable_taxes(self):
        """Gets the refundable_taxes of this Price.

        The amount of taxes which are refundable

        :return: The refundable_taxes of this Price.
        :rtype: str
        """
    ...
    def refundable_taxes(self, refundable_taxes):
        """Sets the refundable_taxes of this Price.
