...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightAvailibilitiesSearch.FlightEndPoint();
  });
  ...
  describe('FlightEndPoint', function() {
    it('should create an instance of FlightEndPoint', function() {
      ...
      //var instance = new FlightAvailibilitiesSearch.FlightEndPoint();
      //expect(instance).to.be.a(FlightAvailibilitiesSearch.FlightEndPoint);
    });
