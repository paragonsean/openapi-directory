...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightAvailibilitiesSearch.OriginalFlightEndPoint();
  });
  ...
  describe('OriginalFlightEndPoint', function() {
    it('should create an instance of OriginalFlightEndPoint', function() {
      ...
      //var instance = new FlightAvailibilitiesSearch.OriginalFlightEndPoint();
      //expect(instance).to.be.a(FlightAvailibilitiesSearch.OriginalFlightEndPoint);
    });
