...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightAvailibilitiesSearch.FlightSegment();
  });
  ...
  describe('FlightSegment', function() {
    it('should create an instance of FlightSegment', function() {
      ...
      //var instance = new FlightAvailibilitiesSearch.FlightSegment();
      //expect(instance).to.be.a(FlightAvailibilitiesSearch.FlightSegment);
    });
