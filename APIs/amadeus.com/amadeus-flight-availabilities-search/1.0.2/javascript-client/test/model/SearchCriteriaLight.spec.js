...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightAvailibilitiesSearch.SearchCriteriaLight();
  });
  ...
  describe('SearchCriteriaLight', function() {
    it('should create an instance of SearchCriteriaLight', function() {
      // uncomment below and update the code to test SearchCriteriaLight
      //var instance = new FlightAvailibilitiesSearch.SearchCriteriaLight();
      //expect(instance).to.be.a(FlightAvailibilitiesSearch.SearchCriteriaLight);
    });
