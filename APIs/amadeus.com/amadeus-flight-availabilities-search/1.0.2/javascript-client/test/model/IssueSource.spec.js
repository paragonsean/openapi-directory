...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightAvailibilitiesSearch.IssueSource();
  });
  ...
  describe('IssueSource', function() {
    it('should create an instance of IssueSource', function() {
      ...
      //var instance = new FlightAvailibilitiesSearch.IssueSource();
      //expect(instance).to.be.a(FlightAvailibilitiesSearch.IssueSource);
    });
