...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightAvailibilitiesSearch.SuccessAvailability();
  });
  ...
  describe('SuccessAvailability', function() {
    it('should create an instance of SuccessAvailability', function() {
      // uncomment below and update the code to test SuccessAvailability
      //var instance = new FlightAvailibilitiesSearch.SuccessAvailability();
      //expect(instance).to.be.a(FlightAvailibilitiesSearch.SuccessAvailability);
    });
