...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightAvailibilitiesSearch.Issue();
  });
  ...
  describe('Issue', function() {
    it('should create an instance of Issue', function() {
      ...
      //var instance = new FlightAvailibilitiesSearch.Issue();
      //expect(instance).to.be.a(FlightAvailibilitiesSearch.Issue);
    });
