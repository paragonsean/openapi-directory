...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightAvailibilitiesSearch.ExtendedSegment();
  });
  ...
  describe('ExtendedSegment', function() {
    it('should create an instance of ExtendedSegment', function() {
      // uncomment below and update the code to test ExtendedSegment
      //var instance = new FlightAvailibilitiesSearch.ExtendedSegment();
      //expect(instance).to.be.a(FlightAvailibilitiesSearch.ExtendedSegment);
    });
    ...
    it('should have the property availabilityClasses (base name: "availabilityClasses")', function() {
      // uncomment below and update the code to test the property availabilityClasses
      //var instance = new FlightAvailibilitiesSearch.ExtendedSegment();
      //expect(instance).to.be();
    });
