...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightAvailibilitiesSearch.GetFlightAvailabilitiesQuery();
  });
  ...
  describe('GetFlightAvailabilitiesQuery', function() {
    it('should create an instance of GetFlightAvailabilitiesQuery', function() {
      // uncomment below and update the code to test GetFlightAvailabilitiesQuery
      //var instance = new FlightAvailibilitiesSearch.GetFlightAvailabilitiesQuery();
      //expect(instance).to.be.a(FlightAvailibilitiesSearch.GetFlightAvailabilitiesQuery);
    });
