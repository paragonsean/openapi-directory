...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightAvailibilitiesSearch.Segment();
  });
  ...
  describe('Segment', function() {
    it('should create an instance of Segment', function() {
      ...
      //var instance = new FlightAvailibilitiesSearch.Segment();
      //expect(instance).to.be.a(FlightAvailibilitiesSearch.Segment);
    });
