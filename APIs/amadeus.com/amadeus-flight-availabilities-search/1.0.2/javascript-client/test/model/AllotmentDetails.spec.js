...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightAvailibilitiesSearch.AllotmentDetails();
  });
  ...
  describe('AllotmentDetails', function() {
    it('should create an instance of AllotmentDetails', function() {
      ...
      //var instance = new FlightAvailibilitiesSearch.AllotmentDetails();
      //expect(instance).to.be.a(FlightAvailibilitiesSearch.AllotmentDetails);
    });
