...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightAvailibilitiesSearch.TravelerInfo();
  });
  ...
  describe('TravelerInfo', function() {
    it('should create an instance of TravelerInfo', function() {
      // uncomment below and update the code to test TravelerInfo
      //var instance = new FlightAvailibilitiesSearch.TravelerInfo();
      //expect(instance).to.be.a(FlightAvailibilitiesSearch.TravelerInfo);
    });
