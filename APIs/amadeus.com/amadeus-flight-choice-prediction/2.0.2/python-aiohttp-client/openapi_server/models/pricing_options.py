...
class PricingOptions(Model):
    ...
    def __init__(self, corporate_codes: List[str]=None, fare_type: List[str]=None, included_checked_bags_only: bool=None, no_penalty_fare: bool=None, no_restriction_fare: bool=None, refundable_fare: bool=None):
        """PricingOptions - a model defined in OpenAPI

        :param corporate_codes: The corporate_codes of this PricingOptions.
    ...
    def corporate_codes(self):
        """Gets the corporate_codes of this PricingOptions.

        Allow Corporate negotiated fares using one or more corporate number (corporate code).

        :return: The corporate_codes of this PricingOptions.
        :rtype: List[str]
        """
    ...
    def corporate_codes(self, corporate_codes):
        """Sets the corporate_codes of this PricingOptions.
