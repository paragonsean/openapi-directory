...
class FlightSegment(Model):
    ...
    def __init__(self, aircraft: AircraftEquipment=None, arrival: FlightEndPoint=None, cabin: str=None, carrier_code: str=None, _class: str=None, departure: FlightEndPoint=None, duration: str=None, number: str=None, operating: OperatingFlight=None, stops: List[FlightStop]=None, suffix: str=None):
        ...
        :param cabin: The cabin of this FlightSegment.
        :param carrier_code: The carrier_code of this FlightSegment.
        :param _class: The _class of this FlightSegment.
        ...
        :param suffix: The suffix of this FlightSegment.
        """
        self.openapi_types = {
    ...
    @property
    def cabin(self):
        """Gets the cabin of this FlightSegment.

        booking cabin / class of service of the carrier

        :return: The cabin of this FlightSegment.
        :rtype: str
        """
        return self._cabin
    ...
    def cabin(self, cabin):
        """Sets the cabin of this FlightSegment.
    ...
    @property
    def _class(self):
        """Gets the _class of this FlightSegment.

        reservation booking designator (RBD) of the carrier

        :return: The _class of this FlightSegment.
        :rtype: str
        """
        return self.__class
    ...
    def _class(self, _class):
        """Sets the _class of this FlightSegment.
    ...
    @property
    def suffix(self):
        """Gets the suffix of this FlightSegment.

        the flight number suffix as assigned by the carrier

        :return: The suffix of this FlightSegment.
        :rtype: str
        """
        return self._suffix
    ...
    def suffix(self, suffix):
        """Sets the suffix of this FlightSegment.
