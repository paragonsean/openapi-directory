...
class FlightOffer(Model):
    ...
    def __init__(self, choice_probability: str=None, disable_pricing: bool=None, fare_rules: FareRules=None, id: str=None, instant_ticketing_required: bool=None, itineraries: List[Itineraries]=None, last_ticketing_date: str=None, non_homogeneous: bool=None, number_of_bookable_seats: float=None, one_way: bool=None, payment_card_required: bool=None, price: ExtendedPrice=None, pricing_options: PricingOptions=None, source: FlightOfferSource=None, traveler_pricings: List[TravelerPricing]=None, type: str=None, validating_airline_codes: List[str]=None):
        ...
        self._choice_probability = choice_probability
    ...
    def choice_probability(self):
        """Gets the choice_probability of this FlightOffer.
        ...
        :return: The choice_probability of this FlightOffer.
        :rtype: str
        """
        return self._choice_probability

    @choice_probability.setter
    def choice_probability(self, choice_probability):
        """Sets the choice_probability of this FlightOffer.

        the choice probability of this Flight Offer. The value is between 1 (100% chance the FlightOffer will be selected) and 0 (no change the FlightOffer will be selected)

        :param choice_probability: The choice_probability of this FlightOffer.
        :type choice_probability: str
        """
