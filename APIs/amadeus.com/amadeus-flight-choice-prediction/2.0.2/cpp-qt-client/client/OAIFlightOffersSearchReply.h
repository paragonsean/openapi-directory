...
/*
 * OAIFlightOffersSearchReply.h
 *
 * 
 */

#ifndef OAIFlightOffersSearchReply_H
#define OAIFlightOffersSearchReply_H
...
class OAIFlightOffersSearchReply : public OAIObject {
public:
    OAIFlightOffersSearchReply();
    OAIFlightOffersSearchReply(QString json);
    ~OAIFlightOffersSearchReply() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFlightOffersSearchReply)

#endif // OAIFlightOffersSearchReply_H
