...
QString OAIFlightSegment::getCabin() const {
    return m_cabin;
}
void OAIFlightSegment::setCabin(const QString &cabin) {
    m_cabin = cabin;
    m_cabin_isSet = true;
}

bool OAIFlightSegment::is_cabin_Set() const{
    return m_cabin_isSet;
}

bool OAIFlightSegment::is_cabin_Valid() const{
...
QString OAIFlightSegment::getRClass() const {
    return m_r_class;
}
void OAIFlightSegment::setRClass(const QString &r_class) {
    m_r_class = r_class;
    m_r_class_isSet = true;
}

bool OAIFlightSegment::is_r_class_Set() const{
    return m_r_class_isSet;
}

bool OAIFlightSegment::is_r_class_Valid() const{
...
QString OAIFlightSegment::getSuffix() const {
    return m_suffix;
}
void OAIFlightSegment::setSuffix(const QString &suffix) {
    m_suffix = suffix;
    m_suffix_isSet = true;
}

bool OAIFlightSegment::is_suffix_Set() const{
    return m_suffix_isSet;
}

bool OAIFlightSegment::is_suffix_Valid() const{
