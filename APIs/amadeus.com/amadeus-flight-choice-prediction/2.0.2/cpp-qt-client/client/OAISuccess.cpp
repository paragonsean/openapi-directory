...
QList<OAIFlightOffer> OAISuccess::getData() const {
    return m_data;
}
void OAISuccess::setData(const QList<OAIFlightOffer> &data) {
    m_data = data;
    m_data_isSet = true;
}
...
OAIDictionaries OAISuccess::getDictionaries() const {
    return m_dictionaries;
}
void OAISuccess::setDictionaries(const OAIDictionaries &dictionaries) {
    m_dictionaries = dictionaries;
    m_dictionaries_isSet = true;
}

bool OAISuccess::is_dictionaries_Set() const{
    return m_dictionaries_isSet;
}

bool OAISuccess::is_dictionaries_Valid() const{
