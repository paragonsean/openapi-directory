...
QString OAIAircraftEquipment::getConfigurationVersion() const {
    return m_configuration_version;
}
void OAIAircraftEquipment::setConfigurationVersion(const QString &configuration_version) {
    m_configuration_version = configuration_version;
    m_configuration_version_isSet = true;
}

bool OAIAircraftEquipment::is_configuration_version_Set() const{
    return m_configuration_version_isSet;
}

bool OAIAircraftEquipment::is_configuration_version_Valid() const{
