...
void OAIFlightOffer::initializeModel() {
    ...
    m_choice_probability_isSet = false;
    m_choice_probability_isValid = false;
...
void OAIFlightOffer::fromJsonObject(QJsonObject json) {
    ...
    m_choice_probability_isValid = ::OpenAPI::fromJsonValue(m_choice_probability, json[QString("choiceProbability")]);
    m_choice_probability_isSet = !json[QString("choiceProbability")].isNull() && m_choice_probability_isValid;
...
QJsonObject OAIFlightOffer::asJsonObject() const {
    QJsonObject obj;
    if (m_choice_probability_isSet) {
        obj.insert(QString("choiceProbability"), ::OpenAPI::toJsonValue(m_choice_probability));
    }
...
QString OAIFlightOffer::getChoiceProbability() const {
    return m_choice_probability;
}
void OAIFlightOffer::setChoiceProbability(const QString &choice_probability) {
    m_choice_probability = choice_probability;
    m_choice_probability_isSet = true;
}

bool OAIFlightOffer::is_choice_probability_Set() const{
    return m_choice_probability_isSet;
}

bool OAIFlightOffer::is_choice_probability_Valid() const{
    return m_choice_probability_isValid;
}
...
bool OAIFlightOffer::isValid() const {
    ...
    return m_id_isValid && m_source_isValid && m_type_isValid && true;
}
