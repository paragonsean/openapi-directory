...
class FlightOffer {
    ...
    constructor(id, source, type) { 
        ...
        FlightOffer.initialize(this, id, source, type);
    }
     ...
     */
    static initialize(obj, id, source, type) { 
        obj['id'] = id;
        obj['source'] = source;
        obj['type'] = type;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('choiceProbability')) {
                obj['choiceProbability'] = ApiClient.convertToType(data['choiceProbability'], 'String');
            }
            if (data.hasOwnProperty('disablePricing')) {
                obj['disablePricing'] = ApiClient.convertToType(data['disablePricing'], 'Boolean');
            }
            if (data.hasOwnProperty('fareRules')) {
                obj['fareRules'] = FareRules.constructFromObject(data['fareRules']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['choiceProbability'] && !(typeof data['choiceProbability'] === 'string' || data['choiceProbability'] instanceof String)) {
            throw new Error("Expected the field `choiceProbability` to be a primitive type in the JSON string but got " + data['choiceProbability']);
        }
        // validate the optional field `fareRules`
        if (data['fareRules']) { // data not null
          FareRules.validateJSON(data['fareRules']);
        }
        // ensure the json data is a string
...
FlightOffer.RequiredProperties = ["id", "source", "type"];
 ...
 * @member {String} choiceProbability
 */
FlightOffer.prototype['choiceProbability'] = undefined;
...
/**
 * @member {module:model/FareRules} fareRules
 */
FlightOffer.prototype['fareRules'] = undefined;
