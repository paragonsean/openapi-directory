...
import FlightChoicePredictionApi from './api/FlightChoicePredictionApi';
...
* <pre>
* var FlightChoicePrediction = require('index'); // See note below*.
* var xxxSvc = new FlightChoicePrediction.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new FlightChoicePrediction.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new FlightChoicePrediction.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new FlightChoicePrediction.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
...
export {
    ...
    /**
     * The FlightOffersSearchReply model constructor.
     * @property {module:model/FlightOffersSearchReply}
     */
    ...
    /**
    * The FlightChoicePredictionApi service constructor.
    * @property {module:api/FlightChoicePredictionApi}
    */
