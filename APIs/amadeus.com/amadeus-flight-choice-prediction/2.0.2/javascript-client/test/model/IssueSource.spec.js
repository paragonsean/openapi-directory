...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightChoicePrediction.IssueSource();
  });
  ...
  describe('IssueSource', function() {
    it('should create an instance of IssueSource', function() {
      ...
      //var instance = new FlightChoicePrediction.IssueSource();
      //expect(instance).to.be.a(FlightChoicePrediction.IssueSource);
    });
