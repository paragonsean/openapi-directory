...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightChoicePrediction.Co2Emission();
  });
  ...
  describe('Co2Emission', function() {
    it('should create an instance of Co2Emission', function() {
      ...
      //var instance = new FlightChoicePrediction.Co2Emission();
      //expect(instance).to.be.a(FlightChoicePrediction.Co2Emission);
    });
