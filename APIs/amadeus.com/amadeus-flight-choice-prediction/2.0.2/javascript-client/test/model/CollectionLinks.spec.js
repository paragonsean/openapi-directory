...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightChoicePrediction.CollectionLinks();
  });
  ...
  describe('CollectionLinks', function() {
    it('should create an instance of CollectionLinks', function() {
      ...
      //var instance = new FlightChoicePrediction.CollectionLinks();
      //expect(instance).to.be.a(FlightChoicePrediction.CollectionLinks);
    });
