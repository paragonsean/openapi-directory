...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightChoicePrediction.AllotmentDetails();
  });
  ...
  describe('AllotmentDetails', function() {
    it('should create an instance of AllotmentDetails', function() {
      ...
      //var instance = new FlightChoicePrediction.AllotmentDetails();
      //expect(instance).to.be.a(FlightChoicePrediction.AllotmentDetails);
    });
