...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlightChoicePrediction.OriginalFlightEndPoint();
  });
  ...
  describe('OriginalFlightEndPoint', function() {
    it('should create an instance of OriginalFlightEndPoint', function() {
      ...
      //var instance = new FlightChoicePrediction.OriginalFlightEndPoint();
      //expect(instance).to.be.a(FlightChoicePrediction.OriginalFlightEndPoint);
    });
