...
void OAIAccountApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("account", defaultConf);
    _serverIndices.insert("account", 0);
}
...
void OAIAccountApi::account() {
    QString fullPath = QString(_serverConfigs["account"][_serverIndices.value("account")].URL()+"/account");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAccountApi::accountCallback);
...
void OAIAccountApi::accountCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT accountSignal(output);
        Q_EMIT accountSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT accountSignalE(output, error_type, error_str);
        Q_EMIT accountSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT accountSignalError(output, error_type, error_str);
        Q_EMIT accountSignalErrorFull(worker, error_type, error_str);
    }
}
