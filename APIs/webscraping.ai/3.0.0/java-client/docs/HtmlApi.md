...
<a id="getHTML"></a>
# **getHTML**
> String getHTML(url, headers, timeout, js, jsTimeout, proxy, country, device, errorOn404, errorOnRedirect)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      String result = apiInstance.getHTML(url, headers, timeout, js, jsTimeout, proxy, country, device, errorOn404, errorOnRedirect);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling HtmlApi#getHTML");
