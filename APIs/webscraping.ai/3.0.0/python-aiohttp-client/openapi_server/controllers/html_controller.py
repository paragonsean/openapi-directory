...
async def get_html(request: web.Request, url, headers=None, timeout=None, js=None, js_timeout=None, proxy=None, country=None, device=None, error_on_404=None, error_on_redirect=None) -> web.Response:
    """Page HTML by URL
