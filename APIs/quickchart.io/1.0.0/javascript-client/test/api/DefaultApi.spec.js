...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuickChartApi.DefaultApi();
  });
  ...
  describe('DefaultApi', function() {
    ...
    describe('qrGet', function() {
      it('should call qrGet successfully', function(done) {
        //uncomment below and update the code to test qrGet
        //instance.qrGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('qrPost', function() {
      it('should call qrPost successfully', function(done) {
        //uncomment below and update the code to test qrPost
        //instance.qrPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
