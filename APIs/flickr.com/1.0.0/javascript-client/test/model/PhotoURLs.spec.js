...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlickrApiSchema.PhotoURLs();
  });
  ...
  describe('PhotoURLs', function() {
    it('should create an instance of PhotoURLs', function() {
      // uncomment below and update the code to test PhotoURLs
      //var instance = new FlickrApiSchema.PhotoURLs();
      //expect(instance).to.be.a(FlickrApiSchema.PhotoURLs);
    });
