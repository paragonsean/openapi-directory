...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BbcIPlayerBusinessLayer.EpisodeSynopses();
  });
  ...
  describe('EpisodeSynopses', function() {
    it('should create an instance of EpisodeSynopses', function() {
      // uncomment below and update the code to test EpisodeSynopses
      //var instance = new BbcIPlayerBusinessLayer.EpisodeSynopses();
      //expect(instance).to.be.a(BbcIPlayerBusinessLayer.EpisodeSynopses);
    });
    ...
    it('should have the property programmeSmall (base name: "programme_small")', function() {
      // uncomment below and update the code to test the property programmeSmall
      //var instance = new BbcIPlayerBusinessLayer.EpisodeSynopses();
      //expect(instance).to.be();
    });
