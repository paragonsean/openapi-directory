...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BbcIPlayerBusinessLayer.ClipSynopses();
  });
  ...
  describe('ClipSynopses', function() {
    it('should create an instance of ClipSynopses', function() {
      // uncomment below and update the code to test ClipSynopses
      //var instance = new BbcIPlayerBusinessLayer.ClipSynopses();
      //expect(instance).to.be.a(BbcIPlayerBusinessLayer.ClipSynopses);
    });
