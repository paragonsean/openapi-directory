...
void OAICategoriesApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("getSubCategories", defaultConf);
    _serverIndices.insert("getSubCategories", 0);
}
...
void OAICategoriesApi::getCategories(const QString &lang) {
...
void OAICategoriesApi::getSubCategories(const QString &category, const QString &lang) {
    QString fullPath = QString(_serverConfigs["getSubCategories"][_serverIndices.value("getSubCategories")].URL()+"/categories/{category}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICategoriesApi::getSubCategoriesCallback);
    connect(this, &OAICategoriesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAICategoriesApi::getSubCategoriesCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getSubCategoriesSignal(output);
        Q_EMIT getSubCategoriesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getSubCategoriesSignalE(output, error_type, error_str);
        Q_EMIT getSubCategoriesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getSubCategoriesSignalError(output, error_type, error_str);
        Q_EMIT getSubCategoriesSignalErrorFull(worker, error_type, error_str);
    }
}
