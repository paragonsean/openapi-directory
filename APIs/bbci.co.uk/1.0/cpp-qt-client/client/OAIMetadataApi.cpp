...
void OAIMetadataApi::getSchema() {
    QString fullPath = QString(_serverConfigs["getSchema"][_serverIndices.value("getSchema")].URL()+"/schema/ibl.json");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMetadataApi::getSchemaCallback);
...
void OAIMetadataApi::getSchemaCallback(OAIHttpRequestWorker *worker) {
...
void OAIMetadataApi::getStatus() {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMetadataApi::getStatusCallback);
    connect(this, &OAIMetadataApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIMetadataApi::getStatusCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
