...
void OAISearchApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("searchSuggest", defaultConf);
    _serverIndices.insert("searchSuggest", 0);
}
...
void OAISearchApi::search(const QString &q, const QString &lang, const QString &rights, const QString &availability) {
...
void OAISearchApi::searchSuggest(const QString &q, const QString &lang, const QString &rights, const QString &availability) {
    QString fullPath = QString(_serverConfigs["searchSuggest"][_serverIndices.value("searchSuggest")].URL()+"/search-suggest");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISearchApi::searchSuggestCallback);
    connect(this, &OAISearchApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAISearchApi::searchSuggestCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchSuggestSignal(output);
        Q_EMIT searchSuggestSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchSuggestSignalE(output, error_type, error_str);
        Q_EMIT searchSuggestSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchSuggestSignalError(output, error_type, error_str);
        Q_EMIT searchSuggestSignalErrorFull(worker, error_type, error_str);
    }
}
