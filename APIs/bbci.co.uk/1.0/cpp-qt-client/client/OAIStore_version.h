...
#ifndef OAIStore_version_H
#define OAIStore_version_H
...
class OAIStore_version : public OAIObject {
public:
    OAIStore_version();
    OAIStore_version(QString json);
    ~OAIStore_version() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStore_version)

#endif // OAIStore_version_H
