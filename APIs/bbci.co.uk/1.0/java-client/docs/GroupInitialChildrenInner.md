...
|**availableOnHdService** | **String** |  |  [optional] |
|**blanked** | **Boolean** |  |  |
|**channelTitle** | **String** |  |  [optional] |
|**duration** | [**BroadcastDuration**](BroadcastDuration.md) |  |  [optional] |
|**episode** | [**Episode**](Episode.md) |  |  |
|**episodeId** | **String** |  |  |
|**events** | [**List&lt;BroadcastEventsInner&gt;**](BroadcastEventsInner.md) |  |  [optional] |
|**repeat** | **Boolean** |  |  |
|**scheduledEnd** | **String** |  |  |
|**scheduledStart** | **String** |  |  |
|**serviceId** | **String** |  |  |
|**transmissionEnd** | **String** |  |  [optional] |
|**transmissionStart** | **String** |  |  [optional] |
|**versionId** | **String** |  |  |
