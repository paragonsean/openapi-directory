...
Connector API
- API version: 10.0.0
  - Build date: 2024-10-12T11:58:14.526870-04:00[America/New_York]
...
------------ | ------------- | ------------- | -------------
*ApiResourcesApi* | [**apiResourceCoverageOne**](docs/ApiResourcesApi.md#apiResourceCoverageOne) | **GET** /connector/apis/{id}/resources/{resource_id}/coverage | Get API Resource Coverage
*ApiResourcesApi* | [**apiResourcesOne**](docs/ApiResourcesApi.md#apiResourcesOne) | **GET** /connector/apis/{id}/resources/{resource_id} | Get API Resource
*ApisApi* | [**apisAll**](docs/ApisApi.md#apisAll) | **GET** /connector/apis | List APIs
*ApisApi* | [**apisOne**](docs/ApisApi.md#apisOne) | **GET** /connector/apis/{id} | Get API
*ConnectorDocsApi* | [**connectorDocsOne**](docs/ConnectorDocsApi.md#connectorDocsOne) | **GET** /connector/connectors/{id}/docs/{doc_id} | Get Connector Doc content
*ConnectorResourcesApi* | [**connectorResourcesOne**](docs/ConnectorResourcesApi.md#connectorResourcesOne) | **GET** /connector/connectors/{id}/resources/{resource_id} | Get Connector Resource
*ConnectorsApi* | [**connectorsAll**](docs/ConnectorsApi.md#connectorsAll) | **GET** /connector/connectors | List Connectors
*ConnectorsApi* | [**connectorsOne**](docs/ConnectorsApi.md#connectorsOne) | **GET** /connector/connectors/{id} | Get Connector
...
## Documentation for Models
 ...
 - [ApiResourceCoverage](docs/ApiResourceCoverage.md)
 - [ApiResourceCoverageCoverageInner](docs/ApiResourceCoverageCoverageInner.md)
 - [ApiResourceLinkedResourcesInner](docs/ApiResourceLinkedResourcesInner.md)
 - [ApiResourcesInner](docs/ApiResourcesInner.md)
 - [ApiStatus](docs/ApiStatus.md)
 - [ApisFilter](docs/ApisFilter.md)
 - [BadRequestResponse](docs/BadRequestResponse.md)
 - [BadRequestResponseDetail](docs/BadRequestResponseDetail.md)
 - [Connector](docs/Connector.md)
 - [ConnectorDoc](docs/ConnectorDoc.md)
 - [ConnectorEvent](docs/ConnectorEvent.md)
 - [ConnectorOauthScopesInner](docs/ConnectorOauthScopesInner.md)
 - [ConnectorResource](docs/ConnectorResource.md)
 - [ConnectorSetting](docs/ConnectorSetting.md)
 - [ConnectorStatus](docs/ConnectorStatus.md)
 - [ConnectorTlsSupport](docs/ConnectorTlsSupport.md)
 - [ConnectorUnifiedApisInner](docs/ConnectorUnifiedApisInner.md)
 - [ConnectorUnifiedApisInnerOauthScopesInner](docs/ConnectorUnifiedApisInnerOauthScopesInner.md)
 - [ConnectorsFilter](docs/ConnectorsFilter.md)
 - [GetApiResourceCoverageResponse](docs/GetApiResourceCoverageResponse.md)
 - [GetApiResourceResponse](docs/GetApiResourceResponse.md)
 - [GetApiResponse](docs/GetApiResponse.md)
 - [GetApisResponse](docs/GetApisResponse.md)
 - [GetConnectorResourceExampleResponse](docs/GetConnectorResourceExampleResponse.md)
 - [GetConnectorResourceExampleResponseData](docs/GetConnectorResourceExampleResponseData.md)
 - [GetConnectorResourceResponse](docs/GetConnectorResourceResponse.md)
 - [GetConnectorResourceSchemaResponse](docs/GetConnectorResourceSchemaResponse.md)
 ...
 - [PaginationCoverage](docs/PaginationCoverage.md)
 - [PaymentRequiredResponse](docs/PaymentRequiredResponse.md)
 - [RequestRate](docs/RequestRate.md)
 - [ResourceStatus](docs/ResourceStatus.md)
 - [SchemaSupport](docs/SchemaSupport.md)
 - [SupportedProperty](docs/SupportedProperty.md)
 - [SupportedPropertyChildPropertiesInner](docs/SupportedPropertyChildPropertiesInner.md)
 ...
 - [VirtualWebhooks](docs/VirtualWebhooks.md)
 - [WebhookSupport](docs/WebhookSupport.md)
