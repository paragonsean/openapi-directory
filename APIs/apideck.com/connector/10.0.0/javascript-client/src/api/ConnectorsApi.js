...
import ConnectorsFilter from '../model/ConnectorsFilter';
import GetConnectorResponse from '../model/GetConnectorResponse';
...
export default class ConnectorsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the connectorsAll operation.
     * @callback module:api/ConnectorsApi~connectorsAllCallback
     ...
     * @param {module:model/ConnectorsFilter} [filter] Apply filters
     * @param {module:api/ConnectorsApi~connectorsAllCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetConnectorsResponse}
     */
    connectorsAll(xApideckAppId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'xApideckAppId' is set
      if (xApideckAppId === undefined || xApideckAppId === null) {
        throw new Error("Missing the required parameter 'xApideckAppId' when calling connectorsAll");
      }
    ...
    /**
     * Callback function to receive the result of the connectorsOne operation.
     * @callback module:api/ConnectorsApi~connectorsOneCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GetConnectorResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/ConnectorsApi~connectorsOneCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetConnectorResponse}
     */
    connectorsOne(xApideckAppId, id, callback) {
      let postBody = null;
      // verify the required parameter 'xApideckAppId' is set
      if (xApideckAppId === undefined || xApideckAppId === null) {
        throw new Error("Missing the required parameter 'xApideckAppId' when calling connectorsOne");
      }
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling connectorsOne");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = GetConnectorResponse;
      return this.apiClient.callApi(
        '/connector/connectors/{id}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
