...
import ApisFilter from '../model/ApisFilter';
...
export default class APIsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the apisAll operation.
     * @callback module:api/APIsApi~apisAllCallback
     ...
     * @param {module:model/ApisFilter} [filter] Apply filters
     * @param {module:api/APIsApi~apisAllCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetApisResponse}
     */
    apisAll(xApideckAppId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'xApideckAppId' is set
      if (xApideckAppId === undefined || xApideckAppId === null) {
        throw new Error("Missing the required parameter 'xApideckAppId' when calling apisAll");
      }
    ...
    /**
     * Callback function to receive the result of the apisOne operation.
     * @callback module:api/APIsApi~apisOneCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/APIsApi~apisOneCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetApiResponse}
     */
    apisOne(xApideckAppId, id, callback) {
      let postBody = null;
      // verify the required parameter 'xApideckAppId' is set
      if (xApideckAppId === undefined || xApideckAppId === null) {
        throw new Error("Missing the required parameter 'xApideckAppId' when calling apisOne");
      }
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling apisOne");
      }
