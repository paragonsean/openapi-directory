...
class GetConnectorsResponse {
     ...
     * @param data {Array.<module:model/Connector>} 
    ...
    constructor(data, status, statusCode) { 
        ...
        GetConnectorsResponse.initialize(this, data, status, statusCode);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [Connector]);
            }
    ...
    static validateJSON(data) {
        ...
        for (const property of GetConnectorsResponse.RequiredProperties) {
...
GetConnectorsResponse.RequiredProperties = ["data", "status", "status_code"];

/**
 * @member {Array.<module:model/Connector>} data
 */
GetConnectorsResponse.prototype['data'] = undefined;

/**
 * @member {module:model/Links} links
 */
GetConnectorsResponse.prototype['links'] = undefined;

/**
 * @member {module:model/Meta} meta
 */
GetConnectorsResponse.prototype['meta'] = undefined;
 ...
 */
GetConnectorsResponse.prototype['status_code'] = undefined;
