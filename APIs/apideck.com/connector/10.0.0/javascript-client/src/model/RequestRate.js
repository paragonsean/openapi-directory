...
class RequestRate {
     ...
     * @param rate {Number} The number of requests per window unit.
     * @param size {Number} Size of request window.
     * @param unit {module:model/RequestRate.UnitEnum} The window unit for the rate.
     */
    constructor(rate, size, unit) { 
        
        RequestRate.initialize(this, rate, size, unit);
    }
     ...
     */
    static initialize(obj, rate, size, unit) { 
        obj['rate'] = rate;
        obj['size'] = size;
        obj['unit'] = unit;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>RequestRate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RequestRate</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RequestRate.RequiredProperties) {
...
RequestRate.RequiredProperties = ["rate", "size", "unit"];

/**
 * The number of requests per window unit.
 * @member {Number} rate
 */
RequestRate.prototype['rate'] = undefined;

/**
 * Size of request window.
 * @member {Number} size
 */
RequestRate.prototype['size'] = undefined;

/**
 * The window unit for the rate.
 * @member {module:model/RequestRate.UnitEnum} unit
 */
RequestRate.prototype['unit'] = undefined;
