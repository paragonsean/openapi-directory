...
import ConnectorUnifiedApisInnerOauthScopesInner from './ConnectorUnifiedApisInnerOauthScopesInner';
import LinkedConnectorResource from './LinkedConnectorResource';
import UnifiedApiId from './UnifiedApiId';

/**
 * The ConnectorUnifiedApisInner model module.
 * @module model/ConnectorUnifiedApisInner
 * @version 10.0.0
 */
class ConnectorUnifiedApisInner {
    /**
     * Constructs a new <code>ConnectorUnifiedApisInner</code>.
     * @alias module:model/ConnectorUnifiedApisInner
     */
    constructor() { 
        
        ConnectorUnifiedApisInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ConnectorUnifiedApisInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ConnectorUnifiedApisInner} obj Optional instance to populate.
     * @return {module:model/ConnectorUnifiedApisInner} The populated <code>ConnectorUnifiedApisInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ConnectorUnifiedApisInner();

            if (data.hasOwnProperty('auth_only')) {
                obj['auth_only'] = ApiClient.convertToType(data['auth_only'], 'Boolean');
            }
            if (data.hasOwnProperty('downstream_unsupported_resources')) {
                obj['downstream_unsupported_resources'] = ApiClient.convertToType(data['downstream_unsupported_resources'], ['String']);
            }
            if (data.hasOwnProperty('id')) {
                obj['id'] = UnifiedApiId.constructFromObject(data['id']);
            }
            if (data.hasOwnProperty('name')) {
                obj['name'] = ApiClient.convertToType(data['name'], 'String');
            }
            if (data.hasOwnProperty('oauth_scopes')) {
                obj['oauth_scopes'] = ApiClient.convertToType(data['oauth_scopes'], [ConnectorUnifiedApisInnerOauthScopesInner]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ConnectorUnifiedApisInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConnectorUnifiedApisInner</code>.
     */
    static validateJSON(data) {
        // ensure the json data is an array
        if (!Array.isArray(data['downstream_unsupported_resources'])) {
            throw new Error("Expected the field `downstream_unsupported_resources` to be an array in the JSON data but got " + data['downstream_unsupported_resources']);
        }
        ...
        if (data['oauth_scopes']) { // data not null
            ...
            for (const item of data['oauth_scopes']) {
                ConnectorUnifiedApisInnerOauthScopesInner.validateJSON(item);
            };
        }
 ...
 */
ConnectorUnifiedApisInner.prototype['auth_only'] = undefined;

/**
 * List of resources that are not supported on the downstream.
 * @member {Array.<String>} downstream_unsupported_resources
 */
ConnectorUnifiedApisInner.prototype['downstream_unsupported_resources'] = undefined;

/**
 * @member {module:model/UnifiedApiId} id
 */
ConnectorUnifiedApisInner.prototype['id'] = undefined;

/**
 * Name of the API.
 * @member {String} name
 */
ConnectorUnifiedApisInner.prototype['name'] = undefined;

/**
 * @member {Array.<module:model/ConnectorUnifiedApisInnerOauthScopesInner>} oauth_scopes
 */
ConnectorUnifiedApisInner.prototype['oauth_scopes'] = undefined;
 ...
 */
ConnectorUnifiedApisInner.prototype['supported_events'] = undefined;
 ...
 */
ConnectorUnifiedApisInner.prototype['supported_resources'] = undefined;
...
export default ConnectorUnifiedApisInner;
