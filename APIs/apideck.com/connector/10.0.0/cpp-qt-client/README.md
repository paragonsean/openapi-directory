...
#include <iostream>
#include "../client/OAIAPIResourcesApi.h"
...
void Example::exampleFunction1(){
     OAIAPIResourcesApi apiInstance;
     
      // Configure API key authorization: apiKey
      apiInstance.setApiKey("YOUR API KEY NAME","YOUR API KEY");

      QEventLoop loop;
      connect(&apiInstance, &OAIAPIResourcesApi::apiResourceCoverageOneSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIAPIResourcesApi::apiResourceCoverageOneSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
      ...
      QString id = create(); // QString | ID of the record you are acting upon.
      ...
      QString resource_id = create(); // QString | ID of the resource you are acting upon.
      apiInstance.apiResourceCoverageOne(x_apideck_app_ididresource_id);
