...
Issue Tracking API
- API version: 10.0.0
  - Build date: 2024-10-12T11:58:06.803353-04:00[America/New_York]
...
------------ | ------------- | ------------- | -------------
*CollectionsApi* | [**collectionsAll**](docs/CollectionsApi.md#collectionsAll) | **GET** /issue-tracking/collections | List Collections
*CollectionsApi* | [**collectionsOne**](docs/CollectionsApi.md#collectionsOne) | **GET** /issue-tracking/collections/{collection_id} | Get Collection
*CommentsApi* | [**collectionTicketCommentsAdd**](docs/CommentsApi.md#collectionTicketCommentsAdd) | **POST** /issue-tracking/collections/{collection_id}/tickets/{ticket_id}/comments | Create Comment
*CommentsApi* | [**collectionTicketCommentsAll**](docs/CommentsApi.md#collectionTicketCommentsAll) | **GET** /issue-tracking/collections/{collection_id}/tickets/{ticket_id}/comments | List Comments
*CommentsApi* | [**collectionTicketCommentsDelete**](docs/CommentsApi.md#collectionTicketCommentsDelete) | **DELETE** /issue-tracking/collections/{collection_id}/tickets/{ticket_id}/comments/{id} | Delete Comment
*CommentsApi* | [**collectionTicketCommentsOne**](docs/CommentsApi.md#collectionTicketCommentsOne) | **GET** /issue-tracking/collections/{collection_id}/tickets/{ticket_id}/comments/{id} | Get Comment
*CommentsApi* | [**collectionTicketCommentsUpdate**](docs/CommentsApi.md#collectionTicketCommentsUpdate) | **PATCH** /issue-tracking/collections/{collection_id}/tickets/{ticket_id}/comments/{id} | Update Comment
*TagsApi* | [**collectionTagsAll**](docs/TagsApi.md#collectionTagsAll) | **GET** /issue-tracking/collections/{collection_id}/tags | List Tags
*TicketsApi* | [**collectionTicketsAdd**](docs/TicketsApi.md#collectionTicketsAdd) | **POST** /issue-tracking/collections/{collection_id}/tickets | Create Ticket
*TicketsApi* | [**collectionTicketsAll**](docs/TicketsApi.md#collectionTicketsAll) | **GET** /issue-tracking/collections/{collection_id}/tickets | List Tickets
*TicketsApi* | [**collectionTicketsDelete**](docs/TicketsApi.md#collectionTicketsDelete) | **DELETE** /issue-tracking/collections/{collection_id}/tickets/{ticket_id} | Delete Ticket
*TicketsApi* | [**collectionTicketsOne**](docs/TicketsApi.md#collectionTicketsOne) | **GET** /issue-tracking/collections/{collection_id}/tickets/{ticket_id} | Get Ticket
*TicketsApi* | [**collectionTicketsUpdate**](docs/TicketsApi.md#collectionTicketsUpdate) | **PATCH** /issue-tracking/collections/{collection_id}/tickets/{ticket_id} | Update Ticket
*UsersApi* | [**collectionUsersAll**](docs/UsersApi.md#collectionUsersAll) | **GET** /issue-tracking/collections/{collection_id}/users | List Users
*UsersApi* | [**collectionUsersOne**](docs/UsersApi.md#collectionUsersOne) | **GET** /issue-tracking/collections/{collection_id}/users/{id} | Get user
...
## Documentation for Models
 ...
 - [CollectionTag](docs/CollectionTag.md)
 - [CollectionTicketComment](docs/CollectionTicketComment.md)
 - [CollectionUser](docs/CollectionUser.md)
 - [CollectionsSort](docs/CollectionsSort.md)
 - [CommentsSort](docs/CommentsSort.md)
 ...
 - [DeleteTicketResponse](docs/DeleteTicketResponse.md)
 - [Department](docs/Department.md)
 - [Email](docs/Email.md)
 - [Gender](docs/Gender.md)
 - [GetCollectionResponse](docs/GetCollectionResponse.md)
 - [GetCollectionTagsResponse](docs/GetCollectionTagsResponse.md)
 - [GetCollectionUserResponse](docs/GetCollectionUserResponse.md)
 - [GetCollectionUsersResponse](docs/GetCollectionUsersResponse.md)
 ...
 - [IssueTrackingEventType](docs/IssueTrackingEventType.md)
 - [IssueTrackingWebhookEvent](docs/IssueTrackingWebhookEvent.md)
 ...
 - [TicketsSort](docs/TicketsSort.md)
 ...
 - [UpdateTicketResponse](docs/UpdateTicketResponse.md)
