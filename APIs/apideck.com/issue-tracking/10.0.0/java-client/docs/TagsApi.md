...
|------------- | ------------- | -------------|
| [**collectionTagsAll**](TagsApi.md#collectionTagsAll) | **GET** /issue-tracking/collections/{collection_id}/tags | List Tags |


<a id="collectionTagsAll"></a>
# **collectionTagsAll**
> GetCollectionTagsResponse collectionTagsAll(collectionId, xApideckConsumerId, xApideckAppId, raw, xApideckServiceId, cursor, limit, passThrough, fields)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      GetCollectionTagsResponse result = apiInstance.collectionTagsAll(collectionId, xApideckConsumerId, xApideckAppId, raw, xApideckServiceId, cursor, limit, passThrough, fields);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling TagsApi#collectionTagsAll");
