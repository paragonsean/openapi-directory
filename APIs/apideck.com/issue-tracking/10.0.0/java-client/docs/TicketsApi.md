...
<a id="collectionTicketsAdd"></a>
# **collectionTicketsAdd**
> CreateTicketResponse collectionTicketsAdd(xApideckConsumerId, xApideckAppId, collectionId, ticket, raw, xApideckServiceId)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      CreateTicketResponse result = apiInstance.collectionTicketsAdd(xApideckConsumerId, xApideckAppId, collectionId, ticket, raw, xApideckServiceId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling TicketsApi#collectionTicketsAdd");
...
<a id="collectionTicketsAll"></a>
# **collectionTicketsAll**
> GetTicketsResponse collectionTicketsAll(xApideckConsumerId, xApideckAppId, collectionId, raw, xApideckServiceId, cursor, limit, sort, filter, passThrough, fields)
...
public class Example {
  public static void main(String[] args) {
    ...
    TicketsSort sort = new TicketsSort(); // TicketsSort | Apply sorting
    IssuesFilter filter = new IssuesFilter(); // IssuesFilter | Apply filters
    ...
    try {
      GetTicketsResponse result = apiInstance.collectionTicketsAll(xApideckConsumerId, xApideckAppId, collectionId, raw, xApideckServiceId, cursor, limit, sort, filter, passThrough, fields);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling TicketsApi#collectionTicketsAll");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="collectionTicketsDelete"></a>
# **collectionTicketsDelete**
> DeleteTicketResponse collectionTicketsDelete(ticketId, xApideckConsumerId, xApideckAppId, collectionId, xApideckServiceId, raw)
...
public class Example {
  public static void main(String[] args) {
    ...
    Boolean raw = false; // Boolean | Include raw response. Mostly used for debugging purposes
    try {
      DeleteTicketResponse result = apiInstance.collectionTicketsDelete(ticketId, xApideckConsumerId, xApideckAppId, collectionId, xApideckServiceId, raw);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling TicketsApi#collectionTicketsDelete");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="collectionTicketsOne"></a>
# **collectionTicketsOne**
> GetTicketResponse collectionTicketsOne(ticketId, xApideckConsumerId, xApideckAppId, collectionId, xApideckServiceId, raw, fields)
...
public class Example {
  public static void main(String[] args) {
    ...
    String fields = "id,updated_at"; // String | The 'fields' parameter allows API users to specify the fields they want to include in the API response. If this parameter is not present, the API will return all available fields. If this parameter is present, only the fields specified in the comma-separated string will be included in the response. Nested properties can also be requested by using a dot notation. <br /><br />Example: `fields=name,email,addresses.city`<br /><br />In the example above, the response will only include the fields \"name\", \"email\" and \"addresses.city\". If any other fields are available, they will be excluded.
    try {
      GetTicketResponse result = apiInstance.collectionTicketsOne(ticketId, xApideckConsumerId, xApideckAppId, collectionId, xApideckServiceId, raw, fields);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling TicketsApi#collectionTicketsOne");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="collectionTicketsUpdate"></a>
# **collectionTicketsUpdate**
> UpdateTicketResponse collectionTicketsUpdate(ticketId, xApideckConsumerId, xApideckAppId, collectionId, ticket, xApideckServiceId, raw)
...
public class Example {
  public static void main(String[] args) {
    ...
    Boolean raw = false; // Boolean | Include raw response. Mostly used for debugging purposes
    try {
      UpdateTicketResponse result = apiInstance.collectionTicketsUpdate(ticketId, xApideckConsumerId, xApideckAppId, collectionId, ticket, xApideckServiceId, raw);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling TicketsApi#collectionTicketsUpdate");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
