...
<a id="collectionTicketCommentsAdd"></a>
# **collectionTicketCommentsAdd**
> CreateCommentResponse collectionTicketCommentsAdd(xApideckConsumerId, xApideckAppId, collectionId, ticketId, collectionTicketComment, raw, xApideckServiceId)
...
public class Example {
  public static void main(String[] args) {
    ...
    String ticketId = "ticketId_example"; // String | ID of the ticket you are acting upon.
    CollectionTicketComment collectionTicketComment = new CollectionTicketComment(); // CollectionTicketComment | 
    ...
    try {
      CreateCommentResponse result = apiInstance.collectionTicketCommentsAdd(xApideckConsumerId, xApideckAppId, collectionId, ticketId, collectionTicketComment, raw, xApideckServiceId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling CommentsApi#collectionTicketCommentsAdd");
...
<a id="collectionTicketCommentsAll"></a>
# **collectionTicketCommentsAll**
> GetCommentsResponse collectionTicketCommentsAll(xApideckConsumerId, xApideckAppId, collectionId, ticketId, raw, xApideckServiceId, cursor, limit, sort, passThrough, fields)
...
public class Example {
  public static void main(String[] args) {
    ...
    CommentsSort sort = new CommentsSort(); // CommentsSort | Apply sorting
    ...
    try {
      GetCommentsResponse result = apiInstance.collectionTicketCommentsAll(xApideckConsumerId, xApideckAppId, collectionId, ticketId, raw, xApideckServiceId, cursor, limit, sort, passThrough, fields);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling CommentsApi#collectionTicketCommentsAll");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="collectionTicketCommentsDelete"></a>
# **collectionTicketCommentsDelete**
> DeleteCommentResponse collectionTicketCommentsDelete(id, xApideckConsumerId, xApideckAppId, collectionId, ticketId, xApideckServiceId, raw)
...
public class Example {
  public static void main(String[] args) {
    ...
    Boolean raw = false; // Boolean | Include raw response. Mostly used for debugging purposes
    try {
      DeleteCommentResponse result = apiInstance.collectionTicketCommentsDelete(id, xApideckConsumerId, xApideckAppId, collectionId, ticketId, xApideckServiceId, raw);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling CommentsApi#collectionTicketCommentsDelete");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="collectionTicketCommentsOne"></a>
# **collectionTicketCommentsOne**
> GetCommentResponse collectionTicketCommentsOne(id, xApideckConsumerId, xApideckAppId, collectionId, ticketId, raw, xApideckServiceId, cursor, limit, fields)
...
public class Example {
  public static void main(String[] args) {
    ...
    String fields = "id,updated_at"; // String | The 'fields' parameter allows API users to specify the fields they want to include in the API response. If this parameter is not present, the API will return all available fields. If this parameter is present, only the fields specified in the comma-separated string will be included in the response. Nested properties can also be requested by using a dot notation. <br /><br />Example: `fields=name,email,addresses.city`<br /><br />In the example above, the response will only include the fields \"name\", \"email\" and \"addresses.city\". If any other fields are available, they will be excluded.
    try {
      GetCommentResponse result = apiInstance.collectionTicketCommentsOne(id, xApideckConsumerId, xApideckAppId, collectionId, ticketId, raw, xApideckServiceId, cursor, limit, fields);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling CommentsApi#collectionTicketCommentsOne");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="collectionTicketCommentsUpdate"></a>
# **collectionTicketCommentsUpdate**
> UpdateCommentResponse collectionTicketCommentsUpdate(id, xApideckConsumerId, xApideckAppId, collectionId, ticketId, collectionTicketComment, xApideckServiceId, raw)
...
public class Example {
  public static void main(String[] args) {
    ...
    Boolean raw = false; // Boolean | Include raw response. Mostly used for debugging purposes
    try {
      UpdateCommentResponse result = apiInstance.collectionTicketCommentsUpdate(id, xApideckConsumerId, xApideckAppId, collectionId, ticketId, collectionTicketComment, xApideckServiceId, raw);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling CommentsApi#collectionTicketCommentsUpdate");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
