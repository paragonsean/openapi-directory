...
|------------- | ------------- | -------------|
| [**collectionUsersAll**](UsersApi.md#collectionUsersAll) | **GET** /issue-tracking/collections/{collection_id}/users | List Users |
| [**collectionUsersOne**](UsersApi.md#collectionUsersOne) | **GET** /issue-tracking/collections/{collection_id}/users/{id} | Get user |


<a id="collectionUsersAll"></a>
# **collectionUsersAll**
> GetCollectionUsersResponse collectionUsersAll(collectionId, xApideckConsumerId, xApideckAppId, raw, xApideckServiceId, cursor, limit, passThrough, fields)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      GetCollectionUsersResponse result = apiInstance.collectionUsersAll(collectionId, xApideckConsumerId, xApideckAppId, raw, xApideckServiceId, cursor, limit, passThrough, fields);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling UsersApi#collectionUsersAll");
...
<a id="collectionUsersOne"></a>
# **collectionUsersOne**
> GetCollectionUserResponse collectionUsersOne(collectionId, id, xApideckConsumerId, xApideckAppId, xApideckServiceId, raw, fields)
...
public class Example {
  public static void main(String[] args) {
    ...
    String fields = "id,updated_at"; // String | The 'fields' parameter allows API users to specify the fields they want to include in the API response. If this parameter is not present, the API will return all available fields. If this parameter is present, only the fields specified in the comma-separated string will be included in the response. Nested properties can also be requested by using a dot notation. <br /><br />Example: `fields=name,email,addresses.city`<br /><br />In the example above, the response will only include the fields \"name\", \"email\" and \"addresses.city\". If any other fields are available, they will be excluded.
    try {
      GetCollectionUserResponse result = apiInstance.collectionUsersOne(collectionId, id, xApideckConsumerId, xApideckAppId, xApideckServiceId, raw, fields);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling UsersApi#collectionUsersOne");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
