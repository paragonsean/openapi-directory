...
public class Address {
  ...
  public Address rowVersion(String rowVersion) {
  ...
  public Address string(String string) {
    this.string = string;
    return this;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(city, contactName, country, county, email, fax, id, latitude, line1, line2, line3, line4, longitude, name, notes, phoneNumber, postalCode, rowVersion, salutation, state, streetNumber, string, type, website);
  }
