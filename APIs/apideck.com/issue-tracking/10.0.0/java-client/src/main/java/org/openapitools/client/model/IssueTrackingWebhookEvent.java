...
import org.openapitools.client.model.IssueTrackingEventType;
...
public class IssueTrackingWebhookEvent {
  ...
  private IssueTrackingEventType eventType;

  public IssueTrackingWebhookEvent() {
  }

  public IssueTrackingWebhookEvent consumerId(String consumerId) {
  ...
  public IssueTrackingWebhookEvent entityId(String entityId) {
  ...
  public IssueTrackingWebhookEvent entityType(String entityType) {
  ...
  public IssueTrackingWebhookEvent entityUrl(String entityUrl) {
  ...
  public IssueTrackingWebhookEvent eventId(String eventId) {
  ...
  public IssueTrackingWebhookEvent executionAttempt(BigDecimal executionAttempt) {
  ...
  public IssueTrackingWebhookEvent occurredAt(String occurredAt) {
  ...
  public IssueTrackingWebhookEvent serviceId(String serviceId) {
  ...
  public IssueTrackingWebhookEvent unifiedApi(UnifiedApiEnum unifiedApi) {
  ...
  public IssueTrackingWebhookEvent eventType(IssueTrackingEventType eventType) {
   ...
   */
  @javax.annotation.Nullable
  public IssueTrackingEventType getEventType() {
    return eventType;
  }

  public void setEventType(IssueTrackingEventType eventType) {
    this.eventType = eventType;
  }
  ...
  public boolean equals(Object o) {
    ...
    IssueTrackingWebhookEvent issueTrackingWebhookEvent = (IssueTrackingWebhookEvent) o;
    return Objects.equals(this.consumerId, issueTrackingWebhookEvent.consumerId) &&
        Objects.equals(this.entityId, issueTrackingWebhookEvent.entityId) &&
        Objects.equals(this.entityType, issueTrackingWebhookEvent.entityType) &&
        Objects.equals(this.entityUrl, issueTrackingWebhookEvent.entityUrl) &&
        Objects.equals(this.eventId, issueTrackingWebhookEvent.eventId) &&
        Objects.equals(this.executionAttempt, issueTrackingWebhookEvent.executionAttempt) &&
        Objects.equals(this.occurredAt, issueTrackingWebhookEvent.occurredAt) &&
        Objects.equals(this.serviceId, issueTrackingWebhookEvent.serviceId) &&
        Objects.equals(this.unifiedApi, issueTrackingWebhookEvent.unifiedApi) &&
        Objects.equals(this.eventType, issueTrackingWebhookEvent.eventType);
  }
  ...
  public String toString() {
    ...
    sb.append("class IssueTrackingWebhookEvent {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IssueTrackingWebhookEvent
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IssueTrackingWebhookEvent.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IssueTrackingWebhookEvent is not found in the empty JSON string", IssueTrackingWebhookEvent.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IssueTrackingWebhookEvent.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IssueTrackingWebhookEvent` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("event_type") != null && !jsonObj.get("event_type").isJsonNull()) {
        IssueTrackingEventType.validateJsonElement(jsonObj.get("event_type"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IssueTrackingWebhookEvent.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IssueTrackingWebhookEvent' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IssueTrackingWebhookEvent> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IssueTrackingWebhookEvent.class));

       return (TypeAdapter<T>) new TypeAdapter<IssueTrackingWebhookEvent>() {
           @Override
           public void write(JsonWriter out, IssueTrackingWebhookEvent value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IssueTrackingWebhookEvent read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IssueTrackingWebhookEvent given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IssueTrackingWebhookEvent
   * @throws IOException if the JSON string is invalid with respect to IssueTrackingWebhookEvent
   */
  public static IssueTrackingWebhookEvent fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IssueTrackingWebhookEvent.class);
  }

  /**
   * Convert an instance of IssueTrackingWebhookEvent to an JSON string
   *
   * @return JSON string
   */
