...
public class Ticket {
  ...
  public Ticket assignees(List<Assignee> assignees) {
    this.assignees = assignees;
    return this;
  }

  public Ticket addAssigneesItem(Assignee assigneesItem) {
  ...
  public Ticket customMappings(Object customMappings) {
  ...
  public Ticket dueDate(OffsetDateTime dueDate) {
  ...
  public Ticket parentId(String parentId) {
  ...
  public Ticket tags(List<CollectionTag> tags) {
    this.tags = tags;
    return this;
  }

  public Ticket addTagsItem(CollectionTag tagsItem) {
    if (this.tags == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.assignees, ticket.assignees) &&
        Objects.equals(this.collectionId, ticket.collectionId) &&
        Objects.equals(this.completedAt, ticket.completedAt) &&
        Objects.equals(this.createdAt, ticket.createdAt) &&
        Objects.equals(this.createdBy, ticket.createdBy) &&
        Objects.equals(this.customMappings, ticket.customMappings) &&
        Objects.equals(this.description, ticket.description) &&
        Objects.equals(this.dueDate, ticket.dueDate) &&
        Objects.equals(this.id, ticket.id) &&
        Objects.equals(this.parentId, ticket.parentId) &&
        ...
        Objects.equals(this.tags, ticket.tags) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(assignees, collectionId, completedAt, createdAt, createdBy, customMappings, description, dueDate, id, parentId, priority, status, subject, tags, type, updatedAt);
  }
      ...
      if (jsonObj.get("assignees") != null && !jsonObj.get("assignees").isJsonNull()) {
        ...
        if (jsonArrayassignees != null) {
          ...
          for (int i = 0; i < jsonArrayassignees.size(); i++) {
            Assignee.validateJsonElement(jsonArrayassignees.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("tags") != null && !jsonObj.get("tags").isJsonNull()) {
        ...
        if (jsonArraytags != null) {
          ...
          for (int i = 0; i < jsonArraytags.size(); i++) {
            CollectionTag.validateJsonElement(jsonArraytags.get(i));
          };
        }
      }
