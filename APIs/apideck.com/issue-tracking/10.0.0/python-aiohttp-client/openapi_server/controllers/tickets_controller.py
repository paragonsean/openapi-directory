...
async def collection_tickets_add(request: web.Request, x_apideck_consumer_id, x_apideck_app_id, collection_id, body, raw=None, x_apideck_service_id=None) -> web.Response:
    """Create Ticket
    ...
    """
    body = Ticket.from_dict(body)
    return web.Response(status=200)


async def collection_tickets_all(request: web.Request, x_apideck_consumer_id, x_apideck_app_id, collection_id, raw=None, x_apideck_service_id=None, cursor=None, limit=None, sort=None, filter=None, pass_through=None, fields=None) -> web.Response:
    """List Tickets
...
async def collection_tickets_delete(request: web.Request, ticket_id, x_apideck_consumer_id, x_apideck_app_id, collection_id, x_apideck_service_id=None, raw=None) -> web.Response:
    """Delete Ticket
...
async def collection_tickets_one(request: web.Request, ticket_id, x_apideck_consumer_id, x_apideck_app_id, collection_id, x_apideck_service_id=None, raw=None, fields=None) -> web.Response:
    """Get Ticket
...
async def collection_tickets_update(request: web.Request, ticket_id, x_apideck_consumer_id, x_apideck_app_id, collection_id, body, x_apideck_service_id=None, raw=None) -> web.Response:
    """Update Ticket
