...
async def collections_all(request: web.Request, x_apideck_consumer_id, x_apideck_app_id, raw=None, x_apideck_service_id=None, cursor=None, limit=None, sort=None, pass_through=None, fields=None) -> web.Response:
    """List Collections
...
async def collections_one(request: web.Request, collection_id, x_apideck_consumer_id, x_apideck_app_id, x_apideck_service_id=None, raw=None, fields=None) -> web.Response:
    """Get Collection
