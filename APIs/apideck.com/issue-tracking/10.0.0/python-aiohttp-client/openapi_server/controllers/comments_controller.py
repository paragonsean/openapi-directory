...
async def collection_ticket_comments_add(request: web.Request, x_apideck_consumer_id, x_apideck_app_id, collection_id, ticket_id, body, raw=None, x_apideck_service_id=None) -> web.Response:
    """Create Comment
    ...
    """
    body = CollectionTicketComment.from_dict(body)
    return web.Response(status=200)


async def collection_ticket_comments_all(request: web.Request, x_apideck_consumer_id, x_apideck_app_id, collection_id, ticket_id, raw=None, x_apideck_service_id=None, cursor=None, limit=None, sort=None, pass_through=None, fields=None) -> web.Response:
    """List Comments
...
async def collection_ticket_comments_delete(request: web.Request, id, x_apideck_consumer_id, x_apideck_app_id, collection_id, ticket_id, x_apideck_service_id=None, raw=None) -> web.Response:
    """Delete Comment
...
async def collection_ticket_comments_one(request: web.Request, id, x_apideck_consumer_id, x_apideck_app_id, collection_id, ticket_id, raw=None, x_apideck_service_id=None, cursor=None, limit=None, fields=None) -> web.Response:
    """Get Comment
...
async def collection_ticket_comments_update(request: web.Request, id, x_apideck_consumer_id, x_apideck_app_id, collection_id, ticket_id, body, x_apideck_service_id=None, raw=None) -> web.Response:
    """Update Comment
