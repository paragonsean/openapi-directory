...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.expect, root.IssueTrackingApi);
  }
}(this, function(expect, IssueTrackingApi) {
  'use strict';

  var instance;

  beforeEach(function() {
    instance = new IssueTrackingApi.Department();
  });
  ...
  describe('Department', function() {
    it('should create an instance of Department', function() {
      ...
      //var instance = new IssueTrackingApi.Department();
      //expect(instance).to.be.a(IssueTrackingApi.Department);
    });
