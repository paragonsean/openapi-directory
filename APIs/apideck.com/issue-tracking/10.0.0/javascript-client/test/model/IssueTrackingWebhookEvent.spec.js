...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IssueTrackingApi.IssueTrackingWebhookEvent();
  });
  ...
  describe('IssueTrackingWebhookEvent', function() {
    it('should create an instance of IssueTrackingWebhookEvent', function() {
      // uncomment below and update the code to test IssueTrackingWebhookEvent
      //var instance = new IssueTrackingApi.IssueTrackingWebhookEvent();
      //expect(instance).to.be.a(IssueTrackingApi.IssueTrackingWebhookEvent);
    });
