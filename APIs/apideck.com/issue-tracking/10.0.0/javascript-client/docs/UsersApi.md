...
> GetCollectionUsersResponse collectionUsersAll(collectionId, xApideckConsumerId, xApideckAppId, opts)
...
let apiInstance = new IssueTrackingApi.UsersApi();
...
apiInstance.collectionUsersAll(collectionId, xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> GetCollectionUserResponse collectionUsersOne(collectionId, id, xApideckConsumerId, xApideckAppId, opts)
...
apiInstance.collectionUsersOne(collectionId, id, xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
