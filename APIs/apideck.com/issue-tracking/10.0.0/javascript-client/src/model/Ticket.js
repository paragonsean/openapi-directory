    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('assignees')) {
                obj['assignees'] = ApiClient.convertToType(data['assignees'], [Assignee]);
            }
            ...
            if (data.hasOwnProperty('tags')) {
                obj['tags'] = ApiClient.convertToType(data['tags'], [CollectionTag]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['tags']) { // data not null
            ...
            for (const item of data['tags']) {
                CollectionTag.validateJSON(item);
            };
        }
        // ensure the json data is a string
...
Ticket.RequiredProperties = ["id"];

/**
 * @member {Array.<module:model/Assignee>} assignees
 */
 ...
 */
Ticket.prototype['collection_id'] = undefined;

/**
 * When the ticket was completed
 * @member {Date} completed_at
 */
Ticket.prototype['completed_at'] = undefined;
 ...
 */
Ticket.prototype['created_by'] = undefined;

/**
 * When custom mappings are configured on the resource, the result is included here.
 * @member {Object} custom_mappings
 */
Ticket.prototype['custom_mappings'] = undefined;
 ...
 */
Ticket.prototype['parent_id'] = undefined;

/**
 * Priority of the ticket
 * @member {module:model/Ticket.PriorityEnum} priority
 */
...
/**
 * @member {Array.<module:model/CollectionTag>} tags
 */
