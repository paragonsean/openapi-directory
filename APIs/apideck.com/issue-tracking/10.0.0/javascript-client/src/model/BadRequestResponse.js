...
import BadRequestResponseDetail from './BadRequestResponseDetail';
...
class BadRequestResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('detail')) {
                obj['detail'] = BadRequestResponseDetail.constructFromObject(data['detail']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['detail']) { // data not null
          BadRequestResponseDetail.validateJSON(data['detail']);
        }
...
/**
 * @member {module:model/BadRequestResponseDetail} detail
 */
BadRequestResponse.prototype['detail'] = undefined;

/**
 * Contains an explanation of the status_code as defined in HTTP/1.1 standard (RFC 7231)
 * @member {String} error
 */
BadRequestResponse.prototype['error'] = undefined;
 ...
 * @member {String} ref
 */
BadRequestResponse.prototype['ref'] = undefined;

/**
 * HTTP status code
 * @member {Number} status_code
 */
BadRequestResponse.prototype['status_code'] = undefined;

/**
 * The type of error returned
 * @member {String} type_name
 */
BadRequestResponse.prototype['type_name'] = undefined;
