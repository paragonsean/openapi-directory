...
class Website {
     ...
     * @param url {String} The website URL
     */
    constructor(url) { 
        
        Website.initialize(this, url);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Website</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Website</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Website.RequiredProperties) {
...
Website.RequiredProperties = ["url"];
...
/**
 * The type of website
 * @member {module:model/Website.TypeEnum} type
 */
Website.prototype['type'] = undefined;

/**
 * The website URL
 * @member {String} url
 */
Website.prototype['url'] = undefined;
