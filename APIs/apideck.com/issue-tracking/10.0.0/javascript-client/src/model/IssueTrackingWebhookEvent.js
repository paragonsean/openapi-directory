...
import IssueTrackingEventType from './IssueTrackingEventType';

/**
 * The IssueTrackingWebhookEvent model module.
 * @module model/IssueTrackingWebhookEvent
 * @version 10.0.0
 */
class IssueTrackingWebhookEvent {
    /**
     * Constructs a new <code>IssueTrackingWebhookEvent</code>.
     * @alias module:model/IssueTrackingWebhookEvent
     */
    constructor() { 
        
        IssueTrackingWebhookEvent.initialize(this);
    }
    ...
    /**
     * Constructs a <code>IssueTrackingWebhookEvent</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IssueTrackingWebhookEvent} obj Optional instance to populate.
     * @return {module:model/IssueTrackingWebhookEvent} The populated <code>IssueTrackingWebhookEvent</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IssueTrackingWebhookEvent();
            ...
            if (data.hasOwnProperty('event_type')) {
                obj['event_type'] = IssueTrackingEventType.constructFromObject(data['event_type']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>IssueTrackingWebhookEvent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IssueTrackingWebhookEvent</code>.
     */
 ...
 */
IssueTrackingWebhookEvent.prototype['consumer_id'] = undefined;

/**
 * The service provider's ID of the entity that triggered this event
 * @member {String} entity_id
 */
IssueTrackingWebhookEvent.prototype['entity_id'] = undefined;

/**
 * The type entity that triggered this event
 * @member {String} entity_type
 */
IssueTrackingWebhookEvent.prototype['entity_type'] = undefined;

/**
 * The url to retrieve entity detail.
 * @member {String} entity_url
 */
IssueTrackingWebhookEvent.prototype['entity_url'] = undefined;

/**
 * Unique reference to this request event
 * @member {String} event_id
 */
IssueTrackingWebhookEvent.prototype['event_id'] = undefined;

/**
 * The current count this request event has been attempted
 * @member {Number} execution_attempt
 */
IssueTrackingWebhookEvent.prototype['execution_attempt'] = undefined;

/**
 * ISO Datetime for when the original event occurred
 * @member {String} occurred_at
 */
IssueTrackingWebhookEvent.prototype['occurred_at'] = undefined;

/**
 * Service provider identifier
 * @member {String} service_id
 */
IssueTrackingWebhookEvent.prototype['service_id'] = undefined;

/**
 * Name of Apideck Unified API
 * @member {module:model/IssueTrackingWebhookEvent.UnifiedApiEnum} unified_api
 */
IssueTrackingWebhookEvent.prototype['unified_api'] = undefined;

/**
 * @member {module:model/IssueTrackingEventType} event_type
 */
IssueTrackingWebhookEvent.prototype['event_type'] = undefined;
 ...
 * @readonly
 */
IssueTrackingWebhookEvent['UnifiedApiEnum'] = {
...
export default IssueTrackingWebhookEvent;
