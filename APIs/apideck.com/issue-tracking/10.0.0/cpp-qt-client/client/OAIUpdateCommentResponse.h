...
/*
 * OAIUpdateCommentResponse.h
 *
 * 
 */

#ifndef OAIUpdateCommentResponse_H
#define OAIUpdateCommentResponse_H
...
class OAIUpdateCommentResponse : public OAIObject {
public:
    OAIUpdateCommentResponse();
    OAIUpdateCommentResponse(QString json);
    ~OAIUpdateCommentResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateCommentResponse)

#endif // OAIUpdateCommentResponse_H
