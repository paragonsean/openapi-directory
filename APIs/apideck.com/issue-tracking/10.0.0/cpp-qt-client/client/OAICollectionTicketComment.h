...
/*
 * OAICollectionTicketComment.h
 *
 * 
 */

#ifndef OAICollectionTicketComment_H
#define OAICollectionTicketComment_H
...
class OAICollectionTicketComment : public OAIObject {
public:
    OAICollectionTicketComment();
    OAICollectionTicketComment(QString json);
    ~OAICollectionTicketComment() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICollectionTicketComment)

#endif // OAICollectionTicketComment_H
