...
/*
 * OAIGetCollectionUsersResponse.h
 *
 * 
 */

#ifndef OAIGetCollectionUsersResponse_H
#define OAIGetCollectionUsersResponse_H

#include <QJsonObject>

#include "OAICollectionUser.h"
#include "OAILinks.h"
#include "OAIMeta.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAICollectionUser;
class OAILinks;
class OAIMeta;

class OAIGetCollectionUsersResponse : public OAIObject {
public:
    OAIGetCollectionUsersResponse();
    OAIGetCollectionUsersResponse(QString json);
    ~OAIGetCollectionUsersResponse() override;
    ...
    QList<OAICollectionUser> getData() const;
    void setData(const QList<OAICollectionUser> &data);
...
private:
    ...
    QList<OAICollectionUser> m_data;
    bool m_data_isSet;
    bool m_data_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetCollectionUsersResponse)

#endif // OAIGetCollectionUsersResponse_H
