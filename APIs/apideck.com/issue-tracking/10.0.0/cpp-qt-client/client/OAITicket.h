...
public:
    ...
    QList<OAIAssignee> getAssignees() const;
    void setAssignees(const QList<OAIAssignee> &assignees);
    ...
    QList<OAICollectionTag> getTags() const;
    void setTags(const QList<OAICollectionTag> &tags);
