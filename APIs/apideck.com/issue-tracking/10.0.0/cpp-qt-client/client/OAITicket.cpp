...
QList<OAIAssignee> OAITicket::getAssignees() const {
    return m_assignees;
}
void OAITicket::setAssignees(const QList<OAIAssignee> &assignees) {
    m_assignees = assignees;
    m_assignees_isSet = true;
}

bool OAITicket::is_assignees_Set() const{
    return m_assignees_isSet;
}

bool OAITicket::is_assignees_Valid() const{
    return m_assignees_isValid;
}

QString OAITicket::getCollectionId() const {
    return m_collection_id;
}
void OAITicket::setCollectionId(const QString &collection_id) {
    m_collection_id = collection_id;
    m_collection_id_isSet = true;
}

bool OAITicket::is_collection_id_Set() const{
    return m_collection_id_isSet;
}

bool OAITicket::is_collection_id_Valid() const{
    return m_collection_id_isValid;
}

QDateTime OAITicket::getCompletedAt() const {
    return m_completed_at;
}
void OAITicket::setCompletedAt(const QDateTime &completed_at) {
    m_completed_at = completed_at;
    m_completed_at_isSet = true;
}

bool OAITicket::is_completed_at_Set() const{
    return m_completed_at_isSet;
}

bool OAITicket::is_completed_at_Valid() const{
...
QString OAITicket::getCreatedBy() const {
    return m_created_by;
}
void OAITicket::setCreatedBy(const QString &created_by) {
    m_created_by = created_by;
    m_created_by_isSet = true;
}

bool OAITicket::is_created_by_Set() const{
    return m_created_by_isSet;
}

bool OAITicket::is_created_by_Valid() const{
    return m_created_by_isValid;
}

OAIObject OAITicket::getCustomMappings() const {
    return m_custom_mappings;
}
void OAITicket::setCustomMappings(const OAIObject &custom_mappings) {
    m_custom_mappings = custom_mappings;
    m_custom_mappings_isSet = true;
}

bool OAITicket::is_custom_mappings_Set() const{
    return m_custom_mappings_isSet;
}

bool OAITicket::is_custom_mappings_Valid() const{
...
QDateTime OAITicket::getDueDate() const {
    return m_due_date;
}
void OAITicket::setDueDate(const QDateTime &due_date) {
    m_due_date = due_date;
    m_due_date_isSet = true;
}

bool OAITicket::is_due_date_Set() const{
    return m_due_date_isSet;
}

bool OAITicket::is_due_date_Valid() const{
...
QString OAITicket::getParentId() const {
    return m_parent_id;
}
void OAITicket::setParentId(const QString &parent_id) {
    m_parent_id = parent_id;
    m_parent_id_isSet = true;
}

bool OAITicket::is_parent_id_Set() const{
    return m_parent_id_isSet;
}

bool OAITicket::is_parent_id_Valid() const{
...
QList<OAICollectionTag> OAITicket::getTags() const {
    return m_tags;
}
void OAITicket::setTags(const QList<OAICollectionTag> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAITicket::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAITicket::is_tags_Valid() const{
