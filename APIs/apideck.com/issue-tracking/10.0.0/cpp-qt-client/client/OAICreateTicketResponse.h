...
/*
 * OAICreateTicketResponse.h
 *
 * 
 */

#ifndef OAICreateTicketResponse_H
#define OAICreateTicketResponse_H
...
class OAICreateTicketResponse : public OAIObject {
public:
    OAICreateTicketResponse();
    OAICreateTicketResponse(QString json);
    ~OAICreateTicketResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateTicketResponse)

#endif // OAICreateTicketResponse_H
