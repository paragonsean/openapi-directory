...
/*
 * OAIGetCommentResponse.h
 *
 * 
 */

#ifndef OAIGetCommentResponse_H
#define OAIGetCommentResponse_H

#include <QJsonObject>

#include "OAICollectionTicketComment.h"
#include <QString>
...
namespace OpenAPI {
class OAICollectionTicketComment;

class OAIGetCommentResponse : public OAIObject {
public:
    OAIGetCommentResponse();
    OAIGetCommentResponse(QString json);
    ~OAIGetCommentResponse() override;
    ...
    OAICollectionTicketComment getData() const;
    void setData(const OAICollectionTicketComment &data);
...
private:
    ...
    OAICollectionTicketComment m_data;
    bool m_data_isSet;
    bool m_data_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetCommentResponse)

#endif // OAIGetCommentResponse_H
