...
/*
 * OAIGetCollectionTagsResponse.h
 *
 * 
 */

#ifndef OAIGetCollectionTagsResponse_H
#define OAIGetCollectionTagsResponse_H
...
class OAIGetCollectionTagsResponse : public OAIObject {
public:
    OAIGetCollectionTagsResponse();
    OAIGetCollectionTagsResponse(QString json);
    ~OAIGetCollectionTagsResponse() override;
    ...
    QList<OAICollectionTag> getData() const;
    void setData(const QList<OAICollectionTag> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetCollectionTagsResponse)

#endif // OAIGetCollectionTagsResponse_H
