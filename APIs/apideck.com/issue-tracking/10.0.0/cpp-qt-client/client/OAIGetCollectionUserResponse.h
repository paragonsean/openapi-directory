...
/*
 * OAIGetCollectionUserResponse.h
 *
 * 
 */

#ifndef OAIGetCollectionUserResponse_H
#define OAIGetCollectionUserResponse_H
...
class OAIGetCollectionUserResponse : public OAIObject {
public:
    OAIGetCollectionUserResponse();
    OAIGetCollectionUserResponse(QString json);
    ~OAIGetCollectionUserResponse() override;
    ...
    OAICollectionUser getData() const;
    void setData(const OAICollectionUser &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetCollectionUserResponse)

#endif // OAIGetCollectionUserResponse_H
