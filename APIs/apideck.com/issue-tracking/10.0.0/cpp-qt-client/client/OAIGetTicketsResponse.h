...
/*
 * OAIGetTicketsResponse.h
 *
 * 
 */

#ifndef OAIGetTicketsResponse_H
#define OAIGetTicketsResponse_H
...
class OAIGetTicketsResponse : public OAIObject {
public:
    OAIGetTicketsResponse();
    OAIGetTicketsResponse(QString json);
    ~OAIGetTicketsResponse() override;
    ...
    QList<OAITicket> getData() const;
    void setData(const QList<OAITicket> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetTicketsResponse)

#endif // OAIGetTicketsResponse_H
