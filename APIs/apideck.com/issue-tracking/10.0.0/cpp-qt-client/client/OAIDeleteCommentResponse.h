...
/*
 * OAIDeleteCommentResponse.h
 *
 * 
 */

#ifndef OAIDeleteCommentResponse_H
#define OAIDeleteCommentResponse_H
...
class OAIDeleteCommentResponse : public OAIObject {
public:
    OAIDeleteCommentResponse();
    OAIDeleteCommentResponse(QString json);
    ~OAIDeleteCommentResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteCommentResponse)

#endif // OAIDeleteCommentResponse_H
