...
/*
 * OAIUnprocessableResponse.h
 *
 * 
 */

#ifndef OAIUnprocessableResponse_H
#define OAIUnprocessableResponse_H
...
class OAIUnprocessableResponse : public OAIObject {
public:
    OAIUnprocessableResponse();
    OAIUnprocessableResponse(QString json);
    ~OAIUnprocessableResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUnprocessableResponse)

#endif // OAIUnprocessableResponse_H
