...
#ifndef OAICollectionUser_H
#define OAICollectionUser_H
...
class OAICollectionUser : public OAIObject {
public:
    OAICollectionUser();
    OAICollectionUser(QString json);
    ~OAICollectionUser() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICollectionUser)

#endif // OAICollectionUser_H
