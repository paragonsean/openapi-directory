...
void OAITagsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("collectionTagsAll", defaultConf);
    _serverIndices.insert("collectionTagsAll", 0);
}
...
void OAITagsApi::collectionTagsAll(const QString &collection_id, const QString &x_apideck_consumer_id, const QString &x_apideck_app_id, const ::OpenAPI::OptionalParam<bool> &raw, const ::OpenAPI::OptionalParam<QString> &x_apideck_service_id, const ::OpenAPI::OptionalParam<QString> &cursor, const ::OpenAPI::OptionalParam<qint32> &limit, const ::OpenAPI::OptionalParam<OAIPassThroughQuery> &pass_through, const ::OpenAPI::OptionalParam<QString> &fields) {
    QString fullPath = QString(_serverConfigs["collectionTagsAll"][_serverIndices.value("collectionTagsAll")].URL()+"/issue-tracking/collections/{collection_id}/tags");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAITagsApi::collectionTagsAllCallback);
...
void OAITagsApi::collectionTagsAllCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIGetCollectionTagsResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT collectionTagsAllSignal(output);
        Q_EMIT collectionTagsAllSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT collectionTagsAllSignalE(output, error_type, error_str);
        Q_EMIT collectionTagsAllSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT collectionTagsAllSignalError(output, error_type, error_str);
        Q_EMIT collectionTagsAllSignalErrorFull(worker, error_type, error_str);
    }
}
