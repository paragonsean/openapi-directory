...
/*
 * OAIDeleteTicketResponse.h
 *
 * 
 */

#ifndef OAIDeleteTicketResponse_H
#define OAIDeleteTicketResponse_H
...
class OAIDeleteTicketResponse : public OAIObject {
public:
    OAIDeleteTicketResponse();
    OAIDeleteTicketResponse(QString json);
    ~OAIDeleteTicketResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteTicketResponse)

#endif // OAIDeleteTicketResponse_H
