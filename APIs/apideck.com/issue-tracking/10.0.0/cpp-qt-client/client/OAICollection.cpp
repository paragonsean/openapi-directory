...
QDateTime OAICollection::getCreatedAt() const {
    return m_created_at;
}
void OAICollection::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAICollection::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAICollection::is_created_at_Valid() const{
    return m_created_at_isValid;
}

OAIObject OAICollection::getCustomMappings() const {
    return m_custom_mappings;
}
void OAICollection::setCustomMappings(const OAIObject &custom_mappings) {
    m_custom_mappings = custom_mappings;
    m_custom_mappings_isSet = true;
}

bool OAICollection::is_custom_mappings_Set() const{
    return m_custom_mappings_isSet;
}

bool OAICollection::is_custom_mappings_Valid() const{
...
QString OAICollection::getParentId() const {
    return m_parent_id;
}
void OAICollection::setParentId(const QString &parent_id) {
    m_parent_id = parent_id;
    m_parent_id_isSet = true;
}

bool OAICollection::is_parent_id_Set() const{
    return m_parent_id_isSet;
}

bool OAICollection::is_parent_id_Valid() const{
...
QDateTime OAICollection::getUpdatedAt() const {
    return m_updated_at;
}
void OAICollection::setUpdatedAt(const QDateTime &updated_at) {
    m_updated_at = updated_at;
    m_updated_at_isSet = true;
}

bool OAICollection::is_updated_at_Set() const{
    return m_updated_at_isSet;
}

bool OAICollection::is_updated_at_Valid() const{
