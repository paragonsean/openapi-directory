...
void OAICollectionsApi::collectionsAll(const QString &x_apideck_consumer_id, const QString &x_apideck_app_id, const ::OpenAPI::OptionalParam<bool> &raw, const ::OpenAPI::OptionalParam<QString> &x_apideck_service_id, const ::OpenAPI::OptionalParam<QString> &cursor, const ::OpenAPI::OptionalParam<qint32> &limit, const ::OpenAPI::OptionalParam<OAICollectionsSort> &sort, const ::OpenAPI::OptionalParam<OAIPassThroughQuery> &pass_through, const ::OpenAPI::OptionalParam<QString> &fields) {
    QString fullPath = QString(_serverConfigs["collectionsAll"][_serverIndices.value("collectionsAll")].URL()+"/issue-tracking/collections");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICollectionsApi::collectionsAllCallback);
...
void OAICollectionsApi::collectionsAllCallback(OAIHttpRequestWorker *worker) {
...
void OAICollectionsApi::collectionsOne(const QString &collection_id, const QString &x_apideck_consumer_id, const QString &x_apideck_app_id, const ::OpenAPI::OptionalParam<QString> &x_apideck_service_id, const ::OpenAPI::OptionalParam<bool> &raw, const ::OpenAPI::OptionalParam<QString> &fields) {
    QString fullPath = QString(_serverConfigs["collectionsOne"][_serverIndices.value("collectionsOne")].URL()+"/issue-tracking/collections/{collection_id}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICollectionsApi::collectionsOneCallback);
    connect(this, &OAICollectionsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAICollectionsApi::collectionsOneCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
