...
/*
 * OAIGetCommentsResponse.h
 *
 * 
 */

#ifndef OAIGetCommentsResponse_H
#define OAIGetCommentsResponse_H
...
class OAIGetCommentsResponse : public OAIObject {
public:
    OAIGetCommentsResponse();
    OAIGetCommentsResponse(QString json);
    ~OAIGetCommentsResponse() override;
    ...
    QList<OAICollectionTicketComment> getData() const;
    void setData(const QList<OAICollectionTicketComment> &data);
...
private:
    ...
    QList<OAICollectionTicketComment> m_data;
    bool m_data_isSet;
    bool m_data_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetCommentsResponse)

#endif // OAIGetCommentsResponse_H
