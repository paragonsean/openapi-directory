...
/*
 * OAICreateCommentResponse.h
 *
 * 
 */

#ifndef OAICreateCommentResponse_H
#define OAICreateCommentResponse_H
...
class OAICreateCommentResponse : public OAIObject {
public:
    OAICreateCommentResponse();
    OAICreateCommentResponse(QString json);
    ~OAICreateCommentResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCommentResponse)

#endif // OAICreateCommentResponse_H
