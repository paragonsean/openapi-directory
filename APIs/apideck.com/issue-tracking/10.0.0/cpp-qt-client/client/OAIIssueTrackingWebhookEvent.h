...
/*
 * OAIIssueTrackingWebhookEvent.h
 *
 * 
 */

#ifndef OAIIssueTrackingWebhookEvent_H
#define OAIIssueTrackingWebhookEvent_H

#include <QJsonObject>

#include "OAIIssueTrackingEventType.h"
#include <QString>
...
class OAIIssueTrackingWebhookEvent : public OAIObject {
public:
    OAIIssueTrackingWebhookEvent();
    OAIIssueTrackingWebhookEvent(QString json);
    ~OAIIssueTrackingWebhookEvent() override;
    ...
    OAIIssueTrackingEventType getEventType() const;
    void setEventType(const OAIIssueTrackingEventType &event_type);
...
private:
    ...
    OAIIssueTrackingEventType m_event_type;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIssueTrackingWebhookEvent)

#endif // OAIIssueTrackingWebhookEvent_H
