...
/*
 * OAIGetTicketResponse.h
 *
 * 
 */

#ifndef OAIGetTicketResponse_H
#define OAIGetTicketResponse_H
...
class OAIGetTicketResponse : public OAIObject {
public:
    OAIGetTicketResponse();
    OAIGetTicketResponse(QString json);
    ~OAIGetTicketResponse() override;
    ...
    OAITicket getData() const;
    void setData(const OAITicket &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetTicketResponse)

#endif // OAIGetTicketResponse_H
