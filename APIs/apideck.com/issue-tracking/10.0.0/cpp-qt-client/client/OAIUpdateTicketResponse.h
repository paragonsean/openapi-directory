...
/*
 * OAIUpdateTicketResponse.h
 *
 * 
 */

#ifndef OAIUpdateTicketResponse_H
#define OAIUpdateTicketResponse_H
...
class OAIUpdateTicketResponse : public OAIObject {
public:
    OAIUpdateTicketResponse();
    OAIUpdateTicketResponse(QString json);
    ~OAIUpdateTicketResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateTicketResponse)

#endif // OAIUpdateTicketResponse_H
