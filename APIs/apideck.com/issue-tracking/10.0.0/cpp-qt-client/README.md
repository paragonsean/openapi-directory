...
#include <iostream>
#include "../client/OAICollectionsApi.h"
...
qint32 Example::create(){
    qint32 obj;
OAICollectionsSort Example::create(){
    OAICollectionsSort obj;
...
void Example::exampleFunction1(){
     OAICollectionsApi apiInstance;
     
      // Configure API key authorization: apiKey
      apiInstance.setApiKey("YOUR API KEY NAME","YOUR API KEY");

      QEventLoop loop;
      connect(&apiInstance, &OAICollectionsApi::collectionsAllSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAICollectionsApi::collectionsAllSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
      ...
      OAICollectionsSort sort = create(); // OAICollectionsSort | Apply sorting
      ...
      apiInstance.collectionsAll(x_apideck_consumer_idx_apideck_app_idrawx_apideck_service_idcursorlimitsortpass_throughfields);
