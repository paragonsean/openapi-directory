...
public class GetMerchantResponse {
  ...
  public GetMerchantResponse data(Merchant data) {
    this.data = data;
    return this;
  }
  ...
  public GetMerchantResponse operation(String operation) {
  ...
  public GetMerchantResponse resource(String resource) {
  ...
  public GetMerchantResponse service(String service) {
  ...
  public GetMerchantResponse statusCode(Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, getMerchantResponse.data) &&
        Objects.equals(this.operation, getMerchantResponse.operation) &&
        Objects.equals(this.resource, getMerchantResponse.resource) &&
        Objects.equals(this.service, getMerchantResponse.service) &&
        Objects.equals(this.status, getMerchantResponse.status) &&
        Objects.equals(this.statusCode, getMerchantResponse.statusCode);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetMerchantResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetMerchantResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetMerchantResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetMerchantResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      Merchant.validateJsonElement(jsonObj.get("data"));
