...
public class CustomFieldValue extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(CustomFieldValue.class.getName());
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>) new TypeAdapter<CustomFieldValue>() {
                ...
                public void write(JsonWriter out, CustomFieldValue value) throws IOException {
                    ...
                    throw new IOException("Failed to serialize as the type doesn't match anyOf schemas: BigDecimal, Boolean, List<Object>, List<String>, Object, String");
                }
                ...
                public CustomFieldValue read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        CustomFieldValue ret = new CustomFieldValue();
                    ...
                    throw new IOException(String.format("Failed deserialization for CustomFieldValue: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public CustomFieldValue(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return CustomFieldValue.schemas;
    }

    /**
     * Set the instance that matches the anyOf child schema, check
     * the instance parameter is valid against the anyOf child schemas:
     * BigDecimal, Boolean, List<Object>, List<String>, Object, String
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be BigDecimal, Boolean, List<Object>, List<String>, Object, String");
    }
     ...
     * BigDecimal, Boolean, List<Object>, List<String>, Object, String
     *
     * @return The actual instance (BigDecimal, Boolean, List<Object>, List<String>, Object, String)
     */
    @SuppressWarnings("unchecked")
    @Override
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format("The JSON string is invalid for CustomFieldValue with anyOf schemas: BigDecimal, Boolean, List<Object>, List<String>, Object, String. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }
