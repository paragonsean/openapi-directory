...
public class CreateMerchantResponse {
  ...
  public CreateMerchantResponse data(UnifiedId data) {
    this.data = data;
    return this;
  }
  ...
  public CreateMerchantResponse operation(String operation) {
  ...
  public CreateMerchantResponse resource(String resource) {
  ...
  public CreateMerchantResponse service(String service) {
  ...
  public CreateMerchantResponse status(String status) {
    this.status = status;
    return this;
  }
  ...
  public CreateMerchantResponse statusCode(Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, createMerchantResponse.data) &&
        Objects.equals(this.operation, createMerchantResponse.operation) &&
        Objects.equals(this.resource, createMerchantResponse.resource) &&
        Objects.equals(this.service, createMerchantResponse.service) &&
        Objects.equals(this.status, createMerchantResponse.status) &&
        Objects.equals(this.statusCode, createMerchantResponse.statusCode);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateMerchantResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateMerchantResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateMerchantResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateMerchantResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
