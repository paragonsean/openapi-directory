...
import org.openapitools.client.model.PosBankAccountAchDetails;
...
public class PosBankAccount {
  ...
  private PosBankAccountAchDetails achDetails;
  ...
  public PosBankAccount accountOwnershipType(String accountOwnershipType) {
  ...
  public PosBankAccount achDetails(PosBankAccountAchDetails achDetails) {
   ...
   */
  @javax.annotation.Nullable
  public PosBankAccountAchDetails getAchDetails() {
    return achDetails;
  }

  public void setAchDetails(PosBankAccountAchDetails achDetails) {
    this.achDetails = achDetails;
  }


  public PosBankAccount bankName(String bankName) {
  ...
  public PosBankAccount country(String country) {
  ...
  public PosBankAccount fingerprint(String fingerprint) {
  ...
  public PosBankAccount statementDescription(String statementDescription) {
  ...
  public PosBankAccount transferType(String transferType) {
  ...
  public boolean equals(Object o) {
    ...
    PosBankAccount posBankAccount = (PosBankAccount) o;
    return Objects.equals(this.accountOwnershipType, posBankAccount.accountOwnershipType) &&
        Objects.equals(this.achDetails, posBankAccount.achDetails) &&
        Objects.equals(this.bankName, posBankAccount.bankName) &&
        Objects.equals(this.country, posBankAccount.country) &&
        Objects.equals(this.fingerprint, posBankAccount.fingerprint) &&
        Objects.equals(this.statementDescription, posBankAccount.statementDescription) &&
        Objects.equals(this.transferType, posBankAccount.transferType);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountOwnershipType, achDetails, bankName, country, fingerprint, statementDescription, transferType);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PosBankAccount
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PosBankAccount.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PosBankAccount is not found in the empty JSON string", PosBankAccount.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PosBankAccount.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PosBankAccount` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("ach_details") != null && !jsonObj.get("ach_details").isJsonNull()) {
        PosBankAccountAchDetails.validateJsonElement(jsonObj.get("ach_details"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PosBankAccount.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PosBankAccount' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PosBankAccount> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PosBankAccount.class));

       return (TypeAdapter<T>) new TypeAdapter<PosBankAccount>() {
           @Override
           public void write(JsonWriter out, PosBankAccount value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PosBankAccount read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PosBankAccount given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PosBankAccount
   * @throws IOException if the JSON string is invalid with respect to PosBankAccount
   */
  public static PosBankAccount fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PosBankAccount.class);
  }

  /**
   * Convert an instance of PosBankAccount to an JSON string
   *
   * @return JSON string
   */
