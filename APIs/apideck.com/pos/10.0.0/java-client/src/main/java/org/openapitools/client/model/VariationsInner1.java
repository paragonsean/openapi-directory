...
public class VariationsInner1 {
  ...
  public VariationsInner1 name(String name) {
    this.name = name;
    return this;
  }
  ...
  public VariationsInner1 presentAtAllLocations(Boolean presentAtAllLocations) {
  ...
  public VariationsInner1 priceAmount(BigDecimal priceAmount) {
  ...
  public VariationsInner1 priceCurrency(Currency priceCurrency) {
  ...
  public VariationsInner1 pricingType(PricingTypeEnum pricingType) {
  ...
  public VariationsInner1 sequence(BigDecimal sequence) {
  ...
  public VariationsInner1 sku(String sku) {
    this.sku = sku;
    return this;
  }
  ...
  public VariationsInner1 stockable(Boolean stockable) {
  ...
  public boolean equals(Object o) {
    ...
    VariationsInner1 variationsInner1 = (VariationsInner1) o;
    return Objects.equals(this.createdAt, variationsInner1.createdAt) &&
        Objects.equals(this.id, variationsInner1.id) &&
        Objects.equals(this.itemId, variationsInner1.itemId) &&
        Objects.equals(this.name, variationsInner1.name) &&
        Objects.equals(this.presentAtAllLocations, variationsInner1.presentAtAllLocations) &&
        Objects.equals(this.priceAmount, variationsInner1.priceAmount) &&
        Objects.equals(this.priceCurrency, variationsInner1.priceCurrency) &&
        Objects.equals(this.pricingType, variationsInner1.pricingType) &&
        Objects.equals(this.sequence, variationsInner1.sequence) &&
        Objects.equals(this.sku, variationsInner1.sku) &&
        Objects.equals(this.stockable, variationsInner1.stockable) &&
        Objects.equals(this.updatedAt, variationsInner1.updatedAt) &&
        Objects.equals(this.version, variationsInner1.version);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(createdAt, id, itemId, name, presentAtAllLocations, priceAmount, priceCurrency, pricingType, sequence, sku, stockable, updatedAt, version);
  }
  ...
  public String toString() {
    ...
    sb.append("class VariationsInner1 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to VariationsInner1
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VariationsInner1.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VariationsInner1 is not found in the empty JSON string", VariationsInner1.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VariationsInner1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VariationsInner1` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VariationsInner1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VariationsInner1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VariationsInner1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VariationsInner1.class));

       return (TypeAdapter<T>) new TypeAdapter<VariationsInner1>() {
           @Override
           public void write(JsonWriter out, VariationsInner1 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public VariationsInner1 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of VariationsInner1 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of VariationsInner1
   * @throws IOException if the JSON string is invalid with respect to VariationsInner1
   */
  public static VariationsInner1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VariationsInner1.class);
  }

  /**
   * Convert an instance of VariationsInner1 to an JSON string
   *
   * @return JSON string
   */
