...
import org.openapitools.client.model.ModifierGroupModifiersInner;
...
public class ModifierGroup {
  public static final String SERIALIZED_NAME_ALTERNATE_NAME = "alternate_name";
  ...
  public static final String SERIALIZED_NAME_MAXIMUM_ALLOWED = "maximum_allowed";
  @SerializedName(SERIALIZED_NAME_MAXIMUM_ALLOWED)
  private Integer maximumAllowed;

  public static final String SERIALIZED_NAME_MINIMUM_REQUIRED = "minimum_required";
  @SerializedName(SERIALIZED_NAME_MINIMUM_REQUIRED)
  ...
  private List<ModifierGroupModifiersInner> modifiers = new ArrayList<>();
  ...
  public ModifierGroup alternateName(String alternateName) {
  ...
  public ModifierGroup customMappings(Object customMappings) {
  ...
  public ModifierGroup deleted(Boolean deleted) {
  ...
  public ModifierGroup maximumAllowed(Integer maximumAllowed) {
  ...
  public ModifierGroup minimumRequired(Integer minimumRequired) {
  ...
  public ModifierGroup modifiers(List<ModifierGroupModifiersInner> modifiers) {
    this.modifiers = modifiers;
    return this;
  }

  public ModifierGroup addModifiersItem(ModifierGroupModifiersInner modifiersItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<ModifierGroupModifiersInner> getModifiers() {
    return modifiers;
  }

  public void setModifiers(List<ModifierGroupModifiersInner> modifiers) {
    this.modifiers = modifiers;
  }
  ...
  public ModifierGroup presentAtAllLocations(Boolean presentAtAllLocations) {
  ...
  public ModifierGroup rowVersion(String rowVersion) {
  ...
  public ModifierGroup selectionType(SelectionTypeEnum selectionType) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.alternateName, modifierGroup.alternateName) &&
        Objects.equals(this.createdAt, modifierGroup.createdAt) &&
        Objects.equals(this.createdBy, modifierGroup.createdBy) &&
        Objects.equals(this.customMappings, modifierGroup.customMappings) &&
        Objects.equals(this.deleted, modifierGroup.deleted) &&
        Objects.equals(this.id, modifierGroup.id) &&
        Objects.equals(this.maximumAllowed, modifierGroup.maximumAllowed) &&
        Objects.equals(this.minimumRequired, modifierGroup.minimumRequired) &&
        Objects.equals(this.modifiers, modifierGroup.modifiers) &&
        Objects.equals(this.name, modifierGroup.name) &&
        Objects.equals(this.presentAtAllLocations, modifierGroup.presentAtAllLocations) &&
        Objects.equals(this.rowVersion, modifierGroup.rowVersion) &&
        Objects.equals(this.selectionType, modifierGroup.selectionType) &&
        Objects.equals(this.updatedAt, modifierGroup.updatedAt) &&
        Objects.equals(this.updatedBy, modifierGroup.updatedBy);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(alternateName, createdAt, createdBy, customMappings, deleted, id, maximumAllowed, minimumRequired, modifiers, name, presentAtAllLocations, rowVersion, selectionType, updatedAt, updatedBy);
  }
  ...
  static {
    ...
    openapiFields.add("alternate_name");
    openapiFields.add("created_at");
    openapiFields.add("created_by");
    openapiFields.add("custom_mappings");
    openapiFields.add("deleted");
    openapiFields.add("id");
    openapiFields.add("maximum_allowed");
    openapiFields.add("minimum_required");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ModifierGroup.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ModifierGroup` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("alternate_name") != null && !jsonObj.get("alternate_name").isJsonNull()) && !jsonObj.get("alternate_name").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `alternate_name` to be a primitive type in the JSON string but got `%s`", jsonObj.get("alternate_name").toString()));
      }
      ...
      if (jsonObj.get("modifiers") != null && !jsonObj.get("modifiers").isJsonNull()) {
        ...
        if (jsonArraymodifiers != null) {
          ...
          for (int i = 0; i < jsonArraymodifiers.size(); i++) {
            ModifierGroupModifiersInner.validateJsonElement(jsonArraymodifiers.get(i));
          };
        }
      }
      ...
      // validate the optional field `selection_type`
      if (jsonObj.get("selection_type") != null && !jsonObj.get("selection_type").isJsonNull()) {
        SelectionTypeEnum.validateJsonElement(jsonObj.get("selection_type"));
      }
