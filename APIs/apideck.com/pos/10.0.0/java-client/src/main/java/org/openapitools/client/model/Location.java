...
public class Location {
  ...
  public Location currency(Currency currency) {
  ...
  public Location customMappings(Object customMappings) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.address, location.address) &&
        ...
        Objects.equals(this.customMappings, location.customMappings) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(address, businessName, createdAt, createdBy, currency, customMappings, id, merchantId, name, status, updatedAt, updatedBy);
  }
