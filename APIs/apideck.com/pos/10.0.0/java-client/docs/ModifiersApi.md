...
<a id="modifiersAdd"></a>
# **modifiersAdd**
> CreateModifierResponse modifiersAdd(xApideckConsumerId, xApideckAppId, modifier, raw, xApideckServiceId)
...
import org.openapitools.client.api.ModifiersApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    ModifiersApi apiInstance = new ModifiersApi(defaultClient);
    ...
    Modifier modifier = new Modifier(); // Modifier | 
    ...
    try {
      CreateModifierResponse result = apiInstance.modifiersAdd(xApideckConsumerId, xApideckAppId, modifier, raw, xApideckServiceId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ModifiersApi#modifiersAdd");
...
<a id="modifiersAll"></a>
# **modifiersAll**
> GetModifiersResponse modifiersAll(xApideckConsumerId, xApideckAppId, raw, xApideckServiceId, cursor, limit, fields)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      GetModifiersResponse result = apiInstance.modifiersAll(xApideckConsumerId, xApideckAppId, raw, xApideckServiceId, cursor, limit, fields);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ModifiersApi#modifiersAll");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="modifiersDelete"></a>
# **modifiersDelete**
> DeleteModifierResponse modifiersDelete(id, xApideckConsumerId, xApideckAppId, xApideckServiceId, raw, filter)
...
public class Example {
  public static void main(String[] args) {
    ...
    String xApideckServiceId = "xApideckServiceId_example"; // String | Provide the service id you want to call (e.g., pipedrive). Only needed when a consumer has activated multiple integrations for a Unified API.
    Boolean raw = false; // Boolean | Include raw response. Mostly used for debugging purposes
    ModifierGroupFilter filter = new ModifierGroupFilter(); // ModifierGroupFilter | Apply filters
    try {
      DeleteModifierResponse result = apiInstance.modifiersDelete(id, xApideckConsumerId, xApideckAppId, xApideckServiceId, raw, filter);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ModifiersApi#modifiersDelete");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="modifiersOne"></a>
# **modifiersOne**
> GetModifierResponse modifiersOne(id, xApideckConsumerId, xApideckAppId, xApideckServiceId, raw, filter, fields)
...
public class Example {
  public static void main(String[] args) {
    ...
    String fields = "id,updated_at"; // String | The 'fields' parameter allows API users to specify the fields they want to include in the API response. If this parameter is not present, the API will return all available fields. If this parameter is present, only the fields specified in the comma-separated string will be included in the response. Nested properties can also be requested by using a dot notation. <br /><br />Example: `fields=name,email,addresses.city`<br /><br />In the example above, the response will only include the fields \"name\", \"email\" and \"addresses.city\". If any other fields are available, they will be excluded.
    try {
      GetModifierResponse result = apiInstance.modifiersOne(id, xApideckConsumerId, xApideckAppId, xApideckServiceId, raw, filter, fields);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ModifiersApi#modifiersOne");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="modifiersUpdate"></a>
# **modifiersUpdate**
> UpdateModifierResponse modifiersUpdate(id, xApideckConsumerId, xApideckAppId, modifier, xApideckServiceId, raw)
...
public class Example {
  public static void main(String[] args) {
    ...
    Boolean raw = false; // Boolean | Include raw response. Mostly used for debugging purposes
    try {
      UpdateModifierResponse result = apiInstance.modifiersUpdate(id, xApideckConsumerId, xApideckAppId, modifier, xApideckServiceId, raw);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ModifiersApi#modifiersUpdate");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
