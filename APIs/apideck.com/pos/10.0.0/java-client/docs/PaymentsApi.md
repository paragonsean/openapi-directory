...
<a id="paymentsAdd"></a>
# **paymentsAdd**
> CreatePosPaymentResponse paymentsAdd(xApideckConsumerId, xApideckAppId, posPayment, raw, xApideckServiceId)
...
public class Example {
  public static void main(String[] args) {
    ...
    PosPayment posPayment = new PosPayment(); // PosPayment | 
    ...
    try {
      CreatePosPaymentResponse result = apiInstance.paymentsAdd(xApideckConsumerId, xApideckAppId, posPayment, raw, xApideckServiceId);
...
<a id="paymentsAll"></a>
# **paymentsAll**
> GetPosPaymentsResponse paymentsAll(xApideckConsumerId, xApideckAppId, raw, xApideckServiceId, cursor, limit, fields)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      GetPosPaymentsResponse result = apiInstance.paymentsAll(xApideckConsumerId, xApideckAppId, raw, xApideckServiceId, cursor, limit, fields);
      System.out.println(result);
    } catch (ApiException e) {
...
# **paymentsDelete**
> DeletePosPaymentResponse paymentsDelete(id, xApideckConsumerId, xApideckAppId, xApideckServiceId, raw)
...
public class Example {
  public static void main(String[] args) {
    ...
    Boolean raw = false; // Boolean | Include raw response. Mostly used for debugging purposes
    try {
      DeletePosPaymentResponse result = apiInstance.paymentsDelete(id, xApideckConsumerId, xApideckAppId, xApideckServiceId, raw);
      System.out.println(result);
    } catch (ApiException e) {
...
<a id="paymentsOne"></a>
# **paymentsOne**
> GetPosPaymentResponse paymentsOne(id, xApideckConsumerId, xApideckAppId, xApideckServiceId, raw, fields)
...
public class Example {
  public static void main(String[] args) {
    ...
    String fields = "id,updated_at"; // String | The 'fields' parameter allows API users to specify the fields they want to include in the API response. If this parameter is not present, the API will return all available fields. If this parameter is present, only the fields specified in the comma-separated string will be included in the response. Nested properties can also be requested by using a dot notation. <br /><br />Example: `fields=name,email,addresses.city`<br /><br />In the example above, the response will only include the fields \"name\", \"email\" and \"addresses.city\". If any other fields are available, they will be excluded.
    try {
      GetPosPaymentResponse result = apiInstance.paymentsOne(id, xApideckConsumerId, xApideckAppId, xApideckServiceId, raw, fields);
      System.out.println(result);
    } catch (ApiException e) {
...
# **paymentsUpdate**
> UpdatePosPaymentResponse paymentsUpdate(id, xApideckConsumerId, xApideckAppId, posPayment, xApideckServiceId, raw)
...
public class Example {
  public static void main(String[] args) {
    ...
    Boolean raw = false; // Boolean | Include raw response. Mostly used for debugging purposes
    try {
      UpdatePosPaymentResponse result = apiInstance.paymentsUpdate(id, xApideckConsumerId, xApideckAppId, posPayment, xApideckServiceId, raw);
      System.out.println(result);
    } catch (ApiException e) {
