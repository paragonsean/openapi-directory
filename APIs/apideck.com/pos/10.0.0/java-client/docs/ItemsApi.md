...
|------------- | ------------- | -------------|
| [**itemsAdd**](ItemsApi.md#itemsAdd) | **POST** /pos/items | Create Item |
| [**itemsAll**](ItemsApi.md#itemsAll) | **GET** /pos/items | List Items |
| [**itemsDelete**](ItemsApi.md#itemsDelete) | **DELETE** /pos/items/{id} | Delete Item |
| [**itemsOne**](ItemsApi.md#itemsOne) | **GET** /pos/items/{id} | Get Item |
| [**itemsUpdate**](ItemsApi.md#itemsUpdate) | **PATCH** /pos/items/{id} | Update Item |


<a id="itemsAdd"></a>
# **itemsAdd**
> CreateItemResponse itemsAdd(xApideckConsumerId, xApideckAppId, item, raw, xApideckServiceId)
...
<a id="itemsAll"></a>
# **itemsAll**
> GetItemsResponse itemsAll(xApideckConsumerId, xApideckAppId, raw, xApideckServiceId, cursor, limit, fields)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      GetItemsResponse result = apiInstance.itemsAll(xApideckConsumerId, xApideckAppId, raw, xApideckServiceId, cursor, limit, fields);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ItemsApi#itemsAll");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="itemsDelete"></a>
# **itemsDelete**
> DeleteItemResponse itemsDelete(id, xApideckConsumerId, xApideckAppId, xApideckServiceId, raw)
...
public class Example {
  public static void main(String[] args) {
    ...
    Boolean raw = false; // Boolean | Include raw response. Mostly used for debugging purposes
    try {
      DeleteItemResponse result = apiInstance.itemsDelete(id, xApideckConsumerId, xApideckAppId, xApideckServiceId, raw);
      System.out.println(result);
    } catch (ApiException e) {
...
<a id="itemsOne"></a>
# **itemsOne**
> GetItemResponse itemsOne(id, xApideckConsumerId, xApideckAppId, xApideckServiceId, raw, fields)
...
public class Example {
  public static void main(String[] args) {
    ...
    String fields = "id,updated_at"; // String | The 'fields' parameter allows API users to specify the fields they want to include in the API response. If this parameter is not present, the API will return all available fields. If this parameter is present, only the fields specified in the comma-separated string will be included in the response. Nested properties can also be requested by using a dot notation. <br /><br />Example: `fields=name,email,addresses.city`<br /><br />In the example above, the response will only include the fields \"name\", \"email\" and \"addresses.city\". If any other fields are available, they will be excluded.
    try {
      GetItemResponse result = apiInstance.itemsOne(id, xApideckConsumerId, xApideckAppId, xApideckServiceId, raw, fields);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ItemsApi#itemsOne");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="itemsUpdate"></a>
# **itemsUpdate**
> UpdateItemResponse itemsUpdate(id, xApideckConsumerId, xApideckAppId, item, xApideckServiceId, raw)
...
public class Example {
  public static void main(String[] args) {
    ...
    Boolean raw = false; // Boolean | Include raw response. Mostly used for debugging purposes
    try {
      UpdateItemResponse result = apiInstance.itemsUpdate(id, xApideckConsumerId, xApideckAppId, item, xApideckServiceId, raw);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ItemsApi#itemsUpdate");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
