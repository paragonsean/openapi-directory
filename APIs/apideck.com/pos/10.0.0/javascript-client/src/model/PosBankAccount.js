...
/**
 * The PosBankAccount model module.
 * @module model/PosBankAccount
 * @version 10.0.0
 */
class PosBankAccount {
    /**
     * Constructs a new <code>PosBankAccount</code>.
     * Card details for this payment. This field is currently not available. Reach out to our team for more info.
     * @alias module:model/PosBankAccount
     */
    constructor() { 
        
        PosBankAccount.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PosBankAccount</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PosBankAccount} obj Optional instance to populate.
     * @return {module:model/PosBankAccount} The populated <code>PosBankAccount</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PosBankAccount();
            ...
            if (data.hasOwnProperty('ach_details')) {
                obj['ach_details'] = PosBankAccountAchDetails.constructFromObject(data['ach_details']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PosBankAccount</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PosBankAccount</code>.
     */
    static validateJSON(data) {
        ...
        if (data['ach_details']) { // data not null
          PosBankAccountAchDetails.validateJSON(data['ach_details']);
        }
        // ensure the json data is a string
 ...
 */
PosBankAccount.prototype['account_ownership_type'] = undefined;

/**
 * @member {module:model/PosBankAccountAchDetails} ach_details
 */
PosBankAccount.prototype['ach_details'] = undefined;

/**
 * The name of the bank associated with the bank account.
 * @member {String} bank_name
 */
PosBankAccount.prototype['bank_name'] = undefined;

/**
 * Country code according to ISO 3166-1 alpha-2.
 * @member {String} country
 */
PosBankAccount.prototype['country'] = undefined;
 ...
 */
PosBankAccount.prototype['fingerprint'] = undefined;

/**
 * The statement description as sent to the bank.
 * @member {String} statement_description
 */
PosBankAccount.prototype['statement_description'] = undefined;

/**
 * The type of the bank transfer. The type can be `ACH` or `UNKNOWN`.
 * @member {String} transfer_type
 */
PosBankAccount.prototype['transfer_type'] = undefined;
