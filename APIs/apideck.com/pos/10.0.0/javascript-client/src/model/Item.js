...
import CategoriesInner from './CategoriesInner';
import Currency from './Currency';
import ItemOptionsInner from './ItemOptionsInner';
import VariationsInner from './VariationsInner';
import VariationsInner1 from './VariationsInner1';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('categories')) {
                obj['categories'] = ApiClient.convertToType(data['categories'], [CategoriesInner]);
            }
            ...
            if (data.hasOwnProperty('is_revenue')) {
                obj['is_revenue'] = ApiClient.convertToType(data['is_revenue'], 'Boolean');
            }
            if (data.hasOwnProperty('modifier_groups')) {
                obj['modifier_groups'] = ApiClient.convertToType(data['modifier_groups'], [VariationsInner]);
            }
            if (data.hasOwnProperty('name')) {
                obj['name'] = ApiClient.convertToType(data['name'], 'String');
            }
            if (data.hasOwnProperty('options')) {
                obj['options'] = ApiClient.convertToType(data['options'], [ItemOptionsInner]);
            }
            ...
            if (data.hasOwnProperty('price_currency')) {
                obj['price_currency'] = Currency.constructFromObject(data['price_currency']);
            }
            ...
            if (data.hasOwnProperty('use_default_tax_rates')) {
                obj['use_default_tax_rates'] = ApiClient.convertToType(data['use_default_tax_rates'], 'Boolean');
            }
            if (data.hasOwnProperty('variations')) {
                obj['variations'] = ApiClient.convertToType(data['variations'], [VariationsInner1]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['categories']) { // data not null
            ...
            for (const item of data['categories']) {
                CategoriesInner.validateJSON(item);
            };
        }
        // ensure the json data is a string
        ...
        if (data['modifier_groups']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['modifier_groups'])) {
                throw new Error("Expected the field `modifier_groups` to be an array in the JSON data but got " + data['modifier_groups']);
            }
            // validate the optional field `modifier_groups` (array)
            for (const item of data['modifier_groups']) {
                VariationsInner.validateJSON(item);
            };
        }
        // ensure the json data is a string
        ...
        if (data['options']) { // data not null
            ...
            for (const item of data['options']) {
                ItemOptionsInner.validateJSON(item);
            };
        }
        // ensure the json data is a string
        ...
        if (data['variations']) { // data not null
            ...
            for (const item of data['variations']) {
                VariationsInner1.validateJSON(item);
            };
        }
        // ensure the json data is a string
...
Item.RequiredProperties = ["name"];

/**
 * @member {String} abbreviation
 */
Item.prototype['abbreviation'] = undefined;
 ...
 */
Item.prototype['absent_at_location_ids'] = undefined;

/**
 * @member {Boolean} available
 */
Item.prototype['available'] = undefined;

/**
 * @member {Boolean} available_for_pickup
 */
Item.prototype['available_for_pickup'] = undefined;

/**
 * @member {Boolean} available_online
 */
Item.prototype['available_online'] = undefined;

/**
 * @member {Array.<module:model/CategoriesInner>} categories
 */
 ...
 * @member {Number} cost
 */
Item.prototype['cost'] = undefined;

/**
 * The date and time when the object was created.
 * @member {Date} created_at
 */
Item.prototype['created_at'] = undefined;

/**
 * The user who created the object.
 * @member {String} created_by
 */
Item.prototype['created_by'] = undefined;

/**
 * When custom mappings are configured on the resource, the result is included here.
 * @member {Object} custom_mappings
 */
Item.prototype['custom_mappings'] = undefined;

/**
 * Flag to indicate if the object is deleted.
 * @member {Boolean} deleted
 */
Item.prototype['deleted'] = undefined;
 ...
 */
Item.prototype['hidden'] = undefined;
 ...
 */
Item.prototype['idempotency_key'] = undefined;

/**
 * True if this item should be counted as revenue. For example, gift cards and donations would not be counted as revenue.
 * @member {Boolean} is_revenue
 */
Item.prototype['is_revenue'] = undefined;

/**
 * @member {Array.<module:model/VariationsInner>} modifier_groups
 */
Item.prototype['modifier_groups'] = undefined;
 ...
 * @member {Array.<module:model/ItemOptionsInner>} options
 */
 ...
 */
Item.prototype['present_at_all_locations'] = undefined;

/**
 * @member {Number} price_amount
 */
Item.prototype['price_amount'] = undefined;

/**
 * @member {module:model/Currency} price_currency
 */
Item.prototype['price_currency'] = undefined;

/**
 * @member {module:model/Item.PricingTypeEnum} pricing_type
 */
Item.prototype['pricing_type'] = undefined;

/**
 * @member {module:model/Item.ProductTypeEnum} product_type
 */
Item.prototype['product_type'] = undefined;
 ...
 */
Item.prototype['tax_ids'] = undefined;

/**
 * The date and time when the object was last updated.
 * @member {Date} updated_at
 */
Item.prototype['updated_at'] = undefined;

/**
 * The user who last updated the object.
 * @member {String} updated_by
 */
Item.prototype['updated_by'] = undefined;

/**
 * @member {Boolean} use_default_tax_rates
 */
Item.prototype['use_default_tax_rates'] = undefined;

/**
 * @member {Array.<module:model/VariationsInner1>} variations
 */
