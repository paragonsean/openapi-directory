...
class Modifier {
     ...
     * @param modifierGroupId {String} 
     * @param name {String} 
     */
    constructor(modifierGroupId, name) { 
        
        Modifier.initialize(this, modifierGroupId, name);
    }
     ...
     */
    static initialize(obj, modifierGroupId, name) { 
        obj['modifier_group_id'] = modifierGroupId;
        obj['name'] = name;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('modifier_group_id')) {
                obj['modifier_group_id'] = ApiClient.convertToType(data['modifier_group_id'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>Modifier</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Modifier</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Modifier.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // ensure the json data is a string
        if (data['alternate_name'] && !(typeof data['alternate_name'] === 'string' || data['alternate_name'] instanceof String)) {
            throw new Error("Expected the field `alternate_name` to be a primitive type in the JSON string but got " + data['alternate_name']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['modifier_group_id'] && !(typeof data['modifier_group_id'] === 'string' || data['modifier_group_id'] instanceof String)) {
            throw new Error("Expected the field `modifier_group_id` to be a primitive type in the JSON string but got " + data['modifier_group_id']);
        }
        // ensure the json data is a string
...
Modifier.RequiredProperties = ["modifier_group_id", "name"];

/**
 * @member {String} alternate_name
 */
Modifier.prototype['alternate_name'] = undefined;

/**
 * @member {Boolean} available
 */
Modifier.prototype['available'] = undefined;

/**
 * The date and time when the object was created.
 * @member {Date} created_at
 */
Modifier.prototype['created_at'] = undefined;

/**
 * The user who created the object.
 * @member {String} created_by
 */
Modifier.prototype['created_by'] = undefined;

/**
 * @member {module:model/Currency} currency
 */
Modifier.prototype['currency'] = undefined;

/**
 * When custom mappings are configured on the resource, the result is included here.
 * @member {Object} custom_mappings
 */
Modifier.prototype['custom_mappings'] = undefined;

/**
 * A unique identifier for an object.
 * @member {String} id
 */
Modifier.prototype['id'] = undefined;

/**
 * A value you specify that uniquely identifies this request among requests you have sent.
 * @member {String} idempotency_key
 */
Modifier.prototype['idempotency_key'] = undefined;

/**
 * @member {String} modifier_group_id
 */
Modifier.prototype['modifier_group_id'] = undefined;

/**
 * @member {String} name
 */
Modifier.prototype['name'] = undefined;

/**
 * @member {Number} price_amount
 */
Modifier.prototype['price_amount'] = undefined;

/**
 * The date and time when the object was last updated.
 * @member {Date} updated_at
 */
Modifier.prototype['updated_at'] = undefined;

/**
 * The user who last updated the object.
 * @member {String} updated_by
 */
Modifier.prototype['updated_by'] = undefined;
