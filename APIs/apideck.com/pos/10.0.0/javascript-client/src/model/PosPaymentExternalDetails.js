...
class PosPaymentExternalDetails {
    ...
    /**
     * Constructs a <code>PosPaymentExternalDetails</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PosPaymentExternalDetails} obj Optional instance to populate.
     * @return {module:model/PosPaymentExternalDetails} The populated <code>PosPaymentExternalDetails</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PosPaymentExternalDetails();

            if (data.hasOwnProperty('source')) {
                obj['source'] = ApiClient.convertToType(data['source'], 'String');
            }
            if (data.hasOwnProperty('source_fee_amount')) {
                obj['source_fee_amount'] = ApiClient.convertToType(data['source_fee_amount'], 'Number');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PosPaymentExternalDetails</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PosPaymentExternalDetails</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PosPaymentExternalDetails.RequiredProperties) {
...
PosPaymentExternalDetails.RequiredProperties = ["source", "type"];

/**
 * A description of the external payment source. For example,  \"Food Delivery Service\".
 * @member {String} source
 */
PosPaymentExternalDetails.prototype['source'] = undefined;

/**
 * The fees paid to the source. The amount minus this field is the net amount seller receives.
 * @member {Number} source_fee_amount
 */
PosPaymentExternalDetails.prototype['source_fee_amount'] = undefined;

/**
 * An ID to associate the payment to its originating source.
 * @member {String} source_id
 */
PosPaymentExternalDetails.prototype['source_id'] = undefined;

/**
 * The type of external payment the seller received. It can be one of the following: - CHECK - Paid using a physical check. - BANK_TRANSFER - Paid using external bank transfer. - OTHER\\_GIFT\\_CARD - Paid using a non-Square gift card. - CRYPTO - Paid using a crypto currency. - SQUARE_CASH - Paid using Square Cash App. - SOCIAL - Paid using peer-to-peer payment applications. - EXTERNAL - A third-party application gathered this payment outside of Square. - EMONEY - Paid using an E-money provider. - CARD - A credit or debit card that Square does not support. - STORED_BALANCE - Use for house accounts, store credit, and so forth. - FOOD_VOUCHER - Restaurant voucher provided by employers to employees to pay for meals - OTHER - A type not listed here.
 * @member {module:model/PosPaymentExternalDetails.TypeEnum} type
 */
PosPaymentExternalDetails.prototype['type'] = undefined;
 ...
 * @readonly
 */
PosPaymentExternalDetails['TypeEnum'] = {
...
export default PosPaymentExternalDetails;
