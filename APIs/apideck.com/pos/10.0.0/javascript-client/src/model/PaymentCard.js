...
class PaymentCard {
    ...
    /**
     * Validates the JSON data with respect to <code>PaymentCard</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PaymentCard</code>.
     */
 ...
 */
PaymentCard.prototype['billing_address'] = undefined;

/**
 * The first six digits of the card number, known as the Bank Identification Number (BIN).
 * @member {String} bin
 */
PaymentCard.prototype['bin'] = undefined;

/**
 * The first six digits of the card number, known as the Bank Identification Number (BIN).
 * @member {module:model/PaymentCard.CardBrandEnum} card_brand
 */
PaymentCard.prototype['card_brand'] = undefined;

/**
 * @member {module:model/PaymentCard.CardTypeEnum} card_type
 */
PaymentCard.prototype['card_type'] = undefined;

/**
 * @member {String} cardholder_name
 */
PaymentCard.prototype['cardholder_name'] = undefined;

/**
 * @member {String} customer_id
 */
PaymentCard.prototype['customer_id'] = undefined;

/**
 * Indicates whether or not a card can be used for payments.
 * @member {Boolean} enabled
 */
PaymentCard.prototype['enabled'] = undefined;

/**
 * The expiration month of the associated card as an integer between 1 and 12.
 * @member {Number} exp_month
 */
PaymentCard.prototype['exp_month'] = undefined;

/**
 * The four-digit year of the card's expiration date.
 * @member {Number} exp_year
 */
PaymentCard.prototype['exp_year'] = undefined;

/**
 * @member {String} fingerprint
 */
PaymentCard.prototype['fingerprint'] = undefined;

/**
 * A unique identifier for an object.
 * @member {String} id
 */
PaymentCard.prototype['id'] = undefined;

/**
 * @member {String} last_4
 */
PaymentCard.prototype['last_4'] = undefined;

/**
 * @member {String} merchant_id
 */
PaymentCard.prototype['merchant_id'] = undefined;

/**
 * @member {module:model/PaymentCard.PrepaidTypeEnum} prepaid_type
 */
PaymentCard.prototype['prepaid_type'] = undefined;
 ...
 */
PaymentCard.prototype['reference_id'] = undefined;

/**
 * @member {String} version
 */
PaymentCard.prototype['version'] = undefined;
...
PaymentCard['CardBrandEnum'] = {
    ...
    /**
     * value: "square-gift-card"
     * @const
     */
    "square-gift-card": "square-gift-card",

    /**
     * value: "square-capital-card"
     * @const
     */
...
/**
 * Allowed values for the <code>prepaid_type</code> property.
 * @enum {String}
 * @readonly
 */
PaymentCard['PrepaidTypeEnum'] = {
