...
class CustomField {
     ...
     * @param id {String} Unique identifier for the custom field.
     */
    constructor(id) { 
        
        CustomField.initialize(this, id);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('value')) {
                obj['value'] = CustomFieldValue.constructFromObject(data['value']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['value']) { // data not null
          CustomFieldValue.validateJSON(data['value']);
        }
...
CustomField.RequiredProperties = ["id"];
...
/**
 * @member {module:model/CustomFieldValue} value
 */
