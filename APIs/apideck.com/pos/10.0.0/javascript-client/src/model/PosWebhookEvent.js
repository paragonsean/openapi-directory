...
/**
 * The PosWebhookEvent model module.
 * @module model/PosWebhookEvent
 * @version 10.0.0
 */
class PosWebhookEvent {
    /**
     * Constructs a new <code>PosWebhookEvent</code>.
     * @alias module:model/PosWebhookEvent
     */
    constructor() { 
        
        PosWebhookEvent.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PosWebhookEvent</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PosWebhookEvent} obj Optional instance to populate.
     * @return {module:model/PosWebhookEvent} The populated <code>PosWebhookEvent</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PosWebhookEvent();
    ...
    /**
     * Validates the JSON data with respect to <code>PosWebhookEvent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PosWebhookEvent</code>.
     */
 ...
 */
PosWebhookEvent.prototype['consumer_id'] = undefined;

/**
 * The service provider's ID of the entity that triggered this event
 * @member {String} entity_id
 */
PosWebhookEvent.prototype['entity_id'] = undefined;

/**
 * The type entity that triggered this event
 * @member {String} entity_type
 */
PosWebhookEvent.prototype['entity_type'] = undefined;

/**
 * The url to retrieve entity detail.
 * @member {String} entity_url
 */
PosWebhookEvent.prototype['entity_url'] = undefined;

/**
 * Unique reference to this request event
 * @member {String} event_id
 */
PosWebhookEvent.prototype['event_id'] = undefined;

/**
 * The current count this request event has been attempted
 * @member {Number} execution_attempt
 */
PosWebhookEvent.prototype['execution_attempt'] = undefined;

/**
 * ISO Datetime for when the original event occurred
 * @member {String} occurred_at
 */
PosWebhookEvent.prototype['occurred_at'] = undefined;

/**
 * Service provider identifier
 * @member {String} service_id
 */
PosWebhookEvent.prototype['service_id'] = undefined;

/**
 * Name of Apideck Unified API
 * @member {module:model/PosWebhookEvent.UnifiedApiEnum} unified_api
 */
PosWebhookEvent.prototype['unified_api'] = undefined;

/**
 * @member {module:model/PosWebhookEvent.EventTypeEnum} event_type
 */
PosWebhookEvent.prototype['event_type'] = undefined;
 ...
 * @readonly
 */
PosWebhookEvent['UnifiedApiEnum'] = {
 ...
 * @readonly
 */
PosWebhookEvent['EventTypeEnum'] = {

    /**
     * value: "pos.order.created"
     * @const
     */
    "order.created": "pos.order.created",

    /**
     * value: "pos.order.updated"
     * @const
     */
    "order.updated": "pos.order.updated",

    /**
     * value: "pos.order.deleted"
     * @const
     */
    "order.deleted": "pos.order.deleted",

    /**
     * value: "pos.payment.created"
     * @const
     */
    "payment.created": "pos.payment.created",

    /**
     * value: "pos.payment.updated"
     * @const
     */
    "payment.updated": "pos.payment.updated",

    /**
     * value: "pos.payment.deleted"
     * @const
     */
    "payment.deleted": "pos.payment.deleted",

    /**
     * value: "pos.merchant.created"
     * @const
     */
    "merchant.created": "pos.merchant.created",

    /**
     * value: "pos.merchant.updated"
     * @const
     */
    "merchant.updated": "pos.merchant.updated",

    /**
     * value: "pos.merchant.deleted"
     * @const
     */
    "merchant.deleted": "pos.merchant.deleted",

    /**
     * value: "pos.location.created"
     * @const
     */
    "location.created": "pos.location.created",

    /**
     * value: "pos.location.updated"
     * @const
     */
    "location.updated": "pos.location.updated",

    /**
     * value: "pos.location.deleted"
     * @const
     */
    "location.deleted": "pos.location.deleted",

    /**
     * value: "pos.item.created"
     * @const
     */
    "item.created": "pos.item.created",

    /**
     * value: "pos.item.updated"
     * @const
     */
    "item.updated": "pos.item.updated",

    /**
     * value: "pos.item.deleted"
     * @const
     */
    "item.deleted": "pos.item.deleted",

    /**
     * value: "pos.modifier.created"
     * @const
     */
    "modifier.created": "pos.modifier.created",

    /**
     * value: "pos.modifier.updated"
     * @const
     */
    "modifier.updated": "pos.modifier.updated",

    /**
     * value: "pos.modifier.deleted"
     * @const
     */
    "modifier.deleted": "pos.modifier.deleted",

    /**
     * value: "pos.modifier-group.created"
     * @const
     */
    "modifier-group.created": "pos.modifier-group.created",

    /**
     * value: "pos.modifier-group.updated"
     * @const
     */
    "modifier-group.updated": "pos.modifier-group.updated",

    /**
     * value: "pos.modifier-group.deleted"
     * @const
     */
    "modifier-group.deleted": "pos.modifier-group.deleted"
};



export default PosWebhookEvent;
