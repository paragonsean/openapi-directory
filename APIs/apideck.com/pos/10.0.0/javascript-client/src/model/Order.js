...
import OrderCustomersInner from './OrderCustomersInner';
import OrderDiscountsInner from './OrderDiscountsInner';
import OrderFulfillmentsInner from './OrderFulfillmentsInner';
import OrderLineItemsInner from './OrderLineItemsInner';
import OrderPaymentsInner from './OrderPaymentsInner';
import OrderRefundsInner from './OrderRefundsInner';
import OrderTaxesInner from './OrderTaxesInner';
import OrderTendersInner from './OrderTendersInner';
...
class Order {
     ...
     */
    constructor(locationId, merchantId) { 
        
        Order.initialize(this, locationId, merchantId);
    }
     ...
     */
    static initialize(obj, locationId, merchantId) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('customers')) {
                obj['customers'] = ApiClient.convertToType(data['customers'], [OrderCustomersInner]);
            }
            if (data.hasOwnProperty('discounts')) {
                obj['discounts'] = ApiClient.convertToType(data['discounts'], [OrderDiscountsInner]);
            }
            ...
            if (data.hasOwnProperty('fulfillments')) {
                obj['fulfillments'] = ApiClient.convertToType(data['fulfillments'], [OrderFulfillmentsInner]);
            }
            ...
            if (data.hasOwnProperty('line_items')) {
                obj['line_items'] = ApiClient.convertToType(data['line_items'], [OrderLineItemsInner]);
            }
            ...
            if (data.hasOwnProperty('order_type_id')) {
                obj['order_type_id'] = ApiClient.convertToType(data['order_type_id'], 'String');
            }
            if (data.hasOwnProperty('payment_status')) {
                obj['payment_status'] = ApiClient.convertToType(data['payment_status'], 'String');
            }
            if (data.hasOwnProperty('payments')) {
                obj['payments'] = ApiClient.convertToType(data['payments'], [OrderPaymentsInner]);
            }
            ...
            if (data.hasOwnProperty('refunds')) {
                obj['refunds'] = ApiClient.convertToType(data['refunds'], [OrderRefundsInner]);
            }
            ...
            if (data.hasOwnProperty('taxes')) {
                obj['taxes'] = ApiClient.convertToType(data['taxes'], [OrderTaxesInner]);
            }
            if (data.hasOwnProperty('tenders')) {
                obj['tenders'] = ApiClient.convertToType(data['tenders'], [OrderTendersInner]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['customers']) { // data not null
            ...
            for (const item of data['customers']) {
                OrderCustomersInner.validateJSON(item);
            };
        }
        if (data['discounts']) { // data not null
            ...
            for (const item of data['discounts']) {
                OrderDiscountsInner.validateJSON(item);
            };
        }
        // ensure the json data is a string
        ...
        if (data['fulfillments']) { // data not null
            ...
            for (const item of data['fulfillments']) {
                OrderFulfillmentsInner.validateJSON(item);
            };
        }
        // ensure the json data is a string
        ...
        if (data['line_items']) { // data not null
            ...
            for (const item of data['line_items']) {
                OrderLineItemsInner.validateJSON(item);
            };
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['order_type_id'] && !(typeof data['order_type_id'] === 'string' || data['order_type_id'] instanceof String)) {
            throw new Error("Expected the field `order_type_id` to be a primitive type in the JSON string but got " + data['order_type_id']);
        }
        // ensure the json data is a string
        ...
        if (data['payments']) { // data not null
            ...
            for (const item of data['payments']) {
                OrderPaymentsInner.validateJSON(item);
            };
        }
        // ensure the json data is a string
        ...
        if (data['refunds']) { // data not null
            ...
            for (const item of data['refunds']) {
                OrderRefundsInner.validateJSON(item);
            };
        }
        // ensure the json data is a string
        ...
        if (data['taxes']) { // data not null
            ...
            for (const item of data['taxes']) {
                OrderTaxesInner.validateJSON(item);
            };
        }
        if (data['tenders']) { // data not null
            ...
            for (const item of data['tenders']) {
                OrderTendersInner.validateJSON(item);
            };
        }
        // ensure the json data is a string
...
Order.RequiredProperties = ["location_id", "merchant_id"];

/**
 * @member {Date} closed_date
 */
Order.prototype['closed_date'] = undefined;
 ...
 */
Order.prototype['created_by'] = undefined;
 ...
 */
Order.prototype['custom_mappings'] = undefined;
...
/**
 * @member {Array.<module:model/OrderCustomersInner>} customers
 */
Order.prototype['customers'] = undefined;

/**
 * @member {Array.<module:model/OrderDiscountsInner>} discounts
 */
 ...
 */
Order.prototype['employee_id'] = undefined;

/**
 * @member {Array.<module:model/OrderFulfillmentsInner>} fulfillments
 */
 ...
 */
Order.prototype['idempotency_key'] = undefined;

/**
 * @member {Array.<module:model/OrderLineItemsInner>} line_items
 */
...
/**
 * @member {String} order_type_id
 */
Order.prototype['order_type_id'] = undefined;
...
/**
 * @member {Array.<module:model/OrderPaymentsInner>} payments
 */
 ...
 */
Order.prototype['refunded'] = undefined;

/**
 * @member {Array.<module:model/OrderRefundsInner>} refunds
 */
 ...
 * @member {String} seat
 */
Order.prototype['seat'] = undefined;
 ...
 * @member {module:model/Order.SourceEnum} source
 */
 ...
 * @member {String} table
 */
Order.prototype['table'] = undefined;

/**
 * @member {Array.<module:model/OrderTaxesInner>} taxes
 */
Order.prototype['taxes'] = undefined;

/**
 * @member {Array.<module:model/OrderTendersInner>} tenders
 */
 ...
 */
Order.prototype['total_discount'] = undefined;

/**
 * @member {Number} total_refund
 */
Order.prototype['total_refund'] = undefined;

/**
 * @member {Number} total_service_charge
 */
Order.prototype['total_service_charge'] = undefined;
 ...
 */
Order.prototype['total_tip'] = undefined;
 ...
 */
Order.prototype['updated_by'] = undefined;
 ...
 */
Order.prototype['voided'] = undefined;

/**
 * @member {Date} voided_at
 */
Order.prototype['voided_at'] = undefined;
