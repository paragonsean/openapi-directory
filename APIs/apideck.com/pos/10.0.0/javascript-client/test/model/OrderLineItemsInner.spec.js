...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PosApi.OrderLineItemsInner();
  });
  ...
  describe('OrderLineItemsInner', function() {
    it('should create an instance of OrderLineItemsInner', function() {
      // uncomment below and update the code to test OrderLineItemsInner
      //var instance = new PosApi.OrderLineItemsInner();
      //expect(instance).to.be.a(PosApi.OrderLineItemsInner);
    });
