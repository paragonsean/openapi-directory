...
(function(root, factory) {
  ...
  describe('Order', function() {
    it('should create an instance of Order', function() {
      ...
      //var instance = new PosApi.Order();
      //expect(instance).to.be.a(PosApi.Order);
    });
    ...
    it('should have the property orderTypeId (base name: "order_type_id")', function() {
      // uncomment below and update the code to test the property orderTypeId
      //var instance = new PosApi.Order();
      //expect(instance).to.be();
    });
