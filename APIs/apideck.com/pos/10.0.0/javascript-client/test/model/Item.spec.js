...
(function(root, factory) {
  ...
  describe('Item', function() {
    it('should create an instance of Item', function() {
      ...
      //var instance = new PosApi.Item();
      //expect(instance).to.be.a(PosApi.Item);
    });
    ...
    it('should have the property isRevenue (base name: "is_revenue")', function() {
      // uncomment below and update the code to test the property isRevenue
      //var instance = new PosApi.Item();
      //expect(instance).to.be();
    });

    it('should have the property modifierGroups (base name: "modifier_groups")', function() {
      // uncomment below and update the code to test the property modifierGroups
      //var instance = new PosApi.Item();
      //expect(instance).to.be();
    });
    ...
    it('should have the property useDefaultTaxRates (base name: "use_default_tax_rates")', function() {
      // uncomment below and update the code to test the property useDefaultTaxRates
      //var instance = new PosApi.Item();
      //expect(instance).to.be();
    });
