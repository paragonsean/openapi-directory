...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PosApi.ModifierGroup();
  });
  ...
  describe('ModifierGroup', function() {
    it('should create an instance of ModifierGroup', function() {
      // uncomment below and update the code to test ModifierGroup
      //var instance = new PosApi.ModifierGroup();
      //expect(instance).to.be.a(PosApi.ModifierGroup);
    });
    ...
    it('should have the property maximumAllowed (base name: "maximum_allowed")', function() {
      // uncomment below and update the code to test the property maximumAllowed
      //var instance = new PosApi.ModifierGroup();
      //expect(instance).to.be();
    });

    it('should have the property minimumRequired (base name: "minimum_required")', function() {
      // uncomment below and update the code to test the property minimumRequired
      //var instance = new PosApi.ModifierGroup();
      //expect(instance).to.be();
    });
