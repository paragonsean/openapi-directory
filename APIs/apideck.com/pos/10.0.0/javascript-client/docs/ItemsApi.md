...
> CreateItemResponse itemsAdd(xApideckConsumerId, xApideckAppId, item, opts)
...
let apiInstance = new PosApi.ItemsApi();
...
apiInstance.itemsAdd(xApideckConsumerId, xApideckAppId, item, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> GetItemsResponse itemsAll(xApideckConsumerId, xApideckAppId, opts)
...
apiInstance.itemsAll(xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> DeleteItemResponse itemsDelete(id, xApideckConsumerId, xApideckAppId, opts)
...
apiInstance.itemsDelete(id, xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> GetItemResponse itemsOne(id, xApideckConsumerId, xApideckAppId, opts)
...
apiInstance.itemsOne(id, xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> UpdateItemResponse itemsUpdate(id, xApideckConsumerId, xApideckAppId, item, opts)
...
apiInstance.itemsUpdate(id, xApideckConsumerId, xApideckAppId, item, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
