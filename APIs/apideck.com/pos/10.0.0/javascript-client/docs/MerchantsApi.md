...
------------- | ------------- | -------------
[**merchantsAdd**](MerchantsApi.md#merchantsAdd) | **POST** /pos/merchants | Create Merchant
[**merchantsAll**](MerchantsApi.md#merchantsAll) | **GET** /pos/merchants | List Merchants
[**merchantsDelete**](MerchantsApi.md#merchantsDelete) | **DELETE** /pos/merchants/{id} | Delete Merchant
[**merchantsOne**](MerchantsApi.md#merchantsOne) | **GET** /pos/merchants/{id} | Get Merchant
[**merchantsUpdate**](MerchantsApi.md#merchantsUpdate) | **PATCH** /pos/merchants/{id} | Update Merchant



## merchantsAdd

> CreateMerchantResponse merchantsAdd(xApideckConsumerId, xApideckAppId, merchant, opts)
...
let apiInstance = new PosApi.MerchantsApi();
...
let merchant = new PosApi.Merchant(); // Merchant | 
let opts = {
...
apiInstance.merchantsAdd(xApideckConsumerId, xApideckAppId, merchant, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> GetMerchantsResponse merchantsAll(xApideckConsumerId, xApideckAppId, opts)
...
apiInstance.merchantsAll(xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> DeleteMerchantResponse merchantsDelete(id, xApideckConsumerId, xApideckAppId, opts)
...
apiInstance.merchantsDelete(id, xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> GetMerchantResponse merchantsOne(id, xApideckConsumerId, xApideckAppId, opts)
...
apiInstance.merchantsOne(id, xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> UpdateMerchantResponse merchantsUpdate(id, xApideckConsumerId, xApideckAppId, merchant, opts)
...
apiInstance.merchantsUpdate(id, xApideckConsumerId, xApideckAppId, merchant, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
