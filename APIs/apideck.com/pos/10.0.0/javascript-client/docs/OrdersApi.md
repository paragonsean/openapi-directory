...
> CreateOrderResponse ordersAdd(xApideckConsumerId, xApideckAppId, order, opts)
...
let apiInstance = new PosApi.OrdersApi();
...
let order = new PosApi.Order(); // Order | 
let opts = {
...
apiInstance.ordersAdd(xApideckConsumerId, xApideckAppId, order, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> GetOrdersResponse ordersAll(xApideckConsumerId, xApideckAppId, opts)
...
apiInstance.ordersAll(xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> DeleteOrderResponse ordersDelete(id, xApideckConsumerId, xApideckAppId, opts)
...
apiInstance.ordersDelete(id, xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> GetOrderResponse ordersOne(id, xApideckConsumerId, xApideckAppId, opts)
...
apiInstance.ordersOne(id, xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> CreateOrderResponse ordersPay(id, xApideckConsumerId, xApideckAppId, order, opts)
...
apiInstance.ordersPay(id, xApideckConsumerId, xApideckAppId, order, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> UpdateOrderResponse ordersUpdate(id, xApideckConsumerId, xApideckAppId, order, opts)
...
apiInstance.ordersUpdate(id, xApideckConsumerId, xApideckAppId, order, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
