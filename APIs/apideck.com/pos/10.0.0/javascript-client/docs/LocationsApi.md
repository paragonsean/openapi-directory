...
> CreateLocationResponse locationsAdd(xApideckConsumerId, xApideckAppId, location, opts)
...
let apiInstance = new PosApi.LocationsApi();
...
let location = new PosApi.Location(); // Location | 
let opts = {
...
apiInstance.locationsAdd(xApideckConsumerId, xApideckAppId, location, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> GetLocationsResponse locationsAll(xApideckConsumerId, xApideckAppId, opts)
...
apiInstance.locationsAll(xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> DeleteLocationResponse locationsDelete(id, xApideckConsumerId, xApideckAppId, opts)
...
apiInstance.locationsDelete(id, xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> GetLocationResponse locationsOne(id, xApideckConsumerId, xApideckAppId, opts)
...
apiInstance.locationsOne(id, xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> UpdateLocationResponse locationsUpdate(id, xApideckConsumerId, xApideckAppId, location, opts)
...
apiInstance.locationsUpdate(id, xApideckConsumerId, xApideckAppId, location, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
