...
------------- | ------------- | -------------
[**tendersAdd**](TendersApi.md#tendersAdd) | **POST** /pos/tenders | Create Tender
[**tendersAll**](TendersApi.md#tendersAll) | **GET** /pos/tenders | List Tenders
[**tendersDelete**](TendersApi.md#tendersDelete) | **DELETE** /pos/tenders/{id} | Delete Tender
[**tendersOne**](TendersApi.md#tendersOne) | **GET** /pos/tenders/{id} | Get Tender
[**tendersUpdate**](TendersApi.md#tendersUpdate) | **PATCH** /pos/tenders/{id} | Update Tender



## tendersAdd

> CreateTenderResponse tendersAdd(xApideckConsumerId, xApideckAppId, tender, opts)
...
let apiInstance = new PosApi.TendersApi();
...
let tender = new PosApi.Tender(); // Tender | 
let opts = {
...
apiInstance.tendersAdd(xApideckConsumerId, xApideckAppId, tender, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> GetTendersResponse tendersAll(xApideckConsumerId, xApideckAppId, opts)
...
apiInstance.tendersAll(xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> DeleteTenderResponse tendersDelete(id, xApideckConsumerId, xApideckAppId, opts)
...
apiInstance.tendersDelete(id, xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> GetTenderResponse tendersOne(id, xApideckConsumerId, xApideckAppId, opts)
...
apiInstance.tendersOne(id, xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> UpdateTenderResponse tendersUpdate(id, xApideckConsumerId, xApideckAppId, tender, opts)
...
apiInstance.tendersUpdate(id, xApideckConsumerId, xApideckAppId, tender, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
