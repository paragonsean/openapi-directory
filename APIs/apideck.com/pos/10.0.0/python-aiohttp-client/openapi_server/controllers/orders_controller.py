...
async def orders_add(request: web.Request, x_apideck_consumer_id, x_apideck_app_id, body, raw=None, x_apideck_service_id=None) -> web.Response:
    """Create Order
...
async def orders_all(request: web.Request, x_apideck_consumer_id, x_apideck_app_id, raw=None, x_apideck_service_id=None, cursor=None, limit=None, location_id=None, fields=None) -> web.Response:
    """List Orders
...
async def orders_delete(request: web.Request, id, x_apideck_consumer_id, x_apideck_app_id, x_apideck_service_id=None, raw=None) -> web.Response:
    """Delete Order
...
async def orders_pay(request: web.Request, id, x_apideck_consumer_id, x_apideck_app_id, body, raw=None, x_apideck_service_id=None, fields=None) -> web.Response:
    """Pay Order
...
async def orders_update(request: web.Request, id, x_apideck_consumer_id, x_apideck_app_id, body, x_apideck_service_id=None, raw=None) -> web.Response:
    """Update Order
