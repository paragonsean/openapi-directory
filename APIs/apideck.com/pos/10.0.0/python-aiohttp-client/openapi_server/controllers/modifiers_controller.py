...
async def modifiers_add(request: web.Request, x_apideck_consumer_id, x_apideck_app_id, body, raw=None, x_apideck_service_id=None) -> web.Response:
    """Create Modifier
    ...
    """
    body = Modifier.from_dict(body)
    return web.Response(status=200)


async def modifiers_all(request: web.Request, x_apideck_consumer_id, x_apideck_app_id, raw=None, x_apideck_service_id=None, cursor=None, limit=None, fields=None) -> web.Response:
    """List Modifiers
...
async def modifiers_delete(request: web.Request, id, x_apideck_consumer_id, x_apideck_app_id, x_apideck_service_id=None, raw=None, filter=None) -> web.Response:
    """Delete Modifier
...
async def modifiers_one(request: web.Request, id, x_apideck_consumer_id, x_apideck_app_id, x_apideck_service_id=None, raw=None, filter=None, fields=None) -> web.Response:
    """Get Modifier
...
async def modifiers_update(request: web.Request, id, x_apideck_consumer_id, x_apideck_app_id, body, x_apideck_service_id=None, raw=None) -> web.Response:
    """Update Modifier
