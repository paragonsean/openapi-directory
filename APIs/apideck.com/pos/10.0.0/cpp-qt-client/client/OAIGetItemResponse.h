...
/*
 * OAIGetItemResponse.h
 *
 * 
 */

#ifndef OAIGetItemResponse_H
#define OAIGetItemResponse_H
...
class OAIGetItemResponse : public OAIObject {
public:
    OAIGetItemResponse();
    OAIGetItemResponse(QString json);
    ~OAIGetItemResponse() override;
    ...
    OAIItem getData() const;
    void setData(const OAIItem &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetItemResponse)

#endif // OAIGetItemResponse_H
