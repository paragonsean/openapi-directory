...
/*
 * OAIUpdatePosPaymentResponse.h
 *
 * 
 */

#ifndef OAIUpdatePosPaymentResponse_H
#define OAIUpdatePosPaymentResponse_H
...
class OAIUpdatePosPaymentResponse : public OAIObject {
public:
    OAIUpdatePosPaymentResponse();
    OAIUpdatePosPaymentResponse(QString json);
    ~OAIUpdatePosPaymentResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdatePosPaymentResponse)

#endif // OAIUpdatePosPaymentResponse_H
