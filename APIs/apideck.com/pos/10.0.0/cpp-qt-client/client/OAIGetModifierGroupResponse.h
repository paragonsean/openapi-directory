...
/*
 * OAIGetModifierGroupResponse.h
 *
 * 
 */

#ifndef OAIGetModifierGroupResponse_H
#define OAIGetModifierGroupResponse_H
...
class OAIGetModifierGroupResponse : public OAIObject {
public:
    OAIGetModifierGroupResponse();
    OAIGetModifierGroupResponse(QString json);
    ~OAIGetModifierGroupResponse() override;
    ...
    OAIModifierGroup getData() const;
    void setData(const OAIModifierGroup &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetModifierGroupResponse)

#endif // OAIGetModifierGroupResponse_H
