...
/*
 * OAIGetOrderTypesResponse.h
 *
 * 
 */

#ifndef OAIGetOrderTypesResponse_H
#define OAIGetOrderTypesResponse_H
...
class OAIGetOrderTypesResponse : public OAIObject {
public:
    OAIGetOrderTypesResponse();
    OAIGetOrderTypesResponse(QString json);
    ~OAIGetOrderTypesResponse() override;
    ...
    QList<OAIOrderType> getData() const;
    void setData(const QList<OAIOrderType> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetOrderTypesResponse)

#endif // OAIGetOrderTypesResponse_H
