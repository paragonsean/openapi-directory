...
/*
 * OAIUpdateModifierGroupResponse.h
 *
 * 
 */

#ifndef OAIUpdateModifierGroupResponse_H
#define OAIUpdateModifierGroupResponse_H
...
class OAIUpdateModifierGroupResponse : public OAIObject {
public:
    OAIUpdateModifierGroupResponse();
    OAIUpdateModifierGroupResponse(QString json);
    ~OAIUpdateModifierGroupResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateModifierGroupResponse)

#endif // OAIUpdateModifierGroupResponse_H
