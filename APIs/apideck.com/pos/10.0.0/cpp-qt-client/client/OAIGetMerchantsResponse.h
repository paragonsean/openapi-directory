...
/*
 * OAIGetMerchantsResponse.h
 *
 * 
 */

#ifndef OAIGetMerchantsResponse_H
#define OAIGetMerchantsResponse_H
...
class OAIGetMerchantsResponse : public OAIObject {
public:
    OAIGetMerchantsResponse();
    OAIGetMerchantsResponse(QString json);
    ~OAIGetMerchantsResponse() override;
    ...
    QList<OAIMerchant> getData() const;
    void setData(const QList<OAIMerchant> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetMerchantsResponse)

#endif // OAIGetMerchantsResponse_H
