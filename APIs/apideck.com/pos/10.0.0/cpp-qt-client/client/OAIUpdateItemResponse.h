...
/*
 * OAIUpdateItemResponse.h
 *
 * 
 */

#ifndef OAIUpdateItemResponse_H
#define OAIUpdateItemResponse_H
...
class OAIUpdateItemResponse : public OAIObject {
public:
    OAIUpdateItemResponse();
    OAIUpdateItemResponse(QString json);
    ~OAIUpdateItemResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateItemResponse)

#endif // OAIUpdateItemResponse_H
