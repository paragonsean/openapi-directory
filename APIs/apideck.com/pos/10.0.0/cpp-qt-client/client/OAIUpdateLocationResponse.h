...
/*
 * OAIUpdateLocationResponse.h
 *
 * 
 */

#ifndef OAIUpdateLocationResponse_H
#define OAIUpdateLocationResponse_H
...
class OAIUpdateLocationResponse : public OAIObject {
public:
    OAIUpdateLocationResponse();
    OAIUpdateLocationResponse(QString json);
    ~OAIUpdateLocationResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateLocationResponse)

#endif // OAIUpdateLocationResponse_H
