...
/*
 * OAIGetTendersResponse.h
 *
 * 
 */

#ifndef OAIGetTendersResponse_H
#define OAIGetTendersResponse_H
...
class OAIGetTendersResponse : public OAIObject {
public:
    OAIGetTendersResponse();
    OAIGetTendersResponse(QString json);
    ~OAIGetTendersResponse() override;
    ...
    QList<OAITender> getData() const;
    void setData(const QList<OAITender> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetTendersResponse)

#endif // OAIGetTendersResponse_H
