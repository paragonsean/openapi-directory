...
/*
 * OAIDeleteMerchantResponse.h
 *
 * 
 */

#ifndef OAIDeleteMerchantResponse_H
#define OAIDeleteMerchantResponse_H
...
class OAIDeleteMerchantResponse : public OAIObject {
public:
    OAIDeleteMerchantResponse();
    OAIDeleteMerchantResponse(QString json);
    ~OAIDeleteMerchantResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteMerchantResponse)

#endif // OAIDeleteMerchantResponse_H
