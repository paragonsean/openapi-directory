...
public:
    ...
    bool isAllowsTipping() const;
    void setAllowsTipping(const bool &allows_tipping);
    bool is_allows_tipping_Set() const;
    bool is_allows_tipping_Valid() const;
    ...
    bool isOpensCashDrawer() const;
    void setOpensCashDrawer(const bool &opens_cash_drawer);
    bool is_opens_cash_drawer_Set() const;
    bool is_opens_cash_drawer_Valid() const;
...
private:
    ...
    bool m_allows_tipping;
    bool m_allows_tipping_isSet;
    bool m_allows_tipping_isValid;
    ...
    bool m_opens_cash_drawer;
    bool m_opens_cash_drawer_isSet;
    bool m_opens_cash_drawer_isValid;
