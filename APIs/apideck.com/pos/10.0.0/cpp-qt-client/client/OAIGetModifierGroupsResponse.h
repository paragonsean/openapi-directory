...
/*
 * OAIGetModifierGroupsResponse.h
 *
 * 
 */

#ifndef OAIGetModifierGroupsResponse_H
#define OAIGetModifierGroupsResponse_H

#include <QJsonObject>

#include "OAILinks.h"
#include "OAIMeta.h"
#include "OAIModifierGroup.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAIModifierGroup;
class OAILinks;
class OAIMeta;

class OAIGetModifierGroupsResponse : public OAIObject {
public:
    OAIGetModifierGroupsResponse();
    OAIGetModifierGroupsResponse(QString json);
    ~OAIGetModifierGroupsResponse() override;
    ...
    QList<OAIModifierGroup> getData() const;
    void setData(const QList<OAIModifierGroup> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetModifierGroupsResponse)

#endif // OAIGetModifierGroupsResponse_H
