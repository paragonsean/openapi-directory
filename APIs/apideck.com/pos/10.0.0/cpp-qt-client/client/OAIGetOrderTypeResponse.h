...
/*
 * OAIGetOrderTypeResponse.h
 *
 * 
 */

#ifndef OAIGetOrderTypeResponse_H
#define OAIGetOrderTypeResponse_H
...
class OAIGetOrderTypeResponse : public OAIObject {
public:
    OAIGetOrderTypeResponse();
    OAIGetOrderTypeResponse(QString json);
    ~OAIGetOrderTypeResponse() override;
    ...
    OAIOrderType getData() const;
    void setData(const OAIOrderType &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetOrderTypeResponse)

#endif // OAIGetOrderTypeResponse_H
