...
/*
 * OAIDeletePosPaymentResponse.h
 *
 * 
 */

#ifndef OAIDeletePosPaymentResponse_H
#define OAIDeletePosPaymentResponse_H
...
class OAIDeletePosPaymentResponse : public OAIObject {
public:
    OAIDeletePosPaymentResponse();
    OAIDeletePosPaymentResponse(QString json);
    ~OAIDeletePosPaymentResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeletePosPaymentResponse)

#endif // OAIDeletePosPaymentResponse_H
