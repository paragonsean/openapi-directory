...
/*
 * OAICreateOrderTypeResponse.h
 *
 * 
 */

#ifndef OAICreateOrderTypeResponse_H
#define OAICreateOrderTypeResponse_H
...
class OAICreateOrderTypeResponse : public OAIObject {
public:
    OAICreateOrderTypeResponse();
    OAICreateOrderTypeResponse(QString json);
    ~OAICreateOrderTypeResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateOrderTypeResponse)

#endif // OAICreateOrderTypeResponse_H
