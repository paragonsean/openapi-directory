...
#ifndef OAIModifierGroup_H
#define OAIModifierGroup_H
...
namespace OpenAPI {
class OAIModifierGroup_modifiers_inner;

class OAIModifierGroup : public OAIObject {
public:
    OAIModifierGroup();
    OAIModifierGroup(QString json);
    ~OAIModifierGroup() override;
    ...
    qint32 getMaximumAllowed() const;
    void setMaximumAllowed(const qint32 &maximum_allowed);
    bool is_maximum_allowed_Set() const;
    bool is_maximum_allowed_Valid() const;

    qint32 getMinimumRequired() const;
    void setMinimumRequired(const qint32 &minimum_required);
    bool is_minimum_required_Set() const;
    bool is_minimum_required_Valid() const;

    QList<OAIModifierGroup_modifiers_inner> getModifiers() const;
    void setModifiers(const QList<OAIModifierGroup_modifiers_inner> &modifiers);
...
private:
    ...
    qint32 m_maximum_allowed;
    bool m_maximum_allowed_isSet;
    bool m_maximum_allowed_isValid;

    qint32 m_minimum_required;
    bool m_minimum_required_isSet;
    bool m_minimum_required_isValid;

    QList<OAIModifierGroup_modifiers_inner> m_modifiers;
...
Q_DECLARE_METATYPE(OpenAPI::OAIModifierGroup)

#endif // OAIModifierGroup_H
