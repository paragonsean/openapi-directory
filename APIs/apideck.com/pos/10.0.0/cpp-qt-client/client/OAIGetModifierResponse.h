...
/*
 * OAIGetModifierResponse.h
 *
 * 
 */

#ifndef OAIGetModifierResponse_H
#define OAIGetModifierResponse_H
...
class OAIGetModifierResponse : public OAIObject {
public:
    OAIGetModifierResponse();
    OAIGetModifierResponse(QString json);
    ~OAIGetModifierResponse() override;
    ...
    OAIModifier getData() const;
    void setData(const OAIModifier &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetModifierResponse)

#endif // OAIGetModifierResponse_H
