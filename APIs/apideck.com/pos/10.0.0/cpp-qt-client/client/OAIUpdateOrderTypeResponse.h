...
/*
 * OAIUpdateOrderTypeResponse.h
 *
 * 
 */

#ifndef OAIUpdateOrderTypeResponse_H
#define OAIUpdateOrderTypeResponse_H
...
class OAIUpdateOrderTypeResponse : public OAIObject {
public:
    OAIUpdateOrderTypeResponse();
    OAIUpdateOrderTypeResponse(QString json);
    ~OAIUpdateOrderTypeResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateOrderTypeResponse)

#endif // OAIUpdateOrderTypeResponse_H
