...
/*
 * OAIUpdateOrderResponse.h
 *
 * 
 */

#ifndef OAIUpdateOrderResponse_H
#define OAIUpdateOrderResponse_H
...
class OAIUpdateOrderResponse : public OAIObject {
public:
    OAIUpdateOrderResponse();
    OAIUpdateOrderResponse(QString json);
    ~OAIUpdateOrderResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateOrderResponse)

#endif // OAIUpdateOrderResponse_H
