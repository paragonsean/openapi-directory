...
/*
 * OAIDeleteModifierGroupResponse.h
 *
 * 
 */

#ifndef OAIDeleteModifierGroupResponse_H
#define OAIDeleteModifierGroupResponse_H
...
class OAIDeleteModifierGroupResponse : public OAIObject {
public:
    OAIDeleteModifierGroupResponse();
    OAIDeleteModifierGroupResponse(QString json);
    ~OAIDeleteModifierGroupResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteModifierGroupResponse)

#endif // OAIDeleteModifierGroupResponse_H
