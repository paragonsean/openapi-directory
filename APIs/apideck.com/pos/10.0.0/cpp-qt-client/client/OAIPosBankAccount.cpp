...
OAIPosBankAccount::OAIPosBankAccount(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPosBankAccount::OAIPosBankAccount() {
    this->initializeModel();
}

OAIPosBankAccount::~OAIPosBankAccount() {}

void OAIPosBankAccount::initializeModel() {
...
void OAIPosBankAccount::fromJson(QString jsonString) {
...
void OAIPosBankAccount::fromJsonObject(QJsonObject json) {
...
QString OAIPosBankAccount::asJson() const {
...
QJsonObject OAIPosBankAccount::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPosBankAccount::getAccountOwnershipType() const {
    return m_account_ownership_type;
}
void OAIPosBankAccount::setAccountOwnershipType(const QString &account_ownership_type) {
    m_account_ownership_type = account_ownership_type;
    m_account_ownership_type_isSet = true;
}

bool OAIPosBankAccount::is_account_ownership_type_Set() const{
    return m_account_ownership_type_isSet;
}

bool OAIPosBankAccount::is_account_ownership_type_Valid() const{
    return m_account_ownership_type_isValid;
}

OAIPosBankAccount_ach_details OAIPosBankAccount::getAchDetails() const {
    return m_ach_details;
}
void OAIPosBankAccount::setAchDetails(const OAIPosBankAccount_ach_details &ach_details) {
    m_ach_details = ach_details;
    m_ach_details_isSet = true;
}

bool OAIPosBankAccount::is_ach_details_Set() const{
    return m_ach_details_isSet;
}

bool OAIPosBankAccount::is_ach_details_Valid() const{
    return m_ach_details_isValid;
}

QString OAIPosBankAccount::getBankName() const {
    return m_bank_name;
}
void OAIPosBankAccount::setBankName(const QString &bank_name) {
    m_bank_name = bank_name;
    m_bank_name_isSet = true;
}

bool OAIPosBankAccount::is_bank_name_Set() const{
    return m_bank_name_isSet;
}

bool OAIPosBankAccount::is_bank_name_Valid() const{
    return m_bank_name_isValid;
}

QString OAIPosBankAccount::getCountry() const {
    return m_country;
}
void OAIPosBankAccount::setCountry(const QString &country) {
    m_country = country;
    m_country_isSet = true;
}

bool OAIPosBankAccount::is_country_Set() const{
    return m_country_isSet;
}

bool OAIPosBankAccount::is_country_Valid() const{
    return m_country_isValid;
}

QString OAIPosBankAccount::getFingerprint() const {
    return m_fingerprint;
}
void OAIPosBankAccount::setFingerprint(const QString &fingerprint) {
    m_fingerprint = fingerprint;
    m_fingerprint_isSet = true;
}

bool OAIPosBankAccount::is_fingerprint_Set() const{
    return m_fingerprint_isSet;
}

bool OAIPosBankAccount::is_fingerprint_Valid() const{
    return m_fingerprint_isValid;
}

QString OAIPosBankAccount::getStatementDescription() const {
    return m_statement_description;
}
void OAIPosBankAccount::setStatementDescription(const QString &statement_description) {
    m_statement_description = statement_description;
    m_statement_description_isSet = true;
}

bool OAIPosBankAccount::is_statement_description_Set() const{
    return m_statement_description_isSet;
}

bool OAIPosBankAccount::is_statement_description_Valid() const{
    return m_statement_description_isValid;
}

QString OAIPosBankAccount::getTransferType() const {
    return m_transfer_type;
}
void OAIPosBankAccount::setTransferType(const QString &transfer_type) {
    m_transfer_type = transfer_type;
    m_transfer_type_isSet = true;
}

bool OAIPosBankAccount::is_transfer_type_Set() const{
    return m_transfer_type_isSet;
}

bool OAIPosBankAccount::is_transfer_type_Valid() const{
    return m_transfer_type_isValid;
}

bool OAIPosBankAccount::isSet() const {
...
bool OAIPosBankAccount::isValid() const {
