...
/*
 * OAICreateModifierGroupResponse.h
 *
 * 
 */

#ifndef OAICreateModifierGroupResponse_H
#define OAICreateModifierGroupResponse_H
...
class OAICreateModifierGroupResponse : public OAIObject {
public:
    OAICreateModifierGroupResponse();
    OAICreateModifierGroupResponse(QString json);
    ~OAICreateModifierGroupResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateModifierGroupResponse)

#endif // OAICreateModifierGroupResponse_H
