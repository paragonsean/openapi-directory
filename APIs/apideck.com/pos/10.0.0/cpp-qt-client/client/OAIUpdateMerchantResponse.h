...
/*
 * OAIUpdateMerchantResponse.h
 *
 * 
 */

#ifndef OAIUpdateMerchantResponse_H
#define OAIUpdateMerchantResponse_H
...
class OAIUpdateMerchantResponse : public OAIObject {
public:
    OAIUpdateMerchantResponse();
    OAIUpdateMerchantResponse(QString json);
    ~OAIUpdateMerchantResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateMerchantResponse)

#endif // OAIUpdateMerchantResponse_H
