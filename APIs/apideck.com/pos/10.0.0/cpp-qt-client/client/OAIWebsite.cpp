...
QString OAIWebsite::getId() const {
    return m_id;
}
void OAIWebsite::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIWebsite::is_id_Set() const{
    return m_id_isSet;
}

bool OAIWebsite::is_id_Valid() const{
    return m_id_isValid;
}
...
QString OAIWebsite::getUrl() const {
    return m_url;
}
void OAIWebsite::setUrl(const QString &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAIWebsite::is_url_Set() const{
    return m_url_isSet;
}

bool OAIWebsite::is_url_Valid() const{
