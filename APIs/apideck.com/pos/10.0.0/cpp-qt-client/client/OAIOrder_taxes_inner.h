...
/*
 * OAIOrder_taxes_inner.h
 *
 * 
 */

#ifndef OAIOrder_taxes_inner_H
#define OAIOrder_taxes_inner_H
...
class OAIOrder_taxes_inner : public OAIObject {
public:
    OAIOrder_taxes_inner();
    OAIOrder_taxes_inner(QString json);
    ~OAIOrder_taxes_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrder_taxes_inner)

#endif // OAIOrder_taxes_inner_H
