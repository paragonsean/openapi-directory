...
/*
 * OAIOrder_refunds_inner.h
 *
 * 
 */

#ifndef OAIOrder_refunds_inner_H
#define OAIOrder_refunds_inner_H
...
class OAIOrder_refunds_inner : public OAIObject {
public:
    OAIOrder_refunds_inner();
    OAIOrder_refunds_inner(QString json);
    ~OAIOrder_refunds_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrder_refunds_inner)

#endif // OAIOrder_refunds_inner_H
