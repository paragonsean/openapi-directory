...
/*
 * OAIDeleteTenderResponse.h
 *
 * 
 */

#ifndef OAIDeleteTenderResponse_H
#define OAIDeleteTenderResponse_H
...
class OAIDeleteTenderResponse : public OAIObject {
public:
    OAIDeleteTenderResponse();
    OAIDeleteTenderResponse(QString json);
    ~OAIDeleteTenderResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteTenderResponse)

#endif // OAIDeleteTenderResponse_H
