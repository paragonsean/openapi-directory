...
/*
 * OAIModifierGroup_modifiers_inner.h
 *
 * 
 */

#ifndef OAIModifierGroup_modifiers_inner_H
#define OAIModifierGroup_modifiers_inner_H
...
class OAIModifierGroup_modifiers_inner : public OAIObject {
public:
    OAIModifierGroup_modifiers_inner();
    OAIModifierGroup_modifiers_inner(QString json);
    ~OAIModifierGroup_modifiers_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIModifierGroup_modifiers_inner)

#endif // OAIModifierGroup_modifiers_inner_H
