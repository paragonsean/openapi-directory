...
/*
 * OAIGetPosPaymentsResponse.h
 *
 * 
 */

#ifndef OAIGetPosPaymentsResponse_H
#define OAIGetPosPaymentsResponse_H
...
class OAIGetPosPaymentsResponse : public OAIObject {
public:
    OAIGetPosPaymentsResponse();
    OAIGetPosPaymentsResponse(QString json);
    ~OAIGetPosPaymentsResponse() override;
    ...
    QList<OAIPosPayment> getData() const;
    void setData(const QList<OAIPosPayment> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPosPaymentsResponse)

#endif // OAIGetPosPaymentsResponse_H
