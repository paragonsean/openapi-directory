...
/*
 * OAIDeleteLocationResponse.h
 *
 * 
 */

#ifndef OAIDeleteLocationResponse_H
#define OAIDeleteLocationResponse_H
...
class OAIDeleteLocationResponse : public OAIObject {
public:
    OAIDeleteLocationResponse();
    OAIDeleteLocationResponse(QString json);
    ~OAIDeleteLocationResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteLocationResponse)

#endif // OAIDeleteLocationResponse_H
