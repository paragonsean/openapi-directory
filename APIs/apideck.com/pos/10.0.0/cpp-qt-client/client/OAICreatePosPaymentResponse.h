...
/*
 * OAICreatePosPaymentResponse.h
 *
 * 
 */

#ifndef OAICreatePosPaymentResponse_H
#define OAICreatePosPaymentResponse_H
...
class OAICreatePosPaymentResponse : public OAIObject {
public:
    OAICreatePosPaymentResponse();
    OAICreatePosPaymentResponse(QString json);
    ~OAICreatePosPaymentResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreatePosPaymentResponse)

#endif // OAICreatePosPaymentResponse_H
