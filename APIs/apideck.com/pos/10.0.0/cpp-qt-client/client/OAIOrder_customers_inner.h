...
/*
 * OAIOrder_customers_inner.h
 *
 * 
 */

#ifndef OAIOrder_customers_inner_H
#define OAIOrder_customers_inner_H
...
class OAIOrder_customers_inner : public OAIObject {
public:
    OAIOrder_customers_inner();
    OAIOrder_customers_inner(QString json);
    ~OAIOrder_customers_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrder_customers_inner)

#endif // OAIOrder_customers_inner_H
