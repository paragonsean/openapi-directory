...
/*
 * OAIGetTenderResponse.h
 *
 * 
 */

#ifndef OAIGetTenderResponse_H
#define OAIGetTenderResponse_H
...
class OAIGetTenderResponse : public OAIObject {
public:
    OAIGetTenderResponse();
    OAIGetTenderResponse(QString json);
    ~OAIGetTenderResponse() override;
    ...
    OAITender getData() const;
    void setData(const OAITender &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetTenderResponse)

#endif // OAIGetTenderResponse_H
