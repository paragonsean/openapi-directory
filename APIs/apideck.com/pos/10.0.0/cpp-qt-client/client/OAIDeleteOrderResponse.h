...
/*
 * OAIDeleteOrderResponse.h
 *
 * 
 */

#ifndef OAIDeleteOrderResponse_H
#define OAIDeleteOrderResponse_H
...
class OAIDeleteOrderResponse : public OAIObject {
public:
    OAIDeleteOrderResponse();
    OAIDeleteOrderResponse(QString json);
    ~OAIDeleteOrderResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteOrderResponse)

#endif // OAIDeleteOrderResponse_H
