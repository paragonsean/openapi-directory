...
/*
 * OAIGetItemsResponse.h
 *
 * 
 */

#ifndef OAIGetItemsResponse_H
#define OAIGetItemsResponse_H
...
class OAIGetItemsResponse : public OAIObject {
public:
    OAIGetItemsResponse();
    OAIGetItemsResponse(QString json);
    ~OAIGetItemsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetItemsResponse)

#endif // OAIGetItemsResponse_H
