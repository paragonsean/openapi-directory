...
/*
 * OAIPosWebhookEvent.h
 *
 * 
 */

#ifndef OAIPosWebhookEvent_H
#define OAIPosWebhookEvent_H
...
class OAIPosWebhookEvent : public OAIObject {
public:
    OAIPosWebhookEvent();
    OAIPosWebhookEvent(QString json);
    ~OAIPosWebhookEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPosWebhookEvent)

#endif // OAIPosWebhookEvent_H
