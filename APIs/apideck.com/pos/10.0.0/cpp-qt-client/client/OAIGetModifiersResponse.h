...
/*
 * OAIGetModifiersResponse.h
 *
 * 
 */

#ifndef OAIGetModifiersResponse_H
#define OAIGetModifiersResponse_H
...
class OAIGetModifiersResponse : public OAIObject {
public:
    OAIGetModifiersResponse();
    OAIGetModifiersResponse(QString json);
    ~OAIGetModifiersResponse() override;
    ...
    QList<OAIModifier> getData() const;
    void setData(const QList<OAIModifier> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetModifiersResponse)

#endif // OAIGetModifiersResponse_H
