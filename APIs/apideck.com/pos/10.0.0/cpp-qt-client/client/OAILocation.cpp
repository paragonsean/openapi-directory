...
QDateTime OAILocation::getCreatedAt() const {
    return m_created_at;
}
void OAILocation::setCreatedAt(const QDateTime &created_at) {
...
QString OAILocation::getCreatedBy() const {
    return m_created_by;
}
void OAILocation::setCreatedBy(const QString &created_by) {
    m_created_by = created_by;
    m_created_by_isSet = true;
}

bool OAILocation::is_created_by_Set() const{
    return m_created_by_isSet;
}

bool OAILocation::is_created_by_Valid() const{
    return m_created_by_isValid;
}

OAICurrency OAILocation::getCurrency() const {
    return m_currency;
}
void OAILocation::setCurrency(const OAICurrency &currency) {
    m_currency = currency;
...
OAIObject OAILocation::getCustomMappings() const {
    return m_custom_mappings;
}
void OAILocation::setCustomMappings(const OAIObject &custom_mappings) {
    m_custom_mappings = custom_mappings;
    m_custom_mappings_isSet = true;
}

bool OAILocation::is_custom_mappings_Set() const{
    return m_custom_mappings_isSet;
}

bool OAILocation::is_custom_mappings_Valid() const{
...
QDateTime OAILocation::getUpdatedAt() const {
    return m_updated_at;
}
void OAILocation::setUpdatedAt(const QDateTime &updated_at) {
    m_updated_at = updated_at;
    m_updated_at_isSet = true;
}

bool OAILocation::is_updated_at_Set() const{
    return m_updated_at_isSet;
}

bool OAILocation::is_updated_at_Valid() const{
    return m_updated_at_isValid;
}

QString OAILocation::getUpdatedBy() const {
    return m_updated_by;
}
void OAILocation::setUpdatedBy(const QString &updated_by) {
    m_updated_by = updated_by;
    m_updated_by_isSet = true;
}

bool OAILocation::is_updated_by_Set() const{
    return m_updated_by_isSet;
}

bool OAILocation::is_updated_by_Valid() const{
