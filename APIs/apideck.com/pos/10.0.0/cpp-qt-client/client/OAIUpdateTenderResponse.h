...
/*
 * OAIUpdateTenderResponse.h
 *
 * 
 */

#ifndef OAIUpdateTenderResponse_H
#define OAIUpdateTenderResponse_H
...
class OAIUpdateTenderResponse : public OAIObject {
public:
    OAIUpdateTenderResponse();
    OAIUpdateTenderResponse(QString json);
    ~OAIUpdateTenderResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateTenderResponse)

#endif // OAIUpdateTenderResponse_H
