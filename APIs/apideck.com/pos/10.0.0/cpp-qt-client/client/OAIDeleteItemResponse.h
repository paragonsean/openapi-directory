...
/*
 * OAIDeleteItemResponse.h
 *
 * 
 */

#ifndef OAIDeleteItemResponse_H
#define OAIDeleteItemResponse_H
...
class OAIDeleteItemResponse : public OAIObject {
public:
    OAIDeleteItemResponse();
    OAIDeleteItemResponse(QString json);
    ~OAIDeleteItemResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteItemResponse)

#endif // OAIDeleteItemResponse_H
