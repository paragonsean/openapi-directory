...
/*
 * OAICreateModifierResponse.h
 *
 * 
 */

#ifndef OAICreateModifierResponse_H
#define OAICreateModifierResponse_H
...
class OAICreateModifierResponse : public OAIObject {
public:
    OAICreateModifierResponse();
    OAICreateModifierResponse(QString json);
    ~OAICreateModifierResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateModifierResponse)

#endif // OAICreateModifierResponse_H
