...
/*
 * OAIDeleteModifierResponse.h
 *
 * 
 */

#ifndef OAIDeleteModifierResponse_H
#define OAIDeleteModifierResponse_H
...
class OAIDeleteModifierResponse : public OAIObject {
public:
    OAIDeleteModifierResponse();
    OAIDeleteModifierResponse(QString json);
    ~OAIDeleteModifierResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteModifierResponse)

#endif // OAIDeleteModifierResponse_H
