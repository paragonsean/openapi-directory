...
/*
 * OAIGetLocationsResponse.h
 *
 * 
 */

#ifndef OAIGetLocationsResponse_H
#define OAIGetLocationsResponse_H
...
class OAIGetLocationsResponse : public OAIObject {
public:
    OAIGetLocationsResponse();
    OAIGetLocationsResponse(QString json);
    ~OAIGetLocationsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetLocationsResponse)

#endif // OAIGetLocationsResponse_H
