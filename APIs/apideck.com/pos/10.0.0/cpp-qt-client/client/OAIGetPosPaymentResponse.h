...
/*
 * OAIGetPosPaymentResponse.h
 *
 * 
 */

#ifndef OAIGetPosPaymentResponse_H
#define OAIGetPosPaymentResponse_H
...
class OAIGetPosPaymentResponse : public OAIObject {
public:
    OAIGetPosPaymentResponse();
    OAIGetPosPaymentResponse(QString json);
    ~OAIGetPosPaymentResponse() override;
    ...
    OAIPosPayment getData() const;
    void setData(const OAIPosPayment &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPosPaymentResponse)

#endif // OAIGetPosPaymentResponse_H
