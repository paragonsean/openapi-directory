...
/*
 * OAIUpdateModifierResponse.h
 *
 * 
 */

#ifndef OAIUpdateModifierResponse_H
#define OAIUpdateModifierResponse_H
...
class OAIUpdateModifierResponse : public OAIObject {
public:
    OAIUpdateModifierResponse();
    OAIUpdateModifierResponse(QString json);
    ~OAIUpdateModifierResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateModifierResponse)

#endif // OAIUpdateModifierResponse_H
