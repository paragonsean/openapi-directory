...
/*
 * OAICreateTenderResponse.h
 *
 * 
 */

#ifndef OAICreateTenderResponse_H
#define OAICreateTenderResponse_H
...
class OAICreateTenderResponse : public OAIObject {
public:
    OAICreateTenderResponse();
    OAICreateTenderResponse(QString json);
    ~OAICreateTenderResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateTenderResponse)

#endif // OAICreateTenderResponse_H
