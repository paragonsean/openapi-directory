...
/*
 * OAIGetLocationResponse.h
 *
 * 
 */

#ifndef OAIGetLocationResponse_H
#define OAIGetLocationResponse_H
...
class OAIGetLocationResponse : public OAIObject {
public:
    OAIGetLocationResponse();
    OAIGetLocationResponse(QString json);
    ~OAIGetLocationResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetLocationResponse)

#endif // OAIGetLocationResponse_H
