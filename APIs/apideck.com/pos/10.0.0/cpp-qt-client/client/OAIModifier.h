...
#ifndef OAIModifier_H
#define OAIModifier_H
...
class OAIModifier : public OAIObject {
public:
    OAIModifier();
    OAIModifier(QString json);
    ~OAIModifier() override;
    ...
    QString getModifierGroupId() const;
    void setModifierGroupId(const QString &modifier_group_id);
    bool is_modifier_group_id_Set() const;
    bool is_modifier_group_id_Valid() const;
...
private:
    ...
    QString m_modifier_group_id;
    bool m_modifier_group_id_isSet;
    bool m_modifier_group_id_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIModifier)
