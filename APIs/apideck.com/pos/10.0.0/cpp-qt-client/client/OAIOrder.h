...
#include "OAIObject.h"
#include "OAIOrder_customers_inner.h"
#include "OAIOrder_discounts_inner.h"
#include "OAIOrder_fulfillments_inner.h"
#include "OAIOrder_line_items_inner.h"
#include "OAIOrder_payments_inner.h"
#include "OAIOrder_refunds_inner.h"
#include "OAIOrder_taxes_inner.h"
...
namespace OpenAPI {
class OAIOrder_customers_inner;
class OAIOrder_discounts_inner;
class OAIOrder_fulfillments_inner;
class OAIOrder_line_items_inner;
class OAIOrder_payments_inner;
class OAIOrder_refunds_inner;
class OAIServiceCharge;
class OAIOrder_taxes_inner;
class OAIOrder_tenders_inner;
...
public:
    ...
    QList<OAIOrder_customers_inner> getCustomers() const;
    void setCustomers(const QList<OAIOrder_customers_inner> &customers);
    bool is_customers_Set() const;
    bool is_customers_Valid() const;

    QList<OAIOrder_discounts_inner> getDiscounts() const;
    void setDiscounts(const QList<OAIOrder_discounts_inner> &discounts);
    ...
    QList<OAIOrder_fulfillments_inner> getFulfillments() const;
    void setFulfillments(const QList<OAIOrder_fulfillments_inner> &fulfillments);
    ...
    QList<OAIOrder_line_items_inner> getLineItems() const;
    void setLineItems(const QList<OAIOrder_line_items_inner> &line_items);
    ...
    void setOrderDate(const QDate &order_date);
    ...
    QString getOrderTypeId() const;
    void setOrderTypeId(const QString &order_type_id);
    bool is_order_type_id_Set() const;
    bool is_order_type_id_Valid() const;
    ...
    QList<OAIOrder_payments_inner> getPayments() const;
    void setPayments(const QList<OAIOrder_payments_inner> &payments);
    ...
    void setRefunded(const bool &refunded);
    bool is_refunded_Set() const;
    bool is_refunded_Valid() const;

    QList<OAIOrder_refunds_inner> getRefunds() const;
    void setRefunds(const QList<OAIOrder_refunds_inner> &refunds);
    ...
    QList<OAIOrder_taxes_inner> getTaxes() const;
    void setTaxes(const QList<OAIOrder_taxes_inner> &taxes);
    bool is_taxes_Set() const;
    bool is_taxes_Valid() const;

    QList<OAIOrder_tenders_inner> getTenders() const;
    void setTenders(const QList<OAIOrder_tenders_inner> &tenders);
    ...
    qint32 getTotalRefund() const;
    void setTotalRefund(const qint32 &total_refund);
    bool is_total_refund_Set() const;
    bool is_total_refund_Valid() const;

    qint32 getTotalServiceCharge() const;
    void setTotalServiceCharge(const qint32 &total_service_charge);
    bool is_total_service_charge_Set() const;
    bool is_total_service_charge_Valid() const;
    ...
    qint32 getTotalTip() const;
    void setTotalTip(const qint32 &total_tip);
    bool is_total_tip_Set() const;
    bool is_total_tip_Valid() const;
...
private:
    ...
    QList<OAIOrder_customers_inner> m_customers;
    bool m_customers_isSet;
    bool m_customers_isValid;

    QList<OAIOrder_discounts_inner> m_discounts;
    ...
    QList<OAIOrder_fulfillments_inner> m_fulfillments;
    ...
    QList<OAIOrder_line_items_inner> m_line_items;
    ...
    QString m_order_type_id;
    bool m_order_type_id_isSet;
    bool m_order_type_id_isValid;

    QString m_payment_status;
    bool m_payment_status_isSet;
    bool m_payment_status_isValid;

    QList<OAIOrder_payments_inner> m_payments;
    ...
    bool m_refunded;
    bool m_refunded_isSet;
    bool m_refunded_isValid;

    QList<OAIOrder_refunds_inner> m_refunds;
    ...
    QList<OAIOrder_taxes_inner> m_taxes;
    bool m_taxes_isSet;
    bool m_taxes_isValid;

    QList<OAIOrder_tenders_inner> m_tenders;
    ...
    qint32 m_total_refund;
    bool m_total_refund_isSet;
    bool m_total_refund_isValid;

    qint32 m_total_service_charge;
    bool m_total_service_charge_isSet;
    bool m_total_service_charge_isValid;
    ...
    qint32 m_total_tip;
    bool m_total_tip_isSet;
    bool m_total_tip_isValid;
