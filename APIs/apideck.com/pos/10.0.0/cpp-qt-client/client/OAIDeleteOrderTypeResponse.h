...
/*
 * OAIDeleteOrderTypeResponse.h
 *
 * 
 */

#ifndef OAIDeleteOrderTypeResponse_H
#define OAIDeleteOrderTypeResponse_H
...
class OAIDeleteOrderTypeResponse : public OAIObject {
public:
    OAIDeleteOrderTypeResponse();
    OAIDeleteOrderTypeResponse(QString json);
    ~OAIDeleteOrderTypeResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteOrderTypeResponse)

#endif // OAIDeleteOrderTypeResponse_H
