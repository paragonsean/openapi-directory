...
#include "OAICategories_inner.h"
#include "OAICurrency.h"
#include "OAIItem_options_inner.h"
#include "OAIObject.h"
...
namespace OpenAPI {
class OAICategories_inner;
class OAIVariations_inner;
class OAIItem_options_inner;
class OAIVariations_inner_1;
...
public:
    ...
    QList<OAICategories_inner> getCategories() const;
    void setCategories(const QList<OAICategories_inner> &categories);
    ...
    bool isIsRevenue() const;
    void setIsRevenue(const bool &is_revenue);
    bool is_is_revenue_Set() const;
    bool is_is_revenue_Valid() const;

    QList<OAIVariations_inner> getModifierGroups() const;
    void setModifierGroups(const QList<OAIVariations_inner> &modifier_groups);
    bool is_modifier_groups_Set() const;
    bool is_modifier_groups_Valid() const;
    ...
    QList<OAIItem_options_inner> getOptions() const;
    void setOptions(const QList<OAIItem_options_inner> &options);
    ...
    OAICurrency getPriceCurrency() const;
    void setPriceCurrency(const OAICurrency &price_currency);
    ...
    bool isUseDefaultTaxRates() const;
    void setUseDefaultTaxRates(const bool &use_default_tax_rates);
    bool is_use_default_tax_rates_Set() const;
    bool is_use_default_tax_rates_Valid() const;

    QList<OAIVariations_inner_1> getVariations() const;
    void setVariations(const QList<OAIVariations_inner_1> &variations);
...
private:
    ...
    QList<OAICategories_inner> m_categories;
    ...
    bool m_is_revenue;
    bool m_is_revenue_isSet;
    bool m_is_revenue_isValid;

    QList<OAIVariations_inner> m_modifier_groups;
    bool m_modifier_groups_isSet;
    bool m_modifier_groups_isValid;

    QString m_name;
    bool m_name_isSet;
    bool m_name_isValid;

    QList<OAIItem_options_inner> m_options;
    ...
    bool m_use_default_tax_rates;
    bool m_use_default_tax_rates_isSet;
    bool m_use_default_tax_rates_isValid;

    QList<OAIVariations_inner_1> m_variations;
