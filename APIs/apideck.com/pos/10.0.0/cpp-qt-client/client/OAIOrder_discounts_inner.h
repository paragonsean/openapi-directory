...
/*
 * OAIOrder_discounts_inner.h
 *
 * 
 */

#ifndef OAIOrder_discounts_inner_H
#define OAIOrder_discounts_inner_H
...
class OAIOrder_discounts_inner : public OAIObject {
public:
    OAIOrder_discounts_inner();
    OAIOrder_discounts_inner(QString json);
    ~OAIOrder_discounts_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrder_discounts_inner)

#endif // OAIOrder_discounts_inner_H
