...
/*
 * OAIGetMerchantResponse.h
 *
 * 
 */

#ifndef OAIGetMerchantResponse_H
#define OAIGetMerchantResponse_H
...
class OAIGetMerchantResponse : public OAIObject {
public:
    OAIGetMerchantResponse();
    OAIGetMerchantResponse(QString json);
    ~OAIGetMerchantResponse() override;
    ...
    OAIMerchant getData() const;
    void setData(const OAIMerchant &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetMerchantResponse)

#endif // OAIGetMerchantResponse_H
