...
/*
 * OAIGetApplicantsResponse.h
 *
 * 
 */

#ifndef OAIGetApplicantsResponse_H
#define OAIGetApplicantsResponse_H
...
class OAIGetApplicantsResponse : public OAIObject {
public:
    OAIGetApplicantsResponse();
    OAIGetApplicantsResponse(QString json);
    ~OAIGetApplicantsResponse() override;
    ...
    QList<OAIApplicant> getData() const;
    void setData(const QList<OAIApplicant> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetApplicantsResponse)

#endif // OAIGetApplicantsResponse_H
