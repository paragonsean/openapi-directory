...
/*
 * OAICreateApplicantResponse.h
 *
 * 
 */

#ifndef OAICreateApplicantResponse_H
#define OAICreateApplicantResponse_H
...
class OAICreateApplicantResponse : public OAIObject {
public:
    OAICreateApplicantResponse();
    OAICreateApplicantResponse(QString json);
    ~OAICreateApplicantResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateApplicantResponse)

#endif // OAICreateApplicantResponse_H
