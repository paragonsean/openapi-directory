...
void OAIJobStatus::fromJson(QString jsonString) {
    ...
    else if ( jsonString.compare("on-hold", Qt::CaseInsensitive) == 0) {
        m_value = eOAIJobStatus::ON_HOLD;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("private", Qt::CaseInsensitive) == 0) {
        m_value = eOAIJobStatus::PRIVATE;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAIJobStatus::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIJobStatus::DRAFT:
            val = "draft";
            break;
        case eOAIJobStatus::INTERNAL:
            val = "internal";
            break;
        case eOAIJobStatus::PUBLISHED:
            val = "published";
            break;
        case eOAIJobStatus::COMPLETED:
            val = "completed";
            break;
        case eOAIJobStatus::ON_HOLD:
            val = "on-hold";
            break;
        case eOAIJobStatus::PRIVATE:
            val = "private";
            break;
        default:
            break;
