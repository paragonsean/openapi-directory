...
/*
 * OAIGetApplicationsResponse.h
 *
 * 
 */

#ifndef OAIGetApplicationsResponse_H
#define OAIGetApplicationsResponse_H
...
class OAIGetApplicationsResponse : public OAIObject {
public:
    OAIGetApplicationsResponse();
    OAIGetApplicationsResponse(QString json);
    ~OAIGetApplicationsResponse() override;
    ...
    QList<OAIApplication> getData() const;
    void setData(const QList<OAIApplication> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetApplicationsResponse)

#endif // OAIGetApplicationsResponse_H
