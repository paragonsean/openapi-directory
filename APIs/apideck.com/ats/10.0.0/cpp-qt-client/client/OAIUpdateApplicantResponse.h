...
/*
 * OAIUpdateApplicantResponse.h
 *
 * 
 */

#ifndef OAIUpdateApplicantResponse_H
#define OAIUpdateApplicantResponse_H
...
class OAIUpdateApplicantResponse : public OAIObject {
public:
    OAIUpdateApplicantResponse();
    OAIUpdateApplicantResponse(QString json);
    ~OAIUpdateApplicantResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateApplicantResponse)

#endif // OAIUpdateApplicantResponse_H
