...
/*
 * OAIDeleteApplicantResponse.h
 *
 * 
 */

#ifndef OAIDeleteApplicantResponse_H
#define OAIDeleteApplicantResponse_H
...
class OAIDeleteApplicantResponse : public OAIObject {
public:
    OAIDeleteApplicantResponse();
    OAIDeleteApplicantResponse(QString json);
    ~OAIDeleteApplicantResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteApplicantResponse)

#endif // OAIDeleteApplicantResponse_H
