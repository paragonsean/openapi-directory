...
/*
 * OAIGetApplicantResponse.h
 *
 * 
 */

#ifndef OAIGetApplicantResponse_H
#define OAIGetApplicantResponse_H
...
class OAIGetApplicantResponse : public OAIObject {
public:
    OAIGetApplicantResponse();
    OAIGetApplicantResponse(QString json);
    ~OAIGetApplicantResponse() override;
    ...
    OAIApplicant getData() const;
    void setData(const OAIApplicant &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetApplicantResponse)

#endif // OAIGetApplicantResponse_H
