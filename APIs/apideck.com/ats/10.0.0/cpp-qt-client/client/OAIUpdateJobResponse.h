...
/*
 * OAIUpdateJobResponse.h
 *
 * 
 */

#ifndef OAIUpdateJobResponse_H
#define OAIUpdateJobResponse_H
...
class OAIUpdateJobResponse : public OAIObject {
public:
    OAIUpdateJobResponse();
    OAIUpdateJobResponse(QString json);
    ~OAIUpdateJobResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateJobResponse)

#endif // OAIUpdateJobResponse_H
