...
#ifndef OAIAtsActivity_H
#define OAIAtsActivity_H
...
class OAIAtsActivity : public OAIObject {
public:
    OAIAtsActivity();
    OAIAtsActivity(QString json);
    ~OAIAtsActivity() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAtsActivity)

#endif // OAIAtsActivity_H
