...
/*
 * OAIAtsWebhookEvent.h
 *
 * 
 */

#ifndef OAIAtsWebhookEvent_H
#define OAIAtsWebhookEvent_H
...
class OAIAtsWebhookEvent : public OAIObject {
public:
    OAIAtsWebhookEvent();
    OAIAtsWebhookEvent(QString json);
    ~OAIAtsWebhookEvent() override;
    ...
    OAIAtsEventType getEventType() const;
    void setEventType(const OAIAtsEventType &event_type);
...
Q_DECLARE_METATYPE(OpenAPI::OAIAtsWebhookEvent)

#endif // OAIAtsWebhookEvent_H
