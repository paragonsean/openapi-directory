...
/*
 * OAIGetJobsResponse.h
 *
 * 
 */

#ifndef OAIGetJobsResponse_H
#define OAIGetJobsResponse_H
...
class OAIGetJobsResponse : public OAIObject {
public:
    OAIGetJobsResponse();
    OAIGetJobsResponse(QString json);
    ~OAIGetJobsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetJobsResponse)

#endif // OAIGetJobsResponse_H
