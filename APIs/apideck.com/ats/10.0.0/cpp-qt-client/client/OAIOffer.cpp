...
QString OAIOffer::getApplicationId() const {
    return m_application_id;
}
void OAIOffer::setApplicationId(const QString &application_id) {
    m_application_id = application_id;
    m_application_id_isSet = true;
}

bool OAIOffer::is_application_id_Set() const{
    return m_application_id_isSet;
}

bool OAIOffer::is_application_id_Valid() const{
    return m_application_id_isValid;
}

QDateTime OAIOffer::getCreatedAt() const {
    return m_created_at;
}
void OAIOffer::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIOffer::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIOffer::is_created_at_Valid() const{
    return m_created_at_isValid;
}

QString OAIOffer::getCreatedBy() const {
    return m_created_by;
}
void OAIOffer::setCreatedBy(const QString &created_by) {
    m_created_by = created_by;
    m_created_by_isSet = true;
}

bool OAIOffer::is_created_by_Set() const{
    return m_created_by_isSet;
}

bool OAIOffer::is_created_by_Valid() const{
    return m_created_by_isValid;
}

OAIObject OAIOffer::getCustomMappings() const {
    return m_custom_mappings;
}
void OAIOffer::setCustomMappings(const OAIObject &custom_mappings) {
    m_custom_mappings = custom_mappings;
    m_custom_mappings_isSet = true;
}

bool OAIOffer::is_custom_mappings_Set() const{
    return m_custom_mappings_isSet;
}

bool OAIOffer::is_custom_mappings_Valid() const{
...
QDateTime OAIOffer::getUpdatedAt() const {
    return m_updated_at;
}
void OAIOffer::setUpdatedAt(const QDateTime &updated_at) {
    m_updated_at = updated_at;
    m_updated_at_isSet = true;
}

bool OAIOffer::is_updated_at_Set() const{
    return m_updated_at_isSet;
}

bool OAIOffer::is_updated_at_Valid() const{
    return m_updated_at_isValid;
}

QString OAIOffer::getUpdatedBy() const {
    return m_updated_by;
}
void OAIOffer::setUpdatedBy(const QString &updated_by) {
    m_updated_by = updated_by;
    m_updated_by_isSet = true;
}

bool OAIOffer::is_updated_by_Set() const{
    return m_updated_by_isSet;
}

bool OAIOffer::is_updated_by_Valid() const{
