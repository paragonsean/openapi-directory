...
public:
    ...
    QString getApplicantId() const;
    void setApplicantId(const QString &applicant_id);
    bool is_applicant_id_Set() const;
    bool is_applicant_id_Valid() const;
    ...
    OAIApplication_stage getStage() const;
    void setStage(const OAIApplication_stage &stage);
...
private:
    ...
    QString m_applicant_id;
    bool m_applicant_id_isSet;
    bool m_applicant_id_isValid;
