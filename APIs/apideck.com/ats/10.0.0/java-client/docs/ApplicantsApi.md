...
| [**applicantsDelete**](ApplicantsApi.md#applicantsDelete) | **DELETE** /ats/applicants/{id} | Delete Applicant |
| [**applicantsOne**](ApplicantsApi.md#applicantsOne) | **GET** /ats/applicants/{id} | Get Applicant |
| [**applicantsUpdate**](ApplicantsApi.md#applicantsUpdate) | **PATCH** /ats/applicants/{id} | Update Applicant |


<a id="applicantsAdd"></a>
# **applicantsAdd**
> CreateApplicantResponse applicantsAdd(xApideckConsumerId, xApideckAppId, applicant, raw, xApideckServiceId)
...
<a id="applicantsAll"></a>
# **applicantsAll**
> GetApplicantsResponse applicantsAll(xApideckConsumerId, xApideckAppId, raw, xApideckServiceId, cursor, limit, filter, passThrough, fields)
...
public class Example {
  public static void main(String[] args) {
    ...
    ApplicantsFilter filter = new ApplicantsFilter(); // ApplicantsFilter | Apply filters
    ...
    try {
      GetApplicantsResponse result = apiInstance.applicantsAll(xApideckConsumerId, xApideckAppId, raw, xApideckServiceId, cursor, limit, filter, passThrough, fields);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApplicantsApi#applicantsAll");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| **filter** | [**ApplicantsFilter**](.md)| Apply filters | [optional] |
...
<a id="applicantsDelete"></a>
# **applicantsDelete**
> DeleteApplicantResponse applicantsDelete(id, xApideckConsumerId, xApideckAppId, xApideckServiceId, raw)
...
public class Example {
  public static void main(String[] args) {
    ...
    Boolean raw = false; // Boolean | Include raw response. Mostly used for debugging purposes
    try {
      DeleteApplicantResponse result = apiInstance.applicantsDelete(id, xApideckConsumerId, xApideckAppId, xApideckServiceId, raw);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApplicantsApi#applicantsDelete");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="applicantsOne"></a>
# **applicantsOne**
> GetApplicantResponse applicantsOne(id, xApideckConsumerId, xApideckAppId, xApideckServiceId, raw, fields)
...
public class Example {
  public static void main(String[] args) {
    ...
    String fields = "id,updated_at"; // String | The 'fields' parameter allows API users to specify the fields they want to include in the API response. If this parameter is not present, the API will return all available fields. If this parameter is present, only the fields specified in the comma-separated string will be included in the response. Nested properties can also be requested by using a dot notation. <br /><br />Example: `fields=name,email,addresses.city`<br /><br />In the example above, the response will only include the fields \"name\", \"email\" and \"addresses.city\". If any other fields are available, they will be excluded.
    try {
      GetApplicantResponse result = apiInstance.applicantsOne(id, xApideckConsumerId, xApideckAppId, xApideckServiceId, raw, fields);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApplicantsApi#applicantsOne");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="applicantsUpdate"></a>
# **applicantsUpdate**
> UpdateApplicantResponse applicantsUpdate(id, xApideckConsumerId, xApideckAppId, applicant, xApideckServiceId, raw)
...
public class Example {
  public static void main(String[] args) {
    ...
    Boolean raw = false; // Boolean | Include raw response. Mostly used for debugging purposes
    try {
      UpdateApplicantResponse result = apiInstance.applicantsUpdate(id, xApideckConsumerId, xApideckAppId, applicant, xApideckServiceId, raw);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApplicantsApi#applicantsUpdate");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
