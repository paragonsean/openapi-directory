...
import org.openapitools.client.model.AtsEventType;
...
public class AtsWebhookEvent {
  ...
  private AtsEventType eventType;

  public AtsWebhookEvent() {
  }

  public AtsWebhookEvent consumerId(String consumerId) {
  ...
  public AtsWebhookEvent entityId(String entityId) {
  ...
  public AtsWebhookEvent entityType(String entityType) {
  ...
  public AtsWebhookEvent entityUrl(String entityUrl) {
  ...
  public AtsWebhookEvent eventId(String eventId) {
  ...
  public AtsWebhookEvent executionAttempt(BigDecimal executionAttempt) {
  ...
  public AtsWebhookEvent occurredAt(String occurredAt) {
  ...
  public AtsWebhookEvent serviceId(String serviceId) {
  ...
  public AtsWebhookEvent unifiedApi(UnifiedApiEnum unifiedApi) {
  ...
  public AtsWebhookEvent eventType(AtsEventType eventType) {
   ...
   */
  @javax.annotation.Nullable
  public AtsEventType getEventType() {
    return eventType;
  }

  public void setEventType(AtsEventType eventType) {
    this.eventType = eventType;
  }
  ...
  public boolean equals(Object o) {
    ...
    AtsWebhookEvent atsWebhookEvent = (AtsWebhookEvent) o;
    return Objects.equals(this.consumerId, atsWebhookEvent.consumerId) &&
        Objects.equals(this.entityId, atsWebhookEvent.entityId) &&
        Objects.equals(this.entityType, atsWebhookEvent.entityType) &&
        Objects.equals(this.entityUrl, atsWebhookEvent.entityUrl) &&
        Objects.equals(this.eventId, atsWebhookEvent.eventId) &&
        Objects.equals(this.executionAttempt, atsWebhookEvent.executionAttempt) &&
        Objects.equals(this.occurredAt, atsWebhookEvent.occurredAt) &&
        Objects.equals(this.serviceId, atsWebhookEvent.serviceId) &&
        Objects.equals(this.unifiedApi, atsWebhookEvent.unifiedApi) &&
        Objects.equals(this.eventType, atsWebhookEvent.eventType);
  }
  ...
  public String toString() {
    ...
    sb.append("class AtsWebhookEvent {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AtsWebhookEvent
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AtsWebhookEvent.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AtsWebhookEvent is not found in the empty JSON string", AtsWebhookEvent.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AtsWebhookEvent.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AtsWebhookEvent` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("event_type") != null && !jsonObj.get("event_type").isJsonNull()) {
        AtsEventType.validateJsonElement(jsonObj.get("event_type"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AtsWebhookEvent.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AtsWebhookEvent' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AtsWebhookEvent> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AtsWebhookEvent.class));

       return (TypeAdapter<T>) new TypeAdapter<AtsWebhookEvent>() {
           @Override
           public void write(JsonWriter out, AtsWebhookEvent value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AtsWebhookEvent read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AtsWebhookEvent given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AtsWebhookEvent
   * @throws IOException if the JSON string is invalid with respect to AtsWebhookEvent
   */
  public static AtsWebhookEvent fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AtsWebhookEvent.class);
  }

  /**
   * Convert an instance of AtsWebhookEvent to an JSON string
   *
   * @return JSON string
   */
