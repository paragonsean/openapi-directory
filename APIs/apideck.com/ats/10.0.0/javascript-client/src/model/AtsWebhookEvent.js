...
import AtsEventType from './AtsEventType';

/**
 * The AtsWebhookEvent model module.
 * @module model/AtsWebhookEvent
 * @version 10.0.0
 */
class AtsWebhookEvent {
    /**
     * Constructs a new <code>AtsWebhookEvent</code>.
     * @alias module:model/AtsWebhookEvent
     */
    constructor() { 
        
        AtsWebhookEvent.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AtsWebhookEvent</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AtsWebhookEvent} obj Optional instance to populate.
     * @return {module:model/AtsWebhookEvent} The populated <code>AtsWebhookEvent</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AtsWebhookEvent();
            ...
            if (data.hasOwnProperty('event_type')) {
                obj['event_type'] = AtsEventType.constructFromObject(data['event_type']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AtsWebhookEvent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AtsWebhookEvent</code>.
     */
 ...
 */
AtsWebhookEvent.prototype['consumer_id'] = undefined;

/**
 * The service provider's ID of the entity that triggered this event
 * @member {String} entity_id
 */
AtsWebhookEvent.prototype['entity_id'] = undefined;

/**
 * The type entity that triggered this event
 * @member {String} entity_type
 */
AtsWebhookEvent.prototype['entity_type'] = undefined;

/**
 * The url to retrieve entity detail.
 * @member {String} entity_url
 */
AtsWebhookEvent.prototype['entity_url'] = undefined;

/**
 * Unique reference to this request event
 * @member {String} event_id
 */
AtsWebhookEvent.prototype['event_id'] = undefined;

/**
 * The current count this request event has been attempted
 * @member {Number} execution_attempt
 */
AtsWebhookEvent.prototype['execution_attempt'] = undefined;

/**
 * ISO Datetime for when the original event occurred
 * @member {String} occurred_at
 */
AtsWebhookEvent.prototype['occurred_at'] = undefined;

/**
 * Service provider identifier
 * @member {String} service_id
 */
AtsWebhookEvent.prototype['service_id'] = undefined;

/**
 * Name of Apideck Unified API
 * @member {module:model/AtsWebhookEvent.UnifiedApiEnum} unified_api
 */
AtsWebhookEvent.prototype['unified_api'] = undefined;

/**
 * @member {module:model/AtsEventType} event_type
 */
AtsWebhookEvent.prototype['event_type'] = undefined;
 ...
 * @readonly
 */
AtsWebhookEvent['UnifiedApiEnum'] = {
...
export default AtsWebhookEvent;
