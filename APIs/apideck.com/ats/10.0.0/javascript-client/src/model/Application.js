...
class Application {
    ...
    constructor(applicantId, jobId) { 
        ...
        Application.initialize(this, applicantId, jobId);
    }
     ...
     */
    static initialize(obj, applicantId, jobId) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('stage')) {
                obj['stage'] = ApplicationStage.constructFromObject(data['stage']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['applicant_id'] && !(typeof data['applicant_id'] === 'string' || data['applicant_id'] instanceof String)) {
            throw new Error("Expected the field `applicant_id` to be a primitive type in the JSON string but got " + data['applicant_id']);
        }
        // ensure the json data is a string
        ...
        if (data['stage']) { // data not null
          ApplicationStage.validateJSON(data['stage']);
        }
        // ensure the json data is a string
...
Application.RequiredProperties = ["applicant_id", "job_id"];

/**
 * @member {String} applicant_id
 */
Application.prototype['applicant_id'] = undefined;
 ...
 */
Application.prototype['custom_mappings'] = undefined;
 ...
 */
Application.prototype['job_id'] = undefined;

/**
 * @member {module:model/ApplicationStage} stage
 */
Application.prototype['stage'] = undefined;
 ...
 */
Application.prototype['updated_by'] = undefined;
