...
import NotFoundResponseDetail from './NotFoundResponseDetail';
...
class NotFoundResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('detail')) {
                obj['detail'] = NotFoundResponseDetail.constructFromObject(data['detail']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['detail']) { // data not null
          NotFoundResponseDetail.validateJSON(data['detail']);
        }
...
/**
 * @member {module:model/NotFoundResponseDetail} detail
 */
NotFoundResponse.prototype['detail'] = undefined;

/**
 * Contains an explanation of the status_code as defined in HTTP/1.1 standard (RFC 7231)
 * @member {String} error
 */
NotFoundResponse.prototype['error'] = undefined;
 ...
 * @member {String} ref
 */
NotFoundResponse.prototype['ref'] = undefined;

/**
 * HTTP status code
 * @member {Number} status_code
 */
NotFoundResponse.prototype['status_code'] = undefined;

/**
 * The type of error returned
 * @member {String} type_name
 */
NotFoundResponse.prototype['type_name'] = undefined;
