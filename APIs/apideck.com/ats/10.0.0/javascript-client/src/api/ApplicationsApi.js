...
export default class ApplicationsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the applicationsAdd operation.
     * @callback module:api/ApplicationsApi~applicationsAddCallback
     ...
     * @param {module:api/ApplicationsApi~applicationsAddCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CreateApplicationResponse}
     */
    applicationsAdd(xApideckConsumerId, xApideckAppId, application, opts, callback) {
      opts = opts || {};
      ...
      if (xApideckConsumerId === undefined || xApideckConsumerId === null) {
        throw new Error("Missing the required parameter 'xApideckConsumerId' when calling applicationsAdd");
      }
      // verify the required parameter 'xApideckAppId' is set
      if (xApideckAppId === undefined || xApideckAppId === null) {
        throw new Error("Missing the required parameter 'xApideckAppId' when calling applicationsAdd");
      }
      // verify the required parameter 'application' is set
      if (application === undefined || application === null) {
        throw new Error("Missing the required parameter 'application' when calling applicationsAdd");
      }
    ...
    /**
     * Callback function to receive the result of the applicationsAll operation.
     * @callback module:api/ApplicationsApi~applicationsAllCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/ApplicationsApi~applicationsAllCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetApplicationsResponse}
     */
    applicationsAll(xApideckConsumerId, xApideckAppId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'xApideckConsumerId' is set
      if (xApideckConsumerId === undefined || xApideckConsumerId === null) {
        throw new Error("Missing the required parameter 'xApideckConsumerId' when calling applicationsAll");
      }
      // verify the required parameter 'xApideckAppId' is set
      if (xApideckAppId === undefined || xApideckAppId === null) {
        throw new Error("Missing the required parameter 'xApideckAppId' when calling applicationsAll");
      }
     ...
     */
    applicationsDelete(id, xApideckConsumerId, xApideckAppId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling applicationsDelete");
      }
      // verify the required parameter 'xApideckConsumerId' is set
      if (xApideckConsumerId === undefined || xApideckConsumerId === null) {
        throw new Error("Missing the required parameter 'xApideckConsumerId' when calling applicationsDelete");
      }
      // verify the required parameter 'xApideckAppId' is set
      if (xApideckAppId === undefined || xApideckAppId === null) {
        throw new Error("Missing the required parameter 'xApideckAppId' when calling applicationsDelete");
      }
    ...
    /**
     * Callback function to receive the result of the applicationsOne operation.
     * @callback module:api/ApplicationsApi~applicationsOneCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} [xApideckServiceId] Provide the service id you want to call (e.g., pipedrive). Only needed when a consumer has activated multiple integrations for a Unified API.
     * @param {Boolean} [raw = false)] Include raw response. Mostly used for debugging purposes
     * @param {module:api/ApplicationsApi~applicationsOneCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetApplicationResponse}
     */
    applicationsOne(id, xApideckConsumerId, xApideckAppId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling applicationsOne");
      }
      // verify the required parameter 'xApideckConsumerId' is set
      if (xApideckConsumerId === undefined || xApideckConsumerId === null) {
        throw new Error("Missing the required parameter 'xApideckConsumerId' when calling applicationsOne");
      }
      // verify the required parameter 'xApideckAppId' is set
      if (xApideckAppId === undefined || xApideckAppId === null) {
        throw new Error("Missing the required parameter 'xApideckAppId' when calling applicationsOne");
      }
     ...
     */
    applicationsUpdate(id, xApideckConsumerId, xApideckAppId, application, opts, callback) {
      opts = opts || {};
      let postBody = application;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling applicationsUpdate");
      }
      // verify the required parameter 'xApideckConsumerId' is set
      if (xApideckConsumerId === undefined || xApideckConsumerId === null) {
        throw new Error("Missing the required parameter 'xApideckConsumerId' when calling applicationsUpdate");
      }
      // verify the required parameter 'xApideckAppId' is set
      if (xApideckAppId === undefined || xApideckAppId === null) {
        throw new Error("Missing the required parameter 'xApideckAppId' when calling applicationsUpdate");
      }
      // verify the required parameter 'application' is set
      if (application === undefined || application === null) {
        throw new Error("Missing the required parameter 'application' when calling applicationsUpdate");
      }
