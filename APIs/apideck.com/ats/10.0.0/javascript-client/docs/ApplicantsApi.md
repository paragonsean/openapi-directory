...
> CreateApplicantResponse applicantsAdd(xApideckConsumerId, xApideckAppId, applicant, opts)
...
let apiInstance = new AtsApi.ApplicantsApi();
...
let applicant = new AtsApi.Applicant(); // Applicant | 
let opts = {
...
apiInstance.applicantsAdd(xApideckConsumerId, xApideckAppId, applicant, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> GetApplicantsResponse applicantsAll(xApideckConsumerId, xApideckAppId, opts)
...
let opts = {
  ...
  'filter': new AtsApi.ApplicantsFilter(), // ApplicantsFilter | Apply filters
...
apiInstance.applicantsAll(xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> DeleteApplicantResponse applicantsDelete(id, xApideckConsumerId, xApideckAppId, opts)
...
apiInstance.applicantsDelete(id, xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> GetApplicantResponse applicantsOne(id, xApideckConsumerId, xApideckAppId, opts)
...
apiInstance.applicantsOne(id, xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> UpdateApplicantResponse applicantsUpdate(id, xApideckConsumerId, xApideckAppId, applicant, opts)
...
apiInstance.applicantsUpdate(id, xApideckConsumerId, xApideckAppId, applicant, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
