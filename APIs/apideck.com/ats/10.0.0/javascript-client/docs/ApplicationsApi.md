...
> CreateApplicationResponse applicationsAdd(xApideckConsumerId, xApideckAppId, application, opts)
...
let apiInstance = new AtsApi.ApplicationsApi();
...
let application = new AtsApi.Application(); // Application | 
let opts = {
...
apiInstance.applicationsAdd(xApideckConsumerId, xApideckAppId, application, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> GetApplicationsResponse applicationsAll(xApideckConsumerId, xApideckAppId, opts)
...
apiInstance.applicationsAll(xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> DeleteApplicationResponse applicationsDelete(id, xApideckConsumerId, xApideckAppId, opts)
...
apiInstance.applicationsDelete(id, xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> GetApplicationResponse applicationsOne(id, xApideckConsumerId, xApideckAppId, opts)
...
apiInstance.applicationsOne(id, xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> UpdateApplicationResponse applicationsUpdate(id, xApideckConsumerId, xApideckAppId, application, opts)
...
apiInstance.applicationsUpdate(id, xApideckConsumerId, xApideckAppId, application, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
