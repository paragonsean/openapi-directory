...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AtsApi.AtsWebhookEvent();
  });
  ...
  describe('AtsWebhookEvent', function() {
    it('should create an instance of AtsWebhookEvent', function() {
      // uncomment below and update the code to test AtsWebhookEvent
      //var instance = new AtsApi.AtsWebhookEvent();
      //expect(instance).to.be.a(AtsApi.AtsWebhookEvent);
    });
