...
public class Folder {
  ...
  public Folder customMappings(Object customMappings) {
  ...
  public Folder owner(Owner owner) {
    this.owner = owner;
    return this;
  }
  ...
  public Folder parentFolders(List<LinkedFolder> parentFolders) {
    this.parentFolders = parentFolders;
    return this;
  }

  public Folder addParentFoldersItem(LinkedFolder parentFoldersItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.createdAt, folder.createdAt) &&
        ...
        Objects.equals(this.customMappings, folder.customMappings) &&
        ...
        Objects.equals(this.parentFolders, folder.parentFolders) &&
        Objects.equals(this.parentFoldersComplete, folder.parentFoldersComplete) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(createdAt, createdBy, customMappings, description, id, name, owner, parentFolders, parentFoldersComplete, path, size, updatedAt, updatedBy);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("parent_folders");
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // validate the required field `parent_folders` (array)
