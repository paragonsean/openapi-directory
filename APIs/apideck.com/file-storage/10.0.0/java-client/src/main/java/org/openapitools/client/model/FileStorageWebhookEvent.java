...
public class FileStorageWebhookEvent {
  ...
  public FileStorageWebhookEvent() {
  }

  public FileStorageWebhookEvent consumerId(String consumerId) {
  ...
  public FileStorageWebhookEvent entityId(String entityId) {
  ...
  public FileStorageWebhookEvent entityType(String entityType) {
  ...
  public FileStorageWebhookEvent entityUrl(String entityUrl) {
  ...
  public FileStorageWebhookEvent eventId(String eventId) {
  ...
  public FileStorageWebhookEvent executionAttempt(BigDecimal executionAttempt) {
  ...
  public FileStorageWebhookEvent occurredAt(String occurredAt) {
  ...
  public FileStorageWebhookEvent serviceId(String serviceId) {
  ...
  public FileStorageWebhookEvent unifiedApi(UnifiedApiEnum unifiedApi) {
  ...
  public FileStorageWebhookEvent eventType(FileStorageEventType eventType) {
  ...
  public boolean equals(Object o) {
    ...
    FileStorageWebhookEvent fileStorageWebhookEvent = (FileStorageWebhookEvent) o;
    return Objects.equals(this.consumerId, fileStorageWebhookEvent.consumerId) &&
        Objects.equals(this.entityId, fileStorageWebhookEvent.entityId) &&
        Objects.equals(this.entityType, fileStorageWebhookEvent.entityType) &&
        Objects.equals(this.entityUrl, fileStorageWebhookEvent.entityUrl) &&
        Objects.equals(this.eventId, fileStorageWebhookEvent.eventId) &&
        Objects.equals(this.executionAttempt, fileStorageWebhookEvent.executionAttempt) &&
        Objects.equals(this.occurredAt, fileStorageWebhookEvent.occurredAt) &&
        Objects.equals(this.serviceId, fileStorageWebhookEvent.serviceId) &&
        Objects.equals(this.unifiedApi, fileStorageWebhookEvent.unifiedApi) &&
        Objects.equals(this.eventType, fileStorageWebhookEvent.eventType);
  }
  ...
  public String toString() {
    ...
    sb.append("class FileStorageWebhookEvent {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FileStorageWebhookEvent
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FileStorageWebhookEvent.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FileStorageWebhookEvent is not found in the empty JSON string", FileStorageWebhookEvent.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FileStorageWebhookEvent.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FileStorageWebhookEvent` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FileStorageWebhookEvent.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FileStorageWebhookEvent' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FileStorageWebhookEvent> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FileStorageWebhookEvent.class));

       return (TypeAdapter<T>) new TypeAdapter<FileStorageWebhookEvent>() {
           @Override
           public void write(JsonWriter out, FileStorageWebhookEvent value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FileStorageWebhookEvent read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FileStorageWebhookEvent given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FileStorageWebhookEvent
   * @throws IOException if the JSON string is invalid with respect to FileStorageWebhookEvent
   */
  public static FileStorageWebhookEvent fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FileStorageWebhookEvent.class);
  }

  /**
   * Convert an instance of FileStorageWebhookEvent to an JSON string
   *
   * @return JSON string
   */
