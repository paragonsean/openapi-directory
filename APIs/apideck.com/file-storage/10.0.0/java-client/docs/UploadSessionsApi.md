...
<a id="uploadSessionsAdd"></a>
# **uploadSessionsAdd**
> CreateUploadSessionResponse uploadSessionsAdd(xApideckConsumerId, xApideckAppId, createUploadSessionRequest, raw, xApideckServiceId)
...
import org.openapitools.client.api.UploadSessionsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    UploadSessionsApi apiInstance = new UploadSessionsApi(defaultClient);
    ...
    CreateUploadSessionRequest createUploadSessionRequest = new CreateUploadSessionRequest(); // CreateUploadSessionRequest | 
    ...
    try {
      ...
      System.err.println("Exception when calling UploadSessionsApi#uploadSessionsAdd");
...
<a id="uploadSessionsDelete"></a>
# **uploadSessionsDelete**
> DeleteUploadSessionResponse uploadSessionsDelete(id, xApideckConsumerId, xApideckAppId, xApideckServiceId, raw)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling UploadSessionsApi#uploadSessionsDelete");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="uploadSessionsFinish"></a>
# **uploadSessionsFinish**
> GetFileResponse uploadSessionsFinish(id, xApideckConsumerId, xApideckAppId, raw, xApideckServiceId, digest, body)
...
public class Example {
  public static void main(String[] args) {
    ...
    Boolean raw = false; // Boolean | Include raw response. Mostly used for debugging purposes
    String xApideckServiceId = "xApideckServiceId_example"; // String | Provide the service id you want to call (e.g., pipedrive). Only needed when a consumer has activated multiple integrations for a Unified API.
    String digest = "sha=fpRyg5eVQletdZqEKaFlqwBXJzM="; // String | The RFC3230 message digest of the uploaded part. Only required for the Box connector. More information on the Box API docs [here](https://developer.box.com/reference/put-files-upload-sessions-id/#param-digest)
    Object body = null; // Object | 
    try {
      GetFileResponse result = apiInstance.uploadSessionsFinish(id, xApideckConsumerId, xApideckAppId, raw, xApideckServiceId, digest, body);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling UploadSessionsApi#uploadSessionsFinish");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="uploadSessionsOne"></a>
# **uploadSessionsOne**
> GetUploadSessionResponse uploadSessionsOne(id, xApideckConsumerId, xApideckAppId, xApideckServiceId, raw, fields)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      GetUploadSessionResponse result = apiInstance.uploadSessionsOne(id, xApideckConsumerId, xApideckAppId, xApideckServiceId, raw, fields);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling UploadSessionsApi#uploadSessionsOne");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="uploadSessionsUpload"></a>
# **uploadSessionsUpload**
> UpdateUploadSessionResponse uploadSessionsUpload(id, xApideckConsumerId, xApideckAppId, partNumber, body, xApideckServiceId, digest, raw)
...
public class Example {
  public static void main(String[] args) {
    ...
    String xApideckConsumerId = "xApideckConsumerId_example"; // String | ID of the consumer which you want to get or push data from
    String xApideckAppId = "dSBdXd2H6Mqwfg0atXHXYcysLJE9qyn1VwBtXHX"; // String | The ID of your Unify application
    BigDecimal partNumber = new BigDecimal("0"); // BigDecimal | Part number of the file part being uploaded.
    File body = new File("/path/to/file"); // File | 
    String xApideckServiceId = "xApideckServiceId_example"; // String | Provide the service id you want to call (e.g., pipedrive). Only needed when a consumer has activated multiple integrations for a Unified API.
    String digest = "sha=fpRyg5eVQletdZqEKaFlqwBXJzM="; // String | The RFC3230 message digest of the uploaded part. Only required for the Box connector. More information on the Box API docs [here](https://developer.box.com/reference/put-files-upload-sessions-id/#param-digest)
    Boolean raw = false; // Boolean | Include raw response. Mostly used for debugging purposes
    try {
      UpdateUploadSessionResponse result = apiInstance.uploadSessionsUpload(id, xApideckConsumerId, xApideckAppId, partNumber, body, xApideckServiceId, digest, raw);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling UploadSessionsApi#uploadSessionsUpload");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| **xApideckConsumerId** | **String**| ID of the consumer which you want to get or push data from | |
| **xApideckAppId** | **String**| The ID of your Unify application | |
| **partNumber** | **BigDecimal**| Part number of the file part being uploaded. | |
| **body** | **File**|  | |
| **xApideckServiceId** | **String**| Provide the service id you want to call (e.g., pipedrive). Only needed when a consumer has activated multiple integrations for a Unified API. | [optional] |
| **digest** | **String**| The RFC3230 message digest of the uploaded part. Only required for the Box connector. More information on the Box API docs [here](https://developer.box.com/reference/put-files-upload-sessions-id/#param-digest) | [optional] |
| **raw** | **Boolean**| Include raw response. Mostly used for debugging purposes | [optional] [default to false] |
