...
# **driveGroupsAll**
> GetDriveGroupsResponse driveGroupsAll(xApideckConsumerId, xApideckAppId, raw, xApideckServiceId, cursor, limit, filter, passThrough, fields)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      GetDriveGroupsResponse result = apiInstance.driveGroupsAll(xApideckConsumerId, xApideckAppId, raw, xApideckServiceId, cursor, limit, filter, passThrough, fields);
      System.out.println(result);
    } catch (ApiException e) {
