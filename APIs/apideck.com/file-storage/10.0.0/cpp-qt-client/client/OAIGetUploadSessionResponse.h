...
/*
 * OAIGetUploadSessionResponse.h
 *
 * 
 */

#ifndef OAIGetUploadSessionResponse_H
#define OAIGetUploadSessionResponse_H
...
namespace OpenAPI {
class OAIUploadSession;

class OAIGetUploadSessionResponse : public OAIObject {
public:
    OAIGetUploadSessionResponse();
    OAIGetUploadSessionResponse(QString json);
    ~OAIGetUploadSessionResponse() override;
    ...
    OAIUploadSession getData() const;
    void setData(const OAIUploadSession &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetUploadSessionResponse)

#endif // OAIGetUploadSessionResponse_H
