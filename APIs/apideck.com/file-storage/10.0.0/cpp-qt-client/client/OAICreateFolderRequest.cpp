...
QString OAICreateFolderRequest::getDescription() const {
    return m_description;
}
void OAICreateFolderRequest::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAICreateFolderRequest::is_description_Set() const{
    return m_description_isSet;
}

bool OAICreateFolderRequest::is_description_Valid() const{
    return m_description_isValid;
}

QString OAICreateFolderRequest::getDriveId() const {
    return m_drive_id;
}
void OAICreateFolderRequest::setDriveId(const QString &drive_id) {
    m_drive_id = drive_id;
    m_drive_id_isSet = true;
}

bool OAICreateFolderRequest::is_drive_id_Set() const{
    return m_drive_id_isSet;
}

bool OAICreateFolderRequest::is_drive_id_Valid() const{
    return m_drive_id_isValid;
}

QString OAICreateFolderRequest::getId() const {
    return m_id;
}
void OAICreateFolderRequest::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAICreateFolderRequest::is_id_Set() const{
    return m_id_isSet;
}

bool OAICreateFolderRequest::is_id_Valid() const{
    return m_id_isValid;
}
...
QString OAICreateFolderRequest::getParentFolderId() const {
    return m_parent_folder_id;
}
void OAICreateFolderRequest::setParentFolderId(const QString &parent_folder_id) {
    m_parent_folder_id = parent_folder_id;
    m_parent_folder_id_isSet = true;
}

bool OAICreateFolderRequest::is_parent_folder_id_Set() const{
    return m_parent_folder_id_isSet;
}

bool OAICreateFolderRequest::is_parent_folder_id_Valid() const{
...
bool OAICreateFolderRequest::isValid() const {
    ...
    return m_name_isValid && m_parent_folder_id_isValid && true;
}
