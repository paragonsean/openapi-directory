...
/*
 * OAIDeleteDriveGroupResponse.h
 *
 * 
 */

#ifndef OAIDeleteDriveGroupResponse_H
#define OAIDeleteDriveGroupResponse_H
...
class OAIDeleteDriveGroupResponse : public OAIObject {
public:
    OAIDeleteDriveGroupResponse();
    OAIDeleteDriveGroupResponse(QString json);
    ~OAIDeleteDriveGroupResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteDriveGroupResponse)

#endif // OAIDeleteDriveGroupResponse_H
