...
/*
 * OAIDeleteFolderResponse.h
 *
 * 
 */

#ifndef OAIDeleteFolderResponse_H
#define OAIDeleteFolderResponse_H
...
class OAIDeleteFolderResponse : public OAIObject {
public:
    OAIDeleteFolderResponse();
    OAIDeleteFolderResponse(QString json);
    ~OAIDeleteFolderResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteFolderResponse)

#endif // OAIDeleteFolderResponse_H
