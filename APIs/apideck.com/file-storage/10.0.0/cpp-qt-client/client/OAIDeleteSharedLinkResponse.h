...
/*
 * OAIDeleteSharedLinkResponse.h
 *
 * 
 */

#ifndef OAIDeleteSharedLinkResponse_H
#define OAIDeleteSharedLinkResponse_H
...
class OAIDeleteSharedLinkResponse : public OAIObject {
public:
    OAIDeleteSharedLinkResponse();
    OAIDeleteSharedLinkResponse(QString json);
    ~OAIDeleteSharedLinkResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteSharedLinkResponse)

#endif // OAIDeleteSharedLinkResponse_H
