...
/*
 * OAIGetDrivesResponse.h
 *
 * 
 */

#ifndef OAIGetDrivesResponse_H
#define OAIGetDrivesResponse_H
...
class OAIGetDrivesResponse : public OAIObject {
public:
    OAIGetDrivesResponse();
    OAIGetDrivesResponse(QString json);
    ~OAIGetDrivesResponse() override;
    ...
    QList<OAIDrive> getData() const;
    void setData(const QList<OAIDrive> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetDrivesResponse)

#endif // OAIGetDrivesResponse_H
