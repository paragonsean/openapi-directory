...
/*
 * OAIUpdateFileResponse.h
 *
 * 
 */

#ifndef OAIUpdateFileResponse_H
#define OAIUpdateFileResponse_H
...
class OAIUpdateFileResponse : public OAIObject {
public:
    OAIUpdateFileResponse();
    OAIUpdateFileResponse(QString json);
    ~OAIUpdateFileResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateFileResponse)

#endif // OAIUpdateFileResponse_H
