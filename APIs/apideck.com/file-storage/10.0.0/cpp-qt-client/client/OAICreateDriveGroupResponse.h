...
/*
 * OAICreateDriveGroupResponse.h
 *
 * 
 */

#ifndef OAICreateDriveGroupResponse_H
#define OAICreateDriveGroupResponse_H
...
class OAICreateDriveGroupResponse : public OAIObject {
public:
    OAICreateDriveGroupResponse();
    OAICreateDriveGroupResponse(QString json);
    ~OAICreateDriveGroupResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateDriveGroupResponse)

#endif // OAICreateDriveGroupResponse_H
