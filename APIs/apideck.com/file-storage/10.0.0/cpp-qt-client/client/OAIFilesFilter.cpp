...
OAIFilesFilter::OAIFilesFilter(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFilesFilter::OAIFilesFilter() {
    this->initializeModel();
}

OAIFilesFilter::~OAIFilesFilter() {}

void OAIFilesFilter::initializeModel() {
...
void OAIFilesFilter::fromJson(QString jsonString) {
...
void OAIFilesFilter::fromJsonObject(QJsonObject json) {
...
QString OAIFilesFilter::asJson() const {
...
QJsonObject OAIFilesFilter::asJsonObject() const {
    QJsonObject obj;
    if (m_drive_id_isSet) {
...
QString OAIFilesFilter::getDriveId() const {
    return m_drive_id;
}
void OAIFilesFilter::setDriveId(const QString &drive_id) {
    m_drive_id = drive_id;
    m_drive_id_isSet = true;
}

bool OAIFilesFilter::is_drive_id_Set() const{
    return m_drive_id_isSet;
}

bool OAIFilesFilter::is_drive_id_Valid() const{
    return m_drive_id_isValid;
}

QString OAIFilesFilter::getFolderId() const {
    return m_folder_id;
}
void OAIFilesFilter::setFolderId(const QString &folder_id) {
    m_folder_id = folder_id;
    m_folder_id_isSet = true;
}

bool OAIFilesFilter::is_folder_id_Set() const{
    return m_folder_id_isSet;
}

bool OAIFilesFilter::is_folder_id_Valid() const{
    return m_folder_id_isValid;
}

bool OAIFilesFilter::isShared() const {
    return m_shared;
}
void OAIFilesFilter::setShared(const bool &shared) {
    m_shared = shared;
    m_shared_isSet = true;
}

bool OAIFilesFilter::is_shared_Set() const{
    return m_shared_isSet;
}

bool OAIFilesFilter::is_shared_Valid() const{
    return m_shared_isValid;
}

bool OAIFilesFilter::isSet() const {
...
bool OAIFilesFilter::isValid() const {
