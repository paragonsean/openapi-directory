...
/*
 * OAIGetFoldersResponse.h
 *
 * 
 */

#ifndef OAIGetFoldersResponse_H
#define OAIGetFoldersResponse_H
...
class OAIGetFoldersResponse : public OAIObject {
public:
    OAIGetFoldersResponse();
    OAIGetFoldersResponse(QString json);
    ~OAIGetFoldersResponse() override;
    ...
    QList<OAIFolder> getData() const;
    void setData(const QList<OAIFolder> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetFoldersResponse)

#endif // OAIGetFoldersResponse_H
