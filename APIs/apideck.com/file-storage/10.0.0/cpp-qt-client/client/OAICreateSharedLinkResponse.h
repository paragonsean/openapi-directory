...
/*
 * OAICreateSharedLinkResponse.h
 *
 * 
 */

#ifndef OAICreateSharedLinkResponse_H
#define OAICreateSharedLinkResponse_H
...
class OAICreateSharedLinkResponse : public OAIObject {
public:
    OAICreateSharedLinkResponse();
    OAICreateSharedLinkResponse(QString json);
    ~OAICreateSharedLinkResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateSharedLinkResponse)

#endif // OAICreateSharedLinkResponse_H
