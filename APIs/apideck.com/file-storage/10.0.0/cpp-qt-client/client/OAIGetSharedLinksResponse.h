...
/*
 * OAIGetSharedLinksResponse.h
 *
 * 
 */

#ifndef OAIGetSharedLinksResponse_H
#define OAIGetSharedLinksResponse_H
...
class OAIGetSharedLinksResponse : public OAIObject {
public:
    OAIGetSharedLinksResponse();
    OAIGetSharedLinksResponse(QString json);
    ~OAIGetSharedLinksResponse() override;
    ...
    QList<OAISharedLink> getData() const;
    void setData(const QList<OAISharedLink> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetSharedLinksResponse)

#endif // OAIGetSharedLinksResponse_H
