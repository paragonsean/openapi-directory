...
/*
 * OAICreateFileResponse.h
 *
 * 
 */

#ifndef OAICreateFileResponse_H
#define OAICreateFileResponse_H
...
class OAICreateFileResponse : public OAIObject {
public:
    OAICreateFileResponse();
    OAICreateFileResponse(QString json);
    ~OAICreateFileResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateFileResponse)

#endif // OAICreateFileResponse_H
