...
/*
 * OAICreateUploadSessionResponse.h
 *
 * 
 */

#ifndef OAICreateUploadSessionResponse_H
#define OAICreateUploadSessionResponse_H
...
class OAICreateUploadSessionResponse : public OAIObject {
public:
    OAICreateUploadSessionResponse();
    OAICreateUploadSessionResponse(QString json);
    ~OAICreateUploadSessionResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateUploadSessionResponse)

#endif // OAICreateUploadSessionResponse_H
