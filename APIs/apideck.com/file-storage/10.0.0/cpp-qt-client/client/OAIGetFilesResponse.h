...
/*
 * OAIGetFilesResponse.h
 *
 * 
 */

#ifndef OAIGetFilesResponse_H
#define OAIGetFilesResponse_H
...
namespace OpenAPI {
class OAIUnifiedFile;
class OAILinks;
class OAIMeta;

class OAIGetFilesResponse : public OAIObject {
public:
    OAIGetFilesResponse();
    OAIGetFilesResponse(QString json);
    ~OAIGetFilesResponse() override;
    ...
    QList<OAIUnifiedFile> getData() const;
    void setData(const QList<OAIUnifiedFile> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetFilesResponse)

#endif // OAIGetFilesResponse_H
