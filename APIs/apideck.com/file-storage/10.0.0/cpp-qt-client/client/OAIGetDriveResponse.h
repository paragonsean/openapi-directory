...
/*
 * OAIGetDriveResponse.h
 *
 * 
 */

#ifndef OAIGetDriveResponse_H
#define OAIGetDriveResponse_H
...
class OAIGetDriveResponse : public OAIObject {
public:
    OAIGetDriveResponse();
    OAIGetDriveResponse(QString json);
    ~OAIGetDriveResponse() override;
    ...
    OAIDrive getData() const;
    void setData(const OAIDrive &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetDriveResponse)

#endif // OAIGetDriveResponse_H
