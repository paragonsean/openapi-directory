...
/*
 * OAIUpdateUploadSessionResponse.h
 *
 * 
 */

#ifndef OAIUpdateUploadSessionResponse_H
#define OAIUpdateUploadSessionResponse_H
...
class OAIUpdateUploadSessionResponse : public OAIObject {
public:
    OAIUpdateUploadSessionResponse();
    OAIUpdateUploadSessionResponse(QString json);
    ~OAIUpdateUploadSessionResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateUploadSessionResponse)

#endif // OAIUpdateUploadSessionResponse_H
