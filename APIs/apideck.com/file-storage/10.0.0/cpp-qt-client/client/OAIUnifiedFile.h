...
#ifndef OAIUnifiedFile_H
#define OAIUnifiedFile_H

#include <QJsonObject>

#include "OAIFileType.h"
#include "OAILinkedFolder.h"
#include "OAIObject.h"
#include "OAIOwner.h"
#include "OAIUnifiedFile_permissions.h"
#include <QDateTime>
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAIOwner;
class OAILinkedFolder;
class OAIUnifiedFile_permissions;

class OAIUnifiedFile : public OAIObject {
public:
    OAIUnifiedFile();
    OAIUnifiedFile(QString json);
    ~OAIUnifiedFile() override;
    ...
    QList<QString> getExportFormats() const;
    void setExportFormats(const QList<QString> &export_formats);
    ...
    QList<OAILinkedFolder> getParentFolders() const;
    void setParentFolders(const QList<OAILinkedFolder> &parent_folders);
    bool is_parent_folders_Set() const;
    bool is_parent_folders_Valid() const;

    bool isParentFoldersComplete() const;
    void setParentFoldersComplete(const bool &parent_folders_complete);
    bool is_parent_folders_complete_Set() const;
    bool is_parent_folders_complete_Valid() const;
    ...
    OAIUnifiedFile_permissions getPermissions() const;
    void setPermissions(const OAIUnifiedFile_permissions &permissions);
    ...
    OAIFileType getType() const;
    void setType(const OAIFileType &type);
...
private:
    ...
    QList<QString> m_export_formats;
    ...
    QList<OAILinkedFolder> m_parent_folders;
    bool m_parent_folders_isSet;
    bool m_parent_folders_isValid;

    bool m_parent_folders_complete;
    bool m_parent_folders_complete_isSet;
    bool m_parent_folders_complete_isValid;

    QString m_path;
    bool m_path_isSet;
    bool m_path_isValid;

    OAIUnifiedFile_permissions m_permissions;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUnifiedFile)

#endif // OAIUnifiedFile_H
