...
/*
 * OAIGetFolderResponse.h
 *
 * 
 */

#ifndef OAIGetFolderResponse_H
#define OAIGetFolderResponse_H
...
class OAIGetFolderResponse : public OAIObject {
public:
    OAIGetFolderResponse();
    OAIGetFolderResponse(QString json);
    ~OAIGetFolderResponse() override;
    ...
    OAIFolder getData() const;
    void setData(const OAIFolder &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetFolderResponse)

#endif // OAIGetFolderResponse_H
