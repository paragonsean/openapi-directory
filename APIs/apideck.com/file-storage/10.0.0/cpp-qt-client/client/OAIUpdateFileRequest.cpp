...
QString OAIUpdateFileRequest::getDescription() const {
    return m_description;
}
void OAIUpdateFileRequest::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIUpdateFileRequest::is_description_Set() const{
    return m_description_isSet;
}

bool OAIUpdateFileRequest::is_description_Valid() const{
...
QString OAIUpdateFileRequest::getParentFolderId() const {
    return m_parent_folder_id;
}
void OAIUpdateFileRequest::setParentFolderId(const QString &parent_folder_id) {
    m_parent_folder_id = parent_folder_id;
    m_parent_folder_id_isSet = true;
}

bool OAIUpdateFileRequest::is_parent_folder_id_Set() const{
    return m_parent_folder_id_isSet;
}

bool OAIUpdateFileRequest::is_parent_folder_id_Valid() const{
