...
/*
 * OAIGetDriveGroupsResponse.h
 *
 * 
 */

#ifndef OAIGetDriveGroupsResponse_H
#define OAIGetDriveGroupsResponse_H
...
class OAIGetDriveGroupsResponse : public OAIObject {
public:
    OAIGetDriveGroupsResponse();
    OAIGetDriveGroupsResponse(QString json);
    ~OAIGetDriveGroupsResponse() override;
    ...
    QList<OAIDriveGroup> getData() const;
    void setData(const QList<OAIDriveGroup> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetDriveGroupsResponse)

#endif // OAIGetDriveGroupsResponse_H
