...
/*
 * OAICreateFolderResponse.h
 *
 * 
 */

#ifndef OAICreateFolderResponse_H
#define OAICreateFolderResponse_H
...
class OAICreateFolderResponse : public OAIObject {
public:
    OAICreateFolderResponse();
    OAICreateFolderResponse(QString json);
    ~OAICreateFolderResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateFolderResponse)

#endif // OAICreateFolderResponse_H
