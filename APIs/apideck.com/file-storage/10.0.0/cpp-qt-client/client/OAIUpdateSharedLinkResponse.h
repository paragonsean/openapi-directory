...
/*
 * OAIUpdateSharedLinkResponse.h
 *
 * 
 */

#ifndef OAIUpdateSharedLinkResponse_H
#define OAIUpdateSharedLinkResponse_H
...
class OAIUpdateSharedLinkResponse : public OAIObject {
public:
    OAIUpdateSharedLinkResponse();
    OAIUpdateSharedLinkResponse(QString json);
    ~OAIUpdateSharedLinkResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateSharedLinkResponse)

#endif // OAIUpdateSharedLinkResponse_H
