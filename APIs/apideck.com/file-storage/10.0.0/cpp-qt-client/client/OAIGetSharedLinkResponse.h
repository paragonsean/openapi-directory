...
/*
 * OAIGetSharedLinkResponse.h
 *
 * 
 */

#ifndef OAIGetSharedLinkResponse_H
#define OAIGetSharedLinkResponse_H
...
class OAIGetSharedLinkResponse : public OAIObject {
public:
    OAIGetSharedLinkResponse();
    OAIGetSharedLinkResponse(QString json);
    ~OAIGetSharedLinkResponse() override;
    ...
    OAISharedLink getData() const;
    void setData(const OAISharedLink &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetSharedLinkResponse)

#endif // OAIGetSharedLinkResponse_H
