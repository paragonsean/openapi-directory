...
/*
 * OAIFileStorageWebhookEvent.h
 *
 * 
 */

#ifndef OAIFileStorageWebhookEvent_H
#define OAIFileStorageWebhookEvent_H
...
class OAIFileStorageWebhookEvent : public OAIObject {
public:
    OAIFileStorageWebhookEvent();
    OAIFileStorageWebhookEvent(QString json);
    ~OAIFileStorageWebhookEvent() override;
    ...
    OAIFileStorageEventType getEventType() const;
    void setEventType(const OAIFileStorageEventType &event_type);
...
private:
    ...
    OAIFileStorageEventType m_event_type;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFileStorageWebhookEvent)

#endif // OAIFileStorageWebhookEvent_H
