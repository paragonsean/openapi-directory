...
QDateTime OAIDrive::getCreatedAt() const {
    return m_created_at;
}
void OAIDrive::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIDrive::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIDrive::is_created_at_Valid() const{
    return m_created_at_isValid;
}

QString OAIDrive::getCreatedBy() const {
    return m_created_by;
}
void OAIDrive::setCreatedBy(const QString &created_by) {
...
OAIObject OAIDrive::getCustomMappings() const {
    return m_custom_mappings;
}
void OAIDrive::setCustomMappings(const OAIObject &custom_mappings) {
    m_custom_mappings = custom_mappings;
    m_custom_mappings_isSet = true;
}

bool OAIDrive::is_custom_mappings_Set() const{
    return m_custom_mappings_isSet;
}

bool OAIDrive::is_custom_mappings_Valid() const{
...
QDateTime OAIDrive::getUpdatedAt() const {
    return m_updated_at;
}
void OAIDrive::setUpdatedAt(const QDateTime &updated_at) {
    m_updated_at = updated_at;
    m_updated_at_isSet = true;
}

bool OAIDrive::is_updated_at_Set() const{
    return m_updated_at_isSet;
}

bool OAIDrive::is_updated_at_Valid() const{
    return m_updated_at_isValid;
}

QString OAIDrive::getUpdatedBy() const {
    return m_updated_by;
}
void OAIDrive::setUpdatedBy(const QString &updated_by) {
    m_updated_by = updated_by;
    m_updated_by_isSet = true;
}

bool OAIDrive::is_updated_by_Set() const{
    return m_updated_by_isSet;
}

bool OAIDrive::is_updated_by_Valid() const{
