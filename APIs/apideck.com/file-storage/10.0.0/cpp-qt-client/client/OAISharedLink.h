...
#ifndef OAISharedLink_H
#define OAISharedLink_H
...
namespace OpenAPI {
class OAISharedLinkTarget;

class OAISharedLink : public OAIObject {
public:
    OAISharedLink();
    OAISharedLink(QString json);
    ~OAISharedLink() override;
    ...
    OAISharedLinkTarget getTarget() const;
    void setTarget(const OAISharedLinkTarget &target);
...
Q_DECLARE_METATYPE(OpenAPI::OAISharedLink)

#endif // OAISharedLink_H
