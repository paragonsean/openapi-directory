...
/*
 * OAIDeleteDriveResponse.h
 *
 * 
 */

#ifndef OAIDeleteDriveResponse_H
#define OAIDeleteDriveResponse_H
...
class OAIDeleteDriveResponse : public OAIObject {
public:
    OAIDeleteDriveResponse();
    OAIDeleteDriveResponse(QString json);
    ~OAIDeleteDriveResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteDriveResponse)

#endif // OAIDeleteDriveResponse_H
