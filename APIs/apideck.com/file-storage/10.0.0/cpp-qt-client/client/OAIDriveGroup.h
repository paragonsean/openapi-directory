...
#ifndef OAIDriveGroup_H
#define OAIDriveGroup_H
...
class OAIDriveGroup : public OAIObject {
public:
    OAIDriveGroup();
    OAIDriveGroup(QString json);
    ~OAIDriveGroup() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDriveGroup)

#endif // OAIDriveGroup_H
