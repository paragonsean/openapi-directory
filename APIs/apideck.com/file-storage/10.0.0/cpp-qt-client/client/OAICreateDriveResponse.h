...
/*
 * OAICreateDriveResponse.h
 *
 * 
 */

#ifndef OAICreateDriveResponse_H
#define OAICreateDriveResponse_H
...
class OAICreateDriveResponse : public OAIObject {
public:
    OAICreateDriveResponse();
    OAICreateDriveResponse(QString json);
    ~OAICreateDriveResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateDriveResponse)

#endif // OAICreateDriveResponse_H
