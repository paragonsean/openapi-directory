...
/*
 * OAIGetDriveGroupResponse.h
 *
 * 
 */

#ifndef OAIGetDriveGroupResponse_H
#define OAIGetDriveGroupResponse_H
...
class OAIGetDriveGroupResponse : public OAIObject {
public:
    OAIGetDriveGroupResponse();
    OAIGetDriveGroupResponse(QString json);
    ~OAIGetDriveGroupResponse() override;
    ...
    OAIDriveGroup getData() const;
    void setData(const OAIDriveGroup &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetDriveGroupResponse)

#endif // OAIGetDriveGroupResponse_H
