...
/*
 * OAIDeleteUploadSessionResponse.h
 *
 * 
 */

#ifndef OAIDeleteUploadSessionResponse_H
#define OAIDeleteUploadSessionResponse_H
...
class OAIDeleteUploadSessionResponse : public OAIObject {
public:
    OAIDeleteUploadSessionResponse();
    OAIDeleteUploadSessionResponse(QString json);
    ~OAIDeleteUploadSessionResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteUploadSessionResponse)

#endif // OAIDeleteUploadSessionResponse_H
