...
/*
 * OAIUpdateDriveGroupResponse.h
 *
 * 
 */

#ifndef OAIUpdateDriveGroupResponse_H
#define OAIUpdateDriveGroupResponse_H
...
class OAIUpdateDriveGroupResponse : public OAIObject {
public:
    OAIUpdateDriveGroupResponse();
    OAIUpdateDriveGroupResponse(QString json);
    ~OAIUpdateDriveGroupResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateDriveGroupResponse)

#endif // OAIUpdateDriveGroupResponse_H
