...
/*
 * OAIUpdateDriveResponse.h
 *
 * 
 */

#ifndef OAIUpdateDriveResponse_H
#define OAIUpdateDriveResponse_H
...
class OAIUpdateDriveResponse : public OAIObject {
public:
    OAIUpdateDriveResponse();
    OAIUpdateDriveResponse(QString json);
    ~OAIUpdateDriveResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateDriveResponse)

#endif // OAIUpdateDriveResponse_H
