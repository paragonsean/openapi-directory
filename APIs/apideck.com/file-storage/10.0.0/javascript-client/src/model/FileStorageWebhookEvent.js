...
import FileStorageEventType from './FileStorageEventType';

/**
 * The FileStorageWebhookEvent model module.
 * @module model/FileStorageWebhookEvent
 * @version 10.0.0
 */
class FileStorageWebhookEvent {
    /**
     * Constructs a new <code>FileStorageWebhookEvent</code>.
     * @alias module:model/FileStorageWebhookEvent
     */
    constructor() { 
        
        FileStorageWebhookEvent.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FileStorageWebhookEvent</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FileStorageWebhookEvent} obj Optional instance to populate.
     * @return {module:model/FileStorageWebhookEvent} The populated <code>FileStorageWebhookEvent</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FileStorageWebhookEvent();
            ...
            if (data.hasOwnProperty('event_type')) {
                obj['event_type'] = FileStorageEventType.constructFromObject(data['event_type']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>FileStorageWebhookEvent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FileStorageWebhookEvent</code>.
     */
 ...
 */
FileStorageWebhookEvent.prototype['consumer_id'] = undefined;

/**
 * The service provider's ID of the entity that triggered this event
 * @member {String} entity_id
 */
FileStorageWebhookEvent.prototype['entity_id'] = undefined;

/**
 * The type entity that triggered this event
 * @member {String} entity_type
 */
FileStorageWebhookEvent.prototype['entity_type'] = undefined;

/**
 * The url to retrieve entity detail.
 * @member {String} entity_url
 */
FileStorageWebhookEvent.prototype['entity_url'] = undefined;

/**
 * Unique reference to this request event
 * @member {String} event_id
 */
FileStorageWebhookEvent.prototype['event_id'] = undefined;

/**
 * The current count this request event has been attempted
 * @member {Number} execution_attempt
 */
FileStorageWebhookEvent.prototype['execution_attempt'] = undefined;

/**
 * ISO Datetime for when the original event occurred
 * @member {String} occurred_at
 */
FileStorageWebhookEvent.prototype['occurred_at'] = undefined;

/**
 * Service provider identifier
 * @member {String} service_id
 */
FileStorageWebhookEvent.prototype['service_id'] = undefined;

/**
 * Name of Apideck Unified API
 * @member {module:model/FileStorageWebhookEvent.UnifiedApiEnum} unified_api
 */
FileStorageWebhookEvent.prototype['unified_api'] = undefined;

/**
 * @member {module:model/FileStorageEventType} event_type
 */
FileStorageWebhookEvent.prototype['event_type'] = undefined;
 ...
 * @readonly
 */
FileStorageWebhookEvent['UnifiedApiEnum'] = {
...
export default FileStorageWebhookEvent;
