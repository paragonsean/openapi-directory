...
class GetFilesResponse {
     ...
     * @param data {Array.<module:model/UnifiedFile>} 
    ...
    constructor(data, operation, resource, service, status, statusCode) { 
        ...
        GetFilesResponse.initialize(this, data, operation, resource, service, status, statusCode);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [UnifiedFile]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GetFilesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetFilesResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetFilesResponse.RequiredProperties) {
...
GetFilesResponse.RequiredProperties = ["data", "operation", "resource", "service", "status", "status_code"];

/**
 * @member {Array.<module:model/UnifiedFile>} data
 */
 ...
 */
GetFilesResponse.prototype['links'] = undefined;
 ...
 */
GetFilesResponse.prototype['operation'] = undefined;

/**
 * Unified API resource name
 * @member {String} resource
 */
GetFilesResponse.prototype['resource'] = undefined;

/**
 * Apideck ID of service provider
 * @member {String} service
 */
GetFilesResponse.prototype['service'] = undefined;
 ...
 */
GetFilesResponse.prototype['status_code'] = undefined;
