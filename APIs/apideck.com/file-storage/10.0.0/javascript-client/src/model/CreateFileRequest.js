...
class CreateFileRequest {
    ...
    constructor(name, parentFolderId) { 
        ...
        CreateFileRequest.initialize(this, name, parentFolderId);
    }
...
CreateFileRequest.RequiredProperties = ["name", "parent_folder_id"];

/**
 * Optional description of the file.
 * @member {String} description
 */
CreateFileRequest.prototype['description'] = undefined;

/**
 * ID of the drive to upload to.
 * @member {String} drive_id
 */
CreateFileRequest.prototype['drive_id'] = undefined;

/**
 * The name of the file.
 * @member {String} name
 */
CreateFileRequest.prototype['name'] = undefined;

/**
 * The parent folder to create the new file within.
 * @member {String} parent_folder_id
 */
CreateFileRequest.prototype['parent_folder_id'] = undefined;
