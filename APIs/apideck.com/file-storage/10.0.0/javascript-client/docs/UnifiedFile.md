...
**exportFormats** | **[String]** | The available file formats when exporting this file. | [optional] 
...
**parentFolders** | [**[LinkedFolder]**](LinkedFolder.md) | The parent folders of the file, starting from the root | [optional] 
