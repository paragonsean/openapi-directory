...
**parentFolders** | [**[LinkedFolder]**](LinkedFolder.md) | The parent folders of the file, starting from the root | 
...
**size** | **Number** | The size of the folder in bytes | [optional] [readonly] 
