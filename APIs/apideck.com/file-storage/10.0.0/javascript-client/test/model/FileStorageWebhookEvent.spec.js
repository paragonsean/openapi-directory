...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FileStorageApi.FileStorageWebhookEvent();
  });
  ...
  describe('FileStorageWebhookEvent', function() {
    it('should create an instance of FileStorageWebhookEvent', function() {
      // uncomment below and update the code to test FileStorageWebhookEvent
      //var instance = new FileStorageApi.FileStorageWebhookEvent();
      //expect(instance).to.be.a(FileStorageApi.FileStorageWebhookEvent);
    });
