...
async def test_folders_add(client):
    """Test case for folders_add

    Create Folder
    """
    body = {"drive_id":"1234","parent_folder_id":"1234","name":"Documents","description":"My Personal Documents","id":"12345"}
    params = [('raw', False),
...
async def test_folders_copy(client):
    """Test case for folders_copy

    Copy Folder
    """
    body = {"parent_folder_id":"1234","name":"Documents","id":"12345"}
    params = [('raw', False),
                    ('fields', 'id,updated_at')]
    headers = { 
        'Accept': 'application/json',
    ...
    response = await client.request(
        method='POST',
        path='/file-storage/folders/{id}/copy'.format(id='id_example'),
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_folders_delete(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/file-storage/folders/{id}'.format(id='id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_folders_one(client):
...
async def test_folders_update(client):
    ...
    """
    body = {"parent_folder_id":"1234","name":"Documents","description":"My Personal Documents","id":"12345"}
    params = [('raw', False)]
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
