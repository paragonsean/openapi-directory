...
async def files_all(request: web.Request, x_apideck_consumer_id, x_apideck_app_id, raw=None, x_apideck_service_id=None, cursor=None, limit=None, filter=None, sort=None, pass_through=None, fields=None) -> web.Response:
    """List Files
...
async def files_delete(request: web.Request, id, x_apideck_consumer_id, x_apideck_app_id, x_apideck_service_id=None, raw=None) -> web.Response:
    """Delete File
...
async def files_download(request: web.Request, id, x_apideck_consumer_id, x_apideck_app_id, x_apideck_service_id=None, fields=None) -> web.Response:
    """Download File
...
async def files_export(request: web.Request, id, x_apideck_consumer_id, x_apideck_app_id, format, x_apideck_service_id=None, fields=None) -> web.Response:
    """Export File
...
async def files_one(request: web.Request, id, x_apideck_consumer_id, x_apideck_app_id, x_apideck_service_id=None, raw=None, fields=None) -> web.Response:
    """Get File
...
async def files_search(request: web.Request, x_apideck_consumer_id, x_apideck_app_id, body, x_apideck_service_id=None, pass_through=None, fields=None, cursor=None, limit=None) -> web.Response:
    """Search Files
    ...
    """
    body = FilesSearch.from_dict(body)
    return web.Response(status=200)


async def files_update(request: web.Request, id, x_apideck_consumer_id, x_apideck_app_id, body, x_apideck_service_id=None, raw=None) -> web.Response:
    """Rename or move File
...
async def files_upload(request: web.Request, x_apideck_metadata, x_apideck_consumer_id, x_apideck_app_id, raw=None, x_apideck_service_id=None, body=None) -> web.Response:
    """Upload file
    ...
    :param x_apideck_metadata: Metadata to attach to the file
    :type x_apideck_metadata: dict | bytes
    :param x_apideck_consumer_id: ID of the consumer which you want to get or push data from
    :type x_apideck_consumer_id: str
    :param x_apideck_app_id: The ID of your Unify application
    :type x_apideck_app_id: str
    ...
    """
    x_apideck_metadata = .from_dict(x_apideck_metadata)
    return web.Response(status=200)
