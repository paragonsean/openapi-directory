...
(function(root, factory) {
  ...
  describe('Message', function() {
    ...
    it('should have the property messagingServiceId (base name: "messaging_service_id")', function() {
      // uncomment below and update the code to test the property messagingServiceId
      //var instance = new SmsApi.Message();
      //expect(instance).to.be();
    });

    it('should have the property numberOfMediaFiles (base name: "number_of_media_files")', function() {
      // uncomment below and update the code to test the property numberOfMediaFiles
      //var instance = new SmsApi.Message();
      //expect(instance).to.be();
    });
