...
class Price {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('per_unit')) {
                obj['per_unit'] = ApiClient.convertToType(data['per_unit'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        if (data['per_unit'] && !(typeof data['per_unit'] === 'string' || data['per_unit'] instanceof String)) {
            throw new Error("Expected the field `per_unit` to be a primitive type in the JSON string but got " + data['per_unit']);
        }
        // ensure the json data is a string
...
/**
 * 
 * @member {String} per_unit
 */
Price.prototype['per_unit'] = undefined;

/**
 * 
 * @member {String} total_amount
 */
Price.prototype['total_amount'] = undefined;
