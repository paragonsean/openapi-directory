...
import TooManyRequestsResponseDetail from './TooManyRequestsResponseDetail';
...
class TooManyRequestsResponse {
    ...
    constructor() { 
        ...
        TooManyRequestsResponse.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('detail')) {
                obj['detail'] = TooManyRequestsResponseDetail.constructFromObject(data['detail']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>TooManyRequestsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TooManyRequestsResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `detail`
        if (data['detail']) { // data not null
          TooManyRequestsResponseDetail.validateJSON(data['detail']);
        }
...
/**
 * @member {module:model/TooManyRequestsResponseDetail} detail
 */
TooManyRequestsResponse.prototype['detail'] = undefined;
 ...
 */
TooManyRequestsResponse.prototype['message'] = undefined;

/**
 * Link to documentation of error type
 * @member {String} ref
 */
TooManyRequestsResponse.prototype['ref'] = undefined;

/**
 * HTTP status code
 * @member {Number} status_code
 */
TooManyRequestsResponse.prototype['status_code'] = undefined;

/**
 * The type of error returned
 * @member {String} type_name
 */
TooManyRequestsResponse.prototype['type_name'] = undefined;
...
export default TooManyRequestsResponse;
