...
> CreateMessageResponse messagesAdd(xApideckConsumerId, xApideckAppId, message, opts)
...
let defaultClient = SmsApi.ApiClient.instance;
...
let apiInstance = new SmsApi.MessagesApi();
...
let message = new SmsApi.Message(); // Message | 
let opts = {
...
apiInstance.messagesAdd(xApideckConsumerId, xApideckAppId, message, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> GetMessagesResponse messagesAll(xApideckConsumerId, xApideckAppId, opts)
...
apiInstance.messagesAll(xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> DeleteMessageResponse messagesDelete(id, xApideckConsumerId, xApideckAppId, opts)
...
apiInstance.messagesDelete(id, xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> GetMessageResponse messagesOne(id, xApideckConsumerId, xApideckAppId, opts)
...
apiInstance.messagesOne(id, xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> UpdateMessageResponse messagesUpdate(id, xApideckConsumerId, xApideckAppId, message, opts)
...
apiInstance.messagesUpdate(id, xApideckConsumerId, xApideckAppId, message, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
