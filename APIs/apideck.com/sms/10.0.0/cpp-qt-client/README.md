...
#include <iostream>
#include "../client/OAIMessagesApi.h"
...
void Example::exampleFunction1(){
     OAIMessagesApi apiInstance;
     
      // Configure API key authorization: apiKey
      apiInstance.setApiKey("YOUR API KEY NAME","YOUR API KEY");

      QEventLoop loop;
      connect(&apiInstance, &OAIMessagesApi::messagesAddSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIMessagesApi::messagesAddSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
      ...
      OAIMessage oai_message = create(); // OAIMessage | 
      ...
      apiInstance.messagesAdd(x_apideck_consumer_idx_apideck_app_idoai_messagerawx_apideck_service_id);
