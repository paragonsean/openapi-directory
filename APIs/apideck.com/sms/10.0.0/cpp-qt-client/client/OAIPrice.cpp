...
void OAIPrice::initializeModel() {
    ...
    m_per_unit_isSet = false;
    m_per_unit_isValid = false;
...
void OAIPrice::fromJsonObject(QJsonObject json) {
    ...
    m_per_unit_isValid = ::OpenAPI::fromJsonValue(m_per_unit, json[QString("per_unit")]);
    m_per_unit_isSet = !json[QString("per_unit")].isNull() && m_per_unit_isValid;
...
QJsonObject OAIPrice::asJsonObject() const {
    ...
    if (m_per_unit_isSet) {
        obj.insert(QString("per_unit"), ::OpenAPI::toJsonValue(m_per_unit));
    }
...
OAICurrency OAIPrice::getCurrency() const {
    return m_currency;
}
void OAIPrice::setCurrency(const OAICurrency &currency) {
    m_currency = currency;
...
QString OAIPrice::getPerUnit() const {
    return m_per_unit;
}
void OAIPrice::setPerUnit(const QString &per_unit) {
    m_per_unit = per_unit;
    m_per_unit_isSet = true;
}

bool OAIPrice::is_per_unit_Set() const{
    return m_per_unit_isSet;
}

bool OAIPrice::is_per_unit_Valid() const{
    return m_per_unit_isValid;
}

QString OAIPrice::getTotalAmount() const {
    return m_total_amount;
}
void OAIPrice::setTotalAmount(const QString &total_amount) {
    m_total_amount = total_amount;
    m_total_amount_isSet = true;
}

bool OAIPrice::is_total_amount_Set() const{
    return m_total_amount_isSet;
}

bool OAIPrice::is_total_amount_Valid() const{
