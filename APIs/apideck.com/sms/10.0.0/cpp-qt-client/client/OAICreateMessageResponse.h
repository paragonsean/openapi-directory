...
/*
 * OAICreateMessageResponse.h
 *
 * 
 */

#ifndef OAICreateMessageResponse_H
#define OAICreateMessageResponse_H
...
class OAICreateMessageResponse : public OAIObject {
public:
    OAICreateMessageResponse();
    OAICreateMessageResponse(QString json);
    ~OAICreateMessageResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateMessageResponse)

#endif // OAICreateMessageResponse_H
