...
/*
 * OAIGetMessageResponse.h
 *
 * 
 */

#ifndef OAIGetMessageResponse_H
#define OAIGetMessageResponse_H
...
class OAIGetMessageResponse : public OAIObject {
public:
    OAIGetMessageResponse();
    OAIGetMessageResponse(QString json);
    ~OAIGetMessageResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetMessageResponse)

#endif // OAIGetMessageResponse_H
