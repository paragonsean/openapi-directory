...
/*
 * OAIUpdateMessageResponse.h
 *
 * 
 */

#ifndef OAIUpdateMessageResponse_H
#define OAIUpdateMessageResponse_H
...
class OAIUpdateMessageResponse : public OAIObject {
public:
    OAIUpdateMessageResponse();
    OAIUpdateMessageResponse(QString json);
    ~OAIUpdateMessageResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateMessageResponse)

#endif // OAIUpdateMessageResponse_H
