...
/*
 * OAIGetMessagesResponse.h
 *
 * 
 */

#ifndef OAIGetMessagesResponse_H
#define OAIGetMessagesResponse_H
...
class OAIGetMessagesResponse : public OAIObject {
public:
    OAIGetMessagesResponse();
    OAIGetMessagesResponse(QString json);
    ~OAIGetMessagesResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetMessagesResponse)

#endif // OAIGetMessagesResponse_H
