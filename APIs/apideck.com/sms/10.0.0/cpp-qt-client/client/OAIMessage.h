...
public:
    ...
    QString getMessagingServiceId() const;
    void setMessagingServiceId(const QString &messaging_service_id);
    bool is_messaging_service_id_Set() const;
    bool is_messaging_service_id_Valid() const;

    qint32 getNumberOfMediaFiles() const;
    void setNumberOfMediaFiles(const qint32 &number_of_media_files);
    bool is_number_of_media_files_Set() const;
    bool is_number_of_media_files_Valid() const;
...
private:
    ...
    QString m_messaging_service_id;
    bool m_messaging_service_id_isSet;
    bool m_messaging_service_id_isValid;

    qint32 m_number_of_media_files;
    bool m_number_of_media_files_isSet;
    bool m_number_of_media_files_isValid;
