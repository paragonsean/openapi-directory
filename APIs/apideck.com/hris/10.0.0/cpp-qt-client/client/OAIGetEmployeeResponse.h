...
/*
 * OAIGetEmployeeResponse.h
 *
 * 
 */

#ifndef OAIGetEmployeeResponse_H
#define OAIGetEmployeeResponse_H
...
class OAIGetEmployeeResponse : public OAIObject {
public:
    OAIGetEmployeeResponse();
    OAIGetEmployeeResponse(QString json);
    ~OAIGetEmployeeResponse() override;
    ...
    OAIEmployee getData() const;
    void setData(const OAIEmployee &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetEmployeeResponse)

#endif // OAIGetEmployeeResponse_H
