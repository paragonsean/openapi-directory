...
/*
 * OAIUpdateDepartmentResponse.h
 *
 * 
 */

#ifndef OAIUpdateDepartmentResponse_H
#define OAIUpdateDepartmentResponse_H
...
class OAIUpdateDepartmentResponse : public OAIObject {
public:
    OAIUpdateDepartmentResponse();
    OAIUpdateDepartmentResponse(QString json);
    ~OAIUpdateDepartmentResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateDepartmentResponse)

#endif // OAIUpdateDepartmentResponse_H
