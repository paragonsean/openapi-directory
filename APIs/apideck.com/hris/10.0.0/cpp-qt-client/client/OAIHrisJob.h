...
namespace OpenAPI {
class OAIHrisJob_location;

class OAIHrisJob : public OAIObject {
public:
    OAIHrisJob();
    OAIHrisJob(QString json);
    ~OAIHrisJob() override;
    ...
    OAIHrisJob_location getLocation() const;
    void setLocation(const OAIHrisJob_location &location);
...
private:
    ...
    OAIHrisJob_location m_location;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHrisJob)
