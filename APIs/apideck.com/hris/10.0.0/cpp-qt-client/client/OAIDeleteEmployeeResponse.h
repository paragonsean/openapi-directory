...
/*
 * OAIDeleteEmployeeResponse.h
 *
 * 
 */

#ifndef OAIDeleteEmployeeResponse_H
#define OAIDeleteEmployeeResponse_H
...
class OAIDeleteEmployeeResponse : public OAIObject {
public:
    OAIDeleteEmployeeResponse();
    OAIDeleteEmployeeResponse(QString json);
    ~OAIDeleteEmployeeResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteEmployeeResponse)

#endif // OAIDeleteEmployeeResponse_H
