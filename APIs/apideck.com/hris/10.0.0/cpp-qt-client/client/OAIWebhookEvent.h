...
#ifndef OAIWebhookEvent_H
#define OAIWebhookEvent_H
...
class OAIWebhookEvent : public OAIObject {
public:
    OAIWebhookEvent();
    OAIWebhookEvent(QString json);
    ~OAIWebhookEvent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWebhookEvent)

#endif // OAIWebhookEvent_H
