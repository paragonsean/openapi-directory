...
/*
 * OAICreateTimeOffRequestResponse.h
 *
 * 
 */

#ifndef OAICreateTimeOffRequestResponse_H
#define OAICreateTimeOffRequestResponse_H
...
class OAICreateTimeOffRequestResponse : public OAIObject {
public:
    OAICreateTimeOffRequestResponse();
    OAICreateTimeOffRequestResponse(QString json);
    ~OAICreateTimeOffRequestResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateTimeOffRequestResponse)

#endif // OAICreateTimeOffRequestResponse_H
