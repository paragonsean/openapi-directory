...
/*
 * OAIEmployeePayroll.h
 *
 * 
 */

#ifndef OAIEmployeePayroll_H
#define OAIEmployeePayroll_H

#include <QJsonObject>

#include "OAICompensation.h"
#include "OAIPayrollTotals.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAICompensation;

class OAIEmployeePayroll : public OAIObject {
public:
    OAIEmployeePayroll();
    OAIEmployeePayroll(QString json);
    ~OAIEmployeePayroll() override;
    ...
    QList<OAICompensation> getCompensations() const;
    void setCompensations(const QList<OAICompensation> &compensations);
    ...
    QString getProcessedDate() const;
    void setProcessedDate(const QString &processed_date);
    bool is_processed_date_Set() const;
    bool is_processed_date_Valid() const;
    ...
    OAIPayrollTotals getTotals() const;
    void setTotals(const OAIPayrollTotals &totals);
...
private:
    ...
    QList<OAICompensation> m_compensations;
    ...
    QString m_processed_date;
    bool m_processed_date_isSet;
    bool m_processed_date_isValid;

    QString m_start_date;
    bool m_start_date_isSet;
    bool m_start_date_isValid;

    OAIPayrollTotals m_totals;
    bool m_totals_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEmployeePayroll)

#endif // OAIEmployeePayroll_H
