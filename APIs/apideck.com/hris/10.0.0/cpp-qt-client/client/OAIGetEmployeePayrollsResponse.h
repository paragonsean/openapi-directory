...
/*
 * OAIGetEmployeePayrollsResponse.h
 *
 * 
 */

#ifndef OAIGetEmployeePayrollsResponse_H
#define OAIGetEmployeePayrollsResponse_H
...
namespace OpenAPI {
class OAIEmployeePayroll;

class OAIGetEmployeePayrollsResponse : public OAIObject {
public:
    OAIGetEmployeePayrollsResponse();
    OAIGetEmployeePayrollsResponse(QString json);
    ~OAIGetEmployeePayrollsResponse() override;
    ...
    QList<OAIEmployeePayroll> getData() const;
    void setData(const QList<OAIEmployeePayroll> &data);
...
private:
    ...
    QList<OAIEmployeePayroll> m_data;
    bool m_data_isSet;
    bool m_data_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetEmployeePayrollsResponse)

#endif // OAIGetEmployeePayrollsResponse_H
