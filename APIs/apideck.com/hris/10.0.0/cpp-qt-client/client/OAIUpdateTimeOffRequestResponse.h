...
/*
 * OAIUpdateTimeOffRequestResponse.h
 *
 * 
 */

#ifndef OAIUpdateTimeOffRequestResponse_H
#define OAIUpdateTimeOffRequestResponse_H
...
class OAIUpdateTimeOffRequestResponse : public OAIObject {
public:
    OAIUpdateTimeOffRequestResponse();
    OAIUpdateTimeOffRequestResponse(QString json);
    ~OAIUpdateTimeOffRequestResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateTimeOffRequestResponse)

#endif // OAIUpdateTimeOffRequestResponse_H
