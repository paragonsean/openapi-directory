...
/*
 * OAICreateHrisCompanyResponse.h
 *
 * 
 */

#ifndef OAICreateHrisCompanyResponse_H
#define OAICreateHrisCompanyResponse_H
...
class OAICreateHrisCompanyResponse : public OAIObject {
public:
    OAICreateHrisCompanyResponse();
    OAICreateHrisCompanyResponse(QString json);
    ~OAICreateHrisCompanyResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateHrisCompanyResponse)

#endif // OAICreateHrisCompanyResponse_H
