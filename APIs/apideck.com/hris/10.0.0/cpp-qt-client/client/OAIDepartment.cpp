...
QString OAIDepartment::getCode() const {
    return m_code;
}
void OAIDepartment::setCode(const QString &code) {
    m_code = code;
    m_code_isSet = true;
}

bool OAIDepartment::is_code_Set() const{
    return m_code_isSet;
}

bool OAIDepartment::is_code_Valid() const{
    return m_code_isValid;
}

QDateTime OAIDepartment::getCreatedAt() const {
    return m_created_at;
}
void OAIDepartment::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIDepartment::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIDepartment::is_created_at_Valid() const{
    return m_created_at_isValid;
}

QString OAIDepartment::getCreatedBy() const {
    return m_created_by;
}
void OAIDepartment::setCreatedBy(const QString &created_by) {
    m_created_by = created_by;
    m_created_by_isSet = true;
}

bool OAIDepartment::is_created_by_Set() const{
    return m_created_by_isSet;
}

bool OAIDepartment::is_created_by_Valid() const{
    return m_created_by_isValid;
}

OAIObject OAIDepartment::getCustomMappings() const {
    return m_custom_mappings;
}
void OAIDepartment::setCustomMappings(const OAIObject &custom_mappings) {
    m_custom_mappings = custom_mappings;
    m_custom_mappings_isSet = true;
}

bool OAIDepartment::is_custom_mappings_Set() const{
    return m_custom_mappings_isSet;
}

bool OAIDepartment::is_custom_mappings_Valid() const{
    return m_custom_mappings_isValid;
}

QString OAIDepartment::getDescription() const {
    return m_description;
}
void OAIDepartment::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIDepartment::is_description_Set() const{
    return m_description_isSet;
}

bool OAIDepartment::is_description_Valid() const{
...
QString OAIDepartment::getParentId() const {
    return m_parent_id;
}
void OAIDepartment::setParentId(const QString &parent_id) {
    m_parent_id = parent_id;
    m_parent_id_isSet = true;
}

bool OAIDepartment::is_parent_id_Set() const{
    return m_parent_id_isSet;
}

bool OAIDepartment::is_parent_id_Valid() const{
    return m_parent_id_isValid;
}

QDateTime OAIDepartment::getUpdatedAt() const {
    return m_updated_at;
}
void OAIDepartment::setUpdatedAt(const QDateTime &updated_at) {
    m_updated_at = updated_at;
    m_updated_at_isSet = true;
}

bool OAIDepartment::is_updated_at_Set() const{
    return m_updated_at_isSet;
}

bool OAIDepartment::is_updated_at_Valid() const{
    return m_updated_at_isValid;
}

QString OAIDepartment::getUpdatedBy() const {
    return m_updated_by;
}
void OAIDepartment::setUpdatedBy(const QString &updated_by) {
    m_updated_by = updated_by;
    m_updated_by_isSet = true;
}

bool OAIDepartment::is_updated_by_Set() const{
    return m_updated_by_isSet;
}

bool OAIDepartment::is_updated_by_Valid() const{
