...
/*
 * OAIDeleteHrisCompanyResponse.h
 *
 * 
 */

#ifndef OAIDeleteHrisCompanyResponse_H
#define OAIDeleteHrisCompanyResponse_H
...
class OAIDeleteHrisCompanyResponse : public OAIObject {
public:
    OAIDeleteHrisCompanyResponse();
    OAIDeleteHrisCompanyResponse(QString json);
    ~OAIDeleteHrisCompanyResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteHrisCompanyResponse)

#endif // OAIDeleteHrisCompanyResponse_H
