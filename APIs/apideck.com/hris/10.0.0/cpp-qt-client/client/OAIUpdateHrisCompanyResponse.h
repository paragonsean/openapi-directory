...
/*
 * OAIUpdateHrisCompanyResponse.h
 *
 * 
 */

#ifndef OAIUpdateHrisCompanyResponse_H
#define OAIUpdateHrisCompanyResponse_H
...
class OAIUpdateHrisCompanyResponse : public OAIObject {
public:
    OAIUpdateHrisCompanyResponse();
    OAIUpdateHrisCompanyResponse(QString json);
    ~OAIUpdateHrisCompanyResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateHrisCompanyResponse)

#endif // OAIUpdateHrisCompanyResponse_H
