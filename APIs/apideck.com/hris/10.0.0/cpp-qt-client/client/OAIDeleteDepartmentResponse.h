...
/*
 * OAIDeleteDepartmentResponse.h
 *
 * 
 */

#ifndef OAIDeleteDepartmentResponse_H
#define OAIDeleteDepartmentResponse_H
...
class OAIDeleteDepartmentResponse : public OAIObject {
public:
    OAIDeleteDepartmentResponse();
    OAIDeleteDepartmentResponse(QString json);
    ~OAIDeleteDepartmentResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteDepartmentResponse)

#endif // OAIDeleteDepartmentResponse_H
