...
/*
 * OAIGetEmployeePayrollResponse.h
 *
 * 
 */

#ifndef OAIGetEmployeePayrollResponse_H
#define OAIGetEmployeePayrollResponse_H
...
class OAIGetEmployeePayrollResponse : public OAIObject {
public:
    OAIGetEmployeePayrollResponse();
    OAIGetEmployeePayrollResponse(QString json);
    ~OAIGetEmployeePayrollResponse() override;
    ...
    OAIEmployeePayroll getData() const;
    void setData(const OAIEmployeePayroll &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetEmployeePayrollResponse)

#endif // OAIGetEmployeePayrollResponse_H
