...
/*
 * OAIGetEmployeesResponse.h
 *
 * 
 */

#ifndef OAIGetEmployeesResponse_H
#define OAIGetEmployeesResponse_H
...
class OAIGetEmployeesResponse : public OAIObject {
public:
    OAIGetEmployeesResponse();
    OAIGetEmployeesResponse(QString json);
    ~OAIGetEmployeesResponse() override;
    ...
    QList<OAIEmployee> getData() const;
    void setData(const QList<OAIEmployee> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetEmployeesResponse)

#endif // OAIGetEmployeesResponse_H
