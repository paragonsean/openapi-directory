...
/*
 * OAIGetHrisJobResponse.h
 *
 * 
 */

#ifndef OAIGetHrisJobResponse_H
#define OAIGetHrisJobResponse_H
...
class OAIGetHrisJobResponse : public OAIObject {
public:
    OAIGetHrisJobResponse();
    OAIGetHrisJobResponse(QString json);
    ~OAIGetHrisJobResponse() override;
    ...
    OAIHrisJob getData() const;
    void setData(const OAIHrisJob &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetHrisJobResponse)

#endif // OAIGetHrisJobResponse_H
