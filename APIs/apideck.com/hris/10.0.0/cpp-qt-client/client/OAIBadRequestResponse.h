...
#include "OAIBadRequestResponse_detail.h"
#include <QString>
...
public:
    ...
    OAIBadRequestResponse_detail getDetail() const;
    void setDetail(const OAIBadRequestResponse_detail &detail);
...
private:
    ...
    OAIBadRequestResponse_detail m_detail;
    bool m_detail_isSet;
