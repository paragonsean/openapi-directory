...
/*
 * OAIGetHrisCompanyResponse.h
 *
 * 
 */

#ifndef OAIGetHrisCompanyResponse_H
#define OAIGetHrisCompanyResponse_H
...
namespace OpenAPI {
class OAIHrisCompany;

class OAIGetHrisCompanyResponse : public OAIObject {
public:
    OAIGetHrisCompanyResponse();
    OAIGetHrisCompanyResponse(QString json);
    ~OAIGetHrisCompanyResponse() override;
    ...
    OAIHrisCompany getData() const;
    void setData(const OAIHrisCompany &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetHrisCompanyResponse)

#endif // OAIGetHrisCompanyResponse_H
