...
#ifndef OAITimeOffRequest_H
#define OAITimeOffRequest_H
...
namespace OpenAPI {
class OAITimeOffRequest_notes;

class OAITimeOffRequest : public OAIObject {
public:
    OAITimeOffRequest();
    OAITimeOffRequest(QString json);
    ~OAITimeOffRequest() override;
    ...
    QString getApprovalDate() const;
    void setApprovalDate(const QString &approval_date);
    ...
    OAITimeOffRequest_notes getNotes() const;
    void setNotes(const OAITimeOffRequest_notes &notes);
...
private:
    ...
    OAITimeOffRequest_notes m_notes;
    bool m_notes_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAITimeOffRequest)

#endif // OAITimeOffRequest_H
