...
OAICompensation::OAICompensation(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICompensation::OAICompensation() {
    this->initializeModel();
}

OAICompensation::~OAICompensation() {}

void OAICompensation::initializeModel() {
...
void OAICompensation::fromJson(QString jsonString) {
...
void OAICompensation::fromJsonObject(QJsonObject json) {
    ...
    m_gross_pay_isValid = ::OpenAPI::fromJsonValue(m_gross_pay, json[QString("gross_pay")]);
    m_gross_pay_isSet = !json[QString("gross_pay")].isNull() && m_gross_pay_isValid;
...
QString OAICompensation::asJson() const {
...
QJsonObject OAICompensation::asJsonObject() const {
    ...
    if (m_gross_pay_isSet) {
        obj.insert(QString("gross_pay"), ::OpenAPI::toJsonValue(m_gross_pay));
    }
    if (m_net_pay_isSet) {
...
QList<OAIBenefit> OAICompensation::getBenefits() const {
    return m_benefits;
}
void OAICompensation::setBenefits(const QList<OAIBenefit> &benefits) {
    m_benefits = benefits;
    m_benefits_isSet = true;
}

bool OAICompensation::is_benefits_Set() const{
    return m_benefits_isSet;
}

bool OAICompensation::is_benefits_Valid() const{
    return m_benefits_isValid;
}

QList<OAIDeduction> OAICompensation::getDeductions() const {
    return m_deductions;
}
void OAICompensation::setDeductions(const QList<OAIDeduction> &deductions) {
    m_deductions = deductions;
    m_deductions_isSet = true;
}

bool OAICompensation::is_deductions_Set() const{
    return m_deductions_isSet;
}

bool OAICompensation::is_deductions_Valid() const{
    return m_deductions_isValid;
}

QString OAICompensation::getEmployeeId() const {
    return m_employee_id;
}
void OAICompensation::setEmployeeId(const QString &employee_id) {
    m_employee_id = employee_id;
    m_employee_id_isSet = true;
}

bool OAICompensation::is_employee_id_Set() const{
    return m_employee_id_isSet;
}

bool OAICompensation::is_employee_id_Valid() const{
    return m_employee_id_isValid;
}

double OAICompensation::getGrossPay() const {
    return m_gross_pay;
}
void OAICompensation::setGrossPay(const double &gross_pay) {
    m_gross_pay = gross_pay;
    m_gross_pay_isSet = true;
}

bool OAICompensation::is_gross_pay_Set() const{
    return m_gross_pay_isSet;
}

bool OAICompensation::is_gross_pay_Valid() const{
    return m_gross_pay_isValid;
}

double OAICompensation::getNetPay() const {
    return m_net_pay;
}
void OAICompensation::setNetPay(const double &net_pay) {
    m_net_pay = net_pay;
    m_net_pay_isSet = true;
}

bool OAICompensation::is_net_pay_Set() const{
    return m_net_pay_isSet;
}

bool OAICompensation::is_net_pay_Valid() const{
    return m_net_pay_isValid;
}

QList<OAITax> OAICompensation::getTaxes() const {
    return m_taxes;
}
void OAICompensation::setTaxes(const QList<OAITax> &taxes) {
    m_taxes = taxes;
    m_taxes_isSet = true;
}

bool OAICompensation::is_taxes_Set() const{
    return m_taxes_isSet;
}

bool OAICompensation::is_taxes_Valid() const{
    return m_taxes_isValid;
}

bool OAICompensation::isSet() const {
...
bool OAICompensation::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_employee_id_isValid && true;
}
