...
/*
 * OAIGetHrisCompaniesResponse.h
 *
 * 
 */

#ifndef OAIGetHrisCompaniesResponse_H
#define OAIGetHrisCompaniesResponse_H
...
class OAIGetHrisCompaniesResponse : public OAIObject {
public:
    OAIGetHrisCompaniesResponse();
    OAIGetHrisCompaniesResponse(QString json);
    ~OAIGetHrisCompaniesResponse() override;
    ...
    QList<OAIHrisCompany> getData() const;
    void setData(const QList<OAIHrisCompany> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetHrisCompaniesResponse)

#endif // OAIGetHrisCompaniesResponse_H
