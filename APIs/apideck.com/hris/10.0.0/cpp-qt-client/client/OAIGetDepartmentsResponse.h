...
/*
 * OAIGetDepartmentsResponse.h
 *
 * 
 */

#ifndef OAIGetDepartmentsResponse_H
#define OAIGetDepartmentsResponse_H
...
class OAIGetDepartmentsResponse : public OAIObject {
public:
    OAIGetDepartmentsResponse();
    OAIGetDepartmentsResponse(QString json);
    ~OAIGetDepartmentsResponse() override;
    ...
    QList<OAIDepartment> getData() const;
    void setData(const QList<OAIDepartment> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetDepartmentsResponse)

#endif // OAIGetDepartmentsResponse_H
