...
/*
 * OAIGetDepartmentResponse.h
 *
 * 
 */

#ifndef OAIGetDepartmentResponse_H
#define OAIGetDepartmentResponse_H
...
class OAIGetDepartmentResponse : public OAIObject {
public:
    OAIGetDepartmentResponse();
    OAIGetDepartmentResponse(QString json);
    ~OAIGetDepartmentResponse() override;
    ...
    OAIDepartment getData() const;
    void setData(const OAIDepartment &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetDepartmentResponse)

#endif // OAIGetDepartmentResponse_H
