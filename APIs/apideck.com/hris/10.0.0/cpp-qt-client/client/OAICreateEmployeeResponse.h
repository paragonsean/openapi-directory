...
/*
 * OAICreateEmployeeResponse.h
 *
 * 
 */

#ifndef OAICreateEmployeeResponse_H
#define OAICreateEmployeeResponse_H
...
class OAICreateEmployeeResponse : public OAIObject {
public:
    OAICreateEmployeeResponse();
    OAICreateEmployeeResponse(QString json);
    ~OAICreateEmployeeResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateEmployeeResponse)

#endif // OAICreateEmployeeResponse_H
