...
/*
 * OAIGetHrisJobsResponse.h
 *
 * 
 */

#ifndef OAIGetHrisJobsResponse_H
#define OAIGetHrisJobsResponse_H
...
class OAIGetHrisJobsResponse : public OAIObject {
public:
    OAIGetHrisJobsResponse();
    OAIGetHrisJobsResponse(QString json);
    ~OAIGetHrisJobsResponse() override;
    ...
    OAIHrisJobs getData() const;
    void setData(const OAIHrisJobs &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetHrisJobsResponse)

#endif // OAIGetHrisJobsResponse_H
