...
/*
 * OAIEmployeesFilter.h
 *
 * 
 */

#ifndef OAIEmployeesFilter_H
#define OAIEmployeesFilter_H
...
class OAIEmployeesFilter : public OAIObject {
public:
    OAIEmployeesFilter();
    OAIEmployeesFilter(QString json);
    ~OAIEmployeesFilter() override;
    ...
    QString getEmploymentStatus() const;
    void setEmploymentStatus(const QString &employment_status);
    ...
    void setManagerId(const QString &manager_id);
    bool is_manager_id_Set() const;
    bool is_manager_id_Valid() const;
...
private:
    ...
    QString m_manager_id;
    bool m_manager_id_isSet;
    bool m_manager_id_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEmployeesFilter)

#endif // OAIEmployeesFilter_H
