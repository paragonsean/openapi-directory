...
/*
 * OAIUpdateEmployeeResponse.h
 *
 * 
 */

#ifndef OAIUpdateEmployeeResponse_H
#define OAIUpdateEmployeeResponse_H
...
class OAIUpdateEmployeeResponse : public OAIObject {
public:
    OAIUpdateEmployeeResponse();
    OAIUpdateEmployeeResponse(QString json);
    ~OAIUpdateEmployeeResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateEmployeeResponse)

#endif // OAIUpdateEmployeeResponse_H
