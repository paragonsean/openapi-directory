...
OAIHrisJobs::OAIHrisJobs(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIHrisJobs::OAIHrisJobs() {
    this->initializeModel();
}

OAIHrisJobs::~OAIHrisJobs() {}

void OAIHrisJobs::initializeModel() {
...
void OAIHrisJobs::fromJson(QString jsonString) {
...
void OAIHrisJobs::fromJsonObject(QJsonObject json) {
...
QString OAIHrisJobs::asJson() const {
...
QJsonObject OAIHrisJobs::asJsonObject() const {
    QJsonObject obj;
    if (m_employee.isSet()) {
...
OAIEmployee OAIHrisJobs::getEmployee() const {
    return m_employee;
}
void OAIHrisJobs::setEmployee(const OAIEmployee &employee) {
    m_employee = employee;
    m_employee_isSet = true;
}

bool OAIHrisJobs::is_employee_Set() const{
    return m_employee_isSet;
}

bool OAIHrisJobs::is_employee_Valid() const{
    return m_employee_isValid;
}

QList<OAIHrisJob> OAIHrisJobs::getJobs() const {
    return m_jobs;
}
void OAIHrisJobs::setJobs(const QList<OAIHrisJob> &jobs) {
    m_jobs = jobs;
    m_jobs_isSet = true;
}

bool OAIHrisJobs::is_jobs_Set() const{
    return m_jobs_isSet;
}

bool OAIHrisJobs::is_jobs_Valid() const{
    return m_jobs_isValid;
}

bool OAIHrisJobs::isSet() const {
...
bool OAIHrisJobs::isValid() const {
