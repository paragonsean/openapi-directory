...
/*
 * OAICreateDepartmentResponse.h
 *
 * 
 */

#ifndef OAICreateDepartmentResponse_H
#define OAICreateDepartmentResponse_H
...
class OAICreateDepartmentResponse : public OAIObject {
public:
    OAICreateDepartmentResponse();
    OAICreateDepartmentResponse(QString json);
    ~OAICreateDepartmentResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateDepartmentResponse)

#endif // OAICreateDepartmentResponse_H
