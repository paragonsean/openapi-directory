...
/*
 * OAIGetTimeOffRequestsResponse.h
 *
 * 
 */

#ifndef OAIGetTimeOffRequestsResponse_H
#define OAIGetTimeOffRequestsResponse_H
...
namespace OpenAPI {
class OAITimeOffRequest;
class OAILinks;
class OAIMeta;

class OAIGetTimeOffRequestsResponse : public OAIObject {
public:
    OAIGetTimeOffRequestsResponse();
    OAIGetTimeOffRequestsResponse(QString json);
    ~OAIGetTimeOffRequestsResponse() override;
    ...
    QList<OAITimeOffRequest> getData() const;
    void setData(const QList<OAITimeOffRequest> &data);
...
private:
    ...
    QList<OAITimeOffRequest> m_data;
    bool m_data_isSet;
    bool m_data_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetTimeOffRequestsResponse)

#endif // OAIGetTimeOffRequestsResponse_H
