...
OAIHrisJob::OAIHrisJob(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIHrisJob::OAIHrisJob() {
    this->initializeModel();
}

OAIHrisJob::~OAIHrisJob() {}

void OAIHrisJob::initializeModel() {
...
void OAIHrisJob::fromJson(QString jsonString) {
...
void OAIHrisJob::fromJsonObject(QJsonObject json) {
...
QString OAIHrisJob::asJson() const {
...
QJsonObject OAIHrisJob::asJsonObject() const {
    QJsonObject obj;
...
OAIObject OAIHrisJob::getCustomMappings() const {
    return m_custom_mappings;
}
void OAIHrisJob::setCustomMappings(const OAIObject &custom_mappings) {
    m_custom_mappings = custom_mappings;
    m_custom_mappings_isSet = true;
}

bool OAIHrisJob::is_custom_mappings_Set() const{
    return m_custom_mappings_isSet;
}

bool OAIHrisJob::is_custom_mappings_Valid() const{
    return m_custom_mappings_isValid;
}

QString OAIHrisJob::getDepartment() const {
    return m_department;
}
void OAIHrisJob::setDepartment(const QString &department) {
    m_department = department;
    m_department_isSet = true;
}

bool OAIHrisJob::is_department_Set() const{
    return m_department_isSet;
}

bool OAIHrisJob::is_department_Valid() const{
    return m_department_isValid;
}

QString OAIHrisJob::getEmployeeId() const {
    return m_employee_id;
}
void OAIHrisJob::setEmployeeId(const QString &employee_id) {
    m_employee_id = employee_id;
    m_employee_id_isSet = true;
}

bool OAIHrisJob::is_employee_id_Set() const{
    return m_employee_id_isSet;
}

bool OAIHrisJob::is_employee_id_Valid() const{
    return m_employee_id_isValid;
}

OAIEmploymentStatus OAIHrisJob::getEmploymentStatus() const {
    return m_employment_status;
}
void OAIHrisJob::setEmploymentStatus(const OAIEmploymentStatus &employment_status) {
    m_employment_status = employment_status;
    m_employment_status_isSet = true;
}

bool OAIHrisJob::is_employment_status_Set() const{
    return m_employment_status_isSet;
}

bool OAIHrisJob::is_employment_status_Valid() const{
    return m_employment_status_isValid;
}

QDate OAIHrisJob::getEndDate() const {
    return m_end_date;
}
void OAIHrisJob::setEndDate(const QDate &end_date) {
    m_end_date = end_date;
    m_end_date_isSet = true;
}

bool OAIHrisJob::is_end_date_Set() const{
    return m_end_date_isSet;
}

bool OAIHrisJob::is_end_date_Valid() const{
    return m_end_date_isValid;
}

QString OAIHrisJob::getId() const {
    return m_id;
}
void OAIHrisJob::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIHrisJob::is_id_Set() const{
    return m_id_isSet;
}

bool OAIHrisJob::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIHrisJob::isIsPrimary() const {
    return m_is_primary;
}
void OAIHrisJob::setIsPrimary(const bool &is_primary) {
    m_is_primary = is_primary;
    m_is_primary_isSet = true;
}

bool OAIHrisJob::is_is_primary_Set() const{
    return m_is_primary_isSet;
}

bool OAIHrisJob::is_is_primary_Valid() const{
    return m_is_primary_isValid;
}

OAIHrisJob_location OAIHrisJob::getLocation() const {
    return m_location;
}
void OAIHrisJob::setLocation(const OAIHrisJob_location &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAIHrisJob::is_location_Set() const{
    return m_location_isSet;
}

bool OAIHrisJob::is_location_Valid() const{
    return m_location_isValid;
}

QDate OAIHrisJob::getStartDate() const {
    return m_start_date;
}
void OAIHrisJob::setStartDate(const QDate &start_date) {
    m_start_date = start_date;
    m_start_date_isSet = true;
}

bool OAIHrisJob::is_start_date_Set() const{
    return m_start_date_isSet;
}

bool OAIHrisJob::is_start_date_Valid() const{
    return m_start_date_isValid;
}

QString OAIHrisJob::getTitle() const {
    return m_title;
}
void OAIHrisJob::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAIHrisJob::is_title_Set() const{
    return m_title_isSet;
}

bool OAIHrisJob::is_title_Valid() const{
    return m_title_isValid;
}

bool OAIHrisJob::isSet() const {
