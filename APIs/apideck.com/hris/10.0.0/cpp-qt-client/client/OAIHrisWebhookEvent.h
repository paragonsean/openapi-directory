...
/*
 * OAIHrisWebhookEvent.h
 *
 * 
 */

#ifndef OAIHrisWebhookEvent_H
#define OAIHrisWebhookEvent_H
...
class OAIHrisWebhookEvent : public OAIObject {
public:
    OAIHrisWebhookEvent();
    OAIHrisWebhookEvent(QString json);
    ~OAIHrisWebhookEvent() override;
    ...
    OAIHrisEventType getEventType() const;
    void setEventType(const OAIHrisEventType &event_type);
...
Q_DECLARE_METATYPE(OpenAPI::OAIHrisWebhookEvent)

#endif // OAIHrisWebhookEvent_H
