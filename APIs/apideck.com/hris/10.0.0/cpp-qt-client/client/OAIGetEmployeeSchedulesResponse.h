...
/*
 * OAIGetEmployeeSchedulesResponse.h
 *
 * 
 */

#ifndef OAIGetEmployeeSchedulesResponse_H
#define OAIGetEmployeeSchedulesResponse_H

#include <QJsonObject>

#include "OAIEmployeeSchedules.h"
#include <QString>
...
namespace OpenAPI {
class OAIEmployeeSchedules;

class OAIGetEmployeeSchedulesResponse : public OAIObject {
public:
    OAIGetEmployeeSchedulesResponse();
    OAIGetEmployeeSchedulesResponse(QString json);
    ~OAIGetEmployeeSchedulesResponse() override;
    ...
    OAIEmployeeSchedules getData() const;
    void setData(const OAIEmployeeSchedules &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetEmployeeSchedulesResponse)

#endif // OAIGetEmployeeSchedulesResponse_H
