...
QString OAICustomField::getId() const {
    return m_id;
}
void OAICustomField::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}
...
OAICustomField_value OAICustomField::getValue() const {
    return m_value;
}
void OAICustomField::setValue(const OAICustomField_value &value) {
    m_value = value;
    m_value_isSet = true;
}
