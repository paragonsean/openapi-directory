...
#ifndef OAIHrisCompany_H
#define OAIHrisCompany_H
...
class OAIHrisCompany : public OAIObject {
public:
    OAIHrisCompany();
    OAIHrisCompany(QString json);
    ~OAIHrisCompany() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHrisCompany)

#endif // OAIHrisCompany_H
