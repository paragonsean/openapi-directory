...
#ifndef OAICompensation_H
#define OAICompensation_H
...
class OAICompensation : public OAIObject {
public:
    OAICompensation();
    OAICompensation(QString json);
    ~OAICompensation() override;
    ...
    QList<OAIBenefit> getBenefits() const;
    void setBenefits(const QList<OAIBenefit> &benefits);
    bool is_benefits_Set() const;
    bool is_benefits_Valid() const;

    QList<OAIDeduction> getDeductions() const;
    void setDeductions(const QList<OAIDeduction> &deductions);
...
private:
    ...
    QList<OAIBenefit> m_benefits;
    bool m_benefits_isSet;
    bool m_benefits_isValid;

    QList<OAIDeduction> m_deductions;
...
Q_DECLARE_METATYPE(OpenAPI::OAICompensation)

#endif // OAICompensation_H
