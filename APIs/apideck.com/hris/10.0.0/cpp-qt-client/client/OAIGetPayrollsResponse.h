...
/*
 * OAIGetPayrollsResponse.h
 *
 * 
 */

#ifndef OAIGetPayrollsResponse_H
#define OAIGetPayrollsResponse_H

#include <QJsonObject>

#include "OAIPayroll.h"
#include <QList>
#include <QString>
...
class OAIGetPayrollsResponse : public OAIObject {
public:
    OAIGetPayrollsResponse();
    OAIGetPayrollsResponse(QString json);
    ~OAIGetPayrollsResponse() override;
    ...
    QList<OAIPayroll> getData() const;
    void setData(const QList<OAIPayroll> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPayrollsResponse)

#endif // OAIGetPayrollsResponse_H
