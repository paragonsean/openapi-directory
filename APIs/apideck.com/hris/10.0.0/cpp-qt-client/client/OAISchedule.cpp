...
void OAISchedule::initializeModel() {
    ...
    m_work_pattern_isSet = false;
    m_work_pattern_isValid = false;
}
...
void OAISchedule::fromJsonObject(QJsonObject json) {
    ...
    m_work_pattern_isValid = ::OpenAPI::fromJsonValue(m_work_pattern, json[QString("work_pattern")]);
    m_work_pattern_isSet = !json[QString("work_pattern")].isNull() && m_work_pattern_isValid;
}
...
QJsonObject OAISchedule::asJsonObject() const {
    ...
    if (m_work_pattern.isSet()) {
        obj.insert(QString("work_pattern"), ::OpenAPI::toJsonValue(m_work_pattern));
    }
    return obj;
}
...
OAISchedule_work_pattern OAISchedule::getWorkPattern() const {
    return m_work_pattern;
}
void OAISchedule::setWorkPattern(const OAISchedule_work_pattern &work_pattern) {
    m_work_pattern = work_pattern;
    m_work_pattern_isSet = true;
}

bool OAISchedule::is_work_pattern_Set() const{
    return m_work_pattern_isSet;
}

bool OAISchedule::is_work_pattern_Valid() const{
    return m_work_pattern_isValid;
}
...
bool OAISchedule::isValid() const {
    ...
    return m_end_date_isValid && m_id_isValid && m_start_date_isValid && m_work_pattern_isValid && true;
}
