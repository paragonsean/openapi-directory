...
/*
 * OAIGetTimeOffRequestResponse.h
 *
 * 
 */

#ifndef OAIGetTimeOffRequestResponse_H
#define OAIGetTimeOffRequestResponse_H
...
class OAIGetTimeOffRequestResponse : public OAIObject {
public:
    OAIGetTimeOffRequestResponse();
    OAIGetTimeOffRequestResponse(QString json);
    ~OAIGetTimeOffRequestResponse() override;
    ...
    OAITimeOffRequest getData() const;
    void setData(const OAITimeOffRequest &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetTimeOffRequestResponse)

#endif // OAIGetTimeOffRequestResponse_H
