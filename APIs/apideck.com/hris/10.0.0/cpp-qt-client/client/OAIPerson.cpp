...
QDate OAIPerson::getBirthday() const {
    return m_birthday;
}
void OAIPerson::setBirthday(const QDate &birthday) {
    m_birthday = birthday;
...
OAIObject OAIPerson::getCustomMappings() const {
    return m_custom_mappings;
}
void OAIPerson::setCustomMappings(const OAIObject &custom_mappings) {
    m_custom_mappings = custom_mappings;
    m_custom_mappings_isSet = true;
}

bool OAIPerson::is_custom_mappings_Set() const{
    return m_custom_mappings_isSet;
}

bool OAIPerson::is_custom_mappings_Valid() const{
    return m_custom_mappings_isValid;
}

QDate OAIPerson::getDeceasedOn() const {
    return m_deceased_on;
}
void OAIPerson::setDeceasedOn(const QDate &deceased_on) {
    m_deceased_on = deceased_on;
    m_deceased_on_isSet = true;
}

bool OAIPerson::is_deceased_on_Set() const{
    return m_deceased_on_isSet;
}

bool OAIPerson::is_deceased_on_Valid() const{
...
OAIGender OAIPerson::getGender() const {
    return m_gender;
}
void OAIPerson::setGender(const OAIGender &gender) {
    m_gender = gender;
    m_gender_isSet = true;
}
...
QString OAIPerson::getInitials() const {
    return m_initials;
}
void OAIPerson::setInitials(const QString &initials) {
    m_initials = initials;
    m_initials_isSet = true;
}

bool OAIPerson::is_initials_Set() const{
    return m_initials_isSet;
}

bool OAIPerson::is_initials_Valid() const{
...
QString OAIPerson::getMiddleName() const {
    return m_middle_name;
}
void OAIPerson::setMiddleName(const QString &middle_name) {
    m_middle_name = middle_name;
    m_middle_name_isSet = true;
}

bool OAIPerson::is_middle_name_Set() const{
    return m_middle_name_isSet;
}

bool OAIPerson::is_middle_name_Valid() const{
