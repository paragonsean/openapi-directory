...
/*
 * OAIDeleteTimeOffRequestResponse.h
 *
 * 
 */

#ifndef OAIDeleteTimeOffRequestResponse_H
#define OAIDeleteTimeOffRequestResponse_H
...
class OAIDeleteTimeOffRequestResponse : public OAIObject {
public:
    OAIDeleteTimeOffRequestResponse();
    OAIDeleteTimeOffRequestResponse(QString json);
    ~OAIDeleteTimeOffRequestResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteTimeOffRequestResponse)

#endif // OAIDeleteTimeOffRequestResponse_H
