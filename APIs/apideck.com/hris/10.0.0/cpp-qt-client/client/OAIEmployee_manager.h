...
/*
 * OAIEmployee_manager.h
 *
 * 
 */

#ifndef OAIEmployee_manager_H
#define OAIEmployee_manager_H
...
class OAIEmployee_manager : public OAIObject {
public:
    OAIEmployee_manager();
    OAIEmployee_manager(QString json);
    ~OAIEmployee_manager() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEmployee_manager)

#endif // OAIEmployee_manager_H
