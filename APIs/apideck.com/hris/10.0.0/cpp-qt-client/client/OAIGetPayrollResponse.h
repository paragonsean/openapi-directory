...
/*
 * OAIGetPayrollResponse.h
 *
 * 
 */

#ifndef OAIGetPayrollResponse_H
#define OAIGetPayrollResponse_H
...
class OAIGetPayrollResponse : public OAIObject {
public:
    OAIGetPayrollResponse();
    OAIGetPayrollResponse(QString json);
    ~OAIGetPayrollResponse() override;
    ...
    OAIPayroll getData() const;
    void setData(const OAIPayroll &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPayrollResponse)

#endif // OAIGetPayrollResponse_H
