...
#include <iostream>
#include "../client/OAICompaniesApi.h"
...
void Example::exampleFunction1(){
     OAICompaniesApi apiInstance;
     
      // Configure API key authorization: apiKey
      apiInstance.setApiKey("YOUR API KEY NAME","YOUR API KEY");

      QEventLoop loop;
      connect(&apiInstance, &OAICompaniesApi::companiesAddSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAICompaniesApi::companiesAddSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
      ...
      OAIHrisCompany oai_hris_company = create(); // OAIHrisCompany | 
      ...
      apiInstance.companiesAdd(x_apideck_consumer_idx_apideck_app_idoai_hris_companyrawx_apideck_service_id);
