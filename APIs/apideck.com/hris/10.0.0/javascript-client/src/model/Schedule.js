...
import ScheduleWorkPattern from './ScheduleWorkPattern';
...
class Schedule {
     ...
     * @param endDate {String} The end date, inclusive, of the schedule period.
     * @param id {String} A unique identifier for an object.
     * @param startDate {String} The start date, inclusive, of the schedule period.
     * @param workPattern {module:model/ScheduleWorkPattern} 
     */
    constructor(endDate, id, startDate, workPattern) { 
        
        Schedule.initialize(this, endDate, id, startDate, workPattern);
    }
     ...
     */
    static initialize(obj, endDate, id, startDate, workPattern) { 
        obj['end_date'] = endDate;
        obj['id'] = id;
        obj['start_date'] = startDate;
        obj['work_pattern'] = workPattern;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('work_pattern')) {
                obj['work_pattern'] = ScheduleWorkPattern.constructFromObject(data['work_pattern']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        // validate the optional field `work_pattern`
        if (data['work_pattern']) { // data not null
          ScheduleWorkPattern.validateJSON(data['work_pattern']);
        }
...
Schedule.RequiredProperties = ["end_date", "id", "start_date", "work_pattern"];

/**
 * The end date, inclusive, of the schedule period.
 * @member {String} end_date
 */
Schedule.prototype['end_date'] = undefined;
 ...
 */
Schedule.prototype['start_date'] = undefined;

/**
 * @member {module:model/ScheduleWorkPattern} work_pattern
 */
Schedule.prototype['work_pattern'] = undefined;
