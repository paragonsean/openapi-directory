...
import HrisEventType from './HrisEventType';
import WebhookEvent from './WebhookEvent';

/**
 * The HrisWebhookEvent model module.
 * @module model/HrisWebhookEvent
 * @version 10.0.0
 */
class HrisWebhookEvent {
    /**
     * Constructs a new <code>HrisWebhookEvent</code>.
     * @alias module:model/HrisWebhookEvent
     * @implements module:model/WebhookEvent
     */
    constructor() { 
        WebhookEvent.initialize(this);
        HrisWebhookEvent.initialize(this);
    }
    ...
    /**
     * Constructs a <code>HrisWebhookEvent</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/HrisWebhookEvent} obj Optional instance to populate.
     * @return {module:model/HrisWebhookEvent} The populated <code>HrisWebhookEvent</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new HrisWebhookEvent();
            WebhookEvent.constructFromObject(data, obj);
            ...
            if (data.hasOwnProperty('entity_url')) {
                obj['entity_url'] = ApiClient.convertToType(data['entity_url'], 'String');
            }
            if (data.hasOwnProperty('event_id')) {
                obj['event_id'] = ApiClient.convertToType(data['event_id'], 'String');
            }
            if (data.hasOwnProperty('execution_attempt')) {
                obj['execution_attempt'] = ApiClient.convertToType(data['execution_attempt'], 'Number');
            }
            ...
            if (data.hasOwnProperty('event_type')) {
                obj['event_type'] = HrisEventType.constructFromObject(data['event_type']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>HrisWebhookEvent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>HrisWebhookEvent</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['entity_url'] && !(typeof data['entity_url'] === 'string' || data['entity_url'] instanceof String)) {
            throw new Error("Expected the field `entity_url` to be a primitive type in the JSON string but got " + data['entity_url']);
        }
        // ensure the json data is a string
 ...
 */
HrisWebhookEvent.prototype['consumer_id'] = undefined;

/**
 * The service provider's ID of the entity that triggered this event
 * @member {String} entity_id
 */
HrisWebhookEvent.prototype['entity_id'] = undefined;

/**
 * The type entity that triggered this event
 * @member {String} entity_type
 */
HrisWebhookEvent.prototype['entity_type'] = undefined;

/**
 * The url to retrieve entity detail.
 * @member {String} entity_url
 */
HrisWebhookEvent.prototype['entity_url'] = undefined;

/**
 * Unique reference to this request event
 * @member {String} event_id
 */
HrisWebhookEvent.prototype['event_id'] = undefined;

/**
 * The current count this request event has been attempted
 * @member {Number} execution_attempt
 */
HrisWebhookEvent.prototype['execution_attempt'] = undefined;

/**
 * ISO Datetime for when the original event occurred
 * @member {String} occurred_at
 */
HrisWebhookEvent.prototype['occurred_at'] = undefined;

/**
 * Service provider identifier
 * @member {String} service_id
 */
HrisWebhookEvent.prototype['service_id'] = undefined;

/**
 * Name of Apideck Unified API
 * @member {module:model/HrisWebhookEvent.UnifiedApiEnum} unified_api
 */
HrisWebhookEvent.prototype['unified_api'] = undefined;

/**
 * @member {module:model/HrisEventType} event_type
 */
HrisWebhookEvent.prototype['event_type'] = undefined;
 ...
 * @member {String} consumer_id
 */
WebhookEvent.prototype['consumer_id'] = undefined;
/**
 * The service provider's ID of the entity that triggered this event
 * @member {String} entity_id
 */
WebhookEvent.prototype['entity_id'] = undefined;
/**
 * The type entity that triggered this event
 * @member {String} entity_type
 */
WebhookEvent.prototype['entity_type'] = undefined;
/**
 * The url to retrieve entity detail.
 * @member {String} entity_url
 */
WebhookEvent.prototype['entity_url'] = undefined;
/**
 * Unique reference to this request event
 * @member {String} event_id
 */
 ...
 * @member {Number} execution_attempt
 */
WebhookEvent.prototype['execution_attempt'] = undefined;
/**
 * ISO Datetime for when the original event occurred
 * @member {String} occurred_at
 */
WebhookEvent.prototype['occurred_at'] = undefined;
/**
 * Service provider identifier
 * @member {String} service_id
 */
WebhookEvent.prototype['service_id'] = undefined;
/**
 * Name of Apideck Unified API
 * @member {module:model/WebhookEvent.UnifiedApiEnum} unified_api
 */
WebhookEvent.prototype['unified_api'] = undefined;
 ...
 * @readonly
 */
HrisWebhookEvent['UnifiedApiEnum'] = {
...
export default HrisWebhookEvent;
