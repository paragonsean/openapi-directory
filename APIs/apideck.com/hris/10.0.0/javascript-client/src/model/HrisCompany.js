...
/**
 * The HrisCompany model module.
 * @module model/HrisCompany
 * @version 10.0.0
 */
class HrisCompany {
    /**
     * Constructs a new <code>HrisCompany</code>.
     * @alias module:model/HrisCompany
     * @param legalName {String} 
     */
    constructor(legalName) { 
        
        HrisCompany.initialize(this, legalName);
    }
    ...
    /**
     * Constructs a <code>HrisCompany</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/HrisCompany} obj Optional instance to populate.
     * @return {module:model/HrisCompany} The populated <code>HrisCompany</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new HrisCompany();

            if (data.hasOwnProperty('addresses')) {
                obj['addresses'] = ApiClient.convertToType(data['addresses'], [Address]);
            }
            if (data.hasOwnProperty('company_number')) {
                obj['company_number'] = ApiClient.convertToType(data['company_number'], 'String');
            }
            ...
            if (data.hasOwnProperty('debtor_id')) {
                obj['debtor_id'] = ApiClient.convertToType(data['debtor_id'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>HrisCompany</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>HrisCompany</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of HrisCompany.RequiredProperties) {
        ...
        if (data['company_number'] && !(typeof data['company_number'] === 'string' || data['company_number'] instanceof String)) {
            throw new Error("Expected the field `company_number` to be a primitive type in the JSON string but got " + data['company_number']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['debtor_id'] && !(typeof data['debtor_id'] === 'string' || data['debtor_id'] instanceof String)) {
            throw new Error("Expected the field `debtor_id` to be a primitive type in the JSON string but got " + data['debtor_id']);
        }
        // ensure the json data is a string
...
HrisCompany.RequiredProperties = ["legal_name"];

/**
 * @member {Array.<module:model/Address>} addresses
 */
HrisCompany.prototype['addresses'] = undefined;

/**
 * An Company Number, Company ID or Company Code, is a unique number that has been assigned to each company.
 * @member {String} company_number
 */
HrisCompany.prototype['company_number'] = undefined;

/**
 * The date and time when the object was created.
 * @member {Date} created_at
 */
HrisCompany.prototype['created_at'] = undefined;

/**
 * The user who created the object.
 * @member {String} created_by
 */
HrisCompany.prototype['created_by'] = undefined;

/**
 * @member {module:model/Currency} currency
 */
HrisCompany.prototype['currency'] = undefined;

/**
 * When custom mappings are configured on the resource, the result is included here.
 * @member {Object} custom_mappings
 */
HrisCompany.prototype['custom_mappings'] = undefined;

/**
 * @member {String} debtor_id
 */
HrisCompany.prototype['debtor_id'] = undefined;

/**
 * @member {Boolean} deleted
 */
HrisCompany.prototype['deleted'] = undefined;

/**
 * @member {String} display_name
 */
HrisCompany.prototype['display_name'] = undefined;

/**
 * @member {Array.<module:model/Email>} emails
 */
HrisCompany.prototype['emails'] = undefined;

/**
 * A unique identifier for an object.
 * @member {String} id
 */
HrisCompany.prototype['id'] = undefined;

/**
 * @member {String} legal_name
 */
HrisCompany.prototype['legal_name'] = undefined;

/**
 * @member {Array.<module:model/PhoneNumber>} phone_numbers
 */
HrisCompany.prototype['phone_numbers'] = undefined;

/**
 * @member {module:model/HrisCompany.StatusEnum} status
 */
HrisCompany.prototype['status'] = undefined;

/**
 * @member {String} subdomain
 */
HrisCompany.prototype['subdomain'] = undefined;

/**
 * The date and time when the object was last updated.
 * @member {Date} updated_at
 */
HrisCompany.prototype['updated_at'] = undefined;

/**
 * The user who last updated the object.
 * @member {String} updated_by
 */
HrisCompany.prototype['updated_by'] = undefined;

/**
 * @member {Array.<module:model/Website>} websites
 */
HrisCompany.prototype['websites'] = undefined;
