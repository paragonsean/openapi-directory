...
/**
 * The Compensation model module.
 * @module model/Compensation
 * @version 10.0.0
 */
class Compensation {
    /**
     * Constructs a new <code>Compensation</code>.
     * @alias module:model/Compensation
     * @param employeeId {String} A unique identifier for an object.
     */
    constructor(employeeId) { 
        
        Compensation.initialize(this, employeeId);
    }
    ...
    /**
     * Constructs a <code>Compensation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Compensation} obj Optional instance to populate.
     * @return {module:model/Compensation} The populated <code>Compensation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Compensation();
    ...
    /**
     * Validates the JSON data with respect to <code>Compensation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Compensation</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Compensation.RequiredProperties) {
        ...
        if (data['benefits']) { // data not null
            ...
            for (const item of data['benefits']) {
                Benefit.validateJSON(item);
            };
        }
        if (data['deductions']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['deductions'])) {
                throw new Error("Expected the field `deductions` to be an array in the JSON data but got " + data['deductions']);
            }
            // validate the optional field `deductions` (array)
            for (const item of data['deductions']) {
                Deduction.validateJSON(item);
            };
        }
