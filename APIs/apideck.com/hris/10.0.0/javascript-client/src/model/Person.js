...
class Person {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('deceased_on')) {
                obj['deceased_on'] = ApiClient.convertToType(data['deceased_on'], 'Date');
            }
 ...
 */
Person.prototype['custom_mappings'] = undefined;

/**
 * Date of death
 * @member {Date} deceased_on
 */
Person.prototype['deceased_on'] = undefined;
 ...
 */
Person.prototype['middle_name'] = undefined;
