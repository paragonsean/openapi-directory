...
> GetEmployeePayrollsResponse employeePayrollsAll(employeeId, xApideckConsumerId, xApideckAppId, opts)
...
let apiInstance = new HrisApi.EmployeePayrollsApi();
let employeeId = "employeeId_example"; // String | ID of the employee you are acting upon.
...
let opts = {
  ...
  'filter': new HrisApi.PayrollsFilter(), // PayrollsFilter | Apply filters
...
apiInstance.employeePayrollsAll(employeeId, xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> GetEmployeePayrollResponse employeePayrollsOne(payrollId, employeeId, xApideckConsumerId, xApideckAppId, opts)
...
let apiInstance = new HrisApi.EmployeePayrollsApi();
let payrollId = "payrollId_example"; // String | ID of the payroll you are acting upon.
let employeeId = "employeeId_example"; // String | ID of the employee you are acting upon.
let xApideckConsumerId = "xApideckConsumerId_example"; // String | ID of the consumer which you want to get or push data from
let xApideckAppId = "dSBdXd2H6Mqwfg0atXHXYcysLJE9qyn1VwBtXHX"; // String | The ID of your Unify application
let opts = {
...
apiInstance.employeePayrollsOne(payrollId, employeeId, xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
