...
> CreateDepartmentResponse departmentsAdd(xApideckConsumerId, xApideckAppId, department, opts)
...
let apiInstance = new HrisApi.DepartmentsApi();
...
let department = new HrisApi.Department(); // Department | 
let opts = {
...
apiInstance.departmentsAdd(xApideckConsumerId, xApideckAppId, department, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> GetDepartmentsResponse departmentsAll(xApideckConsumerId, xApideckAppId, opts)
...
apiInstance.departmentsAll(xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> DeleteDepartmentResponse departmentsDelete(id, xApideckConsumerId, xApideckAppId, opts)
...
apiInstance.departmentsDelete(id, xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> GetDepartmentResponse departmentsOne(id, xApideckConsumerId, xApideckAppId, opts)
...
apiInstance.departmentsOne(id, xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> UpdateDepartmentResponse departmentsUpdate(id, xApideckConsumerId, xApideckAppId, department, opts)
...
apiInstance.departmentsUpdate(id, xApideckConsumerId, xApideckAppId, department, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
