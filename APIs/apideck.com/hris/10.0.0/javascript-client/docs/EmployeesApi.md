...
> CreateEmployeeResponse employeesAdd(xApideckConsumerId, xApideckAppId, employee, opts)
...
let apiInstance = new HrisApi.EmployeesApi();
...
let employee = new HrisApi.Employee(); // Employee | 
let opts = {
...
apiInstance.employeesAdd(xApideckConsumerId, xApideckAppId, employee, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> GetEmployeesResponse employeesAll(xApideckConsumerId, xApideckAppId, opts)
...
let opts = {
  ...
  'filter': new HrisApi.EmployeesFilter(), // EmployeesFilter | Apply filters
  'sort': new HrisApi.EmployeesSort(), // EmployeesSort | Apply sorting
...
apiInstance.employeesAll(xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> DeleteEmployeeResponse employeesDelete(id, xApideckConsumerId, xApideckAppId, opts)
...
apiInstance.employeesDelete(id, xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> GetEmployeeResponse employeesOne(id, xApideckConsumerId, xApideckAppId, opts)
...
apiInstance.employeesOne(id, xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> UpdateEmployeeResponse employeesUpdate(id, xApideckConsumerId, xApideckAppId, employee, opts)
...
apiInstance.employeesUpdate(id, xApideckConsumerId, xApideckAppId, employee, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
