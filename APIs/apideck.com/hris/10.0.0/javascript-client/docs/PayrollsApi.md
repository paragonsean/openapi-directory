...
------------- | ------------- | -------------
[**payrollsAll**](PayrollsApi.md#payrollsAll) | **GET** /hris/payrolls | List Payroll
[**payrollsOne**](PayrollsApi.md#payrollsOne) | **GET** /hris/payrolls/{payroll_id} | Get Payroll



## payrollsAll

> GetPayrollsResponse payrollsAll(xApideckConsumerId, xApideckAppId, opts)
...
let apiInstance = new HrisApi.PayrollsApi();
...
apiInstance.payrollsAll(xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> GetPayrollResponse payrollsOne(payrollId, xApideckConsumerId, xApideckAppId, opts)
...
apiInstance.payrollsOne(payrollId, xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
