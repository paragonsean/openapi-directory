# HrisApi.EmployeeSchedulesApi

All URIs are relative to *https://unify.apideck.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**employeeSchedulesAll**](EmployeeSchedulesApi.md#employeeSchedulesAll) | **GET** /hris/schedules/employees/{employee_id} | List Employee Schedules



## employeeSchedulesAll

> GetEmployeeSchedulesResponse employeeSchedulesAll(employeeId, xApideckConsumerId, xApideckAppId, opts)
...
let apiInstance = new HrisApi.EmployeeSchedulesApi();
...
apiInstance.employeeSchedulesAll(employeeId, xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
