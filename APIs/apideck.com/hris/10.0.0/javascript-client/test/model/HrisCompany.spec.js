...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HrisApi.HrisCompany();
  });
  ...
  describe('HrisCompany', function() {
    it('should create an instance of HrisCompany', function() {
      // uncomment below and update the code to test HrisCompany
      //var instance = new HrisApi.HrisCompany();
      //expect(instance).to.be.a(HrisApi.HrisCompany);
    });
    ...
    it('should have the property debtorId (base name: "debtor_id")', function() {
