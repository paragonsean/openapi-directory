...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.expect, root.HrisApi);
  }
}(this, function(expect, HrisApi) {
  'use strict';

  var instance;

  beforeEach(function() {
    instance = new HrisApi.HrisJob();
  });
  ...
  describe('HrisJob', function() {
    it('should create an instance of HrisJob', function() {
      // uncomment below and update the code to test HrisJob
      //var instance = new HrisApi.HrisJob();
      //expect(instance).to.be.a(HrisApi.HrisJob);
    });
