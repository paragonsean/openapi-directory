...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HrisApi.HrisWebhookEvent();
  });
  ...
  describe('HrisWebhookEvent', function() {
    it('should create an instance of HrisWebhookEvent', function() {
      // uncomment below and update the code to test HrisWebhookEvent
      //var instance = new HrisApi.HrisWebhookEvent();
      //expect(instance).to.be.a(HrisApi.HrisWebhookEvent);
    });
