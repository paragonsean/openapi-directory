...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HrisApi.EmployeePayroll();
  });
  ...
  describe('EmployeePayroll', function() {
    it('should create an instance of EmployeePayroll', function() {
      // uncomment below and update the code to test EmployeePayroll
      //var instance = new HrisApi.EmployeePayroll();
      //expect(instance).to.be.a(HrisApi.EmployeePayroll);
    });
