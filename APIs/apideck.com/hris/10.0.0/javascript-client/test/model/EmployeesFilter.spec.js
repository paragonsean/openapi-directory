...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HrisApi.EmployeesFilter();
  });
  ...
  describe('EmployeesFilter', function() {
    it('should create an instance of EmployeesFilter', function() {
      // uncomment below and update the code to test EmployeesFilter
      //var instance = new HrisApi.EmployeesFilter();
      //expect(instance).to.be.a(HrisApi.EmployeesFilter);
    });
