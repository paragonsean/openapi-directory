...
<a id="timeOffRequestsAdd"></a>
# **timeOffRequestsAdd**
> CreateTimeOffRequestResponse timeOffRequestsAdd(xApideckConsumerId, xApideckAppId, timeOffRequest, raw, xApideckServiceId)
...
import org.openapitools.client.api.TimeOffRequestsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    TimeOffRequestsApi apiInstance = new TimeOffRequestsApi(defaultClient);
    ...
    TimeOffRequest timeOffRequest = new TimeOffRequest(); // TimeOffRequest | 
    ...
    try {
      CreateTimeOffRequestResponse result = apiInstance.timeOffRequestsAdd(xApideckConsumerId, xApideckAppId, timeOffRequest, raw, xApideckServiceId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling TimeOffRequestsApi#timeOffRequestsAdd");
...
<a id="timeOffRequestsAll"></a>
# **timeOffRequestsAll**
> GetTimeOffRequestsResponse timeOffRequestsAll(xApideckConsumerId, xApideckAppId, raw, xApideckServiceId, cursor, limit, filter, passThrough, fields)
...
public class Example {
  public static void main(String[] args) {
    ...
    TimeOffRequestsFilter filter = new TimeOffRequestsFilter(); // TimeOffRequestsFilter | Apply filters
    ...
    try {
      GetTimeOffRequestsResponse result = apiInstance.timeOffRequestsAll(xApideckConsumerId, xApideckAppId, raw, xApideckServiceId, cursor, limit, filter, passThrough, fields);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling TimeOffRequestsApi#timeOffRequestsAll");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="timeOffRequestsDelete"></a>
# **timeOffRequestsDelete**
> DeleteTimeOffRequestResponse timeOffRequestsDelete(id, xApideckConsumerId, xApideckAppId, xApideckServiceId, raw)
...
public class Example {
  public static void main(String[] args) {
    ...
    Boolean raw = false; // Boolean | Include raw response. Mostly used for debugging purposes
    try {
      DeleteTimeOffRequestResponse result = apiInstance.timeOffRequestsDelete(id, xApideckConsumerId, xApideckAppId, xApideckServiceId, raw);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling TimeOffRequestsApi#timeOffRequestsDelete");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="timeOffRequestsOne"></a>
# **timeOffRequestsOne**
> GetTimeOffRequestResponse timeOffRequestsOne(id, xApideckConsumerId, xApideckAppId, xApideckServiceId, raw, fields)
...
public class Example {
  public static void main(String[] args) {
    ...
    String fields = "id,updated_at"; // String | The 'fields' parameter allows API users to specify the fields they want to include in the API response. If this parameter is not present, the API will return all available fields. If this parameter is present, only the fields specified in the comma-separated string will be included in the response. Nested properties can also be requested by using a dot notation. <br /><br />Example: `fields=name,email,addresses.city`<br /><br />In the example above, the response will only include the fields \"name\", \"email\" and \"addresses.city\". If any other fields are available, they will be excluded.
    try {
      GetTimeOffRequestResponse result = apiInstance.timeOffRequestsOne(id, xApideckConsumerId, xApideckAppId, xApideckServiceId, raw, fields);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling TimeOffRequestsApi#timeOffRequestsOne");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="timeOffRequestsUpdate"></a>
# **timeOffRequestsUpdate**
> UpdateTimeOffRequestResponse timeOffRequestsUpdate(id, xApideckConsumerId, xApideckAppId, timeOffRequest, xApideckServiceId, raw)
...
public class Example {
  public static void main(String[] args) {
    ...
    Boolean raw = false; // Boolean | Include raw response. Mostly used for debugging purposes
    try {
      UpdateTimeOffRequestResponse result = apiInstance.timeOffRequestsUpdate(id, xApideckConsumerId, xApideckAppId, timeOffRequest, xApideckServiceId, raw);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling TimeOffRequestsApi#timeOffRequestsUpdate");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
