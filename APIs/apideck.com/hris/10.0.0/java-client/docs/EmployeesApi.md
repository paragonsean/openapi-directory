...
<a id="employeesAdd"></a>
# **employeesAdd**
> CreateEmployeeResponse employeesAdd(xApideckConsumerId, xApideckAppId, employee, raw, xApideckServiceId)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling EmployeesApi#employeesAdd");
...
<a id="employeesAll"></a>
# **employeesAll**
> GetEmployeesResponse employeesAll(xApideckConsumerId, xApideckAppId, raw, xApideckServiceId, cursor, limit, filter, sort, passThrough, fields)
...
public class Example {
  public static void main(String[] args) {
    ...
    EmployeesFilter filter = new EmployeesFilter(); // EmployeesFilter | Apply filters
    EmployeesSort sort = new EmployeesSort(); // EmployeesSort | Apply sorting
    ...
    try {
      GetEmployeesResponse result = apiInstance.employeesAll(xApideckConsumerId, xApideckAppId, raw, xApideckServiceId, cursor, limit, filter, sort, passThrough, fields);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling EmployeesApi#employeesAll");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="employeesDelete"></a>
# **employeesDelete**
> DeleteEmployeeResponse employeesDelete(id, xApideckConsumerId, xApideckAppId, xApideckServiceId, raw)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling EmployeesApi#employeesDelete");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="employeesOne"></a>
# **employeesOne**
> GetEmployeeResponse employeesOne(id, xApideckConsumerId, xApideckAppId, xApideckServiceId, raw, fields)
...
public class Example {
  public static void main(String[] args) {
    ...
    String fields = "id,updated_at"; // String | The 'fields' parameter allows API users to specify the fields they want to include in the API response. If this parameter is not present, the API will return all available fields. If this parameter is present, only the fields specified in the comma-separated string will be included in the response. Nested properties can also be requested by using a dot notation. <br /><br />Example: `fields=name,email,addresses.city`<br /><br />In the example above, the response will only include the fields \"name\", \"email\" and \"addresses.city\". If any other fields are available, they will be excluded.
    try {
      GetEmployeeResponse result = apiInstance.employeesOne(id, xApideckConsumerId, xApideckAppId, xApideckServiceId, raw, fields);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling EmployeesApi#employeesOne");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="employeesUpdate"></a>
# **employeesUpdate**
> UpdateEmployeeResponse employeesUpdate(id, xApideckConsumerId, xApideckAppId, employee, xApideckServiceId, raw)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling EmployeesApi#employeesUpdate");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
