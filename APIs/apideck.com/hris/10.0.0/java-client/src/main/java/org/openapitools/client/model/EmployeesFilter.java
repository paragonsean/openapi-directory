...
public class EmployeesFilter {
  ...
  public EmployeesFilter companyId(String companyId) {
  ...
  public EmployeesFilter departmentId(String departmentId) {
  ...
  public EmployeesFilter email(String email) {
    this.email = email;
    return this;
  }
  ...
  public EmployeesFilter employeeNumber(String employeeNumber) {
  ...
  public EmployeesFilter employmentStatus(EmploymentStatusEnum employmentStatus) {
  ...
  public EmployeesFilter firstName(String firstName) {
  ...
  public EmployeesFilter lastName(String lastName) {
  ...
  public EmployeesFilter managerId(String managerId) {
  ...
  public EmployeesFilter title(String title) {
    this.title = title;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    EmployeesFilter employeesFilter = (EmployeesFilter) o;
    return Objects.equals(this.companyId, employeesFilter.companyId) &&
        Objects.equals(this.departmentId, employeesFilter.departmentId) &&
        Objects.equals(this.email, employeesFilter.email) &&
        Objects.equals(this.employeeNumber, employeesFilter.employeeNumber) &&
        Objects.equals(this.employmentStatus, employeesFilter.employmentStatus) &&
        Objects.equals(this.firstName, employeesFilter.firstName) &&
        Objects.equals(this.lastName, employeesFilter.lastName) &&
        Objects.equals(this.managerId, employeesFilter.managerId) &&
        Objects.equals(this.title, employeesFilter.title);
  }

  @Override
  public int hashCode() {
    return Objects.hash(companyId, departmentId, email, employeeNumber, employmentStatus, firstName, lastName, managerId, title);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to EmployeesFilter
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmployeesFilter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmployeesFilter is not found in the empty JSON string", EmployeesFilter.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EmployeesFilter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmployeesFilter` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmployeesFilter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmployeesFilter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmployeesFilter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmployeesFilter.class));

       return (TypeAdapter<T>) new TypeAdapter<EmployeesFilter>() {
           @Override
           public void write(JsonWriter out, EmployeesFilter value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmployeesFilter read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EmployeesFilter given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EmployeesFilter
   * @throws IOException if the JSON string is invalid with respect to EmployeesFilter
   */
  public static EmployeesFilter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmployeesFilter.class);
  }

  /**
   * Convert an instance of EmployeesFilter to an JSON string
   *
   * @return JSON string
   */
