...
import org.openapitools.client.model.TimeOffRequestNotes;
...
public class TimeOffRequest {
  ...
  private TimeOffRequestNotes notes;
  ...
  public TimeOffRequest amount(BigDecimal amount) {
    this.amount = amount;
    return this;
  }
  ...
  public TimeOffRequest approvalDate(String approvalDate) {
  ...
  public TimeOffRequest customMappings(Object customMappings) {
  ...
  public TimeOffRequest employeeId(String employeeId) {
  ...
  public TimeOffRequest endDate(String endDate) {
  ...
  public TimeOffRequest notes(TimeOffRequestNotes notes) {
    this.notes = notes;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public TimeOffRequestNotes getNotes() {
    return notes;
  }

  public void setNotes(TimeOffRequestNotes notes) {
    this.notes = notes;
  }


  public TimeOffRequest policyId(String policyId) {
  ...
  public TimeOffRequest requestDate(String requestDate) {
  ...
  public TimeOffRequest startDate(String startDate) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.amount, timeOffRequest.amount) &&
        Objects.equals(this.approvalDate, timeOffRequest.approvalDate) &&
        Objects.equals(this.createdAt, timeOffRequest.createdAt) &&
        Objects.equals(this.createdBy, timeOffRequest.createdBy) &&
        Objects.equals(this.customMappings, timeOffRequest.customMappings) &&
        Objects.equals(this.description, timeOffRequest.description) &&
        Objects.equals(this.employeeId, timeOffRequest.employeeId) &&
        Objects.equals(this.endDate, timeOffRequest.endDate) &&
        Objects.equals(this.id, timeOffRequest.id) &&
        Objects.equals(this.notes, timeOffRequest.notes) &&
        Objects.equals(this.policyId, timeOffRequest.policyId) &&
        Objects.equals(this.requestDate, timeOffRequest.requestDate) &&
        ...
        Objects.equals(this.updatedAt, timeOffRequest.updatedAt) &&
        Objects.equals(this.updatedBy, timeOffRequest.updatedBy);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(amount, approvalDate, createdAt, createdBy, customMappings, description, employeeId, endDate, id, notes, policyId, requestDate, requestType, startDate, status, units, updatedAt, updatedBy);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to TimeOffRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TimeOffRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TimeOffRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TimeOffRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("notes") != null && !jsonObj.get("notes").isJsonNull()) {
        TimeOffRequestNotes.validateJsonElement(jsonObj.get("notes"));
      }
