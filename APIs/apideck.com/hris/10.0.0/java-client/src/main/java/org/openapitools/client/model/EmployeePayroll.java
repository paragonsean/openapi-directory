...
public class EmployeePayroll {
  ...
  public EmployeePayroll checkDate(String checkDate) {
  ...
  public EmployeePayroll companyId(String companyId) {
  ...
  public EmployeePayroll compensations(List<Compensation> compensations) {
    this.compensations = compensations;
    return this;
  }

  public EmployeePayroll addCompensationsItem(Compensation compensationsItem) {
  ...
  public EmployeePayroll employeeId(String employeeId) {
  ...
  public EmployeePayroll endDate(String endDate) {
  ...
  public EmployeePayroll processed(Boolean processed) {
  ...
  public EmployeePayroll processedDate(String processedDate) {
  ...
  public EmployeePayroll startDate(String startDate) {
  ...
  public EmployeePayroll totals(PayrollTotals totals) {
    this.totals = totals;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.checkDate, employeePayroll.checkDate) &&
        Objects.equals(this.companyId, employeePayroll.companyId) &&
        Objects.equals(this.compensations, employeePayroll.compensations) &&
        Objects.equals(this.employeeId, employeePayroll.employeeId) &&
        Objects.equals(this.endDate, employeePayroll.endDate) &&
        Objects.equals(this.id, employeePayroll.id) &&
        Objects.equals(this.processed, employeePayroll.processed) &&
        Objects.equals(this.processedDate, employeePayroll.processedDate) &&
        Objects.equals(this.startDate, employeePayroll.startDate) &&
        Objects.equals(this.totals, employeePayroll.totals);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(checkDate, companyId, compensations, employeeId, endDate, id, processed, processedDate, startDate, totals);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to EmployeePayroll
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmployeePayroll.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmployeePayroll is not found in the empty JSON string", EmployeePayroll.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EmployeePayroll.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmployeePayroll` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EmployeePayroll.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmployeePayroll.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmployeePayroll' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmployeePayroll> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmployeePayroll.class));

       return (TypeAdapter<T>) new TypeAdapter<EmployeePayroll>() {
           @Override
           public void write(JsonWriter out, EmployeePayroll value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmployeePayroll read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EmployeePayroll given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EmployeePayroll
   * @throws IOException if the JSON string is invalid with respect to EmployeePayroll
   */
  public static EmployeePayroll fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmployeePayroll.class);
  }

  /**
   * Convert an instance of EmployeePayroll to an JSON string
   *
   * @return JSON string
   */
