...
import org.openapitools.client.model.Compensation;
import org.openapitools.client.model.PayrollTotals;
...
public class Payroll {
  ...
  public Payroll checkDate(String checkDate) {
  ...
  public Payroll companyId(String companyId) {
  ...
  public Payroll compensations(List<Compensation> compensations) {
    this.compensations = compensations;
    return this;
  }

  public Payroll addCompensationsItem(Compensation compensationsItem) {
  ...
  public Payroll customMappings(Object customMappings) {
  ...
  public Payroll endDate(String endDate) {
  ...
  public Payroll processed(Boolean processed) {
  ...
  public Payroll processedDate(String processedDate) {
  ...
  public Payroll startDate(String startDate) {
  ...
  public Payroll totals(PayrollTotals totals) {
    this.totals = totals;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public PayrollTotals getTotals() {
    return totals;
  }

  public void setTotals(PayrollTotals totals) {
    this.totals = totals;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.checkDate, payroll.checkDate) &&
        Objects.equals(this.companyId, payroll.companyId) &&
        Objects.equals(this.compensations, payroll.compensations) &&
        Objects.equals(this.customMappings, payroll.customMappings) &&
        Objects.equals(this.endDate, payroll.endDate) &&
        Objects.equals(this.id, payroll.id) &&
        Objects.equals(this.processed, payroll.processed) &&
        Objects.equals(this.processedDate, payroll.processedDate) &&
        Objects.equals(this.startDate, payroll.startDate) &&
        Objects.equals(this.totals, payroll.totals);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(checkDate, companyId, compensations, customMappings, endDate, id, processed, processedDate, startDate, totals);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Payroll
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Payroll.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Payroll.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Payroll` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("compensations") != null && !jsonObj.get("compensations").isJsonNull()) {
        ...
        if (jsonArraycompensations != null) {
          ...
          for (int i = 0; i < jsonArraycompensations.size(); i++) {
            Compensation.validateJsonElement(jsonArraycompensations.get(i));
          };
        }
      }
