...
public class EmployeeList {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.createdAt, employeeList.createdAt) &&
        Objects.equals(this.firstName, employeeList.firstName) &&
        Objects.equals(this.id, employeeList.id) &&
        Objects.equals(this.lastName, employeeList.lastName) &&
        Objects.equals(this.updatedAt, employeeList.updatedAt)&&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(createdAt, firstName, id, lastName, updatedAt, additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to EmployeeList
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmployeeList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
