...
public class HrisWebhookEvent {
  ...
  private HrisEventType eventType;

  public HrisWebhookEvent() {
  }

  public HrisWebhookEvent consumerId(String consumerId) {
  ...
  public HrisWebhookEvent entityId(String entityId) {
  ...
  public HrisWebhookEvent entityType(String entityType) {
  ...
  public HrisWebhookEvent entityUrl(String entityUrl) {
  ...
  public HrisWebhookEvent eventId(String eventId) {
  ...
  public HrisWebhookEvent executionAttempt(BigDecimal executionAttempt) {
  ...
  public HrisWebhookEvent occurredAt(String occurredAt) {
  ...
  public HrisWebhookEvent serviceId(String serviceId) {
  ...
  public HrisWebhookEvent unifiedApi(UnifiedApiEnum unifiedApi) {
  ...
  public HrisWebhookEvent eventType(HrisEventType eventType) {
   ...
   */
  @javax.annotation.Nullable
  public HrisEventType getEventType() {
    return eventType;
  }

  public void setEventType(HrisEventType eventType) {
    this.eventType = eventType;
  }
  ...
  public boolean equals(Object o) {
    ...
    HrisWebhookEvent hrisWebhookEvent = (HrisWebhookEvent) o;
    return Objects.equals(this.consumerId, hrisWebhookEvent.consumerId) &&
        Objects.equals(this.entityId, hrisWebhookEvent.entityId) &&
        Objects.equals(this.entityType, hrisWebhookEvent.entityType) &&
        Objects.equals(this.entityUrl, hrisWebhookEvent.entityUrl) &&
        Objects.equals(this.eventId, hrisWebhookEvent.eventId) &&
        Objects.equals(this.executionAttempt, hrisWebhookEvent.executionAttempt) &&
        Objects.equals(this.occurredAt, hrisWebhookEvent.occurredAt) &&
        Objects.equals(this.serviceId, hrisWebhookEvent.serviceId) &&
        Objects.equals(this.unifiedApi, hrisWebhookEvent.unifiedApi) &&
        Objects.equals(this.eventType, hrisWebhookEvent.eventType);
  }
  ...
  public String toString() {
    ...
    sb.append("class HrisWebhookEvent {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to HrisWebhookEvent
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!HrisWebhookEvent.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in HrisWebhookEvent is not found in the empty JSON string", HrisWebhookEvent.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!HrisWebhookEvent.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `HrisWebhookEvent` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("event_type") != null && !jsonObj.get("event_type").isJsonNull()) {
        HrisEventType.validateJsonElement(jsonObj.get("event_type"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!HrisWebhookEvent.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'HrisWebhookEvent' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<HrisWebhookEvent> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(HrisWebhookEvent.class));

       return (TypeAdapter<T>) new TypeAdapter<HrisWebhookEvent>() {
           @Override
           public void write(JsonWriter out, HrisWebhookEvent value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public HrisWebhookEvent read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of HrisWebhookEvent given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of HrisWebhookEvent
   * @throws IOException if the JSON string is invalid with respect to HrisWebhookEvent
   */
  public static HrisWebhookEvent fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, HrisWebhookEvent.class);
  }

  /**
   * Convert an instance of HrisWebhookEvent to an JSON string
   *
   * @return JSON string
   */
