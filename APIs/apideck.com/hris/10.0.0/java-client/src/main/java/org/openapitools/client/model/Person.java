...
public class Person {
  ...
  public Person customMappings(Object customMappings) {
  ...
  public Person deceasedOn(LocalDate deceasedOn) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.birthday, person.birthday) &&
        Objects.equals(this.customMappings, person.customMappings) &&
        Objects.equals(this.deceasedOn, person.deceasedOn) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(birthday, customMappings, deceasedOn, firstName, gender, id, initials, lastName, middleName);
  }
