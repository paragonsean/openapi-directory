...
async def payrolls_all(request: web.Request, x_apideck_consumer_id, x_apideck_app_id, raw=None, x_apideck_service_id=None, filter=None, pass_through=None, fields=None) -> web.Response:
    """List Payroll
...
async def payrolls_one(request: web.Request, payroll_id, x_apideck_consumer_id, x_apideck_app_id, raw=None, x_apideck_service_id=None, fields=None) -> web.Response:
    """Get Payroll
