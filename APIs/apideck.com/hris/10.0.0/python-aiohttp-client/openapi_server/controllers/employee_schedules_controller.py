...
async def employee_schedules_all(request: web.Request, employee_id, x_apideck_consumer_id, x_apideck_app_id, raw=None, x_apideck_service_id=None, pass_through=None, fields=None) -> web.Response:
