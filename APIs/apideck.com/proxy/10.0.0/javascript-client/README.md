...
ProxyApi - JavaScript client for proxy_api
...
To use the link you just defined in your project, switch to the directory you want to use your proxy_api from, and run:
...
```javascript
var ProxyApi = require('proxy_api');

var defaultClient = ProxyApi.ApiClient.instance;
...
var api = new ProxyApi.ExecuteApi()
...
var xApideckServiceId = "close"; // {String} Provide the service id you want to call (e.g., pipedrive). Only needed when a consumer has activated multiple integrations for a Unified API.
...
api.deleteProxy(xApideckConsumerId, xApideckAppId, xApideckServiceId, xApideckDownstreamUrl, opts, callback);
...
------------ | ------------- | ------------- | -------------
*ProxyApi.ExecuteApi* | [**deleteProxy**](docs/ExecuteApi.md#deleteProxy) | **DELETE** /proxy | DELETE
*ProxyApi.ExecuteApi* | [**getProxy**](docs/ExecuteApi.md#getProxy) | **GET** /proxy | GET
*ProxyApi.ExecuteApi* | [**optionsProxy**](docs/ExecuteApi.md#optionsProxy) | **OPTIONS** /proxy | OPTIONS
*ProxyApi.ExecuteApi* | [**patchProxy**](docs/ExecuteApi.md#patchProxy) | **PATCH** /proxy | PATCH
*ProxyApi.ExecuteApi* | [**postProxy**](docs/ExecuteApi.md#postProxy) | **POST** /proxy | POST
*ProxyApi.ExecuteApi* | [**putProxy**](docs/ExecuteApi.md#putProxy) | **PUT** /proxy | PUT


## Documentation for Models

 - [ProxyApi.GetProxy401Response](docs/GetProxy401Response.md)
 - [ProxyApi.PostProxyRequest](docs/PostProxyRequest.md)
 - [ProxyApi.PutProxyRequest](docs/PutProxyRequest.md)
