...
/**
 * The GetProxy401Response model module.
 * @module model/GetProxy401Response
 * @version 10.0.0
 */
class GetProxy401Response {
    /**
     * Constructs a new <code>GetProxy401Response</code>.
     * @alias module:model/GetProxy401Response
     */
    constructor() { 
        
        GetProxy401Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetProxy401Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetProxy401Response} obj Optional instance to populate.
     * @return {module:model/GetProxy401Response} The populated <code>GetProxy401Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetProxy401Response();
    ...
    /**
     * Validates the JSON data with respect to <code>GetProxy401Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetProxy401Response</code>.
     */
 ...
 */
GetProxy401Response.prototype['detail'] = undefined;

/**
 * Contains an explanation of the status_code as defined in HTTP/1.1 standard (RFC 7231)
 * @member {String} error
 */
GetProxy401Response.prototype['error'] = undefined;

/**
 * A human-readable message providing more details about the error.
 * @member {String} message
 */
GetProxy401Response.prototype['message'] = undefined;

/**
 * Link to documentation of error type
 * @member {String} ref
 */
GetProxy401Response.prototype['ref'] = undefined;

/**
 * HTTP status code
 * @member {Number} status_code
 */
GetProxy401Response.prototype['status_code'] = undefined;

/**
 * The type of error returned
 * @member {String} type_name
 */
GetProxy401Response.prototype['type_name'] = undefined;
...
export default GetProxy401Response;
