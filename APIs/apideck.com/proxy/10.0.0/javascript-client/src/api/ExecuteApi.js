...
import GetProxy401Response from '../model/GetProxy401Response';
import PostProxyRequest from '../model/PostProxyRequest';
import PutProxyRequest from '../model/PutProxyRequest';
...
* @version 10.0.0
*/
export default class ExecuteApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the deleteProxy operation.
     * @callback module:api/ExecuteApi~deleteProxyCallback
     ...
     * @param {String} xApideckDownstreamUrl Downstream URL
     * @param {Object} opts Optional parameters
     * @param {String} [xApideckDownstreamAuthorization] Downstream authorization header. This will skip the Vault token injection.
     * @param {module:api/ExecuteApi~deleteProxyCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Object}
     */
    deleteProxy(xApideckConsumerId, xApideckAppId, xApideckServiceId, xApideckDownstreamUrl, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'xApideckConsumerId' is set
      if (xApideckConsumerId === undefined || xApideckConsumerId === null) {
        throw new Error("Missing the required parameter 'xApideckConsumerId' when calling deleteProxy");
      }
      // verify the required parameter 'xApideckAppId' is set
      if (xApideckAppId === undefined || xApideckAppId === null) {
        throw new Error("Missing the required parameter 'xApideckAppId' when calling deleteProxy");
      }
      // verify the required parameter 'xApideckServiceId' is set
      if (xApideckServiceId === undefined || xApideckServiceId === null) {
        throw new Error("Missing the required parameter 'xApideckServiceId' when calling deleteProxy");
      }
      // verify the required parameter 'xApideckDownstreamUrl' is set
      if (xApideckDownstreamUrl === undefined || xApideckDownstreamUrl === null) {
        throw new Error("Missing the required parameter 'xApideckDownstreamUrl' when calling deleteProxy");
      }
      ...
      let headerParams = {
        ...
        'x-apideck-service-id': xApideckServiceId,
        'x-apideck-downstream-url': xApideckDownstreamUrl,
        'x-apideck-downstream-authorization': opts['xApideckDownstreamAuthorization']
      };
      let formParams = {
      };
    ...
    /**
     * Callback function to receive the result of the getProxy operation.
     * @callback module:api/ExecuteApi~getProxyCallback
     * @param {String} error Error message, if any.
     * @param {Object} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} [xApideckDownstreamAuthorization] Downstream authorization header. This will skip the Vault token injection.
     * @param {module:api/ExecuteApi~getProxyCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Object}
     */
    getProxy(xApideckConsumerId, xApideckAppId, xApideckServiceId, xApideckDownstreamUrl, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'xApideckConsumerId' is set
      if (xApideckConsumerId === undefined || xApideckConsumerId === null) {
        throw new Error("Missing the required parameter 'xApideckConsumerId' when calling getProxy");
      }
      // verify the required parameter 'xApideckAppId' is set
      if (xApideckAppId === undefined || xApideckAppId === null) {
        throw new Error("Missing the required parameter 'xApideckAppId' when calling getProxy");
      }
      // verify the required parameter 'xApideckServiceId' is set
      if (xApideckServiceId === undefined || xApideckServiceId === null) {
        throw new Error("Missing the required parameter 'xApideckServiceId' when calling getProxy");
      }
      // verify the required parameter 'xApideckDownstreamUrl' is set
      if (xApideckDownstreamUrl === undefined || xApideckDownstreamUrl === null) {
        throw new Error("Missing the required parameter 'xApideckDownstreamUrl' when calling getProxy");
      }
    ...
    /**
     * Callback function to receive the result of the optionsProxy operation.
     * @callback module:api/ExecuteApi~optionsProxyCallback
     * @param {String} error Error message, if any.
     * @param {Object} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} [xApideckDownstreamAuthorization] Downstream authorization header. This will skip the Vault token injection.
     * @param {module:api/ExecuteApi~optionsProxyCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Object}
     */
    optionsProxy(xApideckConsumerId, xApideckAppId, xApideckServiceId, xApideckDownstreamUrl, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'xApideckConsumerId' is set
      if (xApideckConsumerId === undefined || xApideckConsumerId === null) {
        throw new Error("Missing the required parameter 'xApideckConsumerId' when calling optionsProxy");
      }
      // verify the required parameter 'xApideckAppId' is set
      if (xApideckAppId === undefined || xApideckAppId === null) {
        throw new Error("Missing the required parameter 'xApideckAppId' when calling optionsProxy");
      }
      // verify the required parameter 'xApideckServiceId' is set
      if (xApideckServiceId === undefined || xApideckServiceId === null) {
        throw new Error("Missing the required parameter 'xApideckServiceId' when calling optionsProxy");
      }
      // verify the required parameter 'xApideckDownstreamUrl' is set
      if (xApideckDownstreamUrl === undefined || xApideckDownstreamUrl === null) {
        throw new Error("Missing the required parameter 'xApideckDownstreamUrl' when calling optionsProxy");
      }
    ...
    /**
     * Callback function to receive the result of the patchProxy operation.
     * @callback module:api/ExecuteApi~patchProxyCallback
     * @param {String} error Error message, if any.
     * @param {Object} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} [xApideckDownstreamAuthorization] Downstream authorization header. This will skip the Vault token injection.
     * @param {module:model/PostProxyRequest} [postProxyRequest] Depending on the verb/method of the request this will contain the request body you want to POST/PATCH/PUT.
     * @param {module:api/ExecuteApi~patchProxyCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Object}
     */
    patchProxy(xApideckConsumerId, xApideckAppId, xApideckServiceId, xApideckDownstreamUrl, opts, callback) {
      opts = opts || {};
      let postBody = opts['postProxyRequest'];
      // verify the required parameter 'xApideckConsumerId' is set
      if (xApideckConsumerId === undefined || xApideckConsumerId === null) {
        throw new Error("Missing the required parameter 'xApideckConsumerId' when calling patchProxy");
      }
      // verify the required parameter 'xApideckAppId' is set
      if (xApideckAppId === undefined || xApideckAppId === null) {
        throw new Error("Missing the required parameter 'xApideckAppId' when calling patchProxy");
      }
      // verify the required parameter 'xApideckServiceId' is set
      if (xApideckServiceId === undefined || xApideckServiceId === null) {
        throw new Error("Missing the required parameter 'xApideckServiceId' when calling patchProxy");
      }
      // verify the required parameter 'xApideckDownstreamUrl' is set
      if (xApideckDownstreamUrl === undefined || xApideckDownstreamUrl === null) {
        throw new Error("Missing the required parameter 'xApideckDownstreamUrl' when calling patchProxy");
      }
    ...
    /**
     * Callback function to receive the result of the postProxy operation.
     * @callback module:api/ExecuteApi~postProxyCallback
     * @param {String} error Error message, if any.
     * @param {Object} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} [xApideckDownstreamAuthorization] Downstream authorization header. This will skip the Vault token injection.
     * @param {module:model/PostProxyRequest} [postProxyRequest] Depending on the verb/method of the request this will contain the request body you want to POST/PATCH/PUT.
     * @param {module:api/ExecuteApi~postProxyCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Object}
     */
    postProxy(xApideckConsumerId, xApideckAppId, xApideckServiceId, xApideckDownstreamUrl, opts, callback) {
      opts = opts || {};
      let postBody = opts['postProxyRequest'];
      // verify the required parameter 'xApideckConsumerId' is set
      if (xApideckConsumerId === undefined || xApideckConsumerId === null) {
        throw new Error("Missing the required parameter 'xApideckConsumerId' when calling postProxy");
      }
      // verify the required parameter 'xApideckAppId' is set
      if (xApideckAppId === undefined || xApideckAppId === null) {
        throw new Error("Missing the required parameter 'xApideckAppId' when calling postProxy");
      }
      // verify the required parameter 'xApideckServiceId' is set
      if (xApideckServiceId === undefined || xApideckServiceId === null) {
        throw new Error("Missing the required parameter 'xApideckServiceId' when calling postProxy");
      }
      // verify the required parameter 'xApideckDownstreamUrl' is set
      if (xApideckDownstreamUrl === undefined || xApideckDownstreamUrl === null) {
        throw new Error("Missing the required parameter 'xApideckDownstreamUrl' when calling postProxy");
      }
    ...
    /**
     * Callback function to receive the result of the putProxy operation.
     * @callback module:api/ExecuteApi~putProxyCallback
     * @param {String} error Error message, if any.
     * @param {Object} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} [xApideckDownstreamAuthorization] Downstream authorization header. This will skip the Vault token injection.
     * @param {module:model/PutProxyRequest} [putProxyRequest] Depending on the verb/method of the request this will contain the request body you want to POST/PATCH/PUT.
     * @param {module:api/ExecuteApi~putProxyCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Object}
     */
    putProxy(xApideckConsumerId, xApideckAppId, xApideckServiceId, xApideckDownstreamUrl, opts, callback) {
      opts = opts || {};
      let postBody = opts['putProxyRequest'];
      // verify the required parameter 'xApideckConsumerId' is set
      if (xApideckConsumerId === undefined || xApideckConsumerId === null) {
        throw new Error("Missing the required parameter 'xApideckConsumerId' when calling putProxy");
      }
      // verify the required parameter 'xApideckAppId' is set
      if (xApideckAppId === undefined || xApideckAppId === null) {
        throw new Error("Missing the required parameter 'xApideckAppId' when calling putProxy");
      }
      // verify the required parameter 'xApideckServiceId' is set
      if (xApideckServiceId === undefined || xApideckServiceId === null) {
        throw new Error("Missing the required parameter 'xApideckServiceId' when calling putProxy");
      }
      // verify the required parameter 'xApideckDownstreamUrl' is set
      if (xApideckDownstreamUrl === undefined || xApideckDownstreamUrl === null) {
        throw new Error("Missing the required parameter 'xApideckDownstreamUrl' when calling putProxy");
      }
