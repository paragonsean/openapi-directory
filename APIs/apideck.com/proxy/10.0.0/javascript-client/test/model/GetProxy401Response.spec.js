...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.expect, root.ProxyApi);
  }
}(this, function(expect, ProxyApi) {
  'use strict';

  var instance;

  beforeEach(function() {
    instance = new ProxyApi.GetProxy401Response();
  });
  ...
  describe('GetProxy401Response', function() {
    it('should create an instance of GetProxy401Response', function() {
      // uncomment below and update the code to test GetProxy401Response
      //var instance = new ProxyApi.GetProxy401Response();
      //expect(instance).to.be.a(ProxyApi.GetProxy401Response);
    });
