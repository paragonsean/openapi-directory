...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProxyApi.ExecuteApi();
  });
  ...
  describe('ExecuteApi', function() {
    describe('deleteProxy', function() {
      it('should call deleteProxy successfully', function(done) {
        //uncomment below and update the code to test deleteProxy
        //instance.deleteProxy(function(error) {
    ...
    describe('getProxy', function() {
      it('should call getProxy successfully', function(done) {
        //uncomment below and update the code to test getProxy
        //instance.getProxy(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('optionsProxy', function() {
      it('should call optionsProxy successfully', function(done) {
        //uncomment below and update the code to test optionsProxy
        //instance.optionsProxy(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('patchProxy', function() {
      it('should call patchProxy successfully', function(done) {
        //uncomment below and update the code to test patchProxy
        //instance.patchProxy(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('postProxy', function() {
      it('should call postProxy successfully', function(done) {
        //uncomment below and update the code to test postProxy
        //instance.postProxy(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('putProxy', function() {
      it('should call putProxy successfully', function(done) {
        //uncomment below and update the code to test putProxy
        //instance.putProxy(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
