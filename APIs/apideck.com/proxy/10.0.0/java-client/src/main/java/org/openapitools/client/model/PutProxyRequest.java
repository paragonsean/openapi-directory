...
public class PutProxyRequest extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(PutProxyRequest.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!PutProxyRequest.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'PutProxyRequest' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<PutProxyRequest>() {
                @Override
                public void write(JsonWriter out, PutProxyRequest value) throws IOException {
                ...
                @Override
                public PutProxyRequest read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        PutProxyRequest ret = new PutProxyRequest();
                    ...
                    throw new IOException(String.format("Failed deserialization for PutProxyRequest: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public PutProxyRequest() {
        super("anyOf", Boolean.FALSE);
    }

    public PutProxyRequest(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return PutProxyRequest.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to PutProxyRequest
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format("The JSON string is invalid for PutProxyRequest with anyOf schemas: Object, String. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of PutProxyRequest given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of PutProxyRequest
     * @throws IOException if the JSON string is invalid with respect to PutProxyRequest
     */
    public static PutProxyRequest fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, PutProxyRequest.class);
    }

    /**
     * Convert an instance of PutProxyRequest to an JSON string
     *
     * @return JSON string
     */
