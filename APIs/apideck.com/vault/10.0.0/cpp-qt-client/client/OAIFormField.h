...
public:
    ...
    bool isCustomField() const;
    void setCustomField(const bool &custom_field);
    ...
    QList<OAIFormFieldOption> getOptions() const;
    void setOptions(const QList<OAIFormFieldOption> &options);
...
private:
    ...
    QList<OAIFormFieldOption> m_options;
