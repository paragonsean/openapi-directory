...
/*
 * OAICustomFieldFinder.h
 *
 * 
 */

#ifndef OAICustomFieldFinder_H
#define OAICustomFieldFinder_H
...
class OAICustomFieldFinder : public OAIObject {
public:
    OAICustomFieldFinder();
    OAICustomFieldFinder(QString json);
    ~OAICustomFieldFinder() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomFieldFinder)

#endif // OAICustomFieldFinder_H
