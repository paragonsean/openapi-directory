...
#ifndef OAILogsFilter_H
#define OAILogsFilter_H
...
class OAILogsFilter : public OAIObject {
public:
    OAILogsFilter();
    OAILogsFilter(QString json);
    ~OAILogsFilter() override;
    ...
    QString getExcludeUnifiedApis() const;
    void setExcludeUnifiedApis(const QString &exclude_unified_apis);
    bool is_exclude_unified_apis_Set() const;
    bool is_exclude_unified_apis_Valid() const;
...
private:
    ...
    QString m_exclude_unified_apis;
    bool m_exclude_unified_apis_isSet;
    bool m_exclude_unified_apis_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAILogsFilter)

#endif // OAILogsFilter_H
