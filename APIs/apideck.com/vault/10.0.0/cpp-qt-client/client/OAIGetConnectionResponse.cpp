...
OAIConnection OAIGetConnectionResponse::getData() const {
    return m_data;
}
void OAIGetConnectionResponse::setData(const OAIConnection &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIGetConnectionResponse::is_data_Set() const{
    return m_data_isSet;
}

bool OAIGetConnectionResponse::is_data_Valid() const{
    return m_data_isValid;
}

QString OAIGetConnectionResponse::getStatus() const {
    return m_status;
}
void OAIGetConnectionResponse::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIGetConnectionResponse::is_status_Set() const{
    return m_status_isSet;
}

bool OAIGetConnectionResponse::is_status_Valid() const{
    return m_status_isValid;
}

qint32 OAIGetConnectionResponse::getStatusCode() const {
    return m_status_code;
}
void OAIGetConnectionResponse::setStatusCode(const qint32 &status_code) {
    m_status_code = status_code;
    m_status_code_isSet = true;
}

bool OAIGetConnectionResponse::is_status_code_Set() const{
    return m_status_code_isSet;
}

bool OAIGetConnectionResponse::is_status_code_Valid() const{
