...
/*
 * OAICreateSessionResponse_data.h
 *
 * 
 */

#ifndef OAICreateSessionResponse_data_H
#define OAICreateSessionResponse_data_H
...
class OAICreateSessionResponse_data : public OAIObject {
public:
    OAICreateSessionResponse_data();
    OAICreateSessionResponse_data(QString json);
    ~OAICreateSessionResponse_data() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateSessionResponse_data)

#endif // OAICreateSessionResponse_data_H
