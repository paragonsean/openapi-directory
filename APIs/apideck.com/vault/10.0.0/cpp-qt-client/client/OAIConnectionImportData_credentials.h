...
/*
 * OAIConnectionImportData_credentials.h
 *
 * 
 */

#ifndef OAIConnectionImportData_credentials_H
#define OAIConnectionImportData_credentials_H
...
class OAIConnectionImportData_credentials : public OAIObject {
public:
    OAIConnectionImportData_credentials();
    OAIConnectionImportData_credentials(QString json);
    ~OAIConnectionImportData_credentials() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConnectionImportData_credentials)

#endif // OAIConnectionImportData_credentials_H
