...
double OAIConsumer::getAggregatedRequestCount() const {
    return m_aggregated_request_count;
}
void OAIConsumer::setAggregatedRequestCount(const double &aggregated_request_count) {
    m_aggregated_request_count = aggregated_request_count;
    m_aggregated_request_count_isSet = true;
}

bool OAIConsumer::is_aggregated_request_count_Set() const{
    return m_aggregated_request_count_isSet;
}

bool OAIConsumer::is_aggregated_request_count_Valid() const{
    return m_aggregated_request_count_isValid;
}

QString OAIConsumer::getApplicationId() const {
    return m_application_id;
}
void OAIConsumer::setApplicationId(const QString &application_id) {
    m_application_id = application_id;
    m_application_id_isSet = true;
}

bool OAIConsumer::is_application_id_Set() const{
    return m_application_id_isSet;
}

bool OAIConsumer::is_application_id_Valid() const{
    return m_application_id_isValid;
}

QList<OAIConsumerConnection> OAIConsumer::getConnections() const {
    return m_connections;
}
void OAIConsumer::setConnections(const QList<OAIConsumerConnection> &connections) {
    m_connections = connections;
    m_connections_isSet = true;
}

bool OAIConsumer::is_connections_Set() const{
    return m_connections_isSet;
}

bool OAIConsumer::is_connections_Valid() const{
    return m_connections_isValid;
}

QString OAIConsumer::getConsumerId() const {
    return m_consumer_id;
}
void OAIConsumer::setConsumerId(const QString &consumer_id) {
    m_consumer_id = consumer_id;
    m_consumer_id_isSet = true;
}

bool OAIConsumer::is_consumer_id_Set() const{
    return m_consumer_id_isSet;
}

bool OAIConsumer::is_consumer_id_Valid() const{
    return m_consumer_id_isValid;
}

QString OAIConsumer::getCreated() const {
    return m_created;
}
void OAIConsumer::setCreated(const QString &created) {
    m_created = created;
    m_created_isSet = true;
}

bool OAIConsumer::is_created_Set() const{
    return m_created_isSet;
}

bool OAIConsumer::is_created_Valid() const{
    return m_created_isValid;
}

OAIConsumerMetadata OAIConsumer::getMetadata() const {
    return m_metadata;
}
void OAIConsumer::setMetadata(const OAIConsumerMetadata &metadata) {
    m_metadata = metadata;
    m_metadata_isSet = true;
}

bool OAIConsumer::is_metadata_Set() const{
    return m_metadata_isSet;
}

bool OAIConsumer::is_metadata_Valid() const{
    return m_metadata_isValid;
}

QString OAIConsumer::getModified() const {
    return m_modified;
}
void OAIConsumer::setModified(const QString &modified) {
    m_modified = modified;
    m_modified_isSet = true;
}

bool OAIConsumer::is_modified_Set() const{
    return m_modified_isSet;
}

bool OAIConsumer::is_modified_Valid() const{
    return m_modified_isValid;
}

QString OAIConsumer::getRequestCountUpdated() const {
    return m_request_count_updated;
}
void OAIConsumer::setRequestCountUpdated(const QString &request_count_updated) {
    m_request_count_updated = request_count_updated;
    m_request_count_updated_isSet = true;
}

bool OAIConsumer::is_request_count_updated_Set() const{
    return m_request_count_updated_isSet;
}

bool OAIConsumer::is_request_count_updated_Valid() const{
    return m_request_count_updated_isValid;
}

OAIRequestCountAllocation OAIConsumer::getRequestCounts() const {
    return m_request_counts;
}
void OAIConsumer::setRequestCounts(const OAIRequestCountAllocation &request_counts) {
    m_request_counts = request_counts;
    m_request_counts_isSet = true;
}

bool OAIConsumer::is_request_counts_Set() const{
    return m_request_counts_isSet;
}

bool OAIConsumer::is_request_counts_Valid() const{
    return m_request_counts_isValid;
}

QList<QString> OAIConsumer::getServices() const {
    return m_services;
}
void OAIConsumer::setServices(const QList<QString> &services) {
    m_services = services;
    m_services_isSet = true;
}

bool OAIConsumer::is_services_Set() const{
    return m_services_isSet;
}

bool OAIConsumer::is_services_Valid() const{
...
bool OAIConsumer::isValid() const {
    ...
    return m_consumer_id_isValid && true;
}
