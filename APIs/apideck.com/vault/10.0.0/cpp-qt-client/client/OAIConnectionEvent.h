...
/*
 * OAIConnectionEvent.h
 *
 * 
 */

#ifndef OAIConnectionEvent_H
#define OAIConnectionEvent_H
...
class OAIConnectionEvent : public OAIObject {
public:
    OAIConnectionEvent();
    OAIConnectionEvent(QString json);
    ~OAIConnectionEvent() override;
    ...
    OAIConsumerConnection getEntity() const;
    void setEntity(const OAIConsumerConnection &entity);
    ...
    OAIVaultEventType getEventType() const;
    void setEventType(const OAIVaultEventType &event_type);
...
private:
    ...
    OAIConsumerConnection m_entity;
    bool m_entity_isSet;
    ...
    OAIVaultEventType m_event_type;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConnectionEvent)

#endif // OAIConnectionEvent_H
