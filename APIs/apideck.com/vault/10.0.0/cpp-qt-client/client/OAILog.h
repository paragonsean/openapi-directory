...
#include "OAILog_operation.h"
#include "OAILog_service.h"
#include <QString>
...
namespace OpenAPI {
class OAILog_operation;
class OAILog_service;
...
public:
    ...
    QString getApiStyle() const;
    void setApiStyle(const QString &api_style);
    bool is_api_style_Set() const;
    bool is_api_style_Valid() const;
    ...
    bool isChildRequest() const;
    void setChildRequest(const bool &child_request);
    bool is_child_request_Set() const;
    bool is_child_request_Valid() const;
    ...
    qint32 getExecution() const;
    void setExecution(const qint32 &execution);
    ...
    OAILog_operation getOperation() const;
    void setOperation(const OAILog_operation &operation);
    ...
    void setSandbox(const bool &sandbox);
    bool is_sandbox_Set() const;
    bool is_sandbox_Valid() const;

    OAILog_service getService() const;
    void setService(const OAILog_service &service);
...
private:
    ...
    QString m_api_style;
    bool m_api_style_isSet;
    bool m_api_style_isValid;

    QString m_base_url;
    bool m_base_url_isSet;
    bool m_base_url_isValid;

    bool m_child_request;
    bool m_child_request_isSet;
    bool m_child_request_isValid;
