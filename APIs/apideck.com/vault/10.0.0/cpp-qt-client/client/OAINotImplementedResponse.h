...
/*
 * OAINotImplementedResponse.h
 *
 * 
 */

#ifndef OAINotImplementedResponse_H
#define OAINotImplementedResponse_H

#include <QJsonObject>

#include "OAINotImplementedResponse_detail.h"
#include <QString>
...
class OAINotImplementedResponse : public OAIObject {
public:
    OAINotImplementedResponse();
    OAINotImplementedResponse(QString json);
    ~OAINotImplementedResponse() override;
    ...
    OAINotImplementedResponse_detail getDetail() const;
    void setDetail(const OAINotImplementedResponse_detail &detail);
...
private:
    ...
    OAINotImplementedResponse_detail m_detail;
    bool m_detail_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAINotImplementedResponse)

#endif // OAINotImplementedResponse_H
