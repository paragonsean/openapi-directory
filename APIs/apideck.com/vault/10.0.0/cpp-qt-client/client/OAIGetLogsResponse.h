...
/*
 * OAIGetLogsResponse.h
 *
 * 
 */

#ifndef OAIGetLogsResponse_H
#define OAIGetLogsResponse_H
...
class OAIGetLogsResponse : public OAIObject {
public:
    OAIGetLogsResponse();
    OAIGetLogsResponse(QString json);
    ~OAIGetLogsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetLogsResponse)

#endif // OAIGetLogsResponse_H
