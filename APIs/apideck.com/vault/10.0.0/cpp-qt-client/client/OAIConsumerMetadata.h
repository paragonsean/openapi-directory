...
/*
 * OAIConsumerMetadata.h
 *
 * The metadata of the consumer. This is used to display the consumer in the sidebar. This is optional, but recommended.
 */

#ifndef OAIConsumerMetadata_H
#define OAIConsumerMetadata_H
...
class OAIConsumerMetadata : public OAIObject {
public:
    OAIConsumerMetadata();
    OAIConsumerMetadata(QString json);
    ~OAIConsumerMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConsumerMetadata)

#endif // OAIConsumerMetadata_H
