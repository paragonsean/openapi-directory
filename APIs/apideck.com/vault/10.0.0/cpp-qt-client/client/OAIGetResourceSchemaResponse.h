...
/*
 * OAIGetResourceSchemaResponse.h
 *
 * 
 */

#ifndef OAIGetResourceSchemaResponse_H
#define OAIGetResourceSchemaResponse_H
...
class OAIGetResourceSchemaResponse : public OAIObject {
public:
    OAIGetResourceSchemaResponse();
    OAIGetResourceSchemaResponse(QString json);
    ~OAIGetResourceSchemaResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetResourceSchemaResponse)

#endif // OAIGetResourceSchemaResponse_H
