...
/*
 * OAIConsumerConnection.h
 *
 * 
 */

#ifndef OAIConsumerConnection_H
#define OAIConsumerConnection_H
...
class OAIConsumerConnection : public OAIObject {
public:
    OAIConsumerConnection();
    OAIConsumerConnection(QString json);
    ~OAIConsumerConnection() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConsumerConnection)

#endif // OAIConsumerConnection_H
