...
OAIConnection OAIUpdateConnectionResponse::getData() const {
    return m_data;
}
void OAIUpdateConnectionResponse::setData(const OAIConnection &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIUpdateConnectionResponse::is_data_Set() const{
    return m_data_isSet;
}

bool OAIUpdateConnectionResponse::is_data_Valid() const{
    return m_data_isValid;
}

QString OAIUpdateConnectionResponse::getStatus() const {
    return m_status;
}
void OAIUpdateConnectionResponse::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIUpdateConnectionResponse::is_status_Set() const{
    return m_status_isSet;
}

bool OAIUpdateConnectionResponse::is_status_Valid() const{
    return m_status_isValid;
}

qint32 OAIUpdateConnectionResponse::getStatusCode() const {
    return m_status_code;
}
void OAIUpdateConnectionResponse::setStatusCode(const qint32 &status_code) {
    m_status_code = status_code;
    m_status_code_isSet = true;
}

bool OAIUpdateConnectionResponse::is_status_code_Set() const{
    return m_status_code_isSet;
}

bool OAIUpdateConnectionResponse::is_status_code_Valid() const{
