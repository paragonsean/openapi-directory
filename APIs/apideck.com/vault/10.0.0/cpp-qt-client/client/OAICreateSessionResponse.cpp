...
OAICreateSessionResponse_data OAICreateSessionResponse::getData() const {
    return m_data;
}
void OAICreateSessionResponse::setData(const OAICreateSessionResponse_data &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAICreateSessionResponse::is_data_Set() const{
    return m_data_isSet;
}

bool OAICreateSessionResponse::is_data_Valid() const{
    return m_data_isValid;
}

QString OAICreateSessionResponse::getStatus() const {
    return m_status;
}
void OAICreateSessionResponse::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAICreateSessionResponse::is_status_Set() const{
    return m_status_isSet;
}

bool OAICreateSessionResponse::is_status_Valid() const{
    return m_status_isValid;
}

qint32 OAICreateSessionResponse::getStatusCode() const {
    return m_status_code;
}
void OAICreateSessionResponse::setStatusCode(const qint32 &status_code) {
    m_status_code = status_code;
    m_status_code_isSet = true;
}

bool OAICreateSessionResponse::is_status_code_Set() const{
    return m_status_code_isSet;
}

bool OAICreateSessionResponse::is_status_code_Valid() const{
