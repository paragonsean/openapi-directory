...
#ifndef OAICustomMapping_H
#define OAICustomMapping_H
...
class OAICustomMapping : public OAIObject {
public:
    OAICustomMapping();
    OAICustomMapping(QString json);
    ~OAICustomMapping() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomMapping)

#endif // OAICustomMapping_H
