...
/**
 * Gets or Sets VaultEventType
 */
@JsonAdapter(VaultEventType.Adapter.class)
public enum VaultEventType {
  ...
  public static VaultEventType fromValue(String value) {
    for (VaultEventType b : VaultEventType.values()) {
  ...
  public static class Adapter extends TypeAdapter<VaultEventType> {
    @Override
    public void write(final JsonWriter jsonWriter, final VaultEventType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public VaultEventType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return VaultEventType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    VaultEventType.fromValue(value);
  }
}
