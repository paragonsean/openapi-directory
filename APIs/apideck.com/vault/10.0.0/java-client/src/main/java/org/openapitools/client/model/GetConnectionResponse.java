...
public class GetConnectionResponse {
  ...
  public GetConnectionResponse data(Connection data) {
    this.data = data;
    return this;
  }
  ...
  public GetConnectionResponse status(String status) {
    this.status = status;
    return this;
  }
  ...
  public GetConnectionResponse statusCode(Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, getConnectionResponse.data) &&
        Objects.equals(this.status, getConnectionResponse.status) &&
        Objects.equals(this.statusCode, getConnectionResponse.statusCode);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : GetConnectionResponse.openapiRequiredFields) {
