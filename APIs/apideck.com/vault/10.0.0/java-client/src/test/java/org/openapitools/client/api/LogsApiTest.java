...
import org.openapitools.client.model.GetLogsResponse;
import org.openapitools.client.model.LogsFilter;
...
public class LogsApiTest {
     ...
     */
    @Test
    public void logsAllTest() throws ApiException {
        String xApideckAppId = null;
        String xApideckConsumerId = null;
        LogsFilter filter = null;
        String cursor = null;
        Integer limit = null;
        GetLogsResponse response = api.logsAll(xApideckAppId, xApideckConsumerId, filter, cursor, limit);
