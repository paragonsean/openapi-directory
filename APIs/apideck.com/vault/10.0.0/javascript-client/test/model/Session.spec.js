...
(function(root, factory) {
  ...
  describe('Session', function() {
    it('should create an instance of Session', function() {
      ...
      //var instance = new VaultApi.Session();
      //expect(instance).to.be.a(VaultApi.Session);
    });

    it('should have the property consumerMetadata (base name: "consumer_metadata")', function() {
      // uncomment below and update the code to test the property consumerMetadata
      //var instance = new VaultApi.Session();
      //expect(instance).to.be();
    });

    it('should have the property customConsumerSettings (base name: "custom_consumer_settings")', function() {
      // uncomment below and update the code to test the property customConsumerSettings
      //var instance = new VaultApi.Session();
      //expect(instance).to.be();
    });
