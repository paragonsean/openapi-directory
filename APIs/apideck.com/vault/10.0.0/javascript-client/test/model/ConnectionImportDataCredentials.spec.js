...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VaultApi.ConnectionImportDataCredentials();
  });
  ...
  describe('ConnectionImportDataCredentials', function() {
    it('should create an instance of ConnectionImportDataCredentials', function() {
      // uncomment below and update the code to test ConnectionImportDataCredentials
      //var instance = new VaultApi.ConnectionImportDataCredentials();
      //expect(instance).to.be.a(VaultApi.ConnectionImportDataCredentials);
    });
