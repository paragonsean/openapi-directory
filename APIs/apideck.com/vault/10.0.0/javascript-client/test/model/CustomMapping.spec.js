...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VaultApi.CustomMapping();
  });
  ...
  describe('CustomMapping', function() {
    it('should create an instance of CustomMapping', function() {
      // uncomment below and update the code to test CustomMapping
      //var instance = new VaultApi.CustomMapping();
      //expect(instance).to.be.a(VaultApi.CustomMapping);
    });
