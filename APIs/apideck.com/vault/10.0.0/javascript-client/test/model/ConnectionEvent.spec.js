...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VaultApi.ConnectionEvent();
  });
  ...
  describe('ConnectionEvent', function() {
    it('should create an instance of ConnectionEvent', function() {
      // uncomment below and update the code to test ConnectionEvent
      //var instance = new VaultApi.ConnectionEvent();
      //expect(instance).to.be.a(VaultApi.ConnectionEvent);
    });
