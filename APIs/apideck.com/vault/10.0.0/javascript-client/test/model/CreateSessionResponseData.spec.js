...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VaultApi.CreateSessionResponseData();
  });
  ...
  describe('CreateSessionResponseData', function() {
    it('should create an instance of CreateSessionResponseData', function() {
      // uncomment below and update the code to test CreateSessionResponseData
      //var instance = new VaultApi.CreateSessionResponseData();
      //expect(instance).to.be.a(VaultApi.CreateSessionResponseData);
    });
