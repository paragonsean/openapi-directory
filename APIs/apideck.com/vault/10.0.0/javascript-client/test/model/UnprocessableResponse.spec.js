...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VaultApi.UnprocessableResponse();
  });
  ...
  describe('UnprocessableResponse', function() {
    it('should create an instance of UnprocessableResponse', function() {
      // uncomment below and update the code to test UnprocessableResponse
      //var instance = new VaultApi.UnprocessableResponse();
      //expect(instance).to.be.a(VaultApi.UnprocessableResponse);
    });
