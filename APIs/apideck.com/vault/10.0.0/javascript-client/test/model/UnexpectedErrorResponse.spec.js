...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VaultApi.UnexpectedErrorResponse();
  });
  ...
  describe('UnexpectedErrorResponse', function() {
    it('should create an instance of UnexpectedErrorResponse', function() {
      // uncomment below and update the code to test UnexpectedErrorResponse
      //var instance = new VaultApi.UnexpectedErrorResponse();
      //expect(instance).to.be.a(VaultApi.UnexpectedErrorResponse);
    });
