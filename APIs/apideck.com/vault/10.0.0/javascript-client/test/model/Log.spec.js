...
(function(root, factory) {
  ...
  describe('Log', function() {
    it('should create an instance of Log', function() {
      ...
      //var instance = new VaultApi.Log();
      //expect(instance).to.be.a(VaultApi.Log);
    });

    it('should have the property apiStyle (base name: "api_style")', function() {
    ...
    it('should have the property childRequest (base name: "child_request")', function() {
      // uncomment below and update the code to test the property childRequest
      //var instance = new VaultApi.Log();
      //expect(instance).to.be();
    });
