...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VaultApi.NotImplementedResponse();
  });
  ...
  describe('NotImplementedResponse', function() {
    it('should create an instance of NotImplementedResponse', function() {
      // uncomment below and update the code to test NotImplementedResponse
      //var instance = new VaultApi.NotImplementedResponse();
      //expect(instance).to.be.a(VaultApi.NotImplementedResponse);
    });
