...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VaultApi.FormField();
  });
  ...
  describe('FormField', function() {
    it('should create an instance of FormField', function() {
      ...
      //var instance = new VaultApi.FormField();
      //expect(instance).to.be.a(VaultApi.FormField);
    });

    it('should have the property allowCustomValues (base name: "allow_custom_values")', function() {
