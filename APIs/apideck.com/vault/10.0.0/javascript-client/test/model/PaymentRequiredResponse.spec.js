...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VaultApi.PaymentRequiredResponse();
  });
  ...
  describe('PaymentRequiredResponse', function() {
    it('should create an instance of PaymentRequiredResponse', function() {
      // uncomment below and update the code to test PaymentRequiredResponse
      //var instance = new VaultApi.PaymentRequiredResponse();
      //expect(instance).to.be.a(VaultApi.PaymentRequiredResponse);
    });
