...
/**
 * The ConsumerMetadata model module.
 * @module model/ConsumerMetadata
 * @version 10.0.0
 */
class ConsumerMetadata {
    /**
     * Constructs a new <code>ConsumerMetadata</code>.
     * The metadata of the consumer. This is used to display the consumer in the sidebar. This is optional, but recommended.
     * @alias module:model/ConsumerMetadata
     */
    constructor() { 
        
        ConsumerMetadata.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ConsumerMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ConsumerMetadata} obj Optional instance to populate.
     * @return {module:model/ConsumerMetadata} The populated <code>ConsumerMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ConsumerMetadata();
    ...
    /**
     * Validates the JSON data with respect to <code>ConsumerMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConsumerMetadata</code>.
     */
 ...
 */
ConsumerMetadata.prototype['account_name'] = undefined;

/**
 * The email of the user as shown in the sidebar.
 * @member {String} email
 */
ConsumerMetadata.prototype['email'] = undefined;

/**
 * The avatar of the user in the sidebar. Must be a valid URL
 * @member {String} image
 */
ConsumerMetadata.prototype['image'] = undefined;

/**
 * The name of the user as shown in the sidebar.
 * @member {String} user_name
 */
ConsumerMetadata.prototype['user_name'] = undefined;
