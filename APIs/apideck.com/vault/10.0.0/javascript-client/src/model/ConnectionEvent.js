...
import VaultEventType from './VaultEventType';

/**
 * The ConnectionEvent model module.
 * @module model/ConnectionEvent
 * @version 10.0.0
 */
class ConnectionEvent {
    /**
     * Constructs a new <code>ConnectionEvent</code>.
     * @alias module:model/ConnectionEvent
     */
    constructor() { 
        
        ConnectionEvent.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ConnectionEvent</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ConnectionEvent} obj Optional instance to populate.
     * @return {module:model/ConnectionEvent} The populated <code>ConnectionEvent</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ConnectionEvent();

            if (data.hasOwnProperty('entity')) {
                obj['entity'] = ConsumerConnection.constructFromObject(data['entity']);
            }
            ...
            if (data.hasOwnProperty('event_type')) {
                obj['event_type'] = VaultEventType.constructFromObject(data['event_type']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ConnectionEvent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConnectionEvent</code>.
     */
    static validateJSON(data) {
        // validate the optional field `entity`
        if (data['entity']) { // data not null
          ConsumerConnection.validateJSON(data['entity']);
        }
...
/**
 * @member {module:model/ConsumerConnection} entity
 */
ConnectionEvent.prototype['entity'] = undefined;

/**
 * The service provider's ID of the entity that triggered this event
 * @member {String} entity_id
 */
ConnectionEvent.prototype['entity_id'] = undefined;

/**
 * The type entity that triggered this event
 * @member {String} entity_type
 */
ConnectionEvent.prototype['entity_type'] = undefined;

/**
 * Unique reference to this request event
 * @member {String} event_id
 */
ConnectionEvent.prototype['event_id'] = undefined;

/**
 * @member {module:model/VaultEventType} event_type
 */
ConnectionEvent.prototype['event_type'] = undefined;

/**
 * The current count this request event has been attempted
 * @member {Number} execution_attempt
 */
ConnectionEvent.prototype['execution_attempt'] = undefined;

/**
 * ISO Datetime for when the original event occurred
 * @member {String} occurred_at
 */
ConnectionEvent.prototype['occurred_at'] = undefined;

/**
 * Service provider identifier
 * @member {String} service_id
 */
ConnectionEvent.prototype['service_id'] = undefined;
