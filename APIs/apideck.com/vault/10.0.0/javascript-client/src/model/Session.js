...
class Session {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('consumer_metadata')) {
                obj['consumer_metadata'] = ConsumerMetadata.constructFromObject(data['consumer_metadata']);
            }
            if (data.hasOwnProperty('custom_consumer_settings')) {
                obj['custom_consumer_settings'] = ApiClient.convertToType(data['custom_consumer_settings'], {'String': Object});
            }
            if (data.hasOwnProperty('redirect_uri')) {
                obj['redirect_uri'] = ApiClient.convertToType(data['redirect_uri'], 'String');
            }
            if (data.hasOwnProperty('settings')) {
                obj['settings'] = SessionSettings.constructFromObject(data['settings']);
            }
            if (data.hasOwnProperty('theme')) {
                obj['theme'] = SessionTheme.constructFromObject(data['theme']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['consumer_metadata']) { // data not null
          ConsumerMetadata.validateJSON(data['consumer_metadata']);
        }
        ...
        if (data['settings']) { // data not null
          SessionSettings.validateJSON(data['settings']);
        }
        // validate the optional field `theme`
        if (data['theme']) { // data not null
          SessionTheme.validateJSON(data['theme']);
        }
...
/**
 * @member {module:model/ConsumerMetadata} consumer_metadata
 */
Session.prototype['consumer_metadata'] = undefined;

/**
 * Custom consumer settings that are passed as part of the session.
 * @member {Object.<String, Object>} custom_consumer_settings
 */
Session.prototype['custom_consumer_settings'] = undefined;
...
/**
 * @member {module:model/SessionSettings} settings
 */
Session.prototype['settings'] = undefined;

/**
 * @member {module:model/SessionTheme} theme
 */
Session.prototype['theme'] = undefined;
