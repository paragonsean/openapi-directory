...
class LogOperation {
     ...
     * @param id {String} The OpenApi Operation Id associated with the request
     * @param name {String} The OpenApi Operation name associated with the request
     */
    constructor(id, name) { 
        
        LogOperation.initialize(this, id, name);
    }
...
LogOperation.RequiredProperties = ["id", "name"];
