...
* @readonly
*/
export default class VaultEventType {
    ...
    /**
    * Returns a <code>VaultEventType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/VaultEventType} The enum <code>VaultEventType</code> value.
    */
