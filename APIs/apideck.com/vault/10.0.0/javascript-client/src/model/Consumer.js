...
class Consumer {
     ...
     * @param consumerId {String} Unique consumer identifier. You can freely choose a consumer ID yourself. Most of the time, this is an ID of your internal data model that represents a user or account in your system (for example account:12345). If the consumer doesn't exist yet, Vault will upsert a consumer based on your ID.
     */
    constructor(consumerId) { 
        
        Consumer.initialize(this, consumerId);
    }
     ...
     */
    static initialize(obj, consumerId) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('aggregated_request_count')) {
                obj['aggregated_request_count'] = ApiClient.convertToType(data['aggregated_request_count'], 'Number');
            }
            if (data.hasOwnProperty('application_id')) {
                obj['application_id'] = ApiClient.convertToType(data['application_id'], 'String');
            }
            if (data.hasOwnProperty('connections')) {
                obj['connections'] = ApiClient.convertToType(data['connections'], [ConsumerConnection]);
            }
            ...
            if (data.hasOwnProperty('metadata')) {
                obj['metadata'] = ConsumerMetadata.constructFromObject(data['metadata']);
            }
            if (data.hasOwnProperty('modified')) {
                obj['modified'] = ApiClient.convertToType(data['modified'], 'String');
            }
            if (data.hasOwnProperty('request_count_updated')) {
                obj['request_count_updated'] = ApiClient.convertToType(data['request_count_updated'], 'String');
            }
            if (data.hasOwnProperty('request_counts')) {
                obj['request_counts'] = RequestCountAllocation.constructFromObject(data['request_counts']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['connections']) { // data not null
            ...
            for (const item of data['connections']) {
                ConsumerConnection.validateJSON(item);
            };
        }
        // ensure the json data is a string
        ...
        if (data['metadata']) { // data not null
          ConsumerMetadata.validateJSON(data['metadata']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['request_count_updated'] && !(typeof data['request_count_updated'] === 'string' || data['request_count_updated'] instanceof String)) {
            throw new Error("Expected the field `request_count_updated` to be a primitive type in the JSON string but got " + data['request_count_updated']);
        }
        // validate the optional field `request_counts`
        if (data['request_counts']) { // data not null
          RequestCountAllocation.validateJSON(data['request_counts']);
        }
        // ensure the json data is an array
...
Consumer.RequiredProperties = ["consumer_id"];

/**
 * @member {Number} aggregated_request_count
 */
Consumer.prototype['aggregated_request_count'] = undefined;

/**
 * ID of your Apideck Application
 * @member {String} application_id
 */
Consumer.prototype['application_id'] = undefined;

/**
 * @member {Array.<module:model/ConsumerConnection>} connections
 */
Consumer.prototype['connections'] = undefined;

/**
 * Unique consumer identifier. You can freely choose a consumer ID yourself. Most of the time, this is an ID of your internal data model that represents a user or account in your system (for example account:12345). If the consumer doesn't exist yet, Vault will upsert a consumer based on your ID.
 * @member {String} consumer_id
 */
Consumer.prototype['consumer_id'] = undefined;

/**
 * @member {String} created
 */
Consumer.prototype['created'] = undefined;

/**
 * @member {module:model/ConsumerMetadata} metadata
 */
Consumer.prototype['metadata'] = undefined;

/**
 * @member {String} modified
 */
Consumer.prototype['modified'] = undefined;

/**
 * @member {String} request_count_updated
 */
Consumer.prototype['request_count_updated'] = undefined;

/**
 * @member {module:model/RequestCountAllocation} request_counts
 */
Consumer.prototype['request_counts'] = undefined;

/**
 * @member {Array.<String>} services
 */
Consumer.prototype['services'] = undefined;
