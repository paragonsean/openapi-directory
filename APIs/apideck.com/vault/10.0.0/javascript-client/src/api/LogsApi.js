...
export default class LogsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the logsAll operation.
     * @callback module:api/LogsApi~logsAllCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GetLogsResponse} data The data returned by the service call.
     ...
     * @param {module:model/LogsFilter} [filter] Filter results
     ...
     * @param {module:api/LogsApi~logsAllCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetLogsResponse}
     */
    logsAll(xApideckAppId, xApideckConsumerId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'xApideckAppId' is set
      if (xApideckAppId === undefined || xApideckAppId === null) {
        throw new Error("Missing the required parameter 'xApideckAppId' when calling logsAll");
      }
      // verify the required parameter 'xApideckConsumerId' is set
      if (xApideckConsumerId === undefined || xApideckConsumerId === null) {
        throw new Error("Missing the required parameter 'xApideckConsumerId' when calling logsAll");
      }
      ...
      let returnType = GetLogsResponse;
