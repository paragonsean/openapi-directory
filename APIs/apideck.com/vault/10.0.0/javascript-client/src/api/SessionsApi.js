...
export default class SessionsApi {
    ...
    */
     ...
     * @param {module:model/Session} [session] Additional redirect uri and/or consumer metadata
     ...
     */
    sessionsCreate(xApideckConsumerId, xApideckAppId, opts, callback) {
      opts = opts || {};
      ...
      if (xApideckConsumerId === undefined || xApideckConsumerId === null) {
        throw new Error("Missing the required parameter 'xApideckConsumerId' when calling sessionsCreate");
      }
      // verify the required parameter 'xApideckAppId' is set
      if (xApideckAppId === undefined || xApideckAppId === null) {
        throw new Error("Missing the required parameter 'xApideckAppId' when calling sessionsCreate");
      }
