...
**configurableResources** | **[String]** |  | [optional] [readonly] 
**configuration** | [**[ConnectionConfigurationInner]**](ConnectionConfigurationInner.md) |  | [optional] 
**createdAt** | **Number** |  | [optional] [readonly] 
**customMappings** | [**[CustomMapping]**](CustomMapping.md) | List of custom mappings configured for this connection | [optional] 
...
**formFields** | [**[FormField]**](FormField.md) | The settings that are wanted to create a connection. | [optional] [readonly] 
...
**integrationState** | [**IntegrationState**](IntegrationState.md) |  | [optional] 
**logo** | **String** | The logo of the connection, that will be shown in the Vault | [optional] [readonly] 
**metadata** | **{String: Object}** | Attach your own consumer specific metadata | [optional] 
**name** | **String** | The name of the connection | [optional] [readonly] 
**oauthGrantType** | [**OAuthGrantType**](OAuthGrantType.md) |  | [optional] 
**resourceSchemaSupport** | **[String]** |  | [optional] [readonly] 
**resourceSettingsSupport** | **[String]** |  | [optional] [readonly] 
...
**settings** | **{String: Object}** | Connection settings. Values will persist to &#x60;form_fields&#x60; with corresponding id | [optional] 
**settingsRequiredForAuthorization** | **[String]** | List of settings that are required to be configured on integration before authorization can occur | [optional] [readonly] 
