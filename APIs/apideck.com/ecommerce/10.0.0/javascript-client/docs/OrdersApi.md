...
> GetEcommerceOrdersResponse ordersAll(xApideckConsumerId, xApideckAppId, opts)
...
let apiInstance = new EcommerceApi.OrdersApi();
...
let opts = {
  ...
  'filter': new EcommerceApi.EcommerceOrdersFilter(), // EcommerceOrdersFilter | Apply filters
...
> GetEcommerceOrderResponse ordersOne(id, xApideckConsumerId, xApideckAppId, opts)
