...
> GetEcommerceCustomersResponse customersAll(xApideckConsumerId, xApideckAppId, opts)
...
let apiInstance = new EcommerceApi.CustomersApi();
...
> GetEcommerceCustomerResponse customersOne(id, xApideckConsumerId, xApideckAppId, opts)
