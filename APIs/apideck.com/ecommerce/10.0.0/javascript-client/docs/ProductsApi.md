# EcommerceApi.ProductsApi

All URIs are relative to *https://unify.apideck.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**productsAll**](ProductsApi.md#productsAll) | **GET** /ecommerce/products | List Products
[**productsOne**](ProductsApi.md#productsOne) | **GET** /ecommerce/products/{id} | Get Product



## productsAll

> GetProductsResponse productsAll(xApideckConsumerId, xApideckAppId, opts)
...
let apiInstance = new EcommerceApi.ProductsApi();
...
apiInstance.productsAll(xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> GetProductResponse productsOne(id, xApideckConsumerId, xApideckAppId, opts)
...
apiInstance.productsOne(id, xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
