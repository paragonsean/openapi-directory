...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.expect, root.EcommerceApi);
  }
}(this, function(expect, EcommerceApi) {
  'use strict';

  var instance;

  beforeEach(function() {
    instance = new EcommerceApi.Address();
  });
  ...
  describe('Address', function() {
    it('should create an instance of Address', function() {
      ...
      //var instance = new EcommerceApi.Address();
      //expect(instance).to.be.a(EcommerceApi.Address);
    });
