...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EcommerceApi.EcommerceOrderLineItem();
  });
  ...
  describe('EcommerceOrderLineItem', function() {
    it('should create an instance of EcommerceOrderLineItem', function() {
      // uncomment below and update the code to test EcommerceOrderLineItem
      //var instance = new EcommerceApi.EcommerceOrderLineItem();
      //expect(instance).to.be.a(EcommerceApi.EcommerceOrderLineItem);
    });
