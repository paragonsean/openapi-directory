...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EcommerceApi.EcommerceOrder();
  });
  ...
  describe('EcommerceOrder', function() {
    it('should create an instance of EcommerceOrder', function() {
      // uncomment below and update the code to test EcommerceOrder
      //var instance = new EcommerceApi.EcommerceOrder();
      //expect(instance).to.be.a(EcommerceApi.EcommerceOrder);
    });
