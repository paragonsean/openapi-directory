...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EcommerceApi.EcommerceCustomer();
  });
  ...
  describe('EcommerceCustomer', function() {
    it('should create an instance of EcommerceCustomer', function() {
      // uncomment below and update the code to test EcommerceCustomer
      //var instance = new EcommerceApi.EcommerceCustomer();
      //expect(instance).to.be.a(EcommerceApi.EcommerceCustomer);
    });
