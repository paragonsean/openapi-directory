...
/**
 * The EcommerceAddress model module.
 * @module model/EcommerceAddress
 * @version 10.0.0
 */
class EcommerceAddress {
    /**
     * Constructs a new <code>EcommerceAddress</code>.
     * An object representing a shipping or billing address.
     * @alias module:model/EcommerceAddress
     */
    constructor() { 
        
        EcommerceAddress.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EcommerceAddress</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EcommerceAddress} obj Optional instance to populate.
     * @return {module:model/EcommerceAddress} The populated <code>EcommerceAddress</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EcommerceAddress();
    ...
    /**
     * Validates the JSON data with respect to <code>EcommerceAddress</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EcommerceAddress</code>.
     */
 ...
 * @member {String} city
 */
EcommerceAddress.prototype['city'] = undefined;

/**
 * Company name of the customer
 * @member {String} company_name
 */
EcommerceAddress.prototype['company_name'] = undefined;

/**
 * Country of the billing address.
 * @member {String} country
 */
EcommerceAddress.prototype['country'] = undefined;

/**
 * Address line 1 of the billing address.
 * @member {String} line1
 */
EcommerceAddress.prototype['line1'] = undefined;

/**
 * Address line 2 of the billing address.
 * @member {String} line2
 */
EcommerceAddress.prototype['line2'] = undefined;

/**
 * Postal/ZIP code of the billing address.
 * @member {String} postal_code
 */
EcommerceAddress.prototype['postal_code'] = undefined;

/**
 * State/province of the billing address.
 * @member {String} state
 */
EcommerceAddress.prototype['state'] = undefined;
