...
class GetProductsResponse {
     ...
     * @param data {Array.<module:model/EcommerceProduct>} 
    ...
    constructor(data, operation, resource, service, status, statusCode) { 
        ...
        GetProductsResponse.initialize(this, data, operation, resource, service, status, statusCode);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [EcommerceProduct]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['data']) { // data not null
            ...
            for (const item of data['data']) {
                EcommerceProduct.validateJSON(item);
            };
        }
...
GetProductsResponse.RequiredProperties = ["data", "operation", "resource", "service", "status", "status_code"];

/**
 * @member {Array.<module:model/EcommerceProduct>} data
 */
 ...
 */
GetProductsResponse.prototype['operation'] = undefined;

/**
 * Unified API resource name
 * @member {String} resource
 */
GetProductsResponse.prototype['resource'] = undefined;

/**
 * Apideck ID of service provider
 * @member {String} service
 */
GetProductsResponse.prototype['service'] = undefined;
