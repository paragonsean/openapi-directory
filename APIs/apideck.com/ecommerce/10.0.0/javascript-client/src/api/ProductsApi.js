...
export default class ProductsApi {
    ...
    */
     ...
     * @callback module:api/ProductsApi~productsAllCallback
     ...
     * @param {module:api/ProductsApi~productsAllCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetProductsResponse}
     */
    productsAll(xApideckConsumerId, xApideckAppId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'xApideckConsumerId' is set
      if (xApideckConsumerId === undefined || xApideckConsumerId === null) {
        throw new Error("Missing the required parameter 'xApideckConsumerId' when calling productsAll");
      }
      // verify the required parameter 'xApideckAppId' is set
      if (xApideckAppId === undefined || xApideckAppId === null) {
        throw new Error("Missing the required parameter 'xApideckAppId' when calling productsAll");
      }
     ...
     * @callback module:api/ProductsApi~productsOneCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Boolean} [raw = false)] Include raw response. Mostly used for debugging purposes
     * @param {String} [fields] The 'fields' parameter allows API users to specify the fields they want to include in the API response. If this parameter is not present, the API will return all available fields. If this parameter is present, only the fields specified in the comma-separated string will be included in the response. Nested properties can also be requested by using a dot notation. <br /><br />Example: `fields=name,email,addresses.city`<br /><br />In the example above, the response will only include the fields \"name\", \"email\" and \"addresses.city\". If any other fields are available, they will be excluded.
     * @param {module:api/ProductsApi~productsOneCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetProductResponse}
     */
    productsOne(id, xApideckConsumerId, xApideckAppId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      // verify the required parameter 'xApideckConsumerId' is set
      if (xApideckConsumerId === undefined || xApideckConsumerId === null) {
        throw new Error("Missing the required parameter 'xApideckConsumerId' when calling productsOne");
      }
      // verify the required parameter 'xApideckAppId' is set
      if (xApideckAppId === undefined || xApideckAppId === null) {
        throw new Error("Missing the required parameter 'xApideckAppId' when calling productsOne");
      }
