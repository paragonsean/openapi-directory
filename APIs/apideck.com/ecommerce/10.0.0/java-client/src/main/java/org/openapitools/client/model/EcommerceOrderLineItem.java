...
import org.openapitools.client.model.EcommerceOrderLineItemOptionsInner;
...
public class EcommerceOrderLineItem {
  ...
  private List<EcommerceOrderLineItemOptionsInner> options = new ArrayList<>();
  ...
  public EcommerceOrderLineItem description(String description) {
  ...
  public EcommerceOrderLineItem discounts(List<EcommerceDiscount> discounts) {
    this.discounts = discounts;
    return this;
  }

  public EcommerceOrderLineItem addDiscountsItem(EcommerceDiscount discountsItem) {
  ...
  public EcommerceOrderLineItem name(String name) {
    this.name = name;
    return this;
  }
  ...
  public EcommerceOrderLineItem options(List<EcommerceOrderLineItemOptionsInner> options) {
    this.options = options;
    return this;
  }

  public EcommerceOrderLineItem addOptionsItem(EcommerceOrderLineItemOptionsInner optionsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<EcommerceOrderLineItemOptionsInner> getOptions() {
    return options;
  }

  public void setOptions(List<EcommerceOrderLineItemOptionsInner> options) {
    this.options = options;
  }
  ...
  public EcommerceOrderLineItem quantity(String quantity) {
  ...
  public EcommerceOrderLineItem sku(String sku) {
    this.sku = sku;
    return this;
  }
  ...
  public EcommerceOrderLineItem taxAmount(String taxAmount) {
  ...
  public EcommerceOrderLineItem taxRate(String taxRate) {
  ...
  public EcommerceOrderLineItem totalAmount(String totalAmount) {
  ...
  public EcommerceOrderLineItem unitPrice(String unitPrice) {
  ...
  public EcommerceOrderLineItem variantId(String variantId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, ecommerceOrderLineItem.description) &&
        Objects.equals(this.discounts, ecommerceOrderLineItem.discounts) &&
        Objects.equals(this.id, ecommerceOrderLineItem.id) &&
        Objects.equals(this.name, ecommerceOrderLineItem.name) &&
        Objects.equals(this.options, ecommerceOrderLineItem.options) &&
        ...
        Objects.equals(this.sku, ecommerceOrderLineItem.sku) &&
        Objects.equals(this.taxAmount, ecommerceOrderLineItem.taxAmount) &&
        Objects.equals(this.taxRate, ecommerceOrderLineItem.taxRate) &&
        Objects.equals(this.totalAmount, ecommerceOrderLineItem.totalAmount) &&
        Objects.equals(this.unitPrice, ecommerceOrderLineItem.unitPrice) &&
        Objects.equals(this.variantId, ecommerceOrderLineItem.variantId);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, discounts, id, name, options, productId, quantity, sku, taxAmount, taxRate, totalAmount, unitPrice, variantId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to EcommerceOrderLineItem
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EcommerceOrderLineItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EcommerceOrderLineItem is not found in the empty JSON string", EcommerceOrderLineItem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EcommerceOrderLineItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EcommerceOrderLineItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EcommerceOrderLineItem.openapiRequiredFields) {
      ...
      if (jsonObj.get("options") != null && !jsonObj.get("options").isJsonNull()) {
        ...
        if (jsonArrayoptions != null) {
          ...
          for (int i = 0; i < jsonArrayoptions.size(); i++) {
            EcommerceOrderLineItemOptionsInner.validateJsonElement(jsonArrayoptions.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EcommerceOrderLineItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EcommerceOrderLineItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EcommerceOrderLineItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EcommerceOrderLineItem.class));

       return (TypeAdapter<T>) new TypeAdapter<EcommerceOrderLineItem>() {
           @Override
           public void write(JsonWriter out, EcommerceOrderLineItem value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EcommerceOrderLineItem read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EcommerceOrderLineItem given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EcommerceOrderLineItem
   * @throws IOException if the JSON string is invalid with respect to EcommerceOrderLineItem
   */
  public static EcommerceOrderLineItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EcommerceOrderLineItem.class);
  }

  /**
   * Convert an instance of EcommerceOrderLineItem to an JSON string
   *
   * @return JSON string
   */
