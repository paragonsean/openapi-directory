...
public class Meta {
  ...
  public static final String SERIALIZED_NAME_ITEMS_ON_PAGE = "items_on_page";
  ...
  public Meta cursors(MetaCursors cursors) {
  ...
  public MetaCursors getCursors() {
    return cursors;
  }

  public void setCursors(MetaCursors cursors) {
    this.cursors = cursors;
  }


  public Meta itemsOnPage(Integer itemsOnPage) {
  ...
  public boolean equals(Object o) {
    ...
    Meta meta = (Meta) o;
    return Objects.equals(this.cursors, meta.cursors) &&
        Objects.equals(this.itemsOnPage, meta.itemsOnPage);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cursors, itemsOnPage);
  }
  ...
  static {
    ...
    openapiFields.add("items_on_page");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("cursors") != null && !jsonObj.get("cursors").isJsonNull()) {
        MetaCursors.validateJsonElement(jsonObj.get("cursors"));
      }
  }
