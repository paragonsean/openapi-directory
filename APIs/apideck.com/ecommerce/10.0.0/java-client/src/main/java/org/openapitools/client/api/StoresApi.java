...
import org.openapitools.client.model.GetStoreResponse;
...
public class StoresApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> Stores </td><td>  -  </td></tr>
     ...
     */
    public okhttp3.Call storesOneCall(String xApideckConsumerId, String xApideckAppId, String xApideckServiceId, Boolean raw, String fields, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/ecommerce/store";
    ...
    private okhttp3.Call storesOneValidateBeforeCall(String xApideckConsumerId, String xApideckAppId, String xApideckServiceId, Boolean raw, String fields, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'xApideckConsumerId' is set
        if (xApideckConsumerId == null) {
            throw new ApiException("Missing the required parameter 'xApideckConsumerId' when calling storesOne(Async)");
        }

        // verify the required parameter 'xApideckAppId' is set
        if (xApideckAppId == null) {
            throw new ApiException("Missing the required parameter 'xApideckAppId' when calling storesOne(Async)");
        }

        return storesOneCall(xApideckConsumerId, xApideckAppId, xApideckServiceId, raw, fields, _callback);
     ...
     */
    public GetStoreResponse storesOne(String xApideckConsumerId, String xApideckAppId, String xApideckServiceId, Boolean raw, String fields) throws ApiException {
        ApiResponse<GetStoreResponse> localVarResp = storesOneWithHttpInfo(xApideckConsumerId, xApideckAppId, xApideckServiceId, raw, fields);
     ...
     */
    public ApiResponse<GetStoreResponse> storesOneWithHttpInfo(String xApideckConsumerId, String xApideckAppId, String xApideckServiceId, Boolean raw, String fields) throws ApiException {
        okhttp3.Call localVarCall = storesOneValidateBeforeCall(xApideckConsumerId, xApideckAppId, xApideckServiceId, raw, fields, null);
        Type localVarReturnType = new TypeToken<GetStoreResponse>(){}.getType();
     ...
     */
    public okhttp3.Call storesOneAsync(String xApideckConsumerId, String xApideckAppId, String xApideckServiceId, Boolean raw, String fields, final ApiCallback<GetStoreResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = storesOneValidateBeforeCall(xApideckConsumerId, xApideckAppId, xApideckServiceId, raw, fields, _callback);
        Type localVarReturnType = new TypeToken<GetStoreResponse>(){}.getType();
