...
class Example : public QObject {
    ...
    QString create();
    qint32 create();
    OAIEcommerceCustomersFilter create();
    OAIPassThroughQuery create();
    QString create();
public Q_SLOTS:
...
qint32 Example::create(){
    qint32 obj;
OAIEcommerceCustomersFilter Example::create(){
    OAIEcommerceCustomersFilter obj;
OAIPassThroughQuery Example::create(){
    OAIPassThroughQuery obj;
QString Example::create(){
    QString obj;
 return obj;
}
...
void Example::exampleFunction1(){
     OAICustomersApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAICustomersApi::customersAllSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAICustomersApi::customersAllSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
      ...
      bool raw = create(); // bool | Include raw response. Mostly used for debugging purposes
      ...
      QString x_apideck_service_id = create(); // QString | Provide the service id you want to call (e.g., pipedrive). Only needed when a consumer has activated multiple integrations for a Unified API.
      ...
      QString cursor = create(); // QString | Cursor to start from. You can find cursors for next/previous pages in the meta.cursors property of the response.
      ...
      qint32 limit = create(); // qint32 | Number of results to return. Minimum 1, Maximum 200, Default 20
      ...
      OAIEcommerceCustomersFilter filter = create(); // OAIEcommerceCustomersFilter | Apply filters
      ...
      OAIPassThroughQuery pass_through = create(); // OAIPassThroughQuery | Optional unmapped key/values that will be passed through to downstream as query parameters. Ie: ?pass_through[search]=leads becomes ?search=leads
      ...
      QString fields = create(); // QString | The 'fields' parameter allows API users to specify the fields they want to include in the API response. If this parameter is not present, the API will return all available fields. If this parameter is present, only the fields specified in the comma-separated string will be included in the response. Nested properties can also be requested by using a dot notation. <br /><br />Example: `fields=name,email,addresses.city`<br /><br />In the example above, the response will only include the fields \"name\", \"email\" and \"addresses.city\". If any other fields are available, they will be excluded.
      apiInstance.customersAll(x_apideck_consumer_idx_apideck_app_idrawx_apideck_service_idcursorlimitfilterpass_throughfields);
