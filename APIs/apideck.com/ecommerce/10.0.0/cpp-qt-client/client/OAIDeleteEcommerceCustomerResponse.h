...
/*
 * OAIDeleteEcommerceCustomerResponse.h
 *
 * 
 */

#ifndef OAIDeleteEcommerceCustomerResponse_H
#define OAIDeleteEcommerceCustomerResponse_H
...
class OAIDeleteEcommerceCustomerResponse : public OAIObject {
public:
    OAIDeleteEcommerceCustomerResponse();
    OAIDeleteEcommerceCustomerResponse(QString json);
    ~OAIDeleteEcommerceCustomerResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteEcommerceCustomerResponse)

#endif // OAIDeleteEcommerceCustomerResponse_H
