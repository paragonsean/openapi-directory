...
#ifndef OAIEcommerceStore_H
#define OAIEcommerceStore_H
...
class OAIEcommerceStore : public OAIObject {
public:
    OAIEcommerceStore();
    OAIEcommerceStore(QString json);
    ~OAIEcommerceStore() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEcommerceStore)

#endif // OAIEcommerceStore_H
