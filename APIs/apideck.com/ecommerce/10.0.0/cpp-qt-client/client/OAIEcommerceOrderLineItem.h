...
#ifndef OAIEcommerceOrderLineItem_H
#define OAIEcommerceOrderLineItem_H

#include <QJsonObject>

#include "OAIEcommerceDiscount.h"
#include "OAIEcommerceOrderLineItem_options_inner.h"
#include <QList>
#include <QString>
...
class OAIEcommerceOrderLineItem_options_inner;

class OAIEcommerceOrderLineItem : public OAIObject {
public:
    OAIEcommerceOrderLineItem();
    OAIEcommerceOrderLineItem(QString json);
    ~OAIEcommerceOrderLineItem() override;
    ...
    QList<OAIEcommerceOrderLineItem_options_inner> getOptions() const;
    void setOptions(const QList<OAIEcommerceOrderLineItem_options_inner> &options);
...
private:
    ...
    QList<OAIEcommerceOrderLineItem_options_inner> m_options;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEcommerceOrderLineItem)

#endif // OAIEcommerceOrderLineItem_H
