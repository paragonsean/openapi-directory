...
/*
 * OAIDeleteProductResponse.h
 *
 * 
 */

#ifndef OAIDeleteProductResponse_H
#define OAIDeleteProductResponse_H
...
class OAIDeleteProductResponse : public OAIObject {
public:
    OAIDeleteProductResponse();
    OAIDeleteProductResponse(QString json);
    ~OAIDeleteProductResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteProductResponse)

#endif // OAIDeleteProductResponse_H
