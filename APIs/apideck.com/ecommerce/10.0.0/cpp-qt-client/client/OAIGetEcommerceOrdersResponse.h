...
/*
 * OAIGetEcommerceOrdersResponse.h
 *
 * 
 */

#ifndef OAIGetEcommerceOrdersResponse_H
#define OAIGetEcommerceOrdersResponse_H
...
namespace OpenAPI {
class OAIEcommerceOrder;
class OAILinks;
class OAIMeta;

class OAIGetEcommerceOrdersResponse : public OAIObject {
public:
    OAIGetEcommerceOrdersResponse();
    OAIGetEcommerceOrdersResponse(QString json);
    ~OAIGetEcommerceOrdersResponse() override;
    ...
    QList<OAIEcommerceOrder> getData() const;
    void setData(const QList<OAIEcommerceOrder> &data);
...
private:
    ...
    QList<OAIEcommerceOrder> m_data;
    bool m_data_isSet;
    bool m_data_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetEcommerceOrdersResponse)

#endif // OAIGetEcommerceOrdersResponse_H
