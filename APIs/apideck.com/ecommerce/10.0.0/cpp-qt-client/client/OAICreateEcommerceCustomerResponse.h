...
/*
 * OAICreateEcommerceCustomerResponse.h
 *
 * 
 */

#ifndef OAICreateEcommerceCustomerResponse_H
#define OAICreateEcommerceCustomerResponse_H
...
class OAICreateEcommerceCustomerResponse : public OAIObject {
public:
    OAICreateEcommerceCustomerResponse();
    OAICreateEcommerceCustomerResponse(QString json);
    ~OAICreateEcommerceCustomerResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateEcommerceCustomerResponse)

#endif // OAICreateEcommerceCustomerResponse_H
