...
/*
 * OAIGetEcommerceOrderResponse.h
 *
 * 
 */

#ifndef OAIGetEcommerceOrderResponse_H
#define OAIGetEcommerceOrderResponse_H
...
class OAIGetEcommerceOrderResponse : public OAIObject {
public:
    OAIGetEcommerceOrderResponse();
    OAIGetEcommerceOrderResponse(QString json);
    ~OAIGetEcommerceOrderResponse() override;
    ...
    OAIEcommerceOrder getData() const;
    void setData(const OAIEcommerceOrder &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetEcommerceOrderResponse)

#endif // OAIGetEcommerceOrderResponse_H
