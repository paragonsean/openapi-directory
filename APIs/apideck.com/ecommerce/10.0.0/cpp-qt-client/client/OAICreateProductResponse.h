...
/*
 * OAICreateProductResponse.h
 *
 * 
 */

#ifndef OAICreateProductResponse_H
#define OAICreateProductResponse_H
...
class OAICreateProductResponse : public OAIObject {
public:
    OAICreateProductResponse();
    OAICreateProductResponse(QString json);
    ~OAICreateProductResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateProductResponse)

#endif // OAICreateProductResponse_H
