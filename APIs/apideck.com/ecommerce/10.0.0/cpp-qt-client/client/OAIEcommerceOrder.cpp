...
OAIEcommerceOrder::OAIEcommerceOrder(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEcommerceOrder::OAIEcommerceOrder() {
    this->initializeModel();
}

OAIEcommerceOrder::~OAIEcommerceOrder() {}

void OAIEcommerceOrder::initializeModel() {
...
void OAIEcommerceOrder::fromJson(QString jsonString) {
...
void OAIEcommerceOrder::fromJsonObject(QJsonObject json) {
...
QString OAIEcommerceOrder::asJson() const {
...
QJsonObject OAIEcommerceOrder::asJsonObject() const {
    QJsonObject obj;
...
OAIEcommerceAddress OAIEcommerceOrder::getBillingAddress() const {
    return m_billing_address;
}
void OAIEcommerceOrder::setBillingAddress(const OAIEcommerceAddress &billing_address) {
    m_billing_address = billing_address;
    m_billing_address_isSet = true;
}

bool OAIEcommerceOrder::is_billing_address_Set() const{
    return m_billing_address_isSet;
}

bool OAIEcommerceOrder::is_billing_address_Valid() const{
    return m_billing_address_isValid;
}

QDateTime OAIEcommerceOrder::getCreatedAt() const {
    return m_created_at;
}
void OAIEcommerceOrder::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIEcommerceOrder::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIEcommerceOrder::is_created_at_Valid() const{
    return m_created_at_isValid;
}

OAICurrency OAIEcommerceOrder::getCurrency() const {
    return m_currency;
}
void OAIEcommerceOrder::setCurrency(const OAICurrency &currency) {
    m_currency = currency;
    m_currency_isSet = true;
}

bool OAIEcommerceOrder::is_currency_Set() const{
    return m_currency_isSet;
}

bool OAIEcommerceOrder::is_currency_Valid() const{
    return m_currency_isValid;
}

OAIObject OAIEcommerceOrder::getCustomMappings() const {
    return m_custom_mappings;
}
void OAIEcommerceOrder::setCustomMappings(const OAIObject &custom_mappings) {
    m_custom_mappings = custom_mappings;
    m_custom_mappings_isSet = true;
}

bool OAIEcommerceOrder::is_custom_mappings_Set() const{
    return m_custom_mappings_isSet;
}

bool OAIEcommerceOrder::is_custom_mappings_Valid() const{
    return m_custom_mappings_isValid;
}

OAILinkedEcommerceCustomer OAIEcommerceOrder::getCustomer() const {
    return m_customer;
}
void OAIEcommerceOrder::setCustomer(const OAILinkedEcommerceCustomer &customer) {
    m_customer = customer;
    m_customer_isSet = true;
}

bool OAIEcommerceOrder::is_customer_Set() const{
    return m_customer_isSet;
}

bool OAIEcommerceOrder::is_customer_Valid() const{
    return m_customer_isValid;
}

QList<OAIEcommerceDiscount> OAIEcommerceOrder::getDiscounts() const {
    return m_discounts;
}
void OAIEcommerceOrder::setDiscounts(const QList<OAIEcommerceDiscount> &discounts) {
    m_discounts = discounts;
    m_discounts_isSet = true;
}

bool OAIEcommerceOrder::is_discounts_Set() const{
    return m_discounts_isSet;
}

bool OAIEcommerceOrder::is_discounts_Valid() const{
    return m_discounts_isValid;
}

QString OAIEcommerceOrder::getFulfillmentStatus() const {
    return m_fulfillment_status;
}
void OAIEcommerceOrder::setFulfillmentStatus(const QString &fulfillment_status) {
    m_fulfillment_status = fulfillment_status;
    m_fulfillment_status_isSet = true;
}

bool OAIEcommerceOrder::is_fulfillment_status_Set() const{
    return m_fulfillment_status_isSet;
}

bool OAIEcommerceOrder::is_fulfillment_status_Valid() const{
    return m_fulfillment_status_isValid;
}

QString OAIEcommerceOrder::getId() const {
    return m_id;
}
void OAIEcommerceOrder::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIEcommerceOrder::is_id_Set() const{
    return m_id_isSet;
}

bool OAIEcommerceOrder::is_id_Valid() const{
    return m_id_isValid;
}

QList<OAIEcommerceOrderLineItem> OAIEcommerceOrder::getLineItems() const {
    return m_line_items;
}
void OAIEcommerceOrder::setLineItems(const QList<OAIEcommerceOrderLineItem> &line_items) {
    m_line_items = line_items;
    m_line_items_isSet = true;
}

bool OAIEcommerceOrder::is_line_items_Set() const{
    return m_line_items_isSet;
}

bool OAIEcommerceOrder::is_line_items_Valid() const{
    return m_line_items_isValid;
}

QString OAIEcommerceOrder::getNote() const {
    return m_note;
}
void OAIEcommerceOrder::setNote(const QString &note) {
    m_note = note;
    m_note_isSet = true;
}

bool OAIEcommerceOrder::is_note_Set() const{
    return m_note_isSet;
}

bool OAIEcommerceOrder::is_note_Valid() const{
    return m_note_isValid;
}

QString OAIEcommerceOrder::getOrderNumber() const {
    return m_order_number;
}
void OAIEcommerceOrder::setOrderNumber(const QString &order_number) {
    m_order_number = order_number;
    m_order_number_isSet = true;
}

bool OAIEcommerceOrder::is_order_number_Set() const{
    return m_order_number_isSet;
}

bool OAIEcommerceOrder::is_order_number_Valid() const{
    return m_order_number_isValid;
}

QString OAIEcommerceOrder::getPaymentMethod() const {
    return m_payment_method;
}
void OAIEcommerceOrder::setPaymentMethod(const QString &payment_method) {
    m_payment_method = payment_method;
    m_payment_method_isSet = true;
}

bool OAIEcommerceOrder::is_payment_method_Set() const{
    return m_payment_method_isSet;
}

bool OAIEcommerceOrder::is_payment_method_Valid() const{
    return m_payment_method_isValid;
}

QString OAIEcommerceOrder::getPaymentStatus() const {
    return m_payment_status;
}
void OAIEcommerceOrder::setPaymentStatus(const QString &payment_status) {
    m_payment_status = payment_status;
    m_payment_status_isSet = true;
}

bool OAIEcommerceOrder::is_payment_status_Set() const{
    return m_payment_status_isSet;
}

bool OAIEcommerceOrder::is_payment_status_Valid() const{
    return m_payment_status_isValid;
}

OAIEcommerceAddress OAIEcommerceOrder::getShippingAddress() const {
    return m_shipping_address;
}
void OAIEcommerceOrder::setShippingAddress(const OAIEcommerceAddress &shipping_address) {
    m_shipping_address = shipping_address;
    m_shipping_address_isSet = true;
}

bool OAIEcommerceOrder::is_shipping_address_Set() const{
    return m_shipping_address_isSet;
}

bool OAIEcommerceOrder::is_shipping_address_Valid() const{
    return m_shipping_address_isValid;
}

QString OAIEcommerceOrder::getShippingCost() const {
    return m_shipping_cost;
}
void OAIEcommerceOrder::setShippingCost(const QString &shipping_cost) {
    m_shipping_cost = shipping_cost;
    m_shipping_cost_isSet = true;
}

bool OAIEcommerceOrder::is_shipping_cost_Set() const{
    return m_shipping_cost_isSet;
}

bool OAIEcommerceOrder::is_shipping_cost_Valid() const{
    return m_shipping_cost_isValid;
}

OAIEcommerceOrderStatus OAIEcommerceOrder::getStatus() const {
    return m_status;
}
void OAIEcommerceOrder::setStatus(const OAIEcommerceOrderStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIEcommerceOrder::is_status_Set() const{
    return m_status_isSet;
}

bool OAIEcommerceOrder::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIEcommerceOrder::getSubTotal() const {
    return m_sub_total;
}
void OAIEcommerceOrder::setSubTotal(const QString &sub_total) {
    m_sub_total = sub_total;
    m_sub_total_isSet = true;
}

bool OAIEcommerceOrder::is_sub_total_Set() const{
    return m_sub_total_isSet;
}

bool OAIEcommerceOrder::is_sub_total_Valid() const{
    return m_sub_total_isValid;
}

QString OAIEcommerceOrder::getTotalAmount() const {
    return m_total_amount;
}
void OAIEcommerceOrder::setTotalAmount(const QString &total_amount) {
    m_total_amount = total_amount;
    m_total_amount_isSet = true;
}

bool OAIEcommerceOrder::is_total_amount_Set() const{
    return m_total_amount_isSet;
}

bool OAIEcommerceOrder::is_total_amount_Valid() const{
    return m_total_amount_isValid;
}

QString OAIEcommerceOrder::getTotalDiscount() const {
    return m_total_discount;
}
void OAIEcommerceOrder::setTotalDiscount(const QString &total_discount) {
    m_total_discount = total_discount;
    m_total_discount_isSet = true;
}

bool OAIEcommerceOrder::is_total_discount_Set() const{
    return m_total_discount_isSet;
}

bool OAIEcommerceOrder::is_total_discount_Valid() const{
    return m_total_discount_isValid;
}

QString OAIEcommerceOrder::getTotalTax() const {
    return m_total_tax;
}
void OAIEcommerceOrder::setTotalTax(const QString &total_tax) {
    m_total_tax = total_tax;
    m_total_tax_isSet = true;
}

bool OAIEcommerceOrder::is_total_tax_Set() const{
    return m_total_tax_isSet;
}

bool OAIEcommerceOrder::is_total_tax_Valid() const{
    return m_total_tax_isValid;
}

QList<OAITrackingItem> OAIEcommerceOrder::getTracking() const {
    return m_tracking;
}
void OAIEcommerceOrder::setTracking(const QList<OAITrackingItem> &tracking) {
    m_tracking = tracking;
    m_tracking_isSet = true;
}

bool OAIEcommerceOrder::is_tracking_Set() const{
    return m_tracking_isSet;
}

bool OAIEcommerceOrder::is_tracking_Valid() const{
    return m_tracking_isValid;
}

QDateTime OAIEcommerceOrder::getUpdatedAt() const {
    return m_updated_at;
}
void OAIEcommerceOrder::setUpdatedAt(const QDateTime &updated_at) {
    m_updated_at = updated_at;
    m_updated_at_isSet = true;
}

bool OAIEcommerceOrder::is_updated_at_Set() const{
    return m_updated_at_isSet;
}

bool OAIEcommerceOrder::is_updated_at_Valid() const{
    return m_updated_at_isValid;
}

bool OAIEcommerceOrder::isSet() const {
...
bool OAIEcommerceOrder::isValid() const {
