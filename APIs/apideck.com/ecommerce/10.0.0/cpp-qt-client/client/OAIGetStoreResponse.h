...
/*
 * OAIGetStoreResponse.h
 *
 * 
 */

#ifndef OAIGetStoreResponse_H
#define OAIGetStoreResponse_H
...
namespace OpenAPI {
class OAIEcommerceStore;

class OAIGetStoreResponse : public OAIObject {
public:
    OAIGetStoreResponse();
    OAIGetStoreResponse(QString json);
    ~OAIGetStoreResponse() override;
    ...
    OAIEcommerceStore getData() const;
    void setData(const OAIEcommerceStore &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetStoreResponse)

#endif // OAIGetStoreResponse_H
