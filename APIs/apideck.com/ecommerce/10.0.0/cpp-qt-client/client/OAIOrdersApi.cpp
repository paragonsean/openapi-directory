...
void OAIOrdersApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("ordersAll", defaultConf);
    _serverIndices.insert("ordersAll", 0);
    _serverConfigs.insert("ordersOne", defaultConf);
    _serverIndices.insert("ordersOne", 0);
}
...
void OAIOrdersApi::ordersAll(const QString &x_apideck_consumer_id, const QString &x_apideck_app_id, const ::OpenAPI::OptionalParam<bool> &raw, const ::OpenAPI::OptionalParam<QString> &x_apideck_service_id, const ::OpenAPI::OptionalParam<QString> &cursor, const ::OpenAPI::OptionalParam<qint32> &limit, const ::OpenAPI::OptionalParam<OAIEcommerceOrdersFilter> &filter, const ::OpenAPI::OptionalParam<OAIPassThroughQuery> &pass_through, const ::OpenAPI::OptionalParam<QString> &fields) {
    QString fullPath = QString(_serverConfigs["ordersAll"][_serverIndices.value("ordersAll")].URL()+"/ecommerce/orders");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIOrdersApi::ordersAllCallback);
...
void OAIOrdersApi::ordersAllCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIGetEcommerceOrdersResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT ordersAllSignal(output);
        Q_EMIT ordersAllSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT ordersAllSignalE(output, error_type, error_str);
        Q_EMIT ordersAllSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT ordersAllSignalError(output, error_type, error_str);
        Q_EMIT ordersAllSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIOrdersApi::ordersOne(const QString &id, const QString &x_apideck_consumer_id, const QString &x_apideck_app_id, const ::OpenAPI::OptionalParam<QString> &x_apideck_service_id, const ::OpenAPI::OptionalParam<bool> &raw, const ::OpenAPI::OptionalParam<QString> &fields) {
    QString fullPath = QString(_serverConfigs["ordersOne"][_serverIndices.value("ordersOne")].URL()+"/ecommerce/orders/{id}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIOrdersApi::ordersOneCallback);
    connect(this, &OAIOrdersApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIOrdersApi::ordersOneCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIGetEcommerceOrderResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT ordersOneSignal(output);
        Q_EMIT ordersOneSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT ordersOneSignalE(output, error_type, error_str);
        Q_EMIT ordersOneSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT ordersOneSignalError(output, error_type, error_str);
        Q_EMIT ordersOneSignalErrorFull(worker, error_type, error_str);
    }
}
