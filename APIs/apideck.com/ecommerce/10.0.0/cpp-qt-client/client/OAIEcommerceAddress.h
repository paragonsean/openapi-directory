...
/*
 * OAIEcommerceAddress.h
 *
 * An object representing a shipping or billing address.
 */

#ifndef OAIEcommerceAddress_H
#define OAIEcommerceAddress_H
...
class OAIEcommerceAddress : public OAIObject {
public:
    OAIEcommerceAddress();
    OAIEcommerceAddress(QString json);
    ~OAIEcommerceAddress() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEcommerceAddress)

#endif // OAIEcommerceAddress_H
