...
/*
 * OAILinkedEcommerceCustomer.h
 *
 * The customer this entity is linked to.
 */

#ifndef OAILinkedEcommerceCustomer_H
#define OAILinkedEcommerceCustomer_H
...
class OAILinkedEcommerceCustomer : public OAIObject {
public:
    OAILinkedEcommerceCustomer();
    OAILinkedEcommerceCustomer(QString json);
    ~OAILinkedEcommerceCustomer() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinkedEcommerceCustomer)

#endif // OAILinkedEcommerceCustomer_H
