...
/*
 * OAIGetEcommerceCustomersResponse.h
 *
 * 
 */

#ifndef OAIGetEcommerceCustomersResponse_H
#define OAIGetEcommerceCustomersResponse_H
...
namespace OpenAPI {
class OAIEcommerceCustomer;
class OAILinks;
class OAIMeta;

class OAIGetEcommerceCustomersResponse : public OAIObject {
public:
    OAIGetEcommerceCustomersResponse();
    OAIGetEcommerceCustomersResponse(QString json);
    ~OAIGetEcommerceCustomersResponse() override;
    ...
    QList<OAIEcommerceCustomer> getData() const;
    void setData(const QList<OAIEcommerceCustomer> &data);
...
private:
    ...
    QList<OAIEcommerceCustomer> m_data;
    bool m_data_isSet;
    bool m_data_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetEcommerceCustomersResponse)

#endif // OAIGetEcommerceCustomersResponse_H
