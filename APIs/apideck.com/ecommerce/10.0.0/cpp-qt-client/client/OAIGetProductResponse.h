...
/*
 * OAIGetProductResponse.h
 *
 * 
 */

#ifndef OAIGetProductResponse_H
#define OAIGetProductResponse_H
...
namespace OpenAPI {
class OAIEcommerceProduct;

class OAIGetProductResponse : public OAIObject {
public:
    OAIGetProductResponse();
    OAIGetProductResponse(QString json);
    ~OAIGetProductResponse() override;
    ...
    OAIEcommerceProduct getData() const;
    void setData(const OAIEcommerceProduct &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetProductResponse)

#endif // OAIGetProductResponse_H
