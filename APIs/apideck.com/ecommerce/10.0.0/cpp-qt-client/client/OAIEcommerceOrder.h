...
namespace OpenAPI {
class OAIEcommerceAddress;
class OAILinkedEcommerceCustomer;
class OAIEcommerceDiscount;
class OAIEcommerceOrderLineItem;
class OAITrackingItem;

class OAIEcommerceOrder : public OAIObject {
public:
    OAIEcommerceOrder();
    OAIEcommerceOrder(QString json);
    ~OAIEcommerceOrder() override;
    ...
    OAIEcommerceAddress getBillingAddress() const;
    void setBillingAddress(const OAIEcommerceAddress &billing_address);
    ...
    OAILinkedEcommerceCustomer getCustomer() const;
    void setCustomer(const OAILinkedEcommerceCustomer &customer);
    bool is_customer_Set() const;
    bool is_customer_Valid() const;

    QList<OAIEcommerceDiscount> getDiscounts() const;
    void setDiscounts(const QList<OAIEcommerceDiscount> &discounts);
    ...
    QList<OAIEcommerceOrderLineItem> getLineItems() const;
    void setLineItems(const QList<OAIEcommerceOrderLineItem> &line_items);
    ...
    OAIEcommerceAddress getShippingAddress() const;
    void setShippingAddress(const OAIEcommerceAddress &shipping_address);
    ...
    OAIEcommerceOrderStatus getStatus() const;
    void setStatus(const OAIEcommerceOrderStatus &status);
    bool is_status_Set() const;
    bool is_status_Valid() const;

    QString getSubTotal() const;
    void setSubTotal(const QString &sub_total);
    ...
    QString getTotalTax() const;
    void setTotalTax(const QString &total_tax);
    bool is_total_tax_Set() const;
    bool is_total_tax_Valid() const;

    QList<OAITrackingItem> getTracking() const;
    void setTracking(const QList<OAITrackingItem> &tracking);
...
private:
    ...
    OAIEcommerceAddress m_billing_address;
    ...
    OAILinkedEcommerceCustomer m_customer;
    bool m_customer_isSet;
    bool m_customer_isValid;

    QList<OAIEcommerceDiscount> m_discounts;
    ...
    QList<OAIEcommerceOrderLineItem> m_line_items;
    ...
    OAIEcommerceAddress m_shipping_address;
    ...
    OAIEcommerceOrderStatus m_status;
    bool m_status_isSet;
    ...
    QList<OAITrackingItem> m_tracking;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEcommerceOrder)

#endif // OAIEcommerceOrder_H
