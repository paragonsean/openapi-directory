...
/*
 * OAIGetEcommerceCustomerResponse.h
 *
 * 
 */

#ifndef OAIGetEcommerceCustomerResponse_H
#define OAIGetEcommerceCustomerResponse_H
...
class OAIGetEcommerceCustomerResponse : public OAIObject {
public:
    OAIGetEcommerceCustomerResponse();
    OAIGetEcommerceCustomerResponse(QString json);
    ~OAIGetEcommerceCustomerResponse() override;
    ...
    OAIEcommerceCustomer getData() const;
    void setData(const OAIEcommerceCustomer &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetEcommerceCustomerResponse)

#endif // OAIGetEcommerceCustomerResponse_H
