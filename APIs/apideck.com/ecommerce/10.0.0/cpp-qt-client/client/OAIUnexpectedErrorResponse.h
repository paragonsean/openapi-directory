...
/*
 * OAIUnexpectedErrorResponse.h
 *
 * 
 */

#ifndef OAIUnexpectedErrorResponse_H
#define OAIUnexpectedErrorResponse_H

#include <QJsonObject>

#include "OAIUnexpectedErrorResponse_detail.h"
#include <QString>
...
class OAIUnexpectedErrorResponse : public OAIObject {
public:
    OAIUnexpectedErrorResponse();
    OAIUnexpectedErrorResponse(QString json);
    ~OAIUnexpectedErrorResponse() override;
    ...
    OAIUnexpectedErrorResponse_detail getDetail() const;
    void setDetail(const OAIUnexpectedErrorResponse_detail &detail);
...
private:
    ...
    OAIUnexpectedErrorResponse_detail m_detail;
    bool m_detail_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUnexpectedErrorResponse)

#endif // OAIUnexpectedErrorResponse_H
