...
/*
 * OAIUpdateEcommerceCustomerResponse.h
 *
 * 
 */

#ifndef OAIUpdateEcommerceCustomerResponse_H
#define OAIUpdateEcommerceCustomerResponse_H
...
class OAIUpdateEcommerceCustomerResponse : public OAIObject {
public:
    OAIUpdateEcommerceCustomerResponse();
    OAIUpdateEcommerceCustomerResponse(QString json);
    ~OAIUpdateEcommerceCustomerResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateEcommerceCustomerResponse)

#endif // OAIUpdateEcommerceCustomerResponse_H
