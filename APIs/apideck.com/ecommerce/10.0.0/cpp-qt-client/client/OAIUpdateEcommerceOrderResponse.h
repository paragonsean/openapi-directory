...
/*
 * OAIUpdateEcommerceOrderResponse.h
 *
 * 
 */

#ifndef OAIUpdateEcommerceOrderResponse_H
#define OAIUpdateEcommerceOrderResponse_H
...
class OAIUpdateEcommerceOrderResponse : public OAIObject {
public:
    OAIUpdateEcommerceOrderResponse();
    OAIUpdateEcommerceOrderResponse(QString json);
    ~OAIUpdateEcommerceOrderResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateEcommerceOrderResponse)

#endif // OAIUpdateEcommerceOrderResponse_H
