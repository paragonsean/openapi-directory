...
/*
 * OAIPaymentRequiredResponse.h
 *
 * 
 */

#ifndef OAIPaymentRequiredResponse_H
#define OAIPaymentRequiredResponse_H
...
class OAIPaymentRequiredResponse : public OAIObject {
public:
    OAIPaymentRequiredResponse();
    OAIPaymentRequiredResponse(QString json);
    ~OAIPaymentRequiredResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentRequiredResponse)

#endif // OAIPaymentRequiredResponse_H
