...
/*
 * OAIEcommerceCustomer.h
 *
 * 
 */

#ifndef OAIEcommerceCustomer_H
#define OAIEcommerceCustomer_H
...
#include "OAIEmail.h"
#include "OAILinkedEcommerceOrder.h"
#include "OAIObject.h"
...
namespace OpenAPI {
class OAIAddresses_inner;
class OAIEmail;
class OAILinkedEcommerceOrder;
class OAIPhoneNumber;

class OAIEcommerceCustomer : public OAIObject {
public:
    OAIEcommerceCustomer();
    OAIEcommerceCustomer(QString json);
    ~OAIEcommerceCustomer() override;
    ...
    QList<OAIAddresses_inner> getAddresses() const;
    void setAddresses(const QList<OAIAddresses_inner> &addresses);
    ...
    QList<OAILinkedEcommerceOrder> getOrders() const;
    void setOrders(const QList<OAILinkedEcommerceOrder> &orders);
...
private:
    ...
    QList<OAIAddresses_inner> m_addresses;
    ...
    QList<OAILinkedEcommerceOrder> m_orders;
    bool m_orders_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEcommerceCustomer)

#endif // OAIEcommerceCustomer_H
