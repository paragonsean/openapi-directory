...
/*
 * OAIUpdateProductResponse.h
 *
 * 
 */

#ifndef OAIUpdateProductResponse_H
#define OAIUpdateProductResponse_H
...
class OAIUpdateProductResponse : public OAIObject {
public:
    OAIUpdateProductResponse();
    OAIUpdateProductResponse(QString json);
    ~OAIUpdateProductResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateProductResponse)

#endif // OAIUpdateProductResponse_H
