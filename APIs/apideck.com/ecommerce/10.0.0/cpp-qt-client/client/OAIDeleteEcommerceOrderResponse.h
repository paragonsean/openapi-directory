...
/*
 * OAIDeleteEcommerceOrderResponse.h
 *
 * 
 */

#ifndef OAIDeleteEcommerceOrderResponse_H
#define OAIDeleteEcommerceOrderResponse_H
...
class OAIDeleteEcommerceOrderResponse : public OAIObject {
public:
    OAIDeleteEcommerceOrderResponse();
    OAIDeleteEcommerceOrderResponse(QString json);
    ~OAIDeleteEcommerceOrderResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteEcommerceOrderResponse)

#endif // OAIDeleteEcommerceOrderResponse_H
