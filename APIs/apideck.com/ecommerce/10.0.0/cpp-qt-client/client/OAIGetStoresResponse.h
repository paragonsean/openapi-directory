...
/*
 * OAIGetStoresResponse.h
 *
 * 
 */

#ifndef OAIGetStoresResponse_H
#define OAIGetStoresResponse_H
...
class OAIGetStoresResponse : public OAIObject {
public:
    OAIGetStoresResponse();
    OAIGetStoresResponse(QString json);
    ~OAIGetStoresResponse() override;
    ...
    QList<OAIEcommerceStore> getData() const;
    void setData(const QList<OAIEcommerceStore> &data);
...
private:
    ...
    QList<OAIEcommerceStore> m_data;
    bool m_data_isSet;
    bool m_data_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetStoresResponse)

#endif // OAIGetStoresResponse_H
