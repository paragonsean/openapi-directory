...
/*
 * OAIAddresses_inner.h
 *
 * 
 */

#ifndef OAIAddresses_inner_H
#define OAIAddresses_inner_H
...
class OAIAddresses_inner : public OAIObject {
public:
    OAIAddresses_inner();
    OAIAddresses_inner(QString json);
    ~OAIAddresses_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddresses_inner)

#endif // OAIAddresses_inner_H
