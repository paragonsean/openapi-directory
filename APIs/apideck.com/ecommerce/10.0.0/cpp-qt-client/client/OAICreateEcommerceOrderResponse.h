...
/*
 * OAICreateEcommerceOrderResponse.h
 *
 * 
 */

#ifndef OAICreateEcommerceOrderResponse_H
#define OAICreateEcommerceOrderResponse_H
...
class OAICreateEcommerceOrderResponse : public OAIObject {
public:
    OAICreateEcommerceOrderResponse();
    OAICreateEcommerceOrderResponse(QString json);
    ~OAICreateEcommerceOrderResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateEcommerceOrderResponse)

#endif // OAICreateEcommerceOrderResponse_H
