...
/*
 * OAINotFoundResponse.h
 *
 * 
 */

#ifndef OAINotFoundResponse_H
#define OAINotFoundResponse_H

#include <QJsonObject>

#include "OAINotFoundResponse_detail.h"
#include <QString>
...
class OAINotFoundResponse : public OAIObject {
public:
    OAINotFoundResponse();
    OAINotFoundResponse(QString json);
    ~OAINotFoundResponse() override;
    ...
    OAINotFoundResponse_detail getDetail() const;
    void setDetail(const OAINotFoundResponse_detail &detail);
...
private:
    ...
    OAINotFoundResponse_detail m_detail;
    bool m_detail_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAINotFoundResponse)

#endif // OAINotFoundResponse_H
