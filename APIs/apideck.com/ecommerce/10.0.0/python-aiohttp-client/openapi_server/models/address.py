...
class Address(Model):
    ...
    def type(self, type):
        ...
        :type type: str
        """
        allowed_values = [None,"primary", "secondary", "home", "office", "shipping", "billing", "other"]  # noqa: E501
