...
class Example : public QObject {
    ...
    QString create();
    QString create();
    OAICustomerSupportCustomer create();
    bool create();
    QString create();
public Q_SLOTS:
...
QString Example::create(){
    QString obj;
OAICustomerSupportCustomer Example::create(){
    OAICustomerSupportCustomer obj;
bool Example::create(){
    bool obj;
QString Example::create(){
    QString obj;
...
void Example::exampleFunction1(){
     OAICustomersApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAICustomersApi::customersAddSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAICustomersApi::customersAddSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
      ...
      OAICustomerSupportCustomer oai_customer_support_customer = create(); // OAICustomerSupportCustomer | 
      ...
      apiInstance.customersAdd(x_apideck_consumer_idx_apideck_app_idoai_customer_support_customerrawx_apideck_service_id);
