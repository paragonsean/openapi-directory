...
/*
 * OAIGetCustomerSupportCustomerResponse.h
 *
 * 
 */

#ifndef OAIGetCustomerSupportCustomerResponse_H
#define OAIGetCustomerSupportCustomerResponse_H
...
namespace OpenAPI {
class OAICustomerSupportCustomer;

class OAIGetCustomerSupportCustomerResponse : public OAIObject {
public:
    OAIGetCustomerSupportCustomerResponse();
    OAIGetCustomerSupportCustomerResponse(QString json);
    ~OAIGetCustomerSupportCustomerResponse() override;
    ...
    OAICustomerSupportCustomer getData() const;
    void setData(const OAICustomerSupportCustomer &data);
...
private:
    ...
    OAICustomerSupportCustomer m_data;
    bool m_data_isSet;
    bool m_data_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetCustomerSupportCustomerResponse)

#endif // OAIGetCustomerSupportCustomerResponse_H
