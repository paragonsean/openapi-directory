...
/*
 * OAIUpdateCustomerSupportCustomerResponse.h
 *
 * 
 */

#ifndef OAIUpdateCustomerSupportCustomerResponse_H
#define OAIUpdateCustomerSupportCustomerResponse_H
...
class OAIUpdateCustomerSupportCustomerResponse : public OAIObject {
public:
    OAIUpdateCustomerSupportCustomerResponse();
    OAIUpdateCustomerSupportCustomerResponse(QString json);
    ~OAIUpdateCustomerSupportCustomerResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateCustomerSupportCustomerResponse)

#endif // OAIUpdateCustomerSupportCustomerResponse_H
