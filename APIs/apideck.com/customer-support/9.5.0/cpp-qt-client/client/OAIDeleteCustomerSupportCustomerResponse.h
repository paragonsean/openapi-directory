...
/*
 * OAIDeleteCustomerSupportCustomerResponse.h
 *
 * 
 */

#ifndef OAIDeleteCustomerSupportCustomerResponse_H
#define OAIDeleteCustomerSupportCustomerResponse_H

#include <QJsonObject>

#include "OAIUnifiedId.h"
#include <QString>
...
class OAIDeleteCustomerSupportCustomerResponse : public OAIObject {
public:
    OAIDeleteCustomerSupportCustomerResponse();
    OAIDeleteCustomerSupportCustomerResponse(QString json);
    ~OAIDeleteCustomerSupportCustomerResponse() override;
    ...
    OAIUnifiedId getData() const;
    void setData(const OAIUnifiedId &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteCustomerSupportCustomerResponse)

#endif // OAIDeleteCustomerSupportCustomerResponse_H
