...
/*
 * OAIGetCustomerSupportCustomersResponse.h
 *
 * 
 */

#ifndef OAIGetCustomerSupportCustomersResponse_H
#define OAIGetCustomerSupportCustomersResponse_H
...
class OAIGetCustomerSupportCustomersResponse : public OAIObject {
public:
    OAIGetCustomerSupportCustomersResponse();
    OAIGetCustomerSupportCustomersResponse(QString json);
    ~OAIGetCustomerSupportCustomersResponse() override;
    ...
    QList<OAICustomerSupportCustomer> getData() const;
    void setData(const QList<OAICustomerSupportCustomer> &data);
...
private:
    ...
    QList<OAICustomerSupportCustomer> m_data;
    bool m_data_isSet;
    bool m_data_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetCustomerSupportCustomersResponse)

#endif // OAIGetCustomerSupportCustomersResponse_H
