...
public:
    ...
    QDateTime getFirstCallAt() const;
    void setFirstCallAt(const QDateTime &first_call_at);
    bool is_first_call_at_Set() const;
    bool is_first_call_at_Valid() const;

    QDateTime getFirstEmailAt() const;
    void setFirstEmailAt(const QDateTime &first_email_at);
    bool is_first_email_at_Set() const;
    bool is_first_email_at_Valid() const;
    ...
    Q_DECL_DEPRECATED QString getImage() const;
    Q_DECL_DEPRECATED void setImage(const QString &image);
    Q_DECL_DEPRECATED bool is_image_Set() const;
    Q_DECL_DEPRECATED bool is_image_Valid() const;
...
private:
    ...
    QDateTime m_first_call_at;
    bool m_first_call_at_isSet;
    bool m_first_call_at_isValid;

    QDateTime m_first_email_at;
    bool m_first_email_at_isSet;
    bool m_first_email_at_isValid;
