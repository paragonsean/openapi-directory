...
/*
 * OAICustomerSupportCustomer.h
 *
 * 
 */

#ifndef OAICustomerSupportCustomer_H
#define OAICustomerSupportCustomer_H
...
class OAICustomerSupportCustomer : public OAIObject {
public:
    OAICustomerSupportCustomer();
    OAICustomerSupportCustomer(QString json);
    ~OAICustomerSupportCustomer() override;
    ...
    OAIBankAccount getBankAccounts() const;
    void setBankAccounts(const OAIBankAccount &bank_accounts);
    ...
    void setIndividual(const bool &individual);
...
private:
    ...
    OAIBankAccount m_bank_accounts;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomerSupportCustomer)

#endif // OAICustomerSupportCustomer_H
