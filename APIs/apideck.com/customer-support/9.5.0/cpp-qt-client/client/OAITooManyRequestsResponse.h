...
/*
 * OAITooManyRequestsResponse.h
 *
 * 
 */

#ifndef OAITooManyRequestsResponse_H
#define OAITooManyRequestsResponse_H
...
namespace OpenAPI {
class OAITooManyRequestsResponse_detail;

class OAITooManyRequestsResponse : public OAIObject {
public:
    OAITooManyRequestsResponse();
    OAITooManyRequestsResponse(QString json);
    ~OAITooManyRequestsResponse() override;
    ...
    OAITooManyRequestsResponse_detail getDetail() const;
    void setDetail(const OAITooManyRequestsResponse_detail &detail);
...
private:
    ...
    OAITooManyRequestsResponse_detail m_detail;
    bool m_detail_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAITooManyRequestsResponse)

#endif // OAITooManyRequestsResponse_H
