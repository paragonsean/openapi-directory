...
/*
 * OAICreateCustomerSupportCustomerResponse.h
 *
 * 
 */

#ifndef OAICreateCustomerSupportCustomerResponse_H
#define OAICreateCustomerSupportCustomerResponse_H
...
class OAICreateCustomerSupportCustomerResponse : public OAIObject {
public:
    OAICreateCustomerSupportCustomerResponse();
    OAICreateCustomerSupportCustomerResponse(QString json);
    ~OAICreateCustomerSupportCustomerResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCustomerSupportCustomerResponse)

#endif // OAICreateCustomerSupportCustomerResponse_H
