...
async def customers_add(request: web.Request, x_apideck_consumer_id, x_apideck_app_id, body, raw=None, x_apideck_service_id=None) -> web.Response:
    ...
    """
    body = CustomerSupportCustomer.from_dict(body)
    return web.Response(status=200)


async def customers_all(request: web.Request, x_apideck_consumer_id, x_apideck_app_id, raw=None, x_apideck_service_id=None, cursor=None, limit=None, fields=None) -> web.Response:
