...
class Lead(Model):
    ...
    def __init__(self, addresses: List[Address]=None, company_id: str=None, company_name: str=None, contact_id: str=None, created_at: str=None, currency: Currency=None, custom_fields: List[CustomField]=None, description: str=None, emails: List[Email]=None, fax: str=None, first_name: str=None, id: str=None, language: str=None, last_name: str=None, lead_source: str=None, monetary_amount: float=None, name: str=None, owner_id: str=None, phone_numbers: List[PhoneNumber]=None, prefix: str=None, social_links: List[SocialLink]=None, status: str=None, tags: List[str]=None, title: str=None, updated_at: str=None, websites: List[Website]=None):
        ...
        :param contact_id: The contact_id of this Lead.
    ...
    @property
    def contact_id(self):
        """Gets the contact_id of this Lead.


        :return: The contact_id of this Lead.
        :rtype: str
        """
    ...
    def contact_id(self, contact_id):
        """Sets the contact_id of this Lead.
