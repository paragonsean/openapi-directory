...
Customer Support
- API version: 9.5.0
  - Build date: 2024-10-12T11:58:11.025450-04:00[America/New_York]
...
```groovy
  ...
  dependencies {
     implementation "org.openapitools:openapi-java-client:9.5.0"
  }
```
...
* `target/openapi-java-client-9.5.0.jar`
* `target/lib/*.jar`
...
public class Example {
  public static void main(String[] args) {
    ...
    CustomerSupportCustomer customerSupportCustomer = new CustomerSupportCustomer(); // CustomerSupportCustomer | 
    ...
    try {
      CreateCustomerSupportCustomerResponse result = apiInstance.customersAdd(xApideckConsumerId, xApideckAppId, customerSupportCustomer, raw, xApideckServiceId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling CustomersApi#customersAdd");
...
------------ | ------------- | ------------- | -------------
*CustomersApi* | [**customersAdd**](docs/CustomersApi.md#customersAdd) | **POST** /customer-support/customers | Create Customer Support Customer
*CustomersApi* | [**customersAll**](docs/CustomersApi.md#customersAll) | **GET** /customer-support/customers | List Customer Support Customers
*CustomersApi* | [**customersDelete**](docs/CustomersApi.md#customersDelete) | **DELETE** /customer-support/customers/{id} | Delete Customer Support Customer
*CustomersApi* | [**customersOne**](docs/CustomersApi.md#customersOne) | **GET** /customer-support/customers/{id} | Get Customer Support Customer
*CustomersApi* | [**customersUpdate**](docs/CustomersApi.md#customersUpdate) | **PATCH** /customer-support/customers/{id} | Update Customer Support Customer
...
## Documentation for Models
 ...
 - [CreateCustomerSupportCustomerResponse](docs/CreateCustomerSupportCustomerResponse.md)
 - [Currency](docs/Currency.md)
 - [CustomField](docs/CustomField.md)
 - [CustomFieldValue](docs/CustomFieldValue.md)
 - [CustomerSupportCustomer](docs/CustomerSupportCustomer.md)
 - [DeleteCustomerSupportCustomerResponse](docs/DeleteCustomerSupportCustomerResponse.md)
 - [Email](docs/Email.md)
 - [GetCustomerSupportCustomerResponse](docs/GetCustomerSupportCustomerResponse.md)
 - [GetCustomerSupportCustomersResponse](docs/GetCustomerSupportCustomersResponse.md)
 - [Lead](docs/Lead.md)
 - [Links](docs/Links.md)
 - [Meta](docs/Meta.md)
 ...
 - [UpdateCustomerSupportCustomerResponse](docs/UpdateCustomerSupportCustomerResponse.md)
