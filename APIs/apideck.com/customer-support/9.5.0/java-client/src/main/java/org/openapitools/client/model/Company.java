...
public class Company {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(abnBranch, abnOrTfn, acn, addresses, annualRevenue, bankAccounts, birthday, createdAt, createdBy, currency, customFields, deleted, description, emails, fax, firstName, id, image, industry, interactionCount, lastActivityAt, lastName, name, numberOfEmployees, ownerId, ownership, parentId, payeeNumber, phoneNumbers, readOnly, rowType, salesTaxNumber, salutation, socialLinks, status, tags, updatedAt, updatedBy, vatNumber, websites);
  }
