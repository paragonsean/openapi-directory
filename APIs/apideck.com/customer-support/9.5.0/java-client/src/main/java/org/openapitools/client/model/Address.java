...
public class Address {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(city, contactName, country, county, email, fax, id, latitude, line1, line2, line3, line4, longitude, name, phoneNumber, postalCode, rowVersion, salutation, state, streetNumber, string, type, website);
  }
