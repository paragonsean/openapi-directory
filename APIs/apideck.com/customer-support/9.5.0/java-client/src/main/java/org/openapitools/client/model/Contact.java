...
public class Contact {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(active, addresses, birthday, companyId, companyName, createdAt, currentBalance, customFields, department, description, emailDomain, emails, fax, firstCallAt, firstEmailAt, firstName, gender, id, image, language, lastActivityAt, lastName, leadId, leadSource, middleName, name, ownerId, phoneNumbers, photoUrl, prefix, socialLinks, status, suffix, tags, title, type, updatedAt, websites);
  }
