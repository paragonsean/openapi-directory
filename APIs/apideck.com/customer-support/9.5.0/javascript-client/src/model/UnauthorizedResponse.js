...
class UnauthorizedResponse {
    ...
    /**
     * Validates the JSON data with respect to <code>UnauthorizedResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UnauthorizedResponse</code>.
     */
 ...
 */
UnauthorizedResponse.prototype['detail'] = undefined;
 ...
 */
UnauthorizedResponse.prototype['message'] = undefined;

/**
 * Link to documentation of error type
 * @member {String} ref
 */
UnauthorizedResponse.prototype['ref'] = undefined;

/**
 * HTTP status code
 * @member {Number} status_code
 */
UnauthorizedResponse.prototype['status_code'] = undefined;

/**
 * The type of error returned
 * @member {String} type_name
 */
UnauthorizedResponse.prototype['type_name'] = undefined;
