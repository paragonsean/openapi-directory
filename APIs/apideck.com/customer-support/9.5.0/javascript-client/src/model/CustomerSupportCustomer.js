...
/**
 * The CustomerSupportCustomer model module.
 * @module model/CustomerSupportCustomer
 * @version 9.5.0
 */
class CustomerSupportCustomer {
    /**
     * Constructs a new <code>CustomerSupportCustomer</code>.
     * @alias module:model/CustomerSupportCustomer
     */
    constructor() { 
        
        CustomerSupportCustomer.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CustomerSupportCustomer</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CustomerSupportCustomer} obj Optional instance to populate.
     * @return {module:model/CustomerSupportCustomer} The populated <code>CustomerSupportCustomer</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CustomerSupportCustomer();

            if (data.hasOwnProperty('addresses')) {
                obj['addresses'] = ApiClient.convertToType(data['addresses'], [Address]);
            }
            if (data.hasOwnProperty('bank_accounts')) {
                obj['bank_accounts'] = BankAccount.constructFromObject(data['bank_accounts']);
            }
            ...
            if (data.hasOwnProperty('individual')) {
                obj['individual'] = ApiClient.convertToType(data['individual'], 'Boolean');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CustomerSupportCustomer</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CustomerSupportCustomer</code>.
     */
    static validateJSON(data) {
        ...
        if (data['bank_accounts']) { // data not null
          BankAccount.validateJSON(data['bank_accounts']);
        }
 ...
 */
CustomerSupportCustomer.prototype['addresses'] = undefined;

/**
 * @member {module:model/BankAccount} bank_accounts
 */
CustomerSupportCustomer.prototype['bank_accounts'] = undefined;

/**
 * The name of the company.
 * @member {String} company_name
 */
CustomerSupportCustomer.prototype['company_name'] = undefined;

/**
 * The date and time when the object was created.
 * @member {Date} created_at
 */
CustomerSupportCustomer.prototype['created_at'] = undefined;

/**
 * The user who created the object.
 * @member {String} created_by
 */
CustomerSupportCustomer.prototype['created_by'] = undefined;

/**
 * @member {module:model/Currency} currency
 */
CustomerSupportCustomer.prototype['currency'] = undefined;

/**
 * @member {Array.<module:model/Email>} emails
 */
CustomerSupportCustomer.prototype['emails'] = undefined;

/**
 * The first name of the person.
 * @member {String} first_name
 */
CustomerSupportCustomer.prototype['first_name'] = undefined;

/**
 * A unique identifier for an object.
 * @member {String} id
 */
CustomerSupportCustomer.prototype['id'] = undefined;

/**
 * @member {Boolean} individual
 */
CustomerSupportCustomer.prototype['individual'] = undefined;

/**
 * The last name of the person.
 * @member {String} last_name
 */
CustomerSupportCustomer.prototype['last_name'] = undefined;

/**
 * @member {String} notes
 */
CustomerSupportCustomer.prototype['notes'] = undefined;

/**
 * @member {Array.<module:model/PhoneNumber>} phone_numbers
 */
CustomerSupportCustomer.prototype['phone_numbers'] = undefined;

/**
 * Customer status
 * @member {module:model/CustomerSupportCustomer.StatusEnum} status
 */
CustomerSupportCustomer.prototype['status'] = undefined;

/**
 * @member {String} tax_number
 */
CustomerSupportCustomer.prototype['tax_number'] = undefined;

/**
 * The date and time when the object was last updated.
 * @member {Date} updated_at
 */
CustomerSupportCustomer.prototype['updated_at'] = undefined;

/**
 * The user who last updated the object.
 * @member {String} updated_by
 */
CustomerSupportCustomer.prototype['updated_by'] = undefined;
 ...
 * @readonly
 */
CustomerSupportCustomer['StatusEnum'] = {
...
export default CustomerSupportCustomer;
