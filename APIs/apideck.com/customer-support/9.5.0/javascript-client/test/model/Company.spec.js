...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.expect, root.CustomerSupport);
  }
}(this, function(expect, CustomerSupport) {
  'use strict';

  var instance;

  beforeEach(function() {
    instance = new CustomerSupport.Company();
  });
  ...
  describe('Company', function() {
    it('should create an instance of Company', function() {
      ...
      //var instance = new CustomerSupport.Company();
      //expect(instance).to.be.a(CustomerSupport.Company);
    });

    it('should have the property abnBranch (base name: "abn_branch")', function() {
      // uncomment below and update the code to test the property abnBranch
      //var instance = new CustomerSupport.Company();
      //expect(instance).to.be();
    });

    it('should have the property abnOrTfn (base name: "abn_or_tfn")', function() {
      // uncomment below and update the code to test the property abnOrTfn
      //var instance = new CustomerSupport.Company();
      //expect(instance).to.be();
    });
    ...
    it('should have the property numberOfEmployees (base name: "number_of_employees")', function() {
    ...
    it('should have the property payeeNumber (base name: "payee_number")', function() {
      // uncomment below and update the code to test the property payeeNumber
      //var instance = new CustomerSupport.Company();
      //expect(instance).to.be();
    });
    ...
    it('should have the property rowType (base name: "row_type")', function() {
      // uncomment below and update the code to test the property rowType
      //var instance = new CustomerSupport.Company();
      //expect(instance).to.be();
    });

    it('should have the property salesTaxNumber (base name: "sales_tax_number")', function() {
      // uncomment below and update the code to test the property salesTaxNumber
      //var instance = new CustomerSupport.Company();
      //expect(instance).to.be();
    });
