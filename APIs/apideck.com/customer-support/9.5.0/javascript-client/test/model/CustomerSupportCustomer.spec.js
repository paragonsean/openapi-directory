...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CustomerSupport.CustomerSupportCustomer();
  });
  ...
  describe('CustomerSupportCustomer', function() {
    it('should create an instance of CustomerSupportCustomer', function() {
      // uncomment below and update the code to test CustomerSupportCustomer
      //var instance = new CustomerSupport.CustomerSupportCustomer();
      //expect(instance).to.be.a(CustomerSupport.CustomerSupportCustomer);
    });
