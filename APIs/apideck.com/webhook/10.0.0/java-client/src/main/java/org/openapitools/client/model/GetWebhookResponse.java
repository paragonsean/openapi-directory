...
public class GetWebhookResponse {
  ...
  public GetWebhookResponse data(Webhook data) {
    this.data = data;
    return this;
  }
  ...
  public GetWebhookResponse statusCode(Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, getWebhookResponse.data) &&
        Objects.equals(this.status, getWebhookResponse.status) &&
        Objects.equals(this.statusCode, getWebhookResponse.statusCode);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetWebhookResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (String requiredField : GetWebhookResponse.openapiRequiredFields) {
