...
public class CreateWebhookRequest {
  ...
  public CreateWebhookRequest deliveryUrl(URI deliveryUrl) {
  ...
  public CreateWebhookRequest events(List<WebhookEventType> events) {
    this.events = events;
    return this;
  }

  public CreateWebhookRequest addEventsItem(WebhookEventType eventsItem) {
    if (this.events == null) {
  ...
  public CreateWebhookRequest status(Status status) {
    this.status = status;
    return this;
  }
  ...
  public CreateWebhookRequest unifiedApi(UnifiedApiId unifiedApi) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.deliveryUrl, createWebhookRequest.deliveryUrl) &&
        ...
        Objects.equals(this.unifiedApi, createWebhookRequest.unifiedApi);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(deliveryUrl, description, events, status, unifiedApi);
  }
