...
public class WebhookEvent {
  ...
  public WebhookEvent eventType(WebhookEventType eventType) {
  ...
  public WebhookEvent occurredAt(OffsetDateTime occurredAt) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(entityId, entityType, entityUrl, eventId, eventType, executionAttempt, occurredAt, serviceId);
  }
