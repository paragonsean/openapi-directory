...
public class UpdateWebhookRequest {
  ...
  public UpdateWebhookRequest deliveryUrl(URI deliveryUrl) {
  ...
  public UpdateWebhookRequest events(List<WebhookEventType> events) {
    this.events = events;
    return this;
  }

  public UpdateWebhookRequest addEventsItem(WebhookEventType eventsItem) {
    if (this.events == null) {
  ...
  public UpdateWebhookRequest status(Status status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.deliveryUrl, updateWebhookRequest.deliveryUrl) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(deliveryUrl, description, events, status);
  }
