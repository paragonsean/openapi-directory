...
public class GetWebhooksResponse {
  ...
  public GetWebhooksResponse data(List<Webhook> data) {
    this.data = data;
    return this;
  }

  public GetWebhooksResponse addDataItem(Webhook dataItem) {
    if (this.data == null) {
  ...
  public GetWebhooksResponse links(Links links) {
    this.links = links;
    return this;
  }
  ...
  public GetWebhooksResponse meta(Meta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public GetWebhooksResponse statusCode(Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, getWebhooksResponse.data) &&
        Objects.equals(this.links, getWebhooksResponse.links) &&
        Objects.equals(this.meta, getWebhooksResponse.meta) &&
        Objects.equals(this.status, getWebhooksResponse.status) &&
        Objects.equals(this.statusCode, getWebhooksResponse.statusCode);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetWebhooksResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetWebhooksResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetWebhooksResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
