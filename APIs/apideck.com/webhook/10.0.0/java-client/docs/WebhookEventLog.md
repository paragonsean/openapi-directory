...
|**endpoint** | **URI** | The URL of the webhook endpoint. |  [optional] |
...
|**executionAttempt** | **BigDecimal** | Number of attempts webhook endpoint was called before a success was returned or eventually failed |  [optional] |
...
|**statusCode** | **Integer** | HTTP Status code that was returned. |  [optional] |
