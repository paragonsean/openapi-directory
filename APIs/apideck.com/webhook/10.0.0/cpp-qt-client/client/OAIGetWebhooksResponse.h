...
/*
 * OAIGetWebhooksResponse.h
 *
 * 
 */

#ifndef OAIGetWebhooksResponse_H
#define OAIGetWebhooksResponse_H
...
class OAIGetWebhooksResponse : public OAIObject {
public:
    OAIGetWebhooksResponse();
    OAIGetWebhooksResponse(QString json);
    ~OAIGetWebhooksResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetWebhooksResponse)

#endif // OAIGetWebhooksResponse_H
