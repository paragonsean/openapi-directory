...
QString OAICreateWebhookRequest::getDeliveryUrl() const {
    return m_delivery_url;
}
void OAICreateWebhookRequest::setDeliveryUrl(const QString &delivery_url) {
    m_delivery_url = delivery_url;
    m_delivery_url_isSet = true;
}

bool OAICreateWebhookRequest::is_delivery_url_Set() const{
    return m_delivery_url_isSet;
}

bool OAICreateWebhookRequest::is_delivery_url_Valid() const{
    return m_delivery_url_isValid;
}

QString OAICreateWebhookRequest::getDescription() const {
    return m_description;
}
void OAICreateWebhookRequest::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAICreateWebhookRequest::is_description_Set() const{
    return m_description_isSet;
}

bool OAICreateWebhookRequest::is_description_Valid() const{
    return m_description_isValid;
}

QList<OAIWebhookEventType> OAICreateWebhookRequest::getEvents() const {
    return m_events;
}
void OAICreateWebhookRequest::setEvents(const QList<OAIWebhookEventType> &events) {
    m_events = events;
    m_events_isSet = true;
}

bool OAICreateWebhookRequest::is_events_Set() const{
    return m_events_isSet;
}

bool OAICreateWebhookRequest::is_events_Valid() const{
    return m_events_isValid;
}

OAIStatus OAICreateWebhookRequest::getStatus() const {
    return m_status;
}
void OAICreateWebhookRequest::setStatus(const OAIStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAICreateWebhookRequest::is_status_Set() const{
    return m_status_isSet;
}

bool OAICreateWebhookRequest::is_status_Valid() const{
    return m_status_isValid;
}

OAIUnifiedApiId OAICreateWebhookRequest::getUnifiedApi() const {
    return m_unified_api;
}
void OAICreateWebhookRequest::setUnifiedApi(const OAIUnifiedApiId &unified_api) {
    m_unified_api = unified_api;
    m_unified_api_isSet = true;
}

bool OAICreateWebhookRequest::is_unified_api_Set() const{
    return m_unified_api_isSet;
}

bool OAICreateWebhookRequest::is_unified_api_Valid() const{
...
bool OAICreateWebhookRequest::isValid() const {
    ...
    return m_delivery_url_isValid && m_events_isValid && m_status_isValid && m_unified_api_isValid && true;
}
