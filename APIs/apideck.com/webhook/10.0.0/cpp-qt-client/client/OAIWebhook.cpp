...
QString OAIWebhook::getDeliveryUrl() const {
    return m_delivery_url;
}
void OAIWebhook::setDeliveryUrl(const QString &delivery_url) {
    m_delivery_url = delivery_url;
    m_delivery_url_isSet = true;
}

bool OAIWebhook::is_delivery_url_Set() const{
    return m_delivery_url_isSet;
}

bool OAIWebhook::is_delivery_url_Valid() const{
...
QString OAIWebhook::getDisabledReason() const {
    return m_disabled_reason;
}
void OAIWebhook::setDisabledReason(const QString &disabled_reason) {
    m_disabled_reason = disabled_reason;
    m_disabled_reason_isSet = true;
}

bool OAIWebhook::is_disabled_reason_Set() const{
    return m_disabled_reason_isSet;
}

bool OAIWebhook::is_disabled_reason_Valid() const{
    return m_disabled_reason_isValid;
}

QList<OAIWebhookEventType> OAIWebhook::getEvents() const {
    return m_events;
}
void OAIWebhook::setEvents(const QList<OAIWebhookEventType> &events) {
    m_events = events;
    m_events_isSet = true;
}
...
QString OAIWebhook::getExecuteBaseUrl() const {
    return m_execute_base_url;
}
void OAIWebhook::setExecuteBaseUrl(const QString &execute_base_url) {
    m_execute_base_url = execute_base_url;
    m_execute_base_url_isSet = true;
}

bool OAIWebhook::is_execute_base_url_Set() const{
    return m_execute_base_url_isSet;
}

bool OAIWebhook::is_execute_base_url_Valid() const{
...
OAIStatus OAIWebhook::getStatus() const {
    return m_status;
}
void OAIWebhook::setStatus(const OAIStatus &status) {
    m_status = status;
    m_status_isSet = true;
}
...
OAIUnifiedApiId OAIWebhook::getUnifiedApi() const {
    return m_unified_api;
}
void OAIWebhook::setUnifiedApi(const OAIUnifiedApiId &unified_api) {
    m_unified_api = unified_api;
    m_unified_api_isSet = true;
}

bool OAIWebhook::is_unified_api_Set() const{
    return m_unified_api_isSet;
}

bool OAIWebhook::is_unified_api_Valid() const{
