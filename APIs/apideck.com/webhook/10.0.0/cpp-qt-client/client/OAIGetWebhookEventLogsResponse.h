...
/*
 * OAIGetWebhookEventLogsResponse.h
 *
 * 
 */

#ifndef OAIGetWebhookEventLogsResponse_H
#define OAIGetWebhookEventLogsResponse_H

#include <QJsonObject>

#include "OAILinks.h"
#include "OAIMeta.h"
#include "OAIWebhookEventLog.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAIWebhookEventLog;
class OAILinks;
class OAIMeta;

class OAIGetWebhookEventLogsResponse : public OAIObject {
public:
    OAIGetWebhookEventLogsResponse();
    OAIGetWebhookEventLogsResponse(QString json);
    ~OAIGetWebhookEventLogsResponse() override;
    ...
    QList<OAIWebhookEventLog> getData() const;
    void setData(const QList<OAIWebhookEventLog> &data);
...
private:
    ...
    QList<OAIWebhookEventLog> m_data;
    bool m_data_isSet;
    bool m_data_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetWebhookEventLogsResponse)

#endif // OAIGetWebhookEventLogsResponse_H
