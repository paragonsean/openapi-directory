...
/*
 * OAIWebhookEventLog.h
 *
 * 
 */

#ifndef OAIWebhookEventLog_H
#define OAIWebhookEventLog_H
...
namespace OpenAPI {
class OAIWebhookEventLog_attempts_inner;
class OAIWebhookEventLog_service;

class OAIWebhookEventLog : public OAIObject {
public:
    OAIWebhookEventLog();
    OAIWebhookEventLog(QString json);
    ~OAIWebhookEventLog() override;
    ...
    QList<OAIWebhookEventLog_attempts_inner> getAttempts() const;
    void setAttempts(const QList<OAIWebhookEventLog_attempts_inner> &attempts);
    ...
    bool isRetryScheduled() const;
    void setRetryScheduled(const bool &retry_scheduled);
    bool is_retry_scheduled_Set() const;
    bool is_retry_scheduled_Valid() const;

    OAIWebhookEventLog_service getService() const;
    void setService(const OAIWebhookEventLog_service &service);
...
private:
    ...
    QList<OAIWebhookEventLog_attempts_inner> m_attempts;
    ...
    bool m_retry_scheduled;
    bool m_retry_scheduled_isSet;
    bool m_retry_scheduled_isValid;

    OAIWebhookEventLog_service m_service;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWebhookEventLog)

#endif // OAIWebhookEventLog_H
