...
/**
* Enum class UnifiedApiId.
* @enum {}
* @readonly
*/
export default class UnifiedApiId {
    ...
    /**
    * Returns a <code>UnifiedApiId</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/UnifiedApiId} The enum <code>UnifiedApiId</code> value.
    */
