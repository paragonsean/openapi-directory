...
import WebhookEventLogAttemptsInner from './WebhookEventLogAttemptsInner';
...
class WebhookEventLog {
    ...
    constructor() { 
        ...
        WebhookEventLog.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('attempts')) {
                obj['attempts'] = ApiClient.convertToType(data['attempts'], [WebhookEventLogAttemptsInner]);
            }
            ...
            if (data.hasOwnProperty('retry_scheduled')) {
                obj['retry_scheduled'] = ApiClient.convertToType(data['retry_scheduled'], 'Boolean');
            }
            if (data.hasOwnProperty('service')) {
                obj['service'] = WebhookEventLogService.constructFromObject(data['service']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['attempts']) { // data not null
            ...
            for (const item of data['attempts']) {
                WebhookEventLogAttemptsInner.validateJSON(item);
            };
        }
        // ensure the json data is a string
        ...
        if (data['service']) { // data not null
          WebhookEventLogService.validateJSON(data['service']);
        }
        // ensure the json data is a string
 ...
 */
WebhookEventLog.prototype['application_id'] = undefined;

/**
 * record of each attempt to call webhook endpoint
 * @member {Array.<module:model/WebhookEventLogAttemptsInner>} attempts
 */
WebhookEventLog.prototype['attempts'] = undefined;

/**
 * Unique consumer identifier. You can freely choose a consumer ID yourself. Most of the time, this is an ID of your internal data model that represents a user or account in your system (for example account:12345). If the consumer doesn't exist yet, Vault will upsert a consumer based on your ID.
 * @member {String} consumer_id
 */
WebhookEventLog.prototype['consumer_id'] = undefined;

/**
 * The URL of the webhook endpoint.
 * @member {String} endpoint
 */
WebhookEventLog.prototype['endpoint'] = undefined;

/**
 * Name of the Entity described by the attributes delivered within payload
 * @member {String} entity_type
 */
WebhookEventLog.prototype['entity_type'] = undefined;

/**
 * Name of source event that webhook is subscribed to.
 * @member {String} event_type
 */
WebhookEventLog.prototype['event_type'] = undefined;
 ...
 */
WebhookEventLog.prototype['execution_attempt'] = undefined;

/**
 * HTTP Method of request to endpoint.
 * @member {String} http_method
 */
WebhookEventLog.prototype['http_method'] = undefined;
 ...
 * @member {Boolean} retry_scheduled
 */
WebhookEventLog.prototype['retry_scheduled'] = undefined;

/**
 * @member {module:model/WebhookEventLogService} service
 */
WebhookEventLog.prototype['service'] = undefined;

/**
 * HTTP Status code that was returned.
 * @member {Number} status_code
 */
WebhookEventLog.prototype['status_code'] = undefined;
 ...
 */
WebhookEventLog.prototype['timestamp'] = undefined;

/**
 * @member {module:model/UnifiedApiId} unified_api
 */
WebhookEventLog.prototype['unified_api'] = undefined;
