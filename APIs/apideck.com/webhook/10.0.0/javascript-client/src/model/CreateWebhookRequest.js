...
class CreateWebhookRequest {
     ...
     * @param events {Array.<module:model/WebhookEventType>} The list of subscribed events for this webhook. [`*`] indicates that all events are enabled.
     * @param status {module:model/Status} 
     * @param unifiedApi {module:model/UnifiedApiId} 
     */
    constructor(deliveryUrl, events, status, unifiedApi) { 
        
        CreateWebhookRequest.initialize(this, deliveryUrl, events, status, unifiedApi);
    }
     ...
     */
    static initialize(obj, deliveryUrl, events, status, unifiedApi) { 
...
CreateWebhookRequest.RequiredProperties = ["delivery_url", "events", "status", "unified_api"];

/**
 * The delivery url of the webhook endpoint.
 * @member {String} delivery_url
 */
CreateWebhookRequest.prototype['delivery_url'] = undefined;
 ...
 */
CreateWebhookRequest.prototype['events'] = undefined;

/**
 * @member {module:model/Status} status
 */
CreateWebhookRequest.prototype['status'] = undefined;

/**
 * @member {module:model/UnifiedApiId} unified_api
 */
CreateWebhookRequest.prototype['unified_api'] = undefined;
