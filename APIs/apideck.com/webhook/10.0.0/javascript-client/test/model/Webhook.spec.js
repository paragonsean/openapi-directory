...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebhookApi.Webhook();
  });
  ...
  describe('Webhook', function() {
    it('should create an instance of Webhook', function() {
      ...
      //var instance = new WebhookApi.Webhook();
      //expect(instance).to.be.a(WebhookApi.Webhook);
    });
    ...
    it('should have the property deliveryUrl (base name: "delivery_url")', function() {
    ...
    it('should have the property executeBaseUrl (base name: "execute_base_url")', function() {
      // uncomment below and update the code to test the property executeBaseUrl
      //var instance = new WebhookApi.Webhook();
      //expect(instance).to.be();
    });
