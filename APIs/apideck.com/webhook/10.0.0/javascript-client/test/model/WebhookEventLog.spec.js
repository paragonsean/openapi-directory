...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WebhookApi.WebhookEventLog();
  });
  ...
  describe('WebhookEventLog', function() {
    it('should create an instance of WebhookEventLog', function() {
      ...
      //var instance = new WebhookApi.WebhookEventLog();
      //expect(instance).to.be.a(WebhookApi.WebhookEventLog);
    });
    ...
    it('should have the property retryScheduled (base name: "retry_scheduled")', function() {
      // uncomment below and update the code to test the property retryScheduled
      //var instance = new WebhookApi.WebhookEventLog();
      //expect(instance).to.be();
    });
