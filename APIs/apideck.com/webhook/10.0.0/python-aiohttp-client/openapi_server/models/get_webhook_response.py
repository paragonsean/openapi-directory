...
class GetWebhookResponse(Model):
    ...
    def __init__(self, data: Webhook=None, status: str=None, status_code: int=None):
        ...
        :param status: The status of this GetWebhookResponse.
        :param status_code: The status_code of this GetWebhookResponse.
        """
        self.openapi_types = {
            'data': Webhook,
            'status': str,
    ...
    @property
    def status(self):
        """Gets the status of this GetWebhookResponse.

        HTTP Response Status

        :return: The status of this GetWebhookResponse.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this GetWebhookResponse.
    ...
    def status_code(self):
        """Gets the status_code of this GetWebhookResponse.

        HTTP Response Status Code

        :return: The status_code of this GetWebhookResponse.
        :rtype: int
        """
    ...
    def status_code(self, status_code):
        """Sets the status_code of this GetWebhookResponse.
