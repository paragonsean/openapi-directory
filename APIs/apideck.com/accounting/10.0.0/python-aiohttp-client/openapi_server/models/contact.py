...
class Contact(Model):
    ...
    def __init__(self, active: bool=None, addresses: List[Address]=None, birthday: str=None, company_id: str=None, company_name: str=None, created_at: datetime=None, current_balance: float=None, custom_fields: List[CustomField]=None, custom_mappings: object=None, department: str=None, description: str=None, email_domain: str=None, emails: List[Email]=None, fax: str=None, first_call_at: datetime=None, first_email_at: datetime=None, first_name: str=None, gender: str=None, id: str=None, image: str=None, language: str=None, last_activity_at: datetime=None, last_name: str=None, lead_id: str=None, lead_source: str=None, middle_name: str=None, name: str=None, owner_id: str=None, phone_numbers: List[PhoneNumber]=None, photo_url: str=None, prefix: str=None, social_links: List[SocialLink]=None, status: str=None, suffix: str=None, tags: List[str]=None, title: str=None, type: str=None, updated_at: datetime=None, websites: List[Website]=None):
        ...
        :param custom_mappings: The custom_mappings of this Contact.
    ...
    def custom_mappings(self):
        """Gets the custom_mappings of this Contact.

        When custom mappings are configured on the resource, the result is included here.

        :return: The custom_mappings of this Contact.
        :rtype: object
        """
    ...
    def custom_mappings(self, custom_mappings):
        """Sets the custom_mappings of this Contact.
