...
/*
 * OAIGetInvoicesResponse.h
 *
 * 
 */

#ifndef OAIGetInvoicesResponse_H
#define OAIGetInvoicesResponse_H
...
class OAIGetInvoicesResponse : public OAIObject {
public:
    OAIGetInvoicesResponse();
    OAIGetInvoicesResponse(QString json);
    ~OAIGetInvoicesResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetInvoicesResponse)

#endif // OAIGetInvoicesResponse_H
