...
/*
 * OAICreateLedgerAccountResponse.h
 *
 * 
 */

#ifndef OAICreateLedgerAccountResponse_H
#define OAICreateLedgerAccountResponse_H
...
class OAICreateLedgerAccountResponse : public OAIObject {
public:
    OAICreateLedgerAccountResponse();
    OAICreateLedgerAccountResponse(QString json);
    ~OAICreateLedgerAccountResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateLedgerAccountResponse)

#endif // OAICreateLedgerAccountResponse_H
