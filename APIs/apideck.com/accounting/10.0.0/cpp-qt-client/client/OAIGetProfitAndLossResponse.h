...
/*
 * OAIGetProfitAndLossResponse.h
 *
 * 
 */

#ifndef OAIGetProfitAndLossResponse_H
#define OAIGetProfitAndLossResponse_H
...
namespace OpenAPI {
class OAIProfitAndLoss;

class OAIGetProfitAndLossResponse : public OAIObject {
public:
    OAIGetProfitAndLossResponse();
    OAIGetProfitAndLossResponse(QString json);
    ~OAIGetProfitAndLossResponse() override;
    ...
    OAIProfitAndLoss getData() const;
    void setData(const OAIProfitAndLoss &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetProfitAndLossResponse)

#endif // OAIGetProfitAndLossResponse_H
