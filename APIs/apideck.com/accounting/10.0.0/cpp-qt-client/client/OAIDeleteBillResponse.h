...
/*
 * OAIDeleteBillResponse.h
 *
 * 
 */

#ifndef OAIDeleteBillResponse_H
#define OAIDeleteBillResponse_H
...
class OAIDeleteBillResponse : public OAIObject {
public:
    OAIDeleteBillResponse();
    OAIDeleteBillResponse(QString json);
    ~OAIDeleteBillResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteBillResponse)

#endif // OAIDeleteBillResponse_H
