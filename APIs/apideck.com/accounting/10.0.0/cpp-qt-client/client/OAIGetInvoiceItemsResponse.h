...
/*
 * OAIGetInvoiceItemsResponse.h
 *
 * 
 */

#ifndef OAIGetInvoiceItemsResponse_H
#define OAIGetInvoiceItemsResponse_H
...
class OAIGetInvoiceItemsResponse : public OAIObject {
public:
    OAIGetInvoiceItemsResponse();
    OAIGetInvoiceItemsResponse(QString json);
    ~OAIGetInvoiceItemsResponse() override;
    ...
    QList<OAIInvoiceItem> getData() const;
    void setData(const QList<OAIInvoiceItem> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetInvoiceItemsResponse)

#endif // OAIGetInvoiceItemsResponse_H
