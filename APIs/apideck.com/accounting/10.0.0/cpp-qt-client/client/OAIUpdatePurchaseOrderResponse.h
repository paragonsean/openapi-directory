...
/*
 * OAIUpdatePurchaseOrderResponse.h
 *
 * 
 */

#ifndef OAIUpdatePurchaseOrderResponse_H
#define OAIUpdatePurchaseOrderResponse_H
...
class OAIUpdatePurchaseOrderResponse : public OAIObject {
public:
    OAIUpdatePurchaseOrderResponse();
    OAIUpdatePurchaseOrderResponse(QString json);
    ~OAIUpdatePurchaseOrderResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdatePurchaseOrderResponse)

#endif // OAIUpdatePurchaseOrderResponse_H
