...
public:
    ...
    QString getBranchIdentifier() const;
    void setBranchIdentifier(const QString &branch_identifier);
    bool is_branch_identifier_Set() const;
    bool is_branch_identifier_Valid() const;

    QString getBsbNumber() const;
    void setBsbNumber(const QString &bsb_number);
    bool is_bsb_number_Set() const;
    bool is_bsb_number_Valid() const;
...
private:
    ...
    QString m_branch_identifier;
    bool m_branch_identifier_isSet;
    bool m_branch_identifier_isValid;

    QString m_bsb_number;
    bool m_bsb_number_isSet;
    bool m_bsb_number_isValid;
