...
public:
    ...
    QDate getBillDate() const;
    void setBillDate(const QDate &bill_date);
    ...
    QList<OAIBillLineItem> getLineItems() const;
    void setLineItems(const QList<OAIBillLineItem> &line_items);
...
private:
    ...
    QList<OAIBillLineItem> m_line_items;
