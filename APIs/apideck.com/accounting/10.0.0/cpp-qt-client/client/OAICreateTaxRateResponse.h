...
/*
 * OAICreateTaxRateResponse.h
 *
 * 
 */

#ifndef OAICreateTaxRateResponse_H
#define OAICreateTaxRateResponse_H
...
class OAICreateTaxRateResponse : public OAIObject {
public:
    OAICreateTaxRateResponse();
    OAICreateTaxRateResponse(QString json);
    ~OAICreateTaxRateResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateTaxRateResponse)

#endif // OAICreateTaxRateResponse_H
