...
/*
 * OAIGetJournalEntriesResponse.h
 *
 * 
 */

#ifndef OAIGetJournalEntriesResponse_H
#define OAIGetJournalEntriesResponse_H
...
class OAIGetJournalEntriesResponse : public OAIObject {
public:
    OAIGetJournalEntriesResponse();
    OAIGetJournalEntriesResponse(QString json);
    ~OAIGetJournalEntriesResponse() override;
    ...
    QList<OAIJournalEntry> getData() const;
    void setData(const QList<OAIJournalEntry> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetJournalEntriesResponse)

#endif // OAIGetJournalEntriesResponse_H
