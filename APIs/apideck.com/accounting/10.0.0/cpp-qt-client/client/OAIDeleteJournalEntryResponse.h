...
/*
 * OAIDeleteJournalEntryResponse.h
 *
 * 
 */

#ifndef OAIDeleteJournalEntryResponse_H
#define OAIDeleteJournalEntryResponse_H
...
class OAIDeleteJournalEntryResponse : public OAIObject {
public:
    OAIDeleteJournalEntryResponse();
    OAIDeleteJournalEntryResponse(QString json);
    ~OAIDeleteJournalEntryResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteJournalEntryResponse)

#endif // OAIDeleteJournalEntryResponse_H
