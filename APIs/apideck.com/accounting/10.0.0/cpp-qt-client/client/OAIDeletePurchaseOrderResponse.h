...
/*
 * OAIDeletePurchaseOrderResponse.h
 *
 * 
 */

#ifndef OAIDeletePurchaseOrderResponse_H
#define OAIDeletePurchaseOrderResponse_H
...
class OAIDeletePurchaseOrderResponse : public OAIObject {
public:
    OAIDeletePurchaseOrderResponse();
    OAIDeletePurchaseOrderResponse(QString json);
    ~OAIDeletePurchaseOrderResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeletePurchaseOrderResponse)

#endif // OAIDeletePurchaseOrderResponse_H
