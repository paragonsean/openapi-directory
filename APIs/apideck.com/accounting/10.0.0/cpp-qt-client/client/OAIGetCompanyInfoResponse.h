...
/*
 * OAIGetCompanyInfoResponse.h
 *
 * 
 */

#ifndef OAIGetCompanyInfoResponse_H
#define OAIGetCompanyInfoResponse_H
...
namespace OpenAPI {
class OAICompanyInfo;

class OAIGetCompanyInfoResponse : public OAIObject {
public:
    OAIGetCompanyInfoResponse();
    OAIGetCompanyInfoResponse(QString json);
    ~OAIGetCompanyInfoResponse() override;
    ...
    OAICompanyInfo getData() const;
    void setData(const OAICompanyInfo &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetCompanyInfoResponse)

#endif // OAIGetCompanyInfoResponse_H
