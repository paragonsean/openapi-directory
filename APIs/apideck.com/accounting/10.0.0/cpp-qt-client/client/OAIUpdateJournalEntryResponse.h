...
/*
 * OAIUpdateJournalEntryResponse.h
 *
 * 
 */

#ifndef OAIUpdateJournalEntryResponse_H
#define OAIUpdateJournalEntryResponse_H
...
class OAIUpdateJournalEntryResponse : public OAIObject {
public:
    OAIUpdateJournalEntryResponse();
    OAIUpdateJournalEntryResponse(QString json);
    ~OAIUpdateJournalEntryResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateJournalEntryResponse)

#endif // OAIUpdateJournalEntryResponse_H
