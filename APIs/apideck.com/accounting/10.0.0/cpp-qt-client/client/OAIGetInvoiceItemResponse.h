...
/*
 * OAIGetInvoiceItemResponse.h
 *
 * 
 */

#ifndef OAIGetInvoiceItemResponse_H
#define OAIGetInvoiceItemResponse_H
...
class OAIGetInvoiceItemResponse : public OAIObject {
public:
    OAIGetInvoiceItemResponse();
    OAIGetInvoiceItemResponse(QString json);
    ~OAIGetInvoiceItemResponse() override;
    ...
    OAIInvoiceItem getData() const;
    void setData(const OAIInvoiceItem &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetInvoiceItemResponse)

#endif // OAIGetInvoiceItemResponse_H
