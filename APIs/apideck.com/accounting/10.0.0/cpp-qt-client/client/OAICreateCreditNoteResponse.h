...
/*
 * OAICreateCreditNoteResponse.h
 *
 * 
 */

#ifndef OAICreateCreditNoteResponse_H
#define OAICreateCreditNoteResponse_H
...
class OAICreateCreditNoteResponse : public OAIObject {
public:
    OAICreateCreditNoteResponse();
    OAICreateCreditNoteResponse(QString json);
    ~OAICreateCreditNoteResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCreditNoteResponse)

#endif // OAICreateCreditNoteResponse_H
