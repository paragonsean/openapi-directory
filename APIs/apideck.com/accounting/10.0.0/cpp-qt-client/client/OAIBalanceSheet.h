...
#ifndef OAIBalanceSheet_H
#define OAIBalanceSheet_H

#include <QJsonObject>

#include "OAIBalanceSheet_assets.h"
#include "OAIBalanceSheet_equity.h"
#include "OAIBalanceSheet_liabilities.h"
#include "OAIObject.h"
#include <QDateTime>
#include <QString>
...
namespace OpenAPI {
class OAIBalanceSheet_assets;
class OAIBalanceSheet_equity;
class OAIBalanceSheet_liabilities;

class OAIBalanceSheet : public OAIObject {
public:
    OAIBalanceSheet();
    OAIBalanceSheet(QString json);
    ~OAIBalanceSheet() override;
    ...
    OAIBalanceSheet_assets getAssets() const;
    void setAssets(const OAIBalanceSheet_assets &assets);
    ...
    OAIBalanceSheet_equity getEquity() const;
    void setEquity(const OAIBalanceSheet_equity &equity);
    ...
    OAIBalanceSheet_liabilities getLiabilities() const;
    void setLiabilities(const OAIBalanceSheet_liabilities &liabilities);
...
private:
    ...
    OAIBalanceSheet_assets m_assets;
    bool m_assets_isSet;
    ...
    OAIBalanceSheet_equity m_equity;
    bool m_equity_isSet;
    ...
    OAIBalanceSheet_liabilities m_liabilities;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBalanceSheet)

#endif // OAIBalanceSheet_H
