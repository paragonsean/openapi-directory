...
/*
 * OAICreateBillResponse.h
 *
 * 
 */

#ifndef OAICreateBillResponse_H
#define OAICreateBillResponse_H
...
class OAICreateBillResponse : public OAIObject {
public:
    OAICreateBillResponse();
    OAICreateBillResponse(QString json);
    ~OAICreateBillResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateBillResponse)

#endif // OAICreateBillResponse_H
