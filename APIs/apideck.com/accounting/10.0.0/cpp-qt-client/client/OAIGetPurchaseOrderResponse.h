...
/*
 * OAIGetPurchaseOrderResponse.h
 *
 * 
 */

#ifndef OAIGetPurchaseOrderResponse_H
#define OAIGetPurchaseOrderResponse_H
...
class OAIGetPurchaseOrderResponse : public OAIObject {
public:
    OAIGetPurchaseOrderResponse();
    OAIGetPurchaseOrderResponse(QString json);
    ~OAIGetPurchaseOrderResponse() override;
    ...
    OAIPurchaseOrder getData() const;
    void setData(const OAIPurchaseOrder &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPurchaseOrderResponse)

#endif // OAIGetPurchaseOrderResponse_H
