...
/*
 * OAIDeletePaymentResponse.h
 *
 * 
 */

#ifndef OAIDeletePaymentResponse_H
#define OAIDeletePaymentResponse_H
...
class OAIDeletePaymentResponse : public OAIObject {
public:
    OAIDeletePaymentResponse();
    OAIDeletePaymentResponse(QString json);
    ~OAIDeletePaymentResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeletePaymentResponse)

#endif // OAIDeletePaymentResponse_H
