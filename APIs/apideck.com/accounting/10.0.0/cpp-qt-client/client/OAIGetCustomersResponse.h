...
/*
 * OAIGetCustomersResponse.h
 *
 * 
 */

#ifndef OAIGetCustomersResponse_H
#define OAIGetCustomersResponse_H
...
class OAIGetCustomersResponse : public OAIObject {
public:
    OAIGetCustomersResponse();
    OAIGetCustomersResponse(QString json);
    ~OAIGetCustomersResponse() override;
    ...
    QList<OAICustomer> getData() const;
    void setData(const QList<OAICustomer> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetCustomersResponse)

#endif // OAIGetCustomersResponse_H
