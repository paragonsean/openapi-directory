...
/*
 * OAIGetJournalEntryResponse.h
 *
 * 
 */

#ifndef OAIGetJournalEntryResponse_H
#define OAIGetJournalEntryResponse_H
...
class OAIGetJournalEntryResponse : public OAIObject {
public:
    OAIGetJournalEntryResponse();
    OAIGetJournalEntryResponse(QString json);
    ~OAIGetJournalEntryResponse() override;
    ...
    OAIJournalEntry getData() const;
    void setData(const OAIJournalEntry &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetJournalEntryResponse)

#endif // OAIGetJournalEntryResponse_H
