...
/*
 * OAIGetLedgerAccountsResponse.h
 *
 * 
 */

#ifndef OAIGetLedgerAccountsResponse_H
#define OAIGetLedgerAccountsResponse_H
...
class OAIGetLedgerAccountsResponse : public OAIObject {
public:
    OAIGetLedgerAccountsResponse();
    OAIGetLedgerAccountsResponse(QString json);
    ~OAIGetLedgerAccountsResponse() override;
    ...
    QList<OAILedgerAccount> getData() const;
    void setData(const QList<OAILedgerAccount> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetLedgerAccountsResponse)

#endif // OAIGetLedgerAccountsResponse_H
