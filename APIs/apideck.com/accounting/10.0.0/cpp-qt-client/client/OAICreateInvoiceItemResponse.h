...
/*
 * OAICreateInvoiceItemResponse.h
 *
 * 
 */

#ifndef OAICreateInvoiceItemResponse_H
#define OAICreateInvoiceItemResponse_H
...
class OAICreateInvoiceItemResponse : public OAIObject {
public:
    OAICreateInvoiceItemResponse();
    OAICreateInvoiceItemResponse(QString json);
    ~OAICreateInvoiceItemResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateInvoiceItemResponse)

#endif // OAICreateInvoiceItemResponse_H
