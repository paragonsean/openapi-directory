...
/*
 * OAIGetSupplierResponse.h
 *
 * 
 */

#ifndef OAIGetSupplierResponse_H
#define OAIGetSupplierResponse_H
...
class OAIGetSupplierResponse : public OAIObject {
public:
    OAIGetSupplierResponse();
    OAIGetSupplierResponse(QString json);
    ~OAIGetSupplierResponse() override;
    ...
    OAISupplier getData() const;
    void setData(const OAISupplier &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetSupplierResponse)

#endif // OAIGetSupplierResponse_H
