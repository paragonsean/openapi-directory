...
/*
 * OAIGetBillsResponse.h
 *
 * 
 */

#ifndef OAIGetBillsResponse_H
#define OAIGetBillsResponse_H
...
class OAIGetBillsResponse : public OAIObject {
public:
    OAIGetBillsResponse();
    OAIGetBillsResponse(QString json);
    ~OAIGetBillsResponse() override;
    ...
    QList<OAIBill> getData() const;
    void setData(const QList<OAIBill> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetBillsResponse)

#endif // OAIGetBillsResponse_H
