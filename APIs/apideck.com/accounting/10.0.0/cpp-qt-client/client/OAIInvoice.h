...
class OAILinkedTrackingCategory;
...
public:
    ...
    QString getCustomerMemo() const;
    void setCustomerMemo(const QString &customer_memo);
    bool is_customer_memo_Set() const;
    bool is_customer_memo_Valid() const;
    ...
    bool isInvoiceSent() const;
    void setInvoiceSent(const bool &invoice_sent);
    bool is_invoice_sent_Set() const;
    bool is_invoice_sent_Valid() const;
    ...
    QString getSourceDocumentUrl() const;
    void setSourceDocumentUrl(const QString &source_document_url);
    bool is_source_document_url_Set() const;
    bool is_source_document_url_Valid() const;
    ...
    OAILinkedTrackingCategory getTrackingCategory() const;
    void setTrackingCategory(const OAILinkedTrackingCategory &tracking_category);
    bool is_tracking_category_Set() const;
    bool is_tracking_category_Valid() const;
...
private:
    ...
    QString m_customer_memo;
    bool m_customer_memo_isSet;
    bool m_customer_memo_isValid;
    ...
    bool m_invoice_sent;
    bool m_invoice_sent_isSet;
    bool m_invoice_sent_isValid;
    ...
    QString m_source_document_url;
    bool m_source_document_url_isSet;
    bool m_source_document_url_isValid;
    ...
    OAILinkedTrackingCategory m_tracking_category;
    bool m_tracking_category_isSet;
    bool m_tracking_category_isValid;
