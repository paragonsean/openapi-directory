...
class OAICreditNote_allocations_inner;
...
public:
    ...
    QList<OAICreditNote_allocations_inner> getAllocations() const;
    void setAllocations(const QList<OAICreditNote_allocations_inner> &allocations);
    ...
    QDateTime getDatePaid() const;
    void setDatePaid(const QDateTime &date_paid);
    bool is_date_paid_Set() const;
    bool is_date_paid_Valid() const;
...
private:
    ...
    QList<OAICreditNote_allocations_inner> m_allocations;
    ...
    QDateTime m_date_paid;
    bool m_date_paid_isSet;
    bool m_date_paid_isValid;
