...
/*
 * OAIGetBillResponse.h
 *
 * 
 */

#ifndef OAIGetBillResponse_H
#define OAIGetBillResponse_H
...
class OAIGetBillResponse : public OAIObject {
public:
    OAIGetBillResponse();
    OAIGetBillResponse(QString json);
    ~OAIGetBillResponse() override;
    ...
    OAIBill getData() const;
    void setData(const OAIBill &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetBillResponse)

#endif // OAIGetBillResponse_H
