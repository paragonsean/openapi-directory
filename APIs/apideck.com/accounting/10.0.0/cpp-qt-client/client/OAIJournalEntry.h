...
public:
    ...
    QString getJournalSymbol() const;
    void setJournalSymbol(const QString &journal_symbol);
    bool is_journal_symbol_Set() const;
    bool is_journal_symbol_Valid() const;

    QList<OAIJournalEntryLineItem> getLineItems() const;
    void setLineItems(const QList<OAIJournalEntryLineItem> &line_items);
    ...
    QDateTime getPostedAt() const;
    void setPostedAt(const QDateTime &posted_at);
    bool is_posted_at_Set() const;
    bool is_posted_at_Valid() const;
...
private:
    ...
    QString m_journal_symbol;
    bool m_journal_symbol_isSet;
    bool m_journal_symbol_isValid;

    QList<OAIJournalEntryLineItem> m_line_items;
    ...
    QDateTime m_posted_at;
    bool m_posted_at_isSet;
    bool m_posted_at_isValid;
