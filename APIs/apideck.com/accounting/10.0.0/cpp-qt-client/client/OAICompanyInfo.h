...
public:
    ...
    bool isAutomatedSalesTax() const;
    void setAutomatedSalesTax(const bool &automated_sales_tax);
    bool is_automated_sales_tax_Set() const;
    bool is_automated_sales_tax_Valid() const;
    ...
    QDate getCompanyStartDate() const;
    void setCompanyStartDate(const QDate &company_start_date);
    bool is_company_start_date_Set() const;
    bool is_company_start_date_Valid() const;
    ...
    OAITaxRate getDefaultSalesTax() const;
    void setDefaultSalesTax(const OAITaxRate &default_sales_tax);
    ...
    QString getFiscalYearStartMonth() const;
    void setFiscalYearStartMonth(const QString &fiscal_year_start_month);
    bool is_fiscal_year_start_month_Set() const;
    bool is_fiscal_year_start_month_Valid() const;
    ...
    bool isSalesTaxEnabled() const;
    void setSalesTaxEnabled(const bool &sales_tax_enabled);
    bool is_sales_tax_enabled_Set() const;
    bool is_sales_tax_enabled_Valid() const;
...
private:
    ...
    bool m_automated_sales_tax;
    bool m_automated_sales_tax_isSet;
    bool m_automated_sales_tax_isValid;

    QString m_company_name;
    bool m_company_name_isSet;
    bool m_company_name_isValid;

    QDate m_company_start_date;
    bool m_company_start_date_isSet;
    bool m_company_start_date_isValid;
    ...
    OAITaxRate m_default_sales_tax;
    ...
    QString m_fiscal_year_start_month;
    bool m_fiscal_year_start_month_isSet;
    bool m_fiscal_year_start_month_isValid;
    ...
    bool m_sales_tax_enabled;
    bool m_sales_tax_enabled_isSet;
    bool m_sales_tax_enabled_isValid;
