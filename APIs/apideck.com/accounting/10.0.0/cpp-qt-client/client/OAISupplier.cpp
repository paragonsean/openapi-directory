...
OAILinkedLedgerAccount OAISupplier::getAccount() const {
    return m_account;
}
void OAISupplier::setAccount(const OAILinkedLedgerAccount &account) {
    m_account = account;
    m_account_isSet = true;
}

bool OAISupplier::is_account_Set() const{
    return m_account_isSet;
}

bool OAISupplier::is_account_Valid() const{
    return m_account_isValid;
}

QList<OAIAddress> OAISupplier::getAddresses() const {
    return m_addresses;
}
void OAISupplier::setAddresses(const QList<OAIAddress> &addresses) {
    m_addresses = addresses;
    m_addresses_isSet = true;
}

bool OAISupplier::is_addresses_Set() const{
    return m_addresses_isSet;
}

bool OAISupplier::is_addresses_Valid() const{
    return m_addresses_isValid;
}

QList<OAIBankAccount> OAISupplier::getBankAccounts() const {
    return m_bank_accounts;
}
void OAISupplier::setBankAccounts(const QList<OAIBankAccount> &bank_accounts) {
    m_bank_accounts = bank_accounts;
    m_bank_accounts_isSet = true;
}

bool OAISupplier::is_bank_accounts_Set() const{
    return m_bank_accounts_isSet;
}

bool OAISupplier::is_bank_accounts_Valid() const{
    return m_bank_accounts_isValid;
}

QString OAISupplier::getChannel() const {
    return m_channel;
}
void OAISupplier::setChannel(const QString &channel) {
    m_channel = channel;
    m_channel_isSet = true;
}

bool OAISupplier::is_channel_Set() const{
    return m_channel_isSet;
}

bool OAISupplier::is_channel_Valid() const{
    return m_channel_isValid;
}

QString OAISupplier::getCompanyName() const {
    return m_company_name;
}
void OAISupplier::setCompanyName(const QString &company_name) {
    m_company_name = company_name;
    m_company_name_isSet = true;
}

bool OAISupplier::is_company_name_Set() const{
    return m_company_name_isSet;
}

bool OAISupplier::is_company_name_Valid() const{
    return m_company_name_isValid;
}

QDateTime OAISupplier::getCreatedAt() const {
    return m_created_at;
}
void OAISupplier::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAISupplier::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAISupplier::is_created_at_Valid() const{
    return m_created_at_isValid;
}

QString OAISupplier::getCreatedBy() const {
    return m_created_by;
}
void OAISupplier::setCreatedBy(const QString &created_by) {
    m_created_by = created_by;
    m_created_by_isSet = true;
}

bool OAISupplier::is_created_by_Set() const{
    return m_created_by_isSet;
}

bool OAISupplier::is_created_by_Valid() const{
    return m_created_by_isValid;
}

OAICurrency OAISupplier::getCurrency() const {
    return m_currency;
}
void OAISupplier::setCurrency(const OAICurrency &currency) {
    m_currency = currency;
    m_currency_isSet = true;
}

bool OAISupplier::is_currency_Set() const{
    return m_currency_isSet;
}

bool OAISupplier::is_currency_Valid() const{
    return m_currency_isValid;
}

OAIObject OAISupplier::getCustomMappings() const {
    return m_custom_mappings;
}
void OAISupplier::setCustomMappings(const OAIObject &custom_mappings) {
    m_custom_mappings = custom_mappings;
    m_custom_mappings_isSet = true;
}

bool OAISupplier::is_custom_mappings_Set() const{
    return m_custom_mappings_isSet;
}

bool OAISupplier::is_custom_mappings_Valid() const{
    return m_custom_mappings_isValid;
}

QString OAISupplier::getDisplayId() const {
    return m_display_id;
}
void OAISupplier::setDisplayId(const QString &display_id) {
    m_display_id = display_id;
    m_display_id_isSet = true;
}

bool OAISupplier::is_display_id_Set() const{
    return m_display_id_isSet;
}

bool OAISupplier::is_display_id_Valid() const{
    return m_display_id_isValid;
}

QString OAISupplier::getDisplayName() const {
    return m_display_name;
}
void OAISupplier::setDisplayName(const QString &display_name) {
    m_display_name = display_name;
    m_display_name_isSet = true;
}

bool OAISupplier::is_display_name_Set() const{
    return m_display_name_isSet;
}

bool OAISupplier::is_display_name_Valid() const{
    return m_display_name_isValid;
}

QString OAISupplier::getDownstreamId() const {
    return m_downstream_id;
}
void OAISupplier::setDownstreamId(const QString &downstream_id) {
    m_downstream_id = downstream_id;
    m_downstream_id_isSet = true;
}

bool OAISupplier::is_downstream_id_Set() const{
    return m_downstream_id_isSet;
}

bool OAISupplier::is_downstream_id_Valid() const{
    return m_downstream_id_isValid;
}

QList<OAIEmail> OAISupplier::getEmails() const {
    return m_emails;
}
void OAISupplier::setEmails(const QList<OAIEmail> &emails) {
    m_emails = emails;
    m_emails_isSet = true;
}

bool OAISupplier::is_emails_Set() const{
    return m_emails_isSet;
}

bool OAISupplier::is_emails_Valid() const{
    return m_emails_isValid;
}

QString OAISupplier::getFirstName() const {
    return m_first_name;
}
void OAISupplier::setFirstName(const QString &first_name) {
    m_first_name = first_name;
    m_first_name_isSet = true;
}

bool OAISupplier::is_first_name_Set() const{
    return m_first_name_isSet;
}

bool OAISupplier::is_first_name_Valid() const{
    return m_first_name_isValid;
}

QString OAISupplier::getId() const {
    return m_id;
}
void OAISupplier::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAISupplier::is_id_Set() const{
    return m_id_isSet;
}

bool OAISupplier::is_id_Valid() const{
    return m_id_isValid;
}

bool OAISupplier::isIndividual() const {
    return m_individual;
}
void OAISupplier::setIndividual(const bool &individual) {
    m_individual = individual;
    m_individual_isSet = true;
}

bool OAISupplier::is_individual_Set() const{
    return m_individual_isSet;
}

bool OAISupplier::is_individual_Valid() const{
    return m_individual_isValid;
}

QString OAISupplier::getLastName() const {
    return m_last_name;
}
void OAISupplier::setLastName(const QString &last_name) {
    m_last_name = last_name;
    m_last_name_isSet = true;
}

bool OAISupplier::is_last_name_Set() const{
    return m_last_name_isSet;
}

bool OAISupplier::is_last_name_Valid() const{
    return m_last_name_isValid;
}

QString OAISupplier::getMiddleName() const {
    return m_middle_name;
}
void OAISupplier::setMiddleName(const QString &middle_name) {
    m_middle_name = middle_name;
    m_middle_name_isSet = true;
}

bool OAISupplier::is_middle_name_Set() const{
    return m_middle_name_isSet;
}

bool OAISupplier::is_middle_name_Valid() const{
    return m_middle_name_isValid;
}

QString OAISupplier::getNotes() const {
    return m_notes;
}
void OAISupplier::setNotes(const QString &notes) {
    m_notes = notes;
    m_notes_isSet = true;
}

bool OAISupplier::is_notes_Set() const{
    return m_notes_isSet;
}

bool OAISupplier::is_notes_Valid() const{
    return m_notes_isValid;
}

QString OAISupplier::getPaymentMethod() const {
    return m_payment_method;
}
void OAISupplier::setPaymentMethod(const QString &payment_method) {
    m_payment_method = payment_method;
    m_payment_method_isSet = true;
}

bool OAISupplier::is_payment_method_Set() const{
    return m_payment_method_isSet;
}

bool OAISupplier::is_payment_method_Valid() const{
    return m_payment_method_isValid;
}

QList<OAIPhoneNumber> OAISupplier::getPhoneNumbers() const {
    return m_phone_numbers;
}
void OAISupplier::setPhoneNumbers(const QList<OAIPhoneNumber> &phone_numbers) {
    m_phone_numbers = phone_numbers;
    m_phone_numbers_isSet = true;
}

bool OAISupplier::is_phone_numbers_Set() const{
    return m_phone_numbers_isSet;
}

bool OAISupplier::is_phone_numbers_Valid() const{
    return m_phone_numbers_isValid;
}

QString OAISupplier::getRowVersion() const {
    return m_row_version;
}
void OAISupplier::setRowVersion(const QString &row_version) {
    m_row_version = row_version;
    m_row_version_isSet = true;
}

bool OAISupplier::is_row_version_Set() const{
    return m_row_version_isSet;
}

bool OAISupplier::is_row_version_Valid() const{
    return m_row_version_isValid;
}

QString OAISupplier::getStatus() const {
    return m_status;
}
void OAISupplier::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAISupplier::is_status_Set() const{
    return m_status_isSet;
}

bool OAISupplier::is_status_Valid() const{
    return m_status_isValid;
}

QString OAISupplier::getSuffix() const {
    return m_suffix;
}
void OAISupplier::setSuffix(const QString &suffix) {
    m_suffix = suffix;
    m_suffix_isSet = true;
}

bool OAISupplier::is_suffix_Set() const{
    return m_suffix_isSet;
}

bool OAISupplier::is_suffix_Valid() const{
    return m_suffix_isValid;
}

QString OAISupplier::getTaxNumber() const {
    return m_tax_number;
}
void OAISupplier::setTaxNumber(const QString &tax_number) {
    m_tax_number = tax_number;
    m_tax_number_isSet = true;
}

bool OAISupplier::is_tax_number_Set() const{
    return m_tax_number_isSet;
}

bool OAISupplier::is_tax_number_Valid() const{
    return m_tax_number_isValid;
}

OAILinkedTaxRate OAISupplier::getTaxRate() const {
    return m_tax_rate;
}
void OAISupplier::setTaxRate(const OAILinkedTaxRate &tax_rate) {
    m_tax_rate = tax_rate;
    m_tax_rate_isSet = true;
}

bool OAISupplier::is_tax_rate_Set() const{
    return m_tax_rate_isSet;
}

bool OAISupplier::is_tax_rate_Valid() const{
    return m_tax_rate_isValid;
}

QString OAISupplier::getTitle() const {
    return m_title;
}
void OAISupplier::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAISupplier::is_title_Set() const{
    return m_title_isSet;
}

bool OAISupplier::is_title_Valid() const{
...
QString OAISupplier::getUpdatedBy() const {
    return m_updated_by;
}
void OAISupplier::setUpdatedBy(const QString &updated_by) {
    m_updated_by = updated_by;
    m_updated_by_isSet = true;
}

bool OAISupplier::is_updated_by_Set() const{
    return m_updated_by_isSet;
}

bool OAISupplier::is_updated_by_Valid() const{
    return m_updated_by_isValid;
}

QList<OAIWebsite> OAISupplier::getWebsites() const {
    return m_websites;
}
void OAISupplier::setWebsites(const QList<OAIWebsite> &websites) {
    m_websites = websites;
    m_websites_isSet = true;
}

bool OAISupplier::is_websites_Set() const{
    return m_websites_isSet;
}

bool OAISupplier::is_websites_Valid() const{
