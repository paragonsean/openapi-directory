...
QString OAIBillLineItem::getCode() const {
    return m_code;
}
void OAIBillLineItem::setCode(const QString &code) {
    m_code = code;
    m_code_isSet = true;
}

bool OAIBillLineItem::is_code_Set() const{
    return m_code_isSet;
}

bool OAIBillLineItem::is_code_Valid() const{
    return m_code_isValid;
}

QDateTime OAIBillLineItem::getCreatedAt() const {
    return m_created_at;
}
void OAIBillLineItem::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIBillLineItem::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIBillLineItem::is_created_at_Valid() const{
    return m_created_at_isValid;
}

QString OAIBillLineItem::getCreatedBy() const {
    return m_created_by;
}
void OAIBillLineItem::setCreatedBy(const QString &created_by) {
    m_created_by = created_by;
    m_created_by_isSet = true;
}

bool OAIBillLineItem::is_created_by_Set() const{
    return m_created_by_isSet;
}

bool OAIBillLineItem::is_created_by_Valid() const{
    return m_created_by_isValid;
}

QString OAIBillLineItem::getDepartmentId() const {
    return m_department_id;
}
void OAIBillLineItem::setDepartmentId(const QString &department_id) {
    m_department_id = department_id;
    m_department_id_isSet = true;
}

bool OAIBillLineItem::is_department_id_Set() const{
    return m_department_id_isSet;
}

bool OAIBillLineItem::is_department_id_Valid() const{
...
double OAIBillLineItem::getDiscountAmount() const {
    return m_discount_amount;
}
void OAIBillLineItem::setDiscountAmount(const double &discount_amount) {
    m_discount_amount = discount_amount;
    m_discount_amount_isSet = true;
}

bool OAIBillLineItem::is_discount_amount_Set() const{
    return m_discount_amount_isSet;
}

bool OAIBillLineItem::is_discount_amount_Valid() const{
    return m_discount_amount_isValid;
}

double OAIBillLineItem::getDiscountPercentage() const {
    return m_discount_percentage;
}
void OAIBillLineItem::setDiscountPercentage(const double &discount_percentage) {
    m_discount_percentage = discount_percentage;
    m_discount_percentage_isSet = true;
}

bool OAIBillLineItem::is_discount_percentage_Set() const{
    return m_discount_percentage_isSet;
}

bool OAIBillLineItem::is_discount_percentage_Valid() const{
    return m_discount_percentage_isValid;
}

QString OAIBillLineItem::getId() const {
    return m_id;
}
void OAIBillLineItem::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIBillLineItem::is_id_Set() const{
    return m_id_isSet;
}

bool OAIBillLineItem::is_id_Valid() const{
    return m_id_isValid;
}

OAILinkedInvoiceItem OAIBillLineItem::getItem() const {
    return m_item;
}
void OAIBillLineItem::setItem(const OAILinkedInvoiceItem &item) {
    m_item = item;
    m_item_isSet = true;
}

bool OAIBillLineItem::is_item_Set() const{
    return m_item_isSet;
}

bool OAIBillLineItem::is_item_Valid() const{
    return m_item_isValid;
}

OAILinkedLedgerAccount OAIBillLineItem::getLedgerAccount() const {
    return m_ledger_account;
}
void OAIBillLineItem::setLedgerAccount(const OAILinkedLedgerAccount &ledger_account) {
    m_ledger_account = ledger_account;
    m_ledger_account_isSet = true;
}

bool OAIBillLineItem::is_ledger_account_Set() const{
    return m_ledger_account_isSet;
}

bool OAIBillLineItem::is_ledger_account_Valid() const{
    return m_ledger_account_isValid;
}

qint32 OAIBillLineItem::getLineNumber() const {
    return m_line_number;
}
void OAIBillLineItem::setLineNumber(const qint32 &line_number) {
    m_line_number = line_number;
    m_line_number_isSet = true;
}

bool OAIBillLineItem::is_line_number_Set() const{
    return m_line_number_isSet;
}

bool OAIBillLineItem::is_line_number_Valid() const{
    return m_line_number_isValid;
}

QString OAIBillLineItem::getLocationId() const {
    return m_location_id;
}
void OAIBillLineItem::setLocationId(const QString &location_id) {
    m_location_id = location_id;
    m_location_id_isSet = true;
}

bool OAIBillLineItem::is_location_id_Set() const{
    return m_location_id_isSet;
}

bool OAIBillLineItem::is_location_id_Valid() const{
...
QString OAIBillLineItem::getRowId() const {
    return m_row_id;
}
void OAIBillLineItem::setRowId(const QString &row_id) {
    m_row_id = row_id;
    m_row_id_isSet = true;
}

bool OAIBillLineItem::is_row_id_Set() const{
    return m_row_id_isSet;
}

bool OAIBillLineItem::is_row_id_Valid() const{
    return m_row_id_isValid;
}

QString OAIBillLineItem::getRowVersion() const {
    return m_row_version;
}
void OAIBillLineItem::setRowVersion(const QString &row_version) {
    m_row_version = row_version;
    m_row_version_isSet = true;
}

bool OAIBillLineItem::is_row_version_Set() const{
    return m_row_version_isSet;
}

bool OAIBillLineItem::is_row_version_Valid() const{
...
OAILinkedTaxRate OAIBillLineItem::getTaxRate() const {
    return m_tax_rate;
}
void OAIBillLineItem::setTaxRate(const OAILinkedTaxRate &tax_rate) {
    m_tax_rate = tax_rate;
    m_tax_rate_isSet = true;
}

bool OAIBillLineItem::is_tax_rate_Set() const{
    return m_tax_rate_isSet;
}

bool OAIBillLineItem::is_tax_rate_Valid() const{
    return m_tax_rate_isValid;
}

double OAIBillLineItem::getTotalAmount() const {
    return m_total_amount;
}
void OAIBillLineItem::setTotalAmount(const double &total_amount) {
    m_total_amount = total_amount;
    m_total_amount_isSet = true;
}

bool OAIBillLineItem::is_total_amount_Set() const{
    return m_total_amount_isSet;
}

bool OAIBillLineItem::is_total_amount_Valid() const{
    return m_total_amount_isValid;
}

QString OAIBillLineItem::getType() const {
    return m_type;
}
void OAIBillLineItem::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIBillLineItem::is_type_Set() const{
    return m_type_isSet;
}

bool OAIBillLineItem::is_type_Valid() const{
    return m_type_isValid;
}

QString OAIBillLineItem::getUnitOfMeasure() const {
    return m_unit_of_measure;
}
void OAIBillLineItem::setUnitOfMeasure(const QString &unit_of_measure) {
    m_unit_of_measure = unit_of_measure;
    m_unit_of_measure_isSet = true;
}

bool OAIBillLineItem::is_unit_of_measure_Set() const{
    return m_unit_of_measure_isSet;
}

bool OAIBillLineItem::is_unit_of_measure_Valid() const{
...
QDateTime OAIBillLineItem::getUpdatedAt() const {
    return m_updated_at;
}
void OAIBillLineItem::setUpdatedAt(const QDateTime &updated_at) {
    m_updated_at = updated_at;
    m_updated_at_isSet = true;
}

bool OAIBillLineItem::is_updated_at_Set() const{
    return m_updated_at_isSet;
}

bool OAIBillLineItem::is_updated_at_Valid() const{
    return m_updated_at_isValid;
}

QString OAIBillLineItem::getUpdatedBy() const {
    return m_updated_by;
}
void OAIBillLineItem::setUpdatedBy(const QString &updated_by) {
    m_updated_by = updated_by;
    m_updated_by_isSet = true;
}

bool OAIBillLineItem::is_updated_by_Set() const{
    return m_updated_by_isSet;
}

bool OAIBillLineItem::is_updated_by_Valid() const{
