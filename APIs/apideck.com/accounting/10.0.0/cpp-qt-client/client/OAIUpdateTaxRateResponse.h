...
/*
 * OAIUpdateTaxRateResponse.h
 *
 * 
 */

#ifndef OAIUpdateTaxRateResponse_H
#define OAIUpdateTaxRateResponse_H
...
class OAIUpdateTaxRateResponse : public OAIObject {
public:
    OAIUpdateTaxRateResponse();
    OAIUpdateTaxRateResponse(QString json);
    ~OAIUpdateTaxRateResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateTaxRateResponse)

#endif // OAIUpdateTaxRateResponse_H
