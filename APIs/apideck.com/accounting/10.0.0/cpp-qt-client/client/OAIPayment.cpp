...
void OAIPayment::initializeModel() {
    ...
    m_accounts_receivable_account_id_isSet = false;
    m_accounts_receivable_account_id_isValid = false;

    m_accounts_receivable_account_type_isSet = false;
    m_accounts_receivable_account_type_isValid = false;
    ...
    m_reconciled_isSet = false;
    m_reconciled_isValid = false;
...
void OAIPayment::fromJsonObject(QJsonObject json) {
    ...
    m_accounts_receivable_account_id_isValid = ::OpenAPI::fromJsonValue(m_accounts_receivable_account_id, json[QString("accounts_receivable_account_id")]);
    m_accounts_receivable_account_id_isSet = !json[QString("accounts_receivable_account_id")].isNull() && m_accounts_receivable_account_id_isValid;

    m_accounts_receivable_account_type_isValid = ::OpenAPI::fromJsonValue(m_accounts_receivable_account_type, json[QString("accounts_receivable_account_type")]);
    m_accounts_receivable_account_type_isSet = !json[QString("accounts_receivable_account_type")].isNull() && m_accounts_receivable_account_type_isValid;
    ...
    m_reconciled_isValid = ::OpenAPI::fromJsonValue(m_reconciled, json[QString("reconciled")]);
    m_reconciled_isSet = !json[QString("reconciled")].isNull() && m_reconciled_isValid;
...
QJsonObject OAIPayment::asJsonObject() const {
    ...
    if (m_accounts_receivable_account_id_isSet) {
        obj.insert(QString("accounts_receivable_account_id"), ::OpenAPI::toJsonValue(m_accounts_receivable_account_id));
    }
    if (m_accounts_receivable_account_type_isSet) {
        obj.insert(QString("accounts_receivable_account_type"), ::OpenAPI::toJsonValue(m_accounts_receivable_account_type));
    }
    ...
    if (m_reconciled_isSet) {
        obj.insert(QString("reconciled"), ::OpenAPI::toJsonValue(m_reconciled));
    }
...
OAILinkedLedgerAccount OAIPayment::getAccount() const {
    return m_account;
}
void OAIPayment::setAccount(const OAILinkedLedgerAccount &account) {
    m_account = account;
...
QString OAIPayment::getAccountsReceivableAccountId() const {
    return m_accounts_receivable_account_id;
}
void OAIPayment::setAccountsReceivableAccountId(const QString &accounts_receivable_account_id) {
    m_accounts_receivable_account_id = accounts_receivable_account_id;
    m_accounts_receivable_account_id_isSet = true;
}

bool OAIPayment::is_accounts_receivable_account_id_Set() const{
    return m_accounts_receivable_account_id_isSet;
}

bool OAIPayment::is_accounts_receivable_account_id_Valid() const{
    return m_accounts_receivable_account_id_isValid;
}

QString OAIPayment::getAccountsReceivableAccountType() const {
    return m_accounts_receivable_account_type;
}
void OAIPayment::setAccountsReceivableAccountType(const QString &accounts_receivable_account_type) {
    m_accounts_receivable_account_type = accounts_receivable_account_type;
    m_accounts_receivable_account_type_isSet = true;
}

bool OAIPayment::is_accounts_receivable_account_type_Set() const{
    return m_accounts_receivable_account_type_isSet;
}

bool OAIPayment::is_accounts_receivable_account_type_Valid() const{
    return m_accounts_receivable_account_type_isValid;
}

QList<OAIPayment_allocations_inner> OAIPayment::getAllocations() const {
    return m_allocations;
}
void OAIPayment::setAllocations(const QList<OAIPayment_allocations_inner> &allocations) {
    m_allocations = allocations;
    m_allocations_isSet = true;
}

bool OAIPayment::is_allocations_Set() const{
    return m_allocations_isSet;
}

bool OAIPayment::is_allocations_Valid() const{
    return m_allocations_isValid;
}

QDateTime OAIPayment::getCreatedAt() const {
    return m_created_at;
}
void OAIPayment::setCreatedAt(const QDateTime &created_at) {
...
QString OAIPayment::getCreatedBy() const {
    return m_created_by;
}
void OAIPayment::setCreatedBy(const QString &created_by) {
    m_created_by = created_by;
    m_created_by_isSet = true;
}

bool OAIPayment::is_created_by_Set() const{
    return m_created_by_isSet;
}

bool OAIPayment::is_created_by_Valid() const{
    return m_created_by_isValid;
}

OAICurrency OAIPayment::getCurrency() const {
    return m_currency;
}
void OAIPayment::setCurrency(const OAICurrency &currency) {
    m_currency = currency;
...
OAIObject OAIPayment::getCustomMappings() const {
    return m_custom_mappings;
}
void OAIPayment::setCustomMappings(const OAIObject &custom_mappings) {
    m_custom_mappings = custom_mappings;
    m_custom_mappings_isSet = true;
}

bool OAIPayment::is_custom_mappings_Set() const{
    return m_custom_mappings_isSet;
}

bool OAIPayment::is_custom_mappings_Valid() const{
    return m_custom_mappings_isValid;
}

OAILinkedCustomer OAIPayment::getCustomer() const {
    return m_customer;
}
void OAIPayment::setCustomer(const OAILinkedCustomer &customer) {
    m_customer = customer;
    m_customer_isSet = true;
}

bool OAIPayment::is_customer_Set() const{
    return m_customer_isSet;
}

bool OAIPayment::is_customer_Valid() const{
    return m_customer_isValid;
}

QString OAIPayment::getDisplayId() const {
    return m_display_id;
}
void OAIPayment::setDisplayId(const QString &display_id) {
    m_display_id = display_id;
    m_display_id_isSet = true;
}

bool OAIPayment::is_display_id_Set() const{
    return m_display_id_isSet;
}

bool OAIPayment::is_display_id_Valid() const{
    return m_display_id_isValid;
}

QString OAIPayment::getDownstreamId() const {
    return m_downstream_id;
}
void OAIPayment::setDownstreamId(const QString &downstream_id) {
    m_downstream_id = downstream_id;
    m_downstream_id_isSet = true;
}

bool OAIPayment::is_downstream_id_Set() const{
    return m_downstream_id_isSet;
}

bool OAIPayment::is_downstream_id_Valid() const{
...
QString OAIPayment::getPaymentMethodId() const {
    return m_payment_method_id;
}
void OAIPayment::setPaymentMethodId(const QString &payment_method_id) {
    m_payment_method_id = payment_method_id;
    m_payment_method_id_isSet = true;
}

bool OAIPayment::is_payment_method_id_Set() const{
    return m_payment_method_id_isSet;
}

bool OAIPayment::is_payment_method_id_Valid() const{
    return m_payment_method_id_isValid;
}

QString OAIPayment::getPaymentMethodReference() const {
    return m_payment_method_reference;
}
void OAIPayment::setPaymentMethodReference(const QString &payment_method_reference) {
    m_payment_method_reference = payment_method_reference;
    m_payment_method_reference_isSet = true;
}

bool OAIPayment::is_payment_method_reference_Set() const{
    return m_payment_method_reference_isSet;
}

bool OAIPayment::is_payment_method_reference_Valid() const{
    return m_payment_method_reference_isValid;
}

bool OAIPayment::isReconciled() const {
    return m_reconciled;
}
void OAIPayment::setReconciled(const bool &reconciled) {
    m_reconciled = reconciled;
    m_reconciled_isSet = true;
}

bool OAIPayment::is_reconciled_Set() const{
    return m_reconciled_isSet;
}

bool OAIPayment::is_reconciled_Valid() const{
    return m_reconciled_isValid;
}
...
QString OAIPayment::getRowVersion() const {
    return m_row_version;
}
void OAIPayment::setRowVersion(const QString &row_version) {
    m_row_version = row_version;
    m_row_version_isSet = true;
}

bool OAIPayment::is_row_version_Set() const{
    return m_row_version_isSet;
}

bool OAIPayment::is_row_version_Valid() const{
...
OAILinkedSupplier OAIPayment::getSupplier() const {
    return m_supplier;
}
void OAIPayment::setSupplier(const OAILinkedSupplier &supplier) {
    m_supplier = supplier;
    m_supplier_isSet = true;
}

bool OAIPayment::is_supplier_Set() const{
    return m_supplier_isSet;
}

bool OAIPayment::is_supplier_Valid() const{
...
QDateTime OAIPayment::getTransactionDate() const {
    return m_transaction_date;
}
void OAIPayment::setTransactionDate(const QDateTime &transaction_date) {
    m_transaction_date = transaction_date;
    m_transaction_date_isSet = true;
}

bool OAIPayment::is_transaction_date_Set() const{
    return m_transaction_date_isSet;
}

bool OAIPayment::is_transaction_date_Valid() const{
...
QDateTime OAIPayment::getUpdatedAt() const {
    return m_updated_at;
}
void OAIPayment::setUpdatedAt(const QDateTime &updated_at) {
...
QString OAIPayment::getUpdatedBy() const {
    return m_updated_by;
}
void OAIPayment::setUpdatedBy(const QString &updated_by) {
    m_updated_by = updated_by;
    m_updated_by_isSet = true;
}

bool OAIPayment::is_updated_by_Set() const{
    return m_updated_by_isSet;
}

bool OAIPayment::is_updated_by_Valid() const{
...
bool OAIPayment::isValid() const {
    ...
    return m_id_isValid && m_total_amount_isValid && m_transaction_date_isValid && true;
}
