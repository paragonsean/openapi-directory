...
/*
 * OAIGetSuppliersResponse.h
 *
 * 
 */

#ifndef OAIGetSuppliersResponse_H
#define OAIGetSuppliersResponse_H
...
class OAIGetSuppliersResponse : public OAIObject {
public:
    OAIGetSuppliersResponse();
    OAIGetSuppliersResponse(QString json);
    ~OAIGetSuppliersResponse() override;
    ...
    QList<OAISupplier> getData() const;
    void setData(const QList<OAISupplier> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetSuppliersResponse)

#endif // OAIGetSuppliersResponse_H
