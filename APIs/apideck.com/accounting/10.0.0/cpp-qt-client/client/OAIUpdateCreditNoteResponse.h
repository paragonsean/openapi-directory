...
/*
 * OAIUpdateCreditNoteResponse.h
 *
 * 
 */

#ifndef OAIUpdateCreditNoteResponse_H
#define OAIUpdateCreditNoteResponse_H
...
class OAIUpdateCreditNoteResponse : public OAIObject {
public:
    OAIUpdateCreditNoteResponse();
    OAIUpdateCreditNoteResponse(QString json);
    ~OAIUpdateCreditNoteResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateCreditNoteResponse)

#endif // OAIUpdateCreditNoteResponse_H
