...
/*
 * OAIGetTaxRatesResponse.h
 *
 * 
 */

#ifndef OAIGetTaxRatesResponse_H
#define OAIGetTaxRatesResponse_H
...
class OAIGetTaxRatesResponse : public OAIObject {
public:
    OAIGetTaxRatesResponse();
    OAIGetTaxRatesResponse(QString json);
    ~OAIGetTaxRatesResponse() override;
    ...
    QList<OAITaxRate> getData() const;
    void setData(const QList<OAITaxRate> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetTaxRatesResponse)

#endif // OAIGetTaxRatesResponse_H
