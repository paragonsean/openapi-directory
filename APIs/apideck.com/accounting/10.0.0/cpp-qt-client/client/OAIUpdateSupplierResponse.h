...
/*
 * OAIUpdateSupplierResponse.h
 *
 * 
 */

#ifndef OAIUpdateSupplierResponse_H
#define OAIUpdateSupplierResponse_H
...
class OAIUpdateSupplierResponse : public OAIObject {
public:
    OAIUpdateSupplierResponse();
    OAIUpdateSupplierResponse(QString json);
    ~OAIUpdateSupplierResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateSupplierResponse)

#endif // OAIUpdateSupplierResponse_H
