...
/*
 * OAIGetTaxRateResponse.h
 *
 * 
 */

#ifndef OAIGetTaxRateResponse_H
#define OAIGetTaxRateResponse_H
...
class OAIGetTaxRateResponse : public OAIObject {
public:
    OAIGetTaxRateResponse();
    OAIGetTaxRateResponse(QString json);
    ~OAIGetTaxRateResponse() override;
    ...
    OAITaxRate getData() const;
    void setData(const OAITaxRate &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetTaxRateResponse)

#endif // OAIGetTaxRateResponse_H
