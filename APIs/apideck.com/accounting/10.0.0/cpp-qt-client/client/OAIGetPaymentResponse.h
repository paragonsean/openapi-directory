...
/*
 * OAIGetPaymentResponse.h
 *
 * 
 */

#ifndef OAIGetPaymentResponse_H
#define OAIGetPaymentResponse_H
...
class OAIGetPaymentResponse : public OAIObject {
public:
    OAIGetPaymentResponse();
    OAIGetPaymentResponse(QString json);
    ~OAIGetPaymentResponse() override;
    ...
    OAIPayment getData() const;
    void setData(const OAIPayment &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPaymentResponse)

#endif // OAIGetPaymentResponse_H
