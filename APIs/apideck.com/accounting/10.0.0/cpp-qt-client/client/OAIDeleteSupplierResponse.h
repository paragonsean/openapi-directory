...
/*
 * OAIDeleteSupplierResponse.h
 *
 * 
 */

#ifndef OAIDeleteSupplierResponse_H
#define OAIDeleteSupplierResponse_H
...
class OAIDeleteSupplierResponse : public OAIObject {
public:
    OAIDeleteSupplierResponse();
    OAIDeleteSupplierResponse(QString json);
    ~OAIDeleteSupplierResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteSupplierResponse)

#endif // OAIDeleteSupplierResponse_H
