...
/*
 * OAICreateJournalEntryResponse.h
 *
 * 
 */

#ifndef OAICreateJournalEntryResponse_H
#define OAICreateJournalEntryResponse_H
...
class OAICreateJournalEntryResponse : public OAIObject {
public:
    OAICreateJournalEntryResponse();
    OAICreateJournalEntryResponse(QString json);
    ~OAICreateJournalEntryResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateJournalEntryResponse)

#endif // OAICreateJournalEntryResponse_H
