...
/*
 * OAIGetInvoiceResponse.h
 *
 * 
 */

#ifndef OAIGetInvoiceResponse_H
#define OAIGetInvoiceResponse_H
...
class OAIGetInvoiceResponse : public OAIObject {
public:
    OAIGetInvoiceResponse();
    OAIGetInvoiceResponse(QString json);
    ~OAIGetInvoiceResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetInvoiceResponse)

#endif // OAIGetInvoiceResponse_H
