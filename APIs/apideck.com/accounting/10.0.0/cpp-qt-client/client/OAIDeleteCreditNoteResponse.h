...
/*
 * OAIDeleteCreditNoteResponse.h
 *
 * 
 */

#ifndef OAIDeleteCreditNoteResponse_H
#define OAIDeleteCreditNoteResponse_H
...
class OAIDeleteCreditNoteResponse : public OAIObject {
public:
    OAIDeleteCreditNoteResponse();
    OAIDeleteCreditNoteResponse(QString json);
    ~OAIDeleteCreditNoteResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteCreditNoteResponse)

#endif // OAIDeleteCreditNoteResponse_H
