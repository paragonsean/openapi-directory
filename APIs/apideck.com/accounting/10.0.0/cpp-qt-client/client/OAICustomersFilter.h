...
/*
 * OAICustomersFilter.h
 *
 * 
 */

#ifndef OAICustomersFilter_H
#define OAICustomersFilter_H
...
class OAICustomersFilter : public OAIObject {
public:
    OAICustomersFilter();
    OAICustomersFilter(QString json);
    ~OAICustomersFilter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomersFilter)

#endif // OAICustomersFilter_H
