...
/*
 * OAIGetCreditNotesResponse.h
 *
 * 
 */

#ifndef OAIGetCreditNotesResponse_H
#define OAIGetCreditNotesResponse_H
...
class OAIGetCreditNotesResponse : public OAIObject {
public:
    OAIGetCreditNotesResponse();
    OAIGetCreditNotesResponse(QString json);
    ~OAIGetCreditNotesResponse() override;
    ...
    QList<OAICreditNote> getData() const;
    void setData(const QList<OAICreditNote> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetCreditNotesResponse)

#endif // OAIGetCreditNotesResponse_H
