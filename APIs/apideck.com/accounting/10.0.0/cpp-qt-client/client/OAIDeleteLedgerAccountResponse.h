...
/*
 * OAIDeleteLedgerAccountResponse.h
 *
 * 
 */

#ifndef OAIDeleteLedgerAccountResponse_H
#define OAIDeleteLedgerAccountResponse_H
...
class OAIDeleteLedgerAccountResponse : public OAIObject {
public:
    OAIDeleteLedgerAccountResponse();
    OAIDeleteLedgerAccountResponse(QString json);
    ~OAIDeleteLedgerAccountResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteLedgerAccountResponse)

#endif // OAIDeleteLedgerAccountResponse_H
