...
#include "OAIJournalEntryLineItem.h"
...
OAIJournalEntryLineItem::OAIJournalEntryLineItem(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIJournalEntryLineItem::OAIJournalEntryLineItem() {
    this->initializeModel();
}

OAIJournalEntryLineItem::~OAIJournalEntryLineItem() {}

void OAIJournalEntryLineItem::initializeModel() {
...
void OAIJournalEntryLineItem::fromJson(QString jsonString) {
...
void OAIJournalEntryLineItem::fromJsonObject(QJsonObject json) {
...
QString OAIJournalEntryLineItem::asJson() const {
...
QJsonObject OAIJournalEntryLineItem::asJsonObject() const {
    QJsonObject obj;
    if (m_customer.isSet()) {
...
OAILinkedCustomer OAIJournalEntryLineItem::getCustomer() const {
    return m_customer;
}
void OAIJournalEntryLineItem::setCustomer(const OAILinkedCustomer &customer) {
    m_customer = customer;
    m_customer_isSet = true;
}

bool OAIJournalEntryLineItem::is_customer_Set() const{
    return m_customer_isSet;
}

bool OAIJournalEntryLineItem::is_customer_Valid() const{
    return m_customer_isValid;
}

QString OAIJournalEntryLineItem::getDepartmentId() const {
    return m_department_id;
}
void OAIJournalEntryLineItem::setDepartmentId(const QString &department_id) {
    m_department_id = department_id;
    m_department_id_isSet = true;
}

bool OAIJournalEntryLineItem::is_department_id_Set() const{
    return m_department_id_isSet;
}

bool OAIJournalEntryLineItem::is_department_id_Valid() const{
    return m_department_id_isValid;
}

QString OAIJournalEntryLineItem::getDescription() const {
    return m_description;
}
void OAIJournalEntryLineItem::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIJournalEntryLineItem::is_description_Set() const{
    return m_description_isSet;
}

bool OAIJournalEntryLineItem::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIJournalEntryLineItem::getId() const {
    return m_id;
}
void OAIJournalEntryLineItem::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIJournalEntryLineItem::is_id_Set() const{
    return m_id_isSet;
}

bool OAIJournalEntryLineItem::is_id_Valid() const{
    return m_id_isValid;
}

OAILinkedLedgerAccount OAIJournalEntryLineItem::getLedgerAccount() const {
    return m_ledger_account;
}
void OAIJournalEntryLineItem::setLedgerAccount(const OAILinkedLedgerAccount &ledger_account) {
    m_ledger_account = ledger_account;
    m_ledger_account_isSet = true;
}

bool OAIJournalEntryLineItem::is_ledger_account_Set() const{
    return m_ledger_account_isSet;
}

bool OAIJournalEntryLineItem::is_ledger_account_Valid() const{
    return m_ledger_account_isValid;
}

QString OAIJournalEntryLineItem::getLocationId() const {
    return m_location_id;
}
void OAIJournalEntryLineItem::setLocationId(const QString &location_id) {
    m_location_id = location_id;
    m_location_id_isSet = true;
}

bool OAIJournalEntryLineItem::is_location_id_Set() const{
    return m_location_id_isSet;
}

bool OAIJournalEntryLineItem::is_location_id_Valid() const{
    return m_location_id_isValid;
}

double OAIJournalEntryLineItem::getSubTotal() const {
    return m_sub_total;
}
void OAIJournalEntryLineItem::setSubTotal(const double &sub_total) {
    m_sub_total = sub_total;
    m_sub_total_isSet = true;
}

bool OAIJournalEntryLineItem::is_sub_total_Set() const{
    return m_sub_total_isSet;
}

bool OAIJournalEntryLineItem::is_sub_total_Valid() const{
    return m_sub_total_isValid;
}

OAILinkedSupplier OAIJournalEntryLineItem::getSupplier() const {
    return m_supplier;
}
void OAIJournalEntryLineItem::setSupplier(const OAILinkedSupplier &supplier) {
    m_supplier = supplier;
    m_supplier_isSet = true;
}

bool OAIJournalEntryLineItem::is_supplier_Set() const{
    return m_supplier_isSet;
}

bool OAIJournalEntryLineItem::is_supplier_Valid() const{
    return m_supplier_isValid;
}

double OAIJournalEntryLineItem::getTaxAmount() const {
    return m_tax_amount;
}
void OAIJournalEntryLineItem::setTaxAmount(const double &tax_amount) {
    m_tax_amount = tax_amount;
    m_tax_amount_isSet = true;
}

bool OAIJournalEntryLineItem::is_tax_amount_Set() const{
    return m_tax_amount_isSet;
}

bool OAIJournalEntryLineItem::is_tax_amount_Valid() const{
    return m_tax_amount_isValid;
}

OAILinkedTaxRate OAIJournalEntryLineItem::getTaxRate() const {
    return m_tax_rate;
}
void OAIJournalEntryLineItem::setTaxRate(const OAILinkedTaxRate &tax_rate) {
    m_tax_rate = tax_rate;
    m_tax_rate_isSet = true;
}

bool OAIJournalEntryLineItem::is_tax_rate_Set() const{
    return m_tax_rate_isSet;
}

bool OAIJournalEntryLineItem::is_tax_rate_Valid() const{
    return m_tax_rate_isValid;
}

double OAIJournalEntryLineItem::getTotalAmount() const {
    return m_total_amount;
}
void OAIJournalEntryLineItem::setTotalAmount(const double &total_amount) {
    m_total_amount = total_amount;
    m_total_amount_isSet = true;
}

bool OAIJournalEntryLineItem::is_total_amount_Set() const{
    return m_total_amount_isSet;
}

bool OAIJournalEntryLineItem::is_total_amount_Valid() const{
    return m_total_amount_isValid;
}

OAILinkedTrackingCategory OAIJournalEntryLineItem::getTrackingCategory() const {
    return m_tracking_category;
}
void OAIJournalEntryLineItem::setTrackingCategory(const OAILinkedTrackingCategory &tracking_category) {
    m_tracking_category = tracking_category;
    m_tracking_category_isSet = true;
}

bool OAIJournalEntryLineItem::is_tracking_category_Set() const{
    return m_tracking_category_isSet;
}

bool OAIJournalEntryLineItem::is_tracking_category_Valid() const{
    return m_tracking_category_isValid;
}

QString OAIJournalEntryLineItem::getType() const {
    return m_type;
}
void OAIJournalEntryLineItem::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIJournalEntryLineItem::is_type_Set() const{
    return m_type_isSet;
}

bool OAIJournalEntryLineItem::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIJournalEntryLineItem::isSet() const {
...
bool OAIJournalEntryLineItem::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_ledger_account_isValid && m_type_isValid && true;
}
