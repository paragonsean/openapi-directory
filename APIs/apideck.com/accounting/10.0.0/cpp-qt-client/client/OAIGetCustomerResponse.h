...
/*
 * OAIGetCustomerResponse.h
 *
 * 
 */

#ifndef OAIGetCustomerResponse_H
#define OAIGetCustomerResponse_H
...
class OAIGetCustomerResponse : public OAIObject {
public:
    OAIGetCustomerResponse();
    OAIGetCustomerResponse(QString json);
    ~OAIGetCustomerResponse() override;
    ...
    OAICustomer getData() const;
    void setData(const OAICustomer &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetCustomerResponse)

#endif // OAIGetCustomerResponse_H
