...
#ifndef OAILedgerAccount_H
#define OAILedgerAccount_H
...
class OAILedgerAccount_parent_account;
class OAISub_accounts_inner;
class OAILinkedTaxRate;

class OAILedgerAccount : public OAIObject {
public:
    OAILedgerAccount();
    OAILedgerAccount(QString json);
    ~OAILedgerAccount() override;
    ...
    QDate getLastReconciliationDate() const;
    void setLastReconciliationDate(const QDate &last_reconciliation_date);
    bool is_last_reconciliation_date_Set() const;
    bool is_last_reconciliation_date_Valid() const;
    ...
    Q_DECL_DEPRECATED QString getNominalCode() const;
    Q_DECL_DEPRECATED void setNominalCode(const QString &nominal_code);
    Q_DECL_DEPRECATED bool is_nominal_code_Set() const;
    Q_DECL_DEPRECATED bool is_nominal_code_Valid() const;

    double getOpeningBalance() const;
    void setOpeningBalance(const double &opening_balance);
    bool is_opening_balance_Set() const;
    bool is_opening_balance_Valid() const;

    OAILedgerAccount_parent_account getParentAccount() const;
    void setParentAccount(const OAILedgerAccount_parent_account &parent_account);
    ...
    bool isSubAccount() const;
    void setSubAccount(const bool &sub_account);
    bool is_sub_account_Set() const;
    bool is_sub_account_Valid() const;

    QList<OAISub_accounts_inner> getSubAccounts() const;
    void setSubAccounts(const QList<OAISub_accounts_inner> &sub_accounts);
    bool is_sub_accounts_Set() const;
    bool is_sub_accounts_Valid() const;
...
private:
    ...
    QDate m_last_reconciliation_date;
    bool m_last_reconciliation_date_isSet;
    bool m_last_reconciliation_date_isValid;
    ...
    OAILedgerAccount_parent_account m_parent_account;
    ...
    bool m_sub_account;
    bool m_sub_account_isSet;
    bool m_sub_account_isValid;

    QList<OAISub_accounts_inner> m_sub_accounts;
    bool m_sub_accounts_isSet;
    bool m_sub_accounts_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAILedgerAccount)

#endif // OAILedgerAccount_H
