...
/*
 * OAIGetPaymentsResponse.h
 *
 * 
 */

#ifndef OAIGetPaymentsResponse_H
#define OAIGetPaymentsResponse_H
...
class OAIGetPaymentsResponse : public OAIObject {
public:
    OAIGetPaymentsResponse();
    OAIGetPaymentsResponse(QString json);
    ~OAIGetPaymentsResponse() override;
    ...
    QList<OAIPayment> getData() const;
    void setData(const QList<OAIPayment> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPaymentsResponse)

#endif // OAIGetPaymentsResponse_H
