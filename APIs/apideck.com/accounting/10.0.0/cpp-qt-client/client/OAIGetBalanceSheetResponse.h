...
/*
 * OAIGetBalanceSheetResponse.h
 *
 * 
 */

#ifndef OAIGetBalanceSheetResponse_H
#define OAIGetBalanceSheetResponse_H

#include <QJsonObject>

#include "OAIBalanceSheet.h"
#include <QString>
...
namespace OpenAPI {
class OAIBalanceSheet;

class OAIGetBalanceSheetResponse : public OAIObject {
public:
    OAIGetBalanceSheetResponse();
    OAIGetBalanceSheetResponse(QString json);
    ~OAIGetBalanceSheetResponse() override;
    ...
    OAIBalanceSheet getData() const;
    void setData(const OAIBalanceSheet &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetBalanceSheetResponse)

#endif // OAIGetBalanceSheetResponse_H
