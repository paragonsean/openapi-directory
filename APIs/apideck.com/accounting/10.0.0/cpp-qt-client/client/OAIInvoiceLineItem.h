...
/*
 * OAIInvoiceLineItem.h
 *
 * 
 */

#ifndef OAIInvoiceLineItem_H
#define OAIInvoiceLineItem_H

#include <QJsonObject>

#include "OAILinkedInvoiceItem.h"
...
namespace OpenAPI {
class OAILinkedInvoiceItem;
class OAILinkedLedgerAccount;
class OAILinkedTaxRate;

class OAIInvoiceLineItem : public OAIObject {
public:
    OAIInvoiceLineItem();
    OAIInvoiceLineItem(QString json);
    ~OAIInvoiceLineItem() override;
    ...
    OAILinkedInvoiceItem getItem() const;
    void setItem(const OAILinkedInvoiceItem &item);
...
Q_DECLARE_METATYPE(OpenAPI::OAIInvoiceLineItem)

#endif // OAIInvoiceLineItem_H
