...
/*
 * OAIUpdateInvoiceItemsResponse.h
 *
 * 
 */

#ifndef OAIUpdateInvoiceItemsResponse_H
#define OAIUpdateInvoiceItemsResponse_H
...
class OAIUpdateInvoiceItemsResponse : public OAIObject {
public:
    OAIUpdateInvoiceItemsResponse();
    OAIUpdateInvoiceItemsResponse(QString json);
    ~OAIUpdateInvoiceItemsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateInvoiceItemsResponse)

#endif // OAIUpdateInvoiceItemsResponse_H
