...
public:
    ...
    OAILinkedParentCustomer getParent() const;
    void setParent(const OAILinkedParentCustomer &parent);
    ...
    void setProject(const bool &project);
...
private:
    ...
    OAILinkedParentCustomer m_parent;
    bool m_parent_isSet;
