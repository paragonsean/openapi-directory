...
/*
 * OAIGetLedgerAccountResponse.h
 *
 * 
 */

#ifndef OAIGetLedgerAccountResponse_H
#define OAIGetLedgerAccountResponse_H
...
class OAIGetLedgerAccountResponse : public OAIObject {
public:
    OAIGetLedgerAccountResponse();
    OAIGetLedgerAccountResponse(QString json);
    ~OAIGetLedgerAccountResponse() override;
    ...
    OAILedgerAccount getData() const;
    void setData(const OAILedgerAccount &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetLedgerAccountResponse)

#endif // OAIGetLedgerAccountResponse_H
