...
/*
 * OAIDeleteTaxRateResponse.h
 *
 * 
 */

#ifndef OAIDeleteTaxRateResponse_H
#define OAIDeleteTaxRateResponse_H
...
class OAIDeleteTaxRateResponse : public OAIObject {
public:
    OAIDeleteTaxRateResponse();
    OAIDeleteTaxRateResponse(QString json);
    ~OAIDeleteTaxRateResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteTaxRateResponse)

#endif // OAIDeleteTaxRateResponse_H
