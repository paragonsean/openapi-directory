...
class OAIInvoiceItem_purchase_details;
...
public:
    ...
    OAILinkedLedgerAccount getAssetAccount() const;
    void setAssetAccount(const OAILinkedLedgerAccount &asset_account);
    bool is_asset_account_Set() const;
    bool is_asset_account_Valid() const;
    ...
    OAILinkedLedgerAccount getExpenseAccount() const;
    void setExpenseAccount(const OAILinkedLedgerAccount &expense_account);
    ...
    OAILinkedLedgerAccount getIncomeAccount() const;
    void setIncomeAccount(const OAILinkedLedgerAccount &income_account);
    bool is_income_account_Set() const;
    bool is_income_account_Valid() const;

    QDate getInventoryDate() const;
    void setInventoryDate(const QDate &inventory_date);
    bool is_inventory_date_Set() const;
    bool is_inventory_date_Valid() const;
    ...
    OAIInvoiceItem_purchase_details getPurchaseDetails() const;
    void setPurchaseDetails(const OAIInvoiceItem_purchase_details &purchase_details);
    ...
    OAIInvoiceItem_purchase_details getSalesDetails() const;
    void setSalesDetails(const OAIInvoiceItem_purchase_details &sales_details);
    bool is_sales_details_Set() const;
    bool is_sales_details_Valid() const;

    bool isSold() const;
    void setSold(const bool &sold);
...
private:
    ...
    OAILinkedLedgerAccount m_asset_account;
    bool m_asset_account_isSet;
    bool m_asset_account_isValid;
    ...
    OAILinkedLedgerAccount m_expense_account;
    ...
    OAILinkedLedgerAccount m_income_account;
    bool m_income_account_isSet;
    bool m_income_account_isValid;

    QDate m_inventory_date;
    bool m_inventory_date_isSet;
    bool m_inventory_date_isValid;

    QString m_name;
    bool m_name_isSet;
    bool m_name_isValid;

    OAIInvoiceItem_purchase_details m_purchase_details;
    ...
    OAIInvoiceItem_purchase_details m_sales_details;
