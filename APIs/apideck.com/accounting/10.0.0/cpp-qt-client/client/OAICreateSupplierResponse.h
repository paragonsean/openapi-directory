...
/*
 * OAICreateSupplierResponse.h
 *
 * 
 */

#ifndef OAICreateSupplierResponse_H
#define OAICreateSupplierResponse_H
...
class OAICreateSupplierResponse : public OAIObject {
public:
    OAICreateSupplierResponse();
    OAICreateSupplierResponse(QString json);
    ~OAICreateSupplierResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateSupplierResponse)

#endif // OAICreateSupplierResponse_H
