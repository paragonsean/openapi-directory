...
/*
 * OAICreatePurchaseOrderResponse.h
 *
 * 
 */

#ifndef OAICreatePurchaseOrderResponse_H
#define OAICreatePurchaseOrderResponse_H
...
class OAICreatePurchaseOrderResponse : public OAIObject {
public:
    OAICreatePurchaseOrderResponse();
    OAICreatePurchaseOrderResponse(QString json);
    ~OAICreatePurchaseOrderResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreatePurchaseOrderResponse)

#endif // OAICreatePurchaseOrderResponse_H
