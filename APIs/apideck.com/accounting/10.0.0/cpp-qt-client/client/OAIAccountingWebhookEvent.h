...
/*
 * OAIAccountingWebhookEvent.h
 *
 * 
 */

#ifndef OAIAccountingWebhookEvent_H
#define OAIAccountingWebhookEvent_H

#include <QJsonObject>

#include "OAIAccountingEventType.h"
#include <QString>
...
class OAIAccountingWebhookEvent : public OAIObject {
public:
    OAIAccountingWebhookEvent();
    OAIAccountingWebhookEvent(QString json);
    ~OAIAccountingWebhookEvent() override;
    ...
    double getExecutionAttempt() const;
    void setExecutionAttempt(const double &execution_attempt);
    bool is_execution_attempt_Set() const;
    bool is_execution_attempt_Valid() const;
    ...
    OAIAccountingEventType getEventType() const;
    void setEventType(const OAIAccountingEventType &event_type);
...
private:
    ...
    double m_execution_attempt;
    bool m_execution_attempt_isSet;
    bool m_execution_attempt_isValid;
    ...
    OAIAccountingEventType m_event_type;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccountingWebhookEvent)

#endif // OAIAccountingWebhookEvent_H
