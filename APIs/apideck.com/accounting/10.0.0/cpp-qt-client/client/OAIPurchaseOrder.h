...
#include "OAILinkedLedgerAccount.h"
#include "OAILinkedSupplier.h"
#include "OAIObject.h"
#include <QDate>
#include <QDateTime>
#include <QList>
...
class OAILinkedLedgerAccount;
class OAIInvoiceLineItem;
class OAIAddress;
class OAILinkedSupplier;
...
public:
    ...
    bool isAccountingByRow() const;
    void setAccountingByRow(const bool &accounting_by_row);
    bool is_accounting_by_row_Set() const;
    bool is_accounting_by_row_Valid() const;
    ...
    QDate getExpectedArrivalDate() const;
    void setExpectedArrivalDate(const QDate &expected_arrival_date);
    ...
    OAILinkedLedgerAccount getLedgerAccount() const;
    void setLedgerAccount(const OAILinkedLedgerAccount &ledger_account);
    bool is_ledger_account_Set() const;
    bool is_ledger_account_Valid() const;
    ...
    OAILinkedSupplier getSupplier() const;
    void setSupplier(const OAILinkedSupplier &supplier);
    ...
    bool isTaxInclusive() const;
    void setTaxInclusive(const bool &tax_inclusive);
    bool is_tax_inclusive_Set() const;
    bool is_tax_inclusive_Valid() const;
...
private:
    ...
    bool m_accounting_by_row;
    bool m_accounting_by_row_isSet;
    bool m_accounting_by_row_isValid;
    ...
    OAILinkedLedgerAccount m_ledger_account;
    bool m_ledger_account_isSet;
    bool m_ledger_account_isValid;
    ...
    bool m_tax_inclusive;
    bool m_tax_inclusive_isSet;
    bool m_tax_inclusive_isValid;
