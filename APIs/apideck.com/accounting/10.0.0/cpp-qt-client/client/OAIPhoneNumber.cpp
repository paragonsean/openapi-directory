...
QString OAIPhoneNumber::getAreaCode() const {
    return m_area_code;
}
void OAIPhoneNumber::setAreaCode(const QString &area_code) {
    m_area_code = area_code;
    m_area_code_isSet = true;
}

bool OAIPhoneNumber::is_area_code_Set() const{
    return m_area_code_isSet;
}

bool OAIPhoneNumber::is_area_code_Valid() const{
    return m_area_code_isValid;
}

QString OAIPhoneNumber::getCountryCode() const {
    return m_country_code;
}
void OAIPhoneNumber::setCountryCode(const QString &country_code) {
    m_country_code = country_code;
    m_country_code_isSet = true;
}

bool OAIPhoneNumber::is_country_code_Set() const{
    return m_country_code_isSet;
}

bool OAIPhoneNumber::is_country_code_Valid() const{
    return m_country_code_isValid;
}

QString OAIPhoneNumber::getExtension() const {
    return m_extension;
}
void OAIPhoneNumber::setExtension(const QString &extension) {
    m_extension = extension;
    m_extension_isSet = true;
}

bool OAIPhoneNumber::is_extension_Set() const{
    return m_extension_isSet;
}

bool OAIPhoneNumber::is_extension_Valid() const{
    return m_extension_isValid;
}

QString OAIPhoneNumber::getId() const {
    return m_id;
}
void OAIPhoneNumber::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIPhoneNumber::is_id_Set() const{
    return m_id_isSet;
}

bool OAIPhoneNumber::is_id_Valid() const{
    return m_id_isValid;
}
