...
/*
 * OAIUpdateLedgerAccountResponse.h
 *
 * 
 */

#ifndef OAIUpdateLedgerAccountResponse_H
#define OAIUpdateLedgerAccountResponse_H
...
class OAIUpdateLedgerAccountResponse : public OAIObject {
public:
    OAIUpdateLedgerAccountResponse();
    OAIUpdateLedgerAccountResponse(QString json);
    ~OAIUpdateLedgerAccountResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateLedgerAccountResponse)

#endif // OAIUpdateLedgerAccountResponse_H
