...
/*
 * OAIGetPurchaseOrdersResponse.h
 *
 * 
 */

#ifndef OAIGetPurchaseOrdersResponse_H
#define OAIGetPurchaseOrdersResponse_H
...
class OAIGetPurchaseOrdersResponse : public OAIObject {
public:
    OAIGetPurchaseOrdersResponse();
    OAIGetPurchaseOrdersResponse(QString json);
    ~OAIGetPurchaseOrdersResponse() override;
    ...
    QList<OAIPurchaseOrder> getData() const;
    void setData(const QList<OAIPurchaseOrder> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPurchaseOrdersResponse)

#endif // OAIGetPurchaseOrdersResponse_H
