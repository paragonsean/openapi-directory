...
void OAIBill::fromJsonObject(QJsonObject json) {
    ...
    m_bill_date_isValid = ::OpenAPI::fromJsonValue(m_bill_date, json[QString("bill_date")]);
    m_bill_date_isSet = !json[QString("bill_date")].isNull() && m_bill_date_isValid;

    m_bill_number_isValid = ::OpenAPI::fromJsonValue(m_bill_number, json[QString("bill_number")]);
    m_bill_number_isSet = !json[QString("bill_number")].isNull() && m_bill_number_isValid;
...
QJsonObject OAIBill::asJsonObject() const {
    ...
    if (m_bill_date_isSet) {
        obj.insert(QString("bill_date"), ::OpenAPI::toJsonValue(m_bill_date));
    }
    if (m_bill_number_isSet) {
        obj.insert(QString("bill_number"), ::OpenAPI::toJsonValue(m_bill_number));
    }
    if (m_channel_isSet) {
...
bool OAIBill::isAccountingByRow() const {
    return m_accounting_by_row;
}
void OAIBill::setAccountingByRow(const bool &accounting_by_row) {
    m_accounting_by_row = accounting_by_row;
    m_accounting_by_row_isSet = true;
}

bool OAIBill::is_accounting_by_row_Set() const{
    return m_accounting_by_row_isSet;
}

bool OAIBill::is_accounting_by_row_Valid() const{
...
OAIBankAccount OAIBill::getBankAccount() const {
    return m_bank_account;
}
void OAIBill::setBankAccount(const OAIBankAccount &bank_account) {
    m_bank_account = bank_account;
    m_bank_account_isSet = true;
}

bool OAIBill::is_bank_account_Set() const{
    return m_bank_account_isSet;
}

bool OAIBill::is_bank_account_Valid() const{
    return m_bank_account_isValid;
}

QDate OAIBill::getBillDate() const {
    return m_bill_date;
}
void OAIBill::setBillDate(const QDate &bill_date) {
    m_bill_date = bill_date;
    m_bill_date_isSet = true;
}

bool OAIBill::is_bill_date_Set() const{
    return m_bill_date_isSet;
}

bool OAIBill::is_bill_date_Valid() const{
...
QString OAIBill::getChannel() const {
    return m_channel;
}
void OAIBill::setChannel(const QString &channel) {
    m_channel = channel;
    m_channel_isSet = true;
}

bool OAIBill::is_channel_Set() const{
    return m_channel_isSet;
}

bool OAIBill::is_channel_Valid() const{
...
QString OAIBill::getCreatedBy() const {
    return m_created_by;
}
void OAIBill::setCreatedBy(const QString &created_by) {
    m_created_by = created_by;
    m_created_by_isSet = true;
}

bool OAIBill::is_created_by_Set() const{
    return m_created_by_isSet;
}

bool OAIBill::is_created_by_Valid() const{
    return m_created_by_isValid;
}

OAICurrency OAIBill::getCurrency() const {
    return m_currency;
}
void OAIBill::setCurrency(const OAICurrency &currency) {
    m_currency = currency;
    m_currency_isSet = true;
}

bool OAIBill::is_currency_Set() const{
    return m_currency_isSet;
}

bool OAIBill::is_currency_Valid() const{
    return m_currency_isValid;
}

double OAIBill::getCurrencyRate() const {
    return m_currency_rate;
}
void OAIBill::setCurrencyRate(const double &currency_rate) {
    m_currency_rate = currency_rate;
    m_currency_rate_isSet = true;
}

bool OAIBill::is_currency_rate_Set() const{
    return m_currency_rate_isSet;
}

bool OAIBill::is_currency_rate_Valid() const{
    return m_currency_rate_isValid;
}

OAIObject OAIBill::getCustomMappings() const {
    return m_custom_mappings;
}
void OAIBill::setCustomMappings(const OAIObject &custom_mappings) {
    m_custom_mappings = custom_mappings;
    m_custom_mappings_isSet = true;
}

bool OAIBill::is_custom_mappings_Set() const{
    return m_custom_mappings_isSet;
}

bool OAIBill::is_custom_mappings_Valid() const{
    return m_custom_mappings_isValid;
}

double OAIBill::getDeposit() const {
    return m_deposit;
}
void OAIBill::setDeposit(const double &deposit) {
    m_deposit = deposit;
    m_deposit_isSet = true;
}

bool OAIBill::is_deposit_Set() const{
    return m_deposit_isSet;
}

bool OAIBill::is_deposit_Valid() const{
    return m_deposit_isValid;
}

double OAIBill::getDiscountPercentage() const {
    return m_discount_percentage;
}
void OAIBill::setDiscountPercentage(const double &discount_percentage) {
    m_discount_percentage = discount_percentage;
    m_discount_percentage_isSet = true;
}

bool OAIBill::is_discount_percentage_Set() const{
    return m_discount_percentage_isSet;
}

bool OAIBill::is_discount_percentage_Valid() const{
    return m_discount_percentage_isValid;
}

QString OAIBill::getDownstreamId() const {
    return m_downstream_id;
}
void OAIBill::setDownstreamId(const QString &downstream_id) {
    m_downstream_id = downstream_id;
    m_downstream_id_isSet = true;
}

bool OAIBill::is_downstream_id_Set() const{
    return m_downstream_id_isSet;
}

bool OAIBill::is_downstream_id_Valid() const{
    return m_downstream_id_isValid;
}

QDate OAIBill::getDueDate() const {
    return m_due_date;
}
void OAIBill::setDueDate(const QDate &due_date) {
    m_due_date = due_date;
...
QString OAIBill::getLanguage() const {
    return m_language;
}
void OAIBill::setLanguage(const QString &language) {
    m_language = language;
    m_language_isSet = true;
}

bool OAIBill::is_language_Set() const{
    return m_language_isSet;
}

bool OAIBill::is_language_Valid() const{
    return m_language_isValid;
}

OAILinkedLedgerAccount OAIBill::getLedgerAccount() const {
    return m_ledger_account;
}
void OAIBill::setLedgerAccount(const OAILinkedLedgerAccount &ledger_account) {
    m_ledger_account = ledger_account;
    m_ledger_account_isSet = true;
}

bool OAIBill::is_ledger_account_Set() const{
    return m_ledger_account_isSet;
}

bool OAIBill::is_ledger_account_Valid() const{
...
QDate OAIBill::getPaidDate() const {
    return m_paid_date;
}
void OAIBill::setPaidDate(const QDate &paid_date) {
    m_paid_date = paid_date;
    m_paid_date_isSet = true;
}

bool OAIBill::is_paid_date_Set() const{
    return m_paid_date_isSet;
}

bool OAIBill::is_paid_date_Valid() const{
    return m_paid_date_isValid;
}

QString OAIBill::getPaymentMethod() const {
    return m_payment_method;
}
void OAIBill::setPaymentMethod(const QString &payment_method) {
    m_payment_method = payment_method;
    m_payment_method_isSet = true;
}

bool OAIBill::is_payment_method_Set() const{
    return m_payment_method_isSet;
}

bool OAIBill::is_payment_method_Valid() const{
    return m_payment_method_isValid;
}

QString OAIBill::getPoNumber() const {
    return m_po_number;
}
void OAIBill::setPoNumber(const QString &po_number) {
    m_po_number = po_number;
    m_po_number_isSet = true;
}

bool OAIBill::is_po_number_Set() const{
    return m_po_number_isSet;
}

bool OAIBill::is_po_number_Valid() const{
    return m_po_number_isValid;
}

QString OAIBill::getReference() const {
    return m_reference;
}
void OAIBill::setReference(const QString &reference) {
    m_reference = reference;
    m_reference_isSet = true;
}

bool OAIBill::is_reference_Set() const{
    return m_reference_isSet;
}

bool OAIBill::is_reference_Valid() const{
    return m_reference_isValid;
}

QString OAIBill::getRowVersion() const {
    return m_row_version;
}
void OAIBill::setRowVersion(const QString &row_version) {
    m_row_version = row_version;
    m_row_version_isSet = true;
}

bool OAIBill::is_row_version_Set() const{
    return m_row_version_isSet;
}

bool OAIBill::is_row_version_Valid() const{
    return m_row_version_isValid;
}

QString OAIBill::getStatus() const {
    return m_status;
}
void OAIBill::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIBill::is_status_Set() const{
    return m_status_isSet;
}

bool OAIBill::is_status_Valid() const{
    return m_status_isValid;
}

double OAIBill::getSubTotal() const {
    return m_sub_total;
}
void OAIBill::setSubTotal(const double &sub_total) {
    m_sub_total = sub_total;
    m_sub_total_isSet = true;
}

bool OAIBill::is_sub_total_Set() const{
    return m_sub_total_isSet;
}

bool OAIBill::is_sub_total_Valid() const{
    return m_sub_total_isValid;
}

OAILinkedSupplier OAIBill::getSupplier() const {
    return m_supplier;
}
void OAIBill::setSupplier(const OAILinkedSupplier &supplier) {
    m_supplier = supplier;
    m_supplier_isSet = true;
}

bool OAIBill::is_supplier_Set() const{
    return m_supplier_isSet;
}

bool OAIBill::is_supplier_Valid() const{
    return m_supplier_isValid;
}

QString OAIBill::getTaxCode() const {
    return m_tax_code;
}
void OAIBill::setTaxCode(const QString &tax_code) {
    m_tax_code = tax_code;
    m_tax_code_isSet = true;
}

bool OAIBill::is_tax_code_Set() const{
    return m_tax_code_isSet;
}

bool OAIBill::is_tax_code_Valid() const{
    return m_tax_code_isValid;
}

bool OAIBill::isTaxInclusive() const {
    return m_tax_inclusive;
}
void OAIBill::setTaxInclusive(const bool &tax_inclusive) {
    m_tax_inclusive = tax_inclusive;
    m_tax_inclusive_isSet = true;
}

bool OAIBill::is_tax_inclusive_Set() const{
    return m_tax_inclusive_isSet;
}

bool OAIBill::is_tax_inclusive_Valid() const{
    return m_tax_inclusive_isValid;
}

QString OAIBill::getTerms() const {
    return m_terms;
}
void OAIBill::setTerms(const QString &terms) {
    m_terms = terms;
    m_terms_isSet = true;
}

bool OAIBill::is_terms_Set() const{
    return m_terms_isSet;
}

bool OAIBill::is_terms_Valid() const{
    return m_terms_isValid;
}

double OAIBill::getTotal() const {
    return m_total;
}
void OAIBill::setTotal(const double &total) {
    m_total = total;
    m_total_isSet = true;
}

bool OAIBill::is_total_Set() const{
    return m_total_isSet;
}

bool OAIBill::is_total_Valid() const{
    return m_total_isValid;
}

double OAIBill::getTotalTax() const {
    return m_total_tax;
}
void OAIBill::setTotalTax(const double &total_tax) {
    m_total_tax = total_tax;
    m_total_tax_isSet = true;
}

bool OAIBill::is_total_tax_Set() const{
    return m_total_tax_isSet;
}

bool OAIBill::is_total_tax_Valid() const{
...
QString OAIBill::getUpdatedBy() const {
    return m_updated_by;
}
void OAIBill::setUpdatedBy(const QString &updated_by) {
    m_updated_by = updated_by;
    m_updated_by_isSet = true;
}

bool OAIBill::is_updated_by_Set() const{
    return m_updated_by_isSet;
}

bool OAIBill::is_updated_by_Valid() const{
