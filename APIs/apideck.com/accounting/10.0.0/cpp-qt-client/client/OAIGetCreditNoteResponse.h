...
/*
 * OAIGetCreditNoteResponse.h
 *
 * 
 */

#ifndef OAIGetCreditNoteResponse_H
#define OAIGetCreditNoteResponse_H
...
class OAIGetCreditNoteResponse : public OAIObject {
public:
    OAIGetCreditNoteResponse();
    OAIGetCreditNoteResponse(QString json);
    ~OAIGetCreditNoteResponse() override;
    ...
    OAICreditNote getData() const;
    void setData(const OAICreditNote &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetCreditNoteResponse)

#endif // OAIGetCreditNoteResponse_H
