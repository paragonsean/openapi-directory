...
/*
 * OAIUpdateBillResponse.h
 *
 * 
 */

#ifndef OAIUpdateBillResponse_H
#define OAIUpdateBillResponse_H
...
class OAIUpdateBillResponse : public OAIObject {
public:
    OAIUpdateBillResponse();
    OAIUpdateBillResponse(QString json);
    ~OAIUpdateBillResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateBillResponse)

#endif // OAIUpdateBillResponse_H
