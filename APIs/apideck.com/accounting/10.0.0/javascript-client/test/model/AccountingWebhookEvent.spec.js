...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AccountingApi.AccountingWebhookEvent();
  });
  ...
  describe('AccountingWebhookEvent', function() {
    it('should create an instance of AccountingWebhookEvent', function() {
      // uncomment below and update the code to test AccountingWebhookEvent
      //var instance = new AccountingApi.AccountingWebhookEvent();
      //expect(instance).to.be.a(AccountingApi.AccountingWebhookEvent);
    });
