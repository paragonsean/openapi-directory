...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AccountingApi.BankAccount();
  });
  ...
  describe('BankAccount', function() {
    it('should create an instance of BankAccount', function() {
      ...
      //var instance = new AccountingApi.BankAccount();
      //expect(instance).to.be.a(AccountingApi.BankAccount);
    });
    ...
    it('should have the property branchIdentifier (base name: "branch_identifier")', function() {
      // uncomment below and update the code to test the property branchIdentifier
      //var instance = new AccountingApi.BankAccount();
      //expect(instance).to.be();
    });

    it('should have the property bsbNumber (base name: "bsb_number")', function() {
      // uncomment below and update the code to test the property bsbNumber
      //var instance = new AccountingApi.BankAccount();
      //expect(instance).to.be();
    });
