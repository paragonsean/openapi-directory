...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AccountingApi.InvoiceLineItem();
  });
  ...
  describe('InvoiceLineItem', function() {
    it('should create an instance of InvoiceLineItem', function() {
      ...
      //var instance = new AccountingApi.InvoiceLineItem();
      //expect(instance).to.be.a(AccountingApi.InvoiceLineItem);
    });
    ...
    it('should have the property departmentId (base name: "department_id")', function() {
