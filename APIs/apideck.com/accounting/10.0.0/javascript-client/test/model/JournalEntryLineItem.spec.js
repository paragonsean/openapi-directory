...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AccountingApi.JournalEntryLineItem();
  });
  ...
  describe('JournalEntryLineItem', function() {
    it('should create an instance of JournalEntryLineItem', function() {
      // uncomment below and update the code to test JournalEntryLineItem
      //var instance = new AccountingApi.JournalEntryLineItem();
      //expect(instance).to.be.a(AccountingApi.JournalEntryLineItem);
    });
