...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AccountingApi.CreditNote();
  });
  ...
  describe('CreditNote', function() {
    it('should create an instance of CreditNote', function() {
      ...
      //var instance = new AccountingApi.CreditNote();
      //expect(instance).to.be.a(AccountingApi.CreditNote);
    });
    ...
    it('should have the property datePaid (base name: "date_paid")', function() {
      // uncomment below and update the code to test the property datePaid
      //var instance = new AccountingApi.CreditNote();
      //expect(instance).to.be();
    });
    ...
    it('should have the property remainingCredit (base name: "remaining_credit")', function() {
