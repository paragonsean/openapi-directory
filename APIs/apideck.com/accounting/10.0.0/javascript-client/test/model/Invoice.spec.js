...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AccountingApi.Invoice();
  });
  ...
  describe('Invoice', function() {
    it('should create an instance of Invoice', function() {
      ...
      //var instance = new AccountingApi.Invoice();
      //expect(instance).to.be.a(AccountingApi.Invoice);
    });

    it('should have the property accountingByRow (base name: "accounting_by_row")', function() {
      // uncomment below and update the code to test the property accountingByRow
      //var instance = new AccountingApi.Invoice();
    ...
    it('should have the property currencyRate (base name: "currency_rate")', function() {
    ...
    it('should have the property customerMemo (base name: "customer_memo")', function() {
    ...
    it('should have the property sourceDocumentUrl (base name: "source_document_url")', function() {
      // uncomment below and update the code to test the property sourceDocumentUrl
      //var instance = new AccountingApi.Invoice();
      //expect(instance).to.be();
    });
    ...
    it('should have the property taxInclusive (base name: "tax_inclusive")', function() {
      // uncomment below and update the code to test the property taxInclusive
      //var instance = new AccountingApi.Invoice();
      //expect(instance).to.be();
    });
    ...
    it('should have the property trackingCategory (base name: "tracking_category")', function() {
      // uncomment below and update the code to test the property trackingCategory
      //var instance = new AccountingApi.Invoice();
      //expect(instance).to.be();
    });
