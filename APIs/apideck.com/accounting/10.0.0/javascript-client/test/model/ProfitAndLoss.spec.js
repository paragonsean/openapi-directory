...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AccountingApi.ProfitAndLoss();
  });
  ...
  describe('ProfitAndLoss', function() {
    it('should create an instance of ProfitAndLoss', function() {
      // uncomment below and update the code to test ProfitAndLoss
      //var instance = new AccountingApi.ProfitAndLoss();
      //expect(instance).to.be.a(AccountingApi.ProfitAndLoss);
    });
    ...
    it('should have the property netOperatingIncome (base name: "net_operating_income")', function() {
      // uncomment below and update the code to test the property netOperatingIncome
      //var instance = new AccountingApi.ProfitAndLoss();
      //expect(instance).to.be();
    });
