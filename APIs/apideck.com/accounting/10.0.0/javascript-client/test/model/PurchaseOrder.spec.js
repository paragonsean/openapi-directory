...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AccountingApi.PurchaseOrder();
  });
  ...
  describe('PurchaseOrder', function() {
    it('should create an instance of PurchaseOrder', function() {
      ...
      //var instance = new AccountingApi.PurchaseOrder();
      //expect(instance).to.be.a(AccountingApi.PurchaseOrder);
    });
    ...
    it('should have the property expectedArrivalDate (base name: "expected_arrival_date")', function() {
