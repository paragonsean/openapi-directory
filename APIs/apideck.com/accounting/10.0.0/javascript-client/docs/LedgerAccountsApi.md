# AccountingApi.LedgerAccountsApi
...
> CreateLedgerAccountResponse ledgerAccountsAdd(xApideckConsumerId, xApideckAppId, ledgerAccount, opts)
...
let apiInstance = new AccountingApi.LedgerAccountsApi();
...
let ledgerAccount = new AccountingApi.LedgerAccount(); // LedgerAccount | 
let opts = {
...
apiInstance.ledgerAccountsAdd(xApideckConsumerId, xApideckAppId, ledgerAccount, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> GetLedgerAccountsResponse ledgerAccountsAll(xApideckConsumerId, xApideckAppId, opts)
...
apiInstance.ledgerAccountsAll(xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> DeleteLedgerAccountResponse ledgerAccountsDelete(id, xApideckConsumerId, xApideckAppId, opts)
...
apiInstance.ledgerAccountsDelete(id, xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> GetLedgerAccountResponse ledgerAccountsOne(id, xApideckConsumerId, xApideckAppId, opts)
...
apiInstance.ledgerAccountsOne(id, xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> UpdateLedgerAccountResponse ledgerAccountsUpdate(id, xApideckConsumerId, xApideckAppId, ledgerAccount, opts)
...
apiInstance.ledgerAccountsUpdate(id, xApideckConsumerId, xApideckAppId, ledgerAccount, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
