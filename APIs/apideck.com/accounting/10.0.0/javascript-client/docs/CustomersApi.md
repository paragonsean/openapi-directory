...
> CreateCustomerResponse customersAdd(xApideckConsumerId, xApideckAppId, customer, opts)
...
let apiInstance = new AccountingApi.CustomersApi();
...
let customer = new AccountingApi.Customer(); // Customer | 
let opts = {
...
apiInstance.customersAdd(xApideckConsumerId, xApideckAppId, customer, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> GetCustomersResponse customersAll(xApideckConsumerId, xApideckAppId, opts)
...
let opts = {
  ...
  'filter': new AccountingApi.CustomersFilter(), // CustomersFilter | Apply filters
...
apiInstance.customersAll(xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> DeleteCustomerResponse customersDelete(id, xApideckConsumerId, xApideckAppId, opts)
...
apiInstance.customersDelete(id, xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> GetCustomerResponse customersOne(id, xApideckConsumerId, xApideckAppId, opts)
...
apiInstance.customersOne(id, xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> UpdateCustomerResponse customersUpdate(id, xApideckConsumerId, xApideckAppId, customer, opts)
...
apiInstance.customersUpdate(id, xApideckConsumerId, xApideckAppId, customer, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
