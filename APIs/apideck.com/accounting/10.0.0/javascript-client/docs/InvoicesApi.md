...
> CreateInvoiceResponse invoicesAdd(xApideckConsumerId, xApideckAppId, invoice, opts)
...
let apiInstance = new AccountingApi.InvoicesApi();
...
let invoice = new AccountingApi.Invoice(); // Invoice | 
let opts = {
...
apiInstance.invoicesAdd(xApideckConsumerId, xApideckAppId, invoice, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> GetInvoicesResponse invoicesAll(xApideckConsumerId, xApideckAppId, opts)
...
let opts = {
  ...
  'sort': new AccountingApi.InvoicesSort(), // InvoicesSort | Apply sorting
...
apiInstance.invoicesAll(xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> DeleteInvoiceResponse invoicesDelete(id, xApideckConsumerId, xApideckAppId, opts)
...
apiInstance.invoicesDelete(id, xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> GetInvoiceResponse invoicesOne(id, xApideckConsumerId, xApideckAppId, opts)
...
apiInstance.invoicesOne(id, xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> UpdateInvoiceResponse invoicesUpdate(id, xApideckConsumerId, xApideckAppId, invoice, opts)
...
apiInstance.invoicesUpdate(id, xApideckConsumerId, xApideckAppId, invoice, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
