...
> CreateTaxRateResponse taxRatesAdd(xApideckConsumerId, xApideckAppId, taxRate, opts)
...
let apiInstance = new AccountingApi.TaxRatesApi();
...
let taxRate = new AccountingApi.TaxRate(); // TaxRate | 
let opts = {
...
apiInstance.taxRatesAdd(xApideckConsumerId, xApideckAppId, taxRate, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> GetTaxRatesResponse taxRatesAll(xApideckConsumerId, xApideckAppId, opts)
...
let opts = {
  ...
  'filter': new AccountingApi.TaxRatesFilter(), // TaxRatesFilter | Apply filters
...
apiInstance.taxRatesAll(xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> DeleteTaxRateResponse taxRatesDelete(id, xApideckConsumerId, xApideckAppId, opts)
...
apiInstance.taxRatesDelete(id, xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> GetTaxRateResponse taxRatesOne(id, xApideckConsumerId, xApideckAppId, opts)
...
apiInstance.taxRatesOne(id, xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> UpdateTaxRateResponse taxRatesUpdate(id, xApideckConsumerId, xApideckAppId, taxRate, opts)
...
apiInstance.taxRatesUpdate(id, xApideckConsumerId, xApideckAppId, taxRate, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
