# AccountingApi.ProfitAndLossApi

All URIs are relative to *https://unify.apideck.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**profitAndLossOne**](ProfitAndLossApi.md#profitAndLossOne) | **GET** /accounting/profit-and-loss | Get Profit and Loss



## profitAndLossOne

> GetProfitAndLossResponse profitAndLossOne(xApideckConsumerId, xApideckAppId, opts)
...
let apiInstance = new AccountingApi.ProfitAndLossApi();
...
let opts = {
  ...
  'filter': new AccountingApi.ProfitAndLossFilter(), // ProfitAndLossFilter | Apply filters
...
apiInstance.profitAndLossOne(xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
 ...
 **filter** | [**ProfitAndLossFilter**](.md)| Apply filters | [optional] 
