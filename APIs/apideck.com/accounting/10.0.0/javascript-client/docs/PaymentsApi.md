...
> CreatePaymentResponse paymentsAdd(xApideckConsumerId, xApideckAppId, payment, opts)
...
let apiInstance = new AccountingApi.PaymentsApi();
...
let payment = new AccountingApi.Payment(); // Payment | 
let opts = {
...
apiInstance.paymentsAdd(xApideckConsumerId, xApideckAppId, payment, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> GetPaymentsResponse paymentsAll(xApideckConsumerId, xApideckAppId, opts)
...
let opts = {
  ...
  'filter': new AccountingApi.PaymentsFilter(), // PaymentsFilter | Apply filters
...
> DeletePaymentResponse paymentsDelete(id, xApideckConsumerId, xApideckAppId, opts)
...
> GetPaymentResponse paymentsOne(id, xApideckConsumerId, xApideckAppId, opts)
...
> UpdatePaymentResponse paymentsUpdate(id, xApideckConsumerId, xApideckAppId, payment, opts)
...
apiInstance.paymentsUpdate(id, xApideckConsumerId, xApideckAppId, payment, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
