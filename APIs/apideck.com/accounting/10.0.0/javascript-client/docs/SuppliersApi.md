# AccountingApi.SuppliersApi

All URIs are relative to *https://unify.apideck.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**suppliersAdd**](SuppliersApi.md#suppliersAdd) | **POST** /accounting/suppliers | Create Supplier
[**suppliersAll**](SuppliersApi.md#suppliersAll) | **GET** /accounting/suppliers | List Suppliers
[**suppliersDelete**](SuppliersApi.md#suppliersDelete) | **DELETE** /accounting/suppliers/{id} | Delete Supplier
[**suppliersOne**](SuppliersApi.md#suppliersOne) | **GET** /accounting/suppliers/{id} | Get Supplier
[**suppliersUpdate**](SuppliersApi.md#suppliersUpdate) | **PATCH** /accounting/suppliers/{id} | Update Supplier



## suppliersAdd

> CreateSupplierResponse suppliersAdd(xApideckConsumerId, xApideckAppId, supplier, opts)
...
let apiInstance = new AccountingApi.SuppliersApi();
...
let supplier = new AccountingApi.Supplier(); // Supplier | 
let opts = {
...
apiInstance.suppliersAdd(xApideckConsumerId, xApideckAppId, supplier, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> GetSuppliersResponse suppliersAll(xApideckConsumerId, xApideckAppId, opts)
...
let opts = {
  ...
  'filter': new AccountingApi.SuppliersFilter(), // SuppliersFilter | Apply filters
...
apiInstance.suppliersAll(xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **filter** | [**SuppliersFilter**](.md)| Apply filters | [optional] 
...
> DeleteSupplierResponse suppliersDelete(id, xApideckConsumerId, xApideckAppId, opts)
...
apiInstance.suppliersDelete(id, xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> GetSupplierResponse suppliersOne(id, xApideckConsumerId, xApideckAppId, opts)
...
apiInstance.suppliersOne(id, xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> UpdateSupplierResponse suppliersUpdate(id, xApideckConsumerId, xApideckAppId, supplier, opts)
...
apiInstance.suppliersUpdate(id, xApideckConsumerId, xApideckAppId, supplier, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
