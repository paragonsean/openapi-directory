...
class CreateSupplierResponse {
    ...
    constructor(data, operation, resource, service, status, statusCode) { 
        ...
        CreateSupplierResponse.initialize(this, data, operation, resource, service, status, statusCode);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateSupplierResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateSupplierResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateSupplierResponse.RequiredProperties) {
...
CreateSupplierResponse.RequiredProperties = ["data", "operation", "resource", "service", "status", "status_code"];
 ...
 */
CreateSupplierResponse.prototype['operation'] = undefined;

/**
 * Unified API resource name
 * @member {String} resource
 */
CreateSupplierResponse.prototype['resource'] = undefined;

/**
 * Apideck ID of service provider
 * @member {String} service
 */
CreateSupplierResponse.prototype['service'] = undefined;

/**
 * HTTP Response Status
 * @member {String} status
 */
CreateSupplierResponse.prototype['status'] = undefined;

/**
 * HTTP Response Status Code
 * @member {Number} status_code
 */
CreateSupplierResponse.prototype['status_code'] = undefined;
