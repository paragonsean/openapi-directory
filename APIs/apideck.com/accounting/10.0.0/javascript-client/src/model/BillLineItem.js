...
/**
 * The BillLineItem model module.
 * @module model/BillLineItem
 * @version 10.0.0
 */
class BillLineItem {
    /**
     * Constructs a new <code>BillLineItem</code>.
     * @alias module:model/BillLineItem
     */
    constructor() { 
        
        BillLineItem.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BillLineItem</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BillLineItem} obj Optional instance to populate.
     * @return {module:model/BillLineItem} The populated <code>BillLineItem</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BillLineItem();
            ...
            if (data.hasOwnProperty('item')) {
                obj['item'] = LinkedInvoiceItem.constructFromObject(data['item']);
            }
            if (data.hasOwnProperty('ledger_account')) {
                obj['ledger_account'] = LinkedLedgerAccount.constructFromObject(data['ledger_account']);
            }
            ...
            if (data.hasOwnProperty('tax_rate')) {
                obj['tax_rate'] = LinkedTaxRate.constructFromObject(data['tax_rate']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>BillLineItem</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BillLineItem</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['department_id'] && !(typeof data['department_id'] === 'string' || data['department_id'] instanceof String)) {
            throw new Error("Expected the field `department_id` to be a primitive type in the JSON string but got " + data['department_id']);
        }
        // ensure the json data is a string
        ...
        if (data['item']) { // data not null
          LinkedInvoiceItem.validateJSON(data['item']);
        }
        // validate the optional field `ledger_account`
        if (data['ledger_account']) { // data not null
          LinkedLedgerAccount.validateJSON(data['ledger_account']);
        }
        // ensure the json data is a string
        ...
        if (data['tax_rate']) { // data not null
          LinkedTaxRate.validateJSON(data['tax_rate']);
        }
        // ensure the json data is a string
 ...
 * @member {String} code
 */
BillLineItem.prototype['code'] = undefined;

/**
 * The date and time when the object was created.
 * @member {Date} created_at
 */
BillLineItem.prototype['created_at'] = undefined;

/**
 * The user who created the object.
 * @member {String} created_by
 */
BillLineItem.prototype['created_by'] = undefined;

/**
 * Department id
 * @member {String} department_id
 */
BillLineItem.prototype['department_id'] = undefined;

/**
 * User defined description
 * @member {String} description
 */
BillLineItem.prototype['description'] = undefined;

/**
 * Discount amount applied to the line item when supported downstream.
 * @member {Number} discount_amount
 */
BillLineItem.prototype['discount_amount'] = undefined;

/**
 * Discount percentage applied to the line item when supported downstream.
 * @member {Number} discount_percentage
 */
BillLineItem.prototype['discount_percentage'] = undefined;

/**
 * A unique identifier for an object.
 * @member {String} id
 */
BillLineItem.prototype['id'] = undefined;

/**
 * @member {module:model/LinkedInvoiceItem} item
 */
BillLineItem.prototype['item'] = undefined;

/**
 * @member {module:model/LinkedLedgerAccount} ledger_account
 */
BillLineItem.prototype['ledger_account'] = undefined;

/**
 * Line number in the invoice
 * @member {Number} line_number
 */
BillLineItem.prototype['line_number'] = undefined;

/**
 * Location id
 * @member {String} location_id
 */
BillLineItem.prototype['location_id'] = undefined;

/**
 * @member {Number} quantity
 */
BillLineItem.prototype['quantity'] = undefined;

/**
 * Row ID
 * @member {String} row_id
 */
BillLineItem.prototype['row_id'] = undefined;

/**
 * A binary value used to detect updates to a object and prevent data conflicts. It is incremented each time an update is made to the object.
 * @member {String} row_version
 */
BillLineItem.prototype['row_version'] = undefined;

/**
 * Tax amount
 * @member {Number} tax_amount
 */
BillLineItem.prototype['tax_amount'] = undefined;

/**
 * @member {module:model/LinkedTaxRate} tax_rate
 */
BillLineItem.prototype['tax_rate'] = undefined;

/**
 * Total amount of the line item
 * @member {Number} total_amount
 */
BillLineItem.prototype['total_amount'] = undefined;

/**
 * Bill Line Item type
 * @member {module:model/BillLineItem.TypeEnum} type
 */
BillLineItem.prototype['type'] = undefined;

/**
 * Description of the unit type the item is sold as, ie: kg, hour.
 * @member {String} unit_of_measure
 */
BillLineItem.prototype['unit_of_measure'] = undefined;

/**
 * @member {Number} unit_price
 */
BillLineItem.prototype['unit_price'] = undefined;

/**
 * The date and time when the object was last updated.
 * @member {Date} updated_at
 */
BillLineItem.prototype['updated_at'] = undefined;

/**
 * The user who last updated the object.
 * @member {String} updated_by
 */
BillLineItem.prototype['updated_by'] = undefined;
