...
class BankAccount {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('branch_identifier')) {
                obj['branch_identifier'] = ApiClient.convertToType(data['branch_identifier'], 'String');
            }
            if (data.hasOwnProperty('bsb_number')) {
                obj['bsb_number'] = ApiClient.convertToType(data['bsb_number'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['branch_identifier'] && !(typeof data['branch_identifier'] === 'string' || data['branch_identifier'] instanceof String)) {
            throw new Error("Expected the field `branch_identifier` to be a primitive type in the JSON string but got " + data['branch_identifier']);
        }
        // ensure the json data is a string
        if (data['bsb_number'] && !(typeof data['bsb_number'] === 'string' || data['bsb_number'] instanceof String)) {
            throw new Error("Expected the field `bsb_number` to be a primitive type in the JSON string but got " + data['bsb_number']);
        }
        // ensure the json data is a string
 ...
 */
BankAccount.prototype['account_name'] = undefined;
 ...
 * @member {module:model/BankAccount.AccountTypeEnum} account_type
 */
 ...
 * @member {String} branch_identifier
 */
BankAccount.prototype['branch_identifier'] = undefined;
 ...
 * @member {String} bsb_number
 */
BankAccount.prototype['bsb_number'] = undefined;
 ...
 */
BankAccount.prototype['routing_number'] = undefined;
