...
/**
 * The AccountingWebhookEvent model module.
 * @module model/AccountingWebhookEvent
 * @version 10.0.0
 */
class AccountingWebhookEvent {
    /**
     * Constructs a new <code>AccountingWebhookEvent</code>.
     * @alias module:model/AccountingWebhookEvent
     */
    constructor() { 
        
        AccountingWebhookEvent.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AccountingWebhookEvent</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AccountingWebhookEvent} obj Optional instance to populate.
     * @return {module:model/AccountingWebhookEvent} The populated <code>AccountingWebhookEvent</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AccountingWebhookEvent();
            ...
            if (data.hasOwnProperty('event_type')) {
                obj['event_type'] = AccountingEventType.constructFromObject(data['event_type']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AccountingWebhookEvent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AccountingWebhookEvent</code>.
     */
 ...
 */
AccountingWebhookEvent.prototype['consumer_id'] = undefined;

/**
 * The service provider's ID of the entity that triggered this event
 * @member {String} entity_id
 */
AccountingWebhookEvent.prototype['entity_id'] = undefined;

/**
 * The type entity that triggered this event
 * @member {String} entity_type
 */
AccountingWebhookEvent.prototype['entity_type'] = undefined;

/**
 * The url to retrieve entity detail.
 * @member {String} entity_url
 */
AccountingWebhookEvent.prototype['entity_url'] = undefined;

/**
 * Unique reference to this request event
 * @member {String} event_id
 */
AccountingWebhookEvent.prototype['event_id'] = undefined;

/**
 * The current count this request event has been attempted
 * @member {Number} execution_attempt
 */
AccountingWebhookEvent.prototype['execution_attempt'] = undefined;

/**
 * ISO Datetime for when the original event occurred
 * @member {String} occurred_at
 */
AccountingWebhookEvent.prototype['occurred_at'] = undefined;

/**
 * Service provider identifier
 * @member {String} service_id
 */
AccountingWebhookEvent.prototype['service_id'] = undefined;

/**
 * Name of Apideck Unified API
 * @member {module:model/AccountingWebhookEvent.UnifiedApiEnum} unified_api
 */
AccountingWebhookEvent.prototype['unified_api'] = undefined;

/**
 * @member {module:model/AccountingEventType} event_type
 */
AccountingWebhookEvent.prototype['event_type'] = undefined;
 ...
 * @readonly
 */
AccountingWebhookEvent['UnifiedApiEnum'] = {
...
export default AccountingWebhookEvent;
