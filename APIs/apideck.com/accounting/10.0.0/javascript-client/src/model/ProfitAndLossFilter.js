...
/**
 * The ProfitAndLossFilter model module.
 * @module model/ProfitAndLossFilter
 * @version 10.0.0
 */
class ProfitAndLossFilter {
    /**
     * Constructs a new <code>ProfitAndLossFilter</code>.
     * @alias module:model/ProfitAndLossFilter
     */
    constructor() { 
        
        ProfitAndLossFilter.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ProfitAndLossFilter</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ProfitAndLossFilter} obj Optional instance to populate.
     * @return {module:model/ProfitAndLossFilter} The populated <code>ProfitAndLossFilter</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProfitAndLossFilter();
    ...
    /**
     * Validates the JSON data with respect to <code>ProfitAndLossFilter</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProfitAndLossFilter</code>.
     */
