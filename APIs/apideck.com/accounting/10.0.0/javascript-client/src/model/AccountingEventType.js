...
* @readonly
*/
export default class AccountingEventType {
    ...
    /**
    * Returns a <code>AccountingEventType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/AccountingEventType} The enum <code>AccountingEventType</code> value.
    */
