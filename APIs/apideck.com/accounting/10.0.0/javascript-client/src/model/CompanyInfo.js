...
class CompanyInfo {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('automated_sales_tax')) {
                obj['automated_sales_tax'] = ApiClient.convertToType(data['automated_sales_tax'], 'Boolean');
            }
            if (data.hasOwnProperty('company_name')) {
                obj['company_name'] = ApiClient.convertToType(data['company_name'], 'String');
            }
            if (data.hasOwnProperty('company_start_date')) {
                obj['company_start_date'] = ApiClient.convertToType(data['company_start_date'], 'Date');
            }
            ...
            if (data.hasOwnProperty('default_sales_tax')) {
                obj['default_sales_tax'] = TaxRate.constructFromObject(data['default_sales_tax']);
            }
            if (data.hasOwnProperty('emails')) {
                obj['emails'] = ApiClient.convertToType(data['emails'], [Email]);
            }
            if (data.hasOwnProperty('fiscal_year_start_month')) {
                obj['fiscal_year_start_month'] = ApiClient.convertToType(data['fiscal_year_start_month'], 'String');
            }
            ...
            if (data.hasOwnProperty('sales_tax_enabled')) {
                obj['sales_tax_enabled'] = ApiClient.convertToType(data['sales_tax_enabled'], 'Boolean');
            }
    ...
    static validateJSON(data) {
        ...
        if (data['default_sales_tax']) { // data not null
          TaxRate.validateJSON(data['default_sales_tax']);
        }
        ...
        // ensure the json data is a string
        if (data['fiscal_year_start_month'] && !(typeof data['fiscal_year_start_month'] === 'string' || data['fiscal_year_start_month'] instanceof String)) {
            throw new Error("Expected the field `fiscal_year_start_month` to be a primitive type in the JSON string but got " + data['fiscal_year_start_month']);
        }
        // ensure the json data is a string
 ...
 * @member {Boolean} automated_sales_tax
 */
CompanyInfo.prototype['automated_sales_tax'] = undefined;

/**
 * The name of the company.
 * @member {String} company_name
 */
CompanyInfo.prototype['company_name'] = undefined;

/**
 * Date when company file was created
 * @member {Date} company_start_date
 */
CompanyInfo.prototype['company_start_date'] = undefined;

/**
 * country code according to ISO 3166-1 alpha-2.
 * @member {String} country
 */
CompanyInfo.prototype['country'] = undefined;

/**
 * The date and time when the object was created.
 * @member {Date} created_at
 */
CompanyInfo.prototype['created_at'] = undefined;

/**
 * The user who created the object.
 * @member {String} created_by
 */
CompanyInfo.prototype['created_by'] = undefined;

/**
 * @member {module:model/Currency} currency
 */
CompanyInfo.prototype['currency'] = undefined;

/**
 * When custom mappings are configured on the resource, the result is included here.
 * @member {Object} custom_mappings
 */
CompanyInfo.prototype['custom_mappings'] = undefined;

/**
 * @member {module:model/TaxRate} default_sales_tax
 */
CompanyInfo.prototype['default_sales_tax'] = undefined;

/**
 * @member {Array.<module:model/Email>} emails
 */
CompanyInfo.prototype['emails'] = undefined;

/**
 * The start month of fiscal year.
 * @member {module:model/CompanyInfo.FiscalYearStartMonthEnum} fiscal_year_start_month
 */
CompanyInfo.prototype['fiscal_year_start_month'] = undefined;
 ...
 */
CompanyInfo.prototype['language'] = undefined;

/**
 * The legal name of the company
 * @member {String} legal_name
 */
CompanyInfo.prototype['legal_name'] = undefined;

/**
 * @member {Array.<module:model/PhoneNumber>} phone_numbers
 */
CompanyInfo.prototype['phone_numbers'] = undefined;

/**
 * A binary value used to detect updates to a object and prevent data conflicts. It is incremented each time an update is made to the object.
 * @member {String} row_version
 */
CompanyInfo.prototype['row_version'] = undefined;

/**
 * Whether sales tax is enabled for the company
 * @member {Boolean} sales_tax_enabled
 */
CompanyInfo.prototype['sales_tax_enabled'] = undefined;

/**
 * @member {String} sales_tax_number
 */
CompanyInfo.prototype['sales_tax_number'] = undefined;

/**
 * Based on the status some functionality is enabled or disabled.
 * @member {module:model/CompanyInfo.StatusEnum} status
 */
CompanyInfo.prototype['status'] = undefined;

/**
 * The date and time when the object was last updated.
 * @member {Date} updated_at
 */
CompanyInfo.prototype['updated_at'] = undefined;

/**
 * The user who last updated the object.
 * @member {String} updated_by
 */
CompanyInfo.prototype['updated_by'] = undefined;
...
/**
 * Allowed values for the <code>fiscal_year_start_month</code> property.
 * @enum {String}
 * @readonly
 */
CompanyInfo['FiscalYearStartMonthEnum'] = {
