...
public class JournalEntry {
  ...
  public static final String SERIALIZED_NAME_JOURNAL_SYMBOL = "journal_symbol";
  @SerializedName(SERIALIZED_NAME_JOURNAL_SYMBOL)
  private String journalSymbol;

  public static final String SERIALIZED_NAME_LINE_ITEMS = "line_items";
  @SerializedName(SERIALIZED_NAME_LINE_ITEMS)
  private List<JournalEntryLineItem> lineItems = new ArrayList<>();
  ...
  public JournalEntry currency(Currency currency) {
  ...
  public JournalEntry currencyRate(BigDecimal currencyRate) {
  ...
  public JournalEntry customMappings(Object customMappings) {
  ...
  public JournalEntry journalSymbol(String journalSymbol) {
  ...
  public void setJournalSymbol(String journalSymbol) {
    this.journalSymbol = journalSymbol;
  }


  public JournalEntry lineItems(List<JournalEntryLineItem> lineItems) {
    this.lineItems = lineItems;
    return this;
  }

  public JournalEntry addLineItemsItem(JournalEntryLineItem lineItemsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<JournalEntryLineItem> getLineItems() {
    return lineItems;
  }

  public void setLineItems(List<JournalEntryLineItem> lineItems) {
    this.lineItems = lineItems;
  }


  public JournalEntry memo(String memo) {
    this.memo = memo;
    return this;
  }
  ...
  public JournalEntry number(String number) {
    this.number = number;
    return this;
  }
  ...
  public JournalEntry postedAt(OffsetDateTime postedAt) {
  ...
  public JournalEntry rowVersion(String rowVersion) {
  ...
  public JournalEntry taxCode(String taxCode) {
  ...
  public JournalEntry taxType(String taxType) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.createdAt, journalEntry.createdAt) &&
        Objects.equals(this.createdBy, journalEntry.createdBy) &&
        Objects.equals(this.currency, journalEntry.currency) &&
        Objects.equals(this.currencyRate, journalEntry.currencyRate) &&
        Objects.equals(this.customMappings, journalEntry.customMappings) &&
        Objects.equals(this.id, journalEntry.id) &&
        Objects.equals(this.journalSymbol, journalEntry.journalSymbol) &&
        Objects.equals(this.lineItems, journalEntry.lineItems) &&
        Objects.equals(this.memo, journalEntry.memo) &&
        Objects.equals(this.number, journalEntry.number) &&
        Objects.equals(this.postedAt, journalEntry.postedAt) &&
        Objects.equals(this.rowVersion, journalEntry.rowVersion) &&
        Objects.equals(this.taxCode, journalEntry.taxCode) &&
        Objects.equals(this.taxType, journalEntry.taxType) &&
        Objects.equals(this.title, journalEntry.title) &&
        Objects.equals(this.updatedAt, journalEntry.updatedAt) &&
        Objects.equals(this.updatedBy, journalEntry.updatedBy);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(createdAt, createdBy, currency, currencyRate, customMappings, id, journalSymbol, lineItems, memo, number, postedAt, rowVersion, taxCode, taxType, title, updatedAt, updatedBy);
  }
  ...
  public String toString() {
    ...
    sb.append("    journalSymbol: ").append(toIndentedString(journalSymbol)).append("\n");
  ...
  static {
    ...
    openapiFields.add("journal_symbol");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("journal_symbol") != null && !jsonObj.get("journal_symbol").isJsonNull()) && !jsonObj.get("journal_symbol").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `journal_symbol` to be a primitive type in the JSON string but got `%s`", jsonObj.get("journal_symbol").toString()));
      }
      if (jsonObj.get("line_items") != null && !jsonObj.get("line_items").isJsonNull()) {
        ...
        if (jsonArraylineItems != null) {
          ...
          for (int i = 0; i < jsonArraylineItems.size(); i++) {
            JournalEntryLineItem.validateJsonElement(jsonArraylineItems.get(i));
          };
        }
      }
