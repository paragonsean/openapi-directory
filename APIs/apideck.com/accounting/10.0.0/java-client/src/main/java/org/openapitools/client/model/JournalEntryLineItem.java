...
public class JournalEntryLineItem {
  ...
  public JournalEntryLineItem customer(LinkedCustomer customer) {
  ...
  public JournalEntryLineItem description(String description) {
  ...
  public JournalEntryLineItem ledgerAccount(LinkedLedgerAccount ledgerAccount) {
  ...
  public JournalEntryLineItem subTotal(BigDecimal subTotal) {
  ...
  public JournalEntryLineItem supplier(LinkedSupplier supplier) {
  ...
  public JournalEntryLineItem taxAmount(BigDecimal taxAmount) {
  ...
  public JournalEntryLineItem taxRate(LinkedTaxRate taxRate) {
  ...
  public JournalEntryLineItem totalAmount(BigDecimal totalAmount) {
  ...
  public JournalEntryLineItem trackingCategory(LinkedTrackingCategory trackingCategory) {
  ...
  public JournalEntryLineItem type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    JournalEntryLineItem journalEntryLineItem = (JournalEntryLineItem) o;
    return Objects.equals(this.customer, journalEntryLineItem.customer) &&
        Objects.equals(this.departmentId, journalEntryLineItem.departmentId) &&
        Objects.equals(this.description, journalEntryLineItem.description) &&
        Objects.equals(this.id, journalEntryLineItem.id) &&
        Objects.equals(this.ledgerAccount, journalEntryLineItem.ledgerAccount) &&
        Objects.equals(this.locationId, journalEntryLineItem.locationId) &&
        Objects.equals(this.subTotal, journalEntryLineItem.subTotal) &&
        Objects.equals(this.supplier, journalEntryLineItem.supplier) &&
        Objects.equals(this.taxAmount, journalEntryLineItem.taxAmount) &&
        Objects.equals(this.taxRate, journalEntryLineItem.taxRate) &&
        Objects.equals(this.totalAmount, journalEntryLineItem.totalAmount) &&
        Objects.equals(this.trackingCategory, journalEntryLineItem.trackingCategory) &&
        Objects.equals(this.type, journalEntryLineItem.type);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(customer, departmentId, description, id, ledgerAccount, locationId, subTotal, supplier, taxAmount, taxRate, totalAmount, trackingCategory, type);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("ledger_account");
   ...
   * @throws IOException if the JSON Element is invalid with respect to JournalEntryLineItem
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!JournalEntryLineItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in JournalEntryLineItem is not found in the empty JSON string", JournalEntryLineItem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!JournalEntryLineItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `JournalEntryLineItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : JournalEntryLineItem.openapiRequiredFields) {
      ...
      // validate the required field `ledger_account`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!JournalEntryLineItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'JournalEntryLineItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<JournalEntryLineItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(JournalEntryLineItem.class));

       return (TypeAdapter<T>) new TypeAdapter<JournalEntryLineItem>() {
           @Override
           public void write(JsonWriter out, JournalEntryLineItem value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public JournalEntryLineItem read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of JournalEntryLineItem given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of JournalEntryLineItem
   * @throws IOException if the JSON string is invalid with respect to JournalEntryLineItem
   */
  public static JournalEntryLineItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, JournalEntryLineItem.class);
  }

  /**
   * Convert an instance of JournalEntryLineItem to an JSON string
   *
   * @return JSON string
   */
