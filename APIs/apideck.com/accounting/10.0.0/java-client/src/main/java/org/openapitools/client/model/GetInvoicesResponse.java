...
public class GetInvoicesResponse {
  ...
  public GetInvoicesResponse data(List<Invoice> data) {
    this.data = data;
    return this;
  }

  public GetInvoicesResponse addDataItem(Invoice dataItem) {
    if (this.data == null) {
  ...
  public GetInvoicesResponse links(Links links) {
    this.links = links;
    return this;
  }
  ...
  public GetInvoicesResponse meta(Meta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public GetInvoicesResponse operation(String operation) {
  ...
  public GetInvoicesResponse resource(String resource) {
  ...
  public GetInvoicesResponse service(String service) {
  ...
  public GetInvoicesResponse statusCode(Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, getInvoicesResponse.data) &&
        Objects.equals(this.links, getInvoicesResponse.links) &&
        Objects.equals(this.meta, getInvoicesResponse.meta) &&
        Objects.equals(this.operation, getInvoicesResponse.operation) &&
        Objects.equals(this.resource, getInvoicesResponse.resource) &&
        Objects.equals(this.service, getInvoicesResponse.service) &&
        Objects.equals(this.status, getInvoicesResponse.status) &&
        Objects.equals(this.statusCode, getInvoicesResponse.statusCode);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetInvoicesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetInvoicesResponse is not found in the empty JSON string", GetInvoicesResponse.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<GetInvoicesResponse>() {
           @Override
