...
import org.openapitools.client.model.AccountingEventType;
...
public class AccountingWebhookEvent {
  ...
  public AccountingWebhookEvent() {
  }

  public AccountingWebhookEvent consumerId(String consumerId) {
  ...
  public AccountingWebhookEvent entityId(String entityId) {
  ...
  public AccountingWebhookEvent entityType(String entityType) {
  ...
  public AccountingWebhookEvent entityUrl(String entityUrl) {
  ...
  public AccountingWebhookEvent eventId(String eventId) {
  ...
  public AccountingWebhookEvent executionAttempt(BigDecimal executionAttempt) {
  ...
  public AccountingWebhookEvent occurredAt(String occurredAt) {
  ...
  public AccountingWebhookEvent serviceId(String serviceId) {
  ...
  public AccountingWebhookEvent unifiedApi(UnifiedApiEnum unifiedApi) {
  ...
  public AccountingWebhookEvent eventType(AccountingEventType eventType) {
  ...
  public boolean equals(Object o) {
    ...
    AccountingWebhookEvent accountingWebhookEvent = (AccountingWebhookEvent) o;
    return Objects.equals(this.consumerId, accountingWebhookEvent.consumerId) &&
        Objects.equals(this.entityId, accountingWebhookEvent.entityId) &&
        Objects.equals(this.entityType, accountingWebhookEvent.entityType) &&
        Objects.equals(this.entityUrl, accountingWebhookEvent.entityUrl) &&
        Objects.equals(this.eventId, accountingWebhookEvent.eventId) &&
        Objects.equals(this.executionAttempt, accountingWebhookEvent.executionAttempt) &&
        Objects.equals(this.occurredAt, accountingWebhookEvent.occurredAt) &&
        Objects.equals(this.serviceId, accountingWebhookEvent.serviceId) &&
        Objects.equals(this.unifiedApi, accountingWebhookEvent.unifiedApi) &&
        Objects.equals(this.eventType, accountingWebhookEvent.eventType);
  }
  ...
  public String toString() {
    ...
    sb.append("class AccountingWebhookEvent {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AccountingWebhookEvent
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AccountingWebhookEvent.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccountingWebhookEvent is not found in the empty JSON string", AccountingWebhookEvent.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AccountingWebhookEvent.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AccountingWebhookEvent` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("event_type") != null && !jsonObj.get("event_type").isJsonNull()) {
        AccountingEventType.validateJsonElement(jsonObj.get("event_type"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccountingWebhookEvent.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccountingWebhookEvent' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccountingWebhookEvent> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccountingWebhookEvent.class));

       return (TypeAdapter<T>) new TypeAdapter<AccountingWebhookEvent>() {
           @Override
           public void write(JsonWriter out, AccountingWebhookEvent value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AccountingWebhookEvent read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AccountingWebhookEvent given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AccountingWebhookEvent
   * @throws IOException if the JSON string is invalid with respect to AccountingWebhookEvent
   */
  public static AccountingWebhookEvent fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccountingWebhookEvent.class);
  }

  /**
   * Convert an instance of AccountingWebhookEvent to an JSON string
   *
   * @return JSON string
   */
