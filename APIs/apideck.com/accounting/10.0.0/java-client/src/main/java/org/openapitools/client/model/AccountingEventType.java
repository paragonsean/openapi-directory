...
/**
 * Gets or Sets AccountingEventType
 */
@JsonAdapter(AccountingEventType.Adapter.class)
public enum AccountingEventType {
  ...
  AccountingEventType(String value) {
    this.value = value;
  }
  ...
  public static AccountingEventType fromValue(String value) {
    for (AccountingEventType b : AccountingEventType.values()) {
  ...
  public static class Adapter extends TypeAdapter<AccountingEventType> {
    @Override
    public void write(final JsonWriter jsonWriter, final AccountingEventType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AccountingEventType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AccountingEventType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    AccountingEventType.fromValue(value);
  }
}
