...
public class GetSupplierResponse {
  ...
  public GetSupplierResponse operation(String operation) {
  ...
  public GetSupplierResponse resource(String resource) {
  ...
  public GetSupplierResponse service(String service) {
  ...
  public GetSupplierResponse status(String status) {
    this.status = status;
    return this;
  }
  ...
  public GetSupplierResponse statusCode(Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, getSupplierResponse.data) &&
        Objects.equals(this.operation, getSupplierResponse.operation) &&
        Objects.equals(this.resource, getSupplierResponse.resource) &&
        Objects.equals(this.service, getSupplierResponse.service) &&
        Objects.equals(this.status, getSupplierResponse.status) &&
        Objects.equals(this.statusCode, getSupplierResponse.statusCode);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetSupplierResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetSupplierResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetSupplierResponse is not found in the empty JSON string", GetSupplierResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetSupplierResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetSupplierResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetSupplierResponse.openapiRequiredFields) {
      ...
      Supplier.validateJsonElement(jsonObj.get("data"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<GetSupplierResponse>() {
           @Override
