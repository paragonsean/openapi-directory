...
public class TaxRate {
  ...
  private List<TaxComponentsInner> components;
  ...
  public static final String SERIALIZED_NAME_ORIGINAL_TAX_RATE_ID = "original_tax_rate_id";
  @SerializedName(SERIALIZED_NAME_ORIGINAL_TAX_RATE_ID)
  private String originalTaxRateId;

  public static final String SERIALIZED_NAME_REPORT_TAX_TYPE = "report_tax_type";
  ...
  public static final String SERIALIZED_NAME_TAX_PAYABLE_ACCOUNT_ID = "tax_payable_account_id";
  @SerializedName(SERIALIZED_NAME_TAX_PAYABLE_ACCOUNT_ID)
  private String taxPayableAccountId;

  public static final String SERIALIZED_NAME_TAX_REMITTED_ACCOUNT_ID = "tax_remitted_account_id";
  @SerializedName(SERIALIZED_NAME_TAX_REMITTED_ACCOUNT_ID)
  private String taxRemittedAccountId;

  public static final String SERIALIZED_NAME_TOTAL_TAX_RATE = "total_tax_rate";
  ...
  public TaxRate components(List<TaxComponentsInner> components) {
    this.components = components;
    return this;
  }

  public TaxRate addComponentsItem(TaxComponentsInner componentsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<TaxComponentsInner> getComponents() {
    return components;
  }

  public void setComponents(List<TaxComponentsInner> components) {
    this.components = components;
  }
  ...
  public TaxRate customMappings(Object customMappings) {
  ...
  public TaxRate effectiveTaxRate(BigDecimal effectiveTaxRate) {
  ...
  public TaxRate originalTaxRateId(String originalTaxRateId) {
   ...
   */
  @javax.annotation.Nullable
  public String getOriginalTaxRateId() {
    return originalTaxRateId;
  }

  public void setOriginalTaxRateId(String originalTaxRateId) {
    this.originalTaxRateId = originalTaxRateId;
  }


  public TaxRate reportTaxType(String reportTaxType) {
   ...
   */
  @javax.annotation.Nullable
  public String getReportTaxType() {
    return reportTaxType;
  }

  public void setReportTaxType(String reportTaxType) {
    this.reportTaxType = reportTaxType;
  }


  public TaxRate rowVersion(String rowVersion) {
  ...
  public TaxRate taxPayableAccountId(String taxPayableAccountId) {
   ...
   */
  @javax.annotation.Nullable
  public String getTaxPayableAccountId() {
    return taxPayableAccountId;
  }

  public void setTaxPayableAccountId(String taxPayableAccountId) {
    this.taxPayableAccountId = taxPayableAccountId;
  }


  public TaxRate taxRemittedAccountId(String taxRemittedAccountId) {
   ...
   */
  @javax.annotation.Nullable
  public String getTaxRemittedAccountId() {
    return taxRemittedAccountId;
  }

  public void setTaxRemittedAccountId(String taxRemittedAccountId) {
    this.taxRemittedAccountId = taxRemittedAccountId;
  }


  public TaxRate totalTaxRate(BigDecimal totalTaxRate) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, taxRate.code) &&
        Objects.equals(this.components, taxRate.components) &&
        Objects.equals(this.createdAt, taxRate.createdAt) &&
        Objects.equals(this.createdBy, taxRate.createdBy) &&
        Objects.equals(this.customMappings, taxRate.customMappings) &&
        Objects.equals(this.description, taxRate.description) &&
        Objects.equals(this.effectiveTaxRate, taxRate.effectiveTaxRate) &&
        Objects.equals(this.id, taxRate.id) &&
        Objects.equals(this.name, taxRate.name) &&
        Objects.equals(this.originalTaxRateId, taxRate.originalTaxRateId) &&
        Objects.equals(this.reportTaxType, taxRate.reportTaxType) &&
        Objects.equals(this.rowVersion, taxRate.rowVersion) &&
        Objects.equals(this.status, taxRate.status) &&
        Objects.equals(this.taxPayableAccountId, taxRate.taxPayableAccountId) &&
        Objects.equals(this.taxRemittedAccountId, taxRate.taxRemittedAccountId) &&
        Objects.equals(this.totalTaxRate, taxRate.totalTaxRate) &&
        Objects.equals(this.type, taxRate.type) &&
        Objects.equals(this.updatedAt, taxRate.updatedAt) &&
        Objects.equals(this.updatedBy, taxRate.updatedBy);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(code, components, createdAt, createdBy, customMappings, description, effectiveTaxRate, id, name, originalTaxRateId, reportTaxType, rowVersion, status, taxPayableAccountId, taxRemittedAccountId, totalTaxRate, type, updatedAt, updatedBy);
  }
  ...
  public String toString() {
    ...
    sb.append("    originalTaxRateId: ").append(toIndentedString(originalTaxRateId)).append("\n");
    ...
    sb.append("    taxPayableAccountId: ").append(toIndentedString(taxPayableAccountId)).append("\n");
    sb.append("    taxRemittedAccountId: ").append(toIndentedString(taxRemittedAccountId)).append("\n");
  ...
  static {
    ...
    openapiFields.add("original_tax_rate_id");
    openapiFields.add("report_tax_type");
    openapiFields.add("row_version");
    openapiFields.add("status");
    openapiFields.add("tax_payable_account_id");
    openapiFields.add("tax_remitted_account_id");
    openapiFields.add("total_tax_rate");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("components") != null && !jsonObj.get("components").isJsonNull()) {
        ...
        if (jsonArraycomponents != null) {
          ...
          for (int i = 0; i < jsonArraycomponents.size(); i++) {
            TaxComponentsInner.validateJsonElement(jsonArraycomponents.get(i));
          };
        }
      }
      ...
      if ((jsonObj.get("original_tax_rate_id") != null && !jsonObj.get("original_tax_rate_id").isJsonNull()) && !jsonObj.get("original_tax_rate_id").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `original_tax_rate_id` to be a primitive type in the JSON string but got `%s`", jsonObj.get("original_tax_rate_id").toString()));
      }
      if ((jsonObj.get("report_tax_type") != null && !jsonObj.get("report_tax_type").isJsonNull()) && !jsonObj.get("report_tax_type").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `report_tax_type` to be a primitive type in the JSON string but got `%s`", jsonObj.get("report_tax_type").toString()));
      }
      ...
      if ((jsonObj.get("tax_payable_account_id") != null && !jsonObj.get("tax_payable_account_id").isJsonNull()) && !jsonObj.get("tax_payable_account_id").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `tax_payable_account_id` to be a primitive type in the JSON string but got `%s`", jsonObj.get("tax_payable_account_id").toString()));
      }
      if ((jsonObj.get("tax_remitted_account_id") != null && !jsonObj.get("tax_remitted_account_id").isJsonNull()) && !jsonObj.get("tax_remitted_account_id").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `tax_remitted_account_id` to be a primitive type in the JSON string but got `%s`", jsonObj.get("tax_remitted_account_id").toString()));
      }
