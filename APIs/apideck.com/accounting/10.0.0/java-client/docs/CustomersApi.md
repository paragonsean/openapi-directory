...
<a id="customersAdd"></a>
# **customersAdd**
> CreateCustomerResponse customersAdd(xApideckConsumerId, xApideckAppId, customer, raw, xApideckServiceId)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      CreateCustomerResponse result = apiInstance.customersAdd(xApideckConsumerId, xApideckAppId, customer, raw, xApideckServiceId);
...
<a id="customersAll"></a>
# **customersAll**
> GetCustomersResponse customersAll(xApideckConsumerId, xApideckAppId, raw, xApideckServiceId, cursor, limit, filter, passThrough, fields)
...
public class Example {
  public static void main(String[] args) {
    ...
    CustomersFilter filter = new CustomersFilter(); // CustomersFilter | Apply filters
    ...
    try {
      GetCustomersResponse result = apiInstance.customersAll(xApideckConsumerId, xApideckAppId, raw, xApideckServiceId, cursor, limit, filter, passThrough, fields);
      System.out.println(result);
    } catch (ApiException e) {
...
# **customersDelete**
> DeleteCustomerResponse customersDelete(id, xApideckConsumerId, xApideckAppId, xApideckServiceId, raw)
...
<a id="customersOne"></a>
# **customersOne**
> GetCustomerResponse customersOne(id, xApideckConsumerId, xApideckAppId, xApideckServiceId, raw, fields)
...
public class Example {
  public static void main(String[] args) {
    ...
    String fields = "id,updated_at"; // String | The 'fields' parameter allows API users to specify the fields they want to include in the API response. If this parameter is not present, the API will return all available fields. If this parameter is present, only the fields specified in the comma-separated string will be included in the response. Nested properties can also be requested by using a dot notation. <br /><br />Example: `fields=name,email,addresses.city`<br /><br />In the example above, the response will only include the fields \"name\", \"email\" and \"addresses.city\". If any other fields are available, they will be excluded.
    try {
      GetCustomerResponse result = apiInstance.customersOne(id, xApideckConsumerId, xApideckAppId, xApideckServiceId, raw, fields);
      System.out.println(result);
    } catch (ApiException e) {
...
# **customersUpdate**
> UpdateCustomerResponse customersUpdate(id, xApideckConsumerId, xApideckAppId, customer, xApideckServiceId, raw)
...
public class Example {
  public static void main(String[] args) {
    ...
    Boolean raw = false; // Boolean | Include raw response. Mostly used for debugging purposes
    try {
      UpdateCustomerResponse result = apiInstance.customersUpdate(id, xApideckConsumerId, xApideckAppId, customer, xApideckServiceId, raw);
      System.out.println(result);
    } catch (ApiException e) {
