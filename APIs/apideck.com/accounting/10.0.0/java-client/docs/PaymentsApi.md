...
|------------- | ------------- | -------------|
| [**paymentsAdd**](PaymentsApi.md#paymentsAdd) | **POST** /accounting/payments | Create Payment |
| [**paymentsAll**](PaymentsApi.md#paymentsAll) | **GET** /accounting/payments | List Payments |
| [**paymentsDelete**](PaymentsApi.md#paymentsDelete) | **DELETE** /accounting/payments/{id} | Delete Payment |
| [**paymentsOne**](PaymentsApi.md#paymentsOne) | **GET** /accounting/payments/{id} | Get Payment |
| [**paymentsUpdate**](PaymentsApi.md#paymentsUpdate) | **PATCH** /accounting/payments/{id} | Update Payment |


<a id="paymentsAdd"></a>
# **paymentsAdd**
> CreatePaymentResponse paymentsAdd(xApideckConsumerId, xApideckAppId, payment, raw, xApideckServiceId)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      CreatePaymentResponse result = apiInstance.paymentsAdd(xApideckConsumerId, xApideckAppId, payment, raw, xApideckServiceId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling PaymentsApi#paymentsAdd");
...
<a id="paymentsAll"></a>
# **paymentsAll**
> GetPaymentsResponse paymentsAll(xApideckConsumerId, xApideckAppId, raw, xApideckServiceId, cursor, limit, filter, passThrough, fields)
...
public class Example {
  public static void main(String[] args) {
    ...
    PaymentsFilter filter = new PaymentsFilter(); // PaymentsFilter | Apply filters
    ...
    try {
      GetPaymentsResponse result = apiInstance.paymentsAll(xApideckConsumerId, xApideckAppId, raw, xApideckServiceId, cursor, limit, filter, passThrough, fields);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling PaymentsApi#paymentsAll");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
# **paymentsDelete**
> DeletePaymentResponse paymentsDelete(id, xApideckConsumerId, xApideckAppId, xApideckServiceId, raw)
...
public class Example {
  public static void main(String[] args) {
    ...
    Boolean raw = false; // Boolean | Include raw response. Mostly used for debugging purposes
    try {
      DeletePaymentResponse result = apiInstance.paymentsDelete(id, xApideckConsumerId, xApideckAppId, xApideckServiceId, raw);
      System.out.println(result);
    } catch (ApiException e) {
...
<a id="paymentsOne"></a>
# **paymentsOne**
> GetPaymentResponse paymentsOne(id, xApideckConsumerId, xApideckAppId, xApideckServiceId, raw, fields)
...
public class Example {
  public static void main(String[] args) {
    ...
    String fields = "id,updated_at"; // String | The 'fields' parameter allows API users to specify the fields they want to include in the API response. If this parameter is not present, the API will return all available fields. If this parameter is present, only the fields specified in the comma-separated string will be included in the response. Nested properties can also be requested by using a dot notation. <br /><br />Example: `fields=name,email,addresses.city`<br /><br />In the example above, the response will only include the fields \"name\", \"email\" and \"addresses.city\". If any other fields are available, they will be excluded.
    try {
      GetPaymentResponse result = apiInstance.paymentsOne(id, xApideckConsumerId, xApideckAppId, xApideckServiceId, raw, fields);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling PaymentsApi#paymentsOne");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="paymentsUpdate"></a>
# **paymentsUpdate**
> UpdatePaymentResponse paymentsUpdate(id, xApideckConsumerId, xApideckAppId, payment, xApideckServiceId, raw)
...
public class Example {
  public static void main(String[] args) {
    ...
    Boolean raw = false; // Boolean | Include raw response. Mostly used for debugging purposes
    try {
      UpdatePaymentResponse result = apiInstance.paymentsUpdate(id, xApideckConsumerId, xApideckAppId, payment, xApideckServiceId, raw);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling PaymentsApi#paymentsUpdate");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
