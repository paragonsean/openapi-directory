...
|------------- | ------------- | -------------|
| [**invoicesAdd**](InvoicesApi.md#invoicesAdd) | **POST** /accounting/invoices | Create Invoice |
| [**invoicesAll**](InvoicesApi.md#invoicesAll) | **GET** /accounting/invoices | List Invoices |
| [**invoicesDelete**](InvoicesApi.md#invoicesDelete) | **DELETE** /accounting/invoices/{id} | Delete Invoice |
| [**invoicesOne**](InvoicesApi.md#invoicesOne) | **GET** /accounting/invoices/{id} | Get Invoice |
| [**invoicesUpdate**](InvoicesApi.md#invoicesUpdate) | **PATCH** /accounting/invoices/{id} | Update Invoice |


<a id="invoicesAdd"></a>
# **invoicesAdd**
> CreateInvoiceResponse invoicesAdd(xApideckConsumerId, xApideckAppId, invoice, raw, xApideckServiceId)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      CreateInvoiceResponse result = apiInstance.invoicesAdd(xApideckConsumerId, xApideckAppId, invoice, raw, xApideckServiceId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling InvoicesApi#invoicesAdd");
...
<a id="invoicesAll"></a>
# **invoicesAll**
> GetInvoicesResponse invoicesAll(xApideckConsumerId, xApideckAppId, raw, xApideckServiceId, cursor, limit, sort, passThrough, fields)
...
public class Example {
  public static void main(String[] args) {
    ...
    InvoicesSort sort = new InvoicesSort(); // InvoicesSort | Apply sorting
    ...
    try {
      GetInvoicesResponse result = apiInstance.invoicesAll(xApideckConsumerId, xApideckAppId, raw, xApideckServiceId, cursor, limit, sort, passThrough, fields);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling InvoicesApi#invoicesAll");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="invoicesDelete"></a>
# **invoicesDelete**
> DeleteInvoiceResponse invoicesDelete(id, xApideckConsumerId, xApideckAppId, xApideckServiceId, raw)
...
public class Example {
  public static void main(String[] args) {
    ...
    Boolean raw = false; // Boolean | Include raw response. Mostly used for debugging purposes
    try {
      DeleteInvoiceResponse result = apiInstance.invoicesDelete(id, xApideckConsumerId, xApideckAppId, xApideckServiceId, raw);
      System.out.println(result);
    } catch (ApiException e) {
...
<a id="invoicesOne"></a>
# **invoicesOne**
> GetInvoiceResponse invoicesOne(id, xApideckConsumerId, xApideckAppId, xApideckServiceId, raw, fields)
...
public class Example {
  public static void main(String[] args) {
    ...
    String fields = "id,updated_at"; // String | The 'fields' parameter allows API users to specify the fields they want to include in the API response. If this parameter is not present, the API will return all available fields. If this parameter is present, only the fields specified in the comma-separated string will be included in the response. Nested properties can also be requested by using a dot notation. <br /><br />Example: `fields=name,email,addresses.city`<br /><br />In the example above, the response will only include the fields \"name\", \"email\" and \"addresses.city\". If any other fields are available, they will be excluded.
    try {
      GetInvoiceResponse result = apiInstance.invoicesOne(id, xApideckConsumerId, xApideckAppId, xApideckServiceId, raw, fields);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling InvoicesApi#invoicesOne");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="invoicesUpdate"></a>
# **invoicesUpdate**
> UpdateInvoiceResponse invoicesUpdate(id, xApideckConsumerId, xApideckAppId, invoice, xApideckServiceId, raw)
...
public class Example {
  public static void main(String[] args) {
    ...
    Boolean raw = false; // Boolean | Include raw response. Mostly used for debugging purposes
    try {
      UpdateInvoiceResponse result = apiInstance.invoicesUpdate(id, xApideckConsumerId, xApideckAppId, invoice, xApideckServiceId, raw);
      System.out.println(result);
    } catch (ApiException e) {
