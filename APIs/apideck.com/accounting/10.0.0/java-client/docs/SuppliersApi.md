...
<a id="suppliersAdd"></a>
# **suppliersAdd**
> CreateSupplierResponse suppliersAdd(xApideckConsumerId, xApideckAppId, supplier, raw, xApideckServiceId)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      CreateSupplierResponse result = apiInstance.suppliersAdd(xApideckConsumerId, xApideckAppId, supplier, raw, xApideckServiceId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling SuppliersApi#suppliersAdd");
...
<a id="suppliersAll"></a>
# **suppliersAll**
> GetSuppliersResponse suppliersAll(xApideckConsumerId, xApideckAppId, raw, xApideckServiceId, cursor, limit, filter, passThrough, fields)
...
public class Example {
  public static void main(String[] args) {
    ...
    SuppliersFilter filter = new SuppliersFilter(); // SuppliersFilter | Apply filters
    ...
    try {
      GetSuppliersResponse result = apiInstance.suppliersAll(xApideckConsumerId, xApideckAppId, raw, xApideckServiceId, cursor, limit, filter, passThrough, fields);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling SuppliersApi#suppliersAll");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
# **suppliersDelete**
> DeleteSupplierResponse suppliersDelete(id, xApideckConsumerId, xApideckAppId, xApideckServiceId, raw)
...
public class Example {
  public static void main(String[] args) {
    ...
    Boolean raw = false; // Boolean | Include raw response. Mostly used for debugging purposes
    try {
      DeleteSupplierResponse result = apiInstance.suppliersDelete(id, xApideckConsumerId, xApideckAppId, xApideckServiceId, raw);
      System.out.println(result);
    } catch (ApiException e) {
...
<a id="suppliersOne"></a>
# **suppliersOne**
> GetSupplierResponse suppliersOne(id, xApideckConsumerId, xApideckAppId, xApideckServiceId, raw, fields)
...
public class Example {
  public static void main(String[] args) {
    ...
    String fields = "id,updated_at"; // String | The 'fields' parameter allows API users to specify the fields they want to include in the API response. If this parameter is not present, the API will return all available fields. If this parameter is present, only the fields specified in the comma-separated string will be included in the response. Nested properties can also be requested by using a dot notation. <br /><br />Example: `fields=name,email,addresses.city`<br /><br />In the example above, the response will only include the fields \"name\", \"email\" and \"addresses.city\". If any other fields are available, they will be excluded.
    try {
      GetSupplierResponse result = apiInstance.suppliersOne(id, xApideckConsumerId, xApideckAppId, xApideckServiceId, raw, fields);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling SuppliersApi#suppliersOne");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="suppliersUpdate"></a>
# **suppliersUpdate**
> UpdateSupplierResponse suppliersUpdate(id, xApideckConsumerId, xApideckAppId, supplier, xApideckServiceId, raw)
...
public class Example {
  public static void main(String[] args) {
    ...
    Boolean raw = false; // Boolean | Include raw response. Mostly used for debugging purposes
    try {
      UpdateSupplierResponse result = apiInstance.suppliersUpdate(id, xApideckConsumerId, xApideckAppId, supplier, xApideckServiceId, raw);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling SuppliersApi#suppliersUpdate");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
