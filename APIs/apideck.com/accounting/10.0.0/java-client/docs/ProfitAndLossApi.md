...
<a id="profitAndLossOne"></a>
# **profitAndLossOne**
> GetProfitAndLossResponse profitAndLossOne(xApideckConsumerId, xApideckAppId, raw, xApideckServiceId, filter, passThrough, fields)
...
import org.openapitools.client.api.ProfitAndLossApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    ProfitAndLossApi apiInstance = new ProfitAndLossApi(defaultClient);
    ...
    ProfitAndLossFilter filter = new ProfitAndLossFilter(); // ProfitAndLossFilter | Apply filters
    ...
    try {
      GetProfitAndLossResponse result = apiInstance.profitAndLossOne(xApideckConsumerId, xApideckAppId, raw, xApideckServiceId, filter, passThrough, fields);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProfitAndLossApi#profitAndLossOne");
