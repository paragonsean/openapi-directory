...
class Logo {
    ...
    static validateJSON(data) {
        ...
        for (const property of Logo.RequiredProperties) {
...
Logo.RequiredProperties = ["url"];

/**
 * @member {String} content_type
 */
Logo.prototype['content_type'] = undefined;
...
/**
 * @member {module:model/Logo.TypeEnum} type
 */
Logo.prototype['type'] = undefined;
