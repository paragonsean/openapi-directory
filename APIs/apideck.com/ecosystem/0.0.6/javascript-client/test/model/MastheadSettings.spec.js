...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EcosystemApi.MastheadSettings();
  });
  ...
  describe('MastheadSettings', function() {
    it('should create an instance of MastheadSettings', function() {
      // uncomment below and update the code to test MastheadSettings
      //var instance = new EcosystemApi.MastheadSettings();
      //expect(instance).to.be.a(EcosystemApi.MastheadSettings);
    });
