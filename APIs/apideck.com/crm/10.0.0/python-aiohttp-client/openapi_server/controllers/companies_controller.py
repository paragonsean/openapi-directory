...
async def companies_add(request: web.Request, x_apideck_consumer_id, x_apideck_app_id, body, raw=None, x_apideck_service_id=None) -> web.Response:
    """Create company
...
async def companies_all(request: web.Request, x_apideck_consumer_id, x_apideck_app_id, raw=None, x_apideck_service_id=None, cursor=None, limit=None, filter=None, sort=None, pass_through=None, fields=None) -> web.Response:
    """List companies
...
async def companies_delete(request: web.Request, id, x_apideck_consumer_id, x_apideck_app_id, raw=None, x_apideck_service_id=None) -> web.Response:
    """Delete company
...
async def companies_one(request: web.Request, id, x_apideck_consumer_id, x_apideck_app_id, raw=None, x_apideck_service_id=None, fields=None) -> web.Response:
    """Get company
...
async def companies_update(request: web.Request, id, x_apideck_consumer_id, x_apideck_app_id, body, raw=None, x_apideck_service_id=None) -> web.Response:
    """Update company
