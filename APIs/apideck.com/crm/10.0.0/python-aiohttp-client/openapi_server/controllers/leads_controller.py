...
async def leads_all(request: web.Request, x_apideck_consumer_id, x_apideck_app_id, raw=None, x_apideck_service_id=None, cursor=None, limit=None, filter=None, sort=None, pass_through=None, fields=None) -> web.Response:
    """List leads
