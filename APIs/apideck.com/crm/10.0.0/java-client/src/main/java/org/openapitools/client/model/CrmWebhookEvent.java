...
import org.openapitools.client.model.CrmEventType;
...
public class CrmWebhookEvent {
  ...
  public CrmWebhookEvent() {
  }

  public CrmWebhookEvent consumerId(String consumerId) {
  ...
  public CrmWebhookEvent entityId(String entityId) {
  ...
  public CrmWebhookEvent entityType(String entityType) {
  ...
  public CrmWebhookEvent entityUrl(String entityUrl) {
  ...
  public CrmWebhookEvent eventId(String eventId) {
  ...
  public CrmWebhookEvent executionAttempt(BigDecimal executionAttempt) {
  ...
  public CrmWebhookEvent occurredAt(String occurredAt) {
  ...
  public CrmWebhookEvent serviceId(String serviceId) {
  ...
  public CrmWebhookEvent unifiedApi(UnifiedApiEnum unifiedApi) {
  ...
  public CrmWebhookEvent eventType(CrmEventType eventType) {
  ...
  public boolean equals(Object o) {
    ...
    CrmWebhookEvent crmWebhookEvent = (CrmWebhookEvent) o;
    return Objects.equals(this.consumerId, crmWebhookEvent.consumerId) &&
        Objects.equals(this.entityId, crmWebhookEvent.entityId) &&
        Objects.equals(this.entityType, crmWebhookEvent.entityType) &&
        Objects.equals(this.entityUrl, crmWebhookEvent.entityUrl) &&
        Objects.equals(this.eventId, crmWebhookEvent.eventId) &&
        Objects.equals(this.executionAttempt, crmWebhookEvent.executionAttempt) &&
        Objects.equals(this.occurredAt, crmWebhookEvent.occurredAt) &&
        Objects.equals(this.serviceId, crmWebhookEvent.serviceId) &&
        Objects.equals(this.unifiedApi, crmWebhookEvent.unifiedApi) &&
        Objects.equals(this.eventType, crmWebhookEvent.eventType);
  }
  ...
  public String toString() {
    ...
    sb.append("class CrmWebhookEvent {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CrmWebhookEvent
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CrmWebhookEvent.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CrmWebhookEvent is not found in the empty JSON string", CrmWebhookEvent.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CrmWebhookEvent.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CrmWebhookEvent` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("event_type") != null && !jsonObj.get("event_type").isJsonNull()) {
        CrmEventType.validateJsonElement(jsonObj.get("event_type"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CrmWebhookEvent.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CrmWebhookEvent' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CrmWebhookEvent> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CrmWebhookEvent.class));

       return (TypeAdapter<T>) new TypeAdapter<CrmWebhookEvent>() {
           @Override
           public void write(JsonWriter out, CrmWebhookEvent value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CrmWebhookEvent read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CrmWebhookEvent given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CrmWebhookEvent
   * @throws IOException if the JSON string is invalid with respect to CrmWebhookEvent
   */
  public static CrmWebhookEvent fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CrmWebhookEvent.class);
  }

  /**
   * Convert an instance of CrmWebhookEvent to an JSON string
   *
   * @return JSON string
   */
