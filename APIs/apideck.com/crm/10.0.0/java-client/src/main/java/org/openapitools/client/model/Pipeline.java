...
import org.openapitools.client.model.PipelineStagesInner;
...
public class Pipeline {
  ...
  private List<PipelineStagesInner> stages = new ArrayList<>();

  public static final String SERIALIZED_NAME_UPDATED_AT = "updated_at";
  @SerializedName(SERIALIZED_NAME_UPDATED_AT)
  private OffsetDateTime updatedAt;

  public static final String SERIALIZED_NAME_WIN_PROBABILITY_ENABLED = "win_probability_enabled";
  @SerializedName(SERIALIZED_NAME_WIN_PROBABILITY_ENABLED)
  ...
  public Pipeline archived(Boolean archived) {
  ...
  public Pipeline currency(Currency currency) {
  ...
  public Pipeline displayOrder(Integer displayOrder) {
  ...
  public Pipeline stages(List<PipelineStagesInner> stages) {
    this.stages = stages;
    return this;
  }

  public Pipeline addStagesItem(PipelineStagesInner stagesItem) {
    if (this.stages == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<PipelineStagesInner> getStages() {
    return stages;
  }

  public void setStages(List<PipelineStagesInner> stages) {
    this.stages = stages;
  }
  ...
  public Pipeline winProbabilityEnabled(Boolean winProbabilityEnabled) {
   ...
   */
  @javax.annotation.Nullable
  public Boolean getWinProbabilityEnabled() {
    return winProbabilityEnabled;
  }

  public void setWinProbabilityEnabled(Boolean winProbabilityEnabled) {
    this.winProbabilityEnabled = winProbabilityEnabled;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.active, pipeline.active) &&
        Objects.equals(this.archived, pipeline.archived) &&
        Objects.equals(this.createdAt, pipeline.createdAt) &&
        Objects.equals(this.currency, pipeline.currency) &&
        Objects.equals(this.displayOrder, pipeline.displayOrder) &&
        ...
        Objects.equals(this.winProbabilityEnabled, pipeline.winProbabilityEnabled);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(active, archived, createdAt, currency, displayOrder, id, name, stages, updatedAt, winProbabilityEnabled);
  }
  ...
  public String toString() {
    ...
    sb.append("    winProbabilityEnabled: ").append(toIndentedString(winProbabilityEnabled)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("win_probability_enabled");
      ...
      if (jsonObj.get("stages") != null && !jsonObj.get("stages").isJsonNull()) {
        ...
        if (jsonArraystages != null) {
          ...
          for (int i = 0; i < jsonArraystages.size(); i++) {
            PipelineStagesInner.validateJsonElement(jsonArraystages.get(i));
          };
        }
      }
  }
