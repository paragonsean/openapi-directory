...
public class Note {
  ...
  public Note companyId(String companyId) {
  ...
  public Note customMappings(Object customMappings) {
  ...
  public Note leadId(String leadId) {
    this.leadId = leadId;
    return this;
  }
  ...
  public Note opportunityId(String opportunityId) {
  ...
  public Note ownerId(String ownerId) {
  ...
  public boolean equals(Object o) {
    ...
    Note note = (Note) o;
    return Objects.equals(this.active, note.active) &&
        Objects.equals(this.companyId, note.companyId) &&
        ...
        Objects.equals(this.customMappings, note.customMappings) &&
        Objects.equals(this.id, note.id) &&
        Objects.equals(this.leadId, note.leadId) &&
        Objects.equals(this.opportunityId, note.opportunityId) &&
        Objects.equals(this.ownerId, note.ownerId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(active, companyId, contactId, content, createdAt, createdBy, customMappings, id, leadId, opportunityId, ownerId, title, updatedAt, updatedBy);
  }
