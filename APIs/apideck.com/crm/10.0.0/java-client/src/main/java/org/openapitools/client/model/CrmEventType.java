...
/**
 * Gets or Sets CrmEventType
 */
@JsonAdapter(CrmEventType.Adapter.class)
public enum CrmEventType {
  ...
  public static CrmEventType fromValue(String value) {
    for (CrmEventType b : CrmEventType.values()) {
  ...
  public static class Adapter extends TypeAdapter<CrmEventType> {
    @Override
    public void write(final JsonWriter jsonWriter, final CrmEventType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CrmEventType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CrmEventType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    CrmEventType.fromValue(value);
  }
}
