...
public class Opportunity {
  ...
  public Opportunity customMappings(Object customMappings) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.closeDate, opportunity.closeDate) &&
        ...
        Objects.equals(this.customMappings, opportunity.customMappings) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(closeDate, companyId, companyName, contactId, contactIds, createdAt, createdBy, currency, customFields, customMappings, dateLastContacted, dateLeadCreated, dateStageChanged, deleted, description, expectedRevenue, id, interactionCount, lastActivityAt, leadId, leadSource, lossReason, lossReasonId, monetaryAmount, ownerId, pipelineId, pipelineStageId, primaryContactId, priority, sourceId, stageLastChangedAt, status, statusId, tags, title, type, updatedAt, updatedBy, winProbability, wonReason, wonReasonId);
  }
