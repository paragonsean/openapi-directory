...
|------------ | ------------- | ------------- | -------------|
|**closeDate** | **LocalDate** | The actual closing date for the opportunity. If close_date is null, the opportunity is not closed yet. |  [optional] |
...
|**createdAt** | **OffsetDateTime** | The date and time when the opportunity was created. |  [optional] [readonly] |
...
|**dateLastContacted** | **OffsetDateTime** | The date and time when the opportunity was last contacted. |  [optional] [readonly] |
|**dateLeadCreated** | **OffsetDateTime** | The date and time when the lead associated with the opportunity was created. |  [optional] [readonly] |
|**dateStageChanged** | **OffsetDateTime** | The date and time when the stage of the opportunity was last changed. |  [optional] [readonly] |
...
|**expectedRevenue** | **BigDecimal** | The expected revenue from the opportunity |  [optional] [readonly] |
|**id** | **String** | A unique identifier for the opportunity. |  [optional] [readonly] |
|**interactionCount** | **BigDecimal** | The number of interactions with the opportunity. |  [optional] [readonly] |
...
|**monetaryAmount** | **BigDecimal** | The monetary value associated with the opportunity |  [optional] |
...
|**stageLastChangedAt** | **OffsetDateTime** | The date and time when the stage of the opportunity was last changed. |  [optional] |
...
|**updatedAt** | **OffsetDateTime** | The date and time when the opportunity was last updated. |  [optional] [readonly] |
|**updatedBy** | **String** | The unique identifier of the user who last updated the opportunity. |  [optional] [readonly] |
|**winProbability** | **BigDecimal** | The probability of winning the opportunity, expressed as a percentage. |  [optional] |
