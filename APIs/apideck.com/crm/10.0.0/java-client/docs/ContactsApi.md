...
|------------- | ------------- | -------------|
| [**contactsAdd**](ContactsApi.md#contactsAdd) | **POST** /crm/contacts | Create contact |
| [**contactsAll**](ContactsApi.md#contactsAll) | **GET** /crm/contacts | List contacts |
| [**contactsDelete**](ContactsApi.md#contactsDelete) | **DELETE** /crm/contacts/{id} | Delete contact |
| [**contactsOne**](ContactsApi.md#contactsOne) | **GET** /crm/contacts/{id} | Get contact |
| [**contactsUpdate**](ContactsApi.md#contactsUpdate) | **PATCH** /crm/contacts/{id} | Update contact |


<a id="contactsAdd"></a>
# **contactsAdd**
> CreateContactResponse contactsAdd(xApideckConsumerId, xApideckAppId, contact, raw, xApideckServiceId)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      CreateContactResponse result = apiInstance.contactsAdd(xApideckConsumerId, xApideckAppId, contact, raw, xApideckServiceId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ContactsApi#contactsAdd");
...
<a id="contactsAll"></a>
# **contactsAll**
> GetContactsResponse contactsAll(xApideckConsumerId, xApideckAppId, raw, xApideckServiceId, cursor, limit, filter, sort, passThrough, fields)
...
public class Example {
  public static void main(String[] args) {
    ...
    ContactsFilter filter = new ContactsFilter(); // ContactsFilter | Apply filters
    ContactsSort sort = new ContactsSort(); // ContactsSort | Apply sorting
    ...
    try {
      GetContactsResponse result = apiInstance.contactsAll(xApideckConsumerId, xApideckAppId, raw, xApideckServiceId, cursor, limit, filter, sort, passThrough, fields);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ContactsApi#contactsAll");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
# **contactsDelete**
> DeleteContactResponse contactsDelete(id, xApideckConsumerId, xApideckAppId, xApideckServiceId, raw)
...
public class Example {
  public static void main(String[] args) {
    ...
    Boolean raw = false; // Boolean | Include raw response. Mostly used for debugging purposes
    try {
      DeleteContactResponse result = apiInstance.contactsDelete(id, xApideckConsumerId, xApideckAppId, xApideckServiceId, raw);
      System.out.println(result);
    } catch (ApiException e) {
...
<a id="contactsOne"></a>
# **contactsOne**
> GetContactResponse contactsOne(id, xApideckConsumerId, xApideckAppId, xApideckServiceId, raw, fields)
...
public class Example {
  public static void main(String[] args) {
    ...
    String fields = "id,updated_at"; // String | The 'fields' parameter allows API users to specify the fields they want to include in the API response. If this parameter is not present, the API will return all available fields. If this parameter is present, only the fields specified in the comma-separated string will be included in the response. Nested properties can also be requested by using a dot notation. <br /><br />Example: `fields=name,email,addresses.city`<br /><br />In the example above, the response will only include the fields \"name\", \"email\" and \"addresses.city\". If any other fields are available, they will be excluded.
    try {
      GetContactResponse result = apiInstance.contactsOne(id, xApideckConsumerId, xApideckAppId, xApideckServiceId, raw, fields);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ContactsApi#contactsOne");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
# **contactsUpdate**
> UpdateContactResponse contactsUpdate(id, xApideckConsumerId, xApideckAppId, contact, xApideckServiceId, raw)
...
public class Example {
  public static void main(String[] args) {
    ...
    Boolean raw = false; // Boolean | Include raw response. Mostly used for debugging purposes
    try {
      UpdateContactResponse result = apiInstance.contactsUpdate(id, xApideckConsumerId, xApideckAppId, contact, xApideckServiceId, raw);
      System.out.println(result);
    } catch (ApiException e) {
