...
<a id="leadsAdd"></a>
# **leadsAdd**
> CreateLeadResponse leadsAdd(xApideckConsumerId, xApideckAppId, lead, raw, xApideckServiceId)
...
import org.openapitools.client.api.LeadsApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling LeadsApi#leadsAdd");
...
<a id="leadsAll"></a>
# **leadsAll**
> GetLeadsResponse leadsAll(xApideckConsumerId, xApideckAppId, raw, xApideckServiceId, cursor, limit, filter, sort, passThrough, fields)
...
public class Example {
  public static void main(String[] args) {
    ...
    LeadsFilter filter = new LeadsFilter(); // LeadsFilter | Apply filters
    LeadsSort sort = new LeadsSort(); // LeadsSort | Apply sorting
    ...
    try {
      GetLeadsResponse result = apiInstance.leadsAll(xApideckConsumerId, xApideckAppId, raw, xApideckServiceId, cursor, limit, filter, sort, passThrough, fields);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling LeadsApi#leadsAll");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| **filter** | [**LeadsFilter**](.md)| Apply filters | [optional] |
| **sort** | [**LeadsSort**](.md)| Apply sorting | [optional] |
...
<a id="leadsDelete"></a>
# **leadsDelete**
> DeleteLeadResponse leadsDelete(id, xApideckConsumerId, xApideckAppId, xApideckServiceId, raw)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling LeadsApi#leadsDelete");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="leadsOne"></a>
# **leadsOne**
> GetLeadResponse leadsOne(id, xApideckConsumerId, xApideckAppId, xApideckServiceId, raw, fields)
...
public class Example {
  public static void main(String[] args) {
    ...
    String fields = "id,updated_at"; // String | The 'fields' parameter allows API users to specify the fields they want to include in the API response. If this parameter is not present, the API will return all available fields. If this parameter is present, only the fields specified in the comma-separated string will be included in the response. Nested properties can also be requested by using a dot notation. <br /><br />Example: `fields=name,email,addresses.city`<br /><br />In the example above, the response will only include the fields \"name\", \"email\" and \"addresses.city\". If any other fields are available, they will be excluded.
    try {
      GetLeadResponse result = apiInstance.leadsOne(id, xApideckConsumerId, xApideckAppId, xApideckServiceId, raw, fields);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling LeadsApi#leadsOne");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="leadsUpdate"></a>
# **leadsUpdate**
> UpdateLeadResponse leadsUpdate(id, xApideckConsumerId, xApideckAppId, lead, xApideckServiceId, raw)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling LeadsApi#leadsUpdate");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
