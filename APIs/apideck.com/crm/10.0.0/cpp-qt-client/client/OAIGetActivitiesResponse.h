...
/*
 * OAIGetActivitiesResponse.h
 *
 * 
 */

#ifndef OAIGetActivitiesResponse_H
#define OAIGetActivitiesResponse_H
...
class OAIGetActivitiesResponse : public OAIObject {
public:
    OAIGetActivitiesResponse();
    OAIGetActivitiesResponse(QString json);
    ~OAIGetActivitiesResponse() override;
    ...
    QList<OAIActivity> getData() const;
    void setData(const QList<OAIActivity> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetActivitiesResponse)

#endif // OAIGetActivitiesResponse_H
