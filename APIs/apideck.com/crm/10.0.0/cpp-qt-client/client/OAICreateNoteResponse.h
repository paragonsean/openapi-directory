...
/*
 * OAICreateNoteResponse.h
 *
 * 
 */

#ifndef OAICreateNoteResponse_H
#define OAICreateNoteResponse_H
...
class OAICreateNoteResponse : public OAIObject {
public:
    OAICreateNoteResponse();
    OAICreateNoteResponse(QString json);
    ~OAICreateNoteResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateNoteResponse)

#endif // OAICreateNoteResponse_H
