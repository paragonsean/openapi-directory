...
/*
 * OAIUpdateLeadResponse.h
 *
 * 
 */

#ifndef OAIUpdateLeadResponse_H
#define OAIUpdateLeadResponse_H
...
class OAIUpdateLeadResponse : public OAIObject {
public:
    OAIUpdateLeadResponse();
    OAIUpdateLeadResponse(QString json);
    ~OAIUpdateLeadResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateLeadResponse)

#endif // OAIUpdateLeadResponse_H
