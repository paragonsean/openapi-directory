...
/*
 * OAICreateContactResponse.h
 *
 * 
 */

#ifndef OAICreateContactResponse_H
#define OAICreateContactResponse_H
...
class OAICreateContactResponse : public OAIObject {
public:
    OAICreateContactResponse();
    OAICreateContactResponse(QString json);
    ~OAICreateContactResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateContactResponse)

#endif // OAICreateContactResponse_H
