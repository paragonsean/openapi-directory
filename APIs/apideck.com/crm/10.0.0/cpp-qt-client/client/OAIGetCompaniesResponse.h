...
/*
 * OAIGetCompaniesResponse.h
 *
 * 
 */

#ifndef OAIGetCompaniesResponse_H
#define OAIGetCompaniesResponse_H
...
class OAIGetCompaniesResponse : public OAIObject {
public:
    OAIGetCompaniesResponse();
    OAIGetCompaniesResponse(QString json);
    ~OAIGetCompaniesResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetCompaniesResponse)

#endif // OAIGetCompaniesResponse_H
