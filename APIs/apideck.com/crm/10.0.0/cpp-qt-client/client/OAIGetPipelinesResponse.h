...
/*
 * OAIGetPipelinesResponse.h
 *
 * 
 */

#ifndef OAIGetPipelinesResponse_H
#define OAIGetPipelinesResponse_H
...
class OAIGetPipelinesResponse : public OAIObject {
public:
    OAIGetPipelinesResponse();
    OAIGetPipelinesResponse(QString json);
    ~OAIGetPipelinesResponse() override;
    ...
    QList<OAIPipeline> getData() const;
    void setData(const QList<OAIPipeline> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPipelinesResponse)

#endif // OAIGetPipelinesResponse_H
