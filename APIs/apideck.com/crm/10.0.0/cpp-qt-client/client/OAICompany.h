...
public:
    ...
    QString getAbnBranch() const;
    void setAbnBranch(const QString &abn_branch);
    bool is_abn_branch_Set() const;
    bool is_abn_branch_Valid() const;

    QString getAbnOrTfn() const;
    void setAbnOrTfn(const QString &abn_or_tfn);
    bool is_abn_or_tfn_Set() const;
    bool is_abn_or_tfn_Valid() const;
    ...
    qint32 getInteractionCount() const;
    void setInteractionCount(const qint32 &interaction_count);
    ...
    QString getPayeeNumber() const;
    void setPayeeNumber(const QString &payee_number);
    bool is_payee_number_Set() const;
    bool is_payee_number_Valid() const;
    ...
    OAICompany_Row_Type getRowType() const;
    void setRowType(const OAICompany_Row_Type &row_type);
    bool is_row_type_Set() const;
    bool is_row_type_Valid() const;

    QString getSalesTaxNumber() const;
    void setSalesTaxNumber(const QString &sales_tax_number);
    bool is_sales_tax_number_Set() const;
    bool is_sales_tax_number_Valid() const;
...
private:
    ...
    QString m_abn_branch;
    bool m_abn_branch_isSet;
    bool m_abn_branch_isValid;

    QString m_abn_or_tfn;
    bool m_abn_or_tfn_isSet;
    bool m_abn_or_tfn_isValid;
    ...
    QString m_payee_number;
    bool m_payee_number_isSet;
    bool m_payee_number_isValid;
    ...
    OAICompany_Row_Type m_row_type;
    bool m_row_type_isSet;
    bool m_row_type_isValid;

    QString m_sales_tax_number;
    bool m_sales_tax_number_isSet;
    bool m_sales_tax_number_isValid;
