...
/*
 * OAICreateActivityResponse.h
 *
 * 
 */

#ifndef OAICreateActivityResponse_H
#define OAICreateActivityResponse_H
...
class OAICreateActivityResponse : public OAIObject {
public:
    OAICreateActivityResponse();
    OAICreateActivityResponse(QString json);
    ~OAICreateActivityResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateActivityResponse)

#endif // OAICreateActivityResponse_H
