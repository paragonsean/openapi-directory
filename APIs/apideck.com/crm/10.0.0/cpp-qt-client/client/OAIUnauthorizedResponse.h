...
/*
 * OAIUnauthorizedResponse.h
 *
 * 
 */

#ifndef OAIUnauthorizedResponse_H
#define OAIUnauthorizedResponse_H
...
class OAIUnauthorizedResponse : public OAIObject {
public:
    OAIUnauthorizedResponse();
    OAIUnauthorizedResponse(QString json);
    ~OAIUnauthorizedResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUnauthorizedResponse)

#endif // OAIUnauthorizedResponse_H
