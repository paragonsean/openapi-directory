...
/*
 * OAICreateOpportunityResponse.h
 *
 * 
 */

#ifndef OAICreateOpportunityResponse_H
#define OAICreateOpportunityResponse_H
...
class OAICreateOpportunityResponse : public OAIObject {
public:
    OAICreateOpportunityResponse();
    OAICreateOpportunityResponse(QString json);
    ~OAICreateOpportunityResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateOpportunityResponse)

#endif // OAICreateOpportunityResponse_H
