...
/*
 * OAIGetNoteResponse.h
 *
 * 
 */

#ifndef OAIGetNoteResponse_H
#define OAIGetNoteResponse_H
...
class OAIGetNoteResponse : public OAIObject {
public:
    OAIGetNoteResponse();
    OAIGetNoteResponse(QString json);
    ~OAIGetNoteResponse() override;
    ...
    OAINote getData() const;
    void setData(const OAINote &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetNoteResponse)

#endif // OAIGetNoteResponse_H
