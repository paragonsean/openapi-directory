...
/*
 * OAIGetContactsResponse.h
 *
 * 
 */

#ifndef OAIGetContactsResponse_H
#define OAIGetContactsResponse_H
...
class OAIGetContactsResponse : public OAIObject {
public:
    OAIGetContactsResponse();
    OAIGetContactsResponse(QString json);
    ~OAIGetContactsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetContactsResponse)

#endif // OAIGetContactsResponse_H
