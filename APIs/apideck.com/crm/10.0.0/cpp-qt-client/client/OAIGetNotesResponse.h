...
/*
 * OAIGetNotesResponse.h
 *
 * 
 */

#ifndef OAIGetNotesResponse_H
#define OAIGetNotesResponse_H
...
class OAIGetNotesResponse : public OAIObject {
public:
    OAIGetNotesResponse();
    OAIGetNotesResponse(QString json);
    ~OAIGetNotesResponse() override;
    ...
    QList<OAINote> getData() const;
    void setData(const QList<OAINote> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetNotesResponse)

#endif // OAIGetNotesResponse_H
