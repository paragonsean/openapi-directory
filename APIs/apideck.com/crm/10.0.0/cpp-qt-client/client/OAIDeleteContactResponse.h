...
/*
 * OAIDeleteContactResponse.h
 *
 * 
 */

#ifndef OAIDeleteContactResponse_H
#define OAIDeleteContactResponse_H
...
class OAIDeleteContactResponse : public OAIObject {
public:
    OAIDeleteContactResponse();
    OAIDeleteContactResponse(QString json);
    ~OAIDeleteContactResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteContactResponse)

#endif // OAIDeleteContactResponse_H
