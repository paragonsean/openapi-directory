...
/*
 * OAIGetLeadResponse.h
 *
 * 
 */

#ifndef OAIGetLeadResponse_H
#define OAIGetLeadResponse_H
...
class OAIGetLeadResponse : public OAIObject {
public:
    OAIGetLeadResponse();
    OAIGetLeadResponse(QString json);
    ~OAIGetLeadResponse() override;
    ...
    OAILead getData() const;
    void setData(const OAILead &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetLeadResponse)

#endif // OAIGetLeadResponse_H
