...
QList<OAIAddress> OAIUser::getAddresses() const {
    return m_addresses;
}
void OAIUser::setAddresses(const QList<OAIAddress> &addresses) {
    m_addresses = addresses;
    m_addresses_isSet = true;
}

bool OAIUser::is_addresses_Set() const{
    return m_addresses_isSet;
}

bool OAIUser::is_addresses_Valid() const{
...
OAIObject OAIUser::getCustomMappings() const {
    return m_custom_mappings;
}
void OAIUser::setCustomMappings(const OAIObject &custom_mappings) {
    m_custom_mappings = custom_mappings;
    m_custom_mappings_isSet = true;
}

bool OAIUser::is_custom_mappings_Set() const{
    return m_custom_mappings_isSet;
}

bool OAIUser::is_custom_mappings_Valid() const{
...
QString OAIUser::getDivision() const {
    return m_division;
}
void OAIUser::setDivision(const QString &division) {
    m_division = division;
    m_division_isSet = true;
}

bool OAIUser::is_division_Set() const{
    return m_division_isSet;
}

bool OAIUser::is_division_Valid() const{
    return m_division_isValid;
}

QList<OAIEmail> OAIUser::getEmails() const {
    return m_emails;
}
void OAIUser::setEmails(const QList<OAIEmail> &emails) {
    m_emails = emails;
    m_emails_isSet = true;
}

bool OAIUser::is_emails_Set() const{
    return m_emails_isSet;
}

bool OAIUser::is_emails_Valid() const{
    return m_emails_isValid;
}

QString OAIUser::getEmployeeNumber() const {
    return m_employee_number;
}
void OAIUser::setEmployeeNumber(const QString &employee_number) {
    m_employee_number = employee_number;
    m_employee_number_isSet = true;
}

bool OAIUser::is_employee_number_Set() const{
    return m_employee_number_isSet;
}

bool OAIUser::is_employee_number_Valid() const{
...
QString OAIUser::getImage() const {
    return m_image;
}
void OAIUser::setImage(const QString &image) {
    m_image = image;
    m_image_isSet = true;
}

bool OAIUser::is_image_Set() const{
    return m_image_isSet;
}

bool OAIUser::is_image_Valid() const{
...
QString OAIUser::getParentId() const {
    return m_parent_id;
}
void OAIUser::setParentId(const QString &parent_id) {
    m_parent_id = parent_id;
    m_parent_id_isSet = true;
}

bool OAIUser::is_parent_id_Set() const{
    return m_parent_id_isSet;
}

bool OAIUser::is_parent_id_Valid() const{
...
QList<OAIPhoneNumber> OAIUser::getPhoneNumbers() const {
    return m_phone_numbers;
}
void OAIUser::setPhoneNumbers(const QList<OAIPhoneNumber> &phone_numbers) {
...
QString OAIUser::getTitle() const {
    return m_title;
}
void OAIUser::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAIUser::is_title_Set() const{
    return m_title_isSet;
}

bool OAIUser::is_title_Valid() const{
