...
/*
 * OAIUpdateOpportunityResponse.h
 *
 * 
 */

#ifndef OAIUpdateOpportunityResponse_H
#define OAIUpdateOpportunityResponse_H
...
class OAIUpdateOpportunityResponse : public OAIObject {
public:
    OAIUpdateOpportunityResponse();
    OAIUpdateOpportunityResponse(QString json);
    ~OAIUpdateOpportunityResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateOpportunityResponse)

#endif // OAIUpdateOpportunityResponse_H
