...
/*
 * OAIGetActivityResponse.h
 *
 * 
 */

#ifndef OAIGetActivityResponse_H
#define OAIGetActivityResponse_H
...
class OAIGetActivityResponse : public OAIObject {
public:
    OAIGetActivityResponse();
    OAIGetActivityResponse(QString json);
    ~OAIGetActivityResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetActivityResponse)

#endif // OAIGetActivityResponse_H
