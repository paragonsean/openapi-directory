...
/*
 * OAICreateLeadResponse.h
 *
 * 
 */

#ifndef OAICreateLeadResponse_H
#define OAICreateLeadResponse_H
...
class OAICreateLeadResponse : public OAIObject {
public:
    OAICreateLeadResponse();
    OAICreateLeadResponse(QString json);
    ~OAICreateLeadResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateLeadResponse)

#endif // OAICreateLeadResponse_H
