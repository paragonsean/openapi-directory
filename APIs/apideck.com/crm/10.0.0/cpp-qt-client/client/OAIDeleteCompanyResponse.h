...
/*
 * OAIDeleteCompanyResponse.h
 *
 * 
 */

#ifndef OAIDeleteCompanyResponse_H
#define OAIDeleteCompanyResponse_H
...
class OAIDeleteCompanyResponse : public OAIObject {
public:
    OAIDeleteCompanyResponse();
    OAIDeleteCompanyResponse(QString json);
    ~OAIDeleteCompanyResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteCompanyResponse)

#endif // OAIDeleteCompanyResponse_H
