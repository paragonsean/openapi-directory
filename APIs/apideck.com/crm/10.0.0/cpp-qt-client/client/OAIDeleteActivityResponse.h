...
/*
 * OAIDeleteActivityResponse.h
 *
 * 
 */

#ifndef OAIDeleteActivityResponse_H
#define OAIDeleteActivityResponse_H
...
class OAIDeleteActivityResponse : public OAIObject {
public:
    OAIDeleteActivityResponse();
    OAIDeleteActivityResponse(QString json);
    ~OAIDeleteActivityResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteActivityResponse)

#endif // OAIDeleteActivityResponse_H
