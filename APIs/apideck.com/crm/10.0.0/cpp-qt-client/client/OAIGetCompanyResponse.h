...
/*
 * OAIGetCompanyResponse.h
 *
 * 
 */

#ifndef OAIGetCompanyResponse_H
#define OAIGetCompanyResponse_H
...
class OAIGetCompanyResponse : public OAIObject {
public:
    OAIGetCompanyResponse();
    OAIGetCompanyResponse(QString json);
    ~OAIGetCompanyResponse() override;
    ...
    OAICompany getData() const;
    void setData(const OAICompany &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetCompanyResponse)

#endif // OAIGetCompanyResponse_H
