...
/*
 * OAIUpdateNoteResponse.h
 *
 * 
 */

#ifndef OAIUpdateNoteResponse_H
#define OAIUpdateNoteResponse_H
...
class OAIUpdateNoteResponse : public OAIObject {
public:
    OAIUpdateNoteResponse();
    OAIUpdateNoteResponse(QString json);
    ~OAIUpdateNoteResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateNoteResponse)

#endif // OAIUpdateNoteResponse_H
