...
/*
 * OAIUpdateCompanyResponse.h
 *
 * 
 */

#ifndef OAIUpdateCompanyResponse_H
#define OAIUpdateCompanyResponse_H
...
class OAIUpdateCompanyResponse : public OAIObject {
public:
    OAIUpdateCompanyResponse();
    OAIUpdateCompanyResponse(QString json);
    ~OAIUpdateCompanyResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateCompanyResponse)

#endif // OAIUpdateCompanyResponse_H
