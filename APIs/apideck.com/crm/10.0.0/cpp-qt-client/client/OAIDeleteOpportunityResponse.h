...
/*
 * OAIDeleteOpportunityResponse.h
 *
 * 
 */

#ifndef OAIDeleteOpportunityResponse_H
#define OAIDeleteOpportunityResponse_H
...
class OAIDeleteOpportunityResponse : public OAIObject {
public:
    OAIDeleteOpportunityResponse();
    OAIDeleteOpportunityResponse(QString json);
    ~OAIDeleteOpportunityResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteOpportunityResponse)

#endif // OAIDeleteOpportunityResponse_H
