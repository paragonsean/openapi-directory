...
/*
 * OAIGetOpportunityResponse.h
 *
 * 
 */

#ifndef OAIGetOpportunityResponse_H
#define OAIGetOpportunityResponse_H
...
class OAIGetOpportunityResponse : public OAIObject {
public:
    OAIGetOpportunityResponse();
    OAIGetOpportunityResponse(QString json);
    ~OAIGetOpportunityResponse() override;
    ...
    OAIOpportunity getData() const;
    void setData(const OAIOpportunity &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetOpportunityResponse)

#endif // OAIGetOpportunityResponse_H
