...
#include "OAIPipeline_stages_inner.h"
#include <QDateTime>
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAIPipeline_stages_inner;
...
public:
    ...
    QList<OAIPipeline_stages_inner> getStages() const;
    void setStages(const QList<OAIPipeline_stages_inner> &stages);
    ...
    bool isWinProbabilityEnabled() const;
    void setWinProbabilityEnabled(const bool &win_probability_enabled);
    bool is_win_probability_enabled_Set() const;
    bool is_win_probability_enabled_Valid() const;
...
private:
    ...
    QList<OAIPipeline_stages_inner> m_stages;
    bool m_stages_isSet;
    ...
    bool m_win_probability_enabled;
    bool m_win_probability_enabled_isSet;
    bool m_win_probability_enabled_isValid;
};
