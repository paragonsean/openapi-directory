...
/*
 * OAICrmWebhookEvent.h
 *
 * 
 */

#ifndef OAICrmWebhookEvent_H
#define OAICrmWebhookEvent_H
...
class OAICrmWebhookEvent : public OAIObject {
public:
    OAICrmWebhookEvent();
    OAICrmWebhookEvent(QString json);
    ~OAICrmWebhookEvent() override;
    ...
    OAICrmEventType getEventType() const;
    void setEventType(const OAICrmEventType &event_type);
...
Q_DECLARE_METATYPE(OpenAPI::OAICrmWebhookEvent)

#endif // OAICrmWebhookEvent_H
