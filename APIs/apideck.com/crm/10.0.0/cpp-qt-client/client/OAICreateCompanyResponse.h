...
/*
 * OAICreateCompanyResponse.h
 *
 * 
 */

#ifndef OAICreateCompanyResponse_H
#define OAICreateCompanyResponse_H
...
class OAICreateCompanyResponse : public OAIObject {
public:
    OAICreateCompanyResponse();
    OAICreateCompanyResponse(QString json);
    ~OAICreateCompanyResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCompanyResponse)

#endif // OAICreateCompanyResponse_H
