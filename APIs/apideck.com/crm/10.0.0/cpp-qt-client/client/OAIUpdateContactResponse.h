...
/*
 * OAIUpdateContactResponse.h
 *
 * 
 */

#ifndef OAIUpdateContactResponse_H
#define OAIUpdateContactResponse_H
...
class OAIUpdateContactResponse : public OAIObject {
public:
    OAIUpdateContactResponse();
    OAIUpdateContactResponse(QString json);
    ~OAIUpdateContactResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateContactResponse)

#endif // OAIUpdateContactResponse_H
