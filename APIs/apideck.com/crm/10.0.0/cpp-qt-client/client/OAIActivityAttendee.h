...
/*
 * OAIActivityAttendee.h
 *
 * 
 */

#ifndef OAIActivityAttendee_H
#define OAIActivityAttendee_H
...
class OAIActivityAttendee : public OAIObject {
public:
    OAIActivityAttendee();
    OAIActivityAttendee(QString json);
    ~OAIActivityAttendee() override;
    ...
    bool isIsOrganizer() const;
    void setIsOrganizer(const bool &is_organizer);
    bool is_is_organizer_Set() const;
    bool is_is_organizer_Valid() const;
...
private:
    ...
    bool m_is_organizer;
    bool m_is_organizer_isSet;
    bool m_is_organizer_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActivityAttendee)

#endif // OAIActivityAttendee_H
