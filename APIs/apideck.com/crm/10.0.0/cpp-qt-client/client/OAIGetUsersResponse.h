...
/*
 * OAIGetUsersResponse.h
 *
 * 
 */

#ifndef OAIGetUsersResponse_H
#define OAIGetUsersResponse_H
...
class OAIGetUsersResponse : public OAIObject {
public:
    OAIGetUsersResponse();
    OAIGetUsersResponse(QString json);
    ~OAIGetUsersResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetUsersResponse)

#endif // OAIGetUsersResponse_H
