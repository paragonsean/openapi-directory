...
/*
 * OAIDeleteNoteResponse.h
 *
 * 
 */

#ifndef OAIDeleteNoteResponse_H
#define OAIDeleteNoteResponse_H
...
class OAIDeleteNoteResponse : public OAIObject {
public:
    OAIDeleteNoteResponse();
    OAIDeleteNoteResponse(QString json);
    ~OAIDeleteNoteResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteNoteResponse)

#endif // OAIDeleteNoteResponse_H
