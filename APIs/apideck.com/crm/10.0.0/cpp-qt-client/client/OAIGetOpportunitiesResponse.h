...
/*
 * OAIGetOpportunitiesResponse.h
 *
 * 
 */

#ifndef OAIGetOpportunitiesResponse_H
#define OAIGetOpportunitiesResponse_H
...
namespace OpenAPI {
class OAIOpportunity;
class OAILinks;
class OAIMeta;

class OAIGetOpportunitiesResponse : public OAIObject {
public:
    OAIGetOpportunitiesResponse();
    OAIGetOpportunitiesResponse(QString json);
    ~OAIGetOpportunitiesResponse() override;
    ...
    QList<OAIOpportunity> getData() const;
    void setData(const QList<OAIOpportunity> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetOpportunitiesResponse)

#endif // OAIGetOpportunitiesResponse_H
