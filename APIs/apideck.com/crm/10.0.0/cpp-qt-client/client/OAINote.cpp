...
bool OAINote::isActive() const {
    return m_active;
}
void OAINote::setActive(const bool &active) {
    m_active = active;
    m_active_isSet = true;
}

bool OAINote::is_active_Set() const{
    return m_active_isSet;
}

bool OAINote::is_active_Valid() const{
    return m_active_isValid;
}

QString OAINote::getCompanyId() const {
    return m_company_id;
}
void OAINote::setCompanyId(const QString &company_id) {
    m_company_id = company_id;
    m_company_id_isSet = true;
}

bool OAINote::is_company_id_Set() const{
    return m_company_id_isSet;
}

bool OAINote::is_company_id_Valid() const{
    return m_company_id_isValid;
}

QString OAINote::getContactId() const {
    return m_contact_id;
}
void OAINote::setContactId(const QString &contact_id) {
    m_contact_id = contact_id;
    m_contact_id_isSet = true;
}

bool OAINote::is_contact_id_Set() const{
    return m_contact_id_isSet;
}

bool OAINote::is_contact_id_Valid() const{
...
QString OAINote::getCreatedBy() const {
    return m_created_by;
}
void OAINote::setCreatedBy(const QString &created_by) {
    m_created_by = created_by;
    m_created_by_isSet = true;
}

bool OAINote::is_created_by_Set() const{
    return m_created_by_isSet;
}

bool OAINote::is_created_by_Valid() const{
    return m_created_by_isValid;
}

OAIObject OAINote::getCustomMappings() const {
    return m_custom_mappings;
}
void OAINote::setCustomMappings(const OAIObject &custom_mappings) {
    m_custom_mappings = custom_mappings;
    m_custom_mappings_isSet = true;
}

bool OAINote::is_custom_mappings_Set() const{
    return m_custom_mappings_isSet;
}

bool OAINote::is_custom_mappings_Valid() const{
...
QString OAINote::getLeadId() const {
    return m_lead_id;
}
void OAINote::setLeadId(const QString &lead_id) {
    m_lead_id = lead_id;
    m_lead_id_isSet = true;
}

bool OAINote::is_lead_id_Set() const{
    return m_lead_id_isSet;
}

bool OAINote::is_lead_id_Valid() const{
    return m_lead_id_isValid;
}

QString OAINote::getOpportunityId() const {
    return m_opportunity_id;
}
void OAINote::setOpportunityId(const QString &opportunity_id) {
    m_opportunity_id = opportunity_id;
    m_opportunity_id_isSet = true;
}

bool OAINote::is_opportunity_id_Set() const{
    return m_opportunity_id_isSet;
}

bool OAINote::is_opportunity_id_Valid() const{
    return m_opportunity_id_isValid;
}

QString OAINote::getOwnerId() const {
    return m_owner_id;
}
void OAINote::setOwnerId(const QString &owner_id) {
    m_owner_id = owner_id;
    m_owner_id_isSet = true;
}

bool OAINote::is_owner_id_Set() const{
    return m_owner_id_isSet;
}

bool OAINote::is_owner_id_Valid() const{
...
QString OAINote::getUpdatedBy() const {
    return m_updated_by;
}
void OAINote::setUpdatedBy(const QString &updated_by) {
    m_updated_by = updated_by;
    m_updated_by_isSet = true;
}

bool OAINote::is_updated_by_Set() const{
    return m_updated_by_isSet;
}

bool OAINote::is_updated_by_Valid() const{
