...
void Example::exampleFunction1(){
     OAIActivitiesApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIActivitiesApi::activitiesAddSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIActivitiesApi::activitiesAddSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
      ...
      OAIActivity oai_activity = create(); // OAIActivity | 
      ...
      apiInstance.activitiesAdd(x_apideck_consumer_idx_apideck_app_idoai_activityrawx_apideck_service_id);
