...
export default class UsersApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the usersAdd operation.
     * @callback module:api/UsersApi~usersAddCallback
     ...
     * @param {module:api/UsersApi~usersAddCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CreateUserResponse}
     */
    usersAdd(xApideckConsumerId, xApideckAppId, user, opts, callback) {
      opts = opts || {};
      let postBody = user;
      // verify the required parameter 'xApideckConsumerId' is set
      if (xApideckConsumerId === undefined || xApideckConsumerId === null) {
        throw new Error("Missing the required parameter 'xApideckConsumerId' when calling usersAdd");
      }
      // verify the required parameter 'xApideckAppId' is set
      if (xApideckAppId === undefined || xApideckAppId === null) {
        throw new Error("Missing the required parameter 'xApideckAppId' when calling usersAdd");
      }
      // verify the required parameter 'user' is set
      if (user === undefined || user === null) {
        throw new Error("Missing the required parameter 'user' when calling usersAdd");
      }
    ...
    /**
     * Callback function to receive the result of the usersAll operation.
     * @callback module:api/UsersApi~usersAllCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/UsersApi~usersAllCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetUsersResponse}
     */
    usersAll(xApideckConsumerId, xApideckAppId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'xApideckConsumerId' is set
      if (xApideckConsumerId === undefined || xApideckConsumerId === null) {
        throw new Error("Missing the required parameter 'xApideckConsumerId' when calling usersAll");
      }
      // verify the required parameter 'xApideckAppId' is set
      if (xApideckAppId === undefined || xApideckAppId === null) {
        throw new Error("Missing the required parameter 'xApideckAppId' when calling usersAll");
      }
     ...
     */
    usersDelete(id, xApideckConsumerId, xApideckAppId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      // verify the required parameter 'xApideckConsumerId' is set
      if (xApideckConsumerId === undefined || xApideckConsumerId === null) {
        throw new Error("Missing the required parameter 'xApideckConsumerId' when calling usersDelete");
      }
      // verify the required parameter 'xApideckAppId' is set
      if (xApideckAppId === undefined || xApideckAppId === null) {
        throw new Error("Missing the required parameter 'xApideckAppId' when calling usersDelete");
      }
    ...
    /**
     * Callback function to receive the result of the usersOne operation.
     * @callback module:api/UsersApi~usersOneCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Boolean} [raw = false)] Include raw response. Mostly used for debugging purposes
     * @param {String} [fields] The 'fields' parameter allows API users to specify the fields they want to include in the API response. If this parameter is not present, the API will return all available fields. If this parameter is present, only the fields specified in the comma-separated string will be included in the response. Nested properties can also be requested by using a dot notation. <br /><br />Example: `fields=name,email,addresses.city`<br /><br />In the example above, the response will only include the fields \"name\", \"email\" and \"addresses.city\". If any other fields are available, they will be excluded.
     * @param {module:api/UsersApi~usersOneCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetUserResponse}
     */
    usersOne(id, xApideckConsumerId, xApideckAppId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling usersOne");
      }
      // verify the required parameter 'xApideckConsumerId' is set
      if (xApideckConsumerId === undefined || xApideckConsumerId === null) {
        throw new Error("Missing the required parameter 'xApideckConsumerId' when calling usersOne");
      }
      // verify the required parameter 'xApideckAppId' is set
      if (xApideckAppId === undefined || xApideckAppId === null) {
        throw new Error("Missing the required parameter 'xApideckAppId' when calling usersOne");
      }
     ...
     */
    usersUpdate(id, xApideckConsumerId, xApideckAppId, user, opts, callback) {
      opts = opts || {};
      let postBody = user;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
      ...
      // verify the required parameter 'xApideckConsumerId' is set
      if (xApideckConsumerId === undefined || xApideckConsumerId === null) {
        throw new Error("Missing the required parameter 'xApideckConsumerId' when calling usersUpdate");
      }
      // verify the required parameter 'xApideckAppId' is set
      if (xApideckAppId === undefined || xApideckAppId === null) {
        throw new Error("Missing the required parameter 'xApideckAppId' when calling usersUpdate");
      }
      // verify the required parameter 'user' is set
      if (user === undefined || user === null) {
