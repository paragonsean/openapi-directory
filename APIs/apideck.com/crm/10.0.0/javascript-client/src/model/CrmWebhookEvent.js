...
import CrmEventType from './CrmEventType';

/**
 * The CrmWebhookEvent model module.
 * @module model/CrmWebhookEvent
 * @version 10.0.0
 */
class CrmWebhookEvent {
    /**
     * Constructs a new <code>CrmWebhookEvent</code>.
     * @alias module:model/CrmWebhookEvent
     */
    constructor() { 
        
        CrmWebhookEvent.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CrmWebhookEvent</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CrmWebhookEvent} obj Optional instance to populate.
     * @return {module:model/CrmWebhookEvent} The populated <code>CrmWebhookEvent</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CrmWebhookEvent();
            ...
            if (data.hasOwnProperty('event_type')) {
                obj['event_type'] = CrmEventType.constructFromObject(data['event_type']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CrmWebhookEvent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CrmWebhookEvent</code>.
     */
 ...
 */
CrmWebhookEvent.prototype['consumer_id'] = undefined;

/**
 * The service provider's ID of the entity that triggered this event
 * @member {String} entity_id
 */
CrmWebhookEvent.prototype['entity_id'] = undefined;

/**
 * The type entity that triggered this event
 * @member {String} entity_type
 */
CrmWebhookEvent.prototype['entity_type'] = undefined;

/**
 * The url to retrieve entity detail.
 * @member {String} entity_url
 */
CrmWebhookEvent.prototype['entity_url'] = undefined;

/**
 * Unique reference to this request event
 * @member {String} event_id
 */
CrmWebhookEvent.prototype['event_id'] = undefined;

/**
 * The current count this request event has been attempted
 * @member {Number} execution_attempt
 */
CrmWebhookEvent.prototype['execution_attempt'] = undefined;

/**
 * ISO Datetime for when the original event occurred
 * @member {String} occurred_at
 */
CrmWebhookEvent.prototype['occurred_at'] = undefined;

/**
 * Service provider identifier
 * @member {String} service_id
 */
CrmWebhookEvent.prototype['service_id'] = undefined;

/**
 * Name of Apideck Unified API
 * @member {module:model/CrmWebhookEvent.UnifiedApiEnum} unified_api
 */
CrmWebhookEvent.prototype['unified_api'] = undefined;

/**
 * @member {module:model/CrmEventType} event_type
 */
CrmWebhookEvent.prototype['event_type'] = undefined;
 ...
 * @readonly
 */
CrmWebhookEvent['UnifiedApiEnum'] = {
...
export default CrmWebhookEvent;
