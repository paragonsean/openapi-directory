...
import PipelineStagesInner from './PipelineStagesInner';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('stages')) {
                obj['stages'] = ApiClient.convertToType(data['stages'], [PipelineStagesInner]);
            }
            if (data.hasOwnProperty('updated_at')) {
                obj['updated_at'] = ApiClient.convertToType(data['updated_at'], 'Date');
            }
            if (data.hasOwnProperty('win_probability_enabled')) {
                obj['win_probability_enabled'] = ApiClient.convertToType(data['win_probability_enabled'], 'Boolean');
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['stages']) { // data not null
            ...
            for (const item of data['stages']) {
                PipelineStagesInner.validateJSON(item);
            };
        }
...
Pipeline.RequiredProperties = ["name"];
 ...
 */
Pipeline.prototype['archived'] = undefined;
...
/**
 * The Pipeline Stages.
 * @member {Array.<module:model/PipelineStagesInner>} stages
 */
 ...
 * @member {Boolean} win_probability_enabled
 */
Pipeline.prototype['win_probability_enabled'] = undefined;
