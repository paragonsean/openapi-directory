...
/**
* Enum class CrmEventType.
* @enum {}
* @readonly
*/
export default class CrmEventType {
    ...
    /**
    * Returns a <code>CrmEventType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/CrmEventType} The enum <code>CrmEventType</code> value.
    */
