...
class User {
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['employee_number'] && !(typeof data['employee_number'] === 'string' || data['employee_number'] instanceof String)) {
            throw new Error("Expected the field `employee_number` to be a primitive type in the JSON string but got " + data['employee_number']);
        }
        // ensure the json data is a string
...
User.RequiredProperties = ["emails"];
 ...
 */
User.prototype['custom_mappings'] = undefined;
 ...
 */
User.prototype['employee_number'] = undefined;
 ...
 */
User.prototype['parent_id'] = undefined;
