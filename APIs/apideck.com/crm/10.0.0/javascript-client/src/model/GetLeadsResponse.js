...
class GetLeadsResponse {
     ...
     * @param data {Array.<module:model/Lead>} 
    ...
    constructor(data, operation, resource, service, status, statusCode) { 
        ...
        GetLeadsResponse.initialize(this, data, operation, resource, service, status, statusCode);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetLeadsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetLeadsResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetLeadsResponse.RequiredProperties) {
...
GetLeadsResponse.RequiredProperties = ["data", "operation", "resource", "service", "status", "status_code"];

/**
 * @member {Array.<module:model/Lead>} data
 */
 ...
 */
GetLeadsResponse.prototype['links'] = undefined;

/**
 * @member {module:model/Meta} meta
 */
GetLeadsResponse.prototype['meta'] = undefined;

/**
 * Operation performed
 * @member {String} operation
 */
GetLeadsResponse.prototype['operation'] = undefined;

/**
 * Unified API resource name
 * @member {String} resource
 */
GetLeadsResponse.prototype['resource'] = undefined;

/**
 * Apideck ID of service provider
 * @member {String} service
 */
GetLeadsResponse.prototype['service'] = undefined;

/**
 * HTTP Response Status
 * @member {String} status
 */
GetLeadsResponse.prototype['status'] = undefined;

/**
 * HTTP Response Status Code
 * @member {Number} status_code
 */
GetLeadsResponse.prototype['status_code'] = undefined;
