...
/**
 * The OpportunitiesFilter model module.
 * @module model/OpportunitiesFilter
 * @version 10.0.0
 */
class OpportunitiesFilter {
    /**
     * Constructs a new <code>OpportunitiesFilter</code>.
     * @alias module:model/OpportunitiesFilter
     */
    constructor() { 
        
        OpportunitiesFilter.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OpportunitiesFilter</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OpportunitiesFilter} obj Optional instance to populate.
     * @return {module:model/OpportunitiesFilter} The populated <code>OpportunitiesFilter</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OpportunitiesFilter();
    ...
    /**
     * Validates the JSON data with respect to <code>OpportunitiesFilter</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OpportunitiesFilter</code>.
     */
 ...
 */
OpportunitiesFilter.prototype['company_id'] = undefined;

/**
 * Monetary amount to filter on
 * @member {Number} monetary_amount
 */
OpportunitiesFilter.prototype['monetary_amount'] = undefined;

/**
 * Status to filter on
 * @member {String} status
 */
OpportunitiesFilter.prototype['status'] = undefined;

/**
 * Title of the opportunity to filter on
 * @member {String} title
 */
OpportunitiesFilter.prototype['title'] = undefined;

/**
 * Win probability to filter on
 * @member {Number} win_probability
 */
OpportunitiesFilter.prototype['win_probability'] = undefined;
