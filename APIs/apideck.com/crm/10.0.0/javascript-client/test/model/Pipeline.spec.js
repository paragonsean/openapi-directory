...
(function(root, factory) {
  ...
  describe('Pipeline', function() {
    it('should create an instance of Pipeline', function() {
      ...
      //var instance = new CrmApi.Pipeline();
      //expect(instance).to.be.a(CrmApi.Pipeline);
    });
    ...
    it('should have the property winProbabilityEnabled (base name: "win_probability_enabled")', function() {
      // uncomment below and update the code to test the property winProbabilityEnabled
      //var instance = new CrmApi.Pipeline();
      //expect(instance).to.be();
    });
