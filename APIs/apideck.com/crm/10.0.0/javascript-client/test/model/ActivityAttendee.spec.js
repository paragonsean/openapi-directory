...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrmApi.ActivityAttendee();
  });
  ...
  describe('ActivityAttendee', function() {
    it('should create an instance of ActivityAttendee', function() {
      // uncomment below and update the code to test ActivityAttendee
      //var instance = new CrmApi.ActivityAttendee();
      //expect(instance).to.be.a(CrmApi.ActivityAttendee);
    });
