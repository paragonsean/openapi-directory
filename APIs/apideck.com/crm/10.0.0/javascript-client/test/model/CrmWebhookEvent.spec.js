...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CrmApi.CrmWebhookEvent();
  });
  ...
  describe('CrmWebhookEvent', function() {
    it('should create an instance of CrmWebhookEvent', function() {
      // uncomment below and update the code to test CrmWebhookEvent
      //var instance = new CrmApi.CrmWebhookEvent();
      //expect(instance).to.be.a(CrmApi.CrmWebhookEvent);
    });
