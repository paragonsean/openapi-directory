...
> CreateOpportunityResponse opportunitiesAdd(xApideckConsumerId, xApideckAppId, opportunity, opts)
...
let apiInstance = new CrmApi.OpportunitiesApi();
...
let opportunity = new CrmApi.Opportunity(); // Opportunity | 
let opts = {
...
apiInstance.opportunitiesAdd(xApideckConsumerId, xApideckAppId, opportunity, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> GetOpportunitiesResponse opportunitiesAll(xApideckConsumerId, xApideckAppId, opts)
...
let opts = {
  ...
  'filter': new CrmApi.OpportunitiesFilter(), // OpportunitiesFilter | Apply filters
  'sort': new CrmApi.OpportunitiesSort(), // OpportunitiesSort | Apply sorting
...
apiInstance.opportunitiesAll(xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> DeleteOpportunityResponse opportunitiesDelete(id, xApideckConsumerId, xApideckAppId, opts)
...
apiInstance.opportunitiesDelete(id, xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> GetOpportunityResponse opportunitiesOne(id, xApideckConsumerId, xApideckAppId, opts)
...
apiInstance.opportunitiesOne(id, xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> UpdateOpportunityResponse opportunitiesUpdate(id, xApideckConsumerId, xApideckAppId, opportunity, opts)
...
apiInstance.opportunitiesUpdate(id, xApideckConsumerId, xApideckAppId, opportunity, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
