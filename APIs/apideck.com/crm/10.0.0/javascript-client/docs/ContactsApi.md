...
> CreateContactResponse contactsAdd(xApideckConsumerId, xApideckAppId, contact, opts)
...
let apiInstance = new CrmApi.ContactsApi();
...
let contact = new CrmApi.Contact(); // Contact | 
let opts = {
...
apiInstance.contactsAdd(xApideckConsumerId, xApideckAppId, contact, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> GetContactsResponse contactsAll(xApideckConsumerId, xApideckAppId, opts)
...
let opts = {
  ...
  'filter': new CrmApi.ContactsFilter(), // ContactsFilter | Apply filters
  'sort': new CrmApi.ContactsSort(), // ContactsSort | Apply sorting
...
apiInstance.contactsAll(xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> DeleteContactResponse contactsDelete(id, xApideckConsumerId, xApideckAppId, opts)
...
apiInstance.contactsDelete(id, xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> GetContactResponse contactsOne(id, xApideckConsumerId, xApideckAppId, opts)
...
apiInstance.contactsOne(id, xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> UpdateContactResponse contactsUpdate(id, xApideckConsumerId, xApideckAppId, contact, opts)
...
apiInstance.contactsUpdate(id, xApideckConsumerId, xApideckAppId, contact, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
