...
> CreateUserResponse usersAdd(xApideckConsumerId, xApideckAppId, user, opts)
...
let apiInstance = new CrmApi.UsersApi();
...
apiInstance.usersAdd(xApideckConsumerId, xApideckAppId, user, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> GetUsersResponse usersAll(xApideckConsumerId, xApideckAppId, opts)
...
apiInstance.usersAll(xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> DeleteUserResponse usersDelete(id, xApideckConsumerId, xApideckAppId, opts)
...
apiInstance.usersDelete(id, xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> GetUserResponse usersOne(id, xApideckConsumerId, xApideckAppId, opts)
...
apiInstance.usersOne(id, xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> UpdateUserResponse usersUpdate(id, xApideckConsumerId, xApideckAppId, user, opts)
...
apiInstance.usersUpdate(id, xApideckConsumerId, xApideckAppId, user, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
