# CrmApi.ActivitiesApi

All URIs are relative to *https://unify.apideck.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**activitiesAdd**](ActivitiesApi.md#activitiesAdd) | **POST** /crm/activities | Create activity
[**activitiesAll**](ActivitiesApi.md#activitiesAll) | **GET** /crm/activities | List activities
[**activitiesDelete**](ActivitiesApi.md#activitiesDelete) | **DELETE** /crm/activities/{id} | Delete activity
[**activitiesOne**](ActivitiesApi.md#activitiesOne) | **GET** /crm/activities/{id} | Get activity
[**activitiesUpdate**](ActivitiesApi.md#activitiesUpdate) | **PATCH** /crm/activities/{id} | Update activity



## activitiesAdd

> CreateActivityResponse activitiesAdd(xApideckConsumerId, xApideckAppId, activity, opts)
...
let apiInstance = new CrmApi.ActivitiesApi();
...
let activity = new CrmApi.Activity(); // Activity | 
let opts = {
...
apiInstance.activitiesAdd(xApideckConsumerId, xApideckAppId, activity, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> GetActivitiesResponse activitiesAll(xApideckConsumerId, xApideckAppId, opts)
...
let opts = {
  ...
  'filter': new CrmApi.ActivitiesFilter(), // ActivitiesFilter | Apply filters
...
apiInstance.activitiesAll(xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **filter** | [**ActivitiesFilter**](.md)| Apply filters | [optional] 
...
> DeleteActivityResponse activitiesDelete(id, xApideckConsumerId, xApideckAppId, opts)
...
apiInstance.activitiesDelete(id, xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> GetActivityResponse activitiesOne(id, xApideckConsumerId, xApideckAppId, opts)
...
apiInstance.activitiesOne(id, xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> UpdateActivityResponse activitiesUpdate(id, xApideckConsumerId, xApideckAppId, activity, opts)
...
apiInstance.activitiesUpdate(id, xApideckConsumerId, xApideckAppId, activity, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
