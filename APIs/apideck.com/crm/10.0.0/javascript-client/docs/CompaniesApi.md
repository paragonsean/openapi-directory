...
> CreateCompanyResponse companiesAdd(xApideckConsumerId, xApideckAppId, company, opts)
...
let apiInstance = new CrmApi.CompaniesApi();
...
let company = new CrmApi.Company(); // Company | 
let opts = {
...
apiInstance.companiesAdd(xApideckConsumerId, xApideckAppId, company, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> GetCompaniesResponse companiesAll(xApideckConsumerId, xApideckAppId, opts)
...
let opts = {
  ...
  'filter': new CrmApi.CompaniesFilter(), // CompaniesFilter | Apply filters
  'sort': new CrmApi.CompaniesSort(), // CompaniesSort | Apply sorting
...
> DeleteCompanyResponse companiesDelete(id, xApideckConsumerId, xApideckAppId, opts)
...
> GetCompanyResponse companiesOne(id, xApideckConsumerId, xApideckAppId, opts)
...
> UpdateCompanyResponse companiesUpdate(id, xApideckConsumerId, xApideckAppId, company, opts)
...
apiInstance.companiesUpdate(id, xApideckConsumerId, xApideckAppId, company, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
