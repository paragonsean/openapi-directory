...
> CreateLeadResponse leadsAdd(xApideckConsumerId, xApideckAppId, lead, opts)
...
let apiInstance = new CrmApi.LeadsApi();
...
apiInstance.leadsAdd(xApideckConsumerId, xApideckAppId, lead, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> GetLeadsResponse leadsAll(xApideckConsumerId, xApideckAppId, opts)
...
let opts = {
  ...
  'filter': new CrmApi.LeadsFilter(), // LeadsFilter | Apply filters
  'sort': new CrmApi.LeadsSort(), // LeadsSort | Apply sorting
...
apiInstance.leadsAll(xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> DeleteLeadResponse leadsDelete(id, xApideckConsumerId, xApideckAppId, opts)
...
apiInstance.leadsDelete(id, xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> GetLeadResponse leadsOne(id, xApideckConsumerId, xApideckAppId, opts)
...
apiInstance.leadsOne(id, xApideckConsumerId, xApideckAppId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> UpdateLeadResponse leadsUpdate(id, xApideckConsumerId, xApideckAppId, lead, opts)
...
apiInstance.leadsUpdate(id, xApideckConsumerId, xApideckAppId, lead, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
