...
class BankAccount(Model):
    ...
    def __init__(self, account_name: str=None, account_number: str=None, account_type: str=None, bank_code: str=None, bank_name: str=None, bic: str=None, branch_identifier: str=None, bsb_number: str=None, currency: Currency=None, iban: str=None, routing_number: str=None):
