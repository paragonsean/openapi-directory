...
/**
 * The LeadWebhookEvent model module.
 * @module model/LeadWebhookEvent
 * @version 10.0.0
 */
class LeadWebhookEvent {
    /**
     * Constructs a new <code>LeadWebhookEvent</code>.
     * @alias module:model/LeadWebhookEvent
     */
    constructor() { 
        
        LeadWebhookEvent.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LeadWebhookEvent</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LeadWebhookEvent} obj Optional instance to populate.
     * @return {module:model/LeadWebhookEvent} The populated <code>LeadWebhookEvent</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LeadWebhookEvent();
            ...
            if (data.hasOwnProperty('event_type')) {
                obj['event_type'] = LeadEventType.constructFromObject(data['event_type']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>LeadWebhookEvent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LeadWebhookEvent</code>.
     */
 ...
 */
LeadWebhookEvent.prototype['consumer_id'] = undefined;

/**
 * The service provider's ID of the entity that triggered this event
 * @member {String} entity_id
 */
LeadWebhookEvent.prototype['entity_id'] = undefined;

/**
 * The type entity that triggered this event
 * @member {String} entity_type
 */
LeadWebhookEvent.prototype['entity_type'] = undefined;

/**
 * The url to retrieve entity detail.
 * @member {String} entity_url
 */
LeadWebhookEvent.prototype['entity_url'] = undefined;

/**
 * Unique reference to this request event
 * @member {String} event_id
 */
LeadWebhookEvent.prototype['event_id'] = undefined;

/**
 * The current count this request event has been attempted
 * @member {Number} execution_attempt
 */
LeadWebhookEvent.prototype['execution_attempt'] = undefined;

/**
 * ISO Datetime for when the original event occurred
 * @member {String} occurred_at
 */
LeadWebhookEvent.prototype['occurred_at'] = undefined;

/**
 * Service provider identifier
 * @member {String} service_id
 */
LeadWebhookEvent.prototype['service_id'] = undefined;

/**
 * Name of Apideck Unified API
 * @member {module:model/LeadWebhookEvent.UnifiedApiEnum} unified_api
 */
LeadWebhookEvent.prototype['unified_api'] = undefined;

/**
 * @member {module:model/LeadEventType} event_type
 */
LeadWebhookEvent.prototype['event_type'] = undefined;
 ...
 * @readonly
 */
LeadWebhookEvent['UnifiedApiEnum'] = {
...
export default LeadWebhookEvent;
