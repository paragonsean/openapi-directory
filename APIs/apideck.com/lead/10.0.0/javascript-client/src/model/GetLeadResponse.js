...
class GetLeadResponse {
    ...
    constructor(data, operation, resource, service, status, statusCode) { 
        ...
        GetLeadResponse.initialize(this, data, operation, resource, service, status, statusCode);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = Lead.constructFromObject(data['data']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GetLeadResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetLeadResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetLeadResponse.RequiredProperties) {
...
GetLeadResponse.RequiredProperties = ["data", "operation", "resource", "service", "status", "status_code"];

/**
 * @member {module:model/Lead} data
 */
 ...
 */
GetLeadResponse.prototype['operation'] = undefined;

/**
 * Unified API resource name
 * @member {String} resource
 */
GetLeadResponse.prototype['resource'] = undefined;

/**
 * Apideck ID of service provider
 * @member {String} service
 */
GetLeadResponse.prototype['service'] = undefined;

/**
 * HTTP Response Status
 * @member {String} status
 */
GetLeadResponse.prototype['status'] = undefined;

/**
 * HTTP Response Status Code
 * @member {Number} status_code
 */
GetLeadResponse.prototype['status_code'] = undefined;
...
export default GetLeadResponse;
