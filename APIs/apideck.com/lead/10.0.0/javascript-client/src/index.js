...
import LeadEventType from './model/LeadEventType';
import LeadWebhookEvent from './model/LeadWebhookEvent';
...
* <pre>
* var LeadApi = require('index'); // See note below*.
* var xxxSvc = new LeadApi.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new LeadApi.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new LeadApi.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new LeadApi.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
...
export {
    ...
    /**
     * The LeadEventType model constructor.
     * @property {module:model/LeadEventType}
     */
    LeadEventType,

    /**
     * The LeadWebhookEvent model constructor.
     * @property {module:model/LeadWebhookEvent}
     */
    LeadWebhookEvent,
