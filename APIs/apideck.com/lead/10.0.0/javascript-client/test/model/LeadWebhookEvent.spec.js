...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LeadApi.LeadWebhookEvent();
  });
  ...
  describe('LeadWebhookEvent', function() {
    it('should create an instance of LeadWebhookEvent', function() {
      // uncomment below and update the code to test LeadWebhookEvent
      //var instance = new LeadApi.LeadWebhookEvent();
      //expect(instance).to.be.a(LeadApi.LeadWebhookEvent);
    });
