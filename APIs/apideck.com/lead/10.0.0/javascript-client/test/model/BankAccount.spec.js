...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.expect, root.LeadApi);
  }
}(this, function(expect, LeadApi) {
  'use strict';

  var instance;

  beforeEach(function() {
    instance = new LeadApi.BankAccount();
  });
  ...
  describe('BankAccount', function() {
    it('should create an instance of BankAccount', function() {
      ...
      //var instance = new LeadApi.BankAccount();
      //expect(instance).to.be.a(LeadApi.BankAccount);
    });
