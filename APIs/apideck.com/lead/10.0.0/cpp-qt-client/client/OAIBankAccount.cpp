...
void OAIBankAccount::initializeModel() {
    ...
    m_branch_identifier_isSet = false;
    m_branch_identifier_isValid = false;

    m_bsb_number_isSet = false;
    m_bsb_number_isValid = false;
...
void OAIBankAccount::fromJsonObject(QJsonObject json) {
    ...
    m_branch_identifier_isValid = ::OpenAPI::fromJsonValue(m_branch_identifier, json[QString("branch_identifier")]);
    m_branch_identifier_isSet = !json[QString("branch_identifier")].isNull() && m_branch_identifier_isValid;

    m_bsb_number_isValid = ::OpenAPI::fromJsonValue(m_bsb_number, json[QString("bsb_number")]);
    m_bsb_number_isSet = !json[QString("bsb_number")].isNull() && m_bsb_number_isValid;
...
QJsonObject OAIBankAccount::asJsonObject() const {
    ...
    if (m_branch_identifier_isSet) {
        obj.insert(QString("branch_identifier"), ::OpenAPI::toJsonValue(m_branch_identifier));
    }
    if (m_bsb_number_isSet) {
        obj.insert(QString("bsb_number"), ::OpenAPI::toJsonValue(m_bsb_number));
    }
    if (m_currency.isSet()) {
...
QString OAIBankAccount::getBankCode() const {
    return m_bank_code;
}
void OAIBankAccount::setBankCode(const QString &bank_code) {
    m_bank_code = bank_code;
    m_bank_code_isSet = true;
}

bool OAIBankAccount::is_bank_code_Set() const{
    return m_bank_code_isSet;
}

bool OAIBankAccount::is_bank_code_Valid() const{
...
QString OAIBankAccount::getBranchIdentifier() const {
    return m_branch_identifier;
}
void OAIBankAccount::setBranchIdentifier(const QString &branch_identifier) {
    m_branch_identifier = branch_identifier;
    m_branch_identifier_isSet = true;
}

bool OAIBankAccount::is_branch_identifier_Set() const{
    return m_branch_identifier_isSet;
}

bool OAIBankAccount::is_branch_identifier_Valid() const{
    return m_branch_identifier_isValid;
}

QString OAIBankAccount::getBsbNumber() const {
    return m_bsb_number;
}
void OAIBankAccount::setBsbNumber(const QString &bsb_number) {
    m_bsb_number = bsb_number;
    m_bsb_number_isSet = true;
}

bool OAIBankAccount::is_bsb_number_Set() const{
    return m_bsb_number_isSet;
}

bool OAIBankAccount::is_bsb_number_Valid() const{
    return m_bsb_number_isValid;
}
...
QString OAIBankAccount::getRoutingNumber() const {
    return m_routing_number;
}
void OAIBankAccount::setRoutingNumber(const QString &routing_number) {
    m_routing_number = routing_number;
    m_routing_number_isSet = true;
}

bool OAIBankAccount::is_routing_number_Set() const{
    return m_routing_number_isSet;
}

bool OAIBankAccount::is_routing_number_Valid() const{
