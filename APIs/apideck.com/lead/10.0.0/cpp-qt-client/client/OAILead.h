...
class OAILead : public OAIObject {
public:
    OAILead();
    OAILead(QString json);
    ~OAILead() override;
    ...
    double getMonetaryAmount() const;
    void setMonetaryAmount(const double &monetary_amount);
    bool is_monetary_amount_Set() const;
    bool is_monetary_amount_Valid() const;
    ...
    QList<OAIWebsite> getWebsites() const;
    void setWebsites(const QList<OAIWebsite> &websites);
...
private:
    ...
    double m_monetary_amount;
    bool m_monetary_amount_isSet;
    bool m_monetary_amount_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAILead)
