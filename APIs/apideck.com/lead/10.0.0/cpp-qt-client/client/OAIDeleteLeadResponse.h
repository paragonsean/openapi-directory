...
/*
 * OAIDeleteLeadResponse.h
 *
 * 
 */

#ifndef OAIDeleteLeadResponse_H
#define OAIDeleteLeadResponse_H
...
class OAIDeleteLeadResponse : public OAIObject {
public:
    OAIDeleteLeadResponse();
    OAIDeleteLeadResponse(QString json);
    ~OAIDeleteLeadResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteLeadResponse)

#endif // OAIDeleteLeadResponse_H
