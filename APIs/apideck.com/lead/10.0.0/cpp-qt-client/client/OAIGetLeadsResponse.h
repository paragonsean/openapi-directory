...
/*
 * OAIGetLeadsResponse.h
 *
 * 
 */

#ifndef OAIGetLeadsResponse_H
#define OAIGetLeadsResponse_H
...
class OAIGetLeadsResponse : public OAIObject {
public:
    OAIGetLeadsResponse();
    OAIGetLeadsResponse(QString json);
    ~OAIGetLeadsResponse() override;
    ...
    QList<OAILead> getData() const;
    void setData(const QList<OAILead> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetLeadsResponse)

#endif // OAIGetLeadsResponse_H
