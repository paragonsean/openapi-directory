...
/*
 * OAILeadWebhookEvent.h
 *
 * 
 */

#ifndef OAILeadWebhookEvent_H
#define OAILeadWebhookEvent_H
...
class OAILeadWebhookEvent : public OAIObject {
public:
    OAILeadWebhookEvent();
    OAILeadWebhookEvent(QString json);
    ~OAILeadWebhookEvent() override;
    ...
    OAILeadEventType getEventType() const;
    void setEventType(const OAILeadEventType &event_type);
...
Q_DECLARE_METATYPE(OpenAPI::OAILeadWebhookEvent)

#endif // OAILeadWebhookEvent_H
