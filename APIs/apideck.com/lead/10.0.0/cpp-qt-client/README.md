...
void Example::exampleFunction1(){
     OAILeadsApi apiInstance;
     
      // Configure API key authorization: apiKey
      apiInstance.setApiKey("YOUR API KEY NAME","YOUR API KEY");

      QEventLoop loop;
      connect(&apiInstance, &OAILeadsApi::leadsAddSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAILeadsApi::leadsAddSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
      ...
      OAILead oai_lead = create(); // OAILead | 
      ...
      apiInstance.leadsAdd(x_apideck_consumer_idx_apideck_app_idoai_leadrawx_apideck_service_id);
