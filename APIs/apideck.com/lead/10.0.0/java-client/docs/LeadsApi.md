...
|------------- | ------------- | -------------|
| [**leadsAdd**](LeadsApi.md#leadsAdd) | **POST** /lead/leads | Create lead |
| [**leadsAll**](LeadsApi.md#leadsAll) | **GET** /lead/leads | List leads |
| [**leadsDelete**](LeadsApi.md#leadsDelete) | **DELETE** /lead/leads/{id} | Delete lead |
| [**leadsOne**](LeadsApi.md#leadsOne) | **GET** /lead/leads/{id} | Get lead |
| [**leadsUpdate**](LeadsApi.md#leadsUpdate) | **PATCH** /lead/leads/{id} | Update lead |
...
<a id="leadsAll"></a>
# **leadsAll**
> GetLeadsResponse leadsAll(xApideckConsumerId, xApideckAppId, raw, xApideckServiceId, cursor, limit, filter, sort, fields)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      GetLeadsResponse result = apiInstance.leadsAll(xApideckConsumerId, xApideckAppId, raw, xApideckServiceId, cursor, limit, filter, sort, fields);
      System.out.println(result);
    } catch (ApiException e) {
