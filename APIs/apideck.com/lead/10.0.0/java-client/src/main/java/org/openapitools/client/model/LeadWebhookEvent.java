...
import org.openapitools.client.model.LeadEventType;
...
public class LeadWebhookEvent {
  ...
  public LeadWebhookEvent() {
  }

  public LeadWebhookEvent consumerId(String consumerId) {
  ...
  public LeadWebhookEvent entityId(String entityId) {
  ...
  public LeadWebhookEvent entityType(String entityType) {
  ...
  public LeadWebhookEvent entityUrl(String entityUrl) {
  ...
  public LeadWebhookEvent eventId(String eventId) {
  ...
  public LeadWebhookEvent executionAttempt(BigDecimal executionAttempt) {
  ...
  public LeadWebhookEvent occurredAt(String occurredAt) {
  ...
  public LeadWebhookEvent serviceId(String serviceId) {
  ...
  public LeadWebhookEvent unifiedApi(UnifiedApiEnum unifiedApi) {
  ...
  public LeadWebhookEvent eventType(LeadEventType eventType) {
   ...
   */
  @javax.annotation.Nullable
  public LeadEventType getEventType() {
    return eventType;
  }

  public void setEventType(LeadEventType eventType) {
    this.eventType = eventType;
  }
  ...
  public boolean equals(Object o) {
    ...
    LeadWebhookEvent leadWebhookEvent = (LeadWebhookEvent) o;
    return Objects.equals(this.consumerId, leadWebhookEvent.consumerId) &&
        Objects.equals(this.entityId, leadWebhookEvent.entityId) &&
        Objects.equals(this.entityType, leadWebhookEvent.entityType) &&
        Objects.equals(this.entityUrl, leadWebhookEvent.entityUrl) &&
        Objects.equals(this.eventId, leadWebhookEvent.eventId) &&
        Objects.equals(this.executionAttempt, leadWebhookEvent.executionAttempt) &&
        Objects.equals(this.occurredAt, leadWebhookEvent.occurredAt) &&
        Objects.equals(this.serviceId, leadWebhookEvent.serviceId) &&
        Objects.equals(this.unifiedApi, leadWebhookEvent.unifiedApi) &&
        Objects.equals(this.eventType, leadWebhookEvent.eventType);
  }
  ...
  public String toString() {
    ...
    sb.append("class LeadWebhookEvent {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LeadWebhookEvent
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LeadWebhookEvent.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LeadWebhookEvent is not found in the empty JSON string", LeadWebhookEvent.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LeadWebhookEvent.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LeadWebhookEvent` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("event_type") != null && !jsonObj.get("event_type").isJsonNull()) {
        LeadEventType.validateJsonElement(jsonObj.get("event_type"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LeadWebhookEvent.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LeadWebhookEvent' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LeadWebhookEvent> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LeadWebhookEvent.class));

       return (TypeAdapter<T>) new TypeAdapter<LeadWebhookEvent>() {
           @Override
           public void write(JsonWriter out, LeadWebhookEvent value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LeadWebhookEvent read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LeadWebhookEvent given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LeadWebhookEvent
   * @throws IOException if the JSON string is invalid with respect to LeadWebhookEvent
   */
  public static LeadWebhookEvent fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LeadWebhookEvent.class);
  }

  /**
   * Convert an instance of LeadWebhookEvent to an JSON string
   *
   * @return JSON string
   */
