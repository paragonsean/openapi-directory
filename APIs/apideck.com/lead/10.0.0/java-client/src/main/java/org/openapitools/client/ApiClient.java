...
public class ApiClient {
    ...
    private String basePath = "https://unify.apideck.com";
    ...
    public ApiClient() {
        ...
        authentications.put("applicationId", new ApiKeyAuth("header", "x-apideck-app-id"));
        authentications.put("consumerId", new ApiKeyAuth("header", "x-apideck-consumer-id"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://unify.apideck.com
