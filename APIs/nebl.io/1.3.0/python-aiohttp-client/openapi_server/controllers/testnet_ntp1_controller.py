...
async def testnet_broadcast_tx(request: web.Request, body) -> web.Response:
...
async def testnet_burn_token(request: web.Request, body) -> web.Response:
...
async def testnet_get_address_info(request: web.Request, address) -> web.Response:
...
async def testnet_get_token_holders(request: web.Request, tokenid) -> web.Response:
...
async def testnet_get_token_id(request: web.Request, tokensymbol) -> web.Response:
...
async def testnet_get_token_metadata(request: web.Request, tokenid, verbosity=None) -> web.Response:
...
async def testnet_get_token_metadata_of_utxo(request: web.Request, tokenid, utxo, verbosity=None) -> web.Response:
...
async def testnet_get_transaction_info(request: web.Request, txid) -> web.Response:
...
async def testnet_issue_token(request: web.Request, body) -> web.Response:
...
async def testnet_send_token(request: web.Request, body) -> web.Response:
