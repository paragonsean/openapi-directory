...
async def get_address(request: web.Request, address) -> web.Response:
...
async def get_address_balance(request: web.Request, address) -> web.Response:
...
async def get_address_total_received(request: web.Request, address) -> web.Response:
...
async def get_address_total_sent(request: web.Request, address) -> web.Response:
...
async def get_address_unconfirmed_balance(request: web.Request, address) -> web.Response:
...
async def get_address_utxos(request: web.Request, address) -> web.Response:
...
async def get_block(request: web.Request, blockhash) -> web.Response:
...
async def get_block_index(request: web.Request, blockindex) -> web.Response:
...
async def get_raw_tx(request: web.Request, txid) -> web.Response:
...
async def get_status(request: web.Request, q=None) -> web.Response:
...
async def get_sync(request: web.Request, ) -> web.Response:
...
async def get_tx(request: web.Request, txid) -> web.Response:
...
async def get_txs(request: web.Request, address=None, block=None, page_num=None) -> web.Response:
...
async def send_tx(request: web.Request, body) -> web.Response:
