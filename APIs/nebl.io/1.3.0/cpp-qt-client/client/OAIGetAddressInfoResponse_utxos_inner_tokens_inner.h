...
/*
 * OAIGetAddressInfoResponse_utxos_inner_tokens_inner.h
 *
 * 
 */

#ifndef OAIGetAddressInfoResponse_utxos_inner_tokens_inner_H
#define OAIGetAddressInfoResponse_utxos_inner_tokens_inner_H
...
class OAIGetAddressInfoResponse_utxos_inner_tokens_inner : public OAIObject {
public:
    OAIGetAddressInfoResponse_utxos_inner_tokens_inner();
    OAIGetAddressInfoResponse_utxos_inner_tokens_inner(QString json);
    ~OAIGetAddressInfoResponse_utxos_inner_tokens_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetAddressInfoResponse_utxos_inner_tokens_inner)

#endif // OAIGetAddressInfoResponse_utxos_inner_tokens_inner_H
