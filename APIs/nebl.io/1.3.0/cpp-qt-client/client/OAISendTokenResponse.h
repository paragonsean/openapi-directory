...
/*
 * OAISendTokenResponse.h
 *
 * 
 */

#ifndef OAISendTokenResponse_H
#define OAISendTokenResponse_H
...
class OAISendTokenResponse : public OAIObject {
public:
    OAISendTokenResponse();
    OAISendTokenResponse(QString json);
    ~OAISendTokenResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISendTokenResponse)

#endif // OAISendTokenResponse_H
