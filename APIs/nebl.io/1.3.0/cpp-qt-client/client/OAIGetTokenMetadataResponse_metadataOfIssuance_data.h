...
/*
 * OAIGetTokenMetadataResponse_metadataOfIssuance_data.h
 *
 * 
 */

#ifndef OAIGetTokenMetadataResponse_metadataOfIssuance_data_H
#define OAIGetTokenMetadataResponse_metadataOfIssuance_data_H
...
class OAIGetTokenMetadataResponse_metadataOfIssuance_data : public OAIObject {
public:
    OAIGetTokenMetadataResponse_metadataOfIssuance_data();
    OAIGetTokenMetadataResponse_metadataOfIssuance_data(QString json);
    ~OAIGetTokenMetadataResponse_metadataOfIssuance_data() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetTokenMetadataResponse_metadataOfIssuance_data)

#endif // OAIGetTokenMetadataResponse_metadataOfIssuance_data_H
