...
public class ApiClient {
    ...
    private String basePath = "https://ntp1node.nebl.io";
    ...
    public ApiClient() {
        ...
        authentications.put("rpcAuth", new HttpBasicAuth());
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://ntp1node.nebl.io
