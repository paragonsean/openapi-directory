...
let defaultClient = NeblioRestApiSuite.ApiClient.instance;
...
let apiInstance = new NeblioRestApiSuite.JSONRPCApi();
let rpcRequest = new NeblioRestApiSuite.RpcRequest(); // RpcRequest | 
