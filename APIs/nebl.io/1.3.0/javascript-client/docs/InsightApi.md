...
let apiInstance = new NeblioRestApiSuite.InsightApi();
...
> [GetAddressUtxosResponseInner] getAddressUtxos(address)
...
[**[GetAddressUtxosResponseInner]**](GetAddressUtxosResponseInner.md)
...
let apiInstance = new NeblioRestApiSuite.InsightApi();
let sendTxRequest = new NeblioRestApiSuite.SendTxRequest(); // SendTxRequest | Object representing a transaction to broadcast
