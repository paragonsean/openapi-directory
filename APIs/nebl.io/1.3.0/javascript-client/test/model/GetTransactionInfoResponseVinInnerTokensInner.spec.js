...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NeblioRestApiSuite.GetTransactionInfoResponseVinInnerTokensInner();
  });
  ...
  describe('GetTransactionInfoResponseVinInnerTokensInner', function() {
    it('should create an instance of GetTransactionInfoResponseVinInnerTokensInner', function() {
      // uncomment below and update the code to test GetTransactionInfoResponseVinInnerTokensInner
      //var instance = new NeblioRestApiSuite.GetTransactionInfoResponseVinInnerTokensInner();
      //expect(instance).to.be.a(NeblioRestApiSuite.GetTransactionInfoResponseVinInnerTokensInner);
    });
