...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NeblioRestApiSuite.GetTxResponse();
  });
  ...
  describe('GetTxResponse', function() {
    it('should create an instance of GetTxResponse', function() {
      ...
      //var instance = new NeblioRestApiSuite.GetTxResponse();
      //expect(instance).to.be.a(NeblioRestApiSuite.GetTxResponse);
    });
