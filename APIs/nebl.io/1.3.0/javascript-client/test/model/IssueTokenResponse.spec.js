...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NeblioRestApiSuite.IssueTokenResponse();
  });
  ...
  describe('IssueTokenResponse', function() {
    it('should create an instance of IssueTokenResponse', function() {
      // uncomment below and update the code to test IssueTokenResponse
      //var instance = new NeblioRestApiSuite.IssueTokenResponse();
      //expect(instance).to.be.a(NeblioRestApiSuite.IssueTokenResponse);
    });
