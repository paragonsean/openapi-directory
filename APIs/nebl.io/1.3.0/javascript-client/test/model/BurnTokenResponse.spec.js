...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NeblioRestApiSuite.BurnTokenResponse();
  });
  ...
  describe('BurnTokenResponse', function() {
    it('should create an instance of BurnTokenResponse', function() {
      ...
      //var instance = new NeblioRestApiSuite.BurnTokenResponse();
      //expect(instance).to.be.a(NeblioRestApiSuite.BurnTokenResponse);
    });
