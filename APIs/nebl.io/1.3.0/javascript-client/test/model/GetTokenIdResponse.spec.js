...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NeblioRestApiSuite.GetTokenIdResponse();
  });
  ...
  describe('GetTokenIdResponse', function() {
    it('should create an instance of GetTokenIdResponse', function() {
      // uncomment below and update the code to test GetTokenIdResponse
      //var instance = new NeblioRestApiSuite.GetTokenIdResponse();
      //expect(instance).to.be.a(NeblioRestApiSuite.GetTokenIdResponse);
    });
