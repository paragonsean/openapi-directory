...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NeblioRestApiSuite.GetTxResponseVoutInner();
  });
  ...
  describe('GetTxResponseVoutInner', function() {
    it('should create an instance of GetTxResponseVoutInner', function() {
      // uncomment below and update the code to test GetTxResponseVoutInner
      //var instance = new NeblioRestApiSuite.GetTxResponseVoutInner();
      //expect(instance).to.be.a(NeblioRestApiSuite.GetTxResponseVoutInner);
    });
