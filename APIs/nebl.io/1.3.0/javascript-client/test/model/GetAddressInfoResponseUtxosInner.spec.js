...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NeblioRestApiSuite.GetAddressInfoResponseUtxosInner();
  });
  ...
  describe('GetAddressInfoResponseUtxosInner', function() {
    it('should create an instance of GetAddressInfoResponseUtxosInner', function() {
      // uncomment below and update the code to test GetAddressInfoResponseUtxosInner
      //var instance = new NeblioRestApiSuite.GetAddressInfoResponseUtxosInner();
      //expect(instance).to.be.a(NeblioRestApiSuite.GetAddressInfoResponseUtxosInner);
    });
