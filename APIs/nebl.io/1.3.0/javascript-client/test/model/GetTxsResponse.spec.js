...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NeblioRestApiSuite.GetTxsResponse();
  });
  ...
  describe('GetTxsResponse', function() {
    it('should create an instance of GetTxsResponse', function() {
      ...
      //var instance = new NeblioRestApiSuite.GetTxsResponse();
      //expect(instance).to.be.a(NeblioRestApiSuite.GetTxsResponse);
    });
