...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NeblioRestApiSuite.GetFaucetResponse();
  });
  ...
  describe('GetFaucetResponse', function() {
    it('should create an instance of GetFaucetResponse', function() {
      ...
      //var instance = new NeblioRestApiSuite.GetFaucetResponse();
      //expect(instance).to.be.a(NeblioRestApiSuite.GetFaucetResponse);
    });
