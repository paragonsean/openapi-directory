...
export default class TestnetInsightApi {
    ...
    */
     ...
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/GetAddressUtxosResponseInner>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link Array.<module:model/GetAddressUtxosResponseInner>}
     */
    testnetGetAddressUtxos(address, callback) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = [GetAddressUtxosResponseInner];
      return this.apiClient.callApi(
