...
class GetTokenMetadataResponseMetadataOfUtxo {
    ...
    /**
     * Validates the JSON data with respect to <code>GetTokenMetadataResponseMetadataOfUtxo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetTokenMetadataResponseMetadataOfUtxo</code>.
     */
    static validateJSON(data) {
        // validate the optional field `userData`
        if (data['userData']) { // data not null
          GetTokenMetadataResponseMetadataOfUtxoUserData.validateJSON(data['userData']);
        }
