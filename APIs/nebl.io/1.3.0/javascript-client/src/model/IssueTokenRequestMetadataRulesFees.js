...
import IssueTokenRequestMetadataRulesFeesItemsInner from './IssueTokenRequestMetadataRulesFeesItemsInner';
...
class IssueTokenRequestMetadataRulesFees {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [IssueTokenRequestMetadataRulesFeesItemsInner]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>IssueTokenRequestMetadataRulesFees</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IssueTokenRequestMetadataRulesFees</code>.
     */
    static validateJSON(data) {
        if (data['items']) { // data not null
            ...
            for (const item of data['items']) {
                IssueTokenRequestMetadataRulesFeesItemsInner.validateJSON(item);
            };
        }
 ...
 * @member {Array.<module:model/IssueTokenRequestMetadataRulesFeesItemsInner>} items
 */
