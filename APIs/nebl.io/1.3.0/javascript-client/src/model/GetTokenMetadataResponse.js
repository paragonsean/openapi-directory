...
import GetTokenMetadataResponseMetadataOfUtxo from './GetTokenMetadataResponseMetadataOfUtxo';
...
class GetTokenMetadataResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('initialIssuanceAmount')) {
                obj['initialIssuanceAmount'] = ApiClient.convertToType(data['initialIssuanceAmount'], 'Number');
            }
            ...
            if (data.hasOwnProperty('metadataOfUtxo')) {
                obj['metadataOfUtxo'] = GetTokenMetadataResponseMetadataOfUtxo.constructFromObject(data['metadataOfUtxo']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GetTokenMetadataResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetTokenMetadataResponse</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['issuanceTxid'] && !(typeof data['issuanceTxid'] === 'string' || data['issuanceTxid'] instanceof String)) {
            throw new Error("Expected the field `issuanceTxid` to be a primitive type in the JSON string but got " + data['issuanceTxid']);
        }
        // ensure the json data is a string
        ...
        if (data['metadataOfIssuance']) { // data not null
          GetTokenMetadataResponseMetadataOfIssuance.validateJSON(data['metadataOfIssuance']);
        }
        // validate the optional field `metadataOfUtxo`
        if (data['metadataOfUtxo']) { // data not null
          GetTokenMetadataResponseMetadataOfUtxo.validateJSON(data['metadataOfUtxo']);
        }
        // ensure the json data is a string
 ...
 * @member {Number} initialIssuanceAmount
 */
GetTokenMetadataResponse.prototype['initialIssuanceAmount'] = undefined;
...
/**
 * @member {module:model/GetTokenMetadataResponseMetadataOfUtxo} metadataOfUtxo
 */
