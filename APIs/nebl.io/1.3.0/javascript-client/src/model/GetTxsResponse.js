...
class GetTxsResponse {
    ...
    /**
     * Validates the JSON data with respect to <code>GetTxsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetTxsResponse</code>.
     */
    static validateJSON(data) {
        if (data['txs']) { // data not null
            ...
            for (const item of data['txs']) {
                GetTxResponse.validateJSON(item);
            };
        }
