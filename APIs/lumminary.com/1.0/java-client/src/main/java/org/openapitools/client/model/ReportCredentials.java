...
public class ReportCredentials {
  public static final String SERIALIZED_NAME_AUTHORIZATION_UUID = "authorization_uuid";
  @SerializedName(SERIALIZED_NAME_AUTHORIZATION_UUID)
  private String authorizationUuid;

  public static final String SERIALIZED_NAME_CLIENT_PASSWORD = "client_password";
  @SerializedName(SERIALIZED_NAME_CLIENT_PASSWORD)
  private String clientPassword;

  public static final String SERIALIZED_NAME_CLIENT_USERNAME = "client_username";
  @SerializedName(SERIALIZED_NAME_CLIENT_USERNAME)
  ...
  public static final String SERIALIZED_NAME_REPORT_CREDENTIALS_UUID = "report_credentials_uuid";
  @SerializedName(SERIALIZED_NAME_REPORT_CREDENTIALS_UUID)
  private String reportCredentialsUuid;
  ...
  public ReportCredentials authorizationUuid(String authorizationUuid) {
  ...
  public ReportCredentials clientPassword(String clientPassword) {
  ...
  public ReportCredentials clientUsername(String clientUsername) {
  ...
  public ReportCredentials createTimestamp(Integer createTimestamp) {
  ...
  public ReportCredentials reportCredentialsUuid(String reportCredentialsUuid) {
    this.reportCredentialsUuid = reportCredentialsUuid;
    return this;
  }

  /**
   * The uuid of the report
   * @return reportCredentialsUuid
   */
  @javax.annotation.Nonnull
  public String getReportCredentialsUuid() {
    return reportCredentialsUuid;
  }

  public void setReportCredentialsUuid(String reportCredentialsUuid) {
    this.reportCredentialsUuid = reportCredentialsUuid;
  }


  public ReportCredentials reportUrl(String reportUrl) {
  ...
  public boolean equals(Object o) {
    ...
    ReportCredentials reportCredentials = (ReportCredentials) o;
    return Objects.equals(this.authorizationUuid, reportCredentials.authorizationUuid) &&
        Objects.equals(this.clientPassword, reportCredentials.clientPassword) &&
        Objects.equals(this.clientUsername, reportCredentials.clientUsername) &&
        Objects.equals(this.createTimestamp, reportCredentials.createTimestamp) &&
        Objects.equals(this.reportCredentialsUuid, reportCredentials.reportCredentialsUuid) &&
        Objects.equals(this.reportUrl, reportCredentials.reportUrl);
  }

  @Override
  public int hashCode() {
    return Objects.hash(authorizationUuid, clientPassword, clientUsername, createTimestamp, reportCredentialsUuid, reportUrl);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ReportCredentials {\n");
    sb.append("    authorizationUuid: ").append(toIndentedString(authorizationUuid)).append("\n");
    ...
    sb.append("    reportCredentialsUuid: ").append(toIndentedString(reportCredentialsUuid)).append("\n");
  ...
  static {
    ...
    openapiFields.add("authorization_uuid");
    openapiFields.add("client_password");
    openapiFields.add("client_username");
    openapiFields.add("create_timestamp");
    openapiFields.add("report_credentials_uuid");
    openapiFields.add("report_url");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("authorization_uuid");
    openapiRequiredFields.add("create_timestamp");
    openapiRequiredFields.add("report_credentials_uuid");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReportCredentials
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReportCredentials.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReportCredentials is not found in the empty JSON string", ReportCredentials.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReportCredentials.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReportCredentials` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ReportCredentials.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (!jsonObj.get("authorization_uuid").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `authorization_uuid` to be a primitive type in the JSON string but got `%s`", jsonObj.get("authorization_uuid").toString()));
      }
      if ((jsonObj.get("client_password") != null && !jsonObj.get("client_password").isJsonNull()) && !jsonObj.get("client_password").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `client_password` to be a primitive type in the JSON string but got `%s`", jsonObj.get("client_password").toString()));
      }
      if ((jsonObj.get("client_username") != null && !jsonObj.get("client_username").isJsonNull()) && !jsonObj.get("client_username").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `client_username` to be a primitive type in the JSON string but got `%s`", jsonObj.get("client_username").toString()));
      }
      if (!jsonObj.get("report_credentials_uuid").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `report_credentials_uuid` to be a primitive type in the JSON string but got `%s`", jsonObj.get("report_credentials_uuid").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReportCredentials.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReportCredentials' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReportCredentials> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReportCredentials.class));

       return (TypeAdapter<T>) new TypeAdapter<ReportCredentials>() {
           @Override
           public void write(JsonWriter out, ReportCredentials value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReportCredentials read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ReportCredentials given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReportCredentials
   * @throws IOException if the JSON string is invalid with respect to ReportCredentials
   */
  public static ReportCredentials fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReportCredentials.class);
  }

  /**
   * Convert an instance of ReportCredentials to an JSON string
   *
   * @return JSON string
   */
