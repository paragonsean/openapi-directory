...
import org.openapitools.client.model.AccessScope;
...
public class Authorization {
  ...
  public static final String SERIALIZED_NAME_REPORT_CREDENTIALS = "report_credentials";
  @SerializedName(SERIALIZED_NAME_REPORT_CREDENTIALS)
  private List<ReportCredentials> reportCredentials = new ArrayList<>();

  public static final String SERIALIZED_NAME_REPORT_FILES = "report_files";
  @SerializedName(SERIALIZED_NAME_REPORT_FILES)
  private List<ReportFile> reportFiles = new ArrayList<>();

  public static final String SERIALIZED_NAME_SCOPES = "scopes";
  @SerializedName(SERIALIZED_NAME_SCOPES)
  private AccessScope scopes;
  ...
  public Authorization authorizationUuid(String authorizationUuid) {
  ...
  public Authorization clientUuid(String clientUuid) {
  ...
  public Authorization createTimestamp(Integer createTimestamp) {
  ...
  public Authorization isActive(Boolean isActive) {
  ...
  public Authorization order(String order) {
    this.order = order;
    return this;
  }
  ...
  public Authorization productUuid(String productUuid) {
  ...
  public Authorization reportCredentials(List<ReportCredentials> reportCredentials) {
    this.reportCredentials = reportCredentials;
    return this;
  }

  public Authorization addReportCredentialsItem(ReportCredentials reportCredentialsItem) {
    if (this.reportCredentials == null) {
      this.reportCredentials = new ArrayList<>();
    }
    this.reportCredentials.add(reportCredentialsItem);
    return this;
  }

  /**
   * Get reportCredentials
   * @return reportCredentials
   */
  @javax.annotation.Nullable
  public List<ReportCredentials> getReportCredentials() {
    return reportCredentials;
  }

  public void setReportCredentials(List<ReportCredentials> reportCredentials) {
    this.reportCredentials = reportCredentials;
  }


  public Authorization reportFiles(List<ReportFile> reportFiles) {
    this.reportFiles = reportFiles;
    return this;
  }

  public Authorization addReportFilesItem(ReportFile reportFilesItem) {
  ...
  public Authorization scopes(AccessScope scopes) {
    this.scopes = scopes;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public AccessScope getScopes() {
    return scopes;
  }

  public void setScopes(AccessScope scopes) {
    this.scopes = scopes;
  }


  public Authorization sequenceNumber(Integer sequenceNumber) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.authorizationUuid, authorization.authorizationUuid) &&
        Objects.equals(this.clientUuid, authorization.clientUuid) &&
        Objects.equals(this.createTimestamp, authorization.createTimestamp) &&
        Objects.equals(this.isActive, authorization.isActive) &&
        Objects.equals(this.order, authorization.order) &&
        Objects.equals(this.productUuid, authorization.productUuid) &&
        Objects.equals(this.reportCredentials, authorization.reportCredentials) &&
        Objects.equals(this.reportFiles, authorization.reportFiles) &&
        Objects.equals(this.scopes, authorization.scopes) &&
        Objects.equals(this.sequenceNumber, authorization.sequenceNumber) &&
        Objects.equals(this.state, authorization.state);
  }

  @Override
  public int hashCode() {
    return Objects.hash(authorizationUuid, clientUuid, createTimestamp, isActive, order, productUuid, reportCredentials, reportFiles, scopes, sequenceNumber, state);
  }
  ...
  public String toString() {
    ...
    sb.append("    reportCredentials: ").append(toIndentedString(reportCredentials)).append("\n");
  ...
  static {
    ...
    openapiFields.add("report_credentials");
    openapiFields.add("report_files");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("report_credentials") != null && !jsonObj.get("report_credentials").isJsonNull()) {
        JsonArray jsonArrayreportCredentials = jsonObj.getAsJsonArray("report_credentials");
        if (jsonArrayreportCredentials != null) {
          // ensure the json data is an array
          if (!jsonObj.get("report_credentials").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `report_credentials` to be an array in the JSON string but got `%s`", jsonObj.get("report_credentials").toString()));
          }

          // validate the optional field `report_credentials` (array)
          for (int i = 0; i < jsonArrayreportCredentials.size(); i++) {
            ReportCredentials.validateJsonElement(jsonArrayreportCredentials.get(i));
          };
        }
      }
      if (jsonObj.get("report_files") != null && !jsonObj.get("report_files").isJsonNull()) {
        JsonArray jsonArrayreportFiles = jsonObj.getAsJsonArray("report_files");
        if (jsonArrayreportFiles != null) {
          // ensure the json data is an array
          if (!jsonObj.get("report_files").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `report_files` to be an array in the JSON string but got `%s`", jsonObj.get("report_files").toString()));
          }

          // validate the optional field `report_files` (array)
          for (int i = 0; i < jsonArrayreportFiles.size(); i++) {
            ReportFile.validateJsonElement(jsonArrayreportFiles.get(i));
          };
        }
      }
      // validate the required field `scopes`
      AccessScope.validateJsonElement(jsonObj.get("scopes"));
