...
public class PublicGene {
  public static final String SERIALIZED_NAME_CHROMOSOME = "chromosome";
  @SerializedName(SERIALIZED_NAME_CHROMOSOME)
  private String chromosome;

  public static final String SERIALIZED_NAME_MOLECULAR_END_POSITION = "molecular_end_position";
  @SerializedName(SERIALIZED_NAME_MOLECULAR_END_POSITION)
  private Integer molecularEndPosition;

  public static final String SERIALIZED_NAME_MOLECULAR_START_POSITION = "molecular_start_position";
  @SerializedName(SERIALIZED_NAME_MOLECULAR_START_POSITION)
  private Integer molecularStartPosition;

  public static final String SERIALIZED_NAME_PARENT_ACCESSION = "parent_accession";
  @SerializedName(SERIALIZED_NAME_PARENT_ACCESSION)
  private String parentAccession;

  public static final String SERIALIZED_NAME_SNP_IDS = "snp_ids";
  @SerializedName(SERIALIZED_NAME_SNP_IDS)
  private List<String> snpIds = new ArrayList<>();
  ...
  public PublicGene chromosome(String chromosome) {
  ...
  public PublicGene molecularEndPosition(Integer molecularEndPosition) {
    this.molecularEndPosition = molecularEndPosition;
    return this;
  }
   ...
   * minimum: 0
   * @return molecularEndPosition
   */
  @javax.annotation.Nonnull
  public Integer getMolecularEndPosition() {
    return molecularEndPosition;
  }

  public void setMolecularEndPosition(Integer molecularEndPosition) {
    this.molecularEndPosition = molecularEndPosition;
  }


  public PublicGene molecularStartPosition(Integer molecularStartPosition) {
    this.molecularStartPosition = molecularStartPosition;
    return this;
  }
   ...
   * minimum: 0
   * @return molecularStartPosition
   */
  @javax.annotation.Nonnull
  public Integer getMolecularStartPosition() {
    return molecularStartPosition;
  }

  public void setMolecularStartPosition(Integer molecularStartPosition) {
    this.molecularStartPosition = molecularStartPosition;
  }


  public PublicGene parentAccession(String parentAccession) {
  ...
  public PublicGene snpIds(List<String> snpIds) {
    this.snpIds = snpIds;
    return this;
  }

  public PublicGene addSnpIdsItem(String snpIdsItem) {
    if (this.snpIds == null) {
      this.snpIds = new ArrayList<>();
    }
    this.snpIds.add(snpIdsItem);
    return this;
  }
  ...
  public void setSnpIds(List<String> snpIds) {
    this.snpIds = snpIds;
  }


  public PublicGene symbol(String symbol) {
    this.symbol = symbol;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PublicGene publicGene = (PublicGene) o;
    return Objects.equals(this.chromosome, publicGene.chromosome) &&
        Objects.equals(this.molecularEndPosition, publicGene.molecularEndPosition) &&
        Objects.equals(this.molecularStartPosition, publicGene.molecularStartPosition) &&
        Objects.equals(this.parentAccession, publicGene.parentAccession) &&
        Objects.equals(this.snpIds, publicGene.snpIds) &&
        Objects.equals(this.symbol, publicGene.symbol);
  }

  @Override
  public int hashCode() {
    return Objects.hash(chromosome, molecularEndPosition, molecularStartPosition, parentAccession, snpIds, symbol);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PublicGene {\n");
    sb.append("    chromosome: ").append(toIndentedString(chromosome)).append("\n");
    sb.append("    molecularEndPosition: ").append(toIndentedString(molecularEndPosition)).append("\n");
    sb.append("    molecularStartPosition: ").append(toIndentedString(molecularStartPosition)).append("\n");
    sb.append("    parentAccession: ").append(toIndentedString(parentAccession)).append("\n");
    sb.append("    snpIds: ").append(toIndentedString(snpIds)).append("\n");
  ...
  static {
    ...
    openapiFields.add("molecular_end_position");
    openapiFields.add("molecular_start_position");
    openapiFields.add("parent_accession");
    openapiFields.add("snp_ids");
    openapiFields.add("symbol");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("chromosome");
    openapiRequiredFields.add("molecular_end_position");
    openapiRequiredFields.add("molecular_start_position");
    openapiRequiredFields.add("parent_accession");
    openapiRequiredFields.add("snp_ids");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PublicGene
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PublicGene.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PublicGene is not found in the empty JSON string", PublicGene.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PublicGene.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PublicGene` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PublicGene.openapiRequiredFields) {
      ...
      if (!jsonObj.get("parent_accession").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `parent_accession` to be a primitive type in the JSON string but got `%s`", jsonObj.get("parent_accession").toString()));
      }
      // ensure the required json array is present
      if (jsonObj.get("snp_ids") == null) {
        throw new IllegalArgumentException("Expected the field `linkedContent` to be an array in the JSON string but got `null`");
      } else if (!jsonObj.get("snp_ids").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `snp_ids` to be an array in the JSON string but got `%s`", jsonObj.get("snp_ids").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PublicGene.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PublicGene' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PublicGene> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PublicGene.class));

       return (TypeAdapter<T>) new TypeAdapter<PublicGene>() {
           @Override
           public void write(JsonWriter out, PublicGene value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PublicGene read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PublicGene given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PublicGene
   * @throws IOException if the JSON string is invalid with respect to PublicGene
   */
  public static PublicGene fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PublicGene.class);
  }

  /**
   * Convert an instance of PublicGene to an JSON string
   *
   * @return JSON string
   */
