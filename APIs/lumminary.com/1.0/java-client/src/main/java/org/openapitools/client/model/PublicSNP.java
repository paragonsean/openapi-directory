...
public class PublicSNP {
  public static final String SERIALIZED_NAME_ALTERNATIVE_ALLELES = "alternative_alleles";
  @SerializedName(SERIALIZED_NAME_ALTERNATIVE_ALLELES)
  private List<String> alternativeAlleles = new ArrayList<>();

  public static final String SERIALIZED_NAME_CHROMOSOME = "chromosome";
  @SerializedName(SERIALIZED_NAME_CHROMOSOME)
  private String chromosome;

  public static final String SERIALIZED_NAME_CHROMOSOME_ACCESSION = "chromosome_accession";
  @SerializedName(SERIALIZED_NAME_CHROMOSOME_ACCESSION)
  private String chromosomeAccession;

  public static final String SERIALIZED_NAME_DBSNP_VERSION = "dbsnp_version";
  ...
  public static final String SERIALIZED_NAME_REFERENCE_ALLELE = "reference_allele";
  @SerializedName(SERIALIZED_NAME_REFERENCE_ALLELE)
  private String referenceAllele;

  public static final String SERIALIZED_NAME_REFERENCE_GENOME = "reference_genome";
  @SerializedName(SERIALIZED_NAME_REFERENCE_GENOME)
  private String referenceGenome;

  public static final String SERIALIZED_NAME_SNP_ID = "snp_id";
  @SerializedName(SERIALIZED_NAME_SNP_ID)
  private String snpId;

  public PublicSNP() {
  }

  public PublicSNP alternativeAlleles(List<String> alternativeAlleles) {
    this.alternativeAlleles = alternativeAlleles;
    return this;
  }

  public PublicSNP addAlternativeAllelesItem(String alternativeAllelesItem) {
    if (this.alternativeAlleles == null) {
      this.alternativeAlleles = new ArrayList<>();
    }
    this.alternativeAlleles.add(alternativeAllelesItem);
    return this;
  }

  /**
   * Get alternativeAlleles
  ...
  public PublicSNP chromosome(String chromosome) {
  ...
  public PublicSNP chromosomeAccession(String chromosomeAccession) {
  ...
  public PublicSNP dbsnpVersion(Integer dbsnpVersion) {
  ...
  public PublicSNP location(Integer location) {
  ...
  public PublicSNP referenceAllele(String referenceAllele) {
  ...
  public PublicSNP referenceGenome(String referenceGenome) {
  ...
  public PublicSNP snpId(String snpId) {
    this.snpId = snpId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PublicSNP publicSNP = (PublicSNP) o;
    return Objects.equals(this.alternativeAlleles, publicSNP.alternativeAlleles) &&
        Objects.equals(this.chromosome, publicSNP.chromosome) &&
        Objects.equals(this.chromosomeAccession, publicSNP.chromosomeAccession) &&
        Objects.equals(this.dbsnpVersion, publicSNP.dbsnpVersion) &&
        Objects.equals(this.location, publicSNP.location) &&
        Objects.equals(this.referenceAllele, publicSNP.referenceAllele) &&
        Objects.equals(this.referenceGenome, publicSNP.referenceGenome) &&
        Objects.equals(this.snpId, publicSNP.snpId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(alternativeAlleles, chromosome, chromosomeAccession, dbsnpVersion, location, referenceAllele, referenceGenome, snpId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PublicSNP {\n");
    sb.append("    alternativeAlleles: ").append(toIndentedString(alternativeAlleles)).append("\n");
    sb.append("    chromosome: ").append(toIndentedString(chromosome)).append("\n");
    sb.append("    chromosomeAccession: ").append(toIndentedString(chromosomeAccession)).append("\n");
    ...
    sb.append("    snpId: ").append(toIndentedString(snpId)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("alternative_alleles");
    openapiFields.add("chromosome");
    openapiFields.add("chromosome_accession");
    openapiFields.add("dbsnp_version");
    openapiFields.add("location");
    openapiFields.add("reference_allele");
    openapiFields.add("reference_genome");
    openapiFields.add("snp_id");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("chromosome");
    openapiRequiredFields.add("chromosome_accession");
    openapiRequiredFields.add("dbsnp_version");
    openapiRequiredFields.add("location");
    openapiRequiredFields.add("reference_allele");
    openapiRequiredFields.add("reference_genome");
    openapiRequiredFields.add("snp_id");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PublicSNP
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PublicSNP.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PublicSNP is not found in the empty JSON string", PublicSNP.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PublicSNP.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PublicSNP` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PublicSNP.openapiRequiredFields) {
      ...
      if (jsonObj.get("alternative_alleles") != null && !jsonObj.get("alternative_alleles").isJsonNull() && !jsonObj.get("alternative_alleles").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `alternative_alleles` to be an array in the JSON string but got `%s`", jsonObj.get("alternative_alleles").toString()));
      }
      ...
      if (!jsonObj.get("chromosome_accession").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `chromosome_accession` to be a primitive type in the JSON string but got `%s`", jsonObj.get("chromosome_accession").toString()));
      }
      if (!jsonObj.get("reference_allele").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `reference_allele` to be a primitive type in the JSON string but got `%s`", jsonObj.get("reference_allele").toString()));
      }
      if (!jsonObj.get("reference_genome").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `reference_genome` to be a primitive type in the JSON string but got `%s`", jsonObj.get("reference_genome").toString()));
      }
      if (!jsonObj.get("snp_id").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `snp_id` to be a primitive type in the JSON string but got `%s`", jsonObj.get("snp_id").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PublicSNP.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PublicSNP' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PublicSNP> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PublicSNP.class));

       return (TypeAdapter<T>) new TypeAdapter<PublicSNP>() {
           @Override
           public void write(JsonWriter out, PublicSNP value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PublicSNP read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PublicSNP given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PublicSNP
   * @throws IOException if the JSON string is invalid with respect to PublicSNP
   */
  public static PublicSNP fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PublicSNP.class);
  }

  /**
   * Convert an instance of PublicSNP to an JSON string
   *
   * @return JSON string
   */
