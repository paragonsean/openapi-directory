...
public class ClientSNP {
  ...
  public static final String SERIALIZED_NAME_GENOTYPED_ALLELES = "genotyped_alleles";
  @SerializedName(SERIALIZED_NAME_GENOTYPED_ALLELES)
  private List<String> genotypedAlleles = new ArrayList<>();

  public static final String SERIALIZED_NAME_LOCATION = "location";
  @SerializedName(SERIALIZED_NAME_LOCATION)
  private Integer location;

  public static final String SERIALIZED_NAME_PHASED = "phased";
  @SerializedName(SERIALIZED_NAME_PHASED)
  ...
  public ClientSNP chromosomeAccession(String chromosomeAccession) {
  ...
  public ClientSNP genotypedAlleles(List<String> genotypedAlleles) {
    this.genotypedAlleles = genotypedAlleles;
    return this;
  }

  public ClientSNP addGenotypedAllelesItem(String genotypedAllelesItem) {
    if (this.genotypedAlleles == null) {
      this.genotypedAlleles = new ArrayList<>();
    }
    this.genotypedAlleles.add(genotypedAllelesItem);
    return this;
  }

  /**
   * A diploid genoyped allele, if available
   * @return genotypedAlleles
   */
  @javax.annotation.Nonnull
  public List<String> getGenotypedAlleles() {
    return genotypedAlleles;
  }

  public void setGenotypedAlleles(List<String> genotypedAlleles) {
    this.genotypedAlleles = genotypedAlleles;
  }


  public ClientSNP location(Integer location) {
  ...
  public ClientSNP phased(Boolean phased) {
    this.phased = phased;
    return this;
  }
  ...
  public ClientSNP referenceGenome(String referenceGenome) {
  ...
  public ClientSNP snpId(String snpId) {
    this.snpId = snpId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ClientSNP clientSNP = (ClientSNP) o;
    return Objects.equals(this.chromosomeAccession, clientSNP.chromosomeAccession) &&
        Objects.equals(this.genotypedAlleles, clientSNP.genotypedAlleles) &&
        Objects.equals(this.location, clientSNP.location) &&
        Objects.equals(this.phased, clientSNP.phased) &&
        Objects.equals(this.referenceGenome, clientSNP.referenceGenome) &&
        Objects.equals(this.snpId, clientSNP.snpId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(chromosomeAccession, genotypedAlleles, location, phased, referenceGenome, snpId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ClientSNP {\n");
    sb.append("    chromosomeAccession: ").append(toIndentedString(chromosomeAccession)).append("\n");
    sb.append("    genotypedAlleles: ").append(toIndentedString(genotypedAlleles)).append("\n");
  ...
  static {
    ...
    openapiFields.add("genotyped_alleles");
    openapiFields.add("location");
    openapiFields.add("phased");
    ...
    openapiRequiredFields.add("genotyped_alleles");
    openapiRequiredFields.add("location");
    openapiRequiredFields.add("phased");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ClientSNP
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ClientSNP.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ClientSNP is not found in the empty JSON string", ClientSNP.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ClientSNP.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ClientSNP` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ClientSNP.openapiRequiredFields) {
      ...
      if (jsonObj.get("genotyped_alleles") == null) {
        throw new IllegalArgumentException("Expected the field `linkedContent` to be an array in the JSON string but got `null`");
      } else if (!jsonObj.get("genotyped_alleles").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `genotyped_alleles` to be an array in the JSON string but got `%s`", jsonObj.get("genotyped_alleles").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ClientSNP.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ClientSNP' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ClientSNP> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ClientSNP.class));

       return (TypeAdapter<T>) new TypeAdapter<ClientSNP>() {
           @Override
           public void write(JsonWriter out, ClientSNP value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ClientSNP read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ClientSNP given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ClientSNP
   * @throws IOException if the JSON string is invalid with respect to ClientSNP
   */
  public static ClientSNP fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ClientSNP.class);
  }

  /**
   * Convert an instance of ClientSNP to an JSON string
   *
   * @return JSON string
   */
