...
import org.openapitools.client.model.CustomerName;
...
public class AccessScope {
  ...
  public AccessScope address(CustomerAddress address) {
  ...
  public AccessScope dataset(String dataset) {
  ...
  public AccessScope email(String email) {
    this.email = email;
    return this;
  }
  ...
  public AccessScope login(String login) {
    this.login = login;
    return this;
  }
  ...
  public AccessScope name(CustomerName name) {
    this.name = name;
    return this;
  }
  ...
  public AccessScope sex(String sex) {
    this.sex = sex;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AccessScope accessScope = (AccessScope) o;
    return Objects.equals(this.address, accessScope.address) &&
        Objects.equals(this.dataset, accessScope.dataset) &&
        Objects.equals(this.email, accessScope.email) &&
        Objects.equals(this.login, accessScope.login) &&
        Objects.equals(this.name, accessScope.name) &&
        Objects.equals(this.sex, accessScope.sex);
  }

  @Override
  public int hashCode() {
    return Objects.hash(address, dataset, email, login, name, sex);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AccessScope
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AccessScope.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccessScope is not found in the empty JSON string", AccessScope.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AccessScope.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AccessScope` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("name") != null && !jsonObj.get("name").isJsonNull()) {
        CustomerName.validateJsonElement(jsonObj.get("name"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccessScope.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccessScope' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccessScope> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccessScope.class));

       return (TypeAdapter<T>) new TypeAdapter<AccessScope>() {
           @Override
           public void write(JsonWriter out, AccessScope value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AccessScope read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AccessScope given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AccessScope
   * @throws IOException if the JSON string is invalid with respect to AccessScope
   */
  public static AccessScope fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccessScope.class);
  }

  /**
   * Convert an instance of AccessScope to an JSON string
   *
   * @return JSON string
   */
