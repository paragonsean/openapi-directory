...
import org.openapitools.client.model.SnpsMinRequired;
 ...
 * Product
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-10-12T12:43:50.385727-04:00[America/New_York]", comments = "Generator version: 7.9.0")
public class Product {
  public static final String SERIALIZED_NAME_AUTHORIZED_SCOPES = "authorized_scopes";
  @SerializedName(SERIALIZED_NAME_AUTHORIZED_SCOPES)
  ...
  public static final String SERIALIZED_NAME_PRODUCT_UUID = "product_uuid";
  @SerializedName(SERIALIZED_NAME_PRODUCT_UUID)
  ...
  public static final String SERIALIZED_NAME_SNPS_AUTHORIZED = "snps_authorized";
  @SerializedName(SERIALIZED_NAME_SNPS_AUTHORIZED)
  private List<String> snpsAuthorized = new ArrayList<>();

  public static final String SERIALIZED_NAME_SNPS_AUTHORIZED_ANY = "snps_authorized_any";
  @SerializedName(SERIALIZED_NAME_SNPS_AUTHORIZED_ANY)
  private Boolean snpsAuthorizedAny;

  public static final String SERIALIZED_NAME_SNPS_MIN_REQUIRED = "snps_min_required";
  @SerializedName(SERIALIZED_NAME_SNPS_MIN_REQUIRED)
  private SnpsMinRequired snpsMinRequired;

  public static final String SERIALIZED_NAME_SNPS_MIN_REQUIRED_ANY = "snps_min_required_any";
  @SerializedName(SERIALIZED_NAME_SNPS_MIN_REQUIRED_ANY)
  private Boolean snpsMinRequiredAny;

  public Product() {
  }

  public Product authorizedScopes(List<String> authorizedScopes) {
    this.authorizedScopes = authorizedScopes;
    return this;
  }

  public Product addAuthorizedScopesItem(String authorizedScopesItem) {
  ...
  public Product email(String email) {
    this.email = email;
    return this;
  }
  ...
  public Product productUuid(String productUuid) {
  ...
  public Product redirectUri(String redirectUri) {
  ...
  public Product snpsAuthorized(List<String> snpsAuthorized) {
    this.snpsAuthorized = snpsAuthorized;
    return this;
  }

  public Product addSnpsAuthorizedItem(String snpsAuthorizedItem) {
    if (this.snpsAuthorized == null) {
      this.snpsAuthorized = new ArrayList<>();
    }
    this.snpsAuthorized.add(snpsAuthorizedItem);
    return this;
  }

  /**
   * A superset of snps_min_required, containing all SNPs to which an Product has access (includes optional SNPs)
   * @return snpsAuthorized
   */
  @javax.annotation.Nonnull
  public List<String> getSnpsAuthorized() {
    return snpsAuthorized;
  }

  public void setSnpsAuthorized(List<String> snpsAuthorized) {
    this.snpsAuthorized = snpsAuthorized;
  }


  public Product snpsAuthorizedAny(Boolean snpsAuthorizedAny) {
    this.snpsAuthorizedAny = snpsAuthorizedAny;
    return this;
  }

  /**
   * A boolean value specifying if SNP set is not strict
   * @return snpsAuthorizedAny
   */
  @javax.annotation.Nonnull
  public Boolean getSnpsAuthorizedAny() {
    return snpsAuthorizedAny;
  }

  public void setSnpsAuthorizedAny(Boolean snpsAuthorizedAny) {
    this.snpsAuthorizedAny = snpsAuthorizedAny;
  }


  public Product snpsMinRequired(SnpsMinRequired snpsMinRequired) {
    this.snpsMinRequired = snpsMinRequired;
    return this;
  }

  /**
   * Get snpsMinRequired
   * @return snpsMinRequired
   */
  @javax.annotation.Nonnull
  public SnpsMinRequired getSnpsMinRequired() {
    return snpsMinRequired;
  }

  public void setSnpsMinRequired(SnpsMinRequired snpsMinRequired) {
    this.snpsMinRequired = snpsMinRequired;
  }


  public Product snpsMinRequiredAny(Boolean snpsMinRequiredAny) {
    this.snpsMinRequiredAny = snpsMinRequiredAny;
    return this;
  }

  /**
   * A boolean value specifying if SNP set is not strict
   * @return snpsMinRequiredAny
   */
  @javax.annotation.Nonnull
  public Boolean getSnpsMinRequiredAny() {
    return snpsMinRequiredAny;
  }

  public void setSnpsMinRequiredAny(Boolean snpsMinRequiredAny) {
    this.snpsMinRequiredAny = snpsMinRequiredAny;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.authorizedScopes, product.authorizedScopes) &&
        Objects.equals(this.email, product.email) &&
        Objects.equals(this.productUuid, product.productUuid) &&
        Objects.equals(this.redirectUri, product.redirectUri) &&
        Objects.equals(this.snpsAuthorized, product.snpsAuthorized) &&
        Objects.equals(this.snpsAuthorizedAny, product.snpsAuthorizedAny) &&
        Objects.equals(this.snpsMinRequired, product.snpsMinRequired) &&
        Objects.equals(this.snpsMinRequiredAny, product.snpsMinRequiredAny);
  }

  @Override
  public int hashCode() {
    return Objects.hash(authorizedScopes, email, productUuid, redirectUri, snpsAuthorized, snpsAuthorizedAny, snpsMinRequired, snpsMinRequiredAny);
  }
  ...
  public String toString() {
    ...
    sb.append("    snpsAuthorized: ").append(toIndentedString(snpsAuthorized)).append("\n");
    sb.append("    snpsAuthorizedAny: ").append(toIndentedString(snpsAuthorizedAny)).append("\n");
    sb.append("    snpsMinRequired: ").append(toIndentedString(snpsMinRequired)).append("\n");
    sb.append("    snpsMinRequiredAny: ").append(toIndentedString(snpsMinRequiredAny)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("authorized_scopes");
    openapiFields.add("email");
    openapiFields.add("product_uuid");
    openapiFields.add("redirect_uri");
    openapiFields.add("snps_authorized");
    openapiFields.add("snps_authorized_any");
    openapiFields.add("snps_min_required");
    openapiFields.add("snps_min_required_any");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("authorized_scopes");
    openapiRequiredFields.add("product_uuid");
    openapiRequiredFields.add("snps_authorized");
    openapiRequiredFields.add("snps_authorized_any");
    openapiRequiredFields.add("snps_min_required");
    openapiRequiredFields.add("snps_min_required_any");
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("authorized_scopes") == null) {
        throw new IllegalArgumentException("Expected the field `linkedContent` to be an array in the JSON string but got `null`");
      } else if (!jsonObj.get("authorized_scopes").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `authorized_scopes` to be an array in the JSON string but got `%s`", jsonObj.get("authorized_scopes").toString()));
      }
      if ((jsonObj.get("email") != null && !jsonObj.get("email").isJsonNull()) && !jsonObj.get("email").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `email` to be a primitive type in the JSON string but got `%s`", jsonObj.get("email").toString()));
      }
      if (!jsonObj.get("product_uuid").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `product_uuid` to be a primitive type in the JSON string but got `%s`", jsonObj.get("product_uuid").toString()));
      }
      ...
      // ensure the required json array is present
      if (jsonObj.get("snps_authorized") == null) {
        throw new IllegalArgumentException("Expected the field `linkedContent` to be an array in the JSON string but got `null`");
      } else if (!jsonObj.get("snps_authorized").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `snps_authorized` to be an array in the JSON string but got `%s`", jsonObj.get("snps_authorized").toString()));
      }
      // validate the required field `snps_min_required`
      SnpsMinRequired.validateJsonElement(jsonObj.get("snps_min_required"));
  }
