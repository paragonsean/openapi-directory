...
import ClientGene from '../model/ClientGene';
import ClientSNP from '../model/ClientSNP';
import JavascriptWebToken from '../model/JavascriptWebToken';
import Product from '../model/Product';
import PublicGene from '../model/PublicGene';
import PublicSNP from '../model/PublicSNP';
import ReferenceChromosomeOverview from '../model/ReferenceChromosomeOverview';
import ReferenceGenomeOverview from '../model/ReferenceGenomeOverview';
import ReferenceSequence from '../model/ReferenceSequence';
import ReportCredentials from '../model/ReportCredentials';
import ReportFile from '../model/ReportFile';

/**
* LumminaryAPISpec service.
* @module api/LumminaryAPISpecApi
* @version 1.0
*/
export default class LumminaryAPISpecApi {

    /**
    * Constructs a new LumminaryAPISpecApi. 
    * @alias module:api/LumminaryAPISpecApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getAuthorizationsQueue operation.
     * @callback module:api/LumminaryAPISpecApi~getAuthorizationsQueueCallback
     ...
     * @param {String} [seqNumStart] The first sequence number from which to fetch (the sequence number of the last processed authorization)
     * @param {String} [xFields] An optional fields mask
     * @param {module:api/LumminaryAPISpecApi~getAuthorizationsQueueCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/Authorization>}
     */
    getAuthorizationsQueue(productId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'productId' is set
      if (productId === undefined || productId === null) {
        throw new Error("Missing the required parameter 'productId' when calling getAuthorizationsQueue");
      }
      ...
      let queryParams = {
        'seq_num_start': opts['seqNumStart']
      };
      let headerParams = {
    ...
    /**
     * Callback function to receive the result of the getClientGene operation.
     * @callback module:api/LumminaryAPISpecApi~getClientGeneCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ClientGene} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} datasetId The UUID of one of the client's dataset
     * @param {String} geneSymbol The symbol of a gene to be fetched
     * @param {Object} opts Optional parameters
     * @param {String} [xFields] An optional fields mask
     * @param {module:api/LumminaryAPISpecApi~getClientGeneCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ClientGene}
     */
    getClientGene(clientId, datasetId, geneSymbol, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'clientId' is set
      if (clientId === undefined || clientId === null) {
        throw new Error("Missing the required parameter 'clientId' when calling getClientGene");
      }
      // verify the required parameter 'datasetId' is set
      if (datasetId === undefined || datasetId === null) {
        throw new Error("Missing the required parameter 'datasetId' when calling getClientGene");
      }
      // verify the required parameter 'geneSymbol' is set
      if (geneSymbol === undefined || geneSymbol === null) {
        throw new Error("Missing the required parameter 'geneSymbol' when calling getClientGene");
      }
    ...
    /**
     * Callback function to receive the result of the getClientSnp operation.
     * @callback module:api/LumminaryAPISpecApi~getClientSnpCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ClientSNP} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} clientId The UUID of the client
     * @param {String} datasetId The UUID of one of the client's dataset
     * @param {String} snpId The rsId of a SNP to be fetched
     * @param {Object} opts Optional parameters
     * @param {String} [xFields] An optional fields mask
     * @param {module:api/LumminaryAPISpecApi~getClientSnpCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ClientSNP}
     */
    getClientSnp(clientId, datasetId, snpId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'clientId' is set
      if (clientId === undefined || clientId === null) {
        throw new Error("Missing the required parameter 'clientId' when calling getClientSnp");
      }
      // verify the required parameter 'datasetId' is set
      if (datasetId === undefined || datasetId === null) {
        throw new Error("Missing the required parameter 'datasetId' when calling getClientSnp");
      }
      // verify the required parameter 'snpId' is set
      if (snpId === undefined || snpId === null) {
        throw new Error("Missing the required parameter 'snpId' when calling getClientSnp");
      }
    ...
    /**
     * Callback function to receive the result of the getClientSnpGroup operation.
     * @callback module:api/LumminaryAPISpecApi~getClientSnpGroupCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/ClientSNP>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} [xFields] An optional fields mask
     * @param {module:api/LumminaryAPISpecApi~getClientSnpGroupCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/ClientSNP>}
     */
    getClientSnpGroup(clientId, datasetId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'clientId' is set
      if (clientId === undefined || clientId === null) {
        throw new Error("Missing the required parameter 'clientId' when calling getClientSnpGroup");
      }
      // verify the required parameter 'datasetId' is set
      if (datasetId === undefined || datasetId === null) {
        throw new Error("Missing the required parameter 'datasetId' when calling getClientSnpGroup");
      }
    ...
    /**
     * Callback function to receive the result of the getGene operation.
     * @callback module:api/LumminaryAPISpecApi~getGeneCallback
     * @param {String} error Error message, if any.
     * @param {module:model/PublicGene} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */

    /**
     * Generic gene information
     * @param {String} databaseName The name of the database to search. E.g: Genbank
     * @param {String} accession The accession within the selected database
     * @param {Object} opts Optional parameters
     * @param {Number} [dbsnpBuild = 149)] The dbSNP build for which to consider snps belonging to the gene. Defaults to 149
     * @param {String} [referenceGenome = 'GRCH37P13')] The reference genome for which gene annotations will be returned. Defaults to GRCh37p13
     * @param {String} [xFields] An optional fields mask
     * @param {module:api/LumminaryAPISpecApi~getGeneCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/PublicGene}
     */
    getGene(databaseName, accession, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'databaseName' is set
      if (databaseName === undefined || databaseName === null) {
        throw new Error("Missing the required parameter 'databaseName' when calling getGene");
      }
      // verify the required parameter 'accession' is set
      if (accession === undefined || accession === null) {
        throw new Error("Missing the required parameter 'accession' when calling getGene");
      }
      ...
      let queryParams = {
        'dbsnp_build': opts['dbsnpBuild'],
        'reference_genome': opts['referenceGenome']
      };
      let headerParams = {
        'X-Fields': opts['xFields']
      };
     ...
     * @callback module:api/LumminaryAPISpecApi~getProductCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Object} opts Optional parameters
     * @param {String} [xFields] An optional fields mask
     * @param {module:api/LumminaryAPISpecApi~getProductCallback} callback The callback function, accepting three arguments: error, data, response
    ...
    /**
     * Callback function to receive the result of the getProductAuthorization operation.
     * @callback module:api/LumminaryAPISpecApi~getProductAuthorizationCallback
     * @param {String} error Error message, if any.
    ...
    /**
     * @param {String} productId The UUID of the product
     * @param {String} authorizationId The UUID of the authorization
     * @param {Object} opts Optional parameters
     * @param {String} [xFields] An optional fields mask
     * @param {module:api/LumminaryAPISpecApi~getProductAuthorizationCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Authorization}
     */
    getProductAuthorization(productId, authorizationId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'productId' is set
      if (productId === undefined || productId === null) {
        throw new Error("Missing the required parameter 'productId' when calling getProductAuthorization");
      }
      // verify the required parameter 'authorizationId' is set
      if (authorizationId === undefined || authorizationId === null) {
        throw new Error("Missing the required parameter 'authorizationId' when calling getProductAuthorization");
      }
    ...
    /**
     * Callback function to receive the result of the getReferenceChromosome operation.
     * @callback module:api/LumminaryAPISpecApi~getReferenceChromosomeCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ReferenceSequence} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} genomeBuildAccession The accession of the reference genome
     * @param {String} chromosomeAccession The accession to the chromosome
     * @param {Number} rangeStart Location on the chromosome
     * @param {Number} rangeStop Location on the chromosome
     * @param {Object} opts Optional parameters
     * @param {String} [xFields] An optional fields mask
     * @param {module:api/LumminaryAPISpecApi~getReferenceChromosomeCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ReferenceSequence}
     */
    getReferenceChromosome(genomeBuildAccession, chromosomeAccession, rangeStart, rangeStop, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'genomeBuildAccession' is set
      if (genomeBuildAccession === undefined || genomeBuildAccession === null) {
        throw new Error("Missing the required parameter 'genomeBuildAccession' when calling getReferenceChromosome");
      }
      // verify the required parameter 'chromosomeAccession' is set
      if (chromosomeAccession === undefined || chromosomeAccession === null) {
        throw new Error("Missing the required parameter 'chromosomeAccession' when calling getReferenceChromosome");
      }
      // verify the required parameter 'rangeStart' is set
      if (rangeStart === undefined || rangeStart === null) {
        throw new Error("Missing the required parameter 'rangeStart' when calling getReferenceChromosome");
      }
      // verify the required parameter 'rangeStop' is set
      if (rangeStop === undefined || rangeStop === null) {
        throw new Error("Missing the required parameter 'rangeStop' when calling getReferenceChromosome");
      }

      let pathParams = {
        'genomeBuildAccession': genomeBuildAccession,
        'chromosomeAccession': chromosomeAccession
      };
      let queryParams = {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = ReferenceSequence;
      return this.apiClient.callApi(
    ...
    /**
     * Callback function to receive the result of the getReferenceGenome operation.
     * @callback module:api/LumminaryAPISpecApi~getReferenceGenomeCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/ReferenceChromosomeOverview>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */

    /**
     * Reference genome metadata
     * @param {String} genomeBuildAccession 
     * @param {Object} opts Optional parameters
     * @param {String} [xFields] An optional fields mask
     * @param {module:api/LumminaryAPISpecApi~getReferenceGenomeCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/ReferenceChromosomeOverview>}
     */
    getReferenceGenome(genomeBuildAccession, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'genomeBuildAccession' is set
      if (genomeBuildAccession === undefined || genomeBuildAccession === null) {
        throw new Error("Missing the required parameter 'genomeBuildAccession' when calling getReferenceGenome");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = [ReferenceChromosomeOverview];
      return this.apiClient.callApi(
    ...
    /**
     * Callback function to receive the result of the getReferenceGenomesGroup operation.
     * @callback module:api/LumminaryAPISpecApi~getReferenceGenomesGroupCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/ReferenceGenomeOverview>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} [xFields] An optional fields mask
     * @param {module:api/LumminaryAPISpecApi~getReferenceGenomesGroupCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/ReferenceGenomeOverview>}
     */
    getReferenceGenomesGroup(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = [ReferenceGenomeOverview];
      return this.apiClient.callApi(
    ...
    /**
     * Callback function to receive the result of the getReferenceSnp operation.
     * @callback module:api/LumminaryAPISpecApi~getReferenceSnpCallback
     * @param {String} error Error message, if any.
     * @param {module:model/PublicSNP} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} snpAccession The rsId of the SNP
     * @param {Object} opts Optional parameters
     * @param {Number} [dbsnpVersion = 149)] The dbSNP build. Defaults to 149
     * @param {String} [grchVersion = 'GRCH37P13')] The GRCh build on which to place snips. Defaults to GRCh37p13
     * @param {String} [xFields] An optional fields mask
     * @param {module:api/LumminaryAPISpecApi~getReferenceSnpCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/PublicSNP}
     */
    getReferenceSnp(snpAccession, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'snpAccession' is set
      if (snpAccession === undefined || snpAccession === null) {
        throw new Error("Missing the required parameter 'snpAccession' when calling getReferenceSnp");
      }

      let pathParams = {
        'snpAccession': snpAccession
      };
      let queryParams = {
        'dbsnp_version': opts['dbsnpVersion'],
        'grch_version': opts['grchVersion']
      };
      let headerParams = {
        'X-Fields': opts['xFields']
      };
    ...
    /**
     * Callback function to receive the result of the postAuthorizationResultCredentials operation.
     * @callback module:api/LumminaryAPISpecApi~postAuthorizationResultCredentialsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ReportCredentials} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} [xFields] An optional fields mask
     * @param {String} [credentialsUsername] Credentials for accessing the result. Includes password, username and url
     * @param {String} [credentialsPassword] Credentials for accessing the result. Includes password, username and url
     * @param {String} [reportUrl] Credentials for accessing the result. Includes password, username and url
     * @param {module:api/LumminaryAPISpecApi~postAuthorizationResultCredentialsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ReportCredentials}
     */
    postAuthorizationResultCredentials(productId, authorizationId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'productId' is set
      if (productId === undefined || productId === null) {
        throw new Error("Missing the required parameter 'productId' when calling postAuthorizationResultCredentials");
      }
      // verify the required parameter 'authorizationId' is set
      if (authorizationId === undefined || authorizationId === null) {
        throw new Error("Missing the required parameter 'authorizationId' when calling postAuthorizationResultCredentials");
      }
      ...
      let formParams = {
        'credentials_username': opts['credentialsUsername'],
        'credentials_password': opts['credentialsPassword'],
      ...
      let accepts = ['application/json'];
      let returnType = ReportCredentials;
      return this.apiClient.callApi(
    ...
    /**
     * Callback function to receive the result of the postAuthorizationResultFile operation.
     * @callback module:api/LumminaryAPISpecApi~postAuthorizationResultFileCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ReportFile} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} authorizationId The UUID of the authorization
     * @param {Object} opts Optional parameters
     * @param {String} [originalFilename] Optional original filename for the report. If not provided, the filename of uploaded file will be used
     * @param {String} [xFields] An optional fields mask
     * @param {File} [fileReport] A binary file (e.g. pdf) that contains the result of the authorization
     * @param {module:api/LumminaryAPISpecApi~postAuthorizationResultFileCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ReportFile}
     */
    postAuthorizationResultFile(productId, authorizationId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'productId' is set
      if (productId === undefined || productId === null) {
        throw new Error("Missing the required parameter 'productId' when calling postAuthorizationResultFile");
      }
      // verify the required parameter 'authorizationId' is set
      if (authorizationId === undefined || authorizationId === null) {
        throw new Error("Missing the required parameter 'authorizationId' when calling postAuthorizationResultFile");
      }
      ...
      let formParams = {
        'file_report': opts['fileReport']
      };

      let authNames = ['Bearer'];
      let contentTypes = ['multipart/form-data'];
      let accepts = ['application/json'];
      let returnType = ReportFile;
      return this.apiClient.callApi(
    ...
    /**
     * Callback function to receive the result of the postClientSnpGroup operation.
     * @callback module:api/LumminaryAPISpecApi~postClientSnpGroupCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/ClientSNP>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} clientId The UUID of the client
     * @param {String} datasetId The UUID of one of the client's dataset
     * @param {String} snps JSON-encoded list of snps to be fetched
     * @param {Object} opts Optional parameters
     * @param {String} [xFields] An optional fields mask
     * @param {module:api/LumminaryAPISpecApi~postClientSnpGroupCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/ClientSNP>}
     */
    postClientSnpGroup(clientId, datasetId, snps, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'clientId' is set
      if (clientId === undefined || clientId === null) {
        throw new Error("Missing the required parameter 'clientId' when calling postClientSnpGroup");
      }
      // verify the required parameter 'datasetId' is set
      if (datasetId === undefined || datasetId === null) {
        throw new Error("Missing the required parameter 'datasetId' when calling postClientSnpGroup");
      }
      // verify the required parameter 'snps' is set
      if (snps === undefined || snps === null) {
        throw new Error("Missing the required parameter 'snps' when calling postClientSnpGroup");
      }
    ...
    /**
     * Callback function to receive the result of the postJwtAuth operation.
     * @callback module:api/LumminaryAPISpecApi~postJwtAuthCallback
     * @param {String} error Error message, if any.
     * @param {module:model/JavascriptWebToken} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} username The email for a Client, or the API for a partner product
     * @param {String} password The passowrd for a Client, or the API key for a service
     * @param {String} role The role for which authentication will be made. Value : role_product
     * @param {Object} opts Optional parameters
     * @param {String} [xFields] An optional fields mask
     * @param {module:api/LumminaryAPISpecApi~postJwtAuthCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/JavascriptWebToken}
     */
    postJwtAuth(username, password, role, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'username' is set
      if (username === undefined || username === null) {
        throw new Error("Missing the required parameter 'username' when calling postJwtAuth");
      }
      // verify the required parameter 'password' is set
      if (password === undefined || password === null) {
        throw new Error("Missing the required parameter 'password' when calling postJwtAuth");
      }
      // verify the required parameter 'role' is set
      if (role === undefined || role === null) {
        throw new Error("Missing the required parameter 'role' when calling postJwtAuth");
      }
      ...
      let contentTypes = ['application/x-www-form-urlencoded', 'multipart/form-data'];
      let accepts = ['application/json'];
      let returnType = JavascriptWebToken;
      return this.apiClient.callApi(
        '/auth/jwt', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
    ...
    /**
     * Callback function to receive the result of the postProductAuthorization operation.
     * @callback module:api/LumminaryAPISpecApi~postProductAuthorizationCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} productId The UUID of the product
     * @param {String} authorizationId The UUID of the authorization
     * @param {module:api/LumminaryAPISpecApi~postProductAuthorizationCallback} callback The callback function, accepting three arguments: error, data, response
     */
    postProductAuthorization(productId, authorizationId, callback) {
      let postBody = null;
      // verify the required parameter 'productId' is set
      if (productId === undefined || productId === null) {
        throw new Error("Missing the required parameter 'productId' when calling postProductAuthorization");
      }
      // verify the required parameter 'authorizationId' is set
      if (authorizationId === undefined || authorizationId === null) {
        throw new Error("Missing the required parameter 'authorizationId' when calling postProductAuthorization");
      }
    ...
    /**
     * Callback function to receive the result of the postProductAuthorizationUnfulfillable operation.
     * @callback module:api/LumminaryAPISpecApi~postProductAuthorizationUnfulfillableCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} productId The UUID of the product
     * @param {String} authorizationId The UUID of the authorization
     * @param {module:api/LumminaryAPISpecApi~postProductAuthorizationUnfulfillableCallback} callback The callback function, accepting three arguments: error, data, response
     */
    postProductAuthorizationUnfulfillable(productId, authorizationId, callback) {
      let postBody = null;
      // verify the required parameter 'productId' is set
      if (productId === undefined || productId === null) {
        throw new Error("Missing the required parameter 'productId' when calling postProductAuthorizationUnfulfillable");
      }
      // verify the required parameter 'authorizationId' is set
      if (authorizationId === undefined || authorizationId === null) {
        throw new Error("Missing the required parameter 'authorizationId' when calling postProductAuthorizationUnfulfillable");
      }
