...
LumminaryApi - JavaScript client for lumminary_api
# Introduction
...
```shell
npm install lumminary_api --save
```
...
To use the link you just defined in your project, switch to the directory you want to use your lumminary_api from, and run:
...
```javascript
var LumminaryApi = require('lumminary_api');

var defaultClient = LumminaryApi.ApiClient.instance;
...
var api = new LumminaryApi.LumminaryAPISpecApi()
var productId = "productId_example"; // {String} The UUID of the product
var opts = {
...
api.getAuthorizationsQueue(productId, opts, callback);
...
------------ | ------------- | ------------- | -------------
*LumminaryApi.LumminaryAPISpecApi* | [**getAuthorizationsQueue**](docs/LumminaryAPISpecApi.md#getAuthorizationsQueue) | **GET** /products/{productId}/authorizations | 
*LumminaryApi.LumminaryAPISpecApi* | [**getClientGene**](docs/LumminaryAPISpecApi.md#getClientGene) | **GET** /clients/{clientId}/datasets/{datasetId}/genes/{geneSymbol} | Get gene by symbol
*LumminaryApi.LumminaryAPISpecApi* | [**getClientSnp**](docs/LumminaryAPISpecApi.md#getClientSnp) | **GET** /clients/{clientId}/datasets/{datasetId}/snps/{snpId} | Get SNP information
*LumminaryApi.LumminaryAPISpecApi* | [**getClientSnpGroup**](docs/LumminaryAPISpecApi.md#getClientSnpGroup) | **GET** /clients/{clientId}/datasets/{datasetId}/snps/ | 
*LumminaryApi.LumminaryAPISpecApi* | [**getGene**](docs/LumminaryAPISpecApi.md#getGene) | **GET** /reference/genes/databases/{databaseName}/accessions/{accession} | Generic gene information
*LumminaryApi.LumminaryAPISpecApi* | [**getProduct**](docs/LumminaryAPISpecApi.md#getProduct) | **GET** /products/{productId} | Get product details
*LumminaryApi.LumminaryAPISpecApi* | [**getProductAuthorization**](docs/LumminaryAPISpecApi.md#getProductAuthorization) | **GET** /products/{productId}/authorizations/{authorizationId} | 
*LumminaryApi.LumminaryAPISpecApi* | [**getReferenceChromosome**](docs/LumminaryAPISpecApi.md#getReferenceChromosome) | **GET** /reference/genomes/{genomeBuildAccession}/chromosomes/{chromosomeAccession} | Sequence for a region of the reference genome
*LumminaryApi.LumminaryAPISpecApi* | [**getReferenceGenome**](docs/LumminaryAPISpecApi.md#getReferenceGenome) | **GET** /reference/genomes/{genomeBuildAccession}/chromosomes | Reference genome metadata
*LumminaryApi.LumminaryAPISpecApi* | [**getReferenceGenomesGroup**](docs/LumminaryAPISpecApi.md#getReferenceGenomesGroup) | **GET** /reference/genomes/ | Reference genome builds
*LumminaryApi.LumminaryAPISpecApi* | [**getReferenceSnp**](docs/LumminaryAPISpecApi.md#getReferenceSnp) | **GET** /reference/snps/{snpAccession} | Reference SNP data
*LumminaryApi.LumminaryAPISpecApi* | [**postAuthorizationResultCredentials**](docs/LumminaryAPISpecApi.md#postAuthorizationResultCredentials) | **POST** /products/{productId}/authorizations/{authorizationId}/credentials | Provide a result for the authorization
*LumminaryApi.LumminaryAPISpecApi* | [**postAuthorizationResultFile**](docs/LumminaryAPISpecApi.md#postAuthorizationResultFile) | **POST** /products/{productId}/authorizations/{authorizationId}/file | Provide a file result to the authorization, e
*LumminaryApi.LumminaryAPISpecApi* | [**postClientSnpGroup**](docs/LumminaryAPISpecApi.md#postClientSnpGroup) | **POST** /clients/{clientId}/datasets/{datasetId}/snps/ | Get a large group of SNPs
*LumminaryApi.LumminaryAPISpecApi* | [**postJwtAuth**](docs/LumminaryAPISpecApi.md#postJwtAuth) | **POST** /auth/jwt | General-purpose authentication
*LumminaryApi.LumminaryAPISpecApi* | [**postProductAuthorization**](docs/LumminaryAPISpecApi.md#postProductAuthorization) | **POST** /products/{productId}/authorizations/{authorizationId} | Signal that processing is complete, without uploading any result
*LumminaryApi.LumminaryAPISpecApi* | [**postProductAuthorizationUnfulfillable**](docs/LumminaryAPISpecApi.md#postProductAuthorizationUnfulfillable) | **POST** /products/{productId}/authorizations/{authorizationId}/unfulfillable | Catch-all Authorization state, for authorizations that passed all verifications and should reach the partner Product, but cannot be fulfilled for various reasons


## Documentation for Models

 - [LumminaryApi.AccessScope](docs/AccessScope.md)
 - [LumminaryApi.Authorization](docs/Authorization.md)
 - [LumminaryApi.ClientGene](docs/ClientGene.md)
 - [LumminaryApi.ClientSNP](docs/ClientSNP.md)
 - [LumminaryApi.CustomerAddress](docs/CustomerAddress.md)
 - [LumminaryApi.CustomerName](docs/CustomerName.md)
 - [LumminaryApi.FileLocation](docs/FileLocation.md)
 - [LumminaryApi.JavascriptWebToken](docs/JavascriptWebToken.md)
 - [LumminaryApi.MolecularLocation](docs/MolecularLocation.md)
 - [LumminaryApi.Product](docs/Product.md)
 - [LumminaryApi.PublicGene](docs/PublicGene.md)
 - [LumminaryApi.PublicSNP](docs/PublicSNP.md)
 - [LumminaryApi.ReferenceChromosomeOverview](docs/ReferenceChromosomeOverview.md)
 - [LumminaryApi.ReferenceGenomeOverview](docs/ReferenceGenomeOverview.md)
 - [LumminaryApi.ReferenceSequence](docs/ReferenceSequence.md)
 - [LumminaryApi.ReportCredentials](docs/ReportCredentials.md)
 - [LumminaryApi.ReportFile](docs/ReportFile.md)
 - [LumminaryApi.SnpsMinRequired](docs/SnpsMinRequired.md)
