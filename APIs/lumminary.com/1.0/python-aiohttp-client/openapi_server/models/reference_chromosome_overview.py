...
class ReferenceChromosomeOverview(Model):
    ...
    def __init__(self, reference_accession: str=None):
        """ReferenceChromosomeOverview - a model defined in OpenAPI

        :param reference_accession: The reference_accession of this ReferenceChromosomeOverview.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ReferenceChromosomeOverview':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ReferenceChromosomeOverview of this ReferenceChromosomeOverview.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def reference_accession(self):
        """Gets the reference_accession of this ReferenceChromosomeOverview.

        The versioned reference chromosome accession

        :return: The reference_accession of this ReferenceChromosomeOverview.
        :rtype: str
        """
