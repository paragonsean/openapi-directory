...
#ifndef OAI_OAILumminaryAPISpecApi_H
#define OAI_OAILumminaryAPISpecApi_H
...
#include "OAIClientGene.h"
#include "OAIClientSNP.h"
#include "OAIHttpFileElement.h"
#include "OAIJavascriptWebToken.h"
#include "OAIProduct.h"
#include "OAIPublicGene.h"
#include "OAIPublicSNP.h"
#include "OAIReferenceChromosomeOverview.h"
#include "OAIReferenceGenomeOverview.h"
#include "OAIReferenceSequence.h"
#include "OAIReportCredentials.h"
#include "OAIReportFile.h"
#include <QString>
...
class OAILumminaryAPISpecApi : public QObject {
    Q_OBJECT

public:
    OAILumminaryAPISpecApi(const int timeOut = 0);
    ~OAILumminaryAPISpecApi();
    ...
    * @param[in]  seq_num_start QString [optional]
    * @param[in]  x_fields QString [optional]
    */
    virtual void getAuthorizationsQueue(const QString &product_id, const ::OpenAPI::OptionalParam<QString> &seq_num_start = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_fields = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  client_id QString [required]
    * @param[in]  dataset_id QString [required]
    * @param[in]  gene_symbol QString [required]
    * @param[in]  x_fields QString [optional]
    */
    virtual void getClientGene(const QString &client_id, const QString &dataset_id, const QString &gene_symbol, const ::OpenAPI::OptionalParam<QString> &x_fields = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  client_id QString [required]
    * @param[in]  dataset_id QString [required]
    * @param[in]  snp_id QString [required]
    * @param[in]  x_fields QString [optional]
    */
    virtual void getClientSnp(const QString &client_id, const QString &dataset_id, const QString &snp_id, const ::OpenAPI::OptionalParam<QString> &x_fields = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  x_fields QString [optional]
    */
    virtual void getClientSnpGroup(const QString &client_id, const QString &dataset_id, const ::OpenAPI::OptionalParam<QString> &x_fields = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  database_name QString [required]
    * @param[in]  accession QString [required]
    * @param[in]  dbsnp_build qint32 [optional]
    * @param[in]  reference_genome QString [optional]
    * @param[in]  x_fields QString [optional]
    */
    virtual void getGene(const QString &database_name, const QString &accession, const ::OpenAPI::OptionalParam<qint32> &dbsnp_build = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &reference_genome = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_fields = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  product_id QString [required]
    * @param[in]  x_fields QString [optional]
    */
    virtual void getProduct(const QString &product_id, const ::OpenAPI::OptionalParam<QString> &x_fields = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  product_id QString [required]
    * @param[in]  authorization_id QString [required]
    * @param[in]  x_fields QString [optional]
    */
    virtual void getProductAuthorization(const QString &product_id, const QString &authorization_id, const ::OpenAPI::OptionalParam<QString> &x_fields = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  genome_build_accession QString [required]
    * @param[in]  chromosome_accession QString [required]
    * @param[in]  range_start qint32 [required]
    * @param[in]  range_stop qint32 [required]
    * @param[in]  x_fields QString [optional]
    */
    virtual void getReferenceChromosome(const QString &genome_build_accession, const QString &chromosome_accession, const qint32 &range_start, const qint32 &range_stop, const ::OpenAPI::OptionalParam<QString> &x_fields = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  genome_build_accession QString [required]
    * @param[in]  x_fields QString [optional]
    */
    virtual void getReferenceGenome(const QString &genome_build_accession, const ::OpenAPI::OptionalParam<QString> &x_fields = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  x_fields QString [optional]
    */
    virtual void getReferenceGenomesGroup(const ::OpenAPI::OptionalParam<QString> &x_fields = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  snp_accession QString [required]
    * @param[in]  dbsnp_version qint32 [optional]
    * @param[in]  grch_version QString [optional]
    * @param[in]  x_fields QString [optional]
    */
    virtual void getReferenceSnp(const QString &snp_accession, const ::OpenAPI::OptionalParam<qint32> &dbsnp_version = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &grch_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_fields = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  product_id QString [required]
    * @param[in]  authorization_id QString [required]
    * @param[in]  x_fields QString [optional]
    * @param[in]  credentials_username QString [optional]
    * @param[in]  credentials_password QString [optional]
    * @param[in]  report_url QString [optional]
    */
    virtual void postAuthorizationResultCredentials(const QString &product_id, const QString &authorization_id, const ::OpenAPI::OptionalParam<QString> &x_fields = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &credentials_username = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &credentials_password = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &report_url = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  product_id QString [required]
    * @param[in]  authorization_id QString [required]
    * @param[in]  original_filename QString [optional]
    * @param[in]  x_fields QString [optional]
    * @param[in]  file_report OAIHttpFileElement [optional]
    */
    virtual void postAuthorizationResultFile(const QString &product_id, const QString &authorization_id, const ::OpenAPI::OptionalParam<QString> &original_filename = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_fields = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAIHttpFileElement> &file_report = ::OpenAPI::OptionalParam<OAIHttpFileElement>());

    /**
    * @param[in]  client_id QString [required]
    * @param[in]  dataset_id QString [required]
    * @param[in]  snps QString [required]
    * @param[in]  x_fields QString [optional]
    */
    virtual void postClientSnpGroup(const QString &client_id, const QString &dataset_id, const QString &snps, const ::OpenAPI::OptionalParam<QString> &x_fields = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  x_fields QString [optional]
    */
    virtual void postJwtAuth(const QString &username, const QString &password, const QString &role, const ::OpenAPI::OptionalParam<QString> &x_fields = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  product_id QString [required]
    * @param[in]  authorization_id QString [required]
    */
    virtual void postProductAuthorization(const QString &product_id, const QString &authorization_id);

    /**
    * @param[in]  product_id QString [required]
    * @param[in]  authorization_id QString [required]
    */
    virtual void postProductAuthorizationUnfulfillable(const QString &product_id, const QString &authorization_id);
...
private:
    ...
    void getAuthorizationsQueueCallback(OAIHttpRequestWorker *worker);
    void getClientGeneCallback(OAIHttpRequestWorker *worker);
    void getClientSnpCallback(OAIHttpRequestWorker *worker);
    void getClientSnpGroupCallback(OAIHttpRequestWorker *worker);
    void getGeneCallback(OAIHttpRequestWorker *worker);
    void getProductCallback(OAIHttpRequestWorker *worker);
    void getProductAuthorizationCallback(OAIHttpRequestWorker *worker);
    void getReferenceChromosomeCallback(OAIHttpRequestWorker *worker);
    void getReferenceGenomeCallback(OAIHttpRequestWorker *worker);
    void getReferenceGenomesGroupCallback(OAIHttpRequestWorker *worker);
    void getReferenceSnpCallback(OAIHttpRequestWorker *worker);
    void postAuthorizationResultCredentialsCallback(OAIHttpRequestWorker *worker);
    void postAuthorizationResultFileCallback(OAIHttpRequestWorker *worker);
    void postClientSnpGroupCallback(OAIHttpRequestWorker *worker);
    void postJwtAuthCallback(OAIHttpRequestWorker *worker);
    void postProductAuthorizationCallback(OAIHttpRequestWorker *worker);
    void postProductAuthorizationUnfulfillableCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void getAuthorizationsQueueSignal(QList<OAIAuthorization> summary);
    void getClientGeneSignal(OAIClientGene summary);
    void getClientSnpSignal(OAIClientSNP summary);
    void getClientSnpGroupSignal(QList<OAIClientSNP> summary);
    void getGeneSignal(OAIPublicGene summary);
    void getProductSignal(OAIProduct summary);
    void getProductAuthorizationSignal(OAIAuthorization summary);
    void getReferenceChromosomeSignal(OAIReferenceSequence summary);
    void getReferenceGenomeSignal(QList<OAIReferenceChromosomeOverview> summary);
    void getReferenceGenomesGroupSignal(QList<OAIReferenceGenomeOverview> summary);
    void getReferenceSnpSignal(OAIPublicSNP summary);
    void postAuthorizationResultCredentialsSignal(OAIReportCredentials summary);
    void postAuthorizationResultFileSignal(OAIReportFile summary);
    void postClientSnpGroupSignal(QList<OAIClientSNP> summary);
    void postJwtAuthSignal(OAIJavascriptWebToken summary);
    void postProductAuthorizationSignal();
    void postProductAuthorizationUnfulfillableSignal();


    void getAuthorizationsQueueSignalFull(OAIHttpRequestWorker *worker, QList<OAIAuthorization> summary);
    void getClientGeneSignalFull(OAIHttpRequestWorker *worker, OAIClientGene summary);
    void getClientSnpSignalFull(OAIHttpRequestWorker *worker, OAIClientSNP summary);
    void getClientSnpGroupSignalFull(OAIHttpRequestWorker *worker, QList<OAIClientSNP> summary);
    void getGeneSignalFull(OAIHttpRequestWorker *worker, OAIPublicGene summary);
    void getProductSignalFull(OAIHttpRequestWorker *worker, OAIProduct summary);
    void getProductAuthorizationSignalFull(OAIHttpRequestWorker *worker, OAIAuthorization summary);
    void getReferenceChromosomeSignalFull(OAIHttpRequestWorker *worker, OAIReferenceSequence summary);
    void getReferenceGenomeSignalFull(OAIHttpRequestWorker *worker, QList<OAIReferenceChromosomeOverview> summary);
    void getReferenceGenomesGroupSignalFull(OAIHttpRequestWorker *worker, QList<OAIReferenceGenomeOverview> summary);
    void getReferenceSnpSignalFull(OAIHttpRequestWorker *worker, OAIPublicSNP summary);
    void postAuthorizationResultCredentialsSignalFull(OAIHttpRequestWorker *worker, OAIReportCredentials summary);
    void postAuthorizationResultFileSignalFull(OAIHttpRequestWorker *worker, OAIReportFile summary);
    void postClientSnpGroupSignalFull(OAIHttpRequestWorker *worker, QList<OAIClientSNP> summary);
    void postJwtAuthSignalFull(OAIHttpRequestWorker *worker, OAIJavascriptWebToken summary);
    void postProductAuthorizationSignalFull(OAIHttpRequestWorker *worker);
    void postProductAuthorizationUnfulfillableSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use getAuthorizationsQueueSignalError() instead")
    void getAuthorizationsQueueSignalE(QList<OAIAuthorization> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getAuthorizationsQueueSignalError(QList<OAIAuthorization> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getClientGeneSignalError() instead")
    void getClientGeneSignalE(OAIClientGene summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getClientGeneSignalError(OAIClientGene summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getClientSnpSignalError() instead")
    void getClientSnpSignalE(OAIClientSNP summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getClientSnpSignalError(OAIClientSNP summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getClientSnpGroupSignalError() instead")
    void getClientSnpGroupSignalE(QList<OAIClientSNP> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getClientSnpGroupSignalError(QList<OAIClientSNP> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getGeneSignalError() instead")
    void getGeneSignalE(OAIPublicGene summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getGeneSignalError(OAIPublicGene summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use getProductAuthorizationSignalError() instead")
    void getProductAuthorizationSignalE(OAIAuthorization summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getProductAuthorizationSignalError(OAIAuthorization summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getReferenceChromosomeSignalError() instead")
    void getReferenceChromosomeSignalE(OAIReferenceSequence summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getReferenceChromosomeSignalError(OAIReferenceSequence summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getReferenceGenomeSignalError() instead")
    void getReferenceGenomeSignalE(QList<OAIReferenceChromosomeOverview> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getReferenceGenomeSignalError(QList<OAIReferenceChromosomeOverview> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getReferenceGenomesGroupSignalError() instead")
    void getReferenceGenomesGroupSignalE(QList<OAIReferenceGenomeOverview> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getReferenceGenomesGroupSignalError(QList<OAIReferenceGenomeOverview> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getReferenceSnpSignalError() instead")
    void getReferenceSnpSignalE(OAIPublicSNP summary, QNetworkReply::NetworkError error_type, QString error_str);
    void getReferenceSnpSignalError(OAIPublicSNP summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use postAuthorizationResultCredentialsSignalError() instead")
    void postAuthorizationResultCredentialsSignalE(OAIReportCredentials summary, QNetworkReply::NetworkError error_type, QString error_str);
    void postAuthorizationResultCredentialsSignalError(OAIReportCredentials summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use postAuthorizationResultFileSignalError() instead")
    void postAuthorizationResultFileSignalE(OAIReportFile summary, QNetworkReply::NetworkError error_type, QString error_str);
    void postAuthorizationResultFileSignalError(OAIReportFile summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use postClientSnpGroupSignalError() instead")
    void postClientSnpGroupSignalE(QList<OAIClientSNP> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void postClientSnpGroupSignalError(QList<OAIClientSNP> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use postJwtAuthSignalError() instead")
    void postJwtAuthSignalE(OAIJavascriptWebToken summary, QNetworkReply::NetworkError error_type, QString error_str);
    void postJwtAuthSignalError(OAIJavascriptWebToken summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use postProductAuthorizationSignalError() instead")
    void postProductAuthorizationSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void postProductAuthorizationSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use postProductAuthorizationUnfulfillableSignalError() instead")
    void postProductAuthorizationUnfulfillableSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void postProductAuthorizationUnfulfillableSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use getAuthorizationsQueueSignalErrorFull() instead")
    void getAuthorizationsQueueSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getAuthorizationsQueueSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getClientGeneSignalErrorFull() instead")
    void getClientGeneSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getClientGeneSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getClientSnpSignalErrorFull() instead")
    void getClientSnpSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getClientSnpSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getClientSnpGroupSignalErrorFull() instead")
    void getClientSnpGroupSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getClientSnpGroupSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getGeneSignalErrorFull() instead")
    void getGeneSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getGeneSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use getProductAuthorizationSignalErrorFull() instead")
    void getProductAuthorizationSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getProductAuthorizationSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getReferenceChromosomeSignalErrorFull() instead")
    void getReferenceChromosomeSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getReferenceChromosomeSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getReferenceGenomeSignalErrorFull() instead")
    void getReferenceGenomeSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getReferenceGenomeSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getReferenceGenomesGroupSignalErrorFull() instead")
    void getReferenceGenomesGroupSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getReferenceGenomesGroupSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use getReferenceSnpSignalErrorFull() instead")
    void getReferenceSnpSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void getReferenceSnpSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use postAuthorizationResultCredentialsSignalErrorFull() instead")
    void postAuthorizationResultCredentialsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void postAuthorizationResultCredentialsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use postAuthorizationResultFileSignalErrorFull() instead")
    void postAuthorizationResultFileSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void postAuthorizationResultFileSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use postClientSnpGroupSignalErrorFull() instead")
    void postClientSnpGroupSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void postClientSnpGroupSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use postJwtAuthSignalErrorFull() instead")
    void postJwtAuthSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void postJwtAuthSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use postProductAuthorizationSignalErrorFull() instead")
    void postProductAuthorizationSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void postProductAuthorizationSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use postProductAuthorizationUnfulfillableSignalErrorFull() instead")
    void postProductAuthorizationUnfulfillableSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void postProductAuthorizationUnfulfillableSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
