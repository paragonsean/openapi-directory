...
OAIPublicSNP::OAIPublicSNP(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPublicSNP::OAIPublicSNP() {
    this->initializeModel();
}

OAIPublicSNP::~OAIPublicSNP() {}

void OAIPublicSNP::initializeModel() {

    m_alternative_alleles_isSet = false;
    m_alternative_alleles_isValid = false;

    m_chromosome_isSet = false;
    m_chromosome_isValid = false;

    m_chromosome_accession_isSet = false;
    m_chromosome_accession_isValid = false;
    ...
    m_reference_allele_isSet = false;
    m_reference_allele_isValid = false;

    m_reference_genome_isSet = false;
    m_reference_genome_isValid = false;

    m_snp_id_isSet = false;
    m_snp_id_isValid = false;
}

void OAIPublicSNP::fromJson(QString jsonString) {
...
void OAIPublicSNP::fromJsonObject(QJsonObject json) {

    m_alternative_alleles_isValid = ::OpenAPI::fromJsonValue(m_alternative_alleles, json[QString("alternative_alleles")]);
    m_alternative_alleles_isSet = !json[QString("alternative_alleles")].isNull() && m_alternative_alleles_isValid;
    ...
    m_chromosome_accession_isValid = ::OpenAPI::fromJsonValue(m_chromosome_accession, json[QString("chromosome_accession")]);
    m_chromosome_accession_isSet = !json[QString("chromosome_accession")].isNull() && m_chromosome_accession_isValid;

    m_dbsnp_version_isValid = ::OpenAPI::fromJsonValue(m_dbsnp_version, json[QString("dbsnp_version")]);
    m_dbsnp_version_isSet = !json[QString("dbsnp_version")].isNull() && m_dbsnp_version_isValid;

    m_location_isValid = ::OpenAPI::fromJsonValue(m_location, json[QString("location")]);
    m_location_isSet = !json[QString("location")].isNull() && m_location_isValid;

    m_reference_allele_isValid = ::OpenAPI::fromJsonValue(m_reference_allele, json[QString("reference_allele")]);
    m_reference_allele_isSet = !json[QString("reference_allele")].isNull() && m_reference_allele_isValid;

    m_reference_genome_isValid = ::OpenAPI::fromJsonValue(m_reference_genome, json[QString("reference_genome")]);
    m_reference_genome_isSet = !json[QString("reference_genome")].isNull() && m_reference_genome_isValid;

    m_snp_id_isValid = ::OpenAPI::fromJsonValue(m_snp_id, json[QString("snp_id")]);
    m_snp_id_isSet = !json[QString("snp_id")].isNull() && m_snp_id_isValid;
}

QString OAIPublicSNP::asJson() const {
...
QJsonObject OAIPublicSNP::asJsonObject() const {
    QJsonObject obj;
    if (m_alternative_alleles.size() > 0) {
        obj.insert(QString("alternative_alleles"), ::OpenAPI::toJsonValue(m_alternative_alleles));
    }
    if (m_chromosome_isSet) {
        obj.insert(QString("chromosome"), ::OpenAPI::toJsonValue(m_chromosome));
    }
    if (m_chromosome_accession_isSet) {
        obj.insert(QString("chromosome_accession"), ::OpenAPI::toJsonValue(m_chromosome_accession));
    }
    if (m_dbsnp_version_isSet) {
        obj.insert(QString("dbsnp_version"), ::OpenAPI::toJsonValue(m_dbsnp_version));
    }
    if (m_location_isSet) {
        obj.insert(QString("location"), ::OpenAPI::toJsonValue(m_location));
    }
    if (m_reference_allele_isSet) {
        obj.insert(QString("reference_allele"), ::OpenAPI::toJsonValue(m_reference_allele));
    }
    if (m_reference_genome_isSet) {
        obj.insert(QString("reference_genome"), ::OpenAPI::toJsonValue(m_reference_genome));
    }
    if (m_snp_id_isSet) {
        obj.insert(QString("snp_id"), ::OpenAPI::toJsonValue(m_snp_id));
    }
    return obj;
}

QList<QString> OAIPublicSNP::getAlternativeAlleles() const {
    return m_alternative_alleles;
}
void OAIPublicSNP::setAlternativeAlleles(const QList<QString> &alternative_alleles) {
    m_alternative_alleles = alternative_alleles;
    m_alternative_alleles_isSet = true;
}

bool OAIPublicSNP::is_alternative_alleles_Set() const{
    return m_alternative_alleles_isSet;
}

bool OAIPublicSNP::is_alternative_alleles_Valid() const{
    return m_alternative_alleles_isValid;
}

QString OAIPublicSNP::getChromosome() const {
    return m_chromosome;
}
void OAIPublicSNP::setChromosome(const QString &chromosome) {
    m_chromosome = chromosome;
    m_chromosome_isSet = true;
}

bool OAIPublicSNP::is_chromosome_Set() const{
    return m_chromosome_isSet;
}

bool OAIPublicSNP::is_chromosome_Valid() const{
    return m_chromosome_isValid;
}

QString OAIPublicSNP::getChromosomeAccession() const {
    return m_chromosome_accession;
}
void OAIPublicSNP::setChromosomeAccession(const QString &chromosome_accession) {
    m_chromosome_accession = chromosome_accession;
    m_chromosome_accession_isSet = true;
}

bool OAIPublicSNP::is_chromosome_accession_Set() const{
    return m_chromosome_accession_isSet;
}

bool OAIPublicSNP::is_chromosome_accession_Valid() const{
    return m_chromosome_accession_isValid;
}

qint32 OAIPublicSNP::getDbsnpVersion() const {
    return m_dbsnp_version;
}
void OAIPublicSNP::setDbsnpVersion(const qint32 &dbsnp_version) {
    m_dbsnp_version = dbsnp_version;
    m_dbsnp_version_isSet = true;
}

bool OAIPublicSNP::is_dbsnp_version_Set() const{
    return m_dbsnp_version_isSet;
}

bool OAIPublicSNP::is_dbsnp_version_Valid() const{
    return m_dbsnp_version_isValid;
}

qint32 OAIPublicSNP::getLocation() const {
    return m_location;
}
void OAIPublicSNP::setLocation(const qint32 &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAIPublicSNP::is_location_Set() const{
    return m_location_isSet;
}

bool OAIPublicSNP::is_location_Valid() const{
    return m_location_isValid;
}

QString OAIPublicSNP::getReferenceAllele() const {
    return m_reference_allele;
}
void OAIPublicSNP::setReferenceAllele(const QString &reference_allele) {
    m_reference_allele = reference_allele;
    m_reference_allele_isSet = true;
}

bool OAIPublicSNP::is_reference_allele_Set() const{
    return m_reference_allele_isSet;
}

bool OAIPublicSNP::is_reference_allele_Valid() const{
    return m_reference_allele_isValid;
}

QString OAIPublicSNP::getReferenceGenome() const {
    return m_reference_genome;
}
void OAIPublicSNP::setReferenceGenome(const QString &reference_genome) {
    m_reference_genome = reference_genome;
    m_reference_genome_isSet = true;
}

bool OAIPublicSNP::is_reference_genome_Set() const{
    return m_reference_genome_isSet;
}

bool OAIPublicSNP::is_reference_genome_Valid() const{
    return m_reference_genome_isValid;
}

QString OAIPublicSNP::getSnpId() const {
    return m_snp_id;
}
void OAIPublicSNP::setSnpId(const QString &snp_id) {
    m_snp_id = snp_id;
    m_snp_id_isSet = true;
}

bool OAIPublicSNP::is_snp_id_Set() const{
    return m_snp_id_isSet;
}

bool OAIPublicSNP::is_snp_id_Valid() const{
    return m_snp_id_isValid;
}

bool OAIPublicSNP::isSet() const {
...
bool OAIPublicSNP::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_chromosome_isValid && m_chromosome_accession_isValid && m_dbsnp_version_isValid && m_location_isValid && m_reference_allele_isValid && m_reference_genome_isValid && m_snp_id_isValid && true;
}
