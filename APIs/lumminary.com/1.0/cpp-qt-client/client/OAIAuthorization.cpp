...
void OAIAuthorization::initializeModel() {
    ...
    m_authorization_uuid_isSet = false;
    m_authorization_uuid_isValid = false;

    m_client_uuid_isSet = false;
    m_client_uuid_isValid = false;
    ...
    m_product_uuid_isSet = false;
    m_product_uuid_isValid = false;

    m_report_credentials_isSet = false;
    m_report_credentials_isValid = false;

    m_report_files_isSet = false;
    m_report_files_isValid = false;
...
void OAIAuthorization::fromJsonObject(QJsonObject json) {
    ...
    m_authorization_uuid_isValid = ::OpenAPI::fromJsonValue(m_authorization_uuid, json[QString("authorization_uuid")]);
    m_authorization_uuid_isSet = !json[QString("authorization_uuid")].isNull() && m_authorization_uuid_isValid;

    m_client_uuid_isValid = ::OpenAPI::fromJsonValue(m_client_uuid, json[QString("client_uuid")]);
    m_client_uuid_isSet = !json[QString("client_uuid")].isNull() && m_client_uuid_isValid;
    ...
    m_product_uuid_isValid = ::OpenAPI::fromJsonValue(m_product_uuid, json[QString("product_uuid")]);
    m_product_uuid_isSet = !json[QString("product_uuid")].isNull() && m_product_uuid_isValid;

    m_report_credentials_isValid = ::OpenAPI::fromJsonValue(m_report_credentials, json[QString("report_credentials")]);
    m_report_credentials_isSet = !json[QString("report_credentials")].isNull() && m_report_credentials_isValid;

    m_report_files_isValid = ::OpenAPI::fromJsonValue(m_report_files, json[QString("report_files")]);
    m_report_files_isSet = !json[QString("report_files")].isNull() && m_report_files_isValid;
...
QJsonObject OAIAuthorization::asJsonObject() const {
    QJsonObject obj;
    if (m_authorization_uuid_isSet) {
        obj.insert(QString("authorization_uuid"), ::OpenAPI::toJsonValue(m_authorization_uuid));
    }
    if (m_client_uuid_isSet) {
        obj.insert(QString("client_uuid"), ::OpenAPI::toJsonValue(m_client_uuid));
    }
    ...
    if (m_product_uuid_isSet) {
        obj.insert(QString("product_uuid"), ::OpenAPI::toJsonValue(m_product_uuid));
    }
    if (m_report_credentials.size() > 0) {
        obj.insert(QString("report_credentials"), ::OpenAPI::toJsonValue(m_report_credentials));
    }
    if (m_report_files.size() > 0) {
        obj.insert(QString("report_files"), ::OpenAPI::toJsonValue(m_report_files));
    }
    if (m_scopes.isSet()) {
...
QString OAIAuthorization::getAuthorizationUuid() const {
    return m_authorization_uuid;
}
void OAIAuthorization::setAuthorizationUuid(const QString &authorization_uuid) {
    m_authorization_uuid = authorization_uuid;
    m_authorization_uuid_isSet = true;
}

bool OAIAuthorization::is_authorization_uuid_Set() const{
    return m_authorization_uuid_isSet;
}

bool OAIAuthorization::is_authorization_uuid_Valid() const{
    return m_authorization_uuid_isValid;
}

QString OAIAuthorization::getClientUuid() const {
    return m_client_uuid;
}
void OAIAuthorization::setClientUuid(const QString &client_uuid) {
    m_client_uuid = client_uuid;
    m_client_uuid_isSet = true;
}

bool OAIAuthorization::is_client_uuid_Set() const{
    return m_client_uuid_isSet;
}

bool OAIAuthorization::is_client_uuid_Valid() const{
    return m_client_uuid_isValid;
}

qint32 OAIAuthorization::getCreateTimestamp() const {
    return m_create_timestamp;
}
void OAIAuthorization::setCreateTimestamp(const qint32 &create_timestamp) {
    m_create_timestamp = create_timestamp;
    m_create_timestamp_isSet = true;
}

bool OAIAuthorization::is_create_timestamp_Set() const{
    return m_create_timestamp_isSet;
}

bool OAIAuthorization::is_create_timestamp_Valid() const{
    return m_create_timestamp_isValid;
}

bool OAIAuthorization::isIsActive() const {
    return m_is_active;
}
void OAIAuthorization::setIsActive(const bool &is_active) {
    m_is_active = is_active;
    m_is_active_isSet = true;
}

bool OAIAuthorization::is_is_active_Set() const{
    return m_is_active_isSet;
}

bool OAIAuthorization::is_is_active_Valid() const{
    return m_is_active_isValid;
}

QString OAIAuthorization::getOrder() const {
    return m_order;
}
void OAIAuthorization::setOrder(const QString &order) {
    m_order = order;
    m_order_isSet = true;
}

bool OAIAuthorization::is_order_Set() const{
    return m_order_isSet;
}

bool OAIAuthorization::is_order_Valid() const{
    return m_order_isValid;
}

QString OAIAuthorization::getProductUuid() const {
    return m_product_uuid;
}
void OAIAuthorization::setProductUuid(const QString &product_uuid) {
    m_product_uuid = product_uuid;
    m_product_uuid_isSet = true;
}

bool OAIAuthorization::is_product_uuid_Set() const{
    return m_product_uuid_isSet;
}

bool OAIAuthorization::is_product_uuid_Valid() const{
    return m_product_uuid_isValid;
}

QList<OAIReportCredentials> OAIAuthorization::getReportCredentials() const {
    return m_report_credentials;
}
void OAIAuthorization::setReportCredentials(const QList<OAIReportCredentials> &report_credentials) {
    m_report_credentials = report_credentials;
    m_report_credentials_isSet = true;
}

bool OAIAuthorization::is_report_credentials_Set() const{
    return m_report_credentials_isSet;
}

bool OAIAuthorization::is_report_credentials_Valid() const{
    return m_report_credentials_isValid;
}

QList<OAIReportFile> OAIAuthorization::getReportFiles() const {
    return m_report_files;
}
void OAIAuthorization::setReportFiles(const QList<OAIReportFile> &report_files) {
    m_report_files = report_files;
    m_report_files_isSet = true;
}

bool OAIAuthorization::is_report_files_Set() const{
    return m_report_files_isSet;
}

bool OAIAuthorization::is_report_files_Valid() const{
    return m_report_files_isValid;
}

OAIAccessScope OAIAuthorization::getScopes() const {
    return m_scopes;
}
void OAIAuthorization::setScopes(const OAIAccessScope &scopes) {
    m_scopes = scopes;
    m_scopes_isSet = true;
}
...
qint32 OAIAuthorization::getSequenceNumber() const {
    return m_sequence_number;
}
void OAIAuthorization::setSequenceNumber(const qint32 &sequence_number) {
    m_sequence_number = sequence_number;
    m_sequence_number_isSet = true;
}

bool OAIAuthorization::is_sequence_number_Set() const{
    return m_sequence_number_isSet;
}

bool OAIAuthorization::is_sequence_number_Valid() const{
    return m_sequence_number_isValid;
}

QString OAIAuthorization::getState() const {
    return m_state;
}
void OAIAuthorization::setState(const QString &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIAuthorization::is_state_Set() const{
    return m_state_isSet;
}

bool OAIAuthorization::is_state_Valid() const{
...
bool OAIAuthorization::isValid() const {
    ...
    return m_authorization_uuid_isValid && m_client_uuid_isValid && m_create_timestamp_isValid && m_is_active_isValid && m_product_uuid_isValid && m_scopes_isValid && m_state_isValid && true;
}
