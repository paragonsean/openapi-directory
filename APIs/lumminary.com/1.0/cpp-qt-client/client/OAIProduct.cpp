...
void OAIProduct::initializeModel() {
    ...
    m_authorized_scopes_isSet = false;
    m_authorized_scopes_isValid = false;
    ...
    m_snps_authorized_isSet = false;
    m_snps_authorized_isValid = false;

    m_snps_authorized_any_isSet = false;
    m_snps_authorized_any_isValid = false;

    m_snps_min_required_isSet = false;
    m_snps_min_required_isValid = false;

    m_snps_min_required_any_isSet = false;
    m_snps_min_required_any_isValid = false;
}
...
void OAIProduct::fromJsonObject(QJsonObject json) {
    ...
    m_authorized_scopes_isValid = ::OpenAPI::fromJsonValue(m_authorized_scopes, json[QString("authorized_scopes")]);
    m_authorized_scopes_isSet = !json[QString("authorized_scopes")].isNull() && m_authorized_scopes_isValid;
    ...
    m_snps_authorized_isValid = ::OpenAPI::fromJsonValue(m_snps_authorized, json[QString("snps_authorized")]);
    m_snps_authorized_isSet = !json[QString("snps_authorized")].isNull() && m_snps_authorized_isValid;

    m_snps_authorized_any_isValid = ::OpenAPI::fromJsonValue(m_snps_authorized_any, json[QString("snps_authorized_any")]);
    m_snps_authorized_any_isSet = !json[QString("snps_authorized_any")].isNull() && m_snps_authorized_any_isValid;

    m_snps_min_required_isValid = ::OpenAPI::fromJsonValue(m_snps_min_required, json[QString("snps_min_required")]);
    m_snps_min_required_isSet = !json[QString("snps_min_required")].isNull() && m_snps_min_required_isValid;

    m_snps_min_required_any_isValid = ::OpenAPI::fromJsonValue(m_snps_min_required_any, json[QString("snps_min_required_any")]);
    m_snps_min_required_any_isSet = !json[QString("snps_min_required_any")].isNull() && m_snps_min_required_any_isValid;
}
...
QJsonObject OAIProduct::asJsonObject() const {
    QJsonObject obj;
    if (m_authorized_scopes.size() > 0) {
        obj.insert(QString("authorized_scopes"), ::OpenAPI::toJsonValue(m_authorized_scopes));
    }
    if (m_email_isSet) {
    ...
    if (m_snps_authorized.size() > 0) {
        obj.insert(QString("snps_authorized"), ::OpenAPI::toJsonValue(m_snps_authorized));
    }
    if (m_snps_authorized_any_isSet) {
        obj.insert(QString("snps_authorized_any"), ::OpenAPI::toJsonValue(m_snps_authorized_any));
    }
    if (m_snps_min_required.isSet()) {
        obj.insert(QString("snps_min_required"), ::OpenAPI::toJsonValue(m_snps_min_required));
    }
    if (m_snps_min_required_any_isSet) {
        obj.insert(QString("snps_min_required_any"), ::OpenAPI::toJsonValue(m_snps_min_required_any));
    }
    return obj;
}

QList<QString> OAIProduct::getAuthorizedScopes() const {
    return m_authorized_scopes;
}
void OAIProduct::setAuthorizedScopes(const QList<QString> &authorized_scopes) {
    m_authorized_scopes = authorized_scopes;
    m_authorized_scopes_isSet = true;
}

bool OAIProduct::is_authorized_scopes_Set() const{
    return m_authorized_scopes_isSet;
}

bool OAIProduct::is_authorized_scopes_Valid() const{
    return m_authorized_scopes_isValid;
}

QString OAIProduct::getEmail() const {
    return m_email;
}
void OAIProduct::setEmail(const QString &email) {
    m_email = email;
    m_email_isSet = true;
}

bool OAIProduct::is_email_Set() const{
    return m_email_isSet;
}

bool OAIProduct::is_email_Valid() const{
    return m_email_isValid;
}

QString OAIProduct::getProductUuid() const {
    return m_product_uuid;
}
void OAIProduct::setProductUuid(const QString &product_uuid) {
    m_product_uuid = product_uuid;
    m_product_uuid_isSet = true;
}

bool OAIProduct::is_product_uuid_Set() const{
    return m_product_uuid_isSet;
}

bool OAIProduct::is_product_uuid_Valid() const{
    return m_product_uuid_isValid;
}

QString OAIProduct::getRedirectUri() const {
    return m_redirect_uri;
}
void OAIProduct::setRedirectUri(const QString &redirect_uri) {
    m_redirect_uri = redirect_uri;
    m_redirect_uri_isSet = true;
}

bool OAIProduct::is_redirect_uri_Set() const{
    return m_redirect_uri_isSet;
}

bool OAIProduct::is_redirect_uri_Valid() const{
    return m_redirect_uri_isValid;
}

QList<QString> OAIProduct::getSnpsAuthorized() const {
    return m_snps_authorized;
}
void OAIProduct::setSnpsAuthorized(const QList<QString> &snps_authorized) {
    m_snps_authorized = snps_authorized;
    m_snps_authorized_isSet = true;
}

bool OAIProduct::is_snps_authorized_Set() const{
    return m_snps_authorized_isSet;
}

bool OAIProduct::is_snps_authorized_Valid() const{
    return m_snps_authorized_isValid;
}

bool OAIProduct::isSnpsAuthorizedAny() const {
    return m_snps_authorized_any;
}
void OAIProduct::setSnpsAuthorizedAny(const bool &snps_authorized_any) {
    m_snps_authorized_any = snps_authorized_any;
    m_snps_authorized_any_isSet = true;
}

bool OAIProduct::is_snps_authorized_any_Set() const{
    return m_snps_authorized_any_isSet;
}

bool OAIProduct::is_snps_authorized_any_Valid() const{
    return m_snps_authorized_any_isValid;
}

OAISnpsMinRequired OAIProduct::getSnpsMinRequired() const {
    return m_snps_min_required;
}
void OAIProduct::setSnpsMinRequired(const OAISnpsMinRequired &snps_min_required) {
    m_snps_min_required = snps_min_required;
    m_snps_min_required_isSet = true;
}

bool OAIProduct::is_snps_min_required_Set() const{
    return m_snps_min_required_isSet;
}

bool OAIProduct::is_snps_min_required_Valid() const{
    return m_snps_min_required_isValid;
}

bool OAIProduct::isSnpsMinRequiredAny() const {
    return m_snps_min_required_any;
}
void OAIProduct::setSnpsMinRequiredAny(const bool &snps_min_required_any) {
    m_snps_min_required_any = snps_min_required_any;
    m_snps_min_required_any_isSet = true;
}

bool OAIProduct::is_snps_min_required_any_Set() const{
    return m_snps_min_required_any_isSet;
}

bool OAIProduct::is_snps_min_required_any_Valid() const{
    return m_snps_min_required_any_isValid;
}
...
bool OAIProduct::isValid() const {
    ...
    return m_authorized_scopes_isValid && m_product_uuid_isValid && m_snps_authorized_isValid && m_snps_authorized_any_isValid && m_snps_min_required_isValid && m_snps_min_required_any_isValid && true;
}
