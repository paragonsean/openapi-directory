...
- API version: 1.0.0
  - Build date: 2024-10-12T12:32:23.038544-04:00[America/New_York]
...
------------ | ------------- | ------------- | -------------
*DefaultApi* | [**v1EmailDisposableGet**](docs/DefaultApi.md#v1EmailDisposableGet) | **GET** /v1/email/disposable | 
