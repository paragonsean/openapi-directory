...
```
http://localhost:8080/mailboxvalidator/MailboxValidator-Disposable-Email-Checker/1.0.0/ui/
```

Your OpenAPI definition lives here:

```
http://localhost:8080/mailboxvalidator/MailboxValidator-Disposable-Email-Checker/1.0.0/openapi.json
```
