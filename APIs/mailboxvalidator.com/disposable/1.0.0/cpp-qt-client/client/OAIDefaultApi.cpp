...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("https://virtserver.swaggerhub.com/mailboxvalidator/MailboxValidator-Disposable-Email-Checker/1.0.0"),
    ...
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("v1EmailDisposableGet", defaultConf);
    _serverIndices.insert("v1EmailDisposableGet", 0);
}
...
void OAIDefaultApi::v1EmailDisposableGet(const QString &email, const QString &key, const ::OpenAPI::OptionalParam<QString> &format) {
    QString fullPath = QString(_serverConfigs["v1EmailDisposableGet"][_serverIndices.value("v1EmailDisposableGet")].URL()+"/v1/email/disposable");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::v1EmailDisposableGetCallback);
...
void OAIDefaultApi::v1EmailDisposableGetCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT v1EmailDisposableGetSignal(output);
        Q_EMIT v1EmailDisposableGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT v1EmailDisposableGetSignalE(output, error_type, error_str);
        Q_EMIT v1EmailDisposableGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT v1EmailDisposableGetSignalError(output, error_type, error_str);
        Q_EMIT v1EmailDisposableGetSignalErrorFull(worker, error_type, error_str);
    }
}
