...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("v1EmailFreeGet", defaultConf);
    _serverIndices.insert("v1EmailFreeGet", 0);
}
...
void OAIDefaultApi::v1EmailFreeGet(const QString &email, const QString &key, const ::OpenAPI::OptionalParam<QString> &format) {
    QString fullPath = QString(_serverConfigs["v1EmailFreeGet"][_serverIndices.value("v1EmailFreeGet")].URL()+"/v1/email/free");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::v1EmailFreeGetCallback);
...
void OAIDefaultApi::v1EmailFreeGetCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT v1EmailFreeGetSignal(output);
        Q_EMIT v1EmailFreeGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT v1EmailFreeGetSignalE(output, error_type, error_str);
        Q_EMIT v1EmailFreeGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT v1EmailFreeGetSignalError(output, error_type, error_str);
        Q_EMIT v1EmailFreeGetSignalErrorFull(worker, error_type, error_str);
    }
}
