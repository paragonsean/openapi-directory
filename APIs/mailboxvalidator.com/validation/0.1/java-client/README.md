...
- API version: 0.1
  - Build date: 2024-10-12T12:32:24.405043-04:00[America/New_York]
...
------------ | ------------- | ------------- | -------------
*DefaultApi* | [**v1ValidationSingleGet**](docs/DefaultApi.md#v1ValidationSingleGet) | **GET** /v1/validation/single | 
