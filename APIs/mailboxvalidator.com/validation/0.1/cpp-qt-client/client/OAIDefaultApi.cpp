...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("https://api.mailboxvalidator.com"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("v1ValidationSingleGet", defaultConf);
    _serverIndices.insert("v1ValidationSingleGet", 0);
}
...
void OAIDefaultApi::v1ValidationSingleGet(const QString &email, const QString &key, const ::OpenAPI::OptionalParam<QString> &format) {
    QString fullPath = QString(_serverConfigs["v1ValidationSingleGet"][_serverIndices.value("v1ValidationSingleGet")].URL()+"/v1/validation/single");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::v1ValidationSingleGetCallback);
...
void OAIDefaultApi::v1ValidationSingleGetCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT v1ValidationSingleGetSignal(output);
        Q_EMIT v1ValidationSingleGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT v1ValidationSingleGetSignalE(output, error_type, error_str);
        Q_EMIT v1ValidationSingleGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT v1ValidationSingleGetSignalError(output, error_type, error_str);
        Q_EMIT v1ValidationSingleGetSignalErrorFull(worker, error_type, error_str);
    }
}
