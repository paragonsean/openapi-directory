...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new UebermapsApiEndpoints.Subscription();
  });
  ...
  describe('Subscription', function() {
    it('should create an instance of Subscription', function() {
      ...
      //var instance = new UebermapsApiEndpoints.Subscription();
      //expect(instance).to.be.a(UebermapsApiEndpoints.Subscription);
    });
