...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new UebermapsApiEndpoints.UserFullProfile();
  });
  ...
  describe('UserFullProfile', function() {
    it('should create an instance of UserFullProfile', function() {
      // uncomment below and update the code to test UserFullProfile
      //var instance = new UebermapsApiEndpoints.UserFullProfile();
      //expect(instance).to.be.a(UebermapsApiEndpoints.UserFullProfile);
    });
