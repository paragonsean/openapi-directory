...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new UebermapsApiEndpoints.Respot();
  });
  ...
  describe('Respot', function() {
    it('should create an instance of Respot', function() {
      // uncomment below and update the code to test Respot
      //var instance = new UebermapsApiEndpoints.Respot();
      //expect(instance).to.be.a(UebermapsApiEndpoints.Respot);
    });
