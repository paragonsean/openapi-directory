...
void OAIAccountApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("accountPatch", defaultConf);
    _serverIndices.insert("accountPatch", 0);
}
...
void OAIAccountApi::accountPatch(const ::OpenAPI::OptionalParam<OAIUserEditable> &user) {
    QString fullPath = QString(_serverConfigs["accountPatch"][_serverIndices.value("accountPatch")].URL()+"/account");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAccountApi::accountPatchCallback);
...
void OAIAccountApi::accountPatchCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT accountPatchSignal(output);
        Q_EMIT accountPatchSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT accountPatchSignalE(output, error_type, error_str);
        Q_EMIT accountPatchSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT accountPatchSignalError(output, error_type, error_str);
        Q_EMIT accountPatchSignalErrorFull(worker, error_type, error_str);
    }
}
