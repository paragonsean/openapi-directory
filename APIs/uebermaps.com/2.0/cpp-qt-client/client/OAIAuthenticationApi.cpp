...
void OAIAuthenticationApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("authenticationPost", defaultConf);
    _serverIndices.insert("authenticationPost", 0);
}
...
void OAIAuthenticationApi::authenticationPost(const OAIUserAuthentication &user) {
    QString fullPath = QString(_serverConfigs["authenticationPost"][_serverIndices.value("authenticationPost")].URL()+"/authentication");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAuthenticationApi::authenticationPostCallback);
...
void OAIAuthenticationApi::authenticationPostCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIUserFullProfile output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT authenticationPostSignal(output);
        Q_EMIT authenticationPostSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT authenticationPostSignalE(output, error_type, error_str);
        Q_EMIT authenticationPostSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT authenticationPostSignalError(output, error_type, error_str);
        Q_EMIT authenticationPostSignalErrorFull(worker, error_type, error_str);
    }
}
