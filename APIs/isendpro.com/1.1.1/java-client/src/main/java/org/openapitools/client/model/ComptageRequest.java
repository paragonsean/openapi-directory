...
public class ComptageRequest {
   ...
   */
  @JsonAdapter(ComptageEnum.Adapter.class)
  public enum ComptageEnum {
    ...
    public static ComptageEnum fromValue(String value) {
      for (ComptageEnum b : ComptageEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<ComptageEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final ComptageEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public ComptageEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return ComptageEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      ComptageEnum.fromValue(value);
    }
  }

  public static final String SERIALIZED_NAME_COMPTAGE = "comptage";
  @SerializedName(SERIALIZED_NAME_COMPTAGE)
   ...
   */
  @JsonAdapter(SmslongEnum.Adapter.class)
  public enum SmslongEnum {
    ...
    public static SmslongEnum fromValue(String value) {
      for (SmslongEnum b : SmslongEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
    ...
    public static class Adapter extends TypeAdapter<SmslongEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final SmslongEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public SmslongEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return SmslongEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      SmslongEnum.fromValue(value);
    }
  }
  ...
  public ComptageRequest gmtZone(GmtZoneEnum gmtZone) {
  ...
  public ComptageRequest numAzur(NumAzurEnum numAzur) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.comptage, comptageRequest.comptage) &&
        Objects.equals(this.dateEnvoi, comptageRequest.dateEnvoi) &&
        Objects.equals(this.emetteur, comptageRequest.emetteur) &&
        Objects.equals(this.gmtZone, comptageRequest.gmtZone) &&
        Objects.equals(this.keyid, comptageRequest.keyid) &&
        Objects.equals(this.nostop, comptageRequest.nostop) &&
        Objects.equals(this.num, comptageRequest.num) &&
        Objects.equals(this.numAzur, comptageRequest.numAzur) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(comptage, dateEnvoi, emetteur, gmtZone, keyid, nostop, num, numAzur, sms, smslong, tracker, ucs2);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("comptage");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ComptageRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ComptageRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ComptageRequest is not found in the empty JSON string", ComptageRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ComptageRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ComptageRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ComptageRequest.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (!jsonObj.get("comptage").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `comptage` to be a primitive type in the JSON string but got `%s`", jsonObj.get("comptage").toString()));
      }
      // validate the required field `comptage`
      ComptageEnum.validateJsonElement(jsonObj.get("comptage"));
      ...
      // validate the optional field `smslong`
      if (jsonObj.get("smslong") != null && !jsonObj.get("smslong").isJsonNull()) {
        SmslongEnum.validateJsonElement(jsonObj.get("smslong"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ComptageRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ComptageRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ComptageRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ComptageRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ComptageRequest>() {
           @Override
           public void write(JsonWriter out, ComptageRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ComptageRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ComptageRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ComptageRequest
   * @throws IOException if the JSON string is invalid with respect to ComptageRequest
   */
  public static ComptageRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ComptageRequest.class);
  }

  /**
   * Convert an instance of ComptageRequest to an JSON string
   *
   * @return JSON string
   */
