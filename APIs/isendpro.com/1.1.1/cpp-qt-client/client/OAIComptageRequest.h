...
/*
 * OAIComptageRequest.h
 *
 * 
 */

#ifndef OAIComptageRequest_H
#define OAIComptageRequest_H
...
class OAIComptageRequest : public OAIObject {
public:
    OAIComptageRequest();
    OAIComptageRequest(QString json);
    ~OAIComptageRequest() override;
    ...
    QString getComptage() const;
    void setComptage(const QString &comptage);
    bool is_comptage_Set() const;
    bool is_comptage_Valid() const;
...
private:
    ...
    QString m_comptage;
    bool m_comptage_isSet;
    bool m_comptage_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIComptageRequest)

#endif // OAIComptageRequest_H
