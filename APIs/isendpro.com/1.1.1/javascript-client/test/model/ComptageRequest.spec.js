...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiISendPro.ComptageRequest();
  });
  ...
  describe('ComptageRequest', function() {
    it('should create an instance of ComptageRequest', function() {
      // uncomment below and update the code to test ComptageRequest
      //var instance = new ApiISendPro.ComptageRequest();
      //expect(instance).to.be.a(ApiISendPro.ComptageRequest);
    });

    it('should have the property comptage (base name: "comptage")', function() {
      // uncomment below and update the code to test the property comptage
      //var instance = new ApiISendPro.ComptageRequest();
