...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiISendPro.ShortlinkRequest();
  });
  ...
  describe('ShortlinkRequest', function() {
    it('should create an instance of ShortlinkRequest', function() {
      // uncomment below and update the code to test ShortlinkRequest
      //var instance = new ApiISendPro.ShortlinkRequest();
      //expect(instance).to.be.a(ApiISendPro.ShortlinkRequest);
    });
