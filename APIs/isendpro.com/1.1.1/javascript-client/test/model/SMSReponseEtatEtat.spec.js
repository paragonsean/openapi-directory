...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiISendPro.SMSReponseEtatEtat();
  });
  ...
  describe('SMSReponseEtatEtat', function() {
    it('should create an instance of SMSReponseEtatEtat', function() {
      // uncomment below and update the code to test SMSReponseEtatEtat
      //var instance = new ApiISendPro.SMSReponseEtatEtat();
      //expect(instance).to.be.a(ApiISendPro.SMSReponseEtatEtat);
    });
