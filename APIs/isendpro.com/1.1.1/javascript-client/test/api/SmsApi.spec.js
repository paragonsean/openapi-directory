...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiISendPro.SmsApi();
  });
  ...
  describe('SmsApi', function() {
    ...
    describe('sendSmsMulti', function() {
      it('should call sendSmsMulti successfully', function(done) {
        //uncomment below and update the code to test sendSmsMulti
        //instance.sendSmsMulti(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
