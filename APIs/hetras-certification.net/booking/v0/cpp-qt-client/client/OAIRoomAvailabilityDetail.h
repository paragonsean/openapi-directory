...
/*
 * OAIRoomAvailabilityDetail.h
 *
 * 
 */

#ifndef OAIRoomAvailabilityDetail_H
#define OAIRoomAvailabilityDetail_H
...
class OAIRoomAvailabilityDetail : public OAIObject {
public:
    OAIRoomAvailabilityDetail();
    OAIRoomAvailabilityDetail(QString json);
    ~OAIRoomAvailabilityDetail() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRoomAvailabilityDetail)

#endif // OAIRoomAvailabilityDetail_H
