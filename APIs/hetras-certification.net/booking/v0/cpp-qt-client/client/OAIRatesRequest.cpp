...
QByteArray OAIRatesRequest::getAdults() const {
    return m_adults;
}
void OAIRatesRequest::setAdults(const QByteArray &adults) {
    m_adults = adults;
    m_adults_isSet = true;
}

bool OAIRatesRequest::is_adults_Set() const{
    return m_adults_isSet;
}

bool OAIRatesRequest::is_adults_Valid() const{
    return m_adults_isValid;
}

QDateTime OAIRatesRequest::getArrivalDate() const {
    return m_arrival_date;
}
void OAIRatesRequest::setArrivalDate(const QDateTime &arrival_date) {
    m_arrival_date = arrival_date;
    m_arrival_date_isSet = true;
}

bool OAIRatesRequest::is_arrival_date_Set() const{
    return m_arrival_date_isSet;
}

bool OAIRatesRequest::is_arrival_date_Valid() const{
    return m_arrival_date_isValid;
}

QString OAIRatesRequest::getChannelCode() const {
    return m_channel_code;
}
void OAIRatesRequest::setChannelCode(const QString &channel_code) {
    m_channel_code = channel_code;
    m_channel_code_isSet = true;
}

bool OAIRatesRequest::is_channel_code_Set() const{
    return m_channel_code_isSet;
}

bool OAIRatesRequest::is_channel_code_Valid() const{
    return m_channel_code_isValid;
}

QDateTime OAIRatesRequest::getDepartureDate() const {
    return m_departure_date;
}
void OAIRatesRequest::setDepartureDate(const QDateTime &departure_date) {
    m_departure_date = departure_date;
    m_departure_date_isSet = true;
}

bool OAIRatesRequest::is_departure_date_Set() const{
    return m_departure_date_isSet;
}

bool OAIRatesRequest::is_departure_date_Valid() const{
    return m_departure_date_isValid;
}

QString OAIRatesRequest::getExpand() const {
    return m_expand;
}
void OAIRatesRequest::setExpand(const QString &expand) {
    m_expand = expand;
    m_expand_isSet = true;
}

bool OAIRatesRequest::is_expand_Set() const{
    return m_expand_isSet;
}

bool OAIRatesRequest::is_expand_Valid() const{
    return m_expand_isValid;
}

QString OAIRatesRequest::getGroupCode() const {
    return m_group_code;
}
void OAIRatesRequest::setGroupCode(const QString &group_code) {
    m_group_code = group_code;
    m_group_code_isSet = true;
}

bool OAIRatesRequest::is_group_code_Set() const{
    return m_group_code_isSet;
}

bool OAIRatesRequest::is_group_code_Valid() const{
    return m_group_code_isValid;
}

qint32 OAIRatesRequest::getHotelId() const {
    return m_hotel_id;
}
void OAIRatesRequest::setHotelId(const qint32 &hotel_id) {
    m_hotel_id = hotel_id;
    m_hotel_id_isSet = true;
}

bool OAIRatesRequest::is_hotel_id_Set() const{
    return m_hotel_id_isSet;
}

bool OAIRatesRequest::is_hotel_id_Valid() const{
    return m_hotel_id_isValid;
}

QString OAIRatesRequest::getRatePlanCode() const {
    return m_rate_plan_code;
}
void OAIRatesRequest::setRatePlanCode(const QString &rate_plan_code) {
    m_rate_plan_code = rate_plan_code;
    m_rate_plan_code_isSet = true;
}

bool OAIRatesRequest::is_rate_plan_code_Set() const{
    return m_rate_plan_code_isSet;
}

bool OAIRatesRequest::is_rate_plan_code_Valid() const{
    return m_rate_plan_code_isValid;
}

QString OAIRatesRequest::getRoomType() const {
    return m_room_type;
}
void OAIRatesRequest::setRoomType(const QString &room_type) {
    m_room_type = room_type;
    m_room_type_isSet = true;
}

bool OAIRatesRequest::is_room_type_Set() const{
    return m_room_type_isSet;
}

bool OAIRatesRequest::is_room_type_Valid() const{
    return m_room_type_isValid;
}

QByteArray OAIRatesRequest::getRooms() const {
    return m_rooms;
}
void OAIRatesRequest::setRooms(const QByteArray &rooms) {
    m_rooms = rooms;
    m_rooms_isSet = true;
}

bool OAIRatesRequest::is_rooms_Set() const{
    return m_rooms_isSet;
}

bool OAIRatesRequest::is_rooms_Valid() const{
...
bool OAIRatesRequest::isValid() const {
    ...
    return m_adults_isValid && m_arrival_date_isValid && m_channel_code_isValid && m_departure_date_isValid && m_hotel_id_isValid && true;
}
