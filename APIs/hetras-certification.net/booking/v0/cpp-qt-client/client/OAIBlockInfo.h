...
#ifndef OAIBlockInfo_H
#define OAIBlockInfo_H
...
class OAIBlockInfo : public OAIObject {
public:
    OAIBlockInfo();
    OAIBlockInfo(QString json);
    ~OAIBlockInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBlockInfo)

#endif // OAIBlockInfo_H
