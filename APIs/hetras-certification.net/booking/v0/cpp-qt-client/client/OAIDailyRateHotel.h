...
#ifndef OAIDailyRateHotel_H
#define OAIDailyRateHotel_H
...
class OAIDailyRateHotel : public OAIObject {
public:
    OAIDailyRateHotel();
    OAIDailyRateHotel(QString json);
    ~OAIDailyRateHotel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDailyRateHotel)

#endif // OAIDailyRateHotel_H
