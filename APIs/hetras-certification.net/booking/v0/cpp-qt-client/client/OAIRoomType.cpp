...
QMap<QString, OAILinkObject> OAIRoomType::getLinks() const {
    return m__links;
}
void OAIRoomType::setLinks(const QMap<QString, OAILinkObject> &_links) {
    m__links = _links;
    m__links_isSet = true;
}

bool OAIRoomType::is__links_Set() const{
    return m__links_isSet;
}

bool OAIRoomType::is__links_Valid() const{
