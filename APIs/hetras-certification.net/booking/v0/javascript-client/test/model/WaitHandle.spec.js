...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HetrasBookingApiVersion0.WaitHandle();
  });
  ...
  describe('WaitHandle', function() {
    it('should create an instance of WaitHandle', function() {
      ...
      //var instance = new HetrasBookingApiVersion0.WaitHandle();
      //expect(instance).to.be.a(HetrasBookingApiVersion0.WaitHandle);
    });
