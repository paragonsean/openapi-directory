...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HetrasBookingApiVersion0.MailingAddress();
  });
  ...
  describe('MailingAddress', function() {
    it('should create an instance of MailingAddress', function() {
      // uncomment below and update the code to test MailingAddress
      //var instance = new HetrasBookingApiVersion0.MailingAddress();
      //expect(instance).to.be.a(HetrasBookingApiVersion0.MailingAddress);
    });
