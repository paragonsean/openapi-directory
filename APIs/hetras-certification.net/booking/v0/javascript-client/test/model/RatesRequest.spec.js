...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HetrasBookingApiVersion0.RatesRequest();
  });
  ...
  describe('RatesRequest', function() {
    it('should create an instance of RatesRequest', function() {
      // uncomment below and update the code to test RatesRequest
      //var instance = new HetrasBookingApiVersion0.RatesRequest();
      //expect(instance).to.be.a(HetrasBookingApiVersion0.RatesRequest);
    });
