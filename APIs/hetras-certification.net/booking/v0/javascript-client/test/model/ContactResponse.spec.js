...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HetrasBookingApiVersion0.ContactResponse();
  });
  ...
  describe('ContactResponse', function() {
    it('should create an instance of ContactResponse', function() {
      ...
      //var instance = new HetrasBookingApiVersion0.ContactResponse();
      //expect(instance).to.be.a(HetrasBookingApiVersion0.ContactResponse);
    });
