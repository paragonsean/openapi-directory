...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HetrasBookingApiVersion0.DailyRoomRate();
  });
  ...
  describe('DailyRoomRate', function() {
    it('should create an instance of DailyRoomRate', function() {
      // uncomment below and update the code to test DailyRoomRate
      //var instance = new HetrasBookingApiVersion0.DailyRoomRate();
      //expect(instance).to.be.a(HetrasBookingApiVersion0.DailyRoomRate);
    });
