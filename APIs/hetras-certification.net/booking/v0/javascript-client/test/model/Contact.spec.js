...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HetrasBookingApiVersion0.Contact();
  });
  ...
  describe('Contact', function() {
    it('should create an instance of Contact', function() {
      ...
      //var instance = new HetrasBookingApiVersion0.Contact();
      //expect(instance).to.be.a(HetrasBookingApiVersion0.Contact);
    });
