...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HetrasBookingApiVersion0.RoomRate();
  });
  ...
  describe('RoomRate', function() {
    it('should create an instance of RoomRate', function() {
      ...
      //var instance = new HetrasBookingApiVersion0.RoomRate();
      //expect(instance).to.be.a(HetrasBookingApiVersion0.RoomRate);
    });
