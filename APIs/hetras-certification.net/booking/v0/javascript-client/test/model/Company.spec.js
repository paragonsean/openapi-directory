...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HetrasBookingApiVersion0.Company();
  });
  ...
  describe('Company', function() {
    it('should create an instance of Company', function() {
      ...
      //var instance = new HetrasBookingApiVersion0.Company();
      //expect(instance).to.be.a(HetrasBookingApiVersion0.Company);
    });
