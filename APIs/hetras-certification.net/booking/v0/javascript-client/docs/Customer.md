# HetrasBookingApiVersion0.Customer

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**consentSubscribe** | **[String]** | The list of consents which the customer is subscribing | [optional] 
**consentUnsubscribe** | **[String]** | The list of consents which the customer is unsubscribing | [optional] 
