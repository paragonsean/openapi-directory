# HetrasBookingApiVersion0.AddonOffer

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**breakdown** | [**[AddonOfferBreakdown]**](AddonOfferBreakdown.md) | In this collection you will get an entry with price information for every day the addon service will be charged              to the folio of the reservation if the addon service is booked. | [optional] 
