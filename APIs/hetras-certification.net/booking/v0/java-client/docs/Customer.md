...
|------------ | ------------- | ------------- | -------------|
|**consentSubscribe** | **List&lt;String&gt;** | The list of consents which the customer is subscribing |  [optional] |
|**consentUnsubscribe** | **List&lt;String&gt;** | The list of consents which the customer is unsubscribing |  [optional] |
