...
public class RoomRate {
  ...
  public RoomRate businessDay(OffsetDateTime businessDay) {
  ...
  public RoomRate rate(Double rate) {
    this.rate = rate;
    return this;
  }
  ...
  public RoomRate ratePlan(String ratePlan) {
  ...
  public RoomRate roomType(String roomType) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.businessDay, roomRate.businessDay) &&
        Objects.equals(this.rate, roomRate.rate) &&
        Objects.equals(this.ratePlan, roomRate.ratePlan) &&
        Objects.equals(this.roomType, roomRate.roomType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(businessDay, rate, ratePlan, roomType);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to RoomRate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RoomRate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RoomRate is not found in the empty JSON string", RoomRate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RoomRate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RoomRate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RoomRate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RoomRate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RoomRate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RoomRate.class));

       return (TypeAdapter<T>) new TypeAdapter<RoomRate>() {
           @Override
           public void write(JsonWriter out, RoomRate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RoomRate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RoomRate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RoomRate
   * @throws IOException if the JSON string is invalid with respect to RoomRate
   */
  public static RoomRate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RoomRate.class);
  }

  /**
   * Convert an instance of RoomRate to an JSON string
   *
   * @return JSON string
   */
