...
public class RoomType {
  ...
  public RoomType links(Map<String, LinkObject> links) {
    this.links = links;
    return this;
  }

  public RoomType putLinksItem(String key, LinkObject linksItem) {
    if (this.links == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.links, roomType.links) &&
