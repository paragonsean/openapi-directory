...
public class ReservationDetails {
  public static final String SERIALIZED_NAME_ADDON_RATES = "addon_rates";
  @SerializedName(SERIALIZED_NAME_ADDON_RATES)
  private List<AddonRate> addonRates = new ArrayList<>();
  ...
  public ReservationDetails addonRates(List<AddonRate> addonRates) {
    this.addonRates = addonRates;
    return this;
  }

  public ReservationDetails addAddonRatesItem(AddonRate addonRatesItem) {
    if (this.addonRates == null) {
      this.addonRates = new ArrayList<>();
    }
    this.addonRates.add(addonRatesItem);
    return this;
  }
  ...
  public void setAddonRates(List<AddonRate> addonRates) {
    this.addonRates = addonRates;
  }


  public ReservationDetails adults(Integer adults) {
    this.adults = adults;
    return this;
  }
  ...
  public ReservationDetails arrivalDate(OffsetDateTime arrivalDate) {
  ...
  public ReservationDetails channelCode(String channelCode) {
  ...
  public ReservationDetails comment(String comment) {
  ...
  public ReservationDetails company(Company company) {
  ...
  public ReservationDetails contact(Contact contact) {
  ...
  public ReservationDetails departureDate(OffsetDateTime departureDate) {
  ...
  public ReservationDetails externalId(String externalId) {
  ...
  public ReservationDetails groupCode(String groupCode) {
  ...
  public ReservationDetails guarantee(Guarantee guarantee) {
  ...
  public ReservationDetails guests(List<Customer> guests) {
    this.guests = guests;
    return this;
  }

  public ReservationDetails addGuestsItem(Customer guestsItem) {
    if (this.guests == null) {
  ...
  public ReservationDetails hotelId(Integer hotelId) {
  ...
  public ReservationDetails paymentMethod(PaymentMethodEnum paymentMethod) {
  ...
  public ReservationDetails prepayDiscount(Double prepayDiscount) {
  ...
  public ReservationDetails roomRates(List<RoomRate> roomRates) {
    this.roomRates = roomRates;
    return this;
  }

  public ReservationDetails addRoomRatesItem(RoomRate roomRatesItem) {
  ...
  public ReservationDetails rooms(Integer rooms) {
    this.rooms = rooms;
    return this;
  }
  ...
  public ReservationDetails travelAgent(Company travelAgent) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.addonRates, reservationDetails.addonRates) &&
        Objects.equals(this.adults, reservationDetails.adults) &&
        Objects.equals(this.arrivalDate, reservationDetails.arrivalDate) &&
        Objects.equals(this.channelCode, reservationDetails.channelCode) &&
        Objects.equals(this.comment, reservationDetails.comment) &&
        Objects.equals(this.company, reservationDetails.company) &&
        Objects.equals(this.contact, reservationDetails.contact) &&
        Objects.equals(this.departureDate, reservationDetails.departureDate) &&
        Objects.equals(this.externalId, reservationDetails.externalId) &&
        Objects.equals(this.groupCode, reservationDetails.groupCode) &&
        Objects.equals(this.guarantee, reservationDetails.guarantee) &&
        Objects.equals(this.guests, reservationDetails.guests) &&
        Objects.equals(this.hotelId, reservationDetails.hotelId) &&
        Objects.equals(this.paymentMethod, reservationDetails.paymentMethod) &&
        Objects.equals(this.prepayDiscount, reservationDetails.prepayDiscount) &&
        Objects.equals(this.roomRates, reservationDetails.roomRates) &&
        Objects.equals(this.rooms, reservationDetails.rooms) &&
        Objects.equals(this.travelAgent, reservationDetails.travelAgent);
  }

  @Override
  public int hashCode() {
    return Objects.hash(addonRates, adults, arrivalDate, channelCode, comment, company, contact, departureDate, externalId, groupCode, guarantee, guests, hotelId, paymentMethod, prepayDiscount, roomRates, rooms, travelAgent);
  }
  ...
  public String toString() {
    ...
    sb.append("    addonRates: ").append(toIndentedString(addonRates)).append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : ReservationDetails.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (jsonObj.get("addon_rates") != null && !jsonObj.get("addon_rates").isJsonNull()) {
        JsonArray jsonArrayaddonRates = jsonObj.getAsJsonArray("addon_rates");
        if (jsonArrayaddonRates != null) {
          // ensure the json data is an array
          if (!jsonObj.get("addon_rates").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `addon_rates` to be an array in the JSON string but got `%s`", jsonObj.get("addon_rates").toString()));
          }

          // validate the optional field `addon_rates` (array)
          for (int i = 0; i < jsonArrayaddonRates.size(); i++) {
            AddonRate.validateJsonElement(jsonArrayaddonRates.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("room_rates") != null && !jsonObj.get("room_rates").isJsonNull()) {
        ...
        if (jsonArrayroomRates != null) {
          ...
          for (int i = 0; i < jsonArrayroomRates.size(); i++) {
            RoomRate.validateJsonElement(jsonArrayroomRates.get(i));
          };
        }
      }
