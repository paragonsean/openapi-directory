...
#ifndef OAIDatePeriod_H
#define OAIDatePeriod_H
...
class OAIDatePeriod : public OAIObject {
public:
    OAIDatePeriod();
    OAIDatePeriod(QString json);
    ~OAIDatePeriod() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDatePeriod)

#endif // OAIDatePeriod_H
