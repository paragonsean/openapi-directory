...
/*
 * OAIGetRatesRequest.h
 *
 * 
 */

#ifndef OAIGetRatesRequest_H
#define OAIGetRatesRequest_H
...
class OAIGetRatesRequest : public OAIObject {
public:
    OAIGetRatesRequest();
    OAIGetRatesRequest(QString json);
    ~OAIGetRatesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetRatesRequest)

#endif // OAIGetRatesRequest_H
