...
public class ResponseInfo {
  ...
  public ResponseInfo hitCount(Integer hitCount) {
  ...
  public ResponseInfo noMatchIds(List<String> noMatchIds) {
  ...
  public void setNoMatchIds(List<String> noMatchIds) {
    this.noMatchIds = noMatchIds;
  }


  public ResponseInfo requestCount(Integer requestCount) {
