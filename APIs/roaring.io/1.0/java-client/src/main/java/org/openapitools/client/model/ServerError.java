...
public class ServerError {
  ...
  private String error = "InternalServerError";

  public static final String SERIALIZED_NAME_MESSAGE = "message";
  @SerializedName(SERIALIZED_NAME_MESSAGE)
  private String message = "An internal server error occurred, please contact the system administrator with information on the error";

  public ServerError() {
  }

  public ServerError error(String error) {
    this.error = error;
    return this;
  }
