...
public class PutV3ProjectsIdServicesSlackRequest {
  ...
  public PutV3ProjectsIdServicesSlackRequest() {
  }

  public PutV3ProjectsIdServicesSlackRequest webhook(String webhook) {
  ...
  public PutV3ProjectsIdServicesSlackRequest newIssueUrl(String newIssueUrl) {
  ...
  public PutV3ProjectsIdServicesSlackRequest channel(String channel) {
  ...
  public PutV3ProjectsIdServicesSlackRequest pushEvents(String pushEvents) {
  ...
  public PutV3ProjectsIdServicesSlackRequest issueEvents(String issueEvents) {
  ...
  public PutV3ProjectsIdServicesSlackRequest confidentialIssueEvents(String confidentialIssueEvents) {
  ...
  public PutV3ProjectsIdServicesSlackRequest mergeRequestEvents(String mergeRequestEvents) {
  ...
  public PutV3ProjectsIdServicesSlackRequest noteEvents(String noteEvents) {
  ...
  public PutV3ProjectsIdServicesSlackRequest tagPushEvents(String tagPushEvents) {
  ...
  public PutV3ProjectsIdServicesSlackRequest buildEvents(String buildEvents) {
  ...
  public PutV3ProjectsIdServicesSlackRequest pipelineEvents(String pipelineEvents) {
  ...
  public PutV3ProjectsIdServicesSlackRequest wikiPageEvents(String wikiPageEvents) {
  ...
  public boolean equals(Object o) {
    ...
    PutV3ProjectsIdServicesSlackRequest putV3ProjectsIdServicesSlackRequest = (PutV3ProjectsIdServicesSlackRequest) o;
    return Objects.equals(this.webhook, putV3ProjectsIdServicesSlackRequest.webhook) &&
        Objects.equals(this.newIssueUrl, putV3ProjectsIdServicesSlackRequest.newIssueUrl) &&
        Objects.equals(this.channel, putV3ProjectsIdServicesSlackRequest.channel) &&
        Objects.equals(this.pushEvents, putV3ProjectsIdServicesSlackRequest.pushEvents) &&
        Objects.equals(this.issueEvents, putV3ProjectsIdServicesSlackRequest.issueEvents) &&
        Objects.equals(this.confidentialIssueEvents, putV3ProjectsIdServicesSlackRequest.confidentialIssueEvents) &&
        Objects.equals(this.mergeRequestEvents, putV3ProjectsIdServicesSlackRequest.mergeRequestEvents) &&
        Objects.equals(this.noteEvents, putV3ProjectsIdServicesSlackRequest.noteEvents) &&
        Objects.equals(this.tagPushEvents, putV3ProjectsIdServicesSlackRequest.tagPushEvents) &&
        Objects.equals(this.buildEvents, putV3ProjectsIdServicesSlackRequest.buildEvents) &&
        Objects.equals(this.pipelineEvents, putV3ProjectsIdServicesSlackRequest.pipelineEvents) &&
        Objects.equals(this.wikiPageEvents, putV3ProjectsIdServicesSlackRequest.wikiPageEvents);
  }

  @Override
  public int hashCode() {
    return Objects.hash(webhook, newIssueUrl, channel, pushEvents, issueEvents, confidentialIssueEvents, mergeRequestEvents, noteEvents, tagPushEvents, buildEvents, pipelineEvents, wikiPageEvents);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PutV3ProjectsIdServicesSlackRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PutV3ProjectsIdServicesSlackRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PutV3ProjectsIdServicesSlackRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PutV3ProjectsIdServicesSlackRequest is not found in the empty JSON string", PutV3ProjectsIdServicesSlackRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PutV3ProjectsIdServicesSlackRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PutV3ProjectsIdServicesSlackRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PutV3ProjectsIdServicesSlackRequest.openapiRequiredFields) {
      ...
      if ((jsonObj.get("new_issue_url") != null && !jsonObj.get("new_issue_url").isJsonNull()) && !jsonObj.get("new_issue_url").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PutV3ProjectsIdServicesSlackRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PutV3ProjectsIdServicesSlackRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PutV3ProjectsIdServicesSlackRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PutV3ProjectsIdServicesSlackRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PutV3ProjectsIdServicesSlackRequest>() {
           @Override
           public void write(JsonWriter out, PutV3ProjectsIdServicesSlackRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PutV3ProjectsIdServicesSlackRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PutV3ProjectsIdServicesSlackRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PutV3ProjectsIdServicesSlackRequest
   * @throws IOException if the JSON string is invalid with respect to PutV3ProjectsIdServicesSlackRequest
   */
  public static PutV3ProjectsIdServicesSlackRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PutV3ProjectsIdServicesSlackRequest.class);
  }

  /**
   * Convert an instance of PutV3ProjectsIdServicesSlackRequest to an JSON string
   *
   * @return JSON string
   */
