...
public class Board {
  ...
  public Board lists(ModelList lists) {
    this.lists = lists;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public ModelList getLists() {
    return lists;
  }

  public void setLists(ModelList lists) {
    this.lists = lists;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, board.id) &&
        Objects.equals(this.lists, board.lists);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, lists);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("lists") != null && !jsonObj.get("lists").isJsonNull()) {
        ModelList.validateJsonElement(jsonObj.get("lists"));
      }
  }
