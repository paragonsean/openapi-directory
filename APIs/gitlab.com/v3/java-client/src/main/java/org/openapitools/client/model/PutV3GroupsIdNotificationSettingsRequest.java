...
public class PutV3GroupsIdNotificationSettingsRequest {
  ...
  public PutV3GroupsIdNotificationSettingsRequest() {
  }

  public PutV3GroupsIdNotificationSettingsRequest level(String level) {
    this.level = level;
    return this;
  }
  ...
  public PutV3GroupsIdNotificationSettingsRequest newNote(Boolean newNote) {
  ...
  public PutV3GroupsIdNotificationSettingsRequest newIssue(Boolean newIssue) {
  ...
  public PutV3GroupsIdNotificationSettingsRequest reopenIssue(Boolean reopenIssue) {
  ...
  public PutV3GroupsIdNotificationSettingsRequest closeIssue(Boolean closeIssue) {
  ...
  public PutV3GroupsIdNotificationSettingsRequest reassignIssue(Boolean reassignIssue) {
  ...
  public PutV3GroupsIdNotificationSettingsRequest newMergeRequest(Boolean newMergeRequest) {
  ...
  public PutV3GroupsIdNotificationSettingsRequest reopenMergeRequest(Boolean reopenMergeRequest) {
  ...
  public PutV3GroupsIdNotificationSettingsRequest closeMergeRequest(Boolean closeMergeRequest) {
  ...
  public PutV3GroupsIdNotificationSettingsRequest reassignMergeRequest(Boolean reassignMergeRequest) {
  ...
  public PutV3GroupsIdNotificationSettingsRequest mergeMergeRequest(Boolean mergeMergeRequest) {
  ...
  public PutV3GroupsIdNotificationSettingsRequest failedPipeline(Boolean failedPipeline) {
  ...
  public PutV3GroupsIdNotificationSettingsRequest successPipeline(Boolean successPipeline) {
  ...
  public boolean equals(Object o) {
    ...
    PutV3GroupsIdNotificationSettingsRequest putV3GroupsIdNotificationSettingsRequest = (PutV3GroupsIdNotificationSettingsRequest) o;
    return Objects.equals(this.level, putV3GroupsIdNotificationSettingsRequest.level) &&
        Objects.equals(this.newNote, putV3GroupsIdNotificationSettingsRequest.newNote) &&
        Objects.equals(this.newIssue, putV3GroupsIdNotificationSettingsRequest.newIssue) &&
        Objects.equals(this.reopenIssue, putV3GroupsIdNotificationSettingsRequest.reopenIssue) &&
        Objects.equals(this.closeIssue, putV3GroupsIdNotificationSettingsRequest.closeIssue) &&
        Objects.equals(this.reassignIssue, putV3GroupsIdNotificationSettingsRequest.reassignIssue) &&
        Objects.equals(this.newMergeRequest, putV3GroupsIdNotificationSettingsRequest.newMergeRequest) &&
        Objects.equals(this.reopenMergeRequest, putV3GroupsIdNotificationSettingsRequest.reopenMergeRequest) &&
        Objects.equals(this.closeMergeRequest, putV3GroupsIdNotificationSettingsRequest.closeMergeRequest) &&
        Objects.equals(this.reassignMergeRequest, putV3GroupsIdNotificationSettingsRequest.reassignMergeRequest) &&
        Objects.equals(this.mergeMergeRequest, putV3GroupsIdNotificationSettingsRequest.mergeMergeRequest) &&
        Objects.equals(this.failedPipeline, putV3GroupsIdNotificationSettingsRequest.failedPipeline) &&
        Objects.equals(this.successPipeline, putV3GroupsIdNotificationSettingsRequest.successPipeline);
  }
  ...
  public String toString() {
    ...
    sb.append("class PutV3GroupsIdNotificationSettingsRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PutV3GroupsIdNotificationSettingsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PutV3GroupsIdNotificationSettingsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PutV3GroupsIdNotificationSettingsRequest is not found in the empty JSON string", PutV3GroupsIdNotificationSettingsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PutV3GroupsIdNotificationSettingsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PutV3GroupsIdNotificationSettingsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PutV3GroupsIdNotificationSettingsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PutV3GroupsIdNotificationSettingsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PutV3GroupsIdNotificationSettingsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PutV3GroupsIdNotificationSettingsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PutV3GroupsIdNotificationSettingsRequest>() {
           @Override
           public void write(JsonWriter out, PutV3GroupsIdNotificationSettingsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PutV3GroupsIdNotificationSettingsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PutV3GroupsIdNotificationSettingsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PutV3GroupsIdNotificationSettingsRequest
   * @throws IOException if the JSON string is invalid with respect to PutV3GroupsIdNotificationSettingsRequest
   */
  public static PutV3GroupsIdNotificationSettingsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PutV3GroupsIdNotificationSettingsRequest.class);
  }

  /**
   * Convert an instance of PutV3GroupsIdNotificationSettingsRequest to an JSON string
   *
   * @return JSON string
   */
