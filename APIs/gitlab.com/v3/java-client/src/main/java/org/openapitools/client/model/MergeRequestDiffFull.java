...
public class MergeRequestDiffFull {
  ...
  public MergeRequestDiffFull baseCommitSha(String baseCommitSha) {
  ...
  public MergeRequestDiffFull commits(RepoCommit commits) {
  ...
  public MergeRequestDiffFull createdAt(String createdAt) {
  ...
  public MergeRequestDiffFull diffs(RepoDiff diffs) {
    this.diffs = diffs;
    return this;
  }
  ...
  public MergeRequestDiffFull headCommitSha(String headCommitSha) {
  ...
  public MergeRequestDiffFull id(String id) {
    this.id = id;
    return this;
  }
  ...
  public MergeRequestDiffFull mergeRequestId(String mergeRequestId) {
  ...
  public MergeRequestDiffFull realSize(String realSize) {
  ...
  public MergeRequestDiffFull startCommitSha(String startCommitSha) {
  ...
  public MergeRequestDiffFull state(String state) {
    this.state = state;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    MergeRequestDiffFull mergeRequestDiffFull = (MergeRequestDiffFull) o;
    return Objects.equals(this.baseCommitSha, mergeRequestDiffFull.baseCommitSha) &&
        Objects.equals(this.commits, mergeRequestDiffFull.commits) &&
        Objects.equals(this.createdAt, mergeRequestDiffFull.createdAt) &&
        Objects.equals(this.diffs, mergeRequestDiffFull.diffs) &&
        Objects.equals(this.headCommitSha, mergeRequestDiffFull.headCommitSha) &&
        Objects.equals(this.id, mergeRequestDiffFull.id) &&
        Objects.equals(this.mergeRequestId, mergeRequestDiffFull.mergeRequestId) &&
        Objects.equals(this.realSize, mergeRequestDiffFull.realSize) &&
        Objects.equals(this.startCommitSha, mergeRequestDiffFull.startCommitSha) &&
        Objects.equals(this.state, mergeRequestDiffFull.state);
  }

  @Override
  public int hashCode() {
    return Objects.hash(baseCommitSha, commits, createdAt, diffs, headCommitSha, id, mergeRequestId, realSize, startCommitSha, state);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MergeRequestDiffFull {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MergeRequestDiffFull
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MergeRequestDiffFull.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MergeRequestDiffFull is not found in the empty JSON string", MergeRequestDiffFull.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MergeRequestDiffFull.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MergeRequestDiffFull` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MergeRequestDiffFull.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MergeRequestDiffFull' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MergeRequestDiffFull> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MergeRequestDiffFull.class));

       return (TypeAdapter<T>) new TypeAdapter<MergeRequestDiffFull>() {
           @Override
           public void write(JsonWriter out, MergeRequestDiffFull value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MergeRequestDiffFull read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MergeRequestDiffFull given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MergeRequestDiffFull
   * @throws IOException if the JSON string is invalid with respect to MergeRequestDiffFull
   */
  public static MergeRequestDiffFull fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MergeRequestDiffFull.class);
  }

  /**
   * Convert an instance of MergeRequestDiffFull to an JSON string
   *
   * @return JSON string
   */
