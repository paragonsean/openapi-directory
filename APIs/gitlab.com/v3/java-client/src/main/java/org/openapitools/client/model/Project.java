...
public class Project {
  ...
  public Project archived(String archived) {
  ...
  public Project buildsEnabled(String buildsEnabled) {
  ...
  public Project containerRegistryEnabled(String containerRegistryEnabled) {
  ...
  public Project creatorId(String creatorId) {
  ...
  public Project forkedFromProject(BasicProjectDetails forkedFromProject) {
  ...
  public Project forksCount(String forksCount) {
  ...
  public Project httpUrlToRepo(String httpUrlToRepo) {
  ...
  public Project issuesEnabled(String issuesEnabled) {
  ...
  public Project lastActivityAt(String lastActivityAt) {
  ...
  public Project lfsEnabled(String lfsEnabled) {
  ...
  public Project mergeRequestsEnabled(String mergeRequestsEnabled) {
  ...
  public Project namespace(Namespace namespace) {
  ...
  public Project onlyAllowMergeIfAllDiscussionsAreResolved(String onlyAllowMergeIfAllDiscussionsAreResolved) {
  ...
  public Project onlyAllowMergeIfBuildSucceeds(String onlyAllowMergeIfBuildSucceeds) {
  ...
  public Project openIssuesCount(String openIssuesCount) {
  ...
  public Project owner(UserBasic owner) {
    this.owner = owner;
    return this;
  }
  ...
  public Project pathWithNamespace(String pathWithNamespace) {
  ...
  public Project _public(String _public) {
  ...
  public Project publicBuilds(String publicBuilds) {
  ...
  public Project requestAccessEnabled(String requestAccessEnabled) {
  ...
  public Project runnersToken(String runnersToken) {
  ...
  public Project sharedRunnersEnabled(String sharedRunnersEnabled) {
  ...
  public Project sharedWithGroups(String sharedWithGroups) {
  ...
  public Project snippetsEnabled(String snippetsEnabled) {
  ...
  public Project sshUrlToRepo(String sshUrlToRepo) {
  ...
  public Project starCount(String starCount) {
  ...
  public Project statistics(ProjectStatistics statistics) {
  ...
  public Project tagList(String tagList) {
  ...
  public Project visibilityLevel(String visibilityLevel) {
  ...
  public Project wikiEnabled(String wikiEnabled) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.archived, project.archived) &&
        ...
        Objects.equals(this.buildsEnabled, project.buildsEnabled) &&
        Objects.equals(this.containerRegistryEnabled, project.containerRegistryEnabled) &&
        ...
        Objects.equals(this.forkedFromProject, project.forkedFromProject) &&
        Objects.equals(this.forksCount, project.forksCount) &&
        Objects.equals(this.httpUrlToRepo, project.httpUrlToRepo) &&
        Objects.equals(this.id, project.id) &&
        Objects.equals(this.issuesEnabled, project.issuesEnabled) &&
        Objects.equals(this.lastActivityAt, project.lastActivityAt) &&
        Objects.equals(this.lfsEnabled, project.lfsEnabled) &&
        Objects.equals(this.mergeRequestsEnabled, project.mergeRequestsEnabled) &&
        Objects.equals(this.name, project.name) &&
        Objects.equals(this.nameWithNamespace, project.nameWithNamespace) &&
        Objects.equals(this.namespace, project.namespace) &&
        Objects.equals(this.onlyAllowMergeIfAllDiscussionsAreResolved, project.onlyAllowMergeIfAllDiscussionsAreResolved) &&
        Objects.equals(this.onlyAllowMergeIfBuildSucceeds, project.onlyAllowMergeIfBuildSucceeds) &&
        ...
        Objects.equals(this.pathWithNamespace, project.pathWithNamespace) &&
        Objects.equals(this._public, project._public) &&
        Objects.equals(this.publicBuilds, project.publicBuilds) &&
        Objects.equals(this.requestAccessEnabled, project.requestAccessEnabled) &&
        Objects.equals(this.runnersToken, project.runnersToken) &&
        Objects.equals(this.sharedRunnersEnabled, project.sharedRunnersEnabled) &&
        Objects.equals(this.sharedWithGroups, project.sharedWithGroups) &&
        Objects.equals(this.snippetsEnabled, project.snippetsEnabled) &&
        Objects.equals(this.sshUrlToRepo, project.sshUrlToRepo) &&
        Objects.equals(this.starCount, project.starCount) &&
        Objects.equals(this.statistics, project.statistics) &&
        Objects.equals(this.tagList, project.tagList) &&
        Objects.equals(this.visibilityLevel, project.visibilityLevel) &&
        Objects.equals(this.webUrl, project.webUrl) &&
        Objects.equals(this.wikiEnabled, project.wikiEnabled);
  }

  @Override
  public int hashCode() {
    return Objects.hash(archived, avatarUrl, buildsEnabled, containerRegistryEnabled, createdAt, creatorId, defaultBranch, description, forkedFromProject, forksCount, httpUrlToRepo, id, issuesEnabled, lastActivityAt, lfsEnabled, mergeRequestsEnabled, name, nameWithNamespace, namespace, onlyAllowMergeIfAllDiscussionsAreResolved, onlyAllowMergeIfBuildSucceeds, openIssuesCount, owner, path, pathWithNamespace, _public, publicBuilds, requestAccessEnabled, runnersToken, sharedRunnersEnabled, sharedWithGroups, snippetsEnabled, sshUrlToRepo, starCount, statistics, tagList, visibilityLevel, webUrl, wikiEnabled);
  }
