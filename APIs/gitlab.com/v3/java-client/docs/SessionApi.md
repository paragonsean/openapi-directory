...
public class Example {
  public static void main(String[] args) {
    ...
    PostV3SessionRequest postV3SessionRequest = new PostV3SessionRequest(); // PostV3SessionRequest | 
    try {
      UserWithPrivateToken result = apiInstance.postV3Session(postV3SessionRequest);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling SessionApi#postV3Session");
