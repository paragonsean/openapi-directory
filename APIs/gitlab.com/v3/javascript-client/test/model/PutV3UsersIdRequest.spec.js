...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Gitlab.PutV3UsersIdRequest();
  });
  ...
  describe('PutV3UsersIdRequest', function() {
    it('should create an instance of PutV3UsersIdRequest', function() {
      // uncomment below and update the code to test PutV3UsersIdRequest
      //var instance = new Gitlab.PutV3UsersIdRequest();
      //expect(instance).to.be.a(Gitlab.PutV3UsersIdRequest);
    });
