...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Gitlab.PutV3ProjectsIdIssuesIssueIdRequest();
  });
  ...
  describe('PutV3ProjectsIdIssuesIssueIdRequest', function() {
    it('should create an instance of PutV3ProjectsIdIssuesIssueIdRequest', function() {
      // uncomment below and update the code to test PutV3ProjectsIdIssuesIssueIdRequest
      //var instance = new Gitlab.PutV3ProjectsIdIssuesIssueIdRequest();
      //expect(instance).to.be.a(Gitlab.PutV3ProjectsIdIssuesIssueIdRequest);
    });
