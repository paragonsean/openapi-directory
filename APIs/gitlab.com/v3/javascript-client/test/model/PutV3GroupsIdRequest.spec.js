...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Gitlab.PutV3GroupsIdRequest();
  });
  ...
  describe('PutV3GroupsIdRequest', function() {
    it('should create an instance of PutV3GroupsIdRequest', function() {
      // uncomment below and update the code to test PutV3GroupsIdRequest
      //var instance = new Gitlab.PutV3GroupsIdRequest();
      //expect(instance).to.be.a(Gitlab.PutV3GroupsIdRequest);
    });
