...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Gitlab.PutV3ProjectsIdRequest();
  });
  ...
  describe('PutV3ProjectsIdRequest', function() {
    it('should create an instance of PutV3ProjectsIdRequest', function() {
      // uncomment below and update the code to test PutV3ProjectsIdRequest
      //var instance = new Gitlab.PutV3ProjectsIdRequest();
      //expect(instance).to.be.a(Gitlab.PutV3ProjectsIdRequest);
    });
