...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Gitlab.RepoCommitStats();
  });
  ...
  describe('RepoCommitStats', function() {
    it('should create an instance of RepoCommitStats', function() {
      // uncomment below and update the code to test RepoCommitStats
      //var instance = new Gitlab.RepoCommitStats();
      //expect(instance).to.be.a(Gitlab.RepoCommitStats);
    });
