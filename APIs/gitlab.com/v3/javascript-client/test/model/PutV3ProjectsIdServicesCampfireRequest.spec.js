...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Gitlab.PutV3ProjectsIdServicesCampfireRequest();
  });
  ...
  describe('PutV3ProjectsIdServicesCampfireRequest', function() {
    it('should create an instance of PutV3ProjectsIdServicesCampfireRequest', function() {
      // uncomment below and update the code to test PutV3ProjectsIdServicesCampfireRequest
      //var instance = new Gitlab.PutV3ProjectsIdServicesCampfireRequest();
      //expect(instance).to.be.a(Gitlab.PutV3ProjectsIdServicesCampfireRequest);
    });
