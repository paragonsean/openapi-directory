...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Gitlab.PipelineBasic();
  });
  ...
  describe('PipelineBasic', function() {
    it('should create an instance of PipelineBasic', function() {
      // uncomment below and update the code to test PipelineBasic
      //var instance = new Gitlab.PipelineBasic();
      //expect(instance).to.be.a(Gitlab.PipelineBasic);
    });
