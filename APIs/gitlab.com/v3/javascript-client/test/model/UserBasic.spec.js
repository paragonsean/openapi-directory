...
(function(root, factory) {
  ...
  describe('UserBasic', function() {
    it('should create an instance of UserBasic', function() {
      // uncomment below and update the code to test UserBasic
      //var instance = new Gitlab.UserBasic();
      //expect(instance).to.be.a(Gitlab.UserBasic);
    });
