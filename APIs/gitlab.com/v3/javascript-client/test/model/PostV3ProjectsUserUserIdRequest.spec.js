...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Gitlab.PostV3ProjectsUserUserIdRequest();
  });
  ...
  describe('PostV3ProjectsUserUserIdRequest', function() {
    it('should create an instance of PostV3ProjectsUserUserIdRequest', function() {
      // uncomment below and update the code to test PostV3ProjectsUserUserIdRequest
      //var instance = new Gitlab.PostV3ProjectsUserUserIdRequest();
      //expect(instance).to.be.a(Gitlab.PostV3ProjectsUserUserIdRequest);
    });
