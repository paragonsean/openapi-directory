...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Gitlab.UserWithPrivateToken();
  });
  ...
  describe('UserWithPrivateToken', function() {
    it('should create an instance of UserWithPrivateToken', function() {
      // uncomment below and update the code to test UserWithPrivateToken
      //var instance = new Gitlab.UserWithPrivateToken();
      //expect(instance).to.be.a(Gitlab.UserWithPrivateToken);
    });
    ...
    it('should have the property privateToken (base name: "private_token")', function() {
      // uncomment below and update the code to test the property privateToken
      //var instance = new Gitlab.UserWithPrivateToken();
      //expect(instance).to.be();
    });
