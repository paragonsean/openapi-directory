...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Gitlab.PostV3HooksRequest();
  });
  ...
  describe('PostV3HooksRequest', function() {
    it('should create an instance of PostV3HooksRequest', function() {
      // uncomment below and update the code to test PostV3HooksRequest
      //var instance = new Gitlab.PostV3HooksRequest();
      //expect(instance).to.be.a(Gitlab.PostV3HooksRequest);
    });
