...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Gitlab.AccessRequester();
  });
  ...
  describe('AccessRequester', function() {
    it('should create an instance of AccessRequester', function() {
      // uncomment below and update the code to test AccessRequester
      //var instance = new Gitlab.AccessRequester();
      //expect(instance).to.be.a(Gitlab.AccessRequester);
    });
