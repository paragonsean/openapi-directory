...
apiInstance.deleteV3HooksId(id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let apiInstance = new Gitlab.HooksApi();
let id = 56; // Number | The ID of the system hook
apiInstance.getV3HooksId(id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new Gitlab.HooksApi();
let postV3HooksRequest = new Gitlab.PostV3HooksRequest(); // PostV3HooksRequest | 
apiInstance.postV3Hooks(postV3HooksRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
