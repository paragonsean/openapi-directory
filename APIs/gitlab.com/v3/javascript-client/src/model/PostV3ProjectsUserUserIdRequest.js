...
/**
 * The PostV3ProjectsUserUserIdRequest model module.
 * @module model/PostV3ProjectsUserUserIdRequest
 * @version v3
 */
class PostV3ProjectsUserUserIdRequest {
    /**
     * Constructs a new <code>PostV3ProjectsUserUserIdRequest</code>.
     * @alias module:model/PostV3ProjectsUserUserIdRequest
     * @param name {String} The name of the project
     */
    constructor(name) { 
        
        PostV3ProjectsUserUserIdRequest.initialize(this, name);
    }
    ...
    /**
     * Constructs a <code>PostV3ProjectsUserUserIdRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PostV3ProjectsUserUserIdRequest} obj Optional instance to populate.
     * @return {module:model/PostV3ProjectsUserUserIdRequest} The populated <code>PostV3ProjectsUserUserIdRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PostV3ProjectsUserUserIdRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>PostV3ProjectsUserUserIdRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PostV3ProjectsUserUserIdRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PostV3ProjectsUserUserIdRequest.RequiredProperties) {
...
PostV3ProjectsUserUserIdRequest.RequiredProperties = ["name"];

/**
 * The name of the project
 * @member {String} name
 */
PostV3ProjectsUserUserIdRequest.prototype['name'] = undefined;

/**
 * The default branch of the project
 * @member {String} default_branch
 */
PostV3ProjectsUserUserIdRequest.prototype['default_branch'] = undefined;

/**
 * The description of the project
 * @member {String} description
 */
PostV3ProjectsUserUserIdRequest.prototype['description'] = undefined;

/**
 * Flag indication if the issue tracker is enabled
 * @member {Boolean} issues_enabled
 */
PostV3ProjectsUserUserIdRequest.prototype['issues_enabled'] = undefined;

/**
 * Flag indication if merge requests are enabled
 * @member {Boolean} merge_requests_enabled
 */
PostV3ProjectsUserUserIdRequest.prototype['merge_requests_enabled'] = undefined;

/**
 * Flag indication if the wiki is enabled
 * @member {Boolean} wiki_enabled
 */
PostV3ProjectsUserUserIdRequest.prototype['wiki_enabled'] = undefined;

/**
 * Flag indication if builds are enabled
 * @member {Boolean} builds_enabled
 */
PostV3ProjectsUserUserIdRequest.prototype['builds_enabled'] = undefined;

/**
 * Flag indication if snippets are enabled
 * @member {Boolean} snippets_enabled
 */
PostV3ProjectsUserUserIdRequest.prototype['snippets_enabled'] = undefined;

/**
 * Flag indication if shared runners are enabled for that project
 * @member {Boolean} shared_runners_enabled
 */
PostV3ProjectsUserUserIdRequest.prototype['shared_runners_enabled'] = undefined;

/**
 * Flag indication if the container registry is enabled for that project
 * @member {Boolean} container_registry_enabled
 */
PostV3ProjectsUserUserIdRequest.prototype['container_registry_enabled'] = undefined;

/**
 * Flag indication if Git LFS is enabled for that project
 * @member {Boolean} lfs_enabled
 */
PostV3ProjectsUserUserIdRequest.prototype['lfs_enabled'] = undefined;

/**
 * Create a public project. The same as visibility_level = 20.
 * @member {Boolean} public
 */
PostV3ProjectsUserUserIdRequest.prototype['public'] = undefined;

/**
 * Create a public project. The same as visibility_level = 20.
 * @member {module:model/PostV3ProjectsUserUserIdRequest.VisibilityLevelEnum} visibility_level
 */
PostV3ProjectsUserUserIdRequest.prototype['visibility_level'] = undefined;

/**
 * Perform public builds
 * @member {Boolean} public_builds
 */
PostV3ProjectsUserUserIdRequest.prototype['public_builds'] = undefined;

/**
 * Allow users to request member access
 * @member {Boolean} request_access_enabled
 */
PostV3ProjectsUserUserIdRequest.prototype['request_access_enabled'] = undefined;

/**
 * Only allow to merge if builds succeed
 * @member {Boolean} only_allow_merge_if_build_succeeds
 */
PostV3ProjectsUserUserIdRequest.prototype['only_allow_merge_if_build_succeeds'] = undefined;

/**
 * Only allow to merge if all discussions are resolved
 * @member {Boolean} only_allow_merge_if_all_discussions_are_resolved
 */
PostV3ProjectsUserUserIdRequest.prototype['only_allow_merge_if_all_discussions_are_resolved'] = undefined;

/**
 * Namespace ID for the new project. Default to the user namespace.
 * @member {Number} namespace_id
 */
PostV3ProjectsUserUserIdRequest.prototype['namespace_id'] = undefined;

/**
 * URL from which the project is imported
 * @member {String} import_url
 */
PostV3ProjectsUserUserIdRequest.prototype['import_url'] = undefined;
 ...
 * @readonly
 */
PostV3ProjectsUserUserIdRequest['VisibilityLevelEnum'] = {
...
export default PostV3ProjectsUserUserIdRequest;
