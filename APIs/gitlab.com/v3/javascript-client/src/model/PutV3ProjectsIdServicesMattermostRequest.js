...
/**
 * The PutV3ProjectsIdServicesMattermostRequest model module.
 * @module model/PutV3ProjectsIdServicesMattermostRequest
 * @version v3
 */
class PutV3ProjectsIdServicesMattermostRequest {
    /**
     * Constructs a new <code>PutV3ProjectsIdServicesMattermostRequest</code>.
     * @alias module:model/PutV3ProjectsIdServicesMattermostRequest
     * @param webhook {String} The Mattermost webhook. e.g. http://mattermost_host/hooks/...
     */
    constructor(webhook) { 
        
        PutV3ProjectsIdServicesMattermostRequest.initialize(this, webhook);
    }
    ...
    /**
     * Constructs a <code>PutV3ProjectsIdServicesMattermostRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutV3ProjectsIdServicesMattermostRequest} obj Optional instance to populate.
     * @return {module:model/PutV3ProjectsIdServicesMattermostRequest} The populated <code>PutV3ProjectsIdServicesMattermostRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutV3ProjectsIdServicesMattermostRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>PutV3ProjectsIdServicesMattermostRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutV3ProjectsIdServicesMattermostRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PutV3ProjectsIdServicesMattermostRequest.RequiredProperties) {
...
PutV3ProjectsIdServicesMattermostRequest.RequiredProperties = ["webhook"];

/**
 * The Mattermost webhook. e.g. http://mattermost_host/hooks/...
 * @member {String} webhook
 */
PutV3ProjectsIdServicesMattermostRequest.prototype['webhook'] = undefined;

/**
 * Event will be triggered by a push to the repository
 * @member {String} push_events
 */
PutV3ProjectsIdServicesMattermostRequest.prototype['push_events'] = undefined;

/**
 * Event will be triggered when an issue is created/updated/closed
 * @member {String} issue_events
 */
PutV3ProjectsIdServicesMattermostRequest.prototype['issue_events'] = undefined;

/**
 * Event will be triggered when a confidential issue is created/updated/closed
 * @member {String} confidential_issue_events
 */
PutV3ProjectsIdServicesMattermostRequest.prototype['confidential_issue_events'] = undefined;

/**
 * Event will be triggered when a merge request is created/updated/merged
 * @member {String} merge_request_events
 */
PutV3ProjectsIdServicesMattermostRequest.prototype['merge_request_events'] = undefined;

/**
 * Event will be triggered when someone adds a comment
 * @member {String} note_events
 */
PutV3ProjectsIdServicesMattermostRequest.prototype['note_events'] = undefined;

/**
 * Event will be triggered when a new tag is pushed to the repository
 * @member {String} tag_push_events
 */
PutV3ProjectsIdServicesMattermostRequest.prototype['tag_push_events'] = undefined;

/**
 * Event will be triggered when a build status changes
 * @member {String} build_events
 */
PutV3ProjectsIdServicesMattermostRequest.prototype['build_events'] = undefined;

/**
 * @member {String} pipeline_events
 */
PutV3ProjectsIdServicesMattermostRequest.prototype['pipeline_events'] = undefined;

/**
 * Event will be triggered when a wiki page is created/updated
 * @member {String} wiki_page_events
 */
PutV3ProjectsIdServicesMattermostRequest.prototype['wiki_page_events'] = undefined;
...
export default PutV3ProjectsIdServicesMattermostRequest;
