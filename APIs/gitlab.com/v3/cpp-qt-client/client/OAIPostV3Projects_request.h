...
/*
 * OAIPostV3Projects_request.h
 *
 * 
 */

#ifndef OAIPostV3Projects_request_H
#define OAIPostV3Projects_request_H
...
class OAIPostV3Projects_request : public OAIObject {
public:
    OAIPostV3Projects_request();
    OAIPostV3Projects_request(QString json);
    ~OAIPostV3Projects_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPostV3Projects_request)

#endif // OAIPostV3Projects_request_H
