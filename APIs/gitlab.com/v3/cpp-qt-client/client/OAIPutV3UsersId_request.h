...
/*
 * OAIPutV3UsersId_request.h
 *
 * 
 */

#ifndef OAIPutV3UsersId_request_H
#define OAIPutV3UsersId_request_H
...
class OAIPutV3UsersId_request : public OAIObject {
public:
    OAIPutV3UsersId_request();
    OAIPutV3UsersId_request(QString json);
    ~OAIPutV3UsersId_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutV3UsersId_request)

#endif // OAIPutV3UsersId_request_H
