...
/*
 * OAIProjectWithAccess.h
 *
 * Get a single project
 */

#ifndef OAIProjectWithAccess_H
#define OAIProjectWithAccess_H
...
class OAIProjectWithAccess : public OAIObject {
public:
    OAIProjectWithAccess();
    OAIProjectWithAccess(QString json);
    ~OAIProjectWithAccess() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProjectWithAccess)

#endif // OAIProjectWithAccess_H
