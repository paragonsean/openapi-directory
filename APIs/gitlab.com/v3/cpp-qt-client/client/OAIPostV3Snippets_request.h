...
/*
 * OAIPostV3Snippets_request.h
 *
 * 
 */

#ifndef OAIPostV3Snippets_request_H
#define OAIPostV3Snippets_request_H
...
class OAIPostV3Snippets_request : public OAIObject {
public:
    OAIPostV3Snippets_request();
    OAIPostV3Snippets_request(QString json);
    ~OAIPostV3Snippets_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPostV3Snippets_request)

#endif // OAIPostV3Snippets_request_H
