...
/*
 * OAIUserWithPrivateToken.h
 *
 * Login to get token
 */

#ifndef OAIUserWithPrivateToken_H
#define OAIUserWithPrivateToken_H
...
class OAIUserWithPrivateToken : public OAIObject {
public:
    OAIUserWithPrivateToken();
    OAIUserWithPrivateToken(QString json);
    ~OAIUserWithPrivateToken() override;
    ...
    QString getPrivateToken() const;
    void setPrivateToken(const QString &private_token);
    bool is_private_token_Set() const;
    bool is_private_token_Valid() const;
...
private:
    ...
    bool m_private_token_isSet;
    bool m_private_token_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserWithPrivateToken)

#endif // OAIUserWithPrivateToken_H
