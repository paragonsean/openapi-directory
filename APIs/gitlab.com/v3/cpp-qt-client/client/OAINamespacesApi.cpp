...
void OAINamespacesApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("getV3Namespaces", defaultConf);
    _serverIndices.insert("getV3Namespaces", 0);
}
...
void OAINamespacesApi::getV3Namespaces(const ::OpenAPI::OptionalParam<QString> &search, const ::OpenAPI::OptionalParam<qint32> &page, const ::OpenAPI::OptionalParam<qint32> &per_page) {
    QString fullPath = QString(_serverConfigs["getV3Namespaces"][_serverIndices.value("getV3Namespaces")].URL()+"/v3/namespaces");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAINamespacesApi::getV3NamespacesCallback);
...
void OAINamespacesApi::getV3NamespacesCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getV3NamespacesSignal(output);
        Q_EMIT getV3NamespacesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getV3NamespacesSignalE(output, error_type, error_str);
        Q_EMIT getV3NamespacesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getV3NamespacesSignalError(output, error_type, error_str);
        Q_EMIT getV3NamespacesSignalErrorFull(worker, error_type, error_str);
    }
}
