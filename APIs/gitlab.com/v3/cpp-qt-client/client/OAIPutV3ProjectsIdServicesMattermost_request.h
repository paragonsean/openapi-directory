...
/*
 * OAIPutV3ProjectsIdServicesMattermost_request.h
 *
 * 
 */

#ifndef OAIPutV3ProjectsIdServicesMattermost_request_H
#define OAIPutV3ProjectsIdServicesMattermost_request_H
...
class OAIPutV3ProjectsIdServicesMattermost_request : public OAIObject {
public:
    OAIPutV3ProjectsIdServicesMattermost_request();
    OAIPutV3ProjectsIdServicesMattermost_request(QString json);
    ~OAIPutV3ProjectsIdServicesMattermost_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutV3ProjectsIdServicesMattermost_request)

#endif // OAIPutV3ProjectsIdServicesMattermost_request_H
