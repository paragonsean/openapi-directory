...
OAIProjectWithAccess::OAIProjectWithAccess(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIProjectWithAccess::OAIProjectWithAccess() {
    this->initializeModel();
}

OAIProjectWithAccess::~OAIProjectWithAccess() {}

void OAIProjectWithAccess::initializeModel() {
...
void OAIProjectWithAccess::fromJson(QString jsonString) {
...
void OAIProjectWithAccess::fromJsonObject(QJsonObject json) {
...
QString OAIProjectWithAccess::asJson() const {
...
QJsonObject OAIProjectWithAccess::asJsonObject() const {
    QJsonObject obj;
    if (m_archived_isSet) {
...
QString OAIProjectWithAccess::getArchived() const {
    return m_archived;
}
void OAIProjectWithAccess::setArchived(const QString &archived) {
    m_archived = archived;
    m_archived_isSet = true;
}

bool OAIProjectWithAccess::is_archived_Set() const{
    return m_archived_isSet;
}

bool OAIProjectWithAccess::is_archived_Valid() const{
    return m_archived_isValid;
}

QString OAIProjectWithAccess::getAvatarUrl() const {
    return m_avatar_url;
}
void OAIProjectWithAccess::setAvatarUrl(const QString &avatar_url) {
    m_avatar_url = avatar_url;
    m_avatar_url_isSet = true;
}

bool OAIProjectWithAccess::is_avatar_url_Set() const{
    return m_avatar_url_isSet;
}

bool OAIProjectWithAccess::is_avatar_url_Valid() const{
    return m_avatar_url_isValid;
}

QString OAIProjectWithAccess::getBuildsEnabled() const {
    return m_builds_enabled;
}
void OAIProjectWithAccess::setBuildsEnabled(const QString &builds_enabled) {
    m_builds_enabled = builds_enabled;
    m_builds_enabled_isSet = true;
}

bool OAIProjectWithAccess::is_builds_enabled_Set() const{
    return m_builds_enabled_isSet;
}

bool OAIProjectWithAccess::is_builds_enabled_Valid() const{
    return m_builds_enabled_isValid;
}

QString OAIProjectWithAccess::getContainerRegistryEnabled() const {
    return m_container_registry_enabled;
}
void OAIProjectWithAccess::setContainerRegistryEnabled(const QString &container_registry_enabled) {
    m_container_registry_enabled = container_registry_enabled;
    m_container_registry_enabled_isSet = true;
}

bool OAIProjectWithAccess::is_container_registry_enabled_Set() const{
    return m_container_registry_enabled_isSet;
}

bool OAIProjectWithAccess::is_container_registry_enabled_Valid() const{
    return m_container_registry_enabled_isValid;
}

QString OAIProjectWithAccess::getCreatedAt() const {
    return m_created_at;
}
void OAIProjectWithAccess::setCreatedAt(const QString &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIProjectWithAccess::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIProjectWithAccess::is_created_at_Valid() const{
    return m_created_at_isValid;
}

QString OAIProjectWithAccess::getCreatorId() const {
    return m_creator_id;
}
void OAIProjectWithAccess::setCreatorId(const QString &creator_id) {
    m_creator_id = creator_id;
    m_creator_id_isSet = true;
}

bool OAIProjectWithAccess::is_creator_id_Set() const{
    return m_creator_id_isSet;
}

bool OAIProjectWithAccess::is_creator_id_Valid() const{
    return m_creator_id_isValid;
}

QString OAIProjectWithAccess::getDefaultBranch() const {
    return m_default_branch;
}
void OAIProjectWithAccess::setDefaultBranch(const QString &default_branch) {
    m_default_branch = default_branch;
    m_default_branch_isSet = true;
}

bool OAIProjectWithAccess::is_default_branch_Set() const{
    return m_default_branch_isSet;
}

bool OAIProjectWithAccess::is_default_branch_Valid() const{
    return m_default_branch_isValid;
}

QString OAIProjectWithAccess::getDescription() const {
    return m_description;
}
void OAIProjectWithAccess::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIProjectWithAccess::is_description_Set() const{
    return m_description_isSet;
}

bool OAIProjectWithAccess::is_description_Valid() const{
    return m_description_isValid;
}

OAIBasicProjectDetails OAIProjectWithAccess::getForkedFromProject() const {
    return m_forked_from_project;
}
void OAIProjectWithAccess::setForkedFromProject(const OAIBasicProjectDetails &forked_from_project) {
    m_forked_from_project = forked_from_project;
    m_forked_from_project_isSet = true;
}

bool OAIProjectWithAccess::is_forked_from_project_Set() const{
    return m_forked_from_project_isSet;
}

bool OAIProjectWithAccess::is_forked_from_project_Valid() const{
    return m_forked_from_project_isValid;
}

QString OAIProjectWithAccess::getForksCount() const {
    return m_forks_count;
}
void OAIProjectWithAccess::setForksCount(const QString &forks_count) {
    m_forks_count = forks_count;
    m_forks_count_isSet = true;
}

bool OAIProjectWithAccess::is_forks_count_Set() const{
    return m_forks_count_isSet;
}

bool OAIProjectWithAccess::is_forks_count_Valid() const{
    return m_forks_count_isValid;
}

QString OAIProjectWithAccess::getHttpUrlToRepo() const {
    return m_http_url_to_repo;
}
void OAIProjectWithAccess::setHttpUrlToRepo(const QString &http_url_to_repo) {
    m_http_url_to_repo = http_url_to_repo;
    m_http_url_to_repo_isSet = true;
}

bool OAIProjectWithAccess::is_http_url_to_repo_Set() const{
    return m_http_url_to_repo_isSet;
}

bool OAIProjectWithAccess::is_http_url_to_repo_Valid() const{
    return m_http_url_to_repo_isValid;
}

QString OAIProjectWithAccess::getId() const {
    return m_id;
}
void OAIProjectWithAccess::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIProjectWithAccess::is_id_Set() const{
    return m_id_isSet;
}

bool OAIProjectWithAccess::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIProjectWithAccess::getIssuesEnabled() const {
    return m_issues_enabled;
}
void OAIProjectWithAccess::setIssuesEnabled(const QString &issues_enabled) {
    m_issues_enabled = issues_enabled;
    m_issues_enabled_isSet = true;
}

bool OAIProjectWithAccess::is_issues_enabled_Set() const{
    return m_issues_enabled_isSet;
}

bool OAIProjectWithAccess::is_issues_enabled_Valid() const{
    return m_issues_enabled_isValid;
}

QString OAIProjectWithAccess::getLastActivityAt() const {
    return m_last_activity_at;
}
void OAIProjectWithAccess::setLastActivityAt(const QString &last_activity_at) {
    m_last_activity_at = last_activity_at;
    m_last_activity_at_isSet = true;
}

bool OAIProjectWithAccess::is_last_activity_at_Set() const{
    return m_last_activity_at_isSet;
}

bool OAIProjectWithAccess::is_last_activity_at_Valid() const{
    return m_last_activity_at_isValid;
}

QString OAIProjectWithAccess::getLfsEnabled() const {
    return m_lfs_enabled;
}
void OAIProjectWithAccess::setLfsEnabled(const QString &lfs_enabled) {
    m_lfs_enabled = lfs_enabled;
    m_lfs_enabled_isSet = true;
}

bool OAIProjectWithAccess::is_lfs_enabled_Set() const{
    return m_lfs_enabled_isSet;
}

bool OAIProjectWithAccess::is_lfs_enabled_Valid() const{
    return m_lfs_enabled_isValid;
}

QString OAIProjectWithAccess::getMergeRequestsEnabled() const {
    return m_merge_requests_enabled;
}
void OAIProjectWithAccess::setMergeRequestsEnabled(const QString &merge_requests_enabled) {
    m_merge_requests_enabled = merge_requests_enabled;
    m_merge_requests_enabled_isSet = true;
}

bool OAIProjectWithAccess::is_merge_requests_enabled_Set() const{
    return m_merge_requests_enabled_isSet;
}

bool OAIProjectWithAccess::is_merge_requests_enabled_Valid() const{
    return m_merge_requests_enabled_isValid;
}

QString OAIProjectWithAccess::getName() const {
    return m_name;
}
void OAIProjectWithAccess::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIProjectWithAccess::is_name_Set() const{
    return m_name_isSet;
}

bool OAIProjectWithAccess::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIProjectWithAccess::getNameWithNamespace() const {
    return m_name_with_namespace;
}
void OAIProjectWithAccess::setNameWithNamespace(const QString &name_with_namespace) {
    m_name_with_namespace = name_with_namespace;
    m_name_with_namespace_isSet = true;
}

bool OAIProjectWithAccess::is_name_with_namespace_Set() const{
    return m_name_with_namespace_isSet;
}

bool OAIProjectWithAccess::is_name_with_namespace_Valid() const{
    return m_name_with_namespace_isValid;
}

OAINamespace OAIProjectWithAccess::getRNamespace() const {
    return m_r_namespace;
}
void OAIProjectWithAccess::setRNamespace(const OAINamespace &r_namespace) {
    m_r_namespace = r_namespace;
    m_r_namespace_isSet = true;
}

bool OAIProjectWithAccess::is_r_namespace_Set() const{
    return m_r_namespace_isSet;
}

bool OAIProjectWithAccess::is_r_namespace_Valid() const{
    return m_r_namespace_isValid;
}

QString OAIProjectWithAccess::getOnlyAllowMergeIfAllDiscussionsAreResolved() const {
    return m_only_allow_merge_if_all_discussions_are_resolved;
}
void OAIProjectWithAccess::setOnlyAllowMergeIfAllDiscussionsAreResolved(const QString &only_allow_merge_if_all_discussions_are_resolved) {
...
bool OAIProjectWithAccess::is_only_allow_merge_if_all_discussions_are_resolved_Set() const{
    return m_only_allow_merge_if_all_discussions_are_resolved_isSet;
}

bool OAIProjectWithAccess::is_only_allow_merge_if_all_discussions_are_resolved_Valid() const{
    return m_only_allow_merge_if_all_discussions_are_resolved_isValid;
}

QString OAIProjectWithAccess::getOnlyAllowMergeIfBuildSucceeds() const {
    return m_only_allow_merge_if_build_succeeds;
}
void OAIProjectWithAccess::setOnlyAllowMergeIfBuildSucceeds(const QString &only_allow_merge_if_build_succeeds) {
    m_only_allow_merge_if_build_succeeds = only_allow_merge_if_build_succeeds;
    m_only_allow_merge_if_build_succeeds_isSet = true;
}

bool OAIProjectWithAccess::is_only_allow_merge_if_build_succeeds_Set() const{
    return m_only_allow_merge_if_build_succeeds_isSet;
}

bool OAIProjectWithAccess::is_only_allow_merge_if_build_succeeds_Valid() const{
    return m_only_allow_merge_if_build_succeeds_isValid;
}

QString OAIProjectWithAccess::getOpenIssuesCount() const {
    return m_open_issues_count;
}
void OAIProjectWithAccess::setOpenIssuesCount(const QString &open_issues_count) {
    m_open_issues_count = open_issues_count;
    m_open_issues_count_isSet = true;
}

bool OAIProjectWithAccess::is_open_issues_count_Set() const{
    return m_open_issues_count_isSet;
}

bool OAIProjectWithAccess::is_open_issues_count_Valid() const{
    return m_open_issues_count_isValid;
}

OAIUserBasic OAIProjectWithAccess::getOwner() const {
    return m_owner;
}
void OAIProjectWithAccess::setOwner(const OAIUserBasic &owner) {
    m_owner = owner;
    m_owner_isSet = true;
}

bool OAIProjectWithAccess::is_owner_Set() const{
    return m_owner_isSet;
}

bool OAIProjectWithAccess::is_owner_Valid() const{
    return m_owner_isValid;
}

QString OAIProjectWithAccess::getPath() const {
    return m_path;
}
void OAIProjectWithAccess::setPath(const QString &path) {
    m_path = path;
    m_path_isSet = true;
}

bool OAIProjectWithAccess::is_path_Set() const{
    return m_path_isSet;
}

bool OAIProjectWithAccess::is_path_Valid() const{
    return m_path_isValid;
}

QString OAIProjectWithAccess::getPathWithNamespace() const {
    return m_path_with_namespace;
}
void OAIProjectWithAccess::setPathWithNamespace(const QString &path_with_namespace) {
    m_path_with_namespace = path_with_namespace;
    m_path_with_namespace_isSet = true;
}

bool OAIProjectWithAccess::is_path_with_namespace_Set() const{
    return m_path_with_namespace_isSet;
}

bool OAIProjectWithAccess::is_path_with_namespace_Valid() const{
    return m_path_with_namespace_isValid;
}

QString OAIProjectWithAccess::getPermissions() const {
    return m_permissions;
}
void OAIProjectWithAccess::setPermissions(const QString &permissions) {
    m_permissions = permissions;
    m_permissions_isSet = true;
}

bool OAIProjectWithAccess::is_permissions_Set() const{
    return m_permissions_isSet;
}

bool OAIProjectWithAccess::is_permissions_Valid() const{
    return m_permissions_isValid;
}

QString OAIProjectWithAccess::getRPublic() const {
    return m_r_public;
}
void OAIProjectWithAccess::setRPublic(const QString &r_public) {
    m_r_public = r_public;
    m_r_public_isSet = true;
}

bool OAIProjectWithAccess::is_r_public_Set() const{
    return m_r_public_isSet;
}

bool OAIProjectWithAccess::is_r_public_Valid() const{
    return m_r_public_isValid;
}

QString OAIProjectWithAccess::getPublicBuilds() const {
    return m_public_builds;
}
void OAIProjectWithAccess::setPublicBuilds(const QString &public_builds) {
    m_public_builds = public_builds;
    m_public_builds_isSet = true;
}

bool OAIProjectWithAccess::is_public_builds_Set() const{
    return m_public_builds_isSet;
}

bool OAIProjectWithAccess::is_public_builds_Valid() const{
    return m_public_builds_isValid;
}

QString OAIProjectWithAccess::getRequestAccessEnabled() const {
    return m_request_access_enabled;
}
void OAIProjectWithAccess::setRequestAccessEnabled(const QString &request_access_enabled) {
    m_request_access_enabled = request_access_enabled;
    m_request_access_enabled_isSet = true;
}

bool OAIProjectWithAccess::is_request_access_enabled_Set() const{
    return m_request_access_enabled_isSet;
}

bool OAIProjectWithAccess::is_request_access_enabled_Valid() const{
    return m_request_access_enabled_isValid;
}

QString OAIProjectWithAccess::getRunnersToken() const {
    return m_runners_token;
}
void OAIProjectWithAccess::setRunnersToken(const QString &runners_token) {
    m_runners_token = runners_token;
    m_runners_token_isSet = true;
}

bool OAIProjectWithAccess::is_runners_token_Set() const{
    return m_runners_token_isSet;
}

bool OAIProjectWithAccess::is_runners_token_Valid() const{
    return m_runners_token_isValid;
}

QString OAIProjectWithAccess::getSharedRunnersEnabled() const {
    return m_shared_runners_enabled;
}
void OAIProjectWithAccess::setSharedRunnersEnabled(const QString &shared_runners_enabled) {
    m_shared_runners_enabled = shared_runners_enabled;
    m_shared_runners_enabled_isSet = true;
}

bool OAIProjectWithAccess::is_shared_runners_enabled_Set() const{
    return m_shared_runners_enabled_isSet;
}

bool OAIProjectWithAccess::is_shared_runners_enabled_Valid() const{
    return m_shared_runners_enabled_isValid;
}

QString OAIProjectWithAccess::getSharedWithGroups() const {
    return m_shared_with_groups;
}
void OAIProjectWithAccess::setSharedWithGroups(const QString &shared_with_groups) {
    m_shared_with_groups = shared_with_groups;
    m_shared_with_groups_isSet = true;
}

bool OAIProjectWithAccess::is_shared_with_groups_Set() const{
    return m_shared_with_groups_isSet;
}

bool OAIProjectWithAccess::is_shared_with_groups_Valid() const{
    return m_shared_with_groups_isValid;
}

QString OAIProjectWithAccess::getSnippetsEnabled() const {
    return m_snippets_enabled;
}
void OAIProjectWithAccess::setSnippetsEnabled(const QString &snippets_enabled) {
    m_snippets_enabled = snippets_enabled;
    m_snippets_enabled_isSet = true;
}

bool OAIProjectWithAccess::is_snippets_enabled_Set() const{
    return m_snippets_enabled_isSet;
}

bool OAIProjectWithAccess::is_snippets_enabled_Valid() const{
    return m_snippets_enabled_isValid;
}

QString OAIProjectWithAccess::getSshUrlToRepo() const {
    return m_ssh_url_to_repo;
}
void OAIProjectWithAccess::setSshUrlToRepo(const QString &ssh_url_to_repo) {
    m_ssh_url_to_repo = ssh_url_to_repo;
    m_ssh_url_to_repo_isSet = true;
}

bool OAIProjectWithAccess::is_ssh_url_to_repo_Set() const{
    return m_ssh_url_to_repo_isSet;
}

bool OAIProjectWithAccess::is_ssh_url_to_repo_Valid() const{
    return m_ssh_url_to_repo_isValid;
}

QString OAIProjectWithAccess::getStarCount() const {
    return m_star_count;
}
void OAIProjectWithAccess::setStarCount(const QString &star_count) {
    m_star_count = star_count;
    m_star_count_isSet = true;
}

bool OAIProjectWithAccess::is_star_count_Set() const{
    return m_star_count_isSet;
}

bool OAIProjectWithAccess::is_star_count_Valid() const{
    return m_star_count_isValid;
}

OAIProjectStatistics OAIProjectWithAccess::getStatistics() const {
    return m_statistics;
}
void OAIProjectWithAccess::setStatistics(const OAIProjectStatistics &statistics) {
    m_statistics = statistics;
    m_statistics_isSet = true;
}

bool OAIProjectWithAccess::is_statistics_Set() const{
    return m_statistics_isSet;
}

bool OAIProjectWithAccess::is_statistics_Valid() const{
    return m_statistics_isValid;
}

QString OAIProjectWithAccess::getTagList() const {
    return m_tag_list;
}
void OAIProjectWithAccess::setTagList(const QString &tag_list) {
    m_tag_list = tag_list;
    m_tag_list_isSet = true;
}

bool OAIProjectWithAccess::is_tag_list_Set() const{
    return m_tag_list_isSet;
}

bool OAIProjectWithAccess::is_tag_list_Valid() const{
    return m_tag_list_isValid;
}

QString OAIProjectWithAccess::getVisibilityLevel() const {
    return m_visibility_level;
}
void OAIProjectWithAccess::setVisibilityLevel(const QString &visibility_level) {
    m_visibility_level = visibility_level;
    m_visibility_level_isSet = true;
}

bool OAIProjectWithAccess::is_visibility_level_Set() const{
    return m_visibility_level_isSet;
}

bool OAIProjectWithAccess::is_visibility_level_Valid() const{
    return m_visibility_level_isValid;
}

QString OAIProjectWithAccess::getWebUrl() const {
    return m_web_url;
}
void OAIProjectWithAccess::setWebUrl(const QString &web_url) {
    m_web_url = web_url;
    m_web_url_isSet = true;
}

bool OAIProjectWithAccess::is_web_url_Set() const{
    return m_web_url_isSet;
}

bool OAIProjectWithAccess::is_web_url_Valid() const{
    return m_web_url_isValid;
}

QString OAIProjectWithAccess::getWikiEnabled() const {
    return m_wiki_enabled;
}
void OAIProjectWithAccess::setWikiEnabled(const QString &wiki_enabled) {
    m_wiki_enabled = wiki_enabled;
    m_wiki_enabled_isSet = true;
}

bool OAIProjectWithAccess::is_wiki_enabled_Set() const{
    return m_wiki_enabled_isSet;
}

bool OAIProjectWithAccess::is_wiki_enabled_Valid() const{
    return m_wiki_enabled_isValid;
}

bool OAIProjectWithAccess::isSet() const {
...
bool OAIProjectWithAccess::isValid() const {
