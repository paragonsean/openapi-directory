...
#ifndef OAIProjectHook_H
#define OAIProjectHook_H
...
class OAIProjectHook : public OAIObject {
public:
    OAIProjectHook();
    OAIProjectHook(QString json);
    ~OAIProjectHook() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProjectHook)

#endif // OAIProjectHook_H
