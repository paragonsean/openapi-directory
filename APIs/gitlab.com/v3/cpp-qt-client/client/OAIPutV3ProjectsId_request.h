...
/*
 * OAIPutV3ProjectsId_request.h
 *
 * 
 */

#ifndef OAIPutV3ProjectsId_request_H
#define OAIPutV3ProjectsId_request_H
...
class OAIPutV3ProjectsId_request : public OAIObject {
public:
    OAIPutV3ProjectsId_request();
    OAIPutV3ProjectsId_request(QString json);
    ~OAIPutV3ProjectsId_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutV3ProjectsId_request)

#endif // OAIPutV3ProjectsId_request_H
