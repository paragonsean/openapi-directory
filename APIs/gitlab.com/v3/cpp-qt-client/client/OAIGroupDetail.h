...
#ifndef OAIGroupDetail_H
#define OAIGroupDetail_H
...
class OAIGroupDetail : public OAIObject {
public:
    OAIGroupDetail();
    OAIGroupDetail(QString json);
    ~OAIGroupDetail() override;
    ...
    OAIProject getProjects() const;
    void setProjects(const OAIProject &projects);
    ...
    OAIProject getSharedProjects() const;
    void setSharedProjects(const OAIProject &shared_projects);
    bool is_shared_projects_Set() const;
    bool is_shared_projects_Valid() const;
...
private:
    ...
    OAIProject m_shared_projects;
    bool m_shared_projects_isSet;
    bool m_shared_projects_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGroupDetail)

#endif // OAIGroupDetail_H
