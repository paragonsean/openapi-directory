...
/*
 * OAIPutV3GroupsIdNotificationSettings_request.h
 *
 * 
 */

#ifndef OAIPutV3GroupsIdNotificationSettings_request_H
#define OAIPutV3GroupsIdNotificationSettings_request_H
...
class OAIPutV3GroupsIdNotificationSettings_request : public OAIObject {
public:
    OAIPutV3GroupsIdNotificationSettings_request();
    OAIPutV3GroupsIdNotificationSettings_request(QString json);
    ~OAIPutV3GroupsIdNotificationSettings_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutV3GroupsIdNotificationSettings_request)

#endif // OAIPutV3GroupsIdNotificationSettings_request_H
