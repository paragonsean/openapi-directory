...
public class WatchlistScreeningIndividualCreateResponse {
  ...
  public WatchlistScreeningIndividualCreateResponse() {
  }
   ...
   * @return the WatchlistScreeningIndividualCreateResponse instance itself
   */
  public WatchlistScreeningIndividualCreateResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.assignee, watchlistScreeningIndividualCreateResponse.assignee) &&
        ...
        Objects.equals(this.id, watchlistScreeningIndividualCreateResponse.id) &&
        ...
        Objects.equals(this.additionalProperties, watchlistScreeningIndividualCreateResponse.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to WatchlistScreeningIndividualCreateResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WatchlistScreeningIndividualCreateResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WatchlistScreeningIndividualCreateResponse is not found in the empty JSON string", WatchlistScreeningIndividualCreateResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WatchlistScreeningIndividualCreateResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WatchlistScreeningIndividualCreateResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WatchlistScreeningIndividualCreateResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WatchlistScreeningIndividualCreateResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WatchlistScreeningIndividualCreateResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<WatchlistScreeningIndividualCreateResponse>() {
           @Override
           public void write(JsonWriter out, WatchlistScreeningIndividualCreateResponse value) throws IOException {
           ...
           @Override
           public WatchlistScreeningIndividualCreateResponse read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             WatchlistScreeningIndividualCreateResponse instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of WatchlistScreeningIndividualCreateResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of WatchlistScreeningIndividualCreateResponse
   * @throws IOException if the JSON string is invalid with respect to WatchlistScreeningIndividualCreateResponse
   */
  public static WatchlistScreeningIndividualCreateResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WatchlistScreeningIndividualCreateResponse.class);
  }

  /**
   * Convert an instance of WatchlistScreeningIndividualCreateResponse to an JSON string
   *
   * @return JSON string
   */
