...
public class WatchlistScreeningReview {
  ...
  public WatchlistScreeningReview() {
  }
   ...
   * @return the WatchlistScreeningReview instance itself
   */
  public WatchlistScreeningReview putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.auditTrail, watchlistScreeningReview.auditTrail) &&
        ...
        Objects.equals(this.id, watchlistScreeningReview.id)&&
        Objects.equals(this.additionalProperties, watchlistScreeningReview.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(auditTrail, comment, confirmedHits, dismissedHits, id, additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to WatchlistScreeningReview
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WatchlistScreeningReview.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WatchlistScreeningReview is not found in the empty JSON string", WatchlistScreeningReview.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WatchlistScreeningReview.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WatchlistScreeningReview.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WatchlistScreeningReview' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WatchlistScreeningReview> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WatchlistScreeningReview.class));

       return (TypeAdapter<T>) new TypeAdapter<WatchlistScreeningReview>() {
           @Override
           public void write(JsonWriter out, WatchlistScreeningReview value) throws IOException {
           ...
           @Override
           public WatchlistScreeningReview read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             WatchlistScreeningReview instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of WatchlistScreeningReview given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of WatchlistScreeningReview
   * @throws IOException if the JSON string is invalid with respect to WatchlistScreeningReview
   */
  public static WatchlistScreeningReview fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WatchlistScreeningReview.class);
  }

  /**
   * Convert an instance of WatchlistScreeningReview to an JSON string
   *
   * @return JSON string
   */
