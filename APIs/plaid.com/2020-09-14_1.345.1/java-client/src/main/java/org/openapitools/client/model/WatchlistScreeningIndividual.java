...
public class WatchlistScreeningIndividual {
  ...
  public WatchlistScreeningIndividual() {
  }
   ...
   * @return the WatchlistScreeningIndividual instance itself
   */
  public WatchlistScreeningIndividual putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.assignee, watchlistScreeningIndividual.assignee) &&
        ...
        Objects.equals(this.id, watchlistScreeningIndividual.id) &&
        ...
        Objects.equals(this.additionalProperties, watchlistScreeningIndividual.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(assignee, auditTrail, clientUserId, id, searchTerms, status, additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to WatchlistScreeningIndividual
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WatchlistScreeningIndividual.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WatchlistScreeningIndividual is not found in the empty JSON string", WatchlistScreeningIndividual.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WatchlistScreeningIndividual.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WatchlistScreeningIndividual.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WatchlistScreeningIndividual' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WatchlistScreeningIndividual> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WatchlistScreeningIndividual.class));

       return (TypeAdapter<T>) new TypeAdapter<WatchlistScreeningIndividual>() {
           @Override
           public void write(JsonWriter out, WatchlistScreeningIndividual value) throws IOException {
           ...
           @Override
           public WatchlistScreeningIndividual read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             WatchlistScreeningIndividual instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of WatchlistScreeningIndividual given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of WatchlistScreeningIndividual
   * @throws IOException if the JSON string is invalid with respect to WatchlistScreeningIndividual
   */
  public static WatchlistScreeningIndividual fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WatchlistScreeningIndividual.class);
  }

  /**
   * Convert an instance of WatchlistScreeningIndividual to an JSON string
   *
   * @return JSON string
   */
