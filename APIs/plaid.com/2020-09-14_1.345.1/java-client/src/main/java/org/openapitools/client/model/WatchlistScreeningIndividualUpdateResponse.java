...
public class WatchlistScreeningIndividualUpdateResponse {
  ...
  public WatchlistScreeningIndividualUpdateResponse() {
  }
   ...
   * @return the WatchlistScreeningIndividualUpdateResponse instance itself
   */
  public WatchlistScreeningIndividualUpdateResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.assignee, watchlistScreeningIndividualUpdateResponse.assignee) &&
        ...
        Objects.equals(this.id, watchlistScreeningIndividualUpdateResponse.id) &&
        ...
        Objects.equals(this.additionalProperties, watchlistScreeningIndividualUpdateResponse.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to WatchlistScreeningIndividualUpdateResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WatchlistScreeningIndividualUpdateResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WatchlistScreeningIndividualUpdateResponse is not found in the empty JSON string", WatchlistScreeningIndividualUpdateResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WatchlistScreeningIndividualUpdateResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WatchlistScreeningIndividualUpdateResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WatchlistScreeningIndividualUpdateResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WatchlistScreeningIndividualUpdateResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WatchlistScreeningIndividualUpdateResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<WatchlistScreeningIndividualUpdateResponse>() {
           @Override
           public void write(JsonWriter out, WatchlistScreeningIndividualUpdateResponse value) throws IOException {
           ...
           @Override
           public WatchlistScreeningIndividualUpdateResponse read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             WatchlistScreeningIndividualUpdateResponse instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of WatchlistScreeningIndividualUpdateResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of WatchlistScreeningIndividualUpdateResponse
   * @throws IOException if the JSON string is invalid with respect to WatchlistScreeningIndividualUpdateResponse
   */
  public static WatchlistScreeningIndividualUpdateResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WatchlistScreeningIndividualUpdateResponse.class);
  }

  /**
   * Convert an instance of WatchlistScreeningIndividualUpdateResponse to an JSON string
   *
   * @return JSON string
   */
