...
/*
 * OAICreditPayStubNetPay.h
 *
 * An object representing information about the net pay amount on the pay stub.
 */

#ifndef OAICreditPayStubNetPay_H
#define OAICreditPayStubNetPay_H
...
class OAICreditPayStubNetPay : public OAIObject {
public:
    OAICreditPayStubNetPay();
    OAICreditPayStubNetPay(QString json);
    ~OAICreditPayStubNetPay() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreditPayStubNetPay)

#endif // OAICreditPayStubNetPay_H
