...
/*
 * OAIPartnerEndCustomerBillingContact.h
 *
 * The billing contact for the end customer. Defaults to partner&#39;s billing contact if omitted.
 */

#ifndef OAIPartnerEndCustomerBillingContact_H
#define OAIPartnerEndCustomerBillingContact_H
...
class OAIPartnerEndCustomerBillingContact : public OAIObject {
public:
    OAIPartnerEndCustomerBillingContact();
    OAIPartnerEndCustomerBillingContact(QString json);
    ~OAIPartnerEndCustomerBillingContact() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPartnerEndCustomerBillingContact)

#endif // OAIPartnerEndCustomerBillingContact_H
