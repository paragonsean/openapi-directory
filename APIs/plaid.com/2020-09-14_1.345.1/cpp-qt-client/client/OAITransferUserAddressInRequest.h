...
/*
 * OAITransferUserAddressInRequest.h
 *
...
#ifndef OAITransferUserAddressInRequest_H
#define OAITransferUserAddressInRequest_H
...
class OAITransferUserAddressInRequest : public OAIObject {
public:
    OAITransferUserAddressInRequest();
    OAITransferUserAddressInRequest(QString json);
    ~OAITransferUserAddressInRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransferUserAddressInRequest)

#endif // OAITransferUserAddressInRequest_H
