...
/*
 * OAIItemProductReadyWebhook.h
 *
 * Fired once Plaid calculates income from an Item.
 */

#ifndef OAIItemProductReadyWebhook_H
#define OAIItemProductReadyWebhook_H
...
class OAIItemProductReadyWebhook : public OAIObject {
public:
    OAIItemProductReadyWebhook();
    OAIItemProductReadyWebhook(QString json);
    ~OAIItemProductReadyWebhook() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIItemProductReadyWebhook)

#endif // OAIItemProductReadyWebhook_H
