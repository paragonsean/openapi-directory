...
/*
 * OAIPayStubDeductionsTotal.h
 *
 * An object representing the total deductions for the pay period
 */

#ifndef OAIPayStubDeductionsTotal_H
#define OAIPayStubDeductionsTotal_H
...
class OAIPayStubDeductionsTotal : public OAIObject {
public:
    OAIPayStubDeductionsTotal();
    OAIPayStubDeductionsTotal(QString json);
    ~OAIPayStubDeductionsTotal() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPayStubDeductionsTotal)

#endif // OAIPayStubDeductionsTotal_H
