...
/*
 * OAITransferCancelRequest.h
 *
 * Defines the request schema for &#x60;/transfer/cancel&#x60;
 */

#ifndef OAITransferCancelRequest_H
#define OAITransferCancelRequest_H
...
class OAITransferCancelRequest : public OAIObject {
public:
    OAITransferCancelRequest();
    OAITransferCancelRequest(QString json);
    ~OAITransferCancelRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransferCancelRequest)

#endif // OAITransferCancelRequest_H
