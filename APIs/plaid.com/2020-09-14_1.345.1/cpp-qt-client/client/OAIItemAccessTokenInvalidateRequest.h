...
/*
 * OAIItemAccessTokenInvalidateRequest.h
 *
 * ItemAccessTokenInvalidateRequest defines the request schema for &#x60;/item/access_token/invalidate&#x60;
 */

#ifndef OAIItemAccessTokenInvalidateRequest_H
#define OAIItemAccessTokenInvalidateRequest_H
...
class OAIItemAccessTokenInvalidateRequest : public OAIObject {
public:
    OAIItemAccessTokenInvalidateRequest();
    OAIItemAccessTokenInvalidateRequest(QString json);
    ~OAIItemAccessTokenInvalidateRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIItemAccessTokenInvalidateRequest)

#endif // OAIItemAccessTokenInvalidateRequest_H
