...
#ifndef OAIItemErrorWebhook_H
#define OAIItemErrorWebhook_H
...
class OAIItemErrorWebhook : public OAIObject {
public:
    OAIItemErrorWebhook();
    OAIItemErrorWebhook(QString json);
    ~OAIItemErrorWebhook() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIItemErrorWebhook)

#endif // OAIItemErrorWebhook_H
