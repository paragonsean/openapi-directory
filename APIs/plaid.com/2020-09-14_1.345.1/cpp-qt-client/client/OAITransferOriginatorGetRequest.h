...
/*
 * OAITransferOriginatorGetRequest.h
 *
 * Defines the request schema for &#x60;/transfer/originator/get&#x60;
 */

#ifndef OAITransferOriginatorGetRequest_H
#define OAITransferOriginatorGetRequest_H
...
class OAITransferOriginatorGetRequest : public OAIObject {
public:
    OAITransferOriginatorGetRequest();
    OAITransferOriginatorGetRequest(QString json);
    ~OAITransferOriginatorGetRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransferOriginatorGetRequest)

#endif // OAITransferOriginatorGetRequest_H
