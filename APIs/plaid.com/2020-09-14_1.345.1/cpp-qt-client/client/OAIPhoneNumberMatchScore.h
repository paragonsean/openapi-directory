...
#ifndef OAIPhoneNumberMatchScore_H
#define OAIPhoneNumberMatchScore_H
...
class OAIPhoneNumberMatchScore : public OAIObject {
public:
    OAIPhoneNumberMatchScore();
    OAIPhoneNumberMatchScore(QString json);
    ~OAIPhoneNumberMatchScore() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPhoneNumberMatchScore)

#endif // OAIPhoneNumberMatchScore_H
