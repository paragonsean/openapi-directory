...
#ifndef OAITransferDevice_H
#define OAITransferDevice_H
...
class OAITransferDevice : public OAIObject {
public:
    OAITransferDevice();
    OAITransferDevice(QString json);
    ~OAITransferDevice() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransferDevice)

#endif // OAITransferDevice_H
