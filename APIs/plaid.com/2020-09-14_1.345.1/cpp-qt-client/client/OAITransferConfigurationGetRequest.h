...
/*
 * OAITransferConfigurationGetRequest.h
 *
 * Defines the request schema for &#x60;/transfer/configuration/get&#x60;
 */

#ifndef OAITransferConfigurationGetRequest_H
#define OAITransferConfigurationGetRequest_H
...
class OAITransferConfigurationGetRequest : public OAIObject {
public:
    OAITransferConfigurationGetRequest();
    OAITransferConfigurationGetRequest(QString json);
    ~OAITransferConfigurationGetRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransferConfigurationGetRequest)

#endif // OAITransferConfigurationGetRequest_H
