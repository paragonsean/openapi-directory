...
/*
 * OAIWalletTransactionListRequest.h
 *
 * WalletTransactionListRequest defines the request schema for &#x60;/wallet/transaction/list&#x60;
 */

#ifndef OAIWalletTransactionListRequest_H
#define OAIWalletTransactionListRequest_H
...
class OAIWalletTransactionListRequest : public OAIObject {
public:
    OAIWalletTransactionListRequest();
    OAIWalletTransactionListRequest(QString json);
    ~OAIWalletTransactionListRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWalletTransactionListRequest)

#endif // OAIWalletTransactionListRequest_H
