...
/*
 * OAITransferGetRequest.h
 *
 * Defines the request schema for &#x60;/transfer/get&#x60;
 */

#ifndef OAITransferGetRequest_H
#define OAITransferGetRequest_H
...
class OAITransferGetRequest : public OAIObject {
public:
    OAITransferGetRequest();
    OAITransferGetRequest(QString json);
    ~OAITransferGetRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransferGetRequest)

#endif // OAITransferGetRequest_H
