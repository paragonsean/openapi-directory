...
/*
 * OAIIdentityVerificationRetriedWebhook.h
 *
 * Fired when identity verification has been retried, which can be triggered via the dashboard or the API.
 */

#ifndef OAIIdentityVerificationRetriedWebhook_H
#define OAIIdentityVerificationRetriedWebhook_H
...
class OAIIdentityVerificationRetriedWebhook : public OAIObject {
public:
    OAIIdentityVerificationRetriedWebhook();
    OAIIdentityVerificationRetriedWebhook(QString json);
    ~OAIIdentityVerificationRetriedWebhook() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIdentityVerificationRetriedWebhook)

#endif // OAIIdentityVerificationRetriedWebhook_H
