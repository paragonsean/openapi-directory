...
/*
 * OAIProcessorTokenCreateRequest.h
 *
 * ProcessorTokenCreateRequest defines the request schema for &#x60;/processor/token/create&#x60;
 */

#ifndef OAIProcessorTokenCreateRequest_H
#define OAIProcessorTokenCreateRequest_H
...
class OAIProcessorTokenCreateRequest : public OAIObject {
public:
    OAIProcessorTokenCreateRequest();
    OAIProcessorTokenCreateRequest(QString json);
    ~OAIProcessorTokenCreateRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProcessorTokenCreateRequest)

#endif // OAIProcessorTokenCreateRequest_H
