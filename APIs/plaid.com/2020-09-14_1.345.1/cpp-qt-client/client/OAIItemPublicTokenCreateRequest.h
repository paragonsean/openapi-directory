...
/*
 * OAIItemPublicTokenCreateRequest.h
 *
 * ItemPublicTokenCreateRequest defines the request schema for &#x60;/item/public_token/create&#x60;
 */

#ifndef OAIItemPublicTokenCreateRequest_H
#define OAIItemPublicTokenCreateRequest_H
...
class OAIItemPublicTokenCreateRequest : public OAIObject {
public:
    OAIItemPublicTokenCreateRequest();
    OAIItemPublicTokenCreateRequest(QString json);
    ~OAIItemPublicTokenCreateRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIItemPublicTokenCreateRequest)

#endif // OAIItemPublicTokenCreateRequest_H
