...
/*
 * OAIItemApplicationListRequest.h
 *
 * Request to list connected applications for a user.
 */

#ifndef OAIItemApplicationListRequest_H
#define OAIItemApplicationListRequest_H
...
class OAIItemApplicationListRequest : public OAIObject {
public:
    OAIItemApplicationListRequest();
    OAIItemApplicationListRequest(QString json);
    ~OAIItemApplicationListRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIItemApplicationListRequest)

#endif // OAIItemApplicationListRequest_H
