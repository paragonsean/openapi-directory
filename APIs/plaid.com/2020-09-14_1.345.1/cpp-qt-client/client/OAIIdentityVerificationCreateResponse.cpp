...
OAIIdentityVerificationCreateResponse::OAIIdentityVerificationCreateResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIdentityVerificationCreateResponse::OAIIdentityVerificationCreateResponse() {
    this->initializeModel();
}

OAIIdentityVerificationCreateResponse::~OAIIdentityVerificationCreateResponse() {}

void OAIIdentityVerificationCreateResponse::initializeModel() {
...
void OAIIdentityVerificationCreateResponse::fromJson(QString jsonString) {
...
void OAIIdentityVerificationCreateResponse::fromJsonObject(QJsonObject json) {
...
QString OAIIdentityVerificationCreateResponse::asJson() const {
...
QJsonObject OAIIdentityVerificationCreateResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIIdentityVerificationCreateResponse::getClientUserId() const {
    return m_client_user_id;
}
void OAIIdentityVerificationCreateResponse::setClientUserId(const QString &client_user_id) {
    m_client_user_id = client_user_id;
    m_client_user_id_isSet = true;
}

bool OAIIdentityVerificationCreateResponse::is_client_user_id_Set() const{
    return m_client_user_id_isSet;
}

bool OAIIdentityVerificationCreateResponse::is_client_user_id_Valid() const{
    return m_client_user_id_isValid;
}

QDateTime OAIIdentityVerificationCreateResponse::getCompletedAt() const {
    return m_completed_at;
}
void OAIIdentityVerificationCreateResponse::setCompletedAt(const QDateTime &completed_at) {
    m_completed_at = completed_at;
    m_completed_at_isSet = true;
}

bool OAIIdentityVerificationCreateResponse::is_completed_at_Set() const{
    return m_completed_at_isSet;
}

bool OAIIdentityVerificationCreateResponse::is_completed_at_Valid() const{
    return m_completed_at_isValid;
}

QDateTime OAIIdentityVerificationCreateResponse::getCreatedAt() const {
    return m_created_at;
}
void OAIIdentityVerificationCreateResponse::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIIdentityVerificationCreateResponse::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIIdentityVerificationCreateResponse::is_created_at_Valid() const{
    return m_created_at_isValid;
}

OAIDocumentaryVerification OAIIdentityVerificationCreateResponse::getDocumentaryVerification() const {
    return m_documentary_verification;
}
void OAIIdentityVerificationCreateResponse::setDocumentaryVerification(const OAIDocumentaryVerification &documentary_verification) {
    m_documentary_verification = documentary_verification;
    m_documentary_verification_isSet = true;
}

bool OAIIdentityVerificationCreateResponse::is_documentary_verification_Set() const{
    return m_documentary_verification_isSet;
}

bool OAIIdentityVerificationCreateResponse::is_documentary_verification_Valid() const{
    return m_documentary_verification_isValid;
}

QString OAIIdentityVerificationCreateResponse::getId() const {
    return m_id;
}
void OAIIdentityVerificationCreateResponse::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIIdentityVerificationCreateResponse::is_id_Set() const{
    return m_id_isSet;
}

bool OAIIdentityVerificationCreateResponse::is_id_Valid() const{
    return m_id_isValid;
}

OAIKYCCheckDetails OAIIdentityVerificationCreateResponse::getKycCheck() const {
    return m_kyc_check;
}
void OAIIdentityVerificationCreateResponse::setKycCheck(const OAIKYCCheckDetails &kyc_check) {
    m_kyc_check = kyc_check;
    m_kyc_check_isSet = true;
}

bool OAIIdentityVerificationCreateResponse::is_kyc_check_Set() const{
    return m_kyc_check_isSet;
}

bool OAIIdentityVerificationCreateResponse::is_kyc_check_Valid() const{
    return m_kyc_check_isValid;
}

QString OAIIdentityVerificationCreateResponse::getPreviousAttemptId() const {
    return m_previous_attempt_id;
}
void OAIIdentityVerificationCreateResponse::setPreviousAttemptId(const QString &previous_attempt_id) {
    m_previous_attempt_id = previous_attempt_id;
    m_previous_attempt_id_isSet = true;
}

bool OAIIdentityVerificationCreateResponse::is_previous_attempt_id_Set() const{
    return m_previous_attempt_id_isSet;
}

bool OAIIdentityVerificationCreateResponse::is_previous_attempt_id_Valid() const{
    return m_previous_attempt_id_isValid;
}

QDateTime OAIIdentityVerificationCreateResponse::getRedactedAt() const {
    return m_redacted_at;
}
void OAIIdentityVerificationCreateResponse::setRedactedAt(const QDateTime &redacted_at) {
    m_redacted_at = redacted_at;
    m_redacted_at_isSet = true;
}

bool OAIIdentityVerificationCreateResponse::is_redacted_at_Set() const{
    return m_redacted_at_isSet;
}

bool OAIIdentityVerificationCreateResponse::is_redacted_at_Valid() const{
    return m_redacted_at_isValid;
}

QString OAIIdentityVerificationCreateResponse::getRequestId() const {
    return m_request_id;
}
void OAIIdentityVerificationCreateResponse::setRequestId(const QString &request_id) {
    m_request_id = request_id;
    m_request_id_isSet = true;
}

bool OAIIdentityVerificationCreateResponse::is_request_id_Set() const{
    return m_request_id_isSet;
}

bool OAIIdentityVerificationCreateResponse::is_request_id_Valid() const{
    return m_request_id_isValid;
}

OAIRiskCheckDetails OAIIdentityVerificationCreateResponse::getRiskCheck() const {
    return m_risk_check;
}
void OAIIdentityVerificationCreateResponse::setRiskCheck(const OAIRiskCheckDetails &risk_check) {
    m_risk_check = risk_check;
    m_risk_check_isSet = true;
}

bool OAIIdentityVerificationCreateResponse::is_risk_check_Set() const{
    return m_risk_check_isSet;
}

bool OAIIdentityVerificationCreateResponse::is_risk_check_Valid() const{
    return m_risk_check_isValid;
}

QString OAIIdentityVerificationCreateResponse::getShareableUrl() const {
    return m_shareable_url;
}
void OAIIdentityVerificationCreateResponse::setShareableUrl(const QString &shareable_url) {
    m_shareable_url = shareable_url;
    m_shareable_url_isSet = true;
}

bool OAIIdentityVerificationCreateResponse::is_shareable_url_Set() const{
    return m_shareable_url_isSet;
}

bool OAIIdentityVerificationCreateResponse::is_shareable_url_Valid() const{
    return m_shareable_url_isValid;
}

OAIIdentityVerificationStatus OAIIdentityVerificationCreateResponse::getStatus() const {
    return m_status;
}
void OAIIdentityVerificationCreateResponse::setStatus(const OAIIdentityVerificationStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIIdentityVerificationCreateResponse::is_status_Set() const{
    return m_status_isSet;
}

bool OAIIdentityVerificationCreateResponse::is_status_Valid() const{
    return m_status_isValid;
}

OAIIdentityVerificationStepSummary OAIIdentityVerificationCreateResponse::getSteps() const {
    return m_steps;
}
void OAIIdentityVerificationCreateResponse::setSteps(const OAIIdentityVerificationStepSummary &steps) {
    m_steps = steps;
    m_steps_isSet = true;
}

bool OAIIdentityVerificationCreateResponse::is_steps_Set() const{
    return m_steps_isSet;
}

bool OAIIdentityVerificationCreateResponse::is_steps_Valid() const{
    return m_steps_isValid;
}

OAIIdentityVerificationTemplateReference OAIIdentityVerificationCreateResponse::getRTemplate() const {
    return m_r_template;
}
void OAIIdentityVerificationCreateResponse::setRTemplate(const OAIIdentityVerificationTemplateReference &r_template) {
    m_r_template = r_template;
    m_r_template_isSet = true;
}

bool OAIIdentityVerificationCreateResponse::is_r_template_Set() const{
    return m_r_template_isSet;
}

bool OAIIdentityVerificationCreateResponse::is_r_template_Valid() const{
    return m_r_template_isValid;
}

OAIIdentityVerificationUserData OAIIdentityVerificationCreateResponse::getUser() const {
    return m_user;
}
void OAIIdentityVerificationCreateResponse::setUser(const OAIIdentityVerificationUserData &user) {
    m_user = user;
    m_user_isSet = true;
}

bool OAIIdentityVerificationCreateResponse::is_user_Set() const{
    return m_user_isSet;
}

bool OAIIdentityVerificationCreateResponse::is_user_Valid() const{
    return m_user_isValid;
}

QString OAIIdentityVerificationCreateResponse::getWatchlistScreeningId() const {
    return m_watchlist_screening_id;
}
void OAIIdentityVerificationCreateResponse::setWatchlistScreeningId(const QString &watchlist_screening_id) {
    m_watchlist_screening_id = watchlist_screening_id;
    m_watchlist_screening_id_isSet = true;
}

bool OAIIdentityVerificationCreateResponse::is_watchlist_screening_id_Set() const{
    return m_watchlist_screening_id_isSet;
}

bool OAIIdentityVerificationCreateResponse::is_watchlist_screening_id_Valid() const{
    return m_watchlist_screening_id_isValid;
}

bool OAIIdentityVerificationCreateResponse::isSet() const {
...
bool OAIIdentityVerificationCreateResponse::isValid() const {
