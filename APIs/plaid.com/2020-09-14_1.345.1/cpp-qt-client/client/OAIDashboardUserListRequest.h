...
/*
 * OAIDashboardUserListRequest.h
 *
 * Request input for listing dashboard users
 */

#ifndef OAIDashboardUserListRequest_H
#define OAIDashboardUserListRequest_H
...
class OAIDashboardUserListRequest : public OAIObject {
public:
    OAIDashboardUserListRequest();
    OAIDashboardUserListRequest(QString json);
    ~OAIDashboardUserListRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDashboardUserListRequest)

#endif // OAIDashboardUserListRequest_H
