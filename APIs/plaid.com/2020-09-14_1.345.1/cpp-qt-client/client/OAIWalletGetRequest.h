...
/*
 * OAIWalletGetRequest.h
 *
 * WalletGetRequest defines the request schema for &#x60;/wallet/get&#x60;
 */

#ifndef OAIWalletGetRequest_H
#define OAIWalletGetRequest_H
...
class OAIWalletGetRequest : public OAIObject {
public:
    OAIWalletGetRequest();
    OAIWalletGetRequest(QString json);
    ~OAIWalletGetRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWalletGetRequest)

#endif // OAIWalletGetRequest_H
