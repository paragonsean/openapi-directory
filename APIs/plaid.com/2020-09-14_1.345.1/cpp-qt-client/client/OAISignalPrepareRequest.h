...
/*
 * OAISignalPrepareRequest.h
 *
 * SignalPrepareRequest defines the request schema for &#x60;/signal/prepare&#x60;
 */

#ifndef OAISignalPrepareRequest_H
#define OAISignalPrepareRequest_H
...
class OAISignalPrepareRequest : public OAIObject {
public:
    OAISignalPrepareRequest();
    OAISignalPrepareRequest(QString json);
    ~OAISignalPrepareRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISignalPrepareRequest)

#endif // OAISignalPrepareRequest_H
