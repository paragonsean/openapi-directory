...
#ifndef OAIHistoricalUpdateWebhook_H
#define OAIHistoricalUpdateWebhook_H
...
class OAIHistoricalUpdateWebhook : public OAIObject {
public:
    OAIHistoricalUpdateWebhook();
    OAIHistoricalUpdateWebhook(QString json);
    ~OAIHistoricalUpdateWebhook() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHistoricalUpdateWebhook)

#endif // OAIHistoricalUpdateWebhook_H
