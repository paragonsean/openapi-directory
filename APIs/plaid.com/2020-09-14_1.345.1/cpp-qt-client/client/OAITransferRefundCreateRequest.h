...
/*
 * OAITransferRefundCreateRequest.h
 *
 * Defines the request schema for &#x60;/transfer/refund/create&#x60;
 */

#ifndef OAITransferRefundCreateRequest_H
#define OAITransferRefundCreateRequest_H
...
class OAITransferRefundCreateRequest : public OAIObject {
public:
    OAITransferRefundCreateRequest();
    OAITransferRefundCreateRequest(QString json);
    ~OAITransferRefundCreateRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransferRefundCreateRequest)

#endif // OAITransferRefundCreateRequest_H
