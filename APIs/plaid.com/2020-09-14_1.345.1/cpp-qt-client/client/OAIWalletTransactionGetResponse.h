...
/*
 * OAIWalletTransactionGetResponse.h
 *
 * WalletTransactionGetResponse defines the response schema for &#x60;/wallet/transaction/get&#x60;
 */

#ifndef OAIWalletTransactionGetResponse_H
#define OAIWalletTransactionGetResponse_H
...
class OAIWalletTransactionGetResponse : public OAIObject {
public:
    OAIWalletTransactionGetResponse();
    OAIWalletTransactionGetResponse(QString json);
    ~OAIWalletTransactionGetResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWalletTransactionGetResponse)

#endif // OAIWalletTransactionGetResponse_H
