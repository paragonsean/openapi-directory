...
/*
 * OAIPaymentInitiationConsentPaymentExecuteRequest.h
 *
 * PaymentInitiationConsentPaymentExecuteRequest defines the request schema for &#x60;/payment_initiation/consent/payment/execute&#x60;
 */

#ifndef OAIPaymentInitiationConsentPaymentExecuteRequest_H
#define OAIPaymentInitiationConsentPaymentExecuteRequest_H
...
class OAIPaymentInitiationConsentPaymentExecuteRequest : public OAIObject {
public:
    OAIPaymentInitiationConsentPaymentExecuteRequest();
    OAIPaymentInitiationConsentPaymentExecuteRequest(QString json);
    ~OAIPaymentInitiationConsentPaymentExecuteRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentInitiationConsentPaymentExecuteRequest)

#endif // OAIPaymentInitiationConsentPaymentExecuteRequest_H
