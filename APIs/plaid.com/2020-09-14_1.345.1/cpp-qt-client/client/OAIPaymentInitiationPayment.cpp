...
OAIPaymentInitiationPayment::OAIPaymentInitiationPayment(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPaymentInitiationPayment::OAIPaymentInitiationPayment() {
    this->initializeModel();
}

OAIPaymentInitiationPayment::~OAIPaymentInitiationPayment() {}

void OAIPaymentInitiationPayment::initializeModel() {
...
void OAIPaymentInitiationPayment::fromJson(QString jsonString) {
...
void OAIPaymentInitiationPayment::fromJsonObject(QJsonObject json) {
...
QString OAIPaymentInitiationPayment::asJson() const {
...
QJsonObject OAIPaymentInitiationPayment::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPaymentInitiationPayment::getAdjustedReference() const {
    return m_adjusted_reference;
}
void OAIPaymentInitiationPayment::setAdjustedReference(const QString &adjusted_reference) {
    m_adjusted_reference = adjusted_reference;
    m_adjusted_reference_isSet = true;
}

bool OAIPaymentInitiationPayment::is_adjusted_reference_Set() const{
    return m_adjusted_reference_isSet;
}

bool OAIPaymentInitiationPayment::is_adjusted_reference_Valid() const{
    return m_adjusted_reference_isValid;
}

OAIPaymentScheme OAIPaymentInitiationPayment::getAdjustedScheme() const {
    return m_adjusted_scheme;
}
void OAIPaymentInitiationPayment::setAdjustedScheme(const OAIPaymentScheme &adjusted_scheme) {
    m_adjusted_scheme = adjusted_scheme;
    m_adjusted_scheme_isSet = true;
}

bool OAIPaymentInitiationPayment::is_adjusted_scheme_Set() const{
    return m_adjusted_scheme_isSet;
}

bool OAIPaymentInitiationPayment::is_adjusted_scheme_Valid() const{
    return m_adjusted_scheme_isValid;
}

OAIPaymentAmount OAIPaymentInitiationPayment::getAmount() const {
    return m_amount;
}
void OAIPaymentInitiationPayment::setAmount(const OAIPaymentAmount &amount) {
    m_amount = amount;
    m_amount_isSet = true;
}

bool OAIPaymentInitiationPayment::is_amount_Set() const{
    return m_amount_isSet;
}

bool OAIPaymentInitiationPayment::is_amount_Valid() const{
    return m_amount_isValid;
}

OAIPaymentAmountRefunded OAIPaymentInitiationPayment::getAmountRefunded() const {
    return m_amount_refunded;
}
void OAIPaymentInitiationPayment::setAmountRefunded(const OAIPaymentAmountRefunded &amount_refunded) {
    m_amount_refunded = amount_refunded;
    m_amount_refunded_isSet = true;
}

bool OAIPaymentInitiationPayment::is_amount_refunded_Set() const{
    return m_amount_refunded_isSet;
}

bool OAIPaymentInitiationPayment::is_amount_refunded_Valid() const{
    return m_amount_refunded_isValid;
}

OAISenderBACSNullable OAIPaymentInitiationPayment::getBacs() const {
    return m_bacs;
}
void OAIPaymentInitiationPayment::setBacs(const OAISenderBACSNullable &bacs) {
    m_bacs = bacs;
    m_bacs_isSet = true;
}

bool OAIPaymentInitiationPayment::is_bacs_Set() const{
    return m_bacs_isSet;
}

bool OAIPaymentInitiationPayment::is_bacs_Valid() const{
    return m_bacs_isValid;
}

QString OAIPaymentInitiationPayment::getConsentId() const {
    return m_consent_id;
}
void OAIPaymentInitiationPayment::setConsentId(const QString &consent_id) {
    m_consent_id = consent_id;
    m_consent_id_isSet = true;
}

bool OAIPaymentInitiationPayment::is_consent_id_Set() const{
    return m_consent_id_isSet;
}

bool OAIPaymentInitiationPayment::is_consent_id_Valid() const{
    return m_consent_id_isValid;
}

QString OAIPaymentInitiationPayment::getIban() const {
    return m_iban;
}
void OAIPaymentInitiationPayment::setIban(const QString &iban) {
    m_iban = iban;
    m_iban_isSet = true;
}

bool OAIPaymentInitiationPayment::is_iban_Set() const{
    return m_iban_isSet;
}

bool OAIPaymentInitiationPayment::is_iban_Valid() const{
    return m_iban_isValid;
}

QDateTime OAIPaymentInitiationPayment::getLastStatusUpdate() const {
    return m_last_status_update;
}
void OAIPaymentInitiationPayment::setLastStatusUpdate(const QDateTime &last_status_update) {
    m_last_status_update = last_status_update;
    m_last_status_update_isSet = true;
}

bool OAIPaymentInitiationPayment::is_last_status_update_Set() const{
    return m_last_status_update_isSet;
}

bool OAIPaymentInitiationPayment::is_last_status_update_Valid() const{
    return m_last_status_update_isValid;
}

QString OAIPaymentInitiationPayment::getPaymentId() const {
    return m_payment_id;
}
void OAIPaymentInitiationPayment::setPaymentId(const QString &payment_id) {
    m_payment_id = payment_id;
    m_payment_id_isSet = true;
}

bool OAIPaymentInitiationPayment::is_payment_id_Set() const{
    return m_payment_id_isSet;
}

bool OAIPaymentInitiationPayment::is_payment_id_Valid() const{
    return m_payment_id_isValid;
}

QString OAIPaymentInitiationPayment::getRecipientId() const {
    return m_recipient_id;
}
void OAIPaymentInitiationPayment::setRecipientId(const QString &recipient_id) {
    m_recipient_id = recipient_id;
    m_recipient_id_isSet = true;
}

bool OAIPaymentInitiationPayment::is_recipient_id_Set() const{
    return m_recipient_id_isSet;
}

bool OAIPaymentInitiationPayment::is_recipient_id_Valid() const{
    return m_recipient_id_isValid;
}

QString OAIPaymentInitiationPayment::getReference() const {
    return m_reference;
}
void OAIPaymentInitiationPayment::setReference(const QString &reference) {
    m_reference = reference;
    m_reference_isSet = true;
}

bool OAIPaymentInitiationPayment::is_reference_Set() const{
    return m_reference_isSet;
}

bool OAIPaymentInitiationPayment::is_reference_Valid() const{
    return m_reference_isValid;
}

OAIExternalPaymentRefundDetails OAIPaymentInitiationPayment::getRefundDetails() const {
    return m_refund_details;
}
void OAIPaymentInitiationPayment::setRefundDetails(const OAIExternalPaymentRefundDetails &refund_details) {
    m_refund_details = refund_details;
    m_refund_details_isSet = true;
}

bool OAIPaymentInitiationPayment::is_refund_details_Set() const{
    return m_refund_details_isSet;
}

bool OAIPaymentInitiationPayment::is_refund_details_Valid() const{
    return m_refund_details_isValid;
}

QList<QString> OAIPaymentInitiationPayment::getRefundIds() const {
    return m_refund_ids;
}
void OAIPaymentInitiationPayment::setRefundIds(const QList<QString> &refund_ids) {
    m_refund_ids = refund_ids;
    m_refund_ids_isSet = true;
}

bool OAIPaymentInitiationPayment::is_refund_ids_Set() const{
    return m_refund_ids_isSet;
}

bool OAIPaymentInitiationPayment::is_refund_ids_Valid() const{
    return m_refund_ids_isValid;
}

OAIExternalPaymentScheduleGet OAIPaymentInitiationPayment::getSchedule() const {
    return m_schedule;
}
void OAIPaymentInitiationPayment::setSchedule(const OAIExternalPaymentScheduleGet &schedule) {
    m_schedule = schedule;
    m_schedule_isSet = true;
}

bool OAIPaymentInitiationPayment::is_schedule_Set() const{
    return m_schedule_isSet;
}

bool OAIPaymentInitiationPayment::is_schedule_Valid() const{
    return m_schedule_isValid;
}

OAIPaymentScheme OAIPaymentInitiationPayment::getScheme() const {
    return m_scheme;
}
void OAIPaymentInitiationPayment::setScheme(const OAIPaymentScheme &scheme) {
    m_scheme = scheme;
    m_scheme_isSet = true;
}

bool OAIPaymentInitiationPayment::is_scheme_Set() const{
    return m_scheme_isSet;
}

bool OAIPaymentInitiationPayment::is_scheme_Valid() const{
    return m_scheme_isValid;
}

OAIPaymentInitiationPaymentStatus OAIPaymentInitiationPayment::getStatus() const {
    return m_status;
}
void OAIPaymentInitiationPayment::setStatus(const OAIPaymentInitiationPaymentStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIPaymentInitiationPayment::is_status_Set() const{
    return m_status_isSet;
}

bool OAIPaymentInitiationPayment::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIPaymentInitiationPayment::getTransactionId() const {
    return m_transaction_id;
}
void OAIPaymentInitiationPayment::setTransactionId(const QString &transaction_id) {
    m_transaction_id = transaction_id;
    m_transaction_id_isSet = true;
}

bool OAIPaymentInitiationPayment::is_transaction_id_Set() const{
    return m_transaction_id_isSet;
}

bool OAIPaymentInitiationPayment::is_transaction_id_Valid() const{
    return m_transaction_id_isValid;
}

QString OAIPaymentInitiationPayment::getWalletId() const {
    return m_wallet_id;
}
void OAIPaymentInitiationPayment::setWalletId(const QString &wallet_id) {
    m_wallet_id = wallet_id;
    m_wallet_id_isSet = true;
}

bool OAIPaymentInitiationPayment::is_wallet_id_Set() const{
    return m_wallet_id_isSet;
}

bool OAIPaymentInitiationPayment::is_wallet_id_Valid() const{
    return m_wallet_id_isValid;
}

bool OAIPaymentInitiationPayment::isSet() const {
...
bool OAIPaymentInitiationPayment::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_amount_isValid && m_bacs_isValid && m_iban_isValid && m_last_status_update_isValid && m_payment_id_isValid && m_recipient_id_isValid && m_reference_isValid && m_status_isValid && true;
}
