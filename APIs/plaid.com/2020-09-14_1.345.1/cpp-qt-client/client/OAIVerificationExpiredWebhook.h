...
/*
 * OAIVerificationExpiredWebhook.h
 *
...
#ifndef OAIVerificationExpiredWebhook_H
#define OAIVerificationExpiredWebhook_H
...
class OAIVerificationExpiredWebhook : public OAIObject {
public:
    OAIVerificationExpiredWebhook();
    OAIVerificationExpiredWebhook(QString json);
    ~OAIVerificationExpiredWebhook() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVerificationExpiredWebhook)

#endif // OAIVerificationExpiredWebhook_H
