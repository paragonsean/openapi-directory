...
/*
 * OAITransferRecurringCancelRequest.h
 *
 * Defines the request schema for &#x60;/transfer/recurring/cancel&#x60;
 */

#ifndef OAITransferRecurringCancelRequest_H
#define OAITransferRecurringCancelRequest_H
...
class OAITransferRecurringCancelRequest : public OAIObject {
public:
    OAITransferRecurringCancelRequest();
    OAITransferRecurringCancelRequest(QString json);
    ~OAITransferRecurringCancelRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransferRecurringCancelRequest)

#endif // OAITransferRecurringCancelRequest_H
