...
/*
 * OAITransferRecurringGetRequest.h
 *
 * Defines the request schema for &#x60;/transfer/recurring/get&#x60;
 */

#ifndef OAITransferRecurringGetRequest_H
#define OAITransferRecurringGetRequest_H
...
class OAITransferRecurringGetRequest : public OAIObject {
public:
    OAITransferRecurringGetRequest();
    OAITransferRecurringGetRequest(QString json);
    ~OAITransferRecurringGetRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransferRecurringGetRequest)

#endif // OAITransferRecurringGetRequest_H
