...
/*
 * OAIPaymentInitiationPaymentListRequest.h
 *
 * PaymentInitiationPaymentListRequest defines the request schema for &#x60;/payment_initiation/payment/list&#x60;
 */

#ifndef OAIPaymentInitiationPaymentListRequest_H
#define OAIPaymentInitiationPaymentListRequest_H
...
class OAIPaymentInitiationPaymentListRequest : public OAIObject {
public:
    OAIPaymentInitiationPaymentListRequest();
    OAIPaymentInitiationPaymentListRequest(QString json);
    ~OAIPaymentInitiationPaymentListRequest() override;
    ...
    QDateTime getCursor() const;
    void setCursor(const QDateTime &cursor);
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentInitiationPaymentListRequest)

#endif // OAIPaymentInitiationPaymentListRequest_H
