...
/*
 * OAIEntityScreeningStatusUpdatedWebhook.h
 *
...
#ifndef OAIEntityScreeningStatusUpdatedWebhook_H
#define OAIEntityScreeningStatusUpdatedWebhook_H
...
class OAIEntityScreeningStatusUpdatedWebhook : public OAIObject {
public:
    OAIEntityScreeningStatusUpdatedWebhook();
    OAIEntityScreeningStatusUpdatedWebhook(QString json);
    ~OAIEntityScreeningStatusUpdatedWebhook() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEntityScreeningStatusUpdatedWebhook)

#endif // OAIEntityScreeningStatusUpdatedWebhook_H
