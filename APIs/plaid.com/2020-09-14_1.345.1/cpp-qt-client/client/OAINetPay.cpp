...
OAINetPay::OAINetPay(QString json) {
...
void OAINetPay::initializeModel() {
...
void OAINetPay::fromJson(QString jsonString) {
...
void OAINetPay::fromJsonObject(QJsonObject json) {
...
QString OAINetPay::asJson() const {
...
QJsonObject OAINetPay::asJsonObject() const {
    QJsonObject obj;
...
double OAINetPay::getCurrentAmount() const {
    return m_current_amount;
}
void OAINetPay::setCurrentAmount(const double &current_amount) {
    m_current_amount = current_amount;
    m_current_amount_isSet = true;
}

bool OAINetPay::is_current_amount_Set() const{
    return m_current_amount_isSet;
}

bool OAINetPay::is_current_amount_Valid() const{
    return m_current_amount_isValid;
}

QString OAINetPay::getDescription() const {
    return m_description;
}
void OAINetPay::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAINetPay::is_description_Set() const{
    return m_description_isSet;
}

bool OAINetPay::is_description_Valid() const{
    return m_description_isValid;
}

QString OAINetPay::getIsoCurrencyCode() const {
    return m_iso_currency_code;
}
void OAINetPay::setIsoCurrencyCode(const QString &iso_currency_code) {
    m_iso_currency_code = iso_currency_code;
    m_iso_currency_code_isSet = true;
}

bool OAINetPay::is_iso_currency_code_Set() const{
    return m_iso_currency_code_isSet;
}

bool OAINetPay::is_iso_currency_code_Valid() const{
    return m_iso_currency_code_isValid;
}

OAITotal OAINetPay::getTotal() const {
    return m_total;
}
void OAINetPay::setTotal(const OAITotal &total) {
    m_total = total;
    m_total_isSet = true;
}

bool OAINetPay::is_total_Set() const{
    return m_total_isSet;
}

bool OAINetPay::is_total_Valid() const{
    return m_total_isValid;
}

QString OAINetPay::getUnofficialCurrencyCode() const {
    return m_unofficial_currency_code;
}
void OAINetPay::setUnofficialCurrencyCode(const QString &unofficial_currency_code) {
    m_unofficial_currency_code = unofficial_currency_code;
    m_unofficial_currency_code_isSet = true;
}

bool OAINetPay::is_unofficial_currency_code_Set() const{
    return m_unofficial_currency_code_isSet;
}

bool OAINetPay::is_unofficial_currency_code_Valid() const{
    return m_unofficial_currency_code_isValid;
}

double OAINetPay::getYtdAmount() const {
    return m_ytd_amount;
}
void OAINetPay::setYtdAmount(const double &ytd_amount) {
    m_ytd_amount = ytd_amount;
    m_ytd_amount_isSet = true;
}

bool OAINetPay::is_ytd_amount_Set() const{
    return m_ytd_amount_isSet;
}

bool OAINetPay::is_ytd_amount_Valid() const{
    return m_ytd_amount_isValid;
}

bool OAINetPay::isSet() const {
