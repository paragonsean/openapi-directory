...
/*
 * OAIPartnerEndCustomerAddress.h
 *
 * The end customer&#39;s address.
 */

#ifndef OAIPartnerEndCustomerAddress_H
#define OAIPartnerEndCustomerAddress_H
...
class OAIPartnerEndCustomerAddress : public OAIObject {
public:
    OAIPartnerEndCustomerAddress();
    OAIPartnerEndCustomerAddress(QString json);
    ~OAIPartnerEndCustomerAddress() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPartnerEndCustomerAddress)

#endif // OAIPartnerEndCustomerAddress_H
