...
/*
 * OAIAccountsGetRequest.h
 *
 * AccountsGetRequest defines the request schema for &#x60;/accounts/get&#x60;
 */

#ifndef OAIAccountsGetRequest_H
#define OAIAccountsGetRequest_H
...
namespace OpenAPI {
class OAIAccountsGetRequestOptions;

class OAIAccountsGetRequest : public OAIObject {
public:
    OAIAccountsGetRequest();
    OAIAccountsGetRequest(QString json);
    ~OAIAccountsGetRequest() override;
    ...
    OAIAccountsGetRequestOptions getOptions() const;
    void setOptions(const OAIAccountsGetRequestOptions &options);
...
private:
    ...
    OAIAccountsGetRequestOptions m_options;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccountsGetRequest)

#endif // OAIAccountsGetRequest_H
