...
/*
 * OAIDeductionsBreakdown.h
 *
 * An object representing the deduction line items for the pay period
 */

#ifndef OAIDeductionsBreakdown_H
#define OAIDeductionsBreakdown_H
...
class OAIDeductionsBreakdown : public OAIObject {
public:
    OAIDeductionsBreakdown();
    OAIDeductionsBreakdown(QString json);
    ~OAIDeductionsBreakdown() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeductionsBreakdown)

#endif // OAIDeductionsBreakdown_H
