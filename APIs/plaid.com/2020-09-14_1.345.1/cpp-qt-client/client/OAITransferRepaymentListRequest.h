...
/*
 * OAITransferRepaymentListRequest.h
 *
 * Defines the request schema for &#x60;/transfer/repayment/list&#x60;
 */

#ifndef OAITransferRepaymentListRequest_H
#define OAITransferRepaymentListRequest_H
...
class OAITransferRepaymentListRequest : public OAIObject {
public:
    OAITransferRepaymentListRequest();
    OAITransferRepaymentListRequest(QString json);
    ~OAITransferRepaymentListRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransferRepaymentListRequest)

#endif // OAITransferRepaymentListRequest_H
