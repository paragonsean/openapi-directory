...
/*
 * OAINumbersEFTNullable.h
 *
 * Identifying information for transferring money to or from a Canadian bank account via EFT.
 */

#ifndef OAINumbersEFTNullable_H
#define OAINumbersEFTNullable_H
...
class OAINumbersEFTNullable : public OAIObject {
public:
    OAINumbersEFTNullable();
    OAINumbersEFTNullable(QString json);
    ~OAINumbersEFTNullable() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINumbersEFTNullable)

#endif // OAINumbersEFTNullable_H
