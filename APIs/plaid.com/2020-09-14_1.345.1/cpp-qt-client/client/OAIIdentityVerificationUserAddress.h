...
/*
 * OAIIdentityVerificationUserAddress.h
 *
...
#ifndef OAIIdentityVerificationUserAddress_H
#define OAIIdentityVerificationUserAddress_H
...
class OAIIdentityVerificationUserAddress : public OAIObject {
public:
    OAIIdentityVerificationUserAddress();
    OAIIdentityVerificationUserAddress(QString json);
    ~OAIIdentityVerificationUserAddress() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIdentityVerificationUserAddress)

#endif // OAIIdentityVerificationUserAddress_H
