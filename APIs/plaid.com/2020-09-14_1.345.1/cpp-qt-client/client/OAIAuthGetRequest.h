...
#ifndef OAIAuthGetRequest_H
#define OAIAuthGetRequest_H
...
namespace OpenAPI {
class OAIAuthGetRequestOptions;

class OAIAuthGetRequest : public OAIObject {
public:
    OAIAuthGetRequest();
    OAIAuthGetRequest(QString json);
    ~OAIAuthGetRequest() override;
    ...
    OAIAuthGetRequestOptions getOptions() const;
    void setOptions(const OAIAuthGetRequestOptions &options);
...
private:
    ...
    OAIAuthGetRequestOptions m_options;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAuthGetRequest)

#endif // OAIAuthGetRequest_H
