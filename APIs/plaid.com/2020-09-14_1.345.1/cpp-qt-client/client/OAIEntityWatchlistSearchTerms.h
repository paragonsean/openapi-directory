...
/*
 * OAIEntityWatchlistSearchTerms.h
 *
 * Search inputs for creating an entity watchlist screening
 */

#ifndef OAIEntityWatchlistSearchTerms_H
#define OAIEntityWatchlistSearchTerms_H
...
class OAIEntityWatchlistSearchTerms : public OAIObject {
public:
    OAIEntityWatchlistSearchTerms();
    OAIEntityWatchlistSearchTerms(QString json);
    ~OAIEntityWatchlistSearchTerms() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEntityWatchlistSearchTerms)

#endif // OAIEntityWatchlistSearchTerms_H
