...
/*
 * OAIItemRemoveRequest.h
 *
 * ItemRemoveRequest defines the request schema for &#x60;/item/remove&#x60;
 */

#ifndef OAIItemRemoveRequest_H
#define OAIItemRemoveRequest_H
...
class OAIItemRemoveRequest : public OAIObject {
public:
    OAIItemRemoveRequest();
    OAIItemRemoveRequest(QString json);
    ~OAIItemRemoveRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIItemRemoveRequest)

#endif // OAIItemRemoveRequest_H
