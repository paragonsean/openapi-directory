...
void OAITransaction::initializeModel() {
    ...
    m_authorized_datetime_isSet = false;
    m_authorized_datetime_isValid = false;
...
void OAITransaction::fromJsonObject(QJsonObject json) {
    ...
    m_authorized_date_isValid = ::OpenAPI::fromJsonValue(m_authorized_date, json[QString("authorized_date")]);
    m_authorized_date_isSet = !json[QString("authorized_date")].isNull() && m_authorized_date_isValid;

    m_authorized_datetime_isValid = ::OpenAPI::fromJsonValue(m_authorized_datetime, json[QString("authorized_datetime")]);
    m_authorized_datetime_isSet = !json[QString("authorized_datetime")].isNull() && m_authorized_datetime_isValid;
    ...
    m_transaction_code_isValid = ::OpenAPI::fromJsonValue(m_transaction_code, json[QString("transaction_code")]);
    m_transaction_code_isSet = !json[QString("transaction_code")].isNull() && m_transaction_code_isValid;
}
...
QJsonObject OAITransaction::asJsonObject() const {
    ...
    if (m_authorized_date_isSet) {
        obj.insert(QString("authorized_date"), ::OpenAPI::toJsonValue(m_authorized_date));
    }
    if (m_authorized_datetime_isSet) {
        obj.insert(QString("authorized_datetime"), ::OpenAPI::toJsonValue(m_authorized_datetime));
    }
    ...
    if (m_transaction_code.isSet()) {
        obj.insert(QString("transaction_code"), ::OpenAPI::toJsonValue(m_transaction_code));
    }
    return obj;
}
...
QString OAITransaction::getAccountOwner() const {
    return m_account_owner;
}
void OAITransaction::setAccountOwner(const QString &account_owner) {
    m_account_owner = account_owner;
    m_account_owner_isSet = true;
}

bool OAITransaction::is_account_owner_Set() const{
    return m_account_owner_isSet;
}

bool OAITransaction::is_account_owner_Valid() const{
...
QList<QString> OAITransaction::getCategory() const {
    return m_category;
}
void OAITransaction::setCategory(const QList<QString> &category) {
    m_category = category;
...
QString OAITransaction::getCategoryId() const {
    return m_category_id;
}
void OAITransaction::setCategoryId(const QString &category_id) {
...
QDate OAITransaction::getDate() const {
    return m_date;
}
void OAITransaction::setDate(const QDate &date) {
    m_date = date;
    m_date_isSet = true;
}
...
QString OAITransaction::getIsoCurrencyCode() const {
    return m_iso_currency_code;
}
void OAITransaction::setIsoCurrencyCode(const QString &iso_currency_code) {
    m_iso_currency_code = iso_currency_code;
    m_iso_currency_code_isSet = true;
}

bool OAITransaction::is_iso_currency_code_Set() const{
    return m_iso_currency_code_isSet;
}

bool OAITransaction::is_iso_currency_code_Valid() const{
    return m_iso_currency_code_isValid;
}

OAILocation OAITransaction::getLocation() const {
    return m_location;
}
void OAITransaction::setLocation(const OAILocation &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAITransaction::is_location_Set() const{
    return m_location_isSet;
}

bool OAITransaction::is_location_Valid() const{
    return m_location_isValid;
}

QString OAITransaction::getLogoUrl() const {
    return m_logo_url;
}
void OAITransaction::setLogoUrl(const QString &logo_url) {
    m_logo_url = logo_url;
    m_logo_url_isSet = true;
}

bool OAITransaction::is_logo_url_Set() const{
    return m_logo_url_isSet;
}

bool OAITransaction::is_logo_url_Valid() const{
...
QString OAITransaction::getName() const {
    return m_name;
}
void OAITransaction::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAITransaction::is_name_Set() const{
    return m_name_isSet;
}

bool OAITransaction::is_name_Valid() const{
    return m_name_isValid;
}

QString OAITransaction::getOriginalDescription() const {
    return m_original_description;
}
void OAITransaction::setOriginalDescription(const QString &original_description) {
    m_original_description = original_description;
    m_original_description_isSet = true;
}

bool OAITransaction::is_original_description_Set() const{
    return m_original_description_isSet;
}

bool OAITransaction::is_original_description_Valid() const{
    return m_original_description_isValid;
}

OAIPaymentMeta OAITransaction::getPaymentMeta() const {
    return m_payment_meta;
}
void OAITransaction::setPaymentMeta(const OAIPaymentMeta &payment_meta) {
    m_payment_meta = payment_meta;
    m_payment_meta_isSet = true;
}

bool OAITransaction::is_payment_meta_Set() const{
    return m_payment_meta_isSet;
}

bool OAITransaction::is_payment_meta_Valid() const{
    return m_payment_meta_isValid;
}

bool OAITransaction::isPending() const {
    return m_pending;
}
void OAITransaction::setPending(const bool &pending) {
    m_pending = pending;
    m_pending_isSet = true;
}

bool OAITransaction::is_pending_Set() const{
    return m_pending_isSet;
}

bool OAITransaction::is_pending_Valid() const{
    return m_pending_isValid;
}

QString OAITransaction::getPendingTransactionId() const {
    return m_pending_transaction_id;
}
void OAITransaction::setPendingTransactionId(const QString &pending_transaction_id) {
    m_pending_transaction_id = pending_transaction_id;
    m_pending_transaction_id_isSet = true;
}

bool OAITransaction::is_pending_transaction_id_Set() const{
    return m_pending_transaction_id_isSet;
}

bool OAITransaction::is_pending_transaction_id_Valid() const{
...
QString OAITransaction::getTransactionType() const {
    return m_transaction_type;
}
void OAITransaction::setTransactionType(const QString &transaction_type) {
    m_transaction_type = transaction_type;
    m_transaction_type_isSet = true;
}

bool OAITransaction::is_transaction_type_Set() const{
    return m_transaction_type_isSet;
}

bool OAITransaction::is_transaction_type_Valid() const{
    return m_transaction_type_isValid;
}

QString OAITransaction::getUnofficialCurrencyCode() const {
    return m_unofficial_currency_code;
}
void OAITransaction::setUnofficialCurrencyCode(const QString &unofficial_currency_code) {
    m_unofficial_currency_code = unofficial_currency_code;
    m_unofficial_currency_code_isSet = true;
}

bool OAITransaction::is_unofficial_currency_code_Set() const{
    return m_unofficial_currency_code_isSet;
}

bool OAITransaction::is_unofficial_currency_code_Valid() const{
    return m_unofficial_currency_code_isValid;
}

QString OAITransaction::getWebsite() const {
    return m_website;
}
void OAITransaction::setWebsite(const QString &website) {
    m_website = website;
    m_website_isSet = true;
}

bool OAITransaction::is_website_Set() const{
    return m_website_isSet;
}

bool OAITransaction::is_website_Valid() const{
    return m_website_isValid;
}

QDate OAITransaction::getAuthorizedDate() const {
    return m_authorized_date;
}
void OAITransaction::setAuthorizedDate(const QDate &authorized_date) {
...
QDateTime OAITransaction::getAuthorizedDatetime() const {
    return m_authorized_datetime;
}
void OAITransaction::setAuthorizedDatetime(const QDateTime &authorized_datetime) {
    m_authorized_datetime = authorized_datetime;
    m_authorized_datetime_isSet = true;
}

bool OAITransaction::is_authorized_datetime_Set() const{
    return m_authorized_datetime_isSet;
}

bool OAITransaction::is_authorized_datetime_Valid() const{
    return m_authorized_datetime_isValid;
}

QList<OAITransactionCounterparty> OAITransaction::getCounterparties() const {
    return m_counterparties;
}
void OAITransaction::setCounterparties(const QList<OAITransactionCounterparty> &counterparties) {
    m_counterparties = counterparties;
    m_counterparties_isSet = true;
}

bool OAITransaction::is_counterparties_Set() const{
    return m_counterparties_isSet;
}

bool OAITransaction::is_counterparties_Valid() const{
    return m_counterparties_isValid;
}

QDateTime OAITransaction::getDatetime() const {
    return m_datetime;
}
void OAITransaction::setDatetime(const QDateTime &datetime) {
    m_datetime = datetime;
    m_datetime_isSet = true;
}

bool OAITransaction::is_datetime_Set() const{
    return m_datetime_isSet;
}

bool OAITransaction::is_datetime_Valid() const{
    return m_datetime_isValid;
}

QString OAITransaction::getPaymentChannel() const {
    return m_payment_channel;
}
void OAITransaction::setPaymentChannel(const QString &payment_channel) {
    m_payment_channel = payment_channel;
    m_payment_channel_isSet = true;
}

bool OAITransaction::is_payment_channel_Set() const{
    return m_payment_channel_isSet;
}

bool OAITransaction::is_payment_channel_Valid() const{
    return m_payment_channel_isValid;
}

OAIPersonalFinanceCategory OAITransaction::getPersonalFinanceCategory() const {
    return m_personal_finance_category;
}
void OAITransaction::setPersonalFinanceCategory(const OAIPersonalFinanceCategory &personal_finance_category) {
    m_personal_finance_category = personal_finance_category;
    m_personal_finance_category_isSet = true;
}

bool OAITransaction::is_personal_finance_category_Set() const{
    return m_personal_finance_category_isSet;
}

bool OAITransaction::is_personal_finance_category_Valid() const{
    return m_personal_finance_category_isValid;
}

QString OAITransaction::getPersonalFinanceCategoryIconUrl() const {
    return m_personal_finance_category_icon_url;
}
void OAITransaction::setPersonalFinanceCategoryIconUrl(const QString &personal_finance_category_icon_url) {
    m_personal_finance_category_icon_url = personal_finance_category_icon_url;
    m_personal_finance_category_icon_url_isSet = true;
}

bool OAITransaction::is_personal_finance_category_icon_url_Set() const{
    return m_personal_finance_category_icon_url_isSet;
}

bool OAITransaction::is_personal_finance_category_icon_url_Valid() const{
    return m_personal_finance_category_icon_url_isValid;
}

OAITransactionCode OAITransaction::getTransactionCode() const {
    return m_transaction_code;
}
void OAITransaction::setTransactionCode(const OAITransactionCode &transaction_code) {
    m_transaction_code = transaction_code;
    m_transaction_code_isSet = true;
}

bool OAITransaction::is_transaction_code_Set() const{
    return m_transaction_code_isSet;
}

bool OAITransaction::is_transaction_code_Valid() const{
...
bool OAITransaction::isValid() const {
    ...
    return m_account_id_isValid && m_account_owner_isValid && m_amount_isValid && m_category_isValid && m_category_id_isValid && m_date_isValid && m_iso_currency_code_isValid && m_location_isValid && m_name_isValid && m_payment_meta_isValid && m_pending_isValid && m_pending_transaction_id_isValid && m_transaction_id_isValid && m_unofficial_currency_code_isValid && m_authorized_date_isValid && m_authorized_datetime_isValid && m_datetime_isValid && m_payment_channel_isValid && m_transaction_code_isValid && true;
}
