...
/*
 * OAIFallbackAuthMicrodepositVerificationExpiredWebhook.h
 *
 * Fires when an account has an expired verification when using micro-deposits
 */

#ifndef OAIFallbackAuthMicrodepositVerificationExpiredWebhook_H
#define OAIFallbackAuthMicrodepositVerificationExpiredWebhook_H
...
class OAIFallbackAuthMicrodepositVerificationExpiredWebhook : public OAIObject {
public:
    OAIFallbackAuthMicrodepositVerificationExpiredWebhook();
    OAIFallbackAuthMicrodepositVerificationExpiredWebhook(QString json);
    ~OAIFallbackAuthMicrodepositVerificationExpiredWebhook() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFallbackAuthMicrodepositVerificationExpiredWebhook)

#endif // OAIFallbackAuthMicrodepositVerificationExpiredWebhook_H
