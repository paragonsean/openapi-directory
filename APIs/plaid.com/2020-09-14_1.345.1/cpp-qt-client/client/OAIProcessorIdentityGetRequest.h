...
/*
 * OAIProcessorIdentityGetRequest.h
 *
 * ProcessorIdentityGetRequest defines the request schema for &#x60;/processor/identity/get&#x60;
 */

#ifndef OAIProcessorIdentityGetRequest_H
#define OAIProcessorIdentityGetRequest_H
...
class OAIProcessorIdentityGetRequest : public OAIObject {
public:
    OAIProcessorIdentityGetRequest();
    OAIProcessorIdentityGetRequest(QString json);
    ~OAIProcessorIdentityGetRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProcessorIdentityGetRequest)

#endif // OAIProcessorIdentityGetRequest_H
