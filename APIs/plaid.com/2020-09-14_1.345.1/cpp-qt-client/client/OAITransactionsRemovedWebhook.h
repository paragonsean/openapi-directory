...
/*
 * OAITransactionsRemovedWebhook.h
 *
...
#ifndef OAITransactionsRemovedWebhook_H
#define OAITransactionsRemovedWebhook_H
...
class OAITransactionsRemovedWebhook : public OAIObject {
public:
    OAITransactionsRemovedWebhook();
    OAITransactionsRemovedWebhook(QString json);
    ~OAITransactionsRemovedWebhook() override;
    ...
    QList<QString> getRemovedTransactions() const;
    void setRemovedTransactions(const QList<QString> &removed_transactions);
    bool is_removed_transactions_Set() const;
    bool is_removed_transactions_Valid() const;
...
private:
    ...
    QList<QString> m_removed_transactions;
    bool m_removed_transactions_isSet;
    bool m_removed_transactions_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransactionsRemovedWebhook)

#endif // OAITransactionsRemovedWebhook_H
