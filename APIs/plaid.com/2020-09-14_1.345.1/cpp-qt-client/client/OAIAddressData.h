...
#ifndef OAIAddressData_H
#define OAIAddressData_H
...
class OAIAddressData : public OAIObject {
public:
    OAIAddressData();
    OAIAddressData(QString json);
    ~OAIAddressData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddressData)

#endif // OAIAddressData_H
