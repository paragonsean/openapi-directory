...
/*
 * OAITransferSweepListRequest.h
 *
 * Defines the request schema for &#x60;/transfer/sweep/list&#x60;
 */

#ifndef OAITransferSweepListRequest_H
#define OAITransferSweepListRequest_H
...
class OAITransferSweepListRequest : public OAIObject {
public:
    OAITransferSweepListRequest();
    OAITransferSweepListRequest(QString json);
    ~OAITransferSweepListRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransferSweepListRequest)

#endif // OAITransferSweepListRequest_H
