...
/*
 * OAISandboxItemSetVerificationStatusRequest.h
 *
 * SandboxItemSetVerificationStatusRequest defines the request schema for &#x60;/sandbox/item/set_verification_status&#x60;
 */

#ifndef OAISandboxItemSetVerificationStatusRequest_H
#define OAISandboxItemSetVerificationStatusRequest_H
...
class OAISandboxItemSetVerificationStatusRequest : public OAIObject {
public:
    OAISandboxItemSetVerificationStatusRequest();
    OAISandboxItemSetVerificationStatusRequest(QString json);
    ~OAISandboxItemSetVerificationStatusRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISandboxItemSetVerificationStatusRequest)

#endif // OAISandboxItemSetVerificationStatusRequest_H
