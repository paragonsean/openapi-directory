...
OAIPayStubEarningsBreakdown::OAIPayStubEarningsBreakdown(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPayStubEarningsBreakdown::OAIPayStubEarningsBreakdown() {
    this->initializeModel();
}

OAIPayStubEarningsBreakdown::~OAIPayStubEarningsBreakdown() {}

void OAIPayStubEarningsBreakdown::initializeModel() {
...
void OAIPayStubEarningsBreakdown::fromJson(QString jsonString) {
...
void OAIPayStubEarningsBreakdown::fromJsonObject(QJsonObject json) {
...
QString OAIPayStubEarningsBreakdown::asJson() const {
...
QJsonObject OAIPayStubEarningsBreakdown::asJsonObject() const {
    QJsonObject obj;
    if (m_canonical_description_isSet) {
...
QString OAIPayStubEarningsBreakdown::getCanonicalDescription() const {
    return m_canonical_description;
}
void OAIPayStubEarningsBreakdown::setCanonicalDescription(const QString &canonical_description) {
    m_canonical_description = canonical_description;
    m_canonical_description_isSet = true;
}

bool OAIPayStubEarningsBreakdown::is_canonical_description_Set() const{
    return m_canonical_description_isSet;
}

bool OAIPayStubEarningsBreakdown::is_canonical_description_Valid() const{
    return m_canonical_description_isValid;
}

double OAIPayStubEarningsBreakdown::getCurrentAmount() const {
    return m_current_amount;
}
void OAIPayStubEarningsBreakdown::setCurrentAmount(const double &current_amount) {
    m_current_amount = current_amount;
    m_current_amount_isSet = true;
}

bool OAIPayStubEarningsBreakdown::is_current_amount_Set() const{
    return m_current_amount_isSet;
}

bool OAIPayStubEarningsBreakdown::is_current_amount_Valid() const{
    return m_current_amount_isValid;
}

QString OAIPayStubEarningsBreakdown::getDescription() const {
    return m_description;
}
void OAIPayStubEarningsBreakdown::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIPayStubEarningsBreakdown::is_description_Set() const{
    return m_description_isSet;
}

bool OAIPayStubEarningsBreakdown::is_description_Valid() const{
    return m_description_isValid;
}

double OAIPayStubEarningsBreakdown::getHours() const {
    return m_hours;
}
void OAIPayStubEarningsBreakdown::setHours(const double &hours) {
    m_hours = hours;
    m_hours_isSet = true;
}

bool OAIPayStubEarningsBreakdown::is_hours_Set() const{
    return m_hours_isSet;
}

bool OAIPayStubEarningsBreakdown::is_hours_Valid() const{
    return m_hours_isValid;
}

QString OAIPayStubEarningsBreakdown::getIsoCurrencyCode() const {
    return m_iso_currency_code;
}
void OAIPayStubEarningsBreakdown::setIsoCurrencyCode(const QString &iso_currency_code) {
    m_iso_currency_code = iso_currency_code;
    m_iso_currency_code_isSet = true;
}

bool OAIPayStubEarningsBreakdown::is_iso_currency_code_Set() const{
    return m_iso_currency_code_isSet;
}

bool OAIPayStubEarningsBreakdown::is_iso_currency_code_Valid() const{
    return m_iso_currency_code_isValid;
}

double OAIPayStubEarningsBreakdown::getRate() const {
    return m_rate;
}
void OAIPayStubEarningsBreakdown::setRate(const double &rate) {
    m_rate = rate;
    m_rate_isSet = true;
}

bool OAIPayStubEarningsBreakdown::is_rate_Set() const{
    return m_rate_isSet;
}

bool OAIPayStubEarningsBreakdown::is_rate_Valid() const{
    return m_rate_isValid;
}

QString OAIPayStubEarningsBreakdown::getUnofficialCurrencyCode() const {
    return m_unofficial_currency_code;
}
void OAIPayStubEarningsBreakdown::setUnofficialCurrencyCode(const QString &unofficial_currency_code) {
    m_unofficial_currency_code = unofficial_currency_code;
    m_unofficial_currency_code_isSet = true;
}

bool OAIPayStubEarningsBreakdown::is_unofficial_currency_code_Set() const{
    return m_unofficial_currency_code_isSet;
}

bool OAIPayStubEarningsBreakdown::is_unofficial_currency_code_Valid() const{
    return m_unofficial_currency_code_isValid;
}

double OAIPayStubEarningsBreakdown::getYtdAmount() const {
    return m_ytd_amount;
}
void OAIPayStubEarningsBreakdown::setYtdAmount(const double &ytd_amount) {
    m_ytd_amount = ytd_amount;
    m_ytd_amount_isSet = true;
}

bool OAIPayStubEarningsBreakdown::is_ytd_amount_Set() const{
    return m_ytd_amount_isSet;
}

bool OAIPayStubEarningsBreakdown::is_ytd_amount_Valid() const{
    return m_ytd_amount_isValid;
}

bool OAIPayStubEarningsBreakdown::isSet() const {
...
bool OAIPayStubEarningsBreakdown::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_canonical_description_isValid && m_current_amount_isValid && m_description_isValid && m_hours_isValid && m_iso_currency_code_isValid && m_rate_isValid && m_unofficial_currency_code_isValid && m_ytd_amount_isValid && true;
}
