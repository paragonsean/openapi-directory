...
class OAIAssetsErrorWebhook : public OAIObject {
public:
    OAIAssetsErrorWebhook();
    OAIAssetsErrorWebhook(QString json);
    ~OAIAssetsErrorWebhook() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssetsErrorWebhook)

#endif // OAIAssetsErrorWebhook_H
