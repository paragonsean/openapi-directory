...
/*
 * OAIPayStubDeductionsBreakdown.h
 *
 * An object representing the deduction line items for the pay period
 */

#ifndef OAIPayStubDeductionsBreakdown_H
#define OAIPayStubDeductionsBreakdown_H
...
class OAIPayStubDeductionsBreakdown : public OAIObject {
public:
    OAIPayStubDeductionsBreakdown();
    OAIPayStubDeductionsBreakdown(QString json);
    ~OAIPayStubDeductionsBreakdown() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPayStubDeductionsBreakdown)

#endif // OAIPayStubDeductionsBreakdown_H
