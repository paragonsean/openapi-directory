...
/*
 * OAIApplicationGetRequest.h
 *
 * ApplicationGetRequest defines the schema for &#x60;/application/get&#x60;
 */

#ifndef OAIApplicationGetRequest_H
#define OAIApplicationGetRequest_H
...
class OAIApplicationGetRequest : public OAIObject {
public:
    OAIApplicationGetRequest();
    OAIApplicationGetRequest(QString json);
    ~OAIApplicationGetRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApplicationGetRequest)

#endif // OAIApplicationGetRequest_H
