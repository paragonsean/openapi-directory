...
/*
 * OAISandboxItemFireWebhookRequest.h
 *
 * SandboxItemFireWebhookRequest defines the request schema for &#x60;/sandbox/item/fire_webhook&#x60;
 */

#ifndef OAISandboxItemFireWebhookRequest_H
#define OAISandboxItemFireWebhookRequest_H
...
class OAISandboxItemFireWebhookRequest : public OAIObject {
public:
    OAISandboxItemFireWebhookRequest();
    OAISandboxItemFireWebhookRequest(QString json);
    ~OAISandboxItemFireWebhookRequest() override;
    ...
    OAIWebhookType getWebhookType() const;
    void setWebhookType(const OAIWebhookType &webhook_type);
...
Q_DECLARE_METATYPE(OpenAPI::OAISandboxItemFireWebhookRequest)

#endif // OAISandboxItemFireWebhookRequest_H
