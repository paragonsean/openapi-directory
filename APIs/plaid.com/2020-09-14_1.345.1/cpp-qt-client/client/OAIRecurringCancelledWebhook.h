...
/*
 * OAIRecurringCancelledWebhook.h
 *
 * Fired when a recurring transfer is cancelled by Plaid.
 */

#ifndef OAIRecurringCancelledWebhook_H
#define OAIRecurringCancelledWebhook_H
...
class OAIRecurringCancelledWebhook : public OAIObject {
public:
    OAIRecurringCancelledWebhook();
    OAIRecurringCancelledWebhook(QString json);
    ~OAIRecurringCancelledWebhook() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRecurringCancelledWebhook)

#endif // OAIRecurringCancelledWebhook_H
