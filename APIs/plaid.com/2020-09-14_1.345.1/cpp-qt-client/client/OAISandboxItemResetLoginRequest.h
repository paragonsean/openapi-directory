...
/*
 * OAISandboxItemResetLoginRequest.h
 *
 * SandboxItemResetLoginRequest defines the request schema for &#x60;/sandbox/item/reset_login&#x60;
 */

#ifndef OAISandboxItemResetLoginRequest_H
#define OAISandboxItemResetLoginRequest_H
...
class OAISandboxItemResetLoginRequest : public OAIObject {
public:
    OAISandboxItemResetLoginRequest();
    OAISandboxItemResetLoginRequest(QString json);
    ~OAISandboxItemResetLoginRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISandboxItemResetLoginRequest)

#endif // OAISandboxItemResetLoginRequest_H
