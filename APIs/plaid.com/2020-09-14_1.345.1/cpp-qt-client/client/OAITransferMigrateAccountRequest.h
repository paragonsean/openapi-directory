...
/*
 * OAITransferMigrateAccountRequest.h
 *
 * Defines the request schema for &#x60;/transfer/migrate_account&#x60;
 */

#ifndef OAITransferMigrateAccountRequest_H
#define OAITransferMigrateAccountRequest_H
...
class OAITransferMigrateAccountRequest : public OAIObject {
public:
    OAITransferMigrateAccountRequest();
    OAITransferMigrateAccountRequest(QString json);
    ~OAITransferMigrateAccountRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransferMigrateAccountRequest)

#endif // OAITransferMigrateAccountRequest_H
