...
/*
 * OAITransferUserInResponse.h
 *
 * The legal name and other information for the account holder.
 */

#ifndef OAITransferUserInResponse_H
#define OAITransferUserInResponse_H
...
class OAITransferUserInResponse : public OAIObject {
public:
    OAITransferUserInResponse();
    OAITransferUserInResponse(QString json);
    ~OAITransferUserInResponse() override;
    ...
    OAITransferUserAddressInResponse getAddress() const;
    void setAddress(const OAITransferUserAddressInResponse &address);
...
private:
    ...
    OAITransferUserAddressInResponse m_address;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransferUserInResponse)

#endif // OAITransferUserInResponse_H
