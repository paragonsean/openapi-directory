...
OAIPayStubDeductionsTotal::OAIPayStubDeductionsTotal(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPayStubDeductionsTotal::OAIPayStubDeductionsTotal() {
    this->initializeModel();
}

OAIPayStubDeductionsTotal::~OAIPayStubDeductionsTotal() {}

void OAIPayStubDeductionsTotal::initializeModel() {
...
void OAIPayStubDeductionsTotal::fromJson(QString jsonString) {
...
void OAIPayStubDeductionsTotal::fromJsonObject(QJsonObject json) {
...
QString OAIPayStubDeductionsTotal::asJson() const {
...
QJsonObject OAIPayStubDeductionsTotal::asJsonObject() const {
    QJsonObject obj;
...
double OAIPayStubDeductionsTotal::getCurrentAmount() const {
    return m_current_amount;
}
void OAIPayStubDeductionsTotal::setCurrentAmount(const double &current_amount) {
    m_current_amount = current_amount;
    m_current_amount_isSet = true;
}

bool OAIPayStubDeductionsTotal::is_current_amount_Set() const{
    return m_current_amount_isSet;
}

bool OAIPayStubDeductionsTotal::is_current_amount_Valid() const{
    return m_current_amount_isValid;
}

QString OAIPayStubDeductionsTotal::getIsoCurrencyCode() const {
    return m_iso_currency_code;
}
void OAIPayStubDeductionsTotal::setIsoCurrencyCode(const QString &iso_currency_code) {
    m_iso_currency_code = iso_currency_code;
    m_iso_currency_code_isSet = true;
}

bool OAIPayStubDeductionsTotal::is_iso_currency_code_Set() const{
    return m_iso_currency_code_isSet;
}

bool OAIPayStubDeductionsTotal::is_iso_currency_code_Valid() const{
    return m_iso_currency_code_isValid;
}

QString OAIPayStubDeductionsTotal::getUnofficialCurrencyCode() const {
    return m_unofficial_currency_code;
}
void OAIPayStubDeductionsTotal::setUnofficialCurrencyCode(const QString &unofficial_currency_code) {
    m_unofficial_currency_code = unofficial_currency_code;
    m_unofficial_currency_code_isSet = true;
}

bool OAIPayStubDeductionsTotal::is_unofficial_currency_code_Set() const{
    return m_unofficial_currency_code_isSet;
}

bool OAIPayStubDeductionsTotal::is_unofficial_currency_code_Valid() const{
    return m_unofficial_currency_code_isValid;
}

double OAIPayStubDeductionsTotal::getYtdAmount() const {
    return m_ytd_amount;
}
void OAIPayStubDeductionsTotal::setYtdAmount(const double &ytd_amount) {
    m_ytd_amount = ytd_amount;
    m_ytd_amount_isSet = true;
}

bool OAIPayStubDeductionsTotal::is_ytd_amount_Set() const{
    return m_ytd_amount_isSet;
}

bool OAIPayStubDeductionsTotal::is_ytd_amount_Valid() const{
    return m_ytd_amount_isValid;
}

bool OAIPayStubDeductionsTotal::isSet() const {
...
bool OAIPayStubDeductionsTotal::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_current_amount_isValid && m_iso_currency_code_isValid && m_unofficial_currency_code_isValid && m_ytd_amount_isValid && true;
}
