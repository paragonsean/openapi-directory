...
/*
 * OAIBankTransferCreateRequest.h
 *
 * Defines the request schema for &#x60;/bank_transfer/create&#x60;
 */

#ifndef OAIBankTransferCreateRequest_H
#define OAIBankTransferCreateRequest_H
...
class OAIBankTransferCreateRequest : public OAIObject {
public:
    OAIBankTransferCreateRequest();
    OAIBankTransferCreateRequest(QString json);
    ~OAIBankTransferCreateRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBankTransferCreateRequest)

#endif // OAIBankTransferCreateRequest_H
