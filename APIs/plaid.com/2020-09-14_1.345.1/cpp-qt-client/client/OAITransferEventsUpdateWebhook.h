...
/*
 * OAITransferEventsUpdateWebhook.h
 *
...
#ifndef OAITransferEventsUpdateWebhook_H
#define OAITransferEventsUpdateWebhook_H
...
class OAITransferEventsUpdateWebhook : public OAIObject {
public:
    OAITransferEventsUpdateWebhook();
    OAITransferEventsUpdateWebhook(QString json);
    ~OAITransferEventsUpdateWebhook() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransferEventsUpdateWebhook)

#endif // OAITransferEventsUpdateWebhook_H
