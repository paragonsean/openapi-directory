...
class OAICreditAmountWithCurrency : public OAIObject {
public:
    OAICreditAmountWithCurrency();
    OAICreditAmountWithCurrency(QString json);
    ~OAICreditAmountWithCurrency() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreditAmountWithCurrency)

#endif // OAICreditAmountWithCurrency_H
