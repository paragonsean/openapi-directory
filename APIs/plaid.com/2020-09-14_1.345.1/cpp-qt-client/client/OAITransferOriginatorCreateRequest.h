...
/*
 * OAITransferOriginatorCreateRequest.h
 *
 * Defines the request schema for &#x60;/transfer/originator/create&#x60;
 */

#ifndef OAITransferOriginatorCreateRequest_H
#define OAITransferOriginatorCreateRequest_H
...
class OAITransferOriginatorCreateRequest : public OAIObject {
public:
    OAITransferOriginatorCreateRequest();
    OAITransferOriginatorCreateRequest(QString json);
    ~OAITransferOriginatorCreateRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransferOriginatorCreateRequest)

#endif // OAITransferOriginatorCreateRequest_H
