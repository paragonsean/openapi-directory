...
OAIEntityWatchlistScreeningHit::OAIEntityWatchlistScreeningHit(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEntityWatchlistScreeningHit::OAIEntityWatchlistScreeningHit() {
    this->initializeModel();
}

OAIEntityWatchlistScreeningHit::~OAIEntityWatchlistScreeningHit() {}

void OAIEntityWatchlistScreeningHit::initializeModel() {
...
void OAIEntityWatchlistScreeningHit::fromJson(QString jsonString) {
...
void OAIEntityWatchlistScreeningHit::fromJsonObject(QJsonObject json) {
...
QString OAIEntityWatchlistScreeningHit::asJson() const {
...
QJsonObject OAIEntityWatchlistScreeningHit::asJsonObject() const {
    QJsonObject obj;
    if (m_analysis.isSet()) {
...
OAIEntityScreeningHitAnalysis OAIEntityWatchlistScreeningHit::getAnalysis() const {
    return m_analysis;
}
void OAIEntityWatchlistScreeningHit::setAnalysis(const OAIEntityScreeningHitAnalysis &analysis) {
    m_analysis = analysis;
    m_analysis_isSet = true;
}

bool OAIEntityWatchlistScreeningHit::is_analysis_Set() const{
    return m_analysis_isSet;
}

bool OAIEntityWatchlistScreeningHit::is_analysis_Valid() const{
    return m_analysis_isValid;
}

OAIEntityScreeningHitData OAIEntityWatchlistScreeningHit::getData() const {
    return m_data;
}
void OAIEntityWatchlistScreeningHit::setData(const OAIEntityScreeningHitData &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIEntityWatchlistScreeningHit::is_data_Set() const{
    return m_data_isSet;
}

bool OAIEntityWatchlistScreeningHit::is_data_Valid() const{
    return m_data_isValid;
}

QDateTime OAIEntityWatchlistScreeningHit::getFirstActive() const {
    return m_first_active;
}
void OAIEntityWatchlistScreeningHit::setFirstActive(const QDateTime &first_active) {
    m_first_active = first_active;
    m_first_active_isSet = true;
}

bool OAIEntityWatchlistScreeningHit::is_first_active_Set() const{
    return m_first_active_isSet;
}

bool OAIEntityWatchlistScreeningHit::is_first_active_Valid() const{
    return m_first_active_isValid;
}

QDateTime OAIEntityWatchlistScreeningHit::getHistoricalSince() const {
    return m_historical_since;
}
void OAIEntityWatchlistScreeningHit::setHistoricalSince(const QDateTime &historical_since) {
    m_historical_since = historical_since;
    m_historical_since_isSet = true;
}

bool OAIEntityWatchlistScreeningHit::is_historical_since_Set() const{
    return m_historical_since_isSet;
}

bool OAIEntityWatchlistScreeningHit::is_historical_since_Valid() const{
    return m_historical_since_isValid;
}

QString OAIEntityWatchlistScreeningHit::getId() const {
    return m_id;
}
void OAIEntityWatchlistScreeningHit::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIEntityWatchlistScreeningHit::is_id_Set() const{
    return m_id_isSet;
}

bool OAIEntityWatchlistScreeningHit::is_id_Valid() const{
    return m_id_isValid;
}

QDateTime OAIEntityWatchlistScreeningHit::getInactiveSince() const {
    return m_inactive_since;
}
void OAIEntityWatchlistScreeningHit::setInactiveSince(const QDateTime &inactive_since) {
    m_inactive_since = inactive_since;
    m_inactive_since_isSet = true;
}

bool OAIEntityWatchlistScreeningHit::is_inactive_since_Set() const{
    return m_inactive_since_isSet;
}

bool OAIEntityWatchlistScreeningHit::is_inactive_since_Valid() const{
    return m_inactive_since_isValid;
}

OAIEntityWatchlistCode OAIEntityWatchlistScreeningHit::getListCode() const {
    return m_list_code;
}
void OAIEntityWatchlistScreeningHit::setListCode(const OAIEntityWatchlistCode &list_code) {
    m_list_code = list_code;
    m_list_code_isSet = true;
}

bool OAIEntityWatchlistScreeningHit::is_list_code_Set() const{
    return m_list_code_isSet;
}

bool OAIEntityWatchlistScreeningHit::is_list_code_Valid() const{
    return m_list_code_isValid;
}

QString OAIEntityWatchlistScreeningHit::getPlaidUid() const {
    return m_plaid_uid;
}
void OAIEntityWatchlistScreeningHit::setPlaidUid(const QString &plaid_uid) {
    m_plaid_uid = plaid_uid;
    m_plaid_uid_isSet = true;
}

bool OAIEntityWatchlistScreeningHit::is_plaid_uid_Set() const{
    return m_plaid_uid_isSet;
}

bool OAIEntityWatchlistScreeningHit::is_plaid_uid_Valid() const{
    return m_plaid_uid_isValid;
}

OAIWatchlistScreeningHitStatus OAIEntityWatchlistScreeningHit::getReviewStatus() const {
    return m_review_status;
}
void OAIEntityWatchlistScreeningHit::setReviewStatus(const OAIWatchlistScreeningHitStatus &review_status) {
    m_review_status = review_status;
    m_review_status_isSet = true;
}

bool OAIEntityWatchlistScreeningHit::is_review_status_Set() const{
    return m_review_status_isSet;
}

bool OAIEntityWatchlistScreeningHit::is_review_status_Valid() const{
    return m_review_status_isValid;
}

QString OAIEntityWatchlistScreeningHit::getSourceUid() const {
    return m_source_uid;
}
void OAIEntityWatchlistScreeningHit::setSourceUid(const QString &source_uid) {
    m_source_uid = source_uid;
    m_source_uid_isSet = true;
}

bool OAIEntityWatchlistScreeningHit::is_source_uid_Set() const{
    return m_source_uid_isSet;
}

bool OAIEntityWatchlistScreeningHit::is_source_uid_Valid() const{
    return m_source_uid_isValid;
}

bool OAIEntityWatchlistScreeningHit::isSet() const {
...
bool OAIEntityWatchlistScreeningHit::isValid() const {
