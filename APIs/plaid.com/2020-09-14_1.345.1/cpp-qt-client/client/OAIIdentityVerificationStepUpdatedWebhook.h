...
/*
 * OAIIdentityVerificationStepUpdatedWebhook.h
 *
 * Fired when an end user has completed a step of the Identity Verification process.
 */

#ifndef OAIIdentityVerificationStepUpdatedWebhook_H
#define OAIIdentityVerificationStepUpdatedWebhook_H
...
class OAIIdentityVerificationStepUpdatedWebhook : public OAIObject {
public:
    OAIIdentityVerificationStepUpdatedWebhook();
    OAIIdentityVerificationStepUpdatedWebhook(QString json);
    ~OAIIdentityVerificationStepUpdatedWebhook() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIdentityVerificationStepUpdatedWebhook)

#endif // OAIIdentityVerificationStepUpdatedWebhook_H
