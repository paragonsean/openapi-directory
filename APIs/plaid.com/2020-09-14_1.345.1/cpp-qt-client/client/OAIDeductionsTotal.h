...
/*
 * OAIDeductionsTotal.h
 *
 * An object representing the total deductions for the pay period
 */

#ifndef OAIDeductionsTotal_H
#define OAIDeductionsTotal_H
...
class OAIDeductionsTotal : public OAIObject {
public:
    OAIDeductionsTotal();
    OAIDeductionsTotal(QString json);
    ~OAIDeductionsTotal() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeductionsTotal)

#endif // OAIDeductionsTotal_H
