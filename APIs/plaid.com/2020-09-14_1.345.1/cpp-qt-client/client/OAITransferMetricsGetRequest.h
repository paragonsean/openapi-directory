...
/*
 * OAITransferMetricsGetRequest.h
 *
 * Defines the request schema for &#x60;/transfer/metrics/get&#x60;
 */

#ifndef OAITransferMetricsGetRequest_H
#define OAITransferMetricsGetRequest_H
...
class OAITransferMetricsGetRequest : public OAIObject {
public:
    OAITransferMetricsGetRequest();
    OAITransferMetricsGetRequest(QString json);
    ~OAITransferMetricsGetRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransferMetricsGetRequest)

#endif // OAITransferMetricsGetRequest_H
