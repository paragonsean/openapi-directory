...
/*
 * OAIItemWebhookUpdateRequest.h
 *
 * ItemWebhookUpdateRequest defines the request schema for &#x60;/item/webhook/update&#x60;
 */

#ifndef OAIItemWebhookUpdateRequest_H
#define OAIItemWebhookUpdateRequest_H
...
class OAIItemWebhookUpdateRequest : public OAIObject {
public:
    OAIItemWebhookUpdateRequest();
    OAIItemWebhookUpdateRequest(QString json);
    ~OAIItemWebhookUpdateRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIItemWebhookUpdateRequest)

#endif // OAIItemWebhookUpdateRequest_H
