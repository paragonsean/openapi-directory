...
/*
 * OAIWalletTransactionsListRequest.h
 *
 * WalletTransactionListRequest defines the request schema for &#x60;/wallet/transaction/list&#x60;
 */

#ifndef OAIWalletTransactionsListRequest_H
#define OAIWalletTransactionsListRequest_H
...
namespace OpenAPI {
class OAIWalletTransactionListRequestOptions;

class OAIWalletTransactionsListRequest : public OAIObject {
public:
    OAIWalletTransactionsListRequest();
    OAIWalletTransactionsListRequest(QString json);
    ~OAIWalletTransactionsListRequest() override;
    ...
    OAIWalletTransactionListRequestOptions getOptions() const;
    void setOptions(const OAIWalletTransactionListRequestOptions &options);
...
private:
    ...
    OAIWalletTransactionListRequestOptions m_options;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWalletTransactionsListRequest)

#endif // OAIWalletTransactionsListRequest_H
