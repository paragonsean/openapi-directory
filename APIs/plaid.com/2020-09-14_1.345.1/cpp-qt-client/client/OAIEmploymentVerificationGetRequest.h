...
/*
 * OAIEmploymentVerificationGetRequest.h
 *
 * EmploymentVerificationGetRequest defines the request schema for &#x60;/employment/verification/get&#x60;.
 */

#ifndef OAIEmploymentVerificationGetRequest_H
#define OAIEmploymentVerificationGetRequest_H
...
class OAIEmploymentVerificationGetRequest : public OAIObject {
public:
    OAIEmploymentVerificationGetRequest();
    OAIEmploymentVerificationGetRequest(QString json);
    ~OAIEmploymentVerificationGetRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEmploymentVerificationGetRequest)

#endif // OAIEmploymentVerificationGetRequest_H
