...
/*
 * OAIAssetReportTransaction.h
 *
 * A transaction on the asset report
 */

#ifndef OAIAssetReportTransaction_H
#define OAIAssetReportTransaction_H
...
class OAIAssetReportTransaction : public OAIObject {
public:
    OAIAssetReportTransaction();
    OAIAssetReportTransaction(QString json);
    ~OAIAssetReportTransaction() override;
    ...
    OAICreditCategory getCreditCategory() const;
    void setCreditCategory(const OAICreditCategory &credit_category);
    bool is_credit_category_Set() const;
    bool is_credit_category_Valid() const;

    QString getDateTransacted() const;
    void setDateTransacted(const QString &date_transacted);
...
private:
    ...
    OAICreditCategory m_credit_category;
    bool m_credit_category_isSet;
    bool m_credit_category_isValid;

    QString m_date_transacted;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssetReportTransaction)

#endif // OAIAssetReportTransaction_H
