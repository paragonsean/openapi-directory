...
void OAIW2::fromJson(QString jsonString) {
...
void OAIW2::fromJsonObject(QJsonObject json) {
...
QJsonObject OAIW2::asJsonObject() const {
    QJsonObject obj;
...
QString OAIW2::getAllocatedTips() const {
    return m_allocated_tips;
}
void OAIW2::setAllocatedTips(const QString &allocated_tips) {
    m_allocated_tips = allocated_tips;
    m_allocated_tips_isSet = true;
}

bool OAIW2::is_allocated_tips_Set() const{
    return m_allocated_tips_isSet;
}

bool OAIW2::is_allocated_tips_Valid() const{
    return m_allocated_tips_isValid;
}

QList<OAIW2Box12> OAIW2::getBox12() const {
    return m_box_12;
}
void OAIW2::setBox12(const QList<OAIW2Box12> &box_12) {
    m_box_12 = box_12;
    m_box_12_isSet = true;
}

bool OAIW2::is_box_12_Set() const{
    return m_box_12_isSet;
}

bool OAIW2::is_box_12_Valid() const{
    return m_box_12_isValid;
}

QString OAIW2::getBox9() const {
    return m_box_9;
}
void OAIW2::setBox9(const QString &box_9) {
    m_box_9 = box_9;
    m_box_9_isSet = true;
}

bool OAIW2::is_box_9_Set() const{
    return m_box_9_isSet;
}

bool OAIW2::is_box_9_Valid() const{
    return m_box_9_isValid;
}

QString OAIW2::getDependentCareBenefits() const {
    return m_dependent_care_benefits;
}
void OAIW2::setDependentCareBenefits(const QString &dependent_care_benefits) {
    m_dependent_care_benefits = dependent_care_benefits;
    m_dependent_care_benefits_isSet = true;
}

bool OAIW2::is_dependent_care_benefits_Set() const{
    return m_dependent_care_benefits_isSet;
}

bool OAIW2::is_dependent_care_benefits_Valid() const{
    return m_dependent_care_benefits_isValid;
}

OAIEmployee OAIW2::getEmployee() const {
    return m_employee;
}
void OAIW2::setEmployee(const OAIEmployee &employee) {
    m_employee = employee;
    m_employee_isSet = true;
}

bool OAIW2::is_employee_Set() const{
    return m_employee_isSet;
}

bool OAIW2::is_employee_Valid() const{
    return m_employee_isValid;
}

OAIPaystubEmployer OAIW2::getEmployer() const {
    return m_employer;
}
void OAIW2::setEmployer(const OAIPaystubEmployer &employer) {
    m_employer = employer;
    m_employer_isSet = true;
}

bool OAIW2::is_employer_Set() const{
    return m_employer_isSet;
}

bool OAIW2::is_employer_Valid() const{
    return m_employer_isValid;
}

QString OAIW2::getEmployerIdNumber() const {
    return m_employer_id_number;
}
void OAIW2::setEmployerIdNumber(const QString &employer_id_number) {
    m_employer_id_number = employer_id_number;
    m_employer_id_number_isSet = true;
}

bool OAIW2::is_employer_id_number_Set() const{
    return m_employer_id_number_isSet;
}

bool OAIW2::is_employer_id_number_Valid() const{
    return m_employer_id_number_isValid;
}

QString OAIW2::getFederalIncomeTaxWithheld() const {
    return m_federal_income_tax_withheld;
}
void OAIW2::setFederalIncomeTaxWithheld(const QString &federal_income_tax_withheld) {
    m_federal_income_tax_withheld = federal_income_tax_withheld;
    m_federal_income_tax_withheld_isSet = true;
}

bool OAIW2::is_federal_income_tax_withheld_Set() const{
    return m_federal_income_tax_withheld_isSet;
}

bool OAIW2::is_federal_income_tax_withheld_Valid() const{
    return m_federal_income_tax_withheld_isValid;
}

QString OAIW2::getMedicareTaxWithheld() const {
    return m_medicare_tax_withheld;
}
void OAIW2::setMedicareTaxWithheld(const QString &medicare_tax_withheld) {
    m_medicare_tax_withheld = medicare_tax_withheld;
    m_medicare_tax_withheld_isSet = true;
}

bool OAIW2::is_medicare_tax_withheld_Set() const{
    return m_medicare_tax_withheld_isSet;
}

bool OAIW2::is_medicare_tax_withheld_Valid() const{
    return m_medicare_tax_withheld_isValid;
}

QString OAIW2::getMedicareWagesAndTips() const {
    return m_medicare_wages_and_tips;
}
void OAIW2::setMedicareWagesAndTips(const QString &medicare_wages_and_tips) {
    m_medicare_wages_and_tips = medicare_wages_and_tips;
    m_medicare_wages_and_tips_isSet = true;
}

bool OAIW2::is_medicare_wages_and_tips_Set() const{
    return m_medicare_wages_and_tips_isSet;
}

bool OAIW2::is_medicare_wages_and_tips_Valid() const{
    return m_medicare_wages_and_tips_isValid;
}

QString OAIW2::getNonqualifiedPlans() const {
    return m_nonqualified_plans;
}
void OAIW2::setNonqualifiedPlans(const QString &nonqualified_plans) {
    m_nonqualified_plans = nonqualified_plans;
    m_nonqualified_plans_isSet = true;
}

bool OAIW2::is_nonqualified_plans_Set() const{
    return m_nonqualified_plans_isSet;
}

bool OAIW2::is_nonqualified_plans_Valid() const{
    return m_nonqualified_plans_isValid;
}

QString OAIW2::getOther() const {
    return m_other;
}
void OAIW2::setOther(const QString &other) {
    m_other = other;
    m_other_isSet = true;
}

bool OAIW2::is_other_Set() const{
    return m_other_isSet;
}

bool OAIW2::is_other_Valid() const{
    return m_other_isValid;
}

QString OAIW2::getRetirementPlan() const {
    return m_retirement_plan;
}
void OAIW2::setRetirementPlan(const QString &retirement_plan) {
    m_retirement_plan = retirement_plan;
    m_retirement_plan_isSet = true;
}

bool OAIW2::is_retirement_plan_Set() const{
    return m_retirement_plan_isSet;
}

bool OAIW2::is_retirement_plan_Valid() const{
    return m_retirement_plan_isValid;
}

QString OAIW2::getSocialSecurityTaxWithheld() const {
    return m_social_security_tax_withheld;
}
void OAIW2::setSocialSecurityTaxWithheld(const QString &social_security_tax_withheld) {
    m_social_security_tax_withheld = social_security_tax_withheld;
    m_social_security_tax_withheld_isSet = true;
}

bool OAIW2::is_social_security_tax_withheld_Set() const{
    return m_social_security_tax_withheld_isSet;
}

bool OAIW2::is_social_security_tax_withheld_Valid() const{
    return m_social_security_tax_withheld_isValid;
}

QString OAIW2::getSocialSecurityTips() const {
    return m_social_security_tips;
}
void OAIW2::setSocialSecurityTips(const QString &social_security_tips) {
    m_social_security_tips = social_security_tips;
    m_social_security_tips_isSet = true;
}

bool OAIW2::is_social_security_tips_Set() const{
    return m_social_security_tips_isSet;
}

bool OAIW2::is_social_security_tips_Valid() const{
    return m_social_security_tips_isValid;
}

QString OAIW2::getSocialSecurityWages() const {
    return m_social_security_wages;
}
void OAIW2::setSocialSecurityWages(const QString &social_security_wages) {
    m_social_security_wages = social_security_wages;
    m_social_security_wages_isSet = true;
}

bool OAIW2::is_social_security_wages_Set() const{
    return m_social_security_wages_isSet;
}

bool OAIW2::is_social_security_wages_Valid() const{
    return m_social_security_wages_isValid;
}

QList<OAIW2StateAndLocalWages> OAIW2::getStateAndLocalWages() const {
    return m_state_and_local_wages;
}
void OAIW2::setStateAndLocalWages(const QList<OAIW2StateAndLocalWages> &state_and_local_wages) {
    m_state_and_local_wages = state_and_local_wages;
    m_state_and_local_wages_isSet = true;
}

bool OAIW2::is_state_and_local_wages_Set() const{
    return m_state_and_local_wages_isSet;
}

bool OAIW2::is_state_and_local_wages_Valid() const{
    return m_state_and_local_wages_isValid;
}

QString OAIW2::getStatutoryEmployee() const {
    return m_statutory_employee;
}
void OAIW2::setStatutoryEmployee(const QString &statutory_employee) {
    m_statutory_employee = statutory_employee;
    m_statutory_employee_isSet = true;
}

bool OAIW2::is_statutory_employee_Set() const{
    return m_statutory_employee_isSet;
}

bool OAIW2::is_statutory_employee_Valid() const{
    return m_statutory_employee_isValid;
}

QString OAIW2::getTaxYear() const {
    return m_tax_year;
}
void OAIW2::setTaxYear(const QString &tax_year) {
    m_tax_year = tax_year;
    m_tax_year_isSet = true;
}

bool OAIW2::is_tax_year_Set() const{
    return m_tax_year_isSet;
}

bool OAIW2::is_tax_year_Valid() const{
    return m_tax_year_isValid;
}

QString OAIW2::getThirdPartySickPay() const {
    return m_third_party_sick_pay;
}
void OAIW2::setThirdPartySickPay(const QString &third_party_sick_pay) {
    m_third_party_sick_pay = third_party_sick_pay;
    m_third_party_sick_pay_isSet = true;
}

bool OAIW2::is_third_party_sick_pay_Set() const{
    return m_third_party_sick_pay_isSet;
}

bool OAIW2::is_third_party_sick_pay_Valid() const{
    return m_third_party_sick_pay_isValid;
}

QString OAIW2::getWagesTipsOtherComp() const {
    return m_wages_tips_other_comp;
}
void OAIW2::setWagesTipsOtherComp(const QString &wages_tips_other_comp) {
    m_wages_tips_other_comp = wages_tips_other_comp;
    m_wages_tips_other_comp_isSet = true;
}

bool OAIW2::is_wages_tips_other_comp_Set() const{
    return m_wages_tips_other_comp_isSet;
}

bool OAIW2::is_wages_tips_other_comp_Valid() const{
    return m_wages_tips_other_comp_isValid;
}

bool OAIW2::isSet() const {
