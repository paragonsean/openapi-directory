...
/*
 * OAITransactionsRulesListRequest.h
 *
 * TransactionsRulesListRequest defines the request schema for &#x60;/beta/transactions/rules/v1/list&#x60;
 */

#ifndef OAITransactionsRulesListRequest_H
#define OAITransactionsRulesListRequest_H
...
class OAITransactionsRulesListRequest : public OAIObject {
public:
    OAITransactionsRulesListRequest();
    OAITransactionsRulesListRequest(QString json);
    ~OAITransactionsRulesListRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransactionsRulesListRequest)

#endif // OAITransactionsRulesListRequest_H
