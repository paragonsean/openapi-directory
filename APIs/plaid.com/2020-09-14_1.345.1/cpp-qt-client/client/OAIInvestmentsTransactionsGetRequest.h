...
/*
 * OAIInvestmentsTransactionsGetRequest.h
 *
 * InvestmentsTransactionsGetRequest defines the request schema for &#x60;/investments/transactions/get&#x60;
 */

#ifndef OAIInvestmentsTransactionsGetRequest_H
#define OAIInvestmentsTransactionsGetRequest_H
...
namespace OpenAPI {
class OAIInvestmentsTransactionsGetRequestOptions;

class OAIInvestmentsTransactionsGetRequest : public OAIObject {
public:
    OAIInvestmentsTransactionsGetRequest();
    OAIInvestmentsTransactionsGetRequest(QString json);
    ~OAIInvestmentsTransactionsGetRequest() override;
    ...
    OAIInvestmentsTransactionsGetRequestOptions getOptions() const;
    void setOptions(const OAIInvestmentsTransactionsGetRequestOptions &options);
...
private:
    ...
    OAIInvestmentsTransactionsGetRequestOptions m_options;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInvestmentsTransactionsGetRequest)

#endif // OAIInvestmentsTransactionsGetRequest_H
