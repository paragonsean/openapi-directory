...
/*
 * OAIUserPermissionRevokedWebhook.h
 *
...
#ifndef OAIUserPermissionRevokedWebhook_H
#define OAIUserPermissionRevokedWebhook_H
...
class OAIUserPermissionRevokedWebhook : public OAIObject {
public:
    OAIUserPermissionRevokedWebhook();
    OAIUserPermissionRevokedWebhook(QString json);
    ~OAIUserPermissionRevokedWebhook() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserPermissionRevokedWebhook)

#endif // OAIUserPermissionRevokedWebhook_H
