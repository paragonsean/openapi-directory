...
/*
 * OAIProcessorSignalReturnReportRequest.h
 *
 * ProcessorSignalReturnReportRequest defines the request schema for &#x60;/processor/signal/return/report&#x60;
 */

#ifndef OAIProcessorSignalReturnReportRequest_H
#define OAIProcessorSignalReturnReportRequest_H
...
class OAIProcessorSignalReturnReportRequest : public OAIObject {
public:
    OAIProcessorSignalReturnReportRequest();
    OAIProcessorSignalReturnReportRequest(QString json);
    ~OAIProcessorSignalReturnReportRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProcessorSignalReturnReportRequest)

#endif // OAIProcessorSignalReturnReportRequest_H
