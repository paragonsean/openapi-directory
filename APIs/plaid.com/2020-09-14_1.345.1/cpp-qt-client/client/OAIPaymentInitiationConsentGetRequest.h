...
/*
 * OAIPaymentInitiationConsentGetRequest.h
 *
 * PaymentInitiationConsentGetRequest defines the request schema for &#x60;/payment_initiation/consent/get&#x60;
 */

#ifndef OAIPaymentInitiationConsentGetRequest_H
#define OAIPaymentInitiationConsentGetRequest_H
...
class OAIPaymentInitiationConsentGetRequest : public OAIObject {
public:
    OAIPaymentInitiationConsentGetRequest();
    OAIPaymentInitiationConsentGetRequest(QString json);
    ~OAIPaymentInitiationConsentGetRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaymentInitiationConsentGetRequest)

#endif // OAIPaymentInitiationConsentGetRequest_H
