...
OAIIdentityVerificationRetryResponse::OAIIdentityVerificationRetryResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIdentityVerificationRetryResponse::OAIIdentityVerificationRetryResponse() {
    this->initializeModel();
}

OAIIdentityVerificationRetryResponse::~OAIIdentityVerificationRetryResponse() {}

void OAIIdentityVerificationRetryResponse::initializeModel() {
...
void OAIIdentityVerificationRetryResponse::fromJson(QString jsonString) {
...
void OAIIdentityVerificationRetryResponse::fromJsonObject(QJsonObject json) {
...
QString OAIIdentityVerificationRetryResponse::asJson() const {
...
QJsonObject OAIIdentityVerificationRetryResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIIdentityVerificationRetryResponse::getClientUserId() const {
    return m_client_user_id;
}
void OAIIdentityVerificationRetryResponse::setClientUserId(const QString &client_user_id) {
    m_client_user_id = client_user_id;
    m_client_user_id_isSet = true;
}

bool OAIIdentityVerificationRetryResponse::is_client_user_id_Set() const{
    return m_client_user_id_isSet;
}

bool OAIIdentityVerificationRetryResponse::is_client_user_id_Valid() const{
    return m_client_user_id_isValid;
}

QDateTime OAIIdentityVerificationRetryResponse::getCompletedAt() const {
    return m_completed_at;
}
void OAIIdentityVerificationRetryResponse::setCompletedAt(const QDateTime &completed_at) {
    m_completed_at = completed_at;
    m_completed_at_isSet = true;
}

bool OAIIdentityVerificationRetryResponse::is_completed_at_Set() const{
    return m_completed_at_isSet;
}

bool OAIIdentityVerificationRetryResponse::is_completed_at_Valid() const{
    return m_completed_at_isValid;
}

QDateTime OAIIdentityVerificationRetryResponse::getCreatedAt() const {
    return m_created_at;
}
void OAIIdentityVerificationRetryResponse::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIIdentityVerificationRetryResponse::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIIdentityVerificationRetryResponse::is_created_at_Valid() const{
    return m_created_at_isValid;
}

OAIDocumentaryVerification OAIIdentityVerificationRetryResponse::getDocumentaryVerification() const {
    return m_documentary_verification;
}
void OAIIdentityVerificationRetryResponse::setDocumentaryVerification(const OAIDocumentaryVerification &documentary_verification) {
    m_documentary_verification = documentary_verification;
    m_documentary_verification_isSet = true;
}

bool OAIIdentityVerificationRetryResponse::is_documentary_verification_Set() const{
    return m_documentary_verification_isSet;
}

bool OAIIdentityVerificationRetryResponse::is_documentary_verification_Valid() const{
    return m_documentary_verification_isValid;
}

QString OAIIdentityVerificationRetryResponse::getId() const {
    return m_id;
}
void OAIIdentityVerificationRetryResponse::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIIdentityVerificationRetryResponse::is_id_Set() const{
    return m_id_isSet;
}

bool OAIIdentityVerificationRetryResponse::is_id_Valid() const{
    return m_id_isValid;
}

OAIKYCCheckDetails OAIIdentityVerificationRetryResponse::getKycCheck() const {
    return m_kyc_check;
}
void OAIIdentityVerificationRetryResponse::setKycCheck(const OAIKYCCheckDetails &kyc_check) {
    m_kyc_check = kyc_check;
    m_kyc_check_isSet = true;
}

bool OAIIdentityVerificationRetryResponse::is_kyc_check_Set() const{
    return m_kyc_check_isSet;
}

bool OAIIdentityVerificationRetryResponse::is_kyc_check_Valid() const{
    return m_kyc_check_isValid;
}

QString OAIIdentityVerificationRetryResponse::getPreviousAttemptId() const {
    return m_previous_attempt_id;
}
void OAIIdentityVerificationRetryResponse::setPreviousAttemptId(const QString &previous_attempt_id) {
    m_previous_attempt_id = previous_attempt_id;
    m_previous_attempt_id_isSet = true;
}

bool OAIIdentityVerificationRetryResponse::is_previous_attempt_id_Set() const{
    return m_previous_attempt_id_isSet;
}

bool OAIIdentityVerificationRetryResponse::is_previous_attempt_id_Valid() const{
    return m_previous_attempt_id_isValid;
}

QDateTime OAIIdentityVerificationRetryResponse::getRedactedAt() const {
    return m_redacted_at;
}
void OAIIdentityVerificationRetryResponse::setRedactedAt(const QDateTime &redacted_at) {
    m_redacted_at = redacted_at;
    m_redacted_at_isSet = true;
}

bool OAIIdentityVerificationRetryResponse::is_redacted_at_Set() const{
    return m_redacted_at_isSet;
}

bool OAIIdentityVerificationRetryResponse::is_redacted_at_Valid() const{
    return m_redacted_at_isValid;
}

QString OAIIdentityVerificationRetryResponse::getRequestId() const {
    return m_request_id;
}
void OAIIdentityVerificationRetryResponse::setRequestId(const QString &request_id) {
    m_request_id = request_id;
    m_request_id_isSet = true;
}

bool OAIIdentityVerificationRetryResponse::is_request_id_Set() const{
    return m_request_id_isSet;
}

bool OAIIdentityVerificationRetryResponse::is_request_id_Valid() const{
    return m_request_id_isValid;
}

OAIRiskCheckDetails OAIIdentityVerificationRetryResponse::getRiskCheck() const {
    return m_risk_check;
}
void OAIIdentityVerificationRetryResponse::setRiskCheck(const OAIRiskCheckDetails &risk_check) {
    m_risk_check = risk_check;
    m_risk_check_isSet = true;
}

bool OAIIdentityVerificationRetryResponse::is_risk_check_Set() const{
    return m_risk_check_isSet;
}

bool OAIIdentityVerificationRetryResponse::is_risk_check_Valid() const{
    return m_risk_check_isValid;
}

QString OAIIdentityVerificationRetryResponse::getShareableUrl() const {
    return m_shareable_url;
}
void OAIIdentityVerificationRetryResponse::setShareableUrl(const QString &shareable_url) {
    m_shareable_url = shareable_url;
    m_shareable_url_isSet = true;
}

bool OAIIdentityVerificationRetryResponse::is_shareable_url_Set() const{
    return m_shareable_url_isSet;
}

bool OAIIdentityVerificationRetryResponse::is_shareable_url_Valid() const{
    return m_shareable_url_isValid;
}

OAIIdentityVerificationStatus OAIIdentityVerificationRetryResponse::getStatus() const {
    return m_status;
}
void OAIIdentityVerificationRetryResponse::setStatus(const OAIIdentityVerificationStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIIdentityVerificationRetryResponse::is_status_Set() const{
    return m_status_isSet;
}

bool OAIIdentityVerificationRetryResponse::is_status_Valid() const{
    return m_status_isValid;
}

OAIIdentityVerificationStepSummary OAIIdentityVerificationRetryResponse::getSteps() const {
    return m_steps;
}
void OAIIdentityVerificationRetryResponse::setSteps(const OAIIdentityVerificationStepSummary &steps) {
    m_steps = steps;
    m_steps_isSet = true;
}

bool OAIIdentityVerificationRetryResponse::is_steps_Set() const{
    return m_steps_isSet;
}

bool OAIIdentityVerificationRetryResponse::is_steps_Valid() const{
    return m_steps_isValid;
}

OAIIdentityVerificationTemplateReference OAIIdentityVerificationRetryResponse::getRTemplate() const {
    return m_r_template;
}
void OAIIdentityVerificationRetryResponse::setRTemplate(const OAIIdentityVerificationTemplateReference &r_template) {
    m_r_template = r_template;
    m_r_template_isSet = true;
}

bool OAIIdentityVerificationRetryResponse::is_r_template_Set() const{
    return m_r_template_isSet;
}

bool OAIIdentityVerificationRetryResponse::is_r_template_Valid() const{
    return m_r_template_isValid;
}

OAIIdentityVerificationUserData OAIIdentityVerificationRetryResponse::getUser() const {
    return m_user;
}
void OAIIdentityVerificationRetryResponse::setUser(const OAIIdentityVerificationUserData &user) {
    m_user = user;
    m_user_isSet = true;
}

bool OAIIdentityVerificationRetryResponse::is_user_Set() const{
    return m_user_isSet;
}

bool OAIIdentityVerificationRetryResponse::is_user_Valid() const{
    return m_user_isValid;
}

QString OAIIdentityVerificationRetryResponse::getWatchlistScreeningId() const {
    return m_watchlist_screening_id;
}
void OAIIdentityVerificationRetryResponse::setWatchlistScreeningId(const QString &watchlist_screening_id) {
    m_watchlist_screening_id = watchlist_screening_id;
    m_watchlist_screening_id_isSet = true;
}

bool OAIIdentityVerificationRetryResponse::is_watchlist_screening_id_Set() const{
    return m_watchlist_screening_id_isSet;
}

bool OAIIdentityVerificationRetryResponse::is_watchlist_screening_id_Valid() const{
    return m_watchlist_screening_id_isValid;
}

bool OAIIdentityVerificationRetryResponse::isSet() const {
...
bool OAIIdentityVerificationRetryResponse::isValid() const {
