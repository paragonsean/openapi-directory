...
#ifndef OAIItemGetRequest_H
#define OAIItemGetRequest_H
...
class OAIItemGetRequest : public OAIObject {
public:
    OAIItemGetRequest();
    OAIItemGetRequest(QString json);
    ~OAIItemGetRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIItemGetRequest)

#endif // OAIItemGetRequest_H
