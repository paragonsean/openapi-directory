...
/*
 * OAITransactionsRefreshRequest.h
 *
 * TransactionsRefreshRequest defines the request schema for &#x60;/transactions/refresh&#x60;
 */

#ifndef OAITransactionsRefreshRequest_H
#define OAITransactionsRefreshRequest_H
...
class OAITransactionsRefreshRequest : public OAIObject {
public:
    OAITransactionsRefreshRequest();
    OAITransactionsRefreshRequest(QString json);
    ~OAITransactionsRefreshRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransactionsRefreshRequest)

#endif // OAITransactionsRefreshRequest_H
