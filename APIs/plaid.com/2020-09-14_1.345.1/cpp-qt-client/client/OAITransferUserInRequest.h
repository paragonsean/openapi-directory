...
/*
 * OAITransferUserInRequest.h
 *
 * The legal name and other information for the account holder.
 */

#ifndef OAITransferUserInRequest_H
#define OAITransferUserInRequest_H
...
class OAITransferUserInRequest : public OAIObject {
public:
    OAITransferUserInRequest();
    OAITransferUserInRequest(QString json);
    ~OAITransferUserInRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransferUserInRequest)

#endif // OAITransferUserInRequest_H
