...
/*
 * OAITransferListRequest.h
 *
 * Defines the request schema for &#x60;/transfer/list&#x60;
 */

#ifndef OAITransferListRequest_H
#define OAITransferListRequest_H
...
class OAITransferListRequest : public OAIObject {
public:
    OAITransferListRequest();
    OAITransferListRequest(QString json);
    ~OAITransferListRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransferListRequest)

#endif // OAITransferListRequest_H
