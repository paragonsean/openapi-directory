...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.Taxform();
  });
  ...
  describe('Taxform', function() {
    it('should create an instance of Taxform', function() {
      // uncomment below and update the code to test Taxform
      //var instance = new ThePlaidApi.Taxform();
      //expect(instance).to.be.a(ThePlaidApi.Taxform);
    });
