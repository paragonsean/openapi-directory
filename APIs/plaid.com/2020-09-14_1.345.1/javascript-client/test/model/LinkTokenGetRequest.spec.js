...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.LinkTokenGetRequest();
  });
  ...
  describe('LinkTokenGetRequest', function() {
    it('should create an instance of LinkTokenGetRequest', function() {
      // uncomment below and update the code to test LinkTokenGetRequest
      //var instance = new ThePlaidApi.LinkTokenGetRequest();
      //expect(instance).to.be.a(ThePlaidApi.LinkTokenGetRequest);
    });
