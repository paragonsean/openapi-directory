...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.CreditBankIncomeCause();
  });
  ...
  describe('CreditBankIncomeCause', function() {
    it('should create an instance of CreditBankIncomeCause', function() {
      // uncomment below and update the code to test CreditBankIncomeCause
      //var instance = new ThePlaidApi.CreditBankIncomeCause();
      //expect(instance).to.be.a(ThePlaidApi.CreditBankIncomeCause);
    });
