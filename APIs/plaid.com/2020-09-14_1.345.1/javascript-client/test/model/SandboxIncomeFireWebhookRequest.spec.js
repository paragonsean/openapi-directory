...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.SandboxIncomeFireWebhookRequest();
  });
  ...
  describe('SandboxIncomeFireWebhookRequest', function() {
    it('should create an instance of SandboxIncomeFireWebhookRequest', function() {
      // uncomment below and update the code to test SandboxIncomeFireWebhookRequest
      //var instance = new ThePlaidApi.SandboxIncomeFireWebhookRequest();
      //expect(instance).to.be.a(ThePlaidApi.SandboxIncomeFireWebhookRequest);
    });
