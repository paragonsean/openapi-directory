...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.IdentityGetResponse();
  });
  ...
  describe('IdentityGetResponse', function() {
    it('should create an instance of IdentityGetResponse', function() {
      // uncomment below and update the code to test IdentityGetResponse
      //var instance = new ThePlaidApi.IdentityGetResponse();
      //expect(instance).to.be.a(ThePlaidApi.IdentityGetResponse);
    });
