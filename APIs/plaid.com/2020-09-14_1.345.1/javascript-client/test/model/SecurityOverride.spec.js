...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.SecurityOverride();
  });
  ...
  describe('SecurityOverride', function() {
    it('should create an instance of SecurityOverride', function() {
      // uncomment below and update the code to test SecurityOverride
      //var instance = new ThePlaidApi.SecurityOverride();
      //expect(instance).to.be.a(ThePlaidApi.SecurityOverride);
    });
