...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.TransactionsRecurringGetRequest();
  });
  ...
  describe('TransactionsRecurringGetRequest', function() {
    it('should create an instance of TransactionsRecurringGetRequest', function() {
      // uncomment below and update the code to test TransactionsRecurringGetRequest
      //var instance = new ThePlaidApi.TransactionsRecurringGetRequest();
      //expect(instance).to.be.a(ThePlaidApi.TransactionsRecurringGetRequest);
    });
