...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.TransactionsEnhanceGetRequest();
  });
  ...
  describe('TransactionsEnhanceGetRequest', function() {
    it('should create an instance of TransactionsEnhanceGetRequest', function() {
      // uncomment below and update the code to test TransactionsEnhanceGetRequest
      //var instance = new ThePlaidApi.TransactionsEnhanceGetRequest();
      //expect(instance).to.be.a(ThePlaidApi.TransactionsEnhanceGetRequest);
    });
