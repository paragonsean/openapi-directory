...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.NumbersEFT();
  });
  ...
  describe('NumbersEFT', function() {
    it('should create an instance of NumbersEFT', function() {
      // uncomment below and update the code to test NumbersEFT
      //var instance = new ThePlaidApi.NumbersEFT();
      //expect(instance).to.be.a(ThePlaidApi.NumbersEFT);
    });
