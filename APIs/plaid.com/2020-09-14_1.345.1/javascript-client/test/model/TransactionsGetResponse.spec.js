...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.TransactionsGetResponse();
  });
  ...
  describe('TransactionsGetResponse', function() {
    it('should create an instance of TransactionsGetResponse', function() {
      // uncomment below and update the code to test TransactionsGetResponse
      //var instance = new ThePlaidApi.TransactionsGetResponse();
      //expect(instance).to.be.a(ThePlaidApi.TransactionsGetResponse);
    });
