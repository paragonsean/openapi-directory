...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.WalletTransactionListRequest();
  });
  ...
  describe('WalletTransactionListRequest', function() {
    it('should create an instance of WalletTransactionListRequest', function() {
      // uncomment below and update the code to test WalletTransactionListRequest
      //var instance = new ThePlaidApi.WalletTransactionListRequest();
      //expect(instance).to.be.a(ThePlaidApi.WalletTransactionListRequest);
    });
