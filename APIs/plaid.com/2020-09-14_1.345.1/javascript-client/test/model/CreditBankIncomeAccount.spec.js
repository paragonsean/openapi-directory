...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.CreditBankIncomeAccount();
  });
  ...
  describe('CreditBankIncomeAccount', function() {
    it('should create an instance of CreditBankIncomeAccount', function() {
      // uncomment below and update the code to test CreditBankIncomeAccount
      //var instance = new ThePlaidApi.CreditBankIncomeAccount();
      //expect(instance).to.be.a(ThePlaidApi.CreditBankIncomeAccount);
    });
