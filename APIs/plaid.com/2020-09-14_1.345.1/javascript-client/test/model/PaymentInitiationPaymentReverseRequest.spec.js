...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.PaymentInitiationPaymentReverseRequest();
  });
  ...
  describe('PaymentInitiationPaymentReverseRequest', function() {
    it('should create an instance of PaymentInitiationPaymentReverseRequest', function() {
      // uncomment below and update the code to test PaymentInitiationPaymentReverseRequest
      //var instance = new ThePlaidApi.PaymentInitiationPaymentReverseRequest();
      //expect(instance).to.be.a(ThePlaidApi.PaymentInitiationPaymentReverseRequest);
    });
