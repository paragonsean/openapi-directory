...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.AccountAssets();
  });
  ...
  describe('AccountAssets', function() {
    it('should create an instance of AccountAssets', function() {
      // uncomment below and update the code to test AccountAssets
      //var instance = new ThePlaidApi.AccountAssets();
      //expect(instance).to.be.a(ThePlaidApi.AccountAssets);
    });
    ...
    it('should have the property historicalBalances (base name: "historical_balances")', function() {
      // uncomment below and update the code to test the property historicalBalances
      //var instance = new ThePlaidApi.AccountAssets();
      //expect(instance).to.be();
    });
