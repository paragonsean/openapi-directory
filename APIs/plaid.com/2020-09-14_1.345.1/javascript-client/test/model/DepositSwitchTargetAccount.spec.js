...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.DepositSwitchTargetAccount();
  });
  ...
  describe('DepositSwitchTargetAccount', function() {
    it('should create an instance of DepositSwitchTargetAccount', function() {
      // uncomment below and update the code to test DepositSwitchTargetAccount
      //var instance = new ThePlaidApi.DepositSwitchTargetAccount();
      //expect(instance).to.be.a(ThePlaidApi.DepositSwitchTargetAccount);
    });
    ...
    it('should have the property accountSubtype (base name: "account_subtype")', function() {
      // uncomment below and update the code to test the property accountSubtype
      //var instance = new ThePlaidApi.DepositSwitchTargetAccount();
      //expect(instance).to.be();
    });
