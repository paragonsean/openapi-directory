...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.IdentityVerificationListRequest();
  });
  ...
  describe('IdentityVerificationListRequest', function() {
    it('should create an instance of IdentityVerificationListRequest', function() {
      // uncomment below and update the code to test IdentityVerificationListRequest
      //var instance = new ThePlaidApi.IdentityVerificationListRequest();
      //expect(instance).to.be.a(ThePlaidApi.IdentityVerificationListRequest);
    });
