...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.BankTransferUser();
  });
  ...
  describe('BankTransferUser', function() {
    it('should create an instance of BankTransferUser', function() {
      // uncomment below and update the code to test BankTransferUser
      //var instance = new ThePlaidApi.BankTransferUser();
      //expect(instance).to.be.a(ThePlaidApi.BankTransferUser);
    });
