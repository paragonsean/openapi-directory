...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.AuthGetRequest();
  });
  ...
  describe('AuthGetRequest', function() {
    it('should create an instance of AuthGetRequest', function() {
      // uncomment below and update the code to test AuthGetRequest
      //var instance = new ThePlaidApi.AuthGetRequest();
      //expect(instance).to.be.a(ThePlaidApi.AuthGetRequest);
    });
