...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.ItemWebhookUpdateRequest();
  });
  ...
  describe('ItemWebhookUpdateRequest', function() {
    it('should create an instance of ItemWebhookUpdateRequest', function() {
      // uncomment below and update the code to test ItemWebhookUpdateRequest
      //var instance = new ThePlaidApi.ItemWebhookUpdateRequest();
      //expect(instance).to.be.a(ThePlaidApi.ItemWebhookUpdateRequest);
    });
