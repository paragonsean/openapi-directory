...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.SignalPrepareRequest();
  });
  ...
  describe('SignalPrepareRequest', function() {
    it('should create an instance of SignalPrepareRequest', function() {
      // uncomment below and update the code to test SignalPrepareRequest
      //var instance = new ThePlaidApi.SignalPrepareRequest();
      //expect(instance).to.be.a(ThePlaidApi.SignalPrepareRequest);
    });
