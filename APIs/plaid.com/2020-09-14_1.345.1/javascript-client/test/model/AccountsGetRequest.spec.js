...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.AccountsGetRequest();
  });
  ...
  describe('AccountsGetRequest', function() {
    it('should create an instance of AccountsGetRequest', function() {
      // uncomment below and update the code to test AccountsGetRequest
      //var instance = new ThePlaidApi.AccountsGetRequest();
      //expect(instance).to.be.a(ThePlaidApi.AccountsGetRequest);
    });
