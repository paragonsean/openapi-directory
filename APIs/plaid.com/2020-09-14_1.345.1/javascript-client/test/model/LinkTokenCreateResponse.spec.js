...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.LinkTokenCreateResponse();
  });
  ...
  describe('LinkTokenCreateResponse', function() {
    it('should create an instance of LinkTokenCreateResponse', function() {
      // uncomment below and update the code to test LinkTokenCreateResponse
      //var instance = new ThePlaidApi.LinkTokenCreateResponse();
      //expect(instance).to.be.a(ThePlaidApi.LinkTokenCreateResponse);
    });
