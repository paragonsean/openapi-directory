...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.AccountIdentityMatchScore();
  });
  ...
  describe('AccountIdentityMatchScore', function() {
    it('should create an instance of AccountIdentityMatchScore', function() {
      // uncomment below and update the code to test AccountIdentityMatchScore
      //var instance = new ThePlaidApi.AccountIdentityMatchScore();
      //expect(instance).to.be.a(ThePlaidApi.AccountIdentityMatchScore);
    });
