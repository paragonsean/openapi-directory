...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.WalletTransactionListResponse();
  });
  ...
  describe('WalletTransactionListResponse', function() {
    it('should create an instance of WalletTransactionListResponse', function() {
      // uncomment below and update the code to test WalletTransactionListResponse
      //var instance = new ThePlaidApi.WalletTransactionListResponse();
      //expect(instance).to.be.a(ThePlaidApi.WalletTransactionListResponse);
    });
