...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.TransactionsSyncRequest();
  });
  ...
  describe('TransactionsSyncRequest', function() {
    it('should create an instance of TransactionsSyncRequest', function() {
      // uncomment below and update the code to test TransactionsSyncRequest
      //var instance = new ThePlaidApi.TransactionsSyncRequest();
      //expect(instance).to.be.a(ThePlaidApi.TransactionsSyncRequest);
    });
