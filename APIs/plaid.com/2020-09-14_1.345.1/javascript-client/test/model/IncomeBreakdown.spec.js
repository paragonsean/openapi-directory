...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.IncomeBreakdown();
  });
  ...
  describe('IncomeBreakdown', function() {
    it('should create an instance of IncomeBreakdown', function() {
      // uncomment below and update the code to test IncomeBreakdown
      //var instance = new ThePlaidApi.IncomeBreakdown();
      //expect(instance).to.be.a(ThePlaidApi.IncomeBreakdown);
    });
