...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.StandaloneAccountType();
  });
  ...
  describe('StandaloneAccountType', function() {
    it('should create an instance of StandaloneAccountType', function() {
      // uncomment below and update the code to test StandaloneAccountType
      //var instance = new ThePlaidApi.StandaloneAccountType();
      //expect(instance).to.be.a(ThePlaidApi.StandaloneAccountType);
    });
