...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.TransactionsSyncResponse();
  });
  ...
  describe('TransactionsSyncResponse', function() {
    it('should create an instance of TransactionsSyncResponse', function() {
      // uncomment below and update the code to test TransactionsSyncResponse
      //var instance = new ThePlaidApi.TransactionsSyncResponse();
      //expect(instance).to.be.a(ThePlaidApi.TransactionsSyncResponse);
    });
