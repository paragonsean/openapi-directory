...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.ProcessorTokenCreateRequest();
  });
  ...
  describe('ProcessorTokenCreateRequest', function() {
    it('should create an instance of ProcessorTokenCreateRequest', function() {
      // uncomment below and update the code to test ProcessorTokenCreateRequest
      //var instance = new ThePlaidApi.ProcessorTokenCreateRequest();
      //expect(instance).to.be.a(ThePlaidApi.ProcessorTokenCreateRequest);
    });
