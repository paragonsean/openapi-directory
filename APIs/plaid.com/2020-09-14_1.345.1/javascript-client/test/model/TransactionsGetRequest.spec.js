...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.TransactionsGetRequest();
  });
  ...
  describe('TransactionsGetRequest', function() {
    it('should create an instance of TransactionsGetRequest', function() {
      // uncomment below and update the code to test TransactionsGetRequest
      //var instance = new ThePlaidApi.TransactionsGetRequest();
      //expect(instance).to.be.a(ThePlaidApi.TransactionsGetRequest);
    });
