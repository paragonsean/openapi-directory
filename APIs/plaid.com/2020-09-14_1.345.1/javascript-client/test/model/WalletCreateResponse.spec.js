...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.WalletCreateResponse();
  });
  ...
  describe('WalletCreateResponse', function() {
    it('should create an instance of WalletCreateResponse', function() {
      ...
      //var instance = new ThePlaidApi.WalletCreateResponse();
      //expect(instance).to.be.a(ThePlaidApi.WalletCreateResponse);
    });
