...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.SignalDevice();
  });
  ...
  describe('SignalDevice', function() {
    it('should create an instance of SignalDevice', function() {
      // uncomment below and update the code to test SignalDevice
      //var instance = new ThePlaidApi.SignalDevice();
      //expect(instance).to.be.a(ThePlaidApi.SignalDevice);
    });
