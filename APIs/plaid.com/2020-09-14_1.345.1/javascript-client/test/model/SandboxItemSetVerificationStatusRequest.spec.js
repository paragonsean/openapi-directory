...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.SandboxItemSetVerificationStatusRequest();
  });
  ...
  describe('SandboxItemSetVerificationStatusRequest', function() {
    it('should create an instance of SandboxItemSetVerificationStatusRequest', function() {
      // uncomment below and update the code to test SandboxItemSetVerificationStatusRequest
      //var instance = new ThePlaidApi.SandboxItemSetVerificationStatusRequest();
      //expect(instance).to.be.a(ThePlaidApi.SandboxItemSetVerificationStatusRequest);
    });
