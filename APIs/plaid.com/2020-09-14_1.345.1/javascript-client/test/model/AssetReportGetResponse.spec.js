...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.AssetReportGetResponse();
  });
  ...
  describe('AssetReportGetResponse', function() {
    it('should create an instance of AssetReportGetResponse', function() {
      // uncomment below and update the code to test AssetReportGetResponse
      //var instance = new ThePlaidApi.AssetReportGetResponse();
      //expect(instance).to.be.a(ThePlaidApi.AssetReportGetResponse);
    });
