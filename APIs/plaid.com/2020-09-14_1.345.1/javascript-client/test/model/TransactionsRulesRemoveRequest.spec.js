...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.TransactionsRulesRemoveRequest();
  });
  ...
  describe('TransactionsRulesRemoveRequest', function() {
    it('should create an instance of TransactionsRulesRemoveRequest', function() {
      // uncomment below and update the code to test TransactionsRulesRemoveRequest
      //var instance = new ThePlaidApi.TransactionsRulesRemoveRequest();
      //expect(instance).to.be.a(ThePlaidApi.TransactionsRulesRemoveRequest);
    });
