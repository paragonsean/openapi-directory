...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.PaymentInitiationPaymentCreateRequest();
  });
  ...
  describe('PaymentInitiationPaymentCreateRequest', function() {
    it('should create an instance of PaymentInitiationPaymentCreateRequest', function() {
      // uncomment below and update the code to test PaymentInitiationPaymentCreateRequest
      //var instance = new ThePlaidApi.PaymentInitiationPaymentCreateRequest();
      //expect(instance).to.be.a(ThePlaidApi.PaymentInitiationPaymentCreateRequest);
    });
