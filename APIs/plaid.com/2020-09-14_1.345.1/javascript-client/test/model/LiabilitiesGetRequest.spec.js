...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.LiabilitiesGetRequest();
  });
  ...
  describe('LiabilitiesGetRequest', function() {
    it('should create an instance of LiabilitiesGetRequest', function() {
      // uncomment below and update the code to test LiabilitiesGetRequest
      //var instance = new ThePlaidApi.LiabilitiesGetRequest();
      //expect(instance).to.be.a(ThePlaidApi.LiabilitiesGetRequest);
    });
