...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.AccountsGetResponse();
  });
  ...
  describe('AccountsGetResponse', function() {
    it('should create an instance of AccountsGetResponse', function() {
      // uncomment below and update the code to test AccountsGetResponse
      //var instance = new ThePlaidApi.AccountsGetResponse();
      //expect(instance).to.be.a(ThePlaidApi.AccountsGetResponse);
    });
