...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.ItemActivityListRequest();
  });
  ...
  describe('ItemActivityListRequest', function() {
    it('should create an instance of ItemActivityListRequest', function() {
      // uncomment below and update the code to test ItemActivityListRequest
      //var instance = new ThePlaidApi.ItemActivityListRequest();
      //expect(instance).to.be.a(ThePlaidApi.ItemActivityListRequest);
    });
