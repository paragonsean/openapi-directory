...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.IdentityVerificationUserData();
  });
  ...
  describe('IdentityVerificationUserData', function() {
    it('should create an instance of IdentityVerificationUserData', function() {
      // uncomment below and update the code to test IdentityVerificationUserData
      //var instance = new ThePlaidApi.IdentityVerificationUserData();
      //expect(instance).to.be.a(ThePlaidApi.IdentityVerificationUserData);
    });
