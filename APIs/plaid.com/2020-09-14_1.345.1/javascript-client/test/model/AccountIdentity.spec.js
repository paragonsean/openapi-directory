...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.AccountIdentity();
  });
  ...
  describe('AccountIdentity', function() {
    it('should create an instance of AccountIdentity', function() {
      // uncomment below and update the code to test AccountIdentity
      //var instance = new ThePlaidApi.AccountIdentity();
      //expect(instance).to.be.a(ThePlaidApi.AccountIdentity);
    });
