...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.Parties();
  });
  ...
  describe('Parties', function() {
    it('should create an instance of Parties', function() {
      // uncomment below and update the code to test Parties
      //var instance = new ThePlaidApi.Parties();
      //expect(instance).to.be.a(ThePlaidApi.Parties);
    });
