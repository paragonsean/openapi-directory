...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.TransferMigrateAccountRequest();
  });
  ...
  describe('TransferMigrateAccountRequest', function() {
    it('should create an instance of TransferMigrateAccountRequest', function() {
      // uncomment below and update the code to test TransferMigrateAccountRequest
      //var instance = new ThePlaidApi.TransferMigrateAccountRequest();
      //expect(instance).to.be.a(ThePlaidApi.TransferMigrateAccountRequest);
    });
