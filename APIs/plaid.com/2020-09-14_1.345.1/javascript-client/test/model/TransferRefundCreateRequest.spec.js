...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.TransferRefundCreateRequest();
  });
  ...
  describe('TransferRefundCreateRequest', function() {
    it('should create an instance of TransferRefundCreateRequest', function() {
      // uncomment below and update the code to test TransferRefundCreateRequest
      //var instance = new ThePlaidApi.TransferRefundCreateRequest();
      //expect(instance).to.be.a(ThePlaidApi.TransferRefundCreateRequest);
    });
