...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.IdentityGetRequest();
  });
  ...
  describe('IdentityGetRequest', function() {
    it('should create an instance of IdentityGetRequest', function() {
      // uncomment below and update the code to test IdentityGetRequest
      //var instance = new ThePlaidApi.IdentityGetRequest();
      //expect(instance).to.be.a(ThePlaidApi.IdentityGetRequest);
    });
