...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.SignalEvaluateRequest();
  });
  ...
  describe('SignalEvaluateRequest', function() {
    it('should create an instance of SignalEvaluateRequest', function() {
      // uncomment below and update the code to test SignalEvaluateRequest
      //var instance = new ThePlaidApi.SignalEvaluateRequest();
      //expect(instance).to.be.a(ThePlaidApi.SignalEvaluateRequest);
    });
