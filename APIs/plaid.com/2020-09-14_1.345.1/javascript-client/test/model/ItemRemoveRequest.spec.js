...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.ItemRemoveRequest();
  });
  ...
  describe('ItemRemoveRequest', function() {
    it('should create an instance of ItemRemoveRequest', function() {
      // uncomment below and update the code to test ItemRemoveRequest
      //var instance = new ThePlaidApi.ItemRemoveRequest();
      //expect(instance).to.be.a(ThePlaidApi.ItemRemoveRequest);
    });
