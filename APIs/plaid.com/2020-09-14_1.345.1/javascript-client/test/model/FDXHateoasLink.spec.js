...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.FDXHateoasLink();
  });
  ...
  describe('FDXHateoasLink', function() {
    it('should create an instance of FDXHateoasLink', function() {
      // uncomment below and update the code to test FDXHateoasLink
      //var instance = new ThePlaidApi.FDXHateoasLink();
      //expect(instance).to.be.a(ThePlaidApi.FDXHateoasLink);
    });
