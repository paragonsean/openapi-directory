...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.ItemPublicTokenExchangeResponse();
  });
  ...
  describe('ItemPublicTokenExchangeResponse', function() {
    it('should create an instance of ItemPublicTokenExchangeResponse', function() {
      // uncomment below and update the code to test ItemPublicTokenExchangeResponse
      //var instance = new ThePlaidApi.ItemPublicTokenExchangeResponse();
      //expect(instance).to.be.a(ThePlaidApi.ItemPublicTokenExchangeResponse);
    });
