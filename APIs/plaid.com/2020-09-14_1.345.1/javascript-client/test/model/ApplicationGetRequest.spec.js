...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.ApplicationGetRequest();
  });
  ...
  describe('ApplicationGetRequest', function() {
    it('should create an instance of ApplicationGetRequest', function() {
      // uncomment below and update the code to test ApplicationGetRequest
      //var instance = new ThePlaidApi.ApplicationGetRequest();
      //expect(instance).to.be.a(ThePlaidApi.ApplicationGetRequest);
    });
