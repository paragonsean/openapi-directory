...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.DepositSwitchTargetUser();
  });
  ...
  describe('DepositSwitchTargetUser', function() {
    it('should create an instance of DepositSwitchTargetUser', function() {
      // uncomment below and update the code to test DepositSwitchTargetUser
      //var instance = new ThePlaidApi.DepositSwitchTargetUser();
      //expect(instance).to.be.a(ThePlaidApi.DepositSwitchTargetUser);
    });
    ...
    it('should have the property taxPayerId (base name: "tax_payer_id")', function() {
