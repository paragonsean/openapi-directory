...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.LiabilitiesGetResponse();
  });
  ...
  describe('LiabilitiesGetResponse', function() {
    it('should create an instance of LiabilitiesGetResponse', function() {
      // uncomment below and update the code to test LiabilitiesGetResponse
      //var instance = new ThePlaidApi.LiabilitiesGetResponse();
      //expect(instance).to.be.a(ThePlaidApi.LiabilitiesGetResponse);
    });
