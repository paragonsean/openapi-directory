...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.PayrollItem();
  });
  ...
  describe('PayrollItem', function() {
    it('should create an instance of PayrollItem', function() {
      // uncomment below and update the code to test PayrollItem
      //var instance = new ThePlaidApi.PayrollItem();
      //expect(instance).to.be.a(ThePlaidApi.PayrollItem);
    });
