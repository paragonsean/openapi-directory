...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.TransferUserInRequest();
  });
  ...
  describe('TransferUserInRequest', function() {
    it('should create an instance of TransferUserInRequest', function() {
      // uncomment below and update the code to test TransferUserInRequest
      //var instance = new ThePlaidApi.TransferUserInRequest();
      //expect(instance).to.be.a(ThePlaidApi.TransferUserInRequest);
    });
