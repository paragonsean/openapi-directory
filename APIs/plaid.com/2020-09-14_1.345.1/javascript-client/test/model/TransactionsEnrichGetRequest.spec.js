...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.TransactionsEnrichGetRequest();
  });
  ...
  describe('TransactionsEnrichGetRequest', function() {
    it('should create an instance of TransactionsEnrichGetRequest', function() {
      // uncomment below and update the code to test TransactionsEnrichGetRequest
      //var instance = new ThePlaidApi.TransactionsEnrichGetRequest();
      //expect(instance).to.be.a(ThePlaidApi.TransactionsEnrichGetRequest);
    });
