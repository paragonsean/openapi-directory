...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.WalletListRequest();
  });
  ...
  describe('WalletListRequest', function() {
    it('should create an instance of WalletListRequest', function() {
      // uncomment below and update the code to test WalletListRequest
      //var instance = new ThePlaidApi.WalletListRequest();
      //expect(instance).to.be.a(ThePlaidApi.WalletListRequest);
    });
