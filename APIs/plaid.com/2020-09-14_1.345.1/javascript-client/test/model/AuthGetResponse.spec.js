...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.AuthGetResponse();
  });
  ...
  describe('AuthGetResponse', function() {
    it('should create an instance of AuthGetResponse', function() {
      // uncomment below and update the code to test AuthGetResponse
      //var instance = new ThePlaidApi.AuthGetResponse();
      //expect(instance).to.be.a(ThePlaidApi.AuthGetResponse);
    });
