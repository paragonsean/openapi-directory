...
(function(root, factory) {
  ...
  describe('W2', function() {
    it('should create an instance of W2', function() {
      // uncomment below and update the code to test W2
      //var instance = new ThePlaidApi.W2();
      //expect(instance).to.be.a(ThePlaidApi.W2);
    });
