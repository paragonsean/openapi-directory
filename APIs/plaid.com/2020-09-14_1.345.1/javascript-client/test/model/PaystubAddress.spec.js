...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.PaystubAddress();
  });
  ...
  describe('PaystubAddress', function() {
    it('should create an instance of PaystubAddress', function() {
      // uncomment below and update the code to test PaystubAddress
      //var instance = new ThePlaidApi.PaystubAddress();
      //expect(instance).to.be.a(ThePlaidApi.PaystubAddress);
    });
