...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.EntityScreeningHitData();
  });
  ...
  describe('EntityScreeningHitData', function() {
    it('should create an instance of EntityScreeningHitData', function() {
      // uncomment below and update the code to test EntityScreeningHitData
      //var instance = new ThePlaidApi.EntityScreeningHitData();
      //expect(instance).to.be.a(ThePlaidApi.EntityScreeningHitData);
    });
