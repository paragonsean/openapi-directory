...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.ItemGetRequest();
  });
  ...
  describe('ItemGetRequest', function() {
    it('should create an instance of ItemGetRequest', function() {
      // uncomment below and update the code to test ItemGetRequest
      //var instance = new ThePlaidApi.ItemGetRequest();
      //expect(instance).to.be.a(ThePlaidApi.ItemGetRequest);
    });
