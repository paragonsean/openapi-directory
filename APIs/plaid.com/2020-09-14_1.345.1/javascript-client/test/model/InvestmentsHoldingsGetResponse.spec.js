...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.InvestmentsHoldingsGetResponse();
  });
  ...
  describe('InvestmentsHoldingsGetResponse', function() {
    it('should create an instance of InvestmentsHoldingsGetResponse', function() {
      // uncomment below and update the code to test InvestmentsHoldingsGetResponse
      //var instance = new ThePlaidApi.InvestmentsHoldingsGetResponse();
      //expect(instance).to.be.a(ThePlaidApi.InvestmentsHoldingsGetResponse);
    });
