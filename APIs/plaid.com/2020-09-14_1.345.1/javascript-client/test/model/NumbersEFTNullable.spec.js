...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.NumbersEFTNullable();
  });
  ...
  describe('NumbersEFTNullable', function() {
    it('should create an instance of NumbersEFTNullable', function() {
      // uncomment below and update the code to test NumbersEFTNullable
      //var instance = new ThePlaidApi.NumbersEFTNullable();
      //expect(instance).to.be.a(ThePlaidApi.NumbersEFTNullable);
    });
