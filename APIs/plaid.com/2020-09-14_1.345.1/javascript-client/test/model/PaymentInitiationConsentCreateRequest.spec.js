...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.PaymentInitiationConsentCreateRequest();
  });
  ...
  describe('PaymentInitiationConsentCreateRequest', function() {
    it('should create an instance of PaymentInitiationConsentCreateRequest', function() {
      // uncomment below and update the code to test PaymentInitiationConsentCreateRequest
      //var instance = new ThePlaidApi.PaymentInitiationConsentCreateRequest();
      //expect(instance).to.be.a(ThePlaidApi.PaymentInitiationConsentCreateRequest);
    });
