...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.SandboxTransferSimulateRequest();
  });
  ...
  describe('SandboxTransferSimulateRequest', function() {
    it('should create an instance of SandboxTransferSimulateRequest', function() {
      // uncomment below and update the code to test SandboxTransferSimulateRequest
      //var instance = new ThePlaidApi.SandboxTransferSimulateRequest();
      //expect(instance).to.be.a(ThePlaidApi.SandboxTransferSimulateRequest);
    });
