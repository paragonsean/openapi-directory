...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.TransferUserInResponse();
  });
  ...
  describe('TransferUserInResponse', function() {
    it('should create an instance of TransferUserInResponse', function() {
      // uncomment below and update the code to test TransferUserInResponse
      //var instance = new ThePlaidApi.TransferUserInResponse();
      //expect(instance).to.be.a(ThePlaidApi.TransferUserInResponse);
    });
