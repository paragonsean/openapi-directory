...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.CreditPayStubEmployee();
  });
  ...
  describe('CreditPayStubEmployee', function() {
    it('should create an instance of CreditPayStubEmployee', function() {
      // uncomment below and update the code to test CreditPayStubEmployee
      //var instance = new ThePlaidApi.CreditPayStubEmployee();
      //expect(instance).to.be.a(ThePlaidApi.CreditPayStubEmployee);
    });
