...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePlaidApi.WalletTransactionsListRequest();
  });
  ...
  describe('WalletTransactionsListRequest', function() {
    it('should create an instance of WalletTransactionsListRequest', function() {
      // uncomment below and update the code to test WalletTransactionsListRequest
      //var instance = new ThePlaidApi.WalletTransactionsListRequest();
      //expect(instance).to.be.a(ThePlaidApi.WalletTransactionsListRequest);
    });
