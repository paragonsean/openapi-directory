...
class UserAddress {
    ...
    constructor(city, country, postalCode, region, street) { 
        ...
        UserAddress.initialize(this, city, country, postalCode, region, street);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of UserAddress.RequiredProperties) {
...
UserAddress.RequiredProperties = ["city", "country", "postal_code", "region", "street"];
 ...
 */
UserAddress.prototype['postal_code'] = undefined;
