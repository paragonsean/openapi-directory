...
/**
 * The WatchlistScreeningIndividualCreateResponse model module.
 * @module model/WatchlistScreeningIndividualCreateResponse
 * @version 2020-09-14_1.345.1
 */
class WatchlistScreeningIndividualCreateResponse {
    /**
     * Constructs a new <code>WatchlistScreeningIndividualCreateResponse</code>.
     ...
     * @alias module:model/WatchlistScreeningIndividualCreateResponse
     * @extends Object
    ...
    constructor(assignee, auditTrail, clientUserId, id, requestId, searchTerms, status) { 
        ...
        WatchlistScreeningIndividualCreateResponse.initialize(this, assignee, auditTrail, clientUserId, id, requestId, searchTerms, status);
    }
    ...
    /**
     * Constructs a <code>WatchlistScreeningIndividualCreateResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WatchlistScreeningIndividualCreateResponse} obj Optional instance to populate.
     * @return {module:model/WatchlistScreeningIndividualCreateResponse} The populated <code>WatchlistScreeningIndividualCreateResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WatchlistScreeningIndividualCreateResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>WatchlistScreeningIndividualCreateResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WatchlistScreeningIndividualCreateResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WatchlistScreeningIndividualCreateResponse.RequiredProperties) {
...
WatchlistScreeningIndividualCreateResponse.RequiredProperties = ["assignee", "audit_trail", "client_user_id", "id", "request_id", "search_terms", "status"];

/**
 * ID of the associated user.
 * @member {String} assignee
 */
WatchlistScreeningIndividualCreateResponse.prototype['assignee'] = undefined;

/**
 * @member {module:model/WatchlistScreeningAuditTrail} audit_trail
 */
WatchlistScreeningIndividualCreateResponse.prototype['audit_trail'] = undefined;

/**
 * An identifier to help you connect this object to your internal systems. For example, your database ID corresponding to this object.
 * @member {String} client_user_id
 */
WatchlistScreeningIndividualCreateResponse.prototype['client_user_id'] = undefined;

/**
 * ID of the associated screening.
 * @member {String} id
 */
WatchlistScreeningIndividualCreateResponse.prototype['id'] = undefined;

/**
 * A unique identifier for the request, which can be used for troubleshooting. This identifier, like all Plaid identifiers, is case sensitive.
 * @member {String} request_id
 */
WatchlistScreeningIndividualCreateResponse.prototype['request_id'] = undefined;

/**
 * @member {module:model/WatchlistScreeningSearchTerms} search_terms
 */
WatchlistScreeningIndividualCreateResponse.prototype['search_terms'] = undefined;

/**
 * @member {module:model/WatchlistScreeningStatus} status
 */
WatchlistScreeningIndividualCreateResponse.prototype['status'] = undefined;
...
export default WatchlistScreeningIndividualCreateResponse;
