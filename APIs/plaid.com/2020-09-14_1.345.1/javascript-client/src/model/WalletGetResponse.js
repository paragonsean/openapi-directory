...
class WalletGetResponse {
    ...
    constructor(balance, numbers, status, walletId, requestId) { 
        ...
        WalletGetResponse.initialize(this, balance, numbers, status, walletId, requestId);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>WalletGetResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WalletGetResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WalletGetResponse.RequiredProperties) {
...
WalletGetResponse.RequiredProperties = ["balance", "numbers", "status", "wallet_id", "request_id"];

/**
 * @member {module:model/WalletBalance} balance
 */
WalletGetResponse.prototype['balance'] = undefined;

/**
 * @member {module:model/WalletNumbers} numbers
 */
WalletGetResponse.prototype['numbers'] = undefined;

/**
 * The ID of the recipient that corresponds to the e-wallet account numbers
 * @member {String} recipient_id
 */
WalletGetResponse.prototype['recipient_id'] = undefined;

/**
 * @member {module:model/WalletStatus} status
 */
WalletGetResponse.prototype['status'] = undefined;

/**
 * A unique ID identifying the e-wallet
 * @member {String} wallet_id
 */
WalletGetResponse.prototype['wallet_id'] = undefined;

/**
 * A unique identifier for the request, which can be used for troubleshooting. This identifier, like all Plaid identifiers, is case sensitive.
 * @member {String} request_id
 */
WalletGetResponse.prototype['request_id'] = undefined;
...
export default WalletGetResponse;
