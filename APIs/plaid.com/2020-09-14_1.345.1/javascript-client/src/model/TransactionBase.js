...
/**
 * The TransactionBase model module.
 * @module model/TransactionBase
 * @version 2020-09-14_1.345.1
 */
class TransactionBase {
    /**
     * Constructs a new <code>TransactionBase</code>.
     * A representation of a transaction
     * @alias module:model/TransactionBase
     * @extends Object
     ...
     */
    constructor(accountId, amount, date, isoCurrencyCode, pending, transactionId, unofficialCurrencyCode) { 
     ...
     */
    static initialize(obj, accountId, amount, date, isoCurrencyCode, pending, transactionId, unofficialCurrencyCode) { 
    ...
    /**
     * Constructs a <code>TransactionBase</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TransactionBase} obj Optional instance to populate.
     * @return {module:model/TransactionBase} The populated <code>TransactionBase</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TransactionBase();
    ...
    /**
     * Validates the JSON data with respect to <code>TransactionBase</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransactionBase</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransactionBase.RequiredProperties) {
...
TransactionBase.RequiredProperties = ["account_id", "amount", "date", "iso_currency_code", "pending", "transaction_id", "unofficial_currency_code"];
